import{S as Ys,i as Js,s as Qs,e as r,k as c,w as I,t as n,N as Vs,c as o,d as a,m as h,a as p,x as B,h as l,b as m,F as t,g as i,y as q,L as Ws,q as K,o as z,B as D,v as Xs}from"../chunks/vendor-e46c3074.js";import{I as Zs}from"../chunks/IconCopyLink-380c1989.js";import{C as os}from"../chunks/CodeBlock-8e2273c8.js";function sa(Cs){let y,Y,g,_,P,d,ps,M,is,J,f,cs,R,hs,us,E,fs,ms,Q,F,ys,V,v,W,H,gs,X,$,Z,N,js,ss,w,j,_s,T,ws,bs,O,ds,Es,vs,u,$s,A,As,ks,U,Ss,Fs,x,Hs,Ns,as,k,ts,G,Gs,es,S,ns;return d=new Zs({}),v=new os({props:{code:"git remote add space https://huggingface.co/spaces/FULL_SPACE_NAME",highlighted:"git remote add space https://huggingface.co/spaces/FULL_SPACE_NAME"}}),$=new os({props:{code:"git push --force space main",highlighted:"git push --force space main"}}),k=new os({props:{code:`name: Sync to Hugging Face hub
on:
  push:
    branches: [main]
