...
curl https:<span class="hljs-comment">//api-inference.huggingface.co/bulk/status/bulk-68079542</span>`}}),{c(){y(t.$$.fragment)},l(s){w(t.$$.fragment,s)},m(s,o){b(t,s,o),n=!0},p:Q,i(s){n||(q(t.$$.fragment,s),n=!0)},o(s){$(t.$$.fragment,s),n=!1},d(s){k(t,s)}}}function it(j){let t,n;return t=new V({props:{$$slots:{default:[pt]},$$scope:{ctx:j}}}),{c(){y(t.$$.fragment)},l(s){w(t.$$.fragment,s)},m(s,o){b(t,s,o),n=!0},p(s,o){const d={};o&2&&(d.$$scope={dirty:o,ctx:s}),t.$set(d)},i(s){n||(q(t.$$.fragment,s),n=!0)},o(s){$(t.$$.fragment,s),n=!1},d(s){k(t,s)}}}function ct(j){let t,n,s,o,d,K,Hs,ss,Bs,fs,R,zs,ds,W,Cs,ms,E,as,Rs,Ws,ts,Ys,gs,v,P,es,M,Fs,ns,Gs,js,O,Xs,ls,Qs,Vs,_s,Y,Zs,ys,A,ws,F,sa,bs,G,aa,qs,I,ta,os,ea,na,$s,S,la,rs,oa,ra,ks,N,ps,pa,ia,J,ca,is,ua,ha,vs,T,L,cs,H,fa,us,da,Ts,x,ma,B,ga,ja,Es,D,_a,z,ya,wa,Ps,X,ba,Os,U,As;return K=new qa({}),M=new qa({}),A=new Wa({props:{python:!0,js:!0,curl:!0,$$slots:{curl:[et],js:[at],python:[Za]},$$scope:{ctx:j}}}),H=new qa({}),U=new Wa({props:{python:!0,js:!0,curl:!0,$$slots:{curl:[it],js:[rt],python:[lt]},$$scope:{ctx:j}}}),{c(){t=p("meta"),n=m(),s=p("h1"),o=p("a"),d=p("span"),y(K.$$.fragment),Hs=m(),ss=p("span"),Bs=h("Parallelism and batch jobs"),fs=m(),R=p("p"),zs=h(`In order to get your answers as quickly as possible, you probably want
...
status of the job`),ia=m(),J=p("li"),ca=h(`results message: These messages will contain the
...
by the HTTP endpoint. See `),is=p("code"),ua=h("detailed_parameters"),ha=h(" for more information."),vs=m(),T=p("h2"),L=p("a"),cs=p("span"),y(H.$$.fragment),fa=m(),us=p("span"),da=h("Dataset"),Ts=m(),x=p("p"),ma=h(`If you are running regulary against the same dataset to check
...
outputs.`),Os=m(),y(U.$$.fragment),this.h()},l(a){const r=Xa('[data-svelte="svelte-1phssyn"]',document.head);t=i(r,"META",{name:!0,content:!0}),r.forEach(e),n=g(a),s=i(a,"H1",{class:!0});var C=c(s);o=i(C,"A",{id:!0,class:!0,href:!0});var hs=c(o);d=i(hs,"SPAN",{});var $a=c(d);w(K.$$.fragment,$a),$a.forEach(e),hs.forEach(e),Hs=g(C),ss=i(C,"SPAN",{});var ka=c(ss);Bs=f(ka,"Parallelism and batch jobs"),ka.forEach(e),C.forEach(e),fs=g(a),R=i(a,"P",{});var va=c(R);zs=f(va,`In order to get your answers as quickly as possible, you probably want
to run some kind of parallelism on your jobs.`),va.forEach(e),ds=g(a),W=i(a,"P",{});var Ta=c(W);Cs=f(Ta,"There are two options at your disposal for this."),Ta.forEach(e),ms=g(a),E=i(a,"UL",{});var Is=c(E);as=i(Is,"LI",{});var Ea=c(as);Rs=f(Ea,"The streaming option"),Ea.forEach(e),Ws=g(Is),ts=i(Is,"LI",{});var Pa=c(ts);Ys=f(Pa,"The dataset option"),Pa.forEach(e),Is.forEach(e),gs=g(a),v=i(a,"H2",{class:!0});var Ss=c(v);P=i(Ss,"A",{id:!0,class:!0,href:!0});var Oa=c(P);es=i(Oa,"SPAN",{});var Aa=c(es);w(M.$$.fragment,Aa),Aa.forEach(e),Oa.forEach(e),Fs=g(Ss),ns=i(Ss,"SPAN",{});var Ia=c(ns);Gs=f(Ia,"Streaming"),Ia.forEach(e),Ss.forEach(e),js=g(a),O=i(a,"P",{});var Ns=c(O);Xs=f(Ns,`In order to maximize the speed of inference, instead of running many
HTTP requests it will be more efficient to stream your data to the API.
This will require the use of websockets on your end. Internally we\u2019re
using a queue system where machines can variously pull work, seamlessly
using parallelism for you. `),ls=i(Ns,"STRONG",{});var Sa=c(ls);Qs=f(Sa,`This is meant as a batching mechanism and a
single stream should be open at any give time`),Sa.forEach(e),Vs=f(Ns,`. If multiple streams are
open, requests will go to either without any guarantee. This is intended
as it allows recovering from a stream cut. Simply reinitializing the
stream will recover results, everything that was sent is being processed
even if you are not connected anymore. So make sure you don\u2019t send item
multiple times other wise you will be billed multiple times.`),Ns.forEach(e),_s=g(a),Y=i(a,"P",{});var Na=c(Y);Zs=f(Na,"Here is a small example:"),Na.forEach(e),ys=g(a),w(A.$$.fragment,a),ws=g(a),F=i(a,"P",{});var La=c(F);sa=f(La,"The messages you need to send need to contain inputs keys."),La.forEach(e),bs=g(a),G=i(a,"P",{});var xa=c(G);aa=f(xa,`Optionnally you can specifiy id key that will be sent back
with the result. We try to maintain the ordering of results as you sent,
but it\u2019s better to be sure, the id key is there for that.`),xa.forEach(e),qs=g(a),I=i(a,"P",{});var Ls=c(I);ta=f(Ls,`Optionnally, you can specify parameters key that
corresponds to `),os=i(Ls,"CODE",{});var Da=c(os);ea=f(Da,"detailed_parameters"),Da.forEach(e),na=f(Ls,` of
the pipeline you are using.`),Ls.forEach(e),$s=g(a),S=i(a,"P",{});var xs=c(S);la=f(xs,"The received messages will "),rs=i(xs,"EM",{});var Ua=c(rs);oa=f(Ua,"always"),Ua.forEach(e),ra=f(xs," contain a type key."),xs.forEach(e),ks=g(a),N=i(a,"UL",{});var Ds=c(N);ps=i(Ds,"LI",{});var Ka=c(ps);pa=f(Ka,`status message: These messages will contain a
message key that will inform you about the current
status of the job`),Ka.forEach(e),ia=g(Ds),J=i(Ds,"LI",{});var Us=c(J);ca=f(Us,`results message: These messages will contain the
actual results of the computation. id will contain the
id you have sent (or one will be generated automatically).
outputs will contain the result like it would be sent
by the HTTP endpoint. See `),is=i(Us,"CODE",{});var Ma=c(is);ua=f(Ma,"detailed_parameters"),Ma.forEach(e),ha=f(Us," for more information."),Us.forEach(e),Ds.forEach(e),vs=g(a),T=i(a,"H2",{class:!0});var Ks=c(T);L=i(Ks,"A",{id:!0,class:!0,href:!0});var Ja=c(L);cs=i(Ja,"SPAN",{});var Ha=c(cs);w(H.$$.fragment,Ha),Ha.forEach(e),Ja.forEach(e),fa=g(Ks),us=i(Ks,"SPAN",{});var Ba=c(us);da=f(Ba,"Dataset"),Ba.forEach(e),Ks.forEach(e),Ts=g(a),x=i(a,"P",{});var Ms=c(x);ma=f(Ms,`If you are running regulary against the same dataset to check
differences between models or drifts we recommend using a
`),B=i(Ms,"A",{href:!0,rel:!0});var za=c(B);ga=f(za,"dataset"),za.forEach(e),ja=f(Ms," ."),Ms.forEach(e),Es=g(a),D=i(a,"P",{});var Js=c(D);_a=f(Js,`Or use any of the 2000 available datasets:
`),z=i(Js,"A",{href:!0,rel:!0});var Ca=c(z);ya=f(Ca,"here"),Ca.forEach(e),wa=f(Js,"."),Js.forEach(e),Ps=g(a),X=i(a,"P",{});var Ra=c(X);ba=f(Ra,`The outputs of this method will automatically create a private dataset
on your account, and use git mechanisms to store versions of the various
outputs.`),Ra.forEach(e),Os=g(a),w(U.$$.fragment,a),this.h()},h(){_(t,"name","hf:doc:metadata"),_(t,"content",JSON.stringify(ut)),_(o,"id","parallelism-and-batch-jobs"),_(o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),_(o,"href","#parallelism-and-batch-jobs"),_(s,"class","relative group"),_(P,"id","streaming"),_(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),_(P,"href","#streaming"),_(v,"class","relative group"),_(L,"id","dataset"),_(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),_(L,"href","#dataset"),_(T,"class","relative group"),_(B,"href","https://huggingface.co/docs/datasets/"),_(B,"rel","nofollow"),_(z,"href","https://huggingface.co/datasets"),_(z,"rel","nofollow")},m(a,r){l(document.head,t),u(a,n,r),u(a,s,r),l(s,o),l(o,d),b(K,d,null),l(s,Hs),l(s,ss),l(ss,Bs),u(a,fs,r),u(a,R,r),l(R,zs),u(a,ds,r),u(a,W,r),l(W,Cs),u(a,ms,r),u(a,E,r),l(E,as),l(as,Rs),l(E,Ws),l(E,ts),l(ts,Ys),u(a,gs,r),u(a,v,r),l(v,P),l(P,es),b(M,es,null),l(v,Fs),l(v,ns),l(ns,Gs),u(a,js,r),u(a,O,r),l(O,Xs),l(O,ls),l(ls,Qs),l(O,Vs),u(a,_s,r),u(a,Y,r),l(Y,Zs),u(a,ys,r),b(A,a,r),u(a,ws,r),u(a,F,r),l(F,sa),u(a,bs,r),u(a,G,r),l(G,aa),u(a,qs,r),u(a,I,r),l(I,ta),l(I,os),l(os,ea),l(I,na),u(a,$s,r),u(a,S,r),l(S,la),l(S,rs),l(rs,oa),l(S,ra),u(a,ks,r),u(a,N,r),l(N,ps),l(ps,pa),l(N,ia),l(N,J),l(J,ca),l(J,is),l(is,ua),l(J,ha),u(a,vs,r),u(a,T,r),l(T,L),l(L,cs),b(H,cs,null),l(T,fa),l(T,us),l(us,da),u(a,Ts,r),u(a,x,r),l(x,ma),l(x,B),l(B,ga),l(x,ja),u(a,Es,r),u(a,D,r),l(D,_a),l(D,z),l(z,ya),l(D,wa),u(a,Ps,r),u(a,X,r),l(X,ba),u(a,Os,r),b(U,a,r),As=!0},p(a,[r]){const C={};r&2&&(C.$$scope={dirty:r,ctx:a}),A.$set(C);const hs={};r&2&&(hs.$$scope={dirty:r,ctx:a}),U.$set(hs)},i(a){As||(q(K.$$.fragment,a),q(M.$$.fragment,a),q(A.$$.fragment,a),q(H.$$.fragment,a),q(U.$$.fragment,a),As=!0)},o(a){$(K.$$.fragment,a),$(M.$$.fragment,a),$(A.$$.fragment,a),$(H.$$.fragment,a),$(U.$$.fragment,a),As=!1},d(a){e(t),a&&e(n),a&&e(s),k(K),a&&e(fs),a&&e(R),a&&e(ds),a&&e(W),a&&e(ms),a&&e(E),a&&e(gs),a&&e(v),k(M),a&&e(js),a&&e(O),a&&e(_s),a&&e(Y),a&&e(ys),k(A,a),a&&e(ws),a&&e(F),a&&e(bs),a&&e(G),a&&e(qs),a&&e(I),a&&e($s),a&&e(S),a&&e(ks),a&&e(N),a&&e(vs),a&&e(T),k(H),a&&e(Ts),a&&e(x),a&&e(Es),a&&e(D),a&&e(Ps),a&&e(X),a&&e(Os),k(U,a)}}}const ut={local:"parallelism-and-batch-jobs",sections:[{local:"streaming",title:"Streaming"},{local:"dataset",title:"Dataset"}],title:"Parallelism and batch jobs"};function ht(j){return Qa(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class gt extends Ya{constructor(t){super();Fa(this,t,ht,ct,Ga,{})}}export{gt as default,ut as metadata};
