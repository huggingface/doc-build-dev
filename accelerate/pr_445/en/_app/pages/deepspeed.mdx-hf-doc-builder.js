...
state_dict = get_fp32_state_dict_from_zero_checkpoint(checkpoint_dir)`}}),Dt=new U({}),qt=new b({props:{code:"model, eval_dataloader = accelerator.prepare(model, eval_dataloader)",highlighted:"model, eval_dataloader = accelerator.prepare(model, eval_dataloader)"}}),zt=new U({}),Pt=new U({}),xt=new Vt({props:{name:"class accelerate.DeepSpeedPlugin",anchor:"accelerate.DeepSpeedPlugin",parameters:[{name:"config_file",val:": str = None"},{name:"gradient_accumulation_steps",val:": int = None"},{name:"gradient_clipping",val:": float = None"},{name:"zero_stage",val:": int = None"},{name:"is_train_batch_min",val:": str = True"},{name:"offload_optimizer_device",val:": bool = None"},{name:"offload_param_device",val:": bool = None"},{name:"zero3_init_flag",val:": bool = None"},{name:"zero3_save_16bit_model",val:": bool = None"}],source:"https://github.com/huggingface/accelerate/blob/vr_445/src/accelerate/utils/dataclasses.py#L213"}}),Ct=new Vt({props:{name:"deepspeed_config_process",anchor:"accelerate.DeepSpeedPlugin.deepspeed_config_process",parameters:[{name:"prefix",val:" = ''"},{name:"mismatches",val:" = None"},{name:"config",val:" = None"},{name:"must_match",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/accelerate/blob/vr_445/src/accelerate/utils/dataclasses.py#L344"}}),Rt=new Vt({props:{name:"class accelerate.utils.DummyOptim",anchor:"accelerate.utils.DummyOptim",parameters:[{name:"params",val:""},{name:"lr",val:" = 0.001"},{name:"weight_decay",val:" = 0"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"accelerate.utils.DummyOptim.lr",description:`<strong>lr</strong> (float) &#x2014;
...
**kwargs &#x2014;
Other arguments.`,name:"warmup_num_steps"}],source:"https://github.com/huggingface/accelerate/blob/vr_445/src/accelerate/utils/deepspeed.py#L109"}}),At=new Vt({props:{name:"class accelerate.utils.DeepSpeedEngineWrapper",anchor:"accelerate.utils.DeepSpeedEngineWrapper",parameters:[{name:"engine",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedEngineWrapper.engine",description:"<strong>engine</strong> (deepspeed.runtime.engine.DeepSpeedEngine) &#x2014; deepspeed engine to wrap",name:"engine"}],source:"https://github.com/huggingface/accelerate/blob/vr_445/src/accelerate/utils/deepspeed.py#L20"}}),Zt=new Vt({props:{name:"class accelerate.utils.DeepSpeedOptimizerWrapper",anchor:"accelerate.utils.DeepSpeedOptimizerWrapper",parameters:[{name:"optimizer",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedOptimizerWrapper.optimizer",description:`<strong>optimizer</strong> (<code>torch.optim.optimizer.Optimizer</code>) &#x2014;
The optimizer to wrap.`,name:"optimizer"}],source:"https://github.com/huggingface/accelerate/blob/vr_445/src/accelerate/utils/deepspeed.py#L45"}}),Tt=new Vt({props:{name:"class accelerate.utils.DeepSpeedSchedulerWrapper",anchor:"accelerate.utils.DeepSpeedSchedulerWrapper",parameters:[{name:"scheduler",val:""},{name:"optimizers",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedSchedulerWrapper.scheduler",description:`<strong>scheduler</strong> (<code>torch.optim.lr_scheduler.LambdaLR</code>) &#x2014;
The scheduler to wrap.`,name:"scheduler"},{anchor:"accelerate.utils.DeepSpeedSchedulerWrapper.optimizers",description:"<strong>optimizers</strong> (one or a list of <code>torch.optim.Optimizer</code>) &#x2014;",name:"optimizers"}],source:"https://github.com/huggingface/accelerate/blob/vr_445/src/accelerate/utils/deepspeed.py#L69"}}),Nt=new U({}),{c(){M=a("meta"),gn=c(),F=a("h1"),ue=a("a"),Es=a("span"),h(Ne.$$.fragment),jl=c(),Ss=a("span"),bl=l("DeepSpeed"),wn=c(),G=a("p"),Le=a("a"),yl=l("DeepSpeed"),$l=l(" implements everything described in the "),Ue=a("a"),El=l("ZeRO paper"),Sl=l(". Currently it provides full support for:"),vn=c(),y=a("ol"),Ds=a("li"),Dl=l("Optimizer state partitioning (ZeRO stage 1)"),ql=c(),qs=a("li"),zl=l("Gradient partitioning (ZeRO stage 2)"),kl=c(),zs=a("li"),Ol=l("Parameter partitioning (ZeRO stage 3)"),Pl=c(),ks=a("li"),xl=l("Custom mixed precision training handling"),Cl=c(),Os=a("li"),Rl=l("A range of fast CUDA-extension-based optimizers"),Il=c(),Ps=a("li"),Al=l("ZeRO-Offload to CPU and Disk/NVMe"),jn=c(),I=a("p"),Zl=l("ZeRO-Offload has its own dedicated paper: "),Me=a("a"),Tl=l("ZeRO-Offload: Democratizing Billion-Scale Model Training"),Nl=l(". And NVMe-support is described in the paper "),Fe=a("a"),Ll=l(`ZeRO-Infinity: Breaking the GPU
