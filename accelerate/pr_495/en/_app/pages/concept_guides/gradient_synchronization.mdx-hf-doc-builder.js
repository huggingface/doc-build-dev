import{S as Oa,i as Ga,s as Ia,e as n,k as c,w as P,t as o,M as Ba,c as l,d as a,m as h,a as s,x as D,h as r,b as p,G as t,g as d,y as A,L as Na,q as x,o as T,B as j,v as La}from"../../chunks/vendor-hf-doc-builder.js";import{I as et}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{C as De}from"../../chunks/CodeBlock-hf-doc-builder.js";function Ha(ta){let _,Ae,v,S,oe,L,tt,re,at,xe,k,z,ne,H,ot,le,rt,Te,C,nt,se,lt,st,je,m,it,ie,dt,ct,de,ht,pt,ce,ut,mt,Se,U,ze,O,ft,Q,wt,yt,Ce,q,Oe,$,G,he,M,bt,pe,gt,Ge,f,_t,ue,vt,kt,me,$t,Et,Ie,V,Pt,Be,u,Dt,fe,At,xt,we,Tt,jt,ye,St,zt,be,Ct,Ot,Ne,E,I,ge,Y,Gt,_e,It,Le,w,Bt,ve,Nt,Lt,J,ke,Ht,Ut,He,y,qt,$e,Mt,Yt,Ee,Jt,Rt,Ue,R,qe,b,Ft,Pe,Kt,Qt,W,Vt,Wt,Me,F,Ye,B,Xt,X,Zt,ea,Je,K,Re;return L=new et({}),H=new et({}),U=new De({props:{code:`import torch.nn as nn
...
This happens when the model is wrapped with `),ce=n("code"),ut=o("DistributedDataParallel"),mt=o(":"),Se=c(),P(U.$$.fragment),ze=c(),O=n("p"),ft=o("In \u{1F917} Accelerate this conversion happens automatically when calling "),Q=n("a"),wt=o("Accelerator.prepare()"),yt=o(" and passing in your model."),Ce=c(),P(q.$$.fragment),Oe=c(),$=n("h2"),G=n("a"),he=n("span"),P(M.$$.fragment),bt=c(),pe=n("span"),gt=o("The slowdown in gradient accumulation"),Ge=c(),f=n("p"),_t=o("You now understand that PyTorch adds hooks to the "),ue=n("code"),vt=o("forward"),kt=o(" and "),me=n("code"),$t=o("backward"),Et=o(` method of your PyTorch model when
training in a distributed setup. But how does this risk slowing down your code?`),Ie=c(),V=n("p"),Pt=o(`In DDP (distributed data parallel), the specific order in which processes are performed and ran are expected
...
gradient accumulation, you accumulate `),we=n("code"),Tt=o("n"),jt=o(" losses and skip "),ye=n("code"),St=o(".backward()"),zt=o(" until "),be=n("code"),Ct=o("n"),Ot=o(` batches have been reached. This
...
PyTorch cannot automagically tell when you need to do this, but they do provide a tool to help through the `),J=n("a"),ke=n("code"),Ht=o("no_sync"),Ut=o(` context manager
that is added to your model after converting it to DDP.`),He=c(),y=n("p"),qt=o("Under this context manager, PyTorch will skip synchronizing the gradients when "),$e=n("code"),Mt=o(".backward()"),Yt=o(" is called, and the first call to "),Ee=n("code"),Jt=o(".backward()"),Rt=o(` outside this
context manager will trigger the synchronization. See an example below:`),Ue=c(),P(R.$$.fragment),qe=c(),b=n("p"),Ft=o(`In \u{1F917} Accelerate to make this an API that can be called no matter the training device (though it may not do anything if you are not in a distributed system!),
...
This happens when the model is wrapped with `),ce=l(N,"CODE",{});var ha=s(ce);ut=r(ha,"DistributedDataParallel"),ha.forEach(a),mt=r(N,":"),N.forEach(a),Se=h(e),D(U.$$.fragment,e),ze=h(e),O=l(e,"P",{});var Ve=s(O);ft=r(Ve,"In \u{1F917} Accelerate this conversion happens automatically when calling "),Q=l(Ve,"A",{href:!0});var pa=s(Q);wt=r(pa,"Accelerator.prepare()"),pa.forEach(a),yt=r(Ve," and passing in your model."),Ve.forEach(a),Ce=h(e),D(q.$$.fragment,e),Oe=h(e),$=l(e,"H2",{class:!0});var We=s($);G=l(We,"A",{id:!0,class:!0,href:!0});var ua=s(G);he=l(ua,"SPAN",{});var ma=s(he);D(M.$$.fragment,ma),ma.forEach(a),ua.forEach(a),bt=h(We),pe=l(We,"SPAN",{});var fa=s(pe);gt=r(fa,"The slowdown in gradient accumulation"),fa.forEach(a),We.forEach(a),Ge=h(e),f=l(e,"P",{});var Z=s(f);_t=r(Z,"You now understand that PyTorch adds hooks to the "),ue=l(Z,"CODE",{});var wa=s(ue);vt=r(wa,"forward"),wa.forEach(a),kt=r(Z," and "),me=l(Z,"CODE",{});var ya=s(me);$t=r(ya,"backward"),ya.forEach(a),Et=r(Z,` method of your PyTorch model when
training in a distributed setup. But how does this risk slowing down your code?`),Z.forEach(a),Ie=h(e),V=l(e,"P",{});var ba=s(V);Pt=r(ba,`In DDP (distributed data parallel), the specific order in which processes are performed and ran are expected
...
need to have updated their gradients, collated, and updated again before moving onto the next batch of data. But when performing
gradient accumulation, you accumulate `),we=l(g,"CODE",{});var _a=s(we);Tt=r(_a,"n"),_a.forEach(a),jt=r(g," losses and skip "),ye=l(g,"CODE",{});var va=s(ye);St=r(va,".backward()"),va.forEach(a),zt=r(g," until "),be=l(g,"CODE",{});var ka=s(be);Ct=r(ka,"n"),ka.forEach(a),Ot=r(g,` batches have been reached. This
can cause a significant slowdown since all the processes need to communicate with them more times than needed. How
...
PyTorch cannot automagically tell when you need to do this, but they do provide a tool to help through the `),J=l(ee,"A",{href:!0,rel:!0});var Aa=s(J);ke=l(Aa,"CODE",{});var xa=s(ke);Ht=r(xa,"no_sync"),xa.forEach(a),Aa.forEach(a),Ut=r(ee,` context manager
that is added to your model after converting it to DDP.`),ee.forEach(a),He=h(e),y=l(e,"P",{});var te=s(y);qt=r(te,"Under this context manager, PyTorch will skip synchronizing the gradients when "),$e=l(te,"CODE",{});var Ta=s($e);Mt=r(Ta,".backward()"),Ta.forEach(a),Yt=r(te," is called, and the first call to "),Ee=l(te,"CODE",{});var ja=s(Ee);Jt=r(ja,".backward()"),ja.forEach(a),Rt=r(te,` outside this
context manager will trigger the synchronization. See an example below:`),te.forEach(a),Ue=h(e),D(R.$$.fragment,e),qe=h(e),b=l(e,"P",{});var ae=s(b);Ft=r(ae,`In \u{1F917} Accelerate to make this an API that can be called no matter the training device (though it may not do anything if you are not in a distributed system!),
...
gradient accumulation API:`),Ze.forEach(a),Je=h(e),D(K.$$.fragment,e),this.h()},h(){p(_,"name","hf:doc:metadata"),p(_,"content",JSON.stringify(Ua)),p(S,"id","gradient-synchronization"),p(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(S,"href","#gradient-synchronization"),p(v,"class","relative group"),p(z,"id","background-into-pytorch-distributed"),p(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(z,"href","#background-into-pytorch-distributed"),p(k,"class","relative group"),p(Q,"href","/docs/accelerate/pr_495/en/package_reference/accelerator#accelerate.Accelerator.prepare"),p(G,"id","the-slowdown-in-gradient-accumulation"),p(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(G,"href","#the-slowdown-in-gradient-accumulation"),p($,"class","relative group"),p(I,"id","solving-the-slowdown-problem"),p(I,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(I,"href","#solving-the-slowdown-problem"),p(E,"class","relative group"),p(J,"href","https://pytorch.org/docs/stable/generated/torch.nn.parallel.DistributedDataParallel.html#torch.nn.parallel.DistributedDataParallel.no_sync"),p(J,"rel","nofollow"),p(W,"href","/docs/accelerate/pr_495/en/package_reference/accelerator#accelerate.Accelerator.no_sync"),p(X,"href","/docs/accelerate/pr_495/en/package_reference/accelerator#accelerate.Accelerator.accumulate")},m(e,i){t(document.head,_),d(e,Ae,i),d(e,v,i),t(v,S),t(S,oe),A(L,oe,null),t(v,tt),t(v,re),t(re,at),d(e,xe,i),d(e,k,i),t(k,z),t(z,ne),A(H,ne,null),t(k,ot),t(k,le),t(le,rt),d(e,Te,i),d(e,C,i),t(C,nt),t(C,se),t(se,lt),t(C,st),d(e,je,i),d(e,m,i),t(m,it),t(m,ie),t(ie,dt),t(m,ct),t(m,de),t(de,ht),t(m,pt),t(m,ce),t(ce,ut),t(m,mt),d(e,Se,i),A(U,e,i),d(e,ze,i),d(e,O,i),t(O,ft),t(O,Q),t(Q,wt),t(O,yt),d(e,Ce,i),A(q,e,i),d(e,Oe,i),d(e,$,i),t($,G),t(G,he),A(M,he,null),t($,bt),t($,pe),t(pe,gt),d(e,Ge,i),d(e,f,i),t(f,_t),t(f,ue),t(ue,vt),t(f,kt),t(f,me),t(me,$t),t(f,Et),d(e,Ie,i),d(e,V,i),t(V,Pt),d(e,Be,i),d(e,u,i),t(u,Dt),t(u,fe),t(fe,At),t(u,xt),t(u,we),t(we,Tt),t(u,jt),t(u,ye),t(ye,St),t(u,zt),t(u,be),t(be,Ct),t(u,Ot),d(e,Ne,i),d(e,E,i),t(E,I),t(I,ge),A(Y,ge,null),t(E,Gt),t(E,_e),t(_e,It),d(e,Le,i),d(e,w,i),t(w,Bt),t(w,ve),t(ve,Nt),t(w,Lt),t(w,J),t(J,ke),t(ke,Ht),t(w,Ut),d(e,He,i),d(e,y,i),t(y,qt),t(y,$e),t($e,Mt),t(y,Yt),t(y,Ee),t(Ee,Jt),t(y,Rt),d(e,Ue,i),A(R,e,i),d(e,qe,i),d(e,b,i),t(b,Ft),t(b,Pe),t(Pe,Kt),t(b,Qt),t(b,W),t(W,Vt),t(b,Wt),d(e,Me,i),A(F,e,i),d(e,Ye,i),d(e,B,i),t(B,Xt),t(B,X),t(X,Zt),t(B,ea),d(e,Je,i),A(K,e,i),Re=!0},p:Na,i(e){Re||(x(L.$$.fragment,e),x(H.$$.fragment,e),x(U.$$.fragment,e),x(q.$$.fragment,e),x(M.$$.fragment,e),x(Y.$$.fragment,e),x(R.$$.fragment,e),x(F.$$.fragment,e),x(K.$$.fragment,e),Re=!0)},o(e){T(L.$$.fragment,e),T(H.$$.fragment,e),T(U.$$.fragment,e),T(q.$$.fragment,e),T(M.$$.fragment,e),T(Y.$$.fragment,e),T(R.$$.fragment,e),T(F.$$.fragment,e),T(K.$$.fragment,e),Re=!1},d(e){a(_),e&&a(Ae),e&&a(v),j(L),e&&a(xe),e&&a(k),j(H),e&&a(Te),e&&a(C),e&&a(je),e&&a(m),e&&a(Se),j(U,e),e&&a(ze),e&&a(O),e&&a(Ce),j(q,e),e&&a(Oe),e&&a($),j(M),e&&a(Ge),e&&a(f),e&&a(Ie),e&&a(V),e&&a(Be),e&&a(u),e&&a(Ne),e&&a(E),j(Y),e&&a(Le),e&&a(w),e&&a(He),e&&a(y),e&&a(Ue),j(R,e),e&&a(qe),e&&a(b),e&&a(Me),j(F,e),e&&a(Ye),e&&a(B),e&&a(Je),j(K,e)}}}const Ua={local:"gradient-synchronization",sections:[{local:"background-into-pytorch-distributed",title:"Background into PyTorch distributed"},{local:"the-slowdown-in-gradient-accumulation",title:"The slowdown in gradient accumulation"},{local:"solving-the-slowdown-problem",title:"Solving the slowdown problem"}],title:"Gradient Synchronization"};function qa(ta){return La(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ra extends Oa{constructor(_){super();Ga(this,_,qa,Ha,Ia,{})}}export{Ra as default,Ua as metadata};
