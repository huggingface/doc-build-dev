...
This happens when the model is wrapped with `),ce=n("code"),ut=o("DistributedDataParallel"),mt=o(":"),Se=c(),P(H.$$.fragment),ze=c(),O=n("p"),ft=o("In \u{1F917} Accelerate this conversion happens automaticaly when calling "),Q=n("a"),wt=o("Accelerator.prepare()"),yt=o(" and passing in your model."),Ce=c(),P(q.$$.fragment),Oe=c(),$=n("h2"),G=n("a"),he=n("span"),P(M.$$.fragment),bt=c(),pe=n("span"),gt=o("The slowdown in gradient accumulation"),Ge=c(),f=n("p"),_t=o("You now understand that PyTorch adds hooks to the "),ue=n("code"),vt=o("forward"),kt=o(" and "),me=n("code"),$t=o("backward"),Et=o(` method of your PyTorch model when
...
`),Pe=n("code"),Kt=o("ddp_model.no_sync"),Qt=o(" gets replaced with "),W=n("a"),Vt=o("Accelerator.no_sync()"),Wt=o(" and operates the same way:"),Me=c(),P(F.$$.fragment),Ye=c(),B=n("p"),Xt=o("As you may expect, the "),X=n("a"),Zt=o("Accelerator.accumulate()"),ea=o(` function wraps around this coditional check by keeping track of the current batch number, leaving you with the final
...
This happens when the model is wrapped with `),ce=l(N,"CODE",{});var ha=s(ce);ut=r(ha,"DistributedDataParallel"),ha.forEach(a),mt=r(N,":"),N.forEach(a),Se=h(e),D(H.$$.fragment,e),ze=h(e),O=l(e,"P",{});var Ve=s(O);ft=r(Ve,"In \u{1F917} Accelerate this conversion happens automaticaly when calling "),Q=l(Ve,"A",{href:!0});var pa=s(Q);wt=r(pa,"Accelerator.prepare()"),pa.forEach(a),yt=r(Ve," and passing in your model."),Ve.forEach(a),Ce=h(e),D(q.$$.fragment,e),Oe=h(e),$=l(e,"H2",{class:!0});var We=s($);G=l(We,"A",{id:!0,class:!0,href:!0});var ua=s(G);he=l(ua,"SPAN",{});var ma=s(he);D(M.$$.fragment,ma),ma.forEach(a),ua.forEach(a),bt=h(We),pe=l(We,"SPAN",{});var fa=s(pe);gt=r(fa,"The slowdown in gradient accumulation"),fa.forEach(a),We.forEach(a),Ge=h(e),f=l(e,"P",{});var Z=s(f);_t=r(Z,"You now understand that PyTorch adds hooks to the "),ue=l(Z,"CODE",{});var wa=s(ue);vt=r(wa,"forward"),wa.forEach(a),kt=r(Z," and "),me=l(Z,"CODE",{});var ya=s(me);$t=r(ya,"backward"),ya.forEach(a),Et=r(Z,` method of your PyTorch model when
