import{S as Ot,i as Rt,s as Jt,e as s,k as p,w as _,t as l,M as Ut,c as i,d as t,m as u,a as n,x as w,h as c,b as d,G as r,g as o,y as $,q as v,o as b,B as y,v as Kt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Mt}from"../../chunks/Tip-hf-doc-builder.js";import{I as Ye}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{C as oe}from"../../chunks/CodeBlock-hf-doc-builder.js";function Qt(R){let h;return{c(){h=l("In its current state, this code is not going to perform gradient accumulation efficiently due to a process called gradient synchronization. Read more about that in the Concepts tutorial!")},l(m){h=c(m,"In its current state, this code is not going to perform gradient accumulation efficiently due to a process called gradient synchronization. Read more about that in the Concepts tutorial!")},m(m,g){o(m,h,g)},d(m){m&&t(h)}}}function Vt(R){let h;return{c(){h=l("Currently this method only works with non-streaming datasets (`DataLoaders` that have a length). While support for this is being worked on, you can check out the Gradient Synchronization concept tutorial to see how to do this yourself!")},l(m){h=c(m,"Currently this method only works with non-streaming datasets (`DataLoaders` that have a length). While support for this is being worked on, you can check out the Gradient Synchronization concept tutorial to see how to do this yourself!")},m(m,g){o(m,h,g)},d(m){m&&t(h)}}}function Xt(R){let h,m,g,E,se,L,Me,ie,Oe,ge,J,Re,_e,U,Je,we,K,Ue,$e,Q,Ke,ve,G,be,A,x,ne,I,Qe,le,Ve,ye,V,Xe,ke,B,Ae,P,je,j,S,ce,D,Ze,pe,et,ze,f,tt,ue,at,rt,X,ot,st,de,it,nt,Z,lt,ct,Ee,F,xe,T,pt,ee,ut,dt,Pe,H,Se,te,ht,Te,W,Ce,C,mt,ae,ft,gt,Ne,N,qe,z,q,he,Y,_t,me,wt,Le,re,$t,Ge,M,Ie;return L=new Ye({}),G=new oe({props:{code:`device = 'cuda'
model.to(device)
...
<span class="hljs-keyword">for</span> index, batch <span class="hljs-built_in">in</span> enumerate(training_dataloader):
    ...
    <span class="hljs-keyword">if</span> (index+<span class="hljs-number">1</span>) % gradient_accumulation_steps == <span class="hljs-number">0</span>:
        ...
        scheduler.<span class="hljs-built_in">step</span>()`}}),I=new Ye({}),B=new oe({props:{code:`+from accelerate import Accelerator
...
<span class="hljs-addition">+    accelerator.backward(loss)</span>
    if (index+1) % gradient_accumulation_steps == 0:
        optimizer.step()
        scheduler.step()`}}),P=new Mt({props:{warning:!0,$$slots:{default:[Qt]},$$scope:{ctx:R}}}),D=new Ye({}),F=new oe({props:{code:`from accelerate import Accelerator
-accelerator = Accelerator()
...
optimizer.step()
scheduler.step()`}}),N=new Mt({props:{warning:!0,$$slots:{default:[Vt]},$$scope:{ctx:R}}}),Y=new Ye({}),M=new oe({props:{code:`for batch in training_dataloader:
    with accelerator.accumulate(model):
        optimizer.zero_grad()
        inputs, targets = batch
        outputs = model(inputs)
    ...
    <span class="hljs-keyword">with</span> accelerator.accumulate(model):
        ...
        accelerator.backward(loss)
        optimizer.step()
        scheduler.step()`}}),{c(){h=s("meta"),m=p(),g=s("h1"),E=s("a"),se=s("span"),_(L.$$.fragment),Me=p(),ie=s("span"),Oe=l("Performing gradient accumulation with \u{1F917} Accelerate"),ge=p(),J=s("p"),Re=l(`Gradient accumulation is a technique where you can train on bigger batch sizes than
...
You just wrap it around the entire training part of our code:`),Pe=p(),_(H.$$.fragment),Se=p(),te=s("p"),ht=l("You can remove all the special checks for the step number and the loss adjustment:"),Te=p(),_(W.$$.fragment),Ce=p(),C=s("p"),mt=l("As you can see the "),ae=s("a"),ft=l("Accelerator"),gt=l(" is able to keep track of the batch number you are on and it will automatically know whether to step through the prepared optimizer and how to adjust the loss."),Ne=p(),_(N.$$.fragment),qe=p(),z=s("h2"),q=s("a"),he=s("span"),_(Y.$$.fragment),_t=p(),me=s("span"),wt=l("The finished code"),Le=p(),re=s("p"),$t=l("Below is the finished implementation for performing gradient accumulation with \u{1F917} Accelerate"),Ge=p(),_(M.$$.fragment),this.h()},l(e){const a=Ut('[data-svelte="svelte-1phssyn"]',document.head);h=i(a,"META",{name:!0,content:!0}),a.forEach(t),m=u(e),g=i(e,"H1",{class:!0});var O=n(g);E=i(O,"A",{id:!0,class:!0,href:!0});var fe=n(E);se=i(fe,"SPAN",{});var vt=n(se);w(L.$$.fragment,vt),vt.forEach(t),fe.forEach(t),Me=u(O),ie=i(O,"SPAN",{});var bt=n(ie);Oe=c(bt,"Performing gradient accumulation with \u{1F917} Accelerate"),bt.forEach(t),O.forEach(t),ge=u(e),J=i(e,"P",{});var yt=n(J);Re=c(yt,`Gradient accumulation is a technique where you can train on bigger batch sizes than
your machine would normally be able to fit into memory. This is done by accumulating gradients over
