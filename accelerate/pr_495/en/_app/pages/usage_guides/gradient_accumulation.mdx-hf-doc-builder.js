...
<span class="hljs-keyword">for</span> index, batch <span class="hljs-keyword">in</span> <span class="hljs-built_in">enumerate</span>(training_dataloader):
    ...
    <span class="hljs-keyword">if</span> (index+<span class="hljs-number">1</span>) % gradient_accumulation_steps == <span class="hljs-number">0</span>:
        optimizer.step()
        scheduler.step()`}}),j=new bt({props:{warning:!0,$$slots:{default:[Et]},$$scope:{ctx:W}}}),G=new et({}),I=new xe({props:{code:`from accelerate import Accelerator
-accelerator = Accelerator()
...
<span class="hljs-addition">+   scheduler.step()</span>`}}),T=new bt({props:{warning:!0,$$slots:{default:[xt]},$$scope:{ctx:W}}}),{c(){d=s("meta"),h=u(),g=s("h1"),E=s("a"),Q=s("span"),b(q.$$.fragment),je=u(),V=s("span"),Pe=l("Performing gradient accumulation with \u{1F917} Accelerate"),ie=u(),H=s("p"),Ce=l(`Gradient accumulation is a technique where you can train on bigger batch sizes than
...
which can total to adding just one line of code!`),ce=u(),B=s("p"),qe=l("This example will use a very simplistic PyTorch training loop that performs gradient accumulation every two batches:"),ue=u(),b(L.$$.fragment),pe=u(),w=s("h2"),x=s("a"),X=s("span"),b(N.$$.fragment),Le=u(),Y=s("span"),Ne=l("Converting it to \u{1F917} Accelerate"),de=u(),J=s("p"),De=l("First the code shown earlier will be converted to utilize \u{1F917} Accelerate without the special gradient accumulation helper:"),he=u(),b(D.$$.fragment),me=u(),b(j.$$.fragment),fe=u(),$=s("h2"),P=s("a"),Z=s("span"),b(G.$$.fragment),Ge=u(),ee=s("span"),Ie=l("Letting \u{1F917} Accelerate handle gradient accumulation"),ge=u(),f=s("p"),Oe=l("All that is left now is to let \u{1F917} Accelerate handle the gradient accumulation for us. To do so you should pass in a "),te=s("code"),Fe=l("gradient_accumulation_steps"),We=l(" parameter to "),ae=s("code"),He=l("Accelerator"),Me=l(`, dictating the number
of steps to perform before each call to `),re=s("code"),Re=l("step()"),Be=l(" and "),oe=s("code"),Je=l("backward()"),Ue=l(":"),_e=u(),b(I.$$.fragment),we=u(),C=s("p"),Ke=l("From here you can use the "),U=s("a"),Qe=l("Accelerator.accumulate()"),Ve=l(" context manager from inside your training loop to automatically perform the gradient accumulation for you!"),$e=u(),b(O.$$.fragment),be=u(),S=s("p"),Xe=l("As you can see the "),K=s("a"),Ye=l("Accelerator"),Ze=l(` is able to keep track of the batch number you are on and it will automatically know whether to actually perform the backward pass
and step through the prepared schedulers and optimizers.`),ve=u(),b(T.$$.fragment),this.h()},l(e){const a=At('[data-svelte="svelte-1phssyn"]',document.head);d=i(a,"META",{name:!0,content:!0}),a.forEach(t),h=p(e),g=i(e,"H1",{class:!0});var F=n(g);E=i(F,"A",{id:!0,class:!0,href:!0});var se=n(E);Q=i(se,"SPAN",{});var tt=n(Q);v(q.$$.fragment,tt),tt.forEach(t),se.forEach(t),je=p(F),V=i(F,"SPAN",{});var at=n(V);Pe=c(at,"Performing gradient accumulation with \u{1F917} Accelerate"),at.forEach(t),F.forEach(t),ie=p(e),H=i(e,"P",{});var rt=n(H);Ce=c(rt,`Gradient accumulation is a technique where you can train on bigger batch sizes than
your machine would normally be able to fit into memory. This is done by accumulating gradients over
