import{S as qh,i as $h,s as Sh,e as o,k as c,w as d,t as a,M as kh,c as l,d as t,m as u,a as p,x as f,h as n,b as h,$ as Dh,G as s,g as r,y as _,L as Oh,q as m,o as g,B as w,v as zh}from"../../chunks/vendor-hf-doc-builder.js";import{I as ae}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{C as y}from"../../chunks/CodeBlock-hf-doc-builder.js";function Ph(Kr){let L,Ga,U,ne,pt,Pe,Io,it,Zo,Ha,M,xe,To,No,Ce,Lo,Uo,Wa,b,rt,Mo,Fo,ct,Go,Ho,ut,Wo,Bo,ht,Vo,Yo,dt,Jo,Ko,ft,Qo,Ba,R,Xo,Re,el,sl,Ae,tl,al,Va,Cs,nl,Ya,Rs,ol,Ja,oe,ll,Ie,pl,il,Ka,le,F,rl,_t,cl,ul,mt,hl,dl,fl,Ze,_l,gt,ml,gl,Qa,G,pe,wt,Te,wl,vt,vl,Xa,As,jl,en,Is,ie,yl,Ne,bl,El,Zs,Qr,sn,re,ql,Le,$l,Sl,tn,ce,kl,jt,Dl,Ol,an,ue,zl,yt,Pl,xl,nn,he,Cl,bt,Rl,Al,on,de,Il,Et,Zl,Tl,ln,fe,Nl,qt,Ll,Ul,pn,Ts,Ml,rn,Ns,Fl,cn,Ls,Ue,Gl,Us,Hl,Wl,un,H,_e,$t,Me,Bl,St,Vl,hn,W,kt,Yl,Jl,Fe,Kl,Ql,dn,A,Xl,Dt,ep,sp,Ot,tp,ap,fn,B,me,zt,Ge,np,Pt,op,_n,He,mn,Ms,lp,gn,We,wn,ge,pp,xt,ip,rp,vn,Fs,Ct,cp,jn,Be,yn,Ve,bn,Gs,Rt,up,En,Ye,qn,Je,$n,we,hp,At,dp,fp,Sn,Ke,kn,Hs,_p,Dn,V,ve,It,Qe,mp,Zt,gp,On,Xe,zn,Ws,wp,Pn,es,xn,je,vp,Tt,jp,yp,Cn,Bs,Nt,bp,Rn,ss,An,ye,Ep,Lt,qp,$p,In,ts,Zn,as,Tn,Vs,Ut,Sp,Nn,ns,Ln,be,kp,Mt,Dp,Op,Un,os,Mn,ls,Fn,Ys,Ft,zp,Gn,Ee,E,Y,Pp,ps,xp,Cp,is,Rp,Ap,Ip,q,Zp,Gt,Tp,Np,Ht,Lp,Up,Wt,Mp,Fp,Bt,Gp,Hp,Vt,Wp,Bp,Vp,rs,Yp,k,Jp,Yt,Kp,Qp,Jt,Xp,ei,Kt,si,ti,Qt,ai,ni,oi,J,li,Xt,pi,ii,ea,ri,ci,ui,cs,hi,sa,di,fi,_i,ta,$,mi,aa,gi,wi,na,vi,ji,oa,yi,bi,la,Ei,qi,pa,$i,Si,Hn,K,qe,ia,us,ki,ra,Di,Wn,$e,ca,ua,Oi,zi,v,hs,Pi,ha,xi,Ci,Ri,S,Ai,da,Ii,Zi,fa,Ti,Ni,_a,Li,Ui,ma,Mi,Fi,ga,Gi,Hi,Wi,ds,Bi,Q,Vi,wa,Yi,Ji,va,Ki,Qi,Xi,fs,er,X,sr,ja,tr,ar,nr,or,lr,_s,pr,ya,ir,rr,ms,cr,ba,ur,hr,gs,dr,Ea,fr,Bn,ee,Se,qa,ws,_r,$a,mr,Vn,vs,Yn,se,ke,Sa,js,gr,ka,wr,Jn,I,Da,vr,jr,ys,yr,Oa,br,Er,qr,bs,$r,za,Sr,kr,Kn,te,De,Pa,Es,Dr,xa,Or,Qn,Oe,zr,qs,Pr,xr,Xn,D,Ca,$s,Cr,Rr,Ra,Ss,Ar,Ir,Aa,ks,Zr,Tr,Ia,Ds,Nr,eo,Js,Lr,so,Z,Za,Os,Ur,Mr,Ta,zs,Fr,Gr,Na,Ps,Hr,to,T,Wr,La,Br,Vr,xs,Yr,Jr,ao;return Pe=new ae({}),Te=new ae({}),Me=new ae({}),Ge=new ae({}),He=new y({props:{code:"accelerate config",highlighted:"accelerate config"}}),We=new y({props:{code:"accelerate launch my_script.py --args_to_my_script",highlighted:"accelerate launch my_script.py --args_to_my_script"}}),Be=new y({props:{code:`compute_environment: LOCAL_MACHINE
deepspeed_config:
...
User need not change any code and is good for those who are fine with most of the default settings of DeepSpeed.`),Qa=c(),G=o("h2"),pe=o("a"),wt=o("span"),d(Te.$$.fragment),wl=c(),vt=o("span"),vl=a("What is integrated?"),Xa=c(),As=o("p"),jl=a("Training:"),en=c(),Is=o("ol"),ie=o("li"),yl=a(`DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 as well as CPU/Disk offload of optimizer states, gradients and parameters.
Below is a short description of Data Parallelism using ZeRO - Zero Redundancy Optimizer along with diagram from this `),Ne=o("a"),bl=a("blog post"),El=c(),Zs=o("img"),sn=c(),re=o("p"),ql=a("(Source: "),Le=o("a"),$l=a("link"),Sl=a(")"),tn=c(),ce=o("p"),kl=a("a. "),jt=o("strong"),Dl=a("Stage 1"),Ol=a(" : Shards optimizer states across data parallel workers/GPUs"),an=c(),ue=o("p"),zl=a("b. "),yt=o("strong"),Pl=a("Stage 2"),xl=a(" : Shards optimizer states + gradients across data parallel workers/GPUs"),nn=c(),he=o("p"),Cl=a("c. "),bt=o("strong"),Rl=a("Stage 3"),Al=a(": Shards optimizer states + gradients + model parameters across data parallel workers/GPUs"),on=c(),de=o("p"),Il=a("d. "),Et=o("strong"),Zl=a("Optimizer Offload"),Tl=a(": Offloads the gradients + optimizer states to CPU/Disk building on top of ZERO Stage 2"),ln=c(),fe=o("p"),Nl=a("e. "),qt=o("strong"),Ll=a("Param Offload"),Ul=a(": Offloads the model parameters to CPU/Disk building on top of ZERO Stage 3"),pn=c(),Ts=o("u"),Ml=a("Note"),rn=a(`: With respect to Disk Offload, the disk should be an NVME for decent speed but it technically work on any Disk
`),Ns=o("p"),Fl=a("Inference:"),cn=c(),Ls=o("ol"),Ue=o("li"),Gl=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Us=o("a"),Hl=a("deepspeed-zero-inference"),Wl=a("."),un=c(),H=o("h2"),_e=o("a"),$t=o("span"),d(Me.$$.fragment),Bl=c(),St=o("span"),Vl=a("How it works?"),hn=c(),W=o("p"),kt=o("strong"),Yl=a("Pre-Requisites"),Jl=a(": Install DeepSpeed version >=0.6.5. Please refer to the "),Fe=o("a"),Kl=a("DeepSpeed Insallation details"),Ql=a(`
...
On your machine(s) just run:
	...
	`),d(He.$$.fragment),mn=c(),Ms=o("p"),lp=a(`and answer the questions asked. It will ask whether you want to use a config file for DeepSpeed to which you should answer no. Then answer the following questions to generate a basic DeepSpeed config.
This will generate a config file that will be used automatically to properly set the
default options when doing`),gn=c(),d(We.$$.fragment),wn=c(),ge=o("p"),pp=a("For instance, here is how you would run the NLP example "),xt=o("code"),ip=a("examples/nlp_example.py"),rp=a(" (from the root of the repo) with DeepSpeed Plugin:"),vn=c(),Fs=o("p"),Ct=o("strong"),cp=a("ZeRO Stage-2 DeepSpeed Plugin Example"),jn=c(),d(Be.$$.fragment),yn=c(),d(Ve.$$.fragment),bn=c(),Gs=o("p"),Rt=o("strong"),up=a("ZeRO Stage-3 with CPU Offload DeepSpeed Plugin Example"),En=c(),d(Ye.$$.fragment),qn=c(),d(Je.$$.fragment),$n=c(),we=o("p"),hp=a("Currently, "),At=o("code"),dp=a("Accelerate"),fp=a(" supports following config through the CLI:"),Sn=c(),d(Ke.$$.fragment),kn=c(),Hs=o("p"),_p=a("To be able to tweak more options, you will need to use a DeepSpeed config file."),Dn=c(),V=o("h3"),ve=o("a"),It=o("span"),d(Qe.$$.fragment),mp=c(),Zt=o("span"),gp=a("DeepSpeed Config File"),On=a(`

On your machine(s) just run:

	`),d(Xe.$$.fragment),zn=c(),Ws=o("p"),wp=a(`and answer the questions asked. It will ask whether you want to use a config file for deepspeed to which you answer yes
and provide the path to the deepspeed config file.
This will generate a config file that will be used automatically to properly set the
default options when doing`),Pn=c(),d(es.$$.fragment),xn=c(),je=o("p"),vp=a("For instance, here is how you would run the NLP example "),Tt=o("code"),jp=a("examples/by_feature/deepspeed_with_config_support.py"),yp=a(" (from the root of the repo) with DeepSpeed Config File:"),Cn=c(),Bs=o("p"),Nt=o("strong"),bp=a("ZeRO Stage-2 DeepSpeed Config File Example"),Rn=c(),d(ss.$$.fragment),An=c(),ye=o("p"),Ep=a("with the contents of "),Lt=o("code"),qp=a("zero_stage2_config.json"),$p=a(" being:"),In=c(),d(ts.$$.fragment),Zn=c(),d(as.$$.fragment),Tn=c(),Vs=o("p"),Ut=o("strong"),Sp=a("ZeRO Stage-3 with CPU offload DeepSpeed Config File Example"),Nn=c(),d(ns.$$.fragment),Ln=c(),be=o("p"),kp=a("with the contents of "),Mt=o("code"),Dp=a("zero_stage3_offload_config.json"),Op=a(" being:"),Un=c(),d(os.$$.fragment),Mn=c(),d(ls.$$.fragment),Fn=c(),Ys=o("p"),Ft=o("strong"),zp=a("Important code changes when using DeepSpeed Config File"),Gn=c(),Ee=o("ol"),E=o("li"),Y=o("p"),Pp=a(`DeepSpeed Optimizers and Schedulers. For more information on these,
...
This will result in an error because one can only use DS Scheduler when using DS Optim.`),_i=c(),ta=o("li"),$=o("p"),mi=a("Notice the "),aa=o("code"),gi=a("auto"),wi=a(" values in the above example DeepSpeed config files. These are automatically handled by "),na=o("code"),vi=a("prepare"),ji=a(` method
...
One can use this script to do offline consolidation.`),nr=o("br"),or=a(`
It requires no configuration files or GPUs. Here is an example of its usage:`),lr=c(),d(_s.$$.fragment),pr=c(),ya=o("p"),ir=a("To get 32bit model for saving/inference, one can do the following:"),rr=c(),d(ms.$$.fragment),cr=c(),ba=o("p"),ur=a("If only interested in state_dict, one can do the following:"),hr=c(),d(gs.$$.fragment),dr=c(),Ea=o("p"),fr=a("Note that all these functions require ~2x memory (general RAM) of the size of the final checkpoint."),Bn=c(),ee=o("h2"),Se=o("a"),qa=o("span"),d(ws.$$.fragment),_r=c(),$a=o("span"),mr=a("ZeRO Inference"),Vn=a(`
...
With accelerate integration, one has to just prepare model and dataloader as shown below:
	...
	`),d(vs.$$.fragment),Yn=c(),se=o("h2"),ke=o("a"),Sa=o("span"),d(js.$$.fragment),gr=c(),ka=o("span"),wr=a("Few caveats to be aware of"),Jn=c(),I=o("ol"),Da=o("li"),vr=a("Current integration doesn\u2019t support Pipeline Parallelism of DeepSpeed."),jr=c(),ys=o("li"),yr=a("Current integration doesn\u2019t support "),Oa=o("code"),br=a("mpu"),Er=a(", limiting the tensor parallelism which is supported in Megatron-LM."),qr=c(),bs=o("li"),$r=a("Current integration doesn\u2019t support multiple models for a given "),za=o("code"),Sr=a("accelerator"),kr=a(" object."),Kn=c(),te=o("h2"),De=o("a"),Pa=o("span"),d(Es.$$.fragment),Dr=c(),xa=o("span"),Or=a("DeepSpeed Resources"),Qn=c(),Oe=o("p"),zr=a("The documentation for the internals related to deepspeed can be found "),qs=o("a"),Pr=a("here"),xr=a("."),Xn=c(),D=o("ul"),Ca=o("li"),$s=o("a"),Cr=a("Project\u2019s github"),Rr=c(),Ra=o("li"),Ss=o("a"),Ar=a("Usage docs"),Ir=c(),Aa=o("li"),ks=o("a"),Zr=a("API docs"),Tr=c(),Ia=o("li"),Ds=o("a"),Nr=a("Blog posts"),eo=c(),Js=o("p"),Lr=a("Papers:"),so=c(),Z=o("ul"),Za=o("li"),Os=o("a"),Ur=a("ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),Mr=c(),Ta=o("li"),zs=o("a"),Fr=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),Gr=c(),Na=o("li"),Ps=o("a"),Hr=a("ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),to=c(),T=o("p"),Wr=a("Finally, please, remember that, \u{1F917} "),La=o("code"),Br=a("Accelerate"),Vr=a(` only integrates DeepSpeed, therefore if you
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),xs=o("a"),Yr=a("DeepSpeed GitHub"),Jr=a("."),this.h()},l(e){const i=kh('[data-svelte="svelte-1phssyn"]',document.head);L=l(i,"META",{name:!0,content:!0}),i.forEach(t),Ga=u(e),U=l(e,"H1",{class:!0});var no=p(U);ne=l(no,"A",{id:!0,class:!0,href:!0});var Xr=p(ne);pt=l(Xr,"SPAN",{});var ec=p(pt);f(Pe.$$.fragment,ec),ec.forEach(t),Xr.forEach(t),Io=u(no),it=l(no,"SPAN",{});var sc=p(it);Zo=n(sc,"DeepSpeed"),sc.forEach(t),no.forEach(t),Ha=u(e),M=l(e,"P",{});var Ua=p(M);xe=l(Ua,"A",{href:!0,rel:!0});var tc=p(xe);To=n(tc,"DeepSpeed"),tc.forEach(t),No=n(Ua," implements everything described in the "),Ce=l(Ua,"A",{href:!0,rel:!0});var ac=p(Ce);Lo=n(ac,"ZeRO paper"),ac.forEach(t),Uo=n(Ua,". Currently it provides full support for:"),Ua.forEach(t),Wa=u(e),b=l(e,"OL",{});var O=p(b);rt=l(O,"LI",{});var nc=p(rt);Mo=n(nc,"Optimizer state partitioning (ZeRO stage 1)"),nc.forEach(t),Fo=u(O),ct=l(O,"LI",{});var oc=p(ct);Go=n(oc,"Gradient partitioning (ZeRO stage 2)"),oc.forEach(t),Ho=u(O),ut=l(O,"LI",{});var lc=p(ut);Wo=n(lc,"Parameter partitioning (ZeRO stage 3)"),lc.forEach(t),Bo=u(O),ht=l(O,"LI",{});var pc=p(ht);Vo=n(pc,"Custom mixed precision training handling"),pc.forEach(t),Yo=u(O),dt=l(O,"LI",{});var ic=p(dt);Jo=n(ic,"A range of fast CUDA-extension-based optimizers"),ic.forEach(t),Ko=u(O),ft=l(O,"LI",{});var rc=p(ft);Qo=n(rc,"ZeRO-Offload to CPU and Disk/NVMe"),rc.forEach(t),O.forEach(t),Ba=u(e),R=l(e,"P",{});var Ks=p(R);Xo=n(Ks,"ZeRO-Offload has its own dedicated paper: "),Re=l(Ks,"A",{href:!0,rel:!0});var cc=p(Re);el=n(cc,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),cc.forEach(t),sl=n(Ks,". And NVMe-support is described in the paper "),Ae=l(Ks,"A",{href:!0,rel:!0});var uc=p(Ae);tl=n(uc,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),uc.forEach(t),al=n(Ks,"."),Ks.forEach(t),Va=u(e),Cs=l(e,"P",{});var hc=p(Cs);nl=n(hc,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),hc.forEach(t),Ya=u(e),Rs=l(e,"P",{});var dc=p(Rs);ol=n(dc,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
...
On your machine(s) just run:
	...
	`),f(He.$$.fragment,e),mn=u(e),Ms=l(e,"P",{});var Gc=p(Ms);lp=n(Gc,`and answer the questions asked. It will ask whether you want to use a config file for DeepSpeed to which you should answer no. Then answer the following questions to generate a basic DeepSpeed config.
This will generate a config file that will be used automatically to properly set the
default options when doing`),Gc.forEach(t),gn=u(e),f(We.$$.fragment,e),wn=u(e),ge=l(e,"P",{});var vo=p(ge);pp=n(vo,"For instance, here is how you would run the NLP example "),xt=l(vo,"CODE",{});var Hc=p(xt);ip=n(Hc,"examples/nlp_example.py"),Hc.forEach(t),rp=n(vo," (from the root of the repo) with DeepSpeed Plugin:"),vo.forEach(t),vn=u(e),Fs=l(e,"P",{});var Wc=p(Fs);Ct=l(Wc,"STRONG",{});var Bc=p(Ct);cp=n(Bc,"ZeRO Stage-2 DeepSpeed Plugin Example"),Bc.forEach(t),Wc.forEach(t),jn=u(e),f(Be.$$.fragment,e),yn=u(e),f(Ve.$$.fragment,e),bn=u(e),Gs=l(e,"P",{});var Vc=p(Gs);Rt=l(Vc,"STRONG",{});var Yc=p(Rt);up=n(Yc,"ZeRO Stage-3 with CPU Offload DeepSpeed Plugin Example"),Yc.forEach(t),Vc.forEach(t),En=u(e),f(Ye.$$.fragment,e),qn=u(e),f(Je.$$.fragment,e),$n=u(e),we=l(e,"P",{});var jo=p(we);hp=n(jo,"Currently, "),At=l(jo,"CODE",{});var Jc=p(At);dp=n(Jc,"Accelerate"),Jc.forEach(t),fp=n(jo," supports following config through the CLI:"),jo.forEach(t),Sn=u(e),f(Ke.$$.fragment,e),kn=u(e),Hs=l(e,"P",{});var Kc=p(Hs);_p=n(Kc,"To be able to tweak more options, you will need to use a DeepSpeed config file."),Kc.forEach(t),Dn=u(e),V=l(e,"H3",{class:!0});var yo=p(V);ve=l(yo,"A",{id:!0,class:!0,href:!0});var Qc=p(ve);It=l(Qc,"SPAN",{});var Xc=p(It);f(Qe.$$.fragment,Xc),Xc.forEach(t),Qc.forEach(t),mp=u(yo),Zt=l(yo,"SPAN",{});var eu=p(Zt);gp=n(eu,"DeepSpeed Config File"),eu.forEach(t),yo.forEach(t),On=n(e,`

On your machine(s) just run:

	`),f(Xe.$$.fragment,e),zn=u(e),Ws=l(e,"P",{});var su=p(Ws);wp=n(su,`and answer the questions asked. It will ask whether you want to use a config file for deepspeed to which you answer yes
and provide the path to the deepspeed config file.
This will generate a config file that will be used automatically to properly set the
default options when doing`),su.forEach(t),Pn=u(e),f(es.$$.fragment,e),xn=u(e),je=l(e,"P",{});var bo=p(je);vp=n(bo,"For instance, here is how you would run the NLP example "),Tt=l(bo,"CODE",{});var tu=p(Tt);jp=n(tu,"examples/by_feature/deepspeed_with_config_support.py"),tu.forEach(t),yp=n(bo," (from the root of the repo) with DeepSpeed Config File:"),bo.forEach(t),Cn=u(e),Bs=l(e,"P",{});var au=p(Bs);Nt=l(au,"STRONG",{});var nu=p(Nt);bp=n(nu,"ZeRO Stage-2 DeepSpeed Config File Example"),nu.forEach(t),au.forEach(t),Rn=u(e),f(ss.$$.fragment,e),An=u(e),ye=l(e,"P",{});var Eo=p(ye);Ep=n(Eo,"with the contents of "),Lt=l(Eo,"CODE",{});var ou=p(Lt);qp=n(ou,"zero_stage2_config.json"),ou.forEach(t),$p=n(Eo," being:"),Eo.forEach(t),In=u(e),f(ts.$$.fragment,e),Zn=u(e),f(as.$$.fragment,e),Tn=u(e),Vs=l(e,"P",{});var lu=p(Vs);Ut=l(lu,"STRONG",{});var pu=p(Ut);Sp=n(pu,"ZeRO Stage-3 with CPU offload DeepSpeed Config File Example"),pu.forEach(t),lu.forEach(t),Nn=u(e),f(ns.$$.fragment,e),Ln=u(e),be=l(e,"P",{});var qo=p(be);kp=n(qo,"with the contents of "),Mt=l(qo,"CODE",{});var iu=p(Mt);Dp=n(iu,"zero_stage3_offload_config.json"),iu.forEach(t),Op=n(qo," being:"),qo.forEach(t),Un=u(e),f(os.$$.fragment,e),Mn=u(e),f(ls.$$.fragment,e),Fn=u(e),Ys=l(e,"P",{});var ru=p(Ys);Ft=l(ru,"STRONG",{});var cu=p(Ft);zp=n(cu,"Important code changes when using DeepSpeed Config File"),cu.forEach(t),ru.forEach(t),Gn=u(e),Ee=l(e,"OL",{});var $o=p(Ee);E=l($o,"LI",{});var z=p(E);Y=l(z,"P",{});var et=p(Y);Pp=n(et,`DeepSpeed Optimizers and Schedulers. For more information on these,
...
One can use this script to do offline consolidation.`),nr=l(at,"BR",{}),or=n(at,`
It requires no configuration files or GPUs. Here is an example of its usage:`),at.forEach(t),lr=u(j),f(_s.$$.fragment,j),pr=u(j),ya=l(j,"P",{});var Hu=p(ya);ir=n(Hu,"To get 32bit model for saving/inference, one can do the following:"),Hu.forEach(t),rr=u(j),f(ms.$$.fragment,j),cr=u(j),ba=l(j,"P",{});var Wu=p(ba);ur=n(Wu,"If only interested in state_dict, one can do the following:"),Wu.forEach(t),hr=u(j),f(gs.$$.fragment,j),dr=u(j),Ea=l(j,"P",{});var Bu=p(Ea);fr=n(Bu,"Note that all these functions require ~2x memory (general RAM) of the size of the final checkpoint."),Bu.forEach(t),j.forEach(t),Do.forEach(t),Bn=u(e),ee=l(e,"H2",{class:!0});var zo=p(ee);Se=l(zo,"A",{id:!0,class:!0,href:!0});var Vu=p(Se);qa=l(Vu,"SPAN",{});var Yu=p(qa);f(ws.$$.fragment,Yu),Yu.forEach(t),Vu.forEach(t),_r=u(zo),$a=l(zo,"SPAN",{});var Ju=p($a);mr=n(Ju,"ZeRO Inference"),Ju.forEach(t),zo.forEach(t),Vn=n(e,`

DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. 
It uses the same ZeRO protocol as training, but it doesn't use an optimizer and a lr scheduler and only stage 3 is relevant.
With accelerate integration, one has to just prepare model and dataloader as shown below:

	`),f(vs.$$.fragment,e),Yn=u(e),se=l(e,"H2",{class:!0});var Po=p(se);ke=l(Po,"A",{id:!0,class:!0,href:!0});var Ku=p(ke);Sa=l(Ku,"SPAN",{});var Qu=p(Sa);f(js.$$.fragment,Qu),Qu.forEach(t),Ku.forEach(t),gr=u(Po),ka=l(Po,"SPAN",{});var Xu=p(ka);wr=n(Xu,"Few caveats to be aware of"),Xu.forEach(t),Po.forEach(t),Jn=u(e),I=l(e,"OL",{});var nt=p(I);Da=l(nt,"LI",{});var eh=p(Da);vr=n(eh,"Current integration doesn\u2019t support Pipeline Parallelism of DeepSpeed."),eh.forEach(t),jr=u(nt),ys=l(nt,"LI",{});var xo=p(ys);yr=n(xo,"Current integration doesn\u2019t support "),Oa=l(xo,"CODE",{});var sh=p(Oa);br=n(sh,"mpu"),sh.forEach(t),Er=n(xo,", limiting the tensor parallelism which is supported in Megatron-LM."),xo.forEach(t),qr=u(nt),bs=l(nt,"LI",{});var Co=p(bs);$r=n(Co,"Current integration doesn\u2019t support multiple models for a given "),za=l(Co,"CODE",{});var th=p(za);Sr=n(th,"accelerator"),th.forEach(t),kr=n(Co," object."),Co.forEach(t),nt.forEach(t),Kn=u(e),te=l(e,"H2",{class:!0});var Ro=p(te);De=l(Ro,"A",{id:!0,class:!0,href:!0});var ah=p(De);Pa=l(ah,"SPAN",{});var nh=p(Pa);f(Es.$$.fragment,nh),nh.forEach(t),ah.forEach(t),Dr=u(Ro),xa=l(Ro,"SPAN",{});var oh=p(xa);Or=n(oh,"DeepSpeed Resources"),oh.forEach(t),Ro.forEach(t),Qn=u(e),Oe=l(e,"P",{});var Ao=p(Oe);zr=n(Ao,"The documentation for the internals related to deepspeed can be found "),qs=l(Ao,"A",{href:!0,rel:!0});var lh=p(qs);Pr=n(lh,"here"),lh.forEach(t),xr=n(Ao,"."),Ao.forEach(t),Xn=u(e),D=l(e,"UL",{});var ze=p(D);Ca=l(ze,"LI",{});var ph=p(Ca);$s=l(ph,"A",{href:!0,rel:!0});var ih=p($s);Cr=n(ih,"Project\u2019s github"),ih.forEach(t),ph.forEach(t),Rr=u(ze),Ra=l(ze,"LI",{});var rh=p(Ra);Ss=l(rh,"A",{href:!0,rel:!0});var ch=p(Ss);Ar=n(ch,"Usage docs"),ch.forEach(t),rh.forEach(t),Ir=u(ze),Aa=l(ze,"LI",{});var uh=p(Aa);ks=l(uh,"A",{href:!0,rel:!0});var hh=p(ks);Zr=n(hh,"API docs"),hh.forEach(t),uh.forEach(t),Tr=u(ze),Ia=l(ze,"LI",{});var dh=p(Ia);Ds=l(dh,"A",{href:!0,rel:!0});var fh=p(Ds);Nr=n(fh,"Blog posts"),fh.forEach(t),dh.forEach(t),ze.forEach(t),eo=u(e),Js=l(e,"P",{});var _h=p(Js);Lr=n(_h,"Papers:"),_h.forEach(t),so=u(e),Z=l(e,"UL",{});var ot=p(Z);Za=l(ot,"LI",{});var mh=p(Za);Os=l(mh,"A",{href:!0,rel:!0});var gh=p(Os);Ur=n(gh,"ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),gh.forEach(t),mh.forEach(t),Mr=u(ot),Ta=l(ot,"LI",{});var wh=p(Ta);zs=l(wh,"A",{href:!0,rel:!0});var vh=p(zs);Fr=n(vh,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),vh.forEach(t),wh.forEach(t),Gr=u(ot),Na=l(ot,"LI",{});var jh=p(Na);Ps=l(jh,"A",{href:!0,rel:!0});var yh=p(Ps);Hr=n(yh,"ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),yh.forEach(t),jh.forEach(t),ot.forEach(t),to=u(e),T=l(e,"P",{});var lt=p(T);Wr=n(lt,"Finally, please, remember that, \u{1F917} "),La=l(lt,"CODE",{});var bh=p(La);Br=n(bh,"Accelerate"),bh.forEach(t),Vr=n(lt,` only integrates DeepSpeed, therefore if you
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),xs=l(lt,"A",{href:!0,rel:!0});var Eh=p(xs);Yr=n(Eh,"DeepSpeed GitHub"),Eh.forEach(t),Jr=n(lt,"."),lt.forEach(t),this.h()},h(){h(L,"name","hf:doc:metadata"),h(L,"content",JSON.stringify(xh)),h(ne,"id","deepspeed"),h(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ne,"href","#deepspeed"),h(U,"class","relative group"),h(xe,"href","https://github.com/microsoft/DeepSpeed"),h(xe,"rel","nofollow"),h(Ce,"href","https://arxiv.org/abs/1910.02054"),h(Ce,"rel","nofollow"),h(Re,"href","https://arxiv.org/abs/2101.06840"),h(Re,"rel","nofollow"),h(Ae,"href","https://arxiv.org/abs/2104.07857"),h(Ae,"rel","nofollow"),h(Ie,"href","https://github.com/microsoft/DeepSpeed"),h(Ie,"rel","nofollow"),h(pe,"id","what-is-integrated"),h(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(pe,"href","#what-is-integrated"),h(G,"class","relative group"),h(Ne,"href","https://www.microsoft.com/en-us/research/blog/zero-deepspeed-new-system-optimizations-enable-training-models-with-over-100-billion-parameters/"),h(Ne,"rel","nofollow"),Dh(Zs.src,Qr="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/parallelism-zero.png")||h(Zs,"src",Qr),h(Zs,"alt","ZeRO Data Parallelism"),h(Le,"href","https://www.microsoft.com/en-us/research/blog/zero-deepspeed-new-system-optimizations-enable-training-models-with-over-100-billion-parameters/"),h(Le,"rel","nofollow"),h(Us,"href","#deepspeed-zero-inference"),h(_e,"id","how-it-works"),h(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(_e,"href","#how-it-works"),h(H,"class","relative group"),h(Fe,"href","https://github.com/microsoft/DeepSpeed#installation"),h(Fe,"rel","nofollow"),h(me,"id","accelerate-deepspeed-plugin"),h(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(me,"href","#accelerate-deepspeed-plugin"),h(B,"class","relative group"),h(ve,"id","deepspeed-config-file"),h(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ve,"href","#deepspeed-config-file"),h(V,"class","relative group"),h(ps,"href","https://deepspeed.readthedocs.io/en/latest/optimizers.html"),h(ps,"rel","nofollow"),h(is,"href","https://deepspeed.readthedocs.io/en/latest/schedulers.html"),h(is,"rel","nofollow"),h(qe,"id","saving-and-loading"),h(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(qe,"href","#saving-and-loading"),h(K,"class","relative group"),h(Se,"id","zero-inference"),h(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Se,"href","#zero-inference"),h(ee,"class","relative group"),h(ke,"id","few-caveats-to-be-aware-of"),h(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ke,"href","#few-caveats-to-be-aware-of"),h(se,"class","relative group"),h(De,"id","deepspeed-resources"),h(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(De,"href","#deepspeed-resources"),h(te,"class","relative group"),h(qs,"href","https://huggingface.co/docs/accelerate/package_reference/deepspeed"),h(qs,"rel","nofollow"),h($s,"href","https://github.com/microsoft/deepspeed"),h($s,"rel","nofollow"),h(Ss,"href","https://www.deepspeed.ai/getting-started/"),h(Ss,"rel","nofollow"),h(ks,"href","https://deepspeed.readthedocs.io/en/latest/index.html"),h(ks,"rel","nofollow"),h(Ds,"href","https://www.microsoft.com/en-us/research/search/?q=deepspeed"),h(Ds,"rel","nofollow"),h(Os,"href","https://arxiv.org/abs/1910.02054"),h(Os,"rel","nofollow"),h(zs,"href","https://arxiv.org/abs/2101.06840"),h(zs,"rel","nofollow"),h(Ps,"href","https://arxiv.org/abs/2104.07857"),h(Ps,"rel","nofollow"),h(xs,"href","https://github.com/microsoft/DeepSpeed/issues"),h(xs,"rel","nofollow")},m(e,i){s(document.head,L),r(e,Ga,i),r(e,U,i),s(U,ne),s(ne,pt),_(Pe,pt,null),s(U,Io),s(U,it),s(it,Zo),r(e,Ha,i),r(e,M,i),s(M,xe),s(xe,To),s(M,No),s(M,Ce),s(Ce,Lo),s(M,Uo),r(e,Wa,i),r(e,b,i),s(b,rt),s(rt,Mo),s(b,Fo),s(b,ct),s(ct,Go),s(b,Ho),s(b,ut),s(ut,Wo),s(b,Bo),s(b,ht),s(ht,Vo),s(b,Yo),s(b,dt),s(dt,Jo),s(b,Ko),s(b,ft),s(ft,Qo),r(e,Ba,i),r(e,R,i),s(R,Xo),s(R,Re),s(Re,el),s(R,sl),s(R,Ae),s(Ae,tl),s(R,al),r(e,Va,i),r(e,Cs,i),s(Cs,nl),r(e,Ya,i),r(e,Rs,i),s(Rs,ol),r(e,Ja,i),r(e,oe,i),s(oe,ll),s(oe,Ie),s(Ie,pl),s(oe,il),r(e,Ka,i),r(e,le,i),s(le,F),s(F,rl),s(F,_t),s(_t,cl),s(F,ul),s(F,mt),s(mt,hl),s(F,dl),s(le,fl),s(le,Ze),s(Ze,_l),s(Ze,gt),s(gt,ml),s(Ze,gl),r(e,Qa,i),r(e,G,i),s(G,pe),s(pe,wt),_(Te,wt,null),s(G,wl),s(G,vt),s(vt,vl),r(e,Xa,i),r(e,As,i),s(As,jl),r(e,en,i),r(e,Is,i),s(Is,ie),s(ie,yl),s(ie,Ne),s(Ne,bl),s(ie,El),s(ie,Zs),r(e,sn,i),r(e,re,i),s(re,ql),s(re,Le),s(Le,$l),s(re,Sl),r(e,tn,i),r(e,ce,i),s(ce,kl),s(ce,jt),s(jt,Dl),s(ce,Ol),r(e,an,i),r(e,ue,i),s(ue,zl),s(ue,yt),s(yt,Pl),s(ue,xl),r(e,nn,i),r(e,he,i),s(he,Cl),s(he,bt),s(bt,Rl),s(he,Al),r(e,on,i),r(e,de,i),s(de,Il),s(de,Et),s(Et,Zl),s(de,Tl),r(e,ln,i),r(e,fe,i),s(fe,Nl),s(fe,qt),s(qt,Ll),s(fe,Ul),r(e,pn,i),r(e,Ts,i),s(Ts,Ml),r(e,rn,i),r(e,Ns,i),s(Ns,Fl),r(e,cn,i),r(e,Ls,i),s(Ls,Ue),s(Ue,Gl),s(Ue,Us),s(Us,Hl),s(Ue,Wl),r(e,un,i),r(e,H,i),s(H,_e),s(_e,$t),_(Me,$t,null),s(H,Bl),s(H,St),s(St,Vl),r(e,hn,i),r(e,W,i),s(W,kt),s(kt,Yl),s(W,Jl),s(W,Fe),s(Fe,Kl),s(W,Ql),r(e,dn,i),r(e,A,i),s(A,Xl),s(A,Dt),s(Dt,ep),s(A,sp),s(A,Ot),s(Ot,tp),s(A,ap),r(e,fn,i),r(e,B,i),s(B,me),s(me,zt),_(Ge,zt,null),s(B,np),s(B,Pt),s(Pt,op),r(e,_n,i),_(He,e,i),r(e,mn,i),r(e,Ms,i),s(Ms,lp),r(e,gn,i),_(We,e,i),r(e,wn,i),r(e,ge,i),s(ge,pp),s(ge,xt),s(xt,ip),s(ge,rp),r(e,vn,i),r(e,Fs,i),s(Fs,Ct),s(Ct,cp),r(e,jn,i),_(Be,e,i),r(e,yn,i),_(Ve,e,i),r(e,bn,i),r(e,Gs,i),s(Gs,Rt),s(Rt,up),r(e,En,i),_(Ye,e,i),r(e,qn,i),_(Je,e,i),r(e,$n,i),r(e,we,i),s(we,hp),s(we,At),s(At,dp),s(we,fp),r(e,Sn,i),_(Ke,e,i),r(e,kn,i),r(e,Hs,i),s(Hs,_p),r(e,Dn,i),r(e,V,i),s(V,ve),s(ve,It),_(Qe,It,null),s(V,mp),s(V,Zt),s(Zt,gp),r(e,On,i),_(Xe,e,i),r(e,zn,i),r(e,Ws,i),s(Ws,wp),r(e,Pn,i),_(es,e,i),r(e,xn,i),r(e,je,i),s(je,vp),s(je,Tt),s(Tt,jp),s(je,yp),r(e,Cn,i),r(e,Bs,i),s(Bs,Nt),s(Nt,bp),r(e,Rn,i),_(ss,e,i),r(e,An,i),r(e,ye,i),s(ye,Ep),s(ye,Lt),s(Lt,qp),s(ye,$p),r(e,In,i),_(ts,e,i),r(e,Zn,i),_(as,e,i),r(e,Tn,i),r(e,Vs,i),s(Vs,Ut),s(Ut,Sp),r(e,Nn,i),_(ns,e,i),r(e,Ln,i),r(e,be,i),s(be,kp),s(be,Mt),s(Mt,Dp),s(be,Op),r(e,Un,i),_(os,e,i),r(e,Mn,i),_(ls,e,i),r(e,Fn,i),r(e,Ys,i),s(Ys,Ft),s(Ft,zp),r(e,Gn,i),r(e,Ee,i),s(Ee,E),s(E,Y),s(Y,Pp),s(Y,ps),s(ps,xp),s(Y,Cp),s(Y,is),s(is,Rp),s(Y,Ap),s(E,Ip),s(E,q),s(q,Zp),s(q,Gt),s(Gt,Tp),s(q,Np),s(q,Ht),s(Ht,Lp),s(q,Up),s(q,Wt),s(Wt,Mp),s(q,Fp),s(q,Bt),s(Bt,Gp),s(q,Hp),s(q,Vt),s(Vt,Wp),s(q,Bp),s(E,Vp),_(rs,E,null),s(E,Yp),s(E,k),s(k,Jp),s(k,Yt),s(Yt,Kp),s(k,Qp),s(k,Jt),s(Jt,Xp),s(k,ei),s(k,Kt),s(Kt,si),s(k,ti),s(k,Qt),s(Qt,ai),s(k,ni),s(E,oi),s(E,J),s(J,li),s(J,Xt),s(Xt,pi),s(J,ii),s(J,ea),s(ea,ri),s(J,ci),s(E,ui),s(E,cs),s(cs,hi),s(cs,sa),s(sa,di),s(cs,fi),s(Ee,_i),s(Ee,ta),s(ta,$),s($,mi),s($,aa),s(aa,gi),s($,wi),s($,na),s(na,vi),s($,ji),s($,oa),s(oa,yi),s($,bi),s($,la),s(la,Ei),s($,qi),s($,pa),s(pa,$i),s($,Si),r(e,Hn,i),r(e,K,i),s(K,qe),s(qe,ia),_(us,ia,null),s(K,ki),s(K,ra),s(ra,Di),r(e,Wn,i),r(e,$e,i),s($e,ca),s(ca,ua),s(ua,Oi),s($e,zi),s($e,v),s(v,hs),s(hs,Pi),s(hs,ha),s(ha,xi),s(hs,Ci),s(v,Ri),s(v,S),s(S,Ai),s(S,da),s(da,Ii),s(S,Zi),s(S,fa),s(fa,Ti),s(S,Ni),s(S,_a),s(_a,Li),s(S,Ui),s(S,ma),s(ma,Mi),s(S,Fi),s(S,ga),s(ga,Gi),s(S,Hi),s(v,Wi),_(ds,v,null),s(v,Bi),s(v,Q),s(Q,Vi),s(Q,wa),s(wa,Yi),s(Q,Ji),s(Q,va),s(va,Ki),s(Q,Qi),s(v,Xi),_(fs,v,null),s(v,er),s(v,X),s(X,sr),s(X,ja),s(ja,tr),s(X,ar),s(X,nr),s(X,or),s(v,lr),_(_s,v,null),s(v,pr),s(v,ya),s(ya,ir),s(v,rr),_(ms,v,null),s(v,cr),s(v,ba),s(ba,ur),s(v,hr),_(gs,v,null),s(v,dr),s(v,Ea),s(Ea,fr),r(e,Bn,i),r(e,ee,i),s(ee,Se),s(Se,qa),_(ws,qa,null),s(ee,_r),s(ee,$a),s($a,mr),r(e,Vn,i),_(vs,e,i),r(e,Yn,i),r(e,se,i),s(se,ke),s(ke,Sa),_(js,Sa,null),s(se,gr),s(se,ka),s(ka,wr),r(e,Jn,i),r(e,I,i),s(I,Da),s(Da,vr),s(I,jr),s(I,ys),s(ys,yr),s(ys,Oa),s(Oa,br),s(ys,Er),s(I,qr),s(I,bs),s(bs,$r),s(bs,za),s(za,Sr),s(bs,kr),r(e,Kn,i),r(e,te,i),s(te,De),s(De,Pa),_(Es,Pa,null),s(te,Dr),s(te,xa),s(xa,Or),r(e,Qn,i),r(e,Oe,i),s(Oe,zr),s(Oe,qs),s(qs,Pr),s(Oe,xr),r(e,Xn,i),r(e,D,i),s(D,Ca),s(Ca,$s),s($s,Cr),s(D,Rr),s(D,Ra),s(Ra,Ss),s(Ss,Ar),s(D,Ir),s(D,Aa),s(Aa,ks),s(ks,Zr),s(D,Tr),s(D,Ia),s(Ia,Ds),s(Ds,Nr),r(e,eo,i),r(e,Js,i),s(Js,Lr),r(e,so,i),r(e,Z,i),s(Z,Za),s(Za,Os),s(Os,Ur),s(Z,Mr),s(Z,Ta),s(Ta,zs),s(zs,Fr),s(Z,Gr),s(Z,Na),s(Na,Ps),s(Ps,Hr),r(e,to,i),r(e,T,i),s(T,Wr),s(T,La),s(La,Br),s(T,Vr),s(T,xs),s(xs,Yr),s(T,Jr),ao=!0},p:Oh,i(e){ao||(m(Pe.$$.fragment,e),m(Te.$$.fragment,e),m(Me.$$.fragment,e),m(Ge.$$.fragment,e),m(He.$$.fragment,e),m(We.$$.fragment,e),m(Be.$$.fragment,e),m(Ve.$$.fragment,e),m(Ye.$$.fragment,e),m(Je.$$.fragment,e),m(Ke.$$.fragment,e),m(Qe.$$.fragment,e),m(Xe.$$.fragment,e),m(es.$$.fragment,e),m(ss.$$.fragment,e),m(ts.$$.fragment,e),m(as.$$.fragment,e),m(ns.$$.fragment,e),m(os.$$.fragment,e),m(ls.$$.fragment,e),m(rs.$$.fragment,e),m(us.$$.fragment,e),m(ds.$$.fragment,e),m(fs.$$.fragment,e),m(_s.$$.fragment,e),m(ms.$$.fragment,e),m(gs.$$.fragment,e),m(ws.$$.fragment,e),m(vs.$$.fragment,e),m(js.$$.fragment,e),m(Es.$$.fragment,e),ao=!0)},o(e){g(Pe.$$.fragment,e),g(Te.$$.fragment,e),g(Me.$$.fragment,e),g(Ge.$$.fragment,e),g(He.$$.fragment,e),g(We.$$.fragment,e),g(Be.$$.fragment,e),g(Ve.$$.fragment,e),g(Ye.$$.fragment,e),g(Je.$$.fragment,e),g(Ke.$$.fragment,e),g(Qe.$$.fragment,e),g(Xe.$$.fragment,e),g(es.$$.fragment,e),g(ss.$$.fragment,e),g(ts.$$.fragment,e),g(as.$$.fragment,e),g(ns.$$.fragment,e),g(os.$$.fragment,e),g(ls.$$.fragment,e),g(rs.$$.fragment,e),g(us.$$.fragment,e),g(ds.$$.fragment,e),g(fs.$$.fragment,e),g(_s.$$.fragment,e),g(ms.$$.fragment,e),g(gs.$$.fragment,e),g(ws.$$.fragment,e),g(vs.$$.fragment,e),g(js.$$.fragment,e),g(Es.$$.fragment,e),ao=!1},d(e){t(L),e&&t(Ga),e&&t(U),w(Pe),e&&t(Ha),e&&t(M),e&&t(Wa),e&&t(b),e&&t(Ba),e&&t(R),e&&t(Va),e&&t(Cs),e&&t(Ya),e&&t(Rs),e&&t(Ja),e&&t(oe),e&&t(Ka),e&&t(le),e&&t(Qa),e&&t(G),w(Te),e&&t(Xa),e&&t(As),e&&t(en),e&&t(Is),e&&t(sn),e&&t(re),e&&t(tn),e&&t(ce),e&&t(an),e&&t(ue),e&&t(nn),e&&t(he),e&&t(on),e&&t(de),e&&t(ln),e&&t(fe),e&&t(pn),e&&t(Ts),e&&t(rn),e&&t(Ns),e&&t(cn),e&&t(Ls),e&&t(un),e&&t(H),w(Me),e&&t(hn),e&&t(W),e&&t(dn),e&&t(A),e&&t(fn),e&&t(B),w(Ge),e&&t(_n),w(He,e),e&&t(mn),e&&t(Ms),e&&t(gn),w(We,e),e&&t(wn),e&&t(ge),e&&t(vn),e&&t(Fs),e&&t(jn),w(Be,e),e&&t(yn),w(Ve,e),e&&t(bn),e&&t(Gs),e&&t(En),w(Ye,e),e&&t(qn),w(Je,e),e&&t($n),e&&t(we),e&&t(Sn),w(Ke,e),e&&t(kn),e&&t(Hs),e&&t(Dn),e&&t(V),w(Qe),e&&t(On),w(Xe,e),e&&t(zn),e&&t(Ws),e&&t(Pn),w(es,e),e&&t(xn),e&&t(je),e&&t(Cn),e&&t(Bs),e&&t(Rn),w(ss,e),e&&t(An),e&&t(ye),e&&t(In),w(ts,e),e&&t(Zn),w(as,e),e&&t(Tn),e&&t(Vs),e&&t(Nn),w(ns,e),e&&t(Ln),e&&t(be),e&&t(Un),w(os,e),e&&t(Mn),w(ls,e),e&&t(Fn),e&&t(Ys),e&&t(Gn),e&&t(Ee),w(rs),e&&t(Hn),e&&t(K),w(us),e&&t(Wn),e&&t($e),w(ds),w(fs),w(_s),w(ms),w(gs),e&&t(Bn),e&&t(ee),w(ws),e&&t(Vn),w(vs,e),e&&t(Yn),e&&t(se),w(js),e&&t(Jn),e&&t(I),e&&t(Kn),e&&t(te),w(Es),e&&t(Qn),e&&t(Oe),e&&t(Xn),e&&t(D),e&&t(eo),e&&t(Js),e&&t(so),e&&t(Z),e&&t(to),e&&t(T)}}}const xh={local:"deepspeed",sections:[{local:"what-is-integrated",title:"What is integrated?"},{local:"how-it-works",sections:[{local:"accelerate-deepspeed-plugin",title:"Accelerate DeepSpeed Plugin"},{local:"deepspeed-config-file",title:"DeepSpeed Config File"}],title:"How it works?"},{local:"saving-and-loading",title:"Saving and loading"},{local:"zero-inference",title:"ZeRO Inference"},{local:"few-caveats-to-be-aware-of",title:"Few caveats to be aware of "},{local:"deepspeed-resources",title:"DeepSpeed Resources"}],title:"DeepSpeed "};function Ch(Kr){return zh(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Zh extends qh{constructor(L){super();$h(this,L,Ch,Ph,Sh,{})}}export{Zh as default,xh as metadata};
