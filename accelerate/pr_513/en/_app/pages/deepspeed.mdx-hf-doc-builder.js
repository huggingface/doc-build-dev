import{S as Ph,i as xh,s as Ch,e as a,k as c,w as h,t as l,M as Rh,c as n,d as s,m as u,a as o,x as f,h as p,b as d,$ as Ih,G as t,g as i,y as m,L as Ah,q as _,o as g,B as w,v as Zh}from"../chunks/vendor-hf-doc-builder.js";import{D as Vt}from"../chunks/Docstring-hf-doc-builder.js";import{C as b}from"../chunks/CodeBlock-hf-doc-builder.js";import{I as U}from"../chunks/IconCopyLink-hf-doc-builder.js";function Th(Yc){let M,gn,F,ue,Es,Ne,jl,Ss,bl,wn,G,Le,yl,$l,Ue,El,Sl,vn,y,Ds,Dl,ql,qs,zl,kl,zs,Ol,Pl,ks,xl,Cl,Os,Rl,Il,Ps,Al,jn,I,Zl,Me,Tl,Nl,Fe,Ll,Ul,bn,Yt,Ml,yn,Jt,Fl,$n,de,Gl,Ge,Wl,Hl,En,he,W,Bl,xs,Vl,Yl,Cs,Jl,Kl,Ql,We,Xl,Rs,ep,tp,Sn,H,fe,Is,He,sp,As,ap,Dn,Kt,np,qn,Qt,me,op,Be,lp,pp,Xt,Jc,zn,_e,rp,Ve,ip,cp,kn,ge,up,Zs,dp,hp,On,we,fp,Ts,mp,_p,Pn,ve,gp,Ns,wp,vp,xn,je,jp,Ls,bp,yp,Cn,be,$p,Us,Ep,Sp,Rn,es,Dp,In,ts,qp,An,ss,Ye,zp,as,kp,Op,Zn,B,ye,Ms,Je,Pp,Fs,xp,Tn,V,Gs,Cp,Rp,Ke,Ip,Ap,Nn,A,Zp,Ws,Tp,Np,Hs,Lp,Up,Ln,Y,$e,Bs,Qe,Mp,Vs,Fp,Un,Xe,Mn,ns,Gp,Fn,et,Gn,Ee,Wp,Ys,Hp,Bp,Wn,os,Js,Vp,Hn,tt,Bn,st,Vn,ls,Ks,Yp,Yn,at,Jn,nt,Kn,Se,Jp,Qs,Kp,Qp,Qn,ot,Xn,ps,Xp,eo,J,De,Xs,lt,er,ea,tr,to,pt,so,rs,sr,ao,rt,no,qe,ar,ta,nr,or,oo,is,sa,lr,lo,it,po,ze,pr,aa,rr,ir,ro,ct,io,ut,co,cs,na,cr,uo,dt,ho,ke,ur,oa,dr,hr,fo,ht,mo,ft,_o,us,la,fr,go,Oe,$,K,mr,mt,_r,gr,_t,wr,vr,jr,E,br,pa,yr,$r,ra,Er,Sr,ia,Dr,qr,ca,zr,kr,ua,Or,Pr,xr,gt,Cr,q,Rr,da,Ir,Ar,ha,Zr,Tr,fa,Nr,Lr,ma,Ur,Mr,Fr,Q,Gr,_a,Wr,Hr,ga,Br,Vr,Yr,wt,Jr,wa,Kr,Qr,Xr,va,S,ei,ja,ti,si,ba,ai,ni,ya,oi,li,$a,pi,ri,Ea,ii,ci,wo,X,Pe,Sa,vt,ui,Da,di,vo,xe,qa,za,hi,fi,v,jt,mi,ka,_i,gi,wi,D,vi,Oa,ji,bi,Pa,yi,$i,xa,Ei,Si,Ca,Di,qi,Ra,zi,ki,Oi,bt,Pi,ee,xi,Ia,Ci,Ri,Aa,Ii,Ai,Zi,yt,Ti,te,Ni,Za,Li,Ui,Mi,Fi,Gi,$t,Wi,Ta,Hi,Bi,Et,Vi,Na,Yi,Ji,St,Ki,La,Qi,jo,se,Ce,Ua,Dt,Xi,Ma,ec,bo,qt,yo,ae,Re,Fa,zt,tc,Ga,sc,$o,Z,Wa,ac,nc,kt,oc,Ha,lc,pc,rc,Ot,ic,Ba,cc,uc,Eo,ne,Ie,Va,Pt,dc,Ya,hc,So,R,xt,fc,Ja,mc,_c,Ae,Ct,gc,Ka,wc,Do,oe,Rt,vc,Qa,jc,qo,le,It,bc,Xa,yc,zo,pe,At,$c,en,Ec,ko,re,Zt,Sc,tn,Dc,Oo,ie,Tt,qc,sn,zc,Po,ce,Ze,an,Nt,kc,nn,Oc,xo,z,on,Lt,Pc,xc,ln,Ut,Cc,Rc,pn,Mt,Ic,Ac,rn,Ft,Zc,Co,ds,Tc,Ro,T,cn,Gt,Nc,Lc,un,Wt,Uc,Mc,dn,Ht,Fc,Io,N,Gc,hn,Wc,Hc,Bt,Bc,Vc,Ao;return Ne=new U({}),He=new U({}),Je=new U({}),Qe=new U({}),Xe=new b({props:{code:"accelerate config",highlighted:"accelerate config"}}),et=new b({props:{code:"accelerate launch my_script.py --args_to_my_script",highlighted:"accelerate launch my_script.py --args_to_my_script"}}),tt=new b({props:{code:`compute_environment: LOCAL_MACHINE
deepspeed_config:
...
--num_train_epochs 3 \\
--with_tracking \\
--report_to <span class="hljs-string">&quot;wandb&quot;</span>\\`}}),gt=new b({props:{code:` # Creates Dummy Optimizer if \`optimizer\` was spcified in the config file else creates Adam Optimizer
 optimizer_cls = (
     torch.optim.AdamW
 ...
 <span class="hljs-keyword">else</span>:
     lr_scheduler = DummyScheduler(
         optimizer, total_num_steps=args.max_train_steps, warmup_num_steps=args.num_warmup_steps
     )`}}),vt=new U({}),bt=new b({props:{code:`unwrapped_model = accelerator.unwrap_model(model)
...
Saving fp32 state dict to pytorch_model.bin (total_numel=60506624)`}}),Et=new b({props:{code:`from deepspeed.utils.zero_to_fp32 import load_state_dict_from_zero_checkpoint
...
unwrapped_model = accelerator.unwrap_model(model)
fp32_model = load_state_dict_from_zero_checkpoint(unwrapped_model, checkpoint_dir)`}}),St=new b({props:{code:`from deepspeed.utils.zero_to_fp32 import get_fp32_state_dict_from_zero_checkpoint
...
state_dict = get_fp32_state_dict_from_zero_checkpoint(checkpoint_dir)`}}),Dt=new U({}),qt=new b({props:{code:"model, eval_dataloader = accelerator.prepare(model, eval_dataloader)",highlighted:"model, eval_dataloader = accelerator.prepare(model, eval_dataloader)"}}),zt=new U({}),Pt=new U({}),xt=new Vt({props:{name:"class accelerate.DeepSpeedPlugin",anchor:"accelerate.DeepSpeedPlugin",parameters:[{name:"hf_ds_config",val:": typing.Any = None"},{name:"gradient_accumulation_steps",val:": int = None"},{name:"gradient_clipping",val:": float = None"},{name:"zero_stage",val:": int = None"},{name:"is_train_batch_min",val:": str = True"},{name:"offload_optimizer_device",val:": bool = None"},{name:"offload_param_device",val:": bool = None"},{name:"zero3_init_flag",val:": bool = None"},{name:"zero3_save_16bit_model",val:": bool = None"}],source:"https://github.com/huggingface/accelerate/blob/vr_513/src/accelerate/utils/dataclasses.py#L230"}}),Ct=new Vt({props:{name:"deepspeed_config_process",anchor:"accelerate.DeepSpeedPlugin.deepspeed_config_process",parameters:[{name:"prefix",val:" = ''"},{name:"mismatches",val:" = None"},{name:"config",val:" = None"},{name:"must_match",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/accelerate/blob/vr_513/src/accelerate/utils/dataclasses.py#L362"}}),Rt=new Vt({props:{name:"class accelerate.utils.DummyOptim",anchor:"accelerate.utils.DummyOptim",parameters:[{name:"params",val:""},{name:"lr",val:" = 0.001"},{name:"weight_decay",val:" = 0"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"accelerate.utils.DummyOptim.lr",description:`<strong>lr</strong> (float) &#x2014;
...
**kwargs &#x2014;
Other arguments.`,name:"warmup_num_steps"}],source:"https://github.com/huggingface/accelerate/blob/vr_513/src/accelerate/utils/deepspeed.py#L232"}}),At=new Vt({props:{name:"class accelerate.utils.DeepSpeedEngineWrapper",anchor:"accelerate.utils.DeepSpeedEngineWrapper",parameters:[{name:"engine",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedEngineWrapper.engine",description:"<strong>engine</strong> (deepspeed.runtime.engine.DeepSpeedEngine) &#x2014; deepspeed engine to wrap",name:"engine"}],source:"https://github.com/huggingface/accelerate/blob/vr_513/src/accelerate/utils/deepspeed.py#L143"}}),Zt=new Vt({props:{name:"class accelerate.utils.DeepSpeedOptimizerWrapper",anchor:"accelerate.utils.DeepSpeedOptimizerWrapper",parameters:[{name:"optimizer",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedOptimizerWrapper.optimizer",description:`<strong>optimizer</strong> (<code>torch.optim.optimizer.Optimizer</code>) &#x2014;
The optimizer to wrap.`,name:"optimizer"}],source:"https://github.com/huggingface/accelerate/blob/vr_513/src/accelerate/utils/deepspeed.py#L168"}}),Tt=new Vt({props:{name:"class accelerate.utils.DeepSpeedSchedulerWrapper",anchor:"accelerate.utils.DeepSpeedSchedulerWrapper",parameters:[{name:"scheduler",val:""},{name:"optimizers",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedSchedulerWrapper.scheduler",description:`<strong>scheduler</strong> (<code>torch.optim.lr_scheduler.LambdaLR</code>) &#x2014;
The scheduler to wrap.`,name:"scheduler"},{anchor:"accelerate.utils.DeepSpeedSchedulerWrapper.optimizers",description:"<strong>optimizers</strong> (one or a list of <code>torch.optim.Optimizer</code>) &#x2014;",name:"optimizers"}],source:"https://github.com/huggingface/accelerate/blob/vr_513/src/accelerate/utils/deepspeed.py#L192"}}),Nt=new U({}),{c(){M=a("meta"),gn=c(),F=a("h1"),ue=a("a"),Es=a("span"),h(Ne.$$.fragment),jl=c(),Ss=a("span"),bl=l("DeepSpeed"),wn=c(),G=a("p"),Le=a("a"),yl=l("DeepSpeed"),$l=l(" implements everything described in the "),Ue=a("a"),El=l("ZeRO paper"),Sl=l(". Currently it provides full support for:"),vn=c(),y=a("ol"),Ds=a("li"),Dl=l("Optimizer state partitioning (ZeRO stage 1)"),ql=c(),qs=a("li"),zl=l("Gradient partitioning (ZeRO stage 2)"),kl=c(),zs=a("li"),Ol=l("Parameter partitioning (ZeRO stage 3)"),Pl=c(),ks=a("li"),xl=l("Custom mixed precision training handling"),Cl=c(),Os=a("li"),Rl=l("A range of fast CUDA-extension-based optimizers"),Il=c(),Ps=a("li"),Al=l("ZeRO-Offload to CPU and Disk/NVMe"),jn=c(),I=a("p"),Zl=l("ZeRO-Offload has its own dedicated paper: "),Me=a("a"),Tl=l("ZeRO-Offload: Democratizing Billion-Scale Model Training"),Nl=l(". And NVMe-support is described in the paper "),Fe=a("a"),Ll=l(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),Ul=l("."),bn=c(),Yt=a("p"),Ml=l("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),yn=c(),Jt=a("p"),Fl=l(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),$n=c(),de=a("p"),Gl=l("\u{1F917} Accelerate integrates "),Ge=a("a"),Wl=l("DeepSpeed"),Hl=l(" via 2 options:"),En=c(),he=a("ol"),W=a("li"),Bl=l("Integration of the DeepSpeed features via "),xs=a("code"),Vl=l("deepspeed config file"),Yl=l(" specification in "),Cs=a("code"),Jl=l("accelerate config"),Kl=l(` . You just supply your custom config file or use our template. Most of
...
This will generate a config file that will be used automatically to properly set the
default options when doing`),ao=c(),h(rt.$$.fragment),no=c(),qe=a("p"),ar=l("For instance, here is how you would run the NLP example "),ta=a("code"),nr=l("examples/by_feature/deepspeed_with_config_support.py"),or=l(" (from the root of the repo) with DeepSpeed Config File:"),oo=c(),is=a("p"),sa=a("strong"),lr=l("ZeRO Stage-2 DeepSpeed Config File Example"),lo=c(),h(it.$$.fragment),po=c(),ze=a("p"),pr=l("with the contents of "),aa=a("code"),rr=l("zero_stage2_config.json"),ir=l(" being:"),ro=c(),h(ct.$$.fragment),io=c(),h(ut.$$.fragment),co=c(),cs=a("p"),na=a("strong"),cr=l("ZeRO Stage-3 with CPU offload DeepSpeed Config File Example"),uo=c(),h(dt.$$.fragment),ho=c(),ke=a("p"),ur=l("with the contents of "),oa=a("code"),dr=l("zero_stage3_offload_config.json"),hr=l(" being:"),fo=c(),h(ht.$$.fragment),mo=c(),h(ft.$$.fragment),_o=c(),us=a("p"),la=a("strong"),fr=l("Important code changes when using DeepSpeed Config File"),go=c(),Oe=a("ol"),$=a("li"),K=a("p"),mr=l(`DeepSpeed Optimizers and Schedulers. For more information on these,
...
In this situation, those will be used and user has to use `),ia=a("code"),Dr=l("accelerate.utils.DummyOptim"),qr=l(" and "),ca=a("code"),zr=l("accelerate.utils.DummyScheduler"),kr=l(` to replace the PyTorch/Custom optimizers and schedulers in their code.
...
In the above example we can see that the code reamins unchanged if the `),fa=a("code"),Nr=l("optimizer"),Lr=l(" and "),ma=a("code"),Ur=l("scheduler"),Mr=l(" keys are absent in the DeepSpeed config file."),Fr=c(),Q=a("p"),Gr=l("c. Custom Optim + DS Scheduler: The case when only "),_a=a("code"),Wr=l("scheduler"),Hr=l(` key is present in the DeepSpeed config file.
...
Below is the snippet from `),Ra=a("code"),zi=l("examples/by_feature/deepspeed_with_config_support.py"),ki=l(" showing this:"),Oi=c(),h(bt.$$.fragment),Pi=c(),ee=a("p"),xi=l("b. To get 32bit weights, first save the model using "),Ia=a("code"),Ci=l("model.save_checkpoint()"),Ri=l(`.
...
loop when scheduler config is specified in the deepspeed config file.`),zo=c(),pe=a("div"),h(At.$$.fragment),$c=c(),en=a("p"),Ec=l("Internal wrapper for deepspeed.runtime.engine.DeepSpeedEngine. This is used to follow conventional training loop."),ko=c(),re=a("div"),h(Zt.$$.fragment),Sc=c(),tn=a("p"),Dc=l("Internal wrapper around a deepspeed optimizer."),Oo=c(),ie=a("div"),h(Tt.$$.fragment),qc=c(),sn=a("p"),zc=l("Internal wrapper around a deepspeed scheduler."),Po=c(),ce=a("h2"),Ze=a("a"),an=a("span"),h(Nt.$$.fragment),kc=c(),nn=a("span"),Oc=l("Main DeepSpeed Resources"),xo=c(),z=a("ul"),on=a("li"),Lt=a("a"),Pc=l("Project\u2019s github"),xc=c(),ln=a("li"),Ut=a("a"),Cc=l("Usage docs"),Rc=c(),pn=a("li"),Mt=a("a"),Ic=l("API docs"),Ac=c(),rn=a("li"),Ft=a("a"),Zc=l("Blog posts"),Co=c(),ds=a("p"),Tc=l("Papers:"),Ro=c(),T=a("ul"),cn=a("li"),Gt=a("a"),Nc=l("ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),Lc=c(),un=a("li"),Wt=a("a"),Uc=l("ZeRO-Offload: Democratizing Billion-Scale Model Training"),Mc=c(),dn=a("li"),Ht=a("a"),Fc=l("ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),Io=c(),N=a("p"),Gc=l("Finally, please, remember that, \u{1F917} "),hn=a("code"),Wc=l("Accelerate"),Hc=l(` only integrates DeepSpeed, therefore if you
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Bt=a("a"),Bc=l("DeepSpeed GitHub"),Vc=l("."),this.h()},l(e){const r=Rh('[data-svelte="svelte-1phssyn"]',document.head);M=n(r,"META",{name:!0,content:!0}),r.forEach(s),gn=u(e),F=n(e,"H1",{class:!0});var Zo=o(F);ue=n(Zo,"A",{id:!0,class:!0,href:!0});var Kc=o(ue);Es=n(Kc,"SPAN",{});var Qc=o(Es);f(Ne.$$.fragment,Qc),Qc.forEach(s),Kc.forEach(s),jl=u(Zo),Ss=n(Zo,"SPAN",{});var Xc=o(Ss);bl=p(Xc,"DeepSpeed"),Xc.forEach(s),Zo.forEach(s),wn=u(e),G=n(e,"P",{});var fn=o(G);Le=n(fn,"A",{href:!0,rel:!0});var eu=o(Le);yl=p(eu,"DeepSpeed"),eu.forEach(s),$l=p(fn," implements everything described in the "),Ue=n(fn,"A",{href:!0,rel:!0});var tu=o(Ue);El=p(tu,"ZeRO paper"),tu.forEach(s),Sl=p(fn,". Currently it provides full support for:"),fn.forEach(s),vn=u(e),y=n(e,"OL",{});var k=o(y);Ds=n(k,"LI",{});var su=o(Ds);Dl=p(su,"Optimizer state partitioning (ZeRO stage 1)"),su.forEach(s),ql=u(k),qs=n(k,"LI",{});var au=o(qs);zl=p(au,"Gradient partitioning (ZeRO stage 2)"),au.forEach(s),kl=u(k),zs=n(k,"LI",{});var nu=o(zs);Ol=p(nu,"Parameter partitioning (ZeRO stage 3)"),nu.forEach(s),Pl=u(k),ks=n(k,"LI",{});var ou=o(ks);xl=p(ou,"Custom mixed precision training handling"),ou.forEach(s),Cl=u(k),Os=n(k,"LI",{});var lu=o(Os);Rl=p(lu,"A range of fast CUDA-extension-based optimizers"),lu.forEach(s),Il=u(k),Ps=n(k,"LI",{});var pu=o(Ps);Al=p(pu,"ZeRO-Offload to CPU and Disk/NVMe"),pu.forEach(s),k.forEach(s),jn=u(e),I=n(e,"P",{});var hs=o(I);Zl=p(hs,"ZeRO-Offload has its own dedicated paper: "),Me=n(hs,"A",{href:!0,rel:!0});var ru=o(Me);Tl=p(ru,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),ru.forEach(s),Nl=p(hs,". And NVMe-support is described in the paper "),Fe=n(hs,"A",{href:!0,rel:!0});var iu=o(Fe);Ll=p(iu,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),iu.forEach(s),Ul=p(hs,"."),hs.forEach(s),bn=u(e),Yt=n(e,"P",{});var cu=o(Yt);Ml=p(cu,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),cu.forEach(s),yn=u(e),Jt=n(e,"P",{});var uu=o(Jt);Fl=p(uu,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),uu.forEach(s),$n=u(e),de=n(e,"P",{});var To=o(de);Gl=p(To,"\u{1F917} Accelerate integrates "),Ge=n(To,"A",{href:!0,rel:!0});var du=o(Ge);Wl=p(du,"DeepSpeed"),du.forEach(s),Hl=p(To," via 2 options:"),To.forEach(s),En=u(e),he=n(e,"OL",{});var No=o(he);W=n(No,"LI",{});var fs=o(W);Bl=p(fs,"Integration of the DeepSpeed features via "),xs=n(fs,"CODE",{});var hu=o(xs);Vl=p(hu,"deepspeed config file"),hu.forEach(s),Yl=p(fs," specification in "),Cs=n(fs,"CODE",{});var fu=o(Cs);Jl=p(fu,"accelerate config"),fu.forEach(s),Kl=p(fs,` . You just supply your custom config file or use our template. Most of
this document is focused on this feature. This supports all the core features of DeepSpeed and gives user a lot of flexibility.
...
Below is a short description of Data Parallelism using ZeRO - Zero Redundancy Optimizer along with diagram from this `),Be=n(mn,"A",{href:!0,rel:!0});var bu=o(Be);lp=p(bu,"blog post"),bu.forEach(s),pp=u(mn),Xt=n(mn,"IMG",{src:!0,alt:!0}),mn.forEach(s),ju.forEach(s),zn=u(e),_e=n(e,"P",{});var Mo=o(_e);rp=p(Mo,"(Source: "),Ve=n(Mo,"A",{href:!0,rel:!0});var yu=o(Ve);ip=p(yu,"link"),yu.forEach(s),cp=p(Mo,")"),Mo.forEach(s),kn=u(e),ge=n(e,"P",{});var Fo=o(ge);up=p(Fo,"a. "),Zs=n(Fo,"STRONG",{});var $u=o(Zs);dp=p($u,"Stage 1"),$u.forEach(s),hp=p(Fo," : Shards optimizer states across data parallel workers/GPUs"),Fo.forEach(s),On=u(e),we=n(e,"P",{});var Go=o(we);fp=p(Go,"b. "),Ts=n(Go,"STRONG",{});var Eu=o(Ts);mp=p(Eu,"Stage 2"),Eu.forEach(s),_p=p(Go," : Shards optimizer states + gradients across data parallel workers/GPUs"),Go.forEach(s),Pn=u(e),ve=n(e,"P",{});var Wo=o(ve);gp=p(Wo,"c. "),Ns=n(Wo,"STRONG",{});var Su=o(Ns);wp=p(Su,"Stage 3"),Su.forEach(s),vp=p(Wo,": Shards optimizer states + gradients + model parameters across data parallel workers/GPUs"),Wo.forEach(s),xn=u(e),je=n(e,"P",{});var Ho=o(je);jp=p(Ho,"d. "),Ls=n(Ho,"STRONG",{});var Du=o(Ls);bp=p(Du,"Optimizer Offload"),Du.forEach(s),yp=p(Ho,": Offloads the gradients + optimizer states to CPU/Disk building on top of ZERO Stage 2"),Ho.forEach(s),Cn=u(e),be=n(e,"P",{});var Bo=o(be);$p=p(Bo,"e. "),Us=n(Bo,"STRONG",{});var qu=o(Us);Ep=p(qu,"Param Offload"),qu.forEach(s),Sp=p(Bo,": Offloads the model parameters to CPU/Disk building on top of ZERO Stage 3"),Bo.forEach(s),Rn=u(e),es=n(e,"U",{});var zu=o(es);Dp=p(zu,"Note"),zu.forEach(s),In=p(e,`: With respect to Disk Offload, the disk should be an NVME for decent speed but it technically work on any Disk
`),ts=n(e,"P",{});var ku=o(ts);qp=p(ku,"Inference:"),ku.forEach(s),An=u(e),ss=n(e,"OL",{});var Ou=o(ss);Ye=n(Ou,"LI",{});var Vo=o(Ye);zp=p(Vo,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),as=n(Vo,"A",{href:!0});var Pu=o(as);kp=p(Pu,"deepspeed-zero-inference"),Pu.forEach(s),Op=p(Vo,"."),Vo.forEach(s),Ou.forEach(s),Zn=u(e),B=n(e,"H2",{class:!0});var Yo=o(B);ye=n(Yo,"A",{id:!0,class:!0,href:!0});var xu=o(ye);Ms=n(xu,"SPAN",{});var Cu=o(Ms);f(Je.$$.fragment,Cu),Cu.forEach(s),xu.forEach(s),Pp=u(Yo),Fs=n(Yo,"SPAN",{});var Ru=o(Fs);xp=p(Ru,"How it works?"),Ru.forEach(s),Yo.forEach(s),Tn=u(e),V=n(e,"P",{});var _n=o(V);Gs=n(_n,"STRONG",{});var Iu=o(Gs);Cp=p(Iu,"Pre-Requisites"),Iu.forEach(s),Rp=p(_n,": Install DeepSpeed version >=0.6.5. Please refer to the "),Ke=n(_n,"A",{href:!0,rel:!0});var Au=o(Ke);Ip=p(Au,"DeepSpeed Insallation details"),Au.forEach(s),Ap=p(_n,`
...
Followed by more flexible and feature rich `),Hs=n(ms,"CODE",{});var Tu=o(Hs);Lp=p(Tu,"deepspeed config file"),Tu.forEach(s),Up=p(ms," integration."),ms.forEach(s),Ln=u(e),Y=n(e,"H3",{class:!0});var Jo=o(Y);$e=n(Jo,"A",{id:!0,class:!0,href:!0});var Nu=o($e);Bs=n(Nu,"SPAN",{});var Lu=o(Bs);f(Qe.$$.fragment,Lu),Lu.forEach(s),Nu.forEach(s),Mp=u(Jo),Vs=n(Jo,"SPAN",{});var Uu=o(Vs);Fp=p(Uu,"Accelerate DeepSpeed Plugin"),Uu.forEach(s),Jo.forEach(s),Un=p(e,`

On your machine(s) just run:

	`),f(Xe.$$.fragment,e),Mn=u(e),ns=n(e,"P",{});var Mu=o(ns);Gp=p(Mu,`and answer the questions asked. It will ask whether you want to use a config file for DeepSpeed to which you should answer no. Then answer the following questions to generate a basic DeepSpeed config.
This will generate a config file that will be used automatically to properly set the
default options when doing`),Mu.forEach(s),Fn=u(e),f(et.$$.fragment,e),Gn=u(e),Ee=n(e,"P",{});var Ko=o(Ee);Wp=p(Ko,"For instance, here is how you would run the NLP example "),Ys=n(Ko,"CODE",{});var Fu=o(Ys);Hp=p(Fu,"examples/nlp_example.py"),Fu.forEach(s),Bp=p(Ko," (from the root of the repo) with DeepSpeed Plugin:"),Ko.forEach(s),Wn=u(e),os=n(e,"P",{});var Gu=o(os);Js=n(Gu,"STRONG",{});var Wu=o(Js);Vp=p(Wu,"ZeRO Stage-2 DeepSpeed Plugin Example"),Wu.forEach(s),Gu.forEach(s),Hn=u(e),f(tt.$$.fragment,e),Bn=u(e),f(st.$$.fragment,e),Vn=u(e),ls=n(e,"P",{});var Hu=o(ls);Ks=n(Hu,"STRONG",{});var Bu=o(Ks);Yp=p(Bu,"ZeRO Stage-3 with CPU Offload DeepSpeed Plugin Example"),Bu.forEach(s),Hu.forEach(s),Yn=u(e),f(at.$$.fragment,e),Jn=u(e),f(nt.$$.fragment,e),Kn=u(e),Se=n(e,"P",{});var Qo=o(Se);Jp=p(Qo,"Currently, "),Qs=n(Qo,"CODE",{});var Vu=o(Qs);Kp=p(Vu,"Accelerate"),Vu.forEach(s),Qp=p(Qo," supports following config through the CLI:"),Qo.forEach(s),Qn=u(e),f(ot.$$.fragment,e),Xn=u(e),ps=n(e,"P",{});var Yu=o(ps);Xp=p(Yu,"To be able to tweak more options, you will need to use a DeepSpeed config file."),Yu.forEach(s),eo=u(e),J=n(e,"H3",{class:!0});var Xo=o(J);De=n(Xo,"A",{id:!0,class:!0,href:!0});var Ju=o(De);Xs=n(Ju,"SPAN",{});var Ku=o(Xs);f(lt.$$.fragment,Ku),Ku.forEach(s),Ju.forEach(s),er=u(Xo),ea=n(Xo,"SPAN",{});var Qu=o(ea);tr=p(Qu,"DeepSpeed Config File"),Qu.forEach(s),Xo.forEach(s),to=p(e,`
...
In this situation, those will be used and user has to use `),ia=n(P,"CODE",{});var hd=o(ia);Dr=p(hd,"accelerate.utils.DummyOptim"),hd.forEach(s),qr=p(P," and "),ca=n(P,"CODE",{});var fd=o(ca);zr=p(fd,"accelerate.utils.DummyScheduler"),fd.forEach(s),kr=p(P,` to replace the PyTorch/Custom optimizers and schedulers in their code.
...
Only the `),$a=n(x,"CODE",{});var qd=o($a);pi=p(qd,"auto"),qd.forEach(s),ri=p(x," fields specified in above examples are handled by "),Ea=n(x,"CODE",{});var zd=o(Ea);ii=p(zd,"prepare"),zd.forEach(s),ci=p(x," method and the rest have to be explicitly specified by the user."),x.forEach(s),$d.forEach(s),al.forEach(s),wo=u(e),X=n(e,"H2",{class:!0});var ol=o(X);Pe=n(ol,"A",{id:!0,class:!0,href:!0});var kd=o(Pe);Sa=n(kd,"SPAN",{});var Od=o(Sa);f(vt.$$.fragment,Od),Od.forEach(s),kd.forEach(s),ui=u(ol),Da=n(ol,"SPAN",{});var Pd=o(Da);di=p(Pd,"Saving and loading"),Pd.forEach(s),ol.forEach(s),vo=u(e),xe=n(e,"OL",{});var ll=o(xe);qa=n(ll,"LI",{});var xd=o(qa);za=n(xd,"P",{});var Cd=o(za);hi=p(Cd,"Saving and loading of models is unchanged for ZeRO Stage-1 and Stage-2."),Cd.forEach(s),xd.forEach(s),fi=u(ll),v=n(ll,"LI",{});var j=o(v);jt=n(j,"P",{});var pl=o(jt);mi=p(pl,"under ZeRO Stage-3, "),ka=n(pl,"CODE",{});var Rd=o(ka);_i=p(Rd,"state_dict"),Rd.forEach(s),gi=p(pl,` contains just the placeholders since the model weights are partitioned across multiple GPUs.
...
loop when scheduler config is specified in the deepspeed config file.`),ph.forEach(s),ml.forEach(s),zo=u(e),pe=n(e,"DIV",{class:!0});var _l=o(pe);f(At.$$.fragment,_l),$c=u(_l),en=n(_l,"P",{});var rh=o(en);Ec=p(rh,"Internal wrapper for deepspeed.runtime.engine.DeepSpeedEngine. This is used to follow conventional training loop."),rh.forEach(s),_l.forEach(s),ko=u(e),re=n(e,"DIV",{class:!0});var gl=o(re);f(Zt.$$.fragment,gl),Sc=u(gl),tn=n(gl,"P",{});var ih=o(tn);Dc=p(ih,"Internal wrapper around a deepspeed optimizer."),ih.forEach(s),gl.forEach(s),Oo=u(e),ie=n(e,"DIV",{class:!0});var wl=o(ie);f(Tt.$$.fragment,wl),qc=u(wl),sn=n(wl,"P",{});var ch=o(sn);zc=p(ch,"Internal wrapper around a deepspeed scheduler."),ch.forEach(s),wl.forEach(s),Po=u(e),ce=n(e,"H2",{class:!0});var vl=o(ce);Ze=n(vl,"A",{id:!0,class:!0,href:!0});var uh=o(Ze);an=n(uh,"SPAN",{});var dh=o(an);f(Nt.$$.fragment,dh),dh.forEach(s),uh.forEach(s),kc=u(vl),nn=n(vl,"SPAN",{});var hh=o(nn);Oc=p(hh,"Main DeepSpeed Resources"),hh.forEach(s),vl.forEach(s),xo=u(e),z=n(e,"UL",{});var Te=o(z);on=n(Te,"LI",{});var fh=o(on);Lt=n(fh,"A",{href:!0,rel:!0});var mh=o(Lt);Pc=p(mh,"Project\u2019s github"),mh.forEach(s),fh.forEach(s),xc=u(Te),ln=n(Te,"LI",{});var _h=o(ln);Ut=n(_h,"A",{href:!0,rel:!0});var gh=o(Ut);Cc=p(gh,"Usage docs"),gh.forEach(s),_h.forEach(s),Rc=u(Te),pn=n(Te,"LI",{});var wh=o(pn);Mt=n(wh,"A",{href:!0,rel:!0});var vh=o(Mt);Ic=p(vh,"API docs"),vh.forEach(s),wh.forEach(s),Ac=u(Te),rn=n(Te,"LI",{});var jh=o(rn);Ft=n(jh,"A",{href:!0,rel:!0});var bh=o(Ft);Zc=p(bh,"Blog posts"),bh.forEach(s),jh.forEach(s),Te.forEach(s),Co=u(e),ds=n(e,"P",{});var yh=o(ds);Tc=p(yh,"Papers:"),yh.forEach(s),Ro=u(e),T=n(e,"UL",{});var ys=o(T);cn=n(ys,"LI",{});var $h=o(cn);Gt=n($h,"A",{href:!0,rel:!0});var Eh=o(Gt);Nc=p(Eh,"ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),Eh.forEach(s),$h.forEach(s),Lc=u(ys),un=n(ys,"LI",{});var Sh=o(un);Wt=n(Sh,"A",{href:!0,rel:!0});var Dh=o(Wt);Uc=p(Dh,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),Dh.forEach(s),Sh.forEach(s),Mc=u(ys),dn=n(ys,"LI",{});var qh=o(dn);Ht=n(qh,"A",{href:!0,rel:!0});var zh=o(Ht);Fc=p(zh,"ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),zh.forEach(s),qh.forEach(s),ys.forEach(s),Io=u(e),N=n(e,"P",{});var $s=o(N);Gc=p($s,"Finally, please, remember that, \u{1F917} "),hn=n($s,"CODE",{});var kh=o(hn);Wc=p(kh,"Accelerate"),kh.forEach(s),Hc=p($s,` only integrates DeepSpeed, therefore if you
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Bt=n($s,"A",{href:!0,rel:!0});var Oh=o(Bt);Bc=p(Oh,"DeepSpeed GitHub"),Oh.forEach(s),Vc=p($s,"."),$s.forEach(s),this.h()},h(){d(M,"name","hf:doc:metadata"),d(M,"content",JSON.stringify(Nh)),d(ue,"id","deepspeed"),d(ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ue,"href","#deepspeed"),d(F,"class","relative group"),d(Le,"href","https://github.com/microsoft/DeepSpeed"),d(Le,"rel","nofollow"),d(Ue,"href","https://arxiv.org/abs/1910.02054"),d(Ue,"rel","nofollow"),d(Me,"href","https://arxiv.org/abs/2101.06840"),d(Me,"rel","nofollow"),d(Fe,"href","https://arxiv.org/abs/2104.07857"),d(Fe,"rel","nofollow"),d(Ge,"href","https://github.com/microsoft/DeepSpeed"),d(Ge,"rel","nofollow"),d(fe,"id","what-is-integrated"),d(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(fe,"href","#what-is-integrated"),d(H,"class","relative group"),d(Be,"href","https://www.microsoft.com/en-us/research/blog/zero-deepspeed-new-system-optimizations-enable-training-models-with-over-100-billion-parameters/"),d(Be,"rel","nofollow"),Ih(Xt.src,Jc="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/parallelism-zero.png")||d(Xt,"src",Jc),d(Xt,"alt","ZeRO Data Parallelism"),d(Ve,"href","https://www.microsoft.com/en-us/research/blog/zero-deepspeed-new-system-optimizations-enable-training-models-with-over-100-billion-parameters/"),d(Ve,"rel","nofollow"),d(as,"href","#deepspeed-zero-inference"),d(ye,"id","how-it-works"),d(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ye,"href","#how-it-works"),d(B,"class","relative group"),d(Ke,"href","https://github.com/microsoft/DeepSpeed#installation"),d(Ke,"rel","nofollow"),d($e,"id","accelerate-deepspeed-plugin"),d($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d($e,"href","#accelerate-deepspeed-plugin"),d(Y,"class","relative group"),d(De,"id","deepspeed-config-file"),d(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(De,"href","#deepspeed-config-file"),d(J,"class","relative group"),d(mt,"href","https://deepspeed.readthedocs.io/en/latest/optimizers.html"),d(mt,"rel","nofollow"),d(_t,"href","https://deepspeed.readthedocs.io/en/latest/schedulers.html"),d(_t,"rel","nofollow"),d(Pe,"id","saving-and-loading"),d(Pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Pe,"href","#saving-and-loading"),d(X,"class","relative group"),d(Ce,"id","zero-inference"),d(Ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ce,"href","#zero-inference"),d(se,"class","relative group"),d(Re,"id","few-caveats-to-be-aware-of"),d(Re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Re,"href","#few-caveats-to-be-aware-of"),d(ae,"class","relative group"),d(Ie,"id","accelerate.DeepSpeedPlugin"),d(Ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ie,"href","#accelerate.DeepSpeedPlugin"),d(ne,"class","relative group"),d(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ze,"id","main-deepspeed-resources"),d(Ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ze,"href","#main-deepspeed-resources"),d(ce,"class","relative group"),d(Lt,"href","https://github.com/microsoft/deepspeed"),d(Lt,"rel","nofollow"),d(Ut,"href","https://www.deepspeed.ai/getting-started/"),d(Ut,"rel","nofollow"),d(Mt,"href","https://deepspeed.readthedocs.io/en/latest/index.html"),d(Mt,"rel","nofollow"),d(Ft,"href","https://www.microsoft.com/en-us/research/search/?q=deepspeed"),d(Ft,"rel","nofollow"),d(Gt,"href","https://arxiv.org/abs/1910.02054"),d(Gt,"rel","nofollow"),d(Wt,"href","https://arxiv.org/abs/2101.06840"),d(Wt,"rel","nofollow"),d(Ht,"href","https://arxiv.org/abs/2104.07857"),d(Ht,"rel","nofollow"),d(Bt,"href","https://github.com/microsoft/DeepSpeed/issues"),d(Bt,"rel","nofollow")},m(e,r){t(document.head,M),i(e,gn,r),i(e,F,r),t(F,ue),t(ue,Es),m(Ne,Es,null),t(F,jl),t(F,Ss),t(Ss,bl),i(e,wn,r),i(e,G,r),t(G,Le),t(Le,yl),t(G,$l),t(G,Ue),t(Ue,El),t(G,Sl),i(e,vn,r),i(e,y,r),t(y,Ds),t(Ds,Dl),t(y,ql),t(y,qs),t(qs,zl),t(y,kl),t(y,zs),t(zs,Ol),t(y,Pl),t(y,ks),t(ks,xl),t(y,Cl),t(y,Os),t(Os,Rl),t(y,Il),t(y,Ps),t(Ps,Al),i(e,jn,r),i(e,I,r),t(I,Zl),t(I,Me),t(Me,Tl),t(I,Nl),t(I,Fe),t(Fe,Ll),t(I,Ul),i(e,bn,r),i(e,Yt,r),t(Yt,Ml),i(e,yn,r),i(e,Jt,r),t(Jt,Fl),i(e,$n,r),i(e,de,r),t(de,Gl),t(de,Ge),t(Ge,Wl),t(de,Hl),i(e,En,r),i(e,he,r),t(he,W),t(W,Bl),t(W,xs),t(xs,Vl),t(W,Yl),t(W,Cs),t(Cs,Jl),t(W,Kl),t(he,Ql),t(he,We),t(We,Xl),t(We,Rs),t(Rs,ep),t(We,tp),i(e,Sn,r),i(e,H,r),t(H,fe),t(fe,Is),m(He,Is,null),t(H,sp),t(H,As),t(As,ap),i(e,Dn,r),i(e,Kt,r),t(Kt,np),i(e,qn,r),i(e,Qt,r),t(Qt,me),t(me,op),t(me,Be),t(Be,lp),t(me,pp),t(me,Xt),i(e,zn,r),i(e,_e,r),t(_e,rp),t(_e,Ve),t(Ve,ip),t(_e,cp),i(e,kn,r),i(e,ge,r),t(ge,up),t(ge,Zs),t(Zs,dp),t(ge,hp),i(e,On,r),i(e,we,r),t(we,fp),t(we,Ts),t(Ts,mp),t(we,_p),i(e,Pn,r),i(e,ve,r),t(ve,gp),t(ve,Ns),t(Ns,wp),t(ve,vp),i(e,xn,r),i(e,je,r),t(je,jp),t(je,Ls),t(Ls,bp),t(je,yp),i(e,Cn,r),i(e,be,r),t(be,$p),t(be,Us),t(Us,Ep),t(be,Sp),i(e,Rn,r),i(e,es,r),t(es,Dp),i(e,In,r),i(e,ts,r),t(ts,qp),i(e,An,r),i(e,ss,r),t(ss,Ye),t(Ye,zp),t(Ye,as),t(as,kp),t(Ye,Op),i(e,Zn,r),i(e,B,r),t(B,ye),t(ye,Ms),m(Je,Ms,null),t(B,Pp),t(B,Fs),t(Fs,xp),i(e,Tn,r),i(e,V,r),t(V,Gs),t(Gs,Cp),t(V,Rp),t(V,Ke),t(Ke,Ip),t(V,Ap),i(e,Nn,r),i(e,A,r),t(A,Zp),t(A,Ws),t(Ws,Tp),t(A,Np),t(A,Hs),t(Hs,Lp),t(A,Up),i(e,Ln,r),i(e,Y,r),t(Y,$e),t($e,Bs),m(Qe,Bs,null),t(Y,Mp),t(Y,Vs),t(Vs,Fp),i(e,Un,r),m(Xe,e,r),i(e,Mn,r),i(e,ns,r),t(ns,Gp),i(e,Fn,r),m(et,e,r),i(e,Gn,r),i(e,Ee,r),t(Ee,Wp),t(Ee,Ys),t(Ys,Hp),t(Ee,Bp),i(e,Wn,r),i(e,os,r),t(os,Js),t(Js,Vp),i(e,Hn,r),m(tt,e,r),i(e,Bn,r),m(st,e,r),i(e,Vn,r),i(e,ls,r),t(ls,Ks),t(Ks,Yp),i(e,Yn,r),m(at,e,r),i(e,Jn,r),m(nt,e,r),i(e,Kn,r),i(e,Se,r),t(Se,Jp),t(Se,Qs),t(Qs,Kp),t(Se,Qp),i(e,Qn,r),m(ot,e,r),i(e,Xn,r),i(e,ps,r),t(ps,Xp),i(e,eo,r),i(e,J,r),t(J,De),t(De,Xs),m(lt,Xs,null),t(J,er),t(J,ea),t(ea,tr),i(e,to,r),m(pt,e,r),i(e,so,r),i(e,rs,r),t(rs,sr),i(e,ao,r),m(rt,e,r),i(e,no,r),i(e,qe,r),t(qe,ar),t(qe,ta),t(ta,nr),t(qe,or),i(e,oo,r),i(e,is,r),t(is,sa),t(sa,lr),i(e,lo,r),m(it,e,r),i(e,po,r),i(e,ze,r),t(ze,pr),t(ze,aa),t(aa,rr),t(ze,ir),i(e,ro,r),m(ct,e,r),i(e,io,r),m(ut,e,r),i(e,co,r),i(e,cs,r),t(cs,na),t(na,cr),i(e,uo,r),m(dt,e,r),i(e,ho,r),i(e,ke,r),t(ke,ur),t(ke,oa),t(oa,dr),t(ke,hr),i(e,fo,r),m(ht,e,r),i(e,mo,r),m(ft,e,r),i(e,_o,r),i(e,us,r),t(us,la),t(la,fr),i(e,go,r),i(e,Oe,r),t(Oe,$),t($,K),t(K,mr),t(K,mt),t(mt,_r),t(K,gr),t(K,_t),t(_t,wr),t(K,vr),t($,jr),t($,E),t(E,br),t(E,pa),t(pa,yr),t(E,$r),t(E,ra),t(ra,Er),t(E,Sr),t(E,ia),t(ia,Dr),t(E,qr),t(E,ca),t(ca,zr),t(E,kr),t(E,ua),t(ua,Or),t(E,Pr),t($,xr),m(gt,$,null),t($,Cr),t($,q),t(q,Rr),t(q,da),t(da,Ir),t(q,Ar),t(q,ha),t(ha,Zr),t(q,Tr),t(q,fa),t(fa,Nr),t(q,Lr),t(q,ma),t(ma,Ur),t(q,Mr),t($,Fr),t($,Q),t(Q,Gr),t(Q,_a),t(_a,Wr),t(Q,Hr),t(Q,ga),t(ga,Br),t(Q,Vr),t($,Yr),t($,wt),t(wt,Jr),t(wt,wa),t(wa,Kr),t(wt,Qr),t(Oe,Xr),t(Oe,va),t(va,S),t(S,ei),t(S,ja),t(ja,ti),t(S,si),t(S,ba),t(ba,ai),t(S,ni),t(S,ya),t(ya,oi),t(S,li),t(S,$a),t($a,pi),t(S,ri),t(S,Ea),t(Ea,ii),t(S,ci),i(e,wo,r),i(e,X,r),t(X,Pe),t(Pe,Sa),m(vt,Sa,null),t(X,ui),t(X,Da),t(Da,di),i(e,vo,r),i(e,xe,r),t(xe,qa),t(qa,za),t(za,hi),t(xe,fi),t(xe,v),t(v,jt),t(jt,mi),t(jt,ka),t(ka,_i),t(jt,gi),t(v,wi),t(v,D),t(D,vi),t(D,Oa),t(Oa,ji),t(D,bi),t(D,Pa),t(Pa,yi),t(D,$i),t(D,xa),t(xa,Ei),t(D,Si),t(D,Ca),t(Ca,Di),t(D,qi),t(D,Ra),t(Ra,zi),t(D,ki),t(v,Oi),m(bt,v,null),t(v,Pi),t(v,ee),t(ee,xi),t(ee,Ia),t(Ia,Ci),t(ee,Ri),t(ee,Aa),t(Aa,Ii),t(ee,Ai),t(v,Zi),m(yt,v,null),t(v,Ti),t(v,te),t(te,Ni),t(te,Za),t(Za,Li),t(te,Ui),t(te,Mi),t(te,Fi),t(v,Gi),m($t,v,null),t(v,Wi),t(v,Ta),t(Ta,Hi),t(v,Bi),m(Et,v,null),t(v,Vi),t(v,Na),t(Na,Yi),t(v,Ji),m(St,v,null),t(v,Ki),t(v,La),t(La,Qi),i(e,jo,r),i(e,se,r),t(se,Ce),t(Ce,Ua),m(Dt,Ua,null),t(se,Xi),t(se,Ma),t(Ma,ec),i(e,bo,r),m(qt,e,r),i(e,yo,r),i(e,ae,r),t(ae,Re),t(Re,Fa),m(zt,Fa,null),t(ae,tc),t(ae,Ga),t(Ga,sc),i(e,$o,r),i(e,Z,r),t(Z,Wa),t(Wa,ac),t(Z,nc),t(Z,kt),t(kt,oc),t(kt,Ha),t(Ha,lc),t(kt,pc),t(Z,rc),t(Z,Ot),t(Ot,ic),t(Ot,Ba),t(Ba,cc),t(Ot,uc),i(e,Eo,r),i(e,ne,r),t(ne,Ie),t(Ie,Va),m(Pt,Va,null),t(ne,dc),t(ne,Ya),t(Ya,hc),i(e,So,r),i(e,R,r),m(xt,R,null),t(R,fc),t(R,Ja),t(Ja,mc),t(R,_c),t(R,Ae),m(Ct,Ae,null),t(Ae,gc),t(Ae,Ka),t(Ka,wc),i(e,Do,r),i(e,oe,r),m(Rt,oe,null),t(oe,vc),t(oe,Qa),t(Qa,jc),i(e,qo,r),i(e,le,r),m(It,le,null),t(le,bc),t(le,Xa),t(Xa,yc),i(e,zo,r),i(e,pe,r),m(At,pe,null),t(pe,$c),t(pe,en),t(en,Ec),i(e,ko,r),i(e,re,r),m(Zt,re,null),t(re,Sc),t(re,tn),t(tn,Dc),i(e,Oo,r),i(e,ie,r),m(Tt,ie,null),t(ie,qc),t(ie,sn),t(sn,zc),i(e,Po,r),i(e,ce,r),t(ce,Ze),t(Ze,an),m(Nt,an,null),t(ce,kc),t(ce,nn),t(nn,Oc),i(e,xo,r),i(e,z,r),t(z,on),t(on,Lt),t(Lt,Pc),t(z,xc),t(z,ln),t(ln,Ut),t(Ut,Cc),t(z,Rc),t(z,pn),t(pn,Mt),t(Mt,Ic),t(z,Ac),t(z,rn),t(rn,Ft),t(Ft,Zc),i(e,Co,r),i(e,ds,r),t(ds,Tc),i(e,Ro,r),i(e,T,r),t(T,cn),t(cn,Gt),t(Gt,Nc),t(T,Lc),t(T,un),t(un,Wt),t(Wt,Uc),t(T,Mc),t(T,dn),t(dn,Ht),t(Ht,Fc),i(e,Io,r),i(e,N,r),t(N,Gc),t(N,hn),t(hn,Wc),t(N,Hc),t(N,Bt),t(Bt,Bc),t(N,Vc),Ao=!0},p:Ah,i(e){Ao||(_(Ne.$$.fragment,e),_(He.$$.fragment,e),_(Je.$$.fragment,e),_(Qe.$$.fragment,e),_(Xe.$$.fragment,e),_(et.$$.fragment,e),_(tt.$$.fragment,e),_(st.$$.fragment,e),_(at.$$.fragment,e),_(nt.$$.fragment,e),_(ot.$$.fragment,e),_(lt.$$.fragment,e),_(pt.$$.fragment,e),_(rt.$$.fragment,e),_(it.$$.fragment,e),_(ct.$$.fragment,e),_(ut.$$.fragment,e),_(dt.$$.fragment,e),_(ht.$$.fragment,e),_(ft.$$.fragment,e),_(gt.$$.fragment,e),_(vt.$$.fragment,e),_(bt.$$.fragment,e),_(yt.$$.fragment,e),_($t.$$.fragment,e),_(Et.$$.fragment,e),_(St.$$.fragment,e),_(Dt.$$.fragment,e),_(qt.$$.fragment,e),_(zt.$$.fragment,e),_(Pt.$$.fragment,e),_(xt.$$.fragment,e),_(Ct.$$.fragment,e),_(Rt.$$.fragment,e),_(It.$$.fragment,e),_(At.$$.fragment,e),_(Zt.$$.fragment,e),_(Tt.$$.fragment,e),_(Nt.$$.fragment,e),Ao=!0)},o(e){g(Ne.$$.fragment,e),g(He.$$.fragment,e),g(Je.$$.fragment,e),g(Qe.$$.fragment,e),g(Xe.$$.fragment,e),g(et.$$.fragment,e),g(tt.$$.fragment,e),g(st.$$.fragment,e),g(at.$$.fragment,e),g(nt.$$.fragment,e),g(ot.$$.fragment,e),g(lt.$$.fragment,e),g(pt.$$.fragment,e),g(rt.$$.fragment,e),g(it.$$.fragment,e),g(ct.$$.fragment,e),g(ut.$$.fragment,e),g(dt.$$.fragment,e),g(ht.$$.fragment,e),g(ft.$$.fragment,e),g(gt.$$.fragment,e),g(vt.$$.fragment,e),g(bt.$$.fragment,e),g(yt.$$.fragment,e),g($t.$$.fragment,e),g(Et.$$.fragment,e),g(St.$$.fragment,e),g(Dt.$$.fragment,e),g(qt.$$.fragment,e),g(zt.$$.fragment,e),g(Pt.$$.fragment,e),g(xt.$$.fragment,e),g(Ct.$$.fragment,e),g(Rt.$$.fragment,e),g(It.$$.fragment,e),g(At.$$.fragment,e),g(Zt.$$.fragment,e),g(Tt.$$.fragment,e),g(Nt.$$.fragment,e),Ao=!1},d(e){s(M),e&&s(gn),e&&s(F),w(Ne),e&&s(wn),e&&s(G),e&&s(vn),e&&s(y),e&&s(jn),e&&s(I),e&&s(bn),e&&s(Yt),e&&s(yn),e&&s(Jt),e&&s($n),e&&s(de),e&&s(En),e&&s(he),e&&s(Sn),e&&s(H),w(He),e&&s(Dn),e&&s(Kt),e&&s(qn),e&&s(Qt),e&&s(zn),e&&s(_e),e&&s(kn),e&&s(ge),e&&s(On),e&&s(we),e&&s(Pn),e&&s(ve),e&&s(xn),e&&s(je),e&&s(Cn),e&&s(be),e&&s(Rn),e&&s(es),e&&s(In),e&&s(ts),e&&s(An),e&&s(ss),e&&s(Zn),e&&s(B),w(Je),e&&s(Tn),e&&s(V),e&&s(Nn),e&&s(A),e&&s(Ln),e&&s(Y),w(Qe),e&&s(Un),w(Xe,e),e&&s(Mn),e&&s(ns),e&&s(Fn),w(et,e),e&&s(Gn),e&&s(Ee),e&&s(Wn),e&&s(os),e&&s(Hn),w(tt,e),e&&s(Bn),w(st,e),e&&s(Vn),e&&s(ls),e&&s(Yn),w(at,e),e&&s(Jn),w(nt,e),e&&s(Kn),e&&s(Se),e&&s(Qn),w(ot,e),e&&s(Xn),e&&s(ps),e&&s(eo),e&&s(J),w(lt),e&&s(to),w(pt,e),e&&s(so),e&&s(rs),e&&s(ao),w(rt,e),e&&s(no),e&&s(qe),e&&s(oo),e&&s(is),e&&s(lo),w(it,e),e&&s(po),e&&s(ze),e&&s(ro),w(ct,e),e&&s(io),w(ut,e),e&&s(co),e&&s(cs),e&&s(uo),w(dt,e),e&&s(ho),e&&s(ke),e&&s(fo),w(ht,e),e&&s(mo),w(ft,e),e&&s(_o),e&&s(us),e&&s(go),e&&s(Oe),w(gt),e&&s(wo),e&&s(X),w(vt),e&&s(vo),e&&s(xe),w(bt),w(yt),w($t),w(Et),w(St),e&&s(jo),e&&s(se),w(Dt),e&&s(bo),w(qt,e),e&&s(yo),e&&s(ae),w(zt),e&&s($o),e&&s(Z),e&&s(Eo),e&&s(ne),w(Pt),e&&s(So),e&&s(R),w(xt),w(Ct),e&&s(Do),e&&s(oe),w(Rt),e&&s(qo),e&&s(le),w(It),e&&s(zo),e&&s(pe),w(At),e&&s(ko),e&&s(re),w(Zt),e&&s(Oo),e&&s(ie),w(Tt),e&&s(Po),e&&s(ce),w(Nt),e&&s(xo),e&&s(z),e&&s(Co),e&&s(ds),e&&s(Ro),e&&s(T),e&&s(Io),e&&s(N)}}}const Nh={local:"deepspeed",sections:[{local:"what-is-integrated",title:"What is integrated?"},{local:"how-it-works",sections:[{local:"accelerate-deepspeed-plugin",title:"Accelerate DeepSpeed Plugin"},{local:"deepspeed-config-file",title:"DeepSpeed Config File"}],title:"How it works?"},{local:"saving-and-loading",title:"Saving and loading"},{local:"zero-inference",title:"ZeRO Inference"},{local:"few-caveats-to-be-aware-of",title:"Few caveats to be aware of "},{local:"accelerate.DeepSpeedPlugin",title:"Internals"},{local:"main-deepspeed-resources",title:"Main DeepSpeed Resources"}],title:"DeepSpeed "};function Lh(Yc){return Zh(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Wh extends Ph{constructor(M){super();xh(this,M,Lh,Th,Ch,{})}}export{Wh as default,Nh as metadata};
