...
**kwargs &#x2014;
Other arguments.`,name:"warmup_num_steps"}],source:"https://github.com/huggingface/accelerate/blob/vr_465/src/accelerate/utils/deepspeed.py#L232"}}),At=new Vt({props:{name:"class accelerate.utils.DeepSpeedEngineWrapper",anchor:"accelerate.utils.DeepSpeedEngineWrapper",parameters:[{name:"engine",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedEngineWrapper.engine",description:"<strong>engine</strong> (deepspeed.runtime.engine.DeepSpeedEngine) &#x2014; deepspeed engine to wrap",name:"engine"}],source:"https://github.com/huggingface/accelerate/blob/vr_465/src/accelerate/utils/deepspeed.py#L143"}}),Zt=new Vt({props:{name:"class accelerate.utils.DeepSpeedOptimizerWrapper",anchor:"accelerate.utils.DeepSpeedOptimizerWrapper",parameters:[{name:"optimizer",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedOptimizerWrapper.optimizer",description:`<strong>optimizer</strong> (<code>torch.optim.optimizer.Optimizer</code>) &#x2014;
The optimizer to wrap.`,name:"optimizer"}],source:"https://github.com/huggingface/accelerate/blob/vr_465/src/accelerate/utils/deepspeed.py#L168"}}),Tt=new Vt({props:{name:"class accelerate.utils.DeepSpeedSchedulerWrapper",anchor:"accelerate.utils.DeepSpeedSchedulerWrapper",parameters:[{name:"scheduler",val:""},{name:"optimizers",val:""}],parametersDescription:[{anchor:"accelerate.utils.DeepSpeedSchedulerWrapper.scheduler",description:`<strong>scheduler</strong> (<code>torch.optim.lr_scheduler.LambdaLR</code>) &#x2014;
The scheduler to wrap.`,name:"scheduler"},{anchor:"accelerate.utils.DeepSpeedSchedulerWrapper.optimizers",description:"<strong>optimizers</strong> (one or a list of <code>torch.optim.Optimizer</code>) &#x2014;",name:"optimizers"}],source:"https://github.com/huggingface/accelerate/blob/vr_465/src/accelerate/utils/deepspeed.py#L192"}}),Nt=new U({}),{c(){M=a("meta"),gn=c(),G=a("h1"),ue=a("a"),Es=a("span"),h(Ne.$$.fragment),jl=c(),Ss=a("span"),bl=l("DeepSpeed"),wn=c(),F=a("p"),Le=a("a"),yl=l("DeepSpeed"),$l=l(" implements everything described in the "),Ue=a("a"),El=l("ZeRO paper"),Sl=l(". Currently it provides full support for:"),vn=c(),y=a("ol"),Ds=a("li"),Dl=l("Optimizer state partitioning (ZeRO stage 1)"),ql=c(),qs=a("li"),kl=l("Gradient partitioning (ZeRO stage 2)"),zl=c(),ks=a("li"),Ol=l("Parameter partitioning (ZeRO stage 3)"),Pl=c(),zs=a("li"),xl=l("Custom mixed precision training handling"),Cl=c(),Os=a("li"),Rl=l("A range of fast CUDA-extension-based optimizers"),Il=c(),Ps=a("li"),Al=l("ZeRO-Offload to CPU and Disk/NVMe"),jn=c(),I=a("p"),Zl=l("ZeRO-Offload has its own dedicated paper: "),Me=a("a"),Tl=l("ZeRO-Offload: Democratizing Billion-Scale Model Training"),Nl=l(". And NVMe-support is described in the paper "),Ge=a("a"),Ll=l(`ZeRO-Infinity: Breaking the GPU
