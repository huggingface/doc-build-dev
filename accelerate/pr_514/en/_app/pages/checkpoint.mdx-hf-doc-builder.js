...
accelerate.load_state(<span class="hljs-string">&quot;my/save/path&quot;</span>)`}}),{c(){u=s("meta"),B=d(),_=s("h1"),g=s("a"),P=s("span"),Re(w.$$.fragment),K=d(),R=s("span"),Q=r("Checkpointing"),G=d(),E=s("p"),V=r(`When training a PyTorch model with \u{1F917} Accelerate, you may often want to save and continue a state of training. Doing so requires
saving and loading the model, optimizer, RNG generators, and the GradScaler. Inside \u{1F917} Accelerate are two convience functions to achieve this quickly:`),N=d(),y=s("ul"),k=s("li"),X=r("Use "),j=s("a"),Y=r("save_state()"),Z=r(" for saving everything mentioned above to a folder location"),ee=d(),v=s("li"),te=r("Use "),A=s("a"),ae=r("load_state()"),se=r(" for loading everything stored from an earlier "),q=s("code"),oe=r("save_state"),T=d(),$=s("p"),re=r("It should be noted that the expectation is that those states come from the same training script, they should not be from two separate scripts."),D=d(),z=s("ul"),l=s("li"),ne=r("By using "),S=s("a"),ie=r("register_for_checkpointing()"),ce=r(`, you can register custom objects to be automatically stored or loaded from the two prior functions,
so long as the object has a `),x=s("code"),le=r("state_dict"),pe=d(),C=s("strong"),me=r("and"),de=r(" a "),I=s("code"),he=r("load_state_dict"),ue=r(" functionality. This could include objects such as a learning rate scheduler."),O=d(),L=s("p"),_e=r("Below is a brief example using checkpointing to save and reload a state during training:"),M=d(),Re(b.$$.fragment),this.h()},l(e){const c=Te('[data-svelte="svelte-1phssyn"]',document.head);u=o(c,"META",{name:!0,content:!0}),c.forEach(a),B=h(e),_=o(e,"H1",{class:!0});var H=n(_);g=o(H,"A",{id:!0,class:!0,href:!0});var ge=n(g);P=o(ge,"SPAN",{});var ye=n(P);qe(w.$$.fragment,ye),ye.forEach(a),ge.forEach(a),K=h(H),R=o(H,"SPAN",{});var ve=n(R);Q=i(ve,"Checkpointing"),ve.forEach(a),H.forEach(a),G=h(e),E=o(e,"P",{});var we=n(E);V=i(we,`When training a PyTorch model with \u{1F917} Accelerate, you may often want to save and continue a state of training. Doing so requires
saving and loading the model, optimizer, RNG generators, and the GradScaler. Inside \u{1F917} Accelerate are two convience functions to achieve this quickly:`),we.forEach(a),N=h(e),y=o(e,"UL",{});var J=n(y);k=o(J,"LI",{});var F=n(k);X=i(F,"Use "),j=o(F,"A",{href:!0});var ke=n(j);Y=i(ke,"save_state()"),ke.forEach(a),Z=i(F," for saving everything mentioned above to a folder location"),F.forEach(a),ee=h(J),v=o(J,"LI",{});var U=n(v);te=i(U,"Use "),A=o(U,"A",{href:!0});var be=n(A);ae=i(be,"load_state()"),be.forEach(a),se=i(U," for loading everything stored from an earlier "),q=o(U,"CODE",{});var Ee=n(q);oe=i(Ee,"save_state"),Ee.forEach(a),U.forEach(a),J.forEach(a),T=h(e),$=o(e,"P",{});var je=n($);re=i(je,"It should be noted that the expectation is that those states come from the same training script, they should not be from two separate scripts."),je.forEach(a),D=h(e),z=o(e,"UL",{});var Ae=n(z);l=o(Ae,"LI",{});var m=n(l);ne=i(m,"By using "),S=o(m,"A",{href:!0});var $e=n(S);ie=i($e,"register_for_checkpointing()"),$e.forEach(a),ce=i(m,`, you can register custom objects to be automatically stored or loaded from the two prior functions,
so long as the object has a `),x=o(m,"CODE",{});var ze=n(x);le=i(ze,"state_dict"),ze.forEach(a),pe=h(m),C=o(m,"STRONG",{});var Se=n(C);me=i(Se,"and"),Se.forEach(a),de=i(m," a "),I=o(m,"CODE",{});var Le=n(I);he=i(Le,"load_state_dict"),Le.forEach(a),ue=i(m," functionality. This could include objects such as a learning rate scheduler."),m.forEach(a),Ae.forEach(a),O=h(e),L=o(e,"P",{});var Pe=n(L);_e=i(Pe,"Below is a brief example using checkpointing to save and reload a state during training:"),Pe.forEach(a),M=h(e),qe(b.$$.fragment,e),this.h()},h(){f(u,"name","hf:doc:metadata"),f(u,"content",JSON.stringify(Je)),f(g,"id","checkpointing"),f(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(g,"href","#checkpointing"),f(_,"class","relative group"),f(j,"href","/docs/accelerate/pr_514/en/accelerator#accelerate.Accelerator.save_state"),f(A,"href","/docs/accelerate/pr_514/en/accelerator#accelerate.Accelerator.load_state"),f(S,"href","/docs/accelerate/pr_514/en/accelerator#accelerate.Accelerator.register_for_checkpointing")},m(e,c){t(document.head,u),p(e,B,c),p(e,_,c),t(_,g),t(g,P),xe(w,P,null),t(_,K),t(_,R),t(R,Q),p(e,G,c),p(e,E,c),t(E,V),p(e,N,c),p(e,y,c),t(y,k),t(k,X),t(k,j),t(j,Y),t(k,Z),t(y,ee),t(y,v),t(v,te),t(v,A),t(A,ae),t(v,se),t(v,q),t(q,oe),p(e,T,c),p(e,$,c),t($,re),p(e,D,c),p(e,z,c),t(z,l),t(l,ne),t(l,S),t(S,ie),t(l,ce),t(l,x),t(x,le),t(l,pe),t(l,C),t(C,me),t(l,de),t(l,I),t(I,he),t(l,ue),p(e,O,c),p(e,L,c),t(L,_e),p(e,M,c),xe(b,e,c),W=!0},p:De,i(e){W||(Ce(w.$$.fragment,e),Ce(b.$$.fragment,e),W=!0)},o(e){Ie(w.$$.fragment,e),Ie(b.$$.fragment,e),W=!1},d(e){a(u),e&&a(B),e&&a(_),Ue(w),e&&a(G),e&&a(E),e&&a(N),e&&a(y),e&&a(T),e&&a($),e&&a(D),e&&a(z),e&&a(O),e&&a(L),e&&a(M),Ue(b,e)}}}const Je={local:"checkpointing",title:"Checkpointing"};function Fe(fe){return Oe(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Xe extends Be{constructor(u){super();Ge(this,u,Fe,He,Ne,{})}}export{Xe as default,Je as metadata};
