import{S as xl,i as Dl,s as ql,e as s,k as l,w as f,t as r,M as Fl,c as n,d as a,m as g,a as o,x as u,h as i,b as c,F as e,g as y,y as m,q as _,o as b,B as v,v as Nl}from"../../chunks/vendor-7b1da053.js";import{T as cs}from"../../chunks/Tip-41a95816.js";import{D}from"../../chunks/Docstring-f1352b16.js";import{C as be}from"../../chunks/CodeBlock-5f39b59e.js";import{I as pi}from"../../chunks/IconCopyLink-d24e9a6f.js";function Pl(J){let p,q,A,w,H,$,j,N,O,F,E,P,T,U,C;return{c(){p=s("p"),q=r("Raises the following errors:"),A=l(),w=s("ul"),H=s("li"),$=s("a"),j=s("code"),N=r("HTTPError"),O=r(`
...
`),A=n(j,"A",{href:!0});var N=o(A);w=i(N,"HfApi.set_access_token()"),N.forEach(a),H=i(j," instead."),j.forEach(a),this.h()},h(){c(A,"href","/docs/huggingface_hub/pr_678/en/package_reference/hf_api#huggingface_hub.HfApi.set_access_token")},m($,j){y($,p,j),e(p,q),e(p,A),e(A,w),e(p,H)},d($){$&&a(p)}}}function Tl(J){let p,q,A,w,H,$,j,N,O;return{c(){p=s("p"),q=r("Raises the following errors:"),A=l(),w=s("ul"),H=s("li"),$=s("a"),j=s("code"),N=r("HTTPError"),O=r(`
