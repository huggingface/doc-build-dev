...
If the revision to download from cannot be found.`),C.forEach(t),M.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(I,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){v(_,l,P),e(l,b),v(_,f,P),v(_,i,P),e(i,d),e(d,r),e(r,m),e(d,N),e(d,u),e(u,y),e(d,E),e(i,k),e(i,A),e(A,I),e(I,O),e(A,R)},d(_){_&&t(l),_&&t(f),_&&t(i)}}}function Fi(S){let l,b,f,i,d,r,m,N,u,y,E,k,A,I,O,R,_,P,M,U,V,G,C,W,Z,J,re,ee,Q,X,Y,me,_e;return{c(){l=a("p"),b=c("Raises the following errors:"),f=g(),i=a("ul"),d=a("li"),r=a("a"),m=a("code"),N=c("HTTPError"),u=c(`
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),u=n(U,"CODE",{});var G=s(u);y=p(G,"private"),G.forEach(t),E=p(U," and you do not have access."),U.forEach(t),k=h(M),A=n(M,"LI",{});var C=s(A);I=n(C,"A",{href:!0});var W=s(I);O=p(W,"RevisionNotFoundError"),W.forEach(t),R=p(C,`
If the revision to download from cannot be found.`),C.forEach(t),M.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(I,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){v(_,l,P),e(l,b),v(_,f,P),v(_,i,P),e(i,d),e(d,r),e(r,m),e(d,N),e(d,u),e(u,y),e(d,E),e(i,k),e(i,A),e(A,I),e(I,O),e(A,R)},d(_){_&&t(l),_&&t(f),_&&t(i)}}}function Ri(S){let l,b,f,i,d,r,m,N,u,y,E;return{c(){l=a("p"),b=c("Raises the following errors:"),f=g(),i=a("ul"),d=a("li"),r=a("a"),m=c("RepositoryNotFoundError"),N=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),u=a("code"),y=c("private"),E=c(" and you do not have access."),this.h()},l(k){l=n(k,"P",{});var A=s(l);b=p(A,"Raises the following errors:"),A.forEach(t),f=h(k),i=n(k,"UL",{});var I=s(i);d=n(I,"LI",{});var O=s(d);r=n(O,"A",{href:!0});var R=s(r);m=p(R,"RepositoryNotFoundError"),R.forEach(t),N=p(O,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),u=n(U,"CODE",{});var G=s(u);y=p(G,"private"),G.forEach(t),E=p(U," and you do not have access."),U.forEach(t),k=h(M),A=n(M,"LI",{});var C=s(A);I=n(C,"A",{href:!0});var W=s(I);O=p(W,"RevisionNotFoundError"),W.forEach(t),R=p(C,`
If the revision to download from cannot be found.`),C.forEach(t),M.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(I,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){v(_,l,P),e(l,b),v(_,f,P),v(_,i,P),e(i,d),e(d,r),e(r,m),e(d,N),e(d,u),e(u,y),e(d,E),e(i,k),e(i,A),e(A,I),e(I,O),e(A,R)},d(_){_&&t(l),_&&t(f),_&&t(i)}}}function Ui(S){let l,b,f,i,d,r,m,N,u,y,E,k,A,I,O,R;return{c(){l=a("p"),b=c("Raises the following errors:"),f=g(),i=a("ul"),d=a("li"),r=a("a"),m=c("RepositoryNotFoundError"),N=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),u=a("code"),y=c("private"),E=c(" and you do not have access."),k=g(),A=a("li"),I=a("a"),O=c("RevisionNotFoundError"),R=c(`
If the revision to download from cannot be found.`),this.h()},l(_){l=n(_,"P",{});var P=s(l);b=p(P,"Raises the following errors:"),P.forEach(t),f=h(_),i=n(_,"UL",{});var M=s(i);d=n(M,"LI",{});var U=s(d);r=n(U,"A",{href:!0});var V=s(r);m=p(V,"RepositoryNotFoundError"),V.forEach(t),N=p(U,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),u=n(U,"CODE",{});var G=s(u);y=p(G,"private"),G.forEach(t),E=p(U," and you do not have access."),U.forEach(t),k=h(M),A=n(M,"LI",{});var C=s(A);I=n(C,"A",{href:!0});var W=s(I);O=p(W,"RevisionNotFoundError"),W.forEach(t),R=p(C,`
If the revision to download from cannot be found.`),C.forEach(t),M.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(I,"href","/docs/huggingface_hub/pr_949/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){v(_,l,P),e(l,b),v(_,f,P),v(_,i,P),e(i,d),e(d,r),e(r,m),e(d,N),e(d,u),e(u,y),e(d,E),e(i,k),e(i,A),e(A,I),e(I,O),e(A,R)},d(_){_&&t(l),_&&t(f),_&&t(i)}}}function Mi(S){let l,b,f,i,d,r,m,N,u,y,E;return{c(){l=a("p"),b=c("Raises the following errors:"),f=g(),i=a("ul"),d=a("li"),r=a("a"),m=c("RepositoryNotFoundError"),N=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),u=a("code"),y=c("private"),E=c(" and you do not have access."),this.h()},l(k){l=n(k,"P",{});var A=s(l);b=p(A,"Raises the following errors:"),A.forEach(t),f=h(k),i=n(k,"UL",{});var I=s(i);d=n(I,"LI",{});var O=s(d);r=n(O,"A",{href:!0});var R=s(r);m=p(R,"RepositoryNotFoundError"),R.forEach(t),N=p(O,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
Setting it to 2 means at most 2 files will be uploaded concurrently.`,name:"num_threads"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1801",returnDescription:`
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1427",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1224",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L2289",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Lt=new z({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L673"}}),Pt=new z({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/pr_949/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/pr_949/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1387",returnDescription:`
...
Whether to use the <code>auth_token</code> provided from the
<code>huggingface_hub</code> cli. If not logged in, a valid <code>auth_token</code>
can be passed in as a string.`,name:"use_auth_token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1078",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1163",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1332",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1278",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1648",returnDescription:`
...
Whether or not to create a Pull Request from <code>revision</code> with that commit.
Defaults to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L1922",returnDescription:`
...
to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_949/src/huggingface_hub/hf_api.py#L2067",returnDescription:`
