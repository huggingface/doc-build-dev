...
`),A=n(j,"A",{href:!0});var N=o(A);w=i(N,"HfApi.set_access_token()"),N.forEach(a),H=i(j," instead."),j.forEach(a),this.h()},h(){c(A,"href","/docs/huggingface_hub/pr_820/en/package_reference/hf_api#huggingface_hub.HfApi.set_access_token")},m($,j){y($,p,j),e(p,q),e(p,A),e(A,w),e(p,H)},d($){$&&a(p)}}}function Tl(J){let p,q,A,w,H,$,j,N,O;return{c(){p=s("p"),q=r("Raises the following errors:"),A=l(),w=s("ul"),H=s("li"),$=s("a"),j=s("code"),N=r("HTTPError"),O=r(`
