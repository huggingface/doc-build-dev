...
If the revision to download from cannot be found.`),z.forEach(t),S.forEach(t),this.h()},h(){k(r,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),k(T,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(y,O){$(y,i,O),e(i,_),$(y,f,O),$(y,l,O),e(l,p),e(p,r),e(r,u),e(p,E),e(p,m),e(m,b),e(p,x),e(l,w),e(l,A),e(A,T),e(T,P),e(A,M)},d(y){y&&t(i),y&&t(f),y&&t(l)}}}function di(R){let i,_,f,l,p,r,u,E,m,b,x,w,A,T,P,M,y,O,S,U,V,G,z,W,Z,J,se,ee,Q,X,Y,ue,me;return{c(){i=o("p"),_=g("Raises the following errors:"),f=h(),l=o("ul"),p=o("li"),r=o("a"),u=o("code"),E=g("HTTPError"),m=g(`
...
`),f=n(u,"A",{href:!0});var E=s(f);l=c(E,"HfApi.set_access_token()"),E.forEach(t),p=c(u," instead."),u.forEach(t),this.h()},h(){k(f,"href","/docs/huggingface_hub/pr_898/en/package_reference/hf_api#huggingface_hub.HfApi.set_access_token")},m(r,u){$(r,i,u),e(i,_),e(i,f),e(f,l),e(i,p)},d(r){r&&t(i)}}}function $i(R){let i,_,f,l,p,r,u,E,m;return{c(){i=o("p"),_=g("Raises the following errors:"),f=h(),l=o("ul"),p=o("li"),r=o("a"),u=o("code"),E=g("HTTPError"),m=g(`
...
`),f=n(u,"A",{href:!0});var E=s(f);l=c(E,"HfApi.unset_access_token()"),E.forEach(t),p=c(u," instead."),u.forEach(t),this.h()},h(){k(f,"href","/docs/huggingface_hub/pr_898/en/package_reference/hf_api#huggingface_hub.HfApi.unset_access_token")},m(r,u){$(r,i,u),e(i,_),e(i,f),e(f,l),e(i,p)},d(r){r&&t(i)}}}function ki(R){let i,_,f,l,p,r,u,E,m,b,x,w,A,T,P,M;return{c(){i=o("p"),_=g("Raises the following errors:"),f=h(),l=o("ul"),p=o("li"),r=o("a"),u=g("RepositoryNotFoundError"),E=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=o("code"),b=g("private"),x=g(" and you do not have access."),w=h(),A=o("li"),T=o("a"),P=g("RevisionNotFoundError"),M=g(`
If the revision to download from cannot be found.`),this.h()},l(y){i=n(y,"P",{});var O=s(i);_=c(O,"Raises the following errors:"),O.forEach(t),f=d(y),l=n(y,"UL",{});var S=s(l);p=n(S,"LI",{});var U=s(p);r=n(U,"A",{href:!0});var V=s(r);u=c(V,"RepositoryNotFoundError"),V.forEach(t),E=c(U,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=n(U,"CODE",{});var G=s(m);b=c(G,"private"),G.forEach(t),x=c(U," and you do not have access."),U.forEach(t),w=d(S),A=n(S,"LI",{});var z=s(A);T=n(z,"A",{href:!0});var W=s(T);P=c(W,"RevisionNotFoundError"),W.forEach(t),M=c(z,`
If the revision to download from cannot be found.`),z.forEach(t),S.forEach(t),this.h()},h(){k(r,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),k(T,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(y,O){$(y,i,O),e(i,_),$(y,f,O),$(y,l,O),e(l,p),e(p,r),e(r,u),e(p,E),e(p,m),e(m,b),e(p,x),e(l,w),e(l,A),e(A,T),e(T,P),e(A,M)},d(y){y&&t(i),y&&t(f),y&&t(l)}}}function wi(R){let i,_,f,l,p,r,u,E,m,b,x;return{c(){i=o("p"),_=g("Raises the following errors:"),f=h(),l=o("ul"),p=o("li"),r=o("a"),u=g("RepositoryNotFoundError"),E=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=o("code"),b=g("private"),x=g(" and you do not have access."),this.h()},l(w){i=n(w,"P",{});var A=s(i);_=c(A,"Raises the following errors:"),A.forEach(t),f=d(w),l=n(w,"UL",{});var T=s(l);p=n(T,"LI",{});var P=s(p);r=n(P,"A",{href:!0});var M=s(r);u=c(M,"RepositoryNotFoundError"),M.forEach(t),E=c(P,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=n(U,"CODE",{});var G=s(m);b=c(G,"private"),G.forEach(t),x=c(U," and you do not have access."),U.forEach(t),w=d(S),A=n(S,"LI",{});var z=s(A);T=n(z,"A",{href:!0});var W=s(T);P=c(W,"RevisionNotFoundError"),W.forEach(t),M=c(z,`
If the revision to download from cannot be found.`),z.forEach(t),S.forEach(t),this.h()},h(){k(r,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),k(T,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(y,O){$(y,i,O),e(i,_),$(y,f,O),$(y,l,O),e(l,p),e(p,r),e(r,u),e(p,E),e(p,m),e(m,b),e(p,x),e(l,w),e(l,A),e(A,T),e(T,P),e(A,M)},d(y){y&&t(i),y&&t(f),y&&t(l)}}}function Ai(R){let i,_,f,l,p,r,u,E,m,b,x,w,A,T,P,M;return{c(){i=o("p"),_=g("Raises the following errors:"),f=h(),l=o("ul"),p=o("li"),r=o("a"),u=g("RepositoryNotFoundError"),E=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=o("code"),b=g("private"),x=g(" and you do not have access."),w=h(),A=o("li"),T=o("a"),P=g("RevisionNotFoundError"),M=g(`
If the revision to download from cannot be found.`),this.h()},l(y){i=n(y,"P",{});var O=s(i);_=c(O,"Raises the following errors:"),O.forEach(t),f=d(y),l=n(y,"UL",{});var S=s(l);p=n(S,"LI",{});var U=s(p);r=n(U,"A",{href:!0});var V=s(r);u=c(V,"RepositoryNotFoundError"),V.forEach(t),E=c(U,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=n(U,"CODE",{});var G=s(m);b=c(G,"private"),G.forEach(t),x=c(U," and you do not have access."),U.forEach(t),w=d(S),A=n(S,"LI",{});var z=s(A);T=n(z,"A",{href:!0});var W=s(T);P=c(W,"RevisionNotFoundError"),W.forEach(t),M=c(z,`
If the revision to download from cannot be found.`),z.forEach(t),S.forEach(t),this.h()},h(){k(r,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),k(T,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(y,O){$(y,i,O),e(i,_),$(y,f,O),$(y,l,O),e(l,p),e(p,r),e(r,u),e(p,E),e(p,m),e(m,b),e(p,x),e(l,w),e(l,A),e(A,T),e(T,P),e(A,M)},d(y){y&&t(i),y&&t(f),y&&t(l)}}}function xi(R){let i,_,f,l,p,r,u,E,m,b,x;return{c(){i=o("p"),_=g("Raises the following errors:"),f=h(),l=o("ul"),p=o("li"),r=o("a"),u=g("RepositoryNotFoundError"),E=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),m=o("code"),b=g("private"),x=g(" and you do not have access."),this.h()},l(w){i=n(w,"P",{});var A=s(i);_=c(A,"Raises the following errors:"),A.forEach(t),f=d(w),l=n(w,"UL",{});var T=s(l);p=n(T,"LI",{});var P=s(p);r=n(P,"A",{href:!0});var M=s(r);u=c(M,"RepositoryNotFoundError"),M.forEach(t),E=c(P,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the revision to download from cannot be found.`),_e.forEach(t),Y.forEach(t),this.h()},h(){k(r,"href","https://2.python-requests.org/en/master/api/#requests.HTTPError"),k(r,"rel","nofollow"),k(w,"href","https://docs.python.org/3/library/exceptions.html#ValueError"),k(w,"rel","nofollow"),k(O,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),k(J,"href","/docs/huggingface_hub/pr_898/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(Q,X){$(Q,i,X),e(i,_),$(Q,f,X),$(Q,l,X),e(l,p),e(p,r),e(r,u),e(u,E),e(p,m),e(l,b),e(l,x),e(x,w),e(w,A),e(A,T),e(x,P),e(l,M),e(l,y),e(y,O),e(O,S),e(y,U),e(y,V),e(V,G),e(y,z),e(l,W),e(l,Z),e(Z,J),e(J,se),e(Z,ee)},d(Q){Q&&t(i),Q&&t(f),Q&&t(l)}}}function Hi(R){let i,_,f,l,p;return l=new Ae({props:{code:`with open("./local/filepath", "rb") as fobj:
    upload_file(
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1421",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1214",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L2024",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Lt=new C({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L745"}}),Pt=new C({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/pr_898/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/pr_898/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1380",returnDescription:`
...
The password of the account with which to login.`,name:"password"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L558",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1152",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1324",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1269",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1654",returnDescription:`
...
and its content did not change.`,name:"identical_ok"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_898/src/huggingface_hub/hf_api.py#L1809",returnDescription:`
