...
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function Gr(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee,Q,X,Y,de,fe;return{c(){i=o("p"),$=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=o("code"),x=g("HTTPError"),f=g(`
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=c(G,"private"),G.forEach(t),A=c(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=c(W,"RevisionNotFoundError"),W.forEach(t),R=c(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function Yr(M){let i,$,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),$=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);$=c(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=c(R,"RepositoryNotFoundError"),R.forEach(t),x=c(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=c(G,"private"),G.forEach(t),A=c(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=c(W,"RevisionNotFoundError"),W.forEach(t),R=c(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function ei(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),$=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=g("RevisionNotFoundError"),R=g(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);$=c(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=c(V,"RepositoryNotFoundError"),V.forEach(t),x=c(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=c(G,"private"),G.forEach(t),A=c(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=c(W,"RevisionNotFoundError"),W.forEach(t),R=c(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/pr_912/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function ti(M){let i,$,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),$=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);$=c(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=c(R,"RepositoryNotFoundError"),R.forEach(t),x=c(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1332",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1129",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1921",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Ht=new z({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L663"}}),Ft=new z({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/pr_912/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/pr_912/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1292",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1068",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1237",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1183",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1562",returnDescription:`
...
Changing this value has no effect.`,name:"identical_ok"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_912/src/huggingface_hub/hf_api.py#L1715",returnDescription:`
