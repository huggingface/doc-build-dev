...
<span class="hljs-meta">&gt;&gt;&gt; </span>new_filter = ModelFilter(trained_dataset=<span class="hljs-string">&quot;common_voice&quot;</span>)`}}),{c(){x(l.$$.fragment)},l(f){j(l.$$.fragment,f)},m(f,i){H(l,f,i),b=!0},p:Le,i(f){b||(q(l.$$.fragment,f),b=!0)},o(f){D(l.$$.fragment,f),b=!1},d(f){F(l,f)}}}function Ki(U){let l,b,f,i,d;return i=new fe({props:{code:`args = DatasetSearchArguments()
...
<span class="hljs-meta">&gt;&gt;&gt; </span>args.language.en`}}),{c(){l=a("p"),b=c("Example:"),f=g(),x(i.$$.fragment)},l(r){l=n(r,"P",{});var m=s(l);b=p(m,"Example:"),m.forEach(t),f=h(r),j(i.$$.fragment,r)},m(r,m){v(r,l,m),e(l,b),v(r,f,m),H(i,r,m),d=!0},p:Le,i(r){d||(q(i.$$.fragment,r),d=!0)},o(r){D(i.$$.fragment,r),d=!1},d(r){r&&t(l),r&&t(f),F(i,r)}}}function Ji(U){let l,b,f,i,d;return i=new fe({props:{code:`args = ModelSearchArguments()
args.author_or_organization.huggingface
args.language.en`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>args = ModelSearchArguments()
<span class="hljs-meta">&gt;&gt;&gt; </span>args.author_or_organization.huggingface
<span class="hljs-meta">&gt;&gt;&gt; </span>args.language.en`}}),{c(){l=a("p"),b=c("Example:"),f=g(),x(i.$$.fragment)},l(r){l=n(r,"P",{});var m=s(l);b=p(m,"Example:"),m.forEach(t),f=h(r),j(i.$$.fragment,r)},m(r,m){v(r,l,m),e(l,b),v(r,f,m),H(i,r,m),d=!0},p:Le,i(r){d||(q(i.$$.fragment,r),d=!0)},o(r){D(i.$$.fragment,r),d=!1},d(r){r&&t(l),r&&t(f),F(i,r)}}}function Qi(U){let l,b,f,i,d,r,m,N,u,y,E,k,A,I,O,R,_,P,S,M,V,G,C,W,Z,J,re,ee,Q,X,Y,me,_e,B,oe,K,xe,ae,Pe,je,be,T,ne,$o,ve,$e,yo,Oe,ko,rn,Me,qt,ln,To,cn,pn,ie,Dt,gn,Io,hn,dn,Lo,un,fn,Se,mn,He,Ft,_n,Po,bn,vn,Ce,$n,qe,Nt,yn,Oo,kn,wn,ze,An,Ve,Tt,En,Ro,xn,jn,Ge,It,Hn,Uo,qn,Dn,We,Lt,Fn,Mo,Nn,Tn,Be,Pt,In,So,Ln,Pn,le,Ot,On,Co,Rn,Un,Ke,Mn,Je,Sn,Qe,Rt,Cn,zo,zn,Vn,ce,Ut,Gn,Vo,Wn,Bn,Xe,Kn,Ye,Jn,Ze,Mt,Qn,Go,Xn,Yn,pe,St,Zn,Wo,es,ts,Bo,os,as,et,ns,ge,Ct,ss,Ko,rs,is,zt,ls,Vt,cs,ps,gs,tt,hs,De,Gt,ds,Jo,us,fs,ot,ms,at,Wt,_s,Qo,bs,vs,he,Bt,$s,Xo,ys,ks,Yo,ws,As,nt,Es,st,Kt,xs,Zo,js,Hs,Fe,Jt,qs,ea,Ds,Fs,rt,Ns,de,Qt,Ts,ta,Is,Ls,it,Ps,lt,Os,te,Xt,Rs,oa,Us,Ms,aa,Ss,Cs,Yt,zs,na,Vs,Gs,Ws,ct,Bs,pt,Ks,gt,Zt,Js,sa,Qs,Fa,Re,ht,ra,eo,Xs,ia,Ys,Na,to,la,Zs,er,Ta,dt,tr,wo,or,ar,Ia,se,oo,nr,ut,ao,sr,ca,rr,ir,Ne,no,lr,pa,cr,pr,so,gr,ga,hr,dr,ur,ft,ro,fr,ha,mr,La,Ue,mt,da,io,_r,ua,br,Pa,_t,vr,fa,$r,yr,Oa,ye,lo,kr,ma,wr,Ar,bt,Ra,ke,co,Er,_a,xr,jr,vt,Ua,we,po,Hr,ba,qr,Dr,$t,Ma,Ae,go,Fr,va,Nr,Tr,yt,Sa;return r=new Lr({}),J=new fe({props:{code:"",highlighted:`<span class="hljs-keyword">from</span> huggingface_hub <span class="hljs-keyword">import</span> list_models
...
Setting it to 2 means at most 2 files will be uploaded concurrently.`,name:"num_threads"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1737",returnDescription:`
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1354",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1151",returnDescription:`
<p>The dataset repository information.</p>
`,returnType:`
<p><code>DatasetInfo</code></p>
`}}),Se=new Te({props:{$$slots:{default:[Di]},$$scope:{ctx:U}}}),Ft=new z({props:{name:"delete_file",anchor:"huggingface_hub.HfApi.delete_file",parameters:[{name:"path_in_repo",val:": str"},{name:"repo_id",val:": str"},{name:"token",val:": typing.Optional[str] = None"},{name:"repo_type",val:": typing.Optional[str] = None"},{name:"revision",val:": typing.Optional[str] = None"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"commit_description",val:": typing.Optional[str] = None"},{name:"create_pr",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.delete_file.path_in_repo",description:`<strong>path_in_repo</strong> (<code>str</code>) &#x2014;
...
Defaults to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2147"}}),Ce=new Te({props:{$$slots:{default:[Fi]},$$scope:{ctx:U}}}),Nt=new z({props:{name:"delete_repo",anchor:"huggingface_hub.HfApi.delete_repo",parameters:[{name:"repo_id",val:": str = None"},{name:"token",val:": typing.Optional[str] = None"},{name:"repo_type",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.delete_repo.repo_id",description:`<strong>repo_id</strong> (<code>str</code>) &#x2014;
A namespace (user or an organization) and a repo name separated
by a <code>/</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2225",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Lt=new z({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L685"}}),Pt=new z({props:{name:"get_repo_discussions",anchor:"huggingface_hub.HfApi.get_repo_discussions",parameters:[{name:"repo_id",val:": str"},{name:"repo_type",val:": typing.Optional[str] = None"},{name:"token",val:": typing.Optional[str] = None"},{name:"_page_index",val:": int = 0"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.get_repo_discussions.repo_id",description:`<strong>repo_id</strong> (<code>str</code>) &#x2014;
A namespace (user or an organization) and a repo name separated
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2259",returnDescription:`
<p>A <a
...
can be passed in as a string.`,name:"use_auth_token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L911"}}),Ke=new Ie({props:{anchor:"huggingface_hub.HfApi.list_datasets.example",$$slots:{default:[Ti]},$$scope:{ctx:U}}}),Je=new Ie({props:{anchor:"huggingface_hub.HfApi.list_datasets.example-2",$$slots:{default:[Ii]},$$scope:{ctx:U}}}),Rt=new z({props:{name:"list_metrics",anchor:"huggingface_hub.HfApi.list_metrics",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1076",returnDescription:`
...
Whether to use the <code>auth_token</code> provided from the
<code>huggingface_hub</code> cli. If not logged in, a valid <code>auth_token</code>
can be passed in as a string.`,name:"use_auth_token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L703"}}),Xe=new Ie({props:{anchor:"huggingface_hub.HfApi.list_models.example",$$slots:{default:[Li]},$$scope:{ctx:U}}}),Ye=new Ie({props:{anchor:"huggingface_hub.HfApi.list_models.example-2",$$slots:{default:[Pi]},$$scope:{ctx:U}}}),Mt=new z({props:{name:"list_repo_files",anchor:"huggingface_hub.HfApi.list_repo_files",parameters:[{name:"repo_id",val:": str"},{name:"revision",val:": typing.Optional[str] = None"},{name:"repo_type",val:": typing.Optional[str] = None"},{name:"token",val:": typing.Optional[str] = None"},{name:"timeout",val:": typing.Optional[float] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_repo_files.repo_id",description:`<strong>repo_id</strong> (<code>str</code>) &#x2014;
A namespace (user or an organization) and a repo name separated
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1314",returnDescription:`
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1659"}}),tt=new Te({props:{$$slots:{default:[Ri]},$$scope:{ctx:U}}}),Gt=new z({props:{name:"repo_info",anchor:"huggingface_hub.HfApi.repo_info",parameters:[{name:"repo_id",val:": str"},{name:"revision",val:": typing.Optional[str] = None"},{name:"repo_type",val:": typing.Optional[str] = None"},{name:"token",val:": typing.Optional[str] = None"},{name:"timeout",val:": typing.Optional[float] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.repo_info.repo_id",description:`<strong>repo_id</strong> (<code>str</code>) &#x2014;
A namespace (user or an organization) and a repo name separated
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1259",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
The access token to save.`,name:"access_token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L666"}}),Bt=new z({props:{name:"space_info",anchor:"huggingface_hub.HfApi.space_info",parameters:[{name:"repo_id",val:": str"},{name:"revision",val:": typing.Optional[str] = None"},{name:"token",val:": typing.Optional[str] = None"},{name:"timeout",val:": typing.Optional[float] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.space_info.repo_id",description:`<strong>repo_id</strong> (<code>str</code>) &#x2014;
A namespace (user or an organization) and a repo name separated
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1205",returnDescription:`
<p>The space repository information.</p>
`,returnType:`
<p><code>SpaceInfo</code></p>
`}}),nt=new Te({props:{$$slots:{default:[Mi]},$$scope:{ctx:U}}}),Kt=new z({props:{name:"unset_access_token",anchor:"huggingface_hub.HfApi.unset_access_token",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L678"}}),Jt=new z({props:{name:"update_repo_visibility",anchor:"huggingface_hub.HfApi.update_repo_visibility",parameters:[{name:"repo_id",val:": str = None"},{name:"private",val:": bool = False"},{name:"token",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"repo_type",val:": typing.Optional[str] = None"},{name:"name",val:": str = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.update_repo_visibility.repo_id",description:`<strong>repo_id</strong> (<code>str</code>, <em>optional</em>) &#x2014;
A namespace (user or an organization) and a repo name separated
by a <code>/</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1584",returnDescription:`
...
Whether or not to create a Pull Request from <code>revision</code> with that commit.
Defaults to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L1858",returnDescription:`
...
to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2003",returnDescription:`
...
not provided.`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L576"}}),eo=new Lr({}),oo=new z({props:{name:"class huggingface_hub.HfFolder",anchor:"huggingface_hub.HfFolder",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2454"}}),ao=new z({props:{name:"delete_token",anchor:"huggingface_hub.HfFolder.delete_token",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2491"}}),no=new z({props:{name:"get_token",anchor:"huggingface_hub.HfFolder.get_token",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L2470",returnDescription:`
...
model on the Hub.`,name:"trained_dataset"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/utils/endpoint_helpers.py#L153"}}),vt=new Ie({props:{anchor:"huggingface_hub.ModelFilter.example",$$slots:{default:[Bi]},$$scope:{ctx:U}}}),po=new z({props:{name:"class huggingface_hub.DatasetSearchArguments",anchor:"huggingface_hub.DatasetSearchArguments",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L460"}}),$t=new Ie({props:{anchor:"huggingface_hub.DatasetSearchArguments.example",$$slots:{default:[Ki]},$$scope:{ctx:U}}}),go=new z({props:{name:"class huggingface_hub.ModelSearchArguments",anchor:"huggingface_hub.ModelSearchArguments",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_930/src/huggingface_hub/hf_api.py#L422"}}),yt=new Ie({props:{anchor:"huggingface_hub.ModelSearchArguments.example",$$slots:{default:[Ji]},$$scope:{ctx:U}}}),{c(){l=a("meta"),b=g(),f=a("h1"),i=a("a"),d=a("span"),x(r.$$.fragment),m=g(),N=a("span"),u=c("Hugging Face Hub API"),y=g(),E=a("p"),k=c("Below is the documentation for the "),A=a("code"),I=c("HfApi"),O=c(` class, which serves as a Python wrapper for the Hugging Face
...
with a number, it will only exist in the dictionary`),Dr=g(),x($t.$$.fragment),Ma=g(),Ae=a("div"),x(go.$$.fragment),Fr=g(),va=a("p"),Nr=c(`A nested namespace object holding all possible values for properties of
...
compatible with the REST API. For all parameters capitalization does not
matter.`),ki.forEach(t),jr=h(Do),j(vt.$$.fragment,Do),Do.forEach(t),Ua=h(o),we=n(o,"DIV",{class:!0});var Fo=s(we);j(po.$$.fragment,Fo),Hr=h(Fo),ba=n(Fo,"P",{});var wi=s(ba);qr=p(wi,`A nested namespace object holding all possible values for properties of
datasets currently hosted in the Hub with tab-completion. If a value starts
with a number, it will only exist in the dictionary`),wi.forEach(t),Dr=h(Fo),j($t.$$.fragment,Fo),Fo.forEach(t),Ma=h(o),Ae=n(o,"DIV",{class:!0});var No=s(Ae);j(go.$$.fragment,No),Fr=h(No),va=n(No,"P",{});var Ai=s(va);Nr=p(Ai,`A nested namespace object holding all possible values for properties of
models currently hosted in the Hub with tab-completion. If a value starts
with a number, it will only exist in the dictionary`),Ai.forEach(t),Tr=h(No),j(yt.$$.fragment,No),No.forEach(t),this.h()},h(){w(l,"name","hf:doc:metadata"),w(l,"content",JSON.stringify(Xi)),w(i,"id","huggingface_hub.HfApi"),w(i,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),w(i,"href","#huggingface_hub.HfApi"),w(f,"class","relative group"),w(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Vt,"href","https://hf.co/docs/hub/main#how-can-i-rename-or-transfer-a-repo"),w(Vt,"rel","nofollow"),w(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(at,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(st,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ht,"id","huggingface_hub.HfFolder"),w(ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),w(ht,"href","#huggingface_hub.HfFolder"),w(Re,"class","relative group"),w(wo,"href","/docs/huggingface_hub/pr_930/en/package_reference/hf_api#huggingface_hub.HfFolder"),w(ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(mt,"id","huggingface_hub.DatasetFilter"),w(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),w(mt,"href","#huggingface_hub.DatasetFilter"),w(Ue,"class","relative group"),w(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(we,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,$){e(document.head,l),v(o,b,$),v(o,f,$),e(f,i),e(i,d),H(r,d,null),e(f,m),e(f,N),e(N,u),v(o,y,$),v(o,E,$),e(E,k),e(E,A),e(A,I),e(E,O),v(o,R,$),v(o,_,$),e(_,P),e(_,S),e(S,M),e(_,V),v(o,G,$),v(o,C,$),e(C,W),v(o,Z,$),H(J,o,$),v(o,re,$),v(o,ee,$),e(ee,Q),e(ee,X),e(X,Y),e(ee,me),v(o,_e,$),H(B,o,$),v(o,oe,$),v(o,K,$),e(K,xe),e(K,ae),e(ae,Pe),e(K,je),v(o,be,$),v(o,T,$),H(ne,T,null),e(T,$o),e(T,ve),H($e,ve,null),e(ve,yo),e(ve,Oe),e(Oe,ko),e(T,rn),e(T,Me),H(qt,Me,null),e(Me,ln),e(Me,To),e(To,cn),e(T,pn),e(T,ie),H(Dt,ie,null),e(ie,gn),e(ie,Io),e(Io,hn),e(ie,dn),e(ie,Lo),e(Lo,un),e(ie,fn),H(Se,ie,null),e(T,mn),e(T,He),H(Ft,He,null),e(He,_n),e(He,Po),e(Po,bn),e(He,vn),H(Ce,He,null),e(T,$n),e(T,qe),H(Nt,qe,null),e(qe,yn),e(qe,Oo),e(Oo,kn),e(qe,wn),H(ze,qe,null),e(T,An),e(T,Ve),H(Tt,Ve,null),e(Ve,En),e(Ve,Ro),e(Ro,xn),e(T,jn),e(T,Ge),H(It,Ge,null),e(Ge,Hn),e(Ge,Uo),e(Uo,qn),e(T,Dn),e(T,We),H(Lt,We,null),e(We,Fn),e(We,Mo),e(Mo,Nn),e(T,Tn),e(T,Be),H(Pt,Be,null),e(Be,In),e(Be,So),e(So,Ln),e(T,Pn),e(T,le),H(Ot,le,null),e(le,On),e(le,Co),e(Co,Rn),e(le,Un),H(Ke,le,null),e(le,Mn),H(Je,le,null),e(T,Sn),e(T,Qe),H(Rt,Qe,null),e(Qe,Cn),e(Qe,zo),e(zo,zn),e(T,Vn),e(T,ce),H(Ut,ce,null),e(ce,Gn),e(ce,Vo),e(Vo,Wn),e(ce,Bn),H(Xe,ce,null),e(ce,Kn),H(Ye,ce,null),e(T,Jn),e(T,Ze),H(Mt,Ze,null),e(Ze,Qn),e(Ze,Go),e(Go,Xn),e(T,Yn),e(T,pe),H(St,pe,null),e(pe,Zn),e(pe,Wo),e(Wo,es),e(pe,ts),e(pe,Bo),e(Bo,os),e(pe,as),H(et,pe,null),e(T,ns),e(T,ge),H(Ct,ge,null),e(ge,ss),e(ge,Ko),e(Ko,rs),e(ge,is),e(ge,zt),e(zt,ls),e(zt,Vt),e(Vt,cs),e(zt,ps),e(ge,gs),H(tt,ge,null),e(T,hs),e(T,De),H(Gt,De,null),e(De,ds),e(De,Jo),e(Jo,us),e(De,fs),H(ot,De,null),e(T,ms),e(T,at),H(Wt,at,null),e(at,_s),e(at,Qo),e(Qo,bs),e(T,vs),e(T,he),H(Bt,he,null),e(he,$s),e(he,Xo),e(Xo,ys),e(he,ks),e(he,Yo),e(Yo,ws),e(he,As),H(nt,he,null),e(T,Es),e(T,st),H(Kt,st,null),e(st,xs),e(st,Zo),e(Zo,js),e(T,Hs),e(T,Fe),H(Jt,Fe,null),e(Fe,qs),e(Fe,ea),e(ea,Ds),e(Fe,Fs),H(rt,Fe,null),e(T,Ns),e(T,de),H(Qt,de,null),e(de,Ts),e(de,ta),e(ta,Is),e(de,Ls),H(it,de,null),e(de,Ps),H(lt,de,null),e(T,Os),e(T,te),H(Xt,te,null),e(te,Rs),e(te,oa),e(oa,Us),e(te,Ms),e(te,aa),e(aa,Ss),e(te,Cs),e(te,Yt),e(Yt,zs),e(Yt,na),e(na,Vs),e(Yt,Gs),e(te,Ws),H(ct,te,null),e(te,Bs),H(pt,te,null),e(T,Ks),e(T,gt),H(Zt,gt,null),e(gt,Js),e(gt,sa),e(sa,Qs),v(o,Fa,$),v(o,Re,$),e(Re,ht),e(ht,ra),H(eo,ra,null),e(Re,Xs),e(Re,ia),e(ia,Ys),v(o,Na,$),v(o,to,$),e(to,la),e(la,Zs),e(to,er),v(o,Ta,$),v(o,dt,$),e(dt,tr),e(dt,wo),e(wo,or),e(dt,ar),v(o,Ia,$),v(o,se,$),H(oo,se,null),e(se,nr),e(se,ut),H(ao,ut,null),e(ut,sr),e(ut,ca),e(ca,rr),e(se,ir),e(se,Ne),H(no,Ne,null),e(Ne,lr),e(Ne,pa),e(pa,cr),e(Ne,pr),e(Ne,so),e(so,gr),e(so,ga),e(ga,hr),e(so,dr),e(se,ur),e(se,ft),H(ro,ft,null),e(ft,fr),e(ft,ha),e(ha,mr),v(o,La,$),v(o,Ue,$),e(Ue,mt),e(mt,da),H(io,da,null),e(Ue,_r),e(Ue,ua),e(ua,br),v(o,Pa,$),v(o,_t,$),e(_t,vr),e(_t,fa),e(fa,$r),e(_t,yr),v(o,Oa,$),v(o,ye,$),H(lo,ye,null),e(ye,kr),e(ye,ma),e(ma,wr),e(ye,Ar),H(bt,ye,null),v(o,Ra,$),v(o,ke,$),H(co,ke,null),e(ke,Er),e(ke,_a),e(_a,xr),e(ke,jr),H(vt,ke,null),v(o,Ua,$),v(o,we,$),H(po,we,null),e(we,Hr),e(we,ba),e(ba,qr),e(we,Dr),H($t,we,null),v(o,Ma,$),v(o,Ae,$),H(go,Ae,null),e(Ae,Fr),e(Ae,va),e(va,Nr),e(Ae,Tr),H(yt,Ae,null),Sa=!0},p(o,[$]){const ho={};$&2&&(ho.$$scope={dirty:$,ctx:o}),Se.$set(ho);const $a={};$&2&&($a.$$scope={dirty:$,ctx:o}),Ce.$set($a);const ya={};$&2&&(ya.$$scope={dirty:$,ctx:o}),ze.$set(ya);const ka={};$&2&&(ka.$$scope={dirty:$,ctx:o}),Ke.$set(ka);const uo={};$&2&&(uo.$$scope={dirty:$,ctx:o}),Je.$set(uo);const wa={};$&2&&(wa.$$scope={dirty:$,ctx:o}),Xe.$set(wa);const fo={};$&2&&(fo.$$scope={dirty:$,ctx:o}),Ye.$set(fo);const Aa={};$&2&&(Aa.$$scope={dirty:$,ctx:o}),et.$set(Aa);const Ea={};$&2&&(Ea.$$scope={dirty:$,ctx:o}),tt.$set(Ea);const mo={};$&2&&(mo.$$scope={dirty:$,ctx:o}),ot.$set(mo);const xa={};$&2&&(xa.$$scope={dirty:$,ctx:o}),nt.$set(xa);const _o={};$&2&&(_o.$$scope={dirty:$,ctx:o}),rt.$set(_o);const ja={};$&2&&(ja.$$scope={dirty:$,ctx:o}),it.$set(ja);const L={};$&2&&(L.$$scope={dirty:$,ctx:o}),lt.$set(L);const bo={};$&2&&(bo.$$scope={dirty:$,ctx:o}),ct.$set(bo);const Ha={};$&2&&(Ha.$$scope={dirty:$,ctx:o}),pt.$set(Ha);const vo={};$&2&&(vo.$$scope={dirty:$,ctx:o}),bt.$set(vo);const qa={};$&2&&(qa.$$scope={dirty:$,ctx:o}),vt.$set(qa);const Ee={};$&2&&(Ee.$$scope={dirty:$,ctx:o}),$t.$set(Ee);const Da={};$&2&&(Da.$$scope={dirty:$,ctx:o}),yt.$set(Da)},i(o){Sa||(q(r.$$.fragment,o),q(J.$$.fragment,o),q(B.$$.fragment,o),q(ne.$$.fragment,o),q($e.$$.fragment,o),q(qt.$$.fragment,o),q(Dt.$$.fragment,o),q(Se.$$.fragment,o),q(Ft.$$.fragment,o),q(Ce.$$.fragment,o),q(Nt.$$.fragment,o),q(ze.$$.fragment,o),q(Tt.$$.fragment,o),q(It.$$.fragment,o),q(Lt.$$.fragment,o),q(Pt.$$.fragment,o),q(Ot.$$.fragment,o),q(Ke.$$.fragment,o),q(Je.$$.fragment,o),q(Rt.$$.fragment,o),q(Ut.$$.fragment,o),q(Xe.$$.fragment,o),q(Ye.$$.fragment,o),q(Mt.$$.fragment,o),q(St.$$.fragment,o),q(et.$$.fragment,o),q(Ct.$$.fragment,o),q(tt.$$.fragment,o),q(Gt.$$.fragment,o),q(ot.$$.fragment,o),q(Wt.$$.fragment,o),q(Bt.$$.fragment,o),q(nt.$$.fragment,o),q(Kt.$$.fragment,o),q(Jt.$$.fragment,o),q(rt.$$.fragment,o),q(Qt.$$.fragment,o),q(it.$$.fragment,o),q(lt.$$.fragment,o),q(Xt.$$.fragment,o),q(ct.$$.fragment,o),q(pt.$$.fragment,o),q(Zt.$$.fragment,o),q(eo.$$.fragment,o),q(oo.$$.fragment,o),q(ao.$$.fragment,o),q(no.$$.fragment,o),q(ro.$$.fragment,o),q(io.$$.fragment,o),q(lo.$$.fragment,o),q(bt.$$.fragment,o),q(co.$$.fragment,o),q(vt.$$.fragment,o),q(po.$$.fragment,o),q($t.$$.fragment,o),q(go.$$.fragment,o),q(yt.$$.fragment,o),Sa=!0)},o(o){D(r.$$.fragment,o),D(J.$$.fragment,o),D(B.$$.fragment,o),D(ne.$$.fragment,o),D($e.$$.fragment,o),D(qt.$$.fragment,o),D(Dt.$$.fragment,o),D(Se.$$.fragment,o),D(Ft.$$.fragment,o),D(Ce.$$.fragment,o),D(Nt.$$.fragment,o),D(ze.$$.fragment,o),D(Tt.$$.fragment,o),D(It.$$.fragment,o),D(Lt.$$.fragment,o),D(Pt.$$.fragment,o),D(Ot.$$.fragment,o),D(Ke.$$.fragment,o),D(Je.$$.fragment,o),D(Rt.$$.fragment,o),D(Ut.$$.fragment,o),D(Xe.$$.fragment,o),D(Ye.$$.fragment,o),D(Mt.$$.fragment,o),D(St.$$.fragment,o),D(et.$$.fragment,o),D(Ct.$$.fragment,o),D(tt.$$.fragment,o),D(Gt.$$.fragment,o),D(ot.$$.fragment,o),D(Wt.$$.fragment,o),D(Bt.$$.fragment,o),D(nt.$$.fragment,o),D(Kt.$$.fragment,o),D(Jt.$$.fragment,o),D(rt.$$.fragment,o),D(Qt.$$.fragment,o),D(it.$$.fragment,o),D(lt.$$.fragment,o),D(Xt.$$.fragment,o),D(ct.$$.fragment,o),D(pt.$$.fragment,o),D(Zt.$$.fragment,o),D(eo.$$.fragment,o),D(oo.$$.fragment,o),D(ao.$$.fragment,o),D(no.$$.fragment,o),D(ro.$$.fragment,o),D(io.$$.fragment,o),D(lo.$$.fragment,o),D(bt.$$.fragment,o),D(co.$$.fragment,o),D(vt.$$.fragment,o),D(po.$$.fragment,o),D($t.$$.fragment,o),D(go.$$.fragment,o),D(yt.$$.fragment,o),Sa=!1},d(o){t(l),o&&t(b),o&&t(f),F(r),o&&t(y),o&&t(E),o&&t(R),o&&t(_),o&&t(G),o&&t(C),o&&t(Z),F(J,o),o&&t(re),o&&t(ee),o&&t(_e),F(B,o),o&&t(oe),o&&t(K),o&&t(be),o&&t(T),F(ne),F($e),F(qt),F(Dt),F(Se),F(Ft),F(Ce),F(Nt),F(ze),F(Tt),F(It),F(Lt),F(Pt),F(Ot),F(Ke),F(Je),F(Rt),F(Ut),F(Xe),F(Ye),F(Mt),F(St),F(et),F(Ct),F(tt),F(Gt),F(ot),F(Wt),F(Bt),F(nt),F(Kt),F(Jt),F(rt),F(Qt),F(it),F(lt),F(Xt),F(ct),F(pt),F(Zt),o&&t(Fa),o&&t(Re),F(eo),o&&t(Na),o&&t(to),o&&t(Ta),o&&t(dt),o&&t(Ia),o&&t(se),F(oo),F(ao),F(no),F(ro),o&&t(La),o&&t(Ue),F(io),o&&t(Pa),o&&t(_t),o&&t(Oa),o&&t(ye),F(lo),F(bt),o&&t(Ra),o&&t(ke),F(co),F(vt),o&&t(Ua),o&&t(we),F(po),F($t),o&&t(Ma),o&&t(Ae),F(go),F(yt)}}}const Xi={local:"huggingface_hub.HfApi",sections:[{local:"huggingface_hub.HfFolder",title:"Hugging Face local storage"},{local:"huggingface_hub.DatasetFilter",title:"Filtering helpers"}],title:"Hugging Face Hub API"};function Yi(U){return qi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class sl extends Ei{constructor(l){super();xi(this,l,Yi,Qi,ji,{})}}export{sl as default,Xi as metadata};
