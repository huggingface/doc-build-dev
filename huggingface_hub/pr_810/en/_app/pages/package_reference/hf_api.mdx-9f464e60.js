...
`),A=n(j,"A",{href:!0});var N=o(A);w=g(N,"HfApi.set_access_token()"),N.forEach(a),H=g(j," instead."),j.forEach(a),this.h()},h(){c(A,"href","/docs/huggingface_hub/pr_810/en/package_reference/hf_api#huggingface_hub.HfApi.set_access_token")},m($,j){y($,p,j),e(p,q),e(p,A),e(A,w),e(p,H)},d($){$&&a(p)}}}function El(J){let p,q,A,w,H,$,j,N,O;return{c(){p=s("p"),q=l("Raises the following errors:"),A=r(),w=s("ul"),H=s("li"),$=s("a"),j=s("code"),N=l("HTTPError"),O=l(`
