import{S as Br,i as Kr,s as Jr,e as o,k as l,w as k,t as c,M as Qr,c as n,d as a,m as g,a as s,x as w,h as p,b as y,F as e,g as b,y as A,q as j,o as H,B as x,v as Xr,L as de}from"../../chunks/vendor-a09ded63.js";import{T as Qa}from"../../chunks/Tip-27a54654.js";import{D as N}from"../../chunks/Docstring-3f63de13.js";import{C as Z}from"../../chunks/CodeBlock-879da7fe.js";import{I as or}from"../../chunks/IconCopyLink-3f5556be.js";import{E as he}from"../../chunks/ExampleCodeBlock-7aff195a.js";function Yr(P){let i,$,d,f,m,r,h,q,u,v,F,L,M,O,S;return{c(){i=o("p"),$=c("Raises the following errors:"),d=l(),f=o("ul"),m=o("li"),r=o("a"),h=o("code"),q=c("HTTPError"),u=c(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_models(search=<span class="hljs-string">&quot;bert&quot;</span>, author=<span class="hljs-string">&quot;google&quot;</span>)`}}),{c(){i=o("p"),$=c("Example usage with the "),d=o("code"),f=c("search"),m=c(" argument:"),r=l(),k(h.$$.fragment)},l(u){i=n(u,"P",{});var v=s(i);$=p(v,"Example usage with the "),d=n(v,"CODE",{});var F=s(d);f=p(F,"search"),F.forEach(a),m=p(v," argument:"),v.forEach(a),r=g(u),w(h.$$.fragment,u)},m(u,v){b(u,i,v),e(i,$),e(i,d),e(d,f),e(i,m),b(u,r,v),A(h,u,v),q=!0},p:de,i(u){q||(j(h.$$.fragment,u),q=!0)},o(u){H(h.$$.fragment,u),q=!1},d(u){u&&a(i),u&&a(r),x(h,u)}}}function oi(P){let i,$,d,f,m;return{c(){i=o("p"),$=c(`Warning: Deprecated, will be removed in v0.7. Please use
`),d=o("a"),f=c("HfApi.set_access_token()"),m=c(" instead."),this.h()},l(r){i=n(r,"P",{});var h=s(i);$=p(h,`Warning: Deprecated, will be removed in v0.7. Please use
`),d=n(h,"A",{href:!0});var q=s(d);f=p(q,"HfApi.set_access_token()"),q.forEach(a),m=p(h," instead."),h.forEach(a),this.h()},h(){y(d,"href","/docs/huggingface_hub/pr_874/en/package_reference/hf_api#huggingface_hub.HfApi.set_access_token")},m(r,h){b(r,i,h),e(i,$),e(i,d),e(d,f),e(i,m)},d(r){r&&a(i)}}}function ni(P){let i,$,d,f,m,r,h,q,u;return{c(){i=o("p"),$=c("Raises the following errors:"),d=l(),f=o("ul"),m=o("li"),r=o("a"),h=o("code"),q=c("HTTPError"),u=c(`
...
if credentials are invalid`),M.forEach(a),L.forEach(a),this.h()},h(){y(r,"href","https://2.python-requests.org/en/master/api/#requests.HTTPError"),y(r,"rel","nofollow")},m(v,F){b(v,i,F),e(i,$),b(v,d,F),b(v,f,F),e(f,m),e(m,r),e(r,h),e(h,q),e(m,u)},d(v){v&&a(i),v&&a(d),v&&a(f)}}}function si(P){let i,$,d,f,m;return{c(){i=o("p"),$=c(`Warning: Deprecated, will be removed in v0.7. Please use
`),d=o("a"),f=c("HfApi.unset_access_token()"),m=c(" instead."),this.h()},l(r){i=n(r,"P",{});var h=s(i);$=p(h,`Warning: Deprecated, will be removed in v0.7. Please use
`),d=n(h,"A",{href:!0});var q=s(d);f=p(q,"HfApi.unset_access_token()"),q.forEach(a),m=p(h," instead."),h.forEach(a),this.h()},h(){y(d,"href","/docs/huggingface_hub/pr_874/en/package_reference/hf_api#huggingface_hub.HfApi.unset_access_token")},m(r,h){b(r,i,h),e(i,$),e(i,d),e(d,f),e(i,m)},d(r){r&&a(i)}}}function ri(P){let i,$,d,f,m,r,h,q,u,v,F,L,M,O,S;return{c(){i=o("p"),$=c("Raises the following errors:"),d=l(),f=o("ul"),m=o("li"),r=o("a"),h=o("code"),q=c("HTTPError"),u=c(`
if the HuggingFace API returned an error`),v=l(),F=o("li"),L=o("a"),M=o("code"),O=c("ValueError"),S=c(`
if some parameter value is invalid`),this.h()},l(T){i=n(T,"P",{});var I=s(i);$=p(I,"Raises the following errors:"),I.forEach(a),d=g(T),f=n(T,"UL",{});var U=s(f);m=n(U,"LI",{});var C=s(m);r=n(C,"A",{href:!0,rel:!0});var ie=s(r);h=n(ie,"CODE",{});var le=s(h);q=p(le,"HTTPError"),le.forEach(a),ie.forEach(a),u=p(C,`
if the HuggingFace API returned an error`),C.forEach(a),v=g(U),F=n(U,"LI",{});var V=s(F);L=n(V,"A",{href:!0,rel:!0});var G=s(L);M=n(G,"CODE",{});var ge=s(M);O=p(ge,"ValueError"),ge.forEach(a),G.forEach(a),S=p(V,`
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1370",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1199",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1930",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),lt=new N({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L742"}}),gt=new N({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/pr_874/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/pr_874/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1329",returnDescription:`
...
The password of the account with which to login.`,name:"password"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L555",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1149",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1285",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1242",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1591",returnDescription:`
...
and its content did not change.`,name:"identical_ok"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_874/src/huggingface_hub/hf_api.py#L1727",returnDescription:`
