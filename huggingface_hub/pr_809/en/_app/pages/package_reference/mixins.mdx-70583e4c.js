import{S as Cn,i as qn,s as Fn,e as t,k as d,w as v,t as r,M as Ln,c as a,d as n,m as l,a as i,x as y,h as s,b as g,F as e,g as u,y as w,q as k,o as x,B as $,v as Kn}from"../../chunks/vendor-7b1da053.js";import{T as An}from"../../chunks/Tip-41a95816.js";import{D as Y}from"../../chunks/Docstring-f1352b16.js";import{I as so}from"../../chunks/IconCopyLink-d24e9a6f.js";function Wn(he){let h,T,m,f,M;return{c(){h=t("p"),T=r("Passing "),m=t("code"),f=r("use_auth_token=True"),M=r(` is required when you want to use a
...
model_kwargs will be passed to the model during initialization`,name:"model_kwargs"}]}}),B=new An({props:{$$slots:{default:[Un]},$$scope:{ctx:he}}}),ie=new Y({props:{name:"huggingface_hub.push_to_hub_keras",anchor:"huggingface_hub.push_to_hub_keras",parameters:[{name:"model",val:""},{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"log_dir",val:": typing.Optional[str] = None"},{name:"commit_message",val:": typing.Optional[str] = 'Add model'"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"api_endpoint",val:": typing.Optional[str] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = True"},{name:"git_user",val:": typing.Optional[str] = None"},{name:"git_email",val:": typing.Optional[str] = None"},{name:"config",val:": typing.Optional[dict] = None"},{name:"include_optimizer",val:": typing.Optional[bool] = False"},{name:"task_name",val:": typing.Optional[str] = None"},{name:"plot_model",val:": typing.Optional[bool] = True"},{name:"multiple_model_save_args",val:": typing.Optional[typing.Dict] = None"},{name:"**model_save_kwargs",val:""}],source:"https://github.com/huggingface/huggingface_hub/blob/pr_809/src/huggingface_hub/keras_mixin.py#L326",parametersDescription:[{anchor:"huggingface_hub.push_to_hub_keras.model",description:`<strong>model</strong> (<code>Keras.Model</code> or <code>dict</code>) &#x2014;
...
The model(s) must be compiled and built.`,name:"model"},{anchor:"huggingface_hub.push_to_hub_keras.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
config.`,name:"config"},{anchor:"huggingface_hub.push_to_hub_keras.include_optimizer",description:`<strong>include_optimizer</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
card. Requires graphviz and pydot to be installed.`,name:"plot_model"},{anchor:"huggingface_hub.push_to_hub_keras.multiple_model_save_args",description:`<strong>multiple_model_save_args</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
Model save parameters as dictionary, where keys are model identifiers and
values are dictionary of parameters.`,name:"multiple_model_save_args"},{anchor:"huggingface_hub.push_to_hub_keras.model_save_kwargs(dict,",description:`<strong>model_save_kwargs(<code>dict</code>,</strong> <em>optional</em>) &#x2014;
...
<p>The url of the commit of your model in the given repository.</p>
`}}),se=new Y({props:{name:"huggingface_hub.save_pretrained_keras",anchor:"huggingface_hub.save_pretrained_keras",parameters:[{name:"model",val:""},{name:"save_directory",val:": str"},{name:"config",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"include_optimizer",val:": typing.Optional[bool] = False"},{name:"plot_model",val:": typing.Optional[bool] = True"},{name:"task_name",val:": typing.Optional[str] = None"},{name:"multiple_model_save_args",val:": typing.Optional[typing.Dict] = None"},{name:"**model_save_kwargs",val:""}],source:"https://github.com/huggingface/huggingface_hub/blob/pr_809/src/huggingface_hub/keras_mixin.py#L169",parametersDescription:[{anchor:"huggingface_hub.save_pretrained_keras.model",description:`<strong>model</strong> (<code>Keras.Model</code> or <code>dict</code>) &#x2014;
...
and built.`,name:"model"},{anchor:"huggingface_hub.save_pretrained_keras.save_directory",description:`<strong>save_directory</strong> (<code>str</code>) &#x2014;
...
those models.`,name:"config"},{anchor:"huggingface_hub.save_pretrained_keras.include_optimizer(bool,",description:`<strong>include_optimizer(<code>bool</code>,</strong> <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
See `),$e=t("code"),xo=r("huggingface_hub.PyTorchModelHubMixin"),$o=r(" for an example."),Mo=d(),P=t("div"),v(Z.$$.fragment),To=d(),I=t("p"),Eo=r(`Instantiate a pretrained PyTorch model from a pre-trained model
...
back in training mode with `),Te=t("code"),Oo=r("model.train()"),Po=r("."),Do=d(),v(W.$$.fragment),No=d(),U=t("div"),v(ee.$$.fragment),So=d(),oe=t("p"),Io=r(`Upload model checkpoint or tokenizer files to the Hub while
synchronizing a local clone of the repo in `),Ee=t("code"),Ao=r("repo_path_or_name"),Co=r("."),qo=d(),V=t("div"),v(ne.$$.fragment),Fo=d(),He=t("p"),Lo=r("Save weights in local directory."),Ve=d(),A=t("h3"),j=t("a"),ze=t("span"),v(te.$$.fragment),Ko=d(),Oe=t("span"),Wo=r("Keras"),je=d(),z=t("div"),v(ae.$$.fragment),Uo=d(),Pe=t("p"),Vo=r("Instantiate a pretrained Keras model from a pre-trained model from the Hub.\nThe model is expected to be in SavedModel format.```"),jo=d(),v(B.$$.fragment),Be=d(),C=t("div"),v(ie.$$.fragment),Bo=d(),re=t("p"),Ro=r(`Upload model checkpoint or tokenizer files to the Hub while synchronizing a
...
you\u2019re using the Functional or Sequential APIs.`),Ge=d(),O=t("div"),v(de.$$.fragment),Xo=d(),Se=t("p"),Zo=r(`Mixin to provide model Hub upload/download capabilities to Keras models.
...
See `),$e=a(G,"CODE",{});var wn=i($e);xo=s(wn,"huggingface_hub.PyTorchModelHubMixin"),wn.forEach(n),$o=s(G," for an example."),G.forEach(n),Mo=l(D),P=a(D,"DIV",{class:!0});var ue=i(P);y(Z.$$.fragment,ue),To=l(ue),I=a(ue,"P",{});var me=i(I);Eo=s(me,`Instantiate a pretrained PyTorch model from a pre-trained model
configuration from huggingface-hub. The model is set in
evaluation mode by default using `),Me=a(me,"CODE",{});var kn=i(Me);Ho=s(kn,"model.eval()"),kn.forEach(n),zo=s(me,` (Dropout modules
are deactivated). To train the model, you should first set it
back in training mode with `),Te=a(me,"CODE",{});var xn=i(Te);Oo=s(xn,"model.train()"),xn.forEach(n),Po=s(me,"."),me.forEach(n),Do=l(ue),y(W.$$.fragment,ue),ue.forEach(n),No=l(D),U=a(D,"DIV",{class:!0});var Ze=i(U);y(ee.$$.fragment,Ze),So=l(Ze),oe=a(Ze,"P",{});var eo=i(oe);Io=s(eo,`Upload model checkpoint or tokenizer files to the Hub while
synchronizing a local clone of the repo in `),Ee=a(eo,"CODE",{});var $n=i(Ee);Ao=s($n,"repo_path_or_name"),$n.forEach(n),Co=s(eo,"."),eo.forEach(n),Ze.forEach(n),qo=l(D),V=a(D,"DIV",{class:!0});var oo=i(V);y(ne.$$.fragment,oo),Fo=l(oo),He=a(oo,"P",{});var Mn=i(He);Lo=s(Mn,"Save weights in local directory."),Mn.forEach(n),oo.forEach(n),D.forEach(n),Ve=l(o),A=a(o,"H3",{class:!0});var no=i(A);j=a(no,"A",{id:!0,class:!0,href:!0});var Tn=i(j);ze=a(Tn,"SPAN",{});var En=i(ze);y(te.$$.fragment,En),En.forEach(n),Tn.forEach(n),Ko=l(no),Oe=a(no,"SPAN",{});var Hn=i(Oe);Wo=s(Hn,"Keras"),Hn.forEach(n),no.forEach(n),je=l(o),z=a(o,"DIV",{class:!0});var pe=i(z);y(ae.$$.fragment,pe),Uo=l(pe),Pe=a(pe,"P",{});var zn=i(Pe);Vo=s(zn,"Instantiate a pretrained Keras model from a pre-trained model from the Hub.\nThe model is expected to be in SavedModel format.```"),zn.forEach(n),jo=l(pe),y(B.$$.fragment,pe),pe.forEach(n),Be=l(o),C=a(o,"DIV",{class:!0});var to=i(C);y(ie.$$.fragment,to),Bo=l(to),re=a(to,"P",{});var ao=i(re);Ro=s(ao,`Upload model checkpoint or tokenizer files to the Hub while synchronizing a
local clone of the repo in `),De=a(ao,"CODE",{});var On=i(De);Go=s(On,"repo_path_or_name"),On.forEach(n),Yo=s(ao,"."),ao.forEach(n),to.forEach(n),Re=l(o),q=a(o,"DIV",{class:!0});var io=i(q);y(se.$$.fragment,io),Jo=l(io),Ne=a(io,"P",{});var Pn=i(Ne);Qo=s(Pn,`Saves a Keras model to save_directory in SavedModel format. Use this if
you\u2019re using the Functional or Sequential APIs.`),Pn.forEach(n),io.forEach(n),Ge=l(o),O=a(o,"DIV",{class:!0});var _e=i(O);y(de.$$.fragment,_e),Xo=l(_e),Se=a(_e,"P",{});var Dn=i(Se);Zo=s(Dn,`Mixin to provide model Hub upload/download capabilities to Keras models.
Override this class to obtain the following internal methods:`),Dn.forEach(n),en=l(_e),le=a(_e,"UL",{});var ro=i(le);ge=a(ro,"LI",{});var ln=i(ge);Ie=a(ln,"CODE",{});var Nn=i(Ie);on=s(Nn,"_from_pretrained"),Nn.forEach(n),nn=s(ln,", to load a model from the Hub or from local files."),ln.forEach(n),tn=l(ro),R=a(ro,"LI",{});var Fe=i(R);Ae=a(Fe,"CODE",{});var Sn=i(Ae);an=s(Sn,"_save_pretrained"),Sn.forEach(n),rn=s(Fe,", to save a model in the "),Ce=a(Fe,"CODE",{});var In=i(Ce);sn=s(In,"SavedModel"),In.forEach(n),dn=s(Fe," format."),Fe.forEach(n),ro.forEach(n),_e.forEach(n),this.h()},h(){g(h,"name","hf:doc:metadata"),g(h,"content",JSON.stringify(jn)),g(f,"id","mixins-serialization-methods"),g(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(f,"href","#mixins-serialization-methods"),g(m,"class","relative group"),g(F,"id","mixins"),g(F,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(F,"href","#mixins"),g(N,"class","relative group"),g(K,"id","huggingface_hub.ModelHubMixin"),g(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(K,"href","#huggingface_hub.ModelHubMixin"),g(S,"class","relative group"),g(P,"class","docstring"),g(U,"class","docstring"),g(V,"class","docstring"),g(b,"class","docstring"),g(j,"id","huggingface_hub.from_pretrained_keras"),g(j,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(j,"href","#huggingface_hub.from_pretrained_keras"),g(A,"class","relative group"),g(z,"class","docstring"),g(C,"class","docstring"),g(q,"class","docstring"),g(O,"class","docstring")},m(o,c){e(document.head,h),u(o,T,c),u(o,m,c),e(m,f),e(f,M),w(p,M,null),e(m,_),e(m,E),e(E,lo),u(o,Le,c),u(o,N,c),e(N,F),e(F,fe),w(J,fe,null),e(N,co),e(N,be),e(be,ho),u(o,Ke,c),u(o,L,c),e(L,go),e(L,ve),e(ve,uo),e(L,mo),u(o,We,c),u(o,S,c),e(S,K),e(K,ye),w(Q,ye,null),e(S,po),e(S,we),e(we,_o),u(o,Ue,c),u(o,b,c),w(X,b,null),e(b,fo),e(b,H),e(H,bo),e(H,ke),e(ke,vo),e(H,yo),e(H,xe),e(xe,wo),e(H,ko),e(H,$e),e($e,xo),e(H,$o),e(b,Mo),e(b,P),w(Z,P,null),e(P,To),e(P,I),e(I,Eo),e(I,Me),e(Me,Ho),e(I,zo),e(I,Te),e(Te,Oo),e(I,Po),e(P,Do),w(W,P,null),e(b,No),e(b,U),w(ee,U,null),e(U,So),e(U,oe),e(oe,Io),e(oe,Ee),e(Ee,Ao),e(oe,Co),e(b,qo),e(b,V),w(ne,V,null),e(V,Fo),e(V,He),e(He,Lo),u(o,Ve,c),u(o,A,c),e(A,j),e(j,ze),w(te,ze,null),e(A,Ko),e(A,Oe),e(Oe,Wo),u(o,je,c),u(o,z,c),w(ae,z,null),e(z,Uo),e(z,Pe),e(Pe,Vo),e(z,jo),w(B,z,null),u(o,Be,c),u(o,C,c),w(ie,C,null),e(C,Bo),e(C,re),e(re,Ro),e(re,De),e(De,Go),e(re,Yo),u(o,Re,c),u(o,q,c),w(se,q,null),e(q,Jo),e(q,Ne),e(Ne,Qo),u(o,Ge,c),u(o,O,c),w(de,O,null),e(O,Xo),e(O,Se),e(Se,Zo),e(O,en),e(O,le),e(le,ge),e(ge,Ie),e(Ie,on),e(ge,nn),e(le,tn),e(le,R),e(R,Ae),e(Ae,an),e(R,rn),e(R,Ce),e(Ce,sn),e(R,dn),Ye=!0},p(o,[c]){const ce={};c&2&&(ce.$$scope={dirty:c,ctx:o}),W.$set(ce);const qe={};c&2&&(qe.$$scope={dirty:c,ctx:o}),B.$set(qe)},i(o){Ye||(k(p.$$.fragment,o),k(J.$$.fragment,o),k(Q.$$.fragment,o),k(X.$$.fragment,o),k(Z.$$.fragment,o),k(W.$$.fragment,o),k(ee.$$.fragment,o),k(ne.$$.fragment,o),k(te.$$.fragment,o),k(ae.$$.fragment,o),k(B.$$.fragment,o),k(ie.$$.fragment,o),k(se.$$.fragment,o),k(de.$$.fragment,o),Ye=!0)},o(o){x(p.$$.fragment,o),x(J.$$.fragment,o),x(Q.$$.fragment,o),x(X.$$.fragment,o),x(Z.$$.fragment,o),x(W.$$.fragment,o),x(ee.$$.fragment,o),x(ne.$$.fragment,o),x(te.$$.fragment,o),x(ae.$$.fragment,o),x(B.$$.fragment,o),x(ie.$$.fragment,o),x(se.$$.fragment,o),x(de.$$.fragment,o),Ye=!1},d(o){n(h),o&&n(T),o&&n(m),$(p),o&&n(Le),o&&n(N),$(J),o&&n(Ke),o&&n(L),o&&n(We),o&&n(S),$(Q),o&&n(Ue),o&&n(b),$(X),$(Z),$(W),$(ee),$(ne),o&&n(Ve),o&&n(A),$(te),o&&n(je),o&&n(z),$(ae),$(B),o&&n(Be),o&&n(C),$(ie),o&&n(Re),o&&n(q),$(se),o&&n(Ge),o&&n(O),$(de)}}}const jn={local:"mixins-serialization-methods",sections:[{local:"mixins",sections:[{local:"huggingface_hub.ModelHubMixin",title:"PyTorch"},{local:"huggingface_hub.from_pretrained_keras",title:"Keras"}],title:"Mixins"}],title:"Mixins & serialization methods"};function Bn(he){return Kn(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Qn extends Cn{constructor(h){super();qn(this,h,Bn,Vn,Fn,{})}}export{Qn as default,jn as metadata};
