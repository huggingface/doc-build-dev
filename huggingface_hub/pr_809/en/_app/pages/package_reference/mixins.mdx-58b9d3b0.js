...
Setting this to <code>True</code> will plot the model and put it in the model
card. Requires graphviz and pydot to be installed.`,name:"plot_model"},{anchor:"huggingface_hub.save_pretrained_keras.multiple_model_save_args",description:`<strong>multiple_model_save_args</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
Model save parameters as dictionary, where keys are model identifiers
and values are dictionary of parameters.`,name:"multiple_model_save_args"},{anchor:"huggingface_hub.save_pretrained_keras.task_name",description:`<strong>task_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Name of the task the model was trained on. Available tasks
