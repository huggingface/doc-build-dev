import{S as Cn,i as qn,s as Ln,e as t,k as d,w as v,t as r,M as Fn,c as a,d as n,m as l,a as i,x as y,h as s,b as g,F as e,g as u,y as w,q as k,o as x,B as $,v as Kn}from"../../chunks/vendor-7b1da053.js";import{T as In}from"../../chunks/Tip-41a95816.js";import{D as Y}from"../../chunks/Docstring-f1352b16.js";import{I as so}from"../../chunks/IconCopyLink-d24e9a6f.js";function Un(he){let h,T,m,f,M;return{c(){h=t("p"),T=r("Passing "),m=t("code"),f=r("use_auth_token=True"),M=r(` is required when you want to use a
...
<a href="https://github.com/huggingface/hub-docs/blame/main/modelcard.md" rel="nofollow">here</a>.`,name:"tags"},{anchor:"huggingface_hub.push_to_hub_keras.task_name",description:`<strong>task_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
Whether or not to include optimizer in serialization.`,name:"include_optimizer(bool,"},{anchor:"huggingface_hub.save_pretrained_keras.tags",description:`<strong>tags</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
List of tags that are related to model or string of a single tag. See example tags
<a href="https://github.com/huggingface/hub-docs/blame/main/modelcard.md" rel="nofollow">here</a>.`,name:"tags"},{anchor:"huggingface_hub.save_pretrained_keras.task_name",description:`<strong>task_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Name of the task the model was trained on. Available tasks
<a href="https://github.com/huggingface/hub-docs/blob/main/js/src/lib/interfaces/Types.ts" rel="nofollow">here</a>.
This is deprecated in favor of <code>tags</code> and will be removed in v0.7.`,name:"task_name"},{anchor:"huggingface_hub.save_pretrained_keras.plot_model",description:`<strong>plot_model</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Setting this to <code>True</code> will plot the model and put it in the model
card. Requires graphviz and pydot to be installed.`,name:"plot_model"},{anchor:"huggingface_hub.save_pretrained_keras.model_save_kwargs(dict,",description:`<strong>model_save_kwargs(<code>dict</code>,</strong> <em>optional</em>) &#x2014;
model_save_kwargs will be passed to
<a href="https://www.tensorflow.org/api_docs/python/tf/keras/models/save_model" rel="nofollow"><code>tf.keras.models.save_model()</code></a>.`,name:"model_save_kwargs(dict,"}]}}),de=new Y({props:{name:"class huggingface_hub.KerasModelHubMixin",anchor:"huggingface_hub.KerasModelHubMixin",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/huggingface_hub/blob/pr_806/src/huggingface_hub/keras_mixin.py#L433"}}),{c(){h=t("meta"),T=d(),m=t("h1"),f=t("a"),M=t("span"),v(p.$$.fragment),_=d(),E=t("span"),lo=r("Mixins & serialization methods"),Fe=d(),D=t("h2"),L=t("a"),fe=t("span"),v(J.$$.fragment),co=d(),be=t("span"),ho=r("Mixins"),Ke=d(),F=t("p"),go=r("The "),ve=t("code"),uo=r("huggingface_hub"),mo=r(` library offers a range of mixins that can be used as a parent class for your
...
back in training mode with `),Te=t("code"),Po=r("model.train()"),Oo=r("."),No=d(),v(U.$$.fragment),Do=d(),W=t("div"),v(ee.$$.fragment),So=d(),oe=t("p"),Ao=r(`Upload model checkpoint or tokenizer files to the Hub while
synchronizing a local clone of the repo in `),Ee=t("code"),Io=r("repo_path_or_name"),Co=r("."),qo=d(),V=t("div"),v(ne.$$.fragment),Lo=d(),He=t("p"),Fo=r("Save weights in local directory."),Ve=d(),I=t("h3"),j=t("a"),ze=t("span"),v(te.$$.fragment),Ko=d(),Pe=t("span"),Uo=r("Keras"),je=d(),z=t("div"),v(ae.$$.fragment),Wo=d(),Oe=t("p"),Vo=r("Instantiate a pretrained Keras model from a pre-trained model from the Hub.\nThe model is expected to be in SavedModel format.```"),jo=d(),v(B.$$.fragment),Be=d(),C=t("div"),v(ie.$$.fragment),Bo=d(),re=t("p"),Ro=r(`Upload model checkpoint or tokenizer files to the Hub while synchronizing a
local clone of the repo in `),Ne=t("code"),Go=r("repo_path_or_name"),Yo=r("."),Re=d(),q=t("div"),v(se.$$.fragment),Jo=d(),De=t("p"),Qo=r(`Saves a Keras model to save_directory in SavedModel format. Use this if
...
See `),$e=a(G,"CODE",{});var wn=i($e);xo=s(wn,"huggingface_hub.PyTorchModelHubMixin"),wn.forEach(n),$o=s(G," for an example."),G.forEach(n),Mo=l(N),O=a(N,"DIV",{class:!0});var ue=i(O);y(Z.$$.fragment,ue),To=l(ue),A=a(ue,"P",{});var me=i(A);Eo=s(me,`Instantiate a pretrained PyTorch model from a pre-trained model
configuration from huggingface-hub. The model is set in
evaluation mode by default using `),Me=a(me,"CODE",{});var kn=i(Me);Ho=s(kn,"model.eval()"),kn.forEach(n),zo=s(me,` (Dropout modules
are deactivated). To train the model, you should first set it
back in training mode with `),Te=a(me,"CODE",{});var xn=i(Te);Po=s(xn,"model.train()"),xn.forEach(n),Oo=s(me,"."),me.forEach(n),No=l(ue),y(U.$$.fragment,ue),ue.forEach(n),Do=l(N),W=a(N,"DIV",{class:!0});var Ze=i(W);y(ee.$$.fragment,Ze),So=l(Ze),oe=a(Ze,"P",{});var eo=i(oe);Ao=s(eo,`Upload model checkpoint or tokenizer files to the Hub while
synchronizing a local clone of the repo in `),Ee=a(eo,"CODE",{});var $n=i(Ee);Io=s($n,"repo_path_or_name"),$n.forEach(n),Co=s(eo,"."),eo.forEach(n),Ze.forEach(n),qo=l(N),V=a(N,"DIV",{class:!0});var oo=i(V);y(ne.$$.fragment,oo),Lo=l(oo),He=a(oo,"P",{});var Mn=i(He);Fo=s(Mn,"Save weights in local directory."),Mn.forEach(n),oo.forEach(n),N.forEach(n),Ve=l(o),I=a(o,"H3",{class:!0});var no=i(I);j=a(no,"A",{id:!0,class:!0,href:!0});var Tn=i(j);ze=a(Tn,"SPAN",{});var En=i(ze);y(te.$$.fragment,En),En.forEach(n),Tn.forEach(n),Ko=l(no),Pe=a(no,"SPAN",{});var Hn=i(Pe);Uo=s(Hn,"Keras"),Hn.forEach(n),no.forEach(n),je=l(o),z=a(o,"DIV",{class:!0});var pe=i(z);y(ae.$$.fragment,pe),Wo=l(pe),Oe=a(pe,"P",{});var zn=i(Oe);Vo=s(zn,"Instantiate a pretrained Keras model from a pre-trained model from the Hub.\nThe model is expected to be in SavedModel format.```"),zn.forEach(n),jo=l(pe),y(B.$$.fragment,pe),pe.forEach(n),Be=l(o),C=a(o,"DIV",{class:!0});var to=i(C);y(ie.$$.fragment,to),Bo=l(to),re=a(to,"P",{});var ao=i(re);Ro=s(ao,`Upload model checkpoint or tokenizer files to the Hub while synchronizing a
local clone of the repo in `),Ne=a(ao,"CODE",{});var Pn=i(Ne);Go=s(Pn,"repo_path_or_name"),Pn.forEach(n),Yo=s(ao,"."),ao.forEach(n),to.forEach(n),Re=l(o),q=a(o,"DIV",{class:!0});var io=i(q);y(se.$$.fragment,io),Jo=l(io),De=a(io,"P",{});var On=i(De);Qo=s(On,`Saves a Keras model to save_directory in SavedModel format. Use this if
you\u2019re using the Functional or Sequential APIs.`),On.forEach(n),io.forEach(n),Ge=l(o),P=a(o,"DIV",{class:!0});var _e=i(P);y(de.$$.fragment,_e),Xo=l(_e),Se=a(_e,"P",{});var Nn=i(Se);Zo=s(Nn,`Mixin to provide model Hub upload/download capabilities to Keras models.
Override this class to obtain the following internal methods:`),Nn.forEach(n),en=l(_e),le=a(_e,"UL",{});var ro=i(le);ge=a(ro,"LI",{});var ln=i(ge);Ae=a(ln,"CODE",{});var Dn=i(Ae);on=s(Dn,"_from_pretrained"),Dn.forEach(n),nn=s(ln,", to load a model from the Hub or from local files."),ln.forEach(n),tn=l(ro),R=a(ro,"LI",{});var Le=i(R);Ie=a(Le,"CODE",{});var Sn=i(Ie);an=s(Sn,"_save_pretrained"),Sn.forEach(n),rn=s(Le,", to save a model in the "),Ce=a(Le,"CODE",{});var An=i(Ce);sn=s(An,"SavedModel"),An.forEach(n),dn=s(Le," format."),Le.forEach(n),ro.forEach(n),_e.forEach(n),this.h()},h(){g(h,"name","hf:doc:metadata"),g(h,"content",JSON.stringify(jn)),g(f,"id","mixins-serialization-methods"),g(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(f,"href","#mixins-serialization-methods"),g(m,"class","relative group"),g(L,"id","mixins"),g(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(L,"href","#mixins"),g(D,"class","relative group"),g(K,"id","huggingface_hub.ModelHubMixin"),g(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(K,"href","#huggingface_hub.ModelHubMixin"),g(S,"class","relative group"),g(O,"class","docstring"),g(W,"class","docstring"),g(V,"class","docstring"),g(b,"class","docstring"),g(j,"id","huggingface_hub.from_pretrained_keras"),g(j,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(j,"href","#huggingface_hub.from_pretrained_keras"),g(I,"class","relative group"),g(z,"class","docstring"),g(C,"class","docstring"),g(q,"class","docstring"),g(P,"class","docstring")},m(o,c){e(document.head,h),u(o,T,c),u(o,m,c),e(m,f),e(f,M),w(p,M,null),e(m,_),e(m,E),e(E,lo),u(o,Fe,c),u(o,D,c),e(D,L),e(L,fe),w(J,fe,null),e(D,co),e(D,be),e(be,ho),u(o,Ke,c),u(o,F,c),e(F,go),e(F,ve),e(ve,uo),e(F,mo),u(o,Ue,c),u(o,S,c),e(S,K),e(K,ye),w(Q,ye,null),e(S,po),e(S,we),e(we,_o),u(o,We,c),u(o,b,c),w(X,b,null),e(b,fo),e(b,H),e(H,bo),e(H,ke),e(ke,vo),e(H,yo),e(H,xe),e(xe,wo),e(H,ko),e(H,$e),e($e,xo),e(H,$o),e(b,Mo),e(b,O),w(Z,O,null),e(O,To),e(O,A),e(A,Eo),e(A,Me),e(Me,Ho),e(A,zo),e(A,Te),e(Te,Po),e(A,Oo),e(O,No),w(U,O,null),e(b,Do),e(b,W),w(ee,W,null),e(W,So),e(W,oe),e(oe,Ao),e(oe,Ee),e(Ee,Io),e(oe,Co),e(b,qo),e(b,V),w(ne,V,null),e(V,Lo),e(V,He),e(He,Fo),u(o,Ve,c),u(o,I,c),e(I,j),e(j,ze),w(te,ze,null),e(I,Ko),e(I,Pe),e(Pe,Uo),u(o,je,c),u(o,z,c),w(ae,z,null),e(z,Wo),e(z,Oe),e(Oe,Vo),e(z,jo),w(B,z,null),u(o,Be,c),u(o,C,c),w(ie,C,null),e(C,Bo),e(C,re),e(re,Ro),e(re,Ne),e(Ne,Go),e(re,Yo),u(o,Re,c),u(o,q,c),w(se,q,null),e(q,Jo),e(q,De),e(De,Qo),u(o,Ge,c),u(o,P,c),w(de,P,null),e(P,Xo),e(P,Se),e(Se,Zo),e(P,en),e(P,le),e(le,ge),e(ge,Ae),e(Ae,on),e(ge,nn),e(le,tn),e(le,R),e(R,Ie),e(Ie,an),e(R,rn),e(R,Ce),e(Ce,sn),e(R,dn),Ye=!0},p(o,[c]){const ce={};c&2&&(ce.$$scope={dirty:c,ctx:o}),U.$set(ce);const qe={};c&2&&(qe.$$scope={dirty:c,ctx:o}),B.$set(qe)},i(o){Ye||(k(p.$$.fragment,o),k(J.$$.fragment,o),k(Q.$$.fragment,o),k(X.$$.fragment,o),k(Z.$$.fragment,o),k(U.$$.fragment,o),k(ee.$$.fragment,o),k(ne.$$.fragment,o),k(te.$$.fragment,o),k(ae.$$.fragment,o),k(B.$$.fragment,o),k(ie.$$.fragment,o),k(se.$$.fragment,o),k(de.$$.fragment,o),Ye=!0)},o(o){x(p.$$.fragment,o),x(J.$$.fragment,o),x(Q.$$.fragment,o),x(X.$$.fragment,o),x(Z.$$.fragment,o),x(U.$$.fragment,o),x(ee.$$.fragment,o),x(ne.$$.fragment,o),x(te.$$.fragment,o),x(ae.$$.fragment,o),x(B.$$.fragment,o),x(ie.$$.fragment,o),x(se.$$.fragment,o),x(de.$$.fragment,o),Ye=!1},d(o){n(h),o&&n(T),o&&n(m),$(p),o&&n(Fe),o&&n(D),$(J),o&&n(Ke),o&&n(F),o&&n(Ue),o&&n(S),$(Q),o&&n(We),o&&n(b),$(X),$(Z),$(U),$(ee),$(ne),o&&n(Ve),o&&n(I),$(te),o&&n(je),o&&n(z),$(ae),$(B),o&&n(Be),o&&n(C),$(ie),o&&n(Re),o&&n(q),$(se),o&&n(Ge),o&&n(P),$(de)}}}const jn={local:"mixins-serialization-methods",sections:[{local:"mixins",sections:[{local:"huggingface_hub.ModelHubMixin",title:"PyTorch"},{local:"huggingface_hub.from_pretrained_keras",title:"Keras"}],title:"Mixins"}],title:"Mixins & serialization methods"};function Bn(he){return Kn(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Qn extends Cn{constructor(h){super();qn(this,h,Bn,Vn,Ln,{})}}export{Qn as default,jn as metadata};
