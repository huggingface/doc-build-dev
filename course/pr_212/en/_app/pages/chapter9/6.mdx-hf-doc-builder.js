import{S as is,i as ls,s as ps,e as a,k as h,w as ie,t as n,M as cs,c as o,d as t,m as u,a as r,x as le,h as i,b as p,X as ns,G as s,g as c,y as pe,L as hs,q as ce,o as he,B as ue,v as us}from"../../chunks/vendor-hf-doc-builder.js";import{I as It}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{C as rs}from"../../chunks/CodeBlock-hf-doc-builder.js";function ds(At){let b,de,v,j,z,$,Le,W,Oe,fe,H,De,me,_,E,R,I,Ue,V,Be,we,q,Fe,Y,Je,ze,ge,L,We,ye,g,A,Re,X,Ve,Ye,Xe,P,Ke,K,Qe,Ze,et,N,tt,Q,st,at,be,O,ot,ve,S,_e,m,Pt,ke,D,nt,je,k,x,Z,T,rt,ee,it,Ee,U,lt,qe,G,xe,B,pt,$e,w,Nt,Ie,d,ct,te,ht,ut,se,dt,ft,ae,mt,wt,C,gt,yt,oe,bt,vt,M,_t,kt,Ae,y,jt,ne,Et,qt,re,xt,$t,Pe;return $=new It({}),I=new It({}),S=new rs({props:{code:`import random
...
persist data as the user interacts with the model. Note that session state does not share data between different users of your model.`),ge=h(),L=a("p"),We=n("To store data in a session state, you need to do three things:"),ye=h(),g=a("ol"),A=a("li"),Re=n("Pass in an "),X=a("em"),Ve=n("extra parameter"),Ye=n(" into your function, which represents the state of the interface."),Xe=h(),P=a("li"),Ke=n("At the end of the function, return the updated value of the state as an "),K=a("em"),Qe=n("extra return value"),Ze=n("."),et=h(),N=a("li"),tt=n("Add the \u2018state\u2019 input and \u2018state\u2019 output components when creating your "),Q=a("code"),st=n("Interface"),at=n("."),be=h(),O=a("p"),ot=n("See the chatbot example below:"),ve=h(),ie(S.$$.fragment),_e=h(),m=a("iframe"),ke=h(),D=a("p"),nt=n(`Notice how the state of the output component persists across submits.
