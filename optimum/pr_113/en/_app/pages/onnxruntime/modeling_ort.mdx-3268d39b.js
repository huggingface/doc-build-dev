import{S as ji,i as Fi,s as Ri,e as n,k as l,w as h,t as a,M as Ai,c as s,d as o,m,a as r,x as f,h as i,b as c,F as e,g as u,y as g,q as _,o as k,B as w,v as Ci}from"../../chunks/vendor-4918fc3c.js";import{T as vn}from"../../chunks/Tip-3d800dd6.js";import{D as L}from"../../chunks/Docstring-1b707a93.js";import{C as X}from"../../chunks/CodeBlock-99419108.js";import{I as qe}from"../../chunks/IconCopyLink-21d338b1.js";function Pi(W){let d,O,v,$,y;return{c(){d=n("p"),O=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),$=a("Module"),y=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){d=s(T,"P",{});var x=r(d);O=i(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(x,"CODE",{});var j=r(v);$=i(j,"Module"),j.forEach(o),y=i(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(T,x){u(T,d,x),e(d,O),e(d,v),e(v,$),e(d,y)},d(T){T&&o(d)}}}function Ni(W){let d,O,v,$,y;return{c(){d=n("p"),O=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),$=a("Module"),y=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){d=s(T,"P",{});var x=r(d);O=i(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(x,"CODE",{});var j=r(v);$=i(j,"Module"),j.forEach(o),y=i(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(T,x){u(T,d,x),e(d,O),e(d,v),e(v,$),e(d,y)},d(T){T&&o(d)}}}function Si(W){let d,O,v,$,y;return{c(){d=n("p"),O=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),$=a("Module"),y=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){d=s(T,"P",{});var x=r(d);O=i(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(x,"CODE",{});var j=r(v);$=i(j,"Module"),j.forEach(o),y=i(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(T,x){u(T,d,x),e(d,O),e(d,v),e(v,$),e(d,y)},d(T){T&&o(d)}}}function Di(W){let d,O,v,$,y;return{c(){d=n("p"),O=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),$=a("Module"),y=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){d=s(T,"P",{});var x=r(d);O=i(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(x,"CODE",{});var j=r(v);$=i(j,"Module"),j.forEach(o),y=i(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(T,x){u(T,d,x),e(d,O),e(d,v),e(v,$),e(d,y)},d(T){T&&o(d)}}}function Ii(W){let d,O,v,$,y,T,x,j,Tn,Eo,me,xn,_t,$n,bn,jo,K,pe,bt,Me,yn,yt,On,Fo,N,qn,Ot,Mn,zn,qt,En,jn,Mt,Fn,Rn,zt,An,Cn,Ro,ze,Ao,H,Pn,Et,Nn,Sn,jt,Dn,In,Ft,Hn,Qn,Co,Ee,Po,ce,Ln,kt,Xn,Wn,No,Z,de,Rt,je,Bn,At,Un,So,Q,Gn,Ct,Vn,Jn,Fe,Yn,Kn,Pt,Zn,es,Do,Re,Io,ee,ue,Nt,Ae,ts,St,os,Ho,F,Ce,ns,Pe,ss,Dt,rs,as,is,he,Ne,ls,wt,ms,It,ps,cs,fe,Se,ds,Ht,us,hs,ge,De,fs,Qt,gs,Qo,te,_e,Lt,Ie,_s,Xt,ks,Lo,R,He,ws,Wt,vs,Ts,Qe,xs,Bt,$s,bs,ys,Ut,Os,qs,q,Le,Ms,oe,zs,Gt,Es,js,Vt,Fs,Rs,As,ke,Cs,Jt,Ps,Ns,Xe,Ss,We,Ds,Yt,Is,Hs,Qs,Be,Xo,ne,we,Kt,Ue,Ls,Zt,Xs,Wo,A,Ge,Ws,eo,Bs,Us,Ve,Gs,to,Vs,Js,Ys,oo,Ks,Zs,M,Je,er,se,tr,no,or,nr,so,sr,rr,ar,ve,ir,ro,lr,mr,Ye,pr,Ke,cr,ao,dr,ur,hr,Ze,Bo,re,Te,io,et,fr,lo,gr,Uo,C,tt,_r,mo,kr,wr,ot,vr,po,Tr,xr,$r,co,br,yr,b,nt,Or,ae,qr,uo,Mr,zr,ho,Er,jr,Fr,xe,Rr,fo,Ar,Cr,st,Pr,rt,Nr,go,Sr,Dr,Ir,at,Hr,it,Qr,_o,Lr,Xr,Wr,lt,Go,ie,$e,ko,mt,Br,wo,Ur,Vo,P,pt,Gr,vo,Vr,Jr,ct,Yr,To,Kr,Zr,ea,xo,ta,oa,z,dt,na,le,sa,$o,ra,aa,bo,ia,la,ma,be,pa,yo,ca,da,ut,ua,ht,ha,Oo,fa,ga,_a,ft,Jo;return T=new qe({}),Me=new qe({}),ze=new X({props:{code:`from transformers import AutoTokenizer, pipeline
...
question = &quot;What&#x27;s my name?&quot;
context = &quot;My name is Philipp and I live in Nuremberg.&quot;
pred = onnx_qa(question, context)`}}),Ee=new X({props:{code:`from transformers import AutoTokenizer, pipeline
...
result = onnx_clx(text=<span class="hljs-string">&quot;This is a great model&quot;</span>)`}}),je=new qe({}),Re=new X({props:{code:`from transformers import AutoTokenizer
from optimum.onnxruntime import ORTModelForSequenceClassification
...
<li>0 for tokens that are <strong>sentence B</strong>.
<a href="https://huggingface.co/docs/transformers/glossary#token-type-ids" rel="nofollow">What are token type IDs?</a></li>
</ul>`,name:"token_type_ids"}]}}),xe=new vn({props:{$$slots:{default:[Si]},$$scope:{ctx:W}}}),st=new X({props:{code:`from transformers import AutoTokenizer
from optimum.onnxruntime import ORTModelForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My Name is Philipp and i live in Germany.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>pred = onnx_ner(text)`}}),{c(){d=n("meta"),O=l(),v=n("h1"),$=n("a"),y=n("span"),h(T.$$.fragment),x=l(),j=n("span"),Tn=a("Optimum Inference with ONNX Runtime"),Eo=l(),me=n("p"),xn=a(`Optimum Inference is a utility package for building and running inference with accelerated runtime like ONNX Runtime.
Optimum Inference can be used to load optimized models from the `),_t=n("a"),$n=a("Hugging Face Hub"),bn=a(` and create pipelines
to run accelerated inference without rewriting your APIs.`),jo=l(),K=n("h2"),pe=n("a"),bt=n("span"),h(Me.$$.fragment),yn=l(),yt=n("span"),On=a("Switching from Transformers to Optimum Inference"),Fo=l(),N=n("p"),qn=a("The Optimum Inference models are API compatible with Hugging Face Transformers models. This means you can just replace your "),Ot=n("code"),Mn=a("AutoModelForXxx"),zn=a(" class with the corresponding "),qt=n("code"),En=a("ORTModelForXxx"),jn=a(" class in "),Mt=n("code"),Fn=a("optimum"),Rn=a(". For example, this is how you can use a question answering model in "),zt=n("code"),An=a("optimum"),Cn=a(":"),Ro=l(),h(ze.$$.fragment),Ao=l(),H=n("p"),Pn=a("Optimum Inference also includes methods to convert vanilla Transformers models to optimized ones via the "),Et=n("code"),Nn=a('from_pretrained("{model_id}",from_transformers=True)'),Sn=a(` method.
After you have converted a model you can even `),jt=n("code"),Dn=a("optimize"),In=a(" or "),Ft=n("code"),Hn=a("quantize"),Qn=a(" the model if it is supported by the runtime you use."),Co=l(),h(Ee.$$.fragment),Po=l(),ce=n("p"),Ln=a("You can find a complete walkhrough Optimum Inference for ONNX Runtime in this "),kt=n("a"),Xn=a("notebook"),Wn=a("."),No=l(),Z=n("h3"),de=n("a"),Rt=n("span"),h(je.$$.fragment),Bn=l(),At=n("span"),Un=a("Working with the [Hugging Face Model Hub](https://hf.co/models)"),So=l(),Q=n("p"),Gn=a("The Optimum model classes, e.g. "),Ct=n("code"),Vn=a("ORTModel"),Jn=a(" are directly integrated with the "),Fe=n("a"),Yn=a("Hugging Face Model Hub"),Kn=a(`) meaning you can not only
...
from the Hub and converts it to an optimum model and pushes it back into a new repository.`),Do=l(),h(Re.$$.fragment),Io=l(),ee=n("h2"),ue=n("a"),Nt=n("span"),h(Ae.$$.fragment),ts=l(),St=n("span"),os=a("ORTModel"),Ho=l(),F=n("div"),h(Ce.$$.fragment),ns=l(),Pe=n("p"),ss=a(`Base ORTModel class for implementing models using ONNX Runtime. The ORTModel implements generic methods for interacting
...
pooled output) e.g. for GLUE tasks.`),wr=l(),ot=n("p"),vr=a("This model inherits from "),po=n("code"),Tr=a("ORTModel"),xr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving)`),$r=l(),co=n("p"),br=a("Sequence Classification model for ONNX."),yr=l(),b=n("div"),h(nt.$$.fragment),Or=l(),ae=n("p"),qr=a("The "),uo=n("code"),Mr=a("ORTModelForSequenceClassification"),zr=a(" forward method, overrides the "),ho=n("code"),Er=a("__call__"),jr=a(" special method."),Fr=l(),h(xe.$$.fragment),Rr=l(),fo=n("p"),Ar=a("Example of single-label classification:"),Cr=l(),h(st.$$.fragment),Pr=l(),rt=n("p"),Nr=a("Example using "),go=n("code"),Sr=a("transformers.pipelines"),Dr=a(":"),Ir=l(),h(at.$$.fragment),Hr=l(),it=n("p"),Qr=a("Example using zero-shot-classification "),_o=n("code"),Lr=a("transformers.pipelines"),Xr=a(":"),Wr=l(),h(lt.$$.fragment),Go=l(),ie=n("h2"),$e=n("a"),ko=n("span"),h(mt.$$.fragment),Br=l(),wo=n("span"),Ur=a("ORTModelForTokenClassification"),Vo=l(),P=n("div"),h(pt.$$.fragment),Gr=l(),vo=n("p"),Vr=a(`Onnx Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving)`),ea=l(),xo=n("p"),ta=a("Sequence Classification model for ONNX."),oa=l(),z=n("div"),h(dt.$$.fragment),na=l(),le=n("p"),sa=a("The "),$o=n("code"),ra=a("ORTModelForTokenClassification"),aa=a(" forward method, overrides the "),bo=n("code"),ia=a("__call__"),la=a(" special method."),ma=l(),h(be.$$.fragment),pa=l(),yo=n("p"),ca=a("Example of token classification:"),da=l(),h(ut.$$.fragment),ua=l(),ht=n("p"),ha=a("Example using "),Oo=n("code"),fa=a("transformers.pipelines"),ga=a(":"),_a=l(),h(ft.$$.fragment),this.h()},l(t){const p=Ai('[data-svelte="svelte-1phssyn"]',document.head);d=s(p,"META",{name:!0,content:!0}),p.forEach(o),O=m(t),v=s(t,"H1",{class:!0});var gt=r(v);$=s(gt,"A",{id:!0,class:!0,href:!0});var qo=r($);y=s(qo,"SPAN",{});var Mo=r(y);f(T.$$.fragment,Mo),Mo.forEach(o),qo.forEach(o),x=m(gt),j=s(gt,"SPAN",{});var zo=r(j);Tn=i(zo,"Optimum Inference with ONNX Runtime"),zo.forEach(o),gt.forEach(o),Eo=m(t),me=s(t,"P",{});var Yo=r(me);xn=i(Yo,`Optimum Inference is a utility package for building and running inference with accelerated runtime like ONNX Runtime.
Optimum Inference can be used to load optimized models from the `),_t=s(Yo,"A",{href:!0});var wa=r(_t);$n=i(wa,"Hugging Face Hub"),wa.forEach(o),bn=i(Yo,` and create pipelines
to run accelerated inference without rewriting your APIs.`),Yo.forEach(o),jo=m(t),K=s(t,"H2",{class:!0});var Ko=r(K);pe=s(Ko,"A",{id:!0,class:!0,href:!0});var va=r(pe);bt=s(va,"SPAN",{});var Ta=r(bt);f(Me.$$.fragment,Ta),Ta.forEach(o),va.forEach(o),yn=m(Ko),yt=s(Ko,"SPAN",{});var xa=r(yt);On=i(xa,"Switching from Transformers to Optimum Inference"),xa.forEach(o),Ko.forEach(o),Fo=m(t),N=s(t,"P",{});var B=r(N);qn=i(B,"The Optimum Inference models are API compatible with Hugging Face Transformers models. This means you can just replace your "),Ot=s(B,"CODE",{});var $a=r(Ot);Mn=i($a,"AutoModelForXxx"),$a.forEach(o),zn=i(B," class with the corresponding "),qt=s(B,"CODE",{});var ba=r(qt);En=i(ba,"ORTModelForXxx"),ba.forEach(o),jn=i(B," class in "),Mt=s(B,"CODE",{});var ya=r(Mt);Fn=i(ya,"optimum"),ya.forEach(o),Rn=i(B,". For example, this is how you can use a question answering model in "),zt=s(B,"CODE",{});var Oa=r(zt);An=i(Oa,"optimum"),Oa.forEach(o),Cn=i(B,":"),B.forEach(o),Ro=m(t),f(ze.$$.fragment,t),Ao=m(t),H=s(t,"P",{});var ye=r(H);Pn=i(ye,"Optimum Inference also includes methods to convert vanilla Transformers models to optimized ones via the "),Et=s(ye,"CODE",{});var qa=r(Et);Nn=i(qa,'from_pretrained("{model_id}",from_transformers=True)'),qa.forEach(o),Sn=i(ye,` method.
After you have converted a model you can even `),jt=s(ye,"CODE",{});var Ma=r(jt);Dn=i(Ma,"optimize"),Ma.forEach(o),In=i(ye," or "),Ft=s(ye,"CODE",{});var za=r(Ft);Hn=i(za,"quantize"),za.forEach(o),Qn=i(ye," the model if it is supported by the runtime you use."),ye.forEach(o),Co=m(t),f(Ee.$$.fragment,t),Po=m(t),ce=s(t,"P",{});var Zo=r(ce);Ln=i(Zo,"You can find a complete walkhrough Optimum Inference for ONNX Runtime in this "),kt=s(Zo,"A",{href:!0});var Ea=r(kt);Xn=i(Ea,"notebook"),Ea.forEach(o),Wn=i(Zo,"."),Zo.forEach(o),No=m(t),Z=s(t,"H3",{class:!0});var en=r(Z);de=s(en,"A",{id:!0,class:!0,href:!0});var ja=r(de);Rt=s(ja,"SPAN",{});var Fa=r(Rt);f(je.$$.fragment,Fa),Fa.forEach(o),ja.forEach(o),Bn=m(en),At=s(en,"SPAN",{});var Ra=r(At);Un=i(Ra,"Working with the [Hugging Face Model Hub](https://hf.co/models)"),Ra.forEach(o),en.forEach(o),So=m(t),Q=s(t,"P",{});var Oe=r(Q);Gn=i(Oe,"The Optimum model classes, e.g. "),Ct=s(Oe,"CODE",{});var Aa=r(Ct);Vn=i(Aa,"ORTModel"),Aa.forEach(o),Jn=i(Oe," are directly integrated with the "),Fe=s(Oe,"A",{href:!0,rel:!0});var Ca=r(Fe);Yn=i(Ca,"Hugging Face Model Hub"),Ca.forEach(o),Kn=i(Oe,`) meaning you can not only
...
from the Hub and converts it to an optimum model and pushes it back into a new repository.`),Oe.forEach(o),Do=m(t),f(Re.$$.fragment,t),Io=m(t),ee=s(t,"H2",{class:!0});var tn=r(ee);ue=s(tn,"A",{id:!0,class:!0,href:!0});var Na=r(ue);Nt=s(Na,"SPAN",{});var Sa=r(Nt);f(Ae.$$.fragment,Sa),Sa.forEach(o),Na.forEach(o),ts=m(tn),St=s(tn,"SPAN",{});var Da=r(St);os=i(Da,"ORTModel"),Da.forEach(o),tn.forEach(o),Ho=m(t),F=s(t,"DIV",{class:!0});var U=r(F);f(Ce.$$.fragment,U),ns=m(U),Pe=s(U,"P",{});var on=r(Pe);ss=i(on,`Base ORTModel class for implementing models using ONNX Runtime. The ORTModel implements generic methods for interacting
...
pooled output) e.g. for GLUE tasks.`),ui.forEach(o),wr=m(J),ot=s(J,"P",{});var hn=r(ot);vr=i(hn,"This model inherits from "),po=s(hn,"CODE",{});var hi=r(po);Tr=i(hi,"ORTModel"),hi.forEach(o),xr=i(hn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving)`),hn.forEach(o),$r=m(J),co=s(J,"P",{});var fi=r(co);br=i(fi,"Sequence Classification model for ONNX."),fi.forEach(o),yr=m(J),b=s(J,"DIV",{class:!0});var E=r(b);f(nt.$$.fragment,E),Or=m(E),ae=s(E,"P",{});var xt=r(ae);qr=i(xt,"The "),uo=s(xt,"CODE",{});var gi=r(uo);Mr=i(gi,"ORTModelForSequenceClassification"),gi.forEach(o),zr=i(xt," forward method, overrides the "),ho=s(xt,"CODE",{});var _i=r(ho);Er=i(_i,"__call__"),_i.forEach(o),jr=i(xt," special method."),xt.forEach(o),Fr=m(E),f(xe.$$.fragment,E),Rr=m(E),fo=s(E,"P",{});var ki=r(fo);Ar=i(ki,"Example of single-label classification:"),ki.forEach(o),Cr=m(E),f(st.$$.fragment,E),Pr=m(E),rt=s(E,"P",{});var fn=r(rt);Nr=i(fn,"Example using "),go=s(fn,"CODE",{});var wi=r(go);Sr=i(wi,"transformers.pipelines"),wi.forEach(o),Dr=i(fn,":"),fn.forEach(o),Ir=m(E),f(at.$$.fragment,E),Hr=m(E),it=s(E,"P",{});var gn=r(it);Qr=i(gn,"Example using zero-shot-classification "),_o=s(gn,"CODE",{});var vi=r(_o);Lr=i(vi,"transformers.pipelines"),vi.forEach(o),Xr=i(gn,":"),gn.forEach(o),Wr=m(E),f(lt.$$.fragment,E),E.forEach(o),J.forEach(o),Go=m(t),ie=s(t,"H2",{class:!0});var _n=r(ie);$e=s(_n,"A",{id:!0,class:!0,href:!0});var Ti=r($e);ko=s(Ti,"SPAN",{});var xi=r(ko);f(mt.$$.fragment,xi),xi.forEach(o),Ti.forEach(o),Br=m(_n),wo=s(_n,"SPAN",{});var $i=r(wo);Ur=i($i,"ORTModelForTokenClassification"),$i.forEach(o),_n.forEach(o),Vo=m(t),P=s(t,"DIV",{class:!0});var Y=r(P);f(pt.$$.fragment,Y),Gr=m(Y),vo=s(Y,"P",{});var bi=r(vo);Vr=i(bi,`Onnx Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving)`),kn.forEach(o),ea=m(Y),xo=s(Y,"P",{});var Oi=r(xo);ta=i(Oi,"Sequence Classification model for ONNX."),Oi.forEach(o),oa=m(Y),z=s(Y,"DIV",{class:!0});var I=r(z);f(dt.$$.fragment,I),na=m(I),le=s(I,"P",{});var $t=r(le);sa=i($t,"The "),$o=s($t,"CODE",{});var qi=r($o);ra=i(qi,"ORTModelForTokenClassification"),qi.forEach(o),aa=i($t," forward method, overrides the "),bo=s($t,"CODE",{});var Mi=r(bo);ia=i(Mi,"__call__"),Mi.forEach(o),la=i($t," special method."),$t.forEach(o),ma=m(I),f(be.$$.fragment,I),pa=m(I),yo=s(I,"P",{});var zi=r(yo);ca=i(zi,"Example of token classification:"),zi.forEach(o),da=m(I),f(ut.$$.fragment,I),ua=m(I),ht=s(I,"P",{});var wn=r(ht);ha=i(wn,"Example using "),Oo=s(wn,"CODE",{});var Ei=r(Oo);fa=i(Ei,"transformers.pipelines"),Ei.forEach(o),ga=i(wn,":"),wn.forEach(o),_a=m(I),f(ft.$$.fragment,I),I.forEach(o),Y.forEach(o),this.h()},h(){c(d,"name","hf:doc:metadata"),c(d,"content",JSON.stringify(Hi)),c($,"id","optimum-inference-with-onnx-runtime"),c($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($,"href","#optimum-inference-with-onnx-runtime"),c(v,"class","relative group"),c(_t,"href","hf.co/models"),c(pe,"id","switching-from-transformers-to-optimum-inference"),c(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(pe,"href","#switching-from-transformers-to-optimum-inference"),c(K,"class","relative group"),c(kt,"href","xx"),c(de,"id","working-with-the-hugging-face-model-hubhttpshfcomodels"),c(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(de,"href","#working-with-the-hugging-face-model-hubhttpshfcomodels"),c(Z,"class","relative group"),c(Fe,"href","https://hf.co/models"),c(Fe,"rel","nofollow"),c(ue,"id","optimum.onnxruntime.ORTModel"),c(ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ue,"href","#optimum.onnxruntime.ORTModel"),c(ee,"class","relative group"),c(he,"class","docstring"),c(fe,"class","docstring"),c(ge,"class","docstring"),c(F,"class","docstring"),c(_e,"id","optimum.onnxruntime.ORTModelForFeatureExtraction"),c(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_e,"href","#optimum.onnxruntime.ORTModelForFeatureExtraction"),c(te,"class","relative group"),c(q,"class","docstring"),c(R,"class","docstring"),c(we,"id","optimum.onnxruntime.ORTModelForQuestionAnswering"),c(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(we,"href","#optimum.onnxruntime.ORTModelForQuestionAnswering"),c(ne,"class","relative group"),c(M,"class","docstring"),c(A,"class","docstring"),c(Te,"id","optimum.onnxruntime.ORTModelForSequenceClassification"),c(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Te,"href","#optimum.onnxruntime.ORTModelForSequenceClassification"),c(re,"class","relative group"),c(b,"class","docstring"),c(C,"class","docstring"),c($e,"id","optimum.onnxruntime.ORTModelForTokenClassification"),c($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($e,"href","#optimum.onnxruntime.ORTModelForTokenClassification"),c(ie,"class","relative group"),c(z,"class","docstring"),c(P,"class","docstring")},m(t,p){e(document.head,d),u(t,O,p),u(t,v,p),e(v,$),e($,y),g(T,y,null),e(v,x),e(v,j),e(j,Tn),u(t,Eo,p),u(t,me,p),e(me,xn),e(me,_t),e(_t,$n),e(me,bn),u(t,jo,p),u(t,K,p),e(K,pe),e(pe,bt),g(Me,bt,null),e(K,yn),e(K,yt),e(yt,On),u(t,Fo,p),u(t,N,p),e(N,qn),e(N,Ot),e(Ot,Mn),e(N,zn),e(N,qt),e(qt,En),e(N,jn),e(N,Mt),e(Mt,Fn),e(N,Rn),e(N,zt),e(zt,An),e(N,Cn),u(t,Ro,p),g(ze,t,p),u(t,Ao,p),u(t,H,p),e(H,Pn),e(H,Et),e(Et,Nn),e(H,Sn),e(H,jt),e(jt,Dn),e(H,In),e(H,Ft),e(Ft,Hn),e(H,Qn),u(t,Co,p),g(Ee,t,p),u(t,Po,p),u(t,ce,p),e(ce,Ln),e(ce,kt),e(kt,Xn),e(ce,Wn),u(t,No,p),u(t,Z,p),e(Z,de),e(de,Rt),g(je,Rt,null),e(Z,Bn),e(Z,At),e(At,Un),u(t,So,p),u(t,Q,p),e(Q,Gn),e(Q,Ct),e(Ct,Vn),e(Q,Jn),e(Q,Fe),e(Fe,Yn),e(Q,Kn),e(Q,Pt),e(Pt,Zn),e(Q,es),u(t,Do,p),g(Re,t,p),u(t,Io,p),u(t,ee,p),e(ee,ue),e(ue,Nt),g(Ae,Nt,null),e(ee,ts),e(ee,St),e(St,os),u(t,Ho,p),u(t,F,p),g(Ce,F,null),e(F,ns),e(F,Pe),e(Pe,ss),e(Pe,Dt),e(Dt,rs),e(Pe,as),e(F,is),e(F,he),g(Ne,he,null),e(he,ls),e(he,wt),e(wt,ms),e(wt,It),e(It,ps),e(F,cs),e(F,fe),g(Se,fe,null),e(fe,ds),e(fe,Ht),e(Ht,us),e(F,hs),e(F,ge),g(De,ge,null),e(ge,fs),e(ge,Qt),e(Qt,gs),u(t,Qo,p),u(t,te,p),e(te,_e),e(_e,Lt),g(Ie,Lt,null),e(te,_s),e(te,Xt),e(Xt,ks),u(t,Lo,p),u(t,R,p),g(He,R,null),e(R,ws),e(R,Wt),e(Wt,vs),e(R,Ts),e(R,Qe),e(Qe,xs),e(Qe,Bt),e(Bt,$s),e(Qe,bs),e(R,ys),e(R,Ut),e(Ut,Os),e(R,qs),e(R,q),g(Le,q,null),e(q,Ms),e(q,oe),e(oe,zs),e(oe,Gt),e(Gt,Es),e(oe,js),e(oe,Vt),e(Vt,Fs),e(oe,Rs),e(q,As),g(ke,q,null),e(q,Cs),e(q,Jt),e(Jt,Ps),e(q,Ns),g(Xe,q,null),e(q,Ss),e(q,We),e(We,Ds),e(We,Yt),e(Yt,Is),e(We,Hs),e(q,Qs),g(Be,q,null),u(t,Xo,p),u(t,ne,p),e(ne,we),e(we,Kt),g(Ue,Kt,null),e(ne,Ls),e(ne,Zt),e(Zt,Xs),u(t,Wo,p),u(t,A,p),g(Ge,A,null),e(A,Ws),e(A,eo),e(eo,Bs),e(A,Us),e(A,Ve),e(Ve,Gs),e(Ve,to),e(to,Vs),e(Ve,Js),e(A,Ys),e(A,oo),e(oo,Ks),e(A,Zs),e(A,M),g(Je,M,null),e(M,er),e(M,se),e(se,tr),e(se,no),e(no,or),e(se,nr),e(se,so),e(so,sr),e(se,rr),e(M,ar),g(ve,M,null),e(M,ir),e(M,ro),e(ro,lr),e(M,mr),g(Ye,M,null),e(M,pr),e(M,Ke),e(Ke,cr),e(Ke,ao),e(ao,dr),e(Ke,ur),e(M,hr),g(Ze,M,null),u(t,Bo,p),u(t,re,p),e(re,Te),e(Te,io),g(et,io,null),e(re,fr),e(re,lo),e(lo,gr),u(t,Uo,p),u(t,C,p),g(tt,C,null),e(C,_r),e(C,mo),e(mo,kr),e(C,wr),e(C,ot),e(ot,vr),e(ot,po),e(po,Tr),e(ot,xr),e(C,$r),e(C,co),e(co,br),e(C,yr),e(C,b),g(nt,b,null),e(b,Or),e(b,ae),e(ae,qr),e(ae,uo),e(uo,Mr),e(ae,zr),e(ae,ho),e(ho,Er),e(ae,jr),e(b,Fr),g(xe,b,null),e(b,Rr),e(b,fo),e(fo,Ar),e(b,Cr),g(st,b,null),e(b,Pr),e(b,rt),e(rt,Nr),e(rt,go),e(go,Sr),e(rt,Dr),e(b,Ir),g(at,b,null),e(b,Hr),e(b,it),e(it,Qr),e(it,_o),e(_o,Lr),e(it,Xr),e(b,Wr),g(lt,b,null),u(t,Go,p),u(t,ie,p),e(ie,$e),e($e,ko),g(mt,ko,null),e(ie,Br),e(ie,wo),e(wo,Ur),u(t,Vo,p),u(t,P,p),g(pt,P,null),e(P,Gr),e(P,vo),e(vo,Vr),e(P,Jr),e(P,ct),e(ct,Yr),e(ct,To),e(To,Kr),e(ct,Zr),e(P,ea),e(P,xo),e(xo,ta),e(P,oa),e(P,z),g(dt,z,null),e(z,na),e(z,le),e(le,sa),e(le,$o),e($o,ra),e(le,aa),e(le,bo),e(bo,ia),e(le,la),e(z,ma),g(be,z,null),e(z,pa),e(z,yo),e(yo,ca),e(z,da),g(ut,z,null),e(z,ua),e(z,ht),e(ht,ha),e(ht,Oo),e(Oo,fa),e(ht,ga),e(z,_a),g(ft,z,null),Jo=!0},p(t,[p]){const gt={};p&2&&(gt.$$scope={dirty:p,ctx:t}),ke.$set(gt);const qo={};p&2&&(qo.$$scope={dirty:p,ctx:t}),ve.$set(qo);const Mo={};p&2&&(Mo.$$scope={dirty:p,ctx:t}),xe.$set(Mo);const zo={};p&2&&(zo.$$scope={dirty:p,ctx:t}),be.$set(zo)},i(t){Jo||(_(T.$$.fragment,t),_(Me.$$.fragment,t),_(ze.$$.fragment,t),_(Ee.$$.fragment,t),_(je.$$.fragment,t),_(Re.$$.fragment,t),_(Ae.$$.fragment,t),_(Ce.$$.fragment,t),_(Ne.$$.fragment,t),_(Se.$$.fragment,t),_(De.$$.fragment,t),_(Ie.$$.fragment,t),_(He.$$.fragment,t),_(Le.$$.fragment,t),_(ke.$$.fragment,t),_(Xe.$$.fragment,t),_(Be.$$.fragment,t),_(Ue.$$.fragment,t),_(Ge.$$.fragment,t),_(Je.$$.fragment,t),_(ve.$$.fragment,t),_(Ye.$$.fragment,t),_(Ze.$$.fragment,t),_(et.$$.fragment,t),_(tt.$$.fragment,t),_(nt.$$.fragment,t),_(xe.$$.fragment,t),_(st.$$.fragment,t),_(at.$$.fragment,t),_(lt.$$.fragment,t),_(mt.$$.fragment,t),_(pt.$$.fragment,t),_(dt.$$.fragment,t),_(be.$$.fragment,t),_(ut.$$.fragment,t),_(ft.$$.fragment,t),Jo=!0)},o(t){k(T.$$.fragment,t),k(Me.$$.fragment,t),k(ze.$$.fragment,t),k(Ee.$$.fragment,t),k(je.$$.fragment,t),k(Re.$$.fragment,t),k(Ae.$$.fragment,t),k(Ce.$$.fragment,t),k(Ne.$$.fragment,t),k(Se.$$.fragment,t),k(De.$$.fragment,t),k(Ie.$$.fragment,t),k(He.$$.fragment,t),k(Le.$$.fragment,t),k(ke.$$.fragment,t),k(Xe.$$.fragment,t),k(Be.$$.fragment,t),k(Ue.$$.fragment,t),k(Ge.$$.fragment,t),k(Je.$$.fragment,t),k(ve.$$.fragment,t),k(Ye.$$.fragment,t),k(Ze.$$.fragment,t),k(et.$$.fragment,t),k(tt.$$.fragment,t),k(nt.$$.fragment,t),k(xe.$$.fragment,t),k(st.$$.fragment,t),k(at.$$.fragment,t),k(lt.$$.fragment,t),k(mt.$$.fragment,t),k(pt.$$.fragment,t),k(dt.$$.fragment,t),k(be.$$.fragment,t),k(ut.$$.fragment,t),k(ft.$$.fragment,t),Jo=!1},d(t){o(d),t&&o(O),t&&o(v),w(T),t&&o(Eo),t&&o(me),t&&o(jo),t&&o(K),w(Me),t&&o(Fo),t&&o(N),t&&o(Ro),w(ze,t),t&&o(Ao),t&&o(H),t&&o(Co),w(Ee,t),t&&o(Po),t&&o(ce),t&&o(No),t&&o(Z),w(je),t&&o(So),t&&o(Q),t&&o(Do),w(Re,t),t&&o(Io),t&&o(ee),w(Ae),t&&o(Ho),t&&o(F),w(Ce),w(Ne),w(Se),w(De),t&&o(Qo),t&&o(te),w(Ie),t&&o(Lo),t&&o(R),w(He),w(Le),w(ke),w(Xe),w(Be),t&&o(Xo),t&&o(ne),w(Ue),t&&o(Wo),t&&o(A),w(Ge),w(Je),w(ve),w(Ye),w(Ze),t&&o(Bo),t&&o(re),w(et),t&&o(Uo),t&&o(C),w(tt),w(nt),w(xe),w(st),w(at),w(lt),t&&o(Go),t&&o(ie),w(mt),t&&o(Vo),t&&o(P),w(pt),w(dt),w(be),w(ut),w(ft)}}}const Hi={local:"optimum-inference-with-onnx-runtime",sections:[{local:"switching-from-transformers-to-optimum-inference",sections:[{local:"working-with-the-hugging-face-model-hubhttpshfcomodels",title:"Working with the [Hugging Face Model Hub](https://hf.co/models)"}],title:"Switching from Transformers to Optimum Inference"},{local:"optimum.onnxruntime.ORTModel",title:"ORTModel"},{local:"optimum.onnxruntime.ORTModelForFeatureExtraction",title:"ORTModelForFeatureExtraction"},{local:"optimum.onnxruntime.ORTModelForQuestionAnswering",title:"ORTModelForQuestionAnswering"},{local:"optimum.onnxruntime.ORTModelForSequenceClassification",title:"ORTModelForSequenceClassification"},{local:"optimum.onnxruntime.ORTModelForTokenClassification",title:"ORTModelForTokenClassification"}],title:"Optimum Inference with ONNX Runtime"};function Qi(W){return Ci(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gi extends ji{constructor(d){super();Fi(this,d,Qi,Ii,Ri,{})}}export{Gi as default,Hi as metadata};
