import{S as yn,i as xn,s as On,e as o,k as m,w as v,t as i,M as $n,c as a,d as s,m as c,a as n,x as w,h as r,b as u,F as t,g as p,y as q,q as k,o as z,B as j,v as En}from"../chunks/vendor-4918fc3c.js";import{T as Tn}from"../chunks/Tip-3d800dd6.js";import{I as oe}from"../chunks/IconCopyLink-21d338b1.js";import{C as Te}from"../chunks/CodeBlock-99419108.js";function bn(Ct){let d,B,y,T,F,$,ae,Q;return{c(){d=o("p"),B=i("You can also use the "),y=o("code"),T=i("pipeline()"),F=i(" function from Transformers and provide your "),$=o("code"),ae=i("OptimumModel"),Q=i(".")},l(D){d=a(D,"P",{});var E=n(d);B=r(E,"You can also use the "),y=a(E,"CODE",{});var x=n(y);T=r(x,"pipeline()"),x.forEach(s),F=r(E," function from Transformers and provide your "),$=a(E,"CODE",{});var be=n($);ae=r(be,"OptimumModel"),be.forEach(s),Q=r(E,"."),E.forEach(s)},m(D,E){p(D,d,E),t(d,B),t(d,y),t(y,T),t(d,F),t(d,$),t($,ae),t(d,Q)},d(D){D&&s(d)}}}function An(Ct){let d,B,y,T,F,$,ae,Q,D,E,x,be,Pe,ws,qs,ne,ks,zs,Fe,js,ys,Mt,X,Pt,Ae,xs,Ft,Re,Qe,Os,Qt,h,De,Ne,$s,Es,Se,Ie,Ts,bs,He,Le,As,Rs,Ue,We,Cs,Ms,Be,Xe,Ps,Fs,Ye,Ge,Qs,Dt,N,Y,Je,ie,Ds,Ve,Ns,Nt,b,Ss,Ke,Is,Hs,Ze,Ls,Us,et,Ws,Bs,St,Ce,re,Xs,tt,Ys,Gs,It,le,Ht,pe,me,Js,st,Vs,Ks,Lt,ce,Ut,Me,ue,Zs,ot,eo,to,Wt,S,G,at,de,so,nt,oo,Bt,f,ao,it,no,io,he,ro,lo,rt,po,mo,lt,co,uo,pt,ho,fo,Xt,fe,Yt,I,J,mt,ge,go,ct,_o,Gt,O,vo,ut,wo,qo,_e,ko,zo,dt,jo,yo,ht,xo,Oo,Jt,ve,Vt,H,V,ft,we,$o,gt,Eo,Kt,g,To,_t,bo,Ao,vt,Ro,Co,wt,Mo,Po,qt,Fo,Qo,kt,Do,No,Zt,L,K,zt,qe,So,ke,Io,jt,Ho,Lo,es,ze,ts,U,Z,yt,je,Uo,ye,Wo,xt,Bo,Xo,ss,xe,os,W,ee,Ot,Oe,Yo,$t,Go,as,_,Jo,Et,Vo,Ko,Tt,Zo,ea,bt,ta,sa,At,oa,aa,Rt,na,ia,ns,$e,is;return $=new oe({}),X=new Tn({props:{$$slots:{default:[bn]},$$scope:{ctx:Ct}}}),ie=new oe({}),le=new Te({props:{code:`from optimum import optimum_pipeline
...
question = &quot;What&#x27;s my name?&quot;
context = &quot;My name is Philipp and I live in Nuremberg.&quot;
pred = onnx_qa(question, context)`}}),{c(){d=o("meta"),B=m(),y=o("h1"),T=o("a"),F=o("span"),v($.$$.fragment),ae=m(),Q=o("span"),D=i("Optimum pipelines for inference"),E=m(),x=o("p"),be=i("The "),Pe=o("code"),ws=i("optimum_pipeline"),qs=i(" makes it simple to use models from the "),ne=o("a"),ks=i("Model Hub"),zs=i(` for accelerated inference on a variety of tasks such as text classification.
Even if you don\u2019t have experience with a specific modality or understand the code powering the models, you can still use them with the `),Fe=o("code"),js=i("optimum_pipeline"),ys=i("! This tutorial will teach you to:"),Mt=m(),v(X.$$.fragment),Pt=m(),Ae=o("p"),xs=i("Currenlty supported tasks are:"),Ft=m(),Re=o("p"),Qe=o("strong"),Os=i("Onnx Runtime"),Qt=m(),h=o("ul"),De=o("li"),Ne=o("code"),$s=i("feature-extraction"),Es=m(),Se=o("li"),Ie=o("code"),Ts=i("text-classification"),bs=m(),He=o("li"),Le=o("code"),As=i("token-classification"),Rs=m(),Ue=o("li"),We=o("code"),Cs=i("question-answering"),Ms=m(),Be=o("li"),Xe=o("code"),Ps=i("zero-shot-classification"),Fs=m(),Ye=o("li"),Ge=o("code"),Qs=i("text-generation"),Dt=m(),N=o("h2"),Y=o("a"),Je=o("span"),v(ie.$$.fragment),Ds=m(),Ve=o("span"),Ns=i("Optimum pipeline usage"),Nt=m(),b=o("p"),Ss=i("While each task has an associated [~"),Ke=o("code"),Is=i("optimum_pipeline"),Hs=i("], which it is simpler to use the general [~"),Ze=o("code"),Ls=i("optimum_pipeline"),Us=i(`] abstraction which contains all the specific task pipelines.
The [~`),et=o("code"),Ws=i("optimum_pipeline"),Bs=i("] automatically loads a default model and tokenizer capable of inference for your task."),St=m(),Ce=o("ol"),re=o("li"),Xs=i("Start by creating a [~"),tt=o("code"),Ys=i("optimum_pipeline"),Gs=i("] and specify an inference task:"),It=m(),v(le.$$.fragment),Ht=m(),pe=o("ol"),me=o("li"),Js=i("Pass your input text to the [~"),st=o("code"),Vs=i("optimum_pipeline"),Ks=i("]:"),Lt=m(),v(ce.$$.fragment),Ut=m(),Me=o("p"),ue=o("em"),Zs=i("Note: The default models used in the [~"),ot=o("code"),eo=i("optimum_pipeline"),to=i("] are not optimized or quantized, there won\u2019t be an performance improvement comapred to there pytorch counter parts."),Wt=m(),S=o("h3"),G=o("a"),at=o("span"),v(de.$$.fragment),so=m(),nt=o("span"),oo=i("Using vanilla Transformers model and converting to ONNX"),Bt=m(),f=o("p"),ao=i("The "),it=o("code"),no=i("optimum_pipeline"),io=i(" accepts any supported model from the "),he=o("a"),ro=i("Model Hub"),lo=i(`.
There are tags on the Model Hub that allow you to filter for a model you\u2019d like to use for your task.
Once you\u2019ve picked an appropriate model, load it with the `),rt=o("code"),po=i('from_pretrained("{model_id}",from_transformers=True)'),mo=i(" method associated with the "),lt=o("code"),co=i("ORTModelFor*"),uo=i("\n[`AutoTokenizer\u2019] class. For example, here\u2019s how you can load the "),pt=o("code"),ho=i("ORTModelForQuestionAnswering"),fo=i(" class for question answering:"),Xt=m(),v(fe.$$.fragment),Yt=m(),I=o("h3"),J=o("a"),mt=o("span"),v(ge.$$.fragment),go=m(),ct=o("span"),_o=i("Using Optimum models"),Gt=m(),O=o("p"),vo=i("The "),ut=o("code"),wo=i("optimum_pipeline"),qo=i(" is tightly integrated with "),_e=o("a"),ko=i("Model Hub"),zo=i(` and can load optimized models directly, e.g. those created with OnnxRuntime.
There are tags on the Model Hub that allow you to filter for a model you\u2019d like to use for your task.
Once you\u2019ve picked an appropriate model, load it with the `),dt=o("code"),jo=i("from_pretrained()"),yo=i(" method associated with the corresponding "),ht=o("code"),xo=i("ORTModelFor*"),Oo=i("\nand [`AutoTokenizer\u2019] class. For example, here\u2019s how you can load an optimized model for question answering:"),Jt=m(),v(ve.$$.fragment),Vt=m(),H=o("h3"),V=o("a"),ft=o("span"),v(we.$$.fragment),$o=m(),gt=o("span"),Eo=i("Optimizing and Quantizing in Pipelines"),Kt=m(),g=o("p"),To=i("The "),_t=o("code"),bo=i("optimum_pipeline"),Ao=i(" can not only run inference on vanilla Onnxruntime checkpoints you can also use checkpoints optimized with "),vt=o("code"),Ro=i("ORTQuantizer"),Co=i(" and "),wt=o("code"),Mo=i("ORTOptimizer"),Po=i(`
Below you can find two examples on how you could [~`),qt=o("code"),Fo=i("ORTOptimizer"),Qo=i("] and [~"),kt=o("code"),Do=i("ORTQuantizer"),No=i("] to optimize/quantize your model and use it for inference afterwards."),Zt=m(),L=o("h3"),K=o("a"),zt=o("span"),v(qe.$$.fragment),So=m(),ke=o("span"),Io=i("Quantizing with [~"),jt=o("code"),Ho=i("ORTQuantizer"),Lo=i("]"),es=m(),v(ze.$$.fragment),ts=m(),U=o("h3"),Z=o("a"),yt=o("span"),v(je.$$.fragment),Uo=m(),ye=o("span"),Wo=i("Optimizing with [~"),xt=o("code"),Bo=i("ORTOptimizer"),Xo=i("]"),ss=m(),v(xe.$$.fragment),os=m(),W=o("h2"),ee=o("a"),Ot=o("span"),v(Oe.$$.fragment),Yo=m(),$t=o("span"),Go=i("Transformers pipeline usage"),as=m(),_=o("p"),Jo=i("The "),Et=o("code"),Vo=i("optimum_pipeline"),Ko=i(" is just a light wrapper around the "),Tt=o("code"),Zo=i("transformers.pipeline"),ea=i(` function to enable checks for supported tasks and additional features
...
`),Rt=a(M,"CODE",{});var jn=n(Rt);na=r(jn,"ORTModelFor*"),jn.forEach(s),ia=r(M," class."),M.forEach(s),ns=c(e),w($e.$$.fragment,e),this.h()},h(){u(d,"name","hf:doc:metadata"),u(d,"content",JSON.stringify(Rn)),u(T,"id","optimum-pipelines-for-inference"),u(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(T,"href","#optimum-pipelines-for-inference"),u(y,"class","relative group"),u(ne,"href","https://huggingface.co/models"),u(ne,"rel","nofollow"),u(Y,"id","optimum-pipeline-usage"),u(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Y,"href","#optimum-pipeline-usage"),u(N,"class","relative group"),u(pe,"start","2"),u(G,"id","using-vanilla-transformers-model-and-converting-to-onnx"),u(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(G,"href","#using-vanilla-transformers-model-and-converting-to-onnx"),u(S,"class","relative group"),u(he,"href","https://huggingface.co/models"),u(he,"rel","nofollow"),u(J,"id","using-optimum-models"),u(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(J,"href","#using-optimum-models"),u(I,"class","relative group"),u(_e,"href","https://huggingface.co/models"),u(_e,"rel","nofollow"),u(V,"id","optimizing-and-quantizing-in-pipelines"),u(V,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(V,"href","#optimizing-and-quantizing-in-pipelines"),u(H,"class","relative group"),u(K,"id","quantizing-with-ortquantizer"),u(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(K,"href","#quantizing-with-ortquantizer"),u(L,"class","relative group"),u(Z,"id","optimizing-with-ortoptimizer"),u(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Z,"href","#optimizing-with-ortoptimizer"),u(U,"class","relative group"),u(ee,"id","transformers-pipeline-usage"),u(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ee,"href","#transformers-pipeline-usage"),u(W,"class","relative group")},m(e,l){t(document.head,d),p(e,B,l),p(e,y,l),t(y,T),t(T,F),q($,F,null),t(y,ae),t(y,Q),t(Q,D),p(e,E,l),p(e,x,l),t(x,be),t(x,Pe),t(Pe,ws),t(x,qs),t(x,ne),t(ne,ks),t(x,zs),t(x,Fe),t(Fe,js),t(x,ys),p(e,Mt,l),q(X,e,l),p(e,Pt,l),p(e,Ae,l),t(Ae,xs),p(e,Ft,l),p(e,Re,l),t(Re,Qe),t(Qe,Os),p(e,Qt,l),p(e,h,l),t(h,De),t(De,Ne),t(Ne,$s),t(h,Es),t(h,Se),t(Se,Ie),t(Ie,Ts),t(h,bs),t(h,He),t(He,Le),t(Le,As),t(h,Rs),t(h,Ue),t(Ue,We),t(We,Cs),t(h,Ms),t(h,Be),t(Be,Xe),t(Xe,Ps),t(h,Fs),t(h,Ye),t(Ye,Ge),t(Ge,Qs),p(e,Dt,l),p(e,N,l),t(N,Y),t(Y,Je),q(ie,Je,null),t(N,Ds),t(N,Ve),t(Ve,Ns),p(e,Nt,l),p(e,b,l),t(b,Ss),t(b,Ke),t(Ke,Is),t(b,Hs),t(b,Ze),t(Ze,Ls),t(b,Us),t(b,et),t(et,Ws),t(b,Bs),p(e,St,l),p(e,Ce,l),t(Ce,re),t(re,Xs),t(re,tt),t(tt,Ys),t(re,Gs),p(e,It,l),q(le,e,l),p(e,Ht,l),p(e,pe,l),t(pe,me),t(me,Js),t(me,st),t(st,Vs),t(me,Ks),p(e,Lt,l),q(ce,e,l),p(e,Ut,l),p(e,Me,l),t(Me,ue),t(ue,Zs),t(ue,ot),t(ot,eo),t(ue,to),p(e,Wt,l),p(e,S,l),t(S,G),t(G,at),q(de,at,null),t(S,so),t(S,nt),t(nt,oo),p(e,Bt,l),p(e,f,l),t(f,ao),t(f,it),t(it,no),t(f,io),t(f,he),t(he,ro),t(f,lo),t(f,rt),t(rt,po),t(f,mo),t(f,lt),t(lt,co),t(f,uo),t(f,pt),t(pt,ho),t(f,fo),p(e,Xt,l),q(fe,e,l),p(e,Yt,l),p(e,I,l),t(I,J),t(J,mt),q(ge,mt,null),t(I,go),t(I,ct),t(ct,_o),p(e,Gt,l),p(e,O,l),t(O,vo),t(O,ut),t(ut,wo),t(O,qo),t(O,_e),t(_e,ko),t(O,zo),t(O,dt),t(dt,jo),t(O,yo),t(O,ht),t(ht,xo),t(O,Oo),p(e,Jt,l),q(ve,e,l),p(e,Vt,l),p(e,H,l),t(H,V),t(V,ft),q(we,ft,null),t(H,$o),t(H,gt),t(gt,Eo),p(e,Kt,l),p(e,g,l),t(g,To),t(g,_t),t(_t,bo),t(g,Ao),t(g,vt),t(vt,Ro),t(g,Co),t(g,wt),t(wt,Mo),t(g,Po),t(g,qt),t(qt,Fo),t(g,Qo),t(g,kt),t(kt,Do),t(g,No),p(e,Zt,l),p(e,L,l),t(L,K),t(K,zt),q(qe,zt,null),t(L,So),t(L,ke),t(ke,Io),t(ke,jt),t(jt,Ho),t(ke,Lo),p(e,es,l),q(ze,e,l),p(e,ts,l),p(e,U,l),t(U,Z),t(Z,yt),q(je,yt,null),t(U,Uo),t(U,ye),t(ye,Wo),t(ye,xt),t(xt,Bo),t(ye,Xo),p(e,ss,l),q(xe,e,l),p(e,os,l),p(e,W,l),t(W,ee),t(ee,Ot),q(Oe,Ot,null),t(W,Yo),t(W,$t),t($t,Go),p(e,as,l),p(e,_,l),t(_,Jo),t(_,Et),t(Et,Vo),t(_,Ko),t(_,Tt),t(Tt,Zo),t(_,ea),t(_,bt),t(bt,ta),t(_,sa),t(_,At),t(At,oa),t(_,aa),t(_,Rt),t(Rt,na),t(_,ia),p(e,ns,l),q($e,e,l),is=!0},p(e,[l]){const Ee={};l&2&&(Ee.$$scope={dirty:l,ctx:e}),X.$set(Ee)},i(e){is||(k($.$$.fragment,e),k(X.$$.fragment,e),k(ie.$$.fragment,e),k(le.$$.fragment,e),k(ce.$$.fragment,e),k(de.$$.fragment,e),k(fe.$$.fragment,e),k(ge.$$.fragment,e),k(ve.$$.fragment,e),k(we.$$.fragment,e),k(qe.$$.fragment,e),k(ze.$$.fragment,e),k(je.$$.fragment,e),k(xe.$$.fragment,e),k(Oe.$$.fragment,e),k($e.$$.fragment,e),is=!0)},o(e){z($.$$.fragment,e),z(X.$$.fragment,e),z(ie.$$.fragment,e),z(le.$$.fragment,e),z(ce.$$.fragment,e),z(de.$$.fragment,e),z(fe.$$.fragment,e),z(ge.$$.fragment,e),z(ve.$$.fragment,e),z(we.$$.fragment,e),z(qe.$$.fragment,e),z(ze.$$.fragment,e),z(je.$$.fragment,e),z(xe.$$.fragment,e),z(Oe.$$.fragment,e),z($e.$$.fragment,e),is=!1},d(e){s(d),e&&s(B),e&&s(y),j($),e&&s(E),e&&s(x),e&&s(Mt),j(X,e),e&&s(Pt),e&&s(Ae),e&&s(Ft),e&&s(Re),e&&s(Qt),e&&s(h),e&&s(Dt),e&&s(N),j(ie),e&&s(Nt),e&&s(b),e&&s(St),e&&s(Ce),e&&s(It),j(le,e),e&&s(Ht),e&&s(pe),e&&s(Lt),j(ce,e),e&&s(Ut),e&&s(Me),e&&s(Wt),e&&s(S),j(de),e&&s(Bt),e&&s(f),e&&s(Xt),j(fe,e),e&&s(Yt),e&&s(I),j(ge),e&&s(Gt),e&&s(O),e&&s(Jt),j(ve,e),e&&s(Vt),e&&s(H),j(we),e&&s(Kt),e&&s(g),e&&s(Zt),e&&s(L),j(qe),e&&s(es),j(ze,e),e&&s(ts),e&&s(U),j(je),e&&s(ss),j(xe,e),e&&s(os),e&&s(W),j(Oe),e&&s(as),e&&s(_),e&&s(ns),j($e,e)}}}const Rn={local:"optimum-pipelines-for-inference",sections:[{local:"optimum-pipeline-usage",sections:[{local:"using-vanilla-transformers-model-and-converting-to-onnx",title:"Using vanilla Transformers model and converting to ONNX"},{local:"using-optimum-models",title:"Using Optimum models"},{local:"optimizing-and-quantizing-in-pipelines",title:"Optimizing and Quantizing in Pipelines"},{local:"quantizing-with-ortquantizer",title:"Quantizing with [~`ORTQuantizer`]"},{local:"optimizing-with-ortoptimizer",title:"Optimizing with [~`ORTOptimizer`]"}],title:"Optimum pipeline usage"},{local:"transformers-pipeline-usage",title:"Transformers pipeline usage"}],title:"Optimum pipelines for inference"};function Cn(Ct){return En(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Dn extends yn{constructor(d){super();xn(this,d,Cn,An,On,{})}}export{Dn as default,Rn as metadata};
