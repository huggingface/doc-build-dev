...
`}]}}),{c(){l=n("meta"),q=y(),s=n("h1"),u=n("a"),b=n("span"),E(h.$$.fragment),R=y(),z=n("span"),L=M("ONNX Runtime Configuration"),T=y(),d=n("h2"),m=n("a"),x=n("span"),E(g.$$.fragment),F=y(),w=n("span"),S=M("ORTConfig"),N=y(),c=n("div"),E(f.$$.fragment),P=y(),O=n("p"),A=M("ORTConfig is the configuration class handling all the ONNX Runtime optimization and quantization parameters."),this.h()},l(e){const p=ae('[data-svelte="svelte-1phssyn"]',document.head);l=a(p,"META",{name:!0,content:!0}),p.forEach(o),q=v(e),s=a(e,"H1",{class:!0});var $=r(s);u=a($,"A",{id:!0,class:!0,href:!0});var H=r(u);b=a(H,"SPAN",{});var V=r(b);I(h.$$.fragment,V),V.forEach(o),H.forEach(o),R=v($),z=a($,"SPAN",{});var J=r(z);L=k(J,"ONNX Runtime Configuration"),J.forEach(o),$.forEach(o),T=v(e),d=a(e,"H2",{class:!0});var D=r(d);m=a(D,"A",{id:!0,class:!0,href:!0});var j=r(m);x=a(j,"SPAN",{});var K=r(x);I(g.$$.fragment,K),K.forEach(o),j.forEach(o),F=v(D),w=a(D,"SPAN",{});var Y=r(w);S=k(Y,"ORTConfig"),Y.forEach(o),D.forEach(o),N=v(e),c=a(e,"DIV",{class:!0});var Q=r(c);I(f.$$.fragment,Q),P=v(Q),O=a(Q,"P",{});var Z=r(O);A=k(Z,"ORTConfig is the configuration class handling all the ONNX Runtime optimization and quantization parameters."),Z.forEach(o),Q.forEach(o),this.h()},h(){i(l,"name","hf:doc:metadata"),i(l,"content",JSON.stringify(de)),i(u,"id","onnx-runtime-configuration"),i(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(u,"href","#onnx-runtime-configuration"),i(s,"class","relative group"),i(m,"id","optimum.onnxruntime.ORTConfig"),i(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(m,"href","#optimum.onnxruntime.ORTConfig"),i(d,"class","relative group"),i(c,"class","docstring")},m(e,p){t(document.head,l),_(e,q,p),_(e,s,p),t(s,u),t(u,b),W(h,b,null),t(s,R),t(s,z),t(z,L),_(e,T,p),_(e,d,p),t(d,m),t(m,x),W(g,x,null),t(d,F),t(d,w),t(w,S),_(e,N,p),_(e,c,p),W(f,c,null),t(c,P),t(c,O),t(O,A),C=!0},p:ie,i(e){C||(X(h.$$.fragment,e),X(g.$$.fragment,e),X(f.$$.fragment,e),C=!0)},o(e){U(h.$$.fragment,e),U(g.$$.fragment,e),U(f.$$.fragment,e),C=!1},d(e){o(l),e&&o(q),e&&o(s),B(h),e&&o(T),e&&o(d),B(g),e&&o(N),e&&o(c),B(f)}}}const de={local:"onnx-runtime-configuration",sections:[{local:"optimum.onnxruntime.ORTConfig",title:"ORTConfig"}],title:"ONNX Runtime Configuration"};function ce(G){return re(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class he extends oe{constructor(l){super();te(this,l,ce,se,ne,{})}}export{he as default,de as metadata};
