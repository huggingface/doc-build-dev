...
Even if you don\u2019t have experience with a specific modality or understand the code powering the models, you can still use them with the `),Pe=n("code"),vs=i("pipeline()"),ws=i(" function!"),bt=c(),w(X.$$.fragment),At=c(),ye=n("p"),qs=i("Currenlty supported tasks are:"),Rt=c(),xe=n("p"),Fe=n("strong"),ks=i("Onnx Runtime"),Mt=c(),f=n("ul"),Ne=n("li"),Qe=n("code"),zs=i("feature-extraction"),js=c(),Se=n("li"),De=n("code"),ys=i("text-classification"),xs=c(),Ie=n("li"),He=n("code"),Os=i("token-classification"),$s=c(),Le=n("li"),Ue=n("code"),Ts=i("question-answering"),Es=c(),We=n("li"),Xe=n("code"),bs=i("zero-shot-classification"),As=c(),Be=n("li"),Ge=n("code"),Rs=i("text-generation"),Ct=c(),N=n("h2"),B=n("a"),Ye=n("span"),w(ne.$$.fragment),Ms=c(),Je=n("span"),Cs=i("Optimum pipeline usage"),Pt=c(),C=n("p"),Ps=i("While each task has an associated pipeline class, it is simpler to use the general "),Ve=n("code"),Fs=i("pipeline()"),Ns=i(` function which wraps all the task-specific pipelines in one object.
