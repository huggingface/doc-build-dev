import{S as Ra,i as Ca,s as Ma,e as o,k as c,w as q,t as i,M as Pa,c as n,d as s,m as u,a,x as k,h as r,b as m,G as t,g as p,y as z,q as j,o as y,B as x,v as Na}from"../chunks/vendor-hf-doc-builder.js";import{T as Fa}from"../chunks/Tip-hf-doc-builder.js";import{I as te}from"../chunks/IconCopyLink-hf-doc-builder.js";import{C as je}from"../chunks/CodeBlock-hf-doc-builder.js";function Qa(Mt){let h,X,g,T,N;return{c(){h=o("p"),X=i("You can also use the "),g=o("a"),T=i("pipeline()"),N=i(" function from Transformers and provide your Optimum model class."),this.h()},l($){h=n($,"P",{});var C=a(h);X=r(C,"You can also use the "),g=n(C,"A",{href:!0,rel:!0});var U=a(g);T=r(U,"pipeline()"),U.forEach(s),N=r(C," function from Transformers and provide your Optimum model class."),C.forEach(s),this.h()},h(){m(g,"href","https://huggingface.co/docs/transformers/main/en/main_classes/pipelines#pipelines"),m(g,"rel","nofollow")},m($,C){p($,h,C),t(h,X),t(h,g),t(g,T),t(h,N)},d($){$&&s(h)}}}function Sa(Mt){let h,X,g,T,N,$,C,U,vs,Pt,E,ws,Me,qs,ks,se,zs,js,Pe,ys,xs,Nt,W,Ft,ye,Os,Qt,xe,Ne,$s,St,d,Fe,Qe,Ts,Es,Se,De,bs,As,Ie,He,Rs,Cs,Le,Xe,Ms,Ps,Ue,We,Ns,Fs,Be,Ge,Qs,Ss,Ye,Je,Ds,Is,Ve,Ke,Hs,Ls,Ze,et,Xs,Dt,F,B,tt,oe,Us,st,Ws,It,M,Bs,ot,Gs,Ys,nt,Js,Vs,Ht,Oe,at,Ks,Lt,ne,Xt,ae,ie,Zs,it,eo,to,Ut,re,Wt,$e,le,so,rt,oo,no,Bt,Q,G,lt,pe,ao,pt,io,Gt,_,ro,mt,lo,po,me,mo,co,ct,uo,ho,ut,fo,go,Te,_o,vo,Yt,ce,Jt,S,Y,dt,ue,wo,ht,qo,Vt,O,ko,ft,zo,jo,de,yo,xo,gt,Oo,$o,_t,To,Eo,Kt,he,Zt,D,J,vt,fe,bo,wt,Ao,es,v,Ro,qt,Co,Mo,kt,Po,No,zt,Fo,Qo,Ee,So,Do,be,Io,Ho,ts,I,V,jt,ge,Lo,Ae,Xo,yt,Uo,ss,_e,os,H,K,xt,ve,Wo,Re,Bo,Ot,Go,ns,we,as,L,Z,$t,qe,Yo,Tt,Jo,is,w,Vo,Et,Ko,Zo,bt,en,tn,At,sn,on,Rt,nn,an,Ct,rn,ln,rs,ke,ls;return $=new te({}),W=new Fa({props:{$$slots:{default:[Qa]},$$scope:{ctx:Mt}}}),oe=new te({}),ne=new je({props:{code:`from optimum.pipelines import pipeline
...
Once you\u2019ve picked an appropriate model, load it with the `),ct=o("code"),uo=i('from_pretrained("{model_id}",from_transformers=True)'),ho=i(" method associated with the "),ut=o("code"),fo=i("ORTModelFor*"),go=i("\n`AutoTokenizer\u2019 class. For example, here\u2019s how you can load the "),Te=o("a"),_o=i("ORTModelForQuestionAnswering"),vo=i(" class for question answering:"),Yt=c(),q(ce.$$.fragment),Jt=c(),S=o("h3"),Y=o("a"),dt=o("span"),q(ue.$$.fragment),wo=c(),ht=o("span"),qo=i("Using Optimum models"),Vt=c(),O=o("p"),ko=i("The "),ft=o("code"),zo=i("pipeline()"),jo=i(" function is tightly integrated with "),de=o("a"),yo=i("Model Hub"),xo=i(` and can load optimized models directly, e.g. those created with ONNX Runtime.
There are tags on the Model Hub that allow you to filter for a model you\u2019d like to use for your task.
Once you\u2019ve picked an appropriate model, load it with the `),gt=o("code"),Oo=i("from_pretrained()"),$o=i(" method associated with the corresponding "),_t=o("code"),To=i("ORTModelFor*"),Eo=i("\nand `AutoTokenizer\u2019 class. For example, here\u2019s how you can load an optimized model for question answering:"),Kt=c(),q(he.$$.fragment),Zt=c(),D=o("h3"),J=o("a"),vt=o("span"),q(fe.$$.fragment),bo=c(),wt=o("span"),Ao=i("Optimizing and quantizing in pipelines"),es=c(),v=o("p"),Ro=i("The "),qt=o("code"),Co=i("pipeline()"),Mo=i(" function can not only run inference on vanilla ONNX Runtime checkpoints - you can also use checkpoints optimized with "),kt=o("code"),Po=i("ORTQuantizer"),No=i(" and "),zt=o("code"),Fo=i("ORTOptimizer"),Qo=i(`.
Below you can find two examples on how you could `),Ee=o("a"),So=i("ORTOptimizer"),Do=i(" and "),be=o("a"),Io=i("ORTQuantizer"),Ho=i(" to optimize/quantize your model and use it for inference afterwards."),ts=c(),I=o("h3"),V=o("a"),jt=o("span"),q(ge.$$.fragment),Lo=c(),Ae=o("span"),Xo=i("Quantizing with "),yt=o("code"),Uo=i("ORTQuantizer"),ss=c(),q(_e.$$.fragment),os=c(),H=o("h3"),K=o("a"),xt=o("span"),q(ve.$$.fragment),Wo=c(),Re=o("span"),Bo=i("Optimizing with "),Ot=o("code"),Go=i("ORTOptimizer"),ns=c(),q(we.$$.fragment),as=c(),L=o("h2"),Z=o("a"),$t=o("span"),q(qe.$$.fragment),Yo=c(),Tt=o("span"),Jo=i("Transformers pipeline usage"),is=c(),w=o("p"),Vo=i("The "),Et=o("code"),Ko=i("pipeline()"),Zo=i(" function is just a light wrapper around the "),bt=o("code"),en=i("transformers.pipeline"),tn=i(` function to enable checks for supported tasks and additional features
