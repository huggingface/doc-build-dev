...
<span class="hljs-keyword">var</span> preTokenized = preTokenizer.<span class="hljs-title function_">preTokenizeString</span>(<span class="hljs-string">&quot;Hello! How are you? I&#x27;m fine, thank you.&quot;</span>);`}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p:b,i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function xl(l){let t,s;return t=new y({props:{$$slots:{default:[Cl]},$$scope:{ctx:l}}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p(e,r){const i={};r&2&&(i.$$scope={dirty:r,ctx:e}),t.$set(i)},i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Dl(l){let t,s;return t=new v({props:{code:`from tokenizers import pre_tokenizers
...
<span class="hljs-comment"># [(&quot;Call&quot;, (0, 4)), (&quot;9&quot;, (5, 6)), (&quot;1&quot;, (6, 7)), (&quot;1&quot;, (7, 8)), (&quot;!&quot;, (8, 9))]</span>`}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p:b,i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Wl(l){let t,s;return t=new y({props:{$$slots:{default:[Dl]},$$scope:{ctx:l}}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p(e,r){const i={};r&2&&(i.$$scope={dirty:r,ctx:e}),t.$set(i)},i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Ll(l){let t,s;return t=new v({props:{code:`use tokenizers::pre_tokenizers::{digits::Digits, sequence::Sequence};
...
<span class="hljs-comment">// &quot;Hello , y &#x27; all ! How are you ?&quot;</span>`}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p:b,i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function xi(l){let t,s;return t=new y({props:{$$slots:{default:[Ci]},$$scope:{ctx:l}}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p(e,r){const i={};r&2&&(i.$$scope={dirty:r,ctx:e}),t.$set(i)},i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Di(l){let t,s;return t=new v({props:{code:`output = bert_tokenizer.encode("Welcome to the \u{1F917} Tokenizers library.")
print(output.tokens)
...
bert_tokenizer.decode(output.ids)
<span class="hljs-comment"># &quot;welcome to the tok ##eni ##zer ##s library .&quot;</span>`}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p:b,i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Wi(l){let t,s;return t=new y({props:{$$slots:{default:[Di]},$$scope:{ctx:l}}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p(e,r){const i={};r&2&&(i.$$scope={dirty:r,ctx:e}),t.$set(i)},i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Li(l){let t,s;return t=new v({props:{code:`let output = bert_tokenizer.encode("Welcome to the \u{1F917} Tokenizers library.", true)?;
...
<span class="hljs-keyword">var</span> decoded = <span class="hljs-keyword">await</span> <span class="hljs-title function_">decode</span>(output.<span class="hljs-title function_">getIds</span>(), <span class="hljs-literal">true</span>);
<span class="hljs-comment">// &quot;welcome to the tokenizers library.&quot;</span>`}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p:b,i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Mi(l){let t,s;return t=new y({props:{$$slots:{default:[Ri]},$$scope:{ctx:l}}}),{c(){c(t.$$.fragment)},l(e){u(t.$$.fragment,e)},m(e,r){f(t,e,r),s=!0},p(e,r){const i={};r&2&&(i.$$scope={dirty:r,ctx:e}),t.$set(i)},i(e){s||($(t.$$.fragment,e),s=!0)},o(e){m(t.$$.fragment,e),s=!1},d(e){h(t,e)}}}function Yi(l){let t,s,e,r,i,Te,Dn,st,Wn,_s,x,Ln,nt,Hn,On,rt,In,Bn,ks,E,ot,at,Fn,Un,lt,it,Kn,Rn,pt,ct,Mn,Yn,ut,ft,Jn,gs,D,Gn,$t,Qn,Vn,mt,Xn,Zn,ws,W,er,ht,tr,sr,dt,nr,rr,zs,Y,js,I,J,_t,Ee,or,kt,ar,qs,G,lr,Se,ir,pr,bs,L,cr,gt,ur,fr,wt,$r,mr,vs,Q,ys,Oe,hr,Ps,V,Ts,X,dr,zt,_r,kr,Es,Z,Ss,Ie,gr,Ns,B,ee,jt,Ne,wr,qt,zr,As,Be,jr,Cs,te,qr,bt,br,vr,xs,se,Ds,S,yr,vt,Pr,Tr,yt,Er,Sr,Pt,Nr,Ar,Ws,ne,Cr,Tt,xr,Dr,Ls,re,Hs,H,Wr,Et,Lr,Hr,St,Or,Ir,Os,oe,Is,Fe,Br,Bs,F,ae,Nt,Ae,Fr,At,Ur,Fs,le,Kr,Ct,Rr,Mr,Us,Ue,Yr,Ks,ie,Jr,xt,Gr,Qr,Rs,N,Dt,Wt,Vr,Xr,Lt,Ht,Zr,eo,Ot,It,to,so,Bt,Ft,no,Ms,Ce,ro,Ke,oo,Ys,U,pe,Ut,xe,ao,Kt,lo,Js,ce,io,Rt,po,co,Gs,ue,uo,Mt,fo,$o,Qs,fe,Vs,Re,mo,Xs,K,$e,Yt,De,ho,Jt,_o,Zs,me,ko,Gt,go,wo,en,he,tn,Me,zo,sn,de,nn,Ye,jo,rn,_e,on,Je,qo,an,ke,ln,ge,bo,Qt,vo,yo,pn,we,cn,R,ze,Vt,We,Po,Xt,To,un,A,Eo,Zt,So,No,es,Ao,Co,ts,xo,Do,fn,Ge,Wo,$n,je,mn,O,Lo,ss,Ho,Oo,ns,Io,Bo,hn,qe,dn,Qe,Fo,_n,be,kn;return Te=new He({}),Y=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[cl],rust:[il],python:[al]},$$scope:{ctx:l}}}),Ee=new He({}),Q=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[dl],rust:[ml],python:[fl]},$$scope:{ctx:l}}}),V=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[jl],rust:[wl],python:[kl]},$$scope:{ctx:l}}}),Z=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Tl],rust:[yl],python:[bl]},$$scope:{ctx:l}}}),Ne=new He({}),se=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[xl],rust:[Al],python:[Sl]},$$scope:{ctx:l}}}),re=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Il],rust:[Hl],python:[Wl]},$$scope:{ctx:l}}}),oe=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Ml],rust:[Kl],python:[Fl]},$$scope:{ctx:l}}}),Ae=new He({}),xe=new He({}),fe=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Xl],rust:[Ql],python:[Jl]},$$scope:{ctx:l}}}),De=new He({}),he=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[ri],rust:[si],python:[ei]},$$scope:{ctx:l}}}),de=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[ci],rust:[ii],python:[ai]},$$scope:{ctx:l}}}),_e=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[di],rust:[mi],python:[fi]},$$scope:{ctx:l}}}),ke=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[ji],rust:[wi],python:[ki]},$$scope:{ctx:l}}}),we=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Ti],rust:[yi],python:[bi]},$$scope:{ctx:l}}}),We=new He({}),je=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[xi],rust:[Ai],python:[Si]},$$scope:{ctx:l}}}),qe=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Ii],rust:[Hi],python:[Wi]},$$scope:{ctx:l}}}),be=new T({props:{python:!0,rust:!0,node:!0,$$slots:{node:[Mi],rust:[Ki],python:[Fi]},$$scope:{ctx:l}}}),{c(){t=d("meta"),s=j(),e=d("h1"),r=d("a"),i=d("span"),c(Te.$$.fragment),Dn=j(),st=d("span"),Wn=g("The tokenization pipeline"),_s=j(),x=d("p"),Ln=g("When calling "),nt=d("code"),Hn=g("Tokenizer.encode"),On=g(` or
`),rt=d("code"),In=g("Tokenizer.encode_batch"),Bn=g(`, the input
text(s) go through the following pipeline:`),ks=j(),E=d("ul"),ot=d("li"),at=d("code"),Fn=g("normalization"),Un=j(),lt=d("li"),it=d("code"),Kn=g("pre-tokenization"),Rn=j(),pt=d("li"),ct=d("code"),Mn=g("model"),Yn=j(),ut=d("li"),ft=d("code"),Jn=g("post-processing"),gs=j(),D=d("p"),Gn=g(`We\u2019ll see in details what happens during each of those steps in detail,
...
pre-tokenizer:`),xs=j(),c(se.$$.fragment),Ds=j(),S=d("p"),yr=g(`The output is a list of tuples, with each tuple containing one word and
...
punctuation will split contractions like `),Pt=d("code"),Nr=g(`"I'm"`),Ar=g(" in this example."),Ws=j(),ne=d("p"),Cr=g("You can combine together any "),Tt=d("code"),xr=g("PreTokenizer"),Dr=g(` together. For instance, here is a pre-tokenizer that will
...
`),xt=d("code"),Gr=g("Tokenizer"),Qr=g(` so you already know how to
customize this part. Currently, the \u{1F917} Tokenizers library supports:`),Rs=j(),N=d("ul"),Dt=d("li"),Wt=d("code"),Vr=g("models.BPE"),Xr=j(),Lt=d("li"),Ht=d("code"),Zr=g("models.Unigram"),eo=j(),Ot=d("li"),It=d("code"),to=g("models.WordLevel"),so=j(),Bt=d("li"),Ft=d("code"),no=g("models.WordPiece"),Ms=j(),Ce=d("p"),ro=g(`For more details about each model and its behavior, you can check
`),Ke=d("a"),oo=g("here"),Ys=j(),U=d("h2"),pe=d("a"),Ut=d("span"),c(xe.$$.fragment),ao=j(),Kt=d("span"),lo=g("Post-Processing"),Js=j(),ce=d("p"),io=g(`Post-processing is the last step of the tokenization pipeline, to
...
need to retrain a tokenizer after changing its post-processor.`),Xs=j(),K=d("h2"),$e=d("a"),Yt=d("span"),c(De.$$.fragment),ho=j(),Jt=d("span"),_o=g("All together: a BERT tokenizer from scratch &lcub;#example}"),Zs=j(),me=d("p"),ko=g(`Let\u2019s put all those pieces together to build a BERT tokenizer. First,
...
`),es=d("code"),Ao=g("Tokenizer.decode"),Co=g(" (for one predicted text) and "),ts=d("code"),xo=g("Tokenizer.decode_batch"),Do=g(" (for a batch of predictions)."),fn=j(),Ge=d("p"),Wo=g(`The [decoder]{.title-ref} will first convert the IDs back to tokens
...
pre-tokenizer:`),qn.forEach(o),xs=q(n),u(se.$$.fragment,n),Ds=q(n),S=_(n,"P",{});var ve=k(S);yr=w(ve,`The output is a list of tuples, with each tuple containing one word and
its span in the original sentence (which is used to determine the final
...
`),Mt=_(Sn,"CODE",{});var xa=k(Mt);fo=w(xa,"Tokenizer"),xa.forEach(o),$o=w(Sn,` by setting the
corresponding attribute. For instance, here is how we can post-process
to make the inputs suitable for the BERT model:`),Sn.forEach(o),Qs=q(n),u(fe.$$.fragment,n),Vs=q(n),Re=_(n,"P",{});var Da=k(Re);mo=w(Da,`Note that contrarily to the pre-tokenizer or the normalizer, you don\u2019t
need to retrain a tokenizer after changing its post-processor.`),Da.forEach(o),Xs=q(n),K=_(n,"H2",{class:!0});var Nn=k(K);$e=_(Nn,"A",{id:!0,class:!0,href:!0});var Wa=k($e);Yt=_(Wa,"SPAN",{});var La=k(Yt);u(De.$$.fragment,La),La.forEach(o),Wa.forEach(o),ho=q(Nn),Jt=_(Nn,"SPAN",{});var Ha=k(Jt);_o=w(Ha,"All together: a BERT tokenizer from scratch &lcub;#example}"),Ha.forEach(o),Nn.forEach(o),Zs=q(n),me=_(n,"P",{});var An=k(me);ko=w(An,`Let\u2019s put all those pieces together to build a BERT tokenizer. First,
BERT relies on WordPiece, so we instantiate a new
...
`),Qt=_(Cn,"CODE",{});var Ua=k(Qt);vo=w(Ua,"quicktour"),Ua.forEach(o),yo=w(Cn,":"),Cn.forEach(o),pn=q(n),u(we.$$.fragment,n),cn=q(n),R=_(n,"H2",{class:!0});var xn=k(R);ze=_(xn,"A",{id:!0,class:!0,href:!0});var Ka=k(ze);Vt=_(Ka,"SPAN",{});var Ra=k(Vt);u(We.$$.fragment,Ra),Ra.forEach(o),Ka.forEach(o),Po=q(xn),Xt=_(xn,"SPAN",{});var Ma=k(Xt);To=w(Ma,"Decoding"),Ma.forEach(o),xn.forEach(o),un=q(n),A=_(n,"P",{});var Pe=k(A);Eo=w(Pe,"On top of encoding the input texts, a "),Zt=_(Pe,"CODE",{});var Ya=k(Zt);So=w(Ya,"Tokenizer"),Ya.forEach(o),No=w(Pe,` also has an API for decoding, that is converting IDs
generated by your model back to a text. This is done by the methods
`),es=_(Pe,"CODE",{});var Ja=k(es);Ao=w(Ja,"Tokenizer.decode"),Ja.forEach(o),Co=w(Pe," (for one predicted text) and "),ts=_(Pe,"CODE",{});var Ga=k(ts);xo=w(Ga,"Tokenizer.decode_batch"),Ga.forEach(o),Do=w(Pe," (for a batch of predictions)."),Pe.forEach(o),fn=q(n),Ge=_(n,"P",{});var Qa=k(Ge);Wo=w(Qa,`The [decoder]{.title-ref} will first convert the IDs back to tokens
(using the tokenizer\u2019s vocabulary) and remove all special tokens, then
...
default decoing will give:`),tt.forEach(o),hn=q(n),u(qe.$$.fragment,n),dn=q(n),Qe=_(n,"P",{});var Za=k(Qe);Fo=w(Za,"But by changing it to a proper decoder, we get:"),Za.forEach(o),_n=q(n),u(be.$$.fragment,n),this.h()},h(){P(t,"name","hf:doc:metadata"),P(t,"content",JSON.stringify(Ji)),P(r,"id","the-tokenization-pipeline"),P(r,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P(r,"href","#the-tokenization-pipeline"),P(e,"class","relative group"),P(J,"id","normalization"),P(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P(J,"href","#normalization"),P(I,"class","relative group"),P(Se,"href","https://unicode.org/reports/tr15"),P(Se,"rel","nofollow"),P(ee,"id","pretokenization"),P(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P(ee,"href","#pretokenization"),P(B,"class","relative group"),P(ae,"id","model"),P(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P(ae,"href","#model"),P(F,"class","relative group"),P(Ke,"href","components.html#models"),P(pe,"id","postprocessing"),P(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P(pe,"href","#postprocessing"),P(U,"class","relative group"),P($e,"id","all-together-a-bert-tokenizer-from-scratch-amplcubexample"),P($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P($e,"href","#all-together-a-bert-tokenizer-from-scratch-amplcubexample"),P(K,"class","relative group"),P(ze,"id","decoding"),P(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),P(ze,"href","#decoding"),P(R,"class","relative group")},m(n,p){a(document.head,t),z(n,s,p),z(n,e,p),a(e,r),a(r,i),f(Te,i,null),a(e,Dn),a(e,st),a(st,Wn),z(n,_s,p),z(n,x,p),a(x,Ln),a(x,nt),a(nt,Hn),a(x,On),a(x,rt),a(rt,In),a(x,Bn),z(n,ks,p),z(n,E,p),a(E,ot),a(ot,at),a(at,Fn),a(E,Un),a(E,lt),a(lt,it),a(it,Kn),a(E,Rn),a(E,pt),a(pt,ct),a(ct,Mn),a(E,Yn),a(E,ut),a(ut,ft),a(ft,Jn),z(n,gs,p),z(n,D,p),a(D,Gn),a(D,$t),a($t,Qn),a(D,Vn),a(D,mt),a(mt,Xn),a(D,Zn),z(n,ws,p),z(n,W,p),a(W,er),a(W,ht),a(ht,tr),a(W,sr),a(W,dt),a(dt,nr),a(W,rr),z(n,zs,p),f(Y,n,p),z(n,js,p),z(n,I,p),a(I,J),a(J,_t),f(Ee,_t,null),a(I,or),a(I,kt),a(kt,ar),z(n,qs,p),z(n,G,p),a(G,lr),a(G,Se),a(Se,ir),a(G,pr),z(n,bs,p),z(n,L,p),a(L,cr),a(L,gt),a(gt,ur),a(L,fr),a(L,wt),a(wt,$r),a(L,mr),z(n,vs,p),f(Q,n,p),z(n,ys,p),z(n,Oe,p),a(Oe,hr),z(n,Ps,p),f(V,n,p),z(n,Ts,p),z(n,X,p),a(X,dr),a(X,zt),a(zt,_r),a(X,kr),z(n,Es,p),f(Z,n,p),z(n,Ss,p),z(n,Ie,p),a(Ie,gr),z(n,Ns,p),z(n,B,p),a(B,ee),a(ee,jt),f(Ne,jt,null),a(B,wr),a(B,qt),a(qt,zr),z(n,As,p),z(n,Be,p),a(Be,jr),z(n,Cs,p),z(n,te,p),a(te,qr),a(te,bt),a(bt,br),a(te,vr),z(n,xs,p),f(se,n,p),z(n,Ds,p),z(n,S,p),a(S,yr),a(S,vt),a(vt,Pr),a(S,Tr),a(S,yt),a(yt,Er),a(S,Sr),a(S,Pt),a(Pt,Nr),a(S,Ar),z(n,Ws,p),z(n,ne,p),a(ne,Cr),a(ne,Tt),a(Tt,xr),a(ne,Dr),z(n,Ls,p),f(re,n,p),z(n,Hs,p),z(n,H,p),a(H,Wr),a(H,Et),a(Et,Lr),a(H,Hr),a(H,St),a(St,Or),a(H,Ir),z(n,Os,p),f(oe,n,p),z(n,Is,p),z(n,Fe,p),a(Fe,Br),z(n,Bs,p),z(n,F,p),a(F,ae),a(ae,Nt),f(Ae,Nt,null),a(F,Fr),a(F,At),a(At,Ur),z(n,Fs,p),z(n,le,p),a(le,Kr),a(le,Ct),a(Ct,Rr),a(le,Mr),z(n,Us,p),z(n,Ue,p),a(Ue,Yr),z(n,Ks,p),z(n,ie,p),a(ie,Jr),a(ie,xt),a(xt,Gr),a(ie,Qr),z(n,Rs,p),z(n,N,p),a(N,Dt),a(Dt,Wt),a(Wt,Vr),a(N,Xr),a(N,Lt),a(Lt,Ht),a(Ht,Zr),a(N,eo),a(N,Ot),a(Ot,It),a(It,to),a(N,so),a(N,Bt),a(Bt,Ft),a(Ft,no),z(n,Ms,p),z(n,Ce,p),a(Ce,ro),a(Ce,Ke),a(Ke,oo),z(n,Ys,p),z(n,U,p),a(U,pe),a(pe,Ut),f(xe,Ut,null),a(U,ao),a(U,Kt),a(Kt,lo),z(n,Js,p),z(n,ce,p),a(ce,io),a(ce,Rt),a(Rt,po),a(ce,co),z(n,Gs,p),z(n,ue,p),a(ue,uo),a(ue,Mt),a(Mt,fo),a(ue,$o),z(n,Qs,p),f(fe,n,p),z(n,Vs,p),z(n,Re,p),a(Re,mo),z(n,Xs,p),z(n,K,p),a(K,$e),a($e,Yt),f(De,Yt,null),a(K,ho),a(K,Jt),a(Jt,_o),z(n,Zs,p),z(n,me,p),a(me,ko),a(me,Gt),a(Gt,go),a(me,wo),z(n,en,p),f(he,n,p),z(n,tn,p),z(n,Me,p),a(Me,zo),z(n,sn,p),f(de,n,p),z(n,nn,p),z(n,Ye,p),a(Ye,jo),z(n,rn,p),f(_e,n,p),z(n,on,p),z(n,Je,p),a(Je,qo),z(n,an,p),f(ke,n,p),z(n,ln,p),z(n,ge,p),a(ge,bo),a(ge,Qt),a(Qt,vo),a(ge,yo),z(n,pn,p),f(we,n,p),z(n,cn,p),z(n,R,p),a(R,ze),a(ze,Vt),f(We,Vt,null),a(R,Po),a(R,Xt),a(Xt,To),z(n,un,p),z(n,A,p),a(A,Eo),a(A,Zt),a(Zt,So),a(A,No),a(A,es),a(es,Ao),a(A,Co),a(A,ts),a(ts,xo),a(A,Do),z(n,fn,p),z(n,Ge,p),a(Ge,Wo),z(n,$n,p),f(je,n,p),z(n,mn,p),z(n,O,p),a(O,Lo),a(O,ss),a(ss,Ho),a(O,Oo),a(O,ns),a(ns,Io),a(O,Bo),z(n,hn,p),f(qe,n,p),z(n,dn,p),z(n,Qe,p),a(Qe,Fo),z(n,_n,p),f(be,n,p),kn=!0},p(n,[p]){const Le={};p&2&&(Le.$$scope={dirty:p,ctx:n}),Y.$set(Le);const rs={};p&2&&(rs.$$scope={dirty:p,ctx:n}),Q.$set(rs);const os={};p&2&&(os.$$scope={dirty:p,ctx:n}),V.$set(os);const as={};p&2&&(as.$$scope={dirty:p,ctx:n}),Z.$set(as);const M={};p&2&&(M.$$scope={dirty:p,ctx:n}),se.$set(M);const ls={};p&2&&(ls.$$scope={dirty:p,ctx:n}),re.$set(ls);const is={};p&2&&(is.$$scope={dirty:p,ctx:n}),oe.$set(is);const C={};p&2&&(C.$$scope={dirty:p,ctx:n}),fe.$set(C);const ps={};p&2&&(ps.$$scope={dirty:p,ctx:n}),he.$set(ps);const cs={};p&2&&(cs.$$scope={dirty:p,ctx:n}),de.$set(cs);const us={};p&2&&(us.$$scope={dirty:p,ctx:n}),_e.$set(us);const fs={};p&2&&(fs.$$scope={dirty:p,ctx:n}),ke.$set(fs);const $s={};p&2&&($s.$$scope={dirty:p,ctx:n}),we.$set($s);const ms={};p&2&&(ms.$$scope={dirty:p,ctx:n}),je.$set(ms);const hs={};p&2&&(hs.$$scope={dirty:p,ctx:n}),qe.$set(hs);const ds={};p&2&&(ds.$$scope={dirty:p,ctx:n}),be.$set(ds)},i(n){kn||($(Te.$$.fragment,n),$(Y.$$.fragment,n),$(Ee.$$.fragment,n),$(Q.$$.fragment,n),$(V.$$.fragment,n),$(Z.$$.fragment,n),$(Ne.$$.fragment,n),$(se.$$.fragment,n),$(re.$$.fragment,n),$(oe.$$.fragment,n),$(Ae.$$.fragment,n),$(xe.$$.fragment,n),$(fe.$$.fragment,n),$(De.$$.fragment,n),$(he.$$.fragment,n),$(de.$$.fragment,n),$(_e.$$.fragment,n),$(ke.$$.fragment,n),$(we.$$.fragment,n),$(We.$$.fragment,n),$(je.$$.fragment,n),$(qe.$$.fragment,n),$(be.$$.fragment,n),kn=!0)},o(n){m(Te.$$.fragment,n),m(Y.$$.fragment,n),m(Ee.$$.fragment,n),m(Q.$$.fragment,n),m(V.$$.fragment,n),m(Z.$$.fragment,n),m(Ne.$$.fragment,n),m(se.$$.fragment,n),m(re.$$.fragment,n),m(oe.$$.fragment,n),m(Ae.$$.fragment,n),m(xe.$$.fragment,n),m(fe.$$.fragment,n),m(De.$$.fragment,n),m(he.$$.fragment,n),m(de.$$.fragment,n),m(_e.$$.fragment,n),m(ke.$$.fragment,n),m(we.$$.fragment,n),m(We.$$.fragment,n),m(je.$$.fragment,n),m(qe.$$.fragment,n),m(be.$$.fragment,n),kn=!1},d(n){o(t),n&&o(s),n&&o(e),h(Te),n&&o(_s),n&&o(x),n&&o(ks),n&&o(E),n&&o(gs),n&&o(D),n&&o(ws),n&&o(W),n&&o(zs),h(Y,n),n&&o(js),n&&o(I),h(Ee),n&&o(qs),n&&o(G),n&&o(bs),n&&o(L),n&&o(vs),h(Q,n),n&&o(ys),n&&o(Oe),n&&o(Ps),h(V,n),n&&o(Ts),n&&o(X),n&&o(Es),h(Z,n),n&&o(Ss),n&&o(Ie),n&&o(Ns),n&&o(B),h(Ne),n&&o(As),n&&o(Be),n&&o(Cs),n&&o(te),n&&o(xs),h(se,n),n&&o(Ds),n&&o(S),n&&o(Ws),n&&o(ne),n&&o(Ls),h(re,n),n&&o(Hs),n&&o(H),n&&o(Os),h(oe,n),n&&o(Is),n&&o(Fe),n&&o(Bs),n&&o(F),h(Ae),n&&o(Fs),n&&o(le),n&&o(Us),n&&o(Ue),n&&o(Ks),n&&o(ie),n&&o(Rs),n&&o(N),n&&o(Ms),n&&o(Ce),n&&o(Ys),n&&o(U),h(xe),n&&o(Js),n&&o(ce),n&&o(Gs),n&&o(ue),n&&o(Qs),h(fe,n),n&&o(Vs),n&&o(Re),n&&o(Xs),n&&o(K),h(De),n&&o(Zs),n&&o(me),n&&o(en),h(he,n),n&&o(tn),n&&o(Me),n&&o(sn),h(de,n),n&&o(nn),n&&o(Ye),n&&o(rn),h(_e,n),n&&o(on),n&&o(Je),n&&o(an),h(ke,n),n&&o(ln),n&&o(ge),n&&o(pn),h(we,n),n&&o(cn),n&&o(R),h(We),n&&o(un),n&&o(A),n&&o(fn),n&&o(Ge),n&&o($n),h(je,n),n&&o(mn),n&&o(O),n&&o(hn),h(qe,n),n&&o(dn),n&&o(Qe),n&&o(_n),h(be,n)}}}const Ji={local:"the-tokenization-pipeline",sections:[{local:"normalization",title:"Normalization"},{local:"pretokenization",title:"Pre-Tokenization"},{local:"model",title:"Model"},{local:"postprocessing",title:"Post-Processing"},{local:"all-together-a-bert-tokenizer-from-scratch-amplcubexample",title:"All together: a BERT tokenizer from scratch &amp;lcub;#example}"},{local:"decoding",title:"Decoding"}],title:"The tokenization pipeline"};function Gi(l){return rl(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ep extends el{constructor(t){super();tl(this,t,Gi,Yi,sl,{})}}export{ep as default,Ji as metadata};
