import{S as qs,i as xs,s as As,e as i,k as f,w as c,t as l,M as Ps,c as n,d as t,m as h,a as o,x as d,h as p,b as u,G as s,g as r,y,L as Ts,q as w,o as b,B as _,v as Ss}from"../chunks/vendor-hf-doc-builder.js";import{I as at}from"../chunks/IconCopyLink-hf-doc-builder.js";import{C as Y}from"../chunks/CodeBlock-hf-doc-builder.js";function Ls(Zt){let v,ze,z,q,fe,U,rt,he,it,$e,x,nt,Z,ot,lt,je,g,pt,G,ft,ht,ue,ut,mt,Ee,C,qe,k,ct,J,dt,yt,V,wt,bt,xe,N,_t,X,gt,Ae,$,A,me,F,kt,ce,vt,Pe,P,zt,de,$t,jt,Te,D,Se,m,Et,ye,qt,xt,we,At,Pt,be,Tt,St,Le,j,T,_e,I,Lt,ge,Bt,Be,S,Ut,O,Ct,Nt,Ue,ee,Ft,Ce,H,Ne,te,Dt,Fe,K,De,se,It,Ie,ae,Ot,Oe,M,He,re,Ht,Ke,E,L,ke,R,Kt,ve,Mt,Me,ie,Rt,Re,Q,Qe,ne,Qt,We,W,Ye,oe,Wt,Ze;return U=new at({}),C=new Y({props:{code:`from tokenizers import Tokenizer, models, normalizers, pre_tokenizers, decoders, trainers
...
`),X=i("a"),gt=l("here"),Ae=f(),$=i("h2"),A=i("a"),me=i("span"),c(F.$$.fragment),kt=f(),ce=i("span"),vt=l("The most basic way"),Pe=f(),P=i("p"),zt=l(`As you probably guessed already, the easiest way to train our tokenizer
