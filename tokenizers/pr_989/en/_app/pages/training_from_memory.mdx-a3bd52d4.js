...
following:`),Ee=f(),c(C.$$.fragment),qe=f(),k=i("p"),ct=l("This tokenizer is based on the "),G=i("a"),dt=l("Unigram"),yt=l(` model. It
...
`),X=i("a"),gt=l("here"),Ae=f(),$=i("h2"),A=i("a"),me=i("span"),c(N.$$.fragment),kt=f(),ce=i("span"),vt=l("The most basic way"),Pe=f(),P=i("p"),zt=l(`As you probably guessed already, the easiest way to train our tokenizer
...
following:`),le.forEach(t),Ee=h(e),d(C.$$.fragment,e),qe=h(e),k=n(e,"P",{});var pe=o(k);ct=p(pe,"This tokenizer is based on the "),G=n(pe,"A",{href:!0});var ss=o(G);dt=p(ss,"Unigram"),ss.forEach(t),yt=p(pe,` model. It
takes care of normalizing the input using the NFKC Unicode normalization
