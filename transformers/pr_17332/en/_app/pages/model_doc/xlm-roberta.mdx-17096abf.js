...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y2=p(nt),sh=s(nt,"P",{});var e3=a(sh);Z2=i(e3,"Finally, this model supports inherent JAX features such as:"),e3.forEach(t),e$=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var t3=a(ah);Wi=s(t3,"A",{href:!0,rel:!0});var o3=a(Wi);t$=i(o3,"Just-In-Time (JIT) compilation"),o3.forEach(t),t3.forEach(t),o$=p(Is),rh=s(Is,"LI",{});var n3=a(rh);Bi=s(n3,"A",{href:!0,rel:!0});var s3=a(Bi);n$=i(s3,"Automatic Differentiation"),s3.forEach(t),n3.forEach(t),s$=p(Is),ih=s(Is,"LI",{});var a3=a(ih);Ui=s(a3,"A",{href:!0,rel:!0});var r3=a(Ui);a$=i(r3,"Vectorization"),r3.forEach(t),a3.forEach(t),r$=p(Is),lh=s(Is,"LI",{});var i3=a(lh);Qi=s(i3,"A",{href:!0,rel:!0});var l3=a(Qi);i$=i(l3,"Parallelization"),l3.forEach(t),i3.forEach(t),Is.forEach(t),l$=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);d$=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var d3=a(Md);c$=i(d3,"FlaxRobertaForTokenClassification"),d3.forEach(t),p$=i(ff,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ff.forEach(t),h$=p(nt),qt=s(nt,"DIV",{class:!0});var Ds=a(qt);y(Vi.$$.fragment,Ds),m$=p(Ds),Jo=s(Ds,"P",{});var Gd=a(Jo);u$=i(Gd,"The "),dh=s(Gd,"CODE",{});var c3=a(dh);f$=i(c3,"FlaxRobertaPreTrainedModel"),c3.forEach(t),g$=i(Gd," forward method, overrides the "),ch=s(Gd,"CODE",{});var p3=a(ch);_$=i(p3,"__call__"),p3.forEach(t),b$=i(Gd," special method."),Gd.forEach(t),k$=p(Ds),y(ys.$$.fragment,Ds),v$=p(Ds),y(ws.$$.fragment,Ds),Ds.forEach(t),nt.forEach(t),Sm=p(o),Ko=s(o,"H2",{class:!0});var gf=a(Ko);$s=s(gf,"A",{id:!0,class:!0,href:!0});var h3=a($s);ph=s(h3,"SPAN",{});var m3=a(ph);y(Ji.$$.fragment,m3),m3.forEach(t),h3.forEach(t),T$=p(gf),hh=s(gf,"SPAN",{});var u3=a(hh);y$=i(u3,"FlaxXLMRobertaForQuestionAnswering"),u3.forEach(t),gf.forEach(t),Wm=p(o),Pe=s(o,"DIV",{class:!0});var st=a(Pe);y(Ki.$$.fragment,st),w$=p(st),Go=s(st,"P",{});var Yd=a(Go);$$=i(Yd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),mh=s(Yd,"CODE",{});var f3=a(mh);M$=i(f3,"span start logits"),f3.forEach(t),F$=i(Yd," and "),uh=s(Yd,"CODE",{});var g3=a(uh);x$=i(g3,"span end logits"),g3.forEach(t),R$=i(Yd,")."),Yd.forEach(t),L$=p(st),Gi=s(st,"P",{});var _f=a(Gi);E$=i(_f,"This model inherits from "),Fd=s(_f,"A",{href:!0});var _3=a(Fd);z$=i(_3,"FlaxPreTrainedModel"),_3.forEach(t),q$=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),_f.forEach(t),C$=p(st),Yi=s(st,"P",{});var bf=a(Yi);j$=i(bf,"This model is also a Flax Linen "),Zi=s(bf,"A",{href:!0,rel:!0});var b3=a(Zi);X$=i(b3,"flax.linen.Module"),b3.forEach(t),P$=i(bf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),bf.forEach(t),A$=p(st),fh=s(st,"P",{});var k3=a(fh);O$=i(k3,"Finally, this model supports inherent JAX features such as:"),k3.forEach(t),N$=p(st),Ht=s(st,"UL",{});var Ss=a(Ht);gh=s(Ss,"LI",{});var v3=a(gh);el=s(v3,"A",{href:!0,rel:!0});var T3=a(el);I$=i(T3,"Just-In-Time (JIT) compilation"),T3.forEach(t),v3.forEach(t),D$=p(Ss),_h=s(Ss,"LI",{});var y3=a(_h);tl=s(y3,"A",{href:!0,rel:!0});var w3=a(tl);S$=i(w3,"Automatic Differentiation"),w3.forEach(t),y3.forEach(t),W$=p(Ss),bh=s(Ss,"LI",{});var $3=a(bh);ol=s($3,"A",{href:!0,rel:!0});var M3=a(ol);B$=i(M3,"Vectorization"),M3.forEach(t),$3.forEach(t),U$=p(Ss),kh=s(Ss,"LI",{});var F3=a(kh);nl=s(F3,"A",{href:!0,rel:!0});var x3=a(nl);Q$=i(x3,"Parallelization"),x3.forEach(t),F3.forEach(t),Ss.forEach(t),H$=p(st),sl=s(st,"P",{});var kf=a(sl);V$=i(kf,"This class overrides "),xd=s(kf,"A",{href:!0});var R3=a(xd);J$=i(R3,"FlaxRobertaForQuestionAnswering"),R3.forEach(t),K$=i(kf,`. Please check the superclass for the appropriate
