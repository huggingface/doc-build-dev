...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),e3=p(),Ih=n("p"),t3=r("Finally, this model supports inherent JAX features such as:"),o3=p(),Kt=n("ul"),Dh=n("li"),yl=n("a"),n3=r("Just-In-Time (JIT) compilation"),s3=p(),Sh=n("li"),Tl=n("a"),a3=r("Automatic Differentiation"),r3=p(),Wh=n("li"),wl=n("a"),i3=r("Vectorization"),l3=p(),Bh=n("li"),$l=n("a"),d3=r("Parallelization"),c3=p(),Lt=n("div"),y(Fl.$$.fragment),p3=p(),cn=n("p"),h3=r("The "),Uh=n("code"),m3=r("FlaxRobertaPreTrainedModel"),f3=r(" forward method, overrides the "),Hh=n("code"),u3=r("__call__"),g3=r(" special method."),_3=p(),y(Ks.$$.fragment),b3=p(),y(Gs.$$.fragment),Nf=p(),pn=n("h2"),Xs=n("a"),Qh=n("span"),y(xl.$$.fragment),k3=p(),Vh=n("span"),v3=r("FlaxRobertaForQuestionAnswering"),If=p(),Be=n("div"),y(Rl.$$.fragment),y3=p(),hn=n("p"),T3=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Jh=n("code"),w3=r("span start logits"),$3=r(" and "),Kh=n("code"),F3=r("span end logits"),x3=r(")."),R3=p(),Ml=n("p"),M3=r("This model inherits from "),Nd=n("a"),E3=r("FlaxPreTrainedModel"),z3=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),C3=p(),El=n("p"),q3=r("This model is also a Flax Linen "),zl=n("a"),j3=r("flax.linen.Module"),P3=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),L3=p(),Gh=n("p"),A3=r("Finally, this model supports inherent JAX features such as:"),O3=p(),Gt=n("ul"),Xh=n("li"),Cl=n("a"),N3=r("Just-In-Time (JIT) compilation"),I3=p(),Yh=n("li"),ql=n("a"),D3=r("Automatic Differentiation"),S3=p(),Zh=n("li"),jl=n("a"),W3=r("Vectorization"),B3=p(),em=n("li"),Pl=n("a"),U3=r("Parallelization"),H3=p(),At=n("div"),y(Ll.$$.fragment),Q3=p(),mn=n("p"),V3=r("The "),tm=n("code"),J3=r("FlaxRobertaPreTrainedModel"),K3=r(" forward method, overrides the "),om=n("code"),G3=r("__call__"),X3=r(" special method."),Y3=p(),y(Ys.$$.fragment),Z3=p(),y(Zs.$$.fragment),this.h()},l(o){const b=NM('[data-svelte="svelte-1phssyn"]',document.head);d=s(b,"META",{name:!0,content:!0}),b.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var Al=a(c);m=s(Al,"A",{id:!0,class:!0,href:!0});var nm=a(m);_=s(nm,"SPAN",{});var sm=a(_);T(l.$$.fragment,sm),sm.forEach(t),nm.forEach(t),f=h(Al),M=s(Al,"SPAN",{});var am=a(M);te=i(am,"RoBERTa"),am.forEach(t),Al.forEach(t),I=h(o),z=s(o,"H2",{class:!0});var Ol=a(z);X=s(Ol,"A",{id:!0,class:!0,href:!0});var rm=a(X);D=s(rm,"SPAN",{});var im=a(D);T(se.$$.fragment,im),im.forEach(t),rm.forEach(t),be=h(Ol),S=s(Ol,"SPAN",{});var lm=a(S);ke=i(lm,"Overview"),lm.forEach(t),Ol.forEach(t),ue=h(o),K=s(o,"P",{});var Nl=a(K);A=i(Nl,"The RoBERTa model was proposed in "),ae=s(Nl,"A",{href:!0,rel:!0});var dm=a(ae);oe=i(dm,"RoBERTa: A Robustly Optimized BERT Pretraining Approach"),dm.forEach(t),C=i(Nl,` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
