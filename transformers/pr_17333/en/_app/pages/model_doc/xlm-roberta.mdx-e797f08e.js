...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17333/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17333/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17333/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17333/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17333/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17333/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17333/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17333/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17333/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17333/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17333/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17333/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17333/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17333/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17333/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17333/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17333/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17333/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17333/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
not make use of token type ids, therefore a list of zeros is returned.`),Zh.forEach(t),kl.forEach(t),sg=p(et),Fl=s(et,"DIV",{class:!0});var em=a(Fl);y(ta.$$.fragment,em),em.forEach(t),et.forEach(t),sm=p(o),co=s(o,"H2",{class:!0});var Um=a(co);an=s(Um,"A",{id:!0,class:!0,href:!0});var l3=a(an);lc=s(l3,"SPAN",{});var d3=a(lc);y(oa.$$.fragment,d3),d3.forEach(t),l3.forEach(t),ag=p(Um),dc=s(Um,"SPAN",{});var c3=a(dc);rg=i(c3,"XLMRobertaTokenizerFast"),c3.forEach(t),Um.forEach(t),am=p(o),at=s(o,"DIV",{class:!0});var Gt=a(at);y(na.$$.fragment,Gt),ig=p(Gt),yt=s(Gt,"P",{});var Yt=a(yt);lg=i(Yt,"Construct a \u201Cfast\u201D XLM-RoBERTa tokenizer (backed by HuggingFace\u2019s "),cc=s(Yt,"EM",{});var p3=a(cc);dg=i(p3,"tokenizers"),p3.forEach(t),cg=i(Yt,` library). Adapted from
`),xl=s(Yt,"A",{href:!0});var h3=a(xl);pg=i(h3,"RobertaTokenizer"),h3.forEach(t),hg=i(Yt," and "),Rl=s(Yt,"A",{href:!0});var m3=a(Rl);mg=i(m3,"XLNetTokenizer"),m3.forEach(t),ug=i(Yt,`. Based on
`),sa=s(Yt,"A",{href:!0,rel:!0});var u3=a(sa);fg=i(u3,"BPE"),u3.forEach(t),gg=i(Yt,"."),Yt.forEach(t),_g=p(Gt),aa=s(Gt,"P",{});var Qm=a(aa);bg=i(Qm,"This tokenizer inherits from "),Ll=s(Qm,"A",{href:!0});var f3=a(Ll);kg=i(f3,"PreTrainedTokenizerFast"),f3.forEach(t),vg=i(Qm,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Qm.forEach(t),Tg=p(Gt),Kt=s(Gt,"DIV",{class:!0});var Ed=a(Kt);y(ra.$$.fragment,Ed),yg=p(Ed),pc=s(Ed,"P",{});var g3=a(pc);wg=i(g3,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),g3.forEach(t),$g=p(Ed),ia=s(Ed,"UL",{});var Hm=a(ia);El=s(Hm,"LI",{});var r3=a(El);Mg=i(r3,"single sequence: "),hc=s(r3,"CODE",{});var _3=a(hc);Fg=i(_3,"<s> X </s>"),_3.forEach(t),r3.forEach(t),xg=p(Hm),zl=s(Hm,"LI",{});var i3=a(zl);Rg=i(i3,"pair of sequences: "),mc=s(i3,"CODE",{});var b3=a(mc);Lg=i(b3,"<s> A </s></s> B </s>"),b3.forEach(t),i3.forEach(t),Hm.forEach(t),Ed.forEach(t),Eg=p(Gt),rn=s(Gt,"DIV",{class:!0});var Vm=a(rn);y(la.$$.fragment,Vm),zg=p(Vm),uc=s(Vm,"P",{});var k3=a(uc);qg=i(k3,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),k3.forEach(t),Vm.forEach(t),Gt.forEach(t),rm=p(o),po=s(o,"H2",{class:!0});var Jm=a(po);ln=s(Jm,"A",{id:!0,class:!0,href:!0});var v3=a(ln);fc=s(v3,"SPAN",{});var T3=a(fc);y(da.$$.fragment,T3),T3.forEach(t),v3.forEach(t),Cg=p(Jm),gc=s(Jm,"SPAN",{});var y3=a(gc);jg=i(y3,"XLMRobertaModel"),y3.forEach(t),Jm.forEach(t),im=p(o),He=s(o,"DIV",{class:!0});var jt=a(He);y(ca.$$.fragment,jt),Xg=p(jt),_c=s(jt,"P",{});var w3=a(_c);Pg=i(w3,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),w3.forEach(t),Ag=p(jt),pa=s(jt,"P",{});var Km=a(pa);Og=i(Km,"This model inherits from "),ql=s(Km,"A",{href:!0});var $3=a(ql);Ng=i($3,"PreTrainedModel"),$3.forEach(t),Ig=i(Km,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Km.forEach(t),Dg=p(jt),ha=s(jt,"P",{});var Gm=a(ha);Sg=i(Gm,"This model is also a PyTorch "),ma=s(Gm,"A",{href:!0,rel:!0});var M3=a(ma);Wg=i(M3,"torch.nn.Module"),M3.forEach(t),Bg=i(Gm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gm.forEach(t),Ug=p(jt),ua=s(jt,"P",{});var Ym=a(ua);Qg=i(Ym,"This class overrides "),Cl=s(Ym,"A",{href:!0});var F3=a(Cl);Hg=i(F3,"RobertaModel"),F3.forEach(t),Vg=i(Ym,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Ym.forEach(t),Jg=p(jt),wt=s(jt,"DIV",{class:!0});var xs=a(wt);y(fa.$$.fragment,xs),Kg=p(xs),ho=s(xs,"P",{});var zd=a(ho);Gg=i(zd,"The "),jl=s(zd,"A",{href:!0});var x3=a(jl);Yg=i(x3,"RobertaModel"),x3.forEach(t),Zg=i(zd," forward method, overrides the "),bc=s(zd,"CODE",{});var R3=a(bc);e_=i(R3,"__call__"),R3.forEach(t),t_=i(zd," special method."),zd.forEach(t),o_=p(xs),y(dn.$$.fragment,xs),n_=p(xs),y(cn.$$.fragment,xs),xs.forEach(t),jt.forEach(t),lm=p(o),mo=s(o,"H2",{class:!0});var Zm=a(mo);pn=s(Zm,"A",{id:!0,class:!0,href:!0});var L3=a(pn);kc=s(L3,"SPAN",{});var E3=a(kc);y(ga.$$.fragment,E3),E3.forEach(t),L3.forEach(t),s_=p(Zm),vc=s(Zm,"SPAN",{});var z3=a(vc);a_=i(z3,"XLMRobertaForCausalLM"),z3.forEach(t),Zm.forEach(t),dm=p(o),Ve=s(o,"DIV",{class:!0});var Xt=a(Ve);y(_a.$$.fragment,Xt),r_=p(Xt),ba=s(Xt,"P",{});var eu=a(ba);i_=i(eu,"XLM-RoBERTa Model with a "),Tc=s(eu,"CODE",{});var q3=a(Tc);l_=i(q3,"language modeling"),q3.forEach(t),d_=i(eu," head on top for CLM fine-tuning."),eu.forEach(t),c_=p(Xt),ka=s(Xt,"P",{});var tu=a(ka);p_=i(tu,"This model inherits from "),Xl=s(tu,"A",{href:!0});var C3=a(Xl);h_=i(C3,"PreTrainedModel"),C3.forEach(t),m_=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),u_=p(Xt),va=s(Xt,"P",{});var ou=a(va);f_=i(ou,"This model is also a PyTorch "),Ta=s(ou,"A",{href:!0,rel:!0});var j3=a(Ta);g_=i(j3,"torch.nn.Module"),j3.forEach(t),__=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),b_=p(Xt),ya=s(Xt,"P",{});var nu=a(ya);k_=i(nu,"This class overrides "),Pl=s(nu,"A",{href:!0});var X3=a(Pl);v_=i(X3,"RobertaForCausalLM"),X3.forEach(t),T_=i(nu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),nu.forEach(t),y_=p(Xt),$t=s(Xt,"DIV",{class:!0});var Rs=a($t);y(wa.$$.fragment,Rs),w_=p(Rs),uo=s(Rs,"P",{});var qd=a(uo);$_=i(qd,"The "),Al=s(qd,"A",{href:!0});var P3=a(Al);M_=i(P3,"RobertaForCausalLM"),P3.forEach(t),F_=i(qd," forward method, overrides the "),yc=s(qd,"CODE",{});var A3=a(yc);x_=i(A3,"__call__"),A3.forEach(t),R_=i(qd," special method."),qd.forEach(t),L_=p(Rs),y(hn.$$.fragment,Rs),E_=p(Rs),y(mn.$$.fragment,Rs),Rs.forEach(t),Xt.forEach(t),cm=p(o),fo=s(o,"H2",{class:!0});var su=a(fo);un=s(su,"A",{id:!0,class:!0,href:!0});var O3=a(un);wc=s(O3,"SPAN",{});var N3=a(wc);y($a.$$.fragment,N3),N3.forEach(t),O3.forEach(t),z_=p(su),$c=s(su,"SPAN",{});var I3=a($c);q_=i(I3,"XLMRobertaForMaskedLM"),I3.forEach(t),su.forEach(t),pm=p(o),Je=s(o,"DIV",{class:!0});var Pt=a(Je);y(Ma.$$.fragment,Pt),C_=p(Pt),Fa=s(Pt,"P",{});var au=a(Fa);j_=i(au,"XLM-RoBERTa Model with a "),Mc=s(au,"CODE",{});var D3=a(Mc);X_=i(D3,"language modeling"),D3.forEach(t),P_=i(au," head on top."),au.forEach(t),A_=p(Pt),xa=s(Pt,"P",{});var ru=a(xa);O_=i(ru,"This model inherits from "),Ol=s(ru,"A",{href:!0});var S3=a(Ol);N_=i(S3,"PreTrainedModel"),S3.forEach(t),I_=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ru.forEach(t),D_=p(Pt),Ra=s(Pt,"P",{});var iu=a(Ra);S_=i(iu,"This model is also a PyTorch "),La=s(iu,"A",{href:!0,rel:!0});var W3=a(La);W_=i(W3,"torch.nn.Module"),W3.forEach(t),B_=i(iu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),iu.forEach(t),U_=p(Pt),Ea=s(Pt,"P",{});var lu=a(Ea);Q_=i(lu,"This class overrides "),Nl=s(lu,"A",{href:!0});var B3=a(Nl);H_=i(B3,"RobertaForMaskedLM"),B3.forEach(t),V_=i(lu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),lu.forEach(t),J_=p(Pt),rt=s(Pt,"DIV",{class:!0});var Zt=a(rt);y(za.$$.fragment,Zt),K_=p(Zt),go=s(Zt,"P",{});var Cd=a(go);G_=i(Cd,"The "),Il=s(Cd,"A",{href:!0});var U3=a(Il);Y_=i(U3,"RobertaForMaskedLM"),U3.forEach(t),Z_=i(Cd," forward method, overrides the "),Fc=s(Cd,"CODE",{});var Q3=a(Fc);eb=i(Q3,"__call__"),Q3.forEach(t),tb=i(Cd," special method."),Cd.forEach(t),ob=p(Zt),y(fn.$$.fragment,Zt),nb=p(Zt),y(gn.$$.fragment,Zt),sb=p(Zt),y(_n.$$.fragment,Zt),Zt.forEach(t),Pt.forEach(t),hm=p(o),_o=s(o,"H2",{class:!0});var du=a(_o);bn=s(du,"A",{id:!0,class:!0,href:!0});var H3=a(bn);xc=s(H3,"SPAN",{});var V3=a(xc);y(qa.$$.fragment,V3),V3.forEach(t),H3.forEach(t),ab=p(du),Rc=s(du,"SPAN",{});var J3=a(Rc);rb=i(J3,"XLMRobertaForSequenceClassification"),J3.forEach(t),du.forEach(t),mm=p(o),Ke=s(o,"DIV",{class:!0});var At=a(Ke);y(Ca.$$.fragment,At),ib=p(At),Lc=s(At,"P",{});var K3=a(Lc);lb=i(K3,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),K3.forEach(t),db=p(At),ja=s(At,"P",{});var cu=a(ja);cb=i(cu,"This model inherits from "),Dl=s(cu,"A",{href:!0});var G3=a(Dl);pb=i(G3,"PreTrainedModel"),G3.forEach(t),hb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),mb=p(At),Xa=s(At,"P",{});var pu=a(Xa);ub=i(pu,"This model is also a PyTorch "),Pa=s(pu,"A",{href:!0,rel:!0});var Y3=a(Pa);fb=i(Y3,"torch.nn.Module"),Y3.forEach(t),gb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),_b=p(At),Aa=s(At,"P",{});var hu=a(Aa);bb=i(hu,"This class overrides "),Sl=s(hu,"A",{href:!0});var Z3=a(Sl);kb=i(Z3,"RobertaForSequenceClassification"),Z3.forEach(t),vb=i(hu,`. Please check the superclass for the appropriate
