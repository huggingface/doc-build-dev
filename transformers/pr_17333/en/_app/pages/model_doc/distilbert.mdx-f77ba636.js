...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17333/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17333/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y1=r(qd);cv=i(Y1,"span start logits"),Y1.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Z1=r(Pd);hv=i(Z1,"span end logits"),Z1.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(Bt),ia=n(Bt,"P",{});var ou=r(ia);mv=i(ou,"This model inherits from "),nl=n(ou,"A",{href:!0});var e3=r(nl);gv=i(e3,"TFPreTrainedModel"),e3.forEach(t),_v=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),bv=h(Bt),la=n(Bt,"P",{});var su=r(la);vv=i(su,"This model is also a "),da=n(su,"A",{href:!0,rel:!0});var t3=r(da);kv=i(t3,"tf.keras.Model"),t3.forEach(t),Tv=i(su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),su.forEach(t),$v=h(Bt),$(Us.$$.fragment,Bt),wv=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Eo=n(Zt,"P",{});var Dl=r(Eo);Dv=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var o3=r(rl);Fv=i(o3,"TFDistilBertForQuestionAnswering"),o3.forEach(t),Bv=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var s3=r(Ad);xv=i(s3,"__call__"),s3.forEach(t),Mv=i(Dl," special method."),Dl.forEach(t),Ev=h(Zt),$(Hs.$$.fragment,Zt),zv=h(Zt),$(Vs.$$.fragment,Zt),jv=h(Zt),$(Ks.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(o),zo=n(o,"H2",{class:!0});var nu=r(zo);Js=n(nu,"A",{id:!0,class:!0,href:!0});var n3=r(Js);Od=n(n3,"SPAN",{});var r3=r(Od);$(pa.$$.fragment,r3),r3.forEach(t),n3.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var a3=r(Nd);qv=i(a3,"FlaxDistilBertModel"),a3.forEach(t),nu.forEach(t),ah=h(o),Me=n(o,"DIV",{class:!0});var ot=r(Me);$(ha.$$.fragment,ot),Pv=h(ot),Ld=n(ot,"P",{});var i3=r(Ld);Av=i(i3,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i3.forEach(t),Ov=h(ot),ua=n(ot,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l3=r(al);Lv=i(l3,"FlaxPreTrainedModel"),l3.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(ot),fa=n(ot,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d3=r(ma);Qv=i(d3,"flax.linen.Module"),d3.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(ot),Sd=n(ot,"P",{});var c3=r(Sd);Hv=i(c3,"Finally, this model supports inherent JAX features such as:"),c3.forEach(t),Vv=h(ot),Mt=n(ot,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p3=r(Id);ga=n(p3,"A",{href:!0,rel:!0});var h3=r(ga);Kv=i(h3,"Just-In-Time (JIT) compilation"),h3.forEach(t),p3.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u3=r(Wd);_a=n(u3,"A",{href:!0,rel:!0});var f3=r(_a);Gv=i(f3,"Automatic Differentiation"),f3.forEach(t),u3.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m3=r(Qd);ba=n(m3,"A",{href:!0,rel:!0});var g3=r(ba);Yv=i(g3,"Vectorization"),g3.forEach(t),m3.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _3=r(Rd);va=n(_3,"A",{href:!0,rel:!0});var b3=r(va);ek=i(b3,"Parallelization"),b3.forEach(t),_3.forEach(t),kn.forEach(t),tk=h(ot),gt=n(ot,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),ok=h(Tn),jo=n(Tn,"P",{});var Fl=r(jo);sk=i(Fl,"The "),Ud=n(Fl,"CODE",{});var v3=r(Ud);nk=i(v3,"FlaxDistilBertPreTrainedModel"),v3.forEach(t),rk=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k3=r(Hd);ak=i(k3,"__call__"),k3.forEach(t),ik=i(Fl," special method."),Fl.forEach(t),lk=h(Tn),$(Gs.$$.fragment,Tn),dk=h(Tn),$(Xs.$$.fragment,Tn),Tn.forEach(t),ot.forEach(t),ih=h(o),Co=n(o,"H2",{class:!0});var iu=r(Co);Ys=n(iu,"A",{id:!0,class:!0,href:!0});var T3=r(Ys);Vd=n(T3,"SPAN",{});var $3=r(Vd);$(Ta.$$.fragment,$3),$3.forEach(t),T3.forEach(t),ck=h(iu),Kd=n(iu,"SPAN",{});var w3=r(Kd);pk=i(w3,"FlaxDistilBertForMaskedLM"),w3.forEach(t),iu.forEach(t),lh=h(o),Ee=n(o,"DIV",{class:!0});var st=r(Ee);$($a.$$.fragment,st),hk=h(st),wa=n(st,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y3=r(Jd);fk=i(y3,"language modeling"),y3.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(st),ya=n(st,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D3=r(il);bk=i(D3,"FlaxPreTrainedModel"),D3.forEach(t),vk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kk=h(st),Da=n(st,"P",{});var cu=r(Da);Tk=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var F3=r(Fa);$k=i(F3,"flax.linen.Module"),F3.forEach(t),wk=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yk=h(st),Gd=n(st,"P",{});var B3=r(Gd);Dk=i(B3,"Finally, this model supports inherent JAX features such as:"),B3.forEach(t),Fk=h(st),Et=n(st,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var x3=r(Xd);Ba=n(x3,"A",{href:!0,rel:!0});var M3=r(Ba);Bk=i(M3,"Just-In-Time (JIT) compilation"),M3.forEach(t),x3.forEach(t),xk=h($n),Yd=n($n,"LI",{});var E3=r(Yd);xa=n(E3,"A",{href:!0,rel:!0});var z3=r(xa);Mk=i(z3,"Automatic Differentiation"),z3.forEach(t),E3.forEach(t),Ek=h($n),Zd=n($n,"LI",{});var j3=r(Zd);Ma=n(j3,"A",{href:!0,rel:!0});var C3=r(Ma);zk=i(C3,"Vectorization"),C3.forEach(t),j3.forEach(t),jk=h($n),ec=n($n,"LI",{});var q3=r(ec);Ea=n(q3,"A",{href:!0,rel:!0});var P3=r(Ea);Ck=i(P3,"Parallelization"),P3.forEach(t),q3.forEach(t),$n.forEach(t),qk=h(st),_t=n(st,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pk=h(wn),qo=n(wn,"P",{});var Bl=r(qo);Ak=i(Bl,"The "),tc=n(Bl,"CODE",{});var A3=r(tc);Ok=i(A3,"FlaxDistilBertPreTrainedModel"),A3.forEach(t),Nk=i(Bl," forward method, overrides the "),oc=n(Bl,"CODE",{});var O3=r(oc);Lk=i(O3,"__call__"),O3.forEach(t),Sk=i(Bl," special method."),Bl.forEach(t),Ik=h(wn),$(Zs.$$.fragment,wn),Wk=h(wn),$(en.$$.fragment,wn),wn.forEach(t),st.forEach(t),dh=h(o),Po=n(o,"H2",{class:!0});var pu=r(Po);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N3=r(tn);sc=n(N3,"SPAN",{});var L3=r(sc);$(ja.$$.fragment,L3),L3.forEach(t),N3.forEach(t),Qk=h(pu),nc=n(pu,"SPAN",{});var S3=r(nc);Rk=i(S3,"FlaxDistilBertForSequenceClassification"),S3.forEach(t),pu.forEach(t),ch=h(o),ze=n(o,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uk=h(nt),rc=n(nt,"P",{});var I3=r(rc);Hk=i(I3,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I3.forEach(t),Vk=h(nt),qa=n(nt,"P",{});var hu=r(qa);Kk=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W3=r(ll);Jk=i(W3,"FlaxPreTrainedModel"),W3.forEach(t),Gk=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q3=r(Aa);Zk=i(Q3,"flax.linen.Module"),Q3.forEach(t),eT=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tT=h(nt),ac=n(nt,"P",{});var R3=r(ac);oT=i(R3,"Finally, this model supports inherent JAX features such as:"),R3.forEach(t),sT=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U3=r(ic);Oa=n(U3,"A",{href:!0,rel:!0});var H3=r(Oa);nT=i(H3,"Just-In-Time (JIT) compilation"),H3.forEach(t),U3.forEach(t),rT=h(yn),lc=n(yn,"LI",{});var V3=r(lc);Na=n(V3,"A",{href:!0,rel:!0});var K3=r(Na);aT=i(K3,"Automatic Differentiation"),K3.forEach(t),V3.forEach(t),iT=h(yn),dc=n(yn,"LI",{});var J3=r(dc);La=n(J3,"A",{href:!0,rel:!0});var G3=r(La);lT=i(G3,"Vectorization"),G3.forEach(t),J3.forEach(t),dT=h(yn),cc=n(yn,"LI",{});var X3=r(cc);Sa=n(X3,"A",{href:!0,rel:!0});var Y3=r(Sa);cT=i(Y3,"Parallelization"),Y3.forEach(t),X3.forEach(t),yn.forEach(t),pT=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),hT=h(Dn),Ao=n(Dn,"P",{});var xl=r(Ao);uT=i(xl,"The "),pc=n(xl,"CODE",{});var Z3=r(pc);fT=i(Z3,"FlaxDistilBertPreTrainedModel"),Z3.forEach(t),mT=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);gT=i(ey,"__call__"),ey.forEach(t),_T=i(xl," special method."),xl.forEach(t),bT=h(Dn),$(on.$$.fragment,Dn),vT=h(Dn),$(sn.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(o),Oo=n(o,"H2",{class:!0});var fu=r(Oo);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var oy=r(uc);$(Wa.$$.fragment,oy),oy.forEach(t),ty.forEach(t),kT=h(fu),fc=n(fu,"SPAN",{});var sy=r(fc);TT=i(sy,"FlaxDistilBertForMultipleChoice"),sy.forEach(t),fu.forEach(t),hh=h(o),je=n(o,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$T=h(rt),mc=n(rt,"P",{});var ny=r(mc);wT=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
