...
`),u1=o("code"),zT=a("args.fp16_backend"),OT=a(". The rest of config values are up to you."),e3=u(),rs=o("p"),TT=a("This mode gets enabled when "),c1=o("code"),AT=a("--fp16 --fp16_backend amp"),ST=a(" or "),h1=o("code"),CT=a("--fp16_full_eval"),xT=a(" command line args are passed."),s3=u(),Du=o("p"),RT=a("You can also enable/disable this mode explicitly:"),t3=u(),f(Ql.$$.fragment),a3=u(),La=o("p"),IT=a("But then you\u2019re on your own synchronizing the "),zu=o("a"),UT=a("Trainer"),GT=a(` command line arguments and the DeepSpeed
configuration.`),n3=u(),Ma=o("p"),LT=a("Here is the "),er=o("a"),MT=a("documentation"),ZT=a("."),o3=u(),Ks=o("h3"),Za=o("a"),f1=o("span"),f(sr.$$.fragment),NT=u(),d1=o("span"),HT=a("bf16"),l3=u(),Ou=o("p"),BT=a("If bf16 (bfloat16) is desired instead of fp16 then the following configuration section is to be used:"),r3=u(),f(tr.$$.fragment),p3=u(),Tu=o("p"),WT=a("bf16 has the same dynamic range as fp32 and thus doesn\u2019t require loss scaling."),i3=u(),ps=o("p"),FT=a("This mode gets enabled when "),m1=o("code"),VT=a("--bf16"),YT=a(" or "),_1=o("code"),KT=a("--bf16_full_eval"),JT=a(" command line args are passed."),u3=u(),Au=o("p"),XT=a("You can also enable/disable this mode explicitly:"),c3=u(),f(ar.$$.fragment),h3=u(),f(Na.$$.fragment),f3=u(),Js=o("h3"),Ha=o("a"),v1=o("span"),f(nr.$$.fragment),QT=u(),j1=o("span"),eA=a("apex"),d3=u(),Su=o("p"),sA=a("To configure apex AMP-like mode set:"),m3=u(),f(or.$$.fragment),_3=u(),he=o("p"),tA=a("and the "),Cu=o("a"),aA=a("Trainer"),nA=a(" will automatically configure it based on the values of "),g1=o("code"),oA=a("args.fp16_backend"),lA=a(` and
`),y1=o("code"),rA=a("args.fp16_opt_level"),pA=a("."),v3=u(),Ba=o("p"),iA=a("This mode gets enabled when "),w1=o("code"),uA=a("--fp16 --fp16_backend apex --fp16_opt_level 01"),cA=a(" command line args are passed."),j3=u(),xu=o("p"),hA=a("You can also configure this mode explicitly:"),g3=u(),f(lr.$$.fragment),y3=u(),Wa=o("p"),fA=a("But then you\u2019re on your own synchronizing the "),Ru=o("a"),dA=a("Trainer"),mA=a(` command line arguments and the DeepSpeed
configuration.`),w3=u(),Fa=o("p"),_A=a("Here is the "),rr=o("a"),vA=a("documentation"),jA=a("."),b3=u(),Iu=o("a"),E3=u(),Xs=o("h3"),Va=o("a"),b1=o("span"),f(pr.$$.fragment),gA=u(),E1=o("span"),yA=a("Batch Size"),q3=u(),Uu=o("p"),wA=a("To configure batch size, use:"),$3=u(),f(ir.$$.fragment),k3=u(),N=o("p"),bA=a("and the "),Gu=o("a"),EA=a("Trainer"),qA=a(" will automatically set "),q1=o("code"),$A=a("train_micro_batch_size_per_gpu"),kA=a(` to the value of
`),$1=o("code"),PA=a("args.per_device_train_batch_size"),DA=a(" and "),k1=o("code"),zA=a("train_batch_size"),OA=a(" to "),P1=o("code"),TA=a("args.world_size * args.per_device_train_batch_size * args.gradient_accumulation_steps"),AA=a("."),P3=u(),Lu=o("p"),SA=a("You can also set the values explicitly:"),D3=u(),f(ur.$$.fragment),z3=u(),Ya=o("p"),CA=a("But then you\u2019re on your own synchronizing the "),Mu=o("a"),xA=a("Trainer"),RA=a(` command line arguments and the DeepSpeed
configuration.`),O3=u(),Zu=o("a"),T3=u(),Qs=o("h3"),Ka=o("a"),D1=o("span"),f(cr.$$.fragment),IA=u(),z1=o("span"),UA=a("Gradient Accumulation"),A3=u(),Nu=o("p"),GA=a("To configure gradient accumulation set:"),S3=u(),f(hr.$$.fragment),C3=u(),is=o("p"),LA=a("and the "),Hu=o("a"),MA=a("Trainer"),ZA=a(" will automatically set it to the value of "),O1=o("code"),NA=a("args.gradient_accumulation_steps"),HA=a("."),x3=u(),Bu=o("p"),BA=a("You can also set the value explicitly:"),R3=u(),f(fr.$$.fragment),I3=u(),Ja=o("p"),WA=a("But then you\u2019re on your own synchronizing the "),Wu=o("a"),FA=a("Trainer"),VA=a(` command line arguments and the DeepSpeed
configuration.`),U3=u(),Fu=o("a"),G3=u(),et=o("h3"),Xa=o("a"),T1=o("span"),f(dr.$$.fragment),YA=u(),A1=o("span"),KA=a("Gradient Clipping"),L3=u(),Vu=o("p"),JA=a("To configure gradient gradient clipping set:"),M3=u(),f(mr.$$.fragment),Z3=u(),us=o("p"),XA=a("and the "),Yu=o("a"),QA=a("Trainer"),eS=a(" will automatically set it to the value of "),S1=o("code"),sS=a("args.max_grad_norm"),tS=a("."),N3=u(),Ku=o("p"),aS=a("You can also set the value explicitly:"),H3=u(),f(_r.$$.fragment),B3=u(),Qa=o("p"),nS=a("But then you\u2019re on your own synchronizing the "),Ju=o("a"),oS=a("Trainer"),lS=a(` command line arguments and the DeepSpeed
configuration.`),W3=u(),Xu=o("a"),F3=u(),st=o("h3"),en=o("a"),C1=o("span"),f(vr.$$.fragment),rS=u(),x1=o("span"),pS=a("Getting The Model Weights Out"),V3=u(),sn=o("p"),iS=a(`As long as you continue training and resuming using DeepSpeed you don\u2019t need to worry about anything. DeepSpeed stores
...
pattern), and are saved under the normal checkpoint.`),Y3=u(),Qu=o("p"),I1=o("strong"),hS=a("FP16 Weights:"),K3=u(),tn=o("p"),fS=a("When a model is saved under ZeRO-2, you end up having the normal "),U1=o("code"),dS=a("pytorch_model.bin"),mS=a(` file with the model weights, but
they are only the fp16 version of the weights.`),J3=u(),T=o("p"),_S=a(`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
memory it can be done in the same training script. The following sections will discuss both approaches.`),sb=u(),sc=o("p"),W1=o("strong"),SS=a("Live FP32 Weights Recovery:"),tb=u(),tc=o("p"),CS=a("This approach may not work if you model is large and you have little free CPU memory left, at the end of the training."),ab=u(),ac=o("p"),xS=a("If you have saved at least one checkpoint, and you want to use the latest one, you can do the following:"),nb=u(),f(yr.$$.fragment),ob=u(),cs=o("p"),RS=a("If you\u2019re using the "),F1=o("code"),IS=a("--load_best_model_at_end"),US=a(" class:"),V1=o("em"),GS=a("~transformers.TrainingArguments"),LS=a(` argument (to track the best
checkpoint), then you can finish the training by first saving the final model explicitly and then do the same as above:`),lb=u(),f(wr.$$.fragment),rb=u(),f(nn.$$.fragment),pb=u(),on=o("p"),MS=a("Of course, you don\u2019t have to use class:"),Y1=o("em"),ZS=a("~transformers.Trainer"),NS=a(` and you can adjust the examples above to your own
trainer.`),ib=u(),ln=o("p"),HS=a("If for some reason you want more refinement, you can also extract the fp32 "),K1=o("code"),BS=a("state_dict"),WS=a(` of the weights and apply
these yourself as is shown in the following example:`),ub=u(),f(br.$$.fragment),cb=u(),nc=o("p"),J1=o("strong"),FS=a("Offline FP32 Weights Recovery:"),hb=u(),hs=o("p"),VS=a("DeepSpeed creates a special conversion script "),X1=o("code"),YS=a("zero_to_fp32.py"),KS=a(` which it places in the top-level of the checkpoint
folder. Using this script you can extract the weights at any point. The script is standalone and you no longer need to
have the configuration file or a `),Q1=o("code"),JS=a("Trainer"),XS=a(" to do the extraction."),fb=u(),oc=o("p"),QS=a("Let\u2019s say your checkpoint folder looks like this:"),db=u(),f(Er.$$.fragment),mb=u(),rn=o("p"),eC=a("In this example there is just one DeepSpeed checkpoint sub-folder "),ev=o("em"),sC=a("global_step1"),tC=a(`. Therefore to reconstruct the fp32
weights just run:`),_b=u(),f(qr.$$.fragment),vb=u(),pn=o("p"),aC=a("This is it. "),sv=o("code"),nC=a("pytorch_model.bin"),oC=a(" will now contain the full fp32 model weights consolidated from multiple GPUs."),jb=u(),lc=o("p"),lC=a("The script will automatically be able to handle either a ZeRO-2 or ZeRO-3 checkpoint."),gb=u(),$r=o("p"),tv=o("code"),rC=a("python zero_to_fp32.py -h"),pC=a(" will give you usage details."),yb=u(),fs=o("p"),iC=a("The script will auto-discover the deepspeed sub-folder using the contents of the file "),av=o("code"),uC=a("latest"),cC=a(`, which in the current
example will contain `),nv=o("code"),hC=a("global_step1"),fC=a("."),wb=u(),rc=o("p"),dC=a("Note: currently the script requires 2x general RAM of the final fp32 model weights."),bb=u(),tt=o("h3"),un=o("a"),ov=o("span"),f(kr.$$.fragment),mC=u(),lv=o("span"),_C=a("ZeRO-3 and Infinity Nuances"),Eb=u(),pc=o("p"),vC=a("ZeRO-3 is quite different from ZeRO-2 because of its param sharding feature."),qb=u(),ic=o("p"),jC=a("ZeRO-Infinity further extends ZeRO-3 to support NVMe memory and multiple other speed and scalability improvements."),$b=u(),uc=o("p"),gC=a(`While all the efforts were made for things to just work without needing any special changes to your models, in certain
circumstances you may find the following information to be needed.`),kb=u(),at=o("h4"),cn=o("a"),rv=o("span"),f(Pr.$$.fragment),yC=u(),pv=o("span"),wC=a("Constructing Massive Models"),Pb=u(),hn=o("p"),bC=a(`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
context manager (which is also a function decorator), like so:`),Db=u(),f(Dr.$$.fragment),zb=u(),cc=o("p"),$C=a("As you can see this gives you a randomly initialized model."),Ob=u(),D=o("p"),kC=a("If you want to use a pretrained model, "),uv=o("code"),PC=a("model_class.from_pretrained"),DC=a(` will activate this feature as long as
...
`),dv=o("code"),GC=a("from_pretrained"),LC=a(". Here is an example of a possible sequence:"),Tb=u(),f(zr.$$.fragment),Ab=u(),fn=o("p"),MC=a("If you\u2019re using the official example scripts and your command line arguments include "),mv=o("code"),ZC=a("--deepspeed ds_config.json"),NC=a(`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),Sb=u(),dc=o("p"),HC=a("Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),Cb=u(),dn=o("p"),BC=a("For full details on this method and other related features please refer to "),Or=o("a"),WC=a("Constructing Massive Models"),FC=a("."),xb=u(),fe=o("p"),VC=a("Also when loading fp16-pretrained models, you will want to tell "),_v=o("code"),YC=a("from_pretrained"),KC=a(` to use
`),vv=o("code"),JC=a("torch_dtype=torch.float16"),XC=a(". For details, please, see "),mc=o("a"),QC=a("from_pretrained-torch-dtype"),ex=a("."),Rb=u(),nt=o("h4"),mn=o("a"),jv=o("span"),f(Tr.$$.fragment),sx=u(),gv=o("span"),tx=a("Gathering Parameters"),Ib=u(),Ar=o("p"),ax=a(`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=o("a"),nx=a("Gathering Parameters"),Ub=u(),_n=o("p"),ox=a(`We do however use it internally in several places, one such example is when loading pretrained model weights in
...
pattern), and are saved under the normal checkpoint.`),Yq.forEach(t),Y3=c(e),Qu=l(e,"P",{});var QW=r(Qu);I1=l(QW,"STRONG",{});var eF=r(I1);hS=n(eF,"FP16 Weights:"),eF.forEach(t),QW.forEach(t),K3=c(e),tn=l(e,"P",{});var Kq=r(tn);fS=n(Kq,"When a model is saved under ZeRO-2, you end up having the normal "),U1=l(Kq,"CODE",{});var sF=r(U1);dS=n(sF,"pytorch_model.bin"),sF.forEach(t),mS=n(Kq,` file with the model weights, but
they are only the fp16 version of the weights.`),Kq.forEach(t),J3=c(e),T=l(e,"P",{});var Q=r(T);_S=n(Q,`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
`),dv=l(W,"CODE",{});var VF=r(dv);GC=n(VF,"from_pretrained"),VF.forEach(t),LC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),Tb=c(e),d(zr.$$.fragment,e),Ab=c(e),fn=l(e,"P",{});var o$=r(fn);MC=n(o$,"If you\u2019re using the official example scripts and your command line arguments include "),mv=l(o$,"CODE",{});var YF=r(mv);ZC=n(YF,"--deepspeed ds_config.json"),YF.forEach(t),NC=n(o$,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o$.forEach(t),Sb=c(e),dc=l(e,"P",{});var KF=r(dc);HC=n(KF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),KF.forEach(t),Cb=c(e),dn=l(e,"P",{});var l$=r(dn);BC=n(l$,"For full details on this method and other related features please refer to "),Or=l(l$,"A",{href:!0,rel:!0});var JF=r(Or);WC=n(JF,"Constructing Massive Models"),JF.forEach(t),FC=n(l$,"."),l$.forEach(t),xb=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),_v=l(Jn,"CODE",{});var XF=r(_v);YC=n(XF,"from_pretrained"),XF.forEach(t),KC=n(Jn,` to use
`),vv=l(Jn,"CODE",{});var QF=r(vv);JC=n(QF,"torch_dtype=torch.float16"),QF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var eV=r(mc);QC=n(eV,"from_pretrained-torch-dtype"),eV.forEach(t),ex=n(Jn,"."),Jn.forEach(t),Rb=c(e),nt=l(e,"H4",{class:!0});var r$=r(nt);mn=l(r$,"A",{id:!0,class:!0,href:!0});var sV=r(mn);jv=l(sV,"SPAN",{});var tV=r(jv);d(Tr.$$.fragment,tV),tV.forEach(t),sV.forEach(t),sx=c(r$),gv=l(r$,"SPAN",{});var aV=r(gv);tx=n(aV,"Gathering Parameters"),aV.forEach(t),r$.forEach(t),Ib=c(e),Ar=l(e,"P",{});var EG=r(Ar);ax=n(EG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(EG,"A",{href:!0,rel:!0});var nV=r(Sr);nx=n(nV,"Gathering Parameters"),nV.forEach(t),EG.forEach(t),Ub=c(e),_n=l(e,"P",{});var p$=r(_n);ox=n(p$,`We do however use it internally in several places, one such example is when loading pretrained model weights in
