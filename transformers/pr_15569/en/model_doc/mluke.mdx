...
Note that mLUKE has its own tokenizer, [MLukeTokenizer](/docs/transformers/pr_15569/en/model_doc/mluke#transformers.MLukeTokenizer). You can initialize it as follows:
...
Adapted from [XLMRobertaTokenizer](/docs/transformers/pr_15569/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer) and [LukeTokenizer](/docs/transformers/pr_15569/en/model_doc/luke#transformers.LukeTokenizer). Based on
