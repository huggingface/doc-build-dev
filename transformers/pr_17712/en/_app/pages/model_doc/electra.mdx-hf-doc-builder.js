...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17712/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17712/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17712/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17712/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17712/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),Sy=p(ft),y(zs.$$.fragment,ft),Wy=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),Uy=p(ko),en=s(ko,"P",{});var xc=a(en);Ry=i(xc,"The "),oc=s(xc,"A",{href:!0});var E7=a(oc);Hy=i(E7,"TFElectraForTokenClassification"),E7.forEach(t),Qy=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w7=a(nh);By=i(w7,"__call__"),w7.forEach(t),Vy=i(xc," special method."),xc.forEach(t),Ky=p(ko),y(js.$$.fragment,ko),Jy=p(ko),y(Cs.$$.fragment,ko),Gy=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $7=a(Ps);sh=s($7,"SPAN",{});var F7=a(sh);y($i.$$.fragment,F7),F7.forEach(t),$7.forEach(t),Xy=p(vg),ah=s(vg,"SPAN",{});var x7=a(ah);Yy=i(x7,"TFElectraForQuestionAnswering"),x7.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Bt=a(Xe);y(Fi.$$.fragment,Bt),Zy=p(Bt),on=s(Bt,"P",{});var Mc=a(on);eE=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M7=a(rh);tE=i(M7,"span start logits"),M7.forEach(t),oE=i(Mc," and "),ih=s(Mc,"CODE",{});var z7=a(ih);nE=i(z7,"span end logits"),z7.forEach(t),sE=i(Mc,")."),Mc.forEach(t),aE=p(Bt),xi=s(Bt,"P",{});var Tg=a(xi);rE=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var j7=a(nc);iE=i(j7,"TFPreTrainedModel"),j7.forEach(t),lE=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dE=p(Bt),Mi=s(Bt,"P",{});var bg=a(Mi);cE=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var C7=a(zi);pE=i(C7,"tf.keras.Model"),C7.forEach(t),hE=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mE=p(Bt),y(As.$$.fragment,Bt),uE=p(Bt),pt=s(Bt,"DIV",{class:!0});var vo=a(pt);y(ji.$$.fragment,vo),fE=p(vo),nn=s(vo,"P",{});var zc=a(nn);gE=i(zc,"The "),sc=s(zc,"A",{href:!0});var q7=a(sc);_E=i(q7,"TFElectraForQuestionAnswering"),q7.forEach(t),kE=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P7=a(lh);vE=i(P7,"__call__"),P7.forEach(t),TE=i(zc," special method."),zc.forEach(t),bE=p(vo),y(Os.$$.fragment,vo),yE=p(vo),y(Ls.$$.fragment,vo),EE=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Bt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A7=a(Is);dh=s(A7,"SPAN",{});var O7=a(dh);y(Ci.$$.fragment,O7),O7.forEach(t),A7.forEach(t),wE=p(yg),ch=s(yg,"SPAN",{});var L7=a(ch);$E=i(L7,"FlaxElectraModel"),L7.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),FE=p(gt),ph=s(gt,"P",{});var N7=a(ph);xE=i(N7,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N7.forEach(t),ME=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zE=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I7=a(ac);jE=i(I7,"FlaxPreTrainedModel"),I7.forEach(t),CE=i(Eg,`. Check the superclass documentation for the generic methods the
