import{S as pw,i as hw,s as uw,e as a,k as d,w as f,t as o,M as mw,c as r,d as n,m as l,a as i,x as _,h as s,b as c,F as e,g as p,y as g,q as T,o as v,B as k,v as fw}from"../../chunks/vendor-6b77c823.js";import{T as yt}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-af1d0ae0.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Te}from"../../chunks/IconCopyLink-7a11ce68.js";function _w(L){let u,z,b,w,$;return{c(){u=a("p"),z=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=a("code"),w=o("Module"),$=o(`
...
<p>A <a
  href="/docs/transformers/pr_16717/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16717/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16717/src/transformers/models/t5/modeling_t5.py#L1312"}}),zs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16717/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16717/src/transformers/models/t5/modeling_t5.py#L1507"}}),Ss=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16717/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ks=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16717/src/transformers/models/t5/modeling_t5.py#L1809",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16717/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16717/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16717/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),Xs=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16717/src/transformers/models/t5/modeling_t5.py#L1783"}}),Qs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16717/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16717/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16717/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
for summarization: `),B=r(Dr,"EM",{});var e1=i(B);Pe=s(e1,"summarize: \u2026"),e1.forEach(n),m=s(Dr,"."),Dr.forEach(n),Xk.forEach(n),E=l(Ir),te=r(Ir,"LI",{});var t1=i(te);De=r(t1,"P",{});var n1=i(De);dt=s(n1,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),n1.forEach(n),t1.forEach(n),D=l(Ir),Se=r(Ir,"LI",{});var o1=i(Se);ne=r(o1,"P",{});var oo=i(ne);lt=s(oo,"See the "),O=r(oo,"A",{href:!0});var s1=i(O);Y=s(s1,"training"),s1.forEach(n),ct=s(oo,", "),Ne=r(oo,"A",{href:!0});var a1=i(Ne);Z=s(a1,"inference"),a1.forEach(n),pt=s(oo," and "),Oe=r(oo,"A",{href:!0});var r1=i(Oe);Le=s(r1,"scripts"),r1.forEach(n),ht=s(oo," sections below for all details regarding usage."),oo.forEach(n),o1.forEach(n),Ir.forEach(n),Ul=l(t),Va=r(t,"P",{});var i1=i(Va);Kp=s(i1,"T5 comes in different sizes:"),i1.forEach(n),Wl=l(t),Ge=r(t,"UL",{});var Pt=i(Ge);di=r(Pt,"LI",{});var d1=i(di);li=r(d1,"P",{});var l1=i(li);mo=r(l1,"A",{href:!0,rel:!0});var c1=i(mo);Yp=s(c1,"t5-small"),c1.forEach(n),l1.forEach(n),d1.forEach(n),Zp=l(Pt),ci=r(Pt,"LI",{});var p1=i(ci);pi=r(p1,"P",{});var h1=i(pi);fo=r(h1,"A",{href:!0,rel:!0});var u1=i(fo);Jp=s(u1,"t5-base"),u1.forEach(n),h1.forEach(n),p1.forEach(n),Xp=l(Pt),hi=r(Pt,"LI",{});var m1=i(hi);ui=r(m1,"P",{});var f1=i(ui);_o=r(f1,"A",{href:!0,rel:!0});var _1=i(_o);Qp=s(_1,"t5-large"),_1.forEach(n),f1.forEach(n),m1.forEach(n),eh=l(Pt),mi=r(Pt,"LI",{});var g1=i(mi);fi=r(g1,"P",{});var T1=i(fi);go=r(T1,"A",{href:!0,rel:!0});var v1=i(go);th=s(v1,"t5-3b"),v1.forEach(n),T1.forEach(n),g1.forEach(n),nh=l(Pt),_i=r(Pt,"LI",{});var k1=i(_i);Ka=r(k1,"P",{});var Rk=i(Ka);To=r(Rk,"A",{href:!0,rel:!0});var b1=i(To);oh=s(b1,"t5-11b"),b1.forEach(n),sh=s(Rk,"."),Rk.forEach(n),k1.forEach(n),Pt.forEach(n),Rl=l(t),Ya=r(t,"P",{});var y1=i(Ya);ah=s(y1,"Based on the original T5 model, Google has released some follow-up works:"),y1.forEach(n),Bl=l(t),wt=r(t,"UL",{});var Sr=i(wt);gi=r(Sr,"LI",{});var w1=i(gi);kn=r(w1,"P",{});var Dl=i(kn);Ti=r(Dl,"STRONG",{});var x1=i(Ti);rh=s(x1,"T5v1.1"),x1.forEach(n),ih=s(Dl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Za=r(Dl,"A",{href:!0});var $1=i(Za);dh=s($1,"here"),$1.forEach(n),lh=s(Dl,"."),Dl.forEach(n),w1.forEach(n),ch=l(Sr),vi=r(Sr,"LI",{});var z1=i(vi);bn=r(z1,"P",{});var Sl=i(bn);ki=r(Sl,"STRONG",{});var j1=i(ki);ph=s(j1,"mT5"),j1.forEach(n),hh=s(Sl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),Ja=r(Sl,"A",{href:!0});var q1=i(Ja);uh=s(q1,"here"),q1.forEach(n),mh=s(Sl,"."),Sl.forEach(n),z1.forEach(n),fh=l(Sr),bi=r(Sr,"LI",{});var E1=i(bi);yn=r(E1,"P",{});var Gl=i(yn);yi=r(Gl,"STRONG",{});var F1=i(yi);_h=s(F1,"byT5"),F1.forEach(n),gh=s(Gl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Xa=r(Gl,"A",{href:!0});var M1=i(Xa);Th=s(M1,"here"),M1.forEach(n),vh=s(Gl,"."),Gl.forEach(n),E1.forEach(n),Sr.forEach(n),Hl=l(t),wn=r(t,"P",{});var Xc=i(wn);kh=s(Xc,"All checkpoints can be found on the "),vo=r(Xc,"A",{href:!0,rel:!0});var C1=i(vo);bh=s(C1,"hub"),C1.forEach(n),yh=s(Xc,"."),Xc.forEach(n),Vl=l(t),xt=r(t,"P",{});var Gr=i(xt);wh=s(Gr,"This model was contributed by "),ko=r(Gr,"A",{href:!0,rel:!0});var P1=i(ko);xh=s(P1,"thomwolf"),P1.forEach(n),$h=s(Gr,". The original code can be found "),bo=r(Gr,"A",{href:!0,rel:!0});var N1=i(bo);zh=s(N1,"here"),N1.forEach(n),jh=s(Gr,"."),Gr.forEach(n),Kl=l(t),Qa=r(t,"A",{id:!0}),i(Qa).forEach(n),Yl=l(t),Vt=r(t,"H2",{class:!0});var Qc=i(Vt);xn=r(Qc,"A",{id:!0,class:!0,href:!0});var O1=i(xn);wi=r(O1,"SPAN",{});var L1=i(wi);_(yo.$$.fragment,L1),L1.forEach(n),O1.forEach(n),qh=l(Qc),xi=r(Qc,"SPAN",{});var A1=i(xi);Eh=s(A1,"Training"),A1.forEach(n),Qc.forEach(n),Zl=l(t),ut=r(t,"P",{});var so=i(ut);Fh=s(so,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),$i=r(so,"CODE",{});var I1=i($i);Mh=s(I1,"input_ids"),I1.forEach(n),Ch=s(so,`. The target sequence is shifted to the right, i.e., prepended by a
start-sequence token and fed to the decoder using the `),zi=r(so,"CODE",{});var D1=i(zi);Ph=s(D1,"decoder_input_ids"),D1.forEach(n),Nh=s(so,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),ji=r(so,"CODE",{});var S1=i(ji);Oh=s(S1,"labels"),S1.forEach(n),Lh=s(so,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),so.forEach(n),Jl=l(t),$n=r(t,"P",{});var ep=i($n);Ah=s(ep,"One can use "),er=r(ep,"A",{href:!0});var G1=i(er);Ih=s(G1,"T5ForConditionalGeneration"),G1.forEach(n),Dh=s(ep,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),ep.forEach(n),Xl=l(t),tr=r(t,"UL",{});var U1=i(tr);qi=r(U1,"LI",{});var W1=i(qi);Sh=s(W1,"Unsupervised denoising training"),W1.forEach(n),U1.forEach(n),Ql=l(t),me=r(t,"P",{});var et=i(me);Gh=s(et,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Ei=r(et,"EM",{});var R1=i(Ei);Uh=s(R1,"a.k.a"),R1.forEach(n),Wh=s(et,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=r(et,"EM",{});var B1=i(Fi);Rh=s(B1,"real"),B1.forEach(n),Bh=s(et,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Mi=r(et,"CODE",{});var H1=i(Mi);Hh=s(H1,"<extra_id_0>"),H1.forEach(n),Vh=s(et,`,
`),Ci=r(et,"CODE",{});var V1=i(Ci);Kh=s(V1,"<extra_id_1>"),V1.forEach(n),Yh=s(et,", \u2026 up to "),Pi=r(et,"CODE",{});var K1=i(Pi);Zh=s(K1,"<extra_id_99>"),K1.forEach(n),Jh=s(et,`. As a default, 100 sentinel tokens are available in
`),nr=r(et,"A",{href:!0});var Y1=i(nr);Xh=s(Y1,"T5Tokenizer"),Y1.forEach(n),Qh=s(et,"."),et.forEach(n),ec=l(t),or=r(t,"P",{});var Z1=i(or);eu=s(Z1,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Z1.forEach(n),tc=l(t),_(wo.$$.fragment,t),nc=l(t),zn=r(t,"P",{});var tp=i(zn);tu=s(tp,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),xo=r(tp,"A",{href:!0,rel:!0});var J1=i(xo);nu=s(J1,"run_t5_mlm_flax.py"),J1.forEach(n),ou=s(tp,` script in the Examples
directory.`),tp.forEach(n),oc=l(t),sr=r(t,"UL",{});var X1=i(sr);Ni=r(X1,"LI",{});var Q1=i(Ni);su=s(Q1,"Supervised training"),Q1.forEach(n),X1.forEach(n),sc=l(t),ar=r(t,"P",{});var eb=i(ar);au=s(eb,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
...
it will evenly distribute blocks across all devices.`),f5.forEach(n),fT=l(Gt),Qd=r(Gt,"P",{});var _5=i(Qd);_T=s(_5,"Example:"),_5.forEach(n),gT=l(Gt),_(Js.$$.fragment,Gt),Gt.forEach(n),TT=l($e),Tt=r($e,"DIV",{class:!0});var po=i(Tt);_(Xs.$$.fragment,po),vT=l(po),el=r(po,"P",{});var g5=i(el);kT=s(g5,"Moves the model to cpu from a model parallel state."),g5.forEach(n),bT=l(po),tl=r(po,"P",{});var T5=i(tl);yT=s(T5,"Example:"),T5.forEach(n),wT=l(po),_(Qs.$$.fragment,po),po.forEach(n),$e.forEach(n),Gc=l(t),cn=r(t,"H2",{class:!0});var Pp=i(cn);Rn=r(Pp,"A",{id:!0,class:!0,href:!0});var v5=i(Rn);nl=r(v5,"SPAN",{});var k5=i(nl);_(ea.$$.fragment,k5),k5.forEach(n),v5.forEach(n),xT=l(Pp),ol=r(Pp,"SPAN",{});var b5=i(ol);$T=s(b5,"TFT5Model"),b5.forEach(n),Pp.forEach(n),Uc=l(t),de=r(t,"DIV",{class:!0});var ot=i(de);_(ta.$$.fragment,ot),zT=l(ot),sl=r(ot,"P",{});var y5=i(sl);jT=s(y5,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),y5.forEach(n),qT=l(ot),na=r(ot,"P",{});var Np=i(na);ET=s(Np,"The T5 model was proposed in "),oa=r(Np,"A",{href:!0,rel:!0});var w5=i(oa);FT=s(w5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
