...
<span class="hljs-keyword">is</span> paraphrase: <span class="hljs-number">6</span>%`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Z_($){let n,u;return n=new S({props:{$$slots:{default:[K_]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function sj($){let n,u;return n=new q({props:{code:`from transformers import AutoTokenizer, TFAutoModelForSequenceClassification
...
Answer: tensorflow <span class="hljs-number">2.</span> <span class="hljs-number">0</span> <span class="hljs-keyword">and</span> pytorch`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function aj($){let n,u;return n=new S({props:{$$slots:{default:[tj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function nj($){let n,u;return n=new q({props:{code:`from transformers import AutoTokenizer, TFAutoModelForQuestionAnswering
import tensorflow as tf
...
Answer: general - purpose architectures
Question: \u{1F917} Transformers provides interoperability between which frameworks?
Answer: tensorflow <span class="hljs-number">2.</span> <span class="hljs-number">0</span> <span class="hljs-keyword">and</span> pytorch`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function oj($){let n,u;return n=new S({props:{$$slots:{default:[nj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function rj($){let n,u;return n=new q({props:{code:`from transformers import AutoModelForMaskedLM, AutoTokenizer
import torch
...
Distilled models are smaller than the models they mimic. Using them instead of the large versions would <span class="hljs-built_in">help</span> improve our carbon footprint.`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function lj($){let n,u;return n=new S({props:{$$slots:{default:[rj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function ij($){let n,u;return n=new q({props:{code:`from transformers import TFAutoModelForMaskedLM, AutoTokenizer
import tensorflow as tf
...
Distilled models are smaller than the models they mimic. Using them instead of the large versions would <span class="hljs-built_in">help</span> decrease our carbon footprint.
Distilled models are smaller than the models they mimic. Using them instead of the large versions would <span class="hljs-built_in">help</span> offset our carbon footprint.
Distilled models are smaller than the models they mimic. Using them instead of the large versions would <span class="hljs-built_in">help</span> improve our carbon footprint.`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function pj($){let n,u;return n=new S({props:{$$slots:{default:[ij]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function cj($){let n,u,a,f,_,E,A,z;return A=new q({props:{code:`from transformers import AutoModelForCausalLM, AutoTokenizer, top_k_top_p_filtering
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(generated)
Today the weather <span class="hljs-keyword">is</span> really nice <span class="hljs-keyword">and</span> I am planning ...`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function _j($){let n,u;return n=new S({props:{$$slots:{default:[dj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function jj($){let n,u;return n=new q({props:{code:`from transformers import AutoModelForTokenClassification, AutoTokenizer
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predictions = torch.argmax(outputs, dim=<span class="hljs-number">2</span>)`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function kj($){let n,u;return n=new S({props:{$$slots:{default:[jj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function wj($){let n,u;return n=new q({props:{code:`from transformers import TFAutoModelForTokenClassification, AutoTokenizer
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predictions = tf.argmax(outputs, axis=<span class="hljs-number">2</span>)`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function xj($){let n,u;return n=new S({props:{$$slots:{default:[wj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function bj($){let n,u;return n=new q({props:{code:`from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
...
between <span class="hljs-number">1999</span> <span class="hljs-keyword">and</span> <span class="hljs-number">2002.</span>&lt;/s&gt;`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function yj($){let n,u;return n=new S({props:{$$slots:{default:[bj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function $j($){let n,u;return n=new q({props:{code:`from transformers import TFAutoModelForSeq2SeqLM, AutoTokenizer
...
&lt;pad&gt; prosecutors say the marriages were part of an immigration scam. <span class="hljs-keyword">if</span> convicted, barrientos faces two criminal
counts of <span class="hljs-string">&quot;offering a false instrument for filing in the first degree&quot;</span> she has been married <span class="hljs-number">10</span> times, nine of them
between <span class="hljs-number">1999</span> <span class="hljs-keyword">and</span> <span class="hljs-number">2002.</span>`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function vj($){let n,u;return n=new S({props:{$$slots:{default:[$j]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function qj($){let n,u;return n=new q({props:{code:`from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>]))
&lt;pad&gt; Hugging Face ist ein Technologieunternehmen mit Sitz <span class="hljs-keyword">in</span> New York und Paris.`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Aj($){let n,u;return n=new S({props:{$$slots:{default:[Tj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Ij($){let n,u;return n=new q({props:{code:`from transformers import AutoFeatureExtractor, AutoModelForAudioClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_label`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function zj($){let n,u;return n=new S({props:{$$slots:{default:[Ij]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Mj($){let n,u;return n=new q({props:{code:`from transformers import AutoProcessor, AutoModelForCTC
from datasets import load_dataset
import torch
...
Egyptian cat`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:N,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Fj($){let n,u;return n=new S({props:{$$slots:{default:[Pj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Cj($){let n,u,a,f,_,E,A,z,v,I,F,Vs,gs,As,Js,K,Is,fs,Ye,Ks,G,ds,zs,Zs,Z,U,We,Ms,se,us,ss,T,M,na,_s,oa,js,ra,ks,Qe,Ls,zi,ar,ee,Xa,Mi,Li,Va,Pi,nr,la,Fi,or,te,rr,Ps,ae,Ja,Xe,Ci,Ka,Ni,lr,Y,Si,Ve,Di,Oi,Je,Ri,Bi,Ke,Hi,Gi,Ze,Ui,Yi,ir,ia,Wi,pr,pa,Qi,cr,st,hr,ca,Xi,ur,W,Za,Vi,Ji,sn,Ki,Zi,en,sp,ep,tn,tp,ap,an,np,mr,ne,gr,Fs,oe,nn,et,op,on,rp,fr,ws,lp,tt,ip,pp,at,cp,hp,dr,ha,up,_r,nt,jr,ua,mp,kr,ot,wr,ma,gp,xr,D,rn,fp,dp,ln,_p,jp,pn,kp,wp,cn,xp,bp,hn,yp,$p,un,vp,qp,mn,Ep,br,re,yr,Cs,le,gn,rt,Tp,fn,Ap,$r,ga,Ip,vr,ie,zp,lt,Mp,Lp,qr,Ns,pe,dn,it,Pp,_n,Fp,Er,xs,Cp,pt,Np,Sp,ct,Dp,Op,Tr,fa,Rp,Ar,ht,Ir,da,Bp,zr,ut,Mr,_a,Hp,Lr,R,jn,Gp,Up,mt,Yp,kn,Wp,Qp,Xp,wn,Vp,Jp,xn,Kp,Zp,Ss,sc,bn,ec,tc,yn,ac,nc,oc,$n,rc,Pr,ce,Fr,ja,lc,Cr,Ds,he,vn,gt,ic,qn,pc,Nr,ue,cc,ft,hc,uc,Sr,ka,mc,Dr,me,Or,bs,gc,En,fc,dc,Tn,_c,jc,Rr,ge,kc,wa,wc,xc,Br,Os,fe,An,dt,bc,In,yc,Hr,B,$c,zn,vc,qc,Mn,Ec,Tc,Ln,Ac,Ic,Pn,zc,Mc,_t,Lc,Pc,Gr,de,Ur,L,Fc,Fn,Cc,Nc,Cn,Sc,Dc,Nn,Oc,Rc,Sn,Bc,Hc,Dn,Gc,Uc,On,Yc,Wc,Rn,Qc,Xc,Bn,Vc,Jc,Hn,Kc,Zc,Yr,_e,sh,jt,eh,th,Wr,Rs,je,Gn,kt,ah,Un,nh,Qr,ke,oh,wt,rh,lh,Xr,xa,ih,Vr,P,Yn,ph,ch,Wn,hh,uh,Qn,mh,gh,Xn,fh,dh,Vn,_h,jh,Jn,kh,wh,Kn,xh,bh,Zn,yh,$h,so,vh,Jr,ys,qh,xt,Eh,Th,bt,Ah,Ih,Kr,yt,Zr,ba,zh,sl,$t,el,ya,Mh,tl,$a,Lh,al,H,eo,Ph,Fh,to,Ch,Nh,ao,Sh,Dh,no,Oh,Rh,oo,Bh,Hh,ro,Gh,nl,we,ol,va,Uh,rl,$s,Yh,lo,Wh,Qh,io,Xh,Vh,ll,vt,il,Bs,xe,po,qt,Jh,co,Kh,pl,be,Zh,Et,su,eu,cl,ye,tu,Tt,au,nu,hl,qa,ou,ul,At,ml,Q,ru,ho,lu,iu,uo,pu,cu,mo,hu,uu,go,mu,gu,gl,It,fl,Ea,fu,dl,es,Hs,du,fo,_u,ju,_o,ku,wu,xu,jo,bu,yu,ko,$u,vu,zt,qu,wo,Eu,Tu,_l,Ta,Au,jl,$e,kl,Gs,ve,xo,Mt,Iu,bo,zu,wl,qe,Mu,Lt,Lu,Pu,xl,Ee,Fu,Pt,Cu,Nu,bl,Aa,Su,yl,Ft,$l,ts,Du,yo,Ou,Ru,$o,Bu,Hu,vo,Gu,Uu,vl,Ia,Yu,ql,as,Us,Wu,qo,Qu,Xu,Eo,Vu,Ju,Ku,To,Zu,sm,Ao,em,tm,Ct,am,Io,nm,om,El,Te,Tl,za,rm,Al,Ys,Ae,zo,Nt,lm,Mo,im,Il,ns,pm,St,cm,hm,Dt,um,mm,Ma,gm,fm,zl,Ie,dm,La,_m,jm,Ml,Ot,Ll,Pa,km,Pl,os,Lo,wm,xm,Po,bm,ym,Rt,$m,Fo,vm,qm,Em,Bt,Tm,Co,Am,Im,Fl,ze,Cl,Ws,Me,No,Ht,zm,So,Mm,Nl,X,Lm,Gt,Pm,Fm,Ut,Cm,Nm,Yt,Sm,Dm,Fa,Om,Rm,Sl,Le,Bm,Ca,Hm,Gm,Dl,Wt,Ol,Na,Um,Rl,rs,Do,Ym,Wm,Oo,Qm,Xm,Qt,Vm,Ro,Jm,Km,Zm,Bo,sg,Bl,Pe,Hl,Qs,Fe,Ho,Xt,eg,Go,tg,Gl,ls,ag,Vt,ng,og,Jt,rg,lg,Sa,ig,pg,Ul,Ce,cg,Da,hg,ug,Yl,Kt,Wl,Oa,mg,Ql,is,Uo,gg,fg,Yo,dg,_g,Zt,jg,Wo,kg,wg,xg,sa,bg,Qo,yg,$g,Xl,Ne,Vl;return E=new J({}),F=new V_({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Mixed",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/en/task_summary.ipynb"},{label:"PyTorch",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/en/pytorch/task_summary.ipynb"},{label:"TensorFlow",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/en/tensorflow/task_summary.ipynb"},{label:"Mixed",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/en/task_summary.ipynb"},{label:"PyTorch",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/en/pytorch/task_summary.ipynb"},{label:"TensorFlow",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/en/tensorflow/task_summary.ipynb"}]}}),te=new X_({props:{$$slots:{default:[J_]},$$scope:{ctx:$}}}),Xe=new J({}),st=new q({props:{code:`from transformers import pipeline
...
[{<span class="hljs-string">&#x27;translation_text&#x27;</span>: <span class="hljs-string">&#x27;Hugging Face ist ein Technologieunternehmen mit Sitz in New York und Paris.&#x27;</span>}]`}}),Te=new ms({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Aj],pytorch:[Ej]},$$scope:{ctx:$}}}),Nt=new J({}),Ot=new q({props:{code:`from transformers import pipeline
...
Class tiger cat <span class="hljs-keyword">with</span> score <span class="hljs-number">0.0229</span>`}}),Ne=new ms({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{pytorch:[Fj]},$$scope:{ctx:$}}}),{c(){n=l("meta"),u=m(),a=l("h1"),f=l("a"),_=l("span"),j(E.$$.fragment),A=m(),z=l("span"),v=o("Summary of the tasks"),I=m(),j(F.$$.fragment),Vs=m(),gs=l("p"),As=o(`This page shows the most frequent use-cases when using the library. The models available allow for many different
...
on scientific papers e.g. `),lt=l("a"),Mp=o("LysandreJik/arxiv-nlp"),Lp=o("."),qr=m(),Ns=l("h3"),pe=l("a"),dn=l("span"),j(it.$$.fragment),Pp=m(),_n=l("span"),Fp=o("Masked Language Modeling"),Er=m(),xs=l("p"),Cp=o(`Masked language modeling is the task of masking tokens in a sequence with a masking token, and prompting the model to
fill that mask with an appropriate token. This allows the model to attend to both the right context (tokens on the
right of the mask) and the left context (tokens on the left of the mask). Such a training creates a strong basis for
downstream tasks requiring bi-directional context, such as SQuAD (question answering, see `),pt=l("a"),Np=o("Lewis, Lui, Goyal et al."),Sp=o(`, part 4.2). If you would like to fine-tune a model on a masked language modeling
...
(see `),_t=l("a"),Lc=o("gpt-2 config"),Pc=o(" for example)."),Gr=m(),j(de.$$.fragment),Ur=m(),L=l("p"),Fc=o("Text generation is currently possible with "),Fn=l("em"),Cc=o("GPT-2"),Nc=o(", "),Cn=l("em"),Sc=o("OpenAi-GPT"),Dc=o(", "),Nn=l("em"),Oc=o("CTRL"),Rc=o(", "),Sn=l("em"),Bc=o("XLNet"),Hc=o(", "),Dn=l("em"),Gc=o("Transfo-XL"),Uc=o(" and "),On=l("em"),Yc=o("Reformer"),Wc=o(` in
...
with the weights stored in the checkpoint.`),Fh=m(),to=l("li"),Ch=o("Define a sequence with known entities, such as \u201CHugging Face\u201D as an organisation and \u201CNew York City\u201D as a location."),Nh=m(),ao=l("li"),Sh=o(`Split words into tokens so that they can be mapped to predictions. We use a small hack by, first, completely
...
translation task, various approaches are described in this `),Pt=l("a"),Cu=o("document"),Nu=o("."),bl=m(),Aa=l("p"),Su=o(`Here is an example of using the pipelines to do translation. It leverages a T5 model that was only pre-trained on a
...
text), for both the start and end positions.`),tf.forEach(t),bp=g(V),hn=i(V,"LI",{});var af=p(hn);yp=r(af,"Compute the softmax of the result to get probabilities over the tokens."),af.forEach(t),$p=g(V),un=i(V,"LI",{});var nf=p(un);vp=r(nf,"Fetch the tokens from the identified start and stop values, convert those tokens to a string."),nf.forEach(t),qp=g(V),mn=i(V,"LI",{});var of=p(mn);Ep=r(of,"Print the results."),of.forEach(t),V.forEach(t),br=g(s),k(re.$$.fragment,s),yr=g(s),Cs=i(s,"H2",{class:!0});var ei=p(Cs);le=i(ei,"A",{id:!0,class:!0,href:!0});var rf=p(le);gn=i(rf,"SPAN",{});var lf=p(gn);k(rt.$$.fragment,lf),lf.forEach(t),rf.forEach(t),Tp=g(ei),fn=i(ei,"SPAN",{});var pf=p(fn);Ap=r(pf,"Language Modeling"),pf.forEach(t),ei.forEach(t),$r=g(s),ga=i(s,"P",{});var cf=p(ga);Ip=r(cf,`Language modeling is the task of fitting a model to a corpus, which can be domain specific. All popular
transformer-based models are trained using a variant of language modeling, e.g. BERT with masked language modeling,
...
domain-specific: using a language model trained over a very large corpus, and then fine-tuning it to a news dataset or
on scientific papers e.g. `),lt=i(ti,"A",{href:!0,rel:!0});var hf=p(lt);Mp=r(hf,"LysandreJik/arxiv-nlp"),hf.forEach(t),Lp=r(ti,"."),ti.forEach(t),qr=g(s),Ns=i(s,"H3",{class:!0});var ai=p(Ns);pe=i(ai,"A",{id:!0,class:!0,href:!0});var uf=p(pe);dn=i(uf,"SPAN",{});var mf=p(dn);k(it.$$.fragment,mf),mf.forEach(t),uf.forEach(t),Pp=g(ai),_n=i(ai,"SPAN",{});var gf=p(_n);Fp=r(gf,"Masked Language Modeling"),gf.forEach(t),ai.forEach(t),Er=g(s),xs=i(s,"P",{});var Ba=p(xs);Cp=r(Ba,`Masked language modeling is the task of masking tokens in a sequence with a masking token, and prompting the model to
fill that mask with an appropriate token. This allows the model to attend to both the right context (tokens on the
right of the mask) and the left context (tokens on the left of the mask). Such a training creates a strong basis for
downstream tasks requiring bi-directional context, such as SQuAD (question answering, see `),pt=i(Ba,"A",{href:!0,rel:!0});var ff=p(pt);Np=r(ff,"Lewis, Lui, Goyal et al."),ff.forEach(t),Sp=r(Ba,`, part 4.2). If you would like to fine-tune a model on a masked language modeling
...
generate multiple tokens up to a specified length instead of one token at a time.`),li.forEach(t),Br=g(s),Os=i(s,"H3",{class:!0});var ii=p(Os);fe=i(ii,"A",{id:!0,class:!0,href:!0});var Cf=p(fe);An=i(Cf,"SPAN",{});var Nf=p(An);k(dt.$$.fragment,Nf),Nf.forEach(t),Cf.forEach(t),bc=g(ii),In=i(ii,"SPAN",{});var Sf=p(In);yc=r(Sf,"Text Generation"),Sf.forEach(t),ii.forEach(t),Hr=g(s),B=i(s,"P",{});var cs=p(B);$c=r(cs,"In text generation ("),zn=i(cs,"EM",{});var Df=p(zn);vc=r(Df,"a.k.a"),Df.forEach(t),qc=g(cs),Mn=i(cs,"EM",{});var Of=p(Mn);Ec=r(Of,"open-ended text generation"),Of.forEach(t),Tc=r(cs,`) the goal is to create a coherent portion of text that is a
...
(see `),_t=i(cs,"A",{href:!0,rel:!0});var Hf=p(_t);Lc=r(Hf,"gpt-2 config"),Hf.forEach(t),Pc=r(cs," for example)."),cs.forEach(t),Gr=g(s),k(de.$$.fragment,s),Ur=g(s),L=i(s,"P",{});var C=p(L);Fc=r(C,"Text generation is currently possible with "),Fn=i(C,"EM",{});var Gf=p(Fn);Cc=r(Gf,"GPT-2"),Gf.forEach(t),Nc=r(C,", "),Cn=i(C,"EM",{});var Uf=p(Cn);Sc=r(Uf,"OpenAi-GPT"),Uf.forEach(t),Dc=r(C,", "),Nn=i(C,"EM",{});var Yf=p(Nn);Oc=r(Yf,"CTRL"),Yf.forEach(t),Rc=r(C,", "),Sn=i(C,"EM",{});var Wf=p(Sn);Bc=r(Wf,"XLNet"),Wf.forEach(t),Hc=r(C,", "),Dn=i(C,"EM",{});var Qf=p(Dn);Gc=r(Qf,"Transfo-XL"),Qf.forEach(t),Uc=r(C," and "),On=i(C,"EM",{});var Xf=p(On);Yc=r(Xf,"Reformer"),Xf.forEach(t),Wc=r(C,` in
PyTorch and for most models in Tensorflow as well. As can be seen in the example above `),Rn=i(C,"EM",{});var Vf=p(Rn);Qc=r(Vf,"XLNet"),Vf.forEach(t),Xc=r(C," and "),Bn=i(C,"EM",{});var Jf=p(Bn);Vc=r(Jf,"Transfo-XL"),Jf.forEach(t),Jc=r(C,` often
...
on millions of webpages with a causal language modeling objective.`),C.forEach(t),Yr=g(s),_e=i(s,"P",{});var pi=p(_e);sh=r(pi,`For more information on how to apply different decoding strategies for text generation, please also refer to our text
...
arguments of `),uo=i(Es,"CODE",{});var Fd=p(uo);pu=r(Fd,"PreTrainedModel.generate()"),Fd.forEach(t),cu=r(Es," directly in the pipeline for "),mo=i(Es,"CODE",{});var Cd=p(mo);hu=r(Cd,"max_length"),Cd.forEach(t),uu=r(Es," and "),go=i(Es,"CODE",{});var Nd=p(go);mu=r(Nd,"min_length"),Nd.forEach(t),gu=r(Es,` as shown
...
data and the corresponding sentences in German as the target data. If you would like to fine-tune a model on a
translation task, various approaches are described in this `),Pt=i(ji,"A",{href:!0,rel:!0});var Xd=p(Pt);Cu=r(Xd,"document"),Xd.forEach(t),Nu=r(ji,"."),ji.forEach(t),bl=g(s),Aa=i(s,"P",{});var Vd=p(Aa);Su=r(Vd,`Here is an example of using the pipelines to do translation. It leverages a T5 model that was only pre-trained on a
