...
- One can use [PoolFormerFeatureExtractor](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor) to prepare images for the model.
...
This is the configuration class to store the configuration of [PoolFormerModel](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerModel). It is used to instantiate a
...
<docstring><name>class transformers.PoolFormerModel</name><anchor>transformers.PoolFormerModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15531/src/transformers/models/poolformer/modeling_poolformer.py#L362</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([PoolFormerConfig](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerConfig)) -- Model configuration class with all the parameters of the model.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.PoolFormerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15531/src/transformers/models/poolformer/modeling_poolformer.py#L375</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [PoolFormerFeatureExtractor](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor). See
...
elements depending on the configuration ([PoolFormerConfig](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerConfig)) and inputs.
...
The [PoolFormerModel](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.PoolFormerForImageClassification</name><anchor>transformers.PoolFormerForImageClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15531/src/transformers/models/poolformer/modeling_poolformer.py#L425</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([PoolFormerConfig](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15531/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.PoolFormerForImageClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15531/src/transformers/models/poolformer/modeling_poolformer.py#L441</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [PoolFormerFeatureExtractor](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor). See
  [PoolFormerFeatureExtractor.__call__()](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor.__call__) for details.
...
The [PoolFormerForImageClassification](/docs/transformers/pr_15531/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) forward method, overrides the `__call__` special method.
