import{S as H2,i as R2,s as Q2,e as s,k as l,w as _,t as a,L as G2,c as r,d as o,m as c,a as i,x as v,h as n,b as d,J as e,g as f,y as b,q as k,o as T,B as w}from"../../chunks/vendor-9e2b328e.js";import{T as ge}from"../../chunks/Tip-76f97a76.js";import{D as A}from"../../chunks/Docstring-50fd6873.js";import{C as N}from"../../chunks/CodeBlock-88e23343.js";import{I as B}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function X2($){let p,x,m,y,D;return{c(){p=s("p"),x=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),y=a("Module"),D=a(`
...
the latter silently ignores them.`)},l(g){p=r(g,"P",{});var u=i(p);x=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(u,"CODE",{});var V=i(m);y=n(V,"Module"),V.forEach(o),D=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(g,u){f(g,p,u),e(p,x),e(p,m),e(m,y),e(p,D)},d(g){g&&o(p)}}}function rv($){let p,x,m,y,D,g,u,V,xd,Qr,ze,mt,ms,Ht,Dd,fs,Vd,Gr,ft,$d,Rt,Ad,Fd,Xr,hn,Cd,Jr,un,Qt,Md,Gt,qd,jd,Ur,mn,zd,Kr,fn,Xt,Ed,gn,Pd,Sd,Yr,ve,Ld,Jt,Nd,Wd,Ut,Id,Od,Zr,Ee,gt,gs,Kt,Bd,_s,Hd,ei,H,Yt,Rd,_e,Qd,_n,Gd,Xd,vn,Jd,Ud,Zt,Kd,Yd,Zd,Pe,el,bn,tl,ol,kn,al,nl,sl,vs,rl,il,eo,ti,Se,_t,bs,to,dl,ks,ll,oi,R,oo,cl,Le,pl,Tn,hl,ul,ao,ml,fl,gl,Ne,_l,wn,vl,bl,yn,kl,Tl,wl,Ts,yl,xl,no,ai,We,vt,ws,so,Dl,ys,Vl,ni,Q,ro,$l,io,Al,lo,Fl,Cl,Ml,co,ql,xn,jl,zl,El,po,Pl,ho,Sl,Ll,Nl,U,uo,Wl,Ie,Il,Dn,Ol,Bl,xs,Hl,Rl,Ql,bt,Gl,Ds,Xl,Jl,mo,si,Oe,kt,Vs,fo,Ul,$s,Kl,ri,M,go,Yl,As,Zl,ec,_o,tc,vo,oc,ac,nc,bo,sc,Vn,rc,ic,dc,ko,lc,To,cc,pc,hc,K,wo,uc,Be,mc,$n,fc,gc,Fs,_c,vc,bc,Tt,kc,Cs,Tc,wc,yo,ii,He,wt,Ms,xo,yc,qs,xc,di,G,Do,Dc,Re,Vc,js,$c,Ac,Vo,Fc,Cc,Mc,$o,qc,An,jc,zc,Ec,Ao,Pc,Fo,Sc,Lc,Nc,W,Co,Wc,Qe,Ic,Fn,Oc,Bc,zs,Hc,Rc,Qc,yt,Gc,Es,Xc,Jc,Mo,Uc,qo,li,Ge,xt,Ps,jo,Kc,Ss,Yc,ci,q,zo,Zc,Ls,ep,tp,Eo,op,Po,ap,np,sp,So,rp,Cn,ip,dp,lp,Lo,cp,No,pp,hp,up,I,Wo,mp,Xe,fp,Mn,gp,_p,Ns,vp,bp,kp,Dt,Tp,Ws,wp,yp,Io,xp,Oo,pi,Je,Vt,Is,Bo,Dp,Os,Vp,hi,j,Ho,$p,Bs,Ap,Fp,Ro,Cp,Qo,Mp,qp,jp,Go,zp,qn,Ep,Pp,Sp,Xo,Lp,Jo,Np,Wp,Ip,Y,Uo,Op,Ue,Bp,jn,Hp,Rp,Hs,Qp,Gp,Xp,$t,Jp,Rs,Up,Kp,Ko,ui,Ke,At,Qs,Yo,Yp,Gs,Zp,mi,F,Zo,eh,ea,th,ta,oh,ah,nh,oa,sh,zn,rh,ih,dh,aa,lh,na,ch,ph,hh,sa,uh,Xs,mh,fh,gh,z,_h,Js,vh,bh,Us,kh,Th,Ks,wh,yh,Ys,xh,Dh,Zs,Vh,$h,er,Ah,Fh,Ch,Ft,Mh,tr,qh,jh,ra,zh,Eh,Z,ia,Ph,Ye,Sh,En,Lh,Nh,or,Wh,Ih,Oh,Ct,Bh,ar,Hh,Rh,da,fi,Ze,Mt,nr,la,Qh,sr,Gh,gi,X,ca,Xh,et,Jh,rr,Uh,Kh,pa,Yh,Zh,eu,ha,tu,Pn,ou,au,nu,ua,su,ma,ru,iu,du,ee,fa,lu,tt,cu,Sn,pu,hu,ir,uu,mu,fu,qt,gu,dr,_u,vu,ga,_i,ot,jt,lr,_a,bu,cr,ku,vi,J,va,Tu,at,wu,pr,yu,xu,ba,Du,Vu,$u,ka,Au,Ln,Fu,Cu,Mu,Ta,qu,wa,ju,zu,Eu,te,ya,Pu,nt,Su,Nn,Lu,Nu,hr,Wu,Iu,Ou,zt,Bu,ur,Hu,Ru,xa,bi,st,Et,mr,Da,Qu,fr,Gu,ki,E,Va,Xu,gr,Ju,Uu,$a,Ku,Aa,Yu,Zu,em,Fa,tm,Wn,om,am,nm,Ca,sm,Ma,rm,im,dm,C,qa,lm,rt,cm,In,pm,hm,_r,um,mm,fm,Pt,gm,vr,_m,vm,ja,bm,br,km,Tm,za,Ti,it,St,kr,Ea,wm,Tr,ym,wi,P,Pa,xm,wr,Dm,Vm,Sa,$m,La,Am,Fm,Cm,Na,Mm,On,qm,jm,zm,Wa,Em,Ia,Pm,Sm,Lm,oe,Oa,Nm,dt,Wm,Bn,Im,Om,yr,Bm,Hm,Rm,Lt,Qm,xr,Gm,Xm,Ba,yi,lt,Nt,Dr,Ha,Jm,Vr,Um,xi,S,Ra,Km,$r,Ym,Zm,Qa,ef,Ga,tf,of,af,Xa,nf,Hn,sf,rf,df,Ja,lf,Ua,cf,pf,hf,ae,Ka,uf,ct,mf,Rn,ff,gf,Ar,_f,vf,bf,Wt,kf,Fr,Tf,wf,Ya,Di,pt,It,Cr,Za,yf,Mr,xf,Vi,L,en,Df,ht,Vf,qr,$f,Af,jr,Ff,Cf,Mf,tn,qf,on,jf,zf,Ef,an,Pf,Qn,Sf,Lf,Nf,nn,Wf,sn,If,Of,Bf,ne,rn,Hf,ut,Rf,Gn,Qf,Gf,zr,Xf,Jf,Uf,Ot,Kf,Er,Yf,Zf,dn,$i;return g=new B({}),Ht=new B({}),Kt=new B({}),Yt=new A({props:{name:"class transformers.Data2VecTextConfig",anchor:"transformers.Data2VecTextConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/data2vec/configuration_data2vec_text.py#L31",parametersDescription:[{anchor:"transformers.Data2VecTextConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),Tt=new ge({props:{$$slots:{default:[J2]},$$scope:{ctx:$}}}),yo=new N({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Data2VecAudioForAudioFrameClassification
from datasets import load_dataset
import torch
...
`}}),yt=new ge({props:{$$slots:{default:[U2]},$$scope:{ctx:$}}}),Mo=new N({props:{code:`from transformers import Wav2Vec2Processor, Data2VecAudioForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),Bo=new B({}),Ho=new A({props:{name:"class transformers.Data2VecAudioForXVector",anchor:"transformers.Data2VecAudioForXVector",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1399",parametersDescription:[{anchor:"transformers.Data2VecAudioForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/data2vec#transformers.Data2VecAudioConfig">Data2VecAudioConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Uo=new A({props:{name:"forward",anchor:"transformers.Data2VecAudioForXVector.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1449",parametersDescription:[{anchor:"transformers.Data2VecAudioForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_15507/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15507/en/model_doc/data2vec#transformers.Data2VecTextConfig"
...
Models and code are available at `),Gt=s("a"),qd=a("www.github.com/pytorch/fairseq/tree/master/examples/data2vec"),jd=a("."),Ur=l(),mn=s("p"),zd=a("Tips:"),Kr=l(),fn=s("ul"),Xt=s("li"),Ed=a(`Both Data2VecAudio and Data2VecText have been trained using the same self-supervised learning method.
In the case of Data2VecAudio, preprocessing is identical to `),gn=s("a"),Pd=a("RobertaModel"),Sd=a(", including tokenization."),Yr=l(),ve=s("p"),Ld=a("This model was contributed by "),Jt=s("a"),Nd=a("edugp"),Wd=a(`.
The original code can be found `),Ut=s("a"),Id=a("here"),Od=a("."),Zr=l(),Ee=s("h2"),gt=s("a"),gs=s("span"),_(Kt.$$.fragment),Bd=l(),_s=s("span"),Hd=a("Data2VecTextConfig"),ei=l(),H=s("div"),_(Yt.$$.fragment),Rd=l(),_e=s("p"),Qd=a("This is the configuration class to store the configuration of a "),_n=s("a"),Gd=a("Data2VecTextModel"),Xd=a(" and "),vn=s("a"),Jd=a("Data2VecTextModel"),Ud=a(`. It
...
documentation from `),yn=s("a"),kl=a("PretrainedConfig"),Tl=a(" for more information."),wl=l(),Ts=s("p"),yl=a("Example:"),xl=l(),_(no.$$.fragment),ai=l(),We=s("h2"),vt=s("a"),ws=s("span"),_(so.$$.fragment),Dl=l(),ys=s("span"),Vl=a("Data2VecAudioModel"),ni=l(),Q=s("div"),_(ro.$$.fragment),$l=l(),io=s("p"),Al=a(`The bare Data2VecAudio Model transformer outputting raw hidden-states without any specific head on top.
Data2VecAudio was proposed in `),lo=s("a"),Fl=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Cl=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Ml=l(),co=s("p"),ql=a("This model inherits from "),xn=s("a"),jl=a("PreTrainedModel"),zl=a(`. Check the superclass documentation for the generic methods the
...
behavior.`),Nl=l(),U=s("div"),_(uo.$$.fragment),Wl=l(),Ie=s("p"),Il=a("The "),Dn=s("a"),Ol=a("Data2VecAudioModel"),Bl=a(" forward method, overrides the "),xs=s("code"),Hl=a("__call__"),Rl=a(" special method."),Ql=l(),_(bt.$$.fragment),Gl=l(),Ds=s("p"),Xl=a("Example:"),Jl=l(),_(mo.$$.fragment),si=l(),Oe=s("h2"),kt=s("a"),Vs=s("span"),_(fo.$$.fragment),Ul=l(),$s=s("span"),Kl=a("Data2VecAudioForAudioFrameClassification"),ri=l(),M=s("div"),_(go.$$.fragment),Yl=l(),As=s("p"),Zl=a("Data2VecAudio Model with a frame classification head on top for tasks like Speaker Diarization."),ec=l(),_o=s("p"),tc=a("Data2VecAudio was proposed in "),vo=s("a"),oc=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),ac=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),nc=l(),bo=s("p"),sc=a("This model inherits from "),Vn=s("a"),rc=a("PreTrainedModel"),ic=a(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),hc=l(),K=s("div"),_(wo.$$.fragment),uc=l(),Be=s("p"),mc=a("The "),$n=s("a"),fc=a("Data2VecAudioForAudioFrameClassification"),gc=a(" forward method, overrides the "),Fs=s("code"),_c=a("__call__"),vc=a(" special method."),bc=l(),_(Tt.$$.fragment),kc=l(),Cs=s("p"),Tc=a("Example:"),wc=l(),_(yo.$$.fragment),ii=l(),He=s("h2"),wt=s("a"),Ms=s("span"),_(xo.$$.fragment),yc=l(),qs=s("span"),xc=a("Data2VecAudioForCTC"),di=l(),G=s("div"),_(Do.$$.fragment),Dc=l(),Re=s("p"),Vc=a("Data2VecAudio Model with a "),js=s("code"),$c=a("language modeling"),Ac=a(` head on top for Connectionist Temporal Classification (CTC).
Data2VecAudio was proposed in `),Vo=s("a"),Fc=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Cc=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Mc=l(),$o=s("p"),qc=a("This model inherits from "),An=s("a"),jc=a("PreTrainedModel"),zc=a(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nc=l(),W=s("div"),_(Co.$$.fragment),Wc=l(),Qe=s("p"),Ic=a("The "),Fn=s("a"),Oc=a("Data2VecAudioForCTC"),Bc=a(" forward method, overrides the "),zs=s("code"),Hc=a("__call__"),Rc=a(" special method."),Qc=l(),_(yt.$$.fragment),Gc=l(),Es=s("p"),Xc=a("Example:"),Jc=l(),_(Mo.$$.fragment),Uc=l(),_(qo.$$.fragment),li=l(),Ge=s("h2"),xt=s("a"),Ps=s("span"),_(jo.$$.fragment),Kc=l(),Ss=s("span"),Yc=a("Data2VecAudioForSequenceClassification"),ci=l(),q=s("div"),_(zo.$$.fragment),Zc=l(),Ls=s("p"),ep=a(`Data2VecAudio Model with a sequence classification head on top (a linear layer over the pooled output) for tasks
like SUPERB Keyword Spotting.`),tp=l(),Eo=s("p"),op=a("Data2VecAudio was proposed in "),Po=s("a"),ap=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),np=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),sp=l(),So=s("p"),rp=a("This model inherits from "),Cn=s("a"),ip=a("PreTrainedModel"),dp=a(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),up=l(),I=s("div"),_(Wo.$$.fragment),mp=l(),Xe=s("p"),fp=a("The "),Mn=s("a"),gp=a("Data2VecAudioForSequenceClassification"),_p=a(" forward method, overrides the "),Ns=s("code"),vp=a("__call__"),bp=a(" special method."),kp=l(),_(Dt.$$.fragment),Tp=l(),Ws=s("p"),wp=a("Example:"),yp=l(),_(Io.$$.fragment),xp=l(),_(Oo.$$.fragment),pi=l(),Je=s("h2"),Vt=s("a"),Is=s("span"),_(Bo.$$.fragment),Dp=l(),Os=s("span"),Vp=a("Data2VecAudioForXVector"),hi=l(),j=s("div"),_(Ho.$$.fragment),$p=l(),Bs=s("p"),Ap=a("Data2VecAudio Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Fp=l(),Ro=s("p"),Cp=a("Data2VecAudio was proposed in "),Qo=s("a"),Mp=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),qp=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),jp=l(),Go=s("p"),zp=a("This model inherits from "),qn=s("a"),Ep=a("PreTrainedModel"),Pp=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sp=l(),Xo=s("p"),Lp=a("This model is a PyTorch "),Jo=s("a"),Np=a("torch.nn.Module"),Wp=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ip=l(),Y=s("div"),_(Uo.$$.fragment),Op=l(),Ue=s("p"),Bp=a("The "),jn=s("a"),Hp=a("Data2VecAudioForXVector"),Rp=a(" forward method, overrides the "),Hs=s("code"),Qp=a("__call__"),Gp=a(" special method."),Xp=l(),_($t.$$.fragment),Jp=l(),Rs=s("p"),Up=a("Example:"),Kp=l(),_(Ko.$$.fragment),ui=l(),Ke=s("h2"),At=s("a"),Qs=s("span"),_(Yo.$$.fragment),Yp=l(),Gs=s("span"),Zp=a("Data2VecTextModel"),mi=l(),F=s("div"),_(Zo.$$.fragment),eh=l(),ea=s("p"),th=a(`The bare Data2VecText Model for text transformer outputting raw hidden-states without any specific head on top.
Data2VecText was proposed in `),ta=s("a"),oh=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),ah=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),nh=l(),oa=s("p"),sh=a("This model inherits from "),zn=s("a"),rh=a("PreTrainedModel"),ih=a(`. Check the superclass documentation for the generic methods the
...
Kaiser and Illia Polosukhin.`),gh=l(),z=s("p"),_h=a("To behave as an decoder the model needs to be initialized with the "),Js=s("code"),vh=a("is_decoder"),bh=a(` argument of the configuration set
to `),Us=s("code"),kh=a("True"),Th=a(". To be used in a Seq2Seq model, the model needs to initialized with both "),Ks=s("code"),wh=a("is_decoder"),yh=a(` argument and
`),Ys=s("code"),xh=a("add_cross_attention"),Dh=a(" set to "),Zs=s("code"),Vh=a("True"),$h=a("; an "),er=s("code"),Ah=a("encoder_hidden_states"),Fh=a(" is then expected as an input to the forward pass."),Ch=l(),Ft=s("p"),Mh=a(".. _"),tr=s("em"),qh=a("Attention is all you need"),jh=a(": "),ra=s("a"),zh=a("https://arxiv.org/abs/1706.03762"),Eh=l(),Z=s("div"),_(ia.$$.fragment),Ph=l(),Ye=s("p"),Sh=a("The "),En=s("a"),Lh=a("Data2VecTextModel"),Nh=a(" forward method, overrides the "),or=s("code"),Wh=a("__call__"),Ih=a(" special method."),Oh=l(),_(Ct.$$.fragment),Bh=l(),ar=s("p"),Hh=a("Example:"),Rh=l(),_(da.$$.fragment),fi=l(),Ze=s("h2"),Mt=s("a"),nr=s("span"),_(la.$$.fragment),Qh=l(),sr=s("span"),Gh=a("Data2VecTextForCausalLM"),gi=l(),X=s("div"),_(ca.$$.fragment),Xh=l(),et=s("p"),Jh=a("Data2VecText Model with a "),rr=s("code"),Uh=a("language modeling"),Kh=a(` head on top for CLM fine-tuning.
Data2VecText was proposed in `),pa=s("a"),Yh=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Zh=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),eu=l(),ha=s("p"),tu=a("This model inherits from "),Pn=s("a"),ou=a("PreTrainedModel"),au=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nu=l(),ua=s("p"),su=a("This model is also a PyTorch "),ma=s("a"),ru=a("torch.nn.Module"),iu=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du=l(),ee=s("div"),_(fa.$$.fragment),lu=l(),tt=s("p"),cu=a("The "),Sn=s("a"),pu=a("Data2VecTextForCausalLM"),hu=a(" forward method, overrides the "),ir=s("code"),uu=a("__call__"),mu=a(" special method."),fu=l(),_(qt.$$.fragment),gu=l(),dr=s("p"),_u=a("Example:"),vu=l(),_(ga.$$.fragment),_i=l(),ot=s("h2"),jt=s("a"),lr=s("span"),_(_a.$$.fragment),bu=l(),cr=s("span"),ku=a("Data2VecTextForMaskedLM"),vi=l(),J=s("div"),_(va.$$.fragment),Tu=l(),at=s("p"),wu=a("data2vec Model with a "),pr=s("code"),yu=a("language modeling"),xu=a(` head on top.
Data2VecText was proposed in `),ba=s("a"),Du=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Vu=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),$u=l(),ka=s("p"),Au=a("This model inherits from "),Ln=s("a"),Fu=a("PreTrainedModel"),Cu=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mu=l(),Ta=s("p"),qu=a("This model is also a PyTorch "),wa=s("a"),ju=a("torch.nn.Module"),zu=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Eu=l(),te=s("div"),_(ya.$$.fragment),Pu=l(),nt=s("p"),Su=a("The "),Nn=s("a"),Lu=a("Data2VecTextForMaskedLM"),Nu=a(" forward method, overrides the "),hr=s("code"),Wu=a("__call__"),Iu=a(" special method."),Ou=l(),_(zt.$$.fragment),Bu=l(),ur=s("p"),Hu=a("Example:"),Ru=l(),_(xa.$$.fragment),bi=l(),st=s("h2"),Et=s("a"),mr=s("span"),_(Da.$$.fragment),Qu=l(),fr=s("span"),Gu=a("Data2VecTextForSequenceClassification"),ki=l(),E=s("div"),_(Va.$$.fragment),Xu=l(),gr=s("p"),Ju=a(`Data2VecText Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Uu=l(),$a=s("p"),Ku=a("Data2VecText was proposed in "),Aa=s("a"),Yu=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Zu=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),em=l(),Fa=s("p"),tm=a("This model inherits from "),Wn=s("a"),om=a("PreTrainedModel"),am=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
and a softmax) e.g. for RocStories/SWAG tasks.`),Vm=l(),Sa=s("p"),$m=a("Data2VecText was proposed in "),La=s("a"),Am=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Fm=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Cm=l(),Na=s("p"),Mm=a("This model inherits from "),On=s("a"),qm=a("PreTrainedModel"),jm=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zm=l(),Wa=s("p"),Em=a("This model is also a PyTorch "),Ia=s("a"),Pm=a("torch.nn.Module"),Sm=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lm=l(),oe=s("div"),_(Oa.$$.fragment),Nm=l(),dt=s("p"),Wm=a("The "),Bn=s("a"),Im=a("Data2VecTextForMultipleChoice"),Om=a(" forward method, overrides the "),yr=s("code"),Bm=a("__call__"),Hm=a(" special method."),Rm=l(),_(Lt.$$.fragment),Qm=l(),xr=s("p"),Gm=a("Example:"),Xm=l(),_(Ba.$$.fragment),yi=l(),lt=s("h2"),Nt=s("a"),Dr=s("span"),_(Ha.$$.fragment),Jm=l(),Vr=s("span"),Um=a("Data2VecTextForTokenClassification"),xi=l(),S=s("div"),_(Ra.$$.fragment),Km=l(),$r=s("p"),Ym=a(`Data2VecText Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Zm=l(),Qa=s("p"),ef=a("Data2VecText was proposed in "),Ga=s("a"),tf=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),of=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),af=l(),Xa=s("p"),nf=a("This model inherits from "),Hn=s("a"),sf=a("PreTrainedModel"),rf=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df=l(),Ja=s("p"),lf=a("This model is also a PyTorch "),Ua=s("a"),cf=a("torch.nn.Module"),pf=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hf=l(),ae=s("div"),_(Ka.$$.fragment),uf=l(),ct=s("p"),mf=a("The "),Rn=s("a"),ff=a("Data2VecTextForTokenClassification"),gf=a(" forward method, overrides the "),Ar=s("code"),_f=a("__call__"),vf=a(" special method."),bf=l(),_(Wt.$$.fragment),kf=l(),Fr=s("p"),Tf=a("Example:"),wf=l(),_(Ya.$$.fragment),Di=l(),pt=s("h2"),It=s("a"),Cr=s("span"),_(Za.$$.fragment),yf=l(),Mr=s("span"),xf=a("Data2VecTextForQuestionAnswering"),Vi=l(),L=s("div"),_(en.$$.fragment),Df=l(),ht=s("p"),Vf=a(`Data2VecText Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),qr=s("code"),$f=a("span start logits"),Af=a(" and "),jr=s("code"),Ff=a("span end logits"),Cf=a(")."),Mf=l(),tn=s("p"),qf=a("Data2VecText was proposed in "),on=s("a"),jf=a(`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),zf=a(` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Ef=l(),an=s("p"),Pf=a("This model inherits from "),Qn=s("a"),Sf=a("PreTrainedModel"),Lf=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nf=l(),nn=s("p"),Wf=a("This model is also a PyTorch "),sn=s("a"),If=a("torch.nn.Module"),Of=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bf=l(),ne=s("div"),_(rn.$$.fragment),Hf=l(),ut=s("p"),Rf=a("The "),Gn=s("a"),Qf=a("Data2VecTextForQuestionAnswering"),Gf=a(" forward method, overrides the "),zr=s("code"),Xf=a("__call__"),Jf=a(" special method."),Uf=l(),_(Ot.$$.fragment),Kf=l(),Er=s("p"),Yf=a("Example:"),Zf=l(),_(dn.$$.fragment),this.h()},l(t){const h=G2('[data-svelte="svelte-1phssyn"]',document.head);p=r(h,"META",{name:!0,content:!0}),h.forEach(o),x=c(t),m=r(t,"H1",{class:!0});var ln=i(m);y=r(ln,"A",{id:!0,class:!0,href:!0});var Pr=i(y);D=r(Pr,"SPAN",{});var Sr=i(D);v(g.$$.fragment,Sr),Sr.forEach(o),Pr.forEach(o),u=c(ln),V=r(ln,"SPAN",{});var Lr=i(V);xd=n(Lr,"Data2Vec"),Lr.forEach(o),ln.forEach(o),Qr=c(t),ze=r(t,"H2",{class:!0});var cn=i(ze);mt=r(cn,"A",{id:!0,class:!0,href:!0});var Nr=i(mt);ms=r(Nr,"SPAN",{});var Wr=i(ms);v(Ht.$$.fragment,Wr),Wr.forEach(o),Nr.forEach(o),Dd=c(cn),fs=r(cn,"SPAN",{});var Ir=i(fs);Vd=n(Ir,"Overview"),Ir.forEach(o),cn.forEach(o),Gr=c(t),ft=r(t,"P",{});var pn=i(ft);$d=n(pn,"The Data2Vec model was proposed in "),Rt=r(pn,"A",{href:!0,rel:!0});var Or=i(Rt);Ad=n(Or,"data2vec: A General Framework for Self-supervised Learning in Speech, Vision and Language"),Or.forEach(o),Fd=n(pn,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and Michael Auli.
Data2Vec proposes a unified framework for self-supervised learning across different data modalities - text, audio and images.
Importantly, predicted targets for pre-training are contextualized latent representations of the inputs, rather than modality-specific, context-independent targets.`),pn.forEach(o),Xr=c(t),hn=r(t,"P",{});var Br=i(hn);Cd=n(Br,"The abstract from the paper is the following:"),Br.forEach(o),Jr=c(t),un=r(t,"P",{});var Hr=i(un);Qt=r(Hr,"EM",{});var Ai=i(Qt);Md=n(Ai,`While the general idea of self-supervised learning is identical across modalities, the actual algorithms and
objectives differ widely because they were developed with a single modality in mind. To get us closer to general
self-supervised learning, we present data2vec, a framework that uses the same learning method for either speech,
NLP or computer vision. The core idea is to predict latent representations of the full input data based on a
masked view of the input in a selfdistillation setup using a standard Transformer architecture.
...
the entire input. Experiments on the major benchmarks of speech recognition, image classification, and
natural language understanding demonstrate a new state of the art or competitive performance to predominant approaches.
Models and code are available at `),Gt=r(Ai,"A",{href:!0,rel:!0});var eg=i(Gt);qd=n(eg,"www.github.com/pytorch/fairseq/tree/master/examples/data2vec"),eg.forEach(o),jd=n(Ai,"."),Ai.forEach(o),Hr.forEach(o),Ur=c(t),mn=r(t,"P",{});var tg=i(mn);zd=n(tg,"Tips:"),tg.forEach(o),Kr=c(t),fn=r(t,"UL",{});var og=i(fn);Xt=r(og,"LI",{});var Fi=i(Xt);Ed=n(Fi,`Both Data2VecAudio and Data2VecText have been trained using the same self-supervised learning method.
In the case of Data2VecAudio, preprocessing is identical to `),gn=r(Fi,"A",{href:!0});var ag=i(gn);Pd=n(ag,"RobertaModel"),ag.forEach(o),Sd=n(Fi,", including tokenization."),Fi.forEach(o),og.forEach(o),Yr=c(t),ve=r(t,"P",{});var Xn=i(ve);Ld=n(Xn,"This model was contributed by "),Jt=r(Xn,"A",{href:!0,rel:!0});var ng=i(Jt);Nd=n(ng,"edugp"),ng.forEach(o),Wd=n(Xn,`.
The original code can be found `),Ut=r(Xn,"A",{href:!0,rel:!0});var sg=i(Ut);Id=n(sg,"here"),sg.forEach(o),Od=n(Xn,"."),Xn.forEach(o),Zr=c(t),Ee=r(t,"H2",{class:!0});var Ci=i(Ee);gt=r(Ci,"A",{id:!0,class:!0,href:!0});var rg=i(gt);gs=r(rg,"SPAN",{});var ig=i(gs);v(Kt.$$.fragment,ig),ig.forEach(o),rg.forEach(o),Bd=c(Ci),_s=r(Ci,"SPAN",{});var dg=i(_s);Hd=n(dg,"Data2VecTextConfig"),dg.forEach(o),Ci.forEach(o),ei=c(t),H=r(t,"DIV",{class:!0});var be=i(H);v(Yt.$$.fragment,be),Rd=c(be),_e=r(be,"P",{});var Bt=i(_e);Qd=n(Bt,"This is the configuration class to store the configuration of a "),_n=r(Bt,"A",{href:!0});var lg=i(_n);Gd=n(lg,"Data2VecTextModel"),lg.forEach(o),Xd=n(Bt," and "),vn=r(Bt,"A",{href:!0});var cg=i(vn);Jd=n(cg,"Data2VecTextModel"),cg.forEach(o),Ud=n(Bt,`. It
is used to instantiate a Data2VecText model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Data2VecText
`),Zt=r(Bt,"A",{href:!0,rel:!0});var pg=i(Zt);Kd=n(pg,"facebook/data2vec-text-base"),pg.forEach(o),Yd=n(Bt," architecture."),Bt.forEach(o),Zd=c(be),Pe=r(be,"P",{});var Jn=i(Pe);el=n(Jn,"Configuration objects inherit from "),bn=r(Jn,"A",{href:!0});var hg=i(bn);tl=n(hg,"PretrainedConfig"),hg.forEach(o),ol=n(Jn,` and can be used to control the model outputs. Read the
documentation from `),kn=r(Jn,"A",{href:!0});var ug=i(kn);al=n(ug,"PretrainedConfig"),ug.forEach(o),nl=n(Jn," for more information."),Jn.forEach(o),sl=c(be),vs=r(be,"P",{});var mg=i(vs);rl=n(mg,"Examples:"),mg.forEach(o),il=c(be),v(eo.$$.fragment,be),be.forEach(o),ti=c(t),Se=r(t,"H2",{class:!0});var Mi=i(Se);_t=r(Mi,"A",{id:!0,class:!0,href:!0});var fg=i(_t);bs=r(fg,"SPAN",{});var gg=i(bs);v(to.$$.fragment,gg),gg.forEach(o),fg.forEach(o),dl=c(Mi),ks=r(Mi,"SPAN",{});var _g=i(ks);ll=n(_g,"Data2VecAudioConfig"),_g.forEach(o),Mi.forEach(o),oi=c(t),R=r(t,"DIV",{class:!0});var ke=i(R);v(oo.$$.fragment,ke),cl=c(ke),Le=r(ke,"P",{});var Un=i(Le);pl=n(Un,"This is the configuration class to store the configuration of a "),Tn=r(Un,"A",{href:!0});var vg=i(Tn);hl=n(vg,"Data2VecAudioModel"),vg.forEach(o),ul=n(Un,`. It is used to instantiate
an Data2VecAudio model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Data2VecAudio
`),ao=r(Un,"A",{href:!0,rel:!0});var bg=i(ao);ml=n(bg,"facebook/data2vec-audio-base-960h"),bg.forEach(o),fl=n(Un," architecture."),Un.forEach(o),gl=c(ke),Ne=r(ke,"P",{});var Kn=i(Ne);_l=n(Kn,"Configuration objects inherit from "),wn=r(Kn,"A",{href:!0});var kg=i(wn);vl=n(kg,"PretrainedConfig"),kg.forEach(o),bl=n(Kn,` and can be used to control the model outputs. Read the
documentation from `),yn=r(Kn,"A",{href:!0});var Tg=i(yn);kl=n(Tg,"PretrainedConfig"),Tg.forEach(o),Tl=n(Kn," for more information."),Kn.forEach(o),wl=c(ke),Ts=r(ke,"P",{});var wg=i(Ts);yl=n(wg,"Example:"),wg.forEach(o),xl=c(ke),v(no.$$.fragment,ke),ke.forEach(o),ai=c(t),We=r(t,"H2",{class:!0});var qi=i(We);vt=r(qi,"A",{id:!0,class:!0,href:!0});var yg=i(vt);ws=r(yg,"SPAN",{});var xg=i(ws);v(so.$$.fragment,xg),xg.forEach(o),yg.forEach(o),Dl=c(qi),ys=r(qi,"SPAN",{});var Dg=i(ys);Vl=n(Dg,"Data2VecAudioModel"),Dg.forEach(o),qi.forEach(o),ni=c(t),Q=r(t,"DIV",{class:!0});var Te=i(Q);v(ro.$$.fragment,Te),$l=c(Te),io=r(Te,"P",{});var ji=i(io);Al=n(ji,`The bare Data2VecAudio Model transformer outputting raw hidden-states without any specific head on top.
Data2VecAudio was proposed in `),lo=r(ji,"A",{href:!0,rel:!0});var Vg=i(lo);Fl=n(Vg,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Vg.forEach(o),Cl=n(ji,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),ji.forEach(o),Ml=c(Te),co=r(Te,"P",{});var zi=i(co);ql=n(zi,"This model inherits from "),xn=r(zi,"A",{href:!0});var $g=i(xn);jl=n($g,"PreTrainedModel"),$g.forEach(o),zl=n(zi,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ei.forEach(o),Nl=c(Te),U=r(Te,"DIV",{class:!0});var we=i(U);v(uo.$$.fragment,we),Wl=c(we),Ie=r(we,"P",{});var Yn=i(Ie);Il=n(Yn,"The "),Dn=r(Yn,"A",{href:!0});var Fg=i(Dn);Ol=n(Fg,"Data2VecAudioModel"),Fg.forEach(o),Bl=n(Yn," forward method, overrides the "),xs=r(Yn,"CODE",{});var Cg=i(xs);Hl=n(Cg,"__call__"),Cg.forEach(o),Rl=n(Yn," special method."),Yn.forEach(o),Ql=c(we),v(bt.$$.fragment,we),Gl=c(we),Ds=r(we,"P",{});var Mg=i(Ds);Xl=n(Mg,"Example:"),Mg.forEach(o),Jl=c(we),v(mo.$$.fragment,we),we.forEach(o),Te.forEach(o),si=c(t),Oe=r(t,"H2",{class:!0});var Pi=i(Oe);kt=r(Pi,"A",{id:!0,class:!0,href:!0});var qg=i(kt);Vs=r(qg,"SPAN",{});var jg=i(Vs);v(fo.$$.fragment,jg),jg.forEach(o),qg.forEach(o),Ul=c(Pi),$s=r(Pi,"SPAN",{});var zg=i($s);Kl=n(zg,"Data2VecAudioForAudioFrameClassification"),zg.forEach(o),Pi.forEach(o),ri=c(t),M=r(t,"DIV",{class:!0});var ie=i(M);v(go.$$.fragment,ie),Yl=c(ie),As=r(ie,"P",{});var Eg=i(As);Zl=n(Eg,"Data2VecAudio Model with a frame classification head on top for tasks like Speaker Diarization."),Eg.forEach(o),ec=c(ie),_o=r(ie,"P",{});var Si=i(_o);tc=n(Si,"Data2VecAudio was proposed in "),vo=r(Si,"A",{href:!0,rel:!0});var Pg=i(vo);oc=n(Pg,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Pg.forEach(o),ac=n(Si,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Si.forEach(o),nc=c(ie),bo=r(ie,"P",{});var Li=i(bo);sc=n(Li,"This model inherits from "),Vn=r(Li,"A",{href:!0});var Sg=i(Vn);rc=n(Sg,"PreTrainedModel"),Sg.forEach(o),ic=n(Li,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ni.forEach(o),hc=c(ie),K=r(ie,"DIV",{class:!0});var ye=i(K);v(wo.$$.fragment,ye),uc=c(ye),Be=r(ye,"P",{});var Zn=i(Be);mc=n(Zn,"The "),$n=r(Zn,"A",{href:!0});var Ng=i($n);fc=n(Ng,"Data2VecAudioForAudioFrameClassification"),Ng.forEach(o),gc=n(Zn," forward method, overrides the "),Fs=r(Zn,"CODE",{});var Wg=i(Fs);_c=n(Wg,"__call__"),Wg.forEach(o),vc=n(Zn," special method."),Zn.forEach(o),bc=c(ye),v(Tt.$$.fragment,ye),kc=c(ye),Cs=r(ye,"P",{});var Ig=i(Cs);Tc=n(Ig,"Example:"),Ig.forEach(o),wc=c(ye),v(yo.$$.fragment,ye),ye.forEach(o),ie.forEach(o),ii=c(t),He=r(t,"H2",{class:!0});var Wi=i(He);wt=r(Wi,"A",{id:!0,class:!0,href:!0});var Og=i(wt);Ms=r(Og,"SPAN",{});var Bg=i(Ms);v(xo.$$.fragment,Bg),Bg.forEach(o),Og.forEach(o),yc=c(Wi),qs=r(Wi,"SPAN",{});var Hg=i(qs);xc=n(Hg,"Data2VecAudioForCTC"),Hg.forEach(o),Wi.forEach(o),di=c(t),G=r(t,"DIV",{class:!0});var xe=i(G);v(Do.$$.fragment,xe),Dc=c(xe),Re=r(xe,"P",{});var es=i(Re);Vc=n(es,"Data2VecAudio Model with a "),js=r(es,"CODE",{});var Rg=i(js);$c=n(Rg,"language modeling"),Rg.forEach(o),Ac=n(es,` head on top for Connectionist Temporal Classification (CTC).
Data2VecAudio was proposed in `),Vo=r(es,"A",{href:!0,rel:!0});var Qg=i(Vo);Fc=n(Qg,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),Qg.forEach(o),Cc=n(es,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),es.forEach(o),Mc=c(xe),$o=r(xe,"P",{});var Ii=i($o);qc=n(Ii,"This model inherits from "),An=r(Ii,"A",{href:!0});var Gg=i(An);jc=n(Gg,"PreTrainedModel"),Gg.forEach(o),zc=n(Ii,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Oi.forEach(o),Nc=c(xe),W=r(xe,"DIV",{class:!0});var de=i(W);v(Co.$$.fragment,de),Wc=c(de),Qe=r(de,"P",{});var ts=i(Qe);Ic=n(ts,"The "),Fn=r(ts,"A",{href:!0});var Jg=i(Fn);Oc=n(Jg,"Data2VecAudioForCTC"),Jg.forEach(o),Bc=n(ts," forward method, overrides the "),zs=r(ts,"CODE",{});var Ug=i(zs);Hc=n(Ug,"__call__"),Ug.forEach(o),Rc=n(ts," special method."),ts.forEach(o),Qc=c(de),v(yt.$$.fragment,de),Gc=c(de),Es=r(de,"P",{});var Kg=i(Es);Xc=n(Kg,"Example:"),Kg.forEach(o),Jc=c(de),v(Mo.$$.fragment,de),Uc=c(de),v(qo.$$.fragment,de),de.forEach(o),xe.forEach(o),li=c(t),Ge=r(t,"H2",{class:!0});var Bi=i(Ge);xt=r(Bi,"A",{id:!0,class:!0,href:!0});var Yg=i(xt);Ps=r(Yg,"SPAN",{});var Zg=i(Ps);v(jo.$$.fragment,Zg),Zg.forEach(o),Yg.forEach(o),Kc=c(Bi),Ss=r(Bi,"SPAN",{});var e_=i(Ss);Yc=n(e_,"Data2VecAudioForSequenceClassification"),e_.forEach(o),Bi.forEach(o),ci=c(t),q=r(t,"DIV",{class:!0});var le=i(q);v(zo.$$.fragment,le),Zc=c(le),Ls=r(le,"P",{});var t_=i(Ls);ep=n(t_,`Data2VecAudio Model with a sequence classification head on top (a linear layer over the pooled output) for tasks
like SUPERB Keyword Spotting.`),t_.forEach(o),tp=c(le),Eo=r(le,"P",{});var Hi=i(Eo);op=n(Hi,"Data2VecAudio was proposed in "),Po=r(Hi,"A",{href:!0,rel:!0});var o_=i(Po);ap=n(o_,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),o_.forEach(o),np=n(Hi,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Hi.forEach(o),sp=c(le),So=r(le,"P",{});var Ri=i(So);rp=n(Ri,"This model inherits from "),Cn=r(Ri,"A",{href:!0});var a_=i(Cn);ip=n(a_,"PreTrainedModel"),a_.forEach(o),dp=n(Ri,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Qi.forEach(o),up=c(le),I=r(le,"DIV",{class:!0});var ce=i(I);v(Wo.$$.fragment,ce),mp=c(ce),Xe=r(ce,"P",{});var os=i(Xe);fp=n(os,"The "),Mn=r(os,"A",{href:!0});var s_=i(Mn);gp=n(s_,"Data2VecAudioForSequenceClassification"),s_.forEach(o),_p=n(os," forward method, overrides the "),Ns=r(os,"CODE",{});var r_=i(Ns);vp=n(r_,"__call__"),r_.forEach(o),bp=n(os," special method."),os.forEach(o),kp=c(ce),v(Dt.$$.fragment,ce),Tp=c(ce),Ws=r(ce,"P",{});var i_=i(Ws);wp=n(i_,"Example:"),i_.forEach(o),yp=c(ce),v(Io.$$.fragment,ce),xp=c(ce),v(Oo.$$.fragment,ce),ce.forEach(o),le.forEach(o),pi=c(t),Je=r(t,"H2",{class:!0});var Gi=i(Je);Vt=r(Gi,"A",{id:!0,class:!0,href:!0});var d_=i(Vt);Is=r(d_,"SPAN",{});var l_=i(Is);v(Bo.$$.fragment,l_),l_.forEach(o),d_.forEach(o),Dp=c(Gi),Os=r(Gi,"SPAN",{});var c_=i(Os);Vp=n(c_,"Data2VecAudioForXVector"),c_.forEach(o),Gi.forEach(o),hi=c(t),j=r(t,"DIV",{class:!0});var pe=i(j);v(Ho.$$.fragment,pe),$p=c(pe),Bs=r(pe,"P",{});var p_=i(Bs);Ap=n(p_,"Data2VecAudio Model with an XVector feature extraction head on top for tasks like Speaker Verification."),p_.forEach(o),Fp=c(pe),Ro=r(pe,"P",{});var Xi=i(Ro);Cp=n(Xi,"Data2VecAudio was proposed in "),Qo=r(Xi,"A",{href:!0,rel:!0});var h_=i(Qo);Mp=n(h_,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),h_.forEach(o),qp=n(Xi,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Xi.forEach(o),jp=c(pe),Go=r(pe,"P",{});var Ji=i(Go);zp=n(Ji,"This model inherits from "),qn=r(Ji,"A",{href:!0});var u_=i(qn);Ep=n(u_,"PreTrainedModel"),u_.forEach(o),Pp=n(Ji,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Ji.forEach(o),Sp=c(pe),Xo=r(pe,"P",{});var Ui=i(Xo);Lp=n(Ui,"This model is a PyTorch "),Jo=r(Ui,"A",{href:!0,rel:!0});var m_=i(Jo);Np=n(m_,"torch.nn.Module"),m_.forEach(o),Wp=n(Ui,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ui.forEach(o),Ip=c(pe),Y=r(pe,"DIV",{class:!0});var De=i(Y);v(Uo.$$.fragment,De),Op=c(De),Ue=r(De,"P",{});var as=i(Ue);Bp=n(as,"The "),jn=r(as,"A",{href:!0});var f_=i(jn);Hp=n(f_,"Data2VecAudioForXVector"),f_.forEach(o),Rp=n(as," forward method, overrides the "),Hs=r(as,"CODE",{});var g_=i(Hs);Qp=n(g_,"__call__"),g_.forEach(o),Gp=n(as," special method."),as.forEach(o),Xp=c(De),v($t.$$.fragment,De),Jp=c(De),Rs=r(De,"P",{});var __=i(Rs);Up=n(__,"Example:"),__.forEach(o),Kp=c(De),v(Ko.$$.fragment,De),De.forEach(o),pe.forEach(o),ui=c(t),Ke=r(t,"H2",{class:!0});var Ki=i(Ke);At=r(Ki,"A",{id:!0,class:!0,href:!0});var v_=i(At);Qs=r(v_,"SPAN",{});var b_=i(Qs);v(Yo.$$.fragment,b_),b_.forEach(o),v_.forEach(o),Yp=c(Ki),Gs=r(Ki,"SPAN",{});var k_=i(Gs);Zp=n(k_,"Data2VecTextModel"),k_.forEach(o),Ki.forEach(o),mi=c(t),F=r(t,"DIV",{class:!0});var O=i(F);v(Zo.$$.fragment,O),eh=c(O),ea=r(O,"P",{});var Yi=i(ea);th=n(Yi,`The bare Data2VecText Model for text transformer outputting raw hidden-states without any specific head on top.
Data2VecText was proposed in `),ta=r(Yi,"A",{href:!0,rel:!0});var T_=i(ta);oh=n(T_,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),T_.forEach(o),ah=n(Yi,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Yi.forEach(o),nh=c(O),oa=r(O,"P",{});var Zi=i(oa);sh=n(Zi,"This model inherits from "),zn=r(Zi,"A",{href:!0});var w_=i(zn);rh=n(w_,"PreTrainedModel"),w_.forEach(o),ih=n(Zi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nd.forEach(o),du=c($e),ee=r($e,"DIV",{class:!0});var Ae=i(ee);v(fa.$$.fragment,Ae),lu=c(Ae),tt=r(Ae,"P",{});var rs=i(tt);cu=n(rs,"The "),Sn=r(rs,"A",{href:!0});var B_=i(Sn);pu=n(B_,"Data2VecTextForCausalLM"),B_.forEach(o),hu=n(rs," forward method, overrides the "),ir=r(rs,"CODE",{});var H_=i(ir);uu=n(H_,"__call__"),H_.forEach(o),mu=n(rs," special method."),rs.forEach(o),fu=c(Ae),v(qt.$$.fragment,Ae),gu=c(Ae),dr=r(Ae,"P",{});var R_=i(dr);_u=n(R_,"Example:"),R_.forEach(o),vu=c(Ae),v(ga.$$.fragment,Ae),Ae.forEach(o),$e.forEach(o),_i=c(t),ot=r(t,"H2",{class:!0});var sd=i(ot);jt=r(sd,"A",{id:!0,class:!0,href:!0});var Q_=i(jt);lr=r(Q_,"SPAN",{});var G_=i(lr);v(_a.$$.fragment,G_),G_.forEach(o),Q_.forEach(o),bu=c(sd),cr=r(sd,"SPAN",{});var X_=i(cr);ku=n(X_,"Data2VecTextForMaskedLM"),X_.forEach(o),sd.forEach(o),vi=c(t),J=r(t,"DIV",{class:!0});var Fe=i(J);v(va.$$.fragment,Fe),Tu=c(Fe),at=r(Fe,"P",{});var is=i(at);wu=n(is,"data2vec Model with a "),pr=r(is,"CODE",{});var J_=i(pr);yu=n(J_,"language modeling"),J_.forEach(o),xu=n(is,` head on top.
Data2VecText was proposed in `),ba=r(is,"A",{href:!0,rel:!0});var U_=i(ba);Du=n(U_,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),U_.forEach(o),Vu=n(is,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),is.forEach(o),$u=c(Fe),ka=r(Fe,"P",{});var rd=i(ka);Au=n(rd,"This model inherits from "),Ln=r(rd,"A",{href:!0});var K_=i(Ln);Fu=n(K_,"PreTrainedModel"),K_.forEach(o),Cu=n(rd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
and a softmax) e.g. for RocStories/SWAG tasks.`),g2.forEach(o),Vm=c(ue),Sa=r(ue,"P",{});var ud=i(Sa);$m=n(ud,"Data2VecText was proposed in "),La=r(ud,"A",{href:!0,rel:!0});var _2=i(La);Am=n(_2,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),_2.forEach(o),Fm=n(ud,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),ud.forEach(o),Cm=c(ue),Na=r(ue,"P",{});var md=i(Na);Mm=n(md,"This model inherits from "),On=r(md,"A",{href:!0});var v2=i(On);qm=n(v2,"PreTrainedModel"),v2.forEach(o),jm=n(md,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fd.forEach(o),Lm=c(ue),oe=r(ue,"DIV",{class:!0});var Me=i(oe);v(Oa.$$.fragment,Me),Nm=c(Me),dt=r(Me,"P",{});var cs=i(dt);Wm=n(cs,"The "),Bn=r(cs,"A",{href:!0});var k2=i(Bn);Im=n(k2,"Data2VecTextForMultipleChoice"),k2.forEach(o),Om=n(cs," forward method, overrides the "),yr=r(cs,"CODE",{});var T2=i(yr);Bm=n(T2,"__call__"),T2.forEach(o),Hm=n(cs," special method."),cs.forEach(o),Rm=c(Me),v(Lt.$$.fragment,Me),Qm=c(Me),xr=r(Me,"P",{});var w2=i(xr);Gm=n(w2,"Example:"),w2.forEach(o),Xm=c(Me),v(Ba.$$.fragment,Me),Me.forEach(o),ue.forEach(o),yi=c(t),lt=r(t,"H2",{class:!0});var gd=i(lt);Nt=r(gd,"A",{id:!0,class:!0,href:!0});var y2=i(Nt);Dr=r(y2,"SPAN",{});var x2=i(Dr);v(Ha.$$.fragment,x2),x2.forEach(o),y2.forEach(o),Jm=c(gd),Vr=r(gd,"SPAN",{});var D2=i(Vr);Um=n(D2,"Data2VecTextForTokenClassification"),D2.forEach(o),gd.forEach(o),xi=c(t),S=r(t,"DIV",{class:!0});var me=i(S);v(Ra.$$.fragment,me),Km=c(me),$r=r(me,"P",{});var V2=i($r);Ym=n(V2,`Data2VecText Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),V2.forEach(o),Zm=c(me),Qa=r(me,"P",{});var _d=i(Qa);ef=n(_d,"Data2VecText was proposed in "),Ga=r(_d,"A",{href:!0,rel:!0});var $2=i(Ga);tf=n($2,`data2vec: A General Framework for Self-supervised Learning in Speech,
Vision and Language`),$2.forEach(o),of=n(_d,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),_d.forEach(o),af=c(me),Xa=r(me,"P",{});var vd=i(Xa);nf=n(vd,"This model inherits from "),Hn=r(vd,"A",{href:!0});var A2=i(Hn);sf=n(A2,"PreTrainedModel"),A2.forEach(o),rf=n(vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vd.forEach(o),df=c(me),Ja=r(me,"P",{});var bd=i(Ja);lf=n(bd,"This model is also a PyTorch "),Ua=r(bd,"A",{href:!0,rel:!0});var F2=i(Ua);cf=n(F2,"torch.nn.Module"),F2.forEach(o),pf=n(bd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bd.forEach(o),hf=c(me),ae=r(me,"DIV",{class:!0});var qe=i(ae);v(Ka.$$.fragment,qe),uf=c(qe),ct=r(qe,"P",{});var ps=i(ct);mf=n(ps,"The "),Rn=r(ps,"A",{href:!0});var C2=i(Rn);ff=n(C2,"Data2VecTextForTokenClassification"),C2.forEach(o),gf=n(ps," forward method, overrides the "),Ar=r(ps,"CODE",{});var M2=i(Ar);_f=n(M2,"__call__"),M2.forEach(o),vf=n(ps," special method."),ps.forEach(o),bf=c(qe),v(Wt.$$.fragment,qe),kf=c(qe),Fr=r(qe,"P",{});var q2=i(Fr);Tf=n(q2,"Example:"),q2.forEach(o),wf=c(qe),v(Ya.$$.fragment,qe),qe.forEach(o),me.forEach(o),Di=c(t),pt=r(t,"H2",{class:!0});var kd=i(pt);It=r(kd,"A",{id:!0,class:!0,href:!0});var j2=i(It);Cr=r(j2,"SPAN",{});var z2=i(Cr);v(Za.$$.fragment,z2),z2.forEach(o),j2.forEach(o),yf=c(kd),Mr=r(kd,"SPAN",{});var E2=i(Mr);xf=n(E2,"Data2VecTextForQuestionAnswering"),E2.forEach(o),kd.forEach(o),Vi=c(t),L=r(t,"DIV",{class:!0});var fe=i(L);v(en.$$.fragment,fe),Df=c(fe),ht=r(fe,"P",{});var hs=i(ht);Vf=n(hs,`Data2VecText Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
Vision and Language`),L2.forEach(o),zf=n(Td,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu,
Jiatao Gu and Michael Auli.`),Td.forEach(o),Ef=c(fe),an=r(fe,"P",{});var wd=i(an);Pf=n(wd,"This model inherits from "),Qn=r(wd,"A",{href:!0});var N2=i(Qn);Sf=n(N2,"PreTrainedModel"),N2.forEach(o),Lf=n(wd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
