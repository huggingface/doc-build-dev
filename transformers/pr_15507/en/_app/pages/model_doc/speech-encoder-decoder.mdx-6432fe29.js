import{S as ur,i as gr,s as _r,e as a,k as i,w as T,t as n,L as vr,c as s,d as o,m as l,a as d,x as k,h as r,b as c,J as e,g as _,y as D,q as $,o as M,B as q}from"../../chunks/vendor-9e2b328e.js";import{T as br}from"../../chunks/Tip-76f97a76.js";import{D as Ve}from"../../chunks/Docstring-50fd6873.js";import{C as kn}from"../../chunks/CodeBlock-88e23343.js";import{I as Dn}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function wr(Be){let f,x,g,v,N;return{c(){f=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),v=n("Module"),N=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){f=s(S,"P",{});var P=d(f);x=r(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(P,"CODE",{});var J=d(g);v=r(J,"Module"),J.forEach(o),N=r(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(o)},m(S,P){_(S,f,P),e(f,x),e(f,g),e(g,v),e(f,N)},d(S){S&&o(f)}}}function yr(Be){let f,x,g,v,N,S,P,J,Mo,po,b,qo,ye,xo,Po,Oe,jo,Co,Ee,zo,Ao,Se,Fo,Lo,ho,j,No,Re,Wo,Io,X,Vo,Bo,mo,C,Oo,Te,Ro,Ho,ke,Jo,Uo,fo,W,U,He,ee,Go,Je,Yo,uo,u,oe,Zo,G,De,Ko,Qo,$e,Xo,et,ot,I,tt,Me,nt,rt,qe,at,st,dt,Ue,ct,it,te,lt,Y,ne,pt,re,ht,xe,mt,ft,ut,Z,ae,gt,V,_t,Ge,vt,bt,Ye,wt,yt,go,B,K,Ze,se,Et,Ke,St,_o,p,de,Tt,O,kt,Qe,Dt,$t,Xe,Mt,qt,xt,ce,Pt,ie,jt,Ct,zt,le,At,pe,Ft,Lt,Nt,eo,Wt,It,he,Vt,Pe,Bt,Ot,Rt,me,Ht,fe,Jt,Ut,Gt,z,je,Yt,Zt,oo,Kt,Qt,to,Xt,en,on,w,ue,tn,R,nn,Ce,rn,an,no,sn,dn,cn,Q,ln,ro,pn,hn,ge,mn,y,_e,fn,ao,un,gn,H,_n,so,vn,bn,co,wn,yn,En,io,Sn,Tn,ve,vo;return S=new Dn({}),ee=new Dn({}),oe=new Ve({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_15507/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_15507/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<a href="/docs/transformers/pr_15507/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),{c(){f=a("meta"),x=i(),g=a("h1"),v=a("a"),N=a("span"),T(S.$$.fragment),P=i(),J=a("span"),Mo=n("Speech Encoder Decoder Models"),po=i(),b=a("p"),qo=n("The "),ye=a("a"),xo=n("SpeechEncoderDecoderModel"),Po=n(` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),Oe=a("em"),jo=n("e.g."),Co=i(),Ee=a("a"),zo=n("Wav2Vec2"),Ao=n(", "),Se=a("a"),Fo=n("Hubert"),Lo=n(") and any pretrained autoregressive model as the decoder."),ho=i(),j=a("p"),No=n(`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
documentation from `),qe=a("a"),at=n("PretrainedConfig"),st=n(" for more information."),dt=i(),Ue=a("p"),ct=n("Examples:"),it=i(),T(te.$$.fragment),lt=i(),Y=a("div"),T(ne.$$.fragment),pt=i(),re=a("p"),ht=n("Instantiate a "),xe=a("a"),mt=n("SpeechEncoderDecoderConfig"),ft=n(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),ut=i(),Z=a("div"),T(ae.$$.fragment),gt=i(),V=a("p"),_t=n("Serializes this instance to a Python dictionary. Override the default "),Ge=a("em"),vt=n("to_dict()"),bt=n(" from "),Ye=a("em"),wt=n("PretrainedConfig"),yt=n("."),go=i(),B=a("h2"),K=a("a"),Ze=a("span"),T(se.$$.fragment),Et=i(),Ke=a("span"),St=n("SpeechEncoderDecoderModel"),_o=i(),p=a("div"),T(de.$$.fragment),Tt=i(),O=a("p"),kt=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),Qe=a("code"),Dt=n("from_pretrained()"),$t=n(`function and the decoder is loaded via
`),Xe=a("code"),Mt=n("from_pretrained()"),qt=n(`function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),xt=i(),ce=a("p"),Pt=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),zt=i(),le=a("p"),At=n("Additionally, in "),pe=a("a"),Ft=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
models (see the examples for more information).`),It=i(),he=a("p"),Vt=n("This model inherits from "),Pe=a("a"),Bt=n("PreTrainedModel"),Ot=n(`. Check the superclass documentation for the generic methods the
...
:meth`),to=a("em"),Xt=n("~transformers.AutoModelForCausalLM.from_pretrained"),en=n(" class method for the decoder."),on=i(),w=a("div"),T(ue.$$.fragment),tn=i(),R=a("p"),nn=n("The "),Ce=a("a"),rn=n("SpeechEncoderDecoderModel"),an=n(" forward method, overrides the "),no=a("code"),sn=n("__call__"),dn=n(" special method."),cn=i(),T(Q.$$.fragment),ln=i(),ro=a("p"),pn=n("Examples:"),hn=i(),T(ge.$$.fragment),mn=i(),y=a("div"),T(_e.$$.fragment),fn=i(),ao=a("p"),un=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),co=a("code"),wn=n("model.train()"),yn=n("."),En=i(),io=a("p"),Sn=n("Example:"),Tn=i(),T(ve.$$.fragment),this.h()},l(t){const h=vr('[data-svelte="svelte-1phssyn"]',document.head);f=s(h,"META",{name:!0,content:!0}),h.forEach(o),x=l(t),g=s(t,"H1",{class:!0});var be=d(g);v=s(be,"A",{id:!0,class:!0,href:!0});var $n=d(v);N=s($n,"SPAN",{});var Mn=d(N);k(S.$$.fragment,Mn),Mn.forEach(o),$n.forEach(o),P=l(be),J=s(be,"SPAN",{});var qn=d(J);Mo=r(qn,"Speech Encoder Decoder Models"),qn.forEach(o),be.forEach(o),po=l(t),b=s(t,"P",{});var A=d(b);qo=r(A,"The "),ye=s(A,"A",{href:!0});var xn=d(ye);xo=r(xn,"SpeechEncoderDecoderModel"),xn.forEach(o),Po=r(A,` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),Oe=s(A,"EM",{});var Pn=d(Oe);jo=r(Pn,"e.g."),Pn.forEach(o),Co=l(A),Ee=s(A,"A",{href:!0});var jn=d(Ee);zo=r(jn,"Wav2Vec2"),jn.forEach(o),Ao=r(A,", "),Se=s(A,"A",{href:!0});var Cn=d(Se);Fo=r(Cn,"Hubert"),Cn.forEach(o),Lo=r(A,") and any pretrained autoregressive model as the decoder."),A.forEach(o),ho=l(t),j=s(t,"P",{});var ze=d(j);No=r(ze,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
documentation from `),qe=s(Fe,"A",{href:!0});var Rn=d(qe);at=r(Rn,"PretrainedConfig"),Rn.forEach(o),st=r(Fe," for more information."),Fe.forEach(o),dt=l(E),Ue=s(E,"P",{});var Hn=d(Ue);ct=r(Hn,"Examples:"),Hn.forEach(o),it=l(E),k(te.$$.fragment,E),lt=l(E),Y=s(E,"DIV",{class:!0});var wo=d(Y);k(ne.$$.fragment,wo),pt=l(wo),re=s(wo,"P",{});var yo=d(re);ht=r(yo,"Instantiate a "),xe=s(yo,"A",{href:!0});var Jn=d(xe);mt=r(Jn,"SpeechEncoderDecoderConfig"),Jn.forEach(o),ft=r(yo,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),yo.forEach(o),wo.forEach(o),ut=l(E),Z=s(E,"DIV",{class:!0});var Eo=d(Z);k(ae.$$.fragment,Eo),gt=l(Eo),V=s(Eo,"P",{});var Le=d(V);_t=r(Le,"Serializes this instance to a Python dictionary. Override the default "),Ge=s(Le,"EM",{});var Un=d(Ge);vt=r(Un,"to_dict()"),Un.forEach(o),bt=r(Le," from "),Ye=s(Le,"EM",{});var Gn=d(Ye);wt=r(Gn,"PretrainedConfig"),Gn.forEach(o),yt=r(Le,"."),Le.forEach(o),Eo.forEach(o),E.forEach(o),go=l(t),B=s(t,"H2",{class:!0});var So=d(B);K=s(So,"A",{id:!0,class:!0,href:!0});var Yn=d(K);Ze=s(Yn,"SPAN",{});var Zn=d(Ze);k(se.$$.fragment,Zn),Zn.forEach(o),Yn.forEach(o),Et=l(So),Ke=s(So,"SPAN",{});var Kn=d(Ke);St=r(Kn,"SpeechEncoderDecoderModel"),Kn.forEach(o),So.forEach(o),_o=l(t),p=s(t,"DIV",{class:!0});var m=d(p);k(de.$$.fragment,m),Tt=l(m),O=s(m,"P",{});var Ne=d(O);kt=r(Ne,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),Qe=s(Ne,"CODE",{});var Qn=d(Qe);Dt=r(Qn,"from_pretrained()"),Qn.forEach(o),$t=r(Ne,`function and the decoder is loaded via
`),Xe=s(Ne,"CODE",{});var Xn=d(Xe);Mt=r(Xn,"from_pretrained()"),Xn.forEach(o),qt=r(Ne,`function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),Ne.forEach(o),xt=l(m),ce=s(m,"P",{});var To=d(ce);Pt=r(To,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),To.forEach(o),zt=l(m),le=s(m,"P",{});var ko=d(le);At=r(ko,"Additionally, in "),pe=s(ko,"A",{href:!0,rel:!0});var or=d(pe);Ft=r(or,`Large-Scale Self- and Semi-Supervised Learning for Speech
...
models (see the examples for more information).`),tr.forEach(o),It=l(m),he=s(m,"P",{});var Do=d(he);Vt=r(Do,"This model inherits from "),Pe=s(Do,"A",{href:!0});var nr=d(Pe);Bt=r(nr,"PreTrainedModel"),nr.forEach(o),Ot=r(Do,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
