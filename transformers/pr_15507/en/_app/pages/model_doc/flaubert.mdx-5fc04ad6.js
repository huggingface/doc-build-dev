import{S as xb,i as zb,s as qb,e as a,k as l,w as y,t as o,L as Cb,c as r,d as t,m as d,a as i,x as F,h as n,b as h,J as e,g as u,y as M,q as $,o as L,B as E}from"../../chunks/vendor-9e2b328e.js";import{T as Ee}from"../../chunks/Tip-76f97a76.js";import{D as ie}from"../../chunks/Docstring-50fd6873.js";import{C as nt}from"../../chunks/CodeBlock-88e23343.js";import{I as Oe}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Pb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
...
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Db(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
...
first positional argument :`),J=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,G),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,J,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Wb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Ob(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,G),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,J,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Hb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Qb(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,G),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,J,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Bb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Rb(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,G),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,J,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Ub(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Vb(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,G),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,J,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Yb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Jb(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,G),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,J,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Kb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Gb(O){let p,k,m,g,v,b,f,w,le,Y,x,G,H,Z,de,Q,ce,se,U,X,ee,J,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne,c,T,V,we,Te,P,ke,ye,_e,A,D,Fe,Me,W,$e,Le,be,ve,Gl,Bs,Zl,ed,Rs,td,od,xi,Ct,co,Ba,Ro,nd,Ra,sd,zi,st,Uo,ad,Ua,rd,id,_t,Va,ld,dd,Ya,cd,pd,bt,hd,Ja,ud,md,Ka,fd,gd,Ga,_d,bd,vd,Vo,kd,Za,Td,wd,yd,Yo,Fd,Us,Md,$d,qi,Pt,po,er,Jo,Ld,tr,Ed,Ci,He,Ko,xd,or,zd,qd,Go,Cd,Vs,Pd,jd,Xd,Zo,Ad,en,Sd,Nd,Id,Qe,tn,Dd,jt,Wd,Ys,Od,Hd,nr,Qd,Bd,Rd,ho,Ud,sr,Vd,Yd,on,Pi,Xt,uo,ar,nn,Jd,rr,Kd,ji,ze,sn,Gd,ir,Zd,ec,an,tc,Js,oc,nc,sc,rn,ac,ln,rc,ic,lc,dn,dc,Ks,cc,pc,hc,Be,cn,uc,At,mc,Gs,fc,gc,lr,_c,bc,vc,mo,kc,dr,Tc,wc,pn,Xi,St,fo,cr,hn,yc,pr,Fc,Ai,qe,un,Mc,hr,$c,Lc,mn,Ec,Zs,xc,zc,qc,fn,Cc,gn,Pc,jc,Xc,_n,Ac,ea,Sc,Nc,Ic,xe,bn,Dc,Nt,Wc,ta,Oc,Hc,ur,Qc,Bc,Rc,go,Uc,mr,Vc,Yc,vn,Jc,fr,Kc,Gc,kn,Si,It,_o,gr,Tn,Zc,_r,ep,Ni,Ce,wn,tp,br,op,np,yn,sp,oa,ap,rp,ip,Fn,lp,Mn,dp,cp,pp,$n,hp,na,up,mp,fp,Re,Ln,gp,Dt,_p,sa,bp,vp,vr,kp,Tp,wp,bo,yp,kr,Fp,Mp,En,Ii,Wt,vo,Tr,xn,$p,wr,Lp,Di,Pe,zn,Ep,yr,xp,zp,qn,qp,aa,Cp,Pp,jp,Cn,Xp,Pn,Ap,Sp,Np,jn,Ip,ra,Dp,Wp,Op,Ue,Xn,Hp,Ot,Qp,ia,Bp,Rp,Fr,Up,Vp,Yp,ko,Jp,Mr,Kp,Gp,An,Wi,Ht,To,$r,Sn,Zp,Lr,eh,Oi,je,Nn,th,Qt,oh,Er,nh,sh,xr,ah,rh,ih,In,lh,la,dh,ch,ph,Dn,hh,Wn,uh,mh,fh,On,gh,da,_h,bh,vh,Ve,Hn,kh,Bt,Th,ca,wh,yh,zr,Fh,Mh,$h,wo,Lh,qr,Eh,xh,Qn,Hi,Rt,yo,Cr,Bn,zh,Pr,qh,Qi,Xe,Rn,Ch,Ut,Ph,jr,jh,Xh,Xr,Ah,Sh,Nh,Un,Ih,pa,Dh,Wh,Oh,Vn,Hh,Yn,Qh,Bh,Rh,Jn,Uh,ha,Vh,Yh,Jh,Ye,Kn,Kh,Vt,Gh,ua,Zh,eu,Ar,tu,ou,nu,Fo,su,Sr,au,ru,Gn,Bi,Yt,Mo,Nr,Zn,iu,Ir,lu,Ri,Ae,es,du,Dr,cu,pu,ts,hu,ma,uu,mu,fu,os,gu,ns,_u,bu,vu,$o,ku,Je,ss,Tu,Jt,wu,fa,yu,Fu,Wr,Mu,$u,Lu,Lo,Eu,Or,xu,zu,as,Ui,Kt,Eo,Hr,rs,qu,Qr,Cu,Vi,Se,is,Pu,Br,ju,Xu,ls,Au,ga,Su,Nu,Iu,ds,Du,cs,Wu,Ou,Hu,xo,Qu,Ke,ps,Bu,Gt,Ru,_a,Uu,Vu,Rr,Yu,Ju,Ku,zo,Gu,Ur,Zu,em,hs,Yi,Zt,qo,Vr,us,tm,Yr,om,Ji,Ne,ms,nm,Jr,sm,am,fs,rm,ba,im,lm,dm,gs,cm,_s,pm,hm,um,Co,mm,Ge,bs,fm,eo,gm,va,_m,bm,Kr,vm,km,Tm,Po,wm,Gr,ym,Fm,vs,Ki,to,jo,Zr,ks,Mm,ei,$m,Gi,Ie,Ts,Lm,ti,Em,xm,ws,zm,ka,qm,Cm,Pm,ys,jm,Fs,Xm,Am,Sm,Xo,Nm,Ze,Ms,Im,oo,Dm,Ta,Wm,Om,oi,Hm,Qm,Bm,Ao,Rm,ni,Um,Vm,$s,Zi,no,So,si,Ls,Ym,ai,Jm,el,De,Es,Km,ri,Gm,Zm,xs,ef,wa,tf,of,nf,zs,sf,qs,af,rf,lf,No,df,et,Cs,cf,so,pf,ya,hf,uf,ii,mf,ff,gf,Io,_f,li,bf,vf,Ps,tl,ao,Do,di,js,kf,ci,Tf,ol,We,Xs,wf,ro,yf,pi,Ff,Mf,hi,$f,Lf,Ef,As,xf,Fa,zf,qf,Cf,Ss,Pf,Ns,jf,Xf,Af,Wo,Sf,tt,Is,Nf,io,If,Ma,Df,Wf,ui,Of,Hf,Qf,Oo,Bf,mi,Rf,Uf,Ds,nl;return b=new Oe({}),Z=new Oe({}),c=new Oe({}),ke=new ie({props:{name:"class transformers.FlaubertConfig",anchor:"transformers.FlaubertConfig",parameters:[{name:"layerdrop",val:" = 0.0"},{name:"pre_norm",val:" = False"},{name:"pad_token_id",val:" = 2"},{name:"bos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/configuration_flaubert.py#L31",parametersDescription:[{anchor:"transformers.FlaubertConfig.pre_norm",description:`<strong>pre_norm</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
The ID of the language used by the model. This parameter is used when generating text in a given language.`,name:"lang_id"}]}}),Ro=new Oe({}),Uo=new ie({props:{name:"class transformers.FlaubertTokenizer",anchor:"transformers.FlaubertTokenizer",parameters:[{name:"do_lowercase",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/tokenization_flaubert.py#L79"}}),Jo=new Oe({}),Ko=new ie({props:{name:"class transformers.FlaubertModel",anchor:"transformers.FlaubertModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_flaubert.py#L134",parametersDescription:[{anchor:"transformers.FlaubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),tn=new ie({props:{name:"forward",anchor:"transformers.FlaubertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_flaubert.py#L147",parametersDescription:[{anchor:"transformers.FlaubertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertTokenizer">FlaubertTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig"
...
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
>transformers.modeling_outputs.MaskedLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15507/en/model_doc/xlm#transformers.XLMConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),hn=new Oe({}),un=new ie({props:{name:"class transformers.FlaubertForSequenceClassification",anchor:"transformers.FlaubertForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_flaubert.py#L348",parametersDescription:[{anchor:"transformers.FlaubertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bn=new ie({props:{name:"forward",anchor:"transformers.XLMForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_xlm.py#L789",parametersDescription:[{anchor:"transformers.XLMForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),xn=new Oe({}),zn=new ie({props:{name:"class transformers.FlaubertForTokenClassification",anchor:"transformers.FlaubertForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_flaubert.py#L370",parametersDescription:[{anchor:"transformers.FlaubertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new ie({props:{name:"forward",anchor:"transformers.XLMForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_xlm.py#L1118",parametersDescription:[{anchor:"transformers.XLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Sn=new Oe({}),Nn=new ie({props:{name:"class transformers.FlaubertForQuestionAnsweringSimple",anchor:"transformers.FlaubertForQuestionAnsweringSimple",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_flaubert.py#L392",parametersDescription:[{anchor:"transformers.FlaubertForQuestionAnsweringSimple.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hn=new ie({props:{name:"forward",anchor:"transformers.XLMForQuestionAnsweringSimple.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_xlm.py#L890",parametersDescription:[{anchor:"transformers.XLMForQuestionAnsweringSimple.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),Bn=new Oe({}),Rn=new ie({props:{name:"class transformers.FlaubertForQuestionAnswering",anchor:"transformers.FlaubertForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_flaubert.py#L414",parametersDescription:[{anchor:"transformers.FlaubertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new ie({props:{name:"forward",anchor:"transformers.XLMForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"is_impossible",val:" = None"},{name:"cls_index",val:" = None"},{name:"p_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_xlm.py#L995",parametersDescription:[{anchor:"transformers.XLMForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15507/en/model_doc/xlm#transformers.models.xlm.modeling_xlm.XLMForQuestionAnsweringOutput"
...
`}}),Fo=new Ee({props:{$$slots:{default:[Ib]},$$scope:{ctx:O}}}),Gn=new nt({props:{code:`from transformers import XLMTokenizer, XLMForQuestionAnswering
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),Zn=new Oe({}),es=new ie({props:{name:"class transformers.TFFlaubertModel",anchor:"transformers.TFFlaubertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_tf_flaubert.py#L232",parametersDescription:[{anchor:"transformers.TFFlaubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new Ee({props:{$$slots:{default:[Db]},$$scope:{ctx:O}}}),ss=new ie({props:{name:"call",anchor:"transformers.TFFlaubertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_tf_flaubert.py#L237",parametersDescription:[{anchor:"transformers.TFFlaubertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertTokenizer">FlaubertTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),us=new Oe({}),ms=new ie({props:{name:"class transformers.TFFlaubertForSequenceClassification",anchor:"transformers.TFFlaubertForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_tf_flaubert.py#L902",parametersDescription:[{anchor:"transformers.TFFlaubertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Co=new Ee({props:{$$slots:{default:[Qb]},$$scope:{ctx:O}}}),bs=new ie({props:{name:"call",anchor:"transformers.TFXLMForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_tf_xlm.py#L947",parametersDescription:[{anchor:"transformers.TFXLMForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ls=new Oe({}),Es=new ie({props:{name:"class transformers.TFFlaubertForTokenClassification",anchor:"transformers.TFFlaubertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_tf_flaubert.py#L932",parametersDescription:[{anchor:"transformers.TFFlaubertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new Ee({props:{$$slots:{default:[Vb]},$$scope:{ctx:O}}}),Cs=new ie({props:{name:"call",anchor:"transformers.TFXLMForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_tf_xlm.py#L1223",parametersDescription:[{anchor:"transformers.TFXLMForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),js=new Oe({}),Xs=new ie({props:{name:"class transformers.TFFlaubertForQuestionAnsweringSimple",anchor:"transformers.TFFlaubertForQuestionAnsweringSimple",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/flaubert/modeling_tf_flaubert.py#L917",parametersDescription:[{anchor:"transformers.TFFlaubertForQuestionAnsweringSimple.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15507/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15507/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wo=new Ee({props:{$$slots:{default:[Jb]},$$scope:{ctx:O}}}),Is=new ie({props:{name:"call",anchor:"transformers.TFXLMForQuestionAnsweringSimple.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15507/src/transformers/models/xlm/modeling_tf_xlm.py#L1327",parametersDescription:[{anchor:"transformers.TFXLMForQuestionAnsweringSimple.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15507/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15507/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15507/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
`}}),Oo=new Ee({props:{$$slots:{default:[Kb]},$$scope:{ctx:O}}}),Ds=new nt({props:{code:`from transformers import XLMTokenizer, TFXLMForQuestionAnsweringSimple
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&quot; &quot;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] + <span class="hljs-number">1</span>])`}}),{c(){p=a("meta"),k=l(),m=a("h1"),g=a("a"),v=a("span"),y(b.$$.fragment),f=l(),w=a("span"),le=o("FlauBERT"),Y=l(),x=a("h2"),G=a("a"),H=a("span"),y(Z.$$.fragment),de=l(),Q=a("span"),ce=o("Overview"),se=l(),U=a("p"),X=o("The FlauBERT model was proposed in the paper "),ee=a("a"),J=o("FlauBERT: Unsupervised Language Model Pre-training for French"),z=o(` by Hang Le et al. It\u2019s a transformer model pretrained using a masked language
...
community for further reproducible experiments in French NLP.`),re=l(),q=a("p"),he=o("This model was contributed by "),N=a("a"),ue=o("formiel"),me=o(". The original code can be found "),I=a("a"),fe=o("here"),ge=o("."),j=l(),K=a("h2"),S=a("a"),ne=a("span"),y(c.$$.fragment),T=l(),V=a("span"),we=o("FlaubertConfig"),Te=l(),P=a("div"),y(ke.$$.fragment),ye=l(),_e=a("p"),A=o("This is the configuration class to store the configuration of a "),D=a("a"),Fe=o("FlaubertModel"),Me=o(" or a "),W=a("a"),$e=o("TFFlaubertModel"),Le=o(`. It is
used to instantiate a FlauBERT model according to the specified arguments, defining the model architecture.`),be=l(),ve=a("p"),Gl=o("Configuration objects inherit from "),Bs=a("a"),Zl=o("PretrainedConfig"),ed=o(` and can be used to control the model outputs. Read the
documentation from `),Rs=a("a"),td=o("PretrainedConfig"),od=o(" for more information."),xi=l(),Ct=a("h2"),co=a("a"),Ba=a("span"),y(Ro.$$.fragment),nd=l(),Ra=a("span"),sd=o("FlaubertTokenizer"),zi=l(),st=a("div"),y(Uo.$$.fragment),ad=l(),Ua=a("p"),rd=o("Construct a Flaubert tokenizer. Based on Byte-Pair Encoding. The tokenization process is the following:"),id=l(),_t=a("ul"),Va=a("li"),ld=o("Moses preprocessing and tokenization."),dd=l(),Ya=a("li"),cd=o("Normalizing all inputs text."),pd=l(),bt=a("li"),hd=o("The arguments "),Ja=a("code"),ud=o("special_tokens"),md=o(" and the function "),Ka=a("code"),fd=o("set_special_tokens"),gd=o(`, can be used to add additional symbols (like
\u201D`),Ga=a("strong"),_d=o("classify"),bd=o("\u201D) to a vocabulary."),vd=l(),Vo=a("li"),kd=o("The argument "),Za=a("code"),Td=o("do_lowercase"),wd=o(" controls lower casing (automatically set for pretrained vocabularies)."),yd=l(),Yo=a("p"),Fd=o("This tokenizer inherits from "),Us=a("a"),Md=o("XLMTokenizer"),$d=o(`. Please check the superclass for usage examples and documentation
regarding arguments.`),qi=l(),Pt=a("h2"),po=a("a"),er=a("span"),y(Jo.$$.fragment),Ld=l(),tr=a("span"),Ed=o("FlaubertModel"),Ci=l(),He=a("div"),y(Ko.$$.fragment),xd=l(),or=a("p"),zd=o("The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),qd=l(),Go=a("p"),Cd=o("This model inherits from "),Vs=a("a"),Pd=o("PreTrainedModel"),jd=o(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Id=l(),Qe=a("div"),y(tn.$$.fragment),Dd=l(),jt=a("p"),Wd=o("The "),Ys=a("a"),Od=o("FlaubertModel"),Hd=o(" forward method, overrides the "),nr=a("code"),Qd=o("__call__"),Bd=o(" special method."),Rd=l(),y(ho.$$.fragment),Ud=l(),sr=a("p"),Vd=o("Example:"),Yd=l(),y(on.$$.fragment),Pi=l(),Xt=a("h2"),uo=a("a"),ar=a("span"),y(nn.$$.fragment),Jd=l(),rr=a("span"),Kd=o("FlaubertWithLMHeadModel"),ji=l(),ze=a("div"),y(sn.$$.fragment),Gd=l(),ir=a("p"),Zd=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),ec=l(),an=a("p"),tc=o("This model inherits from "),Js=a("a"),oc=o("PreTrainedModel"),nc=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sc=l(),rn=a("p"),ac=o("This model is also a PyTorch "),ln=a("a"),rc=o("torch.nn.Module"),ic=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=l(),dn=a("p"),dc=o("This class overrides "),Ks=a("a"),cc=o("XLMWithLMHeadModel"),pc=o(`. Please check the superclass for the appropriate documentation
...
documentation alongside usage examples.`),Ic=l(),xe=a("div"),y(bn.$$.fragment),Dc=l(),Nt=a("p"),Wc=o("The "),ta=a("a"),Oc=o("XLMForSequenceClassification"),Hc=o(" forward method, overrides the "),ur=a("code"),Qc=o("__call__"),Bc=o(" special method."),Rc=l(),y(go.$$.fragment),Uc=l(),mr=a("p"),Vc=o("Example of single-label classification:"),Yc=l(),y(vn.$$.fragment),Jc=l(),fr=a("p"),Kc=o("Example of multi-label classification:"),Gc=l(),y(kn.$$.fragment),Si=l(),It=a("h2"),_o=a("a"),gr=a("span"),y(Tn.$$.fragment),Zc=l(),_r=a("span"),ep=o("FlaubertForMultipleChoice"),Ni=l(),Ce=a("div"),y(wn.$$.fragment),tp=l(),br=a("p"),op=o(`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
alongside usage examples.`),Op=l(),Ue=a("div"),y(Xn.$$.fragment),Hp=l(),Ot=a("p"),Qp=o("The "),ia=a("a"),Bp=o("XLMForTokenClassification"),Rp=o(" forward method, overrides the "),Fr=a("code"),Up=o("__call__"),Vp=o(" special method."),Yp=l(),y(ko.$$.fragment),Jp=l(),Mr=a("p"),Kp=o("Example:"),Gp=l(),y(An.$$.fragment),Wi=l(),Ht=a("h2"),To=a("a"),$r=a("span"),y(Sn.$$.fragment),Zp=l(),Lr=a("span"),eh=o("FlaubertForQuestionAnsweringSimple"),Oi=l(),je=a("div"),y(Nn.$$.fragment),th=l(),Qt=a("p"),oh=o(`Flaubert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rh=l(),Jn=a("p"),Uh=o("This class overrides "),ha=a("a"),Vh=o("XLMForQuestionAnswering"),Yh=o(`. Please check the superclass for the appropriate documentation
...
behavior.`),vu=l(),y($o.$$.fragment),ku=l(),Je=a("div"),y(ss.$$.fragment),Tu=l(),Jt=a("p"),wu=o("The "),fa=a("a"),yu=o("TFFlaubertModel"),Fu=o(" forward method, overrides the "),Wr=a("code"),Mu=o("__call__"),$u=o(" special method."),Lu=l(),y(Lo.$$.fragment),Eu=l(),Or=a("p"),xu=o("Example:"),zu=l(),y(as.$$.fragment),Ui=l(),Kt=a("h2"),Eo=a("a"),Hr=a("span"),y(rs.$$.fragment),qu=l(),Qr=a("span"),Cu=o("TFFlaubertWithLMHeadModel"),Vi=l(),Se=a("div"),y(is.$$.fragment),Pu=l(),Br=a("p"),ju=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hu=l(),y(xo.$$.fragment),Qu=l(),Ke=a("div"),y(ps.$$.fragment),Bu=l(),Gt=a("p"),Ru=o("The "),_a=a("a"),Uu=o("TFFlaubertWithLMHeadModel"),Vu=o(" forward method, overrides the "),Rr=a("code"),Yu=o("__call__"),Ju=o(" special method."),Ku=l(),y(zo.$$.fragment),Gu=l(),Ur=a("p"),Zu=o("Example:"),em=l(),y(hs.$$.fragment),Yi=l(),Zt=a("h2"),qo=a("a"),Vr=a("span"),y(us.$$.fragment),tm=l(),Yr=a("span"),om=o("TFFlaubertForSequenceClassification"),Ji=l(),Ne=a("div"),y(ms.$$.fragment),nm=l(),Jr=a("p"),sm=o(`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),um=l(),y(Co.$$.fragment),mm=l(),Ge=a("div"),y(bs.$$.fragment),fm=l(),eo=a("p"),gm=o("The "),va=a("a"),_m=o("TFXLMForSequenceClassification"),bm=o(" forward method, overrides the "),Kr=a("code"),vm=o("__call__"),km=o(" special method."),Tm=l(),y(Po.$$.fragment),wm=l(),Gr=a("p"),ym=o("Example:"),Fm=l(),y(vs.$$.fragment),Ki=l(),to=a("h2"),jo=a("a"),Zr=a("span"),y(ks.$$.fragment),Mm=l(),ei=a("span"),$m=o("TFFlaubertForMultipleChoice"),Gi=l(),Ie=a("div"),y(Ts.$$.fragment),Lm=l(),ti=a("p"),Em=o(`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sm=l(),y(Xo.$$.fragment),Nm=l(),Ze=a("div"),y(Ms.$$.fragment),Im=l(),oo=a("p"),Dm=o("The "),Ta=a("a"),Wm=o("TFXLMForMultipleChoice"),Om=o(" forward method, overrides the "),oi=a("code"),Hm=o("__call__"),Qm=o(" special method."),Bm=l(),y(Ao.$$.fragment),Rm=l(),ni=a("p"),Um=o("Example:"),Vm=l(),y($s.$$.fragment),Zi=l(),no=a("h2"),So=a("a"),si=a("span"),y(Ls.$$.fragment),Ym=l(),ai=a("span"),Jm=o("TFFlaubertForTokenClassification"),el=l(),De=a("div"),y(Es.$$.fragment),Km=l(),ri=a("p"),Gm=o(`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dl.forEach(t),Id=d(vt),Qe=r(vt,"DIV",{class:!0});var kt=i(Qe);F(tn.$$.fragment,kt),Dd=d(kt),jt=r(kt,"P",{});var xa=i(jt);Wd=n(xa,"The "),Ys=r(xa,"A",{href:!0});var gg=i(Ys);Od=n(gg,"FlaubertModel"),gg.forEach(t),Hd=n(xa," forward method, overrides the "),nr=r(xa,"CODE",{});var _g=i(nr);Qd=n(_g,"__call__"),_g.forEach(t),Bd=n(xa," special method."),xa.forEach(t),Rd=d(kt),F(ho.$$.fragment,kt),Ud=d(kt),sr=r(kt,"P",{});var bg=i(sr);Vd=n(bg,"Example:"),bg.forEach(t),Yd=d(kt),F(on.$$.fragment,kt),kt.forEach(t),vt.forEach(t),Pi=d(s),Xt=r(s,"H2",{class:!0});var cl=i(Xt);uo=r(cl,"A",{id:!0,class:!0,href:!0});var vg=i(uo);ar=r(vg,"SPAN",{});var kg=i(ar);F(nn.$$.fragment,kg),kg.forEach(t),vg.forEach(t),Jd=d(cl),rr=r(cl,"SPAN",{});var Tg=i(rr);Kd=n(Tg,"FlaubertWithLMHeadModel"),Tg.forEach(t),cl.forEach(t),ji=d(s),ze=r(s,"DIV",{class:!0});var at=i(ze);F(sn.$$.fragment,at),Gd=d(at),ir=r(at,"P",{});var wg=i(ir);Zd=n(wg,`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),wg.forEach(t),ec=d(at),an=r(at,"P",{});var pl=i(an);tc=n(pl,"This model inherits from "),Js=r(pl,"A",{href:!0});var yg=i(Js);oc=n(yg,"PreTrainedModel"),yg.forEach(t),nc=n(pl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hl.forEach(t),lc=d(at),dn=r(at,"P",{});var ul=i(dn);dc=n(ul,"This class overrides "),Ks=r(ul,"A",{href:!0});var Mg=i(Ks);cc=n(Mg,"XLMWithLMHeadModel"),Mg.forEach(t),pc=n(ul,`. Please check the superclass for the appropriate documentation
...
alongside usage examples.`),Ml.forEach(t),Op=d(lt),Ue=r(lt,"DIV",{class:!0});var yt=i(Ue);F(Xn.$$.fragment,yt),Hp=d(yt),Ot=r(yt,"P",{});var Pa=i(Ot);Qp=n(Pa,"The "),ia=r(Pa,"A",{href:!0});var n_=i(ia);Bp=n(n_,"XLMForTokenClassification"),n_.forEach(t),Rp=n(Pa," forward method, overrides the "),Fr=r(Pa,"CODE",{});var s_=i(Fr);Up=n(s_,"__call__"),s_.forEach(t),Vp=n(Pa," special method."),Pa.forEach(t),Yp=d(yt),F(ko.$$.fragment,yt),Jp=d(yt),Mr=r(yt,"P",{});var a_=i(Mr);Kp=n(a_,"Example:"),a_.forEach(t),Gp=d(yt),F(An.$$.fragment,yt),yt.forEach(t),lt.forEach(t),Wi=d(s),Ht=r(s,"H2",{class:!0});var $l=i(Ht);To=r($l,"A",{id:!0,class:!0,href:!0});var r_=i(To);$r=r(r_,"SPAN",{});var i_=i($r);F(Sn.$$.fragment,i_),i_.forEach(t),r_.forEach(t),Zp=d($l),Lr=r($l,"SPAN",{});var l_=i(Lr);eh=n(l_,"FlaubertForQuestionAnsweringSimple"),l_.forEach(t),$l.forEach(t),Oi=d(s),je=r(s,"DIV",{class:!0});var dt=i(je);F(Nn.$$.fragment,dt),th=d(dt),Qt=r(dt,"P",{});var ja=i(Qt);oh=n(ja,`Flaubert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Il.forEach(t),Hu=d(ht),F(xo.$$.fragment,ht),Qu=d(ht),Ke=r(ht,"DIV",{class:!0});var Lt=i(Ke);F(ps.$$.fragment,Lt),Bu=d(Lt),Gt=r(Lt,"P",{});var Ia=i(Gt);Ru=n(Ia,"The "),_a=r(Ia,"A",{href:!0});var H_=i(_a);Uu=n(H_,"TFFlaubertWithLMHeadModel"),H_.forEach(t),Vu=n(Ia," forward method, overrides the "),Rr=r(Ia,"CODE",{});var Q_=i(Rr);Yu=n(Q_,"__call__"),Q_.forEach(t),Ju=n(Ia," special method."),Ia.forEach(t),Ku=d(Lt),F(zo.$$.fragment,Lt),Gu=d(Lt),Ur=r(Lt,"P",{});var B_=i(Ur);Zu=n(B_,"Example:"),B_.forEach(t),em=d(Lt),F(hs.$$.fragment,Lt),Lt.forEach(t),ht.forEach(t),Yi=d(s),Zt=r(s,"H2",{class:!0});var Dl=i(Zt);qo=r(Dl,"A",{id:!0,class:!0,href:!0});var R_=i(qo);Vr=r(R_,"SPAN",{});var U_=i(Vr);F(us.$$.fragment,U_),U_.forEach(t),R_.forEach(t),tm=d(Dl),Yr=r(Dl,"SPAN",{});var V_=i(Yr);om=n(V_,"TFFlaubertForSequenceClassification"),V_.forEach(t),Dl.forEach(t),Ji=d(s),Ne=r(s,"DIV",{class:!0});var ut=i(Ne);F(ms.$$.fragment,ut),nm=d(ut),Jr=r(ut,"P",{});var Y_=i(Jr);sm=n(Y_,`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
e.g. for GLUE tasks.`),Y_.forEach(t),am=d(ut),fs=r(ut,"P",{});var Wl=i(fs);rm=n(Wl,"This model inherits from "),ba=r(Wl,"A",{href:!0});var J_=i(ba);im=n(J_,"TFPreTrainedModel"),J_.forEach(t),lm=n(Wl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wl.forEach(t),dm=d(ut),gs=r(ut,"P",{});var Ol=i(gs);cm=n(Ol,"This model is also a "),_s=r(Ol,"A",{href:!0,rel:!0});var K_=i(_s);pm=n(K_,"tf.keras.Model"),K_.forEach(t),hm=n(Ol,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ol.forEach(t),um=d(ut),F(Co.$$.fragment,ut),mm=d(ut),Ge=r(ut,"DIV",{class:!0});var Et=i(Ge);F(bs.$$.fragment,Et),fm=d(Et),eo=r(Et,"P",{});var Da=i(eo);gm=n(Da,"The "),va=r(Da,"A",{href:!0});var G_=i(va);_m=n(G_,"TFXLMForSequenceClassification"),G_.forEach(t),bm=n(Da," forward method, overrides the "),Kr=r(Da,"CODE",{});var Z_=i(Kr);vm=n(Z_,"__call__"),Z_.forEach(t),km=n(Da," special method."),Da.forEach(t),Tm=d(Et),F(Po.$$.fragment,Et),wm=d(Et),Gr=r(Et,"P",{});var eb=i(Gr);ym=n(eb,"Example:"),eb.forEach(t),Fm=d(Et),F(vs.$$.fragment,Et),Et.forEach(t),ut.forEach(t),Ki=d(s),to=r(s,"H2",{class:!0});var Hl=i(to);jo=r(Hl,"A",{id:!0,class:!0,href:!0});var tb=i(jo);Zr=r(tb,"SPAN",{});var ob=i(Zr);F(ks.$$.fragment,ob),ob.forEach(t),tb.forEach(t),Mm=d(Hl),ei=r(Hl,"SPAN",{});var nb=i(ei);$m=n(nb,"TFFlaubertForMultipleChoice"),nb.forEach(t),Hl.forEach(t),Gi=d(s),Ie=r(s,"DIV",{class:!0});var mt=i(Ie);F(Ts.$$.fragment,mt),Lm=d(mt),ti=r(mt,"P",{});var sb=i(ti);Em=n(sb,`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
