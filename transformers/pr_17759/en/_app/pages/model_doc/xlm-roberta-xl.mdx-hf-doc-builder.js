import{S as Rd,i as zd,s as Fd,e as i,k as g,w as k,t as r,M as Cd,c as l,d as o,m as _,a as d,x as M,h as a,b as m,G as e,g as L,y as w,q as v,o as X,B as $,v as qd,L as A}from"../../chunks/vendor-hf-doc-builder.js";import{T as io}from"../../chunks/Tip-hf-doc-builder.js";import{D as z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as S}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as re}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as P}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ed(T){let s,f,c,p,b;return p=new S({props:{code:`from transformers import XLMRobertaXLModel, XLMRobertaXLConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){w(s,c,p),f=!0},p:A,i(c){f||(v(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function tc(T){let s,f,c,p,b,n,h,y,zs,Yn,ae,Re,Ho,bt,Fs,Uo,Cs,Zn,ze,qs,Lt,Es,js,es,lo,Ps,ts,co,Vo,As,os,po,Ss,ns,ho,kt,Ns,Go,Is,Os,ss,Q,Ds,Mt,Ws,Bs,wt,Qs,Hs,vt,Us,Vs,rs,ie,Fe,Jo,Xt,Gs,Ko,Js,as,N,$t,Ks,G,Ys,mo,Zs,er,Yo,tr,or,Tt,nr,sr,rr,le,ar,uo,ir,lr,fo,dr,cr,pr,Ce,is,de,qe,Zo,yt,hr,en,mr,ls,I,xt,ur,ce,fr,go,gr,_r,Rt,br,Lr,kr,te,Mr,tn,wr,R,vr,on,Xr,$r,nn,Tr,yr,sn,xr,Rr,rn,zr,Fr,an,Cr,qr,ln,Er,jr,dn,Pr,Ar,zt,Sr,Nr,H,Ft,Ir,pe,Or,_o,Dr,Wr,cn,Br,Qr,Hr,Ee,Ur,je,ds,he,Pe,pn,Ct,Vr,hn,Gr,cs,J,qt,Jr,K,Kr,mn,Yr,Zr,bo,ea,ta,Et,oa,na,sa,U,jt,ra,me,aa,Lo,ia,la,un,da,ca,pa,Ae,ha,Se,ps,ue,Ne,fn,Pt,ma,gn,ua,hs,Y,At,fa,Z,ga,_n,_a,ba,ko,La,ka,St,Ma,wa,va,F,Nt,Xa,fe,$a,Mo,Ta,ya,bn,xa,Ra,za,Ie,Fa,Oe,Ca,De,ms,ge,We,Ln,It,qa,kn,Ea,us,O,Ot,ja,Mn,Pa,Aa,_e,Sa,wo,Na,Ia,Dt,Oa,Da,Wa,x,Wt,Ba,be,Qa,vo,Ha,Ua,wn,Va,Ga,Ja,Be,Ka,Qe,Ya,He,Za,Ue,ei,Ve,fs,Le,Ge,vn,Bt,ti,Xn,oi,gs,D,Qt,ni,$n,si,ri,ke,ai,Xo,ii,li,Ht,di,ci,pi,V,Ut,hi,Me,mi,$o,ui,fi,Tn,gi,_i,bi,Je,Li,Ke,_s,we,Ye,yn,Vt,ki,xn,Mi,bs,W,Gt,wi,Rn,vi,Xi,ve,$i,To,Ti,yi,Jt,xi,Ri,zi,C,Kt,Fi,Xe,Ci,yo,qi,Ei,zn,ji,Pi,Ai,Ze,Si,et,Ni,tt,Ls,$e,ot,Fn,Yt,Ii,Cn,Oi,ks,B,Zt,Di,Te,Wi,qn,Bi,Qi,En,Hi,Ui,Vi,ye,Gi,xo,Ji,Ki,eo,Yi,Zi,el,q,to,tl,xe,ol,Ro,nl,sl,jn,rl,al,il,nt,ll,st,dl,rt,Ms;return n=new re({}),bt=new re({}),Xt=new re({}),$t=new z({props:{name:"class transformers.XLMRobertaXLConfig",anchor:"transformers.XLMRobertaXLConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 2560"},{name:"num_hidden_layers",val:" = 36"},{name:"num_attention_heads",val:" = 32"},{name:"intermediate_size",val:" = 10240"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 514"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 250880) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17759/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel">XLMRobertaXLModel</a> or
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L709",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17759/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig"
...
`}}),Ee=new io({props:{$$slots:{default:[jd]},$$scope:{ctx:T}}}),je=new P({props:{anchor:"transformers.XLMRobertaXLModel.forward.example",$$slots:{default:[Pd]},$$scope:{ctx:T}}}),Ct=new re({}),qt=new z({props:{name:"class transformers.XLMRobertaXLForCausalLM",anchor:"transformers.XLMRobertaXLForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17759/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig">XLMRobertaXLConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17759/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L851"}}),jt=new z({props:{name:"forward",anchor:"transformers.XLMRobertaXLForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17759/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L876",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
`}}),Ae=new io({props:{$$slots:{default:[Ad]},$$scope:{ctx:T}}}),Se=new P({props:{anchor:"transformers.XLMRobertaXLForCausalLM.forward.example",$$slots:{default:[Sd]},$$scope:{ctx:T}}}),Pt=new re({}),At=new z({props:{name:"class transformers.XLMRobertaXLForMaskedLM",anchor:"transformers.XLMRobertaXLForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17759/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig">XLMRobertaXLConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17759/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1001"}}),Nt=new z({props:{name:"forward",anchor:"transformers.XLMRobertaXLForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17759/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
`}}),Ie=new io({props:{$$slots:{default:[Nd]},$$scope:{ctx:T}}}),Oe=new P({props:{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.example",$$slots:{default:[Id]},$$scope:{ctx:T}}}),De=new P({props:{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.example-2",$$slots:{default:[Od]},$$scope:{ctx:T}}}),It=new re({}),Ot=new z({props:{name:"class transformers.XLMRobertaXLForSequenceClassification",anchor:"transformers.XLMRobertaXLForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17759/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig">XLMRobertaXLConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17759/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1129"}}),Wt=new z({props:{name:"forward",anchor:"transformers.XLMRobertaXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17759/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1238",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1337",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
`}}),Ze=new io({props:{$$slots:{default:[Gd]},$$scope:{ctx:T}}}),et=new P({props:{anchor:"transformers.XLMRobertaXLForTokenClassification.forward.example",$$slots:{default:[Jd]},$$scope:{ctx:T}}}),tt=new P({props:{anchor:"transformers.XLMRobertaXLForTokenClassification.forward.example-2",$$slots:{default:[Kd]},$$scope:{ctx:T}}}),Yt=new re({}),Zt=new z({props:{name:"class transformers.XLMRobertaXLForQuestionAnswering",anchor:"transformers.XLMRobertaXLForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17759/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig">XLMRobertaXLConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17759/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1435"}}),to=new z({props:{name:"forward",anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17759/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1448",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
both `),sn=i("code"),xr=r("is_decoder"),Rr=r(" argument and "),rn=i("code"),zr=r("add_cross_attention"),Fr=r(" set to "),an=i("code"),Cr=r("True"),qr=r("; an "),ln=i("code"),Er=r("encoder_hidden_states"),jr=r(` is then expected as
an input to the forward pass. .. `),dn=i("em"),Pr=r("Attention is all you need"),Ar=r(": "),zt=i("a"),Sr=r("https://arxiv.org/abs/1706.03762"),Nr=g(),H=i("div"),k(Ft.$$.fragment),Ir=g(),pe=i("p"),Or=r("The "),_o=i("a"),Dr=r("XLMRobertaXLModel"),Wr=r(" forward method, overrides the "),cn=i("code"),Br=r("__call__"),Qr=r(" special method."),Hr=g(),k(Ee.$$.fragment),Ur=g(),k(je.$$.fragment),ds=g(),he=i("h2"),Pe=i("a"),pn=i("span"),k(Ct.$$.fragment),Vr=g(),hn=i("span"),Gr=r("XLMRobertaXLForCausalLM"),cs=g(),J=i("div"),k(qt.$$.fragment),Jr=g(),K=i("p"),Kr=r("XLM-RoBERTa-xlarge Model with a "),mn=i("code"),Yr=r("language modeling"),Zr=r(` head on top for CLM fine-tuning.
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),va=g(),F=i("div"),k(Nt.$$.fragment),Xa=g(),fe=i("p"),$a=r("The "),Mo=i("a"),Ta=r("XLMRobertaXLForMaskedLM"),ya=r(" forward method, overrides the "),bn=i("code"),xa=r("__call__"),Ra=r(" special method."),za=g(),k(Ie.$$.fragment),Fa=g(),k(Oe.$$.fragment),Ca=g(),k(De.$$.fragment),ms=g(),ge=i("h2"),We=i("a"),Ln=i("span"),k(It.$$.fragment),qa=g(),kn=i("span"),Ea=r("XLMRobertaXLForSequenceClassification"),us=g(),O=i("div"),k(Ot.$$.fragment),ja=g(),Mn=i("p"),Pa=r(`XLM-RoBERTa-xlarge Model transformer with a sequence classification/regression head on top (a linear layer on top
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),zi=g(),C=i("div"),k(Kt.$$.fragment),Fi=g(),Xe=i("p"),Ci=r("The "),yo=i("a"),qi=r("XLMRobertaXLForTokenClassification"),Ei=r(" forward method, overrides the "),zn=i("code"),ji=r("__call__"),Pi=r(" special method."),Ai=g(),k(Ze.$$.fragment),Si=g(),k(et.$$.fragment),Ni=g(),k(tt.$$.fragment),Ls=g(),$e=i("h2"),ot=i("a"),Fn=i("span"),k(Yt.$$.fragment),Ii=g(),Cn=i("span"),Oi=r("XLMRobertaXLForQuestionAnswering"),ks=g(),B=i("div"),k(Zt.$$.fragment),Di=g(),Te=i("p"),Wi=r(`XLM-Roberta-xlarge Model with a span classification head on top for extractive question-answering tasks like SQuAD
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),el=g(),q=i("div"),k(to.$$.fragment),tl=g(),xe=i("p"),ol=r("The "),Ro=i("a"),nl=r("XLMRobertaXLForQuestionAnswering"),sl=r(" forward method, overrides the "),jn=i("code"),rl=r("__call__"),al=r(" special method."),il=g(),k(nt.$$.fragment),ll=g(),k(st.$$.fragment),dl=g(),k(rt.$$.fragment),this.h()},l(t){const u=Cd('[data-svelte="svelte-1phssyn"]',document.head);s=l(u,"META",{name:!0,content:!0}),u.forEach(o),f=_(t),c=l(t,"H1",{class:!0});var oo=d(c);p=l(oo,"A",{id:!0,class:!0,href:!0});var Pn=d(p);b=l(Pn,"SPAN",{});var An=d(b);M(n.$$.fragment,An),An.forEach(o),Pn.forEach(o),h=_(oo),y=l(oo,"SPAN",{});var Sn=d(y);zs=a(Sn,"XLM-RoBERTa-XL"),Sn.forEach(o),oo.forEach(o),Yn=_(t),ae=l(t,"H2",{class:!0});var no=d(ae);Re=l(no,"A",{id:!0,class:!0,href:!0});var Nn=d(Re);Ho=l(Nn,"SPAN",{});var In=d(Ho);M(bt.$$.fragment,In),In.forEach(o),Nn.forEach(o),Fs=_(no),Uo=l(no,"SPAN",{});var On=d(Uo);Cs=a(On,"Overview"),On.forEach(o),no.forEach(o),Zn=_(t),ze=l(t,"P",{});var so=d(ze);qs=a(so,"The XLM-RoBERTa-XL model was proposed in "),Lt=l(so,"A",{href:!0,rel:!0});var Dn=d(Lt);Es=a(Dn,"Larger-Scale Transformers for Multilingual Masked Language Modeling"),Dn.forEach(o),js=a(so," by Naman Goyal, Jingfei Du, Myle Ott, Giri Anantharaman, Alexis Conneau."),so.forEach(o),es=_(t),lo=l(t,"P",{});var Wn=d(lo);Ps=a(Wn,"The abstract from the paper is the following:"),Wn.forEach(o),ts=_(t),co=l(t,"P",{});var Bn=d(co);Vo=l(Bn,"EM",{});var Qn=d(Vo);As=a(Qn,"Recent work has demonstrated the effectiveness of cross-lingual language model pretraining for cross-lingual understanding. In this study, we present the results of two larger multilingual masked language models, with 3.5B and 10.7B parameters. Our two new models dubbed XLM-R XL and XLM-R XXL outperform XLM-R by 1.8% and 2.4% average accuracy on XNLI. Our model also outperforms the RoBERTa-Large model on several English tasks of the GLUE benchmark by 0.3% on average while handling 99 more languages. This suggests pretrained models with larger capacity may obtain both strong performance on high-resource languages while greatly improving low-resource languages. We make our code and models publicly available."),Qn.forEach(o),Bn.forEach(o),os=_(t),po=l(t,"P",{});var Hn=d(po);Ss=a(Hn,"Tips:"),Hn.forEach(o),ns=_(t),ho=l(t,"UL",{});var Un=d(ho);kt=l(Un,"LI",{});var ro=d(kt);Ns=a(ro,`XLM-RoBERTa-XL is a multilingual model trained on 100 different languages. Unlike some XLM multilingual models, it does
...
language from the input ids.`),ro.forEach(o),Un.forEach(o),ss=_(t),Q=l(t,"P",{});var ee=d(Q);Ds=a(ee,"This model was contributed by "),Mt=l(ee,"A",{href:!0,rel:!0});var Gn=d(Mt);Ws=a(Gn,"Soonhwan-Kwon"),Gn.forEach(o),Bs=a(ee," and "),wt=l(ee,"A",{href:!0,rel:!0});var Jn=d(wt);Qs=a(Jn,"stefan-it"),Jn.forEach(o),Hs=a(ee,". The original code can be found "),vt=l(ee,"A",{href:!0,rel:!0});var Kn=d(vt);Us=a(Kn,"here"),Kn.forEach(o),Vs=a(ee,"."),ee.forEach(o),rs=_(t),ie=l(t,"H2",{class:!0});var ws=d(ie);Fe=l(ws,"A",{id:!0,class:!0,href:!0});var cl=d(Fe);Jo=l(cl,"SPAN",{});var pl=d(Jo);M(Xt.$$.fragment,pl),pl.forEach(o),cl.forEach(o),Gs=_(ws),Ko=l(ws,"SPAN",{});var hl=d(Ko);Js=a(hl,"XLMRobertaXLConfig"),hl.forEach(o),ws.forEach(o),as=_(t),N=l(t,"DIV",{class:!0});var at=d(N);M($t.$$.fragment,at),Ks=_(at),G=l(at,"P",{});var it=d(G);Ys=a(it,"This is the configuration class to store the configuration of a "),mo=l(it,"A",{href:!0});var ml=d(mo);Zs=a(ml,"XLMRobertaXLModel"),ml.forEach(o),er=a(it," or a "),Yo=l(it,"CODE",{});var ul=d(Yo);tr=a(ul,"TFXLMRobertaXLModel"),ul.forEach(o),or=a(it,`.
It is used to instantiate a XLM_ROBERTA_XL model according to the specified arguments, defining the model
architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the
XLM_ROBERTA_XL `),Tt=l(it,"A",{href:!0,rel:!0});var fl=d(Tt);nr=a(fl,"facebook/xlm-roberta-xl"),fl.forEach(o),sr=a(it," architecture."),it.forEach(o),rr=_(at),le=l(at,"P",{});var zo=d(le);ar=a(zo,"Configuration objects inherit from "),uo=l(zo,"A",{href:!0});var gl=d(uo);ir=a(gl,"PretrainedConfig"),gl.forEach(o),lr=a(zo,` and can be used to control the model outputs. Read the
documentation from `),fo=l(zo,"A",{href:!0});var _l=d(fo);dr=a(_l,"PretrainedConfig"),_l.forEach(o),cr=a(zo," for more information."),zo.forEach(o),pr=_(at),M(Ce.$$.fragment,at),at.forEach(o),is=_(t),de=l(t,"H2",{class:!0});var vs=d(de);qe=l(vs,"A",{id:!0,class:!0,href:!0});var bl=d(qe);Zo=l(bl,"SPAN",{});var Ll=d(Zo);M(yt.$$.fragment,Ll),Ll.forEach(o),bl.forEach(o),hr=_(vs),en=l(vs,"SPAN",{});var kl=d(en);mr=a(kl,"XLMRobertaXLModel"),kl.forEach(o),vs.forEach(o),ls=_(t),I=l(t,"DIV",{class:!0});var lt=d(I);M(xt.$$.fragment,lt),ur=_(lt),ce=l(lt,"P",{});var Fo=d(ce);fr=a(Fo,`The bare XLM-RoBERTa-xlarge Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),go=l(Fo,"A",{href:!0});var Ml=d(go);gr=a(Ml,"PreTrainedModel"),Ml.forEach(o),_r=a(Fo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Rt=l(Fo,"A",{href:!0,rel:!0});var wl=d(Rt);br=a(wl,"torch.nn.Module"),wl.forEach(o),Lr=a(Fo,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Fo.forEach(o),kr=_(lt),te=l(lt,"P",{});var ao=d(te);Mr=a(ao,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Oo.forEach(o),zi=_(gt),C=l(gt,"DIV",{class:!0});var ne=d(C);M(Kt.$$.fragment,ne),Fi=_(ne),Xe=l(ne,"P",{});var Do=d(Xe);Ci=a(Do,"The "),yo=l(Do,"A",{href:!0});var bd=d(yo);qi=a(bd,"XLMRobertaXLForTokenClassification"),bd.forEach(o),Ei=a(Do," forward method, overrides the "),zn=l(Do,"CODE",{});var Ld=d(zn);ji=a(Ld,"__call__"),Ld.forEach(o),Pi=a(Do," special method."),Do.forEach(o),Ai=_(ne),M(Ze.$$.fragment,ne),Si=_(ne),M(et.$$.fragment,ne),Ni=_(ne),M(tt.$$.fragment,ne),ne.forEach(o),gt.forEach(o),Ls=_(t),$e=l(t,"H2",{class:!0});var Rs=d($e);ot=l(Rs,"A",{id:!0,class:!0,href:!0});var kd=d(ot);Fn=l(kd,"SPAN",{});var Md=d(Fn);M(Yt.$$.fragment,Md),Md.forEach(o),kd.forEach(o),Ii=_(Rs),Cn=l(Rs,"SPAN",{});var wd=d(Cn);Oi=a(wd,"XLMRobertaXLForQuestionAnswering"),wd.forEach(o),Rs.forEach(o),ks=_(t),B=l(t,"DIV",{class:!0});var _t=d(B);M(Zt.$$.fragment,_t),Di=_(_t),Te=l(_t,"P",{});var Wo=d(Te);Wi=a(Wo,`XLM-Roberta-xlarge Model with a span classification head on top for extractive question-answering tasks like SQuAD
