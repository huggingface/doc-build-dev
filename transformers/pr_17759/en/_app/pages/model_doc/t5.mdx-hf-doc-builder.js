...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function f1(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),be=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),M=r(z,"UL",{});var L=i(M);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),Te=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),be=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,be),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function _1(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function T1(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),be=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),M=r(z,"UL",{});var L=i(M);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),Te=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),be=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,be),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function b1(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17759/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17759/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17759/en/model_doc/t5#transformers.T5Config"
...
Whether or not to return a <a href="/docs/transformers/pr_17759/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.T5ForConditionalGeneration.forward.labels",description:`<strong>labels</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size,)</code>, <em>optional</em>) &#x2014;
Labels for computing the sequence classification/regression loss. Indices should be in <code>[-100, 0, ..., config.vocab_size - 1]</code>. All labels set to <code>-100</code> are ignored (masked), the loss is only computed for
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17759/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17759/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_tf_t5.py#L1137",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_tf_t5.py#L1313",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17759/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17759/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_tf_t5.py#L1619",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17759/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_17759/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
(`),cs=r(bt,"A",{href:!0,rel:!0});var Qv=i(cs);Sm=s(Qv,"PyTorch"),Qv.forEach(t),Gm=s(bt," and "),ps=r(bt,"A",{href:!0,rel:!0});var e5=i(ps);Um=s(e5,"Tensorflow"),e5.forEach(t),Bm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),Yv.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var t5=i(yn);ll=r(t5,"SPAN",{});var n5=i(ll);v(hs.$$.fragment,n5),n5.forEach(t),t5.forEach(t),Wm=c(np),dl=r(np,"SPAN",{});var o5=i(dl);Rm=s(o5,"T5Config"),o5.forEach(t),np.forEach(t),$c=c(n),kt=r(n,"DIV",{class:!0});var Wr=i(kt);v(us.$$.fragment,Wr),Hm=c(Wr),vt=r(Wr,"P",{});var bo=i(vt);Vm=s(bo,"This is the configuration class to store the configuration of a "),_r=r(bo,"A",{href:!0});var s5=i(_r);Km=s(s5,"T5Model"),s5.forEach(t),Ym=s(bo," or a "),gr=r(bo,"A",{href:!0});var a5=i(gr);Zm=s(a5,"TFT5Model"),a5.forEach(t),Jm=s(bo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(bo,"A",{href:!0,rel:!0});var r5=i(ms);Xm=s(r5,"t5-small"),r5.forEach(t),Qm=s(bo," architecture."),bo.forEach(t),ef=c(Wr),Gt=r(Wr,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var i5=i(Tr);nf=s(i5,"PretrainedConfig"),i5.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),br=r(Rr,"A",{href:!0});var l5=i(br);sf=s(l5,"PretrainedConfig"),l5.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Wr.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var d5=i(wn);cl=r(d5,"SPAN",{});var c5=i(cl);v(fs.$$.fragment,c5),c5.forEach(t),d5.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var p5=i(pl);lf=s(p5,"T5Tokenizer"),p5.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var h5=i(Ts);pf=s(h5,"SentencePiece"),h5.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),bs=r(Ve,"P",{});var ap=i(bs);mf=s(ap,"This tokenizer inherits from "),kr=r(ap,"A",{href:!0});var u5=i(kr);ff=s(u5,"PreTrainedTokenizer"),u5.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ap.forEach(t),gf=c(Ve),qt=r(Ve,"DIV",{class:!0});var Hr=i(qt);v(ks.$$.fragment,Hr),Tf=c(Hr),hl=r(Hr,"P",{});var m5=i(hl);bf=s(m5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),m5.forEach(t),kf=c(Hr),vs=r(Hr,"UL",{});var rp=i(vs);vr=r(rp,"LI",{});var ik=i(vr);vf=s(ik,"single sequence: "),ul=r(ik,"CODE",{});var f5=i(ul);yf=s(f5,"X </s>"),f5.forEach(t),ik.forEach(t),wf=c(rp),yr=r(rp,"LI",{});var lk=i(yr);$f=s(lk,"pair of sequences: "),ml=r(lk,"CODE",{});var _5=i(ml);xf=s(_5,"A </s> B </s>"),_5.forEach(t),lk.forEach(t),rp.forEach(t),Hr.forEach(t),zf=c(Ve),$n=r(Ve,"DIV",{class:!0});var ip=i($n);v(ys.$$.fragment,ip),jf=c(ip),ws=r(ip,"P",{});var lp=i(ws);qf=s(lp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fl=r(lp,"CODE",{});var g5=i(fl);Ef=s(g5,"prepare_for_model"),g5.forEach(t),Ff=s(lp," method."),lp.forEach(t),ip.forEach(t),Mf=c(Ve),xn=r(Ve,"DIV",{class:!0});var dp=i(xn);v($s.$$.fragment,dp),Cf=c(dp),_l=r(dp,"P",{});var T5=i(_l);Pf=s(T5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T5.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var b5=i(wr);v(xs.$$.fragment,b5),b5.forEach(t),Ve.forEach(t),jc=c(n),Bt=r(n,"H2",{class:!0});var cp=i(Bt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var k5=i(zn);gl=r(k5,"SPAN",{});var v5=i(gl);v(zs.$$.fragment,v5),v5.forEach(t),k5.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var y5=i(Tl);Lf=s(y5,"T5TokenizerFast"),y5.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);v(js.$$.fragment,Nt),Af=c(Nt),Wt=r(Nt,"P",{});var Vr=i(Wt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=r(Vr,"EM",{});var w5=i(bl);Df=s(w5,"tokenizers"),w5.forEach(t),Sf=s(Vr,` library). Based on
`),qs=r(Vr,"A",{href:!0,rel:!0});var $5=i(qs);Gf=s($5,"Unigram"),$5.forEach(t),Uf=s(Vr,"."),Vr.forEach(t),Bf=c(Nt),Es=r(Nt,"P",{});var pp=i(Es);Wf=s(pp,"This tokenizer inherits from "),$r=r(pp,"A",{href:!0});var x5=i($r);Rf=s(x5,"PreTrainedTokenizerFast"),x5.forEach(t),Hf=s(pp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),pp.forEach(t),Vf=c(Nt),Et=r(Nt,"DIV",{class:!0});var Kr=i(Et);v(Fs.$$.fragment,Kr),Kf=c(Kr),kl=r(Kr,"P",{});var z5=i(kl);Yf=s(z5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),z5.forEach(t),Zf=c(Kr),Ms=r(Kr,"UL",{});var hp=i(Ms);xr=r(hp,"LI",{});var dk=i(xr);Jf=s(dk,"single sequence: "),vl=r(dk,"CODE",{});var j5=i(vl);Xf=s(j5,"X </s>"),j5.forEach(t),dk.forEach(t),Qf=c(hp),zr=r(hp,"LI",{});var ck=i(zr);e_=s(ck,"pair of sequences: "),yl=r(ck,"CODE",{});var q5=i(yl);t_=s(q5,"A </s> B </s>"),q5.forEach(t),ck.forEach(t),hp.forEach(t),Kr.forEach(t),n_=c(Nt),jn=r(Nt,"DIV",{class:!0});var up=i(jn);v(Cs.$$.fragment,up),o_=c(up),wl=r(up,"P",{});var E5=i(wl);s_=s(E5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),E5.forEach(t),up.forEach(t),Nt.forEach(t),Ec=c(n),Rt=r(n,"H2",{class:!0});var mp=i(Rt);qn=r(mp,"A",{id:!0,class:!0,href:!0});var F5=i(qn);$l=r(F5,"SPAN",{});var M5=i($l);v(Ps.$$.fragment,M5),M5.forEach(t),F5.forEach(t),a_=c(mp),xl=r(mp,"SPAN",{});var C5=i(xl);r_=s(C5,"T5Model"),C5.forEach(t),mp.forEach(t),Fc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);v(Ns.$$.fragment,xe),i_=c(xe),zl=r(xe,"P",{});var P5=i(zl);l_=s(P5,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),P5.forEach(t),d_=c(xe),Os=r(xe,"P",{});var fp=i(Os);c_=s(fp,"The T5 model was proposed in "),Ls=r(fp,"A",{href:!0,rel:!0});var N5=i(Ls);p_=s(N5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),g_=c(xe),Is=r(xe,"P",{});var gp=i(Is);T_=s(gp,"This model is also a PyTorch "),Ds=r(gp,"A",{href:!0,rel:!0});var L5=i(Ds);b_=s(L5,"torch.nn.Module"),L5.forEach(t),k_=s(gp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gp.forEach(t),v_=c(xe),lt=r(xe,"DIV",{class:!0});var ko=i(lt);v(Ss.$$.fragment,ko),y_=c(ko),Ht=r(ko,"P",{});var Yr=i(Ht);w_=s(Yr,"The "),qr=r(Yr,"A",{href:!0});var A5=i(qr);$_=s(A5,"T5Model"),A5.forEach(t),x_=s(Yr," forward method, overrides the "),jl=r(Yr,"CODE",{});var I5=i(jl);z_=s(I5,"__call__"),I5.forEach(t),j_=s(Yr," special method."),Yr.forEach(t),q_=c(ko),v(En.$$.fragment,ko),E_=c(ko),v(Fn.$$.fragment,ko),ko.forEach(t),F_=c(xe),dt=r(xe,"DIV",{class:!0});var vo=i(dt);v(Gs.$$.fragment,vo),M_=c(vo),ql=r(vo,"P",{});var D5=i(ql);C_=s(D5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),D5.forEach(t),P_=c(vo),El=r(vo,"P",{});var S5=i(El);N_=s(S5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),S5.forEach(t),O_=c(vo),v(Mn.$$.fragment,vo),vo.forEach(t),L_=c(xe),Ft=r(xe,"DIV",{class:!0});var Zr=i(Ft);v(Us.$$.fragment,Zr),A_=c(Zr),Fl=r(Zr,"P",{});var G5=i(Fl);I_=s(G5,"Moves the model to cpu from a model parallel state."),G5.forEach(t),D_=c(Zr),v(Cn.$$.fragment,Zr),Zr.forEach(t),xe.forEach(t),Mc=c(n),Vt=r(n,"H2",{class:!0});var Tp=i(Vt);Pn=r(Tp,"A",{id:!0,class:!0,href:!0});var U5=i(Pn);Ml=r(U5,"SPAN",{});var B5=i(Ml);v(Bs.$$.fragment,B5),B5.forEach(t),U5.forEach(t),S_=c(Tp),Cl=r(Tp,"SPAN",{});var W5=i(Cl);G_=s(W5,"T5ForConditionalGeneration"),W5.forEach(t),Tp.forEach(t),Cc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);v(Ws.$$.fragment,ze),U_=c(ze),Rs=r(ze,"P",{});var bp=i(Rs);B_=s(bp,"T5 Model with a "),Pl=r(bp,"CODE",{});var R5=i(Pl);W_=s(R5,"language modeling"),R5.forEach(t),R_=s(bp," head on top."),bp.forEach(t),H_=c(ze),Hs=r(ze,"P",{});var kp=i(Hs);V_=s(kp,"The T5 model was proposed in "),Vs=r(kp,"A",{href:!0,rel:!0});var H5=i(Vs);K_=s(H5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),H5.forEach(t),Y_=s(kp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),kp.forEach(t),Z_=c(ze),Ks=r(ze,"P",{});var vp=i(Ks);J_=s(vp,"This model inherits from "),Er=r(vp,"A",{href:!0});var V5=i(Er);X_=s(V5,"PreTrainedModel"),V5.forEach(t),Q_=s(vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vp.forEach(t),eg=c(ze),Ys=r(ze,"P",{});var yp=i(Ys);tg=s(yp,"This model is also a PyTorch "),Zs=r(yp,"A",{href:!0,rel:!0});var K5=i(Zs);ng=s(K5,"torch.nn.Module"),K5.forEach(t),og=s(yp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yp.forEach(t),sg=c(ze),ct=r(ze,"DIV",{class:!0});var yo=i(ct);v(Js.$$.fragment,yo),ag=c(yo),Kt=r(yo,"P",{});var Jr=i(Kt);rg=s(Jr,"The "),Fr=r(Jr,"A",{href:!0});var Y5=i(Fr);ig=s(Y5,"T5ForConditionalGeneration"),Y5.forEach(t),lg=s(Jr," forward method, overrides the "),Nl=r(Jr,"CODE",{});var Z5=i(Nl);dg=s(Z5,"__call__"),Z5.forEach(t),cg=s(Jr," special method."),Jr.forEach(t),pg=c(yo),v(Nn.$$.fragment,yo),hg=c(yo),v(On.$$.fragment,yo),yo.forEach(t),ug=c(ze),pt=r(ze,"DIV",{class:!0});var wo=i(pt);v(Xs.$$.fragment,wo),mg=c(wo),Ol=r(wo,"P",{});var J5=i(Ol);fg=s(J5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),J5.forEach(t),_g=c(wo),Ll=r(wo,"P",{});var X5=i(Ll);gg=s(X5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),X5.forEach(t),Tg=c(wo),v(Ln.$$.fragment,wo),wo.forEach(t),bg=c(ze),Mt=r(ze,"DIV",{class:!0});var Xr=i(Mt);v(Qs.$$.fragment,Xr),kg=c(Xr),Al=r(Xr,"P",{});var Q5=i(Al);vg=s(Q5,"Moves the model to cpu from a model parallel state."),Q5.forEach(t),yg=c(Xr),v(An.$$.fragment,Xr),Xr.forEach(t),ze.forEach(t),Pc=c(n),Yt=r(n,"H2",{class:!0});var wp=i(Yt);In=r(wp,"A",{id:!0,class:!0,href:!0});var ey=i(In);Il=r(ey,"SPAN",{});var ty=i(Il);v(ea.$$.fragment,ty),ty.forEach(t),ey.forEach(t),wg=c(wp),Dl=r(wp,"SPAN",{});var ny=i(Dl);$g=s(ny,"T5EncoderModel"),ny.forEach(t),wp.forEach(t),Nc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);v(ta.$$.fragment,je),xg=c(je),Sl=r(je,"P",{});var oy=i(Sl);zg=s(oy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),oy.forEach(t),jg=c(je),na=r(je,"P",{});var $p=i(na);qg=s($p,"The T5 model was proposed in "),oa=r($p,"A",{href:!0,rel:!0});var sy=i(oa);Eg=s(sy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
