import{S as Yy,i as Zy,s as Jy,e as a,k as d,w as k,t as o,M as Xy,c as r,d as t,m as c,a as i,x as v,h as s,b as h,G as e,g as m,y,q as w,o as $,B as x,v as Qy,L as ge}from"../../chunks/vendor-hf-doc-builder.js";import{T as wt}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as S}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ke}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _e}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function e5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,be),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function u5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function f5(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),be=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),M=r(z,"UL",{});var L=i(M);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),Te=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),be=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,be),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function _5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function T5(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),be=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),M=r(z,"UL",{});var L=i(M);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),Te=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),be=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,be),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function b5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function k5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, TFT5EncoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Example:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function E5(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe,z,F,te,Ge,et,D,Ue,ne,tt,L,Y,nt,Le,Z,ot,Ae,Ie,st,Ld,Ka,Hp,Ad,Be,ri,ii,Po,Vp,Kp,li,di,No,Yp,Zp,ci,pi,Oo,Jp,Xp,hi,ui,Lo,Qp,eh,mi,Ya,Ao,th,nh,Id,Za,oh,Dd,$t,fi,cn,_i,sh,ah,Ja,rh,ih,lh,gi,pn,Ti,dh,ch,Xa,ph,hh,uh,bi,hn,ki,mh,fh,Qa,_h,gh,Sd,un,Th,Io,bh,kh,Gd,xt,vh,Do,yh,wh,So,$h,xh,Ud,er,Bd,Ot,mn,vi,Go,zh,yi,jh,Wd,at,qh,wi,Eh,Fh,$i,Mh,Ch,xi,Ph,Nh,Rd,fn,Oh,tr,Lh,Ah,Hd,nr,zi,Ih,Vd,me,Dh,ji,Sh,Gh,qi,Uh,Bh,Ei,Wh,Rh,Fi,Hh,Vh,Mi,Kh,Yh,or,Zh,Jh,Kd,sr,Xh,Yd,Uo,Zd,_n,Qh,Bo,eu,tu,Jd,ar,Ci,nu,Xd,rr,ou,Qd,Wo,ec,oe,su,Pi,au,ru,Ni,iu,lu,Oi,du,cu,Li,pu,hu,Ai,uu,mu,Ii,fu,_u,Di,gu,Tu,tc,zt,bu,Si,ku,vu,Gi,yu,wu,nc,fe,$u,Ui,xu,zu,Bi,ju,qu,Wi,Eu,Fu,Ri,Mu,Cu,Ro,Pu,Nu,Hi,Ou,Lu,oc,Ho,sc,ir,Au,ac,lr,Vo,Iu,Vi,Du,Su,rc,jt,Gu,Ko,Uu,Bu,Yo,Wu,Ru,ic,gn,Hu,Ki,Vu,Ku,lc,dr,dc,Lt,Tn,Yi,Zo,Yu,Zi,Zu,cc,rt,Ju,cr,Xu,Qu,Jo,em,tm,Xo,nm,om,pc,Qo,hc,We,sm,Ji,am,rm,Xi,im,lm,pr,dm,cm,Qi,pm,hm,uc,hr,um,mc,es,fc,ur,mm,_c,ts,gc,mr,Tc,At,bn,el,ns,fm,tl,_m,bc,it,gm,os,Tm,bm,nl,km,vm,ol,ym,wm,kc,It,kn,sl,ss,$m,al,xm,vc,fr,zm,yc,vn,rl,Dt,jm,as,qm,Em,rs,Fm,Mm,Cm,il,De,Pm,is,Nm,Om,ls,Lm,Am,ds,Im,Dm,cs,Sm,Gm,ps,Um,Bm,wc,St,yn,ll,hs,Wm,dl,Rm,$c,kt,us,Hm,vt,Vm,_r,Km,Ym,gr,Zm,Jm,ms,Xm,Qm,ef,Gt,tf,Tr,nf,of,br,sf,af,xc,Ut,wn,cl,fs,rf,pl,lf,zc,ie,_s,df,gs,cf,Ts,pf,hf,uf,bs,mf,kr,ff,_f,gf,qt,ks,Tf,hl,bf,kf,vs,vr,vf,ul,yf,wf,yr,$f,ml,xf,zf,$n,ys,jf,ws,qf,fl,Ef,Ff,Mf,xn,$s,Cf,_l,Pf,Nf,wr,xs,jc,Bt,zn,gl,zs,Of,Tl,Lf,qc,Se,js,Af,Wt,If,bl,Df,Sf,qs,Gf,Uf,Bf,Es,Wf,$r,Rf,Hf,Vf,Et,Fs,Kf,kl,Yf,Zf,Ms,xr,Jf,vl,Xf,Qf,zr,e_,yl,t_,n_,jn,Cs,o_,wl,s_,Ec,Rt,qn,$l,Ps,a_,xl,r_,Fc,J,Ns,i_,zl,l_,d_,Os,c_,Ls,p_,h_,u_,As,m_,jr,f_,__,g_,Is,T_,Ds,b_,k_,v_,lt,Ss,y_,Ht,w_,qr,$_,x_,jl,z_,j_,q_,En,E_,Fn,F_,dt,Gs,M_,ql,C_,P_,El,N_,O_,Mn,L_,Ft,Us,A_,Fl,I_,D_,Cn,Mc,Vt,Pn,Ml,Bs,S_,Cl,G_,Cc,X,Ws,U_,Rs,B_,Pl,W_,R_,H_,Hs,V_,Vs,K_,Y_,Z_,Ks,J_,Er,X_,Q_,eg,Ys,tg,Zs,ng,og,sg,ct,Js,ag,Kt,rg,Fr,ig,lg,Nl,dg,cg,pg,Nn,hg,On,ug,pt,Xs,mg,Ol,fg,_g,Ll,gg,Tg,Ln,bg,Mt,Qs,kg,Al,vg,yg,An,Pc,Yt,In,Il,ea,wg,Dl,$g,Nc,Q,ta,xg,Sl,zg,jg,na,qg,oa,Eg,Fg,Mg,sa,Cg,Mr,Pg,Ng,Og,aa,Lg,ra,Ag,Ig,Dg,ht,ia,Sg,Zt,Gg,Cr,Ug,Bg,Gl,Wg,Rg,Hg,Dn,Vg,Sn,Kg,ut,la,Yg,Ul,Zg,Jg,Bl,Xg,Qg,Gn,eT,Ct,da,tT,Wl,nT,oT,Un,Oc,Jt,Bn,Rl,ca,sT,Hl,aT,Lc,le,pa,rT,Vl,iT,lT,ha,dT,ua,cT,pT,hT,ma,uT,Pr,mT,fT,_T,fa,gT,_a,TT,bT,kT,Wn,vT,mt,ga,yT,Xt,wT,Nr,$T,xT,Kl,zT,jT,qT,Rn,ET,Hn,Ac,Qt,Vn,Yl,Ta,FT,Zl,MT,Ic,de,ba,CT,ka,PT,Jl,NT,OT,LT,va,AT,ya,IT,DT,ST,wa,GT,Or,UT,BT,WT,$a,RT,xa,HT,VT,KT,Kn,YT,ft,za,ZT,en,JT,Lr,XT,QT,Xl,eb,tb,nb,Yn,ob,Zn,Dc,tn,Jn,Ql,ja,sb,ed,ab,Sc,ce,qa,rb,td,ib,lb,Ea,db,Fa,cb,pb,hb,Ma,ub,Ar,mb,fb,_b,Ca,gb,Pa,Tb,bb,kb,Xn,vb,_t,Na,yb,nn,wb,Ir,$b,xb,nd,zb,jb,qb,Qn,Eb,eo,Gc,on,to,od,Oa,Fb,sd,Mb,Uc,Je,La,Cb,gt,Aa,Pb,sn,Nb,ad,Ob,Lb,rd,Ab,Ib,Db,no,Sb,oo,Gb,so,Ia,Ub,ao,Bb,ro,Da,Wb,io,Bc,an,lo,id,Sa,Rb,ld,Hb,Wc,Xe,Ga,Vb,Tt,Ua,Kb,rn,Yb,dd,Zb,Jb,cd,Xb,Qb,ek,co,tk,po,nk,ho,Ba,ok,uo,sk,mo,Wa,ak,fo,Rc;return l=new ke({}),ae=new ke({}),Go=new ke({}),Uo=new S({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
<span class="hljs-number">3.7837</span>`}}),Wo=new S({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17881/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17881/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17881/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17881/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17881/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_t5.py#L1492"}}),Ln=new _e({props:{anchor:"transformers.T5ForConditionalGeneration.parallelize.example",$$slots:{default:[r5]},$$scope:{ctx:j}}}),Qs=new C({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_t5.py#L1505"}}),An=new _e({props:{anchor:"transformers.T5ForConditionalGeneration.deparallelize.example",$$slots:{default:[i5]},$$scope:{ctx:j}}}),ea=new ke({}),ta=new C({props:{name:"class transformers.T5EncoderModel",anchor:"transformers.T5EncoderModel",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17881/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_tf_t5.py#L1137",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
`}}),Rn=new wt({props:{$$slots:{default:[u5]},$$scope:{ctx:j}}}),Hn=new _e({props:{anchor:"transformers.TFT5Model.call.example",$$slots:{default:[m5]},$$scope:{ctx:j}}}),Ta=new ke({}),ba=new C({props:{name:"class transformers.TFT5ForConditionalGeneration",anchor:"transformers.TFT5ForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_tf_t5.py#L1313",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),Yn=new wt({props:{$$slots:{default:[_5]},$$scope:{ctx:j}}}),Zn=new _e({props:{anchor:"transformers.TFT5ForConditionalGeneration.call.example",$$slots:{default:[g5]},$$scope:{ctx:j}}}),ja=new ke({}),qa=new C({props:{name:"class transformers.TFT5EncoderModel",anchor:"transformers.TFT5EncoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17881/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_tf_t5.py#L1595"}}),Xn=new wt({props:{$$slots:{default:[T5]},$$scope:{ctx:j}}}),Na=new C({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17881/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17881/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_tf_t5.py#L1619",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17881/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/t5/modeling_flax_t5.py#L1468",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`}}),fo=new _e({props:{anchor:"transformers.FlaxT5ForConditionalGeneration.decode.example",$$slots:{default:[q5]},$$scope:{ctx:j}}}),{c(){p=a("meta"),b=d(),g=a("h1"),u=a("a"),T=a("span"),k(l.$$.fragment),_=d(),q=a("span"),qe=o("T5"),se=d(),E=a("h2"),ee=a("a"),G=a("span"),k(ae.$$.fragment),Ee=d(),U=a("span"),Fe=o("Overview"),ve=d(),B=a("p"),A=o("The T5 model was presented in "),re=a("a"),pe=o("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),M=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),R=a("em"),Oe=o("summarize: \u2026"),z=o("."),F=d(),te=a("li"),Ge=a("p"),et=o("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),D=d(),Ue=a("li"),ne=a("p"),tt=o("See the "),L=a("a"),Y=o("training"),nt=o(", "),Le=a("a"),Z=o("inference"),ot=o(" and "),Ae=a("a"),Ie=o("scripts"),st=o(" sections below for all details regarding usage."),Ld=d(),Ka=a("p"),Hp=o("T5 comes in different sizes:"),Ad=d(),Be=a("ul"),ri=a("li"),ii=a("p"),Po=a("a"),Vp=o("t5-small"),Kp=d(),li=a("li"),di=a("p"),No=a("a"),Yp=o("t5-base"),Zp=d(),ci=a("li"),pi=a("p"),Oo=a("a"),Jp=o("t5-large"),Xp=d(),hi=a("li"),ui=a("p"),Lo=a("a"),Qp=o("t5-3b"),eh=d(),mi=a("li"),Ya=a("p"),Ao=a("a"),th=o("t5-11b"),nh=o("."),Id=d(),Za=a("p"),oh=o("Based on the original T5 model, Google has released some follow-up works:"),Dd=d(),$t=a("ul"),fi=a("li"),cn=a("p"),_i=a("strong"),sh=o("T5v1.1"),ah=o(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),Qa=a("a"),_h=o("here"),gh=o("."),Sd=d(),un=a("p"),Th=o("All checkpoints can be found on the "),Io=a("a"),bh=o("hub"),kh=o("."),Gd=d(),xt=a("p"),vh=o("This model was contributed by "),Do=a("a"),yh=o("thomwolf"),wh=o(". The original code can be found "),So=a("a"),$h=o("here"),xh=o("."),Ud=d(),er=a("a"),Bd=d(),Ot=a("h2"),mn=a("a"),vi=a("span"),k(Go.$$.fragment),zh=d(),yi=a("span"),jh=o("Training"),Wd=d(),at=a("p"),qh=o(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
the output sequence is formed as a concatenation of the same sentinel tokens and the `),qi=a("em"),Uh=o("real"),Bh=o(` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=a("code"),Wh=o("<extra_id_0>"),Rh=o(`,
...
processed as follows:`),Yd=d(),k(Uo.$$.fragment),Zd=d(),_n=a("p"),Qh=o("If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Bo=a("a"),eu=o("run_t5_mlm_flax.py"),tu=o(` script in the Examples
...
the model as follows:`),Qd=d(),k(Wo.$$.fragment),ec=d(),oe=a("p"),su=o("As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=a("code"),au=o("input_ids"),ru=o(` (which are the
...
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Bi=a("code"),ju=o("ignore_index"),qu=o(`
of the `),Wi=a("code"),Eu=o("CrossEntropyLoss"),Fu=o(". In Flax, one can use the "),Ri=a("code"),Mu=o("decoder_attention_mask"),Cu=o(` to ignore padded tokens from
...
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),rc=d(),jt=a("p"),Gu=o("According to "),Ko=a("a"),Uu=o("this forum post"),Bu=o(`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Yo=a("a"),Wu=o("paper"),Ru=o(` for the task prefixes
...
generation works in general in encoder-decoder models.`),pc=d(),k(Qo.$$.fragment),hc=d(),We=a("p"),sm=o("Note that T5 uses the "),Ji=a("code"),am=o("pad_token_id"),rm=o(" as the "),Xi=a("code"),im=o("decoder_start_token_id"),lm=o(`, so when doing generation without using
...
(`),cs=a("a"),Sm=o("PyTorch"),Gm=o(" and "),ps=a("a"),Um=o("Tensorflow"),Bm=o(`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),wc=d(),St=a("h2"),yn=a("a"),ll=a("span"),k(hs.$$.fragment),Wm=d(),dl=a("span"),Rm=o("T5Config"),$c=d(),kt=a("div"),k(us.$$.fragment),Hm=d(),vt=a("p"),Vm=o("This is the configuration class to store the configuration of a "),_r=a("a"),Km=o("T5Model"),Ym=o(" or a "),gr=a("a"),Zm=o("TFT5Model"),Jm=o(`. It is used to
...
use of token type ids, therefore a list of zeros is returned.`),Nf=d(),wr=a("div"),k(xs.$$.fragment),jc=d(),Bt=a("h2"),zn=a("a"),gl=a("span"),k(zs.$$.fragment),Of=d(),Tl=a("span"),Lf=o("T5TokenizerFast"),qc=d(),Se=a("div"),k(js.$$.fragment),Af=d(),Wt=a("p"),If=o("Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=a("em"),Df=o("tokenizers"),Sf=o(` library). Based on
`),qs=a("a"),Gf=o("Unigram"),Uf=o("."),Bf=d(),Es=a("p"),Wf=o("This tokenizer inherits from "),$r=a("a"),Rf=o("PreTrainedTokenizerFast"),Hf=o(` which contains most of the main methods. Users should
...
it will evenly distribute blocks across all devices.`),O_=d(),k(Mn.$$.fragment),L_=d(),Ft=a("div"),k(Us.$$.fragment),A_=d(),Fl=a("p"),I_=o("Moves the model to cpu from a model parallel state."),D_=d(),k(Cn.$$.fragment),Mc=d(),Vt=a("h2"),Pn=a("a"),Ml=a("span"),k(Bs.$$.fragment),S_=d(),Cl=a("span"),G_=o("T5ForConditionalGeneration"),Cc=d(),X=a("div"),k(Ws.$$.fragment),U_=d(),Rs=a("p"),B_=o("T5 Model with a "),Pl=a("code"),W_=o("language modeling"),R_=o(" head on top."),H_=d(),Hs=a("p"),V_=o("The T5 model was proposed in "),Vs=a("a"),K_=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dg=d(),ht=a("div"),k(ia.$$.fragment),Sg=d(),Zt=a("p"),Gg=o("The "),Cr=a("a"),Ug=o("T5EncoderModel"),Bg=o(" forward method, overrides the "),Gl=a("code"),Wg=o("__call__"),Rg=o(" special method."),Hg=d(),k(Dn.$$.fragment),Vg=d(),k(Sn.$$.fragment),Kg=d(),ut=a("div"),k(la.$$.fragment),Yg=d(),Ul=a("p"),Zg=o("This is an experimental feature and is a subject to change at a moment\u2019s notice."),Jg=d(),Bl=a("p"),Xg=o(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Qg=d(),k(Gn.$$.fragment),eT=d(),Ct=a("div"),k(da.$$.fragment),tT=d(),Wl=a("p"),nT=o("Moves the model to cpu from a model parallel state."),oT=d(),k(Un.$$.fragment),Oc=d(),Jt=a("h2"),Bn=a("a"),Rl=a("span"),k(ca.$$.fragment),sT=d(),Hl=a("span"),aT=o("TFT5Model"),Lc=d(),le=a("div"),k(pa.$$.fragment),rT=d(),Vl=a("p"),iT=o("The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),lT=d(),ha=a("p"),dT=o("The T5 model was proposed in "),ua=a("a"),cT=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
behavior.`),kT=d(),k(Wn.$$.fragment),vT=d(),mt=a("div"),k(ga.$$.fragment),yT=d(),Xt=a("p"),wT=o("The "),Nr=a("a"),$T=o("TFT5Model"),xT=o(" forward method, overrides the "),Kl=a("code"),zT=o("__call__"),jT=o(" special method."),qT=d(),k(Rn.$$.fragment),ET=d(),k(Hn.$$.fragment),Ac=d(),Qt=a("h2"),Vn=a("a"),Yl=a("span"),k(Ta.$$.fragment),FT=d(),Zl=a("span"),MT=o("TFT5ForConditionalGeneration"),Ic=d(),de=a("div"),k(ba.$$.fragment),CT=d(),ka=a("p"),PT=o("T5 Model with a "),Jl=a("code"),NT=o("language modeling"),OT=o(" head on top."),LT=d(),va=a("p"),AT=o("The T5 model was proposed in "),ya=a("a"),IT=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),DT=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),ST=d(),wa=a("p"),GT=o("This model inherits from "),Or=a("a"),UT=o("TFPreTrainedModel"),BT=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),WT=d(),$a=a("p"),RT=o("This model is also a "),xa=a("a"),HT=o("tf.keras.Model"),VT=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
to the documentation of byT5 which can be found `),Qa=r(Od,"A",{href:!0});var Pk=i(Qa);_h=s(Pk,"here"),Pk.forEach(t),gh=s(Od,"."),Od.forEach(t),Mk.forEach(t),Dr.forEach(t),Sd=c(n),un=r(n,"P",{});var Hc=i(un);Th=s(Hc,"All checkpoints can be found on the "),Io=r(Hc,"A",{href:!0,rel:!0});var Nk=i(Io);bh=s(Nk,"hub"),Nk.forEach(t),kh=s(Hc,"."),Hc.forEach(t),Gd=c(n),xt=r(n,"P",{});var Sr=i(xt);vh=s(Sr,"This model was contributed by "),Do=r(Sr,"A",{href:!0,rel:!0});var Ok=i(Do);yh=s(Ok,"thomwolf"),Ok.forEach(t),wh=s(Sr,". The original code can be found "),So=r(Sr,"A",{href:!0,rel:!0});var Lk=i(So);$h=s(Lk,"here"),Lk.forEach(t),xh=s(Sr,"."),Sr.forEach(t),Ud=c(n),er=r(n,"A",{id:!0}),i(er).forEach(t),Bd=c(n),Ot=r(n,"H2",{class:!0});var Vc=i(Ot);mn=r(Vc,"A",{id:!0,class:!0,href:!0});var Ak=i(mn);vi=r(Ak,"SPAN",{});var Ik=i(vi);v(Go.$$.fragment,Ik),Ik.forEach(t),Ak.forEach(t),zh=c(Vc),yi=r(Vc,"SPAN",{});var Dk=i(yi);jh=s(Dk,"Training"),Dk.forEach(t),Vc.forEach(t),Wd=c(n),at=r(n,"P",{});var _o=i(at);qh=s(_o,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),_o.forEach(t),Rd=c(n),fn=r(n,"P",{});var Kc=i(fn);Oh=s(Kc,"One can use "),tr=r(Kc,"A",{href:!0});var Bk=i(tr);Lh=s(Bk,"T5ForConditionalGeneration"),Bk.forEach(t),Ah=s(Kc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Kc.forEach(t),Hd=c(n),nr=r(n,"UL",{});var Wk=i(nr);zi=r(Wk,"LI",{});var Rk=i(zi);Ih=s(Rk,"Unsupervised denoising training"),Rk.forEach(t),Wk.forEach(t),Vd=c(n),me=r(n,"P",{});var Re=i(me);Dh=s(Re,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=r(Re,"EM",{});var Hk=i(ji);Sh=s(Hk,"a.k.a"),Hk.forEach(t),Gh=s(Re,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),qi=r(Re,"EM",{});var Vk=i(qi);Uh=s(Vk,"real"),Vk.forEach(t),Bh=s(Re,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=r(Re,"CODE",{});var Kk=i(Ei);Wh=s(Kk,"<extra_id_0>"),Kk.forEach(t),Rh=s(Re,`,
...
processed as follows:`),Xk.forEach(t),Yd=c(n),v(Uo.$$.fragment,n),Zd=c(n),_n=r(n,"P",{});var Yc=i(_n);Qh=s(Yc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Bo=r(Yc,"A",{href:!0,rel:!0});var Qk=i(Bo);eu=s(Qk,"run_t5_mlm_flax.py"),Qk.forEach(t),tu=s(Yc,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),nv.forEach(t),Qd=c(n),v(Wo.$$.fragment,n),ec=c(n),oe=r(n,"P",{});var $e=i(oe);su=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=r($e,"CODE",{});var ov=i(Pi);au=s(ov,"input_ids"),ov.forEach(t),ru=s($e,` (which are the
...
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Bi=r(He,"CODE",{});var uv=i(Bi);ju=s(uv,"ignore_index"),uv.forEach(t),qu=s(He,`
of the `),Wi=r(He,"CODE",{});var mv=i(Wi);Eu=s(mv,"CrossEntropyLoss"),mv.forEach(t),Fu=s(He,". In Flax, one can use the "),Ri=r(He,"CODE",{});var fv=i(Ri);Mu=s(fv,"decoder_attention_mask"),fv.forEach(t),Cu=s(He,` to ignore padded tokens from
...
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Zc.forEach(t),bv.forEach(t),rc=c(n),jt=r(n,"P",{});var Ur=i(jt);Gu=s(Ur,"According to "),Ko=r(Ur,"A",{href:!0,rel:!0});var vv=i(Ko);Uu=s(vv,"this forum post"),vv.forEach(t),Bu=s(Ur,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Yo=r(Ur,"A",{href:!0,rel:!0});var yv=i(Yo);Wu=s(yv,"paper"),yv.forEach(t),Ru=s(Ur,` for the task prefixes
...
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),Ov.forEach(t),_c=c(n),v(ts.$$.fragment,n),gc=c(n),mr=r(n,"A",{id:!0}),i(mr).forEach(t),Tc=c(n),At=r(n,"H2",{class:!0});var Qc=i(At);bn=r(Qc,"A",{id:!0,class:!0,href:!0});var Lv=i(bn);el=r(Lv,"SPAN",{});var Av=i(el);v(ns.$$.fragment,Av),Av.forEach(t),Lv.forEach(t),fm=c(Qc),tl=r(Qc,"SPAN",{});var Iv=i(tl);_m=s(Iv,"Performance"),Iv.forEach(t),Qc.forEach(t),bc=c(n),it=r(n,"P",{});var To=i(it);gm=s(To,"If you\u2019d like a faster training and inference performance, install "),os=r(To,"A",{href:!0,rel:!0});var Dv=i(os);Tm=s(Dv,"apex"),Dv.forEach(t),bm=s(To," and then the model will automatically use "),nl=r(To,"CODE",{});var Sv=i(nl);km=s(Sv,"apex.normalization.FusedRMSNorm"),Sv.forEach(t),vm=s(To," instead of "),ol=r(To,"CODE",{});var Gv=i(ol);ym=s(Gv,"T5LayerNorm"),Gv.forEach(t),wm=s(To,". The former uses an optimized fused kernel which is several times faster than the latter."),To.forEach(t),kc=c(n),It=r(n,"H2",{class:!0});var ep=i(It);kn=r(ep,"A",{id:!0,class:!0,href:!0});var Uv=i(kn);sl=r(Uv,"SPAN",{});var Bv=i(sl);v(ss.$$.fragment,Bv),Bv.forEach(t),Uv.forEach(t),$m=c(ep),al=r(ep,"SPAN",{});var Wv=i(al);xm=s(Wv,"Example scripts"),Wv.forEach(t),ep.forEach(t),vc=c(n),fr=r(n,"P",{});var Rv=i(fr);zm=s(Rv,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rv.forEach(t),yc=c(n),vn=r(n,"UL",{});var tp=i(vn);rl=r(tp,"LI",{});var Hv=i(rl);Dt=r(Hv,"P",{});var Br=i(Dt);jm=s(Br,"pre-training: the "),as=r(Br,"A",{href:!0,rel:!0});var Vv=i(as);qm=s(Vv,"run_t5_mlm_flax.py"),Vv.forEach(t),Em=s(Br,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),rs=r(Br,"A",{href:!0,rel:!0});var Kv=i(rs);Fm=s(Kv,"t5_tokenizer_model.py"),Kv.forEach(t),Mm=s(Br,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Br.forEach(t),Hv.forEach(t),Cm=c(tp),il=r(tp,"LI",{});var Yv=i(il);De=r(Yv,"P",{});var bt=i(De);Pm=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),is=r(bt,"A",{href:!0,rel:!0});var Zv=i(is);Nm=s(Zv,"PyTorch"),Zv.forEach(t),Om=s(bt,", "),ls=r(bt,"A",{href:!0,rel:!0});var Jv=i(ls);Lm=s(Jv,"Tensorflow"),Jv.forEach(t),Am=s(bt,", and "),ds=r(bt,"A",{href:!0,rel:!0});var Xv=i(ds);Im=s(Xv,"Flax"),Xv.forEach(t),Dm=s(bt,`) and translation scripts
(`),cs=r(bt,"A",{href:!0,rel:!0});var Qv=i(cs);Sm=s(Qv,"PyTorch"),Qv.forEach(t),Gm=s(bt," and "),ps=r(bt,"A",{href:!0,rel:!0});var e1=i(ps);Um=s(e1,"Tensorflow"),e1.forEach(t),Bm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),Yv.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var t1=i(yn);ll=r(t1,"SPAN",{});var n1=i(ll);v(hs.$$.fragment,n1),n1.forEach(t),t1.forEach(t),Wm=c(np),dl=r(np,"SPAN",{});var o1=i(dl);Rm=s(o1,"T5Config"),o1.forEach(t),np.forEach(t),$c=c(n),kt=r(n,"DIV",{class:!0});var Wr=i(kt);v(us.$$.fragment,Wr),Hm=c(Wr),vt=r(Wr,"P",{});var bo=i(vt);Vm=s(bo,"This is the configuration class to store the configuration of a "),_r=r(bo,"A",{href:!0});var s1=i(_r);Km=s(s1,"T5Model"),s1.forEach(t),Ym=s(bo," or a "),gr=r(bo,"A",{href:!0});var a1=i(gr);Zm=s(a1,"TFT5Model"),a1.forEach(t),Jm=s(bo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(bo,"A",{href:!0,rel:!0});var r1=i(ms);Xm=s(r1,"t5-small"),r1.forEach(t),Qm=s(bo," architecture."),bo.forEach(t),ef=c(Wr),Gt=r(Wr,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var i1=i(Tr);nf=s(i1,"PretrainedConfig"),i1.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),br=r(Rr,"A",{href:!0});var l1=i(br);sf=s(l1,"PretrainedConfig"),l1.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Wr.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var d1=i(wn);cl=r(d1,"SPAN",{});var c1=i(cl);v(fs.$$.fragment,c1),c1.forEach(t),d1.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var p1=i(pl);lf=s(p1,"T5Tokenizer"),p1.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var h1=i(Ts);pf=s(h1,"SentencePiece"),h1.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),bs=r(Ve,"P",{});var ap=i(bs);mf=s(ap,"This tokenizer inherits from "),kr=r(ap,"A",{href:!0});var u1=i(kr);ff=s(u1,"PreTrainedTokenizer"),u1.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ap.forEach(t),gf=c(Ve),qt=r(Ve,"DIV",{class:!0});var Hr=i(qt);v(ks.$$.fragment,Hr),Tf=c(Hr),hl=r(Hr,"P",{});var m1=i(hl);bf=s(m1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),m1.forEach(t),kf=c(Hr),vs=r(Hr,"UL",{});var rp=i(vs);vr=r(rp,"LI",{});var ik=i(vr);vf=s(ik,"single sequence: "),ul=r(ik,"CODE",{});var f1=i(ul);yf=s(f1,"X </s>"),f1.forEach(t),ik.forEach(t),wf=c(rp),yr=r(rp,"LI",{});var lk=i(yr);$f=s(lk,"pair of sequences: "),ml=r(lk,"CODE",{});var _1=i(ml);xf=s(_1,"A </s> B </s>"),_1.forEach(t),lk.forEach(t),rp.forEach(t),Hr.forEach(t),zf=c(Ve),$n=r(Ve,"DIV",{class:!0});var ip=i($n);v(ys.$$.fragment,ip),jf=c(ip),ws=r(ip,"P",{});var lp=i(ws);qf=s(lp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fl=r(lp,"CODE",{});var g1=i(fl);Ef=s(g1,"prepare_for_model"),g1.forEach(t),Ff=s(lp," method."),lp.forEach(t),ip.forEach(t),Mf=c(Ve),xn=r(Ve,"DIV",{class:!0});var dp=i(xn);v($s.$$.fragment,dp),Cf=c(dp),_l=r(dp,"P",{});var T1=i(_l);Pf=s(T1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T1.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var b1=i(wr);v(xs.$$.fragment,b1),b1.forEach(t),Ve.forEach(t),jc=c(n),Bt=r(n,"H2",{class:!0});var cp=i(Bt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var k1=i(zn);gl=r(k1,"SPAN",{});var v1=i(gl);v(zs.$$.fragment,v1),v1.forEach(t),k1.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var y1=i(Tl);Lf=s(y1,"T5TokenizerFast"),y1.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);v(js.$$.fragment,Nt),Af=c(Nt),Wt=r(Nt,"P",{});var Vr=i(Wt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=r(Vr,"EM",{});var w1=i(bl);Df=s(w1,"tokenizers"),w1.forEach(t),Sf=s(Vr,` library). Based on
`),qs=r(Vr,"A",{href:!0,rel:!0});var $1=i(qs);Gf=s($1,"Unigram"),$1.forEach(t),Uf=s(Vr,"."),Vr.forEach(t),Bf=c(Nt),Es=r(Nt,"P",{});var pp=i(Es);Wf=s(pp,"This tokenizer inherits from "),$r=r(pp,"A",{href:!0});var x1=i($r);Rf=s(x1,"PreTrainedTokenizerFast"),x1.forEach(t),Hf=s(pp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),pp.forEach(t),Vf=c(Nt),Et=r(Nt,"DIV",{class:!0});var Kr=i(Et);v(Fs.$$.fragment,Kr),Kf=c(Kr),kl=r(Kr,"P",{});var z1=i(kl);Yf=s(z1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),z1.forEach(t),Zf=c(Kr),Ms=r(Kr,"UL",{});var hp=i(Ms);xr=r(hp,"LI",{});var dk=i(xr);Jf=s(dk,"single sequence: "),vl=r(dk,"CODE",{});var j1=i(vl);Xf=s(j1,"X </s>"),j1.forEach(t),dk.forEach(t),Qf=c(hp),zr=r(hp,"LI",{});var ck=i(zr);e_=s(ck,"pair of sequences: "),yl=r(ck,"CODE",{});var q1=i(yl);t_=s(q1,"A </s> B </s>"),q1.forEach(t),ck.forEach(t),hp.forEach(t),Kr.forEach(t),n_=c(Nt),jn=r(Nt,"DIV",{class:!0});var up=i(jn);v(Cs.$$.fragment,up),o_=c(up),wl=r(up,"P",{});var E1=i(wl);s_=s(E1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),E1.forEach(t),up.forEach(t),Nt.forEach(t),Ec=c(n),Rt=r(n,"H2",{class:!0});var mp=i(Rt);qn=r(mp,"A",{id:!0,class:!0,href:!0});var F1=i(qn);$l=r(F1,"SPAN",{});var M1=i($l);v(Ps.$$.fragment,M1),M1.forEach(t),F1.forEach(t),a_=c(mp),xl=r(mp,"SPAN",{});var C1=i(xl);r_=s(C1,"T5Model"),C1.forEach(t),mp.forEach(t),Fc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);v(Ns.$$.fragment,xe),i_=c(xe),zl=r(xe,"P",{});var P1=i(zl);l_=s(P1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),P1.forEach(t),d_=c(xe),Os=r(xe,"P",{});var fp=i(Os);c_=s(fp,"The T5 model was proposed in "),Ls=r(fp,"A",{href:!0,rel:!0});var N1=i(Ls);p_=s(N1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),g_=c(xe),Is=r(xe,"P",{});var gp=i(Is);T_=s(gp,"This model is also a PyTorch "),Ds=r(gp,"A",{href:!0,rel:!0});var L1=i(Ds);b_=s(L1,"torch.nn.Module"),L1.forEach(t),k_=s(gp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gp.forEach(t),v_=c(xe),lt=r(xe,"DIV",{class:!0});var ko=i(lt);v(Ss.$$.fragment,ko),y_=c(ko),Ht=r(ko,"P",{});var Yr=i(Ht);w_=s(Yr,"The "),qr=r(Yr,"A",{href:!0});var A1=i(qr);$_=s(A1,"T5Model"),A1.forEach(t),x_=s(Yr," forward method, overrides the "),jl=r(Yr,"CODE",{});var I1=i(jl);z_=s(I1,"__call__"),I1.forEach(t),j_=s(Yr," special method."),Yr.forEach(t),q_=c(ko),v(En.$$.fragment,ko),E_=c(ko),v(Fn.$$.fragment,ko),ko.forEach(t),F_=c(xe),dt=r(xe,"DIV",{class:!0});var vo=i(dt);v(Gs.$$.fragment,vo),M_=c(vo),ql=r(vo,"P",{});var D1=i(ql);C_=s(D1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),D1.forEach(t),P_=c(vo),El=r(vo,"P",{});var S1=i(El);N_=s(S1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),S1.forEach(t),O_=c(vo),v(Mn.$$.fragment,vo),vo.forEach(t),L_=c(xe),Ft=r(xe,"DIV",{class:!0});var Zr=i(Ft);v(Us.$$.fragment,Zr),A_=c(Zr),Fl=r(Zr,"P",{});var G1=i(Fl);I_=s(G1,"Moves the model to cpu from a model parallel state."),G1.forEach(t),D_=c(Zr),v(Cn.$$.fragment,Zr),Zr.forEach(t),xe.forEach(t),Mc=c(n),Vt=r(n,"H2",{class:!0});var Tp=i(Vt);Pn=r(Tp,"A",{id:!0,class:!0,href:!0});var U1=i(Pn);Ml=r(U1,"SPAN",{});var B1=i(Ml);v(Bs.$$.fragment,B1),B1.forEach(t),U1.forEach(t),S_=c(Tp),Cl=r(Tp,"SPAN",{});var W1=i(Cl);G_=s(W1,"T5ForConditionalGeneration"),W1.forEach(t),Tp.forEach(t),Cc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);v(Ws.$$.fragment,ze),U_=c(ze),Rs=r(ze,"P",{});var bp=i(Rs);B_=s(bp,"T5 Model with a "),Pl=r(bp,"CODE",{});var R1=i(Pl);W_=s(R1,"language modeling"),R1.forEach(t),R_=s(bp," head on top."),bp.forEach(t),H_=c(ze),Hs=r(ze,"P",{});var kp=i(Hs);V_=s(kp,"The T5 model was proposed in "),Vs=r(kp,"A",{href:!0,rel:!0});var H1=i(Vs);K_=s(H1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),H1.forEach(t),Y_=s(kp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),kp.forEach(t),Z_=c(ze),Ks=r(ze,"P",{});var vp=i(Ks);J_=s(vp,"This model inherits from "),Er=r(vp,"A",{href:!0});var V1=i(Er);X_=s(V1,"PreTrainedModel"),V1.forEach(t),Q_=s(vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vp.forEach(t),eg=c(ze),Ys=r(ze,"P",{});var yp=i(Ys);tg=s(yp,"This model is also a PyTorch "),Zs=r(yp,"A",{href:!0,rel:!0});var K1=i(Zs);ng=s(K1,"torch.nn.Module"),K1.forEach(t),og=s(yp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yp.forEach(t),sg=c(ze),ct=r(ze,"DIV",{class:!0});var yo=i(ct);v(Js.$$.fragment,yo),ag=c(yo),Kt=r(yo,"P",{});var Jr=i(Kt);rg=s(Jr,"The "),Fr=r(Jr,"A",{href:!0});var Y1=i(Fr);ig=s(Y1,"T5ForConditionalGeneration"),Y1.forEach(t),lg=s(Jr," forward method, overrides the "),Nl=r(Jr,"CODE",{});var Z1=i(Nl);dg=s(Z1,"__call__"),Z1.forEach(t),cg=s(Jr," special method."),Jr.forEach(t),pg=c(yo),v(Nn.$$.fragment,yo),hg=c(yo),v(On.$$.fragment,yo),yo.forEach(t),ug=c(ze),pt=r(ze,"DIV",{class:!0});var wo=i(pt);v(Xs.$$.fragment,wo),mg=c(wo),Ol=r(wo,"P",{});var J1=i(Ol);fg=s(J1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),J1.forEach(t),_g=c(wo),Ll=r(wo,"P",{});var X1=i(Ll);gg=s(X1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),X1.forEach(t),Tg=c(wo),v(Ln.$$.fragment,wo),wo.forEach(t),bg=c(ze),Mt=r(ze,"DIV",{class:!0});var Xr=i(Mt);v(Qs.$$.fragment,Xr),kg=c(Xr),Al=r(Xr,"P",{});var Q1=i(Al);vg=s(Q1,"Moves the model to cpu from a model parallel state."),Q1.forEach(t),yg=c(Xr),v(An.$$.fragment,Xr),Xr.forEach(t),ze.forEach(t),Pc=c(n),Yt=r(n,"H2",{class:!0});var wp=i(Yt);In=r(wp,"A",{id:!0,class:!0,href:!0});var ey=i(In);Il=r(ey,"SPAN",{});var ty=i(Il);v(ea.$$.fragment,ty),ty.forEach(t),ey.forEach(t),wg=c(wp),Dl=r(wp,"SPAN",{});var ny=i(Dl);$g=s(ny,"T5EncoderModel"),ny.forEach(t),wp.forEach(t),Nc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);v(ta.$$.fragment,je),xg=c(je),Sl=r(je,"P",{});var oy=i(Sl);zg=s(oy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),oy.forEach(t),jg=c(je),na=r(je,"P",{});var $p=i(na);qg=s($p,"The T5 model was proposed in "),oa=r($p,"A",{href:!0,rel:!0});var sy=i(oa);Eg=s(sy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zp.forEach(t),Dg=c(je),ht=r(je,"DIV",{class:!0});var $o=i(ht);v(ia.$$.fragment,$o),Sg=c($o),Zt=r($o,"P",{});var Qr=i(Zt);Gg=s(Qr,"The "),Cr=r(Qr,"A",{href:!0});var iy=i(Cr);Ug=s(iy,"T5EncoderModel"),iy.forEach(t),Bg=s(Qr," forward method, overrides the "),Gl=r(Qr,"CODE",{});var ly=i(Gl);Wg=s(ly,"__call__"),ly.forEach(t),Rg=s(Qr," special method."),Qr.forEach(t),Hg=c($o),v(Dn.$$.fragment,$o),Vg=c($o),v(Sn.$$.fragment,$o),$o.forEach(t),Kg=c(je),ut=r(je,"DIV",{class:!0});var xo=i(ut);v(la.$$.fragment,xo),Yg=c(xo),Ul=r(xo,"P",{});var dy=i(Ul);Zg=s(dy,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),dy.forEach(t),Jg=c(xo),Bl=r(xo,"P",{});var cy=i(Bl);Xg=s(cy,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),cy.forEach(t),Qg=c(xo),v(Gn.$$.fragment,xo),xo.forEach(t),eT=c(je),Ct=r(je,"DIV",{class:!0});var ei=i(Ct);v(da.$$.fragment,ei),tT=c(ei),Wl=r(ei,"P",{});var py=i(Wl);nT=s(py,"Moves the model to cpu from a model parallel state."),py.forEach(t),oT=c(ei),v(Un.$$.fragment,ei),ei.forEach(t),je.forEach(t),Oc=c(n),Jt=r(n,"H2",{class:!0});var jp=i(Jt);Bn=r(jp,"A",{id:!0,class:!0,href:!0});var hy=i(Bn);Rl=r(hy,"SPAN",{});var uy=i(Rl);v(ca.$$.fragment,uy),uy.forEach(t),hy.forEach(t),sT=c(jp),Hl=r(jp,"SPAN",{});var my=i(Hl);aT=s(my,"TFT5Model"),my.forEach(t),jp.forEach(t),Lc=c(n),le=r(n,"DIV",{class:!0});var Ke=i(le);v(pa.$$.fragment,Ke),rT=c(Ke),Vl=r(Ke,"P",{});var fy=i(Vl);iT=s(fy,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),fy.forEach(t),lT=c(Ke),ha=r(Ke,"P",{});var qp=i(ha);dT=s(qp,"The T5 model was proposed in "),ua=r(qp,"A",{href:!0,rel:!0});var _y=i(ua);cT=s(_y,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),kT=c(Ke),v(Wn.$$.fragment,Ke),vT=c(Ke),mt=r(Ke,"DIV",{class:!0});var zo=i(mt);v(ga.$$.fragment,zo),yT=c(zo),Xt=r(zo,"P",{});var ti=i(Xt);wT=s(ti,"The "),Nr=r(ti,"A",{href:!0});var by=i(Nr);$T=s(by,"TFT5Model"),by.forEach(t),xT=s(ti," forward method, overrides the "),Kl=r(ti,"CODE",{});var ky=i(Kl);zT=s(ky,"__call__"),ky.forEach(t),jT=s(ti," special method."),ti.forEach(t),qT=c(zo),v(Rn.$$.fragment,zo),ET=c(zo),v(Hn.$$.fragment,zo),zo.forEach(t),Ke.forEach(t),Ac=c(n),Qt=r(n,"H2",{class:!0});var Mp=i(Qt);Vn=r(Mp,"A",{id:!0,class:!0,href:!0});var vy=i(Vn);Yl=r(vy,"SPAN",{});var yy=i(Yl);v(Ta.$$.fragment,yy),yy.forEach(t),vy.forEach(t),FT=c(Mp),Zl=r(Mp,"SPAN",{});var wy=i(Zl);MT=s(wy,"TFT5ForConditionalGeneration"),wy.forEach(t),Mp.forEach(t),Ic=c(n),de=r(n,"DIV",{class:!0});var Ye=i(de);v(ba.$$.fragment,Ye),CT=c(Ye),ka=r(Ye,"P",{});var Cp=i(ka);PT=s(Cp,"T5 Model with a "),Jl=r(Cp,"CODE",{});var $y=i(Jl);NT=s($y,"language modeling"),$y.forEach(t),OT=s(Cp," head on top."),Cp.forEach(t),LT=c(Ye),va=r(Ye,"P",{});var Pp=i(va);AT=s(Pp,"The T5 model was proposed in "),ya=r(Pp,"A",{href:!0,rel:!0});var xy=i(ya);IT=s(xy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),xy.forEach(t),DT=s(Pp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Pp.forEach(t),ST=c(Ye),wa=r(Ye,"P",{});var Np=i(wa);GT=s(Np,"This model inherits from "),Or=r(Np,"A",{href:!0});var zy=i(Or);UT=s(zy,"TFPreTrainedModel"),zy.forEach(t),BT=s(Np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np.forEach(t),WT=c(Ye),$a=r(Ye,"P",{});var Op=i($a);RT=s(Op,"This model is also a "),xa=r(Op,"A",{href:!0,rel:!0});var jy=i(xa);HT=s(jy,"tf.keras.Model"),jy.forEach(t),VT=s(Op,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Op.forEach(t),KT=c(Ye),v(Kn.$$.fragment,Ye),YT=c(Ye),ft=r(Ye,"DIV",{class:!0});var jo=i(ft);v(za.$$.fragment,jo),ZT=c(jo),en=r(jo,"P",{});var ni=i(en);JT=s(ni,"The "),Lr=r(ni,"A",{href:!0});var qy=i(Lr);XT=s(qy,"TFT5ForConditionalGeneration"),qy.forEach(t),QT=s(ni," forward method, overrides the "),Xl=r(ni,"CODE",{});var Ey=i(Xl);eb=s(Ey,"__call__"),Ey.forEach(t),tb=s(ni," special method."),ni.forEach(t),nb=c(jo),v(Yn.$$.fragment,jo),ob=c(jo),v(Zn.$$.fragment,jo),jo.forEach(t),Ye.forEach(t),Dc=c(n),tn=r(n,"H2",{class:!0});var Lp=i(tn);Jn=r(Lp,"A",{id:!0,class:!0,href:!0});var Fy=i(Jn);Ql=r(Fy,"SPAN",{});var My=i(Ql);v(ja.$$.fragment,My),My.forEach(t),Fy.forEach(t),sb=c(Lp),ed=r(Lp,"SPAN",{});var Cy=i(ed);ab=s(Cy,"TFT5EncoderModel"),Cy.forEach(t),Lp.forEach(t),Sc=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);v(qa.$$.fragment,Ze),rb=c(Ze),td=r(Ze,"P",{});var Py=i(td);ib=s(Py,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Py.forEach(t),lb=c(Ze),Ea=r(Ze,"P",{});var Ap=i(Ea);db=s(Ap,"The T5 model was proposed in "),Fa=r(Ap,"A",{href:!0,rel:!0});var Ny=i(Fa);cb=s(Ny,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dp.forEach(t),kb=c(Ze),v(Xn.$$.fragment,Ze),vb=c(Ze),_t=r(Ze,"DIV",{class:!0});var qo=i(_t);v(Na.$$.fragment,qo),yb=c(qo),nn=r(qo,"P",{});var oi=i(nn);wb=s(oi,"The "),Ir=r(oi,"A",{href:!0});var Ay=i(Ir);$b=s(Ay,"TFT5EncoderModel"),Ay.forEach(t),xb=s(oi," forward method, overrides the "),nd=r(oi,"CODE",{});var Iy=i(nd);zb=s(Iy,"__call__"),Iy.forEach(t),jb=s(oi," special method."),oi.forEach(t),qb=c(qo),v(Qn.$$.fragment,qo),Eb=c(qo),v(eo.$$.fragment,qo),qo.forEach(t),Ze.forEach(t),Gc=c(n),on=r(n,"H2",{class:!0});var Sp=i(on);to=r(Sp,"A",{id:!0,class:!0,href:!0});var Dy=i(to);od=r(Dy,"SPAN",{});var Sy=i(od);v(Oa.$$.fragment,Sy),Sy.forEach(t),Dy.forEach(t),Fb=c(Sp),sd=r(Sp,"SPAN",{});var Gy=i(sd);Mb=s(Gy,"FlaxT5Model"),Gy.forEach(t),Sp.forEach(t),Uc=c(n),Je=r(n,"DIV",{class:!0});var Eo=i(Je);v(La.$$.fragment,Eo),Cb=c(Eo),gt=r(Eo,"DIV",{class:!0});var Fo=i(gt);v(Aa.$$.fragment,Fo),Pb=c(Fo),sn=r(Fo,"P",{});var si=i(sn);Nb=s(si,"The "),ad=r(si,"CODE",{});var Uy=i(ad);Ob=s(Uy,"FlaxT5PreTrainedModel"),Uy.forEach(t),Lb=s(si," forward method, overrides the "),rd=r(si,"CODE",{});var By=i(rd);Ab=s(By,"__call__"),By.forEach(t),Ib=s(si," special method."),si.forEach(t),Db=c(Fo),v(no.$$.fragment,Fo),Sb=c(Fo),v(oo.$$.fragment,Fo),Fo.forEach(t),Gb=c(Eo),so=r(Eo,"DIV",{class:!0});var Gp=i(so);v(Ia.$$.fragment,Gp),Ub=c(Gp),v(ao.$$.fragment,Gp),Gp.forEach(t),Bb=c(Eo),ro=r(Eo,"DIV",{class:!0});var Up=i(ro);v(Da.$$.fragment,Up),Wb=c(Up),v(io.$$.fragment,Up),Up.forEach(t),Eo.forEach(t),Bc=c(n),an=r(n,"H2",{class:!0});var Bp=i(an);lo=r(Bp,"A",{id:!0,class:!0,href:!0});var Wy=i(lo);id=r(Wy,"SPAN",{});var Ry=i(id);v(Sa.$$.fragment,Ry),Ry.forEach(t),Wy.forEach(t),Rb=c(Bp),ld=r(Bp,"SPAN",{});var Hy=i(ld);Hb=s(Hy,"FlaxT5ForConditionalGeneration"),Hy.forEach(t),Bp.forEach(t),Wc=c(n),Xe=r(n,"DIV",{class:!0});var Mo=i(Xe);v(Ga.$$.fragment,Mo),Vb=c(Mo),Tt=r(Mo,"DIV",{class:!0});var Co=i(Tt);v(Ua.$$.fragment,Co),Kb=c(Co),rn=r(Co,"P",{});var ai=i(rn);Yb=s(ai,"The "),dd=r(ai,"CODE",{});var Vy=i(dd);Zb=s(Vy,"FlaxT5PreTrainedModel"),Vy.forEach(t),Jb=s(ai," forward method, overrides the "),cd=r(ai,"CODE",{});var Ky=i(cd);Xb=s(Ky,"__call__"),Ky.forEach(t),Qb=s(ai," special method."),ai.forEach(t),ek=c(Co),v(co.$$.fragment,Co),tk=c(Co),v(po.$$.fragment,Co),Co.forEach(t),nk=c(Mo),ho=r(Mo,"DIV",{class:!0});var Wp=i(ho);v(Ba.$$.fragment,Wp),ok=c(Wp),v(uo.$$.fragment,Wp),Wp.forEach(t),sk=c(Mo),mo=r(Mo,"DIV",{class:!0});var Rp=i(mo);v(Wa.$$.fragment,Rp),ak=c(Rp),v(fo.$$.fragment,Rp),Rp.forEach(t),Mo.forEach(t),this.h()},h(){h(p,"name","hf:doc:metadata"),h(p,"content",JSON.stringify(F5)),h(u,"id","t5"),h(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(u,"href","#t5"),h(g,"class","relative group"),h(ee,"id","overview"),h(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ee,"href","#overview"),h(E,"class","relative group"),h(re,"href","https://arxiv.org/pdf/1910.10683.pdf"),h(re,"rel","nofollow"),h(L,"href","#training"),h(Le,"href","#inference"),h(Ae,"href","#scripts"),h(Po,"href","https://huggingface.co/t5-small"),h(Po,"rel","nofollow"),h(No,"href","https://huggingface.co/t5-base"),h(No,"rel","nofollow"),h(Oo,"href","https://huggingface.co/t5-large"),h(Oo,"rel","nofollow"),h(Lo,"href","https://huggingface.co/t5-3b"),h(Lo,"rel","nofollow"),h(Ao,"href","https://huggingface.co/t5-11b"),h(Ao,"rel","nofollow"),h(Ja,"href","t5v1.1"),h(Xa,"href","mt5"),h(Qa,"href","byt5"),h(Io,"href","https://huggingface.co/models?search=t5"),h(Io,"rel","nofollow"),h(Do,"href","https://huggingface.co/thomwolf"),h(Do,"rel","nofollow"),h(So,"href","https://github.com/google-research/text-to-text-transfer-transformer"),h(So,"rel","nofollow"),h(er,"id","training"),h(mn,"id","training"),h(mn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(mn,"href","#training"),h(Ot,"class","relative group"),h(tr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5ForConditionalGeneration"),h(or,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Tokenizer"),h(Bo,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/language-modeling"),h(Bo,"rel","nofollow"),h(Ro,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/summarization"),h(Ro,"rel","nofollow"),h(Ko,"href","https://discuss.huggingface.co/t/t5-finetuning-tips/684"),h(Ko,"rel","nofollow"),h(Yo,"href","https://arxiv.org/pdf/1910.10683.pdf"),h(Yo,"rel","nofollow"),h(dr,"id","inference"),h(Tn,"id","inference"),h(Tn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Tn,"href","#inference"),h(Lt,"class","relative group"),h(cr,"href","/docs/transformers/pr_17881/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(Jo,"href","https://huggingface.co/blog/how-to-generate"),h(Jo,"rel","nofollow"),h(Xo,"href","https://huggingface.co/blog/encoder-decoder#encoder-decoder"),h(Xo,"rel","nofollow"),h(pr,"href","/docs/transformers/pr_17881/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(mr,"id","scripts"),h(bn,"id","performance"),h(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(bn,"href","#performance"),h(At,"class","relative group"),h(os,"href","https://github.com/NVIDIA/apex#quick-start"),h(os,"rel","nofollow"),h(kn,"id","example-scripts"),h(kn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(kn,"href","#example-scripts"),h(It,"class","relative group"),h(as,"href","https://github.com/huggingface/transformers/blob/main/examples/flax/language-modeling/run_t5_mlm_flax.py"),h(as,"rel","nofollow"),h(rs,"href","https://github.com/huggingface/transformers/blob/main/examples/flax/language-modeling/t5_tokenizer_model.py"),h(rs,"rel","nofollow"),h(is,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization"),h(is,"rel","nofollow"),h(ls,"href","https://github.com/huggingface/transformers/tree/main/examples/tensorflow/summarization"),h(ls,"rel","nofollow"),h(ds,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/summarization"),h(ds,"rel","nofollow"),h(cs,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/translation"),h(cs,"rel","nofollow"),h(ps,"href","https://github.com/huggingface/transformers/tree/main/examples/tensorflow/translation"),h(ps,"rel","nofollow"),h(yn,"id","transformers.T5Config"),h(yn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(yn,"href","#transformers.T5Config"),h(St,"class","relative group"),h(_r,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Model"),h(gr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.TFT5Model"),h(ms,"href","https://huggingface.co/t5-small"),h(ms,"rel","nofollow"),h(Tr,"href","/docs/transformers/pr_17881/en/main_classes/configuration#transformers.PretrainedConfig"),h(br,"href","/docs/transformers/pr_17881/en/main_classes/configuration#transformers.PretrainedConfig"),h(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(wn,"id","transformers.T5Tokenizer"),h(wn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(wn,"href","#transformers.T5Tokenizer"),h(Ut,"class","relative group"),h(Ts,"href","https://github.com/google/sentencepiece"),h(Ts,"rel","nofollow"),h(kr,"href","/docs/transformers/pr_17881/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),h(qt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h($n,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(wr,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(zn,"id","transformers.T5TokenizerFast"),h(zn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(zn,"href","#transformers.T5TokenizerFast"),h(Bt,"class","relative group"),h(qs,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),h(qs,"rel","nofollow"),h($r,"href","/docs/transformers/pr_17881/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),h(Et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(jn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(qn,"id","transformers.T5Model"),h(qn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(qn,"href","#transformers.T5Model"),h(Rt,"class","relative group"),h(Ls,"href","https://arxiv.org/abs/1910.10683"),h(Ls,"rel","nofollow"),h(jr,"href","/docs/transformers/pr_17881/en/main_classes/model#transformers.PreTrainedModel"),h(Ds,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ds,"rel","nofollow"),h(qr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5Model"),h(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Pn,"id","transformers.T5ForConditionalGeneration"),h(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Pn,"href","#transformers.T5ForConditionalGeneration"),h(Vt,"class","relative group"),h(Vs,"href","https://arxiv.org/abs/1910.10683"),h(Vs,"rel","nofollow"),h(Er,"href","/docs/transformers/pr_17881/en/main_classes/model#transformers.PreTrainedModel"),h(Zs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Zs,"rel","nofollow"),h(Fr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5ForConditionalGeneration"),h(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(In,"id","transformers.T5EncoderModel"),h(In,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(In,"href","#transformers.T5EncoderModel"),h(Yt,"class","relative group"),h(oa,"href","https://arxiv.org/abs/1910.10683"),h(oa,"rel","nofollow"),h(Mr,"href","/docs/transformers/pr_17881/en/main_classes/model#transformers.PreTrainedModel"),h(ra,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(ra,"rel","nofollow"),h(Cr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.T5EncoderModel"),h(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Bn,"id","transformers.TFT5Model"),h(Bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Bn,"href","#transformers.TFT5Model"),h(Jt,"class","relative group"),h(ua,"href","https://arxiv.org/abs/1910.10683"),h(ua,"rel","nofollow"),h(Pr,"href","/docs/transformers/pr_17881/en/main_classes/model#transformers.TFPreTrainedModel"),h(_a,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(_a,"rel","nofollow"),h(Nr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.TFT5Model"),h(mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Vn,"id","transformers.TFT5ForConditionalGeneration"),h(Vn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Vn,"href","#transformers.TFT5ForConditionalGeneration"),h(Qt,"class","relative group"),h(ya,"href","https://arxiv.org/abs/1910.10683"),h(ya,"rel","nofollow"),h(Or,"href","/docs/transformers/pr_17881/en/main_classes/model#transformers.TFPreTrainedModel"),h(xa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(xa,"rel","nofollow"),h(Lr,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.TFT5ForConditionalGeneration"),h(ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Jn,"id","transformers.TFT5EncoderModel"),h(Jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Jn,"href","#transformers.TFT5EncoderModel"),h(tn,"class","relative group"),h(Fa,"href","https://arxiv.org/abs/1910.10683"),h(Fa,"rel","nofollow"),h(Ar,"href","/docs/transformers/pr_17881/en/main_classes/model#transformers.TFPreTrainedModel"),h(Pa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Pa,"rel","nofollow"),h(Ir,"href","/docs/transformers/pr_17881/en/model_doc/t5#transformers.TFT5EncoderModel"),h(_t,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(to,"id","transformers.FlaxT5Model"),h(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(to,"href","#transformers.FlaxT5Model"),h(on,"class","relative group"),h(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(so,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ro,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(lo,"id","transformers.FlaxT5ForConditionalGeneration"),h(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(lo,"href","#transformers.FlaxT5ForConditionalGeneration"),h(an,"class","relative group"),h(Tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(mo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,f){e(document.head,p),m(n,b,f),m(n,g,f),e(g,u),e(u,T),y(l,T,null),e(g,_),e(g,q),e(q,qe),m(n,se,f),m(n,E,f),e(E,ee),e(ee,G),y(ae,G,null),e(E,Ee),e(E,U),e(U,Fe),m(n,ve,f),m(n,B,f),e(B,A),e(B,re),e(re,pe),e(B,M),m(n,N,f),m(n,he,f),e(he,K),m(n,ye,f),m(n,ue,f),e(ue,W),e(W,Me),m(n,we,f),m(n,P,f),e(P,Ce),m(n,H,f),m(n,V,f),e(V,Te),e(Te,O),e(O,Pe),e(O,be),e(be,I),e(O,Ne),e(O,R),e(R,Oe),e(O,z),e(V,F),e(V,te),e(te,Ge),e(Ge,et),e(V,D),e(V,Ue),e(Ue,ne),e(ne,tt),e(ne,L),e(L,Y),e(ne,nt),e(ne,Le),e(Le,Z),e(ne,ot),e(ne,Ae),e(Ae,Ie),e(ne,st),m(n,Ld,f),m(n,Ka,f),e(Ka,Hp),m(n,Ad,f),m(n,Be,f),e(Be,ri),e(ri,ii),e(ii,Po),e(Po,Vp),e(Be,Kp),e(Be,li),e(li,di),e(di,No),e(No,Yp),e(Be,Zp),e(Be,ci),e(ci,pi),e(pi,Oo),e(Oo,Jp),e(Be,Xp),e(Be,hi),e(hi,ui),e(ui,Lo),e(Lo,Qp),e(Be,eh),e(Be,mi),e(mi,Ya),e(Ya,Ao),e(Ao,th),e(Ya,nh),m(n,Id,f),m(n,Za,f),e(Za,oh),m(n,Dd,f),m(n,$t,f),e($t,fi),e(fi,cn),e(cn,_i),e(_i,sh),e(cn,ah),e(cn,Ja),e(Ja,rh),e(cn,ih),e($t,lh),e($t,gi),e(gi,pn),e(pn,Ti),e(Ti,dh),e(pn,ch),e(pn,Xa),e(Xa,ph),e(pn,hh),e($t,uh),e($t,bi),e(bi,hn),e(hn,ki),e(ki,mh),e(hn,fh),e(hn,Qa),e(Qa,_h),e(hn,gh),m(n,Sd,f),m(n,un,f),e(un,Th),e(un,Io),e(Io,bh),e(un,kh),m(n,Gd,f),m(n,xt,f),e(xt,vh),e(xt,Do),e(Do,yh),e(xt,wh),e(xt,So),e(So,$h),e(xt,xh),m(n,Ud,f),m(n,er,f),m(n,Bd,f),m(n,Ot,f),e(Ot,mn),e(mn,vi),y(Go,vi,null),e(Ot,zh),e(Ot,yi),e(yi,jh),m(n,Wd,f),m(n,at,f),e(at,qh),e(at,wi),e(wi,Eh),e(at,Fh),e(at,$i),e($i,Mh),e(at,Ch),e(at,xi),e(xi,Ph),e(at,Nh),m(n,Rd,f),m(n,fn,f),e(fn,Oh),e(fn,tr),e(tr,Lh),e(fn,Ah),m(n,Hd,f),m(n,nr,f),e(nr,zi),e(zi,Ih),m(n,Vd,f),m(n,me,f),e(me,Dh),e(me,ji),e(ji,Sh),e(me,Gh),e(me,qi),e(qi,Uh),e(me,Bh),e(me,Ei),e(Ei,Wh),e(me,Rh),e(me,Fi),e(Fi,Hh),e(me,Vh),e(me,Mi),e(Mi,Kh),e(me,Yh),e(me,or),e(or,Zh),e(me,Jh),m(n,Kd,f),m(n,sr,f),e(sr,Xh),m(n,Yd,f),y(Uo,n,f),m(n,Zd,f),m(n,_n,f),e(_n,Qh),e(_n,Bo),e(Bo,eu),e(_n,tu),m(n,Jd,f),m(n,ar,f),e(ar,Ci),e(Ci,nu),m(n,Xd,f),m(n,rr,f),e(rr,ou),m(n,Qd,f),y(Wo,n,f),m(n,ec,f),m(n,oe,f),e(oe,su),e(oe,Pi),e(Pi,au),e(oe,ru),e(oe,Ni),e(Ni,iu),e(oe,lu),e(oe,Oi),e(Oi,du),e(oe,cu),e(oe,Li),e(Li,pu),e(oe,hu),e(oe,Ai),e(Ai,uu),e(oe,mu),e(oe,Ii),e(Ii,fu),e(oe,_u),e(oe,Di),e(Di,gu),e(oe,Tu),m(n,tc,f),m(n,zt,f),e(zt,bu),e(zt,Si),e(Si,ku),e(zt,vu),e(zt,Gi),e(Gi,yu),e(zt,wu),m(n,nc,f),m(n,fe,f),e(fe,$u),e(fe,Ui),e(Ui,xu),e(fe,zu),e(fe,Bi),e(Bi,ju),e(fe,qu),e(fe,Wi),e(Wi,Eu),e(fe,Fu),e(fe,Ri),e(Ri,Mu),e(fe,Cu),e(fe,Ro),e(Ro,Pu),e(fe,Nu),e(fe,Hi),e(Hi,Ou),e(fe,Lu),m(n,oc,f),y(Ho,n,f),m(n,sc,f),m(n,ir,f),e(ir,Au),m(n,ac,f),m(n,lr,f),e(lr,Vo),e(Vo,Iu),e(Vo,Vi),e(Vi,Du),e(Vo,Su),m(n,rc,f),m(n,jt,f),e(jt,Gu),e(jt,Ko),e(Ko,Uu),e(jt,Bu),e(jt,Yo),e(Yo,Wu),e(jt,Ru),m(n,ic,f),m(n,gn,f),e(gn,Hu),e(gn,Ki),e(Ki,Vu),e(gn,Ku),m(n,lc,f),m(n,dr,f),m(n,dc,f),m(n,Lt,f),e(Lt,Tn),e(Tn,Yi),y(Zo,Yi,null),e(Lt,Yu),e(Lt,Zi),e(Zi,Zu),m(n,cc,f),m(n,rt,f),e(rt,Ju),e(rt,cr),e(cr,Xu),e(rt,Qu),e(rt,Jo),e(Jo,em),e(rt,tm),e(rt,Xo),e(Xo,nm),e(rt,om),m(n,pc,f),y(Qo,n,f),m(n,hc,f),m(n,We,f),e(We,sm),e(We,Ji),e(Ji,am),e(We,rm),e(We,Xi),e(Xi,im),e(We,lm),e(We,pr),e(pr,dm),e(We,cm),e(We,Qi),e(Qi,pm),e(We,hm),m(n,uc,f),m(n,hr,f),e(hr,um),m(n,mc,f),y(es,n,f),m(n,fc,f),m(n,ur,f),e(ur,mm),m(n,_c,f),y(ts,n,f),m(n,gc,f),m(n,mr,f),m(n,Tc,f),m(n,At,f),e(At,bn),e(bn,el),y(ns,el,null),e(At,fm),e(At,tl),e(tl,_m),m(n,bc,f),m(n,it,f),e(it,gm),e(it,os),e(os,Tm),e(it,bm),e(it,nl),e(nl,km),e(it,vm),e(it,ol),e(ol,ym),e(it,wm),m(n,kc,f),m(n,It,f),e(It,kn),e(kn,sl),y(ss,sl,null),e(It,$m),e(It,al),e(al,xm),m(n,vc,f),m(n,fr,f),e(fr,zm),m(n,yc,f),m(n,vn,f),e(vn,rl),e(rl,Dt),e(Dt,jm),e(Dt,as),e(as,qm),e(Dt,Em),e(Dt,rs),e(rs,Fm),e(Dt,Mm),e(vn,Cm),e(vn,il),e(il,De),e(De,Pm),e(De,is),e(is,Nm),e(De,Om),e(De,ls),e(ls,Lm),e(De,Am),e(De,ds),e(ds,Im),e(De,Dm),e(De,cs),e(cs,Sm),e(De,Gm),e(De,ps),e(ps,Um),e(De,Bm),m(n,wc,f),m(n,St,f),e(St,yn),e(yn,ll),y(hs,ll,null),e(St,Wm),e(St,dl),e(dl,Rm),m(n,$c,f),m(n,kt,f),y(us,kt,null),e(kt,Hm),e(kt,vt),e(vt,Vm),e(vt,_r),e(_r,Km),e(vt,Ym),e(vt,gr),e(gr,Zm),e(vt,Jm),e(vt,ms),e(ms,Xm),e(vt,Qm),e(kt,ef),e(kt,Gt),e(Gt,tf),e(Gt,Tr),e(Tr,nf),e(Gt,of),e(Gt,br),e(br,sf),e(Gt,af),m(n,xc,f),m(n,Ut,f),e(Ut,wn),e(wn,cl),y(fs,cl,null),e(Ut,rf),e(Ut,pl),e(pl,lf),m(n,zc,f),m(n,ie,f),y(_s,ie,null),e(ie,df),e(ie,gs),e(gs,cf),e(gs,Ts),e(Ts,pf),e(gs,hf),e(ie,uf),e(ie,bs),e(bs,mf),e(bs,kr),e(kr,ff),e(bs,_f),e(ie,gf),e(ie,qt),y(ks,qt,null),e(qt,Tf),e(qt,hl),e(hl,bf),e(qt,kf),e(qt,vs),e(vs,vr),e(vr,vf),e(vr,ul),e(ul,yf),e(vs,wf),e(vs,yr),e(yr,$f),e(yr,ml),e(ml,xf),e(ie,zf),e(ie,$n),y(ys,$n,null),e($n,jf),e($n,ws),e(ws,qf),e(ws,fl),e(fl,Ef),e(ws,Ff),e(ie,Mf),e(ie,xn),y($s,xn,null),e(xn,Cf),e(xn,_l),e(_l,Pf),e(ie,Nf),e(ie,wr),y(xs,wr,null),m(n,jc,f),m(n,Bt,f),e(Bt,zn),e(zn,gl),y(zs,gl,null),e(Bt,Of),e(Bt,Tl),e(Tl,Lf),m(n,qc,f),m(n,Se,f),y(js,Se,null),e(Se,Af),e(Se,Wt),e(Wt,If),e(Wt,bl),e(bl,Df),e(Wt,Sf),e(Wt,qs),e(qs,Gf),e(Wt,Uf),e(Se,Bf),e(Se,Es),e(Es,Wf),e(Es,$r),e($r,Rf),e(Es,Hf),e(Se,Vf),e(Se,Et),y(Fs,Et,null),e(Et,Kf),e(Et,kl),e(kl,Yf),e(Et,Zf),e(Et,Ms),e(Ms,xr),e(xr,Jf),e(xr,vl),e(vl,Xf),e(Ms,Qf),e(Ms,zr),e(zr,e_),e(zr,yl),e(yl,t_),e(Se,n_),e(Se,jn),y(Cs,jn,null),e(jn,o_),e(jn,wl),e(wl,s_),m(n,Ec,f),m(n,Rt,f),e(Rt,qn),e(qn,$l),y(Ps,$l,null),e(Rt,a_),e(Rt,xl),e(xl,r_),m(n,Fc,f),m(n,J,f),y(Ns,J,null),e(J,i_),e(J,zl),e(zl,l_),e(J,d_),e(J,Os),e(Os,c_),e(Os,Ls),e(Ls,p_),e(Os,h_),e(J,u_),e(J,As),e(As,m_),e(As,jr),e(jr,f_),e(As,__),e(J,g_),e(J,Is),e(Is,T_),e(Is,Ds),e(Ds,b_),e(Is,k_),e(J,v_),e(J,lt),y(Ss,lt,null),e(lt,y_),e(lt,Ht),e(Ht,w_),e(Ht,qr),e(qr,$_),e(Ht,x_),e(Ht,jl),e(jl,z_),e(Ht,j_),e(lt,q_),y(En,lt,null),e(lt,E_),y(Fn,lt,null),e(J,F_),e(J,dt),y(Gs,dt,null),e(dt,M_),e(dt,ql),e(ql,C_),e(dt,P_),e(dt,El),e(El,N_),e(dt,O_),y(Mn,dt,null),e(J,L_),e(J,Ft),y(Us,Ft,null),e(Ft,A_),e(Ft,Fl),e(Fl,I_),e(Ft,D_),y(Cn,Ft,null),m(n,Mc,f),m(n,Vt,f),e(Vt,Pn),e(Pn,Ml),y(Bs,Ml,null),e(Vt,S_),e(Vt,Cl),e(Cl,G_),m(n,Cc,f),m(n,X,f),y(Ws,X,null),e(X,U_),e(X,Rs),e(Rs,B_),e(Rs,Pl),e(Pl,W_),e(Rs,R_),e(X,H_),e(X,Hs),e(Hs,V_),e(Hs,Vs),e(Vs,K_),e(Hs,Y_),e(X,Z_),e(X,Ks),e(Ks,J_),e(Ks,Er),e(Er,X_),e(Ks,Q_),e(X,eg),e(X,Ys),e(Ys,tg),e(Ys,Zs),e(Zs,ng),e(Ys,og),e(X,sg),e(X,ct),y(Js,ct,null),e(ct,ag),e(ct,Kt),e(Kt,rg),e(Kt,Fr),e(Fr,ig),e(Kt,lg),e(Kt,Nl),e(Nl,dg),e(Kt,cg),e(ct,pg),y(Nn,ct,null),e(ct,hg),y(On,ct,null),e(X,ug),e(X,pt),y(Xs,pt,null),e(pt,mg),e(pt,Ol),e(Ol,fg),e(pt,_g),e(pt,Ll),e(Ll,gg),e(pt,Tg),y(Ln,pt,null),e(X,bg),e(X,Mt),y(Qs,Mt,null),e(Mt,kg),e(Mt,Al),e(Al,vg),e(Mt,yg),y(An,Mt,null),m(n,Pc,f),m(n,Yt,f),e(Yt,In),e(In,Il),y(ea,Il,null),e(Yt,wg),e(Yt,Dl),e(Dl,$g),m(n,Nc,f),m(n,Q,f),y(ta,Q,null),e(Q,xg),e(Q,Sl),e(Sl,zg),e(Q,jg),e(Q,na),e(na,qg),e(na,oa),e(oa,Eg),e(na,Fg),e(Q,Mg),e(Q,sa),e(sa,Cg),e(sa,Mr),e(Mr,Pg),e(sa,Ng),e(Q,Og),e(Q,aa),e(aa,Lg),e(aa,ra),e(ra,Ag),e(aa,Ig),e(Q,Dg),e(Q,ht),y(ia,ht,null),e(ht,Sg),e(ht,Zt),e(Zt,Gg),e(Zt,Cr),e(Cr,Ug),e(Zt,Bg),e(Zt,Gl),e(Gl,Wg),e(Zt,Rg),e(ht,Hg),y(Dn,ht,null),e(ht,Vg),y(Sn,ht,null),e(Q,Kg),e(Q,ut),y(la,ut,null),e(ut,Yg),e(ut,Ul),e(Ul,Zg),e(ut,Jg),e(ut,Bl),e(Bl,Xg),e(ut,Qg),y(Gn,ut,null),e(Q,eT),e(Q,Ct),y(da,Ct,null),e(Ct,tT),e(Ct,Wl),e(Wl,nT),e(Ct,oT),y(Un,Ct,null),m(n,Oc,f),m(n,Jt,f),e(Jt,Bn),e(Bn,Rl),y(ca,Rl,null),e(Jt,sT),e(Jt,Hl),e(Hl,aT),m(n,Lc,f),m(n,le,f),y(pa,le,null),e(le,rT),e(le,Vl),e(Vl,iT),e(le,lT),e(le,ha),e(ha,dT),e(ha,ua),e(ua,cT),e(ha,pT),e(le,hT),e(le,ma),e(ma,uT),e(ma,Pr),e(Pr,mT),e(ma,fT),e(le,_T),e(le,fa),e(fa,gT),e(fa,_a),e(_a,TT),e(fa,bT),e(le,kT),y(Wn,le,null),e(le,vT),e(le,mt),y(ga,mt,null),e(mt,yT),e(mt,Xt),e(Xt,wT),e(Xt,Nr),e(Nr,$T),e(Xt,xT),e(Xt,Kl),e(Kl,zT),e(Xt,jT),e(mt,qT),y(Rn,mt,null),e(mt,ET),y(Hn,mt,null),m(n,Ac,f),m(n,Qt,f),e(Qt,Vn),e(Vn,Yl),y(Ta,Yl,null),e(Qt,FT),e(Qt,Zl),e(Zl,MT),m(n,Ic,f),m(n,de,f),y(ba,de,null),e(de,CT),e(de,ka),e(ka,PT),e(ka,Jl),e(Jl,NT),e(ka,OT),e(de,LT),e(de,va),e(va,AT),e(va,ya),e(ya,IT),e(va,DT),e(de,ST),e(de,wa),e(wa,GT),e(wa,Or),e(Or,UT),e(wa,BT),e(de,WT),e(de,$a),e($a,RT),e($a,xa),e(xa,HT),e($a,VT),e(de,KT),y(Kn,de,null),e(de,YT),e(de,ft),y(za,ft,null),e(ft,ZT),e(ft,en),e(en,JT),e(en,Lr),e(Lr,XT),e(en,QT),e(en,Xl),e(Xl,eb),e(en,tb),e(ft,nb),y(Yn,ft,null),e(ft,ob),y(Zn,ft,null),m(n,Dc,f),m(n,tn,f),e(tn,Jn),e(Jn,Ql),y(ja,Ql,null),e(tn,sb),e(tn,ed),e(ed,ab),m(n,Sc,f),m(n,ce,f),y(qa,ce,null),e(ce,rb),e(ce,td),e(td,ib),e(ce,lb),e(ce,Ea),e(Ea,db),e(Ea,Fa),e(Fa,cb),e(Ea,pb),e(ce,hb),e(ce,Ma),e(Ma,ub),e(Ma,Ar),e(Ar,mb),e(Ma,fb),e(ce,_b),e(ce,Ca),e(Ca,gb),e(Ca,Pa),e(Pa,Tb),e(Ca,bb),e(ce,kb),y(Xn,ce,null),e(ce,vb),e(ce,_t),y(Na,_t,null),e(_t,yb),e(_t,nn),e(nn,wb),e(nn,Ir),e(Ir,$b),e(nn,xb),e(nn,nd),e(nd,zb),e(nn,jb),e(_t,qb),y(Qn,_t,null),e(_t,Eb),y(eo,_t,null),m(n,Gc,f),m(n,on,f),e(on,to),e(to,od),y(Oa,od,null),e(on,Fb),e(on,sd),e(sd,Mb),m(n,Uc,f),m(n,Je,f),y(La,Je,null),e(Je,Cb),e(Je,gt),y(Aa,gt,null),e(gt,Pb),e(gt,sn),e(sn,Nb),e(sn,ad),e(ad,Ob),e(sn,Lb),e(sn,rd),e(rd,Ab),e(sn,Ib),e(gt,Db),y(no,gt,null),e(gt,Sb),y(oo,gt,null),e(Je,Gb),e(Je,so),y(Ia,so,null),e(so,Ub),y(ao,so,null),e(Je,Bb),e(Je,ro),y(Da,ro,null),e(ro,Wb),y(io,ro,null),m(n,Bc,f),m(n,an,f),e(an,lo),e(lo,id),y(Sa,id,null),e(an,Rb),e(an,ld),e(ld,Hb),m(n,Wc,f),m(n,Xe,f),y(Ga,Xe,null),e(Xe,Vb),e(Xe,Tt),y(Ua,Tt,null),e(Tt,Kb),e(Tt,rn),e(rn,Yb),e(rn,dd),e(dd,Zb),e(rn,Jb),e(rn,cd),e(cd,Xb),e(rn,Qb),e(Tt,ek),y(co,Tt,null),e(Tt,tk),y(po,Tt,null),e(Xe,nk),e(Xe,ho),y(Ba,ho,null),e(ho,ok),y(uo,ho,null),e(Xe,sk),e(Xe,mo),y(Wa,mo,null),e(mo,ak),y(fo,mo,null),Rc=!0},p(n,[f]){const Ra={};f&2&&(Ra.$$scope={dirty:f,ctx:n}),En.$set(Ra);const pd={};f&2&&(pd.$$scope={dirty:f,ctx:n}),Fn.$set(pd);const hd={};f&2&&(hd.$$scope={dirty:f,ctx:n}),Mn.$set(hd);const ud={};f&2&&(ud.$$scope={dirty:f,ctx:n}),Cn.$set(ud);const Ha={};f&2&&(Ha.$$scope={dirty:f,ctx:n}),Nn.$set(Ha);const md={};f&2&&(md.$$scope={dirty:f,ctx:n}),On.$set(md);const fd={};f&2&&(fd.$$scope={dirty:f,ctx:n}),Ln.$set(fd);const _d={};f&2&&(_d.$$scope={dirty:f,ctx:n}),An.$set(_d);const Va={};f&2&&(Va.$$scope={dirty:f,ctx:n}),Dn.$set(Va);const gd={};f&2&&(gd.$$scope={dirty:f,ctx:n}),Sn.$set(gd);const Td={};f&2&&(Td.$$scope={dirty:f,ctx:n}),Gn.$set(Td);const bd={};f&2&&(bd.$$scope={dirty:f,ctx:n}),Un.$set(bd);const kd={};f&2&&(kd.$$scope={dirty:f,ctx:n}),Wn.$set(kd);const vd={};f&2&&(vd.$$scope={dirty:f,ctx:n}),Rn.$set(vd);const ln={};f&2&&(ln.$$scope={dirty:f,ctx:n}),Hn.$set(ln);const yd={};f&2&&(yd.$$scope={dirty:f,ctx:n}),Kn.$set(yd);const dn={};f&2&&(dn.$$scope={dirty:f,ctx:n}),Yn.$set(dn);const wd={};f&2&&(wd.$$scope={dirty:f,ctx:n}),Zn.$set(wd);const $d={};f&2&&($d.$$scope={dirty:f,ctx:n}),Xn.$set($d);const xd={};f&2&&(xd.$$scope={dirty:f,ctx:n}),Qn.$set(xd);const zd={};f&2&&(zd.$$scope={dirty:f,ctx:n}),eo.$set(zd);const jd={};f&2&&(jd.$$scope={dirty:f,ctx:n}),no.$set(jd);const yt={};f&2&&(yt.$$scope={dirty:f,ctx:n}),oo.$set(yt);const qd={};f&2&&(qd.$$scope={dirty:f,ctx:n}),ao.$set(qd);const Ed={};f&2&&(Ed.$$scope={dirty:f,ctx:n}),io.$set(Ed);const Fd={};f&2&&(Fd.$$scope={dirty:f,ctx:n}),co.$set(Fd);const Md={};f&2&&(Md.$$scope={dirty:f,ctx:n}),po.$set(Md);const Qe={};f&2&&(Qe.$$scope={dirty:f,ctx:n}),uo.$set(Qe);const Cd={};f&2&&(Cd.$$scope={dirty:f,ctx:n}),fo.$set(Cd)},i(n){Rc||(w(l.$$.fragment,n),w(ae.$$.fragment,n),w(Go.$$.fragment,n),w(Uo.$$.fragment,n),w(Wo.$$.fragment,n),w(Ho.$$.fragment,n),w(Zo.$$.fragment,n),w(Qo.$$.fragment,n),w(es.$$.fragment,n),w(ts.$$.fragment,n),w(ns.$$.fragment,n),w(ss.$$.fragment,n),w(hs.$$.fragment,n),w(us.$$.fragment,n),w(fs.$$.fragment,n),w(_s.$$.fragment,n),w(ks.$$.fragment,n),w(ys.$$.fragment,n),w($s.$$.fragment,n),w(xs.$$.fragment,n),w(zs.$$.fragment,n),w(js.$$.fragment,n),w(Fs.$$.fragment,n),w(Cs.$$.fragment,n),w(Ps.$$.fragment,n),w(Ns.$$.fragment,n),w(Ss.$$.fragment,n),w(En.$$.fragment,n),w(Fn.$$.fragment,n),w(Gs.$$.fragment,n),w(Mn.$$.fragment,n),w(Us.$$.fragment,n),w(Cn.$$.fragment,n),w(Bs.$$.fragment,n),w(Ws.$$.fragment,n),w(Js.$$.fragment,n),w(Nn.$$.fragment,n),w(On.$$.fragment,n),w(Xs.$$.fragment,n),w(Ln.$$.fragment,n),w(Qs.$$.fragment,n),w(An.$$.fragment,n),w(ea.$$.fragment,n),w(ta.$$.fragment,n),w(ia.$$.fragment,n),w(Dn.$$.fragment,n),w(Sn.$$.fragment,n),w(la.$$.fragment,n),w(Gn.$$.fragment,n),w(da.$$.fragment,n),w(Un.$$.fragment,n),w(ca.$$.fragment,n),w(pa.$$.fragment,n),w(Wn.$$.fragment,n),w(ga.$$.fragment,n),w(Rn.$$.fragment,n),w(Hn.$$.fragment,n),w(Ta.$$.fragment,n),w(ba.$$.fragment,n),w(Kn.$$.fragment,n),w(za.$$.fragment,n),w(Yn.$$.fragment,n),w(Zn.$$.fragment,n),w(ja.$$.fragment,n),w(qa.$$.fragment,n),w(Xn.$$.fragment,n),w(Na.$$.fragment,n),w(Qn.$$.fragment,n),w(eo.$$.fragment,n),w(Oa.$$.fragment,n),w(La.$$.fragment,n),w(Aa.$$.fragment,n),w(no.$$.fragment,n),w(oo.$$.fragment,n),w(Ia.$$.fragment,n),w(ao.$$.fragment,n),w(Da.$$.fragment,n),w(io.$$.fragment,n),w(Sa.$$.fragment,n),w(Ga.$$.fragment,n),w(Ua.$$.fragment,n),w(co.$$.fragment,n),w(po.$$.fragment,n),w(Ba.$$.fragment,n),w(uo.$$.fragment,n),w(Wa.$$.fragment,n),w(fo.$$.fragment,n),Rc=!0)},o(n){$(l.$$.fragment,n),$(ae.$$.fragment,n),$(Go.$$.fragment,n),$(Uo.$$.fragment,n),$(Wo.$$.fragment,n),$(Ho.$$.fragment,n),$(Zo.$$.fragment,n),$(Qo.$$.fragment,n),$(es.$$.fragment,n),$(ts.$$.fragment,n),$(ns.$$.fragment,n),$(ss.$$.fragment,n),$(hs.$$.fragment,n),$(us.$$.fragment,n),$(fs.$$.fragment,n),$(_s.$$.fragment,n),$(ks.$$.fragment,n),$(ys.$$.fragment,n),$($s.$$.fragment,n),$(xs.$$.fragment,n),$(zs.$$.fragment,n),$(js.$$.fragment,n),$(Fs.$$.fragment,n),$(Cs.$$.fragment,n),$(Ps.$$.fragment,n),$(Ns.$$.fragment,n),$(Ss.$$.fragment,n),$(En.$$.fragment,n),$(Fn.$$.fragment,n),$(Gs.$$.fragment,n),$(Mn.$$.fragment,n),$(Us.$$.fragment,n),$(Cn.$$.fragment,n),$(Bs.$$.fragment,n),$(Ws.$$.fragment,n),$(Js.$$.fragment,n),$(Nn.$$.fragment,n),$(On.$$.fragment,n),$(Xs.$$.fragment,n),$(Ln.$$.fragment,n),$(Qs.$$.fragment,n),$(An.$$.fragment,n),$(ea.$$.fragment,n),$(ta.$$.fragment,n),$(ia.$$.fragment,n),$(Dn.$$.fragment,n),$(Sn.$$.fragment,n),$(la.$$.fragment,n),$(Gn.$$.fragment,n),$(da.$$.fragment,n),$(Un.$$.fragment,n),$(ca.$$.fragment,n),$(pa.$$.fragment,n),$(Wn.$$.fragment,n),$(ga.$$.fragment,n),$(Rn.$$.fragment,n),$(Hn.$$.fragment,n),$(Ta.$$.fragment,n),$(ba.$$.fragment,n),$(Kn.$$.fragment,n),$(za.$$.fragment,n),$(Yn.$$.fragment,n),$(Zn.$$.fragment,n),$(ja.$$.fragment,n),$(qa.$$.fragment,n),$(Xn.$$.fragment,n),$(Na.$$.fragment,n),$(Qn.$$.fragment,n),$(eo.$$.fragment,n),$(Oa.$$.fragment,n),$(La.$$.fragment,n),$(Aa.$$.fragment,n),$(no.$$.fragment,n),$(oo.$$.fragment,n),$(Ia.$$.fragment,n),$(ao.$$.fragment,n),$(Da.$$.fragment,n),$(io.$$.fragment,n),$(Sa.$$.fragment,n),$(Ga.$$.fragment,n),$(Ua.$$.fragment,n),$(co.$$.fragment,n),$(po.$$.fragment,n),$(Ba.$$.fragment,n),$(uo.$$.fragment,n),$(Wa.$$.fragment,n),$(fo.$$.fragment,n),Rc=!1},d(n){t(p),n&&t(b),n&&t(g),x(l),n&&t(se),n&&t(E),x(ae),n&&t(ve),n&&t(B),n&&t(N),n&&t(he),n&&t(ye),n&&t(ue),n&&t(we),n&&t(P),n&&t(H),n&&t(V),n&&t(Ld),n&&t(Ka),n&&t(Ad),n&&t(Be),n&&t(Id),n&&t(Za),n&&t(Dd),n&&t($t),n&&t(Sd),n&&t(un),n&&t(Gd),n&&t(xt),n&&t(Ud),n&&t(er),n&&t(Bd),n&&t(Ot),x(Go),n&&t(Wd),n&&t(at),n&&t(Rd),n&&t(fn),n&&t(Hd),n&&t(nr),n&&t(Vd),n&&t(me),n&&t(Kd),n&&t(sr),n&&t(Yd),x(Uo,n),n&&t(Zd),n&&t(_n),n&&t(Jd),n&&t(ar),n&&t(Xd),n&&t(rr),n&&t(Qd),x(Wo,n),n&&t(ec),n&&t(oe),n&&t(tc),n&&t(zt),n&&t(nc),n&&t(fe),n&&t(oc),x(Ho,n),n&&t(sc),n&&t(ir),n&&t(ac),n&&t(lr),n&&t(rc),n&&t(jt),n&&t(ic),n&&t(gn),n&&t(lc),n&&t(dr),n&&t(dc),n&&t(Lt),x(Zo),n&&t(cc),n&&t(rt),n&&t(pc),x(Qo,n),n&&t(hc),n&&t(We),n&&t(uc),n&&t(hr),n&&t(mc),x(es,n),n&&t(fc),n&&t(ur),n&&t(_c),x(ts,n),n&&t(gc),n&&t(mr),n&&t(Tc),n&&t(At),x(ns),n&&t(bc),n&&t(it),n&&t(kc),n&&t(It),x(ss),n&&t(vc),n&&t(fr),n&&t(yc),n&&t(vn),n&&t(wc),n&&t(St),x(hs),n&&t($c),n&&t(kt),x(us),n&&t(xc),n&&t(Ut),x(fs),n&&t(zc),n&&t(ie),x(_s),x(ks),x(ys),x($s),x(xs),n&&t(jc),n&&t(Bt),x(zs),n&&t(qc),n&&t(Se),x(js),x(Fs),x(Cs),n&&t(Ec),n&&t(Rt),x(Ps),n&&t(Fc),n&&t(J),x(Ns),x(Ss),x(En),x(Fn),x(Gs),x(Mn),x(Us),x(Cn),n&&t(Mc),n&&t(Vt),x(Bs),n&&t(Cc),n&&t(X),x(Ws),x(Js),x(Nn),x(On),x(Xs),x(Ln),x(Qs),x(An),n&&t(Pc),n&&t(Yt),x(ea),n&&t(Nc),n&&t(Q),x(ta),x(ia),x(Dn),x(Sn),x(la),x(Gn),x(da),x(Un),n&&t(Oc),n&&t(Jt),x(ca),n&&t(Lc),n&&t(le),x(pa),x(Wn),x(ga),x(Rn),x(Hn),n&&t(Ac),n&&t(Qt),x(Ta),n&&t(Ic),n&&t(de),x(ba),x(Kn),x(za),x(Yn),x(Zn),n&&t(Dc),n&&t(tn),x(ja),n&&t(Sc),n&&t(ce),x(qa),x(Xn),x(Na),x(Qn),x(eo),n&&t(Gc),n&&t(on),x(Oa),n&&t(Uc),n&&t(Je),x(La),x(Aa),x(no),x(oo),x(Ia),x(ao),x(Da),x(io),n&&t(Bc),n&&t(an),x(Sa),n&&t(Wc),n&&t(Xe),x(Ga),x(Ua),x(co),x(po),x(Ba),x(uo),x(Wa),x(fo)}}}const F5={local:"t5",sections:[{local:"overview",title:"Overview"},{local:"training",title:"Training"},{local:"inference",title:"Inference"},{local:"performance",title:"Performance"},{local:"example-scripts",title:"Example scripts"},{local:"transformers.T5Config",title:"T5Config"},{local:"transformers.T5Tokenizer",title:"T5Tokenizer"},{local:"transformers.T5TokenizerFast",title:"T5TokenizerFast"},{local:"transformers.T5Model",title:"T5Model"},{local:"transformers.T5ForConditionalGeneration",title:"T5ForConditionalGeneration"},{local:"transformers.T5EncoderModel",title:"T5EncoderModel"},{local:"transformers.TFT5Model",title:"TFT5Model"},{local:"transformers.TFT5ForConditionalGeneration",title:"TFT5ForConditionalGeneration"},{local:"transformers.TFT5EncoderModel",title:"TFT5EncoderModel"},{local:"transformers.FlaxT5Model",title:"FlaxT5Model"},{local:"transformers.FlaxT5ForConditionalGeneration",title:"FlaxT5ForConditionalGeneration"}],title:"T5"};function M5(j){return Qy(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class I5 extends Yy{constructor(p){super();Zy(this,p,M5,E5,Jy,{})}}export{I5 as default,F5 as metadata};
