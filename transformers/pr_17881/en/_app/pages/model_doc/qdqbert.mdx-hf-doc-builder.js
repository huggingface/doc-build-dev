import{S as wu,i as vu,s as $u,e as r,k as p,w as Q,t as n,M as Tu,c as a,d as o,m as h,a as i,x as w,h as s,b as f,G as e,g as b,y as v,q as $,o as T,B as y,v as yu,L as I}from"../../chunks/vendor-hf-doc-builder.js";import{T as xt}from"../../chunks/Tip-hf-doc-builder.js";import{D as F}from"../../chunks/Docstring-hf-doc-builder.js";import{C as M}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as J}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as S}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function qu(q){let d,_,c,u,k;return u=new M({props:{code:`from transformers import QDQBertModel, QDQBertConfig
...
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:I,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Eu(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:I,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Au(q){let d,_,c,u,k;return u=new M({props:{code:`import torch
from transformers import BertTokenizer, QDQBertForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:I,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Nu(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=r("p"),_=n("Example:"),c=p(),Q(u.$$.fragment)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(o),c=h(l),w(u.$$.fragment,l)},m(l,m){b(l,d,m),e(d,_),b(l,c,m),v(u,l,m),k=!0},p:I,i(l){k||($(u.$$.fragment,l),k=!0)},o(l){T(u.$$.fragment,l),k=!1},d(l){l&&o(d),l&&o(c),y(u,l)}}}function Ru(q){let d,_;return d=new M({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:I,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Uu(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=r("p"),_=n("Example:"),c=p(),Q(u.$$.fragment)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(o),c=h(l),w(u.$$.fragment,l)},m(l,m){b(l,d,m),e(d,_),b(l,c,m),v(u,l,m),k=!0},p:I,i(l){k||($(u.$$.fragment,l),k=!0)},o(l){T(u.$$.fragment,l),k=!1},d(l){l&&o(d),l&&o(c),y(u,l)}}}function Xu(q){let d,_;return d=new M({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:I,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Ju(q){let d,_,c,u,k,l,m,D,Da,dr,fe,Ne,Nn,Ft,za,On,Ba,cr,Oe,Ma,jt,xa,Fa,pr,tn,ja,hr,on,Sn,Ea,ur,nn,Pa,mr,G,In,Wn,Ca,Aa,Hn,Se,La,Et,Na,Oa,Rn,Sa,Ia,Un,Pt,Wa,Vn,Ha,Ra,Ua,Xn,Ct,Va,sn,Xa,Ja,fr,Ie,Ka,At,Ga,Ya,gr,ge,We,Jn,Lt,Za,Kn,ei,_r,j,ti,Gn,oi,ni,Nt,si,ri,Yn,ai,ii,Zn,li,di,Ot,ci,pi,br,He,hi,es,ui,mi,kr,rn,fi,Qr,St,wr,_e,Re,ts,It,gi,os,_i,vr,an,bi,$r,Wt,Tr,be,Ue,ns,Ht,ki,ss,Qi,yr,se,wi,Rt,vi,$i,Ut,Ti,yi,qr,Vt,Dr,ke,Ve,rs,Xt,qi,as,Di,zr,K,Jt,zi,Qe,Bi,ln,Mi,xi,Kt,Fi,ji,Ei,we,Pi,dn,Ci,Ai,cn,Li,Ni,Oi,Xe,Br,ve,Je,is,Gt,Si,ls,Ii,Mr,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,rl,al,ps,il,ll,hs,dl,cl,us,pl,hl,ms,ul,ml,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,Ql,wl,gs,vl,$l,Tl,Ke,yl,Ge,xr,Te,Ye,_s,ro,ql,bs,Dl,Fr,E,ao,zl,io,Bl,ks,Ml,xl,Fl,lo,jl,un,El,Pl,Cl,co,Al,po,Ll,Nl,Ol,Z,ho,Sl,ye,Il,mn,Wl,Hl,Qs,Rl,Ul,Vl,Ze,Xl,et,jr,qe,tt,ws,uo,Jl,vs,Kl,Er,P,mo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,rd,_o,ad,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,ud,Ts,md,fd,gd,ot,_d,nt,bd,st,Pr,ze,rt,ys,Qo,kd,qs,Qd,Cr,C,wo,wd,Ds,vd,$d,vo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,Fd,Be,jd,bn,Ed,Pd,zs,Cd,Ad,Ld,at,Nd,it,Od,lt,Sd,dt,Id,ct,Ar,Me,pt,Bs,qo,Wd,Ms,Hd,Lr,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,Fo,sc,xe,rc,Qn,ac,ic,Fs,lc,dc,cc,ht,pc,ut,Nr,Fe,mt,js,jo,hc,Es,uc,Or,L,Eo,mc,Ps,fc,gc,Po,_c,wn,bc,kc,Qc,Co,wc,Ao,vc,$c,Tc,te,Lo,yc,je,qc,vn,Dc,zc,Cs,Bc,Mc,xc,ft,Fc,gt,Sr,Ee,_t,As,No,jc,Ls,Ec,Ir,N,Oo,Pc,Ns,Cc,Ac,So,Lc,$n,Nc,Oc,Sc,Io,Ic,Wo,Wc,Hc,Rc,H,Ho,Uc,Pe,Vc,Tn,Xc,Jc,Os,Kc,Gc,Yc,bt,Zc,kt,ep,Qt,Wr,Ce,wt,Ss,Ro,tp,Is,op,Hr,O,Uo,np,Ae,sp,Ws,rp,ap,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,up,Xo,mp,Jo,fp,gp,_p,R,Ko,bp,Le,kp,qn,Qp,wp,Rs,vp,$p,Tp,vt,yp,$t,qp,Tt,Rr;return l=new J({}),Ft=new J({}),Lt=new J({}),St=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17881/en/model_doc/qdqbert#transformers.QDQBertModel">QDQBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.QDQBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L880",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17881/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1044",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1201",returnDescription:`
<p>A <a
...
`}}),ot=new xt({props:{$$slots:{default:[xu]},$$scope:{ctx:q}}}),nt=new S({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example",$$slots:{default:[Fu]},$$scope:{ctx:q}}}),st=new S({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example-2",$$slots:{default:[ju]},$$scope:{ctx:q}}}),Qo=new J({}),wo=new F({props:{name:"class transformers.QDQBertForSequenceClassification",anchor:"transformers.QDQBertForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17881/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1404",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1298",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1501",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1597",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17881/src/transformers/models/qdqbert/modeling_qdqbert.py#L1678",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17881/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
`}}),vt=new xt({props:{$$slots:{default:[Uu]},$$scope:{ctx:q}}}),$t=new S({props:{anchor:"transformers.QDQBertForQuestionAnswering.forward.example",$$slots:{default:[Vu]},$$scope:{ctx:q}}}),Tt=new S({props:{anchor:"transformers.QDQBertForQuestionAnswering.forward.example-2",$$slots:{default:[Xu]},$$scope:{ctx:q}}}),{c(){d=r("meta"),_=p(),c=r("h1"),u=r("a"),k=r("span"),Q(l.$$.fragment),m=p(),D=r("span"),Da=n("QDQBERT"),dr=p(),fe=r("h2"),Ne=r("a"),Nn=r("span"),Q(Ft.$$.fragment),za=p(),On=r("span"),Ba=n("Overview"),cr=p(),Oe=r("p"),Ma=n("The QDQBERT model can be referenced in "),jt=r("a"),xa=n(`Integer Quantization for Deep Learning Inference: Principles and Empirical
...
SQUAD task can be found at `),sn=r("a"),Xa=n("transformers/examples/research_projects/quantization-qdqbert/"),Ja=n("."),fr=p(),Ie=r("p"),Ka=n("This model was contributed by "),At=r("a"),Ga=n("shangz"),Ya=n("."),gr=p(),ge=r("h3"),We=r("a"),Jn=r("span"),Q(Lt.$$.fragment),Za=p(),Kn=r("span"),ei=n("Set default quantizers"),_r=p(),j=r("p"),ti=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
...
`),Kt=r("a"),Fi=n("bert-base-uncased"),ji=n(" architecture."),Ei=p(),we=r("p"),Pi=n("Configuration objects inherit from "),dn=r("a"),Ci=n("PretrainedConfig"),Ai=n(` and can be used to control the model outputs. Read the
documentation from `),cn=r("a"),Li=n("PretrainedConfig"),Ni=n(" for more information."),Oi=p(),Q(Xe.$$.fragment),Br=p(),ve=r("h2"),Je=r("a"),is=r("span"),Q(Gt.$$.fragment),Si=p(),ls=r("span"),Ii=n("QDQBertModel"),Mr=p(),z=r("div"),Q(Yt.$$.fragment),Wi=p(),ds=r("p"),Hi=n("The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Ri=p(),Zt=r("p"),Ui=n("This model inherits from "),pn=r("a"),Vi=n("PreTrainedModel"),Xi=n(`. Check the superclass documentation for the generic methods the
...
`),us=r("code"),pl=n("add_cross_attention"),hl=n(" set to "),ms=r("code"),ul=n("True"),ml=n("; an "),fs=r("code"),fl=n("encoder_hidden_states"),gl=n(" is then expected as an input to the forward pass."),_l=p(),Y=r("div"),Q(so.$$.fragment),bl=p(),$e=r("p"),kl=n("The "),hn=r("a"),Ql=n("QDQBertModel"),wl=n(" forward method, overrides the "),gs=r("code"),vl=n("__call__"),$l=n(" special method."),Tl=p(),Q(Ke.$$.fragment),yl=p(),Q(Ge.$$.fragment),xr=p(),Te=r("h2"),Ye=r("a"),_s=r("span"),Q(ro.$$.fragment),ql=p(),bs=r("span"),Dl=n("QDQBertLMHeadModel"),Fr=p(),E=r("div"),Q(ao.$$.fragment),zl=p(),io=r("p"),Bl=n("QDQBERT Model with a "),ks=r("code"),Ml=n("language modeling"),xl=n(" head on top for CLM fine-tuning."),Fl=p(),lo=r("p"),jl=n("This model inherits from "),un=r("a"),El=n("PreTrainedModel"),Pl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cl=p(),co=r("p"),Al=n("This model is also a PyTorch "),po=r("a"),Ll=n("torch.nn.Module"),Nl=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ol=p(),Z=r("div"),Q(ho.$$.fragment),Sl=p(),ye=r("p"),Il=n("The "),mn=r("a"),Wl=n("QDQBertLMHeadModel"),Hl=n(" forward method, overrides the "),Qs=r("code"),Rl=n("__call__"),Ul=n(" special method."),Vl=p(),Q(Ze.$$.fragment),Xl=p(),Q(et.$$.fragment),jr=p(),qe=r("h2"),tt=r("a"),ws=r("span"),Q(uo.$$.fragment),Jl=p(),vs=r("span"),Kl=n("QDQBertForMaskedLM"),Er=p(),P=r("div"),Q(mo.$$.fragment),Gl=p(),fo=r("p"),Yl=n("QDQBERT Model with a "),$s=r("code"),Zl=n("language modeling"),ed=n(" head on top."),td=p(),go=r("p"),od=n("This model inherits from "),fn=r("a"),nd=n("PreTrainedModel"),sd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xd=p(),B=r("div"),Q(yo.$$.fragment),Fd=p(),Be=r("p"),jd=n("The "),bn=r("a"),Ed=n("QDQBertForSequenceClassification"),Pd=n(" forward method, overrides the "),zs=r("code"),Cd=n("__call__"),Ad=n(" special method."),Ld=p(),Q(at.$$.fragment),Nd=p(),Q(it.$$.fragment),Od=p(),Q(lt.$$.fragment),Sd=p(),Q(dt.$$.fragment),Id=p(),Q(ct.$$.fragment),Ar=p(),Me=r("h2"),pt=r("a"),Bs=r("span"),Q(qo.$$.fragment),Wd=p(),Ms=r("span"),Hd=n("QDQBertForNextSentencePrediction"),Lr=p(),A=r("div"),Q(Do.$$.fragment),Rd=p(),zo=r("p"),Ud=n("Bert Model with a "),xs=r("code"),Vd=n("next sentence prediction (classification)"),Xd=n(" head on top."),Jd=p(),Bo=r("p"),Kd=n("This model inherits from "),kn=r("a"),Gd=n("PreTrainedModel"),Yd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd=p(),Mo=r("p"),ec=n("This model is also a PyTorch "),xo=r("a"),tc=n("torch.nn.Module"),oc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nc=p(),ee=r("div"),Q(Fo.$$.fragment),sc=p(),xe=r("p"),rc=n("The "),Qn=r("a"),ac=n("QDQBertForNextSentencePrediction"),ic=n(" forward method, overrides the "),Fs=r("code"),lc=n("__call__"),dc=n(" special method."),cc=p(),Q(ht.$$.fragment),pc=p(),Q(ut.$$.fragment),Nr=p(),Fe=r("h2"),mt=r("a"),js=r("span"),Q(jo.$$.fragment),hc=p(),Es=r("span"),uc=n("QDQBertForMultipleChoice"),Or=p(),L=r("div"),Q(Eo.$$.fragment),mc=p(),Ps=r("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=p(),te=r("div"),Q(Lo.$$.fragment),yc=p(),je=r("p"),qc=n("The "),vn=r("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Cs=r("code"),Bc=n("__call__"),Mc=n(" special method."),xc=p(),Q(ft.$$.fragment),Fc=p(),Q(gt.$$.fragment),Sr=p(),Ee=r("h2"),_t=r("a"),As=r("span"),Q(No.$$.fragment),jc=p(),Ls=r("span"),Ec=n("QDQBertForTokenClassification"),Ir=p(),N=r("div"),Q(Oo.$$.fragment),Pc=p(),Ns=r("p"),Cc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc=p(),H=r("div"),Q(Ho.$$.fragment),Uc=p(),Pe=r("p"),Vc=n("The "),Tn=r("a"),Xc=n("QDQBertForTokenClassification"),Jc=n(" forward method, overrides the "),Os=r("code"),Kc=n("__call__"),Gc=n(" special method."),Yc=p(),Q(bt.$$.fragment),Zc=p(),Q(kt.$$.fragment),ep=p(),Q(Qt.$$.fragment),Wr=p(),Ce=r("h2"),wt=r("a"),Ss=r("span"),Q(Ro.$$.fragment),tp=p(),Is=r("span"),op=n("QDQBertForQuestionAnswering"),Hr=p(),O=r("div"),Q(Uo.$$.fragment),np=p(),Ae=r("p"),sp=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p=p(),R=r("div"),Q(Ko.$$.fragment),bp=p(),Le=r("p"),kp=n("The "),qn=r("a"),Qp=n("QDQBertForQuestionAnswering"),wp=n(" forward method, overrides the "),Rs=r("code"),vp=n("__call__"),$p=n(" special method."),Tp=p(),Q(vt.$$.fragment),yp=p(),Q($t.$$.fragment),qp=p(),Q(Tt.$$.fragment),this.h()},l(t){const g=Tu('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(o),_=h(t),c=a(t,"H1",{class:!0});var Go=i(c);u=a(Go,"A",{id:!0,class:!0,href:!0});var Us=i(u);k=a(Us,"SPAN",{});var Vs=i(k);w(l.$$.fragment,Vs),Vs.forEach(o),Us.forEach(o),m=h(Go),D=a(Go,"SPAN",{});var Xs=i(D);Da=s(Xs,"QDQBERT"),Xs.forEach(o),Go.forEach(o),dr=h(t),fe=a(t,"H2",{class:!0});var Yo=i(fe);Ne=a(Yo,"A",{id:!0,class:!0,href:!0});var Js=i(Ne);Nn=a(Js,"SPAN",{});var Ks=i(Nn);w(Ft.$$.fragment,Ks),Ks.forEach(o),Js.forEach(o),za=h(Yo),On=a(Yo,"SPAN",{});var Gs=i(On);Ba=s(Gs,"Overview"),Gs.forEach(o),Yo.forEach(o),cr=h(t),Oe=a(t,"P",{});var Zo=i(Oe);Ma=s(Zo,"The QDQBERT model can be referenced in "),jt=a(Zo,"A",{href:!0,rel:!0});var Ys=i(jt);xa=s(Ys,`Integer Quantization for Deep Learning Inference: Principles and Empirical
...
Quantization Toolkit userguide`),Lp.forEach(o),pi=s(oe," for more details."),oe.forEach(o),br=h(t),He=a(t,"P",{});var Jr=i(He);hi=s(Jr,"Before creating QDQBERT model, one has to set the default "),es=a(Jr,"CODE",{});var Np=i(es);ui=s(Np,"QuantDescriptor"),Np.forEach(o),mi=s(Jr," defining default tensor quantizers."),Jr.forEach(o),kr=h(t),rn=a(t,"P",{});var Op=i(rn);fi=s(Op,"Example:"),Op.forEach(o),Qr=h(t),w(St.$$.fragment,t),wr=h(t),_e=a(t,"H3",{class:!0});var Kr=i(_e);Re=a(Kr,"A",{id:!0,class:!0,href:!0});var Sp=i(Re);ts=a(Sp,"SPAN",{});var Ip=i(ts);w(It.$$.fragment,Ip),Ip.forEach(o),Sp.forEach(o),gi=h(Kr),os=a(Kr,"SPAN",{});var Wp=i(os);_i=s(Wp,"Calibration"),Wp.forEach(o),Kr.forEach(o),vr=h(t),an=a(t,"P",{});var Hp=i(an);bi=s(Hp,`Calibration is the terminology of passing data samples to the quantizer and deciding the best scaling factors for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),aa.forEach(o),Ol=h(re),Z=a(re,"DIV",{class:!0});var zt=i(Z);w(ho.$$.fragment,zt),Sl=h(zt),ye=a(zt,"P",{});var xn=i(ye);Il=s(xn,"The "),mn=a(xn,"A",{href:!0});var Th=i(mn);Wl=s(Th,"QDQBertLMHeadModel"),Th.forEach(o),Hl=s(xn," forward method, overrides the "),Qs=a(xn,"CODE",{});var yh=i(Qs);Rl=s(yh,"__call__"),yh.forEach(o),Ul=s(xn," special method."),xn.forEach(o),Vl=h(zt),w(Ze.$$.fragment,zt),Xl=h(zt),w(et.$$.fragment,zt),zt.forEach(o),re.forEach(o),jr=h(t),qe=a(t,"H2",{class:!0});var ia=i(qe);tt=a(ia,"A",{id:!0,class:!0,href:!0});var qh=i(tt);ws=a(qh,"SPAN",{});var Dh=i(ws);w(uo.$$.fragment,Dh),Dh.forEach(o),qh.forEach(o),Jl=h(ia),vs=a(ia,"SPAN",{});var zh=i(vs);Kl=s(zh,"QDQBertForMaskedLM"),zh.forEach(o),ia.forEach(o),Er=h(t),P=a(t,"DIV",{class:!0});var ae=i(P);w(mo.$$.fragment,ae),Gl=h(ae),fo=a(ae,"P",{});var la=i(fo);Yl=s(la,"QDQBERT Model with a "),$s=a(la,"CODE",{});var Bh=i($s);Zl=s(Bh,"language modeling"),Bh.forEach(o),ed=s(la," head on top."),la.forEach(o),td=h(ae),go=a(ae,"P",{});var da=i(go);od=s(da,"This model inherits from "),fn=a(da,"A",{href:!0});var Mh=i(fn);nd=s(Mh,"PreTrainedModel"),Mh.forEach(o),sd=s(da,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ca.forEach(o),dd=h(ae),W=a(ae,"DIV",{class:!0});var ie=i(W);w(ko.$$.fragment,ie),cd=h(ie),De=a(ie,"P",{});var Fn=i(De);pd=s(Fn,"The "),gn=a(Fn,"A",{href:!0});var Fh=i(gn);hd=s(Fh,"QDQBertForMaskedLM"),Fh.forEach(o),ud=s(Fn," forward method, overrides the "),Ts=a(Fn,"CODE",{});var jh=i(Ts);md=s(jh,"__call__"),jh.forEach(o),fd=s(Fn," special method."),Fn.forEach(o),gd=h(ie),w(ot.$$.fragment,ie),_d=h(ie),w(nt.$$.fragment,ie),bd=h(ie),w(st.$$.fragment,ie),ie.forEach(o),ae.forEach(o),Pr=h(t),ze=a(t,"H2",{class:!0});var pa=i(ze);rt=a(pa,"A",{id:!0,class:!0,href:!0});var Eh=i(rt);ys=a(Eh,"SPAN",{});var Ph=i(ys);w(Qo.$$.fragment,Ph),Ph.forEach(o),Eh.forEach(o),kd=h(pa),qs=a(pa,"SPAN",{});var Ch=i(qs);Qd=s(Ch,"QDQBertForSequenceClassification"),Ch.forEach(o),pa.forEach(o),Cr=h(t),C=a(t,"DIV",{class:!0});var le=i(C);w(wo.$$.fragment,le),wd=h(le),Ds=a(le,"P",{});var Ah=i(Ds);vd=s(Ah,`Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Ah.forEach(o),$d=h(le),vo=a(le,"P",{});var ha=i(vo);Td=s(ha,"This model inherits from "),_n=a(ha,"A",{href:!0});var Lh=i(_n);yd=s(Lh,"PreTrainedModel"),Lh.forEach(o),qd=s(ha,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ua.forEach(o),xd=h(le),B=a(le,"DIV",{class:!0});var X=i(B);w(yo.$$.fragment,X),Fd=h(X),Be=a(X,"P",{});var jn=i(Be);jd=s(jn,"The "),bn=a(jn,"A",{href:!0});var Oh=i(bn);Ed=s(Oh,"QDQBertForSequenceClassification"),Oh.forEach(o),Pd=s(jn," forward method, overrides the "),zs=a(jn,"CODE",{});var Sh=i(zs);Cd=s(Sh,"__call__"),Sh.forEach(o),Ad=s(jn," special method."),jn.forEach(o),Ld=h(X),w(at.$$.fragment,X),Nd=h(X),w(it.$$.fragment,X),Od=h(X),w(lt.$$.fragment,X),Sd=h(X),w(dt.$$.fragment,X),Id=h(X),w(ct.$$.fragment,X),X.forEach(o),le.forEach(o),Ar=h(t),Me=a(t,"H2",{class:!0});var ma=i(Me);pt=a(ma,"A",{id:!0,class:!0,href:!0});var Ih=i(pt);Bs=a(Ih,"SPAN",{});var Wh=i(Bs);w(qo.$$.fragment,Wh),Wh.forEach(o),Ih.forEach(o),Wd=h(ma),Ms=a(ma,"SPAN",{});var Hh=i(Ms);Hd=s(Hh,"QDQBertForNextSentencePrediction"),Hh.forEach(o),ma.forEach(o),Lr=h(t),A=a(t,"DIV",{class:!0});var de=i(A);w(Do.$$.fragment,de),Rd=h(de),zo=a(de,"P",{});var fa=i(zo);Ud=s(fa,"Bert Model with a "),xs=a(fa,"CODE",{});var Rh=i(xs);Vd=s(Rh,"next sentence prediction (classification)"),Rh.forEach(o),Xd=s(fa," head on top."),fa.forEach(o),Jd=h(de),Bo=a(de,"P",{});var ga=i(Bo);Kd=s(ga,"This model inherits from "),kn=a(ga,"A",{href:!0});var Uh=i(kn);Gd=s(Uh,"PreTrainedModel"),Uh.forEach(o),Yd=s(ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_a.forEach(o),nc=h(de),ee=a(de,"DIV",{class:!0});var Bt=i(ee);w(Fo.$$.fragment,Bt),sc=h(Bt),xe=a(Bt,"P",{});var En=i(xe);rc=s(En,"The "),Qn=a(En,"A",{href:!0});var Xh=i(Qn);ac=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(En," forward method, overrides the "),Fs=a(En,"CODE",{});var Jh=i(Fs);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(En," special method."),En.forEach(o),cc=h(Bt),w(ht.$$.fragment,Bt),pc=h(Bt),w(ut.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Nr=h(t),Fe=a(t,"H2",{class:!0});var ba=i(Fe);mt=a(ba,"A",{id:!0,class:!0,href:!0});var Kh=i(mt);js=a(Kh,"SPAN",{});var Gh=i(js);w(jo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(ba),Es=a(ba,"SPAN",{});var Yh=i(Es);uc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),ba.forEach(o),Or=h(t),L=a(t,"DIV",{class:!0});var ce=i(L);w(Eo.$$.fragment,ce),mc=h(ce),Ps=a(ce,"P",{});var Zh=i(Ps);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qa.forEach(o),Tc=h(ce),te=a(ce,"DIV",{class:!0});var Mt=i(te);w(Lo.$$.fragment,Mt),yc=h(Mt),je=a(Mt,"P",{});var Pn=i(je);qc=s(Pn,"The "),vn=a(Pn,"A",{href:!0});var ou=i(vn);Dc=s(ou,"QDQBertForMultipleChoice"),ou.forEach(o),zc=s(Pn," forward method, overrides the "),Cs=a(Pn,"CODE",{});var nu=i(Cs);Bc=s(nu,"__call__"),nu.forEach(o),Mc=s(Pn," special method."),Pn.forEach(o),xc=h(Mt),w(ft.$$.fragment,Mt),Fc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Sr=h(t),Ee=a(t,"H2",{class:!0});var wa=i(Ee);_t=a(wa,"A",{id:!0,class:!0,href:!0});var su=i(_t);As=a(su,"SPAN",{});var ru=i(As);w(No.$$.fragment,ru),ru.forEach(o),su.forEach(o),jc=h(wa),Ls=a(wa,"SPAN",{});var au=i(Ls);Ec=s(au,"QDQBertForTokenClassification"),au.forEach(o),wa.forEach(o),Ir=h(t),N=a(t,"DIV",{class:!0});var pe=i(N);w(Oo.$$.fragment,pe),Pc=h(pe),Ns=a(pe,"P",{});var iu=i(Ns);Cc=s(iu,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),iu.forEach(o),Ac=h(pe),So=a(pe,"P",{});var va=i(So);Lc=s(va,"This model inherits from "),$n=a(va,"A",{href:!0});var lu=i($n);Nc=s(lu,"PreTrainedModel"),lu.forEach(o),Oc=s(va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),va.forEach(o),Sc=h(pe),Io=a(pe,"P",{});var $a=i(Io);Ic=s($a,"This model is also a PyTorch "),Wo=a($a,"A",{href:!0,rel:!0});var du=i(Wo);Wc=s(du,"torch.nn.Module"),du.forEach(o),Hc=s($a,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$a.forEach(o),Rc=h(pe),H=a(pe,"DIV",{class:!0});var he=i(H);w(Ho.$$.fragment,he),Uc=h(he),Pe=a(he,"P",{});var Cn=i(Pe);Vc=s(Cn,"The "),Tn=a(Cn,"A",{href:!0});var cu=i(Tn);Xc=s(cu,"QDQBertForTokenClassification"),cu.forEach(o),Jc=s(Cn," forward method, overrides the "),Os=a(Cn,"CODE",{});var pu=i(Os);Kc=s(pu,"__call__"),pu.forEach(o),Gc=s(Cn," special method."),Cn.forEach(o),Yc=h(he),w(bt.$$.fragment,he),Zc=h(he),w(kt.$$.fragment,he),ep=h(he),w(Qt.$$.fragment,he),he.forEach(o),pe.forEach(o),Wr=h(t),Ce=a(t,"H2",{class:!0});var Ta=i(Ce);wt=a(Ta,"A",{id:!0,class:!0,href:!0});var hu=i(wt);Ss=a(hu,"SPAN",{});var uu=i(Ss);w(Ro.$$.fragment,uu),uu.forEach(o),hu.forEach(o),tp=h(Ta),Is=a(Ta,"SPAN",{});var mu=i(Is);op=s(mu,"QDQBertForQuestionAnswering"),mu.forEach(o),Ta.forEach(o),Hr=h(t),O=a(t,"DIV",{class:!0});var ue=i(O);w(Uo.$$.fragment,ue),np=h(ue),Ae=a(ue,"P",{});var An=i(Ae);sp=s(An,`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
