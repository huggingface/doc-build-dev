...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
parts of DeepSpeed like `),cf=o("code"),g6=a("zero.Init"),w6=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
...
circumstances you may find the following information to be needed.`),RF.forEach(t),k3=c(e),at=l(e,"H4",{class:!0});var a5=r(at);cn=l(a5,"A",{id:!0,class:!0,href:!0});var IF=r(cn);rv=l(IF,"SPAN",{});var UF=r(rv);d(Pr.$$.fragment,UF),UF.forEach(t),IF.forEach(t),wC=c(a5),pv=l(a5,"SPAN",{});var GF=r(pv);yC=n(GF,"Constructing Massive Models"),GF.forEach(t),a5.forEach(t),P3=c(e),hn=l(e,"P",{});var n5=r(hn);bC=n(n5,`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
`),wv=l(p5,"CODE",{});var oV=r(wv);lx=n(oV,"from_pretrained"),oV.forEach(t),rx=n(p5,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g5.forEach(t),JV.forEach(t),j5.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var w5=r(it);qn=l(w5,"A",{id:!0,class:!0,href:!0});var QV=r(qn);Zv=l(QV,"SPAN",{});var eY=r(Zv);d(Jr.$$.fragment,eY),eY.forEach(t),QV.forEach(t),wR=c(w5),Nv=l(w5,"SPAN",{});var sY=r(Nv);yR=n(sY,"Troubleshooting"),sY.forEach(t),w5.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var y5=r(ut);$n=l(y5,"A",{id:!0,class:!0,href:!0});var tY=r($n);Hv=l(tY,"SPAN",{});var aY=r(Hv);d(Xr.$$.fragment,aY),aY.forEach(t),tY.forEach(t),bR=c(y5),Qr=l(y5,"SPAN",{});var b5=r(Qr);ER=n(b5,"the "),Bv=l(b5,"CODE",{});var nY=r(Bv);qR=n(nY,"deepspeed"),nY.forEach(t),$R=n(b5," process gets killed at startup without a traceback"),b5.forEach(t),y5.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Wv=l(ke,"CODE",{});var oY=r(Wv);PR=n(oY,"deepspeed"),oY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
