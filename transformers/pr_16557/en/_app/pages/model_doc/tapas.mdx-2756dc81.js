import{S as Uk,i as Bk,s as Rk,e as o,k as d,w as $,t as s,M as Gk,c as n,d as t,m as p,a as r,x as E,h as a,b as h,N as Vk,F as e,g as u,y as F,q as A,o as z,B as x,v as Kk,L as rn}from"../../chunks/vendor-6b77c823.js";import{T as Ms}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-abef54e3.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Bt}from"../../chunks/IconCopyLink-7a11ce68.js";import{F as Cc,M as ln}from"../../chunks/Markdown-4489c441.js";function Yk(U){let l,_,c,f,v,w,T,y,k,D,q,H,G,V,B,K,re,I,O;return T=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),_=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),c=o("a"),f=s("TapasTokenizer"),v=s(" to convert table-question pairs into "),w=o("code"),T=s("input_ids"),y=s(", "),k=o("code"),D=s("attention_mask"),q=s(", "),H=o("code"),G=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),B=o("a"),K=s("TFTapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),I=d(),O=o("table"),b=o("thead"),M=o("tr"),R=o("th"),C=o("strong"),N=s("Task"),ee=d(),te=o("th"),ce=o("strong"),oe=s("Required inputs"),se=d(),S=o("tbody"),L=o("tr"),W=o("td"),X=s("Conversational"),Q=d(),Y=o("td"),ge=o("code"),ue=s("input_ids"),_e=s(", "),me=o("code"),ne=s("attention_mask"),qe=s(", "),ie=o("code"),we=s("token_type_ids"),g=s(", "),P=o("code"),ve=s("labels"),ze=d(),be=o("tr"),le=o("td"),xe=s("Weak supervision for aggregation"),Me=d(),Z=o("td"),de=o("code"),pe=s("input_ids"),De=s(", "),je=o("code"),Te=s("attention_mask"),Ne=s(", "),ke=o("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=o("code"),Ss=s("labels"),Ps=s(", "),ut=o("code"),mt=s("numeric_values"),pa=s(", "),ft=o("code"),gt=s("numeric_values_scale"),Ds=s(", "),tt=o("code"),Ns=s("float_answer"),Os=d(),Ke=o("tr"),Se=o("td"),Ls=s("Strong supervision for aggregation"),bt=d(),ye=o("td"),kt=o("code"),yt=s("input ids"),Qs=s(", "),qt=o("code"),jt=s("attention mask"),Is=s(", "),$t=o("code"),vs=s("token type ids"),Rt=s(", "),Et=o("code"),ws=s("labels"),Ye=s(", "),$e=o("code"),Ws=s("aggregation_labels"),Ft=d(),ae=o("p"),ot=o("a"),Gt=s("TapasTokenizer"),Hs=s(" creates the "),At=o("code"),os=s("labels"),Us=s(", "),zt=o("code"),xt=s("numeric_values"),Bs=s(" and "),Ct=o("code"),ns=s("numeric_values_scale"),Rs=s(" based on the "),Mt=o("code"),rs=s("answer_coordinates"),Gs=s(" and "),St=o("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Pt=o("code"),is=s("float_answer"),Ks=s(" and "),Dt=o("code"),ls=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ds=d(),$(Ue.$$.fragment),ps=d(),Ee=o("p"),cs=s("Note that "),nt=o("a"),Js=s("TapasTokenizer"),Nt=s(" expects the data of the table to be "),Ot=o("strong"),Xs=s("text-only"),Zs=s(". You can use "),Be=o("code"),ea=s(".astype(str)"),hs=s(` on a dataframe to turn it into text-only data.
...
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=o("p"),_=s("Here we explain how you can use "),c=o("a"),f=s("TapasForQuestionAnswering"),v=s(" or "),w=o("a"),T=s("TFTapasForQuestionAnswering"),y=s(" for inference (i.e. making predictions on new data). For inference, only "),k=o("code"),D=s("input_ids"),q=s(", "),H=o("code"),G=s("attention_mask"),V=s(" and "),B=o("code"),K=s("token_type_ids"),re=s(" (which you can obtain using "),I=o("a"),O=s("TapasTokenizer"),b=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),M=o("code"),R=s("convert_logits_to_predictions"),C=s(" method to convert these into predicted coordinates and optional aggregation indices."),N=d(),ee=o("p"),te=s("However, note that inference is "),ce=o("strong"),oe=s("different"),se=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),S=d(),$(L.$$.fragment),this.h()},l(X){l=n(X,"P",{});var Q=r(l);_=a(Q,"Here we explain how you can use "),c=n(Q,"A",{href:!0});var Y=r(c);f=a(Y,"TapasForQuestionAnswering"),Y.forEach(t),v=a(Q," or "),w=n(Q,"A",{href:!0});var ge=r(w);T=a(ge,"TFTapasForQuestionAnswering"),ge.forEach(t),y=a(Q," for inference (i.e. making predictions on new data). For inference, only "),k=n(Q,"CODE",{});var ue=r(k);D=a(ue,"input_ids"),ue.forEach(t),q=a(Q,", "),H=n(Q,"CODE",{});var _e=r(H);G=a(_e,"attention_mask"),_e.forEach(t),V=a(Q," and "),B=n(Q,"CODE",{});var me=r(B);K=a(me,"token_type_ids"),me.forEach(t),re=a(Q," (which you can obtain using "),I=n(Q,"A",{href:!0});var ne=r(I);O=a(ne,"TapasTokenizer"),ne.forEach(t),b=a(Q,") have to be provided to the model to obtain the logits. Next, you can use the handy "),M=n(Q,"CODE",{});var qe=r(M);R=a(qe,"convert_logits_to_predictions"),qe.forEach(t),C=a(Q," method to convert these into predicted coordinates and optional aggregation indices."),Q.forEach(t),N=p(X),ee=n(X,"P",{});var ie=r(ee);te=a(ie,"However, note that inference is "),ce=n(ie,"STRONG",{});var we=r(ce);oe=a(we,"different"),we.forEach(t),se=a(ie," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ie.forEach(t),S=p(X),E(L.$$.fragment,X),this.h()},h(){h(c,"href","/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),h(w,"href","/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),h(I,"href","/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer")},m(X,Q){u(X,l,Q),e(l,_),e(l,c),e(c,f),e(l,v),e(l,w),e(w,T),e(l,y),e(l,k),e(k,D),e(l,q),e(l,H),e(H,G),e(l,V),e(l,B),e(B,K),e(l,re),e(l,I),e(I,O),e(l,b),e(l,M),e(M,R),e(l,C),u(X,N,Q),u(X,ee,Q),e(ee,te),e(ee,ce),e(ce,oe),e(ee,se),u(X,S,Q),F(L,X,Q),W=!0},p:rn,i(X){W||(A(L.$$.fragment,X),W=!0)},o(X){z(L.$$.fragment,X),W=!1},d(X){X&&t(l),X&&t(N),X&&t(ee),X&&t(S),x(L,X)}}}function dy(U){let l,_;return l=new ln({props:{$$slots:{default:[ly]},$$scope:{ctx:U}}}),{c(){$(l.$$.fragment)},l(c){E(l.$$.fragment,c)},m(c,f){F(l,c,f),_=!0},p(c,f){const v={};f&2&&(v.$$scope={dirty:f,ctx:c}),l.$set(v)},i(c){_||(A(l.$$.fragment,c),_=!0)},o(c){z(l.$$.fragment,c),_=!1},d(c){x(l,c)}}}function py(U){let l,_,c,f,v,w,T,y,k,D,q,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se;return oe=new Ve({props:{code:`from transformers import TapasTokenizer, TFTapasForQuestionAnswering
import pandas as pd
...
Predicted answer: COUNT &gt; <span class="hljs-number">69</span>
What <span class="hljs-keyword">is</span> the total number of movies?
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=o("p"),_=s("Here we explain how you can use "),c=o("a"),f=s("TFTapasForQuestionAnswering"),v=s(" for inference (i.e. making predictions on new data). For inference, only "),w=o("code"),T=s("input_ids"),y=s(", "),k=o("code"),D=s("attention_mask"),q=s(" and "),H=o("code"),G=s("token_type_ids"),V=s(" (which you can obtain using "),B=o("a"),K=s("TapasTokenizer"),re=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),I=o("code"),O=s("convert_logits_to_predictions"),b=s(" method to convert these into predicted coordinates and optional aggregation indices."),M=d(),R=o("p"),C=s("However, note that inference is "),N=o("strong"),ee=s("different"),te=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ce=d(),$(oe.$$.fragment),this.h()},l(S){l=n(S,"P",{});var L=r(l);_=a(L,"Here we explain how you can use "),c=n(L,"A",{href:!0});var W=r(c);f=a(W,"TFTapasForQuestionAnswering"),W.forEach(t),v=a(L," for inference (i.e. making predictions on new data). For inference, only "),w=n(L,"CODE",{});var X=r(w);T=a(X,"input_ids"),X.forEach(t),y=a(L,", "),k=n(L,"CODE",{});var Q=r(k);D=a(Q,"attention_mask"),Q.forEach(t),q=a(L," and "),H=n(L,"CODE",{});var Y=r(H);G=a(Y,"token_type_ids"),Y.forEach(t),V=a(L," (which you can obtain using "),B=n(L,"A",{href:!0});var ge=r(B);K=a(ge,"TapasTokenizer"),ge.forEach(t),re=a(L,") have to be provided to the model to obtain the logits. Next, you can use the handy "),I=n(L,"CODE",{});var ue=r(I);O=a(ue,"convert_logits_to_predictions"),ue.forEach(t),b=a(L," method to convert these into predicted coordinates and optional aggregation indices."),L.forEach(t),M=p(S),R=n(S,"P",{});var _e=r(R);C=a(_e,"However, note that inference is "),N=n(_e,"STRONG",{});var me=r(N);ee=a(me,"different"),me.forEach(t),te=a(_e," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),_e.forEach(t),ce=p(S),E(oe.$$.fragment,S),this.h()},h(){h(c,"href","/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),h(B,"href","/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer")},m(S,L){u(S,l,L),e(l,_),e(l,c),e(c,f),e(l,v),e(l,w),e(w,T),e(l,y),e(l,k),e(k,D),e(l,q),e(l,H),e(H,G),e(l,V),e(l,B),e(B,K),e(l,re),e(l,I),e(I,O),e(l,b),u(S,M,L),u(S,R,L),e(R,C),e(R,N),e(N,ee),e(R,te),u(S,ce,L),F(oe,S,L),se=!0},p:rn,i(S){se||(A(oe.$$.fragment,S),se=!0)},o(S){z(oe.$$.fragment,S),se=!1},d(S){S&&t(l),S&&t(M),S&&t(R),S&&t(ce),x(oe,S)}}}function cy(U){let l,_;return l=new ln({props:{$$slots:{default:[py]},$$scope:{ctx:U}}}),{c(){$(l.$$.fragment)},l(c){E(l.$$.fragment,c)},m(c,f){F(l,c,f),_=!0},p(c,f){const v={};f&2&&(v.$$scope={dirty:f,ctx:c}),l.$set(v)},i(c){_||(A(l.$$.fragment,c),_=!0)},o(c){z(l.$$.fragment,c),_=!1},d(c){x(l,c)}}}function hy(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function uy(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function my(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function fy(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function gy(U){let l,_,c,f,v,w,T,y,k,D,q,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se,S,L,W,X,Q,Y,ge,ue,_e,me,ne,qe,ie,we;return{c(){l=o("p"),_=s("TF 2.0 models accepts two formats as inputs:"),c=d(),f=o("ul"),v=o("li"),w=s("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),y=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),D=d(),q=o("p"),H=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),I=s("."),O=d(),b=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=d(),C=o("ul"),N=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),L=d(),W=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ie=o("code"),we=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){l=n(g,"P",{});var P=r(l);_=a(P,"TF 2.0 models accepts two formats as inputs:"),P.forEach(t),c=p(g),f=n(g,"UL",{});var ve=r(f);v=n(ve,"LI",{});var ze=r(v);w=a(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),T=p(ve),y=n(ve,"LI",{});var be=r(y);k=a(be,"having all inputs as a list, tuple or dict in the first positional arguments."),be.forEach(t),ve.forEach(t),D=p(g),q=n(g,"P",{});var le=r(q);H=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var xe=r(G);V=a(xe,"tf.keras.Model.fit"),xe.forEach(t),B=a(le,` method which currently requires having all the
tensors in the first argument of the model call function: `),K=n(le,"CODE",{});var Me=r(K);re=a(Me,"model(inputs)"),Me.forEach(t),I=a(le,"."),le.forEach(t),O=p(g),b=n(g,"P",{});var Z=r(b);M=a(Z,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function qy(U){let l,_,c,f,v,w,T,y,k,D,q,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se,S,L,W,X,Q,Y,ge,ue,_e,me,ne,qe,ie,we,g,P,ve,ze,be,le,xe,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ss,Ps,ut,mt,pa,ft,gt,Ds,tt,Ns,Os,Ke,Se,Ls,bt,ye,kt,yt,Qs,qt,jt,Is,$t,vs,Rt,Et,ws,Ye,$e,Ws,Ft,ae,ot,Gt,Hs,At,os,Us,zt,xt,Bs,Ct,ns,Rs,Mt,rs,Gs,St,Vs,Le,Pt,is,Ks,Dt,ls,Ys,ds,Ue,ps,Ee,cs,nt,Js,Nt,Ot,Xs,Zs,Be,ea,hs,us,et,Lt,j,J,xa,ta,Ca,ca,Qt,st,sa,rt,Ma,aa,Sa,ha,Ie,ms,bs,Re,Pa,ua,ks,oa,fs,ma,fe,Da,ys,Na,Oa,fa,_t,na,gs,La,Fe,Qa,ra,Ia,Wa,Ha,he,Ua,ia,Ba,Ra,ga,qs,Ga,_a,Ce,la,It,da,Ki,Mc,Sc,Yi,Ji,Pc,Dc,Xi,Zi,Nc,Oc,Va,Ka,el,Lc,Qc,tl,Ic,Wc,sl,Hc,Uc,Ya,al,Bc,Rc,ol,Gc,Vc,nl,Kc,Yc,Ja,rl,Jc,Xc,il,Zc,eh,ll,th,sp,qo,ap,jo,sh,dn,ah,oh,op,$o,nh,pn,rh,ih,np,Hr,dl,lh,rp,Eo,dh,cn,ph,ch,ip,We,Ur,pl,hh,uh,mh,Br,cl,fh,gh,_h,Rr,hl,Th,vh,wh,Gr,ul,bh,kh,yh,Vr,ml,qh,jh,$h,Kr,fl,Eh,Fh,Ah,Yr,gl,zh,xh,Ch,Jr,_l,Mh,Sh,Ph,Xr,Tl,Dh,Nh,lp,Tt,Oh,hn,Lh,Qh,un,Ih,Wh,vl,Hh,Uh,wl,Bh,Rh,bl,Gh,Vh,dp,Zr,kl,Kh,pp,Fo,cp,Pe,Yh,yl,Jh,Xh,ql,Zh,eu,jl,tu,su,$l,au,ou,El,nu,ru,Fl,iu,lu,ei,du,pu,mn,cu,hu,fn,uu,mu,hp,ti,fu,up,Ao,mp,Xa,zo,Al,gn,gu,zl,_u,fp,xo,gp,vt,Tu,xl,vu,wu,Cl,bu,ku,Ml,yu,qu,_n,ju,$u,Tn,Eu,Fu,_p,Za,Co,Sl,vn,Au,Pl,zu,Tp,eo,wn,xu,bn,Cu,si,Mu,Su,vp,to,Mo,Dl,kn,Pu,Nl,Du,wp,Wt,yn,Nu,_s,Ou,ai,Lu,Qu,Ol,Iu,Wu,Ll,Hu,Uu,oi,Bu,Ru,Gu,qn,Vu,jn,Ku,Yu,Ju,Ql,Xu,Zu,$n,bp,so,So,Il,En,em,Wl,tm,kp,Ge,Fn,sm,Hl,am,om,Qe,nm,ni,rm,im,ri,lm,dm,Ul,pm,cm,Bl,hm,um,Rl,mm,fm,Gl,gm,_m,Vl,Tm,vm,Kl,wm,bm,Yl,km,ym,qm,it,Jl,jm,$m,Xl,Em,Fm,Zl,Am,zm,ed,xm,Cm,td,Mm,Sm,sd,Pm,Dm,ad,Nm,Om,ii,li,Lm,Qm,Im,Po,An,Wm,od,Hm,Um,Ta,zn,Bm,xn,Rm,di,Gm,Vm,Km,Cn,Ym,Mn,Jm,Xm,Zm,pi,Sn,yp,ao,Do,nd,Pn,ef,rd,tf,qp,lt,Dn,sf,Nn,af,ci,of,nf,rf,On,lf,Ln,df,pf,cf,Qn,hf,hi,uf,mf,ff,In,gf,Wn,_f,Tf,vf,Vt,Hn,wf,oo,bf,ui,kf,yf,id,qf,jf,$f,No,Ef,ld,Ff,Af,Un,jp,no,Oo,dd,Bn,zf,pd,xf,$p,Ts,Rn,Cf,ro,Mf,cd,Sf,Pf,mi,Df,Nf,Of,Gn,Lf,Vn,Qf,If,Wf,Kt,Kn,Hf,io,Uf,fi,Bf,Rf,hd,Gf,Vf,Kf,Lo,Yf,ud,Jf,Xf,Yn,Ep,lo,Qo,md,Jn,Zf,fd,eg,Fp,Ht,Xn,tg,gd,sg,ag,Zn,og,gi,ng,rg,ig,er,lg,tr,dg,pg,cg,Yt,sr,hg,po,ug,_i,mg,fg,_d,gg,_g,Tg,Io,vg,Td,wg,bg,ar,Ap,co,Wo,vd,or,kg,wd,yg,zp,Ut,nr,qg,ho,jg,bd,$g,Eg,kd,Fg,Ag,zg,rr,xg,Ti,Cg,Mg,Sg,ir,Pg,lr,Dg,Ng,Og,Jt,dr,Lg,uo,Qg,vi,Ig,Wg,yd,Hg,Ug,Bg,Ho,Rg,qd,Gg,Vg,pr,xp,mo,Uo,jd,cr,Kg,$d,Yg,Cp,dt,hr,Jg,Ed,Xg,Zg,ur,e_,wi,t_,s_,a_,mr,o_,fr,n_,r_,i_,Bo,l_,Xt,gr,d_,fo,p_,bi,c_,h_,Fd,u_,m_,f_,Ro,g_,Ad,__,T_,_r,Mp,go,Go,zd,Tr,v_,xd,w_,Sp,pt,vr,b_,wr,k_,Cd,y_,q_,j_,br,$_,ki,E_,F_,A_,kr,z_,yr,x_,C_,M_,Vo,S_,Zt,qr,P_,_o,D_,yi,N_,O_,Md,L_,Q_,I_,Ko,W_,Sd,H_,U_,jr,Pp,To,Yo,Pd,$r,B_,Dd,R_,Dp,ct,Er,G_,Nd,V_,K_,Fr,Y_,qi,J_,X_,Z_,Ar,eT,zr,tT,sT,aT,Jo,oT,es,xr,nT,vo,rT,ji,iT,lT,Od,dT,pT,cT,Xo,hT,Ld,uT,mT,Cr,Np,wo,Zo,Qd,Mr,fT,Id,gT,Op,ht,Sr,_T,bo,TT,Wd,vT,wT,Hd,bT,kT,yT,Pr,qT,$i,jT,$T,ET,Dr,FT,Nr,AT,zT,xT,en,CT,ts,Or,MT,ko,ST,Ei,PT,DT,Ud,NT,OT,LT,tn,QT,Bd,IT,WT,Lr,Lp;return w=new Bt({}),V=new Bt({}),rt=new Bt({}),qo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Zk],pytorch:[Jk]},$$scope:{ctx:U}}}),Fo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ay],pytorch:[ty]},$$scope:{ctx:U}}}),Ao=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[iy],pytorch:[ny]},$$scope:{ctx:U}}}),gn=new Bt({}),xo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[cy],pytorch:[dy]},$$scope:{ctx:U}}}),vn=new Bt({}),wn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L106",parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
`}}),Sn=new He({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/tokenization_tapas.py#L396"}}),Pn=new Bt({}),Dn=new He({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hn=new He({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16557/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Bn=new Bt({}),Rn=new He({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new He({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16557/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Jn=new Bt({}),Xn=new He({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),sr=new He({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16557/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
`}}),Ho=new Ms({props:{$$slots:{default:[fy]},$$scope:{ctx:U}}}),pr=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),cr=new Bt({}),hr=new He({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tf_tapas.py#L962",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Bo=new Ms({props:{$$slots:{default:[gy]},$$scope:{ctx:U}}}),gr=new He({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tf_tapas.py#L968",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16557/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),$r=new Bt({}),Er=new He({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tf_tapas.py#L1578",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jo=new Ms({props:{$$slots:{default:[wy]},$$scope:{ctx:U}}}),xr=new He({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/tapas/modeling_tf_tapas.py#L1589",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16557/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("meta"),_=d(),c=o("h1"),f=o("a"),v=o("span"),$(w.$$.fragment),T=d(),y=o("span"),k=s("TAPAS"),D=d(),q=o("h2"),H=o("a"),G=o("span"),$(V.$$.fragment),B=d(),K=o("span"),re=s("Overview"),I=d(),O=o("p"),b=s("The TAPAS model was proposed in "),M=o("a"),R=s("TAPAS: Weakly Supervised Table Parsing via Pre-training"),C=s(`
...
implementation. Original implementation available at `),jn=o("a"),Ku=s("https://github.com/google-research/tapas/tree/master"),Yu=s("."),Ju=d(),Ql=o("p"),Xu=s("Example:"),Zu=d(),$($n.$$.fragment),bp=d(),so=o("h2"),So=o("a"),Il=o("span"),$(En.$$.fragment),em=d(),Wl=o("span"),tm=s("TapasTokenizer"),kp=d(),Ge=o("div"),$(Fn.$$.fragment),sm=d(),Hl=o("p"),am=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
respectively. 0 for all question tokens, special tokens and padding.`),Sm=d(),sd=o("li"),Pm=s(`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
...
wordpiece.`),Im=d(),Po=o("div"),$(An.$$.fragment),Wm=d(),od=o("p"),Hm=s("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Um=d(),Ta=o("div"),$(zn.$$.fragment),Bm=d(),xn=o("p"),Rm=s("Converts logits of "),di=o("a"),Gm=s("TapasForQuestionAnswering"),Vm=s(` to actual predicted answer coordinates and optional
aggregation indices.`),Km=d(),Cn=o("p"),Ym=s(`The original implementation, on which this function is based, can be found
`),Mn=o("a"),Jm=s("here"),Xm=s("."),Zm=d(),pi=o("div"),$(Sn.$$.fragment),yp=d(),ao=o("h2"),Do=o("a"),nd=o("span"),$(Pn.$$.fragment),ef=d(),rd=o("span"),tf=s("TapasModel"),qp=d(),lt=o("div"),$(Dn.$$.fragment),sf=d(),Nn=o("p"),af=s(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),vf=d(),Vt=o("div"),$(Hn.$$.fragment),wf=d(),oo=o("p"),bf=s("The "),ui=o("a"),kf=s("TapasModel"),yf=s(" forward method, overrides the "),id=o("code"),qf=s("__call__"),jf=s(" special method."),$f=d(),$(No.$$.fragment),Ef=d(),ld=o("p"),Ff=s("Examples:"),Af=d(),$(Un.$$.fragment),jp=d(),no=o("h2"),Oo=o("a"),dd=o("span"),$(Bn.$$.fragment),zf=d(),pd=o("span"),xf=s("TapasForMaskedLM"),$p=d(),Ts=o("div"),$(Rn.$$.fragment),Cf=d(),ro=o("p"),Mf=s("Tapas Model with a "),cd=o("code"),Sf=s("language modeling"),Pf=s(` head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cg=d(),Yt=o("div"),$(sr.$$.fragment),hg=d(),po=o("p"),ug=s("The "),_i=o("a"),mg=s("TapasForSequenceClassification"),fg=s(" forward method, overrides the "),_d=o("code"),gg=s("__call__"),_g=s(" special method."),Tg=d(),$(Io.$$.fragment),vg=d(),Td=o("p"),wg=s("Examples:"),bg=d(),$(ar.$$.fragment),Ap=d(),co=o("h2"),Wo=o("a"),vd=o("span"),$(or.$$.fragment),kg=d(),wd=o("span"),yg=s("TapasForQuestionAnswering"),zp=d(),Ut=o("div"),$(nr.$$.fragment),qg=d(),ho=o("p"),jg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),bd=o("code"),$g=s("logits"),Eg=s(" and optional "),kd=o("code"),Fg=s("logits_aggregation"),Ag=s(`), e.g. for
...
behavior.`),i_=d(),$(Bo.$$.fragment),l_=d(),Xt=o("div"),$(gr.$$.fragment),d_=d(),fo=o("p"),p_=s("The "),bi=o("a"),c_=s("TFTapasModel"),h_=s(" forward method, overrides the "),Fd=o("code"),u_=s("__call__"),m_=s(" special method."),f_=d(),$(Ro.$$.fragment),g_=d(),Ad=o("p"),__=s("Examples:"),T_=d(),$(_r.$$.fragment),Mp=d(),go=o("h2"),Go=o("a"),zd=o("span"),$(Tr.$$.fragment),v_=d(),xd=o("span"),w_=s("TFTapasForMaskedLM"),Sp=d(),pt=o("div"),$(vr.$$.fragment),b_=d(),wr=o("p"),k_=s("Tapas Model with a "),Cd=o("code"),y_=s("language modeling"),q_=s(" head on top."),j_=d(),br=o("p"),$_=s("This model inherits from "),ki=o("a"),E_=s("TFPreTrainedModel"),F_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),A_=d(),kr=o("p"),z_=s("This model is also a "),yr=o("a"),x_=s("tf.keras.Model"),C_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),M_=d(),$(Vo.$$.fragment),S_=d(),Zt=o("div"),$(qr.$$.fragment),P_=d(),_o=o("p"),D_=s("The "),yi=o("a"),N_=s("TFTapasForMaskedLM"),O_=s(" forward method, overrides the "),Md=o("code"),L_=s("__call__"),Q_=s(" special method."),I_=d(),$(Ko.$$.fragment),W_=d(),Sd=o("p"),H_=s("Examples:"),U_=d(),$(jr.$$.fragment),Pp=d(),To=o("h2"),Yo=o("a"),Pd=o("span"),$($r.$$.fragment),B_=d(),Dd=o("span"),R_=s("TFTapasForSequenceClassification"),Dp=d(),ct=o("div"),$(Er.$$.fragment),G_=d(),Nd=o("p"),V_=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),aT=d(),$(Jo.$$.fragment),oT=d(),es=o("div"),$(xr.$$.fragment),nT=d(),vo=o("p"),rT=s("The "),ji=o("a"),iT=s("TFTapasForSequenceClassification"),lT=s(" forward method, overrides the "),Od=o("code"),dT=s("__call__"),pT=s(" special method."),cT=d(),$(Xo.$$.fragment),hT=d(),Ld=o("p"),uT=s("Examples:"),mT=d(),$(Cr.$$.fragment),Np=d(),wo=o("h2"),Zo=o("a"),Qd=o("span"),$(Mr.$$.fragment),fT=d(),Id=o("span"),gT=s("TFTapasForQuestionAnswering"),Op=d(),ht=o("div"),$(Sr.$$.fragment),_T=d(),bo=o("p"),TT=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wd=o("code"),vT=s("logits"),wT=s(" and optional "),Hd=o("code"),bT=s("logits_aggregation"),kT=s(`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),yT=d(),Pr=o("p"),qT=s("This model inherits from "),$i=o("a"),jT=s("TFPreTrainedModel"),$T=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ET=d(),Dr=o("p"),FT=s("This model is also a "),Nr=o("a"),AT=s("tf.keras.Model"),zT=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xT=d(),$(en.$$.fragment),CT=d(),ts=o("div"),$(Or.$$.fragment),MT=d(),ko=o("p"),ST=s("The "),Ei=o("a"),PT=s("TFTapasForQuestionAnswering"),DT=s(" forward method, overrides the "),Ud=o("code"),NT=s("__call__"),OT=s(" special method."),LT=d(),$(tn.$$.fragment),QT=d(),Bd=o("p"),IT=s("Examples:"),WT=d(),$(Lr.$$.fragment),this.h()},l(i){const m=Gk('[data-svelte="svelte-1phssyn"]',document.head);l=n(m,"META",{name:!0,content:!0}),m.forEach(t),_=p(i),c=n(i,"H1",{class:!0});var Qr=r(c);f=n(Qr,"A",{id:!0,class:!0,href:!0});var Rd=r(f);v=n(Rd,"SPAN",{});var Gd=r(v);E(w.$$.fragment,Gd),Gd.forEach(t),Rd.forEach(t),T=p(Qr),y=n(Qr,"SPAN",{});var Vd=r(y);k=a(Vd,"TAPAS"),Vd.forEach(t),Qr.forEach(t),D=p(i),q=n(i,"H2",{class:!0});var Ir=r(q);H=n(Ir,"A",{id:!0,class:!0,href:!0});var Kd=r(H);G=n(Kd,"SPAN",{});var Yd=r(G);E(V.$$.fragment,Yd),Yd.forEach(t),Kd.forEach(t),B=p(Ir),K=n(Ir,"SPAN",{});var Jd=r(K);re=a(Jd,"Overview"),Jd.forEach(t),Ir.forEach(t),I=p(i),O=n(i,"P",{});var Wr=r(O);b=a(Wr,"The TAPAS model was proposed in "),M=n(Wr,"A",{href:!0,rel:!0});var Xd=r(M);R=a(Xd,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Xd.forEach(t),C=a(Wr,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Wr.forEach(t),N=p(i),ee=n(i,"P",{});var Zd=r(ee);te=a(Zd,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Zd.forEach(t),ce=p(i),oe=n(i,"UL",{});var yo=r(oe);se=n(yo,"LI",{});var Fi=r(se);S=n(Fi,"A",{href:!0,rel:!0});var ep=r(S);L=a(ep,"SQA"),ep.forEach(t),W=a(Fi," (Sequential Question Answering by Microsoft)"),Fi.forEach(t),X=p(yo),Q=n(yo,"LI",{});var Ai=r(Q);Y=n(Ai,"A",{href:!0,rel:!0});var tp=r(Y);ge=a(tp,"WTQ"),tp.forEach(t),ue=a(Ai," (Wiki Table Questions by Stanford University)"),Ai.forEach(t),_e=p(yo),me=n(yo,"LI",{});var HT=r(me);ne=n(HT,"A",{href:!0,rel:!0});var ev=r(ne);qe=a(ev,"WikiSQL"),ev.forEach(t),ie=a(HT," (by Salesforce)."),HT.forEach(t),yo.forEach(t),we=p(i),g=n(i,"P",{});var tv=r(g);P=a(tv,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),tv.forEach(t),ve=p(i),ze=n(i,"P",{});var sv=r(ze);be=a(sv,"The abstract from the paper is the following:"),sv.forEach(t),le=p(i),xe=n(i,"P",{});var av=r(xe);Me=n(av,"EM",{});var ov=r(Me);Z=a(ov,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),ov.forEach(t),av.forEach(t),de=p(i),pe=n(i,"P",{});var sn=r(pe);De=a(sn,"In addition, the authors have further pre-trained TAPAS to recognize "),je=n(sn,"STRONG",{});var nv=r(je);Te=a(nv,"table entailment"),nv.forEach(t),Ne=a(sn,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=n(sn,"A",{href:!0,rel:!0});var rv=r(ke);Ae=a(rv,"TabFact"),rv.forEach(t),Oe=a(sn,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=n(sn,"A",{href:!0,rel:!0});var iv=r(Ze);Ss=a(iv,"Understanding tables with intermediate pre-training"),iv.forEach(t),Ps=a(sn," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),sn.forEach(t),ut=p(i),mt=n(i,"IMG",{src:!0,alt:!0,width:!0}),ft=p(i),gt=n(i,"SMALL",{});var Qp=r(gt);Ds=a(Qp,"TAPAS architecture. Taken from the "),tt=n(Qp,"A",{href:!0});var lv=r(tt);Ns=a(lv,"original blog post"),lv.forEach(t),Os=a(Qp,"."),Qp.forEach(t),Ke=p(i),Se=n(i,"P",{});var an=r(Se);Ls=a(an,"This model was contributed by "),bt=n(an,"A",{href:!0,rel:!0});var dv=r(bt);ye=a(dv,"nielsr"),dv.forEach(t),kt=a(an,". The Tensorflow version of this model was contributed by "),yt=n(an,"A",{href:!0,rel:!0});var pv=r(yt);Qs=a(pv,"kamalkraj"),pv.forEach(t),qt=a(an,". The original code can be found "),jt=n(an,"A",{href:!0,rel:!0});var cv=r(jt);Is=a(cv,"here"),cv.forEach(t),$t=a(an,"."),an.forEach(t),vs=p(i),Rt=n(i,"P",{});var hv=r(Rt);Et=a(hv,"Tips:"),hv.forEach(t),ws=p(i),Ye=n(i,"UL",{});var on=r(Ye);$e=n(on,"LI",{});var ss=r($e);Ws=a(ss,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),Ft=n(ss,"CODE",{});var uv=r(Ft);ae=a(uv,"reset_position_index_per_cell"),uv.forEach(t),ot=a(ss," parameter of "),Gt=n(ss,"A",{href:!0});var mv=r(Gt);Hs=a(mv,"TapasConfig"),mv.forEach(t),At=a(ss,", which is set to "),os=n(ss,"CODE",{});var fv=r(os);Us=a(fv,"True"),fv.forEach(t),zt=a(ss," by default. The default versions of the models available on the "),xt=n(ss,"A",{href:!0,rel:!0});var gv=r(xt);Bs=a(gv,"hub"),gv.forEach(t),Ct=a(ss," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),ns=n(ss,"CODE",{});var _v=r(ns);Rs=a(_v,'revision="no_reset"'),_v.forEach(t),Mt=a(ss," when calling the "),rs=n(ss,"CODE",{});var Tv=r(rs);Gs=a(Tv,"from_pretrained()"),Tv.forEach(t),St=a(ss," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),ss.forEach(t),Vs=p(on),Le=n(on,"LI",{});var js=r(Le);Pt=a(js,"TAPAS is based on BERT, so "),is=n(js,"CODE",{});var vv=r(is);Ks=a(vv,"TAPAS-base"),vv.forEach(t),Dt=a(js," for example corresponds to a "),ls=n(js,"CODE",{});var wv=r(ls);Ys=a(wv,"BERT-base"),wv.forEach(t),ds=a(js," architecture. Of course, "),Ue=n(js,"CODE",{});var bv=r(Ue);ps=a(bv,"TAPAS-large"),bv.forEach(t),Ee=a(js," will result in the best performance (the results reported in the paper are from "),cs=n(js,"CODE",{});var kv=r(cs);nt=a(kv,"TAPAS-large"),kv.forEach(t),Js=a(js,"). Results of the various sized models are shown on the "),Nt=n(js,"A",{href:!0,rel:!0});var yv=r(Nt);Ot=a(yv,"original Github repository"),yv.forEach(t),Xs=a(js,"."),js.forEach(t),Zs=p(on),Be=n(on,"LI",{});var zi=r(Be);ea=a(zi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),hs=n(zi,"CODE",{});var qv=r(hs);us=a(qv,"prev_labels"),qv.forEach(t),et=a(zi," token type ids can be overwritten by the predicted "),Lt=n(zi,"CODE",{});var jv=r(Lt);j=a(jv,"labels"),jv.forEach(t),J=a(zi," of the model to the previous question. See \u201CUsage\u201D section for more info."),zi.forEach(t),xa=p(on),ta=n(on,"LI",{});var $v=r(ta);Ca=a($v,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),$v.forEach(t),on.forEach(t),ca=p(i),Qt=n(i,"H2",{class:!0});var Ip=r(Qt);st=n(Ip,"A",{id:!0,class:!0,href:!0});var Ev=r(st);sa=n(Ev,"SPAN",{});var Fv=r(sa);E(rt.$$.fragment,Fv),Fv.forEach(t),Ev.forEach(t),Ma=p(Ip),aa=n(Ip,"SPAN",{});var Av=r(aa);Sa=a(Av,"Usage: fine-tuning"),Av.forEach(t),Ip.forEach(t),ha=p(i),Ie=n(i,"P",{});var Wp=r(Ie);ms=a(Wp,"Here we explain how you can fine-tune "),bs=n(Wp,"A",{href:!0});var zv=r(bs);Re=a(zv,"TapasForQuestionAnswering"),zv.forEach(t),Pa=a(Wp," on your own dataset."),Wp.forEach(t),ua=p(i),ks=n(i,"P",{});var xv=r(ks);oa=n(xv,"STRONG",{});var Cv=r(oa);fs=a(Cv,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),Cv.forEach(t),xv.forEach(t),ma=p(i),fe=n(i,"P",{});var Hp=r(fe);Da=a(Hp,"Basically, there are 3 different ways in which one can fine-tune "),ys=n(Hp,"A",{href:!0});var Mv=r(ys);Na=a(Mv,"TapasForQuestionAnswering"),Mv.forEach(t),Oa=a(Hp,", corresponding to the different datasets on which Tapas was fine-tuned:"),Hp.forEach(t),fa=p(i),_t=n(i,"OL",{});var xi=r(_t);na=n(xi,"LI",{});var Sv=r(na);gs=a(Sv,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),Sv.forEach(t),La=p(xi),Fe=n(xi,"LI",{});var Up=r(Fe);Qa=a(Up,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=n(Up,"STRONG",{});var Pv=r(ra);Ia=a(Pv,"weak supervision"),Pv.forEach(t),Wa=a(Up,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Up.forEach(t),Ha=p(xi),he=n(xi,"LI",{});var Bp=r(he);Ua=a(Bp,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=n(Bp,"STRONG",{});var Dv=r(ia);Ba=a(Dv,"strong supervision"),Dv.forEach(t),Ra=a(Bp,". Here, learning the appropriate aggregation operator is much easier."),Bp.forEach(t),xi.forEach(t),ga=p(i),qs=n(i,"P",{});var Nv=r(qs);Ga=a(Nv,"To summarize:"),Nv.forEach(t),_a=p(i),Ce=n(i,"TABLE",{});var Rp=r(Ce);la=n(Rp,"THEAD",{});var Ov=r(la);It=n(Ov,"TR",{});var Ci=r(It);da=n(Ci,"TH",{});var Lv=r(da);Ki=n(Lv,"STRONG",{});var Qv=r(Ki);Mc=a(Qv,"Task"),Qv.forEach(t),Lv.forEach(t),Sc=p(Ci),Yi=n(Ci,"TH",{});var Iv=r(Yi);Ji=n(Iv,"STRONG",{});var Wv=r(Ji);Pc=a(Wv,"Example dataset"),Wv.forEach(t),Iv.forEach(t),Dc=p(Ci),Xi=n(Ci,"TH",{});var Hv=r(Xi);Zi=n(Hv,"STRONG",{});var Uv=r(Zi);Nc=a(Uv,"Description"),Uv.forEach(t),Hv.forEach(t),Ci.forEach(t),Ov.forEach(t),Oc=p(Rp),Va=n(Rp,"TBODY",{});var Mi=r(Va);Ka=n(Mi,"TR",{});var Si=r(Ka);el=n(Si,"TD",{});var Bv=r(el);Lc=a(Bv,"Conversational"),Bv.forEach(t),Qc=p(Si),tl=n(Si,"TD",{});var Rv=r(tl);Ic=a(Rv,"SQA"),Rv.forEach(t),Wc=p(Si),sl=n(Si,"TD",{});var Gv=r(sl);Hc=a(Gv,"Conversational, only cell selection questions"),Gv.forEach(t),Si.forEach(t),Uc=p(Mi),Ya=n(Mi,"TR",{});var Pi=r(Ya);al=n(Pi,"TD",{});var Vv=r(al);Bc=a(Vv,"Weak supervision for aggregation"),Vv.forEach(t),Rc=p(Pi),ol=n(Pi,"TD",{});var Kv=r(ol);Gc=a(Kv,"WTQ"),Kv.forEach(t),Vc=p(Pi),nl=n(Pi,"TD",{});var Yv=r(nl);Kc=a(Yv,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Yv.forEach(t),Pi.forEach(t),Yc=p(Mi),Ja=n(Mi,"TR",{});var Di=r(Ja);rl=n(Di,"TD",{});var Jv=r(rl);Jc=a(Jv,"Strong supervision for aggregation"),Jv.forEach(t),Xc=p(Di),il=n(Di,"TD",{});var Xv=r(il);Zc=a(Xv,"WikiSQL-supervised"),Xv.forEach(t),eh=p(Di),ll=n(Di,"TD",{});var Zv=r(ll);th=a(Zv,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),Zv.forEach(t),Di.forEach(t),Mi.forEach(t),Rp.forEach(t),sp=p(i),E(qo.$$.fragment,i),ap=p(i),jo=n(i,"P",{});var Gp=r(jo);sh=a(Gp,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),dn=n(Gp,"A",{href:!0,rel:!0});var ew=r(dn);ah=a(ew,"here"),ew.forEach(t),oh=a(Gp," for more info."),Gp.forEach(t),op=p(i),$o=n(i,"P",{});var Vp=r($o);nh=a(Vp,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),pn=n(Vp,"A",{href:!0,rel:!0});var tw=r(pn);rh=a(tw,"here"),tw.forEach(t),ih=a(Vp,"."),Vp.forEach(t),np=p(i),Hr=n(i,"P",{});var sw=r(Hr);dl=n(sw,"STRONG",{});var aw=r(dl);lh=a(aw,"STEP 2: Prepare your data in the SQA format"),aw.forEach(t),sw.forEach(t),rp=p(i),Eo=n(i,"P",{});var Kp=r(Eo);dh=a(Kp,"Second, no matter what you picked above, you should prepare your dataset in the "),cn=n(Kp,"A",{href:!0,rel:!0});var ow=r(cn);ph=a(ow,"SQA"),ow.forEach(t),ch=a(Kp," format. This format is a TSV/CSV file with the following columns:"),Kp.forEach(t),ip=p(i),We=n(i,"UL",{});var at=r(We);Ur=n(at,"LI",{});var UT=r(Ur);pl=n(UT,"CODE",{});var nw=r(pl);hh=a(nw,"id"),nw.forEach(t),uh=a(UT,": optional, id of the table-question pair, for bookkeeping purposes."),UT.forEach(t),mh=p(at),Br=n(at,"LI",{});var BT=r(Br);cl=n(BT,"CODE",{});var rw=r(cl);fh=a(rw,"annotator"),rw.forEach(t),gh=a(BT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),BT.forEach(t),_h=p(at),Rr=n(at,"LI",{});var RT=r(Rr);hl=n(RT,"CODE",{});var iw=r(hl);Th=a(iw,"position"),iw.forEach(t),vh=a(RT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),RT.forEach(t),wh=p(at),Gr=n(at,"LI",{});var GT=r(Gr);ul=n(GT,"CODE",{});var lw=r(ul);bh=a(lw,"question"),lw.forEach(t),kh=a(GT,": string"),GT.forEach(t),yh=p(at),Vr=n(at,"LI",{});var VT=r(Vr);ml=n(VT,"CODE",{});var dw=r(ml);qh=a(dw,"table_file"),dw.forEach(t),jh=a(VT,": string, name of a csv file containing the tabular data"),VT.forEach(t),$h=p(at),Kr=n(at,"LI",{});var KT=r(Kr);fl=n(KT,"CODE",{});var pw=r(fl);Eh=a(pw,"answer_coordinates"),pw.forEach(t),Fh=a(KT,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),KT.forEach(t),Ah=p(at),Yr=n(at,"LI",{});var YT=r(Yr);gl=n(YT,"CODE",{});var cw=r(gl);zh=a(cw,"answer_text"),cw.forEach(t),xh=a(YT,": list of one or more strings (each string being a cell value that is part of the answer)"),YT.forEach(t),Ch=p(at),Jr=n(at,"LI",{});var JT=r(Jr);_l=n(JT,"CODE",{});var hw=r(_l);Mh=a(hw,"aggregation_label"),hw.forEach(t),Sh=a(JT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),JT.forEach(t),Ph=p(at),Xr=n(at,"LI",{});var XT=r(Xr);Tl=n(XT,"CODE",{});var uw=r(Tl);Dh=a(uw,"float_answer"),uw.forEach(t),Nh=a(XT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),XT.forEach(t),at.forEach(t),lp=p(i),Tt=n(i,"P",{});var $s=r(Tt);Oh=a($s,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),hn=n($s,"A",{href:!0,rel:!0});var mw=r(hn);Lh=a(mw,"here"),mw.forEach(t),Qh=a($s,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),un=n($s,"A",{href:!0,rel:!0});var fw=r(un);Ih=a(fw,"here"),fw.forEach(t),Wh=a($s,". Interestingly, these conversion scripts are not perfect (the "),vl=n($s,"CODE",{});var gw=r(vl);Hh=a(gw,"answer_coordinates"),gw.forEach(t),Uh=a($s," and "),wl=n($s,"CODE",{});var _w=r(wl);Bh=a(_w,"float_answer"),_w.forEach(t),Rh=a($s," fields are populated based on the "),bl=n($s,"CODE",{});var Tw=r(bl);Gh=a(Tw,"answer_text"),Tw.forEach(t),Vh=a($s,"), meaning that WTQ and WikiSQL results could actually be improved."),$s.forEach(t),dp=p(i),Zr=n(i,"P",{});var vw=r(Zr);kl=n(vw,"STRONG",{});var ww=r(kl);Kh=a(ww,"STEP 3: Convert your data into tensors using TapasTokenizer"),ww.forEach(t),vw.forEach(t),pp=p(i),E(Fo.$$.fragment,i),cp=p(i),Pe=n(i,"P",{});var Je=r(Pe);Yh=a(Je,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),yl=n(Je,"STRONG",{});var bw=r(yl);Jh=a(bw,"not conversational"),bw.forEach(t),Xh=a(Je,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),ql=n(Je,"CODE",{});var kw=r(ql);Zh=a(kw,"queries"),kw.forEach(t),eu=a(Je,", "),jl=n(Je,"CODE",{});var yw=r(jl);tu=a(yw,"answer_coordinates"),yw.forEach(t),su=a(Je," and "),$l=n(Je,"CODE",{});var qw=r($l);au=a(qw,"answer_text"),qw.forEach(t),ou=a(Je," per table (in the order of their "),El=n(Je,"CODE",{});var jw=r(El);nu=a(jw,"position"),jw.forEach(t),ru=a(Je,`
index) and batch encode each table with its questions. This will make sure that the `),Fl=n(Je,"CODE",{});var $w=r(Fl);iu=a($w,"prev_labels"),$w.forEach(t),lu=a(Je," token types (see docs of "),ei=n(Je,"A",{href:!0});var Ew=r(ei);du=a(Ew,"TapasTokenizer"),Ew.forEach(t),pu=a(Je,") are set correctly. See "),mn=n(Je,"A",{href:!0,rel:!0});var Fw=r(mn);cu=a(Fw,"this notebook"),Fw.forEach(t),hu=a(Je," for more info. See "),fn=n(Je,"A",{href:!0,rel:!0});var Aw=r(fn);uu=a(Aw,"this notebook"),Aw.forEach(t),mu=a(Je," for more info regarding using the TensorFlow model."),Je.forEach(t),hp=p(i),ti=n(i,"P",{});var zw=r(ti);fu=a(zw,"**STEP 4: Train (fine-tune) the model"),zw.forEach(t),up=p(i),E(Ao.$$.fragment,i),mp=p(i),Xa=n(i,"H2",{class:!0});var Yp=r(Xa);zo=n(Yp,"A",{id:!0,class:!0,href:!0});var xw=r(zo);Al=n(xw,"SPAN",{});var Cw=r(Al);E(gn.$$.fragment,Cw),Cw.forEach(t),xw.forEach(t),gu=p(Yp),zl=n(Yp,"SPAN",{});var Mw=r(zl);_u=a(Mw,"Usage: inference"),Mw.forEach(t),Yp.forEach(t),fp=p(i),E(xo.$$.fragment,i),gp=p(i),vt=n(i,"P",{});var Es=r(vt);Tu=a(Es,"In case of a conversational set-up, then each table-question pair must be provided "),xl=n(Es,"STRONG",{});var Sw=r(xl);vu=a(Sw,"sequentially"),Sw.forEach(t),wu=a(Es," to the model, such that the "),Cl=n(Es,"CODE",{});var Pw=r(Cl);bu=a(Pw,"prev_labels"),Pw.forEach(t),ku=a(Es," token types can be overwritten by the predicted "),Ml=n(Es,"CODE",{});var Dw=r(Ml);yu=a(Dw,"labels"),Dw.forEach(t),qu=a(Es," of the previous table-question pair. Again, more info can be found in "),_n=n(Es,"A",{href:!0,rel:!0});var Nw=r(_n);ju=a(Nw,"this notebook"),Nw.forEach(t),$u=a(Es," (for PyTorch) and "),Tn=n(Es,"A",{href:!0,rel:!0});var Ow=r(Tn);Eu=a(Ow,"this notebook"),Ow.forEach(t),Fu=a(Es," (for TensorFlow)."),Es.forEach(t),_p=p(i),Za=n(i,"H2",{class:!0});var Jp=r(Za);Co=n(Jp,"A",{id:!0,class:!0,href:!0});var Lw=r(Co);Sl=n(Lw,"SPAN",{});var Qw=r(Sl);E(vn.$$.fragment,Qw),Qw.forEach(t),Lw.forEach(t),Au=p(Jp),Pl=n(Jp,"SPAN",{});var Iw=r(Pl);zu=a(Iw,"TAPAS specific outputs"),Iw.forEach(t),Jp.forEach(t),Tp=p(i),eo=n(i,"DIV",{class:!0});var Xp=r(eo);E(wn.$$.fragment,Xp),xu=p(Xp),bn=n(Xp,"P",{});var Zp=r(bn);Cu=a(Zp,"Output type of "),si=n(Zp,"A",{href:!0});var Ww=r(si);Mu=a(Ww,"TapasForQuestionAnswering"),Ww.forEach(t),Su=a(Zp,"."),Zp.forEach(t),Xp.forEach(t),vp=p(i),to=n(i,"H2",{class:!0});var ec=r(to);Mo=n(ec,"A",{id:!0,class:!0,href:!0});var Hw=r(Mo);Dl=n(Hw,"SPAN",{});var Uw=r(Dl);E(kn.$$.fragment,Uw),Uw.forEach(t),Hw.forEach(t),Pu=p(ec),Nl=n(ec,"SPAN",{});var Bw=r(Nl);Du=a(Bw,"TapasConfig"),Bw.forEach(t),ec.forEach(t),wp=p(i),Wt=n(i,"DIV",{class:!0});var va=r(Wt);E(yn.$$.fragment,va),Nu=p(va),_s=n(va,"P",{});var wa=r(_s);Ou=a(wa,"This is the configuration class to store the configuration of a "),ai=n(wa,"A",{href:!0});var Rw=r(ai);Lu=a(Rw,"TapasModel"),Rw.forEach(t),Qu=a(wa,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS `),Ol=n(wa,"EM",{});var Gw=r(Ol);Iu=a(Gw,"tapas-base-finetuned-sqa"),Gw.forEach(t),Wu=a(wa,` architecture.
Configuration objects inherit from `),Ll=n(wa,"CODE",{});var Vw=r(Ll);Hu=a(Vw,"PreTrainedConfig"),Vw.forEach(t),Uu=a(wa,` and can be used to control the model outputs. Read the
documentation from `),oi=n(wa,"A",{href:!0});var Kw=r(oi);Bu=a(Kw,"PretrainedConfig"),Kw.forEach(t),Ru=a(wa," for more information."),wa.forEach(t),Gu=p(va),qn=n(va,"P",{});var tc=r(qn);Vu=a(tc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),jn=n(tc,"A",{href:!0,rel:!0});var Yw=r(jn);Ku=a(Yw,"https://github.com/google-research/tapas/tree/master"),Yw.forEach(t),Yu=a(tc,"."),tc.forEach(t),Ju=p(va),Ql=n(va,"P",{});var Jw=r(Ql);Xu=a(Jw,"Example:"),Jw.forEach(t),Zu=p(va),E($n.$$.fragment,va),va.forEach(t),bp=p(i),so=n(i,"H2",{class:!0});var sc=r(so);So=n(sc,"A",{id:!0,class:!0,href:!0});var Xw=r(So);Il=n(Xw,"SPAN",{});var Zw=r(Il);E(En.$$.fragment,Zw),Zw.forEach(t),Xw.forEach(t),em=p(sc),Wl=n(sc,"SPAN",{});var eb=r(Wl);tm=a(eb,"TapasTokenizer"),eb.forEach(t),sc.forEach(t),kp=p(i),Ge=n(i,"DIV",{class:!0});var wt=r(Ge);E(Fn.$$.fragment,wt),sm=p(wt),Hl=n(wt,"P",{});var tb=r(Hl);am=a(tb,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),tb.forEach(t),om=p(wt),Qe=n(wt,"P",{});var Xe=r(Qe);nm=a(Xe,"This tokenizer inherits from "),ni=n(Xe,"A",{href:!0});var sb=r(ni);rm=a(sb,"PreTrainedTokenizer"),sb.forEach(t),im=a(Xe,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),ri=n(Xe,"A",{href:!0});var ab=r(ri);lm=a(ab,"TapasTokenizer"),ab.forEach(t),dm=a(Xe,` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Ul=n(Xe,"CODE",{});var ob=r(Ul);pm=a(ob,"segment_ids"),ob.forEach(t),cm=a(Xe,`,
`),Bl=n(Xe,"CODE",{});var nb=r(Bl);hm=a(nb,"column_ids"),nb.forEach(t),um=a(Xe,", "),Rl=n(Xe,"CODE",{});var rb=r(Rl);mm=a(rb,"row_ids"),rb.forEach(t),fm=a(Xe,", "),Gl=n(Xe,"CODE",{});var ib=r(Gl);gm=a(ib,"prev_labels"),ib.forEach(t),_m=a(Xe,", "),Vl=n(Xe,"CODE",{});var lb=r(Vl);Tm=a(lb,"column_ranks"),lb.forEach(t),vm=a(Xe,", "),Kl=n(Xe,"CODE",{});var db=r(Kl);wm=a(db,"inv_column_ranks"),db.forEach(t),bm=a(Xe," and "),Yl=n(Xe,"CODE",{});var pb=r(Yl);km=a(pb,"numeric_relations"),pb.forEach(t),ym=a(Xe,":"),Xe.forEach(t),qm=p(wt),it=n(wt,"UL",{});var as=r(it);Jl=n(as,"LI",{});var cb=r(Jl);jm=a(cb,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),cb.forEach(t),$m=p(as),Xl=n(as,"LI",{});var hb=r(Xl);Em=a(hb,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),hb.forEach(t),Fm=p(as),Zl=n(as,"LI",{});var ub=r(Zl);Am=a(ub,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),ub.forEach(t),zm=p(as),ed=n(as,"LI",{});var mb=r(ed);xm=a(mb,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),mb.forEach(t),Cm=p(as),td=n(as,"LI",{});var fb=r(td);Mm=a(fb,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),fb.forEach(t),Sm=p(as),sd=n(as,"LI",{});var gb=r(sd);Pm=a(gb,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),gb.forEach(t),Dm=p(as),ad=n(as,"LI",{});var _b=r(ad);Nm=a(_b,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),_b.forEach(t),as.forEach(t),Om=p(wt),ii=n(wt,"P",{});var ZT=r(ii);li=n(ZT,"A",{href:!0});var Tb=r(li);Lm=a(Tb,"TapasTokenizer"),Tb.forEach(t),Qm=a(ZT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),ZT.forEach(t),Im=p(wt),Po=n(wt,"DIV",{class:!0});var ac=r(Po);E(An.$$.fragment,ac),Wm=p(ac),od=n(ac,"P",{});var vb=r(od);Hm=a(vb,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),vb.forEach(t),ac.forEach(t),Um=p(wt),Ta=n(wt,"DIV",{class:!0});var Ni=r(Ta);E(zn.$$.fragment,Ni),Bm=p(Ni),xn=n(Ni,"P",{});var oc=r(xn);Rm=a(oc,"Converts logits of "),di=n(oc,"A",{href:!0});var wb=r(di);Gm=a(wb,"TapasForQuestionAnswering"),wb.forEach(t),Vm=a(oc,` to actual predicted answer coordinates and optional
...
`),Mn=n(nc,"A",{href:!0,rel:!0});var bb=r(Mn);Jm=a(bb,"here"),bb.forEach(t),Xm=a(nc,"."),nc.forEach(t),Ni.forEach(t),Zm=p(wt),pi=n(wt,"DIV",{class:!0});var kb=r(pi);E(Sn.$$.fragment,kb),kb.forEach(t),wt.forEach(t),yp=p(i),ao=n(i,"H2",{class:!0});var rc=r(ao);Do=n(rc,"A",{id:!0,class:!0,href:!0});var yb=r(Do);nd=n(yb,"SPAN",{});var qb=r(nd);E(Pn.$$.fragment,qb),qb.forEach(t),yb.forEach(t),ef=p(rc),rd=n(rc,"SPAN",{});var jb=r(rd);tf=a(jb,"TapasModel"),jb.forEach(t),rc.forEach(t),qp=p(i),lt=n(i,"DIV",{class:!0});var Fs=r(lt);E(Dn.$$.fragment,Fs),sf=p(Fs),Nn=n(Fs,"P",{});var ic=r(Nn);af=a(ic,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ci=n(ic,"A",{href:!0});var $b=r(ci);of=a($b,"PreTrainedModel"),$b.forEach(t),nf=a(ic,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ic.forEach(t),rf=p(Fs),On=n(Fs,"P",{});var lc=r(On);lf=a(lc,"This model is also a PyTorch "),Ln=n(lc,"A",{href:!0,rel:!0});var Eb=r(Ln);df=a(Eb,"torch.nn.Module"),Eb.forEach(t),pf=a(lc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc.forEach(t),cf=p(Fs),Qn=n(Fs,"P",{});var dc=r(Qn);hf=a(dc,"This class is a small change compared to "),hi=n(dc,"A",{href:!0});var Fb=r(hi);uf=a(Fb,"BertModel"),Fb.forEach(t),mf=a(dc,", taking into account the additional token type ids."),dc.forEach(t),ff=p(Fs),In=n(Fs,"P",{});var pc=r(In);gf=a(pc,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),Wn=n(pc,"A",{href:!0,rel:!0});var Ab=r(Wn);_f=a(Ab,`Attention is
all you need`),Ab.forEach(t),Tf=a(pc,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),pc.forEach(t),vf=p(Fs),Vt=n(Fs,"DIV",{class:!0});var ba=r(Vt);E(Hn.$$.fragment,ba),wf=p(ba),oo=n(ba,"P",{});var Oi=r(oo);bf=a(Oi,"The "),ui=n(Oi,"A",{href:!0});var zb=r(ui);kf=a(zb,"TapasModel"),zb.forEach(t),yf=a(Oi," forward method, overrides the "),id=n(Oi,"CODE",{});var xb=r(id);qf=a(xb,"__call__"),xb.forEach(t),jf=a(Oi," special method."),Oi.forEach(t),$f=p(ba),E(No.$$.fragment,ba),Ef=p(ba),ld=n(ba,"P",{});var Cb=r(ld);Ff=a(Cb,"Examples:"),Cb.forEach(t),Af=p(ba),E(Un.$$.fragment,ba),ba.forEach(t),Fs.forEach(t),jp=p(i),no=n(i,"H2",{class:!0});var cc=r(no);Oo=n(cc,"A",{id:!0,class:!0,href:!0});var Mb=r(Oo);dd=n(Mb,"SPAN",{});var Sb=r(dd);E(Bn.$$.fragment,Sb),Sb.forEach(t),Mb.forEach(t),zf=p(cc),pd=n(cc,"SPAN",{});var Pb=r(pd);xf=a(Pb,"TapasForMaskedLM"),Pb.forEach(t),cc.forEach(t),$p=p(i),Ts=n(i,"DIV",{class:!0});var nn=r(Ts);E(Rn.$$.fragment,nn),Cf=p(nn),ro=n(nn,"P",{});var Li=r(ro);Mf=a(Li,"Tapas Model with a "),cd=n(Li,"CODE",{});var Db=r(cd);Sf=a(Db,"language modeling"),Db.forEach(t),Pf=a(Li,` head on top.
This model inherits from `),mi=n(Li,"A",{href:!0});var Nb=r(mi);Df=a(Nb,"PreTrainedModel"),Nb.forEach(t),Nf=a(Li,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Li.forEach(t),Of=p(nn),Gn=n(nn,"P",{});var hc=r(Gn);Lf=a(hc,"This model is also a PyTorch "),Vn=n(hc,"A",{href:!0,rel:!0});var Ob=r(Vn);Qf=a(Ob,"torch.nn.Module"),Ob.forEach(t),If=a(hc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hc.forEach(t),Wf=p(nn),Kt=n(nn,"DIV",{class:!0});var ka=r(Kt);E(Kn.$$.fragment,ka),Hf=p(ka),io=n(ka,"P",{});var Qi=r(io);Uf=a(Qi,"The "),fi=n(Qi,"A",{href:!0});var Lb=r(fi);Bf=a(Lb,"TapasForMaskedLM"),Lb.forEach(t),Rf=a(Qi," forward method, overrides the "),hd=n(Qi,"CODE",{});var Qb=r(hd);Gf=a(Qb,"__call__"),Qb.forEach(t),Vf=a(Qi," special method."),Qi.forEach(t),Kf=p(ka),E(Lo.$$.fragment,ka),Yf=p(ka),ud=n(ka,"P",{});var Ib=r(ud);Jf=a(Ib,"Examples:"),Ib.forEach(t),Xf=p(ka),E(Yn.$$.fragment,ka),ka.forEach(t),nn.forEach(t),Ep=p(i),lo=n(i,"H2",{class:!0});var uc=r(lo);Qo=n(uc,"A",{id:!0,class:!0,href:!0});var Wb=r(Qo);md=n(Wb,"SPAN",{});var Hb=r(md);E(Jn.$$.fragment,Hb),Hb.forEach(t),Wb.forEach(t),Zf=p(uc),fd=n(uc,"SPAN",{});var Ub=r(fd);eg=a(Ub,"TapasForSequenceClassification"),Ub.forEach(t),uc.forEach(t),Fp=p(i),Ht=n(i,"DIV",{class:!0});var ya=r(Ht);E(Xn.$$.fragment,ya),tg=p(ya),gd=n(ya,"P",{});var Bb=r(gd);sg=a(Bb,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Bb.forEach(t),ag=p(ya),Zn=n(ya,"P",{});var mc=r(Zn);og=a(mc,"This model inherits from "),gi=n(mc,"A",{href:!0});var Rb=r(gi);ng=a(Rb,"PreTrainedModel"),Rb.forEach(t),rg=a(mc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mc.forEach(t),ig=p(ya),er=n(ya,"P",{});var fc=r(er);lg=a(fc,"This model is also a PyTorch "),tr=n(fc,"A",{href:!0,rel:!0});var Gb=r(tr);dg=a(Gb,"torch.nn.Module"),Gb.forEach(t),pg=a(fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fc.forEach(t),cg=p(ya),Yt=n(ya,"DIV",{class:!0});var qa=r(Yt);E(sr.$$.fragment,qa),hg=p(qa),po=n(qa,"P",{});var Ii=r(po);ug=a(Ii,"The "),_i=n(Ii,"A",{href:!0});var Vb=r(_i);mg=a(Vb,"TapasForSequenceClassification"),Vb.forEach(t),fg=a(Ii," forward method, overrides the "),_d=n(Ii,"CODE",{});var Kb=r(_d);gg=a(Kb,"__call__"),Kb.forEach(t),_g=a(Ii," special method."),Ii.forEach(t),Tg=p(qa),E(Io.$$.fragment,qa),vg=p(qa),Td=n(qa,"P",{});var Yb=r(Td);wg=a(Yb,"Examples:"),Yb.forEach(t),bg=p(qa),E(ar.$$.fragment,qa),qa.forEach(t),ya.forEach(t),Ap=p(i),co=n(i,"H2",{class:!0});var gc=r(co);Wo=n(gc,"A",{id:!0,class:!0,href:!0});var Jb=r(Wo);vd=n(Jb,"SPAN",{});var Xb=r(vd);E(or.$$.fragment,Xb),Xb.forEach(t),Jb.forEach(t),kg=p(gc),wd=n(gc,"SPAN",{});var Zb=r(wd);yg=a(Zb,"TapasForQuestionAnswering"),Zb.forEach(t),gc.forEach(t),zp=p(i),Ut=n(i,"DIV",{class:!0});var ja=r(Ut);E(nr.$$.fragment,ja),qg=p(ja),ho=n(ja,"P",{});var Wi=r(ho);jg=a(Wi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),bd=n(Wi,"CODE",{});var ek=r(bd);$g=a(ek,"logits"),ek.forEach(t),Eg=a(Wi," and optional "),kd=n(Wi,"CODE",{});var tk=r(kd);Fg=a(tk,"logits_aggregation"),tk.forEach(t),Ag=a(Wi,`), e.g. for
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_c.forEach(t),Sg=p(ja),ir=n(ja,"P",{});var Tc=r(ir);Pg=a(Tc,"This model is also a PyTorch "),lr=n(Tc,"A",{href:!0,rel:!0});var ak=r(lr);Dg=a(ak,"torch.nn.Module"),ak.forEach(t),Ng=a(Tc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),Og=p(ja),Jt=n(ja,"DIV",{class:!0});var $a=r(Jt);E(dr.$$.fragment,$a),Lg=p($a),uo=n($a,"P",{});var Hi=r(uo);Qg=a(Hi,"The "),vi=n(Hi,"A",{href:!0});var ok=r(vi);Ig=a(ok,"TapasForQuestionAnswering"),ok.forEach(t),Wg=a(Hi," forward method, overrides the "),yd=n(Hi,"CODE",{});var nk=r(yd);Hg=a(nk,"__call__"),nk.forEach(t),Ug=a(Hi," special method."),Hi.forEach(t),Bg=p($a),E(Ho.$$.fragment,$a),Rg=p($a),qd=n($a,"P",{});var rk=r(qd);Gg=a(rk,"Examples:"),rk.forEach(t),Vg=p($a),E(pr.$$.fragment,$a),$a.forEach(t),ja.forEach(t),xp=p(i),mo=n(i,"H2",{class:!0});var vc=r(mo);Uo=n(vc,"A",{id:!0,class:!0,href:!0});var ik=r(Uo);jd=n(ik,"SPAN",{});var lk=r(jd);E(cr.$$.fragment,lk),lk.forEach(t),ik.forEach(t),Kg=p(vc),$d=n(vc,"SPAN",{});var dk=r($d);Yg=a(dk,"TFTapasModel"),dk.forEach(t),vc.forEach(t),Cp=p(i),dt=n(i,"DIV",{class:!0});var As=r(dt);E(hr.$$.fragment,As),Jg=p(As),Ed=n(As,"P",{});var pk=r(Ed);Xg=a(pk,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),pk.forEach(t),Zg=p(As),ur=n(As,"P",{});var wc=r(ur);e_=a(wc,"This model inherits from "),wi=n(wc,"A",{href:!0});var ck=r(wi);t_=a(ck,"TFPreTrainedModel"),ck.forEach(t),s_=a(wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wc.forEach(t),a_=p(As),mr=n(As,"P",{});var bc=r(mr);o_=a(bc,"This model is also a "),fr=n(bc,"A",{href:!0,rel:!0});var hk=r(fr);n_=a(hk,"tf.keras.Model"),hk.forEach(t),r_=a(bc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bc.forEach(t),i_=p(As),E(Bo.$$.fragment,As),l_=p(As),Xt=n(As,"DIV",{class:!0});var Ea=r(Xt);E(gr.$$.fragment,Ea),d_=p(Ea),fo=n(Ea,"P",{});var Ui=r(fo);p_=a(Ui,"The "),bi=n(Ui,"A",{href:!0});var uk=r(bi);c_=a(uk,"TFTapasModel"),uk.forEach(t),h_=a(Ui," forward method, overrides the "),Fd=n(Ui,"CODE",{});var mk=r(Fd);u_=a(mk,"__call__"),mk.forEach(t),m_=a(Ui," special method."),Ui.forEach(t),f_=p(Ea),E(Ro.$$.fragment,Ea),g_=p(Ea),Ad=n(Ea,"P",{});var fk=r(Ad);__=a(fk,"Examples:"),fk.forEach(t),T_=p(Ea),E(_r.$$.fragment,Ea),Ea.forEach(t),As.forEach(t),Mp=p(i),go=n(i,"H2",{class:!0});var kc=r(go);Go=n(kc,"A",{id:!0,class:!0,href:!0});var gk=r(Go);zd=n(gk,"SPAN",{});var _k=r(zd);E(Tr.$$.fragment,_k),_k.forEach(t),gk.forEach(t),v_=p(kc),xd=n(kc,"SPAN",{});var Tk=r(xd);w_=a(Tk,"TFTapasForMaskedLM"),Tk.forEach(t),kc.forEach(t),Sp=p(i),pt=n(i,"DIV",{class:!0});var zs=r(pt);E(vr.$$.fragment,zs),b_=p(zs),wr=n(zs,"P",{});var yc=r(wr);k_=a(yc,"Tapas Model with a "),Cd=n(yc,"CODE",{});var vk=r(Cd);y_=a(vk,"language modeling"),vk.forEach(t),q_=a(yc," head on top."),yc.forEach(t),j_=p(zs),br=n(zs,"P",{});var qc=r(br);$_=a(qc,"This model inherits from "),ki=n(qc,"A",{href:!0});var wk=r(ki);E_=a(wk,"TFPreTrainedModel"),wk.forEach(t),F_=a(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qc.forEach(t),A_=p(zs),kr=n(zs,"P",{});var jc=r(kr);z_=a(jc,"This model is also a "),yr=n(jc,"A",{href:!0,rel:!0});var bk=r(yr);x_=a(bk,"tf.keras.Model"),bk.forEach(t),C_=a(jc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jc.forEach(t),M_=p(zs),E(Vo.$$.fragment,zs),S_=p(zs),Zt=n(zs,"DIV",{class:!0});var Fa=r(Zt);E(qr.$$.fragment,Fa),P_=p(Fa),_o=n(Fa,"P",{});var Bi=r(_o);D_=a(Bi,"The "),yi=n(Bi,"A",{href:!0});var kk=r(yi);N_=a(kk,"TFTapasForMaskedLM"),kk.forEach(t),O_=a(Bi," forward method, overrides the "),Md=n(Bi,"CODE",{});var yk=r(Md);L_=a(yk,"__call__"),yk.forEach(t),Q_=a(Bi," special method."),Bi.forEach(t),I_=p(Fa),E(Ko.$$.fragment,Fa),W_=p(Fa),Sd=n(Fa,"P",{});var qk=r(Sd);H_=a(qk,"Examples:"),qk.forEach(t),U_=p(Fa),E(jr.$$.fragment,Fa),Fa.forEach(t),zs.forEach(t),Pp=p(i),To=n(i,"H2",{class:!0});var $c=r(To);Yo=n($c,"A",{id:!0,class:!0,href:!0});var jk=r(Yo);Pd=n(jk,"SPAN",{});var $k=r(Pd);E($r.$$.fragment,$k),$k.forEach(t),jk.forEach(t),B_=p($c),Dd=n($c,"SPAN",{});var Ek=r(Dd);R_=a(Ek,"TFTapasForSequenceClassification"),Ek.forEach(t),$c.forEach(t),Dp=p(i),ct=n(i,"DIV",{class:!0});var xs=r(ct);E(Er.$$.fragment,xs),G_=p(xs),Nd=n(xs,"P",{});var Fk=r(Nd);V_=a(Fk,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fc.forEach(t),aT=p(xs),E(Jo.$$.fragment,xs),oT=p(xs),es=n(xs,"DIV",{class:!0});var Aa=r(es);E(xr.$$.fragment,Aa),nT=p(Aa),vo=n(Aa,"P",{});var Ri=r(vo);rT=a(Ri,"The "),ji=n(Ri,"A",{href:!0});var xk=r(ji);iT=a(xk,"TFTapasForSequenceClassification"),xk.forEach(t),lT=a(Ri," forward method, overrides the "),Od=n(Ri,"CODE",{});var Ck=r(Od);dT=a(Ck,"__call__"),Ck.forEach(t),pT=a(Ri," special method."),Ri.forEach(t),cT=p(Aa),E(Xo.$$.fragment,Aa),hT=p(Aa),Ld=n(Aa,"P",{});var Mk=r(Ld);uT=a(Mk,"Examples:"),Mk.forEach(t),mT=p(Aa),E(Cr.$$.fragment,Aa),Aa.forEach(t),xs.forEach(t),Np=p(i),wo=n(i,"H2",{class:!0});var Ac=r(wo);Zo=n(Ac,"A",{id:!0,class:!0,href:!0});var Sk=r(Zo);Qd=n(Sk,"SPAN",{});var Pk=r(Qd);E(Mr.$$.fragment,Pk),Pk.forEach(t),Sk.forEach(t),fT=p(Ac),Id=n(Ac,"SPAN",{});var Dk=r(Id);gT=a(Dk,"TFTapasForQuestionAnswering"),Dk.forEach(t),Ac.forEach(t),Op=p(i),ht=n(i,"DIV",{class:!0});var Cs=r(ht);E(Sr.$$.fragment,Cs),_T=p(Cs),bo=n(Cs,"P",{});var Gi=r(bo);TT=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wd=n(Gi,"CODE",{});var Nk=r(Wd);vT=a(Nk,"logits"),Nk.forEach(t),wT=a(Gi," and optional "),Hd=n(Gi,"CODE",{});var Ok=r(Hd);bT=a(Ok,"logits_aggregation"),Ok.forEach(t),kT=a(Gi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),yT=p(Cs),Pr=n(Cs,"P",{});var zc=r(Pr);qT=a(zc,"This model inherits from "),$i=n(zc,"A",{href:!0});var Lk=r($i);jT=a(Lk,"TFPreTrainedModel"),Lk.forEach(t),$T=a(zc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
