...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new $t({props:{$$slots:{default:[ww]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/t5/modeling_tf_t5.py#L1309",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16557/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16557/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new $t({props:{$$slots:{default:[$w]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16557/src/transformers/models/t5/modeling_tf_t5.py#L1618",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16557/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16557/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16557/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
for summarization: `),R=s(Ir,"EM",{});var ok=a(R);Ne=i(ok,"summarize: \u2026"),ok.forEach(t),m=i(Ir,"."),Ir.forEach(t),tk.forEach(t),j=l(Ar),te=s(Ar,"LI",{});var sk=a(te);Se=s(sk,"P",{});var ak=a(Se);pt=i(ak,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ak.forEach(t),sk.forEach(t),D=l(Ar),Ge=s(Ar,"LI",{});var rk=a(Ge);ne=s(rk,"P",{});var io=a(ne);ht=i(io,"See the "),O=s(io,"A",{href:!0});var ik=a(O);Y=i(ik,"training"),ik.forEach(t),ut=i(io,", "),Oe=s(io,"A",{href:!0});var dk=a(Oe);Z=i(dk,"inference"),dk.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var lk=a(Le);Ae=i(lk,"scripts"),lk.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rk.forEach(t),Ar.forEach(t),Vl=l(n),Xa=s(n,"P",{});var ck=a(Xa);Dp=i(ck,"T5 comes in different sizes:"),ck.forEach(t),Kl=l(n),Ue=s(n,"UL",{});var Ot=a(Ue);di=s(Ot,"LI",{});var pk=a(di);li=s(pk,"P",{});var hk=a(li);To=s(hk,"A",{href:!0,rel:!0});var uk=a(To);Sp=i(uk,"t5-small"),uk.forEach(t),hk.forEach(t),pk.forEach(t),Gp=l(Ot),ci=s(Ot,"LI",{});var mk=a(ci);pi=s(mk,"P",{});var fk=a(pi);vo=s(fk,"A",{href:!0,rel:!0});var _k=a(vo);Up=i(_k,"t5-base"),_k.forEach(t),fk.forEach(t),mk.forEach(t),Wp=l(Ot),hi=s(Ot,"LI",{});var gk=a(hi);ui=s(gk,"P",{});var Tk=a(ui);ko=s(Tk,"A",{href:!0,rel:!0});var vk=a(ko);Rp=i(vk,"t5-large"),vk.forEach(t),Tk.forEach(t),gk.forEach(t),Bp=l(Ot),mi=s(Ot,"LI",{});var kk=a(mi);fi=s(kk,"P",{});var bk=a(fi);bo=s(bk,"A",{href:!0,rel:!0});var yk=a(bo);Hp=i(yk,"t5-3b"),yk.forEach(t),bk.forEach(t),kk.forEach(t),Vp=l(Ot),_i=s(Ot,"LI",{});var wk=a(_i);Qa=s(wk,"P",{});var Vv=a(Qa);yo=s(Vv,"A",{href:!0,rel:!0});var xk=a(yo);Kp=i(xk,"t5-11b"),xk.forEach(t),Yp=i(Vv,"."),Vv.forEach(t),wk.forEach(t),Ot.forEach(t),Yl=l(n),er=s(n,"P",{});var $k=a(er);Zp=i($k,"Based on the original T5 model, Google has released some follow-up works:"),$k.forEach(t),Zl=l(n),zt=s(n,"UL",{});var Dr=a(zt);gi=s(Dr,"LI",{});var zk=a(gi);$n=s(zk,"P",{});var Rl=a($n);Ti=s(Rl,"STRONG",{});var qk=a(Ti);Jp=i(qk,"T5v1.1"),qk.forEach(t),Xp=i(Rl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Rl,"A",{href:!0});var Ek=a(tr);Qp=i(Ek,"here"),Ek.forEach(t),eh=i(Rl,"."),Rl.forEach(t),zk.forEach(t),th=l(Dr),vi=s(Dr,"LI",{});var jk=a(vi);zn=s(jk,"P",{});var Bl=a(zn);ki=s(Bl,"STRONG",{});var Fk=a(ki);nh=i(Fk,"mT5"),Fk.forEach(t),oh=i(Bl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Bl,"A",{href:!0});var Mk=a(nr);sh=i(Mk,"here"),Mk.forEach(t),ah=i(Bl,"."),Bl.forEach(t),jk.forEach(t),rh=l(Dr),bi=s(Dr,"LI",{});var Ck=a(bi);qn=s(Ck,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var Pk=a(yi);ih=i(Pk,"byT5"),Pk.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
...
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),lo.forEach(t),nc=l(n),Fn=s(n,"P",{});var Rc=a(Fn);Eh=i(Rc,"One can use "),ar=s(Rc,"A",{href:!0});var Rk=a(ar);jh=i(Rk,"T5ForConditionalGeneration"),Rk.forEach(t),Fh=i(Rc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Rc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Bc=a(Mn);dt=s(Bc,"LI",{});var Lt=a(dt);Ei=s(Lt,"P",{});var Bk=a(Ei);Mh=i(Bk,"Unsupervised denoising training"),Bk.forEach(t),Ch=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Ph=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hk=a(ji);Nh=i(Hk,"a.k.a"),Hk.forEach(t),Oh=i(tt,` unique mask tokens) and
...
`),rr=s(tt,"A",{href:!0});var Jk=a(rr);Rh=i(Jk,"T5Tokenizer"),Jk.forEach(t),Bh=i(tt,"."),tt.forEach(t),Hh=l(Lt),Ni=s(Lt,"P",{});var Xk=a(Ni);Vh=i(Xk,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
