...
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16119/en/model_doc/bart#transformers.BartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16119/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16119/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16119/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16119/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16119/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
Ghazvininejad, Abdelrahman Mohamed, Omer Levy, Ves Stoyanov and Luke Zettlemoyer on 29 Oct, 2019.`),fr.forEach(t),D=l(o),$e=a(o,"P",{});var Yl=s($e);ye=i(Yl,"According to the abstract,"),Yl.forEach(t),Ye=l(o),K=a(o,"UL",{});var $o=s(K);re=a($o,"LI",{});var E1=s(re);rt=i(E1,`Bart uses a standard seq2seq/machine translation architecture with a bidirectional encoder (like BERT) and a
left-to-right decoder (like GPT).`),E1.forEach(t),it=l($o),J=a($o,"LI",{});var C1=s(J);dt=i(C1,`The pretraining task involves randomly shuffling the order of the original sentences and a novel in-filling scheme,
where spans of text are replaced with a single mask token.`),C1.forEach(t),ve=l($o),Ue=a($o,"LI",{});var A1=s(Ue);F=i(A1,`BART is particularly effective when fine tuned for text generation but also works well for comprehension tasks. It
matches the performance of RoBERTa with comparable training resources on GLUE and SQuAD, achieves new
state-of-the-art results on a range of abstractive dialogue, question answering, and summarization tasks, with gains
of up to 6 ROUGE.`),A1.forEach(t),$o.forEach(t),M=l(o),U=a(o,"P",{});var Hr=s(U);Lt=i(Hr,"This model was contributed by "),He=a(Hr,"A",{href:!0,rel:!0});var S1=s(He);ie=i(S1,"sshleifer"),S1.forEach(t),Gt=i(Hr,". The Authors\u2019 code can be found "),Qe=a(Hr,"A",{href:!0,rel:!0});var I1=s(Qe);Wt=i(I1,"here"),I1.forEach(t),de=i(Hr,"."),Hr.forEach(t),ue=l(o),Te=a(o,"H3",{class:!0});var Oc=s(Te);je=a(Oc,"A",{id:!0,class:!0,href:!0});var O1=s(je);le=a(O1,"SPAN",{});var N1=s(le);f(Ve.$$.fragment,N1),N1.forEach(t),O1.forEach(t),Rt=l(Oc),Je=a(Oc,"SPAN",{});var D1=s(Je);Ut=i(D1,"Examples"),D1.forEach(t),Oc.forEach(t),tc=l(o),_t=a(o,"UL",{});var Qr=s(_t);xn=a(Qr,"LI",{});var Nc=s(xn);Ip=i(Nc,`Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
`),zn=a(Nc,"A",{href:!0,rel:!0});var L1=s(zn);Op=i(L1,"examples/pytorch/summarization/"),L1.forEach(t),Np=i(Nc,"."),Nc.forEach(t),Dp=l(Qr),lt=a(Qr,"LI",{});var fn=s(lt);Lp=i(fn,"An example of how to train "),_r=a(fn,"A",{href:!0});var G1=s(_r);Gp=i(G1,"BartForConditionalGeneration"),G1.forEach(t),Wp=i(fn," with a Hugging Face "),wi=a(fn,"CODE",{});var W1=s(wi);Rp=i(W1,"datasets"),W1.forEach(t),Up=i(fn,`
object can be found in this `),Fn=a(fn,"A",{href:!0,rel:!0});var R1=s(Fn);Hp=i(R1,"forum discussion"),R1.forEach(t),Qp=i(fn,"."),fn.forEach(t),Vp=l(Qr),jo=a(Qr,"LI",{});var ec=s(jo);Bn=a(ec,"A",{href:!0,rel:!0});var U1=s(Bn);Jp=i(U1,"Distilled checkpoints"),U1.forEach(t),Xp=i(ec," are described in this "),qn=a(ec,"A",{href:!0,rel:!0});var H1=s(qn);Kp=i(H1,"paper"),H1.forEach(t),Zp=i(ec,"."),ec.forEach(t),Qr.forEach(t),oc=l(o),Ht=a(o,"H2",{class:!0});var Dc=s(Ht);Mo=a(Dc,"A",{id:!0,class:!0,href:!0});var Q1=s(Mo);xi=a(Q1,"SPAN",{});var V1=s(xi);f($n.$$.fragment,V1),V1.forEach(t),Q1.forEach(t),Yp=l(Dc),zi=a(Dc,"SPAN",{});var J1=s(zi);eh=i(J1,"Implementation Notes"),J1.forEach(t),Dc.forEach(t),nc=l(o),Me=a(o,"UL",{});var qt=s(Me);ct=a(qt,"LI",{});var _n=s(ct);th=i(_n,"Bart doesn\u2019t use "),Fi=a(_n,"CODE",{});var X1=s(Fi);oh=i(X1,"token_type_ids"),X1.forEach(t),nh=i(_n," for sequence classification. Use "),gr=a(_n,"A",{href:!0});var K1=s(gr);ah=i(K1,"BartTokenizer"),K1.forEach(t),sh=i(_n,` or
`),kr=a(_n,"A",{href:!0});var Z1=s(kr);rh=i(Z1,"encode()"),Z1.forEach(t),ih=i(_n," to get the proper splitting."),_n.forEach(t),dh=l(qt),Qt=a(qt,"LI",{});var Vr=s(Qt);lh=i(Vr,"The forward pass of "),br=a(Vr,"A",{href:!0});var Y1=s(br);ch=i(Y1,"BartModel"),Y1.forEach(t),ph=i(Vr," will create the "),Bi=a(Vr,"CODE",{});var ey=s(Bi);hh=i(ey,"decoder_input_ids"),ey.forEach(t),uh=i(Vr,` if they are not passed.
...
`),qi=a(Jr,"CODE",{});var ty=s(qi);_h=i(ty,"forced_bos_token_id=0"),ty.forEach(t),gh=i(Jr,`. This only works, however, if the string you pass to
`),$i=a(Jr,"CODE",{});var oy=s($i);kh=i(oy,"fairseq.encode"),oy.forEach(t),bh=i(Jr," starts with a space."),Jr.forEach(t),yh=l(qt),yr=a(qt,"LI",{});var j1=s(yr);vr=a(j1,"A",{href:!0});var ny=s(vr);vh=i(ny,"generate()"),ny.forEach(t),Th=i(j1,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),j1.forEach(t),wh=l(qt),Jt=a(qt,"LI",{});var Xr=s(Jt);xh=i(Xr,"Models that load the "),ji=a(Xr,"EM",{});var ay=s(ji);zh=i(ay,"facebook/bart-large-cnn"),ay.forEach(t),Fh=i(Xr," weights will not have a "),Mi=a(Xr,"CODE",{});var sy=s(Mi);Bh=i(sy,"mask_token_id"),sy.forEach(t),qh=i(Xr,`, or be able to perform
mask-filling tasks.`),Xr.forEach(t),qt.forEach(t),ac=l(o),Xt=a(o,"H2",{class:!0});var Lc=s(Xt);Po=a(Lc,"A",{id:!0,class:!0,href:!0});var ry=s(Po);Pi=a(ry,"SPAN",{});var iy=s(Pi);f(jn.$$.fragment,iy),iy.forEach(t),ry.forEach(t),$h=l(Lc),Ei=a(Lc,"SPAN",{});var dy=s(Ei);jh=i(dy,"Mask Filling"),dy.forEach(t),Lc.forEach(t),sc=l(o),gt=a(o,"P",{});var Kr=s(gt);Mh=i(Kr,"The "),Ci=a(Kr,"CODE",{});var ly=s(Ci);Ph=i(ly,"facebook/bart-base"),ly.forEach(t),Eh=i(Kr," and "),Ai=a(Kr,"CODE",{});var cy=s(Ai);Ch=i(cy,"facebook/bart-large"),cy.forEach(t),Ah=i(Kr," checkpoints can be used to fill multi-token masks."),Kr.forEach(t),rc=l(o),f(Mn.$$.fragment,o),ic=l(o),Kt=a(o,"H2",{class:!0});var Gc=s(Kt);Eo=a(Gc,"A",{id:!0,class:!0,href:!0});var py=s(Eo);Si=a(py,"SPAN",{});var hy=s(Si);f(Pn.$$.fragment,hy),hy.forEach(t),py.forEach(t),Sh=l(Gc),Ii=a(Gc,"SPAN",{});var uy=s(Ii);Ih=i(uy,"BartConfig"),uy.forEach(t),Gc.forEach(t),dc=l(o),we=a(o,"DIV",{class:!0});var $t=s(we);f(En.$$.fragment,$t),Oh=l($t),Zt=a($t,"P",{});var Zr=s(Zt);Nh=i(Zr,"This is the configuration class to store the configuration of a "),Tr=a(Zr,"A",{href:!0});var my=s(Tr);Dh=i(my,"BartModel"),my.forEach(t),Lh=i(Zr,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Cn=a(Zr,"A",{href:!0,rel:!0});var fy=s(Cn);Gh=i(fy,"facebook/bart-large"),fy.forEach(t),Wh=i(Zr," architecture."),Zr.forEach(t),Rh=l($t),Yt=a($t,"P",{});var Yr=s(Yt);Uh=i(Yr,"Configuration objects inherit from "),wr=a(Yr,"A",{href:!0});var _y=s(wr);Hh=i(_y,"PretrainedConfig"),_y.forEach(t),Qh=i(Yr,` and can be used to control the model outputs. Read the
documentation from `),xr=a(Yr,"A",{href:!0});var gy=s(xr);Vh=i(gy,"PretrainedConfig"),gy.forEach(t),Jh=i(Yr," for more information."),Yr.forEach(t),Xh=l($t),Oi=a($t,"P",{});var ky=s(Oi);Kh=i(ky,"Example:"),ky.forEach(t),Zh=l($t),f(An.$$.fragment,$t),$t.forEach(t),lc=l(o),eo=a(o,"H2",{class:!0});var Wc=s(eo);Co=a(Wc,"A",{id:!0,class:!0,href:!0});var by=s(Co);Ni=a(by,"SPAN",{});var yy=s(Ni);f(Sn.$$.fragment,yy),yy.forEach(t),by.forEach(t),Yh=l(Wc),Di=a(Wc,"SPAN",{});var vy=s(Di);eu=i(vy,"BartTokenizer"),vy.forEach(t),Wc.forEach(t),cc=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(In.$$.fragment,L),tu=l(L),Li=a(L,"P",{});var Ty=s(Li);ou=i(Ty,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),Ty.forEach(t),nu=l(L),Gi=a(L,"P",{});var wy=s(Gi);au=i(wy,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),wy.forEach(t),su=l(L),f(On.$$.fragment,L),ru=l(L),Nn=a(L,"P",{});var Rc=s(Nn);iu=i(Rc,"You can get around that behavior by passing "),Wi=a(Rc,"CODE",{});var xy=s(Wi);du=i(xy,"add_prefix_space=True"),xy.forEach(t),lu=i(Rc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Rc.forEach(t),cu=l(L),f(Ao.$$.fragment,L),pu=l(L),Dn=a(L,"P",{});var Uc=s(Dn);hu=i(Uc,"This tokenizer inherits from "),zr=a(Uc,"A",{href:!0});var zy=s(zr);uu=i(zy,"PreTrainedTokenizer"),zy.forEach(t),mu=i(Uc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Uc.forEach(t),fu=l(L),kt=a(L,"DIV",{class:!0});var ei=s(kt);f(Ln.$$.fragment,ei),_u=l(ei),Ri=a(ei,"P",{});var Fy=s(Ri);gu=i(Fy,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Fy.forEach(t),ku=l(ei),Gn=a(ei,"UL",{});var Hc=s(Gn);Fr=a(Hc,"LI",{});var M1=s(Fr);bu=i(M1,"single sequence: "),Ui=a(M1,"CODE",{});var By=s(Ui);yu=i(By,"<s> X </s>"),By.forEach(t),M1.forEach(t),vu=l(Hc),Br=a(Hc,"LI",{});var P1=s(Br);Tu=i(P1,"pair of sequences: "),Hi=a(P1,"CODE",{});var qy=s(Hi);wu=i(qy,"<s> A </s></s> B </s>"),qy.forEach(t),P1.forEach(t),Hc.forEach(t),ei.forEach(t),xu=l(L),So=a(L,"DIV",{class:!0});var Qc=s(So);f(Wn.$$.fragment,Qc),zu=l(Qc),Qi=a(Qc,"P",{});var $y=s(Qi);Fu=i($y,"Converts a sequence of tokens (string) in a single string."),$y.forEach(t),Qc.forEach(t),Bu=l(L),Io=a(L,"DIV",{class:!0});var Vc=s(Io);f(Rn.$$.fragment,Vc),qu=l(Vc),Vi=a(Vc,"P",{});var jy=s(Vi);$u=i(jy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),jy.forEach(t),Vc.forEach(t),ju=l(L),Oo=a(L,"DIV",{class:!0});var Jc=s(Oo);f(Un.$$.fragment,Jc),Mu=l(Jc),Hn=a(Jc,"P",{});var Xc=s(Hn);Pu=i(Xc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ji=a(Xc,"CODE",{});var My=s(Ji);Eu=i(My,"prepare_for_model"),My.forEach(t),Cu=i(Xc," method."),Xc.forEach(t),Jc.forEach(t),L.forEach(t),pc=l(o),to=a(o,"H2",{class:!0});var Kc=s(to);No=a(Kc,"A",{id:!0,class:!0,href:!0});var Py=s(No);Xi=a(Py,"SPAN",{});var Ey=s(Xi);f(Qn.$$.fragment,Ey),Ey.forEach(t),Py.forEach(t),Au=l(Kc),Ki=a(Kc,"SPAN",{});var Cy=s(Ki);Su=i(Cy,"BartTokenizerFast"),Cy.forEach(t),Kc.forEach(t),hc=l(o),G=a(o,"DIV",{class:!0});var me=s(G);f(Vn.$$.fragment,me),Iu=l(me),Jn=a(me,"P",{});var Zc=s(Jn);Ou=i(Zc,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Zi=a(Zc,"EM",{});var Ay=s(Zi);Nu=i(Ay,"tokenizers"),Ay.forEach(t),Du=i(Zc,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),Zc.forEach(t),Lu=l(me),Yi=a(me,"P",{});var Sy=s(Yi);Gu=i(Sy,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),Sy.forEach(t),Wu=l(me),f(Xn.$$.fragment,me),Ru=l(me),Kn=a(me,"P",{});var Yc=s(Kn);Uu=i(Yc,"You can get around that behavior by passing "),ed=a(Yc,"CODE",{});var Iy=s(ed);Hu=i(Iy,"add_prefix_space=True"),Iy.forEach(t),Qu=i(Yc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Yc.forEach(t),Vu=l(me),f(Do.$$.fragment,me),Ju=l(me),Zn=a(me,"P",{});var ep=s(Zn);Xu=i(ep,"This tokenizer inherits from "),qr=a(ep,"A",{href:!0});var Oy=s(qr);Ku=i(Oy,"PreTrainedTokenizerFast"),Oy.forEach(t),Zu=i(ep,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ep.forEach(t),Yu=l(me),Lo=a(me,"DIV",{class:!0});var tp=s(Lo);f(Yn.$$.fragment,tp),em=l(tp),td=a(tp,"P",{});var Ny=s(td);tm=i(Ny,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Ny.forEach(t),tp.forEach(t),me.forEach(t),uc=l(o),oo=a(o,"H2",{class:!0});var op=s(oo);Go=a(op,"A",{id:!0,class:!0,href:!0});var Dy=s(Go);od=a(Dy,"SPAN",{});var Ly=s(od);f(ea.$$.fragment,Ly),Ly.forEach(t),Dy.forEach(t),om=l(op),nd=a(op,"SPAN",{});var Gy=s(nd);nm=i(Gy,"BartModel"),Gy.forEach(t),op.forEach(t),mc=l(o),Xe=a(o,"DIV",{class:!0});var gn=s(Xe);f(ta.$$.fragment,gn),am=l(gn),oa=a(gn,"P",{});var np=s(oa);sm=i(np,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),$r=a(np,"A",{href:!0});var Wy=s($r);rm=i(Wy,"PreTrainedModel"),Wy.forEach(t),im=i(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),dm=l(gn),na=a(gn,"P",{});var ap=s(na);lm=i(ap,"This model is also a PyTorch "),aa=a(ap,"A",{href:!0,rel:!0});var Ry=s(aa);cm=i(Ry,"torch.nn.Module"),Ry.forEach(t),pm=i(ap,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ap.forEach(t),hm=l(gn),Pe=a(gn,"DIV",{class:!0});var jt=s(Pe);f(sa.$$.fragment,jt),um=l(jt),no=a(jt,"P",{});var ti=s(no);mm=i(ti,"The "),jr=a(ti,"A",{href:!0});var Uy=s(jr);fm=i(Uy,"BartModel"),Uy.forEach(t),_m=i(ti," forward method, overrides the "),ad=a(ti,"CODE",{});var Hy=s(ad);gm=i(Hy,"__call__"),Hy.forEach(t),km=i(ti," special method."),ti.forEach(t),bm=l(jt),f(Wo.$$.fragment,jt),ym=l(jt),sd=a(jt,"P",{});var Qy=s(sd);vm=i(Qy,"Example:"),Qy.forEach(t),Tm=l(jt),f(ra.$$.fragment,jt),jt.forEach(t),gn.forEach(t),fc=l(o),ao=a(o,"H2",{class:!0});var sp=s(ao);Ro=a(sp,"A",{id:!0,class:!0,href:!0});var Vy=s(Ro);rd=a(Vy,"SPAN",{});var Jy=s(rd);f(ia.$$.fragment,Jy),Jy.forEach(t),Vy.forEach(t),wm=l(sp),id=a(sp,"SPAN",{});var Xy=s(id);xm=i(Xy,"BartForConditionalGeneration"),Xy.forEach(t),sp.forEach(t),_c=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),zm=l(kn),la=a(kn,"P",{});var rp=s(la);Fm=i(rp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mr=a(rp,"A",{href:!0});var Ky=s(Mr);Bm=i(Ky,"PreTrainedModel"),Ky.forEach(t),qm=i(rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rp.forEach(t),$m=l(kn),ca=a(kn,"P",{});var ip=s(ca);jm=i(ip,"This model is also a PyTorch "),pa=a(ip,"A",{href:!0,rel:!0});var Zy=s(pa);Mm=i(Zy,"torch.nn.Module"),Zy.forEach(t),Pm=i(ip,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),Em=l(kn),Z=a(kn,"DIV",{class:!0});var Ne=s(Z);f(ha.$$.fragment,Ne),Cm=l(Ne),so=a(Ne,"P",{});var oi=s(so);Am=i(oi,"The "),Pr=a(oi,"A",{href:!0});var Yy=s(Pr);Sm=i(Yy,"BartForConditionalGeneration"),Yy.forEach(t),Im=i(oi," forward method, overrides the "),dd=a(oi,"CODE",{});var ev=s(dd);Om=i(ev,"__call__"),ev.forEach(t),Nm=i(oi," special method."),oi.forEach(t),Dm=l(Ne),f(Uo.$$.fragment,Ne),Lm=l(Ne),ld=a(Ne,"P",{});var tv=s(ld);Gm=i(tv,"Summarization example:"),tv.forEach(t),Wm=l(Ne),f(ua.$$.fragment,Ne),Rm=l(Ne),cd=a(Ne,"P",{});var ov=s(cd);Um=i(ov,"Mask filling example:"),ov.forEach(t),Hm=l(Ne),f(ma.$$.fragment,Ne),Ne.forEach(t),kn.forEach(t),gc=l(o),ro=a(o,"H2",{class:!0});var dp=s(ro);Ho=a(dp,"A",{id:!0,class:!0,href:!0});var nv=s(Ho);pd=a(nv,"SPAN",{});var av=s(pd);f(fa.$$.fragment,av),av.forEach(t),nv.forEach(t),Qm=l(dp),hd=a(dp,"SPAN",{});var sv=s(hd);Vm=i(sv,"BartForSequenceClassification"),sv.forEach(t),dp.forEach(t),kc=l(o),xe=a(o,"DIV",{class:!0});var Mt=s(xe);f(_a.$$.fragment,Mt),Jm=l(Mt),ud=a(Mt,"P",{});var rv=s(ud);Xm=i(rv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
