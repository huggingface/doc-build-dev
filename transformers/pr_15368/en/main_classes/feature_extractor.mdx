...
- **kwargs** (`Dict[str, Any]`, *optional*) --
  ...
  controlled by the `return_unused_kwargs` keyword parameter.</paramsdesc><paramgroups>0</paramgroups><retdesc>A feature extractor of type [FeatureExtractionMixin](/docs/transformers/pr_15368/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin).</retdesc></docstring>

Instantiate a type of [FeatureExtractionMixin](/docs/transformers/pr_15368/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin) from a feature extractor, *e.g.* a
derived class of [SequenceFeatureExtractor](/docs/transformers/pr_15368/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor).
...
[from_pretrained()](/docs/transformers/pr_15368/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained) class method.
...
<docstring><name>class transformers.SequenceFeatureExtractor</name><anchor>transformers.SequenceFeatureExtractor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15368/src/transformers/feature_extraction_sequence_utils.py#L38</source><parameters>[{"name": "feature_size", "val": ": int"}, {"name": "sampling_rate", "val": ": int"}, {"name": "padding_value", "val": ": float"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **feature_size** (`int`) --
...
Holds the output of the [pad()](/docs/transformers/pr_15368/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor.pad) and feature extractor specific `__call__` methods.
...
<docstring><name>class transformers.ImageFeatureExtractionMixin</name><anchor>transformers.ImageFeatureExtractionMixin</anchor><source>https://github.com/huggingface/transformers/blob/pr_15368/src/transformers/image_utils.py#L76</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>center\_crop</name><anchor>transformers.ImageFeatureExtractionMixin.center_crop</anchor><source>https://github.com/huggingface/transformers/blob/pr_15368/src/transformers/image_utils.py#L210</source><parameters>[{"name": "image", "val": ""}, {"name": "size", "val": ""}]</parameters><paramsdesc>- **image** (`PIL.Image.Image` or `np.ndarray` or `torch.Tensor`) --
  The image to resize.
...
<div class="docstring">
<docstring><name>normalize</name><anchor>transformers.ImageFeatureExtractionMixin.normalize</anchor><source>https://github.com/huggingface/transformers/blob/pr_15368/src/transformers/image_utils.py#L151</source><parameters>[{"name": "image", "val": ""}, {"name": "mean", "val": ""}, {"name": "std", "val": ""}]</parameters><paramsdesc>- **image** (`PIL.Image.Image` or `np.ndarray` or `torch.Tensor`) --
...
<div class="docstring">
<docstring><name>to\_numpy\_array</name><anchor>transformers.ImageFeatureExtractionMixin.to_numpy_array</anchor><source>https://github.com/huggingface/transformers/blob/pr_15368/src/transformers/image_utils.py#L118</source><parameters>[{"name": "image", "val": ""}, {"name": "rescale", "val": " = None"}, {"name": "channel_first", "val": " = True"}]</parameters><paramsdesc>- **image** (`PIL.Image.Image` or `np.ndarray` or `torch.Tensor`) --
...
<div class="docstring">
<docstring><name>to\_pil\_image</name><anchor>transformers.ImageFeatureExtractionMixin.to_pil_image</anchor><source>https://github.com/huggingface/transformers/blob/pr_15368/src/transformers/image_utils.py#L88</source><parameters>[{"name": "image", "val": ""}, {"name": "rescale", "val": " = None"}]</parameters><paramsdesc>- **image** (`PIL.Image.Image` or `numpy.ndarray` or `torch.Tensor`) --
