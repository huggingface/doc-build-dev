import{S as Di,i as zi,s as $i,e as a,k as c,w as f,t as n,M as ji,c as s,d as o,m as l,a as d,x as u,h as r,b as i,F as e,g as h,y as g,q as _,o as b,B as v,v as Fi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-17b815d9.js";import{C as qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Wt}from"../../chunks/IconCopyLink-7a11ce68.js";function Pi(pe){let m,F,y,x,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),x=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);x=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,x),e(m,j)},d(k){k&&o(m)}}}function Ai(pe){let m,F,y,x,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),x=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);x=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,x),e(m,j)},d(k){k&&o(m)}}}function Ci(pe){let m,F,y,x,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),x=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);x=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,x),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,F,y,x,j,k,T,P,xn,Rt,me,qn,wo,Dn,zn,Gt,he,$n,De,jn,Fn,Ut,fe,Pn,Eo,An,Cn,Ht,V,Sn,Mo,Nn,In,ze,Ln,Bn,Yt,W,On,st,Vn,Wn,dt,Rn,Gn,Jt,$e,Zt,R,Un,je,Hn,Yn,Fe,Jn,Zn,Kt,Q,ue,it,Pe,Kn,ct,Qn,Qt,q,Ae,Xn,ge,xo,er,or,qo,tr,nr,rr,X,ar,Do,sr,dr,zo,ir,cr,lr,lt,pr,mr,Ce,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,ee,yr,pt,kr,Tr,mt,wr,Er,Xt,oe,ve,ht,Le,Mr,ft,xr,en,w,Be,qr,te,Dr,jo,zr,$r,Fo,jr,Fr,Pr,Oe,Ar,Ve,Cr,Sr,Nr,ut,Ir,Lr,We,Br,Po,Or,Vr,Wr,Re,Rr,Ge,Gr,Ur,Hr,G,Ao,Yr,Jr,gt,Zr,Kr,_t,Qr,Xr,ea,A,Ue,oa,ne,ta,Co,na,ra,bt,aa,sa,da,ye,ia,vt,ca,la,He,pa,C,Ye,ma,yt,ha,fa,re,ua,kt,ga,_a,Tt,ba,va,ya,wt,ka,Ta,Je,on,ae,ke,Et,Ze,wa,Mt,Ea,tn,E,Ke,Ma,se,xa,So,qa,Da,No,za,$a,ja,Qe,Fa,Xe,Pa,Aa,Ca,xt,Sa,Na,eo,Ia,Io,La,Ba,Oa,oo,Va,to,Wa,Ra,Ga,U,Lo,Ua,Ha,Bo,Ya,Ja,Oo,Za,Ka,Qa,S,no,Xa,de,es,Vo,os,ts,qt,ns,rs,as,Te,ss,Dt,ds,is,ro,cs,L,ao,ls,zt,ps,ms,$t,hs,fs,so,nn,ie,we,jt,io,us,Ft,gs,rn,M,co,_s,ce,bs,Wo,vs,ys,Ro,ks,Ts,ws,lo,Es,po,Ms,xs,qs,Pt,Ds,zs,mo,$s,Go,js,Fs,Ps,ho,As,fo,Cs,Ss,Ns,H,Uo,Is,Ls,At,Bs,Os,Ct,Vs,Ws,Rs,N,uo,Gs,le,Us,Ho,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Wt({}),$e=new qe({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Pe=new Wt({}),Ae=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16827/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16827/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Ce=new qe({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L429",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16827/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),ye=new dd({props:{$$slots:{default:[Pi]},$$scope:{ctx:pe}}}),He=new qe({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
import torch
...
<a href="/docs/transformers/pr_16827/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2bert&quot;</span>)`}}),Ze=new Wt({}),Ke=new O({props:{name:"class transformers.TFEncoderDecoderModel",anchor:"transformers.TFEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16827/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L186"}}),no=new O({props:{name:"call",anchor:"transformers.TFEncoderDecoderModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16827/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16827/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16827/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<a href="/docs/transformers/pr_16827/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16827/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16827/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L494",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16827/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),Te=new dd({props:{$$slots:{default:[Ai]},$$scope:{ctx:pe}}}),ro=new qe({props:{code:`from transformers import TFEncoderDecoderModel, BertTokenizer
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16827/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L330"}}),so=new qe({props:{code:`from transformers import TFEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),io=new Wt({}),co=new O({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L610",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16827/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),Ee=new dd({props:{$$slots:{default:[Ci]},$$scope:{ctx:pe}}}),go=new qe({props:{code:`from transformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16827/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16827/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L741"}}),bo=new qe({props:{code:`from transformers import FlaxEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){m=a("meta"),F=c(),y=a("h1"),x=a("a"),j=a("span"),f(k.$$.fragment),T=c(),P=a("span"),xn=n("Encoder Decoder Models"),Rt=c(),me=a("p"),qn=n("The "),wo=a("a"),Dn=n("EncoderDecoderModel"),zn=n(` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),De=a("a"),jn=n("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Fn=n(` by
...
and decoder for a summarization model as was shown in: `),ze=a("a"),Ln=n("Text Summarization with Pretrained Encoders"),Bn=n(" by Yang Liu and Mirella Lapata."),Yt=c(),W=a("p"),On=n("The "),st=a("code"),Vn=n("from_pretrained()"),Wn=n(` currently doesn\u2019t support initializing the model from a
...
were contributed by `),Fe=a("a"),Jn=n("ydshieh"),Zn=n("."),Kt=c(),Q=a("h2"),ue=a("a"),it=a("span"),f(Pe.$$.fragment),Kn=c(),ct=a("span"),Qn=n("EncoderDecoderConfig"),Qt=c(),q=a("div"),f(Ae.$$.fragment),Xn=c(),ge=a("p"),xo=a("a"),er=n("EncoderDecoderConfig"),or=n(" is the configuration class to store the configuration of a "),qo=a("a"),tr=n("EncoderDecoderModel"),nr=n(`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),rr=c(),X=a("p"),ar=n("Configuration objects inherit from "),Do=a("a"),sr=n("PretrainedConfig"),dr=n(` and can be used to control the model outputs. Read the
documentation from `),zo=a("a"),ir=n("PretrainedConfig"),cr=n(" for more information."),lr=c(),lt=a("p"),pr=n("Examples:"),mr=c(),f(Ce.$$.fragment),hr=c(),_e=a("div"),f(Se.$$.fragment),fr=c(),Ne=a("p"),ur=n("Instantiate a "),$o=a("a"),gr=n("EncoderDecoderConfig"),_r=n(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),br=c(),be=a("div"),f(Ie.$$.fragment),vr=c(),ee=a("p"),yr=n("Serializes this instance to a Python dictionary. Override the default "),pt=a("em"),kr=n("to_dict()"),Tr=n(" from "),mt=a("em"),wr=n("PretrainedConfig"),Er=n("."),Xt=c(),oe=a("h2"),ve=a("a"),ht=a("span"),f(Le.$$.fragment),Mr=c(),ft=a("span"),xr=n("EncoderDecoderModel"),en=c(),w=a("div"),f(Be.$$.fragment),qr=c(),te=a("p"),Dr=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),jo=a("a"),zr=n("from_pretrained()"),$r=n(" function and the decoder is loaded via "),Fo=a("a"),jr=n("from_pretrained()"),Fr=n(`
...
:meth`),_t=a("em"),Qr=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xr=n(" class method for the decoder."),ea=c(),A=a("div"),f(Ue.$$.fragment),oa=c(),ne=a("p"),ta=n("The "),Co=a("a"),na=n("EncoderDecoderModel"),ra=n(" forward method, overrides the "),bt=a("code"),aa=n("__call__"),sa=n(" special method."),da=c(),f(ye.$$.fragment),ia=c(),vt=a("p"),ca=n("Examples:"),la=c(),f(He.$$.fragment),pa=c(),C=a("div"),f(Ye.$$.fragment),ma=c(),yt=a("p"),ha=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Tt=a("code"),ba=n("model.train()"),va=n("."),ya=c(),wt=a("p"),ka=n("Example:"),Ta=c(),f(Je.$$.fragment),on=c(),ae=a("h2"),ke=a("a"),Et=a("span"),f(Ze.$$.fragment),wa=c(),Mt=a("span"),Ea=n("TFEncoderDecoderModel"),tn=c(),E=a("div"),f(Ke.$$.fragment),Ma=c(),se=a("p"),xa=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=a("a"),qa=n("from_pretrained()"),Da=n(" function and the decoder is loaded via "),No=a("a"),za=n("from_pretrained()"),$a=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),Ca=c(),xt=a("p"),Sa=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
method for the decoder.`),Qa=c(),S=a("div"),f(no.$$.fragment),Xa=c(),de=a("p"),es=n("The "),Vo=a("a"),os=n("TFEncoderDecoderModel"),ts=n(" forward method, overrides the "),qt=a("code"),ns=n("__call__"),rs=n(" special method."),as=c(),f(Te.$$.fragment),ss=c(),Dt=a("p"),ds=n("Examples:"),is=c(),f(ro.$$.fragment),cs=c(),L=a("div"),f(ao.$$.fragment),ls=c(),zt=a("p"),ps=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ms=c(),$t=a("p"),hs=n("Example:"),fs=c(),f(so.$$.fragment),nn=c(),ie=a("h2"),we=a("a"),jt=a("span"),f(io.$$.fragment),us=c(),Ft=a("span"),gs=n("FlaxEncoderDecoderModel"),rn=c(),M=a("div"),f(co.$$.fragment),_s=c(),ce=a("p"),bs=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Wo=a("a"),vs=n("from_pretrained()"),ys=n(" function and the decoder is loaded via "),Ro=a("a"),ks=n("from_pretrained()"),Ts=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Tasks`),xs=n(` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),qs=c(),Pt=a("p"),Ds=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),zs=c(),mo=a("p"),$s=n("This model inherits from "),Go=a("a"),js=n("FlaxPreTrainedModel"),Fs=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
checkpoints.`),rd=c(),Lt=a("p"),ad=n("Example:"),sd=c(),f(bo.$$.fragment),this.h()},l(t){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),F=l(t),y=s(t,"H1",{class:!0});var vo=d(y);x=s(vo,"A",{id:!0,class:!0,href:!0});var Bt=d(x);j=s(Bt,"SPAN",{});var Ot=d(j);u(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=l(vo),P=s(vo,"SPAN",{});var id=d(P);xn=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Rt=l(t),me=s(t,"P",{});var sn=d(me);qn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);Dn=r(cd,"EncoderDecoderModel"),cd.forEach(o),zn=r(sn,` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),De=s(dn,"A",{href:!0,rel:!0});var ld=d(De);jn=r(ld,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),ld.forEach(o),Fn=r(dn,` by
...
were contributed by `),Fe=s(Zo,"A",{href:!0,rel:!0});var _d=d(Fe);Jn=r(_d,"ydshieh"),_d.forEach(o),Zn=r(Zo,"."),Zo.forEach(o),Kt=l(t),Q=s(t,"H2",{class:!0});var ln=d(Q);ue=s(ln,"A",{id:!0,class:!0,href:!0});var bd=d(ue);it=s(bd,"SPAN",{});var vd=d(it);u(Pe.$$.fragment,vd),vd.forEach(o),bd.forEach(o),Kn=l(ln),ct=s(ln,"SPAN",{});var yd=d(ct);Qn=r(yd,"EncoderDecoderConfig"),yd.forEach(o),ln.forEach(o),Qt=l(t),q=s(t,"DIV",{class:!0});var I=d(q);u(Ae.$$.fragment,I),Xn=l(I),ge=s(I,"P",{});var Vt=d(ge);xo=s(Vt,"A",{href:!0});var kd=d(xo);er=r(kd,"EncoderDecoderConfig"),kd.forEach(o),or=r(Vt," is the configuration class to store the configuration of a "),qo=s(Vt,"A",{href:!0});var Td=d(qo);tr=r(Td,"EncoderDecoderModel"),Td.forEach(o),nr=r(Vt,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Vt.forEach(o),rr=l(I),X=s(I,"P",{});var Ko=d(X);ar=r(Ko,"Configuration objects inherit from "),Do=s(Ko,"A",{href:!0});var wd=d(Do);sr=r(wd,"PretrainedConfig"),wd.forEach(o),dr=r(Ko,` and can be used to control the model outputs. Read the
documentation from `),zo=s(Ko,"A",{href:!0});var Ed=d(zo);ir=r(Ed,"PretrainedConfig"),Ed.forEach(o),cr=r(Ko," for more information."),Ko.forEach(o),lr=l(I),lt=s(I,"P",{});var Md=d(lt);pr=r(Md,"Examples:"),Md.forEach(o),mr=l(I),u(Ce.$$.fragment,I),hr=l(I),_e=s(I,"DIV",{class:!0});var pn=d(_e);u(Se.$$.fragment,pn),fr=l(pn),Ne=s(pn,"P",{});var mn=d(Ne);ur=r(mn,"Instantiate a "),$o=s(mn,"A",{href:!0});var xd=d($o);gr=r(xd,"EncoderDecoderConfig"),xd.forEach(o),_r=r(mn,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),mn.forEach(o),pn.forEach(o),br=l(I),be=s(I,"DIV",{class:!0});var hn=d(be);u(Ie.$$.fragment,hn),vr=l(hn),ee=s(hn,"P",{});var Qo=d(ee);yr=r(Qo,"Serializes this instance to a Python dictionary. Override the default "),pt=s(Qo,"EM",{});var qd=d(pt);kr=r(qd,"to_dict()"),qd.forEach(o),Tr=r(Qo," from "),mt=s(Qo,"EM",{});var Dd=d(mt);wr=r(Dd,"PretrainedConfig"),Dd.forEach(o),Er=r(Qo,"."),Qo.forEach(o),hn.forEach(o),I.forEach(o),Xt=l(t),oe=s(t,"H2",{class:!0});var fn=d(oe);ve=s(fn,"A",{id:!0,class:!0,href:!0});var zd=d(ve);ht=s(zd,"SPAN",{});var $d=d(ht);u(Le.$$.fragment,$d),$d.forEach(o),zd.forEach(o),Mr=l(fn),ft=s(fn,"SPAN",{});var jd=d(ft);xr=r(jd,"EncoderDecoderModel"),jd.forEach(o),fn.forEach(o),en=l(t),w=s(t,"DIV",{class:!0});var D=d(w);u(Be.$$.fragment,D),qr=l(D),te=s(D,"P",{});var Xo=d(te);Dr=r(Xo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),jo=s(Xo,"A",{href:!0});var Fd=d(jo);zr=r(Fd,"from_pretrained()"),Fd.forEach(o),$r=r(Xo," function and the decoder is loaded via "),Fo=s(Xo,"A",{href:!0});var Pd=d(Fo);jr=r(Pd,"from_pretrained()"),Pd.forEach(o),Fr=r(Xo,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Xo.forEach(o),Pr=l(D),Oe=s(D,"P",{});var un=d(Oe);Ar=r(un,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),un.forEach(o),Nr=l(D),ut=s(D,"P",{});var Cd=d(ut);Ir=r(Cd,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Cd.forEach(o),Lr=l(D),We=s(D,"P",{});var gn=d(We);Br=r(gn,"This model inherits from "),Po=s(gn,"A",{href:!0});var Sd=d(Po);Or=r(Sd,"PreTrainedModel"),Sd.forEach(o),Vr=r(gn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gn.forEach(o),Wr=l(D),Re=s(D,"P",{});var _n=d(Re);Rr=r(_n,"This model is also a PyTorch "),Ge=s(_n,"A",{href:!0,rel:!0});var Nd=d(Ge);Gr=r(Nd,"torch.nn.Module"),Nd.forEach(o),Ur=r(_n,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_n.forEach(o),Hr=l(D),G=s(D,"P",{});var yo=d(G);Ao=s(yo,"A",{href:!0});var Id=d(Ao);Yr=r(Id,"EncoderDecoderModel"),Id.forEach(o),Jr=r(yo,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),_t=s(yo,"EM",{});var Bd=d(_t);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=l(D),A=s(D,"DIV",{class:!0});var Y=d(A);u(Ue.$$.fragment,Y),oa=l(Y),ne=s(Y,"P",{});var et=d(ne);ta=r(et,"The "),Co=s(et,"A",{href:!0});var Od=d(Co);na=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(et," forward method, overrides the "),bt=s(et,"CODE",{});var Vd=d(bt);aa=r(Vd,"__call__"),Vd.forEach(o),sa=r(et," special method."),et.forEach(o),da=l(Y),u(ye.$$.fragment,Y),ia=l(Y),vt=s(Y,"P",{});var Wd=d(vt);ca=r(Wd,"Examples:"),Wd.forEach(o),la=l(Y),u(He.$$.fragment,Y),Y.forEach(o),pa=l(D),C=s(D,"DIV",{class:!0});var J=d(C);u(Ye.$$.fragment,J),ma=l(J),yt=s(J,"P",{});var Rd=d(yt);ha=r(Rd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Tt=s(ot,"CODE",{});var Ud=d(Tt);ba=r(Ud,"model.train()"),Ud.forEach(o),va=r(ot,"."),ot.forEach(o),ya=l(J),wt=s(J,"P",{});var Hd=d(wt);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=l(J),u(Je.$$.fragment,J),J.forEach(o),D.forEach(o),on=l(t),ae=s(t,"H2",{class:!0});var bn=d(ae);ke=s(bn,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);Et=s(Yd,"SPAN",{});var Jd=d(Et);u(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=l(bn),Mt=s(bn,"SPAN",{});var Zd=d(Mt);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bn.forEach(o),tn=l(t),E=s(t,"DIV",{class:!0});var z=d(E);u(Ke.$$.fragment,z),Ma=l(z),se=s(z,"P",{});var tt=d(se);xa=r(tt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=s(tt,"A",{href:!0});var Kd=d(So);qa=r(Kd,"from_pretrained()"),Kd.forEach(o),Da=r(tt," function and the decoder is loaded via "),No=s(tt,"A",{href:!0});var Qd=d(No);za=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(tt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),tt.forEach(o),ja=l(z),Qe=s(z,"P",{});var vn=d(Qe);Fa=r(vn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Xe=s(vn,"A",{href:!0,rel:!0});var Xd=d(Xe);Pa=r(Xd,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Xd.forEach(o),Aa=r(vn,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),vn.forEach(o),Ca=l(z),xt=s(z,"P",{});var ei=d(xt);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),ei.forEach(o),Na=l(z),eo=s(z,"P",{});var yn=d(eo);Ia=r(yn,"This model inherits from "),Io=s(yn,"A",{href:!0});var oi=d(Io);La=r(oi,"TFPreTrainedModel"),oi.forEach(o),Ba=r(yn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yn.forEach(o),Oa=l(z),oo=s(z,"P",{});var kn=d(oo);Va=r(kn,"This model is also a "),to=s(kn,"A",{href:!0,rel:!0});var ti=d(to);Wa=r(ti,"tf.keras.Model"),ti.forEach(o),Ra=r(kn,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kn.forEach(o),Ga=l(z),U=s(z,"P",{});var ko=d(U);Lo=s(ko,"A",{href:!0});var ni=d(Lo);Ua=r(ni,"TFEncoderDecoderModel"),ni.forEach(o),Ha=r(ko,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),ko.forEach(o),Qa=l(z),S=s(z,"DIV",{class:!0});var Z=d(S);u(no.$$.fragment,Z),Xa=l(Z),de=s(Z,"P",{});var nt=d(de);es=r(nt,"The "),Vo=s(nt,"A",{href:!0});var si=d(Vo);os=r(si,"TFEncoderDecoderModel"),si.forEach(o),ts=r(nt," forward method, overrides the "),qt=s(nt,"CODE",{});var di=d(qt);ns=r(di,"__call__"),di.forEach(o),rs=r(nt," special method."),nt.forEach(o),as=l(Z),u(Te.$$.fragment,Z),ss=l(Z),Dt=s(Z,"P",{});var ii=d(Dt);ds=r(ii,"Examples:"),ii.forEach(o),is=l(Z),u(ro.$$.fragment,Z),Z.forEach(o),cs=l(z),L=s(z,"DIV",{class:!0});var Me=d(L);u(ao.$$.fragment,Me),ls=l(Me),zt=s(Me,"P",{});var ci=d(zt);ps=r(ci,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ci.forEach(o),ms=l(Me),$t=s(Me,"P",{});var li=d($t);hs=r(li,"Example:"),li.forEach(o),fs=l(Me),u(so.$$.fragment,Me),Me.forEach(o),z.forEach(o),nn=l(t),ie=s(t,"H2",{class:!0});var Tn=d(ie);we=s(Tn,"A",{id:!0,class:!0,href:!0});var pi=d(we);jt=s(pi,"SPAN",{});var mi=d(jt);u(io.$$.fragment,mi),mi.forEach(o),pi.forEach(o),us=l(Tn),Ft=s(Tn,"SPAN",{});var hi=d(Ft);gs=r(hi,"FlaxEncoderDecoderModel"),hi.forEach(o),Tn.forEach(o),rn=l(t),M=s(t,"DIV",{class:!0});var $=d(M);u(co.$$.fragment,$),_s=l($),ce=s($,"P",{});var rt=d(ce);bs=r(rt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Wo=s(rt,"A",{href:!0});var fi=d(Wo);vs=r(fi,"from_pretrained()"),fi.forEach(o),ys=r(rt," function and the decoder is loaded via "),Ro=s(rt,"A",{href:!0});var ui=d(Ro);ks=r(ui,"from_pretrained()"),ui.forEach(o),Ts=r(rt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Tasks`),gi.forEach(o),xs=r(wn,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),wn.forEach(o),qs=l($),Pt=s($,"P",{});var _i=d(Pt);Ds=r(_i,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),_i.forEach(o),zs=l($),mo=s($,"P",{});var En=d(mo);$s=r(En,"This model inherits from "),Go=s(En,"A",{href:!0});var bi=d(Go);js=r(bi,"FlaxPreTrainedModel"),bi.forEach(o),Fs=r(En,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),En.forEach(o),Ps=l($),ho=s($,"P",{});var Mn=d(ho);As=r(Mn,`This model is also a Flax Linen
`),fo=s(Mn,"A",{href:!0,rel:!0});var vi=d(fo);Cs=r(vi,"flax.nn.Module"),vi.forEach(o),Ss=r(Mn,` subclass. Use it as a
...
encoder and :meth`),Ct=s(To,"EM",{});var Ti=d(Ct);Vs=r(Ti,"~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Ti.forEach(o),Ws=r(To," class method for the decoder."),To.forEach(o),Rs=l($),N=s($,"DIV",{class:!0});var K=d(N);u(uo.$$.fragment,K),Gs=l(K),le=s(K,"P",{});var at=d(le);Us=r(at,"The "),Ho=s(at,"A",{href:!0});var wi=d(Ho);Hs=r(wi,"FlaxEncoderDecoderModel"),wi.forEach(o),Ys=r(at," forward method, overrides the "),St=s(at,"CODE",{});var Ei=d(St);Js=r(Ei,"__call__"),Ei.forEach(o),Zs=r(at," special method."),at.forEach(o),Ks=l(K),u(Ee.$$.fragment,K),Qs=l(K),Nt=s(K,"P",{});var Mi=d(Nt);Xs=r(Mi,"Examples:"),Mi.forEach(o),ed=l(K),u(go.$$.fragment,K),K.forEach(o),od=l($),B=s($,"DIV",{class:!0});var xe=d(B);u(_o.$$.fragment,xe),td=l(xe),It=s(xe,"P",{});var xi=d(It);nd=r(xi,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),xi.forEach(o),rd=l(xe),Lt=s(xe,"P",{});var qi=d(Lt);ad=r(qi,"Example:"),qi.forEach(o),sd=l(xe),u(bo.$$.fragment,xe),xe.forEach(o),$.forEach(o),this.h()},h(){i(m,"name","hf:doc:metadata"),i(m,"content",JSON.stringify(Ni)),i(x,"id","encoder-decoder-models"),i(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(x,"href","#encoder-decoder-models"),i(y,"class","relative group"),i(wo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),i(De,"href","https://arxiv.org/abs/1907.12461"),i(De,"rel","nofollow"),i(Eo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),i(Mo,"href","/docs/transformers/pr_16827/en/model_doc/bert#transformers.BertModel"),i(ze,"href","https://arxiv.org/abs/1908.08345"),i(ze,"rel","nofollow"),i(je,"href","https://github.com/thomwolf"),i(je,"rel","nofollow"),i(Fe,"href","https://github.com/ydshieh"),i(Fe,"rel","nofollow"),i(ue,"id","transformers.EncoderDecoderConfig"),i(ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(ue,"href","#transformers.EncoderDecoderConfig"),i(Q,"class","relative group"),i(xo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),i(qo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),i(Do,"href","/docs/transformers/pr_16827/en/main_classes/configuration#transformers.PretrainedConfig"),i(zo,"href","/docs/transformers/pr_16827/en/main_classes/configuration#transformers.PretrainedConfig"),i($o,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),i(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(ve,"id","transformers.EncoderDecoderModel"),i(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(ve,"href","#transformers.EncoderDecoderModel"),i(oe,"class","relative group"),i(jo,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Fo,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Ve,"href","https://arxiv.org/abs/1907.12461"),i(Ve,"rel","nofollow"),i(Po,"href","/docs/transformers/pr_16827/en/main_classes/model#transformers.PreTrainedModel"),i(Ge,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),i(Ge,"rel","nofollow"),i(Ao,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),i(Co,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),i(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(w,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(ke,"id","transformers.TFEncoderDecoderModel"),i(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(ke,"href","#transformers.TFEncoderDecoderModel"),i(ae,"class","relative group"),i(So,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(No,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Xe,"href","https://arxiv.org/abs/1907.12461"),i(Xe,"rel","nofollow"),i(Io,"href","/docs/transformers/pr_16827/en/main_classes/model#transformers.TFPreTrainedModel"),i(to,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),i(to,"rel","nofollow"),i(Lo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.TFEncoderDecoderModel"),i(Bo,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Oo,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Vo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.TFEncoderDecoderModel"),i(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(we,"id","transformers.FlaxEncoderDecoderModel"),i(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(we,"href","#transformers.FlaxEncoderDecoderModel"),i(ie,"class","relative group"),i(Wo,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Ro,"href","/docs/transformers/pr_16827/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(po,"href","https://arxiv.org/abs/1907.12461"),i(po,"rel","nofollow"),i(Go,"href","/docs/transformers/pr_16827/en/main_classes/model#transformers.FlaxPreTrainedModel"),i(fo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),i(fo,"rel","nofollow"),i(Uo,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.FlaxEncoderDecoderModel"),i(Ho,"href","/docs/transformers/pr_16827/en/model_doc/encoder-decoder#transformers.FlaxEncoderDecoderModel"),i(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,p){e(document.head,m),h(t,F,p),h(t,y,p),e(y,x),e(x,j),g(k,j,null),e(y,T),e(y,P),e(P,xn),h(t,Rt,p),h(t,me,p),e(me,qn),e(me,wo),e(wo,Dn),e(me,zn),h(t,Gt,p),h(t,he,p),e(he,$n),e(he,De),e(De,jn),e(he,Fn),h(t,Ut,p),h(t,fe,p),e(fe,Pn),e(fe,Eo),e(Eo,An),e(fe,Cn),h(t,Ht,p),h(t,V,p),e(V,Sn),e(V,Mo),e(Mo,Nn),e(V,In),e(V,ze),e(ze,Ln),e(V,Bn),h(t,Yt,p),h(t,W,p),e(W,On),e(W,st),e(st,Vn),e(W,Wn),e(W,dt),e(dt,Rn),e(W,Gn),h(t,Jt,p),g($e,t,p),h(t,Zt,p),h(t,R,p),e(R,Un),e(R,je),e(je,Hn),e(R,Yn),e(R,Fe),e(Fe,Jn),e(R,Zn),h(t,Kt,p),h(t,Q,p),e(Q,ue),e(ue,it),g(Pe,it,null),e(Q,Kn),e(Q,ct),e(ct,Qn),h(t,Qt,p),h(t,q,p),g(Ae,q,null),e(q,Xn),e(q,ge),e(ge,xo),e(xo,er),e(ge,or),e(ge,qo),e(qo,tr),e(ge,nr),e(q,rr),e(q,X),e(X,ar),e(X,Do),e(Do,sr),e(X,dr),e(X,zo),e(zo,ir),e(X,cr),e(q,lr),e(q,lt),e(lt,pr),e(q,mr),g(Ce,q,null),e(q,hr),e(q,_e),g(Se,_e,null),e(_e,fr),e(_e,Ne),e(Ne,ur),e(Ne,$o),e($o,gr),e(Ne,_r),e(q,br),e(q,be),g(Ie,be,null),e(be,vr),e(be,ee),e(ee,yr),e(ee,pt),e(pt,kr),e(ee,Tr),e(ee,mt),e(mt,wr),e(ee,Er),h(t,Xt,p),h(t,oe,p),e(oe,ve),e(ve,ht),g(Le,ht,null),e(oe,Mr),e(oe,ft),e(ft,xr),h(t,en,p),h(t,w,p),g(Be,w,null),e(w,qr),e(w,te),e(te,Dr),e(te,jo),e(jo,zr),e(te,$r),e(te,Fo),e(Fo,jr),e(te,Fr),e(w,Pr),e(w,Oe),e(Oe,Ar),e(Oe,Ve),e(Ve,Cr),e(Oe,Sr),e(w,Nr),e(w,ut),e(ut,Ir),e(w,Lr),e(w,We),e(We,Br),e(We,Po),e(Po,Or),e(We,Vr),e(w,Wr),e(w,Re),e(Re,Rr),e(Re,Ge),e(Ge,Gr),e(Re,Ur),e(w,Hr),e(w,G),e(G,Ao),e(Ao,Yr),e(G,Jr),e(G,gt),e(gt,Zr),e(G,Kr),e(G,_t),e(_t,Qr),e(G,Xr),e(w,ea),e(w,A),g(Ue,A,null),e(A,oa),e(A,ne),e(ne,ta),e(ne,Co),e(Co,na),e(ne,ra),e(ne,bt),e(bt,aa),e(ne,sa),e(A,da),g(ye,A,null),e(A,ia),e(A,vt),e(vt,ca),e(A,la),g(He,A,null),e(w,pa),e(w,C),g(Ye,C,null),e(C,ma),e(C,yt),e(yt,ha),e(C,fa),e(C,re),e(re,ua),e(re,kt),e(kt,ga),e(re,_a),e(re,Tt),e(Tt,ba),e(re,va),e(C,ya),e(C,wt),e(wt,ka),e(C,Ta),g(Je,C,null),h(t,on,p),h(t,ae,p),e(ae,ke),e(ke,Et),g(Ze,Et,null),e(ae,wa),e(ae,Mt),e(Mt,Ea),h(t,tn,p),h(t,E,p),g(Ke,E,null),e(E,Ma),e(E,se),e(se,xa),e(se,So),e(So,qa),e(se,Da),e(se,No),e(No,za),e(se,$a),e(E,ja),e(E,Qe),e(Qe,Fa),e(Qe,Xe),e(Xe,Pa),e(Qe,Aa),e(E,Ca),e(E,xt),e(xt,Sa),e(E,Na),e(E,eo),e(eo,Ia),e(eo,Io),e(Io,La),e(eo,Ba),e(E,Oa),e(E,oo),e(oo,Va),e(oo,to),e(to,Wa),e(oo,Ra),e(E,Ga),e(E,U),e(U,Lo),e(Lo,Ua),e(U,Ha),e(U,Bo),e(Bo,Ya),e(U,Ja),e(U,Oo),e(Oo,Za),e(U,Ka),e(E,Qa),e(E,S),g(no,S,null),e(S,Xa),e(S,de),e(de,es),e(de,Vo),e(Vo,os),e(de,ts),e(de,qt),e(qt,ns),e(de,rs),e(S,as),g(Te,S,null),e(S,ss),e(S,Dt),e(Dt,ds),e(S,is),g(ro,S,null),e(E,cs),e(E,L),g(ao,L,null),e(L,ls),e(L,zt),e(zt,ps),e(L,ms),e(L,$t),e($t,hs),e(L,fs),g(so,L,null),h(t,nn,p),h(t,ie,p),e(ie,we),e(we,jt),g(io,jt,null),e(ie,us),e(ie,Ft),e(Ft,gs),h(t,rn,p),h(t,M,p),g(co,M,null),e(M,_s),e(M,ce),e(ce,bs),e(ce,Wo),e(Wo,vs),e(ce,ys),e(ce,Ro),e(Ro,ks),e(ce,Ts),e(M,ws),e(M,lo),e(lo,Es),e(lo,po),e(po,Ms),e(lo,xs),e(M,qs),e(M,Pt),e(Pt,Ds),e(M,zs),e(M,mo),e(mo,$s),e(mo,Go),e(Go,js),e(mo,Fs),e(M,Ps),e(M,ho),e(ho,As),e(ho,fo),e(fo,Cs),e(ho,Ss),e(M,Ns),e(M,H),e(H,Uo),e(Uo,Is),e(H,Ls),e(H,At),e(At,Bs),e(H,Os),e(H,Ct),e(Ct,Vs),e(H,Ws),e(M,Rs),e(M,N),g(uo,N,null),e(N,Gs),e(N,le),e(le,Us),e(le,Ho),e(Ho,Hs),e(le,Ys),e(le,St),e(St,Js),e(le,Zs),e(N,Ks),g(Ee,N,null),e(N,Qs),e(N,Nt),e(Nt,Xs),e(N,ed),g(go,N,null),e(M,od),e(M,B),g(_o,B,null),e(B,td),e(B,It),e(It,nd),e(B,rd),e(B,Lt),e(Lt,ad),e(B,sd),g(bo,B,null),an=!0},p(t,[p]){const vo={};p&2&&(vo.$$scope={dirty:p,ctx:t}),ye.$set(vo);const Bt={};p&2&&(Bt.$$scope={dirty:p,ctx:t}),Te.$set(Bt);const Ot={};p&2&&(Ot.$$scope={dirty:p,ctx:t}),Ee.$set(Ot)},i(t){an||(_(k.$$.fragment,t),_($e.$$.fragment,t),_(Pe.$$.fragment,t),_(Ae.$$.fragment,t),_(Ce.$$.fragment,t),_(Se.$$.fragment,t),_(Ie.$$.fragment,t),_(Le.$$.fragment,t),_(Be.$$.fragment,t),_(Ue.$$.fragment,t),_(ye.$$.fragment,t),_(He.$$.fragment,t),_(Ye.$$.fragment,t),_(Je.$$.fragment,t),_(Ze.$$.fragment,t),_(Ke.$$.fragment,t),_(no.$$.fragment,t),_(Te.$$.fragment,t),_(ro.$$.fragment,t),_(ao.$$.fragment,t),_(so.$$.fragment,t),_(io.$$.fragment,t),_(co.$$.fragment,t),_(uo.$$.fragment,t),_(Ee.$$.fragment,t),_(go.$$.fragment,t),_(_o.$$.fragment,t),_(bo.$$.fragment,t),an=!0)},o(t){b(k.$$.fragment,t),b($e.$$.fragment,t),b(Pe.$$.fragment,t),b(Ae.$$.fragment,t),b(Ce.$$.fragment,t),b(Se.$$.fragment,t),b(Ie.$$.fragment,t),b(Le.$$.fragment,t),b(Be.$$.fragment,t),b(Ue.$$.fragment,t),b(ye.$$.fragment,t),b(He.$$.fragment,t),b(Ye.$$.fragment,t),b(Je.$$.fragment,t),b(Ze.$$.fragment,t),b(Ke.$$.fragment,t),b(no.$$.fragment,t),b(Te.$$.fragment,t),b(ro.$$.fragment,t),b(ao.$$.fragment,t),b(so.$$.fragment,t),b(io.$$.fragment,t),b(co.$$.fragment,t),b(uo.$$.fragment,t),b(Ee.$$.fragment,t),b(go.$$.fragment,t),b(_o.$$.fragment,t),b(bo.$$.fragment,t),an=!1},d(t){o(m),t&&o(F),t&&o(y),v(k),t&&o(Rt),t&&o(me),t&&o(Gt),t&&o(he),t&&o(Ut),t&&o(fe),t&&o(Ht),t&&o(V),t&&o(Yt),t&&o(W),t&&o(Jt),v($e,t),t&&o(Zt),t&&o(R),t&&o(Kt),t&&o(Q),v(Pe),t&&o(Qt),t&&o(q),v(Ae),v(Ce),v(Se),v(Ie),t&&o(Xt),t&&o(oe),v(Le),t&&o(en),t&&o(w),v(Be),v(Ue),v(ye),v(He),v(Ye),v(Je),t&&o(on),t&&o(ae),v(Ze),t&&o(tn),t&&o(E),v(Ke),v(no),v(Te),v(ro),v(ao),v(so),t&&o(nn),t&&o(ie),v(io),t&&o(rn),t&&o(M),v(co),v(uo),v(Ee),v(go),v(_o),v(bo)}}}const Ni={local:"encoder-decoder-models",sections:[{local:"transformers.EncoderDecoderConfig",title:"EncoderDecoderConfig"},{local:"transformers.EncoderDecoderModel",title:"EncoderDecoderModel"},{local:"transformers.TFEncoderDecoderModel",title:"TFEncoderDecoderModel"},{local:"transformers.FlaxEncoderDecoderModel",title:"FlaxEncoderDecoderModel"}],title:"Encoder Decoder Models"};function Ii(pe){return Fi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ri extends Di{constructor(m){super();zi(this,m,Ii,Si,$i,{})}}export{Ri as default,Ni as metadata};
