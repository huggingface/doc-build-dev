...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16151/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16151/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16151/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16151/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16151/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16151/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[W2]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16151/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16151/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16151/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16151/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16151/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16151/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),_r=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16151/src/transformers/models/mbart/modeling_flax_mbart.py#L1343",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16151/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16151/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16151/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16151/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16151/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16151/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16151/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yb=d(),$s=n("p"),e1=r("This model is also a "),Fs=n("a"),t1=r("tf.keras.Model"),o1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),n1=d(),m(cn.$$.fragment),a1=d(),Ie=n("div"),m(js.$$.fragment),s1=d(),Mo=n("p"),r1=r("The "),xi=n("a"),i1=r("TFMBartModel"),d1=r(" forward method, overrides the "),oc=n("code"),l1=r("__call__"),c1=r(" special method."),p1=d(),m(pn.$$.fragment),h1=d(),nc=n("p"),u1=r("Example:"),m1=d(),m(Es.$$.fragment),eh=d(),wo=n("h2"),hn=n("a"),ac=n("span"),m(Ps.$$.fragment),f1=d(),sc=n("span"),_1=r("TFMBartForConditionalGeneration"),th=d(),Fe=n("div"),m(Cs.$$.fragment),g1=d(),Ss=n("p"),k1=r(`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=n("a"),b1=r("TFPreTrainedModel"),v1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),y1=d(),As=n("p"),T1=r("This model is also a "),Is=n("a"),M1=r("tf.keras.Model"),w1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),x1=d(),m(un.$$.fragment),z1=d(),ee=n("div"),m(Ns.$$.fragment),q1=d(),xo=n("p"),B1=r("The "),qi=n("a"),$1=r("TFMBartForConditionalGeneration"),F1=r(" forward method, overrides the "),rc=n("code"),j1=r("__call__"),E1=r(" special method."),P1=d(),m(mn.$$.fragment),C1=d(),ic=n("p"),S1=r("Summarization example:"),A1=d(),m(Os.$$.fragment),I1=d(),dc=n("p"),N1=r("Mask filling example:"),O1=d(),m(Ds.$$.fragment),oh=d(),zo=n("h2"),fn=n("a"),lc=n("span"),m(Ls.$$.fragment),D1=d(),cc=n("span"),L1=r("FlaxMBartModel"),nh=d(),W=n("div"),m(Gs.$$.fragment),G1=d(),Ws=n("p"),W1=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=n("a"),R1=r("FlaxPreTrainedModel"),U1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),X1=d(),Rs=n("p"),H1=r(`This model is also a Flax Linen
`),Us=n("a"),V1=r("flax.nn.Module"),Q1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),J1=d(),pc=n("p"),K1=r("Finally, this model supports inherent JAX features such as:"),Z1=d(),mt=n("ul"),hc=n("li"),Xs=n("a"),Y1=r("Just-In-Time (JIT) compilation"),ev=d(),uc=n("li"),Hs=n("a"),tv=r("Automatic Differentiation"),ov=d(),mc=n("li"),Vs=n("a"),nv=r("Vectorization"),av=d(),fc=n("li"),Qs=n("a"),sv=r("Parallelization"),rv=d(),Ne=n("div"),m(Js.$$.fragment),iv=d(),qo=n("p"),dv=r("The "),_c=n("code"),lv=r("FlaxMBartPreTrainedModel"),cv=r("forward method, overrides the "),gc=n("code"),pv=r("__call__"),hv=r(" special method."),uv=d(),m(_n.$$.fragment),mv=d(),kc=n("p"),fv=r("Example:"),_v=d(),m(Ks.$$.fragment),gv=d(),Mt=n("div"),m(Zs.$$.fragment),kv=d(),bc=n("p"),bv=r("Example:"),vv=d(),m(Ys.$$.fragment),yv=d(),wt=n("div"),m(er.$$.fragment),Tv=d(),vc=n("p"),Mv=r("Example:"),wv=d(),m(tr.$$.fragment),ah=d(),Bo=n("h2"),gn=n("a"),yc=n("span"),m(or.$$.fragment),xv=d(),Tc=n("span"),zv=r("FlaxMBartForConditionalGeneration"),sh=d(),R=n("div"),m(nr.$$.fragment),qv=d(),ar=n("p"),Bv=r(`The MMBart Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Ot),$s=a(Ot,"P",{});var _u=s($s);e1=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var Vx=s(Fs);t1=i(Vx,"tf.keras.Model"),Vx.forEach(t),o1=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),n1=l(Ot),f(cn.$$.fragment,Ot),a1=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),s1=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);r1=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qx=s(xi);i1=i(Qx,"TFMBartModel"),Qx.forEach(t),d1=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jx=s(oc);l1=i(Jx,"__call__"),Jx.forEach(t),c1=i(Ui," special method."),Ui.forEach(t),p1=l(Dt),f(pn.$$.fragment,Dt),h1=l(Dt),nc=a(Dt,"P",{});var Kx=s(nc);u1=i(Kx,"Example:"),Kx.forEach(t),m1=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zx=s(hn);ac=a(Zx,"SPAN",{});var Yx=s(ac);f(Ps.$$.fragment,Yx),Yx.forEach(t),Zx.forEach(t),f1=l(gu),sc=a(gu,"SPAN",{});var ez=s(sc);_1=i(ez,"TFMBartForConditionalGeneration"),ez.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),g1=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);k1=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tz=s(zi);b1=i(tz,"TFPreTrainedModel"),tz.forEach(t),v1=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),y1=l(Lt),As=a(Lt,"P",{});var bu=s(As);T1=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var oz=s(Is);M1=i(oz,"tf.keras.Model"),oz.forEach(t),w1=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),x1=l(Lt),f(un.$$.fragment,Lt),z1=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Ns.$$.fragment,We),q1=l(We),xo=a(We,"P",{});var Xi=s(xo);B1=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nz=s(qi);$1=i(nz,"TFMBartForConditionalGeneration"),nz.forEach(t),F1=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var az=s(rc);j1=i(az,"__call__"),az.forEach(t),E1=i(Xi," special method."),Xi.forEach(t),P1=l(We),f(mn.$$.fragment,We),C1=l(We),ic=a(We,"P",{});var sz=s(ic);S1=i(sz,"Summarization example:"),sz.forEach(t),A1=l(We),f(Os.$$.fragment,We),I1=l(We),dc=a(We,"P",{});var rz=s(dc);N1=i(rz,"Mask filling example:"),rz.forEach(t),O1=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var vu=s(zo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var iz=s(fn);lc=a(iz,"SPAN",{});var dz=s(lc);f(Ls.$$.fragment,dz),dz.forEach(t),iz.forEach(t),D1=l(vu),cc=a(vu,"SPAN",{});var lz=s(cc);L1=i(lz,"FlaxMBartModel"),lz.forEach(t),vu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),G1=l(me),Ws=a(me,"P",{});var yu=s(Ws);W1=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(yu,"A",{href:!0});var cz=s(Bi);R1=i(cz,"FlaxPreTrainedModel"),cz.forEach(t),U1=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),X1=l(me),Rs=a(me,"P",{});var Tu=s(Rs);H1=i(Tu,`This model is also a Flax Linen
`),Us=a(Tu,"A",{href:!0,rel:!0});var pz=s(Us);V1=i(pz,"flax.nn.Module"),pz.forEach(t),Q1=i(Tu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),J1=l(me),pc=a(me,"P",{});var hz=s(pc);K1=i(hz,"Finally, this model supports inherent JAX features such as:"),hz.forEach(t),Z1=l(me),mt=a(me,"UL",{});var Fn=s(mt);hc=a(Fn,"LI",{});var uz=s(hc);Xs=a(uz,"A",{href:!0,rel:!0});var mz=s(Xs);Y1=i(mz,"Just-In-Time (JIT) compilation"),mz.forEach(t),uz.forEach(t),ev=l(Fn),uc=a(Fn,"LI",{});var fz=s(uc);Hs=a(fz,"A",{href:!0,rel:!0});var _z=s(Hs);tv=i(_z,"Automatic Differentiation"),_z.forEach(t),fz.forEach(t),ov=l(Fn),mc=a(Fn,"LI",{});var gz=s(mc);Vs=a(gz,"A",{href:!0,rel:!0});var kz=s(Vs);nv=i(kz,"Vectorization"),kz.forEach(t),gz.forEach(t),av=l(Fn),fc=a(Fn,"LI",{});var bz=s(fc);Qs=a(bz,"A",{href:!0,rel:!0});var vz=s(Qs);sv=i(vz,"Parallelization"),vz.forEach(t),bz.forEach(t),Fn.forEach(t),rv=l(me),Ne=a(me,"DIV",{class:!0});var Gt=s(Ne);f(Js.$$.fragment,Gt),iv=l(Gt),qo=a(Gt,"P",{});var Hi=s(qo);dv=i(Hi,"The "),_c=a(Hi,"CODE",{});var yz=s(_c);lv=i(yz,"FlaxMBartPreTrainedModel"),yz.forEach(t),cv=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tz=s(gc);pv=i(Tz,"__call__"),Tz.forEach(t),hv=i(Hi," special method."),Hi.forEach(t),uv=l(Gt),f(_n.$$.fragment,Gt),mv=l(Gt),kc=a(Gt,"P",{});var Mz=s(kc);fv=i(Mz,"Example:"),Mz.forEach(t),_v=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gv=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),kv=l(Vi),bc=a(Vi,"P",{});var wz=s(bc);bv=i(wz,"Example:"),wz.forEach(t),vv=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),yv=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Tv=l(Qi),vc=a(Qi,"P",{});var xz=s(vc);Mv=i(xz,"Example:"),xz.forEach(t),wv=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(o),Bo=a(o,"H2",{class:!0});var Mu=s(Bo);gn=a(Mu,"A",{id:!0,class:!0,href:!0});var zz=s(gn);yc=a(zz,"SPAN",{});var qz=s(yc);f(or.$$.fragment,qz),qz.forEach(t),zz.forEach(t),xv=l(Mu),Tc=a(Mu,"SPAN",{});var Bz=s(Tc);zv=i(Bz,"FlaxMBartForConditionalGeneration"),Bz.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(nr.$$.fragment,fe),qv=l(fe),ar=a(fe,"P",{});var wu=s(ar);Bv=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sv=l(fe),Mc=a(fe,"P",{});var jz=s(Mc);Av=i(jz,"Finally, this model supports inherent JAX features such as:"),jz.forEach(t),Iv=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ez=s(wc);ir=a(Ez,"A",{href:!0,rel:!0});var Pz=s(ir);Nv=i(Pz,"Just-In-Time (JIT) compilation"),Pz.forEach(t),Ez.forEach(t),Ov=l(jn),xc=a(jn,"LI",{});var Cz=s(xc);dr=a(Cz,"A",{href:!0,rel:!0});var Sz=s(dr);Dv=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Cz.forEach(t),Lv=l(jn),zc=a(jn,"LI",{});var Az=s(zc);lr=a(Az,"A",{href:!0,rel:!0});var Iz=s(lr);Gv=i(Iz,"Vectorization"),Iz.forEach(t),Az.forEach(t),Wv=l(jn),qc=a(jn,"LI",{});var Nz=s(qc);cr=a(Nz,"A",{href:!0,rel:!0});var Oz=s(cr);Rv=i(Oz,"Parallelization"),Oz.forEach(t),Nz.forEach(t),jn.forEach(t),Uv=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xv=l(Re),$o=a(Re,"P",{});var Ji=s($o);Hv=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dz=s(Bc);Vv=i(Dz,"FlaxMBartPreTrainedModel"),Dz.forEach(t),Qv=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var Lz=s($c);Jv=i(Lz,"__call__"),Lz.forEach(t),Kv=i(Ji," special method."),Ji.forEach(t),Zv=l(Re),f(kn.$$.fragment,Re),Yv=l(Re),Fc=a(Re,"P",{});var Gz=s(Fc);ey=i(Gz,"Summarization example:"),Gz.forEach(t),ty=l(Re),f(hr.$$.fragment,Re),oy=l(Re),jc=a(Re,"P",{});var Wz=s(jc);ny=i(Wz,"Mask filling example:"),Wz.forEach(t),ay=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sy=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),ry=l(Ki),Ec=a(Ki,"P",{});var Rz=s(Ec);iy=i(Rz,"Example:"),Rz.forEach(t),dy=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),ly=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cy=l(Zi),Pc=a(Zi,"P",{});var Uz=s(Pc);py=i(Uz,"Example:"),Uz.forEach(t),hy=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var zu=s(Fo);bn=a(zu,"A",{id:!0,class:!0,href:!0});var Xz=s(bn);Cc=a(Xz,"SPAN",{});var Hz=s(Cc);f(kr.$$.fragment,Hz),Hz.forEach(t),Xz.forEach(t),uy=l(zu),Sc=a(zu,"SPAN",{});var Vz=s(Sc);my=i(Vz,"FlaxMBartForSequenceClassification"),Vz.forEach(t),zu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),fy=l(oe),Ac=a(oe,"P",{});var Qz=s(Ac);_y=i(Qz,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qz.forEach(t),gy=l(oe),vr=a(oe,"P",{});var qu=s(vr);ky=i(qu,"This model inherits from "),Fi=a(qu,"A",{href:!0});var Jz=s(Fi);by=i(Jz,"FlaxPreTrainedModel"),Jz.forEach(t),vy=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),yy=l(oe),yr=a(oe,"P",{});var Bu=s(yr);Ty=i(Bu,`This model is also a Flax Linen
`),Tr=a(Bu,"A",{href:!0,rel:!0});var Kz=s(Tr);My=i(Kz,"flax.nn.Module"),Kz.forEach(t),wy=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),xy=l(oe),Ic=a(oe,"P",{});var Zz=s(Ic);zy=i(Zz,"Finally, this model supports inherent JAX features such as:"),Zz.forEach(t),qy=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Yz=s(Nc);Mr=a(Yz,"A",{href:!0,rel:!0});var e2=s(Mr);By=i(e2,"Just-In-Time (JIT) compilation"),e2.forEach(t),Yz.forEach(t),$y=l(En),Oc=a(En,"LI",{});var t2=s(Oc);wr=a(t2,"A",{href:!0,rel:!0});var o2=s(wr);Fy=i(o2,"Automatic Differentiation"),o2.forEach(t),t2.forEach(t),jy=l(En),Dc=a(En,"LI",{});var n2=s(Dc);xr=a(n2,"A",{href:!0,rel:!0});var a2=s(xr);Ey=i(a2,"Vectorization"),a2.forEach(t),n2.forEach(t),Py=l(En),Lc=a(En,"LI",{});var s2=s(Lc);zr=a(s2,"A",{href:!0,rel:!0});var r2=s(zr);Cy=i(r2,"Parallelization"),r2.forEach(t),s2.forEach(t),En.forEach(t),Sy=l(oe),Oe=a(oe,"DIV",{class:!0});var Wt=s(Oe);f(qr.$$.fragment,Wt),Ay=l(Wt),jo=a(Wt,"P",{});var Yi=s(jo);Iy=i(Yi,"The "),Gc=a(Yi,"CODE",{});var i2=s(Gc);Ny=i(i2,"FlaxMBartPreTrainedModel"),i2.forEach(t),Oy=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var d2=s(Wc);Dy=i(d2,"__call__"),d2.forEach(t),Ly=i(Yi," special method."),Yi.forEach(t),Gy=l(Wt),f(vn.$$.fragment,Wt),Wy=l(Wt),Rc=a(Wt,"P",{});var l2=s(Rc);Ry=i(l2,"Example:"),l2.forEach(t),Uy=l(Wt),f(Br.$$.fragment,Wt),Wt.forEach(t),Xy=l(oe),qt=a(oe,"DIV",{class:!0});var ed=s(qt);f($r.$$.fragment,ed),Hy=l(ed),Uc=a(ed,"P",{});var c2=s(Uc);Vy=i(c2,"Example:"),c2.forEach(t),Qy=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),Jy=l(oe),Bt=a(oe,"DIV",{class:!0});var td=s(Bt);f(jr.$$.fragment,td),Ky=l(td),Xc=a(td,"P",{});var p2=s(Xc);Zy=i(p2,"Example:"),p2.forEach(t),Yy=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var h2=s(yn);Hc=a(h2,"SPAN",{});var u2=s(Hc);f(Pr.$$.fragment,u2),u2.forEach(t),h2.forEach(t),eT=l($u),Vc=a($u,"SPAN",{});var m2=s(Vc);tT=i(m2,"FlaxMBartForQuestionAnswering"),m2.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),oT=l(ne),Po=a(ne,"P",{});var od=s(Po);nT=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
