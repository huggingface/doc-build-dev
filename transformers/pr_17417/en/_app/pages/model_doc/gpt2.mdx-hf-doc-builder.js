...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(n,m){_(n,d,m),e(d,T),e(d,u),e(u,c),e(d,g)},d(n){n&&t(d)}}}function Fb(G){let d,T,u,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer, GPT2Model
import torch
...
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,u,x),_(v,c,x),e(c,g),e(g,n),e(c,m),e(c,F),e(F,Q),_(v,C,x),_(v,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,me),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(u),v&&t(c),v&&t(C),v&&t(j),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function Vb(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var F=l(u);c=i(F,"Module"),F.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),T=r("Example:"),u=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Example:"),m.forEach(t),u=h(n),k(c.$$.fragment,n)},m(n,m){_(n,d,m),e(d,T),_(n,u,m),w(c,n,m),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(u),M(c,n)}}}function Jb(G){let d,T,u,c,g,n,m,F,Q,C,j,B,I,Z,_e,S,Te,me,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ve,U,R,de,K,ye,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),u=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),m=p(),F=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),j=s("p"),B=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),me=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ve=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),R=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),u=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),m=h(ne),F=a(ne,"LI",{});var Ae=l(F);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(v),j=a(v,"P",{});var H=l(j);B=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,u,x),_(v,c,x),e(c,g),e(g,n),e(c,m),e(c,F),e(F,Q),_(v,C,x),_(v,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,me),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(u),v&&t(c),v&&t(C),v&&t(j),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function Xb(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var F=l(u);c=i(F,"Module"),F.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),T=r("Example:"),u=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Example:"),m.forEach(t),u=h(n),k(c.$$.fragment,n)},m(n,m){_(n,d,m),e(d,T),_(n,u,m),w(c,n,m),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(u),M(c,n)}}}function Qb(G){let d,T,u,c,g,n,m,F,Q,C,j,B,I,Z,_e,S,Te,me,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ve,U,R,de,K,ye,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),u=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),m=p(),F=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),j=s("p"),B=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),me=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ve=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),R=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),u=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),m=h(ne),F=a(ne,"LI",{});var Ae=l(F);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(v),j=a(v,"P",{});var H=l(j);B=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,u,x),_(v,c,x),e(c,g),e(g,n),e(c,m),e(c,F),e(F,Q),_(v,C,x),_(v,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,me),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(u),v&&t(c),v&&t(C),v&&t(j),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function Zb(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var F=l(u);c=i(F,"Module"),F.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,u,x),_(v,c,x),e(c,g),e(g,n),e(c,m),e(c,F),e(F,Q),_(v,C,x),_(v,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,me),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(u),v&&t(c),v&&t(C),v&&t(j),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function ov(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var F=l(u);c=i(F,"Module"),F.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),u=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Example:"),m.forEach(t),u=h(n),k(c.$$.fragment,n)},m(n,m){_(n,d,m),e(d,T),_(n,u,m),w(c,n,m),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(u),M(c,n)}}}function dv(G){let d,T,u,c,g,n,m,F,Q,C,j,B,I,Z,_e,S,Te,me,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ve,U,R,de,K,ye,oe,N,ce,J,ke,v,x,ne,Ee,Ae,H,qe,We,Ue,D,X,Re,Ce,Y,Be,De,we,Ve,za,hc,uc,$r,mc,fc,Ea,gc,_c,Tc,yt,bc,Pr,vc,yc,Mr,kc,wc,Cn,$c,Pc,Hl,Lt,Dn,Mc,Gc,Gr,xc,Fc,Il,Gt,jc,Ln,zc,Ec,On,qc,Cc,Sl,Ot,go,xr,Nn,Dc,Fr,Lc,Al,at,Hn,Oc,kt,Nc,qa,Hc,Ic,Ca,Sc,Ac,In,Wc,Uc,Rc,Nt,Bc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,Ht,To,jr,Sn,Qc,zr,Zc,Ul,pe,An,ep,Er,tp,op,qr,np,sp,bo,ap,Wn,rp,Cr,ip,lp,dp,vo,cp,Un,pp,Oa,hp,up,mp,Na,Rn,Rl,It,yo,Dr,Bn,fp,Lr,gp,Bl,$e,Vn,_p,Kn,Tp,Or,bp,vp,yp,Nr,kp,wp,ko,$p,Jn,Pp,Hr,Mp,Gp,xp,wo,Fp,Xn,jp,Ha,zp,Ep,Vl,St,$o,Ir,Yn,qp,Sr,Cp,Kl,At,Qn,Dp,Ar,Lp,Jl,Wt,Zn,Op,Wr,Np,Xl,Ut,Po,Ur,es,Hp,Rr,Ip,Yl,Pe,ts,Sp,Br,Ap,Wp,os,Up,Ia,Rp,Bp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Rt,Zp,Sa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,uh,Xr,mh,fh,Fo,Ql,Bt,jo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,bh,vh,cs,yh,Aa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,us,Fh,Vt,jh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Oh,pt,ms,Nh,ti,Hh,Ih,oi,Sh,Ah,qo,Wh,Ft,fs,Uh,ni,Rh,Bh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,eu,tu,bs,ou,vs,nu,su,au,ht,ys,ru,Jt,iu,Ra,lu,du,ii,cu,pu,hu,Lo,uu,Oo,od,Xt,No,li,ks,mu,di,fu,nd,Ge,ws,gu,ci,_u,Tu,Ba,Va,bu,vu,yu,rt,ku,pi,wu,$u,hi,Pu,Mu,ui,Gu,xu,mi,Fu,ju,zu,$s,Eu,Ka,qu,Cu,Du,Ps,Lu,Ms,Ou,Nu,Hu,je,Gs,Iu,Yt,Su,Ja,Au,Wu,fi,Uu,Ru,Bu,Ho,Vu,Io,Ku,So,Ju,Ao,Xu,Wo,sd,Qt,Uo,gi,xs,Yu,_i,Qu,ad,Je,Fs,Zu,Ti,em,tm,js,om,Xa,nm,sm,am,zs,rm,Es,im,lm,dm,Xe,qs,cm,Zt,pm,Ya,hm,um,bi,mm,fm,gm,Ro,_m,Bo,Tm,Vo,rd,eo,Ko,vi,Cs,bm,yi,vm,id,Le,Ds,ym,ki,km,wm,Ls,$m,Qa,Pm,Mm,Gm,Os,xm,Ns,Fm,jm,zm,Jo,Em,ut,Hs,qm,to,Cm,Za,Dm,Lm,wi,Om,Nm,Hm,Xo,Im,Yo,ld,oo,Qo,$i,Is,Sm,Pi,Am,dd,Oe,Ss,Wm,Mi,Um,Rm,As,Bm,er,Vm,Km,Jm,Ws,Xm,Us,Ym,Qm,Zm,Zo,ef,mt,Rs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Bs,cf,Fi,pf,pd,Ne,Vs,hf,ji,uf,mf,Ks,ff,or,gf,_f,Tf,Js,bf,Xs,vf,yf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,Ff,jf,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,ud,he,Zs,Cf,Ci,Df,Lf,sr,ar,Of,Nf,Hf,it,If,Di,Sf,Af,Li,Wf,Uf,Oi,Rf,Bf,Ni,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Hi,dg,cg,pg,dn,hg,cn,ug,pn,md,lo,hn,Ii,sa,mg,Si,fg,fd,co,aa,gg,Ai,_g,gd,po,un,Wi,ra,Tg,Ui,bg,_d,xe,ia,vg,Ri,yg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,Fg,jg,Bi,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ua,Og,Ng,Xi,ma,Hg,Ig,gt,fa,Sg,ho,Ag,Yi,Wg,Ug,Qi,Rg,Bg,Vg,mn,Kg,fn,Td,uo,gn,Zi,ga,Jg,el,Xg,bd,Fe,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,ba,s_,va,a_,r_,i_,ol,l_,d_,$t,nl,ya,c_,p_,sl,ka,h_,u_,al,wa,m_,f_,rl,$a,g_,__,_t,Pa,T_,mo,b_,il,v_,y_,ll,k_,w_,$_,_n,P_,Tn,vd;return n=new ze({}),Z=new ze({}),Nn=new ze({}),Hn=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17417/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_17417/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17417/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17417/src/transformers/models/gpt2/modeling_gpt2.py#L692"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[jb]},$$scope:{ctx:G}}}),is=new L({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17417/src/transformers/models/gpt2/modeling_gpt2.py#L712"}}),Fo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zb]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new L({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17417/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17417/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_17417/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au=p(),ht=s("div"),y(ys.$$.fragment),ru=p(),Jt=s("p"),iu=r("The "),Ra=s("a"),lu=r("GPT2DoubleHeadsModel"),du=r(" forward method, overrides the "),ii=s("code"),cu=r("__call__"),pu=r(" special method."),hu=p(),y(Lo.$$.fragment),uu=p(),y(Oo.$$.fragment),od=p(),Xt=s("h2"),No=s("a"),li=s("span"),y(ks.$$.fragment),mu=p(),di=s("span"),fu=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),y(ws.$$.fragment),gu=p(),ci=s("p"),_u=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tu=p(),Ba=s("p"),Va=s("a"),bu=r("GPT2ForSequenceClassification"),vu=r(` uses the last token in order to do the classification, as other causal models
...
it will evenly distribute blocks across all devices.`),dT.forEach(t),ph=h(wn),k(xo.$$.fragment,wn),wn.forEach(t),hh=h(Ze),xt=a(Ze,"DIV",{class:!0});var hr=l(xt);k(is.$$.fragment,hr),uh=h(hr),Xr=a(hr,"P",{});var cT=l(Xr);mh=i(cT,"Moves the model to cpu from a model parallel state."),cT.forEach(t),fh=h(hr),k(Fo.$$.fragment,hr),hr.forEach(t),Ze.forEach(t),Ql=h(o),Bt=a(o,"H2",{class:!0});var Cd=l(Bt);jo=a(Cd,"A",{id:!0,class:!0,href:!0});var pT=l(jo);Yr=a(pT,"SPAN",{});var hT=l(Yr);k(ls.$$.fragment,hT),hT.forEach(t),pT.forEach(t),gh=h(Cd),Qr=a(Cd,"SPAN",{});var uT=l(Qr);_h=i(uT,"GPT2LMHeadModel"),uT.forEach(t),Cd.forEach(t),Zl=h(o),Me=a(o,"DIV",{class:!0});var et=l(Me);k(ds.$$.fragment,et),Th=h(et),Zr=a(et,"P",{});var mT=l(Zr);bh=i(mT,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(t),xh=h(et),ct=a(et,"DIV",{class:!0});var $n=l(ct);k(us.$$.fragment,$n),Fh=h($n),Vt=a($n,"P",{});var ur=l(Vt);jh=i(ur,"The "),Wa=a(ur,"A",{href:!0});var _T=l(Wa);zh=i(_T,"GPT2LMHeadModel"),_T.forEach(t),Eh=i(ur," forward method, overrides the "),ei=a(ur,"CODE",{});var TT=l(ei);qh=i(TT,"__call__"),TT.forEach(t),Ch=i(ur," special method."),ur.forEach(t),Dh=h($n),k(zo.$$.fragment,$n),Lh=h($n),k(Eo.$$.fragment,$n),$n.forEach(t),Oh=h(et),pt=a(et,"DIV",{class:!0});var Pn=l(pt);k(ms.$$.fragment,Pn),Nh=h(Pn),ti=a(Pn,"P",{});var bT=l(ti);Hh=i(bT,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),bT.forEach(t),Ih=h(Pn),oi=a(Pn,"P",{});var vT=l(oi);Sh=i(vT,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),vT.forEach(t),Ah=h(Pn),k(qo.$$.fragment,Pn),Pn.forEach(t),Wh=h(et),Ft=a(et,"DIV",{class:!0});var mr=l(Ft);k(fs.$$.fragment,mr),Uh=h(mr),ni=a(mr,"P",{});var yT=l(ni);Rh=i(yT,"Moves the model to cpu from a model parallel state."),yT.forEach(t),Bh=h(mr),k(Co.$$.fragment,mr),mr.forEach(t),et.forEach(t),ed=h(o),Kt=a(o,"H2",{class:!0});var Od=l(Kt);Do=a(Od,"A",{id:!0,class:!0,href:!0});var kT=l(Do);si=a(kT,"SPAN",{});var wT=l(si);k(gs.$$.fragment,wT),wT.forEach(t),kT.forEach(t),Vh=h(Od),ai=a(Od,"SPAN",{});var $T=l(ai);Kh=i($T,"GPT2DoubleHeadsModel"),$T.forEach(t),Od.forEach(t),td=h(o),Ke=a(o,"DIV",{class:!0});var jt=l(Ke);k(_s.$$.fragment,jt),Jh=h(jt),ri=a(jt,"P",{});var PT=l(ri);Xh=i(PT,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),PT.forEach(t),Yh=h(jt),Ts=a(jt,"P",{});var Nd=l(Ts);Qh=i(Nd,"This model inherits from "),Ua=a(Nd,"A",{href:!0});var MT=l(Ua);Zh=i(MT,"PreTrainedModel"),MT.forEach(t),eu=i(Nd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(t),tu=h(jt),bs=a(jt,"P",{});var Hd=l(bs);ou=i(Hd,"This model is also a PyTorch "),vs=a(Hd,"A",{href:!0,rel:!0});var GT=l(vs);nu=i(GT,"torch.nn.Module"),GT.forEach(t),su=i(Hd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hd.forEach(t),au=h(jt),ht=a(jt,"DIV",{class:!0});var Mn=l(ht);k(ys.$$.fragment,Mn),ru=h(Mn),Jt=a(Mn,"P",{});var fr=l(Jt);iu=i(fr,"The "),Ra=a(fr,"A",{href:!0});var xT=l(Ra);lu=i(xT,"GPT2DoubleHeadsModel"),xT.forEach(t),du=i(fr," forward method, overrides the "),ii=a(fr,"CODE",{});var FT=l(ii);cu=i(FT,"__call__"),FT.forEach(t),pu=i(fr," special method."),fr.forEach(t),hu=h(Mn),k(Lo.$$.fragment,Mn),uu=h(Mn),k(Oo.$$.fragment,Mn),Mn.forEach(t),jt.forEach(t),od=h(o),Xt=a(o,"H2",{class:!0});var Id=l(Xt);No=a(Id,"A",{id:!0,class:!0,href:!0});var jT=l(No);li=a(jT,"SPAN",{});var zT=l(li);k(ks.$$.fragment,zT),zT.forEach(t),jT.forEach(t),mu=h(Id),di=a(Id,"SPAN",{});var ET=l(di);fu=i(ET,"GPT2ForSequenceClassification"),ET.forEach(t),Id.forEach(t),nd=h(o),Ge=a(o,"DIV",{class:!0});var tt=l(Ge);k(ws.$$.fragment,tt),gu=h(tt),ci=a(tt,"P",{});var qT=l(ci);_u=i(qT,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),qT.forEach(t),Tu=h(tt),Ba=a(tt,"P",{});var M_=l(Ba);Va=a(M_,"A",{href:!0});var CT=l(Va);bu=i(CT,"GPT2ForSequenceClassification"),CT.forEach(t),vu=i(M_,` uses the last token in order to do the classification, as other causal models
...
padding tokens when `),ui=a(zt,"CODE",{});var OT=l(ui);Gu=i(OT,"inputs_embeds"),OT.forEach(t),xu=i(zt," are passed instead of "),mi=a(zt,"CODE",{});var NT=l(mi);Fu=i(NT,"input_ids"),NT.forEach(t),ju=i(zt,`, it does the same (take the last value in
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(t),Hu=h(tt),je=a(tt,"DIV",{class:!0});var ot=l(je);k(Gs.$$.fragment,ot),Iu=h(ot),Yt=a(ot,"P",{});var gr=l(Yt);Su=i(gr,"The "),Ja=a(gr,"A",{href:!0});var ST=l(Ja);Au=i(ST,"GPT2ForSequenceClassification"),ST.forEach(t),Wu=i(gr," forward method, overrides the "),fi=a(gr,"CODE",{});var AT=l(fi);Uu=i(AT,"__call__"),AT.forEach(t),Ru=i(gr," special method."),gr.forEach(t),Bu=h(ot),k(Ho.$$.fragment,ot),Vu=h(ot),k(Io.$$.fragment,ot),Ku=h(ot),k(So.$$.fragment,ot),Ju=h(ot),k(Ao.$$.fragment,ot),Xu=h(ot),k(Wo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),sd=h(o),Qt=a(o,"H2",{class:!0});var Wd=l(Qt);Uo=a(Wd,"A",{id:!0,class:!0,href:!0});var WT=l(Uo);gi=a(WT,"SPAN",{});var UT=l(gi);k(xs.$$.fragment,UT),UT.forEach(t),WT.forEach(t),Yu=h(Wd),_i=a(Wd,"SPAN",{});var RT=l(_i);Qu=i(RT,"GPT2ForTokenClassification"),RT.forEach(t),Wd.forEach(t),ad=h(o),Je=a(o,"DIV",{class:!0});var Et=l(Je);k(Fs.$$.fragment,Et),Zu=h(Et),Ti=a(Et,"P",{});var BT=l(Ti);em=i(BT,`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),BT.forEach(t),tm=h(Et),js=a(Et,"P",{});var Ud=l(js);om=i(Ud,"This model inherits from "),Xa=a(Ud,"A",{href:!0});var VT=l(Xa);nm=i(VT,"PreTrainedModel"),VT.forEach(t),sm=i(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),am=h(Et),zs=a(Et,"P",{});var Rd=l(zs);rm=i(Rd,"This model is also a PyTorch "),Es=a(Rd,"A",{href:!0,rel:!0});var KT=l(Es);im=i(KT,"torch.nn.Module"),KT.forEach(t),lm=i(Rd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rd.forEach(t),dm=h(Et),Xe=a(Et,"DIV",{class:!0});var qt=l(Xe);k(qs.$$.fragment,qt),cm=h(qt),Zt=a(qt,"P",{});var _r=l(Zt);pm=i(_r,"The "),Ya=a(_r,"A",{href:!0});var JT=l(Ya);hm=i(JT,"GPT2ForTokenClassification"),JT.forEach(t),um=i(_r," forward method, overrides the "),bi=a(_r,"CODE",{});var XT=l(bi);mm=i(XT,"__call__"),XT.forEach(t),fm=i(_r," special method."),_r.forEach(t),gm=h(qt),k(Ro.$$.fragment,qt),_m=h(qt),k(Bo.$$.fragment,qt),Tm=h(qt),k(Vo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),rd=h(o),eo=a(o,"H2",{class:!0});var Bd=l(eo);Ko=a(Bd,"A",{id:!0,class:!0,href:!0});var YT=l(Ko);vi=a(YT,"SPAN",{});var QT=l(vi);k(Cs.$$.fragment,QT),QT.forEach(t),YT.forEach(t),bm=h(Bd),yi=a(Bd,"SPAN",{});var ZT=l(yi);vm=i(ZT,"TFGPT2Model"),ZT.forEach(t),Bd.forEach(t),id=h(o),Le=a(o,"DIV",{class:!0});var Tt=l(Le);k(Ds.$$.fragment,Tt),ym=h(Tt),ki=a(Tt,"P",{});var e2=l(ki);km=i(e2,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),e2.forEach(t),wm=h(Tt),Ls=a(Tt,"P",{});var Vd=l(Ls);$m=i(Vd,"This model inherits from "),Qa=a(Vd,"A",{href:!0});var t2=l(Qa);Pm=i(t2,"TFPreTrainedModel"),t2.forEach(t),Mm=i(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vd.forEach(t),Gm=h(Tt),Os=a(Tt,"P",{});var Kd=l(Os);xm=i(Kd,"This model is also a "),Ns=a(Kd,"A",{href:!0,rel:!0});var o2=l(Ns);Fm=i(o2,"tf.keras.Model"),o2.forEach(t),jm=i(Kd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
embeddings).`),l2.forEach(t),Rm=h(bt),As=a(bt,"P",{});var Xd=l(As);Bm=i(Xd,"This model inherits from "),er=a(Xd,"A",{href:!0});var d2=l(er);Vm=i(d2,"TFPreTrainedModel"),d2.forEach(t),Km=i(Xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zm=h(bt),k(Zo.$$.fragment,bt),ef=h(bt),mt=a(bt,"DIV",{class:!0});var xn=l(mt);k(Rs.$$.fragment,xn),tf=h(xn),no=a(xn,"P",{});var br=l(no);of=i(br,"The "),tr=a(br,"A",{href:!0});var p2=l(tr);nf=i(p2,"TFGPT2LMHeadModel"),p2.forEach(t),sf=i(br," forward method, overrides the "),Gi=a(br,"CODE",{});var h2=l(Gi);af=i(h2,"__call__"),h2.forEach(t),rf=i(br," special method."),br.forEach(t),lf=h(xn),k(en.$$.fragment,xn),df=h(xn),k(tn.$$.fragment,xn),xn.forEach(t),bt.forEach(t),cd=h(o),so=a(o,"H2",{class:!0});var Qd=l(so);on=a(Qd,"A",{id:!0,class:!0,href:!0});var u2=l(on);xi=a(u2,"SPAN",{});var m2=l(xi);k(Bs.$$.fragment,m2),m2.forEach(t),u2.forEach(t),cf=h(Qd),Fi=a(Qd,"SPAN",{});var f2=l(Fi);pf=i(f2,"TFGPT2DoubleHeadsModel"),f2.forEach(t),Qd.forEach(t),pd=h(o),Ne=a(o,"DIV",{class:!0});var vt=l(Ne);k(Vs.$$.fragment,vt),hf=h(vt),ji=a(vt,"P",{});var g2=l(ji);uf=i(g2,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
