...
<docstring><name>class transformers.ProcessorMixin</name><anchor>transformers.ProcessorMixin</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/processing_utils.py#L44</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
[DataProcessor](/docs/transformers/pr_15683/en/main_classes/processors#transformers.DataProcessor). The processor returns a list of
[InputExample](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputExample). These
[InputExample](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputExample) can be converted to
[InputFeatures](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputFeatures) in order to be fed to the model.

<div class="docstring">

<docstring><name>class transformers.DataProcessor</name><anchor>transformers.DataProcessor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L81</source><parameters>[]</parameters></docstring>
Base class for data converters for sequence classification data sets.


<div class="docstring">
<docstring><name>get\_dev\_examples</name><anchor>transformers.DataProcessor.get_dev_examples</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L98</source><parameters>[{"name": "data_dir", "val": ""}]</parameters></docstring>
Gets a collection of [InputExample](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputExample) for the dev set.

</div>
<div class="docstring">
<docstring><name>get\_example\_from\_tensor\_dict</name><anchor>transformers.DataProcessor.get_example_from_tensor_dict</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L84</source><parameters>[{"name": "tensor_dict", "val": ""}]</parameters><paramsdesc>tensor_dict -- Keys and values should match the corresponding Glue
...
<div class="docstring">
<docstring><name>get\_labels</name><anchor>transformers.DataProcessor.get_labels</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L106</source><parameters>[]</parameters></docstring>
Gets the list of labels for this data set.

</div>
<div class="docstring">
<docstring><name>get\_test\_examples</name><anchor>transformers.DataProcessor.get_test_examples</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L102</source><parameters>[{"name": "data_dir", "val": ""}]</parameters></docstring>
Gets a collection of [InputExample](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputExample) for the test set.

</div>
<div class="docstring">
<docstring><name>get\_train\_examples</name><anchor>transformers.DataProcessor.get_train_examples</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L94</source><parameters>[{"name": "data_dir", "val": ""}]</parameters></docstring>
Gets a collection of [InputExample](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputExample) for the train set.

</div>
<div class="docstring">
<docstring><name>tfds\_map</name><anchor>transformers.DataProcessor.tfds_map</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L110</source><parameters>[{"name": "example", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.InputExample</name><anchor>transformers.InputExample</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L31</source><parameters>[{"name": "guid", "val": ": str"}, {"name": "text_a", "val": ": str"}, {"name": "text_b", "val": ": typing.Optional[str] = None"}, {"name": "label", "val": ": typing.Optional[str] = None"}]</parameters><paramsdesc>guid -- Unique id for the example.
...
<div class="docstring">
<docstring><name>to\_json\_string</name><anchor>transformers.InputExample.to_json_string</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L50</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>to\_json\_string</name><anchor>transformers.InputFeatures.to_json_string</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/utils.py#L76</source><parameters>[]</parameters></docstring>
Serializes this instance to a JSON string.
...
[InputExample](/docs/transformers/pr_15683/en/main_classes/processors#transformers.InputExample).
...
<docstring><name>class transformers.data.processors.squad.SquadProcessor</name><anchor>transformers.data.processors.squad.SquadProcessor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/squad.py#L543</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>get\_dev\_examples</name><anchor>transformers.data.processors.squad.SquadProcessor.get_dev_examples</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/squad.py#L631</source><parameters>[{"name": "data_dir", "val": ""}, {"name": "filename", "val": " = None"}]</parameters><paramsdesc>data_dir -- Directory containing the data files used for training and evaluating.
...
<div class="docstring">
<docstring><name>get\_examples\_from\_dataset</name><anchor>transformers.data.processors.squad.SquadProcessor.get_examples_from_dataset</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/squad.py#L576</source><parameters>[{"name": "dataset", "val": ""}, {"name": "evaluate", "val": " = False"}]</parameters><paramsdesc>dataset -- The tfds dataset loaded from *tensorflow_datasets.load("squad")*
...
<div class="docstring">
<docstring><name>get\_train\_examples</name><anchor>transformers.data.processors.squad.SquadProcessor.get_train_examples</anchor><source>https://github.com/huggingface/transformers/blob/pr_15683/src/transformers/data/processors/squad.py#L609</source><parameters>[{"name": "data_dir", "val": ""}, {"name": "filename", "val": " = None"}]</parameters><paramsdesc>data_dir -- Directory containing the data files used for training and evaluating.
