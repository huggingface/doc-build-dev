...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18201/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18201/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18201/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18201/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18201/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
alongside usage examples.`),$u.forEach(t),Kk=p(It),lt=s(It,"DIV",{class:!0});var to=a(lt);y(ar.$$.fragment,to),Gk=p(to),Mo=s(to,"P",{});var Od=a(Mo);Yk=i(Od,"The "),Yl=s(Od,"A",{href:!0});var R0=a(Yl);Zk=i(R0,"RobertaForQuestionAnswering"),R0.forEach(t),e1=i(Od," forward method, overrides the "),Wc=s(Od,"CODE",{});var L0=a(Wc);t1=i(L0,"__call__"),L0.forEach(t),o1=i(Od," special method."),Od.forEach(t),n1=p(to),y(qn.$$.fragment,to),s1=p(to),y(Cn.$$.fragment,to),a1=p(to),y(jn.$$.fragment,to),to.forEach(t),It.forEach(t),vm=p(o),Fo=s(o,"H2",{class:!0});var Mu=a(Fo);Xn=s(Mu,"A",{id:!0,class:!0,href:!0});var E0=a(Xn);Bc=s(E0,"SPAN",{});var z0=a(Bc);y(rr.$$.fragment,z0),z0.forEach(t),E0.forEach(t),r1=p(Mu),Uc=s(Mu,"SPAN",{});var q0=a(Uc);i1=i(q0,"TFXLMRobertaModel"),q0.forEach(t),Mu.forEach(t),Tm=p(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(ir.$$.fragment,ut),l1=p(ut),Qc=s(ut,"P",{});var C0=a(Qc);d1=i(C0,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),C0.forEach(t),c1=p(ut),lr=s(ut,"P",{});var Fu=a(lr);p1=i(Fu,"This model inherits from "),Zl=s(Fu,"A",{href:!0});var j0=a(Zl);h1=i(j0,"TFPreTrainedModel"),j0.forEach(t),m1=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fu.forEach(t),u1=p(ut),dr=s(ut,"P",{});var xu=a(dr);f1=i(xu,"This model is also a "),cr=s(xu,"A",{href:!0,rel:!0});var X0=a(cr);g1=i(X0,"tf.keras.Model"),X0.forEach(t),_1=i(xu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xu.forEach(t),b1=p(ut),y(Pn.$$.fragment,ut),k1=p(ut),pr=s(ut,"P",{});var Ru=a(pr);v1=i(Ru,"This class overrides "),ed=s(Ru,"A",{href:!0});var P0=a(ed);T1=i(P0,"TFRobertaModel"),P0.forEach(t),y1=i(Ru,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Ru.forEach(t),w1=p(ut),Ft=s(ut,"DIV",{class:!0});var Es=a(Ft);y(hr.$$.fragment,Es),$1=p(Es),xo=s(Es,"P",{});var Nd=a(xo);M1=i(Nd,"The "),td=s(Nd,"A",{href:!0});var A0=a(td);F1=i(A0,"TFRobertaModel"),A0.forEach(t),x1=i(Nd," forward method, overrides the "),Hc=s(Nd,"CODE",{});var O0=a(Hc);R1=i(O0,"__call__"),O0.forEach(t),L1=i(Nd," special method."),Nd.forEach(t),E1=p(Es),y(An.$$.fragment,Es),z1=p(Es),y(On.$$.fragment,Es),Es.forEach(t),ut.forEach(t),ym=p(o),Ro=s(o,"H2",{class:!0});var Lu=a(Ro);Nn=s(Lu,"A",{id:!0,class:!0,href:!0});var N0=a(Nn);Vc=s(N0,"SPAN",{});var I0=a(Vc);y(mr.$$.fragment,I0),I0.forEach(t),N0.forEach(t),q1=p(Lu),Jc=s(Lu,"SPAN",{});var D0=a(Jc);C1=i(D0,"TFXLMRobertaForMaskedLM"),D0.forEach(t),Lu.forEach(t),wm=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(ur.$$.fragment,ft),j1=p(ft),fr=s(ft,"P",{});var Eu=a(fr);X1=i(Eu,"XLM-RoBERTa Model with a "),Kc=s(Eu,"CODE",{});var S0=a(Kc);P1=i(S0,"language modeling"),S0.forEach(t),A1=i(Eu," head on top."),Eu.forEach(t),O1=p(ft),gr=s(ft,"P",{});var zu=a(gr);N1=i(zu,"This model inherits from "),od=s(zu,"A",{href:!0});var W0=a(od);I1=i(W0,"TFPreTrainedModel"),W0.forEach(t),D1=i(zu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zu.forEach(t),S1=p(ft),_r=s(ft,"P",{});var qu=a(_r);W1=i(qu,"This model is also a "),br=s(qu,"A",{href:!0,rel:!0});var B0=a(br);B1=i(B0,"tf.keras.Model"),B0.forEach(t),U1=i(qu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qu.forEach(t),Q1=p(ft),y(In.$$.fragment,ft),H1=p(ft),kr=s(ft,"P",{});var Cu=a(kr);V1=i(Cu,"This class overrides "),nd=s(Cu,"A",{href:!0});var U0=a(nd);J1=i(U0,"TFRobertaForMaskedLM"),U0.forEach(t),K1=i(Cu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Cu.forEach(t),G1=p(ft),dt=s(ft,"DIV",{class:!0});var oo=a(dt);y(vr.$$.fragment,oo),Y1=p(oo),Lo=s(oo,"P",{});var Id=a(Lo);Z1=i(Id,"The "),sd=s(Id,"A",{href:!0});var Q0=a(sd);ev=i(Q0,"TFRobertaForMaskedLM"),Q0.forEach(t),tv=i(Id," forward method, overrides the "),Gc=s(Id,"CODE",{});var H0=a(Gc);ov=i(H0,"__call__"),H0.forEach(t),nv=i(Id," special method."),Id.forEach(t),sv=p(oo),y(Dn.$$.fragment,oo),av=p(oo),y(Sn.$$.fragment,oo),rv=p(oo),y(Wn.$$.fragment,oo),oo.forEach(t),ft.forEach(t),$m=p(o),Eo=s(o,"H2",{class:!0});var ju=a(Eo);Bn=s(ju,"A",{id:!0,class:!0,href:!0});var V0=a(Bn);Yc=s(V0,"SPAN",{});var J0=a(Yc);y(Tr.$$.fragment,J0),J0.forEach(t),V0.forEach(t),iv=p(ju),Zc=s(ju,"SPAN",{});var K0=a(Zc);lv=i(K0,"TFXLMRobertaForSequenceClassification"),K0.forEach(t),ju.forEach(t),Mm=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(yr.$$.fragment,gt),dv=p(gt),ep=s(gt,"P",{});var G0=a(ep);cv=i(G0,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),G0.forEach(t),pv=p(gt),wr=s(gt,"P",{});var Xu=a(wr);hv=i(Xu,"This model inherits from "),ad=s(Xu,"A",{href:!0});var Y0=a(ad);mv=i(Y0,"TFPreTrainedModel"),Y0.forEach(t),uv=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xu.forEach(t),fv=p(gt),$r=s(gt,"P",{});var Pu=a($r);gv=i(Pu,"This model is also a "),Mr=s(Pu,"A",{href:!0,rel:!0});var Z0=a(Mr);_v=i(Z0,"tf.keras.Model"),Z0.forEach(t),bv=i(Pu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
