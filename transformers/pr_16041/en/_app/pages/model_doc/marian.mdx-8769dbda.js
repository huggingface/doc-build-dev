import{S as nf,i as of,s as sf,e as o,k as d,w as k,t as r,M as af,c as s,d as t,m as l,a,x as v,h as i,b as c,F as e,g as h,y as T,q as M,o as b,B as y}from"../../chunks/vendor-4833417e.js";import{T as pn}from"../../chunks/Tip-fffd6df1.js";import{D as V}from"../../chunks/Docstring-4f315ed9.js";import{C as $e}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as he}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function rf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function df(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function lf(C){let u,z,f,_,w,x,g,$,Le,ue,E,ke,X,Se,Q,ee,Oe,je,G,L,Ee,I,q,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),_=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=o("li"),Le=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ke=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Oe=r("model(inputs)"),je=r("."),G=d(),L=o("p"),Ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),O=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),f=l(m),_=s(m,"UL",{});var be=a(_);w=s(be,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),g=l(be),$=s(be,"LI",{});var ye=a($);Le=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),ue=l(m),E=s(m,"P",{});var D=a(E);ke=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Se=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=s(D,"CODE",{});var at=a(ee);Oe=i(at,"model(inputs)"),at.forEach(t),je=i(D,"."),D.forEach(t),G=l(m),L=s(m,"P",{});var We=a(L);Ee=i(We,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),We.forEach(t),I=l(m),q=s(m,"UL",{});var A=a(q);F=s(A,"LI",{});var ie=a(F);te=i(ie,"a single Tensor with "),ne=s(ie,"CODE",{});var rt=a(ne);ve=i(rt,"input_ids"),rt.forEach(t),He=i(ie," only and nothing else: "),J=s(ie,"CODE",{});var Be=a(J);P=i(Be,"model(input_ids)"),Be.forEach(t),ie.forEach(t),Te=l(A),N=s(A,"LI",{});var U=a(N);De=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(A),S=s(A,"LI",{});var de=a(S);Re=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),A.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,_,j),e(_,w),e(w,x),e(_,g),e(_,$),e($,Le),h(m,ue,j),h(m,E,j),e(E,ke),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,je),h(m,G,j),h(m,L,j),e(L,Ee),h(m,I,j),h(m,q,j),e(q,F),e(F,te),e(F,ne),e(ne,ve),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(E),m&&t(G),m&&t(L),m&&t(I),m&&t(q)}}}function cf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function pf(C){let u,z,f,_,w,x,g,$,Le,ue,E,ke,X,Se,Q,ee,Oe,je,G,L,Ee,I,q,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),_=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=o("li"),Le=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ke=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Oe=r("model(inputs)"),je=r("."),G=d(),L=o("p"),Ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),I=d(),q=o("ul"),F=o("li"),te=r("a single Tensor with "),ne=o("code"),ve=r("input_ids"),He=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),Te=d(),N=o("li"),De=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=o("code"),Me=r("model([input_ids, attention_mask])"),se=r(" or "),ae=o("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),Ue=d(),S=o("li"),Re=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),f=l(m),_=s(m,"UL",{});var be=a(_);w=s(be,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),g=l(be),$=s(be,"LI",{});var ye=a($);Le=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),ue=l(m),E=s(m,"P",{});var D=a(E);ke=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Se=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
...
first positional argument :`),We.forEach(t),I=l(m),q=s(m,"UL",{});var A=a(q);F=s(A,"LI",{});var ie=a(F);te=i(ie,"a single Tensor with "),ne=s(ie,"CODE",{});var rt=a(ne);ve=i(rt,"input_ids"),rt.forEach(t),He=i(ie," only and nothing else: "),J=s(ie,"CODE",{});var Be=a(J);P=i(Be,"model(input_ids)"),Be.forEach(t),ie.forEach(t),Te=l(A),N=s(A,"LI",{});var U=a(N);De=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(A),S=s(A,"LI",{});var de=a(S);Re=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),A.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,_,j),e(_,w),e(w,x),e(_,g),e(_,$),e($,Le),h(m,ue,j),h(m,E,j),e(E,ke),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,je),h(m,G,j),h(m,L,j),e(L,Ee),h(m,I,j),h(m,q,j),e(q,F),e(F,te),e(F,ne),e(ne,ve),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(E),m&&t(G),m&&t(L),m&&t(I),m&&t(q)}}}function hf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function uf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function mf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function ff(C){let u,z,f,_,w,x,g,$,Le,ue,E,ke,X,Se,Q,ee,Oe,je,G,L,Ee,I,q,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H,m,j,be,ot,ye,D,st,at,We,A,ie,rt,Be,U,it,dt,de,xe,wi,Xo,zi,$i,ji,lt,hn,Ei,Ps,qi,Pi,Fi,un,Ni,Fs,Ci,Ii,Ai,ct,Li,Ns,Si,Oi,Cs,Hi,Di,Ui,Is,mn,Ri,As,Wi,Bi,Vi,Ls,fn,Gi,_n,Ji,Yi,er,pt,Ct,Ss,gn,Ki,Os,Zi,tr,qe,Qo,Xi,Hs,Qi,ed,kn,td,vn,nd,od,sd,ht,ad,Ds,rd,id,Us,dd,ld,cd,Rs,pd,nr,ut,It,Ws,Tn,hd,Bs,ud,or,Je,Vs,md,fd,Gs,Mn,_d,gd,Js,bn,kd,sr,mt,At,Ys,yn,vd,Ks,Td,ar,Pe,xn,Md,Zs,bd,yd,xd,wn,wd,Xs,zd,$d,jd,zn,Ed,$n,qd,Pd,Fd,jn,Nd,Qs,Cd,Id,rr,Lt,Ad,En,Ld,Sd,ir,qn,dr,es,Od,lr,Pn,cr,ft,St,ea,Fn,Hd,ta,Dd,pr,ts,Ud,hr,Nn,ur,ns,Rd,mr,Cn,fr,_t,Ot,na,In,Wd,oa,Bd,_r,le,An,Vd,gt,Gd,os,Jd,Yd,Ln,Kd,Zd,Xd,kt,Qd,ss,el,tl,as,nl,ol,sl,sa,al,rl,Sn,gr,vt,Ht,aa,On,il,ra,dl,kr,R,Hn,ll,Dn,cl,Un,pl,hl,ul,Rn,ml,rs,fl,_l,gl,ia,kl,vl,Wn,Tl,Dt,Bn,Ml,da,bl,vr,Tt,Ut,la,Vn,yl,ca,xl,Tr,we,Gn,wl,Jn,zl,is,$l,jl,El,Yn,ql,Kn,Pl,Fl,Nl,me,Zn,Cl,Mt,Il,ds,Al,Ll,pa,Sl,Ol,Hl,Rt,Dl,ha,Ul,Rl,Xn,Mr,bt,Wt,ua,Qn,Wl,ma,Bl,br,ze,eo,Vl,to,Gl,ls,Jl,Yl,Kl,no,Zl,oo,Xl,Ql,ec,Y,so,tc,yt,nc,cs,oc,sc,fa,ac,rc,ic,Bt,dc,ao,lc,ro,cc,pc,hc,_a,uc,mc,io,yr,xt,Vt,ga,lo,fc,ka,_c,xr,wt,co,gc,Ye,po,kc,va,vc,Tc,ho,wr,zt,Gt,Ta,uo,Mc,Ma,bc,zr,ce,mo,yc,fo,xc,ps,wc,zc,$c,_o,jc,go,Ec,qc,Pc,Jt,Fc,fe,ko,Nc,$t,Cc,hs,Ic,Ac,ba,Lc,Sc,Oc,Yt,Hc,ya,Dc,Uc,vo,$r,jt,Kt,xa,To,Rc,wa,Wc,jr,pe,Mo,Bc,bo,Vc,us,Gc,Jc,Yc,yo,Kc,xo,Zc,Xc,Qc,Zt,ep,K,wo,tp,Et,np,ms,op,sp,za,ap,rp,ip,Xt,dp,zo,lp,$o,cp,pp,hp,$a,up,mp,jo,Er,qt,Qt,ja,Eo,fp,Ea,_p,qr,W,qo,gp,Po,kp,fs,vp,Tp,Mp,Fo,bp,No,yp,xp,wp,qa,zp,$p,Ve,Pa,Co,jp,Ep,Fa,Io,qp,Pp,Na,Ao,Fp,Np,Ca,Lo,Cp,Ip,_e,So,Ap,Pt,Lp,Ia,Sp,Op,Aa,Hp,Dp,Up,en,Rp,La,Wp,Bp,Oo,Pr,Ft,tn,Sa,Ho,Vp,Oa,Gp,Fr,B,Do,Jp,Uo,Yp,_s,Kp,Zp,Xp,Ro,Qp,Wo,eh,th,nh,Ha,oh,sh,Ge,Da,Bo,ah,rh,Ua,Vo,ih,dh,Ra,Go,lh,ch,Wa,Jo,ph,hh,ge,Yo,uh,Nt,mh,Ba,fh,_h,Va,gh,kh,vh,nn,Th,Ga,Mh,bh,Ko,Nr;return x=new he({}),te=new he({}),gn=new he({}),Tn=new he({}),yn=new he({}),qn=new $e({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
[<span class="hljs-string">&quot;c&#x27;est une phrase en anglais que nous voulons traduire en fran\xE7ais&quot;</span>, 
 <span class="hljs-string">&#x27;Isto deve ir para o portugu\xEAs.&#x27;</span>,
 <span class="hljs-string">&#x27;Y esto al espa\xF1ol&#x27;</span>]`}}),In=new he({}),An=new V({props:{name:"class transformers.MarianConfig",anchor:"transformers.MarianConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 58100"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 58100"},{name:"eos_token_id",val:" = 0"},{name:"forced_eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/configuration_marian.py#L35",parametersDescription:[{anchor:"transformers.MarianConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)  <span class="hljs-comment"># should work</span>`}}),Bn=new V({props:{name:"as_target_tokenizer",anchor:"transformers.MarianTokenizer.as_target_tokenizer",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/tokenization_marian.py#L268"}}),Vn=new he({}),Gn=new V({props:{name:"class transformers.MarianModel",anchor:"transformers.MarianModel",parameters:[{name:"config",val:": MarianConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_marian.py#L1082",parametersDescription:[{anchor:"transformers.MarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16041/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zn=new V({props:{name:"forward",anchor:"transformers.MarianModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_marian.py#L1109",parametersDescription:[{anchor:"transformers.MarianModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),Qn=new he({}),eo=new V({props:{name:"class transformers.MarianMTModel",anchor:"transformers.MarianMTModel",parameters:[{name:"config",val:": MarianConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_marian.py#L1211",parametersDescription:[{anchor:"transformers.MarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16041/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),so=new V({props:{name:"forward",anchor:"transformers.MarianMTModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_marian.py#L1261",parametersDescription:[{anchor:"transformers.MarianMTModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<span class="hljs-string">&quot;Where&#x27;s the bus stop?&quot;</span>`}}),lo=new he({}),co=new V({props:{name:"class transformers.MarianForCausalLM",anchor:"transformers.MarianForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_marian.py#L1405"}}),po=new V({props:{name:"forward",anchor:"transformers.MarianForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_marian.py#L1436",parametersDescription:[{anchor:"transformers.MarianForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16041/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16041/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),To=new he({}),Mo=new V({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_tf_marian.py#L1315",parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16041/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new pn({props:{$$slots:{default:[pf]},$$scope:{ctx:C}}}),wo=new V({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/marian/modeling_tf_marian.py#L1348",parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16041/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16041/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16041/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){u=o("meta"),z=d(),f=o("h1"),_=o("a"),w=o("span"),k(x.$$.fragment),g=d(),$=o("span"),Le=r("MarianMT"),ue=d(),E=o("p"),ke=o("strong"),X=r("Bugs:"),Se=r(" If you see something strange, file a "),Q=o("a"),ee=r("Github Issue"),Oe=r(`
and assign @patrickvonplaten.`),je=d(),G=o("p"),L=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),Ee=d(),I=o("h2"),q=o("a"),F=o("span"),k(te.$$.fragment),ne=d(),ve=o("span"),He=r("Implementation Notes"),J=d(),P=o("ul"),Te=o("li"),N=o("p"),De=r("Each model is about 298 MB on disk, there are more than 1,000 models."),oe=d(),Me=o("li"),se=o("p"),ae=r("The list of supported language pairs can be found "),re=o("a"),Ue=r("here"),S=r("."),Re=d(),O=o("li"),H=o("p"),m=r("Models were originally trained by "),j=o("a"),be=r("J\xF6rg Tiedemann"),ot=r(" using the "),ye=o("a"),D=r("Marian"),st=r(" C++ library, which supports fast training and translation."),at=d(),We=o("li"),A=o("p"),ie=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),rt=d(),Be=o("li"),U=o("p"),it=r("The 80 opus models that require BPE preprocessing are not supported."),dt=d(),de=o("li"),xe=o("p"),wi=r("The modeling code is the same as "),Xo=o("a"),zi=r("BartForConditionalGeneration"),$i=r(" with a few minor modifications:"),ji=d(),lt=o("ul"),hn=o("li"),Ei=r("static (sinusoid) positional embeddings ("),Ps=o("code"),qi=r("MarianConfig.static_position_embeddings=True"),Pi=r(")"),Fi=d(),un=o("li"),Ni=r("no layernorm_embedding ("),Fs=o("code"),Ci=r("MarianConfig.normalize_embedding=False"),Ii=r(")"),Ai=d(),ct=o("li"),Li=r("the model starts generating with "),Ns=o("code"),Si=r("pad_token_id"),Oi=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Cs=o("code"),Hi=r("<s/>"),Di=r("),"),Ui=d(),Is=o("li"),mn=o("p"),Ri=r("Code to bulk convert models can be found in "),As=o("code"),Wi=r("convert_marian_to_pytorch.py"),Bi=r("."),Vi=d(),Ls=o("li"),fn=o("p"),Gi=r("This model was contributed by "),_n=o("a"),Ji=r("sshleifer"),Yi=r("."),er=d(),pt=o("h2"),Ct=o("a"),Ss=o("span"),k(gn.$$.fragment),Ki=d(),Os=o("span"),Zi=r("Naming"),tr=d(),qe=o("ul"),Qo=o("li"),Xi=r("All model names use the following format: "),Hs=o("code"),Qi=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),ed=d(),kn=o("li"),td=r("The language codes used to name models are inconsistent. Two digit codes can usually be found "),vn=o("a"),nd=r("here"),od=r(`, three digit codes require googling \u201Clanguage
...
codes are required.`),rr=d(),Lt=o("p"),Ad=r("New multi-lingual models from the "),En=o("a"),Ld=r("Tatoeba-Challenge repo"),Sd=r(`
...
group:`),hr=d(),k(Nn.$$.fragment),ur=d(),ns=o("p"),Rd=r("Example of translating english to many romance languages, using old-style 2 character language codes"),mr=d(),k(Cn.$$.fragment),fr=d(),_t=o("h2"),Ot=o("a"),na=o("span"),k(In.$$.fragment),Wd=d(),oa=o("span"),Bd=r("MarianConfig"),_r=d(),le=o("div"),k(An.$$.fragment),Vd=d(),gt=o("p"),Gd=r("This is the configuration class to store the configuration of a "),os=o("a"),Jd=r("MarianModel"),Yd=r(`. It is used to instantiate an
...
`),Ln=o("a"),Kd=r("Helsinki-NLP/opus-mt-en-de"),Zd=r(" architecture."),Xd=d(),kt=o("p"),Qd=r("Configuration objects inherit from "),ss=o("a"),el=r("PretrainedConfig"),tl=r(` and can be used to control the model outputs. Read the
documentation from `),as=o("a"),nl=r("PretrainedConfig"),ol=r(" for more information."),sl=d(),sa=o("p"),al=r("Examples:"),rl=d(),k(Sn.$$.fragment),gr=d(),vt=o("h2"),Ht=o("a"),aa=o("span"),k(On.$$.fragment),il=d(),ra=o("span"),dl=r("MarianTokenizer"),kr=d(),R=o("div"),k(Hn.$$.fragment),ll=d(),Dn=o("p"),cl=r("Construct a Marian tokenizer. Based on "),Un=o("a"),pl=r("SentencePiece"),hl=r("."),ul=d(),Rn=o("p"),ml=r("This tokenizer inherits from "),rs=o("a"),fl=r("PreTrainedTokenizer"),_l=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),gl=d(),ia=o("p"),kl=r("Examples:"),vl=d(),k(Wn.$$.fragment),Tl=d(),Dt=o("div"),k(Bn.$$.fragment),Ml=d(),da=o("p"),bl=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),vr=d(),Tt=o("h2"),Ut=o("a"),la=o("span"),k(Vn.$$.fragment),yl=d(),ca=o("span"),xl=r("MarianModel"),Tr=d(),we=o("div"),k(Gn.$$.fragment),wl=d(),Jn=o("p"),zl=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Nl=d(),me=o("div"),k(Zn.$$.fragment),Cl=d(),Mt=o("p"),Il=r("The "),ds=o("a"),Al=r("MarianModel"),Ll=r(" forward method, overrides the "),pa=o("code"),Sl=r("__call__"),Ol=r(" special method."),Hl=d(),k(Rt.$$.fragment),Dl=d(),ha=o("p"),Ul=r("Example:"),Rl=d(),k(Xn.$$.fragment),Mr=d(),bt=o("h2"),Wt=o("a"),ua=o("span"),k(Qn.$$.fragment),Wl=d(),ma=o("span"),Bl=r("MarianMTModel"),br=d(),ze=o("div"),k(eo.$$.fragment),Vl=d(),to=o("p"),Gl=r(`The Marian Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=d(),Y=o("div"),k(so.$$.fragment),tc=d(),yt=o("p"),nc=r("The "),cs=o("a"),oc=r("MarianMTModel"),sc=r(" forward method, overrides the "),fa=o("code"),ac=r("__call__"),rc=r(" special method."),ic=d(),k(Bt.$$.fragment),dc=d(),ao=o("p"),lc=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),ro=o("a"),cc=r("here"),pc=r("."),hc=d(),_a=o("p"),uc=r("Examples:"),mc=d(),k(io.$$.fragment),yr=d(),xt=o("h2"),Vt=o("a"),ga=o("span"),k(lo.$$.fragment),fc=d(),ka=o("span"),_c=r("MarianForCausalLM"),xr=d(),wt=o("div"),k(co.$$.fragment),gc=d(),Ye=o("div"),k(po.$$.fragment),kc=d(),va=o("p"),vc=r("Example:"),Tc=d(),k(ho.$$.fragment),wr=d(),zt=o("h2"),Gt=o("a"),Ta=o("span"),k(uo.$$.fragment),Mc=d(),Ma=o("span"),bc=r("TFMarianModel"),zr=d(),ce=o("div"),k(mo.$$.fragment),yc=d(),fo=o("p"),xc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$c=d(),_o=o("p"),jc=r("This model is also a "),go=o("a"),Ec=r("tf.keras.Model"),qc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pc=d(),k(Jt.$$.fragment),Fc=d(),fe=o("div"),k(ko.$$.fragment),Nc=d(),$t=o("p"),Cc=r("The "),hs=o("a"),Ic=r("TFMarianModel"),Ac=r(" forward method, overrides the "),ba=o("code"),Lc=r("__call__"),Sc=r(" special method."),Oc=d(),k(Yt.$$.fragment),Hc=d(),ya=o("p"),Dc=r("Example:"),Uc=d(),k(vo.$$.fragment),$r=d(),jt=o("h2"),Kt=o("a"),xa=o("span"),k(To.$$.fragment),Rc=d(),wa=o("span"),Wc=r("TFMarianMTModel"),jr=d(),pe=o("div"),k(Mo.$$.fragment),Bc=d(),bo=o("p"),Vc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
models are listed `),$o=o("a"),cp=r("here"),pp=r("."),hp=d(),$a=o("p"),up=r("Examples:"),mp=d(),k(jo.$$.fragment),Er=d(),qt=o("h2"),Qt=o("a"),ja=o("span"),k(Eo.$$.fragment),fp=d(),Ea=o("span"),_p=r("FlaxMarianModel"),qr=d(),W=o("div"),k(qo.$$.fragment),gp=d(),Po=o("p"),kp=r(`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wp=d(),qa=o("p"),zp=r("Finally, this model supports inherent JAX features such as:"),$p=d(),Ve=o("ul"),Pa=o("li"),Co=o("a"),jp=r("Just-In-Time (JIT) compilation"),Ep=d(),Fa=o("li"),Io=o("a"),qp=r("Automatic Differentiation"),Pp=d(),Na=o("li"),Ao=o("a"),Fp=r("Vectorization"),Np=d(),Ca=o("li"),Lo=o("a"),Cp=r("Parallelization"),Ip=d(),_e=o("div"),k(So.$$.fragment),Ap=d(),Pt=o("p"),Lp=r("The "),Ia=o("code"),Sp=r("FlaxMarianPreTrainedModel"),Op=r("forward method, overrides the "),Aa=o("code"),Hp=r("__call__"),Dp=r(" special method."),Up=d(),k(en.$$.fragment),Rp=d(),La=o("p"),Wp=r("Example:"),Bp=d(),k(Oo.$$.fragment),Pr=d(),Ft=o("h2"),tn=o("a"),Sa=o("span"),k(Ho.$$.fragment),Vp=d(),Oa=o("span"),Gp=r("FlaxMarianMTModel"),Fr=d(),B=o("div"),k(Do.$$.fragment),Jp=d(),Uo=o("p"),Yp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),nh=d(),Ha=o("p"),oh=r("Finally, this model supports inherent JAX features such as:"),sh=d(),Ge=o("ul"),Da=o("li"),Bo=o("a"),ah=r("Just-In-Time (JIT) compilation"),rh=d(),Ua=o("li"),Vo=o("a"),ih=r("Automatic Differentiation"),dh=d(),Ra=o("li"),Go=o("a"),lh=r("Vectorization"),ch=d(),Wa=o("li"),Jo=o("a"),ph=r("Parallelization"),hh=d(),ge=o("div"),k(Yo.$$.fragment),uh=d(),Nt=o("p"),mh=r("The "),Ba=o("code"),fh=r("FlaxMarianPreTrainedModel"),_h=r("forward method, overrides the "),Va=o("code"),gh=r("__call__"),kh=r(" special method."),vh=d(),k(nn.$$.fragment),Th=d(),Ga=o("p"),Mh=r("Example:"),bh=d(),k(Ko.$$.fragment),this.h()},l(n){const p=af('[data-svelte="svelte-1phssyn"]',document.head);u=s(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(n),f=s(n,"H1",{class:!0});var Zo=a(f);_=s(Zo,"A",{id:!0,class:!0,href:!0});var Ja=a(_);w=s(Ja,"SPAN",{});var Ya=a(w);v(x.$$.fragment,Ya),Ya.forEach(t),Ja.forEach(t),g=l(Zo),$=s(Zo,"SPAN",{});var Ka=a($);Le=i(Ka,"MarianMT"),Ka.forEach(t),Zo.forEach(t),ue=l(n),E=s(n,"P",{});var on=a(E);ke=s(on,"STRONG",{});var Za=a(ke);X=i(Za,"Bugs:"),Za.forEach(t),Se=i(on," If you see something strange, file a "),Q=s(on,"A",{href:!0,rel:!0});var Xa=a(Q);ee=i(Xa,"Github Issue"),Xa.forEach(t),Oe=i(on,`
and assign @patrickvonplaten.`),on.forEach(t),je=l(n),G=s(n,"P",{});var Qa=a(G);L=i(Qa,"Translations should be similar, but not identical to output in the test set linked to in each model card."),Qa.forEach(t),Ee=l(n),I=s(n,"H2",{class:!0});var Cr=a(I);q=s(Cr,"A",{id:!0,class:!0,href:!0});var xh=a(q);F=s(xh,"SPAN",{});var wh=a(F);v(te.$$.fragment,wh),wh.forEach(t),xh.forEach(t),ne=l(Cr),ve=s(Cr,"SPAN",{});var zh=a(ve);He=i(zh,"Implementation Notes"),zh.forEach(t),Cr.forEach(t),J=l(n),P=s(n,"UL",{});var Z=a(P);Te=s(Z,"LI",{});var $h=a(Te);N=s($h,"P",{});var jh=a(N);De=i(jh,"Each model is about 298 MB on disk, there are more than 1,000 models."),jh.forEach(t),$h.forEach(t),oe=l(Z),Me=s(Z,"LI",{});var Eh=a(Me);se=s(Eh,"P",{});var Ir=a(se);ae=i(Ir,"The list of supported language pairs can be found "),re=s(Ir,"A",{href:!0,rel:!0});var qh=a(re);Ue=i(qh,"here"),qh.forEach(t),S=i(Ir,"."),Ir.forEach(t),Eh.forEach(t),Re=l(Z),O=s(Z,"LI",{});var Ph=a(O);H=s(Ph,"P",{});var gs=a(H);m=i(gs,"Models were originally trained by "),j=s(gs,"A",{href:!0,rel:!0});var Fh=a(j);be=i(Fh,"J\xF6rg Tiedemann"),Fh.forEach(t),ot=i(gs," using the "),ye=s(gs,"A",{href:!0,rel:!0});var Nh=a(ye);D=i(Nh,"Marian"),Nh.forEach(t),st=i(gs," C++ library, which supports fast training and translation."),gs.forEach(t),Ph.forEach(t),at=l(Z),We=s(Z,"LI",{});var Ch=a(We);A=s(Ch,"P",{});var Ih=a(A);ie=i(Ih,`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),Ih.forEach(t),Ch.forEach(t),rt=l(Z),Be=s(Z,"LI",{});var Ah=a(Be);U=s(Ah,"P",{});var Lh=a(U);it=i(Lh,"The 80 opus models that require BPE preprocessing are not supported."),Lh.forEach(t),Ah.forEach(t),dt=l(Z),de=s(Z,"LI",{});var Ar=a(de);xe=s(Ar,"P",{});var Lr=a(xe);wi=i(Lr,"The modeling code is the same as "),Xo=s(Lr,"A",{href:!0});var Sh=a(Xo);zi=i(Sh,"BartForConditionalGeneration"),Sh.forEach(t),$i=i(Lr," with a few minor modifications:"),Lr.forEach(t),ji=l(Ar),lt=s(Ar,"UL",{});var ks=a(lt);hn=s(ks,"LI",{});var Sr=a(hn);Ei=i(Sr,"static (sinusoid) positional embeddings ("),Ps=s(Sr,"CODE",{});var Oh=a(Ps);qi=i(Oh,"MarianConfig.static_position_embeddings=True"),Oh.forEach(t),Pi=i(Sr,")"),Sr.forEach(t),Fi=l(ks),un=s(ks,"LI",{});var Or=a(un);Ni=i(Or,"no layernorm_embedding ("),Fs=s(Or,"CODE",{});var Hh=a(Fs);Ci=i(Hh,"MarianConfig.normalize_embedding=False"),Hh.forEach(t),Ii=i(Or,")"),Or.forEach(t),Ai=l(ks),ct=s(ks,"LI",{});var vs=a(ct);Li=i(vs,"the model starts generating with "),Ns=s(vs,"CODE",{});var Dh=a(Ns);Si=i(Dh,"pad_token_id"),Dh.forEach(t),Oi=i(vs,` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Cs=s(vs,"CODE",{});var Uh=a(Cs);Hi=i(Uh,"<s/>"),Uh.forEach(t),Di=i(vs,"),"),vs.forEach(t),ks.forEach(t),Ar.forEach(t),Ui=l(Z),Is=s(Z,"LI",{});var Rh=a(Is);mn=s(Rh,"P",{});var Hr=a(mn);Ri=i(Hr,"Code to bulk convert models can be found in "),As=s(Hr,"CODE",{});var Wh=a(As);Wi=i(Wh,"convert_marian_to_pytorch.py"),Wh.forEach(t),Bi=i(Hr,"."),Hr.forEach(t),Rh.forEach(t),Vi=l(Z),Ls=s(Z,"LI",{});var Bh=a(Ls);fn=s(Bh,"P",{});var Dr=a(fn);Gi=i(Dr,"This model was contributed by "),_n=s(Dr,"A",{href:!0,rel:!0});var Vh=a(_n);Ji=i(Vh,"sshleifer"),Vh.forEach(t),Yi=i(Dr,"."),Dr.forEach(t),Bh.forEach(t),Z.forEach(t),er=l(n),pt=s(n,"H2",{class:!0});var Ur=a(pt);Ct=s(Ur,"A",{id:!0,class:!0,href:!0});var Gh=a(Ct);Ss=s(Gh,"SPAN",{});var Jh=a(Ss);v(gn.$$.fragment,Jh),Jh.forEach(t),Gh.forEach(t),Ki=l(Ur),Os=s(Ur,"SPAN",{});var Yh=a(Os);Zi=i(Yh,"Naming"),Yh.forEach(t),Ur.forEach(t),tr=l(n),qe=s(n,"UL",{});var sn=a(qe);Qo=s(sn,"LI",{});var yh=a(Qo);Xi=i(yh,"All model names use the following format: "),Hs=s(yh,"CODE",{});var Kh=a(Hs);Qi=i(Kh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Kh.forEach(t),yh.forEach(t),ed=l(sn),kn=s(sn,"LI",{});var Rr=a(kn);td=i(Rr,"The language codes used to name models are inconsistent. Two digit codes can usually be found "),vn=s(Rr,"A",{href:!0,rel:!0});var Zh=a(vn);nd=i(Zh,"here"),Zh.forEach(t),od=i(Rr,`, three digit codes require googling \u201Clanguage
...
fine-tuning experiments and integration tests.`),su.forEach(t),fd=l(Ms),Gs=s(Ms,"LI",{});var au=a(Gs);Mn=s(au,"A",{href:!0,rel:!0});var ru=a(Mn);_d=i(ru,"Fine-tune on GPU"),ru.forEach(t),au.forEach(t),gd=l(Ms),Js=s(Ms,"LI",{});var iu=a(Js);bn=s(iu,"A",{href:!0,rel:!0});var du=a(bn);kd=i(du,"Fine-tune on GPU with pytorch-lightning"),du.forEach(t),iu.forEach(t),Ms.forEach(t),sr=l(n),mt=s(n,"H2",{class:!0});var Br=a(mt);At=s(Br,"A",{id:!0,class:!0,href:!0});var lu=a(At);Ys=s(lu,"SPAN",{});var cu=a(Ys);v(yn.$$.fragment,cu),cu.forEach(t),lu.forEach(t),vd=l(Br),Ks=s(Br,"SPAN",{});var pu=a(Ks);Td=i(pu,"Multilingual Models"),pu.forEach(t),Br.forEach(t),ar=l(n),Pe=s(n,"UL",{});var an=a(Pe);xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,"All model names use the following format: "),Zs=s(Vr,"CODE",{});var hu=a(Zs);bd=i(hu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),hu.forEach(t),yd=i(Vr,":"),Vr.forEach(t),xd=l(an),wn=s(an,"LI",{});var Gr=a(wn);wd=i(Gr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
codes are required.`),Yr.forEach(t),an.forEach(t),rr=l(n),Lt=s(n,"P",{});var Kr=a(Lt);Ad=i(Kr,"New multi-lingual models from the "),En=s(Kr,"A",{href:!0,rel:!0});var _u=a(En);Ld=i(_u,"Tatoeba-Challenge repo"),_u.forEach(t),Sd=i(Kr,`
require 3 character language codes:`),Kr.forEach(t),ir=l(n),v(qn.$$.fragment,n),dr=l(n),es=s(n,"P",{});var gu=a(es);Od=i(gu,"Here is the code to see all available pretrained models on the hub:"),gu.forEach(t),lr=l(n),v(Pn.$$.fragment,n),cr=l(n),ft=s(n,"H2",{class:!0});var Zr=a(ft);St=s(Zr,"A",{id:!0,class:!0,href:!0});var ku=a(St);ea=s(ku,"SPAN",{});var vu=a(ea);v(Fn.$$.fragment,vu),vu.forEach(t),ku.forEach(t),Hd=l(Zr),ta=s(Zr,"SPAN",{});var Tu=a(ta);Dd=i(Tu,"Old Style Multi-Lingual Models"),Tu.forEach(t),Zr.forEach(t),pr=l(n),ts=s(n,"P",{});var Mu=a(ts);Ud=i(Mu,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Mu.forEach(t),hr=l(n),v(Nn.$$.fragment,n),ur=l(n),ns=s(n,"P",{});var bu=a(ns);Rd=i(bu,"Example of translating english to many romance languages, using old-style 2 character language codes"),bu.forEach(t),mr=l(n),v(Cn.$$.fragment,n),fr=l(n),_t=s(n,"H2",{class:!0});var Xr=a(_t);Ot=s(Xr,"A",{id:!0,class:!0,href:!0});var yu=a(Ot);na=s(yu,"SPAN",{});var xu=a(na);v(In.$$.fragment,xu),xu.forEach(t),yu.forEach(t),Wd=l(Xr),oa=s(Xr,"SPAN",{});var wu=a(oa);Bd=i(wu,"MarianConfig"),wu.forEach(t),Xr.forEach(t),_r=l(n),le=s(n,"DIV",{class:!0});var Ke=a(le);v(An.$$.fragment,Ke),Vd=l(Ke),gt=s(Ke,"P",{});var bs=a(gt);Gd=i(bs,"This is the configuration class to store the configuration of a "),os=s(bs,"A",{href:!0});var zu=a(os);Jd=i(zu,"MarianModel"),zu.forEach(t),Yd=i(bs,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),Ln=s(bs,"A",{href:!0,rel:!0});var $u=a(Ln);Kd=i($u,"Helsinki-NLP/opus-mt-en-de"),$u.forEach(t),Zd=i(bs," architecture."),bs.forEach(t),Xd=l(Ke),kt=s(Ke,"P",{});var ys=a(kt);Qd=i(ys,"Configuration objects inherit from "),ss=s(ys,"A",{href:!0});var ju=a(ss);el=i(ju,"PretrainedConfig"),ju.forEach(t),tl=i(ys,` and can be used to control the model outputs. Read the
documentation from `),as=s(ys,"A",{href:!0});var Eu=a(as);nl=i(Eu,"PretrainedConfig"),Eu.forEach(t),ol=i(ys," for more information."),ys.forEach(t),sl=l(Ke),sa=s(Ke,"P",{});var qu=a(sa);al=i(qu,"Examples:"),qu.forEach(t),rl=l(Ke),v(Sn.$$.fragment,Ke),Ke.forEach(t),gr=l(n),vt=s(n,"H2",{class:!0});var Qr=a(vt);Ht=s(Qr,"A",{id:!0,class:!0,href:!0});var Pu=a(Ht);aa=s(Pu,"SPAN",{});var Fu=a(aa);v(On.$$.fragment,Fu),Fu.forEach(t),Pu.forEach(t),il=l(Qr),ra=s(Qr,"SPAN",{});var Nu=a(ra);dl=i(Nu,"MarianTokenizer"),Nu.forEach(t),Qr.forEach(t),kr=l(n),R=s(n,"DIV",{class:!0});var Fe=a(R);v(Hn.$$.fragment,Fe),ll=l(Fe),Dn=s(Fe,"P",{});var ei=a(Dn);cl=i(ei,"Construct a Marian tokenizer. Based on "),Un=s(ei,"A",{href:!0,rel:!0});var Cu=a(Un);pl=i(Cu,"SentencePiece"),Cu.forEach(t),hl=i(ei,"."),ei.forEach(t),ul=l(Fe),Rn=s(Fe,"P",{});var ti=a(Rn);ml=i(ti,"This tokenizer inherits from "),rs=s(ti,"A",{href:!0});var Iu=a(rs);fl=i(Iu,"PreTrainedTokenizer"),Iu.forEach(t),_l=i(ti,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ti.forEach(t),gl=l(Fe),ia=s(Fe,"P",{});var Au=a(ia);kl=i(Au,"Examples:"),Au.forEach(t),vl=l(Fe),v(Wn.$$.fragment,Fe),Tl=l(Fe),Dt=s(Fe,"DIV",{class:!0});var ni=a(Dt);v(Bn.$$.fragment,ni),Ml=l(ni),da=s(ni,"P",{});var Lu=a(da);bl=i(Lu,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Lu.forEach(t),ni.forEach(t),Fe.forEach(t),vr=l(n),Tt=s(n,"H2",{class:!0});var oi=a(Tt);Ut=s(oi,"A",{id:!0,class:!0,href:!0});var Su=a(Ut);la=s(Su,"SPAN",{});var Ou=a(la);v(Vn.$$.fragment,Ou),Ou.forEach(t),Su.forEach(t),yl=l(oi),ca=s(oi,"SPAN",{});var Hu=a(ca);xl=i(Hu,"MarianModel"),Hu.forEach(t),oi.forEach(t),Tr=l(n),we=s(n,"DIV",{class:!0});var rn=a(we);v(Gn.$$.fragment,rn),wl=l(rn),Jn=s(rn,"P",{});var si=a(Jn);zl=i(si,`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ai.forEach(t),Nl=l(rn),me=s(rn,"DIV",{class:!0});var Ze=a(me);v(Zn.$$.fragment,Ze),Cl=l(Ze),Mt=s(Ze,"P",{});var xs=a(Mt);Il=i(xs,"The "),ds=s(xs,"A",{href:!0});var Ru=a(ds);Al=i(Ru,"MarianModel"),Ru.forEach(t),Ll=i(xs," forward method, overrides the "),pa=s(xs,"CODE",{});var Wu=a(pa);Sl=i(Wu,"__call__"),Wu.forEach(t),Ol=i(xs," special method."),xs.forEach(t),Hl=l(Ze),v(Rt.$$.fragment,Ze),Dl=l(Ze),ha=s(Ze,"P",{});var Bu=a(ha);Ul=i(Bu,"Example:"),Bu.forEach(t),Rl=l(Ze),v(Xn.$$.fragment,Ze),Ze.forEach(t),rn.forEach(t),Mr=l(n),bt=s(n,"H2",{class:!0});var ri=a(bt);Wt=s(ri,"A",{id:!0,class:!0,href:!0});var Vu=a(Wt);ua=s(Vu,"SPAN",{});var Gu=a(ua);v(Qn.$$.fragment,Gu),Gu.forEach(t),Vu.forEach(t),Wl=l(ri),ma=s(ri,"SPAN",{});var Ju=a(ma);Bl=i(Ju,"MarianMTModel"),Ju.forEach(t),ri.forEach(t),br=l(n),ze=s(n,"DIV",{class:!0});var dn=a(ze);v(eo.$$.fragment,dn),Vl=l(dn),to=s(dn,"P",{});var ii=a(to);Gl=i(ii,`The Marian Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),di.forEach(t),ec=l(dn),Y=s(dn,"DIV",{class:!0});var Ne=a(Y);v(so.$$.fragment,Ne),tc=l(Ne),yt=s(Ne,"P",{});var ws=a(yt);nc=i(ws,"The "),cs=s(ws,"A",{href:!0});var Zu=a(cs);oc=i(Zu,"MarianMTModel"),Zu.forEach(t),sc=i(ws," forward method, overrides the "),fa=s(ws,"CODE",{});var Xu=a(fa);ac=i(Xu,"__call__"),Xu.forEach(t),rc=i(ws," special method."),ws.forEach(t),ic=l(Ne),v(Bt.$$.fragment,Ne),dc=l(Ne),ao=s(Ne,"P",{});var li=a(ao);lc=i(li,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),ro=s(li,"A",{href:!0,rel:!0});var Qu=a(ro);cc=i(Qu,"here"),Qu.forEach(t),pc=i(li,"."),li.forEach(t),hc=l(Ne),_a=s(Ne,"P",{});var em=a(_a);uc=i(em,"Examples:"),em.forEach(t),mc=l(Ne),v(io.$$.fragment,Ne),Ne.forEach(t),dn.forEach(t),yr=l(n),xt=s(n,"H2",{class:!0});var ci=a(xt);Vt=s(ci,"A",{id:!0,class:!0,href:!0});var tm=a(Vt);ga=s(tm,"SPAN",{});var nm=a(ga);v(lo.$$.fragment,nm),nm.forEach(t),tm.forEach(t),fc=l(ci),ka=s(ci,"SPAN",{});var om=a(ka);_c=i(om,"MarianForCausalLM"),om.forEach(t),ci.forEach(t),xr=l(n),wt=s(n,"DIV",{class:!0});var pi=a(wt);v(co.$$.fragment,pi),gc=l(pi),Ye=s(pi,"DIV",{class:!0});var zs=a(Ye);v(po.$$.fragment,zs),kc=l(zs),va=s(zs,"P",{});var sm=a(va);vc=i(sm,"Example:"),sm.forEach(t),Tc=l(zs),v(ho.$$.fragment,zs),zs.forEach(t),pi.forEach(t),wr=l(n),zt=s(n,"H2",{class:!0});var hi=a(zt);Gt=s(hi,"A",{id:!0,class:!0,href:!0});var am=a(Gt);Ta=s(am,"SPAN",{});var rm=a(Ta);v(uo.$$.fragment,rm),rm.forEach(t),am.forEach(t),Mc=l(hi),Ma=s(hi,"SPAN",{});var im=a(Ma);bc=i(im,"TFMarianModel"),im.forEach(t),hi.forEach(t),zr=l(n),ce=s(n,"DIV",{class:!0});var Xe=a(ce);v(mo.$$.fragment,Xe),yc=l(Xe),fo=s(Xe,"P",{});var ui=a(fo);xc=i(ui,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ui.forEach(t),$c=l(Xe),_o=s(Xe,"P",{});var mi=a(_o);jc=i(mi,"This model is also a "),go=s(mi,"A",{href:!0,rel:!0});var lm=a(go);Ec=i(lm,"tf.keras.Model"),lm.forEach(t),qc=i(mi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mi.forEach(t),Pc=l(Xe),v(Jt.$$.fragment,Xe),Fc=l(Xe),fe=s(Xe,"DIV",{class:!0});var Qe=a(fe);v(ko.$$.fragment,Qe),Nc=l(Qe),$t=s(Qe,"P",{});var $s=a($t);Cc=i($s,"The "),hs=s($s,"A",{href:!0});var cm=a(hs);Ic=i(cm,"TFMarianModel"),cm.forEach(t),Ac=i($s," forward method, overrides the "),ba=s($s,"CODE",{});var pm=a(ba);Lc=i(pm,"__call__"),pm.forEach(t),Sc=i($s," special method."),$s.forEach(t),Oc=l(Qe),v(Yt.$$.fragment,Qe),Hc=l(Qe),ya=s(Qe,"P",{});var hm=a(ya);Dc=i(hm,"Example:"),hm.forEach(t),Uc=l(Qe),v(vo.$$.fragment,Qe),Qe.forEach(t),Xe.forEach(t),$r=l(n),jt=s(n,"H2",{class:!0});var fi=a(jt);Kt=s(fi,"A",{id:!0,class:!0,href:!0});var um=a(Kt);xa=s(um,"SPAN",{});var mm=a(xa);v(To.$$.fragment,mm),mm.forEach(t),um.forEach(t),Rc=l(fi),wa=s(fi,"SPAN",{});var fm=a(wa);Wc=i(fm,"TFMarianMTModel"),fm.forEach(t),fi.forEach(t),jr=l(n),pe=s(n,"DIV",{class:!0});var et=a(pe);v(Mo.$$.fragment,et),Bc=l(et),bo=s(et,"P",{});var _i=a(bo);Vc=i(_i,`The MARIAN Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_i.forEach(t),Yc=l(et),yo=s(et,"P",{});var gi=a(yo);Kc=i(gi,"This model is also a "),xo=s(gi,"A",{href:!0,rel:!0});var gm=a(xo);Zc=i(gm,"tf.keras.Model"),gm.forEach(t),Xc=i(gi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gi.forEach(t),Qc=l(et),v(Zt.$$.fragment,et),ep=l(et),K=s(et,"DIV",{class:!0});var Ce=a(K);v(wo.$$.fragment,Ce),tp=l(Ce),Et=s(Ce,"P",{});var js=a(Et);np=i(js,"The "),ms=s(js,"A",{href:!0});var km=a(ms);op=i(km,"TFMarianMTModel"),km.forEach(t),sp=i(js," forward method, overrides the "),za=s(js,"CODE",{});var vm=a(za);ap=i(vm,"__call__"),vm.forEach(t),rp=i(js," special method."),js.forEach(t),ip=l(Ce),v(Xt.$$.fragment,Ce),dp=l(Ce),zo=s(Ce,"P",{});var ki=a(zo);lp=i(ki,`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),$o=s(ki,"A",{href:!0,rel:!0});var Tm=a($o);cp=i(Tm,"here"),Tm.forEach(t),pp=i(ki,"."),ki.forEach(t),hp=l(Ce),$a=s(Ce,"P",{});var Mm=a($a);up=i(Mm,"Examples:"),Mm.forEach(t),mp=l(Ce),v(jo.$$.fragment,Ce),Ce.forEach(t),et.forEach(t),Er=l(n),qt=s(n,"H2",{class:!0});var vi=a(qt);Qt=s(vi,"A",{id:!0,class:!0,href:!0});var bm=a(Qt);ja=s(bm,"SPAN",{});var ym=a(ja);v(Eo.$$.fragment,ym),ym.forEach(t),bm.forEach(t),fp=l(vi),Ea=s(vi,"SPAN",{});var xm=a(Ea);_p=i(xm,"FlaxMarianModel"),xm.forEach(t),vi.forEach(t),qr=l(n),W=s(n,"DIV",{class:!0});var Ie=a(W);v(qo.$$.fragment,Ie),gp=l(Ie),Po=s(Ie,"P",{});var Ti=a(Po);kp=i(Ti,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ti.forEach(t),Mp=l(Ie),Fo=s(Ie,"P",{});var Mi=a(Fo);bp=i(Mi,`This model is also a Flax Linen
`),No=s(Mi,"A",{href:!0,rel:!0});var zm=a(No);yp=i(zm,"flax.nn.Module"),zm.forEach(t),xp=i(Mi,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mi.forEach(t),wp=l(Ie),qa=s(Ie,"P",{});var $m=a(qa);zp=i($m,"Finally, this model supports inherent JAX features such as:"),$m.forEach(t),$p=l(Ie),Ve=s(Ie,"UL",{});var ln=a(Ve);Pa=s(ln,"LI",{});var jm=a(Pa);Co=s(jm,"A",{href:!0,rel:!0});var Em=a(Co);jp=i(Em,"Just-In-Time (JIT) compilation"),Em.forEach(t),jm.forEach(t),Ep=l(ln),Fa=s(ln,"LI",{});var qm=a(Fa);Io=s(qm,"A",{href:!0,rel:!0});var Pm=a(Io);qp=i(Pm,"Automatic Differentiation"),Pm.forEach(t),qm.forEach(t),Pp=l(ln),Na=s(ln,"LI",{});var Fm=a(Na);Ao=s(Fm,"A",{href:!0,rel:!0});var Nm=a(Ao);Fp=i(Nm,"Vectorization"),Nm.forEach(t),Fm.forEach(t),Np=l(ln),Ca=s(ln,"LI",{});var Cm=a(Ca);Lo=s(Cm,"A",{href:!0,rel:!0});var Im=a(Lo);Cp=i(Im,"Parallelization"),Im.forEach(t),Cm.forEach(t),ln.forEach(t),Ip=l(Ie),_e=s(Ie,"DIV",{class:!0});var tt=a(_e);v(So.$$.fragment,tt),Ap=l(tt),Pt=s(tt,"P",{});var Es=a(Pt);Lp=i(Es,"The "),Ia=s(Es,"CODE",{});var Am=a(Ia);Sp=i(Am,"FlaxMarianPreTrainedModel"),Am.forEach(t),Op=i(Es,"forward method, overrides the "),Aa=s(Es,"CODE",{});var Lm=a(Aa);Hp=i(Lm,"__call__"),Lm.forEach(t),Dp=i(Es," special method."),Es.forEach(t),Up=l(tt),v(en.$$.fragment,tt),Rp=l(tt),La=s(tt,"P",{});var Sm=a(La);Wp=i(Sm,"Example:"),Sm.forEach(t),Bp=l(tt),v(Oo.$$.fragment,tt),tt.forEach(t),Ie.forEach(t),Pr=l(n),Ft=s(n,"H2",{class:!0});var bi=a(Ft);tn=s(bi,"A",{id:!0,class:!0,href:!0});var Om=a(tn);Sa=s(Om,"SPAN",{});var Hm=a(Sa);v(Ho.$$.fragment,Hm),Hm.forEach(t),Om.forEach(t),Vp=l(bi),Oa=s(bi,"SPAN",{});var Dm=a(Oa);Gp=i(Dm,"FlaxMarianMTModel"),Dm.forEach(t),bi.forEach(t),Fr=l(n),B=s(n,"DIV",{class:!0});var Ae=a(B);v(Do.$$.fragment,Ae),Jp=l(Ae),Uo=s(Ae,"P",{});var yi=a(Uo);Yp=i(yi,`The MARIAN Model with a language modeling head. Can be used for translation.
This model inherits from `),_s=s(yi,"A",{href:!0});var Um=a(_s);Kp=i(Um,"FlaxPreTrainedModel"),Um.forEach(t),Zp=i(yi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yi.forEach(t),Xp=l(Ae),Ro=s(Ae,"P",{});var xi=a(Ro);Qp=i(xi,`This model is also a Flax Linen
`),Wo=s(xi,"A",{href:!0,rel:!0});var Rm=a(Wo);eh=i(Rm,"flax.nn.Module"),Rm.forEach(t),th=i(xi,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xi.forEach(t),nh=l(Ae),Ha=s(Ae,"P",{});var Wm=a(Ha);oh=i(Wm,"Finally, this model supports inherent JAX features such as:"),Wm.forEach(t),sh=l(Ae),Ge=s(Ae,"UL",{});var cn=a(Ge);Da=s(cn,"LI",{});var Bm=a(Da);Bo=s(Bm,"A",{href:!0,rel:!0});var Vm=a(Bo);ah=i(Vm,"Just-In-Time (JIT) compilation"),Vm.forEach(t),Bm.forEach(t),rh=l(cn),Ua=s(cn,"LI",{});var Gm=a(Ua);Vo=s(Gm,"A",{href:!0,rel:!0});var Jm=a(Vo);ih=i(Jm,"Automatic Differentiation"),Jm.forEach(t),Gm.forEach(t),dh=l(cn),Ra=s(cn,"LI",{});var Ym=a(Ra);Go=s(Ym,"A",{href:!0,rel:!0});var Km=a(Go);lh=i(Km,"Vectorization"),Km.forEach(t),Ym.forEach(t),ch=l(cn),Wa=s(cn,"LI",{});var Zm=a(Wa);Jo=s(Zm,"A",{href:!0,rel:!0});var Xm=a(Jo);ph=i(Xm,"Parallelization"),Xm.forEach(t),Zm.forEach(t),cn.forEach(t),hh=l(Ae),ge=s(Ae,"DIV",{class:!0});var nt=a(ge);v(Yo.$$.fragment,nt),uh=l(nt),Nt=s(nt,"P",{});var qs=a(Nt);mh=i(qs,"The "),Ba=s(qs,"CODE",{});var Qm=a(Ba);fh=i(Qm,"FlaxMarianPreTrainedModel"),Qm.forEach(t),_h=i(qs,"forward method, overrides the "),Va=s(qs,"CODE",{});var ef=a(Va);gh=i(ef,"__call__"),ef.forEach(t),kh=i(qs," special method."),qs.forEach(t),vh=l(nt),v(nn.$$.fragment,nt),Th=l(nt),Ga=s(nt,"P",{});var tf=a(Ga);Mh=i(tf,"Example:"),tf.forEach(t),bh=l(nt),v(Ko.$$.fragment,nt),nt.forEach(t),Ae.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(_f)),c(_,"id","marianmt"),c(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_,"href","#marianmt"),c(f,"class","relative group"),c(Q,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),c(Q,"rel","nofollow"),c(q,"id","implementation-notes"),c(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(q,"href","#implementation-notes"),c(I,"class","relative group"),c(re,"href","https://huggingface.co/Helsinki-NLP"),c(re,"rel","nofollow"),c(j,"href","https://researchportal.helsinki.fi/en/persons/j%C3%B6rg-tiedemann"),c(j,"rel","nofollow"),c(ye,"href","https://marian-nmt.github.io/"),c(ye,"rel","nofollow"),c(Xo,"href","/docs/transformers/pr_16041/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(_n,"href","https://huggingface.co/sshleifer"),c(_n,"rel","nofollow"),c(Ct,"id","naming"),c(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ct,"href","#naming"),c(pt,"class","relative group"),c(vn,"href","https://developers.google.com/admin-sdk/directory/v1/languages"),c(vn,"rel","nofollow"),c(It,"id","examples"),c(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(It,"href","#examples"),c(ut,"class","relative group"),c(Mn,"href","https://github.com/huggingface/transformers/blob/master/examples/research_projects/seq2seq-distillation/train_distil_marian_enro_teacher.sh"),c(Mn,"rel","nofollow"),c(bn,"href","https://github.com/huggingface/transformers/blob/master/examples/research_projects/seq2seq-distillation/train_distil_marian_no_teacher.sh"),c(bn,"rel","nofollow"),c(At,"id","multilingual-models"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#multilingual-models"),c(mt,"class","relative group"),c($n,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-roa"),c($n,"rel","nofollow"),c(En,"href","https://github.com/Helsinki-NLP/Tatoeba-Challenge"),c(En,"rel","nofollow"),c(St,"id","old-style-multilingual-models"),c(St,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(St,"href","#old-style-multilingual-models"),c(ft,"class","relative group"),c(Ot,"id","transformers.MarianConfig"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.MarianConfig"),c(_t,"class","relative group"),c(os,"href","/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianModel"),c(Ln,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-de"),c(Ln,"rel","nofollow"),c(ss,"href","/docs/transformers/pr_16041/en/main_classes/configuration#transformers.PretrainedConfig"),c(as,"href","/docs/transformers/pr_16041/en/main_classes/configuration#transformers.PretrainedConfig"),c(le,"class","docstring"),c(Ht,"id","transformers.MarianTokenizer"),c(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ht,"href","#transformers.MarianTokenizer"),c(vt,"class","relative group"),c(Un,"href","https://github.com/google/sentencepiece"),c(Un,"rel","nofollow"),c(rs,"href","/docs/transformers/pr_16041/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(Dt,"class","docstring"),c(R,"class","docstring"),c(Ut,"id","transformers.MarianModel"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.MarianModel"),c(Tt,"class","relative group"),c(is,"href","/docs/transformers/pr_16041/en/main_classes/model#transformers.PreTrainedModel"),c(Kn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Kn,"rel","nofollow"),c(ds,"href","/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianModel"),c(me,"class","docstring"),c(we,"class","docstring"),c(Wt,"id","transformers.MarianMTModel"),c(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wt,"href","#transformers.MarianMTModel"),c(bt,"class","relative group"),c(ls,"href","/docs/transformers/pr_16041/en/main_classes/model#transformers.PreTrainedModel"),c(oo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(oo,"rel","nofollow"),c(cs,"href","/docs/transformers/pr_16041/en/model_doc/marian#transformers.MarianMTModel"),c(ro,"href","https://huggingface.co/models?search=Helsinki-NLP"),c(ro,"rel","nofollow"),c(Y,"class","docstring"),c(ze,"class","docstring"),c(Vt,"id","transformers.MarianForCausalLM"),c(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Vt,"href","#transformers.MarianForCausalLM"),c(xt,"class","relative group"),c(Ye,"class","docstring"),c(wt,"class","docstring"),c(Gt,"id","transformers.TFMarianModel"),c(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gt,"href","#transformers.TFMarianModel"),c(zt,"class","relative group"),c(ps,"href","/docs/transformers/pr_16041/en/main_classes/model#transformers.TFPreTrainedModel"),c(go,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(go,"rel","nofollow"),c(hs,"href","/docs/transformers/pr_16041/en/model_doc/marian#transformers.TFMarianModel"),c(fe,"class","docstring"),c(ce,"class","docstring"),c(Kt,"id","transformers.TFMarianMTModel"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#transformers.TFMarianMTModel"),c(jt,"class","relative group"),c(us,"href","/docs/transformers/pr_16041/en/main_classes/model#transformers.TFPreTrainedModel"),c(xo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(xo,"rel","nofollow"),c(ms,"href","/docs/transformers/pr_16041/en/model_doc/marian#transformers.TFMarianMTModel"),c($o,"href","https://huggingface.co/models?search=Helsinki-NLP"),c($o,"rel","nofollow"),c(K,"class","docstring"),c(pe,"class","docstring"),c(Qt,"id","transformers.FlaxMarianModel"),c(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qt,"href","#transformers.FlaxMarianModel"),c(qt,"class","relative group"),c(fs,"href","/docs/transformers/pr_16041/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(No,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(No,"rel","nofollow"),c(Co,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Co,"rel","nofollow"),c(Io,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Io,"rel","nofollow"),c(Ao,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Ao,"rel","nofollow"),c(Lo,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Lo,"rel","nofollow"),c(_e,"class","docstring"),c(W,"class","docstring"),c(tn,"id","transformers.FlaxMarianMTModel"),c(tn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(tn,"href","#transformers.FlaxMarianMTModel"),c(Ft,"class","relative group"),c(_s,"href","/docs/transformers/pr_16041/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Wo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Wo,"rel","nofollow"),c(Bo,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Bo,"rel","nofollow"),c(Vo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Vo,"rel","nofollow"),c(Go,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Go,"rel","nofollow"),c(Jo,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Jo,"rel","nofollow"),c(ge,"class","docstring"),c(B,"class","docstring")},m(n,p){e(document.head,u),h(n,z,p),h(n,f,p),e(f,_),e(_,w),T(x,w,null),e(f,g),e(f,$),e($,Le),h(n,ue,p),h(n,E,p),e(E,ke),e(ke,X),e(E,Se),e(E,Q),e(Q,ee),e(E,Oe),h(n,je,p),h(n,G,p),e(G,L),h(n,Ee,p),h(n,I,p),e(I,q),e(q,F),T(te,F,null),e(I,ne),e(I,ve),e(ve,He),h(n,J,p),h(n,P,p),e(P,Te),e(Te,N),e(N,De),e(P,oe),e(P,Me),e(Me,se),e(se,ae),e(se,re),e(re,Ue),e(se,S),e(P,Re),e(P,O),e(O,H),e(H,m),e(H,j),e(j,be),e(H,ot),e(H,ye),e(ye,D),e(H,st),e(P,at),e(P,We),e(We,A),e(A,ie),e(P,rt),e(P,Be),e(Be,U),e(U,it),e(P,dt),e(P,de),e(de,xe),e(xe,wi),e(xe,Xo),e(Xo,zi),e(xe,$i),e(de,ji),e(de,lt),e(lt,hn),e(hn,Ei),e(hn,Ps),e(Ps,qi),e(hn,Pi),e(lt,Fi),e(lt,un),e(un,Ni),e(un,Fs),e(Fs,Ci),e(un,Ii),e(lt,Ai),e(lt,ct),e(ct,Li),e(ct,Ns),e(Ns,Si),e(ct,Oi),e(ct,Cs),e(Cs,Hi),e(ct,Di),e(P,Ui),e(P,Is),e(Is,mn),e(mn,Ri),e(mn,As),e(As,Wi),e(mn,Bi),e(P,Vi),e(P,Ls),e(Ls,fn),e(fn,Gi),e(fn,_n),e(_n,Ji),e(fn,Yi),h(n,er,p),h(n,pt,p),e(pt,Ct),e(Ct,Ss),T(gn,Ss,null),e(pt,Ki),e(pt,Os),e(Os,Zi),h(n,tr,p),h(n,qe,p),e(qe,Qo),e(Qo,Xi),e(Qo,Hs),e(Hs,Qi),e(qe,ed),e(qe,kn),e(kn,td),e(kn,vn),e(vn,nd),e(kn,od),e(qe,sd),e(qe,ht),e(ht,ad),e(ht,Ds),e(Ds,rd),e(ht,id),e(ht,Us),e(Us,dd),e(ht,ld),e(qe,cd),e(qe,Rs),e(Rs,pd),h(n,nr,p),h(n,ut,p),e(ut,It),e(It,Ws),T(Tn,Ws,null),e(ut,hd),e(ut,Bs),e(Bs,ud),h(n,or,p),h(n,Je,p),e(Je,Vs),e(Vs,md),e(Je,fd),e(Je,Gs),e(Gs,Mn),e(Mn,_d),e(Je,gd),e(Je,Js),e(Js,bn),e(bn,kd),h(n,sr,p),h(n,mt,p),e(mt,At),e(At,Ys),T(yn,Ys,null),e(mt,vd),e(mt,Ks),e(Ks,Td),h(n,ar,p),h(n,Pe,p),e(Pe,xn),e(xn,Md),e(xn,Zs),e(Zs,bd),e(xn,yd),e(Pe,xd),e(Pe,wn),e(wn,wd),e(wn,Xs),e(Xs,zd),e(wn,$d),e(Pe,jd),e(Pe,zn),e(zn,Ed),e(zn,$n),e($n,qd),e(zn,Pd),e(Pe,Fd),e(Pe,jn),e(jn,Nd),e(jn,Qs),e(Qs,Cd),e(jn,Id),h(n,rr,p),h(n,Lt,p),e(Lt,Ad),e(Lt,En),e(En,Ld),e(Lt,Sd),h(n,ir,p),T(qn,n,p),h(n,dr,p),h(n,es,p),e(es,Od),h(n,lr,p),T(Pn,n,p),h(n,cr,p),h(n,ft,p),e(ft,St),e(St,ea),T(Fn,ea,null),e(ft,Hd),e(ft,ta),e(ta,Dd),h(n,pr,p),h(n,ts,p),e(ts,Ud),h(n,hr,p),T(Nn,n,p),h(n,ur,p),h(n,ns,p),e(ns,Rd),h(n,mr,p),T(Cn,n,p),h(n,fr,p),h(n,_t,p),e(_t,Ot),e(Ot,na),T(In,na,null),e(_t,Wd),e(_t,oa),e(oa,Bd),h(n,_r,p),h(n,le,p),T(An,le,null),e(le,Vd),e(le,gt),e(gt,Gd),e(gt,os),e(os,Jd),e(gt,Yd),e(gt,Ln),e(Ln,Kd),e(gt,Zd),e(le,Xd),e(le,kt),e(kt,Qd),e(kt,ss),e(ss,el),e(kt,tl),e(kt,as),e(as,nl),e(kt,ol),e(le,sl),e(le,sa),e(sa,al),e(le,rl),T(Sn,le,null),h(n,gr,p),h(n,vt,p),e(vt,Ht),e(Ht,aa),T(On,aa,null),e(vt,il),e(vt,ra),e(ra,dl),h(n,kr,p),h(n,R,p),T(Hn,R,null),e(R,ll),e(R,Dn),e(Dn,cl),e(Dn,Un),e(Un,pl),e(Dn,hl),e(R,ul),e(R,Rn),e(Rn,ml),e(Rn,rs),e(rs,fl),e(Rn,_l),e(R,gl),e(R,ia),e(ia,kl),e(R,vl),T(Wn,R,null),e(R,Tl),e(R,Dt),T(Bn,Dt,null),e(Dt,Ml),e(Dt,da),e(da,bl),h(n,vr,p),h(n,Tt,p),e(Tt,Ut),e(Ut,la),T(Vn,la,null),e(Tt,yl),e(Tt,ca),e(ca,xl),h(n,Tr,p),h(n,we,p),T(Gn,we,null),e(we,wl),e(we,Jn),e(Jn,zl),e(Jn,is),e(is,$l),e(Jn,jl),e(we,El),e(we,Yn),e(Yn,ql),e(Yn,Kn),e(Kn,Pl),e(Yn,Fl),e(we,Nl),e(we,me),T(Zn,me,null),e(me,Cl),e(me,Mt),e(Mt,Il),e(Mt,ds),e(ds,Al),e(Mt,Ll),e(Mt,pa),e(pa,Sl),e(Mt,Ol),e(me,Hl),T(Rt,me,null),e(me,Dl),e(me,ha),e(ha,Ul),e(me,Rl),T(Xn,me,null),h(n,Mr,p),h(n,bt,p),e(bt,Wt),e(Wt,ua),T(Qn,ua,null),e(bt,Wl),e(bt,ma),e(ma,Bl),h(n,br,p),h(n,ze,p),T(eo,ze,null),e(ze,Vl),e(ze,to),e(to,Gl),e(to,ls),e(ls,Jl),e(to,Yl),e(ze,Kl),e(ze,no),e(no,Zl),e(no,oo),e(oo,Xl),e(no,Ql),e(ze,ec),e(ze,Y),T(so,Y,null),e(Y,tc),e(Y,yt),e(yt,nc),e(yt,cs),e(cs,oc),e(yt,sc),e(yt,fa),e(fa,ac),e(yt,rc),e(Y,ic),T(Bt,Y,null),e(Y,dc),e(Y,ao),e(ao,lc),e(ao,ro),e(ro,cc),e(ao,pc),e(Y,hc),e(Y,_a),e(_a,uc),e(Y,mc),T(io,Y,null),h(n,yr,p),h(n,xt,p),e(xt,Vt),e(Vt,ga),T(lo,ga,null),e(xt,fc),e(xt,ka),e(ka,_c),h(n,xr,p),h(n,wt,p),T(co,wt,null),e(wt,gc),e(wt,Ye),T(po,Ye,null),e(Ye,kc),e(Ye,va),e(va,vc),e(Ye,Tc),T(ho,Ye,null),h(n,wr,p),h(n,zt,p),e(zt,Gt),e(Gt,Ta),T(uo,Ta,null),e(zt,Mc),e(zt,Ma),e(Ma,bc),h(n,zr,p),h(n,ce,p),T(mo,ce,null),e(ce,yc),e(ce,fo),e(fo,xc),e(fo,ps),e(ps,wc),e(fo,zc),e(ce,$c),e(ce,_o),e(_o,jc),e(_o,go),e(go,Ec),e(_o,qc),e(ce,Pc),T(Jt,ce,null),e(ce,Fc),e(ce,fe),T(ko,fe,null),e(fe,Nc),e(fe,$t),e($t,Cc),e($t,hs),e(hs,Ic),e($t,Ac),e($t,ba),e(ba,Lc),e($t,Sc),e(fe,Oc),T(Yt,fe,null),e(fe,Hc),e(fe,ya),e(ya,Dc),e(fe,Uc),T(vo,fe,null),h(n,$r,p),h(n,jt,p),e(jt,Kt),e(Kt,xa),T(To,xa,null),e(jt,Rc),e(jt,wa),e(wa,Wc),h(n,jr,p),h(n,pe,p),T(Mo,pe,null),e(pe,Bc),e(pe,bo),e(bo,Vc),e(bo,us),e(us,Gc),e(bo,Jc),e(pe,Yc),e(pe,yo),e(yo,Kc),e(yo,xo),e(xo,Zc),e(yo,Xc),e(pe,Qc),T(Zt,pe,null),e(pe,ep),e(pe,K),T(wo,K,null),e(K,tp),e(K,Et),e(Et,np),e(Et,ms),e(ms,op),e(Et,sp),e(Et,za),e(za,ap),e(Et,rp),e(K,ip),T(Xt,K,null),e(K,dp),e(K,zo),e(zo,lp),e(zo,$o),e($o,cp),e(zo,pp),e(K,hp),e(K,$a),e($a,up),e(K,mp),T(jo,K,null),h(n,Er,p),h(n,qt,p),e(qt,Qt),e(Qt,ja),T(Eo,ja,null),e(qt,fp),e(qt,Ea),e(Ea,_p),h(n,qr,p),h(n,W,p),T(qo,W,null),e(W,gp),e(W,Po),e(Po,kp),e(Po,fs),e(fs,vp),e(Po,Tp),e(W,Mp),e(W,Fo),e(Fo,bp),e(Fo,No),e(No,yp),e(Fo,xp),e(W,wp),e(W,qa),e(qa,zp),e(W,$p),e(W,Ve),e(Ve,Pa),e(Pa,Co),e(Co,jp),e(Ve,Ep),e(Ve,Fa),e(Fa,Io),e(Io,qp),e(Ve,Pp),e(Ve,Na),e(Na,Ao),e(Ao,Fp),e(Ve,Np),e(Ve,Ca),e(Ca,Lo),e(Lo,Cp),e(W,Ip),e(W,_e),T(So,_e,null),e(_e,Ap),e(_e,Pt),e(Pt,Lp),e(Pt,Ia),e(Ia,Sp),e(Pt,Op),e(Pt,Aa),e(Aa,Hp),e(Pt,Dp),e(_e,Up),T(en,_e,null),e(_e,Rp),e(_e,La),e(La,Wp),e(_e,Bp),T(Oo,_e,null),h(n,Pr,p),h(n,Ft,p),e(Ft,tn),e(tn,Sa),T(Ho,Sa,null),e(Ft,Vp),e(Ft,Oa),e(Oa,Gp),h(n,Fr,p),h(n,B,p),T(Do,B,null),e(B,Jp),e(B,Uo),e(Uo,Yp),e(Uo,_s),e(_s,Kp),e(Uo,Zp),e(B,Xp),e(B,Ro),e(Ro,Qp),e(Ro,Wo),e(Wo,eh),e(Ro,th),e(B,nh),e(B,Ha),e(Ha,oh),e(B,sh),e(B,Ge),e(Ge,Da),e(Da,Bo),e(Bo,ah),e(Ge,rh),e(Ge,Ua),e(Ua,Vo),e(Vo,ih),e(Ge,dh),e(Ge,Ra),e(Ra,Go),e(Go,lh),e(Ge,ch),e(Ge,Wa),e(Wa,Jo),e(Jo,ph),e(B,hh),e(B,ge),T(Yo,ge,null),e(ge,uh),e(ge,Nt),e(Nt,mh),e(Nt,Ba),e(Ba,fh),e(Nt,_h),e(Nt,Va),e(Va,gh),e(Nt,kh),e(ge,vh),T(nn,ge,null),e(ge,Th),e(ge,Ga),e(Ga,Mh),e(ge,bh),T(Ko,ge,null),Nr=!0},p(n,[p]){const Zo={};p&2&&(Zo.$$scope={dirty:p,ctx:n}),Rt.$set(Zo);const Ja={};p&2&&(Ja.$$scope={dirty:p,ctx:n}),Bt.$set(Ja);const Ya={};p&2&&(Ya.$$scope={dirty:p,ctx:n}),Jt.$set(Ya);const Ka={};p&2&&(Ka.$$scope={dirty:p,ctx:n}),Yt.$set(Ka);const on={};p&2&&(on.$$scope={dirty:p,ctx:n}),Zt.$set(on);const Za={};p&2&&(Za.$$scope={dirty:p,ctx:n}),Xt.$set(Za);const Xa={};p&2&&(Xa.$$scope={dirty:p,ctx:n}),en.$set(Xa);const Qa={};p&2&&(Qa.$$scope={dirty:p,ctx:n}),nn.$set(Qa)},i(n){Nr||(M(x.$$.fragment,n),M(te.$$.fragment,n),M(gn.$$.fragment,n),M(Tn.$$.fragment,n),M(yn.$$.fragment,n),M(qn.$$.fragment,n),M(Pn.$$.fragment,n),M(Fn.$$.fragment,n),M(Nn.$$.fragment,n),M(Cn.$$.fragment,n),M(In.$$.fragment,n),M(An.$$.fragment,n),M(Sn.$$.fragment,n),M(On.$$.fragment,n),M(Hn.$$.fragment,n),M(Wn.$$.fragment,n),M(Bn.$$.fragment,n),M(Vn.$$.fragment,n),M(Gn.$$.fragment,n),M(Zn.$$.fragment,n),M(Rt.$$.fragment,n),M(Xn.$$.fragment,n),M(Qn.$$.fragment,n),M(eo.$$.fragment,n),M(so.$$.fragment,n),M(Bt.$$.fragment,n),M(io.$$.fragment,n),M(lo.$$.fragment,n),M(co.$$.fragment,n),M(po.$$.fragment,n),M(ho.$$.fragment,n),M(uo.$$.fragment,n),M(mo.$$.fragment,n),M(Jt.$$.fragment,n),M(ko.$$.fragment,n),M(Yt.$$.fragment,n),M(vo.$$.fragment,n),M(To.$$.fragment,n),M(Mo.$$.fragment,n),M(Zt.$$.fragment,n),M(wo.$$.fragment,n),M(Xt.$$.fragment,n),M(jo.$$.fragment,n),M(Eo.$$.fragment,n),M(qo.$$.fragment,n),M(So.$$.fragment,n),M(en.$$.fragment,n),M(Oo.$$.fragment,n),M(Ho.$$.fragment,n),M(Do.$$.fragment,n),M(Yo.$$.fragment,n),M(nn.$$.fragment,n),M(Ko.$$.fragment,n),Nr=!0)},o(n){b(x.$$.fragment,n),b(te.$$.fragment,n),b(gn.$$.fragment,n),b(Tn.$$.fragment,n),b(yn.$$.fragment,n),b(qn.$$.fragment,n),b(Pn.$$.fragment,n),b(Fn.$$.fragment,n),b(Nn.$$.fragment,n),b(Cn.$$.fragment,n),b(In.$$.fragment,n),b(An.$$.fragment,n),b(Sn.$$.fragment,n),b(On.$$.fragment,n),b(Hn.$$.fragment,n),b(Wn.$$.fragment,n),b(Bn.$$.fragment,n),b(Vn.$$.fragment,n),b(Gn.$$.fragment,n),b(Zn.$$.fragment,n),b(Rt.$$.fragment,n),b(Xn.$$.fragment,n),b(Qn.$$.fragment,n),b(eo.$$.fragment,n),b(so.$$.fragment,n),b(Bt.$$.fragment,n),b(io.$$.fragment,n),b(lo.$$.fragment,n),b(co.$$.fragment,n),b(po.$$.fragment,n),b(ho.$$.fragment,n),b(uo.$$.fragment,n),b(mo.$$.fragment,n),b(Jt.$$.fragment,n),b(ko.$$.fragment,n),b(Yt.$$.fragment,n),b(vo.$$.fragment,n),b(To.$$.fragment,n),b(Mo.$$.fragment,n),b(Zt.$$.fragment,n),b(wo.$$.fragment,n),b(Xt.$$.fragment,n),b(jo.$$.fragment,n),b(Eo.$$.fragment,n),b(qo.$$.fragment,n),b(So.$$.fragment,n),b(en.$$.fragment,n),b(Oo.$$.fragment,n),b(Ho.$$.fragment,n),b(Do.$$.fragment,n),b(Yo.$$.fragment,n),b(nn.$$.fragment,n),b(Ko.$$.fragment,n),Nr=!1},d(n){t(u),n&&t(z),n&&t(f),y(x),n&&t(ue),n&&t(E),n&&t(je),n&&t(G),n&&t(Ee),n&&t(I),y(te),n&&t(J),n&&t(P),n&&t(er),n&&t(pt),y(gn),n&&t(tr),n&&t(qe),n&&t(nr),n&&t(ut),y(Tn),n&&t(or),n&&t(Je),n&&t(sr),n&&t(mt),y(yn),n&&t(ar),n&&t(Pe),n&&t(rr),n&&t(Lt),n&&t(ir),y(qn,n),n&&t(dr),n&&t(es),n&&t(lr),y(Pn,n),n&&t(cr),n&&t(ft),y(Fn),n&&t(pr),n&&t(ts),n&&t(hr),y(Nn,n),n&&t(ur),n&&t(ns),n&&t(mr),y(Cn,n),n&&t(fr),n&&t(_t),y(In),n&&t(_r),n&&t(le),y(An),y(Sn),n&&t(gr),n&&t(vt),y(On),n&&t(kr),n&&t(R),y(Hn),y(Wn),y(Bn),n&&t(vr),n&&t(Tt),y(Vn),n&&t(Tr),n&&t(we),y(Gn),y(Zn),y(Rt),y(Xn),n&&t(Mr),n&&t(bt),y(Qn),n&&t(br),n&&t(ze),y(eo),y(so),y(Bt),y(io),n&&t(yr),n&&t(xt),y(lo),n&&t(xr),n&&t(wt),y(co),y(po),y(ho),n&&t(wr),n&&t(zt),y(uo),n&&t(zr),n&&t(ce),y(mo),y(Jt),y(ko),y(Yt),y(vo),n&&t($r),n&&t(jt),y(To),n&&t(jr),n&&t(pe),y(Mo),y(Zt),y(wo),y(Xt),y(jo),n&&t(Er),n&&t(qt),y(Eo),n&&t(qr),n&&t(W),y(qo),y(So),y(en),y(Oo),n&&t(Pr),n&&t(Ft),y(Ho),n&&t(Fr),n&&t(B),y(Do),y(Yo),y(nn),y(Ko)}}}const _f={local:"marianmt",sections:[{local:"implementation-notes",title:"Implementation Notes"},{local:"naming",title:"Naming"},{local:"examples",title:"Examples"},{local:"multilingual-models",title:"Multilingual Models"},{local:"old-style-multilingual-models",title:"Old Style Multi-Lingual Models"},{local:"transformers.MarianConfig",title:"MarianConfig"},{local:"transformers.MarianTokenizer",title:"MarianTokenizer"},{local:"transformers.MarianModel",title:"MarianModel"},{local:"transformers.MarianMTModel",title:"MarianMTModel"},{local:"transformers.MarianForCausalLM",title:"MarianForCausalLM"},{local:"transformers.TFMarianModel",title:"TFMarianModel"},{local:"transformers.TFMarianMTModel",title:"TFMarianMTModel"},{local:"transformers.FlaxMarianModel",title:"FlaxMarianModel"},{local:"transformers.FlaxMarianMTModel",title:"FlaxMarianMTModel"}],title:"MarianMT"};function gf(C,u,z){let{fw:f}=u;return C.$$set=_=>{"fw"in _&&z(0,f=_.fw)},[f]}class xf extends nf{constructor(u){super();of(this,u,gf,ff,sf,{fw:0})}}export{xf as default,_f as metadata};
