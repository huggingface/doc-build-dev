import{S as Ts,i as xs,s as Ds,e as a,k as i,w as b,t as n,M as Ms,c as s,d as o,m as l,a as d,x as y,h as t,b as c,F as e,g,y as w,q as E,o as k,B as S}from"../../chunks/vendor-4833417e.js";import{T as Ss}from"../../chunks/Tip-fffd6df1.js";import{D as ne}from"../../chunks/Docstring-4f315ed9.js";import{C as en}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xn}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function $s(he){let p,$,u,T,F;return{c(){p=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),T=n("Module"),F=n(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(x,M){g(x,p,M),e(p,$),e(p,u),e(u,T),e(p,F)},d(x){x&&o(p)}}}function js(he){let p,$,u,T,F;return{c(){p=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),T=n("Module"),F=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){p=s(x,"P",{});var M=d(p);$=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(M,"CODE",{});var L=d(u);T=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(x,M){g(x,p,M),e(p,$),e(p,u),e(u,T),e(p,F)},d(x){x&&o(p)}}}function qs(he){let p,$,u,T,F,x,M,L,Dn,on,j,Mn,Ye,$n,jn,wo,qn,Pn,Ze,zn,Cn,Ke,Fn,An,nn,N,Ln,Eo,Nn,In,me,Wn,Vn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,rn,H,te,ko,fe,Gn,So,Jn,an,D,ue,Yn,re,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,rt,at,st,To,dt,ct,ge,it,ae,_e,lt,ve,pt,ro,ht,mt,ft,se,be,ut,J,gt,xo,_t,vt,Do,bt,yt,sn,Y,de,Mo,ye,wt,$o,Et,dn,m,we,kt,Z,St,jo,Tt,xt,qo,Dt,Mt,$t,Ee,jt,ke,qt,Pt,zt,Se,Ct,Te,Ft,At,Lt,Po,Nt,It,xe,Wt,ao,Vt,Ot,Bt,De,Rt,Me,Ut,Ht,Gt,W,so,Jt,Yt,zo,Zt,Kt,Co,Qt,Xt,er,q,$e,or,K,nr,co,tr,rr,Fo,ar,sr,dr,ce,cr,Ao,ir,lr,je,pr,P,qe,hr,Lo,mr,fr,Q,ur,No,gr,_r,Io,vr,br,yr,Wo,wr,Er,Pe,cn,X,ie,Vo,ze,kr,Oo,Sr,ln,f,Ce,Tr,ee,xr,Bo,Dr,Mr,Ro,$r,jr,qr,Fe,Pr,Ae,zr,Cr,Fr,Le,Ar,Ne,Lr,Nr,Ir,Uo,Wr,Vr,Ie,Or,io,Br,Rr,Ur,We,Hr,Ve,Gr,Jr,Yr,V,lo,Zr,Kr,Ho,Qr,Xr,Go,ea,oa,na,z,Oe,ta,oe,ra,po,aa,sa,Jo,da,ca,ia,le,la,Yo,pa,ha,Be,ma,A,Re,fa,Zo,ua,ga,Ko,_a,va,Ue,pn;return x=new xn({}),fe=new xn({}),ue=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16041/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16041/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16041/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_16041/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_16041/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16041/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16041/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<a href="/docs/transformers/pr_16041/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
tensor of type <code>torch.FloatTensor</code>. See <a href="/docs/transformers/pr_16041/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"><strong>call</strong>()</a>`,name:"input_features"},{anchor:"transformers.SpeechEncoderDecoderModel.forward.return_dict",description:`<strong>return_dict</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
<a href="/docs/transformers/pr_16041/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16041/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxSpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2-2-bart-large&quot;</span>)`}}),{c(){p=a("meta"),$=i(),u=a("h1"),T=a("a"),F=a("span"),b(x.$$.fragment),M=i(),L=a("span"),Dn=n("Speech Encoder Decoder Models"),on=i(),j=a("p"),Mn=n("The "),Ye=a("a"),$n=n("SpeechEncoderDecoderModel"),jn=n(` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),wo=a("em"),qn=n("e.g."),Pn=i(),Ze=a("a"),zn=n("Wav2Vec2"),Cn=n(", "),Ke=a("a"),Fn=n("Hubert"),An=n(") and any pretrained autoregressive model as the decoder."),nn=i(),N=a("p"),Ln=n(`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
`),Xe=a("a"),Un=n("Speech2Text2"),Hn=n("."),rn=i(),H=a("h2"),te=a("a"),ko=a("span"),b(fe.$$.fragment),Gn=i(),So=a("span"),Jn=n("SpeechEncoderDecoderConfig"),an=i(),D=a("div"),b(ue.$$.fragment),Yn=i(),re=a("p"),eo=a("a"),Zn=n("SpeechEncoderDecoderConfig"),Kn=n(` is the configuration class to store the configuration of a
...
Zhou, Wei Li, Peter J. Liu.`),zt=i(),Se=a("p"),Ct=n("Additionally, in "),Te=a("a"),Ft=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
etc.)`),Bt=i(),De=a("p"),Rt=n("This model is also a PyTorch "),Me=a("a"),Ut=n("torch.nn.Module"),Ht=n(` subclass.
...
:meth`),Co=a("em"),Qt=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xt=n(" class method for the decoder."),er=i(),q=a("div"),b($e.$$.fragment),or=i(),K=a("p"),nr=n("The "),co=a("a"),tr=n("SpeechEncoderDecoderModel"),rr=n(" forward method, overrides the "),Fo=a("code"),ar=n("__call__"),sr=n(" special method."),dr=i(),b(ce.$$.fragment),cr=i(),Ao=a("p"),ir=n("Examples:"),lr=i(),b(je.$$.fragment),pr=i(),P=a("div"),b(qe.$$.fragment),hr=i(),Lo=a("p"),mr=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=a("code"),vr=n("model.train()"),br=n("."),yr=i(),Wo=a("p"),wr=n("Example:"),Er=i(),b(Pe.$$.fragment),cn=i(),X=a("h2"),ie=a("a"),Vo=a("span"),b(ze.$$.fragment),kr=i(),Oo=a("span"),Sr=n("FlaxSpeechEncoderDecoderModel"),ln=i(),f=a("div"),b(Ce.$$.fragment),Tr=i(),ee=a("p"),xr=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),Bo=a("code"),Dr=n("from_pretrained()"),Mr=n(`function and the decoder is loaded via
...
Tasks`),Cr=n(` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),Fr=i(),Le=a("p"),Ar=n("Additionally, in "),Ne=a("a"),Lr=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
checkpoints.`),ga=i(),Ko=a("p"),_a=n("Example:"),va=i(),b(Ue.$$.fragment),this.h()},l(r){const h=Ms('[data-svelte="svelte-1phssyn"]',document.head);p=s(h,"META",{name:!0,content:!0}),h.forEach(o),$=l(r),u=s(r,"H1",{class:!0});var He=d(u);T=s(He,"A",{id:!0,class:!0,href:!0});var Qo=d(T);F=s(Qo,"SPAN",{});var ba=d(F);y(x.$$.fragment,ba),ba.forEach(o),Qo.forEach(o),M=l(He),L=s(He,"SPAN",{});var ya=d(L);Dn=t(ya,"Speech Encoder Decoder Models"),ya.forEach(o),He.forEach(o),on=l(r),j=s(r,"P",{});var O=d(j);Mn=t(O,"The "),Ye=s(O,"A",{href:!0});var wa=d(Ye);$n=t(wa,"SpeechEncoderDecoderModel"),wa.forEach(o),jn=t(O,` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),wo=s(O,"EM",{});var Ea=d(wo);qn=t(Ea,"e.g."),Ea.forEach(o),Pn=l(O),Ze=s(O,"A",{href:!0});var ka=d(Ze);zn=t(ka,"Wav2Vec2"),ka.forEach(o),Cn=t(O,", "),Ke=s(O,"A",{href:!0});var Sa=d(Ke);Fn=t(Sa,"Hubert"),Sa.forEach(o),An=t(O,") and any pretrained autoregressive model as the decoder."),O.forEach(o),nn=l(r),N=s(r,"P",{});var ho=d(N);Ln=t(ho,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
Alexis Conneau.`),ho.forEach(o),tn=l(r),I=s(r,"P",{});var mo=d(I);On=t(mo,"An example of how to use a "),Qe=s(mo,"A",{href:!0});var Da=d(Qe);Bn=t(Da,"SpeechEncoderDecoderModel"),Da.forEach(o),Rn=t(mo,` for inference can be seen in
`),Xe=s(mo,"A",{href:!0});var Ma=d(Xe);Un=t(Ma,"Speech2Text2"),Ma.forEach(o),Hn=t(mo,"."),mo.forEach(o),rn=l(r),H=s(r,"H2",{class:!0});var hn=d(H);te=s(hn,"A",{id:!0,class:!0,href:!0});var $a=d(te);ko=s($a,"SPAN",{});var ja=d(ko);y(fe.$$.fragment,ja),ja.forEach(o),$a.forEach(o),Gn=l(hn),So=s(hn,"SPAN",{});var qa=d(So);Jn=t(qa,"SpeechEncoderDecoderConfig"),qa.forEach(o),hn.forEach(o),an=l(r),D=s(r,"DIV",{class:!0});var C=d(D);y(ue.$$.fragment,C),Yn=l(C),re=s(C,"P",{});var Xo=d(re);eo=s(Xo,"A",{href:!0});var Pa=d(eo);Zn=t(Pa,"SpeechEncoderDecoderConfig"),Pa.forEach(o),Kn=t(Xo,` is the configuration class to store the configuration of a
...
arguments, defining the encoder and decoder configs.`),Xo.forEach(o),et=l(C),G=s(C,"P",{});var fo=d(G);ot=t(fo,"Configuration objects inherit from "),no=s(fo,"A",{href:!0});var Ca=d(no);nt=t(Ca,"PretrainedConfig"),Ca.forEach(o),tt=t(fo,` and can be used to control the model outputs. Read the
documentation from `),to=s(fo,"A",{href:!0});var Fa=d(to);rt=t(Fa,"PretrainedConfig"),Fa.forEach(o),at=t(fo," for more information."),fo.forEach(o),st=l(C),To=s(C,"P",{});var Aa=d(To);dt=t(Aa,"Examples:"),Aa.forEach(o),ct=l(C),y(ge.$$.fragment,C),it=l(C),ae=s(C,"DIV",{class:!0});var mn=d(ae);y(_e.$$.fragment,mn),lt=l(mn),ve=s(mn,"P",{});var fn=d(ve);pt=t(fn,"Instantiate a "),ro=s(fn,"A",{href:!0});var La=d(ro);ht=t(La,"SpeechEncoderDecoderConfig"),La.forEach(o),mt=t(fn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),fn.forEach(o),mn.forEach(o),ft=l(C),se=s(C,"DIV",{class:!0});var un=d(se);y(be.$$.fragment,un),ut=l(un),J=s(un,"P",{});var uo=d(J);gt=t(uo,"Serializes this instance to a Python dictionary. Override the default "),xo=s(uo,"EM",{});var Na=d(xo);_t=t(Na,"to_dict()"),Na.forEach(o),vt=t(uo," from "),Do=s(uo,"EM",{});var Ia=d(Do);bt=t(Ia,"PretrainedConfig"),Ia.forEach(o),yt=t(uo,"."),uo.forEach(o),un.forEach(o),C.forEach(o),sn=l(r),Y=s(r,"H2",{class:!0});var gn=d(Y);de=s(gn,"A",{id:!0,class:!0,href:!0});var Wa=d(de);Mo=s(Wa,"SPAN",{});var Va=d(Mo);y(ye.$$.fragment,Va),Va.forEach(o),Wa.forEach(o),wt=l(gn),$o=s(gn,"SPAN",{});var Oa=d($o);Et=t(Oa,"SpeechEncoderDecoderModel"),Oa.forEach(o),gn.forEach(o),dn=l(r),m=s(r,"DIV",{class:!0});var _=d(m);y(we.$$.fragment,_),kt=l(_),Z=s(_,"P",{});var go=d(Z);St=t(go,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),jo=s(go,"CODE",{});var Ba=d(jo);Tt=t(Ba,"from_pretrained()"),Ba.forEach(o),xt=t(go,`function and the decoder is loaded via
`),qo=s(go,"CODE",{});var Ra=d(qo);Dt=t(Ra,"from_pretrained()"),Ra.forEach(o),Mt=t(go,`function. Cross-attention layers are automatically added to the decoder
...
Zhou, Wei Li, Peter J. Liu.`),_n.forEach(o),zt=l(_),Se=s(_,"P",{});var vn=d(Se);Ct=t(vn,"Additionally, in "),Te=s(vn,"A",{href:!0,rel:!0});var Ha=d(Te);Ft=t(Ha,`Large-Scale Self- and Semi-Supervised Learning for Speech
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bn.forEach(o),Bt=l(_),De=s(_,"P",{});var yn=d(De);Rt=t(yn,"This model is also a PyTorch "),Me=s(yn,"A",{href:!0,rel:!0});var Ya=d(Me);Ut=t(Ya,"torch.nn.Module"),Ya.forEach(o),Ht=t(yn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
:meth`),Co=s(Ge,"EM",{});var Qa=d(Co);Qt=t(Qa,"~transformers.AutoModelForCausalLM.from_pretrained"),Qa.forEach(o),Xt=t(Ge," class method for the decoder."),Ge.forEach(o),er=l(_),q=s(_,"DIV",{class:!0});var B=d(q);y($e.$$.fragment,B),or=l(B),K=s(B,"P",{});var _o=d(K);nr=t(_o,"The "),co=s(_o,"A",{href:!0});var Xa=d(co);tr=t(Xa,"SpeechEncoderDecoderModel"),Xa.forEach(o),rr=t(_o," forward method, overrides the "),Fo=s(_o,"CODE",{});var es=d(Fo);ar=t(es,"__call__"),es.forEach(o),sr=t(_o," special method."),_o.forEach(o),dr=l(B),y(ce.$$.fragment,B),cr=l(B),Ao=s(B,"P",{});var os=d(Ao);ir=t(os,"Examples:"),os.forEach(o),lr=l(B),y(je.$$.fragment,B),B.forEach(o),pr=l(_),P=s(_,"DIV",{class:!0});var R=d(P);y(qe.$$.fragment,R),hr=l(R),Lo=s(R,"P",{});var ns=d(Lo);mr=t(ns,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
Tasks`),ps.forEach(o),Cr=t(En,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),En.forEach(o),Fr=l(v),Le=s(v,"P",{});var kn=d(Le);Ar=t(kn,"Additionally, in "),Ne=s(kn,"A",{href:!0,rel:!0});var hs=d(Ne);Lr=t(hs,`Large-Scale Self- and Semi-Supervised Learning for Speech
