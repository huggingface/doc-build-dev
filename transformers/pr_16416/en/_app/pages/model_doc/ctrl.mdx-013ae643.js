...
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function tp(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
tensors in the first argument of the model call function: `),O=r(N,"CODE",{});var Oe=i(O);ve=s(Oe,"model(inputs)"),Oe.forEach(t),pe=s(N,"."),N.forEach(t),x=d(p),j=r(p,"P",{});var He=i(j);ee=s(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function op(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),Ce=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function sp(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ap(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),Ce=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function rp(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ip(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye,p,$,ie,Ae,me,N,qe,Oe,He,D,P,We,ze,K,Be,Pe,we,Ue,En,ma,fa,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,Ca,Ms,ct,Rt,qn,Xt,ya,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,Pa,pt,xa,tn,ja,Sa,on,Ia,Na,Da,Pn,Aa,Oa,Yt,Fs,ht,Mt,xn,Zt,Ha,jn,Wa,qs,Ne,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,Nn,Ya,Ps,$e,so,Za,Dn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,xe,lo,cr,mt,pr,rn,hr,ur,An,mr,fr,gr,Ft,_r,On,Tr,vr,co,xs,ft,qt,Hn,po,kr,Wn,br,js,Re,ho,Cr,Bn,yr,wr,uo,Lr,ln,$r,Rr,Mr,mo,Er,fo,Fr,qr,zr,je,go,Pr,gt,xr,dn,jr,Sr,Un,Ir,Nr,Dr,zt,Ar,Vn,Or,Hr,_o,Ss,_t,Pt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,pn,ai,ri,ii,bo,li,Co,di,ci,pi,B,yo,hi,Tt,ui,hn,mi,fi,Zn,gi,_i,Ti,xt,vi,es,ki,bi,wo,Ci,Lo,yi,ts,wi,Li,$o,$i,Ro,Ns,vt,jt,os,Mo,Ri,ns,Mi,Ds,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,Pi,xi,ji,qo,Si,zo,Ii,Ni,Di,St,Ai,Se,Po,Oi,kt,Hi,mn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,xo,As,bt,Nt,is,jo,Qi,ls,Yi,Os,ce,So,Zi,ds,el,tl,Io,ol,fn,nl,sl,al,No,rl,Do,il,ll,dl,Dt,cl,Ie,Ao,pl,Ct,hl,gn,ul,ml,cs,fl,gl,_l,At,Tl,ps,vl,kl,Oo,Hs,yt,Ot,hs,Ho,bl,us,Cl,Ws,X,Wo,yl,ms,wl,Ll,_n,Tn,$l,Rl,Ml,De,El,fs,Fl,ql,gs,zl,Pl,_s,xl,jl,Ts,Sl,Il,Nl,Bo,Dl,vn,Al,Ol,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,fe,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16416/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Fe({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16416/src/transformers/models/ctrl/modeling_ctrl.py#L353",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_16416/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16416/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),go=new Fe({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16416/src/transformers/models/ctrl/modeling_ctrl.py#L515",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16416/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),Po=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16416/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16416/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Dt=new $t({props:{$$slots:{default:[np]},$$scope:{ctx:J}}}),Ao=new Fe({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16416/src/transformers/models/ctrl/modeling_tf_ctrl.py#L633",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16416/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[ap]},$$scope:{ctx:J}}}),Go=new Fe({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16416/src/transformers/models/ctrl/modeling_tf_ctrl.py#L745",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),{c(){h=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),k(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),A=a("span"),k(Z.$$.fragment),Te=l(),O=a("span"),ve=n("Overview"),pe=l(),x=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ke=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
TensorFlow models accepts `),Pe=a("code"),we=n("past"),Ue=n(" as input. Using the "),En=a("code"),ma=n("past_key_values"),fa=n(` value prevents the model from re-computing
...
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Na=n(" for more information."),Da=l(),Pn=a("p"),Aa=n("Examples:"),Oa=l(),k(Yt.$$.fragment),Fs=l(),ht=a("h2"),Mt=a("a"),xn=a("span"),k(Zt.$$.fragment),Ha=l(),jn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Ne=a("div"),k(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
...
and behavior.`),dr=l(),xe=a("div"),k(lo.$$.fragment),cr=l(),mt=a("p"),pr=n("The "),rn=a("a"),hr=n("CTRLModel"),ur=n(" forward method, overrides the "),An=a("code"),mr=n("__call__"),fr=n(" special method."),gr=l(),k(Ft.$$.fragment),_r=l(),On=a("p"),Tr=n("Example:"),vr=l(),k(co.$$.fragment),xs=l(),ft=a("h2"),qt=a("a"),Hn=a("span"),k(po.$$.fragment),kr=l(),Wn=a("span"),br=n("CTRLLMHeadModel"),js=l(),Re=a("div"),k(ho.$$.fragment),Cr=l(),Bn=a("p"),yr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),k(yo.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(xt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),Ci=l(),k(Lo.$$.fragment),yi=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Ns=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ds=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),Pi=n("TFPreTrainedModel"),xi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ji=l(),qo=a("p"),Si=n("This model is also a "),zo=a("a"),Ii=n("tf.keras.Model"),Ni=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Di=l(),k(St.$$.fragment),Ai=l(),Se=a("div"),k(Po.$$.fragment),Oi=l(),kt=a("p"),Hi=n("The "),mn=a("a"),Wi=n("TFCTRLModel"),Bi=n(" forward method, overrides the "),as=a("code"),Ui=n("__call__"),Vi=n(" special method."),Gi=l(),k(It.$$.fragment),Ki=l(),rs=a("p"),Xi=n("Example:"),Ji=l(),k(xo.$$.fragment),As=l(),bt=a("h2"),Nt=a("a"),is=a("span"),k(jo.$$.fragment),Qi=l(),ls=a("span"),Yi=n("TFCTRLLMHeadModel"),Os=l(),ce=a("div"),k(So.$$.fragment),Zi=l(),ds=a("p"),el=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
TensorFlow models accepts `),Pe=r(Ze,"CODE",{});var gd=i(Pe);we=s(gd,"past"),gd.forEach(t),Ue=s(Ze," as input. Using the "),En=r(Ze,"CODE",{});var _d=i(En);ma=s(_d,"past_key_values"),_d.forEach(t),fa=s(Ze,` value prevents the model from re-computing
...
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
`),Qt=r(Ut,"A",{href:!0,rel:!0});var Rd=i(Qt);qa=s(Rd,"ctrl"),Rd.forEach(t),za=s(Ut," architecture from SalesForce."),Ut.forEach(t),Pa=d(et),pt=r(et,"P",{});var Cn=i(pt);xa=s(Cn,"Configuration objects inherit from "),tn=r(Cn,"A",{href:!0});var Md=i(tn);ja=s(Md,"PretrainedConfig"),Md.forEach(t),Sa=s(Cn,` and can be used to control the model outputs. Read the
documentation from `),on=r(Cn,"A",{href:!0});var Ed=i(on);Ia=s(Ed,"PretrainedConfig"),Ed.forEach(t),Na=s(Cn," for more information."),Cn.forEach(t),Da=d(et),Pn=r(et,"P",{});var Fd=i(Pn);Aa=s(Fd,"Examples:"),Fd.forEach(t),Oa=d(et),b(Yt.$$.fragment,et),et.forEach(t),Fs=d(o),ht=r(o,"H2",{class:!0});var Ks=i(ht);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);xn=r(qd,"SPAN",{});var zd=i(xn);b(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),jn=r(Ks,"SPAN",{});var Pd=i(jn);Wa=s(Pd,"CTRLTokenizer"),Pd.forEach(t),Ks.forEach(t),qs=d(o),Ne=r(o,"DIV",{class:!0});var Vt=i(Ne);b(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var xd=i(Sn);Ua=s(xd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),xd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var jd=i(nn);Ka=s(jd,"PreTrainedTokenizer"),jd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),xe=r(tt,"DIV",{class:!0});var ot=i(xe);b(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var yn=i(mt);pr=s(yn,"The "),rn=r(yn,"A",{href:!0});var Wd=i(rn);hr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(yn," forward method, overrides the "),An=r(yn,"CODE",{});var Bd=i(An);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(yn," special method."),yn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),On=r(ot,"P",{});var Ud=i(On);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),xs=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(po.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(ho.$$.fragment,nt),Cr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);yr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(t),pi=d(at),B=r(at,"DIV",{class:!0});var le=i(B);b(yo.$$.fragment,le),hi=d(le),Tt=r(le,"P",{});var Ln=i(Tt);ui=s(Ln,"The "),hn=r(Ln,"A",{href:!0});var pc=i(hn);mi=s(pc,"CTRLForSequenceClassification"),pc.forEach(t),fi=s(Ln," forward method, overrides the "),Zn=r(Ln,"CODE",{});var hc=i(Zn);gi=s(hc,"__call__"),hc.forEach(t),_i=s(Ln," special method."),Ln.forEach(t),Ti=d(le),b(xt.$$.fragment,le),vi=d(le),es=r(le,"P",{});var uc=i(es);ki=s(uc,"Example of single-label classification:"),uc.forEach(t),bi=d(le),b(wo.$$.fragment,le),Ci=d(le),b(Lo.$$.fragment,le),yi=d(le),ts=r(le,"P",{});var mc=i(ts);wi=s(mc,"Example of multi-label classification:"),mc.forEach(t),Li=d(le),b($o.$$.fragment,le),$i=d(le),b(Ro.$$.fragment,le),le.forEach(t),at.forEach(t),Ns=d(o),vt=r(o,"H2",{class:!0});var aa=i(vt);jt=r(aa,"A",{id:!0,class:!0,href:!0});var fc=i(jt);os=r(fc,"SPAN",{});var gc=i(os);b(Mo.$$.fragment,gc),gc.forEach(t),fc.forEach(t),Ri=d(aa),ns=r(aa,"SPAN",{});var _c=i(ns);Mi=s(_c,"TFCTRLModel"),_c.forEach(t),aa.forEach(t),Ds=d(o),de=r(o,"DIV",{class:!0});var Ge=i(de);b(Eo.$$.fragment,Ge),Ei=d(Ge),ss=r(Ge,"P",{});var Tc=i(ss);Fi=s(Tc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Tc.forEach(t),qi=d(Ge),Fo=r(Ge,"P",{});var ra=i(Fo);zi=s(ra,"This model inherits from "),un=r(ra,"A",{href:!0});var vc=i(un);Pi=s(vc,"TFPreTrainedModel"),vc.forEach(t),xi=s(ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ua.forEach(t),Vl=d(ge),b(Ht.$$.fragment,ge),Gl=d(ge),fe=r(ge,"DIV",{class:!0});var Xe=i(fe);b(Go.$$.fragment,Xe),Kl=d(Xe),wt=r(Xe,"P",{});var Mn=i(wt);Xl=s(Mn,"The "),kn=r(Mn,"A",{href:!0});var Bc=i(kn);Jl=s(Bc,"TFCTRLForSequenceClassification"),Bc.forEach(t),Ql=s(Mn," forward method, overrides the "),vs=r(Mn,"CODE",{});var Uc=i(vs);Yl=s(Uc,"__call__"),Uc.forEach(t),Zl=s(Mn," special method."),Mn.forEach(t),ed=d(Xe),b(Wt.$$.fragment,Xe),td=d(Xe),ks=r(Xe,"P",{});var Vc=i(ks);od=s(Vc,"Example:"),Vc.forEach(t),nd=d(Xe),b(Ko.$$.fragment,Xe),sd=d(Xe),b(Xo.$$.fragment,Xe),Xe.forEach(t),ge.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(lp)),c(g,"id","ctrl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#ctrl"),c(f,"class","relative group"),c(Q,"id","overview"),c(Q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Q,"href","#overview"),c(R,"class","relative group"),c(ee,"href","https://arxiv.org/abs/1909.05858"),c(ee,"rel","nofollow"),c(oe,"href","https://github.com/salesforce/ctrl"),c(oe,"rel","nofollow"),c(Yo,"href","model_doc/ctrl#transformers.CTRLModel.forward"),c(Gt,"href","https://huggingface.co/keskarnitishr"),c(Gt,"rel","nofollow"),c(Kt,"href","https://github.com/salesforce/ctrl"),c(Kt,"rel","nofollow"),c(Rt,"id","transformers.CTRLConfig"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.CTRLConfig"),c(ct,"class","relative group"),c(Zo,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLModel"),c(en,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Qt,"href","https://huggingface.co/ctrl"),c(Qt,"rel","nofollow"),c(tn,"href","/docs/transformers/pr_16416/en/main_classes/configuration#transformers.PretrainedConfig"),c(on,"href","/docs/transformers/pr_16416/en/main_classes/configuration#transformers.PretrainedConfig"),c(Le,"class","docstring"),c(Mt,"id","transformers.CTRLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.CTRLTokenizer"),c(ht,"class","relative group"),c(nn,"href","/docs/transformers/pr_16416/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(sn,"class","docstring"),c(Ne,"class","docstring"),c(Et,"id","transformers.CTRLModel"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.CTRLModel"),c(ut,"class","relative group"),c(an,"href","/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel"),c(io,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(io,"rel","nofollow"),c(rn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLModel"),c(xe,"class","docstring"),c($e,"class","docstring"),c(qt,"id","transformers.CTRLLMHeadModel"),c(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qt,"href","#transformers.CTRLLMHeadModel"),c(ft,"class","relative group"),c(ln,"href","/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel"),c(fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fo,"rel","nofollow"),c(dn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLLMHeadModel"),c(je,"class","docstring"),c(Re,"class","docstring"),c(Pt,"id","transformers.CTRLForSequenceClassification"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.CTRLForSequenceClassification"),c(_t,"class","relative group"),c(cn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(pn,"href","/docs/transformers/pr_16416/en/main_classes/model#transformers.PreTrainedModel"),c(Co,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Co,"rel","nofollow"),c(hn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(B,"class","docstring"),c(Me,"class","docstring"),c(jt,"id","transformers.TFCTRLModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.TFCTRLModel"),c(vt,"class","relative group"),c(un,"href","/docs/transformers/pr_16416/en/main_classes/model#transformers.TFPreTrainedModel"),c(zo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(zo,"rel","nofollow"),c(mn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Se,"class","docstring"),c(de,"class","docstring"),c(Nt,"id","transformers.TFCTRLLMHeadModel"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.TFCTRLLMHeadModel"),c(bt,"class","relative group"),c(fn,"href","/docs/transformers/pr_16416/en/main_classes/model#transformers.TFPreTrainedModel"),c(Do,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Do,"rel","nofollow"),c(gn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.TFCTRLLMHeadModel"),c(Ie,"class","docstring"),c(ce,"class","docstring"),c(Ot,"id","transformers.TFCTRLForSequenceClassification"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.TFCTRLForSequenceClassification"),c(yt,"class","relative group"),c(Tn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(vn,"href","/docs/transformers/pr_16416/en/main_classes/model#transformers.TFPreTrainedModel"),c(Vo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Vo,"rel","nofollow"),c(kn,"href","/docs/transformers/pr_16416/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(fe,"class","docstring"),c(X,"class","docstring")},m(o,m){e(document.head,h),u(o,E,m),u(o,f,m),e(f,g),e(g,v),C(T,v,null),e(f,_),e(f,M),e(M,_e),u(o,Y,m),u(o,R,m),e(R,Q),e(Q,A),C(Z,A,null),e(R,Te),e(R,O),e(O,ve),u(o,pe,m),u(o,x,m),e(x,j),e(x,ee),e(ee,ne),e(x,F),e(x,q),e(q,ke),e(x,U),u(o,he,m),u(o,se,m),e(se,V),u(o,ue,m),u(o,ae,m),e(ae,z),e(z,be),u(o,H,m),u(o,re,m),e(re,Ce),u(o,W,m),u(o,S,m),e(S,te),e(te,I),e(te,oe),e(oe,G),e(te,ye),e(S,p),e(S,$),e($,ie),e(S,Ae),e(S,me),e(me,N),e(me,qe),e(qe,Oe),e(me,He),e(S,D),e(S,P),e(P,We),e(P,ze),e(ze,K),e(P,Be),e(P,Pe),e(Pe,we),e(P,Ue),e(P,En),e(En,ma),e(P,fa),e(P,Yo),e(Yo,Fn),e(Fn,ga),e(P,_a),u(o,Rs,m),u(o,Ye,m),e(Ye,Ta),e(Ye,Gt),e(Gt,va),e(Ye,ka),e(Ye,Kt),e(Kt,ba),e(Ye,Ca),u(o,Ms,m),u(o,ct,m),e(ct,Rt),e(Rt,qn),C(Xt,qn,null),e(ct,ya),e(ct,zn),e(zn,wa),u(o,Es,m),u(o,Le,m),C(Jt,Le,null),e(Le,La),e(Le,Je),e(Je,$a),e(Je,Zo),e(Zo,Ra),e(Je,Ma),e(Je,en),e(en,Ea),e(Je,Fa),e(Je,Qt),e(Qt,qa),e(Je,za),e(Le,Pa),e(Le,pt),e(pt,xa),e(pt,tn),e(tn,ja),e(pt,Sa),e(pt,on),e(on,Ia),e(pt,Na),e(Le,Da),e(Le,Pn),e(Pn,Aa),e(Le,Oa),C(Yt,Le,null),u(o,Fs,m),u(o,ht,m),e(ht,Mt),e(Mt,xn),C(Zt,xn,null),e(ht,Ha),e(ht,jn),e(jn,Wa),u(o,qs,m),u(o,Ne,m),C(eo,Ne,null),e(Ne,Ba),e(Ne,Sn),e(Sn,Ua),e(Ne,Va),e(Ne,to),e(to,Ga),e(to,nn),e(nn,Ka),e(to,Xa),e(Ne,Ja),e(Ne,sn),C(oo,sn,null),u(o,zs,m),u(o,ut,m),e(ut,Et),e(Et,In),C(no,In,null),e(ut,Qa),e(ut,Nn),e(Nn,Ya),u(o,Ps,m),u(o,$e,m),C(so,$e,null),e($e,Za),e($e,Dn),e(Dn,er),e($e,tr),e($e,ao),e(ao,or),e(ao,an),e(an,nr),e(ao,sr),e($e,ar),e($e,ro),e(ro,rr),e(ro,io),e(io,ir),e(ro,lr),e($e,dr),e($e,xe),C(lo,xe,null),e(xe,cr),e(xe,mt),e(mt,pr),e(mt,rn),e(rn,hr),e(mt,ur),e(mt,An),e(An,mr),e(mt,fr),e(xe,gr),C(Ft,xe,null),e(xe,_r),e(xe,On),e(On,Tr),e(xe,vr),C(co,xe,null),u(o,xs,m),u(o,ft,m),e(ft,qt),e(qt,Hn),C(po,Hn,null),e(ft,kr),e(ft,Wn),e(Wn,br),u(o,js,m),u(o,Re,m),C(ho,Re,null),e(Re,Cr),e(Re,Bn),e(Bn,yr),e(Re,wr),e(Re,uo),e(uo,Lr),e(uo,ln),e(ln,$r),e(uo,Rr),e(Re,Mr),e(Re,mo),e(mo,Er),e(mo,fo),e(fo,Fr),e(mo,qr),e(Re,zr),e(Re,je),C(go,je,null),e(je,Pr),e(je,gt),e(gt,xr),e(gt,dn),e(dn,jr),e(gt,Sr),e(gt,Un),e(Un,Ir),e(gt,Nr),e(je,Dr),C(zt,je,null),e(je,Ar),e(je,Vn),e(Vn,Or),e(je,Hr),C(_o,je,null),u(o,Ss,m),u(o,_t,m),e(_t,Pt),e(Pt,Gn),C(To,Gn,null),e(_t,Wr),e(_t,Kn),e(Kn,Br),u(o,Is,m),u(o,Me,m),C(vo,Me,null),e(Me,Ur),e(Me,Ee),e(Ee,Vr),e(Ee,cn),e(cn,Gr),e(Ee,Kr),e(Ee,Xn),e(Xn,Xr),e(Ee,Jr),e(Ee,Jn),e(Jn,Qr),e(Ee,Yr),e(Ee,Qn),e(Qn,Zr),e(Ee,ei),e(Ee,Yn),e(Yn,ti),e(Ee,oi),e(Me,ni),e(Me,ko),e(ko,si),e(ko,pn),e(pn,ai),e(ko,ri),e(Me,ii),e(Me,bo),e(bo,li),e(bo,Co),e(Co,di),e(bo,ci),e(Me,pi),e(Me,B),C(yo,B,null),e(B,hi),e(B,Tt),e(Tt,ui),e(Tt,hn),e(hn,mi),e(Tt,fi),e(Tt,Zn),e(Zn,gi),e(Tt,_i),e(B,Ti),C(xt,B,null),e(B,vi),e(B,es),e(es,ki),e(B,bi),C(wo,B,null),e(B,Ci),C(Lo,B,null),e(B,yi),e(B,ts),e(ts,wi),e(B,Li),C($o,B,null),e(B,$i),C(Ro,B,null),u(o,Ns,m),u(o,vt,m),e(vt,jt),e(jt,os),C(Mo,os,null),e(vt,Ri),e(vt,ns),e(ns,Mi),u(o,Ds,m),u(o,de,m),C(Eo,de,null),e(de,Ei),e(de,ss),e(ss,Fi),e(de,qi),e(de,Fo),e(Fo,zi),e(Fo,un),e(un,Pi),e(Fo,xi),e(de,ji),e(de,qo),e(qo,Si),e(qo,zo),e(zo,Ii),e(qo,Ni),e(de,Di),C(St,de,null),e(de,Ai),e(de,Se),C(Po,Se,null),e(Se,Oi),e(Se,kt),e(kt,Hi),e(kt,mn),e(mn,Wi),e(kt,Bi),e(kt,as),e(as,Ui),e(kt,Vi),e(Se,Gi),C(It,Se,null),e(Se,Ki),e(Se,rs),e(rs,Xi),e(Se,Ji),C(xo,Se,null),u(o,As,m),u(o,bt,m),e(bt,Nt),e(Nt,is),C(jo,is,null),e(bt,Qi),e(bt,ls),e(ls,Yi),u(o,Os,m),u(o,ce,m),C(So,ce,null),e(ce,Zi),e(ce,ds),e(ds,el),e(ce,tl),e(ce,Io),e(Io,ol),e(Io,fn),e(fn,nl),e(Io,sl),e(ce,al),e(ce,No),e(No,rl),e(No,Do),e(Do,il),e(No,ll),e(ce,dl),C(Dt,ce,null),e(ce,cl),e(ce,Ie),C(Ao,Ie,null),e(Ie,pl),e(Ie,Ct),e(Ct,hl),e(Ct,gn),e(gn,ul),e(Ct,ml),e(Ct,cs),e(cs,fl),e(Ct,gl),e(Ie,_l),C(At,Ie,null),e(Ie,Tl),e(Ie,ps),e(ps,vl),e(Ie,kl),C(Oo,Ie,null),u(o,Hs,m),u(o,yt,m),e(yt,Ot),e(Ot,hs),C(Ho,hs,null),e(yt,bl),e(yt,us),e(us,Cl),u(o,Ws,m),u(o,X,m),C(Wo,X,null),e(X,yl),e(X,ms),e(ms,wl),e(X,Ll),e(X,_n),e(_n,Tn),e(Tn,$l),e(_n,Rl),e(X,Ml),e(X,De),e(De,El),e(De,fs),e(fs,Fl),e(De,ql),e(De,gs),e(gs,zl),e(De,Pl),e(De,_s),e(_s,xl),e(De,jl),e(De,Ts),e(Ts,Sl),e(De,Il),e(X,Nl),e(X,Bo),e(Bo,Dl),e(Bo,vn),e(vn,Al),e(Bo,Ol),e(X,Hl),e(X,Uo),e(Uo,Wl),e(Uo,Vo),e(Vo,Bl),e(Uo,Ul),e(X,Vl),C(Ht,X,null),e(X,Gl),e(X,fe),C(Go,fe,null),e(fe,Kl),e(fe,wt),e(wt,Xl),e(wt,kn),e(kn,Jl),e(wt,Ql),e(wt,vs),e(vs,Yl),e(wt,Zl),e(fe,ed),C(Wt,fe,null),e(fe,td),e(fe,ks),e(ks,od),e(fe,nd),C(Ko,fe,null),e(fe,sd),C(Xo,fe,null),Bs=!0},p(o,[m]){const Jo={};m&2&&(Jo.$$scope={dirty:m,ctx:o}),Ft.$set(Jo);const bs={};m&2&&(bs.$$scope={dirty:m,ctx:o}),zt.$set(bs);const Cs={};m&2&&(Cs.$$scope={dirty:m,ctx:o}),xt.$set(Cs);const ys={};m&2&&(ys.$$scope={dirty:m,ctx:o}),St.$set(ys);const Qo={};m&2&&(Qo.$$scope={dirty:m,ctx:o}),It.$set(Qo);const ws={};m&2&&(ws.$$scope={dirty:m,ctx:o}),Dt.$set(ws);const Ls={};m&2&&(Ls.$$scope={dirty:m,ctx:o}),At.$set(Ls);const $s={};m&2&&($s.$$scope={dirty:m,ctx:o}),Ht.$set($s);const Lt={};m&2&&(Lt.$$scope={dirty:m,ctx:o}),Wt.$set(Lt)},i(o){Bs||(y(T.$$.fragment,o),y(Z.$$.fragment,o),y(Xt.$$.fragment,o),y(Jt.$$.fragment,o),y(Yt.$$.fragment,o),y(Zt.$$.fragment,o),y(eo.$$.fragment,o),y(oo.$$.fragment,o),y(no.$$.fragment,o),y(so.$$.fragment,o),y(lo.$$.fragment,o),y(Ft.$$.fragment,o),y(co.$$.fragment,o),y(po.$$.fragment,o),y(ho.$$.fragment,o),y(go.$$.fragment,o),y(zt.$$.fragment,o),y(_o.$$.fragment,o),y(To.$$.fragment,o),y(vo.$$.fragment,o),y(yo.$$.fragment,o),y(xt.$$.fragment,o),y(wo.$$.fragment,o),y(Lo.$$.fragment,o),y($o.$$.fragment,o),y(Ro.$$.fragment,o),y(Mo.$$.fragment,o),y(Eo.$$.fragment,o),y(St.$$.fragment,o),y(Po.$$.fragment,o),y(It.$$.fragment,o),y(xo.$$.fragment,o),y(jo.$$.fragment,o),y(So.$$.fragment,o),y(Dt.$$.fragment,o),y(Ao.$$.fragment,o),y(At.$$.fragment,o),y(Oo.$$.fragment,o),y(Ho.$$.fragment,o),y(Wo.$$.fragment,o),y(Ht.$$.fragment,o),y(Go.$$.fragment,o),y(Wt.$$.fragment,o),y(Ko.$$.fragment,o),y(Xo.$$.fragment,o),Bs=!0)},o(o){w(T.$$.fragment,o),w(Z.$$.fragment,o),w(Xt.$$.fragment,o),w(Jt.$$.fragment,o),w(Yt.$$.fragment,o),w(Zt.$$.fragment,o),w(eo.$$.fragment,o),w(oo.$$.fragment,o),w(no.$$.fragment,o),w(so.$$.fragment,o),w(lo.$$.fragment,o),w(Ft.$$.fragment,o),w(co.$$.fragment,o),w(po.$$.fragment,o),w(ho.$$.fragment,o),w(go.$$.fragment,o),w(zt.$$.fragment,o),w(_o.$$.fragment,o),w(To.$$.fragment,o),w(vo.$$.fragment,o),w(yo.$$.fragment,o),w(xt.$$.fragment,o),w(wo.$$.fragment,o),w(Lo.$$.fragment,o),w($o.$$.fragment,o),w(Ro.$$.fragment,o),w(Mo.$$.fragment,o),w(Eo.$$.fragment,o),w(St.$$.fragment,o),w(Po.$$.fragment,o),w(It.$$.fragment,o),w(xo.$$.fragment,o),w(jo.$$.fragment,o),w(So.$$.fragment,o),w(Dt.$$.fragment,o),w(Ao.$$.fragment,o),w(At.$$.fragment,o),w(Oo.$$.fragment,o),w(Ho.$$.fragment,o),w(Wo.$$.fragment,o),w(Ht.$$.fragment,o),w(Go.$$.fragment,o),w(Wt.$$.fragment,o),w(Ko.$$.fragment,o),w(Xo.$$.fragment,o),Bs=!1},d(o){t(h),o&&t(E),o&&t(f),L(T),o&&t(Y),o&&t(R),L(Z),o&&t(pe),o&&t(x),o&&t(he),o&&t(se),o&&t(ue),o&&t(ae),o&&t(H),o&&t(re),o&&t(W),o&&t(S),o&&t(Rs),o&&t(Ye),o&&t(Ms),o&&t(ct),L(Xt),o&&t(Es),o&&t(Le),L(Jt),L(Yt),o&&t(Fs),o&&t(ht),L(Zt),o&&t(qs),o&&t(Ne),L(eo),L(oo),o&&t(zs),o&&t(ut),L(no),o&&t(Ps),o&&t($e),L(so),L(lo),L(Ft),L(co),o&&t(xs),o&&t(ft),L(po),o&&t(js),o&&t(Re),L(ho),L(go),L(zt),L(_o),o&&t(Ss),o&&t(_t),L(To),o&&t(Is),o&&t(Me),L(vo),L(yo),L(xt),L(wo),L(Lo),L($o),L(Ro),o&&t(Ns),o&&t(vt),L(Mo),o&&t(Ds),o&&t(de),L(Eo),L(St),L(Po),L(It),L(xo),o&&t(As),o&&t(bt),L(jo),o&&t(Os),o&&t(ce),L(So),L(Dt),L(Ao),L(At),L(Oo),o&&t(Hs),o&&t(yt),L(Ho),o&&t(Ws),o&&t(X),L(Wo),L(Ht),L(Go),L(Wt),L(Ko),L(Xo)}}}const lp={local:"ctrl",sections:[{local:"overview",title:"Overview"},{local:"transformers.CTRLConfig",title:"CTRLConfig"},{local:"transformers.CTRLTokenizer",title:"CTRLTokenizer"},{local:"transformers.CTRLModel",title:"CTRLModel"},{local:"transformers.CTRLLMHeadModel",title:"CTRLLMHeadModel"},{local:"transformers.CTRLForSequenceClassification",title:"CTRLForSequenceClassification"},{local:"transformers.TFCTRLModel",title:"TFCTRLModel"},{local:"transformers.TFCTRLLMHeadModel",title:"TFCTRLLMHeadModel"},{local:"transformers.TFCTRLForSequenceClassification",title:"TFCTRLForSequenceClassification"}],title:"CTRL"};function dp(J){return Qc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class fp extends Gc{constructor(h){super();Kc(this,h,dp,ip,Xc,{})}}export{fp as default,lp as metadata};
