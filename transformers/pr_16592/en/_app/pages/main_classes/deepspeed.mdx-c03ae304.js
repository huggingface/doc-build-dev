...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
won\u2019t be possible on a single GPU.`),Yj=u(),qt=o("p"),o5=a("\u{1F917} Transformers integrates "),oo=o("a"),l5=a("DeepSpeed"),r5=a(" via 2 options:"),Kj=u(),$t=o("ol"),lo=o("li"),p5=a("Integration of the core DeepSpeed features via "),Lp=o("a"),i5=a("Trainer"),u5=a(`. This is an everything-done-for-you type
...
yourself, core functionality functions like `),pf=o("code"),m5=a("from_pretrained"),_5=a(" and "),uf=o("code"),v5=a("from_config"),j5=a(` include integration of essential
parts of DeepSpeed like `),cf=o("code"),g5=a("zero.Init"),w5=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=o("a"),y5=a("deepspeed-non-trainer-integration"),b5=a("."),Jj=u(),Np=o("p"),E5=a("What is integrated:"),Xj=u(),Hp=o("p"),q5=a("Training:"),Qj=u(),Bp=o("ol"),hf=o("li"),$5=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),eg=u(),Wp=o("p"),k5=a("Inference:"),sg=u(),Fp=o("ol"),ro=o("li"),P5=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),$s=o("h2"),kt=o("a"),ff=o("span"),f(po.$$.fragment),T5=u(),df=o("span"),A5=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),ks=o("h3"),Pt=o("a"),mf=o("span"),f(io.$$.fragment),S5=u(),_f=o("span"),C5=a("Installation"),rg=u(),Xp=o("p"),x5=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R5=a("or via "),vf=o("code"),I5=a("transformers"),U5=a("\u2019 "),jf=o("code"),G5=a("extras"),L5=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M5=a("or find more details on "),ho=o("a"),Z5=a("the DeepSpeed\u2019s GitHub page"),N5=a(` and
`),fo=o("a"),H5=a("advanced install"),B5=a("."),hg=u(),Dt=o("p"),W5=a("If you\u2019re still struggling with the build, first make sure to read "),Qp=o("a"),F5=a("zero-install-notes"),V5=a("."),fg=u(),ei=o("p"),Y5=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),dg=u(),si=o("p"),K5=a("To make a local build for DeepSpeed:"),mg=u(),f(mo.$$.fragment),_g=u(),Re=o("p"),J5=a("If you intend to use NVMe offload you will also need to include "),gf=o("code"),X5=a("DS_BUILD_AIO=1"),Q5=a(` in the instructions above (and also
install `),wf=o("em"),e$=a("libaio-dev"),s$=a(" system-wide)."),vg=u(),zt=o("p"),t$=a("Edit "),yf=o("code"),a$=a("TORCH_CUDA_ARCH_LIST"),n$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),jg=u(),f(_o.$$.fragment),gg=u(),Pe=o("p"),o$=a("So if you get "),bf=o("code"),l$=a("8, 6"),r$=a(", then use "),Ef=o("code"),p$=a('TORCH_CUDA_ARCH_LIST="8.6"'),i$=a(`. If you have multiple different cards, you can list all
of them like so `),qf=o("code"),u$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),wg=u(),ti=o("p"),c$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),yg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h$=a("it will generate something like "),$f=o("code"),f$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d$=a(` which now you can install
as `),kf=o("code"),m$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_$=a(" locally or on any other machine."),Eg=u(),Ot=o("p"),v$=a("Again, remember to ensure to adjust "),Pf=o("code"),j$=a("TORCH_CUDA_ARCH_LIST"),g$=a(" to the target architectures."),qg=u(),Ue=o("p"),w$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Df=o("strong"),y$=a("Compute Capabilities"),b$=a(` (same as arch in this
context) `),jo=o("a"),E$=a("here"),q$=a("."),$g=u(),ai=o("p"),$$=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(wo.$$.fragment),zg=u(),oi=o("p"),P$=a("If the output is:"),Og=u(),f(yo.$$.fragment),Tg=u(),Tt=o("p"),D$=a("then you know that this card\u2019s arch is "),zf=o("code"),z$=a("8.6"),O$=a("."),Ag=u(),At=o("p"),T$=a("You can also leave "),Of=o("code"),A$=a("TORCH_CUDA_ARCH_LIST"),S$=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Sg=u(),St=o("p"),C$=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=o("a"),x$=a("Deepspeed"),R$=a(","),Cg=u(),li=o("a"),xg=u(),Ps=o("h3"),Ct=o("a"),Tf=o("span"),f(Eo.$$.fragment),I$=u(),Af=o("span"),U$=a("Deployment with multiple GPUs"),Rg=u(),xt=o("p"),G$=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L$=a("Trainer"),M$=a(` command line arguments as
following:`),Ig=u(),Rt=o("ol"),Ds=o("li"),Z$=a("replace "),Sf=o("code"),N$=a("python -m torch.distributed.launch"),H$=a(" with "),Cf=o("code"),B$=a("deepspeed"),W$=a("."),F$=u(),De=o("li"),V$=a("add a new argument "),xf=o("code"),Y$=a("--deepspeed ds_config.json"),K$=a(", where "),Rf=o("code"),J$=a("ds_config.json"),X$=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q$=a("here"),e4=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s4=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t4=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a4=a("Unlike, "),If=o("code"),n4=a("torch.distributed.launch"),o4=a(" where you have to specify how many GPUs to use with "),Uf=o("code"),l4=a("--nproc_per_node"),r4=a(`, with the
`),Gf=o("code"),p4=a("deepspeed"),i4=a(" launcher you don\u2019t have to use the corresponding "),Lf=o("code"),u4=a("--num_gpus"),c4=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=o("a"),h4=a("here"),f4=a("."),Ng=u(),ne=o("p"),d4=a("In fact, you can continue using "),Mf=o("code"),m4=a("-m torch.distributed.launch"),_4=a(` with DeepSpeed as long as you don\u2019t need to use
`),Zf=o("code"),v4=a("deepspeed"),j4=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Nf=o("code"),g4=a("deepspeed"),w4=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Hg=u(),It=o("p"),y4=a("Here is an example of running "),Hf=o("code"),b4=a("run_translation.py"),E4=a(" under DeepSpeed deploying all available GPUs:"),Bg=u(),f(Do.$$.fragment),Wg=u(),Ut=o("p"),q4=a("Note that in the DeepSpeed documentation you are likely to see "),Bf=o("code"),$4=a("--deepspeed --deepspeed_config ds_config.json"),k4=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Fg=u(),Gt=o("p"),P4=a("For some practical usage examples, please, see this "),zo=o("a"),D4=a("post"),z4=a("."),Vg=u(),ui=o("a"),Yg=u(),zs=o("h3"),Lt=o("a"),Wf=o("span"),f(Oo.$$.fragment),O4=u(),Ff=o("span"),T4=a("Deployment with one GPU"),Kg=u(),Mt=o("p"),A4=a("To deploy DeepSpeed with one GPU adjust the "),ci=o("a"),S4=a("Trainer"),C4=a(" command line arguments as follows:"),Jg=u(),f(To.$$.fragment),Xg=u(),Ge=o("p"),x4=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Vf=o("code"),R4=a("--num_gpus=1"),I4=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=o("a"),U4=a("documentation"),G4=a(" discusses the launcher options."),Qg=u(),hi=o("p"),L4=a("Why would you want to use DeepSpeed with just one GPU?"),ew=u(),Zt=o("ol"),Yf=o("li"),M4=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),Z4=u(),Kf=o("li"),N4=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
...
find more details in the discussion below.`),nw=u(),Nt=o("p"),W4=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F4=a("post"),V4=a("."),ow=u(),mi=o("p"),Y4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K4=a("Notes:"),rw=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=o("code"),X4=a("CUDA_VISIBLE_DEVICES"),Q4=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e9=u(),f(Ro.$$.fragment),s9=u(),Xf=o("p"),t9=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pw=u(),ji=o("a"),iw=u(),Ts=o("h3"),Ht=o("a"),Qf=o("span"),f(Io.$$.fragment),a9=u(),ed=o("span"),n9=a("Deployment in Notebooks"),uw=u(),Bt=o("p"),o9=a("The problem with running notebook cells as a script is that there is no normal "),sd=o("code"),l9=a("deepspeed"),r9=a(` launcher to rely on, so
under certain setups we have to emulate it.`),cw=u(),gi=o("p"),p9=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),hw=u(),f(Uo.$$.fragment),fw=u(),Wt=o("p"),i9=a("Note: "),td=o("code"),u9=a("..."),c9=a(" stands for the normal arguments that you\u2019d pass to the functions."),dw=u(),wi=o("p"),h9=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
...
cell with:`),_w=u(),f(Go.$$.fragment),vw=u(),Le=o("p"),d9=a("If the training script is in a normal file and not in the notebook cells, you can launch "),ad=o("code"),m9=a("deepspeed"),_9=a(` normally via
shell from a cell. For example, to use `),nd=o("code"),v9=a("run_translation.py"),j9=a(" you would launch it with:"),jw=u(),f(Lo.$$.fragment),gw=u(),Ft=o("p"),g9=a("or with "),od=o("code"),w9=a("%%bash"),y9=a(" magic, where you can write a multi-line code for the shell program to run:"),ww=u(),f(Mo.$$.fragment),yw=u(),bi=o("p"),b9=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),bw=u(),Vt=o("p"),E9=a("Note: While "),ld=o("code"),q9=a("%%bash"),$9=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Ew=u(),Ei=o("a"),qw=u(),As=o("h3"),Yt=o("a"),rd=o("span"),f(Zo.$$.fragment),k9=u(),pd=o("span"),P9=a("Configuration"),$w=u(),Kt=o("p"),D9=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=o("a"),z9=a("following documentation"),O9=a("."),kw=u(),Jt=o("p"),T9=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=o("a"),A9=a(`the DeepSpeedExamples
repo`),S9=a(":"),Pw=u(),f(Bo.$$.fragment),Dw=u(),Xt=o("p"),C9=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=o("code"),x9=a(".json"),R9=a(" files with:"),zw=u(),f(Wo.$$.fragment),Ow=u(),Qt=o("p"),I9=a("Some more examples are to be found in the "),Fo=o("a"),U9=a("main repo"),G9=a(" as well."),Tw=u(),qi=o("p"),L9=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
...
including optimizer states cpu offload, uses `),ud=o("code"),Z9=a("AdamW"),N9=a(" optimizer and "),cd=o("code"),H9=a("WarmupLR"),B9=a(` scheduler and will enable mixed
precision training if `),hd=o("code"),W9=a("--fp16"),F9=a(" is passed:"),Sw=u(),f(Vo.$$.fragment),Cw=u(),ea=o("p"),V9=a("When you execute the program, DeepSpeed will log the configuration it received from the "),$i=o("a"),Y9=a("Trainer"),K9=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Ss=o("h3"),sa=o("a"),fd=o("span"),f(Yo.$$.fragment),J9=u(),dd=o("span"),X9=a("Passing Configuration"),Iw=u(),G=o("p"),Q9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
the file system before passing it to `),zi=o("a"),p8=a("TrainingArguments"),i8=a("."),Uw=u(),Oi=o("p"),u8=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c8=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),Cs=o("h3"),ta=o("a"),vd=o("span"),f(Xo.$$.fragment),h8=u(),jd=o("span"),f8=a("Shared Configuration"),Hw=u(),f(aa.$$.fragment),Bw=u(),Me=o("p"),d8=a("Some configuration values are required by both the "),Si=o("a"),m8=a("Trainer"),_8=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v8=a("Trainer"),j8=a(" command line arguments."),Ww=u(),na=o("p"),g8=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),w8=a("Trainer"),y8=a(` do the majority
of configuration for you.`),Fw=u(),Ze=o("p"),b8=a("Therefore, in the rest of this guide you will find a special configuration value: "),gd=o("code"),E8=a("auto"),q8=a(`, which when set will be
...
your needs.`),Yw=u(),oa=o("p"),D8=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z8=a("TrainingArguments"),O8=a(" based on that. The steps are:"),Kw=u(),la=o("ol"),wd=o("li"),T8=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A8=u(),Qo=o("li"),S8=a("Create the "),Gi=o("a"),C8=a("TrainingArguments"),x8=a(" object based on these values"),Jw=u(),le=o("p"),R8=a("Do note that some values, such as "),yd=o("code"),I8=a("scheduler.params.total_num_steps"),U8=a(` are calculated by
`),Li=o("a"),G8=a("Trainer"),L8=a(" during "),bd=o("code"),M8=a("train"),Z8=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),xs=o("h3"),ra=o("a"),Ed=o("span"),f(el.$$.fragment),N8=u(),qd=o("span"),H8=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B8=a("Zero Redundancy Optimizer (ZeRO)"),W8=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sy=u(),Ne=o("p"),F8=a("The "),$d=o("code"),V8=a("zero_optimization"),Y8=a(" section of the configuration file is the most important part ("),al=o("a"),K8=a("docs"),J8=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ty=u(),pa=o("p"),X8=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q8=a("Trainer"),ek=a(` provides
...
going to use.`),ny=u(),Hi=o("a"),oy=u(),Rs=o("h4"),ia=o("a"),kd=o("span"),f(nl.$$.fragment),tk=u(),Pd=o("span"),ak=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),nk=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Dd=o("strong"),ok=a("Performance tuning:"),iy=u(),He=o("ul"),Is=o("li"),lk=a("enabling "),zd=o("code"),rk=a("offload_optimizer"),pk=a(" should reduce GPU RAM usage (it requires "),Od=o("code"),ik=a('"stage": 2'),uk=a(")"),ck=u(),L=o("li"),Td=o("code"),hk=a('"overlap_comm": true'),fk=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=o("code"),dk=a("overlap_comm"),mk=a(` uses 4.5x
...
footprint (`),xd=o("code"),wk=a("5e8 x 2Bytes x 2 x 4.5"),yk=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
...
NVMe is discussed further down.`),jy=u(),We=o("p"),Hk=a("Pinned memory is enabled with "),Wd=o("code"),Bk=a("pin_memory"),Wk=a(" set to "),Fd=o("code"),Fk=a("true"),Vk=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gy=u(),Ki=o("p"),Vd=o("strong"),Yk=a("Performance tuning:"),wy=u(),ca=o("ul"),il=o("li"),Yd=o("code"),Kk=a("stage3_max_live_parameters"),Jk=a(": "),Kd=o("code"),Xk=a("1e9"),Qk=u(),ul=o("li"),Jd=o("code"),e7=a("stage3_max_reuse_distance"),s7=a(": "),Xd=o("code"),t7=a("1e9"),yy=u(),M=o("p"),a7=a("If hitting OOM reduce "),Qd=o("code"),n7=a("stage3_max_live_parameters"),o7=a(" and "),em=o("code"),l7=a("stage3_max_reuse_distance"),r7=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),sm=o("code"),p7=a("1e9"),i7=a(` would consume ~2GB. The memory is shared by
`),tm=o("code"),u7=a("stage3_max_live_parameters"),c7=a(" and "),am=o("code"),h7=a("stage3_max_reuse_distance"),f7=a(", so it\u2019s not additive, it\u2019s just 2GB total."),by=u(),ze=o("p"),nm=o("code"),d7=a("stage3_max_live_parameters"),m7=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),om=o("code"),_7=a("stage3_max_reuse_distance"),v7=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),lm=o("code"),j7=a("stage3_max_reuse_distance"),g7=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ey=u(),Ji=o("p"),w7=a("The following configuration values depend on the model\u2019s hidden size:"),qy=u(),Fe=o("ul"),cl=o("li"),rm=o("code"),y7=a("reduce_bucket_size"),b7=a(": "),pm=o("code"),E7=a("hidden_size*hidden_size"),q7=u(),hl=o("li"),im=o("code"),$7=a("stage3_prefetch_bucket_size"),k7=a(": "),um=o("code"),P7=a("0.9 * hidden_size * hidden_size"),D7=u(),fl=o("li"),cm=o("code"),z7=a("stage3_param_persistence_threshold"),O7=a(": "),hm=o("code"),T7=a("10 * hidden_size"),$y=u(),Ve=o("p"),A7=a("therefore set these values to "),fm=o("code"),S7=a("auto"),C7=a(" and the "),Xi=o("a"),x7=a("Trainer"),R7=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),ky=u(),dl=o("p"),dm=o("code"),I7=a("stage3_gather_16bit_weights_on_model_save"),U7=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Py=u(),re=o("p"),G7=a("If you\u2019re migrating from ZeRO-2 configuration note that "),mm=o("code"),L7=a("allgather_partitions"),M7=a(", "),_m=o("code"),Z7=a("allgather_bucket_size"),N7=a(` and
`),vm=o("code"),H7=a("reduce_scatter"),B7=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Dy=u(),Qi=o("ul"),ml=o("li"),jm=o("code"),W7=a("sub_group_size"),F7=a(": "),gm=o("code"),V7=a("1e9"),zy=u(),Oe=o("p"),wm=o("code"),Y7=a("sub_group_size"),K7=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),ym=o("code"),J7=a("sub_group_size"),X7=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),bm=o("code"),Q7=a("sub_group_size"),eP=a(` therefore controls the granularity in which model states are moved in and out of CPU
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),jG=a("DeepSpeed GitHub"),gG=a("."),this.h()},l(e){const p=ZK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Gj=r(k);ee=l(Gj,"SPAN",{});var Lj=r(ee);d(z.$$.fragment,Lj),Lj.forEach(t),Gj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var kG=r(se);R=n(kG,"DeepSpeed Integration"),kG.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Mj=r(S);E=l(Mj,"A",{href:!0,rel:!0});var PG=r(E);q=n(PG,"DeepSpeed"),PG.forEach(t),Es=n(Mj," implements everything described in the "),V=l(Mj,"A",{href:!0,rel:!0});var DG=r(V);qs=n(DG,"ZeRO paper"),DG.forEach(t),L6=n(Mj,". Currently it provides full support for:"),Mj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);tf=l(je,"LI",{});var zG=r(tf);M6=n(zG,"Optimizer state partitioning (ZeRO stage 1)"),zG.forEach(t),Z6=c(je),af=l(je,"LI",{});var OG=r(af);N6=n(OG,"Gradient partitioning (ZeRO stage 2)"),OG.forEach(t),H6=c(je),nf=l(je,"LI",{});var TG=r(nf);B6=n(TG,"Parameter partitioning (ZeRO stage 3)"),TG.forEach(t),W6=c(je),of=l(je,"LI",{});var AG=r(of);F6=n(AG,"Custom mixed precision training handling"),AG.forEach(t),V6=c(je),lf=l(je,"LI",{});var SG=r(lf);Y6=n(SG,"A range of fast CUDA-extension-based optimizers"),SG.forEach(t),K6=c(je),rf=l(je,"LI",{});var CG=r(rf);J6=n(CG,"ZeRO-Offload to CPU and NVMe"),CG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X6=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var xG=r(ao);Q6=n(xG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),xG.forEach(t),e5=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var RG=r(no);s5=n(RG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),RG.forEach(t),t5=n(rh,"."),rh.forEach(t),Fj=c(e),Up=l(e,"P",{});var IG=r(Up);a5=n(IG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),IG.forEach(t),Vj=c(e),Gp=l(e,"P",{});var UG=r(Gp);n5=n(UG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),UG.forEach(t),Yj=c(e),qt=l(e,"P",{});var nE=r(qt);o5=n(nE,"\u{1F917} Transformers integrates "),oo=l(nE,"A",{href:!0,rel:!0});var GG=r(oo);l5=n(GG,"DeepSpeed"),GG.forEach(t),r5=n(nE," via 2 options:"),nE.forEach(t),Kj=c(e),$t=l(e,"OL",{});var oE=r($t);lo=l(oE,"LI",{});var lE=r(lo);p5=n(lE,"Integration of the core DeepSpeed features via "),Lp=l(lE,"A",{href:!0});var LG=r(Lp);i5=n(LG,"Trainer"),LG.forEach(t),u5=n(lE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),lE.forEach(t),c5=c(oE),Y=l(oE,"LI",{});var ge=r(Y);h5=n(ge,"If you don\u2019t use "),Mp=l(ge,"A",{href:!0});var MG=r(Mp);f5=n(MG,"Trainer"),MG.forEach(t),d5=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),pf=l(ge,"CODE",{});var ZG=r(pf);m5=n(ZG,"from_pretrained"),ZG.forEach(t),_5=n(ge," and "),uf=l(ge,"CODE",{});var NG=r(uf);v5=n(NG,"from_config"),NG.forEach(t),j5=n(ge,` include integration of essential
parts of DeepSpeed like `),cf=l(ge,"CODE",{});var HG=r(cf);g5=n(HG,"zero.Init"),HG.forEach(t),w5=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=l(ge,"A",{href:!0});var BG=r(Zp);y5=n(BG,"deepspeed-non-trainer-integration"),BG.forEach(t),b5=n(ge,"."),ge.forEach(t),oE.forEach(t),Jj=c(e),Np=l(e,"P",{});var WG=r(Np);E5=n(WG,"What is integrated:"),WG.forEach(t),Xj=c(e),Hp=l(e,"P",{});var FG=r(Hp);q5=n(FG,"Training:"),FG.forEach(t),Qj=c(e),Bp=l(e,"OL",{});var VG=r(Bp);hf=l(VG,"LI",{});var YG=r(hf);$5=n(YG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),YG.forEach(t),VG.forEach(t),eg=c(e),Wp=l(e,"P",{});var KG=r(Wp);k5=n(KG,"Inference:"),KG.forEach(t),sg=c(e),Fp=l(e,"OL",{});var JG=r(Fp);ro=l(JG,"LI",{});var rE=r(ro);P5=n(rE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=l(rE,"A",{href:!0});var XG=r(Vp);D5=n(XG,"deepspeed-zero-inference"),XG.forEach(t),z5=n(rE,"."),rE.forEach(t),JG.forEach(t),tg=c(e),Yp=l(e,"P",{});var QG=r(Yp);O5=n(QG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),QG.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),$s=l(e,"H2",{class:!0});var pE=r($s);kt=l(pE,"A",{id:!0,class:!0,href:!0});var eL=r(kt);ff=l(eL,"SPAN",{});var sL=r(ff);d(po.$$.fragment,sL),sL.forEach(t),eL.forEach(t),T5=c(pE),df=l(pE,"SPAN",{});var tL=r(df);A5=n(tL,"Trainer Deepspeed Integration"),tL.forEach(t),pE.forEach(t),og=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),lg=c(e),ks=l(e,"H3",{class:!0});var iE=r(ks);Pt=l(iE,"A",{id:!0,class:!0,href:!0});var aL=r(Pt);mf=l(aL,"SPAN",{});var nL=r(mf);d(io.$$.fragment,nL),nL.forEach(t),aL.forEach(t),S5=c(iE),_f=l(iE,"SPAN",{});var oL=r(_f);C5=n(oL,"Installation"),oL.forEach(t),iE.forEach(t),rg=c(e),Xp=l(e,"P",{});var lL=r(Xp);x5=n(lL,"Install the library via pypi:"),lL.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),Ce=l(e,"P",{});var ph=r(Ce);R5=n(ph,"or via "),vf=l(ph,"CODE",{});var rL=r(vf);I5=n(rL,"transformers"),rL.forEach(t),U5=n(ph,"\u2019 "),jf=l(ph,"CODE",{});var pL=r(jf);G5=n(pL,"extras"),pL.forEach(t),L5=n(ph,":"),ph.forEach(t),ug=c(e),d(co.$$.fragment,e),cg=c(e),xe=l(e,"P",{});var ih=r(xe);M5=n(ih,"or find more details on "),ho=l(ih,"A",{href:!0,rel:!0});var iL=r(ho);Z5=n(iL,"the DeepSpeed\u2019s GitHub page"),iL.forEach(t),N5=n(ih,` and
`),fo=l(ih,"A",{href:!0,rel:!0});var uL=r(fo);H5=n(uL,"advanced install"),uL.forEach(t),B5=n(ih,"."),ih.forEach(t),hg=c(e),Dt=l(e,"P",{});var uE=r(Dt);W5=n(uE,"If you\u2019re still struggling with the build, first make sure to read "),Qp=l(uE,"A",{href:!0});var cL=r(Qp);F5=n(cL,"zero-install-notes"),cL.forEach(t),V5=n(uE,"."),uE.forEach(t),fg=c(e),ei=l(e,"P",{});var hL=r(ei);Y5=n(hL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),hL.forEach(t),dg=c(e),si=l(e,"P",{});var fL=r(si);K5=n(fL,"To make a local build for DeepSpeed:"),fL.forEach(t),mg=c(e),d(mo.$$.fragment,e),_g=c(e),Re=l(e,"P",{});var uh=r(Re);J5=n(uh,"If you intend to use NVMe offload you will also need to include "),gf=l(uh,"CODE",{});var dL=r(gf);X5=n(dL,"DS_BUILD_AIO=1"),dL.forEach(t),Q5=n(uh,` in the instructions above (and also
install `),wf=l(uh,"EM",{});var mL=r(wf);e$=n(mL,"libaio-dev"),mL.forEach(t),s$=n(uh," system-wide)."),uh.forEach(t),vg=c(e),zt=l(e,"P",{});var cE=r(zt);t$=n(cE,"Edit "),yf=l(cE,"CODE",{});var _L=r(yf);a$=n(_L,"TORCH_CUDA_ARCH_LIST"),_L.forEach(t),n$=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),cE.forEach(t),jg=c(e),d(_o.$$.fragment,e),gg=c(e),Pe=l(e,"P",{});var Ap=r(Pe);o$=n(Ap,"So if you get "),bf=l(Ap,"CODE",{});var vL=r(bf);l$=n(vL,"8, 6"),vL.forEach(t),r$=n(Ap,", then use "),Ef=l(Ap,"CODE",{});var jL=r(Ef);p$=n(jL,'TORCH_CUDA_ARCH_LIST="8.6"'),jL.forEach(t),i$=n(Ap,`. If you have multiple different cards, you can list all
of them like so `),qf=l(Ap,"CODE",{});var gL=r(qf);u$=n(gL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),gL.forEach(t),Ap.forEach(t),wg=c(e),ti=l(e,"P",{});var wL=r(ti);c$=n(wL,"If you need to use the same setup on multiple machines, make a binary wheel:"),wL.forEach(t),yg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h$=n(ch,"it will generate something like "),$f=l(ch,"CODE",{});var yL=r($f);f$=n(yL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),yL.forEach(t),d$=n(ch,` which now you can install
as `),kf=l(ch,"CODE",{});var bL=r(kf);m$=n(bL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),bL.forEach(t),_$=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),Ot=l(e,"P",{});var hE=r(Ot);v$=n(hE,"Again, remember to ensure to adjust "),Pf=l(hE,"CODE",{});var EL=r(Pf);j$=n(EL,"TORCH_CUDA_ARCH_LIST"),EL.forEach(t),g$=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);w$=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Df=l(hh,"STRONG",{});var qL=r(Df);y$=n(qL,"Compute Capabilities"),qL.forEach(t),b$=n(hh,` (same as arch in this
context) `),jo=l(hh,"A",{href:!0,rel:!0});var $L=r(jo);E$=n($L,"here"),$L.forEach(t),q$=n(hh,"."),hh.forEach(t),$g=c(e),ai=l(e,"P",{});var kL=r(ai);$$=n(kL,"You can check the archs pytorch was built with using:"),kL.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var PL=r(ni);k$=n(PL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),PL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),oi=l(e,"P",{});var DL=r(oi);P$=n(DL,"If the output is:"),DL.forEach(t),Og=c(e),d(yo.$$.fragment,e),Tg=c(e),Tt=l(e,"P",{});var fE=r(Tt);D$=n(fE,"then you know that this card\u2019s arch is "),zf=l(fE,"CODE",{});var zL=r(zf);z$=n(zL,"8.6"),zL.forEach(t),O$=n(fE,"."),fE.forEach(t),Ag=c(e),At=l(e,"P",{});var dE=r(At);T$=n(dE,"You can also leave "),Of=l(dE,"CODE",{});var OL=r(Of);A$=n(OL,"TORCH_CUDA_ARCH_LIST"),OL.forEach(t),S$=n(dE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),dE.forEach(t),Sg=c(e),St=l(e,"P",{});var mE=r(St);C$=n(mE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=l(mE,"A",{href:!0,rel:!0});var TL=r(bo);x$=n(TL,"Deepspeed"),TL.forEach(t),R$=n(mE,","),mE.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Ps=l(e,"H3",{class:!0});var _E=r(Ps);Ct=l(_E,"A",{id:!0,class:!0,href:!0});var AL=r(Ct);Tf=l(AL,"SPAN",{});var SL=r(Tf);d(Eo.$$.fragment,SL),SL.forEach(t),AL.forEach(t),I$=c(_E),Af=l(_E,"SPAN",{});var CL=r(Af);U$=n(CL,"Deployment with multiple GPUs"),CL.forEach(t),_E.forEach(t),Rg=c(e),xt=l(e,"P",{});var vE=r(xt);G$=n(vE,"To deploy this feature with multiple GPUs adjust the "),ri=l(vE,"A",{href:!0});var xL=r(ri);L$=n(xL,"Trainer"),xL.forEach(t),M$=n(vE,` command line arguments as
following:`),vE.forEach(t),Ig=c(e),Rt=l(e,"OL",{});var jE=r(Rt);Ds=l(jE,"LI",{});var fh=r(Ds);Z$=n(fh,"replace "),Sf=l(fh,"CODE",{});var RL=r(Sf);N$=n(RL,"python -m torch.distributed.launch"),RL.forEach(t),H$=n(fh," with "),Cf=l(fh,"CODE",{});var IL=r(Cf);B$=n(IL,"deepspeed"),IL.forEach(t),W$=n(fh,"."),fh.forEach(t),F$=c(jE),De=l(jE,"LI",{});var Mn=r(De);V$=n(Mn,"add a new argument "),xf=l(Mn,"CODE",{});var UL=r(xf);Y$=n(UL,"--deepspeed ds_config.json"),UL.forEach(t),K$=n(Mn,", where "),Rf=l(Mn,"CODE",{});var GL=r(Rf);J$=n(GL,"ds_config.json"),GL.forEach(t),X$=n(Mn,` is the DeepSpeed configuration file as
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var LL=r(qo);Q$=n(LL,"here"),LL.forEach(t),e4=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var ML=r(pi);s4=n(ML,"Therefore, if your original command line looked as follows:"),ML.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ZL=r(ii);t4=n(ZL,"Now it should be:"),ZL.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var we=r(U);a4=n(we,"Unlike, "),If=l(we,"CODE",{});var NL=r(If);n4=n(NL,"torch.distributed.launch"),NL.forEach(t),o4=n(we," where you have to specify how many GPUs to use with "),Uf=l(we,"CODE",{});var HL=r(Uf);l4=n(HL,"--nproc_per_node"),HL.forEach(t),r4=n(we,`, with the
`),Gf=l(we,"CODE",{});var BL=r(Gf);p4=n(BL,"deepspeed"),BL.forEach(t),i4=n(we," launcher you don\u2019t have to use the corresponding "),Lf=l(we,"CODE",{});var WL=r(Lf);u4=n(WL,"--num_gpus"),WL.forEach(t),c4=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(we,"A",{href:!0,rel:!0});var FL=r(Po);h4=n(FL,"here"),FL.forEach(t),f4=n(we,"."),we.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d4=n(Zn,"In fact, you can continue using "),Mf=l(Zn,"CODE",{});var VL=r(Mf);m4=n(VL,"-m torch.distributed.launch"),VL.forEach(t),_4=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
`),Zf=l(Zn,"CODE",{});var YL=r(Zf);v4=n(YL,"deepspeed"),YL.forEach(t),j4=n(Zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Nf=l(Zn,"CODE",{});var KL=r(Nf);g4=n(KL,"deepspeed"),KL.forEach(t),w4=n(Zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zn.forEach(t),Hg=c(e),It=l(e,"P",{});var gE=r(It);y4=n(gE,"Here is an example of running "),Hf=l(gE,"CODE",{});var JL=r(Hf);b4=n(JL,"run_translation.py"),JL.forEach(t),E4=n(gE," under DeepSpeed deploying all available GPUs:"),gE.forEach(t),Bg=c(e),d(Do.$$.fragment,e),Wg=c(e),Ut=l(e,"P",{});var wE=r(Ut);q4=n(wE,"Note that in the DeepSpeed documentation you are likely to see "),Bf=l(wE,"CODE",{});var XL=r(Bf);$4=n(XL,"--deepspeed --deepspeed_config ds_config.json"),XL.forEach(t),k4=n(wE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),wE.forEach(t),Fg=c(e),Gt=l(e,"P",{});var yE=r(Gt);P4=n(yE,"For some practical usage examples, please, see this "),zo=l(yE,"A",{href:!0,rel:!0});var QL=r(zo);D4=n(QL,"post"),QL.forEach(t),z4=n(yE,"."),yE.forEach(t),Vg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Yg=c(e),zs=l(e,"H3",{class:!0});var bE=r(zs);Lt=l(bE,"A",{id:!0,class:!0,href:!0});var eM=r(Lt);Wf=l(eM,"SPAN",{});var sM=r(Wf);d(Oo.$$.fragment,sM),sM.forEach(t),eM.forEach(t),O4=c(bE),Ff=l(bE,"SPAN",{});var tM=r(Ff);T4=n(tM,"Deployment with one GPU"),tM.forEach(t),bE.forEach(t),Kg=c(e),Mt=l(e,"P",{});var EE=r(Mt);A4=n(EE,"To deploy DeepSpeed with one GPU adjust the "),ci=l(EE,"A",{href:!0});var aM=r(ci);S4=n(aM,"Trainer"),aM.forEach(t),C4=n(EE," command line arguments as follows:"),EE.forEach(t),Jg=c(e),d(To.$$.fragment,e),Xg=c(e),Ge=l(e,"P",{});var dh=r(Ge);x4=n(dh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Vf=l(dh,"CODE",{});var nM=r(Vf);R4=n(nM,"--num_gpus=1"),nM.forEach(t),I4=n(dh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=l(dh,"A",{href:!0,rel:!0});var oM=r(Ao);U4=n(oM,"documentation"),oM.forEach(t),G4=n(dh," discusses the launcher options."),dh.forEach(t),Qg=c(e),hi=l(e,"P",{});var lM=r(hi);L4=n(lM,"Why would you want to use DeepSpeed with just one GPU?"),lM.forEach(t),ew=c(e),Zt=l(e,"OL",{});var qE=r(Zt);Yf=l(qE,"LI",{});var rM=r(Yf);M4=n(rM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),rM.forEach(t),Z4=c(qE),Kf=l(qE,"LI",{});var pM=r(Kf);N4=n(pM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),pM.forEach(t),qE.forEach(t),sw=c(e),fi=l(e,"P",{});var iM=r(fi);H4=n(iM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),iM.forEach(t),tw=c(e),d(So.$$.fragment,e),aw=c(e),di=l(e,"P",{});var uM=r(di);B4=n(uM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),uM.forEach(t),nw=c(e),Nt=l(e,"P",{});var $E=r(Nt);W4=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var cM=r(Co);F4=n(cM,"post"),cM.forEach(t),V4=n($E,"."),$E.forEach(t),ow=c(e),mi=l(e,"P",{});var hM=r(mi);Y4=n(hM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),hM.forEach(t),lw=c(e),_i=l(e,"P",{});var fM=r(_i);K4=n(fM,"Notes:"),fM.forEach(t),rw=c(e),vi=l(e,"UL",{});var dM=r(vi);Os=l(dM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J4=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=l(kE,"CODE",{});var mM=r(Jf);X4=n(mM,"CUDA_VISIBLE_DEVICES"),mM.forEach(t),Q4=n(kE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e9=c(mh),d(Ro.$$.fragment,mh),s9=c(mh),Xf=l(mh,"P",{});var _M=r(Xf);t9=n(_M,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),_M.forEach(t),mh.forEach(t),dM.forEach(t),pw=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iw=c(e),Ts=l(e,"H3",{class:!0});var PE=r(Ts);Ht=l(PE,"A",{id:!0,class:!0,href:!0});var vM=r(Ht);Qf=l(vM,"SPAN",{});var jM=r(Qf);d(Io.$$.fragment,jM),jM.forEach(t),vM.forEach(t),a9=c(PE),ed=l(PE,"SPAN",{});var gM=r(ed);n9=n(gM,"Deployment in Notebooks"),gM.forEach(t),PE.forEach(t),uw=c(e),Bt=l(e,"P",{});var DE=r(Bt);o9=n(DE,"The problem with running notebook cells as a script is that there is no normal "),sd=l(DE,"CODE",{});var wM=r(sd);l9=n(wM,"deepspeed"),wM.forEach(t),r9=n(DE,` launcher to rely on, so
under certain setups we have to emulate it.`),DE.forEach(t),cw=c(e),gi=l(e,"P",{});var yM=r(gi);p9=n(yM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),yM.forEach(t),hw=c(e),d(Uo.$$.fragment,e),fw=c(e),Wt=l(e,"P",{});var zE=r(Wt);i9=n(zE,"Note: "),td=l(zE,"CODE",{});var bM=r(td);u9=n(bM,"..."),bM.forEach(t),c9=n(zE," stands for the normal arguments that you\u2019d pass to the functions."),zE.forEach(t),dw=c(e),wi=l(e,"P",{});var EM=r(wi);h9=n(EM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),EM.forEach(t),mw=c(e),yi=l(e,"P",{});var qM=r(yi);f9=n(qM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),qM.forEach(t),_w=c(e),d(Go.$$.fragment,e),vw=c(e),Le=l(e,"P",{});var _h=r(Le);d9=n(_h,"If the training script is in a normal file and not in the notebook cells, you can launch "),ad=l(_h,"CODE",{});var $M=r(ad);m9=n($M,"deepspeed"),$M.forEach(t),_9=n(_h,` normally via
shell from a cell. For example, to use `),nd=l(_h,"CODE",{});var kM=r(nd);v9=n(kM,"run_translation.py"),kM.forEach(t),j9=n(_h," you would launch it with:"),_h.forEach(t),jw=c(e),d(Lo.$$.fragment,e),gw=c(e),Ft=l(e,"P",{});var OE=r(Ft);g9=n(OE,"or with "),od=l(OE,"CODE",{});var PM=r(od);w9=n(PM,"%%bash"),PM.forEach(t),y9=n(OE," magic, where you can write a multi-line code for the shell program to run:"),OE.forEach(t),ww=c(e),d(Mo.$$.fragment,e),yw=c(e),bi=l(e,"P",{});var DM=r(bi);b9=n(DM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),DM.forEach(t),bw=c(e),Vt=l(e,"P",{});var TE=r(Vt);E9=n(TE,"Note: While "),ld=l(TE,"CODE",{});var zM=r(ld);q9=n(zM,"%%bash"),zM.forEach(t),$9=n(TE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),TE.forEach(t),Ew=c(e),Ei=l(e,"A",{id:!0}),r(Ei).forEach(t),qw=c(e),As=l(e,"H3",{class:!0});var AE=r(As);Yt=l(AE,"A",{id:!0,class:!0,href:!0});var OM=r(Yt);rd=l(OM,"SPAN",{});var TM=r(rd);d(Zo.$$.fragment,TM),TM.forEach(t),OM.forEach(t),k9=c(AE),pd=l(AE,"SPAN",{});var AM=r(pd);P9=n(AM,"Configuration"),AM.forEach(t),AE.forEach(t),$w=c(e),Kt=l(e,"P",{});var SE=r(Kt);D9=n(SE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=l(SE,"A",{href:!0,rel:!0});var SM=r(No);z9=n(SM,"following documentation"),SM.forEach(t),O9=n(SE,"."),SE.forEach(t),kw=c(e),Jt=l(e,"P",{});var CE=r(Jt);T9=n(CE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=l(CE,"A",{href:!0,rel:!0});var CM=r(Ho);A9=n(CM,`the DeepSpeedExamples
repo`),CM.forEach(t),S9=n(CE,":"),CE.forEach(t),Pw=c(e),d(Bo.$$.fragment,e),Dw=c(e),Xt=l(e,"P",{});var xE=r(Xt);C9=n(xE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=l(xE,"CODE",{});var xM=r(id);x9=n(xM,".json"),xM.forEach(t),R9=n(xE," files with:"),xE.forEach(t),zw=c(e),d(Wo.$$.fragment,e),Ow=c(e),Qt=l(e,"P",{});var RE=r(Qt);I9=n(RE,"Some more examples are to be found in the "),Fo=l(RE,"A",{href:!0,rel:!0});var RM=r(Fo);U9=n(RM,"main repo"),RM.forEach(t),G9=n(RE," as well."),RE.forEach(t),Tw=c(e),qi=l(e,"P",{});var IM=r(qi);L9=n(IM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),IM.forEach(t),Aw=c(e),oe=l(e,"P",{});var Nn=r(oe);M9=n(Nn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),ud=l(Nn,"CODE",{});var UM=r(ud);Z9=n(UM,"AdamW"),UM.forEach(t),N9=n(Nn," optimizer and "),cd=l(Nn,"CODE",{});var GM=r(cd);H9=n(GM,"WarmupLR"),GM.forEach(t),B9=n(Nn,` scheduler and will enable mixed
precision training if `),hd=l(Nn,"CODE",{});var LM=r(hd);W9=n(LM,"--fp16"),LM.forEach(t),F9=n(Nn," is passed:"),Nn.forEach(t),Sw=c(e),d(Vo.$$.fragment,e),Cw=c(e),ea=l(e,"P",{});var IE=r(ea);V9=n(IE,"When you execute the program, DeepSpeed will log the configuration it received from the "),$i=l(IE,"A",{href:!0});var MM=r($i);Y9=n(MM,"Trainer"),MM.forEach(t),K9=n(IE,`
to the console, so you can see exactly what was the final configuration passed to it.`),IE.forEach(t),xw=c(e),ki=l(e,"A",{id:!0}),r(ki).forEach(t),Rw=c(e),Ss=l(e,"H3",{class:!0});var UE=r(Ss);sa=l(UE,"A",{id:!0,class:!0,href:!0});var ZM=r(sa);fd=l(ZM,"SPAN",{});var NM=r(fd);d(Yo.$$.fragment,NM),NM.forEach(t),ZM.forEach(t),J9=c(UE),dd=l(UE,"SPAN",{});var HM=r(dd);X9=n(HM,"Passing Configuration"),HM.forEach(t),UE.forEach(t),Iw=c(e),G=l(e,"P",{});var ye=r(G);Q9=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(ye,"A",{href:!0});var BM=r(Pi);e8=n(BM,"Trainer"),BM.forEach(t),s8=n(ye," via "),Di=l(ye,"A",{href:!0});var WM=r(Di);t8=n(WM,"TrainingArguments"),WM.forEach(t),a8=n(ye," then for the "),md=l(ye,"CODE",{});var FM=r(md);n8=n(FM,"deepspeed"),FM.forEach(t),o8=n(ye,` argument you can
pass a nested `),_d=l(ye,"CODE",{});var VM=r(_d);l8=n(VM,"dict"),VM.forEach(t),r8=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(ye,"A",{href:!0});var YM=r(zi);p8=n(YM,"TrainingArguments"),YM.forEach(t),i8=n(ye,"."),ye.forEach(t),Uw=c(e),Oi=l(e,"P",{});var KM=r(Oi);u8=n(KM,"To summarize you can do:"),KM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"P",{});var JM=r(Ti);c8=n(JM,"or:"),JM.forEach(t),Mw=c(e),d(Jo.$$.fragment,e),Zw=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Nw=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);ta=l(GE,"A",{id:!0,class:!0,href:!0});var XM=r(ta);vd=l(XM,"SPAN",{});var QM=r(vd);d(Xo.$$.fragment,QM),QM.forEach(t),XM.forEach(t),h8=c(GE),jd=l(GE,"SPAN",{});var eZ=r(jd);f8=n(eZ,"Shared Configuration"),eZ.forEach(t),GE.forEach(t),Hw=c(e),d(aa.$$.fragment,e),Bw=c(e),Me=l(e,"P",{});var vh=r(Me);d8=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var sZ=r(Si);m8=n(sZ,"Trainer"),sZ.forEach(t),_8=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var tZ=r(Ci);v8=n(tZ,"Trainer"),tZ.forEach(t),j8=n(vh," command line arguments."),vh.forEach(t),Ww=c(e),na=l(e,"P",{});var LE=r(na);g8=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var aZ=r(xi);w8=n(aZ,"Trainer"),aZ.forEach(t),y8=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fw=c(e),Ze=l(e,"P",{});var jh=r(Ze);b8=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),gd=l(jh,"CODE",{});var nZ=r(gd);E8=n(nZ,"auto"),nZ.forEach(t),q8=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
...
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vw=c(e),Ii=l(e,"P",{});var lZ=r(Ii);P8=n(lZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),lZ.forEach(t),Yw=c(e),oa=l(e,"P",{});var ME=r(oa);D8=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var rZ=r(Ui);z8=n(rZ,"TrainingArguments"),rZ.forEach(t),O8=n(ME," based on that. The steps are:"),ME.forEach(t),Kw=c(e),la=l(e,"OL",{});var ZE=r(la);wd=l(ZE,"LI",{});var pZ=r(wd);T8=n(pZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),pZ.forEach(t),A8=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S8=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var iZ=r(Gi);C8=n(iZ,"TrainingArguments"),iZ.forEach(t),x8=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jw=c(e),le=l(e,"P",{});var Hn=r(le);R8=n(Hn,"Do note that some values, such as "),yd=l(Hn,"CODE",{});var uZ=r(yd);I8=n(uZ,"scheduler.params.total_num_steps"),uZ.forEach(t),U8=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var cZ=r(Li);G8=n(cZ,"Trainer"),cZ.forEach(t),L8=n(Hn," during "),bd=l(Hn,"CODE",{});var hZ=r(bd);M8=n(hZ,"train"),hZ.forEach(t),Z8=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qw=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);ra=l(HE,"A",{id:!0,class:!0,href:!0});var fZ=r(ra);Ed=l(fZ,"SPAN",{});var dZ=r(Ed);d(el.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),N8=c(HE),qd=l(HE,"SPAN",{});var mZ=r(qd);H8=n(mZ,"ZeRO"),mZ.forEach(t),HE.forEach(t),ey=c(e),sl=l(e,"P",{});var wG=r(sl);tl=l(wG,"A",{href:!0,rel:!0});var _Z=r(tl);B8=n(_Z,"Zero Redundancy Optimizer (ZeRO)"),_Z.forEach(t),W8=n(wG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),ty=c(e),pa=l(e,"P",{});var BE=r(pa);X8=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q8=n(gZ,"Trainer"),gZ.forEach(t),ek=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),ay=c(e),Ni=l(e,"P",{});var wZ=r(Ni);sk=n(wZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),wZ.forEach(t),ny=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),oy=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);ia=l(WE,"A",{id:!0,class:!0,href:!0});var yZ=r(ia);kd=l(yZ,"SPAN",{});var bZ=r(kd);d(nl.$$.fragment,bZ),bZ.forEach(t),yZ.forEach(t),tk=c(WE),Pd=l(WE,"SPAN",{});var EZ=r(Pd);ak=n(EZ,"ZeRO-2 Config"),EZ.forEach(t),WE.forEach(t),ly=c(e),Bi=l(e,"P",{});var qZ=r(Bi);nk=n(qZ,"The following is an example of configuration for ZeRO stage 2:"),qZ.forEach(t),ry=c(e),d(ol.$$.fragment,e),py=c(e),Wi=l(e,"P",{});var $Z=r(Wi);Dd=l($Z,"STRONG",{});var kZ=r(Dd);ok=n(kZ,"Performance tuning:"),kZ.forEach(t),$Z.forEach(t),iy=c(e),He=l(e,"UL",{});var wh=r(He);Is=l(wh,"LI",{});var yh=r(Is);lk=n(yh,"enabling "),zd=l(yh,"CODE",{});var PZ=r(zd);rk=n(PZ,"offload_optimizer"),PZ.forEach(t),pk=n(yh," should reduce GPU RAM usage (it requires "),Od=l(yh,"CODE",{});var DZ=r(Od);ik=n(DZ,'"stage": 2'),DZ.forEach(t),uk=n(yh,")"),yh.forEach(t),ck=c(wh),L=l(wh,"LI",{});var te=r(L);Td=l(te,"CODE",{});var zZ=r(Td);hk=n(zZ,'"overlap_comm": true'),zZ.forEach(t),fk=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=l(te,"CODE",{});var OZ=r(Ad);dk=n(OZ,"overlap_comm"),OZ.forEach(t),mk=n(te,` uses 4.5x
...
footprint (`),xd=l(te,"CODE",{});var SZ=r(xd);wk=n(SZ,"5e8 x 2Bytes x 2 x 4.5"),SZ.forEach(t),yk=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
...
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),qk=c(wh),Id=l(wh,"LI",{});var xZ=r(Id);$k=n(xZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),xZ.forEach(t),wh.forEach(t),uy=c(e),Be=l(e,"P",{});var bh=r(Be);kk=n(bh,"Additionally, "),Ud=l(bh,"CODE",{});var RZ=r(Ud);Pk=n(RZ,"deepspeed==0.4.4"),RZ.forEach(t),Dk=n(bh," added a new option "),Gd=l(bh,"CODE",{});var IZ=r(Gd);zk=n(IZ,"round_robin_gradients"),IZ.forEach(t),Ok=n(bh," which you can enable with:"),bh.forEach(t),cy=c(e),d(ll.$$.fragment,e),hy=c(e),Fi=l(e,"P",{});var UZ=r(Fi);Tk=n(UZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),UZ.forEach(t),fy=c(e),Vi=l(e,"A",{id:!0}),r(Vi).forEach(t),dy=c(e),Us=l(e,"H4",{class:!0});var FE=r(Us);ua=l(FE,"A",{id:!0,class:!0,href:!0});var GZ=r(ua);Ld=l(GZ,"SPAN",{});var LZ=r(Ld);d(rl.$$.fragment,LZ),LZ.forEach(t),GZ.forEach(t),Ak=c(FE),Md=l(FE,"SPAN",{});var MZ=r(Md);Sk=n(MZ,"ZeRO-3 Config"),MZ.forEach(t),FE.forEach(t),my=c(e),Yi=l(e,"P",{});var ZZ=r(Yi);Ck=n(ZZ,"The following is an example of configuration for ZeRO stage 3:"),ZZ.forEach(t),_y=c(e),d(pl.$$.fragment,e),vy=c(e),K=l(e,"P",{});var ys=r(K);xk=n(ys,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Zd=l(ys,"CODE",{});var NZ=r(Zd);Rk=n(NZ,'"device": "cpu"'),NZ.forEach(t),Ik=n(ys,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Nd=l(ys,"CODE",{});var HZ=r(Nd);Uk=n(HZ,"none"),HZ.forEach(t),Gk=n(ys," instead of "),Hd=l(ys,"CODE",{});var BZ=r(Hd);Lk=n(BZ,"cpu"),BZ.forEach(t),Mk=n(ys," for the "),Bd=l(ys,"CODE",{});var WZ=r(Bd);Zk=n(WZ,"device"),WZ.forEach(t),Nk=n(ys,` entry. Offloading to
NVMe is discussed further down.`),ys.forEach(t),jy=c(e),We=l(e,"P",{});var Eh=r(We);Hk=n(Eh,"Pinned memory is enabled with "),Wd=l(Eh,"CODE",{});var FZ=r(Wd);Bk=n(FZ,"pin_memory"),FZ.forEach(t),Wk=n(Eh," set to "),Fd=l(Eh,"CODE",{});var VZ=r(Fd);Fk=n(VZ,"true"),VZ.forEach(t),Vk=n(Eh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Eh.forEach(t),gy=c(e),Ki=l(e,"P",{});var YZ=r(Ki);Vd=l(YZ,"STRONG",{});var KZ=r(Vd);Yk=n(KZ,"Performance tuning:"),KZ.forEach(t),YZ.forEach(t),wy=c(e),ca=l(e,"UL",{});var VE=r(ca);il=l(VE,"LI",{});var YE=r(il);Yd=l(YE,"CODE",{});var JZ=r(Yd);Kk=n(JZ,"stage3_max_live_parameters"),JZ.forEach(t),Jk=n(YE,": "),Kd=l(YE,"CODE",{});var XZ=r(Kd);Xk=n(XZ,"1e9"),XZ.forEach(t),YE.forEach(t),Qk=c(VE),ul=l(VE,"LI",{});var KE=r(ul);Jd=l(KE,"CODE",{});var QZ=r(Jd);e7=n(QZ,"stage3_max_reuse_distance"),QZ.forEach(t),s7=n(KE,": "),Xd=l(KE,"CODE",{});var eN=r(Xd);t7=n(eN,"1e9"),eN.forEach(t),KE.forEach(t),VE.forEach(t),yy=c(e),M=l(e,"P",{});var be=r(M);a7=n(be,"If hitting OOM reduce "),Qd=l(be,"CODE",{});var sN=r(Qd);n7=n(sN,"stage3_max_live_parameters"),sN.forEach(t),o7=n(be," and "),em=l(be,"CODE",{});var tN=r(em);l7=n(tN,"stage3_max_reuse_distance"),tN.forEach(t),r7=n(be,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),sm=l(be,"CODE",{});var aN=r(sm);p7=n(aN,"1e9"),aN.forEach(t),i7=n(be,` would consume ~2GB. The memory is shared by
`),tm=l(be,"CODE",{});var nN=r(tm);u7=n(nN,"stage3_max_live_parameters"),nN.forEach(t),c7=n(be," and "),am=l(be,"CODE",{});var oN=r(am);h7=n(oN,"stage3_max_reuse_distance"),oN.forEach(t),f7=n(be,", so it\u2019s not additive, it\u2019s just 2GB total."),be.forEach(t),by=c(e),ze=l(e,"P",{});var Sp=r(ze);nm=l(Sp,"CODE",{});var lN=r(nm);d7=n(lN,"stage3_max_live_parameters"),lN.forEach(t),m7=n(Sp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),om=l(Sp,"CODE",{});var rN=r(om);_7=n(rN,"stage3_max_reuse_distance"),rN.forEach(t),v7=n(Sp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),lm=l(Sp,"CODE",{});var pN=r(lm);j7=n(pN,"stage3_max_reuse_distance"),pN.forEach(t),g7=n(Sp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Sp.forEach(t),Ey=c(e),Ji=l(e,"P",{});var iN=r(Ji);w7=n(iN,"The following configuration values depend on the model\u2019s hidden size:"),iN.forEach(t),qy=c(e),Fe=l(e,"UL",{});var qh=r(Fe);cl=l(qh,"LI",{});var JE=r(cl);rm=l(JE,"CODE",{});var uN=r(rm);y7=n(uN,"reduce_bucket_size"),uN.forEach(t),b7=n(JE,": "),pm=l(JE,"CODE",{});var cN=r(pm);E7=n(cN,"hidden_size*hidden_size"),cN.forEach(t),JE.forEach(t),q7=c(qh),hl=l(qh,"LI",{});var XE=r(hl);im=l(XE,"CODE",{});var hN=r(im);$7=n(hN,"stage3_prefetch_bucket_size"),hN.forEach(t),k7=n(XE,": "),um=l(XE,"CODE",{});var fN=r(um);P7=n(fN,"0.9 * hidden_size * hidden_size"),fN.forEach(t),XE.forEach(t),D7=c(qh),fl=l(qh,"LI",{});var QE=r(fl);cm=l(QE,"CODE",{});var dN=r(cm);z7=n(dN,"stage3_param_persistence_threshold"),dN.forEach(t),O7=n(QE,": "),hm=l(QE,"CODE",{});var mN=r(hm);T7=n(mN,"10 * hidden_size"),mN.forEach(t),QE.forEach(t),qh.forEach(t),$y=c(e),Ve=l(e,"P",{});var $h=r(Ve);A7=n($h,"therefore set these values to "),fm=l($h,"CODE",{});var _N=r(fm);S7=n(_N,"auto"),_N.forEach(t),C7=n($h," and the "),Xi=l($h,"A",{href:!0});var vN=r(Xi);x7=n(vN,"Trainer"),vN.forEach(t),R7=n($h,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),$h.forEach(t),ky=c(e),dl=l(e,"P",{});var yG=r(dl);dm=l(yG,"CODE",{});var jN=r(dm);I7=n(jN,"stage3_gather_16bit_weights_on_model_save"),jN.forEach(t),U7=n(yG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),yG.forEach(t),Py=c(e),re=l(e,"P",{});var Bn=r(re);G7=n(Bn,"If you\u2019re migrating from ZeRO-2 configuration note that "),mm=l(Bn,"CODE",{});var gN=r(mm);L7=n(gN,"allgather_partitions"),gN.forEach(t),M7=n(Bn,", "),_m=l(Bn,"CODE",{});var wN=r(_m);Z7=n(wN,"allgather_bucket_size"),wN.forEach(t),N7=n(Bn,` and
`),vm=l(Bn,"CODE",{});var yN=r(vm);H7=n(yN,"reduce_scatter"),yN.forEach(t),B7=n(Bn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Bn.forEach(t),Dy=c(e),Qi=l(e,"UL",{});var bN=r(Qi);ml=l(bN,"LI",{});var eq=r(ml);jm=l(eq,"CODE",{});var EN=r(jm);W7=n(EN,"sub_group_size"),EN.forEach(t),F7=n(eq,": "),gm=l(eq,"CODE",{});var qN=r(gm);V7=n(qN,"1e9"),qN.forEach(t),eq.forEach(t),bN.forEach(t),zy=c(e),Oe=l(e,"P",{});var Cp=r(Oe);wm=l(Cp,"CODE",{});var $N=r(wm);Y7=n($N,"sub_group_size"),$N.forEach(t),K7=n(Cp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),ym=l(Cp,"CODE",{});var kN=r(ym);J7=n(kN,"sub_group_size"),kN.forEach(t),X7=n(Cp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),bm=l(Cp,"CODE",{});var PN=r(bm);Q7=n(PN,"sub_group_size"),PN.forEach(t),eP=n(Cp,` therefore controls the granularity in which model states are moved in and out of CPU
...
`),dv=l(W,"CODE",{});var VF=r(dv);GC=n(VF,"from_pretrained"),VF.forEach(t),LC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),T3=c(e),d(zr.$$.fragment,e),A3=c(e),fn=l(e,"P",{});var o6=r(fn);MC=n(o6,"If you\u2019re using the official example scripts and your command line arguments include "),mv=l(o6,"CODE",{});var YF=r(mv);ZC=n(YF,"--deepspeed ds_config.json"),YF.forEach(t),NC=n(o6,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o6.forEach(t),S3=c(e),dc=l(e,"P",{});var KF=r(dc);HC=n(KF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),KF.forEach(t),C3=c(e),dn=l(e,"P",{});var l6=r(dn);BC=n(l6,"For full details on this method and other related features please refer to "),Or=l(l6,"A",{href:!0,rel:!0});var JF=r(Or);WC=n(JF,"Constructing Massive Models"),JF.forEach(t),FC=n(l6,"."),l6.forEach(t),x3=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),_v=l(Jn,"CODE",{});var XF=r(_v);YC=n(XF,"from_pretrained"),XF.forEach(t),KC=n(Jn,` to use
`),vv=l(Jn,"CODE",{});var QF=r(vv);JC=n(QF,"torch_dtype=torch.float16"),QF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var eV=r(mc);QC=n(eV,"from_pretrained-torch-dtype"),eV.forEach(t),ex=n(Jn,"."),Jn.forEach(t),R3=c(e),nt=l(e,"H4",{class:!0});var r6=r(nt);mn=l(r6,"A",{id:!0,class:!0,href:!0});var sV=r(mn);jv=l(sV,"SPAN",{});var tV=r(jv);d(Tr.$$.fragment,tV),tV.forEach(t),sV.forEach(t),sx=c(r6),gv=l(r6,"SPAN",{});var aV=r(gv);tx=n(aV,"Gathering Parameters"),aV.forEach(t),r6.forEach(t),I3=c(e),Ar=l(e,"P",{});var EG=r(Ar);ax=n(EG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(EG,"A",{href:!0,rel:!0});var nV=r(Sr);nx=n(nV,"Gathering Parameters"),nV.forEach(t),EG.forEach(t),U3=c(e),_n=l(e,"P",{});var p6=r(_n);ox=n(p6,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),wv=l(p6,"CODE",{});var oV=r(wv);lx=n(oV,"from_pretrained"),oV.forEach(t),rx=n(p6,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
dump the `),Cc=l(Xn,"A",{href:!0});var GV=r(Cc);Yx=n(GV,"TrainingArguments"),GV.forEach(t),Kx=n(Xn," as it has dozens of entries that are irrelevant."),Xn.forEach(t),RV.forEach(t),Jx=c($e),Nr=l($e,"LI",{});var m6=r(Nr);Sv=l(m6,"P",{});var LV=r(Sv);Xx=n(LV,"Output of:"),LV.forEach(t),Qx=c(m6),d(Hr.$$.fragment,m6),m6.forEach(t),eR=c($e),Cv=l($e,"LI",{});var MV=r(Cv);Br=l(MV,"P",{});var _6=r(Br);sR=n(_6,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Wr=l(_6,"A",{href:!0,rel:!0});var ZV=r(Wr);tR=n(ZV,"notebook"),ZV.forEach(t),aR=n(_6,` as
a starting point.`),_6.forEach(t),MV.forEach(t),nR=c($e),xv=l($e,"LI",{});var NV=r(xv);Rv=l(NV,"P",{});var HV=r(Rv);oR=n(HV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),HV.forEach(t),NV.forEach(t),lR=c($e),Iv=l($e,"LI",{});var BV=r(Iv);Fr=l(BV,"P",{});var v6=r(Fr);rR=n(v6,"If possible try to use one of the existing "),Vr=l(v6,"A",{href:!0,rel:!0});var WV=r(Vr);pR=n(WV,"examples"),WV.forEach(t),iR=n(v6," to reproduce the problem with."),v6.forEach(t),BV.forEach(t),$e.forEach(t),f0=c(e),xc=l(e,"P",{});var FV=r(xc);uR=n(FV,"Things to consider:"),FV.forEach(t),d0=c(e),En=l(e,"UL",{});var j6=r(En);pt=l(j6,"LI",{});var Hh=r(pt);Uv=l(Hh,"P",{});var VV=r(Uv);cR=n(VV,"Deepspeed is often not the cause of the problem."),VV.forEach(t),hR=c(Hh),Gv=l(Hh,"P",{});var YV=r(Gv);fR=n(YV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),KV.forEach(t),Hh.forEach(t),_R=c(j6),Mv=l(j6,"LI",{});var JV=r(Mv);Yr=l(JV,"P",{});var g6=r(Yr);vR=n(g6,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Kr=l(g6,"A",{href:!0,rel:!0});var XV=r(Kr);jR=n(XV,"Deepspeed"),XV.forEach(t),gR=n(g6,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g6.forEach(t),JV.forEach(t),j6.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var w6=r(it);qn=l(w6,"A",{id:!0,class:!0,href:!0});var QV=r(qn);Zv=l(QV,"SPAN",{});var eY=r(Zv);d(Jr.$$.fragment,eY),eY.forEach(t),QV.forEach(t),wR=c(w6),Nv=l(w6,"SPAN",{});var sY=r(Nv);yR=n(sY,"Troubleshooting"),sY.forEach(t),w6.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var y6=r(ut);$n=l(y6,"A",{id:!0,class:!0,href:!0});var tY=r($n);Hv=l(tY,"SPAN",{});var aY=r(Hv);d(Xr.$$.fragment,aY),aY.forEach(t),tY.forEach(t),bR=c(y6),Qr=l(y6,"SPAN",{});var b6=r(Qr);ER=n(b6,"the "),Bv=l(b6,"CODE",{});var nY=r(Bv);qR=n(nY,"deepspeed"),nY.forEach(t),$R=n(b6," process gets killed at startup without a traceback"),b6.forEach(t),y6.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Wv=l(ke,"CODE",{});var oY=r(Wv);PR=n(oY,"deepspeed"),oY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
