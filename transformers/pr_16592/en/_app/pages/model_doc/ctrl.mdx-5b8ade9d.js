...
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function op(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),ye=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var De=i(v);T=s(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var O=i(R);Q=s(O,"This second option is useful when using "),D=r(O,"CODE",{});var qe=i(D);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(O,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var N=i(F);q=r(N,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(N),z=r(N,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ye=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(N),I=r(N,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function sp(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ap(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),ye=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var De=i(v);T=s(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var O=i(R);Q=s(O,"This second option is useful when using "),D=r(O,"CODE",{});var qe=i(D);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(O,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var N=i(F);q=r(N,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(N),z=r(N,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ye=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(N),I=r(N,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function rp(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ip(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce,p,$,ie,De,me,O,qe,Ae,He,N,P,We,ze,K,Be,Pe,we,Ue,En,ma,fa,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,ya,Ms,ct,Rt,qn,Xt,Ca,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,Pa,pt,xa,tn,ja,Sa,on,Ia,Oa,Na,Pn,Da,Aa,Yt,Fs,ht,Mt,xn,Zt,Ha,jn,Wa,qs,Oe,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,On,Ya,Ps,$e,so,Za,Nn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,xe,lo,cr,mt,pr,rn,hr,ur,Dn,mr,fr,gr,Ft,_r,An,Tr,vr,co,xs,ft,qt,Hn,po,kr,Wn,br,js,Re,ho,yr,Bn,Cr,wr,uo,Lr,ln,$r,Rr,Mr,mo,Er,fo,Fr,qr,zr,je,go,Pr,gt,xr,dn,jr,Sr,Un,Ir,Or,Nr,zt,Dr,Vn,Ar,Hr,_o,Ss,_t,Pt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,pn,ai,ri,ii,bo,li,yo,di,ci,pi,B,Co,hi,Tt,ui,hn,mi,fi,Zn,gi,_i,Ti,xt,vi,es,ki,bi,wo,yi,Lo,Ci,ts,wi,Li,$o,$i,Ro,Os,vt,jt,os,Mo,Ri,ns,Mi,Ns,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,Pi,xi,ji,qo,Si,zo,Ii,Oi,Ni,St,Di,Se,Po,Ai,kt,Hi,mn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,xo,Ds,bt,Ot,is,jo,Qi,ls,Yi,As,ce,So,Zi,ds,el,tl,Io,ol,fn,nl,sl,al,Oo,rl,No,il,ll,dl,Nt,cl,Ie,Do,pl,yt,hl,gn,ul,ml,cs,fl,gl,_l,Dt,Tl,ps,vl,kl,Ao,Hs,Ct,At,hs,Ho,bl,us,yl,Ws,X,Wo,Cl,ms,wl,Ll,_n,Tn,$l,Rl,Ml,Ne,El,fs,Fl,ql,gs,zl,Pl,_s,xl,jl,Ts,Sl,Il,Ol,Bo,Nl,vn,Dl,Al,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,fe,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_16592/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Fe({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/models/ctrl/modeling_ctrl.py#L353",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16592/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_16592/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16592/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16592/en/model_doc/ctrl#transformers.CTRLConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16592/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),go=new Fe({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/models/ctrl/modeling_ctrl.py#L515",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16592/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
model = CTRLForSequenceClassification.from_pretrained(
    "ctrl", num_labels=num_labels, problem_type="multi_label_classification"
)
...
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;ctrl&quot;</span>, num_labels=num_labels, problem_type=<span class="hljs-string">&quot;multi_label_classification&quot;</span>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16592/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),Po=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/models/ctrl/modeling_tf_ctrl.py#L521",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16592/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16592/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new $t({props:{$$slots:{default:[np]},$$scope:{ctx:J}}}),Do=new Fe({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/models/ctrl/modeling_tf_ctrl.py#L631",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16592/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16592/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[ap]},$$scope:{ctx:J}}}),Go=new Fe({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16592/src/transformers/models/ctrl/modeling_tf_ctrl.py#L742",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),{c(){h=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),k(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),D=a("span"),k(Z.$$.fragment),Te=l(),A=a("span"),ve=n("Overview"),pe=l(),x=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ke=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Oa=n(" for more information."),Na=l(),Pn=a("p"),Da=n("Examples:"),Aa=l(),k(Yt.$$.fragment),Fs=l(),ht=a("h2"),Mt=a("a"),xn=a("span"),k(Zt.$$.fragment),Ha=l(),jn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Oe=a("div"),k(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ja=l(),sn=a("div"),k(oo.$$.fragment),zs=l(),ut=a("h2"),Et=a("a"),In=a("span"),k(no.$$.fragment),Qa=l(),On=a("span"),Ya=n("CTRLModel"),Ps=l(),$e=a("div"),k(so.$$.fragment),Za=l(),Nn=a("p"),er=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),tr=l(),ao=a("p"),or=n("This model inherits from "),an=a("a"),nr=n("PreTrainedModel"),sr=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=l(),je=a("div"),k(go.$$.fragment),Pr=l(),gt=a("p"),xr=n("The "),dn=a("a"),jr=n("CTRLLMHeadModel"),Sr=n(" forward method, overrides the "),Un=a("code"),Ir=n("__call__"),Or=n(" special method."),Nr=l(),k(zt.$$.fragment),Dr=l(),Vn=a("p"),Ar=n("Example:"),Hr=l(),k(_o.$$.fragment),Ss=l(),_t=a("h2"),Pt=a("a"),Gn=a("span"),k(To.$$.fragment),Wr=l(),Kn=a("span"),Br=n("CTRLForSequenceClassification"),Is=l(),Me=a("div"),k(vo.$$.fragment),Ur=l(),Ee=a("p"),Vr=n(`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),k(Co.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(xt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),yi=l(),k(Lo.$$.fragment),Ci=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Os=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ns=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),Pi=n("TFPreTrainedModel"),xi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation from `),on=r(yn,"A",{href:!0});var Ed=i(on);Ia=s(Ed,"PretrainedConfig"),Ed.forEach(t),Oa=s(yn," for more information."),yn.forEach(t),Na=d(et),Pn=r(et,"P",{});var Fd=i(Pn);Da=s(Fd,"Examples:"),Fd.forEach(t),Aa=d(et),b(Yt.$$.fragment,et),et.forEach(t),Fs=d(o),ht=r(o,"H2",{class:!0});var Ks=i(ht);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);xn=r(qd,"SPAN",{});var zd=i(xn);b(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),jn=r(Ks,"SPAN",{});var Pd=i(jn);Wa=s(Pd,"CTRLTokenizer"),Pd.forEach(t),Ks.forEach(t),qs=d(o),Oe=r(o,"DIV",{class:!0});var Vt=i(Oe);b(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var xd=i(Sn);Ua=s(xd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),xd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var jd=i(nn);Ka=s(jd,"PreTrainedTokenizer"),jd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),xe=r(tt,"DIV",{class:!0});var ot=i(xe);b(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var Cn=i(mt);pr=s(Cn,"The "),rn=r(Cn,"A",{href:!0});var Wd=i(rn);hr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(Cn," forward method, overrides the "),Dn=r(Cn,"CODE",{});var Bd=i(Dn);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(Cn," special method."),Cn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),An=r(ot,"P",{});var Ud=i(An);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),xs=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(po.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(ho.$$.fragment,nt),yr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);Cr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta.forEach(t),zr=d(nt),je=r(nt,"DIV",{class:!0});var st=i(je);b(go.$$.fragment,st),Pr=d(st),gt=r(st,"P",{});var wn=i(gt);xr=s(wn,"The "),dn=r(wn,"A",{href:!0});var Yd=i(dn);jr=s(Yd,"CTRLLMHeadModel"),Yd.forEach(t),Sr=s(wn," forward method, overrides the "),Un=r(wn,"CODE",{});var Zd=i(Un);Ir=s(Zd,"__call__"),Zd.forEach(t),Or=s(wn," special method."),wn.forEach(t),Nr=d(st),b(zt.$$.fragment,st),Dr=d(st),Vn=r(st,"P",{});var ec=i(Vn);Ar=s(ec,"Example:"),ec.forEach(t),Hr=d(st),b(_o.$$.fragment,st),st.forEach(t),nt.forEach(t),Ss=d(o),_t=r(o,"H2",{class:!0});var oa=i(_t);Pt=r(oa,"A",{id:!0,class:!0,href:!0});var tc=i(Pt);Gn=r(tc,"SPAN",{});var oc=i(Gn);b(To.$$.fragment,oc),oc.forEach(t),tc.forEach(t),Wr=d(oa),Kn=r(oa,"SPAN",{});var nc=i(Kn);Br=s(nc,"CTRLForSequenceClassification"),nc.forEach(t),oa.forEach(t),Is=d(o),Me=r(o,"DIV",{class:!0});var at=i(Me);b(vo.$$.fragment,at),Ur=d(at),Ee=r(at,"P",{});var Ve=i(Ee);Vr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
