...
of tokens.`),I.forEach(t),E=g(v),k(A.$$.fragment,v),this.h()},h(){d(a,"href","/docs/transformers/pr_16528/en/internal/generation_utils#transformers.tf_top_k_top_p_filtering")},m(v,I){h(v,n,I),e(n,u),e(n,a),e(a,f),e(n,_),h(v,E,I),w(A,v,I),z=!0},p:C,i(v){z||(x(A.$$.fragment,v),z=!0)},o(v){b(A.$$.fragment,v),z=!1},d(v){v&&t(n),v&&t(E),y(A,v)}}}function mj($){let n,u;return n=new S({props:{$$slots:{default:[uj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function gj($){let n,u,a,f,_,E,A,z,v,I,F,Vs,gs,As,Js,K,Is,fs,We,Ks,G,ds,zs,Zs,Z,U,Ye,Ls,se,us,ss;return n=new q({props:{code:`from transformers import pipeline
...
overridden in the pipeline, as is shown above for the arguments `),As=l("code"),Js=o("max_length"),K=o(" and "),Is=l("code"),fs=o("do_sample"),We=o("."),Ks=m(),G=l("p"),ds=o("Below is an example of text generation using "),zs=l("code"),Zs=o("XLNet"),Z=o(" and its tokenizer, which includes calling "),U=l("code"),Ye=o("generate()"),Ls=o(" directly:"),se=m(),j(us.$$.fragment),this.h()},l(T){k(n.$$.fragment,T),u=g(T),a=i(T,"P",{});var L=p(a);f=r(L,"Here, the model generates a random text with a total maximal length of "),_=i(L,"EM",{});var na=p(_);E=r(na,"50"),na.forEach(t),A=r(L," tokens from context "),z=i(L,"EM",{});var _s=p(z);v=r(_s,`\u201CAs far as I am
concerned, I will\u201D`),_s.forEach(t),I=r(L,`. Behind the scenes, the pipeline object calls the method
...
overridden in the pipeline, as is shown above for the arguments `),As=i(L,"CODE",{});var js=p(As);Js=r(js,"max_length"),js.forEach(t),K=r(L," and "),Is=i(L,"CODE",{});var ra=p(Is);fs=r(ra,"do_sample"),ra.forEach(t),We=r(L,"."),L.forEach(t),Ks=g(T),G=i(T,"P",{});var ks=p(G);ds=r(ks,"Below is an example of text generation using "),zs=i(ks,"CODE",{});var Qe=p(zs);Zs=r(Qe,"XLNet"),Qe.forEach(t),Z=r(ks," and its tokenizer, which includes calling "),U=i(ks,"CODE",{});var Ms=p(U);Ye=r(Ms,"generate()"),Ms.forEach(t),Ls=r(ks," directly:"),ks.forEach(t),se=g(T),k(us.$$.fragment,T),this.h()},h(){d(F,"href","/docs/transformers/pr_16528/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate")},m(T,L){w(n,T,L),h(T,u,L),h(T,a,L),e(a,f),e(a,_),e(_,E),e(a,A),e(a,z),e(z,v),e(a,I),e(a,F),e(F,Vs),e(a,gs),e(a,As),e(As,Js),e(a,K),e(a,Is),e(Is,fs),e(a,We),h(T,Ks,L),h(T,G,L),e(G,ds),e(G,zs),e(zs,Zs),e(G,Z),e(G,U),e(U,Ye),e(G,Ls),h(T,se,L),w(us,T,L),ss=!0},p:C,i(T){ss||(x(n.$$.fragment,T),x(us.$$.fragment,T),ss=!0)},o(T){b(n.$$.fragment,T),b(us.$$.fragment,T),ss=!1},d(T){y(n,T),T&&t(u),T&&t(a),T&&t(Ks),T&&t(G),T&&t(se),y(us,T)}}}function fj($){let n,u;return n=new S({props:{$$slots:{default:[gj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function dj($){let n,u;return n=new q({props:{code:`from transformers import TFAutoModelForCausalLM, AutoTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_label`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function zj($){let n,u;return n=new S({props:{$$slots:{default:[Ij]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Lj($){let n,u;return n=new q({props:{code:`from transformers import AutoProcessor, AutoModelForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription[<span class="hljs-number">0</span>]`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Mj($){let n,u;return n=new S({props:{$$slots:{default:[Lj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Pj($){let n,u;return n=new q({props:{code:`from transformers import AutoFeatureExtractor, AutoModelForImageClassification
import torch
from datasets import load_dataset
...
Egyptian cat`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Fj($){let n,u;return n=new S({props:{$$slots:{default:[Pj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Nj($){let n,u,a,f,_,E,A,z,v,I,F,Vs,gs,As,Js,K,Is,fs,We,Ks,G,ds,zs,Zs,Z,U,Ye,Ls,se,us,ss,T,L,na,_s,oa,js,ra,ks,Qe,Ms,zi,ar,ee,Xa,Li,Mi,Va,Pi,nr,la,Fi,or,te,rr,Ps,ae,Ja,Xe,Ni,Ka,Ci,lr,W,Si,Ve,Di,Oi,Je,Ri,Bi,Ke,Hi,Gi,Ze,Ui,Wi,ir,ia,Yi,pr,pa,Qi,cr,st,hr,ca,Xi,ur,Y,Za,Vi,Ji,sn,Ki,Zi,en,sp,ep,tn,tp,ap,an,np,mr,ne,gr,Fs,oe,nn,et,op,on,rp,fr,ws,lp,tt,ip,pp,at,cp,hp,dr,ha,up,_r,nt,jr,ua,mp,kr,ot,wr,ma,gp,xr,D,rn,fp,dp,ln,_p,jp,pn,kp,wp,cn,xp,bp,hn,yp,$p,un,vp,qp,mn,Ep,br,re,yr,Ns,le,gn,rt,Tp,fn,Ap,$r,ga,Ip,vr,ie,zp,lt,Lp,Mp,qr,Cs,pe,dn,it,Pp,_n,Fp,Er,xs,Np,pt,Cp,Sp,ct,Dp,Op,Tr,fa,Rp,Ar,ht,Ir,da,Bp,zr,ut,Lr,_a,Hp,Mr,R,jn,Gp,Up,mt,Wp,kn,Yp,Qp,Xp,wn,Vp,Jp,xn,Kp,Zp,Ss,sc,bn,ec,tc,yn,ac,nc,oc,$n,rc,Pr,ce,Fr,ja,lc,Nr,Ds,he,vn,gt,ic,qn,pc,Cr,ue,cc,ft,hc,uc,Sr,ka,mc,Dr,me,Or,bs,gc,En,fc,dc,Tn,_c,jc,Rr,ge,kc,wa,wc,xc,Br,Os,fe,An,dt,bc,In,yc,Hr,B,$c,zn,vc,qc,Ln,Ec,Tc,Mn,Ac,Ic,Pn,zc,Lc,_t,Mc,Pc,Gr,de,Ur,M,Fc,Fn,Nc,Cc,Nn,Sc,Dc,Cn,Oc,Rc,Sn,Bc,Hc,Dn,Gc,Uc,On,Wc,Yc,Rn,Qc,Xc,Bn,Vc,Jc,Hn,Kc,Zc,Wr,_e,sh,jt,eh,th,Yr,Rs,je,Gn,kt,ah,Un,nh,Qr,ke,oh,wt,rh,lh,Xr,xa,ih,Vr,P,Wn,ph,ch,Yn,hh,uh,Qn,mh,gh,Xn,fh,dh,Vn,_h,jh,Jn,kh,wh,Kn,xh,bh,Zn,yh,$h,so,vh,Jr,ys,qh,xt,Eh,Th,bt,Ah,Ih,Kr,yt,Zr,ba,zh,sl,$t,el,ya,Lh,tl,$a,Mh,al,H,eo,Ph,Fh,to,Nh,Ch,ao,Sh,Dh,no,Oh,Rh,oo,Bh,Hh,ro,Gh,nl,we,ol,va,Uh,rl,$s,Wh,lo,Yh,Qh,io,Xh,Vh,ll,vt,il,Bs,xe,po,qt,Jh,co,Kh,pl,be,Zh,Et,su,eu,cl,ye,tu,Tt,au,nu,hl,qa,ou,ul,At,ml,Q,ru,ho,lu,iu,uo,pu,cu,mo,hu,uu,go,mu,gu,gl,It,fl,Ea,fu,dl,es,Hs,du,fo,_u,ju,_o,ku,wu,xu,jo,bu,yu,ko,$u,vu,zt,qu,wo,Eu,Tu,_l,Ta,Au,jl,$e,kl,Gs,ve,xo,Lt,Iu,bo,zu,wl,qe,Lu,Mt,Mu,Pu,xl,Ee,Fu,Pt,Nu,Cu,bl,Aa,Su,yl,Ft,$l,ts,Du,yo,Ou,Ru,$o,Bu,Hu,vo,Gu,Uu,vl,Ia,Wu,ql,as,Us,Yu,qo,Qu,Xu,Eo,Vu,Ju,Ku,To,Zu,sm,Ao,em,tm,Nt,am,Io,nm,om,El,Te,Tl,za,rm,Al,Ws,Ae,zo,Ct,lm,Lo,im,Il,ns,pm,St,cm,hm,Dt,um,mm,La,gm,fm,zl,Ie,dm,Ma,_m,jm,Ll,Ot,Ml,Pa,km,Pl,os,Mo,wm,xm,Po,bm,ym,Rt,$m,Fo,vm,qm,Em,Bt,Tm,No,Am,Im,Fl,ze,Nl,Ys,Le,Co,Ht,zm,So,Lm,Cl,X,Mm,Gt,Pm,Fm,Ut,Nm,Cm,Wt,Sm,Dm,Fa,Om,Rm,Sl,Me,Bm,Na,Hm,Gm,Dl,Yt,Ol,Ca,Um,Rl,rs,Do,Wm,Ym,Oo,Qm,Xm,Qt,Vm,Ro,Jm,Km,Zm,Bo,sg,Bl,Pe,Hl,Qs,Fe,Ho,Xt,eg,Go,tg,Gl,ls,ag,Vt,ng,og,Jt,rg,lg,Sa,ig,pg,Ul,Ne,cg,Da,hg,ug,Wl,Kt,Yl,Oa,mg,Ql,is,Uo,gg,fg,Wo,dg,_g,Zt,jg,Yo,kg,wg,xg,sa,bg,Qo,yg,$g,Xl,Ce,Vl;return E=new J({}),F=new V_({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Mixed",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/task_summary.ipynb"},{label:"PyTorch",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/pytorch/task_summary.ipynb"},{label:"TensorFlow",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/tensorflow/task_summary.ipynb"},{label:"Mixed",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/task_summary.ipynb"},{label:"PyTorch",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/pytorch/task_summary.ipynb"},{label:"TensorFlow",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/tensorflow/task_summary.ipynb"}]}}),te=new X_({props:{$$slots:{default:[J_]},$$scope:{ctx:$}}}),Xe=new J({}),st=new q({props:{code:`from transformers import pipeline
...
[{<span class="hljs-string">&#x27;label&#x27;</span>: <span class="hljs-string">&#x27;calm&#x27;</span>, <span class="hljs-string">&#x27;score&#x27;</span>: <span class="hljs-number">0.13856211304664612</span>},
 ...
 {<span class="hljs-string">&#x27;label&#x27;</span>: <span class="hljs-string">&#x27;fearful&#x27;</span>, <span class="hljs-string">&#x27;score&#x27;</span>: <span class="hljs-number">0.12404385954141617</span>}]`}}),ze=new ms({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{pytorch:[zj]},$$scope:{ctx:$}}}),Ht=new J({}),Yt=new q({props:{code:`from transformers import pipeline
...
automatically selecting the correct model architecture. Please check the `),fs=l("a"),We=o("AutoModel"),Ks=o(` documentation
...
following:`),Zs=m(),Z=l("ul"),U=l("li"),Ye=o(`Not all models were fine-tuned on all tasks. If you want to fine-tune a model on a specific task, you can leverage
...
each other. The process is the following:`),ur=m(),Y=l("ol"),Za=l("li"),Vi=o(`Instantiate a tokenizer and a model from the checkpoint name. The model is identified as a BERT model and loads it
...
on scientific papers e.g. `),lt=l("a"),Lp=o("LysandreJik/arxiv-nlp"),Mp=o("."),qr=m(),Cs=l("h3"),pe=l("a"),dn=l("span"),j(it.$$.fragment),Pp=m(),_n=l("span"),Fp=o("Masked Language Modeling"),Er=m(),xs=l("p"),Np=o(`Masked language modeling is the task of masking tokens in a sequence with a masking token, and prompting the model to
...
generate multiple tokens up to a specified length instead of one token at a time.`),Br=m(),Os=l("h3"),fe=l("a"),An=l("span"),j(dt.$$.fragment),bc=m(),In=l("span"),yc=o("Text Generation"),Hr=m(),B=l("p"),$c=o("In text generation ("),zn=l("em"),vc=o("a.k.a"),qc=m(),Ln=l("em"),Ec=o("open-ended text generation"),Tc=o(`) the goal is to create a coherent portion of text that is a
continuation from the given context. The following example shows how `),Mn=l("em"),Ac=o("GPT-2"),Ic=o(` can be used in pipelines to generate text.
As a default all models apply `),Pn=l("em"),zc=o("Top-K"),Lc=o(` sampling when used in pipelines, as configured in their respective configurations
(see `),_t=l("a"),Mc=o("gpt-2 config"),Pc=o(" for example)."),Gr=m(),j(de.$$.fragment),Ur=m(),M=l("p"),Fc=o("Text generation is currently possible with "),Fn=l("em"),Nc=o("GPT-2"),Cc=o(", "),Nn=l("em"),Sc=o("OpenAi-GPT"),Dc=o(", "),Cn=l("em"),Oc=o("CTRL"),Rc=o(", "),Sn=l("em"),Bc=o("XLNet"),Hc=o(", "),Dn=l("em"),Gc=o("Transfo-XL"),Uc=o(" and "),On=l("em"),Wc=o("Reformer"),Yc=o(` in
...
on millions of webpages with a causal language modeling objective.`),Wr=m(),_e=l("p"),sh=o(`For more information on how to apply different decoding strategies for text generation, please also refer to our text
generation blog post `),jt=l("a"),eh=o("here"),th=o("."),Yr=m(),Rs=l("h2"),je=l("a"),Gn=l("span"),j(kt.$$.fragment),ah=m(),Un=l("span"),nh=o("Named Entity Recognition"),Qr=m(),ke=l("p"),oh=o(`Named Entity Recognition (NER) is the task of classifying tokens according to a class, for example, identifying a token
...
token.`),rl=m(),$s=l("p"),Wh=o("In the above example, "),lo=l("code"),Yh=o("predictions"),Qh=o(` is an integer that corresponds to the predicted class. We can use the
...
CNN / Daily Mail), it yields very good results.`),jl=m(),j($e.$$.fragment),kl=m(),Gs=l("h2"),ve=l("a"),xo=l("span"),j(Lt.$$.fragment),Iu=m(),bo=l("span"),zu=o("Translation"),wl=m(),qe=l("p"),Lu=o(`Translation is the task of translating a text from one language to another. If you would like to fine-tune a model on a
...
arguments of `),$o=l("code"),Bu=o("PreTrainedModel.generate()"),Hu=o(" directly in the pipeline as is shown for "),vo=l("code"),Gu=o("max_length"),Uu=o(" above."),vl=m(),Ia=l("p"),Wu=o("Here is an example of doing translation using a model and a tokenizer. The process is the following:"),ql=m(),as=l("ol"),Us=l("li"),Yu=o(`Instantiate a tokenizer and a model from the checkpoint name. Summarization is usually done using an encoder-decoder
model, such as `),qo=l("code"),Qu=o("Bart"),Xu=o(" or "),Eo=l("code"),Vu=o("T5"),Ju=o("."),Ku=m(),To=l("li"),Zu=o("Define the article that should be summarized."),sm=m(),Ao=l("li"),em=o("Add the T5 specific prefix \u201Ctranslate English to German: \u201D"),tm=m(),Nt=l("li"),am=o("Use the "),Io=l("code"),nm=o("PreTrainedModel.generate()"),om=o(" method to perform the translation."),El=m(),j(Te.$$.fragment),Tl=m(),za=l("p"),rm=o("We get the same translation as with the pipeline example."),Al=m(),Ws=l("h2"),Ae=l("a"),zo=l("span"),j(Ct.$$.fragment),lm=m(),Lo=l("span"),im=o("Audio classification"),Il=m(),ns=l("p"),pm=o("Audio classification assigns a class to an audio signal. The Keyword Spotting dataset from the "),St=l("a"),cm=o("SUPERB"),hm=o(" benchmark is an example dataset that can be used for audio classification fine-tuning. This dataset contains ten classes of keywords for classification. If you\u2019d like to fine-tune a model for audio classification, take a look at the "),Dt=l("a"),um=o("run_audio_classification.py"),mm=o(" script or the how-to guide "),La=l("a"),gm=o("here"),fm=o("."),zl=m(),Ie=l("p"),dm=o("The following examples demonstrate how to use a "),Ma=l("a"),_m=o("pipeline()"),jm=o(" and a model and tokenizer for audio classification inference:"),Ll=m(),j(Ot.$$.fragment),Ml=m(),Pa=l("p"),km=o("The general process for using a model and tokenizer for audio classification is:"),Pl=m(),os=l("ol"),Mo=l("li"),wm=o("Instantiate a tokenizer and a model from the checkpoint name."),xm=m(),Po=l("li"),bm=o("Process the audio signal to be classified with a feature extractor."),ym=m(),Rt=l("li"),$m=o("Pass the input through the model and take the "),Fo=l("code"),vm=o("argmax"),qm=o(" to retrieve the most likely class."),Em=m(),Bt=l("li"),Tm=o("Convert the class id to a class name with "),No=l("code"),Am=o("id2label"),Im=o(" to return an interpretable result."),Fl=m(),j(ze.$$.fragment),Nl=m(),Ys=l("h2"),Le=l("a"),Co=l("span"),j(Ht.$$.fragment),zm=m(),So=l("span"),Lm=o("Automatic speech recognition"),Cl=m(),X=l("p"),Mm=o("Automatic speech recognition transcribes an audio signal to text. The "),Gt=l("a"),Pm=o("Common Voice"),Fm=o(" dataset is an example dataset that can be used for automatic speech recognition fine-tuning. It contains an audio file of a speaker and the corresponding sentence. If you\u2019d like to fine-tune a model for automatic speech recognition, take a look at the "),Ut=l("a"),Nm=o("run_speech_recognition_ctc.py"),Cm=o(" or "),Wt=l("a"),Sm=o("run_speech_recognition_seq2seq.py"),Dm=o("scripts or the how-to guide "),Fa=l("a"),Om=o("here"),Rm=o("."),Sl=m(),Me=l("p"),Bm=o("The following examples demonstrate how to use a "),Na=l("a"),Hm=o("pipeline()"),Gm=o(" and a model and tokenizer for automatic speech recognition inference:"),Dl=m(),j(Yt.$$.fragment),Ol=m(),Ca=l("p"),Um=o("The general process for using a model and tokenizer for automatic speech recognition is:"),Rl=m(),rs=l("ol"),Do=l("li"),Wm=o("Instantiate a tokenizer and a model from the checkpoint name."),Ym=m(),Oo=l("li"),Qm=o("Process the audio signal and text with a processor."),Xm=m(),Qt=l("li"),Vm=o("Pass the input through the model and take the "),Ro=l("code"),Jm=o("argmax"),Km=o(" to retrieve the predicted text."),Zm=m(),Bo=l("li"),sg=o("Decode the text with a tokenizer to obtain the transcription."),Bl=m(),j(Pe.$$.fragment),Hl=m(),Qs=l("h2"),Fe=l("a"),Ho=l("span"),j(Xt.$$.fragment),eg=m(),Go=l("span"),tg=o("Image classification"),Gl=m(),ls=l("p"),ag=o("Like text and audio classification, image classification assigns a class to an image. The "),Vt=l("a"),ng=o("CIFAR-100"),og=o(" dataset is an example dataset that can be used for image classification fine-tuning. It contains an image and the corresponding class. If you\u2019d like to fine-tune a model for image classification, take a look at the "),Jt=l("a"),rg=o("run_image_classification.py"),lg=o(" script or the how-to guide "),Sa=l("a"),ig=o("here"),pg=o("."),Ul=m(),Ne=l("p"),cg=o("The following examples demonstrate how to use a "),Da=l("a"),hg=o("pipeline()"),ug=o(" and a model and tokenizer for image classification inference:"),Wl=m(),j(Kt.$$.fragment),Yl=m(),Oa=l("p"),mg=o("The general process for using a model and tokenizer for image classification is:"),Ql=m(),is=l("ol"),Uo=l("li"),gg=o("Instantiate a tokenizer and a model from the checkpoint name."),fg=m(),Wo=l("li"),dg=o("Process the image to be classified with a feature extractor."),_g=m(),Zt=l("li"),jg=o("Pass the input through the model and take the "),Yo=l("code"),kg=o("argmax"),wg=o(" to retrieve the predicted class."),xg=m(),sa=l("li"),bg=o("Convert the class id to a class name with "),Qo=l("code"),yg=o("id2label"),$g=o(" to return an interpretable result."),Xl=m(),j(Ce.$$.fragment),this.h()},l(s){const c=Y_('[data-svelte="svelte-1phssyn"]',document.head);n=i(c,"META",{name:!0,content:!0}),c.forEach(t),u=g(s),a=i(s,"H1",{class:!0});var ea=p(a);f=i(ea,"A",{id:!0,class:!0,href:!0});var Xo=p(f);_=i(Xo,"SPAN",{});var Vo=p(_);k(E.$$.fragment,Vo),Vo.forEach(t),Xo.forEach(t),A=g(ea),z=i(ea,"SPAN",{});var Jo=p(z);v=r(Jo,"Summary of the tasks"),Jo.forEach(t),ea.forEach(t),I=g(s),k(F.$$.fragment,s),Vs=g(s),gs=i(s,"P",{});var Ko=p(gs);As=r(Ko,`This page shows the most frequent use-cases when using the library. The models available allow for many different
configurations and a great versatility in use-cases. The most simple ones are presented here, showcasing usage for
...
automatically selecting the correct model architecture. Please check the `),fs=i(ta,"A",{href:!0});var Zo=p(fs);We=r(Zo,"AutoModel"),Zo.forEach(t),Ks=r(ta,` documentation
...
checkpoints are usually pre-trained on a large corpus of data and fine-tuned on a specific task. This means the
following:`),sr.forEach(t),Zs=g(s),Z=i(s,"UL",{});var aa=p(Z);U=i(aa,"LI",{});var Xs=p(U);Ye=r(Xs,`Not all models were fine-tuned on all tasks. If you want to fine-tune a model on a specific task, you can leverage
...
each other. The process is the following:`),Dg.forEach(t),ur=g(s),Y=i(s,"OL",{});var qs=p(Y);Za=i(qs,"LI",{});var Og=p(Za);Vi=r(Og,`Instantiate a tokenizer and a model from the checkpoint name. The model is identified as a BERT model and loads it
...
paraphrase) and 1 (is a paraphrase).`),Bg.forEach(t),ep=g(qs),tn=i(qs,"LI",{});var Hg=p(tn);tp=r(Hg,"Compute the softmax of the result to get probabilities over the classes."),Hg.forEach(t),ap=g(qs),an=i(qs,"LI",{});var Gg=p(an);np=r(Gg,"Print the results."),Gg.forEach(t),qs.forEach(t),mr=g(s),k(ne.$$.fragment,s),gr=g(s),Fs=i(s,"H2",{class:!0});var si=p(Fs);oe=i(si,"A",{id:!0,class:!0,href:!0});var Ug=p(oe);nn=i(Ug,"SPAN",{});var Wg=p(nn);k(et.$$.fragment,Wg),Wg.forEach(t),Ug.forEach(t),op=g(si),on=i(si,"SPAN",{});var Yg=p(on);rp=r(Yg,"Extractive Question Answering"),Yg.forEach(t),si.forEach(t),fr=g(s),ws=i(s,"P",{});var Ra=p(ws);lp=r(Ra,`Extractive Question Answering is the task of extracting an answer from a text given a question. An example of a
question answering dataset is the SQuAD dataset, which is entirely based on that task. If you would like to fine-tune a
...
model only attends to the left context (tokens on the left of the mask). Such a training is particularly interesting
for generation tasks. If you would like to fine-tune a model on a causal language modeling task, you may leverage the
`),ft=i(ri,"A",{href:!0,rel:!0});var zf=p(ft);hc=r(zf,"run_clm.py"),zf.forEach(t),uc=r(ri," script."),ri.forEach(t),Sr=g(s),ka=i(s,"P",{});var Lf=p(ka);mc=r(Lf,`Usually, the next token is predicted by sampling from the logits of the last hidden state the model produces from the
...
generate multiple tokens up to a specified length instead of one token at a time.`),li.forEach(t),Br=g(s),Os=i(s,"H3",{class:!0});var ii=p(Os);fe=i(ii,"A",{id:!0,class:!0,href:!0});var Nf=p(fe);An=i(Nf,"SPAN",{});var Cf=p(An);k(dt.$$.fragment,Cf),Cf.forEach(t),Nf.forEach(t),bc=g(ii),In=i(ii,"SPAN",{});var Sf=p(In);yc=r(Sf,"Text Generation"),Sf.forEach(t),ii.forEach(t),Hr=g(s),B=i(s,"P",{});var cs=p(B);$c=r(cs,"In text generation ("),zn=i(cs,"EM",{});var Df=p(zn);vc=r(Df,"a.k.a"),Df.forEach(t),qc=g(cs),Ln=i(cs,"EM",{});var Of=p(Ln);Ec=r(Of,"open-ended text generation"),Of.forEach(t),Tc=r(cs,`) the goal is to create a coherent portion of text that is a
continuation from the given context. The following example shows how `),Mn=i(cs,"EM",{});var Rf=p(Mn);Ac=r(Rf,"GPT-2"),Rf.forEach(t),Ic=r(cs,` can be used in pipelines to generate text.
As a default all models apply `),Pn=i(cs,"EM",{});var Bf=p(Pn);zc=r(Bf,"Top-K"),Bf.forEach(t),Lc=r(cs,` sampling when used in pipelines, as configured in their respective configurations
(see `),_t=i(cs,"A",{href:!0,rel:!0});var Hf=p(_t);Mc=r(Hf,"gpt-2 config"),Hf.forEach(t),Pc=r(cs," for example)."),cs.forEach(t),Gr=g(s),k(de.$$.fragment,s),Ur=g(s),M=i(s,"P",{});var N=p(M);Fc=r(N,"Text generation is currently possible with "),Fn=i(N,"EM",{});var Gf=p(Fn);Nc=r(Gf,"GPT-2"),Gf.forEach(t),Cc=r(N,", "),Nn=i(N,"EM",{});var Uf=p(Nn);Sc=r(Uf,"OpenAi-GPT"),Uf.forEach(t),Dc=r(N,", "),Cn=i(N,"EM",{});var Wf=p(Cn);Oc=r(Wf,"CTRL"),Wf.forEach(t),Rc=r(N,", "),Sn=i(N,"EM",{});var Yf=p(Sn);Bc=r(Yf,"XLNet"),Yf.forEach(t),Hc=r(N,", "),Dn=i(N,"EM",{});var Qf=p(Dn);Gc=r(Qf,"Transfo-XL"),Qf.forEach(t),Uc=r(N," and "),On=i(N,"EM",{});var Xf=p(On);Wc=r(Xf,"Reformer"),Xf.forEach(t),Yc=r(N,` in
...
on millions of webpages with a causal language modeling objective.`),N.forEach(t),Wr=g(s),_e=i(s,"P",{});var pi=p(_e);sh=r(pi,`For more information on how to apply different decoding strategies for text generation, please also refer to our text
generation blog post `),jt=i(pi,"A",{href:!0,rel:!0});var Zf=p(jt);eh=r(Zf,"here"),Zf.forEach(t),th=r(pi,"."),pi.forEach(t),Yr=g(s),Rs=i(s,"H2",{class:!0});var ci=p(Rs);je=i(ci,"A",{id:!0,class:!0,href:!0});var sd=p(je);Gn=i(sd,"SPAN",{});var ed=p(Gn);k(kt.$$.fragment,ed),ed.forEach(t),sd.forEach(t),ah=g(ci),Un=i(ci,"SPAN",{});var td=p(Un);nh=r(td,"Named Entity Recognition"),td.forEach(t),ci.forEach(t),Qr=g(s),ke=i(s,"P",{});var hi=p(ke);oh=r(hi,`Named Entity Recognition (NER) is the task of classifying tokens according to a class, for example, identifying a token
as a person, an organisation or a location. An example of a named entity recognition dataset is the CoNLL-2003 dataset,
which is entirely based on that task. If you would like to fine-tune a model on an NER task, you may leverage the
...
token has a prediction as we didn\u2019t remove the \u201C0\u201Dth class, which means that no particular entity was found on that
token.`),vd.forEach(t),rl=g(s),$s=i(s,"P",{});var Wa=p($s);Wh=r(Wa,"In the above example, "),lo=i(Wa,"CODE",{});var qd=p(lo);Yh=r(qd,"predictions"),qd.forEach(t),Qh=r(Wa,` is an integer that corresponds to the predicted class. We can use the
`),io=i(Wa,"CODE",{});var Ed=p(io);Xh=r(Ed,"model.config.id2label"),Ed.forEach(t),Vh=r(Wa,` property in order to recover the class name corresponding to the class number, which is
illustrated below:`),Wa.forEach(t),ll=g(s),k(vt.$$.fragment,s),il=g(s),Bs=i(s,"H2",{class:!0});var ui=p(Bs);xe=i(ui,"A",{id:!0,class:!0,href:!0});var Td=p(xe);po=i(Td,"SPAN",{});var Ad=p(po);k(qt.$$.fragment,Ad),Ad.forEach(t),Td.forEach(t),Jh=g(ui),co=i(ui,"SPAN",{});var Id=p(co);Kh=r(Id,"Summarization"),Id.forEach(t),ui.forEach(t),pl=g(s),be=i(s,"P",{});var mi=p(be);Zh=r(mi,`Summarization is the task of summarizing a document or an article into a shorter text. If you would like to fine-tune a
...
/ Daily Mail data set.`),Md.forEach(t),ul=g(s),k(At.$$.fragment,s),ml=g(s),Q=i(s,"P",{});var Es=p(Q);ru=r(Es,"Because the summarization pipeline depends on the "),ho=i(Es,"CODE",{});var Pd=p(ho);lu=r(Pd,"PreTrainedModel.generate()"),Pd.forEach(t),iu=r(Es,` method, we can override the default
...
below. This outputs the following summary:`),Es.forEach(t),gl=g(s),k(It.$$.fragment,s),fl=g(s),Ea=i(s,"P",{});var Sd=p(Ea);fu=r(Sd,"Here is an example of doing summarization using a model and a tokenizer. The process is the following:"),Sd.forEach(t),dl=g(s),es=i(s,"OL",{});var Se=p(es);Hs=i(Se,"LI",{});var Ya=p(Hs);du=r(Ya,`Instantiate a tokenizer and a model from the checkpoint name. Summarization is usually done using an encoder-decoder
model, such as `),fo=i(Ya,"CODE",{});var Dd=p(fo);_u=r(Dd,"Bart"),Dd.forEach(t),ju=r(Ya," or "),_o=i(Ya,"CODE",{});var Od=p(_o);ku=r(Od,"T5"),Od.forEach(t),wu=r(Ya,"."),Ya.forEach(t),xu=g(Se),jo=i(Se,"LI",{});var Rd=p(jo);bu=r(Rd,"Define the article that should be summarized."),Rd.forEach(t),yu=g(Se),ko=i(Se,"LI",{});var Bd=p(ko);$u=r(Bd,"Add the T5 specific prefix \u201Csummarize: \u201C."),Bd.forEach(t),vu=g(Se),zt=i(Se,"LI",{});var fi=p(zt);qu=r(fi,"Use the "),wo=i(fi,"CODE",{});var Hd=p(wo);Eu=r(Hd,"PreTrainedModel.generate()"),Hd.forEach(t),Tu=r(fi," method to generate the summary."),fi.forEach(t),Se.forEach(t),_l=g(s),Ta=i(s,"P",{});var Gd=p(Ta);Au=r(Gd,`In this example we use Google\u2019s T5 model. Even though it was pre-trained only on a multi-task mixed dataset (including
CNN / Daily Mail), it yields very good results.`),Gd.forEach(t),jl=g(s),k($e.$$.fragment,s),kl=g(s),Gs=i(s,"H2",{class:!0});var di=p(Gs);ve=i(di,"A",{id:!0,class:!0,href:!0});var Ud=p(ve);xo=i(Ud,"SPAN",{});var Wd=p(xo);k(Lt.$$.fragment,Wd),Wd.forEach(t),Ud.forEach(t),Iu=g(di),bo=i(di,"SPAN",{});var Yd=p(bo);zu=r(Yd,"Translation"),Yd.forEach(t),di.forEach(t),wl=g(s),qe=i(s,"P",{});var _i=p(qe);Lu=r(_i,`Translation is the task of translating a text from one language to another. If you would like to fine-tune a model on a
translation task, you may leverage the `),Mt=i(_i,"A",{href:!0,rel:!0});var Qd=p(Mt);Mu=r(Qd,"run_translation.py"),Qd.forEach(t),Pu=r(_i," script."),_i.forEach(t),xl=g(s),Ee=i(s,"P",{});var ji=p(Ee);Fu=r(ji,`An example of a translation dataset is the WMT English to German dataset, which has sentences in English as the input
data and the corresponding sentences in German as the target data. If you would like to fine-tune a model on a
