import{S as Hd,i as Ud,s as Vd,e as n,k as l,w as m,t as r,M as Jd,c as s,d as o,m as c,a,x as f,h as i,b as d,F as e,g as h,y as g,q as _,o as b,B as k}from"../../chunks/vendor-6b77c823.js";import{T as fi}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as ue}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";function Kd(Q){let u,L,v,w,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),q=r(`
...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);L=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var C=a(v);w=i(C,"Module"),C.forEach(o),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,L),e(u,v),e(v,w),e(u,q)},d(T){T&&o(u)}}}function Zd(Q){let u,L,v,w,q,T,y,C,Zn,on,I,ao,es,ts,Fe,os,ns,je,ss,as,nn,Y,fe,ro,Ee,rs,io,is,sn,X,ds,Me,ls,cs,lo,ps,hs,an,jt,us,rn,Et,co,ms,dn,G,fs,Se,gs,_s,Ae,bs,ks,ln,Z,ge,po,Ne,vs,ho,Ts,cn,F,ys,uo,ws,Ps,mo,Ls,zs,fo,qs,Bs,go,$s,xs,pn,_e,Cs,Oe,Fs,js,hn,R,Es,Ie,_o,Ms,Ss,As,Mt,Ns,Os,un,St,bo,Is,mn,De,fn,At,Xe,ko,Ds,Xs,ee,Gs,vo,Rs,Ws,To,Hs,Us,gn,Ge,_n,te,be,yo,Re,Vs,wo,Js,bn,$,We,Ks,oe,Qs,Nt,Ys,Zs,He,ea,ta,oa,ne,na,Ot,sa,aa,It,ra,ia,da,Po,la,ca,Ue,kn,se,ke,Lo,Ve,pa,zo,ha,vn,P,Je,ua,qo,ma,fa,D,ga,Dt,_a,ba,Xt,ka,va,Ke,Ta,ya,wa,Qe,Pa,Bo,La,za,qa,$o,Ba,$a,Ye,xa,ve,Ze,Ca,xo,Fa,ja,N,et,Ea,tt,Ma,Co,Sa,Aa,Na,ot,nt,Fo,Oa,Ia,jo,Da,Xa,st,Eo,Ga,Ra,Mo,Wa,Ha,So,Ua,Tn,ae,Te,Ao,at,Va,No,Ja,yn,S,rt,Ka,it,Qa,Gt,Ya,Za,er,dt,tr,lt,or,nr,sr,j,ct,ar,re,rr,Rt,ir,dr,Oo,lr,cr,pr,ye,hr,Io,ur,mr,pt,wn,ie,we,Do,ht,fr,Xo,gr,Pn,A,ut,_r,mt,br,Wt,kr,vr,Tr,ft,yr,gt,wr,Pr,Lr,E,_t,zr,de,qr,Ht,Br,$r,Go,xr,Cr,Fr,Pe,jr,Ro,Er,Mr,bt,Ln,le,Le,Wo,kt,Sr,Ho,Ar,zn,x,vt,Nr,Uo,Or,Ir,Tt,Dr,Ut,Xr,Gr,Rr,yt,Wr,wt,Hr,Ur,Vr,z,Pt,Jr,ce,Kr,Vt,Qr,Yr,Vo,Zr,ei,ti,ze,oi,Jo,ni,si,Lt,ai,Ko,ri,ii,zt,qn,pe,qe,Qo,qt,di,Yo,li,Bn,he,Bt,ci,W,$t,pi,Zo,hi,ui,xt,$n;return T=new me({}),Ee=new me({}),Ne=new me({}),De=new ue({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),qt=new me({}),Bt=new O({props:{name:"class transformers.PLBartForCausalLM",anchor:"transformers.PLBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/models/plbart/modeling_plbart.py#L1531"}}),$t=new O({props:{name:"forward",anchor:"transformers.PLBartForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/models/plbart/modeling_plbart.py#L1562",parametersDescription:[{anchor:"transformers.PLBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),L=l(),v=n("h1"),w=n("a"),q=n("span"),m(T.$$.fragment),y=l(),C=n("span"),Zn=r("PLBart"),on=l(),I=n("p"),ao=n("strong"),es=r("DISCLAIMER:"),ts=r(" If you see something strange, file a "),Fe=n("a"),os=r("Github Issue"),ns=r(` and assign
`),je=n("a"),ss=r("@gchhablani"),as=r("."),nn=l(),Y=n("h2"),fe=n("a"),ro=n("span"),m(Ee.$$.fragment),rs=l(),io=n("span"),is=r("Overview of PLBart"),sn=l(),X=n("p"),ds=r("The PLBART model was proposed in "),Me=n("a"),ls=r("Unified Pre-training for Program Understanding and Generation"),cs=r(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
on Java, Python and English.`),an=l(),jt=n("p"),us=r("According to the abstract"),rn=l(),Et=n("p"),co=n("em"),ms=r(`Code summarization and generation empower conversion between programming language (PL) and natural language (NL),
...
target text format is `),fo=n("code"),qs=r("[tgt_lang_code] X [eos]"),Bs=r(". "),go=n("code"),$s=r("bos"),xs=r(" is never used."),pn=l(),_e=n("p"),Cs=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=n("a"),Fs=r("the paper"),js=r(" to learn more about this."),hn=l(),R=n("p"),Es=r("In cases where the language code is needed, The regular "),Ie=n("a"),_o=n("strong"),Ms=r("call"),Ss=r("()"),As=r(` will encode source text format, and it should be wrapped
inside the context manager `),Mt=n("a"),Ns=r("as_target_tokenizer()"),Os=r(" to encode target text format."),un=l(),St=n("ul"),bo=n("li"),Is=r("Supervised training"),mn=l(),m(De.$$.fragment),fn=l(),At=n("ul"),Xe=n("li"),ko=n("p"),Ds=r("Generation"),Xs=l(),ee=n("p"),Gs=r("While generating the target text set the "),vo=n("code"),Rs=r("decoder_start_token_id"),Ws=r(` to the target language id. The following
...
`),He=n("a"),ea=r("uclanlp/plbart-base"),ta=r(" architecture."),oa=l(),ne=n("p"),na=r("Configuration objects inherit from "),Ot=n("a"),sa=r("PretrainedConfig"),aa=r(` and can be used to control the model outputs. Read the
documentation from `),It=n("a"),ra=r("PretrainedConfig"),ia=r(" for more information."),da=l(),Po=n("p"),la=r("Example:"),ca=l(),m(Ue.$$.fragment),kn=l(),se=n("h2"),ke=n("a"),Lo=n("span"),m(Ve.$$.fragment),pa=l(),zo=n("span"),ha=r("PLBartTokenizer"),vn=l(),P=n("div"),m(Je.$$.fragment),ua=l(),qo=n("p"),ma=r("Construct an PLBART tokenizer."),fa=l(),D=n("p"),ga=r("Adapted from "),Dt=n("a"),_a=r("RobertaTokenizer"),ba=r(" and "),Xt=n("a"),ka=r("XLNetTokenizer"),va=r(`. Based on
`),Ke=n("a"),Ta=r("SentencePiece"),ya=r("."),wa=l(),Qe=n("p"),Pa=r("The tokenization method is "),Bo=n("code"),La=r("<tokens> <eos> <language code>"),za=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),qa=l(),$o=n("p"),Ba=r("Examples:"),$a=l(),m(Ye.$$.fragment),xa=l(),ve=n("div"),m(Ze.$$.fragment),Ca=l(),xo=n("p"),Fa=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),ja=l(),N=n("div"),m(et.$$.fragment),Ea=l(),tt=n("p"),Ma=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An PLBART sequence has the following format, where `),Co=n("code"),Sa=r("X"),Aa=r(" represents the sequence:"),Na=l(),ot=n("ul"),nt=n("li"),Fo=n("code"),Oa=r("input_ids"),Ia=r(" (for encoder) "),jo=n("code"),Da=r("X [eos, src_lang_code]"),Xa=l(),st=n("li"),Eo=n("code"),Ga=r("decoder_input_ids"),Ra=r(": (for decoder) "),Mo=n("code"),Wa=r("X [eos, tgt_lang_code]"),Ha=l(),So=n("p"),Ua=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
on Java, Python and English.`),Jt.forEach(o),an=c(t),jt=s(t,"P",{});var Li=a(jt);us=i(Li,"According to the abstract"),Li.forEach(o),rn=c(t),Et=s(t,"P",{});var zi=a(Et);co=s(zi,"EM",{});var qi=a(co);ms=i(qi,`Code summarization and generation empower conversion between programming language (PL) and natural language (NL),
while code translation avails the migration of legacy code from one PL to another. This paper introduces PLBART,
a sequence-to-sequence model capable of performing a broad spectrum of program and language understanding and generation tasks.
PLBART is pre-trained on an extensive collection of Java and Python functions and associated NL text via denoising autoencoding.
Experiments on code summarization in the English language, code generation, and code translation in seven programming languages
...
Furthermore, analysis reveals that PLBART learns program syntax, style (e.g., identifier naming convention), logical flow
(e.g., if block inside an else block is equivalent to else if block) that are crucial to program semantics and thus excels
even with limited annotations.`),qi.forEach(o),zi.forEach(o),dn=c(t),G=s(t,"P",{});var Kt=a(G);fs=i(Kt,"This model was contributed by "),Se=s(Kt,"A",{href:!0,rel:!0});var Bi=a(Se);gs=i(Bi,"gchhablani"),Bi.forEach(o),_s=i(Kt,". The Authors\u2019 code can be found "),Ae=s(Kt,"A",{href:!0,rel:!0});var $i=a(Ae);bs=i($i,"here"),$i.forEach(o),ks=i(Kt,"."),Kt.forEach(o),ln=c(t),Z=s(t,"H3",{class:!0});var Cn=a(Z);ge=s(Cn,"A",{id:!0,class:!0,href:!0});var xi=a(ge);po=s(xi,"SPAN",{});var Ci=a(po);f(Ne.$$.fragment,Ci),Ci.forEach(o),xi.forEach(o),vs=c(Cn),ho=s(Cn,"SPAN",{});var Fi=a(ho);Ts=i(Fi,"Training of PLBart"),Fi.forEach(o),Cn.forEach(o),cn=c(t),F=s(t,"P",{});var H=a(F);ys=i(H,`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),uo=s(H,"CODE",{});var ji=a(uo);ws=i(ji,"X [eos, src_lang_code]"),ji.forEach(o),Ps=i(H," where "),mo=s(H,"CODE",{});var Ei=a(mo);Ls=i(Ei,"X"),Ei.forEach(o),zs=i(H,` is the source text. The
target text format is `),fo=s(H,"CODE",{});var Mi=a(fo);qs=i(Mi,"[tgt_lang_code] X [eos]"),Mi.forEach(o),Bs=i(H,". "),go=s(H,"CODE",{});var Si=a(go);$s=i(Si,"bos"),Si.forEach(o),xs=i(H," is never used."),H.forEach(o),pn=c(t),_e=s(t,"P",{});var Fn=a(_e);Cs=i(Fn,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=s(Fn,"A",{href:!0,rel:!0});var Ai=a(Oe);Fs=i(Ai,"the paper"),Ai.forEach(o),js=i(Fn," to learn more about this."),Fn.forEach(o),hn=c(t),R=s(t,"P",{});var Qt=a(R);Es=i(Qt,"In cases where the language code is needed, The regular "),Ie=s(Qt,"A",{href:!0});var mi=a(Ie);_o=s(mi,"STRONG",{});var Ni=a(_o);Ms=i(Ni,"call"),Ni.forEach(o),Ss=i(mi,"()"),mi.forEach(o),As=i(Qt,` will encode source text format, and it should be wrapped
inside the context manager `),Mt=s(Qt,"A",{href:!0});var Oi=a(Mt);Ns=i(Oi,"as_target_tokenizer()"),Oi.forEach(o),Os=i(Qt," to encode target text format."),Qt.forEach(o),un=c(t),St=s(t,"UL",{});var Ii=a(St);bo=s(Ii,"LI",{});var Di=a(bo);Is=i(Di,"Supervised training"),Di.forEach(o),Ii.forEach(o),mn=c(t),f(De.$$.fragment,t),fn=c(t),At=s(t,"UL",{});var Xi=a(At);Xe=s(Xi,"LI",{});var jn=a(Xe);ko=s(jn,"P",{});var Gi=a(ko);Ds=i(Gi,"Generation"),Gi.forEach(o),Xs=c(jn),ee=s(jn,"P",{});var Yt=a(ee);Gs=i(Yt,"While generating the target text set the "),vo=s(Yt,"CODE",{});var Ri=a(vo);Rs=i(Ri,"decoder_start_token_id"),Ri.forEach(o),Ws=i(Yt,` to the target language id. The following
example shows how to translate Python to English using the `),To=s(Yt,"CODE",{});var Wi=a(To);Hs=i(Wi,"uclanlp/plbart-python-en_XX"),Wi.forEach(o),Us=i(Yt," model."),Yt.forEach(o),jn.forEach(o),Xi.forEach(o),gn=c(t),f(Ge.$$.fragment,t),_n=c(t),te=s(t,"H2",{class:!0});var En=a(te);be=s(En,"A",{id:!0,class:!0,href:!0});var Hi=a(be);yo=s(Hi,"SPAN",{});var Ui=a(yo);f(Re.$$.fragment,Ui),Ui.forEach(o),Hi.forEach(o),Vs=c(En),wo=s(En,"SPAN",{});var Vi=a(wo);Js=i(Vi,"PLBartConfig"),Vi.forEach(o),En.forEach(o),bn=c(t),$=s(t,"DIV",{class:!0});var U=a($);f(We.$$.fragment,U),Ks=c(U),oe=s(U,"P",{});var Zt=a(oe);Qs=i(Zt,"This is the configuration class to store the configuration of a "),Nt=s(Zt,"A",{href:!0});var Ji=a(Nt);Ys=i(Ji,"PLBartModel"),Ji.forEach(o),Zs=i(Zt,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
`),He=s(Zt,"A",{href:!0,rel:!0});var Ki=a(He);ea=i(Ki,"uclanlp/plbart-base"),Ki.forEach(o),ta=i(Zt," architecture."),Zt.forEach(o),oa=c(U),ne=s(U,"P",{});var eo=a(ne);na=i(eo,"Configuration objects inherit from "),Ot=s(eo,"A",{href:!0});var Qi=a(Ot);sa=i(Qi,"PretrainedConfig"),Qi.forEach(o),aa=i(eo,` and can be used to control the model outputs. Read the
documentation from `),It=s(eo,"A",{href:!0});var Yi=a(It);ra=i(Yi,"PretrainedConfig"),Yi.forEach(o),ia=i(eo," for more information."),eo.forEach(o),da=c(U),Po=s(U,"P",{});var Zi=a(Po);la=i(Zi,"Example:"),Zi.forEach(o),ca=c(U),f(Ue.$$.fragment,U),U.forEach(o),kn=c(t),se=s(t,"H2",{class:!0});var Mn=a(se);ke=s(Mn,"A",{id:!0,class:!0,href:!0});var ed=a(ke);Lo=s(ed,"SPAN",{});var td=a(Lo);f(Ve.$$.fragment,td),td.forEach(o),ed.forEach(o),pa=c(Mn),zo=s(Mn,"SPAN",{});var od=a(zo);ha=i(od,"PLBartTokenizer"),od.forEach(o),Mn.forEach(o),vn=c(t),P=s(t,"DIV",{class:!0});var B=a(P);f(Je.$$.fragment,B),ua=c(B),qo=s(B,"P",{});var nd=a(qo);ma=i(nd,"Construct an PLBART tokenizer."),nd.forEach(o),fa=c(B),D=s(B,"P",{});var Be=a(D);ga=i(Be,"Adapted from "),Dt=s(Be,"A",{href:!0});var sd=a(Dt);_a=i(sd,"RobertaTokenizer"),sd.forEach(o),ba=i(Be," and "),Xt=s(Be,"A",{href:!0});var ad=a(Xt);ka=i(ad,"XLNetTokenizer"),ad.forEach(o),va=i(Be,`. Based on
`),Ke=s(Be,"A",{href:!0,rel:!0});var rd=a(Ke);Ta=i(rd,"SentencePiece"),rd.forEach(o),ya=i(Be,"."),Be.forEach(o),wa=c(B),Qe=s(B,"P",{});var Sn=a(Qe);Pa=i(Sn,"The tokenization method is "),Bo=s(Sn,"CODE",{});var id=a(Bo);La=i(id,"<tokens> <eos> <language code>"),id.forEach(o),za=i(Sn," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Sn.forEach(o),qa=c(B),$o=s(B,"P",{});var dd=a($o);Ba=i(dd,"Examples:"),dd.forEach(o),$a=c(B),f(Ye.$$.fragment,B),xa=c(B),ve=s(B,"DIV",{class:!0});var An=a(ve);f(Ze.$$.fragment,An),Ca=c(An),xo=s(An,"P",{});var ld=a(xo);Fa=i(ld,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),ld.forEach(o),An.forEach(o),ja=c(B),N=s(B,"DIV",{class:!0});var $e=a(N);f(et.$$.fragment,$e),Ea=c($e),tt=s($e,"P",{});var Nn=a(tt);Ma=i(Nn,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An PLBART sequence has the following format, where `),Co=s(Nn,"CODE",{});var cd=a(Co);Sa=i(cd,"X"),cd.forEach(o),Aa=i(Nn," represents the sequence:"),Nn.forEach(o),Na=c($e),ot=s($e,"UL",{});var On=a(ot);nt=s(On,"LI",{});var In=a(nt);Fo=s(In,"CODE",{});var pd=a(Fo);Oa=i(pd,"input_ids"),pd.forEach(o),Ia=i(In," (for encoder) "),jo=s(In,"CODE",{});var hd=a(jo);Da=i(hd,"X [eos, src_lang_code]"),hd.forEach(o),In.forEach(o),Xa=c(On),st=s(On,"LI",{});var Dn=a(st);Eo=s(Dn,"CODE",{});var ud=a(Eo);Ga=i(ud,"decoder_input_ids"),ud.forEach(o),Ra=i(Dn,": (for decoder) "),Mo=s(Dn,"CODE",{});var md=a(Mo);Wa=i(md,"X [eos, tgt_lang_code]"),md.forEach(o),Dn.forEach(o),On.forEach(o),Ha=c($e),So=s($e,"P",{});var fd=a(So);Ua=i(fd,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),sr=c(xe),j=s(xe,"DIV",{class:!0});var V=a(j);f(ct.$$.fragment,V),ar=c(V),re=s(V,"P",{});var to=a(re);rr=i(to,"The "),Rt=s(to,"A",{href:!0});var Td=a(Rt);ir=i(Td,"PLBartModel"),Td.forEach(o),dr=i(to," forward method, overrides the "),Oo=s(to,"CODE",{});var yd=a(Oo);lr=i(yd,"__call__"),yd.forEach(o),cr=i(to," special method."),to.forEach(o),pr=c(V),f(ye.$$.fragment,V),hr=c(V),Io=s(V,"P",{});var wd=a(Io);ur=i(wd,"Example:"),wd.forEach(o),mr=c(V),f(pt.$$.fragment,V),V.forEach(o),xe.forEach(o),wn=c(t),ie=s(t,"H2",{class:!0});var Wn=a(ie);we=s(Wn,"A",{id:!0,class:!0,href:!0});var Pd=a(we);Do=s(Pd,"SPAN",{});var Ld=a(Do);f(ht.$$.fragment,Ld),Ld.forEach(o),Pd.forEach(o),fr=c(Wn),Xo=s(Wn,"SPAN",{});var zd=a(Xo);gr=i(zd,"PLBartForConditionalGeneration"),zd.forEach(o),Wn.forEach(o),Pn=c(t),A=s(t,"DIV",{class:!0});var Ce=a(A);f(ut.$$.fragment,Ce),_r=c(Ce),mt=s(Ce,"P",{});var Hn=a(mt);br=i(Hn,`The PLBART Model with a language modeling head. Can be used for code-to-text, text-to-code and code-to-code.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Un.forEach(o),Lr=c(Ce),E=s(Ce,"DIV",{class:!0});var J=a(E);f(_t.$$.fragment,J),zr=c(J),de=s(J,"P",{});var oo=a(de);qr=i(oo,"The "),Ht=s(oo,"A",{href:!0});var $d=a(Ht);Br=i($d,"PLBartForConditionalGeneration"),$d.forEach(o),$r=i(oo," forward method, overrides the "),Go=s(oo,"CODE",{});var xd=a(Go);xr=i(xd,"__call__"),xd.forEach(o),Cr=i(oo," special method."),oo.forEach(o),Fr=c(J),f(Pe.$$.fragment,J),jr=c(J),Ro=s(J,"P",{});var Cd=a(Ro);Er=i(Cd,"Mask-filling example:"),Cd.forEach(o),Mr=c(J),f(bt.$$.fragment,J),J.forEach(o),Ce.forEach(o),Ln=c(t),le=s(t,"H2",{class:!0});var Vn=a(le);Le=s(Vn,"A",{id:!0,class:!0,href:!0});var Fd=a(Le);Wo=s(Fd,"SPAN",{});var jd=a(Wo);f(kt.$$.fragment,jd),jd.forEach(o),Fd.forEach(o),Sr=c(Vn),Ho=s(Vn,"SPAN",{});var Ed=a(Ho);Ar=i(Ed,"PLBartForSequenceClassification"),Ed.forEach(o),Vn.forEach(o),zn=c(t),x=s(t,"DIV",{class:!0});var K=a(x);f(vt.$$.fragment,K),Nr=c(K),Uo=s(K,"P",{});var Md=a(Uo);Or=i(Md,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Md.forEach(o),Ir=c(K),Tt=s(K,"P",{});var Jn=a(Tt);Dr=i(Jn,"This model inherits from "),Ut=s(Jn,"A",{href:!0});var Sd=a(Ut);Xr=i(Sd,"PreTrainedModel"),Sd.forEach(o),Gr=i(Jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
