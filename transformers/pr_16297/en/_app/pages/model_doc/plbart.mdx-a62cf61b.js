...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var j=a(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function sl(me){let u,B,v,L,z,T,y,j,ts,sn,I,io,os,ns,je,ss,as,Fe,rs,is,an,Y,fe,lo,Ee,ds,co,ls,rn,W,cs,Me,ps,hs,po,us,ms,dn,Mt,fs,ln,St,ho,gs,cn,G,_s,Se,bs,ks,Ae,vs,Ts,pn,Z,ge,uo,Ne,ys,mo,ws,hn,F,Ps,fo,Ls,qs,go,zs,Bs,_o,$s,xs,bo,Cs,js,un,_e,Fs,Oe,Es,Ms,mn,R,Ss,Ie,ko,As,Ns,Os,At,Is,Ds,fn,Nt,vo,Xs,gn,De,_n,Ot,Xe,To,Ws,Gs,ee,Rs,yo,Hs,Us,wo,Vs,Js,bn,We,kn,te,be,Po,Ge,Ks,Lo,Qs,vn,x,Re,Ys,oe,Zs,It,ea,ta,He,oa,na,sa,ne,aa,Dt,ra,ia,Xt,da,la,ca,qo,pa,ha,Ue,Tn,se,ke,zo,Ve,ua,Bo,ma,yn,P,Je,fa,$o,ga,_a,D,ba,Wt,ka,va,Gt,Ta,ya,Ke,wa,Pa,La,Qe,qa,xo,za,Ba,$a,Co,xa,Ca,Ye,ja,ve,Ze,Fa,jo,Ea,Ma,N,et,Sa,tt,Aa,Fo,Na,Oa,Ia,ot,nt,Eo,Da,Xa,Mo,Wa,Ga,st,So,Ra,Ha,Ao,Ua,Va,No,Ja,wn,ae,Te,Oo,at,Ka,Io,Qa,Pn,S,rt,Ya,it,Za,Rt,er,tr,or,dt,nr,lt,sr,ar,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,ye,mr,Xo,fr,gr,pt,Ln,ie,we,Wo,ht,_r,Go,br,qn,A,ut,kr,mt,vr,Ut,Tr,yr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Cr,Ro,jr,Fr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Or,Bn,C,vt,Ir,Jo,Dr,Xr,Tt,Wr,Jt,Gr,Rr,Hr,yt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,si,Qo,ai,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ct,fi,tn,gi,_i,jt,Cn;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(T.$$.fragment),y=l(),j=n("span"),ts=r("PLBart"),sn=l(),I=n("p"),io=n("strong"),os=r("DISCLAIMER:"),ns=r(" If you see something strange, file a "),je=n("a"),ss=r("Github Issue"),as=r(` and assign
...
target text format is `),_o=n("code"),$s=r("[tgt_lang_code] X [eos]"),xs=r(". "),bo=n("code"),Cs=r("bos"),js=r(" is never used."),un=l(),_e=n("p"),Fs=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=n("a"),Es=r("the paper"),Ms=r(" to learn more about this."),mn=l(),R=n("p"),Ss=r("In cases where the language code is needed, The regular "),Ie=n("a"),ko=n("strong"),As=r("call"),Ns=r("()"),Os=r(` will encode source text format, and it should be wrapped
inside the context manager `),At=n("a"),Is=r("as_target_tokenizer()"),Ds=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xs=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),Ot=n("ul"),Xe=n("li"),To=n("p"),Ws=r("Generation"),Gs=l(),ee=n("p"),Rs=r("While generating the target text set the "),yo=n("code"),Hs=r("decoder_start_token_id"),Us=r(` to the target language id. The following
...
adding special tokens. An PLBART sequence has the following format, where `),Fo=n("code"),Na=r("X"),Oa=r(" represents the sequence:"),Ia=l(),ot=n("ul"),nt=n("li"),Eo=n("code"),Da=r("input_ids"),Xa=r(" (for encoder) "),Mo=n("code"),Wa=r("X [eos, src_lang_code]"),Ga=l(),st=n("li"),So=n("code"),Ra=r("decoder_input_ids"),Ha=r(": (for decoder) "),Ao=n("code"),Ua=r("X [eos, tgt_lang_code]"),Va=l(),No=n("p"),Ja=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
classification.`),Od.forEach(o),Xr=c(Q),Tt=s(Q,"P",{});var Qn=a(Tt);Wr=i(Qn,"This model inherits from "),Jt=s(Qn,"A",{href:!0});var Id=a(Jt);Gr=i(Id,"PreTrainedModel"),Id.forEach(o),Rr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
