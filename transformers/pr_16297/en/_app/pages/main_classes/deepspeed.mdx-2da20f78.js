...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/deepspeed.py#L114"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/deepspeed.py#L105"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/deepspeed.py#L146"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16297/src/transformers/deepspeed.py#L137"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
completes.`),Ew=u(),Ei=o("a"),qw=u(),Ss=o("h3"),Vt=o("a"),ld=o("span"),f(Zo.$$.fragment),k7=u(),rd=o("span"),P7=a("Configuration"),$w=u(),Yt=o("p"),D7=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
...
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Cs=o("h3"),ea=o("a"),hd=o("span"),f(Yo.$$.fragment),J7=u(),fd=o("span"),X7=a("Passing Configuration"),Iw=u(),G=o("p"),Q7=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=o("a"),e9=a("Trainer"),s9=a(" via "),Di=o("a"),t9=a("TrainingArguments"),a9=a(" then for the "),dd=o("code"),n9=a("deepspeed"),o9=a(` argument you can
pass a nested `),md=o("code"),l9=a("dict"),r9=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=o("a"),p9=a("TrainingArguments"),i9=a("."),Uw=u(),Oi=o("p"),u9=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c9=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),xs=o("h3"),sa=o("a"),_d=o("span"),f(Xo.$$.fragment),h9=u(),vd=o("span"),f9=a("Shared Configuration"),Hw=u(),f(ta.$$.fragment),Bw=u(),Me=o("p"),d9=a("Some configuration values are required by both the "),Si=o("a"),m9=a("Trainer"),_9=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v9=a("Trainer"),j9=a(" command line arguments."),Ww=u(),aa=o("p"),g9=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),w9=a("Trainer"),y9=a(` do the majority
of configuration for you.`),Fw=u(),Ze=o("p"),b9=a("Therefore, in the rest of this guide you will find a special configuration value: "),jd=o("code"),E9=a("auto"),q9=a(`, which when set will be
...
your needs.`),Yw=u(),na=o("p"),D9=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z9=a("TrainingArguments"),O9=a(" based on that. The steps are:"),Kw=u(),oa=o("ol"),gd=o("li"),T9=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A9=u(),Qo=o("li"),S9=a("Create the "),Gi=o("a"),C9=a("TrainingArguments"),x9=a(" object based on these values"),Jw=u(),le=o("p"),R9=a("Do note that some values, such as "),wd=o("code"),I9=a("scheduler.params.total_num_steps"),U9=a(` are calculated by
`),Li=o("a"),G9=a("Trainer"),L9=a(" during "),yd=o("code"),M9=a("train"),Z9=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),Rs=o("h3"),la=o("a"),bd=o("span"),f(el.$$.fragment),N9=u(),Ed=o("span"),H9=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B9=a("Zero Redundancy Optimizer (ZeRO)"),W9=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sy=u(),Ne=o("p"),F9=a("The "),qd=o("code"),V9=a("zero_optimization"),Y9=a(" section of the configuration file is the most important part ("),al=o("a"),K9=a("docs"),J9=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ty=u(),ra=o("p"),X9=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q9=a("Trainer"),e8=a(` provides
...
going to use.`),ny=u(),Hi=o("a"),oy=u(),Is=o("h4"),pa=o("a"),$d=o("span"),f(nl.$$.fragment),t8=u(),kd=o("span"),a8=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),n8=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Pd=o("strong"),o8=a("Performance tuning:"),iy=u(),He=o("ul"),Us=o("li"),l8=a("enabling "),Dd=o("code"),r8=a("offload_optimizer"),p8=a(" should reduce GPU RAM usage (it requires "),zd=o("code"),i8=a('"stage": 2'),u8=a(")"),c8=u(),L=o("li"),Od=o("code"),h8=a('"overlap_comm": true'),f8=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Td=o("code"),d8=a("overlap_comm"),m8=a(` uses 4.5x
the `),Ad=o("code"),_8=a("allgather_bucket_size"),v8=a(" and "),Sd=o("code"),j8=a("reduce_bucket_size"),g8=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Cd=o("code"),w8=a("5e8 x 2Bytes x 2 x 4.5"),y8=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),xd=o("code"),b8=a("2e8"),E8=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),q8=u(),Rd=o("li"),$8=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),uy=u(),Be=o("p"),k8=a("Additionally, "),Id=o("code"),P8=a("deepspeed==0.4.4"),D8=a(" added a new option "),Ud=o("code"),z8=a("round_robin_gradients"),O8=a(" which you can enable with:"),cy=u(),f(ll.$$.fragment),hy=u(),Fi=o("p"),T8=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fy=u(),Vi=o("a"),dy=u(),Gs=o("h4"),ia=o("a"),Gd=o("span"),f(rl.$$.fragment),A8=u(),Ld=o("span"),S8=a("ZeRO-3 Config"),my=u(),Yi=o("p"),C8=a("The following is an example of configuration for ZeRO stage 3:"),_y=u(),f(pl.$$.fragment),vy=u(),K=o("p"),x8=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Md=o("code"),R8=a('"device": "cpu"'),I8=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Zd=o("code"),U8=a("none"),G8=a(" instead of "),Nd=o("code"),L8=a("cpu"),M8=a(" for the "),Hd=o("code"),Z8=a("device"),N8=a(` entry. Offloading to
NVMe is discussed further down.`),jy=u(),We=o("p"),H8=a("Pinned memory is enabled with "),Bd=o("code"),B8=a("pin_memory"),W8=a(" set to "),Wd=o("code"),F8=a("true"),V8=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gy=u(),Ki=o("p"),Fd=o("strong"),Y8=a("Performance tuning:"),wy=u(),ua=o("ul"),il=o("li"),Vd=o("code"),K8=a("stage3_max_live_parameters"),J8=a(": "),Yd=o("code"),X8=a("1e9"),Q8=u(),ul=o("li"),Kd=o("code"),ek=a("stage3_max_reuse_distance"),sk=a(": "),Jd=o("code"),tk=a("1e9"),yy=u(),M=o("p"),ak=a("If hitting OOM reduce "),Xd=o("code"),nk=a("stage3_max_live_parameters"),ok=a(" and "),Qd=o("code"),lk=a("stage3_max_reuse_distance"),rk=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),em=o("code"),pk=a("1e9"),ik=a(` would consume ~2GB. The memory is shared by
`),sm=o("code"),uk=a("stage3_max_live_parameters"),ck=a(" and "),tm=o("code"),hk=a("stage3_max_reuse_distance"),fk=a(", so it\u2019s not additive, it\u2019s just 2GB total."),by=u(),ze=o("p"),am=o("code"),dk=a("stage3_max_live_parameters"),mk=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),nm=o("code"),_k=a("stage3_max_reuse_distance"),vk=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),om=o("code"),jk=a("stage3_max_reuse_distance"),gk=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ey=u(),Ji=o("p"),wk=a("The following configuration values depend on the model\u2019s hidden size:"),qy=u(),Fe=o("ul"),cl=o("li"),lm=o("code"),yk=a("reduce_bucket_size"),bk=a(": "),rm=o("code"),Ek=a("hidden_size*hidden_size"),qk=u(),hl=o("li"),pm=o("code"),$k=a("stage3_prefetch_bucket_size"),kk=a(": "),im=o("code"),Pk=a("0.9 * hidden_size * hidden_size"),Dk=u(),fl=o("li"),um=o("code"),zk=a("stage3_param_persistence_threshold"),Ok=a(": "),cm=o("code"),Tk=a("10 * hidden_size"),$y=u(),Ve=o("p"),Ak=a("therefore set these values to "),hm=o("code"),Sk=a("auto"),Ck=a(" and the "),Xi=o("a"),xk=a("Trainer"),Rk=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),ky=u(),dl=o("p"),fm=o("code"),Ik=a("stage3_gather_16bit_weights_on_model_save"),Uk=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Py=u(),re=o("p"),Gk=a("If you\u2019re migrating from ZeRO-2 configuration note that "),dm=o("code"),Lk=a("allgather_partitions"),Mk=a(", "),mm=o("code"),Zk=a("allgather_bucket_size"),Nk=a(` and
`),_m=o("code"),Hk=a("reduce_scatter"),Bk=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Dy=u(),Qi=o("ul"),ml=o("li"),vm=o("code"),Wk=a("sub_group_size"),Fk=a(": "),jm=o("code"),Vk=a("1e9"),zy=u(),Oe=o("p"),gm=o("code"),Yk=a("sub_group_size"),Kk=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
...
ZeRO-Infinity, `),ym=o("code"),Qk=a("sub_group_size"),eP=a(` therefore controls the granularity in which model states are moved in and out of CPU
...
to the console, so you can see exactly what was the final configuration passed to it.`),IE.forEach(t),xw=c(e),ki=l(e,"A",{id:!0}),r(ki).forEach(t),Rw=c(e),Cs=l(e,"H3",{class:!0});var UE=r(Cs);ea=l(UE,"A",{id:!0,class:!0,href:!0});var MM=r(ea);hd=l(MM,"SPAN",{});var ZM=r(hd);d(Yo.$$.fragment,ZM),ZM.forEach(t),MM.forEach(t),J7=c(UE),fd=l(UE,"SPAN",{});var NM=r(fd);X7=n(NM,"Passing Configuration"),NM.forEach(t),UE.forEach(t),Iw=c(e),G=l(e,"P",{});var ye=r(G);Q7=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(ye,"A",{href:!0});var HM=r(Pi);e9=n(HM,"Trainer"),HM.forEach(t),s9=n(ye," via "),Di=l(ye,"A",{href:!0});var BM=r(Di);t9=n(BM,"TrainingArguments"),BM.forEach(t),a9=n(ye," then for the "),dd=l(ye,"CODE",{});var WM=r(dd);n9=n(WM,"deepspeed"),WM.forEach(t),o9=n(ye,` argument you can
pass a nested `),md=l(ye,"CODE",{});var FM=r(md);l9=n(FM,"dict"),FM.forEach(t),r9=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(ye,"A",{href:!0});var VM=r(zi);p9=n(VM,"TrainingArguments"),VM.forEach(t),i9=n(ye,"."),ye.forEach(t),Uw=c(e),Oi=l(e,"P",{});var YM=r(Oi);u9=n(YM,"To summarize you can do:"),YM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"P",{});var KM=r(Ti);c9=n(KM,"or:"),KM.forEach(t),Mw=c(e),d(Jo.$$.fragment,e),Zw=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Nw=c(e),xs=l(e,"H3",{class:!0});var GE=r(xs);sa=l(GE,"A",{id:!0,class:!0,href:!0});var JM=r(sa);_d=l(JM,"SPAN",{});var XM=r(_d);d(Xo.$$.fragment,XM),XM.forEach(t),JM.forEach(t),h9=c(GE),vd=l(GE,"SPAN",{});var QM=r(vd);f9=n(QM,"Shared Configuration"),QM.forEach(t),GE.forEach(t),Hw=c(e),d(ta.$$.fragment,e),Bw=c(e),Me=l(e,"P",{});var vh=r(Me);d9=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var eZ=r(Si);m9=n(eZ,"Trainer"),eZ.forEach(t),_9=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var sZ=r(Ci);v9=n(sZ,"Trainer"),sZ.forEach(t),j9=n(vh," command line arguments."),vh.forEach(t),Ww=c(e),aa=l(e,"P",{});var LE=r(aa);g9=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var tZ=r(xi);w9=n(tZ,"Trainer"),tZ.forEach(t),y9=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fw=c(e),Ze=l(e,"P",{});var jh=r(Ze);b9=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),jd=l(jh,"CODE",{});var aZ=r(jd);E9=n(aZ,"auto"),aZ.forEach(t),q9=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ri=l(jh,"A",{href:!0});var nZ=r(Ri);$9=n(nZ,"Trainer"),nZ.forEach(t),k9=n(jh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vw=c(e),Ii=l(e,"P",{});var oZ=r(Ii);P9=n(oZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),oZ.forEach(t),Yw=c(e),na=l(e,"P",{});var ME=r(na);D9=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var lZ=r(Ui);z9=n(lZ,"TrainingArguments"),lZ.forEach(t),O9=n(ME," based on that. The steps are:"),ME.forEach(t),Kw=c(e),oa=l(e,"OL",{});var ZE=r(oa);gd=l(ZE,"LI",{});var rZ=r(gd);T9=n(rZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),rZ.forEach(t),A9=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S9=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var pZ=r(Gi);C9=n(pZ,"TrainingArguments"),pZ.forEach(t),x9=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jw=c(e),le=l(e,"P",{});var Hn=r(le);R9=n(Hn,"Do note that some values, such as "),wd=l(Hn,"CODE",{});var iZ=r(wd);I9=n(iZ,"scheduler.params.total_num_steps"),iZ.forEach(t),U9=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var uZ=r(Li);G9=n(uZ,"Trainer"),uZ.forEach(t),L9=n(Hn," during "),yd=l(Hn,"CODE",{});var cZ=r(yd);M9=n(cZ,"train"),cZ.forEach(t),Z9=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qw=c(e),Rs=l(e,"H3",{class:!0});var HE=r(Rs);la=l(HE,"A",{id:!0,class:!0,href:!0});var hZ=r(la);bd=l(hZ,"SPAN",{});var fZ=r(bd);d(el.$$.fragment,fZ),fZ.forEach(t),hZ.forEach(t),N9=c(HE),Ed=l(HE,"SPAN",{});var dZ=r(Ed);H9=n(dZ,"ZeRO"),dZ.forEach(t),HE.forEach(t),ey=c(e),sl=l(e,"P",{});var gG=r(sl);tl=l(gG,"A",{href:!0,rel:!0});var mZ=r(tl);B9=n(mZ,"Zero Redundancy Optimizer (ZeRO)"),mZ.forEach(t),W9=n(gG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),gG.forEach(t),sy=c(e),Ne=l(e,"P",{});var gh=r(Ne);F9=n(gh,"The "),qd=l(gh,"CODE",{});var _Z=r(qd);V9=n(_Z,"zero_optimization"),_Z.forEach(t),Y9=n(gh," section of the configuration file is the most important part ("),al=l(gh,"A",{href:!0,rel:!0});var vZ=r(al);K9=n(vZ,"docs"),vZ.forEach(t),J9=n(gh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),ty=c(e),ra=l(e,"P",{});var BE=r(ra);X9=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var jZ=r(Zi);Q9=n(jZ,"Trainer"),jZ.forEach(t),e8=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),ay=c(e),Ni=l(e,"P",{});var gZ=r(Ni);s8=n(gZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),gZ.forEach(t),ny=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),oy=c(e),Is=l(e,"H4",{class:!0});var WE=r(Is);pa=l(WE,"A",{id:!0,class:!0,href:!0});var wZ=r(pa);$d=l(wZ,"SPAN",{});var yZ=r($d);d(nl.$$.fragment,yZ),yZ.forEach(t),wZ.forEach(t),t8=c(WE),kd=l(WE,"SPAN",{});var bZ=r(kd);a8=n(bZ,"ZeRO-2 Config"),bZ.forEach(t),WE.forEach(t),ly=c(e),Bi=l(e,"P",{});var EZ=r(Bi);n8=n(EZ,"The following is an example of configuration for ZeRO stage 2:"),EZ.forEach(t),ry=c(e),d(ol.$$.fragment,e),py=c(e),Wi=l(e,"P",{});var qZ=r(Wi);Pd=l(qZ,"STRONG",{});var $Z=r(Pd);o8=n($Z,"Performance tuning:"),$Z.forEach(t),qZ.forEach(t),iy=c(e),He=l(e,"UL",{});var wh=r(He);Us=l(wh,"LI",{});var yh=r(Us);l8=n(yh,"enabling "),Dd=l(yh,"CODE",{});var kZ=r(Dd);r8=n(kZ,"offload_optimizer"),kZ.forEach(t),p8=n(yh," should reduce GPU RAM usage (it requires "),zd=l(yh,"CODE",{});var PZ=r(zd);i8=n(PZ,'"stage": 2'),PZ.forEach(t),u8=n(yh,")"),yh.forEach(t),c8=c(wh),L=l(wh,"LI",{});var te=r(L);Od=l(te,"CODE",{});var DZ=r(Od);h8=n(DZ,'"overlap_comm": true'),DZ.forEach(t),f8=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Td=l(te,"CODE",{});var zZ=r(Td);d8=n(zZ,"overlap_comm"),zZ.forEach(t),m8=n(te,` uses 4.5x
the `),Ad=l(te,"CODE",{});var OZ=r(Ad);_8=n(OZ,"allgather_bucket_size"),OZ.forEach(t),v8=n(te," and "),Sd=l(te,"CODE",{});var TZ=r(Sd);j8=n(TZ,"reduce_bucket_size"),TZ.forEach(t),g8=n(te,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Cd=l(te,"CODE",{});var AZ=r(Cd);w8=n(AZ,"5e8 x 2Bytes x 2 x 4.5"),AZ.forEach(t),y8=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),xd=l(te,"CODE",{});var SZ=r(xd);b8=n(SZ,"2e8"),SZ.forEach(t),E8=n(te,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),q8=c(wh),Rd=l(wh,"LI",{});var CZ=r(Rd);$8=n(CZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),CZ.forEach(t),wh.forEach(t),uy=c(e),Be=l(e,"P",{});var bh=r(Be);k8=n(bh,"Additionally, "),Id=l(bh,"CODE",{});var xZ=r(Id);P8=n(xZ,"deepspeed==0.4.4"),xZ.forEach(t),D8=n(bh," added a new option "),Ud=l(bh,"CODE",{});var RZ=r(Ud);z8=n(RZ,"round_robin_gradients"),RZ.forEach(t),O8=n(bh," which you can enable with:"),bh.forEach(t),cy=c(e),d(ll.$$.fragment,e),hy=c(e),Fi=l(e,"P",{});var IZ=r(Fi);T8=n(IZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),IZ.forEach(t),fy=c(e),Vi=l(e,"A",{id:!0}),r(Vi).forEach(t),dy=c(e),Gs=l(e,"H4",{class:!0});var FE=r(Gs);ia=l(FE,"A",{id:!0,class:!0,href:!0});var UZ=r(ia);Gd=l(UZ,"SPAN",{});var GZ=r(Gd);d(rl.$$.fragment,GZ),GZ.forEach(t),UZ.forEach(t),A8=c(FE),Ld=l(FE,"SPAN",{});var LZ=r(Ld);S8=n(LZ,"ZeRO-3 Config"),LZ.forEach(t),FE.forEach(t),my=c(e),Yi=l(e,"P",{});var MZ=r(Yi);C8=n(MZ,"The following is an example of configuration for ZeRO stage 3:"),MZ.forEach(t),_y=c(e),d(pl.$$.fragment,e),vy=c(e),K=l(e,"P",{});var ys=r(K);x8=n(ys,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Md=l(ys,"CODE",{});var ZZ=r(Md);R8=n(ZZ,'"device": "cpu"'),ZZ.forEach(t),I8=n(ys,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Zd=l(ys,"CODE",{});var NZ=r(Zd);U8=n(NZ,"none"),NZ.forEach(t),G8=n(ys," instead of "),Nd=l(ys,"CODE",{});var HZ=r(Nd);L8=n(HZ,"cpu"),HZ.forEach(t),M8=n(ys," for the "),Hd=l(ys,"CODE",{});var BZ=r(Hd);Z8=n(BZ,"device"),BZ.forEach(t),N8=n(ys,` entry. Offloading to
NVMe is discussed further down.`),ys.forEach(t),jy=c(e),We=l(e,"P",{});var Eh=r(We);H8=n(Eh,"Pinned memory is enabled with "),Bd=l(Eh,"CODE",{});var WZ=r(Bd);B8=n(WZ,"pin_memory"),WZ.forEach(t),W8=n(Eh," set to "),Wd=l(Eh,"CODE",{});var FZ=r(Wd);F8=n(FZ,"true"),FZ.forEach(t),V8=n(Eh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Eh.forEach(t),gy=c(e),Ki=l(e,"P",{});var VZ=r(Ki);Fd=l(VZ,"STRONG",{});var YZ=r(Fd);Y8=n(YZ,"Performance tuning:"),YZ.forEach(t),VZ.forEach(t),wy=c(e),ua=l(e,"UL",{});var VE=r(ua);il=l(VE,"LI",{});var YE=r(il);Vd=l(YE,"CODE",{});var KZ=r(Vd);K8=n(KZ,"stage3_max_live_parameters"),KZ.forEach(t),J8=n(YE,": "),Yd=l(YE,"CODE",{});var JZ=r(Yd);X8=n(JZ,"1e9"),JZ.forEach(t),YE.forEach(t),Q8=c(VE),ul=l(VE,"LI",{});var KE=r(ul);Kd=l(KE,"CODE",{});var XZ=r(Kd);ek=n(XZ,"stage3_max_reuse_distance"),XZ.forEach(t),sk=n(KE,": "),Jd=l(KE,"CODE",{});var QZ=r(Jd);tk=n(QZ,"1e9"),QZ.forEach(t),KE.forEach(t),VE.forEach(t),yy=c(e),M=l(e,"P",{});var be=r(M);ak=n(be,"If hitting OOM reduce "),Xd=l(be,"CODE",{});var eN=r(Xd);nk=n(eN,"stage3_max_live_parameters"),eN.forEach(t),ok=n(be," and "),Qd=l(be,"CODE",{});var sN=r(Qd);lk=n(sN,"stage3_max_reuse_distance"),sN.forEach(t),rk=n(be,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),em=l(be,"CODE",{});var tN=r(em);pk=n(tN,"1e9"),tN.forEach(t),ik=n(be,` would consume ~2GB. The memory is shared by
`),sm=l(be,"CODE",{});var aN=r(sm);uk=n(aN,"stage3_max_live_parameters"),aN.forEach(t),ck=n(be," and "),tm=l(be,"CODE",{});var nN=r(tm);hk=n(nN,"stage3_max_reuse_distance"),nN.forEach(t),fk=n(be,", so it\u2019s not additive, it\u2019s just 2GB total."),be.forEach(t),by=c(e),ze=l(e,"P",{});var Sp=r(ze);am=l(Sp,"CODE",{});var oN=r(am);dk=n(oN,"stage3_max_live_parameters"),oN.forEach(t),mk=n(Sp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),nm=l(Sp,"CODE",{});var lN=r(nm);_k=n(lN,"stage3_max_reuse_distance"),lN.forEach(t),vk=n(Sp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),om=l(Sp,"CODE",{});var rN=r(om);jk=n(rN,"stage3_max_reuse_distance"),rN.forEach(t),gk=n(Sp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Sp.forEach(t),Ey=c(e),Ji=l(e,"P",{});var pN=r(Ji);wk=n(pN,"The following configuration values depend on the model\u2019s hidden size:"),pN.forEach(t),qy=c(e),Fe=l(e,"UL",{});var qh=r(Fe);cl=l(qh,"LI",{});var JE=r(cl);lm=l(JE,"CODE",{});var iN=r(lm);yk=n(iN,"reduce_bucket_size"),iN.forEach(t),bk=n(JE,": "),rm=l(JE,"CODE",{});var uN=r(rm);Ek=n(uN,"hidden_size*hidden_size"),uN.forEach(t),JE.forEach(t),qk=c(qh),hl=l(qh,"LI",{});var XE=r(hl);pm=l(XE,"CODE",{});var cN=r(pm);$k=n(cN,"stage3_prefetch_bucket_size"),cN.forEach(t),kk=n(XE,": "),im=l(XE,"CODE",{});var hN=r(im);Pk=n(hN,"0.9 * hidden_size * hidden_size"),hN.forEach(t),XE.forEach(t),Dk=c(qh),fl=l(qh,"LI",{});var QE=r(fl);um=l(QE,"CODE",{});var fN=r(um);zk=n(fN,"stage3_param_persistence_threshold"),fN.forEach(t),Ok=n(QE,": "),cm=l(QE,"CODE",{});var dN=r(cm);Tk=n(dN,"10 * hidden_size"),dN.forEach(t),QE.forEach(t),qh.forEach(t),$y=c(e),Ve=l(e,"P",{});var $h=r(Ve);Ak=n($h,"therefore set these values to "),hm=l($h,"CODE",{});var mN=r(hm);Sk=n(mN,"auto"),mN.forEach(t),Ck=n($h," and the "),Xi=l($h,"A",{href:!0});var _N=r(Xi);xk=n(_N,"Trainer"),_N.forEach(t),Rk=n($h,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),$h.forEach(t),ky=c(e),dl=l(e,"P",{});var wG=r(dl);fm=l(wG,"CODE",{});var vN=r(fm);Ik=n(vN,"stage3_gather_16bit_weights_on_model_save"),vN.forEach(t),Uk=n(wG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),wG.forEach(t),Py=c(e),re=l(e,"P",{});var Bn=r(re);Gk=n(Bn,"If you\u2019re migrating from ZeRO-2 configuration note that "),dm=l(Bn,"CODE",{});var jN=r(dm);Lk=n(jN,"allgather_partitions"),jN.forEach(t),Mk=n(Bn,", "),mm=l(Bn,"CODE",{});var gN=r(mm);Zk=n(gN,"allgather_bucket_size"),gN.forEach(t),Nk=n(Bn,` and
`),_m=l(Bn,"CODE",{});var wN=r(_m);Hk=n(wN,"reduce_scatter"),wN.forEach(t),Bk=n(Bn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Bn.forEach(t),Dy=c(e),Qi=l(e,"UL",{});var yN=r(Qi);ml=l(yN,"LI",{});var eq=r(ml);vm=l(eq,"CODE",{});var bN=r(vm);Wk=n(bN,"sub_group_size"),bN.forEach(t),Fk=n(eq,": "),jm=l(eq,"CODE",{});var EN=r(jm);Vk=n(EN,"1e9"),EN.forEach(t),eq.forEach(t),yN.forEach(t),zy=c(e),Oe=l(e,"P",{});var Cp=r(Oe);gm=l(Cp,"CODE",{});var qN=r(gm);Yk=n(qN,"sub_group_size"),qN.forEach(t),Kk=n(Cp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),wm=l(Cp,"CODE",{});var $N=r(wm);Jk=n($N,"sub_group_size"),$N.forEach(t),Xk=n(Cp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),ym=l(Cp,"CODE",{});var kN=r(ym);Qk=n(kN,"sub_group_size"),kN.forEach(t),eP=n(Cp,` therefore controls the granularity in which model states are moved in and out of CPU
