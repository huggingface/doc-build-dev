...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16345/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16345/src/transformers/deepspeed.py#L114"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16345/src/transformers/deepspeed.py#L105"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16345/src/transformers/deepspeed.py#L146"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16345/src/transformers/deepspeed.py#L137"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
`),bo=o("a"),x5=a("Deepspeed"),R5=a(","),Cg=u(),li=o("a"),xg=u(),Ds=o("h3"),St=o("a"),Of=o("span"),f(Eo.$$.fragment),I5=u(),Tf=o("span"),U5=a("Deployment with multiple GPUs"),Rg=u(),Ct=o("p"),G5=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L5=a("Trainer"),M5=a(` command line arguments as
following:`),Ig=u(),xt=o("ol"),zs=o("li"),Z5=a("replace "),Af=o("code"),N5=a("python -m torch.distributed.launch"),H5=a(" with "),Sf=o("code"),B5=a("deepspeed"),W5=a("."),F5=u(),De=o("li"),V5=a("add a new argument "),Cf=o("code"),Y5=a("--deepspeed ds_config.json"),K5=a(", where "),xf=o("code"),J5=a("ds_config.json"),X5=a(` is the DeepSpeed configuration file as
...
find more details in the discussion below.`),nw=u(),Zt=o("p"),W$=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F$=a("post"),V$=a("."),ow=u(),mi=o("p"),Y$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K$=a("Notes:"),rw=u(),vi=o("ul"),Ts=o("li"),xo=o("p"),J$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=o("code"),X$=a("CUDA_VISIBLE_DEVICES"),Q$=a(` to limit
