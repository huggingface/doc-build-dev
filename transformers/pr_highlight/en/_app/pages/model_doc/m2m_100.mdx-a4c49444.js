import{S as Br,i as Hr,s as Ur,e as n,k as l,w as b,t as r,M as Vr,c as s,d as o,m as c,a,x as v,h as i,b as p,F as e,g as _,y,q as w,o as T,B as $,v as Xr,L as ko}from"../../chunks/vendor-6b77c823.js";import{T as Wr}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C as it}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as rt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as go}from"../../chunks/ExampleCodeBlock-5212b321.js";function Rr(q){let h,M,g,u,k;return u=new it({props:{code:`from transformers import M2M100Model, M2M100Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){h=n("p"),M=r("Example:"),g=l(),b(u.$$.fragment)},l(d){h=s(d,"P",{});var f=a(h);M=i(f,"Example:"),f.forEach(o),g=c(d),v(u.$$.fragment,d)},m(d,f){_(d,h,f),e(h,M),_(d,g,f),y(u,d,f),k=!0},p:ko,i(d){k||(w(u.$$.fragment,d),k=!0)},o(d){T(u.$$.fragment,d),k=!1},d(d){d&&o(h),d&&o(g),$(u,d)}}}function Jr(q){let h,M,g,u,k;return u=new it({props:{code:`from transformers import M2M100Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># translate to French</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>gen_tokens = model.generate(**model_inputs, forced_bos_token_id=tokenizer.get_lang_id(<span class="hljs-string">&quot;fr&quot;</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){h=n("p"),M=r("Translation example::"),g=l(),b(u.$$.fragment)},l(d){h=s(d,"P",{});var f=a(h);M=i(f,"Translation example::"),f.forEach(o),g=c(d),v(u.$$.fragment,d)},m(d,f){_(d,h,f),e(h,M),_(d,g,f),y(u,d,f),k=!0},p:ko,i(d){k||(w(u.$$.fragment,d),k=!0)},o(d){T(u.$$.fragment,d),k=!1},d(d){d&&o(h),d&&o(g),$(u,d)}}}function ti(q){let h,M,g,u,k,d,f,N,rn,Mo,H,ee,Et,ye,dn,Ct,ln,bo,te,cn,we,hn,pn,vo,dt,mn,yo,lt,jt,un,wo,oe,fn,Te,_n,gn,To,U,ne,Ft,$e,kn,Pt,Mn,$o,A,bn,St,vn,yn,At,wn,Tn,Dt,$n,zn,zo,C,qn,ct,xn,En,Lt,Cn,jn,It,Fn,Pn,Nt,Sn,An,qo,ht,Gt,Dn,xo,ze,Eo,pt,qe,Ot,Ln,In,E,Nn,Wt,Gn,On,Bt,Wn,Bn,Ht,Hn,Un,Ut,Vn,Xn,Vt,Rn,Jn,Co,xe,jo,V,se,Xt,Ee,Kn,Rt,Zn,Fo,F,Ce,Qn,X,Yn,mt,es,ts,je,os,ns,ss,R,as,ut,rs,is,ft,ds,ls,cs,ae,Po,J,re,Jt,Fe,hs,Kt,ps,So,z,Pe,ms,Se,us,Ae,fs,_s,gs,De,ks,_t,Ms,bs,vs,ie,ys,D,Le,ws,Ie,Ts,Zt,$s,zs,qs,Ne,Ge,Qt,xs,Es,Yt,Cs,js,Oe,eo,Fs,Ps,to,Ss,As,oo,Ds,Ls,de,We,Is,Be,Ns,no,Gs,Os,Ws,G,He,Bs,gt,Hs,kt,Us,Vs,so,Xs,Rs,Mt,Ue,Ao,K,le,ao,Ve,Js,ro,Ks,Do,P,Xe,Zs,Re,Qs,bt,Ys,ea,ta,Je,oa,Ke,na,sa,aa,L,Ze,ra,Z,ia,vt,da,la,io,ca,ha,pa,ce,ma,he,Lo,Q,pe,lo,Qe,ua,co,fa,Io,S,Ye,_a,et,ga,yt,ka,Ma,ba,tt,va,ot,ya,wa,Ta,j,nt,$a,Y,za,wt,qa,xa,ho,Ea,Ca,ja,me,Fa,ue,Pa,fe,No;return d=new rt({}),ye=new rt({}),$e=new rt({}),ze=new it({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_highlight/en/model_doc/m2m_100#transformers.M2M100Model">M2M100Model</a> or`,name:"vocab_size"},{anchor:"transformers.M2M100Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),ae=new go({props:{anchor:"transformers.M2M100Config.example",$$slots:{default:[Rr]},$$scope:{ctx:q}}}),Fe=new rt({}),Pe=new B({props:{name:"class transformers.M2M100Tokenizer",anchor:"transformers.M2M100Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"spm_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"unk_token",val:" = '<unk>'"},{name:"language_codes",val:" = 'm2m100'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"num_madeup_words",val:" = 8"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/tokenization_m2m_100.py#L258",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/tokenization_m2m_100.py#L228",returnDescription:`
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ue=new B({props:{name:"save_vocabulary",anchor:"transformers.M2M100Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/tokenization_m2m_100.py#L304"}}),Ve=new rt({}),Xe=new B({props:{name:"class transformers.M2M100Model",anchor:"transformers.M2M100Model",parameters:[{name:"config",val:": M2M100Config"}],parametersDescription:[{anchor:"transformers.M2M100Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/m2m_100#transformers.M2M100Config">M2M100Config</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/modeling_m2m_100.py#L1104"}}),Ze=new B({props:{name:"forward",anchor:"transformers.M2M100Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.M2M100Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/m2m_100#transformers.M2M100Tokenizer">M2M100Tokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_highlight/en/model_doc/m2m_100#transformers.M2M100Config"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/modeling_m2m_100.py#L1215"}}),nt=new B({props:{name:"forward",anchor:"transformers.M2M100ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.M2M100ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/m2m_100#transformers.M2M100Tokenizer">M2M100Tokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/m2m_100/modeling_m2m_100.py#L1253",returnDescription:`
<p>A <a
...
`}}),me=new Wr({props:{$$slots:{default:[Qr]},$$scope:{ctx:q}}}),ue=new go({props:{anchor:"transformers.M2M100ForConditionalGeneration.forward.example",$$slots:{default:[Yr]},$$scope:{ctx:q}}}),fe=new go({props:{anchor:"transformers.M2M100ForConditionalGeneration.forward.example-2",$$slots:{default:[ei]},$$scope:{ctx:q}}}),{c(){h=n("meta"),M=l(),g=n("h1"),u=n("a"),k=n("span"),b(d.$$.fragment),f=l(),N=n("span"),rn=r("M2M100"),Mo=l(),H=n("h2"),ee=n("a"),Et=n("span"),b(ye.$$.fragment),dn=l(),Ct=n("span"),ln=r("Overview"),bo=l(),te=n("p"),cn=r("The M2M100 model was proposed in "),we=n("a"),hn=r("Beyond English-Centric Multilingual Machine Translation"),pn=r(` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
...
examples. To install `),It=n("code"),Fn=r("sentencepiece"),Pn=r(" run "),Nt=n("code"),Sn=r("pip install sentencepiece"),An=r("."),qo=l(),ht=n("ul"),Gt=n("li"),Dn=r("Supervised Training"),xo=l(),b(ze.$$.fragment),Eo=l(),pt=n("ul"),qe=n("li"),Ot=n("p"),Ln=r("Generation"),In=l(),E=n("p"),Nn=r("M2M100 uses the "),Wt=n("code"),Gn=r("eos_token_id"),On=r(" as the "),Bt=n("code"),Wn=r("decoder_start_token_id"),Bn=r(` for generation with the target language id
...
documentation from `),ft=n("a"),ds=r("PretrainedConfig"),ls=r(" for more information."),cs=l(),b(ae.$$.fragment),Po=l(),J=n("h2"),re=n("a"),Jt=n("span"),b(Fe.$$.fragment),hs=l(),Kt=n("span"),ps=r("M2M100Tokenizer"),So=l(),z=n("div"),b(Pe.$$.fragment),ms=l(),Se=n("p"),us=r("Construct an M2M100 tokenizer. Based on "),Ae=n("a"),fs=r("SentencePiece"),_s=r("."),gs=l(),De=n("p"),ks=r("This tokenizer inherits from "),_t=n("a"),Ms=r("PreTrainedTokenizer"),bs=r(` which contains most of the main methods. Users should refer to
...
and behavior.`),aa=l(),L=n("div"),b(Ze.$$.fragment),ra=l(),Z=n("p"),ia=r("The "),vt=n("a"),da=r("M2M100Model"),la=r(" forward method, overrides the "),io=n("code"),ca=r("__call__"),ha=r(" special method."),pa=l(),b(ce.$$.fragment),ma=l(),b(he.$$.fragment),Lo=l(),Q=n("h2"),pe=n("a"),lo=n("span"),b(Qe.$$.fragment),ua=l(),co=n("span"),fa=r("M2M100ForConditionalGeneration"),Io=l(),S=n("div"),b(Ye.$$.fragment),_a=l(),et=n("p"),ga=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ta=l(),j=n("div"),b(nt.$$.fragment),$a=l(),Y=n("p"),za=r("The "),wt=n("a"),qa=r("M2M100ForConditionalGeneration"),xa=r(" forward method, overrides the "),ho=n("code"),Ea=r("__call__"),Ca=r(" special method."),ja=l(),b(me.$$.fragment),Fa=l(),b(ue.$$.fragment),Pa=l(),b(fe.$$.fragment),this.h()},l(t){const m=Vr('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(o),M=c(t),g=s(t,"H1",{class:!0});var st=a(g);u=s(st,"A",{id:!0,class:!0,href:!0});var po=a(u);k=s(po,"SPAN",{});var mo=a(k);v(d.$$.fragment,mo),mo.forEach(o),po.forEach(o),f=c(st),N=s(st,"SPAN",{});var uo=a(N);rn=i(uo,"M2M100"),uo.forEach(o),st.forEach(o),Mo=c(t),H=s(t,"H2",{class:!0});var at=a(H);ee=s(at,"A",{id:!0,class:!0,href:!0});var fo=a(ee);Et=s(fo,"SPAN",{});var _o=a(Et);v(ye.$$.fragment,_o),_o.forEach(o),fo.forEach(o),dn=c(at),Ct=s(at,"SPAN",{});var Aa=a(Ct);ln=i(Aa,"Overview"),Aa.forEach(o),at.forEach(o),bo=c(t),te=s(t,"P",{});var Go=a(te);cn=i(Go,"The M2M100 model was proposed in "),we=s(Go,"A",{href:!0,rel:!0});var Da=a(we);hn=i(Da,"Beyond English-Centric Multilingual Machine Translation"),Da.forEach(o),pn=i(Go,` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
Siddharth Goyal, Mandeep Baines, Onur Celebi, Guillaume Wenzek, Vishrav Chaudhary, Naman Goyal, Tom Birch, Vitaliy
...
examples. To install `),It=s(O,"CODE",{});var Ja=a(It);Fn=i(Ja,"sentencepiece"),Ja.forEach(o),Pn=i(O," run "),Nt=s(O,"CODE",{});var Ka=a(Nt);Sn=i(Ka,"pip install sentencepiece"),Ka.forEach(o),An=i(O,"."),O.forEach(o),qo=c(t),ht=s(t,"UL",{});var Za=a(ht);Gt=s(Za,"LI",{});var Qa=a(Gt);Dn=i(Qa,"Supervised Training"),Qa.forEach(o),Za.forEach(o),xo=c(t),v(ze.$$.fragment,t),Eo=c(t),pt=s(t,"UL",{});var Ya=a(pt);qe=s(Ya,"LI",{});var Bo=a(qe);Ot=s(Bo,"P",{});var er=a(Ot);Ln=i(er,"Generation"),er.forEach(o),In=c(Bo),E=s(Bo,"P",{});var I=a(E);Nn=i(I,"M2M100 uses the "),Wt=s(I,"CODE",{});var tr=a(Wt);Gn=i(tr,"eos_token_id"),tr.forEach(o),On=i(I," as the "),Bt=s(I,"CODE",{});var or=a(Bt);Wn=i(or,"decoder_start_token_id"),or.forEach(o),Bn=i(I,` for generation with the target language id
being forced as the first generated token. To force the target language id as the first generated token, pass the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),on.forEach(o),aa=c(Me),L=s(Me,"DIV",{class:!0});var be=a(L);v(Ze.$$.fragment,be),ra=c(be),Z=s(be,"P",{});var qt=a(Z);ia=i(qt,"The "),vt=s(qt,"A",{href:!0});var Pr=a(vt);da=i(Pr,"M2M100Model"),Pr.forEach(o),la=i(qt," forward method, overrides the "),io=s(qt,"CODE",{});var Sr=a(io);ca=i(Sr,"__call__"),Sr.forEach(o),ha=i(qt," special method."),qt.forEach(o),pa=c(be),v(ce.$$.fragment,be),ma=c(be),v(he.$$.fragment,be),be.forEach(o),Me.forEach(o),Lo=c(t),Q=s(t,"H2",{class:!0});var nn=a(Q);pe=s(nn,"A",{id:!0,class:!0,href:!0});var Ar=a(pe);lo=s(Ar,"SPAN",{});var Dr=a(lo);v(Qe.$$.fragment,Dr),Dr.forEach(o),Ar.forEach(o),ua=c(nn),co=s(nn,"SPAN",{});var Lr=a(co);fa=i(Lr,"M2M100ForConditionalGeneration"),Lr.forEach(o),nn.forEach(o),Io=c(t),S=s(t,"DIV",{class:!0});var ve=a(S);v(Ye.$$.fragment,ve),_a=c(ve),et=s(ve,"P",{});var sn=a(et);ga=i(sn,`The M2M100 Model with a language modeling head. Can be used for summarization.
