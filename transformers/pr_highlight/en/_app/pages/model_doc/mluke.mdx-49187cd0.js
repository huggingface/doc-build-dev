import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as r,M as sn,c as s,d as n,m as u,a as i,x as $,h as a,b as l,F as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-6b77c823.js";import{D as xt}from"../../chunks/Docstring-1088f2fb.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qt}from"../../chunks/IconCopyLink-7a11ce68.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,ge,v,T,ce,S,Re,de,De,_e,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,J,Ye,ve,G,pe,He,be,Q,Ve,we,R,Te,L,Je,Z,Ge,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,g,nt,F,ot,st,O,it,rt,ze,b,q,ue,B,at,me,lt,Me,m,j,ct,h,dt,te,pt,ut,ne,mt,ht,X,ft,gt,_t,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Ee;return U=new qt({}),S=new qt({}),R=new en({props:{code:`from transformers import LukeModel
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/mluke/tokenization_mluke.py#L365",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/mluke/tokenization_mluke.py#L1492"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),E(U.$$.fragment),We=p(),le=o("span"),Ke=r("mLUKE"),ge=p(),v=o("h2"),T=o("a"),ce=o("span"),E(S.$$.fragment),Re=p(),de=o("span"),De=r("Overview"),_e=p(),f=o("p"),Fe=r("The mLUKE model was proposed in "),W=o("a"),Oe=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
tips, code examples and notebooks.`),qe=p(),g=o("p"),nt=r("This model was contributed by "),F=o("a"),ot=r("ryo0634"),st=r(". The original code can be found "),O=o("a"),it=r("here"),rt=r("."),ze=p(),b=o("h2"),q=o("a"),ue=o("span"),E(B.$$.fragment),at=p(),me=o("span"),lt=r("MLukeTokenizer"),Me=p(),m=o("div"),E(j.$$.fragment),ct=p(),h=o("p"),dt=r("Adapted from "),te=o("a"),pt=r("XLMRobertaTokenizer"),ut=r(" and "),ne=o("a"),mt=r("LukeTokenizer"),ht=r(`. Based on
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),Rt.forEach(n),Kt.forEach(n),be=u(e),Q=s(e,"P",{});var Dt=i(Q);Ve=a(Dt,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Dt.forEach(n),we=u(e),$(R.$$.fragment,e),Te=u(e),L=s(e,"P",{});var Ae=i(L);Je=a(Ae,"Note that mLUKE has its own tokenizer, "),Z=s(Ae,"A",{href:!0});var Ft=i(Z);Ge=a(Ft,"MLukeTokenizer"),Ft.forEach(n),Qe=a(Ae,". You can initialize it as follows:"),Ae.forEach(n),Le=u(e),$(D.$$.fragment,e),xe=u(e),x=s(e,"P",{});var Ne=i(x);Ze=a(Ne,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=s(Ne,"A",{href:!0});var Ot=i(ee);et=a(Ot,"LUKE\u2019s documentation page"),Ot.forEach(n),tt=a(Ne,` for all
tips, code examples and notebooks.`),Ne.forEach(n),qe=u(e),g=s(e,"P",{});var re=i(g);nt=a(re,"This model was contributed by "),F=s(re,"A",{href:!0,rel:!0});var Bt=i(F);ot=a(Bt,"ryo0634"),Bt.forEach(n),st=a(re,". The original code can be found "),O=s(re,"A",{href:!0,rel:!0});var jt=i(O);it=a(jt,"here"),jt.forEach(n),rt=a(re,"."),re.forEach(n),ze=u(e),b=s(e,"H2",{class:!0});var Ie=i(b);q=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=i(q);ue=s(Xt,"SPAN",{});var Ct=i(ue);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),at=u(Ie),me=s(Ie,"SPAN",{});var Yt=i(me);lt=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Me=u(e),m=s(e,"DIV",{class:!0});var _=i(m);$(j.$$.fragment,_),ct=u(_),h=s(_,"P",{});var M=i(h);dt=a(M,"Adapted from "),te=s(M,"A",{href:!0});var Ht=i(te);pt=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),ut=a(M," and "),ne=s(M,"A",{href:!0});var Vt=i(ne);mt=a(Vt,"LukeTokenizer"),Vt.forEach(n),ht=a(M,`. Based on
