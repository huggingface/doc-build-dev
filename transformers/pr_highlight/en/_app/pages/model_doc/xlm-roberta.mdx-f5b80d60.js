...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L194",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L220",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L248",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Zs=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L305"}}),ea=new Me({}),ta=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L155",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L181",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L91"}}),La=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Wa=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),mi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Qi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),nl=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
alongside usage examples.`),HT=c(),xt=n("div"),T(qr.$$.fragment),VT=c(),qo=n("p"),JT=r("The "),cd=n("a"),KT=r("TFRobertaForMultipleChoice"),GT=r(" forward method, overrides the "),ap=n("code"),YT=r("__call__"),ZT=r(" special method."),ey=c(),T(Jn.$$.fragment),ty=c(),T(Kn.$$.fragment),xm=c(),Co=n("h2"),Gn=n("a"),rp=n("span"),T(Cr.$$.fragment),oy=c(),ip=n("span"),ny=r("TFXLMRobertaForTokenClassification"),Rm=c(),Se=n("div"),T(jr.$$.fragment),sy=c(),lp=n("p"),ay=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),ry=c(),Xr=n("p"),iy=r("This model inherits from "),pd=n("a"),ly=r("TFPreTrainedModel"),dy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cy=c(),Pr=n("p"),py=r("This model is also a "),Ar=n("a"),hy=r("tf.keras.Model"),my=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),uy=c(),T(Yn.$$.fragment),fy=c(),Or=n("p"),gy=r("This class overrides "),hd=n("a"),_y=r("TFRobertaForTokenClassification"),by=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ky=c(),pt=n("div"),T(Nr.$$.fragment),vy=c(),jo=n("p"),Ty=r("The "),md=n("a"),yy=r("TFRobertaForTokenClassification"),wy=r(" forward method, overrides the "),dp=n("code"),$y=r("__call__"),My=r(" special method."),Fy=c(),T(Zn.$$.fragment),xy=c(),T(es.$$.fragment),Ry=c(),T(ts.$$.fragment),Lm=c(),Xo=n("h2"),os=n("a"),cp=n("span"),T(Ir.$$.fragment),Ly=c(),pp=n("span"),Ey=r("TFXLMRobertaForQuestionAnswering"),Em=c(),We=n("div"),T(Dr.$$.fragment),zy=c(),Po=n("p"),qy=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),Cy=r("span start logits"),jy=r(" and "),mp=n("code"),Xy=r("span end logits"),Py=r(")."),Ay=c(),Sr=n("p"),Oy=r("This model inherits from "),ud=n("a"),Ny=r("TFPreTrainedModel"),Iy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dy=c(),Wr=n("p"),Sy=r("This model is also a "),Br=n("a"),Wy=r("tf.keras.Model"),By=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uy=c(),T(ns.$$.fragment),Qy=c(),Ur=n("p"),Hy=r("This class overrides "),up=n("code"),Vy=r("TFRobertaForQuestionAnsweringSimple"),Jy=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ky=c(),ht=n("div"),T(Qr.$$.fragment),Gy=c(),Ao=n("p"),Yy=r("The "),fd=n("a"),Zy=r("TFRobertaForQuestionAnswering"),ew=r(" forward method, overrides the "),fp=n("code"),tw=r("__call__"),ow=r(" special method."),nw=c(),T(ss.$$.fragment),sw=c(),T(as.$$.fragment),aw=c(),T(rs.$$.fragment),zm=c(),Oo=n("h2"),is=n("a"),gp=n("span"),T(Hr.$$.fragment),rw=c(),_p=n("span"),iw=r("FlaxXLMRobertaModel"),qm=c(),Be=n("div"),T(Vr.$$.fragment),lw=c(),Jr=n("p"),dw=r(`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=n("a"),cw=r("FlaxPreTrainedModel"),pw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hw=c(),Kr=n("p"),mw=r("This model is also a Flax Linen "),Gr=n("a"),uw=r("flax.linen.Module"),fw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gw=c(),bp=n("p"),_w=r("Finally, this model supports inherent JAX features such as:"),bw=c(),St=n("ul"),kp=n("li"),Yr=n("a"),kw=r("Just-In-Time (JIT) compilation"),vw=c(),vp=n("li"),Zr=n("a"),Tw=r("Automatic Differentiation"),yw=c(),Tp=n("li"),ei=n("a"),ww=r("Vectorization"),$w=c(),yp=n("li"),ti=n("a"),Mw=r("Parallelization"),Fw=c(),oi=n("p"),xw=r("This class overrides "),_d=n("a"),Rw=r("FlaxRobertaModel"),Lw=r(`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Ew=c(),Rt=n("div"),T(ni.$$.fragment),zw=c(),No=n("p"),qw=r("The "),wp=n("code"),Cw=r("FlaxRobertaPreTrainedModel"),jw=r(" forward method, overrides the "),$p=n("code"),Xw=r("__call__"),Pw=r(" special method."),Aw=c(),T(ls.$$.fragment),Ow=c(),T(ds.$$.fragment),Cm=c(),Io=n("h2"),cs=n("a"),Mp=n("span"),T(si.$$.fragment),Nw=c(),Fp=n("span"),Iw=r("FlaxXLMRobertaForMaskedLM"),jm=c(),Ue=n("div"),T(ai.$$.fragment),Dw=c(),Do=n("p"),Sw=r("XLM-RoBERTa Model with a "),xp=n("code"),Ww=r("language modeling"),Bw=r(` head on top.
This model inherits from `),bd=n("a"),Uw=r("FlaxPreTrainedModel"),Qw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hw=c(),ri=n("p"),Vw=r("This model is also a Flax Linen "),ii=n("a"),Jw=r("flax.linen.Module"),Kw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gw=c(),Rp=n("p"),Yw=r("Finally, this model supports inherent JAX features such as:"),Zw=c(),Wt=n("ul"),Lp=n("li"),li=n("a"),e$=r("Just-In-Time (JIT) compilation"),t$=c(),Ep=n("li"),di=n("a"),o$=r("Automatic Differentiation"),n$=c(),zp=n("li"),ci=n("a"),s$=r("Vectorization"),a$=c(),qp=n("li"),pi=n("a"),r$=r("Parallelization"),i$=c(),hi=n("p"),l$=r("This class overrides "),kd=n("a"),d$=r("FlaxRobertaForMaskedLM"),c$=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),p$=c(),Lt=n("div"),T(mi.$$.fragment),h$=c(),So=n("p"),m$=r("The "),Cp=n("code"),u$=r("FlaxRobertaPreTrainedModel"),f$=r(" forward method, overrides the "),jp=n("code"),g$=r("__call__"),_$=r(" special method."),b$=c(),T(ps.$$.fragment),k$=c(),T(hs.$$.fragment),Xm=c(),Wo=n("h2"),ms=n("a"),Xp=n("span"),T(ui.$$.fragment),v$=c(),Pp=n("span"),T$=r("FlaxXLMRobertaForSequenceClassification"),Pm=c(),Ce=n("div"),T(fi.$$.fragment),y$=c(),Ap=n("p"),w$=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),$$=c(),gi=n("p"),M$=r("This model inherits from "),vd=n("a"),F$=r("FlaxPreTrainedModel"),x$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),R$=c(),_i=n("p"),L$=r("This model is also a Flax Linen "),bi=n("a"),E$=r("flax.linen.Module"),z$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),q$=c(),Op=n("p"),C$=r("Finally, this model supports inherent JAX features such as:"),j$=c(),Bt=n("ul"),Np=n("li"),ki=n("a"),X$=r("Just-In-Time (JIT) compilation"),P$=c(),Ip=n("li"),vi=n("a"),A$=r("Automatic Differentiation"),O$=c(),Dp=n("li"),Ti=n("a"),N$=r("Vectorization"),I$=c(),Sp=n("li"),yi=n("a"),D$=r("Parallelization"),S$=c(),wi=n("p"),W$=r("This class overrides "),Td=n("a"),B$=r("FlaxRobertaForSequenceClassification"),U$=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Q$=c(),Et=n("div"),T($i.$$.fragment),H$=c(),Bo=n("p"),V$=r("The "),Wp=n("code"),J$=r("FlaxRobertaPreTrainedModel"),K$=r(" forward method, overrides the "),Bp=n("code"),G$=r("__call__"),Y$=r(" special method."),Z$=c(),T(us.$$.fragment),e1=c(),T(fs.$$.fragment),Am=c(),Uo=n("h2"),gs=n("a"),Up=n("span"),T(Mi.$$.fragment),t1=c(),Qp=n("span"),o1=r("FlaxXLMRobertaForMultipleChoice"),Om=c(),je=n("div"),T(Fi.$$.fragment),n1=c(),Hp=n("p"),s1=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),a1=c(),xi=n("p"),r1=r("This model inherits from "),yd=n("a"),i1=r("FlaxPreTrainedModel"),l1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),d1=c(),Ri=n("p"),c1=r("This model is also a Flax Linen "),Li=n("a"),p1=r("flax.linen.Module"),h1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),m1=c(),Vp=n("p"),u1=r("Finally, this model supports inherent JAX features such as:"),f1=c(),Ut=n("ul"),Jp=n("li"),Ei=n("a"),g1=r("Just-In-Time (JIT) compilation"),_1=c(),Kp=n("li"),zi=n("a"),b1=r("Automatic Differentiation"),k1=c(),Gp=n("li"),qi=n("a"),v1=r("Vectorization"),T1=c(),Yp=n("li"),Ci=n("a"),y1=r("Parallelization"),w1=c(),ji=n("p"),$1=r("This class overrides "),wd=n("a"),M1=r("FlaxRobertaForMultipleChoice"),F1=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),x1=c(),zt=n("div"),T(Xi.$$.fragment),R1=c(),Qo=n("p"),L1=r("The "),Zp=n("code"),E1=r("FlaxRobertaPreTrainedModel"),z1=r(" forward method, overrides the "),eh=n("code"),q1=r("__call__"),C1=r(" special method."),j1=c(),T(_s.$$.fragment),X1=c(),T(bs.$$.fragment),Nm=c(),Ho=n("h2"),ks=n("a"),th=n("span"),T(Pi.$$.fragment),P1=c(),oh=n("span"),A1=r("FlaxXLMRobertaForTokenClassification"),Im=c(),Xe=n("div"),T(Ai.$$.fragment),O1=c(),nh=n("p"),N1=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),I1=c(),Oi=n("p"),D1=r("This model inherits from "),$d=n("a"),S1=r("FlaxPreTrainedModel"),W1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),B1=c(),Ni=n("p"),U1=r("This model is also a Flax Linen "),Ii=n("a"),Q1=r("flax.linen.Module"),H1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),V1=c(),sh=n("p"),J1=r("Finally, this model supports inherent JAX features such as:"),K1=c(),Qt=n("ul"),ah=n("li"),Di=n("a"),G1=r("Just-In-Time (JIT) compilation"),Y1=c(),rh=n("li"),Si=n("a"),Z1=r("Automatic Differentiation"),eM=c(),ih=n("li"),Wi=n("a"),tM=r("Vectorization"),oM=c(),lh=n("li"),Bi=n("a"),nM=r("Parallelization"),sM=c(),Ui=n("p"),aM=r("This class overrides "),Md=n("a"),rM=r("FlaxRobertaForTokenClassification"),iM=r(`. Please check the superclass for the appropriate
...
alongside usage examples.`),Nu.forEach(t),HT=p(_t),xt=s(_t,"DIV",{class:!0});var Ls=a(xt);y(qr.$$.fragment,Ls),VT=p(Ls),qo=s(Ls,"P",{});var Sd=a(qo);JT=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var r0=a(cd);KT=i(r0,"TFRobertaForMultipleChoice"),r0.forEach(t),GT=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var i0=a(ap);YT=i(i0,"__call__"),i0.forEach(t),ZT=i(Sd," special method."),Sd.forEach(t),ey=p(Ls),y(Jn.$$.fragment,Ls),ty=p(Ls),y(Kn.$$.fragment,Ls),Ls.forEach(t),_t.forEach(t),xm=p(o),Co=s(o,"H2",{class:!0});var Iu=a(Co);Gn=s(Iu,"A",{id:!0,class:!0,href:!0});var l0=a(Gn);rp=s(l0,"SPAN",{});var d0=a(rp);y(Cr.$$.fragment,d0),d0.forEach(t),l0.forEach(t),oy=p(Iu),ip=s(Iu,"SPAN",{});var c0=a(ip);ny=i(c0,"TFXLMRobertaForTokenClassification"),c0.forEach(t),Iu.forEach(t),Rm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(jr.$$.fragment,bt),sy=p(bt),lp=s(bt,"P",{});var p0=a(lp);ay=i(p0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),p0.forEach(t),ry=p(bt),Xr=s(bt,"P",{});var Du=a(Xr);iy=i(Du,"This model inherits from "),pd=s(Du,"A",{href:!0});var h0=a(pd);ly=i(h0,"TFPreTrainedModel"),h0.forEach(t),dy=i(Du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Du.forEach(t),cy=p(bt),Pr=s(bt,"P",{});var Su=a(Pr);py=i(Su,"This model is also a "),Ar=s(Su,"A",{href:!0,rel:!0});var m0=a(Ar);hy=i(m0,"tf.keras.Model"),m0.forEach(t),my=i(Su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Su.forEach(t),uy=p(bt),y(Yn.$$.fragment,bt),fy=p(bt),Or=s(bt,"P",{});var Wu=a(Or);gy=i(Wu,"This class overrides "),hd=s(Wu,"A",{href:!0});var u0=a(hd);_y=i(u0,"TFRobertaForTokenClassification"),u0.forEach(t),by=i(Wu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Wu.forEach(t),ky=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Nr.$$.fragment,so),vy=p(so),jo=s(so,"P",{});var Wd=a(jo);Ty=i(Wd,"The "),md=s(Wd,"A",{href:!0});var f0=a(md);yy=i(f0,"TFRobertaForTokenClassification"),f0.forEach(t),wy=i(Wd," forward method, overrides the "),dp=s(Wd,"CODE",{});var g0=a(dp);$y=i(g0,"__call__"),g0.forEach(t),My=i(Wd," special method."),Wd.forEach(t),Fy=p(so),y(Zn.$$.fragment,so),xy=p(so),y(es.$$.fragment,so),Ry=p(so),y(ts.$$.fragment,so),so.forEach(t),bt.forEach(t),Lm=p(o),Xo=s(o,"H2",{class:!0});var Bu=a(Xo);os=s(Bu,"A",{id:!0,class:!0,href:!0});var _0=a(os);cp=s(_0,"SPAN",{});var b0=a(cp);y(Ir.$$.fragment,b0),b0.forEach(t),_0.forEach(t),Ly=p(Bu),pp=s(Bu,"SPAN",{});var k0=a(pp);Ey=i(k0,"TFXLMRobertaForQuestionAnswering"),k0.forEach(t),Bu.forEach(t),Em=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(Dr.$$.fragment,kt),zy=p(kt),Po=s(kt,"P",{});var Bd=a(Po);qy=i(Bd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Bd,"CODE",{});var v0=a(hp);Cy=i(v0,"span start logits"),v0.forEach(t),jy=i(Bd," and "),mp=s(Bd,"CODE",{});var T0=a(mp);Xy=i(T0,"span end logits"),T0.forEach(t),Py=i(Bd,")."),Bd.forEach(t),Ay=p(kt),Sr=s(kt,"P",{});var Uu=a(Sr);Oy=i(Uu,"This model inherits from "),ud=s(Uu,"A",{href:!0});var y0=a(ud);Ny=i(y0,"TFPreTrainedModel"),y0.forEach(t),Iy=i(Uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uu.forEach(t),Dy=p(kt),Wr=s(kt,"P",{});var Qu=a(Wr);Sy=i(Qu,"This model is also a "),Br=s(Qu,"A",{href:!0,rel:!0});var w0=a(Br);Wy=i(w0,"tf.keras.Model"),w0.forEach(t),By=i(Qu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qu.forEach(t),Uy=p(kt),y(ns.$$.fragment,kt),Qy=p(kt),Ur=s(kt,"P",{});var Hu=a(Ur);Hy=i(Hu,"This class overrides "),up=s(Hu,"CODE",{});var $0=a(up);Vy=i($0,"TFRobertaForQuestionAnsweringSimple"),$0.forEach(t),Jy=i(Hu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Hu.forEach(t),Ky=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Qr.$$.fragment,ao),Gy=p(ao),Ao=s(ao,"P",{});var Ud=a(Ao);Yy=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var M0=a(fd);Zy=i(M0,"TFRobertaForQuestionAnswering"),M0.forEach(t),ew=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var F0=a(fp);tw=i(F0,"__call__"),F0.forEach(t),ow=i(Ud," special method."),Ud.forEach(t),nw=p(ao),y(ss.$$.fragment,ao),sw=p(ao),y(as.$$.fragment,ao),aw=p(ao),y(rs.$$.fragment,ao),ao.forEach(t),kt.forEach(t),zm=p(o),Oo=s(o,"H2",{class:!0});var Vu=a(Oo);is=s(Vu,"A",{id:!0,class:!0,href:!0});var x0=a(is);gp=s(x0,"SPAN",{});var R0=a(gp);y(Hr.$$.fragment,R0),R0.forEach(t),x0.forEach(t),rw=p(Vu),_p=s(Vu,"SPAN",{});var L0=a(_p);iw=i(L0,"FlaxXLMRobertaModel"),L0.forEach(t),Vu.forEach(t),qm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Vr.$$.fragment,vt),lw=p(vt),Jr=s(vt,"P",{});var Ju=a(Jr);dw=i(Ju,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=s(Ju,"A",{href:!0});var E0=a(gd);cw=i(E0,"FlaxPreTrainedModel"),E0.forEach(t),pw=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ju.forEach(t),hw=p(vt),Kr=s(vt,"P",{});var Ku=a(Kr);mw=i(Ku,"This model is also a Flax Linen "),Gr=s(Ku,"A",{href:!0,rel:!0});var z0=a(Gr);uw=i(z0,"flax.linen.Module"),z0.forEach(t),fw=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),gw=p(vt),bp=s(vt,"P",{});var q0=a(bp);_w=i(q0,"Finally, this model supports inherent JAX features such as:"),q0.forEach(t),bw=p(vt),St=s(vt,"UL",{});var Es=a(St);kp=s(Es,"LI",{});var C0=a(kp);Yr=s(C0,"A",{href:!0,rel:!0});var j0=a(Yr);kw=i(j0,"Just-In-Time (JIT) compilation"),j0.forEach(t),C0.forEach(t),vw=p(Es),vp=s(Es,"LI",{});var X0=a(vp);Zr=s(X0,"A",{href:!0,rel:!0});var P0=a(Zr);Tw=i(P0,"Automatic Differentiation"),P0.forEach(t),X0.forEach(t),yw=p(Es),Tp=s(Es,"LI",{});var A0=a(Tp);ei=s(A0,"A",{href:!0,rel:!0});var O0=a(ei);ww=i(O0,"Vectorization"),O0.forEach(t),A0.forEach(t),$w=p(Es),yp=s(Es,"LI",{});var N0=a(yp);ti=s(N0,"A",{href:!0,rel:!0});var I0=a(ti);Mw=i(I0,"Parallelization"),I0.forEach(t),N0.forEach(t),Es.forEach(t),Fw=p(vt),oi=s(vt,"P",{});var Gu=a(oi);xw=i(Gu,"This class overrides "),_d=s(Gu,"A",{href:!0});var D0=a(_d);Rw=i(D0,"FlaxRobertaModel"),D0.forEach(t),Lw=i(Gu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Gu.forEach(t),Ew=p(vt),Rt=s(vt,"DIV",{class:!0});var zs=a(Rt);y(ni.$$.fragment,zs),zw=p(zs),No=s(zs,"P",{});var Qd=a(No);qw=i(Qd,"The "),wp=s(Qd,"CODE",{});var S0=a(wp);Cw=i(S0,"FlaxRobertaPreTrainedModel"),S0.forEach(t),jw=i(Qd," forward method, overrides the "),$p=s(Qd,"CODE",{});var W0=a($p);Xw=i(W0,"__call__"),W0.forEach(t),Pw=i(Qd," special method."),Qd.forEach(t),Aw=p(zs),y(ls.$$.fragment,zs),Ow=p(zs),y(ds.$$.fragment,zs),zs.forEach(t),vt.forEach(t),Cm=p(o),Io=s(o,"H2",{class:!0});var Yu=a(Io);cs=s(Yu,"A",{id:!0,class:!0,href:!0});var B0=a(cs);Mp=s(B0,"SPAN",{});var U0=a(Mp);y(si.$$.fragment,U0),U0.forEach(t),B0.forEach(t),Nw=p(Yu),Fp=s(Yu,"SPAN",{});var Q0=a(Fp);Iw=i(Q0,"FlaxXLMRobertaForMaskedLM"),Q0.forEach(t),Yu.forEach(t),jm=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(ai.$$.fragment,Tt),Dw=p(Tt),Do=s(Tt,"P",{});var Hd=a(Do);Sw=i(Hd,"XLM-RoBERTa Model with a "),xp=s(Hd,"CODE",{});var H0=a(xp);Ww=i(H0,"language modeling"),H0.forEach(t),Bw=i(Hd,` head on top.
This model inherits from `),bd=s(Hd,"A",{href:!0});var V0=a(bd);Uw=i(V0,"FlaxPreTrainedModel"),V0.forEach(t),Qw=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),Hw=p(Tt),ri=s(Tt,"P",{});var Zu=a(ri);Vw=i(Zu,"This model is also a Flax Linen "),ii=s(Zu,"A",{href:!0,rel:!0});var J0=a(ii);Jw=i(J0,"flax.linen.Module"),J0.forEach(t),Kw=i(Zu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zu.forEach(t),Gw=p(Tt),Rp=s(Tt,"P",{});var K0=a(Rp);Yw=i(K0,"Finally, this model supports inherent JAX features such as:"),K0.forEach(t),Zw=p(Tt),Wt=s(Tt,"UL",{});var qs=a(Wt);Lp=s(qs,"LI",{});var G0=a(Lp);li=s(G0,"A",{href:!0,rel:!0});var Y0=a(li);e$=i(Y0,"Just-In-Time (JIT) compilation"),Y0.forEach(t),G0.forEach(t),t$=p(qs),Ep=s(qs,"LI",{});var Z0=a(Ep);di=s(Z0,"A",{href:!0,rel:!0});var ex=a(di);o$=i(ex,"Automatic Differentiation"),ex.forEach(t),Z0.forEach(t),n$=p(qs),zp=s(qs,"LI",{});var tx=a(zp);ci=s(tx,"A",{href:!0,rel:!0});var ox=a(ci);s$=i(ox,"Vectorization"),ox.forEach(t),tx.forEach(t),a$=p(qs),qp=s(qs,"LI",{});var nx=a(qp);pi=s(nx,"A",{href:!0,rel:!0});var sx=a(pi);r$=i(sx,"Parallelization"),sx.forEach(t),nx.forEach(t),qs.forEach(t),i$=p(Tt),hi=s(Tt,"P",{});var ef=a(hi);l$=i(ef,"This class overrides "),kd=s(ef,"A",{href:!0});var ax=a(kd);d$=i(ax,"FlaxRobertaForMaskedLM"),ax.forEach(t),c$=i(ef,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),ef.forEach(t),p$=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Cs=a(Lt);y(mi.$$.fragment,Cs),h$=p(Cs),So=s(Cs,"P",{});var Vd=a(So);m$=i(Vd,"The "),Cp=s(Vd,"CODE",{});var rx=a(Cp);u$=i(rx,"FlaxRobertaPreTrainedModel"),rx.forEach(t),f$=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var ix=a(jp);g$=i(ix,"__call__"),ix.forEach(t),_$=i(Vd," special method."),Vd.forEach(t),b$=p(Cs),y(ps.$$.fragment,Cs),k$=p(Cs),y(hs.$$.fragment,Cs),Cs.forEach(t),Tt.forEach(t),Xm=p(o),Wo=s(o,"H2",{class:!0});var tf=a(Wo);ms=s(tf,"A",{id:!0,class:!0,href:!0});var lx=a(ms);Xp=s(lx,"SPAN",{});var dx=a(Xp);y(ui.$$.fragment,dx),dx.forEach(t),lx.forEach(t),v$=p(tf),Pp=s(tf,"SPAN",{});var cx=a(Pp);T$=i(cx,"FlaxXLMRobertaForSequenceClassification"),cx.forEach(t),tf.forEach(t),Pm=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(fi.$$.fragment,tt),y$=p(tt),Ap=s(tt,"P",{});var px=a(Ap);w$=i(px,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),px.forEach(t),$$=p(tt),gi=s(tt,"P",{});var of=a(gi);M$=i(of,"This model inherits from "),vd=s(of,"A",{href:!0});var hx=a(vd);F$=i(hx,"FlaxPreTrainedModel"),hx.forEach(t),x$=i(of,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),of.forEach(t),R$=p(tt),_i=s(tt,"P",{});var nf=a(_i);L$=i(nf,"This model is also a Flax Linen "),bi=s(nf,"A",{href:!0,rel:!0});var mx=a(bi);E$=i(mx,"flax.linen.Module"),mx.forEach(t),z$=i(nf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nf.forEach(t),q$=p(tt),Op=s(tt,"P",{});var ux=a(Op);C$=i(ux,"Finally, this model supports inherent JAX features such as:"),ux.forEach(t),j$=p(tt),Bt=s(tt,"UL",{});var js=a(Bt);Np=s(js,"LI",{});var fx=a(Np);ki=s(fx,"A",{href:!0,rel:!0});var gx=a(ki);X$=i(gx,"Just-In-Time (JIT) compilation"),gx.forEach(t),fx.forEach(t),P$=p(js),Ip=s(js,"LI",{});var _x=a(Ip);vi=s(_x,"A",{href:!0,rel:!0});var bx=a(vi);A$=i(bx,"Automatic Differentiation"),bx.forEach(t),_x.forEach(t),O$=p(js),Dp=s(js,"LI",{});var kx=a(Dp);Ti=s(kx,"A",{href:!0,rel:!0});var vx=a(Ti);N$=i(vx,"Vectorization"),vx.forEach(t),kx.forEach(t),I$=p(js),Sp=s(js,"LI",{});var Tx=a(Sp);yi=s(Tx,"A",{href:!0,rel:!0});var yx=a(yi);D$=i(yx,"Parallelization"),yx.forEach(t),Tx.forEach(t),js.forEach(t),S$=p(tt),wi=s(tt,"P",{});var sf=a(wi);W$=i(sf,"This class overrides "),Td=s(sf,"A",{href:!0});var wx=a(Td);B$=i(wx,"FlaxRobertaForSequenceClassification"),wx.forEach(t),U$=i(sf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),sf.forEach(t),Q$=p(tt),Et=s(tt,"DIV",{class:!0});var Xs=a(Et);y($i.$$.fragment,Xs),H$=p(Xs),Bo=s(Xs,"P",{});var Jd=a(Bo);V$=i(Jd,"The "),Wp=s(Jd,"CODE",{});var $x=a(Wp);J$=i($x,"FlaxRobertaPreTrainedModel"),$x.forEach(t),K$=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var Mx=a(Bp);G$=i(Mx,"__call__"),Mx.forEach(t),Y$=i(Jd," special method."),Jd.forEach(t),Z$=p(Xs),y(us.$$.fragment,Xs),e1=p(Xs),y(fs.$$.fragment,Xs),Xs.forEach(t),tt.forEach(t),Am=p(o),Uo=s(o,"H2",{class:!0});var af=a(Uo);gs=s(af,"A",{id:!0,class:!0,href:!0});var Fx=a(gs);Up=s(Fx,"SPAN",{});var xx=a(Up);y(Mi.$$.fragment,xx),xx.forEach(t),Fx.forEach(t),t1=p(af),Qp=s(af,"SPAN",{});var Rx=a(Qp);o1=i(Rx,"FlaxXLMRobertaForMultipleChoice"),Rx.forEach(t),af.forEach(t),Om=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Fi.$$.fragment,ot),n1=p(ot),Hp=s(ot,"P",{});var Lx=a(Hp);s1=i(Lx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Lx.forEach(t),a1=p(ot),xi=s(ot,"P",{});var rf=a(xi);r1=i(rf,"This model inherits from "),yd=s(rf,"A",{href:!0});var Ex=a(yd);i1=i(Ex,"FlaxPreTrainedModel"),Ex.forEach(t),l1=i(rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),rf.forEach(t),d1=p(ot),Ri=s(ot,"P",{});var lf=a(Ri);c1=i(lf,"This model is also a Flax Linen "),Li=s(lf,"A",{href:!0,rel:!0});var zx=a(Li);p1=i(zx,"flax.linen.Module"),zx.forEach(t),h1=i(lf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lf.forEach(t),m1=p(ot),Vp=s(ot,"P",{});var qx=a(Vp);u1=i(qx,"Finally, this model supports inherent JAX features such as:"),qx.forEach(t),f1=p(ot),Ut=s(ot,"UL",{});var Ps=a(Ut);Jp=s(Ps,"LI",{});var Cx=a(Jp);Ei=s(Cx,"A",{href:!0,rel:!0});var jx=a(Ei);g1=i(jx,"Just-In-Time (JIT) compilation"),jx.forEach(t),Cx.forEach(t),_1=p(Ps),Kp=s(Ps,"LI",{});var Xx=a(Kp);zi=s(Xx,"A",{href:!0,rel:!0});var Px=a(zi);b1=i(Px,"Automatic Differentiation"),Px.forEach(t),Xx.forEach(t),k1=p(Ps),Gp=s(Ps,"LI",{});var Ax=a(Gp);qi=s(Ax,"A",{href:!0,rel:!0});var Ox=a(qi);v1=i(Ox,"Vectorization"),Ox.forEach(t),Ax.forEach(t),T1=p(Ps),Yp=s(Ps,"LI",{});var Nx=a(Yp);Ci=s(Nx,"A",{href:!0,rel:!0});var Ix=a(Ci);y1=i(Ix,"Parallelization"),Ix.forEach(t),Nx.forEach(t),Ps.forEach(t),w1=p(ot),ji=s(ot,"P",{});var df=a(ji);$1=i(df,"This class overrides "),wd=s(df,"A",{href:!0});var Dx=a(wd);M1=i(Dx,"FlaxRobertaForMultipleChoice"),Dx.forEach(t),F1=i(df,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),df.forEach(t),x1=p(ot),zt=s(ot,"DIV",{class:!0});var As=a(zt);y(Xi.$$.fragment,As),R1=p(As),Qo=s(As,"P",{});var Kd=a(Qo);L1=i(Kd,"The "),Zp=s(Kd,"CODE",{});var Sx=a(Zp);E1=i(Sx,"FlaxRobertaPreTrainedModel"),Sx.forEach(t),z1=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var Wx=a(eh);q1=i(Wx,"__call__"),Wx.forEach(t),C1=i(Kd," special method."),Kd.forEach(t),j1=p(As),y(_s.$$.fragment,As),X1=p(As),y(bs.$$.fragment,As),As.forEach(t),ot.forEach(t),Nm=p(o),Ho=s(o,"H2",{class:!0});var cf=a(Ho);ks=s(cf,"A",{id:!0,class:!0,href:!0});var Bx=a(ks);th=s(Bx,"SPAN",{});var Ux=a(th);y(Pi.$$.fragment,Ux),Ux.forEach(t),Bx.forEach(t),P1=p(cf),oh=s(cf,"SPAN",{});var Qx=a(oh);A1=i(Qx,"FlaxXLMRobertaForTokenClassification"),Qx.forEach(t),cf.forEach(t),Im=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ai.$$.fragment,nt),O1=p(nt),nh=s(nt,"P",{});var Hx=a(nh);N1=i(Hx,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Hx.forEach(t),I1=p(nt),Oi=s(nt,"P",{});var pf=a(Oi);D1=i(pf,"This model inherits from "),$d=s(pf,"A",{href:!0});var Vx=a($d);S1=i(Vx,"FlaxPreTrainedModel"),Vx.forEach(t),W1=i(pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),pf.forEach(t),B1=p(nt),Ni=s(nt,"P",{});var hf=a(Ni);U1=i(hf,"This model is also a Flax Linen "),Ii=s(hf,"A",{href:!0,rel:!0});var Jx=a(Ii);Q1=i(Jx,"flax.linen.Module"),Jx.forEach(t),H1=i(hf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),hf.forEach(t),V1=p(nt),sh=s(nt,"P",{});var Kx=a(sh);J1=i(Kx,"Finally, this model supports inherent JAX features such as:"),Kx.forEach(t),K1=p(nt),Qt=s(nt,"UL",{});var Os=a(Qt);ah=s(Os,"LI",{});var Gx=a(ah);Di=s(Gx,"A",{href:!0,rel:!0});var Yx=a(Di);G1=i(Yx,"Just-In-Time (JIT) compilation"),Yx.forEach(t),Gx.forEach(t),Y1=p(Os),rh=s(Os,"LI",{});var Zx=a(rh);Si=s(Zx,"A",{href:!0,rel:!0});var eR=a(Si);Z1=i(eR,"Automatic Differentiation"),eR.forEach(t),Zx.forEach(t),eM=p(Os),ih=s(Os,"LI",{});var tR=a(ih);Wi=s(tR,"A",{href:!0,rel:!0});var oR=a(Wi);tM=i(oR,"Vectorization"),oR.forEach(t),tR.forEach(t),oM=p(Os),lh=s(Os,"LI",{});var nR=a(lh);Bi=s(nR,"A",{href:!0,rel:!0});var sR=a(Bi);nM=i(sR,"Parallelization"),sR.forEach(t),nR.forEach(t),Os.forEach(t),sM=p(nt),Ui=s(nt,"P",{});var mf=a(Ui);aM=i(mf,"This class overrides "),Md=s(mf,"A",{href:!0});var aR=a(Md);rM=i(aR,"FlaxRobertaForTokenClassification"),aR.forEach(t),iM=i(mf,`. Please check the superclass for the appropriate
