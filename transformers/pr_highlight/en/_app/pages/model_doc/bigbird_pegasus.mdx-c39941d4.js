...
elements depending on the configuration (<a
  href="/docs/transformers/pr_highlight/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2501",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2771",returnDescription:`
<p>A <a
...
`}}),De=new K({props:{anchor:"transformers.BigBirdPegasusForCausalLM.forward.example",$$slots:{default:[Hd]},$$scope:{ctx:P}}}),{c(){l=s("meta"),_=p(),c=s("h1"),u=s("a"),v=s("span"),w(r.$$.fragment),m=p(),F=s("span"),rn=i("BigBirdPegasus"),ps=p(),Z=s("h2"),he=s("a"),it=s("span"),w(He.$$.fragment),dn=p(),dt=s("span"),ln=i("Overview"),gs=p(),pe=s("p"),cn=i("The BigBird model was proposed in "),Re=s("a"),un=i("Big Bird: Transformers for Longer Sequences"),hn=i(` by
...
summarization, compared to BERT or RoBERTa.`),ms=p(),Io=s("p"),pn=i("The abstract from the paper is the following:"),fs=p(),Do=s("p"),lt=s("em"),gn=i(`Transformers-based models, such as BERT, have been one of the most successful deep learning models for NLP.
...
propose novel applications to genomics data.`),_s=p(),Qo=s("p"),mn=i("Tips:"),bs=p(),z=s("ul"),Ke=s("li"),fn=i("For an in-detail explanation on how BigBird\u2019s attention works, see "),Ve=s("a"),_n=i("this blog post"),bn=i("."),vn=p(),A=s("li"),wn=i("BigBird comes with 2 implementations: "),ct=s("strong"),kn=i("original_full"),yn=i(" & "),ut=s("strong"),Bn=i("block_sparse"),Tn=i(`. For the sequence length < 1024, using
`),ht=s("strong"),$n=i("original_full"),Pn=i(" is advised as there is no benefit in using "),pt=s("strong"),qn=i("block_sparse"),zn=i(" attention."),xn=p(),gt=s("li"),Fn=i("The code currently uses window size of 3 blocks and 2 global blocks."),Cn=p(),mt=s("li"),En=i("Sequence length must be divisible by block size."),Mn=p(),Je=s("li"),jn=i("Current implementation supports only "),ft=s("strong"),Sn=i("ITC"),On=i("."),An=p(),Ze=s("li"),Ln=i("Current implementation doesn\u2019t support "),_t=s("strong"),Nn=i("num_random_blocks = 0"),In=i("."),Dn=p(),Ye=s("li"),Qn=i("BigBirdPegasus uses the "),Xe=s("a"),Gn=i("PegasusTokenizer"),Wn=i("."),vs=p(),ge=s("p"),Un=i("The original code can be found "),eo=s("a"),Hn=i("here"),Rn=i("."),ws=p(),Y=s("h2"),me=s("a"),bt=s("span"),w(oo.$$.fragment),Kn=p(),vt=s("span"),Vn=i("BigBirdPegasusConfig"),ks=p(),q=s("div"),w(to.$$.fragment),Jn=p(),X=s("p"),Zn=i("This is the configuration class to store the configuration of a "),Go=s("a"),Yn=i("BigBirdPegasusModel"),Xn=i(`. It is used to instantiate
...
`),so=s("a"),ea=i("google/bigbird-pegasus-large-arxiv"),oa=i(" architecture."),ta=p(),ee=s("p"),sa=i("Configuration objects inherit from "),Wo=s("a"),na=i("PretrainedConfig"),aa=i(` and can be used to control the model outputs. Read the
documentation from `),Uo=s("a"),ra=i("PretrainedConfig"),ia=i(" for more information."),da=p(),w(fe.$$.fragment),la=p(),wt=s("blockquote"),kt=s("blockquote"),yt=s("blockquote"),Bt=s("p"),ca=i("from transformers import BigBirdPegasusModel, BigBirdPegasusConfig"),ua=p(),Tt=s("blockquote"),$t=s("blockquote"),no=s("blockquote"),_e=s("h1"),be=s("a"),Pt=s("span"),w(ao.$$.fragment),ha=p(),qt=s("span"),pa=i("Initializing a BigBirdPegasus bigbird-pegasus-base style configuration >>> configuration ="),ga=p(),zt=s("p"),ma=i("BigBirdPegasusConfig()"),fa=p(),xt=s("blockquote"),Ft=s("blockquote"),ro=s("blockquote"),ve=s("h1"),we=s("a"),Ct=s("span"),w(io.$$.fragment),_a=p(),Et=s("span"),ba=i("Initializing a model from the bigbird-pegasus-base style configuration >>> model ="),va=p(),Mt=s("p"),wa=i("BigBirdPegasusModel(configuration)"),ka=p(),jt=s("blockquote"),St=s("blockquote"),Ot=s("blockquote"),ke=s("h1"),ye=s("a"),At=s("span"),w(lo.$$.fragment),ya=p(),Lt=s("span"),Ba=i("Accessing the model configuration >>> configuration = model.config"),ys=p(),oe=s("h2"),Be=s("a"),Nt=s("span"),w(co.$$.fragment),Ta=p(),It=s("span"),$a=i("BigBirdPegasusModel"),Bs=p(),L=s("div"),w(uo.$$.fragment),Pa=p(),ho=s("p"),qa=i(`The bare BigBirdPegasus Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ho=s("a"),za=i("PreTrainedModel"),xa=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Fa=p(),po=s("p"),Ca=i("This model is also a PyTorch "),go=s("a"),Ea=i("torch.nn.Module"),Ma=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ja=p(),I=s("div"),w(mo.$$.fragment),Sa=p(),te=s("p"),Oa=i("The "),Ro=s("a"),Aa=i("BigBirdPegasusModel"),La=i(" forward method, overrides the "),Dt=s("code"),Na=i("__call__"),Ia=i(" special method."),Da=p(),w(Te.$$.fragment),Qa=p(),w($e.$$.fragment),Ts=p(),se=s("h2"),Pe=s("a"),Qt=s("span"),w(fo.$$.fragment),Ga=p(),Gt=s("span"),Wa=i("BigBirdPegasusForConditionalGeneration"),$s=p(),N=s("div"),w(_o.$$.fragment),Ua=p(),bo=s("p"),Ha=i(`The BigBirdPegasus Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ko=s("a"),Ra=i("PreTrainedModel"),Ka=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Va=p(),vo=s("p"),Ja=i("This model is also a PyTorch "),wo=s("a"),Za=i("torch.nn.Module"),Ya=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa=p(),D=s("div"),w(ko.$$.fragment),er=p(),ne=s("p"),or=i("The "),Vo=s("a"),tr=i("BigBirdPegasusForConditionalGeneration"),sr=i(" forward method, overrides the "),Wt=s("code"),nr=i("__call__"),ar=i(" special method."),rr=p(),w(qe.$$.fragment),ir=p(),w(ze.$$.fragment),Ps=p(),ae=s("h2"),xe=s("a"),Ut=s("span"),w(yo.$$.fragment),dr=p(),Ht=s("span"),lr=i("BigBirdPegasusForSequenceClassification"),qs=p(),E=s("div"),w(Bo.$$.fragment),cr=p(),Rt=s("p"),ur=i(`BigBirdPegasus model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g.
for GLUE tasks.`),hr=p(),To=s("p"),pr=i("This model inherits from "),Jo=s("a"),gr=i("PreTrainedModel"),mr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),fr=p(),$o=s("p"),_r=i("This model is also a PyTorch "),Po=s("a"),br=i("torch.nn.Module"),vr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wr=p(),x=s("div"),w(qo.$$.fragment),kr=p(),re=s("p"),yr=i("The "),Zo=s("a"),Br=i("BigBirdPegasusForSequenceClassification"),Tr=i(" forward method, overrides the "),Kt=s("code"),$r=i("__call__"),Pr=i(" special method."),qr=p(),w(Fe.$$.fragment),zr=p(),w(Ce.$$.fragment),xr=p(),w(Ee.$$.fragment),Fr=p(),w(Me.$$.fragment),Cr=p(),w(je.$$.fragment),zs=p(),ie=s("h2"),Se=s("a"),Vt=s("span"),w(zo.$$.fragment),Er=p(),Jt=s("span"),Mr=i("BigBirdPegasusForQuestionAnswering"),xs=p(),M=s("div"),w(xo.$$.fragment),jr=p(),de=s("p"),Sr=i(`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Zt=s("code"),Or=i("span start logits"),Ar=i(" and "),Yt=s("code"),Lr=i("span end logits"),Nr=i(")."),Ir=p(),Fo=s("p"),Dr=i("This model inherits from "),Yo=s("a"),Qr=i("PreTrainedModel"),Gr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Wr=p(),Co=s("p"),Ur=i("This model is also a PyTorch "),Eo=s("a"),Hr=i("torch.nn.Module"),Rr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kr=p(),j=s("div"),w(Mo.$$.fragment),Vr=p(),le=s("p"),Jr=i("The "),Xo=s("a"),Zr=i("BigBirdPegasusForQuestionAnswering"),Yr=i(" forward method, overrides the "),Xt=s("code"),Xr=i("__call__"),ei=i(" special method."),oi=p(),w(Oe.$$.fragment),ti=p(),w(Ae.$$.fragment),si=p(),w(Le.$$.fragment),Fs=p(),ce=s("h2"),Ne=s("a"),es=s("span"),w(jo.$$.fragment),ni=p(),os=s("span"),ai=i("BigBirdPegasusForCausalLM"),Cs=p(),ue=s("div"),w(So.$$.fragment),ri=p(),Ie=s("div"),w(Oo.$$.fragment),ii=p(),w(De.$$.fragment),this.h()},l(o){const f=Cd('[data-svelte="svelte-1phssyn"]',document.head);l=n(f,"META",{name:!0,content:!0}),f.forEach(t),_=g(o),c=n(o,"H1",{class:!0});var Ao=a(c);u=n(Ao,"A",{id:!0,class:!0,href:!0});var ts=a(u);v=n(ts,"SPAN",{});var ss=a(v);k(r.$$.fragment,ss),ss.forEach(t),ts.forEach(t),m=g(Ao),F=n(Ao,"SPAN",{});var ns=a(F);rn=d(ns,"BigBirdPegasus"),ns.forEach(t),Ao.forEach(t),ps=g(o),Z=n(o,"H2",{class:!0});var Lo=a(Z);he=n(Lo,"A",{id:!0,class:!0,href:!0});var as=a(he);it=n(as,"SPAN",{});var rs=a(it);k(He.$$.fragment,rs),rs.forEach(t),as.forEach(t),dn=g(Lo),dt=n(Lo,"SPAN",{});var is=a(dt);ln=d(is,"Overview"),is.forEach(t),Lo.forEach(t),gs=g(o),pe=n(o,"P",{});var No=a(pe);cn=d(No,"The BigBird model was proposed in "),Re=n(No,"A",{href:!0,rel:!0});var ds=a(Re);un=d(ds,"Big Bird: Transformers for Longer Sequences"),ds.forEach(t),hn=d(No,` by
Zaheer, Manzil and Guruganesh, Guru and Dubey, Kumar Avinava and Ainslie, Joshua and Alberti, Chris and Ontanon,
Santiago and Pham, Philip and Ravula, Anirudh and Wang, Qifan and Yang, Li and others. BigBird, is a sparse-attention
based transformer which extends Transformer based models, such as BERT to much longer sequences. In addition to sparse
attention, BigBird also applies global attention as well as random attention to the input sequence. Theoretically, it
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Us.forEach(t),Fa=g(Qe),po=n(Qe,"P",{});var Hs=a(po);Ca=d(Hs,"This model is also a PyTorch "),go=n(Hs,"A",{href:!0,rel:!0});var Yi=a(go);Ea=d(Yi,"torch.nn.Module"),Yi.forEach(t),Ma=d(Hs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
for GLUE tasks.`),ud.forEach(t),hr=g(U),To=n(U,"P",{});var Zs=a(To);pr=d(Zs,"This model inherits from "),Jo=n(Zs,"A",{href:!0});var hd=a(Jo);gr=d(hd,"PreTrainedModel"),hd.forEach(t),mr=d(Zs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Zs.forEach(t),fr=g(U),$o=n(U,"P",{});var Ys=a($o);_r=d(Ys,"This model is also a PyTorch "),Po=n(Ys,"A",{href:!0,rel:!0});var pd=a(Po);br=d(pd,"torch.nn.Module"),pd.forEach(t),vr=d(Ys,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),on.forEach(t),Kr=g(H),j=n(H,"DIV",{class:!0});var R=a(j);k(Mo.$$.fragment,R),Vr=g(R),le=n(R,"P",{});var rt=a(le);Jr=d(rt,"The "),Xo=n(rt,"A",{href:!0});var Bd=a(Xo);Zr=d(Bd,"BigBirdPegasusForQuestionAnswering"),Bd.forEach(t),Yr=d(rt," forward method, overrides the "),Xt=n(rt,"CODE",{});var Td=a(Xt);Xr=d(Td,"__call__"),Td.forEach(t),ei=d(rt," special method."),rt.forEach(t),oi=g(R),k(Oe.$$.fragment,R),ti=g(R),k(Ae.$$.fragment,R),si=g(R),k(Le.$$.fragment,R),R.forEach(t),H.forEach(t),Fs=g(o),ce=n(o,"H2",{class:!0});var tn=a(ce);Ne=n(tn,"A",{id:!0,class:!0,href:!0});var $d=a(Ne);es=n($d,"SPAN",{});var Pd=a(es);k(jo.$$.fragment,Pd),Pd.forEach(t),$d.forEach(t),ni=g(tn),os=n(tn,"SPAN",{});var qd=a(os);ai=d(qd,"BigBirdPegasusForCausalLM"),qd.forEach(t),tn.forEach(t),Cs=g(o),ue=n(o,"DIV",{class:!0});var sn=a(ue);k(So.$$.fragment,sn),ri=g(sn),Ie=n(sn,"DIV",{class:!0});var nn=a(Ie);k(Oo.$$.fragment,nn),ii=g(nn),k(De.$$.fragment,nn),nn.forEach(t),sn.forEach(t),this.h()},h(){h(l,"name","hf:doc:metadata"),h(l,"content",JSON.stringify(Kd)),h(u,"id","bigbirdpegasus"),h(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(u,"href","#bigbirdpegasus"),h(c,"class","relative group"),h(he,"id","overview"),h(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(he,"href","#overview"),h(Z,"class","relative group"),h(Re,"href","https://arxiv.org/abs/2007.14062"),h(Re,"rel","nofollow"),h(Ve,"href","https://huggingface.co/blog/big-bird"),h(Ve,"rel","nofollow"),h(Xe,"href","https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/tokenization_pegasus.py"),h(Xe,"rel","nofollow"),h(eo,"href","https://github.com/google-research/bigbird"),h(eo,"rel","nofollow"),h(me,"id","transformers.BigBirdPegasusConfig"),h(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(me,"href","#transformers.BigBirdPegasusConfig"),h(Y,"class","relative group"),h(Go,"href","/docs/transformers/pr_highlight/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel"),h(so,"href","https://huggingface.co/google/bigbird-pegasus-large-arxiv"),h(so,"rel","nofollow"),h(Wo,"href","/docs/transformers/pr_highlight/en/main_classes/configuration#transformers.PretrainedConfig"),h(Uo,"href","/docs/transformers/pr_highlight/en/main_classes/configuration#transformers.PretrainedConfig"),h(be,"id","initializing-a-bigbirdpegasus-bigbird-pegasus-base-style-configuration->>>-configuration-="),h(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(be,"href","#initializing-a-bigbirdpegasus-bigbird-pegasus-base-style-configuration->>>-configuration-="),h(_e,"class","relative group"),h(we,"id","initializing-a-model-from-the-bigbird-pegasus-base-style-configuration->>>-model-="),h(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(we,"href","#initializing-a-model-from-the-bigbird-pegasus-base-style-configuration->>>-model-="),h(ve,"class","relative group"),h(ye,"id","accessing-the-model-configuration->>>-configuration-=-model.config"),h(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ye,"href","#accessing-the-model-configuration->>>-configuration-=-model.config"),h(ke,"class","relative group"),h(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Be,"id","transformers.BigBirdPegasusModel"),h(Be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Be,"href","#transformers.BigBirdPegasusModel"),h(oe,"class","relative group"),h(Ho,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),h(go,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(go,"rel","nofollow"),h(Ro,"href","/docs/transformers/pr_highlight/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel"),h(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Pe,"id","transformers.BigBirdPegasusForConditionalGeneration"),h(Pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Pe,"href","#transformers.BigBirdPegasusForConditionalGeneration"),h(se,"class","relative group"),h(Ko,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),h(wo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(wo,"rel","nofollow"),h(Vo,"href","/docs/transformers/pr_highlight/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForConditionalGeneration"),h(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xe,"id","transformers.BigBirdPegasusForSequenceClassification"),h(xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(xe,"href","#transformers.BigBirdPegasusForSequenceClassification"),h(ae,"class","relative group"),h(Jo,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),h(Po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Po,"rel","nofollow"),h(Zo,"href","/docs/transformers/pr_highlight/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForSequenceClassification"),h(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Se,"id","transformers.BigBirdPegasusForQuestionAnswering"),h(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Se,"href","#transformers.BigBirdPegasusForQuestionAnswering"),h(ie,"class","relative group"),h(Yo,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),h(Eo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Eo,"rel","nofollow"),h(Xo,"href","/docs/transformers/pr_highlight/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForQuestionAnswering"),h(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ne,"id","transformers.BigBirdPegasusForCausalLM"),h(Ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ne,"href","#transformers.BigBirdPegasusForCausalLM"),h(ce,"class","relative group"),h(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,f){e(document.head,l),b(o,_,f),b(o,c,f),e(c,u),e(u,v),y(r,v,null),e(c,m),e(c,F),e(F,rn),b(o,ps,f),b(o,Z,f),e(Z,he),e(he,it),y(He,it,null),e(Z,dn),e(Z,dt),e(dt,ln),b(o,gs,f),b(o,pe,f),e(pe,cn),e(pe,Re),e(Re,un),e(pe,hn),b(o,ms,f),b(o,Io,f),e(Io,pn),b(o,fs,f),b(o,Do,f),e(Do,lt),e(lt,gn),b(o,_s,f),b(o,Qo,f),e(Qo,mn),b(o,bs,f),b(o,z,f),e(z,Ke),e(Ke,fn),e(Ke,Ve),e(Ve,_n),e(Ke,bn),e(z,vn),e(z,A),e(A,wn),e(A,ct),e(ct,kn),e(A,yn),e(A,ut),e(ut,Bn),e(A,Tn),e(A,ht),e(ht,$n),e(A,Pn),e(A,pt),e(pt,qn),e(A,zn),e(z,xn),e(z,gt),e(gt,Fn),e(z,Cn),e(z,mt),e(mt,En),e(z,Mn),e(z,Je),e(Je,jn),e(Je,ft),e(ft,Sn),e(Je,On),e(z,An),e(z,Ze),e(Ze,Ln),e(Ze,_t),e(_t,Nn),e(Ze,In),e(z,Dn),e(z,Ye),e(Ye,Qn),e(Ye,Xe),e(Xe,Gn),e(Ye,Wn),b(o,vs,f),b(o,ge,f),e(ge,Un),e(ge,eo),e(eo,Hn),e(ge,Rn),b(o,ws,f),b(o,Y,f),e(Y,me),e(me,bt),y(oo,bt,null),e(Y,Kn),e(Y,vt),e(vt,Vn),b(o,ks,f),b(o,q,f),y(to,q,null),e(q,Jn),e(q,X),e(X,Zn),e(X,Go),e(Go,Yn),e(X,Xn),e(X,so),e(so,ea),e(X,oa),e(q,ta),e(q,ee),e(ee,sa),e(ee,Wo),e(Wo,na),e(ee,aa),e(ee,Uo),e(Uo,ra),e(ee,ia),e(q,da),y(fe,q,null),e(q,la),e(q,wt),e(wt,kt),e(kt,yt),e(yt,Bt),e(Bt,ca),e(q,ua),e(q,Tt),e(Tt,$t),e($t,no),e(no,_e),e(_e,be),e(be,Pt),y(ao,Pt,null),e(_e,ha),e(_e,qt),e(qt,pa),e(no,ga),e(no,zt),e(zt,ma),e(q,fa),e(q,xt),e(xt,Ft),e(Ft,ro),e(ro,ve),e(ve,we),e(we,Ct),y(io,Ct,null),e(ve,_a),e(ve,Et),e(Et,ba),e(ro,va),e(ro,Mt),e(Mt,wa),e(q,ka),e(q,jt),e(jt,St),e(St,Ot),e(Ot,ke),e(ke,ye),e(ye,At),y(lo,At,null),e(ke,ya),e(ke,Lt),e(Lt,Ba),b(o,ys,f),b(o,oe,f),e(oe,Be),e(Be,Nt),y(co,Nt,null),e(oe,Ta),e(oe,It),e(It,$a),b(o,Bs,f),b(o,L,f),y(uo,L,null),e(L,Pa),e(L,ho),e(ho,qa),e(ho,Ho),e(Ho,za),e(ho,xa),e(L,Fa),e(L,po),e(po,Ca),e(po,go),e(go,Ea),e(po,Ma),e(L,ja),e(L,I),y(mo,I,null),e(I,Sa),e(I,te),e(te,Oa),e(te,Ro),e(Ro,Aa),e(te,La),e(te,Dt),e(Dt,Na),e(te,Ia),e(I,Da),y(Te,I,null),e(I,Qa),y($e,I,null),b(o,Ts,f),b(o,se,f),e(se,Pe),e(Pe,Qt),y(fo,Qt,null),e(se,Ga),e(se,Gt),e(Gt,Wa),b(o,$s,f),b(o,N,f),y(_o,N,null),e(N,Ua),e(N,bo),e(bo,Ha),e(bo,Ko),e(Ko,Ra),e(bo,Ka),e(N,Va),e(N,vo),e(vo,Ja),e(vo,wo),e(wo,Za),e(vo,Ya),e(N,Xa),e(N,D),y(ko,D,null),e(D,er),e(D,ne),e(ne,or),e(ne,Vo),e(Vo,tr),e(ne,sr),e(ne,Wt),e(Wt,nr),e(ne,ar),e(D,rr),y(qe,D,null),e(D,ir),y(ze,D,null),b(o,Ps,f),b(o,ae,f),e(ae,xe),e(xe,Ut),y(yo,Ut,null),e(ae,dr),e(ae,Ht),e(Ht,lr),b(o,qs,f),b(o,E,f),y(Bo,E,null),e(E,cr),e(E,Rt),e(Rt,ur),e(E,hr),e(E,To),e(To,pr),e(To,Jo),e(Jo,gr),e(To,mr),e(E,fr),e(E,$o),e($o,_r),e($o,Po),e(Po,br),e($o,vr),e(E,wr),e(E,x),y(qo,x,null),e(x,kr),e(x,re),e(re,yr),e(re,Zo),e(Zo,Br),e(re,Tr),e(re,Kt),e(Kt,$r),e(re,Pr),e(x,qr),y(Fe,x,null),e(x,zr),y(Ce,x,null),e(x,xr),y(Ee,x,null),e(x,Fr),y(Me,x,null),e(x,Cr),y(je,x,null),b(o,zs,f),b(o,ie,f),e(ie,Se),e(Se,Vt),y(zo,Vt,null),e(ie,Er),e(ie,Jt),e(Jt,Mr),b(o,xs,f),b(o,M,f),y(xo,M,null),e(M,jr),e(M,de),e(de,Sr),e(de,Zt),e(Zt,Or),e(de,Ar),e(de,Yt),e(Yt,Lr),e(de,Nr),e(M,Ir),e(M,Fo),e(Fo,Dr),e(Fo,Yo),e(Yo,Qr),e(Fo,Gr),e(M,Wr),e(M,Co),e(Co,Ur),e(Co,Eo),e(Eo,Hr),e(Co,Rr),e(M,Kr),e(M,j),y(Mo,j,null),e(j,Vr),e(j,le),e(le,Jr),e(le,Xo),e(Xo,Zr),e(le,Yr),e(le,Xt),e(Xt,Xr),e(le,ei),e(j,oi),y(Oe,j,null),e(j,ti),y(Ae,j,null),e(j,si),y(Le,j,null),b(o,Fs,f),b(o,ce,f),e(ce,Ne),e(Ne,es),y(jo,es,null),e(ce,ni),e(ce,os),e(os,ai),b(o,Cs,f),b(o,ue,f),y(So,ue,null),e(ue,ri),e(ue,Ie),y(Oo,Ie,null),e(Ie,ii),y(De,Ie,null),Es=!0},p(o,[f]){const Ao={};f&2&&(Ao.$$scope={dirty:f,ctx:o}),fe.$set(Ao);const ts={};f&2&&(ts.$$scope={dirty:f,ctx:o}),Te.$set(ts);const ss={};f&2&&(ss.$$scope={dirty:f,ctx:o}),$e.$set(ss);const ns={};f&2&&(ns.$$scope={dirty:f,ctx:o}),qe.$set(ns);const Lo={};f&2&&(Lo.$$scope={dirty:f,ctx:o}),ze.$set(Lo);const as={};f&2&&(as.$$scope={dirty:f,ctx:o}),Fe.$set(as);const rs={};f&2&&(rs.$$scope={dirty:f,ctx:o}),Ce.$set(rs);const is={};f&2&&(is.$$scope={dirty:f,ctx:o}),Ee.$set(is);const No={};f&2&&(No.$$scope={dirty:f,ctx:o}),Me.$set(No);const ds={};f&2&&(ds.$$scope={dirty:f,ctx:o}),je.$set(ds);const ls={};f&2&&(ls.$$scope={dirty:f,ctx:o}),Oe.$set(ls);const cs={};f&2&&(cs.$$scope={dirty:f,ctx:o}),Ae.$set(cs);const us={};f&2&&(us.$$scope={dirty:f,ctx:o}),Le.$set(us);const hs={};f&2&&(hs.$$scope={dirty:f,ctx:o}),De.$set(hs)},i(o){Es||(B(r.$$.fragment,o),B(He.$$.fragment,o),B(oo.$$.fragment,o),B(to.$$.fragment,o),B(fe.$$.fragment,o),B(ao.$$.fragment,o),B(io.$$.fragment,o),B(lo.$$.fragment,o),B(co.$$.fragment,o),B(uo.$$.fragment,o),B(mo.$$.fragment,o),B(Te.$$.fragment,o),B($e.$$.fragment,o),B(fo.$$.fragment,o),B(_o.$$.fragment,o),B(ko.$$.fragment,o),B(qe.$$.fragment,o),B(ze.$$.fragment,o),B(yo.$$.fragment,o),B(Bo.$$.fragment,o),B(qo.$$.fragment,o),B(Fe.$$.fragment,o),B(Ce.$$.fragment,o),B(Ee.$$.fragment,o),B(Me.$$.fragment,o),B(je.$$.fragment,o),B(zo.$$.fragment,o),B(xo.$$.fragment,o),B(Mo.$$.fragment,o),B(Oe.$$.fragment,o),B(Ae.$$.fragment,o),B(Le.$$.fragment,o),B(jo.$$.fragment,o),B(So.$$.fragment,o),B(Oo.$$.fragment,o),B(De.$$.fragment,o),Es=!0)},o(o){T(r.$$.fragment,o),T(He.$$.fragment,o),T(oo.$$.fragment,o),T(to.$$.fragment,o),T(fe.$$.fragment,o),T(ao.$$.fragment,o),T(io.$$.fragment,o),T(lo.$$.fragment,o),T(co.$$.fragment,o),T(uo.$$.fragment,o),T(mo.$$.fragment,o),T(Te.$$.fragment,o),T($e.$$.fragment,o),T(fo.$$.fragment,o),T(_o.$$.fragment,o),T(ko.$$.fragment,o),T(qe.$$.fragment,o),T(ze.$$.fragment,o),T(yo.$$.fragment,o),T(Bo.$$.fragment,o),T(qo.$$.fragment,o),T(Fe.$$.fragment,o),T(Ce.$$.fragment,o),T(Ee.$$.fragment,o),T(Me.$$.fragment,o),T(je.$$.fragment,o),T(zo.$$.fragment,o),T(xo.$$.fragment,o),T(Mo.$$.fragment,o),T(Oe.$$.fragment,o),T(Ae.$$.fragment,o),T(Le.$$.fragment,o),T(jo.$$.fragment,o),T(So.$$.fragment,o),T(Oo.$$.fragment,o),T(De.$$.fragment,o),Es=!1},d(o){t(l),o&&t(_),o&&t(c),$(r),o&&t(ps),o&&t(Z),$(He),o&&t(gs),o&&t(pe),o&&t(ms),o&&t(Io),o&&t(fs),o&&t(Do),o&&t(_s),o&&t(Qo),o&&t(bs),o&&t(z),o&&t(vs),o&&t(ge),o&&t(ws),o&&t(Y),$(oo),o&&t(ks),o&&t(q),$(to),$(fe),$(ao),$(io),$(lo),o&&t(ys),o&&t(oe),$(co),o&&t(Bs),o&&t(L),$(uo),$(mo),$(Te),$($e),o&&t(Ts),o&&t(se),$(fo),o&&t($s),o&&t(N),$(_o),$(ko),$(qe),$(ze),o&&t(Ps),o&&t(ae),$(yo),o&&t(qs),o&&t(E),$(Bo),$(qo),$(Fe),$(Ce),$(Ee),$(Me),$(je),o&&t(zs),o&&t(ie),$(zo),o&&t(xs),o&&t(M),$(xo),$(Mo),$(Oe),$(Ae),$(Le),o&&t(Fs),o&&t(ce),$(jo),o&&t(Cs),o&&t(ue),$(So),$(Oo),$(De)}}}const Kd={local:"bigbirdpegasus",sections:[{local:"overview",title:"Overview"},{local:"transformers.BigBirdPegasusConfig",title:"BigBirdPegasusConfig"},{local:"transformers.BigBirdPegasusModel",title:"BigBirdPegasusModel"},{local:"transformers.BigBirdPegasusForConditionalGeneration",title:"BigBirdPegasusForConditionalGeneration"},{local:"transformers.BigBirdPegasusForSequenceClassification",title:"BigBirdPegasusForSequenceClassification"},{local:"transformers.BigBirdPegasusForQuestionAnswering",title:"BigBirdPegasusForQuestionAnswering"},{local:"transformers.BigBirdPegasusForCausalLM",title:"BigBirdPegasusForCausalLM"}],title:"BigBirdPegasus"};function Vd(P){return Ed(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class tl extends zd{constructor(l){super();xd(this,l,Vd,Rd,Fd,{})}}export{tl as default,Kd as metadata};
