import{S as ol,i as nl,s as sl,e as r,k as m,w,t as l,M as rl,c as a,d as o,m as u,a as i,x as v,h as d,b as f,F as e,g as k,y as $,q as T,o as y,B as I,v as al,L as Q}from"../../chunks/vendor-6b77c823.js";import{T as bo}from"../../chunks/Tip-39098574.js";import{D as N}from"../../chunks/Docstring-1088f2fb.js";import{C as H}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ke}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as W}from"../../chunks/ExampleCodeBlock-5212b321.js";function il(B){let s,g,c,h,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),h=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var M=i(c);h=d(M,"Module"),M.forEach(o),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,h),e(s,b)},d(n){n&&o(s)}}}function ll(B){let s,g,c,h,b;return h=new H({props:{code:`from transformers import RobertaTokenizer, IBertModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=r("p"),g=l("Example:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function dl(B){let s,g,c,h,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),h=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var M=i(c);h=d(M,"Module"),M.forEach(o),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,h),e(s,b)},d(n){n&&o(s)}}}function cl(B){let s,g,c,h,b;return h=new H({props:{code:`from transformers import RobertaTokenizer, IBertForMaskedLM
import torch
...
`}}),{c(){s=r("p"),g=l("Example:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function hl(B){let s,g;return s=new H({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){w(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function pl(B){let s,g,c,h,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),h=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var M=i(c);h=d(M,"Module"),M.forEach(o),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,h),e(s,b)},d(n){n&&o(s)}}}function ml(B){let s,g,c,h,b;return h=new H({props:{code:`import torch
...
`}}),{c(){s=r("p"),g=l("Example of single-label classification:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example of single-label classification:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function ul(B){let s,g;return s=new H({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){w(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function fl(B){let s,g,c,h,b;return h=new H({props:{code:`import torch
from transformers import RobertaTokenizer, IBertForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){s=r("p"),g=l("Example of multi-label classification:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example of multi-label classification:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function gl(B){let s,g;return s=new H({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
model = IBertForSequenceClassification.from_pretrained("kssteven/ibert-roberta-base", num_labels=num_labels)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){w(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function _l(B){let s,g,c,h,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),h=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var M=i(c);h=d(M,"Module"),M.forEach(o),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,h),e(s,b)},d(n){n&&o(s)}}}function bl(B){let s,g,c,h,b;return h=new H({props:{code:`from transformers import RobertaTokenizer, IBertForMultipleChoice
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){s=r("p"),g=l("Example:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function kl(B){let s,g,c,h,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),h=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var M=i(c);h=d(M,"Module"),M.forEach(o),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,h),e(s,b)},d(n){n&&o(s)}}}function wl(B){let s,g,c,h,b;return h=new H({props:{code:`from transformers import RobertaTokenizer, IBertForTokenClassification
import torch
...
`}}),{c(){s=r("p"),g=l("Example:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function vl(B){let s,g;return s=new H({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function $l(B){let s,g,c,h,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),h=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var M=i(c);h=d(M,"Module"),M.forEach(o),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,h),e(s,b)},d(n){n&&o(s)}}}function Tl(B){let s,g,c,h,b;return h=new H({props:{code:`from transformers import RobertaTokenizer, IBertForQuestionAnswering
import torch
...
`}}),{c(){s=r("p"),g=l("Example:"),c=m(),w(h.$$.fragment)},l(n){s=a(n,"P",{});var p=i(s);g=d(p,"Example:"),p.forEach(o),c=u(n),v(h.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),$(h,n,p),b=!0},p:Q,i(n){b||(T(h.$$.fragment,n),b=!0)},o(n){y(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),I(h,n)}}}function yl(B){let s,g;return s=new H({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function Il(B){let s,g,c,h,b,n,p,M,Kn,dn,oe,we,ko,Je,Yn,wo,Zn,cn,ve,Xn,Ke,es,ts,hn,Ht,os,pn,Ut,vo,ns,mn,G,ss,Ye,rs,as,Ze,is,ls,un,ne,$e,$o,Xe,ds,To,cs,fn,U,et,hs,tt,ps,Gt,ms,us,fs,se,gs,Vt,_s,bs,Jt,ks,ws,gn,re,Te,yo,ot,vs,Io,$s,_n,z,nt,Ts,Bo,ys,Is,st,Bs,Kt,Ms,qs,zs,rt,Fs,at,xs,Es,Cs,it,js,lt,Ps,As,Ss,L,dt,Rs,ae,Ns,Yt,Ls,Ds,Mo,Os,Ws,Qs,ye,Hs,Ie,bn,ie,Be,qo,ct,Us,zo,Gs,kn,F,ht,Vs,pt,Js,Fo,Ks,Ys,Zs,mt,Xs,Zt,er,tr,or,ut,nr,ft,sr,rr,ar,P,gt,ir,le,lr,Xt,dr,cr,xo,hr,pr,mr,Me,ur,qe,fr,ze,wn,de,Fe,Eo,_t,gr,Co,_r,vn,x,bt,br,jo,kr,wr,kt,vr,eo,$r,Tr,yr,wt,Ir,vt,Br,Mr,qr,q,$t,zr,ce,Fr,to,xr,Er,Po,Cr,jr,Pr,xe,Ar,Ee,Sr,Ce,Rr,je,Nr,Pe,$n,he,Ae,Ao,Tt,Lr,So,Dr,Tn,E,yt,Or,Ro,Wr,Qr,It,Hr,oo,Ur,Gr,Vr,Bt,Jr,Mt,Kr,Yr,Zr,D,qt,Xr,pe,ea,no,ta,oa,No,na,sa,ra,Se,aa,Re,yn,me,Ne,Lo,zt,ia,Do,la,In,C,Ft,da,Oo,ca,ha,xt,pa,so,ma,ua,fa,Et,ga,Ct,_a,ba,ka,A,jt,wa,ue,va,ro,$a,Ta,Wo,ya,Ia,Ba,Le,Ma,De,qa,Oe,Bn,fe,We,Qo,Pt,za,Ho,Fa,Mn,j,At,xa,ge,Ea,Uo,Ca,ja,Go,Pa,Aa,Sa,St,Ra,ao,Na,La,Da,Rt,Oa,Nt,Wa,Qa,Ha,S,Lt,Ua,_e,Ga,io,Va,Ja,Vo,Ka,Ya,Za,Qe,Xa,He,ei,Ue,qn;return n=new ke({}),Je=new ke({}),Xe=new ke({}),et=new N({props:{name:"class transformers.IBertConfig",anchor:"transformers.IBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"quant_mode",val:" = False"},{name:"force_dequant",val:" = 'none'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.IBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the I-BERT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_highlight/en/model_doc/ibert#transformers.IBertModel">IBertModel</a>`,name:"vocab_size"},{anchor:"transformers.IBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_highlight/en/model_doc/ibert#transformers.IBertConfig"
...
`}}),ye=new bo({props:{$$slots:{default:[il]},$$scope:{ctx:B}}}),Ie=new W({props:{anchor:"transformers.IBertModel.forward.example",$$slots:{default:[ll]},$$scope:{ctx:B}}}),ct=new ke({}),ht=new N({props:{name:"class transformers.IBertForMaskedLM",anchor:"transformers.IBertForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.IBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/ibert#transformers.IBertConfig">IBertConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L856"}}),gt=new N({props:{name:"forward",anchor:"transformers.IBertForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.IBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L875",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L984",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L1080",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L1160"}}),jt=new N({props:{name:"forward",anchor:"transformers.IBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.IBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L1175",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L1261"}}),Lt=new N({props:{name:"forward",anchor:"transformers.IBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.IBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/ibert/modeling_ibert.py#L1275",returnDescription:`
<p>A <a
...
been open-sourced.`),mn=m(),G=r("p"),ss=l("This model was contributed by "),Ye=r("a"),rs=l("kssteven"),as=l(". The original code can be found "),Ze=r("a"),is=l("here"),ls=l("."),un=m(),ne=r("h2"),$e=r("a"),$o=r("span"),w(Xe.$$.fragment),ds=m(),To=r("span"),cs=l("IBertConfig"),fn=m(),U=r("div"),w(et.$$.fragment),hs=m(),tt=r("p"),ps=l("This is the configuration class to store the configuration of a "),Gt=r("a"),ms=l("IBertModel"),us=l(`. It is used to instantiate a I-BERT
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ss=m(),L=r("div"),w(dt.$$.fragment),Rs=m(),ae=r("p"),Ns=l("The "),Yt=r("a"),Ls=l("IBertModel"),Ds=l(" forward method, overrides the "),Mo=r("code"),Os=l("__call__"),Ws=l(" special method."),Qs=m(),w(ye.$$.fragment),Hs=m(),w(Ie.$$.fragment),bn=m(),ie=r("h2"),Be=r("a"),qo=r("span"),w(ct.$$.fragment),Us=m(),zo=r("span"),Gs=l("IBertForMaskedLM"),kn=m(),F=r("div"),w(ht.$$.fragment),Vs=m(),pt=r("p"),Js=l("I-BERT Model with a "),Fo=r("code"),Ks=l("language modeling"),Ys=l(" head on top."),Zs=m(),mt=r("p"),Xs=l("This model inherits from "),Zt=r("a"),er=l("PreTrainedModel"),tr=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),or=m(),ut=r("p"),nr=l("This model is also a PyTorch "),ft=r("a"),sr=l("torch.nn.Module"),rr=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ar=m(),P=r("div"),w(gt.$$.fragment),ir=m(),le=r("p"),lr=l("The "),Xt=r("a"),dr=l("IBertForMaskedLM"),cr=l(" forward method, overrides the "),xo=r("code"),hr=l("__call__"),pr=l(" special method."),mr=m(),w(Me.$$.fragment),ur=m(),w(qe.$$.fragment),fr=m(),w(ze.$$.fragment),wn=m(),de=r("h2"),Fe=r("a"),Eo=r("span"),w(_t.$$.fragment),gr=m(),Co=r("span"),_r=l("IBertForSequenceClassification"),vn=m(),x=r("div"),w(bt.$$.fragment),br=m(),jo=r("p"),kr=l(`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zr=m(),D=r("div"),w(qt.$$.fragment),Xr=m(),pe=r("p"),ea=l("The "),no=r("a"),ta=l("IBertForMultipleChoice"),oa=l(" forward method, overrides the "),No=r("code"),na=l("__call__"),sa=l(" special method."),ra=m(),w(Se.$$.fragment),aa=m(),w(Re.$$.fragment),yn=m(),me=r("h2"),Ne=r("a"),Lo=r("span"),w(zt.$$.fragment),ia=m(),Do=r("span"),la=l("IBertForTokenClassification"),In=m(),C=r("div"),w(Ft.$$.fragment),da=m(),Oo=r("p"),ca=l(`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),ha=m(),xt=r("p"),pa=l("This model inherits from "),so=r("a"),ma=l("PreTrainedModel"),ua=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ha=m(),S=r("div"),w(Lt.$$.fragment),Ua=m(),_e=r("p"),Ga=l("The "),io=r("a"),Va=l("IBertForQuestionAnswering"),Ja=l(" forward method, overrides the "),Vo=r("code"),Ka=l("__call__"),Ya=l(" special method."),Za=m(),w(Qe.$$.fragment),Xa=m(),w(He.$$.fragment),ei=m(),w(Ue.$$.fragment),this.h()},l(t){const _=rl('[data-svelte="svelte-1phssyn"]',document.head);s=a(_,"META",{name:!0,content:!0}),_.forEach(o),g=u(t),c=a(t,"H1",{class:!0});var Dt=i(c);h=a(Dt,"A",{id:!0,class:!0,href:!0});var Jo=i(h);b=a(Jo,"SPAN",{});var Ko=i(b);v(n.$$.fragment,Ko),Ko.forEach(o),Jo.forEach(o),p=u(Dt),M=a(Dt,"SPAN",{});var Yo=i(M);Kn=d(Yo,"I-BERT"),Yo.forEach(o),Dt.forEach(o),dn=u(t),oe=a(t,"H2",{class:!0});var Ot=i(oe);we=a(Ot,"A",{id:!0,class:!0,href:!0});var Zo=i(we);ko=a(Zo,"SPAN",{});var Xo=i(ko);v(Je.$$.fragment,Xo),Xo.forEach(o),Zo.forEach(o),Yn=u(Ot),wo=a(Ot,"SPAN",{});var en=i(wo);Zn=d(en,"Overview"),en.forEach(o),Ot.forEach(o),cn=u(t),ve=a(t,"P",{});var Wt=i(ve);Xn=d(Wt,"The I-BERT model was proposed in "),Ke=a(Wt,"A",{href:!0,rel:!0});var tn=i(Ke);es=d(tn,"I-BERT: Integer-only BERT Quantization"),tn.forEach(o),ts=d(Wt,` by
Sehoon Kim, Amir Gholami, Zhewei Yao, Michael W. Mahoney and Kurt Keutzer. It\u2019s a quantized version of RoBERTa running
inference up to four times faster.`),Wt.forEach(o),hn=u(t),Ht=a(t,"P",{});var on=i(Ht);os=d(on,"The abstract from the paper is the following:"),on.forEach(o),pn=u(t),Ut=a(t,"P",{});var nn=i(Ut);vo=a(nn,"EM",{});var sn=i(vo);ns=d(sn,`Transformer based models, like BERT and RoBERTa, have achieved state-of-the-art results in many Natural Language
Processing tasks. However, their memory footprint, inference latency, and power consumption are prohibitive for
efficient inference at the edge, and even at the data center. While quantization can be a viable solution for this,
previous work on quantizing Transformer based models use floating-point arithmetic during inference, which cannot
efficiently utilize integer-only logical units such as the recent Turing Tensor Cores, or traditional integer-only ARM
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xn.forEach(o),zs=u(O),rt=a(O,"P",{});var En=i(rt);Fs=d(En,"This model is also a PyTorch "),at=a(En,"A",{href:!0,rel:!0});var hi=i(at);xs=d(hi,"torch.nn.Module"),hi.forEach(o),Es=d(En,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),lt=a(Cn,"A",{href:!0,rel:!0});var pi=i(lt);Ps=d(pi,`Attention is
all you need`),pi.forEach(o),As=d(Cn,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Cn.forEach(o),Ss=u(O),L=a(O,"DIV",{class:!0});var Ge=i(L);v(dt.$$.fragment,Ge),Rs=u(Ge),ae=a(Ge,"P",{});var ho=i(ae);Ns=d(ho,"The "),Yt=a(ho,"A",{href:!0});var mi=i(Yt);Ls=d(mi,"IBertModel"),mi.forEach(o),Ds=d(ho," forward method, overrides the "),Mo=a(ho,"CODE",{});var ui=i(Mo);Os=d(ui,"__call__"),ui.forEach(o),Ws=d(ho," special method."),ho.forEach(o),Qs=u(Ge),v(ye.$$.fragment,Ge),Hs=u(Ge),v(Ie.$$.fragment,Ge),Ge.forEach(o),O.forEach(o),bn=u(t),ie=a(t,"H2",{class:!0});var jn=i(ie);Be=a(jn,"A",{id:!0,class:!0,href:!0});var fi=i(Be);qo=a(fi,"SPAN",{});var gi=i(qo);v(ct.$$.fragment,gi),gi.forEach(o),fi.forEach(o),Us=u(jn),zo=a(jn,"SPAN",{});var _i=i(zo);Gs=d(_i,"IBertForMaskedLM"),_i.forEach(o),jn.forEach(o),kn=u(t),F=a(t,"DIV",{class:!0});var V=i(F);v(ht.$$.fragment,V),Vs=u(V),pt=a(V,"P",{});var Pn=i(pt);Js=d(Pn,"I-BERT Model with a "),Fo=a(Pn,"CODE",{});var bi=i(Fo);Ks=d(bi,"language modeling"),bi.forEach(o),Ys=d(Pn," head on top."),Pn.forEach(o),Zs=u(V),mt=a(V,"P",{});var An=i(mt);Xs=d(An,"This model inherits from "),Zt=a(An,"A",{href:!0});var ki=i(Zt);er=d(ki,"PreTrainedModel"),ki.forEach(o),tr=d(An,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
