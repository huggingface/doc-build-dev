import{S as wi,i as Ti,s as yi,e as a,k as h,w as T,t as s,M as ki,c as r,d as t,m as u,a as i,x as y,h as n,b as f,F as e,g,y as k,q as $,o as C,B as H,v as $i,L as xt}from"../../chunks/vendor-6b77c823.js";import{T as wo}from"../../chunks/Tip-39098574.js";import{D as ze}from"../../chunks/Docstring-1088f2fb.js";import{C as qt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Et}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ft}from"../../chunks/ExampleCodeBlock-5212b321.js";function Ci(E){let d,v,c,p,b;return p=new qt({props:{code:`from transformers import HubertModel, HubertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),v=s("Example:"),c=h(),T(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=n(m,"Example:"),m.forEach(t),c=u(l),y(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),k(p,l,m),b=!0},p:xt,i(l){b||($(p.$$.fragment,l),b=!0)},o(l){C(p.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),H(p,l)}}}function Hi(E){let d,v,c,p,b;return{c(){d=a("p"),v=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=s("Module"),b=s(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">8.53</span>`}}),{c(){T(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){k(d,c,p),v=!0},p:xt,i(c){v||($(d.$$.fragment,c),v=!0)},o(c){C(d.$$.fragment,c),v=!1},d(c){H(d,c)}}}function Si(E){let d,v,c,p,b,l,m,F,je,ie,x,K,O,X,Ee,L,Fe,be,A,I,J,me,q,P,le,Q,ve,de,W,xe,we,M,qe,Y,G,fe,Z,Me,ee,N,ce,te,Pe;return{c(){d=a("p"),v=s("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),b=a("li"),l=s("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),F=a("li"),je=s("having all inputs as a list, tuple or dict in the first positional arguments."),ie=h(),x=a("p"),K=s("This second option is useful when using "),O=a("code"),X=s("tf.keras.Model.fit"),Ee=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=a("code"),Fe=s("model(inputs)"),be=s("."),A=h(),I=a("p"),J=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),me=h(),q=a("ul"),P=a("li"),le=s("a single Tensor with "),Q=a("code"),ve=s("input_values"),de=s(" only and nothing else: "),W=a("code"),xe=s("model(inputs_ids)"),we=h(),M=a("li"),qe=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=a("code"),G=s("model([input_values, attention_mask])"),fe=s(" or "),Z=a("code"),Me=s("model([input_values, attention_mask, token_type_ids])"),ee=h(),N=a("li"),ce=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),te=a("code"),Pe=s('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l(w){d=r(w,"P",{});var j=i(d);v=n(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),c=u(w),p=r(w,"UL",{});var ge=i(p);b=r(ge,"LI",{});var _e=i(b);l=n(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),m=u(ge),F=r(ge,"LI",{});var Ne=i(F);je=n(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),ge.forEach(t),ie=u(w),x=r(w,"P",{});var B=i(x);K=n(B,"This second option is useful when using "),O=r(B,"CODE",{});var De=i(O);X=n(De,"tf.keras.Model.fit"),De.forEach(t),Ee=n(B,` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r(B,"CODE",{});var oe=i(L);Fe=n(oe,"model(inputs)"),oe.forEach(t),be=n(B,"."),B.forEach(t),A=u(w),I=r(w,"P",{});var pe=i(I);J=n(pe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe.forEach(t),me=u(w),q=r(w,"UL",{});var S=i(q);P=r(S,"LI",{});var z=i(P);le=n(z,"a single Tensor with "),Q=r(z,"CODE",{});var Be=i(Q);ve=n(Be,"input_values"),Be.forEach(t),de=n(z," only and nothing else: "),W=r(z,"CODE",{});var Se=i(W);xe=n(Se,"model(inputs_ids)"),Se.forEach(t),z.forEach(t),we=u(S),M=r(S,"LI",{});var se=i(M);qe=n(se,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=r(se,"CODE",{});var Ae=i(Y);G=n(Ae,"model([input_values, attention_mask])"),Ae.forEach(t),fe=n(se," or "),Z=r(se,"CODE",{});var D=i(Z);Me=n(D,"model([input_values, attention_mask, token_type_ids])"),D.forEach(t),se.forEach(t),ee=u(S),N=r(S,"LI",{});var ne=i(N);ce=n(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
instance of <a href="/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.HubertConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.HubertConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertConfig"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/hubert/modeling_hubert.py#L1127",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/hubert/modeling_hubert.py#L1262",returnDescription:`
<p>A <a
...
`}}),ut=new wo({props:{$$slots:{default:[qi]},$$scope:{ctx:E}}}),mt=new Ft({props:{anchor:"transformers.HubertForSequenceClassification.forward.example",$$slots:{default:[Mi]},$$scope:{ctx:E}}}),ft=new Ft({props:{anchor:"transformers.HubertForSequenceClassification.forward.example-2",$$slots:{default:[Pi]},$$scope:{ctx:E}}}),oo=new Et({}),so=new ze({props:{name:"class transformers.TFHubertModel",anchor:"transformers.TFHubertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFHubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/hubert/modeling_tf_hubert.py#L1402"}}),_t=new wo({props:{$$slots:{default:[Si]},$$scope:{ctx:E}}}),io=new ze({props:{name:"call",anchor:"transformers.TFHubertModel.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFHubertModel.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/hubert/modeling_tf_hubert.py#L1408",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/hubert/modeling_tf_hubert.py#L1500"}}),Tt=new wo({props:{$$slots:{default:[Ai]},$$scope:{ctx:E}}}),fo=new ze({props:{name:"call",anchor:"transformers.TFHubertForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFHubertForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/hubert/modeling_tf_hubert.py#L1527",returnDescription:`
<p>A <a
...
`}}),yt=new wo({props:{$$slots:{default:[Oi]},$$scope:{ctx:E}}}),kt=new Ft({props:{anchor:"transformers.TFHubertForCTC.call.example",$$slots:{default:[Li]},$$scope:{ctx:E}}}),{c(){d=a("meta"),v=h(),c=a("h1"),p=a("a"),b=a("span"),T(l.$$.fragment),m=h(),F=a("span"),je=s("Hubert"),ie=h(),x=a("h2"),K=a("a"),O=a("span"),T(X.$$.fragment),Ee=h(),L=a("span"),Fe=s("Overview"),be=h(),A=a("p"),I=s("Hubert was proposed in "),J=a("a"),me=s("HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden Units"),q=s(` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia, Ruslan
Salakhutdinov, Abdelrahman Mohamed.`),P=h(),le=a("p"),Q=s("The abstract from the paper is the following:"),ve=h(),de=a("p"),W=a("em"),xe=s(`Self-supervised approaches for speech representation learning are challenged by three unique problems: (1) there are
...
reduction on the more challenging dev-other and test-other evaluation subsets.`),we=h(),M=a("p"),qe=s("Tips:"),Y=h(),G=a("ul"),fe=a("li"),Z=s("Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),Me=h(),ee=a("li"),N=s(`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),ce=a("a"),te=s("Wav2Vec2CTCTokenizer"),Pe=s("."),w=h(),j=a("p"),ge=s("This model was contributed by "),_e=a("a"),Ne=s("patrickvonplaten"),B=s("."),De=h(),oe=a("h2"),pe=a("a"),S=a("span"),T(z.$$.fragment),Be=h(),Se=a("span"),se=s("HubertConfig"),Ae=h(),D=a("div"),T(ne.$$.fragment),Re=h(),Ve=a("p"),Xs=s("This is the configuration class to store the configuration of a "),To=a("a"),Js=s("HubertModel"),Qs=s(`. It is used to instantiate an
...
`),Mt=a("a"),Zs=s("facebook/hubert-base-ls960"),en=s(" architecture."),tn=h(),Ue=a("p"),on=s("Configuration objects inherit from "),yo=a("a"),sn=s("PretrainedConfig"),nn=s(` and can be used to control the model outputs. Read the
documentation from `),ko=a("a"),an=s("PretrainedConfig"),rn=s(" for more information."),ln=h(),T(nt.$$.fragment),bs=h(),Ke=a("h2"),at=a("a"),No=a("span"),T(Pt.$$.fragment),dn=h(),Bo=a("span"),cn=s("HubertModel"),vs=h(),ae=a("div"),T(St.$$.fragment),pn=h(),zt=a("p"),hn=s(`The bare Hubert Model transformer outputting raw hidden-states without any specific head on top.
Hubert was proposed in `),Dt=a("a"),un=s(`HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden
Units`),mn=s(` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia,
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),fn=h(),At=a("p"),gn=s("This model inherits from "),$o=a("a"),_n=s("PreTrainedModel"),bn=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),vn=h(),Ot=a("p"),wn=s("This model is a PyTorch "),Lt=a("a"),Tn=s("torch.nn.Module"),yn=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn=h(),Te=a("div"),T(It.$$.fragment),$n=h(),Ye=a("p"),Cn=s("The "),Co=a("a"),Hn=s("HubertModel"),jn=s(" forward method, overrides the "),Ro=a("code"),En=s("__call__"),Fn=s(" special method."),xn=h(),T(rt.$$.fragment),qn=h(),T(it.$$.fragment),ws=h(),Ge=a("h2"),lt=a("a"),Vo=a("span"),T(Wt.$$.fragment),Mn=h(),Uo=a("span"),Pn=s("HubertForCTC"),Ts=h(),re=a("div"),T(Nt.$$.fragment),Sn=h(),Xe=a("p"),zn=s("Hubert Model with a "),Ko=a("code"),Dn=s("language modeling"),An=s(` head on top for Connectionist Temporal Classification (CTC).
...
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),In=h(),Rt=a("p"),Wn=s("This model inherits from "),Ho=a("a"),Nn=s("PreTrainedModel"),Bn=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Rn=h(),Vt=a("p"),Vn=s("This model is a PyTorch "),Ut=a("a"),Un=s("torch.nn.Module"),Kn=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yn=h(),he=a("div"),T(Kt.$$.fragment),Gn=h(),Je=a("p"),Xn=s("The "),jo=a("a"),Jn=s("HubertForCTC"),Qn=s(" forward method, overrides the "),Yo=a("code"),Zn=s("__call__"),ea=s(" special method."),ta=h(),T(dt.$$.fragment),oa=h(),T(ct.$$.fragment),sa=h(),T(pt.$$.fragment),ys=h(),Qe=a("h2"),ht=a("a"),Go=a("span"),T(Yt.$$.fragment),na=h(),Xo=a("span"),aa=s("HubertForSequenceClassification"),ks=h(),R=a("div"),T(Gt.$$.fragment),ra=h(),Jo=a("p"),ia=s(`Hubert Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),la=h(),Xt=a("p"),da=s("Hubert was proposed in "),Jt=a("a"),ca=s(`HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden
Units`),pa=s(` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia,
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),ha=h(),Qt=a("p"),ua=s("This model inherits from "),Eo=a("a"),ma=s("PreTrainedModel"),fa=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),ga=h(),Zt=a("p"),_a=s("This model is a PyTorch "),eo=a("a"),ba=s("torch.nn.Module"),va=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wa=h(),ue=a("div"),T(to.$$.fragment),Ta=h(),Ze=a("p"),ya=s("The "),Fo=a("a"),ka=s("HubertForSequenceClassification"),$a=s(" forward method, overrides the "),Qo=a("code"),Ca=s("__call__"),Ha=s(" special method."),ja=h(),T(ut.$$.fragment),Ea=h(),T(mt.$$.fragment),Fa=h(),T(ft.$$.fragment),$s=h(),et=a("h2"),gt=a("a"),Zo=a("span"),T(oo.$$.fragment),xa=h(),es=a("span"),qa=s("TFHubertModel"),Cs=h(),V=a("div"),T(so.$$.fragment),Ma=h(),ts=a("p"),Pa=s("The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),Sa=h(),no=a("p"),za=s("This model inherits from "),xo=a("a"),Da=s("TFPreTrainedModel"),Aa=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oa=h(),ao=a("p"),La=s("This model is also a "),ro=a("a"),Ia=s("tf.keras.Model"),Wa=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Na=h(),T(_t.$$.fragment),Ba=h(),ye=a("div"),T(io.$$.fragment),Ra=h(),tt=a("p"),Va=s("The "),qo=a("a"),Ua=s("TFHubertModel"),Ka=s(" forward method, overrides the "),os=a("code"),Ya=s("__call__"),Ga=s(" special method."),Xa=h(),T(bt.$$.fragment),Ja=h(),T(vt.$$.fragment),Hs=h(),ot=a("h2"),wt=a("a"),ss=a("span"),T(lo.$$.fragment),Qa=h(),ns=a("span"),Za=s("TFHubertForCTC"),js=h(),U=a("div"),T(co.$$.fragment),er=h(),po=a("p"),tr=s("TFHubert Model with a "),as=a("code"),or=s("language modeling"),sr=s(" head on top for Connectionist Temporal Classification (CTC)."),nr=h(),ho=a("p"),ar=s("This model inherits from "),Mo=a("a"),rr=s("TFPreTrainedModel"),ir=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lr=h(),uo=a("p"),dr=s("This model is also a "),mo=a("a"),cr=s("tf.keras.Model"),pr=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hr=h(),T(Tt.$$.fragment),ur=h(),ke=a("div"),T(fo.$$.fragment),mr=h(),st=a("p"),fr=s("The "),Po=a("a"),gr=s("TFHubertForCTC"),_r=s(" forward method, overrides the "),rs=a("code"),br=s("__call__"),vr=s(" special method."),wr=h(),T(yt.$$.fragment),Tr=h(),T(kt.$$.fragment),this.h()},l(o){const _=ki('[data-svelte="svelte-1phssyn"]',document.head);d=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=u(o),c=r(o,"H1",{class:!0});var go=i(c);p=r(go,"A",{id:!0,class:!0,href:!0});var is=i(p);b=r(is,"SPAN",{});var ls=i(b);y(l.$$.fragment,ls),ls.forEach(t),is.forEach(t),m=u(go),F=r(go,"SPAN",{});var ds=i(F);je=n(ds,"Hubert"),ds.forEach(t),go.forEach(t),ie=u(o),x=r(o,"H2",{class:!0});var _o=i(x);K=r(_o,"A",{id:!0,class:!0,href:!0});var cs=i(K);O=r(cs,"SPAN",{});var ps=i(O);y(X.$$.fragment,ps),ps.forEach(t),cs.forEach(t),Ee=u(_o),L=r(_o,"SPAN",{});var hs=i(L);Fe=n(hs,"Overview"),hs.forEach(t),_o.forEach(t),be=u(o),A=r(o,"P",{});var bo=i(A);I=n(bo,"Hubert was proposed in "),J=r(bo,"A",{href:!0,rel:!0});var us=i(J);me=n(us,"HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden Units"),us.forEach(t),q=n(bo,` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia, Ruslan
Salakhutdinov, Abdelrahman Mohamed.`),bo.forEach(t),P=u(o),le=r(o,"P",{});var ms=i(le);Q=n(ms,"The abstract from the paper is the following:"),ms.forEach(t),ve=u(o),de=r(o,"P",{});var fs=i(de);W=r(fs,"EM",{});var gs=i(W);xe=n(gs,`Self-supervised approaches for speech representation learning are challenged by three unique problems: (1) there are
multiple sound units in each input utterance, (2) there is no lexicon of input sound units during the pre-training
phase, and (3) sound units have variable lengths with no explicit segmentation. To deal with these three problems, we
propose the Hidden-Unit BERT (HuBERT) approach for self-supervised speech representation learning, which utilizes an
offline clustering step to provide aligned target labels for a BERT-like prediction loss. A key ingredient of our
...
state-of-the-art wav2vec 2.0 performance on the Librispeech (960h) and Libri-light (60,000h) benchmarks with 10min, 1h,
10h, 100h, and 960h fine-tuning subsets. Using a 1B parameter model, HuBERT shows up to 19% and 13% relative WER
reduction on the more challenging dev-other and test-other evaluation subsets.`),gs.forEach(t),fs.forEach(t),we=u(o),M=r(o,"P",{});var _s=i(M);qe=n(_s,"Tips:"),_s.forEach(t),Y=u(o),G=r(o,"UL",{});var vo=i(G);fe=r(vo,"LI",{});var yr=i(fe);Z=n(yr,"Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),yr.forEach(t),Me=u(vo),ee=r(vo,"LI",{});var Fs=i(ee);N=n(Fs,`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),ce=r(Fs,"A",{href:!0});var kr=i(ce);te=n(kr,"Wav2Vec2CTCTokenizer"),kr.forEach(t),Pe=n(Fs,"."),Fs.forEach(t),vo.forEach(t),w=u(o),j=r(o,"P",{});var xs=i(j);ge=n(xs,"This model was contributed by "),_e=r(xs,"A",{href:!0,rel:!0});var $r=i(_e);Ne=n($r,"patrickvonplaten"),$r.forEach(t),B=n(xs,"."),xs.forEach(t),De=u(o),oe=r(o,"H2",{class:!0});var qs=i(oe);pe=r(qs,"A",{id:!0,class:!0,href:!0});var Cr=i(pe);S=r(Cr,"SPAN",{});var Hr=i(S);y(z.$$.fragment,Hr),Hr.forEach(t),Cr.forEach(t),Be=u(qs),Se=r(qs,"SPAN",{});var jr=i(Se);se=n(jr,"HubertConfig"),jr.forEach(t),qs.forEach(t),Ae=u(o),D=r(o,"DIV",{class:!0});var $t=i(D);y(ne.$$.fragment,$t),Re=u($t),Ve=r($t,"P",{});var So=i(Ve);Xs=n(So,"This is the configuration class to store the configuration of a "),To=r(So,"A",{href:!0});var Er=i(To);Js=n(Er,"HubertModel"),Er.forEach(t),Qs=n(So,`. It is used to instantiate an
Hubert model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Hubert
`),Mt=r(So,"A",{href:!0,rel:!0});var Fr=i(Mt);Zs=n(Fr,"facebook/hubert-base-ls960"),Fr.forEach(t),en=n(So," architecture."),So.forEach(t),tn=u($t),Ue=r($t,"P",{});var zo=i(Ue);on=n(zo,"Configuration objects inherit from "),yo=r(zo,"A",{href:!0});var xr=i(yo);sn=n(xr,"PretrainedConfig"),xr.forEach(t),nn=n(zo,` and can be used to control the model outputs. Read the
documentation from `),ko=r(zo,"A",{href:!0});var qr=i(ko);an=n(qr,"PretrainedConfig"),qr.forEach(t),rn=n(zo," for more information."),zo.forEach(t),ln=u($t),y(nt.$$.fragment,$t),$t.forEach(t),bs=u(o),Ke=r(o,"H2",{class:!0});var Ms=i(Ke);at=r(Ms,"A",{id:!0,class:!0,href:!0});var Mr=i(at);No=r(Mr,"SPAN",{});var Pr=i(No);y(Pt.$$.fragment,Pr),Pr.forEach(t),Mr.forEach(t),dn=u(Ms),Bo=r(Ms,"SPAN",{});var Sr=i(Bo);cn=n(Sr,"HubertModel"),Sr.forEach(t),Ms.forEach(t),vs=u(o),ae=r(o,"DIV",{class:!0});var Oe=i(ae);y(St.$$.fragment,Oe),pn=u(Oe),zt=r(Oe,"P",{});var Ps=i(zt);hn=n(Ps,`The bare Hubert Model transformer outputting raw hidden-states without any specific head on top.
Hubert was proposed in `),Dt=r(Ps,"A",{href:!0,rel:!0});var zr=i(Dt);un=n(zr,`HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden
Units`),zr.forEach(t),mn=n(Ps,` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia,
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),Ps.forEach(t),fn=u(Oe),At=r(Oe,"P",{});var Ss=i(At);gn=n(Ss,"This model inherits from "),$o=r(Ss,"A",{href:!0});var Dr=i($o);_n=n(Dr,"PreTrainedModel"),Dr.forEach(t),bn=n(Ss,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Ss.forEach(t),vn=u(Oe),Ot=r(Oe,"P",{});var zs=i(Ot);wn=n(zs,"This model is a PyTorch "),Lt=r(zs,"A",{href:!0,rel:!0});var Ar=i(Lt);Tn=n(Ar,"torch.nn.Module"),Ar.forEach(t),yn=n(zs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zs.forEach(t),kn=u(Oe),Te=r(Oe,"DIV",{class:!0});var Ct=i(Te);y(It.$$.fragment,Ct),$n=u(Ct),Ye=r(Ct,"P",{});var Do=i(Ye);Cn=n(Do,"The "),Co=r(Do,"A",{href:!0});var Or=i(Co);Hn=n(Or,"HubertModel"),Or.forEach(t),jn=n(Do," forward method, overrides the "),Ro=r(Do,"CODE",{});var Lr=i(Ro);En=n(Lr,"__call__"),Lr.forEach(t),Fn=n(Do," special method."),Do.forEach(t),xn=u(Ct),y(rt.$$.fragment,Ct),qn=u(Ct),y(it.$$.fragment,Ct),Ct.forEach(t),Oe.forEach(t),ws=u(o),Ge=r(o,"H2",{class:!0});var Ds=i(Ge);lt=r(Ds,"A",{id:!0,class:!0,href:!0});var Ir=i(lt);Vo=r(Ir,"SPAN",{});var Wr=i(Vo);y(Wt.$$.fragment,Wr),Wr.forEach(t),Ir.forEach(t),Mn=u(Ds),Uo=r(Ds,"SPAN",{});var Nr=i(Uo);Pn=n(Nr,"HubertForCTC"),Nr.forEach(t),Ds.forEach(t),Ts=u(o),re=r(o,"DIV",{class:!0});var Le=i(re);y(Nt.$$.fragment,Le),Sn=u(Le),Xe=r(Le,"P",{});var Ao=i(Xe);zn=n(Ao,"Hubert Model with a "),Ko=r(Ao,"CODE",{});var Br=i(Ko);Dn=n(Br,"language modeling"),Br.forEach(t),An=n(Ao,` head on top for Connectionist Temporal Classification (CTC).
...
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),Ao.forEach(t),In=u(Le),Rt=r(Le,"P",{});var As=i(Rt);Wn=n(As,"This model inherits from "),Ho=r(As,"A",{href:!0});var Vr=i(Ho);Nn=n(Vr,"PreTrainedModel"),Vr.forEach(t),Bn=n(As,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),As.forEach(t),Rn=u(Le),Vt=r(Le,"P",{});var Os=i(Vt);Vn=n(Os,"This model is a PyTorch "),Ut=r(Os,"A",{href:!0,rel:!0});var Ur=i(Ut);Un=n(Ur,"torch.nn.Module"),Ur.forEach(t),Kn=n(Os,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(t),Yn=u(Le),he=r(Le,"DIV",{class:!0});var Ie=i(he);y(Kt.$$.fragment,Ie),Gn=u(Ie),Je=r(Ie,"P",{});var Oo=i(Je);Xn=n(Oo,"The "),jo=r(Oo,"A",{href:!0});var Kr=i(jo);Jn=n(Kr,"HubertForCTC"),Kr.forEach(t),Qn=n(Oo," forward method, overrides the "),Yo=r(Oo,"CODE",{});var Yr=i(Yo);Zn=n(Yr,"__call__"),Yr.forEach(t),ea=n(Oo," special method."),Oo.forEach(t),ta=u(Ie),y(dt.$$.fragment,Ie),oa=u(Ie),y(ct.$$.fragment,Ie),sa=u(Ie),y(pt.$$.fragment,Ie),Ie.forEach(t),Le.forEach(t),ys=u(o),Qe=r(o,"H2",{class:!0});var Ls=i(Qe);ht=r(Ls,"A",{id:!0,class:!0,href:!0});var Gr=i(ht);Go=r(Gr,"SPAN",{});var Xr=i(Go);y(Yt.$$.fragment,Xr),Xr.forEach(t),Gr.forEach(t),na=u(Ls),Xo=r(Ls,"SPAN",{});var Jr=i(Xo);aa=n(Jr,"HubertForSequenceClassification"),Jr.forEach(t),Ls.forEach(t),ks=u(o),R=r(o,"DIV",{class:!0});var $e=i(R);y(Gt.$$.fragment,$e),ra=u($e),Jo=r($e,"P",{});var Qr=i(Jo);ia=n(Qr,`Hubert Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),Qr.forEach(t),la=u($e),Xt=r($e,"P",{});var Is=i(Xt);da=n(Is,"Hubert was proposed in "),Jt=r(Is,"A",{href:!0,rel:!0});var Zr=i(Jt);ca=n(Zr,`HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden
Units`),Zr.forEach(t),pa=n(Is,` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia,
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),Is.forEach(t),ha=u($e),Qt=r($e,"P",{});var Ws=i(Qt);ua=n(Ws,"This model inherits from "),Eo=r(Ws,"A",{href:!0});var ei=i(Eo);ma=n(ei,"PreTrainedModel"),ei.forEach(t),fa=n(Ws,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Ws.forEach(t),ga=u($e),Zt=r($e,"P",{});var Ns=i(Zt);_a=n(Ns,"This model is a PyTorch "),eo=r(Ns,"A",{href:!0,rel:!0});var ti=i(eo);ba=n(ti,"torch.nn.Module"),ti.forEach(t),va=n(Ns,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ns.forEach(t),wa=u($e),ue=r($e,"DIV",{class:!0});var We=i(ue);y(to.$$.fragment,We),Ta=u(We),Ze=r(We,"P",{});var Lo=i(Ze);ya=n(Lo,"The "),Fo=r(Lo,"A",{href:!0});var oi=i(Fo);ka=n(oi,"HubertForSequenceClassification"),oi.forEach(t),$a=n(Lo," forward method, overrides the "),Qo=r(Lo,"CODE",{});var si=i(Qo);Ca=n(si,"__call__"),si.forEach(t),Ha=n(Lo," special method."),Lo.forEach(t),ja=u(We),y(ut.$$.fragment,We),Ea=u(We),y(mt.$$.fragment,We),Fa=u(We),y(ft.$$.fragment,We),We.forEach(t),$e.forEach(t),$s=u(o),et=r(o,"H2",{class:!0});var Bs=i(et);gt=r(Bs,"A",{id:!0,class:!0,href:!0});var ni=i(gt);Zo=r(ni,"SPAN",{});var ai=i(Zo);y(oo.$$.fragment,ai),ai.forEach(t),ni.forEach(t),xa=u(Bs),es=r(Bs,"SPAN",{});var ri=i(es);qa=n(ri,"TFHubertModel"),ri.forEach(t),Bs.forEach(t),Cs=u(o),V=r(o,"DIV",{class:!0});var Ce=i(V);y(so.$$.fragment,Ce),Ma=u(Ce),ts=r(Ce,"P",{});var ii=i(ts);Pa=n(ii,"The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),ii.forEach(t),Sa=u(Ce),no=r(Ce,"P",{});var Rs=i(no);za=n(Rs,"This model inherits from "),xo=r(Rs,"A",{href:!0});var li=i(xo);Da=n(li,"TFPreTrainedModel"),li.forEach(t),Aa=n(Rs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rs.forEach(t),Oa=u(Ce),ao=r(Ce,"P",{});var Vs=i(ao);La=n(Vs,"This model is also a "),ro=r(Vs,"A",{href:!0,rel:!0});var di=i(ro);Ia=n(di,"tf.keras.Model"),di.forEach(t),Wa=n(Vs,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vs.forEach(t),Na=u(Ce),y(_t.$$.fragment,Ce),Ba=u(Ce),ye=r(Ce,"DIV",{class:!0});var Ht=i(ye);y(io.$$.fragment,Ht),Ra=u(Ht),tt=r(Ht,"P",{});var Io=i(tt);Va=n(Io,"The "),qo=r(Io,"A",{href:!0});var ci=i(qo);Ua=n(ci,"TFHubertModel"),ci.forEach(t),Ka=n(Io," forward method, overrides the "),os=r(Io,"CODE",{});var pi=i(os);Ya=n(pi,"__call__"),pi.forEach(t),Ga=n(Io," special method."),Io.forEach(t),Xa=u(Ht),y(bt.$$.fragment,Ht),Ja=u(Ht),y(vt.$$.fragment,Ht),Ht.forEach(t),Ce.forEach(t),Hs=u(o),ot=r(o,"H2",{class:!0});var Us=i(ot);wt=r(Us,"A",{id:!0,class:!0,href:!0});var hi=i(wt);ss=r(hi,"SPAN",{});var ui=i(ss);y(lo.$$.fragment,ui),ui.forEach(t),hi.forEach(t),Qa=u(Us),ns=r(Us,"SPAN",{});var mi=i(ns);Za=n(mi,"TFHubertForCTC"),mi.forEach(t),Us.forEach(t),js=u(o),U=r(o,"DIV",{class:!0});var He=i(U);y(co.$$.fragment,He),er=u(He),po=r(He,"P",{});var Ks=i(po);tr=n(Ks,"TFHubert Model with a "),as=r(Ks,"CODE",{});var fi=i(as);or=n(fi,"language modeling"),fi.forEach(t),sr=n(Ks," head on top for Connectionist Temporal Classification (CTC)."),Ks.forEach(t),nr=u(He),ho=r(He,"P",{});var Ys=i(ho);ar=n(Ys,"This model inherits from "),Mo=r(Ys,"A",{href:!0});var gi=i(Mo);rr=n(gi,"TFPreTrainedModel"),gi.forEach(t),ir=n(Ys,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ys.forEach(t),lr=u(He),uo=r(He,"P",{});var Gs=i(uo);dr=n(Gs,"This model is also a "),mo=r(Gs,"A",{href:!0,rel:!0});var _i=i(mo);cr=n(_i,"tf.keras.Model"),_i.forEach(t),pr=n(Gs,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gs.forEach(t),hr=u(He),y(Tt.$$.fragment,He),ur=u(He),ke=r(He,"DIV",{class:!0});var jt=i(ke);y(fo.$$.fragment,jt),mr=u(jt),st=r(jt,"P",{});var Wo=i(st);fr=n(Wo,"The "),Po=r(Wo,"A",{href:!0});var bi=i(Po);gr=n(bi,"TFHubertForCTC"),bi.forEach(t),_r=n(Wo," forward method, overrides the "),rs=r(Wo,"CODE",{});var vi=i(rs);br=n(vi,"__call__"),vi.forEach(t),vr=n(Wo," special method."),Wo.forEach(t),wr=u(jt),y(yt.$$.fragment,jt),Tr=u(jt),y(kt.$$.fragment,jt),jt.forEach(t),He.forEach(t),this.h()},h(){f(d,"name","hf:doc:metadata"),f(d,"content",JSON.stringify(Wi)),f(p,"id","hubert"),f(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(p,"href","#hubert"),f(c,"class","relative group"),f(K,"id","overview"),f(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(K,"href","#overview"),f(x,"class","relative group"),f(J,"href","https://arxiv.org/abs/2106.07447"),f(J,"rel","nofollow"),f(ce,"href","/docs/transformers/pr_highlight/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),f(_e,"href","https://huggingface.co/patrickvonplaten"),f(_e,"rel","nofollow"),f(pe,"id","transformers.HubertConfig"),f(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(pe,"href","#transformers.HubertConfig"),f(oe,"class","relative group"),f(To,"href","/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertModel"),f(Mt,"href","https://huggingface.co/facebook/hubert-base-ls960"),f(Mt,"rel","nofollow"),f(yo,"href","/docs/transformers/pr_highlight/en/main_classes/configuration#transformers.PretrainedConfig"),f(ko,"href","/docs/transformers/pr_highlight/en/main_classes/configuration#transformers.PretrainedConfig"),f(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(at,"id","transformers.HubertModel"),f(at,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(at,"href","#transformers.HubertModel"),f(Ke,"class","relative group"),f(Dt,"href","https://arxiv.org/abs/2106.07447"),f(Dt,"rel","nofollow"),f($o,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),f(Lt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Lt,"rel","nofollow"),f(Co,"href","/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertModel"),f(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(lt,"id","transformers.HubertForCTC"),f(lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(lt,"href","#transformers.HubertForCTC"),f(Ge,"class","relative group"),f(Bt,"href","https://arxiv.org/abs/2106.07447"),f(Bt,"rel","nofollow"),f(Ho,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),f(Ut,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Ut,"rel","nofollow"),f(jo,"href","/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertForCTC"),f(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ht,"id","transformers.HubertForSequenceClassification"),f(ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ht,"href","#transformers.HubertForSequenceClassification"),f(Qe,"class","relative group"),f(Jt,"href","https://arxiv.org/abs/2106.07447"),f(Jt,"rel","nofollow"),f(Eo,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel"),f(eo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(eo,"rel","nofollow"),f(Fo,"href","/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.HubertForSequenceClassification"),f(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(gt,"id","transformers.TFHubertModel"),f(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(gt,"href","#transformers.TFHubertModel"),f(et,"class","relative group"),f(xo,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.TFPreTrainedModel"),f(ro,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(ro,"rel","nofollow"),f(qo,"href","/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.TFHubertModel"),f(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(wt,"id","transformers.TFHubertForCTC"),f(wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(wt,"href","#transformers.TFHubertForCTC"),f(ot,"class","relative group"),f(Mo,"href","/docs/transformers/pr_highlight/en/main_classes/model#transformers.TFPreTrainedModel"),f(mo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(mo,"rel","nofollow"),f(Po,"href","/docs/transformers/pr_highlight/en/model_doc/hubert#transformers.TFHubertForCTC"),f(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,d),g(o,v,_),g(o,c,_),e(c,p),e(p,b),k(l,b,null),e(c,m),e(c,F),e(F,je),g(o,ie,_),g(o,x,_),e(x,K),e(K,O),k(X,O,null),e(x,Ee),e(x,L),e(L,Fe),g(o,be,_),g(o,A,_),e(A,I),e(A,J),e(J,me),e(A,q),g(o,P,_),g(o,le,_),e(le,Q),g(o,ve,_),g(o,de,_),e(de,W),e(W,xe),g(o,we,_),g(o,M,_),e(M,qe),g(o,Y,_),g(o,G,_),e(G,fe),e(fe,Z),e(G,Me),e(G,ee),e(ee,N),e(ee,ce),e(ce,te),e(ee,Pe),g(o,w,_),g(o,j,_),e(j,ge),e(j,_e),e(_e,Ne),e(j,B),g(o,De,_),g(o,oe,_),e(oe,pe),e(pe,S),k(z,S,null),e(oe,Be),e(oe,Se),e(Se,se),g(o,Ae,_),g(o,D,_),k(ne,D,null),e(D,Re),e(D,Ve),e(Ve,Xs),e(Ve,To),e(To,Js),e(Ve,Qs),e(Ve,Mt),e(Mt,Zs),e(Ve,en),e(D,tn),e(D,Ue),e(Ue,on),e(Ue,yo),e(yo,sn),e(Ue,nn),e(Ue,ko),e(ko,an),e(Ue,rn),e(D,ln),k(nt,D,null),g(o,bs,_),g(o,Ke,_),e(Ke,at),e(at,No),k(Pt,No,null),e(Ke,dn),e(Ke,Bo),e(Bo,cn),g(o,vs,_),g(o,ae,_),k(St,ae,null),e(ae,pn),e(ae,zt),e(zt,hn),e(zt,Dt),e(Dt,un),e(zt,mn),e(ae,fn),e(ae,At),e(At,gn),e(At,$o),e($o,_n),e(At,bn),e(ae,vn),e(ae,Ot),e(Ot,wn),e(Ot,Lt),e(Lt,Tn),e(Ot,yn),e(ae,kn),e(ae,Te),k(It,Te,null),e(Te,$n),e(Te,Ye),e(Ye,Cn),e(Ye,Co),e(Co,Hn),e(Ye,jn),e(Ye,Ro),e(Ro,En),e(Ye,Fn),e(Te,xn),k(rt,Te,null),e(Te,qn),k(it,Te,null),g(o,ws,_),g(o,Ge,_),e(Ge,lt),e(lt,Vo),k(Wt,Vo,null),e(Ge,Mn),e(Ge,Uo),e(Uo,Pn),g(o,Ts,_),g(o,re,_),k(Nt,re,null),e(re,Sn),e(re,Xe),e(Xe,zn),e(Xe,Ko),e(Ko,Dn),e(Xe,An),e(Xe,Bt),e(Bt,On),e(Xe,Ln),e(re,In),e(re,Rt),e(Rt,Wn),e(Rt,Ho),e(Ho,Nn),e(Rt,Bn),e(re,Rn),e(re,Vt),e(Vt,Vn),e(Vt,Ut),e(Ut,Un),e(Vt,Kn),e(re,Yn),e(re,he),k(Kt,he,null),e(he,Gn),e(he,Je),e(Je,Xn),e(Je,jo),e(jo,Jn),e(Je,Qn),e(Je,Yo),e(Yo,Zn),e(Je,ea),e(he,ta),k(dt,he,null),e(he,oa),k(ct,he,null),e(he,sa),k(pt,he,null),g(o,ys,_),g(o,Qe,_),e(Qe,ht),e(ht,Go),k(Yt,Go,null),e(Qe,na),e(Qe,Xo),e(Xo,aa),g(o,ks,_),g(o,R,_),k(Gt,R,null),e(R,ra),e(R,Jo),e(Jo,ia),e(R,la),e(R,Xt),e(Xt,da),e(Xt,Jt),e(Jt,ca),e(Xt,pa),e(R,ha),e(R,Qt),e(Qt,ua),e(Qt,Eo),e(Eo,ma),e(Qt,fa),e(R,ga),e(R,Zt),e(Zt,_a),e(Zt,eo),e(eo,ba),e(Zt,va),e(R,wa),e(R,ue),k(to,ue,null),e(ue,Ta),e(ue,Ze),e(Ze,ya),e(Ze,Fo),e(Fo,ka),e(Ze,$a),e(Ze,Qo),e(Qo,Ca),e(Ze,Ha),e(ue,ja),k(ut,ue,null),e(ue,Ea),k(mt,ue,null),e(ue,Fa),k(ft,ue,null),g(o,$s,_),g(o,et,_),e(et,gt),e(gt,Zo),k(oo,Zo,null),e(et,xa),e(et,es),e(es,qa),g(o,Cs,_),g(o,V,_),k(so,V,null),e(V,Ma),e(V,ts),e(ts,Pa),e(V,Sa),e(V,no),e(no,za),e(no,xo),e(xo,Da),e(no,Aa),e(V,Oa),e(V,ao),e(ao,La),e(ao,ro),e(ro,Ia),e(ao,Wa),e(V,Na),k(_t,V,null),e(V,Ba),e(V,ye),k(io,ye,null),e(ye,Ra),e(ye,tt),e(tt,Va),e(tt,qo),e(qo,Ua),e(tt,Ka),e(tt,os),e(os,Ya),e(tt,Ga),e(ye,Xa),k(bt,ye,null),e(ye,Ja),k(vt,ye,null),g(o,Hs,_),g(o,ot,_),e(ot,wt),e(wt,ss),k(lo,ss,null),e(ot,Qa),e(ot,ns),e(ns,Za),g(o,js,_),g(o,U,_),k(co,U,null),e(U,er),e(U,po),e(po,tr),e(po,as),e(as,or),e(po,sr),e(U,nr),e(U,ho),e(ho,ar),e(ho,Mo),e(Mo,rr),e(ho,ir),e(U,lr),e(U,uo),e(uo,dr),e(uo,mo),e(mo,cr),e(uo,pr),e(U,hr),k(Tt,U,null),e(U,ur),e(U,ke),k(fo,ke,null),e(ke,mr),e(ke,st),e(st,fr),e(st,Po),e(Po,gr),e(st,_r),e(st,rs),e(rs,br),e(st,vr),e(ke,wr),k(yt,ke,null),e(ke,Tr),k(kt,ke,null),Es=!0},p(o,[_]){const go={};_&2&&(go.$$scope={dirty:_,ctx:o}),nt.$set(go);const is={};_&2&&(is.$$scope={dirty:_,ctx:o}),rt.$set(is);const ls={};_&2&&(ls.$$scope={dirty:_,ctx:o}),it.$set(ls);const ds={};_&2&&(ds.$$scope={dirty:_,ctx:o}),dt.$set(ds);const _o={};_&2&&(_o.$$scope={dirty:_,ctx:o}),ct.$set(_o);const cs={};_&2&&(cs.$$scope={dirty:_,ctx:o}),pt.$set(cs);const ps={};_&2&&(ps.$$scope={dirty:_,ctx:o}),ut.$set(ps);const hs={};_&2&&(hs.$$scope={dirty:_,ctx:o}),mt.$set(hs);const bo={};_&2&&(bo.$$scope={dirty:_,ctx:o}),ft.$set(bo);const us={};_&2&&(us.$$scope={dirty:_,ctx:o}),_t.$set(us);const ms={};_&2&&(ms.$$scope={dirty:_,ctx:o}),bt.$set(ms);const fs={};_&2&&(fs.$$scope={dirty:_,ctx:o}),vt.$set(fs);const gs={};_&2&&(gs.$$scope={dirty:_,ctx:o}),Tt.$set(gs);const _s={};_&2&&(_s.$$scope={dirty:_,ctx:o}),yt.$set(_s);const vo={};_&2&&(vo.$$scope={dirty:_,ctx:o}),kt.$set(vo)},i(o){Es||($(l.$$.fragment,o),$(X.$$.fragment,o),$(z.$$.fragment,o),$(ne.$$.fragment,o),$(nt.$$.fragment,o),$(Pt.$$.fragment,o),$(St.$$.fragment,o),$(It.$$.fragment,o),$(rt.$$.fragment,o),$(it.$$.fragment,o),$(Wt.$$.fragment,o),$(Nt.$$.fragment,o),$(Kt.$$.fragment,o),$(dt.$$.fragment,o),$(ct.$$.fragment,o),$(pt.$$.fragment,o),$(Yt.$$.fragment,o),$(Gt.$$.fragment,o),$(to.$$.fragment,o),$(ut.$$.fragment,o),$(mt.$$.fragment,o),$(ft.$$.fragment,o),$(oo.$$.fragment,o),$(so.$$.fragment,o),$(_t.$$.fragment,o),$(io.$$.fragment,o),$(bt.$$.fragment,o),$(vt.$$.fragment,o),$(lo.$$.fragment,o),$(co.$$.fragment,o),$(Tt.$$.fragment,o),$(fo.$$.fragment,o),$(yt.$$.fragment,o),$(kt.$$.fragment,o),Es=!0)},o(o){C(l.$$.fragment,o),C(X.$$.fragment,o),C(z.$$.fragment,o),C(ne.$$.fragment,o),C(nt.$$.fragment,o),C(Pt.$$.fragment,o),C(St.$$.fragment,o),C(It.$$.fragment,o),C(rt.$$.fragment,o),C(it.$$.fragment,o),C(Wt.$$.fragment,o),C(Nt.$$.fragment,o),C(Kt.$$.fragment,o),C(dt.$$.fragment,o),C(ct.$$.fragment,o),C(pt.$$.fragment,o),C(Yt.$$.fragment,o),C(Gt.$$.fragment,o),C(to.$$.fragment,o),C(ut.$$.fragment,o),C(mt.$$.fragment,o),C(ft.$$.fragment,o),C(oo.$$.fragment,o),C(so.$$.fragment,o),C(_t.$$.fragment,o),C(io.$$.fragment,o),C(bt.$$.fragment,o),C(vt.$$.fragment,o),C(lo.$$.fragment,o),C(co.$$.fragment,o),C(Tt.$$.fragment,o),C(fo.$$.fragment,o),C(yt.$$.fragment,o),C(kt.$$.fragment,o),Es=!1},d(o){t(d),o&&t(v),o&&t(c),H(l),o&&t(ie),o&&t(x),H(X),o&&t(be),o&&t(A),o&&t(P),o&&t(le),o&&t(ve),o&&t(de),o&&t(we),o&&t(M),o&&t(Y),o&&t(G),o&&t(w),o&&t(j),o&&t(De),o&&t(oe),H(z),o&&t(Ae),o&&t(D),H(ne),H(nt),o&&t(bs),o&&t(Ke),H(Pt),o&&t(vs),o&&t(ae),H(St),H(It),H(rt),H(it),o&&t(ws),o&&t(Ge),H(Wt),o&&t(Ts),o&&t(re),H(Nt),H(Kt),H(dt),H(ct),H(pt),o&&t(ys),o&&t(Qe),H(Yt),o&&t(ks),o&&t(R),H(Gt),H(to),H(ut),H(mt),H(ft),o&&t($s),o&&t(et),H(oo),o&&t(Cs),o&&t(V),H(so),H(_t),H(io),H(bt),H(vt),o&&t(Hs),o&&t(ot),H(lo),o&&t(js),o&&t(U),H(co),H(Tt),H(fo),H(yt),H(kt)}}}const Wi={local:"hubert",sections:[{local:"overview",title:"Overview"},{local:"transformers.HubertConfig",title:"HubertConfig"},{local:"transformers.HubertModel",title:"HubertModel"},{local:"transformers.HubertForCTC",title:"HubertForCTC"},{local:"transformers.HubertForSequenceClassification",title:"HubertForSequenceClassification"},{local:"transformers.TFHubertModel",title:"TFHubertModel"},{local:"transformers.TFHubertForCTC",title:"TFHubertForCTC"}],title:"Hubert"};function Ni(E){return $i(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gi extends wi{constructor(d){super();Ti(this,d,Ni,Ii,yi,{})}}export{Gi as default,Wi as metadata};
