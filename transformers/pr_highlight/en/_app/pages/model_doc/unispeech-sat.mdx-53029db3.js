...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){c=s("p"),v=n("Example:"),p=h(),b(f.$$.fragment)},l(l){c=r(l,"P",{});var u=i(c);v=a(u,"Example:"),u.forEach(o),p=m(l),w(f.$$.fragment,l)},m(l,u){_(l,c,u),e(c,v),_(l,p,u),y(f,l,u),S=!0},p:ye,i(l){S||($(f.$$.fragment,l),S=!0)},o(l){k(f.$$.fragment,l),S=!1},d(l){l&&o(c),l&&o(p),T(f,l)}}}function Oc(U){let c,v,p,f,S;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),f=n("Module"),S=n(`
...
Tuple of <code>torch.FloatTensor</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L110"}}),ut=new G({}),ft=new A({props:{name:"class transformers.UniSpeechSatModel",anchor:"transformers.UniSpeechSatModel",parameters:[{name:"config",val:": UniSpeechSatConfig"}],parametersDescription:[{anchor:"transformers.UniSpeechSatModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/unispeech-sat#transformers.UniSpeechSatConfig">UniSpeechSatConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1127"}}),wt=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatModel.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.UniSpeechSatModel.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_highlight/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1191",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_highlight/en/model_doc/unispeech-sat#transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatBaseModelOutput"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_highlight/en/model_doc/unispeech-sat#transformers.UniSpeechSatConfig"
...
`}}),je=new No({props:{$$slots:{default:[Oc]},$$scope:{ctx:U}}}),qe=new we({props:{anchor:"transformers.UniSpeechSatModel.forward.example",$$slots:{default:[Lc]},$$scope:{ctx:U}}}),yt=new G({}),$t=new A({props:{name:"class transformers.UniSpeechSatForCTC",anchor:"transformers.UniSpeechSatForCTC",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.UniSpeechSatForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/unispeech-sat#transformers.UniSpeechSatConfig">UniSpeechSatConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1391"}}),xt=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],parametersDescription:[{anchor:"transformers.UniSpeechSatForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code> should be used for
padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See <code>UniSpeechSatProcessor.__call__</code>
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1432",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1522"}}),zt=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],parametersDescription:[{anchor:"transformers.UniSpeechSatForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code> should be used for
padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See <code>UniSpeechSatProcessor.__call__</code>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1567",returnDescription:`
<p>A <a
...
`}}),De=new No({props:{$$slots:{default:[Ic]},$$scope:{ctx:U}}}),Oe=new we({props:{anchor:"transformers.UniSpeechSatForSequenceClassification.forward.example",$$slots:{default:[Bc]},$$scope:{ctx:U}}}),Le=new we({props:{anchor:"transformers.UniSpeechSatForSequenceClassification.forward.example-2",$$slots:{default:[Hc]},$$scope:{ctx:U}}}),Dt=new G({}),Ot=new A({props:{name:"class transformers.UniSpeechSatForAudioFrameClassification",anchor:"transformers.UniSpeechSatForAudioFrameClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.UniSpeechSatForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/unispeech-sat#transformers.UniSpeechSatConfig">UniSpeechSatConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1646"}}),Bt=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForAudioFrameClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.UniSpeechSatForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code> should be used for
padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See <code>UniSpeechSatProcessor.__call__</code>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1689",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1804"}}),Gt=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForXVector.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],parametersDescription:[{anchor:"transformers.UniSpeechSatForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code> should be used for
padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See <code>UniSpeechSatProcessor.__call__</code>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1866",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1249"}}),so=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForPreTraining.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.UniSpeechSatForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code> should be used for
padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See <code>UniSpeechSatProcessor.__call__</code>
...
Whether or not to return a <a href="/docs/transformers/pr_highlight/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1317",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_highlight/en/model_doc/unispeech-sat#transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatForPreTrainingOutput"
...
`}}),Re=new No({props:{$$slots:{default:[Yc]},$$scope:{ctx:U}}}),Ze=new we({props:{anchor:"transformers.UniSpeechSatForPreTraining.forward.example",$$slots:{default:[Jc]},$$scope:{ctx:U}}}),{c(){c=s("meta"),v=h(),p=s("h1"),f=s("a"),S=s("span"),b(l.$$.fragment),u=h(),F=s("span"),Aa=n("UniSpeech-SAT"),Pn=h(),K=s("h2"),ke=s("a"),Wo=s("span"),b(et.$$.fragment),Ma=h(),Io=s("span"),za=n("Overview"),An=h(),Te=s("p"),Da=n("The UniSpeech-SAT model was proposed in "),tt=s("a"),Oa=n(`UniSpeech-SAT: Universal Speech Representation Learning with Speaker Aware
...
dataset to 94 thousand hours public audio data and achieve further performance improvement in all SUPERB tasks.`),Dn=h(),ho=s("p"),Wa=n("Tips:"),On=h(),H=s("ul"),ot=s("li"),Ia=n(`UniSpeechSat is a speech model that accepts a float array corresponding to the raw waveform of the speech signal.
...
found `),st=s("a"),ts=n("here"),os=n("."),Vn=h(),ee=s("h2"),Ue=s("a"),Xo=s("span"),b(rt.$$.fragment),ns=h(),Ro=s("span"),as=n("UniSpeechSatConfig"),Nn=h(),D=s("div"),b(it.$$.fragment),ss=h(),te=s("p"),rs=n("This is the configuration class to store the configuration of a "),fo=s("a"),is=n("UniSpeechSatModel"),ls=n(`. It is used to instantiate an
...
`),lt=s("a"),cs=n("facebook/unispeech_sat-base-960h"),ds=n(" architecture."),ps=h(),oe=s("p"),hs=n("Configuration objects inherit from "),go=s("a"),ms=n("PretrainedConfig"),us=n(` and can be used to control the model outputs. Read the
...
library implements for all its model (such as downloading or saving etc.).`),Mr=h(),At=s("p"),zr=n("This model is a PyTorch "),Mt=s("a"),Dr=n("torch.nn.Module"),Or=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lr=h(),z=s("div"),b(zt.$$.fragment),Vr=h(),he=s("p"),Nr=n("The "),$o=s("a"),Wr=n("UniSpeechSatForSequenceClassification"),Ir=n(" forward method, overrides the "),cn=s("code"),Br=n("__call__"),Hr=n(" special method."),Xr=h(),b(De.$$.fragment),Rr=h(),b(Oe.$$.fragment),Zr=h(),b(Le.$$.fragment),Jn=h(),me=s("h2"),Ve=s("a"),dn=s("span"),b(Dt.$$.fragment),Qr=h(),pn=s("span"),Yr=n("UniSpeechSatForAudioFrameClassification"),Gn=h(),C=s("div"),b(Ot.$$.fragment),Jr=h(),hn=s("p"),Gr=n("UniSpeech-SAT Model with a frame classification head on top for tasks like Speaker Diarization."),Kr=h(),Lt=s("p"),ei=n("UniSpeechSat was proposed in "),Vt=s("a"),ti=n(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zi=h(),V=s("div"),b(Gt.$$.fragment),Di=h(),ge=s("p"),Oi=n("The "),Fo=s("a"),Li=n("UniSpeechSatForXVector"),Vi=n(" forward method, overrides the "),_n=s("code"),Ni=n("__call__"),Wi=n(" special method."),Ii=h(),b(Be.$$.fragment),Bi=h(),b(He.$$.fragment),ta=h(),_e=s("h2"),Xe=s("a"),vn=s("span"),b(Kt.$$.fragment),Hi=h(),Sn=s("span"),Xi=n("UniSpeechSatForPreTraining"),oa=h(),P=s("div"),b(eo.$$.fragment),Ri=h(),ve=s("p"),Zi=n("UniSpeechSat Model with a quantizer and "),bn=s("code"),Qi=n("VQ"),Yi=n(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),il=h(),N=s("div"),b(so.$$.fragment),ll=h(),Se=s("p"),cl=n("The "),Co=s("a"),dl=n("UniSpeechSatForPreTraining"),pl=n(" forward method, overrides the "),wn=s("code"),hl=n("__call__"),ml=n(" special method."),ul=h(),b(Re.$$.fragment),fl=h(),b(Ze.$$.fragment),this.h()},l(t){const g=Mc('[data-svelte="svelte-1phssyn"]',document.head);c=r(g,"META",{name:!0,content:!0}),g.forEach(o),v=m(t),p=r(t,"H1",{class:!0});var ro=i(p);f=r(ro,"A",{id:!0,class:!0,href:!0});var yn=i(f);S=r(yn,"SPAN",{});var $n=i(S);w(l.$$.fragment,$n),$n.forEach(o),yn.forEach(o),u=m(ro),F=r(ro,"SPAN",{});var kn=i(F);Aa=a(kn,"UniSpeech-SAT"),kn.forEach(o),ro.forEach(o),Pn=m(t),K=r(t,"H2",{class:!0});var io=i(K);ke=r(io,"A",{id:!0,class:!0,href:!0});var Tn=i(ke);Wo=r(Tn,"SPAN",{});var Un=i(Wo);w(et.$$.fragment,Un),Un.forEach(o),Tn.forEach(o),Ma=m(io),Io=r(io,"SPAN",{});var Fn=i(Io);za=a(Fn,"Overview"),Fn.forEach(o),io.forEach(o),An=m(t),Te=r(t,"P",{});var lo=i(Te);Da=a(lo,"The UniSpeech-SAT model was proposed in "),tt=r(lo,"A",{href:!0,rel:!0});var xn=i(tt);Oa=a(xn,`UniSpeech-SAT: Universal Speech Representation Learning with Speaker Aware
...
state-of-the-art performance in universal representation learning, especially for speaker identification oriented
tasks. An ablation study is performed verifying the efficacy of each proposed method. Finally, we scale up training
dataset to 94 thousand hours public audio data and achieve further performance improvement in all SUPERB tasks.`),qn.forEach(o),jn.forEach(o),Dn=m(t),ho=r(t,"P",{});var En=i(ho);Wa=a(En,"Tips:"),En.forEach(o),On=m(t),H=r(t,"UL",{});var be=i(H);ot=r(be,"LI",{});var aa=i(ot);Ia=a(aa,`UniSpeechSat is a speech model that accepts a float array corresponding to the raw waveform of the speech signal.
...
found `),st=r(jo,"A",{href:!0,rel:!0});var bl=i(st);ts=a(bl,"here"),bl.forEach(o),os=a(jo,"."),jo.forEach(o),Vn=m(t),ee=r(t,"H2",{class:!0});var ra=i(ee);Ue=r(ra,"A",{id:!0,class:!0,href:!0});var wl=i(Ue);Xo=r(wl,"SPAN",{});var yl=i(Xo);w(rt.$$.fragment,yl),yl.forEach(o),wl.forEach(o),ns=m(ra),Ro=r(ra,"SPAN",{});var $l=i(Ro);as=a($l,"UniSpeechSatConfig"),$l.forEach(o),ra.forEach(o),Nn=m(t),D=r(t,"DIV",{class:!0});var Qe=i(D);w(it.$$.fragment,Qe),ss=m(Qe),te=r(Qe,"P",{});var qo=i(te);rs=a(qo,"This is the configuration class to store the configuration of a "),fo=r(qo,"A",{href:!0});var kl=i(fo);is=a(kl,"UniSpeechSatModel"),kl.forEach(o),ls=a(qo,`. It is used to instantiate an
UniSpeechSat model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the UniSpeechSat
`),lt=r(qo,"A",{href:!0,rel:!0});var Tl=i(lt);cs=a(Tl,"facebook/unispeech_sat-base-960h"),Tl.forEach(o),ds=a(qo," architecture."),qo.forEach(o),ps=m(Qe),oe=r(Qe,"P",{});var Eo=i(oe);hs=a(Eo,"Configuration objects inherit from "),go=r(Eo,"A",{href:!0});var Ul=i(go);ms=a(Ul,"PretrainedConfig"),Ul.forEach(o),us=a(Eo,` and can be used to control the model outputs. Read the
...
library implements for all its model (such as downloading or saving etc.).`),wa.forEach(o),Mr=m(W),At=r(W,"P",{});var ya=i(At);zr=a(ya,"This model is a PyTorch "),Mt=r(ya,"A",{href:!0,rel:!0});var oc=i(Mt);Dr=a(oc,"torch.nn.Module"),oc.forEach(o),Or=a(ya,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ya.forEach(o),Lr=m(W),z=r(W,"DIV",{class:!0});var Y=i(z);w(zt.$$.fragment,Y),Vr=m(Y),he=r(Y,"P",{});var zo=i(he);Nr=a(zo,"The "),$o=r(zo,"A",{href:!0});var nc=i($o);Wr=a(nc,"UniSpeechSatForSequenceClassification"),nc.forEach(o),Ir=a(zo," forward method, overrides the "),cn=r(zo,"CODE",{});var ac=i(cn);Br=a(ac,"__call__"),ac.forEach(o),Hr=a(zo," special method."),zo.forEach(o),Xr=m(Y),w(De.$$.fragment,Y),Rr=m(Y),w(Oe.$$.fragment,Y),Zr=m(Y),w(Le.$$.fragment,Y),Y.forEach(o),W.forEach(o),Jn=m(t),me=r(t,"H2",{class:!0});var $a=i(me);Ve=r($a,"A",{id:!0,class:!0,href:!0});var sc=i(Ve);dn=r(sc,"SPAN",{});var rc=i(dn);w(Dt.$$.fragment,rc),rc.forEach(o),sc.forEach(o),Qr=m($a),pn=r($a,"SPAN",{});var ic=i(pn);Yr=a(ic,"UniSpeechSatForAudioFrameClassification"),ic.forEach(o),$a.forEach(o),Gn=m(t),C=r(t,"DIV",{class:!0});var I=i(C);w(Ot.$$.fragment,I),Jr=m(I),hn=r(I,"P",{});var lc=i(hn);Gr=a(lc,"UniSpeech-SAT Model with a frame classification head on top for tasks like Speaker Diarization."),lc.forEach(o),Kr=m(I),Lt=r(I,"P",{});var ka=i(Lt);ei=a(ka,"UniSpeechSat was proposed in "),Vt=r(ka,"A",{href:!0,rel:!0});var cc=i(Vt);ti=a(cc,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
