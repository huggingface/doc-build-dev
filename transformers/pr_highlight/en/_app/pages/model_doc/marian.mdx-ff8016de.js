import{S as bm,i as ym,s as xm,e as o,k as d,w as M,t as r,M as wm,c as s,d as t,m as c,a,x as b,h as i,b as p,F as e,g,y,q as x,o as w,B as $,v as $m,L as qt}from"../../chunks/vendor-6b77c823.js";import{T as bn}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C as ye}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as de}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as jt}from"../../chunks/ExampleCodeBlock-5212b321.js";function zm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianModel, MarianConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){h=o("p"),v=r("Examples:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Examples:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:qt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function jm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(l){l&&t(h)}}}function Em(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),{c(){h=o("p"),v=r("Example:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:qt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function Fm(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(l){l&&t(h)}}}function Pm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),v=r("Example:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:qt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function Am(z){let h,v,_,u,k,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,ge,te,ne,oe,Se,S,He,H,D;return{c(){h=o("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=d(),u=o("ul"),k=o("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),j=o("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),E=o("p"),ue=r("This second option is useful when using "),Y=o("code"),Le=r("tf.keras.Model.fit"),K=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),Z=o("code"),Ie=r("model(inputs)"),xe=r("."),G=d(),O=o("p"),we=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),L=d(),F=o("ul"),N=o("li"),X=r("a single Tensor with "),Q=o("code"),me=r("input_ids"),Ae=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),fe=d(),C=o("li"),Oe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=o("code"),ge=r("model([input_ids, attention_mask])"),te=r(" or "),ne=o("code"),oe=r("model([input_ids, attention_mask, token_type_ids])"),Se=d(),S=o("li"),He=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),D=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=s(T,"P",{});var q=a(h);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(T),u=s(T,"UL",{});var _e=a(u);k=s(_e,"LI",{});var Ze=a(k);l=i(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),m=c(_e),j=s(_e,"LI",{});var ke=a(j);Ce=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),_e.forEach(t),ce=c(T),E=s(T,"P",{});var U=a(E);ue=i(U,"This second option is useful when using "),Y=s(U,"CODE",{});var Xe=a(Y);Le=i(Xe,"tf.keras.Model.fit"),Xe.forEach(t),K=i(U,` method which currently requires having all the
...
first positional argument :`),De.forEach(t),L=c(T),F=s(T,"UL",{});var I=a(F);N=s(I,"LI",{});var se=a(N);X=i(se,"a single Tensor with "),Q=s(se,"CODE",{});var et=a(Q);me=i(et,"input_ids"),et.forEach(t),Ae=i(se," only and nothing else: "),J=s(se,"CODE",{});var Ue=a(J);P=i(Ue,"model(input_ids)"),Ue.forEach(t),se.forEach(t),fe=c(I),C=s(I,"LI",{});var W=a(C);Oe=i(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(W,"CODE",{});var tt=a(ee);ge=i(tt,"model([input_ids, attention_mask])"),tt.forEach(t),te=i(W," or "),ne=s(W,"CODE",{});var nt=a(ne);oe=i(nt,"model([input_ids, attention_mask, token_type_ids])"),nt.forEach(t),W.forEach(t),Se=c(I),S=s(I,"LI",{});var ae=a(S);He=i(ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=s(ae,"CODE",{});var ve=a(H);D=i(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),ae.forEach(t),I.forEach(t)},m(T,q){g(T,h,q),e(h,v),g(T,_,q),g(T,u,q),e(u,k),e(k,l),e(u,m),e(u,j),e(j,Ce),g(T,ce,q),g(T,E,q),e(E,ue),e(E,Y),e(Y,Le),e(E,K),e(E,Z),e(Z,Ie),e(E,xe),g(T,G,q),g(T,O,q),e(O,we),g(T,L,q),g(T,F,q),e(F,N),e(N,X),e(N,Q),e(Q,me),e(N,Ae),e(N,J),e(J,P),e(F,fe),e(F,C),e(C,Oe),e(C,ee),e(ee,ge),e(C,te),e(C,ne),e(ne,oe),e(F,Se),e(F,S),e(S,He),e(S,H),e(H,D)},d(T){T&&t(h),T&&t(_),T&&t(u),T&&t(ce),T&&t(E),T&&t(G),T&&t(O),T&&t(L),T&&t(F)}}}function Om(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(l){l&&t(h)}}}function Sm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, TFMarianMTModel
...
<span class="hljs-string">&quot;Where is the bus stop ?&quot;</span>`}}),{c(){h=o("p"),v=r("Examples:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Examples:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:qt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function Hm(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(l){l&&t(h)}}}function Dm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),v=r("Example:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:qt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function Um(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(l){l&&t(h)}}}function Wm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, FlaxMarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),v=r("Example:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:qt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function Rm(z){let h,v,_,u,k,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,ge,te,ne,oe,Se,S,He,H,D,T,q,_e,Ze,ke,U,Xe,Qe,De,I,se,et,Ue,W,tt,nt,ae,ve,xi,ns,wi,$i,zi,ot,yn,ji,Cs,qi,Ei,Fi,xn,Pi,Ls,Ni,Ci,Li,st,Ii,Is,Ai,Oi,As,Si,Hi,Di,Os,wn,Ui,Ss,Wi,Ri,Vi,Hs,$n,Bi,zn,Gi,Ji,er,at,Et,Ds,jn,Yi,Us,Ki,tr,$e,os,Zi,Ws,Xi,Qi,qn,el,En,tl,nl,ol,rt,sl,Rs,al,rl,Vs,il,ll,dl,Bs,cl,nr,it,Ft,Gs,Fn,pl,Js,hl,or,Ve,Ys,ul,ml,Ks,Pn,fl,gl,Zs,Nn,_l,sr,lt,Pt,Xs,Cn,kl,Qs,vl,ar,ze,Ln,Tl,ea,Ml,bl,yl,In,xl,ta,wl,$l,zl,An,jl,On,ql,El,Fl,Sn,Pl,na,Nl,Cl,rr,Nt,Ll,Hn,Il,Al,ir,Dn,lr,ss,Ol,dr,Un,cr,dt,Ct,oa,Wn,Sl,sa,Hl,pr,as,Dl,hr,Rn,ur,rs,Ul,mr,Vn,fr,ct,Lt,aa,Bn,Wl,ra,Rl,gr,Te,Gn,Vl,pt,Bl,is,Gl,Jl,Jn,Yl,Kl,Zl,ht,Xl,ls,Ql,ed,ds,td,nd,od,It,_r,ut,At,ia,Yn,sd,la,ad,kr,re,Kn,rd,Zn,id,Xn,ld,dd,cd,Qn,pd,cs,hd,ud,md,Ot,fd,St,eo,gd,da,_d,vr,mt,Ht,ca,to,kd,pa,vd,Tr,Me,no,Td,oo,Md,ps,bd,yd,xd,so,wd,ao,$d,zd,jd,je,ro,qd,ft,Ed,hs,Fd,Pd,ha,Nd,Cd,Ld,Dt,Id,Ut,Mr,gt,Wt,ua,io,Ad,ma,Od,br,be,lo,Sd,co,Hd,us,Dd,Ud,Wd,po,Rd,ho,Vd,Bd,Gd,pe,uo,Jd,_t,Yd,ms,Kd,Zd,fa,Xd,Qd,ec,Rt,tc,mo,nc,fo,oc,sc,ac,Vt,yr,kt,Bt,ga,go,rc,_a,ic,xr,vt,_o,lc,Gt,ko,dc,Jt,wr,Tt,Yt,ka,vo,cc,va,pc,$r,ie,To,hc,Mo,uc,fs,mc,fc,gc,bo,_c,yo,kc,vc,Tc,Kt,Mc,qe,xo,bc,Mt,yc,gs,xc,wc,Ta,$c,zc,jc,Zt,qc,Xt,zr,bt,Qt,Ma,wo,Ec,ba,Fc,jr,le,$o,Pc,zo,Nc,_s,Cc,Lc,Ic,jo,Ac,qo,Oc,Sc,Hc,en,Dc,he,Eo,Uc,yt,Wc,ks,Rc,Vc,ya,Bc,Gc,Jc,tn,Yc,Fo,Kc,Po,Zc,Xc,Qc,nn,qr,xt,on,xa,No,ep,wa,tp,Er,R,Co,np,Lo,op,vs,sp,ap,rp,Io,ip,Ao,lp,dp,cp,$a,pp,hp,We,za,Oo,up,mp,ja,So,fp,gp,qa,Ho,_p,kp,Ea,Do,vp,Tp,Ee,Uo,Mp,wt,bp,Fa,yp,xp,Pa,wp,$p,zp,sn,jp,an,Fr,$t,rn,Na,Wo,qp,Ca,Ep,Pr,V,Ro,Fp,Vo,Pp,Ts,Np,Cp,Lp,Bo,Ip,Go,Ap,Op,Sp,La,Hp,Dp,Re,Ia,Jo,Up,Wp,Aa,Yo,Rp,Vp,Oa,Ko,Bp,Gp,Sa,Zo,Jp,Yp,Fe,Xo,Kp,zt,Zp,Ha,Xp,Qp,Da,eh,th,nh,ln,oh,dn,Nr;return l=new de({}),X=new de({}),jn=new de({}),Fn=new de({}),Cn=new de({}),Dn=new ye({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/configuration_marian.py#L34"}}),It=new jt({props:{anchor:"transformers.MarianConfig.example",$$slots:{default:[zm]},$$scope:{ctx:z}}}),Yn=new de({}),Kn=new B({props:{name:"class transformers.MarianTokenizer",anchor:"transformers.MarianTokenizer",parameters:[{name:"source_spm",val:""},{name:"target_spm",val:""},{name:"vocab",val:""},{name:"target_vocab_file",val:" = None"},{name:"source_lang",val:" = None"},{name:"target_lang",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"model_max_length",val:" = 512"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"separate_vocabs",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MarianTokenizer.source_spm",description:`<strong>source_spm</strong> (<code>str</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_highlight/en/model_doc/marian#transformers.MarianConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/modeling_marian.py#L1390",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_highlight/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/modeling_marian.py#L1565",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/modeling_tf_marian.py#L1169",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/modeling_tf_marian.py#L1243"}}),en=new bn({props:{$$slots:{default:[Am]},$$scope:{ctx:z}}}),Eo=new B({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_highlight/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/modeling_tf_marian.py#L1276",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_highlight/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/marian/modeling_flax_marian.py#L1130",returnDescription:`
<p>A <a
...
`}}),ln=new bn({props:{$$slots:{default:[Um]},$$scope:{ctx:z}}}),dn=new jt({props:{anchor:"transformers.FlaxMarianMTModel.__call__.example",$$slots:{default:[Wm]},$$scope:{ctx:z}}}),{c(){h=o("meta"),v=d(),_=o("h1"),u=o("a"),k=o("span"),M(l.$$.fragment),m=d(),j=o("span"),Ce=r("MarianMT"),ce=d(),E=o("p"),ue=o("strong"),Y=r("Bugs:"),Le=r(" If you see something strange, file a "),K=o("a"),Z=r("Github Issue"),Ie=r(`
and assign @patrickvonplaten.`),xe=d(),G=o("p"),O=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),we=d(),L=o("h2"),F=o("a"),N=o("span"),M(X.$$.fragment),Q=d(),me=o("span"),Ae=r("Implementation Notes"),J=d(),P=o("ul"),fe=o("li"),C=o("p"),Oe=r("Each model is about 298 MB on disk, there are more than 1,000 models."),ee=d(),ge=o("li"),te=o("p"),ne=r("The list of supported language pairs can be found "),oe=o("a"),Se=r("here"),S=r("."),He=d(),H=o("li"),D=o("p"),T=r("Models were originally trained by "),q=o("a"),_e=r("J\xF6rg Tiedemann"),Ze=r(" using the "),ke=o("a"),U=r("Marian"),Xe=r(" C++ library, which supports fast training and translation."),Qe=d(),De=o("li"),I=o("p"),se=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
...
fine-tuning experiments and integration tests.`),ml=d(),Ks=o("li"),Pn=o("a"),fl=r("Fine-tune on GPU"),gl=d(),Zs=o("li"),Nn=o("a"),_l=r("Fine-tune on GPU with pytorch-lightning"),sr=d(),lt=o("h2"),Pt=o("a"),Xs=o("span"),M(Cn.$$.fragment),kl=d(),Qs=o("span"),vl=r("Multilingual Models"),ar=d(),ze=o("ul"),Ln=o("li"),Tl=r("All model names use the following format: "),ea=o("code"),Ml=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),bl=r(":"),yl=d(),In=o("li"),xl=r(`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
group:`),hr=d(),M(Rn.$$.fragment),ur=d(),rs=o("p"),Ul=r("Example of translating english to many romance languages, using old-style 2 character language codes"),mr=d(),M(Vn.$$.fragment),fr=d(),ct=o("h2"),Lt=o("a"),aa=o("span"),M(Bn.$$.fragment),Wl=d(),ra=o("span"),Rl=r("MarianConfig"),gr=d(),Te=o("div"),M(Gn.$$.fragment),Vl=d(),pt=o("p"),Bl=r("This is the configuration class to store the configuration of a "),is=o("a"),Gl=r("MarianModel"),Jl=r(`. It is used to instantiate an
...
documentation from `),ds=o("a"),td=r("PretrainedConfig"),nd=r(" for more information."),od=d(),M(It.$$.fragment),_r=d(),ut=o("h2"),At=o("a"),ia=o("span"),M(Yn.$$.fragment),sd=d(),la=o("span"),ad=r("MarianTokenizer"),kr=d(),re=o("div"),M(Kn.$$.fragment),rd=d(),Zn=o("p"),id=r("Construct a Marian tokenizer. Based on "),Xn=o("a"),ld=r("SentencePiece"),dd=r("."),cd=d(),Qn=o("p"),pd=r("This tokenizer inherits from "),cs=o("a"),hd=r("PreTrainedTokenizer"),ud=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),md=d(),M(Ot.$$.fragment),fd=d(),St=o("div"),M(eo.$$.fragment),gd=d(),da=o("p"),_d=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
and behavior.`),jd=d(),je=o("div"),M(ro.$$.fragment),qd=d(),ft=o("p"),Ed=r("The "),hs=o("a"),Fd=r("MarianModel"),Pd=r(" forward method, overrides the "),ha=o("code"),Nd=r("__call__"),Cd=r(" special method."),Ld=d(),M(Dt.$$.fragment),Id=d(),M(Ut.$$.fragment),Mr=d(),gt=o("h2"),Wt=o("a"),ua=o("span"),M(io.$$.fragment),Ad=d(),ma=o("span"),Od=r("MarianMTModel"),br=d(),be=o("div"),M(lo.$$.fragment),Sd=d(),co=o("p"),Hd=r(`The Marian Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gd=d(),pe=o("div"),M(uo.$$.fragment),Jd=d(),_t=o("p"),Yd=r("The "),ms=o("a"),Kd=r("MarianMTModel"),Zd=r(" forward method, overrides the "),fa=o("code"),Xd=r("__call__"),Qd=r(" special method."),ec=d(),M(Rt.$$.fragment),tc=d(),mo=o("p"),nc=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),fo=o("a"),oc=r("here"),sc=r("."),ac=d(),M(Vt.$$.fragment),yr=d(),kt=o("h2"),Bt=o("a"),ga=o("span"),M(go.$$.fragment),rc=d(),_a=o("span"),ic=r("MarianForCausalLM"),xr=d(),vt=o("div"),M(_o.$$.fragment),lc=d(),Gt=o("div"),M(ko.$$.fragment),dc=d(),M(Jt.$$.fragment),wr=d(),Tt=o("h2"),Yt=o("a"),ka=o("span"),M(vo.$$.fragment),cc=d(),va=o("span"),pc=r("TFMarianModel"),$r=d(),ie=o("div"),M(To.$$.fragment),hc=d(),Mo=o("p"),uc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc=d(),bo=o("p"),_c=r("This model is also a "),yo=o("a"),kc=r("tf.keras.Model"),vc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tc=d(),M(Kt.$$.fragment),Mc=d(),qe=o("div"),M(xo.$$.fragment),bc=d(),Mt=o("p"),yc=r("The "),gs=o("a"),xc=r("TFMarianModel"),wc=r(" forward method, overrides the "),Ta=o("code"),$c=r("__call__"),zc=r(" special method."),jc=d(),M(Zt.$$.fragment),qc=d(),M(Xt.$$.fragment),zr=d(),bt=o("h2"),Qt=o("a"),Ma=o("span"),M(wo.$$.fragment),Ec=d(),ba=o("span"),Fc=r("TFMarianMTModel"),jr=d(),le=o("div"),M($o.$$.fragment),Pc=d(),zo=o("p"),Nc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
This model inherits from `),_s=o("a"),Cc=r("TFPreTrainedModel"),Lc=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation from `),ds=s(zs,"A",{href:!0});var su=a(ds);td=i(su,"PretrainedConfig"),su.forEach(t),nd=i(zs," for more information."),zs.forEach(t),od=c(un),b(It.$$.fragment,un),un.forEach(t),_r=c(n),ut=s(n,"H2",{class:!0});var Zr=a(ut);At=s(Zr,"A",{id:!0,class:!0,href:!0});var au=a(At);ia=s(au,"SPAN",{});var ru=a(ia);b(Yn.$$.fragment,ru),ru.forEach(t),au.forEach(t),sd=c(Zr),la=s(Zr,"SPAN",{});var iu=a(la);ad=i(iu,"MarianTokenizer"),iu.forEach(t),Zr.forEach(t),kr=c(n),re=s(n,"DIV",{class:!0});var Be=a(re);b(Kn.$$.fragment,Be),rd=c(Be),Zn=s(Be,"P",{});var Xr=a(Zn);id=i(Xr,"Construct a Marian tokenizer. Based on "),Xn=s(Xr,"A",{href:!0,rel:!0});var lu=a(Xn);ld=i(lu,"SentencePiece"),lu.forEach(t),dd=i(Xr,"."),Xr.forEach(t),cd=c(Be),Qn=s(Be,"P",{});var Qr=a(Qn);pd=i(Qr,"This tokenizer inherits from "),cs=s(Qr,"A",{href:!0});var du=a(cs);hd=i(du,"PreTrainedTokenizer"),du.forEach(t),ud=i(Qr,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Qr.forEach(t),md=c(Be),b(Ot.$$.fragment,Be),fd=c(Be),St=s(Be,"DIV",{class:!0});var ei=a(St);b(eo.$$.fragment,ei),gd=c(ei),da=s(ei,"P",{});var cu=a(da);_d=i(cu,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oi.forEach(t),jd=c(mn),je=s(mn,"DIV",{class:!0});var fn=a(je);b(ro.$$.fragment,fn),qd=c(fn),ft=s(fn,"P",{});var js=a(ft);Ed=i(js,"The "),hs=s(js,"A",{href:!0});var gu=a(hs);Fd=i(gu,"MarianModel"),gu.forEach(t),Pd=i(js," forward method, overrides the "),ha=s(js,"CODE",{});var _u=a(ha);Nd=i(_u,"__call__"),_u.forEach(t),Cd=i(js," special method."),js.forEach(t),Ld=c(fn),b(Dt.$$.fragment,fn),Id=c(fn),b(Ut.$$.fragment,fn),fn.forEach(t),mn.forEach(t),Mr=c(n),gt=s(n,"H2",{class:!0});var si=a(gt);Wt=s(si,"A",{id:!0,class:!0,href:!0});var ku=a(Wt);ua=s(ku,"SPAN",{});var vu=a(ua);b(io.$$.fragment,vu),vu.forEach(t),ku.forEach(t),Ad=c(si),ma=s(si,"SPAN",{});var Tu=a(ma);Od=i(Tu,"MarianMTModel"),Tu.forEach(t),si.forEach(t),br=c(n),be=s(n,"DIV",{class:!0});var gn=a(be);b(lo.$$.fragment,gn),Sd=c(gn),co=s(gn,"P",{});var ai=a(co);Hd=i(ai,`The Marian Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ai.forEach(t),Wd=c(gn),po=s(gn,"P",{});var ri=a(po);Rd=i(ri,"This model is also a PyTorch "),ho=s(ri,"A",{href:!0,rel:!0});var bu=a(ho);Vd=i(bu,"torch.nn.Module"),bu.forEach(t),Bd=i(ri,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ri.forEach(t),Gd=c(gn),pe=s(gn,"DIV",{class:!0});var Ge=a(pe);b(uo.$$.fragment,Ge),Jd=c(Ge),_t=s(Ge,"P",{});var qs=a(_t);Yd=i(qs,"The "),ms=s(qs,"A",{href:!0});var yu=a(ms);Kd=i(yu,"MarianMTModel"),yu.forEach(t),Zd=i(qs," forward method, overrides the "),fa=s(qs,"CODE",{});var xu=a(fa);Xd=i(xu,"__call__"),xu.forEach(t),Qd=i(qs," special method."),qs.forEach(t),ec=c(Ge),b(Rt.$$.fragment,Ge),tc=c(Ge),mo=s(Ge,"P",{});var ii=a(mo);nc=i(ii,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),fo=s(ii,"A",{href:!0,rel:!0});var wu=a(fo);oc=i(wu,"here"),wu.forEach(t),sc=i(ii,"."),ii.forEach(t),ac=c(Ge),b(Vt.$$.fragment,Ge),Ge.forEach(t),gn.forEach(t),yr=c(n),kt=s(n,"H2",{class:!0});var li=a(kt);Bt=s(li,"A",{id:!0,class:!0,href:!0});var $u=a(Bt);ga=s($u,"SPAN",{});var zu=a(ga);b(go.$$.fragment,zu),zu.forEach(t),$u.forEach(t),rc=c(li),_a=s(li,"SPAN",{});var ju=a(_a);ic=i(ju,"MarianForCausalLM"),ju.forEach(t),li.forEach(t),xr=c(n),vt=s(n,"DIV",{class:!0});var di=a(vt);b(_o.$$.fragment,di),lc=c(di),Gt=s(di,"DIV",{class:!0});var ci=a(Gt);b(ko.$$.fragment,ci),dc=c(ci),b(Jt.$$.fragment,ci),ci.forEach(t),di.forEach(t),wr=c(n),Tt=s(n,"H2",{class:!0});var pi=a(Tt);Yt=s(pi,"A",{id:!0,class:!0,href:!0});var qu=a(Yt);ka=s(qu,"SPAN",{});var Eu=a(ka);b(vo.$$.fragment,Eu),Eu.forEach(t),qu.forEach(t),cc=c(pi),va=s(pi,"SPAN",{});var Fu=a(va);pc=i(Fu,"TFMarianModel"),Fu.forEach(t),pi.forEach(t),$r=c(n),ie=s(n,"DIV",{class:!0});var Je=a(ie);b(To.$$.fragment,Je),hc=c(Je),Mo=s(Je,"P",{});var hi=a(Mo);uc=i(hi,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hi.forEach(t),gc=c(Je),bo=s(Je,"P",{});var ui=a(bo);_c=i(ui,"This model is also a "),yo=s(ui,"A",{href:!0,rel:!0});var Nu=a(yo);kc=i(Nu,"tf.keras.Model"),Nu.forEach(t),vc=i(ui,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ui.forEach(t),Tc=c(Je),b(Kt.$$.fragment,Je),Mc=c(Je),qe=s(Je,"DIV",{class:!0});var _n=a(qe);b(xo.$$.fragment,_n),bc=c(_n),Mt=s(_n,"P",{});var Es=a(Mt);yc=i(Es,"The "),gs=s(Es,"A",{href:!0});var Cu=a(gs);xc=i(Cu,"TFMarianModel"),Cu.forEach(t),wc=i(Es," forward method, overrides the "),Ta=s(Es,"CODE",{});var Lu=a(Ta);$c=i(Lu,"__call__"),Lu.forEach(t),zc=i(Es," special method."),Es.forEach(t),jc=c(_n),b(Zt.$$.fragment,_n),qc=c(_n),b(Xt.$$.fragment,_n),_n.forEach(t),Je.forEach(t),zr=c(n),bt=s(n,"H2",{class:!0});var mi=a(bt);Qt=s(mi,"A",{id:!0,class:!0,href:!0});var Iu=a(Qt);Ma=s(Iu,"SPAN",{});var Au=a(Ma);b(wo.$$.fragment,Au),Au.forEach(t),Iu.forEach(t),Ec=c(mi),ba=s(mi,"SPAN",{});var Ou=a(ba);Fc=i(Ou,"TFMarianMTModel"),Ou.forEach(t),mi.forEach(t),jr=c(n),le=s(n,"DIV",{class:!0});var Ye=a(le);b($o.$$.fragment,Ye),Pc=c(Ye),zo=s(Ye,"P",{});var fi=a(zo);Nc=i(fi,`The MARIAN Model with a language modeling head. Can be used for summarization.
This model inherits from `),_s=s(fi,"A",{href:!0});var Su=a(_s);Cc=i(Su,"TFPreTrainedModel"),Su.forEach(t),Lc=i(fi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fi.forEach(t),Ic=c(Ye),jo=s(Ye,"P",{});var gi=a(jo);Ac=i(gi,"This model is also a "),qo=s(gi,"A",{href:!0,rel:!0});var Hu=a(qo);Oc=i(Hu,"tf.keras.Model"),Hu.forEach(t),Sc=i(gi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gi.forEach(t),Hc=c(Ye),b(en.$$.fragment,Ye),Dc=c(Ye),he=s(Ye,"DIV",{class:!0});var Ke=a(he);b(Eo.$$.fragment,Ke),Uc=c(Ke),yt=s(Ke,"P",{});var Fs=a(yt);Wc=i(Fs,"The "),ks=s(Fs,"A",{href:!0});var Du=a(ks);Rc=i(Du,"TFMarianMTModel"),Du.forEach(t),Vc=i(Fs," forward method, overrides the "),ya=s(Fs,"CODE",{});var Uu=a(ya);Bc=i(Uu,"__call__"),Uu.forEach(t),Gc=i(Fs," special method."),Fs.forEach(t),Jc=c(Ke),b(tn.$$.fragment,Ke),Yc=c(Ke),Fo=s(Ke,"P",{});var _i=a(Fo);Kc=i(_i,`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),Po=s(_i,"A",{href:!0,rel:!0});var Wu=a(Po);Zc=i(Wu,"here"),Wu.forEach(t),Xc=i(_i,"."),_i.forEach(t),Qc=c(Ke),b(nn.$$.fragment,Ke),Ke.forEach(t),Ye.forEach(t),qr=c(n),xt=s(n,"H2",{class:!0});var ki=a(xt);on=s(ki,"A",{id:!0,class:!0,href:!0});var Ru=a(on);xa=s(Ru,"SPAN",{});var Vu=a(xa);b(No.$$.fragment,Vu),Vu.forEach(t),Ru.forEach(t),ep=c(ki),wa=s(ki,"SPAN",{});var Bu=a(wa);tp=i(Bu,"FlaxMarianModel"),Bu.forEach(t),ki.forEach(t),Er=c(n),R=s(n,"DIV",{class:!0});var Pe=a(R);b(Co.$$.fragment,Pe),np=c(Pe),Lo=s(Pe,"P",{});var vi=a(Lo);op=i(vi,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
