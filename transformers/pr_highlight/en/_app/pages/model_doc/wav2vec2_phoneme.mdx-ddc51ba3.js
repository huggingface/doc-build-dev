...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L489",returnDescription:`
<p>The
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L433",returnDescription:`
<p>The decoded
...
of a monolingually pretrained model.`),Ve=c(),oe=n("p"),ao=s("Tips:"),$e=c(),u=n("ul"),he=n("li"),so=s("Wav2Vec2Phoneme uses the exact same architecture as Wav2Vec2"),io=c(),pe=n("li"),co=s("Wav2Vec2Phoneme is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),lo=c(),R=n("li"),ho=s(`Wav2Vec2Phoneme model was trained using connectionist temporal classification (CTC) so the model output has to be
decoded using `),te=n("a"),po=s("Wav2Vec2PhonemeCTCTokenizer"),mo=s("."),uo=c(),me=n("li"),fo=s(`Wav2Vec2Phoneme can be fine-tuned on multiple language at once and decode unseen languages in a single forward pass
...
sequences.`),Ro=c(),$=n("div"),E(Z.$$.fragment),Oo=c(),be=n("p"),Uo=s("Convert a list of lists of token ids into a list of strings by calling decode."),Bo=c(),g=n("div"),E(J.$$.fragment),Mo=c(),Te=n("p"),Ho=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
...
mapping phonemes of the training languages to the target language using articulatory features. Experiments show that
this simple method significantly outperforms prior work which introduced task-specific architectures and used only part
of a monolingually pretrained model.`),lt.forEach(t),ct.forEach(t),Ve=l(e),oe=r(e,"P",{});var dt=a(oe);ao=i(dt,"Tips:"),dt.forEach(t),$e=l(e),u=r(e,"UL",{});var _=a(u);he=r(_,"LI",{});var ht=a(he);so=i(ht,"Wav2Vec2Phoneme uses the exact same architecture as Wav2Vec2"),ht.forEach(t),io=l(_),pe=r(_,"LI",{});var pt=a(pe);co=i(pt,"Wav2Vec2Phoneme is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),pt.forEach(t),lo=l(_),R=r(_,"LI",{});var Oe=a(R);ho=i(Oe,`Wav2Vec2Phoneme model was trained using connectionist temporal classification (CTC) so the model output has to be
decoded using `),te=r(Oe,"A",{href:!0});var mt=a(te);po=i(mt,"Wav2Vec2PhonemeCTCTokenizer"),mt.forEach(t),mo=i(Oe,"."),Oe.forEach(t),uo=l(_),me=r(_,"LI",{});var ut=a(me);fo=i(ut,`Wav2Vec2Phoneme can be fine-tuned on multiple language at once and decode unseen languages in a single forward pass
...
should make use of a dictionary and language model.`),ft.forEach(t),_.forEach(t),Ee=l(e),C=r(e,"P",{});var Ue=a(C);vo=i(Ue,"Relevant checkpoints can be found under "),O=r(Ue,"A",{href:!0,rel:!0});var gt=a(O);ko=i(gt,"https://huggingface.co/models?other=phoneme-recognition"),gt.forEach(t),bo=i(Ue,"."),Ue.forEach(t),qe=l(e),U=r(e,"P",{});var Go=a(U);To=i(Go,"This model was contributed by "),B=r(Go,"A",{href:!0,rel:!0});var _t=a(B);wo=i(_t,"patrickvonplaten"),_t.forEach(t),Go.forEach(t),Le=l(e),P=r(e,"P",{});var Be=a(P);yo=i(Be,"The original code can be found "),M=r(Be,"A",{href:!0,rel:!0});var vt=a(M);zo=i(vt,"here"),vt.forEach(t),Co=i(Be,"."),Be.forEach(t),Fe=l(e),x=r(e,"P",{});var Me=a(x);Po=i(Me,"Wav2Vec2Phoneme\u2019s architecture is based on the Wav2Vec2 model, so one can refer to "),fe=r(Me,"CODE",{});var kt=a(fe);xo=i(kt,"Wav2Vec2"),kt.forEach(t),Wo=i(Me,"\u2019s documentation page except for the tokenizer."),Me.forEach(t),Ie=l(e),T=r(e,"H2",{class:!0});var He=a(T);W=r(He,"A",{id:!0,class:!0,href:!0});var bt=a(W);ge=r(bt,"SPAN",{});var Tt=a(ge);q(H.$$.fragment,Tt),Tt.forEach(t),bt.forEach(t),Vo=l(He),_e=r(He,"SPAN",{});var wt=a(_e);$o=i(wt,"Wav2Vec2PhonemeCTCTokenizer"),wt.forEach(t),He.forEach(t),Ae=l(e),m=r(e,"DIV",{class:!0});var f=a(m);q(X.$$.fragment,f),Eo=l(f),ve=r(f,"P",{});var yt=a(ve);qo=i(yt,"Constructs a Wav2Vec2PhonemeCTC tokenizer."),yt.forEach(t),Lo=l(f),j=r(f,"P",{});var Xe=a(j);Fo=i(Xe,"This tokenizer inherits from "),ne=r(Xe,"A",{href:!0});var zt=a(ne);Io=i(zt,"PreTrainedTokenizer"),zt.forEach(t),Ao=i(Xe,` which contains some of the main methods. Users should refer to
...
sequences.`),Ct.forEach(t),je.forEach(t),Ro=l(f),$=r(f,"DIV",{class:!0});var Qe=a($);q(Z.$$.fragment,Qe),Oo=l(Qe),be=r(Qe,"P",{});var Pt=a(be);Uo=i(Pt,"Convert a list of lists of token ids into a list of strings by calling decode."),Pt.forEach(t),Qe.forEach(t),Bo=l(f),g=r(f,"DIV",{class:!0});var ae=a(g);q(J.$$.fragment,ae),Mo=l(ae),Te=r(ae,"P",{});var xt=a(Te);Ho=i(xt,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),xt.forEach(t),Xo=l(ae),G=r(ae,"P",{});var Ze=a(G);jo=i(Ze,"Similar to doing "),we=r(Ze,"CODE",{});var Wt=a(we);Qo=i(Wt,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Wt.forEach(t),Zo=i(Ze,"."),Ze.forEach(t),ae.forEach(t),Jo=l(f),re=r(f,"DIV",{class:!0});var Vt=a(re);q(K.$$.fragment,Vt),Vt.forEach(t),f.forEach(t),this.h()},h(){h(v,"name","hf:doc:metadata"),h(v,"content",JSON.stringify(Nt)),h(w,"id","wav2vec2phoneme"),h(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(w,"href","#wav2vec2phoneme"),h(k,"class","relative group"),h(y,"id","overview"),h(y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(y,"href","#overview"),h(b,"class","relative group"),h(S,"href","https://arxiv.org/abs/2109.11680"),h(S,"rel","nofollow"),h(te,"href","/docs/transformers/pr_highlight/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer"),h(O,"href","https://huggingface.co/models?other=phoneme-recognition"),h(O,"rel","nofollow"),h(B,"href","https://huggingface.co/patrickvonplaten"),h(B,"rel","nofollow"),h(M,"href","https://github.com/pytorch/fairseq/tree/master/fairseq/models/wav2vec"),h(M,"rel","nofollow"),h(W,"id","transformers.Wav2Vec2PhonemeCTCTokenizer"),h(W,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(W,"href","#transformers.Wav2Vec2PhonemeCTCTokenizer"),h(T,"class","relative group"),h(ne,"href","/docs/transformers/pr_highlight/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),h(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h($,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(g,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,d){o(document.head,v),p(e,ze,d),p(e,k,d),o(k,w),o(w,se),L(N,se,null),o(k,Je),o(k,ie),o(ie,Ge),p(e,Ce,d),p(e,b,d),o(b,y),o(y,ce),L(D,ce,null),o(b,Ke),o(b,le),o(le,Ye),p(e,Pe,d),p(e,z,d),o(z,eo),o(z,S),o(S,oo),o(z,to),p(e,xe,d),p(e,Y,d),o(Y,no),p(e,We,d),p(e,ee,d),o(ee,de),o(de,ro),p(e,Ve,d),p(e,oe,d),o(oe,ao),p(e,$e,d),p(e,u,d),o(u,he),o(he,so),o(u,io),o(u,pe),o(pe,co),o(u,lo),o(u,R),o(R,ho),o(R,te),o(te,po),o(R,mo),o(u,uo),o(u,me),o(me,fo),o(u,go),o(u,ue),o(ue,_o),p(e,Ee,d),p(e,C,d),o(C,vo),o(C,O),o(O,ko),o(C,bo),p(e,qe,d),p(e,U,d),o(U,To),o(U,B),o(B,wo),p(e,Le,d),p(e,P,d),o(P,yo),o(P,M),o(M,zo),o(P,Co),p(e,Fe,d),p(e,x,d),o(x,Po),o(x,fe),o(fe,xo),o(x,Wo),p(e,Ie,d),p(e,T,d),o(T,W),o(W,ge),L(H,ge,null),o(T,Vo),o(T,_e),o(_e,$o),p(e,Ae,d),p(e,m,d),L(X,m,null),o(m,Eo),o(m,ve),o(ve,qo),o(m,Lo),o(m,j),o(j,Fo),o(j,ne),o(ne,Io),o(j,Ao),o(m,No),o(m,V),L(Q,V,null),o(V,Do),o(V,ke),o(ke,So),o(m,Ro),o(m,$),L(Z,$,null),o($,Oo),o($,be),o(be,Uo),o(m,Bo),o(m,g),L(J,g,null),o(g,Mo),o(g,Te),o(Te,Ho),o(g,Xo),o(g,G),o(G,jo),o(G,we),o(we,Qo),o(G,Zo),o(m,Jo),o(m,re),L(K,re,null),Ne=!0},p:Ft,i(e){Ne||(F(N.$$.fragment,e),F(D.$$.fragment,e),F(H.$$.fragment,e),F(X.$$.fragment,e),F(Q.$$.fragment,e),F(Z.$$.fragment,e),F(J.$$.fragment,e),F(K.$$.fragment,e),Ne=!0)},o(e){I(N.$$.fragment,e),I(D.$$.fragment,e),I(H.$$.fragment,e),I(X.$$.fragment,e),I(Q.$$.fragment,e),I(Z.$$.fragment,e),I(J.$$.fragment,e),I(K.$$.fragment,e),Ne=!1},d(e){t(v),e&&t(ze),e&&t(k),A(N),e&&t(Ce),e&&t(b),A(D),e&&t(Pe),e&&t(z),e&&t(xe),e&&t(Y),e&&t(We),e&&t(ee),e&&t(Ve),e&&t(oe),e&&t($e),e&&t(u),e&&t(Ee),e&&t(C),e&&t(qe),e&&t(U),e&&t(Le),e&&t(P),e&&t(Fe),e&&t(x),e&&t(Ie),e&&t(T),A(H),e&&t(Ae),e&&t(m),A(X),A(Q),A(Z),A(J),A(K)}}}const Nt={local:"wav2vec2phoneme",sections:[{local:"overview",title:"Overview"},{local:"transformers.Wav2Vec2PhonemeCTCTokenizer",title:"Wav2Vec2PhonemeCTCTokenizer"}],title:"Wav2Vec2Phoneme"};function Dt(Yo){return It(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ut extends $t{constructor(v){super();Et(this,v,Dt,At,qt,{})}}export{Ut as default,Nt as metadata};
