...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;my-model&quot;</span>, config=encoder_decoder_config)`}}),{c(){c=s("p"),v=n("Examples:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Examples:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function ii(z){let c,v,u,p,_;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=n("Module"),_=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids)`}}),{c(){c=s("p"),v=n("Examples:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Examples:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function li(z){let c,v,u,p,_;return p=new Fe({props:{code:`from transformers import EncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2bert&quot;</span>)`}}),{c(){c=s("p"),v=n("Example:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function pi(z){let c,v,u,p,_;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=d(f,"CODE",{});var A=i(u);p=r(A,"Module"),A.forEach(o),_=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){b(a,c,f),e(c,v),e(c,u),e(u,p),e(c,_)},d(a){a&&o(c)}}}function hi(z){let c,v,u,p,_;return p=new Fe({props:{code:`from transformers import TFEncoderDecoderModel, BertTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># generation</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),{c(){c=s("p"),v=n("Examples:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Examples:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function mi(z){let c,v,u,p,_;return p=new Fe({props:{code:`from transformers import TFEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){c=s("p"),v=n("Example:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function fi(z){let c,v,u,p,_;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=d(f,"CODE",{});var A=i(u);p=r(A,"Module"),A.forEach(o),_=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> summary == <span class="hljs-string">&quot;SAS Alpha Epsilon suspended Sigma Alpha Epsilon members&quot;</span>`}}),{c(){c=s("p"),v=n("Examples:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Examples:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function gi(z){let c,v,u,p,_;return p=new Fe({props:{code:`from transformers import FlaxEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){c=s("p"),v=n("Example:"),u=h(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=m(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function _i(z){let c,v,u,p,_,a,f,A,$n,Ut,ie,xn,xo,Mn,Dn,Ht,ce,zn,Pe,qn,jn,Yt,le,Fn,Mo,Pn,An,Jt,O,Cn,Do,Sn,Nn,Ae,In,Ln,Zt,V,Bn,pt,On,Vn,ht,Wn,Rn,Kt,Ce,Qt,W,Gn,Se,Un,Hn,Ne,Yn,Jn,Xt,J,pe,mt,Ie,Zn,ft,Kn,en,P,Le,Qn,he,zo,Xn,er,qo,or,tr,nr,Z,rr,jo,ar,sr,Fo,dr,ir,cr,me,lr,fe,Be,pr,Oe,hr,Po,mr,fr,ur,ue,Ve,gr,K,_r,ut,br,vr,gt,yr,kr,on,Q,ge,_t,We,Tr,bt,wr,tn,x,Re,Er,X,$r,Ao,xr,Mr,Co,Dr,zr,qr,Ge,jr,Ue,Fr,Pr,Ar,vt,Cr,Sr,He,Nr,So,Ir,Lr,Br,Ye,Or,Je,Vr,Wr,Rr,R,No,Gr,Ur,yt,Hr,Yr,kt,Jr,Zr,Kr,C,Ze,Qr,ee,Xr,Io,ea,oa,Tt,ta,na,ra,_e,aa,be,sa,S,Ke,da,wt,ia,ca,oe,la,Et,pa,ha,$t,ma,fa,ua,ve,nn,te,ye,xt,Qe,ga,Mt,_a,rn,M,Xe,ba,ne,va,Lo,ya,ka,Bo,Ta,wa,Ea,eo,$a,oo,xa,Ma,Da,Dt,za,qa,to,ja,Oo,Fa,Pa,Aa,no,Ca,ro,Sa,Na,Ia,G,Vo,La,Ba,Wo,Oa,Va,Ro,Wa,Ra,Ga,N,ao,Ua,re,Ha,Go,Ya,Ja,zt,Za,Ka,Qa,ke,Xa,Te,es,U,so,os,qt,ts,ns,we,an,ae,Ee,jt,io,rs,Ft,as,sn,D,co,ss,se,ds,Uo,is,cs,Ho,ls,ps,hs,lo,ms,po,fs,us,gs,Pt,_s,bs,ho,vs,Yo,ys,ks,Ts,mo,ws,fo,Es,$s,xs,H,Jo,Ms,Ds,At,zs,qs,Ct,js,Fs,Ps,I,uo,As,de,Cs,Zo,Ss,Ns,St,Is,Ls,Bs,$e,Os,xe,Vs,Y,go,Ws,Nt,Rs,Gs,Me,dn;return a=new Gt({}),Ce=new Fe({props:{code:`# a workaround to load from pytorch checkpoint
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),me=new Eo({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[di]},$$scope:{ctx:z}}}),Be=new B({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
...
`}}),Ve=new B({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L429",returnDescription:`
<p>A <a
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L494",returnDescription:`
<p>A <a
...
`}}),ke=new Us({props:{$$slots:{default:[pi]},$$scope:{ctx:z}}}),Te=new Eo({props:{anchor:"transformers.TFEncoderDecoderModel.call.example",$$slots:{default:[hi]},$$scope:{ctx:z}}}),so=new B({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Information necessary to initiate the encoder. Can be either:</p>
<ul>
<li>A string, the <em>model id</em> of a pretrained model hosted inside a model repo on huggingface.co.
Valid model ids can be located at the root-level, like <code>bert-base-uncased</code>, or namespaced under a
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_highlight/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L330"}}),we=new Eo({props:{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[mi]},$$scope:{ctx:z}}}),io=new Gt({}),co=new B({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_highlight/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L610",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_highlight/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L741"}}),Me=new Eo({props:{anchor:"transformers.FlaxEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[gi]},$$scope:{ctx:z}}}),{c(){c=s("meta"),v=h(),u=s("h1"),p=s("a"),_=s("span"),y(a.$$.fragment),f=h(),A=s("span"),$n=n("Encoder Decoder Models"),Ut=h(),ie=s("p"),xn=n("The "),xo=s("a"),Mn=n("EncoderDecoderModel"),Dn=n(` can be used to initialize a sequence-to-sequence model with any
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),Ht=h(),ce=s("p"),zn=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
was shown in `),Pe=s("a"),qn=n("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),jn=n(` by
Sascha Rothe, Shashi Narayan, Aliaksei Severyn.`),Yt=h(),le=s("p"),Fn=n("After such an "),Mo=s("a"),Pn=n("EncoderDecoderModel"),An=n(` has been trained/fine-tuned, it can be saved/loaded just like
any other models (see the examples for more information).`),Jt=h(),O=s("p"),Cn=n("An application of this architecture could be to leverage two pretrained "),Do=s("a"),Sn=n("BertModel"),Nn=n(` as the encoder
and decoder for a summarization model as was shown in: `),Ae=s("a"),In=n("Text Summarization with Pretrained Encoders"),Ln=n(" by Yang Liu and Mirella Lapata."),Zt=h(),V=s("p"),Bn=n("The "),pt=s("code"),On=n("from_pretrained()"),Vn=n(` currently doesn\u2019t support initializing the model from a
pytorch checkpoint. Passing `),ht=s("code"),Wn=n("from_pt=True"),Rn=n(` to this method will throw an exception. If there are only pytorch
checkpoints for a particular encoder-decoder model, a workaround is:`),Kt=h(),y(Ce.$$.fragment),Qt=h(),W=s("p"),Gn=n("This model was contributed by "),Se=s("a"),Un=n("thomwolf"),Hn=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Ne=s("a"),Yn=n("ydshieh"),Jn=n("."),Xt=h(),J=s("h2"),pe=s("a"),mt=s("span"),y(Ie.$$.fragment),Zn=h(),ft=s("span"),Kn=n("EncoderDecoderConfig"),en=h(),P=s("div"),y(Le.$$.fragment),Qn=h(),he=s("p"),zo=s("a"),Xn=n("EncoderDecoderConfig"),er=n(" is the configuration class to store the configuration of a "),qo=s("a"),or=n("EncoderDecoderModel"),tr=n(`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),nr=h(),Z=s("p"),rr=n("Configuration objects inherit from "),jo=s("a"),ar=n("PretrainedConfig"),sr=n(` and can be used to control the model outputs. Read the
documentation from `),Fo=s("a"),dr=n("PretrainedConfig"),ir=n(" for more information."),cr=h(),y(me.$$.fragment),lr=h(),fe=s("div"),y(Be.$$.fragment),pr=h(),Oe=s("p"),hr=n("Instantiate a "),Po=s("a"),mr=n("EncoderDecoderConfig"),fr=n(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),ur=h(),ue=s("div"),y(Ve.$$.fragment),gr=h(),K=s("p"),_r=n("Serializes this instance to a Python dictionary. Override the default "),ut=s("em"),br=n("to_dict()"),vr=n(" from "),gt=s("em"),yr=n("PretrainedConfig"),kr=n("."),on=h(),Q=s("h2"),ge=s("a"),_t=s("span"),y(We.$$.fragment),Tr=h(),bt=s("span"),wr=n("EncoderDecoderModel"),tn=h(),x=s("div"),y(Re.$$.fragment),Er=h(),X=s("p"),$r=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
generative task, like summarization.`),qr=h(),Ge=s("p"),jr=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Ar=h(),vt=s("p"),Cr=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Sr=h(),He=s("p"),Nr=n("This model inherits from "),So=s("a"),Ir=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Br=h(),Ye=s("p"),Or=n("This model is also a PyTorch "),Je=s("a"),Vr=n("torch.nn.Module"),Wr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr=h(),R=s("p"),No=s("a"),Gr=n("EncoderDecoderModel"),Ur=n(` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),yt=s("em"),Hr=n("~transformers.AutoModel.from_pretrained"),Yr=n(` class method for the encoder and
:meth`),kt=s("em"),Jr=n("~transformers.AutoModelForCausalLM.from_pretrained"),Zr=n(" class method for the decoder."),Kr=h(),C=s("div"),y(Ze.$$.fragment),Qr=h(),ee=s("p"),Xr=n("The "),Io=s("a"),ea=n("EncoderDecoderModel"),oa=n(" forward method, overrides the "),Tt=s("code"),ta=n("__call__"),na=n(" special method."),ra=h(),y(_e.$$.fragment),aa=h(),y(be.$$.fragment),sa=h(),S=s("div"),y(Ke.$$.fragment),da=h(),wt=s("p"),ia=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ca=h(),oe=s("p"),la=n("The model is set in evaluation mode by default using "),Et=s("code"),pa=n("model.eval()"),ha=n(` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),$t=s("code"),ma=n("model.train()"),fa=n("."),ua=h(),y(ve.$$.fragment),nn=h(),te=s("h2"),ye=s("a"),xt=s("span"),y(Qe.$$.fragment),ga=h(),Mt=s("span"),_a=n("TFEncoderDecoderModel"),rn=h(),M=s("div"),y(Xe.$$.fragment),ba=h(),ne=s("p"),va=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Lo=s("a"),ya=n("from_pretrained()"),ka=n(" function and the decoder is loaded via "),Bo=s("a"),Ta=n("from_pretrained()"),wa=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Ea=h(),eo=s("p"),$a=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Da=h(),Dt=s("p"),za=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),qa=h(),to=s("p"),ja=n("This model inherits from "),Oo=s("a"),Fa=n("TFPreTrainedModel"),Pa=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Aa=h(),no=s("p"),Ca=n("This model is also a "),ro=s("a"),Sa=n("tf.keras.Model"),Na=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ia=h(),G=s("p"),Vo=s("a"),La=n("TFEncoderDecoderModel"),Ba=n(` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
`),Wo=s("a"),Oa=n("from_pretrained()"),Va=n(" class method for the encoder and "),Ro=s("a"),Wa=n("from_pretrained()"),Ra=n(` class
method for the decoder.`),Ga=h(),N=s("div"),y(ao.$$.fragment),Ua=h(),re=s("p"),Ha=n("The "),Go=s("a"),Ya=n("TFEncoderDecoderModel"),Ja=n(" forward method, overrides the "),zt=s("code"),Za=n("__call__"),Ka=n(" special method."),Qa=h(),y(ke.$$.fragment),Xa=h(),y(Te.$$.fragment),es=h(),U=s("div"),y(so.$$.fragment),os=h(),qt=s("p"),ts=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ns=h(),y(we.$$.fragment),an=h(),ae=s("h2"),Ee=s("a"),jt=s("span"),y(io.$$.fragment),rs=h(),Ft=s("span"),as=n("FlaxEncoderDecoderModel"),sn=h(),D=s("div"),y(co.$$.fragment),ss=h(),se=s("p"),ds=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Uo=s("a"),is=n("from_pretrained()"),cs=n(" function and the decoder is loaded via "),Ho=s("a"),ls=n("from_pretrained()"),ps=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),hs=h(),lo=s("p"),ms=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),gs=h(),Pt=s("p"),_s=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),bs=h(),ho=s("p"),vs=n("This model inherits from "),Yo=s("a"),ys=n("FlaxPreTrainedModel"),ks=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ts=h(),mo=s("p"),ws=n(`This model is also a Flax Linen
`),fo=s("a"),Es=n("flax.nn.Module"),$s=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xs=h(),H=s("p"),Jo=s("a"),Ms=n("FlaxEncoderDecoderModel"),Ds=n(` is a generic model class that will be instantiated as a transformer architecture with
...
encoder and :meth`),Ct=s("em"),js=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Fs=n(" class method for the decoder."),Ps=h(),I=s("div"),y(uo.$$.fragment),As=h(),de=s("p"),Cs=n("The "),Zo=s("a"),Ss=n("FlaxEncoderDecoderModel"),Ns=n(" forward method, overrides the "),St=s("code"),Is=n("__call__"),Ls=n(" special method."),Bs=h(),y($e.$$.fragment),Os=h(),y(xe.$$.fragment),Vs=h(),Y=s("div"),y(go.$$.fragment),Ws=h(),Nt=s("p"),Rs=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Gs=h(),y(Me.$$.fragment),this.h()},l(t){const g=ai('[data-svelte="svelte-1phssyn"]',document.head);c=d(g,"META",{name:!0,content:!0}),g.forEach(o),v=m(t),u=d(t,"H1",{class:!0});var _o=i(u);p=d(_o,"A",{id:!0,class:!0,href:!0});var It=i(p);_=d(It,"SPAN",{});var Lt=i(_);k(a.$$.fragment,Lt),Lt.forEach(o),It.forEach(o),f=m(_o),A=d(_o,"SPAN",{});var Bt=i(A);$n=r(Bt,"Encoder Decoder Models"),Bt.forEach(o),_o.forEach(o),Ut=m(t),ie=d(t,"P",{});var bo=i(ie);xn=r(bo,"The "),xo=d(bo,"A",{href:!0});var Ot=i(xo);Mn=r(Ot,"EncoderDecoderModel"),Ot.forEach(o),Dn=r(bo,` can be used to initialize a sequence-to-sequence model with any
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),bo.forEach(o),Ht=m(t),ce=d(t,"P",{});var vo=i(ce);zn=r(vo,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
...
Sascha Rothe, Shashi Narayan, Aliaksei Severyn.`),vo.forEach(o),Yt=m(t),le=d(t,"P",{});var yo=i(le);Fn=r(yo,"After such an "),Mo=d(yo,"A",{href:!0});var Wt=i(Mo);Pn=r(Wt,"EncoderDecoderModel"),Wt.forEach(o),An=r(yo,` has been trained/fine-tuned, it can be saved/loaded just like
any other models (see the examples for more information).`),yo.forEach(o),Jt=m(t),O=d(t,"P",{});var Ko=i(O);Cn=r(Ko,"An application of this architecture could be to leverage two pretrained "),Do=d(Ko,"A",{href:!0});var Hs=i(Do);Sn=r(Hs,"BertModel"),Hs.forEach(o),Nn=r(Ko,` as the encoder
and decoder for a summarization model as was shown in: `),Ae=d(Ko,"A",{href:!0,rel:!0});var Ys=i(Ae);In=r(Ys,"Text Summarization with Pretrained Encoders"),Ys.forEach(o),Ln=r(Ko," by Yang Liu and Mirella Lapata."),Ko.forEach(o),Zt=m(t),V=d(t,"P",{});var Qo=i(V);Bn=r(Qo,"The "),pt=d(Qo,"CODE",{});var Js=i(pt);On=r(Js,"from_pretrained()"),Js.forEach(o),Vn=r(Qo,` currently doesn\u2019t support initializing the model from a
pytorch checkpoint. Passing `),ht=d(Qo,"CODE",{});var Zs=i(ht);Wn=r(Zs,"from_pt=True"),Zs.forEach(o),Rn=r(Qo,` to this method will throw an exception. If there are only pytorch
checkpoints for a particular encoder-decoder model, a workaround is:`),Qo.forEach(o),Kt=m(t),k(Ce.$$.fragment,t),Qt=m(t),W=d(t,"P",{});var Xo=i(W);Gn=r(Xo,"This model was contributed by "),Se=d(Xo,"A",{href:!0,rel:!0});var Ks=i(Se);Un=r(Ks,"thomwolf"),Ks.forEach(o),Hn=r(Xo,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Ne=d(Xo,"A",{href:!0,rel:!0});var Qs=i(Ne);Yn=r(Qs,"ydshieh"),Qs.forEach(o),Jn=r(Xo,"."),Xo.forEach(o),Xt=m(t),J=d(t,"H2",{class:!0});var cn=i(J);pe=d(cn,"A",{id:!0,class:!0,href:!0});var Xs=i(pe);mt=d(Xs,"SPAN",{});var ed=i(mt);k(Ie.$$.fragment,ed),ed.forEach(o),Xs.forEach(o),Zn=m(cn),ft=d(cn,"SPAN",{});var od=i(ft);Kn=r(od,"EncoderDecoderConfig"),od.forEach(o),cn.forEach(o),en=m(t),P=d(t,"DIV",{class:!0});var L=i(P);k(Le.$$.fragment,L),Qn=m(L),he=d(L,"P",{});var Rt=i(he);zo=d(Rt,"A",{href:!0});var td=i(zo);Xn=r(td,"EncoderDecoderConfig"),td.forEach(o),er=r(Rt," is the configuration class to store the configuration of a "),qo=d(Rt,"A",{href:!0});var nd=i(qo);or=r(nd,"EncoderDecoderModel"),nd.forEach(o),tr=r(Rt,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Rt.forEach(o),nr=m(L),Z=d(L,"P",{});var et=i(Z);rr=r(et,"Configuration objects inherit from "),jo=d(et,"A",{href:!0});var rd=i(jo);ar=r(rd,"PretrainedConfig"),rd.forEach(o),sr=r(et,` and can be used to control the model outputs. Read the
documentation from `),Fo=d(et,"A",{href:!0});var ad=i(Fo);dr=r(ad,"PretrainedConfig"),ad.forEach(o),ir=r(et," for more information."),et.forEach(o),cr=m(L),k(me.$$.fragment,L),lr=m(L),fe=d(L,"DIV",{class:!0});var ln=i(fe);k(Be.$$.fragment,ln),pr=m(ln),Oe=d(ln,"P",{});var pn=i(Oe);hr=r(pn,"Instantiate a "),Po=d(pn,"A",{href:!0});var sd=i(Po);mr=r(sd,"EncoderDecoderConfig"),sd.forEach(o),fr=r(pn,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),pn.forEach(o),ln.forEach(o),ur=m(L),ue=d(L,"DIV",{class:!0});var hn=i(ue);k(Ve.$$.fragment,hn),gr=m(hn),K=d(hn,"P",{});var ot=i(K);_r=r(ot,"Serializes this instance to a Python dictionary. Override the default "),ut=d(ot,"EM",{});var dd=i(ut);br=r(dd,"to_dict()"),dd.forEach(o),vr=r(ot," from "),gt=d(ot,"EM",{});var id=i(gt);yr=r(id,"PretrainedConfig"),id.forEach(o),kr=r(ot,"."),ot.forEach(o),hn.forEach(o),L.forEach(o),on=m(t),Q=d(t,"H2",{class:!0});var mn=i(Q);ge=d(mn,"A",{id:!0,class:!0,href:!0});var cd=i(ge);_t=d(cd,"SPAN",{});var ld=i(_t);k(We.$$.fragment,ld),ld.forEach(o),cd.forEach(o),Tr=m(mn),bt=d(mn,"SPAN",{});var pd=i(bt);wr=r(pd,"EncoderDecoderModel"),pd.forEach(o),mn.forEach(o),tn=m(t),x=d(t,"DIV",{class:!0});var q=i(x);k(Re.$$.fragment,q),Er=m(q),X=d(q,"P",{});var tt=i(X);$r=r(tt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Ao=d(tt,"A",{href:!0});var hd=i(Ao);xr=r(hd,"from_pretrained()"),hd.forEach(o),Mr=r(tt," function and the decoder is loaded via "),Co=d(tt,"A",{href:!0});var md=i(Co);Dr=r(md,"from_pretrained()"),md.forEach(o),zr=r(tt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),tt.forEach(o),qr=m(q),Ge=d(q,"P",{});var fn=i(Ge);jr=r(fn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),fn.forEach(o),Ar=m(q),vt=d(q,"P",{});var ud=i(vt);Cr=r(ud,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),ud.forEach(o),Sr=m(q),He=d(q,"P",{});var un=i(He);Nr=r(un,"This model inherits from "),So=d(un,"A",{href:!0});var gd=i(So);Ir=r(gd,"PreTrainedModel"),gd.forEach(o),Lr=r(un,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),un.forEach(o),Br=m(q),Ye=d(q,"P",{});var gn=i(Ye);Or=r(gn,"This model is also a PyTorch "),Je=d(gn,"A",{href:!0,rel:!0});var _d=i(Je);Vr=r(_d,"torch.nn.Module"),_d.forEach(o),Wr=r(gn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gn.forEach(o),Rr=m(q),R=d(q,"P",{});var ko=i(R);No=d(ko,"A",{href:!0});var bd=i(No);Gr=r(bd,"EncoderDecoderModel"),bd.forEach(o),Ur=r(ko,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),kt=d(ko,"EM",{});var yd=i(kt);Jr=r(yd,"~transformers.AutoModelForCausalLM.from_pretrained"),yd.forEach(o),Zr=r(ko," class method for the decoder."),ko.forEach(o),Kr=m(q),C=d(q,"DIV",{class:!0});var De=i(C);k(Ze.$$.fragment,De),Qr=m(De),ee=d(De,"P",{});var nt=i(ee);Xr=r(nt,"The "),Io=d(nt,"A",{href:!0});var kd=i(Io);ea=r(kd,"EncoderDecoderModel"),kd.forEach(o),oa=r(nt," forward method, overrides the "),Tt=d(nt,"CODE",{});var Td=i(Tt);ta=r(Td,"__call__"),Td.forEach(o),na=r(nt," special method."),nt.forEach(o),ra=m(De),k(_e.$$.fragment,De),aa=m(De),k(be.$$.fragment,De),De.forEach(o),sa=m(q),S=d(q,"DIV",{class:!0});var ze=i(S);k(Ke.$$.fragment,ze),da=m(ze),wt=d(ze,"P",{});var wd=i(wt);ia=r(wd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),wd.forEach(o),ca=m(ze),oe=d(ze,"P",{});var rt=i(oe);la=r(rt,"The model is set in evaluation mode by default using "),Et=d(rt,"CODE",{});var Ed=i(Et);pa=r(Ed,"model.eval()"),Ed.forEach(o),ha=r(rt,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),$t=d(rt,"CODE",{});var $d=i($t);ma=r($d,"model.train()"),$d.forEach(o),fa=r(rt,"."),rt.forEach(o),ua=m(ze),k(ve.$$.fragment,ze),ze.forEach(o),q.forEach(o),nn=m(t),te=d(t,"H2",{class:!0});var _n=i(te);ye=d(_n,"A",{id:!0,class:!0,href:!0});var xd=i(ye);xt=d(xd,"SPAN",{});var Md=i(xt);k(Qe.$$.fragment,Md),Md.forEach(o),xd.forEach(o),ga=m(_n),Mt=d(_n,"SPAN",{});var Dd=i(Mt);_a=r(Dd,"TFEncoderDecoderModel"),Dd.forEach(o),_n.forEach(o),rn=m(t),M=d(t,"DIV",{class:!0});var j=i(M);k(Xe.$$.fragment,j),ba=m(j),ne=d(j,"P",{});var at=i(ne);va=r(at,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),at.forEach(o),Ea=m(j),eo=d(j,"P",{});var bn=i(eo);$a=r(bn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),bn.forEach(o),Da=m(j),Dt=d(j,"P",{});var Fd=i(Dt);za=r(Fd,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Fd.forEach(o),qa=m(j),to=d(j,"P",{});var vn=i(to);ja=r(vn,"This model inherits from "),Oo=d(vn,"A",{href:!0});var Pd=i(Oo);Fa=r(Pd,"TFPreTrainedModel"),Pd.forEach(o),Pa=r(vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vn.forEach(o),Aa=m(j),no=d(j,"P",{});var yn=i(no);Ca=r(yn,"This model is also a "),ro=d(yn,"A",{href:!0,rel:!0});var Ad=i(ro);Sa=r(Ad,"tf.keras.Model"),Ad.forEach(o),Na=r(yn,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yn.forEach(o),Ia=m(j),G=d(j,"P",{});var To=i(G);Vo=d(To,"A",{href:!0});var Cd=i(Vo);La=r(Cd,"TFEncoderDecoderModel"),Cd.forEach(o),Ba=r(To,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),To.forEach(o),Ga=m(j),N=d(j,"DIV",{class:!0});var qe=i(N);k(ao.$$.fragment,qe),Ua=m(qe),re=d(qe,"P",{});var st=i(re);Ha=r(st,"The "),Go=d(st,"A",{href:!0});var Id=i(Go);Ya=r(Id,"TFEncoderDecoderModel"),Id.forEach(o),Ja=r(st," forward method, overrides the "),zt=d(st,"CODE",{});var Ld=i(zt);Za=r(Ld,"__call__"),Ld.forEach(o),Ka=r(st," special method."),st.forEach(o),Qa=m(qe),k(ke.$$.fragment,qe),Xa=m(qe),k(Te.$$.fragment,qe),qe.forEach(o),es=m(j),U=d(j,"DIV",{class:!0});var dt=i(U);k(so.$$.fragment,dt),os=m(dt),qt=d(dt,"P",{});var Bd=i(qt);ts=r(Bd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Bd.forEach(o),ns=m(dt),k(we.$$.fragment,dt),dt.forEach(o),j.forEach(o),an=m(t),ae=d(t,"H2",{class:!0});var kn=i(ae);Ee=d(kn,"A",{id:!0,class:!0,href:!0});var Od=i(Ee);jt=d(Od,"SPAN",{});var Vd=i(jt);k(io.$$.fragment,Vd),Vd.forEach(o),Od.forEach(o),rs=m(kn),Ft=d(kn,"SPAN",{});var Wd=i(Ft);as=r(Wd,"FlaxEncoderDecoderModel"),Wd.forEach(o),kn.forEach(o),sn=m(t),D=d(t,"DIV",{class:!0});var F=i(D);k(co.$$.fragment,F),ss=m(F),se=d(F,"P",{});var it=i(se);ds=r(it,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),it.forEach(o),hs=m(F),lo=d(F,"P",{});var Tn=i(lo);ms=r(Tn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Tn.forEach(o),gs=m(F),Pt=d(F,"P",{});var Hd=i(Pt);_s=r(Hd,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Hd.forEach(o),bs=m(F),ho=d(F,"P",{});var wn=i(ho);vs=r(wn,"This model inherits from "),Yo=d(wn,"A",{href:!0});var Yd=i(Yo);ys=r(Yd,"FlaxPreTrainedModel"),Yd.forEach(o),ks=r(wn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wn.forEach(o),Ts=m(F),mo=d(F,"P",{});var En=i(mo);ws=r(En,`This model is also a Flax Linen
`),fo=d(En,"A",{href:!0,rel:!0});var Jd=i(fo);Es=r(Jd,"flax.nn.Module"),Jd.forEach(o),$s=r(En,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),En.forEach(o),xs=m(F),H=d(F,"P",{});var wo=i(H);Jo=d(wo,"A",{href:!0});var Zd=i(Jo);Ms=r(Zd,"FlaxEncoderDecoderModel"),Zd.forEach(o),Ds=r(wo,` is a generic model class that will be instantiated as a transformer architecture with
the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one as
