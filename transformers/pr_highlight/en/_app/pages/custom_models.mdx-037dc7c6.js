import{S as Si,i as Bi,s as Hi,e as l,k as c,w as p,t as o,M as Wi,c as r,d as s,m as d,a as i,x as _,h as a,b as h,F as t,g as f,y as g,q as y,o as w,B as b,v as Li}from"../chunks/vendor-6b77c823.js";import{T as nr}from"../chunks/Tip-39098574.js";import{I as Nt}from"../chunks/IconCopyLink-7a11ce68.js";import{C as k}from"../chunks/CodeBlock-3a8b25a8.js";function zi(Z){let m,E;return{c(){m=l("p"),E=o("If your model is very similar to a model inside the library, you can re-use the same configuration as this model.")},l(u){m=r(u,"P",{});var v=i(m);E=a(v,"If your model is very similar to a model inside the library, you can re-use the same configuration as this model."),v.forEach(s)},m(u,v){f(u,m,v),t(m,E)},d(u){u&&s(m)}}}function Yi(Z){let m,E;return{c(){m=l("p"),E=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){m=r(u,"P",{});var v=i(m);E=a(v,"This API is experimental and may have some slight breaking changes in the next releases."),v.forEach(s)},m(u,v){f(u,m,v),t(m,E)},d(u){u&&s(m)}}}function Ui(Z){let m,E,u,v,Y;return{c(){m=l("p"),E=o(`If copying a modeling files from the library, you will need to replace all the relative imports at the top of the file
to import from the `),u=l("code"),v=o("transformers"),Y=o(" package.")},l(P){m=r(P,"P",{});var I=i(m);E=a(I,`If copying a modeling files from the library, you will need to replace all the relative imports at the top of the file
to import from the `),u=r(I,"CODE",{});var ee=i(u);v=a(ee,"transformers"),ee.forEach(s),Y=a(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,E),t(m,u),t(u,v),t(m,Y)},d(P){P&&s(m)}}}function Gi(Z){let m,E,u,v,Y,P,I,ee,sa,qs,Ge,oa,Is,Ke,aa,Ns,N,na,be,la,ra,Ve,ia,fa,xs,U,te,xt,ve,ca,Ot,da,Os,se,ha,Dt,ma,ua,Ds,Je,pa,Fs,$e,Ss,Qe,_a,Bs,x,ke,ga,Ft,ya,wa,ba,G,va,St,$a,ka,Bt,Ea,ja,Ca,K,Pa,Ht,Aa,Ta,Wt,Ma,Ra,Hs,O,qa,Lt,Ia,Na,zt,xa,Oa,Ws,D,Da,Yt,Fa,Sa,Ut,Ba,Ha,Ls,Xe,Wa,zs,Ee,Ys,A,La,Gt,za,Ya,Kt,Ua,Ga,Vt,Ka,Va,Us,je,Gs,F,Ja,Ze,Qa,Xa,et,Za,en,Ks,V,oe,Jt,Ce,tn,Qt,sn,Vs,S,on,tt,an,nn,Xt,ln,rn,Js,ae,fn,Zt,cn,dn,Qs,Pe,Xs,st,hn,Zs,Ae,eo,C,mn,es,un,pn,ts,_n,gn,ss,yn,wn,os,bn,vn,to,ne,so,B,$n,as,kn,En,ot,jn,Cn,oo,at,Pn,ao,Te,no,T,An,nt,Tn,Mn,lt,Rn,qn,rt,In,Nn,lo,it,xn,ro,Me,io,H,On,ft,Dn,Fn,ct,Sn,Bn,fo,J,le,ns,Re,Hn,ls,Wn,co,re,ho,$,Ln,rs,zn,Yn,is,Un,Gn,fs,Kn,Vn,cs,Jn,Qn,ds,Xn,Zn,hs,el,tl,ms,sl,ol,mo,qe,uo,W,al,us,nl,ll,ps,rl,il,po,ie,_o,dt,fl,go,ht,cl,yo,Ie,wo,fe,dl,_s,hl,ml,bo,Ne,vo,ce,ul,mt,pl,_l,$o,ut,gl,ko,xe,Eo,pt,yl,jo,Oe,Co,_t,wl,Po,De,Ao,gt,bl,To,Fe,Mo,M,vl,gs,$l,kl,ys,El,jl,Se,Cl,Pl,Ro,de,Al,yt,Tl,Ml,qo,Q,he,ws,Be,Rl,bs,ql,Io,R,Il,vs,Nl,xl,He,Ol,Dl,$s,Fl,Sl,No,We,xo,me,Bl,ks,Hl,Wl,Oo,Le,Do,wt,Ll,Fo,X,ue,Es,ze,zl,js,Yl,So,bt,Ul,Bo,L,Gl,Cs,Kl,Vl,Ps,Jl,Ql,Ho,Ye,Wo,q,Xl,vt,Zl,er,As,tr,sr,Ts,or,ar,Lo;return P=new Nt({}),ve=new Nt({}),$e=new k({props:{code:`from transformers import PretrainedConfig
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">ResnetModel</span>(<span class="hljs-title class_ inherited__">PreTrainedModel</span>):
    ...
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, tensor, labels=<span class="hljs-literal">None</span></span>):
        ...
        <span class="hljs-keyword">return</span> {<span class="hljs-string">&quot;logits&quot;</span>: logits}`}}),ne=new nr({props:{$$slots:{default:[zi]},$$scope:{ctx:Z}}}),Te=new k({props:{code:"resnet50d = ResnetModelForImageClassification(resnet50d_config)",highlighted:"resnet50d = ResnetModelForImageClassification(resnet50d_config)"}}),Me=new k({props:{code:`import timm
...
resnet50d.model.load_state_dict(pretrained_model.state_dict())`}}),Re=new Nt({}),re=new nr({props:{warning:!0,$$slots:{default:[Yi]},$$scope:{ctx:Z}}}),qe=new k({props:{code:`.
\u2514\u2500\u2500 resnet_model
    \u251C\u2500\u2500 __init__.py
...
AutoModel.register(ResnetConfig, ResnetModel)
AutoModelForImageClassification.register(ResnetConfig, ResnetModelForImageClassification)`}}),{c(){m=l("meta"),E=c(),u=l("h1"),v=l("a"),Y=l("span"),p(P.$$.fragment),I=c(),ee=l("span"),sa=o("Sharing custom models"),qs=c(),Ge=l("p"),oa=o(`The \u{1F917} Transformers library is designed to be easily extensible. Every model is fully coded in a given subfolder
...
superclass.`),Ws=c(),D=l("p"),Da=o("Defining a "),Yt=l("code"),Fa=o("model_type"),Sa=o(" for your configuration (here "),Ut=l("code"),Ba=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
library. Here is how we can create a resnet50d config and save it:`),zs=c(),p(Ee.$$.fragment),Ys=c(),A=l("p"),La=o("This will save a file named "),Gt=l("code"),za=o("config.json"),Ya=o(" inside the folder "),Kt=l("code"),Ua=o("custom-resnet"),Ga=o(`. You can then reload your config with the
...
directly upload your config to the Hub.`),Ks=c(),V=l("h2"),oe=l("a"),Jt=l("span"),p(Ce.$$.fragment),tn=c(),Qt=l("span"),sn=o("Writing a custom model"),Vs=c(),S=l("p"),on=o(`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
easy to transfer those weights:`),ro=c(),p(Me.$$.fragment),io=c(),H=l("p"),On=o("Now let\u2019s see how to make sure that when we do "),ft=l("a"),Dn=o("save_pretrained()"),Fn=o(" or "),ct=l("a"),Sn=o("push_to_hub()"),Bn=o(`, the
code of the model is saved.`),fo=c(),J=l("h2"),le=l("a"),ns=l("span"),p(Re.$$.fragment),Hn=c(),ls=l("span"),Wn=o("Sending the code to the Hub"),co=c(),p(re.$$.fragment),ho=c(),$=l("p"),Ln=o("First, make sure your model is fully defined in a "),rs=l("code"),zn=o(".py"),Yn=o(` file. It can rely on relative imports to some other files as
...
in this `),Se=l("a"),Cl=o("model repo"),Pl=o("."),Ro=c(),de=l("p"),Al=o("See the "),yt=l("a"),Tl=o("sharing tutorial"),Ml=o(" for more information on the push to Hub method."),qo=c(),Q=l("h2"),he=l("a"),ws=l("span"),p(Be.$$.fragment),Rl=c(),bs=l("span"),ql=o("Using a model with custom code"),Io=c(),R=l("p"),Il=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
hash of any commit.`),Fo=c(),X=l("h2"),ue=l("a"),Es=l("span"),p(ze.$$.fragment),zl=c(),js=l("span"),Yl=o("Registering a model with custom code to the auto classes"),So=c(),bt=l("p"),Ul=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
`),be=r($t,"A",{href:!0,rel:!0});var fr=i(be);la=a(fr,"timm library"),fr.forEach(s),ra=a($t," into a "),Ve=r($t,"A",{href:!0});var cr=i(Ve);ia=a(cr,"PreTrainedModel"),cr.forEach(s),fa=a($t,"."),$t.forEach(s),xs=d(e),U=r(e,"H2",{class:!0});var zo=i(U);te=r(zo,"A",{id:!0,class:!0,href:!0});var dr=i(te);xt=r(dr,"SPAN",{});var hr=i(xt);_(ve.$$.fragment,hr),hr.forEach(s),dr.forEach(s),ca=d(zo),Ot=r(zo,"SPAN",{});var mr=i(Ot);da=a(mr,"Writing a custom configuration"),mr.forEach(s),zo.forEach(s),Os=d(e),se=r(e,"P",{});var Yo=i(se);ha=a(Yo,`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
will contain all the necessary information to build the model. As we will see in the next section, the model can only
take a `),Dt=r(Yo,"CODE",{});var ur=i(Dt);ma=a(ur,"config"),ur.forEach(s),ua=a(Yo," to be initialized, so we really need that object to be as complete as possible."),Yo.forEach(s),Ds=d(e),Je=r(e,"P",{});var pr=i(Je);pa=a(pr,`In our example, we will take a couple of arguments of the ResNet class that we might want to tweak. Different
configurations will then give us the different types of ResNets that are possible. We then just store those arguments,
after checking the validity of a few of them.`),pr.forEach(s),Fs=d(e),_($e.$$.fragment,e),Ss=d(e),Qe=r(e,"P",{});var _r=i(Qe);_a=a(_r,"The three important things to remember when writing you own configuration are the following:"),_r.forEach(s),Bs=d(e),x=r(e,"UL",{});var kt=i(x);ke=r(kt,"LI",{});var Uo=i(ke);ga=a(Uo,"you have to inherit from "),Ft=r(Uo,"CODE",{});var gr=i(Ft);ya=a(gr,"PretrainedConfig"),gr.forEach(s),wa=a(Uo,","),Uo.forEach(s),ba=d(kt),G=r(kt,"LI",{});var Et=i(G);va=a(Et,"the "),St=r(Et,"CODE",{});var yr=i(St);$a=a(yr,"__init__"),yr.forEach(s),ka=a(Et," of your "),Bt=r(Et,"CODE",{});var wr=i(Bt);Ea=a(wr,"PretrainedConfig"),wr.forEach(s),ja=a(Et," must accept any kwargs,"),Et.forEach(s),Ca=d(kt),K=r(kt,"LI",{});var jt=i(K);Pa=a(jt,"those "),Ht=r(jt,"CODE",{});var br=i(Ht);Aa=a(br,"kwargs"),br.forEach(s),Ta=a(jt," need to be passed to the superclass "),Wt=r(jt,"CODE",{});var vr=i(Wt);Ma=a(vr,"__init__"),vr.forEach(s),Ra=a(jt,"."),jt.forEach(s),kt.forEach(s),Hs=d(e),O=r(e,"P",{});var Ct=i(O);qa=a(Ct,`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
config with the `),zt=r(Ct,"CODE",{});var kr=i(zt);xa=a(kr,"from_pretrained"),kr.forEach(s),Oa=a(Ct,` method, those fields need to be accepted by your config and then sent to the
superclass.`),Ct.forEach(s),Ws=d(e),D=r(e,"P",{});var Pt=i(D);Da=a(Pt,"Defining a "),Yt=r(Pt,"CODE",{});var Er=i(Yt);Fa=a(Er,"model_type"),Er.forEach(s),Sa=a(Pt," for your configuration (here "),Ut=r(Pt,"CODE",{});var jr=i(Ut);Ba=a(jr,'model_type="resnet"'),jr.forEach(s),Ha=a(Pt,`) is not mandatory, unless you want to
...
thing we need to do before writing this class is a map between the block types and actual block classes. Then the
model is defined from the configuration by passing everything to the `),Zt=r(Ko,"CODE",{});var Dr=i(Zt);cn=a(Dr,"ResNet"),Dr.forEach(s),dn=a(Ko," class:"),Ko.forEach(s),Qs=d(e),_(Pe.$$.fragment,e),Xs=d(e),st=r(e,"P",{});var Fr=i(st);hn=a(Fr,"For the model that will classify images, we just change the forward method:"),Fr.forEach(s),Zs=d(e),_(Ae.$$.fragment,e),eo=d(e),C=r(e,"P",{});var z=i(C);mn=a(z,"In both cases, notice how we inherit from "),es=r(z,"CODE",{});var Sr=i(es);un=a(Sr,"PreTrainedModel"),Sr.forEach(s),pn=a(z," and call the superclass initialization with the "),ts=r(z,"CODE",{});var Br=i(ts);_n=a(Br,"config"),Br.forEach(s),gn=a(z,`
(a bit like when you write a regular `),ss=r(z,"CODE",{});var Hr=i(ss);yn=a(Hr,"torch.nn.Module"),Hr.forEach(s),wn=a(z,"). The line that sets the "),os=r(z,"CODE",{});var Wr=i(os);bn=a(Wr,"config_class"),Wr.forEach(s),vn=a(z,` is not mandatory, unless
you want to register your model with the auto classes (see last section).`),z.forEach(s),to=d(e),_(ne.$$.fragment,e),so=d(e),B=r(e,"P",{});var Mt=i(B);$n=a(Mt,`You can have your model return anything you want, but returning a dictionary like we did for
...
usable inside the `),ot=r(Mt,"A",{href:!0});var zr=i(ot);jn=a(zr,"Trainer"),zr.forEach(s),Cn=a(Mt,` class. Using another output format is fine as long as you are planning on using your own
training loop or another library for training.`),Mt.forEach(s),oo=d(e),at=r(e,"P",{});var Yr=i(at);Pn=a(Yr,"Now that we have our model class, let\u2019s create one:"),Yr.forEach(s),ao=d(e),_(Te.$$.fragment,e),no=d(e),T=r(e,"P",{});var _e=i(T);An=a(_e,"Again, you can use any of the methods of "),nt=r(_e,"A",{href:!0});var Ur=i(nt);Tn=a(Ur,"PreTrainedModel"),Ur.forEach(s),Mn=a(_e,", like "),lt=r(_e,"A",{href:!0});var Gr=i(lt);Rn=a(Gr,"save_pretrained()"),Gr.forEach(s),qn=a(_e,` or
