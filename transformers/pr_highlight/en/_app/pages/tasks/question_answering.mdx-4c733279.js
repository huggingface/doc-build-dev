import{S as za,i as Ca,s as Pa,e as l,k as _,w as b,t as r,M as Fa,c as i,d as e,m as g,a as p,x as q,h as o,b as w,F as t,g as c,y,q as E,o as A,B as T,v as Sa,L as Da}from"../../chunks/vendor-6b77c823.js";import{T as Wt}from"../../chunks/Tip-39098574.js";import{Y as Aa}from"../../chunks/Youtube-5c6e11e6.js";import{I as Kt}from"../../chunks/IconCopyLink-7a11ce68.js";import{C as ls}from"../../chunks/CodeBlock-3a8b25a8.js";import{F as Ta,M as Xt}from"../../chunks/Markdown-9acf6d91.js";function Ma(F){let a,u,n,d,j;return{c(){a=l("p"),u=r("See the question answering "),n=l("a"),d=r("task page"),j=r(" for more information about other forms of question answering and their associated models, datasets, and metrics."),this.h()},l($){a=i($,"P",{});var x=p(a);u=o(x,"See the question answering "),n=i(x,"A",{href:!0,rel:!0});var z=p(n);d=o(z,"task page"),z.forEach(e),j=o(x," for more information about other forms of question answering and their associated models, datasets, and metrics."),x.forEach(e),this.h()},h(){w(n,"href","https://huggingface.co/tasks/question-answering"),w(n,"rel","nofollow")},m($,x){c($,a,x),t(a,u),t(a,n),t(n,d),t(a,j)},d($){$&&e(a)}}}function La(F){let a,u;return a=new ls({props:{code:`from transformers import DefaultDataCollator
...
<span class="hljs-meta">&gt;&gt;&gt; </span>trainer.train()`}}),{c(){a=l("p"),u=r("Load DistilBERT with "),n=l("a"),d=r("AutoModelForQuestionAnswering"),j=r(":"),$=_(),b(x.$$.fragment),z=_(),b(C.$$.fragment),k=_(),S=l("p"),N=r("At this point, only three steps remain:"),X=_(),M=l("ol"),V=l("li"),L=r("Define your training hyperparameters in "),Y=l("a"),ts=r("TrainingArguments"),ms=r("."),es=_(),I=l("li"),is=r("Pass the training arguments to "),P=l("a"),ds=r("Trainer"),R=r(" along with the model, dataset, tokenizer, and data collator."),_s=_(),ss=l("li"),Z=r("Call "),U=l("a"),cs=r("train()"),J=r(" to fine-tune your model."),G=_(),b(O.$$.fragment),this.h()},l(m){a=i(m,"P",{});var D=p(a);u=o(D,"Load DistilBERT with "),n=i(D,"A",{href:!0});var H=p(n);d=o(H,"AutoModelForQuestionAnswering"),H.forEach(e),j=o(D,":"),D.forEach(e),$=g(m),q(x.$$.fragment,m),z=g(m),q(C.$$.fragment,m),k=g(m),S=i(m,"P",{});var as=p(S);N=o(as,"At this point, only three steps remain:"),as.forEach(e),X=g(m),M=i(m,"OL",{});var K=p(M);V=i(K,"LI",{});var W=p(V);L=o(W,"Define your training hyperparameters in "),Y=i(W,"A",{href:!0});var gs=p(Y);ts=o(gs,"TrainingArguments"),gs.forEach(e),ms=o(W,"."),W.forEach(e),es=g(K),I=i(K,"LI",{});var B=p(I);is=o(B,"Pass the training arguments to "),P=i(B,"A",{href:!0});var fs=p(P);ds=o(fs,"Trainer"),fs.forEach(e),R=o(B," along with the model, dataset, tokenizer, and data collator."),B.forEach(e),_s=g(K),ss=i(K,"LI",{});var ps=p(ss);Z=o(ps,"Call "),U=i(ps,"A",{href:!0});var ns=p(U);cs=o(ns,"train()"),ns.forEach(e),J=o(ps," to fine-tune your model."),ps.forEach(e),K.forEach(e),G=g(m),q(O.$$.fragment,m),this.h()},h(){w(n,"href","/docs/transformers/pr_highlight/en/model_doc/auto#transformers.AutoModelForQuestionAnswering"),w(Y,"href","/docs/transformers/pr_highlight/en/main_classes/trainer#transformers.TrainingArguments"),w(P,"href","/docs/transformers/pr_highlight/en/main_classes/trainer#transformers.Trainer"),w(U,"href","/docs/transformers/pr_highlight/en/main_classes/trainer#transformers.Trainer.train")},m(m,D){c(m,a,D),t(a,u),t(a,n),t(n,d),t(a,j),c(m,$,D),y(x,m,D),c(m,z,D),y(C,m,D),c(m,k,D),c(m,S,D),t(S,N),c(m,X,D),c(m,M,D),t(M,V),t(V,L),t(V,Y),t(Y,ts),t(V,ms),t(M,es),t(M,I),t(I,is),t(I,P),t(P,ds),t(I,R),t(M,_s),t(M,ss),t(ss,Z),t(ss,U),t(U,cs),t(ss,J),c(m,G,D),y(O,m,D),Q=!0},p(m,D){const H={};D&2&&(H.$$scope={dirty:D,ctx:m}),C.$set(H)},i(m){Q||(E(x.$$.fragment,m),E(C.$$.fragment,m),E(O.$$.fragment,m),Q=!0)},o(m){A(x.$$.fragment,m),A(C.$$.fragment,m),A(O.$$.fragment,m),Q=!1},d(m){m&&e(a),m&&e($),T(x,m),m&&e(z),T(C,m),m&&e(k),m&&e(S),m&&e(X),m&&e(M),m&&e(G),T(O,m)}}}function Ra(F){let a,u;return a=new Xt({props:{$$slots:{default:[Na]},$$scope:{ctx:F}}}),{c(){b(a.$$.fragment)},l(n){q(a.$$.fragment,n)},m(n,d){y(a,n,d),u=!0},p(n,d){const j={};d&2&&(j.$$scope={dirty:d,ctx:n}),a.$set(j)},i(n){u||(E(a.$$.fragment,n),u=!0)},o(n){A(a.$$.fragment,n),u=!1},d(n){T(a,n)}}}function Ua(F){let a,u,n,d,j;return{c(){a=l("p"),u=r("If you aren\u2019t familiar with fine-tuning a model with Keras, take a look at the basic tutorial "),n=l("a"),d=r("here"),j=r("!"),this.h()},l($){a=i($,"P",{});var x=p(a);u=o(x,"If you aren\u2019t familiar with fine-tuning a model with Keras, take a look at the basic tutorial "),n=i(x,"A",{href:!0});var z=p(n);d=o(z,"here"),z.forEach(e),j=o(x,"!"),x.forEach(e),this.h()},h(){w(n,"href","training#finetune-with-keras")},m($,x){c($,a,x),t(a,u),t(a,n),t(n,d),t(a,j)},d($){$&&e(a)}}}function Ha(F){let a,u,n,d,j,$,x,z,C,k,S,N,X,M,V,L,Y,ts,ms,es,I,is,P,ds,R,_s,ss,Z,U,cs,J,G,O,Q,m,D,H,as,K,W,gs,B,fs,ps,ns,qs,rs,As;return M=new ls({props:{code:`tf_train_set = tokenized_squad["train"].to_tf_dataset(
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.<span class="hljs-built_in">compile</span>(optimizer=optimizer)`}}),rs=new ls({props:{code:"model.fit(x=tf_train_set, validation_data=tf_validation_set, epochs=3)",highlighted:'<span class="hljs-meta">&gt;&gt;&gt; </span>model.fit(x=tf_train_set, validation_data=tf_validation_set, epochs=<span class="hljs-number">3</span>)'}}),{c(){a=l("p"),u=r("To fine-tune a model in TensorFlow, start by converting your datasets to the "),n=l("code"),d=r("tf.data.Dataset"),j=r(" format with "),$=l("a"),x=l("code"),z=r("to_tf_dataset"),C=r(". Specify inputs and the start and end positions of an answer in "),k=l("code"),S=r("columns"),N=r(", whether to shuffle the dataset order, batch size, and the data collator:"),X=_(),b(M.$$.fragment),V=_(),b(L.$$.fragment),Y=_(),ts=l("p"),ms=r("Set up an optimizer function, learning rate schedule, and some training hyperparameters:"),es=_(),b(I.$$.fragment),is=_(),P=l("p"),ds=r("Load DistilBERT with "),R=l("a"),_s=r("TFAutoModelForQuestionAnswering"),ss=r(":"),Z=_(),b(U.$$.fragment),cs=_(),J=l("p"),G=r("Configure the model for training with "),O=l("a"),Q=l("code"),m=r("compile"),D=r(":"),H=_(),b(as.$$.fragment),K=_(),W=l("p"),gs=r("Call "),B=l("a"),fs=l("code"),ps=r("fit"),ns=r(" to fine-tune the model:"),qs=_(),b(rs.$$.fragment),this.h()},l(h){a=i(h,"P",{});var v=p(a);u=o(v,"To fine-tune a model in TensorFlow, start by converting your datasets to the "),n=i(v,"CODE",{});var vs=p(n);d=o(vs,"tf.data.Dataset"),vs.forEach(e),j=o(v," format with "),$=i(v,"A",{href:!0,rel:!0});var hs=p($);x=i(hs,"CODE",{});var Xs=p(x);z=o(Xs,"to_tf_dataset"),Xs.forEach(e),hs.forEach(e),C=o(v,". Specify inputs and the start and end positions of an answer in "),k=i(v,"CODE",{});var Ts=p(k);S=o(Ts,"columns"),Ts.forEach(e),N=o(v,", whether to shuffle the dataset order, batch size, and the data collator:"),v.forEach(e),X=g(h),q(M.$$.fragment,h),V=g(h),q(L.$$.fragment,h),Y=g(h),ts=i(h,"P",{});var Zs=p(ts);ms=o(Zs,"Set up an optimizer function, learning rate schedule, and some training hyperparameters:"),Zs.forEach(e),es=g(h),q(I.$$.fragment,h),is=g(h),P=i(h,"P",{});var Ds=p(P);ds=o(Ds,"Load DistilBERT with "),R=i(Ds,"A",{href:!0});var zs=p(R);_s=o(zs,"TFAutoModelForQuestionAnswering"),zs.forEach(e),ss=o(Ds,":"),Ds.forEach(e),Z=g(h),q(U.$$.fragment,h),cs=g(h),J=i(h,"P",{});var Cs=p(J);G=o(Cs,"Configure the model for training with "),O=i(Cs,"A",{href:!0,rel:!0});var st=p(O);Q=i(st,"CODE",{});var Ns=p(Q);m=o(Ns,"compile"),Ns.forEach(e),st.forEach(e),D=o(Cs,":"),Cs.forEach(e),H=g(h),q(as.$$.fragment,h),K=g(h),W=i(h,"P",{});var os=p(W);gs=o(os,"Call "),B=i(os,"A",{href:!0,rel:!0});var $s=p(B);fs=i($s,"CODE",{});var Ps=p(fs);ps=o(Ps,"fit"),Ps.forEach(e),$s.forEach(e),ns=o(os," to fine-tune the model:"),os.forEach(e),qs=g(h),q(rs.$$.fragment,h),this.h()},h(){w($,"href","https://huggingface.co/docs/datasets/package_reference/main_classes.html#datasets.Dataset.to_tf_dataset"),w($,"rel","nofollow"),w(R,"href","/docs/transformers/pr_highlight/en/model_doc/auto#transformers.TFAutoModelForQuestionAnswering"),w(O,"href","https://keras.io/api/models/model_training_apis/#compile-method"),w(O,"rel","nofollow"),w(B,"href","https://keras.io/api/models/model_training_apis/#fit-method"),w(B,"rel","nofollow")},m(h,v){c(h,a,v),t(a,u),t(a,n),t(n,d),t(a,j),t(a,$),t($,x),t(x,z),t(a,C),t(a,k),t(k,S),t(a,N),c(h,X,v),y(M,h,v),c(h,V,v),y(L,h,v),c(h,Y,v),c(h,ts,v),t(ts,ms),c(h,es,v),y(I,h,v),c(h,is,v),c(h,P,v),t(P,ds),t(P,R),t(R,_s),t(P,ss),c(h,Z,v),y(U,h,v),c(h,cs,v),c(h,J,v),t(J,G),t(J,O),t(O,Q),t(Q,m),t(J,D),c(h,H,v),y(as,h,v),c(h,K,v),c(h,W,v),t(W,gs),t(W,B),t(B,fs),t(fs,ps),t(W,ns),c(h,qs,v),y(rs,h,v),As=!0},p(h,v){const vs={};v&2&&(vs.$$scope={dirty:v,ctx:h}),L.$set(vs)},i(h){As||(E(M.$$.fragment,h),E(L.$$.fragment,h),E(I.$$.fragment,h),E(U.$$.fragment,h),E(as.$$.fragment,h),E(rs.$$.fragment,h),As=!0)},o(h){A(M.$$.fragment,h),A(L.$$.fragment,h),A(I.$$.fragment,h),A(U.$$.fragment,h),A(as.$$.fragment,h),A(rs.$$.fragment,h),As=!1},d(h){h&&e(a),h&&e(X),T(M,h),h&&e(V),T(L,h),h&&e(Y),h&&e(ts),h&&e(es),T(I,h),h&&e(is),h&&e(P),h&&e(Z),T(U,h),h&&e(cs),h&&e(J),h&&e(H),T(as,h),h&&e(K),h&&e(W),h&&e(qs),T(rs,h)}}}function Va(F){let a,u;return a=new Xt({props:{$$slots:{default:[Ha]},$$scope:{ctx:F}}}),{c(){b(a.$$.fragment)},l(n){q(a.$$.fragment,n)},m(n,d){y(a,n,d),u=!0},p(n,d){const j={};d&2&&(j.$$scope={dirty:d,ctx:n}),a.$set(j)},i(n){u||(E(a.$$.fragment,n),u=!0)},o(n){A(a.$$.fragment,n),u=!1},d(n){T(a,n)}}}function Ya(F){let a,u,n,d,j,$,x,z;return{c(){a=l("p"),u=r(`For a more in-depth example of how to fine-tune a model for question answering, take a look at the corresponding
