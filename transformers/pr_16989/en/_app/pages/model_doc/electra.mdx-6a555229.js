import{S as P9,i as A9,s as O9,e as n,k as c,w as b,t as r,M as L9,c as s,d as t,m as p,a,x as y,h as i,b as f,F as e,g as k,y as E,q as w,o as $,B as F,v as N9,L as de}from"../../chunks/vendor-6b77c823.js";import{T as Ee}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-1088f2fb.js";import{C as ce}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as $e}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as le}from"../../chunks/ExampleCodeBlock-5212b321.js";function I9(x){let d,g,h,m,_;return m=new ce({props:{code:`from transformers import ElectraModel, ElectraConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){k(l,d,u),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function D9(x){let d,g,h,m,_;return m=new ce({props:{code:`from transformers import ElectraTokenizer, ElectraModel
import torch
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var M=a(h);m=i(M,"Module"),M.forEach(t),_=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){k(l,d,u),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function U9(x){let d,g,h,m,_;return m=new ce({props:{code:`from transformers import ElectraForPreTraining, ElectraTokenizerFast
import torch
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var M=a(h);m=i(M,"Module"),M.forEach(t),_=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){k(l,d,u),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function H9(x){let d,g,h,m,_;return m=new ce({props:{code:`from transformers import ElectraTokenizer, ElectraForCausalLM, ElectraConfig
import torch
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var M=a(h);m=i(M,"Module"),M.forEach(t),_=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){k(l,d,u),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function B9(x){let d,g,h,m,_;return m=new ce({props:{code:`from transformers import ElectraTokenizer, ElectraForMaskedLM
import torch
...
<span class="hljs-number">1.22</span>`}}),{c(){b(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){E(d,h,m),g=!0},p:de,i(h){g||(w(d.$$.fragment,h),g=!0)},o(h){$(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function K9(x){let d,g,h,m,_;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),_=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var M=a(h);m=i(M,"Module"),M.forEach(t),_=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){k(l,d,u),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function J9(x){let d,g,h,m,_;return m=new ce({props:{code:`import torch
...
<span class="hljs-number">0.06</span>`}}),{c(){b(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){E(d,h,m),g=!0},p:de,i(h){g||(w(d.$$.fragment,h),g=!0)},o(h){$(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function X9(x){let d,g,h,m,_;return m=new ce({props:{code:`import torch
from transformers import ElectraTokenizer, ElectraForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){b(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){E(d,h,m),g=!0},p:de,i(h){g||(w(d.$$.fragment,h),g=!0)},o(h){$(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function Z9(x){let d,g,h,m,_;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),_=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var M=a(h);m=i(M,"Module"),M.forEach(t),_=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16989/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
`}}),jn=new Ee({props:{$$slots:{default:[R9]},$$scope:{ctx:x}}}),qn=new le({props:{anchor:"transformers.ElectraForCausalLM.forward.example",$$slots:{default:[H9]},$$scope:{ctx:x}}}),or=new $e({}),nr=new I({props:{name:"class transformers.ElectraForMaskedLM",anchor:"transformers.ElectraForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
`}}),An=new Ee({props:{$$slots:{default:[Q9]},$$scope:{ctx:x}}}),On=new le({props:{anchor:"transformers.ElectraForMaskedLM.forward.example",$$slots:{default:[B9]},$$scope:{ctx:x}}}),Ln=new le({props:{anchor:"transformers.ElectraForMaskedLM.forward.example-2",$$slots:{default:[V9]},$$scope:{ctx:x}}}),lr=new $e({}),dr=new I({props:{name:"class transformers.ElectraForSequenceClassification",anchor:"transformers.ElectraForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
`}}),Hn=new Ee({props:{$$slots:{default:[Z9]},$$scope:{ctx:x}}}),Qn=new le({props:{anchor:"transformers.ElectraForMultipleChoice.forward.example",$$slots:{default:[ez]},$$scope:{ctx:x}}}),Tr=new $e({}),br=new I({props:{name:"class transformers.ElectraForTokenClassification",anchor:"transformers.ElectraForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16989/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16989/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16989/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16989/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16989/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16989/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16989/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16989/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16989/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16989/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16989/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16989/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16989/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16989/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16989/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16989/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16989/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16989/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16989/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16989/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16989/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),k_=p(no),Da=s(no,"P",{});var Gu=a(Da);v_=i(Gu,"This model is also a PyTorch "),Wa=s(Gu,"A",{href:!0,rel:!0});var sF=a(Wa);T_=i(sF,"torch.nn.Module"),sF.forEach(t),b_=i(Gu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
pooled output) e.g. for GLUE tasks.`),LF.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var df=a(cr);Yk=i(df,"This model inherits from "),ud=s(df,"A",{href:!0});var NF=a(ud);Zk=i(NF,"PreTrainedModel"),NF.forEach(t),ev=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),tv=p(ro),pr=s(ro,"P",{});var cf=a(pr);ov=i(cf,"This model is also a PyTorch "),hr=s(cf,"A",{href:!0,rel:!0});var IF=a(hr);nv=i(IF,"torch.nn.Module"),IF.forEach(t),sv=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),av=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),rv=p(pt),jo=s(pt,"P",{});var Vd=a(jo);iv=i(Vd,"The "),fd=s(Vd,"A",{href:!0});var SF=a(fd);lv=i(SF,"ElectraForSequenceClassification"),SF.forEach(t),dv=i(Vd," forward method, overrides the "),Qc=s(Vd,"CODE",{});var DF=a(Qc);cv=i(DF,"__call__"),DF.forEach(t),pv=i(Vd," special method."),Vd.forEach(t),hv=p(pt),y(In.$$.fragment,pt),mv=p(pt),y(Sn.$$.fragment,pt),uv=p(pt),y(Dn.$$.fragment,pt),fv=p(pt),y(Wn.$$.fragment,pt),gv=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),du=p(o),qo=s(o,"H2",{class:!0});var pf=a(qo);Rn=s(pf,"A",{id:!0,class:!0,href:!0});var WF=a(Rn);Bc=s(WF,"SPAN",{});var UF=a(Bc);y(ur.$$.fragment,UF),UF.forEach(t),WF.forEach(t),_v=p(pf),Vc=s(pf,"SPAN",{});var RF=a(Vc);kv=i(RF,"ElectraForMultipleChoice"),RF.forEach(t),pf.forEach(t),cu=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(fr.$$.fragment,io),vv=p(io),Kc=s(io,"P",{});var HF=a(Kc);Tv=i(HF,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),HF.forEach(t),bv=p(io),gr=s(io,"P",{});var hf=a(gr);yv=i(hf,"This model inherits from "),gd=s(hf,"A",{href:!0});var QF=a(gd);Ev=i(QF,"PreTrainedModel"),QF.forEach(t),wv=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),$v=p(io),_r=s(io,"P",{});var mf=a(_r);Fv=i(mf,"This model is also a PyTorch "),kr=s(mf,"A",{href:!0,rel:!0});var BF=a(kr);xv=i(BF,"torch.nn.Module"),BF.forEach(t),Mv=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mf.forEach(t),zv=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),Cv=p(sa),Po=s(sa,"P",{});var Kd=a(Po);jv=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var VF=a(_d);qv=i(VF,"ElectraForMultipleChoice"),VF.forEach(t),Pv=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var KF=a(Jc);Av=i(KF,"__call__"),KF.forEach(t),Ov=i(Kd," special method."),Kd.forEach(t),Lv=p(sa),y(Hn.$$.fragment,sa),Nv=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),pu=p(o),Ao=s(o,"H2",{class:!0});var uf=a(Ao);Bn=s(uf,"A",{id:!0,class:!0,href:!0});var JF=a(Bn);Gc=s(JF,"SPAN",{});var GF=a(Gc);y(Tr.$$.fragment,GF),GF.forEach(t),JF.forEach(t),Iv=p(uf),Xc=s(uf,"SPAN",{});var XF=a(Xc);Sv=i(XF,"ElectraForTokenClassification"),XF.forEach(t),uf.forEach(t),hu=p(o),Be=s(o,"DIV",{class:!0});var St=a(Be);y(br.$$.fragment,St),Dv=p(St),Yc=s(St,"P",{});var YF=a(Yc);Wv=i(YF,"Electra model with a token classification head on top."),YF.forEach(t),Uv=p(St),Zc=s(St,"P",{});var ZF=a(Zc);Rv=i(ZF,"Both the discriminator and generator may be loaded into this model."),ZF.forEach(t),Hv=p(St),yr=s(St,"P",{});var ff=a(yr);Qv=i(ff,"This model inherits from "),kd=s(ff,"A",{href:!0});var e0=a(kd);Bv=i(e0,"PreTrainedModel"),e0.forEach(t),Vv=i(ff,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ff.forEach(t),Kv=p(St),Er=s(St,"P",{});var gf=a(Er);Jv=i(gf,"This model is also a PyTorch "),wr=s(gf,"A",{href:!0,rel:!0});var t0=a(wr);Gv=i(t0,"torch.nn.Module"),t0.forEach(t),Xv=i(gf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gf.forEach(t),Yv=p(St),at=s(St,"DIV",{class:!0});var lo=a(at);y($r.$$.fragment,lo),Zv=p(lo),Oo=s(lo,"P",{});var Jd=a(Oo);eT=i(Jd,"The "),vd=s(Jd,"A",{href:!0});var o0=a(vd);tT=i(o0,"ElectraForTokenClassification"),o0.forEach(t),oT=i(Jd," forward method, overrides the "),ep=s(Jd,"CODE",{});var n0=a(ep);nT=i(n0,"__call__"),n0.forEach(t),sT=i(Jd," special method."),Jd.forEach(t),aT=p(lo),y(Vn.$$.fragment,lo),rT=p(lo),y(Kn.$$.fragment,lo),iT=p(lo),y(Jn.$$.fragment,lo),lo.forEach(t),St.forEach(t),mu=p(o),Lo=s(o,"H2",{class:!0});var _f=a(Lo);Gn=s(_f,"A",{id:!0,class:!0,href:!0});var s0=a(Gn);tp=s(s0,"SPAN",{});var a0=a(tp);y(Fr.$$.fragment,a0),a0.forEach(t),s0.forEach(t),lT=p(_f),op=s(_f,"SPAN",{});var r0=a(op);dT=i(r0,"ElectraForQuestionAnswering"),r0.forEach(t),_f.forEach(t),uu=p(o),nt=s(o,"DIV",{class:!0});var co=a(nt);y(xr.$$.fragment,co),cT=p(co),No=s(co,"P",{});var Gd=a(No);pT=i(Gd,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),np=s(Gd,"CODE",{});var i0=a(np);hT=i(i0,"span start logits"),i0.forEach(t),mT=i(Gd," and "),sp=s(Gd,"CODE",{});var l0=a(sp);uT=i(l0,"span end logits"),l0.forEach(t),fT=i(Gd,")."),Gd.forEach(t),gT=p(co),Mr=s(co,"P",{});var kf=a(Mr);_T=i(kf,"This model inherits from "),Td=s(kf,"A",{href:!0});var d0=a(Td);kT=i(d0,"PreTrainedModel"),d0.forEach(t),vT=i(kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kf.forEach(t),TT=p(co),zr=s(co,"P",{});var vf=a(zr);bT=i(vf,"This model is also a PyTorch "),Cr=s(vf,"A",{href:!0,rel:!0});var c0=a(Cr);yT=i(c0,"torch.nn.Module"),c0.forEach(t),ET=i(vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),wT=p(co),rt=s(co,"DIV",{class:!0});var po=a(rt);y(jr.$$.fragment,po),$T=p(po),Io=s(po,"P",{});var Xd=a(Io);FT=i(Xd,"The "),bd=s(Xd,"A",{href:!0});var p0=a(bd);xT=i(p0,"ElectraForQuestionAnswering"),p0.forEach(t),MT=i(Xd," forward method, overrides the "),ap=s(Xd,"CODE",{});var h0=a(ap);zT=i(h0,"__call__"),h0.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=p(po),y(Xn.$$.fragment,po),qT=p(po),y(Yn.$$.fragment,po),PT=p(po),y(Zn.$$.fragment,po),po.forEach(t),co.forEach(t),fu=p(o),So=s(o,"H2",{class:!0});var Tf=a(So);es=s(Tf,"A",{id:!0,class:!0,href:!0});var m0=a(es);rp=s(m0,"SPAN",{});var u0=a(rp);y(qr.$$.fragment,u0),u0.forEach(t),m0.forEach(t),AT=p(Tf),ip=s(Tf,"SPAN",{});var f0=a(ip);OT=i(f0,"TFElectraModel"),f0.forEach(t),Tf.forEach(t),gu=p(o),Ve=s(o,"DIV",{class:!0});var Dt=a(Ve);y(Pr.$$.fragment,Dt),LT=p(Dt),lp=s(Dt,"P",{});var g0=a(lp);NT=i(g0,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),g0.forEach(t),IT=p(Dt),Ar=s(Dt,"P",{});var bf=a(Ar);ST=i(bf,"This model inherits from "),yd=s(bf,"A",{href:!0});var _0=a(yd);DT=i(_0,"TFPreTrainedModel"),_0.forEach(t),WT=i(bf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bf.forEach(t),UT=p(Dt),Or=s(Dt,"P",{});var yf=a(Or);RT=i(yf,"This model is also a "),Lr=s(yf,"A",{href:!0,rel:!0});var k0=a(Lr);HT=i(k0,"tf.keras.Model"),k0.forEach(t),QT=i(yf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yf.forEach(t),BT=p(Dt),y(ts.$$.fragment,Dt),VT=p(Dt),xt=s(Dt,"DIV",{class:!0});var aa=a(xt);y(Nr.$$.fragment,aa),KT=p(aa),Do=s(aa,"P",{});var Yd=a(Do);JT=i(Yd,"The "),Ed=s(Yd,"A",{href:!0});var v0=a(Ed);GT=i(v0,"TFElectraModel"),v0.forEach(t),XT=i(Yd," forward method, overrides the "),dp=s(Yd,"CODE",{});var T0=a(dp);YT=i(T0,"__call__"),T0.forEach(t),ZT=i(Yd," special method."),Yd.forEach(t),eb=p(aa),y(os.$$.fragment,aa),tb=p(aa),y(ns.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),_u=p(o),Wo=s(o,"H2",{class:!0});var Ef=a(Wo);ss=s(Ef,"A",{id:!0,class:!0,href:!0});var b0=a(ss);cp=s(b0,"SPAN",{});var y0=a(cp);y(Ir.$$.fragment,y0),y0.forEach(t),b0.forEach(t),ob=p(Ef),pp=s(Ef,"SPAN",{});var E0=a(pp);nb=i(E0,"TFElectraForPreTraining"),E0.forEach(t),Ef.forEach(t),ku=p(o),Oe=s(o,"DIV",{class:!0});var ht=a(Oe);y(Sr.$$.fragment,ht),sb=p(ht),hp=s(ht,"P",{});var w0=a(hp);ab=i(w0,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),w0.forEach(t),rb=p(ht),mp=s(ht,"P",{});var $0=a(mp);ib=i($0,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Af.forEach(t),qy=p(Ut),y(vs.$$.fragment,Ut),Py=p(Ut),zt=s(Ut,"DIV",{class:!0});var ia=a(zt);y(ii.$$.fragment,ia),Ay=p(ia),Ko=s(ia,"P",{});var oc=a(Ko);Oy=i(oc,"The "),jd=s(oc,"A",{href:!0});var Z0=a(jd);Ly=i(Z0,"TFElectraForMultipleChoice"),Z0.forEach(t),Ny=i(oc," forward method, overrides the "),xp=s(oc,"CODE",{});var ex=a(xp);Iy=i(ex,"__call__"),ex.forEach(t),Sy=i(oc," special method."),oc.forEach(t),Dy=p(ia),y(Ts.$$.fragment,ia),Wy=p(ia),y(bs.$$.fragment,ia),ia.forEach(t),Ut.forEach(t),$u=p(o),Jo=s(o,"H2",{class:!0});var Of=a(Jo);ys=s(Of,"A",{id:!0,class:!0,href:!0});var tx=a(ys);Mp=s(tx,"SPAN",{});var ox=a(Mp);y(li.$$.fragment,ox),ox.forEach(t),tx.forEach(t),Uy=p(Of),zp=s(Of,"SPAN",{});var nx=a(zp);Ry=i(nx,"TFElectraForTokenClassification"),nx.forEach(t),Of.forEach(t),Fu=p(o),Ne=s(o,"DIV",{class:!0});var ut=a(Ne);y(di.$$.fragment,ut),Hy=p(ut),Cp=s(ut,"P",{});var sx=a(Cp);Qy=i(sx,"Electra model with a token classification head on top."),sx.forEach(t),By=p(ut),jp=s(ut,"P",{});var ax=a(jp);Vy=i(ax,"Both the discriminator and generator may be loaded into this model."),ax.forEach(t),Ky=p(ut),ci=s(ut,"P",{});var Lf=a(ci);Jy=i(Lf,"This model inherits from "),qd=s(Lf,"A",{href:!0});var rx=a(qd);Gy=i(rx,"TFPreTrainedModel"),rx.forEach(t),Xy=i(Lf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf.forEach(t),Yy=p(ut),pi=s(ut,"P",{});var Nf=a(pi);Zy=i(Nf,"This model is also a "),hi=s(Nf,"A",{href:!0,rel:!0});var ix=a(hi);e1=i(ix,"tf.keras.Model"),ix.forEach(t),t1=i(Nf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nf.forEach(t),o1=p(ut),y(Es.$$.fragment,ut),n1=p(ut),dt=s(ut,"DIV",{class:!0});var uo=a(dt);y(mi.$$.fragment,uo),s1=p(uo),Go=s(uo,"P",{});var nc=a(Go);a1=i(nc,"The "),Pd=s(nc,"A",{href:!0});var lx=a(Pd);r1=i(lx,"TFElectraForTokenClassification"),lx.forEach(t),i1=i(nc," forward method, overrides the "),qp=s(nc,"CODE",{});var dx=a(qp);l1=i(dx,"__call__"),dx.forEach(t),d1=i(nc," special method."),nc.forEach(t),c1=p(uo),y(ws.$$.fragment,uo),p1=p(uo),y($s.$$.fragment,uo),h1=p(uo),y(Fs.$$.fragment,uo),uo.forEach(t),ut.forEach(t),xu=p(o),Xo=s(o,"H2",{class:!0});var If=a(Xo);xs=s(If,"A",{id:!0,class:!0,href:!0});var cx=a(xs);Pp=s(cx,"SPAN",{});var px=a(Pp);y(ui.$$.fragment,px),px.forEach(t),cx.forEach(t),m1=p(If),Ap=s(If,"SPAN",{});var hx=a(Ap);u1=i(hx,"TFElectraForQuestionAnswering"),hx.forEach(t),If.forEach(t),Mu=p(o),Ge=s(o,"DIV",{class:!0});var Rt=a(Ge);y(fi.$$.fragment,Rt),f1=p(Rt),Yo=s(Rt,"P",{});var sc=a(Yo);g1=i(sc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(sc,"CODE",{});var mx=a(Op);_1=i(mx,"span start logits"),mx.forEach(t),k1=i(sc," and "),Lp=s(sc,"CODE",{});var ux=a(Lp);v1=i(ux,"span end logits"),ux.forEach(t),T1=i(sc,")."),sc.forEach(t),b1=p(Rt),gi=s(Rt,"P",{});var Sf=a(gi);y1=i(Sf,"This model inherits from "),Ad=s(Sf,"A",{href:!0});var fx=a(Ad);E1=i(fx,"TFPreTrainedModel"),fx.forEach(t),w1=i(Sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sf.forEach(t),$1=p(Rt),_i=s(Rt,"P",{});var Df=a(_i);F1=i(Df,"This model is also a "),ki=s(Df,"A",{href:!0,rel:!0});var gx=a(ki);x1=i(gx,"tf.keras.Model"),gx.forEach(t),M1=i(Df,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),z1=p(Rt),y(Ms.$$.fragment,Rt),C1=p(Rt),ct=s(Rt,"DIV",{class:!0});var fo=a(ct);y(vi.$$.fragment,fo),j1=p(fo),Zo=s(fo,"P",{});var ac=a(Zo);q1=i(ac,"The "),Od=s(ac,"A",{href:!0});var _x=a(Od);P1=i(_x,"TFElectraForQuestionAnswering"),_x.forEach(t),A1=i(ac," forward method, overrides the "),Np=s(ac,"CODE",{});var kx=a(Np);O1=i(kx,"__call__"),kx.forEach(t),L1=i(ac," special method."),ac.forEach(t),N1=p(fo),y(zs.$$.fragment,fo),I1=p(fo),y(Cs.$$.fragment,fo),S1=p(fo),y(js.$$.fragment,fo),fo.forEach(t),Rt.forEach(t),zu=p(o),en=s(o,"H2",{class:!0});var Wf=a(en);qs=s(Wf,"A",{id:!0,class:!0,href:!0});var vx=a(qs);Ip=s(vx,"SPAN",{});var Tx=a(Ip);y(Ti.$$.fragment,Tx),Tx.forEach(t),vx.forEach(t),D1=p(Wf),Sp=s(Wf,"SPAN",{});var bx=a(Sp);W1=i(bx,"FlaxElectraModel"),bx.forEach(t),Wf.forEach(t),Cu=p(o),Ie=s(o,"DIV",{class:!0});var ft=a(Ie);y(bi.$$.fragment,ft),U1=p(ft),Dp=s(ft,"P",{});var yx=a(Dp);R1=i(yx,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),yx.forEach(t),H1=p(ft),yi=s(ft,"P",{});var Uf=a(yi);Q1=i(Uf,"This model inherits from "),Ld=s(Uf,"A",{href:!0});var Ex=a(Ld);B1=i(Ex,"FlaxPreTrainedModel"),Ex.forEach(t),V1=i(Uf,`. Check the superclass documentation for the generic methods the
...
`),wi=s(Rf,"A",{href:!0,rel:!0});var wx=a(wi);G1=i(wx,"flax.nn.Module"),wx.forEach(t),X1=i(Rf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rf.forEach(t),Y1=p(ft),Wp=s(ft,"P",{});var $x=a(Wp);Z1=i($x,"Finally, this model supports inherent JAX features such as:"),$x.forEach(t),eE=p(ft),Qt=s(ft,"UL",{});var la=a(Qt);Up=s(la,"LI",{});var Fx=a(Up);$i=s(Fx,"A",{href:!0,rel:!0});var xx=a($i);tE=i(xx,"Just-In-Time (JIT) compilation"),xx.forEach(t),Fx.forEach(t),oE=p(la),Rp=s(la,"LI",{});var Mx=a(Rp);Fi=s(Mx,"A",{href:!0,rel:!0});var zx=a(Fi);nE=i(zx,"Automatic Differentiation"),zx.forEach(t),Mx.forEach(t),sE=p(la),Hp=s(la,"LI",{});var Cx=a(Hp);xi=s(Cx,"A",{href:!0,rel:!0});var jx=a(xi);aE=i(jx,"Vectorization"),jx.forEach(t),Cx.forEach(t),rE=p(la),Qp=s(la,"LI",{});var qx=a(Qp);Mi=s(qx,"A",{href:!0,rel:!0});var Px=a(Mi);iE=i(Px,"Parallelization"),Px.forEach(t),qx.forEach(t),la.forEach(t),lE=p(ft),Ct=s(ft,"DIV",{class:!0});var da=a(Ct);y(zi.$$.fragment,da),dE=p(da),tn=s(da,"P",{});var rc=a(tn);cE=i(rc,"The "),Bp=s(rc,"CODE",{});var Ax=a(Bp);pE=i(Ax,"FlaxElectraPreTrainedModel"),Ax.forEach(t),hE=i(rc," forward method, overrides the "),Vp=s(rc,"CODE",{});var Ox=a(Vp);mE=i(Ox,"__call__"),Ox.forEach(t),uE=i(rc," special method."),rc.forEach(t),fE=p(da),y(Ps.$$.fragment,da),gE=p(da),y(As.$$.fragment,da),da.forEach(t),ft.forEach(t),ju=p(o),on=s(o,"H2",{class:!0});var Hf=a(on);Os=s(Hf,"A",{id:!0,class:!0,href:!0});var Lx=a(Os);Kp=s(Lx,"SPAN",{});var Nx=a(Kp);y(Ci.$$.fragment,Nx),Nx.forEach(t),Lx.forEach(t),_E=p(Hf),Jp=s(Hf,"SPAN",{});var Ix=a(Jp);kE=i(Ix,"FlaxElectraForPreTraining"),Ix.forEach(t),Hf.forEach(t),qu=p(o),Pe=s(o,"DIV",{class:!0});var Xe=a(Pe);y(ji.$$.fragment,Xe),vE=p(Xe),Gp=s(Xe,"P",{});var Sx=a(Gp);TE=i(Sx,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),Sx.forEach(t),bE=p(Xe),Xp=s(Xe,"P",{});var Dx=a(Xp);yE=i(Dx,"It is recommended to load the discriminator checkpoint into that model."),Dx.forEach(t),EE=p(Xe),qi=s(Xe,"P",{});var Qf=a(qi);wE=i(Qf,"This model inherits from "),Nd=s(Qf,"A",{href:!0});var Wx=a(Nd);$E=i(Wx,"FlaxPreTrainedModel"),Wx.forEach(t),FE=i(Qf,`. Check the superclass documentation for the generic methods the
...
`),Ai=s(Bf,"A",{href:!0,rel:!0});var Ux=a(Ai);zE=i(Ux,"flax.nn.Module"),Ux.forEach(t),CE=i(Bf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bf.forEach(t),jE=p(Xe),Yp=s(Xe,"P",{});var Rx=a(Yp);qE=i(Rx,"Finally, this model supports inherent JAX features such as:"),Rx.forEach(t),PE=p(Xe),Bt=s(Xe,"UL",{});var ca=a(Bt);Zp=s(ca,"LI",{});var Hx=a(Zp);Oi=s(Hx,"A",{href:!0,rel:!0});var Qx=a(Oi);AE=i(Qx,"Just-In-Time (JIT) compilation"),Qx.forEach(t),Hx.forEach(t),OE=p(ca),eh=s(ca,"LI",{});var Bx=a(eh);Li=s(Bx,"A",{href:!0,rel:!0});var Vx=a(Li);LE=i(Vx,"Automatic Differentiation"),Vx.forEach(t),Bx.forEach(t),NE=p(ca),th=s(ca,"LI",{});var Kx=a(th);Ni=s(Kx,"A",{href:!0,rel:!0});var Jx=a(Ni);IE=i(Jx,"Vectorization"),Jx.forEach(t),Kx.forEach(t),SE=p(ca),oh=s(ca,"LI",{});var Gx=a(oh);Ii=s(Gx,"A",{href:!0,rel:!0});var Xx=a(Ii);DE=i(Xx,"Parallelization"),Xx.forEach(t),Gx.forEach(t),ca.forEach(t),WE=p(Xe),jt=s(Xe,"DIV",{class:!0});var pa=a(jt);y(Si.$$.fragment,pa),UE=p(pa),nn=s(pa,"P",{});var ic=a(nn);RE=i(ic,"The "),nh=s(ic,"CODE",{});var Yx=a(nh);HE=i(Yx,"FlaxElectraPreTrainedModel"),Yx.forEach(t),QE=i(ic," forward method, overrides the "),sh=s(ic,"CODE",{});var Zx=a(sh);BE=i(Zx,"__call__"),Zx.forEach(t),VE=i(ic," special method."),ic.forEach(t),KE=p(pa),y(Ls.$$.fragment,pa),JE=p(pa),y(Ns.$$.fragment,pa),pa.forEach(t),Xe.forEach(t),Pu=p(o),sn=s(o,"H2",{class:!0});var Vf=a(sn);Is=s(Vf,"A",{id:!0,class:!0,href:!0});var eM=a(Is);ah=s(eM,"SPAN",{});var tM=a(ah);y(Di.$$.fragment,tM),tM.forEach(t),eM.forEach(t),GE=p(Vf),rh=s(Vf,"SPAN",{});var oM=a(rh);XE=i(oM,"FlaxElectraForMaskedLM"),oM.forEach(t),Vf.forEach(t),Au=p(o),Se=s(o,"DIV",{class:!0});var gt=a(Se);y(Wi.$$.fragment,gt),YE=p(gt),Ui=s(gt,"P",{});var Kf=a(Ui);ZE=i(Kf,"Electra Model with a "),ih=s(Kf,"CODE",{});var nM=a(ih);ew=i(nM,"language modeling"),nM.forEach(t),tw=i(Kf," head on top."),Kf.forEach(t),ow=p(gt),Ri=s(gt,"P",{});var Jf=a(Ri);nw=i(Jf,"This model inherits from "),Id=s(Jf,"A",{href:!0});var sM=a(Id);sw=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),aw=i(Jf,`. Check the superclass documentation for the generic methods the
...
`),Qi=s(Gf,"A",{href:!0,rel:!0});var aM=a(Qi);lw=i(aM,"flax.nn.Module"),aM.forEach(t),dw=i(Gf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Gf.forEach(t),cw=p(gt),lh=s(gt,"P",{});var rM=a(lh);pw=i(rM,"Finally, this model supports inherent JAX features such as:"),rM.forEach(t),hw=p(gt),Vt=s(gt,"UL",{});var ha=a(Vt);dh=s(ha,"LI",{});var iM=a(dh);Bi=s(iM,"A",{href:!0,rel:!0});var lM=a(Bi);mw=i(lM,"Just-In-Time (JIT) compilation"),lM.forEach(t),iM.forEach(t),uw=p(ha),ch=s(ha,"LI",{});var dM=a(ch);Vi=s(dM,"A",{href:!0,rel:!0});var cM=a(Vi);fw=i(cM,"Automatic Differentiation"),cM.forEach(t),dM.forEach(t),gw=p(ha),ph=s(ha,"LI",{});var pM=a(ph);Ki=s(pM,"A",{href:!0,rel:!0});var hM=a(Ki);_w=i(hM,"Vectorization"),hM.forEach(t),pM.forEach(t),kw=p(ha),hh=s(ha,"LI",{});var mM=a(hh);Ji=s(mM,"A",{href:!0,rel:!0});var uM=a(Ji);vw=i(uM,"Parallelization"),uM.forEach(t),mM.forEach(t),ha.forEach(t),Tw=p(gt),qt=s(gt,"DIV",{class:!0});var ma=a(qt);y(Gi.$$.fragment,ma),bw=p(ma),an=s(ma,"P",{});var lc=a(an);yw=i(lc,"The "),mh=s(lc,"CODE",{});var fM=a(mh);Ew=i(fM,"FlaxElectraPreTrainedModel"),fM.forEach(t),ww=i(lc," forward method, overrides the "),uh=s(lc,"CODE",{});var gM=a(uh);$w=i(gM,"__call__"),gM.forEach(t),Fw=i(lc," special method."),lc.forEach(t),xw=p(ma),y(Ss.$$.fragment,ma),Mw=p(ma),y(Ds.$$.fragment,ma),ma.forEach(t),gt.forEach(t),Ou=p(o),rn=s(o,"H2",{class:!0});var Xf=a(rn);Ws=s(Xf,"A",{id:!0,class:!0,href:!0});var _M=a(Ws);fh=s(_M,"SPAN",{});var kM=a(fh);y(Xi.$$.fragment,kM),kM.forEach(t),_M.forEach(t),zw=p(Xf),gh=s(Xf,"SPAN",{});var vM=a(gh);Cw=i(vM,"FlaxElectraForSequenceClassification"),vM.forEach(t),Xf.forEach(t),Lu=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),jw=p(_t),_h=s(_t,"P",{});var TM=a(_h);qw=i(TM,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),TM.forEach(t),Pw=p(_t),Zi=s(_t,"P",{});var Yf=a(Zi);Aw=i(Yf,"This model inherits from "),Sd=s(Yf,"A",{href:!0});var bM=a(Sd);Ow=i(bM,"FlaxPreTrainedModel"),bM.forEach(t),Lw=i(Yf,`. Check the superclass documentation for the generic methods the
...
`),tl=s(Zf,"A",{href:!0,rel:!0});var yM=a(tl);Sw=i(yM,"flax.nn.Module"),yM.forEach(t),Dw=i(Zf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Zf.forEach(t),Ww=p(_t),kh=s(_t,"P",{});var EM=a(kh);Uw=i(EM,"Finally, this model supports inherent JAX features such as:"),EM.forEach(t),Rw=p(_t),Kt=s(_t,"UL",{});var ua=a(Kt);vh=s(ua,"LI",{});var wM=a(vh);ol=s(wM,"A",{href:!0,rel:!0});var $M=a(ol);Hw=i($M,"Just-In-Time (JIT) compilation"),$M.forEach(t),wM.forEach(t),Qw=p(ua),Th=s(ua,"LI",{});var FM=a(Th);nl=s(FM,"A",{href:!0,rel:!0});var xM=a(nl);Bw=i(xM,"Automatic Differentiation"),xM.forEach(t),FM.forEach(t),Vw=p(ua),bh=s(ua,"LI",{});var MM=a(bh);sl=s(MM,"A",{href:!0,rel:!0});var zM=a(sl);Kw=i(zM,"Vectorization"),zM.forEach(t),MM.forEach(t),Jw=p(ua),yh=s(ua,"LI",{});var CM=a(yh);al=s(CM,"A",{href:!0,rel:!0});var jM=a(al);Gw=i(jM,"Parallelization"),jM.forEach(t),CM.forEach(t),ua.forEach(t),Xw=p(_t),Pt=s(_t,"DIV",{class:!0});var fa=a(Pt);y(rl.$$.fragment,fa),Yw=p(fa),ln=s(fa,"P",{});var dc=a(ln);Zw=i(dc,"The "),Eh=s(dc,"CODE",{});var qM=a(Eh);e$=i(qM,"FlaxElectraPreTrainedModel"),qM.forEach(t),t$=i(dc," forward method, overrides the "),wh=s(dc,"CODE",{});var PM=a(wh);o$=i(PM,"__call__"),PM.forEach(t),n$=i(dc," special method."),dc.forEach(t),s$=p(fa),y(Us.$$.fragment,fa),a$=p(fa),y(Rs.$$.fragment,fa),fa.forEach(t),_t.forEach(t),Nu=p(o),dn=s(o,"H2",{class:!0});var eg=a(dn);Hs=s(eg,"A",{id:!0,class:!0,href:!0});var AM=a(Hs);$h=s(AM,"SPAN",{});var OM=a($h);y(il.$$.fragment,OM),OM.forEach(t),AM.forEach(t),r$=p(eg),Fh=s(eg,"SPAN",{});var LM=a(Fh);i$=i(LM,"FlaxElectraForMultipleChoice"),LM.forEach(t),eg.forEach(t),Iu=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(ll.$$.fragment,kt),l$=p(kt),xh=s(kt,"P",{});var NM=a(xh);d$=i(NM,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),og.forEach(t),k$=p(kt),Mh=s(kt,"P",{});var DM=a(Mh);v$=i(DM,"Finally, this model supports inherent JAX features such as:"),DM.forEach(t),T$=p(kt),Jt=s(kt,"UL",{});var ga=a(Jt);zh=s(ga,"LI",{});var WM=a(zh);hl=s(WM,"A",{href:!0,rel:!0});var UM=a(hl);b$=i(UM,"Just-In-Time (JIT) compilation"),UM.forEach(t),WM.forEach(t),y$=p(ga),Ch=s(ga,"LI",{});var RM=a(Ch);ml=s(RM,"A",{href:!0,rel:!0});var HM=a(ml);E$=i(HM,"Automatic Differentiation"),HM.forEach(t),RM.forEach(t),w$=p(ga),jh=s(ga,"LI",{});var QM=a(jh);ul=s(QM,"A",{href:!0,rel:!0});var BM=a(ul);$$=i(BM,"Vectorization"),BM.forEach(t),QM.forEach(t),F$=p(ga),qh=s(ga,"LI",{});var VM=a(qh);fl=s(VM,"A",{href:!0,rel:!0});var KM=a(fl);x$=i(KM,"Parallelization"),KM.forEach(t),VM.forEach(t),ga.forEach(t),M$=p(kt),At=s(kt,"DIV",{class:!0});var _a=a(At);y(gl.$$.fragment,_a),z$=p(_a),cn=s(_a,"P",{});var cc=a(cn);C$=i(cc,"The "),Ph=s(cc,"CODE",{});var JM=a(Ph);j$=i(JM,"FlaxElectraPreTrainedModel"),JM.forEach(t),q$=i(cc," forward method, overrides the "),Ah=s(cc,"CODE",{});var GM=a(Ah);P$=i(GM,"__call__"),GM.forEach(t),A$=i(cc," special method."),cc.forEach(t),O$=p(_a),y(Qs.$$.fragment,_a),L$=p(_a),y(Bs.$$.fragment,_a),_a.forEach(t),kt.forEach(t),Su=p(o),pn=s(o,"H2",{class:!0});var ng=a(pn);Vs=s(ng,"A",{id:!0,class:!0,href:!0});var XM=a(Vs);Oh=s(XM,"SPAN",{});var YM=a(Oh);y(_l.$$.fragment,YM),YM.forEach(t),XM.forEach(t),N$=p(ng),Lh=s(ng,"SPAN",{});var ZM=a(Lh);I$=i(ZM,"FlaxElectraForTokenClassification"),ZM.forEach(t),ng.forEach(t),Du=p(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(kl.$$.fragment,Ye),S$=p(Ye),Nh=s(Ye,"P",{});var e9=a(Nh);D$=i(e9,"Electra model with a token classification head on top."),e9.forEach(t),W$=p(Ye),Ih=s(Ye,"P",{});var t9=a(Ih);U$=i(t9,"Both the discriminator and generator may be loaded into this model."),t9.forEach(t),R$=p(Ye),vl=s(Ye,"P",{});var sg=a(vl);H$=i(sg,"This model inherits from "),Wd=s(sg,"A",{href:!0});var o9=a(Wd);Q$=i(o9,"FlaxPreTrainedModel"),o9.forEach(t),B$=i(sg,`. Check the superclass documentation for the generic methods the
...
`),bl=s(ag,"A",{href:!0,rel:!0});var n9=a(bl);J$=i(n9,"flax.nn.Module"),n9.forEach(t),G$=i(ag,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ag.forEach(t),X$=p(Ye),Sh=s(Ye,"P",{});var s9=a(Sh);Y$=i(s9,"Finally, this model supports inherent JAX features such as:"),s9.forEach(t),Z$=p(Ye),Gt=s(Ye,"UL",{});var ka=a(Gt);Dh=s(ka,"LI",{});var a9=a(Dh);yl=s(a9,"A",{href:!0,rel:!0});var r9=a(yl);e2=i(r9,"Just-In-Time (JIT) compilation"),r9.forEach(t),a9.forEach(t),t2=p(ka),Wh=s(ka,"LI",{});var i9=a(Wh);El=s(i9,"A",{href:!0,rel:!0});var l9=a(El);o2=i(l9,"Automatic Differentiation"),l9.forEach(t),i9.forEach(t),n2=p(ka),Uh=s(ka,"LI",{});var d9=a(Uh);wl=s(d9,"A",{href:!0,rel:!0});var c9=a(wl);s2=i(c9,"Vectorization"),c9.forEach(t),d9.forEach(t),a2=p(ka),Rh=s(ka,"LI",{});var p9=a(Rh);$l=s(p9,"A",{href:!0,rel:!0});var h9=a($l);r2=i(h9,"Parallelization"),h9.forEach(t),p9.forEach(t),ka.forEach(t),i2=p(Ye),Ot=s(Ye,"DIV",{class:!0});var va=a(Ot);y(Fl.$$.fragment,va),l2=p(va),hn=s(va,"P",{});var pc=a(hn);d2=i(pc,"The "),Hh=s(pc,"CODE",{});var m9=a(Hh);c2=i(m9,"FlaxElectraPreTrainedModel"),m9.forEach(t),p2=i(pc," forward method, overrides the "),Qh=s(pc,"CODE",{});var u9=a(Qh);h2=i(u9,"__call__"),u9.forEach(t),m2=i(pc," special method."),pc.forEach(t),u2=p(va),y(Ks.$$.fragment,va),f2=p(va),y(Js.$$.fragment,va),va.forEach(t),Ye.forEach(t),Wu=p(o),mn=s(o,"H2",{class:!0});var rg=a(mn);Gs=s(rg,"A",{id:!0,class:!0,href:!0});var f9=a(Gs);Bh=s(f9,"SPAN",{});var g9=a(Bh);y(xl.$$.fragment,g9),g9.forEach(t),f9.forEach(t),g2=p(rg),Vh=s(rg,"SPAN",{});var _9=a(Vh);_2=i(_9,"FlaxElectraForQuestionAnswering"),_9.forEach(t),rg.forEach(t),Uu=p(o),Ue=s(o,"DIV",{class:!0});var vt=a(Ue);y(Ml.$$.fragment,vt),k2=p(vt),un=s(vt,"P",{});var hc=a(un);v2=i(hc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Kh=s(hc,"CODE",{});var k9=a(Kh);T2=i(k9,"span start logits"),k9.forEach(t),b2=i(hc," and "),Jh=s(hc,"CODE",{});var v9=a(Jh);y2=i(v9,"span end logits"),v9.forEach(t),E2=i(hc,")."),hc.forEach(t),w2=p(vt),zl=s(vt,"P",{});var ig=a(zl);$2=i(ig,"This model inherits from "),Ud=s(ig,"A",{href:!0});var T9=a(Ud);F2=i(T9,"FlaxPreTrainedModel"),T9.forEach(t),x2=i(ig,`. Check the superclass documentation for the generic methods the
