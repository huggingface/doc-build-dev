...
and configure `),ki=o("a"),e9=a("TrainingArguments"),s9=a(" based on that. The steps are:"),$y=u(),sa=o("ol"),nd=o("li"),t9=a("Create or load the DeepSpeed configuration to be used as a master configuration"),a9=u(),Wo=o("li"),n9=a("Create the "),Pi=o("a"),o9=a("TrainingArguments"),l9=a(" object based on these values"),ky=u(),oe=o("p"),r9=a("Do note that some values, such as "),od=o("code"),p9=a("scheduler.params.total_num_steps"),i9=a(` are calculated by
`),zi=o("a"),u9=a("Trainer"),c9=a(" during "),ld=o("code"),h9=a("train"),f9=a(", but you can of course do the math yourself."),Py=u(),Di=o("a"),zy=u(),Ss=o("h3"),ta=o("a"),rd=o("span"),f(Fo.$$.fragment),d9=u(),pd=o("span"),m9=a("ZeRO"),Dy=u(),Vo=o("p"),Yo=o("a"),_9=a("Zero Redundancy Optimizer (ZeRO)"),v9=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),Oy=u(),Ze=o("p"),j9=a("The "),id=o("code"),w9=a("zero_optimization"),y9=a(" section of the configuration file is the most important part ("),Ko=o("a"),g9=a("docs"),b9=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),Ay=u(),aa=o("p"),q9=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Oi=o("a"),E9=a("Trainer"),$9=a(` provides
no equivalent command line arguments.`),Ty=u(),Ai=o("p"),k9=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),Sy=u(),Ti=o("a"),Cy=u(),Cs=o("h4"),na=o("a"),ud=o("span"),f(Jo.$$.fragment),P9=u(),cd=o("span"),z9=a("ZeRO-2 Config"),xy=u(),Si=o("p"),D9=a("The following is an example of configuration for ZeRO stage 2:"),Ry=u(),f(Xo.$$.fragment),Iy=u(),Ci=o("p"),hd=o("strong"),O9=a("Performance tuning:"),Uy=u(),Ne=o("ul"),xs=o("li"),A9=a("enabling "),fd=o("code"),T9=a("offload_optimizer"),S9=a(" should reduce GPU RAM usage (it requires "),dd=o("code"),C9=a('"stage": 2'),x9=a(")"),R9=u(),G=o("li"),md=o("code"),I9=a('"overlap_comm": true'),U9=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),_d=o("code"),G9=a("overlap_comm"),M9=a(` uses 4.5x
the `),vd=o("code"),L9=a("allgather_bucket_size"),Z9=a(" and "),jd=o("code"),N9=a("reduce_bucket_size"),H9=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),wd=o("code"),B9=a("5e8 x 2Bytes x 2 x 4.5"),W9=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),yd=o("code"),F9=a("2e8"),V9=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),Y9=u(),gd=o("li"),K9=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),Gy=u(),He=o("p"),J9=a("Additionally, "),bd=o("code"),X9=a("deepspeed==0.4.4"),Q9=a(" added a new option "),qd=o("code"),ek=a("round_robin_gradients"),sk=a(" which you can enable with:"),My=u(),f(Qo.$$.fragment),Ly=u(),xi=o("p"),tk=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Zy=u(),Ri=o("a"),Ny=u(),Rs=o("h4"),oa=o("a"),Ed=o("span"),f(el.$$.fragment),ak=u(),$d=o("span"),nk=a("ZeRO-3 Config"),Hy=u(),Ii=o("p"),ok=a("The following is an example of configuration for ZeRO stage 3:"),By=u(),f(sl.$$.fragment),Wy=u(),V=o("p"),lk=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
...
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Xy=u(),Gi=o("p"),Bk=a("The following configuration values depend on the model\u2019s hidden size:"),Qy=u(),We=o("ul"),nl=o("li"),Bd=o("code"),Wk=a("reduce_bucket_size"),Fk=a(": "),Wd=o("code"),Vk=a("hidden_size*hidden_size"),Yk=u(),ol=o("li"),Fd=o("code"),Kk=a("stage3_prefetch_bucket_size"),Jk=a(": "),Vd=o("code"),Xk=a("0.9 * hidden_size * hidden_size"),Qk=u(),ll=o("li"),Yd=o("code"),e7=a("stage3_param_persistence_threshold"),s7=a(": "),Kd=o("code"),t7=a("10 * hidden_size"),eg=u(),Fe=o("p"),a7=a("therefore set these values to "),Jd=o("code"),n7=a("auto"),o7=a(" and the "),Mi=o("a"),l7=a("Trainer"),r7=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),sg=u(),rl=o("p"),Xd=o("code"),p7=a("stage3_gather_16bit_weights_on_model_save"),i7=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),tg=u(),le=o("p"),u7=a("If you\u2019re migrating from ZeRO-2 configuration note that "),Qd=o("code"),c7=a("allgather_partitions"),h7=a(", "),em=o("code"),f7=a("allgather_bucket_size"),d7=a(` and
`),sm=o("code"),m7=a("reduce_scatter"),_7=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),ag=u(),Li=o("ul"),pl=o("li"),tm=o("code"),v7=a("sub_group_size"),j7=a(": "),am=o("code"),w7=a("1e9"),ng=u(),De=o("p"),nm=o("code"),y7=a("sub_group_size"),g7=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),om=o("code"),b7=a("sub_group_size"),q7=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),lm=o("code"),E7=a("sub_group_size"),$7=a(` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),og=u(),Ve=o("p"),k7=a("You can leave "),rm=o("code"),P7=a("sub_group_size"),z7=a(" to its default value of "),pm=o("em"),D7=a("1e9"),O7=a(` when not using NVMe offload. You may want to change its
default value in the following cases:`),lg=u(),ra=o("ol"),il=o("li"),A7=a("Running into OOM during optimizer step: Reduce "),im=o("code"),T7=a("sub_group_size"),S7=a(" to reduce memory utilization of temporary buffers"),C7=u(),ul=o("li"),x7=a("Optimizer Step is taking a long time: Increase "),um=o("code"),R7=a("sub_group_size"),I7=a(` to improve bandwidth utilization as a result of
the increased data buffers.`),rg=u(),Zi=o("a"),pg=u(),Is=o("h3"),pa=o("a"),cm=o("span"),f(cl.$$.fragment),U7=u(),hm=o("span"),G7=a("NVMe Support"),ig=u(),Ni=o("p"),M7=a(`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
...
process. ZeRO-Infinity requires ZeRO-3 enabled.`),ug=u(),Hi=o("p"),L7=a("The following configuration example enables NVMe to offload both optimizer states and the params:"),cg=u(),f(hl.$$.fragment),hg=u(),ia=o("p"),Z7=a(`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),fm=o("em"),N7=a("\u201Cdevice\u201D: \u201Ccpu\u201D"),H7=a(")."),fg=u(),Ye=o("p"),B7=a("Here is the full documentation for offloading "),fl=o("a"),W7=a("optimizer states"),F7=a(" and "),dl=o("a"),V7=a("parameters"),Y7=a("."),dg=u(),ua=o("p"),K7=a("Make sure that your "),dm=o("code"),J7=a("nvme_path"),X7=a(` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),mg=u(),Ke=o("p"),Q7=a("In order to figure out the optimal "),mm=o("code"),eP=a("aio"),sP=a(` configuration block you must run a benchmark on your target setup, as
...
and configure `),ki=l(_q,"A",{href:!0});var nL=r(ki);e9=n(nL,"TrainingArguments"),nL.forEach(t),s9=n(_q," based on that. The steps are:"),_q.forEach(t),$y=c(e),sa=l(e,"OL",{});var vq=r(sa);nd=l(vq,"LI",{});var oL=r(nd);t9=n(oL,"Create or load the DeepSpeed configuration to be used as a master configuration"),oL.forEach(t),a9=c(vq),Wo=l(vq,"LI",{});var jq=r(Wo);n9=n(jq,"Create the "),Pi=l(jq,"A",{href:!0});var lL=r(Pi);o9=n(lL,"TrainingArguments"),lL.forEach(t),l9=n(jq," object based on these values"),jq.forEach(t),vq.forEach(t),ky=c(e),oe=l(e,"P",{});var Rn=r(oe);r9=n(Rn,"Do note that some values, such as "),od=l(Rn,"CODE",{});var rL=r(od);p9=n(rL,"scheduler.params.total_num_steps"),rL.forEach(t),i9=n(Rn,` are calculated by
`),zi=l(Rn,"A",{href:!0});var pL=r(zi);u9=n(pL,"Trainer"),pL.forEach(t),c9=n(Rn," during "),ld=l(Rn,"CODE",{});var iL=r(ld);h9=n(iL,"train"),iL.forEach(t),f9=n(Rn,", but you can of course do the math yourself."),Rn.forEach(t),Py=c(e),Di=l(e,"A",{id:!0}),r(Di).forEach(t),zy=c(e),Ss=l(e,"H3",{class:!0});var wq=r(Ss);ta=l(wq,"A",{id:!0,class:!0,href:!0});var uL=r(ta);rd=l(uL,"SPAN",{});var cL=r(rd);d(Fo.$$.fragment,cL),cL.forEach(t),uL.forEach(t),d9=c(wq),pd=l(wq,"SPAN",{});var hL=r(pd);m9=n(hL,"ZeRO"),hL.forEach(t),wq.forEach(t),Dy=c(e),Vo=l(e,"P",{});var vU=r(Vo);Yo=l(vU,"A",{href:!0,rel:!0});var fL=r(Yo);_9=n(fL,"Zero Redundancy Optimizer (ZeRO)"),fL.forEach(t),v9=n(vU,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),vU.forEach(t),Oy=c(e),Ze=l(e,"P",{});var rh=r(Ze);j9=n(rh,"The "),id=l(rh,"CODE",{});var dL=r(id);w9=n(dL,"zero_optimization"),dL.forEach(t),y9=n(rh," section of the configuration file is the most important part ("),Ko=l(rh,"A",{href:!0,rel:!0});var mL=r(Ko);g9=n(mL,"docs"),mL.forEach(t),b9=n(rh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),rh.forEach(t),Ay=c(e),aa=l(e,"P",{});var yq=r(aa);q9=n(yq,"This section has to be configured exclusively via DeepSpeed configuration - the "),Oi=l(yq,"A",{href:!0});var _L=r(Oi);E9=n(_L,"Trainer"),_L.forEach(t),$9=n(yq,` provides
no equivalent command line arguments.`),yq.forEach(t),Ty=c(e),Ai=l(e,"P",{});var vL=r(Ai);k9=n(vL,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),vL.forEach(t),Sy=c(e),Ti=l(e,"A",{id:!0}),r(Ti).forEach(t),Cy=c(e),Cs=l(e,"H4",{class:!0});var gq=r(Cs);na=l(gq,"A",{id:!0,class:!0,href:!0});var jL=r(na);ud=l(jL,"SPAN",{});var wL=r(ud);d(Jo.$$.fragment,wL),wL.forEach(t),jL.forEach(t),P9=c(gq),cd=l(gq,"SPAN",{});var yL=r(cd);z9=n(yL,"ZeRO-2 Config"),yL.forEach(t),gq.forEach(t),xy=c(e),Si=l(e,"P",{});var gL=r(Si);D9=n(gL,"The following is an example of configuration for ZeRO stage 2:"),gL.forEach(t),Ry=c(e),d(Xo.$$.fragment,e),Iy=c(e),Ci=l(e,"P",{});var bL=r(Ci);hd=l(bL,"STRONG",{});var qL=r(hd);O9=n(qL,"Performance tuning:"),qL.forEach(t),bL.forEach(t),Uy=c(e),Ne=l(e,"UL",{});var ph=r(Ne);xs=l(ph,"LI",{});var ih=r(xs);A9=n(ih,"enabling "),fd=l(ih,"CODE",{});var EL=r(fd);T9=n(EL,"offload_optimizer"),EL.forEach(t),S9=n(ih," should reduce GPU RAM usage (it requires "),dd=l(ih,"CODE",{});var $L=r(dd);C9=n($L,'"stage": 2'),$L.forEach(t),x9=n(ih,")"),ih.forEach(t),R9=c(ph),G=l(ph,"LI",{});var se=r(G);md=l(se,"CODE",{});var kL=r(md);I9=n(kL,'"overlap_comm": true'),kL.forEach(t),U9=n(se," trades off increased GPU RAM usage to lower all-reduce latency. "),_d=l(se,"CODE",{});var PL=r(_d);G9=n(PL,"overlap_comm"),PL.forEach(t),M9=n(se,` uses 4.5x
the `),vd=l(se,"CODE",{});var zL=r(vd);L9=n(zL,"allgather_bucket_size"),zL.forEach(t),Z9=n(se," and "),jd=l(se,"CODE",{});var DL=r(jd);N9=n(DL,"reduce_bucket_size"),DL.forEach(t),H9=n(se,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),wd=l(se,"CODE",{});var OL=r(wd);B9=n(OL,"5e8 x 2Bytes x 2 x 4.5"),OL.forEach(t),W9=n(se,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),yd=l(se,"CODE",{});var AL=r(yd);F9=n(AL,"2e8"),AL.forEach(t),V9=n(se,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),se.forEach(t),Y9=c(ph),gd=l(ph,"LI",{});var TL=r(gd);K9=n(TL,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),TL.forEach(t),ph.forEach(t),Gy=c(e),He=l(e,"P",{});var uh=r(He);J9=n(uh,"Additionally, "),bd=l(uh,"CODE",{});var SL=r(bd);X9=n(SL,"deepspeed==0.4.4"),SL.forEach(t),Q9=n(uh," added a new option "),qd=l(uh,"CODE",{});var CL=r(qd);ek=n(CL,"round_robin_gradients"),CL.forEach(t),sk=n(uh," which you can enable with:"),uh.forEach(t),My=c(e),d(Qo.$$.fragment,e),Ly=c(e),xi=l(e,"P",{});var xL=r(xi);tk=n(xL,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),xL.forEach(t),Zy=c(e),Ri=l(e,"A",{id:!0}),r(Ri).forEach(t),Ny=c(e),Rs=l(e,"H4",{class:!0});var bq=r(Rs);oa=l(bq,"A",{id:!0,class:!0,href:!0});var RL=r(oa);Ed=l(RL,"SPAN",{});var IL=r(Ed);d(el.$$.fragment,IL),IL.forEach(t),RL.forEach(t),ak=c(bq),$d=l(bq,"SPAN",{});var UL=r($d);nk=n(UL,"ZeRO-3 Config"),UL.forEach(t),bq.forEach(t),Hy=c(e),Ii=l(e,"P",{});var GL=r(Ii);ok=n(GL,"The following is an example of configuration for ZeRO stage 3:"),GL.forEach(t),By=c(e),d(sl.$$.fragment,e),Wy=c(e),V=l(e,"P",{});var ws=r(V);lk=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
...
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),gp.forEach(t),Xy=c(e),Gi=l(e,"P",{});var lZ=r(Gi);Bk=n(lZ,"The following configuration values depend on the model\u2019s hidden size:"),lZ.forEach(t),Qy=c(e),We=l(e,"UL",{});var hh=r(We);nl=l(hh,"LI",{});var kq=r(nl);Bd=l(kq,"CODE",{});var rZ=r(Bd);Wk=n(rZ,"reduce_bucket_size"),rZ.forEach(t),Fk=n(kq,": "),Wd=l(kq,"CODE",{});var pZ=r(Wd);Vk=n(pZ,"hidden_size*hidden_size"),pZ.forEach(t),kq.forEach(t),Yk=c(hh),ol=l(hh,"LI",{});var Pq=r(ol);Fd=l(Pq,"CODE",{});var iZ=r(Fd);Kk=n(iZ,"stage3_prefetch_bucket_size"),iZ.forEach(t),Jk=n(Pq,": "),Vd=l(Pq,"CODE",{});var uZ=r(Vd);Xk=n(uZ,"0.9 * hidden_size * hidden_size"),uZ.forEach(t),Pq.forEach(t),Qk=c(hh),ll=l(hh,"LI",{});var zq=r(ll);Yd=l(zq,"CODE",{});var cZ=r(Yd);e7=n(cZ,"stage3_param_persistence_threshold"),cZ.forEach(t),s7=n(zq,": "),Kd=l(zq,"CODE",{});var hZ=r(Kd);t7=n(hZ,"10 * hidden_size"),hZ.forEach(t),zq.forEach(t),hh.forEach(t),eg=c(e),Fe=l(e,"P",{});var fh=r(Fe);a7=n(fh,"therefore set these values to "),Jd=l(fh,"CODE",{});var fZ=r(Jd);n7=n(fZ,"auto"),fZ.forEach(t),o7=n(fh," and the "),Mi=l(fh,"A",{href:!0});var dZ=r(Mi);l7=n(dZ,"Trainer"),dZ.forEach(t),r7=n(fh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),fh.forEach(t),sg=c(e),rl=l(e,"P",{});var jU=r(rl);Xd=l(jU,"CODE",{});var mZ=r(Xd);p7=n(mZ,"stage3_gather_16bit_weights_on_model_save"),mZ.forEach(t),i7=n(jU,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),jU.forEach(t),tg=c(e),le=l(e,"P",{});var In=r(le);u7=n(In,"If you\u2019re migrating from ZeRO-2 configuration note that "),Qd=l(In,"CODE",{});var _Z=r(Qd);c7=n(_Z,"allgather_partitions"),_Z.forEach(t),h7=n(In,", "),em=l(In,"CODE",{});var vZ=r(em);f7=n(vZ,"allgather_bucket_size"),vZ.forEach(t),d7=n(In,` and
`),sm=l(In,"CODE",{});var jZ=r(sm);m7=n(jZ,"reduce_scatter"),jZ.forEach(t),_7=n(In,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),In.forEach(t),ag=c(e),Li=l(e,"UL",{});var wZ=r(Li);pl=l(wZ,"LI",{});var Dq=r(pl);tm=l(Dq,"CODE",{});var yZ=r(tm);v7=n(yZ,"sub_group_size"),yZ.forEach(t),j7=n(Dq,": "),am=l(Dq,"CODE",{});var gZ=r(am);w7=n(gZ,"1e9"),gZ.forEach(t),Dq.forEach(t),wZ.forEach(t),ng=c(e),De=l(e,"P",{});var bp=r(De);nm=l(bp,"CODE",{});var bZ=r(nm);y7=n(bZ,"sub_group_size"),bZ.forEach(t),g7=n(bp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),om=l(bp,"CODE",{});var qZ=r(om);b7=n(qZ,"sub_group_size"),qZ.forEach(t),q7=n(bp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),lm=l(bp,"CODE",{});var EZ=r(lm);E7=n(EZ,"sub_group_size"),EZ.forEach(t),$7=n(bp,` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),bp.forEach(t),og=c(e),Ve=l(e,"P",{});var dh=r(Ve);k7=n(dh,"You can leave "),rm=l(dh,"CODE",{});var $Z=r(rm);P7=n($Z,"sub_group_size"),$Z.forEach(t),z7=n(dh," to its default value of "),pm=l(dh,"EM",{});var kZ=r(pm);D7=n(kZ,"1e9"),kZ.forEach(t),O7=n(dh,` when not using NVMe offload. You may want to change its
default value in the following cases:`),dh.forEach(t),lg=c(e),ra=l(e,"OL",{});var Oq=r(ra);il=l(Oq,"LI",{});var Aq=r(il);A7=n(Aq,"Running into OOM during optimizer step: Reduce "),im=l(Aq,"CODE",{});var PZ=r(im);T7=n(PZ,"sub_group_size"),PZ.forEach(t),S7=n(Aq," to reduce memory utilization of temporary buffers"),Aq.forEach(t),C7=c(Oq),ul=l(Oq,"LI",{});var Tq=r(ul);x7=n(Tq,"Optimizer Step is taking a long time: Increase "),um=l(Tq,"CODE",{});var zZ=r(um);R7=n(zZ,"sub_group_size"),zZ.forEach(t),I7=n(Tq,` to improve bandwidth utilization as a result of
the increased data buffers.`),Tq.forEach(t),Oq.forEach(t),rg=c(e),Zi=l(e,"A",{id:!0}),r(Zi).forEach(t),pg=c(e),Is=l(e,"H3",{class:!0});var Sq=r(Is);pa=l(Sq,"A",{id:!0,class:!0,href:!0});var DZ=r(pa);cm=l(DZ,"SPAN",{});var OZ=r(cm);d(cl.$$.fragment,OZ),OZ.forEach(t),DZ.forEach(t),U7=c(Sq),hm=l(Sq,"SPAN",{});var AZ=r(hm);G7=n(AZ,"NVMe Support"),AZ.forEach(t),Sq.forEach(t),ig=c(e),Ni=l(e,"P",{});var TZ=r(Ni);M7=n(TZ,`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
smart partitioning and tiling algorithms each GPU needs to send and receive very small amounts of data during
offloading so modern NVMe proved to be fit to allow for an even larger total memory pool available to your training
process. ZeRO-Infinity requires ZeRO-3 enabled.`),TZ.forEach(t),ug=c(e),Hi=l(e,"P",{});var SZ=r(Hi);L7=n(SZ,"The following configuration example enables NVMe to offload both optimizer states and the params:"),SZ.forEach(t),cg=c(e),d(hl.$$.fragment,e),hg=c(e),ia=l(e,"P",{});var Cq=r(ia);Z7=n(Cq,`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),fm=l(Cq,"EM",{});var CZ=r(fm);N7=n(CZ,"\u201Cdevice\u201D: \u201Ccpu\u201D"),CZ.forEach(t),H7=n(Cq,")."),Cq.forEach(t),fg=c(e),Ye=l(e,"P",{});var mh=r(Ye);B7=n(mh,"Here is the full documentation for offloading "),fl=l(mh,"A",{href:!0,rel:!0});var xZ=r(fl);W7=n(xZ,"optimizer states"),xZ.forEach(t),F7=n(mh," and "),dl=l(mh,"A",{href:!0,rel:!0});var RZ=r(dl);V7=n(RZ,"parameters"),RZ.forEach(t),Y7=n(mh,"."),mh.forEach(t),dg=c(e),ua=l(e,"P",{});var xq=r(ua);K7=n(xq,"Make sure that your "),dm=l(xq,"CODE",{});var IZ=r(dm);J7=n(IZ,"nvme_path"),IZ.forEach(t),X7=n(xq,` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),xq.forEach(t),mg=c(e),Ke=l(e,"P",{});var _h=r(Ke);Q7=n(_h,"In order to figure out the optimal "),mm=l(_h,"CODE",{});var UZ=r(mm);eP=n(UZ,"aio"),UZ.forEach(t),sP=n(_h,` configuration block you must run a benchmark on your target setup, as
