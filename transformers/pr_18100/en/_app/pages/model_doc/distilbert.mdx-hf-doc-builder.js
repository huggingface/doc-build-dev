...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18100/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18100/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);c1=i(Yw,"span start logits"),Yw.forEach(t),p1=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);h1=i(Zw,"span end logits"),Zw.forEach(t),u1=i(yl,")."),yl.forEach(t),f1=h(Bt),ia=n(Bt,"P",{});var su=r(ia);m1=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e0=r(nl);g1=i(e0,"TFPreTrainedModel"),e0.forEach(t),_1=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),b1=h(Bt),la=n(Bt,"P",{});var ou=r(la);v1=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t0=r(da);k1=i(t0,"tf.keras.Model"),t0.forEach(t),T1=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$1=h(Bt),$(Uo.$$.fragment,Bt),w1=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),y1=h(Zt),Ms=n(Zt,"P",{});var Dl=r(Ms);D1=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var s0=r(rl);F1=i(s0,"TFDistilBertForQuestionAnswering"),s0.forEach(t),B1=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var o0=r(Ad);x1=i(o0,"__call__"),o0.forEach(t),M1=i(Dl," special method."),Dl.forEach(t),E1=h(Zt),$(Ho.$$.fragment,Zt),z1=h(Zt),$(Ko.$$.fragment,Zt),j1=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n0=r(Jo);Od=n(n0,"SPAN",{});var r0=r(Od);$(pa.$$.fragment,r0),r0.forEach(t),n0.forEach(t),C1=h(nu),Nd=n(nu,"SPAN",{});var a0=r(Nd);q1=i(a0,"FlaxDistilBertModel"),a0.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),P1=h(st),Ld=n(st,"P",{});var i0=r(Ld);A1=i(i0,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i0.forEach(t),O1=h(st),ua=n(st,"P",{});var ru=r(ua);N1=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l0=r(al);L1=i(l0,"FlaxPreTrainedModel"),l0.forEach(t),S1=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),I1=h(st),fa=n(st,"P",{});var au=r(fa);W1=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d0=r(ma);Q1=i(d0,"flax.linen.Module"),d0.forEach(t),R1=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),U1=h(st),Sd=n(st,"P",{});var c0=r(Sd);H1=i(c0,"Finally, this model supports inherent JAX features such as:"),c0.forEach(t),K1=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p0=r(Id);ga=n(p0,"A",{href:!0,rel:!0});var h0=r(ga);V1=i(h0,"Just-In-Time (JIT) compilation"),h0.forEach(t),p0.forEach(t),J1=h(kn),Wd=n(kn,"LI",{});var u0=r(Wd);_a=n(u0,"A",{href:!0,rel:!0});var f0=r(_a);G1=i(f0,"Automatic Differentiation"),f0.forEach(t),u0.forEach(t),X1=h(kn),Qd=n(kn,"LI",{});var m0=r(Qd);ba=n(m0,"A",{href:!0,rel:!0});var g0=r(ba);Y1=i(g0,"Vectorization"),g0.forEach(t),m0.forEach(t),Z1=h(kn),Rd=n(kn,"LI",{});var _0=r(Rd);va=n(_0,"A",{href:!0,rel:!0});var b0=r(va);ev=i(b0,"Parallelization"),b0.forEach(t),_0.forEach(t),kn.forEach(t),tv=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sv=h(Tn),zs=n(Tn,"P",{});var Fl=r(zs);ov=i(Fl,"The "),Ud=n(Fl,"CODE",{});var v0=r(Ud);nv=i(v0,"FlaxDistilBertPreTrainedModel"),v0.forEach(t),rv=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k0=r(Hd);av=i(k0,"__call__"),k0.forEach(t),iv=i(Fl," special method."),Fl.forEach(t),lv=h(Tn),$(Go.$$.fragment,Tn),dv=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T0=r(Yo);Kd=n(T0,"SPAN",{});var $0=r(Kd);$(Ta.$$.fragment,$0),$0.forEach(t),T0.forEach(t),cv=h(iu),Vd=n(iu,"SPAN",{});var w0=r(Vd);pv=i(w0,"FlaxDistilBertForMaskedLM"),w0.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hv=h(ot),wa=n(ot,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y0=r(Jd);fv=i(y0,"language modeling"),y0.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(ot),ya=n(ot,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D0=r(il);bv=i(D0,"FlaxPreTrainedModel"),D0.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kv=h(ot),Da=n(ot,"P",{});var cu=r(Da);Tv=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var F0=r(Fa);$v=i(F0,"flax.linen.Module"),F0.forEach(t),wv=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yv=h(ot),Gd=n(ot,"P",{});var B0=r(Gd);Dv=i(B0,"Finally, this model supports inherent JAX features such as:"),B0.forEach(t),Fv=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var x0=r(Xd);Ba=n(x0,"A",{href:!0,rel:!0});var M0=r(Ba);Bv=i(M0,"Just-In-Time (JIT) compilation"),M0.forEach(t),x0.forEach(t),xv=h($n),Yd=n($n,"LI",{});var E0=r(Yd);xa=n(E0,"A",{href:!0,rel:!0});var z0=r(xa);Mv=i(z0,"Automatic Differentiation"),z0.forEach(t),E0.forEach(t),Ev=h($n),Zd=n($n,"LI",{});var j0=r(Zd);Ma=n(j0,"A",{href:!0,rel:!0});var C0=r(Ma);zv=i(C0,"Vectorization"),C0.forEach(t),j0.forEach(t),jv=h($n),ec=n($n,"LI",{});var q0=r(ec);Ea=n(q0,"A",{href:!0,rel:!0});var P0=r(Ea);Cv=i(P0,"Parallelization"),P0.forEach(t),q0.forEach(t),$n.forEach(t),qv=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pv=h(wn),Cs=n(wn,"P",{});var Bl=r(Cs);Av=i(Bl,"The "),tc=n(Bl,"CODE",{});var A0=r(tc);Ov=i(A0,"FlaxDistilBertPreTrainedModel"),A0.forEach(t),Nv=i(Bl," forward method, overrides the "),sc=n(Bl,"CODE",{});var O0=r(sc);Lv=i(O0,"__call__"),O0.forEach(t),Sv=i(Bl," special method."),Bl.forEach(t),Iv=h(wn),$(Zo.$$.fragment,wn),Wv=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N0=r(tn);oc=n(N0,"SPAN",{});var L0=r(oc);$(ja.$$.fragment,L0),L0.forEach(t),N0.forEach(t),Qv=h(pu),nc=n(pu,"SPAN",{});var S0=r(nc);Rv=i(S0,"FlaxDistilBertForSequenceClassification"),S0.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uv=h(nt),rc=n(nt,"P",{});var I0=r(rc);Hv=i(I0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I0.forEach(t),Kv=h(nt),qa=n(nt,"P",{});var hu=r(qa);Vv=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W0=r(ll);Jv=i(W0,"FlaxPreTrainedModel"),W0.forEach(t),Gv=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xv=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yv=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q0=r(Aa);Zv=i(Q0,"flax.linen.Module"),Q0.forEach(t),ek=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var R0=r(ac);sk=i(R0,"Finally, this model supports inherent JAX features such as:"),R0.forEach(t),ok=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U0=r(ic);Oa=n(U0,"A",{href:!0,rel:!0});var H0=r(Oa);nk=i(H0,"Just-In-Time (JIT) compilation"),H0.forEach(t),U0.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var K0=r(lc);Na=n(K0,"A",{href:!0,rel:!0});var V0=r(Na);ak=i(V0,"Automatic Differentiation"),V0.forEach(t),K0.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var J0=r(dc);La=n(J0,"A",{href:!0,rel:!0});var G0=r(La);lk=i(G0,"Vectorization"),G0.forEach(t),J0.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var X0=r(cc);Sa=n(X0,"A",{href:!0,rel:!0});var Y0=r(Sa);ck=i(Y0,"Parallelization"),Y0.forEach(t),X0.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),hk=h(Dn),Ps=n(Dn,"P",{});var xl=r(Ps);uk=i(xl,"The "),pc=n(xl,"CODE",{});var Z0=r(pc);fk=i(Z0,"FlaxDistilBertPreTrainedModel"),Z0.forEach(t),mk=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);gk=i(ey,"__call__"),ey.forEach(t),_k=i(xl," special method."),xl.forEach(t),bk=h(Dn),$(sn.$$.fragment,Dn),vk=h(Dn),$(on.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kk=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);Tk=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),mc=n(rt,"P",{});var ny=r(mc);wk=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
