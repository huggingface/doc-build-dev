...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16922/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16922/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16922/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qv=p(),dt=n("div"),y(qr.$$.fragment),Vv=p(),Lo=n("p"),Jv=r("The "),bd=n("a"),Kv=r("RobertaForQuestionAnswering"),Gv=r(" forward method, overrides the "),pp=n("code"),Xv=r("__call__"),Yv=r(" special method."),Zv=p(),y(Zn.$$.fragment),e2=p(),y(es.$$.fragment),t2=p(),y(ts.$$.fragment),hf=p(),Ao=n("h2"),os=n("a"),hp=n("span"),y(jr.$$.fragment),o2=p(),mp=n("span"),n2=r("TFRobertaModel"),mf=p(),Qe=n("div"),y(Pr.$$.fragment),s2=p(),fp=n("p"),a2=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),r2=p(),Lr=n("p"),i2=r("This model inherits from "),kd=n("a"),l2=r("TFPreTrainedModel"),d2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c2=p(),Ar=n("p"),p2=r("This model is also a "),Or=n("a"),h2=r("tf.keras.Model"),m2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),f2=p(),y(ns.$$.fragment),u2=p(),Rt=n("div"),y(Nr.$$.fragment),g2=p(),Oo=n("p"),_2=r("The "),vd=n("a"),b2=r("TFRobertaModel"),k2=r(" forward method, overrides the "),up=n("code"),v2=r("__call__"),y2=r(" special method."),T2=p(),y(ss.$$.fragment),w2=p(),y(as.$$.fragment),ff=p(),No=n("h2"),rs=n("a"),gp=n("span"),y(Ir.$$.fragment),$2=p(),_p=n("span"),F2=r("TFRobertaForCausalLM"),uf=p(),Io=n("div"),y(Dr.$$.fragment),x2=p(),Mt=n("div"),y(Sr.$$.fragment),R2=p(),Do=n("p"),M2=r("The "),yd=n("a"),E2=r("TFRobertaForCausalLM"),z2=r(" forward method, overrides the "),bp=n("code"),C2=r("__call__"),q2=r(" special method."),j2=p(),y(is.$$.fragment),P2=p(),y(ls.$$.fragment),gf=p(),So=n("h2"),ds=n("a"),kp=n("span"),y(Wr.$$.fragment),L2=p(),vp=n("span"),A2=r("TFRobertaForMaskedLM"),_f=p(),Ve=n("div"),y(Br.$$.fragment),O2=p(),Ur=n("p"),N2=r("RoBERTa Model with a "),yp=n("code"),I2=r("language modeling"),D2=r(" head on top."),S2=p(),Hr=n("p"),W2=r("This model inherits from "),Td=n("a"),B2=r("TFPreTrainedModel"),U2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),H2=p(),Qr=n("p"),Q2=r("This model is also a "),Vr=n("a"),V2=r("tf.keras.Model"),J2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),K2=p(),y(cs.$$.fragment),G2=p(),ct=n("div"),y(Jr.$$.fragment),X2=p(),Wo=n("p"),Y2=r("The "),wd=n("a"),Z2=r("TFRobertaForMaskedLM"),ey=r(" forward method, overrides the "),Tp=n("code"),ty=r("__call__"),oy=r(" special method."),ny=p(),y(ps.$$.fragment),sy=p(),y(hs.$$.fragment),ay=p(),y(ms.$$.fragment),bf=p(),Bo=n("h2"),fs=n("a"),wp=n("span"),y(Kr.$$.fragment),ry=p(),$p=n("span"),iy=r("TFRobertaForSequenceClassification"),kf=p(),Je=n("div"),y(Gr.$$.fragment),ly=p(),Fp=n("p"),dy=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Aw=p(),Zp=n("p"),Ow=r("Finally, this model supports inherent JAX features such as:"),Nw=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),Iw=r("Just-In-Time (JIT) compilation"),Dw=p(),th=n("li"),Li=n("a"),Sw=r("Automatic Differentiation"),Ww=p(),oh=n("li"),Ai=n("a"),Bw=r("Vectorization"),Uw=p(),nh=n("li"),Oi=n("a"),Hw=r("Parallelization"),Qw=p(),Ct=n("div"),y(Ni.$$.fragment),Vw=p(),tn=n("p"),Jw=r("The "),sh=n("code"),Kw=r("FlaxRobertaPreTrainedModel"),Gw=r(" forward method, overrides the "),ah=n("code"),Xw=r("__call__"),Yw=r(" special method."),Zw=p(),y(Os.$$.fragment),e1=p(),y(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),y(Ii.$$.fragment),t1=p(),ih=n("span"),o1=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),y(Di.$$.fragment),n1=p(),Si=n("p"),s1=r("RoBERTa Model with a "),lh=n("code"),a1=r("language modeling"),r1=r(" head on top."),i1=p(),Wi=n("p"),l1=r("This model inherits from "),Pd=n("a"),d1=r("FlaxPreTrainedModel"),c1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),p1=p(),Bi=n("p"),h1=r("This model is also a Flax Linen "),Ui=n("a"),m1=r("flax.linen.Module"),f1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u1=p(),dh=n("p"),g1=r("Finally, this model supports inherent JAX features such as:"),_1=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b1=r("Just-In-Time (JIT) compilation"),k1=p(),ph=n("li"),Qi=n("a"),v1=r("Automatic Differentiation"),y1=p(),hh=n("li"),Vi=n("a"),T1=r("Vectorization"),w1=p(),mh=n("li"),Ji=n("a"),$1=r("Parallelization"),F1=p(),qt=n("div"),y(Ki.$$.fragment),x1=p(),nn=n("p"),R1=r("The "),fh=n("code"),M1=r("FlaxRobertaPreTrainedModel"),E1=r(" forward method, overrides the "),uh=n("code"),z1=r("__call__"),C1=r(" special method."),q1=p(),y(Ds.$$.fragment),j1=p(),y(Ss.$$.fragment),qf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),y(Gi.$$.fragment),P1=p(),_h=n("span"),L1=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),y(Xi.$$.fragment),A1=p(),bh=n("p"),O1=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q1=p(),kh=n("p"),V1=r("Finally, this model supports inherent JAX features such as:"),J1=p(),Vt=n("ul"),vh=n("li"),tl=n("a"),K1=r("Just-In-Time (JIT) compilation"),G1=p(),yh=n("li"),ol=n("a"),X1=r("Automatic Differentiation"),Y1=p(),Th=n("li"),nl=n("a"),Z1=r("Vectorization"),e$=p(),wh=n("li"),sl=n("a"),t$=r("Parallelization"),o$=p(),jt=n("div"),y(al.$$.fragment),n$=p(),an=n("p"),s$=r("The "),$h=n("code"),a$=r("FlaxRobertaPreTrainedModel"),r$=r(" forward method, overrides the "),Fh=n("code"),i$=r("__call__"),l$=r(" special method."),d$=p(),y(Bs.$$.fragment),c$=p(),y(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),y(rl.$$.fragment),p$=p(),Rh=n("span"),h$=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),y(il.$$.fragment),m$=p(),Mh=n("p"),f$=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),u$=p(),ll=n("p"),g$=r("This model inherits from "),Ad=n("a"),_$=r("FlaxPreTrainedModel"),b$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k$=p(),dl=n("p"),v$=r("This model is also a Flax Linen "),cl=n("a"),y$=r("flax.linen.Module"),T$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w$=p(),Eh=n("p"),$$=r("Finally, this model supports inherent JAX features such as:"),F$=p(),Jt=n("ul"),zh=n("li"),pl=n("a"),x$=r("Just-In-Time (JIT) compilation"),R$=p(),Ch=n("li"),hl=n("a"),M$=r("Automatic Differentiation"),E$=p(),qh=n("li"),ml=n("a"),z$=r("Vectorization"),C$=p(),jh=n("li"),fl=n("a"),q$=r("Parallelization"),j$=p(),Pt=n("div"),y(ul.$$.fragment),P$=p(),ln=n("p"),L$=r("The "),Ph=n("code"),A$=r("FlaxRobertaPreTrainedModel"),O$=r(" forward method, overrides the "),Lh=n("code"),N$=r("__call__"),I$=r(" special method."),D$=p(),y(Qs.$$.fragment),S$=p(),y(Vs.$$.fragment),Af=p(),dn=n("h2"),Js=n("a"),Ah=n("span"),y(gl.$$.fragment),W$=p(),Oh=n("span"),B$=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),y(_l.$$.fragment),U$=p(),Nh=n("p"),H$=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q$=p(),bl=n("p"),V$=r("This model inherits from "),Od=n("a"),J$=r("FlaxPreTrainedModel"),K$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),G$=p(),kl=n("p"),X$=r("This model is also a Flax Linen "),vl=n("a"),Y$=r("flax.linen.Module"),Z$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(qr.$$.fragment,po),Vv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var yx=a(bd);Kv=i(yx,"RobertaForQuestionAnswering"),yx.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var Tx=a(pp);Xv=i(Tx,"__call__"),Tx.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),T(Zn.$$.fragment,po),e2=h(po),T(es.$$.fragment,po),t2=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var wx=a(os);hp=s(wx,"SPAN",{});var $x=a(hp);T(jr.$$.fragment,$x),$x.forEach(t),wx.forEach(t),o2=h(gu),mp=s(gu,"SPAN",{});var Fx=a(mp);n2=i(Fx,"TFRobertaModel"),Fx.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),s2=h(Ot),fp=s(Ot,"P",{});var xx=a(fp);a2=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),r2=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);i2=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var Rx=a(kd);l2=i(Rx,"TFPreTrainedModel"),Rx.forEach(t),d2=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),c2=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);p2=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var Mx=a(Or);h2=i(Mx,"tf.keras.Model"),Mx.forEach(t),m2=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),f2=h(Ot),T(ns.$$.fragment,Ot),u2=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),g2=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_2=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var Ex=a(vd);b2=i(Ex,"TFRobertaModel"),Ex.forEach(t),k2=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var zx=a(up);v2=i(zx,"__call__"),zx.forEach(t),y2=i(Gd," special method."),Gd.forEach(t),T2=h(na),T(ss.$$.fragment,na),w2=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var Cx=a(rs);gp=s(Cx,"SPAN",{});var qx=a(gp);T(Ir.$$.fragment,qx),qx.forEach(t),Cx.forEach(t),$2=h(ku),_p=s(ku,"SPAN",{});var jx=a(_p);F2=i(jx,"TFRobertaForCausalLM"),jx.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),x2=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),R2=h(sa),Do=s(sa,"P",{});var Xd=a(Do);M2=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var Px=a(yd);E2=i(Px,"TFRobertaForCausalLM"),Px.forEach(t),z2=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var Lx=a(bp);C2=i(Lx,"__call__"),Lx.forEach(t),q2=i(Xd," special method."),Xd.forEach(t),j2=h(sa),T(is.$$.fragment,sa),P2=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var Ax=a(ds);kp=s(Ax,"SPAN",{});var Ox=a(kp);T(Wr.$$.fragment,Ox),Ox.forEach(t),Ax.forEach(t),L2=h(yu),vp=s(yu,"SPAN",{});var Nx=a(vp);A2=i(Nx,"TFRobertaForMaskedLM"),Nx.forEach(t),yu.forEach(t),_f=h(o),Ve=s(o,"DIV",{class:!0});var Nt=a(Ve);T(Br.$$.fragment,Nt),O2=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);N2=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var Ix=a(yp);I2=i(Ix,"language modeling"),Ix.forEach(t),D2=i(Tu," head on top."),Tu.forEach(t),S2=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);W2=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var Dx=a(Td);B2=i(Dx,"TFPreTrainedModel"),Dx.forEach(t),U2=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),H2=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Q2=i($u,"This model is also a "),Vr=s($u,"A",{href:!0,rel:!0});var Sx=a(Vr);V2=i(Sx,"tf.keras.Model"),Sx.forEach(t),J2=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),K2=h(Nt),T(cs.$$.fragment,Nt),G2=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Jr.$$.fragment,ho),X2=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y2=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var Wx=a(wd);Z2=i(Wx,"TFRobertaForMaskedLM"),Wx.forEach(t),ey=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var Bx=a(Tp);ty=i(Bx,"__call__"),Bx.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),T(ps.$$.fragment,ho),sy=h(ho),T(hs.$$.fragment,ho),ay=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var Ux=a(fs);wp=s(Ux,"SPAN",{});var Hx=a(wp);T(Kr.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),ry=h(Fu),$p=s(Fu,"SPAN",{});var Qx=a($p);iy=i(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);T(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var Vx=a(Fp);dy=i(Vx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
