...
--disable-pip-version-check 2&gt;&amp;1 | <span class="hljs-built_in">tee</span> build.log`}}),to=new g({props:{codee:'CUDA_VISIBLE_DEVICES=0 python -c "import torch; print(torch.cuda.get_device_capability())",',highlighted:'CUDA_VISIBLE_DEVICES=0 python -c <span class="hljs-string">&quot;import torch; print(torch.cuda.get_device_capability())&quot;</span>'}}),ao=new g({props:{codee:`git clone https://github.com/microsoft/DeepSpeed/
cd DeepSpeed
rm -rf build
...
python setup.py build_ext -j8 bdist_wheel`}}),oo=new g({props:{codee:'python -c "import torch; print(torch.cuda.get_arch_list())",',highlighted:'python -c <span class="hljs-string">&quot;import torch; print(torch.cuda.get_arch_list())&quot;</span>'}}),lo=new g({props:{codee:`CUDA_VISIBLE_DEVICES=0 python -c "import torch; \\
...
print(torch.cuda.get_device_properties(torch.device(&#x27;cuda&#x27;)))&quot;</span>`}}),ro=new g({props:{codee:"_CudaDeviceProperties(name='GeForce RTX 3090', major=8, minor=6, total_memory=24268MB, multi_processor_count=82),",highlighted:'_CudaDeviceProperties(name=<span class="hljs-string">&#x27;GeForce RTX 3090&#x27;</span>, major=8, minor=6, total_memory=24268MB, multi_processor_count=82)'}}),io=new y({}),co=new g({props:{codee:"python -m torch.distributed.launch --nproc_per_node=2 your_program.py <normal cl args>,",highlighted:"python -m torch.distributed.launch --nproc_per_node=2 your_program.py &lt;normal cl args&gt;"}}),ho=new g({props:{codee:"deepspeed --num_gpus=2 your_program.py <normal cl args> --deepspeed ds_config.json,",highlighted:"deepspeed --num_gpus=2 your_program.py &lt;normal cl args&gt; --deepspeed ds_config.json"}}),mo=new g({props:{codee:`deepspeed examples/pytorch/translation/run_translation.py \\
...
--source_lang en --target_lang ro`}}),vo=new y({}),jo=new g({props:{codee:`deepspeed --num_gpus=1 examples/pytorch/translation/run_translation.py \\
...
--do_train --max_train_samples 500 --num_train_epochs 1 \\
--dataset_name wmt16 --dataset_config <span class="hljs-string">&quot;ro-en&quot;</span> \\
--source_lang en --target_lang ro`}}),yo=new g({props:{codee:`{
  "zero_optimization": {
     "stage": 2,
     "offload_optimizer": {
         "device": "cpu",
...
<span class="hljs-punctuation">}</span>`}}),qo=new g({props:{codee:"deepspeed --include localhost:1 examples/pytorch/translation/run_translation.py ...,",highlighted:"deepspeed --include localhost:1 examples/pytorch/translation/run_translation.py ..."}}),Eo=new y({}),$o=new g({props:{codee:`# DeepSpeed requires a distributed environment even when only one process is used.
...
trainer = Trainer(...)
trainer.train()`}}),ko=new g({props:{codee:`%%bash
...
EOT`}}),Po=new g({props:{codee:`!git clone https://github.com/huggingface/transformers
...
!cd transformers; deepspeed examples/pytorch/translation/run_translation.py ...`}}),zo=new g({props:{codee:`%%bash
...
git clone https://github.com/huggingface/transformers
cd transformers
deepspeed examples/pytorch/translation/run_translation.py ...`}}),Do=new y({}),Ao=new g({props:{codee:`git clone https://github.com/microsoft/DeepSpeedExamples
...
find . -name <span class="hljs-string">&#x27;*json&#x27;</span>`}}),So=new g({props:{codee:"grep -i Lamb $(find . -name '*json'),",highlighted:'grep -i Lamb $(find . -name <span class="hljs-string">&#x27;*json&#x27;</span>)'}}),xo=new g({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
...
<span class="hljs-punctuation">}</span>`}}),Ro=new y({}),Io=new g({props:{codee:'TrainingArguments(..., deepspeed="/path/to/ds_config.json"),',highlighted:'TrainingArguments(..., deepspeed=<span class="hljs-string">&quot;/path/to/ds_config.json&quot;</span>)'}}),Uo=new g({props:{codee:`ds_config_dict = dict(scheduler=scheduler_params, optimizer=optimizer_params)
...
TrainingArguments(..., deepspeed=ds_config_dict)`}}),Go=new y({}),Wt=new NV({props:{warning:"&lcub;true}",$$slots:{default:[VV]},$$scope:{ctx:Zn}}}),Mo=new y({}),Bo=new y({}),Wo=new g({props:{codee:`{
    "zero_optimization": {
        "stage": 2,
        "offload_optimizer": {
            "device": "cpu",
    ...
    <span class="hljs-attr">&quot;zero_optimization&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;contiguous_gradients&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Fo=new g({props:{codee:`{
    "zero_optimization": {
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Vo=new y({}),Yo=new g({props:{codee:`{
    "zero_optimization": {
        "stage": 3,
        "offload_optimizer": {
            "device": "cpu",
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),ol=new y({}),ll=new g({props:{codee:`{
    "zero_optimization": {
        "stage": 3,
        "offload_optimizer": {
            "device": "nvme",
    ...
    <span class="hljs-attr">&quot;zero_optimization&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;stage3_gather_fp16_weights_on_model_save&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),ul=new y({}),hl=new y({}),fl=new g({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
...
<span class="hljs-punctuation">}</span>`}}),dl=new g({props:{codee:`{
    "fp16": {
        "enabled": true,
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;steps_per_print&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">2000</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;wall_clock_breakdown&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">false</span>
<span class="hljs-punctuation">}</span>`}}),ml=new y({}),_l=new g({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;train_micro_batch_size_per_gpu&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;auto&quot;</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;wall_clock_breakdown&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">false</span>
<span class="hljs-punctuation">}</span>`}}),vl=new g({props:{codee:`{
    "fp16": {
        "enabled": true,
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;steps_per_print&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">2000</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;wall_clock_breakdown&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">false</span>
<span class="hljs-punctuation">}</span>`}}),jl=new y({}),gl=new y({}),wl=new g({props:{codee:`{
   "optimizer": {
       "type": "AdamW",
       "params": {
         "lr": "auto",
   ...
   <span class="hljs-attr">&quot;optimizer&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
       ...
       <span class="hljs-punctuation">}</span>
   <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),kl=new g({props:{codee:`{
   "optimizer": {
       "type": "AdamW",
       "params": {
         "lr": 0.001,
   ...
   <span class="hljs-attr">&quot;optimizer&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
       ...
       <span class="hljs-punctuation">}</span>
   <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Pl=new g({props:{codee:`{
...
<span class="hljs-punctuation">}</span>`}}),zl=new y({}),Tl=new g({props:{codee:`{
   "scheduler": {
         "type": "WarmupLR",
         "params": {
             "warmup_min_lr": "auto",
   ...
   <span class="hljs-attr">&quot;scheduler&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
         ...
         <span class="hljs-punctuation">}</span>
     <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Al=new g({props:{codee:`{
   "scheduler": {
         "type": "WarmupLR",
         "params": {
             "warmup_min_lr": 0,
   ...
   <span class="hljs-attr">&quot;scheduler&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
         ...
         <span class="hljs-punctuation">}</span>
     <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Sl=new g({props:{codee:`{
   "scheduler": {
         "type": "WarmupDecayLR",
         "params": {
   ...
   <span class="hljs-attr">&quot;scheduler&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
         ...
         <span class="hljs-punctuation">}</span>
     <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Cl=new y({}),xl=new g({props:{codee:`{
    "fp16": {
        "enabled": "false",
    }
},`,highlighted:`<span class="hljs-punctuation">{</span>
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Il=new y({}),Ul=new g({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;fp16&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;min_loss_scale&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">1</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Gl=new g({props:{codee:`{
    "fp16": {
        "enabled": true,
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;fp16&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;min_loss_scale&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">1</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Ml=new g({props:{codee:`"amp": {
    "enabled": "auto",
    "opt_level": "auto"
...
<span class="hljs-punctuation">}</span>`}}),Zl=new g({props:{codee:`{
    "amp": {
        "enabled": true,
        "opt_level": "O1"
    }
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Hl=new y({}),Bl=new g({props:{codee:`{
    "train_batch_size": "auto",
    "train_micro_batch_size_per_gpu": "auto"
},`,highlighted:`<span class="hljs-punctuation">{</span>
    <span class="hljs-attr">&quot;train_batch_size&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;auto&quot;</span><span class="hljs-punctuation">,</span>
...
<span class="hljs-punctuation">}</span>`}}),Wl=new g({props:{codee:`{
    "train_batch_size": 12,
...
<span class="hljs-punctuation">}</span>`}}),Ql=new y({}),er=new g({props:{codee:`{
    ...
    <span class="hljs-attr">&quot;zero_optimization&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        <span class="hljs-attr">&quot;stage3_gather_fp16_weights_on_model_save&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),tr=new g({props:{codee:`from transformers.trainer_utils import get_last_checkpoint
...
checkpoint_dir = get_last_checkpoint(trainer.args.output_dir)
fp32_model = load_state_dict_from_zero_checkpoint(trainer.model, checkpoint_dir)`}}),ar=new g({props:{codee:`from deepspeed.utils.zero_to_fp32 import load_state_dict_from_zero_checkpoint
...
trainer.deepspeed.save_checkpoint(checkpoint_dir)
fp32_model = load_state_dict_from_zero_checkpoint(trainer.model, checkpoint_dir)`}}),Ha=new NV({props:{$$slots:{default:[YV]},$$scope:{ctx:Zn}}}),nr=new g({props:{codee:`from deepspeed.utils.zero_to_fp32 import get_fp32_state_dict_from_zero_checkpoint
...
model = model.cpu()
model.load_state_dict(state_dict)`}}),or=new g({props:{codee:`$ ls -l output_dir/checkpoint-1/
...
-rw-rw-r-- 1 stas stas  339 Mar 27 20:42 trainer_state.json
-rw-rw-r-- 1 stas stas 2.3K Mar 27 20:42 training_args.bin
-rwxrw-r-- 1 stas stas 5.5K Mar 27 13:16 zero_to_fp32.py*`}}),lr=new g({props:{codee:"python zero_to_fp32.py . pytorch_model.bin,",highlighted:"python zero_to_fp32.py . pytorch_model.bin"}}),pr=new y({}),ir=new y({}),ur=new g({props:{codee:`from transformers import T5ForConditionalGeneration, T5Config
import deepspeed
...
<span class="hljs-keyword">with</span> deepspeed.zero.Init():
    ...
    model = T5ForConditionalGeneration(config)`}}),cr=new g({props:{codee:`from transformers import AutoModel, Trainer, TrainingArguments
...
trainer = Trainer(model=model, args=training_args, ...)`}}),fr=new y({}),_r=new g({props:{codee:'tensor([1.0], device="cuda:0", dtype=torch.float16, requires_grad=True),',highlighted:'tensor([<span class="hljs-number">1.0</span>], device=<span class="hljs-string">&quot;cuda:0&quot;</span>, dtype=torch.float16, requires_grad=<span class="hljs-literal">True</span>)'}}),vr=new y({}),jr=new g({props:{codee:"deepspeed --num_gpus=2 your_program.py <normal cl args> --do_eval --deepspeed ds_config.json,",highlighted:"deepspeed --num_gpus=2 your_program.py &lt;normal cl args&gt; --do_eval --deepspeed ds_config.json"}}),gr=new g({props:{codee:`deepspeed examples/pytorch/translation/run_translation.py \\
--deepspeed tests/deepspeed/ds_config_zero3.json \\
...
--source_lang en --target_lang ro --dataset_name wmt16 \\
--source_prefix <span class="hljs-string">&quot;translate English to Romanian: &quot;</span>`}}),yr=new y({}),wr=new g({props:{codee:`$ python -c 'from transformers import AutoModel; \\
...
SW: Model with 2783M total params, 65M largest layer params.
  per CPU  |  per GPU |   Options
   ...
   62.23GB |   5.43GB | offload_param=none, offload_optimizer=cpu , zero_init=0
    0.37GB |  46.91GB | offload_param=none, offload_optimizer=none, zero_init=1
   15.56GB |  46.91GB | offload_param=none, offload_optimizer=none, zero_init=0`}}),br=new g({props:{codee:`$ python -c 'from transformers import AutoModel; \\
from deepspeed.runtime.zero.stage3 import estimate_zero3_model_states_mem_needs_all_live; \\
model = AutoModel.from_pretrained("bigscience/T0_3B"); \\
...
SW: Model with 2783M total params, 65M largest layer params.
  per CPU  |  per GPU |   Options
   ...
   62.23GB |   2.84GB | offload_param=none, offload_optimizer=cpu , zero_init=0
    0.74GB |  23.58GB | offload_param=none, offload_optimizer=none, zero_init=1
   31.11GB |  23.58GB | offload_param=none, offload_optimizer=none, zero_init=0
`}}),Er=new y({}),kr=new g({props:{codee:`python -c 'import torch; print(f"torch: {torch.__version__}")'
...
python -c <span class="hljs-string">&#x27;import deepspeed; print(f&quot;deepspeed: {deepspeed.__version__}&quot;)&#x27;</span>`}}),Sr=new y({}),Cr=new y({}),Ir=new y({}),Ur=new g({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;fp16&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;min_loss_scale&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">1</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Gr=new g({props:{codee:`0%|                                                                                                                             | 0/189 [00:00<?, ?it/s]
...
[...],`,highlighted:`<span class="hljs-number">0</span>%|                                                                                                                             | <span class="hljs-number">0</span>/<span class="hljs-number">189</span> [<span class="hljs-number">00</span>:<span class="hljs-number">00</span>&lt;?, ?it/s]
 ...
 [deepscale] OVERFLOW! <span class="hljs-built_in">Rank</span> <span class="hljs-number">0</span> Skipping <span class="hljs-built_in">step</span>. Attempted loss scale: <span class="hljs-number">1</span>, reducing <span class="hljs-keyword">to</span> <span class="hljs-number">1</span>
[...]`}}),Lr=new y({}),Hr=new y({}),Br=new g({props:{codee:`from transformers.deepspeed import HfDeepSpeedConfig
...
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Wr=new g({props:{codee:`from transformers.deepspeed import HfDeepSpeedConfig
...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15886/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15886/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15886/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15886/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15886/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{codee:`#!/usr/bin/env python
