import{S as TP,i as CP,s as bP,e as n,k as l,w as g,t as a,M as yP,c as s,d as o,m as d,a as r,x as _,h as i,b as c,F as e,g as m,y as v,q as P,o as I,B as T}from"../../chunks/vendor-4833417e.js";import{T as ce}from"../../chunks/Tip-fffd6df1.js";import{D as $}from"../../chunks/Docstring-44c5af16.js";import{C as N}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as D}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function LP(x){let p,L,u,b,y;return{c(){p=n("p"),L=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),b=a("Module"),y=a(`
...
testing).`,name:"initializer_factor"}]}}),mn=new N({props:{code:`from transformers import CLIPTextModel, CLIPTextConfig
...
A factor for initializing all weight matrices (should be kept to 1, used internally for initialization
testing).`,name:"initializer_factor"}]}}),_n=new N({props:{code:`from transformers import CLIPVisionModel, CLIPVisionConfig
...
`}}),Co=new ce({props:{$$slots:{default:[LP]},$$scope:{ctx:x}}}),Xn=new N({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, CLIPModel
...
applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_15886/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</p>
`}}),bo=new ce({props:{$$slots:{default:[kP]},$$scope:{ctx:x}}}),Qn=new N({props:{code:`from transformers import CLIPTokenizer, CLIPModel
...
applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_15886/en/model_doc/clip#transformers.CLIPVisionModel"
>CLIPVisionModel</a>.</p>
`}}),yo=new ce({props:{$$slots:{default:[$P]},$$scope:{ctx:x}}}),es=new N({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, CLIPModel
...
`}}),ko=new ce({props:{$$slots:{default:[wP]},$$scope:{ctx:x}}}),ss=new N({props:{code:`from transformers import CLIPTokenizer, CLIPTextModel
...
`}}),wo=new ce({props:{$$slots:{default:[xP]},$$scope:{ctx:x}}}),ls=new N({props:{code:`from PIL import Image
import requests
...
`}}),zo=new ce({props:{$$slots:{default:[zP]},$$scope:{ctx:x}}}),us=new N({props:{code:`import tensorflow as tf
...
the projection layer to the pooled output of <a
  href="/docs/transformers/pr_15886/en/model_doc/clip#transformers.TFCLIPTextModel"
>TFCLIPTextModel</a>.</p>
`}}),jo=new ce({props:{$$slots:{default:[jP]},$$scope:{ctx:x}}}),_s=new N({props:{code:`from transformers import CLIPTokenizer, TFCLIPModel
...
`}}),Mo=new ce({props:{$$slots:{default:[MP]},$$scope:{ctx:x}}}),Ps=new N({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, TFCLIPModel
...
`}}),qo=new ce({props:{$$slots:{default:[FP]},$$scope:{ctx:x}}}),bs=new N({props:{code:`from transformers import CLIPTokenizer, TFCLIPTextModel
...
`}}),Ao=new ce({props:{$$slots:{default:[qP]},$$scope:{ctx:x}}}),$s=new N({props:{code:`from PIL import Image
import requests
...
`}}),Vo=new ce({props:{$$slots:{default:[DP]},$$scope:{ctx:x}}}),Ns=new N({props:{code:`import jax
from PIL import Image
import requests
...
`}}),Os=new N({props:{code:`from transformers import CLIPTokenizer, FlaxCLIPModel
...
`}}),Ws=new N({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, FlaxCLIPModel
...
`}}),So=new ce({props:{$$slots:{default:[AP]},$$scope:{ctx:x}}}),Hs=new N({props:{code:`from transformers import CLIPTokenizer, FlaxCLIPTextModel
...
`}}),Bo=new ce({props:{$$slots:{default:[NP]},$$scope:{ctx:x}}}),Xs=new N({props:{code:`from PIL import Image
import requests
