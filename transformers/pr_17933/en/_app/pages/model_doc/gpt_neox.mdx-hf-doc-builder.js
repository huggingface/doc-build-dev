...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(_,"CODE",{});var X=a(p);f=l(X,"Module"),X.forEach(o),b=l(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(r,_){g(r,d,_),t(d,T),t(d,p),t(p,f),t(d,b)},d(r){r&&o(d)}}}function $s(G){let d,T,p,f,b;return f=new tt({props:{code:`from transformers import GPTNeoXTokenizer, GPTNeoXForCausalLM, GPTNeoXConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),v(f.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=u(r),k(f.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(f,r,_),b=!0},p:oo,i(r){b||(P(f.$$.fragment,r),b=!0)},o(r){y(f.$$.fragment,r),b=!1},d(r){r&&o(d),r&&o(p),$(f,r)}}}function Ns(G){let d,T,p,f,b,r,_,X,A,z,F,q,ot,me,no,nt,so,Nt,R,ao,ue,ro,io,Gt,Y,lo,fe,co,po,Xt,Ie,ho,xt,ge,zt,Oe,mo,Mt,I,K,st,_e,uo,at,fo,Ft,Q,go,rt,_o,To,Ct,Te,Et,O,Z,it,be,bo,lt,vo,qt,M,ve,ko,B,wo,Be,Po,yo,ke,$o,No,Go,S,Xo,Se,xo,zo,De,Mo,Fo,Co,ee,jt,D,te,dt,we,Eo,ct,qo,Lt,N,Pe,jo,ye,Lo,pt,Ao,Io,Oo,ht,Bo,So,oe,Do,$e,Wo,mt,Ho,Uo,Vo,ne,Jo,Ne,Ro,We,Yo,Ko,At,W,se,ut,Ge,Qo,ft,Zo,It,j,Xe,en,xe,tn,ze,on,nn,sn,C,Me,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,Ot,U,ie,_t,Fe,un,Tt,fn,Bt,L,Ce,gn,V,_n,bt,Tn,bn,Ee,vn,kn,wn,E,qe,Pn,J,yn,Ue,$n,Nn,vt,Gn,Xn,xn,le,zn,de,St;return r=new Ae({}),me=new Ae({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ae({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17933/en/model_doc/gpt_neox#transformers.GPTNeoXModel">GPTNeoXModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTNeoXConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[vs]},$$scope:{ctx:G}}}),ne=new Mn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Ae({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17933/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17933/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L384"}}),Me=new et({props:{name:"forward",anchor:"transformers.GPTNeoXModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17933/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L402",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17933/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17933/en/model_doc/gpt_neox#transformers.GPTNeoXConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17933/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L522"}}),qe=new et({props:{name:"forward",anchor:"transformers.GPTNeoXForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17933/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17933/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17933/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
generous the support of `),fe=n("a"),co=i("CoreWeave"),po=i("."),Xt=m(),Ie=n("p"),ho=i("GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),xt=m(),v(ge.$$.fragment),zt=m(),Oe=n("p"),mo=i(`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Mt=m(),I=n("h3"),K=n("a"),st=n("span"),v(_e.$$.fragment),uo=m(),at=n("span"),fo=i("Generation"),Ft=m(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Ct=m(),v(Te.$$.fragment),Et=m(),O=n("h2"),Z=n("a"),it=n("span"),v(be.$$.fragment),bo=m(),lt=n("span"),vo=i("GPTNeoXConfig"),qt=m(),M=n("div"),v(ve.$$.fragment),ko=m(),B=n("p"),wo=i("This is the configuration class to store the configuration of a "),Be=n("a"),Po=i("GPTNeoXModel"),yo=i(`. It is used to instantiate an
...
documentation from `),De=n("a"),Mo=i("PretrainedConfig"),Fo=i(" for more information."),Co=m(),v(ee.$$.fragment),jt=m(),D=n("h2"),te=n("a"),dt=n("span"),v(we.$$.fragment),Eo=m(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),Lt=m(),N=n("div"),v(Pe.$$.fragment),jo=m(),ye=n("p"),Lo=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Ao=i("tokenizers"),Io=i(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),At=m(),W=n("h2"),se=n("a"),ut=n("span"),v(Ge.$$.fragment),Qo=m(),ft=n("span"),Zo=i("GPTNeoXModel"),It=m(),j=n("div"),v(Xe.$$.fragment),en=m(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=m(),C=n("div"),v(Me.$$.fragment),an=m(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=m(),v(ae.$$.fragment),mn=m(),v(re.$$.fragment),Ot=m(),U=n("h2"),ie=n("a"),_t=n("span"),v(Fe.$$.fragment),un=m(),Tt=n("span"),fn=i("GPTNeoXForCausalLM"),Bt=m(),L=n("div"),v(Ce.$$.fragment),gn=m(),V=n("p"),_n=i("GPTNeoX Model with a "),bt=n("code"),Tn=i("language modeling"),bn=i(` head on top for CLM fine-tuning.
This model is a PyTorch `),Ee=n("a"),vn=i("torch.nn.Module"),kn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wn=m(),E=n("div"),v(qe.$$.fragment),Pn=m(),J=n("p"),yn=i("The "),Ue=n("a"),$n=i("GPTNeoXForCausalLM"),Nn=i(" forward method, overrides the "),vt=n("code"),Gn=i("__call__"),Xn=i(" special method."),xn=m(),v(le.$$.fragment),zn=m(),v(de.$$.fragment),this.h()},l(e){const c=_s('[data-svelte="svelte-1phssyn"]',document.head);d=s(c,"META",{name:!0,content:!0}),c.forEach(o),T=u(e),p=s(e,"H1",{class:!0});var je=a(p);f=s(je,"A",{id:!0,class:!0,href:!0});var kt=a(f);b=s(kt,"SPAN",{});var wt=a(b);k(r.$$.fragment,wt),wt.forEach(o),kt.forEach(o),_=u(je),X=s(je,"SPAN",{});var Pt=a(X);A=l(Pt,"GPT-NeoX"),Pt.forEach(o),je.forEach(o),z=u(e),F=s(e,"H2",{class:!0});var Le=a(F);q=s(Le,"A",{id:!0,class:!0,href:!0});var yt=a(q);ot=s(yt,"SPAN",{});var $t=a(ot);k(me.$$.fragment,$t),$t.forEach(o),yt.forEach(o),no=u(Le),nt=s(Le,"SPAN",{});var Fn=a(nt);so=l(Fn,"Overview"),Fn.forEach(o),Le.forEach(o),Nt=u(e),R=s(e,"P",{});var Dt=a(R);ao=l(Dt,`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
be made freely and openly available to the public through a permissive license. It is, to the best of our knowledge,
the largest dense autoregressive model that has publicly available weights at the time of submission. In this work,
we describe GPT-NeoX-20B\u2019s architecture and training and evaluate its performance on a range of language-understanding,
mathematics, and knowledge-based tasks. We find that GPT-NeoX-20B is a particularly powerful few-shot reasoner and
gains far more in performance when evaluated five-shot than similarly sized GPT-3 and FairSeq models. We open-source
the training and evaluation code, as well as the model weights, at `),ue=s(Dt,"A",{href:!0,rel:!0});var Cn=a(ue);ro=l(Cn,"https://github.com/EleutherAI/gpt-neox"),Cn.forEach(o),io=l(Dt,"."),Dt.forEach(o),Gt=u(e),Y=s(e,"P",{});var Wt=a(Y);lo=l(Wt,`Development of the model was led by Sid Black, Stella Biderman and Eric Hallahan, and the model was trained with
generous the support of `),fe=s(Wt,"A",{href:!0,rel:!0});var En=a(fe);co=l(En,"CoreWeave"),En.forEach(o),po=l(Wt,"."),Wt.forEach(o),Xt=u(e),Ie=s(e,"P",{});var qn=a(Ie);ho=l(qn,"GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),qn.forEach(o),xt=u(e),k(ge.$$.fragment,e),zt=u(e),Oe=s(e,"P",{});var jn=a(Oe);mo=l(jn,`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),jn.forEach(o),Mt=u(e),I=s(e,"H3",{class:!0});var Ht=a(I);K=s(Ht,"A",{id:!0,class:!0,href:!0});var Ln=a(K);st=s(Ln,"SPAN",{});var An=a(st);k(_e.$$.fragment,An),An.forEach(o),Ln.forEach(o),uo=u(Ht),at=s(Ht,"SPAN",{});var In=a(at);fo=l(In,"Generation"),In.forEach(o),Ht.forEach(o),Ft=u(e),Q=s(e,"P",{});var Ut=a(Q);go=l(Ut,"The "),rt=s(Ut,"CODE",{});var On=a(rt);_o=l(On,"generate()"),On.forEach(o),To=l(Ut," method can be used to generate text using GPT Neo model."),Ut.forEach(o),Ct=u(e),k(Te.$$.fragment,e),Et=u(e),O=s(e,"H2",{class:!0});var Vt=a(O);Z=s(Vt,"A",{id:!0,class:!0,href:!0});var Bn=a(Z);it=s(Bn,"SPAN",{});var Sn=a(it);k(be.$$.fragment,Sn),Sn.forEach(o),Bn.forEach(o),bo=u(Vt),lt=s(Vt,"SPAN",{});var Dn=a(lt);vo=l(Dn,"GPTNeoXConfig"),Dn.forEach(o),Vt.forEach(o),qt=u(e),M=s(e,"DIV",{class:!0});var ce=a(M);k(ve.$$.fragment,ce),ko=u(ce),B=s(ce,"P",{});var Ve=a(B);wo=l(Ve,"This is the configuration class to store the configuration of a "),Be=s(Ve,"A",{href:!0});var Wn=a(Be);Po=l(Wn,"GPTNeoXModel"),Wn.forEach(o),yo=l(Ve,`. It is used to instantiate an
GPTNeoX model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GPTNeoX
...
documentation from `),De=s(Je,"A",{href:!0});var Vn=a(De);Mo=l(Vn,"PretrainedConfig"),Vn.forEach(o),Fo=l(Je," for more information."),Je.forEach(o),Co=u(ce),k(ee.$$.fragment,ce),ce.forEach(o),jt=u(e),D=s(e,"H2",{class:!0});var Jt=a(D);te=s(Jt,"A",{id:!0,class:!0,href:!0});var Jn=a(te);dt=s(Jn,"SPAN",{});var Rn=a(dt);k(we.$$.fragment,Rn),Rn.forEach(o),Jn.forEach(o),Eo=u(Jt),ct=s(Jt,"SPAN",{});var Yn=a(ct);qo=l(Yn,"GPTNeoXTokenizerFast"),Yn.forEach(o),Jt.forEach(o),Lt=u(e),N=s(e,"DIV",{class:!0});var x=a(N);k(Pe.$$.fragment,x),jo=u(x),ye=s(x,"P",{});var Rt=a(ye);Lo=l(Rt,"Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=s(Rt,"EM",{});var Kn=a(pt);Ao=l(Kn,"tokenizers"),Kn.forEach(o),Io=l(Rt,` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),Kt.forEach(o),x.forEach(o),At=u(e),W=s(e,"H2",{class:!0});var Qt=a(W);se=s(Qt,"A",{id:!0,class:!0,href:!0});var ts=a(se);ut=s(ts,"SPAN",{});var os=a(ut);k(Ge.$$.fragment,os),os.forEach(o),ts.forEach(o),Qo=u(Qt),ft=s(Qt,"SPAN",{});var ns=a(ft);Zo=l(ns,"GPTNeoXModel"),ns.forEach(o),Qt.forEach(o),It=u(e),j=s(e,"DIV",{class:!0});var Re=a(j);k(Xe.$$.fragment,Re),en=u(Re),xe=s(Re,"P",{});var Zt=a(xe);tn=l(Zt,`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=s(Zt,"A",{href:!0,rel:!0});var ss=a(ze);on=l(ss,"torch.nn.Module"),ss.forEach(o),nn=l(Zt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Zt.forEach(o),sn=u(Re),C=s(Re,"DIV",{class:!0});var pe=a(C);k(Me.$$.fragment,pe),an=u(pe),H=s(pe,"P",{});var Ye=a(H);rn=l(Ye,"The "),He=s(Ye,"A",{href:!0});var as=a(He);ln=l(as,"GPTNeoXModel"),as.forEach(o),dn=l(Ye," forward method, overrides the "),gt=s(Ye,"CODE",{});var rs=a(gt);cn=l(rs,"__call__"),rs.forEach(o),pn=l(Ye," special method."),Ye.forEach(o),hn=u(pe),k(ae.$$.fragment,pe),mn=u(pe),k(re.$$.fragment,pe),pe.forEach(o),Re.forEach(o),Ot=u(e),U=s(e,"H2",{class:!0});var eo=a(U);ie=s(eo,"A",{id:!0,class:!0,href:!0});var is=a(ie);_t=s(is,"SPAN",{});var ls=a(_t);k(Fe.$$.fragment,ls),ls.forEach(o),is.forEach(o),un=u(eo),Tt=s(eo,"SPAN",{});var ds=a(Tt);fn=l(ds,"GPTNeoXForCausalLM"),ds.forEach(o),eo.forEach(o),Bt=u(e),L=s(e,"DIV",{class:!0});var Ke=a(L);k(Ce.$$.fragment,Ke),gn=u(Ke),V=s(Ke,"P",{});var Qe=a(V);_n=l(Qe,"GPTNeoX Model with a "),bt=s(Qe,"CODE",{});var cs=a(bt);Tn=l(cs,"language modeling"),cs.forEach(o),bn=l(Qe,` head on top for CLM fine-tuning.
This model is a PyTorch `),Ee=s(Qe,"A",{href:!0,rel:!0});var ps=a(Ee);vn=l(ps,"torch.nn.Module"),ps.forEach(o),kn=l(Qe,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Qe.forEach(o),wn=u(Ke),E=s(Ke,"DIV",{class:!0});var he=a(E);k(qe.$$.fragment,he),Pn=u(he),J=s(he,"P",{});var Ze=a(J);yn=l(Ze,"The "),Ue=s(Ze,"A",{href:!0});var hs=a(Ue);$n=l(hs,"GPTNeoXForCausalLM"),hs.forEach(o),Nn=l(Ze," forward method, overrides the "),vt=s(Ze,"CODE",{});var ms=a(vt);Gn=l(ms,"__call__"),ms.forEach(o),Xn=l(Ze," special method."),Ze.forEach(o),xn=u(he),k(le.$$.fragment,he),zn=u(he),k(de.$$.fragment,he),he.forEach(o),Ke.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(Gs)),h(f,"id","gptneox"),h(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(f,"href","#gptneox"),h(p,"class","relative group"),h(q,"id","overview"),h(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(q,"href","#overview"),h(F,"class","relative group"),h(ue,"href","https://github.com/EleutherAI/gpt-neox"),h(ue,"rel","nofollow"),h(fe,"href","https://www.coreweave.com/"),h(fe,"rel","nofollow"),h(K,"id","generation"),h(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(K,"href","#generation"),h(I,"class","relative group"),h(Z,"id","transformers.GPTNeoXConfig"),h(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Z,"href","#transformers.GPTNeoXConfig"),h(O,"class","relative group"),h(Be,"href","/docs/transformers/pr_17933/en/model_doc/gpt_neox#transformers.GPTNeoXModel"),h(ke,"href","https://huggingface.co/EleutherAI/gpt-neox-20b"),h(ke,"rel","nofollow"),h(Se,"href","/docs/transformers/pr_17933/en/main_classes/configuration#transformers.PretrainedConfig"),h(De,"href","/docs/transformers/pr_17933/en/main_classes/configuration#transformers.PretrainedConfig"),h(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(te,"id","transformers.GPTNeoXTokenizerFast"),h(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(te,"href","#transformers.GPTNeoXTokenizerFast"),h(D,"class","relative group"),h(We,"href","/docs/transformers/pr_17933/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(se,"id","transformers.GPTNeoXModel"),h(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(se,"href","#transformers.GPTNeoXModel"),h(W,"class","relative group"),h(ze,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(ze,"rel","nofollow"),h(He,"href","/docs/transformers/pr_17933/en/model_doc/gpt_neox#transformers.GPTNeoXModel"),h(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ie,"id","transformers.GPTNeoXForCausalLM"),h(ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ie,"href","#transformers.GPTNeoXForCausalLM"),h(U,"class","relative group"),h(Ee,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ee,"rel","nofollow"),h(Ue,"href","/docs/transformers/pr_17933/en/model_doc/gpt_neox#transformers.GPTNeoXForCausalLM"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,c){t(document.head,d),g(e,T,c),g(e,p,c),t(p,f),t(f,b),w(r,b,null),t(p,_),t(p,X),t(X,A),g(e,z,c),g(e,F,c),t(F,q),t(q,ot),w(me,ot,null),t(F,no),t(F,nt),t(nt,so),g(e,Nt,c),g(e,R,c),t(R,ao),t(R,ue),t(ue,ro),t(R,io),g(e,Gt,c),g(e,Y,c),t(Y,lo),t(Y,fe),t(fe,co),t(Y,po),g(e,Xt,c),g(e,Ie,c),t(Ie,ho),g(e,xt,c),w(ge,e,c),g(e,zt,c),g(e,Oe,c),t(Oe,mo),g(e,Mt,c),g(e,I,c),t(I,K),t(K,st),w(_e,st,null),t(I,uo),t(I,at),t(at,fo),g(e,Ft,c),g(e,Q,c),t(Q,go),t(Q,rt),t(rt,_o),t(Q,To),g(e,Ct,c),w(Te,e,c),g(e,Et,c),g(e,O,c),t(O,Z),t(Z,it),w(be,it,null),t(O,bo),t(O,lt),t(lt,vo),g(e,qt,c),g(e,M,c),w(ve,M,null),t(M,ko),t(M,B),t(B,wo),t(B,Be),t(Be,Po),t(B,yo),t(B,ke),t(ke,$o),t(B,No),t(M,Go),t(M,S),t(S,Xo),t(S,Se),t(Se,xo),t(S,zo),t(S,De),t(De,Mo),t(S,Fo),t(M,Co),w(ee,M,null),g(e,jt,c),g(e,D,c),t(D,te),t(te,dt),w(we,dt,null),t(D,Eo),t(D,ct),t(ct,qo),g(e,Lt,c),g(e,N,c),w(Pe,N,null),t(N,jo),t(N,ye),t(ye,Lo),t(ye,pt),t(pt,Ao),t(ye,Io),t(N,Oo),t(N,ht),t(ht,Bo),t(N,So),w(oe,N,null),t(N,Do),t(N,$e),t($e,Wo),t($e,mt),t(mt,Ho),t($e,Uo),t(N,Vo),w(ne,N,null),t(N,Jo),t(N,Ne),t(Ne,Ro),t(Ne,We),t(We,Yo),t(Ne,Ko),g(e,At,c),g(e,W,c),t(W,se),t(se,ut),w(Ge,ut,null),t(W,Qo),t(W,ft),t(ft,Zo),g(e,It,c),g(e,j,c),w(Xe,j,null),t(j,en),t(j,xe),t(xe,tn),t(xe,ze),t(ze,on),t(xe,nn),t(j,sn),t(j,C),w(Me,C,null),t(C,an),t(C,H),t(H,rn),t(H,He),t(He,ln),t(H,dn),t(H,gt),t(gt,cn),t(H,pn),t(C,hn),w(ae,C,null),t(C,mn),w(re,C,null),g(e,Ot,c),g(e,U,c),t(U,ie),t(ie,_t),w(Fe,_t,null),t(U,un),t(U,Tt),t(Tt,fn),g(e,Bt,c),g(e,L,c),w(Ce,L,null),t(L,gn),t(L,V),t(V,_n),t(V,bt),t(bt,Tn),t(V,bn),t(V,Ee),t(Ee,vn),t(V,kn),t(L,wn),t(L,E),w(qe,E,null),t(E,Pn),t(E,J),t(J,yn),t(J,Ue),t(Ue,$n),t(J,Nn),t(J,vt),t(vt,Gn),t(J,Xn),t(E,xn),w(le,E,null),t(E,zn),w(de,E,null),St=!0},p(e,[c]){const je={};c&2&&(je.$$scope={dirty:c,ctx:e}),ee.$set(je);const kt={};c&2&&(kt.$$scope={dirty:c,ctx:e}),oe.$set(kt);const wt={};c&2&&(wt.$$scope={dirty:c,ctx:e}),ne.$set(wt);const Pt={};c&2&&(Pt.$$scope={dirty:c,ctx:e}),ae.$set(Pt);const Le={};c&2&&(Le.$$scope={dirty:c,ctx:e}),re.$set(Le);const yt={};c&2&&(yt.$$scope={dirty:c,ctx:e}),le.$set(yt);const $t={};c&2&&($t.$$scope={dirty:c,ctx:e}),de.$set($t)},i(e){St||(P(r.$$.fragment,e),P(me.$$.fragment,e),P(ge.$$.fragment,e),P(_e.$$.fragment,e),P(Te.$$.fragment,e),P(be.$$.fragment,e),P(ve.$$.fragment,e),P(ee.$$.fragment,e),P(we.$$.fragment,e),P(Pe.$$.fragment,e),P(oe.$$.fragment,e),P(ne.$$.fragment,e),P(Ge.$$.fragment,e),P(Xe.$$.fragment,e),P(Me.$$.fragment,e),P(ae.$$.fragment,e),P(re.$$.fragment,e),P(Fe.$$.fragment,e),P(Ce.$$.fragment,e),P(qe.$$.fragment,e),P(le.$$.fragment,e),P(de.$$.fragment,e),St=!0)},o(e){y(r.$$.fragment,e),y(me.$$.fragment,e),y(ge.$$.fragment,e),y(_e.$$.fragment,e),y(Te.$$.fragment,e),y(be.$$.fragment,e),y(ve.$$.fragment,e),y(ee.$$.fragment,e),y(we.$$.fragment,e),y(Pe.$$.fragment,e),y(oe.$$.fragment,e),y(ne.$$.fragment,e),y(Ge.$$.fragment,e),y(Xe.$$.fragment,e),y(Me.$$.fragment,e),y(ae.$$.fragment,e),y(re.$$.fragment,e),y(Fe.$$.fragment,e),y(Ce.$$.fragment,e),y(qe.$$.fragment,e),y(le.$$.fragment,e),y(de.$$.fragment,e),St=!1},d(e){o(d),e&&o(T),e&&o(p),$(r),e&&o(z),e&&o(F),$(me),e&&o(Nt),e&&o(R),e&&o(Gt),e&&o(Y),e&&o(Xt),e&&o(Ie),e&&o(xt),$(ge,e),e&&o(zt),e&&o(Oe),e&&o(Mt),e&&o(I),$(_e),e&&o(Ft),e&&o(Q),e&&o(Ct),$(Te,e),e&&o(Et),e&&o(O),$(be),e&&o(qt),e&&o(M),$(ve),$(ee),e&&o(jt),e&&o(D),$(we),e&&o(Lt),e&&o(N),$(Pe),$(oe),$(ne),e&&o(At),e&&o(W),$(Ge),e&&o(It),e&&o(j),$(Xe),$(Me),$(ae),$(re),e&&o(Ot),e&&o(U),$(Fe),e&&o(Bt),e&&o(L),$(Ce),$(qe),$(le),$(de)}}}const Gs={local:"gptneox",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTNeoXConfig",title:"GPTNeoXConfig"},{local:"transformers.GPTNeoXTokenizerFast",title:"GPTNeoXTokenizerFast"},{local:"transformers.GPTNeoXModel",title:"GPTNeoXModel"},{local:"transformers.GPTNeoXForCausalLM",title:"GPTNeoXForCausalLM"}],title:"GPT-NeoX"};function Xs(G){return Ts(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class qs extends us{constructor(d){super();fs(this,d,Xs,Ns,gs,{})}}export{qs as default,Gs as metadata};
