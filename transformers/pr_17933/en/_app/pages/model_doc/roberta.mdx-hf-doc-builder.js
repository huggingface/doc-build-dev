...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17933/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s3=a(fd);ov=i(s3,"RobertaForMultipleChoice"),s3.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a3=a(op);sv=i(a3,"__call__"),a3.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cm=a(qo);Vn=s(cm,"A",{id:!0,class:!0,href:!0});var r3=a(Vn);np=s(r3,"SPAN",{});var i3=a(np);y(Tr.$$.fragment,i3),i3.forEach(t),r3.forEach(t),lv=h(cm),sp=s(cm,"SPAN",{});var l3=a(sp);dv=i(l3,"RobertaForTokenClassification"),l3.forEach(t),cm.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d3=a(ap);pv=i(d3,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d3.forEach(t),hv=h(io),wr=s(io,"P",{});var pm=a(wr);uv=i(pm,"This model inherits from "),md=s(pm,"A",{href:!0});var c3=a(md);fv=i(c3,"PreTrainedModel"),c3.forEach(t),mv=i(pm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pm.forEach(t),gv=h(io),$r=s(io,"P",{});var hm=a($r);_v=i(hm,"This model is also a PyTorch "),Fr=s(hm,"A",{href:!0,rel:!0});var p3=a(Fr);bv=i(p3,"torch.nn.Module"),p3.forEach(t),kv=i(hm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h3=a(gd);wv=i(h3,"RobertaForTokenClassification"),h3.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var u3=a(rp);Fv=i(u3,"__call__"),u3.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var um=a(jo);Yn=s(um,"A",{id:!0,class:!0,href:!0});var f3=a(Yn);ip=s(f3,"SPAN",{});var m3=a(ip);y(Rr.$$.fragment,m3),m3.forEach(t),f3.forEach(t),zv=h(um),lp=s(um,"SPAN",{});var g3=a(lp);qv=i(g3,"RobertaForQuestionAnswering"),g3.forEach(t),um.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _3=a(dp);Pv=i(_3,"span start logits"),_3.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b3=a(cp);Av=i(b3,"span end logits"),b3.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fm=a(Er);Iv=i(fm,"This model inherits from "),_d=s(fm,"A",{href:!0});var k3=a(_d);Dv=i(k3,"PreTrainedModel"),k3.forEach(t),Sv=i(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fm.forEach(t),Wv=h(co),zr=s(co,"P",{});var mm=a(zr);Bv=i(mm,"This model is also a PyTorch "),qr=s(mm,"A",{href:!0,rel:!0});var v3=a(qr);Uv=i(v3,"torch.nn.Module"),v3.forEach(t),Hv=i(mm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T3=a(bd);Kv=i(T3,"RobertaForQuestionAnswering"),T3.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y3=a(pp);Xv=i(y3,"__call__"),y3.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gm=a(Ao);os=s(gm,"A",{id:!0,class:!0,href:!0});var w3=a(os);hp=s(w3,"SPAN",{});var $3=a(hp);y(jr.$$.fragment,$3),$3.forEach(t),w3.forEach(t),oT=h(gm),up=s(gm,"SPAN",{});var F3=a(up);nT=i(F3,"TFRobertaModel"),F3.forEach(t),gm.forEach(t),uf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),fp=s(Ot,"P",{});var x3=a(fp);aT=i(x3,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x3.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _m=a(Lr);iT=i(_m,"This model inherits from "),kd=s(_m,"A",{href:!0});var R3=a(kd);lT=i(R3,"TFPreTrainedModel"),R3.forEach(t),dT=i(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bm=a(Ar);pT=i(bm,"This model is also a "),Or=s(bm,"A",{href:!0,rel:!0});var M3=a(Or);hT=i(M3,"tf.keras.Model"),M3.forEach(t),uT=i(bm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bm.forEach(t),fT=h(Ot),y(ns.$$.fragment,Ot),mT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E3=a(vd);bT=i(E3,"TFRobertaModel"),E3.forEach(t),kT=i(Gd," forward method, overrides the "),mp=s(Gd,"CODE",{});var z3=a(mp);vT=i(z3,"__call__"),z3.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var km=a(No);rs=s(km,"A",{id:!0,class:!0,href:!0});var q3=a(rs);gp=s(q3,"SPAN",{});var C3=a(gp);y(Ir.$$.fragment,C3),C3.forEach(t),q3.forEach(t),$T=h(km),_p=s(km,"SPAN",{});var j3=a(_p);FT=i(j3,"TFRobertaForCausalLM"),j3.forEach(t),km.forEach(t),mf=h(o),Io=s(o,"DIV",{class:!0});var vm=a(Io);y(Dr.$$.fragment,vm),xT=h(vm),Mt=s(vm,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P3=a(Td);ET=i(P3,"TFRobertaForCausalLM"),P3.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L3=a(bp);qT=i(L3,"__call__"),L3.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vm.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tm=a(So);ds=s(Tm,"A",{id:!0,class:!0,href:!0});var A3=a(ds);kp=s(A3,"SPAN",{});var O3=a(kp);y(Wr.$$.fragment,O3),O3.forEach(t),A3.forEach(t),LT=h(Tm),vp=s(Tm,"SPAN",{});var N3=a(vp);AT=i(N3,"TFRobertaForMaskedLM"),N3.forEach(t),Tm.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var ym=a(Ur);NT=i(ym,"RoBERTa Model with a "),Tp=s(ym,"CODE",{});var I3=a(Tp);IT=i(I3,"language modeling"),I3.forEach(t),DT=i(ym," head on top."),ym.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wm=a(Hr);WT=i(wm,"This model inherits from "),yd=s(wm,"A",{href:!0});var D3=a(yd);BT=i(D3,"TFPreTrainedModel"),D3.forEach(t),UT=i(wm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wm.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $m=a(Qr);QT=i($m,"This model is also a "),Jr=s($m,"A",{href:!0,rel:!0});var S3=a(Jr);JT=i(S3,"tf.keras.Model"),S3.forEach(t),VT=i($m,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W3=a(wd);ZT=i(W3,"TFRobertaForMaskedLM"),W3.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B3=a(yp);ty=i(B3,"__call__"),B3.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fm=a(Bo);fs=s(Fm,"A",{id:!0,class:!0,href:!0});var U3=a(fs);wp=s(U3,"SPAN",{});var H3=a(wp);y(Kr.$$.fragment,H3),H3.forEach(t),U3.forEach(t),ry=h(Fm),$p=s(Fm,"SPAN",{});var Q3=a($p);iy=i(Q3,"TFRobertaForSequenceClassification"),Q3.forEach(t),Fm.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var J3=a(Fp);dy=i(J3,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J3.forEach(t),cy=h(It),Xr=s(It,"P",{});var xm=a(Xr);py=i(xm,"This model inherits from "),$d=s(xm,"A",{href:!0});var V3=a($d);hy=i(V3,"TFPreTrainedModel"),V3.forEach(t),uy=i(xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xm.forEach(t),fy=h(It),Yr=s(It,"P",{});var Rm=a(Yr);my=i(Rm,"This model is also a "),Zr=s(Rm,"A",{href:!0,rel:!0});var K3=a(Zr);gy=i(K3,"tf.keras.Model"),K3.forEach(t),_y=i(Rm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),by=h(It),y(ms.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vy=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G3=a(Fd);yy=i(G3,"TFRobertaForSequenceClassification"),G3.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X3=a(xp);$y=i(X3,"__call__"),X3.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(uo),y(gs.$$.fragment,uo),Ry=h(uo),y(_s.$$.fragment,uo),My=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mm=a(Ho);ks=s(Mm,"A",{id:!0,class:!0,href:!0});var Y3=a(ks);Rp=s(Y3,"SPAN",{});var Z3=a(Rp);y(ti.$$.fragment,Z3),Z3.forEach(t),Y3.forEach(t),Ey=h(Mm),Mp=s(Mm,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mm.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
