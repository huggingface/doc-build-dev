...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15864/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15864/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15864/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15864/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15864/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
following:`),eg=u(),$t=o("ol"),ws=o("li"),H6=a("replace "),cf=o("code"),B6=a("python -m torch.distributed.launch"),W6=a(" with "),hf=o("code"),F6=a("deepspeed"),V6=a("."),Y6=u(),ye=o("li"),K6=a("add a new argument "),ff=o("code"),J6=a("--deepspeed ds_config.json"),X6=a(", where "),df=o("code"),Q6=a("ds_config.json"),e4=a(` is the DeepSpeed configuration file as
documented `),uo=o("a"),s4=a("here"),t4=a(". The file naming is up to you."),sg=u(),Wp=o("p"),a4=a("Therefore, if your original command line looked as follows:"),tg=u(),f(co.$$.fragment),ag=u(),Fp=o("p"),n4=a("Now it should be:"),ng=u(),f(ho.$$.fragment),og=u(),O=o("p"),o4=a("Unlike, "),mf=o("code"),l4=a("torch.distributed.launch"),r4=a(" where you have to specify how many GPUs to use with "),_f=o("code"),p4=a("--nproc_per_node"),i4=a(`, with the
`),vf=o("code"),u4=a("deepspeed"),c4=a(" launcher you don\u2019t have to use the corresponding "),jf=o("code"),h4=a("--num_gpus"),f4=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),fo=o("a"),d4=a("here"),m4=a("."),lg=u(),J=o("p"),_4=a("In fact, you can continue using "),gf=o("code"),v4=a("-m torch.distributed.launch"),j4=a(` with DeepSpeed as long as you don\u2019t need to use
`),yf=o("code"),g4=a("deepspeed"),y4=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),wf=o("code"),w4=a("deepspeed"),b4=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),rg=u(),kt=o("p"),q4=a("Here is an example of running "),bf=o("code"),E4=a("run_translation.py"),$4=a(" under DeepSpeed deploying all available GPUs:"),pg=u(),f(mo.$$.fragment),ig=u(),Pt=o("p"),k4=a("Note that in the DeepSpeed documentation you are likely to see "),qf=o("code"),P4=a("--deepspeed --deepspeed_config ds_config.json"),z4=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),ug=u(),zt=o("p"),D4=a("For some practical usage examples, please, see this "),_o=o("a"),O4=a("post"),T4=a("."),cg=u(),Vp=o("a"),hg=u(),bs=o("h3"),Dt=o("a"),Ef=o("span"),f(vo.$$.fragment),A4=u(),$f=o("span"),S4=a("Deployment with one GPU"),fg=u(),Ot=o("p"),C4=a("To deploy DeepSpeed with one GPU adjust the "),Yp=o("a"),x4=a("Trainer"),R4=a(" command line arguments as follows:"),dg=u(),f(jo.$$.fragment),mg=u(),Ae=o("p"),I4=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),kf=o("code"),U4=a("--num_gpus=1"),G4=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),go=o("a"),L4=a("documentation"),M4=a(" discusses the launcher options."),_g=u(),Kp=o("p"),Z4=a("Why would you want to use DeepSpeed with just one GPU?"),vg=u(),Tt=o("ol"),Pf=o("li"),N4=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),H4=u(),zf=o("li"),B4=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),jg=u(),Jp=o("p"),W4=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),gg=u(),f(yo.$$.fragment),yg=u(),Xp=o("p"),F4=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),wg=u(),At=o("p"),V4=a("For a practical usage example of this type of deployment, please, see this "),wo=o("a"),Y4=a("post"),K4=a("."),bg=u(),Qp=o("p"),J4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),qg=u(),ei=o("p"),X4=a("Notes:"),Eg=u(),si=o("ul"),qs=o("li"),bo=o("p"),Q4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=o("code"),e$=a("CUDA_VISIBLE_DEVICES"),s$=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),t$=u(),f(qo.$$.fragment),a$=u(),Of=o("p"),n$=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),$g=u(),ti=o("a"),kg=u(),Es=o("h3"),St=o("a"),Tf=o("span"),f(Eo.$$.fragment),o$=u(),Af=o("span"),l$=a("Deployment in Notebooks"),Pg=u(),Ct=o("p"),r$=a("The problem with running notebook cells as a script is that there is no normal "),Sf=o("code"),p$=a("deepspeed"),i$=a(` launcher to rely on, so
under certain setups we have to emulate it.`),zg=u(),ai=o("p"),u$=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Dg=u(),f($o.$$.fragment),Og=u(),xt=o("p"),c$=a("Note: "),Cf=o("code"),h$=a("..."),f$=a(" stands for the normal arguments that you\u2019d pass to the functions."),Tg=u(),ni=o("p"),d$=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Ag=u(),oi=o("p"),m$=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Sg=u(),f(ko.$$.fragment),Cg=u(),Se=o("p"),_$=a("If the training script is in a normal file and not in the notebook cells, you can launch "),xf=o("code"),v$=a("deepspeed"),j$=a(` normally via
shell from a cell. For example, to use `),Rf=o("code"),g$=a("run_translation.py"),y$=a(" you would launch it with:"),xg=u(),f(Po.$$.fragment),Rg=u(),Rt=o("p"),w$=a("or with "),If=o("code"),b$=a("%%bash"),q$=a(" magic, where you can write a multi-line code for the shell program to run:"),Ig=u(),f(zo.$$.fragment),Ug=u(),li=o("p"),E$=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Gg=u(),It=o("p"),$$=a("Note: While "),Uf=o("code"),k$=a("%%bash"),P$=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Lg=u(),ri=o("a"),Mg=u(),$s=o("h3"),Ut=o("a"),Gf=o("span"),f(Do.$$.fragment),z$=u(),Lf=o("span"),D$=a("Configuration"),Zg=u(),Gt=o("p"),O$=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=o("a"),T$=a("following documentation"),A$=a("."),Ng=u(),Lt=o("p"),S$=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=o("a"),C$=a(`the DeepSpeedExamples
repo`),x$=a(":"),Hg=u(),f(Ao.$$.fragment),Bg=u(),Mt=o("p"),R$=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=o("code"),I$=a(".json"),U$=a(" files with:"),Wg=u(),f(So.$$.fragment),Fg=u(),Zt=o("p"),G$=a("Some more examples are to be found in the "),Co=o("a"),L$=a("main repo"),M$=a(" as well."),Vg=u(),pi=o("p"),Z$=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Yg=u(),X=o("p"),N$=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Zf=o("code"),H$=a("AdamW"),B$=a(" optimizer and "),Nf=o("code"),W$=a("WarmupLR"),F$=a(` scheduler and will enable mixed
precision training if `),Hf=o("code"),V$=a("--fp16"),Y$=a(" is passed:"),Kg=u(),f(xo.$$.fragment),Jg=u(),Nt=o("p"),K$=a("When you execute the program, DeepSpeed will log the configuration it received from the "),ii=o("a"),J$=a("Trainer"),X$=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),Xg=u(),ui=o("a"),Qg=u(),ks=o("h3"),Ht=o("a"),Bf=o("span"),f(Ro.$$.fragment),Q$=u(),Wf=o("span"),e8=a("Passing Configuration"),ey=u(),T=o("p"),s8=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
following:`),b0.forEach(t),eg=c(e),$t=l(e,"OL",{});var q0=r($t);ws=l(q0,"LI",{});var Vc=r(ws);H6=n(Vc,"replace "),cf=l(Vc,"CODE",{});var rG=r(cf);B6=n(rG,"python -m torch.distributed.launch"),rG.forEach(t),W6=n(Vc," with "),hf=l(Vc,"CODE",{});var pG=r(hf);F6=n(pG,"deepspeed"),pG.forEach(t),V6=n(Vc,"."),Vc.forEach(t),Y6=c(q0),ye=l(q0,"LI",{});var Pn=r(ye);K6=n(Pn,"add a new argument "),ff=l(Pn,"CODE",{});var iG=r(ff);J6=n(iG,"--deepspeed ds_config.json"),iG.forEach(t),X6=n(Pn,", where "),df=l(Pn,"CODE",{});var uG=r(df);Q6=n(uG,"ds_config.json"),uG.forEach(t),e4=n(Pn,` is the DeepSpeed configuration file as
documented `),uo=l(Pn,"A",{href:!0,rel:!0});var cG=r(uo);s4=n(cG,"here"),cG.forEach(t),t4=n(Pn,". The file naming is up to you."),Pn.forEach(t),q0.forEach(t),sg=c(e),Wp=l(e,"P",{});var hG=r(Wp);a4=n(hG,"Therefore, if your original command line looked as follows:"),hG.forEach(t),tg=c(e),d(co.$$.fragment,e),ag=c(e),Fp=l(e,"P",{});var fG=r(Fp);n4=n(fG,"Now it should be:"),fG.forEach(t),ng=c(e),d(ho.$$.fragment,e),og=c(e),O=l(e,"P",{});var he=r(O);o4=n(he,"Unlike, "),mf=l(he,"CODE",{});var dG=r(mf);l4=n(dG,"torch.distributed.launch"),dG.forEach(t),r4=n(he," where you have to specify how many GPUs to use with "),_f=l(he,"CODE",{});var mG=r(_f);p4=n(mG,"--nproc_per_node"),mG.forEach(t),i4=n(he,`, with the
`),vf=l(he,"CODE",{});var _G=r(vf);u4=n(_G,"deepspeed"),_G.forEach(t),c4=n(he," launcher you don\u2019t have to use the corresponding "),jf=l(he,"CODE",{});var vG=r(jf);h4=n(vG,"--num_gpus"),vG.forEach(t),f4=n(he,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),fo=l(he,"A",{href:!0,rel:!0});var jG=r(fo);d4=n(jG,"here"),jG.forEach(t),m4=n(he,"."),he.forEach(t),lg=c(e),J=l(e,"P",{});var zn=r(J);_4=n(zn,"In fact, you can continue using "),gf=l(zn,"CODE",{});var gG=r(gf);v4=n(gG,"-m torch.distributed.launch"),gG.forEach(t),j4=n(zn,` with DeepSpeed as long as you don\u2019t need to use
`),yf=l(zn,"CODE",{});var yG=r(yf);g4=n(yG,"deepspeed"),yG.forEach(t),y4=n(zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),wf=l(zn,"CODE",{});var wG=r(wf);w4=n(wG,"deepspeed"),wG.forEach(t),b4=n(zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),zn.forEach(t),rg=c(e),kt=l(e,"P",{});var E0=r(kt);q4=n(E0,"Here is an example of running "),bf=l(E0,"CODE",{});var bG=r(bf);E4=n(bG,"run_translation.py"),bG.forEach(t),$4=n(E0," under DeepSpeed deploying all available GPUs:"),E0.forEach(t),pg=c(e),d(mo.$$.fragment,e),ig=c(e),Pt=l(e,"P",{});var $0=r(Pt);k4=n($0,"Note that in the DeepSpeed documentation you are likely to see "),qf=l($0,"CODE",{});var qG=r(qf);P4=n(qG,"--deepspeed --deepspeed_config ds_config.json"),qG.forEach(t),z4=n($0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),$0.forEach(t),ug=c(e),zt=l(e,"P",{});var k0=r(zt);D4=n(k0,"For some practical usage examples, please, see this "),_o=l(k0,"A",{href:!0,rel:!0});var EG=r(_o);O4=n(EG,"post"),EG.forEach(t),T4=n(k0,"."),k0.forEach(t),cg=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),hg=c(e),bs=l(e,"H3",{class:!0});var P0=r(bs);Dt=l(P0,"A",{id:!0,class:!0,href:!0});var $G=r(Dt);Ef=l($G,"SPAN",{});var kG=r(Ef);d(vo.$$.fragment,kG),kG.forEach(t),$G.forEach(t),A4=c(P0),$f=l(P0,"SPAN",{});var PG=r($f);S4=n(PG,"Deployment with one GPU"),PG.forEach(t),P0.forEach(t),fg=c(e),Ot=l(e,"P",{});var z0=r(Ot);C4=n(z0,"To deploy DeepSpeed with one GPU adjust the "),Yp=l(z0,"A",{href:!0});var zG=r(Yp);x4=n(zG,"Trainer"),zG.forEach(t),R4=n(z0," command line arguments as follows:"),z0.forEach(t),dg=c(e),d(jo.$$.fragment,e),mg=c(e),Ae=l(e,"P",{});var Yc=r(Ae);I4=n(Yc,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),kf=l(Yc,"CODE",{});var DG=r(kf);U4=n(DG,"--num_gpus=1"),DG.forEach(t),G4=n(Yc,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),go=l(Yc,"A",{href:!0,rel:!0});var OG=r(go);L4=n(OG,"documentation"),OG.forEach(t),M4=n(Yc," discusses the launcher options."),Yc.forEach(t),_g=c(e),Kp=l(e,"P",{});var TG=r(Kp);Z4=n(TG,"Why would you want to use DeepSpeed with just one GPU?"),TG.forEach(t),vg=c(e),Tt=l(e,"OL",{});var D0=r(Tt);Pf=l(D0,"LI",{});var AG=r(Pf);N4=n(AG,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),AG.forEach(t),H4=c(D0),zf=l(D0,"LI",{});var SG=r(zf);B4=n(SG,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),SG.forEach(t),D0.forEach(t),jg=c(e),Jp=l(e,"P",{});var CG=r(Jp);W4=n(CG,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),CG.forEach(t),gg=c(e),d(yo.$$.fragment,e),yg=c(e),Xp=l(e,"P",{});var xG=r(Xp);F4=n(xG,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),xG.forEach(t),wg=c(e),At=l(e,"P",{});var O0=r(At);V4=n(O0,"For a practical usage example of this type of deployment, please, see this "),wo=l(O0,"A",{href:!0,rel:!0});var RG=r(wo);Y4=n(RG,"post"),RG.forEach(t),K4=n(O0,"."),O0.forEach(t),bg=c(e),Qp=l(e,"P",{});var IG=r(Qp);J4=n(IG,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),IG.forEach(t),qg=c(e),ei=l(e,"P",{});var UG=r(ei);X4=n(UG,"Notes:"),UG.forEach(t),Eg=c(e),si=l(e,"UL",{});var GG=r(si);qs=l(GG,"LI",{});var Kc=r(qs);bo=l(Kc,"P",{});var T0=r(bo);Q4=n(T0,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=l(T0,"CODE",{});var LG=r(Df);e$=n(LG,"CUDA_VISIBLE_DEVICES"),LG.forEach(t),s$=n(T0,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),T0.forEach(t),t$=c(Kc),d(qo.$$.fragment,Kc),a$=c(Kc),Of=l(Kc,"P",{});var MG=r(Of);n$=n(MG,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),MG.forEach(t),Kc.forEach(t),GG.forEach(t),$g=c(e),ti=l(e,"A",{id:!0}),r(ti).forEach(t),kg=c(e),Es=l(e,"H3",{class:!0});var A0=r(Es);St=l(A0,"A",{id:!0,class:!0,href:!0});var ZG=r(St);Tf=l(ZG,"SPAN",{});var NG=r(Tf);d(Eo.$$.fragment,NG),NG.forEach(t),ZG.forEach(t),o$=c(A0),Af=l(A0,"SPAN",{});var HG=r(Af);l$=n(HG,"Deployment in Notebooks"),HG.forEach(t),A0.forEach(t),Pg=c(e),Ct=l(e,"P",{});var S0=r(Ct);r$=n(S0,"The problem with running notebook cells as a script is that there is no normal "),Sf=l(S0,"CODE",{});var BG=r(Sf);p$=n(BG,"deepspeed"),BG.forEach(t),i$=n(S0,` launcher to rely on, so
under certain setups we have to emulate it.`),S0.forEach(t),zg=c(e),ai=l(e,"P",{});var WG=r(ai);u$=n(WG,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),WG.forEach(t),Dg=c(e),d($o.$$.fragment,e),Og=c(e),xt=l(e,"P",{});var C0=r(xt);c$=n(C0,"Note: "),Cf=l(C0,"CODE",{});var FG=r(Cf);h$=n(FG,"..."),FG.forEach(t),f$=n(C0," stands for the normal arguments that you\u2019d pass to the functions."),C0.forEach(t),Tg=c(e),ni=l(e,"P",{});var VG=r(ni);d$=n(VG,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),VG.forEach(t),Ag=c(e),oi=l(e,"P",{});var YG=r(oi);m$=n(YG,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),YG.forEach(t),Sg=c(e),d(ko.$$.fragment,e),Cg=c(e),Se=l(e,"P",{});var Jc=r(Se);_$=n(Jc,"If the training script is in a normal file and not in the notebook cells, you can launch "),xf=l(Jc,"CODE",{});var KG=r(xf);v$=n(KG,"deepspeed"),KG.forEach(t),j$=n(Jc,` normally via
shell from a cell. For example, to use `),Rf=l(Jc,"CODE",{});var JG=r(Rf);g$=n(JG,"run_translation.py"),JG.forEach(t),y$=n(Jc," you would launch it with:"),Jc.forEach(t),xg=c(e),d(Po.$$.fragment,e),Rg=c(e),Rt=l(e,"P",{});var x0=r(Rt);w$=n(x0,"or with "),If=l(x0,"CODE",{});var XG=r(If);b$=n(XG,"%%bash"),XG.forEach(t),q$=n(x0," magic, where you can write a multi-line code for the shell program to run:"),x0.forEach(t),Ig=c(e),d(zo.$$.fragment,e),Ug=c(e),li=l(e,"P",{});var QG=r(li);E$=n(QG,"In such case you don\u2019t need any of the code presented at the beginning of this section."),QG.forEach(t),Gg=c(e),It=l(e,"P",{});var R0=r(It);$$=n(R0,"Note: While "),Uf=l(R0,"CODE",{});var eL=r(Uf);k$=n(eL,"%%bash"),eL.forEach(t),P$=n(R0,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),R0.forEach(t),Lg=c(e),ri=l(e,"A",{id:!0}),r(ri).forEach(t),Mg=c(e),$s=l(e,"H3",{class:!0});var I0=r($s);Ut=l(I0,"A",{id:!0,class:!0,href:!0});var sL=r(Ut);Gf=l(sL,"SPAN",{});var tL=r(Gf);d(Do.$$.fragment,tL),tL.forEach(t),sL.forEach(t),z$=c(I0),Lf=l(I0,"SPAN",{});var aL=r(Lf);D$=n(aL,"Configuration"),aL.forEach(t),I0.forEach(t),Zg=c(e),Gt=l(e,"P",{});var U0=r(Gt);O$=n(U0,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=l(U0,"A",{href:!0,rel:!0});var nL=r(Oo);T$=n(nL,"following documentation"),nL.forEach(t),A$=n(U0,"."),U0.forEach(t),Ng=c(e),Lt=l(e,"P",{});var G0=r(Lt);S$=n(G0,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=l(G0,"A",{href:!0,rel:!0});var oL=r(To);C$=n(oL,`the DeepSpeedExamples
repo`),oL.forEach(t),x$=n(G0,":"),G0.forEach(t),Hg=c(e),d(Ao.$$.fragment,e),Bg=c(e),Mt=l(e,"P",{});var L0=r(Mt);R$=n(L0,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=l(L0,"CODE",{});var lL=r(Mf);I$=n(lL,".json"),lL.forEach(t),U$=n(L0," files with:"),L0.forEach(t),Wg=c(e),d(So.$$.fragment,e),Fg=c(e),Zt=l(e,"P",{});var M0=r(Zt);G$=n(M0,"Some more examples are to be found in the "),Co=l(M0,"A",{href:!0,rel:!0});var rL=r(Co);L$=n(rL,"main repo"),rL.forEach(t),M$=n(M0," as well."),M0.forEach(t),Vg=c(e),pi=l(e,"P",{});var pL=r(pi);Z$=n(pL,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),pL.forEach(t),Yg=c(e),X=l(e,"P",{});var Dn=r(X);N$=n(Dn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Zf=l(Dn,"CODE",{});var iL=r(Zf);H$=n(iL,"AdamW"),iL.forEach(t),B$=n(Dn," optimizer and "),Nf=l(Dn,"CODE",{});var uL=r(Nf);W$=n(uL,"WarmupLR"),uL.forEach(t),F$=n(Dn,` scheduler and will enable mixed
precision training if `),Hf=l(Dn,"CODE",{});var cL=r(Hf);V$=n(cL,"--fp16"),cL.forEach(t),Y$=n(Dn," is passed:"),Dn.forEach(t),Kg=c(e),d(xo.$$.fragment,e),Jg=c(e),Nt=l(e,"P",{});var Z0=r(Nt);K$=n(Z0,"When you execute the program, DeepSpeed will log the configuration it received from the "),ii=l(Z0,"A",{href:!0});var hL=r(ii);J$=n(hL,"Trainer"),hL.forEach(t),X$=n(Z0,`
to the console, so you can see exactly what was the final configuration passed to it.`),Z0.forEach(t),Xg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Qg=c(e),ks=l(e,"H3",{class:!0});var N0=r(ks);Ht=l(N0,"A",{id:!0,class:!0,href:!0});var fL=r(Ht);Bf=l(fL,"SPAN",{});var dL=r(Bf);d(Ro.$$.fragment,dL),dL.forEach(t),fL.forEach(t),Q$=c(N0),Wf=l(N0,"SPAN",{});var mL=r(Wf);e8=n(mL,"Passing Configuration"),mL.forEach(t),N0.forEach(t),ey=c(e),T=l(e,"P",{});var fe=r(T);s8=n(fe,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
