...
context) `),uo=o("a"),V$=a("here"),Y$=a("."),ew=u(),Bp=o("p"),K$=a("You can check the archs pytorch was built with using:"),sw=u(),f(co.$$.fragment),tw=u(),Wp=o("p"),J$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),aw=u(),f(ho.$$.fragment),nw=u(),Fp=o("p"),X$=a("If the output is:"),ow=u(),f(fo.$$.fragment),lw=u(),kt=o("p"),Q$=a("then you know that this card\u2019s arch is "),ff=o("code"),e8=a("8.6"),s8=a("."),rw=u(),Pt=o("p"),t8=a("You can also leave "),df=o("code"),a8=a("TORCH_CUDA_ARCH_LIST"),n8=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),pw=u(),zt=o("p"),o8=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=o("a"),l8=a("Deepspeed"),r8=a(","),iw=u(),Vp=o("a"),uw=u(),$s=o("h3"),Dt=o("a"),mf=o("span"),f(_o.$$.fragment),p8=u(),_f=o("span"),i8=a("Deployment with multiple GPUs"),cw=u(),Ot=o("p"),u8=a("To deploy this feature with multiple GPUs adjust the "),Yp=o("a"),c8=a("Trainer"),h8=a(` command line arguments as
following:`),hw=u(),At=o("ol"),ks=o("li"),f8=a("replace "),vf=o("code"),d8=a("python -m torch.distributed.launch"),m8=a(" with "),jf=o("code"),_8=a("deepspeed"),v8=a("."),j8=u(),Pe=o("li"),w8=a("add a new argument "),wf=o("code"),y8=a("--deepspeed ds_config.json"),g8=a(", where "),yf=o("code"),b8=a("ds_config.json"),q8=a(` is the DeepSpeed configuration file as
documented `),vo=o("a"),E8=a("here"),$8=a(". The file naming is up to you."),fw=u(),Kp=o("p"),k8=a("Therefore, if your original command line looked as follows:"),dw=u(),f(jo.$$.fragment),mw=u(),Jp=o("p"),P8=a("Now it should be:"),_w=u(),f(wo.$$.fragment),vw=u(),I=o("p"),z8=a("Unlike, "),gf=o("code"),D8=a("torch.distributed.launch"),O8=a(" where you have to specify how many GPUs to use with "),bf=o("code"),A8=a("--nproc_per_node"),T8=a(`, with the
`),qf=o("code"),S8=a("deepspeed"),C8=a(" launcher you don\u2019t have to use the corresponding "),Ef=o("code"),x8=a("--num_gpus"),R8=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=o("a"),I8=a("here"),U8=a("."),jw=u(),ae=o("p"),G8=a("In fact, you can continue using "),$f=o("code"),M8=a("-m torch.distributed.launch"),L8=a(` with DeepSpeed as long as you don\u2019t need to use
`),kf=o("code"),Z8=a("deepspeed"),N8=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=o("code"),H8=a("deepspeed"),B8=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),ww=u(),Tt=o("p"),W8=a("Here is an example of running "),zf=o("code"),F8=a("run_translation.py"),V8=a(" under DeepSpeed deploying all available GPUs:"),yw=u(),f(go.$$.fragment),gw=u(),St=o("p"),Y8=a("Note that in the DeepSpeed documentation you are likely to see "),Df=o("code"),K8=a("--deepspeed --deepspeed_config ds_config.json"),J8=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),bw=u(),Ct=o("p"),X8=a("For some practical usage examples, please, see this "),bo=o("a"),Q8=a("post"),e5=a("."),qw=u(),Xp=o("a"),Ew=u(),Ps=o("h3"),xt=o("a"),Of=o("span"),f(qo.$$.fragment),s5=u(),Af=o("span"),t5=a("Deployment with one GPU"),$w=u(),Rt=o("p"),a5=a("To deploy DeepSpeed with one GPU adjust the "),Qp=o("a"),n5=a("Trainer"),o5=a(" command line arguments as follows:"),kw=u(),f(Eo.$$.fragment),Pw=u(),Ue=o("p"),l5=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
...
to the `),Ro=o("a"),e4=a("following documentation"),s4=a("."),sy=u(),Wt=o("p"),t4=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=o("a"),a4=a(`the DeepSpeedExamples
repo`),n4=a(":"),ty=u(),f(Uo.$$.fragment),ay=u(),Ft=o("p"),o4=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Ff=o("code"),l4=a(".json"),r4=a(" files with:"),ny=u(),f(Go.$$.fragment),oy=u(),Vt=o("p"),p4=a("Some more examples are to be found in the "),Mo=o("a"),i4=a("main repo"),u4=a(" as well."),ly=u(),hi=o("p"),c4=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),ry=u(),ne=o("p"),h4=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Vf=o("code"),f4=a("AdamW"),d4=a(" optimizer and "),Yf=o("code"),m4=a("WarmupLR"),_4=a(` scheduler and will enable mixed
precision training if `),Kf=o("code"),v4=a("--fp16"),j4=a(" is passed:"),py=u(),f(Lo.$$.fragment),iy=u(),Yt=o("p"),w4=a("When you execute the program, DeepSpeed will log the configuration it received from the "),fi=o("a"),y4=a("Trainer"),g4=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),uy=u(),di=o("a"),cy=u(),As=o("h3"),Kt=o("a"),Jf=o("span"),f(Zo.$$.fragment),b4=u(),Xf=o("span"),q4=a("Passing Configuration"),hy=u(),U=o("p"),E4=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),mi=o("a"),$4=a("Trainer"),k4=a(" via "),_i=o("a"),P4=a("TrainingArguments"),z4=a(" then for the "),Qf=o("code"),D4=a("deepspeed"),O4=a(` argument you can
pass a nested `),ed=o("code"),A4=a("dict"),T4=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),vi=o("a"),S4=a("TrainingArguments"),C4=a("."),fy=u(),ji=o("p"),x4=a("To summarize you can do:"),dy=u(),f(No.$$.fragment),my=u(),wi=o("p"),R4=a("or:"),_y=u(),f(Ho.$$.fragment),vy=u(),yi=o("a"),jy=u(),Ts=o("h3"),Jt=o("a"),sd=o("span"),f(Bo.$$.fragment),I4=u(),td=o("span"),U4=a("Shared Configuration"),wy=u(),f(Xt.$$.fragment),yy=u(),Me=o("p"),G4=a("Some configuration values are required by both the "),gi=o("a"),M4=a("Trainer"),L4=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),bi=o("a"),Z4=a("Trainer"),N4=a(" command line arguments."),gy=u(),Qt=o("p"),H4=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),qi=o("a"),B4=a("Trainer"),W4=a(` do the majority
of configuration for you.`),by=u(),Le=o("p"),F4=a("Therefore, in the rest of this guide you will find a special configuration value: "),ad=o("code"),V4=a("auto"),Y4=a(`, which when set will be
...
`),Ei=o("a"),K4=a("Trainer"),J4=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),qy=u(),$i=o("p"),X4=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Ey=u(),ea=o("p"),Q4=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
...
context) `),uo=l(eh,"A",{href:!0,rel:!0});var bG=r(uo);V$=n(bG,"here"),bG.forEach(t),Y$=n(eh,"."),eh.forEach(t),ew=c(e),Bp=l(e,"P",{});var qG=r(Bp);K$=n(qG,"You can check the archs pytorch was built with using:"),qG.forEach(t),sw=c(e),d(co.$$.fragment,e),tw=c(e),Wp=l(e,"P",{});var EG=r(Wp);J$=n(EG,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),EG.forEach(t),aw=c(e),d(ho.$$.fragment,e),nw=c(e),Fp=l(e,"P",{});var $G=r(Fp);X$=n($G,"If the output is:"),$G.forEach(t),ow=c(e),d(fo.$$.fragment,e),lw=c(e),kt=l(e,"P",{});var Z0=r(kt);Q$=n(Z0,"then you know that this card\u2019s arch is "),ff=l(Z0,"CODE",{});var kG=r(ff);e8=n(kG,"8.6"),kG.forEach(t),s8=n(Z0,"."),Z0.forEach(t),rw=c(e),Pt=l(e,"P",{});var N0=r(Pt);t8=n(N0,"You can also leave "),df=l(N0,"CODE",{});var PG=r(df);a8=n(PG,"TORCH_CUDA_ARCH_LIST"),PG.forEach(t),n8=n(N0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),N0.forEach(t),pw=c(e),zt=l(e,"P",{});var H0=r(zt);o8=n(H0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=l(H0,"A",{href:!0,rel:!0});var zG=r(mo);l8=n(zG,"Deepspeed"),zG.forEach(t),r8=n(H0,","),H0.forEach(t),iw=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),uw=c(e),$s=l(e,"H3",{class:!0});var B0=r($s);Dt=l(B0,"A",{id:!0,class:!0,href:!0});var DG=r(Dt);mf=l(DG,"SPAN",{});var OG=r(mf);d(_o.$$.fragment,OG),OG.forEach(t),DG.forEach(t),p8=c(B0),_f=l(B0,"SPAN",{});var AG=r(_f);i8=n(AG,"Deployment with multiple GPUs"),AG.forEach(t),B0.forEach(t),cw=c(e),Ot=l(e,"P",{});var W0=r(Ot);u8=n(W0,"To deploy this feature with multiple GPUs adjust the "),Yp=l(W0,"A",{href:!0});var TG=r(Yp);c8=n(TG,"Trainer"),TG.forEach(t),h8=n(W0,` command line arguments as
following:`),W0.forEach(t),hw=c(e),At=l(e,"OL",{});var F0=r(At);ks=l(F0,"LI",{});var sh=r(ks);f8=n(sh,"replace "),vf=l(sh,"CODE",{});var SG=r(vf);d8=n(SG,"python -m torch.distributed.launch"),SG.forEach(t),m8=n(sh," with "),jf=l(sh,"CODE",{});var CG=r(jf);_8=n(CG,"deepspeed"),CG.forEach(t),v8=n(sh,"."),sh.forEach(t),j8=c(F0),Pe=l(F0,"LI",{});var Sn=r(Pe);w8=n(Sn,"add a new argument "),wf=l(Sn,"CODE",{});var xG=r(wf);y8=n(xG,"--deepspeed ds_config.json"),xG.forEach(t),g8=n(Sn,", where "),yf=l(Sn,"CODE",{});var RG=r(yf);b8=n(RG,"ds_config.json"),RG.forEach(t),q8=n(Sn,` is the DeepSpeed configuration file as
documented `),vo=l(Sn,"A",{href:!0,rel:!0});var IG=r(vo);E8=n(IG,"here"),IG.forEach(t),$8=n(Sn,". The file naming is up to you."),Sn.forEach(t),F0.forEach(t),fw=c(e),Kp=l(e,"P",{});var UG=r(Kp);k8=n(UG,"Therefore, if your original command line looked as follows:"),UG.forEach(t),dw=c(e),d(jo.$$.fragment,e),mw=c(e),Jp=l(e,"P",{});var GG=r(Jp);P8=n(GG,"Now it should be:"),GG.forEach(t),_w=c(e),d(wo.$$.fragment,e),vw=c(e),I=l(e,"P",{});var we=r(I);z8=n(we,"Unlike, "),gf=l(we,"CODE",{});var MG=r(gf);D8=n(MG,"torch.distributed.launch"),MG.forEach(t),O8=n(we," where you have to specify how many GPUs to use with "),bf=l(we,"CODE",{});var LG=r(bf);A8=n(LG,"--nproc_per_node"),LG.forEach(t),T8=n(we,`, with the
`),qf=l(we,"CODE",{});var ZG=r(qf);S8=n(ZG,"deepspeed"),ZG.forEach(t),C8=n(we," launcher you don\u2019t have to use the corresponding "),Ef=l(we,"CODE",{});var NG=r(Ef);x8=n(NG,"--num_gpus"),NG.forEach(t),R8=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=l(we,"A",{href:!0,rel:!0});var HG=r(yo);I8=n(HG,"here"),HG.forEach(t),U8=n(we,"."),we.forEach(t),jw=c(e),ae=l(e,"P",{});var Cn=r(ae);G8=n(Cn,"In fact, you can continue using "),$f=l(Cn,"CODE",{});var BG=r($f);M8=n(BG,"-m torch.distributed.launch"),BG.forEach(t),L8=n(Cn,` with DeepSpeed as long as you don\u2019t need to use
`),kf=l(Cn,"CODE",{});var WG=r(kf);Z8=n(WG,"deepspeed"),WG.forEach(t),N8=n(Cn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=l(Cn,"CODE",{});var FG=r(Pf);H8=n(FG,"deepspeed"),FG.forEach(t),B8=n(Cn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Cn.forEach(t),ww=c(e),Tt=l(e,"P",{});var V0=r(Tt);W8=n(V0,"Here is an example of running "),zf=l(V0,"CODE",{});var VG=r(zf);F8=n(VG,"run_translation.py"),VG.forEach(t),V8=n(V0," under DeepSpeed deploying all available GPUs:"),V0.forEach(t),yw=c(e),d(go.$$.fragment,e),gw=c(e),St=l(e,"P",{});var Y0=r(St);Y8=n(Y0,"Note that in the DeepSpeed documentation you are likely to see "),Df=l(Y0,"CODE",{});var YG=r(Df);K8=n(YG,"--deepspeed --deepspeed_config ds_config.json"),YG.forEach(t),J8=n(Y0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Y0.forEach(t),bw=c(e),Ct=l(e,"P",{});var K0=r(Ct);X8=n(K0,"For some practical usage examples, please, see this "),bo=l(K0,"A",{href:!0,rel:!0});var KG=r(bo);Q8=n(KG,"post"),KG.forEach(t),e5=n(K0,"."),K0.forEach(t),qw=c(e),Xp=l(e,"A",{id:!0}),r(Xp).forEach(t),Ew=c(e),Ps=l(e,"H3",{class:!0});var J0=r(Ps);xt=l(J0,"A",{id:!0,class:!0,href:!0});var JG=r(xt);Of=l(JG,"SPAN",{});var XG=r(Of);d(qo.$$.fragment,XG),XG.forEach(t),JG.forEach(t),s5=c(J0),Af=l(J0,"SPAN",{});var QG=r(Af);t5=n(QG,"Deployment with one GPU"),QG.forEach(t),J0.forEach(t),$w=c(e),Rt=l(e,"P",{});var X0=r(Rt);a5=n(X0,"To deploy DeepSpeed with one GPU adjust the "),Qp=l(X0,"A",{href:!0});var eM=r(Qp);n5=n(eM,"Trainer"),eM.forEach(t),o5=n(X0," command line arguments as follows:"),X0.forEach(t),kw=c(e),d(Eo.$$.fragment,e),Pw=c(e),Ue=l(e,"P",{});var th=r(Ue);l5=n(th,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
...
to the `),Ro=l(pq,"A",{href:!0,rel:!0});var OM=r(Ro);e4=n(OM,"following documentation"),OM.forEach(t),s4=n(pq,"."),pq.forEach(t),sy=c(e),Wt=l(e,"P",{});var iq=r(Wt);t4=n(iq,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=l(iq,"A",{href:!0,rel:!0});var AM=r(Io);a4=n(AM,`the DeepSpeedExamples
repo`),AM.forEach(t),n4=n(iq,":"),iq.forEach(t),ty=c(e),d(Uo.$$.fragment,e),ay=c(e),Ft=l(e,"P",{});var uq=r(Ft);o4=n(uq,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Ff=l(uq,"CODE",{});var TM=r(Ff);l4=n(TM,".json"),TM.forEach(t),r4=n(uq," files with:"),uq.forEach(t),ny=c(e),d(Go.$$.fragment,e),oy=c(e),Vt=l(e,"P",{});var cq=r(Vt);p4=n(cq,"Some more examples are to be found in the "),Mo=l(cq,"A",{href:!0,rel:!0});var SM=r(Mo);i4=n(SM,"main repo"),SM.forEach(t),u4=n(cq," as well."),cq.forEach(t),ly=c(e),hi=l(e,"P",{});var CM=r(hi);c4=n(CM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),CM.forEach(t),ry=c(e),ne=l(e,"P",{});var xn=r(ne);h4=n(xn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Vf=l(xn,"CODE",{});var xM=r(Vf);f4=n(xM,"AdamW"),xM.forEach(t),d4=n(xn," optimizer and "),Yf=l(xn,"CODE",{});var RM=r(Yf);m4=n(RM,"WarmupLR"),RM.forEach(t),_4=n(xn,` scheduler and will enable mixed
precision training if `),Kf=l(xn,"CODE",{});var IM=r(Kf);v4=n(IM,"--fp16"),IM.forEach(t),j4=n(xn," is passed:"),xn.forEach(t),py=c(e),d(Lo.$$.fragment,e),iy=c(e),Yt=l(e,"P",{});var hq=r(Yt);w4=n(hq,"When you execute the program, DeepSpeed will log the configuration it received from the "),fi=l(hq,"A",{href:!0});var UM=r(fi);y4=n(UM,"Trainer"),UM.forEach(t),g4=n(hq,`
to the console, so you can see exactly what was the final configuration passed to it.`),hq.forEach(t),uy=c(e),di=l(e,"A",{id:!0}),r(di).forEach(t),cy=c(e),As=l(e,"H3",{class:!0});var fq=r(As);Kt=l(fq,"A",{id:!0,class:!0,href:!0});var GM=r(Kt);Jf=l(GM,"SPAN",{});var MM=r(Jf);d(Zo.$$.fragment,MM),MM.forEach(t),GM.forEach(t),b4=c(fq),Xf=l(fq,"SPAN",{});var LM=r(Xf);q4=n(LM,"Passing Configuration"),LM.forEach(t),fq.forEach(t),hy=c(e),U=l(e,"P",{});var ye=r(U);E4=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),mi=l(ye,"A",{href:!0});var ZM=r(mi);$4=n(ZM,"Trainer"),ZM.forEach(t),k4=n(ye," via "),_i=l(ye,"A",{href:!0});var NM=r(_i);P4=n(NM,"TrainingArguments"),NM.forEach(t),z4=n(ye," then for the "),Qf=l(ye,"CODE",{});var HM=r(Qf);D4=n(HM,"deepspeed"),HM.forEach(t),O4=n(ye,` argument you can
pass a nested `),ed=l(ye,"CODE",{});var BM=r(ed);A4=n(BM,"dict"),BM.forEach(t),T4=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),vi=l(ye,"A",{href:!0});var WM=r(vi);S4=n(WM,"TrainingArguments"),WM.forEach(t),C4=n(ye,"."),ye.forEach(t),fy=c(e),ji=l(e,"P",{});var FM=r(ji);x4=n(FM,"To summarize you can do:"),FM.forEach(t),dy=c(e),d(No.$$.fragment,e),my=c(e),wi=l(e,"P",{});var VM=r(wi);R4=n(VM,"or:"),VM.forEach(t),_y=c(e),d(Ho.$$.fragment,e),vy=c(e),yi=l(e,"A",{id:!0}),r(yi).forEach(t),jy=c(e),Ts=l(e,"H3",{class:!0});var dq=r(Ts);Jt=l(dq,"A",{id:!0,class:!0,href:!0});var YM=r(Jt);sd=l(YM,"SPAN",{});var KM=r(sd);d(Bo.$$.fragment,KM),KM.forEach(t),YM.forEach(t),I4=c(dq),td=l(dq,"SPAN",{});var JM=r(td);U4=n(JM,"Shared Configuration"),JM.forEach(t),dq.forEach(t),wy=c(e),d(Xt.$$.fragment,e),yy=c(e),Me=l(e,"P",{});var oh=r(Me);G4=n(oh,"Some configuration values are required by both the "),gi=l(oh,"A",{href:!0});var XM=r(gi);M4=n(XM,"Trainer"),XM.forEach(t),L4=n(oh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),bi=l(oh,"A",{href:!0});var QM=r(bi);Z4=n(QM,"Trainer"),QM.forEach(t),N4=n(oh," command line arguments."),oh.forEach(t),gy=c(e),Qt=l(e,"P",{});var mq=r(Qt);H4=n(mq,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),qi=l(mq,"A",{href:!0});var eL=r(qi);B4=n(eL,"Trainer"),eL.forEach(t),W4=n(mq,` do the majority
of configuration for you.`),mq.forEach(t),by=c(e),Le=l(e,"P",{});var lh=r(Le);F4=n(lh,"Therefore, in the rest of this guide you will find a special configuration value: "),ad=l(lh,"CODE",{});var sL=r(ad);V4=n(sL,"auto"),sL.forEach(t),Y4=n(lh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ei=l(lh,"A",{href:!0});var tL=r(Ei);K4=n(tL,"Trainer"),tL.forEach(t),J4=n(lh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),lh.forEach(t),qy=c(e),$i=l(e,"P",{});var aL=r($i);X4=n(aL,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),aL.forEach(t),Ey=c(e),ea=l(e,"P",{});var _q=r(ea);Q4=n(_q,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
