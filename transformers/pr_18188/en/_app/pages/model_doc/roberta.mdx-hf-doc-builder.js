...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18188/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18188/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18188/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ut=a(Ue);y(fr.$$.fragment,ut),zk=h(ut),Mo=s(ut,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G0=a(hd);Ck=i(G0,"RobertaForSequenceClassification"),G0.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X0=a(Yc);Pk=i(X0,"__call__"),X0.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ut),y(Dn.$$.fragment,ut),Ok=h(ut),y(Sn.$$.fragment,ut),Nk=h(ut),y(Wn.$$.fragment,ut),Ik=h(ut),y(Bn.$$.fragment,ut),Dk=h(ut),y(Un.$$.fragment,ut),ut.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var iu=a(Eo);Hn=s(iu,"A",{id:!0,class:!0,href:!0});var Y0=a(Hn);Zc=s(Y0,"SPAN",{});var Z0=a(Zc);y(ur.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Sk=h(iu),ep=s(iu,"SPAN",{});var e8=a(ep);Wk=i(e8,"RobertaForMultipleChoice"),e8.forEach(t),iu.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);y(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t8=a(tp);Uk=i(t8,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t8.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lu=a(_r);Qk=i(lu,"This model inherits from "),md=s(lu,"A",{href:!0});var o8=a(md);Jk=i(o8,"PreTrainedModel"),o8.forEach(t),Vk=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),Kk=h(ro),br=s(ro,"P",{});var du=a(br);Gk=i(du,"This model is also a PyTorch "),kr=s(du,"A",{href:!0,rel:!0});var n8=a(kr);Xk=i(n8,"torch.nn.Module"),n8.forEach(t),Yk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),e1=h(oa),zo=s(oa,"P",{});var Qd=a(zo);t1=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s8=a(fd);o1=i(s8,"RobertaForMultipleChoice"),s8.forEach(t),n1=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a8=a(op);s1=i(a8,"__call__"),a8.forEach(t),a1=i(Qd," special method."),Qd.forEach(t),r1=h(oa),y(Qn.$$.fragment,oa),i1=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var r8=a(Vn);np=s(r8,"SPAN",{});var i8=a(np);y(Tr.$$.fragment,i8),i8.forEach(t),r8.forEach(t),l1=h(cu),sp=s(cu,"SPAN",{});var l8=a(sp);d1=i(l8,"RobertaForTokenClassification"),l8.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),c1=h(io),ap=s(io,"P",{});var d8=a(ap);p1=i(d8,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d8.forEach(t),h1=h(io),wr=s(io,"P",{});var pu=a(wr);m1=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var c8=a(ud);f1=i(c8,"PreTrainedModel"),c8.forEach(t),u1=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),g1=h(io),$r=s(io,"P",{});var hu=a($r);_1=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var p8=a(Fr);b1=i(p8,"torch.nn.Module"),p8.forEach(t),k1=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),v1=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),T1=h(lo),Co=s(lo,"P",{});var Jd=a(Co);y1=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h8=a(gd);w1=i(h8,"RobertaForTokenClassification"),h8.forEach(t),$1=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var m8=a(rp);F1=i(m8,"__call__"),m8.forEach(t),x1=i(Jd," special method."),Jd.forEach(t),R1=h(lo),y(Kn.$$.fragment,lo),M1=h(lo),y(Gn.$$.fragment,lo),E1=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f8=a(Yn);ip=s(f8,"SPAN",{});var u8=a(ip);y(Rr.$$.fragment,u8),u8.forEach(t),f8.forEach(t),z1=h(mu),lp=s(mu,"SPAN",{});var g8=a(lp);q1=i(g8,"RobertaForQuestionAnswering"),g8.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),C1=h(co),Po=s(co,"P",{});var Vd=a(Po);j1=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _8=a(dp);P1=i(_8,"span start logits"),_8.forEach(t),L1=i(Vd," and "),cp=s(Vd,"CODE",{});var b8=a(cp);A1=i(b8,"span end logits"),b8.forEach(t),O1=i(Vd,")."),Vd.forEach(t),N1=h(co),Er=s(co,"P",{});var fu=a(Er);I1=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k8=a(_d);D1=i(k8,"PreTrainedModel"),k8.forEach(t),S1=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),W1=h(co),zr=s(co,"P",{});var uu=a(zr);B1=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var v8=a(qr);U1=i(v8,"torch.nn.Module"),v8.forEach(t),H1=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Q1=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),J1=h(po),Lo=s(po,"P",{});var Kd=a(Lo);V1=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T8=a(bd);K1=i(T8,"RobertaForQuestionAnswering"),T8.forEach(t),G1=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y8=a(pp);X1=i(y8,"__call__"),y8.forEach(t),Y1=i(Kd," special method."),Kd.forEach(t),Z1=h(po),y(Zn.$$.fragment,po),ev=h(po),y(es.$$.fragment,po),tv=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w8=a(os);hp=s(w8,"SPAN",{});var $8=a(hp);y(jr.$$.fragment,$8),$8.forEach(t),w8.forEach(t),ov=h(gu),mp=s(gu,"SPAN",{});var F8=a(mp);nv=i(F8,"TFRobertaModel"),F8.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sv=h(Ot),fp=s(Ot,"P",{});var x8=a(fp);av=i(x8,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x8.forEach(t),rv=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iv=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R8=a(kd);lv=i(R8,"TFPreTrainedModel"),R8.forEach(t),dv=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cv=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);pv=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M8=a(Or);hv=i(M8,"tf.keras.Model"),M8.forEach(t),mv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fv=h(Ot),y(ns.$$.fragment,Ot),uv=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gv=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_v=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E8=a(vd);bv=i(E8,"TFRobertaModel"),E8.forEach(t),kv=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z8=a(up);vv=i(z8,"__call__"),z8.forEach(t),Tv=i(Gd," special method."),Gd.forEach(t),yv=h(na),y(ss.$$.fragment,na),wv=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var q8=a(rs);gp=s(q8,"SPAN",{});var C8=a(gp);y(Ir.$$.fragment,C8),C8.forEach(t),q8.forEach(t),$v=h(ku),_p=s(ku,"SPAN",{});var j8=a(_p);Fv=i(j8,"TFRobertaForCausalLM"),j8.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),xv=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),Rv=h(sa),Do=s(sa,"P",{});var Xd=a(Do);Mv=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P8=a(Td);Ev=i(P8,"TFRobertaForCausalLM"),P8.forEach(t),zv=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L8=a(bp);qv=i(L8,"__call__"),L8.forEach(t),Cv=i(Xd," special method."),Xd.forEach(t),jv=h(sa),y(is.$$.fragment,sa),Pv=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var A8=a(ds);kp=s(A8,"SPAN",{});var O8=a(kp);y(Wr.$$.fragment,O8),O8.forEach(t),A8.forEach(t),Lv=h(Tu),vp=s(Tu,"SPAN",{});var N8=a(vp);Av=i(N8,"TFRobertaForMaskedLM"),N8.forEach(t),Tu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),Ov=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);Nv=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var I8=a(Tp);Iv=i(I8,"language modeling"),I8.forEach(t),Dv=i(yu," head on top."),yu.forEach(t),Sv=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wv=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var D8=a(yd);Bv=i(D8,"TFPreTrainedModel"),D8.forEach(t),Uv=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Hv=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Qv=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var S8=a(Jr);Jv=i(S8,"tf.keras.Model"),S8.forEach(t),Vv=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),Kv=h(Nt),y(cs.$$.fragment,Nt),Gv=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),Xv=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yv=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W8=a(wd);Zv=i(W8,"TFRobertaForMaskedLM"),W8.forEach(t),eT=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B8=a(yp);tT=i(B8,"__call__"),B8.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),y(ps.$$.fragment,ho),sT=h(ho),y(hs.$$.fragment,ho),aT=h(ho),y(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U8=a(fs);wp=s(U8,"SPAN",{});var H8=a(wp);y(Kr.$$.fragment,H8),H8.forEach(t),U8.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Q8=a($p);iT=i(Q8,"TFRobertaForSequenceClassification"),Q8.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var J8=a(Fp);dT=i(J8,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J8.forEach(t),cT=h(It),Xr=s(It,"P",{});var xu=a(Xr);pT=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var V8=a($d);hT=i(V8,"TFPreTrainedModel"),V8.forEach(t),mT=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fT=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uT=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var K8=a(Zr);gT=i(K8,"tf.keras.Model"),K8.forEach(t),_T=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G8=a(Fd);yT=i(G8,"TFRobertaForSequenceClassification"),G8.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X8=a(xp);$T=i(X8,"__call__"),X8.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y8=a(ks);Rp=s(Y8,"SPAN",{});var Z8=a(Rp);y(ti.$$.fragment,Z8),Z8.forEach(t),Y8.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);CT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
