...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
Memory Wall for Extreme Scale Deep Learning`),X5=a("."),Bj=u(),Ip=o("p"),Q5=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Wj=u(),Up=o("p"),e6=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
...
install `),jf=o("em"),K6=a("libaio-dev"),J6=a(" system-wide)."),mg=u(),Dt=o("p"),X6=a("Edit "),gf=o("code"),Q6=a("TORCH_CUDA_ARCH_LIST"),e$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
documented `),Eo=o("a"),Y$=a("here"),K$=a(". The file naming is up to you."),Rg=u(),ri=o("p"),J$=a("Therefore, if your original command line looked as follows:"),Ig=u(),f(qo.$$.fragment),Ug=u(),pi=o("p"),X$=a("Now it should be:"),Gg=u(),f($o.$$.fragment),Lg=u(),U=o("p"),Q$=a("Unlike, "),xf=o("code"),e4=a("torch.distributed.launch"),s4=a(" where you have to specify how many GPUs to use with "),Rf=o("code"),t4=a("--nproc_per_node"),a4=a(`, with the
...
install `),jf=l(ih,"EM",{});var rL=r(jf);K6=n(rL,"libaio-dev"),rL.forEach(t),J6=n(ih," system-wide)."),ih.forEach(t),mg=c(e),Dt=l(e,"P",{});var pE=r(Dt);X6=n(pE,"Edit "),gf=l(pE,"CODE",{});var pL=r(gf);Q6=n(pL,"TORCH_CUDA_ARCH_LIST"),pL.forEach(t),e$=n(pE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
