...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16155/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16155/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16155/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16155/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16155/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16155/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16155/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16155/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16155/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16155/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
layers on top of the hidden-states output to compute `),Mc=s(rd,"CODE",{});var Y0=r(Mc);Jk=i(Y0,"span start logits"),Y0.forEach(t),Kk=i(rd," and "),Ec=s(rd,"CODE",{});var Z0=r(Ec);Gk=i(Z0,"span end logits"),Z0.forEach(t),Xk=i(rd,")."),rd.forEach(t),Yk=d(so),Wr=s(so,"P",{});var yf=r(Wr);Zk=i(yf,"This model inherits from "),Ml=s(yf,"A",{href:!0});var e5=r(Ml);e1=i(e5,"PreTrainedModel"),e5.forEach(t),t1=i(yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yf.forEach(t),o1=d(so),Br=s(so,"P",{});var vf=r(Br);n1=i(vf,"This model is also a PyTorch "),Ur=s(vf,"A",{href:!0,rel:!0});var t5=r(Ur);s1=i(t5,"torch.nn.Module"),t5.forEach(t),r1=i(vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),a1=d(so),dt=s(so,"DIV",{class:!0});var ro=r(dt);y(Hr.$$.fragment,ro),i1=d(ro),Do=s(ro,"P",{});var ad=r(Do);l1=i(ad,"The "),El=s(ad,"A",{href:!0});var o5=r(El);d1=i(o5,"RobertaForQuestionAnswering"),o5.forEach(t),c1=i(ad," forward method, overrides the "),zc=s(ad,"CODE",{});var n5=r(zc);p1=i(n5,"__call__"),n5.forEach(t),h1=i(ad," special method."),ad.forEach(t),u1=d(ro),y(In.$$.fragment,ro),f1=d(ro),xc=s(ro,"P",{});var s5=r(xc);m1=i(s5,"Example:"),s5.forEach(t),g1=d(ro),y(Qr.$$.fragment,ro),ro.forEach(t),so.forEach(t),uu=d(o),So=s(o,"H2",{class:!0});var wf=r(So);Dn=s(wf,"A",{id:!0,class:!0,href:!0});var r5=r(Dn);qc=s(r5,"SPAN",{});var a5=r(qc);y(Vr.$$.fragment,a5),a5.forEach(t),r5.forEach(t),_1=d(wf),Cc=s(wf,"SPAN",{});var i5=r(Cc);b1=i(i5,"TFRobertaModel"),i5.forEach(t),wf.forEach(t),fu=d(o),Ue=s(o,"DIV",{class:!0});var Ct=r(Ue);y(Jr.$$.fragment,Ct),k1=d(Ct),Pc=s(Ct,"P",{});var l5=r(Pc);T1=i(l5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),l5.forEach(t),y1=d(Ct),Kr=s(Ct,"P",{});var $f=r(Kr);v1=i($f,"This model inherits from "),zl=s($f,"A",{href:!0});var d5=r(zl);w1=i(d5,"TFPreTrainedModel"),d5.forEach(t),$1=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),F1=d(Ct),Gr=s(Ct,"P",{});var Ff=r(Gr);R1=i(Ff,"This model is also a "),Xr=s(Ff,"A",{href:!0,rel:!0});var c5=r(Xr);M1=i(c5,"tf.keras.Model"),c5.forEach(t),E1=i(Ff,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ff.forEach(t),z1=d(Ct),y(Sn.$$.fragment,Ct),x1=d(Ct),ct=s(Ct,"DIV",{class:!0});var ao=r(ct);y(Yr.$$.fragment,ao),q1=d(ao),Wo=s(ao,"P",{});var id=r(Wo);C1=i(id,"The "),xl=s(id,"A",{href:!0});var p5=r(xl);P1=i(p5,"TFRobertaModel"),p5.forEach(t),j1=i(id," forward method, overrides the "),jc=s(id,"CODE",{});var h5=r(jc);L1=i(h5,"__call__"),h5.forEach(t),A1=i(id," special method."),id.forEach(t),O1=d(ao),y(Wn.$$.fragment,ao),N1=d(ao),Lc=s(ao,"P",{});var u5=r(Lc);I1=i(u5,"Example:"),u5.forEach(t),D1=d(ao),y(Zr.$$.fragment,ao),ao.forEach(t),Ct.forEach(t),mu=d(o),Bo=s(o,"H2",{class:!0});var Rf=r(Bo);Bn=s(Rf,"A",{id:!0,class:!0,href:!0});var f5=r(Bn);Ac=s(f5,"SPAN",{});var m5=r(Ac);y(ea.$$.fragment,m5),m5.forEach(t),f5.forEach(t),S1=d(Rf),Oc=s(Rf,"SPAN",{});var g5=r(Oc);W1=i(g5,"TFRobertaForCausalLM"),g5.forEach(t),Rf.forEach(t),gu=d(o),Uo=s(o,"DIV",{class:!0});var Mf=r(Uo);y(ta.$$.fragment,Mf),B1=d(Mf),pt=s(Mf,"DIV",{class:!0});var io=r(pt);y(oa.$$.fragment,io),U1=d(io),Ho=s(io,"P",{});var ld=r(Ho);H1=i(ld,"The "),ql=s(ld,"A",{href:!0});var _5=r(ql);Q1=i(_5,"TFRobertaForCausalLM"),_5.forEach(t),V1=i(ld," forward method, overrides the "),Nc=s(ld,"CODE",{});var b5=r(Nc);J1=i(b5,"__call__"),b5.forEach(t),K1=i(ld," special method."),ld.forEach(t),G1=d(io),y(Un.$$.fragment,io),X1=d(io),Ic=s(io,"P",{});var k5=r(Ic);Y1=i(k5,"Example:"),k5.forEach(t),Z1=d(io),y(na.$$.fragment,io),io.forEach(t),Mf.forEach(t),_u=d(o),Qo=s(o,"H2",{class:!0});var Ef=r(Qo);Hn=s(Ef,"A",{id:!0,class:!0,href:!0});var T5=r(Hn);Dc=s(T5,"SPAN",{});var y5=r(Dc);y(sa.$$.fragment,y5),y5.forEach(t),T5.forEach(t),eT=d(Ef),Sc=s(Ef,"SPAN",{});var v5=r(Sc);tT=i(v5,"TFRobertaForMaskedLM"),v5.forEach(t),Ef.forEach(t),bu=d(o),He=s(o,"DIV",{class:!0});var Pt=r(He);y(ra.$$.fragment,Pt),oT=d(Pt),aa=s(Pt,"P",{});var zf=r(aa);nT=i(zf,"RoBERTa Model with a "),Wc=s(zf,"CODE",{});var w5=r(Wc);sT=i(w5,"language modeling"),w5.forEach(t),rT=i(zf," head on top."),zf.forEach(t),aT=d(Pt),ia=s(Pt,"P",{});var xf=r(ia);iT=i(xf,"This model inherits from "),Cl=s(xf,"A",{href:!0});var $5=r(Cl);lT=i($5,"TFPreTrainedModel"),$5.forEach(t),dT=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xf.forEach(t),cT=d(Pt),la=s(Pt,"P",{});var qf=r(la);pT=i(qf,"This model is also a "),da=s(qf,"A",{href:!0,rel:!0});var F5=r(da);hT=i(F5,"tf.keras.Model"),F5.forEach(t),uT=i(qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qf.forEach(t),fT=d(Pt),y(Qn.$$.fragment,Pt),mT=d(Pt),ht=s(Pt,"DIV",{class:!0});var lo=r(ht);y(ca.$$.fragment,lo),gT=d(lo),Vo=s(lo,"P",{});var dd=r(Vo);_T=i(dd,"The "),Pl=s(dd,"A",{href:!0});var R5=r(Pl);bT=i(R5,"TFRobertaForMaskedLM"),R5.forEach(t),kT=i(dd," forward method, overrides the "),Bc=s(dd,"CODE",{});var M5=r(Bc);TT=i(M5,"__call__"),M5.forEach(t),yT=i(dd," special method."),dd.forEach(t),vT=d(lo),y(Vn.$$.fragment,lo),wT=d(lo),Uc=s(lo,"P",{});var E5=r(Uc);$T=i(E5,"Example:"),E5.forEach(t),FT=d(lo),y(pa.$$.fragment,lo),lo.forEach(t),Pt.forEach(t),ku=d(o),Jo=s(o,"H2",{class:!0});var Cf=r(Jo);Jn=s(Cf,"A",{id:!0,class:!0,href:!0});var z5=r(Jn);Hc=s(z5,"SPAN",{});var x5=r(Hc);y(ha.$$.fragment,x5),x5.forEach(t),z5.forEach(t),RT=d(Cf),Qc=s(Cf,"SPAN",{});var q5=r(Qc);MT=i(q5,"TFRobertaForSequenceClassification"),q5.forEach(t),Cf.forEach(t),Tu=d(o),Qe=s(o,"DIV",{class:!0});var jt=r(Qe);y(ua.$$.fragment,jt),ET=d(jt),Vc=s(jt,"P",{});var C5=r(Vc);zT=i(C5,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C5.forEach(t),xT=d(jt),fa=s(jt,"P",{});var Pf=r(fa);qT=i(Pf,"This model inherits from "),jl=s(Pf,"A",{href:!0});var P5=r(jl);CT=i(P5,"TFPreTrainedModel"),P5.forEach(t),PT=i(Pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pf.forEach(t),jT=d(jt),ma=s(jt,"P",{});var jf=r(ma);LT=i(jf,"This model is also a "),ga=s(jf,"A",{href:!0,rel:!0});var j5=r(ga);AT=i(j5,"tf.keras.Model"),j5.forEach(t),OT=i(jf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jf.forEach(t),NT=d(jt),y(Kn.$$.fragment,jt),IT=d(jt),ut=s(jt,"DIV",{class:!0});var co=r(ut);y(_a.$$.fragment,co),DT=d(co),Ko=s(co,"P",{});var cd=r(Ko);ST=i(cd,"The "),Ll=s(cd,"A",{href:!0});var L5=r(Ll);WT=i(L5,"TFRobertaForSequenceClassification"),L5.forEach(t),BT=i(cd," forward method, overrides the "),Jc=s(cd,"CODE",{});var A5=r(Jc);UT=i(A5,"__call__"),A5.forEach(t),HT=i(cd," special method."),cd.forEach(t),QT=d(co),y(Gn.$$.fragment,co),VT=d(co),Kc=s(co,"P",{});var O5=r(Kc);JT=i(O5,"Example:"),O5.forEach(t),KT=d(co),y(ba.$$.fragment,co),co.forEach(t),jt.forEach(t),yu=d(o),Go=s(o,"H2",{class:!0});var Lf=r(Go);Xn=s(Lf,"A",{id:!0,class:!0,href:!0});var N5=r(Xn);Gc=s(N5,"SPAN",{});var I5=r(Gc);y(ka.$$.fragment,I5),I5.forEach(t),N5.forEach(t),GT=d(Lf),Xc=s(Lf,"SPAN",{});var D5=r(Xc);XT=i(D5,"TFRobertaForMultipleChoice"),D5.forEach(t),Lf.forEach(t),vu=d(o),Ve=s(o,"DIV",{class:!0});var Lt=r(Ve);y(Ta.$$.fragment,Lt),YT=d(Lt),Yc=s(Lt,"P",{});var S5=r(Yc);ZT=i(S5,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),S5.forEach(t),ey=d(Lt),ya=s(Lt,"P",{});var Af=r(ya);ty=i(Af,"This model inherits from "),Al=s(Af,"A",{href:!0});var W5=r(Al);oy=i(W5,"TFPreTrainedModel"),W5.forEach(t),ny=i(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),sy=d(Lt),va=s(Lt,"P",{});var Of=r(va);ry=i(Of,"This model is also a "),wa=s(Of,"A",{href:!0,rel:!0});var B5=r(wa);ay=i(B5,"tf.keras.Model"),B5.forEach(t),iy=i(Of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),ly=d(Lt),y(Yn.$$.fragment,Lt),dy=d(Lt),ft=s(Lt,"DIV",{class:!0});var po=r(ft);y($a.$$.fragment,po),cy=d(po),Xo=s(po,"P",{});var pd=r(Xo);py=i(pd,"The "),Ol=s(pd,"A",{href:!0});var U5=r(Ol);hy=i(U5,"TFRobertaForMultipleChoice"),U5.forEach(t),uy=i(pd," forward method, overrides the "),Zc=s(pd,"CODE",{});var H5=r(Zc);fy=i(H5,"__call__"),H5.forEach(t),my=i(pd," special method."),pd.forEach(t),gy=d(po),y(Zn.$$.fragment,po),_y=d(po),ep=s(po,"P",{});var Q5=r(ep);by=i(Q5,"Example:"),Q5.forEach(t),ky=d(po),y(Fa.$$.fragment,po),po.forEach(t),Lt.forEach(t),wu=d(o),Yo=s(o,"H2",{class:!0});var Nf=r(Yo);es=s(Nf,"A",{id:!0,class:!0,href:!0});var V5=r(es);tp=s(V5,"SPAN",{});var J5=r(tp);y(Ra.$$.fragment,J5),J5.forEach(t),V5.forEach(t),Ty=d(Nf),op=s(Nf,"SPAN",{});var K5=r(op);yy=i(K5,"TFRobertaForTokenClassification"),K5.forEach(t),Nf.forEach(t),$u=d(o),Je=s(o,"DIV",{class:!0});var At=r(Je);y(Ma.$$.fragment,At),vy=d(At),np=s(At,"P",{});var G5=r(np);wy=i(G5,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),G5.forEach(t),$y=d(At),Ea=s(At,"P",{});var If=r(Ea);Fy=i(If,"This model inherits from "),Nl=s(If,"A",{href:!0});var X5=r(Nl);Ry=i(X5,"TFPreTrainedModel"),X5.forEach(t),My=i(If,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),If.forEach(t),Ey=d(At),za=s(At,"P",{});var Df=r(za);zy=i(Df,"This model is also a "),xa=s(Df,"A",{href:!0,rel:!0});var Y5=r(xa);xy=i(Y5,"tf.keras.Model"),Y5.forEach(t),qy=i(Df,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),Cy=d(At),y(ts.$$.fragment,At),Py=d(At),mt=s(At,"DIV",{class:!0});var ho=r(mt);y(qa.$$.fragment,ho),jy=d(ho),Zo=s(ho,"P",{});var hd=r(Zo);Ly=i(hd,"The "),Il=s(hd,"A",{href:!0});var Z5=r(Il);Ay=i(Z5,"TFRobertaForTokenClassification"),Z5.forEach(t),Oy=i(hd," forward method, overrides the "),sp=s(hd,"CODE",{});var eR=r(sp);Ny=i(eR,"__call__"),eR.forEach(t),Iy=i(hd," special method."),hd.forEach(t),Dy=d(ho),y(os.$$.fragment,ho),Sy=d(ho),rp=s(ho,"P",{});var tR=r(rp);Wy=i(tR,"Example:"),tR.forEach(t),By=d(ho),y(Ca.$$.fragment,ho),ho.forEach(t),At.forEach(t),Fu=d(o),en=s(o,"H2",{class:!0});var Sf=r(en);ns=s(Sf,"A",{id:!0,class:!0,href:!0});var oR=r(ns);ap=s(oR,"SPAN",{});var nR=r(ap);y(Pa.$$.fragment,nR),nR.forEach(t),oR.forEach(t),Uy=d(Sf),ip=s(Sf,"SPAN",{});var sR=r(ip);Hy=i(sR,"TFRobertaForQuestionAnswering"),sR.forEach(t),Sf.forEach(t),Ru=d(o),Ke=s(o,"DIV",{class:!0});var Ot=r(Ke);y(ja.$$.fragment,Ot),Qy=d(Ot),tn=s(Ot,"P",{});var ud=r(tn);Vy=i(ud,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
