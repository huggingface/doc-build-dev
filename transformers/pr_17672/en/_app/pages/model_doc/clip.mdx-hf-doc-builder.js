...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),b=i("Example:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Example:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function y_(x){let d,b,u,c,_;return c=new A({props:{code:`from transformers import CLIPVisionModel, CLIPVisionConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = logits_per_image.softmax(dim=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function k_(x){let d,b,u,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(p,"CODE",{});var L=a(u);c=l(L,"Module"),L.forEach(o),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text_features = model.get_text_features(**inputs)`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function M_(x){let d,b,u,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(p,"CODE",{});var L=a(u);c=l(L,"Module"),L.forEach(o),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function D_(x){let d,b,u,c,_,n,p,L,dn,Ue,j,ne,Ie,Ce,pn,ye,cn,Ft,Z,Fe,xe,qt,H,Q,qe,Re,Dt,De,Le,mn,Ot,O,se,ke,we,fn,Me,hn,At,Y,un,Oe,re;return{c(){d=s("p"),b=i("TF 2.0 models accepts two formats as inputs:"),u=m(),c=s("ul"),_=s("li"),n=i("having all inputs as keyword arguments (like PyTorch models), or"),p=m(),L=s("li"),dn=i("having all inputs as a list, tuple or dict in the first positional arguments."),Ue=m(),j=s("p"),ne=i("This second option is useful when using "),Ie=s("code"),Ce=i("tf.keras.Model.fit"),pn=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),ye=s("code"),cn=i("model(inputs)"),Ft=i("."),Z=m(),Fe=s("p"),xe=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),Oe=s("code"),re=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=r(w,"P",{});var z=a(d);b=l(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(o),u=f(w),c=r(w,"UL",{});var Vt=a(c);_=r(Vt,"LI",{});var Xs=a(_);n=l(Xs,"having all inputs as keyword arguments (like PyTorch models), or"),Xs.forEach(o),p=f(Vt),L=r(Vt,"LI",{});var gn=a(L);dn=l(gn,"having all inputs as a list, tuple or dict in the first positional arguments."),gn.forEach(o),Vt.forEach(o),Ue=f(w),j=r(w,"P",{});var M=a(j);ne=l(M,"This second option is useful when using "),Ie=r(M,"CODE",{});var Zs=a(Ie);Ce=l(Zs,"tf.keras.Model.fit"),Zs.forEach(o),pn=l(M,` method which currently requires having all the
tensors in the first argument of the model call function: `),ye=r(M,"CODE",{});var He=a(ye);cn=l(He,"model(inputs)"),He.forEach(o),Ft=l(M,"."),M.forEach(o),Z=f(w),Fe=r(w,"P",{});var Qs=a(Fe);xe=l(Qs,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = tf.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function V_(x){let d,b,u,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(p,"CODE",{});var L=a(u);c=l(L,"Module"),L.forEach(o),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){v(n,d,p),e(d,b),e(d,u),e(u,c),e(d,_)},d(n){n&&o(d)}}}function N_(x){let d,b,u,c,_;return c=new A({props:{code:`from transformers import CLIPTokenizer, TFCLIPModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text_features = model.get_text_features(**inputs)`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function S_(x){let d,b,u,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(p,"CODE",{});var L=a(u);c=l(L,"Module"),L.forEach(o),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>image_features = model.get_image_features(**inputs)`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function B_(x){let d,b,u,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(p,"CODE",{});var L=a(u);c=l(L,"Module"),L.forEach(o),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text_features = model.get_text_features(**inputs)`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function X_(x){let d,b,u,c,_;return c=new A({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, FlaxCLIPModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>image_features = model.get_image_features(**inputs)`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Examples:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function Z_(x){let d,b,u,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(p,"CODE",{});var L=a(u);c=l(L,"Module"),L.forEach(o),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooler_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=s("p"),b=i("Example:"),u=m(),P(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Example:"),p.forEach(o),u=f(n),$(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,u,p),T(c,n,p),_=!0},p:S,i(n){_||(I(c.$$.fragment,n),_=!0)},o(n){C(c.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(c,n)}}}function tv(x){let d,b,u,c,_,n,p,L,dn,Ue,j,ne,Ie,Ce,pn,ye,cn,Ft,Z,Fe,xe,qt,H,Q,qe,Re,Dt,De,Le,mn,Ot,O,se,ke,we,fn,Me,hn,At,Y,un,Oe,re,w,z,Vt,Xs,gn,M,Zs,He,Qs,Ae,ae,Ys,er,ie,tr,or,Ve,nr,hd,sr,ud,gd,rr,_d,vd,Ri,_n,Hi,Ne,bd,vn,Pd,$d,bn,Td,Id,Ki,Ke,Nt,aa,Pn,Cd,ia,yd,Gi,ee,$n,xd,St,ar,Ld,kd,ir,wd,Md,Ed,Ge,jd,lr,zd,Fd,dr,qd,Dd,Od,Wt,Tn,Ad,In,Vd,pr,Nd,Sd,Ji,Je,Bt,la,Cn,Wd,da,Bd,Xi,te,yn,Ud,Xe,Rd,cr,Hd,Kd,xn,Gd,Jd,Xd,Ze,Zd,mr,Qd,Yd,fr,ep,tp,op,Ut,Zi,Qe,Rt,pa,Ln,np,ca,sp,Qi,oe,kn,rp,Ye,ap,hr,ip,lp,wn,dp,pp,cp,et,mp,ur,fp,hp,gr,up,gp,_p,Ht,Yi,tt,Kt,ma,Mn,vp,fa,bp,el,F,En,Pp,ha,$p,Tp,jn,Ip,_r,Cp,yp,xp,le,zn,Lp,ua,kp,wp,ga,vr,Mp,_a,Ep,jp,va,zp,Fp,Gt,Fn,qp,qn,Dp,ba,Op,Ap,Vp,Jt,Dn,Np,Pa,Sp,Wp,br,On,tl,ot,Xt,$a,An,Bp,Ta,Up,ol,B,Vn,Rp,Nn,Hp,Ia,Kp,Gp,Jp,Sn,Xp,Pr,Zp,Qp,Yp,de,Wn,ec,Ca,tc,oc,ya,$r,nc,xa,sc,rc,La,ac,ic,Zt,Bn,lc,ka,dc,nl,nt,Qt,wa,Un,pc,Ma,cc,sl,Ee,Rn,mc,Ea,fc,hc,Hn,uc,Tr,gc,_c,rl,st,Yt,ja,Kn,vc,za,bc,al,U,Gn,Pc,Fa,$c,Tc,K,Ir,Ic,Cc,Cr,yc,xc,yr,Lc,kc,qa,wc,Mc,xr,Ec,jc,zc,eo,Jn,Fc,Xn,qc,Lr,Dc,Oc,Ac,to,Zn,Vc,Qn,Nc,kr,Sc,Wc,il,rt,oo,Da,Yn,Bc,Oa,Uc,ll,R,es,Rc,ts,Hc,os,Kc,Gc,Jc,pe,ns,Xc,at,Zc,wr,Qc,Yc,Aa,em,tm,om,no,nm,so,sm,ce,ss,rm,it,am,Mr,im,lm,Va,dm,pm,cm,ro,mm,ao,fm,me,rs,hm,lt,um,Er,gm,_m,Na,vm,bm,Pm,io,$m,lo,dl,dt,po,Sa,as,Tm,Wa,Im,pl,pt,is,Cm,fe,ls,ym,ct,xm,jr,Lm,km,Ba,wm,Mm,Em,co,jm,mo,cl,mt,fo,Ua,ds,zm,Ra,Fm,ml,ft,ps,qm,he,cs,Dm,ht,Om,zr,Am,Vm,Ha,Nm,Sm,Wm,ho,Bm,uo,fl,ut,go,Ka,ms,Um,Ga,Rm,hl,q,fs,Hm,hs,Km,Fr,Gm,Jm,Xm,us,Zm,gs,Qm,Ym,ef,_o,tf,ue,_s,of,gt,nf,qr,sf,rf,Ja,af,lf,df,vo,pf,bo,cf,ge,vs,mf,_t,ff,Dr,hf,uf,Xa,gf,_f,vf,Po,bf,$o,Pf,_e,bs,$f,vt,Tf,Or,If,Cf,Za,yf,xf,Lf,To,kf,Io,ul,bt,Co,Qa,Ps,wf,Ya,Mf,gl,Pt,$s,Ef,ve,Ts,jf,$t,zf,Ar,Ff,qf,ei,Df,Of,Af,yo,Vf,xo,_l,Tt,Lo,ti,Is,Nf,oi,Sf,vl,It,Cs,Wf,be,ys,Bf,Ct,Uf,Vr,Rf,Hf,ni,Kf,Gf,Jf,ko,Xf,wo,bl,yt,Mo,si,xs,Zf,ri,Qf,Pl,E,Ls,Yf,ks,eh,Nr,th,oh,nh,ws,sh,Ms,rh,ah,ih,ai,lh,dh,je,ii,Es,ph,ch,li,js,mh,fh,di,zs,hh,uh,pi,Fs,gh,_h,Pe,qs,vh,xt,bh,ci,Ph,$h,mi,Th,Ih,Ch,Eo,yh,jo,xh,zo,Ds,Lh,Fo,kh,qo,Os,wh,Do,$l,Lt,Oo,fi,As,Mh,hi,Eh,Tl,kt,Vs,jh,$e,Ns,zh,wt,Fh,ui,qh,Dh,gi,Oh,Ah,Vh,Ao,Nh,Vo,Il,Mt,No,_i,Ss,Sh,vi,Wh,Cl,Et,Ws,Bh,Te,Bs,Uh,jt,Rh,bi,Hh,Kh,Pi,Gh,Jh,Xh,So,Zh,Wo,yl;return n=new D({}),Ce=new D({}),we=new D({}),_n=new A({props:{code:`from PIL import Image
import requests
...
Dictionary of configuration options used to initialize <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTextConfig">CLIPTextConfig</a>.`,name:"text_config_dict"},{anchor:"transformers.CLIPConfig.vision_config_dict",description:`<strong>vision_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/configuration_clip.py#L245"}}),Tn=new k({props:{name:"from_text_vision_configs",anchor:"transformers.CLIPConfig.from_text_vision_configs",parameters:[{name:"text_config",val:": CLIPTextConfig"},{name:"vision_config",val:": CLIPVisionConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/configuration_clip.py#L294",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPConfig"
>CLIPConfig</a></p>
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPModel">CLIPModel</a>.`,name:"vocab_size"},{anchor:"transformers.CLIPTextConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/tokenization_clip.py#L186",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/tokenization_clip.py#L213",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/tokenization_clip.py#L241",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
The end of sequence token.`,name:"eos_token"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/tokenization_clip_fast.py#L50"}}),Wn=new k({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/tokenization_clip_fast.py#L123",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/tokenization_clip_fast.py#L150",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to convert <code>PIL.Image.Image</code> into <code>RGB</code> format`,name:"convert_rgb"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/feature_extraction_clip.py#L30"}}),Kn=new D({}),Gn=new k({props:{name:"class transformers.CLIPProcessor",anchor:"transformers.CLIPProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.CLIPProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>) &#x2014;
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.CLIPProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTokenizerFast">CLIPTokenizerFast</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/processing_clip.py#L22"}}),Jn=new k({props:{name:"batch_decode",anchor:"transformers.CLIPProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/processing_clip.py#L95"}}),Zn=new k({props:{name:"decode",anchor:"transformers.CLIPProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/processing_clip.py#L102"}}),Yn=new D({}),es=new k({props:{name:"class transformers.CLIPModel",anchor:"transformers.CLIPModel",parameters:[{name:"config",val:": CLIPConfig"}],parametersDescription:[{anchor:"transformers.CLIPModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPConfig">CLIPConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17672/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L847"}}),ns=new k({props:{name:"forward",anchor:"transformers.CLIPModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"return_loss",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CLIPModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17672/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17672/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code> for details.`,name:"pixel_values"},{anchor:"transformers.CLIPModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L978",returnDescription:`
...
<li><strong>text_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</li>
<li><strong>image_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The image embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPVisionModel"
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L882",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L929",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L698",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
...
`}}),co=new X({props:{$$slots:{default:[j_]},$$scope:{ctx:x}}}),mo=new N({props:{anchor:"transformers.CLIPTextModel.forward.example",$$slots:{default:[z_]},$$scope:{ctx:x}}}),ds=new D({}),ps=new k({props:{name:"class transformers.CLIPVisionModel",anchor:"transformers.CLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L794"}}),cs=new k({props:{name:"forward",anchor:"transformers.CLIPVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CLIPVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_clip.py#L807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_tf_clip.py#L1341",returnDescription:`
...
<li><strong>text_embeds(<code>tf.Tensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.TFCLIPTextModel"
...
<a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.TFCLIPVisionModel"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_tf_clip.py#L1259",returnDescription:`
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_tf_clip.py#L1299",returnDescription:`
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_tf_clip.py#L1048",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_tf_clip.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or a tuple of <code>tf.Tensor</code> (if
<code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various elements depending on the
...
<p><a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or <code>tuple(tf.Tensor)</code></p>
`}}),ko=new X({props:{$$slots:{default:[R_]},$$scope:{ctx:x}}}),wo=new N({props:{anchor:"transformers.TFCLIPVisionModel.call.example",$$slots:{default:[H_]},$$scope:{ctx:x}}}),xs=new D({}),Ls=new k({props:{name:"class transformers.FlaxCLIPModel",anchor:"transformers.FlaxCLIPModel",parameters:[{name:"config",val:": CLIPConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPConfig">CLIPConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17672/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxCLIPModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17672/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17672/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L1148"}}),qs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPModel.__call__",parameters:[{name:"input_ids",val:""},{name:"pixel_values",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17672/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17672/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L777",returnDescription:`
...
<a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
<a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17672/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17672/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L822",returnDescription:`
<p>The text embeddings obtained by applying
the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
`}}),Do=new N({props:{anchor:"transformers.FlaxCLIPModel.get_image_features.example",$$slots:{default:[X_]},$$scope:{ctx:x}}}),As=new D({}),Vs=new k({props:{name:"class transformers.FlaxCLIPTextModel",anchor:"transformers.FlaxCLIPTextModel",parameters:[{name:"config",val:": CLIPTextConfig"},{name:"input_shape",val:" = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L969"}}),Ns=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPTextModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPTextModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17672/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17672/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17672/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L622",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
`}}),Ao=new X({props:{$$slots:{default:[Z_]},$$scope:{ctx:x}}}),Vo=new N({props:{anchor:"transformers.FlaxCLIPTextModel.__call__.example",$$slots:{default:[Q_]},$$scope:{ctx:x}}}),Ss=new D({}),Ws=new k({props:{name:"class transformers.FlaxCLIPVisionModel",anchor:"transformers.FlaxCLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L1022"}}),Bs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPVisionModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPVisionModel.__call__.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
Whether or not to return a <a href="/docs/transformers/pr_17672/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17672/src/transformers/models/clip/modeling_flax_clip.py#L702",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17672/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
documentation from `),dr=s("a"),qd=i("PretrainedConfig"),Dd=i(" for more information."),Od=m(),Wt=s("div"),P(Tn.$$.fragment),Ad=m(),In=s("p"),Vd=i("Instantiate a "),pr=s("a"),Nd=i("CLIPConfig"),Sd=i(` (or a derived class) from clip text model configuration and clip vision model
configuration.`),Ji=m(),Je=s("h2"),Bt=s("a"),la=s("span"),P(Cn.$$.fragment),Wd=m(),da=s("span"),Bd=i("CLIPTextConfig"),Xi=m(),te=s("div"),P(yn.$$.fragment),Ud=m(),Xe=s("p"),Rd=i("This is the configuration class to store the configuration of a "),cr=s("a"),Hd=i("CLIPModel"),Kd=i(`. It is used to instantiate an CLIP
...
special tokens using the tokenizer `),ba=s("code"),Op=i("prepare_for_model"),Ap=i(" method."),Vp=m(),Jt=s("div"),P(Dn.$$.fragment),Np=m(),Pa=s("p"),Sp=i(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),Wp=m(),br=s("div"),P(On.$$.fragment),tl=m(),ot=s("h2"),Xt=s("a"),$a=s("span"),P(An.$$.fragment),Bp=m(),Ta=s("span"),Up=i("CLIPTokenizerFast"),ol=m(),B=s("div"),P(Vn.$$.fragment),Rp=m(),Nn=s("p"),Hp=i("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Ia=s("em"),Kp=i("tokenizers"),Gp=i(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),Yp=m(),de=s("div"),P(Wn.$$.fragment),ec=m(),Ca=s("p"),tc=i(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),oc=m(),ya=s("ul"),$r=s("li"),nc=i("single sequence: "),xa=s("code"),sc=i("<|startoftext|> X <|endoftext|>"),rc=m(),La=s("p"),ac=i("Pairs of sequences are not the expected use case, but they will be handled without a separator."),ic=m(),Zt=s("div"),P(Bn.$$.fragment),lc=m(),ka=s("p"),dc=i(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
...
should refer to this superclass for more information regarding those methods.`),rl=m(),st=s("h2"),Yt=s("a"),ja=s("span"),P(Kn.$$.fragment),vc=m(),za=s("span"),bc=i("CLIPProcessor"),al=m(),U=s("div"),P(Gn.$$.fragment),Pc=m(),Fa=s("p"),$c=i("Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Tc=m(),K=s("p"),Ir=s("a"),Ic=i("CLIPProcessor"),Cc=i(" offers all the functionalities of "),Cr=s("a"),yc=i("CLIPFeatureExtractor"),xc=i(" and "),yr=s("a"),Lc=i("CLIPTokenizerFast"),kc=i(`. See the
...
refer to the docstring of this method for more information.`),Ac=m(),to=s("div"),P(Zn.$$.fragment),Vc=m(),Qn=s("p"),Nc=i("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),kr=s("a"),Sc=i("decode()"),Wc=i(`. Please refer to
...
behavior.`),Jc=m(),pe=s("div"),P(ns.$$.fragment),Xc=m(),at=s("p"),Zc=i("The "),wr=s("a"),Qc=i("CLIPModel"),Yc=i(" forward method, overrides the "),Aa=s("code"),em=i("__call__"),tm=i(" special method."),om=m(),P(no.$$.fragment),nm=m(),P(so.$$.fragment),sm=m(),ce=s("div"),P(ss.$$.fragment),rm=m(),it=s("p"),am=i("The "),Mr=s("a"),im=i("CLIPModel"),lm=i(" forward method, overrides the "),Va=s("code"),dm=i("__call__"),pm=i(" special method."),cm=m(),P(ro.$$.fragment),mm=m(),P(ao.$$.fragment),fm=m(),me=s("div"),P(rs.$$.fragment),hm=m(),lt=s("p"),um=i("The "),Er=s("a"),gm=i("CLIPModel"),_m=i(" forward method, overrides the "),Na=s("code"),vm=i("__call__"),bm=i(" special method."),Pm=m(),P(io.$$.fragment),$m=m(),P(lo.$$.fragment),dl=m(),dt=s("h2"),po=s("a"),Sa=s("span"),P(as.$$.fragment),Tm=m(),Wa=s("span"),Im=i("CLIPTextModel"),pl=m(),pt=s("div"),P(is.$$.fragment),Cm=m(),fe=s("div"),P(ls.$$.fragment),ym=m(),ct=s("p"),xm=i("The "),jr=s("a"),Lm=i("CLIPTextModel"),km=i(" forward method, overrides the "),Ba=s("code"),wm=i("__call__"),Mm=i(" special method."),Em=m(),P(co.$$.fragment),jm=m(),P(mo.$$.fragment),cl=m(),mt=s("h2"),fo=s("a"),Ua=s("span"),P(ds.$$.fragment),zm=m(),Ra=s("span"),Fm=i("CLIPVisionModel"),ml=m(),ft=s("div"),P(ps.$$.fragment),qm=m(),he=s("div"),P(cs.$$.fragment),Dm=m(),ht=s("p"),Om=i("The "),zr=s("a"),Am=i("CLIPVisionModel"),Vm=i(" forward method, overrides the "),Ha=s("code"),Nm=i("__call__"),Sm=i(" special method."),Wm=m(),P(ho.$$.fragment),Bm=m(),P(uo.$$.fragment),fl=m(),ut=s("h2"),go=s("a"),Ka=s("span"),P(ms.$$.fragment),Um=m(),Ga=s("span"),Rm=i("TFCLIPModel"),hl=m(),q=s("div"),P(fs.$$.fragment),Hm=m(),hs=s("p"),Km=i("This model inherits from "),Fr=s("a"),Gm=i("TFPreTrainedModel"),Jm=i(`. Check the superclass documentation for the generic methods the
...
documentation from `),dr=r(Sr,"A",{href:!0});var au=a(dr);qd=l(au,"PretrainedConfig"),au.forEach(o),Dd=l(Sr," for more information."),Sr.forEach(o),Od=f(Bo),Wt=r(Bo,"DIV",{class:!0});var xl=a(Wt);$(Tn.$$.fragment,xl),Ad=f(xl),In=r(xl,"P",{});var Ll=a(In);Vd=l(Ll,"Instantiate a "),pr=r(Ll,"A",{href:!0});var iu=a(pr);Nd=l(iu,"CLIPConfig"),iu.forEach(o),Sd=l(Ll,` (or a derived class) from clip text model configuration and clip vision model
configuration.`),Ll.forEach(o),xl.forEach(o),Bo.forEach(o),Ji=f(t),Je=r(t,"H2",{class:!0});var kl=a(Je);Bt=r(kl,"A",{id:!0,class:!0,href:!0});var lu=a(Bt);la=r(lu,"SPAN",{});var du=a(la);$(Cn.$$.fragment,du),du.forEach(o),lu.forEach(o),Wd=f(kl),da=r(kl,"SPAN",{});var pu=a(da);Bd=l(pu,"CLIPTextConfig"),pu.forEach(o),kl.forEach(o),Xi=f(t),te=r(t,"DIV",{class:!0});var Uo=a(te);$(yn.$$.fragment,Uo),Ud=f(Uo),Xe=r(Uo,"P",{});var Wr=a(Xe);Rd=l(Wr,"This is the configuration class to store the configuration of a "),cr=r(Wr,"A",{href:!0});var cu=a(cr);Hd=l(cu,"CLIPModel"),cu.forEach(o),Kd=l(Wr,`. It is used to instantiate an CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the CLIP
...
documentation from `),gr=r(Rr,"A",{href:!0});var $u=a(gr);up=l($u,"PretrainedConfig"),$u.forEach(o),gp=l(Rr," for more information."),Rr.forEach(o),_p=f(Ro),$(Ht.$$.fragment,Ro),Ro.forEach(o),Yi=f(t),tt=r(t,"H2",{class:!0});var Ml=a(tt);Kt=r(Ml,"A",{id:!0,class:!0,href:!0});var Tu=a(Kt);ma=r(Tu,"SPAN",{});var Iu=a(ma);$(Mn.$$.fragment,Iu),Iu.forEach(o),Tu.forEach(o),vp=f(Ml),fa=r(Ml,"SPAN",{});var Cu=a(fa);bp=l(Cu,"CLIPTokenizer"),Cu.forEach(o),Ml.forEach(o),el=f(t),F=r(t,"DIV",{class:!0});var G=a(F);$(En.$$.fragment,G),Pp=f(G),ha=r(G,"P",{});var yu=a(ha);$p=l(yu,"Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),yu.forEach(o),Tp=f(G),jn=r(G,"P",{});var El=a(jn);Ip=l(El,"This tokenizer inherits from "),_r=r(El,"A",{href:!0});var xu=a(_r);Cp=l(xu,"PreTrainedTokenizer"),xu.forEach(o),yp=l(El,` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),ba=r(zl,"CODE",{});var Eu=a(ba);Op=l(Eu,"prepare_for_model"),Eu.forEach(o),Ap=l(zl," method."),zl.forEach(o),jl.forEach(o),Vp=f(G),Jt=r(G,"DIV",{class:!0});var Fl=a(Jt);$(Dn.$$.fragment,Fl),Np=f(Fl),Pa=r(Fl,"P",{});var ju=a(Pa);Sp=l(ju,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ju.forEach(o),Fl.forEach(o),Wp=f(G),br=r(G,"DIV",{class:!0});var zu=a(br);$(On.$$.fragment,zu),zu.forEach(o),G.forEach(o),tl=f(t),ot=r(t,"H2",{class:!0});var ql=a(ot);Xt=r(ql,"A",{id:!0,class:!0,href:!0});var Fu=a(Xt);$a=r(Fu,"SPAN",{});var qu=a($a);$(An.$$.fragment,qu),qu.forEach(o),Fu.forEach(o),Bp=f(ql),Ta=r(ql,"SPAN",{});var Du=a(Ta);Up=l(Du,"CLIPTokenizerFast"),Du.forEach(o),ql.forEach(o),ol=f(t),B=r(t,"DIV",{class:!0});var Se=a(B);$(Vn.$$.fragment,Se),Rp=f(Se),Nn=r(Se,"P",{});var Dl=a(Nn);Hp=l(Dl,"Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Ia=r(Dl,"EM",{});var Ou=a(Ia);Kp=l(Ou,"tokenizers"),Ou.forEach(o),Gp=l(Dl,` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),Ol.forEach(o),Yp=f(Se),de=r(Se,"DIV",{class:!0});var Ko=a(de);$(Wn.$$.fragment,Ko),ec=f(Ko),Ca=r(Ko,"P",{});var Vu=a(Ca);tc=l(Vu,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),Vu.forEach(o),oc=f(Ko),ya=r(Ko,"UL",{});var Nu=a(ya);$r=r(Nu,"LI",{});var Yh=a($r);nc=l(Yh,"single sequence: "),xa=r(Yh,"CODE",{});var Su=a(xa);sc=l(Su,"<|startoftext|> X <|endoftext|>"),Su.forEach(o),Yh.forEach(o),Nu.forEach(o),rc=f(Ko),La=r(Ko,"P",{});var Wu=a(La);ac=l(Wu,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),Wu.forEach(o),Ko.forEach(o),ic=f(Se),Zt=r(Se,"DIV",{class:!0});var Al=a(Zt);$(Bn.$$.fragment,Al),lc=f(Al),ka=r(Al,"P",{});var Bu=a(ka);dc=l(Bu,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),Bu.forEach(o),Al.forEach(o),Se.forEach(o),nl=f(t),nt=r(t,"H2",{class:!0});var Vl=a(nt);Qt=r(Vl,"A",{id:!0,class:!0,href:!0});var Uu=a(Qt);wa=r(Uu,"SPAN",{});var Ru=a(wa);$(Un.$$.fragment,Ru),Ru.forEach(o),Uu.forEach(o),pc=f(Vl),Ma=r(Vl,"SPAN",{});var Hu=a(Ma);cc=l(Hu,"CLIPFeatureExtractor"),Hu.forEach(o),Vl.forEach(o),sl=f(t),Ee=r(t,"DIV",{class:!0});var Hr=a(Ee);$(Rn.$$.fragment,Hr),mc=f(Hr),Ea=r(Hr,"P",{});var Ku=a(Ea);fc=l(Ku,"Constructs a CLIP feature extractor."),Ku.forEach(o),hc=f(Hr),Hn=r(Hr,"P",{});var Nl=a(Hn);uc=l(Nl,"This feature extractor inherits from "),Tr=r(Nl,"A",{href:!0});var Gu=a(Tr);gc=l(Gu,"FeatureExtractionMixin"),Gu.forEach(o),_c=l(Nl,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Nl.forEach(o),Hr.forEach(o),rl=f(t),st=r(t,"H2",{class:!0});var Sl=a(st);Yt=r(Sl,"A",{id:!0,class:!0,href:!0});var Ju=a(Yt);ja=r(Ju,"SPAN",{});var Xu=a(ja);$(Kn.$$.fragment,Xu),Xu.forEach(o),Ju.forEach(o),vc=f(Sl),za=r(Sl,"SPAN",{});var Zu=a(za);bc=l(Zu,"CLIPProcessor"),Zu.forEach(o),Sl.forEach(o),al=f(t),U=r(t,"DIV",{class:!0});var We=a(U);$(Gn.$$.fragment,We),Pc=f(We),Fa=r(We,"P",{});var Qu=a(Fa);$c=l(Qu,"Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Qu.forEach(o),Tc=f(We),K=r(We,"P",{});var ze=a(K);Ir=r(ze,"A",{href:!0});var Yu=a(Ir);Ic=l(Yu,"CLIPProcessor"),Yu.forEach(o),Cc=l(ze," offers all the functionalities of "),Cr=r(ze,"A",{href:!0});var eg=a(Cr);yc=l(eg,"CLIPFeatureExtractor"),eg.forEach(o),xc=l(ze," and "),yr=r(ze,"A",{href:!0});var tg=a(yr);Lc=l(tg,"CLIPTokenizerFast"),tg.forEach(o),kc=l(ze,`. See the
...
refer to the docstring of this method for more information.`),Bl.forEach(o),Wl.forEach(o),Ac=f(We),to=r(We,"DIV",{class:!0});var Ul=a(to);$(Zn.$$.fragment,Ul),Vc=f(Ul),Qn=r(Ul,"P",{});var Rl=a(Qn);Nc=l(Rl,"This method forwards all its arguments to CLIPTokenizerFast\u2019s "),kr=r(Rl,"A",{href:!0});var rg=a(kr);Sc=l(rg,"decode()"),rg.forEach(o),Wc=l(Rl,`. Please refer to
