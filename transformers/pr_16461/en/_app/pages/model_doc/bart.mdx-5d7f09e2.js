...
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function Yw(j){let p,F,v,w,x,T,y,q,se,A,B,pe,be,tt,ye,ve,ot,Ze,V,N,Ue,re,P,S,nt,he,ue,at,J,st,rt,L,Ce,Te,Ye,Z,ie,it,dt,X,lt,we,Re;return{c(){p=n("p"),F=r("TF 2.0 models accepts two formats as inputs:"),v=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=n("li"),se=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),B=n("p"),pe=r("This second option is useful when using "),be=n("code"),tt=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ve=n("code"),ot=r("model(inputs)"),Ze=r("."),V=d(),N=n("p"),Ue=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=d(),P=n("ul"),S=n("li"),nt=r("a single Tensor with "),he=n("code"),ue=r("input_ids"),at=r(" only and nothing else: "),J=n("code"),st=r("model(input_ids)"),rt=d(),L=n("li"),Ce=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Te=n("code"),Ye=r("model([input_ids, attention_mask])"),Z=r(" or "),ie=n("code"),it=r("model([input_ids, attention_mask, token_type_ids])"),dt=d(),X=n("li"),lt=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),we=n("code"),Re=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=a(z,"P",{});var M=s(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),v=l(z),w=a(z,"UL",{});var H=s(w);x=a(H,"LI",{});var Dt=s(x);T=i(Dt,"having all inputs as keyword arguments (like PyTorch models), or"),Dt.forEach(t),y=l(H),q=a(H,"LI",{});var He=s(q);se=i(He,"having all inputs as a list, tuple or dict in the first positional arguments."),He.forEach(t),H.forEach(t),A=l(z),B=a(z,"P",{});var de=s(B);pe=i(de,"This second option is useful when using "),be=a(de,"CODE",{});var Gt=s(be);tt=i(Gt,"tf.keras.Model.fit"),Gt.forEach(t),ye=i(de,` method which currently requires having all the
...
[0, 31414, 232, 2]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[0, 20920, 232, 2]`}}),Lo=new je({props:{$$slots:{default:[Hw]},$$scope:{ctx:j}}}),Yn=new $({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/tokenization_bart_fast.py#L282",parametersDescription:[{anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new Q({}),da=new $({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_bart.py#L1265",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new $({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_bart.py#L1304",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
[<span class="hljs-string">&#x27;not&#x27;</span>, <span class="hljs-string">&#x27;good&#x27;</span>, <span class="hljs-string">&#x27;healthy&#x27;</span>, <span class="hljs-string">&#x27;great&#x27;</span>, <span class="hljs-string">&#x27;very&#x27;</span>]`}}),fa=new Q({}),_a=new $({props:{name:"class transformers.BartForSequenceClassification",anchor:"transformers.BartForSequenceClassification",parameters:[{name:"config",val:": BartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_bart.py#L1434",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ya=new $({props:{name:"forward",anchor:"transformers.BartForSequenceClassification.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_bart.py#L1447",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),Ta=new C({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),wa=new C({props:{code:`import torch
from transformers import BartTokenizer, BartForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),xa=new C({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
model = BartForSequenceClassification.from_pretrained("facebook/bart-base", num_labels=num_labels)
...
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">17</span>]`}}),Ma=new C({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">2.98</span>`}}),Ea=new Q({}),Pa=new $({props:{name:"class transformers.BartForCausalLM",anchor:"transformers.BartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_bart.py#L1690"}}),Aa=new $({props:{name:"forward",anchor:"transformers.BartForCausalLM.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_bart.py#L1721",parametersDescription:[{anchor:"transformers.BartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ts=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForConditionalGeneration.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),qs=new $({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_flax_bart.py#L1319",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Is=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForSequenceClassification.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForSequenceClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ys=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16461/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16461/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),nr=new $({props:{name:"decode",anchor:"transformers.FlaxBartForQuestionAnswering.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16461/src/transformers/models/bart/modeling_flax_bart.py#L1050",parametersDescription:[{anchor:"transformers.FlaxBartForQuestionAnswering.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16461/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16461/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),fm=l(gn),Pe=a(gn,"DIV",{class:!0});var Ct=s(Pe);f(sa.$$.fragment,Ct),_m=l(Ct),no=a(Ct,"P",{});var ai=s(no);gm=i(ai,"The "),Er=a(ai,"A",{href:!0});var Kv=s(Er);km=i(Kv,"BartModel"),Kv.forEach(t),bm=i(ai," forward method, overrides the "),id=a(ai,"CODE",{});var Zv=s(id);ym=i(Zv,"__call__"),Zv.forEach(t),vm=i(ai," special method."),ai.forEach(t),Tm=l(Ct),f(Wo.$$.fragment,Ct),wm=l(Ct),dd=a(Ct,"P",{});var Yv=s(dd);xm=i(Yv,"Example:"),Yv.forEach(t),Fm=l(Ct),f(ra.$$.fragment,Ct),Ct.forEach(t),gn.forEach(t),kc=l(o),ao=a(o,"H2",{class:!0});var dp=s(ao);Uo=a(dp,"A",{id:!0,class:!0,href:!0});var e1=s(Uo);ld=a(e1,"SPAN",{});var t1=s(ld);f(ia.$$.fragment,t1),t1.forEach(t),e1.forEach(t),zm=l(dp),cd=a(dp,"SPAN",{});var o1=s(cd);qm=i(o1,"BartForConditionalGeneration"),o1.forEach(t),dp.forEach(t),bc=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),$m=l(kn),la=a(kn,"P",{});var lp=s(la);Bm=i(lp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Pr=a(lp,"A",{href:!0});var n1=s(Pr);jm=i(n1,"PreTrainedModel"),n1.forEach(t),Cm=i(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Mm=l(kn),ca=a(kn,"P",{});var cp=s(ca);Em=i(cp,"This model is also a PyTorch "),pa=a(cp,"A",{href:!0,rel:!0});var a1=s(pa);Pm=i(a1,"torch.nn.Module"),a1.forEach(t),Am=i(cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),Sm=l(kn),Y=a(kn,"DIV",{class:!0});var Le=s(Y);f(ha.$$.fragment,Le),Om=l(Le),so=a(Le,"P",{});var si=s(so);Im=i(si,"The "),Ar=a(si,"A",{href:!0});var s1=s(Ar);Nm=i(s1,"BartForConditionalGeneration"),s1.forEach(t),Lm=i(si," forward method, overrides the "),pd=a(si,"CODE",{});var r1=s(pd);Dm=i(r1,"__call__"),r1.forEach(t),Gm=i(si," special method."),si.forEach(t),Wm=l(Le),f(Ro.$$.fragment,Le),Um=l(Le),hd=a(Le,"P",{});var i1=s(hd);Rm=i(i1,"Summarization example:"),i1.forEach(t),Hm=l(Le),f(ua.$$.fragment,Le),Qm=l(Le),ud=a(Le,"P",{});var d1=s(ud);Vm=i(d1,"Mask filling example:"),d1.forEach(t),Jm=l(Le),f(ma.$$.fragment,Le),Le.forEach(t),kn.forEach(t),yc=l(o),ro=a(o,"H2",{class:!0});var pp=s(ro);Ho=a(pp,"A",{id:!0,class:!0,href:!0});var l1=s(Ho);md=a(l1,"SPAN",{});var c1=s(md);f(fa.$$.fragment,c1),c1.forEach(t),l1.forEach(t),Xm=l(pp),fd=a(pp,"SPAN",{});var p1=s(fd);Km=i(p1,"BartForSequenceClassification"),p1.forEach(t),pp.forEach(t),vc=l(o),ze=a(o,"DIV",{class:!0});var Mt=s(ze);f(_a.$$.fragment,Mt),Zm=l(Mt),_d=a(Mt,"P",{});var h1=s(_d);Ym=i(h1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),h1.forEach(t),ef=l(Mt),ga=a(Mt,"P",{});var hp=s(ga);tf=i(hp,"This model inherits from "),Sr=a(hp,"A",{href:!0});var u1=s(Sr);of=i(u1,"PreTrainedModel"),u1.forEach(t),nf=i(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),af=l(Mt),ka=a(Mt,"P",{});var up=s(ka);sf=i(up,"This model is also a PyTorch "),ba=a(up,"A",{href:!0,rel:!0});var m1=s(ba);rf=i(m1,"torch.nn.Module"),m1.forEach(t),df=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),lf=l(Mt),D=a(Mt,"DIV",{class:!0});var oe=s(D);f(ya.$$.fragment,oe),cf=l(oe),io=a(oe,"P",{});var ri=s(io);pf=i(ri,"The "),Or=a(ri,"A",{href:!0});var f1=s(Or);hf=i(f1,"BartForSequenceClassification"),f1.forEach(t),uf=i(ri," forward method, overrides the "),gd=a(ri,"CODE",{});var _1=s(gd);mf=i(_1,"__call__"),_1.forEach(t),ff=i(ri," special method."),ri.forEach(t),_f=l(oe),f(Qo.$$.fragment,oe),gf=l(oe),kd=a(oe,"P",{});var g1=s(kd);kf=i(g1,"Example of single-label classification:"),g1.forEach(t),bf=l(oe),f(va.$$.fragment,oe),yf=l(oe),f(Ta.$$.fragment,oe),vf=l(oe),bd=a(oe,"P",{});var k1=s(bd);Tf=i(k1,"Example of multi-label classification:"),k1.forEach(t),wf=l(oe),f(wa.$$.fragment,oe),xf=l(oe),f(xa.$$.fragment,oe),oe.forEach(t),Mt.forEach(t),Tc=l(o),lo=a(o,"H2",{class:!0});var mp=s(lo);Vo=a(mp,"A",{id:!0,class:!0,href:!0});var b1=s(Vo);yd=a(b1,"SPAN",{});var y1=s(yd);f(Fa.$$.fragment,y1),y1.forEach(t),b1.forEach(t),Ff=l(mp),vd=a(mp,"SPAN",{});var v1=s(vd);zf=i(v1,"BartForQuestionAnswering"),v1.forEach(t),mp.forEach(t),wc=l(o),qe=a(o,"DIV",{class:!0});var Et=s(qe);f(za.$$.fragment,Et),qf=l(Et),co=a(Et,"P",{});var ii=s(co);$f=i(ii,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Td=a(ii,"CODE",{});var T1=s(Td);Bf=i(T1,"span start logits"),T1.forEach(t),jf=i(ii," and "),wd=a(ii,"CODE",{});var w1=s(wd);Cf=i(w1,"span end logits"),w1.forEach(t),Mf=i(ii,")."),ii.forEach(t),Ef=l(Et),qa=a(Et,"P",{});var fp=s(qa);Pf=i(fp,"This model inherits from "),Ir=a(fp,"A",{href:!0});var x1=s(Ir);Af=i(x1,"PreTrainedModel"),x1.forEach(t),Sf=i(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),Of=l(Et),$a=a(Et,"P",{});var _p=s($a);If=i(_p,"This model is also a PyTorch "),Ba=a(_p,"A",{href:!0,rel:!0});var F1=s(Ba);Nf=i(F1,"torch.nn.Module"),F1.forEach(t),Lf=i(_p,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),Df=l(Et),fe=a(Et,"DIV",{class:!0});var et=s(fe);f(ja.$$.fragment,et),Gf=l(et),po=a(et,"P",{});var di=s(po);Wf=i(di,"The "),Nr=a(di,"A",{href:!0});var z1=s(Nr);Uf=i(z1,"BartForQuestionAnswering"),z1.forEach(t),Rf=i(di," forward method, overrides the "),xd=a(di,"CODE",{});var q1=s(xd);Hf=i(q1,"__call__"),q1.forEach(t),Qf=i(di," special method."),di.forEach(t),Vf=l(et),f(Jo.$$.fragment,et),Jf=l(et),Fd=a(et,"P",{});var $1=s(Fd);Xf=i($1,"Example:"),$1.forEach(t),Kf=l(et),f(Ca.$$.fragment,et),Zf=l(et),f(Ma.$$.fragment,et),et.forEach(t),Et.forEach(t),xc=l(o),ho=a(o,"H2",{class:!0});var gp=s(ho);Xo=a(gp,"A",{id:!0,class:!0,href:!0});var B1=s(Xo);zd=a(B1,"SPAN",{});var j1=s(zd);f(Ea.$$.fragment,j1),j1.forEach(t),B1.forEach(t),Yf=l(gp),qd=a(gp,"SPAN",{});var C1=s(qd);e_=i(C1,"BartForCausalLM"),C1.forEach(t),gp.forEach(t),Fc=l(o),uo=a(o,"DIV",{class:!0});var kp=s(uo);f(Pa.$$.fragment,kp),t_=l(kp),yt=a(kp,"DIV",{class:!0});var li=s(yt);f(Aa.$$.fragment,li),o_=l(li),$d=a(li,"P",{});var M1=s($d);n_=i(M1,"Example:"),M1.forEach(t),a_=l(li),f(Sa.$$.fragment,li),li.forEach(t),kp.forEach(t),zc=l(o),mo=a(o,"H2",{class:!0});var bp=s(mo);Ko=a(bp,"A",{id:!0,class:!0,href:!0});var E1=s(Ko);Bd=a(E1,"SPAN",{});var P1=s(Bd);f(Oa.$$.fragment,P1),P1.forEach(t),E1.forEach(t),s_=l(bp),jd=a(bp,"SPAN",{});var A1=s(jd);r_=i(A1,"TFBartModel"),A1.forEach(t),bp.forEach(t),qc=l(o),$e=a(o,"DIV",{class:!0});var Pt=s($e);f(Ia.$$.fragment,Pt),i_=l(Pt),Na=a(Pt,"P",{});var yp=s(Na);d_=i(yp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Lr=a(yp,"A",{href:!0});var S1=s(Lr);l_=i(S1,"TFPreTrainedModel"),S1.forEach(t),c_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),p_=l(Pt),La=a(Pt,"P",{});var vp=s(La);h_=i(vp,"This model is also a "),Da=a(vp,"A",{href:!0,rel:!0});var O1=s(Da);u_=i(O1,"tf.keras.Model"),O1.forEach(t),m_=i(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),f_=l(Pt),f(Zo.$$.fragment,Pt),__=l(Pt),Ae=a(Pt,"DIV",{class:!0});var At=s(Ae);f(Ga.$$.fragment,At),g_=l(At),fo=a(At,"P",{});var ci=s(fo);k_=i(ci,"The "),Dr=a(ci,"A",{href:!0});var I1=s(Dr);b_=i(I1,"TFBartModel"),I1.forEach(t),y_=i(ci," forward method, overrides the "),Cd=a(ci,"CODE",{});var N1=s(Cd);v_=i(N1,"__call__"),N1.forEach(t),T_=i(ci," special method."),ci.forEach(t),w_=l(At),f(Yo.$$.fragment,At),x_=l(At),Md=a(At,"P",{});var L1=s(Md);F_=i(L1,"Example:"),L1.forEach(t),z_=l(At),f(Wa.$$.fragment,At),At.forEach(t),Pt.forEach(t),$c=l(o),_o=a(o,"H2",{class:!0});var Tp=s(_o);en=a(Tp,"A",{id:!0,class:!0,href:!0});var D1=s(en);Ed=a(D1,"SPAN",{});var G1=s(Ed);f(Ua.$$.fragment,G1),G1.forEach(t),D1.forEach(t),q_=l(Tp),Pd=a(Tp,"SPAN",{});var W1=s(Pd);$_=i(W1,"TFBartForConditionalGeneration"),W1.forEach(t),Tp.forEach(t),Bc=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(Ra.$$.fragment,St),B_=l(St),Ha=a(St,"P",{});var wp=s(Ha);j_=i(wp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(wp,"A",{href:!0});var U1=s(Gr);C_=i(U1,"TFPreTrainedModel"),U1.forEach(t),M_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),E_=l(St),Qa=a(St,"P",{});var xp=s(Qa);P_=i(xp,"This model is also a "),Va=a(xp,"A",{href:!0,rel:!0});var R1=s(Va);A_=i(R1,"tf.keras.Model"),R1.forEach(t),S_=i(xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xp.forEach(t),O_=l(St),f(tn.$$.fragment,St),I_=l(St),ee=a(St,"DIV",{class:!0});var De=s(ee);f(Ja.$$.fragment,De),N_=l(De),go=a(De,"P",{});var pi=s(go);L_=i(pi,"The "),Wr=a(pi,"A",{href:!0});var H1=s(Wr);D_=i(H1,"TFBartForConditionalGeneration"),H1.forEach(t),G_=i(pi," forward method, overrides the "),Ad=a(pi,"CODE",{});var Q1=s(Ad);W_=i(Q1,"__call__"),Q1.forEach(t),U_=i(pi," special method."),pi.forEach(t),R_=l(De),f(on.$$.fragment,De),H_=l(De),Sd=a(De,"P",{});var V1=s(Sd);Q_=i(V1,"Summarization example:"),V1.forEach(t),V_=l(De),f(Xa.$$.fragment,De),J_=l(De),Od=a(De,"P",{});var J1=s(Od);X_=i(J1,"Mask filling example:"),J1.forEach(t),K_=l(De),f(Ka.$$.fragment,De),De.forEach(t),St.forEach(t),jc=l(o),ko=a(o,"H2",{class:!0});var Fp=s(ko);nn=a(Fp,"A",{id:!0,class:!0,href:!0});var X1=s(nn);Id=a(X1,"SPAN",{});var K1=s(Id);f(Za.$$.fragment,K1),K1.forEach(t),X1.forEach(t),Z_=l(Fp),Nd=a(Fp,"SPAN",{});var Z1=s(Nd);Y_=i(Z1,"FlaxBartModel"),Z1.forEach(t),Fp.forEach(t),Cc=l(o),U=a(o,"DIV",{class:!0});var ge=s(U);f(Ya.$$.fragment,ge),eg=l(ge),es=a(ge,"P",{});var zp=s(es);tg=i(zp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Ur=a(zp,"A",{href:!0});var Y1=s(Ur);og=i(Y1,"FlaxPreTrainedModel"),Y1.forEach(t),ng=i(zp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),qp.forEach(t),dg=l(ge),Ld=a(ge,"P",{});var tT=s(Ld);lg=i(tT,"Finally, this model supports inherent JAX features such as:"),tT.forEach(t),cg=l(ge),ht=a(ge,"UL",{});var bn=s(ht);Dd=a(bn,"LI",{});var oT=s(Dd);ns=a(oT,"A",{href:!0,rel:!0});var nT=s(ns);pg=i(nT,"Just-In-Time (JIT) compilation"),nT.forEach(t),oT.forEach(t),hg=l(bn),Gd=a(bn,"LI",{});var aT=s(Gd);as=a(aT,"A",{href:!0,rel:!0});var sT=s(as);ug=i(sT,"Automatic Differentiation"),sT.forEach(t),aT.forEach(t),mg=l(bn),Wd=a(bn,"LI",{});var rT=s(Wd);ss=a(rT,"A",{href:!0,rel:!0});var iT=s(ss);fg=i(iT,"Vectorization"),iT.forEach(t),rT.forEach(t),_g=l(bn),Ud=a(bn,"LI",{});var dT=s(Ud);rs=a(dT,"A",{href:!0,rel:!0});var lT=s(rs);gg=i(lT,"Parallelization"),lT.forEach(t),dT.forEach(t),bn.forEach(t),kg=l(ge),Se=a(ge,"DIV",{class:!0});var Ot=s(Se);f(is.$$.fragment,Ot),bg=l(Ot),bo=a(Ot,"P",{});var hi=s(bo);yg=i(hi,"The "),Rd=a(hi,"CODE",{});var cT=s(Rd);vg=i(cT,"FlaxBartPreTrainedModel"),cT.forEach(t),Tg=i(hi,"forward method, overrides the "),Hd=a(hi,"CODE",{});var pT=s(Hd);wg=i(pT,"__call__"),pT.forEach(t),xg=i(hi," special method."),hi.forEach(t),Fg=l(Ot),f(an.$$.fragment,Ot),zg=l(Ot),Qd=a(Ot,"P",{});var hT=s(Qd);qg=i(hT,"Example:"),hT.forEach(t),$g=l(Ot),f(ds.$$.fragment,Ot),Ot.forEach(t),Bg=l(ge),vt=a(ge,"DIV",{class:!0});var ui=s(vt);f(ls.$$.fragment,ui),jg=l(ui),Vd=a(ui,"P",{});var uT=s(Vd);Cg=i(uT,"Example:"),uT.forEach(t),Mg=l(ui),f(cs.$$.fragment,ui),ui.forEach(t),Eg=l(ge),Tt=a(ge,"DIV",{class:!0});var mi=s(Tt);f(ps.$$.fragment,mi),Pg=l(mi),Jd=a(mi,"P",{});var mT=s(Jd);Ag=i(mT,"Example:"),mT.forEach(t),Sg=l(mi),f(hs.$$.fragment,mi),mi.forEach(t),ge.forEach(t),Mc=l(o),yo=a(o,"H2",{class:!0});var $p=s(yo);sn=a($p,"A",{id:!0,class:!0,href:!0});var fT=s(sn);Xd=a(fT,"SPAN",{});var _T=s(Xd);f(us.$$.fragment,_T),_T.forEach(t),fT.forEach(t),Og=l($p),Kd=a($p,"SPAN",{});var gT=s(Kd);Ig=i(gT,"FlaxBartForConditionalGeneration"),gT.forEach(t),$p.forEach(t),Ec=l(o),R=a(o,"DIV",{class:!0});var ke=s(R);f(ms.$$.fragment,ke),Ng=l(ke),fs=a(ke,"P",{});var Bp=s(fs);Lg=i(Bp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rr=a(Bp,"A",{href:!0});var kT=s(Rr);Dg=i(kT,"FlaxPreTrainedModel"),kT.forEach(t),Gg=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bp.forEach(t),Wg=l(ke),_s=a(ke,"P",{});var jp=s(_s);Ug=i(jp,`This model is also a Flax Linen
`),gs=a(jp,"A",{href:!0,rel:!0});var bT=s(gs);Rg=i(bT,"flax.nn.Module"),bT.forEach(t),Hg=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(ke),Zd=a(ke,"P",{});var yT=s(Zd);Vg=i(yT,"Finally, this model supports inherent JAX features such as:"),yT.forEach(t),Jg=l(ke),ut=a(ke,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var vT=s(Yd);ks=a(vT,"A",{href:!0,rel:!0});var TT=s(ks);Xg=i(TT,"Just-In-Time (JIT) compilation"),TT.forEach(t),vT.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var wT=s(el);bs=a(wT,"A",{href:!0,rel:!0});var xT=s(bs);Zg=i(xT,"Automatic Differentiation"),xT.forEach(t),wT.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var FT=s(tl);ys=a(FT,"A",{href:!0,rel:!0});var zT=s(ys);ek=i(zT,"Vectorization"),zT.forEach(t),FT.forEach(t),tk=l(yn),ol=a(yn,"LI",{});var qT=s(ol);vs=a(qT,"A",{href:!0,rel:!0});var $T=s(vs);ok=i($T,"Parallelization"),$T.forEach(t),qT.forEach(t),yn.forEach(t),nk=l(ke),te=a(ke,"DIV",{class:!0});var Ge=s(te);f(Ts.$$.fragment,Ge),ak=l(Ge),vo=a(Ge,"P",{});var fi=s(vo);sk=i(fi,"The "),nl=a(fi,"CODE",{});var BT=s(nl);rk=i(BT,"FlaxBartPreTrainedModel"),BT.forEach(t),ik=i(fi,"forward method, overrides the "),al=a(fi,"CODE",{});var jT=s(al);dk=i(jT,"__call__"),jT.forEach(t),lk=i(fi," special method."),fi.forEach(t),ck=l(Ge),f(rn.$$.fragment,Ge),pk=l(Ge),sl=a(Ge,"P",{});var CT=s(sl);hk=i(CT,"Summarization example:"),CT.forEach(t),uk=l(Ge),f(ws.$$.fragment,Ge),mk=l(Ge),rl=a(Ge,"P",{});var MT=s(rl);fk=i(MT,"Mask filling example:"),MT.forEach(t),_k=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gk=l(ke),wt=a(ke,"DIV",{class:!0});var _i=s(wt);f(Fs.$$.fragment,_i),kk=l(_i),il=a(_i,"P",{});var ET=s(il);bk=i(ET,"Example:"),ET.forEach(t),yk=l(_i),f(zs.$$.fragment,_i),_i.forEach(t),vk=l(ke),xt=a(ke,"DIV",{class:!0});var gi=s(xt);f(qs.$$.fragment,gi),Tk=l(gi),dl=a(gi,"P",{});var PT=s(dl);wk=i(PT,"Example:"),PT.forEach(t),xk=l(gi),f($s.$$.fragment,gi),gi.forEach(t),ke.forEach(t),Pc=l(o),To=a(o,"H2",{class:!0});var Cp=s(To);dn=a(Cp,"A",{id:!0,class:!0,href:!0});var AT=s(dn);ll=a(AT,"SPAN",{});var ST=s(ll);f(Bs.$$.fragment,ST),ST.forEach(t),AT.forEach(t),Fk=l(Cp),cl=a(Cp,"SPAN",{});var OT=s(cl);zk=i(OT,"FlaxBartForSequenceClassification"),OT.forEach(t),Cp.forEach(t),Ac=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);f(js.$$.fragment,ne),qk=l(ne),pl=a(ne,"P",{});var IT=s(pl);$k=i(IT,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),IT.forEach(t),Bk=l(ne),Cs=a(ne,"P",{});var Mp=s(Cs);jk=i(Mp,"This model inherits from "),Hr=a(Mp,"A",{href:!0});var NT=s(Hr);Ck=i(NT,"FlaxPreTrainedModel"),NT.forEach(t),Mk=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),Ek=l(ne),Ms=a(ne,"P",{});var Ep=s(Ms);Pk=i(Ep,`This model is also a Flax Linen
`),Es=a(Ep,"A",{href:!0,rel:!0});var LT=s(Es);Ak=i(LT,"flax.nn.Module"),LT.forEach(t),Sk=i(Ep,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ep.forEach(t),Ok=l(ne),hl=a(ne,"P",{});var DT=s(hl);Ik=i(DT,"Finally, this model supports inherent JAX features such as:"),DT.forEach(t),Nk=l(ne),mt=a(ne,"UL",{});var vn=s(mt);ul=a(vn,"LI",{});var GT=s(ul);Ps=a(GT,"A",{href:!0,rel:!0});var WT=s(Ps);Lk=i(WT,"Just-In-Time (JIT) compilation"),WT.forEach(t),GT.forEach(t),Dk=l(vn),ml=a(vn,"LI",{});var UT=s(ml);As=a(UT,"A",{href:!0,rel:!0});var RT=s(As);Gk=i(RT,"Automatic Differentiation"),RT.forEach(t),UT.forEach(t),Wk=l(vn),fl=a(vn,"LI",{});var HT=s(fl);Ss=a(HT,"A",{href:!0,rel:!0});var QT=s(Ss);Uk=i(QT,"Vectorization"),QT.forEach(t),HT.forEach(t),Rk=l(vn),_l=a(vn,"LI",{});var VT=s(_l);Os=a(VT,"A",{href:!0,rel:!0});var JT=s(Os);Hk=i(JT,"Parallelization"),JT.forEach(t),VT.forEach(t),vn.forEach(t),Qk=l(ne),Oe=a(ne,"DIV",{class:!0});var It=s(Oe);f(Is.$$.fragment,It),Vk=l(It),wo=a(It,"P",{});var ki=s(wo);Jk=i(ki,"The "),gl=a(ki,"CODE",{});var XT=s(gl);Xk=i(XT,"FlaxBartPreTrainedModel"),XT.forEach(t),Kk=i(ki,"forward method, overrides the "),kl=a(ki,"CODE",{});var KT=s(kl);Zk=i(KT,"__call__"),KT.forEach(t),Yk=i(ki," special method."),ki.forEach(t),eb=l(It),f(ln.$$.fragment,It),tb=l(It),bl=a(It,"P",{});var ZT=s(bl);ob=i(ZT,"Example:"),ZT.forEach(t),nb=l(It),f(Ns.$$.fragment,It),It.forEach(t),ab=l(ne),Ft=a(ne,"DIV",{class:!0});var bi=s(Ft);f(Ls.$$.fragment,bi),sb=l(bi),yl=a(bi,"P",{});var YT=s(yl);rb=i(YT,"Example:"),YT.forEach(t),ib=l(bi),f(Ds.$$.fragment,bi),bi.forEach(t),db=l(ne),zt=a(ne,"DIV",{class:!0});var yi=s(zt);f(Gs.$$.fragment,yi),lb=l(yi),vl=a(yi,"P",{});var ew=s(vl);cb=i(ew,"Example:"),ew.forEach(t),pb=l(yi),f(Ws.$$.fragment,yi),yi.forEach(t),ne.forEach(t),Sc=l(o),xo=a(o,"H2",{class:!0});var Pp=s(xo);cn=a(Pp,"A",{id:!0,class:!0,href:!0});var tw=s(cn);Tl=a(tw,"SPAN",{});var ow=s(Tl);f(Us.$$.fragment,ow),ow.forEach(t),tw.forEach(t),hb=l(Pp),wl=a(Pp,"SPAN",{});var nw=s(wl);ub=i(nw,"FlaxBartForQuestionAnswering"),nw.forEach(t),Pp.forEach(t),Oc=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);f(Rs.$$.fragment,ae),mb=l(ae),Fo=a(ae,"P",{});var vi=s(Fo);fb=i(vi,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),xl=a(vi,"CODE",{});var aw=s(xl);_b=i(aw,"span start logits"),aw.forEach(t),gb=i(vi," and "),Fl=a(vi,"CODE",{});var sw=s(Fl);kb=i(sw,"span end logits"),sw.forEach(t),bb=i(vi,")."),vi.forEach(t),yb=l(ae),Hs=a(ae,"P",{});var Ap=s(Hs);vb=i(Ap,"This model inherits from "),Qr=a(Ap,"A",{href:!0});var rw=s(Qr);Tb=i(rw,"FlaxPreTrainedModel"),rw.forEach(t),wb=i(Ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ap.forEach(t),xb=l(ae),Qs=a(ae,"P",{});var Sp=s(Qs);Fb=i(Sp,`This model is also a Flax Linen
`),Vs=a(Sp,"A",{href:!0,rel:!0});var iw=s(Vs);zb=i(iw,"flax.nn.Module"),iw.forEach(t),qb=i(Sp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sp.forEach(t),$b=l(ae),zl=a(ae,"P",{});var dw=s(zl);Bb=i(dw,"Finally, this model supports inherent JAX features such as:"),dw.forEach(t),jb=l(ae),ft=a(ae,"UL",{});var Tn=s(ft);ql=a(Tn,"LI",{});var lw=s(ql);Js=a(lw,"A",{href:!0,rel:!0});var cw=s(Js);Cb=i(cw,"Just-In-Time (JIT) compilation"),cw.forEach(t),lw.forEach(t),Mb=l(Tn),$l=a(Tn,"LI",{});var pw=s($l);Xs=a(pw,"A",{href:!0,rel:!0});var hw=s(Xs);Eb=i(hw,"Automatic Differentiation"),hw.forEach(t),pw.forEach(t),Pb=l(Tn),Bl=a(Tn,"LI",{});var uw=s(Bl);Ks=a(uw,"A",{href:!0,rel:!0});var mw=s(Ks);Ab=i(mw,"Vectorization"),mw.forEach(t),uw.forEach(t),Sb=l(Tn),jl=a(Tn,"LI",{});var fw=s(jl);Zs=a(fw,"A",{href:!0,rel:!0});var _w=s(Zs);Ob=i(_w,"Parallelization"),_w.forEach(t),fw.forEach(t),Tn.forEach(t),Ib=l(ae),Ie=a(ae,"DIV",{class:!0});var Nt=s(Ie);f(Ys.$$.fragment,Nt),Nb=l(Nt),zo=a(Nt,"P",{});var Ti=s(zo);Lb=i(Ti,"The "),Cl=a(Ti,"CODE",{});var gw=s(Cl);Db=i(gw,"FlaxBartPreTrainedModel"),gw.forEach(t),Gb=i(Ti,"forward method, overrides the "),Ml=a(Ti,"CODE",{});var kw=s(Ml);Wb=i(kw,"__call__"),kw.forEach(t),Ub=i(Ti," special method."),Ti.forEach(t),Rb=l(Nt),f(pn.$$.fragment,Nt),Hb=l(Nt),El=a(Nt,"P",{});var bw=s(El);Qb=i(bw,"Example:"),bw.forEach(t),Vb=l(Nt),f(er.$$.fragment,Nt),Nt.forEach(t),Jb=l(ae),qt=a(ae,"DIV",{class:!0});var wi=s(qt);f(tr.$$.fragment,wi),Xb=l(wi),Pl=a(wi,"P",{});var yw=s(Pl);Kb=i(yw,"Example:"),yw.forEach(t),Zb=l(wi),f(or.$$.fragment,wi),wi.forEach(t),Yb=l(ae),$t=a(ae,"DIV",{class:!0});var xi=s($t);f(nr.$$.fragment,xi),ey=l(xi),Al=a(xi,"P",{});var vw=s(Al);ty=i(vw,"Example:"),vw.forEach(t),oy=l(xi),f(ar.$$.fragment,xi),xi.forEach(t),ae.forEach(t),Ic=l(o),qo=a(o,"H2",{class:!0});var Op=s(qo);hn=a(Op,"A",{id:!0,class:!0,href:!0});var Tw=s(hn);Sl=a(Tw,"SPAN",{});var ww=s(Sl);f(sr.$$.fragment,ww),ww.forEach(t),Tw.forEach(t),ny=l(Op),Ol=a(Op,"SPAN",{});var xw=s(Ol);ay=i(xw,"FlaxBartForCausalLM"),xw.forEach(t),Op.forEach(t),Nc=l(o),K=a(o,"DIV",{class:!0});var We=s(K);f(rr.$$.fragment,We),sy=l(We),Il=a(We,"P",{});var Fw=s(Il);ry=i(Fw,`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
