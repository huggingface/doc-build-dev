...
configuration. Check out the <a href="/docs/transformers/pr_16261/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$s=new M({props:{name:"forward",anchor:"transformers.T5Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_t5.py#L1342",parametersDescription:[{anchor:"transformers.T5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16261/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16261/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16261/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_t5.py#L1310"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16261/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Os=new M({props:{name:"forward",anchor:"transformers.T5ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_t5.py#L1536",parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16261/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_t5.py#L1505"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16261/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_t5.py#L1807",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16261/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16261/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_t5.py#L1781"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_16261/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16261/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_tf_t5.py#L1357",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16261/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16261/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[xw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16261/src/transformers/models/t5/modeling_tf_t5.py#L1688",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16261/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16261/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16261/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16261/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16261/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16261/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
for summarization: `),U=s(Dr,"EM",{});var o1=a(U);Ae=i(o1,"summarize: \u2026"),o1.forEach(t),m=i(Dr,"."),Dr.forEach(t),t1.forEach(t),j=l(Nr),te=s(Nr,"LI",{});var s1=a(te);Oe=s(s1,"P",{});var a1=a(Oe);pt=i(a1,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),a1.forEach(t),s1.forEach(t),S=l(Nr),Ge=s(Nr,"LI",{});var r1=a(Ge);ne=s(r1,"P",{});var io=a(ne);ht=i(io,"See the "),I=s(io,"A",{href:!0});var i1=a(I);Y=i(i1,"training"),i1.forEach(t),ut=i(io,", "),Ie=s(io,"A",{href:!0});var d1=a(Ie);Z=i(d1,"inference"),d1.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var l1=a(Le);Ne=i(l1,"scripts"),l1.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),r1.forEach(t),Nr.forEach(t),Vl=l(n),Xa=s(n,"P",{});var c1=a(Xa);Sp=i(c1,"T5 comes in different sizes:"),c1.forEach(t),Kl=l(n),Be=s(n,"UL",{});var It=a(Be);di=s(It,"LI",{});var p1=a(di);li=s(p1,"P",{});var h1=a(li);To=s(h1,"A",{href:!0,rel:!0});var u1=a(To);Op=i(u1,"t5-small"),u1.forEach(t),h1.forEach(t),p1.forEach(t),Gp=l(It),ci=s(It,"LI",{});var m1=a(ci);pi=s(m1,"P",{});var f1=a(pi);vo=s(f1,"A",{href:!0,rel:!0});var _1=a(vo);Bp=i(_1,"t5-base"),_1.forEach(t),f1.forEach(t),m1.forEach(t),Wp=l(It),hi=s(It,"LI",{});var g1=a(hi);ui=s(g1,"P",{});var T1=a(ui);ko=s(T1,"A",{href:!0,rel:!0});var v1=a(ko);Up=i(v1,"t5-large"),v1.forEach(t),T1.forEach(t),g1.forEach(t),Rp=l(It),mi=s(It,"LI",{});var k1=a(mi);fi=s(k1,"P",{});var b1=a(fi);bo=s(b1,"A",{href:!0,rel:!0});var y1=a(bo);Hp=i(y1,"t5-3b"),y1.forEach(t),b1.forEach(t),k1.forEach(t),Vp=l(It),_i=s(It,"LI",{});var w1=a(_i);Qa=s(w1,"P",{});var Vk=a(Qa);yo=s(Vk,"A",{href:!0,rel:!0});var x1=a(yo);Kp=i(x1,"t5-11b"),x1.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),w1.forEach(t),It.forEach(t),Yl=l(n),er=s(n,"P",{});var z1=a(er);Zp=i(z1,"Based on the original T5 model, Google has released some follow-up works:"),z1.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Sr=a($t);gi=s(Sr,"LI",{});var $1=a(gi);zn=s($1,"P",{});var Ul=a(zn);Ti=s(Ul,"STRONG",{});var q1=a(Ti);Jp=i(q1,"T5v1.1"),q1.forEach(t),Xp=i(Ul,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Ul,"A",{href:!0});var E1=a(tr);Qp=i(E1,"here"),E1.forEach(t),eh=i(Ul,"."),Ul.forEach(t),$1.forEach(t),th=l(Sr),vi=s(Sr,"LI",{});var j1=a(vi);$n=s(j1,"P",{});var Rl=a($n);ki=s(Rl,"STRONG",{});var F1=a(ki);nh=i(F1,"mT5"),F1.forEach(t),oh=i(Rl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var M1=a(nr);sh=i(M1,"here"),M1.forEach(t),ah=i(Rl,"."),Rl.forEach(t),j1.forEach(t),rh=l(Sr),bi=s(Sr,"LI",{});var P1=a(bi);qn=s(P1,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var C1=a(yi);ih=i(C1,"byT5"),C1.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var A1=a(or);lh=i(A1,"here"),A1.forEach(t),ch=i(Hl,"."),Hl.forEach(t),P1.forEach(t),Sr.forEach(t),Jl=l(n),En=s(n,"P",{});var Bc=a(En);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var I1=a(wo);hh=i(I1,"hub"),I1.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Or=a(qt);mh=i(Or,"This model was contributed by "),xo=s(Or,"A",{href:!0,rel:!0});var L1=a(xo);fh=i(L1,"thomwolf"),L1.forEach(t),_h=i(Or,". The original code can be found "),zo=s(Or,"A",{href:!0,rel:!0});var N1=a(zo);gh=i(N1,"here"),N1.forEach(t),Th=i(Or,"."),Or.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var D1=a(jn);wi=s(D1,"SPAN",{});var S1=a(wi);_($o.$$.fragment,S1),S1.forEach(t),D1.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var O1=a(xi);kh=i(O1,"Training"),O1.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),Uc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Lt=a(dt);Ei=s(Lt,"P",{});var R1=a(Ei);Mh=i(R1,"Unsupervised denoising training"),R1.forEach(t),Ph=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var H1=a(ji);Ah=i(H1,"a.k.a"),H1.forEach(t),Ih=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var V1=a(Fi);Lh=i(V1,"real"),V1.forEach(t),Nh=i(tt,` masked tokens. Each
...
`),Pi=s(tt,"CODE",{});var Y1=a(Pi);Oh=i(Y1,"<extra_id_1>"),Y1.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Z1=a(Ci);Bh=i(Z1,"<extra_id_99>"),Z1.forEach(t),Wh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var J1=a(rr);Uh=i(J1,"T5Tokenizer"),J1.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Lt),Ai=s(Lt,"P",{});var X1=a(Ai);Vh=i(X1,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
directory.`),Hc.forEach(t),Lt.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Ii=s(nt,"P",{});var eb=a(Ii);eu=i(eb,"Supervised training"),eb.forEach(t),tu=l(nt),Li=s(nt,"P",{});var tb=a(Li);nu=i(tb,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),tb.forEach(t),ou=l(nt),_(Fo.$$.fragment,nt),su=l(nt),re=s(nt,"P",{});var we=a(re);au=i(we,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ni=s(we,"CODE",{});var nb=a(Ni);ru=i(nb,"input_ids"),nb.forEach(t),iu=i(we,` (which are the
...
of the `),Ki=s(ot,"CODE",{});var ub=a(Ki);Pu=i(ub,"CrossEntropyLoss"),ub.forEach(t),Cu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var mb=a(Yi);Au=i(mb,"decoder_attention_mask"),mb.forEach(t),Iu=i(ot,` to ignore padded tokens from
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var fb=a(Mo);Lu=i(fb,"Flax summarization script"),fb.forEach(t),Nu=i(ot,` for details). We also pass
...
ignored. The code example below illustrates all of this.`),ot.forEach(t),Ou=l(nt),_(Po.$$.fragment,nt),nt.forEach(t),Rc.forEach(t),sc=l(n),ir=s(n,"P",{});var gb=a(ir);Gu=i(gb,"Additional training tips:"),gb.forEach(t),ac=l(n),Et=s(n,"UL",{});var Br=a(Et);Ji=s(Br,"LI",{});var Tb=a(Ji);Co=s(Tb,"P",{});var Vc=a(Co);Bu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var vb=a(Xi);Wu=i(vb,"Trainer"),vb.forEach(t),Uu=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Vc.forEach(t),Tb.forEach(t),Ru=l(Br),Qi=s(Br,"LI",{});var kb=a(Qi);Xt=s(kb,"P",{});var Wr=a(Xt);Hu=i(Wr,"According to "),Ao=s(Wr,"A",{href:!0,rel:!0});var bb=a(Ao);Vu=i(bb,"this forum post"),bb.forEach(t),Ku=i(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Io=s(Wr,"A",{href:!0,rel:!0});var yb=a(Io);Yu=i(yb,"paper"),yb.forEach(t),Zu=i(Wr,` for the task prefixes
used).`),Wr.forEach(t),kb.forEach(t),Ju=l(Br),ed=s(Br,"LI",{});var wb=a(ed);Lo=s(wb,"P",{});var Kc=a(Lo);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
generation works in general in encoder-decoder models.`),co.forEach(t),lc=l(n),_(Oo.$$.fragment,n),cc=l(n),We=s(n,"P",{});var Nt=a(We);cm=i(Nt,"Note that T5 uses the "),sd=s(Nt,"CODE",{});var Mb=a(sd);pm=i(Mb,"pad_token_id"),Mb.forEach(t),hm=i(Nt," as the "),ad=s(Nt,"CODE",{});var Pb=a(ad);um=i(Pb,"decoder_start_token_id"),Pb.forEach(t),mm=i(Nt,`, so when doing generation without using
`),cr=s(Nt,"A",{href:!0});var Cb=a(cr);fm=i(Cb,"generate()"),Cb.forEach(t),_m=i(Nt,", make sure you start it with the "),rd=s(Nt,"CODE",{});var Ab=a(rd);gm=i(Ab,"pad_token_id"),Ab.forEach(t),Tm=i(Nt,"."),Nt.forEach(t),pc=l(n),pr=s(n,"P",{});var Ib=a(pr);vm=i(Ib,"The example above only shows a single example. You can also do batched inference, like so:"),Ib.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Cn=s(Zc,"A",{id:!0,class:!0,href:!0});var Lb=a(Cn);id=s(Lb,"SPAN",{});var Nb=a(id);_(Bo.$$.fragment,Nb),Nb.forEach(t),Lb.forEach(t),km=l(Zc),dd=s(Zc,"SPAN",{});var Db=a(dd);bm=i(Db,"Performance"),Db.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Wo=s(po,"A",{href:!0,rel:!0});var Sb=a(Wo);wm=i(Sb,"apex"),Sb.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var Ob=a(ld);zm=i(Ob,"apex.normalization.FusedRMSNorm"),Ob.forEach(t),$m=i(po," instead of "),cd=s(po,"CODE",{});var Gb=a(cd);qm=i(Gb,"T5LayerNorm"),Gb.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);An=s(Jc,"A",{id:!0,class:!0,href:!0});var Bb=a(An);pd=s(Bb,"SPAN",{});var Wb=a(pd);_(Uo.$$.fragment,Wb),Wb.forEach(t),Bb.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var Ub=a(hd);Fm=i(Ub,"Example scripts"),Ub.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var Rb=a(ur);Mm=i(Rb,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rb.forEach(t),Tc=l(n),In=s(n,"UL",{});var Xc=a(In);ud=s(Xc,"LI",{});var Hb=a(ud);nn=s(Hb,"P",{});var Ur=a(nn);Pm=i(Ur,"pre-training: the "),Ro=s(Ur,"A",{href:!0,rel:!0});var Vb=a(Ro);Cm=i(Vb,"run_t5_mlm_flax.py"),Vb.forEach(t),Am=i(Ur,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Ur,"A",{href:!0,rel:!0});var Kb=a(Ho);Im=i(Kb,"t5_tokenizer_model.py"),Kb.forEach(t),Lm=i(Ur,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Ur.forEach(t),Hb.forEach(t),Nm=l(Xc),md=s(Xc,"LI",{});var Yb=a(md);De=s(Yb,"P",{});var yt=a(De);Dm=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Zb=a(Vo);Sm=i(Zb,"PyTorch"),Zb.forEach(t),Om=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var Jb=a(Ko);Gm=i(Jb,"Tensorflow"),Jb.forEach(t),Bm=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var Xb=a(Yo);Wm=i(Xb,"Flax"),Xb.forEach(t),Um=i(yt,`) and translation scripts
...
adding special tokens. A sequence has the following format:`),m5.forEach(t),zf=l(Vr),is=s(Vr,"UL",{});var op=a(is);vr=s(op,"LI",{});var Kk=a(vr);$f=i(Kk,"single sequence: "),kd=s(Kk,"CODE",{});var f5=a(kd);qf=i(f5,"X </s>"),f5.forEach(t),Kk.forEach(t),Ef=l(op),kr=s(op,"LI",{});var Yk=a(kr);jf=i(Yk,"pair of sequences: "),bd=s(Yk,"CODE",{});var _5=a(bd);Ff=i(_5,"A </s> B </s>"),_5.forEach(t),Yk.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),Dn=s(st,"DIV",{class:!0});var sp=a(Dn);_(ds.$$.fragment,sp),Pf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Cf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var g5=a(yd);Af=i(g5,"prepare_for_model"),g5.forEach(t),If=i(ap," method."),ap.forEach(t),sp.forEach(t),Lf=l(st),Sn=s(st,"DIV",{class:!0});var rp=a(Sn);_(cs.$$.fragment,rp),Nf=l(rp),wd=s(rp,"P",{});var T5=a(wd);Df=i(T5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T5.forEach(t),rp.forEach(t),Sf=l(st),br=s(st,"DIV",{class:!0});var v5=a(br);_(ps.$$.fragment,v5),v5.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);On=s(ip,"A",{id:!0,class:!0,href:!0});var k5=a(On);xd=s(k5,"SPAN",{});var b5=a(xd);_(hs.$$.fragment,b5),b5.forEach(t),k5.forEach(t),Of=l(ip),zd=s(ip,"SPAN",{});var y5=a(zd);Gf=i(y5,"T5TokenizerFast"),y5.forEach(t),ip.forEach(t),xc=l(n),Se=s(n,"DIV",{class:!0});var Dt=a(Se);_(us.$$.fragment,Dt),Bf=l(Dt),dn=s(Dt,"P",{});var Kr=a(dn);Wf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),$d=s(Kr,"EM",{});var w5=a($d);Uf=i(w5,"tokenizers"),w5.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var x5=a(ms);Hf=i(x5,"Unigram"),x5.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Dt),fs=s(Dt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),yr=s(dp,"A",{href:!0});var z5=a(yr);Zf=i(z5,"PreTrainedTokenizerFast"),z5.forEach(t),Jf=i(dp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),dp.forEach(t),Xf=l(Dt),Ft=s(Dt,"DIV",{class:!0});var Yr=a(Ft);_(_s.$$.fragment,Yr),Qf=l(Yr),qd=s(Yr,"P",{});var $5=a(qd);e_=i($5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
use of token type ids, therefore a list of zeros is returned.`),j5.forEach(t),cp.forEach(t),Dt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var F5=a(Bn);Md=s(F5,"SPAN",{});var M5=a(Md);_(vs.$$.fragment,M5),M5.forEach(t),F5.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var P5=a(Pd);p_=i(P5,"T5Model"),P5.forEach(t),pp.forEach(t),$c=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(ks.$$.fragment,xe),h_=l(xe),Cd=s(xe,"P",{});var C5=a(Cd);u_=i(C5,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),C5.forEach(t),m_=l(xe),bs=s(xe,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var A5=a(ys);__=i(A5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),A5.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var I5=a(zr);k_=i(I5,"PreTrainedModel"),I5.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),$_=l(xe),Ue=s(xe,"DIV",{class:!0});var St=a(Ue);_($s.$$.fragment,St),q_=l(St),cn=s(St,"P",{});var Zr=a(cn);E_=i(Zr,"The "),$r=s(Zr,"A",{href:!0});var N5=a($r);j_=i(N5,"T5Model"),N5.forEach(t),F_=i(Zr," forward method, overrides the "),Ad=s(Zr,"CODE",{});var D5=a(Ad);M_=i(D5,"__call__"),D5.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(St),_(Wn.$$.fragment,St),A_=l(St),Id=s(St,"P",{});var S5=a(Id);I_=i(S5,"Example:"),S5.forEach(t),L_=l(St),_(qs.$$.fragment,St),St.forEach(t),N_=l(xe),Re=s(xe,"DIV",{class:!0});var Ot=a(Re);_(Es.$$.fragment,Ot),D_=l(Ot),Ld=s(Ot,"P",{});var O5=a(Ld);S_=i(O5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),O5.forEach(t),O_=l(Ot),Nd=s(Ot,"P",{});var G5=a(Nd);G_=i(G5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G5.forEach(t),B_=l(Ot),Dd=s(Ot,"P",{});var B5=a(Dd);W_=i(B5,"Example:"),B5.forEach(t),U_=l(Ot),_(js.$$.fragment,Ot),Ot.forEach(t),R_=l(xe),vt=s(xe,"DIV",{class:!0});var uo=a(vt);_(Fs.$$.fragment,uo),H_=l(uo),Sd=s(uo,"P",{});var W5=a(Sd);V_=i(W5,"Moves the model to cpu from a model parallel state."),W5.forEach(t),K_=l(uo),Od=s(uo,"P",{});var U5=a(Od);Y_=i(U5,"Example:"),U5.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Un=s(fp,"A",{id:!0,class:!0,href:!0});var R5=a(Un);Gd=s(R5,"SPAN",{});var H5=a(Gd);_(Ps.$$.fragment,H5),H5.forEach(t),R5.forEach(t),J_=l(fp),Bd=s(fp,"SPAN",{});var V5=a(Bd);X_=i(V5,"T5ForConditionalGeneration"),V5.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),As=s(ze,"P",{});var _p=a(As);eg=i(_p,"T5 Model with a "),Wd=s(_p,"CODE",{});var K5=a(Wd);tg=i(K5,"language modeling"),K5.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),Is=s(ze,"P",{});var gp=a(Is);sg=i(gp,"The T5 model was proposed in "),Ls=s(gp,"A",{href:!0,rel:!0});var Y5=a(Ls);ag=i(Y5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Y5.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Ns=s(ze,"P",{});var Tp=a(Ns);dg=i(Tp,"This model inherits from "),qr=s(Tp,"A",{href:!0});var Z5=a(qr);lg=i(Z5,"PreTrainedModel"),Z5.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ds=s(ze,"P",{});var vp=a(Ds);hg=i(vp,"This model is also a PyTorch "),Ss=s(vp,"A",{href:!0,rel:!0});var J5=a(Ss);ug=i(J5,"torch.nn.Module"),J5.forEach(t),mg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
