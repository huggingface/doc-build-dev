...
Whether or not to return a <a href="/docs/transformers/pr_17710/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17710/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17710/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17710/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17710/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var Ry=r(ac);sk=i(Ry,"Finally, this model supports inherent JAX features such as:"),Ry.forEach(t),ok=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uy=r(ic);Oa=n(Uy,"A",{href:!0,rel:!0});var Hy=r(Oa);nk=i(Hy,"Just-In-Time (JIT) compilation"),Hy.forEach(t),Uy.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var Ky=r(lc);Na=n(Ky,"A",{href:!0,rel:!0});var Vy=r(Na);ak=i(Vy,"Automatic Differentiation"),Vy.forEach(t),Ky.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var Jy=r(dc);La=n(Jy,"A",{href:!0,rel:!0});var Gy=r(La);lk=i(Gy,"Vectorization"),Gy.forEach(t),Jy.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var Xy=r(cc);Sa=n(Xy,"A",{href:!0,rel:!0});var Yy=r(Sa);ck=i(Yy,"Parallelization"),Yy.forEach(t),Xy.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hk=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uk=i(Bl,"The "),pc=n(Bl,"CODE",{});var Zy=r(pc);fk=i(Zy,"FlaxDistilBertPreTrainedModel"),Zy.forEach(t),mk=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var e0=r(hc);gk=i(e0,"__call__"),e0.forEach(t),_k=i(Bl," special method."),Bl.forEach(t),bk=h(Fn),$(sn.$$.fragment,Fn),vk=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var t0=r(nn);uc=n(t0,"SPAN",{});var s0=r(uc);$(Wa.$$.fragment,s0),s0.forEach(t),t0.forEach(t),kk=h(fu),fc=n(fu,"SPAN",{});var o0=r(fc);Tk=i(o0,"FlaxDistilBertForMultipleChoice"),o0.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),mc=n(rt,"P",{});var n0=r(mc);wk=i(n0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),n0.forEach(t),yk=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);Fk=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var r0=r(dl);Dk=i(r0,"FlaxPreTrainedModel"),r0.forEach(t),xk=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),Bk=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);Mk=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var a0=r(Ha);Ek=i(a0,"flax.linen.Module"),a0.forEach(t),zk=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jk=h(rt),gc=n(rt,"P",{});var i0=r(gc);Ck=i(i0,"Finally, this model supports inherent JAX features such as:"),i0.forEach(t),qk=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var l0=r(_c);Ka=n(l0,"A",{href:!0,rel:!0});var d0=r(Ka);Pk=i(d0,"Just-In-Time (JIT) compilation"),d0.forEach(t),l0.forEach(t),Ak=h(Dn),bc=n(Dn,"LI",{});var c0=r(bc);Va=n(c0,"A",{href:!0,rel:!0});var p0=r(Va);Ok=i(p0,"Automatic Differentiation"),p0.forEach(t),c0.forEach(t),Nk=h(Dn),vc=n(Dn,"LI",{});var h0=r(vc);Ja=n(h0,"A",{href:!0,rel:!0});var u0=r(Ja);Lk=i(u0,"Vectorization"),u0.forEach(t),h0.forEach(t),Sk=h(Dn),kc=n(Dn,"LI",{});var f0=r(kc);Ga=n(f0,"A",{href:!0,rel:!0});var m0=r(Ga);Ik=i(m0,"Parallelization"),m0.forEach(t),f0.forEach(t),Dn.forEach(t),Wk=h(rt),vt=n(rt,"DIV",{class:!0});var xn=r(vt);$(Xa.$$.fragment,xn),Qk=h(xn),Os=n(xn,"P",{});var Ml=r(Os);Rk=i(Ml,"The "),Tc=n(Ml,"CODE",{});var g0=r(Tc);Uk=i(g0,"FlaxDistilBertPreTrainedModel"),g0.forEach(t),Hk=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _0=r($c);Kk=i(_0,"__call__"),_0.forEach(t),Vk=i(Ml," special method."),Ml.forEach(t),Jk=h(xn),$(rn.$$.fragment,xn),Gk=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var b0=r(ln);wc=n(b0,"SPAN",{});var v0=r(wc);$(Ya.$$.fragment,v0),v0.forEach(t),b0.forEach(t),Xk=h(_u),yc=n(_u,"SPAN",{});var k0=r(yc);Yk=i(k0,"FlaxDistilBertForTokenClassification"),k0.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Zk=h(at),Fc=n(at,"P",{});var T0=r(Fc);eT=i(T0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),vu.forEach(t),dT=h(at),Dc=n(at,"P",{});var y0=r(Dc);cT=i(y0,"Finally, this model supports inherent JAX features such as:"),y0.forEach(t),pT=h(at),Ct=n(at,"UL",{});var Bn=r(Ct);xc=n(Bn,"LI",{});var F0=r(xc);oi=n(F0,"A",{href:!0,rel:!0});var D0=r(oi);hT=i(D0,"Just-In-Time (JIT) compilation"),D0.forEach(t),F0.forEach(t),uT=h(Bn),Bc=n(Bn,"LI",{});var x0=r(Bc);ni=n(x0,"A",{href:!0,rel:!0});var B0=r(ni);fT=i(B0,"Automatic Differentiation"),B0.forEach(t),x0.forEach(t),mT=h(Bn),Mc=n(Bn,"LI",{});var M0=r(Mc);ri=n(M0,"A",{href:!0,rel:!0});var E0=r(ri);gT=i(E0,"Vectorization"),E0.forEach(t),M0.forEach(t),_T=h(Bn),Ec=n(Bn,"LI",{});var z0=r(Ec);ai=n(z0,"A",{href:!0,rel:!0});var j0=r(ai);bT=i(j0,"Parallelization"),j0.forEach(t),z0.forEach(t),Bn.forEach(t),vT=h(at),kt=n(at,"DIV",{class:!0});var Mn=r(kt);$(ii.$$.fragment,Mn),kT=h(Mn),Ls=n(Mn,"P",{});var El=r(Ls);TT=i(El,"The "),zc=n(El,"CODE",{});var C0=r(zc);$T=i(C0,"FlaxDistilBertPreTrainedModel"),C0.forEach(t),wT=i(El," forward method, overrides the "),jc=n(El,"CODE",{});var q0=r(jc);yT=i(q0,"__call__"),q0.forEach(t),FT=i(El," special method."),El.forEach(t),DT=h(Mn),$(dn.$$.fragment,Mn),xT=h(Mn),$(cn.$$.fragment,Mn),Mn.forEach(t),at.forEach(t),mh=h(s),Ss=n(s,"H2",{class:!0});var ku=r(Ss);pn=n(ku,"A",{id:!0,class:!0,href:!0});var P0=r(pn);Cc=n(P0,"SPAN",{});var A0=r(Cc);$(li.$$.fragment,A0),A0.forEach(t),P0.forEach(t),BT=h(ku),qc=n(ku,"SPAN",{});var O0=r(qc);MT=i(O0,"FlaxDistilBertForQuestionAnswering"),O0.forEach(t),ku.forEach(t),gh=h(s),qe=n(s,"DIV",{class:!0});var it=r(qe);$(di.$$.fragment,it),ET=h(it),Is=n(it,"P",{});var zl=r(Is);zT=i(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
