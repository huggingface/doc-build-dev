...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17710/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_17710/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),Ho=new be({props:{$$slots:{default:[W0]},$$scope:{ctx:B}}}),Vo=new re({props:{anchor:"transformers.TFDistilBertForQuestionAnswering.call.example",$$slots:{default:[Q0]},$$scope:{ctx:B}}}),Ko=new re({props:{anchor:"transformers.TFDistilBertForQuestionAnswering.call.example-2",$$slots:{default:[R0]},$$scope:{ctx:B}}}),pa=new Te({}),ha=new H({props:{name:"class transformers.FlaxDistilBertModel",anchor:"transformers.FlaxDistilBertModel",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17710/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17710/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17710/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17710/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),sn=new be({props:{$$slots:{default:[J0]},$$scope:{ctx:B}}}),on=new re({props:{anchor:"transformers.FlaxDistilBertForSequenceClassification.__call__.example",$$slots:{default:[G0]},$$scope:{ctx:B}}}),Wa=new Te({}),Qa=new H({props:{name:"class transformers.FlaxDistilBertForMultipleChoice",anchor:"transformers.FlaxDistilBertForMultipleChoice",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17710/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(st),Sd=n(st,"P",{});var cy=r(Sd);Hv=i(cy,"Finally, this model supports inherent JAX features such as:"),cy.forEach(t),Vv=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var py=r(Id);ga=n(py,"A",{href:!0,rel:!0});var hy=r(ga);Kv=i(hy,"Just-In-Time (JIT) compilation"),hy.forEach(t),py.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var uy=r(Wd);_a=n(uy,"A",{href:!0,rel:!0});var fy=r(_a);Gv=i(fy,"Automatic Differentiation"),fy.forEach(t),uy.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var my=r(Qd);ba=n(my,"A",{href:!0,rel:!0});var gy=r(ba);Yv=i(gy,"Vectorization"),gy.forEach(t),my.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _y=r(Rd);va=n(_y,"A",{href:!0,rel:!0});var by=r(va);e1=i(by,"Parallelization"),by.forEach(t),_y.forEach(t),kn.forEach(t),t1=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),s1=h(Tn),zs=n(Tn,"P",{});var Fl=r(zs);o1=i(Fl,"The "),Ud=n(Fl,"CODE",{});var vy=r(Ud);n1=i(vy,"FlaxDistilBertPreTrainedModel"),vy.forEach(t),r1=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var ky=r(Hd);a1=i(ky,"__call__"),ky.forEach(t),i1=i(Fl," special method."),Fl.forEach(t),l1=h(Tn),$(Go.$$.fragment,Tn),d1=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var Ty=r(Yo);Vd=n(Ty,"SPAN",{});var $y=r(Vd);$(Ta.$$.fragment,$y),$y.forEach(t),Ty.forEach(t),c1=h(iu),Kd=n(iu,"SPAN",{});var wy=r(Kd);p1=i(wy,"FlaxDistilBertForMaskedLM"),wy.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),h1=h(ot),wa=n(ot,"P",{});var lu=r(wa);u1=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yy=r(Jd);f1=i(yy,"language modeling"),yy.forEach(t),m1=i(lu," head on top."),lu.forEach(t),g1=h(ot),ya=n(ot,"P",{});var du=r(ya);_1=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Dy=r(il);b1=i(Dy,"FlaxPreTrainedModel"),Dy.forEach(t),v1=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),k1=h(ot),Da=n(ot,"P",{});var cu=r(Da);T1=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var Fy=r(Fa);$1=i(Fy,"flax.linen.Module"),Fy.forEach(t),w1=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),y1=h(ot),Gd=n(ot,"P",{});var By=r(Gd);D1=i(By,"Finally, this model supports inherent JAX features such as:"),By.forEach(t),F1=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var xy=r(Xd);Ba=n(xy,"A",{href:!0,rel:!0});var My=r(Ba);B1=i(My,"Just-In-Time (JIT) compilation"),My.forEach(t),xy.forEach(t),x1=h($n),Yd=n($n,"LI",{});var Ey=r(Yd);xa=n(Ey,"A",{href:!0,rel:!0});var zy=r(xa);M1=i(zy,"Automatic Differentiation"),zy.forEach(t),Ey.forEach(t),E1=h($n),Zd=n($n,"LI",{});var jy=r(Zd);Ma=n(jy,"A",{href:!0,rel:!0});var Cy=r(Ma);z1=i(Cy,"Vectorization"),Cy.forEach(t),jy.forEach(t),j1=h($n),ec=n($n,"LI",{});var qy=r(ec);Ea=n(qy,"A",{href:!0,rel:!0});var Py=r(Ea);C1=i(Py,"Parallelization"),Py.forEach(t),qy.forEach(t),$n.forEach(t),q1=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),P1=h(wn),Cs=n(wn,"P",{});var Bl=r(Cs);A1=i(Bl,"The "),tc=n(Bl,"CODE",{});var Ay=r(tc);O1=i(Ay,"FlaxDistilBertPreTrainedModel"),Ay.forEach(t),N1=i(Bl," forward method, overrides the "),sc=n(Bl,"CODE",{});var Oy=r(sc);L1=i(Oy,"__call__"),Oy.forEach(t),S1=i(Bl," special method."),Bl.forEach(t),I1=h(wn),$(Zo.$$.fragment,wn),W1=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var Ny=r(tn);oc=n(Ny,"SPAN",{});var Ly=r(oc);$(ja.$$.fragment,Ly),Ly.forEach(t),Ny.forEach(t),Q1=h(pu),nc=n(pu,"SPAN",{});var Sy=r(nc);R1=i(Sy,"FlaxDistilBertForSequenceClassification"),Sy.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),U1=h(nt),rc=n(nt,"P",{});var Iy=r(rc);H1=i(Iy,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
