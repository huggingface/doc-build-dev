...
- **kwargs** (`Dict[str, Any]`, *optional*) --
  ...
  controlled by the `return_unused_kwargs` keyword parameter.</paramsdesc><paramgroups>0</paramgroups><retdesc>A feature extractor of type [FeatureExtractionMixin](/docs/transformers/pr_15562/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin).</retdesc></docstring>

Instantiate a type of [FeatureExtractionMixin](/docs/transformers/pr_15562/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin) from a feature extractor, *e.g.* a
...
[from_pretrained()](/docs/transformers/pr_15562/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained) class method.
