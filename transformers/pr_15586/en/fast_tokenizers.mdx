...
The [PreTrainedTokenizerFast](/docs/transformers/pr_15586/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast) depends on the [🤗 Tokenizers](https://huggingface.co/docs/tokenizers) library. The tokenizers obtained from the 🤗 Tokenizers library can be
...
[PreTrainedTokenizerFast](/docs/transformers/pr_15586/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast) class allows for easy instantiation, by accepting the instantiated
...
The path to which we saved this file can be passed to the [PreTrainedTokenizerFast](/docs/transformers/pr_15586/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast) initialization
