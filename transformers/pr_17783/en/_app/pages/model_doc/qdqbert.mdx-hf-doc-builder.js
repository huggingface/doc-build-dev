import{S as wu,i as vu,s as $u,e as r,k as p,w as Q,t as n,M as Tu,c as a,d as o,m as h,a as i,x as w,h as s,b as f,G as e,g as b,y as v,q as $,o as T,B as y,v as yu,L as O}from"../../chunks/vendor-hf-doc-builder.js";import{T as xt}from"../../chunks/Tip-hf-doc-builder.js";import{D as F}from"../../chunks/Docstring-hf-doc-builder.js";import{C as M}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as J}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as I}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function qu(q){let d,_,c,u,k;return u=new M({props:{code:`from transformers import QDQBertModel, QDQBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Ju(q){let d,_,c,u,k,l,m,D,Da,dr,fe,Se,Sn,Ft,za,Ln,Ba,cr,Le,Ma,jt,xa,Fa,pr,tn,ja,hr,on,In,Ea,ur,nn,Pa,mr,G,On,Wn,Ca,Aa,Hn,Ie,Na,Et,Sa,La,Rn,Ia,Oa,Un,Pt,Wa,Vn,Ha,Ra,Ua,Xn,Ct,Va,sn,Xa,Ja,fr,Oe,Ka,At,Ga,Ya,gr,ge,We,Jn,Nt,Za,Kn,ei,_r,j,ti,Gn,oi,ni,St,si,ri,Yn,ai,ii,Zn,li,di,Lt,ci,pi,br,He,hi,es,ui,mi,kr,rn,fi,Qr,It,wr,_e,Re,ts,Ot,gi,os,_i,vr,an,bi,$r,Wt,Tr,be,Ue,ns,Ht,ki,ss,Qi,yr,se,wi,Rt,vi,$i,Ut,Ti,yi,qr,Vt,Dr,ke,Ve,rs,Xt,qi,as,Di,zr,K,Jt,zi,Qe,Bi,ln,Mi,xi,Kt,Fi,ji,Ei,we,Pi,dn,Ci,Ai,cn,Ni,Si,Li,Xe,Br,ve,Je,is,Gt,Ii,ls,Oi,Mr,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,rl,al,ps,il,ll,hs,dl,cl,us,pl,hl,ms,ul,ml,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,Ql,wl,gs,vl,$l,Tl,Ke,yl,Ge,xr,Te,Ye,_s,ro,ql,bs,Dl,Fr,E,ao,zl,io,Bl,ks,Ml,xl,Fl,lo,jl,un,El,Pl,Cl,co,Al,po,Nl,Sl,Ll,Z,ho,Il,ye,Ol,mn,Wl,Hl,Qs,Rl,Ul,Vl,Ze,Xl,et,jr,qe,tt,ws,uo,Jl,vs,Kl,Er,P,mo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,rd,_o,ad,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,ud,Ts,md,fd,gd,ot,_d,nt,bd,st,Pr,ze,rt,ys,Qo,kd,qs,Qd,Cr,C,wo,wd,Ds,vd,$d,vo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,Fd,Be,jd,bn,Ed,Pd,zs,Cd,Ad,Nd,at,Sd,it,Ld,lt,Id,dt,Od,ct,Ar,Me,pt,Bs,qo,Wd,Ms,Hd,Nr,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,Fo,sc,xe,rc,Qn,ac,ic,Fs,lc,dc,cc,ht,pc,ut,Sr,Fe,mt,js,jo,hc,Es,uc,Lr,N,Eo,mc,Ps,fc,gc,Po,_c,wn,bc,kc,Qc,Co,wc,Ao,vc,$c,Tc,te,No,yc,je,qc,vn,Dc,zc,Cs,Bc,Mc,xc,ft,Fc,gt,Ir,Ee,_t,As,So,jc,Ns,Ec,Or,S,Lo,Pc,Ss,Cc,Ac,Io,Nc,$n,Sc,Lc,Ic,Oo,Oc,Wo,Wc,Hc,Rc,H,Ho,Uc,Pe,Vc,Tn,Xc,Jc,Ls,Kc,Gc,Yc,bt,Zc,kt,ep,Qt,Wr,Ce,wt,Is,Ro,tp,Os,op,Hr,L,Uo,np,Ae,sp,Ws,rp,ap,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,up,Xo,mp,Jo,fp,gp,_p,R,Ko,bp,Ne,kp,qn,Qp,wp,Rs,vp,$p,Tp,vt,yp,$t,qp,Tt,Rr;return l=new J({}),Ft=new J({}),Nt=new J({}),It=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17783/en/model_doc/qdqbert#transformers.QDQBertModel">QDQBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.QDQBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L881",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17783/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17783/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1022"}}),ho=new F({props:{name:"forward",anchor:"transformers.QDQBertLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.QDQBertLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17783/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1045",returnDescription:`
<p>A <a
...
`}}),Ze=new xt({props:{$$slots:{default:[Bu]},$$scope:{ctx:q}}}),et=new I({props:{anchor:"transformers.QDQBertLMHeadModel.forward.example",$$slots:{default:[Mu]},$$scope:{ctx:q}}}),uo=new J({}),mo=new F({props:{name:"class transformers.QDQBertForMaskedLM",anchor:"transformers.QDQBertForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17783/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17783/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1170"}}),ko=new F({props:{name:"forward",anchor:"transformers.QDQBertForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.QDQBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17783/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1196",returnDescription:`
<p>A <a
...
`}}),ot=new xt({props:{$$slots:{default:[xu]},$$scope:{ctx:q}}}),nt=new I({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example",$$slots:{default:[Fu]},$$scope:{ctx:q}}}),st=new I({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example-2",$$slots:{default:[ju]},$$scope:{ctx:q}}}),Qo=new J({}),wo=new F({props:{name:"class transformers.QDQBertForSequenceClassification",anchor:"transformers.QDQBertForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17783/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17783/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1385"}}),yo=new F({props:{name:"forward",anchor:"transformers.QDQBertForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17783/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1397",returnDescription:`
<p>A <a
...
`}}),at=new xt({props:{$$slots:{default:[Eu]},$$scope:{ctx:q}}}),it=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example",$$slots:{default:[Pu]},$$scope:{ctx:q}}}),lt=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-2",$$slots:{default:[Cu]},$$scope:{ctx:q}}}),dt=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-3",$$slots:{default:[Au]},$$scope:{ctx:q}}}),ct=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-4",$$slots:{default:[Nu]},$$scope:{ctx:q}}}),qo=new J({}),Do=new F({props:{name:"class transformers.QDQBertForNextSentencePrediction",anchor:"transformers.QDQBertForNextSentencePrediction",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17783/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17783/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1281"}}),Fo=new F({props:{name:"forward",anchor:"transformers.QDQBertForNextSentencePrediction.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17783/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1291",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1494",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1590",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/qdqbert/modeling_qdqbert.py#L1671",returnDescription:`
<p>A <a
...
`}}),vt=new xt({props:{$$slots:{default:[Uu]},$$scope:{ctx:q}}}),$t=new I({props:{anchor:"transformers.QDQBertForQuestionAnswering.forward.example",$$slots:{default:[Vu]},$$scope:{ctx:q}}}),Tt=new I({props:{anchor:"transformers.QDQBertForQuestionAnswering.forward.example-2",$$slots:{default:[Xu]},$$scope:{ctx:q}}}),{c(){d=r("meta"),_=p(),c=r("h1"),u=r("a"),k=r("span"),Q(l.$$.fragment),m=p(),D=r("span"),Da=n("QDQBERT"),dr=p(),fe=r("h2"),Se=r("a"),Sn=r("span"),Q(Ft.$$.fragment),za=p(),Ln=r("span"),Ba=n("Overview"),cr=p(),Le=r("p"),Ma=n("The QDQBERT model can be referenced in "),jt=r("a"),xa=n(`Integer Quantization for Deep Learning Inference: Principles and Empirical
Evaluation`),Fa=n(` by Hao Wu, Patrick Judd, Xiaojie Zhang, Mikhail Isaev and Paulius
Micikevicius.`),pr=p(),tn=r("p"),ja=n("The abstract from the paper is the following:"),hr=p(),on=r("p"),In=r("em"),Ea=n(`Quantization techniques can reduce the size of Deep Neural Networks and improve inference latency and throughput by
...
SQUAD task can be found at `),sn=r("a"),Xa=n("transformers/examples/research_projects/quantization-qdqbert/"),Ja=n("."),fr=p(),Oe=r("p"),Ka=n("This model was contributed by "),At=r("a"),Ga=n("shangz"),Ya=n("."),gr=p(),ge=r("h3"),We=r("a"),Jn=r("span"),Q(Nt.$$.fragment),Za=p(),Kn=r("span"),ei=n("Set default quantizers"),_r=p(),j=r("p"),ti=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nc=p(),ee=r("div"),Q(Fo.$$.fragment),sc=p(),xe=r("p"),rc=n("The "),Qn=r("a"),ac=n("QDQBertForNextSentencePrediction"),ic=n(" forward method, overrides the "),Fs=r("code"),lc=n("__call__"),dc=n(" special method."),cc=p(),Q(ht.$$.fragment),pc=p(),Q(ut.$$.fragment),Sr=p(),Fe=r("h2"),mt=r("a"),js=r("span"),Q(jo.$$.fragment),hc=p(),Es=r("span"),uc=n("QDQBertForMultipleChoice"),Lr=p(),N=r("div"),Q(Eo.$$.fragment),mc=p(),Ps=r("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=p(),te=r("div"),Q(No.$$.fragment),yc=p(),je=r("p"),qc=n("The "),vn=r("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Cs=r("code"),Bc=n("__call__"),Mc=n(" special method."),xc=p(),Q(ft.$$.fragment),Fc=p(),Q(gt.$$.fragment),Ir=p(),Ee=r("h2"),_t=r("a"),As=r("span"),Q(So.$$.fragment),jc=p(),Ns=r("span"),Ec=n("QDQBertForTokenClassification"),Or=p(),S=r("div"),Q(Lo.$$.fragment),Pc=p(),Ss=r("p"),Cc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p=p(),R=r("div"),Q(Ko.$$.fragment),bp=p(),Ne=r("p"),kp=n("The "),qn=r("a"),Qp=n("QDQBertForQuestionAnswering"),wp=n(" forward method, overrides the "),Rs=r("code"),vp=n("__call__"),$p=n(" special method."),Tp=p(),Q(vt.$$.fragment),yp=p(),Q($t.$$.fragment),qp=p(),Q(Tt.$$.fragment),this.h()},l(t){const g=Tu('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(o),_=h(t),c=a(t,"H1",{class:!0});var Go=i(c);u=a(Go,"A",{id:!0,class:!0,href:!0});var Us=i(u);k=a(Us,"SPAN",{});var Vs=i(k);w(l.$$.fragment,Vs),Vs.forEach(o),Us.forEach(o),m=h(Go),D=a(Go,"SPAN",{});var Xs=i(D);Da=s(Xs,"QDQBERT"),Xs.forEach(o),Go.forEach(o),dr=h(t),fe=a(t,"H2",{class:!0});var Yo=i(fe);Se=a(Yo,"A",{id:!0,class:!0,href:!0});var Js=i(Se);Sn=a(Js,"SPAN",{});var Ks=i(Sn);w(Ft.$$.fragment,Ks),Ks.forEach(o),Js.forEach(o),za=h(Yo),Ln=a(Yo,"SPAN",{});var Gs=i(Ln);Ba=s(Gs,"Overview"),Gs.forEach(o),Yo.forEach(o),cr=h(t),Le=a(t,"P",{});var Zo=i(Le);Ma=s(Zo,"The QDQBERT model can be referenced in "),jt=a(Zo,"A",{href:!0,rel:!0});var Ys=i(jt);xa=s(Ys,`Integer Quantization for Deep Learning Inference: Principles and Empirical
Evaluation`),Ys.forEach(o),Fa=s(Zo,` by Hao Wu, Patrick Judd, Xiaojie Zhang, Mikhail Isaev and Paulius
Micikevicius.`),Zo.forEach(o),pr=h(t),tn=a(t,"P",{});var Zs=i(tn);ja=s(Zs,"The abstract from the paper is the following:"),Zs.forEach(o),hr=h(t),on=a(t,"P",{});var er=i(on);In=a(er,"EM",{});var tr=i(In);Ea=s(tr,`Quantization techniques can reduce the size of Deep Neural Networks and improve inference latency and throughput by
taking advantage of high throughput integer instructions. In this paper we review the mathematical aspects of
quantization parameters and evaluate their choices on a wide range of neural network models for different application
domains, including vision, speech, and language. We focus on quantization techniques that are amenable to acceleration
by processors with high-throughput integer math pipelines. We also present a workflow for 8-bit quantization that is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ua.forEach(o),xd=h(le),B=a(le,"DIV",{class:!0});var X=i(B);w(yo.$$.fragment,X),Fd=h(X),Be=a(X,"P",{});var jn=i(Be);jd=s(jn,"The "),bn=a(jn,"A",{href:!0});var Lh=i(bn);Ed=s(Lh,"QDQBertForSequenceClassification"),Lh.forEach(o),Pd=s(jn," forward method, overrides the "),zs=a(jn,"CODE",{});var Ih=i(zs);Cd=s(Ih,"__call__"),Ih.forEach(o),Ad=s(jn," special method."),jn.forEach(o),Nd=h(X),w(at.$$.fragment,X),Sd=h(X),w(it.$$.fragment,X),Ld=h(X),w(lt.$$.fragment,X),Id=h(X),w(dt.$$.fragment,X),Od=h(X),w(ct.$$.fragment,X),X.forEach(o),le.forEach(o),Ar=h(t),Me=a(t,"H2",{class:!0});var ma=i(Me);pt=a(ma,"A",{id:!0,class:!0,href:!0});var Oh=i(pt);Bs=a(Oh,"SPAN",{});var Wh=i(Bs);w(qo.$$.fragment,Wh),Wh.forEach(o),Oh.forEach(o),Wd=h(ma),Ms=a(ma,"SPAN",{});var Hh=i(Ms);Hd=s(Hh,"QDQBertForNextSentencePrediction"),Hh.forEach(o),ma.forEach(o),Nr=h(t),A=a(t,"DIV",{class:!0});var de=i(A);w(Do.$$.fragment,de),Rd=h(de),zo=a(de,"P",{});var fa=i(zo);Ud=s(fa,"Bert Model with a "),xs=a(fa,"CODE",{});var Rh=i(xs);Vd=s(Rh,"next sentence prediction (classification)"),Rh.forEach(o),Xd=s(fa," head on top."),fa.forEach(o),Jd=h(de),Bo=a(de,"P",{});var ga=i(Bo);Kd=s(ga,"This model inherits from "),kn=a(ga,"A",{href:!0});var Uh=i(kn);Gd=s(Uh,"PreTrainedModel"),Uh.forEach(o),Yd=s(ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_a.forEach(o),nc=h(de),ee=a(de,"DIV",{class:!0});var Bt=i(ee);w(Fo.$$.fragment,Bt),sc=h(Bt),xe=a(Bt,"P",{});var En=i(xe);rc=s(En,"The "),Qn=a(En,"A",{href:!0});var Xh=i(Qn);ac=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(En," forward method, overrides the "),Fs=a(En,"CODE",{});var Jh=i(Fs);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(En," special method."),En.forEach(o),cc=h(Bt),w(ht.$$.fragment,Bt),pc=h(Bt),w(ut.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Sr=h(t),Fe=a(t,"H2",{class:!0});var ba=i(Fe);mt=a(ba,"A",{id:!0,class:!0,href:!0});var Kh=i(mt);js=a(Kh,"SPAN",{});var Gh=i(js);w(jo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(ba),Es=a(ba,"SPAN",{});var Yh=i(Es);uc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),ba.forEach(o),Lr=h(t),N=a(t,"DIV",{class:!0});var ce=i(N);w(Eo.$$.fragment,ce),mc=h(ce),Ps=a(ce,"P",{});var Zh=i(Ps);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qa.forEach(o),Tc=h(ce),te=a(ce,"DIV",{class:!0});var Mt=i(te);w(No.$$.fragment,Mt),yc=h(Mt),je=a(Mt,"P",{});var Pn=i(je);qc=s(Pn,"The "),vn=a(Pn,"A",{href:!0});var ou=i(vn);Dc=s(ou,"QDQBertForMultipleChoice"),ou.forEach(o),zc=s(Pn," forward method, overrides the "),Cs=a(Pn,"CODE",{});var nu=i(Cs);Bc=s(nu,"__call__"),nu.forEach(o),Mc=s(Pn," special method."),Pn.forEach(o),xc=h(Mt),w(ft.$$.fragment,Mt),Fc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Ir=h(t),Ee=a(t,"H2",{class:!0});var wa=i(Ee);_t=a(wa,"A",{id:!0,class:!0,href:!0});var su=i(_t);As=a(su,"SPAN",{});var ru=i(As);w(So.$$.fragment,ru),ru.forEach(o),su.forEach(o),jc=h(wa),Ns=a(wa,"SPAN",{});var au=i(Ns);Ec=s(au,"QDQBertForTokenClassification"),au.forEach(o),wa.forEach(o),Or=h(t),S=a(t,"DIV",{class:!0});var pe=i(S);w(Lo.$$.fragment,pe),Pc=h(pe),Ss=a(pe,"P",{});var iu=i(Ss);Cc=s(iu,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
