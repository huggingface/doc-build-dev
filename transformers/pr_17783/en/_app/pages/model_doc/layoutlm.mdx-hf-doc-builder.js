...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(o),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:qo,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(h,l)}}}function mh(E){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
...
first positional argument :`),$e.forEach(o),Q=p(g),F=r(g,"UL",{});var O=i(F);q=r(O,"LI",{});var K=i(q);le=s(K,"a single Tensor with "),H=r(K,"CODE",{});var xe=i(H);V=s(xe,"input_ids"),xe.forEach(o),ee=s(K," only and nothing else: "),B=r(K,"CODE",{});var ye=i(B);oe=s(ye,"model(inputs_ids)"),ye.forEach(o),K.forEach(o),de=p(O),C=r(O,"LI",{});var P=i(C);ce=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(P,"CODE",{});var ze=i(U);pe=s(ze,"model([input_ids, attention_mask])"),ze.forEach(o),te=s(P," or "),R=r(P,"CODE",{});var ke=i(R);ue=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(o),P.forEach(o),he=p(O),N=r(O,"LI",{});var ge=i(N);me=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=r(ge,"CODE",{});var Ee=i(W);fe=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(o),ge.forEach(o),O.forEach(o)},m(g,x){f(g,d,x),e(d,k),f(g,_,x),f(g,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),f(g,Y,x),f(g,z,x),e(z,ae),e(z,I),e(I,Z),e(z,ne),e(z,A),e(A,ie),e(z,se),f(g,J,x),f(g,D,x),e(D,G),f(g,Q,x),f(g,F,x),e(F,q),e(q,le),e(q,H),e(H,V),e(q,ee),e(q,B),e(B,oe),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,te),e(C,R),e(R,ue),e(F,he),e(F,N),e(N,me),e(N,W),e(W,fe)},d(g){g&&o(d),g&&o(_),g&&o(h),g&&o(Y),g&&o(z),g&&o(J),g&&o(D),g&&o(Q),g&&o(F)}}}function Th(E){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(o),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(l,m){f(l,d,m),e(d,k),e(d,_),e(_,h),e(d,b)},d(l){l&&o(d)}}}function vh(E){let d,k,_,h,b;return h=new oo({props:{code:`from transformers import LayoutLMTokenizer, TFLayoutLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(o),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:qo,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(h,l)}}}function Mh(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,he,N,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),B=a("code"),oe=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),te=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),N=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(o),_=p(g),h=r(g,"UL",{});var X=i(h);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(o),m=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(o),X.forEach(o),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(o),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(o),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:qo,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(h,l)}}}function jh(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,he,N,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),B=a("code"),oe=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),te=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),N=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(o),_=p(g),h=r(g,"UL",{});var X=i(h);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(o),m=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(o),X.forEach(o),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(o),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(o),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:qo,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(h,l)}}}function Eh(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,he,N,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),B=a("code"),oe=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),te=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),N=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(o),_=p(g),h=r(g,"UL",{});var X=i(h);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(o),m=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(o),X.forEach(o),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(o),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(o),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:qo,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(h,l)}}}function Ph(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,he,N,me,W,fe,g,x,X,je,Me,S,be,Fe,$e,O,K,xe,ye,P,ze,ke,ge,Ee,Qn,Hr,Br,Os,Rr,Kr,xt,Vr,Xr,jt,Yr,Zr,Da,Ft,Aa,to,Gr,Is,Jr,Qr,Ds,ei,oi,Ua,zt,Wa,es,eo,ti,os,ni,si,Et,ai,ri,qt,ii,li,Ha,no,di,Ct,ci,pi,Pt,ui,hi,Ba,ro,Co,As,Nt,mi,Us,fi,Ra,Pe,St,gi,io,_i,ts,yi,bi,Ot,ki,Li,wi,lo,Ti,ns,vi,Mi,ss,$i,xi,ji,Po,Ka,co,No,Ws,It,Fi,Hs,zi,Va,Ne,Dt,Ei,Bs,qi,Ci,So,as,Pi,Ni,rs,Si,Oi,Ii,At,Di,is,Ai,Ui,Xa,po,Oo,Rs,Ut,Wi,Ks,Hi,Ya,Se,Wt,Bi,Vs,Ri,Ki,Io,ls,Vi,Xi,ds,Yi,Zi,Gi,Ht,Ji,cs,Qi,el,Za,uo,Do,Xs,Bt,ol,Ys,tl,Ga,Oe,Rt,nl,Kt,sl,Vt,al,rl,il,Xt,ll,Yt,dl,cl,pl,Ae,Zt,ul,ho,hl,ps,ml,fl,Zs,gl,_l,yl,Ao,bl,Uo,Ja,mo,Wo,Gs,Gt,kl,Js,Ll,Qa,Ie,Jt,wl,fo,Tl,Qs,vl,Ml,Qt,$l,xl,jl,en,Fl,on,zl,El,ql,Ue,tn,Cl,go,Pl,us,Nl,Sl,ea,Ol,Il,Dl,Ho,Al,Bo,er,_o,Ro,oa,nn,Ul,ta,Wl,or,qe,sn,Hl,an,Bl,rn,Rl,Kl,Vl,ln,Xl,dn,Yl,Zl,Gl,cn,Jl,pn,Ql,ed,od,We,un,td,yo,nd,hs,sd,ad,na,rd,id,ld,Ko,dd,Vo,tr,bo,Xo,sa,hn,cd,aa,pd,nr,Ce,mn,ud,ko,hd,fn,md,fd,gn,gd,_d,yd,_n,bd,yn,kd,Ld,wd,bn,Td,kn,vd,Md,$d,He,Ln,xd,Lo,jd,ms,Fd,zd,ra,Ed,qd,Cd,Yo,Pd,Zo,sr,wo,Go,ia,wn,Nd,la,Sd,ar,Le,Tn,Od,da,Id,Dd,vn,Ad,fs,Ud,Wd,Hd,Mn,Bd,$n,Rd,Kd,Vd,Jo,Xd,Be,xn,Yd,To,Zd,gs,Gd,Jd,ca,Qd,ec,oc,Qo,tc,et,rr,vo,ot,pa,jn,nc,ua,sc,ir,we,Fn,ac,zn,rc,ha,ic,lc,dc,En,cc,_s,pc,uc,hc,qn,mc,Cn,fc,gc,_c,tt,yc,Re,Pn,bc,Mo,kc,ys,Lc,wc,ma,Tc,vc,Mc,nt,$c,st,lr,$o,at,fa,Nn,xc,ga,jc,dr,Te,Sn,Fc,_a,zc,Ec,On,qc,bs,Cc,Pc,Nc,In,Sc,Dn,Oc,Ic,Dc,rt,Ac,Ke,An,Uc,xo,Wc,ks,Hc,Bc,ya,Rc,Kc,Vc,it,Xc,lt,cr,jo,dt,ba,Un,Yc,ka,Zc,pr,ve,Wn,Gc,La,Jc,Qc,Hn,ep,Ls,op,tp,np,Bn,sp,Rn,ap,rp,ip,ct,lp,Ve,Kn,dp,Fo,cp,ws,pp,up,wa,hp,mp,fp,pt,gp,ut,ur;return l=new De({}),A=new De({}),Ft=new oo({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
just in case (e.g., 1024).`,name:"max_2d_position_embeddings"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/layoutlm/configuration_layoutlm.py#L39"}}),Po=new Eo({props:{anchor:"transformers.LayoutLMConfig.example",$$slots:{default:[hh]},$$scope:{ctx:E}}}),It=new De({}),Dt=new _e({props:{name:"class transformers.LayoutLMTokenizer",anchor:"transformers.LayoutLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/layoutlm/tokenization_layoutlm.py#L50"}}),Ut=new De({}),Wt=new _e({props:{name:"class transformers.LayoutLMTokenizerFast",anchor:"transformers.LayoutLMTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/layoutlm/tokenization_layoutlm_fast.py#L59"}}),Bt=new De({}),Rt=new _e({props:{name:"class transformers.LayoutLMModel",anchor:"transformers.LayoutLMModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17783/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17783/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17783/src/transformers/models/layoutlm/modeling_layoutlm.py#L703"}}),Zt=new _e({props:{name:"forward",anchor:"transformers.LayoutLMModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17783/en/model_doc/layoutlm#transformers.LayoutLMTokenizer">LayoutLMTokenizer</a>. See <a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17783/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(from 93.07 to 94.42).`),$e=c(),O=a("p"),K=n("Tips:"),xe=c(),ye=a("ul"),P=a("li"),ze=n("In addition to "),ke=a("em"),ge=n("input_ids"),Ee=n(", "),Qn=a("a"),Hr=n("forward()"),Br=n(" also expects the input "),Os=a("code"),Rr=n("bbox"),Kr=n(`, which are
...
scale. To normalize, you can use the following function:`),Da=c(),L(Ft.$$.fragment),Aa=c(),to=a("p"),Gr=n("Here, "),Is=a("code"),Jr=n("width"),Qr=n(" and "),Ds=a("code"),ei=n("height"),oi=n(` correspond to the width and height of the original document in which the token
...
`),Ot=a("a"),ki=n("microsoft/layoutlm-base-uncased"),Li=n(" architecture."),wi=c(),lo=a("p"),Ti=n("Configuration objects inherit from "),ns=a("a"),vi=n("BertConfig"),Mi=n(` and can be used to control the model outputs. Read the
documentation from `),ss=a("a"),$i=n("BertConfig"),xi=n(" for more information."),ji=c(),L(Po.$$.fragment),Ka=c(),co=a("h2"),No=a("a"),Ws=a("span"),L(It.$$.fragment),Fi=c(),Hs=a("span"),zi=n("LayoutLMTokenizer"),Va=c(),Ne=a("div"),L(Dt.$$.fragment),Ei=c(),Bs=a("p"),qi=n("Constructs a LayoutLM tokenizer."),Ci=c(),So=a("p"),as=a("a"),Pi=n("LayoutLMTokenizer"),Ni=n(" is identical to "),rs=a("a"),Si=n("BertTokenizer"),Oi=n(` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),Ii=c(),At=a("p"),Di=n("Refer to superclass "),is=a("a"),Ai=n("BertTokenizer"),Ui=n(" for usage examples and documentation concerning parameters."),Xa=c(),po=a("h2"),Oo=a("a"),Rs=a("span"),L(Ut.$$.fragment),Wi=c(),Ks=a("span"),Hi=n("LayoutLMTokenizerFast"),Ya=c(),Se=a("div"),L(Wt.$$.fragment),Bi=c(),Vs=a("p"),Ri=n("Constructs a \u201CFast\u201D LayoutLMTokenizer."),Ki=c(),Io=a("p"),ls=a("a"),Vi=n("LayoutLMTokenizerFast"),Xi=n(" is identical to "),ds=a("a"),Yi=n("BertTokenizerFast"),Zi=n(` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),Gi=c(),Ht=a("p"),Ji=n("Refer to superclass "),cs=a("a"),Qi=n("BertTokenizerFast"),el=n(" for usage examples and documentation concerning parameters."),Za=c(),uo=a("h2"),Do=a("a"),Xs=a("span"),L(Bt.$$.fragment),ol=c(),Ys=a("span"),tl=n("LayoutLMModel"),Ga=c(),Oe=a("div"),L(Rt.$$.fragment),nl=c(),Kt=a("p"),sl=n(`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),pl=c(),Ae=a("div"),L(Zt.$$.fragment),ul=c(),ho=a("p"),hl=n("The "),ps=a("a"),ml=n("LayoutLMModel"),fl=n(" forward method, overrides the "),Zs=a("code"),gl=n("__call__"),_l=n(" special method."),yl=c(),L(Ao.$$.fragment),bl=c(),L(Uo.$$.fragment),Ja=c(),mo=a("h2"),Wo=a("a"),Gs=a("span"),L(Gt.$$.fragment),kl=c(),Js=a("span"),Ll=n("LayoutLMForMaskedLM"),Qa=c(),Ie=a("div"),L(Jt.$$.fragment),wl=c(),fo=a("p"),Tl=n("LayoutLM Model with a "),Qs=a("code"),vl=n("language modeling"),Ml=n(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$d=c(),He=a("div"),L(Ln.$$.fragment),xd=c(),Lo=a("p"),jd=n("The "),ms=a("a"),Fd=n("LayoutLMForTokenClassification"),zd=n(" forward method, overrides the "),ra=a("code"),Ed=n("__call__"),qd=n(" special method."),Cd=c(),L(Yo.$$.fragment),Pd=c(),L(Zo.$$.fragment),sr=c(),wo=a("h2"),Go=a("a"),ia=a("span"),L(wn.$$.fragment),Nd=c(),la=a("span"),Sd=n("TFLayoutLMModel"),ar=c(),Le=a("div"),L(Tn.$$.fragment),Od=c(),da=a("p"),Id=n("The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Dd=c(),vn=a("p"),Ad=n("This model inherits from "),fs=a("a"),Ud=n("TFPreTrainedModel"),Wd=n(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_c=c(),L(tt.$$.fragment),yc=c(),Re=a("div"),L(Pn.$$.fragment),bc=c(),Mo=a("p"),kc=n("The "),ys=a("a"),Lc=n("TFLayoutLMForMaskedLM"),wc=n(" forward method, overrides the "),ma=a("code"),Tc=n("__call__"),vc=n(" special method."),Mc=c(),L(nt.$$.fragment),$c=c(),L(st.$$.fragment),lr=c(),$o=a("h2"),at=a("a"),fa=a("span"),L(Nn.$$.fragment),xc=c(),ga=a("span"),jc=n("TFLayoutLMForSequenceClassification"),dr=c(),Te=a("div"),L(Sn.$$.fragment),Fc=c(),_a=a("p"),zc=n(`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip=c(),L(ct.$$.fragment),lp=c(),Ve=a("div"),L(Kn.$$.fragment),dp=c(),Fo=a("p"),cp=n("The "),ws=a("a"),pp=n("TFLayoutLMForTokenClassification"),up=n(" forward method, overrides the "),wa=a("code"),hp=n("__call__"),mp=n(" special method."),fp=c(),L(pt.$$.fragment),gp=c(),L(ut.$$.fragment),this.h()},l(t){const y=ph('[data-svelte="svelte-1phssyn"]',document.head);d=r(y,"META",{name:!0,content:!0}),y.forEach(o),k=p(t),_=r(t,"H1",{class:!0});var Vn=i(_);h=r(Vn,"A",{id:!0,class:!0,href:!0});var Ta=i(h);b=r(Ta,"SPAN",{});var va=i(b);w(l.$$.fragment,va),va.forEach(o),Ta.forEach(o),m=p(Vn),j=r(Vn,"SPAN",{});var Ma=i(j);re=s(Ma,"LayoutLM"),Ma.forEach(o),Vn.forEach(o),Y=p(t),z=r(t,"A",{id:!0}),i(z).forEach(o),ae=p(t),I=r(t,"H2",{class:!0});var Xn=i(I);Z=r(Xn,"A",{id:!0,class:!0,href:!0});var $a=i(Z);ne=r($a,"SPAN",{});var xa=i(ne);w(A.$$.fragment,xa),xa.forEach(o),$a.forEach(o),ie=p(Xn),se=r(Xn,"SPAN",{});var ja=i(se);J=s(ja,"Overview"),ja.forEach(o),Xn.forEach(o),D=p(t),G=r(t,"P",{});var Yn=i(G);Q=s(Yn,"The LayoutLM model was proposed in the paper "),F=r(Yn,"A",{href:!0,rel:!0});var Fa=i(F);q=s(Fa,`LayoutLM: Pre-training of Text and Layout for Document Image
...
document-level pretraining. It achieves new state-of-the-art results in several downstream tasks, including form
understanding (from 70.72 to 79.27), receipt understanding (from 94.02 to 95.24) and document image classification
(from 93.07 to 94.42).`),Na.forEach(o),Pa.forEach(o),$e=p(t),O=r(t,"P",{});var Sa=i(O);K=s(Sa,"Tips:"),Sa.forEach(o),xe=p(t),ye=r(t,"UL",{});var _p=i(ye);P=r(_p,"LI",{});var Xe=i(P);ze=s(Xe,"In addition to "),ke=r(Xe,"EM",{});var yp=i(ke);ge=s(yp,"input_ids"),yp.forEach(o),Ee=s(Xe,", "),Qn=r(Xe,"A",{href:!0});var bp=i(Qn);Hr=s(bp,"forward()"),bp.forEach(o),Br=s(Xe," also expects the input "),Os=r(Xe,"CODE",{});var kp=i(Os);Rr=s(kp,"bbox"),kp.forEach(o),Kr=s(Xe,`, which are
the bounding boxes (i.e. 2D-positions) of the input tokens. These can be obtained using an external OCR engine such
...
(x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1) represents the
position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on a 0-1000
scale. To normalize, you can use the following function:`),Xe.forEach(o),_p.forEach(o),Da=p(t),w(Ft.$$.fragment,t),Aa=p(t),to=r(t,"P",{});var Ts=i(to);Gr=s(Ts,"Here, "),Is=r(Ts,"CODE",{});var Tp=i(Is);Jr=s(Tp,"width"),Tp.forEach(o),Qr=s(Ts," and "),Ds=r(Ts,"CODE",{});var vp=i(Ds);ei=s(vp,"height"),vp.forEach(o),oi=s(Ts,` correspond to the width and height of the original document in which the token
occurs. Those can be obtained using the Python Image Library (PIL) library for example, as follows:`),Ts.forEach(o),Ua=p(t),w(zt.$$.fragment,t),Wa=p(t),es=r(t,"UL",{});var Mp=i(es);eo=r(Mp,"LI",{});var ht=i(eo);ti=s(ht,"For a demo which shows how to fine-tune "),os=r(ht,"A",{href:!0});var $p=i(os);ni=s($p,"LayoutLMForTokenClassification"),$p.forEach(o),si=s(ht," on the "),Et=r(ht,"A",{href:!0,rel:!0});var xp=i(Et);ai=s(xp,"FUNSD dataset"),xp.forEach(o),ri=s(ht," (a collection of annotated forms), see "),qt=r(ht,"A",{href:!0,rel:!0});var jp=i(qt);ii=s(jp,"this notebook"),jp.forEach(o),li=s(ht,`.
It includes an inference part, which shows how to use Google\u2019s Tesseract on a new document.`),ht.forEach(o),Mp.forEach(o),Ha=p(t),no=r(t,"P",{});var vs=i(no);di=s(vs,"This model was contributed by "),Ct=r(vs,"A",{href:!0,rel:!0});var Fp=i(Ct);ci=s(Fp,"liminghao1630"),Fp.forEach(o),pi=s(vs,`. The original code can be found
`),Pt=r(vs,"A",{href:!0,rel:!0});var zp=i(Pt);ui=s(zp,"here"),zp.forEach(o),hi=s(vs,"."),vs.forEach(o),Ba=p(t),ro=r(t,"H2",{class:!0});var hr=i(ro);Co=r(hr,"A",{id:!0,class:!0,href:!0});var Ep=i(Co);As=r(Ep,"SPAN",{});var qp=i(As);w(Nt.$$.fragment,qp),qp.forEach(o),Ep.forEach(o),mi=p(hr),Us=r(hr,"SPAN",{});var Cp=i(Us);fi=s(Cp,"LayoutLMConfig"),Cp.forEach(o),hr.forEach(o),Ra=p(t),Pe=r(t,"DIV",{class:!0});var mt=i(Pe);w(St.$$.fragment,mt),gi=p(mt),io=r(mt,"P",{});var Ms=i(io);_i=s(Ms,"This is the configuration class to store the configuration of a "),ts=r(Ms,"A",{href:!0});var Pp=i(ts);yi=s(Pp,"LayoutLMModel"),Pp.forEach(o),bi=s(Ms,`. It is used to instantiate a
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),Ot=r(Ms,"A",{href:!0,rel:!0});var Np=i(Ot);ki=s(Np,"microsoft/layoutlm-base-uncased"),Np.forEach(o),Li=s(Ms," architecture."),Ms.forEach(o),wi=p(mt),lo=r(mt,"P",{});var $s=i(lo);Ti=s($s,"Configuration objects inherit from "),ns=r($s,"A",{href:!0});var Sp=i(ns);vi=s(Sp,"BertConfig"),Sp.forEach(o),Mi=s($s,` and can be used to control the model outputs. Read the
documentation from `),ss=r($s,"A",{href:!0});var Op=i(ss);$i=s(Op,"BertConfig"),Op.forEach(o),xi=s($s," for more information."),$s.forEach(o),ji=p(mt),w(Po.$$.fragment,mt),mt.forEach(o),Ka=p(t),co=r(t,"H2",{class:!0});var mr=i(co);No=r(mr,"A",{id:!0,class:!0,href:!0});var Ip=i(No);Ws=r(Ip,"SPAN",{});var Dp=i(Ws);w(It.$$.fragment,Dp),Dp.forEach(o),Ip.forEach(o),Fi=p(mr),Hs=r(mr,"SPAN",{});var Ap=i(Hs);zi=s(Ap,"LayoutLMTokenizer"),Ap.forEach(o),mr.forEach(o),Va=p(t),Ne=r(t,"DIV",{class:!0});var ft=i(Ne);w(Dt.$$.fragment,ft),Ei=p(ft),Bs=r(ft,"P",{});var Up=i(Bs);qi=s(Up,"Constructs a LayoutLM tokenizer."),Up.forEach(o),Ci=p(ft),So=r(ft,"P",{});var Oa=i(So);as=r(Oa,"A",{href:!0});var Wp=i(as);Pi=s(Wp,"LayoutLMTokenizer"),Wp.forEach(o),Ni=s(Oa," is identical to "),rs=r(Oa,"A",{href:!0});var Hp=i(rs);Si=s(Hp,"BertTokenizer"),Hp.forEach(o),Oi=s(Oa,` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),Oa.forEach(o),Ii=p(ft),At=r(ft,"P",{});var fr=i(At);Di=s(fr,"Refer to superclass "),is=r(fr,"A",{href:!0});var Bp=i(is);Ai=s(Bp,"BertTokenizer"),Bp.forEach(o),Ui=s(fr," for usage examples and documentation concerning parameters."),fr.forEach(o),ft.forEach(o),Xa=p(t),po=r(t,"H2",{class:!0});var gr=i(po);Oo=r(gr,"A",{id:!0,class:!0,href:!0});var Rp=i(Oo);Rs=r(Rp,"SPAN",{});var Kp=i(Rs);w(Ut.$$.fragment,Kp),Kp.forEach(o),Rp.forEach(o),Wi=p(gr),Ks=r(gr,"SPAN",{});var Vp=i(Ks);Hi=s(Vp,"LayoutLMTokenizerFast"),Vp.forEach(o),gr.forEach(o),Ya=p(t),Se=r(t,"DIV",{class:!0});var gt=i(Se);w(Wt.$$.fragment,gt),Bi=p(gt),Vs=r(gt,"P",{});var Xp=i(Vs);Ri=s(Xp,"Constructs a \u201CFast\u201D LayoutLMTokenizer."),Xp.forEach(o),Ki=p(gt),Io=r(gt,"P",{});var Ia=i(Io);ls=r(Ia,"A",{href:!0});var Yp=i(ls);Vi=s(Yp,"LayoutLMTokenizerFast"),Yp.forEach(o),Xi=s(Ia," is identical to "),ds=r(Ia,"A",{href:!0});var Zp=i(ds);Yi=s(Zp,"BertTokenizerFast"),Zp.forEach(o),Zi=s(Ia,` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),Ia.forEach(o),Gi=p(gt),Ht=r(gt,"P",{});var _r=i(Ht);Ji=s(_r,"Refer to superclass "),cs=r(_r,"A",{href:!0});var Gp=i(cs);Qi=s(Gp,"BertTokenizerFast"),Gp.forEach(o),el=s(_r," for usage examples and documentation concerning parameters."),_r.forEach(o),gt.forEach(o),Za=p(t),uo=r(t,"H2",{class:!0});var yr=i(uo);Do=r(yr,"A",{id:!0,class:!0,href:!0});var Jp=i(Do);Xs=r(Jp,"SPAN",{});var Qp=i(Xs);w(Bt.$$.fragment,Qp),Qp.forEach(o),Jp.forEach(o),ol=p(yr),Ys=r(yr,"SPAN",{});var eu=i(Ys);tl=s(eu,"LayoutLMModel"),eu.forEach(o),yr.forEach(o),Ga=p(t),Oe=r(t,"DIV",{class:!0});var _t=i(Oe);w(Rt.$$.fragment,_t),nl=p(_t),Kt=r(_t,"P",{});var br=i(Kt);sl=s(br,`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kr.forEach(o),pl=p(_t),Ae=r(_t,"DIV",{class:!0});var yt=i(Ae);w(Zt.$$.fragment,yt),ul=p(yt),ho=r(yt,"P",{});var xs=i(ho);hl=s(xs,"The "),ps=r(xs,"A",{href:!0});var nu=i(ps);ml=s(nu,"LayoutLMModel"),nu.forEach(o),fl=s(xs," forward method, overrides the "),Zs=r(xs,"CODE",{});var su=i(Zs);gl=s(su,"__call__"),su.forEach(o),_l=s(xs," special method."),xs.forEach(o),yl=p(yt),w(Ao.$$.fragment,yt),bl=p(yt),w(Uo.$$.fragment,yt),yt.forEach(o),_t.forEach(o),Ja=p(t),mo=r(t,"H2",{class:!0});var Lr=i(mo);Wo=r(Lr,"A",{id:!0,class:!0,href:!0});var au=i(Wo);Gs=r(au,"SPAN",{});var ru=i(Gs);w(Gt.$$.fragment,ru),ru.forEach(o),au.forEach(o),kl=p(Lr),Js=r(Lr,"SPAN",{});var iu=i(Js);Ll=s(iu,"LayoutLMForMaskedLM"),iu.forEach(o),Lr.forEach(o),Qa=p(t),Ie=r(t,"DIV",{class:!0});var bt=i(Ie);w(Jt.$$.fragment,bt),wl=p(bt),fo=r(bt,"P",{});var js=i(fo);Tl=s(js,"LayoutLM Model with a "),Qs=r(js,"CODE",{});var lu=i(Qs);vl=s(lu,"language modeling"),lu.forEach(o),Ml=s(js,` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$r.forEach(o),od=p(so),We=r(so,"DIV",{class:!0});var Lt=i(We);w(un.$$.fragment,Lt),td=p(Lt),yo=r(Lt,"P",{});var zs=i(yo);nd=s(zs,"The "),hs=r(zs,"A",{href:!0});var bu=i(hs);sd=s(bu,"LayoutLMForSequenceClassification"),bu.forEach(o),ad=s(zs," forward method, overrides the "),na=r(zs,"CODE",{});var ku=i(na);rd=s(ku,"__call__"),ku.forEach(o),id=s(zs," special method."),zs.forEach(o),ld=p(Lt),w(Ko.$$.fragment,Lt),dd=p(Lt),w(Vo.$$.fragment,Lt),Lt.forEach(o),so.forEach(o),tr=p(t),bo=r(t,"H2",{class:!0});var xr=i(bo);Xo=r(xr,"A",{id:!0,class:!0,href:!0});var Lu=i(Xo);sa=r(Lu,"SPAN",{});var wu=i(sa);w(hn.$$.fragment,wu),wu.forEach(o),Lu.forEach(o),cd=p(xr),aa=r(xr,"SPAN",{});var Tu=i(aa);pd=s(Tu,"LayoutLMForTokenClassification"),Tu.forEach(o),xr.forEach(o),nr=p(t),Ce=r(t,"DIV",{class:!0});var ao=i(Ce);w(mn.$$.fragment,ao),ud=p(ao),ko=r(ao,"P",{});var Es=i(ko);hd=s(Es,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
sequence labeling (information extraction) tasks such as the `),fn=r(Es,"A",{href:!0,rel:!0});var vu=i(fn);md=s(vu,"FUNSD"),vu.forEach(o),fd=s(Es,`
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fr.forEach(o),$d=p(ao),He=r(ao,"DIV",{class:!0});var wt=i(He);w(Ln.$$.fragment,wt),xd=p(wt),Lo=r(wt,"P",{});var qs=i(Lo);jd=s(qs,"The "),ms=r(qs,"A",{href:!0});var ju=i(ms);Fd=s(ju,"LayoutLMForTokenClassification"),ju.forEach(o),zd=s(qs," forward method, overrides the "),ra=r(qs,"CODE",{});var Fu=i(ra);Ed=s(Fu,"__call__"),Fu.forEach(o),qd=s(qs," special method."),qs.forEach(o),Cd=p(wt),w(Yo.$$.fragment,wt),Pd=p(wt),w(Zo.$$.fragment,wt),wt.forEach(o),ao.forEach(o),sr=p(t),wo=r(t,"H2",{class:!0});var zr=i(wo);Go=r(zr,"A",{id:!0,class:!0,href:!0});var zu=i(Go);ia=r(zu,"SPAN",{});var Eu=i(ia);w(wn.$$.fragment,Eu),Eu.forEach(o),zu.forEach(o),Nd=p(zr),la=r(zr,"SPAN",{});var qu=i(la);Sd=s(qu,"TFLayoutLMModel"),qu.forEach(o),zr.forEach(o),ar=p(t),Le=r(t,"DIV",{class:!0});var Ye=i(Le);w(Tn.$$.fragment,Ye),Od=p(Ye),da=r(Ye,"P",{});var Cu=i(da);Id=s(Cu,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Cu.forEach(o),Dd=p(Ye),vn=r(Ye,"P",{});var Er=i(vn);Ad=s(Er,"This model inherits from "),fs=r(Er,"A",{href:!0});var Pu=i(fs);Ud=s(Pu,"TFPreTrainedModel"),Pu.forEach(o),Wd=s(Er,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sr.forEach(o),_c=p(Ze),w(tt.$$.fragment,Ze),yc=p(Ze),Re=r(Ze,"DIV",{class:!0});var vt=i(Re);w(Pn.$$.fragment,vt),bc=p(vt),Mo=r(vt,"P",{});var Ps=i(Mo);kc=s(Ps,"The "),ys=r(Ps,"A",{href:!0});var Bu=i(ys);Lc=s(Bu,"TFLayoutLMForMaskedLM"),Bu.forEach(o),wc=s(Ps," forward method, overrides the "),ma=r(Ps,"CODE",{});var Ru=i(ma);Tc=s(Ru,"__call__"),Ru.forEach(o),vc=s(Ps," special method."),Ps.forEach(o),Mc=p(vt),w(nt.$$.fragment,vt),$c=p(vt),w(st.$$.fragment,vt),vt.forEach(o),Ze.forEach(o),lr=p(t),$o=r(t,"H2",{class:!0});var Or=i($o);at=r(Or,"A",{id:!0,class:!0,href:!0});var Ku=i(at);fa=r(Ku,"SPAN",{});var Vu=i(fa);w(Nn.$$.fragment,Vu),Vu.forEach(o),Ku.forEach(o),xc=p(Or),ga=r(Or,"SPAN",{});var Xu=i(ga);jc=s(Xu,"TFLayoutLMForSequenceClassification"),Xu.forEach(o),Or.forEach(o),dr=p(t),Te=r(t,"DIV",{class:!0});var Ge=i(Te);w(Sn.$$.fragment,Ge),Fc=p(Ge),_a=r(Ge,"P",{});var Yu=i(_a);zc=s(Yu,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Yu.forEach(o),Ec=p(Ge),On=r(Ge,"P",{});var Ir=i(On);qc=s(Ir,"This model inherits from "),bs=r(Ir,"A",{href:!0});var Zu=i(bs);Cc=s(Zu,"TFPreTrainedModel"),Zu.forEach(o),Pc=s(Ir,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ir.forEach(o),Nc=p(Ge),In=r(Ge,"P",{});var Dr=i(In);Sc=s(Dr,"This model is also a "),Dn=r(Dr,"A",{href:!0,rel:!0});var Gu=i(Dn);Oc=s(Gu,"tf.keras.Model"),Gu.forEach(o),Ic=s(Dr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dr.forEach(o),Dc=p(Ge),w(rt.$$.fragment,Ge),Ac=p(Ge),Ke=r(Ge,"DIV",{class:!0});var Mt=i(Ke);w(An.$$.fragment,Mt),Uc=p(Mt),xo=r(Mt,"P",{});var Ns=i(xo);Wc=s(Ns,"The "),ks=r(Ns,"A",{href:!0});var Ju=i(ks);Hc=s(Ju,"TFLayoutLMForSequenceClassification"),Ju.forEach(o),Bc=s(Ns," forward method, overrides the "),ya=r(Ns,"CODE",{});var Qu=i(ya);Rc=s(Qu,"__call__"),Qu.forEach(o),Kc=s(Ns," special method."),Ns.forEach(o),Vc=p(Mt),w(it.$$.fragment,Mt),Xc=p(Mt),w(lt.$$.fragment,Mt),Mt.forEach(o),Ge.forEach(o),cr=p(t),jo=r(t,"H2",{class:!0});var Ar=i(jo);dt=r(Ar,"A",{id:!0,class:!0,href:!0});var eh=i(dt);ba=r(eh,"SPAN",{});var oh=i(ba);w(Un.$$.fragment,oh),oh.forEach(o),eh.forEach(o),Yc=p(Ar),ka=r(Ar,"SPAN",{});var th=i(ka);Zc=s(th,"TFLayoutLMForTokenClassification"),th.forEach(o),Ar.forEach(o),pr=p(t),ve=r(t,"DIV",{class:!0});var Je=i(ve);w(Wn.$$.fragment,Je),Gc=p(Je),La=r(Je,"P",{});var nh=i(La);Jc=s(nh,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
