...
<a href="/docs/transformers/pr_15944/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15944/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_15944/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/modeling_utils.py#L601",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15944/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15944/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_15944/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15944/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_15944/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_15944/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_15944/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15944/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_15944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
post`),zk=r("."),Dk=l(),Jd=o("p"),Ak=r("Examples:"),Gk=l(),c(Ys.$$.fragment),Sk=l(),fe=o("div"),c(Ks.$$.fragment),Nk=l(),Qd=o("p"),Ck=r("Generates sequences for models with a language modeling head using greedy decoding."),Ik=l(),ep=o("p"),Bk=r("Examples:"),Wk=l(),c(Zs.$$.fragment),Uk=l(),be=o("div"),c(Js.$$.fragment),Hk=l(),tp=o("p"),Vk=r("Generates sequences for models with a language modeling head using beam search decoding."),Xk=l(),np=o("p"),Rk=r("Examples:"),Yk=l(),c(Qs.$$.fragment),Kk=l(),jn=o("div"),c(ea.$$.fragment),Zk=l(),ta=o("p"),Jk=r("Implement in subclasses of "),cr=o("a"),Qk=r("PreTrainedModel"),e4=r(" for custom behavior to prepare inputs in the generate method."),t4=l(),ve=o("div"),c(na.$$.fragment),n4=l(),op=o("p"),o4=r("Generates sequences for models with a language modeling head using multinomial sampling."),s4=l(),sp=o("p"),a4=r("Examples:"),r4=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),i4=l(),aa=o("p"),l4=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),d4=r("TFPreTrainedModel"),p4=r("."),c4=l(),$n=o("div"),c(ra.$$.fragment),m4=l(),ia=o("p"),u4=r("Implement in subclasses of "),ur=o("a"),g4=r("PreTrainedModel"),h4=r(" for custom behavior to adjust the logits in the generate method."),_4=l(),N=o("div"),c(la.$$.fragment),f4=l(),ap=o("p"),b4=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),v4=l(),da=o("p"),y4=r("Adapted in part from "),pa=o("a"),k4=r(`Facebook\u2019s XLM beam search
code`),x4=r("."),w4=l(),Ee=o("p"),T4=r("Apart from "),rp=o("code"),j4=r("input_ids"),$4=r(" and "),ip=o("code"),M4=r("attention_mask"),P4=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),E4=r("PretrainedConfig"),L4=r(` of the model. The default values indicated are the default
values of those config.`),q4=l(),ca=o("p"),F4=r("Most of these parameters are explained in more detail in "),ma=o("a"),O4=r(`this blog
post`),z4=r("."),D4=l(),lp=o("p"),A4=r("Examples:"),G4=l(),c(ua.$$.fragment),S4=l(),ye=o("div"),c(ga.$$.fragment),N4=l(),dp=o("p"),C4=r("Generates sequences for models with a language modeling head using greedy decoding."),I4=l(),pp=o("p"),B4=r("Examples:"),W4=l(),c(ha.$$.fragment),U4=l(),Mn=o("div"),c(_a.$$.fragment),H4=l(),fa=o("p"),V4=r("Implement in subclasses of "),hr=o("a"),X4=r("TFPreTrainedModel"),R4=r(" for custom behavior to prepare inputs in the generate method."),Y4=l(),ke=o("div"),c(ba.$$.fragment),K4=l(),cp=o("p"),Z4=r("Generates sequences for models with a language modeling head using multinomial sampling."),J4=l(),mp=o("p"),Q4=r("Examples:"),ex=l(),c(va.$$.fragment),ac=l(),Le=o("div"),c(ya.$$.fragment),tx=l(),ka=o("p"),nx=r("A class containing all of the functions supporting generation, to be used as a mixin in "),_r=o("a"),ox=r("FlaxPreTrainedModel"),sx=r("."),ax=l(),H=o("div"),c(xa.$$.fragment),rx=l(),up=o("p"),ix=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
post`),$j.forEach(t),zk=i(xm,"."),xm.forEach(t),Dk=d(je),Jd=s(je,"P",{});var Mj=a(Jd);Ak=i(Mj,"Examples:"),Mj.forEach(t),Gk=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sk=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),Nk=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);Ck=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),Ik=d(Sn),ep=s(Sn,"P",{});var Ej=a(ep);Bk=i(Ej,"Examples:"),Ej.forEach(t),Wk=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Uk=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hk=d(Nn),tp=s(Nn,"P",{});var Lj=a(tp);Vk=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),Xk=d(Nn),np=s(Nn,"P",{});var qj=a(np);Rk=i(qj,"Examples:"),qj.forEach(t),Yk=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kk=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zk=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jk=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Qk=i(Fj,"PreTrainedModel"),Fj.forEach(t),e4=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),t4=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),n4=d(Cn),op=s(Cn,"P",{});var Oj=a(op);o4=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),s4=d(Cn),sp=s(Cn,"P",{});var zj=a(sp);a4=i(zj,"Examples:"),zj.forEach(t),r4=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),i4=d(J),aa=s(J,"P",{});var jm=a(aa);l4=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var Dj=a(mr);d4=i(Dj,"TFPreTrainedModel"),Dj.forEach(t),p4=i(jm,"."),jm.forEach(t),c4=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),m4=d($m),ia=s($m,"P",{});var Mm=a(ia);u4=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);g4=i(Aj,"PreTrainedModel"),Aj.forEach(t),h4=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_4=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),f4=d(Q),ap=s(Q,"P",{});var Gj=a(ap);b4=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),Gj.forEach(t),v4=d(Q),da=s(Q,"P",{});var Pm=a(da);y4=i(Pm,"Adapted in part from "),pa=s(Pm,"A",{href:!0,rel:!0});var Sj=a(pa);k4=i(Sj,`Facebook\u2019s XLM beam search
code`),Sj.forEach(t),x4=i(Pm,"."),Pm.forEach(t),w4=d(Q),Ee=s(Q,"P",{});var In=a(Ee);T4=i(In,"Apart from "),rp=s(In,"CODE",{});var Nj=a(rp);j4=i(Nj,"input_ids"),Nj.forEach(t),$4=i(In," and "),ip=s(In,"CODE",{});var Cj=a(ip);M4=i(Cj,"attention_mask"),Cj.forEach(t),P4=i(In,`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=s(In,"A",{href:!0});var Ij=a(gr);E4=i(Ij,"PretrainedConfig"),Ij.forEach(t),L4=i(In,` of the model. The default values indicated are the default
values of those config.`),In.forEach(t),q4=d(Q),ca=s(Q,"P",{});var Em=a(ca);F4=i(Em,"Most of these parameters are explained in more detail in "),ma=s(Em,"A",{href:!0,rel:!0});var Bj=a(ma);O4=i(Bj,`this blog
post`),Bj.forEach(t),z4=i(Em,"."),Em.forEach(t),D4=d(Q),lp=s(Q,"P",{});var Wj=a(lp);A4=i(Wj,"Examples:"),Wj.forEach(t),G4=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),S4=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),N4=d(Bn),dp=s(Bn,"P",{});var Uj=a(dp);C4=i(Uj,"Generates sequences for models with a language modeling head using greedy decoding."),Uj.forEach(t),I4=d(Bn),pp=s(Bn,"P",{});var Hj=a(pp);B4=i(Hj,"Examples:"),Hj.forEach(t),W4=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),U4=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(_a.$$.fragment,Lm),H4=d(Lm),fa=s(Lm,"P",{});var qm=a(fa);V4=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var Vj=a(hr);X4=i(Vj,"TFPreTrainedModel"),Vj.forEach(t),R4=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Y4=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),K4=d(Wn),cp=s(Wn,"P",{});var Xj=a(cp);Z4=i(Xj,"Generates sequences for models with a language modeling head using multinomial sampling."),Xj.forEach(t),J4=d(Wn),mp=s(Wn,"P",{});var Rj=a(mp);Q4=i(Rj,"Examples:"),Rj.forEach(t),ex=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),tx=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nx=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Yj=a(_r);ox=i(Yj,"FlaxPreTrainedModel"),Yj.forEach(t),sx=i(Fm,"."),Fm.forEach(t),ax=d(Sr),H=s(Sr,"DIV",{class:!0});var $e=a(H);m(xa.$$.fragment,$e),rx=d($e),up=s($e,"P",{});var Kj=a(up);ix=i(Kj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
