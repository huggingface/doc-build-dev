...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15944/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),np=new y({}),{c(){w=o("meta"),M=u(),b=o("h1"),$=o("a"),ms=o("span"),f(F.$$.fragment),Nn=u(),_s=o("span"),vs=a("DeepSpeed Integration"),ht=u(),V=o("p"),Y=o("a"),Z=a("DeepSpeed"),yp=a(" implements everything described in the "),$e=o("a"),wp=a("ZeRO paper"),ZE=a(". Currently it provides full support for:"),pj=u(),D=o("ol"),Ch=o("li"),NE=a("Optimizer state partitioning (ZeRO stage 1)"),HE=u(),xh=o("li"),BE=a("Gradient partitioning (ZeRO stage 2)"),WE=u(),Rh=o("li"),FE=a("Parameter partitioning (ZeRO stage 3)"),VE=u(),Ih=o("li"),YE=a("Custom mixed precision training handling"),KE=u(),Uh=o("li"),JE=a("A range of fast CUDA-extension-based optimizers"),XE=u(),Gh=o("li"),QE=a("ZeRO-Offload to CPU and NVMe"),ij=u(),ke=o("p"),e4=a("ZeRO-Offload has its own dedicated paper: "),Hn=o("a"),s4=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),t4=a(". And NVMe-support is described in the paper "),Bn=o("a"),a4=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),n4=a("."),uj=u(),bp=o("p"),o4=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),cj=u(),qp=o("p"),l4=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),hj=u(),ft=o("p"),r4=a("\u{1F917} Transformers integrates "),Wn=o("a"),p4=a("DeepSpeed"),i4=a(" via 2 options:"),fj=u(),dt=o("ol"),Fn=o("li"),u4=a("Integration of the core DeepSpeed features via "),Ep=o("a"),c4=a("Trainer"),h4=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),f4=u(),L=o("li"),d4=a("If you don\u2019t use "),$p=o("a"),m4=a("Trainer"),_4=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Lh=o("code"),v4=a("from_pretrained"),j4=a(" and "),Mh=o("code"),g4=a("from_config"),y4=a(` include integration of essential
parts of DeepSpeed like `),Zh=o("code"),w4=a("zero.Init"),b4=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),kp=o("a"),q4=a("deepspeed-non-trainer-integration"),E4=a("."),dj=u(),Pp=o("p"),$4=a("What is integrated:"),mj=u(),zp=o("p"),k4=a("Training:"),_j=u(),Dp=o("ol"),Nh=o("li"),P4=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),vj=u(),Op=o("p"),z4=a("Inference:"),jj=u(),Tp=o("ol"),Vn=o("li"),D4=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Ap=o("a"),O4=a("deepspeed-zero-inference"),T4=a("."),gj=u(),Sp=o("p"),A4=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),yj=u(),Cp=o("a"),wj=u(),js=o("h2"),mt=o("a"),Hh=o("span"),f(Yn.$$.fragment),S4=u(),Bh=o("span"),C4=a("Trainer Deepspeed Integration"),bj=u(),xp=o("a"),qj=u(),gs=o("h3"),_t=o("a"),Wh=o("span"),f(Kn.$$.fragment),x4=u(),Fh=o("span"),R4=a("Installation"),Ej=u(),Rp=o("p"),I4=a("Install the library via pypi:"),$j=u(),f(Jn.$$.fragment),kj=u(),Pe=o("p"),U4=a("or via "),Vh=o("code"),G4=a("transformers"),L4=a("\u2019 "),Yh=o("code"),M4=a("extras"),Z4=a(":"),Pj=u(),f(Xn.$$.fragment),zj=u(),ze=o("p"),N4=a("or find more details on "),Qn=o("a"),H4=a("the DeepSpeed\u2019s GitHub page"),B4=a(` and
`),eo=o("a"),W4=a("advanced install"),F4=a("."),Dj=u(),vt=o("p"),V4=a("If you\u2019re still struggling with the build, first make sure to read "),Ip=o("a"),Y4=a("zero-install-notes"),K4=a("."),Oj=u(),Up=o("p"),J4=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Tj=u(),Gp=o("p"),X4=a("To make a local build for DeepSpeed:"),Aj=u(),f(so.$$.fragment),Sj=u(),De=o("p"),Q4=a("If you intend to use NVMe offload you will also need to include "),Kh=o("code"),e5=a("DS_BUILD_AIO=1"),s5=a(` in the instructions above (and also
...
following:`),eg=u(),$t=o("ol"),ws=o("li"),H5=a("replace "),cf=o("code"),B5=a("python -m torch.distributed.launch"),W5=a(" with "),hf=o("code"),F5=a("deepspeed"),V5=a("."),Y5=u(),ye=o("li"),K5=a("add a new argument "),ff=o("code"),J5=a("--deepspeed ds_config.json"),X5=a(", where "),df=o("code"),Q5=a("ds_config.json"),e$=a(` is the DeepSpeed configuration file as
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),hp=o("a"),NI=a("DeepSpeed GitHub"),HI=a("."),this.h()},l(e){const p=FV('[data-svelte="svelte-1phssyn"]',document.head);w=l(p,"META",{name:!0,content:!0}),p.forEach(t),M=c(e),b=l(e,"H1",{class:!0});var fp=r(b);$=l(fp,"A",{id:!0,class:!0,href:!0});var tj=r($);ms=l(tj,"SPAN",{});var KI=r(ms);d(F.$$.fragment,KI),KI.forEach(t),tj.forEach(t),Nn=c(fp),_s=l(fp,"SPAN",{});var JI=r(_s);vs=n(JI,"DeepSpeed Integration"),JI.forEach(t),fp.forEach(t),ht=c(e),V=l(e,"P",{});var aj=r(V);Y=l(aj,"A",{href:!0,rel:!0});var XI=r(Y);Z=n(XI,"DeepSpeed"),XI.forEach(t),yp=n(aj," implements everything described in the "),$e=l(aj,"A",{href:!0,rel:!0});var QI=r($e);wp=n(QI,"ZeRO paper"),QI.forEach(t),ZE=n(aj,". Currently it provides full support for:"),aj.forEach(t),pj=c(e),D=l(e,"OL",{});var ue=r(D);Ch=l(ue,"LI",{});var eU=r(Ch);NE=n(eU,"Optimizer state partitioning (ZeRO stage 1)"),eU.forEach(t),HE=c(ue),xh=l(ue,"LI",{});var sU=r(xh);BE=n(sU,"Gradient partitioning (ZeRO stage 2)"),sU.forEach(t),WE=c(ue),Rh=l(ue,"LI",{});var tU=r(Rh);FE=n(tU,"Parameter partitioning (ZeRO stage 3)"),tU.forEach(t),VE=c(ue),Ih=l(ue,"LI",{});var aU=r(Ih);YE=n(aU,"Custom mixed precision training handling"),aU.forEach(t),KE=c(ue),Uh=l(ue,"LI",{});var nU=r(Uh);JE=n(nU,"A range of fast CUDA-extension-based optimizers"),nU.forEach(t),XE=c(ue),Gh=l(ue,"LI",{});var oU=r(Gh);QE=n(oU,"ZeRO-Offload to CPU and NVMe"),oU.forEach(t),ue.forEach(t),ij=c(e),ke=l(e,"P",{});var Zc=r(ke);e4=n(Zc,"ZeRO-Offload has its own dedicated paper: "),Hn=l(Zc,"A",{href:!0,rel:!0});var lU=r(Hn);s4=n(lU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),lU.forEach(t),t4=n(Zc,". And NVMe-support is described in the paper "),Bn=l(Zc,"A",{href:!0,rel:!0});var rU=r(Bn);a4=n(rU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),rU.forEach(t),n4=n(Zc,"."),Zc.forEach(t),uj=c(e),bp=l(e,"P",{});var pU=r(bp);o4=n(pU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),pU.forEach(t),cj=c(e),qp=l(e,"P",{});var iU=r(qp);l4=n(iU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),iU.forEach(t),hj=c(e),ft=l(e,"P",{});var i0=r(ft);r4=n(i0,"\u{1F917} Transformers integrates "),Wn=l(i0,"A",{href:!0,rel:!0});var uU=r(Wn);p4=n(uU,"DeepSpeed"),uU.forEach(t),i4=n(i0," via 2 options:"),i0.forEach(t),fj=c(e),dt=l(e,"OL",{});var u0=r(dt);Fn=l(u0,"LI",{});var c0=r(Fn);u4=n(c0,"Integration of the core DeepSpeed features via "),Ep=l(c0,"A",{href:!0});var cU=r(Ep);c4=n(cU,"Trainer"),cU.forEach(t),h4=n(c0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),c0.forEach(t),f4=c(u0),L=l(u0,"LI",{});var ce=r(L);d4=n(ce,"If you don\u2019t use "),$p=l(ce,"A",{href:!0});var hU=r($p);m4=n(hU,"Trainer"),hU.forEach(t),_4=n(ce,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Lh=l(ce,"CODE",{});var fU=r(Lh);v4=n(fU,"from_pretrained"),fU.forEach(t),j4=n(ce," and "),Mh=l(ce,"CODE",{});var dU=r(Mh);g4=n(dU,"from_config"),dU.forEach(t),y4=n(ce,` include integration of essential
parts of DeepSpeed like `),Zh=l(ce,"CODE",{});var mU=r(Zh);w4=n(mU,"zero.Init"),mU.forEach(t),b4=n(ce,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),kp=l(ce,"A",{href:!0});var _U=r(kp);q4=n(_U,"deepspeed-non-trainer-integration"),_U.forEach(t),E4=n(ce,"."),ce.forEach(t),u0.forEach(t),dj=c(e),Pp=l(e,"P",{});var vU=r(Pp);$4=n(vU,"What is integrated:"),vU.forEach(t),mj=c(e),zp=l(e,"P",{});var jU=r(zp);k4=n(jU,"Training:"),jU.forEach(t),_j=c(e),Dp=l(e,"OL",{});var gU=r(Dp);Nh=l(gU,"LI",{});var yU=r(Nh);P4=n(yU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),yU.forEach(t),gU.forEach(t),vj=c(e),Op=l(e,"P",{});var wU=r(Op);z4=n(wU,"Inference:"),wU.forEach(t),jj=c(e),Tp=l(e,"OL",{});var bU=r(Tp);Vn=l(bU,"LI",{});var h0=r(Vn);D4=n(h0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Ap=l(h0,"A",{href:!0});var qU=r(Ap);O4=n(qU,"deepspeed-zero-inference"),qU.forEach(t),T4=n(h0,"."),h0.forEach(t),bU.forEach(t),gj=c(e),Sp=l(e,"P",{});var EU=r(Sp);A4=n(EU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),EU.forEach(t),yj=c(e),Cp=l(e,"A",{id:!0}),r(Cp).forEach(t),wj=c(e),js=l(e,"H2",{class:!0});var f0=r(js);mt=l(f0,"A",{id:!0,class:!0,href:!0});var $U=r(mt);Hh=l($U,"SPAN",{});var kU=r(Hh);d(Yn.$$.fragment,kU),kU.forEach(t),$U.forEach(t),S4=c(f0),Bh=l(f0,"SPAN",{});var PU=r(Bh);C4=n(PU,"Trainer Deepspeed Integration"),PU.forEach(t),f0.forEach(t),bj=c(e),xp=l(e,"A",{id:!0}),r(xp).forEach(t),qj=c(e),gs=l(e,"H3",{class:!0});var d0=r(gs);_t=l(d0,"A",{id:!0,class:!0,href:!0});var zU=r(_t);Wh=l(zU,"SPAN",{});var DU=r(Wh);d(Kn.$$.fragment,DU),DU.forEach(t),zU.forEach(t),x4=c(d0),Fh=l(d0,"SPAN",{});var OU=r(Fh);R4=n(OU,"Installation"),OU.forEach(t),d0.forEach(t),Ej=c(e),Rp=l(e,"P",{});var TU=r(Rp);I4=n(TU,"Install the library via pypi:"),TU.forEach(t),$j=c(e),d(Jn.$$.fragment,e),kj=c(e),Pe=l(e,"P",{});var Nc=r(Pe);U4=n(Nc,"or via "),Vh=l(Nc,"CODE",{});var AU=r(Vh);G4=n(AU,"transformers"),AU.forEach(t),L4=n(Nc,"\u2019 "),Yh=l(Nc,"CODE",{});var SU=r(Yh);M4=n(SU,"extras"),SU.forEach(t),Z4=n(Nc,":"),Nc.forEach(t),Pj=c(e),d(Xn.$$.fragment,e),zj=c(e),ze=l(e,"P",{});var Hc=r(ze);N4=n(Hc,"or find more details on "),Qn=l(Hc,"A",{href:!0,rel:!0});var CU=r(Qn);H4=n(CU,"the DeepSpeed\u2019s GitHub page"),CU.forEach(t),B4=n(Hc,` and
`),eo=l(Hc,"A",{href:!0,rel:!0});var xU=r(eo);W4=n(xU,"advanced install"),xU.forEach(t),F4=n(Hc,"."),Hc.forEach(t),Dj=c(e),vt=l(e,"P",{});var m0=r(vt);V4=n(m0,"If you\u2019re still struggling with the build, first make sure to read "),Ip=l(m0,"A",{href:!0});var RU=r(Ip);Y4=n(RU,"zero-install-notes"),RU.forEach(t),K4=n(m0,"."),m0.forEach(t),Oj=c(e),Up=l(e,"P",{});var IU=r(Up);J4=n(IU,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),IU.forEach(t),Tj=c(e),Gp=l(e,"P",{});var UU=r(Gp);X4=n(UU,"To make a local build for DeepSpeed:"),UU.forEach(t),Aj=c(e),d(so.$$.fragment,e),Sj=c(e),De=l(e,"P",{});var Bc=r(De);Q4=n(Bc,"If you intend to use NVMe offload you will also need to include "),Kh=l(Bc,"CODE",{});var GU=r(Kh);e5=n(GU,"DS_BUILD_AIO=1"),GU.forEach(t),s5=n(Bc,` in the instructions above (and also
