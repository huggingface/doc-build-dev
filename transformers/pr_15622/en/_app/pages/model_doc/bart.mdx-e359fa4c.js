...
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function Y1(j){let p,F,v,w,x,T,y,q,se,A,B,pe,ke,tt,ye,ve,ot,Ze,V,N,Ue,re,P,S,nt,he,ue,at,J,st,rt,L,Ce,Te,Ye,Z,ie,it,dt,X,lt,we,Re;return{c(){p=n("p"),F=r("TF 2.0 models accepts two formats as inputs:"),v=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=n("li"),se=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),B=n("p"),pe=r("This second option is useful when using "),ke=n("code"),tt=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ve=n("code"),ot=r("model(inputs)"),Ze=r("."),V=d(),N=n("p"),Ue=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=d(),P=n("ul"),S=n("li"),nt=r("a single Tensor with "),he=n("code"),ue=r("input_ids"),at=r(" only and nothing else: "),J=n("code"),st=r("model(input_ids)"),rt=d(),L=n("li"),Ce=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Te=n("code"),Ye=r("model([input_ids, attention_mask])"),Z=r(" or "),ie=n("code"),it=r("model([input_ids, attention_mask, token_type_ids])"),dt=d(),X=n("li"),lt=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),we=n("code"),Re=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=a(z,"P",{});var M=s(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),v=l(z),w=a(z,"UL",{});var H=s(w);x=a(H,"LI",{});var Dt=s(x);T=i(Dt,"having all inputs as keyword arguments (like PyTorch models), or"),Dt.forEach(t),y=l(H),q=a(H,"LI",{});var He=s(q);se=i(He,"having all inputs as a list, tuple or dict in the first positional arguments."),He.forEach(t),H.forEach(t),A=l(z),B=a(z,"P",{});var de=s(B);pe=i(de,"This second option is useful when using "),ke=a(de,"CODE",{});var Gt=s(ke);tt=i(Gt,"tf.keras.Model.fit"),Gt.forEach(t),ye=i(de,` method which currently requires having all the
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/configuration_bart.py#L35"}}),An=new C({props:{code:`from transformers import BartModel, BartConfig
...
other word. (BART tokenizer detect beginning of words by the preceding space).`,name:"add_prefix_space"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/tokenization_bart.py#L101"}}),In=new C({props:{code:`from transformers import BartTokenizer
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/tokenization_bart.py#L390",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
Whether the post processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/tokenization_bart_fast.py#L70"}}),Xn=new C({props:{code:`from transformers import BartTokenizerFast
...
[0, 31414, 232, 2]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[0, 20920, 232, 2]`}}),Lo=new je({props:{$$slots:{default:[H1]},$$scope:{ctx:j}}}),Yn=new $({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_bart.py#L1168",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15622/en/model_doc/bart#transformers.BartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_bart.py#L1307",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_bart.py#L1450",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_bart.py#L1576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_bart.py#L1725",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_tf_bart.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_tf_bart.py#L1251",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),on=new je({props:{$$slots:{default:[ew]},$$scope:{ctx:j}}}),Xa=new C({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),Za=new Q({}),Ya=new $({props:{name:"class transformers.FlaxBartModel",anchor:"transformers.FlaxBartModel",parameters:[{name:"config",val:": BartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15622/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15622/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxBartModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1164",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
`}}),an=new je({props:{$$slots:{default:[tw]},$$scope:{ctx:j}}}),ds=new C({props:{code:`from transformers import BartTokenizer, FlaxBartModel
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L987",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1050",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),us=new Q({}),ms=new $({props:{name:"class transformers.FlaxBartForConditionalGeneration",anchor:"transformers.FlaxBartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15622/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1164",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),rn=new je({props:{$$slots:{default:[ow]},$$scope:{ctx:j}}}),ws=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1319",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1164",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
`}}),ln=new je({props:{$$slots:{default:[nw]},$$scope:{ctx:j}}}),Ns=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1164",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
`}}),pn=new je({props:{$$slots:{default:[aw]},$$scope:{ctx:j}}}),er=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/bart/modeling_flax_bart.py#L1789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),un=new je({props:{$$slots:{default:[sw]},$$scope:{ctx:j}}}),fr=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForCausalLM
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),fm=l(gn),Pe=a(gn,"DIV",{class:!0});var Ct=s(Pe);f(sa.$$.fragment,Ct),_m=l(Ct),no=a(Ct,"P",{});var ai=s(no);gm=i(ai,"The "),Er=a(ai,"A",{href:!0});var Kv=s(Er);bm=i(Kv,"BartModel"),Kv.forEach(t),km=i(ai," forward method, overrides the "),id=a(ai,"CODE",{});var Zv=s(id);ym=i(Zv,"__call__"),Zv.forEach(t),vm=i(ai," special method."),ai.forEach(t),Tm=l(Ct),f(Wo.$$.fragment,Ct),wm=l(Ct),dd=a(Ct,"P",{});var Yv=s(dd);xm=i(Yv,"Example:"),Yv.forEach(t),Fm=l(Ct),f(ra.$$.fragment,Ct),Ct.forEach(t),gn.forEach(t),bc=l(o),ao=a(o,"H2",{class:!0});var dp=s(ao);Uo=a(dp,"A",{id:!0,class:!0,href:!0});var e2=s(Uo);ld=a(e2,"SPAN",{});var t2=s(ld);f(ia.$$.fragment,t2),t2.forEach(t),e2.forEach(t),zm=l(dp),cd=a(dp,"SPAN",{});var o2=s(cd);qm=i(o2,"BartForConditionalGeneration"),o2.forEach(t),dp.forEach(t),kc=l(o),Ke=a(o,"DIV",{class:!0});var bn=s(Ke);f(da.$$.fragment,bn),$m=l(bn),la=a(bn,"P",{});var lp=s(la);Bm=i(lp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Pr=a(lp,"A",{href:!0});var n2=s(Pr);jm=i(n2,"PreTrainedModel"),n2.forEach(t),Cm=i(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Mm=l(bn),ca=a(bn,"P",{});var cp=s(ca);Em=i(cp,"This model is also a PyTorch "),pa=a(cp,"A",{href:!0,rel:!0});var a2=s(pa);Pm=i(a2,"torch.nn.Module"),a2.forEach(t),Am=i(cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),Sm=l(bn),Y=a(bn,"DIV",{class:!0});var Le=s(Y);f(ha.$$.fragment,Le),Om=l(Le),so=a(Le,"P",{});var si=s(so);Im=i(si,"The "),Ar=a(si,"A",{href:!0});var s2=s(Ar);Nm=i(s2,"BartForConditionalGeneration"),s2.forEach(t),Lm=i(si," forward method, overrides the "),pd=a(si,"CODE",{});var r2=s(pd);Dm=i(r2,"__call__"),r2.forEach(t),Gm=i(si," special method."),si.forEach(t),Wm=l(Le),f(Ro.$$.fragment,Le),Um=l(Le),hd=a(Le,"P",{});var i2=s(hd);Rm=i(i2,"Summarization example:"),i2.forEach(t),Hm=l(Le),f(ua.$$.fragment,Le),Qm=l(Le),ud=a(Le,"P",{});var d2=s(ud);Vm=i(d2,"Mask filling example:"),d2.forEach(t),Jm=l(Le),f(ma.$$.fragment,Le),Le.forEach(t),bn.forEach(t),yc=l(o),ro=a(o,"H2",{class:!0});var pp=s(ro);Ho=a(pp,"A",{id:!0,class:!0,href:!0});var l2=s(Ho);md=a(l2,"SPAN",{});var c2=s(md);f(fa.$$.fragment,c2),c2.forEach(t),l2.forEach(t),Xm=l(pp),fd=a(pp,"SPAN",{});var p2=s(fd);Km=i(p2,"BartForSequenceClassification"),p2.forEach(t),pp.forEach(t),vc=l(o),ze=a(o,"DIV",{class:!0});var Mt=s(ze);f(_a.$$.fragment,Mt),Zm=l(Mt),_d=a(Mt,"P",{});var h2=s(_d);Ym=i(h2,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),h2.forEach(t),ef=l(Mt),ga=a(Mt,"P",{});var hp=s(ga);tf=i(hp,"This model inherits from "),Sr=a(hp,"A",{href:!0});var u2=s(Sr);of=i(u2,"PreTrainedModel"),u2.forEach(t),nf=i(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),af=l(Mt),ba=a(Mt,"P",{});var up=s(ba);sf=i(up,"This model is also a PyTorch "),ka=a(up,"A",{href:!0,rel:!0});var m2=s(ka);rf=i(m2,"torch.nn.Module"),m2.forEach(t),df=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),lf=l(Mt),D=a(Mt,"DIV",{class:!0});var oe=s(D);f(ya.$$.fragment,oe),cf=l(oe),io=a(oe,"P",{});var ri=s(io);pf=i(ri,"The "),Or=a(ri,"A",{href:!0});var f2=s(Or);hf=i(f2,"BartForSequenceClassification"),f2.forEach(t),uf=i(ri," forward method, overrides the "),gd=a(ri,"CODE",{});var _2=s(gd);mf=i(_2,"__call__"),_2.forEach(t),ff=i(ri," special method."),ri.forEach(t),_f=l(oe),f(Qo.$$.fragment,oe),gf=l(oe),bd=a(oe,"P",{});var g2=s(bd);bf=i(g2,"Example of single-label classification:"),g2.forEach(t),kf=l(oe),f(va.$$.fragment,oe),yf=l(oe),f(Ta.$$.fragment,oe),vf=l(oe),kd=a(oe,"P",{});var b2=s(kd);Tf=i(b2,"Example of multi-label classification:"),b2.forEach(t),wf=l(oe),f(wa.$$.fragment,oe),xf=l(oe),f(xa.$$.fragment,oe),oe.forEach(t),Mt.forEach(t),Tc=l(o),lo=a(o,"H2",{class:!0});var mp=s(lo);Vo=a(mp,"A",{id:!0,class:!0,href:!0});var k2=s(Vo);yd=a(k2,"SPAN",{});var y2=s(yd);f(Fa.$$.fragment,y2),y2.forEach(t),k2.forEach(t),Ff=l(mp),vd=a(mp,"SPAN",{});var v2=s(vd);zf=i(v2,"BartForQuestionAnswering"),v2.forEach(t),mp.forEach(t),wc=l(o),qe=a(o,"DIV",{class:!0});var Et=s(qe);f(za.$$.fragment,Et),qf=l(Et),co=a(Et,"P",{});var ii=s(co);$f=i(ii,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Td=a(ii,"CODE",{});var T2=s(Td);Bf=i(T2,"span start logits"),T2.forEach(t),jf=i(ii," and "),wd=a(ii,"CODE",{});var w2=s(wd);Cf=i(w2,"span end logits"),w2.forEach(t),Mf=i(ii,")."),ii.forEach(t),Ef=l(Et),qa=a(Et,"P",{});var fp=s(qa);Pf=i(fp,"This model inherits from "),Ir=a(fp,"A",{href:!0});var x2=s(Ir);Af=i(x2,"PreTrainedModel"),x2.forEach(t),Sf=i(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),Of=l(Et),$a=a(Et,"P",{});var _p=s($a);If=i(_p,"This model is also a PyTorch "),Ba=a(_p,"A",{href:!0,rel:!0});var F2=s(Ba);Nf=i(F2,"torch.nn.Module"),F2.forEach(t),Lf=i(_p,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),Df=l(Et),fe=a(Et,"DIV",{class:!0});var et=s(fe);f(ja.$$.fragment,et),Gf=l(et),po=a(et,"P",{});var di=s(po);Wf=i(di,"The "),Nr=a(di,"A",{href:!0});var z2=s(Nr);Uf=i(z2,"BartForQuestionAnswering"),z2.forEach(t),Rf=i(di," forward method, overrides the "),xd=a(di,"CODE",{});var q2=s(xd);Hf=i(q2,"__call__"),q2.forEach(t),Qf=i(di," special method."),di.forEach(t),Vf=l(et),f(Jo.$$.fragment,et),Jf=l(et),Fd=a(et,"P",{});var $2=s(Fd);Xf=i($2,"Example:"),$2.forEach(t),Kf=l(et),f(Ca.$$.fragment,et),Zf=l(et),f(Ma.$$.fragment,et),et.forEach(t),Et.forEach(t),xc=l(o),ho=a(o,"H2",{class:!0});var gp=s(ho);Xo=a(gp,"A",{id:!0,class:!0,href:!0});var B2=s(Xo);zd=a(B2,"SPAN",{});var j2=s(zd);f(Ea.$$.fragment,j2),j2.forEach(t),B2.forEach(t),Yf=l(gp),qd=a(gp,"SPAN",{});var C2=s(qd);e_=i(C2,"BartForCausalLM"),C2.forEach(t),gp.forEach(t),Fc=l(o),uo=a(o,"DIV",{class:!0});var bp=s(uo);f(Pa.$$.fragment,bp),t_=l(bp),yt=a(bp,"DIV",{class:!0});var li=s(yt);f(Aa.$$.fragment,li),o_=l(li),$d=a(li,"P",{});var M2=s($d);n_=i(M2,"Example:"),M2.forEach(t),a_=l(li),f(Sa.$$.fragment,li),li.forEach(t),bp.forEach(t),zc=l(o),mo=a(o,"H2",{class:!0});var kp=s(mo);Ko=a(kp,"A",{id:!0,class:!0,href:!0});var E2=s(Ko);Bd=a(E2,"SPAN",{});var P2=s(Bd);f(Oa.$$.fragment,P2),P2.forEach(t),E2.forEach(t),s_=l(kp),jd=a(kp,"SPAN",{});var A2=s(jd);r_=i(A2,"TFBartModel"),A2.forEach(t),kp.forEach(t),qc=l(o),$e=a(o,"DIV",{class:!0});var Pt=s($e);f(Ia.$$.fragment,Pt),i_=l(Pt),Na=a(Pt,"P",{});var yp=s(Na);d_=i(yp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Lr=a(yp,"A",{href:!0});var S2=s(Lr);l_=i(S2,"TFPreTrainedModel"),S2.forEach(t),c_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),p_=l(Pt),La=a(Pt,"P",{});var vp=s(La);h_=i(vp,"This model is also a "),Da=a(vp,"A",{href:!0,rel:!0});var O2=s(Da);u_=i(O2,"tf.keras.Model"),O2.forEach(t),m_=i(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),f_=l(Pt),f(Zo.$$.fragment,Pt),__=l(Pt),Ae=a(Pt,"DIV",{class:!0});var At=s(Ae);f(Ga.$$.fragment,At),g_=l(At),fo=a(At,"P",{});var ci=s(fo);b_=i(ci,"The "),Dr=a(ci,"A",{href:!0});var I2=s(Dr);k_=i(I2,"TFBartModel"),I2.forEach(t),y_=i(ci," forward method, overrides the "),Cd=a(ci,"CODE",{});var N2=s(Cd);v_=i(N2,"__call__"),N2.forEach(t),T_=i(ci," special method."),ci.forEach(t),w_=l(At),f(Yo.$$.fragment,At),x_=l(At),Md=a(At,"P",{});var L2=s(Md);F_=i(L2,"Example:"),L2.forEach(t),z_=l(At),f(Wa.$$.fragment,At),At.forEach(t),Pt.forEach(t),$c=l(o),_o=a(o,"H2",{class:!0});var Tp=s(_o);en=a(Tp,"A",{id:!0,class:!0,href:!0});var D2=s(en);Ed=a(D2,"SPAN",{});var G2=s(Ed);f(Ua.$$.fragment,G2),G2.forEach(t),D2.forEach(t),q_=l(Tp),Pd=a(Tp,"SPAN",{});var W2=s(Pd);$_=i(W2,"TFBartForConditionalGeneration"),W2.forEach(t),Tp.forEach(t),Bc=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(Ra.$$.fragment,St),B_=l(St),Ha=a(St,"P",{});var wp=s(Ha);j_=i(wp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(wp,"A",{href:!0});var U2=s(Gr);C_=i(U2,"TFPreTrainedModel"),U2.forEach(t),M_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),E_=l(St),Qa=a(St,"P",{});var xp=s(Qa);P_=i(xp,"This model is also a "),Va=a(xp,"A",{href:!0,rel:!0});var R2=s(Va);A_=i(R2,"tf.keras.Model"),R2.forEach(t),S_=i(xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xp.forEach(t),O_=l(St),f(tn.$$.fragment,St),I_=l(St),ee=a(St,"DIV",{class:!0});var De=s(ee);f(Ja.$$.fragment,De),N_=l(De),go=a(De,"P",{});var pi=s(go);L_=i(pi,"The "),Wr=a(pi,"A",{href:!0});var H2=s(Wr);D_=i(H2,"TFBartForConditionalGeneration"),H2.forEach(t),G_=i(pi," forward method, overrides the "),Ad=a(pi,"CODE",{});var Q2=s(Ad);W_=i(Q2,"__call__"),Q2.forEach(t),U_=i(pi," special method."),pi.forEach(t),R_=l(De),f(on.$$.fragment,De),H_=l(De),Sd=a(De,"P",{});var V2=s(Sd);Q_=i(V2,"Summarization example:"),V2.forEach(t),V_=l(De),f(Xa.$$.fragment,De),J_=l(De),Od=a(De,"P",{});var J2=s(Od);X_=i(J2,"Mask filling example:"),J2.forEach(t),K_=l(De),f(Ka.$$.fragment,De),De.forEach(t),St.forEach(t),jc=l(o),bo=a(o,"H2",{class:!0});var Fp=s(bo);nn=a(Fp,"A",{id:!0,class:!0,href:!0});var X2=s(nn);Id=a(X2,"SPAN",{});var K2=s(Id);f(Za.$$.fragment,K2),K2.forEach(t),X2.forEach(t),Z_=l(Fp),Nd=a(Fp,"SPAN",{});var Z2=s(Nd);Y_=i(Z2,"FlaxBartModel"),Z2.forEach(t),Fp.forEach(t),Cc=l(o),U=a(o,"DIV",{class:!0});var ge=s(U);f(Ya.$$.fragment,ge),eg=l(ge),es=a(ge,"P",{});var zp=s(es);tg=i(zp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Ur=a(zp,"A",{href:!0});var Y2=s(Ur);og=i(Y2,"FlaxPreTrainedModel"),Y2.forEach(t),ng=i(zp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zp.forEach(t),ag=l(ge),ts=a(ge,"P",{});var qp=s(ts);sg=i(qp,`This model is also a Flax Linen
`),os=a(qp,"A",{href:!0,rel:!0});var eT=s(os);rg=i(eT,"flax.nn.Module"),eT.forEach(t),ig=i(qp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),qp.forEach(t),dg=l(ge),Ld=a(ge,"P",{});var tT=s(Ld);lg=i(tT,"Finally, this model supports inherent JAX features such as:"),tT.forEach(t),cg=l(ge),ht=a(ge,"UL",{});var kn=s(ht);Dd=a(kn,"LI",{});var oT=s(Dd);ns=a(oT,"A",{href:!0,rel:!0});var nT=s(ns);pg=i(nT,"Just-In-Time (JIT) compilation"),nT.forEach(t),oT.forEach(t),hg=l(kn),Gd=a(kn,"LI",{});var aT=s(Gd);as=a(aT,"A",{href:!0,rel:!0});var sT=s(as);ug=i(sT,"Automatic Differentiation"),sT.forEach(t),aT.forEach(t),mg=l(kn),Wd=a(kn,"LI",{});var rT=s(Wd);ss=a(rT,"A",{href:!0,rel:!0});var iT=s(ss);fg=i(iT,"Vectorization"),iT.forEach(t),rT.forEach(t),_g=l(kn),Ud=a(kn,"LI",{});var dT=s(Ud);rs=a(dT,"A",{href:!0,rel:!0});var lT=s(rs);gg=i(lT,"Parallelization"),lT.forEach(t),dT.forEach(t),kn.forEach(t),bg=l(ge),Se=a(ge,"DIV",{class:!0});var Ot=s(Se);f(is.$$.fragment,Ot),kg=l(Ot),ko=a(Ot,"P",{});var hi=s(ko);yg=i(hi,"The "),Rd=a(hi,"CODE",{});var cT=s(Rd);vg=i(cT,"FlaxBartPreTrainedModel"),cT.forEach(t),Tg=i(hi," forward method, overrides the "),Hd=a(hi,"CODE",{});var pT=s(Hd);wg=i(pT,"__call__"),pT.forEach(t),xg=i(hi," special method."),hi.forEach(t),Fg=l(Ot),f(an.$$.fragment,Ot),zg=l(Ot),Qd=a(Ot,"P",{});var hT=s(Qd);qg=i(hT,"Example:"),hT.forEach(t),$g=l(Ot),f(ds.$$.fragment,Ot),Ot.forEach(t),Bg=l(ge),vt=a(ge,"DIV",{class:!0});var ui=s(vt);f(ls.$$.fragment,ui),jg=l(ui),Vd=a(ui,"P",{});var uT=s(Vd);Cg=i(uT,"Example:"),uT.forEach(t),Mg=l(ui),f(cs.$$.fragment,ui),ui.forEach(t),Eg=l(ge),Tt=a(ge,"DIV",{class:!0});var mi=s(Tt);f(ps.$$.fragment,mi),Pg=l(mi),Jd=a(mi,"P",{});var mT=s(Jd);Ag=i(mT,"Example:"),mT.forEach(t),Sg=l(mi),f(hs.$$.fragment,mi),mi.forEach(t),ge.forEach(t),Mc=l(o),yo=a(o,"H2",{class:!0});var $p=s(yo);sn=a($p,"A",{id:!0,class:!0,href:!0});var fT=s(sn);Xd=a(fT,"SPAN",{});var _T=s(Xd);f(us.$$.fragment,_T),_T.forEach(t),fT.forEach(t),Og=l($p),Kd=a($p,"SPAN",{});var gT=s(Kd);Ig=i(gT,"FlaxBartForConditionalGeneration"),gT.forEach(t),$p.forEach(t),Ec=l(o),R=a(o,"DIV",{class:!0});var be=s(R);f(ms.$$.fragment,be),Ng=l(be),fs=a(be,"P",{});var Bp=s(fs);Lg=i(Bp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rr=a(Bp,"A",{href:!0});var bT=s(Rr);Dg=i(bT,"FlaxPreTrainedModel"),bT.forEach(t),Gg=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bp.forEach(t),Wg=l(be),_s=a(be,"P",{});var jp=s(_s);Ug=i(jp,`This model is also a Flax Linen
`),gs=a(jp,"A",{href:!0,rel:!0});var kT=s(gs);Rg=i(kT,"flax.nn.Module"),kT.forEach(t),Hg=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(be),Zd=a(be,"P",{});var yT=s(Zd);Vg=i(yT,"Finally, this model supports inherent JAX features such as:"),yT.forEach(t),Jg=l(be),ut=a(be,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var vT=s(Yd);bs=a(vT,"A",{href:!0,rel:!0});var TT=s(bs);Xg=i(TT,"Just-In-Time (JIT) compilation"),TT.forEach(t),vT.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var wT=s(el);ks=a(wT,"A",{href:!0,rel:!0});var xT=s(ks);Zg=i(xT,"Automatic Differentiation"),xT.forEach(t),wT.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var FT=s(tl);ys=a(FT,"A",{href:!0,rel:!0});var zT=s(ys);eb=i(zT,"Vectorization"),zT.forEach(t),FT.forEach(t),tb=l(yn),ol=a(yn,"LI",{});var qT=s(ol);vs=a(qT,"A",{href:!0,rel:!0});var $T=s(vs);ob=i($T,"Parallelization"),$T.forEach(t),qT.forEach(t),yn.forEach(t),nb=l(be),te=a(be,"DIV",{class:!0});var Ge=s(te);f(Ts.$$.fragment,Ge),ab=l(Ge),vo=a(Ge,"P",{});var fi=s(vo);sb=i(fi,"The "),nl=a(fi,"CODE",{});var BT=s(nl);rb=i(BT,"FlaxBartPreTrainedModel"),BT.forEach(t),ib=i(fi," forward method, overrides the "),al=a(fi,"CODE",{});var jT=s(al);db=i(jT,"__call__"),jT.forEach(t),lb=i(fi," special method."),fi.forEach(t),cb=l(Ge),f(rn.$$.fragment,Ge),pb=l(Ge),sl=a(Ge,"P",{});var CT=s(sl);hb=i(CT,"Summarization example:"),CT.forEach(t),ub=l(Ge),f(ws.$$.fragment,Ge),mb=l(Ge),rl=a(Ge,"P",{});var MT=s(rl);fb=i(MT,"Mask filling example:"),MT.forEach(t),_b=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gb=l(be),wt=a(be,"DIV",{class:!0});var _i=s(wt);f(Fs.$$.fragment,_i),bb=l(_i),il=a(_i,"P",{});var ET=s(il);kb=i(ET,"Example:"),ET.forEach(t),yb=l(_i),f(zs.$$.fragment,_i),_i.forEach(t),vb=l(be),xt=a(be,"DIV",{class:!0});var gi=s(xt);f(qs.$$.fragment,gi),Tb=l(gi),dl=a(gi,"P",{});var PT=s(dl);wb=i(PT,"Example:"),PT.forEach(t),xb=l(gi),f($s.$$.fragment,gi),gi.forEach(t),be.forEach(t),Pc=l(o),To=a(o,"H2",{class:!0});var Cp=s(To);dn=a(Cp,"A",{id:!0,class:!0,href:!0});var AT=s(dn);ll=a(AT,"SPAN",{});var ST=s(ll);f(Bs.$$.fragment,ST),ST.forEach(t),AT.forEach(t),Fb=l(Cp),cl=a(Cp,"SPAN",{});var OT=s(cl);zb=i(OT,"FlaxBartForSequenceClassification"),OT.forEach(t),Cp.forEach(t),Ac=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);f(js.$$.fragment,ne),qb=l(ne),pl=a(ne,"P",{});var IT=s(pl);$b=i(IT,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),IT.forEach(t),Bb=l(ne),Cs=a(ne,"P",{});var Mp=s(Cs);jb=i(Mp,"This model inherits from "),Hr=a(Mp,"A",{href:!0});var NT=s(Hr);Cb=i(NT,"FlaxPreTrainedModel"),NT.forEach(t),Mb=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),Eb=l(ne),Ms=a(ne,"P",{});var Ep=s(Ms);Pb=i(Ep,`This model is also a Flax Linen
`),Es=a(Ep,"A",{href:!0,rel:!0});var LT=s(Es);Ab=i(LT,"flax.nn.Module"),LT.forEach(t),Sb=i(Ep,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ep.forEach(t),Ob=l(ne),hl=a(ne,"P",{});var DT=s(hl);Ib=i(DT,"Finally, this model supports inherent JAX features such as:"),DT.forEach(t),Nb=l(ne),mt=a(ne,"UL",{});var vn=s(mt);ul=a(vn,"LI",{});var GT=s(ul);Ps=a(GT,"A",{href:!0,rel:!0});var WT=s(Ps);Lb=i(WT,"Just-In-Time (JIT) compilation"),WT.forEach(t),GT.forEach(t),Db=l(vn),ml=a(vn,"LI",{});var UT=s(ml);As=a(UT,"A",{href:!0,rel:!0});var RT=s(As);Gb=i(RT,"Automatic Differentiation"),RT.forEach(t),UT.forEach(t),Wb=l(vn),fl=a(vn,"LI",{});var HT=s(fl);Ss=a(HT,"A",{href:!0,rel:!0});var QT=s(Ss);Ub=i(QT,"Vectorization"),QT.forEach(t),HT.forEach(t),Rb=l(vn),_l=a(vn,"LI",{});var VT=s(_l);Os=a(VT,"A",{href:!0,rel:!0});var JT=s(Os);Hb=i(JT,"Parallelization"),JT.forEach(t),VT.forEach(t),vn.forEach(t),Qb=l(ne),Oe=a(ne,"DIV",{class:!0});var It=s(Oe);f(Is.$$.fragment,It),Vb=l(It),wo=a(It,"P",{});var bi=s(wo);Jb=i(bi,"The "),gl=a(bi,"CODE",{});var XT=s(gl);Xb=i(XT,"FlaxBartPreTrainedModel"),XT.forEach(t),Kb=i(bi," forward method, overrides the "),bl=a(bi,"CODE",{});var KT=s(bl);Zb=i(KT,"__call__"),KT.forEach(t),Yb=i(bi," special method."),bi.forEach(t),ek=l(It),f(ln.$$.fragment,It),tk=l(It),kl=a(It,"P",{});var ZT=s(kl);ok=i(ZT,"Example:"),ZT.forEach(t),nk=l(It),f(Ns.$$.fragment,It),It.forEach(t),ak=l(ne),Ft=a(ne,"DIV",{class:!0});var ki=s(Ft);f(Ls.$$.fragment,ki),sk=l(ki),yl=a(ki,"P",{});var YT=s(yl);rk=i(YT,"Example:"),YT.forEach(t),ik=l(ki),f(Ds.$$.fragment,ki),ki.forEach(t),dk=l(ne),zt=a(ne,"DIV",{class:!0});var yi=s(zt);f(Gs.$$.fragment,yi),lk=l(yi),vl=a(yi,"P",{});var e1=s(vl);ck=i(e1,"Example:"),e1.forEach(t),pk=l(yi),f(Ws.$$.fragment,yi),yi.forEach(t),ne.forEach(t),Sc=l(o),xo=a(o,"H2",{class:!0});var Pp=s(xo);cn=a(Pp,"A",{id:!0,class:!0,href:!0});var t1=s(cn);Tl=a(t1,"SPAN",{});var o1=s(Tl);f(Us.$$.fragment,o1),o1.forEach(t),t1.forEach(t),hk=l(Pp),wl=a(Pp,"SPAN",{});var n1=s(wl);uk=i(n1,"FlaxBartForQuestionAnswering"),n1.forEach(t),Pp.forEach(t),Oc=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);f(Rs.$$.fragment,ae),mk=l(ae),Fo=a(ae,"P",{});var vi=s(Fo);fk=i(vi,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),xl=a(vi,"CODE",{});var a1=s(xl);_k=i(a1,"span start logits"),a1.forEach(t),gk=i(vi," and "),Fl=a(vi,"CODE",{});var s1=s(Fl);bk=i(s1,"span end logits"),s1.forEach(t),kk=i(vi,")."),vi.forEach(t),yk=l(ae),Hs=a(ae,"P",{});var Ap=s(Hs);vk=i(Ap,"This model inherits from "),Qr=a(Ap,"A",{href:!0});var r1=s(Qr);Tk=i(r1,"FlaxPreTrainedModel"),r1.forEach(t),wk=i(Ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ap.forEach(t),xk=l(ae),Qs=a(ae,"P",{});var Sp=s(Qs);Fk=i(Sp,`This model is also a Flax Linen
`),Vs=a(Sp,"A",{href:!0,rel:!0});var i1=s(Vs);zk=i(i1,"flax.nn.Module"),i1.forEach(t),qk=i(Sp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sp.forEach(t),$k=l(ae),zl=a(ae,"P",{});var d1=s(zl);Bk=i(d1,"Finally, this model supports inherent JAX features such as:"),d1.forEach(t),jk=l(ae),ft=a(ae,"UL",{});var Tn=s(ft);ql=a(Tn,"LI",{});var l1=s(ql);Js=a(l1,"A",{href:!0,rel:!0});var c1=s(Js);Ck=i(c1,"Just-In-Time (JIT) compilation"),c1.forEach(t),l1.forEach(t),Mk=l(Tn),$l=a(Tn,"LI",{});var p1=s($l);Xs=a(p1,"A",{href:!0,rel:!0});var h1=s(Xs);Ek=i(h1,"Automatic Differentiation"),h1.forEach(t),p1.forEach(t),Pk=l(Tn),Bl=a(Tn,"LI",{});var u1=s(Bl);Ks=a(u1,"A",{href:!0,rel:!0});var m1=s(Ks);Ak=i(m1,"Vectorization"),m1.forEach(t),u1.forEach(t),Sk=l(Tn),jl=a(Tn,"LI",{});var f1=s(jl);Zs=a(f1,"A",{href:!0,rel:!0});var _1=s(Zs);Ok=i(_1,"Parallelization"),_1.forEach(t),f1.forEach(t),Tn.forEach(t),Ik=l(ae),Ie=a(ae,"DIV",{class:!0});var Nt=s(Ie);f(Ys.$$.fragment,Nt),Nk=l(Nt),zo=a(Nt,"P",{});var Ti=s(zo);Lk=i(Ti,"The "),Cl=a(Ti,"CODE",{});var g1=s(Cl);Dk=i(g1,"FlaxBartPreTrainedModel"),g1.forEach(t),Gk=i(Ti," forward method, overrides the "),Ml=a(Ti,"CODE",{});var b1=s(Ml);Wk=i(b1,"__call__"),b1.forEach(t),Uk=i(Ti," special method."),Ti.forEach(t),Rk=l(Nt),f(pn.$$.fragment,Nt),Hk=l(Nt),El=a(Nt,"P",{});var k1=s(El);Qk=i(k1,"Example:"),k1.forEach(t),Vk=l(Nt),f(er.$$.fragment,Nt),Nt.forEach(t),Jk=l(ae),qt=a(ae,"DIV",{class:!0});var wi=s(qt);f(tr.$$.fragment,wi),Xk=l(wi),Pl=a(wi,"P",{});var y1=s(Pl);Kk=i(y1,"Example:"),y1.forEach(t),Zk=l(wi),f(or.$$.fragment,wi),wi.forEach(t),Yk=l(ae),$t=a(ae,"DIV",{class:!0});var xi=s($t);f(nr.$$.fragment,xi),ey=l(xi),Al=a(xi,"P",{});var v1=s(Al);ty=i(v1,"Example:"),v1.forEach(t),oy=l(xi),f(ar.$$.fragment,xi),xi.forEach(t),ae.forEach(t),Ic=l(o),qo=a(o,"H2",{class:!0});var Op=s(qo);hn=a(Op,"A",{id:!0,class:!0,href:!0});var T1=s(hn);Sl=a(T1,"SPAN",{});var w1=s(Sl);f(sr.$$.fragment,w1),w1.forEach(t),T1.forEach(t),ny=l(Op),Ol=a(Op,"SPAN",{});var x1=s(Ol);ay=i(x1,"FlaxBartForCausalLM"),x1.forEach(t),Op.forEach(t),Nc=l(o),K=a(o,"DIV",{class:!0});var We=s(K);f(rr.$$.fragment,We),sy=l(We),Il=a(We,"P",{});var F1=s(Il);ry=i(F1,`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
