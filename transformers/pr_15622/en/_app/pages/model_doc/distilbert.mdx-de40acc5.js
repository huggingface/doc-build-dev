...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15622/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_15622/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15622/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hv=l(),v(Eo.$$.fragment),Vv=l(),Ve=o("div"),v(Yr.$$.fragment),Kv=l(),Ps=o("p"),Jv=a("The "),Xi=o("a"),Gv=a("TFDistilBertForQuestionAnswering"),Xv=a(" forward method, overrides the "),Wd=o("code"),Yv=a("__call__"),Zv=a(" special method."),e2=l(),v(xo.$$.fragment),t2=l(),Rd=o("p"),s2=a("Example:"),o2=l(),v(Zr.$$.fragment),n2=l(),v(ea.$$.fragment),Zp=l(),As=o("h2"),zo=o("a"),Ud=o("span"),v(ta.$$.fragment),r2=l(),Qd=o("span"),a2=a("FlaxDistilBertModel"),eh=l(),Me=o("div"),v(sa.$$.fragment),i2=l(),Hd=o("p"),l2=a("The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),d2=l(),oa=o("p"),c2=a("This model inherits from "),Yi=o("a"),p2=a("FlaxPreTrainedModel"),h2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),u2=l(),na=o("p"),m2=a("This model is also a Flax Linen "),ra=o("a"),f2=a("flax.linen.Module"),g2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_2=l(),Vd=o("p"),b2=a("Finally, this model supports inherent JAX features such as:"),v2=l(),qt=o("ul"),Kd=o("li"),aa=o("a"),k2=a("Just-In-Time (JIT) compilation"),T2=l(),Jd=o("li"),ia=o("a"),w2=a("Automatic Differentiation"),y2=l(),Gd=o("li"),la=o("a"),$2=a("Vectorization"),F2=l(),Xd=o("li"),da=o("a"),D2=a("Parallelization"),B2=l(),rt=o("div"),v(ca.$$.fragment),M2=l(),Os=o("p"),E2=a("The "),Yd=o("code"),x2=a("FlaxDistilBertPreTrainedModel"),z2=a(" forward method, overrides the "),Zd=o("code"),j2=a("__call__"),C2=a(" special method."),q2=l(),v(jo.$$.fragment),P2=l(),ec=o("p"),A2=a("Example:"),O2=l(),v(pa.$$.fragment),th=l(),Ns=o("h2"),Co=o("a"),tc=o("span"),v(ha.$$.fragment),N2=l(),sc=o("span"),L2=a("FlaxDistilBertForMaskedLM"),sh=l(),Ee=o("div"),v(ua.$$.fragment),S2=l(),ma=o("p"),I2=a("DistilBert Model with a "),oc=o("code"),W2=a("language modeling"),R2=a(" head on top."),U2=l(),fa=o("p"),Q2=a("This model inherits from "),Zi=o("a"),H2=a("FlaxPreTrainedModel"),V2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),K2=l(),ga=o("p"),J2=a("This model is also a Flax Linen "),_a=o("a"),G2=a("flax.linen.Module"),X2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y2=l(),nc=o("p"),Z2=a("Finally, this model supports inherent JAX features such as:"),ek=l(),Pt=o("ul"),rc=o("li"),ba=o("a"),tk=a("Just-In-Time (JIT) compilation"),sk=l(),ac=o("li"),va=o("a"),ok=a("Automatic Differentiation"),nk=l(),ic=o("li"),ka=o("a"),rk=a("Vectorization"),ak=l(),lc=o("li"),Ta=o("a"),ik=a("Parallelization"),lk=l(),at=o("div"),v(wa.$$.fragment),dk=l(),Ls=o("p"),ck=a("The "),dc=o("code"),pk=a("FlaxDistilBertPreTrainedModel"),hk=a(" forward method, overrides the "),cc=o("code"),uk=a("__call__"),mk=a(" special method."),fk=l(),v(qo.$$.fragment),gk=l(),pc=o("p"),_k=a("Example:"),bk=l(),v(ya.$$.fragment),oh=l(),Ss=o("h2"),Po=o("a"),hc=o("span"),v($a.$$.fragment),vk=l(),uc=o("span"),kk=a("FlaxDistilBertForSequenceClassification"),nh=l(),xe=o("div"),v(Fa.$$.fragment),Tk=l(),mc=o("p"),wk=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
contributed by `),Zo=n(Wt,"A",{href:!0,rel:!0});var Kw=r(Zo);Fu=i(Kw,"kamalkraj"),Kw.forEach(t),Du=i(Wt,". The original code can be found "),en=n(Wt,"A",{href:!0,rel:!0});var Jw=r(en);Bu=i(Jw,"here"),Jw.forEach(t),Mu=i(Wt,"."),Wt.forEach(t),yp=d(s),as=n(s,"H2",{class:!0});var hh=r(as);Js=n(hh,"A",{id:!0,class:!0,href:!0});var Gw=r(Js);Dl=n(Gw,"SPAN",{});var Xw=r(Dl);k(tn.$$.fragment,Xw),Xw.forEach(t),Gw.forEach(t),Eu=d(hh),Bl=n(hh,"SPAN",{});var Yw=r(Bl);xu=i(Yw,"DistilBertConfig"),Yw.forEach(t),hh.forEach(t),$p=d(s),Ke=n(s,"DIV",{class:!0});var Rt=r(Ke);k(sn.$$.fragment,Rt),zu=d(Rt),Ct=n(Rt,"P",{});var Ro=r(Ct);ju=i(Ro,"This is the configuration class to store the configuration of a "),bi=n(Ro,"A",{href:!0});var Zw=r(bi);Cu=i(Zw,"DistilBertModel"),Zw.forEach(t),qu=i(Ro," or a "),vi=n(Ro,"A",{href:!0});var e1=r(vi);Pu=i(e1,"TFDistilBertModel"),e1.forEach(t),Au=i(Ro,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
`),on=n(Ro,"A",{href:!0,rel:!0});var t1=r(on);Ou=i(t1,"distilbert-base-uncased"),t1.forEach(t),Nu=i(Ro," architecture."),Ro.forEach(t),Lu=d(Rt),is=n(Rt,"P",{});var nl=r(is);Su=i(nl,"Configuration objects inherit from "),ki=n(nl,"A",{href:!0});var s1=r(ki);Iu=i(s1,"PretrainedConfig"),s1.forEach(t),Wu=i(nl,` and can be used to control the model outputs. Read the
documentation from `),Ti=n(nl,"A",{href:!0});var o1=r(Ti);Ru=i(o1,"PretrainedConfig"),o1.forEach(t),Uu=i(nl," for more information."),nl.forEach(t),Qu=d(Rt),Ml=n(Rt,"P",{});var n1=r(Ml);Hu=i(n1,"Examples:"),n1.forEach(t),Vu=d(Rt),k(nn.$$.fragment,Rt),Rt.forEach(t),Fp=d(s),ls=n(s,"H2",{class:!0});var uh=r(ls);Gs=n(uh,"A",{id:!0,class:!0,href:!0});var r1=r(Gs);El=n(r1,"SPAN",{});var a1=r(El);k(rn.$$.fragment,a1),a1.forEach(t),r1.forEach(t),Ku=d(uh),xl=n(uh,"SPAN",{});var i1=r(xl);Ju=i(i1,"DistilBertTokenizer"),i1.forEach(t),uh.forEach(t),Dp=d(s),_t=n(s,"DIV",{class:!0});var Uo=r(_t);k(an.$$.fragment,Uo),Gu=d(Uo),zl=n(Uo,"P",{});var l1=r(zl);Xu=i(l1,"Construct a DistilBERT tokenizer."),l1.forEach(t),Yu=d(Uo),Xs=n(Uo,"P",{});var kp=r(Xs);wi=n(kp,"A",{href:!0});var d1=r(wi);Zu=i(d1,"DistilBertTokenizer"),d1.forEach(t),em=i(kp," is identical to "),yi=n(kp,"A",{href:!0});var c1=r(yi);tm=i(c1,"BertTokenizer"),c1.forEach(t),sm=i(kp,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),kp.forEach(t),om=d(Uo),ln=n(Uo,"P",{});var mh=r(ln);nm=i(mh,"Refer to superclass "),$i=n(mh,"A",{href:!0});var p1=r($i);rm=i(p1,"BertTokenizer"),p1.forEach(t),am=i(mh," for usage examples and documentation concerning parameters."),mh.forEach(t),Uo.forEach(t),Bp=d(s),ds=n(s,"H2",{class:!0});var fh=r(ds);Ys=n(fh,"A",{id:!0,class:!0,href:!0});var h1=r(Ys);jl=n(h1,"SPAN",{});var u1=r(jl);k(dn.$$.fragment,u1),u1.forEach(t),h1.forEach(t),im=d(fh),Cl=n(fh,"SPAN",{});var m1=r(Cl);lm=i(m1,"DistilBertTokenizerFast"),m1.forEach(t),fh.forEach(t),Mp=d(s),bt=n(s,"DIV",{class:!0});var Qo=r(bt);k(cn.$$.fragment,Qo),dm=d(Qo),pn=n(Qo,"P",{});var gh=r(pn);cm=i(gh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),ql=n(gh,"EM",{});var f1=r(ql);pm=i(f1,"tokenizers"),f1.forEach(t),hm=i(gh," library)."),gh.forEach(t),um=d(Qo),Zs=n(Qo,"P",{});var Tp=r(Zs);Fi=n(Tp,"A",{href:!0});var g1=r(Fi);mm=i(g1,"DistilBertTokenizerFast"),g1.forEach(t),fm=i(Tp," is identical to "),Di=n(Tp,"A",{href:!0});var _1=r(Di);gm=i(_1,"BertTokenizerFast"),_1.forEach(t),_m=i(Tp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Tp.forEach(t),bm=d(Qo),hn=n(Qo,"P",{});var _h=r(hn);vm=i(_h,"Refer to superclass "),Bi=n(_h,"A",{href:!0});var b1=r(Bi);km=i(b1,"BertTokenizerFast"),b1.forEach(t),Tm=i(_h," for usage examples and documentation concerning parameters."),_h.forEach(t),Qo.forEach(t),Ep=d(s),cs=n(s,"H2",{class:!0});var bh=r(cs);eo=n(bh,"A",{id:!0,class:!0,href:!0});var v1=r(eo);Pl=n(v1,"SPAN",{});var k1=r(Pl);k(un.$$.fragment,k1),k1.forEach(t),v1.forEach(t),wm=d(bh),Al=n(bh,"SPAN",{});var T1=r(Al);ym=i(T1,"DistilBertModel"),T1.forEach(t),bh.forEach(t),xp=d(s),Je=n(s,"DIV",{class:!0});var Ut=r(Je);k(mn.$$.fragment,Ut),$m=d(Ut),Ol=n(Ut,"P",{});var w1=r(Ol);Fm=i(w1,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),w1.forEach(t),Dm=d(Ut),fn=n(Ut,"P",{});var vh=r(fn);Bm=i(vh,"This model inherits from "),Mi=n(vh,"A",{href:!0});var y1=r(Mi);Mm=i(y1,"PreTrainedModel"),y1.forEach(t),Em=i(vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vh.forEach(t),xm=d(Ut),gn=n(Ut,"P",{});var kh=r(gn);zm=i(kh,"This model is also a PyTorch "),_n=n(kh,"A",{href:!0,rel:!0});var $1=r(_n);jm=i($1,"torch.nn.Module"),$1.forEach(t),Cm=i(kh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kh.forEach(t),qm=d(Ut),tt=n(Ut,"DIV",{class:!0});var Qt=r(tt);k(bn.$$.fragment,Qt),Pm=d(Qt),ps=n(Qt,"P",{});var rl=r(ps);Am=i(rl,"The "),Ei=n(rl,"A",{href:!0});var F1=r(Ei);Om=i(F1,"DistilBertModel"),F1.forEach(t),Nm=i(rl," forward method, overrides the "),Nl=n(rl,"CODE",{});var D1=r(Nl);Lm=i(D1,"__call__"),D1.forEach(t),Sm=i(rl," special method."),rl.forEach(t),Im=d(Qt),k(to.$$.fragment,Qt),Wm=d(Qt),Ll=n(Qt,"P",{});var B1=r(Ll);Rm=i(B1,"Example:"),B1.forEach(t),Um=d(Qt),k(vn.$$.fragment,Qt),Qt.forEach(t),Ut.forEach(t),zp=d(s),hs=n(s,"H2",{class:!0});var Th=r(hs);so=n(Th,"A",{id:!0,class:!0,href:!0});var M1=r(so);Sl=n(M1,"SPAN",{});var E1=r(Sl);k(kn.$$.fragment,E1),E1.forEach(t),M1.forEach(t),Qm=d(Th),Il=n(Th,"SPAN",{});var x1=r(Il);Hm=i(x1,"DistilBertForMaskedLM"),x1.forEach(t),Th.forEach(t),jp=d(s),Ge=n(s,"DIV",{class:!0});var Ht=r(Ge);k(Tn.$$.fragment,Ht),Vm=d(Ht),wn=n(Ht,"P",{});var wh=r(wn);Km=i(wh,"DistilBert Model with a "),Wl=n(wh,"CODE",{});var z1=r(Wl);Jm=i(z1,"masked language modeling"),z1.forEach(t),Gm=i(wh," head on top."),wh.forEach(t),Xm=d(Ht),yn=n(Ht,"P",{});var yh=r(yn);Ym=i(yh,"This model inherits from "),xi=n(yh,"A",{href:!0});var j1=r(xi);Zm=i(j1,"PreTrainedModel"),j1.forEach(t),ef=i(yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yh.forEach(t),tf=d(Ht),$n=n(Ht,"P",{});var $h=r($n);sf=i($h,"This model is also a PyTorch "),Fn=n($h,"A",{href:!0,rel:!0});var C1=r(Fn);of=i(C1,"torch.nn.Module"),C1.forEach(t),nf=i($h,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),rf=d(Ht),Ie=n(Ht,"DIV",{class:!0});var kt=r(Ie);k(Dn.$$.fragment,kt),af=d(kt),us=n(kt,"P",{});var al=r(us);lf=i(al,"The "),zi=n(al,"A",{href:!0});var q1=r(zi);df=i(q1,"DistilBertForMaskedLM"),q1.forEach(t),cf=i(al," forward method, overrides the "),Rl=n(al,"CODE",{});var P1=r(Rl);pf=i(P1,"__call__"),P1.forEach(t),hf=i(al," special method."),al.forEach(t),uf=d(kt),k(oo.$$.fragment,kt),mf=d(kt),Ul=n(kt,"P",{});var A1=r(Ul);ff=i(A1,"Example:"),A1.forEach(t),gf=d(kt),k(Bn.$$.fragment,kt),_f=d(kt),k(Mn.$$.fragment,kt),kt.forEach(t),Ht.forEach(t),Cp=d(s),ms=n(s,"H2",{class:!0});var Fh=r(ms);no=n(Fh,"A",{id:!0,class:!0,href:!0});var O1=r(no);Ql=n(O1,"SPAN",{});var N1=r(Ql);k(En.$$.fragment,N1),N1.forEach(t),O1.forEach(t),bf=d(Fh),Hl=n(Fh,"SPAN",{});var L1=r(Hl);vf=i(L1,"DistilBertForSequenceClassification"),L1.forEach(t),Fh.forEach(t),qp=d(s),Xe=n(s,"DIV",{class:!0});var Vt=r(Xe);k(xn.$$.fragment,Vt),kf=d(Vt),Vl=n(Vt,"P",{});var S1=r(Vl);Tf=i(S1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),S1.forEach(t),wf=d(Vt),zn=n(Vt,"P",{});var Dh=r(zn);yf=i(Dh,"This model inherits from "),ji=n(Dh,"A",{href:!0});var I1=r(ji);$f=i(I1,"PreTrainedModel"),I1.forEach(t),Ff=i(Dh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dh.forEach(t),Df=d(Vt),jn=n(Vt,"P",{});var Bh=r(jn);Bf=i(Bh,"This model is also a PyTorch "),Cn=n(Bh,"A",{href:!0,rel:!0});var W1=r(Cn);Mf=i(W1,"torch.nn.Module"),W1.forEach(t),Ef=i(Bh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh.forEach(t),xf=d(Vt),ke=n(Vt,"DIV",{class:!0});var qe=r(ke);k(qn.$$.fragment,qe),zf=d(qe),fs=n(qe,"P",{});var il=r(fs);jf=i(il,"The "),Ci=n(il,"A",{href:!0});var R1=r(Ci);Cf=i(R1,"DistilBertForSequenceClassification"),R1.forEach(t),qf=i(il," forward method, overrides the "),Kl=n(il,"CODE",{});var U1=r(Kl);Pf=i(U1,"__call__"),U1.forEach(t),Af=i(il," special method."),il.forEach(t),Of=d(qe),k(ro.$$.fragment,qe),Nf=d(qe),Jl=n(qe,"P",{});var Q1=r(Jl);Lf=i(Q1,"Example of single-label classification:"),Q1.forEach(t),Sf=d(qe),k(Pn.$$.fragment,qe),If=d(qe),k(An.$$.fragment,qe),Wf=d(qe),Gl=n(qe,"P",{});var H1=r(Gl);Rf=i(H1,"Example of multi-label classification:"),H1.forEach(t),Uf=d(qe),k(On.$$.fragment,qe),Qf=d(qe),k(Nn.$$.fragment,qe),qe.forEach(t),Vt.forEach(t),Pp=d(s),gs=n(s,"H2",{class:!0});var Mh=r(gs);ao=n(Mh,"A",{id:!0,class:!0,href:!0});var V1=r(ao);Xl=n(V1,"SPAN",{});var K1=r(Xl);k(Ln.$$.fragment,K1),K1.forEach(t),V1.forEach(t),Hf=d(Mh),Yl=n(Mh,"SPAN",{});var J1=r(Yl);Vf=i(J1,"DistilBertForMultipleChoice"),J1.forEach(t),Mh.forEach(t),Ap=d(s),Ye=n(s,"DIV",{class:!0});var Kt=r(Ye);k(Sn.$$.fragment,Kt),Kf=d(Kt),Zl=n(Kt,"P",{});var G1=r(Zl);Jf=i(G1,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),G1.forEach(t),Gf=d(Kt),In=n(Kt,"P",{});var Eh=r(In);Xf=i(Eh,"This model inherits from "),qi=n(Eh,"A",{href:!0});var X1=r(qi);Yf=i(X1,"PreTrainedModel"),X1.forEach(t),Zf=i(Eh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eh.forEach(t),eg=d(Kt),Wn=n(Kt,"P",{});var xh=r(Wn);tg=i(xh,"This model is also a PyTorch "),Rn=n(xh,"A",{href:!0,rel:!0});var Y1=r(Rn);sg=i(Y1,"torch.nn.Module"),Y1.forEach(t),og=i(xh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Kt),st=n(Kt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),Pi=n(ll,"A",{href:!0});var Z1=r(Pi);ig=i(Z1,"DistilBertForMultipleChoice"),Z1.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var ey=r(ed);dg=i(ey,"__call__"),ey.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var ty=r(td);ug=i(ty,"Examples:"),ty.forEach(t),mg=d(Jt),k(Qn.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Op=d(s),bs=n(s,"H2",{class:!0});var zh=r(bs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var sy=r(lo);sd=n(sy,"SPAN",{});var oy=r(sd);k(Hn.$$.fragment,oy),oy.forEach(t),sy.forEach(t),fg=d(zh),od=n(zh,"SPAN",{});var ny=r(od);gg=i(ny,"DistilBertForTokenClassification"),ny.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Vn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var ry=r(nd);bg=i(ry,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Hv=d(zt),k(Eo.$$.fragment,zt),Vv=d(zt),Ve=n(zt,"DIV",{class:!0});var jt=r(Ve);k(Yr.$$.fragment,jt),Kv=d(jt),Ps=n(jt,"P",{});var bl=r(Ps);Jv=i(bl,"The "),Xi=n(bl,"A",{href:!0});var v$=r(Xi);Gv=i(v$,"TFDistilBertForQuestionAnswering"),v$.forEach(t),Xv=i(bl," forward method, overrides the "),Wd=n(bl,"CODE",{});var k$=r(Wd);Yv=i(k$,"__call__"),k$.forEach(t),Zv=i(bl," special method."),bl.forEach(t),e2=d(jt),k(xo.$$.fragment,jt),t2=d(jt),Rd=n(jt,"P",{});var T$=r(Rd);s2=i(T$,"Example:"),T$.forEach(t),o2=d(jt),k(Zr.$$.fragment,jt),n2=d(jt),k(ea.$$.fragment,jt),jt.forEach(t),zt.forEach(t),Zp=d(s),As=n(s,"H2",{class:!0});var su=r(As);zo=n(su,"A",{id:!0,class:!0,href:!0});var w$=r(zo);Ud=n(w$,"SPAN",{});var y$=r(Ud);k(ta.$$.fragment,y$),y$.forEach(t),w$.forEach(t),r2=d(su),Qd=n(su,"SPAN",{});var $$=r(Qd);a2=i($$,"FlaxDistilBertModel"),$$.forEach(t),su.forEach(t),eh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(sa.$$.fragment,pt),i2=d(pt),Hd=n(pt,"P",{});var F$=r(Hd);l2=i(F$,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),F$.forEach(t),d2=d(pt),oa=n(pt,"P",{});var ou=r(oa);c2=i(ou,"This model inherits from "),Yi=n(ou,"A",{href:!0});var D$=r(Yi);p2=i(D$,"FlaxPreTrainedModel"),D$.forEach(t),h2=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ou.forEach(t),u2=d(pt),na=n(pt,"P",{});var nu=r(na);m2=i(nu,"This model is also a Flax Linen "),ra=n(nu,"A",{href:!0,rel:!0});var B$=r(ra);f2=i(B$,"flax.linen.Module"),B$.forEach(t),g2=i(nu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),_2=d(pt),Vd=n(pt,"P",{});var M$=r(Vd);b2=i(M$,"Finally, this model supports inherent JAX features such as:"),M$.forEach(t),v2=d(pt),qt=n(pt,"UL",{});var Ho=r(qt);Kd=n(Ho,"LI",{});var E$=r(Kd);aa=n(E$,"A",{href:!0,rel:!0});var x$=r(aa);k2=i(x$,"Just-In-Time (JIT) compilation"),x$.forEach(t),E$.forEach(t),T2=d(Ho),Jd=n(Ho,"LI",{});var z$=r(Jd);ia=n(z$,"A",{href:!0,rel:!0});var j$=r(ia);w2=i(j$,"Automatic Differentiation"),j$.forEach(t),z$.forEach(t),y2=d(Ho),Gd=n(Ho,"LI",{});var C$=r(Gd);la=n(C$,"A",{href:!0,rel:!0});var q$=r(la);$2=i(q$,"Vectorization"),q$.forEach(t),C$.forEach(t),F2=d(Ho),Xd=n(Ho,"LI",{});var P$=r(Xd);da=n(P$,"A",{href:!0,rel:!0});var A$=r(da);D2=i(A$,"Parallelization"),A$.forEach(t),P$.forEach(t),Ho.forEach(t),B2=d(pt),rt=n(pt,"DIV",{class:!0});var es=r(rt);k(ca.$$.fragment,es),M2=d(es),Os=n(es,"P",{});var vl=r(Os);E2=i(vl,"The "),Yd=n(vl,"CODE",{});var O$=r(Yd);x2=i(O$,"FlaxDistilBertPreTrainedModel"),O$.forEach(t),z2=i(vl," forward method, overrides the "),Zd=n(vl,"CODE",{});var N$=r(Zd);j2=i(N$,"__call__"),N$.forEach(t),C2=i(vl," special method."),vl.forEach(t),q2=d(es),k(jo.$$.fragment,es),P2=d(es),ec=n(es,"P",{});var L$=r(ec);A2=i(L$,"Example:"),L$.forEach(t),O2=d(es),k(pa.$$.fragment,es),es.forEach(t),pt.forEach(t),th=d(s),Ns=n(s,"H2",{class:!0});var ru=r(Ns);Co=n(ru,"A",{id:!0,class:!0,href:!0});var S$=r(Co);tc=n(S$,"SPAN",{});var I$=r(tc);k(ha.$$.fragment,I$),I$.forEach(t),S$.forEach(t),N2=d(ru),sc=n(ru,"SPAN",{});var W$=r(sc);L2=i(W$,"FlaxDistilBertForMaskedLM"),W$.forEach(t),ru.forEach(t),sh=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(ua.$$.fragment,ht),S2=d(ht),ma=n(ht,"P",{});var au=r(ma);I2=i(au,"DistilBert Model with a "),oc=n(au,"CODE",{});var R$=r(oc);W2=i(R$,"language modeling"),R$.forEach(t),R2=i(au," head on top."),au.forEach(t),U2=d(ht),fa=n(ht,"P",{});var iu=r(fa);Q2=i(iu,"This model inherits from "),Zi=n(iu,"A",{href:!0});var U$=r(Zi);H2=i(U$,"FlaxPreTrainedModel"),U$.forEach(t),V2=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),K2=d(ht),ga=n(ht,"P",{});var lu=r(ga);J2=i(lu,"This model is also a Flax Linen "),_a=n(lu,"A",{href:!0,rel:!0});var Q$=r(_a);G2=i(Q$,"flax.linen.Module"),Q$.forEach(t),X2=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Y2=d(ht),nc=n(ht,"P",{});var H$=r(nc);Z2=i(H$,"Finally, this model supports inherent JAX features such as:"),H$.forEach(t),ek=d(ht),Pt=n(ht,"UL",{});var Vo=r(Pt);rc=n(Vo,"LI",{});var V$=r(rc);ba=n(V$,"A",{href:!0,rel:!0});var K$=r(ba);tk=i(K$,"Just-In-Time (JIT) compilation"),K$.forEach(t),V$.forEach(t),sk=d(Vo),ac=n(Vo,"LI",{});var J$=r(ac);va=n(J$,"A",{href:!0,rel:!0});var G$=r(va);ok=i(G$,"Automatic Differentiation"),G$.forEach(t),J$.forEach(t),nk=d(Vo),ic=n(Vo,"LI",{});var X$=r(ic);ka=n(X$,"A",{href:!0,rel:!0});var Y$=r(ka);rk=i(Y$,"Vectorization"),Y$.forEach(t),X$.forEach(t),ak=d(Vo),lc=n(Vo,"LI",{});var Z$=r(lc);Ta=n(Z$,"A",{href:!0,rel:!0});var eF=r(Ta);ik=i(eF,"Parallelization"),eF.forEach(t),Z$.forEach(t),Vo.forEach(t),lk=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dk=d(ts),Ls=n(ts,"P",{});var kl=r(Ls);ck=i(kl,"The "),dc=n(kl,"CODE",{});var tF=r(dc);pk=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),hk=i(kl," forward method, overrides the "),cc=n(kl,"CODE",{});var sF=r(cc);uk=i(sF,"__call__"),sF.forEach(t),mk=i(kl," special method."),kl.forEach(t),fk=d(ts),k(qo.$$.fragment,ts),gk=d(ts),pc=n(ts,"P",{});var oF=r(pc);_k=i(oF,"Example:"),oF.forEach(t),bk=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ss=n(s,"H2",{class:!0});var du=r(Ss);Po=n(du,"A",{id:!0,class:!0,href:!0});var nF=r(Po);hc=n(nF,"SPAN",{});var rF=r(hc);k($a.$$.fragment,rF),rF.forEach(t),nF.forEach(t),vk=d(du),uc=n(du,"SPAN",{});var aF=r(uc);kk=i(aF,"FlaxDistilBertForSequenceClassification"),aF.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Fa.$$.fragment,ut),Tk=d(ut),mc=n(ut,"P",{});var iF=r(mc);wk=i(iF,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
