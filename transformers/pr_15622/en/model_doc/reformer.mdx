...
For training, the [ReformerModelWithLMHead](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerModelWithLMHead) should be used as follows:
...
- **is_decoder** (`bool`, *optional*, defaults to `False`) --
  Whether or not to use a causal mask in addition to the `attention_mask` passed to [ReformerModel](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerModel). When
...
- **vocab_size** (`int`, *optional*, defaults to 320) --\
  ...
  the `inputs_ids` passed when calling [ReformerModel](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerModel).
...
This is the configuration class to store the configuration of a [ReformerModel](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerModel). It is used to instantiate a
...
<docstring><name>class transformers.ReformerTokenizer</name><anchor>transformers.ReformerTokenizer</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/tokenization_reformer.py#L46</source><parameters>[{"name": "vocab_file", "val": ""}, {"name": "eos_token", "val": " = '</s>'"}, {"name": "unk_token", "val": " = '<unk>'"}, {"name": "additional_special_tokens", "val": " = []"}, {"name": "sp_model_kwargs", "val": ": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_file** (`str`) --
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.ReformerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L1989</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "num_hashes", "val": " = None"}, {"name": "past_buckets_states", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [ReformerTokenizer](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerTokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/pr_15622/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and
...
- **num_hashes** (`int`, *optional*) --
  ...
  For more information, see `num_hashes` in [ReformerConfig](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerConfig).
...
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/pr_15622/en/main_classes/output#transformers.file_utils.ModelOutput) instead of a plain tuple.</paramsdesc><paramgroups>0</paramgroups><rettype>`transformers.models.reformer.modeling_reformer.ReformerModelOutput`or `tuple(torch.FloatTensor)`</rettype><retdesc>A `transformers.models.reformer.modeling_reformer.ReformerModelOutput`or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ReformerConfig](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.
...
The [ReformerModel](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerModel) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.ReformerModelWithLMHead.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2196</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "num_hashes", "val": " = None"}, {"name": "past_buckets_states", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "return_dict", "val": " = None"}, {"name": "labels", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. During training the input_ids sequence_length has to be
  a multiple of the relevant model's chunk lengths (lsh's, local's or both). During evaluation, the indices
  are automatically padded to be a multiple of the chunk length.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [ReformerModelWithLMHead](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerModelWithLMHead) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.ReformerForMaskedLM</name><anchor>transformers.ReformerForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2294</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([ReformerConfig](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15622/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
Reformer Model with a `language modeling` head on top.
Reformer was proposed in [Reformer: The Efficient Transformer](https://arxiv.org/abs/2001.04451) by Nikita Kitaev,
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.ReformerForMaskedLM.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2312</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "num_hashes", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. During training the input_ids sequence_length has to be
  a multiple of the relevant model's chunk lengths (lsh's, local's or both). During evaluation, the indices
  are automatically padded to be a multiple of the chunk length.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [ReformerForMaskedLM](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerForMaskedLM) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.ReformerForSequenceClassification</name><anchor>transformers.ReformerForSequenceClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2380</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([ReformerConfig](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15622/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.ReformerForSequenceClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2394</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "num_hashes", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. During training the input_ids sequence_length has to be
  a multiple of the relevant model's chunk lengths (lsh's, local's or both). During evaluation, the indices
  are automatically padded to be a multiple of the chunk length.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [ReformerForSequenceClassification](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerForSequenceClassification) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.ReformerForQuestionAnswering</name><anchor>transformers.ReformerForQuestionAnswering</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2501</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([ReformerConfig](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15622/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.ReformerForQuestionAnswering.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15622/src/transformers/models/reformer/modeling_reformer.py#L2513</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "num_hashes", "val": " = None"}, {"name": "start_positions", "val": " = None"}, {"name": "end_positions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. During training the input_ids sequence_length has to be
  a multiple of the relevant model's chunk lengths (lsh's, local's or both). During evaluation, the indices
  are automatically padded to be a multiple of the chunk length.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [ReformerForQuestionAnswering](/docs/transformers/pr_15622/en/model_doc/reformer#transformers.ReformerForQuestionAnswering) forward method, overrides the `__call__` special method.
