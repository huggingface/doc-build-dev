...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16199/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16199/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16199/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16199/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16199/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16199/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[W2]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16199/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16199/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16199/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16199/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16199/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16199/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16199/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16199/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16199/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16199/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sv=d(),Mc=n("p"),Av=r("Finally, this model supports inherent JAX features such as:"),Ov=d(),ft=n("ul"),wc=n("li"),ir=n("a"),Iv=r("Just-In-Time (JIT) compilation"),Nv=d(),xc=n("li"),dr=n("a"),Dv=r("Automatic Differentiation"),Lv=d(),zc=n("li"),lr=n("a"),Gv=r("Vectorization"),Wv=d(),qc=n("li"),cr=n("a"),Rv=r("Parallelization"),Uv=d(),te=n("div"),m(pr.$$.fragment),Xv=d(),Fo=n("p"),Hv=r("The "),Bc=n("code"),Vv=r("FlaxMBartPreTrainedModel"),Qv=r("forward method, overrides the "),Fc=n("code"),Jv=r("__call__"),Kv=r(" special method."),Zv=d(),m(kn.$$.fragment),Yv=d(),$c=n("p"),e1=r("Summarization example:"),t1=d(),m(hr.$$.fragment),o1=d(),jc=n("p"),n1=r("Mask filling example:"),a1=d(),m(ur.$$.fragment),s1=d(),xt=n("div"),m(mr.$$.fragment),r1=d(),Ec=n("p"),i1=r("Example:"),d1=d(),m(fr.$$.fragment),l1=d(),zt=n("div"),m(_r.$$.fragment),c1=d(),Pc=n("p"),p1=r("Example:"),h1=d(),m(gr.$$.fragment),rh=d(),$o=n("h2"),bn=n("a"),Cc=n("span"),m(kr.$$.fragment),u1=d(),Sc=n("span"),m1=r("FlaxMBartForSequenceClassification"),ih=d(),O=n("div"),m(br.$$.fragment),f1=d(),Ac=n("p"),_1=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),g1=d(),yr=n("p"),k1=r("This model inherits from "),$i=n("a"),b1=r("FlaxPreTrainedModel"),y1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),v1=d(),vr=n("p"),T1=r(`This model is also a Flax Linen
`),Tr=n("a"),M1=r("flax.nn.Module"),w1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),x1=d(),Oc=n("p"),z1=r("Finally, this model supports inherent JAX features such as:"),q1=d(),_t=n("ul"),Ic=n("li"),Mr=n("a"),B1=r("Just-In-Time (JIT) compilation"),F1=d(),Nc=n("li"),wr=n("a"),$1=r("Automatic Differentiation"),j1=d(),Dc=n("li"),xr=n("a"),E1=r("Vectorization"),P1=d(),Lc=n("li"),zr=n("a"),C1=r("Parallelization"),S1=d(),Ne=n("div"),m(qr.$$.fragment),A1=d(),jo=n("p"),O1=r("The "),Gc=n("code"),I1=r("FlaxMBartPreTrainedModel"),N1=r("forward method, overrides the "),Wc=n("code"),D1=r("__call__"),L1=r(" special method."),G1=d(),m(yn.$$.fragment),W1=d(),Rc=n("p"),R1=r("Example:"),U1=d(),m(Br.$$.fragment),X1=d(),qt=n("div"),m(Fr.$$.fragment),H1=d(),Uc=n("p"),V1=r("Example:"),Q1=d(),m($r.$$.fragment),J1=d(),Bt=n("div"),m(jr.$$.fragment),K1=d(),Xc=n("p"),Z1=r("Example:"),Y1=d(),m(Er.$$.fragment),dh=d(),Eo=n("h2"),vn=n("a"),Hc=n("span"),m(Pr.$$.fragment),eT=d(),Vc=n("span"),tT=r("FlaxMBartForQuestionAnswering"),lh=d(),I=n("div"),m(Cr.$$.fragment),oT=d(),Po=n("p"),nT=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),HT.forEach(t),Ze=l(o),se=a(o,"P",{});var fp=s(se);ye=i(fp,"This model was contributed by "),ve=a(fp,"A",{href:!0,rel:!0});var VT=s(ve);ht=i(VT,"valhalla"),VT.forEach(t),re=i(fp,". The Authors\u2019 code can be found "),Te=a(fp,"A",{href:!0,rel:!0});var QT=s(Te);Me=i(QT,"here"),QT.forEach(t),fp.forEach(t),Ye=l(o),w=a(o,"H3",{class:!0});var ph=s(w);F=a(ph,"A",{id:!0,class:!0,href:!0});var JT=s(F);we=a(JT,"SPAN",{});var KT=s(we);f(He.$$.fragment,KT),KT.forEach(t),JT.forEach(t),Ut=l(ph),K=a(ph,"SPAN",{});var ZT=s(K);Xt=i(ZT,"Training of MBart"),ZT.forEach(t),ph.forEach(t),kt=l(o),X=a(o,"P",{});var jt=s(X);ie=i(jt,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
target text format is `),Ve=a(jt,"CODE",{});var tM=s(Ve);Kt=i(tM,"[tgt_lang_code] X [eos]"),tM.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var oM=s(rd);Pu=i(oM,"bos"),oM.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var UT=s(Cn);id=a(UT,"STRONG",{});var nM=s(id);Au=i(nM,"call"),nM.forEach(t),Ou=i(UT,"()"),UT.forEach(t),Iu=i(Ei,` will encode source text format, and it should be wrapped
