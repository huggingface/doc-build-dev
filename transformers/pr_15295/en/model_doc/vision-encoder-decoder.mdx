...
The [VisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel) can be used to initialize an image-to-text-sequence model with any
...
An example of how to use a [VisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel) for inference can be seen in [TrOCR](trocr).
...
[VisionEncoderDecoderConfig](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig) is the configuration class to store the configuration of a
[VisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel). It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
Instantiate a [VisionEncoderDecoderConfig](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig) (or a derived class) from a pre-trained encoder model
...
[VisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel) is a generic model class that will be instantiated as a transformer architecture with
...
elements depending on the configuration ([VisionEncoderDecoderConfig](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig)) and inputs.
...
The [VisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel) forward method, overrides the `__call__` special method.
...
[TFVisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel) is a generic model class that will be instantiated as a transformer architecture
...
<docstring><name>call</name><anchor>transformers.TFVisionEncoderDecoderModel.call</anchor><source>https://github.com/huggingface/transformers/blob/pr_15295/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L475</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "decoder_input_ids", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}, {"name": "training", "val": " = False"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pixel_values** (`np.ndarray`, `tf.Tensor`, `List[tf.Tensor]` ``Dict[str, tf.Tensor]` or `Dict[str, np.ndarray]` and each example must have the shape `(batch_size, num_channels, height, width)`) --
  ...
  [ViTFeatureExtractor](/docs/transformers/pr_15295/en/model_doc/vit#transformers.ViTFeatureExtractor). See [ViTFeatureExtractor.__call__()](/docs/transformers/pr_15295/en/model_doc/vit#transformers.ViTFeatureExtractor.__call__) for details.
...
configuration ([VisionEncoderDecoderConfig](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig)) and inputs.
...
- **encoder_attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [TFVisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel) forward method, overrides the `__call__` special method.
...
[FlaxVisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel) is a generic model class that will be instantiated as a transformer architecture
...
- **encoder_attentions** (`tuple(jnp.ndarray)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `jnp.ndarray` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [FlaxVisionEncoderDecoderModel](/docs/transformers/pr_15295/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel) forward method, overrides the `__call__` special method.
