...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16255/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:A}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/t5/modeling_tf_t5.py#L1357",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:A}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/t5/modeling_tf_t5.py#L1688",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),v5=d(),f(Xn.$$.fragment),k5=d(),Je=o("div"),f(ya.$$.fragment),b5=d(),Tn=o("p"),y5=r("The "),Or=o("a"),w5=r("TFT5ForConditionalGeneration"),x5=r(" forward method, overrides the "),fl=o("code"),z5=r("__call__"),$5=r(" special method."),q5=d(),f(Qn.$$.fragment),E5=d(),_l=o("p"),j5=r("Examples:"),F5=d(),f(wa.$$.fragment),Lc=d(),vn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),M5=d(),Tl=o("span"),P5=r("TFT5EncoderModel"),Ac=d(),ce=o("div"),f(za.$$.fragment),C5=d(),vl=o("p"),O5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),L5=d(),$a=o("p"),A5=r("The T5 model was proposed in "),qa=o("a"),I5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),N5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),D5=d(),Ea=o("p"),S5=r("This model inherits from "),Lr=o("a"),G5=r("TFPreTrainedModel"),B5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),W5=d(),ja=o("p"),U5=r("This model is also a "),Fa=o("a"),R5=r("tf.keras.Model"),H5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V5=d(),f(to.$$.fragment),K5=d(),Xe=o("div"),f(Ma.$$.fragment),Y5=d(),kn=o("p"),Z5=r("The "),Ar=o("a"),J5=r("TFT5EncoderModel"),X5=r(" forward method, overrides the "),kl=o("code"),Q5=r("__call__"),ev=r(" special method."),tv=d(),f(no.$$.fragment),nv=d(),bl=o("p"),ov=r("Examples:"),sv=d(),f(Pa.$$.fragment),Ic=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),av=d(),wl=o("span"),rv=r("FlaxT5Model"),Nc=d(),lt=o("div"),f(Oa.$$.fragment),iv=d(),Qe=o("div"),f(La.$$.fragment),dv=d(),yn=o("p"),lv=r("The "),xl=o("code"),cv=r("FlaxT5PreTrainedModel"),pv=r("forward method, overrides the "),zl=o("code"),hv=r("__call__"),uv=r(" special method."),mv=d(),f(so.$$.fragment),fv=d(),$l=o("p"),_v=r("Example:"),gv=d(),f(Aa.$$.fragment),Tv=d(),Mt=o("div"),f(Ia.$$.fragment),vv=d(),ql=o("p"),kv=r("Example:"),bv=d(),f(Na.$$.fragment),yv=d(),Pt=o("div"),f(Da.$$.fragment),wv=d(),El=o("p"),xv=r("Example:"),zv=d(),f(Sa.$$.fragment),Dc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),$v=d(),Fl=o("span"),qv=r("FlaxT5ForConditionalGeneration"),Sc=d(),ct=o("div"),f(Ba.$$.fragment),Ev=d(),et=o("div"),f(Wa.$$.fragment),jv=d(),xn=o("p"),Fv=r("The "),Ml=o("code"),Mv=r("FlaxT5PreTrainedModel"),Pv=r("forward method, overrides the "),Pl=o("code"),Cv=r("__call__"),Ov=r(" special method."),Lv=d(),f(ro.$$.fragment),Av=d(),Cl=o("p"),Iv=r("Example:"),Nv=d(),f(Ua.$$.fragment),Dv=d(),Ct=o("div"),f(Ra.$$.fragment),Sv=d(),Ol=o("p"),Gv=r("Example:"),Bv=d(),f(Ha.$$.fragment),Wv=d(),Ot=o("div"),f(Va.$$.fragment),Uv=d(),Ll=o("p"),Rv=r("Example:"),Hv=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),$=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Al=a(w);z=s(Al,"SPAN",{});var Il=a(z);_(x.$$.fragment,Il),Il.forEach(t),Al.forEach(t),y=l(Ya),q=s(Ya,"SPAN",{});var Nl=a(q);qe=i(Nl,"T5"),Nl.forEach(t),Ya.forEach(t),oe=l(n),E=s(n,"H2",{class:!0});var Za=a(E);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Dl=a(ee);S=s(Dl,"SPAN",{});var Sl=a(S);_(se.$$.fragment,Sl),Sl.forEach(t),Dl.forEach(t),Ee=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),ke=l(n),B=s(n,"P",{});var Ja=a(B);I=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Bl=a(ae);pe=i(Bl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Bl.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),U=s(Nr,"EM",{});var ok=a(U);Oe=i(ok,"summarize: \u2026"),ok.forEach(t),m=i(Nr,"."),Nr.forEach(t),tk.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var sk=a(te);Se=s(sk,"P",{});var ak=a(Se);pt=i(ak,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ak.forEach(t),sk.forEach(t),D=l(Ir),Ge=s(Ir,"LI",{});var rk=a(Ge);ne=s(rk,"P",{});var io=a(ne);ht=i(io,"See the "),L=s(io,"A",{href:!0});var ik=a(L);Y=i(ik,"training"),ik.forEach(t),ut=i(io,", "),Le=s(io,"A",{href:!0});var dk=a(Le);Z=i(dk,"inference"),dk.forEach(t),mt=i(io," and "),Ae=s(io,"A",{href:!0});var lk=a(Ae);Ie=i(lk,"scripts"),lk.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rk.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var ck=a(Xa);Dp=i(ck,"T5 comes in different sizes:"),ck.forEach(t),Kl=l(n),Be=s(n,"UL",{});var Lt=a(Be);di=s(Lt,"LI",{});var pk=a(di);li=s(pk,"P",{});var hk=a(li);To=s(hk,"A",{href:!0,rel:!0});var uk=a(To);Sp=i(uk,"t5-small"),uk.forEach(t),hk.forEach(t),pk.forEach(t),Gp=l(Lt),ci=s(Lt,"LI",{});var mk=a(ci);pi=s(mk,"P",{});var fk=a(pi);vo=s(fk,"A",{href:!0,rel:!0});var _k=a(vo);Bp=i(_k,"t5-base"),_k.forEach(t),fk.forEach(t),mk.forEach(t),Wp=l(Lt),hi=s(Lt,"LI",{});var gk=a(hi);ui=s(gk,"P",{});var Tk=a(ui);ko=s(Tk,"A",{href:!0,rel:!0});var vk=a(ko);Up=i(vk,"t5-large"),vk.forEach(t),Tk.forEach(t),gk.forEach(t),Rp=l(Lt),mi=s(Lt,"LI",{});var kk=a(mi);fi=s(kk,"P",{});var bk=a(fi);bo=s(bk,"A",{href:!0,rel:!0});var yk=a(bo);Hp=i(yk,"t5-3b"),yk.forEach(t),bk.forEach(t),kk.forEach(t),Vp=l(Lt),_i=s(Lt,"LI",{});var wk=a(_i);Qa=s(wk,"P",{});var Vv=a(Qa);yo=s(Vv,"A",{href:!0,rel:!0});var xk=a(yo);Kp=i(xk,"t5-11b"),xk.forEach(t),Yp=i(Vv,"."),Vv.forEach(t),wk.forEach(t),Lt.forEach(t),Yl=l(n),er=s(n,"P",{});var zk=a(er);Zp=i(zk,"Based on the original T5 model, Google has released some follow-up works:"),zk.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Dr=a($t);gi=s(Dr,"LI",{});var $k=a(gi);zn=s($k,"P",{});var Ul=a(zn);Ti=s(Ul,"STRONG",{});var qk=a(Ti);Jp=i(qk,"T5v1.1"),qk.forEach(t),Xp=i(Ul,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Ok=a(or);lh=i(Ok,"here"),Ok.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pk.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Bc=a(En);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var Lk=a(wo);hh=i(Lk,"hub"),Lk.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Ak=a(xo);fh=i(Ak,"thomwolf"),Ak.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var Ik=a(zo);gh=i(Ik,"here"),Ik.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var Nk=a(jn);wi=s(Nk,"SPAN",{});var Dk=a(wi);_($o.$$.fragment,Dk),Dk.forEach(t),Nk.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var Sk=a(xi);kh=i(Sk,"Training"),Sk.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),Uc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var At=a(dt);Ei=s(At,"P",{});var Rk=a(Ei);Mh=i(Rk,"Unsupervised denoising training"),Rk.forEach(t),Ph=l(At),_e=s(At,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hk=a(ji);Oh=i(Hk,"a.k.a"),Hk.forEach(t),Lh=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var Vk=a(Fi);Ah=i(Vk,"real"),Vk.forEach(t),Ih=i(tt,` masked tokens. Each
...
`),rr=s(tt,"A",{href:!0});var Jk=a(rr);Uh=i(Jk,"T5Tokenizer"),Jk.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(At),Oi=s(At,"P",{});var Xk=a(Oi);Vh=i(Xk,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Xk.forEach(t),Kh=l(At),_(qo.$$.fragment,At),Yh=l(At),Eo=s(At,"P",{});var Hc=a(Eo);Zh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Qk=a(jo);Jh=i(Qk,"run_t5_mlm_flax.py"),Qk.forEach(t),Xh=i(Hc,` script in the Examples
