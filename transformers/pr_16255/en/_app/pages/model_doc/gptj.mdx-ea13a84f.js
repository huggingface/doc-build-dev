...
`),S=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),N=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ke=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
tensors in the first argument of the model call function: `),W=r(C,"CODE",{});var Se=i(W);fe=s(Se,"model(inputs)"),Se.forEach(t),ie=s(C,"."),C.forEach(t),L=d(h),A=r(h,"P",{});var xe=i(A);ee=s(xe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),xe.forEach(t),te=d(h),J=r(h,"UL",{});var z=i(J);x=r(z,"LI",{});var Q=i(x);ge=s(Q,"a single Tensor with "),U=r(Q,"CODE",{});var pe=i(U);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=r(D,"CODE",{});var Ne=i(S);Te=s(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ce=s(D," or "),N=r(D,"CODE",{});var we=i(N);B=s(we,"model([input_ids, attention_mask, token_type_ids])"),we.forEach(t),D.forEach(t),ve=d(z),q=r(z,"LI",{});var be=i(q);ke=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(be,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),be.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,v),e(v,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,J,G),e(J,x),e(x,ge),e(x,U),e(U,le),e(x,Y),e(x,H),e(H,oe),e(J,_e),e(J,M),e(M,de),e(M,S),e(S,Te),e(M,ce),e(M,N),e(N,B),e(J,ve),e(J,q),e(q,ke),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(J)}}}function cg(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,U,le,Y,H,oe,_e,M,de,S,Te,ce,N,B,ve,q,ke,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),U=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),N=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ke=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,U,le,Y,H,oe,_e,M,de,S,Te,ce,N,B,ve,q,ke,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),U=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),N=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ke=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,U,le,Y,H,oe,_e,M,de,S,Te,ce,N,B,ve,q,ke,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),U=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),N=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ke=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function vg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,U,le,Y,H,oe,_e,M,de,S,Te,ce,N,B,ve,q,ke,R,se,h,G,V,Ae,Ie,C,Le,Se,xe,z,Q,pe,Fe,D,Ne,we,be,De,Ks,pt,Ai,Jo,Ii,Li,Xs,Si,Ni,Ys,Di,Oi,Mr,$t,Kt,Zs,xo,Wi,ea,Bi,qr,Xt,Qi,ms,Ui,Hi,Cr,Mo,zr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,Co,Vi,oa,Ki,Lr,Ye,zo,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Sr,jt,Zt,sa,Lo,cl,aa,pl,Nr,ht,So,hl,No,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,vs,vl,kl,ra,wl,bl,yl,eo,Pl,ia,$l,Fl,Wo,Dr,Et,to,la,Bo,jl,da,Gl,Or,et,Qo,El,ca,Jl,xl,Uo,Ml,Ho,ql,Cl,zl,We,Ro,Al,Jt,Il,ks,Ll,Sl,pa,Nl,Dl,Ol,oo,Wl,ha,Bl,Ql,Vo,Wr,xt,no,ua,Ko,Ul,ma,Hl,Br,je,Xo,Rl,fa,Vl,Kl,ws,bs,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,va,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,ys,gd,_d,ka,Td,vd,kd,so,wd,wa,bd,yd,tn,Pd,on,$d,ba,Fd,jd,nn,Gd,sn,Qr,qt,ao,ya,an,Ed,Pa,Jd,Ur,ot,rn,xd,Ct,Md,$a,qd,Cd,Fa,zd,Ad,Id,ln,Ld,dn,Sd,Nd,Dd,Me,cn,Od,zt,Wd,Ps,Bd,Qd,ja,Ud,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,Ea,un,Zd,Ja,ec,Rr,Ge,mn,tc,xa,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,Be,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,vc,co,kc,qa,wc,bc,vn,Vr,Lt,po,Ca,kn,yc,za,Pc,Kr,Ee,wn,$c,Aa,Fc,jc,bn,Gc,js,Ec,Jc,xc,yn,Mc,Pn,qc,Cc,zc,ho,Ac,Qe,$n,Ic,St,Lc,Gs,Sc,Nc,Ia,Dc,Oc,Wc,uo,Bc,La,Qc,Uc,Fn,Xr,Nt,mo,Sa,jn,Hc,Na,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,Es,Js,Yc,Zc,ep,nt,tp,Oa,op,np,Wa,sp,ap,Ba,rp,ip,Qa,lp,dp,cp,En,pp,xs,hp,up,mp,Jn,fp,xn,gp,_p,Tp,fo,vp,qe,Mn,kp,Dt,wp,Ms,bp,yp,Ua,Pp,$p,Fp,go,jp,Ha,Gp,Ep,qn,Jp,Cn,Zr,Ot,_o,Ra,zn,xp,Va,Mp,ei,Je,An,qp,Wt,Cp,Ka,zp,Ap,Xa,Ip,Lp,Sp,In,Np,qs,Dp,Op,Wp,Ln,Bp,Sn,Qp,Up,Hp,To,Rp,Ce,Nn,Vp,Bt,Kp,Cs,Xp,Yp,Ya,Zp,eh,th,vo,oh,Za,nh,sh,Dn,ah,On,ti,Qt,ko,er,Wn,rh,tr,ih,oi,ye,Bn,lh,or,dh,ch,Qn,ph,zs,hh,uh,mh,Un,fh,Hn,gh,_h,Th,nr,vh,kh,ut,sr,Rn,wh,bh,ar,Vn,yh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Ue,Yn,Eh,Ut,Jh,lr,xh,Mh,dr,qh,Ch,zh,wo,Ah,cr,Ih,Lh,Zn,ni,Ht,bo,pr,es,Sh,hr,Nh,si,Pe,ts,Dh,ur,Oh,Wh,os,Bh,As,Qh,Uh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,vr,cu,pu,kr,hu,uu,mu,yo,fu,wr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),z=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Bo=new Xe({}),Qo=new re({props:{name:"class transformers.GPTJForCausalLM",anchor:"transformers.GPTJForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/gptj/modeling_gptj.py#L689",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16255/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=a("meta"),F=l(),f=a("h1"),_=a("a"),v=a("span"),k(T.$$.fragment),g=l(),j=a("span"),ue=n("GPT-J"),K=l(),E=a("h2"),X=a("a"),O=a("span"),k(Z.$$.fragment),me=l(),W=a("span"),fe=n("Overview"),ie=l(),L=a("p"),A=n("The GPT-J model was released in the "),ee=a("a"),te=n("kingoflolz/mesh-transformer-jax"),J=n(` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),x=a("a"),ge=n("the Pile"),U=n(" dataset."),le=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),_e=n("Stella Biderman"),M=n("."),de=l(),S=a("p"),Te=n("Tips:"),ce=l(),N=a("ul"),B=a("li"),ve=n("To load "),q=a("a"),ke=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
usage to 1x. There is also a `),C=a("a"),Le=n("fp16 branch"),Se=n(` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),xe=l(),k(z.$$.fragment),Q=l(),pe=a("ul"),Fe=a("li"),D=a("p"),Ne=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
...
`),Xs=a("code"),Si=n("<|extratoken_1|>... <|extratoken_143|>"),Ni=n(", so the "),Ys=a("code"),Di=n("vocab_size"),Oi=n(" of tokenizer also becomes 50400."),Mr=l(),$t=a("h3"),Kt=a("a"),Zs=a("span"),k(xo.$$.fragment),Wi=l(),ea=a("span"),Bi=n("Generation"),qr=l(),Xt=a("p"),Qi=n("The "),ms=a("a"),Ui=n("generate()"),Hi=n(` method can be used to generate text using GPT-J
model.`),Cr=l(),k(Mo.$$.fragment),zr=l(),fs=a("p"),Ri=n("\u2026or in float16 precision:"),Ar=l(),k(qo.$$.fragment),Ir=l(),Ft=a("h2"),Yt=a("a"),ta=a("span"),k(Co.$$.fragment),Vi=l(),oa=a("span"),Ki=n("GPTJConfig"),Lr=l(),Ye=a("div"),k(zo.$$.fragment),Xi=l(),Ze=a("p"),Yi=n("This is the configuration class to store the configuration of a "),gs=a("a"),Zi=n("GPTJModel"),el=n(`. It is used to instantiate a GPT-J
...
behavior.`),gl=l(),Oe=a("div"),k(Oo.$$.fragment),_l=l(),Gt=a("p"),Tl=n("The "),vs=a("a"),vl=n("GPTJModel"),kl=n(" forward method, overrides the "),ra=a("code"),wl=n("__call__"),bl=n(" special method."),yl=l(),k(eo.$$.fragment),Pl=l(),ia=a("p"),$l=n("Example:"),Fl=l(),k(Wo.$$.fragment),Dr=l(),Et=a("h2"),to=a("a"),la=a("span"),k(Bo.$$.fragment),jl=l(),da=a("span"),Gl=n("GPTJForCausalLM"),Or=l(),et=a("div"),k(Qo.$$.fragment),El=l(),ca=a("p"),Jl=n("The GPT-J Model transformer with a language modeling head on top."),xl=l(),Uo=a("p"),Ml=n("This model is a PyTorch "),Ho=a("a"),ql=n("torch.nn.Module"),Cl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=l(),We=a("div"),k(Ro.$$.fragment),Al=l(),Jt=a("p"),Il=n("The "),ks=a("a"),Ll=n("GPTJForCausalLM"),Sl=n(" forward method, overrides the "),pa=a("code"),Nl=n("__call__"),Dl=n(" special method."),Ol=l(),k(oo.$$.fragment),Wl=l(),ha=a("p"),Bl=n("Example:"),Ql=l(),k(Vo.$$.fragment),Wr=l(),xt=a("h2"),no=a("a"),ua=a("span"),k(Ko.$$.fragment),Ul=l(),ma=a("span"),Hl=n("GPTJForSequenceClassification"),Br=l(),je=a("div"),k(Xo.$$.fragment),Rl=l(),fa=a("p"),Vl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Kl=l(),ws=a("p"),bs=a("a"),Xl=n("GPTJForSequenceClassification"),Yl=n(` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),k(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),ys=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),ka=a("code"),Td=n("__call__"),vd=n(" special method."),kd=l(),k(so.$$.fragment),wd=l(),wa=a("p"),bd=n("Example of single-label classification:"),yd=l(),k(tn.$$.fragment),Pd=l(),k(on.$$.fragment),$d=l(),ba=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),k(nn.$$.fragment),Gd=l(),k(sn.$$.fragment),Qr=l(),qt=a("h2"),ao=a("a"),ya=a("span"),k(an.$$.fragment),Ed=l(),Pa=a("span"),Jd=n("GPTJForQuestionAnswering"),Ur=l(),ot=a("div"),k(rn.$$.fragment),xd=l(),Ct=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),$a=a("code"),qd=n("span start logits"),Cd=n(" and "),Fa=a("code"),zd=n("span end logits"),Ad=n(")."),Id=l(),ln=a("p"),Ld=n("This model is a PyTorch "),dn=a("a"),Sd=n("torch.nn.Module"),Nd=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dd=l(),Me=a("div"),k(cn.$$.fragment),Od=l(),zt=a("p"),Wd=n("The "),Ps=a("a"),Bd=n("GPTJForQuestionAnswering"),Qd=n(" forward method, overrides the "),ja=a("code"),Ud=n("__call__"),Hd=n(" special method."),Rd=l(),k(ro.$$.fragment),Vd=l(),Ga=a("p"),Kd=n("Example:"),Xd=l(),k(pn.$$.fragment),Yd=l(),k(hn.$$.fragment),Hr=l(),At=a("h2"),io=a("a"),Ea=a("span"),k(un.$$.fragment),Zd=l(),Ja=a("span"),ec=n("TFGPTJModel"),Rr=l(),Ge=a("div"),k(mn.$$.fragment),tc=l(),xa=a("p"),oc=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),nc=l(),fn=a("p"),sc=n("This model inherits from "),$s=a("a"),ac=n("TFPreTrainedModel"),rc=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),pc=l(),k(lo.$$.fragment),hc=l(),Be=a("div"),k(Tn.$$.fragment),uc=l(),It=a("p"),mc=n("The "),Fs=a("a"),fc=n("TFGPTJModel"),gc=n(" forward method, overrides the "),Ma=a("code"),_c=n("__call__"),Tc=n(" special method."),vc=l(),k(co.$$.fragment),kc=l(),qa=a("p"),wc=n("Example:"),bc=l(),k(vn.$$.fragment),Vr=l(),Lt=a("h2"),po=a("a"),Ca=a("span"),k(kn.$$.fragment),yc=l(),za=a("span"),Pc=n("TFGPTJForCausalLM"),Kr=l(),Ee=a("div"),k(wn.$$.fragment),$c=l(),Aa=a("p"),Fc=n("The GPT-J Model transformer with a language modeling head on top."),jc=l(),bn=a("p"),Gc=n("This model inherits from "),js=a("a"),Ec=n("TFPreTrainedModel"),Jc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xc=l(),yn=a("p"),Mc=n("This model is also a "),Pn=a("a"),qc=n("tf.keras.Model"),Cc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zc=l(),k(ho.$$.fragment),Ac=l(),Qe=a("div"),k($n.$$.fragment),Ic=l(),St=a("p"),Lc=n("The "),Gs=a("a"),Sc=n("TFGPTJForCausalLM"),Nc=n(" forward method, overrides the "),Ia=a("code"),Dc=n("__call__"),Oc=n(" special method."),Wc=l(),k(uo.$$.fragment),Bc=l(),La=a("p"),Qc=n("Example:"),Uc=l(),k(Fn.$$.fragment),Xr=l(),Nt=a("h2"),mo=a("a"),Sa=a("span"),k(jn.$$.fragment),Hc=l(),Na=a("span"),Rc=n("TFGPTJForSequenceClassification"),Yr=l(),ae=a("div"),k(Gn.$$.fragment),Vc=l(),Da=a("p"),Kc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Xc=l(),Es=a("p"),Js=a("a"),Yc=n("GPTJForSequenceClassification"),Zc=n(` uses the last token in order to do the classification, as other causal models
...
padding tokens when `),Ba=a("code"),rp=n("inputs_embeds"),ip=n(" are passed instead of "),Qa=a("code"),lp=n("input_ids"),dp=n(`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),k(fo.$$.fragment),vp=l(),qe=a("div"),k(Mn.$$.fragment),kp=l(),Dt=a("p"),wp=n("The "),Ms=a("a"),bp=n("TFGPTJForSequenceClassification"),yp=n(" forward method, overrides the "),Ua=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),k(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),Ep=l(),k(qn.$$.fragment),Jp=l(),k(Cn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),k(zn.$$.fragment),xp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),Je=a("div"),k(An.$$.fragment),qp=l(),Wt=a("p"),Cp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ka=a("code"),zp=n("span start logits"),Ap=n(" and "),Xa=a("code"),Ip=n("span end logits"),Lp=n(")."),Sp=l(),In=a("p"),Np=n("This model inherits from "),qs=a("a"),Dp=n("TFPreTrainedModel"),Op=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wp=l(),Ln=a("p"),Bp=n("This model is also a "),Sn=a("a"),Qp=n("tf.keras.Model"),Up=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp=l(),k(To.$$.fragment),Rp=l(),Ce=a("div"),k(Nn.$$.fragment),Vp=l(),Bt=a("p"),Kp=n("The "),Cs=a("a"),Xp=n("TFGPTJForQuestionAnswering"),Yp=n(" forward method, overrides the "),Ya=a("code"),Zp=n("__call__"),eh=n(" special method."),th=l(),k(vo.$$.fragment),oh=l(),Za=a("p"),nh=n("Example:"),sh=l(),k(Dn.$$.fragment),ah=l(),k(On.$$.fragment),ti=l(),Qt=a("h2"),ko=a("a"),er=a("span"),k(Wn.$$.fragment),rh=l(),tr=a("span"),ih=n("FlaxGPTJModel"),oi=l(),ye=a("div"),k(Bn.$$.fragment),lh=l(),or=a("p"),dh=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),ch=l(),Qn=a("p"),ph=n("This model inherits from "),zs=a("a"),hh=n("FlaxPreTrainedModel"),uh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mh=l(),Un=a("p"),fh=n(`This model is also a Flax Linen
`),Hn=a("a"),gh=n("flax.nn.Module"),_h=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Th=l(),nr=a("p"),vh=n("Finally, this model supports inherent JAX features such as:"),kh=l(),ut=a("ul"),sr=a("li"),Rn=a("a"),wh=n("Just-In-Time (JIT) compilation"),bh=l(),ar=a("li"),Vn=a("a"),yh=n("Automatic Differentiation"),Ph=l(),rr=a("li"),Kn=a("a"),$h=n("Vectorization"),Fh=l(),ir=a("li"),Xn=a("a"),jh=n("Parallelization"),Gh=l(),Ue=a("div"),k(Yn.$$.fragment),Eh=l(),Ut=a("p"),Jh=n("The "),lr=a("code"),xh=n("FlaxGPTJPreTrainedModel"),Mh=n("forward method, overrides the "),dr=a("code"),qh=n("__call__"),Ch=n(" special method."),zh=l(),k(wo.$$.fragment),Ah=l(),cr=a("p"),Ih=n("Example:"),Lh=l(),k(Zn.$$.fragment),ni=l(),Ht=a("h2"),bo=a("a"),pr=a("span"),k(es.$$.fragment),Sh=l(),hr=a("span"),Nh=n("FlaxGPTJForCausalLM"),si=l(),Pe=a("div"),k(ts.$$.fragment),Dh=l(),ur=a("p"),Oh=n("The GPTJ Model transformer with a language modeling head on top."),Wh=l(),os=a("p"),Bh=n("This model inherits from "),As=a("a"),Qh=n("FlaxPreTrainedModel"),Uh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh=l(),ns=a("p"),Rh=n(`This model is also a Flax Linen
`),ss=a("a"),Vh=n("flax.nn.Module"),Kh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Xh=l(),mr=a("p"),Yh=n("Finally, this model supports inherent JAX features such as:"),Zh=l(),mt=a("ul"),fr=a("li"),as=a("a"),eu=n("Just-In-Time (JIT) compilation"),tu=l(),gr=a("li"),rs=a("a"),ou=n("Automatic Differentiation"),nu=l(),_r=a("li"),is=a("a"),su=n("Vectorization"),au=l(),Tr=a("li"),ls=a("a"),ru=n("Parallelization"),iu=l(),He=a("div"),k(ds.$$.fragment),lu=l(),Rt=a("p"),du=n("The "),vr=a("code"),cu=n("FlaxGPTJPreTrainedModel"),pu=n("forward method, overrides the "),kr=a("code"),hu=n("__call__"),uu=n(" special method."),mu=l(),k(yo.$$.fragment),fu=l(),wr=a("p"),gu=n("Example:"),_u=l(),k(cs.$$.fragment),this.h()},l(o){const m=ng('[data-svelte="svelte-1phssyn"]',document.head);p=r(m,"META",{name:!0,content:!0}),m.forEach(t),F=d(o),f=r(o,"H1",{class:!0});var ps=i(f);_=r(ps,"A",{id:!0,class:!0,href:!0});var br=i(_);v=r(br,"SPAN",{});var yr=i(v);w(T.$$.fragment,yr),yr.forEach(t),br.forEach(t),g=d(ps),j=r(ps,"SPAN",{});var Pr=i(j);ue=s(Pr,"GPT-J"),Pr.forEach(t),ps.forEach(t),K=d(o),E=r(o,"H2",{class:!0});var hs=i(E);X=r(hs,"A",{id:!0,class:!0,href:!0});var $r=i(X);O=r($r,"SPAN",{});var Fr=i(O);w(Z.$$.fragment,Fr),Fr.forEach(t),$r.forEach(t),me=d(hs),W=r(hs,"SPAN",{});var jr=i(W);fe=s(jr,"Overview"),jr.forEach(t),hs.forEach(t),ie=d(o),L=r(o,"P",{});var Vt=i(L);A=s(Vt,"The GPT-J model was released in the "),ee=r(Vt,"A",{href:!0,rel:!0});var Gr=i(ee);te=s(Gr,"kingoflolz/mesh-transformer-jax"),Gr.forEach(t),J=s(Vt,` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),x=r(Vt,"A",{href:!0,rel:!0});var Er=i(x);ge=s(Er,"the Pile"),Er.forEach(t),U=s(Vt," dataset."),Vt.forEach(t),le=d(o),Y=r(o,"P",{});var us=i(Y);H=s(us,"This model was contributed by "),oe=r(us,"A",{href:!0,rel:!0});var Jr=i(oe);_e=s(Jr,"Stella Biderman"),Jr.forEach(t),M=s(us,"."),us.forEach(t),de=d(o),S=r(o,"P",{});var xr=i(S);Te=s(xr,"Tips:"),xr.forEach(t),ce=d(o),N=r(o,"UL",{});var wu=i(N);B=r(wu,"LI",{});var ft=i(B);ve=s(ft,"To load "),q=r(ft,"A",{href:!0,rel:!0});var bu=i(q);ke=s(bu,"GPT-J"),bu.forEach(t),R=s(ft,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
...
usage to 1x. There is also a `),C=r(ft,"A",{href:!0,rel:!0});var $u=i(C);Le=s($u,"fp16 branch"),$u.forEach(t),Se=s(ft,` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),ft.forEach(t),wu.forEach(t),xe=d(o),w(z.$$.fragment,o),Q=d(o),pe=r(o,"UL",{});var ri=i(pe);Fe=r(ri,"LI",{});var Fu=i(Fe);D=r(Fu,"P",{});var Tu=i(D);Ne=s(Tu,`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
...
`),Xs=r(Po,"CODE",{});var Ju=i(Xs);Si=s(Ju,"<|extratoken_1|>... <|extratoken_143|>"),Ju.forEach(t),Ni=s(Po,", so the "),Ys=r(Po,"CODE",{});var xu=i(Ys);Di=s(xu,"vocab_size"),xu.forEach(t),Oi=s(Po," of tokenizer also becomes 50400."),Po.forEach(t),Gu.forEach(t),ri.forEach(t),Mr=d(o),$t=r(o,"H3",{class:!0});var ii=i($t);Kt=r(ii,"A",{id:!0,class:!0,href:!0});var Mu=i(Kt);Zs=r(Mu,"SPAN",{});var qu=i(Zs);w(xo.$$.fragment,qu),qu.forEach(t),Mu.forEach(t),Wi=d(ii),ea=r(ii,"SPAN",{});var Cu=i(ea);Bi=s(Cu,"Generation"),Cu.forEach(t),ii.forEach(t),qr=d(o),Xt=r(o,"P",{});var li=i(Xt);Qi=s(li,"The "),ms=r(li,"A",{href:!0});var zu=i(ms);Ui=s(zu,"generate()"),zu.forEach(t),Hi=s(li,` method can be used to generate text using GPT-J
model.`),li.forEach(t),Cr=d(o),w(Mo.$$.fragment,o),zr=d(o),fs=r(o,"P",{});var Au=i(fs);Ri=s(Au,"\u2026or in float16 precision:"),Au.forEach(t),Ar=d(o),w(qo.$$.fragment,o),Ir=d(o),Ft=r(o,"H2",{class:!0});var di=i(Ft);Yt=r(di,"A",{id:!0,class:!0,href:!0});var Iu=i(Yt);ta=r(Iu,"SPAN",{});var Lu=i(ta);w(Co.$$.fragment,Lu),Lu.forEach(t),Iu.forEach(t),Vi=d(di),oa=r(di,"SPAN",{});var Su=i(oa);Ki=s(Su,"GPTJConfig"),Su.forEach(t),di.forEach(t),Lr=d(o),Ye=r(o,"DIV",{class:!0});var $o=i(Ye);w(zo.$$.fragment,$o),Xi=d($o),Ze=r($o,"P",{});var gt=i(Ze);Yi=s(gt,"This is the configuration class to store the configuration of a "),gs=r(gt,"A",{href:!0});var Nu=i(gs);Zi=s(Nu,"GPTJModel"),Nu.forEach(t),el=s(gt,`. It is used to instantiate a GPT-J
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
...
for more information.`),gt.forEach(t),il=d($o),na=r($o,"P",{});var Bu=i(na);ll=s(Bu,"Example:"),Bu.forEach(t),dl=d($o),w(Io.$$.fragment,$o),$o.forEach(t),Sr=d(o),jt=r(o,"H2",{class:!0});var ci=i(jt);Zt=r(ci,"A",{id:!0,class:!0,href:!0});var Qu=i(Zt);sa=r(Qu,"SPAN",{});var Uu=i(sa);w(Lo.$$.fragment,Uu),Uu.forEach(t),Qu.forEach(t),cl=d(ci),aa=r(ci,"SPAN",{});var Hu=i(aa);pl=s(Hu,"GPTJModel"),Hu.forEach(t),ci.forEach(t),Nr=d(o),ht=r(o,"DIV",{class:!0});var Is=i(ht);w(So.$$.fragment,Is),hl=d(Is),No=r(Is,"P",{});var pi=i(No);ul=s(pi,`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Do=r(pi,"A",{href:!0,rel:!0});var Ru=i(Do);ml=s(Ru,"torch.nn.Module"),Ru.forEach(t),fl=s(pi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pi.forEach(t),gl=d(Is),Oe=r(Is,"DIV",{class:!0});var _t=i(Oe);w(Oo.$$.fragment,_t),_l=d(_t),Gt=r(_t,"P",{});var Ls=i(Gt);Tl=s(Ls,"The "),vs=r(Ls,"A",{href:!0});var Vu=i(vs);vl=s(Vu,"GPTJModel"),Vu.forEach(t),kl=s(Ls," forward method, overrides the "),ra=r(Ls,"CODE",{});var Ku=i(ra);wl=s(Ku,"__call__"),Ku.forEach(t),bl=s(Ls," special method."),Ls.forEach(t),yl=d(_t),w(eo.$$.fragment,_t),Pl=d(_t),ia=r(_t,"P",{});var Xu=i(ia);$l=s(Xu,"Example:"),Xu.forEach(t),Fl=d(_t),w(Wo.$$.fragment,_t),_t.forEach(t),Is.forEach(t),Dr=d(o),Et=r(o,"H2",{class:!0});var hi=i(Et);to=r(hi,"A",{id:!0,class:!0,href:!0});var Yu=i(to);la=r(Yu,"SPAN",{});var Zu=i(la);w(Bo.$$.fragment,Zu),Zu.forEach(t),Yu.forEach(t),jl=d(hi),da=r(hi,"SPAN",{});var em=i(da);Gl=s(em,"GPTJForCausalLM"),em.forEach(t),hi.forEach(t),Or=d(o),et=r(o,"DIV",{class:!0});var Fo=i(et);w(Qo.$$.fragment,Fo),El=d(Fo),ca=r(Fo,"P",{});var tm=i(ca);Jl=s(tm,"The GPT-J Model transformer with a language modeling head on top."),tm.forEach(t),xl=d(Fo),Uo=r(Fo,"P",{});var ui=i(Uo);Ml=s(ui,"This model is a PyTorch "),Ho=r(ui,"A",{href:!0,rel:!0});var om=i(Ho);ql=s(om,"torch.nn.Module"),om.forEach(t),Cl=s(ui,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ui.forEach(t),zl=d(Fo),We=r(Fo,"DIV",{class:!0});var Tt=i(We);w(Ro.$$.fragment,Tt),Al=d(Tt),Jt=r(Tt,"P",{});var Ss=i(Jt);Il=s(Ss,"The "),ks=r(Ss,"A",{href:!0});var nm=i(ks);Ll=s(nm,"GPTJForCausalLM"),nm.forEach(t),Sl=s(Ss," forward method, overrides the "),pa=r(Ss,"CODE",{});var sm=i(pa);Nl=s(sm,"__call__"),sm.forEach(t),Dl=s(Ss," special method."),Ss.forEach(t),Ol=d(Tt),w(oo.$$.fragment,Tt),Wl=d(Tt),ha=r(Tt,"P",{});var am=i(ha);Bl=s(am,"Example:"),am.forEach(t),Ql=d(Tt),w(Vo.$$.fragment,Tt),Tt.forEach(t),Fo.forEach(t),Wr=d(o),xt=r(o,"H2",{class:!0});var mi=i(xt);no=r(mi,"A",{id:!0,class:!0,href:!0});var rm=i(no);ua=r(rm,"SPAN",{});var im=i(ua);w(Ko.$$.fragment,im),im.forEach(t),rm.forEach(t),Ul=d(mi),ma=r(mi,"SPAN",{});var lm=i(ma);Hl=s(lm,"GPTJForSequenceClassification"),lm.forEach(t),mi.forEach(t),Br=d(o),je=r(o,"DIV",{class:!0});var st=i(je);w(Xo.$$.fragment,st),Rl=d(st),fa=r(st,"P",{});var dm=i(fa);Vl=s(dm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),dm.forEach(t),Kl=d(st),ws=r(st,"P",{});var vu=i(ws);bs=r(vu,"A",{href:!0});var cm=i(bs);Xl=s(cm,"GPTJForSequenceClassification"),cm.forEach(t),Yl=s(vu,` uses the last token in order to do the classification, as other causal models
...
SQuAD (a linear layers on top of the hidden-states output to compute `),$a=r(Ds,"CODE",{});var ym=i($a);qd=s(ym,"span start logits"),ym.forEach(t),Cd=s(Ds," and "),Fa=r(Ds,"CODE",{});var Pm=i(Fa);zd=s(Pm,"span end logits"),Pm.forEach(t),Ad=s(Ds,")."),Ds.forEach(t),Id=d(jo),ln=r(jo,"P",{});var _i=i(ln);Ld=s(_i,"This model is a PyTorch "),dn=r(_i,"A",{href:!0,rel:!0});var $m=i(dn);Sd=s($m,"torch.nn.Module"),$m.forEach(t),Nd=s(_i,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_i.forEach(t),Dd=d(jo),Me=r(jo,"DIV",{class:!0});var at=i(Me);w(cn.$$.fragment,at),Od=d(at),zt=r(at,"P",{});var Os=i(zt);Wd=s(Os,"The "),Ps=r(Os,"A",{href:!0});var Fm=i(Ps);Bd=s(Fm,"GPTJForQuestionAnswering"),Fm.forEach(t),Qd=s(Os," forward method, overrides the "),ja=r(Os,"CODE",{});var jm=i(ja);Ud=s(jm,"__call__"),jm.forEach(t),Hd=s(Os," special method."),Os.forEach(t),Rd=d(at),w(ro.$$.fragment,at),Vd=d(at),Ga=r(at,"P",{});var Gm=i(Ga);Kd=s(Gm,"Example:"),Gm.forEach(t),Xd=d(at),w(pn.$$.fragment,at),Yd=d(at),w(hn.$$.fragment,at),at.forEach(t),jo.forEach(t),Hr=d(o),At=r(o,"H2",{class:!0});var Ti=i(At);io=r(Ti,"A",{id:!0,class:!0,href:!0});var Em=i(io);Ea=r(Em,"SPAN",{});var Jm=i(Ea);w(un.$$.fragment,Jm),Jm.forEach(t),Em.forEach(t),Zd=d(Ti),Ja=r(Ti,"SPAN",{});var xm=i(Ja);ec=s(xm,"TFGPTJModel"),xm.forEach(t),Ti.forEach(t),Rr=d(o),Ge=r(o,"DIV",{class:!0});var rt=i(Ge);w(mn.$$.fragment,rt),tc=d(rt),xa=r(rt,"P",{});var Mm=i(xa);oc=s(Mm,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Mm.forEach(t),nc=d(rt),fn=r(rt,"P",{});var vi=i(fn);sc=s(vi,"This model inherits from "),$s=r(vi,"A",{href:!0});var qm=i($s);ac=s(qm,"TFPreTrainedModel"),qm.forEach(t),rc=s(vi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vi.forEach(t),ic=d(rt),gn=r(rt,"P",{});var ki=i(gn);lc=s(ki,"This model is also a "),_n=r(ki,"A",{href:!0,rel:!0});var Cm=i(_n);dc=s(Cm,"tf.keras.Model"),Cm.forEach(t),cc=s(ki,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ki.forEach(t),pc=d(rt),w(lo.$$.fragment,rt),hc=d(rt),Be=r(rt,"DIV",{class:!0});var kt=i(Be);w(Tn.$$.fragment,kt),uc=d(kt),It=r(kt,"P",{});var Ws=i(It);mc=s(Ws,"The "),Fs=r(Ws,"A",{href:!0});var zm=i(Fs);fc=s(zm,"TFGPTJModel"),zm.forEach(t),gc=s(Ws," forward method, overrides the "),Ma=r(Ws,"CODE",{});var Am=i(Ma);_c=s(Am,"__call__"),Am.forEach(t),Tc=s(Ws," special method."),Ws.forEach(t),vc=d(kt),w(co.$$.fragment,kt),kc=d(kt),qa=r(kt,"P",{});var Im=i(qa);wc=s(Im,"Example:"),Im.forEach(t),bc=d(kt),w(vn.$$.fragment,kt),kt.forEach(t),rt.forEach(t),Vr=d(o),Lt=r(o,"H2",{class:!0});var wi=i(Lt);po=r(wi,"A",{id:!0,class:!0,href:!0});var Lm=i(po);Ca=r(Lm,"SPAN",{});var Sm=i(Ca);w(kn.$$.fragment,Sm),Sm.forEach(t),Lm.forEach(t),yc=d(wi),za=r(wi,"SPAN",{});var Nm=i(za);Pc=s(Nm,"TFGPTJForCausalLM"),Nm.forEach(t),wi.forEach(t),Kr=d(o),Ee=r(o,"DIV",{class:!0});var it=i(Ee);w(wn.$$.fragment,it),$c=d(it),Aa=r(it,"P",{});var Dm=i(Aa);Fc=s(Dm,"The GPT-J Model transformer with a language modeling head on top."),Dm.forEach(t),jc=d(it),bn=r(it,"P",{});var bi=i(bn);Gc=s(bi,"This model inherits from "),js=r(bi,"A",{href:!0});var Om=i(js);Ec=s(Om,"TFPreTrainedModel"),Om.forEach(t),Jc=s(bi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bi.forEach(t),xc=d(it),yn=r(it,"P",{});var yi=i(yn);Mc=s(yi,"This model is also a "),Pn=r(yi,"A",{href:!0,rel:!0});var Wm=i(Pn);qc=s(Wm,"tf.keras.Model"),Wm.forEach(t),Cc=s(yi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yi.forEach(t),zc=d(it),w(ho.$$.fragment,it),Ac=d(it),Qe=r(it,"DIV",{class:!0});var wt=i(Qe);w($n.$$.fragment,wt),Ic=d(wt),St=r(wt,"P",{});var Bs=i(St);Lc=s(Bs,"The "),Gs=r(Bs,"A",{href:!0});var Bm=i(Gs);Sc=s(Bm,"TFGPTJForCausalLM"),Bm.forEach(t),Nc=s(Bs," forward method, overrides the "),Ia=r(Bs,"CODE",{});var Qm=i(Ia);Dc=s(Qm,"__call__"),Qm.forEach(t),Oc=s(Bs," special method."),Bs.forEach(t),Wc=d(wt),w(uo.$$.fragment,wt),Bc=d(wt),La=r(wt,"P",{});var Um=i(La);Qc=s(Um,"Example:"),Um.forEach(t),Uc=d(wt),w(Fn.$$.fragment,wt),wt.forEach(t),it.forEach(t),Xr=d(o),Nt=r(o,"H2",{class:!0});var Pi=i(Nt);mo=r(Pi,"A",{id:!0,class:!0,href:!0});var Hm=i(mo);Sa=r(Hm,"SPAN",{});var Rm=i(Sa);w(jn.$$.fragment,Rm),Rm.forEach(t),Hm.forEach(t),Hc=d(Pi),Na=r(Pi,"SPAN",{});var Vm=i(Na);Rc=s(Vm,"TFGPTJForSequenceClassification"),Vm.forEach(t),Pi.forEach(t),Yr=d(o),ae=r(o,"DIV",{class:!0});var ze=i(ae);w(Gn.$$.fragment,ze),Vc=d(ze),Da=r(ze,"P",{});var Km=i(Da);Kc=s(Km,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Km.forEach(t),Xc=d(ze),Es=r(ze,"P",{});var ku=i(Es);Js=r(ku,"A",{href:!0});var Xm=i(Js);Yc=s(Xm,"GPTJForSequenceClassification"),Xm.forEach(t),Zc=s(ku,` uses the last token in order to do the classification, as other causal models
(e.g. GPT, GPT-2, GPT-Neo) do.`),ku.forEach(t),ep=d(ze),nt=r(ze,"P",{});var bt=i(nt);tp=s(bt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
no `),Wa=r(bt,"CODE",{});var Zm=i(Wa);sp=s(Zm,"pad_token_id"),Zm.forEach(t),ap=s(bt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Ba=r(bt,"CODE",{});var ef=i(Ba);rp=s(ef,"inputs_embeds"),ef.forEach(t),ip=s(bt," are passed instead of "),Qa=r(bt,"CODE",{});var tf=i(Qa);lp=s(tf,"input_ids"),tf.forEach(t),dp=s(bt,`, it does the same (take the last value in
each row of the batch).`),bt.forEach(t),cp=d(ze),En=r(ze,"P",{});var $i=i(En);pp=s($i,"This model inherits from "),xs=r($i,"A",{href:!0});var of=i(xs);hp=s(of,"TFPreTrainedModel"),of.forEach(t),up=s($i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(ze),w(fo.$$.fragment,ze),vp=d(ze),qe=r(ze,"DIV",{class:!0});var lt=i(qe);w(Mn.$$.fragment,lt),kp=d(lt),Dt=r(lt,"P",{});var Qs=i(Dt);wp=s(Qs,"The "),Ms=r(Qs,"A",{href:!0});var sf=i(Ms);bp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),yp=s(Qs," forward method, overrides the "),Ua=r(Qs,"CODE",{});var af=i(Ua);Pp=s(af,"__call__"),af.forEach(t),$p=s(Qs," special method."),Qs.forEach(t),Fp=d(lt),w(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),Ep=d(lt),w(qn.$$.fragment,lt),Jp=d(lt),w(Cn.$$.fragment,lt),lt.forEach(t),ze.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);w(zn.$$.fragment,df),df.forEach(t),lf.forEach(t),xp=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),Je=r(o,"DIV",{class:!0});var dt=i(Je);w(An.$$.fragment,dt),qp=d(dt),Wt=r(dt,"P",{});var Us=i(Wt);Cp=s(Us,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ka=r(Us,"CODE",{});var pf=i(Ka);zp=s(pf,"span start logits"),pf.forEach(t),Ap=s(Us," and "),Xa=r(Us,"CODE",{});var hf=i(Xa);Ip=s(hf,"span end logits"),hf.forEach(t),Lp=s(Us,")."),Us.forEach(t),Sp=d(dt),In=r(dt,"P",{});var Gi=i(In);Np=s(Gi,"This model inherits from "),qs=r(Gi,"A",{href:!0});var uf=i(qs);Dp=s(uf,"TFPreTrainedModel"),uf.forEach(t),Op=s(Gi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gi.forEach(t),Wp=d(dt),Ln=r(dt,"P",{});var Ei=i(Ln);Bp=s(Ei,"This model is also a "),Sn=r(Ei,"A",{href:!0,rel:!0});var mf=i(Sn);Qp=s(mf,"tf.keras.Model"),mf.forEach(t),Up=s(Ei,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Hp=d(dt),w(To.$$.fragment,dt),Rp=d(dt),Ce=r(dt,"DIV",{class:!0});var ct=i(Ce);w(Nn.$$.fragment,ct),Vp=d(ct),Bt=r(ct,"P",{});var Hs=i(Bt);Kp=s(Hs,"The "),Cs=r(Hs,"A",{href:!0});var ff=i(Cs);Xp=s(ff,"TFGPTJForQuestionAnswering"),ff.forEach(t),Yp=s(Hs," forward method, overrides the "),Ya=r(Hs,"CODE",{});var gf=i(Ya);Zp=s(gf,"__call__"),gf.forEach(t),eh=s(Hs," special method."),Hs.forEach(t),th=d(ct),w(vo.$$.fragment,ct),oh=d(ct),Za=r(ct,"P",{});var _f=i(Za);nh=s(_f,"Example:"),_f.forEach(t),sh=d(ct),w(Dn.$$.fragment,ct),ah=d(ct),w(On.$$.fragment,ct),ct.forEach(t),dt.forEach(t),ti=d(o),Qt=r(o,"H2",{class:!0});var Ji=i(Qt);ko=r(Ji,"A",{id:!0,class:!0,href:!0});var Tf=i(ko);er=r(Tf,"SPAN",{});var vf=i(er);w(Wn.$$.fragment,vf),vf.forEach(t),Tf.forEach(t),rh=d(Ji),tr=r(Ji,"SPAN",{});var kf=i(tr);ih=s(kf,"FlaxGPTJModel"),kf.forEach(t),Ji.forEach(t),oi=d(o),ye=r(o,"DIV",{class:!0});var Re=i(ye);w(Bn.$$.fragment,Re),lh=d(Re),or=r(Re,"P",{});var wf=i(or);dh=s(wf,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),wf.forEach(t),ch=d(Re),Qn=r(Re,"P",{});var xi=i(Qn);ph=s(xi,"This model inherits from "),zs=r(xi,"A",{href:!0});var bf=i(zs);hh=s(bf,"FlaxPreTrainedModel"),bf.forEach(t),uh=s(xi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zi.forEach(t),Xh=d(Ve),mr=r(Ve,"P",{});var Of=i(mr);Yh=s(Of,"Finally, this model supports inherent JAX features such as:"),Of.forEach(t),Zh=d(Ve),mt=r(Ve,"UL",{});var Eo=i(mt);fr=r(Eo,"LI",{});var Wf=i(fr);as=r(Wf,"A",{href:!0,rel:!0});var Bf=i(as);eu=s(Bf,"Just-In-Time (JIT) compilation"),Bf.forEach(t),Wf.forEach(t),tu=d(Eo),gr=r(Eo,"LI",{});var Qf=i(gr);rs=r(Qf,"A",{href:!0,rel:!0});var Uf=i(rs);ou=s(Uf,"Automatic Differentiation"),Uf.forEach(t),Qf.forEach(t),nu=d(Eo),_r=r(Eo,"LI",{});var Hf=i(_r);is=r(Hf,"A",{href:!0,rel:!0});var Rf=i(is);su=s(Rf,"Vectorization"),Rf.forEach(t),Hf.forEach(t),au=d(Eo),Tr=r(Eo,"LI",{});var Vf=i(Tr);ls=r(Vf,"A",{href:!0,rel:!0});var Kf=i(ls);ru=s(Kf,"Parallelization"),Kf.forEach(t),Vf.forEach(t),Eo.forEach(t),iu=d(Ve),He=r(Ve,"DIV",{class:!0});var Pt=i(He);w(ds.$$.fragment,Pt),lu=d(Pt),Rt=r(Pt,"P",{});var Vs=i(Rt);du=s(Vs,"The "),vr=r(Vs,"CODE",{});var Xf=i(vr);cu=s(Xf,"FlaxGPTJPreTrainedModel"),Xf.forEach(t),pu=s(Vs,"forward method, overrides the "),kr=r(Vs,"CODE",{});var Yf=i(kr);hu=s(Yf,"__call__"),Yf.forEach(t),uu=s(Vs," special method."),Vs.forEach(t),mu=d(Pt),w(yo.$$.fragment,Pt),fu=d(Pt),wr=r(Pt,"P",{});var Zf=i(wr);gu=s(Zf,"Example:"),Zf.forEach(t),_u=d(Pt),w(cs.$$.fragment,Pt),Pt.forEach(t),Ve.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(kg)),c(_,"id","gptj"),c(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_,"href","#gptj"),c(f,"class","relative group"),c(X,"id","overview"),c(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(X,"href","#overview"),c(E,"class","relative group"),c(ee,"href","https://github.com/kingoflolz/mesh-transformer-jax"),c(ee,"rel","nofollow"),c(x,"href","https://pile.eleuther.ai/"),c(x,"rel","nofollow"),c(oe,"href","https://huggingface.co/stellaathena"),c(oe,"rel","nofollow"),c(q,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(q,"rel","nofollow"),c(C,"href","https://huggingface.co/EleutherAI/gpt-j-6B/tree/float16"),c(C,"rel","nofollow"),c(we,"href","https://github.com/kingoflolz/mesh-transformer-jax/blob/master/howto_finetune.md"),c(we,"rel","nofollow"),c(Jo,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Jo,"rel","nofollow"),c(Kt,"id","generation"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#generation"),c($t,"class","relative group"),c(ms,"href","/docs/transformers/pr_16255/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Yt,"id","transformers.GPTJConfig"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.GPTJConfig"),c(Ft,"class","relative group"),c(gs,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJModel"),c(Ao,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Ao,"rel","nofollow"),c(_s,"href","/docs/transformers/pr_16255/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ts,"href","/docs/transformers/pr_16255/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ye,"class","docstring"),c(Zt,"id","transformers.GPTJModel"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.GPTJModel"),c(jt,"class","relative group"),c(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Do,"rel","nofollow"),c(vs,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJModel"),c(Oe,"class","docstring"),c(ht,"class","docstring"),c(to,"id","transformers.GPTJForCausalLM"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.GPTJForCausalLM"),c(Et,"class","relative group"),c(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ho,"rel","nofollow"),c(ks,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJForCausalLM"),c(We,"class","docstring"),c(et,"class","docstring"),c(no,"id","transformers.GPTJForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.GPTJForSequenceClassification"),c(xt,"class","relative group"),c(bs,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Zo,"rel","nofollow"),c(ys,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(ne,"class","docstring"),c(je,"class","docstring"),c(ao,"id","transformers.GPTJForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.GPTJForQuestionAnswering"),c(qt,"class","relative group"),c(dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(dn,"rel","nofollow"),c(Ps,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJForQuestionAnswering"),c(Me,"class","docstring"),c(ot,"class","docstring"),c(io,"id","transformers.TFGPTJModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFGPTJModel"),c(At,"class","relative group"),c($s,"href","/docs/transformers/pr_16255/en/main_classes/model#transformers.TFPreTrainedModel"),c(_n,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(_n,"rel","nofollow"),c(Fs,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.TFGPTJModel"),c(Be,"class","docstring"),c(Ge,"class","docstring"),c(po,"id","transformers.TFGPTJForCausalLM"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.TFGPTJForCausalLM"),c(Lt,"class","relative group"),c(js,"href","/docs/transformers/pr_16255/en/main_classes/model#transformers.TFPreTrainedModel"),c(Pn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Pn,"rel","nofollow"),c(Gs,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.TFGPTJForCausalLM"),c(Qe,"class","docstring"),c(Ee,"class","docstring"),c(mo,"id","transformers.TFGPTJForSequenceClassification"),c(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mo,"href","#transformers.TFGPTJForSequenceClassification"),c(Nt,"class","relative group"),c(Js,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(xs,"href","/docs/transformers/pr_16255/en/main_classes/model#transformers.TFPreTrainedModel"),c(xn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(xn,"rel","nofollow"),c(Ms,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.TFGPTJForSequenceClassification"),c(qe,"class","docstring"),c(ae,"class","docstring"),c(_o,"id","transformers.TFGPTJForQuestionAnswering"),c(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_o,"href","#transformers.TFGPTJForQuestionAnswering"),c(Ot,"class","relative group"),c(qs,"href","/docs/transformers/pr_16255/en/main_classes/model#transformers.TFPreTrainedModel"),c(Sn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Sn,"rel","nofollow"),c(Cs,"href","/docs/transformers/pr_16255/en/model_doc/gptj#transformers.TFGPTJForQuestionAnswering"),c(Ce,"class","docstring"),c(Je,"class","docstring"),c(ko,"id","transformers.FlaxGPTJModel"),c(ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ko,"href","#transformers.FlaxGPTJModel"),c(Qt,"class","relative group"),c(zs,"href","/docs/transformers/pr_16255/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Hn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Hn,"rel","nofollow"),c(Rn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Rn,"rel","nofollow"),c(Vn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Vn,"rel","nofollow"),c(Kn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Kn,"rel","nofollow"),c(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Xn,"rel","nofollow"),c(Ue,"class","docstring"),c(ye,"class","docstring"),c(bo,"id","transformers.FlaxGPTJForCausalLM"),c(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bo,"href","#transformers.FlaxGPTJForCausalLM"),c(Ht,"class","relative group"),c(As,"href","/docs/transformers/pr_16255/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ss,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(ss,"rel","nofollow"),c(as,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(as,"rel","nofollow"),c(rs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(rs,"rel","nofollow"),c(is,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(is,"rel","nofollow"),c(ls,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ls,"rel","nofollow"),c(He,"class","docstring"),c(Pe,"class","docstring")},m(o,m){e(document.head,p),u(o,F,m),u(o,f,m),e(f,_),e(_,v),b(T,v,null),e(f,g),e(f,j),e(j,ue),u(o,K,m),u(o,E,m),e(E,X),e(X,O),b(Z,O,null),e(E,me),e(E,W),e(W,fe),u(o,ie,m),u(o,L,m),e(L,A),e(L,ee),e(ee,te),e(L,J),e(L,x),e(x,ge),e(L,U),u(o,le,m),u(o,Y,m),e(Y,H),e(Y,oe),e(oe,_e),e(Y,M),u(o,de,m),u(o,S,m),e(S,Te),u(o,ce,m),u(o,N,m),e(N,B),e(B,ve),e(B,q),e(q,ke),e(B,R),e(B,se),e(se,h),e(B,G),e(B,V),e(V,Ae),e(B,Ie),e(B,C),e(C,Le),e(B,Se),u(o,xe,m),b(z,o,m),u(o,Q,m),u(o,pe,m),e(pe,Fe),e(Fe,D),e(D,Ne),e(D,we),e(we,be),e(pe,De),e(pe,Ks),e(Ks,pt),e(pt,Ai),e(pt,Jo),e(Jo,Ii),e(pt,Li),e(pt,Xs),e(Xs,Si),e(pt,Ni),e(pt,Ys),e(Ys,Di),e(pt,Oi),u(o,Mr,m),u(o,$t,m),e($t,Kt),e(Kt,Zs),b(xo,Zs,null),e($t,Wi),e($t,ea),e(ea,Bi),u(o,qr,m),u(o,Xt,m),e(Xt,Qi),e(Xt,ms),e(ms,Ui),e(Xt,Hi),u(o,Cr,m),b(Mo,o,m),u(o,zr,m),u(o,fs,m),e(fs,Ri),u(o,Ar,m),b(qo,o,m),u(o,Ir,m),u(o,Ft,m),e(Ft,Yt),e(Yt,ta),b(Co,ta,null),e(Ft,Vi),e(Ft,oa),e(oa,Ki),u(o,Lr,m),u(o,Ye,m),b(zo,Ye,null),e(Ye,Xi),e(Ye,Ze),e(Ze,Yi),e(Ze,gs),e(gs,Zi),e(Ze,el),e(Ze,Ao),e(Ao,tl),e(Ze,ol),e(Ze,_s),e(_s,nl),e(Ze,sl),e(Ze,Ts),e(Ts,al),e(Ze,rl),e(Ye,il),e(Ye,na),e(na,ll),e(Ye,dl),b(Io,Ye,null),u(o,Sr,m),u(o,jt,m),e(jt,Zt),e(Zt,sa),b(Lo,sa,null),e(jt,cl),e(jt,aa),e(aa,pl),u(o,Nr,m),u(o,ht,m),b(So,ht,null),e(ht,hl),e(ht,No),e(No,ul),e(No,Do),e(Do,ml),e(No,fl),e(ht,gl),e(ht,Oe),b(Oo,Oe,null),e(Oe,_l),e(Oe,Gt),e(Gt,Tl),e(Gt,vs),e(vs,vl),e(Gt,kl),e(Gt,ra),e(ra,wl),e(Gt,bl),e(Oe,yl),b(eo,Oe,null),e(Oe,Pl),e(Oe,ia),e(ia,$l),e(Oe,Fl),b(Wo,Oe,null),u(o,Dr,m),u(o,Et,m),e(Et,to),e(to,la),b(Bo,la,null),e(Et,jl),e(Et,da),e(da,Gl),u(o,Or,m),u(o,et,m),b(Qo,et,null),e(et,El),e(et,ca),e(ca,Jl),e(et,xl),e(et,Uo),e(Uo,Ml),e(Uo,Ho),e(Ho,ql),e(Uo,Cl),e(et,zl),e(et,We),b(Ro,We,null),e(We,Al),e(We,Jt),e(Jt,Il),e(Jt,ks),e(ks,Ll),e(Jt,Sl),e(Jt,pa),e(pa,Nl),e(Jt,Dl),e(We,Ol),b(oo,We,null),e(We,Wl),e(We,ha),e(ha,Bl),e(We,Ql),b(Vo,We,null),u(o,Wr,m),u(o,xt,m),e(xt,no),e(no,ua),b(Ko,ua,null),e(xt,Ul),e(xt,ma),e(ma,Hl),u(o,Br,m),u(o,je,m),b(Xo,je,null),e(je,Rl),e(je,fa),e(fa,Vl),e(je,Kl),e(je,ws),e(ws,bs),e(bs,Xl),e(ws,Yl),e(je,Zl),e(je,tt),e(tt,ed),e(tt,ga),e(ga,td),e(tt,od),e(tt,_a),e(_a,nd),e(tt,sd),e(tt,Ta),e(Ta,ad),e(tt,rd),e(tt,va),e(va,id),e(tt,ld),e(je,dd),e(je,Yo),e(Yo,cd),e(Yo,Zo),e(Zo,pd),e(Yo,hd),e(je,ud),e(je,ne),b(en,ne,null),e(ne,md),e(ne,Mt),e(Mt,fd),e(Mt,ys),e(ys,gd),e(Mt,_d),e(Mt,ka),e(ka,Td),e(Mt,vd),e(ne,kd),b(so,ne,null),e(ne,wd),e(ne,wa),e(wa,bd),e(ne,yd),b(tn,ne,null),e(ne,Pd),b(on,ne,null),e(ne,$d),e(ne,ba),e(ba,Fd),e(ne,jd),b(nn,ne,null),e(ne,Gd),b(sn,ne,null),u(o,Qr,m),u(o,qt,m),e(qt,ao),e(ao,ya),b(an,ya,null),e(qt,Ed),e(qt,Pa),e(Pa,Jd),u(o,Ur,m),u(o,ot,m),b(rn,ot,null),e(ot,xd),e(ot,Ct),e(Ct,Md),e(Ct,$a),e($a,qd),e(Ct,Cd),e(Ct,Fa),e(Fa,zd),e(Ct,Ad),e(ot,Id),e(ot,ln),e(ln,Ld),e(ln,dn),e(dn,Sd),e(ln,Nd),e(ot,Dd),e(ot,Me),b(cn,Me,null),e(Me,Od),e(Me,zt),e(zt,Wd),e(zt,Ps),e(Ps,Bd),e(zt,Qd),e(zt,ja),e(ja,Ud),e(zt,Hd),e(Me,Rd),b(ro,Me,null),e(Me,Vd),e(Me,Ga),e(Ga,Kd),e(Me,Xd),b(pn,Me,null),e(Me,Yd),b(hn,Me,null),u(o,Hr,m),u(o,At,m),e(At,io),e(io,Ea),b(un,Ea,null),e(At,Zd),e(At,Ja),e(Ja,ec),u(o,Rr,m),u(o,Ge,m),b(mn,Ge,null),e(Ge,tc),e(Ge,xa),e(xa,oc),e(Ge,nc),e(Ge,fn),e(fn,sc),e(fn,$s),e($s,ac),e(fn,rc),e(Ge,ic),e(Ge,gn),e(gn,lc),e(gn,_n),e(_n,dc),e(gn,cc),e(Ge,pc),b(lo,Ge,null),e(Ge,hc),e(Ge,Be),b(Tn,Be,null),e(Be,uc),e(Be,It),e(It,mc),e(It,Fs),e(Fs,fc),e(It,gc),e(It,Ma),e(Ma,_c),e(It,Tc),e(Be,vc),b(co,Be,null),e(Be,kc),e(Be,qa),e(qa,wc),e(Be,bc),b(vn,Be,null),u(o,Vr,m),u(o,Lt,m),e(Lt,po),e(po,Ca),b(kn,Ca,null),e(Lt,yc),e(Lt,za),e(za,Pc),u(o,Kr,m),u(o,Ee,m),b(wn,Ee,null),e(Ee,$c),e(Ee,Aa),e(Aa,Fc),e(Ee,jc),e(Ee,bn),e(bn,Gc),e(bn,js),e(js,Ec),e(bn,Jc),e(Ee,xc),e(Ee,yn),e(yn,Mc),e(yn,Pn),e(Pn,qc),e(yn,Cc),e(Ee,zc),b(ho,Ee,null),e(Ee,Ac),e(Ee,Qe),b($n,Qe,null),e(Qe,Ic),e(Qe,St),e(St,Lc),e(St,Gs),e(Gs,Sc),e(St,Nc),e(St,Ia),e(Ia,Dc),e(St,Oc),e(Qe,Wc),b(uo,Qe,null),e(Qe,Bc),e(Qe,La),e(La,Qc),e(Qe,Uc),b(Fn,Qe,null),u(o,Xr,m),u(o,Nt,m),e(Nt,mo),e(mo,Sa),b(jn,Sa,null),e(Nt,Hc),e(Nt,Na),e(Na,Rc),u(o,Yr,m),u(o,ae,m),b(Gn,ae,null),e(ae,Vc),e(ae,Da),e(Da,Kc),e(ae,Xc),e(ae,Es),e(Es,Js),e(Js,Yc),e(Es,Zc),e(ae,ep),e(ae,nt),e(nt,tp),e(nt,Oa),e(Oa,op),e(nt,np),e(nt,Wa),e(Wa,sp),e(nt,ap),e(nt,Ba),e(Ba,rp),e(nt,ip),e(nt,Qa),e(Qa,lp),e(nt,dp),e(ae,cp),e(ae,En),e(En,pp),e(En,xs),e(xs,hp),e(En,up),e(ae,mp),e(ae,Jn),e(Jn,fp),e(Jn,xn),e(xn,gp),e(Jn,_p),e(ae,Tp),b(fo,ae,null),e(ae,vp),e(ae,qe),b(Mn,qe,null),e(qe,kp),e(qe,Dt),e(Dt,wp),e(Dt,Ms),e(Ms,bp),e(Dt,yp),e(Dt,Ua),e(Ua,Pp),e(Dt,$p),e(qe,Fp),b(go,qe,null),e(qe,jp),e(qe,Ha),e(Ha,Gp),e(qe,Ep),b(qn,qe,null),e(qe,Jp),b(Cn,qe,null),u(o,Zr,m),u(o,Ot,m),e(Ot,_o),e(_o,Ra),b(zn,Ra,null),e(Ot,xp),e(Ot,Va),e(Va,Mp),u(o,ei,m),u(o,Je,m),b(An,Je,null),e(Je,qp),e(Je,Wt),e(Wt,Cp),e(Wt,Ka),e(Ka,zp),e(Wt,Ap),e(Wt,Xa),e(Xa,Ip),e(Wt,Lp),e(Je,Sp),e(Je,In),e(In,Np),e(In,qs),e(qs,Dp),e(In,Op),e(Je,Wp),e(Je,Ln),e(Ln,Bp),e(Ln,Sn),e(Sn,Qp),e(Ln,Up),e(Je,Hp),b(To,Je,null),e(Je,Rp),e(Je,Ce),b(Nn,Ce,null),e(Ce,Vp),e(Ce,Bt),e(Bt,Kp),e(Bt,Cs),e(Cs,Xp),e(Bt,Yp),e(Bt,Ya),e(Ya,Zp),e(Bt,eh),e(Ce,th),b(vo,Ce,null),e(Ce,oh),e(Ce,Za),e(Za,nh),e(Ce,sh),b(Dn,Ce,null),e(Ce,ah),b(On,Ce,null),u(o,ti,m),u(o,Qt,m),e(Qt,ko),e(ko,er),b(Wn,er,null),e(Qt,rh),e(Qt,tr),e(tr,ih),u(o,oi,m),u(o,ye,m),b(Bn,ye,null),e(ye,lh),e(ye,or),e(or,dh),e(ye,ch),e(ye,Qn),e(Qn,ph),e(Qn,zs),e(zs,hh),e(Qn,uh),e(ye,mh),e(ye,Un),e(Un,fh),e(Un,Hn),e(Hn,gh),e(Un,_h),e(ye,Th),e(ye,nr),e(nr,vh),e(ye,kh),e(ye,ut),e(ut,sr),e(sr,Rn),e(Rn,wh),e(ut,bh),e(ut,ar),e(ar,Vn),e(Vn,yh),e(ut,Ph),e(ut,rr),e(rr,Kn),e(Kn,$h),e(ut,Fh),e(ut,ir),e(ir,Xn),e(Xn,jh),e(ye,Gh),e(ye,Ue),b(Yn,Ue,null),e(Ue,Eh),e(Ue,Ut),e(Ut,Jh),e(Ut,lr),e(lr,xh),e(Ut,Mh),e(Ut,dr),e(dr,qh),e(Ut,Ch),e(Ue,zh),b(wo,Ue,null),e(Ue,Ah),e(Ue,cr),e(cr,Ih),e(Ue,Lh),b(Zn,Ue,null),u(o,ni,m),u(o,Ht,m),e(Ht,bo),e(bo,pr),b(es,pr,null),e(Ht,Sh),e(Ht,hr),e(hr,Nh),u(o,si,m),u(o,Pe,m),b(ts,Pe,null),e(Pe,Dh),e(Pe,ur),e(ur,Oh),e(Pe,Wh),e(Pe,os),e(os,Bh),e(os,As),e(As,Qh),e(os,Uh),e(Pe,Hh),e(Pe,ns),e(ns,Rh),e(ns,ss),e(ss,Vh),e(ns,Kh),e(Pe,Xh),e(Pe,mr),e(mr,Yh),e(Pe,Zh),e(Pe,mt),e(mt,fr),e(fr,as),e(as,eu),e(mt,tu),e(mt,gr),e(gr,rs),e(rs,ou),e(mt,nu),e(mt,_r),e(_r,is),e(is,su),e(mt,au),e(mt,Tr),e(Tr,ls),e(ls,ru),e(Pe,iu),e(Pe,He),b(ds,He,null),e(He,lu),e(He,Rt),e(Rt,du),e(Rt,vr),e(vr,cu),e(Rt,pu),e(Rt,kr),e(kr,hu),e(Rt,uu),e(He,mu),b(yo,He,null),e(He,fu),e(He,wr),e(wr,gu),e(He,_u),b(cs,He,null),ai=!0},p(o,[m]){const ps={};m&2&&(ps.$$scope={dirty:m,ctx:o}),eo.$set(ps);const br={};m&2&&(br.$$scope={dirty:m,ctx:o}),oo.$set(br);const yr={};m&2&&(yr.$$scope={dirty:m,ctx:o}),so.$set(yr);const Pr={};m&2&&(Pr.$$scope={dirty:m,ctx:o}),ro.$set(Pr);const hs={};m&2&&(hs.$$scope={dirty:m,ctx:o}),lo.$set(hs);const $r={};m&2&&($r.$$scope={dirty:m,ctx:o}),co.$set($r);const Fr={};m&2&&(Fr.$$scope={dirty:m,ctx:o}),ho.$set(Fr);const jr={};m&2&&(jr.$$scope={dirty:m,ctx:o}),uo.$set(jr);const Vt={};m&2&&(Vt.$$scope={dirty:m,ctx:o}),fo.$set(Vt);const Gr={};m&2&&(Gr.$$scope={dirty:m,ctx:o}),go.$set(Gr);const Er={};m&2&&(Er.$$scope={dirty:m,ctx:o}),To.$set(Er);const us={};m&2&&(us.$$scope={dirty:m,ctx:o}),vo.$set(us);const Jr={};m&2&&(Jr.$$scope={dirty:m,ctx:o}),wo.$set(Jr);const xr={};m&2&&(xr.$$scope={dirty:m,ctx:o}),yo.$set(xr)},i(o){ai||(y(T.$$.fragment,o),y(Z.$$.fragment,o),y(z.$$.fragment,o),y(xo.$$.fragment,o),y(Mo.$$.fragment,o),y(qo.$$.fragment,o),y(Co.$$.fragment,o),y(zo.$$.fragment,o),y(Io.$$.fragment,o),y(Lo.$$.fragment,o),y(So.$$.fragment,o),y(Oo.$$.fragment,o),y(eo.$$.fragment,o),y(Wo.$$.fragment,o),y(Bo.$$.fragment,o),y(Qo.$$.fragment,o),y(Ro.$$.fragment,o),y(oo.$$.fragment,o),y(Vo.$$.fragment,o),y(Ko.$$.fragment,o),y(Xo.$$.fragment,o),y(en.$$.fragment,o),y(so.$$.fragment,o),y(tn.$$.fragment,o),y(on.$$.fragment,o),y(nn.$$.fragment,o),y(sn.$$.fragment,o),y(an.$$.fragment,o),y(rn.$$.fragment,o),y(cn.$$.fragment,o),y(ro.$$.fragment,o),y(pn.$$.fragment,o),y(hn.$$.fragment,o),y(un.$$.fragment,o),y(mn.$$.fragment,o),y(lo.$$.fragment,o),y(Tn.$$.fragment,o),y(co.$$.fragment,o),y(vn.$$.fragment,o),y(kn.$$.fragment,o),y(wn.$$.fragment,o),y(ho.$$.fragment,o),y($n.$$.fragment,o),y(uo.$$.fragment,o),y(Fn.$$.fragment,o),y(jn.$$.fragment,o),y(Gn.$$.fragment,o),y(fo.$$.fragment,o),y(Mn.$$.fragment,o),y(go.$$.fragment,o),y(qn.$$.fragment,o),y(Cn.$$.fragment,o),y(zn.$$.fragment,o),y(An.$$.fragment,o),y(To.$$.fragment,o),y(Nn.$$.fragment,o),y(vo.$$.fragment,o),y(Dn.$$.fragment,o),y(On.$$.fragment,o),y(Wn.$$.fragment,o),y(Bn.$$.fragment,o),y(Yn.$$.fragment,o),y(wo.$$.fragment,o),y(Zn.$$.fragment,o),y(es.$$.fragment,o),y(ts.$$.fragment,o),y(ds.$$.fragment,o),y(yo.$$.fragment,o),y(cs.$$.fragment,o),ai=!0)},o(o){P(T.$$.fragment,o),P(Z.$$.fragment,o),P(z.$$.fragment,o),P(xo.$$.fragment,o),P(Mo.$$.fragment,o),P(qo.$$.fragment,o),P(Co.$$.fragment,o),P(zo.$$.fragment,o),P(Io.$$.fragment,o),P(Lo.$$.fragment,o),P(So.$$.fragment,o),P(Oo.$$.fragment,o),P(eo.$$.fragment,o),P(Wo.$$.fragment,o),P(Bo.$$.fragment,o),P(Qo.$$.fragment,o),P(Ro.$$.fragment,o),P(oo.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(en.$$.fragment,o),P(so.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(an.$$.fragment,o),P(rn.$$.fragment,o),P(cn.$$.fragment,o),P(ro.$$.fragment,o),P(pn.$$.fragment,o),P(hn.$$.fragment,o),P(un.$$.fragment,o),P(mn.$$.fragment,o),P(lo.$$.fragment,o),P(Tn.$$.fragment,o),P(co.$$.fragment,o),P(vn.$$.fragment,o),P(kn.$$.fragment,o),P(wn.$$.fragment,o),P(ho.$$.fragment,o),P($n.$$.fragment,o),P(uo.$$.fragment,o),P(Fn.$$.fragment,o),P(jn.$$.fragment,o),P(Gn.$$.fragment,o),P(fo.$$.fragment,o),P(Mn.$$.fragment,o),P(go.$$.fragment,o),P(qn.$$.fragment,o),P(Cn.$$.fragment,o),P(zn.$$.fragment,o),P(An.$$.fragment,o),P(To.$$.fragment,o),P(Nn.$$.fragment,o),P(vo.$$.fragment,o),P(Dn.$$.fragment,o),P(On.$$.fragment,o),P(Wn.$$.fragment,o),P(Bn.$$.fragment,o),P(Yn.$$.fragment,o),P(wo.$$.fragment,o),P(Zn.$$.fragment,o),P(es.$$.fragment,o),P(ts.$$.fragment,o),P(ds.$$.fragment,o),P(yo.$$.fragment,o),P(cs.$$.fragment,o),ai=!1},d(o){t(p),o&&t(F),o&&t(f),$(T),o&&t(K),o&&t(E),$(Z),o&&t(ie),o&&t(L),o&&t(le),o&&t(Y),o&&t(de),o&&t(S),o&&t(ce),o&&t(N),o&&t(xe),$(z,o),o&&t(Q),o&&t(pe),o&&t(Mr),o&&t($t),$(xo),o&&t(qr),o&&t(Xt),o&&t(Cr),$(Mo,o),o&&t(zr),o&&t(fs),o&&t(Ar),$(qo,o),o&&t(Ir),o&&t(Ft),$(Co),o&&t(Lr),o&&t(Ye),$(zo),$(Io),o&&t(Sr),o&&t(jt),$(Lo),o&&t(Nr),o&&t(ht),$(So),$(Oo),$(eo),$(Wo),o&&t(Dr),o&&t(Et),$(Bo),o&&t(Or),o&&t(et),$(Qo),$(Ro),$(oo),$(Vo),o&&t(Wr),o&&t(xt),$(Ko),o&&t(Br),o&&t(je),$(Xo),$(en),$(so),$(tn),$(on),$(nn),$(sn),o&&t(Qr),o&&t(qt),$(an),o&&t(Ur),o&&t(ot),$(rn),$(cn),$(ro),$(pn),$(hn),o&&t(Hr),o&&t(At),$(un),o&&t(Rr),o&&t(Ge),$(mn),$(lo),$(Tn),$(co),$(vn),o&&t(Vr),o&&t(Lt),$(kn),o&&t(Kr),o&&t(Ee),$(wn),$(ho),$($n),$(uo),$(Fn),o&&t(Xr),o&&t(Nt),$(jn),o&&t(Yr),o&&t(ae),$(Gn),$(fo),$(Mn),$(go),$(qn),$(Cn),o&&t(Zr),o&&t(Ot),$(zn),o&&t(ei),o&&t(Je),$(An),$(To),$(Nn),$(vo),$(Dn),$(On),o&&t(ti),o&&t(Qt),$(Wn),o&&t(oi),o&&t(ye),$(Bn),$(Yn),$(wo),$(Zn),o&&t(ni),o&&t(Ht),$(es),o&&t(si),o&&t(Pe),$(ts),$(ds),$(yo),$(cs)}}}const kg={local:"gptj",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTJConfig",title:"GPTJConfig"},{local:"transformers.GPTJModel",title:"GPTJModel"},{local:"transformers.GPTJForCausalLM",title:"GPTJForCausalLM"},{local:"transformers.GPTJForSequenceClassification",title:"GPTJForSequenceClassification"},{local:"transformers.GPTJForQuestionAnswering",title:"GPTJForQuestionAnswering"},{local:"transformers.TFGPTJModel",title:"TFGPTJModel"},{local:"transformers.TFGPTJForCausalLM",title:"TFGPTJForCausalLM"},{local:"transformers.TFGPTJForSequenceClassification",title:"TFGPTJForSequenceClassification"},{local:"transformers.TFGPTJForQuestionAnswering",title:"TFGPTJForQuestionAnswering"},{local:"transformers.FlaxGPTJModel",title:"FlaxGPTJModel"},{local:"transformers.FlaxGPTJForCausalLM",title:"FlaxGPTJForCausalLM"}],title:"GPT-J"};function wg(I){return sg(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class jg extends eg{constructor(p){super();tg(this,p,wg,vg,og,{})}}export{jg as default,kg as metadata};
