...
<a href="/docs/transformers/pr_16255/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new me({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),va=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ea=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),La=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xa=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16255/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),li=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16255/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16255/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16255/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Eh.forEach(t),yg=d(Qt),We=n(Qt,"DIV",{class:!0});var kt=r(We);k(Xn.$$.fragment,kt),$g=d(kt),bo=n(kt,"P",{});var rl=r(bo);Dg=i(rl,"The "),Ci=n(rl,"A",{href:!0});var e2=r(Ci);Fg=i(e2,"DistilBertForTokenClassification"),e2.forEach(t),Bg=i(rl," forward method, overrides the "),td=n(rl,"CODE",{});var t2=r(td);Mg=i(t2,"__call__"),t2.forEach(t),Eg=i(rl," special method."),rl.forEach(t),xg=d(kt),k(cs.$$.fragment,kt),zg=d(kt),od=n(kt,"P",{});var o2=r(od);jg=i(o2,"Example:"),o2.forEach(t),Cg=d(kt),k(Yn.$$.fragment,kt),Pg=d(kt),k(Zn.$$.fragment,kt),kt.forEach(t),Qt.forEach(t),qp=d(o),ko=n(o,"H2",{class:!0});var xh=r(ko);ps=n(xh,"A",{id:!0,class:!0,href:!0});var s2=r(ps);sd=n(s2,"SPAN",{});var n2=r(sd);k(er.$$.fragment,n2),n2.forEach(t),s2.forEach(t),qg=d(xh),nd=n(xh,"SPAN",{});var r2=r(nd);Ag=i(r2,"DistilBertForQuestionAnswering"),r2.forEach(t),xh.forEach(t),Ap=d(o),Ge=n(o,"DIV",{class:!0});var Vt=r(Ge);k(tr.$$.fragment,Vt),Og=d(Vt),wo=n(Vt,"P",{});var al=r(wo);Ng=i(al,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),rd=n(al,"CODE",{});var a2=r(rd);Ig=i(a2,"span start logits"),a2.forEach(t),Lg=i(al," and "),ad=n(al,"CODE",{});var i2=r(ad);Sg=i(i2,"span end logits"),i2.forEach(t),Wg=i(al,")."),al.forEach(t),Rg=d(Vt),or=n(Vt,"P",{});var zh=r(or);Ug=i(zh,"This model inherits from "),Pi=n(zh,"A",{href:!0});var l2=r(Pi);Hg=i(l2,"PreTrainedModel"),l2.forEach(t),Qg=i(zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zh.forEach(t),Vg=d(Vt),sr=n(Vt,"P",{});var jh=r(sr);Jg=i(jh,"This model is also a PyTorch "),nr=n(jh,"A",{href:!0,rel:!0});var d2=r(nr);Kg=i(d2,"torch.nn.Module"),d2.forEach(t),Gg=i(jh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jh.forEach(t),Xg=d(Vt),Re=n(Vt,"DIV",{class:!0});var wt=r(Re);k(rr.$$.fragment,wt),Yg=d(wt),yo=n(wt,"P",{});var il=r(yo);Zg=i(il,"The "),qi=n(il,"A",{href:!0});var c2=r(qi);e_=i(c2,"DistilBertForQuestionAnswering"),c2.forEach(t),t_=i(il," forward method, overrides the "),id=n(il,"CODE",{});var p2=r(id);o_=i(p2,"__call__"),p2.forEach(t),s_=i(il," special method."),il.forEach(t),n_=d(wt),k(hs.$$.fragment,wt),r_=d(wt),ld=n(wt,"P",{});var h2=r(ld);a_=i(h2,"Example:"),h2.forEach(t),i_=d(wt),k(ar.$$.fragment,wt),l_=d(wt),k(ir.$$.fragment,wt),wt.forEach(t),Vt.forEach(t),Op=d(o),$o=n(o,"H2",{class:!0});var Ch=r($o);us=n(Ch,"A",{id:!0,class:!0,href:!0});var u2=r(us);dd=n(u2,"SPAN",{});var f2=r(dd);k(lr.$$.fragment,f2),f2.forEach(t),u2.forEach(t),d_=d(Ch),cd=n(Ch,"SPAN",{});var m2=r(cd);c_=i(m2,"TFDistilBertModel"),m2.forEach(t),Ch.forEach(t),Np=d(o),qe=n(o,"DIV",{class:!0});var yt=r(qe);k(dr.$$.fragment,yt),p_=d(yt),pd=n(yt,"P",{});var g2=r(pd);h_=i(g2,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),g2.forEach(t),u_=d(yt),cr=n(yt,"P",{});var Ph=r(cr);f_=i(Ph,"This model inherits from "),Ai=n(Ph,"A",{href:!0});var _2=r(Ai);m_=i(_2,"TFPreTrainedModel"),_2.forEach(t),g_=i(Ph,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ph.forEach(t),__=d(yt),pr=n(yt,"P",{});var qh=r(pr);v_=i(qh,"This model is also a "),hr=n(qh,"A",{href:!0,rel:!0});var v2=r(hr);T_=i(v2,"tf.keras.Model"),v2.forEach(t),b_=i(qh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qh.forEach(t),k_=d(yt),k(fs.$$.fragment,yt),w_=d(yt),Ze=n(yt,"DIV",{class:!0});var Jt=r(Ze);k(ur.$$.fragment,Jt),y_=d(Jt),Do=n(Jt,"P",{});var ll=r(Do);$_=i(ll,"The "),Oi=n(ll,"A",{href:!0});var T2=r(Oi);D_=i(T2,"TFDistilBertModel"),T2.forEach(t),F_=i(ll," forward method, overrides the "),hd=n(ll,"CODE",{});var b2=r(hd);B_=i(b2,"__call__"),b2.forEach(t),M_=i(ll," special method."),ll.forEach(t),E_=d(Jt),k(ms.$$.fragment,Jt),x_=d(Jt),ud=n(Jt,"P",{});var k2=r(ud);z_=i(k2,"Example:"),k2.forEach(t),j_=d(Jt),k(fr.$$.fragment,Jt),Jt.forEach(t),yt.forEach(t),Ip=d(o),Fo=n(o,"H2",{class:!0});var Ah=r(Fo);gs=n(Ah,"A",{id:!0,class:!0,href:!0});var w2=r(gs);fd=n(w2,"SPAN",{});var y2=r(fd);k(mr.$$.fragment,y2),y2.forEach(t),w2.forEach(t),C_=d(Ah),md=n(Ah,"SPAN",{});var $2=r(md);P_=i($2,"TFDistilBertForMaskedLM"),$2.forEach(t),Ah.forEach(t),Lp=d(o),Ae=n(o,"DIV",{class:!0});var $t=r(Ae);k(gr.$$.fragment,$t),q_=d($t),_r=n($t,"P",{});var Oh=r(_r);A_=i(Oh,"DistilBert Model with a "),gd=n(Oh,"CODE",{});var D2=r(gd);O_=i(D2,"masked language modeling"),D2.forEach(t),N_=i(Oh," head on top."),Oh.forEach(t),I_=d($t),vr=n($t,"P",{});var Nh=r(vr);L_=i(Nh,"This model inherits from "),Ni=n(Nh,"A",{href:!0});var F2=r(Ni);S_=i(F2,"TFPreTrainedModel"),F2.forEach(t),W_=i(Nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nh.forEach(t),R_=d($t),Tr=n($t,"P",{});var Ih=r(Tr);U_=i(Ih,"This model is also a "),br=n(Ih,"A",{href:!0,rel:!0});var B2=r(br);H_=i(B2,"tf.keras.Model"),B2.forEach(t),Q_=i(Ih,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),V_=d($t),k(_s.$$.fragment,$t),J_=d($t),et=n($t,"DIV",{class:!0});var Kt=r(et);k(kr.$$.fragment,Kt),K_=d(Kt),Bo=n(Kt,"P",{});var dl=r(Bo);G_=i(dl,"The "),Ii=n(dl,"A",{href:!0});var M2=r(Ii);X_=i(M2,"TFDistilBertForMaskedLM"),M2.forEach(t),Y_=i(dl," forward method, overrides the "),_d=n(dl,"CODE",{});var E2=r(_d);Z_=i(E2,"__call__"),E2.forEach(t),ev=i(dl," special method."),dl.forEach(t),tv=d(Kt),k(vs.$$.fragment,Kt),ov=d(Kt),vd=n(Kt,"P",{});var x2=r(vd);sv=i(x2,"Example:"),x2.forEach(t),nv=d(Kt),k(wr.$$.fragment,Kt),Kt.forEach(t),$t.forEach(t),Sp=d(o),Mo=n(o,"H2",{class:!0});var Lh=r(Mo);Ts=n(Lh,"A",{id:!0,class:!0,href:!0});var z2=r(Ts);Td=n(z2,"SPAN",{});var j2=r(Td);k(yr.$$.fragment,j2),j2.forEach(t),z2.forEach(t),rv=d(Lh),bd=n(Lh,"SPAN",{});var C2=r(bd);av=i(C2,"TFDistilBertForSequenceClassification"),C2.forEach(t),Lh.forEach(t),Wp=d(o),Oe=n(o,"DIV",{class:!0});var Dt=r(Oe);k($r.$$.fragment,Dt),iv=d(Dt),kd=n(Dt,"P",{});var P2=r(kd);lv=i(P2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),P2.forEach(t),dv=d(Dt),Dr=n(Dt,"P",{});var Sh=r(Dr);cv=i(Sh,"This model inherits from "),Li=n(Sh,"A",{href:!0});var q2=r(Li);pv=i(q2,"TFPreTrainedModel"),q2.forEach(t),hv=i(Sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sh.forEach(t),uv=d(Dt),Fr=n(Dt,"P",{});var Wh=r(Fr);fv=i(Wh,"This model is also a "),Br=n(Wh,"A",{href:!0,rel:!0});var A2=r(Br);mv=i(A2,"tf.keras.Model"),A2.forEach(t),gv=i(Wh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wh.forEach(t),_v=d(Dt),k(bs.$$.fragment,Dt),vv=d(Dt),tt=n(Dt,"DIV",{class:!0});var Gt=r(tt);k(Mr.$$.fragment,Gt),Tv=d(Gt),Eo=n(Gt,"P",{});var cl=r(Eo);bv=i(cl,"The "),Si=n(cl,"A",{href:!0});var O2=r(Si);kv=i(O2,"TFDistilBertForSequenceClassification"),O2.forEach(t),wv=i(cl," forward method, overrides the "),wd=n(cl,"CODE",{});var N2=r(wd);yv=i(N2,"__call__"),N2.forEach(t),$v=i(cl," special method."),cl.forEach(t),Dv=d(Gt),k(ks.$$.fragment,Gt),Fv=d(Gt),yd=n(Gt,"P",{});var I2=r(yd);Bv=i(I2,"Example:"),I2.forEach(t),Mv=d(Gt),k(Er.$$.fragment,Gt),Gt.forEach(t),Dt.forEach(t),Rp=d(o),xo=n(o,"H2",{class:!0});var Rh=r(xo);ws=n(Rh,"A",{id:!0,class:!0,href:!0});var L2=r(ws);$d=n(L2,"SPAN",{});var S2=r($d);k(xr.$$.fragment,S2),S2.forEach(t),L2.forEach(t),Ev=d(Rh),Dd=n(Rh,"SPAN",{});var W2=r(Dd);xv=i(W2,"TFDistilBertForMultipleChoice"),W2.forEach(t),Rh.forEach(t),Up=d(o),Ne=n(o,"DIV",{class:!0});var Ft=r(Ne);k(zr.$$.fragment,Ft),zv=d(Ft),Fd=n(Ft,"P",{});var R2=r(Fd);jv=i(R2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),R2.forEach(t),Cv=d(Ft),jr=n(Ft,"P",{});var Uh=r(jr);Pv=i(Uh,"This model inherits from "),Wi=n(Uh,"A",{href:!0});var U2=r(Wi);qv=i(U2,"TFPreTrainedModel"),U2.forEach(t),Av=i(Uh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uh.forEach(t),Ov=d(Ft),Cr=n(Ft,"P",{});var Hh=r(Cr);Nv=i(Hh,"This model is also a "),Pr=n(Hh,"A",{href:!0,rel:!0});var H2=r(Pr);Iv=i(H2,"tf.keras.Model"),H2.forEach(t),Lv=i(Hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh.forEach(t),Sv=d(Ft),k(ys.$$.fragment,Ft),Wv=d(Ft),ot=n(Ft,"DIV",{class:!0});var Xt=r(ot);k(qr.$$.fragment,Xt),Rv=d(Xt),zo=n(Xt,"P",{});var pl=r(zo);Uv=i(pl,"The "),Ri=n(pl,"A",{href:!0});var Q2=r(Ri);Hv=i(Q2,"TFDistilBertForMultipleChoice"),Q2.forEach(t),Qv=i(pl," forward method, overrides the "),Bd=n(pl,"CODE",{});var V2=r(Bd);Vv=i(V2,"__call__"),V2.forEach(t),Jv=i(pl," special method."),pl.forEach(t),Kv=d(Xt),k($s.$$.fragment,Xt),Gv=d(Xt),Md=n(Xt,"P",{});var J2=r(Md);Xv=i(J2,"Example:"),J2.forEach(t),Yv=d(Xt),k(Ar.$$.fragment,Xt),Xt.forEach(t),Ft.forEach(t),Hp=d(o),jo=n(o,"H2",{class:!0});var Qh=r(jo);Ds=n(Qh,"A",{id:!0,class:!0,href:!0});var K2=r(Ds);Ed=n(K2,"SPAN",{});var G2=r(Ed);k(Or.$$.fragment,G2),G2.forEach(t),K2.forEach(t),Zv=d(Qh),xd=n(Qh,"SPAN",{});var X2=r(xd);eT=i(X2,"TFDistilBertForTokenClassification"),X2.forEach(t),Qh.forEach(t),Qp=d(o),Ie=n(o,"DIV",{class:!0});var Bt=r(Ie);k(Nr.$$.fragment,Bt),tT=d(Bt),zd=n(Bt,"P",{});var Y2=r(zd);oT=i(Y2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Y2.forEach(t),sT=d(Bt),Ir=n(Bt,"P",{});var Vh=r(Ir);nT=i(Vh,"This model inherits from "),Ui=n(Vh,"A",{href:!0});var Z2=r(Ui);rT=i(Z2,"TFPreTrainedModel"),Z2.forEach(t),aT=i(Vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vh.forEach(t),iT=d(Bt),Lr=n(Bt,"P",{});var Jh=r(Lr);lT=i(Jh,"This model is also a "),Sr=n(Jh,"A",{href:!0,rel:!0});var e$=r(Sr);dT=i(e$,"tf.keras.Model"),e$.forEach(t),cT=i(Jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jh.forEach(t),pT=d(Bt),k(Fs.$$.fragment,Bt),hT=d(Bt),st=n(Bt,"DIV",{class:!0});var Yt=r(st);k(Wr.$$.fragment,Yt),uT=d(Yt),Co=n(Yt,"P",{});var hl=r(Co);fT=i(hl,"The "),Hi=n(hl,"A",{href:!0});var t$=r(Hi);mT=i(t$,"TFDistilBertForTokenClassification"),t$.forEach(t),gT=i(hl," forward method, overrides the "),jd=n(hl,"CODE",{});var o$=r(jd);_T=i(o$,"__call__"),o$.forEach(t),vT=i(hl," special method."),hl.forEach(t),TT=d(Yt),k(Bs.$$.fragment,Yt),bT=d(Yt),Cd=n(Yt,"P",{});var s$=r(Cd);kT=i(s$,"Example:"),s$.forEach(t),wT=d(Yt),k(Rr.$$.fragment,Yt),Yt.forEach(t),Bt.forEach(t),Vp=d(o),Po=n(o,"H2",{class:!0});var Kh=r(Po);Ms=n(Kh,"A",{id:!0,class:!0,href:!0});var n$=r(Ms);Pd=n(n$,"SPAN",{});var r$=r(Pd);k(Ur.$$.fragment,r$),r$.forEach(t),n$.forEach(t),yT=d(Kh),qd=n(Kh,"SPAN",{});var a$=r(qd);$T=i(a$,"TFDistilBertForQuestionAnswering"),a$.forEach(t),Kh.forEach(t),Jp=d(o),Le=n(o,"DIV",{class:!0});var Mt=r(Le);k(Hr.$$.fragment,Mt),DT=d(Mt),qo=n(Mt,"P",{});var ul=r(qo);FT=i(ul,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Ad=n(ul,"CODE",{});var i$=r(Ad);BT=i(i$,"span start logits"),i$.forEach(t),MT=i(ul," and "),Od=n(ul,"CODE",{});var l$=r(Od);ET=i(l$,"span end logits"),l$.forEach(t),xT=i(ul,")."),ul.forEach(t),zT=d(Mt),Qr=n(Mt,"P",{});var Gh=r(Qr);jT=i(Gh,"This model inherits from "),Qi=n(Gh,"A",{href:!0});var d$=r(Qi);CT=i(d$,"TFPreTrainedModel"),d$.forEach(t),PT=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),qT=d(Mt),Vr=n(Mt,"P",{});var Xh=r(Vr);AT=i(Xh,"This model is also a "),Jr=n(Xh,"A",{href:!0,rel:!0});var c$=r(Jr);OT=i(c$,"tf.keras.Model"),c$.forEach(t),NT=i(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),IT=d(Mt),k(Es.$$.fragment,Mt),LT=d(Mt),nt=n(Mt,"DIV",{class:!0});var Zt=r(nt);k(Kr.$$.fragment,Zt),ST=d(Zt),Ao=n(Zt,"P",{});var fl=r(Ao);WT=i(fl,"The "),Vi=n(fl,"A",{href:!0});var p$=r(Vi);RT=i(p$,"TFDistilBertForQuestionAnswering"),p$.forEach(t),UT=i(fl," forward method, overrides the "),Nd=n(fl,"CODE",{});var h$=r(Nd);HT=i(h$,"__call__"),h$.forEach(t),QT=i(fl," special method."),fl.forEach(t),VT=d(Zt),k(xs.$$.fragment,Zt),JT=d(Zt),Id=n(Zt,"P",{});var u$=r(Id);KT=i(u$,"Example:"),u$.forEach(t),GT=d(Zt),k(Gr.$$.fragment,Zt),Zt.forEach(t),Mt.forEach(t),Kp=d(o),Oo=n(o,"H2",{class:!0});var Yh=r(Oo);zs=n(Yh,"A",{id:!0,class:!0,href:!0});var f$=r(zs);Ld=n(f$,"SPAN",{});var m$=r(Ld);k(Xr.$$.fragment,m$),m$.forEach(t),f$.forEach(t),XT=d(Yh),Sd=n(Yh,"SPAN",{});var g$=r(Sd);YT=i(g$,"FlaxDistilBertModel"),g$.forEach(t),Yh.forEach(t),Gp=d(o),Me=n(o,"DIV",{class:!0});var pt=r(Me);k(Yr.$$.fragment,pt),ZT=d(pt),Wd=n(pt,"P",{});var _$=r(Wd);eb=i(_$,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),_$.forEach(t),tb=d(pt),Zr=n(pt,"P",{});var Zh=r(Zr);ob=i(Zh,"This model inherits from "),Ji=n(Zh,"A",{href:!0});var v$=r(Ji);sb=i(v$,"FlaxPreTrainedModel"),v$.forEach(t),nb=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Zh.forEach(t),rb=d(pt),ea=n(pt,"P",{});var eu=r(ea);ab=i(eu,"This model is also a Flax Linen "),ta=n(eu,"A",{href:!0,rel:!0});var T$=r(ta);ib=i(T$,"flax.linen.Module"),T$.forEach(t),lb=i(eu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),eu.forEach(t),db=d(pt),Rd=n(pt,"P",{});var b$=r(Rd);cb=i(b$,"Finally, this model supports inherent JAX features such as:"),b$.forEach(t),pb=d(pt),xt=n(pt,"UL",{});var Qs=r(xt);Ud=n(Qs,"LI",{});var k$=r(Ud);oa=n(k$,"A",{href:!0,rel:!0});var w$=r(oa);hb=i(w$,"Just-In-Time (JIT) compilation"),w$.forEach(t),k$.forEach(t),ub=d(Qs),Hd=n(Qs,"LI",{});var y$=r(Hd);sa=n(y$,"A",{href:!0,rel:!0});var $$=r(sa);fb=i($$,"Automatic Differentiation"),$$.forEach(t),y$.forEach(t),mb=d(Qs),Qd=n(Qs,"LI",{});var D$=r(Qd);na=n(D$,"A",{href:!0,rel:!0});var F$=r(na);gb=i(F$,"Vectorization"),F$.forEach(t),D$.forEach(t),_b=d(Qs),Vd=n(Qs,"LI",{});var B$=r(Vd);ra=n(B$,"A",{href:!0,rel:!0});var M$=r(ra);vb=i(M$,"Parallelization"),M$.forEach(t),B$.forEach(t),Qs.forEach(t),Tb=d(pt),rt=n(pt,"DIV",{class:!0});var eo=r(rt);k(aa.$$.fragment,eo),bb=d(eo),No=n(eo,"P",{});var ml=r(No);kb=i(ml,"The "),Jd=n(ml,"CODE",{});var E$=r(Jd);wb=i(E$,"FlaxDistilBertPreTrainedModel"),E$.forEach(t),yb=i(ml,"forward method, overrides the "),Kd=n(ml,"CODE",{});var x$=r(Kd);$b=i(x$,"__call__"),x$.forEach(t),Db=i(ml," special method."),ml.forEach(t),Fb=d(eo),k(js.$$.fragment,eo),Bb=d(eo),Gd=n(eo,"P",{});var z$=r(Gd);Mb=i(z$,"Example:"),z$.forEach(t),Eb=d(eo),k(ia.$$.fragment,eo),eo.forEach(t),pt.forEach(t),Xp=d(o),Io=n(o,"H2",{class:!0});var tu=r(Io);Cs=n(tu,"A",{id:!0,class:!0,href:!0});var j$=r(Cs);Xd=n(j$,"SPAN",{});var C$=r(Xd);k(la.$$.fragment,C$),C$.forEach(t),j$.forEach(t),xb=d(tu),Yd=n(tu,"SPAN",{});var P$=r(Yd);zb=i(P$,"FlaxDistilBertForMaskedLM"),P$.forEach(t),tu.forEach(t),Yp=d(o),Ee=n(o,"DIV",{class:!0});var ht=r(Ee);k(da.$$.fragment,ht),jb=d(ht),ca=n(ht,"P",{});var ou=r(ca);Cb=i(ou,"DistilBert Model with a "),Zd=n(ou,"CODE",{});var q$=r(Zd);Pb=i(q$,"language modeling"),q$.forEach(t),qb=i(ou," head on top."),ou.forEach(t),Ab=d(ht),pa=n(ht,"P",{});var su=r(pa);Ob=i(su,"This model inherits from "),Ki=n(su,"A",{href:!0});var A$=r(Ki);Nb=i(A$,"FlaxPreTrainedModel"),A$.forEach(t),Ib=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),su.forEach(t),Lb=d(ht),ha=n(ht,"P",{});var nu=r(ha);Sb=i(nu,"This model is also a Flax Linen "),ua=n(nu,"A",{href:!0,rel:!0});var O$=r(ua);Wb=i(O$,"flax.linen.Module"),O$.forEach(t),Rb=i(nu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),Ub=d(ht),ec=n(ht,"P",{});var N$=r(ec);Hb=i(N$,"Finally, this model supports inherent JAX features such as:"),N$.forEach(t),Qb=d(ht),zt=n(ht,"UL",{});var Vs=r(zt);tc=n(Vs,"LI",{});var I$=r(tc);fa=n(I$,"A",{href:!0,rel:!0});var L$=r(fa);Vb=i(L$,"Just-In-Time (JIT) compilation"),L$.forEach(t),I$.forEach(t),Jb=d(Vs),oc=n(Vs,"LI",{});var S$=r(oc);ma=n(S$,"A",{href:!0,rel:!0});var W$=r(ma);Kb=i(W$,"Automatic Differentiation"),W$.forEach(t),S$.forEach(t),Gb=d(Vs),sc=n(Vs,"LI",{});var R$=r(sc);ga=n(R$,"A",{href:!0,rel:!0});var U$=r(ga);Xb=i(U$,"Vectorization"),U$.forEach(t),R$.forEach(t),Yb=d(Vs),nc=n(Vs,"LI",{});var H$=r(nc);_a=n(H$,"A",{href:!0,rel:!0});var Q$=r(_a);Zb=i(Q$,"Parallelization"),Q$.forEach(t),H$.forEach(t),Vs.forEach(t),ek=d(ht),at=n(ht,"DIV",{class:!0});var to=r(at);k(va.$$.fragment,to),tk=d(to),Lo=n(to,"P",{});var gl=r(Lo);ok=i(gl,"The "),rc=n(gl,"CODE",{});var V$=r(rc);sk=i(V$,"FlaxDistilBertPreTrainedModel"),V$.forEach(t),nk=i(gl,"forward method, overrides the "),ac=n(gl,"CODE",{});var J$=r(ac);rk=i(J$,"__call__"),J$.forEach(t),ak=i(gl," special method."),gl.forEach(t),ik=d(to),k(Ps.$$.fragment,to),lk=d(to),ic=n(to,"P",{});var K$=r(ic);dk=i(K$,"Example:"),K$.forEach(t),ck=d(to),k(Ta.$$.fragment,to),to.forEach(t),ht.forEach(t),Zp=d(o),So=n(o,"H2",{class:!0});var ru=r(So);qs=n(ru,"A",{id:!0,class:!0,href:!0});var G$=r(qs);lc=n(G$,"SPAN",{});var X$=r(lc);k(ba.$$.fragment,X$),X$.forEach(t),G$.forEach(t),pk=d(ru),dc=n(ru,"SPAN",{});var Y$=r(dc);hk=i(Y$,"FlaxDistilBertForSequenceClassification"),Y$.forEach(t),ru.forEach(t),eh=d(o),xe=n(o,"DIV",{class:!0});var ut=r(xe);k(ka.$$.fragment,ut),uk=d(ut),cc=n(ut,"P",{});var Z$=r(cc);fk=i(Z$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Z$.forEach(t),mk=d(ut),wa=n(ut,"P",{});var au=r(wa);gk=i(au,"This model inherits from "),Gi=n(au,"A",{href:!0});var eD=r(Gi);_k=i(eD,"FlaxPreTrainedModel"),eD.forEach(t),vk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),au.forEach(t),Tk=d(ut),ya=n(ut,"P",{});var iu=r(ya);bk=i(iu,"This model is also a Flax Linen "),$a=n(iu,"A",{href:!0,rel:!0});var tD=r($a);kk=i(tD,"flax.linen.Module"),tD.forEach(t),wk=i(iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),iu.forEach(t),yk=d(ut),pc=n(ut,"P",{});var oD=r(pc);$k=i(oD,"Finally, this model supports inherent JAX features such as:"),oD.forEach(t),Dk=d(ut),jt=n(ut,"UL",{});var Js=r(jt);hc=n(Js,"LI",{});var sD=r(hc);Da=n(sD,"A",{href:!0,rel:!0});var nD=r(Da);Fk=i(nD,"Just-In-Time (JIT) compilation"),nD.forEach(t),sD.forEach(t),Bk=d(Js),uc=n(Js,"LI",{});var rD=r(uc);Fa=n(rD,"A",{href:!0,rel:!0});var aD=r(Fa);Mk=i(aD,"Automatic Differentiation"),aD.forEach(t),rD.forEach(t),Ek=d(Js),fc=n(Js,"LI",{});var iD=r(fc);Ba=n(iD,"A",{href:!0,rel:!0});var lD=r(Ba);xk=i(lD,"Vectorization"),lD.forEach(t),iD.forEach(t),zk=d(Js),mc=n(Js,"LI",{});var dD=r(mc);Ma=n(dD,"A",{href:!0,rel:!0});var cD=r(Ma);jk=i(cD,"Parallelization"),cD.forEach(t),dD.forEach(t),Js.forEach(t),Ck=d(ut),it=n(ut,"DIV",{class:!0});var oo=r(it);k(Ea.$$.fragment,oo),Pk=d(oo),Wo=n(oo,"P",{});var _l=r(Wo);qk=i(_l,"The "),gc=n(_l,"CODE",{});var pD=r(gc);Ak=i(pD,"FlaxDistilBertPreTrainedModel"),pD.forEach(t),Ok=i(_l,"forward method, overrides the "),_c=n(_l,"CODE",{});var hD=r(_c);Nk=i(hD,"__call__"),hD.forEach(t),Ik=i(_l," special method."),_l.forEach(t),Lk=d(oo),k(As.$$.fragment,oo),Sk=d(oo),vc=n(oo,"P",{});var uD=r(vc);Wk=i(uD,"Example:"),uD.forEach(t),Rk=d(oo),k(xa.$$.fragment,oo),oo.forEach(t),ut.forEach(t),th=d(o),Ro=n(o,"H2",{class:!0});var lu=r(Ro);Os=n(lu,"A",{id:!0,class:!0,href:!0});var fD=r(Os);Tc=n(fD,"SPAN",{});var mD=r(Tc);k(za.$$.fragment,mD),mD.forEach(t),fD.forEach(t),Uk=d(lu),bc=n(lu,"SPAN",{});var gD=r(bc);Hk=i(gD,"FlaxDistilBertForMultipleChoice"),gD.forEach(t),lu.forEach(t),oh=d(o),ze=n(o,"DIV",{class:!0});var ft=r(ze);k(ja.$$.fragment,ft),Qk=d(ft),kc=n(ft,"P",{});var _D=r(kc);Vk=i(_D,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),_D.forEach(t),Jk=d(ft),Ca=n(ft,"P",{});var du=r(Ca);Kk=i(du,"This model inherits from "),Xi=n(du,"A",{href:!0});var vD=r(Xi);Gk=i(vD,"FlaxPreTrainedModel"),vD.forEach(t),Xk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),Yk=d(ft),Pa=n(ft,"P",{});var cu=r(Pa);Zk=i(cu,"This model is also a Flax Linen "),qa=n(cu,"A",{href:!0,rel:!0});var TD=r(qa);ew=i(TD,"flax.linen.Module"),TD.forEach(t),tw=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),ow=d(ft),wc=n(ft,"P",{});var bD=r(wc);sw=i(bD,"Finally, this model supports inherent JAX features such as:"),bD.forEach(t),nw=d(ft),Ct=n(ft,"UL",{});var Ks=r(Ct);yc=n(Ks,"LI",{});var kD=r(yc);Aa=n(kD,"A",{href:!0,rel:!0});var wD=r(Aa);rw=i(wD,"Just-In-Time (JIT) compilation"),wD.forEach(t),kD.forEach(t),aw=d(Ks),$c=n(Ks,"LI",{});var yD=r($c);Oa=n(yD,"A",{href:!0,rel:!0});var $D=r(Oa);iw=i($D,"Automatic Differentiation"),$D.forEach(t),yD.forEach(t),lw=d(Ks),Dc=n(Ks,"LI",{});var DD=r(Dc);Na=n(DD,"A",{href:!0,rel:!0});var FD=r(Na);dw=i(FD,"Vectorization"),FD.forEach(t),DD.forEach(t),cw=d(Ks),Fc=n(Ks,"LI",{});var BD=r(Fc);Ia=n(BD,"A",{href:!0,rel:!0});var MD=r(Ia);pw=i(MD,"Parallelization"),MD.forEach(t),BD.forEach(t),Ks.forEach(t),hw=d(ft),lt=n(ft,"DIV",{class:!0});var so=r(lt);k(La.$$.fragment,so),uw=d(so),Uo=n(so,"P",{});var vl=r(Uo);fw=i(vl,"The "),Bc=n(vl,"CODE",{});var ED=r(Bc);mw=i(ED,"FlaxDistilBertPreTrainedModel"),ED.forEach(t),gw=i(vl,"forward method, overrides the "),Mc=n(vl,"CODE",{});var xD=r(Mc);_w=i(xD,"__call__"),xD.forEach(t),vw=i(vl," special method."),vl.forEach(t),Tw=d(so),k(Ns.$$.fragment,so),bw=d(so),Ec=n(so,"P",{});var zD=r(Ec);kw=i(zD,"Example:"),zD.forEach(t),ww=d(so),k(Sa.$$.fragment,so),so.forEach(t),ft.forEach(t),sh=d(o),Ho=n(o,"H2",{class:!0});var pu=r(Ho);Is=n(pu,"A",{id:!0,class:!0,href:!0});var jD=r(Is);xc=n(jD,"SPAN",{});var CD=r(xc);k(Wa.$$.fragment,CD),CD.forEach(t),jD.forEach(t),yw=d(pu),zc=n(pu,"SPAN",{});var PD=r(zc);$w=i(PD,"FlaxDistilBertForTokenClassification"),PD.forEach(t),pu.forEach(t),nh=d(o),je=n(o,"DIV",{class:!0});var mt=r(je);k(Ra.$$.fragment,mt),Dw=d(mt),jc=n(mt,"P",{});var qD=r(jc);Fw=i(qD,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),qD.forEach(t),Bw=d(mt),Ua=n(mt,"P",{});var hu=r(Ua);Mw=i(hu,"This model inherits from "),Yi=n(hu,"A",{href:!0});var AD=r(Yi);Ew=i(AD,"FlaxPreTrainedModel"),AD.forEach(t),xw=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),zw=d(mt),Ha=n(mt,"P",{});var uu=r(Ha);jw=i(uu,"This model is also a Flax Linen "),Qa=n(uu,"A",{href:!0,rel:!0});var OD=r(Qa);Cw=i(OD,"flax.linen.Module"),OD.forEach(t),Pw=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),qw=d(mt),Cc=n(mt,"P",{});var ND=r(Cc);Aw=i(ND,"Finally, this model supports inherent JAX features such as:"),ND.forEach(t),Ow=d(mt),Pt=n(mt,"UL",{});var Gs=r(Pt);Pc=n(Gs,"LI",{});var ID=r(Pc);Va=n(ID,"A",{href:!0,rel:!0});var LD=r(Va);Nw=i(LD,"Just-In-Time (JIT) compilation"),LD.forEach(t),ID.forEach(t),Iw=d(Gs),qc=n(Gs,"LI",{});var SD=r(qc);Ja=n(SD,"A",{href:!0,rel:!0});var WD=r(Ja);Lw=i(WD,"Automatic Differentiation"),WD.forEach(t),SD.forEach(t),Sw=d(Gs),Ac=n(Gs,"LI",{});var RD=r(Ac);Ka=n(RD,"A",{href:!0,rel:!0});var UD=r(Ka);Ww=i(UD,"Vectorization"),UD.forEach(t),RD.forEach(t),Rw=d(Gs),Oc=n(Gs,"LI",{});var HD=r(Oc);Ga=n(HD,"A",{href:!0,rel:!0});var QD=r(Ga);Uw=i(QD,"Parallelization"),QD.forEach(t),HD.forEach(t),Gs.forEach(t),Hw=d(mt),dt=n(mt,"DIV",{class:!0});var no=r(dt);k(Xa.$$.fragment,no),Qw=d(no),Qo=n(no,"P",{});var Tl=r(Qo);Vw=i(Tl,"The "),Nc=n(Tl,"CODE",{});var VD=r(Nc);Jw=i(VD,"FlaxDistilBertPreTrainedModel"),VD.forEach(t),Kw=i(Tl,"forward method, overrides the "),Ic=n(Tl,"CODE",{});var JD=r(Ic);Gw=i(JD,"__call__"),JD.forEach(t),Xw=i(Tl," special method."),Tl.forEach(t),Yw=d(no),k(Ls.$$.fragment,no),Zw=d(no),Lc=n(no,"P",{});var KD=r(Lc);e1=i(KD,"Example:"),KD.forEach(t),t1=d(no),k(Ya.$$.fragment,no),no.forEach(t),mt.forEach(t),rh=d(o),Vo=n(o,"H2",{class:!0});var fu=r(Vo);Ss=n(fu,"A",{id:!0,class:!0,href:!0});var GD=r(Ss);Sc=n(GD,"SPAN",{});var XD=r(Sc);k(Za.$$.fragment,XD),XD.forEach(t),GD.forEach(t),o1=d(fu),Wc=n(fu,"SPAN",{});var YD=r(Wc);s1=i(YD,"FlaxDistilBertForQuestionAnswering"),YD.forEach(t),fu.forEach(t),ah=d(o),Ce=n(o,"DIV",{class:!0});var gt=r(Ce);k(ei.$$.fragment,gt),n1=d(gt),Jo=n(gt,"P",{});var bl=r(Jo);r1=i(bl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Rc=n(bl,"CODE",{});var ZD=r(Rc);a1=i(ZD,"span start logits"),ZD.forEach(t),i1=i(bl," and "),Uc=n(bl,"CODE",{});var eF=r(Uc);l1=i(eF,"span end logits"),eF.forEach(t),d1=i(bl,")."),bl.forEach(t),c1=d(gt),ti=n(gt,"P",{});var mu=r(ti);p1=i(mu,"This model inherits from "),Zi=n(mu,"A",{href:!0});var tF=r(Zi);h1=i(tF,"FlaxPreTrainedModel"),tF.forEach(t),u1=i(mu,`. Check the superclass documentation for the generic methods the
