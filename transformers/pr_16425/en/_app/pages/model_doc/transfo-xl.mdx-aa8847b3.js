import{S as Cf,i as Pf,s as jf,e as n,k as l,w as v,t as r,M as Of,c as s,d as t,m as d,a,x as b,h as i,b as c,F as e,g as f,y as w,q as y,o as k,B as L,v as Sf}from"../../chunks/vendor-6b77c823.js";import{T as it}from"../../chunks/Tip-39098574.js";import{D as te}from"../../chunks/Docstring-abef54e3.js";import{C as Qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ge}from"../../chunks/IconCopyLink-7a11ce68.js";function Nf(R){let p,M,u,g,$,_,T,X,I,W;return{c(){p=n("p"),M=r("TransformerXL does "),u=n("strong"),g=r("not"),$=r(" work with "),_=n("em"),T=r("torch.nn.DataParallel"),X=r(" due to a bug in PyTorch, see "),I=n("a"),W=r("issue #36035"),this.h()},l(x){p=s(x,"P",{});var C=a(p);M=i(C,"TransformerXL does "),u=s(C,"STRONG",{});var O=a(u);g=i(O,"not"),O.forEach(t),$=i(C," work with "),_=s(C,"EM",{});var K=a(_);T=i(K,"torch.nn.DataParallel"),K.forEach(t),X=i(C," due to a bug in PyTorch, see "),I=s(C,"A",{href:!0,rel:!0});var ae=a(I);W=i(ae,"issue #36035"),ae.forEach(t),C.forEach(t),this.h()},h(){c(I,"href","https://github.com/pytorch/pytorch/issues/36035"),c(I,"rel","nofollow")},m(x,C){f(x,p,C),e(p,M),e(p,u),e(u,g),e(p,$),e(p,_),e(_,T),e(p,X),e(p,I),e(I,W)},d(x){x&&t(p)}}}function Af(R){let p,M,u,g,$;return{c(){p=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var T=a(p);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,p,T),e(p,M),e(p,u),e(u,g),e(p,$)},d(_){_&&t(p)}}}function If(R){let p,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){p=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),V=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),B=s(H,"CODE",{});var pe=a(B);$e=i(pe,"model(inputs)"),pe.forEach(t),ge=i(H,"."),H.forEach(t),U=d(h),N=s(h,"P",{});var He=a(N);ne=i(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),re=d(h),F=s(h,"UL",{});var P=a(F);z=s(P,"LI",{});var S=a(z);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var ze=a(Q);_e=i(ze,"input_ids"),ze.forEach(t),le=i(S," only and nothing else: "),V=s(S,"CODE",{});var we=a(V);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,p,E),e(p,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,B),e(B,$e),e(x,ge),f(h,U,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,V),e(V,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(p),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(U),h&&t(N),h&&t(re),h&&t(F)}}}function Wf(R){let p,M,u,g,$;return{c(){p=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var T=a(p);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,p,T),e(p,M),e(p,u),e(u,g),e(p,$)},d(_){_&&t(p)}}}function Bf(R){let p,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){p=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),V=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),he=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=s(h,"P",{});var E=a(p);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(h),g=s(h,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Be=a(X);I=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),de.forEach(t),W=d(h),x=s(h,"P",{});var H=a(x);C=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(h),F=s(h,"UL",{});var P=a(F);z=s(P,"LI",{});var S=a(z);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var ze=a(Q);_e=i(ze,"input_ids"),ze.forEach(t),le=i(S," only and nothing else: "),V=s(S,"CODE",{});var we=a(V);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var Ce=a(G);oe=i(Ce,"model([input_ids, attention_mask])"),Ce.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),he=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,p,E),e(p,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,B),e(B,$e),e(x,ge),f(h,U,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,V),e(V,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(p),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(U),h&&t(N),h&&t(re),h&&t(F)}}}function Uf(R){let p,M,u,g,$;return{c(){p=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var T=a(p);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,p,T),e(p,M),e(p,u),e(u,g),e(p,$)},d(_){_&&t(p)}}}function Vf(R){let p,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){p=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),V=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),he=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=s(h,"P",{});var E=a(p);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(h),g=s(h,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Be=a(X);I=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),de.forEach(t),W=d(h),x=s(h,"P",{});var H=a(x);C=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(h),F=s(h,"UL",{});var P=a(F);z=s(P,"LI",{});var S=a(z);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var ze=a(Q);_e=i(ze,"input_ids"),ze.forEach(t),le=i(S," only and nothing else: "),V=s(S,"CODE",{});var we=a(V);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var Ce=a(G);oe=i(Ce,"model([input_ids, attention_mask])"),Ce.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),he=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,p,E),e(p,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,B),e(B,$e),e(x,ge),f(h,U,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,V),e(V,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(p),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(U),h&&t(N),h&&t(re),h&&t(F)}}}function Rf(R){let p,M,u,g,$;return{c(){p=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var T=a(p);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,p,T),e(p,M),e(p,u),e(u,g),e(p,$)},d(_){_&&t(p)}}}function Kf(R){let p,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee,h,E,de,be,Be,H,Ae,pe,He,P,S,ze,we,J,Ce,Ue,ye,D,Kt,Da,Ye,Ia,cn,Wa,Ba,fn,Ua,Va,Gt,Ra,Ka,Ga,lt,Ya,hn,Qa,Za,pn,Ja,er,tr,Hn,or,nr,Yt,Ws,dt,Mt,Dn,Qt,sr,In,ar,Bs,De,Zt,rr,Jt,ir,eo,lr,dr,cr,to,fr,mn,hr,pr,mr,un,oo,Us,ct,Et,Wn,no,ur,Bn,gr,Vs,ft,so,_r,Un,Tr,Rs,ht,ao,vr,Vn,br,Ks,pt,ro,wr,Rn,yr,Gs,mt,io,kr,Kn,Lr,Ys,ut,Ft,Gn,lo,$r,Yn,xr,Qs,Fe,co,Xr,Qn,Mr,Er,fo,Fr,gn,qr,zr,Cr,ho,Pr,po,jr,Or,Sr,Pe,mo,Nr,gt,Ar,_n,Hr,Dr,Zn,Ir,Wr,Br,qt,Ur,Jn,Vr,Rr,uo,Zs,_t,zt,es,go,Kr,ts,Gr,Js,qe,_o,Yr,os,Qr,Zr,To,Jr,Tn,ei,ti,oi,vo,ni,bo,si,ai,ri,je,wo,ii,Tt,li,vn,di,ci,ns,fi,hi,pi,Ct,mi,ss,ui,gi,yo,ea,vt,Pt,as,ko,_i,rs,Ti,ta,se,Lo,vi,is,bi,wi,bn,wn,yi,ki,Li,Ie,$i,ls,xi,Xi,ds,Mi,Ei,cs,Fi,qi,fs,zi,Ci,Pi,$o,ji,yn,Oi,Si,Ni,xo,Ai,Xo,Hi,Di,Ii,Y,Mo,Wi,bt,Bi,kn,Ui,Vi,hs,Ri,Ki,Gi,jt,Yi,ps,Qi,Zi,Eo,Ji,Fo,el,ms,tl,ol,qo,nl,zo,oa,wt,Ot,us,Co,sl,gs,al,na,me,Po,rl,_s,il,ll,jo,dl,Ln,cl,fl,hl,Oo,pl,So,ml,ul,gl,St,_l,Oe,No,Tl,yt,vl,$n,bl,wl,Ts,yl,kl,Ll,Nt,$l,vs,xl,Xl,Ao,sa,kt,At,bs,Ho,Ml,ws,El,aa,ue,Do,Fl,ys,ql,zl,Io,Cl,xn,Pl,jl,Ol,Wo,Sl,Bo,Nl,Al,Hl,Ht,Dl,Se,Uo,Il,Lt,Wl,Xn,Bl,Ul,ks,Vl,Rl,Kl,Dt,Gl,Ls,Yl,Ql,Vo,ra,$t,It,$s,Ro,Zl,xs,Jl,ia,ee,Ko,ed,Xs,td,od,Mn,En,nd,sd,ad,We,rd,Ms,id,ld,Es,dd,cd,Fs,fd,hd,qs,pd,md,ud,Go,gd,Fn,_d,Td,vd,Yo,bd,Qo,wd,yd,kd,Wt,Ld,ke,Zo,$d,xt,xd,qn,Xd,Md,zs,Ed,Fd,qd,Bt,zd,Cs,Cd,Pd,Jo,jd,en,la,Xt,Ut,Ps,tn,Od,js,Sd,da,on,nn,ca,sn,an,fa;return _=new Ge({}),K=new Ge({}),pe=new it({props:{warning:!0,$$slots:{default:[Nf]},$$scope:{ctx:R}}}),we=new Ge({}),Kt=new te({props:{name:"class transformers.TransfoXLConfig",anchor:"transformers.TransfoXLConfig",parameters:[{name:"vocab_size",val:" = 267735"},{name:"cutoffs",val:" = [20000, 40000, 200000]"},{name:"d_model",val:" = 1024"},{name:"d_embed",val:" = 1024"},{name:"n_head",val:" = 16"},{name:"d_head",val:" = 64"},{name:"d_inner",val:" = 4096"},{name:"div_val",val:" = 4"},{name:"pre_lnorm",val:" = False"},{name:"n_layer",val:" = 18"},{name:"mem_len",val:" = 1600"},{name:"clamp_len",val:" = 1000"},{name:"same_length",val:" = True"},{name:"proj_share_all_but_first",val:" = True"},{name:"attn_type",val:" = 0"},{name:"sample_softmax",val:" = -1"},{name:"adaptive",val:" = True"},{name:"dropout",val:" = 0.1"},{name:"dropatt",val:" = 0.0"},{name:"untie_r",val:" = True"},{name:"init",val:" = 'normal'"},{name:"init_range",val:" = 0.01"},{name:"proj_init_std",val:" = 0.01"},{name:"init_std",val:" = 0.02"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29",parametersDescription:[{anchor:"transformers.TransfoXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 267735) &#x2014;
...
Tuple of <code>tf.Tensor</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}]}}),lo=new Ge({}),co=new te({props:{name:"class transformers.TransfoXLModel",anchor:"transformers.TransfoXLModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L771",parametersDescription:[{anchor:"transformers.TransfoXLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),mo=new te({props:{name:"forward",anchor:"transformers.TransfoXLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L875",parametersDescription:[{anchor:"transformers.TransfoXLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),go=new Ge({}),_o=new te({props:{name:"class transformers.TransfoXLLMHeadModel",anchor:"transformers.TransfoXLLMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1013",parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wo=new te({props:{name:"forward",anchor:"transformers.TransfoXLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1065",parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ko=new Ge({}),Lo=new te({props:{name:"class transformers.TransfoXLForSequenceClassification",anchor:"transformers.TransfoXLForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1198",parametersDescription:[{anchor:"transformers.TransfoXLForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Mo=new te({props:{name:"forward",anchor:"transformers.TransfoXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"mems",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1209",parametersDescription:[{anchor:"transformers.TransfoXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),Co=new Ge({}),Po=new te({props:{name:"class transformers.TFTransfoXLModel",anchor:"transformers.TFTransfoXLModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L878",parametersDescription:[{anchor:"transformers.TFTransfoXLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new it({props:{$$slots:{default:[If]},$$scope:{ctx:R}}}),No=new te({props:{name:"call",anchor:"transformers.TFTransfoXLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L883",parametersDescription:[{anchor:"transformers.TFTransfoXLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ho=new Ge({}),Do=new te({props:{name:"class transformers.TFTransfoXLLMHeadModel",anchor:"transformers.TFTransfoXLLMHeadModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L935",parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new it({props:{$$slots:{default:[Bf]},$$scope:{ctx:R}}}),Uo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L963",parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput"
...
`}}),Dt=new it({props:{$$slots:{default:[Uf]},$$scope:{ctx:R}}}),Vo=new Qe({props:{code:`from transformers import TransfoXLTokenizer, TFTransfoXLLMHeadModel
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ro=new Ge({}),Ko=new te({props:{name:"class transformers.TFTransfoXLForSequenceClassification",anchor:"transformers.TFTransfoXLForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1057",parametersDescription:[{anchor:"transformers.TFTransfoXLForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wt=new it({props:{$$slots:{default:[Vf]},$$scope:{ctx:R}}}),Zo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"mems",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1072",parametersDescription:[{anchor:"transformers.TFTransfoXLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Bt=new it({props:{$$slots:{default:[Rf]},$$scope:{ctx:R}}}),Jo=new Qe({props:{code:`from transformers import TransfoXLTokenizer, TFTransfoXLForSequenceClassification
import tensorflow as tf
...
inputs and outputs (tied).`),z=l(),ie=n("p"),Q=r("The abstract from the paper is the following:"),_e=l(),le=n("p"),V=n("em"),xe=r(`Transformers have a potential of learning longer-term dependency, but are limited by a fixed-length context in the
...
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Me=l(),he=n("li"),A=r("Transformer-XL is one of the few models that has no sequence length limit."),ve=l(),j=n("p"),Ee=r("This model was contributed by "),h=n("a"),E=r("thomwolf"),de=r(". The original code can be found "),be=n("a"),Be=r("here"),H=r("."),Ae=l(),v(pe.$$.fragment),He=l(),P=n("h2"),S=n("a"),ze=n("span"),v(we.$$.fragment),J=l(),Ce=n("span"),Ue=r("TransfoXLConfig"),ye=l(),D=n("div"),v(Kt.$$.fragment),Da=l(),Ye=n("p"),Ia=r("This is the configuration class to store the configuration of a "),cn=n("a"),Wa=r("TransfoXLModel"),Ba=r(" or a "),fn=n("a"),Ua=r("TFTransfoXLModel"),Va=r(`. It is
...
documentation from `),pn=n("a"),Ja=r("PretrainedConfig"),er=r(" for more information."),tr=l(),Hn=n("p"),or=r("Examples:"),nr=l(),v(Yt.$$.fragment),Ws=l(),dt=n("h2"),Mt=n("a"),Dn=n("span"),v(Qt.$$.fragment),sr=l(),In=n("span"),ar=r("TransfoXLTokenizer"),Bs=l(),De=n("div"),v(Zt.$$.fragment),rr=l(),Jt=n("p"),ir=r("Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=n("a"),lr=r(`the original
...
this superclass for more information regarding those methods.`),mr=l(),un=n("div"),v(oo.$$.fragment),Us=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Bn=n("span"),gr=r("TransfoXL specific outputs"),Vs=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Un=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),ht=n("div"),v(ao.$$.fragment),vr=l(),Vn=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),pt=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),mt=n("div"),v(io.$$.fragment),kr=l(),Kn=n("p"),Lr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),zr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=l(),ho=n("p"),Pr=r("This model is also a PyTorch "),po=n("a"),jr=r("torch.nn.Module"),Or=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sr=l(),Pe=n("div"),v(mo.$$.fragment),Nr=l(),gt=n("p"),Ar=r("The "),_n=n("a"),Hr=r("TransfoXLModel"),Dr=r(" forward method, overrides the "),Zn=n("code"),Ir=r("__call__"),Wr=r(" special method."),Br=l(),v(qt.$$.fragment),Ur=l(),Jn=n("p"),Vr=r("Example:"),Rr=l(),v(uo.$$.fragment),Zs=l(),_t=n("h2"),zt=n("a"),es=n("span"),v(go.$$.fragment),Kr=l(),ts=n("span"),Gr=r("TransfoXLLMHeadModel"),Js=l(),qe=n("div"),v(_o.$$.fragment),Yr=l(),os=n("p"),Qr=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ri=l(),je=n("div"),v(wo.$$.fragment),ii=l(),Tt=n("p"),li=r("The "),vn=n("a"),di=r("TransfoXLLMHeadModel"),ci=r(" forward method, overrides the "),ns=n("code"),fi=r("__call__"),hi=r(" special method."),pi=l(),v(Ct.$$.fragment),mi=l(),ss=n("p"),ui=r("Example:"),gi=l(),v(yo.$$.fragment),ea=l(),vt=n("h2"),Pt=n("a"),as=n("span"),v(ko.$$.fragment),_i=l(),rs=n("span"),Ti=r("TransfoXLForSequenceClassification"),ta=l(),se=n("div"),v(Lo.$$.fragment),vi=l(),is=n("p"),bi=r("The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),wi=l(),bn=n("p"),wn=n("a"),yi=r("TransfoXLForSequenceClassification"),ki=r(` uses the last token in order to do the classification, as other causal
models (e.g. GPT-1) do.`),Li=l(),Ie=n("p"),$i=r(`Since it does classification on the last token, it requires to know the position of the last token. If a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Bi=r("The "),kn=n("a"),Ui=r("TransfoXLForSequenceClassification"),Vi=r(" forward method, overrides the "),hs=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),ps=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ms=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(zo.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(Co.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),me=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),Ln=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hl=l(),Oo=n("p"),pl=r("This model is also a "),So=n("a"),ml=r("tf.keras.Model"),ul=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gl=l(),v(St.$$.fragment),_l=l(),Oe=n("div"),v(No.$$.fragment),Tl=l(),yt=n("p"),vl=r("The "),$n=n("a"),bl=r("TFTransfoXLModel"),wl=r(" forward method, overrides the "),Ts=n("code"),yl=r("__call__"),kl=r(" special method."),Ll=l(),v(Nt.$$.fragment),$l=l(),vs=n("p"),xl=r("Example:"),Xl=l(),v(Ao.$$.fragment),sa=l(),kt=n("h2"),At=n("a"),bs=n("span"),v(Ho.$$.fragment),Ml=l(),ws=n("span"),El=r("TFTransfoXLLMHeadModel"),aa=l(),ue=n("div"),v(Do.$$.fragment),Fl=l(),ys=n("p"),ql=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ol=l(),Wo=n("p"),Sl=r("This model is also a "),Bo=n("a"),Nl=r("tf.keras.Model"),Al=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hl=l(),v(Ht.$$.fragment),Dl=l(),Se=n("div"),v(Uo.$$.fragment),Il=l(),Lt=n("p"),Wl=r("The "),Xn=n("a"),Bl=r("TFTransfoXLLMHeadModel"),Ul=r(" forward method, overrides the "),ks=n("code"),Vl=r("__call__"),Rl=r(" special method."),Kl=l(),v(Dt.$$.fragment),Gl=l(),Ls=n("p"),Yl=r("Example:"),Ql=l(),v(Vo.$$.fragment),ra=l(),$t=n("h2"),It=n("a"),$s=n("span"),v(Ro.$$.fragment),Zl=l(),xs=n("span"),Jl=r("TFTransfoXLForSequenceClassification"),ia=l(),ee=n("div"),v(Ko.$$.fragment),ed=l(),Xs=n("p"),td=r("The Transfo XL Model transformer with a sequence classification head on top (linear layer)."),od=l(),Mn=n("p"),En=n("a"),nd=r("TFTransfoXLForSequenceClassification"),sd=r(` uses the last token in order to do the classification, as other causal
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kd=l(),v(Wt.$$.fragment),Ld=l(),ke=n("div"),v(Zo.$$.fragment),$d=l(),xt=n("p"),xd=r("The "),qn=n("a"),Xd=r("TFTransfoXLForSequenceClassification"),Md=r(" forward method, overrides the "),zs=n("code"),Ed=r("__call__"),Fd=r(" special method."),qd=l(),v(Bt.$$.fragment),zd=l(),Cs=n("p"),Cd=r("Example:"),Pd=l(),v(Jo.$$.fragment),jd=l(),v(en.$$.fragment),la=l(),Xt=n("h2"),Ut=n("a"),Ps=n("span"),v(tn.$$.fragment),Od=l(),js=n("span"),Sd=r("Internal Layers"),da=l(),on=n("div"),v(nn.$$.fragment),ca=l(),sn=n("div"),v(an.$$.fragment),this.h()},l(o){const m=Of('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(t),M=d(o),u=s(o,"H1",{class:!0});var rn=a(u);g=s(rn,"A",{id:!0,class:!0,href:!0});var Os=a(g);$=s(Os,"SPAN",{});var Ss=a($);b(_.$$.fragment,Ss),Ss.forEach(t),Os.forEach(t),T=d(rn),X=s(rn,"SPAN",{});var Ns=a(X);I=i(Ns,"Transformer XL"),Ns.forEach(t),rn.forEach(t),W=d(o),x=s(o,"H2",{class:!0});var ln=a(x);C=s(ln,"A",{id:!0,class:!0,href:!0});var As=a(C);O=s(As,"SPAN",{});var Hs=a(O);b(K.$$.fragment,Hs),Hs.forEach(t),As.forEach(t),ae=d(ln),B=s(ln,"SPAN",{});var Ds=a(B);$e=i(Ds,"Overview"),Ds.forEach(t),ln.forEach(t),ge=d(o),U=s(o,"P",{});var dn=a(U);N=i(dn,"The Transformer-XL model was proposed in "),ne=s(dn,"A",{href:!0,rel:!0});var Is=a(ne);re=i(Is,"Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context"),Is.forEach(t),F=i(dn,` by Zihang Dai, Zhilin Yang, Yiming Yang, Jaime Carbonell, Quoc V. Le, Ruslan
Salakhutdinov. It\u2019s a causal (uni-directional) transformer with relative positioning (sinuso\xEFdal) embeddings which can
reuse previously computed hidden-states to attend to longer context (memory). This model also uses adaptive softmax
inputs and outputs (tied).`),dn.forEach(t),z=d(o),ie=s(o,"P",{});var Hd=a(ie);Q=i(Hd,"The abstract from the paper is the following:"),Hd.forEach(t),_e=d(o),le=s(o,"P",{});var Dd=a(le);V=s(Dd,"EM",{});var Id=a(V);xe=i(Id,`Transformers have a potential of learning longer-term dependency, but are limited by a fixed-length context in the
setting of language modeling. We propose a novel neural architecture Transformer-XL that enables learning dependency
beyond a fixed length without disrupting temporal coherence. It consists of a segment-level recurrence mechanism and a
novel positional encoding scheme. Our method not only enables capturing longer-term dependency, but also resolves the
context fragmentation problem. As a result, Transformer-XL learns dependency that is 80% longer than RNNs and 450%
...
bpc/perplexity to 0.99 on enwiki8, 1.08 on text8, 18.3 on WikiText-103, 21.8 on One Billion Word, and 54.5 on Penn
Treebank (without finetuning). When trained only on WikiText-103, Transformer-XL manages to generate reasonably
coherent, novel text articles with thousands of tokens.`),Id.forEach(t),Dd.forEach(t),Te=d(o),q=s(o,"P",{});var Wd=a(q);Xe=i(Wd,"Tips:"),Wd.forEach(t),G=d(o),oe=s(o,"UL",{});var ha=a(oe);fe=s(ha,"LI",{});var Bd=a(fe);Z=i(Bd,`Transformer-XL uses relative sinusoidal positional embeddings. Padding can be done on the left or on the right. The
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Bd.forEach(t),Me=d(ha),he=s(ha,"LI",{});var Ud=a(he);A=i(Ud,"Transformer-XL is one of the few models that has no sequence length limit."),Ud.forEach(t),ha.forEach(t),ve=d(o),j=s(o,"P",{});var zn=a(j);Ee=i(zn,"This model was contributed by "),h=s(zn,"A",{href:!0,rel:!0});var Vd=a(h);E=i(Vd,"thomwolf"),Vd.forEach(t),de=i(zn,". The original code can be found "),be=s(zn,"A",{href:!0,rel:!0});var Rd=a(be);Be=i(Rd,"here"),Rd.forEach(t),H=i(zn,"."),zn.forEach(t),Ae=d(o),b(pe.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var pa=a(P);S=s(pa,"A",{id:!0,class:!0,href:!0});var Kd=a(S);ze=s(Kd,"SPAN",{});var Gd=a(ze);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(pa),Ce=s(pa,"SPAN",{});var Yd=a(Ce);Ue=i(Yd,"TransfoXLConfig"),Yd.forEach(t),pa.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Vt=a(Ye);Ia=i(Vt,"This is the configuration class to store the configuration of a "),cn=s(Vt,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Ba=i(Vt," or a "),fn=s(Vt,"A",{href:!0});var Zd=a(fn);Ua=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Va=i(Vt,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the `),Gt=s(Vt,"A",{href:!0,rel:!0});var Jd=a(Gt);Ra=i(Jd,`Transformer
XL`),Jd.forEach(t),Ka=i(Vt," architecture."),Vt.forEach(t),Ga=d(Ze),lt=s(Ze,"P",{});var Cn=a(lt);Ya=i(Cn,"Configuration objects inherit from "),hn=s(Cn,"A",{href:!0});var ec=a(hn);Qa=i(ec,"PretrainedConfig"),ec.forEach(t),Za=i(Cn,` and can be used to control the model outputs. Read the
documentation from `),pn=s(Cn,"A",{href:!0});var tc=a(pn);Ja=i(tc,"PretrainedConfig"),tc.forEach(t),er=i(Cn," for more information."),Cn.forEach(t),tr=d(Ze),Hn=s(Ze,"P",{});var oc=a(Hn);or=i(oc,"Examples:"),oc.forEach(t),nr=d(Ze),b(Yt.$$.fragment,Ze),Ze.forEach(t),Ws=d(o),dt=s(o,"H2",{class:!0});var ma=a(dt);Mt=s(ma,"A",{id:!0,class:!0,href:!0});var nc=a(Mt);Dn=s(nc,"SPAN",{});var sc=a(Dn);b(Qt.$$.fragment,sc),sc.forEach(t),nc.forEach(t),sr=d(ma),In=s(ma,"SPAN",{});var ac=a(In);ar=i(ac,"TransfoXLTokenizer"),ac.forEach(t),ma.forEach(t),Bs=d(o),De=s(o,"DIV",{class:!0});var Rt=a(De);b(Zt.$$.fragment,Rt),rr=d(Rt),Jt=s(Rt,"P",{});var ua=a(Jt);ir=i(ua,"Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=s(ua,"A",{href:!0,rel:!0});var rc=a(eo);lr=i(rc,`the original
...
this superclass for more information regarding those methods.`),ga.forEach(t),mr=d(Rt),un=s(Rt,"DIV",{class:!0});var lc=a(un);b(oo.$$.fragment,lc),lc.forEach(t),Rt.forEach(t),Us=d(o),ct=s(o,"H2",{class:!0});var _a=a(ct);Et=s(_a,"A",{id:!0,class:!0,href:!0});var dc=a(Et);Wn=s(dc,"SPAN",{});var cc=a(Wn);b(no.$$.fragment,cc),cc.forEach(t),dc.forEach(t),ur=d(_a),Bn=s(_a,"SPAN",{});var fc=a(Bn);gr=i(fc,"TransfoXL specific outputs"),fc.forEach(t),_a.forEach(t),Vs=d(o),ft=s(o,"DIV",{class:!0});var Ta=a(ft);b(so.$$.fragment,Ta),_r=d(Ta),Un=s(Ta,"P",{});var hc=a(Un);Tr=i(hc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),hc.forEach(t),Ta.forEach(t),Rs=d(o),ht=s(o,"DIV",{class:!0});var va=a(ht);b(ao.$$.fragment,va),vr=d(va),Vn=s(va,"P",{});var pc=a(Vn);br=i(pc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),pc.forEach(t),va.forEach(t),Ks=d(o),pt=s(o,"DIV",{class:!0});var ba=a(pt);b(ro.$$.fragment,ba),wr=d(ba),Rn=s(ba,"P",{});var mc=a(Rn);yr=i(mc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),mc.forEach(t),ba.forEach(t),Gs=d(o),mt=s(o,"DIV",{class:!0});var wa=a(mt);b(io.$$.fragment,wa),kr=d(wa),Kn=s(wa,"P",{});var uc=a(Kn);Lr=i(uc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),uc.forEach(t),wa.forEach(t),Ys=d(o),ut=s(o,"H2",{class:!0});var ya=a(ut);Ft=s(ya,"A",{id:!0,class:!0,href:!0});var gc=a(Ft);Gn=s(gc,"SPAN",{});var _c=a(Gn);b(lo.$$.fragment,_c),_c.forEach(t),gc.forEach(t),$r=d(ya),Yn=s(ya,"SPAN",{});var Tc=a(Yn);xr=i(Tc,"TransfoXLModel"),Tc.forEach(t),ya.forEach(t),Qs=d(o),Fe=s(o,"DIV",{class:!0});var Je=a(Fe);b(co.$$.fragment,Je),Xr=d(Je),Qn=s(Je,"P",{});var vc=a(Qn);Mr=i(vc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),vc.forEach(t),Er=d(Je),fo=s(Je,"P",{});var ka=a(fo);Fr=i(ka,"This model inherits from "),gn=s(ka,"A",{href:!0});var bc=a(gn);qr=i(bc,"PreTrainedModel"),bc.forEach(t),zr=i(ka,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ka.forEach(t),Cr=d(Je),ho=s(Je,"P",{});var La=a(ho);Pr=i(La,"This model is also a PyTorch "),po=s(La,"A",{href:!0,rel:!0});var wc=a(po);jr=i(wc,"torch.nn.Module"),wc.forEach(t),Or=i(La,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),La.forEach(t),Sr=d(Je),Pe=s(Je,"DIV",{class:!0});var et=a(Pe);b(mo.$$.fragment,et),Nr=d(et),gt=s(et,"P",{});var Pn=a(gt);Ar=i(Pn,"The "),_n=s(Pn,"A",{href:!0});var yc=a(_n);Hr=i(yc,"TransfoXLModel"),yc.forEach(t),Dr=i(Pn," forward method, overrides the "),Zn=s(Pn,"CODE",{});var kc=a(Zn);Ir=i(kc,"__call__"),kc.forEach(t),Wr=i(Pn," special method."),Pn.forEach(t),Br=d(et),b(qt.$$.fragment,et),Ur=d(et),Jn=s(et,"P",{});var Lc=a(Jn);Vr=i(Lc,"Example:"),Lc.forEach(t),Rr=d(et),b(uo.$$.fragment,et),et.forEach(t),Je.forEach(t),Zs=d(o),_t=s(o,"H2",{class:!0});var $a=a(_t);zt=s($a,"A",{id:!0,class:!0,href:!0});var $c=a(zt);es=s($c,"SPAN",{});var xc=a(es);b(go.$$.fragment,xc),xc.forEach(t),$c.forEach(t),Kr=d($a),ts=s($a,"SPAN",{});var Xc=a(ts);Gr=i(Xc,"TransfoXLLMHeadModel"),Xc.forEach(t),$a.forEach(t),Js=d(o),qe=s(o,"DIV",{class:!0});var tt=a(qe);b(_o.$$.fragment,tt),Yr=d(tt),os=s(tt,"P",{});var Mc=a(os);Qr=i(Mc,`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa.forEach(t),ri=d(tt),je=s(tt,"DIV",{class:!0});var ot=a(je);b(wo.$$.fragment,ot),ii=d(ot),Tt=s(ot,"P",{});var jn=a(Tt);li=i(jn,"The "),vn=s(jn,"A",{href:!0});var qc=a(vn);di=i(qc,"TransfoXLLMHeadModel"),qc.forEach(t),ci=i(jn," forward method, overrides the "),ns=s(jn,"CODE",{});var zc=a(ns);fi=i(zc,"__call__"),zc.forEach(t),hi=i(jn," special method."),jn.forEach(t),pi=d(ot),b(Ct.$$.fragment,ot),mi=d(ot),ss=s(ot,"P",{});var Cc=a(ss);ui=i(Cc,"Example:"),Cc.forEach(t),gi=d(ot),b(yo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),ea=d(o),vt=s(o,"H2",{class:!0});var Ma=a(vt);Pt=s(Ma,"A",{id:!0,class:!0,href:!0});var Pc=a(Pt);as=s(Pc,"SPAN",{});var jc=a(as);b(ko.$$.fragment,jc),jc.forEach(t),Pc.forEach(t),_i=d(Ma),rs=s(Ma,"SPAN",{});var Oc=a(rs);Ti=i(Oc,"TransfoXLForSequenceClassification"),Oc.forEach(t),Ma.forEach(t),ta=d(o),se=s(o,"DIV",{class:!0});var Ne=a(se);b(Lo.$$.fragment,Ne),vi=d(Ne),is=s(Ne,"P",{});var Sc=a(is);bi=i(Sc,"The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),Sc.forEach(t),wi=d(Ne),bn=s(Ne,"P",{});var Nd=a(bn);wn=s(Nd,"A",{href:!0});var Nc=a(wn);yi=i(Nc,"TransfoXLForSequenceClassification"),Nc.forEach(t),ki=i(Nd,` uses the last token in order to do the classification, as other causal
models (e.g. GPT-1) do.`),Nd.forEach(t),Li=d(Ne),Ie=s(Ne,"P",{});var nt=a(Ie);$i=i(nt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ea.forEach(t),Ni=d(Ne),xo=s(Ne,"P",{});var Fa=a(xo);Ai=i(Fa,"This model is also a PyTorch "),Xo=s(Fa,"A",{href:!0,rel:!0});var Bc=a(Xo);Hi=i(Bc,"torch.nn.Module"),Bc.forEach(t),Di=i(Fa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Bi=i(On,"The "),kn=s(On,"A",{href:!0});var Uc=a(kn);Ui=i(Uc,"TransfoXLForSequenceClassification"),Uc.forEach(t),Vi=i(On," forward method, overrides the "),hs=s(On,"CODE",{});var Vc=a(hs);Ri=i(Vc,"__call__"),Vc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),ps=s(ce,"P",{});var Rc=a(ps);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ms=s(ce,"P",{});var Kc=a(ms);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(zo.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(Co.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),me=s(o,"DIV",{class:!0});var Ve=a(me);b(Po.$$.fragment,Ve),rl=d(Ve),_s=s(Ve,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Ve),jo=s(Ve,"P",{});var za=a(jo);dl=i(za,"This model inherits from "),Ln=s(za,"A",{href:!0});var Jc=a(Ln);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(za,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),za.forEach(t),hl=d(Ve),Oo=s(Ve,"P",{});var Ca=a(Oo);pl=i(Ca,"This model is also a "),So=s(Ca,"A",{href:!0,rel:!0});var ef=a(So);ml=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(Ca,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ca.forEach(t),gl=d(Ve),b(St.$$.fragment,Ve),_l=d(Ve),Oe=s(Ve,"DIV",{class:!0});var st=a(Oe);b(No.$$.fragment,st),Tl=d(st),yt=s(st,"P",{});var Sn=a(yt);vl=i(Sn,"The "),$n=s(Sn,"A",{href:!0});var tf=a($n);bl=i(tf,"TFTransfoXLModel"),tf.forEach(t),wl=i(Sn," forward method, overrides the "),Ts=s(Sn,"CODE",{});var of=a(Ts);yl=i(of,"__call__"),of.forEach(t),kl=i(Sn," special method."),Sn.forEach(t),Ll=d(st),b(Nt.$$.fragment,st),$l=d(st),vs=s(st,"P",{});var nf=a(vs);xl=i(nf,"Example:"),nf.forEach(t),Xl=d(st),b(Ao.$$.fragment,st),st.forEach(t),Ve.forEach(t),sa=d(o),kt=s(o,"H2",{class:!0});var Pa=a(kt);At=s(Pa,"A",{id:!0,class:!0,href:!0});var sf=a(At);bs=s(sf,"SPAN",{});var af=a(bs);b(Ho.$$.fragment,af),af.forEach(t),sf.forEach(t),Ml=d(Pa),ws=s(Pa,"SPAN",{});var rf=a(ws);El=i(rf,"TFTransfoXLLMHeadModel"),rf.forEach(t),Pa.forEach(t),aa=d(o),ue=s(o,"DIV",{class:!0});var Re=a(ue);b(Do.$$.fragment,Re),Fl=d(Re),ys=s(Re,"P",{});var lf=a(ys);ql=i(lf,`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ja.forEach(t),Ol=d(Re),Wo=s(Re,"P",{});var Oa=a(Wo);Sl=i(Oa,"This model is also a "),Bo=s(Oa,"A",{href:!0,rel:!0});var cf=a(Bo);Nl=i(cf,"tf.keras.Model"),cf.forEach(t),Al=i(Oa,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oa.forEach(t),Hl=d(Re),b(Ht.$$.fragment,Re),Dl=d(Re),Se=s(Re,"DIV",{class:!0});var at=a(Se);b(Uo.$$.fragment,at),Il=d(at),Lt=s(at,"P",{});var Nn=a(Lt);Wl=i(Nn,"The "),Xn=s(Nn,"A",{href:!0});var ff=a(Xn);Bl=i(ff,"TFTransfoXLLMHeadModel"),ff.forEach(t),Ul=i(Nn," forward method, overrides the "),ks=s(Nn,"CODE",{});var hf=a(ks);Vl=i(hf,"__call__"),hf.forEach(t),Rl=i(Nn," special method."),Nn.forEach(t),Kl=d(at),b(Dt.$$.fragment,at),Gl=d(at),Ls=s(at,"P",{});var pf=a(Ls);Yl=i(pf,"Example:"),pf.forEach(t),Ql=d(at),b(Vo.$$.fragment,at),at.forEach(t),Re.forEach(t),ra=d(o),$t=s(o,"H2",{class:!0});var Sa=a($t);It=s(Sa,"A",{id:!0,class:!0,href:!0});var mf=a(It);$s=s(mf,"SPAN",{});var uf=a($s);b(Ro.$$.fragment,uf),uf.forEach(t),mf.forEach(t),Zl=d(Sa),xs=s(Sa,"SPAN",{});var gf=a(xs);Jl=i(gf,"TFTransfoXLForSequenceClassification"),gf.forEach(t),Sa.forEach(t),ia=d(o),ee=s(o,"DIV",{class:!0});var Le=a(ee);b(Ko.$$.fragment,Le),ed=d(Le),Xs=s(Le,"P",{});var _f=a(Xs);td=i(_f,"The Transfo XL Model transformer with a sequence classification head on top (linear layer)."),_f.forEach(t),od=d(Le),Mn=s(Le,"P",{});var Ad=a(Mn);En=s(Ad,"A",{href:!0});var Tf=a(En);nd=i(Tf,"TFTransfoXLForSequenceClassification"),Tf.forEach(t),sd=i(Ad,` uses the last token in order to do the classification, as other causal
models (e.g. GPT-1,GPT-2) do.`),Ad.forEach(t),ad=d(Le),We=s(Le,"P",{});var rt=a(We);rd=i(rt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
each row of the batch).`),rt.forEach(t),ud=d(Le),Go=s(Le,"P",{});var Na=a(Go);gd=i(Na,"This model inherits from "),Fn=s(Na,"A",{href:!0});var kf=a(Fn);_d=i(kf,"TFPreTrainedModel"),kf.forEach(t),Td=i(Na,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Na.forEach(t),vd=d(Le),Yo=s(Le,"P",{});var Aa=a(Yo);bd=i(Aa,"This model is also a "),Qo=s(Aa,"A",{href:!0,rel:!0});var Lf=a(Qo);wd=i(Lf,"tf.keras.Model"),Lf.forEach(t),yd=i(Aa,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aa.forEach(t),kd=d(Le),b(Wt.$$.fragment,Le),Ld=d(Le),ke=s(Le,"DIV",{class:!0});var Ke=a(ke);b(Zo.$$.fragment,Ke),$d=d(Ke),xt=s(Ke,"P",{});var An=a(xt);xd=i(An,"The "),qn=s(An,"A",{href:!0});var $f=a(qn);Xd=i($f,"TFTransfoXLForSequenceClassification"),$f.forEach(t),Md=i(An," forward method, overrides the "),zs=s(An,"CODE",{});var xf=a(zs);Ed=i(xf,"__call__"),xf.forEach(t),Fd=i(An," special method."),An.forEach(t),qd=d(Ke),b(Bt.$$.fragment,Ke),zd=d(Ke),Cs=s(Ke,"P",{});var Xf=a(Cs);Cd=i(Xf,"Example:"),Xf.forEach(t),Pd=d(Ke),b(Jo.$$.fragment,Ke),jd=d(Ke),b(en.$$.fragment,Ke),Ke.forEach(t),Le.forEach(t),la=d(o),Xt=s(o,"H2",{class:!0});var Ha=a(Xt);Ut=s(Ha,"A",{id:!0,class:!0,href:!0});var Mf=a(Ut);Ps=s(Mf,"SPAN",{});var Ef=a(Ps);b(tn.$$.fragment,Ef),Ef.forEach(t),Mf.forEach(t),Od=d(Ha),js=s(Ha,"SPAN",{});var Ff=a(js);Sd=i(Ff,"Internal Layers"),Ff.forEach(t),Ha.forEach(t),da=d(o),on=s(o,"DIV",{class:!0});var qf=a(on);b(nn.$$.fragment,qf),qf.forEach(t),ca=d(o),sn=s(o,"DIV",{class:!0});var zf=a(sn);b(an.$$.fragment,zf),zf.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Gf)),c(g,"id","transformer-xl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#transformer-xl"),c(u,"class","relative group"),c(C,"id","overview"),c(C,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(C,"href","#overview"),c(x,"class","relative group"),c(ne,"href","https://arxiv.org/abs/1901.02860"),c(ne,"rel","nofollow"),c(h,"href","https://huggingface.co/thomwolf"),c(h,"rel","nofollow"),c(be,"href","https://github.com/kimiyoung/transformer-xl"),c(be,"rel","nofollow"),c(S,"id","transformers.TransfoXLConfig"),c(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(S,"href","#transformers.TransfoXLConfig"),c(P,"class","relative group"),c(cn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLModel"),c(fn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TFTransfoXLModel"),c(Gt,"href","https://huggingface.co/transfo-xl-wt103"),c(Gt,"rel","nofollow"),c(hn,"href","/docs/transformers/pr_16425/en/main_classes/configuration#transformers.PretrainedConfig"),c(pn,"href","/docs/transformers/pr_16425/en/main_classes/configuration#transformers.PretrainedConfig"),c(D,"class","docstring"),c(Mt,"id","transformers.TransfoXLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.TransfoXLTokenizer"),c(dt,"class","relative group"),c(eo,"href","https://github.com/kimiyoung/transformer-xl"),c(eo,"rel","nofollow"),c(mn,"href","/docs/transformers/pr_16425/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(un,"class","docstring"),c(De,"class","docstring"),c(Et,"id","transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(ct,"class","relative group"),c(ft,"class","docstring"),c(ht,"class","docstring"),c(pt,"class","docstring"),c(mt,"class","docstring"),c(Ft,"id","transformers.TransfoXLModel"),c(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ft,"href","#transformers.TransfoXLModel"),c(ut,"class","relative group"),c(gn,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel"),c(po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(po,"rel","nofollow"),c(_n,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLModel"),c(Pe,"class","docstring"),c(Fe,"class","docstring"),c(zt,"id","transformers.TransfoXLLMHeadModel"),c(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zt,"href","#transformers.TransfoXLLMHeadModel"),c(_t,"class","relative group"),c(Tn,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel"),c(bo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(bo,"rel","nofollow"),c(vn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLLMHeadModel"),c(je,"class","docstring"),c(qe,"class","docstring"),c(Pt,"id","transformers.TransfoXLForSequenceClassification"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.TransfoXLForSequenceClassification"),c(vt,"class","relative group"),c(wn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLForSequenceClassification"),c(yn,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel"),c(Xo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Xo,"rel","nofollow"),c(kn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TransfoXLForSequenceClassification"),c(Y,"class","docstring"),c(se,"class","docstring"),c(Ot,"id","transformers.TFTransfoXLModel"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.TFTransfoXLModel"),c(wt,"class","relative group"),c(Ln,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.TFPreTrainedModel"),c(So,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(So,"rel","nofollow"),c($n,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TFTransfoXLModel"),c(Oe,"class","docstring"),c(me,"class","docstring"),c(At,"id","transformers.TFTransfoXLLMHeadModel"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.TFTransfoXLLMHeadModel"),c(kt,"class","relative group"),c(xn,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.TFPreTrainedModel"),c(Bo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Bo,"rel","nofollow"),c(Xn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TFTransfoXLLMHeadModel"),c(Se,"class","docstring"),c(ue,"class","docstring"),c(It,"id","transformers.TFTransfoXLForSequenceClassification"),c(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(It,"href","#transformers.TFTransfoXLForSequenceClassification"),c($t,"class","relative group"),c(En,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TFTransfoXLForSequenceClassification"),c(Fn,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.TFPreTrainedModel"),c(Qo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Qo,"rel","nofollow"),c(qn,"href","/docs/transformers/pr_16425/en/model_doc/transfo-xl#transformers.TFTransfoXLForSequenceClassification"),c(ke,"class","docstring"),c(ee,"class","docstring"),c(Ut,"id","transformers.AdaptiveEmbedding"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.AdaptiveEmbedding"),c(Xt,"class","relative group"),c(on,"class","docstring"),c(sn,"class","docstring")},m(o,m){e(document.head,p),f(o,M,m),f(o,u,m),e(u,g),e(g,$),w(_,$,null),e(u,T),e(u,X),e(X,I),f(o,W,m),f(o,x,m),e(x,C),e(C,O),w(K,O,null),e(x,ae),e(x,B),e(B,$e),f(o,ge,m),f(o,U,m),e(U,N),e(U,ne),e(ne,re),e(U,F),f(o,z,m),f(o,ie,m),e(ie,Q),f(o,_e,m),f(o,le,m),e(le,V),e(V,xe),f(o,Te,m),f(o,q,m),e(q,Xe),f(o,G,m),f(o,oe,m),e(oe,fe),e(fe,Z),e(oe,Me),e(oe,he),e(he,A),f(o,ve,m),f(o,j,m),e(j,Ee),e(j,h),e(h,E),e(j,de),e(j,be),e(be,Be),e(j,H),f(o,Ae,m),w(pe,o,m),f(o,He,m),f(o,P,m),e(P,S),e(S,ze),w(we,ze,null),e(P,J),e(P,Ce),e(Ce,Ue),f(o,ye,m),f(o,D,m),w(Kt,D,null),e(D,Da),e(D,Ye),e(Ye,Ia),e(Ye,cn),e(cn,Wa),e(Ye,Ba),e(Ye,fn),e(fn,Ua),e(Ye,Va),e(Ye,Gt),e(Gt,Ra),e(Ye,Ka),e(D,Ga),e(D,lt),e(lt,Ya),e(lt,hn),e(hn,Qa),e(lt,Za),e(lt,pn),e(pn,Ja),e(lt,er),e(D,tr),e(D,Hn),e(Hn,or),e(D,nr),w(Yt,D,null),f(o,Ws,m),f(o,dt,m),e(dt,Mt),e(Mt,Dn),w(Qt,Dn,null),e(dt,sr),e(dt,In),e(In,ar),f(o,Bs,m),f(o,De,m),w(Zt,De,null),e(De,rr),e(De,Jt),e(Jt,ir),e(Jt,eo),e(eo,lr),e(Jt,dr),e(De,cr),e(De,to),e(to,fr),e(to,mn),e(mn,hr),e(to,pr),e(De,mr),e(De,un),w(oo,un,null),f(o,Us,m),f(o,ct,m),e(ct,Et),e(Et,Wn),w(no,Wn,null),e(ct,ur),e(ct,Bn),e(Bn,gr),f(o,Vs,m),f(o,ft,m),w(so,ft,null),e(ft,_r),e(ft,Un),e(Un,Tr),f(o,Rs,m),f(o,ht,m),w(ao,ht,null),e(ht,vr),e(ht,Vn),e(Vn,br),f(o,Ks,m),f(o,pt,m),w(ro,pt,null),e(pt,wr),e(pt,Rn),e(Rn,yr),f(o,Gs,m),f(o,mt,m),w(io,mt,null),e(mt,kr),e(mt,Kn),e(Kn,Lr),f(o,Ys,m),f(o,ut,m),e(ut,Ft),e(Ft,Gn),w(lo,Gn,null),e(ut,$r),e(ut,Yn),e(Yn,xr),f(o,Qs,m),f(o,Fe,m),w(co,Fe,null),e(Fe,Xr),e(Fe,Qn),e(Qn,Mr),e(Fe,Er),e(Fe,fo),e(fo,Fr),e(fo,gn),e(gn,qr),e(fo,zr),e(Fe,Cr),e(Fe,ho),e(ho,Pr),e(ho,po),e(po,jr),e(ho,Or),e(Fe,Sr),e(Fe,Pe),w(mo,Pe,null),e(Pe,Nr),e(Pe,gt),e(gt,Ar),e(gt,_n),e(_n,Hr),e(gt,Dr),e(gt,Zn),e(Zn,Ir),e(gt,Wr),e(Pe,Br),w(qt,Pe,null),e(Pe,Ur),e(Pe,Jn),e(Jn,Vr),e(Pe,Rr),w(uo,Pe,null),f(o,Zs,m),f(o,_t,m),e(_t,zt),e(zt,es),w(go,es,null),e(_t,Kr),e(_t,ts),e(ts,Gr),f(o,Js,m),f(o,qe,m),w(_o,qe,null),e(qe,Yr),e(qe,os),e(os,Qr),e(qe,Zr),e(qe,To),e(To,Jr),e(To,Tn),e(Tn,ei),e(To,ti),e(qe,oi),e(qe,vo),e(vo,ni),e(vo,bo),e(bo,si),e(vo,ai),e(qe,ri),e(qe,je),w(wo,je,null),e(je,ii),e(je,Tt),e(Tt,li),e(Tt,vn),e(vn,di),e(Tt,ci),e(Tt,ns),e(ns,fi),e(Tt,hi),e(je,pi),w(Ct,je,null),e(je,mi),e(je,ss),e(ss,ui),e(je,gi),w(yo,je,null),f(o,ea,m),f(o,vt,m),e(vt,Pt),e(Pt,as),w(ko,as,null),e(vt,_i),e(vt,rs),e(rs,Ti),f(o,ta,m),f(o,se,m),w(Lo,se,null),e(se,vi),e(se,is),e(is,bi),e(se,wi),e(se,bn),e(bn,wn),e(wn,yi),e(bn,ki),e(se,Li),e(se,Ie),e(Ie,$i),e(Ie,ls),e(ls,xi),e(Ie,Xi),e(Ie,ds),e(ds,Mi),e(Ie,Ei),e(Ie,cs),e(cs,Fi),e(Ie,qi),e(Ie,fs),e(fs,zi),e(Ie,Ci),e(se,Pi),e(se,$o),e($o,ji),e($o,yn),e(yn,Oi),e($o,Si),e(se,Ni),e(se,xo),e(xo,Ai),e(xo,Xo),e(Xo,Hi),e(xo,Di),e(se,Ii),e(se,Y),w(Mo,Y,null),e(Y,Wi),e(Y,bt),e(bt,Bi),e(bt,kn),e(kn,Ui),e(bt,Vi),e(bt,hs),e(hs,Ri),e(bt,Ki),e(Y,Gi),w(jt,Y,null),e(Y,Yi),e(Y,ps),e(ps,Qi),e(Y,Zi),w(Eo,Y,null),e(Y,Ji),w(Fo,Y,null),e(Y,el),e(Y,ms),e(ms,tl),e(Y,ol),w(qo,Y,null),e(Y,nl),w(zo,Y,null),f(o,oa,m),f(o,wt,m),e(wt,Ot),e(Ot,us),w(Co,us,null),e(wt,sl),e(wt,gs),e(gs,al),f(o,na,m),f(o,me,m),w(Po,me,null),e(me,rl),e(me,_s),e(_s,il),e(me,ll),e(me,jo),e(jo,dl),e(jo,Ln),e(Ln,cl),e(jo,fl),e(me,hl),e(me,Oo),e(Oo,pl),e(Oo,So),e(So,ml),e(Oo,ul),e(me,gl),w(St,me,null),e(me,_l),e(me,Oe),w(No,Oe,null),e(Oe,Tl),e(Oe,yt),e(yt,vl),e(yt,$n),e($n,bl),e(yt,wl),e(yt,Ts),e(Ts,yl),e(yt,kl),e(Oe,Ll),w(Nt,Oe,null),e(Oe,$l),e(Oe,vs),e(vs,xl),e(Oe,Xl),w(Ao,Oe,null),f(o,sa,m),f(o,kt,m),e(kt,At),e(At,bs),w(Ho,bs,null),e(kt,Ml),e(kt,ws),e(ws,El),f(o,aa,m),f(o,ue,m),w(Do,ue,null),e(ue,Fl),e(ue,ys),e(ys,ql),e(ue,zl),e(ue,Io),e(Io,Cl),e(Io,xn),e(xn,Pl),e(Io,jl),e(ue,Ol),e(ue,Wo),e(Wo,Sl),e(Wo,Bo),e(Bo,Nl),e(Wo,Al),e(ue,Hl),w(Ht,ue,null),e(ue,Dl),e(ue,Se),w(Uo,Se,null),e(Se,Il),e(Se,Lt),e(Lt,Wl),e(Lt,Xn),e(Xn,Bl),e(Lt,Ul),e(Lt,ks),e(ks,Vl),e(Lt,Rl),e(Se,Kl),w(Dt,Se,null),e(Se,Gl),e(Se,Ls),e(Ls,Yl),e(Se,Ql),w(Vo,Se,null),f(o,ra,m),f(o,$t,m),e($t,It),e(It,$s),w(Ro,$s,null),e($t,Zl),e($t,xs),e(xs,Jl),f(o,ia,m),f(o,ee,m),w(Ko,ee,null),e(ee,ed),e(ee,Xs),e(Xs,td),e(ee,od),e(ee,Mn),e(Mn,En),e(En,nd),e(Mn,sd),e(ee,ad),e(ee,We),e(We,rd),e(We,Ms),e(Ms,id),e(We,ld),e(We,Es),e(Es,dd),e(We,cd),e(We,Fs),e(Fs,fd),e(We,hd),e(We,qs),e(qs,pd),e(We,md),e(ee,ud),e(ee,Go),e(Go,gd),e(Go,Fn),e(Fn,_d),e(Go,Td),e(ee,vd),e(ee,Yo),e(Yo,bd),e(Yo,Qo),e(Qo,wd),e(Yo,yd),e(ee,kd),w(Wt,ee,null),e(ee,Ld),e(ee,ke),w(Zo,ke,null),e(ke,$d),e(ke,xt),e(xt,xd),e(xt,qn),e(qn,Xd),e(xt,Md),e(xt,zs),e(zs,Ed),e(xt,Fd),e(ke,qd),w(Bt,ke,null),e(ke,zd),e(ke,Cs),e(Cs,Cd),e(ke,Pd),w(Jo,ke,null),e(ke,jd),w(en,ke,null),f(o,la,m),f(o,Xt,m),e(Xt,Ut),e(Ut,Ps),w(tn,Ps,null),e(Xt,Od),e(Xt,js),e(js,Sd),f(o,da,m),f(o,on,m),w(nn,on,null),f(o,ca,m),f(o,sn,m),w(an,sn,null),fa=!0},p(o,[m]){const rn={};m&2&&(rn.$$scope={dirty:m,ctx:o}),pe.$set(rn);const Os={};m&2&&(Os.$$scope={dirty:m,ctx:o}),qt.$set(Os);const Ss={};m&2&&(Ss.$$scope={dirty:m,ctx:o}),Ct.$set(Ss);const Ns={};m&2&&(Ns.$$scope={dirty:m,ctx:o}),jt.$set(Ns);const ln={};m&2&&(ln.$$scope={dirty:m,ctx:o}),St.$set(ln);const As={};m&2&&(As.$$scope={dirty:m,ctx:o}),Nt.$set(As);const Hs={};m&2&&(Hs.$$scope={dirty:m,ctx:o}),Ht.$set(Hs);const Ds={};m&2&&(Ds.$$scope={dirty:m,ctx:o}),Dt.$set(Ds);const dn={};m&2&&(dn.$$scope={dirty:m,ctx:o}),Wt.$set(dn);const Is={};m&2&&(Is.$$scope={dirty:m,ctx:o}),Bt.$set(Is)},i(o){fa||(y(_.$$.fragment,o),y(K.$$.fragment,o),y(pe.$$.fragment,o),y(we.$$.fragment,o),y(Kt.$$.fragment,o),y(Yt.$$.fragment,o),y(Qt.$$.fragment,o),y(Zt.$$.fragment,o),y(oo.$$.fragment,o),y(no.$$.fragment,o),y(so.$$.fragment,o),y(ao.$$.fragment,o),y(ro.$$.fragment,o),y(io.$$.fragment,o),y(lo.$$.fragment,o),y(co.$$.fragment,o),y(mo.$$.fragment,o),y(qt.$$.fragment,o),y(uo.$$.fragment,o),y(go.$$.fragment,o),y(_o.$$.fragment,o),y(wo.$$.fragment,o),y(Ct.$$.fragment,o),y(yo.$$.fragment,o),y(ko.$$.fragment,o),y(Lo.$$.fragment,o),y(Mo.$$.fragment,o),y(jt.$$.fragment,o),y(Eo.$$.fragment,o),y(Fo.$$.fragment,o),y(qo.$$.fragment,o),y(zo.$$.fragment,o),y(Co.$$.fragment,o),y(Po.$$.fragment,o),y(St.$$.fragment,o),y(No.$$.fragment,o),y(Nt.$$.fragment,o),y(Ao.$$.fragment,o),y(Ho.$$.fragment,o),y(Do.$$.fragment,o),y(Ht.$$.fragment,o),y(Uo.$$.fragment,o),y(Dt.$$.fragment,o),y(Vo.$$.fragment,o),y(Ro.$$.fragment,o),y(Ko.$$.fragment,o),y(Wt.$$.fragment,o),y(Zo.$$.fragment,o),y(Bt.$$.fragment,o),y(Jo.$$.fragment,o),y(en.$$.fragment,o),y(tn.$$.fragment,o),y(nn.$$.fragment,o),y(an.$$.fragment,o),fa=!0)},o(o){k(_.$$.fragment,o),k(K.$$.fragment,o),k(pe.$$.fragment,o),k(we.$$.fragment,o),k(Kt.$$.fragment,o),k(Yt.$$.fragment,o),k(Qt.$$.fragment,o),k(Zt.$$.fragment,o),k(oo.$$.fragment,o),k(no.$$.fragment,o),k(so.$$.fragment,o),k(ao.$$.fragment,o),k(ro.$$.fragment,o),k(io.$$.fragment,o),k(lo.$$.fragment,o),k(co.$$.fragment,o),k(mo.$$.fragment,o),k(qt.$$.fragment,o),k(uo.$$.fragment,o),k(go.$$.fragment,o),k(_o.$$.fragment,o),k(wo.$$.fragment,o),k(Ct.$$.fragment,o),k(yo.$$.fragment,o),k(ko.$$.fragment,o),k(Lo.$$.fragment,o),k(Mo.$$.fragment,o),k(jt.$$.fragment,o),k(Eo.$$.fragment,o),k(Fo.$$.fragment,o),k(qo.$$.fragment,o),k(zo.$$.fragment,o),k(Co.$$.fragment,o),k(Po.$$.fragment,o),k(St.$$.fragment,o),k(No.$$.fragment,o),k(Nt.$$.fragment,o),k(Ao.$$.fragment,o),k(Ho.$$.fragment,o),k(Do.$$.fragment,o),k(Ht.$$.fragment,o),k(Uo.$$.fragment,o),k(Dt.$$.fragment,o),k(Vo.$$.fragment,o),k(Ro.$$.fragment,o),k(Ko.$$.fragment,o),k(Wt.$$.fragment,o),k(Zo.$$.fragment,o),k(Bt.$$.fragment,o),k(Jo.$$.fragment,o),k(en.$$.fragment,o),k(tn.$$.fragment,o),k(nn.$$.fragment,o),k(an.$$.fragment,o),fa=!1},d(o){t(p),o&&t(M),o&&t(u),L(_),o&&t(W),o&&t(x),L(K),o&&t(ge),o&&t(U),o&&t(z),o&&t(ie),o&&t(_e),o&&t(le),o&&t(Te),o&&t(q),o&&t(G),o&&t(oe),o&&t(ve),o&&t(j),o&&t(Ae),L(pe,o),o&&t(He),o&&t(P),L(we),o&&t(ye),o&&t(D),L(Kt),L(Yt),o&&t(Ws),o&&t(dt),L(Qt),o&&t(Bs),o&&t(De),L(Zt),L(oo),o&&t(Us),o&&t(ct),L(no),o&&t(Vs),o&&t(ft),L(so),o&&t(Rs),o&&t(ht),L(ao),o&&t(Ks),o&&t(pt),L(ro),o&&t(Gs),o&&t(mt),L(io),o&&t(Ys),o&&t(ut),L(lo),o&&t(Qs),o&&t(Fe),L(co),L(mo),L(qt),L(uo),o&&t(Zs),o&&t(_t),L(go),o&&t(Js),o&&t(qe),L(_o),L(wo),L(Ct),L(yo),o&&t(ea),o&&t(vt),L(ko),o&&t(ta),o&&t(se),L(Lo),L(Mo),L(jt),L(Eo),L(Fo),L(qo),L(zo),o&&t(oa),o&&t(wt),L(Co),o&&t(na),o&&t(me),L(Po),L(St),L(No),L(Nt),L(Ao),o&&t(sa),o&&t(kt),L(Ho),o&&t(aa),o&&t(ue),L(Do),L(Ht),L(Uo),L(Dt),L(Vo),o&&t(ra),o&&t($t),L(Ro),o&&t(ia),o&&t(ee),L(Ko),L(Wt),L(Zo),L(Bt),L(Jo),L(en),o&&t(la),o&&t(Xt),L(tn),o&&t(da),o&&t(on),L(nn),o&&t(ca),o&&t(sn),L(an)}}}const Gf={local:"transformer-xl",sections:[{local:"overview",title:"Overview"},{local:"transformers.TransfoXLConfig",title:"TransfoXLConfig"},{local:"transformers.TransfoXLTokenizer",title:"TransfoXLTokenizer"},{local:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput",title:"TransfoXL specific outputs"},{local:"transformers.TransfoXLModel",title:"TransfoXLModel"},{local:"transformers.TransfoXLLMHeadModel",title:"TransfoXLLMHeadModel"},{local:"transformers.TransfoXLForSequenceClassification",title:"TransfoXLForSequenceClassification"},{local:"transformers.TFTransfoXLModel",title:"TFTransfoXLModel"},{local:"transformers.TFTransfoXLLMHeadModel",title:"TFTransfoXLLMHeadModel"},{local:"transformers.TFTransfoXLForSequenceClassification",title:"TFTransfoXLForSequenceClassification"},{local:"transformers.AdaptiveEmbedding",title:"Internal Layers"}],title:"Transformer XL"};function Yf(R){return Sf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class oh extends Cf{constructor(p){super();Pf(this,p,Yf,Kf,jf,{})}}export{oh as default,Gf as metadata};
