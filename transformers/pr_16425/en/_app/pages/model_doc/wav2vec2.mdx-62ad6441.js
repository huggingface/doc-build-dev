...
above for more information.`),this.h()},l(D){p=s(D,"P",{});var q=n(p);W=i(q,"This class method is simply calling "),f=s(q,"A",{href:!0});var F=n(f);T=i(F,"save_pretrained()"),F.forEach(t),x=i(q,` and
`),k=s(q,"CODE",{});var A=n(k);y=i(A,"save_pretrained"),A.forEach(t),j=i(q,`. Please refer to the docstrings of the methods
above for more information.`),q.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/pr_16425/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(D,q){h(D,p,q),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j)},d(D){D&&t(p)}}}function TT(E){let p,W,f,T,x,k,y,j,D,q,F,A,O,X;return{c(){p=a("p"),W=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
`),f=a("a"),T=r("from_pretrained()"),x=r(`, Wav2Vec2CTCTokenizer\u2019s
`),k=a("code"),y=r("from_pretrained"),j=r(`, and
`),D=a("code"),q=r("pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),F=r("."),A=l(),O=a("p"),X=r("Please refer to the docstrings of the methods above for more information."),this.h()},l(S){p=s(S,"P",{});var C=n(p);W=i(C,`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
`),D=s(C,"CODE",{});var B=n(D);q=i(B,"pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),B.forEach(t),F=i(C,"."),C.forEach(t),A=c(S),O=s(S,"P",{});var H=n(O);X=i(H,"Please refer to the docstrings of the methods above for more information."),H.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/pr_16425/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(S,C){h(S,p,C),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j),e(p,D),e(D,q),e(p,F),h(S,A,C),h(S,O,C),e(O,X)},d(S){S&&t(p),S&&t(A),S&&t(O)}}}function xT(E){let p,W;return{c(){p=a("p"),W=r("This function makes use of Python\u2019s multiprocessing.")},l(f){p=s(f,"P",{});var T=n(p);W=i(T,"This function makes use of Python\u2019s multiprocessing."),T.forEach(t)},m(f,T){h(f,p,T),e(p,W)},d(f){f&&t(p)}}}function WT(E){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function PT(E){let p,W,f,T,x,k,y,j,D,q,F,A,O,X,S,C,Ve,ge,B,H,_e,Ge,M,I,Fe,ve,Ye,Ee,oe,ct,et,L,dt,de,pe,Je,we,pt,be,ae,Pe,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),D=r("having all inputs as a list, tuple or dict in the first positional arguments."),q=l(),F=a("p"),A=r("This second option is useful when using "),O=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
...
first positional argument :`),Ge=l(),M=a("ul"),I=a("li"),Fe=r("a single Tensor with "),ve=a("code"),Ye=r("input_values"),Ee=r(" only and nothing else: "),oe=a("code"),ct=r("model(inputs_ids)"),et=l(),L=a("li"),dt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ye=s(xe,"CODE",{});var Ht=n(ye);mt=i(Ht,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ht.forEach(t),xe.forEach(t),G.forEach(t)},m($,P){h($,p,P),e(p,W),h($,f,P),h($,T,P),e(T,x),e(x,k),e(T,y),e(T,j),e(j,D),h($,q,P),h($,F,P),e(F,A),e(F,O),e(O,X),e(F,S),e(F,C),e(C,Ve),e(F,ge),h($,B,P),h($,H,P),e(H,_e),h($,Ge,P),h($,M,P),e(M,I),e(I,Fe),e(I,ve),e(ve,Ye),e(I,Ee),e(I,oe),e(oe,ct),e(M,et),e(M,L),e(L,dt),e(L,de),e(de,pe),e(L,Je),e(L,we),e(we,pt),e(M,be),e(M,ae),e(ae,Pe),e(ae,ye),e(ye,mt)},d($){$&&t(p),$&&t(f),$&&t(T),$&&t(q),$&&t(F),$&&t(B),$&&t(H),$&&t(Ge),$&&t(M)}}}function CT(E){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function qT(E){let p,W,f,T,x,k,y,j,D,q,F,A,O,X,S,C,Ve,ge,B,H,_e,Ge,M,I,Fe,ve,Ye,Ee,oe,ct,et,L,dt,de,pe,Je,we,pt,be,ae,Pe,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),D=r("having all inputs as a list, tuple or dict in the first positional arguments."),q=l(),F=a("p"),A=r("This second option is useful when using "),O=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),Ve=r("model(inputs)"),ge=r("."),B=l(),H=a("p"),_e=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ge=l(),M=a("ul"),I=a("li"),Fe=r("a single Tensor with "),ve=a("code"),Ye=r("input_values"),Ee=r(" only and nothing else: "),oe=a("code"),ct=r("model(inputs_ids)"),et=l(),L=a("li"),dt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=a("code"),pe=r("model([input_values, attention_mask])"),Je=r(" or "),we=a("code"),pt=r("model([input_values, attention_mask, token_type_ids])"),be=l(),ae=a("li"),Pe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),mt=r('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l($){p=s($,"P",{});var P=n(p);W=i(P,"TF 2.0 models accepts two formats as inputs:"),P.forEach(t),f=c($),T=s($,"UL",{});var Ze=n(T);x=s(Ze,"LI",{});var Ke=n(x);k=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),y=c(Ze),j=s(Ze,"LI",{});var Bt=n(j);D=i(Bt,"having all inputs as a list, tuple or dict in the first positional arguments."),Bt.forEach(t),Ze.forEach(t),q=c($),F=s($,"P",{});var se=n(F);A=i(se,"This second option is useful when using "),O=s(se,"CODE",{});var xt=n(O);X=i(xt,"tf.keras.Model.fit"),xt.forEach(t),S=i(se,` method which currently requires having all the
...
[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>]`}}),un=new ee({}),gn=new V({props:{name:"class transformers.Wav2Vec2ForXVector",anchor:"transformers.Wav2Vec2ForXVector",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2065",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": FloatTensor"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2127",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16425/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[PT]},$$scope:{ctx:E}}}),On=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
`}}),da=new fe({props:{$$slots:{default:[CT]},$$scope:{ctx:E}}}),Ln=new ue({props:{code:`from transformers import Wav2Vec2Processor, TFWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[qT]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># show that cosine similarity is much higher than random</span>
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> np.asarray(cosine_sim)[mask_time_indices].mean() &gt; <span class="hljs-number">0.5</span>`}}),{c(){p=a("meta"),W=l(),f=a("h1"),T=a("a"),x=a("span"),u(k.$$.fragment),y=l(),j=a("span"),D=r("Wav2Vec2"),q=l(),F=a("h2"),A=a("a"),O=a("span"),u(X.$$.fragment),S=l(),C=a("span"),Ve=r("Overview"),ge=l(),B=a("p"),H=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Ge=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),M=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=l(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),Ye=l(),Ee=a("p"),oe=a("em"),ct=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
library implements for all its model (such as downloading or saving etc.).`),zu=l(),As=a("p"),Au=r("This model is a PyTorch "),Os=a("a"),Ou=r("torch.nn.Module"),Lu=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Du=l(),ze=a("div"),u(Ls.$$.fragment),Su=l(),ao=a("p"),Nu=r("The "),ri=a("a"),Iu=r("Wav2Vec2Model"),Bu=r(" forward method, overrides the "),Cl=a("code"),Uu=r("__call__"),Hu=r(" special method."),Ru=l(),u(Ko.$$.fragment),Xu=l(),ql=a("p"),Gu=r("Example:"),Ju=l(),u(Ds.$$.fragment),bd=l(),so=a("h2"),Qo=a("a"),Ml=a("span"),u(Ss.$$.fragment),Zu=l(),zl=a("span"),Ku=r("Wav2Vec2ForCTC"),yd=l(),$e=a("div"),u(Ns.$$.fragment),Qu=l(),no=a("p"),Yu=r("Wav2Vec2 Model with a "),Al=a("code"),eg=r("language modeling"),tg=r(` head on top for Connectionist Temporal Classification (CTC).
...
behavior.`),O2=l(),u(ca.$$.fragment),L2=l(),De=a("div"),u(On.$$.fragment),D2=l(),vo=a("p"),S2=r("The "),vi=a("a"),N2=r("TFWav2Vec2Model"),I2=r(" forward method, overrides the "),lc=a("code"),B2=r("__call__"),U2=r(" special method."),H2=l(),u(da.$$.fragment),R2=l(),cc=a("p"),X2=r("Example:"),G2=l(),u(Ln.$$.fragment),Cd=l(),wo=a("h2"),pa=a("a"),dc=a("span"),u(Dn.$$.fragment),J2=l(),pc=a("span"),Z2=r("TFWav2Vec2ForCTC"),qd=l(),ce=a("div"),u(Sn.$$.fragment),K2=l(),Nn=a("p"),Q2=r("TFWav2Vec2 Model with a "),mc=a("code"),Y2=r("language modeling"),ev=r(" head on top for Connectionist Temporal Classification (CTC)."),tv=l(),In=a("p"),ov=r("This model inherits from "),wi=a("a"),av=r("TFPreTrainedModel"),sv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation from `),Ar=s($i,"A",{href:!0});var zb=n(Ar);_m=i(zb,"PretrainedConfig"),zb.forEach(t),vm=i($i," for more information."),$i.forEach(t),wm=c(Ft),Xi=s(Ft,"P",{});var Ab=n(Xi);bm=i(Ab,"Example:"),Ab.forEach(t),ym=c(Ft),g(Ea.$$.fragment,Ft),Ft.forEach(t),sd=c(o),Gt=s(o,"H2",{class:!0});var Ud=n(Gt);Fo=s(Ud,"A",{id:!0,class:!0,href:!0});var Ob=n(Fo);Gi=s(Ob,"SPAN",{});var Lb=n(Gi);g(Pa.$$.fragment,Lb),Lb.forEach(t),Ob.forEach(t),km=c(Ud),Ji=s(Ud,"SPAN",{});var Db=n(Ji);Tm=i(Db,"Wav2Vec2CTCTokenizer"),Db.forEach(t),Ud.forEach(t),nd=c(o),Z=s(o,"DIV",{class:!0});var Ue=n(Z);g(Ca.$$.fragment,Ue),xm=c(Ue),Zi=s(Ue,"P",{});var Sb=n(Zi);Wm=i(Sb,"Constructs a Wav2Vec2CTC tokenizer."),Sb.forEach(t),$m=c(Ue),qa=s(Ue,"P",{});var Hd=n(qa);jm=i(Hd,"This tokenizer inherits from "),Or=s(Hd,"A",{href:!0});var Nb=n(Or);Vm=i(Nb,"PreTrainedTokenizer"),Nb.forEach(t),Fm=i(Hd,` which contains some of the main methods. Users should refer to
...
library implements for all its model (such as downloading or saving etc.).`),Wp.forEach(t),zu=c(Pt),As=s(Pt,"P",{});var $p=n(As);Au=i($p,"This model is a PyTorch "),Os=s($p,"A",{href:!0,rel:!0});var Ky=n(Os);Ou=i(Ky,"torch.nn.Module"),Ky.forEach(t),Lu=i($p,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Du=c(Pt),ze=s(Pt,"DIV",{class:!0});var Ct=n(ze);g(Ls.$$.fragment,Ct),Su=c(Ct),ao=s(Ct,"P",{});var Ci=n(ao);Nu=i(Ci,"The "),ri=s(Ci,"A",{href:!0});var Qy=n(ri);Iu=i(Qy,"Wav2Vec2Model"),Qy.forEach(t),Bu=i(Ci," forward method, overrides the "),Cl=s(Ci,"CODE",{});var Yy=n(Cl);Uu=i(Yy,"__call__"),Yy.forEach(t),Hu=i(Ci," special method."),Ci.forEach(t),Ru=c(Ct),g(Ko.$$.fragment,Ct),Xu=c(Ct),ql=s(Ct,"P",{});var e1=n(ql);Gu=i(e1,"Example:"),e1.forEach(t),Ju=c(Ct),g(Ds.$$.fragment,Ct),Ct.forEach(t),Pt.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var t1=n(Qo);Ml=s(t1,"SPAN",{});var o1=n(Ml);g(Ss.$$.fragment,o1),o1.forEach(t),t1.forEach(t),Zu=c(jp),zl=s(jp,"SPAN",{});var a1=n(zl);Ku=i(a1,"Wav2Vec2ForCTC"),a1.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var qt=n($e);g(Ns.$$.fragment,qt),Qu=c(qt),no=s(qt,"P",{});var qi=n(no);Yu=i(qi,"Wav2Vec2 Model with a "),Al=s(qi,"CODE",{});var s1=n(Al);eg=i(s1,"language modeling"),s1.forEach(t),tg=i(qi,` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),mg=c(qt),me=s(qt,"DIV",{class:!0});var ot=n(me);g(Rs.$$.fragment,ot),hg=c(ot),ro=s(ot,"P",{});var Mi=n(ro);fg=i(Mi,"The "),li=s(Mi,"A",{href:!0});var l1=n(li);ug=i(l1,"Wav2Vec2ForCTC"),l1.forEach(t),gg=i(Mi," forward method, overrides the "),Ol=s(Mi,"CODE",{});var c1=n(Ol);_g=i(c1,"__call__"),c1.forEach(t),vg=i(Mi," special method."),Mi.forEach(t),wg=c(ot),g(Yo.$$.fragment,ot),bg=c(ot),Ll=s(ot,"P",{});var d1=n(Ll);yg=i(d1,"Example:"),d1.forEach(t),kg=c(ot),g(Xs.$$.fragment,ot),Tg=c(ot),g(Gs.$$.fragment,ot),ot.forEach(t),qt.forEach(t),kd=c(o),io=s(o,"H2",{class:!0});var Ep=n(io);ea=s(Ep,"A",{id:!0,class:!0,href:!0});var p1=n(ea);Dl=s(p1,"SPAN",{});var m1=n(Dl);g(Js.$$.fragment,m1),m1.forEach(t),p1.forEach(t),xg=c(Ep),Sl=s(Ep,"SPAN",{});var h1=n(Sl);Wg=i(h1,"Wav2Vec2ForSequenceClassification"),h1.forEach(t),Ep.forEach(t),Td=c(o),ne=s(o,"DIV",{class:!0});var at=n(ne);g(Zs.$$.fragment,at),$g=c(at),Nl=s(at,"P",{});var f1=n(Nl);jg=i(f1,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
library implements for all its model (such as downloading or saving etc.).`),Cp.forEach(t),Ag=c(at),en=s(at,"P",{});var qp=n(en);Og=i(qp,"This model is a PyTorch "),tn=s(qp,"A",{href:!0,rel:!0});var _1=n(tn);Lg=i(_1,"torch.nn.Module"),_1.forEach(t),Dg=i(qp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Op.forEach(t),f_=c(nt),Ae=s(nt,"DIV",{class:!0});var Mt=n(Ae);g(hn.$$.fragment,Mt),u_=c(Mt),po=s(Mt,"P",{});var Ai=n(po);g_=i(Ai,"The "),mi=s(Ai,"A",{href:!0});var V1=n(mi);__=i(V1,"Wav2Vec2ForAudioFrameClassification"),V1.forEach(t),v_=i(Ai," forward method, overrides the "),Xl=s(Ai,"CODE",{});var F1=n(Xl);w_=i(F1,"__call__"),F1.forEach(t),b_=i(Ai," special method."),Ai.forEach(t),y_=c(Mt),g(aa.$$.fragment,Mt),k_=c(Mt),Gl=s(Mt,"P",{});var E1=n(Gl);T_=i(E1,"Example:"),E1.forEach(t),x_=c(Mt),g(fn.$$.fragment,Mt),Mt.forEach(t),nt.forEach(t),$d=c(o),mo=s(o,"H2",{class:!0});var Lp=n(mo);sa=s(Lp,"A",{id:!0,class:!0,href:!0});var P1=n(sa);Jl=s(P1,"SPAN",{});var C1=n(Jl);g(un.$$.fragment,C1),C1.forEach(t),P1.forEach(t),W_=c(Lp),Zl=s(Lp,"SPAN",{});var q1=n(Zl);$_=i(q1,"Wav2Vec2ForXVector"),q1.forEach(t),Lp.forEach(t),jd=c(o),ie=s(o,"DIV",{class:!0});var rt=n(ie);g(gn.$$.fragment,rt),j_=c(rt),Kl=s(rt,"P",{});var M1=n(Kl);V_=i(M1,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),M1.forEach(t),F_=c(rt),_n=s(rt,"P",{});var Dp=n(_n);E_=i(Dp,"Wav2Vec2 was proposed in "),vn=s(Dp,"A",{href:!0,rel:!0});var z1=n(vn);P_=i(z1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),z1.forEach(t),C_=i(Dp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Dp.forEach(t),q_=c(rt),wn=s(rt,"P",{});var Sp=n(wn);M_=i(Sp,"This model inherits from "),hi=s(Sp,"A",{href:!0});var A1=n(hi);z_=i(A1,"PreTrainedModel"),A1.forEach(t),A_=i(Sp,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),N_=c(rt),Oe=s(rt,"DIV",{class:!0});var zt=n(Oe);g(kn.$$.fragment,zt),I_=c(zt),ho=s(zt,"P",{});var Oi=n(ho);B_=i(Oi,"The "),fi=s(Oi,"A",{href:!0});var L1=n(fi);U_=i(L1,"Wav2Vec2ForXVector"),L1.forEach(t),H_=i(Oi," forward method, overrides the "),Ql=s(Oi,"CODE",{});var D1=n(Ql);R_=i(D1,"__call__"),D1.forEach(t),X_=i(Oi," special method."),Oi.forEach(t),G_=c(zt),g(na.$$.fragment,zt),J_=c(zt),Yl=s(zt,"P",{});var S1=n(Yl);Z_=i(S1,"Example:"),S1.forEach(t),K_=c(zt),g(Tn.$$.fragment,zt),zt.forEach(t),rt.forEach(t),Vd=c(o),fo=s(o,"H2",{class:!0});var Ip=n(fo);ra=s(Ip,"A",{id:!0,class:!0,href:!0});var N1=n(ra);ec=s(N1,"SPAN",{});var I1=n(ec);g(xn.$$.fragment,I1),I1.forEach(t),N1.forEach(t),Q_=c(Ip),tc=s(Ip,"SPAN",{});var B1=n(tc);Y_=i(B1,"Wav2Vec2ForPreTraining"),B1.forEach(t),Ip.forEach(t),Fd=c(o),je=s(o,"DIV",{class:!0});var At=n(je);g(Wn.$$.fragment,At),e2=c(At),uo=s(At,"P",{});var Li=n(uo);t2=i(Li,"Wav2Vec2 Model with a quantizer and "),oc=s(Li,"CODE",{});var U1=n(oc);o2=i(U1,"VQ"),U1.forEach(t),a2=i(Li,` head on top.
