import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as ma,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as y,v as fa}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,m,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),j=n(`
...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),j=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,m),e(m,B),e(u,j)},d(T){T&&o(u)}}}function ba(He){let u,D,m,B,j,T,w,S,Do,Kt,R,Y,kt,ie,So,yt,Mo,Qt,M,Ao,Ve,Oo,Fo,de,Lo,No,Xt,Je,Io,Yt,Ke,Tt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,O,an,ue,dn,ln,me,cn,hn,io,W,ee,Bt,fe,pn,zt,un,lo,$,ge,mn,_e,fn,$t,gn,_n,bn,U,vn,rt,kn,yn,st,Tn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,x,ke,qn,ye,Pn,Te,Cn,jn,xn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,Ct,Be,On,jt,Fn,uo,f,ze,Ln,xt,Nn,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,Ce,Yn,Zn,er,J,tr,lt,or,nr,je,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,mr,fr,Ot,gr,_r,Ft,br,vr,kr,q,xe,yr,K,Tr,ct,wr,Er,Lt,Br,zr,$r,ne,Gr,Nt,qr,Pr,De,mo,Q,re,It,Se,Cr,Rt,jr,fo,G,Me,xr,Ae,Dr,Wt,Sr,Mr,Ar,Oe,Or,ht,Fr,Lr,Nr,Fe,Ir,Le,Rr,Wr,Ur,P,Ne,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return T=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ne=new Ue({props:{name:"forward",anchor:"transformers.BertGenerationDecoder.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/bert_generation/modeling_bert_generation.py#L469",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),Ct=s("span"),g(Be.$$.fragment),On=l(),jt=s("span"),Fn=n("BertGenerationEncoder"),uo=l(),f=s("div"),g(ze.$$.fragment),Ln=l(),xt=s("p"),Nn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
`),At=s("code"),mr=n("add_cross_attention"),fr=n(" set to "),Ot=s("code"),gr=n("True"),_r=n("; an "),Ft=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(xe.$$.fragment),yr=l(),K=s("p"),Tr=n("The "),ct=s("a"),wr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Lt=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),Nt=s("p"),qr=n("Example:"),Pr=l(),g(De.$$.fragment),mo=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),Cr=l(),Rt=s("span"),jr=n("BertGenerationDecoder"),fo=l(),G=s("div"),g(Me.$$.fragment),xr=l(),Ae=s("p"),Dr=n("BertGeneration Model with a "),Wt=s("code"),Sr=n("language modeling"),Mr=n(" head on top for CLM fine-tuning."),Ar=l(),Oe=s("p"),Or=n("This model inherits from "),ht=s("a"),Fr=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
