...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){m=n("meta"),T=d(),h=n("h1"),S=n("a"),W=n("span"),_(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Ot=d(),I=n("h2"),Z=n("a"),ut=n("span"),_(ce.$$.fragment),bo=d(),gt=n("span"),wo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs
