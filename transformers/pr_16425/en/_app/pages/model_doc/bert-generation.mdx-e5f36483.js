import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as fa,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T,v as ma}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,f,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var S=i(f);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(y,w){p(y,u,w),e(u,D),e(u,f),e(f,B),e(u,x)},d(y){y&&o(u)}}}function _a(He){let u,D,f,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var S=i(f);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(y,w){p(y,u,w),e(u,D),e(u,f),e(f,B),e(u,x)},d(y){y&&o(u)}}}function ba(He){let u,D,f,B,x,y,w,S,Do,Kt,R,Y,kt,ie,So,Tt,Mo,Qt,M,Ao,Ve,No,Lo,de,Fo,Oo,Xt,Je,Io,Yt,Ke,yt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,N,an,ue,dn,ln,fe,cn,hn,io,W,ee,Bt,me,pn,zt,un,lo,$,ge,fn,_e,mn,$t,gn,_n,bn,U,vn,rt,kn,Tn,st,yn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,C,ke,qn,Te,Pn,ye,jn,xn,Cn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,jt,Be,Nn,xt,Ln,uo,m,ze,Fn,Ct,On,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,je,Yn,Zn,er,J,tr,lt,or,nr,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,fr,mr,Nt,gr,_r,Lt,br,vr,kr,q,Ce,Tr,K,yr,ct,wr,Er,Ft,Br,zr,$r,ne,Gr,Ot,qr,Pr,De,fo,Q,re,It,Se,jr,Rt,xr,mo,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Lr,Fr,Or,Le,Ir,Fe,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return y=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),D=l(),f=s("h1"),B=s("a"),x=s("span"),g(y.$$.fragment),w=l(),S=s("span"),Do=n("BertGeneration"),Kt=l(),R=s("h2"),Y=s("a"),kt=s("span"),g(ie.$$.fragment),So=l(),Tt=s("span"),Mo=n("Overview"),Qt=l(),M=s("p"),Ao=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
documentation from `),st=s("a"),yn=n("PretrainedConfig"),wn=n(" for more information."),En=l(),Gt=s("p"),Bn=n("Examples:"),zn=l(),g(be.$$.fragment),co=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ve.$$.fragment),$n=l(),Pt=s("span"),Gn=n("BertGenerationTokenizer"),ho=l(),C=s("div"),g(ke.$$.fragment),qn=l(),Te=s("p"),Pn=n("Construct a BertGeneration tokenizer. Based on "),ye=s("a"),jn=n("SentencePiece"),xn=n("."),Cn=l(),we=s("p"),Dn=n("This tokenizer inherits from "),at=s("a"),Sn=n("PreTrainedTokenizer"),Mn=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),jt=s("span"),g(Be.$$.fragment),Nn=l(),xt=s("span"),Ln=n("BertGenerationEncoder"),uo=l(),m=s("div"),g(ze.$$.fragment),Fn=l(),Ct=s("p"),On=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
`),At=s("code"),fr=n("add_cross_attention"),mr=n(" set to "),Nt=s("code"),gr=n("True"),_r=n("; an "),Lt=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),yr=n("The "),ct=s("a"),wr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Ft=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),Ot=s("p"),qr=n("Example:"),Pr=l(),g(De.$$.fragment),fo=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=n("BertGenerationDecoder"),mo=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=n("BertGeneration Model with a "),Wt=s("code"),Sr=n("language modeling"),Mr=n(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Nr=n("This model inherits from "),ht=s("a"),Lr=n("PreTrainedModel"),Fr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Le=s("p"),Ir=n("This model is also a PyTorch "),Fe=s("a"),Rr=n("torch.nn.Module"),Wr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),P=s("div"),g(Oe.$$.fragment),Hr=l(),X=s("p"),Vr=n("The "),pt=s("a"),Jr=n("BertGenerationDecoder"),Kr=n(" forward method, overrides the "),Ut=s("code"),Qr=n("__call__"),Xr=n(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=n("Example:"),ts=l(),g(Ie.$$.fragment),this.h()},l(t){const h=fa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),D=c(t),f=a(t,"H1",{class:!0});var Re=i(f);B=a(Re,"A",{id:!0,class:!0,href:!0});var Vt=i(B);x=a(Vt,"SPAN",{});var os=i(x);_(y.$$.fragment,os),os.forEach(o),Vt.forEach(o),w=c(Re),S=a(Re,"SPAN",{});var ns=i(S);Do=r(ns,"BertGeneration"),ns.forEach(o),Re.forEach(o),Kt=c(t),R=a(t,"H2",{class:!0});var _o=i(R);Y=a(_o,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(ie.$$.fragment,ss),ss.forEach(o),rs.forEach(o),So=c(_o),Tt=a(_o,"SPAN",{});var as=i(Tt);Mo=r(as,"Overview"),as.forEach(o),_o.forEach(o),Qt=c(t),M=a(t,"P",{});var ut=i(M);Ao=r(ut,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ve=a(ut,"A",{href:!0});var is=i(Ve);No=r(is,"EncoderDecoderModel"),is.forEach(o),Lo=r(ut," as proposed in "),de=a(ut,"A",{href:!0,rel:!0});var ds=i(de);Fo=r(ds,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
combination with `),wt=a(We,"CODE",{});var ks=i(wt);on=r(ks,"EncoderDecoder"),ks.forEach(o),nn=r(We,"."),We.forEach(o),rn=c(ko),Et=a(ko,"LI",{});var Ts=i(Et);sn=r(Ts,`For summarization, sentence splitting, sentence fusion and translation, no special tokens are required for the input.
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(o),ko.forEach(o),ao=c(t),N=a(t,"P",{});var ft=i(N);an=r(ft,"This model was contributed by "),ue=a(ft,"A",{href:!0,rel:!0});var ys=i(ue);dn=r(ys,"patrickvonplaten"),ys.forEach(o),ln=r(ft,`. The original code can be
found `),fe=a(ft,"A",{href:!0,rel:!0});var ws=i(fe);cn=r(ws,"here"),ws.forEach(o),hn=r(ft,"."),ft.forEach(o),io=c(t),W=a(t,"H2",{class:!0});var To=i(W);ee=a(To,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(me.$$.fragment,Bs),Bs.forEach(o),Es.forEach(o),pn=c(To),zt=a(To,"SPAN",{});var zs=i(zt);un=r(zs,"BertGenerationConfig"),zs.forEach(o),To.forEach(o),lo=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(ge.$$.fragment,L),fn=c(L),_e=a(L,"P",{});var yo=i(_e);mn=r(yo,"This is the configuration class to store the configuration of a "),$t=a(yo,"CODE",{});var $s=i($t);gn=r($s,"BertGenerationPreTrainedModel"),$s.forEach(o),_n=r(yo,` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),yo.forEach(o),bn=c(L),U=a(L,"P",{});var mt=i(U);vn=r(mt,"Configuration objects inherit from "),rt=a(mt,"A",{href:!0});var Gs=i(rt);kn=r(Gs,"PretrainedConfig"),Gs.forEach(o),Tn=r(mt,` and can be used to control the model outputs. Read the
documentation from `),st=a(mt,"A",{href:!0});var qs=i(st);yn=r(qs,"PretrainedConfig"),qs.forEach(o),wn=r(mt," for more information."),mt.forEach(o),En=c(L),Gt=a(L,"P",{});var Ps=i(Gt);Bn=r(Ps,"Examples:"),Ps.forEach(o),zn=c(L),_(be.$$.fragment,L),L.forEach(o),co=c(t),H=a(t,"H2",{class:!0});var wo=i(H);te=a(wo,"A",{id:!0,class:!0,href:!0});var js=i(te);qt=a(js,"SPAN",{});var xs=i(qt);_(ve.$$.fragment,xs),xs.forEach(o),js.forEach(o),$n=c(wo),Pt=a(wo,"SPAN",{});var Cs=i(Pt);Gn=r(Cs,"BertGenerationTokenizer"),Cs.forEach(o),wo.forEach(o),ho=c(t),C=a(t,"DIV",{class:!0});var ae=i(C);_(ke.$$.fragment,ae),qn=c(ae),Te=a(ae,"P",{});var Eo=i(Te);Pn=r(Eo,"Construct a BertGeneration tokenizer. Based on "),ye=a(Eo,"A",{href:!0,rel:!0});var Ds=i(ye);jn=r(Ds,"SentencePiece"),Ds.forEach(o),xn=r(Eo,"."),Eo.forEach(o),Cn=c(ae),we=a(ae,"P",{});var Bo=i(we);Dn=r(Bo,"This tokenizer inherits from "),at=a(Bo,"A",{href:!0});var Ss=i(at);Sn=r(Ss,"PreTrainedTokenizer"),Ss.forEach(o),Mn=r(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),An=c(ae),it=a(ae,"DIV",{class:!0});var Ms=i(it);_(Ee.$$.fragment,Ms),Ms.forEach(o),ae.forEach(o),po=c(t),V=a(t,"H2",{class:!0});var zo=i(V);oe=a(zo,"A",{id:!0,class:!0,href:!0});var As=i(oe);jt=a(As,"SPAN",{});var Ns=i(jt);_(Be.$$.fragment,Ns),Ns.forEach(o),As.forEach(o),Nn=c(zo),xt=a(zo,"SPAN",{});var Ls=i(xt);Ln=r(Ls,"BertGenerationEncoder"),Ls.forEach(o),zo.forEach(o),uo=c(t),m=a(t,"DIV",{class:!0});var z=i(m);_(ze.$$.fragment,z),Fn=c(z),Ct=a(z,"P",{});var Fs=i(Ct);On=r(Fs,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Fs.forEach(o),In=c(z),$e=a(z,"P",{});var $o=i($e);Rn=r($o,"This model inherits from "),dt=a($o,"A",{href:!0});var Os=i(dt);Wn=r(Os,"PreTrainedModel"),Os.forEach(o),Un=r($o,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
