import{S as Si,i as Ti,s as Ui,e as n,k as c,w as _,t as r,M as ki,c as a,d as o,m as d,a as s,x as v,h as i,b as l,F as e,g as h,y as b,q as w,o as y,B as S,v as $i}from"../../chunks/vendor-6b77c823.js";import{T as wn}from"../../chunks/Tip-39098574.js";import{D as L}from"../../chunks/Docstring-abef54e3.js";import{C as Tt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Te}from"../../chunks/IconCopyLink-7a11ce68.js";function Ci(W){let m,k,u,T,U;return{c(){m=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),T=r("Module"),U=r(`
...
decoded using `),jt=n("a"),zn=r("Wav2Vec2CTCTokenizer"),On=r("."),Po=c(),N=n("p"),Dn=r("This model was contributed by "),je=n("a"),An=r("patrickvonplaten"),Ln=r(`. The Authors\u2019 code can be
found `),Fe=n("a"),Wn=r("here"),Nn=r("."),Eo=c(),Q=n("h2"),me=n("a"),Zt=n("span"),_(xe.$$.fragment),Vn=c(),Jt=n("span"),In=r("UniSpeechConfig"),Mo=c(),x=n("div"),_(qe.$$.fragment),Bn=c(),X=n("p"),Hn=r("This is the configuration class to store the configuration of a "),Ft=n("a"),Kn=r("UniSpeechModel"),Yn=r(`. It is used to instantiate an
...
documentation from `),qt=n("a"),ea=r("PretrainedConfig"),ta=r(" for more information."),oa=c(),Gt=n("p"),na=r("Example:"),aa=c(),_(Ee.$$.fragment),zo=c(),J=n("h2"),ue=n("a"),eo=n("span"),_(Me.$$.fragment),sa=c(),to=n("span"),ra=r("UniSpeech specific outputs"),Oo=c(),G=n("div"),_(ze.$$.fragment),ia=c(),Oe=n("p"),la=r("Output type of "),oo=n("code"),ca=r("UniSpeechBaseModelOutput"),da=r(", with potential hidden states and attentions."),Do=c(),ee=n("div"),_(De.$$.fragment),pa=c(),Ae=n("p"),ha=r("Output type of "),no=n("code"),ma=r("UniSpeechForPreTrainingOutput"),ua=r(", with potential hidden states and attentions."),Ao=c(),te=n("h2"),fe=n("a"),ao=n("span"),_(Le.$$.fragment),fa=c(),so=n("span"),ga=r("UniSpeechModel"),Lo=c(),q=n("div"),_(We.$$.fragment),_a=c(),Ne=n("p"),va=r(`The bare UniSpeech Model transformer outputting raw hidden-states without any specific head on top.
...
Michael Zeng, Xuedong Huang.`),ya=c(),Ie=n("p"),Sa=r("This model inherits from "),Pt=n("a"),Ta=r("PreTrainedModel"),Ua=r(`. Check the superclass documentation for the generic methods the
...
behavior.`),Fa=c(),M=n("div"),_(Ke.$$.fragment),xa=c(),oe=n("p"),qa=r("The "),Et=n("a"),Pa=r("UniSpeechModel"),Ea=r(" forward method, overrides the "),ro=n("code"),Ma=r("__call__"),za=r(" special method."),Oa=c(),_(ge.$$.fragment),Da=c(),io=n("p"),Aa=r("Example:"),La=c(),_(Ye.$$.fragment),Wo=c(),ne=n("h2"),_e=n("a"),lo=n("span"),_(Re.$$.fragment),Wa=c(),co=n("span"),Na=r("UniSpeechForCTC"),No=c(),P=n("div"),_(Qe.$$.fragment),Va=c(),ae=n("p"),Ia=r("UniSpeech Model with a "),po=n("code"),Ba=r("language modeling"),Ha=r(` head on top for Connectionist Temporal Classification (CTC).
...
SUPERB Keyword Spotting.`),vs=c(),st=n("p"),bs=r("UniSpeech was proposed in "),rt=n("a"),ws=r(`UniSpeech: Unified Speech Representation Learning with Labeled and Unlabeled
