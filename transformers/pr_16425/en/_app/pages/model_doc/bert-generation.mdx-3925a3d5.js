import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as fa,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as y,v as ma}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,f,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var S=i(f);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,f),e(f,B),e(u,x)},d(T){T&&o(u)}}}function _a(He){let u,D,f,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var S=i(f);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,f),e(f,B),e(u,x)},d(T){T&&o(u)}}}function ba(He){let u,D,f,B,x,T,w,S,Do,Kt,R,Y,kt,ie,So,yt,Mo,Qt,M,Ao,Ve,Oo,Fo,de,Lo,No,Xt,Je,Io,Yt,Ke,Tt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,O,an,ue,dn,ln,fe,cn,hn,io,W,ee,Bt,me,pn,zt,un,lo,$,ge,fn,_e,mn,$t,gn,_n,bn,U,vn,rt,kn,yn,st,Tn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,C,ke,qn,ye,Pn,Te,jn,xn,Cn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,jt,Be,On,xt,Fn,uo,m,ze,Ln,Ct,Nn,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,je,Yn,Zn,er,J,tr,lt,or,nr,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,fr,mr,Ot,gr,_r,Ft,br,vr,kr,q,Ce,yr,K,Tr,ct,wr,Er,Lt,Br,zr,$r,ne,Gr,Nt,qr,Pr,De,fo,Q,re,It,Se,jr,Rt,xr,mo,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Oe,Or,ht,Fr,Lr,Nr,Fe,Ir,Le,Rr,Wr,Ur,P,Ne,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return T=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
</ul>`,name:"sp_model_kwargs"}]}}),Ee=new Ue({props:{name:"save_vocabulary",anchor:"transformers.BertGenerationTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/bert_generation/tokenization_bert_generation.py#L155"}}),Be=new vt({}),ze=new Ue({props:{name:"class transformers.BertGenerationEncoder",anchor:"transformers.BertGenerationEncoder",parameters:[{name:"config",val:": BertGenerationConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/bert_generation/modeling_bert_generation.py#L261",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ce=new Ue({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor, ...], ...] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/bert_generation/modeling_bert_generation.py#L302",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Se=new vt({}),Me=new Ue({props:{name:"class transformers.BertGenerationDecoder",anchor:"transformers.BertGenerationDecoder",parameters:[{name:"config",val:": BertGenerationConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/bert_generation/modeling_bert_generation.py#L450",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ne=new Ue({props:{name:"forward",anchor:"transformers.BertGenerationDecoder.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[torch.FloatTensor, ...], ...], NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/bert_generation/modeling_bert_generation.py#L469",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See <a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16425/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),D=l(),f=s("h1"),B=s("a"),x=s("span"),g(T.$$.fragment),w=l(),S=s("span"),Do=n("BertGeneration"),Kt=l(),R=s("h2"),Y=s("a"),kt=s("span"),g(ie.$$.fragment),So=l(),yt=s("span"),Mo=n("Overview"),Qt=l(),M=s("p"),Ao=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ve=s("a"),Oo=n("EncoderDecoderModel"),Fo=n(" as proposed in "),de=s("a"),Lo=n(`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),No=n(" by Sascha Rothe, Shashi Narayan, Aliaksei Severyn."),Xt=l(),Je=s("p"),Io=n("The abstract from the paper is the following:"),Yt=l(),Ke=s("p"),Tt=s("em"),Ro=n(`Unsupervised pretraining of large neural models has recently revolutionized Natural Language Processing. By
...
Therefore, no EOS token should be added to the end of the input.`),ao=l(),O=s("p"),an=n("This model was contributed by "),ue=s("a"),dn=n("patrickvonplaten"),ln=n(`. The original code can be
found `),fe=s("a"),cn=n("here"),hn=n("."),io=l(),W=s("h2"),ee=s("a"),Bt=s("span"),g(me.$$.fragment),pn=l(),zt=s("span"),un=n("BertGenerationConfig"),lo=l(),$=s("div"),g(ge.$$.fragment),fn=l(),_e=s("p"),mn=n("This is the configuration class to store the configuration of a "),$t=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(` It is used to
...
documentation from `),st=s("a"),Tn=n("PretrainedConfig"),wn=n(" for more information."),En=l(),Gt=s("p"),Bn=n("Examples:"),zn=l(),g(be.$$.fragment),co=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ve.$$.fragment),$n=l(),Pt=s("span"),Gn=n("BertGenerationTokenizer"),ho=l(),C=s("div"),g(ke.$$.fragment),qn=l(),ye=s("p"),Pn=n("Construct a BertGeneration tokenizer. Based on "),Te=s("a"),jn=n("SentencePiece"),xn=n("."),Cn=l(),we=s("p"),Dn=n("This tokenizer inherits from "),at=s("a"),Sn=n("PreTrainedTokenizer"),Mn=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),jt=s("span"),g(Be.$$.fragment),On=l(),xt=s("span"),Fn=n("BertGenerationEncoder"),uo=l(),m=s("div"),g(ze.$$.fragment),Ln=l(),Ct=s("p"),Nn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
cross-attention is added between the self-attention layers, following the architecture described in `),je=s("a"),Yn=n(`Attention is
...
described in `),xe=s("a"),rr=n("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),sr=n(`
...
to `),St=s("code"),cr=n("True"),hr=n(". To be used in a Seq2Seq model, the model needs to initialized with both "),Mt=s("code"),pr=n("is_decoder"),ur=n(` argument and
`),At=s("code"),fr=n("add_cross_attention"),mr=n(" set to "),Ot=s("code"),gr=n("True"),_r=n("; an "),Ft=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),yr=l(),K=s("p"),Tr=n("The "),ct=s("a"),wr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Lt=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),Nt=s("p"),qr=n("Example:"),Pr=l(),g(De.$$.fragment),fo=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=n("BertGenerationDecoder"),mo=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=n("BertGeneration Model with a "),Wt=s("code"),Sr=n("language modeling"),Mr=n(" head on top for CLM fine-tuning."),Ar=l(),Oe=s("p"),Or=n("This model inherits from "),ht=s("a"),Fr=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nr=l(),Fe=s("p"),Ir=n("This model is also a PyTorch "),Le=s("a"),Rr=n("torch.nn.Module"),Wr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),P=s("div"),g(Ne.$$.fragment),Hr=l(),X=s("p"),Vr=n("The "),pt=s("a"),Jr=n("BertGenerationDecoder"),Kr=n(" forward method, overrides the "),Ut=s("code"),Qr=n("__call__"),Xr=n(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=n("Example:"),ts=l(),g(Ie.$$.fragment),this.h()},l(t){const h=fa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),D=c(t),f=a(t,"H1",{class:!0});var Re=i(f);B=a(Re,"A",{id:!0,class:!0,href:!0});var Vt=i(B);x=a(Vt,"SPAN",{});var os=i(x);_(T.$$.fragment,os),os.forEach(o),Vt.forEach(o),w=c(Re),S=a(Re,"SPAN",{});var ns=i(S);Do=r(ns,"BertGeneration"),ns.forEach(o),Re.forEach(o),Kt=c(t),R=a(t,"H2",{class:!0});var _o=i(R);Y=a(_o,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(ie.$$.fragment,ss),ss.forEach(o),rs.forEach(o),So=c(_o),yt=a(_o,"SPAN",{});var as=i(yt);Mo=r(as,"Overview"),as.forEach(o),_o.forEach(o),Qt=c(t),M=a(t,"P",{});var ut=i(M);Ao=r(ut,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ve=a(ut,"A",{href:!0});var is=i(Ve);Oo=r(is,"EncoderDecoderModel"),is.forEach(o),Fo=r(ut," as proposed in "),de=a(ut,"A",{href:!0,rel:!0});var ds=i(de);Lo=r(ds,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),ds.forEach(o),No=r(ut," by Sascha Rothe, Shashi Narayan, Aliaksei Severyn."),ut.forEach(o),Xt=c(t),Je=a(t,"P",{});var ls=i(Je);Io=r(ls,"The abstract from the paper is the following:"),ls.forEach(o),Yt=c(t),Ke=a(t,"P",{});var cs=i(Ke);Tt=a(cs,"EM",{});var hs=i(Tt);Ro=r(hs,`Unsupervised pretraining of large neural models has recently revolutionized Natural Language Processing. By
warm-starting from the publicly released checkpoints, NLP practitioners have pushed the state-of-the-art on multiple
benchmarks while saving significant amounts of compute time. So far the focus has been mainly on the Natural Language
Understanding tasks. In this paper, we demonstrate the efficacy of pre-trained checkpoints for Sequence Generation. We
developed a Transformer-based sequence-to-sequence model that is compatible with publicly available pre-trained BERT,
GPT-2 and RoBERTa checkpoints and conducted an extensive empirical study on the utility of initializing our model, both
encoder and decoder, with these checkpoints. Our models result in new state-of-the-art results on Machine Translation,
Text Summarization, Sentence Splitting, and Sentence Fusion.`),hs.forEach(o),cs.forEach(o),Zt=c(t),Qe=a(t,"P",{});var ps=i(Qe);Wo=r(ps,"Usage:"),ps.forEach(o),eo=c(t),Xe=a(t,"UL",{});var us=i(Xe);le=a(us,"LI",{});var bo=i(le);Uo=r(bo,"The model can be used in combination with the "),Ye=a(bo,"A",{href:!0});var fs=i(Ye);Ho=r(fs,"EncoderDecoderModel"),fs.forEach(o),Vo=r(bo,` to leverage two pretrained
BERT checkpoints for subsequent fine-tuning.`),bo.forEach(o),us.forEach(o),to=c(t),_(ce.$$.fragment,t),oo=c(t),Ze=a(t,"UL",{});var ms=i(Ze);he=a(ms,"LI",{});var vo=i(he);Jo=r(vo,"Pretrained "),et=a(vo,"A",{href:!0});var gs=i(et);Ko=r(gs,"EncoderDecoderModel"),gs.forEach(o),Qo=r(vo," are also directly available in the model hub, e.g.,"),vo.forEach(o),ms.forEach(o),no=c(t),_(pe.$$.fragment,t),ro=c(t),tt=a(t,"P",{});var _s=i(tt);Xo=r(_s,"Tips:"),_s.forEach(o),so=c(t),Z=a(t,"UL",{});var ko=i(Z);A=a(ko,"LI",{});var We=i(A);ot=a(We,"A",{href:!0});var bs=i(ot);Yo=r(bs,"BertGenerationEncoder"),bs.forEach(o),Zo=r(We," and "),nt=a(We,"A",{href:!0});var vs=i(nt);en=r(vs,"BertGenerationDecoder"),vs.forEach(o),tn=r(We,` should be used in
...
Therefore, no EOS token should be added to the end of the input.`),ys.forEach(o),ko.forEach(o),ao=c(t),O=a(t,"P",{});var ft=i(O);an=r(ft,"This model was contributed by "),ue=a(ft,"A",{href:!0,rel:!0});var Ts=i(ue);dn=r(Ts,"patrickvonplaten"),Ts.forEach(o),ln=r(ft,`. The original code can be
found `),fe=a(ft,"A",{href:!0,rel:!0});var ws=i(fe);cn=r(ws,"here"),ws.forEach(o),hn=r(ft,"."),ft.forEach(o),io=c(t),W=a(t,"H2",{class:!0});var yo=i(W);ee=a(yo,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(me.$$.fragment,Bs),Bs.forEach(o),Es.forEach(o),pn=c(yo),zt=a(yo,"SPAN",{});var zs=i(zt);un=r(zs,"BertGenerationConfig"),zs.forEach(o),yo.forEach(o),lo=c(t),$=a(t,"DIV",{class:!0});var F=i($);_(ge.$$.fragment,F),fn=c(F),_e=a(F,"P",{});var To=i(_e);mn=r(To,"This is the configuration class to store the configuration of a "),$t=a(To,"CODE",{});var $s=i($t);gn=r($s,"BertGenerationPreTrainedModel"),$s.forEach(o),_n=r(To,` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),To.forEach(o),bn=c(F),U=a(F,"P",{});var mt=i(U);vn=r(mt,"Configuration objects inherit from "),rt=a(mt,"A",{href:!0});var Gs=i(rt);kn=r(Gs,"PretrainedConfig"),Gs.forEach(o),yn=r(mt,` and can be used to control the model outputs. Read the
documentation from `),st=a(mt,"A",{href:!0});var qs=i(st);Tn=r(qs,"PretrainedConfig"),qs.forEach(o),wn=r(mt," for more information."),mt.forEach(o),En=c(F),Gt=a(F,"P",{});var Ps=i(Gt);Bn=r(Ps,"Examples:"),Ps.forEach(o),zn=c(F),_(be.$$.fragment,F),F.forEach(o),co=c(t),H=a(t,"H2",{class:!0});var wo=i(H);te=a(wo,"A",{id:!0,class:!0,href:!0});var js=i(te);qt=a(js,"SPAN",{});var xs=i(qt);_(ve.$$.fragment,xs),xs.forEach(o),js.forEach(o),$n=c(wo),Pt=a(wo,"SPAN",{});var Cs=i(Pt);Gn=r(Cs,"BertGenerationTokenizer"),Cs.forEach(o),wo.forEach(o),ho=c(t),C=a(t,"DIV",{class:!0});var ae=i(C);_(ke.$$.fragment,ae),qn=c(ae),ye=a(ae,"P",{});var Eo=i(ye);Pn=r(Eo,"Construct a BertGeneration tokenizer. Based on "),Te=a(Eo,"A",{href:!0,rel:!0});var Ds=i(Te);jn=r(Ds,"SentencePiece"),Ds.forEach(o),xn=r(Eo,"."),Eo.forEach(o),Cn=c(ae),we=a(ae,"P",{});var Bo=i(we);Dn=r(Bo,"This tokenizer inherits from "),at=a(Bo,"A",{href:!0});var Ss=i(at);Sn=r(Ss,"PreTrainedTokenizer"),Ss.forEach(o),Mn=r(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),An=c(ae),it=a(ae,"DIV",{class:!0});var Ms=i(it);_(Ee.$$.fragment,Ms),Ms.forEach(o),ae.forEach(o),po=c(t),V=a(t,"H2",{class:!0});var zo=i(V);oe=a(zo,"A",{id:!0,class:!0,href:!0});var As=i(oe);jt=a(As,"SPAN",{});var Os=i(jt);_(Be.$$.fragment,Os),Os.forEach(o),As.forEach(o),On=c(zo),xt=a(zo,"SPAN",{});var Fs=i(xt);Fn=r(Fs,"BertGenerationEncoder"),Fs.forEach(o),zo.forEach(o),uo=c(t),m=a(t,"DIV",{class:!0});var z=i(m);_(ze.$$.fragment,z),Ln=c(z),Ct=a(z,"P",{});var Ls=i(Ct);Nn=r(Ls,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Ls.forEach(o),In=c(z),$e=a(z,"P",{});var $o=i($e);Rn=r($o,"This model inherits from "),dt=a($o,"A",{href:!0});var Ns=i(dt);Wn=r(Ns,"PreTrainedModel"),Ns.forEach(o),Un=r($o,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
cross-attention is added between the self-attention layers, following the architecture described in `),je=a(qo,"A",{href:!0,rel:!0});var Rs=i(je);Yn=r(Rs,`Attention is
...
described in `),xe=a(gt,"A",{href:!0,rel:!0});var Us=i(xe);rr=r(Us,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Us.forEach(o),sr=r(gt,`
by Sascha Rothe, Shashi Narayan, and Aliaksei Severyn.`),gt.forEach(o),ar=c(z),E=a(z,"P",{});var j=i(E);ir=r(j,"To behave as an decoder the model needs to be initialized with the "),Dt=a(j,"CODE",{});var Hs=i(Dt);dr=r(Hs,"is_decoder"),Hs.forEach(o),lr=r(j,` argument of the configuration set
to `),St=a(j,"CODE",{});var Vs=i(St);cr=r(Vs,"True"),Vs.forEach(o),hr=r(j,". To be used in a Seq2Seq model, the model needs to initialized with both "),Mt=a(j,"CODE",{});var Js=i(Mt);pr=r(Js,"is_decoder"),Js.forEach(o),ur=r(j,` argument and
`),At=a(j,"CODE",{});var Ks=i(At);fr=r(Ks,"add_cross_attention"),Ks.forEach(o),mr=r(j," set to "),Ot=a(j,"CODE",{});var Qs=i(Ot);gr=r(Qs,"True"),Qs.forEach(o),_r=r(j,"; an "),Ft=a(j,"CODE",{});var Xs=i(Ft);br=r(Xs,"encoder_hidden_states"),Xs.forEach(o),vr=r(j," is then expected as an input to the forward pass."),j.forEach(o),kr=c(z),q=a(z,"DIV",{class:!0});var L=i(q);_(Ce.$$.fragment,L),yr=c(L),K=a(L,"P",{});var _t=i(K);Tr=r(_t,"The "),ct=a(_t,"A",{href:!0});var Ys=i(ct);wr=r(Ys,"BertGenerationEncoder"),Ys.forEach(o),Er=r(_t," forward method, overrides the "),Lt=a(_t,"CODE",{});var Zs=i(Lt);Br=r(Zs,"__call__"),Zs.forEach(o),zr=r(_t," special method."),_t.forEach(o),$r=c(L),_(ne.$$.fragment,L),Gr=c(L),Nt=a(L,"P",{});var ea=i(Nt);qr=r(ea,"Example:"),ea.forEach(o),Pr=c(L),_(De.$$.fragment,L),L.forEach(o),z.forEach(o),fo=c(t),Q=a(t,"H2",{class:!0});var Po=i(Q);re=a(Po,"A",{id:!0,class:!0,href:!0});var ta=i(re);It=a(ta,"SPAN",{});var oa=i(It);_(Se.$$.fragment,oa),oa.forEach(o),ta.forEach(o),jr=c(Po),Rt=a(Po,"SPAN",{});var na=i(Rt);xr=r(na,"BertGenerationDecoder"),na.forEach(o),Po.forEach(o),mo=c(t),G=a(t,"DIV",{class:!0});var N=i(G);_(Me.$$.fragment,N),Cr=c(N),Ae=a(N,"P",{});var jo=i(Ae);Dr=r(jo,"BertGeneration Model with a "),Wt=a(jo,"CODE",{});var ra=i(Wt);Sr=r(ra,"language modeling"),ra.forEach(o),Mr=r(jo," head on top for CLM fine-tuning."),jo.forEach(o),Ar=c(N),Oe=a(N,"P",{});var xo=i(Oe);Or=r(xo,"This model inherits from "),ht=a(xo,"A",{href:!0});var sa=i(ht);Fr=r(sa,"PreTrainedModel"),sa.forEach(o),Lr=r(xo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xo.forEach(o),Nr=c(N),Fe=a(N,"P",{});var Co=i(Fe);Ir=r(Co,"This model is also a PyTorch "),Le=a(Co,"A",{href:!0,rel:!0});var aa=i(Le);Rr=r(aa,"torch.nn.Module"),aa.forEach(o),Wr=r(Co,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Co.forEach(o),Ur=c(N),P=a(N,"DIV",{class:!0});var I=i(P);_(Ne.$$.fragment,I),Hr=c(I),X=a(I,"P",{});var bt=i(X);Vr=r(bt,"The "),pt=a(bt,"A",{href:!0});var ia=i(pt);Jr=r(ia,"BertGenerationDecoder"),ia.forEach(o),Kr=r(bt," forward method, overrides the "),Ut=a(bt,"CODE",{});var da=i(Ut);Qr=r(da,"__call__"),da.forEach(o),Xr=r(bt," special method."),bt.forEach(o),Yr=c(I),_(se.$$.fragment,I),Zr=c(I),Ht=a(I,"P",{});var la=i(Ht);es=r(la,"Example:"),la.forEach(o),ts=c(I),_(Ie.$$.fragment,I),I.forEach(o),N.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(va)),d(B,"id","bertgeneration"),d(B,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(B,"href","#bertgeneration"),d(f,"class","relative group"),d(Y,"id","overview"),d(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Y,"href","#overview"),d(R,"class","relative group"),d(Ve,"href","/docs/transformers/pr_16425/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(de,"href","https://arxiv.org/abs/1907.12461"),d(de,"rel","nofollow"),d(Ye,"href","/docs/transformers/pr_16425/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(et,"href","/docs/transformers/pr_16425/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(ot,"href","/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(nt,"href","/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(ue,"href","https://huggingface.co/patrickvonplaten"),d(ue,"rel","nofollow"),d(fe,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(fe,"rel","nofollow"),d(ee,"id","transformers.BertGenerationConfig"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#transformers.BertGenerationConfig"),d(W,"class","relative group"),d(rt,"href","/docs/transformers/pr_16425/en/main_classes/configuration#transformers.PretrainedConfig"),d(st,"href","/docs/transformers/pr_16425/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring"),d(te,"id","transformers.BertGenerationTokenizer"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationTokenizer"),d(H,"class","relative group"),d(Te,"href","https://github.com/google/sentencepiece"),d(Te,"rel","nofollow"),d(at,"href","/docs/transformers/pr_16425/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(it,"class","docstring"),d(C,"class","docstring"),d(oe,"id","transformers.BertGenerationEncoder"),d(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(oe,"href","#transformers.BertGenerationEncoder"),d(V,"class","relative group"),d(dt,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel"),d(qe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(qe,"rel","nofollow"),d(je,"href","https://arxiv.org/abs/1706.03762"),d(je,"rel","nofollow"),d(lt,"href","/docs/transformers/pr_16425/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(xe,"href","https://arxiv.org/abs/1907.12461"),d(xe,"rel","nofollow"),d(ct,"href","/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(q,"class","docstring"),d(m,"class","docstring"),d(re,"id","transformers.BertGenerationDecoder"),d(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(re,"href","#transformers.BertGenerationDecoder"),d(Q,"class","relative group"),d(ht,"href","/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel"),d(Le,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Le,"rel","nofollow"),d(pt,"href","/docs/transformers/pr_16425/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(P,"class","docstring"),d(G,"class","docstring")},m(t,h){e(document.head,u),p(t,D,h),p(t,f,h),e(f,B),e(B,x),b(T,x,null),e(f,w),e(f,S),e(S,Do),p(t,Kt,h),p(t,R,h),e(R,Y),e(Y,kt),b(ie,kt,null),e(R,So),e(R,yt),e(yt,Mo),p(t,Qt,h),p(t,M,h),e(M,Ao),e(M,Ve),e(Ve,Oo),e(M,Fo),e(M,de),e(de,Lo),e(M,No),p(t,Xt,h),p(t,Je,h),e(Je,Io),p(t,Yt,h),p(t,Ke,h),e(Ke,Tt),e(Tt,Ro),p(t,Zt,h),p(t,Qe,h),e(Qe,Wo),p(t,eo,h),p(t,Xe,h),e(Xe,le),e(le,Uo),e(le,Ye),e(Ye,Ho),e(le,Vo),p(t,to,h),b(ce,t,h),p(t,oo,h),p(t,Ze,h),e(Ze,he),e(he,Jo),e(he,et),e(et,Ko),e(he,Qo),p(t,no,h),b(pe,t,h),p(t,ro,h),p(t,tt,h),e(tt,Xo),p(t,so,h),p(t,Z,h),e(Z,A),e(A,ot),e(ot,Yo),e(A,Zo),e(A,nt),e(nt,en),e(A,tn),e(A,wt),e(wt,on),e(A,nn),e(Z,rn),e(Z,Et),e(Et,sn),p(t,ao,h),p(t,O,h),e(O,an),e(O,ue),e(ue,dn),e(O,ln),e(O,fe),e(fe,cn),e(O,hn),p(t,io,h),p(t,W,h),e(W,ee),e(ee,Bt),b(me,Bt,null),e(W,pn),e(W,zt),e(zt,un),p(t,lo,h),p(t,$,h),b(ge,$,null),e($,fn),e($,_e),e(_e,mn),e(_e,$t),e($t,gn),e(_e,_n),e($,bn),e($,U),e(U,vn),e(U,rt),e(rt,kn),e(U,yn),e(U,st),e(st,Tn),e(U,wn),e($,En),e($,Gt),e(Gt,Bn),e($,zn),b(be,$,null),p(t,co,h),p(t,H,h),e(H,te),e(te,qt),b(ve,qt,null),e(H,$n),e(H,Pt),e(Pt,Gn),p(t,ho,h),p(t,C,h),b(ke,C,null),e(C,qn),e(C,ye),e(ye,Pn),e(ye,Te),e(Te,jn),e(ye,xn),e(C,Cn),e(C,we),e(we,Dn),e(we,at),e(at,Sn),e(we,Mn),e(C,An),e(C,it),b(Ee,it,null),p(t,po,h),p(t,V,h),e(V,oe),e(oe,jt),b(Be,jt,null),e(V,On),e(V,xt),e(xt,Fn),p(t,uo,h),p(t,m,h),b(ze,m,null),e(m,Ln),e(m,Ct),e(Ct,Nn),e(m,In),e(m,$e),e($e,Rn),e($e,dt),e(dt,Wn),e($e,Un),e(m,Hn),e(m,Ge),e(Ge,Vn),e(Ge,qe),e(qe,Jn),e(Ge,Kn),e(m,Qn),e(m,Pe),e(Pe,Xn),e(Pe,je),e(je,Yn),e(Pe,Zn),e(m,er),e(m,J),e(J,tr),e(J,lt),e(lt,or),e(J,nr),e(J,xe),e(xe,rr),e(J,sr),e(m,ar),e(m,E),e(E,ir),e(E,Dt),e(Dt,dr),e(E,lr),e(E,St),e(St,cr),e(E,hr),e(E,Mt),e(Mt,pr),e(E,ur),e(E,At),e(At,fr),e(E,mr),e(E,Ot),e(Ot,gr),e(E,_r),e(E,Ft),e(Ft,br),e(E,vr),e(m,kr),e(m,q),b(Ce,q,null),e(q,yr),e(q,K),e(K,Tr),e(K,ct),e(ct,wr),e(K,Er),e(K,Lt),e(Lt,Br),e(K,zr),e(q,$r),b(ne,q,null),e(q,Gr),e(q,Nt),e(Nt,qr),e(q,Pr),b(De,q,null),p(t,fo,h),p(t,Q,h),e(Q,re),e(re,It),b(Se,It,null),e(Q,jr),e(Q,Rt),e(Rt,xr),p(t,mo,h),p(t,G,h),b(Me,G,null),e(G,Cr),e(G,Ae),e(Ae,Dr),e(Ae,Wt),e(Wt,Sr),e(Ae,Mr),e(G,Ar),e(G,Oe),e(Oe,Or),e(Oe,ht),e(ht,Fr),e(Oe,Lr),e(G,Nr),e(G,Fe),e(Fe,Ir),e(Fe,Le),e(Le,Rr),e(Fe,Wr),e(G,Ur),e(G,P),b(Ne,P,null),e(P,Hr),e(P,X),e(X,Vr),e(X,pt),e(pt,Jr),e(X,Kr),e(X,Ut),e(Ut,Qr),e(X,Xr),e(P,Yr),b(se,P,null),e(P,Zr),e(P,Ht),e(Ht,es),e(P,ts),b(Ie,P,null),go=!0},p(t,[h]){const Re={};h&2&&(Re.$$scope={dirty:h,ctx:t}),ne.$set(Re);const Vt={};h&2&&(Vt.$$scope={dirty:h,ctx:t}),se.$set(Vt)},i(t){go||(v(T.$$.fragment,t),v(ie.$$.fragment,t),v(ce.$$.fragment,t),v(pe.$$.fragment,t),v(me.$$.fragment,t),v(ge.$$.fragment,t),v(be.$$.fragment,t),v(ve.$$.fragment,t),v(ke.$$.fragment,t),v(Ee.$$.fragment,t),v(Be.$$.fragment,t),v(ze.$$.fragment,t),v(Ce.$$.fragment,t),v(ne.$$.fragment,t),v(De.$$.fragment,t),v(Se.$$.fragment,t),v(Me.$$.fragment,t),v(Ne.$$.fragment,t),v(se.$$.fragment,t),v(Ie.$$.fragment,t),go=!0)},o(t){k(T.$$.fragment,t),k(ie.$$.fragment,t),k(ce.$$.fragment,t),k(pe.$$.fragment,t),k(me.$$.fragment,t),k(ge.$$.fragment,t),k(be.$$.fragment,t),k(ve.$$.fragment,t),k(ke.$$.fragment,t),k(Ee.$$.fragment,t),k(Be.$$.fragment,t),k(ze.$$.fragment,t),k(Ce.$$.fragment,t),k(ne.$$.fragment,t),k(De.$$.fragment,t),k(Se.$$.fragment,t),k(Me.$$.fragment,t),k(Ne.$$.fragment,t),k(se.$$.fragment,t),k(Ie.$$.fragment,t),go=!1},d(t){o(u),t&&o(D),t&&o(f),y(T),t&&o(Kt),t&&o(R),y(ie),t&&o(Qt),t&&o(M),t&&o(Xt),t&&o(Je),t&&o(Yt),t&&o(Ke),t&&o(Zt),t&&o(Qe),t&&o(eo),t&&o(Xe),t&&o(to),y(ce,t),t&&o(oo),t&&o(Ze),t&&o(no),y(pe,t),t&&o(ro),t&&o(tt),t&&o(so),t&&o(Z),t&&o(ao),t&&o(O),t&&o(io),t&&o(W),y(me),t&&o(lo),t&&o($),y(ge),y(be),t&&o(co),t&&o(H),y(ve),t&&o(ho),t&&o(C),y(ke),y(Ee),t&&o(po),t&&o(V),y(Be),t&&o(uo),t&&o(m),y(ze),y(Ce),y(ne),y(De),t&&o(fo),t&&o(Q),y(Se),t&&o(mo),t&&o(G),y(Me),y(Ne),y(se),y(Ie)}}}const va={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function ka(He){return ma(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class za extends ha{constructor(u){super();pa(this,u,ka,ba,ua,{})}}export{za as default,va as metadata};
