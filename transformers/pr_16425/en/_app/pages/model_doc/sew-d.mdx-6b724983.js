...
instance of <a href="/docs/transformers/pr_16425/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16425/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16425/en/model_doc/sew-d#transformers.SEWDConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">384</span>]`}}),ke=new ht({}),Ce=new Je({props:{name:"class transformers.SEWDForCTC",anchor:"transformers.SEWDForCTC",parameters:[{name:"config",val:": SEWDConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/sew_d/modeling_sew_d.py#L1482",parametersDescription:[{anchor:"transformers.SEWDForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Pe=new Je({props:{name:"forward",anchor:"transformers.SEWDForCTC.forward",parameters:[{name:"input_values",val:": FloatTensor"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/sew_d/modeling_sew_d.py#L1523",parametersDescription:[{anchor:"transformers.SEWDForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16425/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-number">0.21</span>`}}),ze=new ht({}),Ae=new Je({props:{name:"class transformers.SEWDForSequenceClassification",anchor:"transformers.SEWDForSequenceClassification",parameters:[{name:"config",val:": SEWDConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/sew_d/modeling_sew_d.py#L1613",parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ke=new Je({props:{name:"forward",anchor:"transformers.SEWDForSequenceClassification.forward",parameters:[{name:"input_values",val:": FloatTensor"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/sew_d/modeling_sew_d.py#L1658",parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16425/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){m=n("meta"),T=d(),h=n("h1"),S=n("a"),W=n("span"),_(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Ot=d(),I=n("h2"),Z=n("a"),ut=n("span"),_(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs
in Unsupervised Pre-training for Speech Recognition`),So=r(` by Felix Wu, Kwangyoun Kim,
Jing Pan, Kyu Han, Kilian Q. Weinberger, Yoav Artzi.`),Vt=d(),Qe=n("p"),Wo=r("The abstract from the paper is the following:"),It=d(),Be=n("p"),_t=n("em"),Do=r(`This paper is a study of performance-efficiency trade-offs in pre-trained models for automatic speech recognition
...
library implements for all its model (such as downloading or saving etc.).`),zn=d(),xe=n("p"),An=r("This model is a PyTorch "),je=n("a"),On=r("torch.nn.Module"),Ln=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vn=d(),k=n("div"),_(Pe.$$.fragment),In=d(),B=n("p"),Nn=r("The "),at=n("a"),Kn=r("SEWDForCTC"),Hn=r(" forward method, overrides the "),$t=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=d(),_(ie.$$.fragment),Qn=d(),qt=n("p"),Bn=r("Example:"),Yn=d(),_(Fe.$$.fragment),Gn=d(),_(Me.$$.fragment),Gt=d(),Y=n("h2"),le=n("a"),xt=n("span"),_(ze.$$.fragment),Xn=d(),jt=n("span"),Zn=r("SEWDForSequenceClassification"),Xt=d(),D=n("div"),_(Ae.$$.fragment),ea=d(),Pt=n("p"),ta=r(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),oa=d(),Oe=n("p"),na=r("SEW-D was proposed in "),Le=n("a"),aa=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),sa=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),ra=d(),Ve=n("p"),ia=r("This model inherits from "),st=n("a"),la=r("PreTrainedModel"),da=r(`. Check the superclass documentation for the generic methods the
...
using `),Ge=a(no,"A",{href:!0});var Aa=s(Ge);qo=i(Aa,"Wav2Vec2CTCTokenizer"),Aa.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=c(t),oe=a(t,"P",{});var ao=s(oe);jo=i(ao,"This model was contributed by "),fe=a(ao,"A",{href:!0,rel:!0});var Oa=s(fe);Po=i(Oa,"anton-l"),Oa.forEach(o),Fo=i(ao,"."),ao.forEach(o),Rt=c(t),N=a(t,"H2",{class:!0});var so=s(N);ne=a(so,"A",{id:!0,class:!0,href:!0});var La=s(ne);wt=a(La,"SPAN",{});var Va=s(wt);v(he.$$.fragment,Va),Va.forEach(o),La.forEach(o),Mo=c(so),bt=a(so,"SPAN",{});var Ia=s(bt);zo=i(Ia,"SEWDConfig"),Ia.forEach(o),so.forEach(o),Ut=c(t),$=a(t,"DIV",{class:!0});var A=s($);v(ue.$$.fragment,A),Ao=c(A),K=a(A,"P",{});var it=s(K);Oo=i(it,"This is the configuration class to store the configuration of a "),Xe=a(it,"A",{href:!0});var Na=s(Xe);Lo=i(Na,"SEWDModel"),Na.forEach(o),Vo=i(it,`. It is used to instantiate a SEW-D
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW-D
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(O),P=a(O,"DIV",{class:!0});var L=s(P);v(De.$$.fragment,L),hn=c(L),U=a(L,"P",{});var dt=s(U);un=i(dt,"The "),ot=a(dt,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWDModel"),Za.forEach(o),_n=i(dt," forward method, overrides the "),Wt=a(dt,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(L),v(se.$$.fragment,L),yn=c(L),Dt=a(L,"P",{});var ts=s(Dt);En=i(ts,"Example:"),ts.forEach(o),Sn=c(L),v(Te.$$.fragment,L),L.forEach(o),O.forEach(o),Bt=c(t),J=a(t,"H2",{class:!0});var po=s(J);re=a(po,"A",{id:!0,class:!0,href:!0});var os=s(re);Tt=a(os,"SPAN",{});var ns=s(Tt);v(ke.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=c(po),kt=a(po,"SPAN",{});var as=s(kt);Dn=i(as,"SEWDForCTC"),as.forEach(o),po.forEach(o),Yt=c(t),x=a(t,"DIV",{class:!0});var V=s(x);v(Ce.$$.fragment,V),Tn=c(V),Q=a(V,"P",{});var ct=s(Q);kn=i(ct,"SEW-D Model with a "),Ct=a(ct,"CODE",{});var ss=s(Ct);Cn=i(ss,"language modeling"),ss.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(V),qe=a(V,"P",{});var mo=s(qe);Pn=i(mo,"This model inherits from "),nt=a(mo,"A",{href:!0});var is=s(nt);Fn=i(is,"PreTrainedModel"),is.forEach(o),Mn=i(mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),mo.forEach(o),zn=c(V),xe=a(V,"P",{});var fo=s(xe);An=i(fo,"This model is a PyTorch "),je=a(fo,"A",{href:!0,rel:!0});var ls=s(je);On=i(ls,"torch.nn.Module"),ls.forEach(o),Ln=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Vn=c(V),k=a(V,"DIV",{class:!0});var F=s(k);v(Pe.$$.fragment,F),In=c(F),B=a(F,"P",{});var pt=s(B);Nn=i(pt,"The "),at=a(pt,"A",{href:!0});var ds=s(at);Kn=i(ds,"SEWDForCTC"),ds.forEach(o),Hn=i(pt," forward method, overrides the "),$t=a(pt,"CODE",{});var cs=s($t);Rn=i(cs,"__call__"),cs.forEach(o),Un=i(pt," special method."),pt.forEach(o),Jn=c(F),v(ie.$$.fragment,F),Qn=c(F),qt=a(F,"P",{});var ps=s(qt);Bn=i(ps,"Example:"),ps.forEach(o),Yn=c(F),v(Fe.$$.fragment,F),Gn=c(F),v(Me.$$.fragment,F),F.forEach(o),V.forEach(o),Gt=c(t),Y=a(t,"H2",{class:!0});var ho=s(Y);le=a(ho,"A",{id:!0,class:!0,href:!0});var ms=s(le);xt=a(ms,"SPAN",{});var fs=s(xt);v(ze.$$.fragment,fs),fs.forEach(o),ms.forEach(o),Xn=c(ho),jt=a(ho,"SPAN",{});var hs=s(jt);Zn=i(hs,"SEWDForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=c(t),D=a(t,"DIV",{class:!0});var M=s(D);v(Ae.$$.fragment,M),ea=c(M),Pt=a(M,"P",{});var us=s(Pt);ta=i(us,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),us.forEach(o),oa=c(M),Oe=a(M,"P",{});var uo=s(Oe);na=i(uo,"SEW-D was proposed in "),Le=a(uo,"A",{href:!0,rel:!0});var gs=s(Le);aa=i(gs,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),gs.forEach(o),sa=i(uo,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),uo.forEach(o),ra=c(M),Ve=a(M,"P",{});var go=s(Ve);ia=i(go,"This model inherits from "),st=a(go,"A",{href:!0});var _s=s(st);la=i(_s,"PreTrainedModel"),_s.forEach(o),da=i(go,`. Check the superclass documentation for the generic methods the
