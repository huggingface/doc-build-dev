import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as fa,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as y,v as ma}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,f,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),B=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var S=i(f);B=r(S,"Module"),S.forEach(o),j=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,f),e(f,B),e(u,j)},d(T){T&&o(u)}}}function _a(He){let u,D,f,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),B=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var S=i(f);B=r(S,"Module"),S.forEach(o),j=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,f),e(f,B),e(u,j)},d(T){T&&o(u)}}}function ba(He){let u,D,f,B,j,T,w,S,Do,Kt,R,Y,kt,ie,So,yt,Mo,Qt,M,Ao,Ve,Oo,Fo,de,Lo,No,Xt,Je,Io,Yt,Ke,Tt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,O,an,ue,dn,ln,fe,cn,hn,io,W,ee,Bt,me,pn,zt,un,lo,$,ge,fn,_e,mn,$t,gn,_n,bn,U,vn,rt,kn,yn,st,Tn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,x,ke,qn,ye,Pn,Te,Cn,jn,xn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,Ct,Be,On,jt,Fn,uo,m,ze,Ln,xt,Nn,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,Ce,Yn,Zn,er,J,tr,lt,or,nr,je,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,fr,mr,Ot,gr,_r,Ft,br,vr,kr,q,xe,yr,K,Tr,ct,wr,Er,Lt,Br,zr,$r,ne,Gr,Nt,qr,Pr,De,fo,Q,re,It,Se,Cr,Rt,jr,mo,G,Me,xr,Ae,Dr,Wt,Sr,Mr,Ar,Oe,Or,ht,Fr,Lr,Nr,Fe,Ir,Le,Rr,Wr,Ur,P,Ne,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return T=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
documentation from `),st=s("a"),Tn=n("PretrainedConfig"),wn=n(" for more information."),En=l(),Gt=s("p"),Bn=n("Examples:"),zn=l(),g(be.$$.fragment),co=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ve.$$.fragment),$n=l(),Pt=s("span"),Gn=n("BertGenerationTokenizer"),ho=l(),x=s("div"),g(ke.$$.fragment),qn=l(),ye=s("p"),Pn=n("Construct a BertGeneration tokenizer. Based on "),Te=s("a"),Cn=n("SentencePiece"),jn=n("."),xn=l(),we=s("p"),Dn=n("This tokenizer inherits from "),at=s("a"),Sn=n("PreTrainedTokenizer"),Mn=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),Ct=s("span"),g(Be.$$.fragment),On=l(),jt=s("span"),Fn=n("BertGenerationEncoder"),uo=l(),m=s("div"),g(ze.$$.fragment),Ln=l(),xt=s("p"),Nn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
cross-attention is added between the self-attention layers, following the architecture described in `),Ce=s("a"),Yn=n(`Attention is
...
documentation from `),st=a(mt,"A",{href:!0});var qs=i(st);Tn=r(qs,"PretrainedConfig"),qs.forEach(o),wn=r(mt," for more information."),mt.forEach(o),En=c(F),Gt=a(F,"P",{});var Ps=i(Gt);Bn=r(Ps,"Examples:"),Ps.forEach(o),zn=c(F),_(be.$$.fragment,F),F.forEach(o),co=c(t),H=a(t,"H2",{class:!0});var wo=i(H);te=a(wo,"A",{id:!0,class:!0,href:!0});var Cs=i(te);qt=a(Cs,"SPAN",{});var js=i(qt);_(ve.$$.fragment,js),js.forEach(o),Cs.forEach(o),$n=c(wo),Pt=a(wo,"SPAN",{});var xs=i(Pt);Gn=r(xs,"BertGenerationTokenizer"),xs.forEach(o),wo.forEach(o),ho=c(t),x=a(t,"DIV",{class:!0});var ae=i(x);_(ke.$$.fragment,ae),qn=c(ae),ye=a(ae,"P",{});var Eo=i(ye);Pn=r(Eo,"Construct a BertGeneration tokenizer. Based on "),Te=a(Eo,"A",{href:!0,rel:!0});var Ds=i(Te);Cn=r(Ds,"SentencePiece"),Ds.forEach(o),jn=r(Eo,"."),Eo.forEach(o),xn=c(ae),we=a(ae,"P",{});var Bo=i(we);Dn=r(Bo,"This tokenizer inherits from "),at=a(Bo,"A",{href:!0});var Ss=i(at);Sn=r(Ss,"PreTrainedTokenizer"),Ss.forEach(o),Mn=r(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),An=c(ae),it=a(ae,"DIV",{class:!0});var Ms=i(it);_(Ee.$$.fragment,Ms),Ms.forEach(o),ae.forEach(o),po=c(t),V=a(t,"H2",{class:!0});var zo=i(V);oe=a(zo,"A",{id:!0,class:!0,href:!0});var As=i(oe);Ct=a(As,"SPAN",{});var Os=i(Ct);_(Be.$$.fragment,Os),Os.forEach(o),As.forEach(o),On=c(zo),jt=a(zo,"SPAN",{});var Fs=i(jt);Fn=r(Fs,"BertGenerationEncoder"),Fs.forEach(o),zo.forEach(o),uo=c(t),m=a(t,"DIV",{class:!0});var z=i(m);_(ze.$$.fragment,z),Ln=c(z),xt=a(z,"P",{});var Ls=i(xt);Nn=r(Ls,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Ls.forEach(o),In=c(z),$e=a(z,"P",{});var $o=i($e);Rn=r($o,"This model inherits from "),dt=a($o,"A",{href:!0});var Ns=i(dt);Wn=r(Ns,"PreTrainedModel"),Ns.forEach(o),Un=r($o,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
cross-attention is added between the self-attention layers, following the architecture described in `),Ce=a(qo,"A",{href:!0,rel:!0});var Rs=i(Ce);Yn=r(Rs,`Attention is
