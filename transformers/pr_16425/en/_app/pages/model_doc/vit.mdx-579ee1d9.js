...
breaking changes to fix it in the future. If you see something strange, file a `),f=s(u,"A",{href:!0,rel:!0});var V=n(f);g=i(V,"Github Issue"),V.forEach(t),v=i(u,"."),u.forEach(t),this.h()},h(){l(f,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),l(f,"rel","nofollow")},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function Tm(M){let p,T;return{c(){p=a("p"),T=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),g.forEach(t)},m(f,g){m(f,p,g),e(p,T)},d(f){f&&t(p)}}}function wm(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function bm(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function ym(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function $m(M){let p,T,f,g,v,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae;return{c(){p=a("p"),T=r("TF 2.0 models accepts two formats as inputs:"),f=d(),g=a("ul"),v=a("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),V=a("li"),pe=r("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=r("This second option is useful when using "),j=a("code"),B=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
...
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=n(C);he=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,I){m(E,p,I),e(p,T),m(E,f,I),m(E,g,I),e(g,v),e(v,_),e(g,u),e(g,V),e(V,pe),m(E,R,I),m(E,k,I),e(k,ie),e(k,j),e(j,B),e(k,oe),e(k,C),e(C,he),e(k,ae)},d(E){E&&t(p),E&&t(f),E&&t(g),E&&t(R),E&&t(k)}}}function xm(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function Fm(M){let p,T,f,g,v,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae;return{c(){p=a("p"),T=r("TF 2.0 models accepts two formats as inputs:"),f=d(),g=a("ul"),v=a("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),V=a("li"),pe=r("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=r("This second option is useful when using "),j=a("code"),B=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),he=r("model(inputs)"),ae=r(".")},l(E){p=s(E,"P",{});var I=n(p);T=i(I,"TF 2.0 models accepts two formats as inputs:"),I.forEach(t),f=c(E),g=s(E,"UL",{});var z=n(g);v=s(z,"LI",{});var Ie=n(v);_=i(Ie,"having all inputs as keyword arguments (like PyTorch models), or"),Ie.forEach(t),u=c(z),V=s(z,"LI",{});var se=n(V);pe=i(se,"having all inputs as a list, tuple or dict in the first positional arguments."),se.forEach(t),z.forEach(t),R=c(E),k=s(E,"P",{});var L=n(k);ie=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var je=n(j);B=i(je,"tf.keras.Model.fit"),je.forEach(t),oe=i(L,` method which currently requires having all the
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=n(C);he=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,I){m(E,p,I),e(p,T),m(E,f,I),m(E,g,I),e(g,v),e(v,_),e(g,u),e(g,V),e(V,pe),m(E,R,I),m(E,k,I),e(k,ie),e(k,j),e(j,B),e(k,oe),e(k,C),e(C,he),e(k,ae)},d(E){E&&t(p),E&&t(f),E&&t(g),E&&t(R),E&&t(k)}}}function Vm(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function Em(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function km(M){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function Mm(M){let p,T,f,g,v,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae,E,I,z,Ie,se,L,je,Te,Xo,tr,sn,Zo,Da,or,nn,Qo,ar,rn,N,Vt,sr,Et,nr,rr,ir,Oa,lr,dr,kt,cr,Yo,pr,hr,mr,Pe,fr,Sa,ur,gr,Mt,_r,vr,Tr,Ce,wr,It,br,yr,jt,$r,xr,Fr,qe,Vr,Pt,Er,kr,Ct,Mr,Ir,jr,Wa,Pr,ln,ea,Cr,dn,le,Ba,P,ta,qr,Ar,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,sa,Kr,Gr,Xr,Ka,na,ra,Zr,Qr,Yr,Ga,qt,ei,At,ti,oi,ai,Xa,ia,la,si,ni,cn,we,ri,zt,ii,li,Nt,di,ci,pn,et,pi,Lt,hi,mi,hn,Ae,tt,Za,Dt,fi,Qa,ui,mn,U,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,pa,Vi,Ei,ki,Ya,Mi,Ii,Wt,fn,Le,ot,es,Bt,ji,ts,Pi,un,ne,Ut,Ci,os,qi,Ai,Rt,zi,ha,Ni,Li,Di,be,Ht,Oi,as,Si,Wi,at,gn,De,st,ss,Jt,Bi,ns,Ui,_n,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rs,el,tl,ol,nt,al,is,sl,nl,Qt,vn,Se,rt,ls,Yt,rl,ds,il,Tn,fe,eo,ll,We,dl,cs,cl,pl,to,hl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,ps,Tl,wl,bl,it,yl,hs,$l,xl,ao,wn,Ue,lt,ms,so,Fl,fs,Vl,bn,re,no,El,us,kl,Ml,ro,Il,io,jl,Pl,Cl,K,lo,ql,Re,Al,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Bl,co,yn,He,ct,vs,po,Ul,Ts,Rl,$n,D,ho,Hl,ws,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,pt,ad,G,go,sd,Je,nd,_a,rd,id,bs,ld,dd,cd,ht,pd,ys,hd,md,_o,xn,Ke,mt,$s,vo,fd,xs,ud,Fn,O,To,gd,Fs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Md,Ta,Id,jd,Vs,Pd,Cd,qd,ut,Ad,Es,zd,Nd,xo,Vn,Xe,gt,ks,Fo,Ld,Ms,Dd,En,q,Vo,Od,Is,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Mo,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Io,Yd,ec,Cs,jo,tc,oc,qs,Po,ac,sc,As,Co,nc,rc,Z,qo,ic,Ze,lc,zs,dc,cc,Ns,pc,hc,mc,_t,fc,Ls,uc,gc,Ao,kn,Qe,vt,Ds,zo,_c,Os,vc,Mn,A,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Mc,Ws,Ic,jc,ge,Bs,So,Pc,Cc,Us,Wo,qc,Ac,Rs,Bo,zc,Nc,Hs,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Bc,Ks,Uc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,In;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:M}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p><a
  href="/docs/transformers/pr_16425/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a></p>
`}}),at=new _e({props:{warning:!0,$$slots:{default:[Tm]},$$scope:{ctx:M}}}),Jt=new ve({}),Kt=new W({props:{name:"class transformers.ViTModel",anchor:"transformers.ViTModel",parameters:[{name:"config",val:": ViTConfig"},{name:"add_pooling_layer",val:": bool = True"},{name:"use_mask_token",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/modeling_vit.py#L511",parametersDescription:[{anchor:"transformers.ViTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new W({props:{name:"forward",anchor:"transformers.ViTModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/modeling_vit.py#L536",parametersDescription:[{anchor:"transformers.ViTModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTConfig"
...
`}}),nt=new _e({props:{$$slots:{default:[wm]},$$scope:{ctx:M}}}),Qt=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),Yt=new ve({}),eo=new W({props:{name:"class transformers.ViTForMaskedImageModeling",anchor:"transformers.ViTForMaskedImageModeling",parameters:[{name:"config",val:": ViTConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/modeling_vit.py#L616",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new W({props:{name:"forward",anchor:"transformers.ViTForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/modeling_vit.py#L630",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
`}}),it=new _e({props:{$$slots:{default:[bm]},$$scope:{ctx:M}}}),ao=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),so=new ve({}),no=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:": ViTConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/modeling_vit.py#L726",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16425/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new W({props:{name:"forward",anchor:"transformers.ViTForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16425/src/transformers/models/vit/modeling_vit.py#L739",parametersDescription:[{anchor:"transformers.ViTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16425/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
`}}),ht=new _e({props:{$$slots:{default:[xm]},$$scope:{ctx:M}}}),_o=new Ft({props:{code:`from transformers import ViTFeatureExtractor, TFViTModel
from PIL import Image
import requests
...
`}}),ut=new _e({props:{$$slots:{default:[Vm]},$$scope:{ctx:M}}}),xo=new Ft({props:{code:`from transformers import ViTFeatureExtractor, TFViTForImageClassification
...
`}}),_t=new _e({props:{$$slots:{default:[Em]},$$scope:{ctx:M}}}),Ao=new Ft({props:{code:`from transformers import ViTFeatureExtractor, FlaxViTModel
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){p=a("meta"),T=d(),f=a("h1"),g=a("a"),v=a("span"),w(_.$$.fragment),u=d(),V=a("span"),pe=r("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),w(C.$$.fragment),he=d(),ae=a("span"),E=r("Overview"),I=d(),z=a("p"),Ie=r("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),Mt=a("a"),_r=r("hub"),vr=r("."),Tr=d(),Ce=a("li"),wr=r("The available checkpoints are either (1) pre-trained on "),It=a("a"),br=r("ImageNet-21k"),yr=r(` (a collection of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),w(ft.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Md=r("The "),Ta=a("a"),Id=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),Vs=a("code"),Pd=r("__call__"),Cd=r(" special method."),qd=d(),w(ut.$$.fragment),Ad=d(),Es=a("p"),zd=r("Examples:"),Nd=d(),w(xo.$$.fragment),Vn=d(),Xe=a("h2"),gt=a("a"),ks=a("span"),w(Fo.$$.fragment),Ld=d(),Ms=a("span"),Dd=r("FlaxVitModel"),En=d(),q=a("div"),w(Vo.$$.fragment),Od=d(),Is=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),wa=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),Mt=s(ya,"A",{href:!0,rel:!0});var np=n(Mt);_r=i(np,"hub"),np.forEach(t),vr=i(ya,"."),ya.forEach(t),Tr=c(Y),Ce=s(Y,"LI",{});var $a=n(Ce);wr=i($a,"The available checkpoints are either (1) pre-trained on "),It=s($a,"A",{href:!0,rel:!0});var rp=n(It);br=i(rp,"ImageNet-21k"),rp.forEach(t),yr=i($a,` (a collection of
...
found `),Nt=s(Fa,"A",{href:!0,rel:!0});var kp=n(Nt);di=i(kp,"here"),kp.forEach(t),ci=i(Fa,"."),Fa.forEach(t),pn=c(o),et=s(o,"P",{});var qn=n(et);pi=i(qn,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=s(qn,"A",{href:!0,rel:!0});var Mp=n(Lt);hi=i(Mp,"timm library"),Mp.forEach(t),mi=i(qn,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),qn.forEach(t),hn=c(o),Ae=s(o,"H2",{class:!0});var An=n(Ae);tt=s(An,"A",{id:!0,class:!0,href:!0});var Ip=n(tt);Za=s(Ip,"SPAN",{});var jp=n(Za);b(Dt.$$.fragment,jp),jp.forEach(t),Ip.forEach(t),fi=c(An),Qa=s(An,"SPAN",{});var Pp=n(Qa);ui=i(Pp,"ViTConfig"),Pp.forEach(t),An.forEach(t),mn=c(o),U=s(o,"DIV",{class:!0});var ye=n(U);b(Ot.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Va=n(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=s(Va,"A",{href:!0});var Cp=n(da);vi=i(Cp,"ViTModel"),Cp.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kn.forEach(t),Vd=c(ce),b(ft.$$.fragment,ce),Ed=c(ce),X=s(ce,"DIV",{class:!0});var Ee=n(X);b($o.$$.fragment,Ee),kd=c(Ee),Ge=s(Ee,"P",{});var za=n(Ge);Md=i(za,"The "),Ta=s(za,"A",{href:!0});var kh=n(Ta);Id=i(kh,"TFViTForImageClassification"),kh.forEach(t),jd=i(za," forward method, overrides the "),Vs=s(za,"CODE",{});var Mh=n(Vs);Pd=i(Mh,"__call__"),Mh.forEach(t),Cd=i(za," special method."),za.forEach(t),qd=c(Ee),b(ut.$$.fragment,Ee),Ad=c(Ee),Es=s(Ee,"P",{});var Ih=n(Es);zd=i(Ih,"Examples:"),Ih.forEach(t),Nd=c(Ee),b(xo.$$.fragment,Ee),Ee.forEach(t),ce.forEach(t),Vn=c(o),Xe=s(o,"H2",{class:!0});var Gn=n(Xe);gt=s(Gn,"A",{id:!0,class:!0,href:!0});var jh=n(gt);ks=s(jh,"SPAN",{});var Ph=n(ks);b(Fo.$$.fragment,Ph),Ph.forEach(t),jh.forEach(t),Ld=c(Gn),Ms=s(Gn,"SPAN",{});var Ch=n(Ms);Dd=i(Ch,"FlaxVitModel"),Ch.forEach(t),Gn.forEach(t),En=c(o),q=s(o,"DIV",{class:!0});var ee=n(q);b(Vo.$$.fragment,ee),Od=c(ee),Is=s(ee,"P",{});var qh=n(Is);Sd=i(qh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),qh.forEach(t),Wd=c(ee),Eo=s(ee,"P",{});var Xn=n(Eo);Bd=i(Xn,"This model inherits from "),wa=s(Xn,"A",{href:!0});var Ah=n(wa);Ud=i(Ah,"FlaxPreTrainedModel"),Ah.forEach(t),Rd=i(Xn,`. Check the superclass documentation for the generic methods the
