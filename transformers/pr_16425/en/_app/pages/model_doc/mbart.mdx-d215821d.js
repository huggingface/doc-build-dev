...
`),xe=a(Qe,"CODE",{});var Kt=s(xe);Ye=i(Kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Kt.forEach(t),Qe.forEach(t),de.forEach(t)},m(w,B){h(w,b,B),e(b,z),h(w,v,B),h(w,M,B),e(M,x),e(x,T),e(M,y),e(M,F),e(F,rt),h(w,Ee,B),h(w,j,B),e(j,Ue),e(j,ke),e(ke,it),e(j,be),e(j,ye),e(ye,dt),e(j,Ke),h(w,J,B),h(w,N,B),e(N,Xe),h(w,se,B),h(w,E,B),e(E,O),e(O,lt),e(O,pe),e(pe,he),e(O,ct),e(O,K),e(K,pt),e(E,ht),e(E,D),e(D,Pe),e(D,ve),e(ve,Ze),e(D,re),e(D,Te),e(Te,we),e(E,ut),e(E,ie),e(ie,Me),e(ie,xe),e(xe,Ye)},d(w){w&&t(b),w&&t(v),w&&t(M),w&&t(Ee),w&&t(j),w&&t(J),w&&t(N),w&&t(se),w&&t(E)}}}function Hz(C){let b,z,v,M,x;return{c(){b=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var F=s(v);M=i(F,"Module"),F.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,M),e(b,x)},d(T){T&&t(b)}}}function Jz(C){let b,z,v,M,x,T,y,F,rt,Ee,j,Ue,ke,it,be,ye,dt,Ke,J,N,Xe,se,E,O,lt,pe,he,ct,K,pt,ht,D,Pe,ve,Ze,re,Te,we,ut,ie,Me,xe,Ye;return{c(){b=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=d(),M=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),F=n("li"),rt=r("having all inputs as a list, tuple or dict in the first positional arguments."),Ee=d(),j=n("p"),Ue=r("This second option is useful when using "),ke=n("code"),it=r("tf.keras.Model.fit"),be=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ye=n("code"),dt=r("model(inputs)"),Ke=r("."),J=d(),N=n("p"),Xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),se=d(),E=n("ul"),O=n("li"),lt=r("a single Tensor with "),pe=n("code"),he=r("input_ids"),ct=r(" only and nothing else: "),K=n("code"),pt=r("model(input_ids)"),ht=d(),D=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ve=n("code"),Ze=r("model([input_ids, attention_mask])"),re=r(" or "),Te=n("code"),we=r("model([input_ids, attention_mask, token_type_ids])"),ut=d(),ie=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),xe=n("code"),Ye=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){b=a(w,"P",{});var B=s(b);z=i(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),v=l(w),M=a(w,"UL",{});var ze=s(M);x=a(ze,"LI",{});var Ve=s(x);T=i(Ve,"having all inputs as keyword arguments (like PyTorch models), or"),Ve.forEach(t),y=l(ze),F=a(ze,"LI",{});var Ut=s(F);rt=i(Ut,"having all inputs as a list, tuple or dict in the first positional arguments."),Ut.forEach(t),ze.forEach(t),Ee=l(w),j=a(w,"P",{});var Z=s(j);Ue=i(Z,"This second option is useful when using "),ke=a(Z,"CODE",{});var Xt=s(ke);it=i(Xt,"tf.keras.Model.fit"),Xt.forEach(t),be=i(Z,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var F=s(v);M=i(F,"Module"),F.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,M),e(b,x)},d(T){T&&t(b)}}}function oq(C){let b,z,v,M,x,T,y,F,rt,Ee,j,Ue,ke,it,be,ye,dt,Ke,J,N,Xe,se,E,O,lt,pe,he,ct,K,pt,ht,D,Pe,ve,Ze,re,Te,we,ut,ie,Me,xe,Ye,w,B,ze,Ve,Ut,Z,Xt,bt,V,de,le,Vt,Qt,ce,Ht,Jt,Qe,Kt,Su,ld,Ou,Au,bp,yt,Iu,Pn,cd,Nu,Du,Lu,ti,Gu,Wu,yp,oi,pd,Ru,vp,Sn,Tp,ni,On,hd,Uu,Xu,Zt,Vu,ud,Qu,Hu,md,Ju,Ku,wp,An,Mp,Yt,So,fd,In,Zu,_d,Yu,xp,vt,em,Nn,tm,om,gd,nm,am,zp,ai,sm,qp,si,kd,rm,Fp,eo,Oo,bd,Dn,im,yd,dm,$p,et,lm,vd,cm,pm,Td,hm,um,wd,mm,fm,Bp,Ao,_m,ri,gm,km,jp,ii,Md,bm,Cp,Ln,Ep,di,Gn,xd,ym,vm,qe,Tm,zd,wm,Mm,qd,xm,zm,Fd,qm,Fm,$d,$m,Bm,Bd,jm,Cm,Pp,Wn,Sp,to,Io,jd,Rn,Em,Cd,Pm,Op,Fe,Un,Sm,oo,Om,li,Am,Im,Xn,Nm,Dm,Lm,no,Gm,ci,Wm,Rm,pi,Um,Xm,Vm,Ed,Qm,Hm,Vn,Ap,ao,No,Pd,Qn,Jm,Sd,Km,Ip,G,Hn,Zm,Od,Ym,ef,mt,tf,hi,of,nf,ui,af,sf,Jn,rf,df,lf,Kn,cf,Ad,pf,hf,uf,Id,mf,ff,Zn,_f,Do,Yn,gf,Nd,kf,bf,tt,ea,yf,ta,vf,Dd,Tf,wf,Mf,oa,na,Ld,xf,zf,Gd,qf,Ff,aa,Wd,$f,Bf,Rd,jf,Cf,Ud,Ef,Np,so,Lo,Xd,sa,Pf,Vd,Sf,Dp,P,ra,Of,ro,Af,Qd,If,Nf,ia,Df,Lf,Gf,Tt,mi,Wf,Rf,fi,Uf,Xf,_i,Vf,Qf,Hf,da,Jf,Hd,Kf,Zf,Yf,Jd,e_,t_,la,o_,Se,ca,n_,Kd,a_,s_,pa,r_,Zd,i_,d_,l_,ha,ua,Yd,c_,p_,el,h_,u_,ma,tl,m_,f_,ol,__,g_,nl,k_,b_,Go,fa,y_,al,v_,T_,Wo,_a,w_,sl,M_,x_,Ro,ga,z_,rl,q_,Lp,io,Uo,il,ka,F_,dl,$_,Gp,S,ba,B_,ya,j_,va,C_,E_,P_,Ta,S_,gi,O_,A_,I_,ll,N_,D_,wa,L_,ot,Ma,G_,xa,W_,cl,R_,U_,X_,za,qa,pl,V_,Q_,hl,H_,J_,Fa,ul,K_,Z_,ml,Y_,eg,fl,tg,og,Xo,$a,ng,_l,ag,sg,Vo,Ba,rg,ja,ig,gl,dg,lg,cg,Qo,Ca,pg,kl,hg,ug,Ho,Ea,mg,bl,fg,Wp,lo,Jo,yl,Pa,_g,vl,gg,Rp,W,Sa,kg,co,bg,Tl,yg,vg,Oa,Tg,wg,Mg,Aa,xg,ki,zg,qg,Fg,wl,$g,Bg,Ia,jg,Oe,Na,Cg,Ml,Eg,Pg,Da,Sg,xl,Og,Ag,Ig,La,Ga,zl,Ng,Dg,ql,Lg,Gg,Wa,Fl,Wg,Rg,$l,Ug,Xg,Bl,Vg,Qg,Ko,Ra,Hg,jl,Jg,Kg,Zo,Ua,Zg,Cl,Yg,Up,po,Yo,El,Xa,ek,Pl,tk,Xp,He,Va,ok,Qa,nk,bi,ak,sk,rk,Ha,ik,Ja,dk,lk,ck,Ae,Ka,pk,ho,hk,yi,uk,mk,Sl,fk,_k,gk,en,kk,Ol,bk,yk,Za,Vp,uo,tn,Al,Ya,vk,Il,Tk,Qp,Je,es,wk,ts,Mk,vi,xk,zk,qk,os,Fk,ns,$k,Bk,jk,Y,as,Ck,mo,Ek,Ti,Pk,Sk,Nl,Ok,Ak,Ik,on,Nk,Dl,Dk,Lk,ss,Gk,Ll,Wk,Rk,rs,Hp,fo,nn,Gl,is,Uk,Wl,Xk,Jp,$e,ds,Vk,_o,Qk,Rl,Hk,Jk,Ul,Kk,Zk,Yk,ls,eb,wi,tb,ob,nb,cs,ab,ps,sb,rb,ib,ue,hs,db,go,lb,Mi,cb,pb,Xl,hb,ub,mb,an,fb,Vl,_b,gb,us,kb,ms,Kp,ko,sn,Ql,fs,bb,Hl,yb,Zp,Be,_s,vb,Jl,Tb,wb,gs,Mb,xi,xb,zb,qb,ks,Fb,bs,$b,Bb,jb,L,ys,Cb,bo,Eb,zi,Pb,Sb,Kl,Ob,Ab,Ib,rn,Nb,Zl,Db,Lb,vs,Gb,Ts,Wb,Yl,Rb,Ub,ws,Xb,Ms,Yp,yo,dn,ec,xs,Vb,tc,Qb,eh,vo,zs,Hb,wt,qs,Jb,oc,Kb,Zb,Fs,th,To,ln,nc,$s,Yb,ac,ey,oh,je,Bs,ty,js,oy,qi,ny,ay,sy,Cs,ry,Es,iy,dy,ly,cn,cy,Ie,Ps,py,wo,hy,Fi,uy,my,sc,fy,_y,gy,pn,ky,rc,by,yy,Ss,nh,Mo,hn,ic,Os,vy,dc,Ty,ah,Ce,As,wy,Is,My,$i,xy,zy,qy,Ns,Fy,Ds,$y,By,jy,un,Cy,ee,Ls,Ey,xo,Py,Bi,Sy,Oy,lc,Ay,Iy,Ny,mn,Dy,cc,Ly,Gy,Gs,Wy,pc,Ry,Uy,Ws,sh,zo,fn,hc,Rs,Xy,uc,Vy,rh,R,Us,Qy,Xs,Hy,ji,Jy,Ky,Zy,Vs,Yy,Qs,ev,tv,ov,mc,nv,av,ft,fc,Hs,sv,rv,_c,Js,iv,dv,gc,Ks,lv,cv,kc,Zs,pv,hv,Ne,Ys,uv,qo,mv,bc,fv,_v,yc,gv,kv,bv,_n,yv,vc,vv,Tv,er,wv,Mt,tr,Mv,Tc,xv,zv,or,qv,xt,nr,Fv,wc,$v,Bv,ar,ih,Fo,gn,Mc,sr,jv,xc,Cv,dh,U,rr,Ev,ir,Pv,Ci,Sv,Ov,Av,dr,Iv,lr,Nv,Dv,Lv,zc,Gv,Wv,_t,qc,cr,Rv,Uv,Fc,pr,Xv,Vv,$c,hr,Qv,Hv,Bc,ur,Jv,Kv,te,mr,Zv,$o,Yv,jc,eT,tT,Cc,oT,nT,aT,kn,sT,Ec,rT,iT,fr,dT,Pc,lT,cT,_r,pT,zt,gr,hT,Sc,uT,mT,kr,fT,qt,br,_T,Oc,gT,kT,yr,lh,Bo,bn,Ac,vr,bT,Ic,yT,ch,A,Tr,vT,Nc,TT,wT,wr,MT,Ei,xT,zT,qT,Mr,FT,xr,$T,BT,jT,Dc,CT,ET,gt,Lc,zr,PT,ST,Gc,qr,OT,AT,Wc,Fr,IT,NT,Rc,$r,DT,LT,De,Br,GT,jo,WT,Uc,RT,UT,Xc,XT,VT,QT,yn,HT,Vc,JT,KT,jr,ZT,Ft,Cr,YT,Qc,e2,t2,Er,o2,$t,Pr,n2,Hc,a2,s2,Sr,ph,Co,vn,Jc,Or,r2,Kc,i2,hh,I,Ar,d2,Eo,l2,Zc,c2,p2,Yc,h2,u2,m2,Ir,f2,Pi,_2,g2,k2,Nr,b2,Dr,y2,v2,T2,ep,w2,M2,kt,tp,Lr,x2,z2,op,Gr,q2,F2,np,Wr,$2,B2,ap,Rr,j2,C2,Le,Ur,E2,Po,P2,sp,S2,O2,rp,A2,I2,N2,Tn,D2,ip,L2,G2,Xr,W2,Bt,Vr,R2,dp,U2,X2,Qr,V2,jt,Hr,Q2,lp,H2,J2,Jr,uh;return T=new X({}),se=new X({}),Ve=new X({}),Sn=new $({props:{code:`from transformers import MBartForConditionalGeneration, MBartTokenizer
...
target text format is `),Qe=n("code"),Kt=r("[tgt_lang_code] X [eos]"),Su=r(". "),ld=n("code"),Ou=r("bos"),Au=r(" is never used."),bp=d(),yt=n("p"),Iu=r("The regular "),Pn=n("a"),cd=n("strong"),Nu=r("call"),Du=r("()"),Lu=r(` will encode source text format, and it should be wrapped
inside the context manager `),ti=n("a"),Gu=r("as_target_tokenizer()"),Wu=r(" to encode target text format."),yp=d(),oi=n("ul"),pd=n("li"),Ru=r("Supervised training"),vp=d(),u(Sn.$$.fragment),Tp=d(),ni=n("ul"),On=n("li"),hd=n("p"),Uu=r("Generation"),Xu=d(),Zt=n("p"),Vu=r("While generating the target text set the "),ud=n("code"),Qu=r("decoder_start_token_id"),Hu=r(` to the target language id. The following
example shows how to translate English to Romanian using the `),md=n("em"),Ju=r("facebook/mbart-large-en-ro"),Ku=r(" model."),wp=d(),u(An.$$.fragment),Mp=d(),Yt=n("h2"),So=n("a"),fd=n("span"),u(In.$$.fragment),Zu=d(),_d=n("span"),Yu=r("Overview of MBart-50"),xp=d(),vt=n("p"),em=r("MBart-50 was introduced in the "),Nn=n("a"),tm=r("Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),om=r(` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
improving 9.3 BLEU on average over bilingual baselines from scratch.`),Fp=d(),eo=n("h3"),Oo=n("a"),bd=n("span"),u(Dn.$$.fragment),im=d(),yd=n("span"),dm=r("Training of MBart-50"),$p=d(),et=n("p"),lm=r(`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),Bp=d(),Ao=n("p"),_m=r("MBart-50 has its own tokenizer "),ri=n("a"),gm=r("MBart50Tokenizer"),km=r("."),jp=d(),ii=n("ul"),Md=n("li"),bm=r("Supervised training"),Cp=d(),u(Ln.$$.fragment),Ep=d(),di=n("ul"),Gn=n("li"),xd=n("p"),ym=r("Generation"),vm=d(),qe=n("p"),Tm=r("To generate using the mBART-50 multilingual translation models, "),zd=n("code"),wm=r("eos_token_id"),Mm=r(` is used as the
...
`),Bd=n("em"),jm=r("facebook/mbart-50-large-many-to-many"),Cm=r(" checkpoint."),Pp=d(),u(Wn.$$.fragment),Sp=d(),to=n("h2"),Io=n("a"),jd=n("span"),u(Rn.$$.fragment),Em=d(),Cd=n("span"),Pm=r("MBartConfig"),Op=d(),Fe=n("div"),u(Un.$$.fragment),Sm=d(),oo=n("p"),Om=r("This is the configuration class to store the configuration of a "),li=n("a"),Am=r("MBartModel"),Im=r(`. It is used to instantiate an MBART
...
documentation from `),pi=n("a"),Um=r("PretrainedConfig"),Xm=r(" for more information."),Vm=d(),Ed=n("p"),Qm=r("Example:"),Hm=d(),u(Vn.$$.fragment),Ap=d(),ao=n("h2"),No=n("a"),Pd=n("span"),u(Qn.$$.fragment),Jm=d(),Sd=n("span"),Km=r("MBartTokenizer"),Ip=d(),G=n("div"),u(Hn.$$.fragment),Zm=d(),Od=n("p"),Ym=r("Construct an MBART tokenizer."),ef=d(),mt=n("p"),tf=r("Adapted from "),hi=n("a"),of=r("RobertaTokenizer"),nf=r(" and "),ui=n("a"),af=r("XLNetTokenizer"),sf=r(`. Based on
`),Jn=n("a"),rf=r("SentencePiece"),df=r("."),lf=d(),Kn=n("p"),cf=r("The tokenization method is "),Ad=n("code"),pf=r("<tokens> <eos> <language code>"),hf=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),uf=d(),Id=n("p"),mf=r("Examples:"),ff=d(),u(Zn.$$.fragment),_f=d(),Do=n("div"),u(Yn.$$.fragment),gf=d(),Nd=n("p"),kf=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
separator.`),Np=d(),so=n("h2"),Lo=n("a"),Xd=n("span"),u(sa.$$.fragment),Pf=d(),Vd=n("span"),Sf=r("MBartTokenizerFast"),Dp=d(),P=n("div"),u(ra.$$.fragment),Of=d(),ro=n("p"),Af=r("Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Qd=n("em"),If=r("tokenizers"),Nf=r(` library). Based on
...
`),Oa=n("a"),Tg=r("BPE"),wg=r("."),Mg=d(),Aa=n("p"),xg=r("This tokenizer inherits from "),ki=n("a"),zg=r("PreTrainedTokenizerFast"),qg=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Fg=d(),wl=n("p"),$g=r("Examples:"),Bg=d(),u(Ia.$$.fragment),jg=d(),Oe=n("div"),u(Na.$$.fragment),Cg=d(),Ml=n("p"),Eg=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),Pg=d(),Da=n("p"),Sg=r("An MBART-50 sequence has the following format, where "),xl=n("code"),Og=r("X"),Ag=r(" represents the sequence:"),Ig=d(),La=n("ul"),Ga=n("li"),zl=n("code"),Ng=r("input_ids"),Dg=r(" (for encoder) "),ql=n("code"),Lg=r("[src_lang_code] X [eos]"),Gg=d(),Wa=n("li"),Fl=n("code"),Wg=r("labels"),Rg=r(": (for decoder) "),$l=n("code"),Ug=r("[tgt_lang_code] X [eos]"),Xg=d(),Bl=n("p"),Vg=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
and behavior.`),ck=d(),Ae=n("div"),u(Ka.$$.fragment),pk=d(),ho=n("p"),hk=r("The "),yi=n("a"),uk=r("MBartModel"),mk=r(" forward method, overrides the "),Sl=n("code"),fk=r("__call__"),_k=r(" special method."),gk=d(),u(en.$$.fragment),kk=d(),Ol=n("p"),bk=r("Example:"),yk=d(),u(Za.$$.fragment),Vp=d(),uo=n("h2"),tn=n("a"),Al=n("span"),u(Ya.$$.fragment),vk=d(),Il=n("span"),Tk=r("MBartForConditionalGeneration"),Qp=d(),Je=n("div"),u(es.$$.fragment),wk=d(),ts=n("p"),Mk=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jb=d(),L=n("div"),u(ys.$$.fragment),Cb=d(),bo=n("p"),Eb=r("The "),zi=n("a"),Pb=r("MBartForSequenceClassification"),Sb=r(" forward method, overrides the "),Kl=n("code"),Ob=r("__call__"),Ab=r(" special method."),Ib=d(),u(rn.$$.fragment),Nb=d(),Zl=n("p"),Db=r("Example of single-label classification:"),Lb=d(),u(vs.$$.fragment),Gb=d(),u(Ts.$$.fragment),Wb=d(),Yl=n("p"),Rb=r("Example of multi-label classification:"),Ub=d(),u(ws.$$.fragment),Xb=d(),u(Ms.$$.fragment),Yp=d(),yo=n("h2"),dn=n("a"),ec=n("span"),u(xs.$$.fragment),Vb=d(),tc=n("span"),Qb=r("MBartForCausalLM"),eh=d(),vo=n("div"),u(zs.$$.fragment),Hb=d(),wt=n("div"),u(qs.$$.fragment),Jb=d(),oc=n("p"),Kb=r("Example:"),Zb=d(),u(Fs.$$.fragment),th=d(),To=n("h2"),ln=n("a"),nc=n("span"),u($s.$$.fragment),Yb=d(),ac=n("span"),ey=r("TFMBartModel"),oh=d(),je=n("div"),u(Bs.$$.fragment),ty=d(),js=n("p"),oy=r(`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
behavior.`),ly=d(),u(cn.$$.fragment),cy=d(),Ie=n("div"),u(Ps.$$.fragment),py=d(),wo=n("p"),hy=r("The "),Fi=n("a"),uy=r("TFMBartModel"),my=r(" forward method, overrides the "),sc=n("code"),fy=r("__call__"),_y=r(" special method."),gy=d(),u(pn.$$.fragment),ky=d(),rc=n("p"),by=r("Example:"),yy=d(),u(Ss.$$.fragment),nh=d(),Mo=n("h2"),hn=n("a"),ic=n("span"),u(Os.$$.fragment),vy=d(),dc=n("span"),Ty=r("TFMBartForConditionalGeneration"),ah=d(),Ce=n("div"),u(As.$$.fragment),wy=d(),Is=n("p"),My=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
target text format is `),Qe=a(Ct,"CODE",{});var i1=s(Qe);Kt=i(i1,"[tgt_lang_code] X [eos]"),i1.forEach(t),Su=i(Ct,". "),ld=a(Ct,"CODE",{});var d1=s(ld);Ou=i(d1,"bos"),d1.forEach(t),Au=i(Ct," is never used."),Ct.forEach(t),bp=l(o),yt=a(o,"P",{});var Si=s(yt);Iu=i(Si,"The regular "),Pn=a(Si,"A",{href:!0});var K2=s(Pn);cd=a(K2,"STRONG",{});var l1=s(cd);Nu=i(l1,"call"),l1.forEach(t),Du=i(K2,"()"),K2.forEach(t),Lu=i(Si,` will encode source text format, and it should be wrapped
inside the context manager `),ti=a(Si,"A",{href:!0});var c1=s(ti);Gu=i(c1,"as_target_tokenizer()"),c1.forEach(t),Wu=i(Si," to encode target text format."),Si.forEach(t),yp=l(o),oi=a(o,"UL",{});var p1=s(oi);pd=a(p1,"LI",{});var h1=s(pd);Ru=i(h1,"Supervised training"),h1.forEach(t),p1.forEach(t),vp=l(o),m(Sn.$$.fragment,o),Tp=l(o),ni=a(o,"UL",{});var u1=s(ni);On=a(u1,"LI",{});var fh=s(On);hd=a(fh,"P",{});var m1=s(hd);Uu=i(m1,"Generation"),m1.forEach(t),Xu=l(fh),Zt=a(fh,"P",{});var Oi=s(Zt);Vu=i(Oi,"While generating the target text set the "),ud=a(Oi,"CODE",{});var f1=s(ud);Qu=i(f1,"decoder_start_token_id"),f1.forEach(t),Hu=i(Oi,` to the target language id. The following
example shows how to translate English to Romanian using the `),md=a(Oi,"EM",{});var _1=s(md);Ju=i(_1,"facebook/mbart-large-en-ro"),_1.forEach(t),Ku=i(Oi," model."),Oi.forEach(t),fh.forEach(t),u1.forEach(t),wp=l(o),m(An.$$.fragment,o),Mp=l(o),Yt=a(o,"H2",{class:!0});var _h=s(Yt);So=a(_h,"A",{id:!0,class:!0,href:!0});var g1=s(So);fd=a(g1,"SPAN",{});var k1=s(fd);m(In.$$.fragment,k1),k1.forEach(t),g1.forEach(t),Zu=l(_h),_d=a(_h,"SPAN",{});var b1=s(_d);Yu=i(b1,"Overview of MBart-50"),b1.forEach(t),_h.forEach(t),xp=l(o),vt=a(o,"P",{});var Ai=s(vt);em=i(Ai,"MBart-50 was introduced in the "),Nn=a(Ai,"A",{href:!0,rel:!0});var y1=s(Nn);tm=i(y1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),y1.forEach(t),om=i(Ai,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),gd=a(Ai,"EM",{});var v1=s(gd);nm=i(v1,"mbart-large-cc25"),v1.forEach(t),am=i(Ai,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Ai.forEach(t),zp=l(o),ai=a(o,"P",{});var T1=s(ai);sm=i(T1,"According to the abstract"),T1.forEach(t),qp=l(o),si=a(o,"P",{});var w1=s(si);kd=a(w1,"EM",{});var M1=s(kd);rm=i(M1,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),M1.forEach(t),w1.forEach(t),Fp=l(o),eo=a(o,"H3",{class:!0});var gh=s(eo);Oo=a(gh,"A",{id:!0,class:!0,href:!0});var x1=s(Oo);bd=a(x1,"SPAN",{});var z1=s(bd);m(Dn.$$.fragment,z1),z1.forEach(t),x1.forEach(t),im=l(gh),yd=a(gh,"SPAN",{});var q1=s(yd);dm=i(q1,"Training of MBart-50"),q1.forEach(t),gh.forEach(t),$p=l(o),et=a(o,"P",{});var Mn=s(et);lm=i(Mn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),Mn.forEach(t),Bp=l(o),Ao=a(o,"P",{});var kh=s(Ao);_m=i(kh,"MBart-50 has its own tokenizer "),ri=a(kh,"A",{href:!0});var j1=s(ri);gm=i(j1,"MBart50Tokenizer"),j1.forEach(t),km=i(kh,"."),kh.forEach(t),jp=l(o),ii=a(o,"UL",{});var C1=s(ii);Md=a(C1,"LI",{});var E1=s(Md);bm=i(E1,"Supervised training"),E1.forEach(t),C1.forEach(t),Cp=l(o),m(Ln.$$.fragment,o),Ep=l(o),di=a(o,"UL",{});var P1=s(di);Gn=a(P1,"LI",{});var bh=s(Gn);xd=a(bh,"P",{});var S1=s(xd);ym=i(S1,"Generation"),S1.forEach(t),vm=l(bh),qe=a(bh,"P",{});var nt=s(qe);Tm=i(nt,"To generate using the mBART-50 multilingual translation models, "),zd=a(nt,"CODE",{});var O1=s(zd);wm=i(O1,"eos_token_id"),O1.forEach(t),Mm=i(nt,` is used as the
`),qd=a(nt,"CODE",{});var A1=s(qd);xm=i(A1,"decoder_start_token_id"),A1.forEach(t),zm=i(nt,` and the target language id is forced as the first generated token. To force the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Bd=a(nt,"EM",{});var D1=s(Bd);jm=i(D1,"facebook/mbart-50-large-many-to-many"),D1.forEach(t),Cm=i(nt," checkpoint."),nt.forEach(t),bh.forEach(t),P1.forEach(t),Pp=l(o),m(Wn.$$.fragment,o),Sp=l(o),to=a(o,"H2",{class:!0});var yh=s(to);Io=a(yh,"A",{id:!0,class:!0,href:!0});var L1=s(Io);jd=a(L1,"SPAN",{});var G1=s(jd);m(Rn.$$.fragment,G1),G1.forEach(t),L1.forEach(t),Em=l(yh),Cd=a(yh,"SPAN",{});var W1=s(Cd);Pm=i(W1,"MBartConfig"),W1.forEach(t),yh.forEach(t),Op=l(o),Fe=a(o,"DIV",{class:!0});var Et=s(Fe);m(Un.$$.fragment,Et),Sm=l(Et),oo=a(Et,"P",{});var Ii=s(oo);Om=i(Ii,"This is the configuration class to store the configuration of a "),li=a(Ii,"A",{href:!0});var R1=s(li);Am=i(R1,"MBartModel"),R1.forEach(t),Im=i(Ii,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
...
documentation from `),pi=a(Ni,"A",{href:!0});var V1=s(pi);Um=i(V1,"PretrainedConfig"),V1.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Vm=l(Et),Ed=a(Et,"P",{});var Q1=s(Ed);Qm=i(Q1,"Example:"),Q1.forEach(t),Hm=l(Et),m(Vn.$$.fragment,Et),Et.forEach(t),Ap=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var H1=s(No);Pd=a(H1,"SPAN",{});var J1=s(Pd);m(Qn.$$.fragment,J1),J1.forEach(t),H1.forEach(t),Jm=l(vh),Sd=a(vh,"SPAN",{});var K1=s(Sd);Km=i(K1,"MBartTokenizer"),K1.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Hn.$$.fragment,me),Zm=l(me),Od=a(me,"P",{});var Z1=s(Od);Ym=i(Z1,"Construct an MBART tokenizer."),Z1.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Y1=s(hi);of=i(Y1,"RobertaTokenizer"),Y1.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var ew=s(ui);af=i(ew,"XLNetTokenizer"),ew.forEach(t),sf=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var tw=s(Jn);rf=i(tw,"SentencePiece"),tw.forEach(t),df=i(xn,"."),xn.forEach(t),lf=l(me),Kn=a(me,"P",{});var Th=s(Kn);cf=i(Th,"The tokenization method is "),Ad=a(Th,"CODE",{});var ow=s(Ad);pf=i(ow,"<tokens> <eos> <language code>"),ow.forEach(t),hf=i(Th," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Th.forEach(t),uf=l(me),Id=a(me,"P",{});var nw=s(Id);mf=i(nw,"Examples:"),nw.forEach(t),ff=l(me),m(Zn.$$.fragment,me),_f=l(me),Do=a(me,"DIV",{class:!0});var wh=s(Do);m(Yn.$$.fragment,wh),gf=l(wh),Nd=a(wh,"P",{});var aw=s(Nd);kf=i(aw,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
make use of token type ids, therefore a list of zeros is returned.`),Fw.forEach(t),Ph.forEach(t),T_=l(Q),Wo=a(Q,"DIV",{class:!0});var Sh=s(Wo);m(_a.$$.fragment,Sh),w_=l(Sh),sl=a(Sh,"P",{});var $w=s(sl);M_=i($w,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$w.forEach(t),Sh.forEach(t),x_=l(Q),Ro=a(Q,"DIV",{class:!0});var Oh=s(Ro);m(ga.$$.fragment,Oh),z_=l(Oh),rl=a(Oh,"P",{});var Bw=s(rl);q_=i(Bw,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),Bw.forEach(t),Oh.forEach(t),Q.forEach(t),Lp=l(o),io=a(o,"H2",{class:!0});var Ah=s(io);Uo=a(Ah,"A",{id:!0,class:!0,href:!0});var jw=s(Uo);il=a(jw,"SPAN",{});var Cw=s(il);m(ka.$$.fragment,Cw),Cw.forEach(t),jw.forEach(t),F_=l(Ah),dl=a(Ah,"SPAN",{});var Ew=s(dl);$_=i(Ew,"MBart50Tokenizer"),Ew.forEach(t),Ah.forEach(t),Gp=l(o),S=a(o,"DIV",{class:!0});var H=s(S);m(ba.$$.fragment,H),B_=l(H),ya=a(H,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var Pw=s(va);C_=i(Pw,"SentencePiece"),Pw.forEach(t),E_=i(Ih,"."),Ih.forEach(t),P_=l(H),Ta=a(H,"P",{});var Nh=s(Ta);S_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var Sw=s(gi);O_=i(Sw,"PreTrainedTokenizer"),Sw.forEach(t),A_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(H),ll=a(H,"P",{});var Ow=s(ll);N_=i(Ow,"Examples:"),Ow.forEach(t),D_=l(H),m(wa.$$.fragment,H),L_=l(H),ot=a(H,"DIV",{class:!0});var qn=s(ot);m(Ma.$$.fragment,qn),G_=l(qn),xa=a(qn,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=a(Dh,"CODE",{});var Aw=s(cl);R_=i(Aw,"X"),Aw.forEach(t),U_=i(Dh," represents the sequence:"),Dh.forEach(t),X_=l(qn),za=a(qn,"UL",{});var Lh=s(za);qa=a(Lh,"LI",{});var Gh=s(qa);pl=a(Gh,"CODE",{});var Iw=s(pl);V_=i(Iw,"input_ids"),Iw.forEach(t),Q_=i(Gh," (for encoder) "),hl=a(Gh,"CODE",{});var Nw=s(hl);H_=i(Nw,"[src_lang_code] X [eos]"),Nw.forEach(t),Gh.forEach(t),J_=l(Lh),Fa=a(Lh,"LI",{});var Wh=s(Fa);ul=a(Wh,"CODE",{});var Dw=s(ul);K_=i(Dw,"labels"),Dw.forEach(t),Z_=i(Wh,": (for decoder) "),ml=a(Wh,"CODE",{});var Lw=s(ml);Y_=i(Lw,"[tgt_lang_code] X [eos]"),Lw.forEach(t),Wh.forEach(t),Lh.forEach(t),eg=l(qn),fl=a(qn,"P",{});var Gw=s(fl);tg=i(Gw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
`),Oa=a(Li,"A",{href:!0,rel:!0});var Kw=s(Oa);Tg=i(Kw,"BPE"),Kw.forEach(t),wg=i(Li,"."),Li.forEach(t),Mg=l(fe),Aa=a(fe,"P",{});var Jh=s(Aa);xg=i(Jh,"This tokenizer inherits from "),ki=a(Jh,"A",{href:!0});var Zw=s(ki);zg=i(Zw,"PreTrainedTokenizerFast"),Zw.forEach(t),qg=i(Jh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Fg=l(fe),wl=a(fe,"P",{});var Yw=s(wl);$g=i(Yw,"Examples:"),Yw.forEach(t),Bg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Oe=a(fe,"DIV",{class:!0});var St=s(Oe);m(Na.$$.fragment,St),Cg=l(St),Ml=a(St,"P",{});var eM=s(Ml);Eg=i(eM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),eM.forEach(t),Pg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var tM=s(xl);Og=i(tM,"X"),tM.forEach(t),Ag=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var oM=s(zl);Ng=i(oM,"input_ids"),oM.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var nM=s(ql);Lg=i(nM,"[src_lang_code] X [eos]"),nM.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Fl=a(eu,"CODE",{});var aM=s(Fl);Wg=i(aM,"labels"),aM.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var sM=s($l);Ug=i(sM,"[tgt_lang_code] X [eos]"),sM.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Bl=a(St,"P",{});var rM=s(Bl);Vg=i(rM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Fn),Ae=a(Fn,"DIV",{class:!0});var Ot=s(Ae);m(Ka.$$.fragment,Ot),pk=l(Ot),ho=a(Ot,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var mM=s(yi);uk=i(mM,"MBartModel"),mM.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var fM=s(Sl);fk=i(fM,"__call__"),fM.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(Ot),m(en.$$.fragment,Ot),kk=l(Ot),Ol=a(Ot,"P",{});var _M=s(Ol);bk=i(_M,"Example:"),_M.forEach(t),yk=l(Ot),m(Za.$$.fragment,Ot),Ot.forEach(t),Fn.forEach(t),Vp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var gM=s(tn);Al=a(gM,"SPAN",{});var kM=s(Al);m(Ya.$$.fragment,kM),kM.forEach(t),gM.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var bM=s(Il);Tk=i(bM,"MBartForConditionalGeneration"),bM.forEach(t),ru.forEach(t),Qp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),wk=l($n),ts=a($n,"P",{});var iu=s(ts);Mk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ck=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Ek=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var TM=s(Ti);Pk=i(TM,"MBartForConditionalGeneration"),TM.forEach(t),Sk=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var wM=s(Nl);Ok=i(wM,"__call__"),wM.forEach(t),Ak=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var MM=s(Dl);Dk=i(MM,"Translation example:"),MM.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var xM=s(Ll);Wk=i(xM,"Mask filling example:"),xM.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Hp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var zM=s(nn);Gl=a(zM,"SPAN",{});var qM=s(Gl);m(is.$$.fragment,qM),qM.forEach(t),zM.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var FM=s(Wl);Xk=i(FM,"MBartForQuestionAnswering"),FM.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var At=s($e);m(ds.$$.fragment,At),Vk=l(At),_o=a(At,"P",{});var Ri=s(_o);Qk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $M=s(Rl);Hk=i($M,"span start logits"),$M.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var BM=s(Ul);Kk=i(BM,"span end logits"),BM.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(At),ls=a(At,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),wi=a(cu,"A",{href:!0});var jM=s(wi);tb=i(jM,"PreTrainedModel"),jM.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(At),cs=a(At,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var CM=s(ps);sb=i(CM,"torch.nn.Module"),CM.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(At),ue=a(At,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),Mi=a(Ui,"A",{href:!0});var EM=s(Mi);cb=i(EM,"MBartForQuestionAnswering"),EM.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var PM=s(Xl);hb=i(PM,"__call__"),PM.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Vl=a(at,"P",{});var SM=s(Vl);_b=i(SM,"Example:"),SM.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),At.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var OM=s(sn);Ql=a(OM,"SPAN",{});var AM=s(Ql);m(fs.$$.fragment,AM),AM.forEach(t),OM.forEach(t),bb=l(hu),Hl=a(hu,"SPAN",{});var IM=s(Hl);yb=i(IM,"MBartForSequenceClassification"),IM.forEach(t),hu.forEach(t),Zp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var NM=s(Jl);Tb=i(NM,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ju.forEach(t),jT=l(ne),Dc=a(ne,"P",{});var az=s(Dc);CT=i(az,"Finally, this model supports inherent JAX features such as:"),az.forEach(t),ET=l(ne),gt=a(ne,"UL",{});var Cn=s(gt);Lc=a(Cn,"LI",{});var sz=s(Lc);zr=a(sz,"A",{href:!0,rel:!0});var rz=s(zr);PT=i(rz,"Just-In-Time (JIT) compilation"),rz.forEach(t),sz.forEach(t),ST=l(Cn),Gc=a(Cn,"LI",{});var iz=s(Gc);qr=a(iz,"A",{href:!0,rel:!0});var dz=s(qr);OT=i(dz,"Automatic Differentiation"),dz.forEach(t),iz.forEach(t),AT=l(Cn),Wc=a(Cn,"LI",{});var lz=s(Wc);Fr=a(lz,"A",{href:!0,rel:!0});var cz=s(Fr);IT=i(cz,"Vectorization"),cz.forEach(t),lz.forEach(t),NT=l(Cn),Rc=a(Cn,"LI",{});var pz=s(Rc);$r=a(pz,"A",{href:!0,rel:!0});var hz=s($r);DT=i(hz,"Parallelization"),hz.forEach(t),pz.forEach(t),Cn.forEach(t),LT=l(ne),De=a(ne,"DIV",{class:!0});var Wt=s(De);m(Br.$$.fragment,Wt),GT=l(Wt),jo=a(Wt,"P",{});var od=s(jo);WT=i(od,"The "),Uc=a(od,"CODE",{});var uz=s(Uc);RT=i(uz,"FlaxMBartPreTrainedModel"),uz.forEach(t),UT=i(od,"forward method, overrides the "),Xc=a(od,"CODE",{});var mz=s(Xc);XT=i(mz,"__call__"),mz.forEach(t),VT=i(od," special method."),od.forEach(t),QT=l(Wt),m(yn.$$.fragment,Wt),HT=l(Wt),Vc=a(Wt,"P",{});var fz=s(Vc);JT=i(fz,"Example:"),fz.forEach(t),KT=l(Wt),m(jr.$$.fragment,Wt),Wt.forEach(t),ZT=l(ne),Ft=a(ne,"DIV",{class:!0});var nd=s(Ft);m(Cr.$$.fragment,nd),YT=l(nd),Qc=a(nd,"P",{});var _z=s(Qc);e2=i(_z,"Example:"),_z.forEach(t),t2=l(nd),m(Er.$$.fragment,nd),nd.forEach(t),o2=l(ne),$t=a(ne,"DIV",{class:!0});var ad=s($t);m(Pr.$$.fragment,ad),n2=l(ad),Hc=a(ad,"P",{});var gz=s(Hc);a2=i(gz,"Example:"),gz.forEach(t),s2=l(ad),m(Sr.$$.fragment,ad),ad.forEach(t),ne.forEach(t),ph=l(o),Co=a(o,"H2",{class:!0});var Cu=s(Co);vn=a(Cu,"A",{id:!0,class:!0,href:!0});var kz=s(vn);Jc=a(kz,"SPAN",{});var bz=s(Jc);m(Or.$$.fragment,bz),bz.forEach(t),kz.forEach(t),r2=l(Cu),Kc=a(Cu,"SPAN",{});var yz=s(Kc);i2=i(yz,"FlaxMBartForQuestionAnswering"),yz.forEach(t),Cu.forEach(t),hh=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);m(Ar.$$.fragment,ae),d2=l(ae),Eo=a(ae,"P",{});var sd=s(Eo);l2=i(sd,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
