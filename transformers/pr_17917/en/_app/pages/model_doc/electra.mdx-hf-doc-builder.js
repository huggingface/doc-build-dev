...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L805"}}),Ka=new we({}),Ja=new I({props:{name:"class transformers.ElectraModel",anchor:"transformers.ElectraModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17917/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L810"}}),Za=new I({props:{name:"forward",anchor:"transformers.ElectraModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.ElectraModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L837",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17917/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L894"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17917/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L1043"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17917/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L1526"}}),rl=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForCausalLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17917/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L980"}}),_l=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17917/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L1353"}}),nd=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17917/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17917/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17917/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17917/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17917/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yk=c(),xt=n("div"),b(hr.$$.fragment),Zk=c(),Co=n("p"),e1=r("The "),Ad=n("a"),t1=r("ElectraForCausalLM"),o1=r(" forward method, overrides the "),ip=n("code"),n1=r("__call__"),s1=r(" special method."),a1=c(),b(Nn.$$.fragment),r1=c(),b(In.$$.fragment),Su=c(),qo=n("h2"),Dn=n("a"),lp=n("span"),b(mr.$$.fragment),i1=c(),dp=n("span"),l1=r("ElectraForMaskedLM"),Wu=c(),Qe=n("div"),b(ur.$$.fragment),d1=c(),cp=n("p"),c1=r("Electra model with a language modeling head on top."),p1=c(),pp=n("p"),h1=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),b1=c(),at=n("div"),b(kr.$$.fragment),y1=c(),Po=n("p"),E1=r("The "),Ld=n("a"),w1=r("ElectraForMaskedLM"),$1=r(" forward method, overrides the "),hp=n("code"),F1=r("__call__"),x1=r(" special method."),M1=c(),b(Sn.$$.fragment),z1=c(),b(Wn.$$.fragment),j1=c(),b(Un.$$.fragment),Uu=c(),Ao=n("h2"),Bn=n("a"),mp=n("span"),b(vr.$$.fragment),C1=c(),up=n("span"),q1=r("ElectraForSequenceClassification"),Bu=c(),ot=n("div"),b(Tr.$$.fragment),P1=c(),fp=n("p"),A1=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),B1=c(),Re=n("div"),b(wr.$$.fragment),R1=c(),Oo=n("p"),H1=r("The "),Id=n("a"),Q1=r("ElectraForSequenceClassification"),V1=r(" forward method, overrides the "),gp=n("code"),K1=r("__call__"),J1=r(" special method."),G1=c(),b(Rn.$$.fragment),X1=c(),b(Hn.$$.fragment),Y1=c(),b(Qn.$$.fragment),Z1=c(),b(Vn.$$.fragment),ev=c(),b(Kn.$$.fragment),Ru=c(),Lo=n("h2"),Jn=n("a"),_p=n("span"),b($r.$$.fragment),tv=c(),kp=n("span"),ov=r("ElectraForMultipleChoice"),Hu=c(),nt=n("div"),b(Fr.$$.fragment),nv=c(),vp=n("p"),sv=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mv=c(),Mt=n("div"),b(jr.$$.fragment),uv=c(),No=n("p"),fv=r("The "),Sd=n("a"),gv=r("ElectraForMultipleChoice"),_v=r(" forward method, overrides the "),Tp=n("code"),kv=r("__call__"),vv=r(" special method."),Tv=c(),b(Gn.$$.fragment),bv=c(),b(Xn.$$.fragment),Qu=c(),Io=n("h2"),Yn=n("a"),bp=n("span"),b(Cr.$$.fragment),yv=c(),yp=n("span"),Ev=r("ElectraForTokenClassification"),Vu=c(),Ve=n("div"),b(qr.$$.fragment),wv=c(),Ep=n("p"),$v=r("Electra model with a token classification head on top."),Fv=c(),wp=n("p"),xv=r("Both the discriminator and generator may be loaded into this model."),Mv=c(),Pr=n("p"),zv=r("This model inherits from "),Wd=n("a"),jv=r("PreTrainedModel"),Cv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qv=c(),Ar=n("p"),Pv=r("This model is also a PyTorch "),Or=n("a"),Av=r("torch.nn.Module"),Ov=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lv=c(),rt=n("div"),b(Lr.$$.fragment),Nv=c(),Do=n("p"),Iv=r("The "),Ud=n("a"),Dv=r("ElectraForTokenClassification"),Sv=r(" forward method, overrides the "),$p=n("code"),Wv=r("__call__"),Uv=r(" special method."),Bv=c(),b(Zn.$$.fragment),Rv=c(),b(es.$$.fragment),Hv=c(),b(ts.$$.fragment),Ku=c(),So=n("h2"),os=n("a"),Fp=n("span"),b(Nr.$$.fragment),Qv=c(),xp=n("span"),Vv=r("ElectraForQuestionAnswering"),Ju=c(),st=n("div"),b(Ir.$$.fragment),Kv=c(),Wo=n("p"),Jv=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mp=n("code"),Gv=r("span start logits"),Xv=r(" and "),zp=n("code"),Yv=r("span end logits"),Zv=r(")."),eT=c(),Dr=n("p"),tT=r("This model inherits from "),Bd=n("a"),oT=r("PreTrainedModel"),nT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sT=c(),Sr=n("p"),aT=r("This model is also a PyTorch "),Wr=n("a"),rT=r("torch.nn.Module"),iT=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lT=c(),it=n("div"),b(Ur.$$.fragment),dT=c(),Uo=n("p"),cT=r("The "),Rd=n("a"),pT=r("ElectraForQuestionAnswering"),hT=r(" forward method, overrides the "),jp=n("code"),mT=r("__call__"),uT=r(" special method."),fT=c(),b(ns.$$.fragment),gT=c(),b(ss.$$.fragment),_T=c(),b(as.$$.fragment),Gu=c(),Bo=n("h2"),rs=n("a"),Cp=n("span"),b(Br.$$.fragment),kT=c(),qp=n("span"),vT=r("TFElectraModel"),Xu=c(),Ke=n("div"),b(Rr.$$.fragment),TT=c(),Pp=n("p"),bT=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),yT=c(),Hr=n("p"),ET=r("This model inherits from "),Hd=n("a"),wT=r("TFPreTrainedModel"),$T=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),FT=c(),Qr=n("p"),xT=r("This model is also a "),Vr=n("a"),MT=r("tf.keras.Model"),zT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jT=c(),b(is.$$.fragment),CT=c(),zt=n("div"),b(Kr.$$.fragment),qT=c(),Ro=n("p"),PT=r("The "),Qd=n("a"),AT=r("TFElectraModel"),OT=r(" forward method, overrides the "),Ap=n("code"),LT=r("__call__"),NT=r(" special method."),IT=c(),b(ls.$$.fragment),DT=c(),b(ds.$$.fragment),Yu=c(),Ho=n("h2"),cs=n("a"),Op=n("span"),b(Jr.$$.fragment),ST=c(),Lp=n("span"),WT=r("TFElectraForPreTraining"),Zu=c(),Oe=n("div"),b(Gr.$$.fragment),UT=c(),Np=n("p"),BT=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),RT=c(),Ip=n("p"),HT=r(`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eb=c(),b(ps.$$.fragment),tb=c(),jt=n("div"),b(ei.$$.fragment),ob=c(),Qo=n("p"),nb=r("The "),Kd=n("a"),sb=r("TFElectraForPreTraining"),ab=r(" forward method, overrides the "),Dp=n("code"),rb=r("__call__"),ib=r(" special method."),lb=c(),b(hs.$$.fragment),db=c(),b(ms.$$.fragment),ef=c(),Vo=n("h2"),us=n("a"),Sp=n("span"),b(ti.$$.fragment),cb=c(),Wp=n("span"),pb=r("TFElectraForMaskedLM"),tf=c(),Le=n("div"),b(oi.$$.fragment),hb=c(),Up=n("p"),mb=r("Electra model with a language modeling head on top."),ub=c(),Bp=n("p"),fb=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wb=c(),b(fs.$$.fragment),$b=c(),lt=n("div"),b(ri.$$.fragment),Fb=c(),Ko=n("p"),xb=r("The "),Gd=n("a"),Mb=r("TFElectraForMaskedLM"),zb=r(" forward method, overrides the "),Rp=n("code"),jb=r("__call__"),Cb=r(" special method."),qb=c(),b(gs.$$.fragment),Pb=c(),b(_s.$$.fragment),Ab=c(),b(ks.$$.fragment),of=c(),Jo=n("h2"),vs=n("a"),Hp=n("span"),b(ii.$$.fragment),Ob=c(),Qp=n("span"),Lb=r("TFElectraForSequenceClassification"),nf=c(),Je=n("div"),b(li.$$.fragment),Nb=c(),Vp=n("p"),Ib=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bb=c(),ci=n("p"),Rb=r("This model is also a "),pi=n("a"),Hb=r("tf.keras.Model"),Qb=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Df.forEach(t),Yk=p(lo),xt=s(lo,"DIV",{class:!0});var ha=a(xt);y(hr.$$.fragment,ha),Zk=p(ha),Co=s(ha,"P",{});var fc=a(Co);e1=i(fc,"The "),Ad=s(fc,"A",{href:!0});var N0=a(Ad);t1=i(N0,"ElectraForCausalLM"),N0.forEach(t),o1=i(fc," forward method, overrides the "),ip=s(fc,"CODE",{});var I0=a(ip);n1=i(I0,"__call__"),I0.forEach(t),s1=i(fc," special method."),fc.forEach(t),a1=p(ha),y(Nn.$$.fragment,ha),r1=p(ha),y(In.$$.fragment,ha),ha.forEach(t),lo.forEach(t),Su=p(o),qo=s(o,"H2",{class:!0});var Sf=a(qo);Dn=s(Sf,"A",{id:!0,class:!0,href:!0});var D0=a(Dn);lp=s(D0,"SPAN",{});var S0=a(lp);y(mr.$$.fragment,S0),S0.forEach(t),D0.forEach(t),i1=p(Sf),dp=s(Sf,"SPAN",{});var W0=a(dp);l1=i(W0,"ElectraForMaskedLM"),W0.forEach(t),Sf.forEach(t),Wu=p(o),Qe=s(o,"DIV",{class:!0});var Wt=a(Qe);y(ur.$$.fragment,Wt),d1=p(Wt),cp=s(Wt,"P",{});var U0=a(cp);c1=i(U0,"Electra model with a language modeling head on top."),U0.forEach(t),p1=p(Wt),pp=s(Wt,"P",{});var B0=a(pp);h1=i(B0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),B0.forEach(t),m1=p(Wt),fr=s(Wt,"P",{});var Wf=a(fr);u1=i(Wf,"This model inherits from "),Od=s(Wf,"A",{href:!0});var R0=a(Od);f1=i(R0,"PreTrainedModel"),R0.forEach(t),g1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_1=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);k1=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var H0=a(_r);v1=i(H0,"torch.nn.Module"),H0.forEach(t),T1=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),b1=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),y1=p(co),Po=s(co,"P",{});var gc=a(Po);E1=i(gc,"The "),Ld=s(gc,"A",{href:!0});var Q0=a(Ld);w1=i(Q0,"ElectraForMaskedLM"),Q0.forEach(t),$1=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V0=a(hp);F1=i(V0,"__call__"),V0.forEach(t),x1=i(gc," special method."),gc.forEach(t),M1=p(co),y(Sn.$$.fragment,co),z1=p(co),y(Wn.$$.fragment,co),j1=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Bf=a(Ao);Bn=s(Bf,"A",{id:!0,class:!0,href:!0});var K0=a(Bn);mp=s(K0,"SPAN",{});var J0=a(mp);y(vr.$$.fragment,J0),J0.forEach(t),K0.forEach(t),C1=p(Bf),up=s(Bf,"SPAN",{});var G0=a(up);q1=i(G0,"ElectraForSequenceClassification"),G0.forEach(t),Bf.forEach(t),Bu=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),P1=p(po),fp=s(po,"P",{});var X0=a(fp);A1=i(X0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X0.forEach(t),O1=p(po),br=s(po,"P",{});var Rf=a(br);L1=i(Rf,"This model inherits from "),Nd=s(Rf,"A",{href:!0});var Y0=a(Nd);N1=i(Y0,"PreTrainedModel"),Y0.forEach(t),I1=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),D1=p(po),yr=s(po,"P",{});var Hf=a(yr);S1=i(Hf,"This model is also a PyTorch "),Er=s(Hf,"A",{href:!0,rel:!0});var Z0=a(Er);W1=i(Z0,"torch.nn.Module"),Z0.forEach(t),U1=i(Hf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hf.forEach(t),B1=p(po),Re=s(po,"DIV",{class:!0});var ht=a(Re);y(wr.$$.fragment,ht),R1=p(ht),Oo=s(ht,"P",{});var _c=a(Oo);H1=i(_c,"The "),Id=s(_c,"A",{href:!0});var ex=a(Id);Q1=i(ex,"ElectraForSequenceClassification"),ex.forEach(t),V1=i(_c," forward method, overrides the "),gp=s(_c,"CODE",{});var tx=a(gp);K1=i(tx,"__call__"),tx.forEach(t),J1=i(_c," special method."),_c.forEach(t),G1=p(ht),y(Rn.$$.fragment,ht),X1=p(ht),y(Hn.$$.fragment,ht),Y1=p(ht),y(Qn.$$.fragment,ht),Z1=p(ht),y(Vn.$$.fragment,ht),ev=p(ht),y(Kn.$$.fragment,ht),ht.forEach(t),po.forEach(t),Ru=p(o),Lo=s(o,"H2",{class:!0});var Qf=a(Lo);Jn=s(Qf,"A",{id:!0,class:!0,href:!0});var ox=a(Jn);_p=s(ox,"SPAN",{});var nx=a(_p);y($r.$$.fragment,nx),nx.forEach(t),ox.forEach(t),tv=p(Qf),kp=s(Qf,"SPAN",{});var sx=a(kp);ov=i(sx,"ElectraForMultipleChoice"),sx.forEach(t),Qf.forEach(t),Hu=p(o),nt=s(o,"DIV",{class:!0});var ho=a(nt);y(Fr.$$.fragment,ho),nv=p(ho),vp=s(ho,"P",{});var ax=a(vp);sv=i(ax,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xf.forEach(t),Lv=p(Ut),rt=s(Ut,"DIV",{class:!0});var mo=a(rt);y(Lr.$$.fragment,mo),Nv=p(mo),Do=s(mo,"P",{});var vc=a(Do);Iv=i(vc,"The "),Ud=s(vc,"A",{href:!0});var _x=a(Ud);Dv=i(_x,"ElectraForTokenClassification"),_x.forEach(t),Sv=i(vc," forward method, overrides the "),$p=s(vc,"CODE",{});var kx=a($p);Wv=i(kx,"__call__"),kx.forEach(t),Uv=i(vc," special method."),vc.forEach(t),Bv=p(mo),y(Zn.$$.fragment,mo),Rv=p(mo),y(es.$$.fragment,mo),Hv=p(mo),y(ts.$$.fragment,mo),mo.forEach(t),Ut.forEach(t),Ku=p(o),So=s(o,"H2",{class:!0});var Yf=a(So);os=s(Yf,"A",{id:!0,class:!0,href:!0});var vx=a(os);Fp=s(vx,"SPAN",{});var Tx=a(Fp);y(Nr.$$.fragment,Tx),Tx.forEach(t),vx.forEach(t),Qv=p(Yf),xp=s(Yf,"SPAN",{});var bx=a(xp);Vv=i(bx,"ElectraForQuestionAnswering"),bx.forEach(t),Yf.forEach(t),Ju=p(o),st=s(o,"DIV",{class:!0});var uo=a(st);y(Ir.$$.fragment,uo),Kv=p(uo),Wo=s(uo,"P",{});var Tc=a(Wo);Jv=i(Tc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mp=s(Tc,"CODE",{});var yx=a(Mp);Gv=i(yx,"span start logits"),yx.forEach(t),Xv=i(Tc," and "),zp=s(Tc,"CODE",{});var Ex=a(zp);Yv=i(Ex,"span end logits"),Ex.forEach(t),Zv=i(Tc,")."),Tc.forEach(t),eT=p(uo),Dr=s(uo,"P",{});var Zf=a(Dr);tT=i(Zf,"This model inherits from "),Bd=s(Zf,"A",{href:!0});var wx=a(Bd);oT=i(wx,"PreTrainedModel"),wx.forEach(t),nT=i(Zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg.forEach(t),lT=p(uo),it=s(uo,"DIV",{class:!0});var fo=a(it);y(Ur.$$.fragment,fo),dT=p(fo),Uo=s(fo,"P",{});var bc=a(Uo);cT=i(bc,"The "),Rd=s(bc,"A",{href:!0});var Fx=a(Rd);pT=i(Fx,"ElectraForQuestionAnswering"),Fx.forEach(t),hT=i(bc," forward method, overrides the "),jp=s(bc,"CODE",{});var xx=a(jp);mT=i(xx,"__call__"),xx.forEach(t),uT=i(bc," special method."),bc.forEach(t),fT=p(fo),y(ns.$$.fragment,fo),gT=p(fo),y(ss.$$.fragment,fo),_T=p(fo),y(as.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Gu=p(o),Bo=s(o,"H2",{class:!0});var tg=a(Bo);rs=s(tg,"A",{id:!0,class:!0,href:!0});var Mx=a(rs);Cp=s(Mx,"SPAN",{});var zx=a(Cp);y(Br.$$.fragment,zx),zx.forEach(t),Mx.forEach(t),kT=p(tg),qp=s(tg,"SPAN",{});var jx=a(qp);vT=i(jx,"TFElectraModel"),jx.forEach(t),tg.forEach(t),Xu=p(o),Ke=s(o,"DIV",{class:!0});var Bt=a(Ke);y(Rr.$$.fragment,Bt),TT=p(Bt),Pp=s(Bt,"P",{});var Cx=a(Pp);bT=i(Cx,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),Cx.forEach(t),yT=p(Bt),Hr=s(Bt,"P",{});var og=a(Hr);ET=i(og,"This model inherits from "),Hd=s(og,"A",{href:!0});var qx=a(Hd);wT=i(qx,"TFPreTrainedModel"),qx.forEach(t),$T=i(og,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),og.forEach(t),FT=p(Bt),Qr=s(Bt,"P",{});var ng=a(Qr);xT=i(ng,"This model is also a "),Vr=s(ng,"A",{href:!0,rel:!0});var Px=a(Vr);MT=i(Px,"tf.keras.Model"),Px.forEach(t),zT=i(ng,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ng.forEach(t),jT=p(Bt),y(is.$$.fragment,Bt),CT=p(Bt),zt=s(Bt,"DIV",{class:!0});var ua=a(zt);y(Kr.$$.fragment,ua),qT=p(ua),Ro=s(ua,"P",{});var yc=a(Ro);PT=i(yc,"The "),Qd=s(yc,"A",{href:!0});var Ax=a(Qd);AT=i(Ax,"TFElectraModel"),Ax.forEach(t),OT=i(yc," forward method, overrides the "),Ap=s(yc,"CODE",{});var Ox=a(Ap);LT=i(Ox,"__call__"),Ox.forEach(t),NT=i(yc," special method."),yc.forEach(t),IT=p(ua),y(ls.$$.fragment,ua),DT=p(ua),y(ds.$$.fragment,ua),ua.forEach(t),Bt.forEach(t),Yu=p(o),Ho=s(o,"H2",{class:!0});var sg=a(Ho);cs=s(sg,"A",{id:!0,class:!0,href:!0});var Lx=a(cs);Op=s(Lx,"SPAN",{});var Nx=a(Op);y(Jr.$$.fragment,Nx),Nx.forEach(t),Lx.forEach(t),ST=p(sg),Lp=s(sg,"SPAN",{});var Ix=a(Lp);WT=i(Ix,"TFElectraForPreTraining"),Ix.forEach(t),sg.forEach(t),Zu=p(o),Oe=s(o,"DIV",{class:!0});var mt=a(Oe);y(Gr.$$.fragment,mt),UT=p(mt),Np=s(mt,"P",{});var Dx=a(Np);BT=i(Dx,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),Dx.forEach(t),RT=p(mt),Ip=s(mt,"P",{});var Sx=a(Ip);HT=i(Sx,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rg.forEach(t),eb=p(mt),y(ps.$$.fragment,mt),tb=p(mt),jt=s(mt,"DIV",{class:!0});var fa=a(jt);y(ei.$$.fragment,fa),ob=p(fa),Qo=s(fa,"P",{});var Ec=a(Qo);nb=i(Ec,"The "),Kd=s(Ec,"A",{href:!0});var Bx=a(Kd);sb=i(Bx,"TFElectraForPreTraining"),Bx.forEach(t),ab=i(Ec," forward method, overrides the "),Dp=s(Ec,"CODE",{});var Rx=a(Dp);rb=i(Rx,"__call__"),Rx.forEach(t),ib=i(Ec," special method."),Ec.forEach(t),lb=p(fa),y(hs.$$.fragment,fa),db=p(fa),y(ms.$$.fragment,fa),fa.forEach(t),mt.forEach(t),ef=p(o),Vo=s(o,"H2",{class:!0});var ig=a(Vo);us=s(ig,"A",{id:!0,class:!0,href:!0});var Hx=a(us);Sp=s(Hx,"SPAN",{});var Qx=a(Sp);y(ti.$$.fragment,Qx),Qx.forEach(t),Hx.forEach(t),cb=p(ig),Wp=s(ig,"SPAN",{});var Vx=a(Wp);pb=i(Vx,"TFElectraForMaskedLM"),Vx.forEach(t),ig.forEach(t),tf=p(o),Le=s(o,"DIV",{class:!0});var ut=a(Le);y(oi.$$.fragment,ut),hb=p(ut),Up=s(ut,"P",{});var Kx=a(Up);mb=i(Kx,"Electra model with a language modeling head on top."),Kx.forEach(t),ub=p(ut),Bp=s(ut,"P",{});var Jx=a(Bp);fb=i(Jx,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dg.forEach(t),wb=p(ut),y(fs.$$.fragment,ut),$b=p(ut),lt=s(ut,"DIV",{class:!0});var go=a(lt);y(ri.$$.fragment,go),Fb=p(go),Ko=s(go,"P",{});var wc=a(Ko);xb=i(wc,"The "),Gd=s(wc,"A",{href:!0});var Yx=a(Gd);Mb=i(Yx,"TFElectraForMaskedLM"),Yx.forEach(t),zb=i(wc," forward method, overrides the "),Rp=s(wc,"CODE",{});var Zx=a(Rp);jb=i(Zx,"__call__"),Zx.forEach(t),Cb=i(wc," special method."),wc.forEach(t),qb=p(go),y(gs.$$.fragment,go),Pb=p(go),y(_s.$$.fragment,go),Ab=p(go),y(ks.$$.fragment,go),go.forEach(t),ut.forEach(t),of=p(o),Jo=s(o,"H2",{class:!0});var cg=a(Jo);vs=s(cg,"A",{id:!0,class:!0,href:!0});var e7=a(vs);Hp=s(e7,"SPAN",{});var t7=a(Hp);y(ii.$$.fragment,t7),t7.forEach(t),e7.forEach(t),Ob=p(cg),Qp=s(cg,"SPAN",{});var o7=a(Qp);Lb=i(o7,"TFElectraForSequenceClassification"),o7.forEach(t),cg.forEach(t),nf=p(o),Je=s(o,"DIV",{class:!0});var Rt=a(Je);y(li.$$.fragment,Rt),Nb=p(Rt),Vp=s(Rt,"P",{});var n7=a(Vp);Ib=i(n7,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),n7.forEach(t),Db=p(Rt),di=s(Rt,"P",{});var pg=a(di);Sb=i(pg,"This model inherits from "),Xd=s(pg,"A",{href:!0});var s7=a(Xd);Wb=i(s7,"TFPreTrainedModel"),s7.forEach(t),Ub=i(pg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pg.forEach(t),Bb=p(Rt),ci=s(Rt,"P",{});var hg=a(ci);Rb=i(hg,"This model is also a "),pi=s(hg,"A",{href:!0,rel:!0});var a7=a(pi);Hb=i(a7,"tf.keras.Model"),a7.forEach(t),Qb=i(hg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg.forEach(t),Vb=p(Rt),y(Ts.$$.fragment,Rt),Kb=p(Rt),dt=s(Rt,"DIV",{class:!0});var _o=a(dt);y(hi.$$.fragment,_o),Jb=p(_o),Go=s(_o,"P",{});var $c=a(Go);Gb=i($c,"The "),Yd=s($c,"A",{href:!0});var r7=a(Yd);Xb=i(r7,"TFElectraForSequenceClassification"),r7.forEach(t),Yb=i($c," forward method, overrides the "),Kp=s($c,"CODE",{});var i7=a(Kp);Zb=i(i7,"__call__"),i7.forEach(t),ey=i($c," special method."),$c.forEach(t),ty=p(_o),y(bs.$$.fragment,_o),oy=p(_o),y(ys.$$.fragment,_o),ny=p(_o),y(Es.$$.fragment,_o),_o.forEach(t),Rt.forEach(t),sf=p(o),Xo=s(o,"H2",{class:!0});var mg=a(Xo);ws=s(mg,"A",{id:!0,class:!0,href:!0});var l7=a(ws);Jp=s(l7,"SPAN",{});var d7=a(Jp);y(mi.$$.fragment,d7),d7.forEach(t),l7.forEach(t),sy=p(mg),Gp=s(mg,"SPAN",{});var c7=a(Gp);ay=i(c7,"TFElectraForMultipleChoice"),c7.forEach(t),mg.forEach(t),af=p(o),Ge=s(o,"DIV",{class:!0});var Ht=a(Ge);y(ui.$$.fragment,Ht),ry=p(Ht),Xp=s(Ht,"P",{});var p7=a(Xp);iy=i(p7,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),p7.forEach(t),ly=p(Ht),fi=s(Ht,"P",{});var ug=a(fi);dy=i(ug,"This model inherits from "),Zd=s(ug,"A",{href:!0});var h7=a(Zd);cy=i(h7,"TFPreTrainedModel"),h7.forEach(t),py=i(ug,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ug.forEach(t),hy=p(Ht),gi=s(Ht,"P",{});var fg=a(gi);my=i(fg,"This model is also a "),_i=s(fg,"A",{href:!0,rel:!0});var m7=a(_i);uy=i(m7,"tf.keras.Model"),m7.forEach(t),fy=i(fg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),gy=p(Ht),y($s.$$.fragment,Ht),_y=p(Ht),Ct=s(Ht,"DIV",{class:!0});var ga=a(Ct);y(ki.$$.fragment,ga),ky=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);vy=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u7=a(ec);Ty=i(u7,"TFElectraForMultipleChoice"),u7.forEach(t),by=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f7=a(Yp);yy=i(f7,"__call__"),f7.forEach(t),Ey=i(Fc," special method."),Fc.forEach(t),wy=p(ga),y(Fs.$$.fragment,ga),$y=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Ht.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g7=a(Ms);Zp=s(g7,"SPAN",{});var _7=a(Zp);y(vi.$$.fragment,_7),_7.forEach(t),g7.forEach(t),Fy=p(gg),eh=s(gg,"SPAN",{});var k7=a(eh);xy=i(k7,"TFElectraForTokenClassification"),k7.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),My=p(ft),th=s(ft,"P",{});var v7=a(th);zy=i(v7,"Electra model with a token classification head on top."),v7.forEach(t),jy=p(ft),oh=s(ft,"P",{});var T7=a(oh);Cy=i(T7,"Both the discriminator and generator may be loaded into this model."),T7.forEach(t),qy=p(ft),bi=s(ft,"P",{});var _g=a(bi);Py=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b7=a(tc);Ay=i(b7,"TFPreTrainedModel"),b7.forEach(t),Oy=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_g.forEach(t),Ly=p(ft),yi=s(ft,"P",{});var kg=a(yi);Ny=i(kg,"This model is also a "),Ei=s(kg,"A",{href:!0,rel:!0});var y7=a(Ei);Iy=i(y7,"tf.keras.Model"),y7.forEach(t),Dy=i(kg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),Sy=p(ft),y(zs.$$.fragment,ft),Wy=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),Uy=p(ko),en=s(ko,"P",{});var xc=a(en);By=i(xc,"The "),oc=s(xc,"A",{href:!0});var E7=a(oc);Ry=i(E7,"TFElectraForTokenClassification"),E7.forEach(t),Hy=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w7=a(nh);Qy=i(w7,"__call__"),w7.forEach(t),Vy=i(xc," special method."),xc.forEach(t),Ky=p(ko),y(js.$$.fragment,ko),Jy=p(ko),y(Cs.$$.fragment,ko),Gy=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $7=a(Ps);sh=s($7,"SPAN",{});var F7=a(sh);y($i.$$.fragment,F7),F7.forEach(t),$7.forEach(t),Xy=p(vg),ah=s(vg,"SPAN",{});var x7=a(ah);Yy=i(x7,"TFElectraForQuestionAnswering"),x7.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Qt=a(Xe);y(Fi.$$.fragment,Qt),Zy=p(Qt),on=s(Qt,"P",{});var Mc=a(on);eE=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M7=a(rh);tE=i(M7,"span start logits"),M7.forEach(t),oE=i(Mc," and "),ih=s(Mc,"CODE",{});var z7=a(ih);nE=i(z7,"span end logits"),z7.forEach(t),sE=i(Mc,")."),Mc.forEach(t),aE=p(Qt),xi=s(Qt,"P",{});var Tg=a(xi);rE=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var j7=a(nc);iE=i(j7,"TFPreTrainedModel"),j7.forEach(t),lE=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dE=p(Qt),Mi=s(Qt,"P",{});var bg=a(Mi);cE=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var C7=a(zi);pE=i(C7,"tf.keras.Model"),C7.forEach(t),hE=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mE=p(Qt),y(As.$$.fragment,Qt),uE=p(Qt),pt=s(Qt,"DIV",{class:!0});var vo=a(pt);y(ji.$$.fragment,vo),fE=p(vo),nn=s(vo,"P",{});var zc=a(nn);gE=i(zc,"The "),sc=s(zc,"A",{href:!0});var q7=a(sc);_E=i(q7,"TFElectraForQuestionAnswering"),q7.forEach(t),kE=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P7=a(lh);vE=i(P7,"__call__"),P7.forEach(t),TE=i(zc," special method."),zc.forEach(t),bE=p(vo),y(Os.$$.fragment,vo),yE=p(vo),y(Ls.$$.fragment,vo),EE=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Qt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A7=a(Is);dh=s(A7,"SPAN",{});var O7=a(dh);y(Ci.$$.fragment,O7),O7.forEach(t),A7.forEach(t),wE=p(yg),ch=s(yg,"SPAN",{});var L7=a(ch);$E=i(L7,"FlaxElectraModel"),L7.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),FE=p(gt),ph=s(gt,"P",{});var N7=a(ph);xE=i(N7,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N7.forEach(t),ME=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zE=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I7=a(ac);jE=i(I7,"FlaxPreTrainedModel"),I7.forEach(t),CE=i(Eg,`. Check the superclass documentation for the generic methods the
...
`),Oi=s(wg,"A",{href:!0,rel:!0});var D7=a(Oi);AE=i(D7,"flax.nn.Module"),D7.forEach(t),OE=i(wg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wg.forEach(t),LE=p(gt),hh=s(gt,"P",{});var S7=a(hh);NE=i(S7,"Finally, this model supports inherent JAX features such as:"),S7.forEach(t),IE=p(gt),Kt=s(gt,"UL",{});var _a=a(Kt);mh=s(_a,"LI",{});var W7=a(mh);Li=s(W7,"A",{href:!0,rel:!0});var U7=a(Li);DE=i(U7,"Just-In-Time (JIT) compilation"),U7.forEach(t),W7.forEach(t),SE=p(_a),uh=s(_a,"LI",{});var B7=a(uh);Ni=s(B7,"A",{href:!0,rel:!0});var R7=a(Ni);WE=i(R7,"Automatic Differentiation"),R7.forEach(t),B7.forEach(t),UE=p(_a),fh=s(_a,"LI",{});var H7=a(fh);Ii=s(H7,"A",{href:!0,rel:!0});var Q7=a(Ii);BE=i(Q7,"Vectorization"),Q7.forEach(t),H7.forEach(t),RE=p(_a),gh=s(_a,"LI",{});var V7=a(gh);Di=s(V7,"A",{href:!0,rel:!0});var K7=a(Di);HE=i(K7,"Parallelization"),K7.forEach(t),V7.forEach(t),_a.forEach(t),QE=p(gt),qt=s(gt,"DIV",{class:!0});var ka=a(qt);y(Si.$$.fragment,ka),VE=p(ka),an=s(ka,"P",{});var jc=a(an);KE=i(jc,"The "),_h=s(jc,"CODE",{});var J7=a(_h);JE=i(J7,"FlaxElectraPreTrainedModel"),J7.forEach(t),GE=i(jc," forward method, overrides the "),kh=s(jc,"CODE",{});var G7=a(kh);XE=i(G7,"__call__"),G7.forEach(t),YE=i(jc," special method."),jc.forEach(t),ZE=p(ka),y(Ds.$$.fragment,ka),ew=p(ka),y(Ss.$$.fragment,ka),ka.forEach(t),gt.forEach(t),mf=p(o),rn=s(o,"H2",{class:!0});var $g=a(rn);Ws=s($g,"A",{id:!0,class:!0,href:!0});var X7=a(Ws);vh=s(X7,"SPAN",{});var Y7=a(vh);y(Wi.$$.fragment,Y7),Y7.forEach(t),X7.forEach(t),tw=p($g),Th=s($g,"SPAN",{});var Z7=a(Th);ow=i(Z7,"FlaxElectraForPreTraining"),Z7.forEach(t),$g.forEach(t),uf=p(o),Pe=s(o,"DIV",{class:!0});var Ye=a(Pe);y(Ui.$$.fragment,Ye),nw=p(Ye),bh=s(Ye,"P",{});var eM=a(bh);sw=i(eM,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),eM.forEach(t),aw=p(Ye),yh=s(Ye,"P",{});var tM=a(yh);rw=i(tM,"It is recommended to load the discriminator checkpoint into that model."),tM.forEach(t),iw=p(Ye),Bi=s(Ye,"P",{});var Fg=a(Bi);lw=i(Fg,"This model inherits from "),rc=s(Fg,"A",{href:!0});var oM=a(rc);dw=i(oM,"FlaxPreTrainedModel"),oM.forEach(t),cw=i(Fg,`. Check the superclass documentation for the generic methods the
...
`),tl=s(jg,"A",{href:!0,rel:!0});var TM=a(tl);Rw=i(TM,"flax.nn.Module"),TM.forEach(t),Hw=i(jg,` subclass. Use it as a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$$=p(kt),Bh=s(kt,"P",{});var IM=a(Bh);F$=i(IM,"Finally, this model supports inherent JAX features such as:"),IM.forEach(t),x$=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Rh=s(Ea,"LI",{});var DM=a(Rh);ml=s(DM,"A",{href:!0,rel:!0});var SM=a(ml);M$=i(SM,"Just-In-Time (JIT) compilation"),SM.forEach(t),DM.forEach(t),z$=p(Ea),Hh=s(Ea,"LI",{});var WM=a(Hh);ul=s(WM,"A",{href:!0,rel:!0});var UM=a(ul);j$=i(UM,"Automatic Differentiation"),UM.forEach(t),WM.forEach(t),C$=p(Ea),Qh=s(Ea,"LI",{});var BM=a(Qh);fl=s(BM,"A",{href:!0,rel:!0});var RM=a(fl);q$=i(RM,"Vectorization"),RM.forEach(t),BM.forEach(t),P$=p(Ea),Vh=s(Ea,"LI",{});var HM=a(Vh);gl=s(HM,"A",{href:!0,rel:!0});var QM=a(gl);A$=i(QM,"Parallelization"),QM.forEach(t),HM.forEach(t),Ea.forEach(t),O$=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L$=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N$=i(Pc,"The "),Kh=s(Pc,"CODE",{});var VM=a(Kh);I$=i(VM,"FlaxElectraPreTrainedModel"),VM.forEach(t),D$=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var KM=a(Jh);S$=i(KM,"__call__"),KM.forEach(t),W$=i(Pc," special method."),Pc.forEach(t),U$=p(wa),y(Ks.$$.fragment,wa),B$=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var JM=a(Gs);Gh=s(JM,"SPAN",{});var GM=a(Gh);y(kl.$$.fragment,GM),GM.forEach(t),JM.forEach(t),R$=p(Og),Xh=s(Og,"SPAN",{});var XM=a(Xh);H$=i(XM,"FlaxElectraForSequenceClassification"),XM.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q$=p(vt),Yh=s(vt,"P",{});var YM=a(Yh);V$=i(YM,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
`),Ul=s(Bg,"A",{href:!0,rel:!0});var Oz=a(Ul);cF=i(Oz,"flax.nn.Module"),Oz.forEach(t),pF=i(Bg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bg.forEach(t),hF=p(Ze),Tm=s(Ze,"P",{});var Lz=a(Tm);mF=i(Lz,"Finally, this model supports inherent JAX features such as:"),Lz.forEach(t),uF=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var Nz=a(bm);Bl=s(Nz,"A",{href:!0,rel:!0});var Iz=a(Bl);fF=i(Iz,"Just-In-Time (JIT) compilation"),Iz.forEach(t),Nz.forEach(t),gF=p(za),ym=s(za,"LI",{});var Dz=a(ym);Rl=s(Dz,"A",{href:!0,rel:!0});var Sz=a(Rl);_F=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Dz.forEach(t),kF=p(za),Em=s(za,"LI",{});var Wz=a(Em);Hl=s(Wz,"A",{href:!0,rel:!0});var Uz=a(Hl);vF=i(Uz,"Vectorization"),Uz.forEach(t),Wz.forEach(t),TF=p(za),wm=s(za,"LI",{});var Bz=a(wm);Ql=s(Bz,"A",{href:!0,rel:!0});var Rz=a(Ql);bF=i(Rz,"Parallelization"),Rz.forEach(t),Bz.forEach(t),za.forEach(t),yF=p(Ze),It=s(Ze,"DIV",{class:!0});var ja=a(It);y(Vl.$$.fragment,ja),EF=p(ja),kn=s(ja,"P",{});var Lc=a(kn);wF=i(Lc,"The "),$m=s(Lc,"CODE",{});var Hz=a($m);$F=i(Hz,"FlaxElectraPreTrainedModel"),Hz.forEach(t),FF=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var Qz=a(Fm);xF=i(Qz,"__call__"),Qz.forEach(t),MF=i(Lc," special method."),Lc.forEach(t),zF=p(ja),y(na.$$.fragment,ja),jF=p(ja),y(sa.$$.fragment,ja),ja.forEach(t),Ze.forEach(t),$f=p(o),vn=s(o,"H2",{class:!0});var Rg=a(vn);aa=s(Rg,"A",{id:!0,class:!0,href:!0});var Vz=a(aa);xm=s(Vz,"SPAN",{});var Kz=a(xm);y(Kl.$$.fragment,Kz),Kz.forEach(t),Vz.forEach(t),CF=p(Rg),Mm=s(Rg,"SPAN",{});var Jz=a(Mm);qF=i(Jz,"FlaxElectraForQuestionAnswering"),Jz.forEach(t),Rg.forEach(t),Ff=p(o),Be=s(o,"DIV",{class:!0});var bt=a(Be);y(Jl.$$.fragment,bt),PF=p(bt),Tn=s(bt,"P",{});var Nc=a(Tn);AF=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=s(Nc,"CODE",{});var Gz=a(zm);OF=i(Gz,"span start logits"),Gz.forEach(t),LF=i(Nc," and "),jm=s(Nc,"CODE",{});var Xz=a(jm);NF=i(Xz,"span end logits"),Xz.forEach(t),IF=i(Nc,")."),Nc.forEach(t),DF=p(bt),Gl=s(bt,"P",{});var Hg=a(Gl);SF=i(Hg,"This model inherits from "),hc=s(Hg,"A",{href:!0});var Yz=a(hc);WF=i(Yz,"FlaxPreTrainedModel"),Yz.forEach(t),UF=i(Hg,`. Check the superclass documentation for the generic methods the
