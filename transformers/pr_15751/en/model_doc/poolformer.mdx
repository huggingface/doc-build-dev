...
- One can use [PoolFormerFeatureExtractor](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor) to prepare images for the model.
...
This is the configuration class to store the configuration of [PoolFormerModel](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerModel). It is used to instantiate a
...
This feature extractor inherits from [FeatureExtractionMixin](/docs/transformers/pr_15751/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin) which contains most of the main methods. Users
...
<docstring><name>class transformers.PoolFormerModel</name><anchor>transformers.PoolFormerModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15751/src/transformers/models/poolformer/modeling_poolformer.py#L360</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([PoolFormerConfig](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerConfig)) -- Model configuration class with all the parameters of the model.
...
elements depending on the configuration ([PoolFormerConfig](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerConfig)) and inputs.
...
The [PoolFormerModel](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.PoolFormerForImageClassification</name><anchor>transformers.PoolFormerForImageClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15751/src/transformers/models/poolformer/modeling_poolformer.py#L423</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([PoolFormerConfig](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15751/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
The [PoolFormerForImageClassification](/docs/transformers/pr_15751/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) forward method, overrides the `__call__` special method.
