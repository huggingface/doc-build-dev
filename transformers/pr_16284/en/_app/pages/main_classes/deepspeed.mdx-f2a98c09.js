...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16284/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16284/src/transformers/deepspeed.py#L114"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16284/src/transformers/deepspeed.py#L105"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16284/src/transformers/deepspeed.py#L146"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16284/src/transformers/deepspeed.py#L137"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),ks=o("h2"),$t=o("a"),hf=o("span"),f(po.$$.fragment),T6=u(),ff=o("span"),A6=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),Ps=o("h3"),kt=o("a"),df=o("span"),f(io.$$.fragment),S6=u(),mf=o("span"),C6=a("Installation"),rg=u(),Xp=o("p"),x6=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R6=a("or via "),_f=o("code"),I6=a("transformers"),U6=a("\u2019 "),vf=o("code"),G6=a("extras"),L6=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M6=a("or find more details on "),ho=o("a"),Z6=a("the DeepSpeed\u2019s GitHub page"),N6=a(` and
...
`),bo=o("a"),x$=a("Deepspeed"),R$=a(","),Cg=u(),li=o("a"),xg=u(),Ds=o("h3"),St=o("a"),Of=o("span"),f(Eo.$$.fragment),I$=u(),Tf=o("span"),U$=a("Deployment with multiple GPUs"),Rg=u(),Ct=o("p"),G$=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L$=a("Trainer"),M$=a(` command line arguments as
following:`),Ig=u(),xt=o("ol"),zs=o("li"),Z$=a("replace "),Af=o("code"),N$=a("python -m torch.distributed.launch"),H$=a(" with "),Sf=o("code"),B$=a("deepspeed"),W$=a("."),F$=u(),De=o("li"),V$=a("add a new argument "),Cf=o("code"),Y$=a("--deepspeed ds_config.json"),K$=a(", where "),xf=o("code"),J$=a("ds_config.json"),X$=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q$=a("here"),e5=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s5=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t5=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a5=a("Unlike, "),Rf=o("code"),n5=a("torch.distributed.launch"),o5=a(" where you have to specify how many GPUs to use with "),If=o("code"),l5=a("--nproc_per_node"),r5=a(`, with the
