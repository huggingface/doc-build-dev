import{S as qi,i as xi,s as ji,e as a,k as i,w as u,t as n,L as $i,c as s,d as o,m as c,a as d,x as g,h as r,b as l,J as e,g as h,y as _,q as b,o as v,B as y}from"../../chunks/vendor-9e2b328e.js";import{T as dd}from"../../chunks/Tip-76f97a76.js";import{D as O}from"../../chunks/Docstring-50fd6873.js";import{C as Me}from"../../chunks/CodeBlock-88e23343.js";import{I as Rt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Pi(Q){let m,q,f,w,P;return{c(){m=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);q=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,q),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ai(Q){let m,q,f,w,P,k,T,F,zn,Gt,me,Mn,wo,qn,xn,Ut,he,jn,qe,$n,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,xe,Ln,Bn,Jt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Yt,je,Zt,G,Vn,$e,Hn,Jn,Pe,Yn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,qo,sr,dr,xo,ir,cr,lr,tt,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,jo,gr,_r,br,be,Ie,vr,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,ve,at,Le,Dr,st,zr,en,E,Be,Mr,ne,qr,dt,xr,jr,it,$r,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,$o,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Jr,Yr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,mt,aa,sa,da,ye,ia,ht,ca,la,He,pa,A,Je,ma,ft,ha,fa,ae,ua,ut,ga,_a,gt,ba,va,ya,_t,ka,Ta,Ye,on,se,ke,bt,Ze,wa,vt,Ea,tn,D,Ke,Da,de,za,yt,Ma,qa,kt,xa,ja,$a,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ja,Ya,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,ms,qt,hs,fs,so,nn,ce,we,xt,io,us,jt,gs,rn,z,co,_s,le,bs,$t,vs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,qs,xs,mo,js,No,$s,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Js,St,Ys,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Rt({}),je=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Fe=new Rt({}),Ce=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15805/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26",parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_15805/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_15805/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_15805/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15805/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
configuration. Check out the <a href="/docs/transformers/pr_15805/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ve=new O({props:{name:"forward",anchor:"transformers.EncoderDecoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15805/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",parametersDescription:[{anchor:"transformers.EncoderDecoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15805/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15805/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15805/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_15805/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_15805/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15805/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_15805/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15805/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Yt=i(),u(je.$$.fragment),Zt=i(),G=a("p"),Vn=n("This model was contributed by "),$e=a("a"),Hn=n("thomwolf"),Jn=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Pe=a("a"),Yn=n("ydshieh"),Zn=n("."),Kt=i(),X=a("h2"),ue=a("a"),et=a("span"),u(Fe.$$.fragment),Kn=i(),ot=a("span"),Qn=n("EncoderDecoderConfig"),Qt=i(),M=a("div"),u(Ce.$$.fragment),Xn=i(),ge=a("p"),zo=a("a"),er=n("EncoderDecoderConfig"),or=n(" is the configuration class to store the configuration of a "),Mo=a("a"),tr=n("EncoderDecoderModel"),nr=n(`. It is
...
:meth`),pt=a("em"),Qr=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xr=n(" class method for the decoder."),ea=i(),C=a("div"),u(Ve.$$.fragment),oa=i(),re=a("p"),ta=n("The "),Fo=a("a"),na=n("EncoderDecoderModel"),ra=n(" forward method, overrides the "),mt=a("code"),aa=n("__call__"),sa=n(" special method."),da=i(),u(ye.$$.fragment),ia=i(),ht=a("p"),ca=n("Examples:"),la=i(),u(He.$$.fragment),pa=i(),A=a("div"),u(Je.$$.fragment),ma=i(),ft=a("p"),ha=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),gt=a("code"),ba=n("model.train()"),va=n("."),ya=i(),_t=a("p"),ka=n("Example:"),Ta=i(),u(Ye.$$.fragment),on=i(),se=a("h2"),ke=a("a"),bt=a("span"),u(Ze.$$.fragment),wa=i(),vt=a("span"),Ea=n("TFEncoderDecoderModel"),tn=i(),D=a("div"),u(Ke.$$.fragment),Da=i(),de=a("p"),za=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
