...
<docstring><name>from\_pretrained</name><anchor>transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained</anchor><source>https://github.com/huggingface/transformers/blob/pr_15031/src/transformers/feature_extraction_utils.py#L224</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ": typing.Union[str, os.PathLike]"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  ...
  - a path to a *directory* containing a feature extractor file saved using the
    [save_pretrained()](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin.save_pretrained) method, e.g.,
    `./my_model_directory/`.
...
- **kwargs** (`Dict[str, Any]`, *optional*) --
  ...
  controlled by the `return_unused_kwargs` keyword parameter.</paramsdesc><paramgroups>0</paramgroups><retdesc>A feature extractor of type [FeatureExtractionMixin](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin).</retdesc></docstring>

Instantiate a type of [FeatureExtractionMixin](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin) from a feature extractor, *e.g.* a
derived class of [SequenceFeatureExtractor](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor).
...
[from_pretrained()](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained) class method.
...
<docstring><name>pad</name><anchor>transformers.SequenceFeatureExtractor.pad</anchor><source>https://github.com/huggingface/transformers/blob/pr_15031/src/transformers/feature_extraction_sequence_utils.py#L61</source><parameters>[{"name": "processed_features", "val": ": typing.Union[transformers.feature_extraction_utils.BatchFeature, typing.List[transformers.feature_extraction_utils.BatchFeature], typing.Dict[str, transformers.feature_extraction_utils.BatchFeature], typing.Dict[str, typing.List[transformers.feature_extraction_utils.BatchFeature]], typing.List[typing.Dict[str, transformers.feature_extraction_utils.BatchFeature]]]"}, {"name": "padding", "val": ": typing.Union[bool, str, transformers.file_utils.PaddingStrategy] = True"}, {"name": "max_length", "val": ": typing.Optional[int] = None"}, {"name": "truncation", "val": ": bool = False"}, {"name": "pad_to_multiple_of", "val": ": typing.Optional[int] = None"}, {"name": "return_attention_mask", "val": ": typing.Optional[bool] = None"}, {"name": "return_tensors", "val": ": typing.Union[str, transformers.file_utils.TensorType, NoneType] = None"}]</parameters><paramsdesc>- **processed_features** ([BatchFeature](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.BatchFeature), list of [BatchFeature](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.BatchFeature), `Dict[str, List[float]]`, `Dict[str, List[List[float]]` or `List[Dict[str, List[float]]]`) --
  Processed inputs. Can represent one input ([BatchFeature](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.BatchFeature) or `Dict[str, List[float]]`) or a batch of
  input values / vectors (list of [BatchFeature](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.BatchFeature), *Dict[str, List[List[float]]]* or *List[Dict[str,
  List[float]]]*) so you can use this method during preprocessing as well as in a PyTorch Dataloader
  collate function.

  Instead of `List[float]` you can have tensors (numpy arrays, PyTorch tensors or TensorFlow tensors),
  see the note above for the return type.
- **padding** (`bool`, `str` or [PaddingStrategy](/docs/transformers/pr_15031/en/internal/file_utils#transformers.file_utils.PaddingStrategy), *optional*, defaults to `True`) --
...
Holds the output of the [pad()](/docs/transformers/pr_15031/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor.pad) and feature extractor specific `__call__` methods.
...
<docstring><name>class transformers.ImageFeatureExtractionMixin</name><anchor>transformers.ImageFeatureExtractionMixin</anchor><source>https://github.com/huggingface/transformers/blob/pr_15031/src/transformers/image_utils.py#L76</source><parameters>[]</parameters></docstring>
