import{S as md,i as fd,s as gd,e as s,k as p,w as k,t as i,M as _d,c as n,d as o,m as h,a,x as T,h as l,b as c,G as e,g as _,y,q as w,o as $,B as V,v as vd,L as Gt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Po}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ke}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as G}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Kt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function bd(B){let d,b,g,m,v;return m=new Ke({props:{code:`from transformers import VisualBertModel, VisualBertConfig
...
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(u,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Ed(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){d=s("p"),b=i("Example:"),g=p(),k(m.$$.fragment)},l(r){d=n(r,"P",{});var u=a(d);b=l(u,"Example:"),u.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,u){_(r,d,u),e(d,b),_(r,g,u),y(m,r,u),v=!0},p:Gt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function Pd(B){let d,b,g,m,v,r,u,q,qn,Vs,J,me,Mo,Ge,zn,Ao,xn,Bs,fe,Fn,Je,En,Pn,qs,Jt,Mn,zs,Yt,jo,An,xs,Xt,jn,Fs,ge,Co,Ye,Cn,Zt,Ln,On,Rn,Lo,Oo,Nn,Es,Y,_e,Ro,Xe,In,No,Dn,Ps,eo,Sn,Ms,to,Wn,As,ve,Qn,oo,Hn,Un,js,be,Io,so,Ze,Kn,Gn,Jn,Do,no,et,Yn,Xn,Cs,ke,Zn,ao,ea,ta,Ls,tt,Os,D,oa,ot,sa,na,st,aa,ra,Rs,X,Te,So,nt,ia,Wo,la,Ns,A,at,da,Z,ca,ro,ua,pa,rt,ha,ma,fa,ee,ga,io,_a,va,lo,ba,ka,Ta,ye,Is,te,we,Qo,it,ya,Ho,wa,Ds,z,lt,$a,dt,Va,co,Ba,qa,za,ct,xa,ut,Fa,Ea,Pa,pt,Ma,ht,Aa,ja,Ca,C,mt,La,oe,Oa,uo,Ra,Na,Uo,Ia,Da,Sa,$e,Wa,Ve,Ss,se,Be,Ko,ft,Qa,Go,Ha,Ws,x,gt,Ua,ne,Ka,Jo,Ga,Ja,Yo,Ya,Xa,Za,_t,er,po,tr,or,sr,vt,nr,bt,ar,rr,ir,L,kt,lr,ae,dr,ho,cr,ur,Xo,pr,hr,mr,qe,fr,ze,Qs,re,xe,Zo,Tt,gr,es,_r,Hs,F,yt,vr,ts,br,kr,wt,Tr,mo,yr,wr,$r,$t,Vr,Vt,Br,qr,zr,O,Bt,xr,ie,Fr,fo,Er,Pr,os,Mr,Ar,jr,Fe,Cr,Ee,Us,le,Pe,ss,qt,Lr,ns,Or,Ks,E,zt,Rr,as,Nr,Ir,xt,Dr,go,Sr,Wr,Qr,Ft,Hr,Et,Ur,Kr,Gr,R,Pt,Jr,de,Yr,_o,Xr,Zr,rs,ei,ti,oi,Me,si,Ae,Gs,ce,je,is,Mt,ni,ls,ai,Js,P,At,ri,ds,ii,li,jt,di,vo,ci,ui,pi,Ct,hi,Lt,mi,fi,gi,N,Ot,_i,ue,vi,bo,bi,ki,cs,Ti,yi,wi,Ce,$i,Le,Ys,pe,Oe,us,Rt,Vi,ps,Bi,Xs,M,Nt,qi,hs,zi,xi,It,Fi,ko,Ei,Pi,Mi,Dt,Ai,St,ji,Ci,Li,I,Wt,Oi,he,Ri,To,Ni,Ii,ms,Di,Si,Wi,Re,Qi,Ne,Zs;return r=new G({}),Ge=new G({}),Xe=new G({}),tt=new Ke({props:{code:`import torch
from transformers import BertTokenizer, VisualBertModel
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17560/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>. Vocabulary size of the model. Defines the
different tokens that can be represented by the <code>inputs_ids</code> passed to the forward method of
<a href="/docs/transformers/pr_17560/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.VisualBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17560/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L716",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17560/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17560/en/model_doc/visual_bert#transformers.VisualBertConfig"
...
</ul>`,name:"sentence_image_labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L889",returnDescription:`
...
`}}),qe=new Po({props:{$$slots:{default:[yd]},$$scope:{ctx:B}}}),ze=new Kt({props:{anchor:"transformers.VisualBertForPreTraining.forward.example",$$slots:{default:[wd]},$$scope:{ctx:B}}}),Tt=new G({}),yt=new j({props:{name:"class transformers.VisualBertForQuestionAnswering",anchor:"transformers.VisualBertForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17560/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17560/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L1175"}}),Bt=new j({props:{name:"forward",anchor:"transformers.VisualBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17560/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17560/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17560/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Fe=new Po({props:{$$slots:{default:[$d]},$$scope:{ctx:B}}}),Ee=new Kt({props:{anchor:"transformers.VisualBertForQuestionAnswering.forward.example",$$slots:{default:[Vd]},$$scope:{ctx:B}}}),qt=new G({}),zt=new j({props:{name:"class transformers.VisualBertForMultipleChoice",anchor:"transformers.VisualBertForMultipleChoice",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17560/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17560/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L1022"}}),Pt=new j({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17560/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17560/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17560/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L1033",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/pr_17560/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ce=new Po({props:{$$slots:{default:[zd]},$$scope:{ctx:B}}}),Le=new Kt({props:{anchor:"transformers.VisualBertForVisualReasoning.forward.example",$$slots:{default:[xd]},$$scope:{ctx:B}}}),Rt=new G({}),Nt=new j({props:{name:"class transformers.VisualBertForRegionToPhraseAlignment",anchor:"transformers.VisualBertForRegionToPhraseAlignment",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17560/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17560/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L1461"}}),Wt=new j({props:{name:"forward",anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"region_to_phrase_position",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17560/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17560/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17560/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
outputs from the attention layer.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17560/src/transformers/models/visual_bert/modeling_visual_bert.py#L1473",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17560/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/pr_17560/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Po({props:{$$slots:{default:[Fd]},$$scope:{ctx:B}}}),Ne=new Kt({props:{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.example",$$slots:{default:[Ed]},$$scope:{ctx:B}}}),{c(){d=s("meta"),b=p(),g=s("h1"),m=s("a"),v=s("span"),k(r.$$.fragment),u=p(),q=s("span"),qn=i("VisualBERT"),Vs=p(),J=s("h2"),me=s("a"),Mo=s("span"),k(Ge.$$.fragment),zn=p(),Ao=s("span"),xn=i("Overview"),Bs=p(),fe=s("p"),Fn=i("The VisualBERT model was proposed in "),Je=s("a"),En=i("VisualBERT: A Simple and Performant Baseline for Vision and Language"),Pn=i(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
...
projects, and the states can be loaded directly into the detector provided.`),Es=p(),Y=s("h2"),_e=s("a"),Ro=s("span"),k(Xe.$$.fragment),In=p(),No=s("span"),Dn=i("Usage"),Ps=p(),eo=s("p"),Sn=i(`VisualBERT is a multi-modal vision and language model. It can be used for visual question answering, multiple choice,
...
etc.)`),za=p(),ct=s("p"),xa=i("This model is also a PyTorch "),ut=s("a"),Fa=i("torch.nn.Module"),Ea=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pa=p(),pt=s("p"),Ma=i("The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=s("a"),Aa=i(`Attention is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=p(),O=s("div"),k(Bt.$$.fragment),xr=p(),ie=s("p"),Fr=i("The "),fo=s("a"),Er=i("VisualBertForQuestionAnswering"),Pr=i(" forward method, overrides the "),os=s("code"),Mr=i("__call__"),Ar=i(" special method."),jr=p(),k(Fe.$$.fragment),Cr=p(),k(Ee.$$.fragment),Us=p(),le=s("h2"),Pe=s("a"),ss=s("span"),k(qt.$$.fragment),Lr=p(),ns=s("span"),Or=i("VisualBertForMultipleChoice"),Ks=p(),E=s("div"),k(zt.$$.fragment),Rr=p(),as=s("p"),Nr=i(`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr=p(),Ft=s("p"),Hr=i("This model is also a PyTorch "),Et=s("a"),Ur=i("torch.nn.Module"),Kr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr=p(),R=s("div"),k(Pt.$$.fragment),Jr=p(),de=s("p"),Yr=i("The "),_o=s("a"),Xr=i("VisualBertForMultipleChoice"),Zr=i(" forward method, overrides the "),rs=s("code"),ei=i("__call__"),ti=i(" special method."),oi=p(),k(Me.$$.fragment),si=p(),k(Ae.$$.fragment),Gs=p(),ce=s("h2"),je=s("a"),is=s("span"),k(Mt.$$.fragment),ni=p(),ls=s("span"),ai=i("VisualBertForVisualReasoning"),Js=p(),P=s("div"),k(At.$$.fragment),ri=p(),ds=s("p"),ii=i(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dn.forEach(o),za=h(S),ct=n(S,"P",{});var cn=a(ct);xa=l(cn,"This model is also a PyTorch "),ut=n(cn,"A",{href:!0,rel:!0});var wl=a(ut);Fa=l(wl,"torch.nn.Module"),wl.forEach(o),Ea=l(cn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cn.forEach(o),Pa=h(S),pt=n(S,"P",{});var un=a(pt);Ma=l(un,"The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=n(un,"A",{href:!0,rel:!0});var $l=a(ht);Aa=l($l,`Attention is
...
`),Yo=n(Bo,"CODE",{});var El=a(Yo);Ya=l(El,"sentence-image prediction (classification)"),El.forEach(o),Xa=l(Bo," head."),Bo.forEach(o),Za=h(W),_t=n(W,"P",{});var hn=a(_t);er=l(hn,"This model inherits from "),po=n(hn,"A",{href:!0});var Pl=a(po);tr=l(Pl,"PreTrainedModel"),Pl.forEach(o),or=l(hn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_n.forEach(o),zr=h(Q),O=n(Q,"DIV",{class:!0});var We=a(O);T(Bt.$$.fragment,We),xr=h(We),ie=n(We,"P",{});var zo=a(ie);Fr=l(zo,"The "),fo=n(zo,"A",{href:!0});var Dl=a(fo);Er=l(Dl,"VisualBertForQuestionAnswering"),Dl.forEach(o),Pr=l(zo," forward method, overrides the "),os=n(zo,"CODE",{});var Sl=a(os);Mr=l(Sl,"__call__"),Sl.forEach(o),Ar=l(zo," special method."),zo.forEach(o),jr=h(We),T(Fe.$$.fragment,We),Cr=h(We),T(Ee.$$.fragment,We),We.forEach(o),Q.forEach(o),Us=h(t),le=n(t,"H2",{class:!0});var vn=a(le);Pe=n(vn,"A",{id:!0,class:!0,href:!0});var Wl=a(Pe);ss=n(Wl,"SPAN",{});var Ql=a(ss);T(qt.$$.fragment,Ql),Ql.forEach(o),Wl.forEach(o),Lr=h(vn),ns=n(vn,"SPAN",{});var Hl=a(ns);Or=l(Hl,"VisualBertForMultipleChoice"),Hl.forEach(o),vn.forEach(o),Ks=h(t),E=n(t,"DIV",{class:!0});var H=a(E);T(zt.$$.fragment,H),Rr=h(H),as=n(H,"P",{});var Ul=a(as);Nr=l(Ul,`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bn.forEach(o),Qr=h(H),Ft=n(H,"P",{});var kn=a(Ft);Hr=l(kn,"This model is also a PyTorch "),Et=n(kn,"A",{href:!0,rel:!0});var Gl=a(Et);Ur=l(Gl,"torch.nn.Module"),Gl.forEach(o),Kr=l(kn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kn.forEach(o),Gr=h(H),R=n(H,"DIV",{class:!0});var Qe=a(R);T(Pt.$$.fragment,Qe),Jr=h(Qe),de=n(Qe,"P",{});var xo=a(de);Yr=l(xo,"The "),_o=n(xo,"A",{href:!0});var Jl=a(_o);Xr=l(Jl,"VisualBertForMultipleChoice"),Jl.forEach(o),Zr=l(xo," forward method, overrides the "),rs=n(xo,"CODE",{});var Yl=a(rs);ei=l(Yl,"__call__"),Yl.forEach(o),ti=l(xo," special method."),xo.forEach(o),oi=h(Qe),T(Me.$$.fragment,Qe),si=h(Qe),T(Ae.$$.fragment,Qe),Qe.forEach(o),H.forEach(o),Gs=h(t),ce=n(t,"H2",{class:!0});var Tn=a(ce);je=n(Tn,"A",{id:!0,class:!0,href:!0});var Xl=a(je);is=n(Xl,"SPAN",{});var Zl=a(is);T(Mt.$$.fragment,Zl),Zl.forEach(o),Xl.forEach(o),ni=h(Tn),ls=n(Tn,"SPAN",{});var ed=a(ls);ai=l(ed,"VisualBertForVisualReasoning"),ed.forEach(o),Tn.forEach(o),Js=h(t),P=n(t,"DIV",{class:!0});var U=a(P);T(At.$$.fragment,U),ri=h(U),ds=n(U,"P",{});var td=a(ds);ii=l(td,`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
e.g. for Flickr30 Entities task.`),dd.forEach(o),xi=h(K),It=n(K,"P",{});var Vn=a(It);Fi=l(Vn,"This model inherits from "),ko=n(Vn,"A",{href:!0});var cd=a(ko);Ei=l(cd,"PreTrainedModel"),cd.forEach(o),Pi=l(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
