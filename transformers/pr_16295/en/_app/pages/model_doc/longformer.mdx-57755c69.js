import{S as QT,i as HT,s as RT,e as r,k as l,w as k,t as n,Y as Oo,M as UT,c as a,d as t,m as d,a as i,x as v,h as s,Z as Po,b as c,F as e,g as h,y as b,q as T,o as y,B as L}from"../../chunks/vendor-6b77c823.js";import{T as Pe}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-abef54e3.js";import{C as at}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ze}from"../../chunks/IconCopyLink-7a11ce68.js";function VT(Q){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
...
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function ZT(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,P,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,re,K,R,ae,_e,j,ie,U,we;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),pe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),R=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
tensors in the first argument of the model call function: `),S=a(A,"CODE",{});var $e=i(S);pe=s($e,"model(inputs)"),$e.forEach(t),le=s(A,"."),A.forEach(t),G=d(m),P=a(m,"P",{});var Fe=i(P);te=s(Fe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Fe.forEach(t),X=d(m),z=a(m,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=a(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(O),q=a(O,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),U=a(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),O.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,P,F),e(P,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,R),e(R,ae),e(z,_e),e(z,j),e(j,ie),e(j,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(P),m&&t(X),m&&t(z)}}}function e1(Q){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function t1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,P,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,re,K,R,ae,_e,j,ie,U,we;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),pe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),R=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var Y=i(u);$=a(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=a(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=a(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=a(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=a(m,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=a(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(O),q=a(O,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(N,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=a(N,"CODE",{});var be=i(R);ae=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(O),j=a(O,"LI",{});var oe=i(j);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),O.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,P,F),e(P,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,R),e(R,ae),e(z,_e),e(z,j),e(j,ie),e(j,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(P),m&&t(X),m&&t(z)}}}function o1(Q){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function n1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,P,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,re,K,R,ae,_e,j,ie,U,we;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),pe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),R=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var Y=i(u);$=a(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=a(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=a(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=a(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=a(m,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=a(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(O),q=a(O,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(N,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=a(N,"CODE",{});var be=i(R);ae=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(O),j=a(O,"LI",{});var oe=i(j);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),O.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,P,F),e(P,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,R),e(R,ae),e(z,_e),e(z,j),e(j,ie),e(j,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(P),m&&t(X),m&&t(z)}}}function s1(Q){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function r1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,P,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,re,K,R,ae,_e,j,ie,U,we;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),pe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),R=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var Y=i(u);$=a(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=a(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=a(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=a(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=a(m,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=a(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(O),q=a(O,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(N,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=a(N,"CODE",{});var be=i(R);ae=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(O),j=a(O,"LI",{});var oe=i(j);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),O.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,P,F),e(P,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,R),e(R,ae),e(z,_e),e(z,j),e(j,ie),e(j,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(P),m&&t(X),m&&t(z)}}}function a1(Q){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function i1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,P,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,re,K,R,ae,_e,j,ie,U,we;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),pe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),R=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var Y=i(u);$=a(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=a(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=a(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=a(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=a(m,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=a(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(O),q=a(O,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(N,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=a(N,"CODE",{});var be=i(R);ae=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(O),j=a(O,"LI",{});var oe=i(j);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),O.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,P,F),e(P,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,R),e(R,ae),e(z,_e),e(z,j),e(j,ie),e(j,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(P),m&&t(X),m&&t(z)}}}function l1(Q){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function d1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,P,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,re,K,R,ae,_e,j,ie,U,we;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),pe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),R=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var Y=i(u);$=a(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=a(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=a(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=a(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),os=new B({props:{name:"forward",anchor:"transformers.LongformerModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_longformer.py#L1608",parametersDescription:[{anchor:"transformers.LongformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16295/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerConfig"
...
`}}),Uo=new Pe({props:{$$slots:{default:[VT]},$$scope:{ctx:Q}}}),ns=new at({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),cs=new B({props:{name:"forward",anchor:"transformers.LongformerForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_longformer.py#L1751",parametersDescription:[{anchor:"transformers.LongformerForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
`}}),Go=new Pe({props:{$$slots:{default:[GT]},$$scope:{ctx:Q}}}),hs=new at({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_s=new B({props:{name:"forward",anchor:"transformers.LongformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_longformer.py#L1852",parametersDescription:[{anchor:"transformers.LongformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
`}}),Jo=new Pe({props:{$$slots:{default:[KT]},$$scope:{ctx:Q}}}),ws=new at({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$s=new B({props:{name:"forward",anchor:"transformers.LongformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_longformer.py#L2199",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
`}}),Yo=new Pe({props:{$$slots:{default:[JT]},$$scope:{ctx:Q}}}),Fs=new at({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Cs=new B({props:{name:"forward",anchor:"transformers.LongformerForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_longformer.py#L2118",parametersDescription:[{anchor:"transformers.LongformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
`}}),en=new Pe({props:{$$slots:{default:[XT]},$$scope:{ctx:Q}}}),Os=new at({props:{code:`from transformers import LongformerTokenizer, LongformerForTokenClassification
import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ss=new B({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"start_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"end_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_longformer.py#L1978",parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
`}}),on=new Pe({props:{$$slots:{default:[YT]},$$scope:{ctx:Q}}}),Ds=new at({props:{code:`from transformers import LongformerTokenizer, LongformerForQuestionAnswering
import torch
...
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),sn=new Pe({props:{$$slots:{default:[ZT]},$$scope:{ctx:Q}}}),Gs=new B({props:{name:"call",anchor:"transformers.TFLongformerModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_tf_longformer.py#L2028",parametersDescription:[{anchor:"transformers.TFLongformerModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16295/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
behaviors between training and evaluation).`,name:"training"}]}}),rn=new Pe({props:{$$slots:{default:[e1]},$$scope:{ctx:Q}}}),Ks=new ze({}),Js=new B({props:{name:"class transformers.TFLongformerForMaskedLM",anchor:"transformers.TFLongformerForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_tf_longformer.py#L2094",parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ln=new Pe({props:{$$slots:{default:[t1]},$$scope:{ctx:Q}}}),tr=new B({props:{name:"call",anchor:"transformers.TFLongformerForMaskedLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_tf_longformer.py#L2111",parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
`}}),dn=new Pe({props:{$$slots:{default:[o1]},$$scope:{ctx:Q}}}),or=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new Pe({props:{$$slots:{default:[n1]},$$scope:{ctx:Q}}}),lr=new B({props:{name:"call",anchor:"transformers.TFLongformerForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_tf_longformer.py#L2220",parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
`}}),mn=new Pe({props:{$$slots:{default:[s1]},$$scope:{ctx:Q}}}),dr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),pn=new Pe({props:{$$slots:{default:[r1]},$$scope:{ctx:Q}}}),gr=new B({props:{name:"call",anchor:"transformers.TFLongformerForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_tf_longformer.py#L2389",parametersDescription:[{anchor:"transformers.TFLongformerForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
`}}),gn=new Pe({props:{$$slots:{default:[a1]},$$scope:{ctx:Q}}}),ur=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
`}}),wn=new Pe({props:{$$slots:{default:[l1]},$$scope:{ctx:Q}}}),yr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new Pe({props:{$$slots:{default:[d1]},$$scope:{ctx:Q}}}),Er=new B({props:{name:"call",anchor:"transformers.TFLongformerForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/longformer/modeling_tf_longformer.py#L2513",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16295/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
`}}),bn=new Pe({props:{$$slots:{default:[c1]},$$scope:{ctx:Q}}}),zr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
WikiHop and TriviaQA.`),ce=l(),q=r("p"),ue=n("Tips:"),W=l(),re=r("ul"),K=r("li"),R=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),ae=r("code"),_e=n("token_type_ids"),j=n(`. You don\u2019t need to indicate which
...
`),Ha=r("code"),qh=n("config.attention_window"),Ch=n(". Note that "),Ra=r("code"),Oh=n("config.attention_window"),Ph=n(" can be of type "),Ua=r("code"),jh=n("List"),Ah=n(` to define a
...
`),Ja=r("code"),Rh=n("global_attention_mask"),Uh=n(":"),md=l(),jo=r("ul"),Xa=r("li"),Vh=n("0: the token attends \u201Clocally\u201D,"),Gh=l(),Ya=r("li"),Kh=n("1: the token attends \u201Cglobally\u201D."),fd=l(),Ao=r("p"),Jh=n("For more information please also refer to "),Pr=r("a"),Xh=n("forward()"),Yh=n(" method."),pd=l(),Ve=r("p"),Zh=n(`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
...
\u201Clocally\u201D attending tokens.`),yd=l(),No=r("p"),em=n("For more information, please refer to the official "),Tn=r("a"),tm=n("paper"),om=n("."),Ld=l(),jt=r("h2"),Io=r("a"),Za=r("span"),k(yn.$$.fragment),nm=l(),ei=r("span"),sm=n("Training"),$d=l(),At=r("p"),jr=r("a"),rm=n("LongformerForMaskedLM"),am=n(" is trained the exact same way "),Ar=r("a"),im=n("RobertaForMaskedLM"),lm=n(` is
trained and should be used as follows:`),Fd=l(),k(Ln.$$.fragment),xd=l(),Nt=r("h2"),So=r("a"),ti=r("span"),k($n.$$.fragment),dm=l(),oi=r("span"),cm=n("LongformerConfig"),Md=l(),je=r("div"),k(Fn.$$.fragment),hm=l(),It=r("p"),mm=n("This is the configuration class to store the configuration of a "),Nr=r("a"),fm=n("LongformerModel"),pm=n(" or a "),Ir=r("a"),gm=n("TFLongformerModel"),um=n(`. It
...
parent class for more information.`),Em=l(),ni=r("p"),zm=n("Example:"),qm=l(),k(Mn.$$.fragment),Ed=l(),Bt=r("h2"),Do=r("a"),si=r("span"),k(En.$$.fragment),Cm=l(),ri=r("span"),Om=n("LongformerTokenizer"),zd=l(),ft=r("div"),k(zn.$$.fragment),Pm=l(),ai=r("p"),jm=n("Construct a Longformer tokenizer."),Am=l(),Bo=r("p"),Wr=r("a"),Nm=n("LongformerTokenizer"),Im=n(" is identical to "),Qr=r("a"),Sm=n("RobertaTokenizer"),Dm=n(`. Refer to the superclass for usage examples and
documentation concerning parameters.`),qd=l(),Wt=r("h2"),Wo=r("a"),ii=r("span"),k(qn.$$.fragment),Bm=l(),li=r("span"),Wm=n("LongformerTokenizerFast"),Cd=l(),pt=r("div"),k(Cn.$$.fragment),Qm=l(),On=r("p"),Hm=n("Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),di=r("em"),Rm=n("tokenizers"),Um=n(" library)."),Vm=l(),Qo=r("p"),Hr=r("a"),Gm=n("LongformerTokenizerFast"),Km=n(" is identical to "),Rr=r("a"),Jm=n("RobertaTokenizerFast"),Xm=n(`. Refer to the superclass for usage examples
and documentation concerning parameters.`),Od=l(),Qt=r("h2"),Ho=r("a"),ci=r("span"),k(Pn.$$.fragment),Ym=l(),hi=r("span"),Zm=n("Longformer specific outputs"),Pd=l(),Ht=r("div"),k(jn.$$.fragment),ef=l(),mi=r("p"),tf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),jd=l(),Rt=r("div"),k(An.$$.fragment),of=l(),fi=r("p"),nf=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Ad=l(),Ut=r("div"),k(Nn.$$.fragment),sf=l(),pi=r("p"),rf=n("Base class for masked language models outputs."),Nd=l(),Vt=r("div"),k(In.$$.fragment),af=l(),gi=r("p"),lf=n("Base class for outputs of question answering Longformer models."),Id=l(),Gt=r("div"),k(Sn.$$.fragment),df=l(),ui=r("p"),cf=n("Base class for outputs of sentence classification models."),Sd=l(),Kt=r("div"),k(Dn.$$.fragment),hf=l(),_i=r("p"),mf=n("Base class for outputs of multiple choice Longformer models."),Dd=l(),Jt=r("div"),k(Bn.$$.fragment),ff=l(),wi=r("p"),pf=n("Base class for outputs of token classification models."),Bd=l(),Xt=r("div"),k(Wn.$$.fragment),gf=l(),ki=r("p"),uf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Wd=l(),Yt=r("div"),k(Qn.$$.fragment),_f=l(),vi=r("p"),wf=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Qd=l(),Zt=r("div"),k(Hn.$$.fragment),kf=l(),bi=r("p"),vf=n("Base class for masked language models outputs."),Hd=l(),eo=r("div"),k(Rn.$$.fragment),bf=l(),Ti=r("p"),Tf=n("Base class for outputs of question answering Longformer models."),Rd=l(),to=r("div"),k(Un.$$.fragment),yf=l(),yi=r("p"),Lf=n("Base class for outputs of sentence classification models."),Ud=l(),oo=r("div"),k(Vn.$$.fragment),$f=l(),Li=r("p"),Ff=n("Base class for outputs of multiple choice models."),Vd=l(),no=r("div"),k(Gn.$$.fragment),xf=l(),$i=r("p"),Mf=n("Base class for outputs of token classification models."),Gd=l(),so=r("h2"),Ro=r("a"),Fi=r("span"),k(Kn.$$.fragment),Ef=l(),xi=r("span"),zf=n("LongformerModel"),Kd=l(),qe=r("div"),k(Jn.$$.fragment),qf=l(),Mi=r("p"),Cf=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Of=l(),Xn=r("p"),Pf=n("This model inherits from "),Ur=r("a"),jf=n("PreTrainedModel"),Af=n(`. Check the superclass documentation for the generic methods the
...
kernel to be memory and compute efficient.`),Xf=l(),Ge=r("div"),k(os.$$.fragment),Yf=l(),ao=r("p"),Zf=n("The "),Gr=r("a"),ep=n("LongformerModel"),tp=n(" forward method, overrides the "),zi=r("code"),op=n("__call__"),np=n(" special method."),sp=l(),k(Uo.$$.fragment),rp=l(),qi=r("p"),ap=n("Examples:"),ip=l(),k(ns.$$.fragment),Jd=l(),io=r("h2"),Vo=r("a"),Ci=r("span"),k(ss.$$.fragment),lp=l(),Oi=r("span"),dp=n("LongformerForMaskedLM"),Xd=l(),We=r("div"),k(rs.$$.fragment),cp=l(),as=r("p"),hp=n("Longformer Model with a "),Pi=r("code"),mp=n("language modeling"),fp=n(" head on top."),pp=l(),is=r("p"),gp=n("This model inherits from "),Kr=r("a"),up=n("PreTrainedModel"),_p=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp=l(),ls=r("p"),kp=n("This model is also a PyTorch "),ds=r("a"),vp=n("torch.nn.Module"),bp=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tp=l(),Ke=r("div"),k(cs.$$.fragment),yp=l(),lo=r("p"),Lp=n("The "),Jr=r("a"),$p=n("LongformerForMaskedLM"),Fp=n(" forward method, overrides the "),ji=r("code"),xp=n("__call__"),Mp=n(" special method."),Ep=l(),k(Go.$$.fragment),zp=l(),Ai=r("p"),qp=n("Examples:"),Cp=l(),k(hs.$$.fragment),Yd=l(),co=r("h2"),Ko=r("a"),Ni=r("span"),k(ms.$$.fragment),Op=l(),Ii=r("span"),Pp=n("LongformerForSequenceClassification"),Zd=l(),Qe=r("div"),k(fs.$$.fragment),jp=l(),Si=r("p"),Ap=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dg=l(),Xe=r("div"),k(Cs.$$.fragment),Bg=l(),go=r("p"),Wg=n("The "),oa=r("a"),Qg=n("LongformerForTokenClassification"),Hg=n(" forward method, overrides the "),Xi=r("code"),Rg=n("__call__"),Ug=n(" special method."),Vg=l(),k(en.$$.fragment),Gg=l(),Yi=r("p"),Kg=n("Example:"),Jg=l(),k(Os.$$.fragment),sc=l(),uo=r("h2"),tn=r("a"),Zi=r("span"),k(Ps.$$.fragment),Xg=l(),el=r("span"),Yg=n("LongformerForQuestionAnswering"),rc=l(),Ue=r("div"),k(js.$$.fragment),Zg=l(),_o=r("p"),eu=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu=l(),Hs=r("p"),Ou=n("This model is also a "),Rs=r("a"),Pu=n("tf.keras.Model"),ju=n(` subclass. Use it
...
TriviaQA (a linear layer on top of the hidden-states output to compute `),_l=r("code"),q_=n("span start logits"),C_=n(" and "),wl=r("code"),O_=n("span end logits"),P_=n(")."),j_=l(),rr=r("p"),A_=n("This model inherits from "),ca=r("a"),N_=n("TFPreTrainedModel"),I_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ow=l(),vr=r("p"),Pw=n("This model is also a "),br=r("a"),jw=n("tf.keras.Model"),Aw=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nw=l(),k(_n.$$.fragment),Iw=l(),ot=r("div"),k(Tr.$$.fragment),Sw=l(),zo=r("p"),Dw=n("The "),ga=r("a"),Bw=n("TFLongformerForTokenClassification"),Ww=n(" forward method, overrides the "),El=r("code"),Qw=n("__call__"),Hw=n(" special method."),Rw=l(),k(wn.$$.fragment),Uw=l(),zl=r("p"),Vw=n("Example:"),Gw=l(),k(yr.$$.fragment),uc=l(),qo=r("h2"),kn=r("a"),ql=r("span"),k(Lr.$$.fragment),Kw=l(),Cl=r("span"),Jw=n("TFLongformerForMultipleChoice"),_c=l(),De=r("div"),k($r.$$.fragment),Xw=l(),Ol=r("p"),Yw=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
`),m=a(gt,"CODE",{});var kk=i(m);F=s(kk,"</s>"),kk.forEach(t),Y=s(gt,")."),gt.forEach(t),Vl.forEach(t),Te=d(o),he=a(o,"P",{});var wa=i(he);A=s(wa,"This model was contributed by "),ve=a(wa,"A",{href:!0,rel:!0});var vk=i(ve);$e=s(vk,"beltagy"),vk.forEach(t),Fe=s(wa,". The Authors\u2019 code can be found "),O=a(wa,"A",{href:!0,rel:!0});var bk=i(O);V=s(bk,"here"),bk.forEach(t),xe=s(wa,"."),wa.forEach(t),ye=d(o),N=a(o,"H2",{class:!0});var kc=i(N);ke=a(kc,"A",{id:!0,class:!0,href:!0});var Tk=i(ke);be=a(Tk,"SPAN",{});var yk=i(be);v(oe.$$.fragment,yk),yk.forEach(t),Tk.forEach(t),Me=d(kc),Qa=a(kc,"SPAN",{});var Lk=i(Qa);Eh=s(Lk,"Longformer Self Attention"),Lk.forEach(t),kc.forEach(t),Zl=d(o),Le=a(o,"P",{});var Oe=i(Le);zh=s(Oe,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),Ha=a(Oe,"CODE",{});var $k=i(Ha);qh=s($k,"config.attention_window"),$k.forEach(t),Ch=s(Oe,". Note that "),Ra=a(Oe,"CODE",{});var Fk=i(Ra);Oh=s(Fk,"config.attention_window"),Fk.forEach(t),Ph=s(Oe," can be of type "),Ua=a(Oe,"CODE",{});var xk=i(Ua);jh=s(xk,"List"),xk.forEach(t),Ah=s(Oe,` to define a
different `),ad=Po(Oe),id=s(Oe,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),Va=a(Oe,"CODE",{});var Mk=i(Va);Nh=s(Mk,"BertSelfAttention"),Mk.forEach(t),Ih=s(Oe,"."),Oe.forEach(t),ld=d(o),ut=a(o,"P",{});var ka=i(ut);Sh=s(ka,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
...
`),Ja=a(va,"CODE",{});var qk=i(Ja);Rh=s(qk,"global_attention_mask"),qk.forEach(t),Uh=s(va,":"),va.forEach(t),md=d(o),jo=a(o,"UL",{});var vc=i(jo);Xa=a(vc,"LI",{});var Ck=i(Xa);Vh=s(Ck,"0: the token attends \u201Clocally\u201D,"),Ck.forEach(t),Gh=d(vc),Ya=a(vc,"LI",{});var Ok=i(Ya);Kh=s(Ok,"1: the token attends \u201Cglobally\u201D."),Ok.forEach(t),vc.forEach(t),fd=d(o),Ao=a(o,"P",{});var bc=i(Ao);Jh=s(bc,"For more information please also refer to "),Pr=a(bc,"A",{href:!0});var Pk=i(Pr);Xh=s(Pk,"forward()"),Pk.forEach(t),Yh=s(bc," method."),bc.forEach(t),pd=d(o),Ve=a(o,"P",{});var kt=i(Ve);Zh=s(kt,`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
...
to provide the ability to process long sequences following the self-attention approach described in `),es=a(Fa,"A",{href:!0,rel:!0});var Ov=i(es);Rf=s(Ov,`Longformer:
the Long-Document Transformer`),Ov.forEach(t),Uf=s(Fa,` by Iz Beltagy, Matthew E. Peters, and Arman Cohan.
Longformer self-attention combines a local (sliding window) and global attention to extend to long documents
without the O(n^2) increase in memory and compute.`),Fa.forEach(t),Vf=d(st),ts=a(st,"P",{});var Uc=i(ts);Gf=s(Uc,"The self-attention module "),Ei=a(Uc,"CODE",{});var Pv=i(Ei);Kf=s(Pv,"LongformerSelfAttention"),Pv.forEach(t),Jf=s(Uc,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Uc.forEach(t),Xf=d(st),Ge=a(st,"DIV",{class:!0});var vt=i(Ge);v(os.$$.fragment,vt),Yf=d(vt),ao=a(vt,"P",{});var xa=i(ao);Zf=s(xa,"The "),Gr=a(xa,"A",{href:!0});var jv=i(Gr);ep=s(jv,"LongformerModel"),jv.forEach(t),tp=s(xa," forward method, overrides the "),zi=a(xa,"CODE",{});var Av=i(zi);op=s(Av,"__call__"),Av.forEach(t),np=s(xa," special method."),xa.forEach(t),sp=d(vt),v(Uo.$$.fragment,vt),rp=d(vt),qi=a(vt,"P",{});var Nv=i(qi);ap=s(Nv,"Examples:"),Nv.forEach(t),ip=d(vt),v(ns.$$.fragment,vt),vt.forEach(t),st.forEach(t),Jd=d(o),io=a(o,"H2",{class:!0});var Vc=i(io);Vo=a(Vc,"A",{id:!0,class:!0,href:!0});var Iv=i(Vo);Ci=a(Iv,"SPAN",{});var Sv=i(Ci);v(ss.$$.fragment,Sv),Sv.forEach(t),Iv.forEach(t),lp=d(Vc),Oi=a(Vc,"SPAN",{});var Dv=i(Oi);dp=s(Dv,"LongformerForMaskedLM"),Dv.forEach(t),Vc.forEach(t),Xd=d(o),We=a(o,"DIV",{class:!0});var bt=i(We);v(rs.$$.fragment,bt),cp=d(bt),as=a(bt,"P",{});var Gc=i(as);hp=s(Gc,"Longformer Model with a "),Pi=a(Gc,"CODE",{});var Bv=i(Pi);mp=s(Bv,"language modeling"),Bv.forEach(t),fp=s(Gc," head on top."),Gc.forEach(t),pp=d(bt),is=a(bt,"P",{});var Kc=i(is);gp=s(Kc,"This model inherits from "),Kr=a(Kc,"A",{href:!0});var Wv=i(Kr);up=s(Wv,"PreTrainedModel"),Wv.forEach(t),_p=s(Kc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jc.forEach(t),Tp=d(bt),Ke=a(bt,"DIV",{class:!0});var Tt=i(Ke);v(cs.$$.fragment,Tt),yp=d(Tt),lo=a(Tt,"P",{});var Ma=i(lo);Lp=s(Ma,"The "),Jr=a(Ma,"A",{href:!0});var Hv=i(Jr);$p=s(Hv,"LongformerForMaskedLM"),Hv.forEach(t),Fp=s(Ma," forward method, overrides the "),ji=a(Ma,"CODE",{});var Rv=i(ji);xp=s(Rv,"__call__"),Rv.forEach(t),Mp=s(Ma," special method."),Ma.forEach(t),Ep=d(Tt),v(Go.$$.fragment,Tt),zp=d(Tt),Ai=a(Tt,"P",{});var Uv=i(Ai);qp=s(Uv,"Examples:"),Uv.forEach(t),Cp=d(Tt),v(hs.$$.fragment,Tt),Tt.forEach(t),bt.forEach(t),Yd=d(o),co=a(o,"H2",{class:!0});var Xc=i(co);Ko=a(Xc,"A",{id:!0,class:!0,href:!0});var Vv=i(Ko);Ni=a(Vv,"SPAN",{});var Gv=i(Ni);v(ms.$$.fragment,Gv),Gv.forEach(t),Vv.forEach(t),Op=d(Xc),Ii=a(Xc,"SPAN",{});var Kv=i(Ii);Pp=s(Kv,"LongformerForSequenceClassification"),Kv.forEach(t),Xc.forEach(t),Zd=d(o),Qe=a(o,"DIV",{class:!0});var yt=i(Qe);v(fs.$$.fragment,yt),jp=d(yt),Si=a(yt,"P",{});var Jv=i(Si);Ap=s(Jv,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
for Named-Entity-Recognition (NER) tasks.`),gb.forEach(t),Cg=d(Ft),Es=a(Ft,"P",{});var sh=i(Es);Og=s(sh,"This model inherits from "),ta=a(sh,"A",{href:!0});var ub=i(ta);Pg=s(ub,"PreTrainedModel"),ub.forEach(t),jg=s(sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rh.forEach(t),Dg=d(Ft),Xe=a(Ft,"DIV",{class:!0});var xt=i(Xe);v(Cs.$$.fragment,xt),Bg=d(xt),go=a(xt,"P",{});var qa=i(go);Wg=s(qa,"The "),oa=a(qa,"A",{href:!0});var wb=i(oa);Qg=s(wb,"LongformerForTokenClassification"),wb.forEach(t),Hg=s(qa," forward method, overrides the "),Xi=a(qa,"CODE",{});var kb=i(Xi);Rg=s(kb,"__call__"),kb.forEach(t),Ug=s(qa," special method."),qa.forEach(t),Vg=d(xt),v(en.$$.fragment,xt),Gg=d(xt),Yi=a(xt,"P",{});var vb=i(Yi);Kg=s(vb,"Example:"),vb.forEach(t),Jg=d(xt),v(Os.$$.fragment,xt),xt.forEach(t),Ft.forEach(t),sc=d(o),uo=a(o,"H2",{class:!0});var ah=i(uo);tn=a(ah,"A",{id:!0,class:!0,href:!0});var bb=i(tn);Zi=a(bb,"SPAN",{});var Tb=i(Zi);v(Ps.$$.fragment,Tb),Tb.forEach(t),bb.forEach(t),Xg=d(ah),el=a(ah,"SPAN",{});var yb=i(el);Yg=s(yb,"LongformerForQuestionAnswering"),yb.forEach(t),ah.forEach(t),rc=d(o),Ue=a(o,"DIV",{class:!0});var Mt=i(Ue);v(js.$$.fragment,Mt),Zg=d(Mt),_o=a(Mt,"P",{});var Ca=i(_o);eu=s(Ca,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lh.forEach(t),fu=d(Mt),Ye=a(Mt,"DIV",{class:!0});var Et=i(Ye);v(Ss.$$.fragment,Et),pu=d(Et),wo=a(Et,"P",{});var Oa=i(wo);gu=s(Oa,"The "),sa=a(Oa,"A",{href:!0});var Mb=i(sa);uu=s(Mb,"LongformerForQuestionAnswering"),Mb.forEach(t),_u=s(Oa," forward method, overrides the "),nl=a(Oa,"CODE",{});var Eb=i(nl);wu=s(Eb,"__call__"),Eb.forEach(t),ku=s(Oa," special method."),Oa.forEach(t),vu=d(Et),v(on.$$.fragment,Et),bu=d(Et),sl=a(Et,"P",{});var zb=i(sl);Tu=s(zb,"Examples:"),zb.forEach(t),yu=d(Et),v(Ds.$$.fragment,Et),Et.forEach(t),Mt.forEach(t),ac=d(o),ko=a(o,"H2",{class:!0});var dh=i(ko);nn=a(dh,"A",{id:!0,class:!0,href:!0});var qb=i(nn);rl=a(qb,"SPAN",{});var Cb=i(rl);v(Bs.$$.fragment,Cb),Cb.forEach(t),qb.forEach(t),Lu=d(dh),al=a(dh,"SPAN",{});var Ob=i(al);$u=s(Ob,"TFLongformerModel"),Ob.forEach(t),dh.forEach(t),ic=d(o),Ee=a(o,"DIV",{class:!0});var Be=i(Ee);v(Ws.$$.fragment,Be),Fu=d(Be),il=a(Be,"P",{});var Pb=i(il);xu=s(Pb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Pb.forEach(t),Mu=d(Be),Qs=a(Be,"P",{});var ch=i(Qs);Eu=s(ch,"This model inherits from "),ra=a(ch,"A",{href:!0});var jb=i(ra);zu=s(jb,"TFPreTrainedModel"),jb.forEach(t),qu=s(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ch.forEach(t),Cu=d(Be),Hs=a(Be,"P",{});var hh=i(Hs);Ou=s(hh,"This model is also a "),Rs=a(hh,"A",{href:!0,rel:!0});var Ab=i(Rs);Pu=s(Ab,"tf.keras.Model"),Ab.forEach(t),ju=s(hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hh.forEach(t),Au=d(Be),v(sn.$$.fragment,Be),Nu=d(Be),vo=a(Be,"P",{});var Pa=i(vo);Iu=s(Pa,"This class copies code from "),aa=a(Pa,"A",{href:!0});var Nb=i(aa);Su=s(Nb,"TFRobertaModel"),Nb.forEach(t),Du=s(Pa,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
`),Us=a(Pa,"A",{href:!0,rel:!0});var Ib=i(Us);Bu=s(Ib,"Longformer: the Long-Document Transformer"),Ib.forEach(t),Wu=s(Pa,` by Iz Beltagy, Matthew E. Peters, and
Arman Cohan. Longformer self-attention combines a local (sliding window) and global attention to extend to long
documents without the O(n^2) increase in memory and compute.`),Pa.forEach(t),Qu=d(Be),Vs=a(Be,"P",{});var mh=i(Vs);Hu=s(mh,"The self-attention module "),ll=a(mh,"CODE",{});var Sb=i(ll);Ru=s(Sb,"TFLongformerSelfAttention"),Sb.forEach(t),Uu=s(mh,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),mh.forEach(t),Vu=d(Be),wt=a(Be,"DIV",{class:!0});var ja=i(wt);v(Gs.$$.fragment,ja),Gu=d(ja),bo=a(ja,"P",{});var Aa=i(bo);Ku=s(Aa,"The "),ia=a(Aa,"A",{href:!0});var Db=i(ia);Ju=s(Db,"TFLongformerModel"),Db.forEach(t),Xu=s(Aa," forward method, overrides the "),dl=a(Aa,"CODE",{});var Bb=i(dl);Yu=s(Bb,"__call__"),Bb.forEach(t),Zu=s(Aa," special method."),Aa.forEach(t),e_=d(ja),v(rn.$$.fragment,ja),ja.forEach(t),Be.forEach(t),lc=d(o),To=a(o,"H2",{class:!0});var fh=i(To);an=a(fh,"A",{id:!0,class:!0,href:!0});var Wb=i(an);cl=a(Wb,"SPAN",{});var Qb=i(cl);v(Ks.$$.fragment,Qb),Qb.forEach(t),Wb.forEach(t),t_=d(fh),hl=a(fh,"SPAN",{});var Hb=i(hl);o_=s(Hb,"TFLongformerForMaskedLM"),Hb.forEach(t),fh.forEach(t),dc=d(o),Ae=a(o,"DIV",{class:!0});var lt=i(Ae);v(Js.$$.fragment,lt),n_=d(lt),Xs=a(lt,"P",{});var ph=i(Xs);s_=s(ph,"Longformer Model with a "),ml=a(ph,"CODE",{});var Rb=i(ml);r_=s(Rb,"language modeling"),Rb.forEach(t),a_=s(ph," head on top."),ph.forEach(t),i_=d(lt),Ys=a(lt,"P",{});var gh=i(Ys);l_=s(gh,"This model inherits from "),la=a(gh,"A",{href:!0});var Ub=i(la);d_=s(Ub,"TFPreTrainedModel"),Ub.forEach(t),c_=s(gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
TriviaQA (a linear layer on top of the hidden-states output to compute `),_l=a(Ia,"CODE",{});var eT=i(_l);q_=s(eT,"span start logits"),eT.forEach(t),C_=s(Ia," and "),wl=a(Ia,"CODE",{});var tT=i(wl);O_=s(tT,"span end logits"),tT.forEach(t),P_=s(Ia,")."),Ia.forEach(t),j_=d(dt),rr=a(dt,"P",{});var wh=i(rr);A_=s(wh,"This model inherits from "),ca=a(wh,"A",{href:!0});var oT=i(ca);N_=s(oT,"TFPreTrainedModel"),oT.forEach(t),I_=s(wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lh.forEach(t),Ow=d(ht),vr=a(ht,"P",{});var $h=i(vr);Pw=s($h,"This model is also a "),br=a($h,"A",{href:!0,rel:!0});var bT=i(br);jw=s(bT,"tf.keras.Model"),bT.forEach(t),Aw=s($h,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$h.forEach(t),Nw=d(ht),v(_n.$$.fragment,ht),Iw=d(ht),ot=a(ht,"DIV",{class:!0});var Ot=i(ot);v(Tr.$$.fragment,Ot),Sw=d(Ot),zo=a(Ot,"P",{});var Ba=i(zo);Dw=s(Ba,"The "),ga=a(Ba,"A",{href:!0});var TT=i(ga);Bw=s(TT,"TFLongformerForTokenClassification"),TT.forEach(t),Ww=s(Ba," forward method, overrides the "),El=a(Ba,"CODE",{});var yT=i(El);Qw=s(yT,"__call__"),yT.forEach(t),Hw=s(Ba," special method."),Ba.forEach(t),Rw=d(Ot),v(wn.$$.fragment,Ot),Uw=d(Ot),zl=a(Ot,"P",{});var LT=i(zl);Vw=s(LT,"Example:"),LT.forEach(t),Gw=d(Ot),v(yr.$$.fragment,Ot),Ot.forEach(t),ht.forEach(t),uc=d(o),qo=a(o,"H2",{class:!0});var Fh=i(qo);kn=a(Fh,"A",{id:!0,class:!0,href:!0});var $T=i(kn);ql=a($T,"SPAN",{});var FT=i(ql);v(Lr.$$.fragment,FT),FT.forEach(t),$T.forEach(t),Kw=d(Fh),Cl=a(Fh,"SPAN",{});var xT=i(Cl);Jw=s(xT,"TFLongformerForMultipleChoice"),xT.forEach(t),Fh.forEach(t),_c=d(o),De=a(o,"DIV",{class:!0});var mt=i(De);v($r.$$.fragment,mt),Xw=d(mt),Ol=a(mt,"P",{});var MT=i(Ol);Yw=s(MT,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
