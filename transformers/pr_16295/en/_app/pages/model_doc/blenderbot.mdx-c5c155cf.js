...
first positional argument :`),U=i(),M=n("ul"),C=n("li"),Pe=a("a single Tensor with "),J=n("code"),Q=a("input_ids"),Ne=a(" only and nothing else: "),W=n("code"),Oe=a("model(input_ids)"),Ae=i(),O=n("li"),ue=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),we.forEach(t),U=l(m),M=r(m,"UL",{});var K=s(M);C=r(K,"LI",{});var V=s(C);Pe=d(V,"a single Tensor with "),J=r(V,"CODE",{});var ut=s(J);Q=d(ut,"input_ids"),ut.forEach(t),Ne=d(V," only and nothing else: "),W=r(V,"CODE",{});var Je=s(W);Oe=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=l(K),O=r(K,"LI",{});var A=s(O);ue=d(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(A,"CODE",{});var Be=s(re);$e=d(Be,"model([input_ids, attention_mask])"),Be.forEach(t),me=d(A," or "),H=r(A,"CODE",{});var mt=s(H);Ie=d(mt,"model([input_ids, attention_mask, token_type_ids])"),mt.forEach(t),A.forEach(t),qe=l(K),E=r(K,"LI",{});var se=s(E);Se=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(se,"CODE",{});var ft=s(R);Le=d(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),se.forEach(t),K.forEach(t)},m(m,$){p(m,u,$),e(u,x),p(m,f,$),p(m,T,$),e(T,z),e(z,B),e(T,w),e(T,F),e(F,Ee),p(m,he,$),p(m,q,$),e(q,ve),e(q,te),e(te,Ce),e(q,oe),e(q,ne),e(ne,je),e(q,Fe),p(m,G,$),p(m,N,$),e(N,ye),p(m,U,$),p(m,M,$),e(M,C),e(C,Pe),e(C,J),e(J,Q),e(C,Ne),e(C,W),e(W,Oe),e(M,Ae),e(M,O),e(O,ue),e(O,re),e(re,$e),e(O,me),e(O,H),e(H,Ie),e(M,qe),e(M,E),e(E,Se),e(E,R),e(R,Le)},d(m){m&&t(u),m&&t(f),m&&t(T),m&&t(he),m&&t(q),m&&t(G),m&&t(N),m&&t(U),m&&t(M)}}}function jf(D){let u,x,f,T,z;return{c(){u=n("p"),x=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),z=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(B){u=r(B,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var F=s(f);T=d(F,"Module"),F.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(B){u=r(B,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var F=s(f);T=d(F,"Module"),F.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(B,w){p(B,u,w),e(u,x),e(u,f),e(f,T),e(u,z)},d(B){B&&t(u)}}}function Of(D){let u,x,f,T,z,B,w,F,Ee,he,q,ve,te,Ce,oe,ne,je,Fe,G,N,ye,U,M,C,Pe,J,Q,Ne,W,Oe,Ae,O,ue,re,$e,me,H,Ie,qe,E,Se,R,Le,m,$,Te,ht,Ve,j,fe,De,we,K,V,ut,Je,A,Be,mt,se,ft,$d,qd,uo,Md,mo,Ed,Cd,jd,Ge,Pd,qr,Nd,Od,Mr,Ad,Id,Rn,Sd,Ld,Ta,_t,Ot,Er,fo,Dd,Cr,Gd,wa,Un,Wd,Ba,_o,za,gt,At,jr,go,Rd,Pr,Ud,xa,ae,bo,Hd,bt,Kd,Hn,Vd,Jd,ko,Qd,Xd,Yd,kt,Zd,Kn,ei,ti,Vn,oi,ni,ri,Nr,si,ai,vo,Fa,vt,It,Or,yo,di,Ar,ii,$a,de,To,li,Ir,ci,pi,St,Sr,hi,ui,Jn,mi,fi,_i,wo,gi,Qn,bi,ki,vi,Qe,Bo,yi,Lr,Ti,wi,Dr,Xn,Bi,Gr,zi,qa,yt,Lt,Wr,zo,xi,Rr,Fi,Ma,ie,xo,$i,Fo,qi,Ur,Mi,Ei,Ci,Dt,Hr,ji,Pi,Yn,Ni,Oi,Ai,$o,Ii,Zn,Si,Li,Di,Xe,qo,Gi,Kr,Wi,Ri,Vr,er,Ui,Jr,Hi,Ea,Tt,Gt,Qr,Mo,Ki,Xr,Vi,Ca,We,Ji,Yr,Qi,Xi,Zr,Yi,Zi,es,el,ja,ze,Eo,tl,Co,ol,tr,nl,rl,sl,jo,al,Po,dl,il,ll,_e,No,cl,wt,pl,or,hl,ul,ts,ml,fl,_l,Wt,gl,os,bl,kl,Oo,Pa,Bt,Rt,ns,Ao,vl,rs,yl,Na,Re,Tl,nr,wl,Bl,ss,zl,xl,as,Fl,Oa,xe,Io,$l,So,ql,rr,Ml,El,Cl,Lo,jl,Do,Pl,Nl,Ol,ge,Go,Al,zt,Il,sr,Sl,Ll,ds,Dl,Gl,Wl,Ut,Rl,is,Ul,Hl,Wo,Aa,xt,Ht,ls,Ro,Kl,cs,Vl,Ia,Ft,Uo,Jl,Ye,Ho,Ql,ps,Xl,Yl,Ko,Sa,$t,Kt,hs,Vo,Zl,us,ec,La,le,Jo,tc,Qo,oc,ar,nc,rc,sc,Xo,ac,Yo,dc,ic,lc,Vt,cc,be,Zo,pc,qt,hc,dr,uc,mc,ms,fc,_c,gc,Jt,bc,fs,kc,vc,en,Da,Mt,Qt,_s,tn,yc,gs,Tc,Ga,ce,on,wc,nn,Bc,ir,zc,xc,Fc,rn,$c,sn,qc,Mc,Ec,Xt,Cc,X,an,jc,Et,Pc,lr,Nc,Oc,bs,Ac,Ic,Sc,Yt,Lc,ks,Dc,Gc,vs,ys,Ts,ws,Wc,Rc,Bs,zs,xs,dn,Uc,Fs,Hc,Kc,Wa,Ct,Zt,$s,ln,Vc,qs,Jc,Ra,I,cn,Qc,pn,Xc,cr,Yc,Zc,ep,hn,tp,un,op,np,rp,Ms,sp,ap,Ue,Es,mn,dp,ip,Cs,fn,lp,cp,js,_n,pp,hp,Ps,gn,up,mp,ke,bn,fp,jt,_p,Ns,gp,bp,Os,kp,vp,yp,eo,Tp,As,wp,Bp,kn,zp,Ze,vn,xp,Is,Fp,$p,yn,qp,et,Tn,Mp,Ss,Ep,Cp,wn,Ua,Pt,to,Ls,Bn,jp,Ds,Pp,Ha,S,zn,Np,xn,Op,pr,Ap,Ip,Sp,Fn,Lp,$n,Dp,Gp,Wp,Gs,Rp,Up,He,Ws,qn,Hp,Kp,Rs,Mn,Vp,Jp,Us,En,Qp,Xp,Hs,Cn,Yp,Zp,L,jn,eh,Nt,th,Ks,oh,nh,Vs,rh,sh,ah,oo,dh,Js,ih,lh,Qs,Xs,Ys,Zs,ch,ph,ea,ta,oa,na,hh,uh,ra,sa,aa,da,mh,fh,ia,la,Pn,no,ro,ca,Nn,_h,pa,gh,bh,ha,kh,vh,tt,On,yh,ua,Th,wh,An,Bh,ot,In,zh,ma,xh,Fh,Sn,Ka;return B=new pe({}),U=new pe({}),we=new pe({}),fo=new pe({}),_o=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Mo=new pe({}),Eo=new P({props:{name:"class transformers.BlenderbotModel",anchor:"transformers.BlenderbotModel",parameters:[{name:"config",val:": BlenderbotConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/blenderbot/modeling_blenderbot.py#L1080",parametersDescription:[{anchor:"transformers.BlenderbotModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16295/en/model_doc/blenderbot#transformers.BlenderbotConfig">BlenderbotConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16295/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new P({props:{name:"forward",anchor:"transformers.BlenderbotModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/blenderbot/modeling_blenderbot.py#L1118",parametersDescription:[{anchor:"transformers.BlenderbotModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/blenderbot#transformers.BlenderbotTokenizer">BlenderbotTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16295/en/model_doc/blenderbot#transformers.BlenderbotConfig"
...
`}}),Wt=new ho({props:{$$slots:{default:[$f]},$$scope:{ctx:D}}}),Oo=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
`}}),oo=new ho({props:{$$slots:{default:[Nf]},$$scope:{ctx:D}}}),Nn=new pe({}),On=new P({props:{name:"encode",anchor:"transformers.FlaxBlenderbotPreTrainedModel.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16295/src/transformers/models/blenderbot/modeling_flax_blenderbot.py#L963",parametersDescription:[{anchor:"transformers.FlaxBlenderbotPreTrainedModel.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16295/en/model_doc/blenderbot#transformers.BlenderbotTokenizer">BlenderbotTokenizer</a>. See <a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16295/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("meta"),x=i(),f=n("h1"),T=n("a"),z=n("span"),_(B.$$.fragment),w=i(),F=n("span"),Ee=a("Blenderbot"),he=i(),q=n("p"),ve=n("strong"),te=a("DISCLAIMER:"),Ce=a(" If you see something strange, file a "),oe=n("a"),ne=a("Github Issue"),je=a(" ."),Fe=i(),G=n("h2"),N=n("a"),ye=n("span"),_(U.$$.fragment),M=i(),C=n("span"),Pe=a("Overview"),J=i(),Q=n("p"),Ne=a("The Blender chatbot model was proposed in "),W=n("a"),Oe=a("Recipes for building an open-domain chatbot"),Ae=a(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),O=i(),ue=n("p"),re=a("The abstract of the paper is the following:"),$e=i(),me=n("p"),H=n("em"),Ie=a(`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
...
documentation from `),Vn=n("a"),oi=a("PretrainedConfig"),ni=a(" for more information."),ri=i(),Nr=n("p"),si=a("Example:"),ai=i(),_(vo.$$.fragment),Fa=i(),vt=n("h2"),It=n("a"),Or=n("span"),_(yo.$$.fragment),di=i(),Ar=n("span"),ii=a("BlenderbotTokenizer"),$a=i(),de=n("div"),_(To.$$.fragment),li=i(),Ir=n("p"),ci=a("Construct a Blenderbot tokenizer."),pi=i(),St=n("p"),Sr=n("code"),hi=a("Blenderbot"),ui=a(" is nearly identical to "),Jn=n("a"),mi=a("RobertaTokenizer"),fi=a(` and runs end-to-end tokenization: punctuation splitting
...
adding special tokens. A Blenderbot sequence has the following format:`),wi=i(),Dr=n("ul"),Xn=n("li"),Bi=a("single sequence: "),Gr=n("code"),zi=a("X </s>"),qa=i(),yt=n("h2"),Lt=n("a"),Wr=n("span"),_(zo.$$.fragment),xi=i(),Rr=n("span"),Fi=a("BlenderbotTokenizerFast"),Ma=i(),ie=n("div"),_(xo.$$.fragment),$i=i(),Fo=n("p"),qi=a("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Ur=n("em"),Mi=a("tokenizers"),Ei=a(" library)."),Ci=i(),Dt=n("p"),Hr=n("code"),ji=a("BlenderbotFast"),Pi=a(" is nearly identical to "),Yn=n("a"),Ni=a("RobertaTokenizerFast"),Oi=a(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ai=i(),$o=n("p"),Ii=a("Refer to superclass "),Zn=n("a"),Si=a("RobertaTokenizerFast"),Li=a(" for usage examples and documentation concerning parameters."),Di=i(),Xe=n("div"),_(qo.$$.fragment),Gi=i(),Kr=n("p"),Wi=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
and behavior.`),ll=i(),_e=n("div"),_(No.$$.fragment),cl=i(),wt=n("p"),pl=a("The "),or=n("a"),hl=a("BlenderbotModel"),ul=a(" forward method, overrides the "),ts=n("code"),ml=a("__call__"),fl=a(" special method."),_l=i(),_(Wt.$$.fragment),gl=i(),os=n("p"),bl=a("Example:"),kl=i(),_(Oo.$$.fragment),Pa=i(),Bt=n("h2"),Rt=n("a"),ns=n("span"),_(Ao.$$.fragment),vl=i(),rs=n("span"),yl=a("BlenderbotForConditionalGeneration"),Na=i(),Re=n("p"),Tl=a("See "),nr=n("a"),wl=a("BartForConditionalGeneration"),Bl=a(" for arguments to "),ss=n("em"),zl=a("forward"),xl=a(" and "),as=n("em"),Fl=a("generate"),Oa=i(),xe=n("div"),_(Io.$$.fragment),$l=i(),So=n("p"),ql=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec=i(),_(Xt.$$.fragment),Cc=i(),X=n("div"),_(an.$$.fragment),jc=i(),Et=n("p"),Pc=a("The "),lr=n("a"),Nc=a("TFBlenderbotForConditionalGeneration"),Oc=a(" forward method, overrides the "),bs=n("code"),Ac=a("__call__"),Ic=a(" special method."),Sc=i(),_(Yt.$$.fragment),Lc=i(),ks=n("p"),Dc=a("Conversation example::"),Gc=i(),vs=n("blockquote"),ys=n("blockquote"),Ts=n("blockquote"),ws=n("p"),Wc=a(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rp=i(),Ms=n("p"),sp=a("Finally, this model supports inherent JAX features such as:"),ap=i(),Ue=n("ul"),Es=n("li"),mn=n("a"),dp=a("Just-In-Time (JIT) compilation"),ip=i(),Cs=n("li"),fn=n("a"),lp=a("Automatic Differentiation"),cp=i(),js=n("li"),_n=n("a"),pp=a("Vectorization"),hp=i(),Ps=n("li"),gn=n("a"),up=a("Parallelization"),mp=i(),ke=n("div"),_(bn.$$.fragment),fp=i(),jt=n("p"),_p=a("The "),Ns=n("code"),gp=a("FlaxBlenderbotPreTrainedModel"),bp=a("forward method, overrides the "),Os=n("code"),kp=a("__call__"),vp=a(" special method."),yp=i(),_(eo.$$.fragment),Tp=i(),As=n("p"),wp=a("Example:"),Bp=i(),_(kn.$$.fragment),zp=i(),Ze=n("div"),_(vn.$$.fragment),xp=i(),Is=n("p"),Fp=a("Example:"),$p=i(),_(yn.$$.fragment),qp=i(),et=n("div"),_(Tn.$$.fragment),Mp=i(),Ss=n("p"),Ep=a("Example:"),Cp=i(),_(wn.$$.fragment),Ua=i(),Pt=n("h2"),to=n("a"),Ls=n("span"),_(Bn.$$.fragment),jp=i(),Ds=n("span"),Pp=a("FlaxBlenderbotForConditionalGeneration"),Ha=i(),S=n("div"),_(zn.$$.fragment),Np=i(),xn=n("p"),Op=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dd.forEach(t),ll=l(io),_e=r(io,"DIV",{class:!0});var at=s(_e);g(No.$$.fragment,at),cl=l(at),wt=r(at,"P",{});var br=s(wt);pl=d(br,"The "),or=r(br,"A",{href:!0});var ju=s(or);hl=d(ju,"BlenderbotModel"),ju.forEach(t),ul=d(br," forward method, overrides the "),ts=r(br,"CODE",{});var Pu=s(ts);ml=d(Pu,"__call__"),Pu.forEach(t),fl=d(br," special method."),br.forEach(t),_l=l(at),g(Wt.$$.fragment,at),gl=l(at),os=r(at,"P",{});var Nu=s(os);bl=d(Nu,"Example:"),Nu.forEach(t),kl=l(at),g(Oo.$$.fragment,at),at.forEach(t),io.forEach(t),Pa=l(o),Bt=r(o,"H2",{class:!0});var id=s(Bt);Rt=r(id,"A",{id:!0,class:!0,href:!0});var Ou=s(Rt);ns=r(Ou,"SPAN",{});var Au=s(ns);g(Ao.$$.fragment,Au),Au.forEach(t),Ou.forEach(t),vl=l(id),rs=r(id,"SPAN",{});var Iu=s(rs);yl=d(Iu,"BlenderbotForConditionalGeneration"),Iu.forEach(t),id.forEach(t),Na=l(o),Re=r(o,"P",{});var Wn=s(Re);Tl=d(Wn,"See "),nr=r(Wn,"A",{href:!0});var Su=s(nr);wl=d(Su,"BartForConditionalGeneration"),Su.forEach(t),Bl=d(Wn," for arguments to "),ss=r(Wn,"EM",{});var Lu=s(ss);zl=d(Lu,"forward"),Lu.forEach(t),xl=d(Wn," and "),as=r(Wn,"EM",{});var Du=s(as);Fl=d(Du,"generate"),Du.forEach(t),Wn.forEach(t),Oa=l(o),xe=r(o,"DIV",{class:!0});var lo=s(xe);g(Io.$$.fragment,lo),$l=l(lo),So=r(lo,"P",{});var ld=s(So);ql=d(ld,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cd.forEach(t),Ol=l(lo),ge=r(lo,"DIV",{class:!0});var dt=s(ge);g(Go.$$.fragment,dt),Al=l(dt),zt=r(dt,"P",{});var kr=s(zt);Il=d(kr,"The "),sr=r(kr,"A",{href:!0});var Ru=s(sr);Sl=d(Ru,"BlenderbotForConditionalGeneration"),Ru.forEach(t),Ll=d(kr," forward method, overrides the "),ds=r(kr,"CODE",{});var Uu=s(ds);Dl=d(Uu,"__call__"),Uu.forEach(t),Gl=d(kr," special method."),kr.forEach(t),Wl=l(dt),g(Ut.$$.fragment,dt),Rl=l(dt),is=r(dt,"P",{});var Hu=s(is);Ul=d(Hu,"Conversation example:"),Hu.forEach(t),Hl=l(dt),g(Wo.$$.fragment,dt),dt.forEach(t),lo.forEach(t),Aa=l(o),xt=r(o,"H2",{class:!0});var pd=s(xt);Ht=r(pd,"A",{id:!0,class:!0,href:!0});var Ku=s(Ht);ls=r(Ku,"SPAN",{});var Vu=s(ls);g(Ro.$$.fragment,Vu),Vu.forEach(t),Ku.forEach(t),Kl=l(pd),cs=r(pd,"SPAN",{});var Ju=s(cs);Vl=d(Ju,"BlenderbotForCausalLM"),Ju.forEach(t),pd.forEach(t),Ia=l(o),Ft=r(o,"DIV",{class:!0});var hd=s(Ft);g(Uo.$$.fragment,hd),Jl=l(hd),Ye=r(hd,"DIV",{class:!0});var vr=s(Ye);g(Ho.$$.fragment,vr),Ql=l(vr),ps=r(vr,"P",{});var Qu=s(ps);Xl=d(Qu,"Example:"),Qu.forEach(t),Yl=l(vr),g(Ko.$$.fragment,vr),vr.forEach(t),hd.forEach(t),Sa=l(o),$t=r(o,"H2",{class:!0});var ud=s($t);Kt=r(ud,"A",{id:!0,class:!0,href:!0});var Xu=s(Kt);hs=r(Xu,"SPAN",{});var Yu=s(hs);g(Vo.$$.fragment,Yu),Yu.forEach(t),Xu.forEach(t),Zl=l(ud),us=r(ud,"SPAN",{});var Zu=s(us);ec=d(Zu,"TFBlenderbotModel"),Zu.forEach(t),ud.forEach(t),La=l(o),le=r(o,"DIV",{class:!0});var it=s(le);g(Jo.$$.fragment,it),tc=l(it),Qo=r(it,"P",{});var md=s(Qo);oc=d(md,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bd.forEach(t),Ec=l(ct),g(Xt.$$.fragment,ct),Cc=l(ct),X=r(ct,"DIV",{class:!0});var Me=s(X);g(an.$$.fragment,Me),jc=l(Me),Et=r(Me,"P",{});var Tr=s(Et);Pc=d(Tr,"The "),lr=r(Tr,"A",{href:!0});var cm=s(lr);Nc=d(cm,"TFBlenderbotForConditionalGeneration"),cm.forEach(t),Oc=d(Tr," forward method, overrides the "),bs=r(Tr,"CODE",{});var pm=s(bs);Ac=d(pm,"__call__"),pm.forEach(t),Ic=d(Tr," special method."),Tr.forEach(t),Sc=l(Me),g(Yt.$$.fragment,Me),Lc=l(Me),ks=r(Me,"P",{});var hm=s(ks);Dc=d(hm,"Conversation example::"),hm.forEach(t),Gc=l(Me),vs=r(Me,"BLOCKQUOTE",{});var um=s(vs);ys=r(um,"BLOCKQUOTE",{});var mm=s(ys);Ts=r(mm,"BLOCKQUOTE",{});var fm=s(Ts);ws=r(fm,"P",{});var _m=s(ws);Wc=d(_m,`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
\u2018facebook/blenderbot-400M-distill\u2019 >>> model = TFBlenderbotForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(mname) >>> UTTERANCE = \u201CMy friends are cool but they eat too
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
