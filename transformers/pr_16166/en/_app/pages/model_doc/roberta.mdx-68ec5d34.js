...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
[0, 31414, 232, 328, 2]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[0, 20920, 232, 2]`}}),$n=new fe({props:{$$slots:{default:[bE]},$$scope:{ctx:q}}}),Qs=new j({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.RobertaTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:""},{name:"token_ids_1",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/tokenization_roberta_fast.py#L270"}}),Vs=new ye({}),Js=new j({props:{name:"class transformers.RobertaModel",anchor:"transformers.RobertaModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L696",parametersDescription:[{anchor:"transformers.RobertaModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16166/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),er=new j({props:{name:"forward",anchor:"transformers.RobertaModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L741",parametersDescription:[{anchor:"transformers.RobertaModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16166/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>past_key_values</code>).`,name:"use_cache"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16166/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16166/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16166/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),sa=new ye({}),ra=new j({props:{name:"class transformers.TFRobertaForMaskedLM",anchor:"transformers.TFRobertaForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_tf_roberta.py#L1055",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16166/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qn=new fe({props:{$$slots:{default:[zE]},$$scope:{ctx:q}}}),ca=new j({props:{name:"call",anchor:"transformers.TFRobertaForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_tf_roberta.py#L1072",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ha=new ye({}),ua=new j({props:{name:"class transformers.TFRobertaForSequenceClassification",anchor:"transformers.TFRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_tf_roberta.py#L1319",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16166/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new fe({props:{$$slots:{default:[qE]},$$scope:{ctx:q}}}),_a=new j({props:{name:"call",anchor:"transformers.TFRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16166/src/transformers/models/roberta/modeling_tf_roberta.py#L1330",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16166/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16166/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_16166/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16166/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16166/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16166/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16166/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Uw=l(),Op=n("p"),Hw=a("Finally, this model supports inherent JAX features such as:"),Qw=l(),Dt=n("ul"),Np=n("li"),fi=n("a"),Vw=a("Just-In-Time (JIT) compilation"),Jw=l(),Ip=n("li"),mi=n("a"),Kw=a("Automatic Differentiation"),Gw=l(),Dp=n("li"),gi=n("a"),Xw=a("Vectorization"),Yw=l(),Sp=n("li"),_i=n("a"),Zw=a("Parallelization"),e6=l(),kt=n("div"),T(bi.$$.fragment),t6=l(),dn=n("p"),o6=a("The "),Wp=n("code"),n6=a("FlaxRobertaPreTrainedModel"),s6=a("forward method, overrides the "),Bp=n("code"),r6=a("__call__"),a6=a(" special method."),i6=l(),T(ps.$$.fragment),l6=l(),Up=n("p"),d6=a("Example:"),c6=l(),T(ki.$$.fragment),Pu=l(),cn=n("h2"),hs=n("a"),Hp=n("span"),T(Ti.$$.fragment),p6=l(),Qp=n("span"),h6=a("FlaxRobertaForMultipleChoice"),ju=l(),Ne=n("div"),T(yi.$$.fragment),u6=l(),Vp=n("p"),f6=a(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),m6=l(),vi=n("p"),g6=a("This model inherits from "),Hl=n("a"),_6=a("FlaxPreTrainedModel"),b6=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k6=l(),wi=n("p"),T6=a("This model is also a Flax Linen "),$i=n("a"),y6=a("flax.linen.Module"),v6=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w6=l(),Jp=n("p"),$6=a("Finally, this model supports inherent JAX features such as:"),F6=l(),St=n("ul"),Kp=n("li"),Fi=n("a"),R6=a("Just-In-Time (JIT) compilation"),M6=l(),Gp=n("li"),Ri=n("a"),E6=a("Automatic Differentiation"),z6=l(),Xp=n("li"),Mi=n("a"),x6=a("Vectorization"),q6=l(),Yp=n("li"),Ei=n("a"),C6=a("Parallelization"),P6=l(),Tt=n("div"),T(zi.$$.fragment),j6=l(),pn=n("p"),L6=a("The "),Zp=n("code"),A6=a("FlaxRobertaPreTrainedModel"),O6=a("forward method, overrides the "),eh=n("code"),N6=a("__call__"),I6=a(" special method."),D6=l(),T(us.$$.fragment),S6=l(),th=n("p"),W6=a("Example:"),B6=l(),T(xi.$$.fragment),Lu=l(),hn=n("h2"),fs=n("a"),oh=n("span"),T(qi.$$.fragment),U6=l(),nh=n("span"),H6=a("FlaxRobertaForTokenClassification"),Au=l(),Ie=n("div"),T(Ci.$$.fragment),Q6=l(),sh=n("p"),V6=a(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J6=l(),Pi=n("p"),K6=a("This model inherits from "),Ql=n("a"),G6=a("FlaxPreTrainedModel"),X6=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Y6=l(),ji=n("p"),Z6=a("This model is also a Flax Linen "),Li=n("a"),e$=a("flax.linen.Module"),t$=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
layers on top of the hidden-states output to compute `),Mc=s(rd,"CODE",{});var Y2=r(Mc);Jk=i(Y2,"span start logits"),Y2.forEach(t),Kk=i(rd," and "),Ec=s(rd,"CODE",{});var Z2=r(Ec);Gk=i(Z2,"span end logits"),Z2.forEach(t),Xk=i(rd,")."),rd.forEach(t),Yk=d(so),Wr=s(so,"P",{});var yf=r(Wr);Zk=i(yf,"This model inherits from "),Ml=s(yf,"A",{href:!0});var e0=r(Ml);e1=i(e0,"PreTrainedModel"),e0.forEach(t),t1=i(yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yf.forEach(t),o1=d(so),Br=s(so,"P",{});var vf=r(Br);n1=i(vf,"This model is also a PyTorch "),Ur=s(vf,"A",{href:!0,rel:!0});var t0=r(Ur);s1=i(t0,"torch.nn.Module"),t0.forEach(t),r1=i(vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),a1=d(so),dt=s(so,"DIV",{class:!0});var ro=r(dt);y(Hr.$$.fragment,ro),i1=d(ro),Do=s(ro,"P",{});var ad=r(Do);l1=i(ad,"The "),El=s(ad,"A",{href:!0});var o0=r(El);d1=i(o0,"RobertaForQuestionAnswering"),o0.forEach(t),c1=i(ad," forward method, overrides the "),zc=s(ad,"CODE",{});var n0=r(zc);p1=i(n0,"__call__"),n0.forEach(t),h1=i(ad," special method."),ad.forEach(t),u1=d(ro),y(In.$$.fragment,ro),f1=d(ro),xc=s(ro,"P",{});var s0=r(xc);m1=i(s0,"Example:"),s0.forEach(t),g1=d(ro),y(Qr.$$.fragment,ro),ro.forEach(t),so.forEach(t),uu=d(o),So=s(o,"H2",{class:!0});var wf=r(So);Dn=s(wf,"A",{id:!0,class:!0,href:!0});var r0=r(Dn);qc=s(r0,"SPAN",{});var a0=r(qc);y(Vr.$$.fragment,a0),a0.forEach(t),r0.forEach(t),_1=d(wf),Cc=s(wf,"SPAN",{});var i0=r(Cc);b1=i(i0,"TFRobertaModel"),i0.forEach(t),wf.forEach(t),fu=d(o),Ue=s(o,"DIV",{class:!0});var Ct=r(Ue);y(Jr.$$.fragment,Ct),k1=d(Ct),Pc=s(Ct,"P",{});var l0=r(Pc);T1=i(l0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),l0.forEach(t),y1=d(Ct),Kr=s(Ct,"P",{});var $f=r(Kr);v1=i($f,"This model inherits from "),zl=s($f,"A",{href:!0});var d0=r(zl);w1=i(d0,"TFPreTrainedModel"),d0.forEach(t),$1=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),F1=d(Ct),Gr=s(Ct,"P",{});var Ff=r(Gr);R1=i(Ff,"This model is also a "),Xr=s(Ff,"A",{href:!0,rel:!0});var c0=r(Xr);M1=i(c0,"tf.keras.Model"),c0.forEach(t),E1=i(Ff,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ff.forEach(t),z1=d(Ct),y(Sn.$$.fragment,Ct),x1=d(Ct),ct=s(Ct,"DIV",{class:!0});var ao=r(ct);y(Yr.$$.fragment,ao),q1=d(ao),Wo=s(ao,"P",{});var id=r(Wo);C1=i(id,"The "),xl=s(id,"A",{href:!0});var p0=r(xl);P1=i(p0,"TFRobertaModel"),p0.forEach(t),j1=i(id," forward method, overrides the "),jc=s(id,"CODE",{});var h0=r(jc);L1=i(h0,"__call__"),h0.forEach(t),A1=i(id," special method."),id.forEach(t),O1=d(ao),y(Wn.$$.fragment,ao),N1=d(ao),Lc=s(ao,"P",{});var u0=r(Lc);I1=i(u0,"Example:"),u0.forEach(t),D1=d(ao),y(Zr.$$.fragment,ao),ao.forEach(t),Ct.forEach(t),mu=d(o),Bo=s(o,"H2",{class:!0});var Rf=r(Bo);Bn=s(Rf,"A",{id:!0,class:!0,href:!0});var f0=r(Bn);Ac=s(f0,"SPAN",{});var m0=r(Ac);y(ea.$$.fragment,m0),m0.forEach(t),f0.forEach(t),S1=d(Rf),Oc=s(Rf,"SPAN",{});var g0=r(Oc);W1=i(g0,"TFRobertaForCausalLM"),g0.forEach(t),Rf.forEach(t),gu=d(o),Uo=s(o,"DIV",{class:!0});var Mf=r(Uo);y(ta.$$.fragment,Mf),B1=d(Mf),pt=s(Mf,"DIV",{class:!0});var io=r(pt);y(oa.$$.fragment,io),U1=d(io),Ho=s(io,"P",{});var ld=r(Ho);H1=i(ld,"The "),ql=s(ld,"A",{href:!0});var _0=r(ql);Q1=i(_0,"TFRobertaForCausalLM"),_0.forEach(t),V1=i(ld," forward method, overrides the "),Nc=s(ld,"CODE",{});var b0=r(Nc);J1=i(b0,"__call__"),b0.forEach(t),K1=i(ld," special method."),ld.forEach(t),G1=d(io),y(Un.$$.fragment,io),X1=d(io),Ic=s(io,"P",{});var k0=r(Ic);Y1=i(k0,"Example:"),k0.forEach(t),Z1=d(io),y(na.$$.fragment,io),io.forEach(t),Mf.forEach(t),_u=d(o),Qo=s(o,"H2",{class:!0});var Ef=r(Qo);Hn=s(Ef,"A",{id:!0,class:!0,href:!0});var T0=r(Hn);Dc=s(T0,"SPAN",{});var y0=r(Dc);y(sa.$$.fragment,y0),y0.forEach(t),T0.forEach(t),eT=d(Ef),Sc=s(Ef,"SPAN",{});var v0=r(Sc);tT=i(v0,"TFRobertaForMaskedLM"),v0.forEach(t),Ef.forEach(t),bu=d(o),He=s(o,"DIV",{class:!0});var Pt=r(He);y(ra.$$.fragment,Pt),oT=d(Pt),aa=s(Pt,"P",{});var zf=r(aa);nT=i(zf,"RoBERTa Model with a "),Wc=s(zf,"CODE",{});var w0=r(Wc);sT=i(w0,"language modeling"),w0.forEach(t),rT=i(zf," head on top."),zf.forEach(t),aT=d(Pt),ia=s(Pt,"P",{});var xf=r(ia);iT=i(xf,"This model inherits from "),Cl=s(xf,"A",{href:!0});var $0=r(Cl);lT=i($0,"TFPreTrainedModel"),$0.forEach(t),dT=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xf.forEach(t),cT=d(Pt),la=s(Pt,"P",{});var qf=r(la);pT=i(qf,"This model is also a "),da=s(qf,"A",{href:!0,rel:!0});var F0=r(da);hT=i(F0,"tf.keras.Model"),F0.forEach(t),uT=i(qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qf.forEach(t),fT=d(Pt),y(Qn.$$.fragment,Pt),mT=d(Pt),ht=s(Pt,"DIV",{class:!0});var lo=r(ht);y(ca.$$.fragment,lo),gT=d(lo),Vo=s(lo,"P",{});var dd=r(Vo);_T=i(dd,"The "),Pl=s(dd,"A",{href:!0});var R0=r(Pl);bT=i(R0,"TFRobertaForMaskedLM"),R0.forEach(t),kT=i(dd," forward method, overrides the "),Bc=s(dd,"CODE",{});var M0=r(Bc);TT=i(M0,"__call__"),M0.forEach(t),yT=i(dd," special method."),dd.forEach(t),vT=d(lo),y(Vn.$$.fragment,lo),wT=d(lo),Uc=s(lo,"P",{});var E0=r(Uc);$T=i(E0,"Example:"),E0.forEach(t),FT=d(lo),y(pa.$$.fragment,lo),lo.forEach(t),Pt.forEach(t),ku=d(o),Jo=s(o,"H2",{class:!0});var Cf=r(Jo);Jn=s(Cf,"A",{id:!0,class:!0,href:!0});var z0=r(Jn);Hc=s(z0,"SPAN",{});var x0=r(Hc);y(ha.$$.fragment,x0),x0.forEach(t),z0.forEach(t),RT=d(Cf),Qc=s(Cf,"SPAN",{});var q0=r(Qc);MT=i(q0,"TFRobertaForSequenceClassification"),q0.forEach(t),Cf.forEach(t),Tu=d(o),Qe=s(o,"DIV",{class:!0});var jt=r(Qe);y(ua.$$.fragment,jt),ET=d(jt),Vc=s(jt,"P",{});var C0=r(Vc);zT=i(C0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C0.forEach(t),xT=d(jt),fa=s(jt,"P",{});var Pf=r(fa);qT=i(Pf,"This model inherits from "),jl=s(Pf,"A",{href:!0});var P0=r(jl);CT=i(P0,"TFPreTrainedModel"),P0.forEach(t),PT=i(Pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pf.forEach(t),jT=d(jt),ma=s(jt,"P",{});var jf=r(ma);LT=i(jf,"This model is also a "),ga=s(jf,"A",{href:!0,rel:!0});var j0=r(ga);AT=i(j0,"tf.keras.Model"),j0.forEach(t),OT=i(jf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jf.forEach(t),NT=d(jt),y(Kn.$$.fragment,jt),IT=d(jt),ut=s(jt,"DIV",{class:!0});var co=r(ut);y(_a.$$.fragment,co),DT=d(co),Ko=s(co,"P",{});var cd=r(Ko);ST=i(cd,"The "),Ll=s(cd,"A",{href:!0});var L0=r(Ll);WT=i(L0,"TFRobertaForSequenceClassification"),L0.forEach(t),BT=i(cd," forward method, overrides the "),Jc=s(cd,"CODE",{});var A0=r(Jc);UT=i(A0,"__call__"),A0.forEach(t),HT=i(cd," special method."),cd.forEach(t),QT=d(co),y(Gn.$$.fragment,co),VT=d(co),Kc=s(co,"P",{});var O0=r(Kc);JT=i(O0,"Example:"),O0.forEach(t),KT=d(co),y(ba.$$.fragment,co),co.forEach(t),jt.forEach(t),yu=d(o),Go=s(o,"H2",{class:!0});var Lf=r(Go);Xn=s(Lf,"A",{id:!0,class:!0,href:!0});var N0=r(Xn);Gc=s(N0,"SPAN",{});var I0=r(Gc);y(ka.$$.fragment,I0),I0.forEach(t),N0.forEach(t),GT=d(Lf),Xc=s(Lf,"SPAN",{});var D0=r(Xc);XT=i(D0,"TFRobertaForMultipleChoice"),D0.forEach(t),Lf.forEach(t),vu=d(o),Ve=s(o,"DIV",{class:!0});var Lt=r(Ve);y(Ta.$$.fragment,Lt),YT=d(Lt),Yc=s(Lt,"P",{});var S0=r(Yc);ZT=i(S0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),S0.forEach(t),ey=d(Lt),ya=s(Lt,"P",{});var Af=r(ya);ty=i(Af,"This model inherits from "),Al=s(Af,"A",{href:!0});var W0=r(Al);oy=i(W0,"TFPreTrainedModel"),W0.forEach(t),ny=i(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),sy=d(Lt),va=s(Lt,"P",{});var Of=r(va);ry=i(Of,"This model is also a "),wa=s(Of,"A",{href:!0,rel:!0});var B0=r(wa);ay=i(B0,"tf.keras.Model"),B0.forEach(t),iy=i(Of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),ly=d(Lt),y(Yn.$$.fragment,Lt),dy=d(Lt),ft=s(Lt,"DIV",{class:!0});var po=r(ft);y($a.$$.fragment,po),cy=d(po),Xo=s(po,"P",{});var pd=r(Xo);py=i(pd,"The "),Ol=s(pd,"A",{href:!0});var U0=r(Ol);hy=i(U0,"TFRobertaForMultipleChoice"),U0.forEach(t),uy=i(pd," forward method, overrides the "),Zc=s(pd,"CODE",{});var H0=r(Zc);fy=i(H0,"__call__"),H0.forEach(t),my=i(pd," special method."),pd.forEach(t),gy=d(po),y(Zn.$$.fragment,po),_y=d(po),ep=s(po,"P",{});var Q0=r(ep);by=i(Q0,"Example:"),Q0.forEach(t),ky=d(po),y(Fa.$$.fragment,po),po.forEach(t),Lt.forEach(t),wu=d(o),Yo=s(o,"H2",{class:!0});var Nf=r(Yo);es=s(Nf,"A",{id:!0,class:!0,href:!0});var V0=r(es);tp=s(V0,"SPAN",{});var J0=r(tp);y(Ra.$$.fragment,J0),J0.forEach(t),V0.forEach(t),Ty=d(Nf),op=s(Nf,"SPAN",{});var K0=r(op);yy=i(K0,"TFRobertaForTokenClassification"),K0.forEach(t),Nf.forEach(t),$u=d(o),Je=s(o,"DIV",{class:!0});var At=r(Je);y(Ma.$$.fragment,At),vy=d(At),np=s(At,"P",{});var G0=r(np);wy=i(G0,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),G0.forEach(t),$y=d(At),Ea=s(At,"P",{});var If=r(Ea);Fy=i(If,"This model inherits from "),Nl=s(If,"A",{href:!0});var X0=r(Nl);Ry=i(X0,"TFPreTrainedModel"),X0.forEach(t),My=i(If,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),If.forEach(t),Ey=d(At),za=s(At,"P",{});var Df=r(za);zy=i(Df,"This model is also a "),xa=s(Df,"A",{href:!0,rel:!0});var Y0=r(xa);xy=i(Y0,"tf.keras.Model"),Y0.forEach(t),qy=i(Df,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),Cy=d(At),y(ts.$$.fragment,At),Py=d(At),mt=s(At,"DIV",{class:!0});var ho=r(mt);y(qa.$$.fragment,ho),jy=d(ho),Zo=s(ho,"P",{});var hd=r(Zo);Ly=i(hd,"The "),Il=s(hd,"A",{href:!0});var Z0=r(Il);Ay=i(Z0,"TFRobertaForTokenClassification"),Z0.forEach(t),Oy=i(hd," forward method, overrides the "),sp=s(hd,"CODE",{});var eR=r(sp);Ny=i(eR,"__call__"),eR.forEach(t),Iy=i(hd," special method."),hd.forEach(t),Dy=d(ho),y(os.$$.fragment,ho),Sy=d(ho),rp=s(ho,"P",{});var tR=r(rp);Wy=i(tR,"Example:"),tR.forEach(t),By=d(ho),y(Ca.$$.fragment,ho),ho.forEach(t),At.forEach(t),Fu=d(o),en=s(o,"H2",{class:!0});var Sf=r(en);ns=s(Sf,"A",{id:!0,class:!0,href:!0});var oR=r(ns);ap=s(oR,"SPAN",{});var nR=r(ap);y(Pa.$$.fragment,nR),nR.forEach(t),oR.forEach(t),Uy=d(Sf),ip=s(Sf,"SPAN",{});var sR=r(ip);Hy=i(sR,"TFRobertaForQuestionAnswering"),sR.forEach(t),Sf.forEach(t),Ru=d(o),Ke=s(o,"DIV",{class:!0});var Ot=r(Ke);y(ja.$$.fragment,Ot),Qy=d(Ot),tn=s(Ot,"P",{});var ud=r(tn);Vy=i(ud,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),lp=s(ud,"CODE",{});var rR=r(lp);Jy=i(rR,"span start logits"),rR.forEach(t),Ky=i(ud," and "),dp=s(ud,"CODE",{});var aR=r(dp);Gy=i(aR,"span end logits"),aR.forEach(t),Xy=i(ud,")."),ud.forEach(t),Yy=d(Ot),La=s(Ot,"P",{});var Wf=r(La);Zy=i(Wf,"This model inherits from "),Dl=s(Wf,"A",{href:!0});var iR=r(Dl);ev=i(iR,"TFPreTrainedModel"),iR.forEach(t),tv=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),ov=d(Ot),Aa=s(Ot,"P",{});var Bf=r(Aa);nv=i(Bf,"This model is also a "),Oa=s(Bf,"A",{href:!0,rel:!0});var lR=r(Oa);sv=i(lR,"tf.keras.Model"),lR.forEach(t),rv=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),av=d(Ot),y(ss.$$.fragment,Ot),iv=d(Ot),gt=s(Ot,"DIV",{class:!0});var uo=r(gt);y(Na.$$.fragment,uo),lv=d(uo),on=s(uo,"P",{});var fd=r(on);dv=i(fd,"The "),Sl=s(fd,"A",{href:!0});var dR=r(Sl);cv=i(dR,"TFRobertaForQuestionAnswering"),dR.forEach(t),pv=i(fd," forward method, overrides the "),cp=s(fd,"CODE",{});var cR=r(cp);hv=i(cR,"__call__"),cR.forEach(t),uv=i(fd," special method."),fd.forEach(t),fv=d(uo),y(rs.$$.fragment,uo),mv=d(uo),pp=s(uo,"P",{});var pR=r(pp);gv=i(pR,"Example:"),pR.forEach(t),_v=d(uo),y(Ia.$$.fragment,uo),uo.forEach(t),Ot.forEach(t),Mu=d(o),nn=s(o,"H2",{class:!0});var Uf=r(nn);as=s(Uf,"A",{id:!0,class:!0,href:!0});var hR=r(as);hp=s(hR,"SPAN",{});var uR=r(hp);y(Da.$$.fragment,uR),uR.forEach(t),hR.forEach(t),bv=d(Uf),up=s(Uf,"SPAN",{});var fR=r(up);kv=i(fR,"FlaxRobertaModel"),fR.forEach(t),Uf.forEach(t),Eu=d(o),Le=s(o,"DIV",{class:!0});var Ft=r(Le);y(Sa.$$.fragment,Ft),Tv=d(Ft),fp=s(Ft,"P",{});var mR=r(fp);yv=i(mR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),mR.forEach(t),vv=d(Ft),Wa=s(Ft,"P",{});var Hf=r(Wa);wv=i(Hf,"This model inherits from "),Wl=s(Hf,"A",{href:!0});var gR=r(Wl);$v=i(gR,"FlaxPreTrainedModel"),gR.forEach(t),Fv=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),Rv=d(Ft),Ba=s(Ft,"P",{});var Qf=r(Ba);Mv=i(Qf,"This model is also a Flax Linen "),Ua=s(Qf,"A",{href:!0,rel:!0});var _R=r(Ua);Ev=i(_R,"flax.linen.Module"),_R.forEach(t),zv=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),xv=d(Ft),mp=s(Ft,"P",{});var bR=r(mp);qv=i(bR,"Finally, this model supports inherent JAX features such as:"),bR.forEach(t),Cv=d(Ft),Nt=s(Ft,"UL",{});var bs=r(Nt);gp=s(bs,"LI",{});var kR=r(gp);Ha=s(kR,"A",{href:!0,rel:!0});var TR=r(Ha);Pv=i(TR,"Just-In-Time (JIT) compilation"),TR.forEach(t),kR.forEach(t),jv=d(bs),_p=s(bs,"LI",{});var yR=r(_p);Qa=s(yR,"A",{href:!0,rel:!0});var vR=r(Qa);Lv=i(vR,"Automatic Differentiation"),vR.forEach(t),yR.forEach(t),Av=d(bs),bp=s(bs,"LI",{});var wR=r(bp);Va=s(wR,"A",{href:!0,rel:!0});var $R=r(Va);Ov=i($R,"Vectorization"),$R.forEach(t),wR.forEach(t),Nv=d(bs),kp=s(bs,"LI",{});var FR=r(kp);Ja=s(FR,"A",{href:!0,rel:!0});var RR=r(Ja);Iv=i(RR,"Parallelization"),RR.forEach(t),FR.forEach(t),bs.forEach(t),Dv=d(Ft),_t=s(Ft,"DIV",{class:!0});var fo=r(_t);y(Ka.$$.fragment,fo),Sv=d(fo),sn=s(fo,"P",{});var md=r(sn);Wv=i(md,"The "),Tp=s(md,"CODE",{});var MR=r(Tp);Bv=i(MR,"FlaxRobertaPreTrainedModel"),MR.forEach(t),Uv=i(md,"forward method, overrides the "),yp=s(md,"CODE",{});var ER=r(yp);Hv=i(ER,"__call__"),ER.forEach(t),Qv=i(md," special method."),md.forEach(t),Vv=d(fo),y(is.$$.fragment,fo),Jv=d(fo),vp=s(fo,"P",{});var zR=r(vp);Kv=i(zR,"Example:"),zR.forEach(t),Gv=d(fo),y(Ga.$$.fragment,fo),fo.forEach(t),Ft.forEach(t),zu=d(o),rn=s(o,"H2",{class:!0});var Vf=r(rn);ls=s(Vf,"A",{id:!0,class:!0,href:!0});var xR=r(ls);wp=s(xR,"SPAN",{});var qR=r(wp);y(Xa.$$.fragment,qR),qR.forEach(t),xR.forEach(t),Xv=d(Vf),$p=s(Vf,"SPAN",{});var CR=r($p);Yv=i(CR,"FlaxRobertaForMaskedLM"),CR.forEach(t),Vf.forEach(t),xu=d(o),Ae=s(o,"DIV",{class:!0});var Rt=r(Ae);y(Ya.$$.fragment,Rt),Zv=d(Rt),Za=s(Rt,"P",{});var Jf=r(Za);ew=i(Jf,"RoBERTa Model with a "),Fp=s(Jf,"CODE",{});var PR=r(Fp);tw=i(PR,"language modeling"),PR.forEach(t),ow=i(Jf," head on top."),Jf.forEach(t),nw=d(Rt),ei=s(Rt,"P",{});var Kf=r(ei);sw=i(Kf,"This model inherits from "),Bl=s(Kf,"A",{href:!0});var jR=r(Bl);rw=i(jR,"FlaxPreTrainedModel"),jR.forEach(t),aw=i(Kf,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zf.forEach(t),Uw=d(Mt),Op=s(Mt,"P",{});var eM=r(Op);Hw=i(eM,"Finally, this model supports inherent JAX features such as:"),eM.forEach(t),Qw=d(Mt),Dt=s(Mt,"UL",{});var Ts=r(Dt);Np=s(Ts,"LI",{});var tM=r(Np);fi=s(tM,"A",{href:!0,rel:!0});var oM=r(fi);Vw=i(oM,"Just-In-Time (JIT) compilation"),oM.forEach(t),tM.forEach(t),Jw=d(Ts),Ip=s(Ts,"LI",{});var nM=r(Ip);mi=s(nM,"A",{href:!0,rel:!0});var sM=r(mi);Kw=i(sM,"Automatic Differentiation"),sM.forEach(t),nM.forEach(t),Gw=d(Ts),Dp=s(Ts,"LI",{});var rM=r(Dp);gi=s(rM,"A",{href:!0,rel:!0});var aM=r(gi);Xw=i(aM,"Vectorization"),aM.forEach(t),rM.forEach(t),Yw=d(Ts),Sp=s(Ts,"LI",{});var iM=r(Sp);_i=s(iM,"A",{href:!0,rel:!0});var lM=r(_i);Zw=i(lM,"Parallelization"),lM.forEach(t),iM.forEach(t),Ts.forEach(t),e6=d(Mt),kt=s(Mt,"DIV",{class:!0});var go=r(kt);y(bi.$$.fragment,go),t6=d(go),dn=s(go,"P",{});var _d=r(dn);o6=i(_d,"The "),Wp=s(_d,"CODE",{});var dM=r(Wp);n6=i(dM,"FlaxRobertaPreTrainedModel"),dM.forEach(t),s6=i(_d,"forward method, overrides the "),Bp=s(_d,"CODE",{});var cM=r(Bp);r6=i(cM,"__call__"),cM.forEach(t),a6=i(_d," special method."),_d.forEach(t),i6=d(go),y(ps.$$.fragment,go),l6=d(go),Up=s(go,"P",{});var pM=r(Up);d6=i(pM,"Example:"),pM.forEach(t),c6=d(go),y(ki.$$.fragment,go),go.forEach(t),Mt.forEach(t),Pu=d(o),cn=s(o,"H2",{class:!0});var em=r(cn);hs=s(em,"A",{id:!0,class:!0,href:!0});var hM=r(hs);Hp=s(hM,"SPAN",{});var uM=r(Hp);y(Ti.$$.fragment,uM),uM.forEach(t),hM.forEach(t),p6=d(em),Qp=s(em,"SPAN",{});var fM=r(Qp);h6=i(fM,"FlaxRobertaForMultipleChoice"),fM.forEach(t),em.forEach(t),ju=d(o),Ne=s(o,"DIV",{class:!0});var Et=r(Ne);y(yi.$$.fragment,Et),u6=d(Et),Vp=s(Et,"P",{});var mM=r(Vp);f6=i(mM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),mM.forEach(t),m6=d(Et),vi=s(Et,"P",{});var tm=r(vi);g6=i(tm,"This model inherits from "),Hl=s(tm,"A",{href:!0});var gM=r(Hl);_6=i(gM,"FlaxPreTrainedModel"),gM.forEach(t),b6=i(tm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tm.forEach(t),k6=d(Et),wi=s(Et,"P",{});var om=r(wi);T6=i(om,"This model is also a Flax Linen "),$i=s(om,"A",{href:!0,rel:!0});var _M=r($i);y6=i(_M,"flax.linen.Module"),_M.forEach(t),v6=i(om,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),om.forEach(t),w6=d(Et),Jp=s(Et,"P",{});var bM=r(Jp);$6=i(bM,"Finally, this model supports inherent JAX features such as:"),bM.forEach(t),F6=d(Et),St=s(Et,"UL",{});var ys=r(St);Kp=s(ys,"LI",{});var kM=r(Kp);Fi=s(kM,"A",{href:!0,rel:!0});var TM=r(Fi);R6=i(TM,"Just-In-Time (JIT) compilation"),TM.forEach(t),kM.forEach(t),M6=d(ys),Gp=s(ys,"LI",{});var yM=r(Gp);Ri=s(yM,"A",{href:!0,rel:!0});var vM=r(Ri);E6=i(vM,"Automatic Differentiation"),vM.forEach(t),yM.forEach(t),z6=d(ys),Xp=s(ys,"LI",{});var wM=r(Xp);Mi=s(wM,"A",{href:!0,rel:!0});var $M=r(Mi);x6=i($M,"Vectorization"),$M.forEach(t),wM.forEach(t),q6=d(ys),Yp=s(ys,"LI",{});var FM=r(Yp);Ei=s(FM,"A",{href:!0,rel:!0});var RM=r(Ei);C6=i(RM,"Parallelization"),RM.forEach(t),FM.forEach(t),ys.forEach(t),P6=d(Et),Tt=s(Et,"DIV",{class:!0});var _o=r(Tt);y(zi.$$.fragment,_o),j6=d(_o),pn=s(_o,"P",{});var bd=r(pn);L6=i(bd,"The "),Zp=s(bd,"CODE",{});var MM=r(Zp);A6=i(MM,"FlaxRobertaPreTrainedModel"),MM.forEach(t),O6=i(bd,"forward method, overrides the "),eh=s(bd,"CODE",{});var EM=r(eh);N6=i(EM,"__call__"),EM.forEach(t),I6=i(bd," special method."),bd.forEach(t),D6=d(_o),y(us.$$.fragment,_o),S6=d(_o),th=s(_o,"P",{});var zM=r(th);W6=i(zM,"Example:"),zM.forEach(t),B6=d(_o),y(xi.$$.fragment,_o),_o.forEach(t),Et.forEach(t),Lu=d(o),hn=s(o,"H2",{class:!0});var nm=r(hn);fs=s(nm,"A",{id:!0,class:!0,href:!0});var xM=r(fs);oh=s(xM,"SPAN",{});var qM=r(oh);y(qi.$$.fragment,qM),qM.forEach(t),xM.forEach(t),U6=d(nm),nh=s(nm,"SPAN",{});var CM=r(nh);H6=i(CM,"FlaxRobertaForTokenClassification"),CM.forEach(t),nm.forEach(t),Au=d(o),Ie=s(o,"DIV",{class:!0});var zt=r(Ie);y(Ci.$$.fragment,zt),Q6=d(zt),sh=s(zt,"P",{});var PM=r(sh);V6=i(PM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),PM.forEach(t),J6=d(zt),Pi=s(zt,"P",{});var sm=r(Pi);K6=i(sm,"This model inherits from "),Ql=s(sm,"A",{href:!0});var jM=r(Ql);G6=i(jM,"FlaxPreTrainedModel"),jM.forEach(t),X6=i(sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sm.forEach(t),Y6=d(zt),ji=s(zt,"P",{});var rm=r(ji);Z6=i(rm,"This model is also a Flax Linen "),Li=s(rm,"A",{href:!0,rel:!0});var LM=r(Li);e$=i(LM,"flax.linen.Module"),LM.forEach(t),t$=i(rm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
