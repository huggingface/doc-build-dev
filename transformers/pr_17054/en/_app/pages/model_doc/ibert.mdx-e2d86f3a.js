import{S as al,i as il,s as ll,e as r,k as u,w as v,t as l,M as dl,c as a,d as o,m as f,a as i,x as w,h as d,b as m,F as e,g as k,y as $,q as T,o as y,B as I,v as cl,L as Q}from"../../chunks/vendor-6b77c823.js";import{T as vo}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-1088f2fb.js";import{C as H}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as W}from"../../chunks/ExampleCodeBlock-5212b321.js";function pl(B){let s,g,c,p,b;return{c(){s=r("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=l("Module"),b=l(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(s.$$.fragment)},l(c){w(s.$$.fragment,c)},m(c,p){$(s,c,p),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function Fl(B){let s,g,c,p,b,n,h,q,Yn,pn,oe,we,wo,Ke,Zn,$o,Xn,hn,$e,es,Ye,ts,os,mn,Ut,ns,un,Gt,To,ss,fn,G,rs,Ze,as,is,Xe,ls,ds,gn,ne,Te,yo,et,cs,Io,ps,_n,U,tt,hs,se,ms,Vt,us,fs,ot,gs,_s,bs,re,ks,Jt,vs,ws,Kt,$s,Ts,bn,ae,ye,Bo,nt,ys,qo,Is,kn,F,st,Bs,Mo,qs,Ms,rt,Fs,Yt,zs,xs,Es,at,Cs,it,js,Ps,As,lt,Ls,dt,Ss,Os,Rs,R,ct,Ns,ie,Ds,Zt,Ws,Qs,Fo,Hs,Us,Gs,Ie,Vs,Be,vn,le,qe,zo,pt,Js,xo,Ks,wn,z,ht,Ys,mt,Zs,Eo,Xs,er,tr,ut,or,Xt,nr,sr,rr,ft,ar,gt,ir,lr,dr,P,_t,cr,de,pr,eo,hr,mr,Co,ur,fr,gr,Me,_r,Fe,br,ze,$n,ce,xe,jo,bt,kr,Po,vr,Tn,x,kt,wr,Ao,$r,Tr,vt,yr,to,Ir,Br,qr,wt,Mr,$t,Fr,zr,xr,M,Tt,Er,pe,Cr,oo,jr,Pr,Lo,Ar,Lr,Sr,Ee,Or,Ce,Rr,je,Nr,Pe,Dr,Ae,yn,he,Le,So,yt,Wr,Oo,Qr,In,E,It,Hr,Ro,Ur,Gr,Bt,Vr,no,Jr,Kr,Yr,qt,Zr,Mt,Xr,ea,ta,N,Ft,oa,me,na,so,sa,ra,No,aa,ia,la,Se,da,Oe,Bn,ue,Re,Do,zt,ca,Wo,pa,qn,C,xt,ha,Qo,ma,ua,Et,fa,ro,ga,_a,ba,Ct,ka,jt,va,wa,$a,A,Pt,Ta,fe,ya,ao,Ia,Ba,Ho,qa,Ma,Fa,Ne,za,De,xa,We,Mn,ge,Qe,Uo,At,Ea,Go,Ca,Fn,j,Lt,ja,_e,Pa,Vo,Aa,La,Jo,Sa,Oa,Ra,St,Na,io,Da,Wa,Qa,Ot,Ha,Rt,Ua,Ga,Va,L,Nt,Ja,be,Ka,lo,Ya,Za,Ko,Xa,ei,ti,He,oi,Ue,ni,Ge,zn;return n=new ve({}),Ke=new ve({}),et=new ve({}),tt=new O({props:{name:"class transformers.IBertConfig",anchor:"transformers.IBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"quant_mode",val:" = False"},{name:"force_dequant",val:" = 'none'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.IBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the I-BERT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17054/en/model_doc/ibert#transformers.IBertModel">IBertModel</a>`,name:"vocab_size"},{anchor:"transformers.IBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17054/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L773",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17054/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17054/en/model_doc/ibert#transformers.IBertConfig"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17054/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L858"}}),_t=new O({props:{name:"forward",anchor:"transformers.IBertForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.IBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17054/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17054/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17054/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L877",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L986",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L1082",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17054/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L1162"}}),Pt=new O({props:{name:"forward",anchor:"transformers.IBertForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.IBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17054/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17054/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17054/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L1177",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17054/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L1263"}}),Nt=new O({props:{name:"forward",anchor:"transformers.IBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.IBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17054/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17054/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17054/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17054/src/transformers/models/ibert/modeling_ibert.py#L1277",returnDescription:`
<p>A <a
...
`}}),He=new vo({props:{$$slots:{default:[Bl]},$$scope:{ctx:B}}}),Ue=new W({props:{anchor:"transformers.IBertForQuestionAnswering.forward.example",$$slots:{default:[ql]},$$scope:{ctx:B}}}),Ge=new W({props:{anchor:"transformers.IBertForQuestionAnswering.forward.example-2",$$slots:{default:[Ml]},$$scope:{ctx:B}}}),{c(){s=r("meta"),g=u(),c=r("h1"),p=r("a"),b=r("span"),v(n.$$.fragment),h=u(),q=r("span"),Yn=l("I-BERT"),pn=u(),oe=r("h2"),we=r("a"),wo=r("span"),v(Ke.$$.fragment),Zn=u(),$o=r("span"),Xn=l("Overview"),hn=u(),$e=r("p"),es=l("The I-BERT model was proposed in "),Ye=r("a"),ts=l("I-BERT: Integer-only BERT Quantization"),os=l(` by
Sehoon Kim, Amir Gholami, Zhewei Yao, Michael W. Mahoney and Kurt Keutzer. It\u2019s a quantized version of RoBERTa running
inference up to four times faster.`),mn=u(),Ut=r("p"),ns=l("The abstract from the paper is the following:"),un=u(),Gt=r("p"),To=r("em"),ss=l(`Transformer based models, like BERT and RoBERTa, have achieved state-of-the-art results in many Natural Language
...
been open-sourced.`),fn=u(),G=r("p"),rs=l("This model was contributed by "),Ze=r("a"),as=l("kssteven"),is=l(". The original code can be found "),Xe=r("a"),ls=l("here"),ds=l("."),gn=u(),ne=r("h2"),Te=r("a"),yo=r("span"),v(et.$$.fragment),cs=u(),Io=r("span"),ps=l("IBertConfig"),_n=u(),U=r("div"),v(tt.$$.fragment),hs=u(),se=r("p"),ms=l("This is the configuration class to store the configuration of a "),Vt=r("a"),us=l("IBertModel"),fs=l(`. It is used to instantiate a I-BERT
...
etc.)`),Es=u(),at=r("p"),Cs=l("This model is also a PyTorch "),it=r("a"),js=l("torch.nn.Module"),Ps=l(` subclass.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Rs=u(),R=r("div"),v(ct.$$.fragment),Ns=u(),ie=r("p"),Ds=l("The "),Zt=r("a"),Ws=l("IBertModel"),Qs=l(" forward method, overrides the "),Fo=r("code"),Hs=l("__call__"),Us=l(" special method."),Gs=u(),v(Ie.$$.fragment),Vs=u(),v(Be.$$.fragment),vn=u(),le=r("h2"),qe=r("a"),zo=r("span"),v(pt.$$.fragment),Js=u(),xo=r("span"),Ks=l("IBertForMaskedLM"),wn=u(),z=r("div"),v(ht.$$.fragment),Ys=u(),mt=r("p"),Zs=l("I-BERT Model with a "),Eo=r("code"),Xs=l("language modeling"),er=l(" head on top."),tr=u(),ut=r("p"),or=l("This model inherits from "),Xt=r("a"),nr=l("PreTrainedModel"),sr=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rr=u(),ft=r("p"),ar=l("This model is also a PyTorch "),gt=r("a"),ir=l("torch.nn.Module"),lr=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dr=u(),P=r("div"),v(_t.$$.fragment),cr=u(),de=r("p"),pr=l("The "),eo=r("a"),hr=l("IBertForMaskedLM"),mr=l(" forward method, overrides the "),Co=r("code"),ur=l("__call__"),fr=l(" special method."),gr=u(),v(Me.$$.fragment),_r=u(),v(Fe.$$.fragment),br=u(),v(ze.$$.fragment),$n=u(),ce=r("h2"),xe=r("a"),jo=r("span"),v(bt.$$.fragment),kr=u(),Po=r("span"),vr=l("IBertForSequenceClassification"),Tn=u(),x=r("div"),v(kt.$$.fragment),wr=u(),Ao=r("p"),$r=l(`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xr=u(),M=r("div"),v(Tt.$$.fragment),Er=u(),pe=r("p"),Cr=l("The "),oo=r("a"),jr=l("IBertForSequenceClassification"),Pr=l(" forward method, overrides the "),Lo=r("code"),Ar=l("__call__"),Lr=l(" special method."),Sr=u(),v(Ee.$$.fragment),Or=u(),v(Ce.$$.fragment),Rr=u(),v(je.$$.fragment),Nr=u(),v(Pe.$$.fragment),Dr=u(),v(Ae.$$.fragment),yn=u(),he=r("h2"),Le=r("a"),So=r("span"),v(yt.$$.fragment),Wr=u(),Oo=r("span"),Qr=l("IBertForMultipleChoice"),In=u(),E=r("div"),v(It.$$.fragment),Hr=u(),Ro=r("p"),Ur=l(`I-BERT Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Gr=u(),Bt=r("p"),Vr=l("This model inherits from "),no=r("a"),Jr=l("PreTrainedModel"),Kr=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yr=u(),qt=r("p"),Zr=l("This model is also a PyTorch "),Mt=r("a"),Xr=l("torch.nn.Module"),ea=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta=u(),N=r("div"),v(Ft.$$.fragment),oa=u(),me=r("p"),na=l("The "),so=r("a"),sa=l("IBertForMultipleChoice"),ra=l(" forward method, overrides the "),No=r("code"),aa=l("__call__"),ia=l(" special method."),la=u(),v(Se.$$.fragment),da=u(),v(Oe.$$.fragment),Bn=u(),ue=r("h2"),Re=r("a"),Do=r("span"),v(zt.$$.fragment),ca=u(),Wo=r("span"),pa=l("IBertForTokenClassification"),qn=u(),C=r("div"),v(xt.$$.fragment),ha=u(),Qo=r("p"),ma=l(`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),ua=u(),Et=r("p"),fa=l("This model inherits from "),ro=r("a"),ga=l("PreTrainedModel"),_a=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ba=u(),Ct=r("p"),ka=l("This model is also a PyTorch "),jt=r("a"),va=l("torch.nn.Module"),wa=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$a=u(),A=r("div"),v(Pt.$$.fragment),Ta=u(),fe=r("p"),ya=l("The "),ao=r("a"),Ia=l("IBertForTokenClassification"),Ba=l(" forward method, overrides the "),Ho=r("code"),qa=l("__call__"),Ma=l(" special method."),Fa=u(),v(Ne.$$.fragment),za=u(),v(De.$$.fragment),xa=u(),v(We.$$.fragment),Mn=u(),ge=r("h2"),Qe=r("a"),Uo=r("span"),v(At.$$.fragment),Ea=u(),Go=r("span"),Ca=l("IBertForQuestionAnswering"),Fn=u(),j=r("div"),v(Lt.$$.fragment),ja=u(),_e=r("p"),Pa=l(`I-BERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vo=r("code"),Aa=l("span start logits"),La=l(" and "),Jo=r("code"),Sa=l("span end logits"),Oa=l(")."),Ra=u(),St=r("p"),Na=l("This model inherits from "),io=r("a"),Da=l("PreTrainedModel"),Wa=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qa=u(),Ot=r("p"),Ha=l("This model is also a PyTorch "),Rt=r("a"),Ua=l("torch.nn.Module"),Ga=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Va=u(),L=r("div"),v(Nt.$$.fragment),Ja=u(),be=r("p"),Ka=l("The "),lo=r("a"),Ya=l("IBertForQuestionAnswering"),Za=l(" forward method, overrides the "),Ko=r("code"),Xa=l("__call__"),ei=l(" special method."),ti=u(),v(He.$$.fragment),oi=u(),v(Ue.$$.fragment),ni=u(),v(Ge.$$.fragment),this.h()},l(t){const _=dl('[data-svelte="svelte-1phssyn"]',document.head);s=a(_,"META",{name:!0,content:!0}),_.forEach(o),g=f(t),c=a(t,"H1",{class:!0});var Dt=i(c);p=a(Dt,"A",{id:!0,class:!0,href:!0});var Yo=i(p);b=a(Yo,"SPAN",{});var Zo=i(b);w(n.$$.fragment,Zo),Zo.forEach(o),Yo.forEach(o),h=f(Dt),q=a(Dt,"SPAN",{});var Xo=i(q);Yn=d(Xo,"I-BERT"),Xo.forEach(o),Dt.forEach(o),pn=f(t),oe=a(t,"H2",{class:!0});var Wt=i(oe);we=a(Wt,"A",{id:!0,class:!0,href:!0});var en=i(we);wo=a(en,"SPAN",{});var tn=i(wo);w(Ke.$$.fragment,tn),tn.forEach(o),en.forEach(o),Zn=f(Wt),$o=a(Wt,"SPAN",{});var on=i($o);Xn=d(on,"Overview"),on.forEach(o),Wt.forEach(o),hn=f(t),$e=a(t,"P",{});var Qt=i($e);es=d(Qt,"The I-BERT model was proposed in "),Ye=a(Qt,"A",{href:!0,rel:!0});var nn=i(Ye);ts=d(nn,"I-BERT: Integer-only BERT Quantization"),nn.forEach(o),os=d(Qt,` by
Sehoon Kim, Amir Gholami, Zhewei Yao, Michael W. Mahoney and Kurt Keutzer. It\u2019s a quantized version of RoBERTa running
inference up to four times faster.`),Qt.forEach(o),mn=f(t),Ut=a(t,"P",{});var sn=i(Ut);ns=d(sn,"The abstract from the paper is the following:"),sn.forEach(o),un=f(t),Gt=a(t,"P",{});var rn=i(Gt);To=a(rn,"EM",{});var an=i(To);ss=d(an,`Transformer based models, like BERT and RoBERTa, have achieved state-of-the-art results in many Natural Language
Processing tasks. However, their memory footprint, inference latency, and power consumption are prohibitive for
efficient inference at the edge, and even at the data center. While quantization can be a viable solution for this,
previous work on quantizing Transformer based models use floating-point arithmetic during inference, which cannot
efficiently utilize integer-only logical units such as the recent Turing Tensor Cores, or traditional integer-only ARM
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),jn.forEach(o),Rs=f(D),R=a(D,"DIV",{class:!0});var Ve=i(R);w(ct.$$.fragment,Ve),Ns=f(Ve),ie=a(Ve,"P",{});var mo=i(ie);Ds=d(mo,"The "),Zt=a(mo,"A",{href:!0});var _i=i(Zt);Ws=d(_i,"IBertModel"),_i.forEach(o),Qs=d(mo," forward method, overrides the "),Fo=a(mo,"CODE",{});var bi=i(Fo);Hs=d(bi,"__call__"),bi.forEach(o),Us=d(mo," special method."),mo.forEach(o),Gs=f(Ve),w(Ie.$$.fragment,Ve),Vs=f(Ve),w(Be.$$.fragment,Ve),Ve.forEach(o),D.forEach(o),vn=f(t),le=a(t,"H2",{class:!0});var Pn=i(le);qe=a(Pn,"A",{id:!0,class:!0,href:!0});var ki=i(qe);zo=a(ki,"SPAN",{});var vi=i(zo);w(pt.$$.fragment,vi),vi.forEach(o),ki.forEach(o),Js=f(Pn),xo=a(Pn,"SPAN",{});var wi=i(xo);Ks=d(wi,"IBertForMaskedLM"),wi.forEach(o),Pn.forEach(o),wn=f(t),z=a(t,"DIV",{class:!0});var V=i(z);w(ht.$$.fragment,V),Ys=f(V),mt=a(V,"P",{});var An=i(mt);Zs=d(An,"I-BERT Model with a "),Eo=a(An,"CODE",{});var $i=i(Eo);Xs=d($i,"language modeling"),$i.forEach(o),er=d(An," head on top."),An.forEach(o),tr=f(V),ut=a(V,"P",{});var Ln=i(ut);or=d(Ln,"This model inherits from "),Xt=a(Ln,"A",{href:!0});var Ti=i(Xt);nr=d(Ti,"PreTrainedModel"),Ti.forEach(o),sr=d(Ln,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ln.forEach(o),rr=f(V),ft=a(V,"P",{});var Sn=i(ft);ar=d(Sn,"This model is also a PyTorch "),gt=a(Sn,"A",{href:!0,rel:!0});var yi=i(gt);ir=d(yi,"torch.nn.Module"),yi.forEach(o),lr=d(Sn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sn.forEach(o),dr=f(V),P=a(V,"DIV",{class:!0});var J=i(P);w(_t.$$.fragment,J),cr=f(J),de=a(J,"P",{});var uo=i(de);pr=d(uo,"The "),eo=a(uo,"A",{href:!0});var Ii=i(eo);hr=d(Ii,"IBertForMaskedLM"),Ii.forEach(o),mr=d(uo," forward method, overrides the "),Co=a(uo,"CODE",{});var Bi=i(Co);ur=d(Bi,"__call__"),Bi.forEach(o),fr=d(uo," special method."),uo.forEach(o),gr=f(J),w(Me.$$.fragment,J),_r=f(J),w(Fe.$$.fragment,J),br=f(J),w(ze.$$.fragment,J),J.forEach(o),V.forEach(o),$n=f(t),ce=a(t,"H2",{class:!0});var On=i(ce);xe=a(On,"A",{id:!0,class:!0,href:!0});var qi=i(xe);jo=a(qi,"SPAN",{});var Mi=i(jo);w(bt.$$.fragment,Mi),Mi.forEach(o),qi.forEach(o),kr=f(On),Po=a(On,"SPAN",{});var Fi=i(Po);vr=d(Fi,"IBertForSequenceClassification"),Fi.forEach(o),On.forEach(o),Tn=f(t),x=a(t,"DIV",{class:!0});var K=i(x);w(kt.$$.fragment,K),wr=f(K),Ao=a(K,"P",{});var zi=i(Ao);$r=d(zi,`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
