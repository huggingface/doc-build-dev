import{S as As,i as Is,s as Os,e as a,k as d,w as k,t as n,M as Ss,c as s,d as o,m as c,a as i,x as y,h as r,b as l,F as e,g as p,y as L,L as Cs,q as b,o as v,B as w,v as Us}from"../../chunks/vendor-6b77c823.js";import{D as O}from"../../chunks/Docstring-1088f2fb.js";import{C as Ds}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Vt}from"../../chunks/IconCopyLink-7a11ce68.js";function Ws(ga){let S,Ht,C,j,dt,ne,Mo,ct,Xo,Gt,U,V,ut,re,Eo,pt,qo,Yt,q,$o,ae,Fo,Po,se,No,Do,Jt,Fe,Ao,Zt,Pe,mt,Io,Kt,Ne,Oo,Qt,ie,eo,$,So,De,Co,Uo,Ae,Wo,Ro,to,le,oo,z,Bo,Ie,jo,Vo,Oe,Ho,Go,Se,Yo,Jo,Ce,Zo,Ko,no,H,Qo,Ue,en,tn,ro,F,on,de,nn,rn,ce,an,sn,ao,W,G,ft,ue,ln,ht,dn,so,_,pe,cn,E,un,We,pn,mn,Re,fn,hn,me,_n,gn,kn,fe,yn,Be,Ln,bn,vn,Y,he,wn,_t,xn,Tn,P,_e,zn,gt,Mn,Xn,ge,je,En,kt,qn,$n,Ve,Fn,yt,Pn,Nn,J,ke,Dn,ye,An,Lt,In,On,Sn,Z,Le,Cn,bt,Un,Wn,He,be,io,R,K,vt,ve,Rn,wt,Bn,lo,M,we,jn,X,Vn,xt,Hn,Gn,Ge,Yn,Jn,Ye,Zn,Kn,xe,Qn,er,tr,Te,or,Je,nr,rr,ar,Q,ze,sr,Tt,ir,co,B,ee,zt,Me,lr,Mt,dr,uo,T,Xe,cr,Xt,ur,pr,Ze,Ke,mr,fr,hr,h,_r,Qe,gr,kr,et,yr,Lr,tt,br,vr,Et,wr,xr,qt,Tr,zr,$t,Mr,Xr,Ft,Er,qr,Pt,$r,Fr,Nt,Pr,Nr,Dr,N,Ee,Ar,m,Ir,Dt,Or,Sr,qe,At,Cr,Ur,Wr,ot,Rr,Br,It,jr,Vr,Ot,Hr,Gr,$e,St,Yr,Jr,Zr,Ct,Kr,Qr,nt,ea,ta,Ut,oa,na,Wt,ra,aa,Rt,sa,ia,Bt,la,da,ca,jt,ua,po;return ne=new Vt({}),re=new Vt({}),ie=new Ds({props:{code:`from transformers import LayoutLMv2Model
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17038/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L447",returnDescription:`
<p>A <a
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17038/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L319",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17038/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L345",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17038/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L373",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),be=new O({props:{name:"save_vocabulary",anchor:"transformers.LayoutXLMTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17038/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L430"}}),ve=new Vt({}),we=new O({props:{name:"class transformers.LayoutXLMTokenizerFast",anchor:"transformers.LayoutXLMTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutXLMTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17038/src/transformers/models/layoutxlm/tokenization_layoutxlm_fast.py#L171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17038/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
`),Oe=a("a"),Ho=n("LayoutLMv2FeatureExtractor"),Go=n(` and
`),Se=a("a"),Yo=n("LayoutXLMTokenizer"),Jo=n("/"),Ce=a("a"),Zo=n("LayoutXLMTokenizerFast"),Ko=n(` in sequence) to prepare all
data for the model.`),no=d(),H=a("p"),Qo=n("As LayoutXLM\u2019s architecture is equivalent to that of LayoutLMv2, one can refer to "),Ue=a("a"),en=n("LayoutLMv2\u2019s documentation page"),tn=n(" for all tips, code examples and notebooks."),ro=d(),F=a("p"),on=n("This model was contributed by "),de=a("a"),nn=n("nielsr"),rn=n(". The original code can be found "),ce=a("a"),an=n("here"),sn=n("."),ao=d(),W=a("h2"),G=a("a"),ft=a("span"),k(ue.$$.fragment),ln=d(),ht=a("span"),dn=n("LayoutXLMTokenizer"),so=d(),_=a("div"),k(pe.$$.fragment),cn=d(),E=a("p"),un=n("Adapted from "),We=a("a"),pn=n("RobertaTokenizer"),mn=n(" and "),Re=a("a"),fn=n("XLNetTokenizer"),hn=n(`. Based on
...
not make use of token type ids, therefore a list of zeros is returned.`),Wn=d(),He=a("div"),k(be.$$.fragment),io=d(),R=a("h2"),K=a("a"),vt=a("span"),k(ve.$$.fragment),Rn=d(),wt=a("span"),Bn=n("LayoutXLMTokenizerFast"),lo=d(),M=a("div"),k(we.$$.fragment),jn=d(),X=a("p"),Vn=n("Construct a \u201Cfast\u201D LayoutXLM tokenizer (backed by HuggingFace\u2019s "),xt=a("em"),Hn=n("tokenizers"),Gn=n(` library). Adapted from
`),Ge=a("a"),Yn=n("RobertaTokenizer"),Jn=n(" and "),Ye=a("a"),Zn=n("XLNetTokenizer"),Kn=n(`. Based on
...
`),ot=a("a"),Rr=n("LayoutLMv2FeatureExtractor"),Br=n(" was initialized with "),It=a("code"),jr=n("apply_ocr"),Vr=n(" set to "),Ot=a("code"),Hr=n("True"),Gr=n(`, it passes the obtained words and
...
`),Oe=s(D,"A",{href:!0});var Pa=i(Oe);Ho=r(Pa,"LayoutLMv2FeatureExtractor"),Pa.forEach(o),Go=r(D,` and
...
sequences with word-level normalized bounding boxes and optional labels.`),Va.forEach(o),ko.forEach(o),Tn=c(x),P=s(x,"DIV",{class:!0});var it=i(P);y(_e.$$.fragment,it),zn=c(it),gt=s(it,"P",{});var Ha=i(gt);Mn=r(Ha,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Ha.forEach(o),Xn=c(it),ge=s(it,"UL",{});var yo=i(ge);je=s(yo,"LI",{});var pa=i(je);En=r(pa,"single sequence: "),kt=s(pa,"CODE",{});var Ga=i(kt);qn=r(Ga,"<s> X </s>"),Ga.forEach(o),pa.forEach(o),$n=c(yo),Ve=s(yo,"LI",{});var ma=i(Ve);Fn=r(ma,"pair of sequences: "),yt=s(ma,"CODE",{});var Ya=i(yt);Pn=r(Ya,"<s> A </s></s> B </s>"),Ya.forEach(o),ma.forEach(o),yo.forEach(o),it.forEach(o),Nn=c(x),J=s(x,"DIV",{class:!0});var Lo=i(J);y(ke.$$.fragment,Lo),Dn=c(Lo),ye=s(Lo,"P",{});var bo=i(ye);An=r(bo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
not make use of token type ids, therefore a list of zeros is returned.`),Za.forEach(o),vo.forEach(o),Wn=c(x),He=s(x,"DIV",{class:!0});var Ka=i(He);y(be.$$.fragment,Ka),Ka.forEach(o),x.forEach(o),io=c(t),R=s(t,"H2",{class:!0});var wo=i(R);K=s(wo,"A",{id:!0,class:!0,href:!0});var Qa=i(K);vt=s(Qa,"SPAN",{});var es=i(vt);y(ve.$$.fragment,es),es.forEach(o),Qa.forEach(o),Rn=c(wo),wt=s(wo,"SPAN",{});var ts=i(wt);Bn=r(ts,"LayoutXLMTokenizerFast"),ts.forEach(o),wo.forEach(o),lo=c(t),M=s(t,"DIV",{class:!0});var oe=i(M);y(we.$$.fragment,oe),jn=c(oe),X=s(oe,"P",{});var A=i(X);Vn=r(A,"Construct a \u201Cfast\u201D LayoutXLM tokenizer (backed by HuggingFace\u2019s "),xt=s(A,"EM",{});var os=i(xt);Hn=r(os,"tokenizers"),os.forEach(o),Gn=r(A,` library). Adapted from
`),Ge=s(A,"A",{href:!0});var ns=i(Ge);Yn=r(ns,"RobertaTokenizer"),ns.forEach(o),Jn=r(A," and "),Ye=s(A,"A",{href:!0});var rs=i(Ye);Zn=r(rs,"XLNetTokenizer"),rs.forEach(o),Kn=r(A,`. Based on
...
`),ot=s(f,"A",{href:!0});var xs=i(ot);Rr=r(xs,"LayoutLMv2FeatureExtractor"),xs.forEach(o),Br=r(f," was initialized with "),It=s(f,"CODE",{});var Ts=i(It);jr=r(Ts,"apply_ocr"),Ts.forEach(o),Vr=r(f," set to "),Ot=s(f,"CODE",{});var zs=i(Ot);Hr=r(zs,"True"),zs.forEach(o),Gr=r(f,`, it passes the obtained words and
