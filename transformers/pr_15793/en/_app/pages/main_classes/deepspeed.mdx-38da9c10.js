...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
to no avail, the next thing to try is to pre-build the modules before installing them.`),Tj=u(),Gp=o("p"),X5=a("To make a local build for DeepSpeed:"),Aj=u(),f(so.$$.fragment),Sj=u(),De=o("p"),Q5=a("If you intend to use NVMe offload you will also need to include "),Kh=o("code"),e$=a("DS_BUILD_AIO=1"),s$=a(` in the instructions above (and also
install `),Jh=o("em"),t$=a("libaio-dev"),a$=a(" system-wide)."),Cj=u(),jt=o("p"),n$=a("Edit "),Xh=o("code"),o$=a("TORCH_CUDA_ARCH_LIST"),l$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),xj=u(),f(to.$$.fragment),Rj=u(),ge=o("p"),r$=a("So if you get "),Qh=o("code"),p$=a("8, 6"),i$=a(", then use "),ef=o("code"),u$=a('TORCH_CUDA_ARCH_LIST="8.6"'),c$=a(`. If you have multiple different cards, you can list all
of them like so `),sf=o("code"),h$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Ij=u(),Lp=o("p"),f$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Uj=u(),f(ao.$$.fragment),Gj=u(),Oe=o("p"),d$=a("it will generate something like "),tf=o("code"),m$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_$=a(` which now you can install
as `),af=o("code"),v$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),j$=a(" locally or on any other machine."),Lj=u(),gt=o("p"),g$=a("Again, remember to ensure to adjust "),nf=o("code"),y$=a("TORCH_CUDA_ARCH_LIST"),w$=a(" to the target architectures."),Mj=u(),Te=o("p"),b$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),of=o("strong"),q$=a("Compute Capabilities"),E$=a(` (same as arch in this
context) `),no=o("a"),$$=a("here"),k$=a("."),Zj=u(),Mp=o("p"),P$=a("You can check the archs pytorch was built with using:"),Nj=u(),f(oo.$$.fragment),Hj=u(),Zp=o("p"),z$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Bj=u(),f(lo.$$.fragment),Wj=u(),Np=o("p"),D$=a("If the output is:"),Fj=u(),f(ro.$$.fragment),Vj=u(),yt=o("p"),O$=a("then you know that this card\u2019s arch is "),lf=o("code"),T$=a("8.6"),A$=a("."),Yj=u(),wt=o("p"),S$=a("You can also leave "),rf=o("code"),C$=a("TORCH_CUDA_ARCH_LIST"),x$=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Kj=u(),bt=o("p"),R$=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),po=o("a"),I$=a("Deepspeed"),U$=a(","),Jj=u(),Hp=o("a"),Xj=u(),ys=o("h3"),qt=o("a"),pf=o("span"),f(io.$$.fragment),G$=u(),uf=o("span"),L$=a("Deployment with multiple GPUs"),Qj=u(),Et=o("p"),M$=a("To deploy this feature with multiple GPUs adjust the "),Bp=o("a"),Z$=a("Trainer"),N$=a(` command line arguments as
following:`),eg=u(),$t=o("ol"),ws=o("li"),H$=a("replace "),cf=o("code"),B$=a("python -m torch.distributed.launch"),W$=a(" with "),hf=o("code"),F$=a("deepspeed"),V$=a("."),Y$=u(),ye=o("li"),K$=a("add a new argument "),ff=o("code"),J$=a("--deepspeed ds_config.json"),X$=a(", where "),df=o("code"),Q$=a("ds_config.json"),e6=a(` is the DeepSpeed configuration file as
...
to the console, so you can see exactly what was the final configuration passed to it.`),Xg=u(),ui=o("a"),Qg=u(),ks=o("h3"),Ht=o("a"),Bf=o("span"),f(Ro.$$.fragment),Q4=u(),Wf=o("span"),e7=a("Passing Configuration"),ey=u(),T=o("p"),s7=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ci=o("a"),t7=a("Trainer"),a7=a(" via "),hi=o("a"),n7=a("TrainingArguments"),o7=a(" then for the "),Ff=o("code"),l7=a("deepspeed"),r7=a(` argument you can
pass a nested `),Vf=o("code"),p7=a("dict"),i7=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),fi=o("a"),u7=a("TrainingArguments"),c7=a("."),sy=u(),di=o("p"),h7=a("To summarize you can do:"),ty=u(),f(Io.$$.fragment),ay=u(),mi=o("p"),f7=a("or:"),ny=u(),f(Uo.$$.fragment),oy=u(),_i=o("a"),ly=u(),Ps=o("h3"),Bt=o("a"),Yf=o("span"),f(Go.$$.fragment),d7=u(),Kf=o("span"),m7=a("Shared Configuration"),ry=u(),f(Wt.$$.fragment),py=u(),Ce=o("p"),_7=a("Some configuration values are required by both the "),vi=o("a"),v7=a("Trainer"),j7=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),ji=o("a"),g7=a("Trainer"),y7=a(" command line arguments."),iy=u(),Ft=o("p"),w7=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),gi=o("a"),b7=a("Trainer"),q7=a(` do the majority
of configuration for you.`),uy=u(),xe=o("p"),E7=a("Therefore, in the rest of this guide you will find a special configuration value: "),Jf=o("code"),$7=a("auto"),k7=a(`, which when set will be
...
`),yi=o("a"),P7=a("Trainer"),z7=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),cy=u(),wi=o("p"),D7=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),hy=u(),Vt=o("p"),O7=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),bi=o("a"),T7=a("TrainingArguments"),A7=a(" based on that. The steps are:"),fy=u(),Yt=o("ol"),Xf=o("li"),S7=a("Create or load the DeepSpeed configuration to be used as a master configuration"),C7=u(),Lo=o("li"),x7=a("Create the "),qi=o("a"),R7=a("TrainingArguments"),I7=a(" object based on these values"),dy=u(),Q=o("p"),U7=a("Do note that some values, such as "),Qf=o("code"),G7=a("scheduler.params.total_num_steps"),L7=a(` are calculated by
`),Ei=o("a"),M7=a("Trainer"),Z7=a(" during "),ed=o("code"),N7=a("train"),H7=a(", but you can of course do the math yourself."),my=u(),$i=o("a"),_y=u(),zs=o("h3"),Kt=o("a"),sd=o("span"),f(Mo.$$.fragment),B7=u(),td=o("span"),W7=a("ZeRO"),vy=u(),Zo=o("p"),No=o("a"),F7=a("Zero Redundancy Optimizer (ZeRO)"),V7=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),jy=u(),Re=o("p"),Y7=a("The "),ad=o("code"),K7=a("zero_optimization"),J7=a(" section of the configuration file is the most important part ("),Ho=o("a"),X7=a("docs"),Q7=a(`), since that is where you define
...
and its typically accessed much faster than normal CPU memory.`),Ry=u(),Ci=o("p"),kd=o("strong"),J9=a("Performance tuning:"),Iy=u(),ea=o("ul"),Ko=o("li"),Pd=o("code"),X9=a("stage3_max_live_parameters"),Q9=a(": "),zd=o("code"),e8=a("1e9"),s8=u(),Jo=o("li"),Dd=o("code"),t8=a("stage3_max_reuse_distance"),a8=a(": "),Od=o("code"),n8=a("1e9"),Uy=u(),S=o("p"),o8=a("If hitting OOM reduce "),Td=o("code"),l8=a("stage3_max_live_parameters"),r8=a(" and "),Ad=o("code"),p8=a("stage3_max_reuse_distance"),i8=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Sd=o("code"),u8=a("1e9"),c8=a(` would consume ~2GB. The memory is shared by
`),Cd=o("code"),h8=a("stage3_max_live_parameters"),f8=a(" and "),xd=o("code"),d8=a("stage3_max_reuse_distance"),m8=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Gy=u(),we=o("p"),Rd=o("code"),_8=a("stage3_max_live_parameters"),v8=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Id=o("code"),j8=a("stage3_max_reuse_distance"),g8=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Ud=o("code"),y8=a("stage3_max_reuse_distance"),w8=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ly=u(),xi=o("p"),b8=a("The following configuration values depend on the model\u2019s hidden size:"),My=u(),Le=o("ul"),Xo=o("li"),Gd=o("code"),q8=a("reduce_bucket_size"),E8=a(": "),Ld=o("code"),$8=a("hidden_size*hidden_size"),k8=u(),Qo=o("li"),Md=o("code"),P8=a("stage3_prefetch_bucket_size"),z8=a(": "),Zd=o("code"),D8=a("0.9 * hidden_size * hidden_size"),O8=u(),el=o("li"),Nd=o("code"),T8=a("stage3_param_persistence_threshold"),A8=a(": "),Hd=o("code"),S8=a("10 * hidden_size"),Zy=u(),Me=o("p"),C8=a("therefore set these values to "),Bd=o("code"),x8=a("auto"),R8=a(" and the "),Ri=o("a"),I8=a("Trainer"),U8=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),Ny=u(),sl=o("p"),Wd=o("code"),G8=a("stage3_gather_fp16_weights_on_model_save"),L8=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Hy=u(),ee=o("p"),M8=a("If you\u2019re migrating from ZeRO-2 configuration note that "),Fd=o("code"),Z8=a("allgather_partitions"),N8=a(", "),Vd=o("code"),H8=a("allgather_bucket_size"),B8=a(` and
`),Yd=o("code"),W8=a("reduce_scatter"),F8=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),By=u(),Ii=o("ul"),tl=o("li"),Kd=o("code"),V8=a("sub_group_size"),Y8=a(": "),Jd=o("code"),K8=a("1e9"),Wy=u(),be=o("p"),Xd=o("code"),J8=a("sub_group_size"),X8=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),Qd=o("code"),Q8=a("sub_group_size"),ek=a(` and each buckets is updated one at a time. When used with NVMe offload in
...
to no avail, the next thing to try is to pre-build the modules before installing them.`),IU.forEach(t),Tj=c(e),Gp=l(e,"P",{});var UU=r(Gp);X5=n(UU,"To make a local build for DeepSpeed:"),UU.forEach(t),Aj=c(e),d(so.$$.fragment,e),Sj=c(e),De=l(e,"P",{});var Bc=r(De);Q5=n(Bc,"If you intend to use NVMe offload you will also need to include "),Kh=l(Bc,"CODE",{});var GU=r(Kh);e$=n(GU,"DS_BUILD_AIO=1"),GU.forEach(t),s$=n(Bc,` in the instructions above (and also
install `),Jh=l(Bc,"EM",{});var LU=r(Jh);t$=n(LU,"libaio-dev"),LU.forEach(t),a$=n(Bc," system-wide)."),Bc.forEach(t),Cj=c(e),jt=l(e,"P",{});var _0=r(jt);n$=n(_0,"Edit "),Xh=l(_0,"CODE",{});var MU=r(Xh);o$=n(MU,"TORCH_CUDA_ARCH_LIST"),MU.forEach(t),l$=n(_0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_0.forEach(t),xj=c(e),d(to.$$.fragment,e),Rj=c(e),ge=l(e,"P",{});var dp=r(ge);r$=n(dp,"So if you get "),Qh=l(dp,"CODE",{});var ZU=r(Qh);p$=n(ZU,"8, 6"),ZU.forEach(t),i$=n(dp,", then use "),ef=l(dp,"CODE",{});var NU=r(ef);u$=n(NU,'TORCH_CUDA_ARCH_LIST="8.6"'),NU.forEach(t),c$=n(dp,`. If you have multiple different cards, you can list all
of them like so `),sf=l(dp,"CODE",{});var HU=r(sf);h$=n(HU,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),HU.forEach(t),dp.forEach(t),Ij=c(e),Lp=l(e,"P",{});var BU=r(Lp);f$=n(BU,"If you need to use the same setup on multiple machines, make a binary wheel:"),BU.forEach(t),Uj=c(e),d(ao.$$.fragment,e),Gj=c(e),Oe=l(e,"P",{});var Wc=r(Oe);d$=n(Wc,"it will generate something like "),tf=l(Wc,"CODE",{});var WU=r(tf);m$=n(WU,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),WU.forEach(t),_$=n(Wc,` which now you can install
as `),af=l(Wc,"CODE",{});var FU=r(af);v$=n(FU,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),FU.forEach(t),j$=n(Wc," locally or on any other machine."),Wc.forEach(t),Lj=c(e),gt=l(e,"P",{});var v0=r(gt);g$=n(v0,"Again, remember to ensure to adjust "),nf=l(v0,"CODE",{});var VU=r(nf);y$=n(VU,"TORCH_CUDA_ARCH_LIST"),VU.forEach(t),w$=n(v0," to the target architectures."),v0.forEach(t),Mj=c(e),Te=l(e,"P",{});var Fc=r(Te);b$=n(Fc,"You can find the complete list of NVIDIA GPUs and their corresponding "),of=l(Fc,"STRONG",{});var YU=r(of);q$=n(YU,"Compute Capabilities"),YU.forEach(t),E$=n(Fc,` (same as arch in this
context) `),no=l(Fc,"A",{href:!0,rel:!0});var KU=r(no);$$=n(KU,"here"),KU.forEach(t),k$=n(Fc,"."),Fc.forEach(t),Zj=c(e),Mp=l(e,"P",{});var JU=r(Mp);P$=n(JU,"You can check the archs pytorch was built with using:"),JU.forEach(t),Nj=c(e),d(oo.$$.fragment,e),Hj=c(e),Zp=l(e,"P",{});var XU=r(Zp);z$=n(XU,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),XU.forEach(t),Bj=c(e),d(lo.$$.fragment,e),Wj=c(e),Np=l(e,"P",{});var QU=r(Np);D$=n(QU,"If the output is:"),QU.forEach(t),Fj=c(e),d(ro.$$.fragment,e),Vj=c(e),yt=l(e,"P",{});var j0=r(yt);O$=n(j0,"then you know that this card\u2019s arch is "),lf=l(j0,"CODE",{});var eG=r(lf);T$=n(eG,"8.6"),eG.forEach(t),A$=n(j0,"."),j0.forEach(t),Yj=c(e),wt=l(e,"P",{});var g0=r(wt);S$=n(g0,"You can also leave "),rf=l(g0,"CODE",{});var sG=r(rf);C$=n(sG,"TORCH_CUDA_ARCH_LIST"),sG.forEach(t),x$=n(g0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),g0.forEach(t),Kj=c(e),bt=l(e,"P",{});var y0=r(bt);R$=n(y0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),po=l(y0,"A",{href:!0,rel:!0});var tG=r(po);I$=n(tG,"Deepspeed"),tG.forEach(t),U$=n(y0,","),y0.forEach(t),Jj=c(e),Hp=l(e,"A",{id:!0}),r(Hp).forEach(t),Xj=c(e),ys=l(e,"H3",{class:!0});var w0=r(ys);qt=l(w0,"A",{id:!0,class:!0,href:!0});var aG=r(qt);pf=l(aG,"SPAN",{});var nG=r(pf);d(io.$$.fragment,nG),nG.forEach(t),aG.forEach(t),G$=c(w0),uf=l(w0,"SPAN",{});var oG=r(uf);L$=n(oG,"Deployment with multiple GPUs"),oG.forEach(t),w0.forEach(t),Qj=c(e),Et=l(e,"P",{});var b0=r(Et);M$=n(b0,"To deploy this feature with multiple GPUs adjust the "),Bp=l(b0,"A",{href:!0});var lG=r(Bp);Z$=n(lG,"Trainer"),lG.forEach(t),N$=n(b0,` command line arguments as
following:`),b0.forEach(t),eg=c(e),$t=l(e,"OL",{});var q0=r($t);ws=l(q0,"LI",{});var Vc=r(ws);H$=n(Vc,"replace "),cf=l(Vc,"CODE",{});var rG=r(cf);B$=n(rG,"python -m torch.distributed.launch"),rG.forEach(t),W$=n(Vc," with "),hf=l(Vc,"CODE",{});var pG=r(hf);F$=n(pG,"deepspeed"),pG.forEach(t),V$=n(Vc,"."),Vc.forEach(t),Y$=c(q0),ye=l(q0,"LI",{});var Pn=r(ye);K$=n(Pn,"add a new argument "),ff=l(Pn,"CODE",{});var iG=r(ff);J$=n(iG,"--deepspeed ds_config.json"),iG.forEach(t),X$=n(Pn,", where "),df=l(Pn,"CODE",{});var uG=r(df);Q$=n(uG,"ds_config.json"),uG.forEach(t),e6=n(Pn,` is the DeepSpeed configuration file as
...
to the console, so you can see exactly what was the final configuration passed to it.`),Z0.forEach(t),Xg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Qg=c(e),ks=l(e,"H3",{class:!0});var N0=r(ks);Ht=l(N0,"A",{id:!0,class:!0,href:!0});var fL=r(Ht);Bf=l(fL,"SPAN",{});var dL=r(Bf);d(Ro.$$.fragment,dL),dL.forEach(t),fL.forEach(t),Q4=c(N0),Wf=l(N0,"SPAN",{});var mL=r(Wf);e7=n(mL,"Passing Configuration"),mL.forEach(t),N0.forEach(t),ey=c(e),T=l(e,"P",{});var fe=r(T);s7=n(fe,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ci=l(fe,"A",{href:!0});var _L=r(ci);t7=n(_L,"Trainer"),_L.forEach(t),a7=n(fe," via "),hi=l(fe,"A",{href:!0});var vL=r(hi);n7=n(vL,"TrainingArguments"),vL.forEach(t),o7=n(fe," then for the "),Ff=l(fe,"CODE",{});var jL=r(Ff);l7=n(jL,"deepspeed"),jL.forEach(t),r7=n(fe,` argument you can
pass a nested `),Vf=l(fe,"CODE",{});var gL=r(Vf);p7=n(gL,"dict"),gL.forEach(t),i7=n(fe,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),fi=l(fe,"A",{href:!0});var yL=r(fi);u7=n(yL,"TrainingArguments"),yL.forEach(t),c7=n(fe,"."),fe.forEach(t),sy=c(e),di=l(e,"P",{});var wL=r(di);h7=n(wL,"To summarize you can do:"),wL.forEach(t),ty=c(e),d(Io.$$.fragment,e),ay=c(e),mi=l(e,"P",{});var bL=r(mi);f7=n(bL,"or:"),bL.forEach(t),ny=c(e),d(Uo.$$.fragment,e),oy=c(e),_i=l(e,"A",{id:!0}),r(_i).forEach(t),ly=c(e),Ps=l(e,"H3",{class:!0});var H0=r(Ps);Bt=l(H0,"A",{id:!0,class:!0,href:!0});var qL=r(Bt);Yf=l(qL,"SPAN",{});var EL=r(Yf);d(Go.$$.fragment,EL),EL.forEach(t),qL.forEach(t),d7=c(H0),Kf=l(H0,"SPAN",{});var $L=r(Kf);m7=n($L,"Shared Configuration"),$L.forEach(t),H0.forEach(t),ry=c(e),d(Wt.$$.fragment,e),py=c(e),Ce=l(e,"P",{});var Xc=r(Ce);_7=n(Xc,"Some configuration values are required by both the "),vi=l(Xc,"A",{href:!0});var kL=r(vi);v7=n(kL,"Trainer"),kL.forEach(t),j7=n(Xc,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),ji=l(Xc,"A",{href:!0});var PL=r(ji);g7=n(PL,"Trainer"),PL.forEach(t),y7=n(Xc," command line arguments."),Xc.forEach(t),iy=c(e),Ft=l(e,"P",{});var B0=r(Ft);w7=n(B0,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),gi=l(B0,"A",{href:!0});var zL=r(gi);b7=n(zL,"Trainer"),zL.forEach(t),q7=n(B0,` do the majority
of configuration for you.`),B0.forEach(t),uy=c(e),xe=l(e,"P",{});var Qc=r(xe);E7=n(Qc,"Therefore, in the rest of this guide you will find a special configuration value: "),Jf=l(Qc,"CODE",{});var DL=r(Jf);$7=n(DL,"auto"),DL.forEach(t),k7=n(Qc,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),yi=l(Qc,"A",{href:!0});var OL=r(yi);P7=n(OL,"Trainer"),OL.forEach(t),z7=n(Qc,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),Qc.forEach(t),cy=c(e),wi=l(e,"P",{});var TL=r(wi);D7=n(TL,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),TL.forEach(t),hy=c(e),Vt=l(e,"P",{});var W0=r(Vt);O7=n(W0,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),bi=l(W0,"A",{href:!0});var AL=r(bi);T7=n(AL,"TrainingArguments"),AL.forEach(t),A7=n(W0," based on that. The steps are:"),W0.forEach(t),fy=c(e),Yt=l(e,"OL",{});var F0=r(Yt);Xf=l(F0,"LI",{});var SL=r(Xf);S7=n(SL,"Create or load the DeepSpeed configuration to be used as a master configuration"),SL.forEach(t),C7=c(F0),Lo=l(F0,"LI",{});var V0=r(Lo);x7=n(V0,"Create the "),qi=l(V0,"A",{href:!0});var CL=r(qi);R7=n(CL,"TrainingArguments"),CL.forEach(t),I7=n(V0," object based on these values"),V0.forEach(t),F0.forEach(t),dy=c(e),Q=l(e,"P",{});var On=r(Q);U7=n(On,"Do note that some values, such as "),Qf=l(On,"CODE",{});var xL=r(Qf);G7=n(xL,"scheduler.params.total_num_steps"),xL.forEach(t),L7=n(On,` are calculated by
`),Ei=l(On,"A",{href:!0});var RL=r(Ei);M7=n(RL,"Trainer"),RL.forEach(t),Z7=n(On," during "),ed=l(On,"CODE",{});var IL=r(ed);N7=n(IL,"train"),IL.forEach(t),H7=n(On,", but you can of course do the math yourself."),On.forEach(t),my=c(e),$i=l(e,"A",{id:!0}),r($i).forEach(t),_y=c(e),zs=l(e,"H3",{class:!0});var Y0=r(zs);Kt=l(Y0,"A",{id:!0,class:!0,href:!0});var UL=r(Kt);sd=l(UL,"SPAN",{});var GL=r(sd);d(Mo.$$.fragment,GL),GL.forEach(t),UL.forEach(t),B7=c(Y0),td=l(Y0,"SPAN",{});var LL=r(td);W7=n(LL,"ZeRO"),LL.forEach(t),Y0.forEach(t),vy=c(e),Zo=l(e,"P",{});var BI=r(Zo);No=l(BI,"A",{href:!0,rel:!0});var ML=r(No);F7=n(ML,"Zero Redundancy Optimizer (ZeRO)"),ML.forEach(t),V7=n(BI,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),BI.forEach(t),jy=c(e),Re=l(e,"P",{});var eh=r(Re);Y7=n(eh,"The "),ad=l(eh,"CODE",{});var ZL=r(ad);K7=n(ZL,"zero_optimization"),ZL.forEach(t),J7=n(eh," section of the configuration file is the most important part ("),Ho=l(eh,"A",{href:!0,rel:!0});var NL=r(Ho);X7=n(NL,"docs"),NL.forEach(t),Q7=n(eh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
...
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),nh.forEach(t),Ry=c(e),Ci=l(e,"P",{});var yM=r(Ci);kd=l(yM,"STRONG",{});var wM=r(kd);J9=n(wM,"Performance tuning:"),wM.forEach(t),yM.forEach(t),Iy=c(e),ea=l(e,"UL",{});var Q0=r(ea);Ko=l(Q0,"LI",{});var eq=r(Ko);Pd=l(eq,"CODE",{});var bM=r(Pd);X9=n(bM,"stage3_max_live_parameters"),bM.forEach(t),Q9=n(eq,": "),zd=l(eq,"CODE",{});var qM=r(zd);e8=n(qM,"1e9"),qM.forEach(t),eq.forEach(t),s8=c(Q0),Jo=l(Q0,"LI",{});var sq=r(Jo);Dd=l(sq,"CODE",{});var EM=r(Dd);t8=n(EM,"stage3_max_reuse_distance"),EM.forEach(t),a8=n(sq,": "),Od=l(sq,"CODE",{});var $M=r(Od);n8=n($M,"1e9"),$M.forEach(t),sq.forEach(t),Q0.forEach(t),Uy=c(e),S=l(e,"P",{});var de=r(S);o8=n(de,"If hitting OOM reduce "),Td=l(de,"CODE",{});var kM=r(Td);l8=n(kM,"stage3_max_live_parameters"),kM.forEach(t),r8=n(de," and "),Ad=l(de,"CODE",{});var PM=r(Ad);p8=n(PM,"stage3_max_reuse_distance"),PM.forEach(t),i8=n(de,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Sd=l(de,"CODE",{});var zM=r(Sd);u8=n(zM,"1e9"),zM.forEach(t),c8=n(de,` would consume ~2GB. The memory is shared by
`),Cd=l(de,"CODE",{});var DM=r(Cd);h8=n(DM,"stage3_max_live_parameters"),DM.forEach(t),f8=n(de," and "),xd=l(de,"CODE",{});var OM=r(xd);d8=n(OM,"stage3_max_reuse_distance"),OM.forEach(t),m8=n(de,", so it\u2019s not additive, it\u2019s just 2GB total."),de.forEach(t),Gy=c(e),we=l(e,"P",{});var mp=r(we);Rd=l(mp,"CODE",{});var TM=r(Rd);_8=n(TM,"stage3_max_live_parameters"),TM.forEach(t),v8=n(mp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Id=l(mp,"CODE",{});var AM=r(Id);j8=n(AM,"stage3_max_reuse_distance"),AM.forEach(t),g8=n(mp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Ud=l(mp,"CODE",{});var SM=r(Ud);y8=n(SM,"stage3_max_reuse_distance"),SM.forEach(t),w8=n(mp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),mp.forEach(t),Ly=c(e),xi=l(e,"P",{});var CM=r(xi);b8=n(CM,"The following configuration values depend on the model\u2019s hidden size:"),CM.forEach(t),My=c(e),Le=l(e,"UL",{});var oh=r(Le);Xo=l(oh,"LI",{});var tq=r(Xo);Gd=l(tq,"CODE",{});var xM=r(Gd);q8=n(xM,"reduce_bucket_size"),xM.forEach(t),E8=n(tq,": "),Ld=l(tq,"CODE",{});var RM=r(Ld);$8=n(RM,"hidden_size*hidden_size"),RM.forEach(t),tq.forEach(t),k8=c(oh),Qo=l(oh,"LI",{});var aq=r(Qo);Md=l(aq,"CODE",{});var IM=r(Md);P8=n(IM,"stage3_prefetch_bucket_size"),IM.forEach(t),z8=n(aq,": "),Zd=l(aq,"CODE",{});var UM=r(Zd);D8=n(UM,"0.9 * hidden_size * hidden_size"),UM.forEach(t),aq.forEach(t),O8=c(oh),el=l(oh,"LI",{});var nq=r(el);Nd=l(nq,"CODE",{});var GM=r(Nd);T8=n(GM,"stage3_param_persistence_threshold"),GM.forEach(t),A8=n(nq,": "),Hd=l(nq,"CODE",{});var LM=r(Hd);S8=n(LM,"10 * hidden_size"),LM.forEach(t),nq.forEach(t),oh.forEach(t),Zy=c(e),Me=l(e,"P",{});var lh=r(Me);C8=n(lh,"therefore set these values to "),Bd=l(lh,"CODE",{});var MM=r(Bd);x8=n(MM,"auto"),MM.forEach(t),R8=n(lh," and the "),Ri=l(lh,"A",{href:!0});var ZM=r(Ri);I8=n(ZM,"Trainer"),ZM.forEach(t),U8=n(lh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),lh.forEach(t),Ny=c(e),sl=l(e,"P",{});var WI=r(sl);Wd=l(WI,"CODE",{});var NM=r(Wd);G8=n(NM,"stage3_gather_fp16_weights_on_model_save"),NM.forEach(t),L8=n(WI,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),WI.forEach(t),Hy=c(e),ee=l(e,"P",{});var Tn=r(ee);M8=n(Tn,"If you\u2019re migrating from ZeRO-2 configuration note that "),Fd=l(Tn,"CODE",{});var HM=r(Fd);Z8=n(HM,"allgather_partitions"),HM.forEach(t),N8=n(Tn,", "),Vd=l(Tn,"CODE",{});var BM=r(Vd);H8=n(BM,"allgather_bucket_size"),BM.forEach(t),B8=n(Tn,` and
`),Yd=l(Tn,"CODE",{});var WM=r(Yd);W8=n(WM,"reduce_scatter"),WM.forEach(t),F8=n(Tn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Tn.forEach(t),By=c(e),Ii=l(e,"UL",{});var FM=r(Ii);tl=l(FM,"LI",{});var oq=r(tl);Kd=l(oq,"CODE",{});var VM=r(Kd);V8=n(VM,"sub_group_size"),VM.forEach(t),Y8=n(oq,": "),Jd=l(oq,"CODE",{});var YM=r(Jd);K8=n(YM,"1e9"),YM.forEach(t),oq.forEach(t),FM.forEach(t),Wy=c(e),be=l(e,"P",{});var _p=r(be);Xd=l(_p,"CODE",{});var KM=r(Xd);J8=n(KM,"sub_group_size"),KM.forEach(t),X8=n(_p,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),Qd=l(_p,"CODE",{});var JM=r(Qd);Q8=n(JM,"sub_group_size"),JM.forEach(t),ek=n(_p,` and each buckets is updated one at a time. When used with NVMe offload in
