import{S as As,i as Os,s as qs,e as r,k as d,w as g,t as o,L as Ss,c as a,d as t,m as c,a as s,x as _,h as n,b as m,J as e,g as z,y as b,q as y,o as v,B as w}from"../../chunks/vendor-9e2b328e.js";import{T as Ta}from"../../chunks/Tip-76f97a76.js";import{D as E}from"../../chunks/Docstring-50fd6873.js";import{C as js}from"../../chunks/CodeBlock-88e23343.js";import{I as zs}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Fs(B){let h,P,u,p,j;return{c(){h=r("p"),P=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),u=r("strong"),p=o("not"),j=o(" load the model weights. It only affects the model\u2019s configuration.")},l(k){h=a(k,"P",{});var C=s(h);P=n(C,`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),u=a(C,"STRONG",{});var q=s(u);p=n(q,"not"),q.forEach(t),j=n(C," load the model weights. It only affects the model\u2019s configuration."),C.forEach(t)},m(k,C){z(k,h,C),e(h,P),e(h,u),e(u,p),e(h,j)},d(k){k&&t(h)}}}function Is(B){let h,P,u,p,j;return{c(){h=r("p"),P=o("Passing "),u=r("code"),p=o("use_auth_token=True"),j=o(" is required when you want to use a private model.")},l(k){h=a(k,"P",{});var C=s(h);P=n(C,"Passing "),u=a(C,"CODE",{});var q=s(u);p=n(q,"use_auth_token=True"),q.forEach(t),j=n(C," is required when you want to use a private model."),C.forEach(t)},m(k,C){z(k,h,C),e(h,P),e(h,u),e(u,p),e(h,j)},d(k){k&&t(h)}}}function Ls(B){let h,P;return{c(){h=r("p"),P=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){h=a(u,"P",{});var p=s(h);P=n(p,"This API is experimental and may have some slight breaking changes in the next releases."),p.forEach(t)},m(u,p){z(u,h,p),e(h,P)},d(u){u&&t(h)}}}function Ns(B){let h,P,u,p,j,k,C,q,jo,ao,G,zo,Ge,Ao,Oo,so,T,qo,it,So,Fo,dt,Io,Lo,ct,No,Mo,lt,Wo,Ho,io,J,X,ft,we,Vo,ht,Bo,co,l,$e,Jo,mt,Ro,Uo,K,Go,ut,Xo,Ko,S,M,pt,Qo,Yo,gt,Zo,en,Xe,tn,on,nn,x,_t,rn,an,bt,sn,dn,Ke,cn,ln,Qe,fn,hn,Ye,mn,un,pn,Q,yt,gn,_n,vt,bn,yn,vn,Y,wt,wn,$n,$t,kn,Pn,Cn,kt,En,Tn,F,Z,Pt,xn,Dn,Ct,jn,zn,An,ee,Et,On,qn,Tt,Sn,Fn,In,te,xt,Ln,Nn,Dt,Mn,Wn,Hn,oe,jt,Vn,Bn,zt,Jn,Rn,Un,A,ke,Gn,Pe,Xn,At,Kn,Qn,Yn,Ot,Zn,er,Ce,tr,ne,Ee,or,I,nr,qt,rr,ar,St,sr,ir,Ft,dr,cr,lr,re,Te,fr,xe,hr,Ze,mr,ur,pr,ae,De,gr,je,_r,et,br,yr,vr,D,ze,wr,Ae,$r,tt,kr,Pr,Cr,se,Er,It,Tr,xr,Oe,Dr,ie,qe,jr,L,zr,Lt,Ar,Or,ot,qr,Sr,Nt,Fr,Ir,Lr,W,Se,Nr,Fe,Mr,Mt,Wr,Hr,Vr,de,Br,ce,Ie,Jr,R,Rr,Wt,Ur,Gr,nt,Xr,Kr,Qr,le,Le,Yr,Ht,Zr,ea,fe,Ne,ta,Vt,oa,na,he,Me,ra,Bt,aa,sa,me,We,ia,Jt,da,ca,ue,He,la,Ve,fa,Rt,ha,ma,ua,O,Be,pa,Je,ga,Ut,_a,ba,ya,U,va,Gt,wa,$a,Xt,ka,Pa,Ca,Kt,Ea,lo;return k=new zs({}),we=new zs({}),$e=new E({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/configuration_utils.py#L53",parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/pr_15793/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/pr_15793/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
that can be used as decoder models within the <a href="/docs/transformers/pr_15793/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Whether the model should return a <a
  href="/docs/transformers/pr_15793/en/main_classes/output#transformers.file_utils.ModelOutput"
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),De=new E({props:{name:"from_json_file",anchor:"transformers.PretrainedConfig.from_json_file",parameters:[{name:"json_file",val:": typing.Union[str, os.PathLike]"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/configuration_utils.py#L690",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_json_file.json_file",description:`<strong>json_file</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_15793/en/main_classes/model#transformers.file_utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),Le=new E({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/configuration_utils.py#L750",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Ne=new E({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/configuration_utils.py#L718",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Me=new E({props:{name:"to_json_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/configuration_utils.py#L788",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),lt=r("code"),Wo=o("vocab_size"),Ho=o("."),io=d(),J=r("h2"),X=r("a"),ft=r("span"),g(we.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),co=d(),l=r("div"),g($e.$$.fragment),Jo=d(),mt=r("p"),Ro=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Uo=d(),g(K.$$.fragment),Go=d(),ut=r("p"),Xo=o("Class attributes (overridden by derived classes):"),Ko=d(),S=r("ul"),M=r("li"),pt=r("strong"),Qo=o("model_type"),Yo=o(" ("),gt=r("code"),Zo=o("str"),en=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
model.`),Hn=d(),oe=r("li"),jt=r("strong"),Vn=o("num_hidden_layers"),Bn=o(" ("),zt=r("code"),Jn=o("int"),Rn=o(") \u2014 The number of blocks in the model."),Un=d(),A=r("div"),g(ke.$$.fragment),Gn=d(),Pe=r("p"),Xn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),At=r("code"),Kn=o("repo_path_or_name"),Qn=o("."),Yn=d(),Ot=r("p"),Zn=o("Examples:"),er=d(),g(Ce.$$.fragment),tr=d(),ne=r("div"),g(Ee.$$.fragment),or=d(),I=r("p"),nr=o("Checks whether the passed dictionary has a "),qt=r("em"),rr=o("torch_dtype"),ar=o(` key and if it\u2019s not None, converts torch.dtype to a
...
stored in the json format.`),lr=d(),re=r("div"),g(Te.$$.fragment),fr=d(),xe=r("p"),hr=o("Instantiates a "),Ze=r("a"),mr=o("PretrainedConfig"),ur=o(" from a Python dictionary of parameters."),pr=d(),ae=r("div"),g(De.$$.fragment),gr=d(),je=r("p"),_r=o("Instantiates a "),et=r("a"),br=o("PretrainedConfig"),yr=o(" from the path to a JSON file of parameters."),vr=d(),D=r("div"),g(ze.$$.fragment),wr=d(),Ae=r("p"),$r=o("Instantiate a "),tt=r("a"),kr=o("PretrainedConfig"),Pr=o(" (or a derived class) from a pretrained model configuration."),Cr=d(),g(se.$$.fragment),Er=d(),It=r("p"),Tr=o("Examples:"),xr=d(),g(Oe.$$.fragment),Dr=d(),ie=r("div"),g(qe.$$.fragment),jr=d(),L=r("p"),zr=o("From a "),Lt=r("code"),Ar=o("pretrained_model_name_or_path"),Or=o(`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=r("a"),qr=o("PretrainedConfig"),Sr=o(" using "),Nt=r("code"),Fr=o("from_dict"),Ir=o("."),Lr=d(),W=r("div"),g(Se.$$.fragment),Nr=d(),Fe=r("p"),Mr=o(`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Mt=r("code"),Wr=o("AutoConfig"),Hr=o("."),Vr=d(),g(de.$$.fragment),Br=d(),ce=r("div"),g(Ie.$$.fragment),Jr=d(),R=r("p"),Rr=o("Save a configuration object to the directory "),Wt=r("code"),Ur=o("save_directory"),Gr=o(`, so that it can be re-loaded using the
`),nt=r("a"),Xr=o("from_pretrained()"),Kr=o(" class method."),Qr=d(),le=r("div"),g(Le.$$.fragment),Yr=d(),Ht=r("p"),Zr=o("Serializes this instance to a Python dictionary."),ea=d(),fe=r("div"),g(Ne.$$.fragment),ta=d(),Vt=r("p"),oa=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),na=d(),he=r("div"),g(Me.$$.fragment),ra=d(),Bt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),me=r("div"),g(We.$$.fragment),ia=d(),Jt=r("p"),da=o("Serializes this instance to a JSON string."),ca=d(),ue=r("div"),g(He.$$.fragment),la=d(),Ve=r("p"),fa=o("Updates attributes of this class with attributes from "),Rt=r("code"),ha=o("config_dict"),ma=o("."),ua=d(),O=r("div"),g(Be.$$.fragment),pa=d(),Je=r("p"),ga=o("Updates attributes of this class with attributes from "),Ut=r("code"),_a=o("update_str"),ba=o("."),ya=d(),U=r("p"),va=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);h=a($,"META",{name:!0,content:!0}),$.forEach(t),P=c(i),u=a(i,"H1",{class:!0});var Re=s(u);p=a(Re,"A",{id:!0,class:!0,href:!0});var Qt=s(p);j=a(Qt,"SPAN",{});var Yt=s(j);_(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),C=c(Re),q=a(Re,"SPAN",{});var xa=s(q);jo=n(xa,"Configuration"),xa.forEach(t),Re.forEach(t),ao=c(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),lt=a(H,"CODE",{});var Oa=s(lt);Wo=n(Oa,"vocab_size"),Oa.forEach(t),Ho=n(H,"."),H.forEach(t),io=c(i),J=a(i,"H2",{class:!0});var ho=s(J);X=a(ho,"A",{id:!0,class:!0,href:!0});var qa=s(X);ft=a(qa,"SPAN",{});var Sa=s(ft);_(we.$$.fragment,Sa),Sa.forEach(t),qa.forEach(t),Vo=c(ho),ht=a(ho,"SPAN",{});var Fa=s(ht);Bo=n(Fa,"PretrainedConfig"),Fa.forEach(t),ho.forEach(t),co=c(i),l=a(i,"DIV",{class:!0});var f=s(l);_($e.$$.fragment,f),Jo=c(f),mt=a(f,"P",{});var Ia=s(mt);Ro=n(Ia,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Ia.forEach(t),Uo=c(f),_(K.$$.fragment,f),Go=c(f),ut=a(f,"P",{});var La=s(ut);Xo=n(La,"Class attributes (overridden by derived classes):"),La.forEach(t),Ko=c(f),S=a(f,"UL",{});var pe=s(S);M=a(pe,"LI",{});var Ue=s(M);pt=a(Ue,"STRONG",{});var Na=s(pt);Qo=n(Na,"model_type"),Na.forEach(t),Yo=n(Ue," ("),gt=a(Ue,"CODE",{});var Ma=s(gt);Zo=n(Ma,"str"),Ma.forEach(t),en=n(Ue,`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Xe=a(Ue,"A",{href:!0});var Wa=s(Xe);tn=n(Wa,"AutoConfig"),Wa.forEach(t),on=n(Ue,"."),Ue.forEach(t),nn=c(pe),x=a(pe,"LI",{});var N=s(x);_t=a(N,"STRONG",{});var Ha=s(_t);rn=n(Ha,"is_composition"),Ha.forEach(t),an=n(N," ("),bt=a(N,"CODE",{});var Va=s(bt);sn=n(Va,"bool"),Va.forEach(t),dn=n(N,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
...
`),Qe=a(N,"A",{href:!0});var Ja=s(Qe);fn=n(Ja,"EncoderDecoderConfig"),Ja.forEach(t),hn=n(N," or "),Ye=a(N,"A",{href:!0});var Ra=s(Ye);mn=n(Ra,"~RagConfig"),Ra.forEach(t),un=n(N,"."),N.forEach(t),pn=c(pe),Q=a(pe,"LI",{});var Zt=s(Q);yt=a(Zt,"STRONG",{});var Ua=s(yt);gn=n(Ua,"keys_to_ignore_at_inference"),Ua.forEach(t),_n=n(Zt," ("),vt=a(Zt,"CODE",{});var Ga=s(vt);bn=n(Ga,"List[str]"),Ga.forEach(t),yn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
...
stored in the json format.`),be.forEach(t),uo.forEach(t),lr=c(f),re=a(f,"DIV",{class:!0});var po=s(re);_(Te.$$.fragment,po),fr=c(po),xe=a(po,"P",{});var go=s(xe);hr=n(go,"Instantiates a "),Ze=a(go,"A",{href:!0});var fs=s(Ze);mr=n(fs,"PretrainedConfig"),fs.forEach(t),ur=n(go," from a Python dictionary of parameters."),go.forEach(t),po.forEach(t),pr=c(f),ae=a(f,"DIV",{class:!0});var _o=s(ae);_(De.$$.fragment,_o),gr=c(_o),je=a(_o,"P",{});var bo=s(je);_r=n(bo,"Instantiates a "),et=a(bo,"A",{href:!0});var hs=s(et);br=n(hs,"PretrainedConfig"),hs.forEach(t),yr=n(bo," from the path to a JSON file of parameters."),bo.forEach(t),_o.forEach(t),vr=c(f),D=a(f,"DIV",{class:!0});var V=s(D);_(ze.$$.fragment,V),wr=c(V),Ae=a(V,"P",{});var yo=s(Ae);$r=n(yo,"Instantiate a "),tt=a(yo,"A",{href:!0});var ms=s(tt);kr=n(ms,"PretrainedConfig"),ms.forEach(t),Pr=n(yo," (or a derived class) from a pretrained model configuration."),yo.forEach(t),Cr=c(V),_(se.$$.fragment,V),Er=c(V),It=a(V,"P",{});var us=s(It);Tr=n(us,"Examples:"),us.forEach(t),xr=c(V),_(Oe.$$.fragment,V),V.forEach(t),Dr=c(f),ie=a(f,"DIV",{class:!0});var vo=s(ie);_(qe.$$.fragment,vo),jr=c(vo),L=a(vo,"P",{});var ye=s(L);zr=n(ye,"From a "),Lt=a(ye,"CODE",{});var ps=s(Lt);Ar=n(ps,"pretrained_model_name_or_path"),ps.forEach(t),Or=n(ye,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ye,"A",{href:!0});var gs=s(ot);qr=n(gs,"PretrainedConfig"),gs.forEach(t),Sr=n(ye," using "),Nt=a(ye,"CODE",{});var _s=s(Nt);Fr=n(_s,"from_dict"),_s.forEach(t),Ir=n(ye,"."),ye.forEach(t),vo.forEach(t),Lr=c(f),W=a(f,"DIV",{class:!0});var rt=s(W);_(Se.$$.fragment,rt),Nr=c(rt),Fe=a(rt,"P",{});var wo=s(Fe);Mr=n(wo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Mt=a(wo,"CODE",{});var bs=s(Mt);Wr=n(bs,"AutoConfig"),bs.forEach(t),Hr=n(wo,"."),wo.forEach(t),Vr=c(rt),_(de.$$.fragment,rt),rt.forEach(t),Br=c(f),ce=a(f,"DIV",{class:!0});var $o=s(ce);_(Ie.$$.fragment,$o),Jr=c($o),R=a($o,"P",{});var at=s(R);Rr=n(at,"Save a configuration object to the directory "),Wt=a(at,"CODE",{});var ys=s(Wt);Ur=n(ys,"save_directory"),ys.forEach(t),Gr=n(at,`, so that it can be re-loaded using the
...
serializes to a Python dictionary.`),$s.forEach(t),Po.forEach(t),na=c(f),he=a(f,"DIV",{class:!0});var Co=s(he);_(Me.$$.fragment,Co),ra=c(Co),Bt=a(Co,"P",{});var ks=s(Bt);aa=n(ks,"Save this instance to a JSON file."),ks.forEach(t),Co.forEach(t),sa=c(f),me=a(f,"DIV",{class:!0});var Eo=s(me);_(We.$$.fragment,Eo),ia=c(Eo),Jt=a(Eo,"P",{});var Ps=s(Jt);da=n(Ps,"Serializes this instance to a JSON string."),Ps.forEach(t),Eo.forEach(t),ca=c(f),ue=a(f,"DIV",{class:!0});var To=s(ue);_(He.$$.fragment,To),la=c(To),Ve=a(To,"P",{});var xo=s(Ve);fa=n(xo,"Updates attributes of this class with attributes from "),Rt=a(xo,"CODE",{});var Cs=s(Rt);ha=n(Cs,"config_dict"),Cs.forEach(t),ma=n(xo,"."),xo.forEach(t),To.forEach(t),ua=c(f),O=a(f,"DIV",{class:!0});var ve=s(O);_(Be.$$.fragment,ve),pa=c(ve),Je=a(ve,"P",{});var Do=s(Je);ga=n(Do,"Updates attributes of this class with attributes from "),Ut=a(Do,"CODE",{});var Es=s(Ut);_a=n(Es,"update_str"),Es.forEach(t),ba=n(Do,"."),Do.forEach(t),ya=c(ve),U=a(ve,"P",{});var st=s(U);va=n(st,"The expected format is ints, floats and strings as is, and for booleans use "),Gt=a(st,"CODE",{});var Ts=s(Gt);wa=n(Ts,"true"),Ts.forEach(t),$a=n(st," or "),Xt=a(st,"CODE",{});var xs=s(Xt);ka=n(xs,"false"),xs.forEach(t),Pa=n(st,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),st.forEach(t),Ca=c(ve),Kt=a(ve,"P",{});var Ds=s(Kt);Ea=n(Ds,"The keys to change have to already exist in the config object."),Ds.forEach(t),ve.forEach(t),f.forEach(t),this.h()},h(){m(h,"name","hf:doc:metadata"),m(h,"content",JSON.stringify(Ms)),m(p,"id","configuration"),m(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(p,"href","#configuration"),m(u,"class","relative group"),m(Ge,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),m(X,"id","transformers.PretrainedConfig"),m(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(X,"href","#transformers.PretrainedConfig"),m(J,"class","relative group"),m(Xe,"href","/docs/transformers/pr_15793/en/model_doc/auto#transformers.AutoConfig"),m(Ke,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),m(Qe,"href","/docs/transformers/pr_15793/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),m(Ye,"href","/docs/transformers/pr_15793/en/model_doc/rag#transformers.RagConfig"),m(A,"class","docstring"),m(ne,"class","docstring"),m(Ze,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),m(re,"class","docstring"),m(et,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),m(ae,"class","docstring"),m(tt,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),m(D,"class","docstring"),m(ot,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),m(ie,"class","docstring"),m(W,"class","docstring"),m(nt,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),m(ce,"class","docstring"),m(le,"class","docstring"),m(fe,"class","docstring"),m(he,"class","docstring"),m(me,"class","docstring"),m(ue,"class","docstring"),m(O,"class","docstring"),m(l,"class","docstring")},m(i,$){e(document.head,h),z(i,P,$),z(i,u,$),e(u,p),e(p,j),b(k,j,null),e(u,C),e(u,q),e(q,jo),z(i,ao,$),z(i,G,$),e(G,zo),e(G,Ge),e(Ge,Ao),e(G,Oo),z(i,so,$),z(i,T,$),e(T,qo),e(T,it),e(it,So),e(T,Fo),e(T,dt),e(dt,Io),e(T,Lo),e(T,ct),e(ct,No),e(T,Mo),e(T,lt),e(lt,Wo),e(T,Ho),z(i,io,$),z(i,J,$),e(J,X),e(X,ft),b(we,ft,null),e(J,Vo),e(J,ht),e(ht,Bo),z(i,co,$),z(i,l,$),b($e,l,null),e(l,Jo),e(l,mt),e(mt,Ro),e(l,Uo),b(K,l,null),e(l,Go),e(l,ut),e(ut,Xo),e(l,Ko),e(l,S),e(S,M),e(M,pt),e(pt,Qo),e(M,Yo),e(M,gt),e(gt,Zo),e(M,en),e(M,Xe),e(Xe,tn),e(M,on),e(S,nn),e(S,x),e(x,_t),e(_t,rn),e(x,an),e(x,bt),e(bt,sn),e(x,dn),e(x,Ke),e(Ke,cn),e(x,ln),e(x,Qe),e(Qe,fn),e(x,hn),e(x,Ye),e(Ye,mn),e(x,un),e(S,pn),e(S,Q),e(Q,yt),e(yt,gn),e(Q,_n),e(Q,vt),e(vt,bn),e(Q,yn),e(S,vn),e(S,Y),e(Y,wt),e(wt,wn),e(Y,$n),e(Y,$t),e($t,kn),e(Y,Pn),e(l,Cn),e(l,kt),e(kt,En),e(l,Tn),e(l,F),e(F,Z),e(Z,Pt),e(Pt,xn),e(Z,Dn),e(Z,Ct),e(Ct,jn),e(Z,zn),e(F,An),e(F,ee),e(ee,Et),e(Et,On),e(ee,qn),e(ee,Tt),e(Tt,Sn),e(ee,Fn),e(F,In),e(F,te),e(te,xt),e(xt,Ln),e(te,Nn),e(te,Dt),e(Dt,Mn),e(te,Wn),e(F,Hn),e(F,oe),e(oe,jt),e(jt,Vn),e(oe,Bn),e(oe,zt),e(zt,Jn),e(oe,Rn),e(l,Un),e(l,A),b(ke,A,null),e(A,Gn),e(A,Pe),e(Pe,Xn),e(Pe,At),e(At,Kn),e(Pe,Qn),e(A,Yn),e(A,Ot),e(Ot,Zn),e(A,er),b(Ce,A,null),e(l,tr),e(l,ne),b(Ee,ne,null),e(ne,or),e(ne,I),e(I,nr),e(I,qt),e(qt,rr),e(I,ar),e(I,St),e(St,sr),e(I,ir),e(I,Ft),e(Ft,dr),e(I,cr),e(l,lr),e(l,re),b(Te,re,null),e(re,fr),e(re,xe),e(xe,hr),e(xe,Ze),e(Ze,mr),e(xe,ur),e(l,pr),e(l,ae),b(De,ae,null),e(ae,gr),e(ae,je),e(je,_r),e(je,et),e(et,br),e(je,yr),e(l,vr),e(l,D),b(ze,D,null),e(D,wr),e(D,Ae),e(Ae,$r),e(Ae,tt),e(tt,kr),e(Ae,Pr),e(D,Cr),b(se,D,null),e(D,Er),e(D,It),e(It,Tr),e(D,xr),b(Oe,D,null),e(l,Dr),e(l,ie),b(qe,ie,null),e(ie,jr),e(ie,L),e(L,zr),e(L,Lt),e(Lt,Ar),e(L,Or),e(L,ot),e(ot,qr),e(L,Sr),e(L,Nt),e(Nt,Fr),e(L,Ir),e(l,Lr),e(l,W),b(Se,W,null),e(W,Nr),e(W,Fe),e(Fe,Mr),e(Fe,Mt),e(Mt,Wr),e(Fe,Hr),e(W,Vr),b(de,W,null),e(l,Br),e(l,ce),b(Ie,ce,null),e(ce,Jr),e(ce,R),e(R,Rr),e(R,Wt),e(Wt,Ur),e(R,Gr),e(R,nt),e(nt,Xr),e(R,Kr),e(l,Qr),e(l,le),b(Le,le,null),e(le,Yr),e(le,Ht),e(Ht,Zr),e(l,ea),e(l,fe),b(Ne,fe,null),e(fe,ta),e(fe,Vt),e(Vt,oa),e(l,na),e(l,he),b(Me,he,null),e(he,ra),e(he,Bt),e(Bt,aa),e(l,sa),e(l,me),b(We,me,null),e(me,ia),e(me,Jt),e(Jt,da),e(l,ca),e(l,ue),b(He,ue,null),e(ue,la),e(ue,Ve),e(Ve,fa),e(Ve,Rt),e(Rt,ha),e(Ve,ma),e(l,ua),e(l,O),b(Be,O,null),e(O,pa),e(O,Je),e(Je,ga),e(Je,Ut),e(Ut,_a),e(Je,ba),e(O,ya),e(O,U),e(U,va),e(U,Gt),e(Gt,wa),e(U,$a),e(U,Xt),e(Xt,ka),e(U,Pa),e(O,Ca),e(O,Kt),e(Kt,Ea),lo=!0},p(i,[$]){const Re={};$&2&&(Re.$$scope={dirty:$,ctx:i}),K.$set(Re);const Qt={};$&2&&(Qt.$$scope={dirty:$,ctx:i}),se.$set(Qt);const Yt={};$&2&&(Yt.$$scope={dirty:$,ctx:i}),de.$set(Yt)},i(i){lo||(y(k.$$.fragment,i),y(we.$$.fragment,i),y($e.$$.fragment,i),y(K.$$.fragment,i),y(ke.$$.fragment,i),y(Ce.$$.fragment,i),y(Ee.$$.fragment,i),y(Te.$$.fragment,i),y(De.$$.fragment,i),y(ze.$$.fragment,i),y(se.$$.fragment,i),y(Oe.$$.fragment,i),y(qe.$$.fragment,i),y(Se.$$.fragment,i),y(de.$$.fragment,i),y(Ie.$$.fragment,i),y(Le.$$.fragment,i),y(Ne.$$.fragment,i),y(Me.$$.fragment,i),y(We.$$.fragment,i),y(He.$$.fragment,i),y(Be.$$.fragment,i),lo=!0)},o(i){v(k.$$.fragment,i),v(we.$$.fragment,i),v($e.$$.fragment,i),v(K.$$.fragment,i),v(ke.$$.fragment,i),v(Ce.$$.fragment,i),v(Ee.$$.fragment,i),v(Te.$$.fragment,i),v(De.$$.fragment,i),v(ze.$$.fragment,i),v(se.$$.fragment,i),v(Oe.$$.fragment,i),v(qe.$$.fragment,i),v(Se.$$.fragment,i),v(de.$$.fragment,i),v(Ie.$$.fragment,i),v(Le.$$.fragment,i),v(Ne.$$.fragment,i),v(Me.$$.fragment,i),v(We.$$.fragment,i),v(He.$$.fragment,i),v(Be.$$.fragment,i),lo=!1},d(i){t(h),i&&t(P),i&&t(u),w(k),i&&t(ao),i&&t(G),i&&t(so),i&&t(T),i&&t(io),i&&t(J),w(we),i&&t(co),i&&t(l),w($e),w(K),w(ke),w(Ce),w(Ee),w(Te),w(De),w(ze),w(se),w(Oe),w(qe),w(Se),w(de),w(Ie),w(Le),w(Ne),w(Me),w(We),w(He),w(Be)}}}const Ms={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ws(B,h,P){let{fw:u}=h;return B.$$set=p=>{"fw"in p&&P(0,u=p.fw)},[u]}class Gs extends As{constructor(h){super();Os(this,h,Ws,Ns,qs,{fw:0})}}export{Gs as default,Ms as metadata};
