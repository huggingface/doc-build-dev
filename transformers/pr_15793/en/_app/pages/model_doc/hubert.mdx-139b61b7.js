...
Dimensionality of the projection before token mean-pooling for classification.`,name:"classifier_proj_size"}]}}),kt=new wt({props:{codee:`from transformers import HubertModel, HubertConfig
...
`}}),dt=new go({props:{$$slots:{default:[Ui]},$$scope:{ctx:A}}}),xt=new wt({props:{codee:`from transformers import Wav2Vec2Processor, HubertModel
...
`}}),pt=new go({props:{$$slots:{default:[Ki]},$$scope:{ctx:A}}}),Wt=new wt({props:{codee:`from transformers import Wav2Vec2Processor, HubertForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;MISTER QUILTER IS THE APOSTLE OF THE MIDDLE CLASSES AND WE ARE GLAD TO WELCOME HIS GOSPEL&#x27;</span>`}}),Lt=new wt({props:{codee:`with processor.as_target_processor():
...
`}}),ut=new go({props:{$$slots:{default:[Yi]},$$scope:{ctx:A}}}),Xt=new wt({props:{codee:`from transformers import Wav2Vec2FeatureExtractor, HubertForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;_unknown_&#x27;</span>`}}),Jt=new wt({props:{codee:`# compute loss - target_label is e.g. "down"
...
`}}),gt=new go({props:{$$slots:{default:[Xi]},$$scope:{ctx:A}}}),no=new wt({props:{codee:`from transformers import Wav2Vec2Processor, TFHubertModel
from datasets import load_dataset
import soundfile as sf
...
`}}),vt=new go({props:{$$slots:{default:[Qi]},$$scope:{ctx:A}}}),uo=new wt({props:{codee:`import tensorflow as tf
