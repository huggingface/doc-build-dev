...
</ul>`,name:"kwargs"}]}}),Ae=new Me({props:{codee:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
`}}),ye=new dd({props:{$$slots:{default:[Pi]},$$scope:{ctx:Q}}}),He=new Me({props:{codee:`from transformers import EncoderDecoderModel, BertTokenizer
import torch
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Je=new Me({props:{codee:`from transformers import EncoderDecoderModel
...
`}}),Te=new dd({props:{$$slots:{default:[Fi]},$$scope:{ctx:Q}}}),ro=new Me({props:{codee:`from transformers import TFEncoderDecoderModel, BertTokenizer
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),so=new Me({props:{codee:`from transformers import TFEncoderDecoderModel
...
`}}),Ee=new dd({props:{$$slots:{default:[Ci]},$$scope:{ctx:Q}}}),go=new Me({props:{codee:`from transformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),bo=new Me({props:{codee:`from transformers import FlaxEncoderDecoderModel
