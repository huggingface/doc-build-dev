import{S as wl,i as Ll,s as zl,e as n,k as l,w as m,t as r,M as Bl,c as a,d as o,m as c,a as s,x as f,h as i,b as d,F as e,g as h,y as _,q as g,o as b,B as k}from"../../chunks/vendor-4833417e.js";import{T as Mi}from"../../chunks/Tip-fffd6df1.js";import{D}from"../../chunks/Docstring-7b52c3d4.js";import{C as Ce}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ue}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function ql(J){let u,z,v,P,q;return{c(){u=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),P=r("Module"),q=r(`
...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var F=s(v);P=i(F,"Module"),F.forEach(o),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,z),e(u,v),e(v,P),e(u,q)},d(T){T&&o(u)}}}function Cl(J){let u,z,v,P,q,T,y,F,pa,fn,O,ao,ha,ua,Ee,ma,fa,Fe,_a,ga,_n,Y,me,so,Me,ba,ro,ka,gn,G,va,je,Ta,ya,io,Pa,wa,bn,Et,La,kn,Ft,lo,za,vn,R,Ba,Ae,qa,$a,Ne,xa,Ca,Tn,Z,fe,co,Se,Ea,po,Fa,yn,M,Ma,ho,ja,Aa,uo,Na,Sa,mo,Ia,Da,fo,Oa,Xa,Pn,_e,Ga,Ie,Ra,Wa,wn,W,Ua,De,_o,Ha,Va,Ka,Mt,Qa,Ja,Ln,jt,go,Ya,zn,Oe,Bn,At,Xe,bo,Za,es,ee,ts,ko,os,ns,vo,as,ss,qn,Ge,$n,te,ge,To,Re,rs,yo,is,xn,C,We,ds,oe,ls,Nt,cs,ps,Ue,hs,us,ms,ne,fs,St,_s,gs,It,bs,ks,vs,Po,Ts,ys,He,Cn,ae,be,wo,Ve,Ps,Lo,ws,En,w,Ke,Ls,zo,zs,Bs,X,qs,Dt,$s,xs,Ot,Cs,Es,Qe,Fs,Ms,js,Je,As,Bo,Ns,Ss,Is,qo,Ds,Os,Ye,Xs,ke,Ze,Gs,$o,Rs,Ws,I,et,Us,tt,Hs,xo,Vs,Ks,Qs,ot,nt,Co,Js,Ys,Eo,Zs,er,at,Fo,tr,or,Mo,nr,ar,jo,sr,Fn,se,ve,Ao,st,rr,No,ir,Mn,N,rt,dr,it,lr,Xt,cr,pr,hr,dt,ur,lt,mr,fr,_r,j,ct,gr,re,br,Gt,kr,vr,So,Tr,yr,Pr,Te,wr,Io,Lr,zr,pt,jn,ie,ye,Do,ht,Br,Oo,qr,An,S,ut,$r,mt,xr,Rt,Cr,Er,Fr,ft,Mr,_t,jr,Ar,Nr,L,gt,Sr,de,Ir,Wt,Dr,Or,Xo,Xr,Gr,Rr,Pe,Wr,Go,Ur,Hr,Ro,Wo,Uo,Ho,Vr,Kr,Vo,Ko,Qo,Jo,Qr,Jr,Yo,Yr,Zr,Zo,en,tn,on,ei,Nn,le,we,nn,bt,ti,an,oi,Sn,E,kt,ni,sn,ai,si,vt,ri,Ut,ii,di,li,Tt,ci,yt,pi,hi,ui,B,Pt,mi,ce,fi,Ht,_i,gi,rn,bi,ki,vi,Le,Ti,dn,yi,Pi,wt,wi,ln,Li,zi,Lt,In,pe,ze,cn,zt,Bi,pn,qi,Dn,he,Bt,$i,U,qt,xi,hn,Ci,Ei,$t,On;return T=new ue({}),Me=new ue({}),Se=new ue({}),Oe=new Ce({props:{codee:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model(**inputs)`}}),Ge=new Ce({props:{codee:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),He=new Ce({props:{codee:`from transformers import PLBartModel, PLBartConfig
...
BPE-dropout.</li>
</ul>`,name:"sp_model_kwargs"}]}}),Ye=new Ce({props:{codee:`from transformers import PLBartTokenizer
...
`}}),st=new ue({}),rt=new D({props:{name:"class transformers.PLBartModel",anchor:"transformers.PLBartModel",parameters:[{name:"config",val:": PLBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/plbart/modeling_plbart.py#L1105",parametersDescription:[{anchor:"transformers.PLBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15793/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ct=new D({props:{name:"forward",anchor:"transformers.PLBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/plbart/modeling_plbart.py#L1131",parametersDescription:[{anchor:"transformers.PLBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartConfig"
...
`}}),Te=new Mi({props:{$$slots:{default:[ql]},$$scope:{ctx:J}}}),pt=new Ce({props:{codee:`from transformers import PLBartTokenizer, PLBartModel
import torch
...
`}}),Pe=new Mi({props:{$$slots:{default:[$l]},$$scope:{ctx:J}}}),bt=new ue({}),kt=new D({props:{name:"class transformers.PLBartForSequenceClassification",anchor:"transformers.PLBartForSequenceClassification",parameters:[{name:"config",val:": PLBartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/plbart/modeling_plbart.py#L1390",parametersDescription:[{anchor:"transformers.PLBartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15793/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Pt=new D({props:{name:"forward",anchor:"transformers.PLBartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/plbart/modeling_plbart.py#L1403",parametersDescription:[{anchor:"transformers.PLBartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
See <a href="/docs/transformers/pr_15793/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15793/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Le=new Mi({props:{$$slots:{default:[xl]},$$scope:{ctx:J}}}),wt=new Ce({props:{codee:`from transformers import PLBartTokenizer, PLBartForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Lt=new Ce({props:{codee:`from transformers import PLBartTokenizer, PLBartForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),zt=new ue({}),Bt=new D({props:{name:"class transformers.PLBartForCausalLM",anchor:"transformers.PLBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/plbart/modeling_plbart.py#L1525"}}),qt=new D({props:{name:"forward",anchor:"transformers.PLBartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15793/src/transformers/models/plbart/modeling_plbart.py#L1556",parametersDescription:[{anchor:"transformers.PLBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a>. See <a href="/docs/transformers/pr_15793/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),$t=new Ce({props:{codee:`from transformers import PLBartTokenizer, PLBartForCausalLM
...
`),Fe=n("a"),_a=r("@gchhablani"),ga=r("."),_n=l(),Y=n("h2"),me=n("a"),so=n("span"),m(Me.$$.fragment),ba=l(),ro=n("span"),ka=r("Overview of PLBart"),gn=l(),G=n("p"),va=r("The PLBART model was proposed in "),je=n("a"),Ta=r("Unified Pre-training for Program Understanding and Generation"),ya=r(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
target text format is `),mo=n("code"),Ia=r("[tgt_lang_code] X [eos]"),Da=r(". "),fo=n("code"),Oa=r("bos"),Xa=r(" is never used."),Pn=l(),_e=n("p"),Ga=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=n("a"),Ra=r("the paper"),Wa=r(" to learn more about this."),wn=l(),W=n("p"),Ua=r("In cases where the language code is needed, The regular "),De=n("a"),_o=n("strong"),Ha=r("call"),Va=r("()"),Ka=r(` will encode source text format, and it should be wrapped
inside the context manager `),Mt=n("a"),Qa=r("as_target_tokenizer()"),Ja=r(" to encode target text format."),Ln=l(),jt=n("ul"),go=n("li"),Ya=r("Supervised training"),zn=l(),m(Oe.$$.fragment),Bn=l(),At=n("ul"),Xe=n("li"),bo=n("p"),Za=r("Generation"),es=l(),ee=n("p"),ts=r("While generating the target text set the "),ko=n("code"),os=r("decoder_start_token_id"),ns=r(` to the target language id. The following
example shows how to translate Python to English using the `),vo=n("code"),as=r("uclanlp/plbart-python-en_XX"),ss=r(" model."),qn=l(),m(Ge.$$.fragment),$n=l(),te=n("h2"),ge=n("a"),To=n("span"),m(Re.$$.fragment),rs=l(),yo=n("span"),is=r("PLBartConfig"),xn=l(),C=n("div"),m(We.$$.fragment),ds=l(),oe=n("p"),ls=r("This is the configuration class to store the configuration of a "),Nt=n("a"),cs=r("PLBartModel"),ps=r(`. It is used to instantiate an
...
`),Ue=n("a"),hs=r("uclanlp/plbart-base"),us=r(" architecture."),ms=l(),ne=n("p"),fs=r("Configuration objects inherit from "),St=n("a"),_s=r("PretrainedConfig"),gs=r(` and can be used to control the model outputs. Read the
...
target text format is `),mo=a(H,"CODE",{});var ed=s(mo);Ia=i(ed,"[tgt_lang_code] X [eos]"),ed.forEach(o),Da=i(H,". "),fo=a(H,"CODE",{});var td=s(fo);Oa=i(td,"bos"),td.forEach(o),Xa=i(H," is never used."),H.forEach(o),Pn=c(t),_e=a(t,"P",{});var Rn=s(_e);Ga=i(Rn,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=a(Rn,"A",{href:!0,rel:!0});var od=s(Ie);Ra=i(od,"the paper"),od.forEach(o),Wa=i(Rn," to learn more about this."),Rn.forEach(o),wn=c(t),W=a(t,"P",{});var Qt=s(W);Ua=i(Qt,"In cases where the language code is needed, The regular "),De=a(Qt,"A",{href:!0});var Fi=s(De);_o=a(Fi,"STRONG",{});var nd=s(_o);Ha=i(nd,"call"),nd.forEach(o),Va=i(Fi,"()"),Fi.forEach(o),Ka=i(Qt,` will encode source text format, and it should be wrapped
inside the context manager `),Mt=a(Qt,"A",{href:!0});var ad=s(Mt);Qa=i(ad,"as_target_tokenizer()"),ad.forEach(o),Ja=i(Qt," to encode target text format."),Qt.forEach(o),Ln=c(t),jt=a(t,"UL",{});var sd=s(jt);go=a(sd,"LI",{});var rd=s(go);Ya=i(rd,"Supervised training"),rd.forEach(o),sd.forEach(o),zn=c(t),f(Oe.$$.fragment,t),Bn=c(t),At=a(t,"UL",{});var id=s(At);Xe=a(id,"LI",{});var Wn=s(Xe);bo=a(Wn,"P",{});var dd=s(bo);Za=i(dd,"Generation"),dd.forEach(o),es=c(Wn),ee=a(Wn,"P",{});var Jt=s(ee);ts=i(Jt,"While generating the target text set the "),ko=a(Jt,"CODE",{});var ld=s(ko);os=i(ld,"decoder_start_token_id"),ld.forEach(o),ns=i(Jt,` to the target language id. The following
example shows how to translate Python to English using the `),vo=a(Jt,"CODE",{});var cd=s(vo);as=i(cd,"uclanlp/plbart-python-en_XX"),cd.forEach(o),ss=i(Jt," model."),Jt.forEach(o),Wn.forEach(o),id.forEach(o),qn=c(t),f(Ge.$$.fragment,t),$n=c(t),te=a(t,"H2",{class:!0});var Un=s(te);ge=a(Un,"A",{id:!0,class:!0,href:!0});var pd=s(ge);To=a(pd,"SPAN",{});var hd=s(To);f(Re.$$.fragment,hd),hd.forEach(o),pd.forEach(o),rs=c(Un),yo=a(Un,"SPAN",{});var ud=s(yo);is=i(ud,"PLBartConfig"),ud.forEach(o),Un.forEach(o),xn=c(t),C=a(t,"DIV",{class:!0});var V=s(C);f(We.$$.fragment,V),ds=c(V),oe=a(V,"P",{});var Yt=s(oe);ls=i(Yt,"This is the configuration class to store the configuration of a "),Nt=a(Yt,"A",{href:!0});var md=s(Nt);cs=i(md,"PLBartModel"),md.forEach(o),ps=i(Yt,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
`),Ue=a(Yt,"A",{href:!0,rel:!0});var fd=s(Ue);hs=i(fd,"uclanlp/plbart-base"),fd.forEach(o),us=i(Yt," architecture."),Yt.forEach(o),ms=c(V),ne=a(V,"P",{});var Zt=s(ne);fs=i(Zt,"Configuration objects inherit from "),St=a(Zt,"A",{href:!0});var _d=s(St);_s=i(_d,"PretrainedConfig"),_d.forEach(o),gs=i(Zt,` and can be used to control the model outputs. Read the
documentation from `),It=a(Zt,"A",{href:!0});var gd=s(It);bs=i(gd,"PretrainedConfig"),gd.forEach(o),ks=i(Zt," for more information."),Zt.forEach(o),vs=c(V),Po=a(V,"P",{});var bd=s(Po);Ts=i(bd,"Example:"),bd.forEach(o),ys=c(V),f(He.$$.fragment,V),V.forEach(o),Cn=c(t),ae=a(t,"H2",{class:!0});var Hn=s(ae);be=a(Hn,"A",{id:!0,class:!0,href:!0});var kd=s(be);wo=a(kd,"SPAN",{});var vd=s(wo);f(Ve.$$.fragment,vd),vd.forEach(o),kd.forEach(o),Ps=c(Hn),Lo=a(Hn,"SPAN",{});var Td=s(Lo);ws=i(Td,"PLBartTokenizer"),Td.forEach(o),Hn.forEach(o),En=c(t),w=a(t,"DIV",{class:!0});var $=s(w);f(Ke.$$.fragment,$),Ls=c($),zo=a($,"P",{});var yd=s(zo);zs=i(yd,"Construct an PLBART tokenizer."),yd.forEach(o),Bs=c($),X=a($,"P",{});var Be=s(X);qs=i(Be,"Adapted from "),Dt=a(Be,"A",{href:!0});var Pd=s(Dt);$s=i(Pd,"RobertaTokenizer"),Pd.forEach(o),xs=i(Be," and "),Ot=a(Be,"A",{href:!0});var wd=s(Ot);Cs=i(wd,"XLNetTokenizer"),wd.forEach(o),Es=i(Be,`. Based on
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),da.forEach(o),ui=c(Q),B=a(Q,"DIV",{class:!0});var A=s(B);f(Pt.$$.fragment,A),mi=c(A),ce=a(A,"P",{});var oo=s(ce);fi=i(oo,"The "),Ht=a(oo,"A",{href:!0});var _l=s(Ht);_i=i(_l,"PLBartForSequenceClassification"),_l.forEach(o),gi=i(oo," forward method, overrides the "),rn=a(oo,"CODE",{});var gl=s(rn);bi=i(gl,"__call__"),gl.forEach(o),ki=i(oo," special method."),oo.forEach(o),vi=c(A),f(Le.$$.fragment,A),Ti=c(A),dn=a(A,"P",{});var bl=s(dn);yi=i(bl,"Example of single-label classification:"),bl.forEach(o),Pi=c(A),f(wt.$$.fragment,A),wi=c(A),ln=a(A,"P",{});var kl=s(ln);Li=i(kl,"Example of multi-label classification:"),kl.forEach(o),zi=c(A),f(Lt.$$.fragment,A),A.forEach(o),Q.forEach(o),In=c(t),pe=a(t,"H2",{class:!0});var la=s(pe);ze=a(la,"A",{id:!0,class:!0,href:!0});var vl=s(ze);cn=a(vl,"SPAN",{});var Tl=s(cn);f(zt.$$.fragment,Tl),Tl.forEach(o),vl.forEach(o),Bi=c(la),pn=a(la,"SPAN",{});var yl=s(pn);qi=i(yl,"PLBartForCausalLM"),yl.forEach(o),la.forEach(o),Dn=c(t),he=a(t,"DIV",{class:!0});var ca=s(he);f(Bt.$$.fragment,ca),$i=c(ca),U=a(ca,"DIV",{class:!0});var no=s(U);f(qt.$$.fragment,no),xi=c(no),hn=a(no,"P",{});var Pl=s(hn);Ci=i(Pl,"Example:"),Pl.forEach(o),Ei=c(no),f($t.$$.fragment,no),no.forEach(o),ca.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(El)),d(P,"id","plbart"),d(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(P,"href","#plbart"),d(v,"class","relative group"),d(Ee,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),d(Ee,"rel","nofollow"),d(Fe,"href","https://www.github.com/gchhablani"),d(Fe,"rel","nofollow"),d(me,"id","overview-of-plbart"),d(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(me,"href","#overview-of-plbart"),d(Y,"class","relative group"),d(je,"href","https://arxiv.org/abs/2103.06333"),d(je,"rel","nofollow"),d(Ae,"href","https://huggingface.co/gchhablani"),d(Ae,"rel","nofollow"),d(Ne,"href","https://github.com/wasiahmad/PLBART"),d(Ne,"rel","nofollow"),d(fe,"id","training-of-plbart"),d(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(fe,"href","#training-of-plbart"),d(Z,"class","relative group"),d(Ie,"href","https://arxiv.org/abs/2103.06333"),d(Ie,"rel","nofollow"),d(De,"href","/docs/transformers/pr_15793/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),d(Mt,"href","/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartTokenizer.as_target_tokenizer"),d(ge,"id","transformers.PLBartConfig"),d(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ge,"href","#transformers.PLBartConfig"),d(te,"class","relative group"),d(Nt,"href","/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartModel"),d(Ue,"href","https://huggingface.co/uclanlp/plbart-base"),d(Ue,"rel","nofollow"),d(St,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),d(It,"href","/docs/transformers/pr_15793/en/main_classes/configuration#transformers.PretrainedConfig"),d(C,"class","docstring"),d(be,"id","transformers.PLBartTokenizer"),d(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(be,"href","#transformers.PLBartTokenizer"),d(ae,"class","relative group"),d(Dt,"href","/docs/transformers/pr_15793/en/model_doc/roberta#transformers.RobertaTokenizer"),d(Ot,"href","/docs/transformers/pr_15793/en/model_doc/xlnet#transformers.XLNetTokenizer"),d(Qe,"href","https://github.com/google/sentencepiece"),d(Qe,"rel","nofollow"),d(ke,"class","docstring"),d(I,"class","docstring"),d(w,"class","docstring"),d(ve,"id","transformers.PLBartModel"),d(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ve,"href","#transformers.PLBartModel"),d(se,"class","relative group"),d(Xt,"href","/docs/transformers/pr_15793/en/main_classes/model#transformers.PreTrainedModel"),d(lt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(lt,"rel","nofollow"),d(Gt,"href","/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartModel"),d(j,"class","docstring"),d(N,"class","docstring"),d(ye,"id","transformers.PLBartForConditionalGeneration"),d(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ye,"href","#transformers.PLBartForConditionalGeneration"),d(ie,"class","relative group"),d(Rt,"href","/docs/transformers/pr_15793/en/main_classes/model#transformers.PreTrainedModel"),d(_t,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(_t,"rel","nofollow"),d(Wt,"href","/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartForConditionalGeneration"),d(L,"class","docstring"),d(S,"class","docstring"),d(we,"id","transformers.PLBartForSequenceClassification"),d(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(we,"href","#transformers.PLBartForSequenceClassification"),d(le,"class","relative group"),d(Ut,"href","/docs/transformers/pr_15793/en/main_classes/model#transformers.PreTrainedModel"),d(yt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(yt,"rel","nofollow"),d(Ht,"href","/docs/transformers/pr_15793/en/model_doc/plbart#transformers.PLBartForSequenceClassification"),d(B,"class","docstring"),d(E,"class","docstring"),d(ze,"id","transformers.PLBartForCausalLM"),d(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ze,"href","#transformers.PLBartForCausalLM"),d(pe,"class","relative group"),d(U,"class","docstring"),d(he,"class","docstring")},m(t,p){e(document.head,u),h(t,z,p),h(t,v,p),e(v,P),e(P,q),_(T,q,null),e(v,y),e(v,F),e(F,pa),h(t,fn,p),h(t,O,p),e(O,ao),e(ao,ha),e(O,ua),e(O,Ee),e(Ee,ma),e(O,fa),e(O,Fe),e(Fe,_a),e(O,ga),h(t,_n,p),h(t,Y,p),e(Y,me),e(me,so),_(Me,so,null),e(Y,ba),e(Y,ro),e(ro,ka),h(t,gn,p),h(t,G,p),e(G,va),e(G,je),e(je,Ta),e(G,ya),e(G,io),e(io,Pa),e(G,wa),h(t,bn,p),h(t,Et,p),e(Et,La),h(t,kn,p),h(t,Ft,p),e(Ft,lo),e(lo,za),h(t,vn,p),h(t,R,p),e(R,Ba),e(R,Ae),e(Ae,qa),e(R,$a),e(R,Ne),e(Ne,xa),e(R,Ca),h(t,Tn,p),h(t,Z,p),e(Z,fe),e(fe,co),_(Se,co,null),e(Z,Ea),e(Z,po),e(po,Fa),h(t,yn,p),h(t,M,p),e(M,Ma),e(M,ho),e(ho,ja),e(M,Aa),e(M,uo),e(uo,Na),e(M,Sa),e(M,mo),e(mo,Ia),e(M,Da),e(M,fo),e(fo,Oa),e(M,Xa),h(t,Pn,p),h(t,_e,p),e(_e,Ga),e(_e,Ie),e(Ie,Ra),e(_e,Wa),h(t,wn,p),h(t,W,p),e(W,Ua),e(W,De),e(De,_o),e(_o,Ha),e(De,Va),e(W,Ka),e(W,Mt),e(Mt,Qa),e(W,Ja),h(t,Ln,p),h(t,jt,p),e(jt,go),e(go,Ya),h(t,zn,p),_(Oe,t,p),h(t,Bn,p),h(t,At,p),e(At,Xe),e(Xe,bo),e(bo,Za),e(Xe,es),e(Xe,ee),e(ee,ts),e(ee,ko),e(ko,os),e(ee,ns),e(ee,vo),e(vo,as),e(ee,ss),h(t,qn,p),_(Ge,t,p),h(t,$n,p),h(t,te,p),e(te,ge),e(ge,To),_(Re,To,null),e(te,rs),e(te,yo),e(yo,is),h(t,xn,p),h(t,C,p),_(We,C,null),e(C,ds),e(C,oe),e(oe,ls),e(oe,Nt),e(Nt,cs),e(oe,ps),e(oe,Ue),e(Ue,hs),e(oe,us),e(C,ms),e(C,ne),e(ne,fs),e(ne,St),e(St,_s),e(ne,gs),e(ne,It),e(It,bs),e(ne,ks),e(C,vs),e(C,Po),e(Po,Ts),e(C,ys),_(He,C,null),h(t,Cn,p),h(t,ae,p),e(ae,be),e(be,wo),_(Ve,wo,null),e(ae,Ps),e(ae,Lo),e(Lo,ws),h(t,En,p),h(t,w,p),_(Ke,w,null),e(w,Ls),e(w,zo),e(zo,zs),e(w,Bs),e(w,X),e(X,qs),e(X,Dt),e(Dt,$s),e(X,xs),e(X,Ot),e(Ot,Cs),e(X,Es),e(X,Qe),e(Qe,Fs),e(X,Ms),e(w,js),e(w,Je),e(Je,As),e(Je,Bo),e(Bo,Ns),e(Je,Ss),e(w,Is),e(w,qo),e(qo,Ds),e(w,Os),_(Ye,w,null),e(w,Xs),e(w,ke),_(Ze,ke,null),e(ke,Gs),e(ke,$o),e($o,Rs),e(w,Ws),e(w,I),_(et,I,null),e(I,Us),e(I,tt),e(tt,Hs),e(tt,xo),e(xo,Vs),e(tt,Ks),e(I,Qs),e(I,ot),e(ot,nt),e(nt,Co),e(Co,Js),e(nt,Ys),e(nt,Eo),e(Eo,Zs),e(ot,er),e(ot,at),e(at,Fo),e(Fo,tr),e(at,or),e(at,Mo),e(Mo,nr),e(I,ar),e(I,jo),e(jo,sr),h(t,Fn,p),h(t,se,p),e(se,ve),e(ve,Ao),_(st,Ao,null),e(se,rr),e(se,No),e(No,ir),h(t,Mn,p),h(t,N,p),_(rt,N,null),e(N,dr),e(N,it),e(it,lr),e(it,Xt),e(Xt,cr),e(it,pr),e(N,hr),e(N,dt),e(dt,ur),e(dt,lt),e(lt,mr),e(dt,fr),e(N,_r),e(N,j),_(ct,j,null),e(j,gr),e(j,re),e(re,br),e(re,Gt),e(Gt,kr),e(re,vr),e(re,So),e(So,Tr),e(re,yr),e(j,Pr),_(Te,j,null),e(j,wr),e(j,Io),e(Io,Lr),e(j,zr),_(pt,j,null),h(t,jn,p),h(t,ie,p),e(ie,ye),e(ye,Do),_(ht,Do,null),e(ie,Br),e(ie,Oo),e(Oo,qr),h(t,An,p),h(t,S,p),_(ut,S,null),e(S,$r),e(S,mt),e(mt,xr),e(mt,Rt),e(Rt,Cr),e(mt,Er),e(S,Fr),e(S,ft),e(ft,Mr),e(ft,_t),e(_t,jr),e(ft,Ar),e(S,Nr),e(S,L),_(gt,L,null),e(L,Sr),e(L,de),e(de,Ir),e(de,Wt),e(Wt,Dr),e(de,Or),e(de,Xo),e(Xo,Xr),e(de,Gr),e(L,Rr),_(Pe,L,null),e(L,Wr),e(L,Go),e(Go,Ur),e(L,Hr),e(L,Ro),e(Ro,Wo),e(Wo,Uo),e(Uo,Ho),e(Ho,Vr),e(L,Kr),e(L,Vo),e(Vo,Ko),e(Ko,Qo),e(Qo,Jo),e(Jo,Qr),e(L,Jr),e(L,Yo),e(Yo,Yr),e(L,Zr),e(L,Zo),e(Zo,en),e(en,tn),e(tn,on),e(on,ei),h(t,Nn,p),h(t,le,p),e(le,we),e(we,nn),_(bt,nn,null),e(le,ti),e(le,an),e(an,oi),h(t,Sn,p),h(t,E,p),_(kt,E,null),e(E,ni),e(E,sn),e(sn,ai),e(E,si),e(E,vt),e(vt,ri),e(vt,Ut),e(Ut,ii),e(vt,di),e(E,li),e(E,Tt),e(Tt,ci),e(Tt,yt),e(yt,pi),e(Tt,hi),e(E,ui),e(E,B),_(Pt,B,null),e(B,mi),e(B,ce),e(ce,fi),e(ce,Ht),e(Ht,_i),e(ce,gi),e(ce,rn),e(rn,bi),e(ce,ki),e(B,vi),_(Le,B,null),e(B,Ti),e(B,dn),e(dn,yi),e(B,Pi),_(wt,B,null),e(B,wi),e(B,ln),e(ln,Li),e(B,zi),_(Lt,B,null),h(t,In,p),h(t,pe,p),e(pe,ze),e(ze,cn),_(zt,cn,null),e(pe,Bi),e(pe,pn),e(pn,qi),h(t,Dn,p),h(t,he,p),_(Bt,he,null),e(he,$i),e(he,U),_(qt,U,null),e(U,xi),e(U,hn),e(hn,Ci),e(U,Ei),_($t,U,null),On=!0},p(t,[p]){const xt={};p&2&&(xt.$$scope={dirty:p,ctx:t}),Te.$set(xt);const un={};p&2&&(un.$$scope={dirty:p,ctx:t}),Pe.$set(un);const mn={};p&2&&(mn.$$scope={dirty:p,ctx:t}),Le.$set(mn)},i(t){On||(g(T.$$.fragment,t),g(Me.$$.fragment,t),g(Se.$$.fragment,t),g(Oe.$$.fragment,t),g(Ge.$$.fragment,t),g(Re.$$.fragment,t),g(We.$$.fragment,t),g(He.$$.fragment,t),g(Ve.$$.fragment,t),g(Ke.$$.fragment,t),g(Ye.$$.fragment,t),g(Ze.$$.fragment,t),g(et.$$.fragment,t),g(st.$$.fragment,t),g(rt.$$.fragment,t),g(ct.$$.fragment,t),g(Te.$$.fragment,t),g(pt.$$.fragment,t),g(ht.$$.fragment,t),g(ut.$$.fragment,t),g(gt.$$.fragment,t),g(Pe.$$.fragment,t),g(bt.$$.fragment,t),g(kt.$$.fragment,t),g(Pt.$$.fragment,t),g(Le.$$.fragment,t),g(wt.$$.fragment,t),g(Lt.$$.fragment,t),g(zt.$$.fragment,t),g(Bt.$$.fragment,t),g(qt.$$.fragment,t),g($t.$$.fragment,t),On=!0)},o(t){b(T.$$.fragment,t),b(Me.$$.fragment,t),b(Se.$$.fragment,t),b(Oe.$$.fragment,t),b(Ge.$$.fragment,t),b(Re.$$.fragment,t),b(We.$$.fragment,t),b(He.$$.fragment,t),b(Ve.$$.fragment,t),b(Ke.$$.fragment,t),b(Ye.$$.fragment,t),b(Ze.$$.fragment,t),b(et.$$.fragment,t),b(st.$$.fragment,t),b(rt.$$.fragment,t),b(ct.$$.fragment,t),b(Te.$$.fragment,t),b(pt.$$.fragment,t),b(ht.$$.fragment,t),b(ut.$$.fragment,t),b(gt.$$.fragment,t),b(Pe.$$.fragment,t),b(bt.$$.fragment,t),b(kt.$$.fragment,t),b(Pt.$$.fragment,t),b(Le.$$.fragment,t),b(wt.$$.fragment,t),b(Lt.$$.fragment,t),b(zt.$$.fragment,t),b(Bt.$$.fragment,t),b(qt.$$.fragment,t),b($t.$$.fragment,t),On=!1},d(t){o(u),t&&o(z),t&&o(v),k(T),t&&o(fn),t&&o(O),t&&o(_n),t&&o(Y),k(Me),t&&o(gn),t&&o(G),t&&o(bn),t&&o(Et),t&&o(kn),t&&o(Ft),t&&o(vn),t&&o(R),t&&o(Tn),t&&o(Z),k(Se),t&&o(yn),t&&o(M),t&&o(Pn),t&&o(_e),t&&o(wn),t&&o(W),t&&o(Ln),t&&o(jt),t&&o(zn),k(Oe,t),t&&o(Bn),t&&o(At),t&&o(qn),k(Ge,t),t&&o($n),t&&o(te),k(Re),t&&o(xn),t&&o(C),k(We),k(He),t&&o(Cn),t&&o(ae),k(Ve),t&&o(En),t&&o(w),k(Ke),k(Ye),k(Ze),k(et),t&&o(Fn),t&&o(se),k(st),t&&o(Mn),t&&o(N),k(rt),k(ct),k(Te),k(pt),t&&o(jn),t&&o(ie),k(ht),t&&o(An),t&&o(S),k(ut),k(gt),k(Pe),t&&o(Nn),t&&o(le),k(bt),t&&o(Sn),t&&o(E),k(kt),k(Pt),k(Le),k(wt),k(Lt),t&&o(In),t&&o(pe),k(zt),t&&o(Dn),t&&o(he),k(Bt),k(qt),k($t)}}}const El={local:"plbart",sections:[{local:"overview-of-plbart",sections:[{local:"training-of-plbart",title:"Training of PLBart"}],title:"Overview of PLBart"},{local:"transformers.PLBartConfig",title:"PLBartConfig"},{local:"transformers.PLBartTokenizer",title:"PLBartTokenizer"},{local:"transformers.PLBartModel",title:"PLBartModel"},{local:"transformers.PLBartForConditionalGeneration",title:"PLBartForConditionalGeneration"},{local:"transformers.PLBartForSequenceClassification",title:"PLBartForSequenceClassification"},{local:"transformers.PLBartForCausalLM",title:"PLBartForCausalLM"}],title:"PLBart"};function Fl(J,u,z){let{fw:v}=u;return J.$$set=P=>{"fw"in P&&z(0,v=P.fw)},[v]}class Dl extends wl{constructor(u){super();Ll(this,u,Fl,Cl,zl,{fw:0})}}export{Dl as default,El as metadata};
