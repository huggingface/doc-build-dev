import{S as mm,i as fm,s as um,e as a,k as d,w,t as n,M as gm,c as s,d as t,m as c,a as r,x as b,h as i,b as l,F as e,g as f,y,q as $,o as x,B as F}from"../../chunks/vendor-4833417e.js";import{T as _e}from"../../chunks/Tip-fffd6df1.js";import{D as W}from"../../chunks/Docstring-4f315ed9.js";import{C as Ft}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ve}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function _m(I){let p,v,m,g,T;return{c(){p=a("p"),v=n(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=a("a"),g=n("Github Issue"),T=n("."),this.h()},l(_){p=s(_,"P",{});var u=r(p);v=i(u,`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=s(u,"A",{href:!0,rel:!0});var V=r(m);g=i(V,"Github Issue"),V.forEach(t),T=i(u,"."),u.forEach(t),this.h()},h(){l(m,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),l(m,"rel","nofollow")},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function vm(I){let p,v;return{c(){p=a("p"),v=n(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
PIL images.`)},l(m){p=s(m,"P",{});var g=r(p);v=i(g,`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
PIL images.`),g.forEach(t)},m(m,g){f(m,p,g),e(p,v)},d(m){m&&t(p)}}}function Tm(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function wm(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function bm(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function ym(I){let p,v,m,g,T,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae;return{c(){p=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),m=d(),g=a("ul"),T=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),V=a("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=n("This second option is useful when using "),j=a("code"),B=n("tf.keras.Model.fit"),oe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),he=n("model(inputs)"),ae=n(".")},l(E){p=s(E,"P",{});var M=r(p);v=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),m=c(E),g=s(E,"UL",{});var z=r(g);T=s(z,"LI",{});var Me=r(T);_=i(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),u=c(z),V=s(z,"LI",{});var se=r(V);pe=i(se,"having all inputs as a list, tuple or dict in the first positional arguments."),se.forEach(t),z.forEach(t),R=c(E),k=s(E,"P",{});var L=r(k);ie=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var je=r(j);B=i(je,"tf.keras.Model.fit"),je.forEach(t),oe=i(L,` method which currently requires having all the
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=r(C);he=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){f(E,p,M),e(p,v),f(E,m,M),f(E,g,M),e(g,T),e(T,_),e(g,u),e(g,V),e(V,pe),f(E,R,M),f(E,k,M),e(k,ie),e(k,j),e(j,B),e(k,oe),e(k,C),e(C,he),e(k,ae)},d(E){E&&t(p),E&&t(m),E&&t(g),E&&t(R),E&&t(k)}}}function $m(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function xm(I){let p,v,m,g,T,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae;return{c(){p=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),m=d(),g=a("ul"),T=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),V=a("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=n("This second option is useful when using "),j=a("code"),B=n("tf.keras.Model.fit"),oe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),he=n("model(inputs)"),ae=n(".")},l(E){p=s(E,"P",{});var M=r(p);v=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),m=c(E),g=s(E,"UL",{});var z=r(g);T=s(z,"LI",{});var Me=r(T);_=i(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),u=c(z),V=s(z,"LI",{});var se=r(V);pe=i(se,"having all inputs as a list, tuple or dict in the first positional arguments."),se.forEach(t),z.forEach(t),R=c(E),k=s(E,"P",{});var L=r(k);ie=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var je=r(j);B=i(je,"tf.keras.Model.fit"),je.forEach(t),oe=i(L,` method which currently requires having all the
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=r(C);he=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){f(E,p,M),e(p,v),f(E,m,M),f(E,g,M),e(g,T),e(T,_),e(g,u),e(g,V),e(V,pe),f(E,R,M),f(E,k,M),e(k,ie),e(k,j),e(j,B),e(k,oe),e(k,C),e(C,he),e(k,ae)},d(E){E&&t(p),E&&t(m),E&&t(g),E&&t(R),E&&t(k)}}}function Fm(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function Vm(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function Em(I){let p,v,m,g,T;return{c(){p=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=r(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=r(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function km(I){let p,v,m,g,T,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae,E,M,z,Me,se,L,je,Te,Xo,en,sr,Zo,Da,tn,rr,Qo,on,nr,N,Vt,an,Et,sn,rn,nn,Oa,ln,dn,kt,cn,Yo,pn,hn,mn,Pe,fn,Sa,un,gn,It,_n,vn,Tn,Ce,wn,Mt,bn,yn,jt,$n,xn,Fn,qe,Vn,Pt,En,kn,Ct,In,Mn,jn,Wa,Pn,ir,ea,Cn,lr,le,Ba,P,ta,qn,An,oa,zn,Nn,aa,Ln,Dn,Ua,On,Sn,Ra,Wn,Bn,Ha,Un,Rn,Ja,Hn,Jn,sa,Kn,Gn,Xn,Ka,ra,na,Zn,Qn,Yn,Ga,qt,ei,At,ti,oi,ai,Xa,ia,la,si,ri,dr,we,ni,zt,ii,li,Nt,di,ci,cr,et,pi,Lt,hi,mi,pr,Ae,tt,Za,Dt,fi,Qa,ui,hr,U,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,pa,Vi,Ei,ki,Ya,Ii,Mi,Wt,mr,Le,ot,es,Bt,ji,ts,Pi,fr,re,Ut,Ci,os,qi,Ai,Rt,zi,ha,Ni,Li,Di,be,Ht,Oi,as,Si,Wi,at,ur,De,st,ss,Jt,Bi,rs,Ui,gr,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,ns,el,tl,ol,rt,al,is,sl,rl,Qt,_r,Se,nt,ls,Yt,nl,ds,il,vr,fe,eo,ll,We,dl,cs,cl,pl,to,hl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,ps,Tl,wl,bl,it,yl,hs,$l,xl,ao,Tr,Ue,lt,ms,so,Fl,fs,Vl,wr,ne,ro,El,us,kl,Il,no,Ml,io,jl,Pl,Cl,K,lo,ql,Re,Al,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Bl,co,br,He,ct,vs,po,Ul,Ts,Rl,yr,D,ho,Hl,ws,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,pt,ad,G,go,sd,Je,rd,_a,nd,id,bs,ld,dd,cd,ht,pd,ys,hd,md,_o,$r,Ke,mt,$s,vo,fd,xs,ud,xr,O,To,gd,Fs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Vs,Pd,Cd,qd,ut,Ad,Es,zd,Nd,xo,Fr,Xe,gt,ks,Fo,Ld,Is,Dd,Vr,q,Vo,Od,Ms,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,qs,Po,ac,sc,As,Co,rc,nc,Z,qo,ic,Ze,lc,zs,dc,cc,Ns,pc,hc,mc,_t,fc,Ls,uc,gc,Ao,Er,Qe,vt,Ds,zo,_c,Os,vc,kr,A,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Ic,Ws,Mc,jc,ge,Bs,So,Pc,Cc,Us,Wo,qc,Ac,Rs,Bo,zc,Nc,Hs,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Bc,Ks,Uc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Ir;return _=new ve({}),k=new _e({props:{$$slots:{default:[_m]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16138/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/feature_extractor#transformers.BatchFeature"
...
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16138/en/model_doc/vit#transformers.ViTConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),Yt=new ve({}),eo=new W({props:{name:"class transformers.ViTForMaskedImageModeling",anchor:"transformers.ViTForMaskedImageModeling",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16138/src/transformers/models/vit/modeling_vit.py#L592",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16138/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16138/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new W({props:{name:"forward",anchor:"transformers.ViTForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"interpolate_pos_encoding",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16138/src/transformers/models/vit/modeling_vit.py#L606",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16138/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),so=new ve({}),ro=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16138/src/transformers/models/vit/modeling_vit.py#L702",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16138/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16138/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new W({props:{name:"forward",anchor:"transformers.ViTForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"interpolate_pos_encoding",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16138/src/transformers/models/vit/modeling_vit.py#L715",parametersDescription:[{anchor:"transformers.ViTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16138/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16138/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){p=a("meta"),v=d(),m=a("h1"),g=a("a"),T=a("span"),w(_.$$.fragment),u=d(),V=a("span"),pe=n("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),w(C.$$.fragment),he=d(),ae=a("span"),E=n("Overview"),M=d(),z=a("p"),Me=n("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=n(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
found `),Nt=a("a"),di=n("here"),ci=n("."),cr=d(),et=a("p"),pi=n("Note that we converted the weights from Ross Wightman\u2019s "),Lt=a("a"),hi=n("timm library"),mi=n(`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),pr=d(),Ae=a("h2"),tt=a("a"),Za=a("span"),w(Dt.$$.fragment),fi=d(),Qa=a("span"),ui=n("ViTConfig"),hr=d(),U=a("div"),w(Ot.$$.fragment),gi=d(),ze=a("p"),_i=n("This is the configuration class to store the configuration of a "),da=a("a"),vi=n("ViTModel"),Ti=n(`. It is used to instantiate an ViT
...
behavior.`),Gi=d(),H=a("div"),w(Zt.$$.fragment),Xi=d(),Oe=a("p"),Zi=n("The "),ma=a("a"),Qi=n("ViTModel"),Yi=n(" forward method, overrides the "),ns=a("code"),el=n("__call__"),tl=n(" special method."),ol=d(),w(rt.$$.fragment),al=d(),is=a("p"),sl=n("Example:"),rl=d(),w(Qt.$$.fragment),_r=d(),Se=a("h2"),nt=a("a"),ls=a("span"),w(Yt.$$.fragment),nl=d(),ds=a("span"),il=n("ViTForMaskedImageModeling"),vr=d(),fe=a("div"),w(eo.$$.fragment),ll=d(),We=a("p"),dl=n("ViT Model with a decoder on top for masked image modeling, as proposed in "),cs=a("code"),cl=n("SimMIM <https://arxiv.org/abs/2111.09886>"),pl=n(`__.
This model is a PyTorch `),to=a("a"),hl=n("torch.nn.Module"),ml=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fl=d(),J=a("div"),w(oo.$$.fragment),ul=d(),Be=a("p"),gl=n("The "),fa=a("a"),_l=n("ViTForMaskedImageModeling"),vl=n(" forward method, overrides the "),ps=a("code"),Tl=n("__call__"),wl=n(" special method."),bl=d(),w(it.$$.fragment),yl=d(),hs=a("p"),$l=n("Examples:"),xl=d(),w(ao.$$.fragment),Tr=d(),Ue=a("h2"),lt=a("a"),ms=a("span"),w(so.$$.fragment),Fl=d(),fs=a("span"),Vl=n("ViTForImageClassification"),wr=d(),ne=a("div"),w(ro.$$.fragment),El=d(),us=a("p"),kl=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Il=d(),no=a("p"),Ml=n("This model is a PyTorch "),io=a("a"),jl=n("torch.nn.Module"),Pl=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=d(),K=a("div"),w(lo.$$.fragment),ql=d(),Re=a("p"),Al=n("The "),ua=a("a"),zl=n("ViTForImageClassification"),Nl=n(" forward method, overrides the "),gs=a("code"),Ll=n("__call__"),Dl=n(" special method."),Ol=d(),w(dt.$$.fragment),Sl=d(),_s=a("p"),Wl=n("Example:"),Bl=d(),w(co.$$.fragment),br=d(),He=a("h2"),ct=a("a"),vs=a("span"),w(po.$$.fragment),Ul=d(),Ts=a("span"),Rl=n("TFViTModel"),yr=d(),D=a("div"),w(ho.$$.fragment),Hl=d(),ws=a("p"),Jl=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Kl=d(),mo=a("p"),Gl=n("This model inherits from "),ga=a("a"),Xl=n("TFPreTrainedModel"),Zl=n(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),js=a("p"),Zd=n("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Ps=a("li"),Mo=a("a"),Yd=n("Just-In-Time (JIT) compilation"),ec=d(),Cs=a("li"),jo=a("a"),tc=n("Automatic Differentiation"),oc=d(),qs=a("li"),Po=a("a"),ac=n("Vectorization"),sc=d(),As=a("li"),Co=a("a"),rc=n("Parallelization"),nc=d(),Z=a("div"),w(qo.$$.fragment),ic=d(),Ze=a("p"),lc=n("The "),zs=a("code"),dc=n("FlaxViTPreTrainedModel"),cc=n("forward method, overrides the "),Ns=a("code"),pc=n("__call__"),hc=n(" special method."),mc=d(),w(_t.$$.fragment),fc=d(),Ls=a("p"),uc=n("Examples:"),gc=d(),w(Ao.$$.fragment),Er=d(),Qe=a("h2"),vt=a("a"),Ds=a("span"),w(zo.$$.fragment),_c=d(),Os=a("span"),vc=n("FlaxViTForImageClassification"),kr=d(),A=a("div"),w(No.$$.fragment),Tc=d(),Ss=a("p"),wc=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ic=d(),Ws=a("p"),Mc=n("Finally, this model supports inherent JAX features such as:"),jc=d(),ge=a("ul"),Bs=a("li"),So=a("a"),Pc=n("Just-In-Time (JIT) compilation"),Cc=d(),Us=a("li"),Wo=a("a"),qc=n("Automatic Differentiation"),Ac=d(),Rs=a("li"),Bo=a("a"),zc=n("Vectorization"),Nc=d(),Hs=a("li"),Uo=a("a"),Lc=n("Parallelization"),Dc=d(),Q=a("div"),w(Ro.$$.fragment),Oc=d(),Ye=a("p"),Sc=n("The "),Js=a("code"),Wc=n("FlaxViTPreTrainedModel"),Bc=n("forward method, overrides the "),Ks=a("code"),Uc=n("__call__"),Rc=n(" special method."),Hc=d(),w(Tt.$$.fragment),Jc=d(),Gs=a("p"),Kc=n("Example:"),Gc=d(),w(Ho.$$.fragment),this.h()},l(o){const h=gm('[data-svelte="svelte-1phssyn"]',document.head);p=s(h,"META",{name:!0,content:!0}),h.forEach(t),v=c(o),m=s(o,"H1",{class:!0});var Jo=r(m);g=s(Jo,"A",{id:!0,class:!0,href:!0});var Xs=r(g);T=s(Xs,"SPAN",{});var Zs=r(T);b(_.$$.fragment,Zs),Zs.forEach(t),Xs.forEach(t),u=c(Jo),V=s(Jo,"SPAN",{});var Qs=r(V);pe=i(Qs,"Vision Transformer (ViT)"),Qs.forEach(t),Jo.forEach(t),R=c(o),b(k.$$.fragment,o),ie=c(o),j=s(o,"H2",{class:!0});var Ko=r(j);B=s(Ko,"A",{id:!0,class:!0,href:!0});var Ys=r(B);oe=s(Ys,"SPAN",{});var er=r(oe);b(C.$$.fragment,er),er.forEach(t),Ys.forEach(t),he=c(Ko),ae=s(Ko,"SPAN",{});var tr=r(ae);E=i(tr,"Overview"),tr.forEach(t),Ko.forEach(t),M=c(o),z=s(o,"P",{});var Go=r(z);Me=i(Go,"The Vision Transformer (ViT) model was proposed in "),se=s(Go,"A",{href:!0,rel:!0});var or=r(se);L=i(or,`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
data and transferred to multiple mid-sized or small image recognition benchmarks (ImageNet, CIFAR-100, VTAB, etc.),
Vision Transformer (ViT) attains excellent results compared to state-of-the-art convolutional networks while requiring
substantially fewer computational resources to train.`),Yc.forEach(t),Qc.forEach(t),rr=c(o),Qo=s(o,"P",{});var ep=r(Qo);on=i(ep,"Tips:"),ep.forEach(t),nr=c(o),N=s(o,"UL",{});var Y=r(N);Vt=s(Y,"LI",{});var Mr=r(Vt);an=i(Mr,"Demo notebooks regarding inference as well as fine-tuning ViT on custom data can be found "),Et=s(Mr,"A",{href:!0,rel:!0});var tp=r(Et);sn=i(tp,"here"),tp.forEach(t),rn=i(Mr,"."),Mr.forEach(t),nn=c(Y),Oa=s(Y,"LI",{});var op=r(Oa);ln=i(op,`To feed images to the Transformer encoder, each image is split into a sequence of fixed-size non-overlapping patches,
which are then linearly embedded. A [CLS] token is added to serve as representation of an entire image, which can be
used for classification. The authors also add absolute position embeddings, and feed the resulting sequence of
vectors to a standard Transformer encoder.`),op.forEach(t),dn=c(Y),kt=s(Y,"LI",{});var jr=r(kt);cn=i(jr,`As the Vision Transformer expects each image to be of the same size (resolution), one can use
`),Yo=s(jr,"A",{href:!0});var ap=r(Yo);pn=i(ap,"ViTFeatureExtractor"),ap.forEach(t),hn=i(jr," to resize (or rescale) and normalize images for the model."),jr.forEach(t),mn=c(Y),Pe=s(Y,"LI",{});var ya=r(Pe);fn=i(ya,`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
each checkpoint. For example, `),Sa=s(ya,"CODE",{});var sp=r(Sa);un=i(sp,"google/vit-base-patch16-224"),sp.forEach(t),gn=i(ya,` refers to a base-sized architecture with patch
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),It=s(ya,"A",{href:!0,rel:!0});var rp=r(It);_n=i(rp,"hub"),rp.forEach(t),vn=i(ya,"."),ya.forEach(t),Tn=c(Y),Ce=s(Y,"LI",{});var $a=r(Ce);wn=i($a,"The available checkpoints are either (1) pre-trained on "),Mt=s($a,"A",{href:!0,rel:!0});var np=r(Mt);bn=i(np,"ImageNet-21k"),np.forEach(t),yn=i($a,` (a collection of
14 million images and 21k classes) only, or (2) also fine-tuned on `),jt=s($a,"A",{href:!0,rel:!0});var ip=r(jt);$n=i(ip,"ImageNet"),ip.forEach(t),xn=i($a,` (also referred to as ILSVRC 2012, a collection of 1.3 million
...
use a higher resolution than pre-training `),Pt=s(xa,"A",{href:!0,rel:!0});var lp=r(Pt);En=i(lp,"(Touvron et al., 2019)"),lp.forEach(t),kn=i(xa,", "),Ct=s(xa,"A",{href:!0,rel:!0});var dp=r(Ct);In=i(dp,`(Kolesnikov
et al., 2020)`),dp.forEach(t),Mn=i(xa,`. In order to fine-tune at higher resolution, the authors perform
2D interpolation of the pre-trained position embeddings, according to their location in the original image.`),xa.forEach(t),jn=c(Y),Wa=s(Y,"LI",{});var cp=r(Wa);Pn=i(cp,`The best results are obtained with supervised pre-training, which is not the case in NLP. The authors also performed
an experiment with a self-supervised pre-training objective, namely masked patched prediction (inspired by masked
language modeling). With this approach, the smaller ViT-B/16 model achieves 79.9% accuracy on ImageNet, a significant
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),cp.forEach(t),Y.forEach(t),ir=c(o),ea=s(o,"P",{});var pp=r(ea);Cn=i(pp,"Following the original Vision Transformer, some follow-up works have been made:"),pp.forEach(t),lr=c(o),le=s(o,"UL",{});var wt=r(le);Ba=s(wt,"LI",{});var hp=r(Ba);P=s(hp,"P",{});var S=r(P);ta=s(S,"A",{href:!0});var mp=r(ta);qn=i(mp,"DeiT"),mp.forEach(t),An=i(S,` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
The authors of DeiT also released more efficiently trained ViT models, which you can directly plug into `),oa=s(S,"A",{href:!0});var fp=r(oa);zn=i(fp,"ViTModel"),fp.forEach(t),Nn=i(S,` or
`),aa=s(S,"A",{href:!0});var up=r(aa);Ln=i(up,"ViTForImageClassification"),up.forEach(t),Dn=i(S,". There are 4 variants available (in 3 different sizes): "),Ua=s(S,"EM",{});var gp=r(Ua);On=i(gp,"facebook/deit-tiny-patch16-224"),gp.forEach(t),Sn=i(S,`,
`),Ra=s(S,"EM",{});var _p=r(Ra);Wn=i(_p,"facebook/deit-small-patch16-224"),_p.forEach(t),Bn=i(S,", "),Ha=s(S,"EM",{});var vp=r(Ha);Un=i(vp,"facebook/deit-base-patch16-224"),vp.forEach(t),Rn=i(S," and "),Ja=s(S,"EM",{});var Tp=r(Ja);Hn=i(Tp,"facebook/deit-base-patch16-384"),Tp.forEach(t),Jn=i(S,`. Note that one should
use `),sa=s(S,"A",{href:!0});var wp=r(sa);Kn=i(wp,"DeiTFeatureExtractor"),wp.forEach(t),Gn=i(S," in order to prepare images for the model."),S.forEach(t),hp.forEach(t),Xn=c(wt),Ka=s(wt,"LI",{});var bp=r(Ka);ra=s(bp,"P",{});var Xc=r(ra);na=s(Xc,"A",{href:!0});var yp=r(na);Zn=i(yp,"BEiT"),yp.forEach(t),Qn=i(Xc,` (BERT pre-training of Image Transformers) by Microsoft Research. BEiT models outperform supervised pre-trained
vision transformers using a self-supervised method inspired by BERT (masked image modeling) and based on a VQ-VAE.`),Xc.forEach(t),bp.forEach(t),Yn=c(wt),Ga=s(wt,"LI",{});var $p=r(Ga);qt=s($p,"P",{});var Pr=r(qt);ei=i(Pr,`DINO (a method for self-supervised training of Vision Transformers) by Facebook AI. Vision Transformers trained using
the DINO method show very interesting properties not seen with convolutional models. They are capable of segmenting
objects, without having ever been trained to do so. DINO checkpoints can be found on the `),At=s(Pr,"A",{href:!0,rel:!0});var xp=r(At);ti=i(xp,"hub"),xp.forEach(t),oi=i(Pr,"."),Pr.forEach(t),$p.forEach(t),ai=c(wt),Xa=s(wt,"LI",{});var Fp=r(Xa);ia=s(Fp,"P",{});var Zc=r(ia);la=s(Zc,"A",{href:!0});var Vp=r(la);si=i(Vp,"MAE"),Vp.forEach(t),ri=i(Zc,` (Masked Autoencoders) by Facebook AI. By pre-training Vision Transformers to reconstruct pixel values for a high portion
(75%) of masked patches (using an asymmetric encoder-decoder architecture), the authors show that this simple method outperforms
supervised pre-training after fine-tuning.`),Zc.forEach(t),Fp.forEach(t),wt.forEach(t),dr=c(o),we=s(o,"P",{});var Fa=r(we);ni=i(Fa,"This model was contributed by "),zt=s(Fa,"A",{href:!0,rel:!0});var Ep=r(zt);ii=i(Ep,"nielsr"),Ep.forEach(t),li=i(Fa,`. The original code (written in JAX) can be
found `),Nt=s(Fa,"A",{href:!0,rel:!0});var kp=r(Nt);di=i(kp,"here"),kp.forEach(t),ci=i(Fa,"."),Fa.forEach(t),cr=c(o),et=s(o,"P",{});var Cr=r(et);pi=i(Cr,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=s(Cr,"A",{href:!0,rel:!0});var Ip=r(Lt);hi=i(Ip,"timm library"),Ip.forEach(t),mi=i(Cr,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),Cr.forEach(t),pr=c(o),Ae=s(o,"H2",{class:!0});var qr=r(Ae);tt=s(qr,"A",{id:!0,class:!0,href:!0});var Mp=r(tt);Za=s(Mp,"SPAN",{});var jp=r(Za);b(Dt.$$.fragment,jp),jp.forEach(t),Mp.forEach(t),fi=c(qr),Qa=s(qr,"SPAN",{});var Pp=r(Qa);ui=i(Pp,"ViTConfig"),Pp.forEach(t),qr.forEach(t),hr=c(o),U=s(o,"DIV",{class:!0});var ye=r(U);b(Ot.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Va=r(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=s(Va,"A",{href:!0});var Cp=r(da);vi=i(Cp,"ViTModel"),Cp.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
`),St=s(Va,"A",{href:!0,rel:!0});var qp=r(St);wi=i(qp,"google/vit-base-patch16-224"),qp.forEach(t),bi=i(Va," architecture."),Va.forEach(t),yi=c(ye),Ne=s(ye,"P",{});var Ea=r(Ne);$i=i(Ea,"Configuration objects inherit from "),ca=s(Ea,"A",{href:!0});var Ap=r(ca);xi=i(Ap,"PretrainedConfig"),Ap.forEach(t),Fi=i(Ea,` and can be used to control the model outputs. Read the
documentation from `),pa=s(Ea,"A",{href:!0});var zp=r(pa);Vi=i(zp,"PretrainedConfig"),zp.forEach(t),Ei=i(Ea," for more information."),Ea.forEach(t),ki=c(ye),Ya=s(ye,"P",{});var Np=r(Ya);Ii=i(Np,"Example:"),Np.forEach(t),Mi=c(ye),b(Wt.$$.fragment,ye),ye.forEach(t),mr=c(o),Le=s(o,"H2",{class:!0});var Ar=r(Le);ot=s(Ar,"A",{id:!0,class:!0,href:!0});var Lp=r(ot);es=s(Lp,"SPAN",{});var Dp=r(es);b(Bt.$$.fragment,Dp),Dp.forEach(t),Lp.forEach(t),ji=c(Ar),ts=s(Ar,"SPAN",{});var Op=r(ts);Pi=i(Op,"ViTFeatureExtractor"),Op.forEach(t),Ar.forEach(t),fr=c(o),re=s(o,"DIV",{class:!0});var bt=r(re);b(Ut.$$.fragment,bt),Ci=c(bt),os=s(bt,"P",{});var Sp=r(os);qi=i(Sp,"Constructs a ViT feature extractor."),Sp.forEach(t),Ai=c(bt),Rt=s(bt,"P",{});var zr=r(Rt);zi=i(zr,"This feature extractor inherits from "),ha=s(zr,"A",{href:!0});var Wp=r(ha);Ni=i(Wp,"FeatureExtractionMixin"),Wp.forEach(t),Li=i(zr,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),zr.forEach(t),Di=c(bt),be=s(bt,"DIV",{class:!0});var ka=r(be);b(Ht.$$.fragment,ka),Oi=c(ka),as=s(ka,"P",{});var Bp=r(as);Si=i(Bp,"Main method to prepare for the model one or several image(s)."),Bp.forEach(t),Wi=c(ka),b(at.$$.fragment,ka),ka.forEach(t),bt.forEach(t),ur=c(o),De=s(o,"H2",{class:!0});var Nr=r(De);st=s(Nr,"A",{id:!0,class:!0,href:!0});var Up=r(st);ss=s(Up,"SPAN",{});var Rp=r(ss);b(Jt.$$.fragment,Rp),Rp.forEach(t),Up.forEach(t),Bi=c(Nr),rs=s(Nr,"SPAN",{});var Hp=r(rs);Ui=i(Hp,"ViTModel"),Hp.forEach(t),Nr.forEach(t),gr=c(o),me=s(o,"DIV",{class:!0});var Ia=r(me);b(Kt.$$.fragment,Ia),Ri=c(Ia),Gt=s(Ia,"P",{});var Lr=r(Gt);Hi=i(Lr,`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Xt=s(Lr,"A",{href:!0,rel:!0});var Jp=r(Xt);Ji=i(Jp,"torch.nn.Module"),Jp.forEach(t),Ki=i(Lr,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lr.forEach(t),Gi=c(Ia),H=s(Ia,"DIV",{class:!0});var $e=r(H);b(Zt.$$.fragment,$e),Xi=c($e),Oe=s($e,"P",{});var Ma=r(Oe);Zi=i(Ma,"The "),ma=s(Ma,"A",{href:!0});var Kp=r(ma);Qi=i(Kp,"ViTModel"),Kp.forEach(t),Yi=i(Ma," forward method, overrides the "),ns=s(Ma,"CODE",{});var Gp=r(ns);el=i(Gp,"__call__"),Gp.forEach(t),tl=i(Ma," special method."),Ma.forEach(t),ol=c($e),b(rt.$$.fragment,$e),al=c($e),is=s($e,"P",{});var Xp=r(is);sl=i(Xp,"Example:"),Xp.forEach(t),rl=c($e),b(Qt.$$.fragment,$e),$e.forEach(t),Ia.forEach(t),_r=c(o),Se=s(o,"H2",{class:!0});var Dr=r(Se);nt=s(Dr,"A",{id:!0,class:!0,href:!0});var Zp=r(nt);ls=s(Zp,"SPAN",{});var Qp=r(ls);b(Yt.$$.fragment,Qp),Qp.forEach(t),Zp.forEach(t),nl=c(Dr),ds=s(Dr,"SPAN",{});var Yp=r(ds);il=i(Yp,"ViTForMaskedImageModeling"),Yp.forEach(t),Dr.forEach(t),vr=c(o),fe=s(o,"DIV",{class:!0});var ja=r(fe);b(eo.$$.fragment,ja),ll=c(ja),We=s(ja,"P",{});var Pa=r(We);dl=i(Pa,"ViT Model with a decoder on top for masked image modeling, as proposed in "),cs=s(Pa,"CODE",{});var eh=r(cs);cl=i(eh,"SimMIM <https://arxiv.org/abs/2111.09886>"),eh.forEach(t),pl=i(Pa,`__.
This model is a PyTorch `),to=s(Pa,"A",{href:!0,rel:!0});var th=r(to);hl=i(th,"torch.nn.Module"),th.forEach(t),ml=i(Pa,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pa.forEach(t),fl=c(ja),J=s(ja,"DIV",{class:!0});var xe=r(J);b(oo.$$.fragment,xe),ul=c(xe),Be=s(xe,"P",{});var Ca=r(Be);gl=i(Ca,"The "),fa=s(Ca,"A",{href:!0});var oh=r(fa);_l=i(oh,"ViTForMaskedImageModeling"),oh.forEach(t),vl=i(Ca," forward method, overrides the "),ps=s(Ca,"CODE",{});var ah=r(ps);Tl=i(ah,"__call__"),ah.forEach(t),wl=i(Ca," special method."),Ca.forEach(t),bl=c(xe),b(it.$$.fragment,xe),yl=c(xe),hs=s(xe,"P",{});var sh=r(hs);$l=i(sh,"Examples:"),sh.forEach(t),xl=c(xe),b(ao.$$.fragment,xe),xe.forEach(t),ja.forEach(t),Tr=c(o),Ue=s(o,"H2",{class:!0});var Or=r(Ue);lt=s(Or,"A",{id:!0,class:!0,href:!0});var rh=r(lt);ms=s(rh,"SPAN",{});var nh=r(ms);b(so.$$.fragment,nh),nh.forEach(t),rh.forEach(t),Fl=c(Or),fs=s(Or,"SPAN",{});var ih=r(fs);Vl=i(ih,"ViTForImageClassification"),ih.forEach(t),Or.forEach(t),wr=c(o),ne=s(o,"DIV",{class:!0});var yt=r(ne);b(ro.$$.fragment,yt),El=c(yt),us=s(yt,"P",{});var lh=r(us);kl=i(lh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),lh.forEach(t),Il=c(yt),no=s(yt,"P",{});var Sr=r(no);Ml=i(Sr,"This model is a PyTorch "),io=s(Sr,"A",{href:!0,rel:!0});var dh=r(io);jl=i(dh,"torch.nn.Module"),dh.forEach(t),Pl=i(Sr,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Sr.forEach(t),Cl=c(yt),K=s(yt,"DIV",{class:!0});var Fe=r(K);b(lo.$$.fragment,Fe),ql=c(Fe),Re=s(Fe,"P",{});var qa=r(Re);Al=i(qa,"The "),ua=s(qa,"A",{href:!0});var ch=r(ua);zl=i(ch,"ViTForImageClassification"),ch.forEach(t),Nl=i(qa," forward method, overrides the "),gs=s(qa,"CODE",{});var ph=r(gs);Ll=i(ph,"__call__"),ph.forEach(t),Dl=i(qa," special method."),qa.forEach(t),Ol=c(Fe),b(dt.$$.fragment,Fe),Sl=c(Fe),_s=s(Fe,"P",{});var hh=r(_s);Wl=i(hh,"Example:"),hh.forEach(t),Bl=c(Fe),b(co.$$.fragment,Fe),Fe.forEach(t),yt.forEach(t),br=c(o),He=s(o,"H2",{class:!0});var Wr=r(He);ct=s(Wr,"A",{id:!0,class:!0,href:!0});var mh=r(ct);vs=s(mh,"SPAN",{});var fh=r(vs);b(po.$$.fragment,fh),fh.forEach(t),mh.forEach(t),Ul=c(Wr),Ts=s(Wr,"SPAN",{});var uh=r(Ts);Rl=i(uh,"TFViTModel"),uh.forEach(t),Wr.forEach(t),yr=c(o),D=s(o,"DIV",{class:!0});var de=r(D);b(ho.$$.fragment,de),Hl=c(de),ws=s(de,"P",{});var gh=r(ws);Jl=i(gh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),gh.forEach(t),Kl=c(de),mo=s(de,"P",{});var Br=r(mo);Gl=i(Br,"This model inherits from "),ga=s(Br,"A",{href:!0});var _h=r(ga);Xl=i(_h,"TFPreTrainedModel"),_h.forEach(t),Zl=i(Br,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Br.forEach(t),Ql=c(de),fo=s(de,"P",{});var Ur=r(fo);Yl=i(Ur,"This model is also a "),uo=s(Ur,"A",{href:!0,rel:!0});var vh=r(uo);ed=i(vh,"tf.keras.Model"),vh.forEach(t),td=i(Ur,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ur.forEach(t),od=c(de),b(pt.$$.fragment,de),ad=c(de),G=s(de,"DIV",{class:!0});var Ve=r(G);b(go.$$.fragment,Ve),sd=c(Ve),Je=s(Ve,"P",{});var Aa=r(Je);rd=i(Aa,"The "),_a=s(Aa,"A",{href:!0});var Th=r(_a);nd=i(Th,"TFViTModel"),Th.forEach(t),id=i(Aa," forward method, overrides the "),bs=s(Aa,"CODE",{});var wh=r(bs);ld=i(wh,"__call__"),wh.forEach(t),dd=i(Aa," special method."),Aa.forEach(t),cd=c(Ve),b(ht.$$.fragment,Ve),pd=c(Ve),ys=s(Ve,"P",{});var bh=r(ys);hd=i(bh,"Examples:"),bh.forEach(t),md=c(Ve),b(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),$r=c(o),Ke=s(o,"H2",{class:!0});var Rr=r(Ke);mt=s(Rr,"A",{id:!0,class:!0,href:!0});var yh=r(mt);$s=s(yh,"SPAN",{});var $h=r($s);b(vo.$$.fragment,$h),$h.forEach(t),yh.forEach(t),fd=c(Rr),xs=s(Rr,"SPAN",{});var xh=r(xs);ud=i(xh,"TFViTForImageClassification"),xh.forEach(t),Rr.forEach(t),xr=c(o),O=s(o,"DIV",{class:!0});var ce=r(O);b(To.$$.fragment,ce),gd=c(ce),Fs=s(ce,"P",{});var Fh=r(Fs);_d=i(Fh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Fh.forEach(t),vd=c(ce),wo=s(ce,"P",{});var Hr=r(wo);Td=i(Hr,"This model inherits from "),va=s(Hr,"A",{href:!0});var Vh=r(va);wd=i(Vh,"TFPreTrainedModel"),Vh.forEach(t),bd=i(Hr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hr.forEach(t),yd=c(ce),bo=s(ce,"P",{});var Jr=r(bo);$d=i(Jr,"This model is also a "),yo=s(Jr,"A",{href:!0,rel:!0});var Eh=r(yo);xd=i(Eh,"tf.keras.Model"),Eh.forEach(t),Fd=i(Jr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jr.forEach(t),Vd=c(ce),b(ft.$$.fragment,ce),Ed=c(ce),X=s(ce,"DIV",{class:!0});var Ee=r(X);b($o.$$.fragment,Ee),kd=c(Ee),Ge=s(Ee,"P",{});var za=r(Ge);Id=i(za,"The "),Ta=s(za,"A",{href:!0});var kh=r(Ta);Md=i(kh,"TFViTForImageClassification"),kh.forEach(t),jd=i(za," forward method, overrides the "),Vs=s(za,"CODE",{});var Ih=r(Vs);Pd=i(Ih,"__call__"),Ih.forEach(t),Cd=i(za," special method."),za.forEach(t),qd=c(Ee),b(ut.$$.fragment,Ee),Ad=c(Ee),Es=s(Ee,"P",{});var Mh=r(Es);zd=i(Mh,"Examples:"),Mh.forEach(t),Nd=c(Ee),b(xo.$$.fragment,Ee),Ee.forEach(t),ce.forEach(t),Fr=c(o),Xe=s(o,"H2",{class:!0});var Kr=r(Xe);gt=s(Kr,"A",{id:!0,class:!0,href:!0});var jh=r(gt);ks=s(jh,"SPAN",{});var Ph=r(ks);b(Fo.$$.fragment,Ph),Ph.forEach(t),jh.forEach(t),Ld=c(Kr),Is=s(Kr,"SPAN",{});var Ch=r(Is);Dd=i(Ch,"FlaxVitModel"),Ch.forEach(t),Kr.forEach(t),Vr=c(o),q=s(o,"DIV",{class:!0});var ee=r(q);b(Vo.$$.fragment,ee),Od=c(ee),Ms=s(ee,"P",{});var qh=r(Ms);Sd=i(qh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),qh.forEach(t),Wd=c(ee),Eo=s(ee,"P",{});var Gr=r(Eo);Bd=i(Gr,"This model inherits from "),wa=s(Gr,"A",{href:!0});var Ah=r(wa);Ud=i(Ah,"FlaxPreTrainedModel"),Ah.forEach(t),Rd=i(Gr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gr.forEach(t),Hd=c(ee),ko=s(ee,"P",{});var Xr=r(ko);Jd=i(Xr,"This model is also a Flax Linen "),Io=s(Xr,"A",{href:!0,rel:!0});var zh=r(Io);Kd=i(zh,"flax.linen.Module"),zh.forEach(t),Gd=i(Xr,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Xr.forEach(t),Xd=c(ee),js=s(ee,"P",{});var Nh=r(js);Zd=i(Nh,"Finally, this model supports inherent JAX features such as:"),Nh.forEach(t),Qd=c(ee),ue=s(ee,"UL",{});var $t=r(ue);Ps=s($t,"LI",{});var Lh=r(Ps);Mo=s(Lh,"A",{href:!0,rel:!0});var Dh=r(Mo);Yd=i(Dh,"Just-In-Time (JIT) compilation"),Dh.forEach(t),Lh.forEach(t),ec=c($t),Cs=s($t,"LI",{});var Oh=r(Cs);jo=s(Oh,"A",{href:!0,rel:!0});var Sh=r(jo);tc=i(Sh,"Automatic Differentiation"),Sh.forEach(t),Oh.forEach(t),oc=c($t),qs=s($t,"LI",{});var Wh=r(qs);Po=s(Wh,"A",{href:!0,rel:!0});var Bh=r(Po);ac=i(Bh,"Vectorization"),Bh.forEach(t),Wh.forEach(t),sc=c($t),As=s($t,"LI",{});var Uh=r(As);Co=s(Uh,"A",{href:!0,rel:!0});var Rh=r(Co);rc=i(Rh,"Parallelization"),Rh.forEach(t),Uh.forEach(t),$t.forEach(t),nc=c(ee),Z=s(ee,"DIV",{class:!0});var ke=r(Z);b(qo.$$.fragment,ke),ic=c(ke),Ze=s(ke,"P",{});var Na=r(Ze);lc=i(Na,"The "),zs=s(Na,"CODE",{});var Hh=r(zs);dc=i(Hh,"FlaxViTPreTrainedModel"),Hh.forEach(t),cc=i(Na,"forward method, overrides the "),Ns=s(Na,"CODE",{});var Jh=r(Ns);pc=i(Jh,"__call__"),Jh.forEach(t),hc=i(Na," special method."),Na.forEach(t),mc=c(ke),b(_t.$$.fragment,ke),fc=c(ke),Ls=s(ke,"P",{});var Kh=r(Ls);uc=i(Kh,"Examples:"),Kh.forEach(t),gc=c(ke),b(Ao.$$.fragment,ke),ke.forEach(t),ee.forEach(t),Er=c(o),Qe=s(o,"H2",{class:!0});var Zr=r(Qe);vt=s(Zr,"A",{id:!0,class:!0,href:!0});var Gh=r(vt);Ds=s(Gh,"SPAN",{});var Xh=r(Ds);b(zo.$$.fragment,Xh),Xh.forEach(t),Gh.forEach(t),_c=c(Zr),Os=s(Zr,"SPAN",{});var Zh=r(Os);vc=i(Zh,"FlaxViTForImageClassification"),Zh.forEach(t),Zr.forEach(t),kr=c(o),A=s(o,"DIV",{class:!0});var te=r(A);b(No.$$.fragment,te),Tc=c(te),Ss=s(te,"P",{});var Qh=r(Ss);wc=i(Qh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Qh.forEach(t),bc=c(te),Lo=s(te,"P",{});var Qr=r(Lo);yc=i(Qr,"This model inherits from "),ba=s(Qr,"A",{href:!0});var Yh=r(ba);$c=i(Yh,"FlaxPreTrainedModel"),Yh.forEach(t),xc=i(Qr,`. Check the superclass documentation for the generic methods the
