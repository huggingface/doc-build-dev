...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){v(d.$$.fragment)},l(p){$(d.$$.fragment,p)},m(p,u){S(d,p,u),w=!0},p:uo,i(p){w||(T(d.$$.fragment,p),w=!0)},o(p){y(d.$$.fragment,p),w=!1},d(p){x(d,p)}}}function ua(M){let d,w,p,u,b;return{c(){d=n("p"),w=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var g=i(d);w=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(g,"CODE",{});var F=i(p);u=r(F,"Module"),F.forEach(o),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(l,g){_(l,d,g),e(d,w),e(d,p),e(p,u),e(d,b)},d(l){l&&o(d)}}}function ga(M){let d,w,p,u,b;return u=new go({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){d=n("p"),w=a("Example:"),p=m(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var g=i(d);w=r(g,"Example:"),g.forEach(o),p=f(l),$(u.$$.fragment,l)},m(l,g){_(l,d,g),e(d,w),_(l,p,g),S(u,l,g),b=!0},p:uo,i(l){b||(T(u.$$.fragment,l),b=!0)},o(l){y(u.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(u,l)}}}function _a(M){let d,w,p,u,b;return{c(){d=n("p"),w=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var g=i(d);w=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(g,"CODE",{});var F=i(p);u=r(F,"Module"),F.forEach(o),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(l,g){_(l,d,g),e(d,w),e(d,p),e(p,u),e(d,b)},d(l){l&&o(d)}}}function wa(M){let d,w,p,u,b;return u=new go({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),{c(){d=n("p"),w=a("Examples:"),p=m(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var g=i(d);w=r(g,"Examples:"),g.forEach(o),p=f(l),$(u.$$.fragment,l)},m(l,g){_(l,d,g),e(d,w),_(l,p,g),S(u,l,g),b=!0},p:uo,i(l){b||(T(u.$$.fragment,l),b=!0)},o(l){y(u.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(u,l)}}}function ba(M){let d,w,p,u,b;return{c(){d=n("p"),w=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var g=i(d);w=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(g,"CODE",{});var F=i(p);u=r(F,"Module"),F.forEach(o),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(l,g){_(l,d,g),e(d,w),e(d,p),e(p,u),e(d,b)},d(l){l&&o(d)}}}function va(M){let d,w,p,u,b;return u=new go({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17005/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17005/src/transformers/models/swin/modeling_swin.py#L983"}}),Ae=new He({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17005/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_17005/src/transformers/models/swin/modeling_swin.py#L998",returnDescription:`
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17005/src/transformers/models/swin/modeling_swin.py#L1108",returnDescription:`
...
`}}),de=new us({props:{$$slots:{default:[ba]},$$scope:{ctx:M}}}),ce=new fo({props:{anchor:"transformers.SwinForImageClassification.forward.example",$$slots:{default:[va]},$$scope:{ctx:M}}}),{c(){d=n("meta"),w=m(),p=n("h1"),u=n("a"),b=n("span"),v(l.$$.fragment),g=m(),F=n("span"),_o=a("Swin Transformer"),Lt=m(),N=n("h2"),J=n("a"),ct=n("span"),v(ge.$$.fragment),wo=m(),ht=n("span"),bo=a("Overview"),Ht=m(),L=n("p"),vo=a("The Swin Transformer was proposed in "),_e=n("a"),$o=a("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),So=n("br"),To=a(`
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Vt=m(),Ve=n("p"),ko=a("Tips:"),Bt=m(),O=n("ul"),we=n("li"),Mo=a("One can use the "),Be=n("a"),Eo=a("AutoFeatureExtractor"),Fo=a(" API to prepare images for the model."),Co=m(),be=n("li"),jo=a("Swin pads the inputs supporting any input height and width (if divisible by "),mt=n("code"),Io=a("32"),Ao=a(")."),Po=m(),k=n("li"),qo=a("Swin can be used as a "),ft=n("em"),zo=a("backbone"),Oo=a(". When "),ut=n("code"),Do=a("output_hidden_states = True"),No=a(", it will output both "),gt=n("code"),Lo=a("hidden_states"),Ho=a(" and "),_t=n("code"),Wo=a("reshaped_hidden_states"),Uo=a(". The "),wt=n("code"),Vo=a("reshaped_hidden_states"),Bo=a(" have a shape of "),bt=n("code"),Ko=a("(batch, num_channels, height, width)"),Ro=a(" rather than "),vt=n("code"),Yo=a("(batch_size, sequence_length, num_channels)"),Zo=a("."),Kt=m(),Q=n("img"),Rt=m(),X=n("small"),Go=a("Swin Transformer architecture. Taken from the "),Ke=n("a"),Jo=a("original paper"),Qo=a("."),Yt=m(),D=n("p"),Xo=a("This model was contributed by "),ve=n("a"),en=a("novice03"),tn=a(". The original code can be found "),$e=n("a"),on=a("here"),nn=a("."),Zt=m(),H=n("h2"),ee=n("a"),$t=n("span"),v(Se.$$.fragment),sn=m(),St=n("span"),an=a("SwinConfig"),Gt=m(),C=n("div"),v(Te.$$.fragment),rn=m(),W=n("p"),ln=a("This is the configuration class to store the configuration of a "),Re=n("a"),dn=a("SwinModel"),cn=a(`. It is used to instantiate a Swin
...
documentation from `),Ze=n("a"),_n=a("PretrainedConfig"),wn=a(" for more information."),bn=m(),v(te.$$.fragment),Jt=m(),V=n("h2"),oe=n("a"),Tt=n("span"),v(xe.$$.fragment),vn=m(),yt=n("span"),$n=a("SwinModel"),Qt=m(),q=n("div"),v(ke.$$.fragment),Sn=m(),Me=n("p"),Tn=a(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ee=n("a"),yn=a("torch.nn.Module"),xn=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn=m(),I=n("div"),v(Fe.$$.fragment),Mn=m(),B=n("p"),En=a("The "),Ge=n("a"),Fn=a("SwinModel"),Cn=a(" forward method, overrides the "),xt=n("code"),jn=a("__call__"),In=a(" special method."),An=m(),v(ne.$$.fragment),Pn=m(),v(se.$$.fragment),Xt=m(),K=n("h2"),ae=n("a"),kt=n("span"),v(Ce.$$.fragment),qn=m(),Mt=n("span"),zn=a("SwinForMaskedImageModeling"),eo=m(),z=n("div"),v(je.$$.fragment),On=m(),R=n("p"),Dn=a("Swin Model with a decoder on top for masked image modeling, as proposed in "),Et=n("code"),Nn=a("SimMIM <https://arxiv.org/abs/2111.09886>"),Ln=a(`__.
This model is a PyTorch `),Ie=n("a"),Hn=a("torch.nn.Module"),Wn=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Un=m(),A=n("div"),v(Ae.$$.fragment),Vn=m(),Y=n("p"),Bn=a("The "),Je=n("a"),Kn=a("SwinForMaskedImageModeling"),Rn=a(" forward method, overrides the "),Ft=n("code"),Yn=a("__call__"),Zn=a(" special method."),Gn=m(),v(re.$$.fragment),Jn=m(),v(ie.$$.fragment),to=m(),Z=n("h2"),le=n("a"),Ct=n("span"),v(Pe.$$.fragment),Qn=m(),jt=n("span"),Xn=a("SwinForImageClassification"),oo=m(),j=n("div"),v(qe.$$.fragment),es=m(),It=n("p"),ts=a(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),os=m(),ze=n("p"),ns=a("This model is a PyTorch "),Oe=n("a"),ss=a("torch.nn.Module"),as=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),rs=m(),P=n("div"),v(De.$$.fragment),is=m(),G=n("p"),ls=a("The "),Qe=n("a"),ds=a("SwinForImageClassification"),cs=a(" forward method, overrides the "),At=n("code"),hs=a("__call__"),ps=a(" special method."),ms=m(),v(de.$$.fragment),fs=m(),v(ce.$$.fragment),this.h()},l(t){const h=ha('[data-svelte="svelte-1phssyn"]',document.head);d=s(h,"META",{name:!0,content:!0}),h.forEach(o),w=f(t),p=s(t,"H1",{class:!0});var Ne=i(p);u=s(Ne,"A",{id:!0,class:!0,href:!0});var Pt=i(u);b=s(Pt,"SPAN",{});var qt=i(b);$(l.$$.fragment,qt),qt.forEach(o),Pt.forEach(o),g=f(Ne),F=s(Ne,"SPAN",{});var zt=i(F);_o=r(zt,"Swin Transformer"),zt.forEach(o),Ne.forEach(o),Lt=f(t),N=s(t,"H2",{class:!0});var Le=i(N);J=s(Le,"A",{id:!0,class:!0,href:!0});var Ot=i(J);ct=s(Ot,"SPAN",{});var Dt=i(ct);$(ge.$$.fragment,Dt),Dt.forEach(o),Ot.forEach(o),wo=f(Le),ht=s(Le,"SPAN",{});var _s=i(ht);bo=r(_s,"Overview"),_s.forEach(o),Le.forEach(o),Ht=f(t),L=s(t,"P",{});var Nt=i(L);vo=r(Nt,"The Swin Transformer was proposed in "),_e=s(Nt,"A",{href:!0,rel:!0});var ws=i(_e);$o=r(ws,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),ws.forEach(o),So=s(Nt,"BR",{}),To=r(Nt,`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Nt.forEach(o),Wt=f(t),We=s(t,"P",{});var bs=i(We);yo=r(bs,"The abstract from the paper is the following:"),bs.forEach(o),Ut=f(t),Ue=s(t,"P",{});var vs=i(Ue);pt=s(vs,"EM",{});var $s=i(pt);xo=r($s,`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
for computer vision. Challenges in adapting Transformer from language to vision arise from differences between the two domains,
such as large variations in the scale of visual entities and the high resolution of pixels in images compared to words in text.
To address these differences, we propose a hierarchical Transformer whose representation is computed with \\bold{S}hifted
\\bold{win}dows. The shifted windowing scheme brings greater efficiency by limiting self-attention computation to non-overlapping
...
documentation from `),Ze=s(ot,"A",{href:!0});var Hs=i(Ze);_n=r(Hs,"PretrainedConfig"),Hs.forEach(o),wn=r(ot," for more information."),ot.forEach(o),bn=f(he),$(te.$$.fragment,he),he.forEach(o),Jt=f(t),V=s(t,"H2",{class:!0});var lo=i(V);oe=s(lo,"A",{id:!0,class:!0,href:!0});var Ws=i(oe);Tt=s(Ws,"SPAN",{});var Us=i(Tt);$(xe.$$.fragment,Us),Us.forEach(o),Ws.forEach(o),vn=f(lo),yt=s(lo,"SPAN",{});var Vs=i(yt);$n=r(Vs,"SwinModel"),Vs.forEach(o),lo.forEach(o),Qt=f(t),q=s(t,"DIV",{class:!0});var nt=i(q);$(ke.$$.fragment,nt),Sn=f(nt),Me=s(nt,"P",{});var co=i(Me);Tn=r(co,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
