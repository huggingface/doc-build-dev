import{S as Mv,i as $v,s as Ev,e as s,k as d,w as v,t as n,M as qv,c as r,d as o,m as p,a as i,x as y,h as a,b as l,G as e,g as u,y as b,q as L,o as w,B as k,v as zv,L as an}from"../../chunks/vendor-hf-doc-builder.js";import{T as Gi}from"../../chunks/Tip-hf-doc-builder.js";import{D}from"../../chunks/Docstring-hf-doc-builder.js";import{C as U}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as nn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function jv(j){let h,x,f,g,T;return g=new U({props:{code:`from transformers import LayoutLMv2Model, LayoutLMv2Config
...
torch.Size([<span class="hljs-number">1</span>, <span class="hljs-number">342</span>, <span class="hljs-number">768</span>])`}}),{c(){h=s("p"),x=n("Examples:"),f=d(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=a(_,"Examples:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:an,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){w(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),k(g,m)}}}function Iv(j){let h,x,f,g,T;return{c(){h=s("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=a(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var O=i(f);g=a(O,"Module"),O.forEach(o),T=a(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
(<span class="hljs-number">4</span>, <span class="hljs-string">&#x27;advertisement&#x27;</span>)`}}),{c(){h=s("p"),x=n("Example:"),f=d(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=a(_,"Example:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:an,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){w(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),k(g,m)}}}function Dv(j){let h,x,f,g,T;return{c(){h=s("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=a(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var O=i(f);g=a(O,"Module"),O.forEach(o),T=a(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
[<span class="hljs-string">&#x27;B-ANSWER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>]`}}),{c(){h=s("p"),x=n("Example:"),f=d(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=a(_,"Example:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:an,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){w(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),k(g,m)}}}function Nv(j){let h,x,f,g,T;return{c(){h=s("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=a(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var O=i(f);g=a(O,"Module"),O.forEach(o),T=a(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
(<span class="hljs-number">154</span>, <span class="hljs-number">287</span>)`}}),{c(){v(h.$$.fragment)},l(f){y(h.$$.fragment,f)},m(f,g){b(h,f,g),x=!0},p:an,i(f){x||(L(h.$$.fragment,f),x=!0)},o(f){w(h.$$.fragment,f),x=!1},d(f){k(h,f)}}}function Uv(j){let h,x,f,g,T,m,_,O,Hi,gr,Me,Ve,_a,Et,Ki,va,Xi,_r,me,Yi,qt,Zi,Ji,sn,el,tl,vr,he,X,ol,zt,nl,al,jt,sl,rl,Ft,il,ll,Pt,cl,dl,pl,Ct,ul,It,ml,hl,fl,At,gl,Dt,_l,vl,yr,rn,yl,br,ln,ya,bl,Lr,ae,Ll,ba,wl,kl,La,xl,Tl,wa,Ml,$l,wr,Ot,kr,cn,El,xr,dn,ql,Tr,V,ka,zl,jl,Nt,Fl,St,Pl,Cl,Il,Rt,Al,Ut,Dl,Ol,Nl,$e,Sl,Bt,Rl,Ul,Wt,Bl,Wl,Vl,M,Ql,xa,Gl,Hl,pn,Kl,Xl,Ta,Yl,Zl,Ma,Jl,ec,$a,tc,oc,Ea,nc,ac,qa,sc,rc,za,ic,lc,ja,cc,dc,un,pc,uc,Vt,mc,hc,Qt,fc,gc,Mr,Gt,$r,fe,_c,Fa,vc,yc,Pa,bc,Lc,Er,Ht,qr,Qe,wc,mn,kc,xc,zr,ge,I,Tc,hn,Mc,$c,Ca,Ec,qc,Ia,zc,jc,fn,Fc,Pc,Aa,Cc,Ic,Da,Ac,Dc,Oa,Oc,Nc,Sc,Kt,Rc,gn,Uc,Bc,Wc,Xt,Vc,Na,Qc,Gc,jr,Ge,Hc,_n,Kc,Xc,Fr,Ee,He,Sa,Yt,Yc,Ra,Zc,Pr,Q,Jc,vn,ed,td,yn,od,nd,bn,ad,sd,Ln,rd,id,Cr,Zt,Ir,E,ld,wn,cd,dd,kn,pd,ud,Ua,md,hd,xn,fd,gd,Tn,_d,vd,Ba,yd,bd,Wa,Ld,wd,Va,kd,xd,Qa,Td,Md,Ga,$d,Ed,Ar,B,Mn,qd,zd,Jt,jd,Fd,$n,Pd,Cd,Ha,Id,Ad,Ka,Dd,Od,Dr,En,Nd,Or,qn,Xa,Sd,Nr,zn,Rd,Sr,eo,Rr,jn,Ya,Ud,Ur,_e,Bd,Za,Wd,Vd,Ja,Qd,Gd,Br,to,Wr,Fn,es,Hd,Vr,G,Kd,ts,Xd,Yd,os,Zd,Jd,ns,ep,tp,as,op,np,Qr,oo,Gr,Pn,ss,ap,Hr,Cn,sp,Kr,no,Xr,In,rs,rp,Yr,An,ip,Zr,ao,Jr,qe,Ke,is,so,lp,ls,cp,ei,Y,ro,dp,ze,pp,Dn,up,mp,io,hp,fp,gp,je,_p,On,vp,yp,Nn,bp,Lp,wp,Xe,ti,Fe,Ye,cs,lo,kp,ds,xp,oi,Z,co,Tp,ps,Mp,$p,po,Ep,us,qp,zp,jp,ve,uo,Fp,ms,Pp,Cp,Ze,ni,Pe,Je,hs,mo,Ip,fs,Ap,ai,N,ho,Dp,S,Op,Sn,Np,Sp,gs,Rp,Up,_s,Bp,Wp,vs,Vp,Qp,ys,Gp,Hp,bs,Kp,Xp,Yp,fo,Zp,Rn,Jp,eu,tu,Un,Bn,ou,nu,au,et,go,su,Ls,ru,iu,Wn,_o,si,Ce,tt,ws,vo,lu,ks,cu,ri,J,yo,du,bo,pu,xs,uu,mu,hu,Lo,fu,Vn,gu,_u,vu,ot,wo,yu,Ts,bu,ii,Ie,nt,Ms,ko,Lu,$s,wu,li,W,xo,ku,Es,xu,Tu,Qn,Gn,Mu,$u,Eu,F,qu,Hn,zu,ju,Kn,Fu,Pu,Xn,Cu,Iu,qs,Au,Du,zs,Ou,Nu,js,Su,Ru,Fs,Uu,Bu,Ps,Wu,Vu,Cs,Qu,Gu,Hu,ye,To,Ku,$,Xu,Is,Yu,Zu,Mo,As,Ju,em,tm,Yn,om,nm,Ds,am,sm,Os,rm,im,$o,Ns,lm,cm,dm,Ss,pm,um,Zn,mm,hm,Rs,fm,gm,Us,_m,vm,Bs,ym,bm,Ws,Lm,wm,km,Vs,xm,ci,Ae,at,Qs,Eo,Tm,Gs,Mm,di,de,qo,$m,zo,Em,jo,qm,zm,jm,se,Fo,Fm,De,Pm,Jn,Cm,Im,Hs,Am,Dm,Om,st,Nm,rt,pi,Oe,it,Ks,Po,Sm,Xs,Rm,ui,ee,Co,Um,Io,Bm,Ao,Wm,Vm,Qm,Do,Gm,Oo,Hm,Km,Xm,re,No,Ym,Ne,Zm,ea,Jm,eh,Ys,th,oh,nh,lt,ah,ct,mi,Se,dt,Zs,So,sh,Js,rh,hi,te,Ro,ih,oe,lh,Uo,ch,dh,Bo,ph,uh,Wo,mh,hh,Vo,fh,gh,_h,Qo,vh,Go,yh,bh,Lh,ie,Ho,wh,Re,kh,ta,xh,Th,er,Mh,$h,Eh,pt,qh,ut,fi,Ue,mt,tr,Ko,zh,or,jh,gi,ne,Xo,Fh,pe,Ph,Yo,Ch,Ih,nr,Ah,Dh,ar,Oh,Nh,Sh,Zo,Rh,Jo,Uh,Bh,Wh,A,en,Vh,Be,Qh,oa,Gh,Hh,sr,Kh,Xh,Yh,ht,Zh,rr,Jh,ef,ir,tf,of,ft,nf,gt,_i;return m=new ce({}),Et=new ce({}),Ot=new U({props:{code:`python -m pip install 'git+https://github.com/facebookresearch/detectron2.git'
...
`}}),ht=new Gi({props:{$$slots:{default:[Nv]},$$scope:{ctx:j}}}),ft=new nn({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[Sv]},$$scope:{ctx:j}}}),gt=new nn({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example-2",$$slots:{default:[Rv]},$$scope:{ctx:j}}}),{c(){h=s("meta"),x=d(),f=s("h1"),g=s("a"),T=s("span"),v(m.$$.fragment),_=d(),O=s("span"),Hi=n("LayoutLMV2"),gr=d(),Me=s("h2"),Ve=s("a"),_a=s("span"),v(Et.$$.fragment),Ki=d(),va=s("span"),Xi=n("Overview"),_r=d(),me=s("p"),Yi=n("The LayoutLMV2 model was proposed in "),qt=s("a"),Zi=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ji=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
Dinei Florencio, Cha Zhang, Wanxiang Che, Min Zhang, Lidong Zhou. LayoutLMV2 improves `),sn=s("a"),el=n("LayoutLM"),tl=n(` to obtain
state-of-the-art results across several document image understanding benchmarks:`),vr=d(),he=s("ul"),X=s("li"),ol=n("information extraction from scanned documents: the "),zt=s("a"),nl=n("FUNSD"),al=n(` dataset (a
...
and the `),Pt=s("a"),cl=n("Kleister-NDA"),dl=n(` dataset (a collection of non-disclosure
agreements from the EDGAR database, including 254 documents for training, 83 documents for validation, and 203
documents for testing).`),pl=d(),Ct=s("li"),ul=n("document image classification: the "),It=s("a"),ml=n("RVL-CDIP"),hl=n(` dataset (a collection of
400,000 images belonging to one of 16 classes).`),fl=d(),At=s("li"),gl=n("document visual question answering: the "),Dt=s("a"),_l=n("DocVQA"),vl=n(` dataset (a collection of 50,000
questions defined on 12,000+ document images).`),yr=d(),rn=s("p"),yl=n("The abstract from the paper is the following:"),br=d(),ln=s("p"),ya=s("em"),bl=n(`Pre-training of text and layout has proved effective in a variety of visually-rich document understanding tasks due to
...
this https URL.`),Lr=d(),ae=s("p"),Ll=n("LayoutLMv2 depends on "),ba=s("code"),wl=n("detectron2"),kl=n(", "),La=s("code"),xl=n("torchvision"),Tl=n(" and "),wa=s("code"),Ml=n("tesseract"),$l=n(`. Run the
following to install them:`),wr=d(),v(Ot.$$.fragment),kr=d(),cn=s("p"),El=n("(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),xr=d(),dn=s("p"),ql=n("Tips:"),Tr=d(),V=s("ul"),ka=s("li"),zl=n(`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
pre-training (while LayoutLMv1 only adds visual embeddings during fine-tuning).`),jl=d(),Nt=s("li"),Fl=n(`LayoutLMv2 adds both a relative 1D attention bias as well as a spatial 2D attention bias to the attention scores in
the self-attention layers. Details can be found on page 5 of the `),St=s("a"),Pl=n("paper"),Cl=n("."),Il=d(),Rt=s("li"),Al=n("Demo notebooks on how to use the LayoutLMv2 model on RVL-CDIP, FUNSD, DocVQA, CORD can be found "),Ut=s("a"),Dl=n("here"),Ol=n("."),Nl=d(),$e=s("li"),Sl=n("LayoutLMv2 uses Facebook AI\u2019s "),Bt=s("a"),Rl=n("Detectron2"),Ul=n(` package for its visual
backbone. See `),Wt=s("a"),Bl=n("this link"),Wl=n(` for installation
instructions.`),Vl=d(),M=s("li"),Ql=n("In addition to "),xa=s("code"),Gl=n("input_ids"),Hl=n(", "),pn=s("a"),Kl=n("forward()"),Xl=n(` expects 2 additional inputs, namely
`),Ta=s("code"),Yl=n("image"),Zl=n(" and "),Ma=s("code"),Jl=n("bbox"),ec=n(". The "),$a=s("code"),tc=n("image"),oc=n(` input corresponds to the original document image in which the text
tokens occur. The model expects each document image to be of size 224x224. This means that if you have a batch of
document images, `),Ea=s("code"),nc=n("image"),ac=n(` should be a tensor of shape (batch_size, 3, 224, 224). This can be either a
`),qa=s("code"),sc=n("torch.Tensor"),rc=n(" or a "),za=s("code"),ic=n("Detectron2.structures.ImageList"),lc=n(`. You don\u2019t need to normalize the channels, as this is
done by the model. Important to note is that the visual backbone expects BGR channels instead of RGB, as all models
in Detectron2 are pre-trained using the BGR format. The `),ja=s("code"),cc=n("bbox"),dc=n(` input are the bounding boxes (i.e. 2D-positions)
of the input text tokens. This is identical to `),un=s("a"),pc=n("LayoutLMModel"),uc=n(`. These can be obtained using an
external OCR engine such as Google\u2019s `),Vt=s("a"),mc=n("Tesseract"),hc=n(" (there\u2019s a "),Qt=s("a"),fc=n(`Python
wrapper`),gc=n(` available). Each bounding box should be in (x0, y0, x1, y1)
format, where (x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1)
represents the position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on
a 0-1000 scale. To normalize, you can use the following function:`),Mr=d(),v(Gt.$$.fragment),$r=d(),fe=s("p"),_c=n("Here, "),Fa=s("code"),vc=n("width"),yc=n(" and "),Pa=s("code"),bc=n("height"),Lc=n(` correspond to the width and height of the original document in which the token
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),Er=d(),v(Ht.$$.fragment),qr=d(),Qe=s("p"),wc=n("However, this model includes a brand new "),mn=s("a"),kc=n("LayoutLMv2Processor"),xc=n(` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
section below.`),zr=d(),ge=s("ul"),I=s("li"),Tc=n("Internally, "),hn=s("a"),Mc=n("LayoutLMv2Model"),$c=n(" will send the "),Ca=s("code"),Ec=n("image"),qc=n(` input through its visual backbone to
obtain a lower-resolution feature map, whose shape is equal to the `),Ia=s("code"),zc=n("image_feature_pool_shape"),jc=n(` attribute of
`),fn=s("a"),Fc=n("LayoutLMv2Config"),Pc=n(`. This feature map is then flattened to obtain a sequence of image tokens. As
the size of the feature map is 7x7 by default, one obtains 49 image tokens. These are then concatenated with the text
tokens, and send through the Transformer encoder. This means that the last hidden states of the model will have a
length of 512 + 49 = 561, if you pad the text tokens up to the max length. More generally, the last hidden states
will have a shape of `),Aa=s("code"),Cc=n("seq_length"),Ic=n(" + "),Da=s("code"),Ac=n("image_feature_pool_shape[0]"),Dc=n(` *
`),Oa=s("code"),Oc=n("config.image_feature_pool_shape[1]"),Nc=n("."),Sc=d(),Kt=s("li"),Rc=n("When calling "),gn=s("a"),Uc=n("from_pretrained()"),Bc=n(`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),Wc=d(),Xt=s("li"),Vc=n("If you want to train the model in a distributed environment, make sure to call "),Na=s("code"),Qc=n("synchronize_batch_norm"),Gc=n(` on the
model in order to properly synchronize the batch normalization layers of the visual backbone.`),jr=d(),Ge=s("p"),Hc=n(`In addition, there\u2019s LayoutXLM, which is a multilingual version of LayoutLMv2. More information can be found on
`),_n=s("a"),Kc=n("LayoutXLM\u2019s documentation page"),Xc=n("."),Fr=d(),Ee=s("h2"),He=s("a"),Sa=s("span"),v(Yt.$$.fragment),Yc=d(),Ra=s("span"),Zc=n("Usage: LayoutLMv2Processor"),Pr=d(),Q=s("p"),Jc=n("The easiest way to prepare data for the model is to use "),vn=s("a"),ed=n("LayoutLMv2Processor"),td=n(`, which internally
combines a feature extractor (`),yn=s("a"),od=n("LayoutLMv2FeatureExtractor"),nd=n(`) and a tokenizer
(`),bn=s("a"),ad=n("LayoutLMv2Tokenizer"),sd=n(" or "),Ln=s("a"),rd=n("LayoutLMv2TokenizerFast"),id=n(`). The feature extractor
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),Cr=d(),v(Zt.$$.fragment),Ir=d(),E=s("p"),ld=n("In short, one can provide a document image (and possibly additional data) to "),wn=s("a"),cd=n("LayoutLMv2Processor"),dd=n(`,
and it will create the inputs expected by the model. Internally, the processor first uses
`),kn=s("a"),pd=n("LayoutLMv2FeatureExtractor"),ud=n(` to apply OCR on the image to get a list of words and normalized
bounding boxes, as well to resize the image to a given size in order to get the `),Ua=s("code"),md=n("image"),hd=n(` input. The words and
normalized bounding boxes are then provided to `),xn=s("a"),fd=n("LayoutLMv2Tokenizer"),gd=n(` or
`),Tn=s("a"),_d=n("LayoutLMv2TokenizerFast"),vd=n(", which converts them to token-level "),Ba=s("code"),yd=n("input_ids"),bd=n(`,
`),Wa=s("code"),Ld=n("attention_mask"),wd=n(", "),Va=s("code"),kd=n("token_type_ids"),xd=n(", "),Qa=s("code"),Td=n("bbox"),Md=n(`. Optionally, one can provide word labels to the processor,
which are turned into token-level `),Ga=s("code"),$d=n("labels"),Ed=n("."),Ar=d(),B=s("p"),Mn=s("a"),qd=n("LayoutLMv2Processor"),zd=n(" uses "),Jt=s("a"),jd=n("PyTesseract"),Fd=n(`, a Python
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),$n=s("a"),Pd=n("LayoutLMv2FeatureExtractor"),Cd=n(" with "),Ha=s("code"),Id=n("apply_ocr"),Ad=n(" set to "),Ka=s("code"),Dd=n("False"),Od=n("."),Dr=d(),En=s("p"),Nd=n(`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Or=d(),qn=s("p"),Xa=s("strong"),Sd=n(`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
True`),Nr=d(),zn=s("p"),Rd=n(`This is the simplest case, in which the processor (actually the feature extractor) will perform OCR on the image to get
the words and normalized bounding boxes.`),Sr=d(),v(eo.$$.fragment),Rr=d(),jn=s("p"),Ya=s("strong"),Ud=n("Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Ur=d(),_e=s("p"),Bd=n("In case one wants to do OCR themselves, one can initialize the feature extractor with "),Za=s("code"),Wd=n("apply_ocr"),Vd=n(` set to
`),Ja=s("code"),Qd=n("False"),Gd=n(`. In that case, one should provide the words and corresponding (normalized) bounding boxes themselves to
the processor.`),Br=d(),v(to.$$.fragment),Wr=d(),Fn=s("p"),es=s("strong"),Hd=n("Use case 3: token classification (training), apply_ocr=False"),Vr=d(),G=s("p"),Kd=n(`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
labels in order to train a model. The processor will then convert these into token-level `),ts=s("code"),Xd=n("labels"),Yd=n(`. By default, it
will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),os=s("code"),Zd=n("ignore_index"),Jd=n(` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
initialize the tokenizer with `),ns=s("code"),ep=n("only_label_first_subword"),tp=n(" set to "),as=s("code"),op=n("False"),np=n("."),Qr=d(),v(oo.$$.fragment),Gr=d(),Pn=s("p"),ss=s("strong"),ap=n("Use case 4: visual question answering (inference), apply_ocr=True"),Hr=d(),Cn=s("p"),sp=n(`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. By default, the
processor will apply OCR on the image, and create [CLS] question tokens [SEP] word tokens [SEP].`),Kr=d(),v(no.$$.fragment),Xr=d(),In=s("p"),rs=s("strong"),rp=n("Use case 5: visual question answering (inference), apply_ocr=False"),Yr=d(),An=s("p"),ip=n(`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. If you want to
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Zr=d(),v(ao.$$.fragment),Jr=d(),qe=s("h2"),Ke=s("a"),is=s("span"),v(so.$$.fragment),lp=d(),ls=s("span"),cp=n("LayoutLMv2Config"),ei=d(),Y=s("div"),v(ro.$$.fragment),dp=d(),ze=s("p"),pp=n("This is the configuration class to store the configuration of a "),Dn=s("a"),up=n("LayoutLMv2Model"),mp=n(`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
`),io=s("a"),hp=n("microsoft/layoutlmv2-base-uncased"),fp=n(" architecture."),gp=d(),je=s("p"),_p=n("Configuration objects inherit from "),On=s("a"),vp=n("PretrainedConfig"),yp=n(` and can be used to control the model outputs. Read the
documentation from `),Nn=s("a"),bp=n("PretrainedConfig"),Lp=n(" for more information."),wp=d(),v(Xe.$$.fragment),ti=d(),Fe=s("h2"),Ye=s("a"),cs=s("span"),v(lo.$$.fragment),kp=d(),ds=s("span"),xp=n("LayoutLMv2FeatureExtractor"),oi=d(),Z=s("div"),v(co.$$.fragment),Tp=d(),ps=s("p"),Mp=n(`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
to apply OCR on them in order to get a list of words and normalized bounding boxes.`),$p=d(),po=s("p"),Ep=n("This feature extractor inherits from "),us=s("code"),qp=n("PreTrainedFeatureExtractor()"),zp=n(` which contains most
of the main methods. Users should refer to this superclass for more information regarding those methods.`),jp=d(),ve=s("div"),v(uo.$$.fragment),Fp=d(),ms=s("p"),Pp=n("Main method to prepare for the model one or several image(s)."),Cp=d(),v(Ze.$$.fragment),ni=d(),Pe=s("h2"),Je=s("a"),hs=s("span"),v(mo.$$.fragment),Ip=d(),fs=s("span"),Ap=n("LayoutLMv2Tokenizer"),ai=d(),N=s("div"),v(ho.$$.fragment),Dp=d(),S=s("p"),Op=n("Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Sn=s("a"),Np=n("LayoutLMv2Tokenizer"),Sp=n(` can be used to turn words, word-level
...
optional `),bs=s("code"),Kp=n("labels"),Xp=n(" (for token classification)."),Yp=d(),fo=s("p"),Zp=n("This tokenizer inherits from "),Rn=s("a"),Jp=n("PreTrainedTokenizer"),eu=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),tu=d(),Un=s("p"),Bn=s("a"),ou=n("LayoutLMv2Tokenizer"),nu=n(` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),au=d(),et=s("div"),v(go.$$.fragment),su=d(),Ls=s("p"),ru=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),iu=d(),Wn=s("div"),v(_o.$$.fragment),si=d(),Ce=s("h2"),tt=s("a"),ws=s("span"),v(vo.$$.fragment),lu=d(),ks=s("span"),cu=n("LayoutLMv2TokenizerFast"),ri=d(),J=s("div"),v(yo.$$.fragment),du=d(),bo=s("p"),pu=n("Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),xs=s("em"),uu=n("tokenizers"),mu=n(" library). Based on WordPiece."),hu=d(),Lo=s("p"),fu=n("This tokenizer inherits from "),Vn=s("a"),gu=n("PreTrainedTokenizerFast"),_u=n(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),vu=d(),ot=s("div"),v(wo.$$.fragment),yu=d(),Ts=s("p"),bu=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),ii=d(),Ie=s("h2"),nt=s("a"),Ms=s("span"),v(ko.$$.fragment),Lu=d(),$s=s("span"),wu=n("LayoutLMv2Processor"),li=d(),W=s("div"),v(xo.$$.fragment),ku=d(),Es=s("p"),xu=n(`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),Tu=d(),Qn=s("p"),Gn=s("a"),Mu=n("LayoutLMv2Processor"),$u=n(" offers all the functionalities you need to prepare data for the model."),Eu=d(),F=s("p"),qu=n("It first uses "),Hn=s("a"),zu=n("LayoutLMv2FeatureExtractor"),ju=n(` to resize document images to a fixed size, and optionally applies OCR
...
into token-level `),Cs=s("code"),Qu=n("labels"),Gu=n(" for token classification tasks (such as FUNSD, CORD)."),Hu=d(),ye=s("div"),v(To.$$.fragment),Ku=d(),$=s("p"),Xu=n("This method first forwards the "),Is=s("code"),Yu=n("images"),Zu=n(" argument to "),Mo=s("a"),As=s("strong"),Ju=n("call"),em=n("()"),tm=n(`. In case
...
bounding boxes along with the additional arguments to `),$o=s("a"),Ns=s("strong"),lm=n("call"),cm=n("()"),dm=n(` and returns the output,
...
`),Us=s("code"),_m=n("False"),vm=n(", it passes the words ("),Bs=s("code"),ym=n("text"),bm=n("/"),Ws=s("code"),Lm=n("text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_17005/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),wm=n("."),km=d(),Vs=s("p"),xm=n("Please refer to the docstring of the above two methods for more information."),ci=d(),Ae=s("h2"),at=s("a"),Qs=s("span"),v(Eo.$$.fragment),Tm=d(),Gs=s("span"),Mm=n("LayoutLMv2Model"),di=d(),de=s("div"),v(qo.$$.fragment),$m=d(),zo=s("p"),Em=n(`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),jo=s("a"),qm=n("torch.nn.Module"),zm=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jm=d(),se=s("div"),v(Fo.$$.fragment),Fm=d(),De=s("p"),Pm=n("The "),Jn=s("a"),Cm=n("LayoutLMv2Model"),Im=n(" forward method, overrides the "),Hs=s("code"),Am=n("__call__"),Dm=n(" special method."),Om=d(),v(st.$$.fragment),Nm=d(),v(rt.$$.fragment),pi=d(),Oe=s("h2"),it=s("a"),Ks=s("span"),v(Po.$$.fragment),Sm=d(),Xs=s("span"),Rm=n("LayoutLMv2ForSequenceClassification"),ui=d(),ee=s("div"),v(Co.$$.fragment),Um=d(),Io=s("p"),Bm=n(`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
`),Ao=s("a"),Wm=n("RVL-CDIP"),Vm=n(" dataset."),Qm=d(),Do=s("p"),Gm=n("This model is a PyTorch "),Oo=s("a"),Hm=n("torch.nn.Module"),Km=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xm=d(),re=s("div"),v(No.$$.fragment),Ym=d(),Ne=s("p"),Zm=n("The "),ea=s("a"),Jm=n("LayoutLMv2ForSequenceClassification"),eh=n(" forward method, overrides the "),Ys=s("code"),th=n("__call__"),oh=n(" special method."),nh=d(),v(lt.$$.fragment),ah=d(),v(ct.$$.fragment),mi=d(),Se=s("h2"),dt=s("a"),Zs=s("span"),v(So.$$.fragment),sh=d(),Js=s("span"),rh=n("LayoutLMv2ForTokenClassification"),hi=d(),te=s("div"),v(Ro.$$.fragment),ih=d(),oe=s("p"),lh=n(`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
`),Uo=s("a"),ch=n("FUNSD"),dh=n(", "),Bo=s("a"),ph=n("SROIE"),uh=n(`,
`),Wo=s("a"),mh=n("CORD"),hh=n(" and "),Vo=s("a"),fh=n("Kleister-NDA"),gh=n("."),_h=d(),Qo=s("p"),vh=n("This model is a PyTorch "),Go=s("a"),yh=n("torch.nn.Module"),bh=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lh=d(),ie=s("div"),v(Ho.$$.fragment),wh=d(),Re=s("p"),kh=n("The "),ta=s("a"),xh=n("LayoutLMv2ForTokenClassification"),Th=n(" forward method, overrides the "),er=s("code"),Mh=n("__call__"),$h=n(" special method."),Eh=d(),v(pt.$$.fragment),qh=d(),v(ut.$$.fragment),fi=d(),Ue=s("h2"),mt=s("a"),tr=s("span"),v(Ko.$$.fragment),zh=d(),or=s("span"),jh=n("LayoutLMv2ForQuestionAnswering"),gi=d(),ne=s("div"),v(Xo.$$.fragment),Fh=d(),pe=s("p"),Ph=n(`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
`),Yo=s("a"),Ch=n("DocVQA"),Ih=n(` (a linear layer on top of the text part of the hidden-states output to
compute `),nr=s("code"),Ah=n("span start logits"),Dh=n(" and "),ar=s("code"),Oh=n("span end logits"),Nh=n(")."),Sh=d(),Zo=s("p"),Rh=n("This model is a PyTorch "),Jo=s("a"),Uh=n("torch.nn.Module"),Bh=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wh=d(),A=s("div"),v(en.$$.fragment),Vh=d(),Be=s("p"),Qh=n("The "),oa=s("a"),Gh=n("LayoutLMv2ForQuestionAnswering"),Hh=n(" forward method, overrides the "),sr=s("code"),Kh=n("__call__"),Xh=n(" special method."),Yh=d(),v(ht.$$.fragment),Zh=d(),rr=s("p"),Jh=n("Example:"),ef=d(),ir=s("p"),tf=n(`In this example below, we give the LayoutLMv2 model an image (of texts) and ask it a question. It will give us
a prediction of what it thinks the answer is (the span of the answer within the texts parsed from the image).`),of=d(),v(ft.$$.fragment),nf=d(),v(gt.$$.fragment),this.h()},l(t){const c=qv('[data-svelte="svelte-1phssyn"]',document.head);h=r(c,"META",{name:!0,content:!0}),c.forEach(o),x=p(t),f=r(t,"H1",{class:!0});var tn=i(f);g=r(tn,"A",{id:!0,class:!0,href:!0});var lr=i(g);T=r(lr,"SPAN",{});var cr=i(T);y(m.$$.fragment,cr),cr.forEach(o),lr.forEach(o),_=p(tn),O=r(tn,"SPAN",{});var dr=i(O);Hi=a(dr,"LayoutLMV2"),dr.forEach(o),tn.forEach(o),gr=p(t),Me=r(t,"H2",{class:!0});var on=i(Me);Ve=r(on,"A",{id:!0,class:!0,href:!0});var pr=i(Ve);_a=r(pr,"SPAN",{});var ur=i(_a);y(Et.$$.fragment,ur),ur.forEach(o),pr.forEach(o),Ki=p(on),va=r(on,"SPAN",{});var mr=i(va);Xi=a(mr,"Overview"),mr.forEach(o),on.forEach(o),_r=p(t),me=r(t,"P",{});var We=i(me);Yi=a(We,"The LayoutLMV2 model was proposed in "),qt=r(We,"A",{href:!0,rel:!0});var hr=i(qt);Zi=a(hr,"LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),hr.forEach(o),Ji=a(We,` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
...
state-of-the-art results across several document image understanding benchmarks:`),We.forEach(o),vr=p(t),he=r(t,"UL",{});var na=i(he);X=r(na,"LI",{});var be=i(X);ol=a(be,"information extraction from scanned documents: the "),zt=r(be,"A",{href:!0,rel:!0});var cf=i(zt);nl=a(cf,"FUNSD"),cf.forEach(o),al=a(be,` dataset (a
collection of 199 annotated forms comprising more than 30,000 words), the `),jt=r(be,"A",{href:!0,rel:!0});var df=i(jt);sl=a(df,"CORD"),df.forEach(o),rl=a(be,`
...
and the `),Pt=r(be,"A",{href:!0,rel:!0});var uf=i(Pt);cl=a(uf,"Kleister-NDA"),uf.forEach(o),dl=a(be,` dataset (a collection of non-disclosure
agreements from the EDGAR database, including 254 documents for training, 83 documents for validation, and 203
...
following to install them:`),_t.forEach(o),wr=p(t),y(Ot.$$.fragment,t),kr=p(t),cn=r(t,"P",{});var Lf=i(cn);El=a(Lf,"(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),Lf.forEach(o),xr=p(t),dn=r(t,"P",{});var wf=i(dn);ql=a(wf,"Tips:"),wf.forEach(o),Tr=p(t),V=r(t,"UL",{});var Le=i(V);ka=r(Le,"LI",{});var kf=i(ka);zl=a(kf,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
`),Ta=r(q,"CODE",{});var zf=i(Ta);Yl=a(zf,"image"),zf.forEach(o),Zl=a(q," and "),Ma=r(q,"CODE",{});var jf=i(Ma);Jl=a(jf,"bbox"),jf.forEach(o),ec=a(q,". The "),$a=r(q,"CODE",{});var Ff=i($a);tc=a(Ff,"image"),Ff.forEach(o),oc=a(q,` input corresponds to the original document image in which the text
tokens occur. The model expects each document image to be of size 224x224. This means that if you have a batch of
document images, `),Ea=r(q,"CODE",{});var Pf=i(Ea);nc=a(Pf,"image"),Pf.forEach(o),ac=a(q,` should be a tensor of shape (batch_size, 3, 224, 224). This can be either a
`),qa=r(q,"CODE",{});var Cf=i(qa);sc=a(Cf,"torch.Tensor"),Cf.forEach(o),rc=a(q," or a "),za=r(q,"CODE",{});var If=i(za);ic=a(If,"Detectron2.structures.ImageList"),If.forEach(o),lc=a(q,`. You don\u2019t need to normalize the channels, as this is
done by the model. Important to note is that the visual backbone expects BGR channels instead of RGB, as all models
in Detectron2 are pre-trained using the BGR format. The `),ja=r(q,"CODE",{});var Af=i(ja);cc=a(Af,"bbox"),Af.forEach(o),dc=a(q,` input are the bounding boxes (i.e. 2D-positions)
of the input text tokens. This is identical to `),un=r(q,"A",{href:!0});var Df=i(un);pc=a(Df,"LayoutLMModel"),Df.forEach(o),uc=a(q,`. These can be obtained using an
external OCR engine such as Google\u2019s `),Vt=r(q,"A",{href:!0,rel:!0});var Of=i(Vt);mc=a(Of,"Tesseract"),Of.forEach(o),hc=a(q," (there\u2019s a "),Qt=r(q,"A",{href:!0,rel:!0});var Nf=i(Qt);fc=a(Nf,`Python
wrapper`),Nf.forEach(o),gc=a(q,` available). Each bounding box should be in (x0, y0, x1, y1)
format, where (x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1)
represents the position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on
a 0-1000 scale. To normalize, you can use the following function:`),q.forEach(o),Le.forEach(o),Mr=p(t),y(Gt.$$.fragment,t),$r=p(t),fe=r(t,"P",{});var sa=i(fe);_c=a(sa,"Here, "),Fa=r(sa,"CODE",{});var Sf=i(Fa);vc=a(Sf,"width"),Sf.forEach(o),yc=a(sa," and "),Pa=r(sa,"CODE",{});var Rf=i(Pa);bc=a(Rf,"height"),Rf.forEach(o),Lc=a(sa,` correspond to the width and height of the original document in which the token
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),sa.forEach(o),Er=p(t),y(Ht.$$.fragment,t),qr=p(t),Qe=r(t,"P",{});var wi=i(Qe);wc=a(wi,"However, this model includes a brand new "),mn=r(wi,"A",{href:!0});var Uf=i(mn);kc=a(Uf,"LayoutLMv2Processor"),Uf.forEach(o),xc=a(wi,` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
section below.`),wi.forEach(o),zr=p(t),ge=r(t,"UL",{});var ra=i(ge);I=r(ra,"LI",{});var R=i(I);Tc=a(R,"Internally, "),hn=r(R,"A",{href:!0});var Bf=i(hn);Mc=a(Bf,"LayoutLMv2Model"),Bf.forEach(o),$c=a(R," will send the "),Ca=r(R,"CODE",{});var Wf=i(Ca);Ec=a(Wf,"image"),Wf.forEach(o),qc=a(R,` input through its visual backbone to
obtain a lower-resolution feature map, whose shape is equal to the `),Ia=r(R,"CODE",{});var Vf=i(Ia);zc=a(Vf,"image_feature_pool_shape"),Vf.forEach(o),jc=a(R,` attribute of
`),fn=r(R,"A",{href:!0});var Qf=i(fn);Fc=a(Qf,"LayoutLMv2Config"),Qf.forEach(o),Pc=a(R,`. This feature map is then flattened to obtain a sequence of image tokens. As
the size of the feature map is 7x7 by default, one obtains 49 image tokens. These are then concatenated with the text
tokens, and send through the Transformer encoder. This means that the last hidden states of the model will have a
length of 512 + 49 = 561, if you pad the text tokens up to the max length. More generally, the last hidden states
will have a shape of `),Aa=r(R,"CODE",{});var Gf=i(Aa);Cc=a(Gf,"seq_length"),Gf.forEach(o),Ic=a(R," + "),Da=r(R,"CODE",{});var Hf=i(Da);Ac=a(Hf,"image_feature_pool_shape[0]"),Hf.forEach(o),Dc=a(R,` *
`),Oa=r(R,"CODE",{});var Kf=i(Oa);Oc=a(Kf,"config.image_feature_pool_shape[1]"),Kf.forEach(o),Nc=a(R,"."),R.forEach(o),Sc=p(ra),Kt=r(ra,"LI",{});var ki=i(Kt);Rc=a(ki,"When calling "),gn=r(ki,"A",{href:!0});var Xf=i(gn);Uc=a(Xf,"from_pretrained()"),Xf.forEach(o),Bc=a(ki,`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),ki.forEach(o),Wc=p(ra),Xt=r(ra,"LI",{});var xi=i(Xt);Vc=a(xi,"If you want to train the model in a distributed environment, make sure to call "),Na=r(xi,"CODE",{});var Yf=i(Na);Qc=a(Yf,"synchronize_batch_norm"),Yf.forEach(o),Gc=a(xi,` on the
model in order to properly synchronize the batch normalization layers of the visual backbone.`),xi.forEach(o),ra.forEach(o),jr=p(t),Ge=r(t,"P",{});var Ti=i(Ge);Hc=a(Ti,`In addition, there\u2019s LayoutXLM, which is a multilingual version of LayoutLMv2. More information can be found on
`),_n=r(Ti,"A",{href:!0});var Zf=i(_n);Kc=a(Zf,"LayoutXLM\u2019s documentation page"),Zf.forEach(o),Xc=a(Ti,"."),Ti.forEach(o),Fr=p(t),Ee=r(t,"H2",{class:!0});var Mi=i(Ee);He=r(Mi,"A",{id:!0,class:!0,href:!0});var Jf=i(He);Sa=r(Jf,"SPAN",{});var eg=i(Sa);y(Yt.$$.fragment,eg),eg.forEach(o),Jf.forEach(o),Yc=p(Mi),Ra=r(Mi,"SPAN",{});var tg=i(Ra);Zc=a(tg,"Usage: LayoutLMv2Processor"),tg.forEach(o),Mi.forEach(o),Pr=p(t),Q=r(t,"P",{});var we=i(Q);Jc=a(we,"The easiest way to prepare data for the model is to use "),vn=r(we,"A",{href:!0});var og=i(vn);ed=a(og,"LayoutLMv2Processor"),og.forEach(o),td=a(we,`, which internally
combines a feature extractor (`),yn=r(we,"A",{href:!0});var ng=i(yn);od=a(ng,"LayoutLMv2FeatureExtractor"),ng.forEach(o),nd=a(we,`) and a tokenizer
(`),bn=r(we,"A",{href:!0});var ag=i(bn);ad=a(ag,"LayoutLMv2Tokenizer"),ag.forEach(o),sd=a(we," or "),Ln=r(we,"A",{href:!0});var sg=i(Ln);rd=a(sg,"LayoutLMv2TokenizerFast"),sg.forEach(o),id=a(we,`). The feature extractor
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),we.forEach(o),Cr=p(t),y(Zt.$$.fragment,t),Ir=p(t),E=r(t,"P",{});var P=i(E);ld=a(P,"In short, one can provide a document image (and possibly additional data) to "),wn=r(P,"A",{href:!0});var rg=i(wn);cd=a(rg,"LayoutLMv2Processor"),rg.forEach(o),dd=a(P,`,
and it will create the inputs expected by the model. Internally, the processor first uses
`),kn=r(P,"A",{href:!0});var ig=i(kn);pd=a(ig,"LayoutLMv2FeatureExtractor"),ig.forEach(o),ud=a(P,` to apply OCR on the image to get a list of words and normalized
bounding boxes, as well to resize the image to a given size in order to get the `),Ua=r(P,"CODE",{});var lg=i(Ua);md=a(lg,"image"),lg.forEach(o),hd=a(P,` input. The words and
normalized bounding boxes are then provided to `),xn=r(P,"A",{href:!0});var cg=i(xn);fd=a(cg,"LayoutLMv2Tokenizer"),cg.forEach(o),gd=a(P,` or
`),Tn=r(P,"A",{href:!0});var dg=i(Tn);_d=a(dg,"LayoutLMv2TokenizerFast"),dg.forEach(o),vd=a(P,", which converts them to token-level "),Ba=r(P,"CODE",{});var pg=i(Ba);yd=a(pg,"input_ids"),pg.forEach(o),bd=a(P,`,
`),Wa=r(P,"CODE",{});var ug=i(Wa);Ld=a(ug,"attention_mask"),ug.forEach(o),wd=a(P,", "),Va=r(P,"CODE",{});var mg=i(Va);kd=a(mg,"token_type_ids"),mg.forEach(o),xd=a(P,", "),Qa=r(P,"CODE",{});var hg=i(Qa);Td=a(hg,"bbox"),hg.forEach(o),Md=a(P,`. Optionally, one can provide word labels to the processor,
which are turned into token-level `),Ga=r(P,"CODE",{});var fg=i(Ga);$d=a(fg,"labels"),fg.forEach(o),Ed=a(P,"."),P.forEach(o),Ar=p(t),B=r(t,"P",{});var ue=i(B);Mn=r(ue,"A",{href:!0});var gg=i(Mn);qd=a(gg,"LayoutLMv2Processor"),gg.forEach(o),zd=a(ue," uses "),Jt=r(ue,"A",{href:!0,rel:!0});var _g=i(Jt);jd=a(_g,"PyTesseract"),_g.forEach(o),Fd=a(ue,`, a Python
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),$n=r(ue,"A",{href:!0});var vg=i($n);Pd=a(vg,"LayoutLMv2FeatureExtractor"),vg.forEach(o),Cd=a(ue," with "),Ha=r(ue,"CODE",{});var yg=i(Ha);Id=a(yg,"apply_ocr"),yg.forEach(o),Ad=a(ue," set to "),Ka=r(ue,"CODE",{});var bg=i(Ka);Dd=a(bg,"False"),bg.forEach(o),Od=a(ue,"."),ue.forEach(o),Dr=p(t),En=r(t,"P",{});var Lg=i(En);Nd=a(Lg,`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Lg.forEach(o),Or=p(t),qn=r(t,"P",{});var wg=i(qn);Xa=r(wg,"STRONG",{});var kg=i(Xa);Sd=a(kg,`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
True`),kg.forEach(o),wg.forEach(o),Nr=p(t),zn=r(t,"P",{});var xg=i(zn);Rd=a(xg,`This is the simplest case, in which the processor (actually the feature extractor) will perform OCR on the image to get
the words and normalized bounding boxes.`),xg.forEach(o),Sr=p(t),y(eo.$$.fragment,t),Rr=p(t),jn=r(t,"P",{});var Tg=i(jn);Ya=r(Tg,"STRONG",{});var Mg=i(Ya);Ud=a(Mg,"Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Mg.forEach(o),Tg.forEach(o),Ur=p(t),_e=r(t,"P",{});var ia=i(_e);Bd=a(ia,"In case one wants to do OCR themselves, one can initialize the feature extractor with "),Za=r(ia,"CODE",{});var $g=i(Za);Wd=a($g,"apply_ocr"),$g.forEach(o),Vd=a(ia,` set to
`),Ja=r(ia,"CODE",{});var Eg=i(Ja);Qd=a(Eg,"False"),Eg.forEach(o),Gd=a(ia,`. In that case, one should provide the words and corresponding (normalized) bounding boxes themselves to
the processor.`),ia.forEach(o),Br=p(t),y(to.$$.fragment,t),Wr=p(t),Fn=r(t,"P",{});var qg=i(Fn);es=r(qg,"STRONG",{});var zg=i(es);Hd=a(zg,"Use case 3: token classification (training), apply_ocr=False"),zg.forEach(o),qg.forEach(o),Vr=p(t),G=r(t,"P",{});var ke=i(G);Kd=a(ke,`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
labels in order to train a model. The processor will then convert these into token-level `),ts=r(ke,"CODE",{});var jg=i(ts);Xd=a(jg,"labels"),jg.forEach(o),Yd=a(ke,`. By default, it
will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),os=r(ke,"CODE",{});var Fg=i(os);Zd=a(Fg,"ignore_index"),Fg.forEach(o),Jd=a(ke,` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
...
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Sg.forEach(o),Zr=p(t),y(ao.$$.fragment,t),Jr=p(t),qe=r(t,"H2",{class:!0});var $i=i(qe);Ke=r($i,"A",{id:!0,class:!0,href:!0});var Rg=i(Ke);is=r(Rg,"SPAN",{});var Ug=i(is);y(so.$$.fragment,Ug),Ug.forEach(o),Rg.forEach(o),lp=p($i),ls=r($i,"SPAN",{});var Bg=i(ls);cp=a(Bg,"LayoutLMv2Config"),Bg.forEach(o),$i.forEach(o),ei=p(t),Y=r(t,"DIV",{class:!0});var vt=i(Y);y(ro.$$.fragment,vt),dp=p(vt),ze=r(vt,"P",{});var la=i(ze);pp=a(la,"This is the configuration class to store the configuration of a "),Dn=r(la,"A",{href:!0});var Wg=i(Dn);up=a(Wg,"LayoutLMv2Model"),Wg.forEach(o),mp=a(la,`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
`),io=r(la,"A",{href:!0,rel:!0});var Vg=i(io);hp=a(Vg,"microsoft/layoutlmv2-base-uncased"),Vg.forEach(o),fp=a(la," architecture."),la.forEach(o),gp=p(vt),je=r(vt,"P",{});var ca=i(je);_p=a(ca,"Configuration objects inherit from "),On=r(ca,"A",{href:!0});var Qg=i(On);vp=a(Qg,"PretrainedConfig"),Qg.forEach(o),yp=a(ca,` and can be used to control the model outputs. Read the
documentation from `),Nn=r(ca,"A",{href:!0});var Gg=i(Nn);bp=a(Gg,"PretrainedConfig"),Gg.forEach(o),Lp=a(ca," for more information."),ca.forEach(o),wp=p(vt),y(Xe.$$.fragment,vt),vt.forEach(o),ti=p(t),Fe=r(t,"H2",{class:!0});var Ei=i(Fe);Ye=r(Ei,"A",{id:!0,class:!0,href:!0});var Hg=i(Ye);cs=r(Hg,"SPAN",{});var Kg=i(cs);y(lo.$$.fragment,Kg),Kg.forEach(o),Hg.forEach(o),kp=p(Ei),ds=r(Ei,"SPAN",{});var Xg=i(ds);xp=a(Xg,"LayoutLMv2FeatureExtractor"),Xg.forEach(o),Ei.forEach(o),oi=p(t),Z=r(t,"DIV",{class:!0});var yt=i(Z);y(co.$$.fragment,yt),Tp=p(yt),ps=r(yt,"P",{});var Yg=i(ps);Mp=a(Yg,`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),qi.forEach(o),jp=p(yt),ve=r(yt,"DIV",{class:!0});var da=i(ve);y(uo.$$.fragment,da),Fp=p(da),ms=r(da,"P",{});var Jg=i(ms);Pp=a(Jg,"Main method to prepare for the model one or several image(s)."),Jg.forEach(o),Cp=p(da),y(Ze.$$.fragment,da),da.forEach(o),yt.forEach(o),ni=p(t),Pe=r(t,"H2",{class:!0});var zi=i(Pe);Je=r(zi,"A",{id:!0,class:!0,href:!0});var e_=i(Je);hs=r(e_,"SPAN",{});var t_=i(hs);y(mo.$$.fragment,t_),t_.forEach(o),e_.forEach(o),Ip=p(zi),fs=r(zi,"SPAN",{});var o_=i(fs);Ap=a(o_,"LayoutLMv2Tokenizer"),o_.forEach(o),zi.forEach(o),ai=p(t),N=r(t,"DIV",{class:!0});var le=i(N);y(ho.$$.fragment,le),Dp=p(le),S=r(le,"P",{});var H=i(S);Op=a(H,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Sn=r(H,"A",{href:!0});var n_=i(Sn);Np=a(n_,"LayoutLMv2Tokenizer"),n_.forEach(o),Sp=a(H,` can be used to turn words, word-level
...
optional `),bs=r(H,"CODE",{});var l_=i(bs);Kp=a(l_,"labels"),l_.forEach(o),Xp=a(H," (for token classification)."),H.forEach(o),Yp=p(le),fo=r(le,"P",{});var ji=i(fo);Zp=a(ji,"This tokenizer inherits from "),Rn=r(ji,"A",{href:!0});var c_=i(Rn);Jp=a(c_,"PreTrainedTokenizer"),c_.forEach(o),eu=a(ji,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ji.forEach(o),tu=p(le),Un=r(le,"P",{});var af=i(Un);Bn=r(af,"A",{href:!0});var d_=i(Bn);ou=a(d_,"LayoutLMv2Tokenizer"),d_.forEach(o),nu=a(af,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
...
sequences with word-level normalized bounding boxes and optional labels.`),p_.forEach(o),Fi.forEach(o),iu=p(le),Wn=r(le,"DIV",{class:!0});var u_=i(Wn);y(_o.$$.fragment,u_),u_.forEach(o),le.forEach(o),si=p(t),Ce=r(t,"H2",{class:!0});var Pi=i(Ce);tt=r(Pi,"A",{id:!0,class:!0,href:!0});var m_=i(tt);ws=r(m_,"SPAN",{});var h_=i(ws);y(vo.$$.fragment,h_),h_.forEach(o),m_.forEach(o),lu=p(Pi),ks=r(Pi,"SPAN",{});var f_=i(ks);cu=a(f_,"LayoutLMv2TokenizerFast"),f_.forEach(o),Pi.forEach(o),ri=p(t),J=r(t,"DIV",{class:!0});var bt=i(J);y(yo.$$.fragment,bt),du=p(bt),bo=r(bt,"P",{});var Ci=i(bo);pu=a(Ci,"Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),xs=r(Ci,"EM",{});var g_=i(xs);uu=a(g_,"tokenizers"),g_.forEach(o),mu=a(Ci," library). Based on WordPiece."),Ci.forEach(o),hu=p(bt),Lo=r(bt,"P",{});var Ii=i(Lo);fu=a(Ii,"This tokenizer inherits from "),Vn=r(Ii,"A",{href:!0});var __=i(Vn);gu=a(__,"PreTrainedTokenizerFast"),__.forEach(o),_u=a(Ii,` which contains most of the main methods. Users should
...
bounding boxes along with the additional arguments to `),$o=r(z,"A",{href:!0});var lf=i($o);Ns=r(lf,"STRONG",{});var O_=i(Ns);lm=a(O_,"call"),O_.forEach(o),cm=a(lf,"()"),lf.forEach(o),dm=a(z,` and returns the output,
