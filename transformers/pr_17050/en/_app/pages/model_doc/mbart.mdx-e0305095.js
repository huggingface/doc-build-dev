...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart50/tokenization_mbart50.py#L48"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[IM]},$$scope:{ctx:x}}}),ns=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart50/tokenization_mbart50.py#L257",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ps=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),us=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),hs=new R({}),ms=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_mbart.py#L1167",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17050/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_mbart.py#L1301",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_mbart.py#L1570",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_mbart.py#L1443",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_mbart.py#L1722",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_tf_mbart.py#L1158",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_tf_mbart.py#L1266",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17050/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17050/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17050/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
documentation from `),ki=s(Wi,"A",{href:!0});var m0=r(ki);Dm=d(m0,"PretrainedConfig"),m0.forEach(t),Lm=d(Wi," for more information."),Wi.forEach(t),Gm=u(ta),v(Fo.$$.fragment,ta),ta.forEach(t),$p=u(o),Ut=s(o,"H2",{class:!0});var ru=r(Ut);qo=s(ru,"A",{id:!0,class:!0,href:!0});var f0=r(qo);Fd=s(f0,"SPAN",{});var _0=r(Fd);v(qa.$$.fragment,_0),_0.forEach(t),f0.forEach(t),Wm=u(ru),qd=s(ru,"SPAN",{});var g0=r(qd);Um=d(g0,"MBartTokenizer"),g0.forEach(t),ru.forEach(t),xp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(Ba.$$.fragment,Se),Rm=u(Se),Bd=s(Se,"P",{});var b0=r(Bd);Xm=d(b0,"Construct an MBART tokenizer."),b0.forEach(t),Qm=u(Se),ht=s(Se,"P",{});var oa=r(ht);Vm=d(oa,"Adapted from "),yi=s(oa,"A",{href:!0});var k0=r(yi);Hm=d(k0,"RobertaTokenizer"),k0.forEach(t),Jm=d(oa," and "),vi=s(oa,"A",{href:!0});var y0=r(vi);Km=d(y0,"XLNetTokenizer"),y0.forEach(t),Zm=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var v0=r(ja);Ym=d(v0,"SentencePiece"),v0.forEach(t),ef=d(oa,"."),oa.forEach(t),tf=u(Se),Ca=s(Se,"P",{});var iu=r(Ca);of=d(iu,"The tokenization method is "),jd=s(iu,"CODE",{});var T0=r(jd);nf=d(T0,"<tokens> <eos> <language code>"),T0.forEach(t),af=d(iu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),iu.forEach(t),sf=u(Se),v(Bo.$$.fragment,Se),rf=u(Se),jo=s(Se,"DIV",{class:!0});var du=r(jo);v(Ea.$$.fragment,du),df=u(du),Cd=s(du,"P",{});var w0=r(Cd);lf=d(w0,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An MBART sequence has the following format, where `),Ed=s(lu,"CODE",{});var M0=r(Ed);hf=d(M0,"X"),M0.forEach(t),mf=d(lu," represents the sequence:"),lu.forEach(t),ff=u(na),Aa=s(na,"UL",{});var cu=r(Aa);Oa=s(cu,"LI",{});var pu=r(Oa);Pd=s(pu,"CODE",{});var $0=r(Pd);_f=d($0,"input_ids"),$0.forEach(t),gf=d(pu," (for encoder) "),Sd=s(pu,"CODE",{});var x0=r(Sd);bf=d(x0,"X [eos, src_lang_code]"),x0.forEach(t),pu.forEach(t),kf=u(cu),Ia=s(cu,"LI",{});var uu=r(Ia);Ad=s(uu,"CODE",{});var z0=r(Ad);yf=d(z0,"decoder_input_ids"),z0.forEach(t),vf=d(uu,": (for decoder) "),Od=s(uu,"CODE",{});var F0=r(Od);Tf=d(F0,"X [eos, tgt_lang_code]"),F0.forEach(t),uu.forEach(t),cu.forEach(t),wf=u(na),Id=s(na,"P",{});var q0=r(Id);Mf=d(q0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),q0.forEach(t),na.forEach(t),Se.forEach(t),zp=u(o),Rt=s(o,"H2",{class:!0});var hu=r(Rt);Co=s(hu,"A",{id:!0,class:!0,href:!0});var B0=r(Co);Nd=s(B0,"SPAN",{});var j0=r(Nd);v(Na.$$.fragment,j0),j0.forEach(t),B0.forEach(t),$f=u(hu),Dd=s(hu,"SPAN",{});var C0=r(Dd);xf=d(C0,"MBartTokenizerFast"),C0.forEach(t),hu.forEach(t),Fp=u(o),O=s(o,"DIV",{class:!0});var Y=r(O);v(Da.$$.fragment,Y),zf=u(Y),Xt=s(Y,"P",{});var Ui=r(Xt);Ff=d(Ui,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ld=s(Ui,"EM",{});var E0=r(Ld);qf=d(E0,"tokenizers"),E0.forEach(t),Bf=d(Ui,` library). Based on
`),La=s(Ui,"A",{href:!0,rel:!0});var P0=r(La);jf=d(P0,"BPE"),P0.forEach(t),Cf=d(Ui,"."),Ui.forEach(t),Ef=u(Y),Ga=s(Y,"P",{});var mu=r(Ga);Pf=d(mu,"This tokenizer inherits from "),Ti=s(mu,"A",{href:!0});var S0=r(Ti);Sf=d(S0,"PreTrainedTokenizerFast"),S0.forEach(t),Af=d(mu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),mu.forEach(t),Of=u(Y),Wa=s(Y,"P",{});var fu=r(Wa);If=d(fu,"The tokenization method is "),Gd=s(fu,"CODE",{});var A0=r(Gd);Nf=d(A0,"<tokens> <eos> <language code>"),A0.forEach(t),Df=d(fu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),fu.forEach(t),Lf=u(Y),v(Eo.$$.fragment,Y),Gf=u(Y),qe=s(Y,"DIV",{class:!0});var vt=r(qe);v(Ua.$$.fragment,vt),Wf=u(vt),Wd=s(vt,"P",{});var O0=r(Wd);Uf=d(O0,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),O0.forEach(t),Rf=u(vt),Ra=s(vt,"P",{});var _u=r(Ra);Xf=d(_u,"An MBART sequence has the following format, where "),Ud=s(_u,"CODE",{});var I0=r(Ud);Qf=d(I0,"X"),I0.forEach(t),Vf=d(_u," represents the sequence:"),_u.forEach(t),Hf=u(vt),Xa=s(vt,"UL",{});var gu=r(Xa);Qa=s(gu,"LI",{});var bu=r(Qa);Rd=s(bu,"CODE",{});var N0=r(Rd);Jf=d(N0,"input_ids"),N0.forEach(t),Kf=d(bu," (for encoder) "),Xd=s(bu,"CODE",{});var D0=r(Xd);Zf=d(D0,"X [eos, src_lang_code]"),D0.forEach(t),bu.forEach(t),Yf=u(gu),Va=s(gu,"LI",{});var ku=r(Va);Qd=s(ku,"CODE",{});var L0=r(Qd);e_=d(L0,"decoder_input_ids"),L0.forEach(t),t_=d(ku,": (for decoder) "),Vd=s(ku,"CODE",{});var G0=r(Vd);o_=d(G0,"X [eos, tgt_lang_code]"),G0.forEach(t),ku.forEach(t),gu.forEach(t),n_=u(vt),Hd=s(vt,"P",{});var W0=r(Hd);a_=d(W0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),W0.forEach(t),vt.forEach(t),s_=u(Y),Po=s(Y,"DIV",{class:!0});var yu=r(Po);v(Ha.$$.fragment,yu),r_=u(yu),Jd=s(yu,"P",{});var U0=r(Jd);i_=d(U0,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),U0.forEach(t),yu.forEach(t),d_=u(Y),So=s(Y,"DIV",{class:!0});var vu=r(So);v(Ja.$$.fragment,vu),l_=u(vu),Kd=s(vu,"P",{});var R0=r(Kd);c_=d(R0,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),R0.forEach(t),vu.forEach(t),p_=u(Y),Ao=s(Y,"DIV",{class:!0});var Tu=r(Ao);v(Ka.$$.fragment,Tu),u_=u(Tu),Zd=s(Tu,"P",{});var X0=r(Zd);h_=d(X0,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),X0.forEach(t),Tu.forEach(t),Y.forEach(t),qp=u(o),Qt=s(o,"H2",{class:!0});var wu=r(Qt);Oo=s(wu,"A",{id:!0,class:!0,href:!0});var Q0=r(Oo);Yd=s(Q0,"SPAN",{});var V0=r(Yd);v(Za.$$.fragment,V0),V0.forEach(t),Q0.forEach(t),m_=u(wu),el=s(wu,"SPAN",{});var H0=r(el);f_=d(H0,"MBart50Tokenizer"),H0.forEach(t),wu.forEach(t),Bp=u(o),I=s(o,"DIV",{class:!0});var ee=r(I);v(Ya.$$.fragment,ee),__=u(ee),es=s(ee,"P",{});var Mu=r(es);g_=d(Mu,"Construct a MBart50 tokenizer. Based on "),ts=s(Mu,"A",{href:!0,rel:!0});var J0=r(ts);b_=d(J0,"SentencePiece"),J0.forEach(t),k_=d(Mu,"."),Mu.forEach(t),y_=u(ee),os=s(ee,"P",{});var $u=r(os);v_=d($u,"This tokenizer inherits from "),wi=s($u,"A",{href:!0});var K0=r(wi);T_=d(K0,"PreTrainedTokenizer"),K0.forEach(t),w_=d($u,` which contains most of the main methods. Users should refer to
