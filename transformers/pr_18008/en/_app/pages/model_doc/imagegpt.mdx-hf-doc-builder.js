import{S as ic,i as lc,s as dc,e as a,k as l,w as b,t as r,M as cc,c as n,d as t,m as d,a as s,x as y,h as i,b as p,N as pc,G as e,g as u,y as I,q as w,o as P,B as k,v as mc,L as pn}from"../../chunks/vendor-hf-doc-builder.js";import{T as dn}from"../../chunks/Tip-hf-doc-builder.js";import{D as fe}from"../../chunks/Docstring-hf-doc-builder.js";import{C as mn}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as $t}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as cn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function hc($){let m,v,f,g,T;return g=new mn({props:{code:`from transformers import ImageGPTModel, ImageGPTConfig
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18008/src/transformers/models/imagegpt/feature_extraction_imagegpt.py#L96",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18008/en/main_classes/feature_extractor#transformers.BatchFeature"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18008/src/transformers/models/imagegpt/modeling_imagegpt.py#L664",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18008/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18008/en/model_doc/imagegpt#transformers.ImageGPTConfig"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18008/src/transformers/models/imagegpt/modeling_imagegpt.py#L957",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18008/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18008/src/transformers/models/imagegpt/modeling_imagegpt.py#L1109",returnDescription:`
...
train an XL variant, which they didn\u2019t release. The differences in size are summarized in the following table:`),Ca=l(),be=a("table"),to=a("thead"),G=a("tr"),oo=a("th"),ao=a("strong"),Kn=r("Model variant"),Yn=l(),no=a("th"),so=a("strong"),Zn=r("Depths"),es=l(),ro=a("th"),io=a("strong"),ts=r("Hidden sizes"),os=l(),lo=a("th"),co=a("strong"),as=r("Decoder hidden size"),ns=l(),po=a("th"),mo=a("strong"),ss=r("Params (M)"),rs=l(),ho=a("th"),go=a("strong"),is=r("ImageNet-1k Top 1"),ls=l(),E=a("tbody"),C=a("tr"),uo=a("td"),ds=r("MiT-b0"),cs=l(),fo=a("td"),ps=r("[2, 2, 2, 2]"),ms=l(),_o=a("td"),hs=r("[32, 64, 160, 256]"),gs=l(),To=a("td"),us=r("256"),fs=l(),vo=a("td"),_s=r("3.7"),Ts=l(),bo=a("td"),vs=r("70.5"),bs=l(),F=a("tr"),yo=a("td"),ys=r("MiT-b1"),Is=l(),Io=a("td"),ws=r("[2, 2, 2, 2]"),Ps=l(),wo=a("td"),ks=r("[64, 128, 320, 512]"),$s=l(),Po=a("td"),xs=r("256"),Gs=l(),ko=a("td"),Es=r("14.0"),Cs=l(),$o=a("td"),Fs=r("78.7"),Ms=l(),M=a("tr"),xo=a("td"),zs=r("MiT-b2"),js=l(),Go=a("td"),qs=r("[3, 4, 6, 3]"),As=l(),Eo=a("td"),Ds=r("[64, 128, 320, 512]"),Ns=l(),Co=a("td"),Os=r("768"),Ls=l(),Fo=a("td"),Ss=r("25.4"),Ws=l(),Mo=a("td"),Rs=r("81.6"),Bs=l(),z=a("tr"),zo=a("td"),Hs=r("MiT-b3"),Vs=l(),jo=a("td"),Us=r("[3, 4, 18, 3]"),Js=l(),qo=a("td"),Xs=r("[64, 128, 320, 512]"),Qs=l(),Ao=a("td"),Ks=r("768"),Ys=l(),Do=a("td"),Zs=r("45.2"),er=l(),No=a("td"),tr=r("83.1"),or=l(),j=a("tr"),Oo=a("td"),ar=r("MiT-b4"),nr=l(),Lo=a("td"),sr=r("[3, 8, 27, 3]"),rr=l(),So=a("td"),ir=r("[64, 128, 320, 512]"),lr=l(),Wo=a("td"),dr=r("768"),cr=l(),Ro=a("td"),pr=r("62.6"),mr=l(),Bo=a("td"),hr=r("83.6"),gr=l(),q=a("tr"),Ho=a("td"),ur=r("MiT-b5"),fr=l(),Vo=a("td"),_r=r("[3, 6, 40, 3]"),Tr=l(),Uo=a("td"),vr=r("[64, 128, 320, 512]"),br=l(),Jo=a("td"),yr=r("768"),Ir=l(),Xo=a("td"),wr=r("82.0"),Pr=l(),Qo=a("td"),kr=r("83.8"),Fa=l(),ie=a("h2"),ye=a("a"),Ko=a("span"),b(Ye.$$.fragment),$r=l(),Yo=a("span"),xr=r("ImageGPTConfig"),Ma=l(),L=a("div"),b(Ze.$$.fragment),Gr=l(),te=a("p"),Er=r("This is the configuration class to store the configuration of a "),jt=a("a"),Cr=r("ImageGPTModel"),Fr=r(" or a "),Zo=a("code"),Mr=r("TFImageGPTModel"),zr=r(`. It is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ji=l(),B=a("div"),b(ft.$$.fragment),qi=l(),he=a("p"),Ai=r("The "),St=a("a"),Di=r("ImageGPTForCausalImageModeling"),Ni=r(" forward method, overrides the "),pa=a("code"),Oi=r("__call__"),Li=r(" special method."),Si=l(),b(Ee.$$.fragment),Wi=l(),b(Ce.$$.fragment),Oa=l(),ge=a("h2"),Fe=a("a"),ma=a("span"),b(_t.$$.fragment),Ri=l(),ha=a("span"),Bi=r("ImageGPTForImageClassification"),La=l(),N=a("div"),b(Tt.$$.fragment),Hi=l(),vt=a("p"),Vi=r(`The ImageGPT Model transformer with an image classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),an.forEach(t),ji=d(ne),B=n(ne,"DIV",{class:!0});var Oe=s(B);y(ft.$$.fragment,Oe),qi=d(Oe),he=n(Oe,"P",{});var Jt=s(he);Ai=i(Jt,"The "),St=n(Jt,"A",{href:!0});var Kd=s(St);Di=i(Kd,"ImageGPTForCausalImageModeling"),Kd.forEach(t),Ni=i(Jt," forward method, overrides the "),pa=n(Jt,"CODE",{});var Yd=s(pa);Oi=i(Yd,"__call__"),Yd.forEach(t),Li=i(Jt," special method."),Jt.forEach(t),Si=d(Oe),y(Ee.$$.fragment,Oe),Wi=d(Oe),y(Ce.$$.fragment,Oe),Oe.forEach(t),ne.forEach(t),Oa=d(o),ge=n(o,"H2",{class:!0});var nn=s(ge);Fe=n(nn,"A",{id:!0,class:!0,href:!0});var Zd=s(Fe);ma=n(Zd,"SPAN",{});var ec=s(ma);y(_t.$$.fragment,ec),ec.forEach(t),Zd.forEach(t),Ri=d(nn),ha=n(nn,"SPAN",{});var tc=s(ha);Bi=i(tc,"ImageGPTForImageClassification"),tc.forEach(t),nn.forEach(t),La=d(o),N=n(o,"DIV",{class:!0});var se=s(N);y(Tt.$$.fragment,se),Hi=d(se),vt=n(se,"P",{});var sn=s(vt);Vi=i(sn,`The ImageGPT Model transformer with an image classification head on top (linear layer).
