...
instance of <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16341/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16341/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Whether or not <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16341/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<a href="/docs/transformers/pr_16341/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_16341/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_16341/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
Tuple of <code>jnp.ndarray</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}]}}),Cs=new V({props:{name:"replace",anchor:"transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput.replace",parameters:[{name:"**updates",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/flax/struct.py#L120"}}),Es=new ee({}),qs=new V({props:{name:"class transformers.Wav2Vec2Model",anchor:"transformers.Wav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1237",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ls=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2Model.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
<p>A <a
  href="/docs/transformers/pr_16341/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<span class="hljs-number">53.48</span>`}}),Js=new ee({}),Zs=new V({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),nn=new ee({}),rn=new V({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[ET]},$$scope:{ctx:C}}}),On=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16341/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[PT]},$$scope:{ctx:C}}}),Rn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16341/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16341/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16341/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16341/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16341/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16341/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Zd.forEach(t),th=c(ba),Po=s(ba,"DIV",{class:!0});var Kd=n(Po);g(Ba.$$.fragment,Kd),oh=c(Kd),nl=s(Kd,"P",{});var Yb=n(nl);ah=i(Yb,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),Yb.forEach(t),Kd.forEach(t),ba.forEach(t),ld=c(o),Zt=s(o,"H2",{class:!0});var Qd=n(Zt);zo=s(Qd,"A",{id:!0,class:!0,href:!0});var e1=n(zo);rl=s(e1,"SPAN",{});var t1=n(rl);g(Ua.$$.fragment,t1),t1.forEach(t),e1.forEach(t),sh=c(Qd),il=s(Qd,"SPAN",{});var o1=n(il);nh=i(o1,"Wav2Vec2Processor"),o1.forEach(t),Qd.forEach(t),cd=c(o),M=s(o,"DIV",{class:!0});var H=n(M);g(Ra.$$.fragment,H),rh=c(H),ll=s(H,"P",{});var a1=n(ll);ih=i(a1,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),a1.forEach(t),lh=c(H),ze=s(H,"P",{});var Tt=n(ze);Sr=s(Tt,"A",{href:!0});var s1=n(Sr);ch=i(s1,"Wav2Vec2Processor"),s1.forEach(t),dh=i(Tt," offers all the functionalities of "),Nr=s(Tt,"A",{href:!0});var n1=n(Nr);ph=i(n1,"Wav2Vec2FeatureExtractor"),n1.forEach(t),mh=i(Tt," and "),Ir=s(Tt,"A",{href:!0});var r1=n(Ir);hh=i(r1,"PreTrainedTokenizer"),r1.forEach(t),fh=i(Tt,`.
See the docstring of `),Ha=s(Tt,"A",{href:!0});var kb=n(Ha);cl=s(kb,"STRONG",{});var i1=n(cl);uh=i(i1,"call"),i1.forEach(t),gh=i(kb,"()"),kb.forEach(t),_h=i(Tt," and "),Br=s(Tt,"A",{href:!0});var l1=n(Br);vh=i(l1,"decode()"),l1.forEach(t),wh=i(Tt," for more information."),Tt.forEach(t),bh=c(H),Mo=s(H,"DIV",{class:!0});var Yd=n(Mo);g(Xa.$$.fragment,Yd),yh=c(Yd),ft=s(Yd,"P",{});var ya=n(ft);kh=i(ya,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
...
`),Ur=s(ya,"A",{href:!0});var d1=n(Ur);$h=i(d1,"as_target_processor()"),d1.forEach(t),jh=i(ya,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Ja=s(ya,"A",{href:!0});var xb=n(Ja);pl=s(xb,"STRONG",{});var p1=n(pl);Vh=i(p1,"call"),p1.forEach(t),Fh=i(xb,"()"),xb.forEach(t),Ch=i(ya,". Please refer to the docstring of the above two methods for more information."),ya.forEach(t),Yd.forEach(t),Eh=c(H),Ao=s(H,"DIV",{class:!0});var ep=n(Ao);g(Za.$$.fragment,ep),qh=c(ep),ut=s(ep,"P",{});var ka=n(ut);Ph=i(ka,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Rr=s(ka,"A",{href:!0});var m1=n(Rr);zh=i(m1,"pad()"),m1.forEach(t),Mh=i(ka,` and returns its output. If used in the context
`),Hr=s(ka,"A",{href:!0});var h1=n(Hr);Ah=i(h1,"as_target_processor()"),h1.forEach(t),Oh=i(ka,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Xr=s(ka,"A",{href:!0});var f1=n(Xr);Lh=i(f1,"pad()"),f1.forEach(t),Dh=i(ka,". Please refer to the docstring of the above two methods for more information."),ka.forEach(t),ep.forEach(t),Sh=c(H),Gr=s(H,"DIV",{class:!0});var u1=n(Gr);g(Ka.$$.fragment,u1),u1.forEach(t),Nh=c(H),$t=s(H,"DIV",{class:!0});var ji=n($t);g(Qa.$$.fragment,ji),Ih=c(ji),Ya=s(ji,"P",{});var tp=n(Ya);Bh=i(tp,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Jr=s(tp,"A",{href:!0});var g1=n(Jr);Uh=i(g1,"from_pretrained()"),g1.forEach(t),Rh=i(tp," method."),tp.forEach(t),Hh=c(ji),g(Oo.$$.fragment,ji),ji.forEach(t),Xh=c(H),Lo=s(H,"DIV",{class:!0});var op=n(Lo);g(es.$$.fragment,op),Gh=c(op),ts=s(op,"P",{});var ap=n(ts);Jh=i(ap,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Zr=s(ap,"A",{href:!0});var _1=n(Zr);Zh=i(_1,"batch_decode()"),_1.forEach(t),Kh=i(ap,`. Please
refer to the docstring of this method for more information.`),ap.forEach(t),op.forEach(t),Qh=c(H),Do=s(H,"DIV",{class:!0});var sp=n(Do);g(os.$$.fragment,sp),Yh=c(sp),as=s(sp,"P",{});var np=n(as);ef=i(np,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Kr=s(np,"A",{href:!0});var v1=n(Kr);tf=i(v1,"decode()"),v1.forEach(t),of=i(np,`. Please refer
to the docstring of this method for more information.`),np.forEach(t),sp.forEach(t),af=c(H),So=s(H,"DIV",{class:!0});var rp=n(So);g(ss.$$.fragment,rp),sf=c(rp),ml=s(rp,"P",{});var w1=n(ml);nf=i(w1,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),w1.forEach(t),rp.forEach(t),H.forEach(t),dd=c(o),Kt=s(o,"H2",{class:!0});var ip=n(Kt);No=s(ip,"A",{id:!0,class:!0,href:!0});var b1=n(No);hl=s(b1,"SPAN",{});var y1=n(hl);g(ns.$$.fragment,y1),y1.forEach(t),b1.forEach(t),rf=c(ip),fl=s(ip,"SPAN",{});var k1=n(fl);lf=i(k1,"Wav2Vec2ProcessorWithLM"),k1.forEach(t),ip.forEach(t),pd=c(o),N=s(o,"DIV",{class:!0});var te=n(N);g(rs.$$.fragment,te),cf=c(te),ul=s(te,"P",{});var T1=n(ul);df=i(T1,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor, a Wav2Vec2 CTC tokenizer and a decoder
...
`),Yr=s(xa,"A",{href:!0});var j1=n(Yr);Wf=i(j1,"pad()"),j1.forEach(t),$f=i(xa,` and returns its output. If used in the context
`),ei=s(xa,"A",{href:!0});var V1=n(ei);jf=i(V1,"as_target_processor()"),V1.forEach(t),Vf=i(xa,` this method forwards all its arguments to
...
for more information.`),xa.forEach(t),cp.forEach(t),Ef=c(te),jt=s(te,"DIV",{class:!0});var Vi=n(jt);g(ps.$$.fragment,Vi),qf=c(Vi),ms=s(Vi,"P",{});var dp=n(ms);Pf=i(dp,"Instantiate a "),oi=s(dp,"A",{href:!0});var C1=n(oi);zf=i(C1,"Wav2Vec2ProcessorWithLM"),C1.forEach(t),Mf=i(dp," from a pretrained Wav2Vec2 processor."),dp.forEach(t),Af=c(Vi),g(Uo.$$.fragment,Vi),Vi.forEach(t),Of=c(te),ai=s(te,"DIV",{class:!0});var E1=n(ai);g(hs.$$.fragment,E1),E1.forEach(t),Lf=c(te),Vt=s(te,"DIV",{class:!0});var Fi=n(Vt);g(fs.$$.fragment,Fi),Df=c(Fi),vl=s(Fi,"P",{});var q1=n(vl);Sf=i(q1,"Batch decode output logits to audio transcription with language model support."),q1.forEach(t),Nf=c(Fi),g(Ro.$$.fragment,Fi),Fi.forEach(t),If=c(te),tt=s(te,"DIV",{class:!0});var Wa=n(tt);g(us.$$.fragment,Wa),Bf=c(Wa),wl=s(Wa,"P",{});var P1=n(wl);Uf=i(P1,"Decode output logits to audio transcription with language model support."),P1.forEach(t),Rf=c(Wa),bl=s(Wa,"P",{});var z1=n(bl);Hf=i(z1,"Example:"),z1.forEach(t),Xf=c(Wa),g(gs.$$.fragment,Wa),Wa.forEach(t),Gf=c(te),Ho=s(te,"DIV",{class:!0});var pp=n(Ho);g(_s.$$.fragment,pp),Jf=c(pp),yl=s(pp,"P",{});var M1=n(yl);Zf=i(M1,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),M1.forEach(t),pp.forEach(t),te.forEach(t),md=c(o),Qt=s(o,"H2",{class:!0});var mp=n(Qt);Xo=s(mp,"A",{id:!0,class:!0,href:!0});var A1=n(Xo);kl=s(A1,"SPAN",{});var O1=n(kl);g(vs.$$.fragment,O1),O1.forEach(t),A1.forEach(t),Kf=c(mp),Tl=s(mp,"SPAN",{});var L1=n(Tl);Qf=i(L1,"Wav2Vec2 specific outputs"),L1.forEach(t),mp.forEach(t),hd=c(o),Yt=s(o,"DIV",{class:!0});var hp=n(Yt);g(ws.$$.fragment,hp),Yf=c(hp),bs=s(hp,"P",{});var fp=n(bs);eu=i(fp,"Output type of "),xl=s(fp,"CODE",{});var D1=n(xl);tu=i(D1,"Wav2Vec2DecoderWithLM"),D1.forEach(t),ou=i(fp,", with transcription."),fp.forEach(t),hp.forEach(t),fd=c(o),eo=s(o,"DIV",{class:!0});var up=n(eo);g(ys.$$.fragment,up),au=c(up),ks=s(up,"P",{});var gp=n(ks);su=i(gp,"Output type of "),Wl=s(gp,"CODE",{});var S1=n(Wl);nu=i(S1,"Wav2Vec2BaseModelOutput"),S1.forEach(t),ru=i(gp,", with potential hidden states and attentions."),gp.forEach(t),up.forEach(t),ud=c(o),to=s(o,"DIV",{class:!0});var _p=n(to);g(Ts.$$.fragment,_p),iu=c(_p),xs=s(_p,"P",{});var vp=n(xs);lu=i(vp,"Output type of "),si=s(vp,"A",{href:!0});var N1=n(si);cu=i(N1,"Wav2Vec2ForPreTraining"),N1.forEach(t),du=i(vp,", with potential hidden states and attentions."),vp.forEach(t),_p.forEach(t),gd=c(o),vt=s(o,"DIV",{class:!0});var Ci=n(vt);g(Ws.$$.fragment,Ci),pu=c(Ci),$s=s(Ci,"P",{});var wp=n($s);mu=i(wp,"Output type of "),$l=s(wp,"CODE",{});var I1=n($l);hu=i(I1,"FlaxWav2Vec2BaseModelOutput"),I1.forEach(t),fu=i(wp,", with potential hidden states and attentions."),wp.forEach(t),uu=c(Ci),Go=s(Ci,"DIV",{class:!0});var bp=n(Go);g(js.$$.fragment,bp),gu=c(bp),jl=s(bp,"P",{});var B1=n(jl);_u=i(B1,"\u201CReturns a new object replacing the specified fields with new values."),B1.forEach(t),bp.forEach(t),Ci.forEach(t),_d=c(o),wt=s(o,"DIV",{class:!0});var Ei=n(wt);g(Vs.$$.fragment,Ei),vu=c(Ei),Fs=s(Ei,"P",{});var yp=n(Fs);wu=i(yp,"Output type of "),Vl=s(yp,"CODE",{});var U1=n(Vl);bu=i(U1,"FlaxWav2Vec2ForPreTrainingOutput"),U1.forEach(t),yu=i(yp,", with potential hidden states and attentions."),yp.forEach(t),ku=c(Ei),Jo=s(Ei,"DIV",{class:!0});var kp=n(Jo);g(Cs.$$.fragment,kp),Tu=c(kp),Fl=s(kp,"P",{});var R1=n(Fl);xu=i(R1,"\u201CReturns a new object replacing the specified fields with new values."),R1.forEach(t),kp.forEach(t),Ei.forEach(t),vd=c(o),oo=s(o,"H2",{class:!0});var Tp=n(oo);Zo=s(Tp,"A",{id:!0,class:!0,href:!0});var H1=n(Zo);Cl=s(H1,"SPAN",{});var X1=n(Cl);g(Es.$$.fragment,X1),X1.forEach(t),H1.forEach(t),Wu=c(Tp),El=s(Tp,"SPAN",{});var G1=n(El);$u=i(G1,"Wav2Vec2Model"),G1.forEach(t),Tp.forEach(t),wd=c(o),We=s(o,"DIV",{class:!0});var Et=n(We);g(qs.$$.fragment,Et),ju=c(Et),Ps=s(Et,"P",{});var xp=n(Ps);Vu=i(xp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Du=c(Et),Me=s(Et,"DIV",{class:!0});var qt=n(Me);g(Ls.$$.fragment,qt),Su=c(qt),ao=s(qt,"P",{});var qi=n(ao);Nu=i(qi,"The "),ri=s(qi,"A",{href:!0});var Q1=n(ri);Iu=i(Q1,"Wav2Vec2Model"),Q1.forEach(t),Bu=i(qi," forward method, overrides the "),ql=s(qi,"CODE",{});var Y1=n(ql);Uu=i(Y1,"__call__"),Y1.forEach(t),Ru=i(qi," special method."),qi.forEach(t),Hu=c(qt),g(Ko.$$.fragment,qt),Xu=c(qt),Pl=s(qt,"P",{});var ey=n(Pl);Gu=i(ey,"Example:"),ey.forEach(t),Ju=c(qt),g(Ds.$$.fragment,qt),qt.forEach(t),Et.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var ty=n(Qo);zl=s(ty,"SPAN",{});var oy=n(zl);g(Ss.$$.fragment,oy),oy.forEach(t),ty.forEach(t),Zu=c(jp),Ml=s(jp,"SPAN",{});var ay=n(Ml);Ku=i(ay,"Wav2Vec2ForCTC"),ay.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var Pt=n($e);g(Ns.$$.fragment,Pt),Qu=c(Pt),no=s(Pt,"P",{});var Pi=n(no);Yu=i(Pi,"Wav2Vec2 Model with a "),Al=s(Pi,"CODE",{});var sy=n(Al);eg=i(sy,"language modeling"),sy.forEach(t),tg=i(Pi,` head on top for Connectionist Temporal Classification (CTC).
...
Auli.`),Pi.forEach(t),sg=c(Pt),Bs=s(Pt,"P",{});var Vp=n(Bs);ng=i(Vp,"This model inherits from "),ii=s(Vp,"A",{href:!0});var ry=n(ii);rg=i(ry,"PreTrainedModel"),ry.forEach(t),ig=i(Vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Vp.forEach(t),lg=c(Pt),Us=s(Pt,"P",{});var Fp=n(Us);cg=i(Fp,"This model is a PyTorch "),Rs=s(Fp,"A",{href:!0,rel:!0});var iy=n(Rs);dg=i(iy,"torch.nn.Module"),iy.forEach(t),pg=i(Fp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),mg=c(Pt),me=s(Pt,"DIV",{class:!0});var ot=n(me);g(Hs.$$.fragment,ot),hg=c(ot),ro=s(ot,"P",{});var zi=n(ro);fg=i(zi,"The "),li=s(zi,"A",{href:!0});var ly=n(li);ug=i(ly,"Wav2Vec2ForCTC"),ly.forEach(t),gg=i(zi," forward method, overrides the "),Ol=s(zi,"CODE",{});var cy=n(Ol);_g=i(cy,"__call__"),cy.forEach(t),vg=i(zi," special method."),zi.forEach(t),wg=c(ot),g(Yo.$$.fragment,ot),bg=c(ot),Ll=s(ot,"P",{});var dy=n(Ll);yg=i(dy,"Example:"),dy.forEach(t),kg=c(ot),g(Xs.$$.fragment,ot),Tg=c(ot),g(Gs.$$.fragment,ot),ot.forEach(t),Pt.forEach(t),kd=c(o),io=s(o,"H2",{class:!0});var Cp=n(io);ea=s(Cp,"A",{id:!0,class:!0,href:!0});var py=n(ea);Dl=s(py,"SPAN",{});var my=n(Dl);g(Js.$$.fragment,my),my.forEach(t),py.forEach(t),xg=c(Cp),Sl=s(Cp,"SPAN",{});var hy=n(Sl);Wg=i(hy,"Wav2Vec2ForSequenceClassification"),hy.forEach(t),Cp.forEach(t),Td=c(o),ne=s(o,"DIV",{class:!0});var at=n(ne);g(Zs.$$.fragment,at),$g=c(at),Nl=s(at,"P",{});var fy=n(Nl);jg=i(fy,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),fy.forEach(t),Vg=c(at),Ks=s(at,"P",{});var Ep=n(Ks);Fg=i(Ep,"Wav2Vec2 was proposed in "),Qs=s(Ep,"A",{href:!0,rel:!0});var uy=n(Qs);Cg=i(uy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),Sg=c(at),he=s(at,"DIV",{class:!0});var st=n(he);g(on.$$.fragment,st),Ng=c(st),lo=s(st,"P",{});var Mi=n(lo);Ig=i(Mi,"The "),di=s(Mi,"A",{href:!0});var vy=n(di);Bg=i(vy,"Wav2Vec2ForSequenceClassification"),vy.forEach(t),Ug=i(Mi," forward method, overrides the "),Il=s(Mi,"CODE",{});var wy=n(Il);Rg=i(wy,"__call__"),wy.forEach(t),Hg=i(Mi," special method."),Mi.forEach(t),Xg=c(st),g(ta.$$.fragment,st),Gg=c(st),Bl=s(st,"P",{});var by=n(Bl);Jg=i(by,"Example:"),by.forEach(t),Zg=c(st),g(an.$$.fragment,st),Kg=c(st),g(sn.$$.fragment,st),st.forEach(t),at.forEach(t),xd=c(o),co=s(o,"H2",{class:!0});var zp=n(co);oa=s(zp,"A",{id:!0,class:!0,href:!0});var yy=n(oa);Ul=s(yy,"SPAN",{});var ky=n(Ul);g(nn.$$.fragment,ky),ky.forEach(t),yy.forEach(t),Qg=c(zp),Rl=s(zp,"SPAN",{});var Ty=n(Rl);Yg=i(Ty,"Wav2Vec2ForAudioFrameClassification"),Ty.forEach(t),zp.forEach(t),Wd=c(o),re=s(o,"DIV",{class:!0});var nt=n(re);g(rn.$$.fragment,nt),e_=c(nt),Hl=s(nt,"P",{});var xy=n(Hl);t_=i(xy,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),xy.forEach(t),o_=c(nt),ln=s(nt,"P",{});var Mp=n(ln);a_=i(Mp,"Wav2Vec2 was proposed in "),cn=s(Mp,"A",{href:!0,rel:!0});var Wy=n(cn);s_=i(Wy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),N_=c(rt),Oe=s(rt,"DIV",{class:!0});var Mt=n(Oe);g(kn.$$.fragment,Mt),I_=c(Mt),ho=s(Mt,"P",{});var Oi=n(ho);B_=i(Oi,"The "),fi=s(Oi,"A",{href:!0});var Ly=n(fi);U_=i(Ly,"Wav2Vec2ForXVector"),Ly.forEach(t),R_=i(Oi," forward method, overrides the "),Ql=s(Oi,"CODE",{});var Dy=n(Ql);H_=i(Dy,"__call__"),Dy.forEach(t),X_=i(Oi," special method."),Oi.forEach(t),G_=c(Mt),g(na.$$.fragment,Mt),J_=c(Mt),Yl=s(Mt,"P",{});var Sy=n(Yl);Z_=i(Sy,"Example:"),Sy.forEach(t),K_=c(Mt),g(Tn.$$.fragment,Mt),Mt.forEach(t),rt.forEach(t),Vd=c(o),fo=s(o,"H2",{class:!0});var Ip=n(fo);ra=s(Ip,"A",{id:!0,class:!0,href:!0});var Ny=n(ra);ec=s(Ny,"SPAN",{});var Iy=n(ec);g(xn.$$.fragment,Iy),Iy.forEach(t),Ny.forEach(t),Q_=c(Ip),tc=s(Ip,"SPAN",{});var By=n(tc);Y_=i(By,"Wav2Vec2ForPreTraining"),By.forEach(t),Ip.forEach(t),Fd=c(o),je=s(o,"DIV",{class:!0});var At=n(je);g(Wn.$$.fragment,At),ev=c(At),uo=s(At,"P",{});var Li=n(uo);tv=i(Li,"Wav2Vec2 Model with a quantizer and "),oc=s(Li,"CODE",{});var Uy=n(oc);ov=i(Uy,"VQ"),Uy.forEach(t),av=i(Li,` head on top.
Wav2Vec2 was proposed in `),$n=s(Li,"A",{href:!0,rel:!0});var Ry=n($n);sv=i(Ry,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Ry.forEach(t),nv=i(Li,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Li.forEach(t),rv=c(At),jn=s(At,"P",{});var Bp=n(jn);iv=i(Bp,"This model inherits from "),ui=s(Bp,"A",{href:!0});var Hy=n(ui);lv=i(Hy,"PreTrainedModel"),Hy.forEach(t),cv=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Bp.forEach(t),dv=c(At),Vn=s(At,"P",{});var Up=n(Vn);pv=i(Up,"This model is a PyTorch "),Fn=s(Up,"A",{href:!0,rel:!0});var Xy=n(Fn);mv=i(Xy,"torch.nn.Module"),Xy.forEach(t),hv=i(Up,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Up.forEach(t),fv=c(At),Le=s(At,"DIV",{class:!0});var Ot=n(Le);g(Cn.$$.fragment,Ot),uv=c(Ot),go=s(Ot,"P",{});var Di=n(go);gv=i(Di,"The "),gi=s(Di,"A",{href:!0});var Gy=n(gi);_v=i(Gy,"Wav2Vec2ForPreTraining"),Gy.forEach(t),vv=i(Di," forward method, overrides the "),ac=s(Di,"CODE",{});var Jy=n(ac);wv=i(Jy,"__call__"),Jy.forEach(t),bv=i(Di," special method."),Di.forEach(t),yv=c(Ot),g(ia.$$.fragment,Ot),kv=c(Ot),sc=s(Ot,"P",{});var Zy=n(sc);Tv=i(Zy,"Example:"),Zy.forEach(t),xv=c(Ot),g(En.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Cd=c(o),_o=s(o,"H2",{class:!0});var Rp=n(_o);la=s(Rp,"A",{id:!0,class:!0,href:!0});var Ky=n(la);nc=s(Ky,"SPAN",{});var Qy=n(nc);g(qn.$$.fragment,Qy),Qy.forEach(t),Ky.forEach(t),Wv=c(Rp),rc=s(Rp,"SPAN",{});var Yy=n(rc);$v=i(Yy,"TFWav2Vec2Model"),Yy.forEach(t),Rp.forEach(t),Ed=c(o),le=s(o,"DIV",{class:!0});var it=n(le);g(Pn.$$.fragment,it),jv=c(it),ic=s(it,"P",{});var ek=n(ic);Vv=i(ek,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),ek.forEach(t),Fv=c(it),zn=s(it,"P",{});var Hp=n(zn);Cv=i(Hp,"This model inherits from "),_i=s(Hp,"A",{href:!0});var tk=n(_i);Ev=i(tk,"TFPreTrainedModel"),tk.forEach(t),qv=i(Hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
