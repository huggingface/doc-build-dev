...
the latter silently ignores them.`)},l(g){h=n(g,"P",{});var f=a(h);V=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n(f,"CODE",{});var $=a(m);y=i($,"Module"),$.forEach(s),B=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(s)},m(g,f){p(g,h,f),e(h,V),e(h,m),e(m,y),e(h,B)},d(g){g&&s(h)}}}function Yd(A){let h,V,m,y,B,g,f,$,$n,yo,oe,Te,Fs,Se,zn,xs,qn,Bo,we,Fn,We,xn,Pn,Vo,Ut,En,$o,Kt,Ps,Mn,zo,Jt,An,qo,ye,Es,Oe,jn,Gt,Cn,Rn,Nn,Ms,As,In,Fo,ne,Be,js,Qe,Dn,Cs,Ln,xo,Yt,Sn,Po,Xt,Wn,Eo,Ve,On,Zt,Qn,Hn,Mo,$e,Rs,es,He,Un,Kn,Jn,Ns,ts,Ue,Gn,Yn,Ao,ze,Xn,ss,Zn,ea,jo,Ke,Co,S,ta,Je,sa,oa,Ge,na,aa,Ro,ae,qe,Is,Ye,ra,Ds,ia,No,z,Xe,la,re,da,os,ca,ua,Ze,ha,pa,ma,ie,fa,ns,ga,_a,as,va,ba,ka,Ls,Ta,wa,et,Io,le,Fe,Ss,tt,ya,Ws,Ba,Do,q,st,Va,ot,$a,rs,za,qa,Fa,nt,xa,at,Pa,Ea,Ma,rt,Aa,it,ja,Ca,Ra,j,lt,Na,de,Ia,is,Da,La,Os,Sa,Wa,Oa,xe,Qa,Qs,Ha,Ua,dt,Lo,ce,Pe,Hs,ct,Ka,Us,Ja,So,F,ut,Ga,ue,Ya,Ks,Xa,Za,Js,er,tr,sr,ht,or,ls,nr,ar,rr,pt,ir,mt,lr,dr,cr,C,ft,ur,he,hr,ds,pr,mr,Gs,fr,gr,_r,Ee,vr,Ys,br,kr,gt,Wo,pe,Me,Xs,_t,Tr,Zs,wr,Oo,x,vt,yr,eo,Br,Vr,bt,$r,cs,zr,qr,Fr,kt,xr,Tt,Pr,Er,Mr,R,wt,Ar,me,jr,us,Cr,Rr,to,Nr,Ir,Dr,Ae,Lr,so,Sr,Wr,yt,Qo,fe,je,oo,Bt,Or,no,Qr,Ho,P,Vt,Hr,ao,Ur,Kr,$t,Jr,hs,Gr,Yr,Xr,zt,Zr,qt,ei,ti,si,N,Ft,oi,ge,ni,ps,ai,ri,ro,ii,li,di,Ce,ci,io,ui,hi,xt,Uo,_e,Re,lo,Pt,pi,co,mi,Ko,E,Et,fi,uo,gi,_i,Mt,vi,ms,bi,ki,Ti,At,wi,jt,yi,Bi,Vi,I,Ct,$i,ve,zi,fs,qi,Fi,ho,xi,Pi,Ei,Ne,Mi,po,Ai,ji,Rt,Jo,be,Ie,mo,Nt,Ci,fo,Ri,Go,M,It,Ni,go,Ii,Di,Dt,Li,gs,Si,Wi,Oi,Lt,Qi,St,Hi,Ui,Ki,D,Wt,Ji,ke,Gi,_s,Yi,Xi,_o,Zi,el,tl,De,sl,vo,ol,nl,Ot,Yo;return g=new se({}),Se=new se({}),Qe=new se({}),Ke=new Le({props:{code:`import torch
...
`}}),xe=new qs({props:{$$slots:{default:[Qd]},$$scope:{ctx:A}}}),dt=new Le({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image.
from transformers import BertTokenizer, VisualBertModel
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ft=new L({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"visual_embeds",val:" = None"},{name:"visual_attention_mask",val:" = None"},{name:"visual_token_type_ids",val:" = None"},{name:"image_text_alignment",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16341/src/transformers/models/visual_bert/modeling_visual_bert.py#L1036",parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16341/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16341/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16341/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Ce=new qs({props:{$$slots:{default:[Kd]},$$scope:{ctx:A}}}),xt=new Le({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){h=o("meta"),V=d(),m=o("h1"),y=o("a"),B=o("span"),_(g.$$.fragment),f=d(),$=o("span"),$n=r("VisualBERT"),yo=d(),oe=o("h2"),Te=o("a"),Fs=o("span"),_(Se.$$.fragment),zn=d(),xs=o("span"),qn=r("Overview"),Bo=d(),we=o("p"),Fn=r("The VisualBERT model was proposed in "),We=o("a"),xn=r("VisualBERT: A Simple and Performant Baseline for Vision and Language"),Pn=r(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
...
projects, and the states can be loaded directly into the detector provided.`),Fo=d(),ne=o("h2"),Be=o("a"),js=o("span"),_(Qe.$$.fragment),Dn=d(),Cs=o("span"),Ln=r("Usage"),xo=d(),Yt=o("p"),Sn=r(`VisualBERT is a multi-modal vision and language model. It can be used for visual question answering, multiple choice,
...
etc.)`),Fa=d(),nt=o("p"),xa=r("This model is also a PyTorch "),at=o("a"),Pa=r("torch.nn.Module"),Ea=r(` subclass.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ra=d(),j=o("div"),_(lt.$$.fragment),Na=d(),de=o("p"),Ia=r("The "),is=o("a"),Da=r("VisualBertModel"),La=r(" forward method, overrides the "),Os=o("code"),Sa=r("__call__"),Wa=r(" special method."),Oa=d(),_(xe.$$.fragment),Qa=d(),Qs=o("p"),Ha=r("Example:"),Ua=d(),_(dt.$$.fragment),Lo=d(),ce=o("h2"),Pe=o("a"),Hs=o("span"),_(ct.$$.fragment),Ka=d(),Us=o("span"),Ja=r("VisualBertForPreTraining"),So=d(),F=o("div"),_(ut.$$.fragment),Ga=d(),ue=o("p"),Ya=r("VisualBert Model with two heads on top as done during the pretraining: a "),Ks=o("code"),Xa=r("masked language modeling"),Za=r(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cr=d(),C=o("div"),_(ft.$$.fragment),ur=d(),he=o("p"),hr=r("The "),ds=o("a"),pr=r("VisualBertForPreTraining"),mr=r(" forward method, overrides the "),Gs=o("code"),fr=r("__call__"),gr=r(" special method."),_r=d(),_(Ee.$$.fragment),vr=d(),Ys=o("p"),br=r("Example:"),kr=d(),_(gt.$$.fragment),Wo=d(),pe=o("h2"),Me=o("a"),Xs=o("span"),_(_t.$$.fragment),Tr=d(),Zs=o("span"),wr=r("VisualBertForQuestionAnswering"),Oo=d(),x=o("div"),_(vt.$$.fragment),yr=d(),eo=o("p"),Br=r(`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fr=d(),kt=o("p"),xr=r("This model is also a PyTorch "),Tt=o("a"),Pr=r("torch.nn.Module"),Er=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si=d(),N=o("div"),_(Ft.$$.fragment),oi=d(),ge=o("p"),ni=r("The "),ps=o("a"),ai=r("VisualBertForMultipleChoice"),ri=r(" forward method, overrides the "),ro=o("code"),ii=r("__call__"),li=r(" special method."),di=d(),_(Ce.$$.fragment),ci=d(),io=o("p"),ui=r("Example:"),hi=d(),_(xt.$$.fragment),Uo=d(),_e=o("h2"),Re=o("a"),lo=o("span"),_(Pt.$$.fragment),pi=d(),co=o("span"),mi=r("VisualBertForVisualReasoning"),Ko=d(),E=o("div"),_(Et.$$.fragment),fi=d(),uo=o("p"),gi=r(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vi=d(),I=o("div"),_(Ct.$$.fragment),$i=d(),ve=o("p"),zi=r("The "),fs=o("a"),qi=r("VisualBertForVisualReasoning"),Fi=r(" forward method, overrides the "),ho=o("code"),xi=r("__call__"),Pi=r(" special method."),Ei=d(),_(Ne.$$.fragment),Mi=d(),po=o("p"),Ai=r("Example:"),ji=d(),_(Rt.$$.fragment),Jo=d(),be=o("h2"),Ie=o("a"),mo=o("span"),_(Nt.$$.fragment),Ci=d(),fo=o("span"),Ri=r("VisualBertForRegionToPhraseAlignment"),Go=d(),M=o("div"),_(It.$$.fragment),Ni=d(),go=o("p"),Ii=r(`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ln.forEach(s),Fa=c(O),nt=n(O,"P",{});var dn=a(nt);xa=i(dn,"This model is also a PyTorch "),at=n(dn,"A",{href:!0,rel:!0});var Wl=a(at);Pa=i(Wl,"torch.nn.Module"),Wl.forEach(s),Ea=i(dn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fn.forEach(s),Fr=c(K),kt=n(K,"P",{});var gn=a(kt);xr=i(gn,"This model is also a PyTorch "),Tt=n(gn,"A",{href:!0,rel:!0});var dd=a(Tt);Pr=i(dd,"torch.nn.Module"),dd.forEach(s),Er=i(gn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bn.forEach(s),si=c(G),N=n(G,"DIV",{class:!0});var Y=a(N);v(Ft.$$.fragment,Y),oi=c(Y),ge=n(Y,"P",{});var Vs=a(ge);ni=i(Vs,"The "),ps=n(Vs,"A",{href:!0});var bd=a(ps);ai=i(bd,"VisualBertForMultipleChoice"),bd.forEach(s),ri=i(Vs," forward method, overrides the "),ro=n(Vs,"CODE",{});var kd=a(ro);ii=i(kd,"__call__"),kd.forEach(s),li=i(Vs," special method."),Vs.forEach(s),di=c(Y),v(Ce.$$.fragment,Y),ci=c(Y),io=n(Y,"P",{});var Td=a(io);ui=i(Td,"Example:"),Td.forEach(s),hi=c(Y),v(xt.$$.fragment,Y),Y.forEach(s),G.forEach(s),Uo=c(t),_e=n(t,"H2",{class:!0});var kn=a(_e);Re=n(kn,"A",{id:!0,class:!0,href:!0});var wd=a(Re);lo=n(wd,"SPAN",{});var yd=a(lo);v(Pt.$$.fragment,yd),yd.forEach(s),wd.forEach(s),pi=c(kn),co=n(kn,"SPAN",{});var Bd=a(co);mi=i(Bd,"VisualBertForVisualReasoning"),Bd.forEach(s),kn.forEach(s),Ko=c(t),E=n(t,"DIV",{class:!0});var X=a(E);v(Et.$$.fragment,X),fi=c(X),uo=n(X,"P",{});var Vd=a(uo);gi=i(Vd,`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wn.forEach(s),Vi=c(X),I=n(X,"DIV",{class:!0});var Z=a(I);v(Ct.$$.fragment,Z),$i=c(Z),ve=n(Z,"P",{});var $s=a(ve);zi=i($s,"The "),fs=n($s,"A",{href:!0});var qd=a(fs);qi=i(qd,"VisualBertForVisualReasoning"),qd.forEach(s),Fi=i($s," forward method, overrides the "),ho=n($s,"CODE",{});var Fd=a(ho);xi=i(Fd,"__call__"),Fd.forEach(s),Pi=i($s," special method."),$s.forEach(s),Ei=c(Z),v(Ne.$$.fragment,Z),Mi=c(Z),po=n(Z,"P",{});var xd=a(po);Ai=i(xd,"Example:"),xd.forEach(s),ji=c(Z),v(Rt.$$.fragment,Z),Z.forEach(s),X.forEach(s),Jo=c(t),be=n(t,"H2",{class:!0});var yn=a(be);Ie=n(yn,"A",{id:!0,class:!0,href:!0});var Pd=a(Ie);mo=n(Pd,"SPAN",{});var Ed=a(mo);v(Nt.$$.fragment,Ed),Ed.forEach(s),Pd.forEach(s),Ci=c(yn),fo=n(yn,"SPAN",{});var Md=a(fo);Ri=i(Md,"VisualBertForRegionToPhraseAlignment"),Md.forEach(s),yn.forEach(s),Go=c(t),M=n(t,"DIV",{class:!0});var ee=a(M);v(It.$$.fragment,ee),Ni=c(ee),go=n(ee,"P",{});var Ad=a(go);Ii=i(Ad,`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
