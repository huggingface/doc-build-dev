...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16201/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16201/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16201/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16201/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16201/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16201/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wx]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16201/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16201/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16201/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16201/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16201/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16201/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sy=l(fe),Mc=a(fe,"P",{});var j0=s(Mc);Ay=i(j0,"Finally, this model supports inherent JAX features such as:"),j0.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var E0=s(wc);ir=a(E0,"A",{href:!0,rel:!0});var P0=s(ir);Ny=i(P0,"Just-In-Time (JIT) compilation"),P0.forEach(t),E0.forEach(t),Oy=l(jn),xc=a(jn,"LI",{});var C0=s(xc);dr=a(C0,"A",{href:!0,rel:!0});var S0=s(dr);Dy=i(S0,"Automatic Differentiation"),S0.forEach(t),C0.forEach(t),Ly=l(jn),zc=a(jn,"LI",{});var A0=s(zc);lr=a(A0,"A",{href:!0,rel:!0});var I0=s(lr);Gy=i(I0,"Vectorization"),I0.forEach(t),A0.forEach(t),Wy=l(jn),qc=a(jn,"LI",{});var N0=s(qc);cr=a(N0,"A",{href:!0,rel:!0});var O0=s(cr);Ry=i(O0,"Parallelization"),O0.forEach(t),N0.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xy=l(Re),$o=a(Re,"P",{});var Ji=s($o);Hy=i(Ji,"The "),Bc=a(Ji,"CODE",{});var D0=s(Bc);Vy=i(D0,"FlaxMBartPreTrainedModel"),D0.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var L0=s($c);Jy=i(L0,"__call__"),L0.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(Re),f(kn.$$.fragment,Re),Yy=l(Re),Fc=a(Re,"P",{});var G0=s(Fc);e1=i(G0,"Summarization example:"),G0.forEach(t),t1=l(Re),f(hr.$$.fragment,Re),o1=l(Re),jc=a(Re,"P",{});var W0=s(jc);n1=i(W0,"Mask filling example:"),W0.forEach(t),a1=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),s1=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),r1=l(Ki),Ec=a(Ki,"P",{});var R0=s(Ec);i1=i(R0,"Example:"),R0.forEach(t),d1=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),l1=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),c1=l(Zi),Pc=a(Zi,"P",{});var U0=s(Pc);p1=i(U0,"Example:"),U0.forEach(t),h1=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var zu=s(Fo);bn=a(zu,"A",{id:!0,class:!0,href:!0});var X0=s(bn);Cc=a(X0,"SPAN",{});var H0=s(Cc);f(kr.$$.fragment,H0),H0.forEach(t),X0.forEach(t),u1=l(zu),Sc=a(zu,"SPAN",{});var V0=s(Sc);m1=i(V0,"FlaxMBartForSequenceClassification"),V0.forEach(t),zu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),f1=l(oe),Ac=a(oe,"P",{});var Q0=s(Ac);_1=i(Q0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Q0.forEach(t),g1=l(oe),vr=a(oe,"P",{});var qu=s(vr);k1=i(qu,"This model inherits from "),Fi=a(qu,"A",{href:!0});var J0=s(Fi);b1=i(J0,"FlaxPreTrainedModel"),J0.forEach(t),v1=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),y1=l(oe),yr=a(oe,"P",{});var Bu=s(yr);T1=i(Bu,`This model is also a Flax Linen
`),Tr=a(Bu,"A",{href:!0,rel:!0});var K0=s(Tr);M1=i(K0,"flax.nn.Module"),K0.forEach(t),w1=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),x1=l(oe),Ic=a(oe,"P",{});var Z0=s(Ic);z1=i(Z0,"Finally, this model supports inherent JAX features such as:"),Z0.forEach(t),q1=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Y0=s(Nc);Mr=a(Y0,"A",{href:!0,rel:!0});var ex=s(Mr);B1=i(ex,"Just-In-Time (JIT) compilation"),ex.forEach(t),Y0.forEach(t),$1=l(En),Oc=a(En,"LI",{});var tx=s(Oc);wr=a(tx,"A",{href:!0,rel:!0});var ox=s(wr);F1=i(ox,"Automatic Differentiation"),ox.forEach(t),tx.forEach(t),j1=l(En),Dc=a(En,"LI",{});var nx=s(Dc);xr=a(nx,"A",{href:!0,rel:!0});var ax=s(xr);E1=i(ax,"Vectorization"),ax.forEach(t),nx.forEach(t),P1=l(En),Lc=a(En,"LI",{});var sx=s(Lc);zr=a(sx,"A",{href:!0,rel:!0});var rx=s(zr);C1=i(rx,"Parallelization"),rx.forEach(t),sx.forEach(t),En.forEach(t),S1=l(oe),Oe=a(oe,"DIV",{class:!0});var Wt=s(Oe);f(qr.$$.fragment,Wt),A1=l(Wt),jo=a(Wt,"P",{});var Yi=s(jo);I1=i(Yi,"The "),Gc=a(Yi,"CODE",{});var ix=s(Gc);N1=i(ix,"FlaxMBartPreTrainedModel"),ix.forEach(t),O1=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var dx=s(Wc);D1=i(dx,"__call__"),dx.forEach(t),L1=i(Yi," special method."),Yi.forEach(t),G1=l(Wt),f(vn.$$.fragment,Wt),W1=l(Wt),Rc=a(Wt,"P",{});var lx=s(Rc);R1=i(lx,"Example:"),lx.forEach(t),U1=l(Wt),f(Br.$$.fragment,Wt),Wt.forEach(t),X1=l(oe),qt=a(oe,"DIV",{class:!0});var ed=s(qt);f($r.$$.fragment,ed),H1=l(ed),Uc=a(ed,"P",{});var cx=s(Uc);V1=i(cx,"Example:"),cx.forEach(t),Q1=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),J1=l(oe),Bt=a(oe,"DIV",{class:!0});var td=s(Bt);f(jr.$$.fragment,td),K1=l(td),Xc=a(td,"P",{});var px=s(Xc);Z1=i(px,"Example:"),px.forEach(t),Y1=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var hx=s(yn);Hc=a(hx,"SPAN",{});var ux=s(Hc);f(Pr.$$.fragment,ux),ux.forEach(t),hx.forEach(t),eT=l($u),Vc=a($u,"SPAN",{});var mx=s(Vc);tT=i(mx,"FlaxMBartForQuestionAnswering"),mx.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),oT=l(ne),Po=a(ne,"P",{});var od=s(Po);nT=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Qc=a(od,"CODE",{});var fx=s(Qc);aT=i(fx,"span start logits"),fx.forEach(t),sT=i(od," and "),Jc=a(od,"CODE",{});var _x=s(Jc);rT=i(_x,"span end logits"),_x.forEach(t),iT=i(od,")."),od.forEach(t),dT=l(ne),Sr=a(ne,"P",{});var Fu=s(Sr);lT=i(Fu,"This model inherits from "),ji=a(Fu,"A",{href:!0});var gx=s(ji);cT=i(gx,"FlaxPreTrainedModel"),gx.forEach(t),pT=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
