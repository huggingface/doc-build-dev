import{S as V_,i as R_,s as H_,e as n,k as l,w as b,t as r,M as K_,c as s,d as t,m as c,a,x as y,h as i,b as p,G as e,g as f,y as T,q as w,o as P,B as $,v as Q_,L as Qe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Uo}from"../../chunks/Tip-hf-doc-builder.js";import{D as M}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Se}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Z}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ke}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function J_(z){let u,v,_,h,k;return h=new Se({props:{code:`from transformers import PegasusModel, PegasusConfig
...
`),oe=s(R,"CODE",{});var lt=a(oe);V=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),R.forEach(t),L.forEach(t)},m(x,q){f(x,u,q),e(u,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,H,q),f(x,S,q),e(S,O),e(O,Le),e(O,Y),e(Y,ee),e(O,Ge),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,K),e(K,Ue),e(S,We),e(S,W),e(W,Be),e(W,oe),e(oe,V)},d(x){x&&t(u),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(H),x&&t(S)}}}function nk(z){let u,v,_,h,k;return{c(){u=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,u,m),e(u,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(h,d)}}}function ak(z){let u,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,H,S,O,Le,Y,ee,Ge,U,Ne,De,I,me,de,ze,te,K,Ue,We,W,Be,oe,V;return{c(){u=n("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),ve=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),H=l(),S=n("ul"),O=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),K=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=l(),W=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),V=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){u=s(x,"P",{});var q=a(u);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var be=a(h);k=s(be,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(be),F=s(be,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
...
first positional argument :`),le.forEach(t),H=c(x),S=s(x,"UL",{});var L=a(S);O=s(L,"LI",{});var J=a(O);Le=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var Te=a(Y);ee=i(Te,"input_ids"),Te.forEach(t),Ge=i(J," only and nothing else: "),U=s(J,"CODE",{});var it=a(U);Ne=i(it,"model(input_ids)"),it.forEach(t),J.forEach(t),De=c(L),I=s(L,"LI",{});var X=a(I);me=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var dt=a(de);ze=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),te=i(X," or "),K=s(X,"CODE",{});var Xe=a(K);Ue=i(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),X.forEach(t),We=c(L),W=s(L,"LI",{});var R=a(W);Be=i(R,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(R,"CODE",{});var lt=a(oe);V=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),R.forEach(t),L.forEach(t)},m(x,q){f(x,u,q),e(u,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,H,q),f(x,S,q),e(S,O),e(O,Le),e(O,Y),e(Y,ee),e(O,Ge),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,K),e(K,Ue),e(S,We),e(S,W),e(W,Be),e(W,oe),e(oe,V)},d(x){x&&t(u),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(H),x&&t(S)}}}function rk(z){let u,v,_,h,k;return{c(){u=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,u,m),e(u,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(h,d)}}}function fk(z){let u,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,H,S,O,Le,Y,ee,Ge,U,Ne,De,I,me,de,ze,te,K,Ue,We,W,Be,oe,V,x,q,be,at,ye,Q,rt,Je,le,L,J,Te,it,X,dt,Xe,R,lt,Wo,Zd,Yd,la,el,tl,zi,fe,ca,ol,nl,pa,sl,al,ua,rl,il,Bo,dl,Vo,ll,cl,pl,At,Ro,ul,hl,Ho,ml,fl,Fi,ct,It,ha,Ko,gl,ma,_l,qi,Ze,Lt,Qo,kl,vl,Jo,bl,yl,Tl,fa,wl,Pl,ga,$l,Ei,pt,Gt,_a,Xo,xl,ka,zl,Ci,ge,va,ba,Fl,ql,ya,Es,El,Cs,Cl,Ml,Zo,Ta,jl,Sl,ut,wa,Ol,Al,Pa,Il,Ll,Yo,Gl,$a,Nl,Dl,Ul,xa,Ve,Wl,za,Bl,Vl,Fa,Rl,Hl,qa,Kl,Ql,Jl,Ea,ht,Xl,en,Zl,Yl,Ca,ec,tc,Mi,mt,Nt,Ma,tn,oc,ja,nc,ji,on,Si,ft,Dt,Sa,nn,sc,Oa,ac,Oi,we,sn,rc,gt,ic,Ms,dc,lc,an,cc,pc,uc,_t,hc,js,mc,fc,Ss,gc,_c,kc,Ut,Ai,kt,Wt,Aa,rn,vc,Ia,bc,Ii,Bt,yc,La,Tc,wc,Li,B,dn,Pc,ln,$c,cn,xc,zc,Fc,pn,qc,Os,Ec,Cc,Mc,Fe,un,jc,hn,Sc,Ga,Oc,Ac,Ic,mn,As,Lc,Na,Gc,Nc,fn,Dc,Da,Uc,Wc,Bc,Ua,Vc,Rc,Vt,gn,Hc,Wa,Kc,Qc,Rt,_n,Jc,Ba,Xc,Zc,Ht,kn,Yc,Va,ep,Gi,vt,Kt,Ra,vn,tp,Ha,op,Ni,ce,bn,np,bt,sp,Ka,ap,rp,yn,ip,dp,lp,Tn,cp,Is,pp,up,hp,Ye,wn,mp,Qa,fp,gp,Pn,Ls,_p,Ja,kp,vp,$n,bp,Xa,yp,Tp,wp,Qt,xn,Pp,Za,$p,Di,yt,Jt,Ya,zn,xp,er,zp,Ui,Pe,Fn,Fp,qn,qp,Gs,Ep,Cp,Mp,En,jp,Cn,Sp,Op,Ap,qe,Mn,Ip,Tt,Lp,Ns,Gp,Np,tr,Dp,Up,Wp,Xt,Bp,Zt,Wi,wt,Yt,or,jn,Vp,nr,Rp,Bi,$e,Sn,Hp,On,Kp,Ds,Qp,Jp,Xp,An,Zp,In,Yp,eu,tu,Ee,Ln,ou,Pt,nu,Us,su,au,sr,ru,iu,du,eo,lu,to,Vi,$t,oo,ar,Gn,cu,rr,pu,Ri,xt,Nn,uu,no,Dn,hu,so,Hi,zt,ao,ir,Un,mu,dr,fu,Ki,pe,Wn,gu,Bn,_u,Ws,ku,vu,bu,Vn,yu,Rn,Tu,wu,Pu,ro,$u,Ce,Hn,xu,Ft,zu,Bs,Fu,qu,lr,Eu,Cu,Mu,io,ju,lo,Qi,qt,co,cr,Kn,Su,pr,Ou,Ji,ue,Qn,Au,Jn,Iu,Vs,Lu,Gu,Nu,Xn,Du,Zn,Uu,Wu,Bu,po,Vu,Me,Yn,Ru,Et,Hu,Rs,Ku,Qu,ur,Ju,Xu,Zu,uo,Yu,ho,Xi,Ct,mo,hr,es,eh,mr,th,Zi,G,ts,oh,os,nh,Hs,sh,ah,rh,ns,ih,ss,dh,lh,ch,fr,ph,uh,Re,gr,as,hh,mh,_r,rs,fh,gh,kr,is,_h,kh,vr,ds,vh,bh,je,ls,yh,Mt,Th,br,wh,Ph,yr,$h,xh,zh,fo,Fh,go,qh,_o,cs,Eh,ko,Ch,vo,ps,Mh,bo,Yi,jt,yo,Tr,us,jh,wr,Sh,ed,N,hs,Oh,ms,Ah,Ks,Ih,Lh,Gh,fs,Nh,gs,Dh,Uh,Wh,Pr,Bh,Vh,He,$r,_s,Rh,Hh,xr,ks,Kh,Qh,zr,vs,Jh,Xh,Fr,bs,Zh,Yh,C,ys,em,St,tm,qr,om,nm,Er,sm,am,rm,To,im,Cr,dm,lm,Mr,jr,Sr,Or,cm,pm,Ar,Ir,Lr,Gr,um,hm,Nr,Dr,Ur,Wr,mm,fm,Br,Vr,Ts,wo,Po,Rr,ws,gm,Hr,_m,km,Kr,vm,bm,Qr,ym,Tm,Jr,Xr,Zr,Yr,wm,Pm,ei,ti,oi,ni,$m,xm,si,ai,ri,ii,zm,Fm,di,li,ci,pi,qm,Em,$o,Ps,Cm,xo,Mm,zo,$s,jm,Fo,td;return d=new Z({}),H=new Z({}),Te=new Z({}),Ko=new Z({}),Xo=new Z({}),tn=new Z({}),on=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_pegasus.py#L1190",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_pegasus.py#L1357",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_pegasus.py#L1549",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1193",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
`}}),io=new Uo({props:{$$slots:{default:[nk]},$$scope:{ctx:z}}}),lo=new Ke({props:{anchor:"transformers.TFPegasusModel.call.example",$$slots:{default:[sk]},$$scope:{ctx:z}}}),Kn=new Z({}),Qn=new M({props:{name:"class transformers.TFPegasusForConditionalGeneration",anchor:"transformers.TFPegasusForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17634/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1268"}}),po=new Uo({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),Yn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_17634/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17634/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1301",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
`}}),bo=new Ke({props:{anchor:"transformers.FlaxPegasusModel.decode.example",$$slots:{default:[pk]},$$scope:{ctx:z}}}),us=new Z({}),hs=new M({props:{name:"class transformers.FlaxPegasusForConditionalGeneration",anchor:"transformers.FlaxPegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17634/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17634/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17634/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`}}),Fo=new Ke({props:{anchor:"transformers.FlaxPegasusForConditionalGeneration.decode.example",$$slots:{default:[mk]},$$scope:{ctx:z}}}),{c(){u=n("meta"),v=l(),_=n("h1"),h=n("a"),k=n("span"),b(d.$$.fragment),m=l(),F=n("span"),Oe=r("Pegasus"),he=l(),E=n("p"),ke=n("strong"),ae=r("DISCLAIMER:"),Ae=r(" If you see something strange, file a "),re=n("a"),ie=r("Github Issue"),Ie=r(`
and assign @patrickvonplaten.`),xe=l(),D=n("h2"),A=n("a"),ve=n("span"),b(H.$$.fragment),S=l(),O=n("span"),Le=r("Overview"),Y=l(),ee=n("p"),Ge=r("The Pegasus model was proposed in "),U=n("a"),Ne=r("PEGASUS: Pre-training with Extracted Gap-sentences for Abstractive Summarization"),De=r(" by Jingqing Zhang, Yao Zhao, Mohammad Saleh and Peter J. Liu on Dec 18, 2019."),I=l(),me=n("p"),de=r("According to the abstract,"),ze=l(),te=n("ul"),K=n("li"),Ue=r(`Pegasus\u2019 pretraining task is intentionally similar to summarization: important sentences are removed/masked from an
...
documentation from `),Ss=n("a"),gc=r("PretrainedConfig"),_c=r(" for more information."),kc=l(),b(Ut.$$.fragment),Ai=l(),kt=n("h2"),Wt=n("a"),Aa=n("span"),b(rn.$$.fragment),vc=l(),Ia=n("span"),bc=r("PegasusTokenizer"),Ii=l(),Bt=n("p"),yc=r("warning: "),La=n("code"),Tc=r("add_tokens"),wc=r(" does not work at the moment."),Li=l(),B=n("div"),b(dn.$$.fragment),Pc=l(),ln=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),cn=n("a"),xc=r("SentencePiece"),zc=r("."),Fc=l(),pn=n("p"),qc=r("This tokenizer inherits from "),Os=n("a"),Ec=r("PreTrainedTokenizer"),Cc=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Mc=l(),Fe=n("div"),b(un.$$.fragment),jc=l(),hn=n("p"),Sc=r(`Build model inputs from a sequence or a pair of sequences for sequence classification tasks by concatenating
...
separator.`),Rc=l(),Vt=n("div"),b(gn.$$.fragment),Hc=l(),Wa=n("p"),Kc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),Rt=n("div"),b(_n.$$.fragment),Jc=l(),Ba=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),Ht=n("div"),b(kn.$$.fragment),Yc=l(),Va=n("p"),ep=r("Just EOS"),Gi=l(),vt=n("h2"),Kt=n("a"),Ra=n("span"),b(vn.$$.fragment),tp=l(),Ha=n("span"),op=r("PegasusTokenizerFast"),Ni=l(),ce=n("div"),b(bn.$$.fragment),np=l(),bt=n("p"),sp=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ka=n("em"),ap=r("tokenizers"),rp=r(` library). Based on
...
This model inherits from `),Gs=n("a"),Ep=r("PreTrainedModel"),Cp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp=l(),En=n("p"),jp=r("This model is also a PyTorch "),Cn=n("a"),Sp=r("torch.nn.Module"),Op=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ap=l(),qe=n("div"),b(Mn.$$.fragment),Ip=l(),Tt=n("p"),Lp=r("The "),Ns=n("a"),Gp=r("PegasusModel"),Np=r(" forward method, overrides the "),tr=n("code"),Dp=r("__call__"),Up=r(" special method."),Wp=l(),b(Xt.$$.fragment),Bp=l(),b(Zt.$$.fragment),Wi=l(),wt=n("h2"),Yt=n("a"),or=n("span"),b(jn.$$.fragment),Vp=l(),nr=n("span"),Rp=r("PegasusForConditionalGeneration"),Bi=l(),$e=n("div"),b(Sn.$$.fragment),Hp=l(),On=n("p"),Kp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tu=l(),Ee=n("div"),b(Ln.$$.fragment),ou=l(),Pt=n("p"),nu=r("The "),Us=n("a"),su=r("PegasusForConditionalGeneration"),au=r(" forward method, overrides the "),sr=n("code"),ru=r("__call__"),iu=r(" special method."),du=l(),b(eo.$$.fragment),lu=l(),b(to.$$.fragment),Vi=l(),$t=n("h2"),oo=n("a"),ar=n("span"),b(Gn.$$.fragment),cu=l(),rr=n("span"),pu=r("PegasusForCausalLM"),Ri=l(),xt=n("div"),b(Nn.$$.fragment),uu=l(),no=n("div"),b(Dn.$$.fragment),hu=l(),b(so.$$.fragment),Hi=l(),zt=n("h2"),ao=n("a"),ir=n("span"),b(Un.$$.fragment),mu=l(),dr=n("span"),fu=r("TFPegasusModel"),Ki=l(),pe=n("div"),b(Wn.$$.fragment),gu=l(),Bn=n("p"),_u=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bu=l(),Vn=n("p"),yu=r("This model is also a "),Rn=n("a"),Tu=r("tf.keras.Model"),wu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pu=l(),b(ro.$$.fragment),$u=l(),Ce=n("div"),b(Hn.$$.fragment),xu=l(),Ft=n("p"),zu=r("The "),Bs=n("a"),Fu=r("TFPegasusModel"),qu=r(" forward method, overrides the "),lr=n("code"),Eu=r("__call__"),Cu=r(" special method."),Mu=l(),b(io.$$.fragment),ju=l(),b(lo.$$.fragment),Qi=l(),qt=n("h2"),co=n("a"),cr=n("span"),b(Kn.$$.fragment),Su=l(),pr=n("span"),Ou=r("TFPegasusForConditionalGeneration"),Ji=l(),ue=n("div"),b(Qn.$$.fragment),Au=l(),Jn=n("p"),Iu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Vs=n("a"),Lu=r("TFPreTrainedModel"),Gu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu=l(),Xn=n("p"),Du=r("This model is also a "),Zn=n("a"),Uu=r("tf.keras.Model"),Wu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu=l(),b(po.$$.fragment),Vu=l(),Me=n("div"),b(Yn.$$.fragment),Ru=l(),Et=n("p"),Hu=r("The "),Rs=n("a"),Ku=r("TFPegasusForConditionalGeneration"),Qu=r(" forward method, overrides the "),ur=n("code"),Ju=r("__call__"),Xu=r(" special method."),Zu=l(),b(uo.$$.fragment),Yu=l(),b(ho.$$.fragment),Xi=l(),Ct=n("h2"),mo=n("a"),hr=n("span"),b(es.$$.fragment),eh=l(),mr=n("span"),th=r("FlaxPegasusModel"),Zi=l(),G=n("div"),b(ts.$$.fragment),oh=l(),os=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ch=l(),fr=n("p"),ph=r("Finally, this model supports inherent JAX features such as:"),uh=l(),Re=n("ul"),gr=n("li"),as=n("a"),hh=r("Just-In-Time (JIT) compilation"),mh=l(),_r=n("li"),rs=n("a"),fh=r("Automatic Differentiation"),gh=l(),kr=n("li"),is=n("a"),_h=r("Vectorization"),kh=l(),vr=n("li"),ds=n("a"),vh=r("Parallelization"),bh=l(),je=n("div"),b(ls.$$.fragment),yh=l(),Mt=n("p"),Th=r("The "),br=n("code"),wh=r("FlaxPegasusPreTrainedModel"),Ph=r(" forward method, overrides the "),yr=n("code"),$h=r("__call__"),xh=r(" special method."),zh=l(),b(fo.$$.fragment),Fh=l(),b(go.$$.fragment),qh=l(),_o=n("div"),b(cs.$$.fragment),Eh=l(),b(ko.$$.fragment),Ch=l(),vo=n("div"),b(ps.$$.fragment),Mh=l(),b(bo.$$.fragment),Yi=l(),jt=n("h2"),yo=n("a"),Tr=n("span"),b(us.$$.fragment),jh=l(),wr=n("span"),Sh=r("FlaxPegasusForConditionalGeneration"),ed=l(),N=n("div"),b(hs.$$.fragment),Oh=l(),ms=n("p"),Ah=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wh=l(),Pr=n("p"),Bh=r("Finally, this model supports inherent JAX features such as:"),Vh=l(),He=n("ul"),$r=n("li"),_s=n("a"),Rh=r("Just-In-Time (JIT) compilation"),Hh=l(),xr=n("li"),ks=n("a"),Kh=r("Automatic Differentiation"),Qh=l(),zr=n("li"),vs=n("a"),Jh=r("Vectorization"),Xh=l(),Fr=n("li"),bs=n("a"),Zh=r("Parallelization"),Yh=l(),C=n("div"),b(ys.$$.fragment),em=l(),St=n("p"),tm=r("The "),qr=n("code"),om=r("FlaxPegasusPreTrainedModel"),nm=r(" forward method, overrides the "),Er=n("code"),sm=r("__call__"),am=r(" special method."),rm=l(),b(To.$$.fragment),im=l(),Cr=n("p"),dm=r("Summarization example:"),lm=l(),Mr=n("blockquote"),jr=n("blockquote"),Sr=n("blockquote"),Or=n("p"),cm=r("from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),pm=l(),Ar=n("blockquote"),Ir=n("blockquote"),Lr=n("blockquote"),Gr=n("p"),um=r(`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),Br=n("blockquote"),Vr=n("blockquote"),Ts=n("blockquote"),wo=n("h1"),Po=n("a"),Rr=n("span"),b(ws.$$.fragment),gm=l(),Hr=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),Kr=n("p"),vm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),bm=l(),Qr=n("p"),ym=r("Mask filling example:"),Tm=l(),Jr=n("blockquote"),Xr=n("blockquote"),Zr=n("blockquote"),Yr=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
`),la=s(Qs,"EM",{});var Um=a(la);el=i(Um,"pegasus-large"),Um.forEach(t),tl=i(Qs,", whence the other checkpoints are fine-tuned:"),Qs.forEach(t),zi=c(o),fe=s(o,"UL",{});var et=a(fe);ca=s(et,"LI",{});var Wm=a(ca);ol=i(Wm,"Each checkpoint is 2.2 GB on disk and 568M parameters."),Wm.forEach(t),nl=c(et),pa=s(et,"LI",{});var Bm=a(pa);sl=i(Bm,"FP16 is not supported (help/ideas on this appreciated!)."),Bm.forEach(t),al=c(et),ua=s(et,"LI",{});var Vm=a(ua);rl=i(Vm,"Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),Vm.forEach(t),il=c(et),Bo=s(et,"LI",{});var nd=a(Bo);dl=i(nd,"Full replication results and correctly pre-processed data can be found in this "),Vo=s(nd,"A",{href:!0,rel:!0});var Rm=a(Vo);ll=i(Rm,"Issue"),Rm.forEach(t),cl=i(nd,"."),nd.forEach(t),pl=c(et),At=s(et,"LI",{});var $i=a(At);Ro=s($i,"A",{href:!0,rel:!0});var Hm=a(Ro);ul=i(Hm,"Distilled checkpoints"),Hm.forEach(t),hl=i($i," are described in this "),Ho=s($i,"A",{href:!0,rel:!0});var Km=a(Ho);ml=i(Km,"paper"),Km.forEach(t),fl=i($i,"."),$i.forEach(t),et.forEach(t),Fi=c(o),ct=s(o,"H3",{class:!0});var sd=a(ct);It=s(sd,"A",{id:!0,class:!0,href:!0});var Qm=a(It);ha=s(Qm,"SPAN",{});var Jm=a(ha);y(Ko.$$.fragment,Jm),Jm.forEach(t),Qm.forEach(t),gl=c(sd),ma=s(sd,"SPAN",{});var Xm=a(ma);_l=i(Xm,"Examples"),Xm.forEach(t),sd.forEach(t),qi=c(o),Ze=s(o,"UL",{});var Js=a(Ze);Lt=s(Js,"LI",{});var xi=a(Lt);Qo=s(xi,"A",{href:!0,rel:!0});var Zm=a(Qo);kl=i(Zm,"Script"),Zm.forEach(t),vl=i(xi,` to fine-tune pegasus
on the XSUM dataset. Data download instructions at `),Jo=s(xi,"A",{href:!0,rel:!0});var Ym=a(Jo);bl=i(Ym,"examples/pytorch/summarization/"),Ym.forEach(t),yl=i(xi,"."),xi.forEach(t),Tl=c(Js),fa=s(Js,"LI",{});var ef=a(fa);wl=i(ef,"FP16 is not supported (help/ideas on this appreciated!)."),ef.forEach(t),Pl=c(Js),ga=s(Js,"LI",{});var tf=a(ga);$l=i(tf,"The adafactor optimizer is recommended for pegasus fine-tuning."),tf.forEach(t),Js.forEach(t),Ei=c(o),pt=s(o,"H2",{class:!0});var ad=a(pt);Gt=s(ad,"A",{id:!0,class:!0,href:!0});var of=a(Gt);_a=s(of,"SPAN",{});var nf=a(_a);y(Xo.$$.fragment,nf),nf.forEach(t),of.forEach(t),xl=c(ad),ka=s(ad,"SPAN",{});var sf=a(ka);zl=i(sf,"Implementation Notes"),sf.forEach(t),ad.forEach(t),Ci=c(o),ge=s(o,"UL",{});var tt=a(ge);va=s(tt,"LI",{});var af=a(va);ba=s(af,"P",{});var rf=a(ba);Fl=i(rf,"All models are transformer encoder-decoders with 16 layers in each component."),rf.forEach(t),af.forEach(t),ql=c(tt),ya=s(tt,"LI",{});var df=a(ya);Es=s(df,"P",{});var Sm=a(Es);El=i(Sm,"The implementation is completely inherited from "),Cs=s(Sm,"A",{href:!0});var lf=a(Cs);Cl=i(lf,"BartForConditionalGeneration"),lf.forEach(t),Sm.forEach(t),df.forEach(t),Ml=c(tt),Zo=s(tt,"LI",{});var rd=a(Zo);Ta=s(rd,"P",{});var cf=a(Ta);jl=i(cf,"Some key configuration differences:"),cf.forEach(t),Sl=c(rd),ut=s(rd,"UL",{});var Xs=a(ut);wa=s(Xs,"LI",{});var pf=a(wa);Ol=i(pf,"static, sinusoidal position embeddings"),pf.forEach(t),Al=c(Xs),Pa=s(Xs,"LI",{});var uf=a(Pa);Il=i(uf,"the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),uf.forEach(t),Ll=c(Xs),Yo=s(Xs,"LI",{});var id=a(Yo);Gl=i(id,"more beams are used ("),$a=s(id,"CODE",{});var hf=a($a);Nl=i(hf,"num_beams=8"),hf.forEach(t),Dl=i(id,")"),id.forEach(t),Xs.forEach(t),rd.forEach(t),Ul=c(tt),xa=s(tt,"LI",{});var mf=a(xa);Ve=s(mf,"P",{});var Eo=a(Ve);Wl=i(Eo,"All pretrained pegasus checkpoints are the same besides three attributes: "),za=s(Eo,"CODE",{});var ff=a(za);Bl=i(ff,"tokenizer.model_max_length"),ff.forEach(t),Vl=i(Eo,` (maximum
input size), `),Fa=s(Eo,"CODE",{});var gf=a(Fa);Rl=i(gf,"max_length"),gf.forEach(t),Hl=i(Eo," (the maximum number of tokens to generate) and "),qa=s(Eo,"CODE",{});var _f=a(qa);Kl=i(_f,"length_penalty"),_f.forEach(t),Ql=i(Eo,"."),Eo.forEach(t),mf.forEach(t),Jl=c(tt),Ea=s(tt,"LI",{});var kf=a(Ea);ht=s(kf,"P",{});var Zs=a(ht);Xl=i(Zs,"The code to convert checkpoints trained in the author\u2019s "),en=s(Zs,"A",{href:!0,rel:!0});var vf=a(en);Zl=i(vf,"repo"),vf.forEach(t),Yl=i(Zs,` can be
found in `),Ca=s(Zs,"CODE",{});var bf=a(Ca);ec=i(bf,"convert_pegasus_tf_to_pytorch.py"),bf.forEach(t),tc=i(Zs,"."),Zs.forEach(t),kf.forEach(t),tt.forEach(t),Mi=c(o),mt=s(o,"H2",{class:!0});var dd=a(mt);Nt=s(dd,"A",{id:!0,class:!0,href:!0});var yf=a(Nt);Ma=s(yf,"SPAN",{});var Tf=a(Ma);y(tn.$$.fragment,Tf),Tf.forEach(t),yf.forEach(t),oc=c(dd),ja=s(dd,"SPAN",{});var wf=a(ja);nc=i(wf,"Usage Example"),wf.forEach(t),dd.forEach(t),ji=c(o),y(on.$$.fragment,o),Si=c(o),ft=s(o,"H2",{class:!0});var ld=a(ft);Dt=s(ld,"A",{id:!0,class:!0,href:!0});var Pf=a(Dt);Sa=s(Pf,"SPAN",{});var $f=a(Sa);y(nn.$$.fragment,$f),$f.forEach(t),Pf.forEach(t),sc=c(ld),Oa=s(ld,"SPAN",{});var xf=a(Oa);ac=i(xf,"PegasusConfig"),xf.forEach(t),ld.forEach(t),Oi=c(o),we=s(o,"DIV",{class:!0});var Co=a(we);y(sn.$$.fragment,Co),rc=c(Co),gt=s(Co,"P",{});var Ys=a(gt);ic=i(Ys,"This is the configuration class to store the configuration of a "),Ms=s(Ys,"A",{href:!0});var zf=a(Ms);dc=i(zf,"PegasusModel"),zf.forEach(t),lc=i(Ys,`. It is used to instantiate an
PEGASUS model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PEGASUS
`),an=s(Ys,"A",{href:!0,rel:!0});var Ff=a(an);cc=i(Ff,"google/pegasus-large"),Ff.forEach(t),pc=i(Ys," architecture."),Ys.forEach(t),uc=c(Co),_t=s(Co,"P",{});var ea=a(_t);hc=i(ea,"Configuration objects inherit from "),js=s(ea,"A",{href:!0});var qf=a(js);mc=i(qf,"PretrainedConfig"),qf.forEach(t),fc=i(ea,` and can be used to control the model outputs. Read the
documentation from `),Ss=s(ea,"A",{href:!0});var Ef=a(Ss);gc=i(Ef,"PretrainedConfig"),Ef.forEach(t),_c=i(ea," for more information."),ea.forEach(t),kc=c(Co),y(Ut.$$.fragment,Co),Co.forEach(t),Ai=c(o),kt=s(o,"H2",{class:!0});var cd=a(kt);Wt=s(cd,"A",{id:!0,class:!0,href:!0});var Cf=a(Wt);Aa=s(Cf,"SPAN",{});var Mf=a(Aa);y(rn.$$.fragment,Mf),Mf.forEach(t),Cf.forEach(t),vc=c(cd),Ia=s(cd,"SPAN",{});var jf=a(Ia);bc=i(jf,"PegasusTokenizer"),jf.forEach(t),cd.forEach(t),Ii=c(o),Bt=s(o,"P",{});var pd=a(Bt);yc=i(pd,"warning: "),La=s(pd,"CODE",{});var Sf=a(La);Tc=i(Sf,"add_tokens"),Sf.forEach(t),wc=i(pd," does not work at the moment."),pd.forEach(t),Li=c(o),B=s(o,"DIV",{class:!0});var _e=a(B);y(dn.$$.fragment,_e),Pc=c(_e),ln=s(_e,"P",{});var ud=a(ln);$c=i(ud,"Construct a PEGASUS tokenizer. Based on "),cn=s(ud,"A",{href:!0,rel:!0});var Of=a(cn);xc=i(Of,"SentencePiece"),Of.forEach(t),zc=i(ud,"."),ud.forEach(t),Fc=c(_e),pn=s(_e,"P",{});var hd=a(pn);qc=i(hd,"This tokenizer inherits from "),Os=s(hd,"A",{href:!0});var Af=a(Os);Ec=i(Af,"PreTrainedTokenizer"),Af.forEach(t),Cc=i(hd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),hd.forEach(t),Mc=c(_e),Fe=s(_e,"DIV",{class:!0});var Mo=a(Fe);y(un.$$.fragment,Mo),jc=c(Mo),hn=s(Mo,"P",{});var md=a(hn);Sc=i(md,`Build model inputs from a sequence or a pair of sequences for sequence classification tasks by concatenating
...
separator.`),Nf.forEach(t),Mo.forEach(t),Rc=c(_e),Vt=s(_e,"DIV",{class:!0});var _d=a(Vt);y(gn.$$.fragment,_d),Hc=c(_d),Wa=s(_d,"P",{});var Df=a(Wa);Kc=i(Df,"Converts a sequence of tokens (string) in a single string."),Df.forEach(t),_d.forEach(t),Qc=c(_e),Rt=s(_e,"DIV",{class:!0});var kd=a(Rt);y(_n.$$.fragment,kd),Jc=c(kd),Ba=s(kd,"P",{});var Uf=a(Ba);Xc=i(Uf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Uf.forEach(t),kd.forEach(t),Zc=c(_e),Ht=s(_e,"DIV",{class:!0});var vd=a(Ht);y(kn.$$.fragment,vd),Yc=c(vd),Va=s(vd,"P",{});var Wf=a(Va);ep=i(Wf,"Just EOS"),Wf.forEach(t),vd.forEach(t),_e.forEach(t),Gi=c(o),vt=s(o,"H2",{class:!0});var bd=a(vt);Kt=s(bd,"A",{id:!0,class:!0,href:!0});var Bf=a(Kt);Ra=s(Bf,"SPAN",{});var Vf=a(Ra);y(vn.$$.fragment,Vf),Vf.forEach(t),Bf.forEach(t),tp=c(bd),Ha=s(bd,"SPAN",{});var Rf=a(Ha);op=i(Rf,"PegasusTokenizerFast"),Rf.forEach(t),bd.forEach(t),Ni=c(o),ce=s(o,"DIV",{class:!0});var ot=a(ce);y(bn.$$.fragment,ot),np=c(ot),bt=s(ot,"P",{});var ta=a(bt);sp=i(ta,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ka=s(ta,"EM",{});var Hf=a(Ka);ap=i(Hf,"tokenizers"),Hf.forEach(t),rp=i(ta,` library). Based on
`),yn=s(ta,"A",{href:!0,rel:!0});var Kf=a(yn);ip=i(Kf,"Unigram"),Kf.forEach(t),dp=i(ta,"."),ta.forEach(t),lp=c(ot),Tn=s(ot,"P",{});var yd=a(Tn);cp=i(yd,"This tokenizer inherits from "),Is=s(yd,"A",{href:!0});var Qf=a(Is);pp=i(Qf,"PreTrainedTokenizerFast"),Qf.forEach(t),up=i(yd,` which contains most of the main methods. Users should
...
This model inherits from `),Gs=s(xd,"A",{href:!0});var ng=a(Gs);Ep=i(ng,"PreTrainedModel"),ng.forEach(t),Cp=i(xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xd.forEach(t),Mp=c(jo),En=s(jo,"P",{});var zd=a(En);jp=i(zd,"This model is also a PyTorch "),Cn=s(zd,"A",{href:!0,rel:!0});var sg=a(Cn);Sp=i(sg,"torch.nn.Module"),sg.forEach(t),Op=i(zd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zd.forEach(t),Ap=c(jo),qe=s(jo,"DIV",{class:!0});var So=a(qe);y(Mn.$$.fragment,So),Ip=c(So),Tt=s(So,"P",{});var na=a(Tt);Lp=i(na,"The "),Ns=s(na,"A",{href:!0});var ag=a(Ns);Gp=i(ag,"PegasusModel"),ag.forEach(t),Np=i(na," forward method, overrides the "),tr=s(na,"CODE",{});var rg=a(tr);Dp=i(rg,"__call__"),rg.forEach(t),Up=i(na," special method."),na.forEach(t),Wp=c(So),y(Xt.$$.fragment,So),Bp=c(So),y(Zt.$$.fragment,So),So.forEach(t),jo.forEach(t),Wi=c(o),wt=s(o,"H2",{class:!0});var Fd=a(wt);Yt=s(Fd,"A",{id:!0,class:!0,href:!0});var ig=a(Yt);or=s(ig,"SPAN",{});var dg=a(or);y(jn.$$.fragment,dg),dg.forEach(t),ig.forEach(t),Vp=c(Fd),nr=s(Fd,"SPAN",{});var lg=a(nr);Rp=i(lg,"PegasusForConditionalGeneration"),lg.forEach(t),Fd.forEach(t),Bi=c(o),$e=s(o,"DIV",{class:!0});var Oo=a($e);y(Sn.$$.fragment,Oo),Hp=c(Oo),On=s(Oo,"P",{});var qd=a(On);Kp=i(qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed.forEach(t),tu=c(Oo),Ee=s(Oo,"DIV",{class:!0});var Ao=a(Ee);y(Ln.$$.fragment,Ao),ou=c(Ao),Pt=s(Ao,"P",{});var sa=a(Pt);nu=i(sa,"The "),Us=s(sa,"A",{href:!0});var ug=a(Us);su=i(ug,"PegasusForConditionalGeneration"),ug.forEach(t),au=i(sa," forward method, overrides the "),sr=s(sa,"CODE",{});var hg=a(sr);ru=i(hg,"__call__"),hg.forEach(t),iu=i(sa," special method."),sa.forEach(t),du=c(Ao),y(eo.$$.fragment,Ao),lu=c(Ao),y(to.$$.fragment,Ao),Ao.forEach(t),Oo.forEach(t),Vi=c(o),$t=s(o,"H2",{class:!0});var Cd=a($t);oo=s(Cd,"A",{id:!0,class:!0,href:!0});var mg=a(oo);ar=s(mg,"SPAN",{});var fg=a(ar);y(Gn.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cu=c(Cd),rr=s(Cd,"SPAN",{});var gg=a(rr);pu=i(gg,"PegasusForCausalLM"),gg.forEach(t),Cd.forEach(t),Ri=c(o),xt=s(o,"DIV",{class:!0});var Md=a(xt);y(Nn.$$.fragment,Md),uu=c(Md),no=s(Md,"DIV",{class:!0});var jd=a(no);y(Dn.$$.fragment,jd),hu=c(jd),y(so.$$.fragment,jd),jd.forEach(t),Md.forEach(t),Hi=c(o),zt=s(o,"H2",{class:!0});var Sd=a(zt);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var _g=a(ao);ir=s(_g,"SPAN",{});var kg=a(ir);y(Un.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mu=c(Sd),dr=s(Sd,"SPAN",{});var vg=a(dr);fu=i(vg,"TFPegasusModel"),vg.forEach(t),Sd.forEach(t),Ki=c(o),pe=s(o,"DIV",{class:!0});var nt=a(pe);y(Wn.$$.fragment,nt),gu=c(nt),Bn=s(nt,"P",{});var Od=a(Bn);_u=i(Od,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Od.forEach(t),bu=c(nt),Vn=s(nt,"P",{});var Ad=a(Vn);yu=i(Ad,"This model is also a "),Rn=s(Ad,"A",{href:!0,rel:!0});var yg=a(Rn);Tu=i(yg,"tf.keras.Model"),yg.forEach(t),wu=i(Ad,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ad.forEach(t),Pu=c(nt),y(ro.$$.fragment,nt),$u=c(nt),Ce=s(nt,"DIV",{class:!0});var Io=a(Ce);y(Hn.$$.fragment,Io),xu=c(Io),Ft=s(Io,"P",{});var aa=a(Ft);zu=i(aa,"The "),Bs=s(aa,"A",{href:!0});var Tg=a(Bs);Fu=i(Tg,"TFPegasusModel"),Tg.forEach(t),qu=i(aa," forward method, overrides the "),lr=s(aa,"CODE",{});var wg=a(lr);Eu=i(wg,"__call__"),wg.forEach(t),Cu=i(aa," special method."),aa.forEach(t),Mu=c(Io),y(io.$$.fragment,Io),ju=c(Io),y(lo.$$.fragment,Io),Io.forEach(t),nt.forEach(t),Qi=c(o),qt=s(o,"H2",{class:!0});var Id=a(qt);co=s(Id,"A",{id:!0,class:!0,href:!0});var Pg=a(co);cr=s(Pg,"SPAN",{});var $g=a(cr);y(Kn.$$.fragment,$g),$g.forEach(t),Pg.forEach(t),Su=c(Id),pr=s(Id,"SPAN",{});var xg=a(pr);Ou=i(xg,"TFPegasusForConditionalGeneration"),xg.forEach(t),Id.forEach(t),Ji=c(o),ue=s(o,"DIV",{class:!0});var st=a(ue);y(Qn.$$.fragment,st),Au=c(st),Jn=s(st,"P",{});var Ld=a(Jn);Iu=i(Ld,`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Vs=s(Ld,"A",{href:!0});var zg=a(Vs);Lu=i(zg,"TFPreTrainedModel"),zg.forEach(t),Gu=i(Ld,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hd.forEach(t),Wh=c(se),Pr=s(se,"P",{});var Zg=a(Pr);Bh=i(Zg,"Finally, this model supports inherent JAX features such as:"),Zg.forEach(t),Vh=c(se),He=s(se,"UL",{});var Do=a(He);$r=s(Do,"LI",{});var Yg=a($r);_s=s(Yg,"A",{href:!0,rel:!0});var e_=a(_s);Rh=i(e_,"Just-In-Time (JIT) compilation"),e_.forEach(t),Yg.forEach(t),Hh=c(Do),xr=s(Do,"LI",{});var t_=a(xr);ks=s(t_,"A",{href:!0,rel:!0});var o_=a(ks);Kh=i(o_,"Automatic Differentiation"),o_.forEach(t),t_.forEach(t),Qh=c(Do),zr=s(Do,"LI",{});var n_=a(zr);vs=s(n_,"A",{href:!0,rel:!0});var s_=a(vs);Jh=i(s_,"Vectorization"),s_.forEach(t),n_.forEach(t),Xh=c(Do),Fr=s(Do,"LI",{});var a_=a(Fr);bs=s(a_,"A",{href:!0,rel:!0});var r_=a(bs);Zh=i(r_,"Parallelization"),r_.forEach(t),a_.forEach(t),Do.forEach(t),Yh=c(se),C=s(se,"DIV",{class:!0});var j=a(C);y(ys.$$.fragment,j),em=c(j),St=s(j,"P",{});var da=a(St);tm=i(da,"The "),qr=s(da,"CODE",{});var i_=a(qr);om=i(i_,"FlaxPegasusPreTrainedModel"),i_.forEach(t),nm=i(da," forward method, overrides the "),Er=s(da,"CODE",{});var d_=a(Er);sm=i(d_,"__call__"),d_.forEach(t),am=i(da," special method."),da.forEach(t),rm=c(j),y(To.$$.fragment,j),im=c(j),Cr=s(j,"P",{});var l_=a(Cr);dm=i(l_,"Summarization example:"),l_.forEach(t),lm=c(j),Mr=s(j,"BLOCKQUOTE",{});var c_=a(Mr);jr=s(c_,"BLOCKQUOTE",{});var p_=a(jr);Sr=s(p_,"BLOCKQUOTE",{});var u_=a(Sr);Or=s(u_,"P",{});var h_=a(Or);cm=i(h_,"from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),h_.forEach(t),u_.forEach(t),p_.forEach(t),c_.forEach(t),pm=c(j),Ar=s(j,"BLOCKQUOTE",{});var m_=a(Ar);Ir=s(m_,"BLOCKQUOTE",{});var f_=a(Ir);Lr=s(f_,"BLOCKQUOTE",{});var g_=a(Lr);Gr=s(g_,"P",{});var __=a(Gr);um=i(__,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),y_.forEach(t),b_.forEach(t),v_.forEach(t),k_.forEach(t),fm=c(j),Br=s(j,"BLOCKQUOTE",{});var T_=a(Br);Vr=s(T_,"BLOCKQUOTE",{});var w_=a(Vr);Ts=s(w_,"BLOCKQUOTE",{});var Kd=a(Ts);wo=s(Kd,"H1",{class:!0});var Qd=a(wo);Po=s(Qd,"A",{id:!0,class:!0,href:!0});var P_=a(Po);Rr=s(P_,"SPAN",{});var $_=a(Rr);y(ws.$$.fragment,$_),$_.forEach(t),P_.forEach(t),gm=c(Qd),Hr=s(Qd,"SPAN",{});var x_=a(Hr);_m=i(x_,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),x_.forEach(t),Qd.forEach(t),km=c(Kd),Kr=s(Kd,"P",{});var z_=a(Kr);vm=i(z_,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),z_.forEach(t),Kd.forEach(t),w_.forEach(t),T_.forEach(t),bm=c(j),Qr=s(j,"P",{});var F_=a(Qr);ym=i(F_,"Mask filling example:"),F_.forEach(t),Tm=c(j),Jr=s(j,"BLOCKQUOTE",{});var q_=a(Jr);Xr=s(q_,"BLOCKQUOTE",{});var E_=a(Xr);Zr=s(E_,"BLOCKQUOTE",{});var C_=a(Zr);Yr=s(C_,"P",{});var M_=a(Yr);wm=i(M_,`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),N_.forEach(t),G_.forEach(t),L_.forEach(t),I_.forEach(t),Fm=c(j),di=s(j,"BLOCKQUOTE",{});var D_=a(di);li=s(D_,"BLOCKQUOTE",{});var U_=a(li);ci=s(U_,"BLOCKQUOTE",{});var W_=a(ci);pi=s(W_,"P",{});var B_=a(pi);qm=i(B_,"tokenizer.decode(predictions).split()"),B_.forEach(t),W_.forEach(t),U_.forEach(t),D_.forEach(t),j.forEach(t),Em=c(se),$o=s(se,"DIV",{class:!0});var Jd=a($o);y(Ps.$$.fragment,Jd),Cm=c(Jd),y(xo.$$.fragment,Jd),Jd.forEach(t),Mm=c(se),zo=s(se,"DIV",{class:!0});var Xd=a(zo);y($s.$$.fragment,Xd),jm=c(Xd),y(Fo.$$.fragment,Xd),Xd.forEach(t),se.forEach(t),this.h()},h(){p(u,"name","hf:doc:metadata"),p(u,"content",JSON.stringify(gk)),p(h,"id","pegasus"),p(h,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(h,"href","#pegasus"),p(_,"class","relative group"),p(re,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),p(re,"rel","nofollow"),p(A,"id","overview"),p(A,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(A,"href","#overview"),p(D,"class","relative group"),p(U,"href","https://arxiv.org/pdf/1912.08777.pdf"),p(U,"rel","nofollow"),p(q,"href","https://huggingface.co/sshleifer"),p(q,"rel","nofollow"),p(ye,"href","https://github.com/google-research/pegasus"),p(ye,"rel","nofollow"),p(L,"id","checkpoints"),p(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(L,"href","#checkpoints"),p(le,"class","relative group"),p(Wo,"href","https://huggingface.co/models?search=pegasus"),p(Wo,"rel","nofollow"),p(Vo,"href","https://github.com/huggingface/transformers/issues/6844#issue-689259666"),p(Vo,"rel","nofollow"),p(Ro,"href","https://huggingface.co/models?search=distill-pegasus"),p(Ro,"rel","nofollow"),p(Ho,"href","https://arxiv.org/abs/2010.13002"),p(Ho,"rel","nofollow"),p(It,"id","examples"),p(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(It,"href","#examples"),p(ct,"class","relative group"),p(Qo,"href","https://github.com/huggingface/transformers/tree/main/examples/research_projects/seq2seq-distillation/finetune_pegasus_xsum.sh"),p(Qo,"rel","nofollow"),p(Jo,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization/README.md"),p(Jo,"rel","nofollow"),p(Gt,"id","implementation-notes"),p(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Gt,"href","#implementation-notes"),p(pt,"class","relative group"),p(Cs,"href","/docs/transformers/pr_17634/en/model_doc/bart#transformers.BartForConditionalGeneration"),p(en,"href","https://github.com/google-research/pegasus"),p(en,"rel","nofollow"),p(Nt,"id","usage-example"),p(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Nt,"href","#usage-example"),p(mt,"class","relative group"),p(Dt,"id","transformers.PegasusConfig"),p(Dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Dt,"href","#transformers.PegasusConfig"),p(ft,"class","relative group"),p(Ms,"href","/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusModel"),p(an,"href","https://huggingface.co/google/pegasus-large"),p(an,"rel","nofollow"),p(js,"href","/docs/transformers/pr_17634/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ss,"href","/docs/transformers/pr_17634/en/main_classes/configuration#transformers.PretrainedConfig"),p(we,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Wt,"id","transformers.PegasusTokenizer"),p(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Wt,"href","#transformers.PegasusTokenizer"),p(kt,"class","relative group"),p(cn,"href","https://github.com/google/sentencepiece"),p(cn,"rel","nofollow"),p(Os,"href","/docs/transformers/pr_17634/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Rt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Kt,"id","transformers.PegasusTokenizerFast"),p(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Kt,"href","#transformers.PegasusTokenizerFast"),p(vt,"class","relative group"),p(yn,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),p(yn,"rel","nofollow"),p(Is,"href","/docs/transformers/pr_17634/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),p(Ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Qt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Jt,"id","transformers.PegasusModel"),p(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Jt,"href","#transformers.PegasusModel"),p(yt,"class","relative group"),p(Gs,"href","/docs/transformers/pr_17634/en/main_classes/model#transformers.PreTrainedModel"),p(Cn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Cn,"rel","nofollow"),p(Ns,"href","/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusModel"),p(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Yt,"id","transformers.PegasusForConditionalGeneration"),p(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Yt,"href","#transformers.PegasusForConditionalGeneration"),p(wt,"class","relative group"),p(Ds,"href","/docs/transformers/pr_17634/en/main_classes/model#transformers.PreTrainedModel"),p(In,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(In,"rel","nofollow"),p(Us,"href","/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),p(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(oo,"id","transformers.PegasusForCausalLM"),p(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(oo,"href","#transformers.PegasusForCausalLM"),p($t,"class","relative group"),p(no,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(xt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ao,"id","transformers.TFPegasusModel"),p(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ao,"href","#transformers.TFPegasusModel"),p(zt,"class","relative group"),p(Ws,"href","/docs/transformers/pr_17634/en/main_classes/model#transformers.TFPreTrainedModel"),p(Rn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(Rn,"rel","nofollow"),p(Bs,"href","/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.TFPegasusModel"),p(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(co,"id","transformers.TFPegasusForConditionalGeneration"),p(co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(co,"href","#transformers.TFPegasusForConditionalGeneration"),p(qt,"class","relative group"),p(Vs,"href","/docs/transformers/pr_17634/en/main_classes/model#transformers.TFPreTrainedModel"),p(Zn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(Zn,"rel","nofollow"),p(Rs,"href","/docs/transformers/pr_17634/en/model_doc/pegasus#transformers.TFPegasusForConditionalGeneration"),p(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(mo,"id","transformers.FlaxPegasusModel"),p(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(mo,"href","#transformers.FlaxPegasusModel"),p(Ct,"class","relative group"),p(Hs,"href","/docs/transformers/pr_17634/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(ss,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(ss,"rel","nofollow"),p(as,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(as,"rel","nofollow"),p(rs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(rs,"rel","nofollow"),p(is,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(is,"rel","nofollow"),p(ds,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(ds,"rel","nofollow"),p(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(_o,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(vo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(yo,"id","transformers.FlaxPegasusForConditionalGeneration"),p(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(yo,"href","#transformers.FlaxPegasusForConditionalGeneration"),p(jt,"class","relative group"),p(Ks,"href","/docs/transformers/pr_17634/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(gs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(gs,"rel","nofollow"),p(_s,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(_s,"rel","nofollow"),p(ks,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(ks,"rel","nofollow"),p(vs,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(vs,"rel","nofollow"),p(bs,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(bs,"rel","nofollow"),p(Po,"id","generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),p(Po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Po,"href","#generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),p(wo,"class","relative group"),p(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p($o,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(zo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,u),f(o,v,g),f(o,_,g),e(_,h),e(h,k),T(d,k,null),e(_,m),e(_,F),e(F,Oe),f(o,he,g),f(o,E,g),e(E,ke),e(ke,ae),e(E,Ae),e(E,re),e(re,ie),e(E,Ie),f(o,xe,g),f(o,D,g),e(D,A),e(A,ve),T(H,ve,null),e(D,S),e(D,O),e(O,Le),f(o,Y,g),f(o,ee,g),e(ee,Ge),e(ee,U),e(U,Ne),e(ee,De),f(o,I,g),f(o,me,g),e(me,de),f(o,ze,g),f(o,te,g),e(te,K),e(K,Ue),e(te,We),e(te,W),e(W,Be),f(o,oe,g),f(o,V,g),e(V,x),e(V,q),e(q,be),e(V,at),e(V,ye),e(ye,Q),e(V,rt),f(o,Je,g),f(o,le,g),e(le,L),e(L,J),T(Te,J,null),e(le,it),e(le,X),e(X,dt),f(o,Xe,g),f(o,R,g),e(R,lt),e(R,Wo),e(Wo,Zd),e(R,Yd),e(R,la),e(la,el),e(R,tl),f(o,zi,g),f(o,fe,g),e(fe,ca),e(ca,ol),e(fe,nl),e(fe,pa),e(pa,sl),e(fe,al),e(fe,ua),e(ua,rl),e(fe,il),e(fe,Bo),e(Bo,dl),e(Bo,Vo),e(Vo,ll),e(Bo,cl),e(fe,pl),e(fe,At),e(At,Ro),e(Ro,ul),e(At,hl),e(At,Ho),e(Ho,ml),e(At,fl),f(o,Fi,g),f(o,ct,g),e(ct,It),e(It,ha),T(Ko,ha,null),e(ct,gl),e(ct,ma),e(ma,_l),f(o,qi,g),f(o,Ze,g),e(Ze,Lt),e(Lt,Qo),e(Qo,kl),e(Lt,vl),e(Lt,Jo),e(Jo,bl),e(Lt,yl),e(Ze,Tl),e(Ze,fa),e(fa,wl),e(Ze,Pl),e(Ze,ga),e(ga,$l),f(o,Ei,g),f(o,pt,g),e(pt,Gt),e(Gt,_a),T(Xo,_a,null),e(pt,xl),e(pt,ka),e(ka,zl),f(o,Ci,g),f(o,ge,g),e(ge,va),e(va,ba),e(ba,Fl),e(ge,ql),e(ge,ya),e(ya,Es),e(Es,El),e(Es,Cs),e(Cs,Cl),e(ge,Ml),e(ge,Zo),e(Zo,Ta),e(Ta,jl),e(Zo,Sl),e(Zo,ut),e(ut,wa),e(wa,Ol),e(ut,Al),e(ut,Pa),e(Pa,Il),e(ut,Ll),e(ut,Yo),e(Yo,Gl),e(Yo,$a),e($a,Nl),e(Yo,Dl),e(ge,Ul),e(ge,xa),e(xa,Ve),e(Ve,Wl),e(Ve,za),e(za,Bl),e(Ve,Vl),e(Ve,Fa),e(Fa,Rl),e(Ve,Hl),e(Ve,qa),e(qa,Kl),e(Ve,Ql),e(ge,Jl),e(ge,Ea),e(Ea,ht),e(ht,Xl),e(ht,en),e(en,Zl),e(ht,Yl),e(ht,Ca),e(Ca,ec),e(ht,tc),f(o,Mi,g),f(o,mt,g),e(mt,Nt),e(Nt,Ma),T(tn,Ma,null),e(mt,oc),e(mt,ja),e(ja,nc),f(o,ji,g),T(on,o,g),f(o,Si,g),f(o,ft,g),e(ft,Dt),e(Dt,Sa),T(nn,Sa,null),e(ft,sc),e(ft,Oa),e(Oa,ac),f(o,Oi,g),f(o,we,g),T(sn,we,null),e(we,rc),e(we,gt),e(gt,ic),e(gt,Ms),e(Ms,dc),e(gt,lc),e(gt,an),e(an,cc),e(gt,pc),e(we,uc),e(we,_t),e(_t,hc),e(_t,js),e(js,mc),e(_t,fc),e(_t,Ss),e(Ss,gc),e(_t,_c),e(we,kc),T(Ut,we,null),f(o,Ai,g),f(o,kt,g),e(kt,Wt),e(Wt,Aa),T(rn,Aa,null),e(kt,vc),e(kt,Ia),e(Ia,bc),f(o,Ii,g),f(o,Bt,g),e(Bt,yc),e(Bt,La),e(La,Tc),e(Bt,wc),f(o,Li,g),f(o,B,g),T(dn,B,null),e(B,Pc),e(B,ln),e(ln,$c),e(ln,cn),e(cn,xc),e(ln,zc),e(B,Fc),e(B,pn),e(pn,qc),e(pn,Os),e(Os,Ec),e(pn,Cc),e(B,Mc),e(B,Fe),T(un,Fe,null),e(Fe,jc),e(Fe,hn),e(hn,Sc),e(hn,Ga),e(Ga,Oc),e(hn,Ac),e(Fe,Ic),e(Fe,mn),e(mn,As),e(As,Lc),e(As,Na),e(Na,Gc),e(mn,Nc),e(mn,fn),e(fn,Dc),e(fn,Da),e(Da,Uc),e(fn,Wc),e(Fe,Bc),e(Fe,Ua),e(Ua,Vc),e(B,Rc),e(B,Vt),T(gn,Vt,null),e(Vt,Hc),e(Vt,Wa),e(Wa,Kc),e(B,Qc),e(B,Rt),T(_n,Rt,null),e(Rt,Jc),e(Rt,Ba),e(Ba,Xc),e(B,Zc),e(B,Ht),T(kn,Ht,null),e(Ht,Yc),e(Ht,Va),e(Va,ep),f(o,Gi,g),f(o,vt,g),e(vt,Kt),e(Kt,Ra),T(vn,Ra,null),e(vt,tp),e(vt,Ha),e(Ha,op),f(o,Ni,g),f(o,ce,g),T(bn,ce,null),e(ce,np),e(ce,bt),e(bt,sp),e(bt,Ka),e(Ka,ap),e(bt,rp),e(bt,yn),e(yn,ip),e(bt,dp),e(ce,lp),e(ce,Tn),e(Tn,cp),e(Tn,Is),e(Is,pp),e(Tn,up),e(ce,hp),e(ce,Ye),T(wn,Ye,null),e(Ye,mp),e(Ye,Qa),e(Qa,fp),e(Ye,gp),e(Ye,Pn),e(Pn,Ls),e(Ls,_p),e(Ls,Ja),e(Ja,kp),e(Pn,vp),e(Pn,$n),e($n,bp),e($n,Xa),e(Xa,yp),e($n,Tp),e(ce,wp),e(ce,Qt),T(xn,Qt,null),e(Qt,Pp),e(Qt,Za),e(Za,$p),f(o,Di,g),f(o,yt,g),e(yt,Jt),e(Jt,Ya),T(zn,Ya,null),e(yt,xp),e(yt,er),e(er,zp),f(o,Ui,g),f(o,Pe,g),T(Fn,Pe,null),e(Pe,Fp),e(Pe,qn),e(qn,qp),e(qn,Gs),e(Gs,Ep),e(qn,Cp),e(Pe,Mp),e(Pe,En),e(En,jp),e(En,Cn),e(Cn,Sp),e(En,Op),e(Pe,Ap),e(Pe,qe),T(Mn,qe,null),e(qe,Ip),e(qe,Tt),e(Tt,Lp),e(Tt,Ns),e(Ns,Gp),e(Tt,Np),e(Tt,tr),e(tr,Dp),e(Tt,Up),e(qe,Wp),T(Xt,qe,null),e(qe,Bp),T(Zt,qe,null),f(o,Wi,g),f(o,wt,g),e(wt,Yt),e(Yt,or),T(jn,or,null),e(wt,Vp),e(wt,nr),e(nr,Rp),f(o,Bi,g),f(o,$e,g),T(Sn,$e,null),e($e,Hp),e($e,On),e(On,Kp),e(On,Ds),e(Ds,Qp),e(On,Jp),e($e,Xp),e($e,An),e(An,Zp),e(An,In),e(In,Yp),e(An,eu),e($e,tu),e($e,Ee),T(Ln,Ee,null),e(Ee,ou),e(Ee,Pt),e(Pt,nu),e(Pt,Us),e(Us,su),e(Pt,au),e(Pt,sr),e(sr,ru),e(Pt,iu),e(Ee,du),T(eo,Ee,null),e(Ee,lu),T(to,Ee,null),f(o,Vi,g),f(o,$t,g),e($t,oo),e(oo,ar),T(Gn,ar,null),e($t,cu),e($t,rr),e(rr,pu),f(o,Ri,g),f(o,xt,g),T(Nn,xt,null),e(xt,uu),e(xt,no),T(Dn,no,null),e(no,hu),T(so,no,null),f(o,Hi,g),f(o,zt,g),e(zt,ao),e(ao,ir),T(Un,ir,null),e(zt,mu),e(zt,dr),e(dr,fu),f(o,Ki,g),f(o,pe,g),T(Wn,pe,null),e(pe,gu),e(pe,Bn),e(Bn,_u),e(Bn,Ws),e(Ws,ku),e(Bn,vu),e(pe,bu),e(pe,Vn),e(Vn,yu),e(Vn,Rn),e(Rn,Tu),e(Vn,wu),e(pe,Pu),T(ro,pe,null),e(pe,$u),e(pe,Ce),T(Hn,Ce,null),e(Ce,xu),e(Ce,Ft),e(Ft,zu),e(Ft,Bs),e(Bs,Fu),e(Ft,qu),e(Ft,lr),e(lr,Eu),e(Ft,Cu),e(Ce,Mu),T(io,Ce,null),e(Ce,ju),T(lo,Ce,null),f(o,Qi,g),f(o,qt,g),e(qt,co),e(co,cr),T(Kn,cr,null),e(qt,Su),e(qt,pr),e(pr,Ou),f(o,Ji,g),f(o,ue,g),T(Qn,ue,null),e(ue,Au),e(ue,Jn),e(Jn,Iu),e(Jn,Vs),e(Vs,Lu),e(Jn,Gu),e(ue,Nu),e(ue,Xn),e(Xn,Du),e(Xn,Zn),e(Zn,Uu),e(Xn,Wu),e(ue,Bu),T(po,ue,null),e(ue,Vu),e(ue,Me),T(Yn,Me,null),e(Me,Ru),e(Me,Et),e(Et,Hu),e(Et,Rs),e(Rs,Ku),e(Et,Qu),e(Et,ur),e(ur,Ju),e(Et,Xu),e(Me,Zu),T(uo,Me,null),e(Me,Yu),T(ho,Me,null),f(o,Xi,g),f(o,Ct,g),e(Ct,mo),e(mo,hr),T(es,hr,null),e(Ct,eh),e(Ct,mr),e(mr,th),f(o,Zi,g),f(o,G,g),T(ts,G,null),e(G,oh),e(G,os),e(os,nh),e(os,Hs),e(Hs,sh),e(os,ah),e(G,rh),e(G,ns),e(ns,ih),e(ns,ss),e(ss,dh),e(ns,lh),e(G,ch),e(G,fr),e(fr,ph),e(G,uh),e(G,Re),e(Re,gr),e(gr,as),e(as,hh),e(Re,mh),e(Re,_r),e(_r,rs),e(rs,fh),e(Re,gh),e(Re,kr),e(kr,is),e(is,_h),e(Re,kh),e(Re,vr),e(vr,ds),e(ds,vh),e(G,bh),e(G,je),T(ls,je,null),e(je,yh),e(je,Mt),e(Mt,Th),e(Mt,br),e(br,wh),e(Mt,Ph),e(Mt,yr),e(yr,$h),e(Mt,xh),e(je,zh),T(fo,je,null),e(je,Fh),T(go,je,null),e(G,qh),e(G,_o),T(cs,_o,null),e(_o,Eh),T(ko,_o,null),e(G,Ch),e(G,vo),T(ps,vo,null),e(vo,Mh),T(bo,vo,null),f(o,Yi,g),f(o,jt,g),e(jt,yo),e(yo,Tr),T(us,Tr,null),e(jt,jh),e(jt,wr),e(wr,Sh),f(o,ed,g),f(o,N,g),T(hs,N,null),e(N,Oh),e(N,ms),e(ms,Ah),e(ms,Ks),e(Ks,Ih),e(ms,Lh),e(N,Gh),e(N,fs),e(fs,Nh),e(fs,gs),e(gs,Dh),e(fs,Uh),e(N,Wh),e(N,Pr),e(Pr,Bh),e(N,Vh),e(N,He),e(He,$r),e($r,_s),e(_s,Rh),e(He,Hh),e(He,xr),e(xr,ks),e(ks,Kh),e(He,Qh),e(He,zr),e(zr,vs),e(vs,Jh),e(He,Xh),e(He,Fr),e(Fr,bs),e(bs,Zh),e(N,Yh),e(N,C),T(ys,C,null),e(C,em),e(C,St),e(St,tm),e(St,qr),e(qr,om),e(St,nm),e(St,Er),e(Er,sm),e(St,am),e(C,rm),T(To,C,null),e(C,im),e(C,Cr),e(Cr,dm),e(C,lm),e(C,Mr),e(Mr,jr),e(jr,Sr),e(Sr,Or),e(Or,cm),e(C,pm),e(C,Ar),e(Ar,Ir),e(Ir,Lr),e(Lr,Gr),e(Gr,um),e(C,hm),e(C,Nr),e(Nr,Dr),e(Dr,Ur),e(Ur,Wr),e(Wr,mm),e(C,fm),e(C,Br),e(Br,Vr),e(Vr,Ts),e(Ts,wo),e(wo,Po),e(Po,Rr),T(ws,Rr,null),e(wo,gm),e(wo,Hr),e(Hr,_m),e(Ts,km),e(Ts,Kr),e(Kr,vm),e(C,bm),e(C,Qr),e(Qr,ym),e(C,Tm),e(C,Jr),e(Jr,Xr),e(Xr,Zr),e(Zr,Yr),e(Yr,wm),e(C,Pm),e(C,ei),e(ei,ti),e(ti,oi),e(oi,ni),e(ni,$m),e(C,xm),e(C,si),e(si,ai),e(ai,ri),e(ri,ii),e(ii,zm),e(C,Fm),e(C,di),e(di,li),e(li,ci),e(ci,pi),e(pi,qm),e(N,Em),e(N,$o),T(Ps,$o,null),e($o,Cm),T(xo,$o,null),e(N,Mm),e(N,zo),T($s,zo,null),e(zo,jm),T(Fo,zo,null),td=!0},p(o,[g]){const xs={};g&2&&(xs.$$scope={dirty:g,ctx:o}),Ut.$set(xs);const ui={};g&2&&(ui.$$scope={dirty:g,ctx:o}),Xt.$set(ui);const hi={};g&2&&(hi.$$scope={dirty:g,ctx:o}),Zt.$set(hi);const mi={};g&2&&(mi.$$scope={dirty:g,ctx:o}),eo.$set(mi);const qo={};g&2&&(qo.$$scope={dirty:g,ctx:o}),to.$set(qo);const fi={};g&2&&(fi.$$scope={dirty:g,ctx:o}),so.$set(fi);const gi={};g&2&&(gi.$$scope={dirty:g,ctx:o}),ro.$set(gi);const zs={};g&2&&(zs.$$scope={dirty:g,ctx:o}),io.$set(zs);const _i={};g&2&&(_i.$$scope={dirty:g,ctx:o}),lo.$set(_i);const ki={};g&2&&(ki.$$scope={dirty:g,ctx:o}),po.$set(ki);const vi={};g&2&&(vi.$$scope={dirty:g,ctx:o}),uo.$set(vi);const Fs={};g&2&&(Fs.$$scope={dirty:g,ctx:o}),ho.$set(Fs);const bi={};g&2&&(bi.$$scope={dirty:g,ctx:o}),fo.$set(bi);const yi={};g&2&&(yi.$$scope={dirty:g,ctx:o}),go.$set(yi);const qs={};g&2&&(qs.$$scope={dirty:g,ctx:o}),ko.$set(qs);const Ti={};g&2&&(Ti.$$scope={dirty:g,ctx:o}),bo.$set(Ti);const wi={};g&2&&(wi.$$scope={dirty:g,ctx:o}),To.$set(wi);const Ot={};g&2&&(Ot.$$scope={dirty:g,ctx:o}),xo.$set(Ot);const Pi={};g&2&&(Pi.$$scope={dirty:g,ctx:o}),Fo.$set(Pi)},i(o){td||(w(d.$$.fragment,o),w(H.$$.fragment,o),w(Te.$$.fragment,o),w(Ko.$$.fragment,o),w(Xo.$$.fragment,o),w(tn.$$.fragment,o),w(on.$$.fragment,o),w(nn.$$.fragment,o),w(sn.$$.fragment,o),w(Ut.$$.fragment,o),w(rn.$$.fragment,o),w(dn.$$.fragment,o),w(un.$$.fragment,o),w(gn.$$.fragment,o),w(_n.$$.fragment,o),w(kn.$$.fragment,o),w(vn.$$.fragment,o),w(bn.$$.fragment,o),w(wn.$$.fragment,o),w(xn.$$.fragment,o),w(zn.$$.fragment,o),w(Fn.$$.fragment,o),w(Mn.$$.fragment,o),w(Xt.$$.fragment,o),w(Zt.$$.fragment,o),w(jn.$$.fragment,o),w(Sn.$$.fragment,o),w(Ln.$$.fragment,o),w(eo.$$.fragment,o),w(to.$$.fragment,o),w(Gn.$$.fragment,o),w(Nn.$$.fragment,o),w(Dn.$$.fragment,o),w(so.$$.fragment,o),w(Un.$$.fragment,o),w(Wn.$$.fragment,o),w(ro.$$.fragment,o),w(Hn.$$.fragment,o),w(io.$$.fragment,o),w(lo.$$.fragment,o),w(Kn.$$.fragment,o),w(Qn.$$.fragment,o),w(po.$$.fragment,o),w(Yn.$$.fragment,o),w(uo.$$.fragment,o),w(ho.$$.fragment,o),w(es.$$.fragment,o),w(ts.$$.fragment,o),w(ls.$$.fragment,o),w(fo.$$.fragment,o),w(go.$$.fragment,o),w(cs.$$.fragment,o),w(ko.$$.fragment,o),w(ps.$$.fragment,o),w(bo.$$.fragment,o),w(us.$$.fragment,o),w(hs.$$.fragment,o),w(ys.$$.fragment,o),w(To.$$.fragment,o),w(ws.$$.fragment,o),w(Ps.$$.fragment,o),w(xo.$$.fragment,o),w($s.$$.fragment,o),w(Fo.$$.fragment,o),td=!0)},o(o){P(d.$$.fragment,o),P(H.$$.fragment,o),P(Te.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(Ut.$$.fragment,o),P(rn.$$.fragment,o),P(dn.$$.fragment,o),P(un.$$.fragment,o),P(gn.$$.fragment,o),P(_n.$$.fragment,o),P(kn.$$.fragment,o),P(vn.$$.fragment,o),P(bn.$$.fragment,o),P(wn.$$.fragment,o),P(xn.$$.fragment,o),P(zn.$$.fragment,o),P(Fn.$$.fragment,o),P(Mn.$$.fragment,o),P(Xt.$$.fragment,o),P(Zt.$$.fragment,o),P(jn.$$.fragment,o),P(Sn.$$.fragment,o),P(Ln.$$.fragment,o),P(eo.$$.fragment,o),P(to.$$.fragment,o),P(Gn.$$.fragment,o),P(Nn.$$.fragment,o),P(Dn.$$.fragment,o),P(so.$$.fragment,o),P(Un.$$.fragment,o),P(Wn.$$.fragment,o),P(ro.$$.fragment,o),P(Hn.$$.fragment,o),P(io.$$.fragment,o),P(lo.$$.fragment,o),P(Kn.$$.fragment,o),P(Qn.$$.fragment,o),P(po.$$.fragment,o),P(Yn.$$.fragment,o),P(uo.$$.fragment,o),P(ho.$$.fragment,o),P(es.$$.fragment,o),P(ts.$$.fragment,o),P(ls.$$.fragment,o),P(fo.$$.fragment,o),P(go.$$.fragment,o),P(cs.$$.fragment,o),P(ko.$$.fragment,o),P(ps.$$.fragment,o),P(bo.$$.fragment,o),P(us.$$.fragment,o),P(hs.$$.fragment,o),P(ys.$$.fragment,o),P(To.$$.fragment,o),P(ws.$$.fragment,o),P(Ps.$$.fragment,o),P(xo.$$.fragment,o),P($s.$$.fragment,o),P(Fo.$$.fragment,o),td=!1},d(o){t(u),o&&t(v),o&&t(_),$(d),o&&t(he),o&&t(E),o&&t(xe),o&&t(D),$(H),o&&t(Y),o&&t(ee),o&&t(I),o&&t(me),o&&t(ze),o&&t(te),o&&t(oe),o&&t(V),o&&t(Je),o&&t(le),$(Te),o&&t(Xe),o&&t(R),o&&t(zi),o&&t(fe),o&&t(Fi),o&&t(ct),$(Ko),o&&t(qi),o&&t(Ze),o&&t(Ei),o&&t(pt),$(Xo),o&&t(Ci),o&&t(ge),o&&t(Mi),o&&t(mt),$(tn),o&&t(ji),$(on,o),o&&t(Si),o&&t(ft),$(nn),o&&t(Oi),o&&t(we),$(sn),$(Ut),o&&t(Ai),o&&t(kt),$(rn),o&&t(Ii),o&&t(Bt),o&&t(Li),o&&t(B),$(dn),$(un),$(gn),$(_n),$(kn),o&&t(Gi),o&&t(vt),$(vn),o&&t(Ni),o&&t(ce),$(bn),$(wn),$(xn),o&&t(Di),o&&t(yt),$(zn),o&&t(Ui),o&&t(Pe),$(Fn),$(Mn),$(Xt),$(Zt),o&&t(Wi),o&&t(wt),$(jn),o&&t(Bi),o&&t($e),$(Sn),$(Ln),$(eo),$(to),o&&t(Vi),o&&t($t),$(Gn),o&&t(Ri),o&&t(xt),$(Nn),$(Dn),$(so),o&&t(Hi),o&&t(zt),$(Un),o&&t(Ki),o&&t(pe),$(Wn),$(ro),$(Hn),$(io),$(lo),o&&t(Qi),o&&t(qt),$(Kn),o&&t(Ji),o&&t(ue),$(Qn),$(po),$(Yn),$(uo),$(ho),o&&t(Xi),o&&t(Ct),$(es),o&&t(Zi),o&&t(G),$(ts),$(ls),$(fo),$(go),$(cs),$(ko),$(ps),$(bo),o&&t(Yi),o&&t(jt),$(us),o&&t(ed),o&&t(N),$(hs),$(ys),$(To),$(ws),$(Ps),$(xo),$($s),$(Fo)}}}const gk={local:"pegasus",sections:[{local:"overview",title:"Overview"},{local:"checkpoints",sections:[{local:"examples",title:"Examples"}],title:"Checkpoints"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage-example",title:"Usage Example"},{local:"transformers.PegasusConfig",title:"PegasusConfig"},{local:"transformers.PegasusTokenizer",title:"PegasusTokenizer"},{local:"transformers.PegasusTokenizerFast",title:"PegasusTokenizerFast"},{local:"transformers.PegasusModel",title:"PegasusModel"},{local:"transformers.PegasusForConditionalGeneration",title:"PegasusForConditionalGeneration"},{local:"transformers.PegasusForCausalLM",title:"PegasusForCausalLM"},{local:"transformers.TFPegasusModel",title:"TFPegasusModel"},{local:"transformers.TFPegasusForConditionalGeneration",title:"TFPegasusForConditionalGeneration"},{local:"transformers.FlaxPegasusModel",title:"FlaxPegasusModel"},{local:"transformers.FlaxPegasusForConditionalGeneration",title:"FlaxPegasusForConditionalGeneration"}],title:"Pegasus"};function _k(z){return Q_(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Pk extends V_{constructor(u){super();R_(this,u,_k,fk,H_,{})}}export{Pk as default,gk as metadata};
