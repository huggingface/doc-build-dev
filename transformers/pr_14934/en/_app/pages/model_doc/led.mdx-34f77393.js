import{S as Cf,i as Of,s as Pf,e as n,k as i,w as f,t as r,M as Af,c as s,d as t,m as l,a,x as _,h as d,b as c,F as e,g as h,y as g,q as v,o as T,B as k,v as Nf}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as $}from"../../chunks/Docstring-abef54e3.js";import{C as Ne}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _e}from"../../chunks/IconCopyLink-7a11ce68.js";function jf(G){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function If(G){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Gf(G){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Bf(G){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Qf(G){let u,L,b,E,q,y,w,D,je,ge,z,Y,R,ne,Ie,V,Ge,Me,B,K,se,Le,S,P,ve,ae,Se,Te,X,Be,Ce,C,Qe,ee,x,M,Q,He,We,j,Ue,re,De;return{c(){u=n("p"),L=r("TF 2.0 models accepts two formats as inputs:"),b=i(),E=n("ul"),q=n("li"),y=r("having all inputs as keyword arguments (like PyTorch models), or"),w=i(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),ge=i(),z=n("p"),Y=r("This second option is useful when using "),R=n("code"),ne=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),Ge=r("model(inputs)"),Me=r("."),B=i(),K=n("p"),se=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Le=i(),S=n("ul"),P=n("li"),ve=r("a single Tensor with "),ae=n("code"),Se=r("input_ids"),Te=r(" only and nothing else: "),X=n("code"),Be=r("model(input_ids)"),Ce=i(),C=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),re=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var F=a(u);L=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),b=l(m),E=s(m,"UL",{});var de=a(E);q=s(de,"LI",{});var st=a(q);y=d(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(de),D=s(de,"LI",{});var at=a(D);je=d(at,"having all inputs as a list, tuple or dict in the first positional arguments."),at.forEach(t),de.forEach(t),ge=l(m),z=s(m,"P",{});var I=a(z);Y=d(I,"This second option is useful when using "),R=s(I,"CODE",{});var rt=a(R);ne=d(rt,"tf.keras.Model.fit"),rt.forEach(t),Ie=d(I,` method which currently requires having all the
tensors in the first argument of the model call function: `),V=s(I,"CODE",{});var dt=a(V);Ge=d(dt,"model(inputs)"),dt.forEach(t),Me=d(I,"."),I.forEach(t),B=l(m),K=s(m,"P",{});var Oe=a(K);se=d(Oe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var J=a(S);P=s(J,"LI",{});var ie=a(P);ve=d(ie,"a single Tensor with "),ae=s(ie,"CODE",{});var Pe=a(ae);Se=d(Pe,"input_ids"),Pe.forEach(t),Te=d(ie," only and nothing else: "),X=s(ie,"CODE",{});var it=a(X);Be=d(it,"model(input_ids)"),it.forEach(t),ie.forEach(t),Ce=l(J),C=s(J,"LI",{});var le=a(C);Qe=d(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(le,"CODE",{});var lt=a(ee);x=d(lt,"model([input_ids, attention_mask])"),lt.forEach(t),M=d(le," or "),Q=s(le,"CODE",{});var ce=a(Q);He=d(ce,"model([input_ids, attention_mask, token_type_ids])"),ce.forEach(t),le.forEach(t),We=l(J),j=s(J,"LI",{});var Re=a(j);Ue=d(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),re=s(Re,"CODE",{});var Ve=a(re);De=d(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),Re.forEach(t),J.forEach(t)},m(m,F){h(m,u,F),e(u,L),h(m,b,F),h(m,E,F),e(E,q),e(q,y),e(E,w),e(E,D),e(D,je),h(m,ge,F),h(m,z,F),e(z,Y),e(z,R),e(R,ne),e(z,Ie),e(z,V),e(V,Ge),e(z,Me),h(m,B,F),h(m,K,F),e(K,se),h(m,Le,F),h(m,S,F),e(S,P),e(P,ve),e(P,ae),e(ae,Se),e(P,Te),e(P,X),e(X,Be),e(S,Ce),e(S,C),e(C,Qe),e(C,ee),e(ee,x),e(C,M),e(C,Q),e(Q,He),e(S,We),e(S,j),e(j,Ue),e(j,re),e(re,De)},d(m){m&&t(u),m&&t(b),m&&t(E),m&&t(ge),m&&t(z),m&&t(B),m&&t(K),m&&t(Le),m&&t(S)}}}function Hf(G){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Wf(G){let u,L,b,E,q,y,w,D,je,ge,z,Y,R,ne,Ie,V,Ge,Me,B,K,se,Le,S,P,ve,ae,Se,Te,X,Be,Ce,C,Qe,ee,x,M,Q,He,We,j,Ue,re,De;return{c(){u=n("p"),L=r("TF 2.0 models accepts two formats as inputs:"),b=i(),E=n("ul"),q=n("li"),y=r("having all inputs as keyword arguments (like PyTorch models), or"),w=i(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),ge=i(),z=n("p"),Y=r("This second option is useful when using "),R=n("code"),ne=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),Ge=r("model(inputs)"),Me=r("."),B=i(),K=n("p"),se=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Le=i(),S=n("ul"),P=n("li"),ve=r("a single Tensor with "),ae=n("code"),Se=r("input_ids"),Te=r(" only and nothing else: "),X=n("code"),Be=r("model(input_ids)"),Ce=i(),C=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=n("code"),x=r("model([input_ids, attention_mask])"),M=r(" or "),Q=n("code"),He=r("model([input_ids, attention_mask, token_type_ids])"),We=i(),j=n("li"),Ue=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),re=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var F=a(u);L=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),b=l(m),E=s(m,"UL",{});var de=a(E);q=s(de,"LI",{});var st=a(q);y=d(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(de),D=s(de,"LI",{});var at=a(D);je=d(at,"having all inputs as a list, tuple or dict in the first positional arguments."),at.forEach(t),de.forEach(t),ge=l(m),z=s(m,"P",{});var I=a(z);Y=d(I,"This second option is useful when using "),R=s(I,"CODE",{});var rt=a(R);ne=d(rt,"tf.keras.Model.fit"),rt.forEach(t),Ie=d(I,` method which currently requires having all the
...
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var J=a(S);P=s(J,"LI",{});var ie=a(P);ve=d(ie,"a single Tensor with "),ae=s(ie,"CODE",{});var Pe=a(ae);Se=d(Pe,"input_ids"),Pe.forEach(t),Te=d(ie," only and nothing else: "),X=s(ie,"CODE",{});var it=a(X);Be=d(it,"model(input_ids)"),it.forEach(t),ie.forEach(t),Ce=l(J),C=s(J,"LI",{});var le=a(C);Qe=d(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(le,"CODE",{});var lt=a(ee);x=d(lt,"model([input_ids, attention_mask])"),lt.forEach(t),M=d(le," or "),Q=s(le,"CODE",{});var ce=a(Q);He=d(ce,"model([input_ids, attention_mask, token_type_ids])"),ce.forEach(t),le.forEach(t),We=l(J),j=s(J,"LI",{});var Re=a(j);Ue=d(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),re=s(Re,"CODE",{});var Ve=a(re);De=d(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),Re.forEach(t),J.forEach(t)},m(m,F){h(m,u,F),e(u,L),h(m,b,F),h(m,E,F),e(E,q),e(q,y),e(E,w),e(E,D),e(D,je),h(m,ge,F),h(m,z,F),e(z,Y),e(z,R),e(R,ne),e(z,Ie),e(z,V),e(V,Ge),e(z,Me),h(m,B,F),h(m,K,F),e(K,se),h(m,Le,F),h(m,S,F),e(S,P),e(P,ve),e(P,ae),e(ae,Se),e(P,Te),e(P,X),e(X,Be),e(S,Ce),e(S,C),e(C,Qe),e(C,ee),e(ee,x),e(C,M),e(C,Q),e(Q,He),e(S,We),e(S,j),e(j,Ue),e(j,re),e(re,De)},d(m){m&&t(u),m&&t(b),m&&t(E),m&&t(ge),m&&t(z),m&&t(B),m&&t(K),m&&t(Le),m&&t(S)}}}function Uf(G){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Rf(G){let u,L,b,E,q,y,w,D,je,ge,z,Y,R,ne,Ie,V,Ge,Me,B,K,se,Le,S,P,ve,ae,Se,Te,X,Be,Ce,C,Qe,ee,x,M,Q,He,We,j,Ue,re,De,m,F,de,st,at,I,rt,dt,Oe,J,ie,Pe,it,le,lt,ce,Re,Ve,Pd,Ad,Ss,Nd,jd,Id,ze,Gd,Cs,Bd,Qd,Os,Hd,Wd,Kn,Ud,Rd,Ps,Vd,Kd,Xd,Z,Jd,As,Zd,Yd,Ns,ei,ti,Xn,oi,ni,js,si,ai,Is,ri,di,Gs,ii,li,ci,ct,hi,Bs,pi,ui,Qs,mi,fi,_i,vo,gi,To,vi,Ti,ki,ko,bi,bo,wi,yi,_r,Nt,Ei,wo,qi,Li,gr,ht,jt,Hs,yo,Di,Ws,zi,vr,O,Eo,Fi,pt,$i,Jn,xi,Mi,qo,Si,Ci,Oi,ut,Pi,Zn,Ai,Ni,Yn,ji,Ii,Gi,Us,Bi,Qi,Lo,Hi,Rs,Vs,Ks,Xs,Wi,Ui,Js,Zs,Ys,It,Gt,ea,Do,Ri,ta,Vi,Ki,oa,na,zo,Bt,Qt,sa,Fo,Xi,aa,Ji,Zi,ra,Yi,el,da,ia,la,Ht,Wt,ca,$o,tl,ha,ol,Tr,mt,Ut,pa,xo,nl,ua,sl,kr,N,Mo,al,ma,rl,dl,Rt,es,il,ll,ts,cl,hl,pl,So,ul,os,ml,fl,_l,Ke,Co,gl,fa,vl,Tl,Oo,ns,kl,_a,bl,wl,ss,yl,ga,El,ql,Vt,Po,Ll,Ao,Dl,va,zl,Fl,$l,Kt,No,xl,Ta,Ml,Sl,as,jo,br,ft,Xt,ka,Io,Cl,ba,Ol,wr,Fe,Go,Pl,Bo,Al,wa,Nl,jl,Il,Jt,rs,Gl,Bl,ds,Ql,Hl,Wl,Qo,Ul,is,Rl,Vl,yr,_t,Zt,ya,Ho,Kl,Ea,Xl,Er,gt,Wo,Jl,qa,Zl,qr,vt,Uo,Yl,La,ec,Lr,Tt,Ro,tc,Da,oc,Dr,kt,Vo,nc,za,sc,zr,bt,Ko,ac,Fa,rc,Fr,wt,Xo,dc,$a,ic,$r,yt,Jo,lc,xa,cc,xr,Et,Zo,hc,Ma,pc,Mr,qt,Yt,Sa,Yo,uc,Ca,mc,Sr,$e,en,fc,tn,_c,ls,gc,vc,Tc,on,kc,nn,bc,wc,yc,ke,sn,Ec,Lt,qc,cs,Lc,Dc,Oa,zc,Fc,$c,eo,xc,Pa,Mc,Sc,an,Cr,Dt,to,Aa,rn,Cc,Na,Oc,Or,xe,dn,Pc,ln,Ac,hs,Nc,jc,Ic,cn,Gc,hn,Bc,Qc,Hc,H,pn,Wc,zt,Uc,ps,Rc,Vc,ja,Kc,Xc,Jc,oo,Zc,Ia,Yc,eh,un,th,Ga,oh,nh,mn,Pr,Ft,no,Ba,fn,sh,Qa,ah,Ar,he,_n,rh,Ha,dh,ih,gn,lh,us,ch,hh,ph,vn,uh,Tn,mh,fh,_h,A,kn,gh,$t,vh,ms,Th,kh,Wa,bh,wh,yh,so,Eh,Ua,qh,Lh,bn,Dh,wn,zh,Ra,Fh,$h,yn,xh,En,Nr,xt,ao,Va,qn,Mh,Ka,Sh,jr,pe,Ln,Ch,Mt,Oh,Xa,Ph,Ah,Ja,Nh,jh,Ih,Dn,Gh,fs,Bh,Qh,Hh,zn,Wh,Fn,Uh,Rh,Vh,te,$n,Kh,St,Xh,_s,Jh,Zh,Za,Yh,ep,tp,ro,op,Ya,np,sp,xn,ap,Mn,Ir,Ct,io,er,Sn,rp,tr,dp,Gr,ue,Cn,ip,On,lp,gs,cp,hp,pp,Pn,up,An,mp,fp,_p,lo,gp,be,Nn,vp,Ot,Tp,vs,kp,bp,or,wp,yp,Ep,co,qp,nr,Lp,Dp,jn,Br,Pt,ho,sr,In,zp,ar,Fp,Qr,me,Gn,$p,Bn,xp,Ts,Mp,Sp,Cp,Qn,Op,Hn,Pp,Ap,Np,po,jp,we,Wn,Ip,At,Gp,ks,Bp,Qp,rr,Hp,Wp,Up,uo,Rp,dr,Vp,Kp,Un,Hr;return y=new _e({}),ne=new _e({}),yo=new _e({}),Eo=new $({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
Vocabulary size of the LED model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDModel">LEDModel</a> or <a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.TFLEDModel">TFLEDModel</a>.`,name:"vocab_size"},{anchor:"transformers.LEDConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}]}}),Lo=new Ne({props:{code:"",highlighted:""}}),Do=new _e({}),Fo=new _e({}),$o=new _e({}),xo=new _e({}),Mo=new $({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/tokenization_led.py#L43"}}),Co=new $({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/bart/tokenization_bart.py#L338",parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}]}}),Ro=new $({props:{name:"class transformers.models.led.modeling_led.LEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_led.LEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L1237",parametersDescription:[{anchor:"transformers.models.led.modeling_led.LEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}]}}),Yo=new _e({}),en=new $({props:{name:"class transformers.LEDModel",anchor:"transformers.LEDModel",parameters:[{name:"config",val:": LEDConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2154",parametersDescription:[{anchor:"transformers.LEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),sn=new $({props:{name:"forward",anchor:"transformers.LEDModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2181",parametersDescription:[{anchor:"transformers.LEDModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_14934/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_14934/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),rn=new _e({}),dn=new $({props:{name:"class transformers.LEDForConditionalGeneration",anchor:"transformers.LEDForConditionalGeneration",parameters:[{name:"config",val:": LEDConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2277",parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),pn=new $({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2321",parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),fn=new _e({}),_n=new $({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2468",parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new $({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2481",parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_14934/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
`}}),so=new go({props:{$$slots:{default:[Gf]},$$scope:{ctx:G}}}),bn=new Ne({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),qn=new _e({}),Ln=new $({props:{name:"class transformers.LEDForQuestionAnswering",anchor:"transformers.LEDForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2596",parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$n=new $({props:{name:"forward",anchor:"transformers.LEDForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_led.py#L2608",parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_14934/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),Sn=new _e({}),Cn=new $({props:{name:"class transformers.TFLEDModel",anchor:"transformers.TFLEDModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_tf_led.py#L2191",parametersDescription:[{anchor:"transformers.TFLEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_14934/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new go({props:{$$slots:{default:[Qf]},$$scope:{ctx:G}}}),Nn=new $({props:{name:"call",anchor:"transformers.TFLEDModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput, NoneType] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14934/src/transformers/models/led/modeling_tf_led.py#L2203",parametersDescription:[{anchor:"transformers.TFLEDModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_14934/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14934/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_14934/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
<p>A <a
  href="/docs/transformers/pr_14934/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_14934/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){u=n("meta"),L=i(),b=n("h1"),E=n("a"),q=n("span"),f(y.$$.fragment),w=i(),D=n("span"),je=r("LED"),ge=i(),z=n("h2"),Y=n("a"),R=n("span"),f(ne.$$.fragment),Ie=i(),V=n("span"),Ge=r("Overview"),Me=i(),B=n("p"),K=r("The LED model was proposed in "),se=n("a"),Le=r("Longformer: The Long-Document Transformer"),S=r(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),P=i(),ve=n("p"),ae=r("The abstract from the paper is the following:"),Se=i(),Te=n("p"),X=n("em"),Be=r(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
`),j=n("a"),Ue=r("BartForConditionalGeneration"),re=r(" exchanging the traditional "),De=n("em"),m=r("self-attention"),F=r(` layer with
`),de=n("em"),st=r("Longformer"),at=r("\u2019s "),I=n("em"),rt=r("chunked self-attention"),dt=r(" layer. "),Oe=n("a"),J=r("LEDTokenizer"),ie=r(` is an alias of
`),Pe=n("a"),it=r("BartTokenizer"),le=r("."),lt=i(),ce=n("li"),Re=r("LED works very well on long-range "),Ve=n("em"),Pd=r("sequence-to-sequence"),Ad=r(" tasks where the "),Ss=n("code"),Nd=r("input_ids"),jd=r(` largely exceed a length of
1024 tokens.`),Id=i(),ze=n("li"),Gd=r("LED pads the "),Cs=n("code"),Bd=r("input_ids"),Qd=r(" to be a multiple of "),Os=n("code"),Hd=r("config.attention_window"),Wd=r(` if required. Therefore a small speed-up is
gained, when `),Kn=n("a"),Ud=r("LEDTokenizer"),Rd=r(" is used with the "),Ps=n("code"),Vd=r("pad_to_multiple_of"),Kd=r(" argument."),Xd=i(),Z=n("li"),Jd=r("LED makes use of "),As=n("em"),Zd=r("global attention"),Yd=r(" by means of the "),Ns=n("code"),ei=r("global_attention_mask"),ti=r(` (see
...
`),Qs=n("code"),mi=r("model.gradient_checkpointing_enable()"),fi=r("."),_i=i(),vo=n("li"),gi=r("A notebook showing how to evaluate LED, can be accessed "),To=n("a"),vi=r("here"),Ti=r("."),ki=i(),ko=n("li"),bi=r("A notebook showing how to fine-tune LED, can be accessed "),bo=n("a"),wi=r("here"),yi=r("."),_r=i(),Nt=n("p"),Ei=r("This model was contributed by "),wo=n("a"),qi=r("patrickvonplaten"),Li=r("."),gr=i(),ht=n("h2"),jt=n("a"),Hs=n("span"),f(yo.$$.fragment),Di=i(),Ws=n("span"),zi=r("LEDConfig"),vr=i(),O=n("div"),f(Eo.$$.fragment),Fi=i(),pt=n("p"),$i=r("This is the configuration class to store the configuration of a "),Jn=n("a"),xi=r("LEDModel"),Mi=r(`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),qo=n("a"),Si=r("allenai/led-base-16384"),Ci=r(" architecture."),Oi=i(),ut=n("p"),Pi=r("Configuration objects inherit from "),Zn=n("a"),Ai=r("PretrainedConfig"),Ni=r(` and can be used to control the model outputs. Read the
documentation from `),Yn=n("a"),ji=r("PretrainedConfig"),Ii=r(" for more information."),Gi=i(),Us=n("p"),Bi=r("Example:"),Qi=i(),f(Lo.$$.fragment),Hi=i(),Rs=n("blockquote"),Vs=n("blockquote"),Ks=n("blockquote"),Xs=n("p"),Wi=r("from transformers import LEDModel, LEDConfig"),Ui=i(),Js=n("blockquote"),Zs=n("blockquote"),Ys=n("blockquote"),It=n("h1"),Gt=n("a"),ea=n("span"),f(Do.$$.fragment),Ri=i(),ta=n("span"),Vi=r("Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Ki=i(),oa=n("blockquote"),na=n("blockquote"),zo=n("blockquote"),Bt=n("h1"),Qt=n("a"),sa=n("span"),f(Fo.$$.fragment),Xi=i(),aa=n("span"),Ji=r("Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Zi=i(),ra=n("p"),Yi=r("LEDModel(configuration)"),el=i(),da=n("blockquote"),ia=n("blockquote"),la=n("blockquote"),Ht=n("h1"),Wt=n("a"),ca=n("span"),f($o.$$.fragment),tl=i(),ha=n("span"),ol=r("Accessing the model configuration >>> configuration = model.config"),Tr=i(),mt=n("h2"),Ut=n("a"),pa=n("span"),f(xo.$$.fragment),nl=i(),ua=n("span"),sl=r("LEDTokenizer"),kr=i(),N=n("div"),f(Mo.$$.fragment),al=i(),ma=n("p"),rl=r("Construct a LED tokenizer."),dl=i(),Rt=n("p"),es=n("a"),il=r("LEDTokenizer"),ll=r(" is identical to "),ts=n("a"),cl=r("BartTokenizer"),hl=r(` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),Tl=i(),Oo=n("ul"),ns=n("li"),kl=r("single sequence: "),_a=n("code"),bl=r("<s> X </s>"),wl=i(),ss=n("li"),yl=r("pair of sequences: "),ga=n("code"),El=r("<s> A </s></s> B </s>"),ql=i(),Vt=n("div"),f(Po.$$.fragment),Ll=i(),Ao=n("p"),Dl=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),va=n("code"),zl=r("prepare_for_model"),Fl=r(" method."),$l=i(),Kt=n("div"),f(No.$$.fragment),xl=i(),Ta=n("p"),Ml=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Sl=i(),as=n("div"),f(jo.$$.fragment),br=i(),ft=n("h2"),Xt=n("a"),ka=n("span"),f(Io.$$.fragment),Cl=i(),ba=n("span"),Ol=r("LEDTokenizerFast"),wr=i(),Fe=n("div"),f(Go.$$.fragment),Pl=i(),Bo=n("p"),Al=r("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),wa=n("em"),Nl=r("tokenizers"),jl=r(" library)."),Il=i(),Jt=n("p"),rs=n("a"),Gl=r("LEDTokenizerFast"),Bl=r(" is identical to "),ds=n("a"),Ql=r("BartTokenizerFast"),Hl=r(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Wl=i(),Qo=n("p"),Ul=r("Refer to superclass "),is=n("a"),Rl=r("BartTokenizerFast"),Vl=r(" for usage examples and documentation concerning parameters."),yr=i(),_t=n("h2"),Zt=n("a"),ya=n("span"),f(Ho.$$.fragment),Kl=i(),Ea=n("span"),Xl=r("LED specific outputs"),Er=i(),gt=n("div"),f(Wo.$$.fragment),Jl=i(),qa=n("p"),Zl=r("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),qr=i(),vt=n("div"),f(Uo.$$.fragment),Yl=i(),La=n("p"),ec=r(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Lr=i(),Tt=n("div"),f(Ro.$$.fragment),tc=i(),Da=n("p"),oc=r("Base class for sequence-to-sequence language models outputs."),Dr=i(),kt=n("div"),f(Vo.$$.fragment),nc=i(),za=n("p"),sc=r("Base class for outputs of sequence-to-sequence sentence classification models."),zr=i(),bt=n("div"),f(Ko.$$.fragment),ac=i(),Fa=n("p"),rc=r("Base class for outputs of sequence-to-sequence question answering models."),Fr=i(),wt=n("div"),f(Xo.$$.fragment),dc=i(),$a=n("p"),ic=r("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),$r=i(),yt=n("div"),f(Jo.$$.fragment),lc=i(),xa=n("p"),cc=r(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),xr=i(),Et=n("div"),f(Zo.$$.fragment),hc=i(),Ma=n("p"),pc=r("Base class for sequence-to-sequence language models outputs."),Mr=i(),qt=n("h2"),Yt=n("a"),Sa=n("span"),f(Yo.$$.fragment),uc=i(),Ca=n("span"),mc=r("LEDModel"),Sr=i(),$e=n("div"),f(en.$$.fragment),fc=i(),tn=n("p"),_c=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),yc=i(),ke=n("div"),f(sn.$$.fragment),Ec=i(),Lt=n("p"),qc=r("The "),cs=n("a"),Lc=r("LEDModel"),Dc=r(" forward method, overrides the "),Oa=n("code"),zc=r("__call__"),Fc=r(" special method."),$c=i(),f(eo.$$.fragment),xc=i(),Pa=n("p"),Mc=r("Example:"),Sc=i(),f(an.$$.fragment),Cr=i(),Dt=n("h2"),to=n("a"),Aa=n("span"),f(rn.$$.fragment),Cc=i(),Na=n("span"),Oc=r("LEDForConditionalGeneration"),Or=i(),xe=n("div"),f(dn.$$.fragment),Pc=i(),ln=n("p"),Ac=r(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hc=i(),H=n("div"),f(pn.$$.fragment),Wc=i(),zt=n("p"),Uc=r("The "),ps=n("a"),Rc=r("LEDForConditionalGeneration"),Vc=r(" forward method, overrides the "),ja=n("code"),Kc=r("__call__"),Xc=r(" special method."),Jc=i(),f(oo.$$.fragment),Zc=i(),Ia=n("p"),Yc=r("Conditional generation example:"),eh=i(),f(un.$$.fragment),th=i(),Ga=n("p"),oh=r("Summarization example:"),nh=i(),f(mn.$$.fragment),Pr=i(),Ft=n("h2"),no=n("a"),Ba=n("span"),f(fn.$$.fragment),sh=i(),Qa=n("span"),ah=r("LEDForSequenceClassification"),Ar=i(),he=n("div"),f(_n.$$.fragment),rh=i(),Ha=n("p"),dh=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_h=i(),A=n("div"),f(kn.$$.fragment),gh=i(),$t=n("p"),vh=r("The "),ms=n("a"),Th=r("LEDForSequenceClassification"),kh=r(" forward method, overrides the "),Wa=n("code"),bh=r("__call__"),wh=r(" special method."),yh=i(),f(so.$$.fragment),Eh=i(),Ua=n("p"),qh=r("Example of single-label classification:"),Lh=i(),f(bn.$$.fragment),Dh=i(),f(wn.$$.fragment),zh=i(),Ra=n("p"),Fh=r("Example of multi-label classification:"),$h=i(),f(yn.$$.fragment),xh=i(),f(En.$$.fragment),Nr=i(),xt=n("h2"),ao=n("a"),Va=n("span"),f(qn.$$.fragment),Mh=i(),Ka=n("span"),Sh=r("LEDForQuestionAnswering"),jr=i(),pe=n("div"),f(Ln.$$.fragment),Ch=i(),Mt=n("p"),Oh=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Xa=n("code"),Ph=r("span start logits"),Ah=r(" and "),Ja=n("code"),Nh=r("span end logits"),jh=r(")."),Ih=i(),Dn=n("p"),Gh=r("This model inherits from "),fs=n("a"),Bh=r("PreTrainedModel"),Qh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh=i(),zn=n("p"),Wh=r("This model is also a PyTorch "),Fn=n("a"),Uh=r("torch.nn.Module"),Rh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vh=i(),te=n("div"),f($n.$$.fragment),Kh=i(),St=n("p"),Xh=r("The "),_s=n("a"),Jh=r("LEDForQuestionAnswering"),Zh=r(" forward method, overrides the "),Za=n("code"),Yh=r("__call__"),ep=r(" special method."),tp=i(),f(ro.$$.fragment),op=i(),Ya=n("p"),np=r("Example:"),sp=i(),f(xn.$$.fragment),ap=i(),f(Mn.$$.fragment),Ir=i(),Ct=n("h2"),io=n("a"),er=n("span"),f(Sn.$$.fragment),rp=i(),tr=n("span"),dp=r("TFLEDModel"),Gr=i(),ue=n("div"),f(Cn.$$.fragment),ip=i(),On=n("p"),lp=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pp=i(),Pn=n("p"),up=r("This model is also a "),An=n("a"),mp=r("tf.keras.Model"),fp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_p=i(),f(lo.$$.fragment),gp=i(),be=n("div"),f(Nn.$$.fragment),vp=i(),Ot=n("p"),Tp=r("The "),vs=n("a"),kp=r("TFLEDModel"),bp=r(" forward method, overrides the "),or=n("code"),wp=r("__call__"),yp=r(" special method."),Ep=i(),f(co.$$.fragment),qp=i(),nr=n("p"),Lp=r("Example:"),Dp=i(),f(jn.$$.fragment),Br=i(),Pt=n("h2"),ho=n("a"),sr=n("span"),f(In.$$.fragment),zp=i(),ar=n("span"),Fp=r("TFLEDForConditionalGeneration"),Qr=i(),me=n("div"),f(Gn.$$.fragment),$p=i(),Bn=n("p"),xp=r(`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cp=i(),Qn=n("p"),Op=r("This model is also a "),Hn=n("a"),Pp=r("tf.keras.Model"),Ap=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Np=i(),f(po.$$.fragment),jp=i(),we=n("div"),f(Wn.$$.fragment),Ip=i(),At=n("p"),Gp=r("The "),ks=n("a"),Bp=r("TFLEDForConditionalGeneration"),Qp=r(" forward method, overrides the "),rr=n("code"),Hp=r("__call__"),Wp=r(" special method."),Up=i(),f(uo.$$.fragment),Rp=i(),dr=n("p"),Vp=r("Examples:"),Kp=i(),f(Un.$$.fragment),this.h()},l(o){const p=Af('[data-svelte="svelte-1phssyn"]',document.head);u=s(p,"META",{name:!0,content:!0}),p.forEach(t),L=l(o),b=s(o,"H1",{class:!0});var Rn=a(b);E=s(Rn,"A",{id:!0,class:!0,href:!0});var ir=a(E);q=s(ir,"SPAN",{});var lr=a(q);_(y.$$.fragment,lr),lr.forEach(t),ir.forEach(t),w=l(Rn),D=s(Rn,"SPAN",{});var cr=a(D);je=d(cr,"LED"),cr.forEach(t),Rn.forEach(t),ge=l(o),z=s(o,"H2",{class:!0});var Vn=a(z);Y=s(Vn,"A",{id:!0,class:!0,href:!0});var hr=a(Y);R=s(hr,"SPAN",{});var pr=a(R);_(ne.$$.fragment,pr),pr.forEach(t),hr.forEach(t),Ie=l(Vn),V=s(Vn,"SPAN",{});var ur=a(V);Ge=d(ur,"Overview"),ur.forEach(t),Vn.forEach(t),Me=l(o),B=s(o,"P",{});var Wr=a(B);K=d(Wr,"The LED model was proposed in "),se=s(Wr,"A",{href:!0,rel:!0});var Zp=a(se);Le=d(Zp,"Longformer: The Long-Document Transformer"),Zp.forEach(t),S=d(Wr,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Wr.forEach(t),P=l(o),ve=s(o,"P",{});var Yp=a(ve);ae=d(Yp,"The abstract from the paper is the following:"),Yp.forEach(t),Se=l(o),Te=s(o,"P",{});var eu=a(Te);X=s(eu,"EM",{});var tu=a(X);Be=d(tu,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),j=s(fe,"A",{href:!0});var su=a(j);Ue=d(su,"BartForConditionalGeneration"),su.forEach(t),re=d(fe," exchanging the traditional "),De=s(fe,"EM",{});var au=a(De);m=d(au,"self-attention"),au.forEach(t),F=d(fe,` layer with
...
`),Pe=s(fe,"A",{href:!0});var lu=a(Pe);it=d(lu,"BartTokenizer"),lu.forEach(t),le=d(fe,"."),fe.forEach(t),lt=l(ye),ce=s(ye,"LI",{});var bs=a(ce);Re=d(bs,"LED works very well on long-range "),Ve=s(bs,"EM",{});var cu=a(Ve);Pd=d(cu,"sequence-to-sequence"),cu.forEach(t),Ad=d(bs," tasks where the "),Ss=s(bs,"CODE",{});var hu=a(Ss);Nd=d(hu,"input_ids"),hu.forEach(t),jd=d(bs,` largely exceed a length of
1024 tokens.`),bs.forEach(t),Id=l(ye),ze=s(ye,"LI",{});var Xe=a(ze);Gd=d(Xe,"LED pads the "),Cs=s(Xe,"CODE",{});var pu=a(Cs);Bd=d(pu,"input_ids"),pu.forEach(t),Qd=d(Xe," to be a multiple of "),Os=s(Xe,"CODE",{});var uu=a(Os);Hd=d(uu,"config.attention_window"),uu.forEach(t),Wd=d(Xe,` if required. Therefore a small speed-up is
gained, when `),Kn=s(Xe,"A",{href:!0});var mu=a(Kn);Ud=d(mu,"LEDTokenizer"),mu.forEach(t),Rd=d(Xe," is used with the "),Ps=s(Xe,"CODE",{});var fu=a(Ps);Vd=d(fu,"pad_to_multiple_of"),fu.forEach(t),Kd=d(Xe," argument."),Xe.forEach(t),Xd=l(ye),Z=s(ye,"LI",{});var Ee=a(Z);Jd=d(Ee,"LED makes use of "),As=s(Ee,"EM",{});var _u=a(As);Zd=d(_u,"global attention"),_u.forEach(t),Yd=d(Ee," by means of the "),Ns=s(Ee,"CODE",{});var gu=a(Ns);ei=d(gu,"global_attention_mask"),gu.forEach(t),ti=d(Ee,` (see
...
`),Is=s(Ee,"CODE",{});var ku=a(Is);ri=d(ku,"<s>"),ku.forEach(t),di=d(Ee," token. For question answering, it is advised to put "),Gs=s(Ee,"EM",{});var bu=a(Gs);ii=d(bu,"global attention"),bu.forEach(t),li=d(Ee," on all tokens of the question."),Ee.forEach(t),ci=l(ye),ct=s(ye,"LI",{});var ws=a(ct);hi=d(ws,"To fine-tune LED on all 16384, it is necessary to enable "),Bs=s(ws,"EM",{});var wu=a(Bs);pi=d(wu,"gradient checkpointing"),wu.forEach(t),ui=d(ws,` by executing
`),Qs=s(ws,"CODE",{});var yu=a(Qs);mi=d(yu,"model.gradient_checkpointing_enable()"),yu.forEach(t),fi=d(ws,"."),ws.forEach(t),_i=l(ye),vo=s(ye,"LI",{});var Ur=a(vo);gi=d(Ur,"A notebook showing how to evaluate LED, can be accessed "),To=s(Ur,"A",{href:!0,rel:!0});var Eu=a(To);vi=d(Eu,"here"),Eu.forEach(t),Ti=d(Ur,"."),Ur.forEach(t),ki=l(ye),ko=s(ye,"LI",{});var Rr=a(ko);bi=d(Rr,"A notebook showing how to fine-tune LED, can be accessed "),bo=s(Rr,"A",{href:!0,rel:!0});var qu=a(bo);wi=d(qu,"here"),qu.forEach(t),yi=d(Rr,"."),Rr.forEach(t),ye.forEach(t),_r=l(o),Nt=s(o,"P",{});var Vr=a(Nt);Ei=d(Vr,"This model was contributed by "),wo=s(Vr,"A",{href:!0,rel:!0});var Lu=a(wo);qi=d(Lu,"patrickvonplaten"),Lu.forEach(t),Li=d(Vr,"."),Vr.forEach(t),gr=l(o),ht=s(o,"H2",{class:!0});var Kr=a(ht);jt=s(Kr,"A",{id:!0,class:!0,href:!0});var Du=a(jt);Hs=s(Du,"SPAN",{});var zu=a(Hs);_(yo.$$.fragment,zu),zu.forEach(t),Du.forEach(t),Di=l(Kr),Ws=s(Kr,"SPAN",{});var Fu=a(Ws);zi=d(Fu,"LEDConfig"),Fu.forEach(t),Kr.forEach(t),vr=l(o),O=s(o,"DIV",{class:!0});var W=a(O);_(Eo.$$.fragment,W),Fi=l(W),pt=s(W,"P",{});var ys=a(pt);$i=d(ys,"This is the configuration class to store the configuration of a "),Jn=s(ys,"A",{href:!0});var $u=a(Jn);xi=d($u,"LEDModel"),$u.forEach(t),Mi=d(ys,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),qo=s(ys,"A",{href:!0,rel:!0});var xu=a(qo);Si=d(xu,"allenai/led-base-16384"),xu.forEach(t),Ci=d(ys," architecture."),ys.forEach(t),Oi=l(W),ut=s(W,"P",{});var Es=a(ut);Pi=d(Es,"Configuration objects inherit from "),Zn=s(Es,"A",{href:!0});var Mu=a(Zn);Ai=d(Mu,"PretrainedConfig"),Mu.forEach(t),Ni=d(Es,` and can be used to control the model outputs. Read the
documentation from `),Yn=s(Es,"A",{href:!0});var Su=a(Yn);ji=d(Su,"PretrainedConfig"),Su.forEach(t),Ii=d(Es," for more information."),Es.forEach(t),Gi=l(W),Us=s(W,"P",{});var Cu=a(Us);Bi=d(Cu,"Example:"),Cu.forEach(t),Qi=l(W),_(Lo.$$.fragment,W),Hi=l(W),Rs=s(W,"BLOCKQUOTE",{});var Ou=a(Rs);Vs=s(Ou,"BLOCKQUOTE",{});var Pu=a(Vs);Ks=s(Pu,"BLOCKQUOTE",{});var Au=a(Ks);Xs=s(Au,"P",{});var Nu=a(Xs);Wi=d(Nu,"from transformers import LEDModel, LEDConfig"),Nu.forEach(t),Au.forEach(t),Pu.forEach(t),Ou.forEach(t),Ui=l(W),Js=s(W,"BLOCKQUOTE",{});var ju=a(Js);Zs=s(ju,"BLOCKQUOTE",{});var Iu=a(Zs);Ys=s(Iu,"BLOCKQUOTE",{});var Gu=a(Ys);It=s(Gu,"H1",{class:!0});var Xr=a(It);Gt=s(Xr,"A",{id:!0,class:!0,href:!0});var Bu=a(Gt);ea=s(Bu,"SPAN",{});var Qu=a(ea);_(Do.$$.fragment,Qu),Qu.forEach(t),Bu.forEach(t),Ri=l(Xr),ta=s(Xr,"SPAN",{});var Hu=a(ta);Vi=d(Hu,"Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Hu.forEach(t),Xr.forEach(t),Gu.forEach(t),Iu.forEach(t),ju.forEach(t),Ki=l(W),oa=s(W,"BLOCKQUOTE",{});var Wu=a(oa);na=s(Wu,"BLOCKQUOTE",{});var Uu=a(na);zo=s(Uu,"BLOCKQUOTE",{});var Jr=a(zo);Bt=s(Jr,"H1",{class:!0});var Zr=a(Bt);Qt=s(Zr,"A",{id:!0,class:!0,href:!0});var Ru=a(Qt);sa=s(Ru,"SPAN",{});var Vu=a(sa);_(Fo.$$.fragment,Vu),Vu.forEach(t),Ru.forEach(t),Xi=l(Zr),aa=s(Zr,"SPAN",{});var Ku=a(aa);Ji=d(Ku,"Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Ku.forEach(t),Zr.forEach(t),Zi=l(Jr),ra=s(Jr,"P",{});var Xu=a(ra);Yi=d(Xu,"LEDModel(configuration)"),Xu.forEach(t),Jr.forEach(t),Uu.forEach(t),Wu.forEach(t),el=l(W),da=s(W,"BLOCKQUOTE",{});var Ju=a(da);ia=s(Ju,"BLOCKQUOTE",{});var Zu=a(ia);la=s(Zu,"BLOCKQUOTE",{});var Yu=a(la);Ht=s(Yu,"H1",{class:!0});var Yr=a(Ht);Wt=s(Yr,"A",{id:!0,class:!0,href:!0});var em=a(Wt);ca=s(em,"SPAN",{});var tm=a(ca);_($o.$$.fragment,tm),tm.forEach(t),em.forEach(t),tl=l(Yr),ha=s(Yr,"SPAN",{});var om=a(ha);ol=d(om,"Accessing the model configuration >>> configuration = model.config"),om.forEach(t),Yr.forEach(t),Yu.forEach(t),Zu.forEach(t),Ju.forEach(t),W.forEach(t),Tr=l(o),mt=s(o,"H2",{class:!0});var ed=a(mt);Ut=s(ed,"A",{id:!0,class:!0,href:!0});var nm=a(Ut);pa=s(nm,"SPAN",{});var sm=a(pa);_(xo.$$.fragment,sm),sm.forEach(t),nm.forEach(t),nl=l(ed),ua=s(ed,"SPAN",{});var am=a(ua);sl=d(am,"LEDTokenizer"),am.forEach(t),ed.forEach(t),kr=l(o),N=s(o,"DIV",{class:!0});var oe=a(N);_(Mo.$$.fragment,oe),al=l(oe),ma=s(oe,"P",{});var rm=a(ma);rl=d(rm,"Construct a LED tokenizer."),rm.forEach(t),dl=l(oe),Rt=s(oe,"P",{});var mr=a(Rt);es=s(mr,"A",{href:!0});var dm=a(es);il=d(dm,"LEDTokenizer"),dm.forEach(t),ll=d(mr," is identical to "),ts=s(mr,"A",{href:!0});var im=a(ts);cl=d(im,"BartTokenizer"),im.forEach(t),hl=d(mr,` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),cm.forEach(t),Tl=l(qs),Oo=s(qs,"UL",{});var od=a(Oo);ns=s(od,"LI",{});var Xp=a(ns);kl=d(Xp,"single sequence: "),_a=s(Xp,"CODE",{});var hm=a(_a);bl=d(hm,"<s> X </s>"),hm.forEach(t),Xp.forEach(t),wl=l(od),ss=s(od,"LI",{});var Jp=a(ss);yl=d(Jp,"pair of sequences: "),ga=s(Jp,"CODE",{});var pm=a(ga);El=d(pm,"<s> A </s></s> B </s>"),pm.forEach(t),Jp.forEach(t),od.forEach(t),qs.forEach(t),ql=l(oe),Vt=s(oe,"DIV",{class:!0});var nd=a(Vt);_(Po.$$.fragment,nd),Ll=l(nd),Ao=s(nd,"P",{});var sd=a(Ao);Dl=d(sd,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),va=s(sd,"CODE",{});var um=a(va);zl=d(um,"prepare_for_model"),um.forEach(t),Fl=d(sd," method."),sd.forEach(t),nd.forEach(t),$l=l(oe),Kt=s(oe,"DIV",{class:!0});var ad=a(Kt);_(No.$$.fragment,ad),xl=l(ad),Ta=s(ad,"P",{});var mm=a(Ta);Ml=d(mm,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),mm.forEach(t),ad.forEach(t),Sl=l(oe),as=s(oe,"DIV",{class:!0});var fm=a(as);_(jo.$$.fragment,fm),fm.forEach(t),oe.forEach(t),br=l(o),ft=s(o,"H2",{class:!0});var rd=a(ft);Xt=s(rd,"A",{id:!0,class:!0,href:!0});var _m=a(Xt);ka=s(_m,"SPAN",{});var gm=a(ka);_(Io.$$.fragment,gm),gm.forEach(t),_m.forEach(t),Cl=l(rd),ba=s(rd,"SPAN",{});var vm=a(ba);Ol=d(vm,"LEDTokenizerFast"),vm.forEach(t),rd.forEach(t),wr=l(o),Fe=s(o,"DIV",{class:!0});var mo=a(Fe);_(Go.$$.fragment,mo),Pl=l(mo),Bo=s(mo,"P",{});var dd=a(Bo);Al=d(dd,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),wa=s(dd,"EM",{});var Tm=a(wa);Nl=d(Tm,"tokenizers"),Tm.forEach(t),jl=d(dd," library)."),dd.forEach(t),Il=l(mo),Jt=s(mo,"P",{});var fr=a(Jt);rs=s(fr,"A",{href:!0});var km=a(rs);Gl=d(km,"LEDTokenizerFast"),km.forEach(t),Bl=d(fr," is identical to "),ds=s(fr,"A",{href:!0});var bm=a(ds);Ql=d(bm,"BartTokenizerFast"),bm.forEach(t),Hl=d(fr,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),fr.forEach(t),Wl=l(mo),Qo=s(mo,"P",{});var id=a(Qo);Ul=d(id,"Refer to superclass "),is=s(id,"A",{href:!0});var wm=a(is);Rl=d(wm,"BartTokenizerFast"),wm.forEach(t),Vl=d(id," for usage examples and documentation concerning parameters."),id.forEach(t),mo.forEach(t),yr=l(o),_t=s(o,"H2",{class:!0});var ld=a(_t);Zt=s(ld,"A",{id:!0,class:!0,href:!0});var ym=a(Zt);ya=s(ym,"SPAN",{});var Em=a(ya);_(Ho.$$.fragment,Em),Em.forEach(t),ym.forEach(t),Kl=l(ld),Ea=s(ld,"SPAN",{});var qm=a(Ea);Xl=d(qm,"LED specific outputs"),qm.forEach(t),ld.forEach(t),Er=l(o),gt=s(o,"DIV",{class:!0});var cd=a(gt);_(Wo.$$.fragment,cd),Jl=l(cd),qa=s(cd,"P",{});var Lm=a(qa);Zl=d(Lm,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Lm.forEach(t),cd.forEach(t),qr=l(o),vt=s(o,"DIV",{class:!0});var hd=a(vt);_(Uo.$$.fragment,hd),Yl=l(hd),La=s(hd,"P",{});var Dm=a(La);ec=d(Dm,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Dm.forEach(t),hd.forEach(t),Lr=l(o),Tt=s(o,"DIV",{class:!0});var pd=a(Tt);_(Ro.$$.fragment,pd),tc=l(pd),Da=s(pd,"P",{});var zm=a(Da);oc=d(zm,"Base class for sequence-to-sequence language models outputs."),zm.forEach(t),pd.forEach(t),Dr=l(o),kt=s(o,"DIV",{class:!0});var ud=a(kt);_(Vo.$$.fragment,ud),nc=l(ud),za=s(ud,"P",{});var Fm=a(za);sc=d(Fm,"Base class for outputs of sequence-to-sequence sentence classification models."),Fm.forEach(t),ud.forEach(t),zr=l(o),bt=s(o,"DIV",{class:!0});var md=a(bt);_(Ko.$$.fragment,md),ac=l(md),Fa=s(md,"P",{});var $m=a(Fa);rc=d($m,"Base class for outputs of sequence-to-sequence question answering models."),$m.forEach(t),md.forEach(t),Fr=l(o),wt=s(o,"DIV",{class:!0});var fd=a(wt);_(Xo.$$.fragment,fd),dc=l(fd),$a=s(fd,"P",{});var xm=a($a);ic=d(xm,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),xm.forEach(t),fd.forEach(t),$r=l(o),yt=s(o,"DIV",{class:!0});var _d=a(yt);_(Jo.$$.fragment,_d),lc=l(_d),xa=s(_d,"P",{});var Mm=a(xa);cc=d(Mm,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Mm.forEach(t),_d.forEach(t),xr=l(o),Et=s(o,"DIV",{class:!0});var gd=a(Et);_(Zo.$$.fragment,gd),hc=l(gd),Ma=s(gd,"P",{});var Sm=a(Ma);pc=d(Sm,"Base class for sequence-to-sequence language models outputs."),Sm.forEach(t),gd.forEach(t),Mr=l(o),qt=s(o,"H2",{class:!0});var vd=a(qt);Yt=s(vd,"A",{id:!0,class:!0,href:!0});var Cm=a(Yt);Sa=s(Cm,"SPAN",{});var Om=a(Sa);_(Yo.$$.fragment,Om),Om.forEach(t),Cm.forEach(t),uc=l(vd),Ca=s(vd,"SPAN",{});var Pm=a(Ca);mc=d(Pm,"LEDModel"),Pm.forEach(t),vd.forEach(t),Sr=l(o),$e=s(o,"DIV",{class:!0});var fo=a($e);_(en.$$.fragment,fo),fc=l(fo),tn=s(fo,"P",{});var Td=a(tn);_c=d(Td,`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),ls=s(Td,"A",{href:!0});var Am=a(ls);gc=d(Am,"PreTrainedModel"),Am.forEach(t),vc=d(Td,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Td.forEach(t),Tc=l(fo),on=s(fo,"P",{});var kd=a(on);kc=d(kd,"This model is also a PyTorch "),nn=s(kd,"A",{href:!0,rel:!0});var Nm=a(nn);bc=d(Nm,"torch.nn.Module"),Nm.forEach(t),wc=d(kd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd.forEach(t),yc=l(fo),ke=s(fo,"DIV",{class:!0});var Je=a(ke);_(sn.$$.fragment,Je),Ec=l(Je),Lt=s(Je,"P",{});var Ls=a(Lt);qc=d(Ls,"The "),cs=s(Ls,"A",{href:!0});var jm=a(cs);Lc=d(jm,"LEDModel"),jm.forEach(t),Dc=d(Ls," forward method, overrides the "),Oa=s(Ls,"CODE",{});var Im=a(Oa);zc=d(Im,"__call__"),Im.forEach(t),Fc=d(Ls," special method."),Ls.forEach(t),$c=l(Je),_(eo.$$.fragment,Je),xc=l(Je),Pa=s(Je,"P",{});var Gm=a(Pa);Mc=d(Gm,"Example:"),Gm.forEach(t),Sc=l(Je),_(an.$$.fragment,Je),Je.forEach(t),fo.forEach(t),Cr=l(o),Dt=s(o,"H2",{class:!0});var bd=a(Dt);to=s(bd,"A",{id:!0,class:!0,href:!0});var Bm=a(to);Aa=s(Bm,"SPAN",{});var Qm=a(Aa);_(rn.$$.fragment,Qm),Qm.forEach(t),Bm.forEach(t),Cc=l(bd),Na=s(bd,"SPAN",{});var Hm=a(Na);Oc=d(Hm,"LEDForConditionalGeneration"),Hm.forEach(t),bd.forEach(t),Or=l(o),xe=s(o,"DIV",{class:!0});var _o=a(xe);_(dn.$$.fragment,_o),Pc=l(_o),ln=s(_o,"P",{});var wd=a(ln);Ac=d(wd,`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yd.forEach(t),Hc=l(_o),H=s(_o,"DIV",{class:!0});var qe=a(H);_(pn.$$.fragment,qe),Wc=l(qe),zt=s(qe,"P",{});var Ds=a(zt);Uc=d(Ds,"The "),ps=s(Ds,"A",{href:!0});var Rm=a(ps);Rc=d(Rm,"LEDForConditionalGeneration"),Rm.forEach(t),Vc=d(Ds," forward method, overrides the "),ja=s(Ds,"CODE",{});var Vm=a(ja);Kc=d(Vm,"__call__"),Vm.forEach(t),Xc=d(Ds," special method."),Ds.forEach(t),Jc=l(qe),_(oo.$$.fragment,qe),Zc=l(qe),Ia=s(qe,"P",{});var Km=a(Ia);Yc=d(Km,"Conditional generation example:"),Km.forEach(t),eh=l(qe),_(un.$$.fragment,qe),th=l(qe),Ga=s(qe,"P",{});var Xm=a(Ga);oh=d(Xm,"Summarization example:"),Xm.forEach(t),nh=l(qe),_(mn.$$.fragment,qe),qe.forEach(t),_o.forEach(t),Pr=l(o),Ft=s(o,"H2",{class:!0});var Ed=a(Ft);no=s(Ed,"A",{id:!0,class:!0,href:!0});var Jm=a(no);Ba=s(Jm,"SPAN",{});var Zm=a(Ba);_(fn.$$.fragment,Zm),Zm.forEach(t),Jm.forEach(t),sh=l(Ed),Qa=s(Ed,"SPAN",{});var Ym=a(Qa);ah=d(Ym,"LEDForSequenceClassification"),Ym.forEach(t),Ed.forEach(t),Ar=l(o),he=s(o,"DIV",{class:!0});var Ze=a(he);_(_n.$$.fragment,Ze),rh=l(Ze),Ha=s(Ze,"P",{});var ef=a(Ha);dh=d(ef,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(t),_h=l(Ze),A=s(Ze,"DIV",{class:!0});var U=a(A);_(kn.$$.fragment,U),gh=l(U),$t=s(U,"P",{});var zs=a($t);vh=d(zs,"The "),ms=s(zs,"A",{href:!0});var nf=a(ms);Th=d(nf,"LEDForSequenceClassification"),nf.forEach(t),kh=d(zs," forward method, overrides the "),Wa=s(zs,"CODE",{});var sf=a(Wa);bh=d(sf,"__call__"),sf.forEach(t),wh=d(zs," special method."),zs.forEach(t),yh=l(U),_(so.$$.fragment,U),Eh=l(U),Ua=s(U,"P",{});var af=a(Ua);qh=d(af,"Example of single-label classification:"),af.forEach(t),Lh=l(U),_(bn.$$.fragment,U),Dh=l(U),_(wn.$$.fragment,U),zh=l(U),Ra=s(U,"P",{});var rf=a(Ra);Fh=d(rf,"Example of multi-label classification:"),rf.forEach(t),$h=l(U),_(yn.$$.fragment,U),xh=l(U),_(En.$$.fragment,U),U.forEach(t),Ze.forEach(t),Nr=l(o),xt=s(o,"H2",{class:!0});var Dd=a(xt);ao=s(Dd,"A",{id:!0,class:!0,href:!0});var df=a(ao);Va=s(df,"SPAN",{});var lf=a(Va);_(qn.$$.fragment,lf),lf.forEach(t),df.forEach(t),Mh=l(Dd),Ka=s(Dd,"SPAN",{});var cf=a(Ka);Sh=d(cf,"LEDForQuestionAnswering"),cf.forEach(t),Dd.forEach(t),jr=l(o),pe=s(o,"DIV",{class:!0});var Ye=a(pe);_(Ln.$$.fragment,Ye),Ch=l(Ye),Mt=s(Ye,"P",{});var Fs=a(Mt);Oh=d(Fs,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Xa=s(Fs,"CODE",{});var hf=a(Xa);Ph=d(hf,"span start logits"),hf.forEach(t),Ah=d(Fs," and "),Ja=s(Fs,"CODE",{});var pf=a(Ja);Nh=d(pf,"span end logits"),pf.forEach(t),jh=d(Fs,")."),Fs.forEach(t),Ih=l(Ye),Dn=s(Ye,"P",{});var zd=a(Dn);Gh=d(zd,"This model inherits from "),fs=s(zd,"A",{href:!0});var uf=a(fs);Bh=d(uf,"PreTrainedModel"),uf.forEach(t),Qh=d(zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zd.forEach(t),Hh=l(Ye),zn=s(Ye,"P",{});var Fd=a(zn);Wh=d(Fd,"This model is also a PyTorch "),Fn=s(Fd,"A",{href:!0,rel:!0});var mf=a(Fn);Uh=d(mf,"torch.nn.Module"),mf.forEach(t),Rh=d(Fd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fd.forEach(t),Vh=l(Ye),te=s(Ye,"DIV",{class:!0});var Ae=a(te);_($n.$$.fragment,Ae),Kh=l(Ae),St=s(Ae,"P",{});var $s=a(St);Xh=d($s,"The "),_s=s($s,"A",{href:!0});var ff=a(_s);Jh=d(ff,"LEDForQuestionAnswering"),ff.forEach(t),Zh=d($s," forward method, overrides the "),Za=s($s,"CODE",{});var _f=a(Za);Yh=d(_f,"__call__"),_f.forEach(t),ep=d($s," special method."),$s.forEach(t),tp=l(Ae),_(ro.$$.fragment,Ae),op=l(Ae),Ya=s(Ae,"P",{});var gf=a(Ya);np=d(gf,"Example:"),gf.forEach(t),sp=l(Ae),_(xn.$$.fragment,Ae),ap=l(Ae),_(Mn.$$.fragment,Ae),Ae.forEach(t),Ye.forEach(t),Ir=l(o),Ct=s(o,"H2",{class:!0});var $d=a(Ct);io=s($d,"A",{id:!0,class:!0,href:!0});var vf=a(io);er=s(vf,"SPAN",{});var Tf=a(er);_(Sn.$$.fragment,Tf),Tf.forEach(t),vf.forEach(t),rp=l($d),tr=s($d,"SPAN",{});var kf=a(tr);dp=d(kf,"TFLEDModel"),kf.forEach(t),$d.forEach(t),Gr=l(o),ue=s(o,"DIV",{class:!0});var et=a(ue);_(Cn.$$.fragment,et),ip=l(et),On=s(et,"P",{});var xd=a(On);lp=d(xd,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xd.forEach(t),pp=l(et),Pn=s(et,"P",{});var Md=a(Pn);up=d(Md,"This model is also a "),An=s(Md,"A",{href:!0,rel:!0});var wf=a(An);mp=d(wf,"tf.keras.Model"),wf.forEach(t),fp=d(Md,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Md.forEach(t),_p=l(et),_(lo.$$.fragment,et),gp=l(et),be=s(et,"DIV",{class:!0});var tt=a(be);_(Nn.$$.fragment,tt),vp=l(tt),Ot=s(tt,"P",{});var xs=a(Ot);Tp=d(xs,"The "),vs=s(xs,"A",{href:!0});var yf=a(vs);kp=d(yf,"TFLEDModel"),yf.forEach(t),bp=d(xs," forward method, overrides the "),or=s(xs,"CODE",{});var Ef=a(or);wp=d(Ef,"__call__"),Ef.forEach(t),yp=d(xs," special method."),xs.forEach(t),Ep=l(tt),_(co.$$.fragment,tt),qp=l(tt),nr=s(tt,"P",{});var qf=a(nr);Lp=d(qf,"Example:"),qf.forEach(t),Dp=l(tt),_(jn.$$.fragment,tt),tt.forEach(t),et.forEach(t),Br=l(o),Pt=s(o,"H2",{class:!0});var Sd=a(Pt);ho=s(Sd,"A",{id:!0,class:!0,href:!0});var Lf=a(ho);sr=s(Lf,"SPAN",{});var Df=a(sr);_(In.$$.fragment,Df),Df.forEach(t),Lf.forEach(t),zp=l(Sd),ar=s(Sd,"SPAN",{});var zf=a(ar);Fp=d(zf,"TFLEDForConditionalGeneration"),zf.forEach(t),Sd.forEach(t),Qr=l(o),me=s(o,"DIV",{class:!0});var ot=a(me);_(Gn.$$.fragment,ot),$p=l(ot),Bn=s(ot,"P",{});var Cd=a(Bn);xp=d(Cd,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ts=s(Cd,"A",{href:!0});var Ff=a(Ts);Mp=d(Ff,"TFPreTrainedModel"),Ff.forEach(t),Sp=d(Cd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cd.forEach(t),Cp=l(ot),Qn=s(ot,"P",{});var Od=a(Qn);Op=d(Od,"This model is also a "),Hn=s(Od,"A",{href:!0,rel:!0});var $f=a(Hn);Pp=d($f,"tf.keras.Model"),$f.forEach(t),Ap=d(Od,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Od.forEach(t),Np=l(ot),_(po.$$.fragment,ot),jp=l(ot),we=s(ot,"DIV",{class:!0});var nt=a(we);_(Wn.$$.fragment,nt),Ip=l(nt),At=s(nt,"P",{});var Ms=a(At);Gp=d(Ms,"The "),ks=s(Ms,"A",{href:!0});var xf=a(ks);Bp=d(xf,"TFLEDForConditionalGeneration"),xf.forEach(t),Qp=d(Ms," forward method, overrides the "),rr=s(Ms,"CODE",{});var Mf=a(rr);Hp=d(Mf,"__call__"),Mf.forEach(t),Wp=d(Ms," special method."),Ms.forEach(t),Up=l(nt),_(uo.$$.fragment,nt),Rp=l(nt),dr=s(nt,"P",{});var Sf=a(dr);Vp=d(Sf,"Examples:"),Sf.forEach(t),Kp=l(nt),_(Un.$$.fragment,nt),nt.forEach(t),ot.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(Vf)),c(E,"id","led"),c(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(E,"href","#led"),c(b,"class","relative group"),c(Y,"id","overview"),c(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Y,"href","#overview"),c(z,"class","relative group"),c(se,"href","https://arxiv.org/abs/2004.05150"),c(se,"rel","nofollow"),c(Q,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(j,"href","/docs/transformers/pr_14934/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(Oe,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer"),c(Pe,"href","/docs/transformers/pr_14934/en/model_doc/bart#transformers.BartTokenizer"),c(Kn,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer"),c(Xn,"href","/docs/transformers/pr_14934/en/model_doc/longformer#transformers.LongformerModel"),c(To,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),c(To,"rel","nofollow"),c(bo,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),c(bo,"rel","nofollow"),c(wo,"href","https://huggingface.co/patrickvonplaten"),c(wo,"rel","nofollow"),c(jt,"id","transformers.LEDConfig"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.LEDConfig"),c(ht,"class","relative group"),c(Jn,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDModel"),c(qo,"href","https://huggingface.co/allenai/led-base-16384"),c(qo,"rel","nofollow"),c(Zn,"href","/docs/transformers/pr_14934/en/main_classes/configuration#transformers.PretrainedConfig"),c(Yn,"href","/docs/transformers/pr_14934/en/main_classes/configuration#transformers.PretrainedConfig"),c(Gt,"id","initializing-a-led-allenai/led-base-16384-style-configuration->>>-configuration-=-ledconfig()"),c(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gt,"href","#initializing-a-led-allenai/led-base-16384-style-configuration->>>-configuration-=-ledconfig()"),c(It,"class","relative group"),c(Qt,"id","initializing-a-model-from-the-allenai/led-base-16384-style-configuration->>>-model-="),c(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qt,"href","#initializing-a-model-from-the-allenai/led-base-16384-style-configuration->>>-model-="),c(Bt,"class","relative group"),c(Wt,"id","accessing-the-model-configuration->>>-configuration-=-model.config"),c(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wt,"href","#accessing-the-model-configuration->>>-configuration-=-model.config"),c(Ht,"class","relative group"),c(O,"class","docstring"),c(Ut,"id","transformers.LEDTokenizer"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.LEDTokenizer"),c(mt,"class","relative group"),c(es,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizer"),c(ts,"href","/docs/transformers/pr_14934/en/model_doc/bart#transformers.BartTokenizer"),c(os,"href","/docs/transformers/pr_14934/en/model_doc/bart#transformers.BartTokenizer"),c(Ke,"class","docstring"),c(Vt,"class","docstring"),c(Kt,"class","docstring"),c(as,"class","docstring"),c(N,"class","docstring"),c(Xt,"id","transformers.LEDTokenizerFast"),c(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xt,"href","#transformers.LEDTokenizerFast"),c(ft,"class","relative group"),c(rs,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDTokenizerFast"),c(ds,"href","/docs/transformers/pr_14934/en/model_doc/bart#transformers.BartTokenizerFast"),c(is,"href","/docs/transformers/pr_14934/en/model_doc/bart#transformers.BartTokenizerFast"),c(Fe,"class","docstring"),c(Zt,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(_t,"class","relative group"),c(gt,"class","docstring"),c(vt,"class","docstring"),c(Tt,"class","docstring"),c(kt,"class","docstring"),c(bt,"class","docstring"),c(wt,"class","docstring"),c(yt,"class","docstring"),c(Et,"class","docstring"),c(Yt,"id","transformers.LEDModel"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.LEDModel"),c(qt,"class","relative group"),c(ls,"href","/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel"),c(nn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(nn,"rel","nofollow"),c(cs,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDModel"),c(ke,"class","docstring"),c($e,"class","docstring"),c(to,"id","transformers.LEDForConditionalGeneration"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.LEDForConditionalGeneration"),c(Dt,"class","relative group"),c(hs,"href","/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel"),c(hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(hn,"rel","nofollow"),c(ps,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(H,"class","docstring"),c(xe,"class","docstring"),c(no,"id","transformers.LEDForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.LEDForSequenceClassification"),c(Ft,"class","relative group"),c(us,"href","/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel"),c(Tn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Tn,"rel","nofollow"),c(ms,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDForSequenceClassification"),c(A,"class","docstring"),c(he,"class","docstring"),c(ao,"id","transformers.LEDForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.LEDForQuestionAnswering"),c(xt,"class","relative group"),c(fs,"href","/docs/transformers/pr_14934/en/main_classes/model#transformers.PreTrainedModel"),c(Fn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Fn,"rel","nofollow"),c(_s,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.LEDForQuestionAnswering"),c(te,"class","docstring"),c(pe,"class","docstring"),c(io,"id","transformers.TFLEDModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFLEDModel"),c(Ct,"class","relative group"),c(gs,"href","/docs/transformers/pr_14934/en/main_classes/model#transformers.TFPreTrainedModel"),c(An,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(An,"rel","nofollow"),c(vs,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.TFLEDModel"),c(be,"class","docstring"),c(ue,"class","docstring"),c(ho,"id","transformers.TFLEDForConditionalGeneration"),c(ho,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ho,"href","#transformers.TFLEDForConditionalGeneration"),c(Pt,"class","relative group"),c(Ts,"href","/docs/transformers/pr_14934/en/main_classes/model#transformers.TFPreTrainedModel"),c(Hn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Hn,"rel","nofollow"),c(ks,"href","/docs/transformers/pr_14934/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),c(we,"class","docstring"),c(me,"class","docstring")},m(o,p){e(document.head,u),h(o,L,p),h(o,b,p),e(b,E),e(E,q),g(y,q,null),e(b,w),e(b,D),e(D,je),h(o,ge,p),h(o,z,p),e(z,Y),e(Y,R),g(ne,R,null),e(z,Ie),e(z,V),e(V,Ge),h(o,Me,p),h(o,B,p),e(B,K),e(B,se),e(se,Le),e(B,S),h(o,P,p),h(o,ve,p),e(ve,ae),h(o,Se,p),h(o,Te,p),e(Te,X),e(X,Be),h(o,Ce,p),h(o,C,p),e(C,Qe),h(o,ee,p),h(o,x,p),e(x,M),e(M,Q),e(Q,He),e(M,We),e(M,j),e(j,Ue),e(M,re),e(M,De),e(De,m),e(M,F),e(M,de),e(de,st),e(M,at),e(M,I),e(I,rt),e(M,dt),e(M,Oe),e(Oe,J),e(M,ie),e(M,Pe),e(Pe,it),e(M,le),e(x,lt),e(x,ce),e(ce,Re),e(ce,Ve),e(Ve,Pd),e(ce,Ad),e(ce,Ss),e(Ss,Nd),e(ce,jd),e(x,Id),e(x,ze),e(ze,Gd),e(ze,Cs),e(Cs,Bd),e(ze,Qd),e(ze,Os),e(Os,Hd),e(ze,Wd),e(ze,Kn),e(Kn,Ud),e(ze,Rd),e(ze,Ps),e(Ps,Vd),e(ze,Kd),e(x,Xd),e(x,Z),e(Z,Jd),e(Z,As),e(As,Zd),e(Z,Yd),e(Z,Ns),e(Ns,ei),e(Z,ti),e(Z,Xn),e(Xn,oi),e(Z,ni),e(Z,js),e(js,si),e(Z,ai),e(Z,Is),e(Is,ri),e(Z,di),e(Z,Gs),e(Gs,ii),e(Z,li),e(x,ci),e(x,ct),e(ct,hi),e(ct,Bs),e(Bs,pi),e(ct,ui),e(ct,Qs),e(Qs,mi),e(ct,fi),e(x,_i),e(x,vo),e(vo,gi),e(vo,To),e(To,vi),e(vo,Ti),e(x,ki),e(x,ko),e(ko,bi),e(ko,bo),e(bo,wi),e(ko,yi),h(o,_r,p),h(o,Nt,p),e(Nt,Ei),e(Nt,wo),e(wo,qi),e(Nt,Li),h(o,gr,p),h(o,ht,p),e(ht,jt),e(jt,Hs),g(yo,Hs,null),e(ht,Di),e(ht,Ws),e(Ws,zi),h(o,vr,p),h(o,O,p),g(Eo,O,null),e(O,Fi),e(O,pt),e(pt,$i),e(pt,Jn),e(Jn,xi),e(pt,Mi),e(pt,qo),e(qo,Si),e(pt,Ci),e(O,Oi),e(O,ut),e(ut,Pi),e(ut,Zn),e(Zn,Ai),e(ut,Ni),e(ut,Yn),e(Yn,ji),e(ut,Ii),e(O,Gi),e(O,Us),e(Us,Bi),e(O,Qi),g(Lo,O,null),e(O,Hi),e(O,Rs),e(Rs,Vs),e(Vs,Ks),e(Ks,Xs),e(Xs,Wi),e(O,Ui),e(O,Js),e(Js,Zs),e(Zs,Ys),e(Ys,It),e(It,Gt),e(Gt,ea),g(Do,ea,null),e(It,Ri),e(It,ta),e(ta,Vi),e(O,Ki),e(O,oa),e(oa,na),e(na,zo),e(zo,Bt),e(Bt,Qt),e(Qt,sa),g(Fo,sa,null),e(Bt,Xi),e(Bt,aa),e(aa,Ji),e(zo,Zi),e(zo,ra),e(ra,Yi),e(O,el),e(O,da),e(da,ia),e(ia,la),e(la,Ht),e(Ht,Wt),e(Wt,ca),g($o,ca,null),e(Ht,tl),e(Ht,ha),e(ha,ol),h(o,Tr,p),h(o,mt,p),e(mt,Ut),e(Ut,pa),g(xo,pa,null),e(mt,nl),e(mt,ua),e(ua,sl),h(o,kr,p),h(o,N,p),g(Mo,N,null),e(N,al),e(N,ma),e(ma,rl),e(N,dl),e(N,Rt),e(Rt,es),e(es,il),e(Rt,ll),e(Rt,ts),e(ts,cl),e(Rt,hl),e(N,pl),e(N,So),e(So,ul),e(So,os),e(os,ml),e(So,fl),e(N,_l),e(N,Ke),g(Co,Ke,null),e(Ke,gl),e(Ke,fa),e(fa,vl),e(Ke,Tl),e(Ke,Oo),e(Oo,ns),e(ns,kl),e(ns,_a),e(_a,bl),e(Oo,wl),e(Oo,ss),e(ss,yl),e(ss,ga),e(ga,El),e(N,ql),e(N,Vt),g(Po,Vt,null),e(Vt,Ll),e(Vt,Ao),e(Ao,Dl),e(Ao,va),e(va,zl),e(Ao,Fl),e(N,$l),e(N,Kt),g(No,Kt,null),e(Kt,xl),e(Kt,Ta),e(Ta,Ml),e(N,Sl),e(N,as),g(jo,as,null),h(o,br,p),h(o,ft,p),e(ft,Xt),e(Xt,ka),g(Io,ka,null),e(ft,Cl),e(ft,ba),e(ba,Ol),h(o,wr,p),h(o,Fe,p),g(Go,Fe,null),e(Fe,Pl),e(Fe,Bo),e(Bo,Al),e(Bo,wa),e(wa,Nl),e(Bo,jl),e(Fe,Il),e(Fe,Jt),e(Jt,rs),e(rs,Gl),e(Jt,Bl),e(Jt,ds),e(ds,Ql),e(Jt,Hl),e(Fe,Wl),e(Fe,Qo),e(Qo,Ul),e(Qo,is),e(is,Rl),e(Qo,Vl),h(o,yr,p),h(o,_t,p),e(_t,Zt),e(Zt,ya),g(Ho,ya,null),e(_t,Kl),e(_t,Ea),e(Ea,Xl),h(o,Er,p),h(o,gt,p),g(Wo,gt,null),e(gt,Jl),e(gt,qa),e(qa,Zl),h(o,qr,p),h(o,vt,p),g(Uo,vt,null),e(vt,Yl),e(vt,La),e(La,ec),h(o,Lr,p),h(o,Tt,p),g(Ro,Tt,null),e(Tt,tc),e(Tt,Da),e(Da,oc),h(o,Dr,p),h(o,kt,p),g(Vo,kt,null),e(kt,nc),e(kt,za),e(za,sc),h(o,zr,p),h(o,bt,p),g(Ko,bt,null),e(bt,ac),e(bt,Fa),e(Fa,rc),h(o,Fr,p),h(o,wt,p),g(Xo,wt,null),e(wt,dc),e(wt,$a),e($a,ic),h(o,$r,p),h(o,yt,p),g(Jo,yt,null),e(yt,lc),e(yt,xa),e(xa,cc),h(o,xr,p),h(o,Et,p),g(Zo,Et,null),e(Et,hc),e(Et,Ma),e(Ma,pc),h(o,Mr,p),h(o,qt,p),e(qt,Yt),e(Yt,Sa),g(Yo,Sa,null),e(qt,uc),e(qt,Ca),e(Ca,mc),h(o,Sr,p),h(o,$e,p),g(en,$e,null),e($e,fc),e($e,tn),e(tn,_c),e(tn,ls),e(ls,gc),e(tn,vc),e($e,Tc),e($e,on),e(on,kc),e(on,nn),e(nn,bc),e(on,wc),e($e,yc),e($e,ke),g(sn,ke,null),e(ke,Ec),e(ke,Lt),e(Lt,qc),e(Lt,cs),e(cs,Lc),e(Lt,Dc),e(Lt,Oa),e(Oa,zc),e(Lt,Fc),e(ke,$c),g(eo,ke,null),e(ke,xc),e(ke,Pa),e(Pa,Mc),e(ke,Sc),g(an,ke,null),h(o,Cr,p),h(o,Dt,p),e(Dt,to),e(to,Aa),g(rn,Aa,null),e(Dt,Cc),e(Dt,Na),e(Na,Oc),h(o,Or,p),h(o,xe,p),g(dn,xe,null),e(xe,Pc),e(xe,ln),e(ln,Ac),e(ln,hs),e(hs,Nc),e(ln,jc),e(xe,Ic),e(xe,cn),e(cn,Gc),e(cn,hn),e(hn,Bc),e(cn,Qc),e(xe,Hc),e(xe,H),g(pn,H,null),e(H,Wc),e(H,zt),e(zt,Uc),e(zt,ps),e(ps,Rc),e(zt,Vc),e(zt,ja),e(ja,Kc),e(zt,Xc),e(H,Jc),g(oo,H,null),e(H,Zc),e(H,Ia),e(Ia,Yc),e(H,eh),g(un,H,null),e(H,th),e(H,Ga),e(Ga,oh),e(H,nh),g(mn,H,null),h(o,Pr,p),h(o,Ft,p),e(Ft,no),e(no,Ba),g(fn,Ba,null),e(Ft,sh),e(Ft,Qa),e(Qa,ah),h(o,Ar,p),h(o,he,p),g(_n,he,null),e(he,rh),e(he,Ha),e(Ha,dh),e(he,ih),e(he,gn),e(gn,lh),e(gn,us),e(us,ch),e(gn,hh),e(he,ph),e(he,vn),e(vn,uh),e(vn,Tn),e(Tn,mh),e(vn,fh),e(he,_h),e(he,A),g(kn,A,null),e(A,gh),e(A,$t),e($t,vh),e($t,ms),e(ms,Th),e($t,kh),e($t,Wa),e(Wa,bh),e($t,wh),e(A,yh),g(so,A,null),e(A,Eh),e(A,Ua),e(Ua,qh),e(A,Lh),g(bn,A,null),e(A,Dh),g(wn,A,null),e(A,zh),e(A,Ra),e(Ra,Fh),e(A,$h),g(yn,A,null),e(A,xh),g(En,A,null),h(o,Nr,p),h(o,xt,p),e(xt,ao),e(ao,Va),g(qn,Va,null),e(xt,Mh),e(xt,Ka),e(Ka,Sh),h(o,jr,p),h(o,pe,p),g(Ln,pe,null),e(pe,Ch),e(pe,Mt),e(Mt,Oh),e(Mt,Xa),e(Xa,Ph),e(Mt,Ah),e(Mt,Ja),e(Ja,Nh),e(Mt,jh),e(pe,Ih),e(pe,Dn),e(Dn,Gh),e(Dn,fs),e(fs,Bh),e(Dn,Qh),e(pe,Hh),e(pe,zn),e(zn,Wh),e(zn,Fn),e(Fn,Uh),e(zn,Rh),e(pe,Vh),e(pe,te),g($n,te,null),e(te,Kh),e(te,St),e(St,Xh),e(St,_s),e(_s,Jh),e(St,Zh),e(St,Za),e(Za,Yh),e(St,ep),e(te,tp),g(ro,te,null),e(te,op),e(te,Ya),e(Ya,np),e(te,sp),g(xn,te,null),e(te,ap),g(Mn,te,null),h(o,Ir,p),h(o,Ct,p),e(Ct,io),e(io,er),g(Sn,er,null),e(Ct,rp),e(Ct,tr),e(tr,dp),h(o,Gr,p),h(o,ue,p),g(Cn,ue,null),e(ue,ip),e(ue,On),e(On,lp),e(On,gs),e(gs,cp),e(On,hp),e(ue,pp),e(ue,Pn),e(Pn,up),e(Pn,An),e(An,mp),e(Pn,fp),e(ue,_p),g(lo,ue,null),e(ue,gp),e(ue,be),g(Nn,be,null),e(be,vp),e(be,Ot),e(Ot,Tp),e(Ot,vs),e(vs,kp),e(Ot,bp),e(Ot,or),e(or,wp),e(Ot,yp),e(be,Ep),g(co,be,null),e(be,qp),e(be,nr),e(nr,Lp),e(be,Dp),g(jn,be,null),h(o,Br,p),h(o,Pt,p),e(Pt,ho),e(ho,sr),g(In,sr,null),e(Pt,zp),e(Pt,ar),e(ar,Fp),h(o,Qr,p),h(o,me,p),g(Gn,me,null),e(me,$p),e(me,Bn),e(Bn,xp),e(Bn,Ts),e(Ts,Mp),e(Bn,Sp),e(me,Cp),e(me,Qn),e(Qn,Op),e(Qn,Hn),e(Hn,Pp),e(Qn,Ap),e(me,Np),g(po,me,null),e(me,jp),e(me,we),g(Wn,we,null),e(we,Ip),e(we,At),e(At,Gp),e(At,ks),e(ks,Bp),e(At,Qp),e(At,rr),e(rr,Hp),e(At,Wp),e(we,Up),g(uo,we,null),e(we,Rp),e(we,dr),e(dr,Vp),e(we,Kp),g(Un,we,null),Hr=!0},p(o,[p]){const Rn={};p&2&&(Rn.$$scope={dirty:p,ctx:o}),eo.$set(Rn);const ir={};p&2&&(ir.$$scope={dirty:p,ctx:o}),oo.$set(ir);const lr={};p&2&&(lr.$$scope={dirty:p,ctx:o}),so.$set(lr);const cr={};p&2&&(cr.$$scope={dirty:p,ctx:o}),ro.$set(cr);const Vn={};p&2&&(Vn.$$scope={dirty:p,ctx:o}),lo.$set(Vn);const hr={};p&2&&(hr.$$scope={dirty:p,ctx:o}),co.$set(hr);const pr={};p&2&&(pr.$$scope={dirty:p,ctx:o}),po.$set(pr);const ur={};p&2&&(ur.$$scope={dirty:p,ctx:o}),uo.$set(ur)},i(o){Hr||(v(y.$$.fragment,o),v(ne.$$.fragment,o),v(yo.$$.fragment,o),v(Eo.$$.fragment,o),v(Lo.$$.fragment,o),v(Do.$$.fragment,o),v(Fo.$$.fragment,o),v($o.$$.fragment,o),v(xo.$$.fragment,o),v(Mo.$$.fragment,o),v(Co.$$.fragment,o),v(Po.$$.fragment,o),v(No.$$.fragment,o),v(jo.$$.fragment,o),v(Io.$$.fragment,o),v(Go.$$.fragment,o),v(Ho.$$.fragment,o),v(Wo.$$.fragment,o),v(Uo.$$.fragment,o),v(Ro.$$.fragment,o),v(Vo.$$.fragment,o),v(Ko.$$.fragment,o),v(Xo.$$.fragment,o),v(Jo.$$.fragment,o),v(Zo.$$.fragment,o),v(Yo.$$.fragment,o),v(en.$$.fragment,o),v(sn.$$.fragment,o),v(eo.$$.fragment,o),v(an.$$.fragment,o),v(rn.$$.fragment,o),v(dn.$$.fragment,o),v(pn.$$.fragment,o),v(oo.$$.fragment,o),v(un.$$.fragment,o),v(mn.$$.fragment,o),v(fn.$$.fragment,o),v(_n.$$.fragment,o),v(kn.$$.fragment,o),v(so.$$.fragment,o),v(bn.$$.fragment,o),v(wn.$$.fragment,o),v(yn.$$.fragment,o),v(En.$$.fragment,o),v(qn.$$.fragment,o),v(Ln.$$.fragment,o),v($n.$$.fragment,o),v(ro.$$.fragment,o),v(xn.$$.fragment,o),v(Mn.$$.fragment,o),v(Sn.$$.fragment,o),v(Cn.$$.fragment,o),v(lo.$$.fragment,o),v(Nn.$$.fragment,o),v(co.$$.fragment,o),v(jn.$$.fragment,o),v(In.$$.fragment,o),v(Gn.$$.fragment,o),v(po.$$.fragment,o),v(Wn.$$.fragment,o),v(uo.$$.fragment,o),v(Un.$$.fragment,o),Hr=!0)},o(o){T(y.$$.fragment,o),T(ne.$$.fragment,o),T(yo.$$.fragment,o),T(Eo.$$.fragment,o),T(Lo.$$.fragment,o),T(Do.$$.fragment,o),T(Fo.$$.fragment,o),T($o.$$.fragment,o),T(xo.$$.fragment,o),T(Mo.$$.fragment,o),T(Co.$$.fragment,o),T(Po.$$.fragment,o),T(No.$$.fragment,o),T(jo.$$.fragment,o),T(Io.$$.fragment,o),T(Go.$$.fragment,o),T(Ho.$$.fragment,o),T(Wo.$$.fragment,o),T(Uo.$$.fragment,o),T(Ro.$$.fragment,o),T(Vo.$$.fragment,o),T(Ko.$$.fragment,o),T(Xo.$$.fragment,o),T(Jo.$$.fragment,o),T(Zo.$$.fragment,o),T(Yo.$$.fragment,o),T(en.$$.fragment,o),T(sn.$$.fragment,o),T(eo.$$.fragment,o),T(an.$$.fragment,o),T(rn.$$.fragment,o),T(dn.$$.fragment,o),T(pn.$$.fragment,o),T(oo.$$.fragment,o),T(un.$$.fragment,o),T(mn.$$.fragment,o),T(fn.$$.fragment,o),T(_n.$$.fragment,o),T(kn.$$.fragment,o),T(so.$$.fragment,o),T(bn.$$.fragment,o),T(wn.$$.fragment,o),T(yn.$$.fragment,o),T(En.$$.fragment,o),T(qn.$$.fragment,o),T(Ln.$$.fragment,o),T($n.$$.fragment,o),T(ro.$$.fragment,o),T(xn.$$.fragment,o),T(Mn.$$.fragment,o),T(Sn.$$.fragment,o),T(Cn.$$.fragment,o),T(lo.$$.fragment,o),T(Nn.$$.fragment,o),T(co.$$.fragment,o),T(jn.$$.fragment,o),T(In.$$.fragment,o),T(Gn.$$.fragment,o),T(po.$$.fragment,o),T(Wn.$$.fragment,o),T(uo.$$.fragment,o),T(Un.$$.fragment,o),Hr=!1},d(o){t(u),o&&t(L),o&&t(b),k(y),o&&t(ge),o&&t(z),k(ne),o&&t(Me),o&&t(B),o&&t(P),o&&t(ve),o&&t(Se),o&&t(Te),o&&t(Ce),o&&t(C),o&&t(ee),o&&t(x),o&&t(_r),o&&t(Nt),o&&t(gr),o&&t(ht),k(yo),o&&t(vr),o&&t(O),k(Eo),k(Lo),k(Do),k(Fo),k($o),o&&t(Tr),o&&t(mt),k(xo),o&&t(kr),o&&t(N),k(Mo),k(Co),k(Po),k(No),k(jo),o&&t(br),o&&t(ft),k(Io),o&&t(wr),o&&t(Fe),k(Go),o&&t(yr),o&&t(_t),k(Ho),o&&t(Er),o&&t(gt),k(Wo),o&&t(qr),o&&t(vt),k(Uo),o&&t(Lr),o&&t(Tt),k(Ro),o&&t(Dr),o&&t(kt),k(Vo),o&&t(zr),o&&t(bt),k(Ko),o&&t(Fr),o&&t(wt),k(Xo),o&&t($r),o&&t(yt),k(Jo),o&&t(xr),o&&t(Et),k(Zo),o&&t(Mr),o&&t(qt),k(Yo),o&&t(Sr),o&&t($e),k(en),k(sn),k(eo),k(an),o&&t(Cr),o&&t(Dt),k(rn),o&&t(Or),o&&t(xe),k(dn),k(pn),k(oo),k(un),k(mn),o&&t(Pr),o&&t(Ft),k(fn),o&&t(Ar),o&&t(he),k(_n),k(kn),k(so),k(bn),k(wn),k(yn),k(En),o&&t(Nr),o&&t(xt),k(qn),o&&t(jr),o&&t(pe),k(Ln),k($n),k(ro),k(xn),k(Mn),o&&t(Ir),o&&t(Ct),k(Sn),o&&t(Gr),o&&t(ue),k(Cn),k(lo),k(Nn),k(co),k(jn),o&&t(Br),o&&t(Pt),k(In),o&&t(Qr),o&&t(me),k(Gn),k(po),k(Wn),k(uo),k(Un)}}}const Vf={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function Kf(G){return Nf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class t_ extends Cf{constructor(u){super();Of(this,u,Kf,Rf,Pf,{})}}export{t_ as default,Vf as metadata};
