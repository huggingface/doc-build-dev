import{S as LM,i as AM,s as OM,e as n,k as p,w as y,t as r,M as NM,c as s,d as t,m as h,a,x as T,h as i,b as u,F as e,g as k,y as w,q as $,o as F,B as x,v as IM,L as Z}from"../../chunks/vendor-6b77c823.js";import{T as fe}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-1088f2fb.js";import{C as ee}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as $e}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Y}from"../../chunks/ExampleCodeBlock-5212b321.js";function DM(R){let d,g,c,m,_;return m=new ee({props:{code:`from transformers import RobertaConfig, RobertaModel
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15977/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15977/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15977/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var x7=a(kh);V$=i(x7,"Finally, this model supports inherent JAX features such as:"),x7.forEach(t),J$=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var R7=a(vh);tl=s(R7,"A",{href:!0,rel:!0});var M7=a(tl);K$=i(M7,"Just-In-Time (JIT) compilation"),M7.forEach(t),R7.forEach(t),G$=h(ha),yh=s(ha,"LI",{});var E7=a(yh);ol=s(E7,"A",{href:!0,rel:!0});var z7=a(ol);X$=i(z7,"Automatic Differentiation"),z7.forEach(t),E7.forEach(t),Y$=h(ha),Th=s(ha,"LI",{});var C7=a(Th);nl=s(C7,"A",{href:!0,rel:!0});var q7=a(nl);Z$=i(q7,"Vectorization"),q7.forEach(t),C7.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var j7=a(wh);sl=s(j7,"A",{href:!0,rel:!0});var P7=a(sl);t2=i(P7,"Parallelization"),P7.forEach(t),j7.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n2=h(ma),an=s(ma,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var L7=a($h);a2=i(L7,"FlaxRobertaPreTrainedModel"),L7.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A7=a(Fh);i2=i(A7,"__call__"),A7.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ma),T(Bs.$$.fragment,ma),c2=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var O7=a(Hs);xh=s(O7,"SPAN",{});var N7=a(xh);T(rl.$$.fragment,N7),N7.forEach(t),O7.forEach(t),p2=h(Gu),Rh=s(Gu,"SPAN",{});var I7=a(Rh);h2=i(I7,"FlaxRobertaForMultipleChoice"),I7.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m2=h(vt),Mh=s(vt,"P",{});var D7=a(Mh);f2=i(D7,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D7.forEach(t),u2=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g2=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var S7=a(Ad);_2=i(S7,"FlaxPreTrainedModel"),S7.forEach(t),b2=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k2=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v2=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var W7=a(cl);y2=i(W7,"flax.linen.Module"),W7.forEach(t),T2=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w2=h(vt),Eh=s(vt,"P",{});var B7=a(Eh);$2=i(B7,"Finally, this model supports inherent JAX features such as:"),B7.forEach(t),F2=h(vt),Jt=s(vt,"UL",{});var fa=a(Jt);zh=s(fa,"LI",{});var U7=a(zh);pl=s(U7,"A",{href:!0,rel:!0});var H7=a(pl);x2=i(H7,"Just-In-Time (JIT) compilation"),H7.forEach(t),U7.forEach(t),R2=h(fa),Ch=s(fa,"LI",{});var Q7=a(Ch);hl=s(Q7,"A",{href:!0,rel:!0});var V7=a(hl);M2=i(V7,"Automatic Differentiation"),V7.forEach(t),Q7.forEach(t),E2=h(fa),qh=s(fa,"LI",{});var J7=a(qh);ml=s(J7,"A",{href:!0,rel:!0});var K7=a(ml);z2=i(K7,"Vectorization"),K7.forEach(t),J7.forEach(t),C2=h(fa),jh=s(fa,"LI",{});var G7=a(jh);fl=s(G7,"A",{href:!0,rel:!0});var X7=a(fl);q2=i(X7,"Parallelization"),X7.forEach(t),G7.forEach(t),fa.forEach(t),j2=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);T(ul.$$.fragment,ua),P2=h(ua),ln=s(ua,"P",{});var lc=a(ln);L2=i(lc,"The "),Ph=s(lc,"CODE",{});var Y7=a(Ph);A2=i(Y7,"FlaxRobertaPreTrainedModel"),Y7.forEach(t),O2=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var Z7=a(Lh);N2=i(Z7,"__call__"),Z7.forEach(t),I2=i(lc," special method."),lc.forEach(t),D2=h(ua),T(Qs.$$.fragment,ua),S2=h(ua),T(Vs.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Js=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Js);Ah=s(eM,"SPAN",{});var tM=a(Ah);T(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W2=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B2=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var yt=a(We);T(_l.$$.fragment,yt),U2=h(yt),Nh=s(yt,"P",{});var nM=a(Nh);H2=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
