...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=s("p"),T=n("Examples:"),_=p(),v(g.$$.fragment)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Examples:"),f.forEach(t),_=u(d),y(g.$$.fragment,d)},m(d,f){m(d,h,f),e(h,T),m(d,_,f),b(g,d,f),x=!0},p:pa,i(d){x||(L(g.$$.fragment,d),x=!0)},o(d){w(g.$$.fragment,d),x=!1},d(d){d&&t(h),d&&t(_),k(g,d)}}}function cv(P){let h,T,_,g,x,d,f,D,Ci,sr,xe,Be,ua,Mo,Ii,ma,Ai,rr,pe,Di,$o,Oi,Ni,Jt,Si,Ri,ir,ue,H,Ui,Eo,Bi,Wi,zo,Vi,Qi,qo,Gi,Hi,Fo,Ki,Xi,Yi,Po,Zi,jo,Ji,el,ol,Co,tl,Io,nl,al,lr,en,sl,cr,on,ha,rl,dr,tn,il,pr,B,fa,ll,cl,Ao,dl,Do,pl,ul,ml,Oo,hl,No,fl,gl,_l,Te,vl,So,yl,bl,Ro,Ll,wl,kl,M,xl,ga,Tl,Ml,nn,$l,El,_a,zl,ql,va,Fl,Pl,ya,jl,Cl,ba,Il,Al,La,Dl,Ol,wa,Nl,Sl,ka,Rl,Ul,an,Bl,Wl,Uo,Vl,Ql,Bo,Gl,Hl,ur,Wo,mr,me,Kl,xa,Xl,Yl,Ta,Zl,Jl,hr,Vo,fr,We,ec,sn,oc,tc,gr,he,I,nc,rn,ac,sc,Ma,rc,ic,$a,lc,cc,ln,dc,pc,Ea,uc,mc,za,hc,fc,qa,gc,_c,vc,Qo,yc,cn,bc,Lc,wc,Go,kc,Fa,xc,Tc,_r,Ve,Mc,dn,$c,Ec,vr,Me,Qe,Pa,Ho,zc,ja,qc,yr,W,Fc,pn,Pc,jc,un,Cc,Ic,mn,Ac,Dc,hn,Oc,Nc,br,Ko,Lr,E,Sc,fn,Rc,Uc,gn,Bc,Wc,Ca,Vc,Qc,_n,Gc,Hc,vn,Kc,Xc,Ia,Yc,Zc,Aa,Jc,ed,Da,od,td,Oa,nd,ad,Na,sd,rd,wr,R,yn,id,ld,Xo,cd,dd,bn,pd,ud,Sa,md,hd,Ra,fd,gd,kr,Ln,_d,xr,wn,Ua,vd,Tr,kn,yd,Mr,Yo,$r,xn,Ba,bd,Er,fe,Ld,Wa,wd,kd,Va,xd,Td,zr,Zo,qr,Tn,Qa,Md,Fr,V,$d,Ga,Ed,zd,Ha,qd,Fd,Ka,Pd,jd,Xa,Cd,Id,Pr,Jo,jr,Mn,Ya,Ad,Cr,$n,Dd,Ir,et,Ar,En,Za,Od,Dr,zn,Nd,Or,ot,Nr,$e,Ge,Ja,tt,Sd,es,Rd,Sr,K,nt,Ud,Ee,Bd,qn,Wd,Vd,at,Qd,Gd,Hd,ze,Kd,Fn,Xd,Yd,Pn,Zd,Jd,ep,He,Rr,qe,Ke,os,st,op,ts,tp,Ur,X,rt,np,ns,ap,sp,it,rp,as,ip,lp,cp,ge,lt,dp,ss,pp,up,Xe,Br,Fe,Ye,rs,ct,mp,is,hp,Wr,O,dt,fp,N,gp,jn,_p,vp,ls,yp,bp,cs,Lp,wp,ds,kp,xp,ps,Tp,Mp,us,$p,Ep,zp,pt,qp,Cn,Fp,Pp,jp,In,An,Cp,Ip,Ap,Ze,ut,Dp,ms,Op,Np,Dn,mt,Vr,Pe,Je,hs,ht,Sp,fs,Rp,Qr,Y,ft,Up,gt,Bp,gs,Wp,Vp,Qp,_t,Gp,On,Hp,Kp,Xp,eo,vt,Yp,_s,Zp,Gr,je,oo,vs,yt,Jp,ys,eu,Hr,U,bt,ou,bs,tu,nu,Nn,Sn,au,su,ru,F,iu,Rn,lu,cu,Un,du,pu,Bn,uu,mu,Ls,hu,fu,ws,gu,_u,ks,vu,yu,xs,bu,Lu,Ts,wu,ku,Ms,xu,Tu,Mu,_e,Lt,$u,$,Eu,$s,zu,qu,wt,Es,Fu,Pu,ju,Wn,Cu,Iu,zs,Au,Du,qs,Ou,Nu,kt,Fs,Su,Ru,Uu,Ps,Bu,Wu,Vn,Vu,Qu,js,Gu,Hu,Cs,Ku,Xu,Is,Yu,Zu,As,Ju,em,om,Ds,tm,Kr,Ce,to,Os,xt,nm,Ns,am,Xr,le,Tt,sm,Mt,rm,$t,im,lm,cm,te,Et,dm,Ie,pm,Qn,um,mm,Ss,hm,fm,gm,no,_m,ao,Yr,Ae,so,Rs,zt,vm,Us,ym,Zr,Z,qt,bm,Ft,Lm,Pt,wm,km,xm,jt,Tm,Ct,Mm,$m,Em,ne,It,zm,De,qm,Gn,Fm,Pm,Bs,jm,Cm,Im,ro,Am,io,Jr,Oe,lo,Ws,At,Dm,Vs,Om,ei,J,Dt,Nm,ee,Sm,Ot,Rm,Um,Nt,Bm,Wm,St,Vm,Qm,Rt,Gm,Hm,Km,Ut,Xm,Bt,Ym,Zm,Jm,ae,Wt,eh,Ne,oh,Hn,th,nh,Qs,ah,sh,rh,co,ih,po,oi,Se,uo,Gs,Vt,lh,Hs,ch,ti,oe,Qt,dh,ce,ph,Gt,uh,mh,Ks,hh,fh,Xs,gh,_h,vh,Ht,yh,Kt,bh,Lh,wh,se,Xt,kh,Re,xh,Kn,Th,Mh,Ys,$h,Eh,zh,mo,qh,ho,ni;return d=new ie({}),Mo=new ie({}),Wo=new G({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Model">LayoutLMv2Model</a> or
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15977/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a> with the following fields:</p>
<ul>
<li><strong>pixel_values</strong> \u2014 Pixel values to be fed to a model, of shape (batch_size, num_channels, height,
width).</li>
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LayoutLMv2Tokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_15977/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L414"}}),mt=new A({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L394"}}),ht=new ie({}),ft=new A({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),Lt=new A({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),xt=new ie({}),Tt=new A({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15977/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L709"}}),Et=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_15977/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_15977/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15977/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config"
...
`}}),no=new ji({props:{$$slots:{default:[ov]},$$scope:{ctx:P}}}),ao=new da({props:{anchor:"transformers.LayoutLMv2Model.forward.example",$$slots:{default:[tv]},$$scope:{ctx:P}}}),zt=new ie({}),qt=new A({props:{name:"class transformers.LayoutLMv2ForSequenceClassification",anchor:"transformers.LayoutLMv2ForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15977/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L954"}}),It=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_15977/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15977/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L968",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15977/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1123"}}),Wt=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_15977/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15977/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1137",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_15977/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1246",returnDescription:`
<p>A <a
...
`),_a=s("code"),zl=n("image"),ql=n(" and "),va=s("code"),Fl=n("bbox"),Pl=n(". The "),ya=s("code"),jl=n("image"),Cl=n(` input corresponds to the original document image in which the text
...
`),qa=s("code"),gc=n("config.image_feature_pool_shape[1]"),_c=n("."),vc=p(),Qo=s("li"),yc=n("When calling "),cn=s("a"),bc=n("from_pretrained()"),Lc=n(`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),wc=p(),Go=s("li"),kc=n("If you want to train the model in a distributed environment, make sure to call "),Fa=s("code"),xc=n("synchronize_batch_norm"),Tc=n(` on the
...
`),dn=s("a"),$c=n("LayoutXLM\u2019s documentation page"),Ec=n("."),vr=p(),Me=s("h2"),Qe=s("a"),Pa=s("span"),v(Ho.$$.fragment),zc=p(),ja=s("span"),qc=n("Usage: LayoutLMv2Processor"),yr=p(),W=s("p"),Fc=n("The easiest way to prepare data for the model is to use "),pn=s("a"),Pc=n("LayoutLMv2Processor"),jc=n(`, which internally
...
the processor.`),zr=p(),v(Zo.$$.fragment),qr=p(),Tn=s("p"),Qa=s("strong"),Md=n("Use case 3: token classification (training), apply_ocr=False"),Fr=p(),V=s("p"),$d=n(`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Or=p(),v(ot.$$.fragment),Nr=p(),$e=s("h2"),Ge=s("a"),Ja=s("span"),v(tt.$$.fragment),Sd=p(),es=s("span"),Rd=n("LayoutLMv2Config"),Sr=p(),K=s("div"),v(nt.$$.fragment),Ud=p(),Ee=s("p"),Bd=n("This is the configuration class to store the configuration of a "),qn=s("a"),Wd=n("LayoutLMv2Model"),Vd=n(`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
`),at=s("a"),Qd=n("microsoft/layoutlmv2-base-uncased"),Gd=n(" architecture."),Hd=p(),ze=s("p"),Kd=n("Configuration objects inherit from "),Fn=s("a"),Xd=n("PretrainedConfig"),Yd=n(` and can be used to control the model outputs. Read the
documentation from `),Pn=s("a"),Zd=n("PretrainedConfig"),Jd=n(" for more information."),ep=p(),v(He.$$.fragment),Rr=p(),qe=s("h2"),Ke=s("a"),os=s("span"),v(st.$$.fragment),op=p(),ts=s("span"),tp=n("LayoutLMv2FeatureExtractor"),Ur=p(),X=s("div"),v(rt.$$.fragment),np=p(),ns=s("p"),ap=n(`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
optional `),us=s("code"),$p=n("labels"),Ep=n(" (for token classification)."),zp=p(),pt=s("p"),qp=n("This tokenizer inherits from "),Cn=s("a"),Fp=n("PreTrainedTokenizer"),Pp=n(` which contains most of the main methods. Users should refer to
...
single processor.`),nu=p(),Nn=s("p"),Sn=s("a"),au=n("LayoutLMv2Processor"),su=n(" offers all the functionalities you need to prepare data for the model."),ru=p(),F=s("p"),iu=n("It first uses "),Rn=s("a"),lu=n("LayoutLMv2FeatureExtractor"),cu=n(` to resize document images to a fixed size, and optionally applies OCR
...
into token-level `),Ms=s("code"),xu=n("labels"),Tu=n(" for token classification tasks (such as FUNSD, CORD)."),Mu=p(),_e=s("div"),v(Lt.$$.fragment),$u=p(),$=s("p"),Eu=n("This method first forwards the "),$s=s("code"),zu=n("images"),qu=n(" argument to "),wt=s("a"),Es=s("strong"),Fu=n("call"),Pu=n("()"),ju=n(`. In case
`),Wn=s("a"),Cu=n("LayoutLMv2FeatureExtractor"),Iu=n(" was initialized with "),zs=s("code"),Au=n("apply_ocr"),Du=n(" set to "),qs=s("code"),Ou=n("True"),Nu=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=s("a"),Fs=s("strong"),Su=n("call"),Ru=n("()"),Uu=n(` and returns the output,
...
dataset (a collection of 800 receipts for training, 100 for validation and 100 for testing), the `),qo=r(ve,"A",{href:!0,rel:!0});var Oh=i(qo);Gi=a(Oh,"SROIE"),Oh.forEach(t),Hi=a(ve,` dataset (a collection of 626 receipts for training and 347 receipts for testing)
and the `),Fo=r(ve,"A",{href:!0,rel:!0});var Nh=i(Fo);Ki=a(Nh,"Kleister-NDA"),Nh.forEach(t),Xi=a(ve,` dataset (a collection of non-disclosure
agreements from the EDGAR database, including 254 documents for training, 83 documents for validation, and 203
...
`),_a=r(z,"CODE",{});var Jh=i(_a);zl=a(Jh,"image"),Jh.forEach(t),ql=a(z," and "),va=r(z,"CODE",{});var ef=i(va);Fl=a(ef,"bbox"),ef.forEach(t),Pl=a(z,". The "),ya=r(z,"CODE",{});var of=i(ya);jl=a(of,"image"),of.forEach(t),Cl=a(z,` input corresponds to the original document image in which the text
tokens occur. The model expects each document image to be of size 224x224. This means that if you have a batch of
...
`),qa=r(S,"CODE",{});var yf=i(qa);gc=a(yf,"config.image_feature_pool_shape[1]"),yf.forEach(t),_c=a(S,"."),S.forEach(t),vc=u(Jn),Qo=r(Jn,"LI",{});var ci=i(Qo);yc=a(ci,"When calling "),cn=r(ci,"A",{href:!0});var bf=i(cn);bc=a(bf,"from_pretrained()"),bf.forEach(t),Lc=a(ci,`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),ci.forEach(t),wc=u(Jn),Go=r(Jn,"LI",{});var di=i(Go);kc=a(di,"If you want to train the model in a distributed environment, make sure to call "),Fa=r(di,"CODE",{});var Lf=i(Fa);xc=a(Lf,"synchronize_batch_norm"),Lf.forEach(t),Tc=a(di,` on the
...
`),dn=r(pi,"A",{href:!0});var wf=i(dn);$c=a(wf,"LayoutXLM\u2019s documentation page"),wf.forEach(t),Ec=a(pi,"."),pi.forEach(t),vr=u(o),Me=r(o,"H2",{class:!0});var ui=i(Me);Qe=r(ui,"A",{id:!0,class:!0,href:!0});var kf=i(Qe);Pa=r(kf,"SPAN",{});var xf=i(Pa);y(Ho.$$.fragment,xf),xf.forEach(t),kf.forEach(t),zc=u(ui),ja=r(ui,"SPAN",{});var Tf=i(ja);qc=a(Tf,"Usage: LayoutLMv2Processor"),Tf.forEach(t),ui.forEach(t),yr=u(o),W=r(o,"P",{});var be=i(W);Fc=a(be,"The easiest way to prepare data for the model is to use "),pn=r(be,"A",{href:!0});var Mf=i(pn);Pc=a(Mf,"LayoutLMv2Processor"),Mf.forEach(t),jc=a(be,`, which internally
...
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),be.forEach(t),br=u(o),y(Ko.$$.fragment,o),Lr=u(o),E=r(o,"P",{});var j=i(E);Sc=a(j,"In short, one can provide a document image (and possibly additional data) to "),fn=r(j,"A",{href:!0});var qf=i(fn);Rc=a(qf,"LayoutLMv2Processor"),qf.forEach(t),Uc=a(j,`,
and it will create the inputs expected by the model. Internally, the processor first uses
`),gn=r(j,"A",{href:!0});var Ff=i(gn);Bc=a(Ff,"LayoutLMv2FeatureExtractor"),Ff.forEach(t),Wc=a(j,` to apply OCR on the image to get a list of words and normalized
...
the processor.`),ea.forEach(t),zr=u(o),y(Zo.$$.fragment,o),qr=u(o),Tn=r(o,"P",{});var Jf=i(Tn);Qa=r(Jf,"STRONG",{});var eg=i(Qa);Md=a(eg,"Use case 3: token classification (training), apply_ocr=False"),eg.forEach(t),Jf.forEach(t),Fr=u(o),V=r(o,"P",{});var Le=i(V);$d=a(Le,`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
documentation from `),Pn=r(ta,"A",{href:!0});var _g=i(Pn);Zd=a(_g,"PretrainedConfig"),_g.forEach(t),Jd=a(ta," for more information."),ta.forEach(t),ep=u(fo),y(He.$$.fragment,fo),fo.forEach(t),Rr=u(o),qe=r(o,"H2",{class:!0});var hi=i(qe);Ke=r(hi,"A",{id:!0,class:!0,href:!0});var vg=i(Ke);os=r(vg,"SPAN",{});var yg=i(os);y(st.$$.fragment,yg),yg.forEach(t),vg.forEach(t),op=u(hi),ts=r(hi,"SPAN",{});var bg=i(ts);tp=a(bg,"LayoutLMv2FeatureExtractor"),bg.forEach(t),hi.forEach(t),Ur=u(o),X=r(o,"DIV",{class:!0});var go=i(X);y(rt.$$.fragment,go),np=u(go),ns=r(go,"P",{});var Lg=i(ns);ap=a(Lg,`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),fi.forEach(t),cp=u(go),ge=r(go,"DIV",{class:!0});var na=i(ge);y(lt.$$.fragment,na),dp=u(na),ss=r(na,"P",{});var kg=i(ss);pp=a(kg,"Main method to prepare for the model one or several image(s)."),kg.forEach(t),up=u(na),y(Xe.$$.fragment,na),na.forEach(t),go.forEach(t),Br=u(o),Fe=r(o,"H2",{class:!0});var gi=i(Fe);Ye=r(gi,"A",{id:!0,class:!0,href:!0});var xg=i(Ye);rs=r(xg,"SPAN",{});var Tg=i(rs);y(ct.$$.fragment,Tg),Tg.forEach(t),xg.forEach(t),mp=u(gi),is=r(gi,"SPAN",{});var Mg=i(is);hp=a(Mg,"LayoutLMv2Tokenizer"),Mg.forEach(t),gi.forEach(t),Wr=u(o),O=r(o,"DIV",{class:!0});var re=i(O);y(dt.$$.fragment,re),fp=u(re),N=r(re,"P",{});var Q=i(N);gp=a(Q,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),jn=r(Q,"A",{href:!0});var $g=i(jn);_p=a($g,"LayoutLMv2Tokenizer"),$g.forEach(t),vp=a(Q,` can be used to turn words, word-level
bounding boxes and optional word labels to token-level `),ls=r(Q,"CODE",{});var Eg=i(ls);yp=a(Eg,"input_ids"),Eg.forEach(t),bp=a(Q,", "),cs=r(Q,"CODE",{});var zg=i(cs);Lp=a(zg,"attention_mask"),zg.forEach(t),wp=a(Q,", "),ds=r(Q,"CODE",{});var qg=i(ds);kp=a(qg,"token_type_ids"),qg.forEach(t),xp=a(Q,", "),ps=r(Q,"CODE",{});var Fg=i(ps);Tp=a(Fg,"bbox"),Fg.forEach(t),Mp=a(Q,`, and
optional `),us=r(Q,"CODE",{});var Pg=i(us);$p=a(Pg,"labels"),Pg.forEach(t),Ep=a(Q," (for token classification)."),Q.forEach(t),zp=u(re),pt=r(re,"P",{});var _i=i(pt);qp=a(_i,"This tokenizer inherits from "),Cn=r(_i,"A",{href:!0});var jg=i(Cn);Fp=a(jg,"PreTrainedTokenizer"),jg.forEach(t),Pp=a(_i,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),_i.forEach(t),jp=u(re),In=r(re,"P",{});var Fh=i(In);An=r(Fh,"A",{href:!0});var Cg=i(An);Cp=a(Cg,"LayoutLMv2Tokenizer"),Cg.forEach(t),Ip=a(Fh,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),Fh.forEach(t),Ap=u(re),Ze=r(re,"DIV",{class:!0});var vi=i(Ze);y(ut.$$.fragment,vi),Dp=u(vi),ms=r(vi,"P",{});var Ig=i(ms);Op=a(Ig,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
into token-level `),Ms=r(C,"CODE",{});var t_=i(Ms);xu=a(t_,"labels"),t_.forEach(t),Tu=a(C," for token classification tasks (such as FUNSD, CORD)."),C.forEach(t),Mu=u(we),_e=r(we,"DIV",{class:!0});var aa=i(_e);y(Lt.$$.fragment,aa),$u=u(aa),$=r(aa,"P",{});var q=i($);Eu=a(q,"This method first forwards the "),$s=r(q,"CODE",{});var n_=i($s);zu=a(n_,"images"),n_.forEach(t),qu=a(q," argument to "),wt=r(q,"A",{href:!0});var jh=i(wt);Es=r(jh,"STRONG",{});var a_=i(Es);Fu=a(a_,"call"),a_.forEach(t),Pu=a(jh,"()"),jh.forEach(t),ju=a(q,`. In case
`),Wn=r(q,"A",{href:!0});var s_=i(Wn);Cu=a(s_,"LayoutLMv2FeatureExtractor"),s_.forEach(t),Iu=a(q," was initialized with "),zs=r(q,"CODE",{});var r_=i(zs);Au=a(r_,"apply_ocr"),r_.forEach(t),Du=a(q," set to "),qs=r(q,"CODE",{});var i_=i(qs);Ou=a(i_,"True"),i_.forEach(t),Nu=a(q,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=r(q,"A",{href:!0});var Ch=i(kt);Fs=r(Ch,"STRONG",{});var l_=i(Fs);Su=a(l_,"call"),l_.forEach(t),Ru=a(Ch,"()"),Ch.forEach(t),Uu=a(q,` and returns the output,
together with resized `),Ps=r(q,"CODE",{});var c_=i(Ps);Bu=a(c_,"images"),c_.forEach(t),Wu=a(q,". In case "),Vn=r(q,"A",{href:!0});var d_=i(Vn);Vu=a(d_,"LayoutLMv2FeatureExtractor"),d_.forEach(t),Qu=a(q," was initialized with "),js=r(q,"CODE",{});var p_=i(js);Gu=a(p_,"apply_ocr"),p_.forEach(t),Hu=a(q,` set to
`),Cs=r(q,"CODE",{});var u_=i(Cs);Ku=a(u_,"False"),u_.forEach(t),Xu=a(q,", it passes the words ("),Is=r(q,"CODE",{});var m_=i(Is);Yu=a(m_,"text"),m_.forEach(t),Zu=a(q,"/"),As=r(q,"CODE",{});var h_=i(As);Ju=a(h_,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_15977/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),h_.forEach(t),em=a(q,"."),q.forEach(t),om=u(aa),Ds=r(aa,"P",{});var f_=i(Ds);tm=a(f_,"Please refer to the docstring of the above two methods for more information."),f_.forEach(t),aa.forEach(t),we.forEach(t),Kr=u(o),Ce=r(o,"H2",{class:!0});var xi=i(Ce);to=r(xi,"A",{id:!0,class:!0,href:!0});var g_=i(to);Os=r(g_,"SPAN",{});var __=i(Os);y(xt.$$.fragment,__),__.forEach(t),g_.forEach(t),nm=u(xi),Ns=r(xi,"SPAN",{});var v_=i(Ns);am=a(v_,"LayoutLMv2Model"),v_.forEach(t),xi.forEach(t),Xr=u(o),le=r(o,"DIV",{class:!0});var sa=i(le);y(Tt.$$.fragment,sa),sm=u(sa),Mt=r(sa,"P",{});var Ti=i(Mt);rm=a(Ti,`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),$t=r(Ti,"A",{href:!0,rel:!0});var y_=i($t);im=a(y_,"torch.nn.Module"),y_.forEach(t),lm=a(Ti,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cm=u(sa),te=r(sa,"DIV",{class:!0});var vo=i(te);y(Et.$$.fragment,vo),dm=u(vo),Ie=r(vo,"P",{});var ra=i(Ie);pm=a(ra,"The "),Qn=r(ra,"A",{href:!0});var b_=i(Qn);um=a(b_,"LayoutLMv2Model"),b_.forEach(t),mm=a(ra," forward method, overrides the "),Ss=r(ra,"CODE",{});var L_=i(Ss);hm=a(L_,"__call__"),L_.forEach(t),fm=a(ra," special method."),ra.forEach(t),gm=u(vo),y(no.$$.fragment,vo),_m=u(vo),y(ao.$$.fragment,vo),vo.forEach(t),sa.forEach(t),Yr=u(o),Ae=r(o,"H2",{class:!0});var Mi=i(Ae);so=r(Mi,"A",{id:!0,class:!0,href:!0});var w_=i(so);Rs=r(w_,"SPAN",{});var k_=i(Rs);y(zt.$$.fragment,k_),k_.forEach(t),w_.forEach(t),vm=u(Mi),Us=r(Mi,"SPAN",{});var x_=i(Us);ym=a(x_,"LayoutLMv2ForSequenceClassification"),x_.forEach(t),Mi.forEach(t),Zr=u(o),Z=r(o,"DIV",{class:!0});var yo=i(Z);y(qt.$$.fragment,yo),bm=u(yo),Ft=r(yo,"P",{});var $i=i(Ft);Lm=a($i,`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Em=u(yo),ne=r(yo,"DIV",{class:!0});var bo=i(ne);y(It.$$.fragment,bo),zm=u(bo),De=r(bo,"P",{});var ia=i(De);qm=a(ia,"The "),Gn=r(ia,"A",{href:!0});var $_=i(Gn);Fm=a($_,"LayoutLMv2ForSequenceClassification"),$_.forEach(t),Pm=a(ia," forward method, overrides the "),Bs=r(ia,"CODE",{});var E_=i(Bs);jm=a(E_,"__call__"),E_.forEach(t),Cm=a(ia," special method."),ia.forEach(t),Im=u(bo),y(ro.$$.fragment,bo),Am=u(bo),y(io.$$.fragment,bo),bo.forEach(t),yo.forEach(t),Jr=u(o),Oe=r(o,"H2",{class:!0});var zi=i(Oe);lo=r(zi,"A",{id:!0,class:!0,href:!0});var z_=i(lo);Ws=r(z_,"SPAN",{});var q_=i(Ws);y(At.$$.fragment,q_),q_.forEach(t),z_.forEach(t),Dm=u(zi),Vs=r(zi,"SPAN",{});var F_=i(Vs);Om=a(F_,"LayoutLMv2ForTokenClassification"),F_.forEach(t),zi.forEach(t),ei=u(o),J=r(o,"DIV",{class:!0});var Lo=i(J);y(Dt.$$.fragment,Lo),Nm=u(Lo),ee=r(Lo,"P",{});var ke=i(ee);Sm=a(ke,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
...
`),St=r(ke,"A",{href:!0,rel:!0});var C_=i(St);Vm=a(C_,"CORD"),C_.forEach(t),Qm=a(ke," and "),Rt=r(ke,"A",{href:!0,rel:!0});var I_=i(Rt);Gm=a(I_,"Kleister-NDA"),I_.forEach(t),Hm=a(ke,"."),ke.forEach(t),Km=u(Lo),Ut=r(Lo,"P",{});var qi=i(Ut);Xm=a(qi,"This model is a PyTorch "),Bt=r(qi,"A",{href:!0,rel:!0});var A_=i(Bt);Ym=a(A_,"torch.nn.Module"),A_.forEach(t),Zm=a(qi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qi.forEach(t),Jm=u(Lo),ae=r(Lo,"DIV",{class:!0});var wo=i(ae);y(Wt.$$.fragment,wo),eh=u(wo),Ne=r(wo,"P",{});var la=i(Ne);oh=a(la,"The "),Hn=r(la,"A",{href:!0});var D_=i(Hn);th=a(D_,"LayoutLMv2ForTokenClassification"),D_.forEach(t),nh=a(la," forward method, overrides the "),Qs=r(la,"CODE",{});var O_=i(Qs);ah=a(O_,"__call__"),O_.forEach(t),sh=a(la," special method."),la.forEach(t),rh=u(wo),y(co.$$.fragment,wo),ih=u(wo),y(po.$$.fragment,wo),wo.forEach(t),Lo.forEach(t),oi=u(o),Se=r(o,"H2",{class:!0});var Fi=i(Se);uo=r(Fi,"A",{id:!0,class:!0,href:!0});var N_=i(uo);Gs=r(N_,"SPAN",{});var S_=i(Gs);y(Vt.$$.fragment,S_),S_.forEach(t),N_.forEach(t),lh=u(Fi),Hs=r(Fi,"SPAN",{});var R_=i(Hs);ch=a(R_,"LayoutLMv2ForQuestionAnswering"),R_.forEach(t),Fi.forEach(t),ti=u(o),oe=r(o,"DIV",{class:!0});var ko=i(oe);y(Qt.$$.fragment,ko),dh=u(ko),ce=r(ko,"P",{});var xo=i(ce);ph=a(xo,`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
