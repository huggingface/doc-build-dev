...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart50/tokenization_mbart50.py#L50"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[IM]},$$scope:{ctx:x}}}),ns=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart50/tokenization_mbart50.py#L259",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ps=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart50/tokenization_mbart50.py#L350"}}),us=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart50/tokenization_mbart50.py#L356"}}),hs=new R({}),ms=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_mbart.py#L1172",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17291/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_mbart.py#L1448",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_mbart.py#L1727",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_tf_mbart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_tf_mbart.py#L1284",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17291/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17291/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17291/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
example shows how to translate English to Romanian using the `),ld=s(To,"EM",{});var np=r(ld);Rh=d(np,"facebook/mbart-large-en-ro"),np.forEach(t),Xh=d(To," model."),To.forEach(t),ii.forEach(t),ep.forEach(t),pp=u(o),v(ka.$$.fragment,o),up=u(o),Nt=s(o,"H2",{class:!0});var di=r(Nt);Mo=s(di,"A",{id:!0,class:!0,href:!0});var ap=r(Mo);cd=s(ap,"SPAN",{});var sp=r(cd);v(ya.$$.fragment,sp),sp.forEach(t),ap.forEach(t),Qh=u(di),pd=s(di,"SPAN",{});var rp=r(pd);Vh=d(rp,"Overview of MBart-50"),rp.forEach(t),di.forEach(t),hp=u(o),yt=s(o,"P",{});var wo=r(yt);Hh=d(wo,"MBart-50 was introduced in the "),va=s(wo,"A",{href:!0,rel:!0});var L1=r(va);Jh=d(L1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),L1.forEach(t),Kh=d(wo,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),R1.forEach(t),U1.forEach(t),_p=u(o),Dt=s(o,"H3",{class:!0});var ou=r(Dt);$o=s(ou,"A",{id:!0,class:!0,href:!0});var X1=r($o);md=s(X1,"SPAN",{});var Q1=r(md);v(Ta.$$.fragment,Q1),Q1.forEach(t),X1.forEach(t),om=u(ou),fd=s(ou,"SPAN",{});var V1=r(fd);nm=d(V1,"Training of MBart-50"),V1.forEach(t),ou.forEach(t),gp=u(o),He=s(o,"P",{});var ea=r(He);am=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),_d=s(ea,"CODE",{});var H1=r(_d);sm=d(H1,"[lang_code] X [eos]"),H1.forEach(t),rm=d(ea,", where "),gd=s(ea,"CODE",{});var J1=r(gd);im=d(J1,"lang_code"),J1.forEach(t),dm=d(ea,` is source
...
documentation from `),ki=s(Wi,"A",{href:!0});var mT=r(ki);Dm=d(mT,"PretrainedConfig"),mT.forEach(t),Lm=d(Wi," for more information."),Wi.forEach(t),Gm=u(ta),v(Fo.$$.fragment,ta),ta.forEach(t),$p=u(o),Ut=s(o,"H2",{class:!0});var ru=r(Ut);qo=s(ru,"A",{id:!0,class:!0,href:!0});var fT=r(qo);Fd=s(fT,"SPAN",{});var _T=r(Fd);v(qa.$$.fragment,_T),_T.forEach(t),fT.forEach(t),Wm=u(ru),qd=s(ru,"SPAN",{});var gT=r(qd);Um=d(gT,"MBartTokenizer"),gT.forEach(t),ru.forEach(t),xp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(Ba.$$.fragment,Se),Rm=u(Se),Bd=s(Se,"P",{});var bT=r(Bd);Xm=d(bT,"Construct an MBART tokenizer."),bT.forEach(t),Qm=u(Se),ht=s(Se,"P",{});var oa=r(ht);Vm=d(oa,"Adapted from "),yi=s(oa,"A",{href:!0});var kT=r(yi);Hm=d(kT,"RobertaTokenizer"),kT.forEach(t),Jm=d(oa," and "),vi=s(oa,"A",{href:!0});var yT=r(vi);Km=d(yT,"XLNetTokenizer"),yT.forEach(t),Zm=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var vT=r(ja);Ym=d(vT,"SentencePiece"),vT.forEach(t),ef=d(oa,"."),oa.forEach(t),tf=u(Se),Ca=s(Se,"P",{});var iu=r(Ca);of=d(iu,"The tokenization method is "),jd=s(iu,"CODE",{});var TT=r(jd);nf=d(TT,"<tokens> <eos> <language code>"),TT.forEach(t),af=d(iu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),iu.forEach(t),sf=u(Se),v(Bo.$$.fragment,Se),rf=u(Se),jo=s(Se,"DIV",{class:!0});var du=r(jo);v(Ea.$$.fragment,du),df=u(du),Cd=s(du,"P",{});var wT=r(Cd);lf=d(wT,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An MBART sequence has the following format, where `),Ed=s(lu,"CODE",{});var MT=r(Ed);hf=d(MT,"X"),MT.forEach(t),mf=d(lu," represents the sequence:"),lu.forEach(t),ff=u(na),Aa=s(na,"UL",{});var cu=r(Aa);Oa=s(cu,"LI",{});var pu=r(Oa);Pd=s(pu,"CODE",{});var $T=r(Pd);_f=d($T,"input_ids"),$T.forEach(t),gf=d(pu," (for encoder) "),Sd=s(pu,"CODE",{});var xT=r(Sd);bf=d(xT,"X [eos, src_lang_code]"),xT.forEach(t),pu.forEach(t),kf=u(cu),Ia=s(cu,"LI",{});var uu=r(Ia);Ad=s(uu,"CODE",{});var zT=r(Ad);yf=d(zT,"decoder_input_ids"),zT.forEach(t),vf=d(uu,": (for decoder) "),Od=s(uu,"CODE",{});var FT=r(Od);Tf=d(FT,"X [eos, tgt_lang_code]"),FT.forEach(t),uu.forEach(t),cu.forEach(t),wf=u(na),Id=s(na,"P",{});var qT=r(Id);Mf=d(qT,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),qT.forEach(t),na.forEach(t),Se.forEach(t),zp=u(o),Rt=s(o,"H2",{class:!0});var hu=r(Rt);Co=s(hu,"A",{id:!0,class:!0,href:!0});var BT=r(Co);Nd=s(BT,"SPAN",{});var jT=r(Nd);v(Na.$$.fragment,jT),jT.forEach(t),BT.forEach(t),$f=u(hu),Dd=s(hu,"SPAN",{});var CT=r(Dd);xf=d(CT,"MBartTokenizerFast"),CT.forEach(t),hu.forEach(t),Fp=u(o),O=s(o,"DIV",{class:!0});var Y=r(O);v(Da.$$.fragment,Y),zf=u(Y),Xt=s(Y,"P",{});var Ui=r(Xt);Ff=d(Ui,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ld=s(Ui,"EM",{});var ET=r(Ld);qf=d(ET,"tokenizers"),ET.forEach(t),Bf=d(Ui,` library). Based on
`),La=s(Ui,"A",{href:!0,rel:!0});var PT=r(La);jf=d(PT,"BPE"),PT.forEach(t),Cf=d(Ui,"."),Ui.forEach(t),Ef=u(Y),Ga=s(Y,"P",{});var mu=r(Ga);Pf=d(mu,"This tokenizer inherits from "),Ti=s(mu,"A",{href:!0});var ST=r(Ti);Sf=d(ST,"PreTrainedTokenizerFast"),ST.forEach(t),Af=d(mu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),mu.forEach(t),Of=u(Y),Wa=s(Y,"P",{});var fu=r(Wa);If=d(fu,"The tokenization method is "),Gd=s(fu,"CODE",{});var AT=r(Gd);Nf=d(AT,"<tokens> <eos> <language code>"),AT.forEach(t),Df=d(fu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),fu.forEach(t),Lf=u(Y),v(Eo.$$.fragment,Y),Gf=u(Y),qe=s(Y,"DIV",{class:!0});var vt=r(qe);v(Ua.$$.fragment,vt),Wf=u(vt),Wd=s(vt,"P",{});var OT=r(Wd);Uf=d(OT,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),OT.forEach(t),Rf=u(vt),Ra=s(vt,"P",{});var _u=r(Ra);Xf=d(_u,"An MBART sequence has the following format, where "),Ud=s(_u,"CODE",{});var IT=r(Ud);Qf=d(IT,"X"),IT.forEach(t),Vf=d(_u," represents the sequence:"),_u.forEach(t),Hf=u(vt),Xa=s(vt,"UL",{});var gu=r(Xa);Qa=s(gu,"LI",{});var bu=r(Qa);Rd=s(bu,"CODE",{});var NT=r(Rd);Jf=d(NT,"input_ids"),NT.forEach(t),Kf=d(bu," (for encoder) "),Xd=s(bu,"CODE",{});var DT=r(Xd);Zf=d(DT,"X [eos, src_lang_code]"),DT.forEach(t),bu.forEach(t),Yf=u(gu),Va=s(gu,"LI",{});var ku=r(Va);Qd=s(ku,"CODE",{});var LT=r(Qd);e_=d(LT,"decoder_input_ids"),LT.forEach(t),t_=d(ku,": (for decoder) "),Vd=s(ku,"CODE",{});var GT=r(Vd);o_=d(GT,"X [eos, tgt_lang_code]"),GT.forEach(t),ku.forEach(t),gu.forEach(t),n_=u(vt),Hd=s(vt,"P",{});var WT=r(Hd);a_=d(WT,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),WT.forEach(t),vt.forEach(t),s_=u(Y),Po=s(Y,"DIV",{class:!0});var yu=r(Po);v(Ha.$$.fragment,yu),r_=u(yu),Jd=s(yu,"P",{});var UT=r(Jd);i_=d(UT,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),UT.forEach(t),yu.forEach(t),d_=u(Y),So=s(Y,"DIV",{class:!0});var vu=r(So);v(Ja.$$.fragment,vu),l_=u(vu),Kd=s(vu,"P",{});var RT=r(Kd);c_=d(RT,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),RT.forEach(t),vu.forEach(t),p_=u(Y),Ao=s(Y,"DIV",{class:!0});var Tu=r(Ao);v(Ka.$$.fragment,Tu),u_=u(Tu),Zd=s(Tu,"P",{});var XT=r(Zd);h_=d(XT,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),XT.forEach(t),Tu.forEach(t),Y.forEach(t),qp=u(o),Qt=s(o,"H2",{class:!0});var wu=r(Qt);Oo=s(wu,"A",{id:!0,class:!0,href:!0});var QT=r(Oo);Yd=s(QT,"SPAN",{});var VT=r(Yd);v(Za.$$.fragment,VT),VT.forEach(t),QT.forEach(t),m_=u(wu),el=s(wu,"SPAN",{});var HT=r(el);f_=d(HT,"MBart50Tokenizer"),HT.forEach(t),wu.forEach(t),Bp=u(o),I=s(o,"DIV",{class:!0});var ee=r(I);v(Ya.$$.fragment,ee),__=u(ee),es=s(ee,"P",{});var Mu=r(es);g_=d(Mu,"Construct a MBart50 tokenizer. Based on "),ts=s(Mu,"A",{href:!0,rel:!0});var JT=r(ts);b_=d(JT,"SentencePiece"),JT.forEach(t),k_=d(Mu,"."),Mu.forEach(t),y_=u(ee),os=s(ee,"P",{});var $u=r(os);v_=d($u,"This tokenizer inherits from "),wi=s($u,"A",{href:!0});var KT=r(wi);T_=d(KT,"PreTrainedTokenizer"),KT.forEach(t),w_=d($u,` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),dl=s(Cu,"CODE",{});var s2=r(dl);X_=d(s2,"prepare_for_model"),s2.forEach(t),Q_=d(Cu," method."),Cu.forEach(t),ju.forEach(t),V_=u(ee),Lo=s(ee,"DIV",{class:!0});var Eu=r(Lo);v(ps.$$.fragment,Eu),H_=u(Eu),ll=s(Eu,"P",{});var r2=r(ll);J_=d(r2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),r2.forEach(t),Eu.forEach(t),K_=u(ee),Go=s(ee,"DIV",{class:!0});var Pu=r(Go);v(us.$$.fragment,Pu),Z_=u(Pu),cl=s(Pu,"P",{});var i2=r(cl);Y_=d(i2,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),i2.forEach(t),Pu.forEach(t),ee.forEach(t),jp=u(o),Vt=s(o,"H2",{class:!0});var Su=r(Vt);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var d2=r(Wo);pl=s(d2,"SPAN",{});var l2=r(pl);v(hs.$$.fragment,l2),l2.forEach(t),d2.forEach(t),eg=u(Su),ul=s(Su,"SPAN",{});var c2=r(ul);tg=d(c2,"MBart50TokenizerFast"),c2.forEach(t),Su.forEach(t),Cp=u(o),K=s(o,"DIV",{class:!0});var Ae=r(K);v(ms.$$.fragment,Ae),og=u(Ae),Ht=s(Ae,"P",{});var Ri=r(Ht);ng=d(Ri,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),hl=s(Ri,"EM",{});var p2=r(hl);ag=d(p2,"tokenizers"),p2.forEach(t),sg=d(Ri,` library). Based on
...
refer to this superclass for more information regarding those methods.`),Au.forEach(t),ug=u(Ae),v(Uo.$$.fragment,Ae),hg=u(Ae),Be=s(Ae,"DIV",{class:!0});var Tt=r(Be);v(gs.$$.fragment,Tt),mg=u(Tt),ml=s(Tt,"P",{});var m2=r(ml);fg=d(m2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),m2.forEach(t),_g=u(Tt),bs=s(Tt,"P",{});var Ou=r(bs);gg=d(Ou,"An MBART-50 sequence has the following format, where "),fl=s(Ou,"CODE",{});var f2=r(fl);bg=d(f2,"X"),f2.forEach(t),kg=d(Ou," represents the sequence:"),Ou.forEach(t),yg=u(Tt),ks=s(Tt,"UL",{});var Iu=r(ks);ys=s(Iu,"LI",{});var Nu=r(ys);_l=s(Nu,"CODE",{});var _2=r(_l);vg=d(_2,"input_ids"),_2.forEach(t),Tg=d(Nu," (for encoder) "),gl=s(Nu,"CODE",{});var g2=r(gl);wg=d(g2,"[src_lang_code] X [eos]"),g2.forEach(t),Nu.forEach(t),Mg=u(Iu),vs=s(Iu,"LI",{});var Du=r(vs);bl=s(Du,"CODE",{});var b2=r(bl);$g=d(b2,"labels"),b2.forEach(t),xg=d(Du,": (for decoder) "),kl=s(Du,"CODE",{});var k2=r(kl);zg=d(k2,"[tgt_lang_code] X [eos]"),k2.forEach(t),Du.forEach(t),Iu.forEach(t),Fg=u(Tt),yl=s(Tt,"P",{});var y2=r(yl);qg=d(y2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),y2.forEach(t),Tt.forEach(t),Bg=u(Ae),Ro=s(Ae,"DIV",{class:!0});var Lu=r(Ro);v(Ts.$$.fragment,Lu),jg=u(Lu),vl=s(Lu,"P",{});var v2=r(vl);Cg=d(v2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),v2.forEach(t),Lu.forEach(t),Eg=u(Ae),Xo=s(Ae,"DIV",{class:!0});var Gu=r(Xo);v(ws.$$.fragment,Gu),Pg=u(Gu),Tl=s(Gu,"P",{});var T2=r(Tl);Sg=d(T2,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),T2.forEach(t),Gu.forEach(t),Ae.forEach(t),Ep=u(o),Jt=s(o,"H2",{class:!0});var Wu=r(Jt);Qo=s(Wu,"A",{id:!0,class:!0,href:!0});var w2=r(Qo);wl=s(w2,"SPAN",{});var M2=r(wl);v(Ms.$$.fragment,M2),M2.forEach(t),w2.forEach(t),Ag=u(Wu),Ml=s(Wu,"SPAN",{});var $2=r(Ml);Og=d($2,"MBartModel"),$2.forEach(t),Wu.forEach(t),Pp=u(o),We=s(o,"DIV",{class:!0});var sa=r(We);v($s.$$.fragment,sa),Ig=u(sa),xs=s(sa,"P",{});var Uu=r(xs);Ng=d(Uu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ru.forEach(t),Xg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);v(qs.$$.fragment,ra),Qg=u(ra),Kt=s(ra,"P",{});var Xi=r(Kt);Vg=d(Xi,"The "),xi=s(Xi,"A",{href:!0});var F2=r(xi);Hg=d(F2,"MBartModel"),F2.forEach(t),Jg=d(Xi," forward method, overrides the "),$l=s(Xi,"CODE",{});var q2=r($l);Kg=d(q2,"__call__"),q2.forEach(t),Zg=d(Xi," special method."),Xi.forEach(t),Yg=u(ra),v(Vo.$$.fragment,ra),eb=u(ra),v(Ho.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Sp=u(o),Zt=s(o,"H2",{class:!0});var Xu=r(Zt);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var B2=r(Jo);xl=s(B2,"SPAN",{});var j2=r(xl);v(Bs.$$.fragment,j2),j2.forEach(t),B2.forEach(t),tb=u(Xu),zl=s(Xu,"SPAN",{});var C2=r(zl);ob=d(C2,"MBartForConditionalGeneration"),C2.forEach(t),Xu.forEach(t),Ap=u(o),Ue=s(o,"DIV",{class:!0});var ia=r(Ue);v(js.$$.fragment,ia),nb=u(ia),Cs=s(ia,"P",{});var Qu=r(Cs);ab=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=s(Qu,"A",{href:!0});var E2=r(zi);sb=d(E2,"PreTrainedModel"),E2.forEach(t),rb=d(Qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qu.forEach(t),ib=u(ia),Es=s(ia,"P",{});var Vu=r(Es);db=d(Vu,"This model is also a PyTorch "),Ps=s(Vu,"A",{href:!0,rel:!0});var P2=r(Ps);lb=d(P2,"torch.nn.Module"),P2.forEach(t),cb=d(Vu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vu.forEach(t),pb=u(ia),je=s(ia,"DIV",{class:!0});var wt=r(je);v(Ss.$$.fragment,wt),ub=u(wt),Yt=s(wt,"P",{});var Qi=r(Yt);hb=d(Qi,"The "),Fi=s(Qi,"A",{href:!0});var S2=r(Fi);mb=d(S2,"MBartForConditionalGeneration"),S2.forEach(t),fb=d(Qi," forward method, overrides the "),Fl=s(Qi,"CODE",{});var A2=r(Fl);_b=d(A2,"__call__"),A2.forEach(t),gb=d(Qi," special method."),Qi.forEach(t),bb=u(wt),v(Ko.$$.fragment,wt),kb=u(wt),v(Zo.$$.fragment,wt),yb=u(wt),v(Yo.$$.fragment,wt),wt.forEach(t),ia.forEach(t),Op=u(o),eo=s(o,"H2",{class:!0});var Hu=r(eo);en=s(Hu,"A",{id:!0,class:!0,href:!0});var O2=r(en);ql=s(O2,"SPAN",{});var I2=r(ql);v(As.$$.fragment,I2),I2.forEach(t),O2.forEach(t),vb=u(Hu),Bl=s(Hu,"SPAN",{});var N2=r(Bl);Tb=d(N2,"MBartForQuestionAnswering"),N2.forEach(t),Hu.forEach(t),Ip=u(o),we=s(o,"DIV",{class:!0});var Mt=r(we);v(Os.$$.fragment,Mt),wb=u(Mt),to=s(Mt,"P",{});var Vi=r(to);Mb=d(Vi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),jl=s(Vi,"CODE",{});var D2=r(jl);$b=d(D2,"span start logits"),D2.forEach(t),xb=d(Vi," and "),Cl=s(Vi,"CODE",{});var L2=r(Cl);zb=d(L2,"span end logits"),L2.forEach(t),Fb=d(Vi,")."),Vi.forEach(t),qb=u(Mt),Is=s(Mt,"P",{});var Ju=r(Is);Bb=d(Ju,"This model inherits from "),qi=s(Ju,"A",{href:!0});var G2=r(qi);jb=d(G2,"PreTrainedModel"),G2.forEach(t),Cb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),Eb=u(Mt),Ns=s(Mt,"P",{});var Ku=r(Ns);Pb=d(Ku,"This model is also a PyTorch "),Ds=s(Ku,"A",{href:!0,rel:!0});var W2=r(Ds);Sb=d(W2,"torch.nn.Module"),W2.forEach(t),Ab=d(Ku,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Ob=u(Mt),Ce=s(Mt,"DIV",{class:!0});var $t=r(Ce);v(Ls.$$.fragment,$t),Ib=u($t),oo=s($t,"P",{});var Hi=r(oo);Nb=d(Hi,"The "),Bi=s(Hi,"A",{href:!0});var U2=r(Bi);Db=d(U2,"MBartForQuestionAnswering"),U2.forEach(t),Lb=d(Hi," forward method, overrides the "),El=s(Hi,"CODE",{});var R2=r(El);Gb=d(R2,"__call__"),R2.forEach(t),Wb=d(Hi," special method."),Hi.forEach(t),Ub=u($t),v(tn.$$.fragment,$t),Rb=u($t),v(on.$$.fragment,$t),Xb=u($t),v(nn.$$.fragment,$t),$t.forEach(t),Mt.forEach(t),Np=u(o),no=s(o,"H2",{class:!0});var Zu=r(no);an=s(Zu,"A",{id:!0,class:!0,href:!0});var X2=r(an);Pl=s(X2,"SPAN",{});var Q2=r(Pl);v(Gs.$$.fragment,Q2),Q2.forEach(t),X2.forEach(t),Qb=u(Zu),Sl=s(Zu,"SPAN",{});var V2=r(Sl);Vb=d(V2,"MBartForSequenceClassification"),V2.forEach(t),Zu.forEach(t),Dp=u(o),Me=s(o,"DIV",{class:!0});var xt=r(Me);v(Ws.$$.fragment,xt),Hb=u(xt),Al=s(xt,"P",{});var H2=r(Al);Jb=d(H2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),H2.forEach(t),Kb=u(xt),Us=s(xt,"P",{});var Yu=r(Us);Zb=d(Yu,"This model inherits from "),ji=s(Yu,"A",{href:!0});var J2=r(ji);Yb=d(J2,"PreTrainedModel"),J2.forEach(t),ek=d(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
