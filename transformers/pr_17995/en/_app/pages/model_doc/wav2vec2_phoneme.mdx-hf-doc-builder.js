...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17995/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17995/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17995/src/transformers/tokenization_utils_base.py#L2429",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17995/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17995/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L506",returnDescription:`
<p>The
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17995/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L450",returnDescription:`
<p>The decoded
