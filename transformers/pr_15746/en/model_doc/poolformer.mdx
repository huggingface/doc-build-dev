...
- local: overview
  title: Overview
- local: transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput
  title: PoolFormer specific outputs
...
- One can use [PoolFormerFeatureExtractor](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor) to prepare images for the model.
...
<h2 id="transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput">PoolFormer specific outputs</h2>

<div class="docstring">

<docstring><name>class transformers.models.poolformer.modeling\_poolformer.PoolFormerModelOutput</name><anchor>transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput</anchor><source>https://github.com/huggingface/transformers/blob/pr_15746/src/transformers/models/poolformer/modeling_poolformer.py#L67</source><parameters>[{"name": "last_hidden_state", "val": ": FloatTensor = None"}, {"name": "hidden_states", "val": ": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}]</parameters><paramsdesc>- **last_hidden_state** (`torch.FloatTensor` of shape `(batch_size, sequence_length, hidden_size)`) --
  Sequence of hidden-states at the output of the last layer of the model.

- **hidden_states** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_hidden_states=True` is passed or when `config.output_hidden_states=True`) --
  Tuple of `torch.FloatTensor` (one for the output of the embeddings + one for the output of each layer) of
  shape `(batch_size, sequence_length, hidden_size)`. Hidden-states of the model at the output of each layer
  plus the initial embedding outputs.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<docstring><name>class transformers.models.poolformer.modeling\_poolformer.PoolFormerClassifierOutput</name><anchor>transformers.models.poolformer.modeling_poolformer.PoolFormerClassifierOutput</anchor><source>https://github.com/huggingface/transformers/blob/pr_15746/src/transformers/models/poolformer/modeling_poolformer.py#L86</source><parameters>[{"name": "loss", "val": ": typing.Optional[torch.FloatTensor] = None"}, {"name": "logits", "val": ": FloatTensor = None"}, {"name": "hidden_states", "val": ": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}]</parameters><paramsdesc>- **loss** (`torch.FloatTensor` of shape `(1,)`, *optional*, returned when `labels` is provided) --
...
- **hidden_states** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_hidden_states=True` is passed or when `config.output_hidden_states=True`) --
  ...
  Hidden-states of the model at the output of each layer plus the initial embedding outputs.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
This is the configuration class to store the configuration of [PoolFormerModel](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerModel). It is used to instantiate a
...
<docstring><name>class transformers.PoolFormerModel</name><anchor>transformers.PoolFormerModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15746/src/transformers/models/poolformer/modeling_poolformer.py#L360</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([PoolFormerConfig](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerConfig)) -- Model configuration class with all the parameters of the model.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.PoolFormerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15746/src/transformers/models/poolformer/modeling_poolformer.py#L373</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [PoolFormerFeatureExtractor](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor). See
  [PoolFormerFeatureExtractor.__call__()](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor.__call__) for details.</paramsdesc><paramgroups>0</paramgroups><rettype>[transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput) or `tuple(torch.FloatTensor)`</rettype><retdesc>A [transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.models.poolformer.modeling_poolformer.PoolFormerModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([PoolFormerConfig](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerConfig)) and inputs.
...
The [PoolFormerModel](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.PoolFormerForImageClassification</name><anchor>transformers.PoolFormerForImageClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15746/src/transformers/models/poolformer/modeling_poolformer.py#L423</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([PoolFormerConfig](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15746/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.PoolFormerForImageClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15746/src/transformers/models/poolformer/modeling_poolformer.py#L439</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [PoolFormerFeatureExtractor](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor). See
  [PoolFormerFeatureExtractor.__call__()](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor.__call__) for details.

- **labels** (`torch.LongTensor` of shape `(batch_size,)`, *optional*) --
  Labels for computing the image classification/regression loss. Indices should be in `[0, ...,
  config.num_labels - 1]`. If `config.num_labels == 1` a regression loss is computed (Mean-Square loss), If
  `config.num_labels > 1` a classification loss is computed (Cross-Entropy).</paramsdesc><paramgroups>0</paramgroups><rettype>[transformers.models.poolformer.modeling_poolformer.PoolFormerClassifierOutput](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.models.poolformer.modeling_poolformer.PoolFormerClassifierOutput) or `tuple(torch.FloatTensor)`</rettype><retdesc>A [transformers.models.poolformer.modeling_poolformer.PoolFormerClassifierOutput](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.models.poolformer.modeling_poolformer.PoolFormerClassifierOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([PoolFormerConfig](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerConfig)) and inputs.
...
The [PoolFormerForImageClassification](/docs/transformers/pr_15746/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) forward method, overrides the `__call__` special method.
