...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){b(d.$$.fragment)},l(p){k(d.$$.fragment,p)},m(p,u){w(d,p,u),T=!0},p:oo,i(p){T||(P(d.$$.fragment,p),T=!0)},o(p){$(d.$$.fragment,p),T=!1},d(p){y(d,p)}}}function bs(G){let d,T,p,u,v;return u=new tt({props:{code:`from transformers import GPTNeoXTokenizerFast
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=i("Example:"),p=m(),b(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),v=!0},p:oo,i(r){v||(P(u.$$.fragment,r),v=!0)},o(r){$(u.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),y(u,r)}}}function $s(G){let d,T,p,u,v;return{c(){d=n("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(_,"CODE",{});var X=a(p);u=l(X,"Module"),X.forEach(o),v=l(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(r,_){g(r,d,_),t(d,T),t(d,p),t(p,u),t(d,v)},d(r){r&&o(d)}}}function ys(G){let d,T,p,u,v;return u=new tt({props:{code:`from transformers import GPTNeoXTokenizer, GPTNeoXForCausalLM, GPTNeoXConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),b(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),v=!0},p:oo,i(r){v||(P(u.$$.fragment,r),v=!0)},o(r){$(u.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),y(u,r)}}}function Ns(G){let d,T,p,u,v,r,_,X,L,z,C,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Ie,ho,xt,ge,zt,Se,mo,Mt,I,K,st,_e,fo,at,uo,Ct,Q,go,rt,_o,To,Et,Te,Ft,S,Z,it,ve,vo,lt,bo,qt,M,be,ko,D,wo,De,Po,$o,ke,yo,No,Go,B,Xo,Be,xo,zo,We,Mo,Co,Eo,ee,jt,W,te,dt,we,Fo,ct,qo,At,N,Pe,jo,$e,Ao,pt,Lo,Io,So,ht,Do,Bo,oe,Wo,ye,Oo,mt,Ho,Vo,Uo,ne,Jo,Ne,Ro,Oe,Yo,Ko,Lt,O,se,ft,Ge,Qo,ut,Zo,It,j,Xe,en,xe,tn,ze,on,nn,sn,E,Me,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,St,V,ie,_t,Ce,fn,Tt,un,Dt,A,Ee,gn,U,_n,vt,Tn,vn,Fe,bn,kn,wn,F,qe,Pn,J,$n,Ve,yn,Nn,bt,Gn,Xn,xn,le,zn,de,Bt;return r=new Le({}),me=new Le({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Le({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17598/en/model_doc/gpt_neox#transformers.GPTNeoXModel">GPTNeoXModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTNeoXConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17598/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[bs]},$$scope:{ctx:G}}}),ne=new Mn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Le({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17598/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17598/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17598/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L377"}}),Me=new et({props:{name:"forward",anchor:"transformers.GPTNeoXModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17598/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17598/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L395",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17598/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17598/en/model_doc/gpt_neox#transformers.GPTNeoXConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17598/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17598/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L515"}}),qe=new et({props:{name:"forward",anchor:"transformers.GPTNeoXForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17598/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17598/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17598/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L534",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17598/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
`}}),le=new Mn({props:{$$slots:{default:[$s]},$$scope:{ctx:G}}}),de=new to({props:{anchor:"transformers.GPTNeoXForCausalLM.forward.example",$$slots:{default:[ys]},$$scope:{ctx:G}}}),{c(){d=n("meta"),T=m(),p=n("h1"),u=n("a"),v=n("span"),b(r.$$.fragment),_=m(),X=n("span"),L=i("GPT-NeoX"),z=m(),C=n("h2"),q=n("a"),ot=n("span"),b(me.$$.fragment),no=m(),nt=n("span"),so=i("Overview"),Nt=m(),R=n("p"),ao=i(`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
...
generous the support of `),ue=n("a"),co=i("CoreWeave"),po=i("."),Xt=m(),Ie=n("p"),ho=i("GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),xt=m(),b(ge.$$.fragment),zt=m(),Se=n("p"),mo=i(`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Mt=m(),I=n("h3"),K=n("a"),st=n("span"),b(_e.$$.fragment),fo=m(),at=n("span"),uo=i("Generation"),Ct=m(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Et=m(),b(Te.$$.fragment),Ft=m(),S=n("h2"),Z=n("a"),it=n("span"),b(ve.$$.fragment),vo=m(),lt=n("span"),bo=i("GPTNeoXConfig"),qt=m(),M=n("div"),b(be.$$.fragment),ko=m(),D=n("p"),wo=i("This is the configuration class to store the configuration of a "),De=n("a"),Po=i("GPTNeoXModel"),$o=i(`. It is used to instantiate an
...
Byte-Pair-Encoding.`),So=m(),ht=n("p"),Do=i("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Bo=m(),b(oe.$$.fragment),Wo=m(),ye=n("p"),Oo=i("You can get around that behavior by passing "),mt=n("code"),Ho=i("add_prefix_space=True"),Vo=i(` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Uo=m(),b(ne.$$.fragment),Jo=m(),Ne=n("p"),Ro=i("This tokenizer inherits from "),Oe=n("a"),Yo=i("PreTrainedTokenizerFast"),Ko=i(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Lt=m(),O=n("h2"),se=n("a"),ft=n("span"),b(Ge.$$.fragment),Qo=m(),ut=n("span"),Zo=i("GPTNeoXModel"),It=m(),j=n("div"),b(Xe.$$.fragment),en=m(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=m(),E=n("div"),b(Me.$$.fragment),an=m(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=m(),b(ae.$$.fragment),mn=m(),b(re.$$.fragment),St=m(),V=n("h2"),ie=n("a"),_t=n("span"),b(Ce.$$.fragment),fn=m(),Tt=n("span"),un=i("GPTNeoXForCausalLM"),Dt=m(),A=n("div"),b(Ee.$$.fragment),gn=m(),U=n("p"),_n=i("GPTNeoX Model with a "),vt=n("code"),Tn=i("language modeling"),vn=i(` head on top for CLM fine-tuning.
This model is a PyTorch `),Fe=n("a"),bn=i("torch.nn.Module"),kn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wn=m(),F=n("div"),b(qe.$$.fragment),Pn=m(),J=n("p"),$n=i("The "),Ve=n("a"),yn=i("GPTNeoXForCausalLM"),Nn=i(" forward method, overrides the "),bt=n("code"),Gn=i("__call__"),Xn=i(" special method."),xn=m(),b(le.$$.fragment),zn=m(),b(de.$$.fragment),this.h()},l(e){const c=_s('[data-svelte="svelte-1phssyn"]',document.head);d=s(c,"META",{name:!0,content:!0}),c.forEach(o),T=f(e),p=s(e,"H1",{class:!0});var je=a(p);u=s(je,"A",{id:!0,class:!0,href:!0});var kt=a(u);v=s(kt,"SPAN",{});var wt=a(v);k(r.$$.fragment,wt),wt.forEach(o),kt.forEach(o),_=f(je),X=s(je,"SPAN",{});var Pt=a(X);L=l(Pt,"GPT-NeoX"),Pt.forEach(o),je.forEach(o),z=f(e),C=s(e,"H2",{class:!0});var Ae=a(C);q=s(Ae,"A",{id:!0,class:!0,href:!0});var $t=a(q);ot=s($t,"SPAN",{});var yt=a(ot);k(me.$$.fragment,yt),yt.forEach(o),$t.forEach(o),no=f(Ae),nt=s(Ae,"SPAN",{});var Cn=a(nt);so=l(Cn,"Overview"),Cn.forEach(o),Ae.forEach(o),Nt=f(e),R=s(e,"P",{});var Wt=a(R);ao=l(Wt,`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
be made freely and openly available to the public through a permissive license. It is, to the best of our knowledge,
the largest dense autoregressive model that has publicly available weights at the time of submission. In this work,
we describe GPT-NeoX-20B\u2019s architecture and training and evaluate its performance on a range of language-understanding,
mathematics, and knowledge-based tasks. We find that GPT-NeoX-20B is a particularly powerful few-shot reasoner and
