...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16084/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16084/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16084/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16084/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16084/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
to no avail, the next thing to try is to pre-build the modules before installing them.`),Tj=u(),Gp=o("p"),X6=a("To make a local build for DeepSpeed:"),Aj=u(),f(so.$$.fragment),Sj=u(),De=o("p"),Q6=a("If you intend to use NVMe offload you will also need to include "),Kh=o("code"),e4=a("DS_BUILD_AIO=1"),s4=a(` in the instructions above (and also
install `),Jh=o("em"),t4=a("libaio-dev"),a4=a(" system-wide)."),Cj=u(),jt=o("p"),n4=a("Edit "),Xh=o("code"),o4=a("TORCH_CUDA_ARCH_LIST"),l4=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),xj=u(),f(to.$$.fragment),Rj=u(),ge=o("p"),r4=a("So if you get "),Qh=o("code"),p4=a("8, 6"),i4=a(", then use "),ef=o("code"),u4=a('TORCH_CUDA_ARCH_LIST="8.6"'),c4=a(`. If you have multiple different cards, you can list all
of them like so `),sf=o("code"),h4=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Ij=u(),Lp=o("p"),f4=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Uj=u(),f(ao.$$.fragment),Gj=u(),Oe=o("p"),d4=a("it will generate something like "),tf=o("code"),m4=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_4=a(` which now you can install
as `),af=o("code"),v4=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),j4=a(" locally or on any other machine."),Lj=u(),gt=o("p"),g4=a("Again, remember to ensure to adjust "),nf=o("code"),y4=a("TORCH_CUDA_ARCH_LIST"),w4=a(" to the target architectures."),Mj=u(),Te=o("p"),b4=a("You can find the complete list of NVIDIA GPUs and their corresponding "),of=o("strong"),q4=a("Compute Capabilities"),E4=a(` (same as arch in this
context) `),no=o("a"),$4=a("here"),k4=a("."),Zj=u(),Mp=o("p"),P4=a("You can check the archs pytorch was built with using:"),Nj=u(),f(oo.$$.fragment),Hj=u(),Zp=o("p"),z4=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Bj=u(),f(lo.$$.fragment),Wj=u(),Np=o("p"),D4=a("If the output is:"),Fj=u(),f(ro.$$.fragment),Vj=u(),yt=o("p"),O4=a("then you know that this card\u2019s arch is "),lf=o("code"),T4=a("8.6"),A4=a("."),Yj=u(),wt=o("p"),S4=a("You can also leave "),rf=o("code"),C4=a("TORCH_CUDA_ARCH_LIST"),x4=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Kj=u(),bt=o("p"),R4=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),po=o("a"),I4=a("Deepspeed"),U4=a(","),Jj=u(),Hp=o("a"),Xj=u(),ys=o("h3"),qt=o("a"),pf=o("span"),f(io.$$.fragment),G4=u(),uf=o("span"),L4=a("Deployment with multiple GPUs"),Qj=u(),Et=o("p"),M4=a("To deploy this feature with multiple GPUs adjust the "),Bp=o("a"),Z4=a("Trainer"),N4=a(` command line arguments as
following:`),eg=u(),$t=o("ol"),ws=o("li"),H4=a("replace "),cf=o("code"),B4=a("python -m torch.distributed.launch"),W4=a(" with "),hf=o("code"),F4=a("deepspeed"),V4=a("."),Y4=u(),ye=o("li"),K4=a("add a new argument "),ff=o("code"),J4=a("--deepspeed ds_config.json"),X4=a(", where "),df=o("code"),Q4=a("ds_config.json"),e$=a(` is the DeepSpeed configuration file as
...
find more details in the discussion below.`),wg=u(),At=o("p"),V$=a("For a practical usage example of this type of deployment, please, see this "),wo=o("a"),Y$=a("post"),K$=a("."),bg=u(),Qp=o("p"),J$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),qg=u(),ei=o("p"),X$=a("Notes:"),Eg=u(),si=o("ul"),qs=o("li"),bo=o("p"),Q$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=o("code"),e5=a("CUDA_VISIBLE_DEVICES"),s5=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),t5=u(),f(qo.$$.fragment),a5=u(),Of=o("p"),n5=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),$g=u(),ti=o("a"),kg=u(),Es=o("h3"),St=o("a"),Tf=o("span"),f(Eo.$$.fragment),o5=u(),Af=o("span"),l5=a("Deployment in Notebooks"),Pg=u(),Ct=o("p"),r5=a("The problem with running notebook cells as a script is that there is no normal "),Sf=o("code"),p5=a("deepspeed"),i5=a(` launcher to rely on, so
under certain setups we have to emulate it.`),zg=u(),ai=o("p"),u5=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Dg=u(),f($o.$$.fragment),Og=u(),xt=o("p"),c5=a("Note: "),Cf=o("code"),h5=a("..."),f5=a(" stands for the normal arguments that you\u2019d pass to the functions."),Tg=u(),ni=o("p"),d5=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Ag=u(),oi=o("p"),m5=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Sg=u(),f(ko.$$.fragment),Cg=u(),Se=o("p"),_5=a("If the training script is in a normal file and not in the notebook cells, you can launch "),xf=o("code"),v5=a("deepspeed"),j5=a(` normally via
shell from a cell. For example, to use `),Rf=o("code"),g5=a("run_translation.py"),y5=a(" you would launch it with:"),xg=u(),f(Po.$$.fragment),Rg=u(),Rt=o("p"),w5=a("or with "),If=o("code"),b5=a("%%bash"),q5=a(" magic, where you can write a multi-line code for the shell program to run:"),Ig=u(),f(zo.$$.fragment),Ug=u(),li=o("p"),E5=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Gg=u(),It=o("p"),$5=a("Note: While "),Uf=o("code"),k5=a("%%bash"),P5=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Lg=u(),ri=o("a"),Mg=u(),$s=o("h3"),Ut=o("a"),Gf=o("span"),f(Do.$$.fragment),z5=u(),Lf=o("span"),D5=a("Configuration"),Zg=u(),Gt=o("p"),O5=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=o("a"),T5=a("following documentation"),A5=a("."),Ng=u(),Lt=o("p"),S5=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=o("a"),C5=a(`the DeepSpeedExamples
repo`),x5=a(":"),Hg=u(),f(Ao.$$.fragment),Bg=u(),Mt=o("p"),R5=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=o("code"),I5=a(".json"),U5=a(" files with:"),Wg=u(),f(So.$$.fragment),Fg=u(),Zt=o("p"),G5=a("Some more examples are to be found in the "),Co=o("a"),L5=a("main repo"),M5=a(" as well."),Vg=u(),pi=o("p"),Z5=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Yg=u(),X=o("p"),N5=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Zf=o("code"),H5=a("AdamW"),B5=a(" optimizer and "),Nf=o("code"),W5=a("WarmupLR"),F5=a(` scheduler and will enable mixed
precision training if `),Hf=o("code"),V5=a("--fp16"),Y5=a(" is passed:"),Kg=u(),f(xo.$$.fragment),Jg=u(),Nt=o("p"),K5=a("When you execute the program, DeepSpeed will log the configuration it received from the "),ii=o("a"),J5=a("Trainer"),X5=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),Xg=u(),ui=o("a"),Qg=u(),ks=o("h3"),Ht=o("a"),Bf=o("span"),f(Ro.$$.fragment),Q5=u(),Wf=o("span"),e8=a("Passing Configuration"),ey=u(),T=o("p"),s8=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
to no avail, the next thing to try is to pre-build the modules before installing them.`),IU.forEach(t),Tj=c(e),Gp=l(e,"P",{});var UU=r(Gp);X6=n(UU,"To make a local build for DeepSpeed:"),UU.forEach(t),Aj=c(e),d(so.$$.fragment,e),Sj=c(e),De=l(e,"P",{});var Bc=r(De);Q6=n(Bc,"If you intend to use NVMe offload you will also need to include "),Kh=l(Bc,"CODE",{});var GU=r(Kh);e4=n(GU,"DS_BUILD_AIO=1"),GU.forEach(t),s4=n(Bc,` in the instructions above (and also
install `),Jh=l(Bc,"EM",{});var LU=r(Jh);t4=n(LU,"libaio-dev"),LU.forEach(t),a4=n(Bc," system-wide)."),Bc.forEach(t),Cj=c(e),jt=l(e,"P",{});var _0=r(jt);n4=n(_0,"Edit "),Xh=l(_0,"CODE",{});var MU=r(Xh);o4=n(MU,"TORCH_CUDA_ARCH_LIST"),MU.forEach(t),l4=n(_0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_0.forEach(t),xj=c(e),d(to.$$.fragment,e),Rj=c(e),ge=l(e,"P",{});var dp=r(ge);r4=n(dp,"So if you get "),Qh=l(dp,"CODE",{});var ZU=r(Qh);p4=n(ZU,"8, 6"),ZU.forEach(t),i4=n(dp,", then use "),ef=l(dp,"CODE",{});var NU=r(ef);u4=n(NU,'TORCH_CUDA_ARCH_LIST="8.6"'),NU.forEach(t),c4=n(dp,`. If you have multiple different cards, you can list all
of them like so `),sf=l(dp,"CODE",{});var HU=r(sf);h4=n(HU,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),HU.forEach(t),dp.forEach(t),Ij=c(e),Lp=l(e,"P",{});var BU=r(Lp);f4=n(BU,"If you need to use the same setup on multiple machines, make a binary wheel:"),BU.forEach(t),Uj=c(e),d(ao.$$.fragment,e),Gj=c(e),Oe=l(e,"P",{});var Wc=r(Oe);d4=n(Wc,"it will generate something like "),tf=l(Wc,"CODE",{});var WU=r(tf);m4=n(WU,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),WU.forEach(t),_4=n(Wc,` which now you can install
as `),af=l(Wc,"CODE",{});var FU=r(af);v4=n(FU,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),FU.forEach(t),j4=n(Wc," locally or on any other machine."),Wc.forEach(t),Lj=c(e),gt=l(e,"P",{});var v0=r(gt);g4=n(v0,"Again, remember to ensure to adjust "),nf=l(v0,"CODE",{});var VU=r(nf);y4=n(VU,"TORCH_CUDA_ARCH_LIST"),VU.forEach(t),w4=n(v0," to the target architectures."),v0.forEach(t),Mj=c(e),Te=l(e,"P",{});var Fc=r(Te);b4=n(Fc,"You can find the complete list of NVIDIA GPUs and their corresponding "),of=l(Fc,"STRONG",{});var YU=r(of);q4=n(YU,"Compute Capabilities"),YU.forEach(t),E4=n(Fc,` (same as arch in this
context) `),no=l(Fc,"A",{href:!0,rel:!0});var KU=r(no);$4=n(KU,"here"),KU.forEach(t),k4=n(Fc,"."),Fc.forEach(t),Zj=c(e),Mp=l(e,"P",{});var JU=r(Mp);P4=n(JU,"You can check the archs pytorch was built with using:"),JU.forEach(t),Nj=c(e),d(oo.$$.fragment,e),Hj=c(e),Zp=l(e,"P",{});var XU=r(Zp);z4=n(XU,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),XU.forEach(t),Bj=c(e),d(lo.$$.fragment,e),Wj=c(e),Np=l(e,"P",{});var QU=r(Np);D4=n(QU,"If the output is:"),QU.forEach(t),Fj=c(e),d(ro.$$.fragment,e),Vj=c(e),yt=l(e,"P",{});var j0=r(yt);O4=n(j0,"then you know that this card\u2019s arch is "),lf=l(j0,"CODE",{});var eG=r(lf);T4=n(eG,"8.6"),eG.forEach(t),A4=n(j0,"."),j0.forEach(t),Yj=c(e),wt=l(e,"P",{});var g0=r(wt);S4=n(g0,"You can also leave "),rf=l(g0,"CODE",{});var sG=r(rf);C4=n(sG,"TORCH_CUDA_ARCH_LIST"),sG.forEach(t),x4=n(g0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),g0.forEach(t),Kj=c(e),bt=l(e,"P",{});var y0=r(bt);R4=n(y0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),po=l(y0,"A",{href:!0,rel:!0});var tG=r(po);I4=n(tG,"Deepspeed"),tG.forEach(t),U4=n(y0,","),y0.forEach(t),Jj=c(e),Hp=l(e,"A",{id:!0}),r(Hp).forEach(t),Xj=c(e),ys=l(e,"H3",{class:!0});var w0=r(ys);qt=l(w0,"A",{id:!0,class:!0,href:!0});var aG=r(qt);pf=l(aG,"SPAN",{});var nG=r(pf);d(io.$$.fragment,nG),nG.forEach(t),aG.forEach(t),G4=c(w0),uf=l(w0,"SPAN",{});var oG=r(uf);L4=n(oG,"Deployment with multiple GPUs"),oG.forEach(t),w0.forEach(t),Qj=c(e),Et=l(e,"P",{});var b0=r(Et);M4=n(b0,"To deploy this feature with multiple GPUs adjust the "),Bp=l(b0,"A",{href:!0});var lG=r(Bp);Z4=n(lG,"Trainer"),lG.forEach(t),N4=n(b0,` command line arguments as
following:`),b0.forEach(t),eg=c(e),$t=l(e,"OL",{});var q0=r($t);ws=l(q0,"LI",{});var Vc=r(ws);H4=n(Vc,"replace "),cf=l(Vc,"CODE",{});var rG=r(cf);B4=n(rG,"python -m torch.distributed.launch"),rG.forEach(t),W4=n(Vc," with "),hf=l(Vc,"CODE",{});var pG=r(hf);F4=n(pG,"deepspeed"),pG.forEach(t),V4=n(Vc,"."),Vc.forEach(t),Y4=c(q0),ye=l(q0,"LI",{});var Pn=r(ye);K4=n(Pn,"add a new argument "),ff=l(Pn,"CODE",{});var iG=r(ff);J4=n(iG,"--deepspeed ds_config.json"),iG.forEach(t),X4=n(Pn,", where "),df=l(Pn,"CODE",{});var uG=r(df);Q4=n(uG,"ds_config.json"),uG.forEach(t),e$=n(Pn,` is the DeepSpeed configuration file as
...
find more details in the discussion below.`),xG.forEach(t),wg=c(e),At=l(e,"P",{});var O0=r(At);V$=n(O0,"For a practical usage example of this type of deployment, please, see this "),wo=l(O0,"A",{href:!0,rel:!0});var RG=r(wo);Y$=n(RG,"post"),RG.forEach(t),K$=n(O0,"."),O0.forEach(t),bg=c(e),Qp=l(e,"P",{});var IG=r(Qp);J$=n(IG,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),IG.forEach(t),qg=c(e),ei=l(e,"P",{});var UG=r(ei);X$=n(UG,"Notes:"),UG.forEach(t),Eg=c(e),si=l(e,"UL",{});var GG=r(si);qs=l(GG,"LI",{});var Kc=r(qs);bo=l(Kc,"P",{});var T0=r(bo);Q$=n(T0,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=l(T0,"CODE",{});var LG=r(Df);e5=n(LG,"CUDA_VISIBLE_DEVICES"),LG.forEach(t),s5=n(T0,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),T0.forEach(t),t5=c(Kc),d(qo.$$.fragment,Kc),a5=c(Kc),Of=l(Kc,"P",{});var MG=r(Of);n5=n(MG,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),MG.forEach(t),Kc.forEach(t),GG.forEach(t),$g=c(e),ti=l(e,"A",{id:!0}),r(ti).forEach(t),kg=c(e),Es=l(e,"H3",{class:!0});var A0=r(Es);St=l(A0,"A",{id:!0,class:!0,href:!0});var ZG=r(St);Tf=l(ZG,"SPAN",{});var NG=r(Tf);d(Eo.$$.fragment,NG),NG.forEach(t),ZG.forEach(t),o5=c(A0),Af=l(A0,"SPAN",{});var HG=r(Af);l5=n(HG,"Deployment in Notebooks"),HG.forEach(t),A0.forEach(t),Pg=c(e),Ct=l(e,"P",{});var S0=r(Ct);r5=n(S0,"The problem with running notebook cells as a script is that there is no normal "),Sf=l(S0,"CODE",{});var BG=r(Sf);p5=n(BG,"deepspeed"),BG.forEach(t),i5=n(S0,` launcher to rely on, so
under certain setups we have to emulate it.`),S0.forEach(t),zg=c(e),ai=l(e,"P",{});var WG=r(ai);u5=n(WG,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),WG.forEach(t),Dg=c(e),d($o.$$.fragment,e),Og=c(e),xt=l(e,"P",{});var C0=r(xt);c5=n(C0,"Note: "),Cf=l(C0,"CODE",{});var FG=r(Cf);h5=n(FG,"..."),FG.forEach(t),f5=n(C0," stands for the normal arguments that you\u2019d pass to the functions."),C0.forEach(t),Tg=c(e),ni=l(e,"P",{});var VG=r(ni);d5=n(VG,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),VG.forEach(t),Ag=c(e),oi=l(e,"P",{});var YG=r(oi);m5=n(YG,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),YG.forEach(t),Sg=c(e),d(ko.$$.fragment,e),Cg=c(e),Se=l(e,"P",{});var Jc=r(Se);_5=n(Jc,"If the training script is in a normal file and not in the notebook cells, you can launch "),xf=l(Jc,"CODE",{});var KG=r(xf);v5=n(KG,"deepspeed"),KG.forEach(t),j5=n(Jc,` normally via
shell from a cell. For example, to use `),Rf=l(Jc,"CODE",{});var JG=r(Rf);g5=n(JG,"run_translation.py"),JG.forEach(t),y5=n(Jc," you would launch it with:"),Jc.forEach(t),xg=c(e),d(Po.$$.fragment,e),Rg=c(e),Rt=l(e,"P",{});var x0=r(Rt);w5=n(x0,"or with "),If=l(x0,"CODE",{});var XG=r(If);b5=n(XG,"%%bash"),XG.forEach(t),q5=n(x0," magic, where you can write a multi-line code for the shell program to run:"),x0.forEach(t),Ig=c(e),d(zo.$$.fragment,e),Ug=c(e),li=l(e,"P",{});var QG=r(li);E5=n(QG,"In such case you don\u2019t need any of the code presented at the beginning of this section."),QG.forEach(t),Gg=c(e),It=l(e,"P",{});var R0=r(It);$5=n(R0,"Note: While "),Uf=l(R0,"CODE",{});var eL=r(Uf);k5=n(eL,"%%bash"),eL.forEach(t),P5=n(R0,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),R0.forEach(t),Lg=c(e),ri=l(e,"A",{id:!0}),r(ri).forEach(t),Mg=c(e),$s=l(e,"H3",{class:!0});var I0=r($s);Ut=l(I0,"A",{id:!0,class:!0,href:!0});var sL=r(Ut);Gf=l(sL,"SPAN",{});var tL=r(Gf);d(Do.$$.fragment,tL),tL.forEach(t),sL.forEach(t),z5=c(I0),Lf=l(I0,"SPAN",{});var aL=r(Lf);D5=n(aL,"Configuration"),aL.forEach(t),I0.forEach(t),Zg=c(e),Gt=l(e,"P",{});var U0=r(Gt);O5=n(U0,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=l(U0,"A",{href:!0,rel:!0});var nL=r(Oo);T5=n(nL,"following documentation"),nL.forEach(t),A5=n(U0,"."),U0.forEach(t),Ng=c(e),Lt=l(e,"P",{});var G0=r(Lt);S5=n(G0,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=l(G0,"A",{href:!0,rel:!0});var oL=r(To);C5=n(oL,`the DeepSpeedExamples
repo`),oL.forEach(t),x5=n(G0,":"),G0.forEach(t),Hg=c(e),d(Ao.$$.fragment,e),Bg=c(e),Mt=l(e,"P",{});var L0=r(Mt);R5=n(L0,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=l(L0,"CODE",{});var lL=r(Mf);I5=n(lL,".json"),lL.forEach(t),U5=n(L0," files with:"),L0.forEach(t),Wg=c(e),d(So.$$.fragment,e),Fg=c(e),Zt=l(e,"P",{});var M0=r(Zt);G5=n(M0,"Some more examples are to be found in the "),Co=l(M0,"A",{href:!0,rel:!0});var rL=r(Co);L5=n(rL,"main repo"),rL.forEach(t),M5=n(M0," as well."),M0.forEach(t),Vg=c(e),pi=l(e,"P",{});var pL=r(pi);Z5=n(pL,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),pL.forEach(t),Yg=c(e),X=l(e,"P",{});var Dn=r(X);N5=n(Dn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Zf=l(Dn,"CODE",{});var iL=r(Zf);H5=n(iL,"AdamW"),iL.forEach(t),B5=n(Dn," optimizer and "),Nf=l(Dn,"CODE",{});var uL=r(Nf);W5=n(uL,"WarmupLR"),uL.forEach(t),F5=n(Dn,` scheduler and will enable mixed
precision training if `),Hf=l(Dn,"CODE",{});var cL=r(Hf);V5=n(cL,"--fp16"),cL.forEach(t),Y5=n(Dn," is passed:"),Dn.forEach(t),Kg=c(e),d(xo.$$.fragment,e),Jg=c(e),Nt=l(e,"P",{});var Z0=r(Nt);K5=n(Z0,"When you execute the program, DeepSpeed will log the configuration it received from the "),ii=l(Z0,"A",{href:!0});var hL=r(ii);J5=n(hL,"Trainer"),hL.forEach(t),X5=n(Z0,`
to the console, so you can see exactly what was the final configuration passed to it.`),Z0.forEach(t),Xg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Qg=c(e),ks=l(e,"H3",{class:!0});var N0=r(ks);Ht=l(N0,"A",{id:!0,class:!0,href:!0});var fL=r(Ht);Bf=l(fL,"SPAN",{});var dL=r(Bf);d(Ro.$$.fragment,dL),dL.forEach(t),fL.forEach(t),Q5=c(N0),Wf=l(N0,"SPAN",{});var mL=r(Wf);e8=n(mL,"Passing Configuration"),mL.forEach(t),N0.forEach(t),ey=c(e),T=l(e,"P",{});var fe=r(T);s8=n(fe,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
