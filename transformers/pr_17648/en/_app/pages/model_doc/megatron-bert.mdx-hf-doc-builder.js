import{S as cm,i as pm,s as hm,e as a,k as m,w as k,t as r,M as mm,c as i,d as o,m as g,a as l,x as M,h as s,b as f,G as e,g as b,y as w,q as T,o as $,B as y,v as gm,L as j}from"../../chunks/vendor-hf-doc-builder.js";import{T as We}from"../../chunks/Tip-hf-doc-builder.js";import{D as q}from"../../chunks/Docstring-hf-doc-builder.js";import{C as z}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as te}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function um(B){let d,_,c,h,v;return h=new z({props:{code:`from transformers import MegatronBertModel, MegatronBertConfig
...
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){w(d,c,h),_=!0},p:j,i(c){_||(T(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function qm(B){let d,_,c,h,v;return h=new z({props:{code:`import torch
from transformers import BertTokenizer, MegatronBertForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){w(d,c,h),_=!0},p:j,i(c){_||(T(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Im(B){let d,_,c,h,v,n,p,F,$a,ls,fe,Re,Gn,Et,ya,Qn,Ba,ds,He,Fa,jt,za,xa,cs,nn,qa,ps,rn,Vn,Pa,hs,sn,Ca,ms,Ue,Ea,Ot,ja,Oa,gs,oe,Aa,At,La,Sa,Lt,Na,Ia,us,an,Da,fs,ln,Wa,_s,St,bs,dn,Ra,vs,Nt,ks,cn,Ha,Ms,ne,Ua,Jn,Ga,Qa,Kn,Va,Ja,ws,It,Ts,Dt,$s,re,Ka,Wt,Ya,Xa,Rt,Za,ei,ys,_e,Ge,Yn,Ht,ti,Xn,oi,Bs,J,Ut,ni,be,ri,pn,si,ai,Gt,ii,li,di,ve,ci,hn,pi,hi,mn,mi,gi,ui,Qe,Fs,ke,Ve,Zn,Qt,fi,er,_i,zs,x,Vt,bi,tr,vi,ki,Jt,Mi,gn,wi,Ti,$i,Kt,yi,Yt,Bi,Fi,zi,Xt,xi,Zt,qi,Pi,Ci,C,Ei,or,ji,Oi,nr,Ai,Li,rr,Si,Ni,sr,Ii,Di,ar,Wi,Ri,ir,Hi,Ui,Gi,K,eo,Qi,Me,Vi,un,Ji,Ki,lr,Yi,Xi,Zi,Je,el,Ke,xs,we,Ye,dr,to,tl,cr,ol,qs,O,oo,nl,no,rl,pr,sl,al,il,ro,ll,fn,dl,cl,pl,so,hl,ao,ml,gl,ul,R,io,fl,Te,_l,_n,bl,vl,hr,kl,Ml,wl,Xe,Tl,Ze,$l,et,Ps,$e,tt,mr,lo,yl,gr,Bl,Cs,A,co,Fl,po,zl,ur,xl,ql,Pl,ho,Cl,bn,El,jl,Ol,mo,Al,go,Ll,Sl,Nl,Y,uo,Il,ye,Dl,vn,Wl,Rl,fr,Hl,Ul,Gl,ot,Ql,nt,Es,Be,rt,_r,fo,Vl,br,Jl,js,L,_o,Kl,bo,Yl,vr,Xl,Zl,ed,vo,td,kn,od,nd,rd,ko,sd,Mo,ad,id,ld,X,wo,dd,Fe,cd,Mn,pd,hd,kr,md,gd,ud,st,fd,at,Os,ze,it,Mr,To,_d,wr,bd,As,S,$o,vd,xe,kd,Tr,Md,wd,$r,Td,$d,yd,yo,Bd,wn,Fd,zd,xd,Bo,qd,Fo,Pd,Cd,Ed,Z,zo,jd,qe,Od,Tn,Ad,Ld,yr,Sd,Nd,Id,lt,Dd,dt,Ls,Pe,ct,Br,xo,Wd,Fr,Rd,Ss,N,qo,Hd,zr,Ud,Gd,Po,Qd,$n,Vd,Jd,Kd,Co,Yd,Eo,Xd,Zd,ec,P,jo,tc,Ce,oc,yn,nc,rc,xr,sc,ac,ic,pt,lc,ht,dc,mt,cc,gt,pc,ut,Ns,Ee,ft,qr,Oo,hc,Pr,mc,Is,I,Ao,gc,Cr,uc,fc,Lo,_c,Bn,bc,vc,kc,So,Mc,No,wc,Tc,$c,ee,Io,yc,je,Bc,Fn,Fc,zc,Er,xc,qc,Pc,_t,Cc,bt,Ds,Oe,vt,jr,Do,Ec,Or,jc,Ws,D,Wo,Oc,Ar,Ac,Lc,Ro,Sc,zn,Nc,Ic,Dc,Ho,Wc,Uo,Rc,Hc,Uc,H,Go,Gc,Ae,Qc,xn,Vc,Jc,Lr,Kc,Yc,Xc,kt,Zc,Mt,ep,wt,Rs,Le,Tt,Sr,Qo,tp,Nr,op,Hs,W,Vo,np,Se,rp,Ir,sp,ap,Dr,ip,lp,dp,Jo,cp,qn,pp,hp,mp,Ko,gp,Yo,up,fp,_p,U,Xo,bp,Ne,vp,Pn,kp,Mp,Wr,wp,Tp,$p,$t,yp,yt,Bp,Bt,Us;return n=new te({}),Et=new te({}),St=new z({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/configuration_megatron_bert.py#L28"}}),Qe=new E({props:{anchor:"transformers.MegatronBertConfig.example",$$slots:{default:[um]},$$scope:{ctx:B}}}),Qt=new te({}),Vt=new q({props:{name:"class transformers.MegatronBertModel",anchor:"transformers.MegatronBertModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.MegatronBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L834"}}),eo=new q({props:{name:"forward",anchor:"transformers.MegatronBertModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MegatronBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L873",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig"
...
`}}),Je=new We({props:{$$slots:{default:[fm]},$$scope:{ctx:B}}}),Ke=new E({props:{anchor:"transformers.MegatronBertModel.forward.example",$$slots:{default:[_m]},$$scope:{ctx:B}}}),to=new te({}),oo=new q({props:{name:"class transformers.MegatronBertForMaskedLM",anchor:"transformers.MegatronBertForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MegatronBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1261"}}),io=new q({props:{name:"forward",anchor:"transformers.MegatronBertForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MegatronBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17648/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17648/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17648/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1287",returnDescription:`
<p>A <a
...
`}}),Xe=new We({props:{$$slots:{default:[bm]},$$scope:{ctx:B}}}),Ze=new E({props:{anchor:"transformers.MegatronBertForMaskedLM.forward.example",$$slots:{default:[vm]},$$scope:{ctx:B}}}),et=new E({props:{anchor:"transformers.MegatronBertForMaskedLM.forward.example-2",$$slots:{default:[km]},$$scope:{ctx:B}}}),lo=new te({}),co=new q({props:{name:"class transformers.MegatronBertForCausalLM",anchor:"transformers.MegatronBertForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MegatronBertForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1115"}}),uo=new q({props:{name:"forward",anchor:"transformers.MegatronBertForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MegatronBertForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17648/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17648/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17648/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1138",returnDescription:`
<p>A <a
...
`}}),ot=new We({props:{$$slots:{default:[Mm]},$$scope:{ctx:B}}}),nt=new E({props:{anchor:"transformers.MegatronBertForCausalLM.forward.example",$$slots:{default:[wm]},$$scope:{ctx:B}}}),fo=new te({}),_o=new q({props:{name:"class transformers.MegatronBertForNextSentencePrediction",anchor:"transformers.MegatronBertForNextSentencePrediction",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MegatronBertForNextSentencePrediction.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1371"}}),wo=new q({props:{name:"forward",anchor:"transformers.MegatronBertForNextSentencePrediction.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MegatronBertForNextSentencePrediction.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17648/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17648/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17648/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1384",returnDescription:`
<p>A <a
...
`}}),st=new We({props:{$$slots:{default:[Tm]},$$scope:{ctx:B}}}),at=new E({props:{anchor:"transformers.MegatronBertForNextSentencePrediction.forward.example",$$slots:{default:[$m]},$$scope:{ctx:B}}}),To=new te({}),$o=new q({props:{name:"class transformers.MegatronBertForPreTraining",anchor:"transformers.MegatronBertForPreTraining",parameters:[{name:"config",val:""},{name:"add_binary_head",val:" = True"}],parametersDescription:[{anchor:"transformers.MegatronBertForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1011"}}),zo=new q({props:{name:"forward",anchor:"transformers.MegatronBertForPreTraining.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"next_sentence_label",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MegatronBertForPreTraining.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17648/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17648/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17648/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1027",returnDescription:`
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1490",returnDescription:`
<p>A <a
...
`}}),pt=new We({props:{$$slots:{default:[Fm]},$$scope:{ctx:B}}}),ht=new E({props:{anchor:"transformers.MegatronBertForSequenceClassification.forward.example",$$slots:{default:[zm]},$$scope:{ctx:B}}}),mt=new E({props:{anchor:"transformers.MegatronBertForSequenceClassification.forward.example-2",$$slots:{default:[xm]},$$scope:{ctx:B}}}),gt=new E({props:{anchor:"transformers.MegatronBertForSequenceClassification.forward.example-3",$$slots:{default:[qm]},$$scope:{ctx:B}}}),ut=new E({props:{anchor:"transformers.MegatronBertForSequenceClassification.forward.example-4",$$slots:{default:[Pm]},$$scope:{ctx:B}}}),Oo=new te({}),Ao=new q({props:{name:"class transformers.MegatronBertForMultipleChoice",anchor:"transformers.MegatronBertForMultipleChoice",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MegatronBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17648/en/model_doc/megatron-bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1576"}}),Io=new q({props:{name:"forward",anchor:"transformers.MegatronBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MegatronBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17648/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17648/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17648/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1587",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1685",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17648/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1766",returnDescription:`
<p>A <a
...
`}}),$t=new We({props:{$$slots:{default:[Lm]},$$scope:{ctx:B}}}),yt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example",$$slots:{default:[Sm]},$$scope:{ctx:B}}}),Bt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example-2",$$slots:{default:[Nm]},$$scope:{ctx:B}}}),{c(){d=a("meta"),_=m(),c=a("h1"),h=a("a"),v=a("span"),k(n.$$.fragment),p=m(),F=a("span"),$a=r("MegatronBERT"),ls=m(),fe=a("h2"),Re=a("a"),Gn=a("span"),k(Et.$$.fragment),ya=m(),Qn=a("span"),Ba=r("Overview"),ds=m(),He=a("p"),Fa=r("The MegatronBERT model was proposed in "),jt=a("a"),za=r(`Megatron-LM: Training Multi-Billion Parameter Language Models Using Model
Parallelism`),xa=r(` by Mohammad Shoeybi, Mostofa Patwary, Raul Puri, Patrick LeGresley,
Jared Casper and Bryan Catanzaro.`),cs=m(),nn=a("p"),qa=r("The abstract from the paper is the following:"),ps=m(),rn=a("p"),Vn=a("em"),Pa=r(`Recent work in language modeling demonstrates that training large transformer models advances the state of the art in
...
\u201Cpipeline parallel\u201D techniques.`),ys=m(),_e=a("h2"),Ge=a("a"),Yn=a("span"),k(Ht.$$.fragment),ti=m(),Xn=a("span"),oi=r("MegatronBertConfig"),Bs=m(),J=a("div"),k(Ut.$$.fragment),ni=m(),be=a("p"),ri=r("This is the configuration class to store the configuration of a "),pn=a("a"),si=r("MegatronBertModel"),ai=r(`. It is used to instantiate a
...
`),Gt=a("a"),ii=r("nvidia/megatron-bert-uncased-345m"),li=r(" architecture."),di=m(),ve=a("p"),ci=r("Configuration objects inherit from "),hn=a("a"),pi=r("PretrainedConfig"),hi=r(` and can be used to control the model outputs. Read the
documentation from `),mn=a("a"),mi=r("PretrainedConfig"),gi=r(" for more information."),ui=m(),k(Qe.$$.fragment),Fs=m(),ke=a("h2"),Ve=a("a"),Zn=a("span"),k(Qt.$$.fragment),fi=m(),er=a("span"),_i=r("MegatronBertModel"),zs=m(),x=a("div"),k(Vt.$$.fragment),bi=m(),tr=a("p"),vi=r("The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),ki=m(),Jt=a("p"),Mi=r("This model inherits from "),gn=a("a"),wi=r("PreTrainedModel"),Ti=r(`. Check the superclass documentation for the generic methods the
...
cross-attention is added between the self-attention layers, following the architecture described in `),Zt=a("a"),qi=r(`Attention is
all you need`),Pi=r(` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
...
`),sr=a("code"),Ii=r("add_cross_attention"),Di=r(" set to "),ar=a("code"),Wi=r("True"),Ri=r("; an "),ir=a("code"),Hi=r("encoder_hidden_states"),Ui=r(" is then expected as an input to the forward pass."),Gi=m(),K=a("div"),k(eo.$$.fragment),Qi=m(),Me=a("p"),Vi=r("The "),un=a("a"),Ji=r("MegatronBertModel"),Ki=r(" forward method, overrides the "),lr=a("code"),Yi=r("__call__"),Xi=r(" special method."),Zi=m(),k(Je.$$.fragment),el=m(),k(Ke.$$.fragment),xs=m(),we=a("h2"),Ye=a("a"),dr=a("span"),k(to.$$.fragment),tl=m(),cr=a("span"),ol=r("MegatronBertForMaskedLM"),qs=m(),O=a("div"),k(oo.$$.fragment),nl=m(),no=a("p"),rl=r("MegatronBert Model with a "),pr=a("code"),sl=r("language modeling"),al=r(" head on top."),il=m(),ro=a("p"),ll=r("This model inherits from "),fn=a("a"),dl=r("PreTrainedModel"),cl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pl=m(),so=a("p"),hl=r("This model is also a PyTorch "),ao=a("a"),ml=r("torch.nn.Module"),gl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ul=m(),R=a("div"),k(io.$$.fragment),fl=m(),Te=a("p"),_l=r("The "),_n=a("a"),bl=r("MegatronBertForMaskedLM"),vl=r(" forward method, overrides the "),hr=a("code"),kl=r("__call__"),Ml=r(" special method."),wl=m(),k(Xe.$$.fragment),Tl=m(),k(Ze.$$.fragment),$l=m(),k(et.$$.fragment),Ps=m(),$e=a("h2"),tt=a("a"),mr=a("span"),k(lo.$$.fragment),yl=m(),gr=a("span"),Bl=r("MegatronBertForCausalLM"),Cs=m(),A=a("div"),k(co.$$.fragment),Fl=m(),po=a("p"),zl=r("MegatronBert Model with a "),ur=a("code"),xl=r("language modeling"),ql=r(" head on top for CLM fine-tuning."),Pl=m(),ho=a("p"),Cl=r("This model inherits from "),bn=a("a"),El=r("PreTrainedModel"),jl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ol=m(),mo=a("p"),Al=r("This model is also a PyTorch "),go=a("a"),Ll=r("torch.nn.Module"),Sl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nl=m(),Y=a("div"),k(uo.$$.fragment),Il=m(),ye=a("p"),Dl=r("The "),vn=a("a"),Wl=r("MegatronBertForCausalLM"),Rl=r(" forward method, overrides the "),fr=a("code"),Hl=r("__call__"),Ul=r(" special method."),Gl=m(),k(ot.$$.fragment),Ql=m(),k(nt.$$.fragment),Es=m(),Be=a("h2"),rt=a("a"),_r=a("span"),k(fo.$$.fragment),Vl=m(),br=a("span"),Jl=r("MegatronBertForNextSentencePrediction"),js=m(),L=a("div"),k(_o.$$.fragment),Kl=m(),bo=a("p"),Yl=r("MegatronBert Model with a "),vr=a("code"),Xl=r("next sentence prediction (classification)"),Zl=r(" head on top."),ed=m(),vo=a("p"),td=r("This model inherits from "),kn=a("a"),od=r("PreTrainedModel"),nd=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xd=m(),Bo=a("p"),qd=r("This model is also a PyTorch "),Fo=a("a"),Pd=r("torch.nn.Module"),Cd=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed=m(),Z=a("div"),k(zo.$$.fragment),jd=m(),qe=a("p"),Od=r("The "),Tn=a("a"),Ad=r("MegatronBertForPreTraining"),Ld=r(" forward method, overrides the "),yr=a("code"),Sd=r("__call__"),Nd=r(" special method."),Id=m(),k(lt.$$.fragment),Dd=m(),k(dt.$$.fragment),Ls=m(),Pe=a("h2"),ct=a("a"),Br=a("span"),k(xo.$$.fragment),Wd=m(),Fr=a("span"),Rd=r("MegatronBertForSequenceClassification"),Ss=m(),N=a("div"),k(qo.$$.fragment),Hd=m(),zr=a("p"),Ud=r(`MegatronBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Gd=m(),Po=a("p"),Qd=r("This model inherits from "),$n=a("a"),Vd=r("PreTrainedModel"),Jd=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kd=m(),Co=a("p"),Yd=r("This model is also a PyTorch "),Eo=a("a"),Xd=r("torch.nn.Module"),Zd=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=m(),P=a("div"),k(jo.$$.fragment),tc=m(),Ce=a("p"),oc=r("The "),yn=a("a"),nc=r("MegatronBertForSequenceClassification"),rc=r(" forward method, overrides the "),xr=a("code"),sc=r("__call__"),ac=r(" special method."),ic=m(),k(pt.$$.fragment),lc=m(),k(ht.$$.fragment),dc=m(),k(mt.$$.fragment),cc=m(),k(gt.$$.fragment),pc=m(),k(ut.$$.fragment),Ns=m(),Ee=a("h2"),ft=a("a"),qr=a("span"),k(Oo.$$.fragment),hc=m(),Pr=a("span"),mc=r("MegatronBertForMultipleChoice"),Is=m(),I=a("div"),k(Ao.$$.fragment),gc=m(),Cr=a("p"),uc=r(`MegatronBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output
...
`),Kn=i(De,"CODE",{});var Fp=l(Kn);Va=s(Fp,"megatron_bert_345m_v0_1_{cased, uncased}.zip"),Fp.forEach(o),Ja=s(De," and that the commands are run from inside that folder:"),De.forEach(o),ws=g(t),M(It.$$.fragment,t),Ts=g(t),M(Dt.$$.fragment,t),$s=g(t),re=i(t,"P",{});var Cn=l(re);Ka=s(Cn,"This model was contributed by "),Wt=i(Cn,"A",{href:!0,rel:!0});var zp=l(Wt);Ya=s(zp,"jdemouth"),zp.forEach(o),Xa=s(Cn,". The original code can be found "),Rt=i(Cn,"A",{href:!0,rel:!0});var xp=l(Rt);Za=s(xp,"here"),xp.forEach(o),ei=s(Cn,`. That repository contains a multi-GPU and multi-node implementation of the
Megatron Language models. In particular, it contains a hybrid model parallel approach using \u201Ctensor parallel\u201D and
\u201Cpipeline parallel\u201D techniques.`),Cn.forEach(o),ys=g(t),_e=i(t,"H2",{class:!0});var Gs=l(_e);Ge=i(Gs,"A",{id:!0,class:!0,href:!0});var qp=l(Ge);Yn=i(qp,"SPAN",{});var Pp=l(Yn);M(Ht.$$.fragment,Pp),Pp.forEach(o),qp.forEach(o),ti=g(Gs),Xn=i(Gs,"SPAN",{});var Cp=l(Xn);oi=s(Cp,"MegatronBertConfig"),Cp.forEach(o),Gs.forEach(o),Bs=g(t),J=i(t,"DIV",{class:!0});var Ft=l(J);M(Ut.$$.fragment,Ft),ni=g(Ft),be=i(Ft,"P",{});var En=l(be);ri=s(En,"This is the configuration class to store the configuration of a "),pn=i(En,"A",{href:!0});var Ep=l(pn);si=s(Ep,"MegatronBertModel"),Ep.forEach(o),ai=s(En,`. It is used to instantiate a
MEGATRON_BERT model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MEGATRON_BERT
`),Gt=i(En,"A",{href:!0,rel:!0});var jp=l(Gt);ii=s(jp,"nvidia/megatron-bert-uncased-345m"),jp.forEach(o),li=s(En," architecture."),En.forEach(o),di=g(Ft),ve=i(Ft,"P",{});var jn=l(ve);ci=s(jn,"Configuration objects inherit from "),hn=i(jn,"A",{href:!0});var Op=l(hn);pi=s(Op,"PretrainedConfig"),Op.forEach(o),hi=s(jn,` and can be used to control the model outputs. Read the
documentation from `),mn=i(jn,"A",{href:!0});var Ap=l(mn);mi=s(Ap,"PretrainedConfig"),Ap.forEach(o),gi=s(jn," for more information."),jn.forEach(o),ui=g(Ft),M(Qe.$$.fragment,Ft),Ft.forEach(o),Fs=g(t),ke=i(t,"H2",{class:!0});var Qs=l(ke);Ve=i(Qs,"A",{id:!0,class:!0,href:!0});var Lp=l(Ve);Zn=i(Lp,"SPAN",{});var Sp=l(Zn);M(Qt.$$.fragment,Sp),Sp.forEach(o),Lp.forEach(o),fi=g(Qs),er=i(Qs,"SPAN",{});var Np=l(er);_i=s(Np,"MegatronBertModel"),Np.forEach(o),Qs.forEach(o),zs=g(t),x=i(t,"DIV",{class:!0});var G=l(x);M(Vt.$$.fragment,G),bi=g(G),tr=i(G,"P",{});var Ip=l(tr);vi=s(Ip,"The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),Ip.forEach(o),ki=g(G),Jt=i(G,"P",{});var Vs=l(Jt);Mi=s(Vs,"This model inherits from "),gn=i(Vs,"A",{href:!0});var Dp=l(gn);wi=s(Dp,"PreTrainedModel"),Dp.forEach(o),Ti=s(Vs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
cross-attention is added between the self-attention layers, following the architecture described in `),Zt=i(Ks,"A",{href:!0,rel:!0});var Rp=l(Zt);qi=s(Rp,`Attention is
all you need`),Rp.forEach(o),Pi=s(Ks,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ca.forEach(o),xd=g(de),Bo=i(de,"P",{});var pa=l(Bo);qd=s(pa,"This model is also a PyTorch "),Fo=i(pa,"A",{href:!0,rel:!0});var zh=l(Fo);Pd=s(zh,"torch.nn.Module"),zh.forEach(o),Cd=s(pa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pa.forEach(o),Ed=g(de),Z=i(de,"DIV",{class:!0});var Pt=l(Z);M(zo.$$.fragment,Pt),jd=g(Pt),qe=i(Pt,"P",{});var In=l(qe);Od=s(In,"The "),Tn=i(In,"A",{href:!0});var xh=l(Tn);Ad=s(xh,"MegatronBertForPreTraining"),xh.forEach(o),Ld=s(In," forward method, overrides the "),yr=i(In,"CODE",{});var qh=l(yr);Sd=s(qh,"__call__"),qh.forEach(o),Nd=s(In," special method."),In.forEach(o),Id=g(Pt),M(lt.$$.fragment,Pt),Dd=g(Pt),M(dt.$$.fragment,Pt),Pt.forEach(o),de.forEach(o),Ls=g(t),Pe=i(t,"H2",{class:!0});var ha=l(Pe);ct=i(ha,"A",{id:!0,class:!0,href:!0});var Ph=l(ct);Br=i(Ph,"SPAN",{});var Ch=l(Br);M(xo.$$.fragment,Ch),Ch.forEach(o),Ph.forEach(o),Wd=g(ha),Fr=i(ha,"SPAN",{});var Eh=l(Fr);Rd=s(Eh,"MegatronBertForSequenceClassification"),Eh.forEach(o),ha.forEach(o),Ss=g(t),N=i(t,"DIV",{class:!0});var ce=l(N);M(qo.$$.fragment,ce),Hd=g(ce),zr=i(ce,"P",{});var jh=l(zr);Ud=s(jh,`MegatronBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),jh.forEach(o),Gd=g(ce),Po=i(ce,"P",{});var ma=l(Po);Qd=s(ma,"This model inherits from "),$n=i(ma,"A",{href:!0});var Oh=l($n);Vd=s(Oh,"PreTrainedModel"),Oh.forEach(o),Jd=s(ma,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ka.forEach(o),Uc=g(he),H=i(he,"DIV",{class:!0});var me=l(H);M(Go.$$.fragment,me),Gc=g(me),Ae=i(me,"P",{});var Rn=l(Ae);Qc=s(Rn,"The "),xn=i(Rn,"A",{href:!0});var Zh=l(xn);Vc=s(Zh,"MegatronBertForTokenClassification"),Zh.forEach(o),Jc=s(Rn," forward method, overrides the "),Lr=i(Rn,"CODE",{});var em=l(Lr);Kc=s(em,"__call__"),em.forEach(o),Yc=s(Rn," special method."),Rn.forEach(o),Xc=g(me),M(kt.$$.fragment,me),Zc=g(me),M(Mt.$$.fragment,me),ep=g(me),M(wt.$$.fragment,me),me.forEach(o),he.forEach(o),Rs=g(t),Le=i(t,"H2",{class:!0});var Ma=l(Le);Tt=i(Ma,"A",{id:!0,class:!0,href:!0});var tm=l(Tt);Sr=i(tm,"SPAN",{});var om=l(Sr);M(Qo.$$.fragment,om),om.forEach(o),tm.forEach(o),tp=g(Ma),Nr=i(Ma,"SPAN",{});var nm=l(Nr);op=s(nm,"MegatronBertForQuestionAnswering"),nm.forEach(o),Ma.forEach(o),Hs=g(t),W=i(t,"DIV",{class:!0});var ge=l(W);M(Vo.$$.fragment,ge),np=g(ge),Se=i(ge,"P",{});var Hn=l(Se);rp=s(Hn,`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Ir=i(Hn,"CODE",{});var rm=l(Ir);sp=s(rm,"span start logits"),rm.forEach(o),ap=s(Hn," and "),Dr=i(Hn,"CODE",{});var sm=l(Dr);ip=s(sm,"span end logits"),sm.forEach(o),lp=s(Hn,")."),Hn.forEach(o),dp=g(ge),Jo=i(ge,"P",{});var wa=l(Jo);cp=s(wa,"This model inherits from "),qn=i(wa,"A",{href:!0});var am=l(qn);pp=s(am,"PreTrainedModel"),am.forEach(o),hp=s(wa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
