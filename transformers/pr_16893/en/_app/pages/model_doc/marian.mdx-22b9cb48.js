import{S as _m,i as gm,s as vm,e as o,k as d,w as M,t as r,M as km,c as s,d as t,m as c,a,x as b,h as i,b as p,F as e,g as _,y,q as x,o as w,B as $,v as Tm,L as jt}from"../../chunks/vendor-6b77c823.js";import{T as bn}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C as ye}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as de}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as zt}from"../../chunks/ExampleCodeBlock-5212b321.js";function Mm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianModel, MarianConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){h=o("p"),k=r("Examples:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Examples:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function bm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)  <span class="hljs-comment"># should work</span>`}}),{c(){h=o("p"),k=r("Examples:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Examples:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function ym(z){let h,k,g,u,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var j=a(g);u=i(j,"Module"),j.forEach(t),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,h,m),e(h,k),e(h,g),e(g,u),e(h,v)},d(l){l&&t(h)}}}function xm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),{c(){h=o("p"),k=r("Example:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Example:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function wm(z){let h,k,g,u,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var j=a(g);u=i(j,"Module"),j.forEach(t),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,h,m),e(h,k),e(h,g),e(g,u),e(h,v)},d(l){l&&t(h)}}}function $m(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianMTModel
...
<span class="hljs-string">&quot;Where&#x27;s the bus stop?&quot;</span>`}}),{c(){h=o("p"),k=r("Examples:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Examples:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function zm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){h=o("p"),k=r("Example:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Example:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function jm(z){let h,k,g,u,v,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,_e,te,ne,oe,Se,S,He,H,D;return{c(){h=o("p"),k=r("TF 2.0 models accepts two formats as inputs:"),g=d(),u=o("ul"),v=o("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),j=o("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),E=o("p"),ue=r("This second option is useful when using "),Y=o("code"),Le=r("tf.keras.Model.fit"),K=r(` method which currently requires having all the
...
`),H=o("code"),D=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=s(T,"P",{});var q=a(h);k=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(T),u=s(T,"UL",{});var ge=a(u);v=s(ge,"LI",{});var Ke=a(v);l=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),m=c(ge),j=s(ge,"LI",{});var ve=a(j);Ce=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),ge.forEach(t),ce=c(T),E=s(T,"P",{});var W=a(E);ue=i(W,"This second option is useful when using "),Y=s(W,"CODE",{});var Ze=a(Y);Le=i(Ze,"tf.keras.Model.fit"),Ze.forEach(t),K=i(W,` method which currently requires having all the
tensors in the first argument of the model call function: `),Z=s(W,"CODE",{});var Xe=a(Z);Ie=i(Xe,"model(inputs)"),Xe.forEach(t),xe=i(W,"."),W.forEach(t),G=c(T),O=s(T,"P",{});var De=a(O);we=i(De,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),De.forEach(t),L=c(T),F=s(T,"UL",{});var I=a(F);N=s(I,"LI",{});var se=a(N);X=i(se,"a single Tensor with "),Q=s(se,"CODE",{});var Qe=a(Q);me=i(Qe,"input_ids"),Qe.forEach(t),Ae=i(se," only and nothing else: "),J=s(se,"CODE",{});var We=a(J);P=i(We,"model(input_ids)"),We.forEach(t),se.forEach(t),fe=c(I),C=s(I,"LI",{});var U=a(C);Oe=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(U,"CODE",{});var et=a(ee);_e=i(et,"model([input_ids, attention_mask])"),et.forEach(t),te=i(U," or "),ne=s(U,"CODE",{});var tt=a(ne);oe=i(tt,"model([input_ids, attention_mask, token_type_ids])"),tt.forEach(t),U.forEach(t),Se=c(I),S=s(I,"LI",{});var ae=a(S);He=i(ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=s(ae,"CODE",{});var ke=a(H);D=i(ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ke.forEach(t),ae.forEach(t),I.forEach(t)},m(T,q){_(T,h,q),e(h,k),_(T,g,q),_(T,u,q),e(u,v),e(v,l),e(u,m),e(u,j),e(j,Ce),_(T,ce,q),_(T,E,q),e(E,ue),e(E,Y),e(Y,Le),e(E,K),e(E,Z),e(Z,Ie),e(E,xe),_(T,G,q),_(T,O,q),e(O,we),_(T,L,q),_(T,F,q),e(F,N),e(N,X),e(N,Q),e(Q,me),e(N,Ae),e(N,J),e(J,P),e(F,fe),e(F,C),e(C,Oe),e(C,ee),e(ee,_e),e(C,te),e(C,ne),e(ne,oe),e(F,Se),e(F,S),e(S,He),e(S,H),e(H,D)},d(T){T&&t(h),T&&t(g),T&&t(u),T&&t(ce),T&&t(E),T&&t(G),T&&t(O),T&&t(L),T&&t(F)}}}function qm(z){let h,k,g,u,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var j=a(g);u=i(j,"Module"),j.forEach(t),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,h,m),e(h,k),e(h,g),e(g,u),e(h,v)},d(l){l&&t(h)}}}function Em(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, TFMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),k=r("Example:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Example:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function Fm(z){let h,k,g,u,v,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,_e,te,ne,oe,Se,S,He,H,D;return{c(){h=o("p"),k=r("TF 2.0 models accepts two formats as inputs:"),g=d(),u=o("ul"),v=o("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),j=o("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),E=o("p"),ue=r("This second option is useful when using "),Y=o("code"),Le=r("tf.keras.Model.fit"),K=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),Z=o("code"),Ie=r("model(inputs)"),xe=r("."),G=d(),O=o("p"),we=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),L=d(),F=o("ul"),N=o("li"),X=r("a single Tensor with "),Q=o("code"),me=r("input_ids"),Ae=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),fe=d(),C=o("li"),Oe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=o("code"),_e=r("model([input_ids, attention_mask])"),te=r(" or "),ne=o("code"),oe=r("model([input_ids, attention_mask, token_type_ids])"),Se=d(),S=o("li"),He=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),D=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=s(T,"P",{});var q=a(h);k=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(T),u=s(T,"UL",{});var ge=a(u);v=s(ge,"LI",{});var Ke=a(v);l=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),m=c(ge),j=s(ge,"LI",{});var ve=a(j);Ce=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),ge.forEach(t),ce=c(T),E=s(T,"P",{});var W=a(E);ue=i(W,"This second option is useful when using "),Y=s(W,"CODE",{});var Ze=a(Y);Le=i(Ze,"tf.keras.Model.fit"),Ze.forEach(t),K=i(W,` method which currently requires having all the
...
first positional argument :`),De.forEach(t),L=c(T),F=s(T,"UL",{});var I=a(F);N=s(I,"LI",{});var se=a(N);X=i(se,"a single Tensor with "),Q=s(se,"CODE",{});var Qe=a(Q);me=i(Qe,"input_ids"),Qe.forEach(t),Ae=i(se," only and nothing else: "),J=s(se,"CODE",{});var We=a(J);P=i(We,"model(input_ids)"),We.forEach(t),se.forEach(t),fe=c(I),C=s(I,"LI",{});var U=a(C);Oe=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(U,"CODE",{});var et=a(ee);_e=i(et,"model([input_ids, attention_mask])"),et.forEach(t),te=i(U," or "),ne=s(U,"CODE",{});var tt=a(ne);oe=i(tt,"model([input_ids, attention_mask, token_type_ids])"),tt.forEach(t),U.forEach(t),Se=c(I),S=s(I,"LI",{});var ae=a(S);He=i(ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=s(ae,"CODE",{});var ke=a(H);D=i(ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ke.forEach(t),ae.forEach(t),I.forEach(t)},m(T,q){_(T,h,q),e(h,k),_(T,g,q),_(T,u,q),e(u,v),e(v,l),e(u,m),e(u,j),e(j,Ce),_(T,ce,q),_(T,E,q),e(E,ue),e(E,Y),e(Y,Le),e(E,K),e(E,Z),e(Z,Ie),e(E,xe),_(T,G,q),_(T,O,q),e(O,we),_(T,L,q),_(T,F,q),e(F,N),e(N,X),e(N,Q),e(Q,me),e(N,Ae),e(N,J),e(J,P),e(F,fe),e(F,C),e(C,Oe),e(C,ee),e(ee,_e),e(C,te),e(C,ne),e(ne,oe),e(F,Se),e(F,S),e(S,He),e(S,H),e(H,D)},d(T){T&&t(h),T&&t(g),T&&t(u),T&&t(ce),T&&t(E),T&&t(G),T&&t(O),T&&t(L),T&&t(F)}}}function Pm(z){let h,k,g,u,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var j=a(g);u=i(j,"Module"),j.forEach(t),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,h,m),e(h,k),e(h,g),e(g,u),e(h,v)},d(l){l&&t(h)}}}function Nm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, TFMarianMTModel
...
<span class="hljs-string">&quot;Where is the bus stop ?&quot;</span>`}}),{c(){h=o("p"),k=r("Examples:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Examples:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function Cm(z){let h,k,g,u,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var j=a(g);u=i(j,"Module"),j.forEach(t),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,h,m),e(h,k),e(h,g),e(g,u),e(h,v)},d(l){l&&t(h)}}}function Lm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),k=r("Example:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Example:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function Im(z){let h,k,g,u,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var j=a(g);u=i(j,"Module"),j.forEach(t),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,h,m),e(h,k),e(h,g),e(g,u),e(h,v)},d(l){l&&t(h)}}}function Am(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianTokenizer, FlaxMarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),k=r("Example:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Example:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function Om(z){let h,k,g,u,v,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,_e,te,ne,oe,Se,S,He,H,D,T,q,ge,Ke,ve,W,Ze,Xe,De,I,se,Qe,We,U,et,tt,ae,ke,bi,ts,yi,xi,wi,nt,yn,$i,Ps,zi,ji,qi,xn,Ei,Ns,Fi,Pi,Ni,ot,Ci,Cs,Li,Ii,Ls,Ai,Oi,Si,Is,wn,Hi,As,Di,Wi,Ui,Os,$n,Ri,zn,Vi,Bi,Za,st,qt,Ss,jn,Gi,Hs,Ji,Xa,$e,ns,Yi,Ds,Ki,Zi,qn,Xi,En,Qi,el,tl,at,nl,Ws,ol,sl,Us,al,rl,il,Rs,ll,Qa,rt,Et,Vs,Fn,dl,Bs,cl,er,Ft,Gs,pl,hl,Js,Pn,ul,tr,it,Pt,Ys,Nn,ml,Ks,fl,nr,ze,Cn,_l,Zs,gl,vl,kl,Ln,Tl,Xs,Ml,bl,yl,In,xl,An,wl,$l,zl,On,jl,Qs,ql,El,or,Nt,Fl,Sn,Pl,Nl,sr,Hn,ar,os,Cl,rr,Dn,ir,lt,Ct,ea,Wn,Ll,ta,Il,lr,ss,Al,dr,Un,cr,as,Ol,pr,Rn,hr,dt,Lt,na,Vn,Sl,oa,Hl,ur,Te,Bn,Dl,ct,Wl,rs,Ul,Rl,Gn,Vl,Bl,Gl,pt,Jl,is,Yl,Kl,ls,Zl,Xl,Ql,It,mr,ht,At,sa,Jn,ed,aa,td,fr,re,Yn,nd,Kn,od,Zn,sd,ad,rd,Xn,id,ds,ld,dd,cd,Ot,pd,St,Qn,hd,ra,ud,_r,ut,Ht,ia,eo,md,la,fd,gr,Me,to,_d,no,gd,cs,vd,kd,Td,oo,Md,so,bd,yd,xd,je,ao,wd,mt,$d,ps,zd,jd,da,qd,Ed,Fd,Dt,Pd,Wt,vr,ft,Ut,ca,ro,Nd,pa,Cd,kr,be,io,Ld,lo,Id,hs,Ad,Od,Sd,co,Hd,po,Dd,Wd,Ud,pe,ho,Rd,_t,Vd,us,Bd,Gd,ha,Jd,Yd,Kd,Rt,Zd,uo,Xd,mo,Qd,ec,tc,Vt,Tr,gt,Bt,ua,fo,nc,ma,oc,Mr,vt,_o,sc,Gt,go,ac,Jt,br,kt,Yt,fa,vo,rc,_a,ic,yr,ie,ko,lc,To,dc,ms,cc,pc,hc,Mo,uc,bo,mc,fc,_c,Kt,gc,qe,yo,vc,Tt,kc,fs,Tc,Mc,ga,bc,yc,xc,Zt,wc,Xt,xr,Mt,Qt,va,xo,$c,ka,zc,wr,le,wo,jc,$o,qc,_s,Ec,Fc,Pc,zo,Nc,jo,Cc,Lc,Ic,en,Ac,he,qo,Oc,bt,Sc,gs,Hc,Dc,Ta,Wc,Uc,Rc,tn,Vc,Eo,Bc,Fo,Gc,Jc,Yc,nn,$r,yt,on,Ma,Po,Kc,ba,Zc,zr,R,No,Xc,Co,Qc,vs,ep,tp,np,Lo,op,Io,sp,ap,rp,ya,ip,lp,Ue,xa,Ao,dp,cp,wa,Oo,pp,hp,$a,So,up,mp,za,Ho,fp,_p,Ee,Do,gp,xt,vp,ja,kp,Tp,qa,Mp,bp,yp,sn,xp,an,jr,wt,rn,Ea,Wo,wp,Fa,$p,qr,V,Uo,zp,Ro,jp,ks,qp,Ep,Fp,Vo,Pp,Bo,Np,Cp,Lp,Pa,Ip,Ap,Re,Na,Go,Op,Sp,Ca,Jo,Hp,Dp,La,Yo,Wp,Up,Ia,Ko,Rp,Vp,Fe,Zo,Bp,$t,Gp,Aa,Jp,Yp,Oa,Kp,Zp,Xp,ln,Qp,dn,Er;return l=new de({}),X=new de({}),jn=new de({}),Fn=new de({}),Nn=new de({}),Hn=new ye({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
old_style_multi_models = [<span class="hljs-string">f&quot;<span class="hljs-subst">{org}</span>/<span class="hljs-subst">{s}</span>&quot;</span> <span class="hljs-keyword">for</span> s <span class="hljs-keyword">in</span> suffix <span class="hljs-keyword">if</span> s != s.lower()]`}}),Wn=new de({}),Un=new ye({props:{code:`['Helsinki-NLP/opus-mt-NORTH_EU-NORTH_EU',
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/configuration_marian.py#L34"}}),It=new zt({props:{anchor:"transformers.MarianConfig.example",$$slots:{default:[Mm]},$$scope:{ctx:z}}}),Jn=new de({}),Yn=new B({props:{name:"class transformers.MarianTokenizer",anchor:"transformers.MarianTokenizer",parameters:[{name:"source_spm",val:""},{name:"target_spm",val:""},{name:"vocab",val:""},{name:"target_vocab_file",val:" = None"},{name:"source_lang",val:" = None"},{name:"target_lang",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"model_max_length",val:" = 512"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"separate_vocabs",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MarianTokenizer.source_spm",description:`<strong>source_spm</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16893/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_marian.py#L1165",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_marian.py#L1392",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16893/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_marian.py#L1567",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
configuration. Check out the <a href="/docs/transformers/pr_16893/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_tf_marian.py#L1155"}}),Kt=new bn({props:{$$slots:{default:[jm]},$$scope:{ctx:z}}}),yo=new B({props:{name:"call",anchor:"transformers.TFMarianModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_tf_marian.py#L1167",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16893/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_tf_marian.py#L1241"}}),en=new bn({props:{$$slots:{default:[Fm]},$$scope:{ctx:z}}}),qo=new B({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_16893/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16893/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_tf_marian.py#L1274",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),tn=new bn({props:{$$slots:{default:[Pm]},$$scope:{ctx:z}}}),nn=new zt({props:{anchor:"transformers.TFMarianMTModel.call.example",$$slots:{default:[Nm]},$$scope:{ctx:z}}}),Po=new de({}),No=new B({props:{name:"class transformers.FlaxMarianModel",anchor:"transformers.FlaxMarianModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16893/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxMarianModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16893/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_flax_marian.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
`}}),sn=new bn({props:{$$slots:{default:[Cm]},$$scope:{ctx:z}}}),an=new zt({props:{anchor:"transformers.FlaxMarianModel.__call__.example",$$slots:{default:[Lm]},$$scope:{ctx:z}}}),Wo=new de({}),Uo=new B({props:{name:"class transformers.FlaxMarianMTModel",anchor:"transformers.FlaxMarianMTModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_16893/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16893/src/transformers/models/marian/modeling_flax_marian.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16893/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),ln=new bn({props:{$$slots:{default:[Im]},$$scope:{ctx:z}}}),dn=new zt({props:{anchor:"transformers.FlaxMarianMTModel.__call__.example",$$slots:{default:[Am]},$$scope:{ctx:z}}}),{c(){h=o("meta"),k=d(),g=o("h1"),u=o("a"),v=o("span"),M(l.$$.fragment),m=d(),j=o("span"),Ce=r("MarianMT"),ce=d(),E=o("p"),ue=o("strong"),Y=r("Bugs:"),Le=r(" If you see something strange, file a "),K=o("a"),Z=r("Github Issue"),Ie=r(`
and assign @patrickvonplaten.`),xe=d(),G=o("p"),O=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),we=d(),L=o("h2"),F=o("a"),N=o("span"),M(X.$$.fragment),Q=d(),me=o("span"),Ae=r("Implementation Notes"),J=d(),P=o("ul"),fe=o("li"),C=o("p"),Oe=r("Each model is about 298 MB on disk, there are more than 1,000 models."),ee=d(),_e=o("li"),te=o("p"),ne=r("The list of supported language pairs can be found "),oe=o("a"),Se=r("here"),S=r("."),He=d(),H=o("li"),D=o("p"),T=r("Models were originally trained by "),q=o("a"),ge=r("J\xF6rg Tiedemann"),Ke=r(" using the "),ve=o("a"),W=r("Marian"),Ze=r(" C++ library, which supports fast training and translation."),Xe=d(),De=o("li"),I=o("p"),se=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),Qe=d(),We=o("li"),U=o("p"),et=r("The 80 opus models that require BPE preprocessing are not supported."),tt=d(),ae=o("li"),ke=o("p"),bi=r("The modeling code is the same as "),ts=o("a"),yi=r("BartForConditionalGeneration"),xi=r(" with a few minor modifications:"),wi=d(),nt=o("ul"),yn=o("li"),$i=r("static (sinusoid) positional embeddings ("),Ps=o("code"),zi=r("MarianConfig.static_position_embeddings=True"),ji=r(")"),qi=d(),xn=o("li"),Ei=r("no layernorm_embedding ("),Ns=o("code"),Fi=r("MarianConfig.normalize_embedding=False"),Pi=r(")"),Ni=d(),ot=o("li"),Ci=r("the model starts generating with "),Cs=o("code"),Li=r("pad_token_id"),Ii=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Ls=o("code"),Ai=r("<s/>"),Oi=r("),"),Si=d(),Is=o("li"),wn=o("p"),Hi=r("Code to bulk convert models can be found in "),As=o("code"),Di=r("convert_marian_to_pytorch.py"),Wi=r("."),Ui=d(),Os=o("li"),$n=o("p"),Ri=r("This model was contributed by "),zn=o("a"),Vi=r("sshleifer"),Bi=r("."),Za=d(),st=o("h2"),qt=o("a"),Ss=o("span"),M(jn.$$.fragment),Gi=d(),Hs=o("span"),Ji=r("Naming"),Xa=d(),$e=o("ul"),ns=o("li"),Yi=r("All model names use the following format: "),Ds=o("code"),Ki=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),Zi=d(),qn=o("li"),Xi=r("The language codes used to name models are inconsistent. Two digit codes can usually be found "),En=o("a"),Qi=r("here"),el=r(`, three digit codes require googling \u201Clanguage
code {code}\u201C.`),tl=d(),at=o("li"),nl=r("Codes formatted like "),Ws=o("code"),ol=r("es_AR"),sl=r(" are usually "),Us=o("code"),al=r("code_{region}"),rl=r(". That one is Spanish from Argentina."),il=d(),Rs=o("li"),ll=r(`The models were converted in two stages. The first 1000 models use ISO-639-2 codes to identify languages, the second
...
fine-tuning experiments and integration tests.`),hl=d(),Js=o("li"),Pn=o("a"),ul=r("Fine-tune on GPU"),tr=d(),it=o("h2"),Pt=o("a"),Ys=o("span"),M(Nn.$$.fragment),ml=d(),Ks=o("span"),fl=r("Multilingual Models"),nr=d(),ze=o("ul"),Cn=o("li"),_l=r("All model names use the following format: "),Zs=o("code"),gl=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),vl=r(":"),kl=d(),Ln=o("li"),Tl=r(`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
require 3 character language codes:`),sr=d(),M(Hn.$$.fragment),ar=d(),os=o("p"),Cl=r("Here is the code to see all available pretrained models on the hub:"),rr=d(),M(Dn.$$.fragment),ir=d(),lt=o("h2"),Ct=o("a"),ea=o("span"),M(Wn.$$.fragment),Ll=d(),ta=o("span"),Il=r("Old Style Multi-Lingual Models"),lr=d(),ss=o("p"),Al=r(`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),dr=d(),M(Un.$$.fragment),cr=d(),as=o("p"),Ol=r("Example of translating english to many romance languages, using old-style 2 character language codes"),pr=d(),M(Rn.$$.fragment),hr=d(),dt=o("h2"),Lt=o("a"),na=o("span"),M(Vn.$$.fragment),Sl=d(),oa=o("span"),Hl=r("MarianConfig"),ur=d(),Te=o("div"),M(Bn.$$.fragment),Dl=d(),ct=o("p"),Wl=r("This is the configuration class to store the configuration of a "),rs=o("a"),Ul=r("MarianModel"),Rl=r(`. It is used to instantiate an
...
sequence-to-sequence models that need a slightly different processing for the labels.`),_r=d(),ut=o("h2"),Ht=o("a"),ia=o("span"),M(eo.$$.fragment),md=d(),la=o("span"),fd=r("MarianModel"),gr=d(),Me=o("div"),M(to.$$.fragment),_d=d(),no=o("p"),gd=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),xd=d(),je=o("div"),M(ao.$$.fragment),wd=d(),mt=o("p"),$d=r("The "),ps=o("a"),zd=r("MarianModel"),jd=r(" forward method, overrides the "),da=o("code"),qd=r("__call__"),Ed=r(" special method."),Fd=d(),M(Dt.$$.fragment),Pd=d(),M(Wt.$$.fragment),vr=d(),ft=o("h2"),Ut=o("a"),ca=o("span"),M(ro.$$.fragment),Nd=d(),pa=o("span"),Cd=r("MarianMTModel"),kr=d(),be=o("div"),M(io.$$.fragment),Ld=d(),lo=o("p"),Id=r(`The Marian Model with a language modeling head. Can be used for summarization.
This model inherits from `),hs=o("a"),Ad=r("PreTrainedModel"),Od=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sd=d(),co=o("p"),Hd=r("This model is also a PyTorch "),po=o("a"),Dd=r("torch.nn.Module"),Wd=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ud=d(),pe=o("div"),M(ho.$$.fragment),Rd=d(),_t=o("p"),Vd=r("The "),us=o("a"),Bd=r("MarianMTModel"),Gd=r(" forward method, overrides the "),ha=o("code"),Jd=r("__call__"),Yd=r(" special method."),Kd=d(),M(Rt.$$.fragment),Zd=d(),uo=o("p"),Xd=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),mo=o("a"),Qd=r("here"),ec=r("."),tc=d(),M(Vt.$$.fragment),Tr=d(),gt=o("h2"),Bt=o("a"),ua=o("span"),M(fo.$$.fragment),nc=d(),ma=o("span"),oc=r("MarianForCausalLM"),Mr=d(),vt=o("div"),M(_o.$$.fragment),sc=d(),Gt=o("div"),M(go.$$.fragment),ac=d(),M(Jt.$$.fragment),br=d(),kt=o("h2"),Yt=o("a"),fa=o("span"),M(vo.$$.fragment),rc=d(),_a=o("span"),ic=r("TFMarianModel"),yr=d(),ie=o("div"),M(ko.$$.fragment),lc=d(),To=o("p"),dc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
behavior.`),_c=d(),M(Kt.$$.fragment),gc=d(),qe=o("div"),M(yo.$$.fragment),vc=d(),Tt=o("p"),kc=r("The "),fs=o("a"),Tc=r("TFMarianModel"),Mc=r(" forward method, overrides the "),ga=o("code"),bc=r("__call__"),yc=r(" special method."),xc=d(),M(Zt.$$.fragment),wc=d(),M(Xt.$$.fragment),xr=d(),Mt=o("h2"),Qt=o("a"),va=o("span"),M(xo.$$.fragment),$c=d(),ka=o("span"),zc=r("TFMarianMTModel"),wr=d(),le=o("div"),M(wo.$$.fragment),jc=d(),$o=o("p"),qc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
This model inherits from `),_s=o("a"),Ec=r("TFPreTrainedModel"),Fc=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc=d(),zo=o("p"),Nc=r("This model is also a "),jo=o("a"),Cc=r("tf.keras.Model"),Lc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic=d(),M(en.$$.fragment),Ac=d(),he=o("div"),M(qo.$$.fragment),Oc=d(),bt=o("p"),Sc=r("The "),gs=o("a"),Hc=r("TFMarianMTModel"),Dc=r(" forward method, overrides the "),Ta=o("code"),Wc=r("__call__"),Uc=r(" special method."),Rc=d(),M(tn.$$.fragment),Vc=d(),Eo=o("p"),Bc=r(`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rp=d(),ya=o("p"),ip=r("Finally, this model supports inherent JAX features such as:"),lp=d(),Ue=o("ul"),xa=o("li"),Ao=o("a"),dp=r("Just-In-Time (JIT) compilation"),cp=d(),wa=o("li"),Oo=o("a"),pp=r("Automatic Differentiation"),hp=d(),$a=o("li"),So=o("a"),up=r("Vectorization"),mp=d(),za=o("li"),Ho=o("a"),fp=r("Parallelization"),_p=d(),Ee=o("div"),M(Do.$$.fragment),gp=d(),xt=o("p"),vp=r("The "),ja=o("code"),kp=r("FlaxMarianPreTrainedModel"),Tp=r(" forward method, overrides the "),qa=o("code"),Mp=r("__call__"),bp=r(" special method."),yp=d(),M(sn.$$.fragment),xp=d(),M(an.$$.fragment),jr=d(),wt=o("h2"),rn=o("a"),Ea=o("span"),M(Wo.$$.fragment),wp=d(),Fa=o("span"),$p=r("FlaxMarianMTModel"),qr=d(),V=o("div"),M(Uo.$$.fragment),zp=d(),Ro=o("p"),jp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
require 3 character language codes:`),Br.forEach(t),sr=c(n),b(Hn.$$.fragment,n),ar=c(n),os=s(n,"P",{});var Hh=a(os);Cl=i(Hh,"Here is the code to see all available pretrained models on the hub:"),Hh.forEach(t),rr=c(n),b(Dn.$$.fragment,n),ir=c(n),lt=s(n,"H2",{class:!0});var Gr=a(lt);Ct=s(Gr,"A",{id:!0,class:!0,href:!0});var Dh=a(Ct);ea=s(Dh,"SPAN",{});var Wh=a(ea);b(Wn.$$.fragment,Wh),Wh.forEach(t),Dh.forEach(t),Ll=c(Gr),ta=s(Gr,"SPAN",{});var Uh=a(ta);Il=i(Uh,"Old Style Multi-Lingual Models"),Uh.forEach(t),Gr.forEach(t),lr=c(n),ss=s(n,"P",{});var Rh=a(ss);Al=i(Rh,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Rh.forEach(t),dr=c(n),b(Un.$$.fragment,n),cr=c(n),as=s(n,"P",{});var Vh=a(as);Ol=i(Vh,"Example of translating english to many romance languages, using old-style 2 character language codes"),Vh.forEach(t),pr=c(n),b(Rn.$$.fragment,n),hr=c(n),dt=s(n,"H2",{class:!0});var Jr=a(dt);Lt=s(Jr,"A",{id:!0,class:!0,href:!0});var Bh=a(Lt);na=s(Bh,"SPAN",{});var Gh=a(na);b(Vn.$$.fragment,Gh),Gh.forEach(t),Bh.forEach(t),Sl=c(Jr),oa=s(Jr,"SPAN",{});var Jh=a(oa);Hl=i(Jh,"MarianConfig"),Jh.forEach(t),Jr.forEach(t),ur=c(n),Te=s(n,"DIV",{class:!0});var un=a(Te);b(Bn.$$.fragment,un),Dl=c(un),ct=s(un,"P",{});var xs=a(ct);Wl=i(xs,"This is the configuration class to store the configuration of a "),rs=s(xs,"A",{href:!0});var Yh=a(rs);Ul=i(Yh,"MarianModel"),Yh.forEach(t),Rl=i(xs,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
...
sequence-to-sequence models that need a slightly different processing for the labels.`),su.forEach(t),Xr.forEach(t),Ve.forEach(t),_r=c(n),ut=s(n,"H2",{class:!0});var Qr=a(ut);Ht=s(Qr,"A",{id:!0,class:!0,href:!0});var au=a(Ht);ia=s(au,"SPAN",{});var ru=a(ia);b(eo.$$.fragment,ru),ru.forEach(t),au.forEach(t),md=c(Qr),la=s(Qr,"SPAN",{});var iu=a(la);fd=i(iu,"MarianModel"),iu.forEach(t),Qr.forEach(t),gr=c(n),Me=s(n,"DIV",{class:!0});var mn=a(Me);b(to.$$.fragment,mn),_d=c(mn),no=s(mn,"P",{});var ei=a(no);gd=i(ei,`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ti.forEach(t),xd=c(mn),je=s(mn,"DIV",{class:!0});var fn=a(je);b(ao.$$.fragment,fn),wd=c(fn),mt=s(fn,"P",{});var $s=a(mt);$d=i($s,"The "),ps=s($s,"A",{href:!0});var cu=a(ps);zd=i(cu,"MarianModel"),cu.forEach(t),jd=i($s," forward method, overrides the "),da=s($s,"CODE",{});var pu=a(da);qd=i(pu,"__call__"),pu.forEach(t),Ed=i($s," special method."),$s.forEach(t),Fd=c(fn),b(Dt.$$.fragment,fn),Pd=c(fn),b(Wt.$$.fragment,fn),fn.forEach(t),mn.forEach(t),vr=c(n),ft=s(n,"H2",{class:!0});var ni=a(ft);Ut=s(ni,"A",{id:!0,class:!0,href:!0});var hu=a(Ut);ca=s(hu,"SPAN",{});var uu=a(ca);b(ro.$$.fragment,uu),uu.forEach(t),hu.forEach(t),Nd=c(ni),pa=s(ni,"SPAN",{});var mu=a(pa);Cd=i(mu,"MarianMTModel"),mu.forEach(t),ni.forEach(t),kr=c(n),be=s(n,"DIV",{class:!0});var _n=a(be);b(io.$$.fragment,_n),Ld=c(_n),lo=s(_n,"P",{});var oi=a(lo);Id=i(oi,`The Marian Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oi.forEach(t),Sd=c(_n),co=s(_n,"P",{});var si=a(co);Hd=i(si,"This model is also a PyTorch "),po=s(si,"A",{href:!0,rel:!0});var _u=a(po);Dd=i(_u,"torch.nn.Module"),_u.forEach(t),Wd=i(si,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si.forEach(t),Ud=c(_n),pe=s(_n,"DIV",{class:!0});var Be=a(pe);b(ho.$$.fragment,Be),Rd=c(Be),_t=s(Be,"P",{});var zs=a(_t);Vd=i(zs,"The "),us=s(zs,"A",{href:!0});var gu=a(us);Bd=i(gu,"MarianMTModel"),gu.forEach(t),Gd=i(zs," forward method, overrides the "),ha=s(zs,"CODE",{});var vu=a(ha);Jd=i(vu,"__call__"),vu.forEach(t),Yd=i(zs," special method."),zs.forEach(t),Kd=c(Be),b(Rt.$$.fragment,Be),Zd=c(Be),uo=s(Be,"P",{});var ai=a(uo);Xd=i(ai,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),mo=s(ai,"A",{href:!0,rel:!0});var ku=a(mo);Qd=i(ku,"here"),ku.forEach(t),ec=i(ai,"."),ai.forEach(t),tc=c(Be),b(Vt.$$.fragment,Be),Be.forEach(t),_n.forEach(t),Tr=c(n),gt=s(n,"H2",{class:!0});var ri=a(gt);Bt=s(ri,"A",{id:!0,class:!0,href:!0});var Tu=a(Bt);ua=s(Tu,"SPAN",{});var Mu=a(ua);b(fo.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),nc=c(ri),ma=s(ri,"SPAN",{});var bu=a(ma);oc=i(bu,"MarianForCausalLM"),bu.forEach(t),ri.forEach(t),Mr=c(n),vt=s(n,"DIV",{class:!0});var ii=a(vt);b(_o.$$.fragment,ii),sc=c(ii),Gt=s(ii,"DIV",{class:!0});var li=a(Gt);b(go.$$.fragment,li),ac=c(li),b(Jt.$$.fragment,li),li.forEach(t),ii.forEach(t),br=c(n),kt=s(n,"H2",{class:!0});var di=a(kt);Yt=s(di,"A",{id:!0,class:!0,href:!0});var yu=a(Yt);fa=s(yu,"SPAN",{});var xu=a(fa);b(vo.$$.fragment,xu),xu.forEach(t),yu.forEach(t),rc=c(di),_a=s(di,"SPAN",{});var wu=a(_a);ic=i(wu,"TFMarianModel"),wu.forEach(t),di.forEach(t),yr=c(n),ie=s(n,"DIV",{class:!0});var Ge=a(ie);b(ko.$$.fragment,Ge),lc=c(Ge),To=s(Ge,"P",{});var ci=a(To);dc=i(ci,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pi.forEach(t),_c=c(Ge),b(Kt.$$.fragment,Ge),gc=c(Ge),qe=s(Ge,"DIV",{class:!0});var gn=a(qe);b(yo.$$.fragment,gn),vc=c(gn),Tt=s(gn,"P",{});var js=a(Tt);kc=i(js,"The "),fs=s(js,"A",{href:!0});var ju=a(fs);Tc=i(ju,"TFMarianModel"),ju.forEach(t),Mc=i(js," forward method, overrides the "),ga=s(js,"CODE",{});var qu=a(ga);bc=i(qu,"__call__"),qu.forEach(t),yc=i(js," special method."),js.forEach(t),xc=c(gn),b(Zt.$$.fragment,gn),wc=c(gn),b(Xt.$$.fragment,gn),gn.forEach(t),Ge.forEach(t),xr=c(n),Mt=s(n,"H2",{class:!0});var hi=a(Mt);Qt=s(hi,"A",{id:!0,class:!0,href:!0});var Eu=a(Qt);va=s(Eu,"SPAN",{});var Fu=a(va);b(xo.$$.fragment,Fu),Fu.forEach(t),Eu.forEach(t),$c=c(hi),ka=s(hi,"SPAN",{});var Pu=a(ka);zc=i(Pu,"TFMarianMTModel"),Pu.forEach(t),hi.forEach(t),wr=c(n),le=s(n,"DIV",{class:!0});var Je=a(le);b(wo.$$.fragment,Je),jc=c(Je),$o=s(Je,"P",{});var ui=a($o);qc=i(ui,`The MARIAN Model with a language modeling head. Can be used for summarization.
This model inherits from `),_s=s(ui,"A",{href:!0});var Nu=a(_s);Ec=i(Nu,"TFPreTrainedModel"),Nu.forEach(t),Fc=i(ui,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mi.forEach(t),Ic=c(Je),b(en.$$.fragment,Je),Ac=c(Je),he=s(Je,"DIV",{class:!0});var Ye=a(he);b(qo.$$.fragment,Ye),Oc=c(Ye),bt=s(Ye,"P",{});var qs=a(bt);Sc=i(qs,"The "),gs=s(qs,"A",{href:!0});var Lu=a(gs);Hc=i(Lu,"TFMarianMTModel"),Lu.forEach(t),Dc=i(qs," forward method, overrides the "),Ta=s(qs,"CODE",{});var Iu=a(Ta);Wc=i(Iu,"__call__"),Iu.forEach(t),Uc=i(qs," special method."),qs.forEach(t),Rc=c(Ye),b(tn.$$.fragment,Ye),Vc=c(Ye),Eo=s(Ye,"P",{});var fi=a(Eo);Bc=i(fi,`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),Fo=s(fi,"A",{href:!0,rel:!0});var Au=a(Fo);Gc=i(Au,"here"),Au.forEach(t),Jc=i(fi,"."),fi.forEach(t),Yc=c(Ye),b(nn.$$.fragment,Ye),Ye.forEach(t),Je.forEach(t),$r=c(n),yt=s(n,"H2",{class:!0});var _i=a(yt);on=s(_i,"A",{id:!0,class:!0,href:!0});var Ou=a(on);Ma=s(Ou,"SPAN",{});var Su=a(Ma);b(Po.$$.fragment,Su),Su.forEach(t),Ou.forEach(t),Kc=c(_i),ba=s(_i,"SPAN",{});var Hu=a(ba);Zc=i(Hu,"FlaxMarianModel"),Hu.forEach(t),_i.forEach(t),zr=c(n),R=s(n,"DIV",{class:!0});var Pe=a(R);b(No.$$.fragment,Pe),Xc=c(Pe),Co=s(Pe,"P",{});var gi=a(Co);Qc=i(gi,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),vs=s(gi,"A",{href:!0});var Du=a(vs);ep=i(Du,"FlaxPreTrainedModel"),Du.forEach(t),tp=i(gi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gi.forEach(t),np=c(Pe),Lo=s(Pe,"P",{});var vi=a(Lo);op=i(vi,`This model is also a Flax Linen
`),Io=s(vi,"A",{href:!0,rel:!0});var Wu=a(Io);sp=i(Wu,"flax.nn.Module"),Wu.forEach(t),ap=i(vi,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),vi.forEach(t),rp=c(Pe),ya=s(Pe,"P",{});var Uu=a(ya);ip=i(Uu,"Finally, this model supports inherent JAX features such as:"),Uu.forEach(t),lp=c(Pe),Ue=s(Pe,"UL",{});var vn=a(Ue);xa=s(vn,"LI",{});var Ru=a(xa);Ao=s(Ru,"A",{href:!0,rel:!0});var Vu=a(Ao);dp=i(Vu,"Just-In-Time (JIT) compilation"),Vu.forEach(t),Ru.forEach(t),cp=c(vn),wa=s(vn,"LI",{});var Bu=a(wa);Oo=s(Bu,"A",{href:!0,rel:!0});var Gu=a(Oo);pp=i(Gu,"Automatic Differentiation"),Gu.forEach(t),Bu.forEach(t),hp=c(vn),$a=s(vn,"LI",{});var Ju=a($a);So=s(Ju,"A",{href:!0,rel:!0});var Yu=a(So);up=i(Yu,"Vectorization"),Yu.forEach(t),Ju.forEach(t),mp=c(vn),za=s(vn,"LI",{});var Ku=a(za);Ho=s(Ku,"A",{href:!0,rel:!0});var Zu=a(Ho);fp=i(Zu,"Parallelization"),Zu.forEach(t),Ku.forEach(t),vn.forEach(t),_p=c(Pe),Ee=s(Pe,"DIV",{class:!0});var kn=a(Ee);b(Do.$$.fragment,kn),gp=c(kn),xt=s(kn,"P",{});var Es=a(xt);vp=i(Es,"The "),ja=s(Es,"CODE",{});var Xu=a(ja);kp=i(Xu,"FlaxMarianPreTrainedModel"),Xu.forEach(t),Tp=i(Es," forward method, overrides the "),qa=s(Es,"CODE",{});var Qu=a(qa);Mp=i(Qu,"__call__"),Qu.forEach(t),bp=i(Es," special method."),Es.forEach(t),yp=c(kn),b(sn.$$.fragment,kn),xp=c(kn),b(an.$$.fragment,kn),kn.forEach(t),Pe.forEach(t),jr=c(n),wt=s(n,"H2",{class:!0});var ki=a(wt);rn=s(ki,"A",{id:!0,class:!0,href:!0});var em=a(rn);Ea=s(em,"SPAN",{});var tm=a(Ea);b(Wo.$$.fragment,tm),tm.forEach(t),em.forEach(t),wp=c(ki),Fa=s(ki,"SPAN",{});var nm=a(Fa);$p=i(nm,"FlaxMarianMTModel"),nm.forEach(t),ki.forEach(t),qr=c(n),V=s(n,"DIV",{class:!0});var Ne=a(V);b(Uo.$$.fragment,Ne),zp=c(Ne),Ro=s(Ne,"P",{});var Ti=a(Ro);jp=i(Ti,`The MARIAN Model with a language modeling head. Can be used for translation.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mi.forEach(t),Lp=c(Ne),Pa=s(Ne,"P",{});var am=a(Pa);Ip=i(am,"Finally, this model supports inherent JAX features such as:"),am.forEach(t),Ap=c(Ne),Re=s(Ne,"UL",{});var Tn=a(Re);Na=s(Tn,"LI",{});var rm=a(Na);Go=s(rm,"A",{href:!0,rel:!0});var im=a(Go);Op=i(im,"Just-In-Time (JIT) compilation"),im.forEach(t),rm.forEach(t),Sp=c(Tn),Ca=s(Tn,"LI",{});var lm=a(Ca);Jo=s(lm,"A",{href:!0,rel:!0});var dm=a(Jo);Hp=i(dm,"Automatic Differentiation"),dm.forEach(t),lm.forEach(t),Dp=c(Tn),La=s(Tn,"LI",{});var cm=a(La);Yo=s(cm,"A",{href:!0,rel:!0});var pm=a(Yo);Wp=i(pm,"Vectorization"),pm.forEach(t),cm.forEach(t),Up=c(Tn),Ia=s(Tn,"LI",{});var hm=a(Ia);Ko=s(hm,"A",{href:!0,rel:!0});var um=a(Ko);Rp=i(um,"Parallelization"),um.forEach(t),hm.forEach(t),Tn.forEach(t),Vp=c(Ne),Fe=s(Ne,"DIV",{class:!0});var Mn=a(Fe);b(Zo.$$.fragment,Mn),Bp=c(Mn),$t=s(Mn,"P",{});var Fs=a($t);Gp=i(Fs,"The "),Aa=s(Fs,"CODE",{});var mm=a(Aa);Jp=i(mm,"FlaxMarianPreTrainedModel"),mm.forEach(t),Yp=i(Fs," forward method, overrides the "),Oa=s(Fs,"CODE",{});var fm=a(Oa);Kp=i(fm,"__call__"),fm.forEach(t),Zp=i(Fs," special method."),Fs.forEach(t),Xp=c(Mn),b(ln.$$.fragment,Mn),Qp=c(Mn),b(dn.$$.fragment,Mn),Mn.forEach(t),Ne.forEach(t),this.h()},h(){p(h,"name","hf:doc:metadata"),p(h,"content",JSON.stringify(Sm)),p(u,"id","marianmt"),p(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(u,"href","#marianmt"),p(g,"class","relative group"),p(K,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),p(K,"rel","nofollow"),p(F,"id","implementation-notes"),p(F,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(F,"href","#implementation-notes"),p(L,"class","relative group"),p(oe,"href","https://huggingface.co/Helsinki-NLP"),p(oe,"rel","nofollow"),p(q,"href","https://researchportal.helsinki.fi/en/persons/j%C3%B6rg-tiedemann"),p(q,"rel","nofollow"),p(ve,"href","https://marian-nmt.github.io/"),p(ve,"rel","nofollow"),p(ts,"href","/docs/transformers/pr_16893/en/model_doc/bart#transformers.BartForConditionalGeneration"),p(zn,"href","https://huggingface.co/sshleifer"),p(zn,"rel","nofollow"),p(qt,"id","naming"),p(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(qt,"href","#naming"),p(st,"class","relative group"),p(En,"href","https://developers.google.com/admin-sdk/directory/v1/languages"),p(En,"rel","nofollow"),p(Et,"id","examples"),p(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Et,"href","#examples"),p(rt,"class","relative group"),p(Pn,"href","https://github.com/huggingface/transformers/blob/master/examples/legacy/seq2seq/train_distil_marian_enro.sh"),p(Pn,"rel","nofollow"),p(Pt,"id","multilingual-models"),p(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Pt,"href","#multilingual-models"),p(it,"class","relative group"),p(An,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-roa"),p(An,"rel","nofollow"),p(Sn,"href","https://github.com/Helsinki-NLP/Tatoeba-Challenge"),p(Sn,"rel","nofollow"),p(Ct,"id","old-style-multilingual-models"),p(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ct,"href","#old-style-multilingual-models"),p(lt,"class","relative group"),p(Lt,"id","transformers.MarianConfig"),p(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Lt,"href","#transformers.MarianConfig"),p(dt,"class","relative group"),p(rs,"href","/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianModel"),p(Gn,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-de"),p(Gn,"rel","nofollow"),p(is,"href","/docs/transformers/pr_16893/en/main_classes/configuration#transformers.PretrainedConfig"),p(ls,"href","/docs/transformers/pr_16893/en/main_classes/configuration#transformers.PretrainedConfig"),p(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(At,"id","transformers.MarianTokenizer"),p(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(At,"href","#transformers.MarianTokenizer"),p(ht,"class","relative group"),p(Zn,"href","https://github.com/google/sentencepiece"),p(Zn,"rel","nofollow"),p(ds,"href","/docs/transformers/pr_16893/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(St,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ht,"id","transformers.MarianModel"),p(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ht,"href","#transformers.MarianModel"),p(ut,"class","relative group"),p(cs,"href","/docs/transformers/pr_16893/en/main_classes/model#transformers.PreTrainedModel"),p(so,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(so,"rel","nofollow"),p(ps,"href","/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianModel"),p(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ut,"id","transformers.MarianMTModel"),p(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ut,"href","#transformers.MarianMTModel"),p(ft,"class","relative group"),p(hs,"href","/docs/transformers/pr_16893/en/main_classes/model#transformers.PreTrainedModel"),p(po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(po,"rel","nofollow"),p(us,"href","/docs/transformers/pr_16893/en/model_doc/marian#transformers.MarianMTModel"),p(mo,"href","https://huggingface.co/models?search=Helsinki-NLP"),p(mo,"rel","nofollow"),p(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Bt,"id","transformers.MarianForCausalLM"),p(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Bt,"href","#transformers.MarianForCausalLM"),p(gt,"class","relative group"),p(Gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Yt,"id","transformers.TFMarianModel"),p(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Yt,"href","#transformers.TFMarianModel"),p(kt,"class","relative group"),p(ms,"href","/docs/transformers/pr_16893/en/main_classes/model#transformers.TFPreTrainedModel"),p(bo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(bo,"rel","nofollow"),p(fs,"href","/docs/transformers/pr_16893/en/model_doc/marian#transformers.TFMarianModel"),p(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Qt,"id","transformers.TFMarianMTModel"),p(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Qt,"href","#transformers.TFMarianMTModel"),p(Mt,"class","relative group"),p(_s,"href","/docs/transformers/pr_16893/en/main_classes/model#transformers.TFPreTrainedModel"),p(jo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(jo,"rel","nofollow"),p(gs,"href","/docs/transformers/pr_16893/en/model_doc/marian#transformers.TFMarianMTModel"),p(Fo,"href","https://huggingface.co/models?search=Helsinki-NLP"),p(Fo,"rel","nofollow"),p(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(on,"id","transformers.FlaxMarianModel"),p(on,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(on,"href","#transformers.FlaxMarianModel"),p(yt,"class","relative group"),p(vs,"href","/docs/transformers/pr_16893/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Io,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(Io,"rel","nofollow"),p(Ao,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(Ao,"rel","nofollow"),p(Oo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(Oo,"rel","nofollow"),p(So,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(So,"rel","nofollow"),p(Ho,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(Ho,"rel","nofollow"),p(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(rn,"id","transformers.FlaxMarianMTModel"),p(rn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(rn,"href","#transformers.FlaxMarianMTModel"),p(wt,"class","relative group"),p(ks,"href","/docs/transformers/pr_16893/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Bo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(Bo,"rel","nofollow"),p(Go,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(Go,"rel","nofollow"),p(Jo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(Jo,"rel","nofollow"),p(Yo,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(Yo,"rel","nofollow"),p(Ko,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(Ko,"rel","nofollow"),p(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,f){e(document.head,h),_(n,k,f),_(n,g,f),e(g,u),e(u,v),y(l,v,null),e(g,m),e(g,j),e(j,Ce),_(n,ce,f),_(n,E,f),e(E,ue),e(ue,Y),e(E,Le),e(E,K),e(K,Z),e(E,Ie),_(n,xe,f),_(n,G,f),e(G,O),_(n,we,f),_(n,L,f),e(L,F),e(F,N),y(X,N,null),e(L,Q),e(L,me),e(me,Ae),_(n,J,f),_(n,P,f),e(P,fe),e(fe,C),e(C,Oe),e(P,ee),e(P,_e),e(_e,te),e(te,ne),e(te,oe),e(oe,Se),e(te,S),e(P,He),e(P,H),e(H,D),e(D,T),e(D,q),e(q,ge),e(D,Ke),e(D,ve),e(ve,W),e(D,Ze),e(P,Xe),e(P,De),e(De,I),e(I,se),e(P,Qe),e(P,We),e(We,U),e(U,et),e(P,tt),e(P,ae),e(ae,ke),e(ke,bi),e(ke,ts),e(ts,yi),e(ke,xi),e(ae,wi),e(ae,nt),e(nt,yn),e(yn,$i),e(yn,Ps),e(Ps,zi),e(yn,ji),e(nt,qi),e(nt,xn),e(xn,Ei),e(xn,Ns),e(Ns,Fi),e(xn,Pi),e(nt,Ni),e(nt,ot),e(ot,Ci),e(ot,Cs),e(Cs,Li),e(ot,Ii),e(ot,Ls),e(Ls,Ai),e(ot,Oi),e(P,Si),e(P,Is),e(Is,wn),e(wn,Hi),e(wn,As),e(As,Di),e(wn,Wi),e(P,Ui),e(P,Os),e(Os,$n),e($n,Ri),e($n,zn),e(zn,Vi),e($n,Bi),_(n,Za,f),_(n,st,f),e(st,qt),e(qt,Ss),y(jn,Ss,null),e(st,Gi),e(st,Hs),e(Hs,Ji),_(n,Xa,f),_(n,$e,f),e($e,ns),e(ns,Yi),e(ns,Ds),e(Ds,Ki),e($e,Zi),e($e,qn),e(qn,Xi),e(qn,En),e(En,Qi),e(qn,el),e($e,tl),e($e,at),e(at,nl),e(at,Ws),e(Ws,ol),e(at,sl),e(at,Us),e(Us,al),e(at,rl),e($e,il),e($e,Rs),e(Rs,ll),_(n,Qa,f),_(n,rt,f),e(rt,Et),e(Et,Vs),y(Fn,Vs,null),e(rt,dl),e(rt,Bs),e(Bs,cl),_(n,er,f),_(n,Ft,f),e(Ft,Gs),e(Gs,pl),e(Ft,hl),e(Ft,Js),e(Js,Pn),e(Pn,ul),_(n,tr,f),_(n,it,f),e(it,Pt),e(Pt,Ys),y(Nn,Ys,null),e(it,ml),e(it,Ks),e(Ks,fl),_(n,nr,f),_(n,ze,f),e(ze,Cn),e(Cn,_l),e(Cn,Zs),e(Zs,gl),e(Cn,vl),e(ze,kl),e(ze,Ln),e(Ln,Tl),e(Ln,Xs),e(Xs,Ml),e(Ln,bl),e(ze,yl),e(ze,In),e(In,xl),e(In,An),e(An,wl),e(In,$l),e(ze,zl),e(ze,On),e(On,jl),e(On,Qs),e(Qs,ql),e(On,El),_(n,or,f),_(n,Nt,f),e(Nt,Fl),e(Nt,Sn),e(Sn,Pl),e(Nt,Nl),_(n,sr,f),y(Hn,n,f),_(n,ar,f),_(n,os,f),e(os,Cl),_(n,rr,f),y(Dn,n,f),_(n,ir,f),_(n,lt,f),e(lt,Ct),e(Ct,ea),y(Wn,ea,null),e(lt,Ll),e(lt,ta),e(ta,Il),_(n,lr,f),_(n,ss,f),e(ss,Al),_(n,dr,f),y(Un,n,f),_(n,cr,f),_(n,as,f),e(as,Ol),_(n,pr,f),y(Rn,n,f),_(n,hr,f),_(n,dt,f),e(dt,Lt),e(Lt,na),y(Vn,na,null),e(dt,Sl),e(dt,oa),e(oa,Hl),_(n,ur,f),_(n,Te,f),y(Bn,Te,null),e(Te,Dl),e(Te,ct),e(ct,Wl),e(ct,rs),e(rs,Ul),e(ct,Rl),e(ct,Gn),e(Gn,Vl),e(ct,Bl),e(Te,Gl),e(Te,pt),e(pt,Jl),e(pt,is),e(is,Yl),e(pt,Kl),e(pt,ls),e(ls,Zl),e(pt,Xl),e(Te,Ql),y(It,Te,null),_(n,mr,f),_(n,ht,f),e(ht,At),e(At,sa),y(Jn,sa,null),e(ht,ed),e(ht,aa),e(aa,td),_(n,fr,f),_(n,re,f),y(Yn,re,null),e(re,nd),e(re,Kn),e(Kn,od),e(Kn,Zn),e(Zn,sd),e(Kn,ad),e(re,rd),e(re,Xn),e(Xn,id),e(Xn,ds),e(ds,ld),e(Xn,dd),e(re,cd),y(Ot,re,null),e(re,pd),e(re,St),y(Qn,St,null),e(St,hd),e(St,ra),e(ra,ud),_(n,_r,f),_(n,ut,f),e(ut,Ht),e(Ht,ia),y(eo,ia,null),e(ut,md),e(ut,la),e(la,fd),_(n,gr,f),_(n,Me,f),y(to,Me,null),e(Me,_d),e(Me,no),e(no,gd),e(no,cs),e(cs,vd),e(no,kd),e(Me,Td),e(Me,oo),e(oo,Md),e(oo,so),e(so,bd),e(oo,yd),e(Me,xd),e(Me,je),y(ao,je,null),e(je,wd),e(je,mt),e(mt,$d),e(mt,ps),e(ps,zd),e(mt,jd),e(mt,da),e(da,qd),e(mt,Ed),e(je,Fd),y(Dt,je,null),e(je,Pd),y(Wt,je,null),_(n,vr,f),_(n,ft,f),e(ft,Ut),e(Ut,ca),y(ro,ca,null),e(ft,Nd),e(ft,pa),e(pa,Cd),_(n,kr,f),_(n,be,f),y(io,be,null),e(be,Ld),e(be,lo),e(lo,Id),e(lo,hs),e(hs,Ad),e(lo,Od),e(be,Sd),e(be,co),e(co,Hd),e(co,po),e(po,Dd),e(co,Wd),e(be,Ud),e(be,pe),y(ho,pe,null),e(pe,Rd),e(pe,_t),e(_t,Vd),e(_t,us),e(us,Bd),e(_t,Gd),e(_t,ha),e(ha,Jd),e(_t,Yd),e(pe,Kd),y(Rt,pe,null),e(pe,Zd),e(pe,uo),e(uo,Xd),e(uo,mo),e(mo,Qd),e(uo,ec),e(pe,tc),y(Vt,pe,null),_(n,Tr,f),_(n,gt,f),e(gt,Bt),e(Bt,ua),y(fo,ua,null),e(gt,nc),e(gt,ma),e(ma,oc),_(n,Mr,f),_(n,vt,f),y(_o,vt,null),e(vt,sc),e(vt,Gt),y(go,Gt,null),e(Gt,ac),y(Jt,Gt,null),_(n,br,f),_(n,kt,f),e(kt,Yt),e(Yt,fa),y(vo,fa,null),e(kt,rc),e(kt,_a),e(_a,ic),_(n,yr,f),_(n,ie,f),y(ko,ie,null),e(ie,lc),e(ie,To),e(To,dc),e(To,ms),e(ms,cc),e(To,pc),e(ie,hc),e(ie,Mo),e(Mo,uc),e(Mo,bo),e(bo,mc),e(Mo,fc),e(ie,_c),y(Kt,ie,null),e(ie,gc),e(ie,qe),y(yo,qe,null),e(qe,vc),e(qe,Tt),e(Tt,kc),e(Tt,fs),e(fs,Tc),e(Tt,Mc),e(Tt,ga),e(ga,bc),e(Tt,yc),e(qe,xc),y(Zt,qe,null),e(qe,wc),y(Xt,qe,null),_(n,xr,f),_(n,Mt,f),e(Mt,Qt),e(Qt,va),y(xo,va,null),e(Mt,$c),e(Mt,ka),e(ka,zc),_(n,wr,f),_(n,le,f),y(wo,le,null),e(le,jc),e(le,$o),e($o,qc),e($o,_s),e(_s,Ec),e($o,Fc),e(le,Pc),e(le,zo),e(zo,Nc),e(zo,jo),e(jo,Cc),e(zo,Lc),e(le,Ic),y(en,le,null),e(le,Ac),e(le,he),y(qo,he,null),e(he,Oc),e(he,bt),e(bt,Sc),e(bt,gs),e(gs,Hc),e(bt,Dc),e(bt,Ta),e(Ta,Wc),e(bt,Uc),e(he,Rc),y(tn,he,null),e(he,Vc),e(he,Eo),e(Eo,Bc),e(Eo,Fo),e(Fo,Gc),e(Eo,Jc),e(he,Yc),y(nn,he,null),_(n,$r,f),_(n,yt,f),e(yt,on),e(on,Ma),y(Po,Ma,null),e(yt,Kc),e(yt,ba),e(ba,Zc),_(n,zr,f),_(n,R,f),y(No,R,null),e(R,Xc),e(R,Co),e(Co,Qc),e(Co,vs),e(vs,ep),e(Co,tp),e(R,np),e(R,Lo),e(Lo,op),e(Lo,Io),e(Io,sp),e(Lo,ap),e(R,rp),e(R,ya),e(ya,ip),e(R,lp),e(R,Ue),e(Ue,xa),e(xa,Ao),e(Ao,dp),e(Ue,cp),e(Ue,wa),e(wa,Oo),e(Oo,pp),e(Ue,hp),e(Ue,$a),e($a,So),e(So,up),e(Ue,mp),e(Ue,za),e(za,Ho),e(Ho,fp),e(R,_p),e(R,Ee),y(Do,Ee,null),e(Ee,gp),e(Ee,xt),e(xt,vp),e(xt,ja),e(ja,kp),e(xt,Tp),e(xt,qa),e(qa,Mp),e(xt,bp),e(Ee,yp),y(sn,Ee,null),e(Ee,xp),y(an,Ee,null),_(n,jr,f),_(n,wt,f),e(wt,rn),e(rn,Ea),y(Wo,Ea,null),e(wt,wp),e(wt,Fa),e(Fa,$p),_(n,qr,f),_(n,V,f),y(Uo,V,null),e(V,zp),e(V,Ro),e(Ro,jp),e(Ro,ks),e(ks,qp),e(Ro,Ep),e(V,Fp),e(V,Vo),e(Vo,Pp),e(Vo,Bo),e(Bo,Np),e(Vo,Cp),e(V,Lp),e(V,Pa),e(Pa,Ip),e(V,Ap),e(V,Re),e(Re,Na),e(Na,Go),e(Go,Op),e(Re,Sp),e(Re,Ca),e(Ca,Jo),e(Jo,Hp),e(Re,Dp),e(Re,La),e(La,Yo),e(Yo,Wp),e(Re,Up),e(Re,Ia),e(Ia,Ko),e(Ko,Rp),e(V,Vp),e(V,Fe),y(Zo,Fe,null),e(Fe,Bp),e(Fe,$t),e($t,Gp),e($t,Aa),e(Aa,Jp),e($t,Yp),e($t,Oa),e(Oa,Kp),e($t,Zp),e(Fe,Xp),y(ln,Fe,null),e(Fe,Qp),y(dn,Fe,null),Er=!0},p(n,[f]){const Xo={};f&2&&(Xo.$$scope={dirty:f,ctx:n}),It.$set(Xo);const Sa={};f&2&&(Sa.$$scope={dirty:f,ctx:n}),Ot.$set(Sa);const Ha={};f&2&&(Ha.$$scope={dirty:f,ctx:n}),Dt.$set(Ha);const Da={};f&2&&(Da.$$scope={dirty:f,ctx:n}),Wt.$set(Da);const cn={};f&2&&(cn.$$scope={dirty:f,ctx:n}),Rt.$set(cn);const Wa={};f&2&&(Wa.$$scope={dirty:f,ctx:n}),Vt.$set(Wa);const Ua={};f&2&&(Ua.$$scope={dirty:f,ctx:n}),Jt.$set(Ua);const Ra={};f&2&&(Ra.$$scope={dirty:f,ctx:n}),Kt.$set(Ra);const Qo={};f&2&&(Qo.$$scope={dirty:f,ctx:n}),Zt.$set(Qo);const Va={};f&2&&(Va.$$scope={dirty:f,ctx:n}),Xt.$set(Va);const Ba={};f&2&&(Ba.$$scope={dirty:f,ctx:n}),en.$set(Ba);const Ga={};f&2&&(Ga.$$scope={dirty:f,ctx:n}),tn.$set(Ga);const A={};f&2&&(A.$$scope={dirty:f,ctx:n}),nn.$set(A);const Ja={};f&2&&(Ja.$$scope={dirty:f,ctx:n}),sn.$set(Ja);const Ya={};f&2&&(Ya.$$scope={dirty:f,ctx:n}),an.$set(Ya);const Ka={};f&2&&(Ka.$$scope={dirty:f,ctx:n}),ln.$set(Ka);const es={};f&2&&(es.$$scope={dirty:f,ctx:n}),dn.$set(es)},i(n){Er||(x(l.$$.fragment,n),x(X.$$.fragment,n),x(jn.$$.fragment,n),x(Fn.$$.fragment,n),x(Nn.$$.fragment,n),x(Hn.$$.fragment,n),x(Dn.$$.fragment,n),x(Wn.$$.fragment,n),x(Un.$$.fragment,n),x(Rn.$$.fragment,n),x(Vn.$$.fragment,n),x(Bn.$$.fragment,n),x(It.$$.fragment,n),x(Jn.$$.fragment,n),x(Yn.$$.fragment,n),x(Ot.$$.fragment,n),x(Qn.$$.fragment,n),x(eo.$$.fragment,n),x(to.$$.fragment,n),x(ao.$$.fragment,n),x(Dt.$$.fragment,n),x(Wt.$$.fragment,n),x(ro.$$.fragment,n),x(io.$$.fragment,n),x(ho.$$.fragment,n),x(Rt.$$.fragment,n),x(Vt.$$.fragment,n),x(fo.$$.fragment,n),x(_o.$$.fragment,n),x(go.$$.fragment,n),x(Jt.$$.fragment,n),x(vo.$$.fragment,n),x(ko.$$.fragment,n),x(Kt.$$.fragment,n),x(yo.$$.fragment,n),x(Zt.$$.fragment,n),x(Xt.$$.fragment,n),x(xo.$$.fragment,n),x(wo.$$.fragment,n),x(en.$$.fragment,n),x(qo.$$.fragment,n),x(tn.$$.fragment,n),x(nn.$$.fragment,n),x(Po.$$.fragment,n),x(No.$$.fragment,n),x(Do.$$.fragment,n),x(sn.$$.fragment,n),x(an.$$.fragment,n),x(Wo.$$.fragment,n),x(Uo.$$.fragment,n),x(Zo.$$.fragment,n),x(ln.$$.fragment,n),x(dn.$$.fragment,n),Er=!0)},o(n){w(l.$$.fragment,n),w(X.$$.fragment,n),w(jn.$$.fragment,n),w(Fn.$$.fragment,n),w(Nn.$$.fragment,n),w(Hn.$$.fragment,n),w(Dn.$$.fragment,n),w(Wn.$$.fragment,n),w(Un.$$.fragment,n),w(Rn.$$.fragment,n),w(Vn.$$.fragment,n),w(Bn.$$.fragment,n),w(It.$$.fragment,n),w(Jn.$$.fragment,n),w(Yn.$$.fragment,n),w(Ot.$$.fragment,n),w(Qn.$$.fragment,n),w(eo.$$.fragment,n),w(to.$$.fragment,n),w(ao.$$.fragment,n),w(Dt.$$.fragment,n),w(Wt.$$.fragment,n),w(ro.$$.fragment,n),w(io.$$.fragment,n),w(ho.$$.fragment,n),w(Rt.$$.fragment,n),w(Vt.$$.fragment,n),w(fo.$$.fragment,n),w(_o.$$.fragment,n),w(go.$$.fragment,n),w(Jt.$$.fragment,n),w(vo.$$.fragment,n),w(ko.$$.fragment,n),w(Kt.$$.fragment,n),w(yo.$$.fragment,n),w(Zt.$$.fragment,n),w(Xt.$$.fragment,n),w(xo.$$.fragment,n),w(wo.$$.fragment,n),w(en.$$.fragment,n),w(qo.$$.fragment,n),w(tn.$$.fragment,n),w(nn.$$.fragment,n),w(Po.$$.fragment,n),w(No.$$.fragment,n),w(Do.$$.fragment,n),w(sn.$$.fragment,n),w(an.$$.fragment,n),w(Wo.$$.fragment,n),w(Uo.$$.fragment,n),w(Zo.$$.fragment,n),w(ln.$$.fragment,n),w(dn.$$.fragment,n),Er=!1},d(n){t(h),n&&t(k),n&&t(g),$(l),n&&t(ce),n&&t(E),n&&t(xe),n&&t(G),n&&t(we),n&&t(L),$(X),n&&t(J),n&&t(P),n&&t(Za),n&&t(st),$(jn),n&&t(Xa),n&&t($e),n&&t(Qa),n&&t(rt),$(Fn),n&&t(er),n&&t(Ft),n&&t(tr),n&&t(it),$(Nn),n&&t(nr),n&&t(ze),n&&t(or),n&&t(Nt),n&&t(sr),$(Hn,n),n&&t(ar),n&&t(os),n&&t(rr),$(Dn,n),n&&t(ir),n&&t(lt),$(Wn),n&&t(lr),n&&t(ss),n&&t(dr),$(Un,n),n&&t(cr),n&&t(as),n&&t(pr),$(Rn,n),n&&t(hr),n&&t(dt),$(Vn),n&&t(ur),n&&t(Te),$(Bn),$(It),n&&t(mr),n&&t(ht),$(Jn),n&&t(fr),n&&t(re),$(Yn),$(Ot),$(Qn),n&&t(_r),n&&t(ut),$(eo),n&&t(gr),n&&t(Me),$(to),$(ao),$(Dt),$(Wt),n&&t(vr),n&&t(ft),$(ro),n&&t(kr),n&&t(be),$(io),$(ho),$(Rt),$(Vt),n&&t(Tr),n&&t(gt),$(fo),n&&t(Mr),n&&t(vt),$(_o),$(go),$(Jt),n&&t(br),n&&t(kt),$(vo),n&&t(yr),n&&t(ie),$(ko),$(Kt),$(yo),$(Zt),$(Xt),n&&t(xr),n&&t(Mt),$(xo),n&&t(wr),n&&t(le),$(wo),$(en),$(qo),$(tn),$(nn),n&&t($r),n&&t(yt),$(Po),n&&t(zr),n&&t(R),$(No),$(Do),$(sn),$(an),n&&t(jr),n&&t(wt),$(Wo),n&&t(qr),n&&t(V),$(Uo),$(Zo),$(ln),$(dn)}}}const Sm={local:"marianmt",sections:[{local:"implementation-notes",title:"Implementation Notes"},{local:"naming",title:"Naming"},{local:"examples",title:"Examples"},{local:"multilingual-models",title:"Multilingual Models"},{local:"old-style-multilingual-models",title:"Old Style Multi-Lingual Models"},{local:"transformers.MarianConfig",title:"MarianConfig"},{local:"transformers.MarianTokenizer",title:"MarianTokenizer"},{local:"transformers.MarianModel",title:"MarianModel"},{local:"transformers.MarianMTModel",title:"MarianMTModel"},{local:"transformers.MarianForCausalLM",title:"MarianForCausalLM"},{local:"transformers.TFMarianModel",title:"TFMarianModel"},{local:"transformers.TFMarianMTModel",title:"TFMarianMTModel"},{local:"transformers.FlaxMarianModel",title:"FlaxMarianModel"},{local:"transformers.FlaxMarianMTModel",title:"FlaxMarianMTModel"}],title:"MarianMT"};function Hm(z){return Tm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gm extends _m{constructor(h){super();gm(this,h,Hm,Om,vm,{})}}export{Gm as default,Sm as metadata};
