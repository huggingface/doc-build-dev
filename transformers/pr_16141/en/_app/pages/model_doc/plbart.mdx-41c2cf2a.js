...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);L=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var C=a(v);w=i(C,"Module"),C.forEach(o),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,L),e(u,v),e(v,w),e(u,q)},d(T){T&&o(u)}}}function Zd(Q){let u,L,v,w,q,T,y,C,Zn,on,D,ao,es,ts,je,os,ns,Ee,ss,as,nn,Y,fe,ro,Fe,rs,io,is,sn,O,ds,Me,ls,cs,lo,ps,hs,an,Et,us,rn,Ft,co,ms,dn,G,fs,Se,gs,_s,Ae,bs,ks,ln,Z,ge,po,Ne,vs,ho,Ts,cn,j,ys,uo,ws,Ps,mo,Ls,zs,fo,qs,Bs,go,$s,xs,pn,_e,Cs,Ie,js,Es,hn,R,Fs,De,_o,Ms,Ss,As,Mt,Ns,Is,un,St,bo,Ds,mn,Xe,fn,At,Oe,ko,Xs,Os,ee,Gs,vo,Rs,Ws,To,Hs,Us,gn,Ge,_n,te,be,yo,Re,Vs,wo,Js,bn,$,We,Ks,oe,Qs,Nt,Ys,Zs,He,ea,ta,oa,ne,na,It,sa,aa,Dt,ra,ia,da,Po,la,ca,Ue,kn,se,ke,Lo,Ve,pa,zo,ha,vn,P,Je,ua,qo,ma,fa,X,ga,Xt,_a,ba,Ot,ka,va,Ke,Ta,ya,wa,Qe,Pa,Bo,La,za,qa,$o,Ba,$a,Ye,xa,ve,Ze,Ca,xo,ja,Ea,N,et,Fa,tt,Ma,Co,Sa,Aa,Na,ot,nt,jo,Ia,Da,Eo,Xa,Oa,st,Fo,Ga,Ra,Mo,Wa,Ha,So,Ua,Tn,ae,Te,Ao,at,Va,No,Ja,yn,S,rt,Ka,it,Qa,Gt,Ya,Za,er,dt,tr,lt,or,nr,sr,E,ct,ar,re,rr,Rt,ir,dr,Io,lr,cr,pr,ye,hr,Do,ur,mr,pt,wn,ie,we,Xo,ht,fr,Oo,gr,Pn,A,ut,_r,mt,br,Wt,kr,vr,Tr,ft,yr,gt,wr,Pr,Lr,F,_t,zr,de,qr,Ht,Br,$r,Go,xr,Cr,jr,Pe,Er,Ro,Fr,Mr,bt,Ln,le,Le,Wo,kt,Sr,Ho,Ar,zn,x,vt,Nr,Uo,Ir,Dr,Tt,Xr,Ut,Or,Gr,Rr,yt,Wr,wt,Hr,Ur,Vr,z,Pt,Jr,ce,Kr,Vt,Qr,Yr,Vo,Zr,ei,ti,ze,oi,Jo,ni,si,Lt,ai,Ko,ri,ii,zt,qn,pe,qe,Qo,qt,di,Yo,li,Bn,he,Bt,ci,W,$t,pi,Zo,hi,ui,xt,$n;return T=new me({}),Fe=new me({}),Ne=new me({}),Xe=new ue({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
`}}),at=new me({}),rt=new I({props:{name:"class transformers.PLBartModel",anchor:"transformers.PLBartModel",parameters:[{name:"config",val:": PLBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16141/src/transformers/models/plbart/modeling_plbart.py#L1110",parametersDescription:[{anchor:"transformers.PLBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16141/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ct=new I({props:{name:"forward",anchor:"transformers.PLBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16141/src/transformers/models/plbart/modeling_plbart.py#L1136",parametersDescription:[{anchor:"transformers.PLBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16141/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
See <a href="/docs/transformers/pr_16141/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16141/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16141/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16141/en/model_doc/plbart#transformers.PLBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16141/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
[<span class="hljs-string">&#x27;same&#x27;</span>, <span class="hljs-string">&#x27;first&#x27;</span>, <span class="hljs-string">&#x27;highest&#x27;</span>, <span class="hljs-string">&#x27;result&#x27;</span>, <span class="hljs-string">&#x27;Fib&#x27;</span>]`}}),kt=new me({}),vt=new I({props:{name:"class transformers.PLBartForSequenceClassification",anchor:"transformers.PLBartForSequenceClassification",parameters:[{name:"config",val:": PLBartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16141/src/transformers/models/plbart/modeling_plbart.py#L1395",parametersDescription:[{anchor:"transformers.PLBartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16141/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Pt=new I({props:{name:"forward",anchor:"transformers.PLBartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16141/src/transformers/models/plbart/modeling_plbart.py#L1408",parametersDescription:[{anchor:"transformers.PLBartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16141/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
See <a href="/docs/transformers/pr_16141/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16141/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16141/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),qt=new me({}),Bt=new I({props:{name:"class transformers.PLBartForCausalLM",anchor:"transformers.PLBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16141/src/transformers/models/plbart/modeling_plbart.py#L1531"}}),$t=new I({props:{name:"forward",anchor:"transformers.PLBartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16141/src/transformers/models/plbart/modeling_plbart.py#L1562",parametersDescription:[{anchor:"transformers.PLBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16141/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a>. See <a href="/docs/transformers/pr_16141/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),L=l(),v=n("h1"),w=n("a"),q=n("span"),m(T.$$.fragment),y=l(),C=n("span"),Zn=r("PLBart"),on=l(),D=n("p"),ao=n("strong"),es=r("DISCLAIMER:"),ts=r(" If you see something strange, file a "),je=n("a"),os=r("Github Issue"),ns=r(` and assign
...
target text format is `),fo=n("code"),qs=r("[tgt_lang_code] X [eos]"),Bs=r(". "),go=n("code"),$s=r("bos"),xs=r(" is never used."),pn=l(),_e=n("p"),Cs=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=n("a"),js=r("the paper"),Es=r(" to learn more about this."),hn=l(),R=n("p"),Fs=r("In cases where the language code is needed, The regular "),De=n("a"),_o=n("strong"),Ms=r("call"),Ss=r("()"),As=r(` will encode source text format, and it should be wrapped
inside the context manager `),Mt=n("a"),Ns=r("as_target_tokenizer()"),Is=r(" to encode target text format."),un=l(),St=n("ul"),bo=n("li"),Ds=r("Supervised training"),mn=l(),m(Xe.$$.fragment),fn=l(),At=n("ul"),Oe=n("li"),ko=n("p"),Xs=r("Generation"),Os=l(),ee=n("p"),Gs=r("While generating the target text set the "),vo=n("code"),Rs=r("decoder_start_token_id"),Ws=r(` to the target language id. The following
...
documentation from `),Dt=n("a"),ra=r("PretrainedConfig"),ia=r(" for more information."),da=l(),Po=n("p"),la=r("Example:"),ca=l(),m(Ue.$$.fragment),kn=l(),se=n("h2"),ke=n("a"),Lo=n("span"),m(Ve.$$.fragment),pa=l(),zo=n("span"),ha=r("PLBartTokenizer"),vn=l(),P=n("div"),m(Je.$$.fragment),ua=l(),qo=n("p"),ma=r("Construct an PLBART tokenizer."),fa=l(),X=n("p"),ga=r("Adapted from "),Xt=n("a"),_a=r("RobertaTokenizer"),ba=r(" and "),Ot=n("a"),ka=r("XLNetTokenizer"),va=r(`. Based on
...
sequence-to-sequence models that need a slightly different processing for the labels.`),Ea=l(),N=n("div"),m(et.$$.fragment),Fa=l(),tt=n("p"),Ma=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An PLBART sequence has the following format, where `),Co=n("code"),Sa=r("X"),Aa=r(" represents the sequence:"),Na=l(),ot=n("ul"),nt=n("li"),jo=n("code"),Ia=r("input_ids"),Da=r(" (for encoder) "),Eo=n("code"),Xa=r("X [eos, src_lang_code]"),Oa=l(),st=n("li"),Fo=n("code"),Ga=r("decoder_input_ids"),Ra=r(": (for decoder) "),Mo=n("code"),Wa=r("X [eos, tgt_lang_code]"),Ha=l(),So=n("p"),Ua=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
on Java, Python and English.`),Jt.forEach(o),an=c(t),Et=s(t,"P",{});var Li=a(Et);us=i(Li,"According to the abstract"),Li.forEach(o),rn=c(t),Ft=s(t,"P",{});var zi=a(Ft);co=s(zi,"EM",{});var qi=a(co);ms=i(qi,`Code summarization and generation empower conversion between programming language (PL) and natural language (NL),
while code translation avails the migration of legacy code from one PL to another. This paper introduces PLBART,
a sequence-to-sequence model capable of performing a broad spectrum of program and language understanding and generation tasks.
PLBART is pre-trained on an extensive collection of Java and Python functions and associated NL text via denoising autoencoding.
Experiments on code summarization in the English language, code generation, and code translation in seven programming languages
...
target text format is `),fo=s(H,"CODE",{});var Mi=a(fo);qs=i(Mi,"[tgt_lang_code] X [eos]"),Mi.forEach(o),Bs=i(H,". "),go=s(H,"CODE",{});var Si=a(go);$s=i(Si,"bos"),Si.forEach(o),xs=i(H," is never used."),H.forEach(o),pn=c(t),_e=s(t,"P",{});var jn=a(_e);Cs=i(jn,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=s(jn,"A",{href:!0,rel:!0});var Ai=a(Ie);js=i(Ai,"the paper"),Ai.forEach(o),Es=i(jn," to learn more about this."),jn.forEach(o),hn=c(t),R=s(t,"P",{});var Qt=a(R);Fs=i(Qt,"In cases where the language code is needed, The regular "),De=s(Qt,"A",{href:!0});var mi=a(De);_o=s(mi,"STRONG",{});var Ni=a(_o);Ms=i(Ni,"call"),Ni.forEach(o),Ss=i(mi,"()"),mi.forEach(o),As=i(Qt,` will encode source text format, and it should be wrapped
inside the context manager `),Mt=s(Qt,"A",{href:!0});var Ii=a(Mt);Ns=i(Ii,"as_target_tokenizer()"),Ii.forEach(o),Is=i(Qt," to encode target text format."),Qt.forEach(o),un=c(t),St=s(t,"UL",{});var Di=a(St);bo=s(Di,"LI",{});var Xi=a(bo);Ds=i(Xi,"Supervised training"),Xi.forEach(o),Di.forEach(o),mn=c(t),f(Xe.$$.fragment,t),fn=c(t),At=s(t,"UL",{});var Oi=a(At);Oe=s(Oi,"LI",{});var En=a(Oe);ko=s(En,"P",{});var Gi=a(ko);Xs=i(Gi,"Generation"),Gi.forEach(o),Os=c(En),ee=s(En,"P",{});var Yt=a(ee);Gs=i(Yt,"While generating the target text set the "),vo=s(Yt,"CODE",{});var Ri=a(vo);Rs=i(Ri,"decoder_start_token_id"),Ri.forEach(o),Ws=i(Yt,` to the target language id. The following
...
documentation from `),Dt=s(eo,"A",{href:!0});var Yi=a(Dt);ra=i(Yi,"PretrainedConfig"),Yi.forEach(o),ia=i(eo," for more information."),eo.forEach(o),da=c(U),Po=s(U,"P",{});var Zi=a(Po);la=i(Zi,"Example:"),Zi.forEach(o),ca=c(U),f(Ue.$$.fragment,U),U.forEach(o),kn=c(t),se=s(t,"H2",{class:!0});var Mn=a(se);ke=s(Mn,"A",{id:!0,class:!0,href:!0});var ed=a(ke);Lo=s(ed,"SPAN",{});var td=a(Lo);f(Ve.$$.fragment,td),td.forEach(o),ed.forEach(o),pa=c(Mn),zo=s(Mn,"SPAN",{});var od=a(zo);ha=i(od,"PLBartTokenizer"),od.forEach(o),Mn.forEach(o),vn=c(t),P=s(t,"DIV",{class:!0});var B=a(P);f(Je.$$.fragment,B),ua=c(B),qo=s(B,"P",{});var nd=a(qo);ma=i(nd,"Construct an PLBART tokenizer."),nd.forEach(o),fa=c(B),X=s(B,"P",{});var Be=a(X);ga=i(Be,"Adapted from "),Xt=s(Be,"A",{href:!0});var sd=a(Xt);_a=i(sd,"RobertaTokenizer"),sd.forEach(o),ba=i(Be," and "),Ot=s(Be,"A",{href:!0});var ad=a(Ot);ka=i(ad,"XLNetTokenizer"),ad.forEach(o),va=i(Be,`. Based on
...
sequence-to-sequence models that need a slightly different processing for the labels.`),ld.forEach(o),An.forEach(o),Ea=c(B),N=s(B,"DIV",{class:!0});var $e=a(N);f(et.$$.fragment,$e),Fa=c($e),tt=s($e,"P",{});var Nn=a(tt);Ma=i(Nn,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),fd.forEach(o),$e.forEach(o),B.forEach(o),Tn=c(t),ae=s(t,"H2",{class:!0});var On=a(ae);Te=s(On,"A",{id:!0,class:!0,href:!0});var gd=a(Te);Ao=s(gd,"SPAN",{});var _d=a(Ao);f(at.$$.fragment,_d),_d.forEach(o),gd.forEach(o),Va=c(On),No=s(On,"SPAN",{});var bd=a(No);Ja=i(bd,"PLBartModel"),bd.forEach(o),On.forEach(o),yn=c(t),S=s(t,"DIV",{class:!0});var xe=a(S);f(rt.$$.fragment,xe),Ka=c(xe),it=s(xe,"P",{});var Gn=a(it);Qa=i(Gn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Un.forEach(o),Lr=c(Ce),F=s(Ce,"DIV",{class:!0});var J=a(F);f(_t.$$.fragment,J),zr=c(J),de=s(J,"P",{});var oo=a(de);qr=i(oo,"The "),Ht=s(oo,"A",{href:!0});var $d=a(Ht);Br=i($d,"PLBartForConditionalGeneration"),$d.forEach(o),$r=i(oo," forward method, overrides the "),Go=s(oo,"CODE",{});var xd=a(Go);xr=i(xd,"__call__"),xd.forEach(o),Cr=i(oo," special method."),oo.forEach(o),jr=c(J),f(Pe.$$.fragment,J),Er=c(J),Ro=s(J,"P",{});var Cd=a(Ro);Fr=i(Cd,"Mask-filling example:"),Cd.forEach(o),Mr=c(J),f(bt.$$.fragment,J),J.forEach(o),Ce.forEach(o),Ln=c(t),le=s(t,"H2",{class:!0});var Vn=a(le);Le=s(Vn,"A",{id:!0,class:!0,href:!0});var jd=a(Le);Wo=s(jd,"SPAN",{});var Ed=a(Wo);f(kt.$$.fragment,Ed),Ed.forEach(o),jd.forEach(o),Sr=c(Vn),Ho=s(Vn,"SPAN",{});var Fd=a(Ho);Ar=i(Fd,"PLBartForSequenceClassification"),Fd.forEach(o),Vn.forEach(o),zn=c(t),x=s(t,"DIV",{class:!0});var K=a(x);f(vt.$$.fragment,K),Nr=c(K),Uo=s(K,"P",{});var Md=a(Uo);Ir=i(Md,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Md.forEach(o),Dr=c(K),Tt=s(K,"P",{});var Jn=a(Tt);Xr=i(Jn,"This model inherits from "),Ut=s(Jn,"A",{href:!0});var Sd=a(Ut);Or=i(Sd,"PreTrainedModel"),Sd.forEach(o),Gr=i(Jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
