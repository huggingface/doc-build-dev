...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);x=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);q=o(R,"Module"),R.forEach(n),y=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,x),e(p,m),e(m,q),e(p,y)},d(g){g&&n(p)}}}function bT(M){let p,x,m,q,y,g,h,R,ti,Da,$e,ot,Fr,Ot,oi,zr,ni,Ia,an,ri,Wa,nt,si,St,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,Lt,pi,hi,Ua,Ee,st,Er,Dt,ui,jr,mi,Va,de,It,gi,me,ln,_i,fi,Mr,vi,bi,pn,Ti,wi,hn,ki,qi,yi,at,Wt,xi,Ht,Ri,un,Fi,zi,$i,dt,Bt,Ei,Qt,ji,mn,Mi,Gi,Ka,je,it,Gr,Ut,Ai,Ar,Pi,Ya,Me,Vt,Ni,ct,Kt,Ci,Pr,Oi,Ja,Ge,lt,Nr,Yt,Si,Cr,Li,Xa,Ae,Jt,Di,Or,Ii,Za,Xt,Zt,ed,Pe,pt,Sr,eo,Wi,Lr,Hi,td,X,to,Bi,Dr,Qi,Ui,Ir,Vi,Ki,oo,Yi,ht,no,Ji,Wr,Xi,Zi,ut,ro,ec,Ne,tc,Hr,oc,nc,Br,rc,sc,ac,mt,so,dc,ao,ic,Qr,cc,lc,od,Ce,gt,Ur,io,pc,Vr,hc,nd,S,co,uc,Oe,mc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,xc,_n,Rc,Fc,Xr,zc,$c,fn,Ec,jc,Mc,G,Gc,vn,Ac,Pc,Zr,Nc,Cc,es,Oc,Sc,ts,Lc,Dc,os,Ic,Wc,bn,Hc,Bc,ns,Qc,Uc,Tn,Vc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,po,sl,ho,al,dl,il,ee,uo,cl,Se,ll,qn,pl,hl,ss,ul,ml,gl,ft,_l,as,fl,vl,mo,rd,Le,vt,ds,go,bl,is,Tl,sd,$,_o,wl,De,kl,yn,ql,yl,cs,xl,Rl,Fl,bt,zl,ls,$l,El,ps,jl,Ml,ce,Gl,hs,Al,Pl,xn,Nl,Cl,us,Ol,Sl,Rn,Ll,Dl,Il,A,Wl,Fn,Hl,Bl,ms,Ql,Ul,gs,Vl,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,ep,tp,vs,op,np,$n,rp,sp,En,ap,dp,bs,ip,cp,lp,fo,pp,jn,hp,up,mp,vo,gp,bo,_p,fp,vp,te,To,bp,Ie,Tp,Mn,wp,kp,Ts,qp,yp,xp,Tt,Rp,ws,Fp,zp,wo,$p,wt,ko,Ep,qo,jp,Gn,Mp,Gp,ad,We,kt,ks,yo,Ap,qs,Pp,dd,E,xo,Np,He,Cp,An,Op,Sp,ys,Lp,Dp,Ip,qt,Wp,xs,Hp,Bp,Rs,Qp,Up,le,Vp,Fs,Kp,Yp,Pn,Jp,Xp,zs,Zp,eh,Nn,th,oh,nh,P,rh,Cn,sh,ah,$s,dh,ih,Es,ch,lh,js,ph,hh,Ms,uh,mh,On,gh,_h,Gs,fh,vh,Sn,bh,Th,Ln,wh,kh,As,qh,yh,xh,Ro,Rh,Dn,Fh,zh,$h,Fo,Eh,zo,jh,Mh,Gh,oe,$o,Ah,Be,Ph,In,Nh,Ch,Ps,Oh,Sh,Lh,yt,Dh,Ns,Ih,Wh,Eo,Hh,xt,jo,Bh,Cs,Qh,id,Qe,Rt,Os,Mo,Uh,Ss,Vh,cd,N,Go,Kh,Ue,Yh,Wn,Jh,Xh,Ls,Zh,eu,tu,Ft,ou,Ds,nu,ru,pe,su,Is,au,du,Hn,iu,cu,Ws,lu,pu,Bn,hu,uu,mu,L,gu,Qn,_u,fu,Hs,vu,bu,Bs,Tu,wu,Qs,ku,qu,Us,yu,xu,Un,Ru,Fu,Vs,zu,$u,Vn,Eu,ju,Ks,Mu,Gu,Au,Ao,Pu,Kn,Nu,Cu,Ou,Po,Su,No,Lu,Du,Iu,Ys,Wu,Hu,ne,Co,Bu,Ve,Qu,Yn,Uu,Vu,Js,Ku,Yu,Ju,zt,Xu,Xs,Zu,em,Oo,ld,Ke,$t,Zs,So,tm,ea,om,pd,F,Lo,nm,Ye,rm,Jn,sm,am,ta,dm,im,cm,Et,lm,oa,pm,hm,na,um,mm,he,gm,ra,_m,fm,Xn,vm,bm,sa,Tm,wm,Zn,km,qm,ym,D,xm,er,Rm,Fm,aa,zm,$m,da,Em,jm,ia,Mm,Gm,ca,Am,Pm,tr,Nm,Cm,la,Om,Sm,or,Lm,Dm,pa,Im,Wm,Hm,Do,Bm,nr,Qm,Um,Vm,Io,Km,Wo,Ym,Jm,Xm,ha,Zm,eg,re,Ho,tg,Je,og,rr,ng,rg,ua,sg,ag,dg,jt,ig,ma,cg,lg,Bo,pg,Mt,Qo,hg,Uo,ug,sr,mg,gg,hd,Xe,Gt,ga,Vo,_g,_a,fg,ud,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,xg,va,Rg,Fg,ba,zg,$g,ue,Eg,Ta,jg,Mg,dr,Gg,Ag,wa,Pg,Ng,ir,Cg,Og,Sg,I,Lg,cr,Dg,Ig,ka,Wg,Hg,qa,Bg,Qg,ya,Ug,Vg,xa,Kg,Yg,lr,Jg,Xg,Ra,Zg,e_,pr,t_,o_,Fa,n_,r_,s_,Yo,a_,hr,d_,i_,c_,Jo,l_,Xo,p_,h_,u_,za,m_,g_,se,Zo,__,et,f_,ur,v_,b_,$a,T_,w_,k_,Pt,q_,Ea,y_,x_,en,R_,Nt,tn,F_,ja,z_,md;return g=new _e({}),Ot=new _e({}),Dt=new _e({}),It=new j({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16632/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"doc_sep"},{anchor:"transformers.RagConfig.n_docs",description:`<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to 5) &#x2014;
...
<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"retrieval_batch_size"},{anchor:"transformers.RagConfig.dataset",description:`<strong>dataset</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;wiki_dpr&quot;</code>) &#x2014;
...
one (default) from the datasets library with <code>config.index_name=&quot;wiki_dpr&quot;</code> for example.`,name:"config"},{anchor:"transformers.RagRetriever.question_encoder_tokenizer",description:`<strong>question_encoder_tokenizer</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
The tokenizer that was used to tokenize the question. It is used to decode the question and then use the
generator_tokenizer.`,name:"question_encoder_tokenizer"},{anchor:"transformers.RagRetriever.generator_tokenizer",description:`<strong>generator_tokenizer</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
...
`}}),io=new _e({}),co=new j({props:{name:"class transformers.RagModel",anchor:"transformers.RagModel",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16632/src/transformers/models/rag/modeling_rag.py#L493",parametersDescription:[{anchor:"transformers.RagModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.RagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}]}}),_t=new ge({props:{$$slots:{default:[dT]},$$scope:{ctx:M}}}),uo=new j({props:{name:"forward",anchor:"transformers.RagModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16632/src/transformers/models/rag/modeling_rag.py#L536",parametersDescription:[{anchor:"transformers.RagModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
...
<p>A <a
  href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids=inputs[<span class="hljs-string">&quot;input_ids&quot;</span>])`}}),go=new _e({}),_o=new j({props:{name:"class transformers.RagSequenceForGeneration",anchor:"transformers.RagSequenceForGeneration",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16632/src/transformers/models/rag/modeling_rag.py#L737",parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16632/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_16632/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],returnDescription:`
<p>The generated
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16632/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
`,returnType:`
<p><code>torch.LongTensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),Mo=new _e({}),Go=new j({props:{name:"class transformers.TFRagModel",anchor:"transformers.TFRagModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16632/src/transformers/models/rag/modeling_tf_rag.py#L483",parametersDescription:[{anchor:"transformers.TFRagModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.TFRagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}]}}),Ft=new ge({props:{$$slots:{default:[uT]},$$scope:{ctx:M}}}),Co=new j({props:{name:"call",anchor:"transformers.TFRagModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16632/src/transformers/models/rag/modeling_tf_rag.py#L534",parametersDescription:[{anchor:"transformers.TFRagModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
...
`}}),zt=new ge({props:{$$slots:{default:[mT]},$$scope:{ctx:M}}}),Oo=new sn({props:{code:`from transformers import RagTokenizer, RagRetriever, TFRagModel
import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagSequenceForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16632/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16632/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16632/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
...
`,returnType:`
<p><code>tf.Tensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),{c(){p=r("meta"),x=c(),m=r("h1"),q=r("a"),y=r("span"),f(g.$$.fragment),h=c(),R=r("span"),ti=t("RAG"),Da=c(),$e=r("h2"),ot=r("a"),Fr=r("span"),f(Ot.$$.fragment),oi=c(),zr=r("span"),ni=t("Overview"),Ia=c(),an=r("p"),ri=t(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
decoder model configuration.`),$i=c(),dt=r("div"),f(Bt.$$.fragment),Ei=c(),Qt=r("p"),ji=t("Serializes this instance to a Python dictionary. Override the default "),mn=r("a"),Mi=t("to_dict()"),Gi=t("."),Ka=c(),je=r("h2"),it=r("a"),Gr=r("span"),f(Ut.$$.fragment),Ai=c(),Ar=r("span"),Pi=t("RagTokenizer"),Ya=c(),Me=r("div"),f(Vt.$$.fragment),Ni=c(),ct=r("div"),f(Kt.$$.fragment),Ci=c(),Pr=r("p"),Oi=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ja=c(),Ge=r("h2"),lt=r("a"),Nr=r("span"),f(Yt.$$.fragment),Si=c(),Cr=r("span"),Li=t("Rag specific outputs"),Xa=c(),Ae=r("div"),f(Jt.$$.fragment),Di=c(),Or=r("p"),Ii=t("Base class for retriever augmented marginalized models outputs."),Za=c(),Xt=r("div"),f(Zt.$$.fragment),ed=c(),Pe=r("h2"),pt=r("a"),Sr=r("span"),f(eo.$$.fragment),Wi=c(),Lr=r("span"),Hi=t("RagRetriever"),td=c(),X=r("div"),f(to.$$.fragment),Bi=c(),Dr=r("p"),Qi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
contents, and it formats them to be used with a RagModel.`),Ui=c(),Ir=r("p"),Vi=t("Examples:"),Ki=c(),f(oo.$$.fragment),Yi=c(),ht=r("div"),f(no.$$.fragment),Ji=c(),Wr=r("p"),Xi=t("Retriever initialization function. It loads the index into memory."),Zi=c(),ut=r("div"),f(ro.$$.fragment),ec=c(),Ne=r("p"),tc=t("Postprocessing retrieved "),Hr=r("code"),oc=t("docs"),nc=t(" and combining them with "),Br=r("code"),rc=t("input_strings"),sc=t("."),ac=c(),mt=r("div"),f(so.$$.fragment),dc=c(),ao=r("p"),ic=t("Retrieves documents for specified "),Qr=r("code"),cc=t("question_hidden_states"),lc=t("."),od=c(),Ce=r("h2"),gt=r("a"),Ur=r("span"),f(io.$$.fragment),pc=c(),Vr=r("span"),hc=t("RagModel"),nd=c(),S=r("div"),f(co.$$.fragment),uc=c(),Oe=r("p"),mc=t("The "),gn=r("a"),gc=t("RagModel"),_c=t(" forward method, overrides the "),Kr=r("code"),fc=t("__call__"),vc=t(" special method."),bc=c(),f(_t.$$.fragment),Tc=c(),Yr=r("p"),wc=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
...
`),Zr=r("em"),Nc=t("autoencoding"),Cc=t(" model as the "),es=r("code"),Oc=t("question_encoder"),Sc=t(" and any "),ts=r("em"),Lc=t("seq2seq"),Dc=t(" model with language model head as the "),os=r("code"),Ic=t("generator"),Wc=t(`.
...
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Ml=c(),ce=r("p"),Gl=t("The question encoder can be any "),hs=r("em"),Al=t("autoencoding"),Pl=t(" model, preferably "),xn=r("a"),Nl=t("DPRQuestionEncoder"),Cl=t(`, and the generator can be
any `),us=r("em"),Ol=t("seq2seq"),Sl=t(" model, preferably "),Rn=r("a"),Ll=t("BartForConditionalGeneration"),Dl=t("."),Il=c(),A=r("p"),Wl=t("The model can be initialized with a "),Fn=r("a"),Hl=t("RagRetriever"),Bl=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
any `),zs=r("em"),Zp=t("seq2seq"),eh=t(" model, preferably "),Nn=r("a"),th=t("BartForConditionalGeneration"),oh=t("."),nh=c(),P=r("p"),rh=t("The model can be initialized with a "),Cn=r("a"),sh=t("RagRetriever"),ah=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
It has been tested with `),On=r("a"),gh=t("DPRQuestionEncoder"),_h=t(" as the "),Gs=r("code"),fh=t("question_encoder"),vh=t(" and "),Sn=r("a"),bh=t("BartForConditionalGeneration"),Th=t(` or
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gh=c(),oe=r("div"),f($o.$$.fragment),Ah=c(),Be=r("p"),Ph=t("The "),In=r("a"),Nh=t("RagTokenForGeneration"),Ch=t(" forward method, overrides the "),Ps=r("code"),Oh=t("__call__"),Sh=t(" special method."),Lh=c(),f(yt.$$.fragment),Dh=c(),Ns=r("p"),Ih=t("Example:"),Wh=c(),f(Eo.$$.fragment),Hh=c(),xt=r("div"),f(jo.$$.fragment),Bh=c(),Cs=r("p"),Qh=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),Rt=r("a"),Os=r("span"),f(Mo.$$.fragment),Uh=c(),Ss=r("span"),Vh=t("TFRagModel"),cd=c(),N=r("div"),f(Go.$$.fragment),Kh=c(),Ue=r("p"),Yh=t("The "),Wn=r("a"),Jh=t("TFRagModel"),Xh=t(" forward method, overrides the "),Ls=r("code"),Zh=t("__call__"),eu=t(" special method."),tu=c(),f(Ft.$$.fragment),ou=c(),Ds=r("p"),nu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
as the `),Ks=r("code"),Mu=t("generator"),Gu=t("."),Au=c(),Ao=r("p"),Pu=t("This model inherits from "),Kn=r("a"),Nu=t("TFPreTrainedModel"),Cu=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ou=c(),Po=r("p"),Su=t("This model is also a Tensorflow "),No=r("a"),Lu=t("tf.keras.Model"),Du=t(`
...
It has been tested with `),tr=r("a"),Nm=t("TFDPRQuestionEncoder"),Cm=t(" as the "),la=r("code"),Om=t("question_encoder"),Sm=t(" and "),or=r("a"),Lm=t("TFBartForConditionalGeneration"),Dm=t(`
...
any `),wa=r("em"),Pg=t("seq2seq"),Ng=t(" model, preferably "),ir=r("a"),Cg=t("TFBartForConditionalGeneration"),Og=t("."),Sg=c(),I=r("p"),Lg=t("The model can be initialized with a "),cr=r("a"),Dg=t("RagRetriever"),Ig=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd.forEach(n),vp=l(H),te=s(H,"DIV",{class:!0});var Te=a(te);v(To.$$.fragment,Te),bp=l(Te),Ie=s(Te,"P",{});var vr=a(Ie);Tp=o(vr,"The "),Mn=s(vr,"A",{href:!0});var ev=a(Mn);wp=o(ev,"RagSequenceForGeneration"),ev.forEach(n),kp=o(vr," forward method, overrides the "),Ts=s(vr,"CODE",{});var tv=a(Ts);qp=o(tv,"__call__"),tv.forEach(n),yp=o(vr," special method."),vr.forEach(n),xp=l(Te),v(Tt.$$.fragment,Te),Rp=l(Te),ws=s(Te,"P",{});var ov=a(ws);Fp=o(ov,"Example:"),ov.forEach(n),zp=l(Te),v(wo.$$.fragment,Te),Te.forEach(n),$p=l(H),wt=s(H,"DIV",{class:!0});var Cd=a(wt);v(ko.$$.fragment,Cd),Ep=l(Cd),qo=s(Cd,"P",{});var Od=a(qo);jp=o(Od,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Gn=s(Od,"A",{href:!0});var nv=a(Gn);Mp=o(nv,"generate()"),nv.forEach(n),Gp=o(Od,"`\ndocumentation for more information on how to set other generate input parameters."),Od.forEach(n),Cd.forEach(n),H.forEach(n),ad=l(d),We=s(d,"H2",{class:!0});var Sd=a(We);kt=s(Sd,"A",{id:!0,class:!0,href:!0});var rv=a(kt);ks=s(rv,"SPAN",{});var sv=a(ks);v(yo.$$.fragment,sv),sv.forEach(n),rv.forEach(n),Ap=l(Sd),qs=s(Sd,"SPAN",{});var av=a(qs);Pp=o(av,"RagTokenForGeneration"),av.forEach(n),Sd.forEach(n),dd=l(d),E=s(d,"DIV",{class:!0});var Q=a(E);v(xo.$$.fragment,Q),Np=l(Q),He=s(Q,"P",{});var br=a(He);Cp=o(br,"The "),An=s(br,"A",{href:!0});var dv=a(An);Op=o(dv,"RagTokenForGeneration"),dv.forEach(n),Sp=o(br," forward method, overrides the "),ys=s(br,"CODE",{});var iv=a(ys);Lp=o(iv,"__call__"),iv.forEach(n),Dp=o(br," special method."),br.forEach(n),Ip=l(Q),v(qt.$$.fragment,Q),Wp=l(Q),xs=s(Q,"P",{});var cv=a(xs);Hp=o(cv,"A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),cv.forEach(n),Bp=l(Q),Rs=s(Q,"P",{});var lv=a(Rs);Qp=o(lv,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
any `),zs=s(we,"EM",{});var uv=a(zs);Zp=o(uv,"seq2seq"),uv.forEach(n),eh=o(we," model, preferably "),Nn=s(we,"A",{href:!0});var mv=a(Nn);th=o(mv,"BartForConditionalGeneration"),mv.forEach(n),oh=o(we,"."),we.forEach(n),nh=l(Q),P=s(Q,"P",{});var U=a(P);rh=o(U,"The model can be initialized with a "),Cn=s(U,"A",{href:!0});var gv=a(Cn);sh=o(gv,"RagRetriever"),gv.forEach(n),ah=o(U,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
It has been tested with `),On=s(U,"A",{href:!0});var Tv=a(On);gh=o(Tv,"DPRQuestionEncoder"),Tv.forEach(n),_h=o(U," as the "),Gs=s(U,"CODE",{});var wv=a(Gs);fh=o(wv,"question_encoder"),wv.forEach(n),vh=o(U," and "),Sn=s(U,"A",{href:!0});var kv=a(Sn);bh=o(kv,"BartForConditionalGeneration"),kv.forEach(n),Th=o(U,` or
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(n),Gh=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);v($o.$$.fragment,ke),Ah=l(ke),Be=s(ke,"P",{});var Tr=a(Be);Ph=o(Tr,"The "),In=s(Tr,"A",{href:!0});var Fv=a(In);Nh=o(Fv,"RagTokenForGeneration"),Fv.forEach(n),Ch=o(Tr," forward method, overrides the "),Ps=s(Tr,"CODE",{});var zv=a(Ps);Oh=o(zv,"__call__"),zv.forEach(n),Sh=o(Tr," special method."),Tr.forEach(n),Lh=l(ke),v(yt.$$.fragment,ke),Dh=l(ke),Ns=s(ke,"P",{});var $v=a(Ns);Ih=o($v,"Example:"),$v.forEach(n),Wh=l(ke),v(Eo.$$.fragment,ke),ke.forEach(n),Hh=l(Q),xt=s(Q,"DIV",{class:!0});var Id=a(xt);v(jo.$$.fragment,Id),Bh=l(Id),Cs=s(Id,"P",{});var Ev=a(Cs);Qh=o(Ev,"Implements RAG token decoding."),Ev.forEach(n),Id.forEach(n),Q.forEach(n),id=l(d),Qe=s(d,"H2",{class:!0});var Wd=a(Qe);Rt=s(Wd,"A",{id:!0,class:!0,href:!0});var jv=a(Rt);Os=s(jv,"SPAN",{});var Mv=a(Os);v(Mo.$$.fragment,Mv),Mv.forEach(n),jv.forEach(n),Uh=l(Wd),Ss=s(Wd,"SPAN",{});var Gv=a(Ss);Vh=o(Gv,"TFRagModel"),Gv.forEach(n),Wd.forEach(n),cd=l(d),N=s(d,"DIV",{class:!0});var V=a(N);v(Go.$$.fragment,V),Kh=l(V),Ue=s(V,"P",{});var wr=a(Ue);Yh=o(wr,"The "),Wn=s(wr,"A",{href:!0});var Av=a(Wn);Jh=o(Av,"TFRagModel"),Av.forEach(n),Xh=o(wr," forward method, overrides the "),Ls=s(wr,"CODE",{});var Pv=a(Ls);Zh=o(Pv,"__call__"),Pv.forEach(n),eu=o(wr," special method."),wr.forEach(n),tu=l(V),v(Ft.$$.fragment,V),ou=l(V),Ds=s(V,"P",{});var Nv=a(Ds);nu=o(Nv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Nv.forEach(n),ru=l(V),pe=s(V,"P",{});var qe=a(pe);su=o(qe,"The question encoder can be any "),Is=s(qe,"EM",{});var Cv=a(Is);au=o(Cv,"autoencoding"),Cv.forEach(n),du=o(qe," model, preferably "),Hn=s(qe,"A",{href:!0});var Ov=a(Hn);iu=o(Ov,"TFDPRQuestionEncoder"),Ov.forEach(n),cu=o(qe,`, and the generator can be
...
as the `),Ks=s(K,"CODE",{});var Kv=a(Ks);Mu=o(Kv,"generator"),Kv.forEach(n),Gu=o(K,"."),K.forEach(n),Au=l(V),Ao=s(V,"P",{});var Hd=a(Ao);Pu=o(Hd,"This model inherits from "),Kn=s(Hd,"A",{href:!0});var Yv=a(Kn);Nu=o(Yv,"TFPreTrainedModel"),Yv.forEach(n),Cu=o(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(n),Ou=l(V),Po=s(V,"P",{});var Bd=a(Po);Su=o(Bd,"This model is also a Tensorflow "),No=s(Bd,"A",{href:!0,rel:!0});var Jv=a(No);Lu=o(Jv,"tf.keras.Model"),Jv.forEach(n),Du=o(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
SavedModel format.`),Xv.forEach(n),Hu=l(V),ne=s(V,"DIV",{class:!0});var ye=a(ne);v(Co.$$.fragment,ye),Bu=l(ye),Ve=s(ye,"P",{});var kr=a(Ve);Qu=o(kr,"The "),Yn=s(kr,"A",{href:!0});var Zv=a(Yn);Uu=o(Zv,"TFRagModel"),Zv.forEach(n),Vu=o(kr," forward method, overrides the "),Js=s(kr,"CODE",{});var eb=a(Js);Ku=o(eb,"__call__"),eb.forEach(n),Yu=o(kr," special method."),kr.forEach(n),Ju=l(ye),v(zt.$$.fragment,ye),Xu=l(ye),Xs=s(ye,"P",{});var tb=a(Xs);Zu=o(tb,"Example:"),tb.forEach(n),em=l(ye),v(Oo.$$.fragment,ye),ye.forEach(n),V.forEach(n),ld=l(d),Ke=s(d,"H2",{class:!0});var Qd=a(Ke);$t=s(Qd,"A",{id:!0,class:!0,href:!0});var ob=a($t);Zs=s(ob,"SPAN",{});var nb=a(Zs);v(So.$$.fragment,nb),nb.forEach(n),ob.forEach(n),tm=l(Qd),ea=s(Qd,"SPAN",{});var rb=a(ea);om=o(rb,"TFRagSequenceForGeneration"),rb.forEach(n),Qd.forEach(n),pd=l(d),F=s(d,"DIV",{class:!0});var C=a(F);v(Lo.$$.fragment,C),nm=l(C),Ye=s(C,"P",{});var qr=a(Ye);rm=o(qr,"The "),Jn=s(qr,"A",{href:!0});var sb=a(Jn);sm=o(sb,"TFRagSequenceForGeneration"),sb.forEach(n),am=o(qr," forward method, overrides the "),ta=s(qr,"CODE",{});var ab=a(ta);dm=o(ab,"__call__"),ab.forEach(n),im=o(qr," special method."),qr.forEach(n),cm=l(C),v(Et.$$.fragment,C),lm=l(C),oa=s(C,"P",{});var db=a(oa);pm=o(db,"A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),db.forEach(n),hm=l(C),na=s(C,"P",{});var ib=a(na);um=o(ib,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),ib.forEach(n),mm=l(C),he=s(C,"P",{});var xe=a(he);gm=o(xe,"The question encoder can be any "),ra=s(xe,"EM",{});var cb=a(ra);_m=o(cb,"autoencoding"),cb.forEach(n),fm=o(xe," model, preferably "),Xn=s(xe,"A",{href:!0});var lb=a(Xn);vm=o(lb,"TFDPRQuestionEncoder"),lb.forEach(n),bm=o(xe,`, and the generator can be
any `),sa=s(xe,"EM",{});var pb=a(sa);Tm=o(pb,"seq2seq"),pb.forEach(n),wm=o(xe," model, preferably "),Zn=s(xe,"A",{href:!0});var hb=a(Zn);km=o(hb,"TFBartForConditionalGeneration"),hb.forEach(n),qm=o(xe,"."),xe.forEach(n),ym=l(C),D=s(C,"P",{});var Y=a(D);xm=o(Y,"The model can be initialized with a "),er=s(Y,"A",{href:!0});var ub=a(er);Rm=o(ub,"RagRetriever"),ub.forEach(n),Fm=o(Y,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
It has been tested with `),tr=s(Y,"A",{href:!0});var vb=a(tr);Nm=o(vb,"TFDPRQuestionEncoder"),vb.forEach(n),Cm=o(Y," as the "),la=s(Y,"CODE",{});var bb=a(la);Om=o(bb,"question_encoder"),bb.forEach(n),Sm=o(Y," and "),or=s(Y,"A",{href:!0});var Tb=a(or);Lm=o(Tb,"TFBartForConditionalGeneration"),Tb.forEach(n),Dm=o(Y,`
as the `),pa=s(Y,"CODE",{});var wb=a(pa);Im=o(wb,"generator"),wb.forEach(n),Wm=o(Y,"."),Y.forEach(n),Hm=l(C),Do=s(C,"P",{});var Ud=a(Do);Bm=o(Ud,"This model inherits from "),nr=s(Ud,"A",{href:!0});var kb=a(nr);Qm=o(kb,"TFPreTrainedModel"),kb.forEach(n),Um=o(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(n),Vm=l(C),Io=s(C,"P",{});var Vd=a(Io);Km=o(Vd,"This model is also a Tensorflow "),Wo=s(Vd,"A",{href:!0,rel:!0});var qb=a(Wo);Ym=o(qb,"tf.keras.Model"),qb.forEach(n),Jm=o(Vd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Vd.forEach(n),Xm=l(C),ha=s(C,"P",{});var yb=a(ha);Zm=o(yb,`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),yb.forEach(n),eg=l(C),re=s(C,"DIV",{class:!0});var Re=a(re);v(Ho.$$.fragment,Re),tg=l(Re),Je=s(Re,"P",{});var yr=a(Je);og=o(yr,"The "),rr=s(yr,"A",{href:!0});var xb=a(rr);ng=o(xb,"TFRagSequenceForGeneration"),xb.forEach(n),rg=o(yr," forward method, overrides the "),ua=s(yr,"CODE",{});var Rb=a(ua);sg=o(Rb,"__call__"),Rb.forEach(n),ag=o(yr," special method."),yr.forEach(n),dg=l(Re),v(jt.$$.fragment,Re),ig=l(Re),ma=s(Re,"P",{});var Fb=a(ma);cg=o(Fb,"Example:"),Fb.forEach(n),lg=l(Re),v(Bo.$$.fragment,Re),Re.forEach(n),pg=l(C),Mt=s(C,"DIV",{class:!0});var Kd=a(Mt);v(Qo.$$.fragment,Kd),hg=l(Kd),Uo=s(Kd,"P",{});var Yd=a(Uo);ug=o(Yd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),sr=s(Yd,"A",{href:!0});var zb=a(sr);mg=o(zb,"generate()"),zb.forEach(n),gg=o(Yd,"`\ndocumentation for more information on how to set other generate input parameters"),Yd.forEach(n),Kd.forEach(n),C.forEach(n),hd=l(d),Xe=s(d,"H2",{class:!0});var Jd=a(Xe);Gt=s(Jd,"A",{id:!0,class:!0,href:!0});var $b=a(Gt);ga=s($b,"SPAN",{});var Eb=a(ga);v(Vo.$$.fragment,Eb),Eb.forEach(n),$b.forEach(n),_g=l(Jd),_a=s(Jd,"SPAN",{});var jb=a(_a);fg=o(jb,"TFRagTokenForGeneration"),jb.forEach(n),Jd.forEach(n),ud=l(d),z=s(d,"DIV",{class:!0});var O=a(z);v(Ko.$$.fragment,O),vg=l(O),Ze=s(O,"P",{});var xr=a(Ze);bg=o(xr,"The "),ar=s(xr,"A",{href:!0});var Mb=a(ar);Tg=o(Mb,"TFRagTokenForGeneration"),Mb.forEach(n),wg=o(xr," forward method, overrides the "),fa=s(xr,"CODE",{});var Gb=a(fa);kg=o(Gb,"__call__"),Gb.forEach(n),qg=o(xr," special method."),xr.forEach(n),yg=l(O),v(At.$$.fragment,O),xg=l(O),va=s(O,"P",{});var Ab=a(va);Rg=o(Ab,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Ab.forEach(n),Fg=l(O),ba=s(O,"P",{});var Pb=a(ba);zg=o(Pb,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Pb.forEach(n),$g=l(O),ue=s(O,"P",{});var Fe=a(ue);Eg=o(Fe,"The question encoder can be any "),Ta=s(Fe,"EM",{});var Nb=a(Ta);jg=o(Nb,"autoencoding"),Nb.forEach(n),Mg=o(Fe," model, preferably "),dr=s(Fe,"A",{href:!0});var Cb=a(dr);Gg=o(Cb,"TFDPRQuestionEncoder"),Cb.forEach(n),Ag=o(Fe,`, and the generator can be
any `),wa=s(Fe,"EM",{});var Ob=a(wa);Pg=o(Ob,"seq2seq"),Ob.forEach(n),Ng=o(Fe," model, preferably "),ir=s(Fe,"A",{href:!0});var Sb=a(ir);Cg=o(Sb,"TFBartForConditionalGeneration"),Sb.forEach(n),Og=o(Fe,"."),Fe.forEach(n),Sg=l(O),I=s(O,"P",{});var J=a(I);Lg=o(J,"The model can be initialized with a "),cr=s(J,"A",{href:!0});var Lb=a(cr);Dg=o(Lb,"RagRetriever"),Lb.forEach(n),Ig=o(J,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
