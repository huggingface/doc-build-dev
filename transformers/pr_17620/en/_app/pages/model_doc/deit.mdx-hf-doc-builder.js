...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/deit/feature_extraction_deit.py#L91",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17620/en/model_doc/deit#transformers.DeiTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/deit/modeling_deit.py#L591",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/deit/modeling_deit.py#L698",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17620/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/deit/modeling_deit.py#L852",returnDescription:`
...
should refer to this superclass for more information regarding those methods.`),yr=f(),R=a("div"),v(Re.$$.fragment),Dr=f(),ao=a("p"),kr=n("Main method to preprocess one or several image(s) to be fed as input to the model."),xr=f(),v(fe.$$.fragment),Ro=f(),Y=a("h2"),ue=a("a"),ro=a("span"),v(Ue.$$.fragment),Ir=f(),so=a("span"),Er=n("DeiTModel"),Uo=f(),S=a("div"),v(Je.$$.fragment),Fr=f(),Ge=a("p"),Mr=n(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
...
should refer to this superclass for more information regarding those methods.`),aa.forEach(o),yr=u(Ee),R=r(Ee,"DIV",{class:!0});var Pt=s(R);w(Re.$$.fragment,Pt),Dr=u(Pt),ao=r(Pt,"P",{});var vn=s(ao);kr=i(vn,"Main method to preprocess one or several image(s) to be fed as input to the model."),vn.forEach(o),xr=u(Pt),w(fe.$$.fragment,Pt),Pt.forEach(o),Ee.forEach(o),Ro=u(t),Y=r(t,"H2",{class:!0});var ra=s(Y);ue=r(ra,"A",{id:!0,class:!0,href:!0});var wn=s(ue);ro=r(wn,"SPAN",{});var $n=s(ro);w(Ue.$$.fragment,$n),$n.forEach(o),wn.forEach(o),Ir=u(ra),so=r(ra,"SPAN",{});var yn=s(so);Er=i(yn,"DeiTModel"),yn.forEach(o),ra.forEach(o),Uo=u(t),S=r(t,"DIV",{class:!0});var zt=s(S);w(Je.$$.fragment,zt),Fr=u(zt),Ge=r(zt,"P",{});var sa=s(Ge);Mr=i(sa,`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
