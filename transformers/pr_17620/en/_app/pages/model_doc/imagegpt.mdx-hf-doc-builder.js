...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/imagegpt/feature_extraction_imagegpt.py#L96",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/imagegpt/modeling_imagegpt.py#L656",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17620/en/model_doc/imagegpt#transformers.ImageGPTConfig"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/imagegpt/modeling_imagegpt.py#L949",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17620/src/transformers/models/imagegpt/modeling_imagegpt.py#L1101",returnDescription:`
...
should refer to this superclass for more information regarding those methods.`),Kr=l(),oe=a("div"),b(nt.$$.fragment),Yr=l(),aa=a("p"),Zr=r("Main method to preprocess one or several image(s) to be fed as input to the model."),ei=l(),b(Pe.$$.fragment),qa=l(),ce=a("h2"),ke=a("a"),na=a("span"),b(st.$$.fragment),ti=l(),sa=a("span"),oi=r("ImageGPTModel"),Aa=l(),A=a("div"),b(rt.$$.fragment),ai=l(),ra=a("p"),ni=r("The bare ImageGPT Model transformer outputting raw hidden-states without any specific head on top."),si=l(),it=a("p"),ri=r("This model inherits from "),Nt=a("a"),ii=r("PreTrainedModel"),li=r(`. Check the superclass documentation for the generic methods the
...
should refer to this superclass for more information regarding those methods.`),Ka.forEach(t),Kr=d(De),oe=n(De,"DIV",{class:!0});var Vt=s(oe);y(nt.$$.fragment,Vt),Yr=d(Vt),aa=n(Vt,"P",{});var Ad=s(aa);Zr=i(Ad,"Main method to preprocess one or several image(s) to be fed as input to the model."),Ad.forEach(t),ei=d(Vt),y(Pe.$$.fragment,Vt),Vt.forEach(t),De.forEach(t),qa=d(o),ce=n(o,"H2",{class:!0});var Ya=s(ce);ke=n(Ya,"A",{id:!0,class:!0,href:!0});var Dd=s(ke);na=n(Dd,"SPAN",{});var Nd=s(na);y(st.$$.fragment,Nd),Nd.forEach(t),Dd.forEach(t),ti=d(Ya),sa=n(Ya,"SPAN",{});var Od=s(sa);oi=i(Od,"ImageGPTModel"),Od.forEach(t),Ya.forEach(t),Aa=d(o),A=n(o,"DIV",{class:!0});var ae=s(A);y(rt.$$.fragment,ae),ai=d(ae),ra=n(ae,"P",{});var Ld=s(ra);ni=i(Ld,"The bare ImageGPT Model transformer outputting raw hidden-states without any specific head on top."),Ld.forEach(t),si=d(ae),it=n(ae,"P",{});var Za=s(it);ri=i(Za,"This model inherits from "),Nt=n(Za,"A",{href:!0});var Sd=s(Nt);ii=i(Sd,"PreTrainedModel"),Sd.forEach(t),li=i(Za,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
