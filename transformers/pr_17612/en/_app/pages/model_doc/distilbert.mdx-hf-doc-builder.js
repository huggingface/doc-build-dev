...
the latter silently ignores them.`)},l(l){d=n(l,"P",{});var f=r(d);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(f,"CODE",{});var x=r(c);u=i(x,"Module"),x.forEach(t),_=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){b(l,d,f),e(d,g),e(d,c),e(c,u),e(d,_)},d(l){l&&t(d)}}}function KD(B){let d,g,c,u,_;return u=new ie({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForMaskedLM
...
Whether or not to return a <a href="/docs/transformers/pr_17612/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17612/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17612/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17612/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17612/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17612/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17612/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17612/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17612/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
general usage and behavior.`),Uv=p(),Sd=o("p"),Hv=a("Finally, this model supports inherent JAX features such as:"),Vv=p(),Mt=o("ul"),Id=o("li"),ga=o("a"),Kv=a("Just-In-Time (JIT) compilation"),Jv=p(),Wd=o("li"),_a=o("a"),Gv=a("Automatic Differentiation"),Xv=p(),Qd=o("li"),ba=o("a"),Yv=a("Vectorization"),Zv=p(),Rd=o("li"),va=o("a"),e1=a("Parallelization"),t1=p(),gt=o("div"),T(ka.$$.fragment),s1=p(),zs=o("p"),o1=a("The "),Ud=o("code"),n1=a("FlaxDistilBertPreTrainedModel"),r1=a(" forward method, overrides the "),Hd=o("code"),a1=a("__call__"),i1=a(" special method."),l1=p(),T(Go.$$.fragment),d1=p(),T(Xo.$$.fragment),ih=p(),js=o("h2"),Yo=o("a"),Vd=o("span"),T(Ta.$$.fragment),c1=p(),Kd=o("span"),p1=a("FlaxDistilBertForMaskedLM"),lh=p(),Ee=o("div"),T($a.$$.fragment),h1=p(),wa=o("p"),u1=a("DistilBert Model with a "),Jd=o("code"),f1=a("language modeling"),m1=a(" head on top."),g1=p(),ya=o("p"),_1=a("This model inherits from "),il=o("a"),b1=a("FlaxPreTrainedModel"),v1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k1=p(),Da=o("p"),T1=a("This model is also a Flax Linen "),Fa=o("a"),$1=a("flax.linen.Module"),w1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),y1=p(),Gd=o("p"),D1=a("Finally, this model supports inherent JAX features such as:"),F1=p(),Et=o("ul"),Xd=o("li"),Ba=o("a"),B1=a("Just-In-Time (JIT) compilation"),x1=p(),Yd=o("li"),xa=o("a"),M1=a("Automatic Differentiation"),E1=p(),Zd=o("li"),Ma=o("a"),z1=a("Vectorization"),j1=p(),ec=o("li"),Ea=o("a"),C1=a("Parallelization"),q1=p(),_t=o("div"),T(za.$$.fragment),P1=p(),Cs=o("p"),A1=a("The "),tc=o("code"),O1=a("FlaxDistilBertPreTrainedModel"),N1=a(" forward method, overrides the "),sc=o("code"),L1=a("__call__"),S1=a(" special method."),I1=p(),T(Zo.$$.fragment),W1=p(),T(en.$$.fragment),dh=p(),qs=o("h2"),tn=o("a"),oc=o("span"),T(ja.$$.fragment),Q1=p(),nc=o("span"),R1=a("FlaxDistilBertForSequenceClassification"),ch=p(),ze=o("div"),T(Ca.$$.fragment),U1=p(),rc=o("p"),H1=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V1=p(),qa=o("p"),K1=a("This model inherits from "),ll=o("a"),J1=a("FlaxPreTrainedModel"),G1=a(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),jk=p(),gc=o("p"),Ck=a("Finally, this model supports inherent JAX features such as:"),qk=p(),jt=o("ul"),_c=o("li"),Va=o("a"),Pk=a("Just-In-Time (JIT) compilation"),Ak=p(),bc=o("li"),Ka=o("a"),Ok=a("Automatic Differentiation"),Nk=p(),vc=o("li"),Ja=o("a"),Lk=a("Vectorization"),Sk=p(),kc=o("li"),Ga=o("a"),Ik=a("Parallelization"),Wk=p(),vt=o("div"),T(Xa.$$.fragment),Qk=p(),Os=o("p"),Rk=a("The "),Tc=o("code"),Uk=a("FlaxDistilBertPreTrainedModel"),Hk=a(" forward method, overrides the "),$c=o("code"),Vk=a("__call__"),Kk=a(" special method."),Jk=p(),T(rn.$$.fragment),Gk=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),Xk=p(),yc=o("span"),Yk=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=o("div"),T(Za.$$.fragment),Zk=p(),Dc=o("p"),eT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
and wordpiece.`),fn.forEach(t),of=h(St),Sn=n(St,"P",{});var yi=r(Sn);nf=i(yi,"Refer to superclass "),ji=n(yi,"A",{href:!0});var yp=r(ji);rf=i(yp,"BertTokenizer"),yp.forEach(t),af=i(yi," for usage examples and documentation concerning parameters."),yi.forEach(t),St.forEach(t),Cp=h(s),os=n(s,"H2",{class:!0});var Di=r(os);Ks=n(Di,"A",{id:!0,class:!0,href:!0});var Dp=r(Ks);Nl=n(Dp,"SPAN",{});var Fp=r(Nl);$(In.$$.fragment,Fp),Fp.forEach(t),Dp.forEach(t),lf=h(Di),Ll=n(Di,"SPAN",{});var d$=r(Ll);df=i(d$,"DistilBertTokenizerFast"),d$.forEach(t),Di.forEach(t),qp=h(s),ct=n(s,"DIV",{class:!0});var mn=r(ct);$(Wn.$$.fragment,mn),cf=h(mn),Qn=n(mn,"P",{});var bh=r(Qn);pf=i(bh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Sl=n(bh,"EM",{});var c$=r(Sl);hf=i(c$,"tokenizers"),c$.forEach(t),uf=i(bh," library)."),bh.forEach(t),ff=h(mn),Js=n(mn,"P",{});var Bp=r(Js);Ci=n(Bp,"A",{href:!0});var p$=r(Ci);mf=i(p$,"DistilBertTokenizerFast"),p$.forEach(t),gf=i(Bp," is identical to "),qi=n(Bp,"A",{href:!0});var h$=r(qi);_f=i(h$,"BertTokenizerFast"),h$.forEach(t),bf=i(Bp,` and runs end-to-end tokenization: punctuation
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fh.forEach(t),nm=h(Wt),Ke=n(Wt,"DIV",{class:!0});var Qt=r(Ke);$(or.$$.fragment,Qt),rm=h(Qt),is=n(Qt,"P",{});var ul=r(is);am=i(ul,"The "),Li=n(ul,"A",{href:!0});var x$=r(Li);im=i(x$,"DistilBertForMaskedLM"),x$.forEach(t),lm=i(ul," forward method, overrides the "),Kl=n(ul,"CODE",{});var M$=r(Kl);dm=i(M$,"__call__"),M$.forEach(t),cm=i(ul," special method."),ul.forEach(t),pm=h(Qt),$(eo.$$.fragment,Qt),hm=h(Qt),$(to.$$.fragment,Qt),um=h(Qt),$(so.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),Lp=h(s),ls=n(s,"H2",{class:!0});var Bh=r(ls);oo=n(Bh,"A",{id:!0,class:!0,href:!0});var E$=r(oo);Jl=n(E$,"SPAN",{});var z$=r(Jl);$(nr.$$.fragment,z$),z$.forEach(t),E$.forEach(t),fm=h(Bh),Gl=n(Bh,"SPAN",{});var j$=r(Gl);mm=i(j$,"DistilBertForSequenceClassification"),j$.forEach(t),Bh.forEach(t),Sp=h(s),Re=n(s,"DIV",{class:!0});var Rt=r(Re);$(rr.$$.fragment,Rt),gm=h(Rt),Xl=n(Rt,"P",{});var C$=r(Xl);_m=i(C$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Vt=r(Je);$(Tr.$$.fragment,Vt),bg=h(Vt),us=n(Vt,"P",{});var gl=r(us);vg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var Y$=r(Ui);kg=i(Y$,"DistilBertForTokenClassification"),Y$.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var Z$=r(ad);$g=i(Z$,"__call__"),Z$.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Vt),$(fo.$$.fragment,Vt),Dg=h(Vt),$(mo.$$.fragment,Vt),Fg=h(Vt),$(go.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),Up=h(s),fs=n(s,"H2",{class:!0});var Ah=r(fs);_o=n(Ah,"A",{id:!0,class:!0,href:!0});var ew=r(_o);id=n(ew,"SPAN",{});var tw=r(id);$($r.$$.fragment,tw),tw.forEach(t),ew.forEach(t),Bg=h(Ah),ld=n(Ah,"SPAN",{});var sw=r(ld);xg=i(sw,"DistilBertForQuestionAnswering"),sw.forEach(t),Ah.forEach(t),Hp=h(s),Ve=n(s,"DIV",{class:!0});var Kt=r(Ve);$(wr.$$.fragment,Kt),Mg=h(Kt),ms=n(Kt,"P",{});var _l=r(ms);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh.forEach(t),Qg=h(Kt),Ge=n(Kt,"DIV",{class:!0});var Jt=r(Ge);$(Br.$$.fragment,Jt),Rg=h(Jt),gs=n(Jt,"P",{});var bl=r(gs);Ug=i(bl,"The "),Vi=n(bl,"A",{href:!0});var iw=r(Vi);Hg=i(iw,"DistilBertForQuestionAnswering"),iw.forEach(t),Vg=i(bl," forward method, overrides the "),pd=n(bl,"CODE",{});var lw=r(pd);Kg=i(lw,"__call__"),lw.forEach(t),Jg=i(bl," special method."),bl.forEach(t),Gg=h(Jt),$(bo.$$.fragment,Jt),Xg=h(Jt),$(vo.$$.fragment,Jt),Yg=h(Jt),$(ko.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Vp=h(s),_s=n(s,"H2",{class:!0});var Lh=r(_s);To=n(Lh,"A",{id:!0,class:!0,href:!0});var dw=r(To);hd=n(dw,"SPAN",{});var cw=r(hd);$(xr.$$.fragment,cw),cw.forEach(t),dw.forEach(t),Zg=h(Lh),ud=n(Lh,"SPAN",{});var pw=r(ud);e_=i(pw,"TFDistilBertModel"),pw.forEach(t),Lh.forEach(t),Kp=h(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);$(Mr.$$.fragment,$t),t_=h($t),fd=n($t,"P",{});var hw=r(fd);s_=i(hw,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),hw.forEach(t),o_=h($t),Er=n($t,"P",{});var Sh=r(Er);n_=i(Sh,"This model inherits from "),Ki=n(Sh,"A",{href:!0});var uw=r(Ki);r_=i(uw,"TFPreTrainedModel"),uw.forEach(t),a_=i(Sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Ub=h(Ft),sa=n(Ft,"P",{});var eu=r(sa);Hb=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var Hw=r(oa);Vb=i(Hw,"tf.keras.Model"),Hw.forEach(t),Kb=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Ft),$(So.$$.fragment,Ft),Gb=h(Ft),Ze=n(Ft,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Fs=n(Yt,"P",{});var wl=r(Fs);Yb=i(wl,"The "),ol=n(wl,"A",{href:!0});var Vw=r(ol);Zb=i(Vw,"TFDistilBertForTokenClassification"),Vw.forEach(t),ev=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Kw=r(zd);tv=i(Kw,"__call__"),Kw.forEach(t),sv=i(wl," special method."),wl.forEach(t),ov=h(Yt),$(Io.$$.fragment,Yt),nv=h(Yt),$(Wo.$$.fragment,Yt),rv=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Ft.forEach(t),oh=h(s),Bs=n(s,"H2",{class:!0});var tu=r(Bs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Ro);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),av=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);iv=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var Bt=r(Ie);$(aa.$$.fragment,Bt),lv=h(Bt),xs=n(Bt,"P",{});var yl=r(xs);dv=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(st),Sd=n(st,"P",{});var c2=r(Sd);Hv=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),Vv=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p2=r(Id);ga=n(p2,"A",{href:!0,rel:!0});var h2=r(ga);Kv=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u2=r(Wd);_a=n(u2,"A",{href:!0,rel:!0});var f2=r(_a);Gv=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m2=r(Qd);ba=n(m2,"A",{href:!0,rel:!0});var g2=r(ba);Yv=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _2=r(Rd);va=n(_2,"A",{href:!0,rel:!0});var b2=r(va);e1=i(b2,"Parallelization"),b2.forEach(t),_2.forEach(t),kn.forEach(t),t1=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),s1=h(Tn),zs=n(Tn,"P",{});var Fl=r(zs);o1=i(Fl,"The "),Ud=n(Fl,"CODE",{});var v2=r(Ud);n1=i(v2,"FlaxDistilBertPreTrainedModel"),v2.forEach(t),r1=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k2=r(Hd);a1=i(k2,"__call__"),k2.forEach(t),i1=i(Fl," special method."),Fl.forEach(t),l1=h(Tn),$(Go.$$.fragment,Tn),d1=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T2=r(Yo);Vd=n(T2,"SPAN",{});var $2=r(Vd);$(Ta.$$.fragment,$2),$2.forEach(t),T2.forEach(t),c1=h(iu),Kd=n(iu,"SPAN",{});var w2=r(Kd);p1=i(w2,"FlaxDistilBertForMaskedLM"),w2.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),h1=h(ot),wa=n(ot,"P",{});var lu=r(wa);u1=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y2=r(Jd);f1=i(y2,"language modeling"),y2.forEach(t),m1=i(lu," head on top."),lu.forEach(t),g1=h(ot),ya=n(ot,"P",{});var du=r(ya);_1=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D2=r(il);b1=i(D2,"FlaxPreTrainedModel"),D2.forEach(t),v1=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),k1=h(ot),Da=n(ot,"P",{});var cu=r(Da);T1=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var F2=r(Fa);$1=i(F2,"flax.linen.Module"),F2.forEach(t),w1=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),y1=h(ot),Gd=n(ot,"P",{});var B2=r(Gd);D1=i(B2,"Finally, this model supports inherent JAX features such as:"),B2.forEach(t),F1=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var x2=r(Xd);Ba=n(x2,"A",{href:!0,rel:!0});var M2=r(Ba);B1=i(M2,"Just-In-Time (JIT) compilation"),M2.forEach(t),x2.forEach(t),x1=h($n),Yd=n($n,"LI",{});var E2=r(Yd);xa=n(E2,"A",{href:!0,rel:!0});var z2=r(xa);M1=i(z2,"Automatic Differentiation"),z2.forEach(t),E2.forEach(t),E1=h($n),Zd=n($n,"LI",{});var j2=r(Zd);Ma=n(j2,"A",{href:!0,rel:!0});var C2=r(Ma);z1=i(C2,"Vectorization"),C2.forEach(t),j2.forEach(t),j1=h($n),ec=n($n,"LI",{});var q2=r(ec);Ea=n(q2,"A",{href:!0,rel:!0});var P2=r(Ea);C1=i(P2,"Parallelization"),P2.forEach(t),q2.forEach(t),$n.forEach(t),q1=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),P1=h(wn),Cs=n(wn,"P",{});var Bl=r(Cs);A1=i(Bl,"The "),tc=n(Bl,"CODE",{});var A2=r(tc);O1=i(A2,"FlaxDistilBertPreTrainedModel"),A2.forEach(t),N1=i(Bl," forward method, overrides the "),sc=n(Bl,"CODE",{});var O2=r(sc);L1=i(O2,"__call__"),O2.forEach(t),S1=i(Bl," special method."),Bl.forEach(t),I1=h(wn),$(Zo.$$.fragment,wn),W1=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N2=r(tn);oc=n(N2,"SPAN",{});var L2=r(oc);$(ja.$$.fragment,L2),L2.forEach(t),N2.forEach(t),Q1=h(pu),nc=n(pu,"SPAN",{});var S2=r(nc);R1=i(S2,"FlaxDistilBertForSequenceClassification"),S2.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),U1=h(nt),rc=n(nt,"P",{});var I2=r(rc);H1=i(I2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I2.forEach(t),V1=h(nt),qa=n(nt,"P",{});var hu=r(qa);K1=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W2=r(ll);J1=i(W2,"FlaxPreTrainedModel"),W2.forEach(t),G1=i(hu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var R2=r(ac);sk=i(R2,"Finally, this model supports inherent JAX features such as:"),R2.forEach(t),ok=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U2=r(ic);Oa=n(U2,"A",{href:!0,rel:!0});var H2=r(Oa);nk=i(H2,"Just-In-Time (JIT) compilation"),H2.forEach(t),U2.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var V2=r(lc);Na=n(V2,"A",{href:!0,rel:!0});var K2=r(Na);ak=i(K2,"Automatic Differentiation"),K2.forEach(t),V2.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var J2=r(dc);La=n(J2,"A",{href:!0,rel:!0});var G2=r(La);lk=i(G2,"Vectorization"),G2.forEach(t),J2.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var X2=r(cc);Sa=n(X2,"A",{href:!0,rel:!0});var Y2=r(Sa);ck=i(Y2,"Parallelization"),Y2.forEach(t),X2.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),hk=h(Dn),Ps=n(Dn,"P",{});var xl=r(Ps);uk=i(xl,"The "),pc=n(xl,"CODE",{});var Z2=r(pc);fk=i(Z2,"FlaxDistilBertPreTrainedModel"),Z2.forEach(t),mk=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);gk=i(ey,"__call__"),ey.forEach(t),_k=i(xl," special method."),xl.forEach(t),bk=h(Dn),$(sn.$$.fragment,Dn),vk=h(Dn),$(on.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kk=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);Tk=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),mc=n(rt,"P",{});var ny=r(mc);wk=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),ny.forEach(t),yk=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);Dk=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var ry=r(dl);Fk=i(ry,"FlaxPreTrainedModel"),ry.forEach(t),Bk=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),xk=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);Mk=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var ay=r(Ha);Ek=i(ay,"flax.linen.Module"),ay.forEach(t),zk=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jk=h(rt),gc=n(rt,"P",{});var iy=r(gc);Ck=i(iy,"Finally, this model supports inherent JAX features such as:"),iy.forEach(t),qk=h(rt),jt=n(rt,"UL",{});var Fn=r(jt);_c=n(Fn,"LI",{});var ly=r(_c);Va=n(ly,"A",{href:!0,rel:!0});var dy=r(Va);Pk=i(dy,"Just-In-Time (JIT) compilation"),dy.forEach(t),ly.forEach(t),Ak=h(Fn),bc=n(Fn,"LI",{});var cy=r(bc);Ka=n(cy,"A",{href:!0,rel:!0});var py=r(Ka);Ok=i(py,"Automatic Differentiation"),py.forEach(t),cy.forEach(t),Nk=h(Fn),vc=n(Fn,"LI",{});var hy=r(vc);Ja=n(hy,"A",{href:!0,rel:!0});var uy=r(Ja);Lk=i(uy,"Vectorization"),uy.forEach(t),hy.forEach(t),Sk=h(Fn),kc=n(Fn,"LI",{});var fy=r(kc);Ga=n(fy,"A",{href:!0,rel:!0});var my=r(Ga);Ik=i(my,"Parallelization"),my.forEach(t),fy.forEach(t),Fn.forEach(t),Wk=h(rt),vt=n(rt,"DIV",{class:!0});var Bn=r(vt);$(Xa.$$.fragment,Bn),Qk=h(Bn),Os=n(Bn,"P",{});var Ml=r(Os);Rk=i(Ml,"The "),Tc=n(Ml,"CODE",{});var gy=r(Tc);Uk=i(gy,"FlaxDistilBertPreTrainedModel"),gy.forEach(t),Hk=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _y=r($c);Vk=i(_y,"__call__"),_y.forEach(t),Kk=i(Ml," special method."),Ml.forEach(t),Jk=h(Bn),$(rn.$$.fragment,Bn),Gk=h(Bn),$(an.$$.fragment,Bn),Bn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var by=r(ln);wc=n(by,"SPAN",{});var vy=r(wc);$(Ya.$$.fragment,vy),vy.forEach(t),by.forEach(t),Xk=h(_u),yc=n(_u,"SPAN",{});var ky=r(yc);Yk=i(ky,"FlaxDistilBertForTokenClassification"),ky.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Zk=h(at),Dc=n(at,"P",{});var Ty=r(Dc);eT=i(Ty,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ty.forEach(t),tT=h(at),ei=n(at,"P",{});var bu=r(ei);sT=i(bu,"This model inherits from "),cl=n(bu,"A",{href:!0});var $y=r(cl);oT=i($y,"FlaxPreTrainedModel"),$y.forEach(t),nT=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),bu.forEach(t),rT=h(at),ti=n(at,"P",{});var vu=r(ti);aT=i(vu,"This model is also a Flax Linen "),si=n(vu,"A",{href:!0,rel:!0});var wy=r(si);iT=i(wy,"flax.linen.Module"),wy.forEach(t),lT=i(vu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),vu.forEach(t),dT=h(at),Fc=n(at,"P",{});var yy=r(Fc);cT=i(yy,"Finally, this model supports inherent JAX features such as:"),yy.forEach(t),pT=h(at),Ct=n(at,"UL",{});var xn=r(Ct);Bc=n(xn,"LI",{});var Dy=r(Bc);oi=n(Dy,"A",{href:!0,rel:!0});var Fy=r(oi);hT=i(Fy,"Just-In-Time (JIT) compilation"),Fy.forEach(t),Dy.forEach(t),uT=h(xn),xc=n(xn,"LI",{});var By=r(xc);ni=n(By,"A",{href:!0,rel:!0});var xy=r(ni);fT=i(xy,"Automatic Differentiation"),xy.forEach(t),By.forEach(t),mT=h(xn),Mc=n(xn,"LI",{});var My=r(Mc);ri=n(My,"A",{href:!0,rel:!0});var Ey=r(ri);gT=i(Ey,"Vectorization"),Ey.forEach(t),My.forEach(t),_T=h(xn),Ec=n(xn,"LI",{});var zy=r(Ec);ai=n(zy,"A",{href:!0,rel:!0});var jy=r(ai);bT=i(jy,"Parallelization"),jy.forEach(t),zy.forEach(t),xn.forEach(t),vT=h(at),kt=n(at,"DIV",{class:!0});var Mn=r(kt);$(ii.$$.fragment,Mn),kT=h(Mn),Ls=n(Mn,"P",{});var El=r(Ls);TT=i(El,"The "),zc=n(El,"CODE",{});var Cy=r(zc);$T=i(Cy,"FlaxDistilBertPreTrainedModel"),Cy.forEach(t),wT=i(El," forward method, overrides the "),jc=n(El,"CODE",{});var qy=r(jc);yT=i(qy,"__call__"),qy.forEach(t),DT=i(El," special method."),El.forEach(t),FT=h(Mn),$(dn.$$.fragment,Mn),BT=h(Mn),$(cn.$$.fragment,Mn),Mn.forEach(t),at.forEach(t),mh=h(s),Ss=n(s,"H2",{class:!0});var ku=r(Ss);pn=n(ku,"A",{id:!0,class:!0,href:!0});var Py=r(pn);Cc=n(Py,"SPAN",{});var Ay=r(Cc);$(li.$$.fragment,Ay),Ay.forEach(t),Py.forEach(t),xT=h(ku),qc=n(ku,"SPAN",{});var Oy=r(qc);MT=i(Oy,"FlaxDistilBertForQuestionAnswering"),Oy.forEach(t),ku.forEach(t),gh=h(s),qe=n(s,"DIV",{class:!0});var it=r(qe);$(di.$$.fragment,it),ET=h(it),Is=n(it,"P",{});var zl=r(Is);zT=i(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
