...
<docstring><name>class transformers.ByT5Tokenizer</name><anchor>transformers.ByT5Tokenizer</anchor><source>https://github.com/huggingface/transformers/blob/pr_15706/src/transformers/models/byt5/tokenization_byt5.py#L28</source><parameters>[{"name": "eos_token", "val": " = '</s>'"}, {"name": "unk_token", "val": " = '<unk>'"}, {"name": "pad_token", "val": " = '<pad>'"}, {"name": "extra_ids", "val": " = 125"}, {"name": "additional_special_tokens", "val": " = None"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **eos_token** (`str`, *optional*, defaults to `"&amp;lt;/s>"`) --
...
<div class="docstring">
<docstring><name>convert\_tokens\_to\_string</name><anchor>transformers.ByT5Tokenizer.convert_tokens_to_string</anchor><source>https://github.com/huggingface/transformers/blob/pr_15706/src/transformers/models/byt5/tokenization_byt5.py#L228</source><parameters>[{"name": "tokens", "val": ""}]</parameters></docstring>
Converts a sequence of tokens (string) in a single string.

</div>
<div class="docstring">
<docstring><name>create\_token\_type\_ids\_from\_sequences</name><anchor>transformers.ByT5Tokenizer.create_token_type_ids_from_sequences</anchor><source>https://github.com/huggingface/transformers/blob/pr_15706/src/transformers/models/byt5/tokenization_byt5.py#L155</source><parameters>[{"name": "token_ids_0", "val": ": typing.List[int]"}, {"name": "token_ids_1", "val": ": typing.Optional[typing.List[int]] = None"}]</parameters><paramsdesc>- **token_ids_0** (`List[int]`) --
  List of IDs.
- **token_ids_1** (`List[int]`, *optional*) --
...
<div class="docstring">
<docstring><name>get\_special\_tokens\_mask</name><anchor>transformers.ByT5Tokenizer.get_special_tokens_mask</anchor><source>https://github.com/huggingface/transformers/blob/pr_15706/src/transformers/models/byt5/tokenization_byt5.py#L117</source><parameters>[{"name": "token_ids_0", "val": ": typing.List[int]"}, {"name": "token_ids_1", "val": ": typing.Optional[typing.List[int]] = None"}, {"name": "already_has_special_tokens", "val": ": bool = False"}]</parameters><paramsdesc>- **token_ids_0** (`List[int]`) --
  List of IDs.
- **token_ids_1** (`List[int]`, *optional*) --
...
See [ByT5Tokenizer](/docs/transformers/pr_15706/en/model_doc/byt5#transformers.ByT5Tokenizer) for all details.
