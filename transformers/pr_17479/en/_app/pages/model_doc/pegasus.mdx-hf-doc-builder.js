...
first positional argument :`),H=l(),S=n("ul"),O=n("li"),Ge=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Le=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),le.forEach(t),H=c(x),S=s(x,"UL",{});var G=a(S);O=s(G,"LI",{});var J=a(O);Ge=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var Te=a(Y);ee=i(Te,"input_ids"),Te.forEach(t),Le=i(J," only and nothing else: "),U=s(J,"CODE",{});var it=a(U);Ne=i(it,"model(input_ids)"),it.forEach(t),J.forEach(t),De=c(G),I=s(G,"LI",{});var X=a(I);me=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var dt=a(de);ze=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),te=i(X," or "),K=s(X,"CODE",{});var Xe=a(K);Ue=i(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),X.forEach(t),We=c(G),W=s(G,"LI",{});var R=a(W);Be=i(R,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(R,"CODE",{});var lt=a(oe);V=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),R.forEach(t),G.forEach(t)},m(x,q){f(x,u,q),e(u,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,H,q),f(x,S,q),e(S,O),e(O,Ge),e(O,Y),e(Y,ee),e(O,Le),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,K),e(K,Ue),e(S,We),e(S,W),e(W,Be),e(W,oe),e(oe,V)},d(x){x&&t(u),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(H),x&&t(S)}}}function nk(z){let u,v,_,h,k;return{c(){u=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,u,m),e(u,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(h,d)}}}function ak(z){let u,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,H,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,K,Ue,We,W,Be,oe,V;return{c(){u=n("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),ve=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),H=l(),S=n("ul"),O=n("li"),Ge=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Le=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),K=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=l(),W=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),V=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){u=s(x,"P",{});var q=a(u);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var be=a(h);k=s(be,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(be),F=s(be,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,u,m),e(u,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(h,d)}}}function fk(z){let u,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,H,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,K,Ue,We,W,Be,oe,V,x,q,be,at,ye,Q,rt,Je,le,G,J,Te,it,X,dt,Xe,R,lt,Wo,Zd,Yd,la,el,tl,zi,fe,ca,ol,nl,pa,sl,al,ua,rl,il,Bo,dl,Vo,ll,cl,pl,At,Ro,ul,hl,Ho,ml,fl,Fi,ct,It,ha,Ko,gl,ma,_l,qi,Ze,Gt,Qo,kl,vl,Jo,bl,yl,Tl,fa,wl,Pl,ga,$l,Ei,pt,Lt,_a,Xo,xl,ka,zl,Ci,ge,va,ba,Fl,ql,ya,Es,El,Cs,Cl,Ml,Zo,Ta,jl,Sl,ut,wa,Ol,Al,Pa,Il,Gl,Yo,Ll,$a,Nl,Dl,Ul,xa,Ve,Wl,za,Bl,Vl,Fa,Rl,Hl,qa,Kl,Ql,Jl,Ea,ht,Xl,en,Zl,Yl,Ca,ec,tc,Mi,mt,Nt,Ma,tn,oc,ja,nc,ji,on,Si,ft,Dt,Sa,nn,sc,Oa,ac,Oi,we,sn,rc,gt,ic,Ms,dc,lc,an,cc,pc,uc,_t,hc,js,mc,fc,Ss,gc,_c,kc,Ut,Ai,kt,Wt,Aa,rn,vc,Ia,bc,Ii,Bt,yc,Ga,Tc,wc,Gi,B,dn,Pc,ln,$c,cn,xc,zc,Fc,pn,qc,Os,Ec,Cc,Mc,Fe,un,jc,hn,Sc,La,Oc,Ac,Ic,mn,As,Gc,Na,Lc,Nc,fn,Dc,Da,Uc,Wc,Bc,Ua,Vc,Rc,Vt,gn,Hc,Wa,Kc,Qc,Rt,_n,Jc,Ba,Xc,Zc,Ht,kn,Yc,Va,ep,Li,vt,Kt,Ra,vn,tp,Ha,op,Ni,ce,bn,np,bt,sp,Ka,ap,rp,yn,ip,dp,lp,Tn,cp,Is,pp,up,hp,Ye,wn,mp,Qa,fp,gp,Pn,Gs,_p,Ja,kp,vp,$n,bp,Xa,yp,Tp,wp,Qt,xn,Pp,Za,$p,Di,yt,Jt,Ya,zn,xp,er,zp,Ui,Pe,Fn,Fp,qn,qp,Ls,Ep,Cp,Mp,En,jp,Cn,Sp,Op,Ap,qe,Mn,Ip,Tt,Gp,Ns,Lp,Np,tr,Dp,Up,Wp,Xt,Bp,Zt,Wi,wt,Yt,or,jn,Vp,nr,Rp,Bi,$e,Sn,Hp,On,Kp,Ds,Qp,Jp,Xp,An,Zp,In,Yp,eu,tu,Ee,Gn,ou,Pt,nu,Us,su,au,sr,ru,iu,du,eo,lu,to,Vi,$t,oo,ar,Ln,cu,rr,pu,Ri,xt,Nn,uu,no,Dn,hu,so,Hi,zt,ao,ir,Un,mu,dr,fu,Ki,pe,Wn,gu,Bn,_u,Ws,ku,vu,bu,Vn,yu,Rn,Tu,wu,Pu,ro,$u,Ce,Hn,xu,Ft,zu,Bs,Fu,qu,lr,Eu,Cu,Mu,io,ju,lo,Qi,qt,co,cr,Kn,Su,pr,Ou,Ji,ue,Qn,Au,Jn,Iu,Vs,Gu,Lu,Nu,Xn,Du,Zn,Uu,Wu,Bu,po,Vu,Me,Yn,Ru,Et,Hu,Rs,Ku,Qu,ur,Ju,Xu,Zu,uo,Yu,ho,Xi,Ct,mo,hr,es,eh,mr,th,Zi,L,ts,oh,os,nh,Hs,sh,ah,rh,ns,ih,ss,dh,lh,ch,fr,ph,uh,Re,gr,as,hh,mh,_r,rs,fh,gh,kr,is,_h,kh,vr,ds,vh,bh,je,ls,yh,Mt,Th,br,wh,Ph,yr,$h,xh,zh,fo,Fh,go,qh,_o,cs,Eh,ko,Ch,vo,ps,Mh,bo,Yi,jt,yo,Tr,us,jh,wr,Sh,ed,N,hs,Oh,ms,Ah,Ks,Ih,Gh,Lh,fs,Nh,gs,Dh,Uh,Wh,Pr,Bh,Vh,He,$r,_s,Rh,Hh,xr,ks,Kh,Qh,zr,vs,Jh,Xh,Fr,bs,Zh,Yh,C,ys,em,St,tm,qr,om,nm,Er,sm,am,rm,To,im,Cr,dm,lm,Mr,jr,Sr,Or,cm,pm,Ar,Ir,Gr,Lr,um,hm,Nr,Dr,Ur,Wr,mm,fm,Br,Vr,Ts,wo,Po,Rr,ws,gm,Hr,_m,km,Kr,vm,bm,Qr,ym,Tm,Jr,Xr,Zr,Yr,wm,Pm,ei,ti,oi,ni,$m,xm,si,ai,ri,ii,zm,Fm,di,li,ci,pi,qm,Em,$o,Ps,Cm,xo,Mm,zo,$s,jm,Fo,td;return d=new Z({}),H=new Z({}),Te=new Z({}),Ko=new Z({}),Xo=new Z({}),tn=new Z({}),on=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/tokenization_pegasus.py#L258",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_pegasus.py#L1190",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17479/en/model_doc/pegasus#transformers.PegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_pegasus.py#L1357",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_pegasus.py#L1549",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1208",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17479/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1285"}}),po=new Uo({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),Yn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17479/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_17479/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17479/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1318",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
`}}),bo=new Ke({props:{anchor:"transformers.FlaxPegasusModel.decode.example",$$slots:{default:[pk]},$$scope:{ctx:z}}}),us=new Z({}),hs=new M({props:{name:"class transformers.FlaxPegasusForConditionalGeneration",anchor:"transformers.FlaxPegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17479/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17479/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
on the XSUM dataset. Data download instructions at `),Jo=n("a"),bl=r("examples/pytorch/summarization/"),yl=r("."),Tl=l(),fa=n("li"),wl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=l(),ga=n("li"),$l=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Ei=l(),pt=n("h2"),Lt=n("a"),_a=n("span"),b(Xo.$$.fragment),xl=l(),ka=n("span"),zl=r("Implementation Notes"),Ci=l(),ge=n("ul"),va=n("li"),ba=n("p"),Fl=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=l(),ya=n("li"),Es=n("p"),El=r("The implementation is completely inherited from "),Cs=n("a"),Cl=r("BartForConditionalGeneration"),Ml=l(),Zo=n("li"),Ta=n("p"),jl=r("Some key configuration differences:"),Sl=l(),ut=n("ul"),wa=n("li"),Ol=r("static, sinusoidal position embeddings"),Al=l(),Pa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Gl=l(),Yo=n("li"),Ll=r("more beams are used ("),$a=n("code"),Nl=r("num_beams=8"),Dl=r(")"),Ul=l(),xa=n("li"),Ve=n("p"),Wl=r("All pretrained pegasus checkpoints are the same besides three attributes: "),za=n("code"),Bl=r("tokenizer.model_max_length"),Vl=r(` (maximum
...
separator.`),Rc=l(),Vt=n("div"),b(gn.$$.fragment),Hc=l(),Wa=n("p"),Kc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),Rt=n("div"),b(_n.$$.fragment),Jc=l(),Ba=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),Ht=n("div"),b(kn.$$.fragment),Yc=l(),Va=n("p"),ep=r("Just EOS"),Li=l(),vt=n("h2"),Kt=n("a"),Ra=n("span"),b(vn.$$.fragment),tp=l(),Ha=n("span"),op=r("PegasusTokenizerFast"),Ni=l(),ce=n("div"),b(bn.$$.fragment),np=l(),bt=n("p"),sp=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ka=n("em"),ap=r("tokenizers"),rp=r(` library). Based on
...
This model inherits from `),Ls=n("a"),Ep=r("PreTrainedModel"),Cp=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Ap=l(),qe=n("div"),b(Mn.$$.fragment),Ip=l(),Tt=n("p"),Gp=r("The "),Ns=n("a"),Lp=r("PegasusModel"),Np=r(" forward method, overrides the "),tr=n("code"),Dp=r("__call__"),Up=r(" special method."),Wp=l(),b(Xt.$$.fragment),Bp=l(),b(Zt.$$.fragment),Wi=l(),wt=n("h2"),Yt=n("a"),or=n("span"),b(jn.$$.fragment),Vp=l(),nr=n("span"),Rp=r("PegasusForConditionalGeneration"),Bi=l(),$e=n("div"),b(Sn.$$.fragment),Hp=l(),On=n("p"),Kp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
This model inherits from `),Vs=n("a"),Gu=r("TFPreTrainedModel"),Lu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu=l(),Xn=n("p"),Du=r("This model is also a "),Zn=n("a"),Uu=r("tf.keras.Model"),Wu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu=l(),b(po.$$.fragment),Vu=l(),Me=n("div"),b(Yn.$$.fragment),Ru=l(),Et=n("p"),Hu=r("The "),Rs=n("a"),Ku=r("TFPegasusForConditionalGeneration"),Qu=r(" forward method, overrides the "),ur=n("code"),Ju=r("__call__"),Xu=r(" special method."),Zu=l(),b(uo.$$.fragment),Yu=l(),b(ho.$$.fragment),Xi=l(),Ct=n("h2"),mo=n("a"),hr=n("span"),b(es.$$.fragment),eh=l(),mr=n("span"),th=r("FlaxPegasusModel"),Zi=l(),L=n("div"),b(ts.$$.fragment),oh=l(),os=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Ks=n("a"),Ih=r("FlaxPreTrainedModel"),Gh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
This model inherits from `),Ls=s(xd,"A",{href:!0});var ng=a(Ls);Ep=i(ng,"PreTrainedModel"),ng.forEach(t),Cp=i(xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed.forEach(t),tu=c(Oo),Ee=s(Oo,"DIV",{class:!0});var Ao=a(Ee);y(Gn.$$.fragment,Ao),ou=c(Ao),Pt=s(Ao,"P",{});var sa=a(Pt);nu=i(sa,"The "),Us=s(sa,"A",{href:!0});var ug=a(Us);su=i(ug,"PegasusForConditionalGeneration"),ug.forEach(t),au=i(sa," forward method, overrides the "),sr=s(sa,"CODE",{});var hg=a(sr);ru=i(hg,"__call__"),hg.forEach(t),iu=i(sa," special method."),sa.forEach(t),du=c(Ao),y(eo.$$.fragment,Ao),lu=c(Ao),y(to.$$.fragment,Ao),Ao.forEach(t),Oo.forEach(t),Vi=c(o),$t=s(o,"H2",{class:!0});var Cd=a($t);oo=s(Cd,"A",{id:!0,class:!0,href:!0});var mg=a(oo);ar=s(mg,"SPAN",{});var fg=a(ar);y(Ln.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cu=c(Cd),rr=s(Cd,"SPAN",{});var gg=a(rr);pu=i(gg,"PegasusForCausalLM"),gg.forEach(t),Cd.forEach(t),Ri=c(o),xt=s(o,"DIV",{class:!0});var Md=a(xt);y(Nn.$$.fragment,Md),uu=c(Md),no=s(Md,"DIV",{class:!0});var jd=a(no);y(Dn.$$.fragment,jd),hu=c(jd),y(so.$$.fragment,jd),jd.forEach(t),Md.forEach(t),Hi=c(o),zt=s(o,"H2",{class:!0});var Sd=a(zt);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var _g=a(ao);ir=s(_g,"SPAN",{});var kg=a(ir);y(Un.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mu=c(Sd),dr=s(Sd,"SPAN",{});var vg=a(dr);fu=i(vg,"TFPegasusModel"),vg.forEach(t),Sd.forEach(t),Ki=c(o),pe=s(o,"DIV",{class:!0});var nt=a(pe);y(Wn.$$.fragment,nt),gu=c(nt),Bn=s(nt,"P",{});var Od=a(Bn);_u=i(Od,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Vs=s(Gd,"A",{href:!0});var zg=a(Vs);Gu=i(zg,"TFPreTrainedModel"),zg.forEach(t),Lu=i(Gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
