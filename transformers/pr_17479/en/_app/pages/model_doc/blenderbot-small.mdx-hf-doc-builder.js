import{S as dh,i as ih,s as ch,e as n,k as i,w as v,t as s,M as ph,c as a,d as o,m as c,a as r,x as y,h as l,b as m,G as e,g as _,y as T,q as w,o as S,B as $,v as mh,L as Xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Fn}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
`),se=a(oe,"CODE",{});var ce=r(se);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=r(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ye=r(X);qe=l(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ye,"CODE",{});var Te=r(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ye.forEach(o),Y.forEach(o)},m(x,F){_(x,p,F),e(p,k),_(x,f,F),_(x,u,F),e(u,b),e(b,d),e(u,h),e(u,q),e(q,Ce),_(x,ue,F),_(x,B,F),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,V,F),_(x,Q,F),e(Q,Ie),_(x,Z,F),_(x,j,F),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,re),e(j,N),e(N,ke),e(N,se),e(se,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,qe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(V),x&&o(Q),x&&o(Z),x&&o(j)}}}function vh(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Th(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,qe,H,De;return{c(){p=n("p"),k=s("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),q=n("li"),Ce=s("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=s("This second option is useful when using "),W=n("code"),Oe=s("tf.keras.Model.fit"),Pe=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Le=s("model(inputs)"),Ne=s("."),V=i(),Q=n("p"),Ie=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=s("a single Tensor with "),ae=n("code"),Be=s("input_ids"),J=s(" only and nothing else: "),D=n("code"),be=s("model(input_ids)"),re=i(),N=n("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=n("code"),ze=s("model([input_ids, attention_mask])"),ee=s(" or "),le=n("code"),de=s("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var F=r(p);k=l(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),f=c(x),u=a(x,"UL",{});var ie=r(u);b=a(ie,"LI",{});var Ze=r(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),q=a(ie,"LI",{});var Re=r(q);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=r(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=r(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
first positional argument :`),oo.forEach(o),Z=c(x),j=a(x,"UL",{});var Y=r(j);L=a(Y,"LI",{});var G=r(L);he=l(G,"a single Tensor with "),ae=a(G,"CODE",{});var to=r(ae);Be=l(to,"input_ids"),to.forEach(o),J=l(G," only and nothing else: "),D=a(G,"CODE",{});var no=r(D);be=l(no,"model(input_ids)"),no.forEach(o),G.forEach(o),re=c(Y),N=a(Y,"LI",{});var oe=r(N);ke=l(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=a(oe,"CODE",{});var ce=r(se);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=r(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ye=r(X);qe=l(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ye,"CODE",{});var Te=r(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ye.forEach(o),Y.forEach(o)},m(x,F){_(x,p,F),e(p,k),_(x,f,F),_(x,u,F),e(u,b),e(b,d),e(u,h),e(u,q),e(q,Ce),_(x,ue,F),_(x,B,F),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,V,F),_(x,Q,F),e(Q,Ie),_(x,Z,F),_(x,j,F),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,re),e(j,N),e(N,ke),e(N,se),e(se,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,qe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(V),x&&o(Q),x&&o(Z),x&&o(j)}}}function wh(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Fh(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,qe,H,De,x,F,ie,Ze,Re,O,eo,ve,oo,Y,G,to,no,oe,ce,fe,ye,Te,ml,sa,ul,cs,we,ut,hl,ao,fl,En,_l,gl,ht,bl,kl,vl,ro,yl,Mn,Tl,wl,Cn,Sl,$l,xl,wo,ps,so,So,la,ft,Bl,da,zl,ms,U,_t,ql,ia,Fl,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,$o,kt,Dl,lo,Gl,ma,Ul,Wl,ua,Rl,Hl,Kl,Ke,vt,Vl,On,Ql,Pn,Jl,Xl,ha,Yl,Zl,Ln,yt,us,io,xo,fa,Tt,ed,_a,od,hs,Ge,wt,td,St,nd,ga,ad,rd,sd,Bo,$t,ld,ba,dd,fs,co,zo,ka,xt,id,va,cd,_s,Se,Bt,pd,zt,md,Nn,ud,hd,fd,qt,_d,Ft,gd,bd,kd,Fe,Et,vd,po,yd,In,Td,wd,ya,Sd,$d,xd,qo,Bd,Fo,gs,mo,Eo,Ta,Mt,zd,wa,qd,bs,$e,Ct,Fd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,uo,Ad,Dn,Dd,Gd,Sa,Ud,Wd,Rd,Mo,Hd,Co,ks,ho,jo,$a,Nt,Kd,xa,Vd,vs,fo,It,Qd,Oo,At,Jd,Po,ys,_o,Lo,Ba,Dt,Xd,za,Yd,Ts,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,ri,si,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,qa,ui,hi,fi,Io,_i,Ao,ws,bo,Do,Fa,Kt,gi,Ea,bi,Ss,me,Vt,ki,Qt,vi,Wn,yi,Ti,wi,Jt,Si,Xt,$i,xi,Bi,Go,zi,P,Yt,qi,ko,Fi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Va,Zt,Ri,Qa,Hi,Ki,Vi,Ja,Xa,Ya,Za,Qi,$s,vo,Wo,er,en,Ji,or,Xi,xs,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,rc,sc,tr,lc,dc,Ue,nr,rn,ic,cc,ar,sn,pc,mc,rr,ln,uc,hc,sr,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Vo,vc,Qo,mn,yc,Jo,Bs,yo,Xo,lr,un,Tc,dr,wc,zs,A,hn,Sc,fn,$c,Kn,xc,Bc,zc,_n,qc,gn,Fc,Ec,Mc,ir,Cc,jc,We,cr,bn,Oc,Pc,pr,kn,Lc,Nc,mr,vn,Ic,Ac,ur,yn,Dc,Gc,E,Tn,Uc,To,Wc,hr,Rc,Hc,fr,Kc,Vc,Qc,Yo,Jc,_r,Xc,Yc,gr,br,kr,vr,Zc,ep,yr,Tr,wr,Sr,op,tp,$r,xr,Br,zr,np,ap,qr,Fr,wn,Zo,et,Er,Sn,rp,Mr,sp,lp,Cr,dp,ip,jr,cp,pp,Or,Pr,Lr,Nr,mp,up,Ir,Ar,Dr,Gr,hp,fp,Ur,Wr,Rr,Hr,_p,gp,Kr,Vr,Qr,Jr,bp,kp,ot,$n,vp,tt,yp,nt,xn,Tp,at,qs;return d=new xe({}),re=new xe({}),Te=new xe({}),ut=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/tokenization_utils.py#L845",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L98",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17479/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1251",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1156",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1266",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L972",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1035",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17479/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17479/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1307",returnDescription:`
<p>A <a
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[qh]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),v(d.$$.fragment),h=i(),q=n("span"),Ce=s("Blenderbot Small"),ue=i(),B=n("p"),je=s("Note that "),W=n("a"),Oe=s("BlenderbotSmallModel"),Pe=s(` and
...
documentation from `),Cn=n("a"),Sl=s("PretrainedConfig"),$l=s(" for more information."),xl=i(),v(wo.$$.fragment),ps=i(),so=n("h2"),So=n("a"),la=n("span"),v(ft.$$.fragment),Bl=i(),da=n("span"),zl=s("BlenderbotSmallTokenizer"),ms=i(),U=n("div"),v(_t.$$.fragment),ql=i(),ia=n("p"),Fl=s("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=s("This tokenizer inherits from "),jn=n("a"),Cl=s("PreTrainedTokenizer"),jl=s(` which contains most of the main methods. Users should refer to
...
adding special tokens.`),Nl=i(),pa=n("p"),Il=s("This implementation does not add special tokens and this method should be overridden in a subclass."),Al=i(),$o=n("div"),v(kt.$$.fragment),Dl=i(),lo=n("p"),Gl=s(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
IDs?`),Xl=i(),ha=n("p"),Yl=s("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),v(yt.$$.fragment),us=i(),io=n("h2"),xo=n("a"),fa=n("span"),v(Tt.$$.fragment),ed=i(),_a=n("span"),od=s("BlenderbotSmallTokenizerFast"),hs=i(),Ge=n("div"),v(wt.$$.fragment),td=i(),St=n("p"),nd=s("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=s("tokenizers"),rd=s(" library)."),sd=i(),Bo=n("div"),v($t.$$.fragment),ld=i(),ba=n("p"),dd=s(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fs=i(),co=n("h2"),zo=n("a"),ka=n("span"),v(xt.$$.fragment),id=i(),va=n("span"),cd=s("BlenderbotSmallModel"),_s=i(),Se=n("div"),v(Bt.$$.fragment),pd=i(),zt=n("p"),md=s(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),kd=i(),Fe=n("div"),v(Et.$$.fragment),vd=i(),po=n("p"),yd=s("The "),In=n("a"),Td=s("BlenderbotSmallModel"),wd=s(" forward method, overrides the "),ya=n("code"),Sd=s("__call__"),$d=s(" special method."),xd=i(),v(qo.$$.fragment),Bd=i(),v(Fo.$$.fragment),gs=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),v(Mt.$$.fragment),zd=i(),wa=n("span"),qd=s("BlenderbotSmallForConditionalGeneration"),bs=i(),$e=n("div"),v(Ct.$$.fragment),Fd=i(),jt=n("p"),Ed=s(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),v(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=s("The "),Dn=n("a"),Dd=s("BlenderbotSmallForConditionalGeneration"),Gd=s(" forward method, overrides the "),Sa=n("code"),Ud=s("__call__"),Wd=s(" special method."),Rd=i(),v(Mo.$$.fragment),Hd=i(),v(Co.$$.fragment),ks=i(),ho=n("h2"),jo=n("a"),$a=n("span"),v(Nt.$$.fragment),Kd=i(),xa=n("span"),Vd=s("BlenderbotSmallForCausalLM"),vs=i(),fo=n("div"),v(It.$$.fragment),Qd=i(),Oo=n("div"),v(At.$$.fragment),Jd=i(),v(Po.$$.fragment),ys=i(),_o=n("h2"),Lo=n("a"),Ba=n("span"),v(Dt.$$.fragment),Xd=i(),za=n("span"),Yd=s("TFBlenderbotSmallModel"),Ts=i(),pe=n("div"),v(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=s(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
behavior.`),li=i(),v(No.$$.fragment),di=i(),Me=n("div"),v(Ht.$$.fragment),ii=i(),go=n("p"),ci=s("The "),Un=n("a"),pi=s("TFBlenderbotSmallModel"),mi=s(" forward method, overrides the "),qa=n("code"),ui=s("__call__"),hi=s(" special method."),fi=i(),v(Io.$$.fragment),_i=i(),v(Ao.$$.fragment),ws=i(),bo=n("h2"),Do=n("a"),Fa=n("span"),v(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=s("TFBlenderbotSmallForConditionalGeneration"),Ss=i(),me=n("div"),v(Vt.$$.fragment),ki=i(),Qt=n("p"),vi=s(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),ap=i(),qr=n("blockquote"),Fr=n("blockquote"),wn=n("blockquote"),Zo=n("h1"),et=n("a"),Er=n("span"),v(Sn.$$.fragment),rp=i(),Mr=n("span"),sp=s("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),lp=i(),Cr=n("p"),dp=s("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),ip=i(),jr=n("p"),cp=s("Mask filling example:"),pp=i(),Or=n("blockquote"),Pr=n("blockquote"),Lr=n("blockquote"),Nr=n("p"),mp=s(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Kr=n("blockquote"),Vr=n("blockquote"),Qr=n("blockquote"),Jr=n("p"),bp=s("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),v($n.$$.fragment),vp=i(),v(tt.$$.fragment),yp=i(),nt=n("div"),v(xn.$$.fragment),Tp=i(),v(at.$$.fragment),this.h()},l(t){const g=ph('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var Bn=r(f);u=a(Bn,"A",{id:!0,class:!0,href:!0});var Xr=r(u);b=a(Xr,"SPAN",{});var Yr=r(b);y(d.$$.fragment,Yr),Yr.forEach(o),Xr.forEach(o),h=c(Bn),q=a(Bn,"SPAN",{});var Zr=r(q);Ce=l(Zr,"Blenderbot Small"),Zr.forEach(o),Bn.forEach(o),ue=c(t),B=a(t,"P",{});var _e=r(B);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var es=r(W);Oe=l(es,"BlenderbotSmallModel"),es.forEach(o),Pe=l(_e,` and
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),$p.forEach(o),Sp.forEach(o),Re=c(t),O=a(t,"P",{});var Vn=r(O);eo=l(Vn,"This model was contributed by "),ve=a(Vn,"A",{href:!0,rel:!0});var xp=r(ve);oo=l(xp,"patrickvonplaten"),xp.forEach(o),Y=l(Vn,`. The authors\u2019 code can be
found `),G=a(Vn,"A",{href:!0,rel:!0});var Bp=r(G);to=l(Bp,"here"),Bp.forEach(o),no=l(Vn," ."),Vn.forEach(o),oe=c(t),ce=a(t,"H2",{class:!0});var Fs=r(ce);fe=a(Fs,"A",{id:!0,class:!0,href:!0});var zp=r(fe);ye=a(zp,"SPAN",{});var qp=r(ye);y(Te.$$.fragment,qp),qp.forEach(o),zp.forEach(o),ml=c(Fs),sa=a(Fs,"SPAN",{});var Fp=r(sa);ul=l(Fp,"BlenderbotSmallConfig"),Fp.forEach(o),Fs.forEach(o),cs=c(t),we=a(t,"DIV",{class:!0});var rt=r(we);y(ut.$$.fragment,rt),hl=c(rt),ao=a(rt,"P",{});var Qn=r(ao);fl=l(Qn,"This is the configuration class to store the configuration of a "),En=a(Qn,"A",{href:!0});var Ep=r(En);_l=l(Ep,"BlenderbotSmallModel"),Ep.forEach(o),gl=l(Qn,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
...
documentation from `),Cn=a(Jn,"A",{href:!0});var jp=r(Cn);Sl=l(jp,"PretrainedConfig"),jp.forEach(o),$l=l(Jn," for more information."),Jn.forEach(o),xl=c(rt),y(wo.$$.fragment,rt),rt.forEach(o),ps=c(t),so=a(t,"H2",{class:!0});var Es=r(so);So=a(Es,"A",{id:!0,class:!0,href:!0});var Op=r(So);la=a(Op,"SPAN",{});var Pp=r(la);y(ft.$$.fragment,Pp),Pp.forEach(o),Op.forEach(o),Bl=c(Es),da=a(Es,"SPAN",{});var Lp=r(da);zl=l(Lp,"BlenderbotSmallTokenizer"),Lp.forEach(o),Es.forEach(o),ms=c(t),U=a(t,"DIV",{class:!0});var ge=r(U);y(_t.$$.fragment,ge),ql=c(ge),ia=a(ge,"P",{});var Np=r(ia);Fl=l(Np,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),Np.forEach(o),El=c(ge),gt=a(ge,"P",{});var Ms=r(gt);Ml=l(Ms,"This tokenizer inherits from "),jn=a(Ms,"A",{href:!0});var Ip=r(jn);Cl=l(Ip,"PreTrainedTokenizer"),Ip.forEach(o),jl=l(Ms,` which contains most of the main methods. Users should refer to
...
adding special tokens.`),Ap.forEach(o),Nl=c(Xn),pa=a(Xn,"P",{});var Dp=r(pa);Il=l(Dp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Dp.forEach(o),Xn.forEach(o),Al=c(ge),$o=a(ge,"DIV",{class:!0});var Cs=r($o);y(kt.$$.fragment,Cs),Dl=c(Cs),lo=a(Cs,"P",{});var Yn=r(lo);Gl=l(Yn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(o),kd=c(st),Fe=a(st,"DIV",{class:!0});var lt=r(Fe);y(Et.$$.fragment,lt),vd=c(lt),po=a(lt,"P",{});var oa=r(po);yd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=r(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),ya=a(oa,"CODE",{});var am=r(ya);Sd=l(am,"__call__"),am.forEach(o),$d=l(oa," special method."),oa.forEach(o),xd=c(lt),y(qo.$$.fragment,lt),Bd=c(lt),y(Fo.$$.fragment,lt),lt.forEach(o),st.forEach(o),gs=c(t),mo=a(t,"H2",{class:!0});var As=r(mo);Eo=a(As,"A",{id:!0,class:!0,href:!0});var rm=r(Eo);Ta=a(rm,"SPAN",{});var sm=r(Ta);y(Mt.$$.fragment,sm),sm.forEach(o),rm.forEach(o),zd=c(As),wa=a(As,"SPAN",{});var lm=r(wa);qd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),As.forEach(o),bs=c(t),$e=a(t,"DIV",{class:!0});var dt=r($e);y(Ct.$$.fragment,dt),Fd=c(dt),jt=a(dt,"P",{});var Ds=r(jt);Ed=l(Ds,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gs.forEach(o),Nd=c(dt),Ee=a(dt,"DIV",{class:!0});var it=r(Ee);y(Lt.$$.fragment,it),Id=c(it),uo=a(it,"P",{});var ta=r(uo);Ad=l(ta,"The "),Dn=a(ta,"A",{href:!0});var cm=r(Dn);Dd=l(cm,"BlenderbotSmallForConditionalGeneration"),cm.forEach(o),Gd=l(ta," forward method, overrides the "),Sa=a(ta,"CODE",{});var pm=r(Sa);Ud=l(pm,"__call__"),pm.forEach(o),Wd=l(ta," special method."),ta.forEach(o),Rd=c(it),y(Mo.$$.fragment,it),Hd=c(it),y(Co.$$.fragment,it),it.forEach(o),dt.forEach(o),ks=c(t),ho=a(t,"H2",{class:!0});var Us=r(ho);jo=a(Us,"A",{id:!0,class:!0,href:!0});var mm=r(jo);$a=a(mm,"SPAN",{});var um=r($a);y(Nt.$$.fragment,um),um.forEach(o),mm.forEach(o),Kd=c(Us),xa=a(Us,"SPAN",{});var hm=r(xa);Vd=l(hm,"BlenderbotSmallForCausalLM"),hm.forEach(o),Us.forEach(o),vs=c(t),fo=a(t,"DIV",{class:!0});var Ws=r(fo);y(It.$$.fragment,Ws),Qd=c(Ws),Oo=a(Ws,"DIV",{class:!0});var Rs=r(Oo);y(At.$$.fragment,Rs),Jd=c(Rs),y(Po.$$.fragment,Rs),Rs.forEach(o),Ws.forEach(o),ys=c(t),_o=a(t,"H2",{class:!0});var Hs=r(_o);Lo=a(Hs,"A",{id:!0,class:!0,href:!0});var fm=r(Lo);Ba=a(fm,"SPAN",{});var _m=r(Ba);y(Dt.$$.fragment,_m),_m.forEach(o),fm.forEach(o),Xd=c(Hs),za=a(Hs,"SPAN",{});var gm=r(za);Yd=l(gm,"TFBlenderbotSmallModel"),gm.forEach(o),Hs.forEach(o),Ts=c(t),pe=a(t,"DIV",{class:!0});var Ve=r(pe);y(Gt.$$.fragment,Ve),Zd=c(Ve),Ut=a(Ve,"P",{});var Ks=r(Ut);ei=l(Ks,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vs.forEach(o),li=c(Ve),y(No.$$.fragment,Ve),di=c(Ve),Me=a(Ve,"DIV",{class:!0});var ct=r(Me);y(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=r(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var vm=r(Un);pi=l(vm,"TFBlenderbotSmallModel"),vm.forEach(o),mi=l(na," forward method, overrides the "),qa=a(na,"CODE",{});var ym=r(qa);ui=l(ym,"__call__"),ym.forEach(o),hi=l(na," special method."),na.forEach(o),fi=c(ct),y(Io.$$.fragment,ct),_i=c(ct),y(Ao.$$.fragment,ct),ct.forEach(o),Ve.forEach(o),ws=c(t),bo=a(t,"H2",{class:!0});var Qs=r(bo);Do=a(Qs,"A",{id:!0,class:!0,href:!0});var Tm=r(Do);Fa=a(Tm,"SPAN",{});var wm=r(Fa);y(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Qs),Ea=a(Qs,"SPAN",{});var Sm=r(Ea);bi=l(Sm,"TFBlenderbotSmallForConditionalGeneration"),Sm.forEach(o),Qs.forEach(o),Ss=c(t),me=a(t,"DIV",{class:!0});var Qe=r(me);y(Vt.$$.fragment,Qe),ki=c(Qe),Qt=a(Qe,"P",{});var Js=r(Qt);vi=l(Js,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
This model inherits from `),Wn=a(Js,"A",{href:!0});var $m=r(Wn);yi=l($m,"TFPreTrainedModel"),$m.forEach(o),Ti=l(Js,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
