import{S as zx,i as qx,s as Cx,e as n,k as c,w as T,t as r,M as jx,c as s,d as t,m as p,a,x as y,h as i,b as u,F as e,g as b,y as w,q as $,o as M,B as F,v as Xx,L as le}from"../../chunks/vendor-6b77c823.js";import{T as $e}from"../../chunks/Tip-39098574.js";import{D as X}from"../../chunks/Docstring-1088f2fb.js";import{C as de}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Me}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as ie}from"../../chunks/ExampleCodeBlock-5212b321.js";function Px(x){let d,g,h,m,_;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),_=r(`
...
<span class="hljs-number">0.1</span>`}}),{c(){T(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){w(d,h,m),g=!0},p:le,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function Wx(x){let d,g,h,m,_;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),_=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var f=a(d);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(f,"CODE",{});var R=a(h);m=i(R,"Module"),R.forEach(t),_=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){b(l,d,f),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function Bx(x){let d,g,h,m,_;return m=new de({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),g=r("Example:"),h=c(),T(m.$$.fragment)},l(l){d=s(l,"P",{});var f=a(d);g=i(f,"Example:"),f.forEach(t),h=p(l),y(m.$$.fragment,l)},m(l,f){b(l,d,f),e(d,g),b(l,h,f),w(m,l,f),_=!0},p:le,i(l){_||($(m.$$.fragment,l),_=!0)},o(l){M(m.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(h),F(m,l)}}}function aR(x){let d,g,h,m,_,l,f,R,ue,J,E,Y,D,ee,fe,S,ge,ce,V,P,te,K,z,C,se,U,pe,ae,W,_e,he,q,be,B,Z,oe,Q,re,ke,A,ve,I,Te;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),R=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),E=n("p"),Y=r("This second option is useful when using "),D=n("code"),ee=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),ce=r("."),V=c(),P=n("p"),te=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=c(),z=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),pe=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),he=c(),q=n("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Z=r("model([input_ids, attention_mask])"),oe=r(" or "),Q=n("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),ke=c(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),I=n("code"),Te=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var L=a(d);g=i(L,"TF 2.0 models accepts two formats as inputs:"),L.forEach(t),h=p(v),m=s(v,"UL",{});var G=a(m);_=s(G,"LI",{});var xe=a(_);l=i(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),f=p(G),R=s(G,"LI",{});var me=a(R);ue=i(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),G.forEach(t),J=p(v),E=s(v,"P",{});var O=a(E);Y=i(O,"This second option is useful when using "),D=s(O,"CODE",{});var we=a(D);ee=i(we,"tf.keras.Model.fit"),we.forEach(t),fe=i(O,` method which currently requires having all the
...
<span class="hljs-number">0.1</span>`}}),{c(){T(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){w(d,h,m),g=!0},p:le,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function dR(x){let d,g,h,m,_,l,f,R,ue,J,E,Y,D,ee,fe,S,ge,ce,V,P,te,K,z,C,se,U,pe,ae,W,_e,he,q,be,B,Z,oe,Q,re,ke,A,ve,I,Te;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),R=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),E=n("p"),Y=r("This second option is useful when using "),D=n("code"),ee=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),ce=r("."),V=c(),P=n("p"),te=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=c(),z=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),pe=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),he=c(),q=n("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Z=r("model([input_ids, attention_mask])"),oe=r(" or "),Q=n("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),ke=c(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),I=n("code"),Te=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var L=a(d);g=i(L,"TF 2.0 models accepts two formats as inputs:"),L.forEach(t),h=p(v),m=s(v,"UL",{});var G=a(m);_=s(G,"LI",{});var xe=a(_);l=i(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),f=p(G),R=s(G,"LI",{});var me=a(R);ue=i(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),G.forEach(t),J=p(v),E=s(v,"P",{});var O=a(E);Y=i(O,"This second option is useful when using "),D=s(O,"CODE",{});var we=a(D);ee=i(we,"tf.keras.Model.fit"),we.forEach(t),fe=i(O,` method which currently requires having all the
...
<span class="hljs-number">0.08</span>`}}),{c(){T(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){w(d,h,m),g=!0},p:le,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function mR(x){let d,g,h,m,_,l,f,R,ue,J,E,Y,D,ee,fe,S,ge,ce,V,P,te,K,z,C,se,U,pe,ae,W,_e,he,q,be,B,Z,oe,Q,re,ke,A,ve,I,Te;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),R=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),E=n("p"),Y=r("This second option is useful when using "),D=n("code"),ee=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),ce=r("."),V=c(),P=n("p"),te=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=c(),z=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),pe=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),he=c(),q=n("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Z=r("model([input_ids, attention_mask])"),oe=r(" or "),Q=n("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),ke=c(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),I=n("code"),Te=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var L=a(d);g=i(L,"TF 2.0 models accepts two formats as inputs:"),L.forEach(t),h=p(v),m=s(v,"UL",{});var G=a(m);_=s(G,"LI",{});var xe=a(_);l=i(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),f=p(G),R=s(G,"LI",{});var me=a(R);ue=i(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),G.forEach(t),J=p(v),E=s(v,"P",{});var O=a(E);Y=i(O,"This second option is useful when using "),D=s(O,"CODE",{});var we=a(D);ee=i(we,"tf.keras.Model.fit"),we.forEach(t),fe=i(O,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=n("p"),g=r("Example:"),h=c(),T(m.$$.fragment)},l(l){d=s(l,"P",{});var f=a(d);g=i(f,"Example:"),f.forEach(t),h=p(l),y(m.$$.fragment,l)},m(l,f){b(l,d,f),e(d,g),b(l,h,f),w(m,l,f),_=!0},p:le,i(l){_||($(m.$$.fragment,l),_=!0)},o(l){M(m.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(h),F(m,l)}}}function gR(x){let d,g,h,m,_,l,f,R,ue,J,E,Y,D,ee,fe,S,ge,ce,V,P,te,K,z,C,se,U,pe,ae,W,_e,he,q,be,B,Z,oe,Q,re,ke,A,ve,I,Te;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),R=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),E=n("p"),Y=r("This second option is useful when using "),D=n("code"),ee=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),ce=r("."),V=c(),P=n("p"),te=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=c(),z=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),pe=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),he=c(),q=n("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Z=r("model([input_ids, attention_mask])"),oe=r(" or "),Q=n("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),ke=c(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),I=n("code"),Te=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var L=a(d);g=i(L,"TF 2.0 models accepts two formats as inputs:"),L.forEach(t),h=p(v),m=s(v,"UL",{});var G=a(m);_=s(G,"LI",{});var xe=a(_);l=i(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),f=p(G),R=s(G,"LI",{});var me=a(R);ue=i(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),G.forEach(t),J=p(v),E=s(v,"P",{});var O=a(E);Y=i(O,"This second option is useful when using "),D=s(O,"CODE",{});var we=a(D);ee=i(we,"tf.keras.Model.fit"),we.forEach(t),fe=i(O,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.01</span>`}}),{c(){T(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){w(d,h,m),g=!0},p:le,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function vR(x){let d,g,h,m,_,l,f,R,ue,J,E,Y,D,ee,fe,S,ge,ce,V,P,te,K,z,C,se,U,pe,ae,W,_e,he,q,be,B,Z,oe,Q,re,ke,A,ve,I,Te;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),R=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),E=n("p"),Y=r("This second option is useful when using "),D=n("code"),ee=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),ce=r("."),V=c(),P=n("p"),te=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=c(),z=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),pe=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),he=c(),q=n("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Z=r("model([input_ids, attention_mask])"),oe=r(" or "),Q=n("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),ke=c(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),I=n("code"),Te=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var L=a(d);g=i(L,"TF 2.0 models accepts two formats as inputs:"),L.forEach(t),h=p(v),m=s(v,"UL",{});var G=a(m);_=s(G,"LI",{});var xe=a(_);l=i(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),f=p(G),R=s(G,"LI",{});var me=a(R);ue=i(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),G.forEach(t),J=p(v),E=s(v,"P",{});var O=a(E);Y=i(O,"This second option is useful when using "),D=s(O,"CODE",{});var we=a(D);ee=i(we,"tf.keras.Model.fit"),we.forEach(t),fe=i(O,` method which currently requires having all the
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L194",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L220",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L248",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L305"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L155",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L181",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),da=new Me({}),ca=new X({props:{name:"class transformers.XLMRobertaModel",anchor:"transformers.XLMRobertaModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.XLMRobertaModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17044/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L65"}}),fa=new X({props:{name:"forward",anchor:"transformers.XLMRobertaModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17044/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17044/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
`}}),kn=new $e({props:{$$slots:{default:[Wx]},$$scope:{ctx:x}}}),vn=new ie({props:{anchor:"transformers.XLMRobertaForSequenceClassification.forward.example",$$slots:{default:[Bx]},$$scope:{ctx:x}}}),Tn=new ie({props:{anchor:"transformers.XLMRobertaForSequenceClassification.forward.example-2",$$slots:{default:[Ux]},$$scope:{ctx:x}}}),yn=new ie({props:{anchor:"transformers.XLMRobertaForSequenceClassification.forward.example-3",$$slots:{default:[Qx]},$$scope:{ctx:x}}}),wn=new ie({props:{anchor:"transformers.XLMRobertaForSequenceClassification.forward.example-4",$$slots:{default:[Hx]},$$scope:{ctx:x}}}),Na=new Me({}),Ia=new X({props:{name:"class transformers.XLMRobertaForMultipleChoice",anchor:"transformers.XLMRobertaForMultipleChoice",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17044/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17044/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17044/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
`}}),ts=new $e({props:{$$slots:{default:[_R]},$$scope:{ctx:x}}}),os=new ie({props:{anchor:"transformers.TFXLMRobertaForTokenClassification.call.example",$$slots:{default:[bR]},$$scope:{ctx:x}}}),ns=new ie({props:{anchor:"transformers.TFXLMRobertaForTokenClassification.call.example-2",$$slots:{default:[kR]},$$scope:{ctx:x}}}),Sr=new Me({}),Wr=new X({props:{name:"class transformers.TFXLMRobertaForQuestionAnswering",anchor:"transformers.TFXLMRobertaForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17044/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17044/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
`}}),cs=new $e({props:{$$slots:{default:[$R]},$$scope:{ctx:x}}}),ps=new ie({props:{anchor:"transformers.FlaxXLMRobertaModel.__call__.example",$$slots:{default:[MR]},$$scope:{ctx:x}}}),ri=new Me({}),ii=new X({props:{name:"class transformers.FlaxXLMRobertaForMaskedLM",anchor:"transformers.FlaxXLMRobertaForMaskedLM",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17044/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17044/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17044/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17044/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17044/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17044/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17044/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17044/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17044/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17044/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
`}}),ys=new $e({props:{$$slots:{default:[qR]},$$scope:{ctx:x}}}),ws=new ie({props:{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.example",$$slots:{default:[CR]},$$scope:{ctx:x}}}),Ji=new Me({}),Ki=new X({props:{name:"class transformers.FlaxXLMRobertaForQuestionAnswering",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17044/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17044/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17044/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17044/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17044/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ST=c(),zr=n("p"),WT=r("This model is also a "),qr=n("a"),BT=r("tf.keras.Model"),UT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
documentation alongside usage examples.`),w1=c(),pt=n("div"),T(Dr.$$.fragment),$1=c(),Xo=n("p"),M1=r("The "),md=n("a"),F1=r("TFRobertaForTokenClassification"),x1=r(" forward method, overrides the "),dp=n("code"),R1=r("__call__"),L1=r(" special method."),E1=c(),T(ts.$$.fragment),z1=c(),T(os.$$.fragment),q1=c(),T(ns.$$.fragment),Em=c(),Po=n("h2"),ss=n("a"),cp=n("span"),T(Sr.$$.fragment),C1=c(),pp=n("span"),j1=r("TFXLMRobertaForQuestionAnswering"),zm=c(),We=n("div"),T(Wr.$$.fragment),X1=c(),Ao=n("p"),P1=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),A1=r("span start logits"),O1=r(" and "),mp=n("code"),N1=r("span end logits"),I1=r(")."),D1=c(),Br=n("p"),S1=r("This model inherits from "),ud=n("a"),W1=r("TFPreTrainedModel"),B1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y$=c(),sh=n("p"),Z$=r("Finally, this model supports inherent JAX features such as:"),eM=c(),Qt=n("ul"),ah=n("li"),Wi=n("a"),tM=r("Just-In-Time (JIT) compilation"),oM=c(),rh=n("li"),Bi=n("a"),nM=r("Automatic Differentiation"),sM=c(),ih=n("li"),Ui=n("a"),aM=r("Vectorization"),rM=c(),lh=n("li"),Qi=n("a"),iM=r("Parallelization"),lM=c(),Hi=n("p"),dM=r("This class overrides "),Md=n("a"),cM=r("FlaxRobertaForTokenClassification"),pM=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),hM=c(),qt=n("div"),T(Vi.$$.fragment),mM=c(),Jo=n("p"),uM=r("The "),dh=n("code"),fM=r("FlaxRobertaPreTrainedModel"),gM=r(" forward method, overrides the "),ch=n("code"),_M=r("__call__"),bM=r(" special method."),kM=c(),T(ys.$$.fragment),vM=c(),T(ws.$$.fragment),Sm=c(),Ko=n("h2"),$s=n("a"),ph=n("span"),T(Ji.$$.fragment),TM=c(),hh=n("span"),yM=r("FlaxXLMRobertaForQuestionAnswering"),Wm=c(),Pe=n("div"),T(Ki.$$.fragment),wM=c(),Go=n("p"),$M=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Km.forEach(t),Dg=p(jt),ha=s(jt,"P",{});var Gm=a(ha);Sg=i(Gm,"This model is also a PyTorch "),ma=s(Gm,"A",{href:!0,rel:!0});var M0=a(ma);Wg=i(M0,"torch.nn.Module"),M0.forEach(t),Bg=i(Gm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ru.forEach(t),D_=p(Pt),Ra=s(Pt,"P",{});var iu=a(Ra);S_=i(iu,"This model is also a PyTorch "),La=s(iu,"A",{href:!0,rel:!0});var W0=a(La);W_=i(W0,"torch.nn.Module"),W0.forEach(t),B_=i(iu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),iu.forEach(t),U_=p(Pt),Ea=s(Pt,"P",{});var lu=a(Ea);Q_=i(lu,"This class overrides "),Nl=s(lu,"A",{href:!0});var B0=a(Nl);H_=i(B0,"RobertaForMaskedLM"),B0.forEach(t),V_=i(lu,`. Please check the superclass for the appropriate documentation
...
documentation alongside usage examples.`),hu.forEach(t),Tb=p(At),Qe=s(At,"DIV",{class:!0});var mt=a(Qe);y(Oa.$$.fragment,mt),yb=p(mt),bo=s(mt,"P",{});var jd=a(bo);wb=i(jd,"The "),Wl=s(jd,"A",{href:!0});var e2=a(Wl);$b=i(e2,"RobertaForSequenceClassification"),e2.forEach(t),Mb=i(jd," forward method, overrides the "),Ec=s(jd,"CODE",{});var t2=a(Ec);Fb=i(t2,"__call__"),t2.forEach(t),xb=i(jd," special method."),jd.forEach(t),Rb=p(mt),y(kn.$$.fragment,mt),Lb=p(mt),y(vn.$$.fragment,mt),Eb=p(mt),y(Tn.$$.fragment,mt),zb=p(mt),y(yn.$$.fragment,mt),qb=p(mt),y(wn.$$.fragment,mt),mt.forEach(t),At.forEach(t),um=p(o),ko=s(o,"H2",{class:!0});var mu=a(ko);$n=s(mu,"A",{id:!0,class:!0,href:!0});var o2=a($n);zc=s(o2,"SPAN",{});var n2=a(zc);y(Na.$$.fragment,n2),n2.forEach(t),o2.forEach(t),Cb=p(mu),qc=s(mu,"SPAN",{});var s2=a(qc);jb=i(s2,"XLMRobertaForMultipleChoice"),s2.forEach(t),mu.forEach(t),fm=p(o),Ge=s(o,"DIV",{class:!0});var Ot=a(Ge);y(Ia.$$.fragment,Ot),Xb=p(Ot),Cc=s(Ot,"P",{});var a2=a(Cc);Pb=i(a2,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),a2.forEach(t),Ab=p(Ot),Da=s(Ot,"P",{});var uu=a(Da);Ob=i(uu,"This model inherits from "),Bl=s(uu,"A",{href:!0});var r2=a(Bl);Nb=i(r2,"PreTrainedModel"),r2.forEach(t),Ib=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),Db=p(Ot),Sa=s(Ot,"P",{});var fu=a(Sa);Sb=i(fu,"This model is also a PyTorch "),Wa=s(fu,"A",{href:!0,rel:!0});var i2=a(Wa);Wb=i(i2,"torch.nn.Module"),i2.forEach(t),Bb=i(fu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fu.forEach(t),Ub=p(Ot),Ba=s(Ot,"P",{});var gu=a(Ba);Qb=i(gu,"This class overrides "),Ul=s(gu,"A",{href:!0});var l2=a(Ul);Hb=i(l2,"RobertaForMultipleChoice"),l2.forEach(t),Vb=i(gu,`. Please check the superclass for the appropriate documentation
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),Sk=p(It),or=s(It,"P",{});var wu=a(or);Wk=i(wu,"This model is also a PyTorch "),nr=s(wu,"A",{href:!0,rel:!0});var F2=a(nr);Bk=i(F2,"torch.nn.Module"),F2.forEach(t),Uk=i(wu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pu.forEach(t),kT=p(gt),y(Un.$$.fragment,gt),vT=p(gt),Fr=s(gt,"P",{});var Au=a(Fr);TT=i(Au,"This class overrides "),rd=s(Au,"A",{href:!0});var e4=a(rd);yT=i(e4,"TFRobertaForSequenceClassification"),e4.forEach(t),wT=i(Au,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Au.forEach(t),$T=p(gt),ct=s(gt,"DIV",{class:!0});var no=a(ct);y(xr.$$.fragment,no),MT=p(no),zo=s(no,"P",{});var Dd=a(zo);FT=i(Dd,"The "),id=s(Dd,"A",{href:!0});var t4=a(id);xT=i(t4,"TFRobertaForSequenceClassification"),t4.forEach(t),RT=i(Dd," forward method, overrides the "),tp=s(Dd,"CODE",{});var o4=a(tp);LT=i(o4,"__call__"),o4.forEach(t),ET=i(Dd," special method."),Dd.forEach(t),zT=p(no),y(Qn.$$.fragment,no),qT=p(no),y(Hn.$$.fragment,no),CT=p(no),y(Vn.$$.fragment,no),no.forEach(t),gt.forEach(t),Fm=p(o),qo=s(o,"H2",{class:!0});var Ou=a(qo);Jn=s(Ou,"A",{id:!0,class:!0,href:!0});var n4=a(Jn);op=s(n4,"SPAN",{});var s4=a(op);y(Rr.$$.fragment,s4),s4.forEach(t),n4.forEach(t),jT=p(Ou),np=s(Ou,"SPAN",{});var a4=a(np);XT=i(a4,"TFXLMRobertaForMultipleChoice"),a4.forEach(t),Ou.forEach(t),xm=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Lr.$$.fragment,_t),PT=p(_t),sp=s(_t,"P",{});var r4=a(sp);AT=i(r4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),r4.forEach(t),OT=p(_t),Er=s(_t,"P",{});var Nu=a(Er);NT=i(Nu,"This model inherits from "),ld=s(Nu,"A",{href:!0});var i4=a(ld);IT=i(i4,"TFPreTrainedModel"),i4.forEach(t),DT=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu.forEach(t),ST=p(_t),zr=s(_t,"P",{});var Iu=a(zr);WT=i(Iu,"This model is also a "),qr=s(Iu,"A",{href:!0,rel:!0});var l4=a(qr);BT=i(l4,"tf.keras.Model"),l4.forEach(t),UT=i(Iu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Iu.forEach(t),QT=p(_t),y(Kn.$$.fragment,_t),HT=p(_t),Cr=s(_t,"P",{});var Du=a(Cr);VT=i(Du,"This class overrides "),dd=s(Du,"A",{href:!0});var d4=a(dd);JT=i(d4,"TFRobertaForMultipleChoice"),d4.forEach(t),KT=i(Du,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Du.forEach(t),GT=p(_t),xt=s(_t,"DIV",{class:!0});var zs=a(xt);y(jr.$$.fragment,zs),YT=p(zs),Co=s(zs,"P",{});var Sd=a(Co);ZT=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var c4=a(cd);e1=i(c4,"TFRobertaForMultipleChoice"),c4.forEach(t),t1=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var p4=a(ap);o1=i(p4,"__call__"),p4.forEach(t),n1=i(Sd," special method."),Sd.forEach(t),s1=p(zs),y(Gn.$$.fragment,zs),a1=p(zs),y(Yn.$$.fragment,zs),zs.forEach(t),_t.forEach(t),Rm=p(o),jo=s(o,"H2",{class:!0});var Su=a(jo);Zn=s(Su,"A",{id:!0,class:!0,href:!0});var h4=a(Zn);rp=s(h4,"SPAN",{});var m4=a(rp);y(Xr.$$.fragment,m4),m4.forEach(t),h4.forEach(t),r1=p(Su),ip=s(Su,"SPAN",{});var u4=a(ip);i1=i(u4,"TFXLMRobertaForTokenClassification"),u4.forEach(t),Su.forEach(t),Lm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(Pr.$$.fragment,bt),l1=p(bt),lp=s(bt,"P",{});var f4=a(lp);d1=i(f4,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),f4.forEach(t),c1=p(bt),Ar=s(bt,"P",{});var Wu=a(Ar);p1=i(Wu,"This model inherits from "),pd=s(Wu,"A",{href:!0});var g4=a(pd);h1=i(g4,"TFPreTrainedModel"),g4.forEach(t),m1=i(Wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wu.forEach(t),u1=p(bt),Or=s(bt,"P",{});var Bu=a(Or);f1=i(Bu,"This model is also a "),Nr=s(Bu,"A",{href:!0,rel:!0});var _4=a(Nr);g1=i(_4,"tf.keras.Model"),_4.forEach(t),_1=i(Bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu.forEach(t),b1=p(bt),y(es.$$.fragment,bt),k1=p(bt),Ir=s(bt,"P",{});var Uu=a(Ir);v1=i(Uu,"This class overrides "),hd=s(Uu,"A",{href:!0});var b4=a(hd);T1=i(b4,"TFRobertaForTokenClassification"),b4.forEach(t),y1=i(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),w1=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Dr.$$.fragment,so),$1=p(so),Xo=s(so,"P",{});var Wd=a(Xo);M1=i(Wd,"The "),md=s(Wd,"A",{href:!0});var k4=a(md);F1=i(k4,"TFRobertaForTokenClassification"),k4.forEach(t),x1=i(Wd," forward method, overrides the "),dp=s(Wd,"CODE",{});var v4=a(dp);R1=i(v4,"__call__"),v4.forEach(t),L1=i(Wd," special method."),Wd.forEach(t),E1=p(so),y(ts.$$.fragment,so),z1=p(so),y(os.$$.fragment,so),q1=p(so),y(ns.$$.fragment,so),so.forEach(t),bt.forEach(t),Em=p(o),Po=s(o,"H2",{class:!0});var Qu=a(Po);ss=s(Qu,"A",{id:!0,class:!0,href:!0});var T4=a(ss);cp=s(T4,"SPAN",{});var y4=a(cp);y(Sr.$$.fragment,y4),y4.forEach(t),T4.forEach(t),C1=p(Qu),pp=s(Qu,"SPAN",{});var w4=a(pp);j1=i(w4,"TFXLMRobertaForQuestionAnswering"),w4.forEach(t),Qu.forEach(t),zm=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(Wr.$$.fragment,kt),X1=p(kt),Ao=s(kt,"P",{});var Bd=a(Ao);P1=i(Bd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Bd,"CODE",{});var $4=a(hp);A1=i($4,"span start logits"),$4.forEach(t),O1=i(Bd," and "),mp=s(Bd,"CODE",{});var M4=a(mp);N1=i(M4,"span end logits"),M4.forEach(t),I1=i(Bd,")."),Bd.forEach(t),D1=p(kt),Br=s(kt,"P",{});var Hu=a(Br);S1=i(Hu,"This model inherits from "),ud=s(Hu,"A",{href:!0});var F4=a(ud);W1=i(F4,"TFPreTrainedModel"),F4.forEach(t),B1=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hu.forEach(t),U1=p(kt),Ur=s(kt,"P",{});var Vu=a(Ur);Q1=i(Vu,"This model is also a "),Qr=s(Vu,"A",{href:!0,rel:!0});var x4=a(Qr);H1=i(x4,"tf.keras.Model"),x4.forEach(t),V1=i(Vu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vu.forEach(t),J1=p(kt),y(as.$$.fragment,kt),K1=p(kt),Hr=s(kt,"P",{});var Ju=a(Hr);G1=i(Ju,"This class overrides "),up=s(Ju,"CODE",{});var R4=a(up);Y1=i(R4,"TFRobertaForQuestionAnsweringSimple"),R4.forEach(t),Z1=i(Ju,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ju.forEach(t),ey=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Vr.$$.fragment,ao),ty=p(ao),Oo=s(ao,"P",{});var Ud=a(Oo);oy=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var L4=a(fd);ny=i(L4,"TFRobertaForQuestionAnswering"),L4.forEach(t),sy=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var E4=a(fp);ay=i(E4,"__call__"),E4.forEach(t),ry=i(Ud," special method."),Ud.forEach(t),iy=p(ao),y(rs.$$.fragment,ao),ly=p(ao),y(is.$$.fragment,ao),dy=p(ao),y(ls.$$.fragment,ao),ao.forEach(t),kt.forEach(t),qm=p(o),No=s(o,"H2",{class:!0});var Ku=a(No);ds=s(Ku,"A",{id:!0,class:!0,href:!0});var z4=a(ds);gp=s(z4,"SPAN",{});var q4=a(gp);y(Jr.$$.fragment,q4),q4.forEach(t),z4.forEach(t),cy=p(Ku),_p=s(Ku,"SPAN",{});var C4=a(_p);py=i(C4,"FlaxXLMRobertaModel"),C4.forEach(t),Ku.forEach(t),Cm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Kr.$$.fragment,vt),hy=p(vt),Gr=s(vt,"P",{});var Gu=a(Gr);my=i(Gu,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=s(Gu,"A",{href:!0});var j4=a(gd);uy=i(j4,"FlaxPreTrainedModel"),j4.forEach(t),fy=i(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gu.forEach(t),gy=p(vt),Yr=s(vt,"P",{});var Yu=a(Yr);_y=i(Yu,"This model is also a Flax Linen "),Zr=s(Yu,"A",{href:!0,rel:!0});var X4=a(Zr);by=i(X4,"flax.linen.Module"),X4.forEach(t),ky=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),vy=p(vt),bp=s(vt,"P",{});var P4=a(bp);Ty=i(P4,"Finally, this model supports inherent JAX features such as:"),P4.forEach(t),yy=p(vt),St=s(vt,"UL",{});var qs=a(St);kp=s(qs,"LI",{});var A4=a(kp);ei=s(A4,"A",{href:!0,rel:!0});var O4=a(ei);wy=i(O4,"Just-In-Time (JIT) compilation"),O4.forEach(t),A4.forEach(t),$y=p(qs),vp=s(qs,"LI",{});var N4=a(vp);ti=s(N4,"A",{href:!0,rel:!0});var I4=a(ti);My=i(I4,"Automatic Differentiation"),I4.forEach(t),N4.forEach(t),Fy=p(qs),Tp=s(qs,"LI",{});var D4=a(Tp);oi=s(D4,"A",{href:!0,rel:!0});var S4=a(oi);xy=i(S4,"Vectorization"),S4.forEach(t),D4.forEach(t),Ry=p(qs),yp=s(qs,"LI",{});var W4=a(yp);ni=s(W4,"A",{href:!0,rel:!0});var B4=a(ni);Ly=i(B4,"Parallelization"),B4.forEach(t),W4.forEach(t),qs.forEach(t),Ey=p(vt),si=s(vt,"P",{});var Zu=a(si);zy=i(Zu,"This class overrides "),_d=s(Zu,"A",{href:!0});var U4=a(_d);qy=i(U4,"FlaxRobertaModel"),U4.forEach(t),Cy=i(Zu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Zu.forEach(t),jy=p(vt),Rt=s(vt,"DIV",{class:!0});var Cs=a(Rt);y(ai.$$.fragment,Cs),Xy=p(Cs),Io=s(Cs,"P",{});var Qd=a(Io);Py=i(Qd,"The "),wp=s(Qd,"CODE",{});var Q4=a(wp);Ay=i(Q4,"FlaxRobertaPreTrainedModel"),Q4.forEach(t),Oy=i(Qd," forward method, overrides the "),$p=s(Qd,"CODE",{});var H4=a($p);Ny=i(H4,"__call__"),H4.forEach(t),Iy=i(Qd," special method."),Qd.forEach(t),Dy=p(Cs),y(cs.$$.fragment,Cs),Sy=p(Cs),y(ps.$$.fragment,Cs),Cs.forEach(t),vt.forEach(t),jm=p(o),Do=s(o,"H2",{class:!0});var ef=a(Do);hs=s(ef,"A",{id:!0,class:!0,href:!0});var V4=a(hs);Mp=s(V4,"SPAN",{});var J4=a(Mp);y(ri.$$.fragment,J4),J4.forEach(t),V4.forEach(t),Wy=p(ef),Fp=s(ef,"SPAN",{});var K4=a(Fp);By=i(K4,"FlaxXLMRobertaForMaskedLM"),K4.forEach(t),ef.forEach(t),Xm=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(ii.$$.fragment,Tt),Uy=p(Tt),So=s(Tt,"P",{});var Hd=a(So);Qy=i(Hd,"XLM-RoBERTa Model with a "),xp=s(Hd,"CODE",{});var G4=a(xp);Hy=i(G4,"language modeling"),G4.forEach(t),Vy=i(Hd,` head on top.
This model inherits from `),bd=s(Hd,"A",{href:!0});var Y4=a(bd);Jy=i(Y4,"FlaxPreTrainedModel"),Y4.forEach(t),Ky=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),Gy=p(Tt),li=s(Tt,"P",{});var tf=a(li);Yy=i(tf,"This model is also a Flax Linen "),di=s(tf,"A",{href:!0,rel:!0});var Z4=a(di);Zy=i(Z4,"flax.linen.Module"),Z4.forEach(t),ew=i(tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tf.forEach(t),tw=p(Tt),Rp=s(Tt,"P",{});var eF=a(Rp);ow=i(eF,"Finally, this model supports inherent JAX features such as:"),eF.forEach(t),nw=p(Tt),Wt=s(Tt,"UL",{});var js=a(Wt);Lp=s(js,"LI",{});var tF=a(Lp);ci=s(tF,"A",{href:!0,rel:!0});var oF=a(ci);sw=i(oF,"Just-In-Time (JIT) compilation"),oF.forEach(t),tF.forEach(t),aw=p(js),Ep=s(js,"LI",{});var nF=a(Ep);pi=s(nF,"A",{href:!0,rel:!0});var sF=a(pi);rw=i(sF,"Automatic Differentiation"),sF.forEach(t),nF.forEach(t),iw=p(js),zp=s(js,"LI",{});var aF=a(zp);hi=s(aF,"A",{href:!0,rel:!0});var rF=a(hi);lw=i(rF,"Vectorization"),rF.forEach(t),aF.forEach(t),dw=p(js),qp=s(js,"LI",{});var iF=a(qp);mi=s(iF,"A",{href:!0,rel:!0});var lF=a(mi);cw=i(lF,"Parallelization"),lF.forEach(t),iF.forEach(t),js.forEach(t),pw=p(Tt),ui=s(Tt,"P",{});var of=a(ui);hw=i(of,"This class overrides "),kd=s(of,"A",{href:!0});var dF=a(kd);mw=i(dF,"FlaxRobertaForMaskedLM"),dF.forEach(t),uw=i(of,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),of.forEach(t),fw=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Xs=a(Lt);y(fi.$$.fragment,Xs),gw=p(Xs),Wo=s(Xs,"P",{});var Vd=a(Wo);_w=i(Vd,"The "),Cp=s(Vd,"CODE",{});var cF=a(Cp);bw=i(cF,"FlaxRobertaPreTrainedModel"),cF.forEach(t),kw=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var pF=a(jp);vw=i(pF,"__call__"),pF.forEach(t),Tw=i(Vd," special method."),Vd.forEach(t),yw=p(Xs),y(ms.$$.fragment,Xs),ww=p(Xs),y(us.$$.fragment,Xs),Xs.forEach(t),Tt.forEach(t),Pm=p(o),Bo=s(o,"H2",{class:!0});var nf=a(Bo);fs=s(nf,"A",{id:!0,class:!0,href:!0});var hF=a(fs);Xp=s(hF,"SPAN",{});var mF=a(Xp);y(gi.$$.fragment,mF),mF.forEach(t),hF.forEach(t),$w=p(nf),Pp=s(nf,"SPAN",{});var uF=a(Pp);Mw=i(uF,"FlaxXLMRobertaForSequenceClassification"),uF.forEach(t),nf.forEach(t),Am=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(_i.$$.fragment,tt),Fw=p(tt),Ap=s(tt,"P",{});var fF=a(Ap);xw=i(fF,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),fF.forEach(t),Rw=p(tt),bi=s(tt,"P",{});var sf=a(bi);Lw=i(sf,"This model inherits from "),vd=s(sf,"A",{href:!0});var gF=a(vd);Ew=i(gF,"FlaxPreTrainedModel"),gF.forEach(t),zw=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sf.forEach(t),qw=p(tt),ki=s(tt,"P",{});var af=a(ki);Cw=i(af,"This model is also a Flax Linen "),vi=s(af,"A",{href:!0,rel:!0});var _F=a(vi);jw=i(_F,"flax.linen.Module"),_F.forEach(t),Xw=i(af,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),Pw=p(tt),Op=s(tt,"P",{});var bF=a(Op);Aw=i(bF,"Finally, this model supports inherent JAX features such as:"),bF.forEach(t),Ow=p(tt),Bt=s(tt,"UL",{});var Ps=a(Bt);Np=s(Ps,"LI",{});var kF=a(Np);Ti=s(kF,"A",{href:!0,rel:!0});var vF=a(Ti);Nw=i(vF,"Just-In-Time (JIT) compilation"),vF.forEach(t),kF.forEach(t),Iw=p(Ps),Ip=s(Ps,"LI",{});var TF=a(Ip);yi=s(TF,"A",{href:!0,rel:!0});var yF=a(yi);Dw=i(yF,"Automatic Differentiation"),yF.forEach(t),TF.forEach(t),Sw=p(Ps),Dp=s(Ps,"LI",{});var wF=a(Dp);wi=s(wF,"A",{href:!0,rel:!0});var $F=a(wi);Ww=i($F,"Vectorization"),$F.forEach(t),wF.forEach(t),Bw=p(Ps),Sp=s(Ps,"LI",{});var MF=a(Sp);$i=s(MF,"A",{href:!0,rel:!0});var FF=a($i);Uw=i(FF,"Parallelization"),FF.forEach(t),MF.forEach(t),Ps.forEach(t),Qw=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);Hw=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var xF=a(Td);Vw=i(xF,"FlaxRobertaForSequenceClassification"),xF.forEach(t),Jw=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),Kw=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),Gw=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Yw=i(Jd,"The "),Wp=s(Jd,"CODE",{});var RF=a(Wp);Zw=i(RF,"FlaxRobertaPreTrainedModel"),RF.forEach(t),e$=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var LF=a(Bp);t$=i(LF,"__call__"),LF.forEach(t),o$=i(Jd," special method."),Jd.forEach(t),n$=p(As),y(gs.$$.fragment,As),s$=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var EF=a(bs);Up=s(EF,"SPAN",{});var zF=a(Up);y(xi.$$.fragment,zF),zF.forEach(t),EF.forEach(t),a$=p(lf),Qp=s(lf,"SPAN",{});var qF=a(Qp);r$=i(qF,"FlaxXLMRobertaForMultipleChoice"),qF.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i$=p(ot),Hp=s(ot,"P",{});var CF=a(Hp);l$=i(CF,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),CF.forEach(t),d$=p(ot),Li=s(ot,"P",{});var df=a(Li);c$=i(df,"This model inherits from "),yd=s(df,"A",{href:!0});var jF=a(yd);p$=i(jF,"FlaxPreTrainedModel"),jF.forEach(t),h$=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),df.forEach(t),m$=p(ot),Ei=s(ot,"P",{});var cf=a(Ei);u$=i(cf,"This model is also a Flax Linen "),zi=s(cf,"A",{href:!0,rel:!0});var XF=a(zi);f$=i(XF,"flax.linen.Module"),XF.forEach(t),g$=i(cf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),_$=p(ot),Vp=s(ot,"P",{});var PF=a(Vp);b$=i(PF,"Finally, this model supports inherent JAX features such as:"),PF.forEach(t),k$=p(ot),Ut=s(ot,"UL",{});var Os=a(Ut);Jp=s(Os,"LI",{});var AF=a(Jp);qi=s(AF,"A",{href:!0,rel:!0});var OF=a(qi);v$=i(OF,"Just-In-Time (JIT) compilation"),OF.forEach(t),AF.forEach(t),T$=p(Os),Kp=s(Os,"LI",{});var NF=a(Kp);Ci=s(NF,"A",{href:!0,rel:!0});var IF=a(Ci);y$=i(IF,"Automatic Differentiation"),IF.forEach(t),NF.forEach(t),w$=p(Os),Gp=s(Os,"LI",{});var DF=a(Gp);ji=s(DF,"A",{href:!0,rel:!0});var SF=a(ji);$$=i(SF,"Vectorization"),SF.forEach(t),DF.forEach(t),M$=p(Os),Yp=s(Os,"LI",{});var WF=a(Yp);Xi=s(WF,"A",{href:!0,rel:!0});var BF=a(Xi);F$=i(BF,"Parallelization"),BF.forEach(t),WF.forEach(t),Os.forEach(t),x$=p(ot),Pi=s(ot,"P",{});var pf=a(Pi);R$=i(pf,"This class overrides "),wd=s(pf,"A",{href:!0});var UF=a(wd);L$=i(UF,"FlaxRobertaForMultipleChoice"),UF.forEach(t),E$=i(pf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),pf.forEach(t),z$=p(ot),zt=s(ot,"DIV",{class:!0});var Ns=a(zt);y(Ai.$$.fragment,Ns),q$=p(Ns),Ho=s(Ns,"P",{});var Kd=a(Ho);C$=i(Kd,"The "),Zp=s(Kd,"CODE",{});var QF=a(Zp);j$=i(QF,"FlaxRobertaPreTrainedModel"),QF.forEach(t),X$=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var HF=a(eh);P$=i(HF,"__call__"),HF.forEach(t),A$=i(Kd," special method."),Kd.forEach(t),O$=p(Ns),y(ks.$$.fragment,Ns),N$=p(Ns),y(vs.$$.fragment,Ns),Ns.forEach(t),ot.forEach(t),Im=p(o),Vo=s(o,"H2",{class:!0});var hf=a(Vo);Ts=s(hf,"A",{id:!0,class:!0,href:!0});var VF=a(Ts);th=s(VF,"SPAN",{});var JF=a(th);y(Oi.$$.fragment,JF),JF.forEach(t),VF.forEach(t),I$=p(hf),oh=s(hf,"SPAN",{});var KF=a(oh);D$=i(KF,"FlaxXLMRobertaForTokenClassification"),KF.forEach(t),hf.forEach(t),Dm=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ni.$$.fragment,nt),S$=p(nt),nh=s(nt,"P",{});var GF=a(nh);W$=i(GF,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),GF.forEach(t),B$=p(nt),Ii=s(nt,"P",{});var mf=a(Ii);U$=i(mf,"This model inherits from "),$d=s(mf,"A",{href:!0});var YF=a($d);Q$=i(YF,"FlaxPreTrainedModel"),YF.forEach(t),H$=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mf.forEach(t),V$=p(nt),Di=s(nt,"P",{});var uf=a(Di);J$=i(uf,"This model is also a Flax Linen "),Si=s(uf,"A",{href:!0,rel:!0});var ZF=a(Si);K$=i(ZF,"flax.linen.Module"),ZF.forEach(t),G$=i(uf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y$=p(nt),sh=s(nt,"P",{});var ex=a(sh);Z$=i(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),eM=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var tx=a(ah);Wi=s(tx,"A",{href:!0,rel:!0});var ox=a(Wi);tM=i(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),oM=p(Is),rh=s(Is,"LI",{});var nx=a(rh);Bi=s(nx,"A",{href:!0,rel:!0});var sx=a(Bi);nM=i(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),sM=p(Is),ih=s(Is,"LI",{});var ax=a(ih);Ui=s(ax,"A",{href:!0,rel:!0});var rx=a(Ui);aM=i(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),rM=p(Is),lh=s(Is,"LI",{});var ix=a(lh);Qi=s(ix,"A",{href:!0,rel:!0});var lx=a(Qi);iM=i(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),Is.forEach(t),lM=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);dM=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var dx=a(Md);cM=i(dx,"FlaxRobertaForTokenClassification"),dx.forEach(t),pM=i(ff,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ff.forEach(t),hM=p(nt),qt=s(nt,"DIV",{class:!0});var Ds=a(qt);y(Vi.$$.fragment,Ds),mM=p(Ds),Jo=s(Ds,"P",{});var Gd=a(Jo);uM=i(Gd,"The "),dh=s(Gd,"CODE",{});var cx=a(dh);fM=i(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),gM=i(Gd," forward method, overrides the "),ch=s(Gd,"CODE",{});var px=a(ch);_M=i(px,"__call__"),px.forEach(t),bM=i(Gd," special method."),Gd.forEach(t),kM=p(Ds),y(ys.$$.fragment,Ds),vM=p(Ds),y(ws.$$.fragment,Ds),Ds.forEach(t),nt.forEach(t),Sm=p(o),Ko=s(o,"H2",{class:!0});var gf=a(Ko);$s=s(gf,"A",{id:!0,class:!0,href:!0});var hx=a($s);ph=s(hx,"SPAN",{});var mx=a(ph);y(Ji.$$.fragment,mx),mx.forEach(t),hx.forEach(t),TM=p(gf),hh=s(gf,"SPAN",{});var ux=a(hh);yM=i(ux,"FlaxXLMRobertaForQuestionAnswering"),ux.forEach(t),gf.forEach(t),Wm=p(o),Pe=s(o,"DIV",{class:!0});var st=a(Pe);y(Ki.$$.fragment,st),wM=p(st),Go=s(st,"P",{});var Yd=a(Go);$M=i(Yd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
