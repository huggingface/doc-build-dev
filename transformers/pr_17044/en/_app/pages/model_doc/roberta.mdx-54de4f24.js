...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17044/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf.forEach(t),Ak=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(ur.$$.fragment,so),Ok=h(so),Mo=s(so,"P",{});var wd=a(Mo);Nk=i(wd,"The "),Vl=s(wd,"A",{href:!0});var X2=a(Vl);Ik=i(X2,"RobertaForTokenClassification"),X2.forEach(t),Dk=i(wd," forward method, overrides the "),Lc=s(wd,"CODE",{});var Y2=a(Lc);Sk=i(Y2,"__call__"),Y2.forEach(t),Wk=i(wd," special method."),wd.forEach(t),Bk=h(so),y(Bn.$$.fragment,so),Uk=h(so),y(Un.$$.fragment,so),Hk=h(so),y(Hn.$$.fragment,so),so.forEach(t),no.forEach(t),Mm=h(o),Eo=s(o,"H2",{class:!0});var Cf=a(Eo);Qn=s(Cf,"A",{id:!0,class:!0,href:!0});var Z2=a(Qn);Ac=s(Z2,"SPAN",{});var e4=a(Ac);y(gr.$$.fragment,e4),e4.forEach(t),Z2.forEach(t),Qk=h(Cf),Oc=s(Cf,"SPAN",{});var t4=a(Oc);Vk=i(t4,"RobertaForQuestionAnswering"),t4.forEach(t),Cf.forEach(t),Em=h(o),at=s(o,"DIV",{class:!0});var ao=a(at);y(_r.$$.fragment,ao),Jk=h(ao),zo=s(ao,"P",{});var $d=a(zo);Kk=i($d,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Nc=s($d,"CODE",{});var o4=a(Nc);Gk=i(o4,"span start logits"),o4.forEach(t),Xk=i($d," and "),Ic=s($d,"CODE",{});var n4=a(Ic);Yk=i(n4,"span end logits"),n4.forEach(t),Zk=i($d,")."),$d.forEach(t),ev=h(ao),br=s(ao,"P",{});var jf=a(br);tv=i(jf,"This model inherits from "),Jl=s(jf,"A",{href:!0});var s4=a(Jl);ov=i(s4,"PreTrainedModel"),s4.forEach(t),nv=i(jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jf.forEach(t),sv=h(ao),kr=s(ao,"P",{});var Pf=a(kr);av=i(Pf,"This model is also a PyTorch "),vr=s(Pf,"A",{href:!0,rel:!0});var a4=a(vr);rv=i(a4,"torch.nn.Module"),a4.forEach(t),iv=i(Pf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pf.forEach(t),lv=h(ao),lt=s(ao,"DIV",{class:!0});var ro=a(lt);y(Tr.$$.fragment,ro),dv=h(ro),qo=s(ro,"P",{});var Fd=a(qo);cv=i(Fd,"The "),Kl=s(Fd,"A",{href:!0});var r4=a(Kl);pv=i(r4,"RobertaForQuestionAnswering"),r4.forEach(t),hv=i(Fd," forward method, overrides the "),Dc=s(Fd,"CODE",{});var i4=a(Dc);mv=i(i4,"__call__"),i4.forEach(t),fv=i(Fd," special method."),Fd.forEach(t),uv=h(ro),y(Vn.$$.fragment,ro),gv=h(ro),y(Jn.$$.fragment,ro),_v=h(ro),y(Kn.$$.fragment,ro),ro.forEach(t),ao.forEach(t),zm=h(o),Co=s(o,"H2",{class:!0});var Lf=a(Co);Gn=s(Lf,"A",{id:!0,class:!0,href:!0});var l4=a(Gn);Sc=s(l4,"SPAN",{});var d4=a(Sc);y(yr.$$.fragment,d4),d4.forEach(t),l4.forEach(t),bv=h(Lf),Wc=s(Lf,"SPAN",{});var c4=a(Wc);kv=i(c4,"TFRobertaModel"),c4.forEach(t),Lf.forEach(t),qm=h(o),He=s(o,"DIV",{class:!0});var Pt=a(He);y(wr.$$.fragment,Pt),vv=h(Pt),Bc=s(Pt,"P",{});var p4=a(Bc);Tv=i(p4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),p4.forEach(t),yv=h(Pt),$r=s(Pt,"P",{});var Af=a($r);wv=i(Af,"This model inherits from "),Gl=s(Af,"A",{href:!0});var h4=a(Gl);$v=i(h4,"TFPreTrainedModel"),h4.forEach(t),Fv=i(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),xv=h(Pt),Fr=s(Pt,"P",{});var Of=a(Fr);Rv=i(Of,"This model is also a "),xr=s(Of,"A",{href:!0,rel:!0});var m4=a(xr);Mv=i(m4,"tf.keras.Model"),m4.forEach(t),Ev=i(Of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),zv=h(Pt),y(Xn.$$.fragment,Pt),qv=h(Pt),Ft=s(Pt,"DIV",{class:!0});var Js=a(Ft);y(Rr.$$.fragment,Js),Cv=h(Js),jo=s(Js,"P",{});var xd=a(jo);jv=i(xd,"The "),Xl=s(xd,"A",{href:!0});var f4=a(Xl);Pv=i(f4,"TFRobertaModel"),f4.forEach(t),Lv=i(xd," forward method, overrides the "),Uc=s(xd,"CODE",{});var u4=a(Uc);Av=i(u4,"__call__"),u4.forEach(t),Ov=i(xd," special method."),xd.forEach(t),Nv=h(Js),y(Yn.$$.fragment,Js),Iv=h(Js),y(Zn.$$.fragment,Js),Js.forEach(t),Pt.forEach(t),Cm=h(o),Po=s(o,"H2",{class:!0});var Nf=a(Po);es=s(Nf,"A",{id:!0,class:!0,href:!0});var g4=a(es);Hc=s(g4,"SPAN",{});var _4=a(Hc);y(Mr.$$.fragment,_4),_4.forEach(t),g4.forEach(t),Dv=h(Nf),Qc=s(Nf,"SPAN",{});var b4=a(Qc);Sv=i(b4,"TFRobertaForCausalLM"),b4.forEach(t),Nf.forEach(t),jm=h(o),Lo=s(o,"DIV",{class:!0});var If=a(Lo);y(Er.$$.fragment,If),Wv=h(If),xt=s(If,"DIV",{class:!0});var Ks=a(xt);y(zr.$$.fragment,Ks),Bv=h(Ks),Ao=s(Ks,"P",{});var Rd=a(Ao);Uv=i(Rd,"The "),Yl=s(Rd,"A",{href:!0});var k4=a(Yl);Hv=i(k4,"TFRobertaForCausalLM"),k4.forEach(t),Qv=i(Rd," forward method, overrides the "),Vc=s(Rd,"CODE",{});var v4=a(Vc);Vv=i(v4,"__call__"),v4.forEach(t),Jv=i(Rd," special method."),Rd.forEach(t),Kv=h(Ks),y(ts.$$.fragment,Ks),Gv=h(Ks),y(os.$$.fragment,Ks),Ks.forEach(t),If.forEach(t),Pm=h(o),Oo=s(o,"H2",{class:!0});var Df=a(Oo);ns=s(Df,"A",{id:!0,class:!0,href:!0});var T4=a(ns);Jc=s(T4,"SPAN",{});var y4=a(Jc);y(qr.$$.fragment,y4),y4.forEach(t),T4.forEach(t),Xv=h(Df),Kc=s(Df,"SPAN",{});var w4=a(Kc);Yv=i(w4,"TFRobertaForMaskedLM"),w4.forEach(t),Df.forEach(t),Lm=h(o),Qe=s(o,"DIV",{class:!0});var Lt=a(Qe);y(Cr.$$.fragment,Lt),Zv=h(Lt),jr=s(Lt,"P",{});var Sf=a(jr);eT=i(Sf,"RoBERTa Model with a "),Gc=s(Sf,"CODE",{});var $4=a(Gc);tT=i($4,"language modeling"),$4.forEach(t),oT=i(Sf," head on top."),Sf.forEach(t),nT=h(Lt),Pr=s(Lt,"P",{});var Wf=a(Pr);sT=i(Wf,"This model inherits from "),Zl=s(Wf,"A",{href:!0});var F4=a(Zl);aT=i(F4,"TFPreTrainedModel"),F4.forEach(t),rT=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),iT=h(Lt),Lr=s(Lt,"P",{});var Bf=a(Lr);lT=i(Bf,"This model is also a "),Ar=s(Bf,"A",{href:!0,rel:!0});var x4=a(Ar);dT=i(x4,"tf.keras.Model"),x4.forEach(t),cT=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),pT=h(Lt),y(ss.$$.fragment,Lt),hT=h(Lt),dt=s(Lt,"DIV",{class:!0});var io=a(dt);y(Or.$$.fragment,io),mT=h(io),No=s(io,"P",{});var Md=a(No);fT=i(Md,"The "),ed=s(Md,"A",{href:!0});var R4=a(ed);uT=i(R4,"TFRobertaForMaskedLM"),R4.forEach(t),gT=i(Md," forward method, overrides the "),Xc=s(Md,"CODE",{});var M4=a(Xc);_T=i(M4,"__call__"),M4.forEach(t),bT=i(Md," special method."),Md.forEach(t),kT=h(io),y(as.$$.fragment,io),vT=h(io),y(rs.$$.fragment,io),TT=h(io),y(is.$$.fragment,io),io.forEach(t),Lt.forEach(t),Am=h(o),Io=s(o,"H2",{class:!0});var Uf=a(Io);ls=s(Uf,"A",{id:!0,class:!0,href:!0});var E4=a(ls);Yc=s(E4,"SPAN",{});var z4=a(Yc);y(Nr.$$.fragment,z4),z4.forEach(t),E4.forEach(t),yT=h(Uf),Zc=s(Uf,"SPAN",{});var q4=a(Zc);wT=i(q4,"TFRobertaForSequenceClassification"),q4.forEach(t),Uf.forEach(t),Om=h(o),Ve=s(o,"DIV",{class:!0});var At=a(Ve);y(Ir.$$.fragment,At),$T=h(At),ep=s(At,"P",{});var C4=a(ep);FT=i(C4,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C4.forEach(t),xT=h(At),Dr=s(At,"P",{});var Hf=a(Dr);RT=i(Hf,"This model inherits from "),td=s(Hf,"A",{href:!0});var j4=a(td);MT=i(j4,"TFPreTrainedModel"),j4.forEach(t),ET=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),zT=h(At),Sr=s(At,"P",{});var Qf=a(Sr);qT=i(Qf,"This model is also a "),Wr=s(Qf,"A",{href:!0,rel:!0});var P4=a(Wr);CT=i(P4,"tf.keras.Model"),P4.forEach(t),jT=i(Qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qf.forEach(t),PT=h(At),y(ds.$$.fragment,At),LT=h(At),ct=s(At,"DIV",{class:!0});var lo=a(ct);y(Br.$$.fragment,lo),AT=h(lo),Do=s(lo,"P",{});var Ed=a(Do);OT=i(Ed,"The "),od=s(Ed,"A",{href:!0});var L4=a(od);NT=i(L4,"TFRobertaForSequenceClassification"),L4.forEach(t),IT=i(Ed," forward method, overrides the "),tp=s(Ed,"CODE",{});var A4=a(tp);DT=i(A4,"__call__"),A4.forEach(t),ST=i(Ed," special method."),Ed.forEach(t),WT=h(lo),y(cs.$$.fragment,lo),BT=h(lo),y(ps.$$.fragment,lo),UT=h(lo),y(hs.$$.fragment,lo),lo.forEach(t),At.forEach(t),Nm=h(o),So=s(o,"H2",{class:!0});var Vf=a(So);ms=s(Vf,"A",{id:!0,class:!0,href:!0});var O4=a(ms);op=s(O4,"SPAN",{});var N4=a(op);y(Ur.$$.fragment,N4),N4.forEach(t),O4.forEach(t),HT=h(Vf),np=s(Vf,"SPAN",{});var I4=a(np);QT=i(I4,"TFRobertaForMultipleChoice"),I4.forEach(t),Vf.forEach(t),Im=h(o),Je=s(o,"DIV",{class:!0});var Ot=a(Je);y(Hr.$$.fragment,Ot),VT=h(Ot),sp=s(Ot,"P",{});var D4=a(sp);JT=i(D4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D4.forEach(t),KT=h(Ot),Qr=s(Ot,"P",{});var Jf=a(Qr);GT=i(Jf,"This model inherits from "),nd=s(Jf,"A",{href:!0});var S4=a(nd);XT=i(S4,"TFPreTrainedModel"),S4.forEach(t),YT=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),ZT=h(Ot),Vr=s(Ot,"P",{});var Kf=a(Vr);ey=i(Kf,"This model is also a "),Jr=s(Kf,"A",{href:!0,rel:!0});var W4=a(Jr);ty=i(W4,"tf.keras.Model"),W4.forEach(t),oy=i(Kf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kf.forEach(t),ny=h(Ot),y(fs.$$.fragment,Ot),sy=h(Ot),Rt=s(Ot,"DIV",{class:!0});var Gs=a(Rt);y(Kr.$$.fragment,Gs),ay=h(Gs),Wo=s(Gs,"P",{});var zd=a(Wo);ry=i(zd,"The "),sd=s(zd,"A",{href:!0});var B4=a(sd);iy=i(B4,"TFRobertaForMultipleChoice"),B4.forEach(t),ly=i(zd," forward method, overrides the "),ap=s(zd,"CODE",{});var U4=a(ap);dy=i(U4,"__call__"),U4.forEach(t),cy=i(zd," special method."),zd.forEach(t),py=h(Gs),y(us.$$.fragment,Gs),hy=h(Gs),y(gs.$$.fragment,Gs),Gs.forEach(t),Ot.forEach(t),Dm=h(o),Bo=s(o,"H2",{class:!0});var Gf=a(Bo);_s=s(Gf,"A",{id:!0,class:!0,href:!0});var H4=a(_s);rp=s(H4,"SPAN",{});var Q4=a(rp);y(Gr.$$.fragment,Q4),Q4.forEach(t),H4.forEach(t),my=h(Gf),ip=s(Gf,"SPAN",{});var V4=a(ip);fy=i(V4,"TFRobertaForTokenClassification"),V4.forEach(t),Gf.forEach(t),Sm=h(o),Ke=s(o,"DIV",{class:!0});var Nt=a(Ke);y(Xr.$$.fragment,Nt),uy=h(Nt),lp=s(Nt,"P",{});var J4=a(lp);gy=i(J4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J4.forEach(t),_y=h(Nt),Yr=s(Nt,"P",{});var Xf=a(Yr);by=i(Xf,"This model inherits from "),ad=s(Xf,"A",{href:!0});var K4=a(ad);ky=i(K4,"TFPreTrainedModel"),K4.forEach(t),vy=i(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xf.forEach(t),Ty=h(Nt),Zr=s(Nt,"P",{});var Yf=a(Zr);yy=i(Yf,"This model is also a "),ei=s(Yf,"A",{href:!0,rel:!0});var G4=a(ei);wy=i(G4,"tf.keras.Model"),G4.forEach(t),$y=i(Yf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),Fy=h(Nt),y(bs.$$.fragment,Nt),xy=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),Ry=h(co),Uo=s(co,"P",{});var qd=a(Uo);My=i(qd,"The "),rd=s(qd,"A",{href:!0});var X4=a(rd);Ey=i(X4,"TFRobertaForTokenClassification"),X4.forEach(t),zy=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var Y4=a(dp);qy=i(Y4,"__call__"),Y4.forEach(t),Cy=i(qd," special method."),qd.forEach(t),jy=h(co),y(ks.$$.fragment,co),Py=h(co),y(vs.$$.fragment,co),Ly=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var Z4=a(ys);cp=s(Z4,"SPAN",{});var eF=a(cp);y(oi.$$.fragment,eF),eF.forEach(t),Z4.forEach(t),Ay=h(Zf),pp=s(Zf,"SPAN",{});var tF=a(pp);Oy=i(tF,"TFRobertaForQuestionAnswering"),tF.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),Ny=h(It),Qo=s(It,"P",{});var Cd=a(Qo);Iy=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var oF=a(hp);Dy=i(oF,"span start logits"),oF.forEach(t),Sy=i(Cd," and "),mp=s(Cd,"CODE",{});var nF=a(mp);Wy=i(nF,"span end logits"),nF.forEach(t),By=i(Cd,")."),Cd.forEach(t),Uy=h(It),si=s(It,"P",{});var eu=a(si);Hy=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var sF=a(id);Qy=i(sF,"TFPreTrainedModel"),sF.forEach(t),Vy=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),Jy=h(It),ai=s(It,"P",{});var tu=a(ai);Ky=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var aF=a(ri);Gy=i(aF,"tf.keras.Model"),aF.forEach(t),Xy=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Yy=h(It),y(ws.$$.fragment,It),Zy=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ew=h(po),Vo=s(po,"P",{});var jd=a(Vo);tw=i(jd,"The "),ld=s(jd,"A",{href:!0});var rF=a(ld);ow=i(rF,"TFRobertaForQuestionAnswering"),rF.forEach(t),nw=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var iF=a(fp);sw=i(iF,"__call__"),iF.forEach(t),aw=i(jd," special method."),jd.forEach(t),rw=h(po),y($s.$$.fragment,po),iw=h(po),y(Fs.$$.fragment,po),lw=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var lF=a(Rs);up=s(lF,"SPAN",{});var dF=a(up);y(li.$$.fragment,dF),dF.forEach(t),lF.forEach(t),dw=h(ou),gp=s(ou,"SPAN",{});var cF=a(gp);cw=i(cF,"FlaxRobertaModel"),cF.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),pw=h(ut),_p=s(ut,"P",{});var pF=a(_p);hw=i(pF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),pF.forEach(t),mw=h(ut),ci=s(ut,"P",{});var nu=a(ci);fw=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var hF=a(dd);uw=i(hF,"FlaxPreTrainedModel"),hF.forEach(t),gw=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),_w=h(ut),pi=s(ut,"P",{});var su=a(pi);bw=i(su,"This model is also a Flax Linen "),hi=s(su,"A",{href:!0,rel:!0});var mF=a(hi);kw=i(mF,"flax.linen.Module"),mF.forEach(t),vw=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),Tw=h(ut),bp=s(ut,"P",{});var fF=a(bp);yw=i(fF,"Finally, this model supports inherent JAX features such as:"),fF.forEach(t),ww=h(ut),St=s(ut,"UL",{});var Xs=a(St);kp=s(Xs,"LI",{});var uF=a(kp);mi=s(uF,"A",{href:!0,rel:!0});var gF=a(mi);$w=i(gF,"Just-In-Time (JIT) compilation"),gF.forEach(t),uF.forEach(t),Fw=h(Xs),vp=s(Xs,"LI",{});var _F=a(vp);fi=s(_F,"A",{href:!0,rel:!0});var bF=a(fi);xw=i(bF,"Automatic Differentiation"),bF.forEach(t),_F.forEach(t),Rw=h(Xs),Tp=s(Xs,"LI",{});var kF=a(Tp);ui=s(kF,"A",{href:!0,rel:!0});var vF=a(ui);Mw=i(vF,"Vectorization"),vF.forEach(t),kF.forEach(t),Ew=h(Xs),yp=s(Xs,"LI",{});var TF=a(yp);gi=s(TF,"A",{href:!0,rel:!0});var yF=a(gi);zw=i(yF,"Parallelization"),yF.forEach(t),TF.forEach(t),Xs.forEach(t),qw=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);y(_i.$$.fragment,Ys),Cw=h(Ys),Ko=s(Ys,"P",{});var Pd=a(Ko);jw=i(Pd,"The "),wp=s(Pd,"CODE",{});var wF=a(wp);Pw=i(wF,"FlaxRobertaPreTrainedModel"),wF.forEach(t),Lw=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var $F=a($p);Aw=i($F,"__call__"),$F.forEach(t),Ow=i(Pd," special method."),Pd.forEach(t),Nw=h(Ys),y(Ms.$$.fragment,Ys),Iw=h(Ys),y(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Qm=h(o),Go=s(o,"H2",{class:!0});var au=a(Go);zs=s(au,"A",{id:!0,class:!0,href:!0});var FF=a(zs);Fp=s(FF,"SPAN",{});var xF=a(Fp);y(bi.$$.fragment,xF),xF.forEach(t),FF.forEach(t),Dw=h(au),xp=s(au,"SPAN",{});var RF=a(xp);Sw=i(RF,"FlaxRobertaForMaskedLM"),RF.forEach(t),au.forEach(t),Vm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);y(ki.$$.fragment,gt),Ww=h(gt),vi=s(gt,"P",{});var ru=a(vi);Bw=i(ru,"RoBERTa Model with a "),Rp=s(ru,"CODE",{});var MF=a(Rp);Uw=i(MF,"language modeling"),MF.forEach(t),Hw=i(ru," head on top."),ru.forEach(t),Qw=h(gt),Ti=s(gt,"P",{});var iu=a(Ti);Vw=i(iu,"This model inherits from "),cd=s(iu,"A",{href:!0});var EF=a(cd);Jw=i(EF,"FlaxPreTrainedModel"),EF.forEach(t),Kw=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Gw=h(gt),yi=s(gt,"P",{});var lu=a(yi);Xw=i(lu,"This model is also a Flax Linen "),wi=s(lu,"A",{href:!0,rel:!0});var zF=a(wi);Yw=i(zF,"flax.linen.Module"),zF.forEach(t),Zw=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),e1=h(gt),Mp=s(gt,"P",{});var qF=a(Mp);t1=i(qF,"Finally, this model supports inherent JAX features such as:"),qF.forEach(t),o1=h(gt),Wt=s(gt,"UL",{});var Zs=a(Wt);Ep=s(Zs,"LI",{});var CF=a(Ep);$i=s(CF,"A",{href:!0,rel:!0});var jF=a($i);n1=i(jF,"Just-In-Time (JIT) compilation"),jF.forEach(t),CF.forEach(t),s1=h(Zs),zp=s(Zs,"LI",{});var PF=a(zp);Fi=s(PF,"A",{href:!0,rel:!0});var LF=a(Fi);a1=i(LF,"Automatic Differentiation"),LF.forEach(t),PF.forEach(t),r1=h(Zs),qp=s(Zs,"LI",{});var AF=a(qp);xi=s(AF,"A",{href:!0,rel:!0});var OF=a(xi);i1=i(OF,"Vectorization"),OF.forEach(t),AF.forEach(t),l1=h(Zs),Cp=s(Zs,"LI",{});var NF=a(Cp);Ri=s(NF,"A",{href:!0,rel:!0});var IF=a(Ri);d1=i(IF,"Parallelization"),IF.forEach(t),NF.forEach(t),Zs.forEach(t),c1=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);y(Mi.$$.fragment,ea),p1=h(ea),Xo=s(ea,"P",{});var Ld=a(Xo);h1=i(Ld,"The "),jp=s(Ld,"CODE",{});var DF=a(jp);m1=i(DF,"FlaxRobertaPreTrainedModel"),DF.forEach(t),f1=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var SF=a(Pp);u1=i(SF,"__call__"),SF.forEach(t),g1=i(Ld," special method."),Ld.forEach(t),_1=h(ea),y(qs.$$.fragment,ea),b1=h(ea),y(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Jm=h(o),Yo=s(o,"H2",{class:!0});var du=a(Yo);js=s(du,"A",{id:!0,class:!0,href:!0});var WF=a(js);Lp=s(WF,"SPAN",{});var BF=a(Lp);y(Ei.$$.fragment,BF),BF.forEach(t),WF.forEach(t),k1=h(du),Ap=s(du,"SPAN",{});var UF=a(Ap);v1=i(UF,"FlaxRobertaForSequenceClassification"),UF.forEach(t),du.forEach(t),Km=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);y(zi.$$.fragment,_t),T1=h(_t),Op=s(_t,"P",{});var HF=a(Op);y1=i(HF,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),HF.forEach(t),w1=h(_t),qi=s(_t,"P",{});var cu=a(qi);$1=i(cu,"This model inherits from "),pd=s(cu,"A",{href:!0});var QF=a(pd);F1=i(QF,"FlaxPreTrainedModel"),QF.forEach(t),x1=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),R1=h(_t),Ci=s(_t,"P",{});var pu=a(Ci);M1=i(pu,"This model is also a Flax Linen "),ji=s(pu,"A",{href:!0,rel:!0});var VF=a(ji);E1=i(VF,"flax.linen.Module"),VF.forEach(t),z1=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),q1=h(_t),Np=s(_t,"P",{});var JF=a(Np);C1=i(JF,"Finally, this model supports inherent JAX features such as:"),JF.forEach(t),j1=h(_t),Bt=s(_t,"UL",{});var ta=a(Bt);Ip=s(ta,"LI",{});var KF=a(Ip);Pi=s(KF,"A",{href:!0,rel:!0});var GF=a(Pi);P1=i(GF,"Just-In-Time (JIT) compilation"),GF.forEach(t),KF.forEach(t),L1=h(ta),Dp=s(ta,"LI",{});var XF=a(Dp);Li=s(XF,"A",{href:!0,rel:!0});var YF=a(Li);A1=i(YF,"Automatic Differentiation"),YF.forEach(t),XF.forEach(t),O1=h(ta),Sp=s(ta,"LI",{});var ZF=a(Sp);Ai=s(ZF,"A",{href:!0,rel:!0});var ex=a(Ai);N1=i(ex,"Vectorization"),ex.forEach(t),ZF.forEach(t),I1=h(ta),Wp=s(ta,"LI",{});var tx=a(Wp);Oi=s(tx,"A",{href:!0,rel:!0});var ox=a(Oi);D1=i(ox,"Parallelization"),ox.forEach(t),tx.forEach(t),ta.forEach(t),S1=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);y(Ni.$$.fragment,oa),W1=h(oa),Zo=s(oa,"P",{});var Ad=a(Zo);B1=i(Ad,"The "),Bp=s(Ad,"CODE",{});var nx=a(Bp);U1=i(nx,"FlaxRobertaPreTrainedModel"),nx.forEach(t),H1=i(Ad," forward method, overrides the "),Up=s(Ad,"CODE",{});var sx=a(Up);Q1=i(sx,"__call__"),sx.forEach(t),V1=i(Ad," special method."),Ad.forEach(t),J1=h(oa),y(Ps.$$.fragment,oa),K1=h(oa),y(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Gm=h(o),en=s(o,"H2",{class:!0});var hu=a(en);As=s(hu,"A",{id:!0,class:!0,href:!0});var ax=a(As);Hp=s(ax,"SPAN",{});var rx=a(Hp);y(Ii.$$.fragment,rx),rx.forEach(t),ax.forEach(t),G1=h(hu),Qp=s(hu,"SPAN",{});var ix=a(Qp);X1=i(ix,"FlaxRobertaForMultipleChoice"),ix.forEach(t),hu.forEach(t),Xm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);y(Di.$$.fragment,bt),Y1=h(bt),Vp=s(bt,"P",{});var lx=a(Vp);Z1=i(lx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
