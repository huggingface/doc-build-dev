import{S as ql,i as Nl,s as Sl,e as s,k as m,w,t as a,M as Ol,c as n,d as o,m as p,a as r,x,h as i,b as c,N as Dl,F as e,g as _,y as k,q as T,o as y,B as $,v as Wl,L as vo}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as j}from"../../chunks/Docstring-1088f2fb.js";import{C as bo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as G}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as _o}from"../../chunks/ExampleCodeBlock-5212b321.js";function Rl(V){let d,b,g,h,v;return h=new bo({props:{code:`from transformers import ViLTModel, ViLTConfig
...
The vocabulary size of the modalities passed when calling <a href="/docs/transformers/pr_16980/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>. This is used after concatening the
...
</ul>`,name:"pad_and_return_pixel_mask"},{anchor:"transformers.ViltFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16980/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>, defaults to <code>&apos;np&apos;</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/feature_extraction_vilt.py#L180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16980/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16980/en/model_doc/vilt#transformers.ViltFeatureExtractor">ViltFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_16980/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L755",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16980/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16980/en/model_doc/vilt#transformers.ViltConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16980/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L892"}}),Tt=new j({props:{name:"forward",anchor:"transformers.ViltForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16980/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_16980/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16980/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
loss is only computed for the tokens with labels in <em>[0, &#x2026;, config.vocab_size]</em>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L908",returnDescription:`
<p>A <a
...
answers are applicable, where 1.0 is the highest score.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L1082",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16980/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L1274"}}),Mt=new j({props:{name:"forward",anchor:"transformers.ViltForImagesAndTextClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16980/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_16980/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16980/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Binary classification labels.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L1293",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16980/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L1175"}}),At=new j({props:{name:"forward",anchor:"transformers.ViltForImageAndTextRetrieval.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16980/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_16980/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16980/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Labels are currently not supported.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16980/src/transformers/models/vilt/modeling_vilt.py#L1187",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16980/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),ys=m(),Ot=s("p"),vn=a("Tips:"),$s=m(),C=s("ul"),tt=s("li"),bn=a("The quickest way to get started with ViLT is by checking the "),ot=s("a"),wn=a("example notebooks"),xn=a(`
...
additional embedding layers for the language modality.`),Vs=m(),ge=s("img"),Fs=m(),_e=s("small"),Nn=a("ViLT architecture. Taken from the "),Rt=s("a"),Sn=a("original paper"),On=a("."),js=m(),U=s("p"),Dn=a("This model was contributed by "),st=s("a"),Wn=a("nielsr"),Rn=a(". The original code can be found "),nt=s("a"),Bn=a("here"),Qn=a("."),Es=m(),Z=s("h2"),ve=s("a"),Fo=s("span"),w(rt.$$.fragment),Un=m(),jo=s("span"),Hn=a("ViltConfig"),Ms=m(),M=s("div"),w(at.$$.fragment),Kn=m(),Y=s("p"),Gn=a("This is the configuration class to store the configuration of a "),Eo=s("code"),Jn=a("ViLTModel"),Xn=a(`. It is used to instantiate an ViLT
...
documentation from `),Qt=s("a"),nr=a("PretrainedConfig"),rr=a(" for more information."),ar=m(),w(be.$$.fragment),Ps=m(),te=s("h2"),we=s("a"),Mo=s("span"),w(lt.$$.fragment),ir=m(),Po=s("span"),lr=a("ViltFeatureExtractor"),Is=m(),P=s("div"),w(dt.$$.fragment),dr=m(),Io=s("p"),cr=a("Constructs a ViLT feature extractor."),mr=m(),ct=s("p"),pr=a("This feature extractor inherits from "),Ut=s("a"),hr=a("FeatureExtractionMixin"),fr=a(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ur=m(),H=s("div"),w(mt.$$.fragment),gr=m(),zo=s("p"),_r=a("Main method to prepare for the model one or several image(s)."),vr=m(),w(xe.$$.fragment),zs=m(),oe=s("h2"),ke=s("a"),Ao=s("span"),w(pt.$$.fragment),br=m(),Lo=s("span"),wr=a("ViltProcessor"),As=m(),I=s("div"),w(ht.$$.fragment),xr=m(),Co=s("p"),kr=a("Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Tr=m(),E=s("p"),Ht=s("a"),yr=a("ViltProcessor"),$r=a(" offers all the functionalities of "),Kt=s("a"),Vr=a("ViltFeatureExtractor"),Fr=a(" and "),Gt=s("a"),jr=a("BertTokenizerFast"),Er=a(`. See the
docstring of `),ft=s("a"),qo=s("strong"),Mr=a("call"),Pr=a("()"),Ir=a(" and "),No=s("code"),zr=a("decode()"),Ar=a(" for more information."),Lr=m(),K=s("div"),w(ut.$$.fragment),Cr=m(),se=s("p"),qr=a("This method uses "),Te=s("a"),Nr=a("ViltFeatureExtractor."),So=s("strong"),Sr=a("call"),Or=a("()"),Dr=a(` method to prepare image(s) for the model, and
`),ye=s("a"),Wr=a("BertTokenizerFast."),Oo=s("strong"),Rr=a("call"),Br=a("()"),Qr=a(" to prepare text for the model."),Ur=m(),Do=s("p"),Hr=a("Please refer to the docstring of the above two methods for more information."),Ls=m(),ne=s("h2"),$e=s("a"),Wo=s("span"),w(gt.$$.fragment),Kr=m(),Ro=s("span"),Gr=a("ViltModel"),Cs=m(),R=s("div"),w(_t.$$.fragment),Jr=m(),vt=s("p"),Xr=a(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),ea=m(),q=s("div"),w(bt.$$.fragment),ta=m(),re=s("p"),oa=a("The "),Jt=s("a"),sa=a("ViltModel"),na=a(" forward method, overrides the "),Qo=s("code"),ra=a("__call__"),aa=a(" special method."),ia=m(),w(Ve.$$.fragment),la=m(),w(Fe.$$.fragment),qs=m(),ae=s("h2"),je=s("a"),Uo=s("span"),w(wt.$$.fragment),da=m(),Ho=s("span"),ca=a("ViltForMaskedLM"),Ns=m(),z=s("div"),w(xt.$$.fragment),ma=m(),Ko=s("p"),pa=a("ViLT Model with a language modeling head on top as done during pretraining."),ha=m(),kt=s("p"),fa=a("This model is a PyTorch "),Go=s("code"),ua=a("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),ga=a(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_a=m(),N=s("div"),w(Tt.$$.fragment),va=m(),ie=s("p"),ba=a("The "),Xt=s("a"),wa=a("ViltForMaskedLM"),xa=a(" forward method, overrides the "),Jo=s("code"),ka=a("__call__"),Ta=a(" special method."),ya=m(),w(Ee.$$.fragment),$a=m(),w(Me.$$.fragment),Ss=m(),le=s("h2"),Pe=s("a"),Xo=s("span"),w(yt.$$.fragment),Va=m(),Zo=s("span"),Fa=a("ViltForQuestionAnswering"),Os=m(),A=s("div"),w($t.$$.fragment),ja=m(),Yo=s("p"),Ea=a(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Aa=m(),S=s("div"),w(Ft.$$.fragment),La=m(),de=s("p"),Ca=a("The "),Zt=s("a"),qa=a("ViltForQuestionAnswering"),Na=a(" forward method, overrides the "),ts=s("code"),Sa=a("__call__"),Oa=a(" special method."),Da=m(),w(Ie.$$.fragment),Wa=m(),w(ze.$$.fragment),Ds=m(),ce=s("h2"),Ae=s("a"),os=s("span"),w(jt.$$.fragment),Ra=m(),ss=s("span"),Ba=a("ViltForImagesAndTextClassification"),Ws=m(),B=s("div"),w(Et.$$.fragment),Qa=m(),ns=s("p"),Ua=a("Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Ha=m(),O=s("div"),w(Mt.$$.fragment),Ka=m(),me=s("p"),Ga=a("The "),Yt=s("a"),Ja=a("ViltForImagesAndTextClassification"),Xa=a(" forward method, overrides the "),rs=s("code"),Za=a("__call__"),Ya=a(" special method."),ei=m(),w(Le.$$.fragment),ti=m(),w(Ce.$$.fragment),Rs=m(),pe=s("h2"),qe=s("a"),as=s("span"),w(Pt.$$.fragment),oi=m(),is=s("span"),si=a("ViltForImageAndTextRetrieval"),Bs=m(),L=s("div"),w(It.$$.fragment),ni=m(),ls=s("p"),ri=a(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ci=m(),D=s("div"),w(At.$$.fragment),mi=m(),he=s("p"),pi=a("The "),eo=s("a"),hi=a("ViltForImageAndTextRetrieval"),fi=a(" forward method, overrides the "),cs=s("code"),ui=a("__call__"),gi=a(" special method."),_i=m(),w(Ne.$$.fragment),vi=m(),w(Se.$$.fragment),this.h()},l(t){const u=Ol('[data-svelte="svelte-1phssyn"]',document.head);d=n(u,"META",{name:!0,content:!0}),u.forEach(o),b=p(t),g=n(t,"H1",{class:!0});var Lt=r(g);h=n(Lt,"A",{id:!0,class:!0,href:!0});var ms=r(h);v=n(ms,"SPAN",{});var ps=r(v);x(l.$$.fragment,ps),ps.forEach(o),ms.forEach(o),f=p(Lt),F=n(Lt,"SPAN",{});var hs=r(F);cn=i(hs,"ViLT"),hs.forEach(o),Lt.forEach(o),ws=p(t),J=n(t,"H2",{class:!0});var Ct=r(J);fe=n(Ct,"A",{id:!0,class:!0,href:!0});var fs=r(fe);wo=n(fs,"SPAN",{});var us=r(wo);x(Ye.$$.fragment,us),us.forEach(o),fs.forEach(o),mn=p(Ct),xo=n(Ct,"SPAN",{});var gs=r(xo);pn=i(gs,"Overview"),gs.forEach(o),Ct.forEach(o),xs=p(t),ue=n(t,"P",{});var qt=r(ue);hn=i(qt,"The ViLT model was proposed in "),et=n(qt,"A",{href:!0,rel:!0});var _s=r(et);fn=i(_s,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),_s.forEach(o),un=i(qt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),qt.forEach(o),ks=p(t),Nt=n(t,"P",{});var vs=r(Nt);gn=i(vs,"The abstract from the paper is the following:"),vs.forEach(o),Ts=p(t),St=n(t,"P",{});var bs=r(St);ko=n(bs,"EM",{});var xi=r(ko);_n=i(xi,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
documentation from `),Qt=n(no,"A",{href:!0});var Si=r(Qt);nr=i(Si,"PretrainedConfig"),Si.forEach(o),rr=i(no," for more information."),no.forEach(o),ar=p(We),x(be.$$.fragment,We),We.forEach(o),Ps=p(t),te=n(t,"H2",{class:!0});var Gs=r(te);we=n(Gs,"A",{id:!0,class:!0,href:!0});var Oi=r(we);Mo=n(Oi,"SPAN",{});var Di=r(Mo);x(lt.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),ir=p(Gs),Po=n(Gs,"SPAN",{});var Wi=r(Po);lr=i(Wi,"ViltFeatureExtractor"),Wi.forEach(o),Gs.forEach(o),Is=p(t),P=n(t,"DIV",{class:!0});var Re=r(P);x(dt.$$.fragment,Re),dr=p(Re),Io=n(Re,"P",{});var Ri=r(Io);cr=i(Ri,"Constructs a ViLT feature extractor."),Ri.forEach(o),mr=p(Re),ct=n(Re,"P",{});var Js=r(ct);pr=i(Js,"This feature extractor inherits from "),Ut=n(Js,"A",{href:!0});var Bi=r(Ut);hr=i(Bi,"FeatureExtractionMixin"),Bi.forEach(o),fr=i(Js,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Js.forEach(o),ur=p(Re),H=n(Re,"DIV",{class:!0});var ro=r(H);x(mt.$$.fragment,ro),gr=p(ro),zo=n(ro,"P",{});var Qi=r(zo);_r=i(Qi,"Main method to prepare for the model one or several image(s)."),Qi.forEach(o),vr=p(ro),x(xe.$$.fragment,ro),ro.forEach(o),Re.forEach(o),zs=p(t),oe=n(t,"H2",{class:!0});var Xs=r(oe);ke=n(Xs,"A",{id:!0,class:!0,href:!0});var Ui=r(ke);Ao=n(Ui,"SPAN",{});var Hi=r(Ao);x(pt.$$.fragment,Hi),Hi.forEach(o),Ui.forEach(o),br=p(Xs),Lo=n(Xs,"SPAN",{});var Ki=r(Lo);wr=i(Ki,"ViltProcessor"),Ki.forEach(o),Xs.forEach(o),As=p(t),I=n(t,"DIV",{class:!0});var Be=r(I);x(ht.$$.fragment,Be),xr=p(Be),Co=n(Be,"P",{});var Gi=r(Co);kr=i(Gi,"Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Gi.forEach(o),Tr=p(Be),E=n(Be,"P",{});var Q=r(E);Ht=n(Q,"A",{href:!0});var Ji=r(Ht);yr=i(Ji,"ViltProcessor"),Ji.forEach(o),$r=i(Q," offers all the functionalities of "),Kt=n(Q,"A",{href:!0});var Xi=r(Kt);Vr=i(Xi,"ViltFeatureExtractor"),Xi.forEach(o),Fr=i(Q," and "),Gt=n(Q,"A",{href:!0});var Zi=r(Gt);jr=i(Zi,"BertTokenizerFast"),Zi.forEach(o),Er=i(Q,`. See the
docstring of `),ft=n(Q,"A",{href:!0});var bi=r(ft);qo=n(bi,"STRONG",{});var Yi=r(qo);Mr=i(Yi,"call"),Yi.forEach(o),Pr=i(bi,"()"),bi.forEach(o),Ir=i(Q," and "),No=n(Q,"CODE",{});var el=r(No);zr=i(el,"decode()"),el.forEach(o),Ar=i(Q," for more information."),Q.forEach(o),Lr=p(Be),K=n(Be,"DIV",{class:!0});var ao=r(K);x(ut.$$.fragment,ao),Cr=p(ao),se=n(ao,"P",{});var io=r(se);qr=i(io,"This method uses "),Te=n(io,"A",{href:!0});var Zs=r(Te);Nr=i(Zs,"ViltFeatureExtractor."),So=n(Zs,"STRONG",{});var tl=r(So);Sr=i(tl,"call"),tl.forEach(o),Or=i(Zs,"()"),Zs.forEach(o),Dr=i(io,` method to prepare image(s) for the model, and
`),ye=n(io,"A",{href:!0});var Ys=r(ye);Wr=i(Ys,"BertTokenizerFast."),Oo=n(Ys,"STRONG",{});var ol=r(Oo);Rr=i(ol,"call"),ol.forEach(o),Br=i(Ys,"()"),Ys.forEach(o),Qr=i(io," to prepare text for the model."),io.forEach(o),Ur=p(ao),Do=n(ao,"P",{});var sl=r(Do);Hr=i(sl,"Please refer to the docstring of the above two methods for more information."),sl.forEach(o),ao.forEach(o),Be.forEach(o),Ls=p(t),ne=n(t,"H2",{class:!0});var en=r(ne);$e=n(en,"A",{id:!0,class:!0,href:!0});var nl=r($e);Wo=n(nl,"SPAN",{});var rl=r(Wo);x(gt.$$.fragment,rl),rl.forEach(o),nl.forEach(o),Kr=p(en),Ro=n(en,"SPAN",{});var al=r(Ro);Gr=i(al,"ViltModel"),al.forEach(o),en.forEach(o),Cs=p(t),R=n(t,"DIV",{class:!0});var lo=r(R);x(_t.$$.fragment,lo),Jr=p(lo),vt=n(lo,"P",{});var tn=r(vt);Xr=i(tn,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),tn.forEach(o),ea=p(lo),q=n(lo,"DIV",{class:!0});var Qe=r(q);x(bt.$$.fragment,Qe),ta=p(Qe),re=n(Qe,"P",{});var co=r(re);oa=i(co,"The "),Jt=n(co,"A",{href:!0});var ll=r(Jt);sa=i(ll,"ViltModel"),ll.forEach(o),na=i(co," forward method, overrides the "),Qo=n(co,"CODE",{});var dl=r(Qo);ra=i(dl,"__call__"),dl.forEach(o),aa=i(co," special method."),co.forEach(o),ia=p(Qe),x(Ve.$$.fragment,Qe),la=p(Qe),x(Fe.$$.fragment,Qe),Qe.forEach(o),lo.forEach(o),qs=p(t),ae=n(t,"H2",{class:!0});var on=r(ae);je=n(on,"A",{id:!0,class:!0,href:!0});var cl=r(je);Uo=n(cl,"SPAN",{});var ml=r(Uo);x(wt.$$.fragment,ml),ml.forEach(o),cl.forEach(o),da=p(on),Ho=n(on,"SPAN",{});var pl=r(Ho);ca=i(pl,"ViltForMaskedLM"),pl.forEach(o),on.forEach(o),Ns=p(t),z=n(t,"DIV",{class:!0});var Ue=r(z);x(xt.$$.fragment,Ue),ma=p(Ue),Ko=n(Ue,"P",{});var hl=r(Ko);pa=i(hl,"ViLT Model with a language modeling head on top as done during pretraining."),hl.forEach(o),ha=p(Ue),kt=n(Ue,"P",{});var sn=r(kt);fa=i(sn,"This model is a PyTorch "),Go=n(sn,"CODE",{});var fl=r(Go);ua=i(fl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),fl.forEach(o),ga=i(sn,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn.forEach(o),_a=p(Ue),N=n(Ue,"DIV",{class:!0});var He=r(N);x(Tt.$$.fragment,He),va=p(He),ie=n(He,"P",{});var mo=r(ie);ba=i(mo,"The "),Xt=n(mo,"A",{href:!0});var ul=r(Xt);wa=i(ul,"ViltForMaskedLM"),ul.forEach(o),xa=i(mo," forward method, overrides the "),Jo=n(mo,"CODE",{});var gl=r(Jo);ka=i(gl,"__call__"),gl.forEach(o),Ta=i(mo," special method."),mo.forEach(o),ya=p(He),x(Ee.$$.fragment,He),$a=p(He),x(Me.$$.fragment,He),He.forEach(o),Ue.forEach(o),Ss=p(t),le=n(t,"H2",{class:!0});var nn=r(le);Pe=n(nn,"A",{id:!0,class:!0,href:!0});var _l=r(Pe);Xo=n(_l,"SPAN",{});var vl=r(Xo);x(yt.$$.fragment,vl),vl.forEach(o),_l.forEach(o),Va=p(nn),Zo=n(nn,"SPAN",{});var bl=r(Zo);Fa=i(bl,"ViltForQuestionAnswering"),bl.forEach(o),nn.forEach(o),Os=p(t),A=n(t,"DIV",{class:!0});var Ke=r(A);x($t.$$.fragment,Ke),ja=p(Ke),Yo=n(Ke,"P",{});var wl=r(Yo);Ea=i(wl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
token) for visual question answering, e.g. for VQAv2.`),wl.forEach(o),Ma=p(Ke),Vt=n(Ke,"P",{});var rn=r(Vt);Pa=i(rn,"This model is a PyTorch "),es=n(rn,"CODE",{});var xl=r(es);Ia=i(xl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),xl.forEach(o),za=i(rn,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),rn.forEach(o),Aa=p(Ke),S=n(Ke,"DIV",{class:!0});var Ge=r(S);x(Ft.$$.fragment,Ge),La=p(Ge),de=n(Ge,"P",{});var po=r(de);Ca=i(po,"The "),Zt=n(po,"A",{href:!0});var kl=r(Zt);qa=i(kl,"ViltForQuestionAnswering"),kl.forEach(o),Na=i(po," forward method, overrides the "),ts=n(po,"CODE",{});var Tl=r(ts);Sa=i(Tl,"__call__"),Tl.forEach(o),Oa=i(po," special method."),po.forEach(o),Da=p(Ge),x(Ie.$$.fragment,Ge),Wa=p(Ge),x(ze.$$.fragment,Ge),Ge.forEach(o),Ke.forEach(o),Ds=p(t),ce=n(t,"H2",{class:!0});var an=r(ce);Ae=n(an,"A",{id:!0,class:!0,href:!0});var yl=r(Ae);os=n(yl,"SPAN",{});var $l=r(os);x(jt.$$.fragment,$l),$l.forEach(o),yl.forEach(o),Ra=p(an),ss=n(an,"SPAN",{});var Vl=r(ss);Ba=i(Vl,"ViltForImagesAndTextClassification"),Vl.forEach(o),an.forEach(o),Ws=p(t),B=n(t,"DIV",{class:!0});var ho=r(B);x(Et.$$.fragment,ho),Qa=p(ho),ns=n(ho,"P",{});var Fl=r(ns);Ua=i(Fl,"Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Fl.forEach(o),Ha=p(ho),O=n(ho,"DIV",{class:!0});var Je=r(O);x(Mt.$$.fragment,Je),Ka=p(Je),me=n(Je,"P",{});var fo=r(me);Ga=i(fo,"The "),Yt=n(fo,"A",{href:!0});var jl=r(Yt);Ja=i(jl,"ViltForImagesAndTextClassification"),jl.forEach(o),Xa=i(fo," forward method, overrides the "),rs=n(fo,"CODE",{});var El=r(rs);Za=i(El,"__call__"),El.forEach(o),Ya=i(fo," special method."),fo.forEach(o),ei=p(Je),x(Le.$$.fragment,Je),ti=p(Je),x(Ce.$$.fragment,Je),Je.forEach(o),ho.forEach(o),Rs=p(t),pe=n(t,"H2",{class:!0});var ln=r(pe);qe=n(ln,"A",{id:!0,class:!0,href:!0});var Ml=r(qe);as=n(Ml,"SPAN",{});var Pl=r(as);x(Pt.$$.fragment,Pl),Pl.forEach(o),Ml.forEach(o),oi=p(ln),is=n(ln,"SPAN",{});var Il=r(is);si=i(Il,"ViltForImageAndTextRetrieval"),Il.forEach(o),ln.forEach(o),Bs=p(t),L=n(t,"DIV",{class:!0});var Xe=r(L);x(It.$$.fragment,Xe),ni=p(Xe),ls=n(Xe,"P",{});var zl=r(ls);ri=i(zl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
