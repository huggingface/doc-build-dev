...
behavior.`),Ki=p(),R=a("div"),w(to.$$.fragment),Yi=p(),we=a("p"),Qi=n("The "),ca=a("a"),Zi=n("BeitModel"),el=n(" forward method, overrides the "),Ya=a("code"),tl=n("__call__"),ol=n(" special method."),al=p(),w(De.$$.fragment),rl=p(),w(Ve.$$.fragment),gs=p(),xe=a("h2"),We=a("a"),Qa=a("span"),w(oo.$$.fragment),sl=p(),Za=a("span"),nl=n("BeitForMaskedImageModeling"),_s=p(),te=a("div"),w(ao.$$.fragment),il=p(),oe=a("p"),ll=n("Beit Model transformer with a \u2018language\u2019 modeling head on top. BEiT does masked image modeling by predicting visual tokens of a Vector-Quantize Variational Autoencoder (VQ-VAE), whereas other vision models like ViT and DeiT predict RGB pixel values. The "),pa=a("a"),dl=n("AutoModelForMaskedImageModeling"),cl=n(" class only supports pixel-based image modeling, so you will need to use "),ma=a("a"),pl=n("BeitForMaskedImageModeling"),ml=n(` directly if you wish to do masked image modeling with BEiT.
