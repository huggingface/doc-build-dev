import{S as Ls,i as Hs,s as Ws,e as n,k as d,w,t as r,M as Us,c as s,d as o,m as c,a,x as v,h as i,b as l,N as Vs,F as e,g as p,y as b,q as S,o as y,B as $}from"../../chunks/vendor-4833417e.js";import{T as Zn}from"../../chunks/Tip-fffd6df1.js";import{D as Oe}from"../../chunks/Docstring-4f315ed9.js";import{C as so}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as at}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Bs(O){let m,T,f,_,k;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,T),e(m,f),e(f,_),e(m,k)},d(u){u&&o(m)}}}function Ks(O){let m,T,f,_,k;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=s(u,"P",{});var g=a(m);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var x=a(f);_=i(x,"Module"),x.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,T),e(m,f),e(f,_),e(m,k)},d(u){u&&o(m)}}}function Ys(O){let m,T,f,_,k;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=s(u,"P",{});var g=a(m);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var x=a(f);_=i(x,"Module"),x.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,T),e(m,f),e(f,_),e(m,k)},d(u){u&&o(m)}}}function Zs(O){let m,T,f,_,k,u,g,x,ao,Ft,D,J,rt,ce,ro,it,io,jt,L,lo,he,co,ho,po,Ct,De,mo,It,Le,lt,fo,At,He,uo,Pt,Q,pe,go,We,_o,wo,vo,me,bo,dt,So,yo,qt,X,Rn,zt,ee,$o,Ue,To,ko,Nt,P,xo,fe,Mo,Eo,ue,Fo,jo,Ot,H,te,ct,ge,Co,ht,Io,Dt,j,_e,Ao,W,Po,Ve,qo,zo,we,No,Oo,Do,U,Lo,Be,Ho,Wo,Ke,Uo,Vo,Bo,ve,Lt,V,oe,pt,be,Ko,mt,Yo,Ht,I,Se,Zo,ye,Ro,$e,Go,Jo,Qo,M,Te,Xo,B,en,Ye,tn,on,ft,nn,sn,an,ne,rn,ut,ln,dn,ke,Wt,K,se,gt,xe,cn,_t,hn,Ut,A,Me,pn,Y,mn,wt,fn,un,Ee,gn,_n,wn,E,Fe,vn,Z,bn,Ze,Sn,yn,vt,$n,Tn,kn,ae,xn,bt,Mn,En,je,Vt,R,re,St,Ce,Fn,yt,jn,Bt,C,Ie,Cn,$t,In,An,Ae,Pn,Pe,qn,zn,Nn,F,qe,On,G,Dn,Re,Ln,Hn,Tt,Wn,Un,Vn,ie,Bn,kt,Kn,Yn,ze,Kt;return u=new at({}),ce=new at({}),ge=new at({}),_e=new Oe({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/models/swin/configuration_swin.py#L29",parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
`}}),ne=new Zn({props:{$$slots:{default:[Bs]},$$scope:{ctx:O}}}),ke=new so({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),xe=new at({}),Me=new Oe({props:{name:"class transformers.SwinForMaskedImageModeling",anchor:"transformers.SwinForMaskedImageModeling",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/models/swin/modeling_swin.py#L989",parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15986/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15986/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Fe=new Oe({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/models/swin/modeling_swin.py#L1004",parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_15986/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
`}}),ae=new Zn({props:{$$slots:{default:[Ks]},$$scope:{ctx:O}}}),je=new so({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),Ce=new at({}),Ie=new Oe({props:{name:"class transformers.SwinForImageClassification",anchor:"transformers.SwinForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/models/swin/modeling_swin.py#L1099",parametersDescription:[{anchor:"transformers.SwinForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15986/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ie=new Zn({props:{$$slots:{default:[Ys]},$$scope:{ctx:O}}}),ze=new so({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
tabby, tabby cat`}}),{c(){m=n("meta"),T=d(),f=n("h1"),_=n("a"),k=n("span"),w(u.$$.fragment),g=d(),x=n("span"),ao=r("Swin Transformer"),Ft=d(),D=n("h2"),J=n("a"),rt=n("span"),w(ce.$$.fragment),ro=d(),it=n("span"),io=r("Overview"),jt=d(),L=n("p"),lo=r("The Swin Transformer was proposed in "),he=n("a"),co=r("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),ho=n("br"),po=r(`
...
architecture.`),Do=d(),U=n("p"),Lo=r("Configuration objects inherit from "),Be=n("a"),Ho=r("PretrainedConfig"),Wo=r(` and can be used to control the model outputs. Read the
documentation from `),Ke=n("a"),Uo=r("PretrainedConfig"),Vo=r(" for more information."),Bo=d(),w(ve.$$.fragment),Lt=d(),V=n("h2"),oe=n("a"),pt=n("span"),w(be.$$.fragment),Ko=d(),mt=n("span"),Yo=r("SwinModel"),Ht=d(),I=n("div"),w(Se.$$.fragment),Zo=d(),ye=n("p"),Ro=r(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wn=d(),E=n("div"),w(Fe.$$.fragment),vn=d(),Z=n("p"),bn=r("The "),Ze=n("a"),Sn=r("SwinForMaskedImageModeling"),yn=r(" forward method, overrides the "),vt=n("code"),$n=r("__call__"),Tn=r(" special method."),kn=d(),w(ae.$$.fragment),xn=d(),bt=n("p"),Mn=r("Examples:"),En=d(),w(je.$$.fragment),Vt=d(),R=n("h2"),re=n("a"),St=n("span"),w(Ce.$$.fragment),Fn=d(),yt=n("span"),jn=r("SwinForImageClassification"),Bt=d(),C=n("div"),w(Ie.$$.fragment),Cn=d(),$t=n("p"),In=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),An=d(),Ae=n("p"),Pn=r("This model is a PyTorch "),Pe=n("a"),qn=r("torch.nn.Module"),zn=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nn=d(),F=n("div"),w(qe.$$.fragment),On=d(),G=n("p"),Dn=r("The "),Re=n("a"),Ln=r("SwinForImageClassification"),Hn=r(" forward method, overrides the "),Tt=n("code"),Wn=r("__call__"),Un=r(" special method."),Vn=d(),w(ie.$$.fragment),Bn=d(),kt=n("p"),Kn=r("Example:"),Yn=d(),w(ze.$$.fragment),this.h()},l(t){const h=Us('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(o),T=c(t),f=s(t,"H1",{class:!0});var Ne=a(f);_=s(Ne,"A",{id:!0,class:!0,href:!0});var xt=a(_);k=s(xt,"SPAN",{});var Mt=a(k);v(u.$$.fragment,Mt),Mt.forEach(o),xt.forEach(o),g=c(Ne),x=s(Ne,"SPAN",{});var Gn=a(x);ao=i(Gn,"Swin Transformer"),Gn.forEach(o),Ne.forEach(o),Ft=c(t),D=s(t,"H2",{class:!0});var Yt=a(D);J=s(Yt,"A",{id:!0,class:!0,href:!0});var Jn=a(J);rt=s(Jn,"SPAN",{});var Qn=a(rt);v(ce.$$.fragment,Qn),Qn.forEach(o),Jn.forEach(o),ro=c(Yt),it=s(Yt,"SPAN",{});var Xn=a(it);io=i(Xn,"Overview"),Xn.forEach(o),Yt.forEach(o),jt=c(t),L=s(t,"P",{});var Et=a(L);lo=i(Et,"The Swin Transformer was proposed in "),he=s(Et,"A",{href:!0,rel:!0});var es=a(he);co=i(es,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),es.forEach(o),ho=s(Et,"BR",{}),po=i(Et,`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Et.forEach(o),Ct=c(t),De=s(t,"P",{});var ts=a(De);mo=i(ts,"The abstract from the paper is the following:"),ts.forEach(o),It=c(t),Le=s(t,"P",{});var os=a(Le);lt=s(os,"EM",{});var ns=a(lt);fo=i(ns,`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
for computer vision. Challenges in adapting Transformer from language to vision arise from differences between the two domains,
such as large variations in the scale of visual entities and the high resolution of pixels in images compared to words in text.
To address these differences, we propose a hierarchical Transformer whose representation is computed with \\bold{S}hifted
\\bold{win}dows. The shifted windowing scheme brings greater efficiency by limiting self-attention computation to non-overlapping
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ot.forEach(o),wn=c(tt),E=s(tt,"DIV",{class:!0});var z=a(E);v(Fe.$$.fragment,z),vn=c(z),Z=s(z,"P",{});var nt=a(Z);bn=i(nt,"The "),Ze=s(nt,"A",{href:!0});var Fs=a(Ze);Sn=i(Fs,"SwinForMaskedImageModeling"),Fs.forEach(o),yn=i(nt," forward method, overrides the "),vt=s(nt,"CODE",{});var js=a(vt);$n=i(js,"__call__"),js.forEach(o),Tn=i(nt," special method."),nt.forEach(o),kn=c(z),v(ae.$$.fragment,z),xn=c(z),bt=s(z,"P",{});var Cs=a(bt);Mn=i(Cs,"Examples:"),Cs.forEach(o),En=c(z),v(je.$$.fragment,z),z.forEach(o),tt.forEach(o),Vt=c(t),R=s(t,"H2",{class:!0});var oo=a(R);re=s(oo,"A",{id:!0,class:!0,href:!0});var Is=a(re);St=s(Is,"SPAN",{});var As=a(St);v(Ce.$$.fragment,As),As.forEach(o),Is.forEach(o),Fn=c(oo),yt=s(oo,"SPAN",{});var Ps=a(yt);jn=i(Ps,"SwinForImageClassification"),Ps.forEach(o),oo.forEach(o),Bt=c(t),C=s(t,"DIV",{class:!0});var de=a(C);v(Ie.$$.fragment,de),Cn=c(de),$t=s(de,"P",{});var qs=a($t);In=i(qs,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),no.forEach(o),Nn=c(de),F=s(de,"DIV",{class:!0});var N=a(F);v(qe.$$.fragment,N),On=c(N),G=s(N,"P",{});var st=a(G);Dn=i(st,"The "),Re=s(st,"A",{href:!0});var Ns=a(Re);Ln=i(Ns,"SwinForImageClassification"),Ns.forEach(o),Hn=i(st," forward method, overrides the "),Tt=s(st,"CODE",{});var Os=a(Tt);Wn=i(Os,"__call__"),Os.forEach(o),Un=i(st," special method."),st.forEach(o),Vn=c(N),v(ie.$$.fragment,N),Bn=c(N),kt=s(N,"P",{});var Ds=a(kt);Kn=i(Ds,"Example:"),Ds.forEach(o),Yn=c(N),v(ze.$$.fragment,N),N.forEach(o),de.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Rs)),l(_,"id","swin-transformer"),l(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(_,"href","#swin-transformer"),l(f,"class","relative group"),l(J,"id","overview"),l(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(J,"href","#overview"),l(D,"class","relative group"),l(he,"href","https://arxiv.org/abs/2103.14030"),l(he,"rel","nofollow"),l(We,"href","/docs/transformers/pr_15986/en/model_doc/auto#transformers.AutoFeatureExtractor"),Vs(X.src,Rn="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/swin_transformer_architecture.png")||l(X,"src",Rn),l(X,"alt","drawing"),l(X,"width","600"),l(Ue,"href","https://arxiv.org/abs/2102.03334"),l(fe,"href","https://huggingface.co/novice03%3E"),l(fe,"rel","nofollow"),l(ue,"href","https://github.com/microsoft/Swin-Transformer"),l(ue,"rel","nofollow"),l(te,"id","transformers.SwinConfig"),l(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(te,"href","#transformers.SwinConfig"),l(H,"class","relative group"),l(Ve,"href","/docs/transformers/pr_15986/en/model_doc/swin#transformers.SwinModel"),l(we,"href","https://huggingface.co/microsoft/swin-tiny-patch4-window7-224"),l(we,"rel","nofollow"),l(Be,"href","/docs/transformers/pr_15986/en/main_classes/configuration#transformers.PretrainedConfig"),l(Ke,"href","/docs/transformers/pr_15986/en/main_classes/configuration#transformers.PretrainedConfig"),l(j,"class","docstring"),l(oe,"id","transformers.SwinModel"),l(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(oe,"href","#transformers.SwinModel"),l(V,"class","relative group"),l($e,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l($e,"rel","nofollow"),l(Ye,"href","/docs/transformers/pr_15986/en/model_doc/swin#transformers.SwinModel"),l(M,"class","docstring"),l(I,"class","docstring"),l(se,"id","transformers.SwinForMaskedImageModeling"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#transformers.SwinForMaskedImageModeling"),l(K,"class","relative group"),l(Ee,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ee,"rel","nofollow"),l(Ze,"href","/docs/transformers/pr_15986/en/model_doc/swin#transformers.SwinForMaskedImageModeling"),l(E,"class","docstring"),l(A,"class","docstring"),l(re,"id","transformers.SwinForImageClassification"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SwinForImageClassification"),l(R,"class","relative group"),l(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Pe,"rel","nofollow"),l(Re,"href","/docs/transformers/pr_15986/en/model_doc/swin#transformers.SwinForImageClassification"),l(F,"class","docstring"),l(C,"class","docstring")},m(t,h){e(document.head,m),p(t,T,h),p(t,f,h),e(f,_),e(_,k),b(u,k,null),e(f,g),e(f,x),e(x,ao),p(t,Ft,h),p(t,D,h),e(D,J),e(J,rt),b(ce,rt,null),e(D,ro),e(D,it),e(it,io),p(t,jt,h),p(t,L,h),e(L,lo),e(L,he),e(he,co),e(L,ho),e(L,po),p(t,Ct,h),p(t,De,h),e(De,mo),p(t,It,h),p(t,Le,h),e(Le,lt),e(lt,fo),p(t,At,h),p(t,He,h),e(He,uo),p(t,Pt,h),p(t,Q,h),e(Q,pe),e(pe,go),e(pe,We),e(We,_o),e(pe,wo),e(Q,vo),e(Q,me),e(me,bo),e(me,dt),e(dt,So),e(me,yo),p(t,qt,h),p(t,X,h),p(t,zt,h),p(t,ee,h),e(ee,$o),e(ee,Ue),e(Ue,To),e(ee,ko),p(t,Nt,h),p(t,P,h),e(P,xo),e(P,fe),e(fe,Mo),e(P,Eo),e(P,ue),e(ue,Fo),e(P,jo),p(t,Ot,h),p(t,H,h),e(H,te),e(te,ct),b(ge,ct,null),e(H,Co),e(H,ht),e(ht,Io),p(t,Dt,h),p(t,j,h),b(_e,j,null),e(j,Ao),e(j,W),e(W,Po),e(W,Ve),e(Ve,qo),e(W,zo),e(W,we),e(we,No),e(W,Oo),e(j,Do),e(j,U),e(U,Lo),e(U,Be),e(Be,Ho),e(U,Wo),e(U,Ke),e(Ke,Uo),e(U,Vo),e(j,Bo),b(ve,j,null),p(t,Lt,h),p(t,V,h),e(V,oe),e(oe,pt),b(be,pt,null),e(V,Ko),e(V,mt),e(mt,Yo),p(t,Ht,h),p(t,I,h),b(Se,I,null),e(I,Zo),e(I,ye),e(ye,Ro),e(ye,$e),e($e,Go),e(ye,Jo),e(I,Qo),e(I,M),b(Te,M,null),e(M,Xo),e(M,B),e(B,en),e(B,Ye),e(Ye,tn),e(B,on),e(B,ft),e(ft,nn),e(B,sn),e(M,an),b(ne,M,null),e(M,rn),e(M,ut),e(ut,ln),e(M,dn),b(ke,M,null),p(t,Wt,h),p(t,K,h),e(K,se),e(se,gt),b(xe,gt,null),e(K,cn),e(K,_t),e(_t,hn),p(t,Ut,h),p(t,A,h),b(Me,A,null),e(A,pn),e(A,Y),e(Y,mn),e(Y,wt),e(wt,fn),e(Y,un),e(Y,Ee),e(Ee,gn),e(Y,_n),e(A,wn),e(A,E),b(Fe,E,null),e(E,vn),e(E,Z),e(Z,bn),e(Z,Ze),e(Ze,Sn),e(Z,yn),e(Z,vt),e(vt,$n),e(Z,Tn),e(E,kn),b(ae,E,null),e(E,xn),e(E,bt),e(bt,Mn),e(E,En),b(je,E,null),p(t,Vt,h),p(t,R,h),e(R,re),e(re,St),b(Ce,St,null),e(R,Fn),e(R,yt),e(yt,jn),p(t,Bt,h),p(t,C,h),b(Ie,C,null),e(C,Cn),e(C,$t),e($t,In),e(C,An),e(C,Ae),e(Ae,Pn),e(Ae,Pe),e(Pe,qn),e(Ae,zn),e(C,Nn),e(C,F),b(qe,F,null),e(F,On),e(F,G),e(G,Dn),e(G,Re),e(Re,Ln),e(G,Hn),e(G,Tt),e(Tt,Wn),e(G,Un),e(F,Vn),b(ie,F,null),e(F,Bn),e(F,kt),e(kt,Kn),e(F,Yn),b(ze,F,null),Kt=!0},p(t,[h]){const Ne={};h&2&&(Ne.$$scope={dirty:h,ctx:t}),ne.$set(Ne);const xt={};h&2&&(xt.$$scope={dirty:h,ctx:t}),ae.$set(xt);const Mt={};h&2&&(Mt.$$scope={dirty:h,ctx:t}),ie.$set(Mt)},i(t){Kt||(S(u.$$.fragment,t),S(ce.$$.fragment,t),S(ge.$$.fragment,t),S(_e.$$.fragment,t),S(ve.$$.fragment,t),S(be.$$.fragment,t),S(Se.$$.fragment,t),S(Te.$$.fragment,t),S(ne.$$.fragment,t),S(ke.$$.fragment,t),S(xe.$$.fragment,t),S(Me.$$.fragment,t),S(Fe.$$.fragment,t),S(ae.$$.fragment,t),S(je.$$.fragment,t),S(Ce.$$.fragment,t),S(Ie.$$.fragment,t),S(qe.$$.fragment,t),S(ie.$$.fragment,t),S(ze.$$.fragment,t),Kt=!0)},o(t){y(u.$$.fragment,t),y(ce.$$.fragment,t),y(ge.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(be.$$.fragment,t),y(Se.$$.fragment,t),y(Te.$$.fragment,t),y(ne.$$.fragment,t),y(ke.$$.fragment,t),y(xe.$$.fragment,t),y(Me.$$.fragment,t),y(Fe.$$.fragment,t),y(ae.$$.fragment,t),y(je.$$.fragment,t),y(Ce.$$.fragment,t),y(Ie.$$.fragment,t),y(qe.$$.fragment,t),y(ie.$$.fragment,t),y(ze.$$.fragment,t),Kt=!1},d(t){o(m),t&&o(T),t&&o(f),$(u),t&&o(Ft),t&&o(D),$(ce),t&&o(jt),t&&o(L),t&&o(Ct),t&&o(De),t&&o(It),t&&o(Le),t&&o(At),t&&o(He),t&&o(Pt),t&&o(Q),t&&o(qt),t&&o(X),t&&o(zt),t&&o(ee),t&&o(Nt),t&&o(P),t&&o(Ot),t&&o(H),$(ge),t&&o(Dt),t&&o(j),$(_e),$(ve),t&&o(Lt),t&&o(V),$(be),t&&o(Ht),t&&o(I),$(Se),$(Te),$(ne),$(ke),t&&o(Wt),t&&o(K),$(xe),t&&o(Ut),t&&o(A),$(Me),$(Fe),$(ae),$(je),t&&o(Vt),t&&o(R),$(Ce),t&&o(Bt),t&&o(C),$(Ie),$(qe),$(ie),$(ze)}}}const Rs={local:"swin-transformer",sections:[{local:"overview",title:"Overview"},{local:"transformers.SwinConfig",title:"SwinConfig"},{local:"transformers.SwinModel",title:"SwinModel"},{local:"transformers.SwinForMaskedImageModeling",title:"SwinForMaskedImageModeling"},{local:"transformers.SwinForImageClassification",title:"SwinForImageClassification"}],title:"Swin Transformer"};function Gs(O,m,T){let{fw:f}=m;return O.$$set=_=>{"fw"in _&&T(0,f=_.fw)},[f]}class na extends Ls{constructor(m){super();Hs(this,m,Gs,Zs,Ws,{fw:0})}}export{na as default,Rs as metadata};
