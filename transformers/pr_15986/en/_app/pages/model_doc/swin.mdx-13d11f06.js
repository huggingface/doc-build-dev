import{S as wa,i as va,s as ba,e as n,k as d,w,t as a,M as Sa,c as s,d as o,m as c,a as i,x as v,h as r,b as l,N as ya,F as e,g as p,y as b,q as S,o as y,B as $}from"../../chunks/vendor-6b77c823.js";import{T as vs}from"../../chunks/Tip-39098574.js";import{D as Le}from"../../chunks/Docstring-abef54e3.js";import{C as fo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as lt}from"../../chunks/IconCopyLink-7a11ce68.js";function $a(H){let m,k,f,_,x;return{c(){m=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),x=a(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,k),e(m,f),e(f,_),e(m,x)},d(u){u&&o(m)}}}function Ta(H){let m,k,f,_,x;return{c(){m=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),x=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=s(u,"P",{});var g=i(m);k=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var E=i(f);_=r(E,"Module"),E.forEach(o),x=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),ae=new vs({props:{$$slots:{default:[$a]},$$scope:{ctx:H}}}),Me=new fo({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
`}}),ie=new vs({props:{$$slots:{default:[Ta]},$$scope:{ctx:H}}}),Ie=new fo({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Ht=d(),He=n("p"),yo=a("The abstract from the paper is the following:"),Wt=d(),We=n("p"),ht=n("em"),$o=a(`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
...
documentation from `),Ze=n("a"),un=a("PretrainedConfig"),gn=a(" for more information."),_n=d(),w(Se.$$.fragment),Gt=d(),Y=n("h2"),se=n("a"),yt=n("span"),w(ye.$$.fragment),wn=d(),$t=n("span"),vn=a("SwinModel"),Jt=d(),P=n("div"),w($e.$$.fragment),bn=d(),Te=n("p"),Sn=a(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ke=n("a"),yn=a("torch.nn.Module"),$n=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Tn=d(),F=n("div"),w(xe.$$.fragment),kn=d(),Z=n("p"),xn=a("The "),Re=n("a"),Mn=a("SwinModel"),En=a(" forward method, overrides the "),Tt=n("code"),Fn=a("__call__"),jn=a(" special method."),Cn=d(),w(ae.$$.fragment),In=d(),kt=n("p"),An=a("Example:"),Pn=d(),w(Me.$$.fragment),Qt=d(),R=n("h2"),re=n("a"),xt=n("span"),w(Ee.$$.fragment),qn=d(),Mt=n("span"),zn=a("SwinForMaskedImageModeling"),Xt=d(),q=n("div"),w(Fe.$$.fragment),On=d(),G=n("p"),Dn=a("Swin Model with a decoder on top for masked image modeling, as proposed in "),Et=n("code"),Nn=a("SimMIM <https://arxiv.org/abs/2111.09886>"),Ln=a(`__.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ls=d(),C=n("div"),w(Oe.$$.fragment),ds=d(),X=n("p"),cs=a("The "),Je=n("a"),hs=a("SwinForImageClassification"),ps=a(" forward method, overrides the "),Pt=n("code"),ms=a("__call__"),fs=a(" special method."),us=d(),w(de.$$.fragment),gs=d(),qt=n("p"),_s=a("Example:"),ws=d(),w(De.$$.fragment),this.h()},l(t){const h=Sa('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(o),k=c(t),f=s(t,"H1",{class:!0});var Ne=i(f);_=s(Ne,"A",{id:!0,class:!0,href:!0});var zt=i(_);x=s(zt,"SPAN",{});var Ot=i(x);v(u.$$.fragment,Ot),Ot.forEach(o),zt.forEach(o),g=c(Ne),E=s(Ne,"SPAN",{});var Ss=i(E);uo=r(Ss,"Swin Transformer"),Ss.forEach(o),Ne.forEach(o),Nt=c(t),W=s(t,"H2",{class:!0});var no=i(W);ee=s(no,"A",{id:!0,class:!0,href:!0});var ys=i(ee);dt=s(ys,"SPAN",{});var $s=i(dt);v(pe.$$.fragment,$s),$s.forEach(o),ys.forEach(o),go=c(no),ct=s(no,"SPAN",{});var Ts=i(ct);_o=r(Ts,"Overview"),Ts.forEach(o),no.forEach(o),Lt=c(t),U=s(t,"P",{});var Dt=i(U);wo=r(Dt,"The Swin Transformer was proposed in "),me=s(Dt,"A",{href:!0,rel:!0});var ks=i(me);vo=r(ks,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),ks.forEach(o),bo=s(Dt,"BR",{}),So=r(Dt,`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Dt.forEach(o),Ht=c(t),He=s(t,"P",{});var xs=i(He);yo=r(xs,"The abstract from the paper is the following:"),xs.forEach(o),Wt=c(t),We=s(t,"P",{});var Ms=i(We);ht=s(Ms,"EM",{});var Es=i(ht);$o=r(Es,`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
for computer vision. Challenges in adapting Transformer from language to vision arise from differences between the two domains,
such as large variations in the scale of visual entities and the high resolution of pixels in images compared to words in text.
To address these differences, we propose a hierarchical Transformer whose representation is computed with \\bold{S}hifted
\\bold{win}dows. The shifted windowing scheme brings greater efficiency by limiting self-attention computation to non-overlapping
