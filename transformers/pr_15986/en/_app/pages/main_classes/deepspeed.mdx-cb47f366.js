...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15986/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
DeepSpeed docs.`),gy=u(),Jt=o("p"),e9=a("This section has to be configured exclusively via DeepSpeed configuration - the "),ki=o("a"),s9=a("Trainer"),t9=a(` provides
no equivalent command line arguments.`),yy=u(),Pi=o("p"),a9=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),wy=u(),zi=o("a"),by=u(),Ds=o("h4"),Xt=o("a"),nd=o("span"),f(Bo.$$.fragment),n9=u(),od=o("span"),o9=a("ZeRO-2 Config"),qy=u(),Di=o("p"),l9=a("The following is an example of configuration for ZeRO stage 2:"),Ey=u(),f(Wo.$$.fragment),$y=u(),Oi=o("p"),ld=o("strong"),r9=a("Performance tuning:"),ky=u(),Ie=o("ul"),Os=o("li"),p9=a("enabling "),rd=o("code"),i9=a("offload_optimizer"),u9=a(" should reduce GPU RAM usage (it requires "),pd=o("code"),c9=a('"stage": 2'),h9=a(")"),f9=u(),A=o("li"),id=o("code"),d9=a('"overlap_comm": true'),m9=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),ud=o("code"),_9=a("overlap_comm"),v9=a(` uses 4.5x
the `),cd=o("code"),j9=a("allgather_bucket_size"),g9=a(" and "),hd=o("code"),y9=a("reduce_bucket_size"),w9=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),fd=o("code"),b9=a("5e8 x 2Bytes x 2 x 4.5"),q9=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),dd=o("code"),E9=a("2e8"),$9=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),k9=u(),md=o("li"),P9=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),Py=u(),Ue=o("p"),z9=a("Additionally, "),_d=o("code"),D9=a("deepspeed==0.4.4"),O9=a(" added a new option "),vd=o("code"),T9=a("round_robin_gradients"),A9=a(" which you can enable with:"),zy=u(),f(Fo.$$.fragment),Dy=u(),Ti=o("p"),S9=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Oy=u(),Ai=o("a"),Ty=u(),Ts=o("h4"),Qt=o("a"),jd=o("span"),f(Vo.$$.fragment),C9=u(),gd=o("span"),x9=a("ZeRO-3 Config"),Ay=u(),Si=o("p"),R9=a("The following is an example of configuration for ZeRO stage 3:"),Sy=u(),f(Yo.$$.fragment),Cy=u(),N=o("p"),I9=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),yd=o("code"),U9=a('"device": "cpu"'),G9=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),wd=o("code"),L9=a("none"),M9=a(" instead of "),bd=o("code"),Z9=a("cpu"),N9=a(" for the "),qd=o("code"),H9=a("device"),B9=a(` entry. Offloading to
NVMe is discussed further down.`),xy=u(),Ge=o("p"),W9=a("Pinned memory is enabled with "),Ed=o("code"),F9=a("pin_memory"),V9=a(" set to "),$d=o("code"),Y9=a("true"),K9=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Ry=u(),Ci=o("p"),kd=o("strong"),J9=a("Performance tuning:"),Iy=u(),ea=o("ul"),Ko=o("li"),Pd=o("code"),X9=a("stage3_max_live_parameters"),Q9=a(": "),zd=o("code"),e7=a("1e9"),s7=u(),Jo=o("li"),Dd=o("code"),t7=a("stage3_max_reuse_distance"),a7=a(": "),Od=o("code"),n7=a("1e9"),Uy=u(),S=o("p"),o7=a("If hitting OOM reduce "),Td=o("code"),l7=a("stage3_max_live_parameters"),r7=a(" and "),Ad=o("code"),p7=a("stage3_max_reuse_distance"),i7=a(`. They should have minimal impact
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),eh.forEach(t),gy=c(e),Jt=l(e,"P",{});var K0=r(Jt);e9=n(K0,"This section has to be configured exclusively via DeepSpeed configuration - the "),ki=l(K0,"A",{href:!0});var HL=r(ki);s9=n(HL,"Trainer"),HL.forEach(t),t9=n(K0,` provides
no equivalent command line arguments.`),K0.forEach(t),yy=c(e),Pi=l(e,"P",{});var BL=r(Pi);a9=n(BL,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),BL.forEach(t),wy=c(e),zi=l(e,"A",{id:!0}),r(zi).forEach(t),by=c(e),Ds=l(e,"H4",{class:!0});var J0=r(Ds);Xt=l(J0,"A",{id:!0,class:!0,href:!0});var WL=r(Xt);nd=l(WL,"SPAN",{});var FL=r(nd);d(Bo.$$.fragment,FL),FL.forEach(t),WL.forEach(t),n9=c(J0),od=l(J0,"SPAN",{});var VL=r(od);o9=n(VL,"ZeRO-2 Config"),VL.forEach(t),J0.forEach(t),qy=c(e),Di=l(e,"P",{});var YL=r(Di);l9=n(YL,"The following is an example of configuration for ZeRO stage 2:"),YL.forEach(t),Ey=c(e),d(Wo.$$.fragment,e),$y=c(e),Oi=l(e,"P",{});var KL=r(Oi);ld=l(KL,"STRONG",{});var JL=r(ld);r9=n(JL,"Performance tuning:"),JL.forEach(t),KL.forEach(t),ky=c(e),Ie=l(e,"UL",{});var sh=r(Ie);Os=l(sh,"LI",{});var th=r(Os);p9=n(th,"enabling "),rd=l(th,"CODE",{});var XL=r(rd);i9=n(XL,"offload_optimizer"),XL.forEach(t),u9=n(th," should reduce GPU RAM usage (it requires "),pd=l(th,"CODE",{});var QL=r(pd);c9=n(QL,'"stage": 2'),QL.forEach(t),h9=n(th,")"),th.forEach(t),f9=c(sh),A=l(sh,"LI",{});var K=r(A);id=l(K,"CODE",{});var eM=r(id);d9=n(eM,'"overlap_comm": true'),eM.forEach(t),m9=n(K," trades off increased GPU RAM usage to lower all-reduce latency. "),ud=l(K,"CODE",{});var sM=r(ud);_9=n(sM,"overlap_comm"),sM.forEach(t),v9=n(K,` uses 4.5x
the `),cd=l(K,"CODE",{});var tM=r(cd);j9=n(tM,"allgather_bucket_size"),tM.forEach(t),g9=n(K," and "),hd=l(K,"CODE",{});var aM=r(hd);y9=n(aM,"reduce_bucket_size"),aM.forEach(t),w9=n(K,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),fd=l(K,"CODE",{});var nM=r(fd);b9=n(nM,"5e8 x 2Bytes x 2 x 4.5"),nM.forEach(t),q9=n(K,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),dd=l(K,"CODE",{});var oM=r(dd);E9=n(oM,"2e8"),oM.forEach(t),$9=n(K,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),K.forEach(t),k9=c(sh),md=l(sh,"LI",{});var lM=r(md);P9=n(lM,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),lM.forEach(t),sh.forEach(t),Py=c(e),Ue=l(e,"P",{});var ah=r(Ue);z9=n(ah,"Additionally, "),_d=l(ah,"CODE",{});var rM=r(_d);D9=n(rM,"deepspeed==0.4.4"),rM.forEach(t),O9=n(ah," added a new option "),vd=l(ah,"CODE",{});var pM=r(vd);T9=n(pM,"round_robin_gradients"),pM.forEach(t),A9=n(ah," which you can enable with:"),ah.forEach(t),zy=c(e),d(Fo.$$.fragment,e),Dy=c(e),Ti=l(e,"P",{});var iM=r(Ti);S9=n(iM,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),iM.forEach(t),Oy=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Ty=c(e),Ts=l(e,"H4",{class:!0});var X0=r(Ts);Qt=l(X0,"A",{id:!0,class:!0,href:!0});var uM=r(Qt);jd=l(uM,"SPAN",{});var cM=r(jd);d(Vo.$$.fragment,cM),cM.forEach(t),uM.forEach(t),C9=c(X0),gd=l(X0,"SPAN",{});var hM=r(gd);x9=n(hM,"ZeRO-3 Config"),hM.forEach(t),X0.forEach(t),Ay=c(e),Si=l(e,"P",{});var fM=r(Si);R9=n(fM,"The following is an example of configuration for ZeRO stage 3:"),fM.forEach(t),Sy=c(e),d(Yo.$$.fragment,e),Cy=c(e),N=l(e,"P",{});var hs=r(N);I9=n(hs,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),yd=l(hs,"CODE",{});var dM=r(yd);U9=n(dM,'"device": "cpu"'),dM.forEach(t),G9=n(hs,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),wd=l(hs,"CODE",{});var mM=r(wd);L9=n(mM,"none"),mM.forEach(t),M9=n(hs," instead of "),bd=l(hs,"CODE",{});var _M=r(bd);Z9=n(_M,"cpu"),_M.forEach(t),N9=n(hs," for the "),qd=l(hs,"CODE",{});var vM=r(qd);H9=n(vM,"device"),vM.forEach(t),B9=n(hs,` entry. Offloading to
NVMe is discussed further down.`),hs.forEach(t),xy=c(e),Ge=l(e,"P",{});var nh=r(Ge);W9=n(nh,"Pinned memory is enabled with "),Ed=l(nh,"CODE",{});var jM=r(Ed);F9=n(jM,"pin_memory"),jM.forEach(t),V9=n(nh," set to "),$d=l(nh,"CODE",{});var gM=r($d);Y9=n(gM,"true"),gM.forEach(t),K9=n(nh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),nh.forEach(t),Ry=c(e),Ci=l(e,"P",{});var yM=r(Ci);kd=l(yM,"STRONG",{});var wM=r(kd);J9=n(wM,"Performance tuning:"),wM.forEach(t),yM.forEach(t),Iy=c(e),ea=l(e,"UL",{});var Q0=r(ea);Ko=l(Q0,"LI",{});var eq=r(Ko);Pd=l(eq,"CODE",{});var bM=r(Pd);X9=n(bM,"stage3_max_live_parameters"),bM.forEach(t),Q9=n(eq,": "),zd=l(eq,"CODE",{});var qM=r(zd);e7=n(qM,"1e9"),qM.forEach(t),eq.forEach(t),s7=c(Q0),Jo=l(Q0,"LI",{});var sq=r(Jo);Dd=l(sq,"CODE",{});var EM=r(Dd);t7=n(EM,"stage3_max_reuse_distance"),EM.forEach(t),a7=n(sq,": "),Od=l(sq,"CODE",{});var $M=r(Od);n7=n($M,"1e9"),$M.forEach(t),sq.forEach(t),Q0.forEach(t),Uy=c(e),S=l(e,"P",{});var de=r(S);o7=n(de,"If hitting OOM reduce "),Td=l(de,"CODE",{});var kM=r(Td);l7=n(kM,"stage3_max_live_parameters"),kM.forEach(t),r7=n(de," and "),Ad=l(de,"CODE",{});var PM=r(Ad);p7=n(PM,"stage3_max_reuse_distance"),PM.forEach(t),i7=n(de,`. They should have minimal impact
