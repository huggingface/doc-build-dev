import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as r,M as sn,c as s,d as n,m as u,a as i,x as $,h as a,b as l,F as t,g as d,y as A,L as rn,q as P,o as N,B as I}from"../../chunks/vendor-6b77c823.js";import{D as xt}from"../../chunks/Docstring-abef54e3.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zt}from"../../chunks/IconCopyLink-7a11ce68.js";function an(Se){let g,V,h,f,le,U,Ke,ce,De,_e,b,T,de,W,Re,pe,Fe,ge,k,Oe,S,Be,je,K,Xe,Ce,ke,J,Ye,ye,G,He,ve,Q,ue,Ve,be,Z,Je,we,D,Te,L,Ge,ee,Qe,Ze,Le,R,qe,q,et,te,tt,nt,xe,y,ot,F,st,it,O,rt,at,ze,w,x,me,B,lt,he,ct,Me,m,j,dt,_,pt,ne,ut,mt,oe,ht,ft,X,_t,gt,kt,C,yt,se,vt,bt,wt,z,Y,Tt,fe,Lt,qt,ie,H,Ee;return U=new zt({}),W=new zt({}),D=new en({props:{code:`from transformers import LukeModel
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.MLukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16352/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16352/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16352/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p><a
  href="/docs/transformers/pr_16352/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16352/src/transformers/models/mluke/tokenization_mluke.py#L1493"}}),{c(){g=o("meta"),V=p(),h=o("h1"),f=o("a"),le=o("span"),E(U.$$.fragment),Ke=p(),ce=o("span"),De=r("mLUKE"),_e=p(),b=o("h2"),T=o("a"),de=o("span"),E(W.$$.fragment),Re=p(),pe=o("span"),Fe=r("Overview"),ge=p(),k=o("p"),Oe=r("The mLUKE model was proposed in "),S=o("a"),Be=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),je=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
classification, cloze-style knowledge completion.`),ye=p(),G=o("p"),He=r("The abstract from the paper is the following:"),ve=p(),Q=o("p"),ue=o("em"),Ve=r(`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
...
of the `),K=s(re,"A",{href:!0,rel:!0});var Ut=i(K);Xe=a(Ut,"LUKE model"),Ut.forEach(n),Ce=a(re," trained on the basis of XLM-RoBERTa."),re.forEach(n),ke=u(e),J=s(e,"P",{});var Wt=i(J);Ye=a(Wt,`It is based on XLM-RoBERTa and adds entity embeddings, which helps improve performance on various downstream tasks
involving reasoning about entities such as named entity recognition, extractive question answering, relation
