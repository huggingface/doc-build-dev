...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16004/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_16004/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7f4955ad3270>"}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),zo=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_utils.py#L194"}}),Do=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16004/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16004/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_16004/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16004/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_16004/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_16004/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_16004/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16004/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16004/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_16004/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
post`),zk=r("."),Dk=l(),Jd=o("p"),Ak=r("Examples:"),Gk=l(),c(Ys.$$.fragment),Sk=l(),fe=o("div"),c(Ks.$$.fragment),Nk=l(),Qd=o("p"),Ck=r("Generates sequences for models with a language modeling head using greedy decoding."),Ik=l(),ep=o("p"),Bk=r("Examples:"),Wk=l(),c(Zs.$$.fragment),Uk=l(),be=o("div"),c(Js.$$.fragment),Hk=l(),tp=o("p"),Vk=r("Generates sequences for models with a language modeling head using beam search decoding."),Xk=l(),np=o("p"),Rk=r("Examples:"),Yk=l(),c(Qs.$$.fragment),Kk=l(),jn=o("div"),c(ea.$$.fragment),Zk=l(),ta=o("p"),Jk=r("Implement in subclasses of "),cr=o("a"),Qk=r("PreTrainedModel"),e0=r(" for custom behavior to prepare inputs in the generate method."),t0=l(),ve=o("div"),c(na.$$.fragment),n0=l(),op=o("p"),o0=r("Generates sequences for models with a language modeling head using multinomial sampling."),s0=l(),sp=o("p"),a0=r("Examples:"),r0=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),i0=l(),aa=o("p"),l0=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),d0=r("TFPreTrainedModel"),p0=r("."),c0=l(),$n=o("div"),c(ra.$$.fragment),m0=l(),ia=o("p"),u0=r("Implement in subclasses of "),ur=o("a"),g0=r("PreTrainedModel"),h0=r(" for custom behavior to adjust the logits in the generate method."),_0=l(),N=o("div"),c(la.$$.fragment),f0=l(),ap=o("p"),b0=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),v0=l(),da=o("p"),y0=r("Adapted in part from "),pa=o("a"),k0=r(`Facebook\u2019s XLM beam search
code`),x0=r("."),w0=l(),Ee=o("p"),T0=r("Apart from "),rp=o("code"),j0=r("input_ids"),$0=r(" and "),ip=o("code"),M0=r("attention_mask"),P0=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),E0=r("PretrainedConfig"),L0=r(` of the model. The default values indicated are the default
values of those config.`),q0=l(),ca=o("p"),F0=r("Most of these parameters are explained in more detail in "),ma=o("a"),O0=r(`this blog
post`),z0=r("."),D0=l(),lp=o("p"),A0=r("Examples:"),G0=l(),c(ua.$$.fragment),S0=l(),ye=o("div"),c(ga.$$.fragment),N0=l(),dp=o("p"),C0=r("Generates sequences for models with a language modeling head using greedy decoding."),I0=l(),pp=o("p"),B0=r("Examples:"),W0=l(),c(ha.$$.fragment),U0=l(),Mn=o("div"),c(_a.$$.fragment),H0=l(),fa=o("p"),V0=r("Implement in subclasses of "),hr=o("a"),X0=r("TFPreTrainedModel"),R0=r(" for custom behavior to prepare inputs in the generate method."),Y0=l(),ke=o("div"),c(ba.$$.fragment),K0=l(),cp=o("p"),Z0=r("Generates sequences for models with a language modeling head using multinomial sampling."),J0=l(),mp=o("p"),Q0=r("Examples:"),ex=l(),c(va.$$.fragment),ac=l(),Le=o("div"),c(ya.$$.fragment),tx=l(),ka=o("p"),nx=r("A class containing all of the functions supporting generation, to be used as a mixin in "),_r=o("a"),ox=r("FlaxPreTrainedModel"),sx=r("."),ax=l(),H=o("div"),c(xa.$$.fragment),rx=l(),up=o("p"),ix=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
`),Ua=s(we,"A",{href:!0});var Xx=a(Ua);ru=i(Xx,"FlaxGenerationMixin"),Xx.forEach(t),iu=i(we," (for the Flax/JAX models)."),we.forEach(t),Gp=d(n),ot=s(n,"H2",{class:!0});var pc=a(ot);Tt=s(pc,"A",{id:!0,class:!0,href:!0});var Rx=a(Tt);Ur=s(Rx,"SPAN",{});var Yx=a(Ur);m(Hn.$$.fragment,Yx),Yx.forEach(t),Rx.forEach(t),lu=d(pc),Hr=s(pc,"SPAN",{});var Kx=a(Hr);du=i(Kx,"PreTrainedModel"),Kx.forEach(t),pc.forEach(t),Sp=d(n),w=s(n,"DIV",{class:!0});var j=a(w);m(Vn.$$.fragment,j),pu=d(j),Vr=s(j,"P",{});var Zx=a(Vr);cu=i(Zx,"Base class for all models."),Zx.forEach(t),mu=d(j),Ha=s(j,"P",{});var Ox=a(Ha);Va=s(Ox,"A",{href:!0});var Jx=a(Va);uu=i(Jx,"PreTrainedModel"),Jx.forEach(t),gu=i(Ox,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),Ox.forEach(t),hu=d(j),Xn=s(j,"UL",{});var cc=a(Xn);Xr=s(cc,"LI",{});var Qx=a(Xr);_u=i(Qx,"resize the input embeddings,"),Qx.forEach(t),fu=d(cc),Rr=s(cc,"LI",{});var ew=a(Rr);bu=i(ew,"prune heads in the self-attention heads."),ew.forEach(t),cc.forEach(t),vu=d(j),Yr=s(j,"P",{});var tw=a(Yr);yu=i(tw,"Class attributes (overridden by derived classes):"),tw.forEach(t),ku=d(j),ne=s(j,"UL",{});var Ye=a(ne);Kr=s(Ye,"LI",{});var nw=a(Kr);Ae=s(nw,"P",{});var Fa=a(Ae);Zr=s(Fa,"STRONG",{});var ow=a(Zr);xu=i(ow,"config_class"),ow.forEach(t),wu=i(Fa," ("),Xa=s(Fa,"A",{href:!0});var sw=a(Xa);Tu=i(sw,"PretrainedConfig"),sw.forEach(t),ju=i(Fa,") \u2014 A subclass of "),Ra=s(Fa,"A",{href:!0});var aw=a(Ra);$u=i(aw,"PretrainedConfig"),aw.forEach(t),Mu=i(Fa,` to use as configuration class
for this model architecture.`),Fa.forEach(t),nw.forEach(t),Pu=d(Ye),Rn=s(Ye,"LI",{});var mc=a(Rn);Ge=s(mc,"P",{});var Oa=a(Ge);Jr=s(Oa,"STRONG",{});var rw=a(Jr);Eu=i(rw,"load_tf_weights"),rw.forEach(t),Lu=i(Oa," ("),Qr=s(Oa,"CODE",{});var iw=a(Qr);qu=i(iw,"Callable"),iw.forEach(t),Fu=i(Oa,") \u2014 A python "),ei=s(Oa,"EM",{});var lw=a(ei);Ou=i(lw,"method"),lw.forEach(t),zu=i(Oa,` for loading a TensorFlow checkpoint in a PyTorch model,
taking as arguments:`),Oa.forEach(t),Du=d(mc),st=s(mc,"UL",{});var br=a(st);jt=s(br,"LI",{});var jp=a(jt);ti=s(jp,"STRONG",{});var dw=a(ti);Au=i(dw,"model"),dw.forEach(t),Gu=i(jp," ("),Ya=s(jp,"A",{href:!0});var pw=a(Ya);Su=i(pw,"PreTrainedModel"),pw.forEach(t),Nu=i(jp,") \u2014 An instance of the model on which to load the TensorFlow checkpoint."),jp.forEach(t),Cu=d(br),$t=s(br,"LI",{});var $p=a($t);ni=s($p,"STRONG",{});var cw=a(ni);Iu=i(cw,"config"),cw.forEach(t),Bu=i($p," ("),oi=s($p,"CODE",{});var mw=a(oi);Wu=i(mw,"PreTrainedConfig"),mw.forEach(t),Uu=i($p,") \u2014 An instance of the configuration associated to the model."),$p.forEach(t),Hu=d(br),Mt=s(br,"LI",{});var Mp=a(Mt);si=s(Mp,"STRONG",{});var uw=a(si);Vu=i(uw,"path"),uw.forEach(t),Xu=i(Mp," ("),ai=s(Mp,"CODE",{});var gw=a(ai);Ru=i(gw,"str"),gw.forEach(t),Yu=i(Mp,") \u2014 A path to the TensorFlow checkpoint."),Mp.forEach(t),br.forEach(t),mc.forEach(t),Ku=d(Ye),ri=s(Ye,"LI",{});var hw=a(ri);Pt=s(hw,"P",{});var Pp=a(Pt);ii=s(Pp,"STRONG",{});var _w=a(ii);Zu=i(_w,"base_model_prefix"),_w.forEach(t),Ju=i(Pp," ("),li=s(Pp,"CODE",{});var fw=a(li);Qu=i(fw,"str"),fw.forEach(t),eg=i(Pp,`) \u2014 A string indicating the attribute associated to the base model in derived
...
models, `),_i=s(Oe,"CODE",{});var jw=a(_i);ug=i(jw,"pixel_values"),jw.forEach(t),gg=i(Oe," for vision models and "),fi=s(Oe,"CODE",{});var $w=a(fi);hg=i($w,"input_values"),$w.forEach(t),_g=i(Oe," for speech models)."),Oe.forEach(t),kw.forEach(t),Ye.forEach(t),fg=d(j),le=s(j,"DIV",{class:!0});var En=a(le);m(Yn.$$.fragment,En),bg=d(En),Kn=s(En,"P",{});var uc=a(Kn);vg=i(uc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),bi=s(uc,"CODE",{});var Mw=a(bi);yg=i(Mw,"repo_path_or_name"),Mw.forEach(t),kg=i(uc,"."),uc.forEach(t),xg=d(En),vi=s(En,"P",{});var Pw=a(vi);wg=i(Pw,"Examples:"),Pw.forEach(t),Tg=d(En),m(Zn.$$.fragment,En),En.forEach(t),jg=d(j),z=s(j,"DIV",{class:!0});var C=a(z);m(Jn.$$.fragment,C),$g=d(C),yi=s(C,"P",{});var Ew=a(yi);Mg=i(Ew,"Instantiate a pretrained pytorch model from a pre-trained model configuration."),Ew.forEach(t),Pg=d(C),at=s(C,"P",{});var vr=a(at);Eg=i(vr,"The model is set in evaluation mode by default using "),ki=s(vr,"CODE",{});var Lw=a(ki);Lg=i(Lw,"model.eval()"),Lw.forEach(t),qg=i(vr,` (Dropout modules are deactivated). To train
the model, you should first set it back in training mode with `),xi=s(vr,"CODE",{});var qw=a(xi);Fg=i(qw,"model.train()"),qw.forEach(t),Og=i(vr,"."),vr.forEach(t),zg=d(C),Qn=s(C,"P",{});var gc=a(Qn);Dg=i(gc,"The warning "),wi=s(gc,"EM",{});var Fw=a(wi);Ag=i(Fw,"Weights from XXX not initialized from pretrained model"),Fw.forEach(t),Gg=i(gc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),hc.forEach(t),Bg=d(C),m(Lt.$$.fragment,C),Wg=d(C),m(qt.$$.fragment,C),Ug=d(C),ji=s(C,"P",{});var zw=a(ji);Hg=i(zw,"Examples:"),zw.forEach(t),Vg=d(C),m(to.$$.fragment,C),C.forEach(t),Xg=d(j),Ft=s(j,"DIV",{class:!0});var _c=a(Ft);m(no.$$.fragment,_c),Rg=d(_c),$i=s(_c,"P",{});var Dw=a($i);Yg=i(Dw,"Returns the model\u2019s input embeddings."),Dw.forEach(t),_c.forEach(t),Kg=d(j),Ot=s(j,"DIV",{class:!0});var fc=a(Ot);m(oo.$$.fragment,fc),Zg=d(fc),Mi=s(fc,"P",{});var Aw=a(Mi);Jg=i(Aw,"Returns the model\u2019s output embeddings."),Aw.forEach(t),fc.forEach(t),Qg=d(j),Se=s(j,"DIV",{class:!0});var yr=a(Se);m(so.$$.fragment,yr),eh=d(yr),Pi=s(yr,"P",{});var Gw=a(Pi);th=i(Gw,"Deactivates gradient checkpointing for the current model."),Gw.forEach(t),nh=d(yr),Ei=s(yr,"P",{});var Sw=a(Ei);oh=i(Sw,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Sw.forEach(t),yr.forEach(t),sh=d(j),Ne=s(j,"DIV",{class:!0});var kr=a(Ne);m(ao.$$.fragment,kr),ah=d(kr),Li=s(kr,"P",{});var Nw=a(Li);rh=i(Nw,"Activates gradient checkpointing for the current model."),Nw.forEach(t),ih=d(kr),qi=s(kr,"P",{});var Cw=a(qi);lh=i(Cw,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Cw.forEach(t),kr.forEach(t),dh=d(j),zt=s(j,"DIV",{class:!0});var bc=a(zt);m(ro.$$.fragment,bc),ph=d(bc),Fi=s(bc,"P",{});var Iw=a(Fi);ch=i(Iw,"If needed prunes and maybe initializes weights."),Iw.forEach(t),bc.forEach(t),mh=d(j),Dt=s(j,"DIV",{class:!0});var vc=a(Dt);m(io.$$.fragment,vc),uh=d(vc),Oi=s(vc,"P",{});var Bw=a(Oi);gh=i(Bw,`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),Bw.forEach(t),vc.forEach(t),hh=d(j),At=s(j,"DIV",{class:!0});var yc=a(At);m(lo.$$.fragment,yc),_h=d(yc),zi=s(yc,"P",{});var Ww=a(zi);fh=i(Ww,"Prunes heads of the base model."),Ww.forEach(t),yc.forEach(t),bh=d(j),Ce=s(j,"DIV",{class:!0});var xr=a(Ce);m(po.$$.fragment,xr),vh=d(xr),Di=s(xr,"P",{});var Uw=a(Di);yh=i(Uw,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Uw.forEach(t),kh=d(xr),m(Gt.$$.fragment,xr),xr.forEach(t),xh=d(j),Ie=s(j,"DIV",{class:!0});var wr=a(Ie);m(co.$$.fragment,wr),wh=d(wr),mo=s(wr,"P",{});var kc=a(mo);Th=i(kc,"Resizes input token embeddings matrix of the model if "),Ai=s(kc,"CODE",{});var Hw=a(Ai);jh=i(Hw,"new_num_tokens != config.vocab_size"),Hw.forEach(t),$h=i(kc,"."),kc.forEach(t),Mh=d(wr),uo=s(wr,"P",{});var xc=a(uo);Ph=i(xc,"Takes care of tying weights embeddings afterwards if the model class has a "),Gi=s(xc,"CODE",{});var Vw=a(Gi);Eh=i(Vw,"tie_weights()"),Vw.forEach(t),Lh=i(xc," method."),xc.forEach(t),wr.forEach(t),qh=d(j),St=s(j,"DIV",{class:!0});var wc=a(St);m(go.$$.fragment,wc),Fh=d(wc),ho=s(wc,"P",{});var Tc=a(ho);Oh=i(Tc,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=s(Tc,"CODE",{});var Xw=a(Si);zh=i(Xw,"[from_pretrained()](/docs/transformers/pr_16004/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Xw.forEach(t),Dh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var Rw=a(Ni);Sh=i(Rw,"Set model\u2019s input embeddings."),Rw.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var Yw=a(Ci);Ih=i(Yw,"Tie the weights between the input embeddings and the output embeddings."),Yw.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var Kw=a(Ii);Uh=i(Kw,"torchscript"),Kw.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),$c.forEach(t),Tr.forEach(t),j.forEach(t),Np=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cp=d(n),rt=s(n,"H3",{class:!0});var Mc=a(rt);Ct=s(Mc,"A",{id:!0,class:!0,href:!0});var Zw=a(Ct);Bi=s(Zw,"SPAN",{});var Jw=a(Bi);m(vo.$$.fragment,Jw),Jw.forEach(t),Zw.forEach(t),Vh=d(Mc),Wi=s(Mc,"SPAN",{});var Qw=a(Wi);Xh=i(Qw,"Model Instantiation dtype"),Qw.forEach(t),Mc.forEach(t),Ip=d(n),de=s(n,"P",{});var Ln=a(de);Rh=i(Ln,"Under Pytorch a model normally gets instantiated with "),Ui=s(Ln,"CODE",{});var eT=a(Ui);Yh=i(eT,"torch.float32"),eT.forEach(t),Kh=i(Ln,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(Ln,"CODE",{});var tT=a(Hi);Zh=i(tT,"dtype"),tT.forEach(t),Jh=i(Ln," using "),Vi=s(Ln,"CODE",{});var nT=a(Vi);Qh=i(nT,"torch_dtype"),nT.forEach(t),e_=i(Ln," argument:"),Ln.forEach(t),Bp=d(n),m(yo.$$.fragment,n),Wp=d(n),We=s(n,"P",{});var jr=a(We);t_=i(jr,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s(jr,"CODE",{});var oT=a(Xi);n_=i(oT,'"auto"'),oT.forEach(t),o_=i(jr,`,
and then `),Ri=s(jr,"CODE",{});var sT=a(Ri);s_=i(sT,"dtype"),sT.forEach(t),a_=i(jr," will be automatically derived from the model\u2019s weights:"),jr.forEach(t),Up=d(n),m(ko.$$.fragment,n),Hp=d(n),It=s(n,"P",{});var Pc=a(It);r_=i(Pc,"Models instantiated from scratch can also be told which "),Yi=s(Pc,"CODE",{});var aT=a(Yi);i_=i(aT,"dtype"),aT.forEach(t),l_=i(Pc," to use with:"),Pc.forEach(t),Vp=d(n),m(xo.$$.fragment,n),Xp=d(n),Za=s(n,"P",{});var rT=a(Za);d_=i(rT,"Due to Pytorch design, this functionality is only available for floating dtypes."),rT.forEach(t),Rp=d(n),it=s(n,"H2",{class:!0});var Ec=a(it);Bt=s(Ec,"A",{id:!0,class:!0,href:!0});var iT=a(Bt);Ki=s(iT,"SPAN",{});var lT=a(Ki);m(wo.$$.fragment,lT),lT.forEach(t),iT.forEach(t),p_=d(Ec),Zi=s(Ec,"SPAN",{});var dT=a(Zi);c_=i(dT,"ModuleUtilsMixin"),dT.forEach(t),Ec.forEach(t),Yp=d(n),L=s(n,"DIV",{class:!0});var D=a(L);m(To.$$.fragment,D),m_=d(D),jo=s(D,"P",{});var Lc=a(jo);u_=i(Lc,"A few utilities for "),Ji=s(Lc,"CODE",{});var pT=a(Ji);g_=i(pT,"torch.nn.Modules"),pT.forEach(t),h_=i(Lc,", to be used as a mixin."),Lc.forEach(t),__=d(D),Ue=s(D,"DIV",{class:!0});var $r=a(Ue);m($o.$$.fragment,$r),f_=d($r),Qi=s($r,"P",{});var cT=a(Qi);b_=i(cT,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),cT.forEach(t),v_=d($r),lt=s($r,"P",{});var Mr=a(lt);y_=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var mT=a(el);k_=i(mT,"mem_rss_diff"),mT.forEach(t),x_=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var uT=a(tl);w_=i(uT,"model.reset_memory_hooks_state()"),uT.forEach(t),T_=i(Mr,"."),Mr.forEach(t),$r.forEach(t),j_=d(D),Wt=s(D,"DIV",{class:!0});var qc=a(Wt);m(Mo.$$.fragment,qc),$_=d(qc),nl=s(qc,"P",{});var gT=a(nl);M_=i(gT,"Helper function to estimate the total number of tokens from the model inputs."),gT.forEach(t),qc.forEach(t),P_=d(D),Ut=s(D,"DIV",{class:!0});var Fc=a(Ut);m(Po.$$.fragment,Fc),E_=d(Fc),dt=s(Fc,"P",{});var Pr=a(dt);L_=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
...
paper`),_T.forEach(t),z_=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fc.forEach(t),D_=d(D),Ht=s(D,"DIV",{class:!0});var Oc=a(Ht);m(Lo.$$.fragment,Oc),A_=d(Oc),sl=s(Oc,"P",{});var fT=a(sl);G_=i(fT,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),fT.forEach(t),Oc.forEach(t),S_=d(D),Vt=s(D,"DIV",{class:!0});var zc=a(Vt);m(qo.$$.fragment,zc),N_=d(zc),al=s(zc,"P",{});var bT=a(al);C_=i(bT,"Prepare the head mask if needed."),bT.forEach(t),zc.forEach(t),I_=d(D),Xt=s(D,"DIV",{class:!0});var Dc=a(Xt);m(Fo.$$.fragment,Dc),B_=d(Dc),rl=s(Dc,"P",{});var vT=a(rl);W_=i(vT,"Invert an attention mask (e.g., switches 0. and 1.)."),vT.forEach(t),Dc.forEach(t),U_=d(D),Rt=s(D,"DIV",{class:!0});var Ac=a(Rt);m(Oo.$$.fragment,Ac),H_=d(Ac),il=s(Ac,"P",{});var yT=a(il);V_=i(yT,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),yT.forEach(t),Ac.forEach(t),X_=d(D),Yt=s(D,"DIV",{class:!0});var Gc=a(Yt);m(zo.$$.fragment,Gc),R_=d(Gc),pt=s(Gc,"P",{});var Er=a(pt);Y_=i(Er,"Reset the "),ll=s(Er,"CODE",{});var kT=a(ll);K_=i(kT,"mem_rss_diff"),kT.forEach(t),Z_=i(Er," attribute of each module (see "),Ja=s(Er,"A",{href:!0});var xT=a(Ja);J_=i(xT,"add_memory_hooks()"),xT.forEach(t),Q_=i(Er,")."),Er.forEach(t),Gc.forEach(t),D.forEach(t),Kp=d(n),ct=s(n,"H2",{class:!0});var Sc=a(ct);Kt=s(Sc,"A",{id:!0,class:!0,href:!0});var wT=a(Kt);dl=s(wT,"SPAN",{});var TT=a(dl);m(Do.$$.fragment,TT),TT.forEach(t),wT.forEach(t),ef=d(Sc),pl=s(Sc,"SPAN",{});var jT=a(pl);tf=i(jT,"TFPreTrainedModel"),jT.forEach(t),Sc.forEach(t),Zp=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),nf=d(k),cl=s(k,"P",{});var $T=a(cl);of=i($T,"Base class for all TF models."),$T.forEach(t),sf=d(k),Qa=s(k,"P",{});var zx=a(Qa);er=s(zx,"A",{href:!0});var MT=a(er);af=i(MT,"TFPreTrainedModel"),MT.forEach(t),rf=i(zx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),zx.forEach(t),lf=d(k),Go=s(k,"UL",{});var Nc=a(Go);ml=s(Nc,"LI",{});var PT=a(ml);df=i(PT,"resize the input embeddings,"),PT.forEach(t),pf=d(Nc),ul=s(Nc,"LI",{});var ET=a(ul);cf=i(ET,"prune heads in the self-attention heads."),ET.forEach(t),Nc.forEach(t),mf=d(k),gl=s(k,"P",{});var LT=a(gl);uf=i(LT,"Class attributes (overridden by derived classes):"),LT.forEach(t),gf=d(k),mt=s(k,"UL",{});var Lr=a(mt);He=s(Lr,"LI",{});var za=a(He);hl=s(za,"STRONG",{});var qT=a(hl);hf=i(qT,"config_class"),qT.forEach(t),_f=i(za," ("),tr=s(za,"A",{href:!0});var FT=a(tr);ff=i(FT,"PretrainedConfig"),FT.forEach(t),bf=i(za,") \u2014 A subclass of "),nr=s(za,"A",{href:!0});var OT=a(nr);vf=i(OT,"PretrainedConfig"),OT.forEach(t),yf=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),kf=d(Lr),Zt=s(Lr,"LI",{});var Lp=a(Zt);_l=s(Lp,"STRONG",{});var zT=a(_l);xf=i(zT,"base_model_prefix"),zT.forEach(t),wf=i(Lp," ("),fl=s(Lp,"CODE",{});var DT=a(fl);Tf=i(DT,"str"),DT.forEach(t),jf=i(Lp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Lp.forEach(t),$f=d(Lr),X=s(Lr,"LI",{});var ze=a(X);bl=s(ze,"STRONG",{});var AT=a(bl);Mf=i(AT,"main_input_name"),AT.forEach(t),Pf=i(ze," ("),vl=s(ze,"CODE",{});var GT=a(vl);Ef=i(GT,"str"),GT.forEach(t),Lf=i(ze,") \u2014 The name of the principal input to the model (often "),yl=s(ze,"CODE",{});var ST=a(yl);qf=i(ST,"input_ids"),ST.forEach(t),Ff=i(ze,` for NLP
models, `),kl=s(ze,"CODE",{});var NT=a(kl);Of=i(NT,"pixel_values"),NT.forEach(t),zf=i(ze," for vision models and "),xl=s(ze,"CODE",{});var CT=a(xl);Df=i(CT,"input_values"),CT.forEach(t),Af=i(ze," for speech models)."),ze.forEach(t),Lr.forEach(t),Gf=d(k),pe=s(k,"DIV",{class:!0});var qn=a(pe);m(So.$$.fragment,qn),Sf=d(qn),No=s(qn,"P",{});var Cc=a(No);Nf=i(Cc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=s(Cc,"CODE",{});var IT=a(wl);Cf=i(IT,"repo_path_or_name"),IT.forEach(t),If=i(Cc,"."),Cc.forEach(t),Bf=d(qn),Tl=s(qn,"P",{});var BT=a(Tl);Wf=i(BT,"Examples:"),BT.forEach(t),Uf=d(qn),m(Co.$$.fragment,qn),qn.forEach(t),Hf=d(k),Jt=s(k,"DIV",{class:!0});var Ic=a(Jt);m(Io.$$.fragment,Ic),Vf=d(Ic),jl=s(Ic,"P",{});var WT=a(jl);Xf=i(WT,`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),WT.forEach(t),Ic.forEach(t),Rf=d(k),S=s(k,"DIV",{class:!0});var Z=a(S);m(Bo.$$.fragment,Z),Yf=d(Z),$l=s(Z,"P",{});var UT=a($l);Kf=i(UT,"Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),UT.forEach(t),Zf=d(Z),Wo=s(Z,"P",{});var Bc=a(Wo);Jf=i(Bc,"The warning "),Ml=s(Bc,"EM",{});var HT=a(Ml);Qf=i(HT,"Weights from XXX not initialized from pretrained model"),HT.forEach(t),eb=i(Bc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),Wc.forEach(t),ab=d(Z),m(Qt.$$.fragment,Z),rb=d(Z),El=s(Z,"P",{});var XT=a(El);ib=i(XT,"Examples:"),XT.forEach(t),lb=d(Z),m(Ho.$$.fragment,Z),Z.forEach(t),db=d(k),en=s(k,"DIV",{class:!0});var Uc=a(en);m(Vo.$$.fragment,Uc),pb=d(Uc),Ll=s(Uc,"P",{});var RT=a(Ll);cb=i(RT,"Dict of bias attached to an LM head. The key represents the name of the bias attribute."),RT.forEach(t),Uc.forEach(t),mb=d(k),tn=s(k,"DIV",{class:!0});var Hc=a(tn);m(Xo.$$.fragment,Hc),ub=d(Hc),ql=s(Hc,"P",{});var YT=a(ql);gb=i(YT,"Returns the model\u2019s input embeddings layer."),YT.forEach(t),Hc.forEach(t),hb=d(k),nn=s(k,"DIV",{class:!0});var Vc=a(nn);m(Ro.$$.fragment,Vc),_b=d(Vc),Fl=s(Vc,"P",{});var KT=a(Fl);fb=i(KT,"The LM Head layer. This method must be overwritten by all the models that have a lm head."),KT.forEach(t),Vc.forEach(t),bb=d(k),on=s(k,"DIV",{class:!0});var Xc=a(on);m(Yo.$$.fragment,Xc),vb=d(Xc),Ol=s(Xc,"P",{});var ZT=a(Ol);yb=i(ZT,"Returns the model\u2019s output embeddings"),ZT.forEach(t),Xc.forEach(t),kb=d(k),sn=s(k,"DIV",{class:!0});var Rc=a(sn);m(Ko.$$.fragment,Rc),xb=d(Rc),zl=s(Rc,"P",{});var JT=a(zl);wb=i(JT,`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),JT.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),jb=d(Yc),Dl=s(Yc,"P",{});var QT=a(Dl);$b=i(QT,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),QT.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var e2=a(Al);Eb=i(e2,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),e2.forEach(t),Kc.forEach(t),Lb=d(k),ln=s(k,"DIV",{class:!0});var Zc=a(ln);m(Qo.$$.fragment,Zc),qb=d(Zc),Gl=s(Zc,"P",{});var t2=a(Gl);Fb=i(t2,"Prunes heads of the base model."),t2.forEach(t),Zc.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),zb=d(qr),ts=s(qr,"P",{});var Jc=a(ts);Db=i(Jc,"Resizes input token embeddings matrix of the model if "),Sl=s(Jc,"CODE",{});var n2=a(Sl);Ab=i(n2,"new_num_tokens != config.vocab_size"),n2.forEach(t),Gb=i(Jc,"."),Jc.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qc=a(ns);Nb=i(Qc,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qc,"CODE",{});var o2=a(Nl);Cb=i(o2,"tie_weights()"),o2.forEach(t),Ib=i(Qc," method."),Qc.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),or=s(tm,"A",{href:!0});var s2=a(or);Hb=i(s2,"from_pretrained()"),s2.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),pn=s(k,"DIV",{class:!0});var nm=a(pn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var a2=a(Cl);Yb=i(a2,"Method used for serving the model."),a2.forEach(t),nm.forEach(t),Kb=d(k),cn=s(k,"DIV",{class:!0});var om=a(cn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var r2=a(Il);Jb=i(r2,"Prepare the output of the saved model. Each model must implement this function."),r2.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),ev=d(sm),Bl=s(sm,"P",{});var i2=a(Bl);tv=i(i2,"Set all the bias in the LM head."),i2.forEach(t),sm.forEach(t),nv=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),ov=d(am),Wl=s(am,"P",{});var l2=a(Wl);sv=i(l2,"Set model\u2019s input embeddings"),l2.forEach(t),am.forEach(t),av=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),rv=d(rm),Ul=s(rm,"P",{});var d2=a(Ul);iv=i(d2,"Set model\u2019s output embeddings"),d2.forEach(t),rm.forEach(t),lv=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(ps.$$.fragment,im),dv=d(im),Hl=s(im,"P",{});var p2=a(Hl);pv=i(p2,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),p2.forEach(t),im.forEach(t),cv=d(k),ce=s(k,"DIV",{class:!0});var Fn=a(ce);m(cs.$$.fragment,Fn),mv=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);uv=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var c2=a(Vl);gv=i(c2,"train_step"),c2.forEach(t),hv=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var m2=a(Xl);_v=i(m2,"train_step"),m2.forEach(t),fv=i(Ke,`. In
this case, it expects the same `),Rl=s(Ke,"CODE",{});var u2=a(Rl);bv=i(u2,"data"),u2.forEach(t),vv=i(Ke," as the original function (i.e. "),Yl=s(Ke,"CODE",{});var g2=a(Yl);yv=i(g2,"(inputs, labels)"),g2.forEach(t),kv=i(Ke,")."),Ke.forEach(t),xv=d(Fn),ut=s(Fn,"P",{});var Fr=a(ut);wv=i(Fr,`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h2=a(Kl);Tv=i(h2,"data"),h2.forEach(t),jv=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _2=a(Zl);$v=i(_2,"(inputs,)"),_2.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var f2=a(Jl);Lv=i(f2,"loss"),f2.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b2=a(Ql);Fv=i(b2,"loss"),b2.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v2=a(_n);ed=s(v2,"SPAN",{});var y2=a(ed);m(ms.$$.fragment,y2),y2.forEach(t),v2.forEach(t),zv=d(lm),td=s(lm,"SPAN",{});var k2=a(td);Dv=i(k2,"TFModelUtilsMixin"),k2.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var zr=a(Pe);m(us.$$.fragment,zr),Av=d(zr),gs=s(zr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x2=a(nd);Sv=i(x2,"tf.keras.Model"),x2.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(zr),fn=s(zr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),Iv=d(pm),od=s(pm,"P",{});var w2=a(od);Bv=i(w2,"Get the number of (optionally, trainable) parameters in the model."),w2.forEach(t),pm.forEach(t),zr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T2=a(bn);sd=s(T2,"SPAN",{});var j2=a(sd);m(_s.$$.fragment,j2),j2.forEach(t),T2.forEach(t),Wv=d(cm),ad=s(cm,"SPAN",{});var $2=a(ad);Uv=i($2,"FlaxPreTrainedModel"),$2.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var M2=a(rd);Vv=i(M2,"Base class for all models."),M2.forEach(t),Xv=d(q),sr=s(q,"P",{});var Dx=a(sr);ar=s(Dx,"A",{href:!0});var P2=a(ar);Rv=i(P2,"FlaxPreTrainedModel"),P2.forEach(t),Yv=i(Dx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),Dx.forEach(t),Kv=d(q),id=s(q,"P",{});var E2=a(id);Zv=i(E2,"Class attributes (overridden by derived classes):"),E2.forEach(t),Jv=d(q),ft=s(q,"UL",{});var Dr=a(ft);Xe=s(Dr,"LI",{});var Da=a(Xe);ld=s(Da,"STRONG",{});var L2=a(ld);Qv=i(L2,"config_class"),L2.forEach(t),ey=i(Da," ("),rr=s(Da,"A",{href:!0});var q2=a(rr);ty=i(q2,"PretrainedConfig"),q2.forEach(t),ny=i(Da,") \u2014 A subclass of "),ir=s(Da,"A",{href:!0});var F2=a(ir);oy=i(F2,"PretrainedConfig"),F2.forEach(t),sy=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),ay=d(Dr),vn=s(Dr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O2=a(dd);ry=i(O2,"base_model_prefix"),O2.forEach(t),iy=i(qp," ("),pd=s(qp,"CODE",{});var z2=a(pd);ly=i(z2,"str"),z2.forEach(t),dy=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),py=d(Dr),R=s(Dr,"LI",{});var De=a(R);cd=s(De,"STRONG",{});var D2=a(cd);cy=i(D2,"main_input_name"),D2.forEach(t),my=i(De," ("),md=s(De,"CODE",{});var A2=a(md);uy=i(A2,"str"),A2.forEach(t),gy=i(De,") \u2014 The name of the principal input to the model (often "),ud=s(De,"CODE",{});var G2=a(ud);hy=i(G2,"input_ids"),G2.forEach(t),_y=i(De,` for NLP
models, `),gd=s(De,"CODE",{});var S2=a(gd);fy=i(S2,"pixel_values"),S2.forEach(t),by=i(De," for vision models and "),hd=s(De,"CODE",{});var N2=a(hd);vy=i(N2,"input_values"),N2.forEach(t),yy=i(De," for speech models)."),De.forEach(t),Dr.forEach(t),ky=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xy=d(On),vs=s(On,"P",{});var mm=a(vs);wy=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C2=a(_d);Ty=i(C2,"repo_path_or_name"),C2.forEach(t),jy=i(mm,"."),mm.forEach(t),$y=d(On),fd=s(On,"P",{});var I2=a(fd);My=i(I2,"Examples:"),I2.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ey=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ly=d(Te),bd=s(Te,"P",{});var B2=a(bd);qy=i(B2,"Instantiate a pretrained flax model from a pre-trained model configuration."),B2.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var W2=a(vd);zy=i(W2,"Weights from XXX not initialized from pretrained model"),W2.forEach(t),Dy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),Ay=d(Te),ws=s(Te,"P",{});var gm=a(ws);Gy=i(gm,"The warning "),yd=s(gm,"EM",{});var U2=a(yd);Sy=i(U2,"Weights from XXX not used in YYY"),U2.forEach(t),Ny=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),Cy=d(Te),kd=s(Te,"P",{});var H2=a(kd);Iy=i(H2,"Examples:"),H2.forEach(t),By=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),Wy=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m(js.$$.fragment,Ar),Uy=d(Ar),xd=s(Ar,"P",{});var V2=a(xd);Hy=i(V2,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V2.forEach(t),Vy=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xy=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m($s.$$.fragment,hm),Ry=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Yy=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X2=a(wd);Ky=i(X2,"[from_pretrained()](/docs/transformers/pr_16004/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X2.forEach(t),Zy=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);e1=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R2=a(Td);t1=i(R2,"params"),R2.forEach(t),n1=i(Je," to "),jd=s(Je,"CODE",{});var Y2=a(jd);o1=i(Y2,"jax.numpy.bfloat16"),Y2.forEach(t),s1=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var K2=a($d);a1=i(K2,"params"),K2.forEach(t),r1=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Z2=a(Md);i1=i(Z2,"params"),Z2.forEach(t),l1=i(Je," in place."),Je.forEach(t),d1=d(Ze),Pd=s(Ze,"P",{});var J2=a(Pd);p1=i(J2,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),J2.forEach(t),c1=d(Ze),Ed=s(Ze,"P",{});var Q2=a(Ed);m1=i(Q2,"Examples:"),Q2.forEach(t),u1=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),g1=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),h1=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_1=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var ej=a(Ld);f1=i(ej,"parmas"),ej.forEach(t),b1=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);v1=i(tj,"jax.numpy.float16"),tj.forEach(t),y1=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);k1=i(nj,"params"),nj.forEach(t),x1=i(et,` tree and does not cast the
...
post`),$j.forEach(t),zk=i(xm,"."),xm.forEach(t),Dk=d(je),Jd=s(je,"P",{});var Mj=a(Jd);Ak=i(Mj,"Examples:"),Mj.forEach(t),Gk=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sk=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),Nk=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);Ck=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),Ik=d(Sn),ep=s(Sn,"P",{});var Ej=a(ep);Bk=i(Ej,"Examples:"),Ej.forEach(t),Wk=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Uk=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hk=d(Nn),tp=s(Nn,"P",{});var Lj=a(tp);Vk=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),Xk=d(Nn),np=s(Nn,"P",{});var qj=a(np);Rk=i(qj,"Examples:"),qj.forEach(t),Yk=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kk=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zk=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jk=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Qk=i(Fj,"PreTrainedModel"),Fj.forEach(t),e0=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),t0=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),n0=d(Cn),op=s(Cn,"P",{});var Oj=a(op);o0=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),s0=d(Cn),sp=s(Cn,"P",{});var zj=a(sp);a0=i(zj,"Examples:"),zj.forEach(t),r0=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),i0=d(J),aa=s(J,"P",{});var jm=a(aa);l0=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var Dj=a(mr);d0=i(Dj,"TFPreTrainedModel"),Dj.forEach(t),p0=i(jm,"."),jm.forEach(t),c0=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),m0=d($m),ia=s($m,"P",{});var Mm=a(ia);u0=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);g0=i(Aj,"PreTrainedModel"),Aj.forEach(t),h0=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_0=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),f0=d(Q),ap=s(Q,"P",{});var Gj=a(ap);b0=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),Gj.forEach(t),v0=d(Q),da=s(Q,"P",{});var Pm=a(da);y0=i(Pm,"Adapted in part from "),pa=s(Pm,"A",{href:!0,rel:!0});var Sj=a(pa);k0=i(Sj,`Facebook\u2019s XLM beam search
code`),Sj.forEach(t),x0=i(Pm,"."),Pm.forEach(t),w0=d(Q),Ee=s(Q,"P",{});var In=a(Ee);T0=i(In,"Apart from "),rp=s(In,"CODE",{});var Nj=a(rp);j0=i(Nj,"input_ids"),Nj.forEach(t),$0=i(In," and "),ip=s(In,"CODE",{});var Cj=a(ip);M0=i(Cj,"attention_mask"),Cj.forEach(t),P0=i(In,`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=s(In,"A",{href:!0});var Ij=a(gr);E0=i(Ij,"PretrainedConfig"),Ij.forEach(t),L0=i(In,` of the model. The default values indicated are the default
values of those config.`),In.forEach(t),q0=d(Q),ca=s(Q,"P",{});var Em=a(ca);F0=i(Em,"Most of these parameters are explained in more detail in "),ma=s(Em,"A",{href:!0,rel:!0});var Bj=a(ma);O0=i(Bj,`this blog
post`),Bj.forEach(t),z0=i(Em,"."),Em.forEach(t),D0=d(Q),lp=s(Q,"P",{});var Wj=a(lp);A0=i(Wj,"Examples:"),Wj.forEach(t),G0=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),S0=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),N0=d(Bn),dp=s(Bn,"P",{});var Uj=a(dp);C0=i(Uj,"Generates sequences for models with a language modeling head using greedy decoding."),Uj.forEach(t),I0=d(Bn),pp=s(Bn,"P",{});var Hj=a(pp);B0=i(Hj,"Examples:"),Hj.forEach(t),W0=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),U0=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(_a.$$.fragment,Lm),H0=d(Lm),fa=s(Lm,"P",{});var qm=a(fa);V0=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var Vj=a(hr);X0=i(Vj,"TFPreTrainedModel"),Vj.forEach(t),R0=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Y0=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),K0=d(Wn),cp=s(Wn,"P",{});var Xj=a(cp);Z0=i(Xj,"Generates sequences for models with a language modeling head using multinomial sampling."),Xj.forEach(t),J0=d(Wn),mp=s(Wn,"P",{});var Rj=a(mp);Q0=i(Rj,"Examples:"),Rj.forEach(t),ex=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),tx=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nx=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Yj=a(_r);ox=i(Yj,"FlaxPreTrainedModel"),Yj.forEach(t),sx=i(Fm,"."),Fm.forEach(t),ax=d(Sr),H=s(Sr,"DIV",{class:!0});var $e=a(H);m(xa.$$.fragment,$e),rx=d($e),up=s($e,"P",{});var Kj=a(up);ix=i(Kj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),Kj.forEach(t),lx=d($e),yt=s($e,"P",{});var Nr=a(yt);dx=i(Nr,"Apart from "),gp=s(Nr,"CODE",{});var Zj=a(gp);px=i(Zj,"input_ids"),Zj.forEach(t),cx=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
