...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17440/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17440/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17440/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17440/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17440/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
special tokens using the tokenizer `),Tc=s(Ql,"CODE",{});var e4=a(Tc);d_=i(e4,"prepare_for_model"),e4.forEach(t),c_=i(Ql," method."),Ql.forEach(t),Hl.forEach(t),p_=h(Fe),$n=s(Fe,"DIV",{class:!0});var Sf=a($n);T(ja.$$.fragment,Sf),h_=h(Sf),wc=s(Sf,"P",{});var t4=a(wc);m_=i(t4,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),t4.forEach(t),Sf.forEach(t),f_=h(Fe),od=s(Fe,"DIV",{class:!0});var o4=a(od);T(Pa.$$.fragment,o4),o4.forEach(t),Fe.forEach(t),Km=h(o),vo=s(o,"H2",{class:!0});var Wf=a(vo);Fn=s(Wf,"A",{id:!0,class:!0,href:!0});var n4=a(Fn);$c=s(n4,"SPAN",{});var s4=a($c);T(La.$$.fragment,s4),s4.forEach(t),n4.forEach(t),u_=h(Wf),Fc=s(Wf,"SPAN",{});var a4=a(Fc);g_=i(a4,"RobertaTokenizerFast"),a4.forEach(t),Wf.forEach(t),Gm=h(o),Le=s(o,"DIV",{class:!0});var Ye=a(Le);T(Aa.$$.fragment,Ye),__=h(Ye),Oa=s(Ye,"P",{});var Bf=a(Oa);b_=i(Bf,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),xc=s(Bf,"EM",{});var r4=a(xc);k_=i(r4,"tokenizers"),r4.forEach(t),v_=i(Bf,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),Bf.forEach(t),y_=h(Ye),Rc=s(Ye,"P",{});var i4=a(Rc);T_=i(i4,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),i4.forEach(t),w_=h(Ye),T(xn.$$.fragment,Ye),$_=h(Ye),Na=s(Ye,"P",{});var Uf=a(Na);F_=i(Uf,"You can get around that behavior by passing "),Mc=s(Uf,"CODE",{});var l4=a(Mc);x_=i(l4,"add_prefix_space=True"),l4.forEach(t),R_=i(Uf,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uf.forEach(t),M_=h(Ye),T(Rn.$$.fragment,Ye),E_=h(Ye),Ia=s(Ye,"P",{});var Hf=a(Ia);z_=i(Hf,"This tokenizer inherits from "),nd=s(Hf,"A",{href:!0});var d4=a(nd);q_=i(d4,"PreTrainedTokenizerFast"),d4.forEach(t),C_=i(Hf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hf.forEach(t),j_=h(Ye),sd=s(Ye,"DIV",{class:!0});var c4=a(sd);T(Da.$$.fragment,c4),c4.forEach(t),Ye.forEach(t),Xm=h(o),yo=s(o,"H2",{class:!0});var Qf=a(yo);Mn=s(Qf,"A",{id:!0,class:!0,href:!0});var p4=a(Mn);Ec=s(p4,"SPAN",{});var h4=a(Ec);T(Sa.$$.fragment,h4),h4.forEach(t),p4.forEach(t),P_=h(Qf),zc=s(Qf,"SPAN",{});var m4=a(zc);L_=i(m4,"RobertaModel"),m4.forEach(t),Qf.forEach(t),Ym=h(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);T(Wa.$$.fragment,Ze),A_=h(Ze),qc=s(Ze,"P",{});var f4=a(qc);O_=i(f4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),f4.forEach(t),N_=h(Ze),Ba=s(Ze,"P",{});var Jf=a(Ba);I_=i(Jf,"This model inherits from "),ad=s(Jf,"A",{href:!0});var u4=a(ad);D_=i(u4,"PreTrainedModel"),u4.forEach(t),S_=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),W_=h(Ze),Ua=s(Ze,"P",{});var Vf=a(Ua);B_=i(Vf,"This model is also a PyTorch "),Ha=s(Vf,"A",{href:!0,rel:!0});var g4=a(Ha);U_=i(g4,"torch.nn.Module"),g4.forEach(t),H_=i(Vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),Cc=s(Kf,"EM",{});var _4=a(Cc);V_=i(_4,`Attention is
all you need`),_4.forEach(t),K_=i(Kf,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),Kf.forEach(t),G_=h(Ze),He=s(Ze,"P",{});var ft=a(He);X_=i(ft,"To behave as an decoder the model needs to be initialized with the "),jc=s(ft,"CODE",{});var b4=a(jc);Y_=i(b4,"is_decoder"),b4.forEach(t),Z_=i(ft,` argument of the configuration set
to `),Pc=s(ft,"CODE",{});var k4=a(Pc);eb=i(k4,"True"),k4.forEach(t),tb=i(ft,". To be used in a Seq2Seq model, the model needs to initialized with both "),Lc=s(ft,"CODE",{});var v4=a(Lc);ob=i(v4,"is_decoder"),v4.forEach(t),nb=i(ft,` argument and
`),Ac=s(ft,"CODE",{});var y4=a(Ac);sb=i(y4,"add_cross_attention"),y4.forEach(t),ab=i(ft," set to "),Oc=s(ft,"CODE",{});var T4=a(Oc);rb=i(T4,"True"),T4.forEach(t),ib=i(ft,"; an "),Nc=s(ft,"CODE",{});var w4=a(Nc);lb=i(w4,"encoder_hidden_states"),w4.forEach(t),db=i(ft," is then expected as an input to the forward pass."),ft.forEach(t),cb=h(Ze),En=s(Ze,"P",{});var Bm=a(En);pb=i(Bm,".. _"),Ic=s(Bm,"EM",{});var $4=a(Ic);hb=i($4,"Attention is all you need"),$4.forEach(t),mb=i(Bm,": "),Ja=s(Bm,"A",{href:!0,rel:!0});var F4=a(Ja);fb=i(F4,"https://arxiv.org/abs/1706.03762"),F4.forEach(t),Bm.forEach(t),ub=h(Ze),$t=s(Ze,"DIV",{class:!0});var ea=a($t);T(Va.$$.fragment,ea),gb=h(ea),To=s(ea,"P",{});var Wd=a(To);_b=i(Wd,"The "),rd=s(Wd,"A",{href:!0});var x4=a(rd);bb=i(x4,"RobertaModel"),x4.forEach(t),kb=i(Wd," forward method, overrides the "),Dc=s(Wd,"CODE",{});var R4=a(Dc);vb=i(R4,"__call__"),R4.forEach(t),yb=i(Wd," special method."),Wd.forEach(t),Tb=h(ea),T(zn.$$.fragment,ea),wb=h(ea),T(qn.$$.fragment,ea),ea.forEach(t),Ze.forEach(t),Zm=h(o),wo=s(o,"H2",{class:!0});var Gf=a(wo);Cn=s(Gf,"A",{id:!0,class:!0,href:!0});var M4=a(Cn);Sc=s(M4,"SPAN",{});var E4=a(Sc);T(Ka.$$.fragment,E4),E4.forEach(t),M4.forEach(t),$b=h(Gf),Wc=s(Gf,"SPAN",{});var z4=a(Wc);Fb=i(z4,"RobertaForCausalLM"),z4.forEach(t),Gf.forEach(t),ef=h(o),tt=s(o,"DIV",{class:!0});var oo=a(tt);T(Ga.$$.fragment,oo),xb=h(oo),Xa=s(oo,"P",{});var Xf=a(Xa);Rb=i(Xf,"RoBERTa Model with a "),Bc=s(Xf,"CODE",{});var q4=a(Bc);Mb=i(q4,"language modeling"),q4.forEach(t),Eb=i(Xf," head on top for CLM fine-tuning."),Xf.forEach(t),zb=h(oo),Ya=s(oo,"P",{});var Yf=a(Ya);qb=i(Yf,"This model inherits from "),id=s(Yf,"A",{href:!0});var C4=a(id);Cb=i(C4,"PreTrainedModel"),C4.forEach(t),jb=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yf.forEach(t),Pb=h(oo),Za=s(oo,"P",{});var Zf=a(Za);Lb=i(Zf,"This model is also a PyTorch "),er=s(Zf,"A",{href:!0,rel:!0});var j4=a(er);Ab=i(j4,"torch.nn.Module"),j4.forEach(t),Ob=i(Zf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zf.forEach(t),Nb=h(oo),Ft=s(oo,"DIV",{class:!0});var ta=a(Ft);T(tr.$$.fragment,ta),Ib=h(ta),$o=s(ta,"P",{});var Bd=a($o);Db=i(Bd,"The "),ld=s(Bd,"A",{href:!0});var P4=a(ld);Sb=i(P4,"RobertaForCausalLM"),P4.forEach(t),Wb=i(Bd," forward method, overrides the "),Uc=s(Bd,"CODE",{});var L4=a(Uc);Bb=i(L4,"__call__"),L4.forEach(t),Ub=i(Bd," special method."),Bd.forEach(t),Hb=h(ta),T(jn.$$.fragment,ta),Qb=h(ta),T(Pn.$$.fragment,ta),ta.forEach(t),oo.forEach(t),tf=h(o),Fo=s(o,"H2",{class:!0});var eu=a(Fo);Ln=s(eu,"A",{id:!0,class:!0,href:!0});var A4=a(Ln);Hc=s(A4,"SPAN",{});var O4=a(Hc);T(or.$$.fragment,O4),O4.forEach(t),A4.forEach(t),Jb=h(eu),Qc=s(eu,"SPAN",{});var N4=a(Qc);Vb=i(N4,"RobertaForMaskedLM"),N4.forEach(t),eu.forEach(t),of=h(o),ot=s(o,"DIV",{class:!0});var no=a(ot);T(nr.$$.fragment,no),Kb=h(no),sr=s(no,"P",{});var tu=a(sr);Gb=i(tu,"RoBERTa Model with a "),Jc=s(tu,"CODE",{});var I4=a(Jc);Xb=i(I4,"language modeling"),I4.forEach(t),Yb=i(tu," head on top."),tu.forEach(t),Zb=h(no),ar=s(no,"P",{});var ou=a(ar);ek=i(ou,"This model inherits from "),dd=s(ou,"A",{href:!0});var D4=a(dd);tk=i(D4,"PreTrainedModel"),D4.forEach(t),ok=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),nk=h(no),rr=s(no,"P",{});var nu=a(rr);sk=i(nu,"This model is also a PyTorch "),ir=s(nu,"A",{href:!0,rel:!0});var S4=a(ir);ak=i(S4,"torch.nn.Module"),S4.forEach(t),rk=i(nu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),ik=h(no),it=s(no,"DIV",{class:!0});var so=a(it);T(lr.$$.fragment,so),lk=h(so),xo=s(so,"P",{});var Ud=a(xo);dk=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var W4=a(cd);ck=i(W4,"RobertaForMaskedLM"),W4.forEach(t),pk=i(Ud," forward method, overrides the "),Vc=s(Ud,"CODE",{});var B4=a(Vc);hk=i(B4,"__call__"),B4.forEach(t),mk=i(Ud," special method."),Ud.forEach(t),fk=h(so),T(An.$$.fragment,so),uk=h(so),T(On.$$.fragment,so),gk=h(so),T(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nf=h(o),Ro=s(o,"H2",{class:!0});var su=a(Ro);In=s(su,"A",{id:!0,class:!0,href:!0});var U4=a(In);Kc=s(U4,"SPAN",{});var H4=a(Kc);T(dr.$$.fragment,H4),H4.forEach(t),U4.forEach(t),_k=h(su),Gc=s(su,"SPAN",{});var Q4=a(Gc);bk=i(Q4,"RobertaForSequenceClassification"),Q4.forEach(t),su.forEach(t),sf=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);T(cr.$$.fragment,ao),kk=h(ao),Xc=s(ao,"P",{});var J4=a(Xc);vk=i(J4,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J4.forEach(t),yk=h(ao),pr=s(ao,"P",{});var au=a(pr);Tk=i(au,"This model inherits from "),pd=s(au,"A",{href:!0});var V4=a(pd);wk=i(V4,"PreTrainedModel"),V4.forEach(t),$k=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),Fk=h(ao),hr=s(ao,"P",{});var ru=a(hr);xk=i(ru,"This model is also a PyTorch "),mr=s(ru,"A",{href:!0,rel:!0});var K4=a(mr);Rk=i(K4,"torch.nn.Module"),K4.forEach(t),Mk=i(ru,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ut=a(Ue);T(fr.$$.fragment,ut),zk=h(ut),Mo=s(ut,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G4=a(hd);Ck=i(G4,"RobertaForSequenceClassification"),G4.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X4=a(Yc);Pk=i(X4,"__call__"),X4.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ut),T(Dn.$$.fragment,ut),Ok=h(ut),T(Sn.$$.fragment,ut),Nk=h(ut),T(Wn.$$.fragment,ut),Ik=h(ut),T(Bn.$$.fragment,ut),Dk=h(ut),T(Un.$$.fragment,ut),ut.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var iu=a(Eo);Hn=s(iu,"A",{id:!0,class:!0,href:!0});var Y4=a(Hn);Zc=s(Y4,"SPAN",{});var Z4=a(Zc);T(ur.$$.fragment,Z4),Z4.forEach(t),Y4.forEach(t),Sk=h(iu),ep=s(iu,"SPAN",{});var eF=a(ep);Wk=i(eF,"RobertaForMultipleChoice"),eF.forEach(t),iu.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);T(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var tF=a(tp);Uk=i(tF,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tF.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lu=a(_r);Qk=i(lu,"This model inherits from "),md=s(lu,"A",{href:!0});var oF=a(md);Jk=i(oF,"PreTrainedModel"),oF.forEach(t),Vk=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),Kk=h(ro),br=s(ro,"P",{});var du=a(br);Gk=i(du,"This model is also a PyTorch "),kr=s(du,"A",{href:!0,rel:!0});var nF=a(kr);Xk=i(nF,"torch.nn.Module"),nF.forEach(t),Yk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);T(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var sF=a(fd);ov=i(sF,"RobertaForMultipleChoice"),sF.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var aF=a(op);sv=i(aF,"__call__"),aF.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),T(Qn.$$.fragment,oa),iv=h(oa),T(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var rF=a(Vn);np=s(rF,"SPAN",{});var iF=a(np);T(yr.$$.fragment,iF),iF.forEach(t),rF.forEach(t),lv=h(cu),sp=s(cu,"SPAN",{});var lF=a(sp);dv=i(lF,"RobertaForTokenClassification"),lF.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);T(Tr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var dF=a(ap);pv=i(dF,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dF.forEach(t),hv=h(io),wr=s(io,"P",{});var pu=a(wr);mv=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var cF=a(ud);fv=i(cF,"PreTrainedModel"),cF.forEach(t),uv=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),gv=h(io),$r=s(io,"P",{});var hu=a($r);_v=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var pF=a(Fr);bv=i(pF,"torch.nn.Module"),pF.forEach(t),kv=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);T(xr.$$.fragment,lo),yv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);Tv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var hF=a(gd);wv=i(hF,"RobertaForTokenClassification"),hF.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var mF=a(rp);Fv=i(mF,"__call__"),mF.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),T(Kn.$$.fragment,lo),Mv=h(lo),T(Gn.$$.fragment,lo),Ev=h(lo),T(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var fF=a(Yn);ip=s(fF,"SPAN",{});var uF=a(ip);T(Rr.$$.fragment,uF),uF.forEach(t),fF.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var gF=a(lp);qv=i(gF,"RobertaForQuestionAnswering"),gF.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);T(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _F=a(dp);Pv=i(_F,"span start logits"),_F.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var bF=a(cp);Av=i(bF,"span end logits"),bF.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fu=a(Er);Iv=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var kF=a(_d);Dv=i(kF,"PreTrainedModel"),kF.forEach(t),Sv=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wv=h(co),zr=s(co,"P",{});var uu=a(zr);Bv=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var vF=a(qr);Uv=i(vF,"torch.nn.Module"),vF.forEach(t),Hv=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var yF=a(bd);Kv=i(yF,"RobertaForQuestionAnswering"),yF.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var TF=a(pp);Xv=i(TF,"__call__"),TF.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),T(Zn.$$.fragment,po),ey=h(po),T(es.$$.fragment,po),ty=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var wF=a(os);hp=s(wF,"SPAN",{});var $F=a(hp);T(jr.$$.fragment,$F),$F.forEach(t),wF.forEach(t),oy=h(gu),mp=s(gu,"SPAN",{});var FF=a(mp);ny=i(FF,"TFRobertaModel"),FF.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),sy=h(Ot),fp=s(Ot,"P",{});var xF=a(fp);ay=i(xF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xF.forEach(t),ry=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iy=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var RF=a(kd);ly=i(RF,"TFPreTrainedModel"),RF.forEach(t),dy=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cy=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);py=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var MF=a(Or);hy=i(MF,"tf.keras.Model"),MF.forEach(t),my=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fy=h(Ot),T(ns.$$.fragment,Ot),uy=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),gy=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_y=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var EF=a(vd);by=i(EF,"TFRobertaModel"),EF.forEach(t),ky=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var zF=a(up);vy=i(zF,"__call__"),zF.forEach(t),yy=i(Gd," special method."),Gd.forEach(t),Ty=h(na),T(ss.$$.fragment,na),wy=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var qF=a(rs);gp=s(qF,"SPAN",{});var CF=a(gp);T(Ir.$$.fragment,CF),CF.forEach(t),qF.forEach(t),$y=h(ku),_p=s(ku,"SPAN",{});var jF=a(_p);Fy=i(jF,"TFRobertaForCausalLM"),jF.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),xy=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),Ry=h(sa),Do=s(sa,"P",{});var Xd=a(Do);My=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var PF=a(yd);Ey=i(PF,"TFRobertaForCausalLM"),PF.forEach(t),zy=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var LF=a(bp);qy=i(LF,"__call__"),LF.forEach(t),Cy=i(Xd," special method."),Xd.forEach(t),jy=h(sa),T(is.$$.fragment,sa),Py=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var AF=a(ds);kp=s(AF,"SPAN",{});var OF=a(kp);T(Wr.$$.fragment,OF),OF.forEach(t),AF.forEach(t),Ly=h(yu),vp=s(yu,"SPAN",{});var NF=a(vp);Ay=i(NF,"TFRobertaForMaskedLM"),NF.forEach(t),yu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);T(Br.$$.fragment,Nt),Oy=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);Ny=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var IF=a(yp);Iy=i(IF,"language modeling"),IF.forEach(t),Dy=i(Tu," head on top."),Tu.forEach(t),Sy=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wy=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var DF=a(Td);By=i(DF,"TFPreTrainedModel"),DF.forEach(t),Uy=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Hy=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Qy=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var SF=a(Jr);Jy=i(SF,"tf.keras.Model"),SF.forEach(t),Vy=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),Ky=h(Nt),T(cs.$$.fragment,Nt),Gy=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Vr.$$.fragment,ho),Xy=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yy=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var WF=a(wd);Zy=i(WF,"TFRobertaForMaskedLM"),WF.forEach(t),eT=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var BF=a(Tp);tT=i(BF,"__call__"),BF.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),T(ps.$$.fragment,ho),sT=h(ho),T(hs.$$.fragment,ho),aT=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var UF=a(fs);wp=s(UF,"SPAN",{});var HF=a(wp);T(Kr.$$.fragment,HF),HF.forEach(t),UF.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var QF=a($p);iT=i(QF,"TFRobertaForSequenceClassification"),QF.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);T(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var JF=a(Fp);dT=i(JF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),JF.forEach(t),cT=h(It),Xr=s(It,"P",{});var xu=a(Xr);pT=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var VF=a($d);hT=i(VF,"TFPreTrainedModel"),VF.forEach(t),mT=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fT=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uT=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var KF=a(Zr);gT=i(KF,"tf.keras.Model"),KF.forEach(t),_T=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),T(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var GF=a(Fd);TT=i(GF,"TFRobertaForSequenceClassification"),GF.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var XF=a(xp);$T=i(XF,"__call__"),XF.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),T(gs.$$.fragment,mo),RT=h(mo),T(_s.$$.fragment,mo),MT=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var YF=a(ks);Rp=s(YF,"SPAN",{});var ZF=a(Rp);T(ti.$$.fragment,ZF),ZF.forEach(t),YF.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);CT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
