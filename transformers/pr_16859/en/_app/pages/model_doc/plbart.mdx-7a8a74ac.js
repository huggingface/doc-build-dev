...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16859/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_16859/src/transformers/models/plbart/configuration_plbart.py#L32"}}),Ue=new X({props:{code:`from transformers import PLBartModel, PLBartConfig
...
BPE-dropout.</li>
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16859/src/transformers/models/plbart/tokenization_plbart.py#L75"}}),Ye=new X({props:{code:`from transformers import PLBartTokenizer
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16859/src/transformers/models/plbart/tokenization_plbart.py#L302",returnDescription:`
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16859/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16859/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16859/src/transformers/models/plbart/modeling_plbart.py#L1272",returnDescription:`
<p>A <a
...
provide it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16859/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a>. See <a href="/docs/transformers/pr_16859/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
