...
documented `),qo=o("a"),Q$=a("here"),e6=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s6=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t6=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a6=a("Unlike, "),If=o("code"),n6=a("torch.distributed.launch"),o6=a(" where you have to specify how many GPUs to use with "),Uf=o("code"),l6=a("--nproc_per_node"),r6=a(`, with the
