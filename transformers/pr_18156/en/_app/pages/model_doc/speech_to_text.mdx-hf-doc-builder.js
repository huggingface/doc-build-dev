import{S as Kp,i as Jp,s as Yp,e as r,k as l,w as x,t as n,M as Xp,c as a,d as t,m as p,a as i,x as k,h as s,b as c,G as e,g as m,y,q as w,o as S,B as $,v as Qp,L as Zs}from"../../chunks/vendor-hf-doc-builder.js";import{T as to}from"../../chunks/Tip-hf-doc-builder.js";import{D as I}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ln}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as We}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Qs}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Zp(P){let h,b,_,f,v;return f=new ln({props:{code:`from transformers import Speech2TextModel, Speech2TextConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,h,g),e(h,b),e(h,_),e(_,f),e(h,v)},d(d){d&&t(h)}}}function nh(P){let h,b,_,f,v;return f=new ln({props:{code:`import torch
...
the latter silently ignores them.`)},l(d){h=a(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(g,"CODE",{});var E=i(_);f=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,h,g),e(h,b),e(h,_),e(_,f),e(h,v)},d(d){d&&t(h)}}}function rh(P){let h,b,_,f,v;return f=new ln({props:{code:`import torch
...
`),Z=r("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=a(T,"P",{});var z=i(h);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),_=p(T),f=a(T,"UL",{});var X=i(f);v=a(X,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(X),E=a(X,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),X.forEach(t),F=p(T),q=a(T,"P",{});var Q=i(q);L=s(Q,"This second option is useful when using "),H=a(Q,"CODE",{});var Re=i(H);ee=s(Re,"tf.keras.Model.fit"),Re.forEach(t),Pe=s(Q,` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a(Q,"CODE",{});var ue=i(B);Ce=s(ue,"model(inputs)"),ue.forEach(t),ye=s(Q,"."),Q.forEach(t),N=p(T),K=a(T,"P",{});var et=i(K);te=s(et,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),Z=a(Oe,"CODE",{});var nt=i(Z);Y=s(nt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),nt.forEach(t),Oe.forEach(t),U.forEach(t)},m(T,z){m(T,h,z),e(h,b),m(T,_,z),m(T,f,z),e(f,v),e(v,d),e(f,g),e(f,E),e(E,A),m(T,F,z),m(T,q,z),e(q,L),e(q,H),e(H,ee),e(q,Pe),e(q,B),e(B,Ce),e(q,ye),m(T,N,z),m(T,K,z),e(K,te),m(T,Te,z),m(T,j,z),e(j,M),e(M,je),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,re),e(j,Ne),e(j,G),e(G,we),e(G,O),e(O,Ae),e(G,ae),e(G,ie),e(ie,De),e(j,de),e(j,J),e(J,Ie),e(J,Z),e(Z,Y)},d(T){T&&t(h),T&&t(_),T&&t(f),T&&t(F),T&&t(q),T&&t(N),T&&t(K),T&&t(Te),T&&t(j)}}}function ih(P){let h,b,_,f,v;return{c(){h=r("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=a(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(g,"CODE",{});var E=i(_);f=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,h,g),e(h,b),e(h,_),e(_,f),e(h,v)},d(d){d&&t(h)}}}function dh(P){let h,b,_,f,v;return f=new ln({props:{code:`from transformers import Speech2TextTokenizer, TFSpeech2TextModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=r("p"),b=n("Example:"),_=l(),x(f.$$.fragment)},l(d){h=a(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(f.$$.fragment,d)},m(d,g){m(d,h,g),e(h,b),m(d,_,g),y(f,d,g),v=!0},p:Zs,i(d){v||(w(f.$$.fragment,d),v=!0)},o(d){S(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(f,d)}}}function ch(P){let h,b,_,f,v,d,g,E,A,F,q,L,H,ee,Pe,B,Ce,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,re,Ne,G,we,O,Ae,ae,ie,De,de,J,Ie,Z,Y;return{c(){h=r("p"),b=n("TF 2.0 models accepts two formats as inputs:"),_=l(),f=r("ul"),v=r("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),E=r("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),F=l(),q=r("p"),L=n("This second option is useful when using "),H=r("code"),ee=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=r("code"),Ce=n("model(inputs)"),ye=n("."),N=l(),K=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=l(),j=r("ul"),M=r("li"),je=n("a single Tensor with "),oe=r("code"),ne=n("input_ids"),Me=n(" only and nothing else: "),se=r("code"),re=n("model(input_ids)"),Ne=l(),G=r("li"),we=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r("code"),Ae=n("model([input_ids, attention_mask])"),ae=n(" or "),ie=r("code"),De=n("model([input_ids, attention_mask, token_type_ids])"),de=l(),J=r("li"),Ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=a(T,"P",{});var z=i(h);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),_=p(T),f=a(T,"UL",{});var X=i(f);v=a(X,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(X),E=a(X,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),X.forEach(t),F=p(T),q=a(T,"P",{});var Q=i(q);L=s(Q,"This second option is useful when using "),H=a(Q,"CODE",{});var Re=i(H);ee=s(Re,"tf.keras.Model.fit"),Re.forEach(t),Pe=s(Q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(d){h=a(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(g,"CODE",{});var E=i(_);f=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,h,g),e(h,b),e(h,_),e(_,f),e(h,v)},d(d){d&&t(h)}}}function ph(P){let h,b,_,f,v;return f=new ln({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=r("p"),b=n("Example:"),_=l(),x(f.$$.fragment)},l(d){h=a(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(f.$$.fragment,d)},m(d,g){m(d,h,g),e(h,b),m(d,_,g),y(f,d,g),v=!0},p:Zs,i(d){v||(w(f.$$.fragment,d),v=!0)},o(d){S(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(f,d)}}}function hh(P){let h,b,_,f,v,d,g,E,A,F,q,L,H,ee,Pe,B,Ce,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,re,Ne,G,we,O,Ae,ae,ie,De,de,J,Ie,Z,Y,T,z,X,Ze,Le,Q,Re,ue,et,U,ce,tt,Ve,C,ot,Se,Oe,nt,pn,oa,na,hn,sa,ra,fn,aa,ia,er,W,da,Yn,ca,la,Xn,pa,ha,Qn,fa,ma,Zn,ua,_a,es,ga,Ta,oo,va,ba,ts,xa,tr,mn,os,ka,or,no,nr,un,so,ns,ya,wa,le,Sa,ss,$a,Ea,rs,qa,Fa,as,za,Pa,is,Ca,ja,ds,Ma,Na,sr,ro,rr,Tt,Aa,ao,Da,Ia,ar,st,vt,cs,io,La,ls,Oa,ir,ve,co,Ga,rt,Ua,_n,Wa,Ra,lo,Va,Ha,Ba,at,Ka,gn,Ja,Ya,Tn,Xa,Qa,Za,bt,dr,it,xt,ps,po,ei,hs,ti,cr,R,ho,oi,fs,ni,si,fo,ri,vn,ai,ii,di,kt,mo,ci,ms,li,pi,yt,uo,hi,_o,fi,us,mi,ui,_i,He,go,gi,bn,Ti,xn,vi,bi,_s,xi,ki,kn,To,lr,dt,wt,gs,vo,yi,Ts,wi,pr,pe,bo,Si,vs,$i,Ei,xo,qi,yn,Fi,zi,Pi,bs,Ci,ji,St,ko,Mi,xs,Ni,hr,ct,$t,ks,yo,Ai,ys,Di,fr,D,wo,Ii,ws,Li,Oi,_e,wn,Gi,Ui,Sn,Wi,Ri,$n,Vi,Hi,So,Ss,Bi,Ki,Ji,En,Yi,Xi,Qi,Et,$o,Zi,Ge,ed,Eo,$s,td,od,nd,qn,sd,rd,qo,Es,ad,id,dd,cd,Be,Fo,ld,qs,pd,hd,qt,fd,Ke,zo,md,Po,ud,Fn,_d,gd,Td,Ft,vd,zt,Co,bd,jo,xd,zn,kd,yd,wd,Pt,Mo,Sd,No,$d,Pn,Ed,qd,Fd,Ct,Ao,zd,Fs,Pd,mr,lt,jt,zs,Do,Cd,Ps,jd,ur,be,Io,Md,Lo,Nd,Cn,Ad,Dd,Id,Oo,Ld,Go,Od,Gd,Ud,$e,Uo,Wd,pt,Rd,jn,Vd,Hd,Cs,Bd,Kd,Jd,Mt,Yd,Nt,_r,ht,At,js,Wo,Xd,Ms,Qd,gr,xe,Ro,Zd,Vo,ec,Mn,tc,oc,nc,Ho,sc,Bo,rc,ac,ic,Ee,Ko,dc,ft,cc,Nn,lc,pc,Ns,hc,fc,mc,Dt,uc,It,Tr,mt,Lt,As,Jo,_c,Ds,gc,vr,he,Yo,Tc,Xo,vc,An,bc,xc,kc,Qo,yc,Zo,wc,Sc,$c,Ot,Ec,qe,en,qc,ut,Fc,Dn,zc,Pc,Is,Cc,jc,Mc,Gt,Nc,Ut,br,_t,Wt,Ls,tn,Ac,Os,Dc,xr,fe,on,Ic,nn,Lc,In,Oc,Gc,Uc,sn,Wc,rn,Rc,Vc,Hc,Rt,Bc,Fe,an,Kc,gt,Jc,Ln,Yc,Xc,Gs,Qc,Zc,el,Vt,tl,Ht,kr;return d=new We({}),ee=new We({}),X=new We({}),no=new ln({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextModel">Speech2TextModel</a>`,name:"vocab_size"},{anchor:"transformers.Speech2TextConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
avoid subtle bugs.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Speech2TextFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_18156/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
...
<p>Indices can be obtained using <code>SpeechToTextTokenizer</code>. See <a href="/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18156/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18156/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1143",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18156/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
>transformers.modeling_outputs.Seq2SeqLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextConfig"
...
only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18156/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1289",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18156/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
>transformers.modeling_outputs.Seq2SeqLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a>. See <a href="/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_18156/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18156/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1259",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18156/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18156/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1354",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18156/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),Vt=new to({props:{$$slots:{default:[lh]},$$scope:{ctx:P}}}),Ht=new Qs({props:{anchor:"transformers.TFSpeech2TextForConditionalGeneration.call.example",$$slots:{default:[ph]},$$scope:{ctx:P}}}),{c(){h=r("meta"),b=l(),_=r("h1"),f=r("a"),v=r("span"),x(d.$$.fragment),g=l(),E=r("span"),A=n("Speech2Text"),F=l(),q=r("h2"),L=r("a"),H=r("span"),x(ee.$$.fragment),Pe=l(),B=r("span"),Ce=n("Overview"),ye=l(),N=r("p"),K=n("The Speech2Text model was proposed in "),te=r("a"),Te=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),j=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),M=r("a"),je=n("LibriSpeech"),oe=n(", "),ne=r("a"),Me=n("CoVoST 2"),se=n(", "),re=r("a"),Ne=n("MuST-C"),G=n("."),we=l(),O=r("p"),Ae=n("This model was contributed by "),ae=r("a"),ie=n("valhalla"),De=n(". The original code can be found "),de=r("a"),J=n("here"),Ie=n("."),Z=l(),Y=r("h2"),T=r("a"),z=r("span"),x(X.$$.fragment),Ze=l(),Le=r("span"),Q=n("Inference"),Re=l(),ue=r("p"),et=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
...
`),Qn=r("code"),fa=n('pip install transformers"[speech, sentencepiece]"'),ma=n(" or install the packages separately with "),Zn=r("code"),ua=n("pip install torchaudio sentencepiece"),_a=n(". Also "),es=r("code"),ga=n("torchaudio"),Ta=n(" requires the development version of the "),oo=r("a"),va=n("libsndfile"),ba=n(` package which can be installed via a system package manager. On Ubuntu it can
be installed as follows: `),ts=r("code"),xa=n("apt install libsndfile1-dev"),tr=l(),mn=r("ul"),os=r("li"),ka=n("ASR and Speech Translation"),or=l(),x(no.$$.fragment),nr=l(),un=r("ul"),so=r("li"),ns=r("p"),ya=n("Multilingual speech translation"),wa=l(),le=r("p"),Sa=n("For multilingual speech translation models, "),ss=r("code"),$a=n("eos_token_id"),Ea=n(" is used as the "),rs=r("code"),qa=n("decoder_start_token_id"),Fa=n(` and
the target language id is forced as the first generated token. To force the target language id as the first
generated token, pass the `),as=r("code"),za=n("forced_bos_token_id"),Pa=n(" parameter to the "),is=r("code"),Ca=n("generate()"),ja=n(` method. The following
...
information.`),cd=l(),Be=r("div"),x(Fo.$$.fragment),ld=l(),qs=r("p"),pd=n("Instantiate a processor associated with a pretrained model."),hd=l(),x(qt.$$.fragment),fd=l(),Ke=r("div"),x(zo.$$.fragment),md=l(),Po=r("p"),ud=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Fn=r("a"),_d=n("from_pretrained()"),gd=n(" method."),Td=l(),x(Ft.$$.fragment),vd=l(),zt=r("div"),x(Co.$$.fragment),bd=l(),jo=r("p"),xd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),zn=r("a"),kd=n("batch_decode()"),yd=n(`. Please
...
to the docstring of this method for more information.`),Fd=l(),Ct=r("div"),x(Ao.$$.fragment),zd=l(),Fs=r("p"),Pd=n(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),mr=l(),lt=r("h2"),jt=r("a"),zs=r("span"),x(Do.$$.fragment),Cd=l(),Ps=r("span"),jd=n("Speech2TextModel"),ur=l(),be=r("div"),x(Io.$$.fragment),Md=l(),Lo=r("p"),Nd=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ic=l(),Ee=r("div"),x(Ko.$$.fragment),dc=l(),ft=r("p"),cc=n("The "),Nn=r("a"),lc=n("Speech2TextForConditionalGeneration"),pc=n(" forward method, overrides the "),Ns=r("code"),hc=n("__call__"),fc=n(" special method."),mc=l(),x(Dt.$$.fragment),uc=l(),x(It.$$.fragment),Tr=l(),mt=r("h2"),Lt=r("a"),As=r("span"),x(Jo.$$.fragment),_c=l(),Ds=r("span"),gc=n("TFSpeech2TextModel"),vr=l(),he=r("div"),x(Yo.$$.fragment),Tc=l(),Xo=r("p"),vc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
features. The `),pn=a(Je,"A",{href:!0});var fl=i(pn);oa=s(fl,"Speech2TextProcessor"),fl.forEach(t),na=s(Je," wraps "),hn=a(Je,"A",{href:!0});var ml=i(hn);sa=s(ml,"Speech2TextFeatureExtractor"),ml.forEach(t),ra=s(Je,` and
`),fn=a(Je,"A",{href:!0});var ul=i(fn);aa=s(ul,"Speech2TextTokenizer"),ul.forEach(t),ia=s(Je,` into a single instance to both extract the input features and decode the
predicted token ids.`),Je.forEach(t),er=p(o),W=a(o,"P",{});var me=i(W);da=s(me,"The feature extractor depends on "),Yn=a(me,"CODE",{});var _l=i(Yn);ca=s(_l,"torchaudio"),_l.forEach(t),la=s(me," and the tokenizer depends on "),Xn=a(me,"CODE",{});var gl=i(Xn);pa=s(gl,"sentencepiece"),gl.forEach(t),ha=s(me,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
`),Qn=a(me,"CODE",{});var Tl=i(Qn);fa=s(Tl,'pip install transformers"[speech, sentencepiece]"'),Tl.forEach(t),ma=s(me," or install the packages separately with "),Zn=a(me,"CODE",{});var vl=i(Zn);ua=s(vl,"pip install torchaudio sentencepiece"),vl.forEach(t),_a=s(me,". Also "),es=a(me,"CODE",{});var bl=i(es);ga=s(bl,"torchaudio"),bl.forEach(t),Ta=s(me," requires the development version of the "),oo=a(me,"A",{href:!0,rel:!0});var xl=i(oo);va=s(xl,"libsndfile"),xl.forEach(t),ba=s(me,` package which can be installed via a system package manager. On Ubuntu it can
...
the target language id is forced as the first generated token. To force the target language id as the first
generated token, pass the `),as=a(ze,"CODE",{});var Fl=i(as);za=s(Fl,"forced_bos_token_id"),Fl.forEach(t),Pa=s(ze," parameter to the "),is=a(ze,"CODE",{});var zl=i(is);Ca=s(zl,"generate()"),zl.forEach(t),ja=s(ze,` method. The following
example shows how to transate English speech to French text using the `),ds=a(ze,"EM",{});var Pl=i(ds);Ma=s(Pl,"facebook/s2t-medium-mustc-multilingual-st"),Pl.forEach(t),Na=s(ze,`
checkpoint.`),ze.forEach(t),Sr.forEach(t),Sl.forEach(t),sr=p(o),k(ro.$$.fragment,o),rr=p(o),Tt=a(o,"P",{});var $r=i(Tt);Aa=s($r,"See the "),ao=a($r,"A",{href:!0,rel:!0});var Cl=i(ao);Da=s(Cl,"model hub"),Cl.forEach(t),Ia=s($r," to look for Speech2Text checkpoints."),$r.forEach(t),ar=p(o),st=a(o,"H2",{class:!0});var Er=i(st);vt=a(Er,"A",{id:!0,class:!0,href:!0});var jl=i(vt);cs=a(jl,"SPAN",{});var Ml=i(cs);k(io.$$.fragment,Ml),Ml.forEach(t),jl.forEach(t),La=p(Er),ls=a(Er,"SPAN",{});var Nl=i(ls);Oa=s(Nl,"Speech2TextConfig"),Nl.forEach(t),Er.forEach(t),ir=p(o),ve=a(o,"DIV",{class:!0});var Bt=i(ve);k(co.$$.fragment,Bt),Ga=p(Bt),rt=a(Bt,"P",{});var Gn=i(rt);Ua=s(Gn,"This is the configuration class to store the configuration of a "),_n=a(Gn,"A",{href:!0});var Al=i(_n);Wa=s(Al,"Speech2TextModel"),Al.forEach(t),Ra=s(Gn,`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
...
`),qo=a(Kt,"A",{href:!0});var rl=i(qo);Es=a(rl,"STRONG",{});var mp=i(Es);ad=s(mp,"call"),mp.forEach(t),id=s(rl,"()"),rl.forEach(t),dd=s(Kt,`. Please refer to the doctsring of the above two methods for more
information.`),Kt.forEach(t),Dr.forEach(t),cd=p(V),Be=a(V,"DIV",{class:!0});var Rn=i(Be);k(Fo.$$.fragment,Rn),ld=p(Rn),qs=a(Rn,"P",{});var up=i(qs);pd=s(up,"Instantiate a processor associated with a pretrained model."),up.forEach(t),hd=p(Rn),k(qt.$$.fragment,Rn),Rn.forEach(t),fd=p(V),Ke=a(V,"DIV",{class:!0});var Vn=i(Ke);k(zo.$$.fragment,Vn),md=p(Vn),Po=a(Vn,"P",{});var Ir=i(Po);ud=s(Ir,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Fn=a(Ir,"A",{href:!0});var _p=i(Fn);_d=s(_p,"from_pretrained()"),_p.forEach(t),gd=s(Ir," method."),Ir.forEach(t),Td=p(Vn),k(Ft.$$.fragment,Vn),Vn.forEach(t),vd=p(V),zt=a(V,"DIV",{class:!0});var Lr=i(zt);k(Co.$$.fragment,Lr),bd=p(Lr),jo=a(Lr,"P",{});var Or=i(jo);xd=s(Or,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),zn=a(Or,"A",{href:!0});var gp=i(zn);kd=s(gp,"batch_decode()"),gp.forEach(t),yd=s(Or,`. Please
...
to the docstring of this method for more information.`),Ur.forEach(t),Gr.forEach(t),Fd=p(V),Ct=a(V,"DIV",{class:!0});var Wr=i(Ct);k(Ao.$$.fragment,Wr),zd=p(Wr),Fs=a(Wr,"P",{});var vp=i(Fs);Pd=s(vp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),vp.forEach(t),Wr.forEach(t),V.forEach(t),mr=p(o),lt=a(o,"H2",{class:!0});var Rr=i(lt);jt=a(Rr,"A",{id:!0,class:!0,href:!0});var bp=i(jt);zs=a(bp,"SPAN",{});var xp=i(zs);k(Do.$$.fragment,xp),xp.forEach(t),bp.forEach(t),Cd=p(Rr),Ps=a(Rr,"SPAN",{});var kp=i(Ps);jd=s(kp,"Speech2TextModel"),kp.forEach(t),Rr.forEach(t),ur=p(o),be=a(o,"DIV",{class:!0});var Jt=i(be);k(Io.$$.fragment,Jt),Md=p(Jt),Lo=a(Jt,"P",{});var Vr=i(Lo);Nd=s(Vr,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr.forEach(t),ic=p(Xt),Ee=a(Xt,"DIV",{class:!0});var Qt=i(Ee);k(Ko.$$.fragment,Qt),dc=p(Qt),ft=a(Qt,"P",{});var Bn=i(ft);cc=s(Bn,"The "),Nn=a(Bn,"A",{href:!0});var Cp=i(Nn);lc=s(Cp,"Speech2TextForConditionalGeneration"),Cp.forEach(t),pc=s(Bn," forward method, overrides the "),Ns=a(Bn,"CODE",{});var jp=i(Ns);hc=s(jp,"__call__"),jp.forEach(t),fc=s(Bn," special method."),Bn.forEach(t),mc=p(Qt),k(Dt.$$.fragment,Qt),uc=p(Qt),k(It.$$.fragment,Qt),Qt.forEach(t),Xt.forEach(t),Tr=p(o),mt=a(o,"H2",{class:!0});var Yr=i(mt);Lt=a(Yr,"A",{id:!0,class:!0,href:!0});var Mp=i(Lt);As=a(Mp,"SPAN",{});var Np=i(As);k(Jo.$$.fragment,Np),Np.forEach(t),Mp.forEach(t),_c=p(Yr),Ds=a(Yr,"SPAN",{});var Ap=i(Ds);gc=s(Ap,"TFSpeech2TextModel"),Ap.forEach(t),Yr.forEach(t),vr=p(o),he=a(o,"DIV",{class:!0});var Xe=i(he);k(Yo.$$.fragment,Xe),Tc=p(Xe),Xo=a(Xe,"P",{});var Xr=i(Xo);vc=s(Xr,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ta.forEach(t),Hc=p(Qe),k(Rt.$$.fragment,Qe),Bc=p(Qe),Fe=a(Qe,"DIV",{class:!0});var eo=i(Fe);k(an.$$.fragment,eo),Kc=p(eo),gt=a(eo,"P",{});var Jn=i(gt);Jc=s(Jn,"The "),Ln=a(Jn,"A",{href:!0});var Hp=i(Ln);Yc=s(Hp,"TFSpeech2TextForConditionalGeneration"),Hp.forEach(t),Xc=s(Jn," forward method, overrides the "),Gs=a(Jn,"CODE",{});var Bp=i(Gs);Qc=s(Bp,"__call__"),Bp.forEach(t),Zc=s(Jn," special method."),Jn.forEach(t),el=p(eo),k(Vt.$$.fragment,eo),tl=p(eo),k(Ht.$$.fragment,eo),eo.forEach(t),Qe.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(fh)),c(f,"id","speech2text"),c(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(f,"href","#speech2text"),c(_,"class","relative group"),c(L,"id","overview"),c(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(L,"href","#overview"),c(q,"class","relative group"),c(te,"href","https://arxiv.org/abs/2010.05171"),c(te,"rel","nofollow"),c(M,"href","http://www.openslr.org/12"),c(M,"rel","nofollow"),c(ne,"href","https://github.com/facebookresearch/covost"),c(ne,"rel","nofollow"),c(re,"href","https://ict.fbk.eu/must-c/"),c(re,"rel","nofollow"),c(ae,"href","https://huggingface.co/valhalla"),c(ae,"rel","nofollow"),c(de,"href","https://github.com/pytorch/fairseq/tree/master/examples/speech_to_text"),c(de,"rel","nofollow"),c(T,"id","inference"),c(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(T,"href","#inference"),c(Y,"class","relative group"),c(Se,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),c(pn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextProcessor"),c(hn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),c(fn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer"),c(oo,"href","http://www.mega-nerd.com/libsndfile/"),c(oo,"rel","nofollow"),c(ao,"href","https://huggingface.co/models?filter=speech_to_text"),c(ao,"rel","nofollow"),c(vt,"id","transformers.Speech2TextConfig"),c(vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(vt,"href","#transformers.Speech2TextConfig"),c(st,"class","relative group"),c(_n,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextModel"),c(lo,"href","https://huggingface.co/facebook/s2t-small-librispeech-asr"),c(lo,"rel","nofollow"),c(gn,"href","/docs/transformers/pr_18156/en/main_classes/configuration#transformers.PretrainedConfig"),c(Tn,"href","/docs/transformers/pr_18156/en/main_classes/configuration#transformers.PretrainedConfig"),c(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(xt,"id","transformers.Speech2TextTokenizer"),c(xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xt,"href","#transformers.Speech2TextTokenizer"),c(it,"class","relative group"),c(vn,"href","/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(yt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(xn,"href","../glossary#token-type-ids"),c(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(kn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(wt,"id","transformers.Speech2TextFeatureExtractor"),c(wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wt,"href","#transformers.Speech2TextFeatureExtractor"),c(dt,"class","relative group"),c(yn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),c(St,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c($t,"id","transformers.Speech2TextProcessor"),c($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($t,"href","#transformers.Speech2TextProcessor"),c(ct,"class","relative group"),c(wn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextProcessor"),c(Sn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),c($n,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer"),c(So,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextProcessor.__call__"),c(En,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextProcessor.decode"),c(Eo,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor.__call__"),c(qn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextProcessor.as_target_processor"),c(qo,"href","/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"),c(Et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Fn,"href","/docs/transformers/pr_18156/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),c(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(zn,"href","/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.batch_decode"),c(zt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Pn,"href","/docs/transformers/pr_18156/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.decode"),c(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(jt,"id","transformers.Speech2TextModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.Speech2TextModel"),c(lt,"class","relative group"),c(Cn,"href","/docs/transformers/pr_18156/en/main_classes/model#transformers.PreTrainedModel"),c(Go,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Go,"rel","nofollow"),c(jn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextModel"),c($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(At,"id","transformers.Speech2TextForConditionalGeneration"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.Speech2TextForConditionalGeneration"),c(ht,"class","relative group"),c(Mn,"href","/docs/transformers/pr_18156/en/main_classes/model#transformers.PreTrainedModel"),c(Bo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Bo,"rel","nofollow"),c(Nn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.Speech2TextForConditionalGeneration"),c(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Lt,"id","transformers.TFSpeech2TextModel"),c(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Lt,"href","#transformers.TFSpeech2TextModel"),c(mt,"class","relative group"),c(An,"href","/docs/transformers/pr_18156/en/main_classes/model#transformers.TFPreTrainedModel"),c(Zo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Zo,"rel","nofollow"),c(Dn,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.TFSpeech2TextModel"),c(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Wt,"id","transformers.TFSpeech2TextForConditionalGeneration"),c(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wt,"href","#transformers.TFSpeech2TextForConditionalGeneration"),c(_t,"class","relative group"),c(In,"href","/docs/transformers/pr_18156/en/main_classes/model#transformers.TFPreTrainedModel"),c(rn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(rn,"rel","nofollow"),c(Ln,"href","/docs/transformers/pr_18156/en/model_doc/speech_to_text#transformers.TFSpeech2TextForConditionalGeneration"),c(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,u){e(document.head,h),m(o,b,u),m(o,_,u),e(_,f),e(f,v),y(d,v,null),e(_,g),e(_,E),e(E,A),m(o,F,u),m(o,q,u),e(q,L),e(L,H),y(ee,H,null),e(q,Pe),e(q,B),e(B,Ce),m(o,ye,u),m(o,N,u),e(N,K),e(N,te),e(te,Te),e(N,j),e(N,M),e(M,je),e(N,oe),e(N,ne),e(ne,Me),e(N,se),e(N,re),e(re,Ne),e(N,G),m(o,we,u),m(o,O,u),e(O,Ae),e(O,ae),e(ae,ie),e(O,De),e(O,de),e(de,J),e(O,Ie),m(o,Z,u),m(o,Y,u),e(Y,T),e(T,z),y(X,z,null),e(Y,Ze),e(Y,Le),e(Le,Q),m(o,Re,u),m(o,ue,u),e(ue,et),e(ue,U),e(U,ce),e(ue,tt),m(o,Ve,u),m(o,C,u),e(C,ot),e(C,Se),e(Se,Oe),e(C,nt),e(C,pn),e(pn,oa),e(C,na),e(C,hn),e(hn,sa),e(C,ra),e(C,fn),e(fn,aa),e(C,ia),m(o,er,u),m(o,W,u),e(W,da),e(W,Yn),e(Yn,ca),e(W,la),e(W,Xn),e(Xn,pa),e(W,ha),e(W,Qn),e(Qn,fa),e(W,ma),e(W,Zn),e(Zn,ua),e(W,_a),e(W,es),e(es,ga),e(W,Ta),e(W,oo),e(oo,va),e(W,ba),e(W,ts),e(ts,xa),m(o,tr,u),m(o,mn,u),e(mn,os),e(os,ka),m(o,or,u),y(no,o,u),m(o,nr,u),m(o,un,u),e(un,so),e(so,ns),e(ns,ya),e(so,wa),e(so,le),e(le,Sa),e(le,ss),e(ss,$a),e(le,Ea),e(le,rs),e(rs,qa),e(le,Fa),e(le,as),e(as,za),e(le,Pa),e(le,is),e(is,Ca),e(le,ja),e(le,ds),e(ds,Ma),e(le,Na),m(o,sr,u),y(ro,o,u),m(o,rr,u),m(o,Tt,u),e(Tt,Aa),e(Tt,ao),e(ao,Da),e(Tt,Ia),m(o,ar,u),m(o,st,u),e(st,vt),e(vt,cs),y(io,cs,null),e(st,La),e(st,ls),e(ls,Oa),m(o,ir,u),m(o,ve,u),y(co,ve,null),e(ve,Ga),e(ve,rt),e(rt,Ua),e(rt,_n),e(_n,Wa),e(rt,Ra),e(rt,lo),e(lo,Va),e(rt,Ha),e(ve,Ba),e(ve,at),e(at,Ka),e(at,gn),e(gn,Ja),e(at,Ya),e(at,Tn),e(Tn,Xa),e(at,Qa),e(ve,Za),y(bt,ve,null),m(o,dr,u),m(o,it,u),e(it,xt),e(xt,ps),y(po,ps,null),e(it,ei),e(it,hs),e(hs,ti),m(o,cr,u),m(o,R,u),y(ho,R,null),e(R,oi),e(R,fs),e(fs,ni),e(R,si),e(R,fo),e(fo,ri),e(fo,vn),e(vn,ai),e(fo,ii),e(R,di),e(R,kt),y(mo,kt,null),e(kt,ci),e(kt,ms),e(ms,li),e(R,pi),e(R,yt),y(uo,yt,null),e(yt,hi),e(yt,_o),e(_o,fi),e(_o,us),e(us,mi),e(_o,ui),e(R,_i),e(R,He),y(go,He,null),e(He,gi),e(He,bn),e(bn,Ti),e(bn,xn),e(xn,vi),e(He,bi),e(He,_s),e(_s,xi),e(R,ki),e(R,kn),y(To,kn,null),m(o,lr,u),m(o,dt,u),e(dt,wt),e(wt,gs),y(vo,gs,null),e(dt,yi),e(dt,Ts),e(Ts,wi),m(o,pr,u),m(o,pe,u),y(bo,pe,null),e(pe,Si),e(pe,vs),e(vs,$i),e(pe,Ei),e(pe,xo),e(xo,qi),e(xo,yn),e(yn,Fi),e(xo,zi),e(pe,Pi),e(pe,bs),e(bs,Ci),e(pe,ji),e(pe,St),y(ko,St,null),e(St,Mi),e(St,xs),e(xs,Ni),m(o,hr,u),m(o,ct,u),e(ct,$t),e($t,ks),y(yo,ks,null),e(ct,Ai),e(ct,ys),e(ys,Di),m(o,fr,u),m(o,D,u),y(wo,D,null),e(D,Ii),e(D,ws),e(ws,Li),e(D,Oi),e(D,_e),e(_e,wn),e(wn,Gi),e(_e,Ui),e(_e,Sn),e(Sn,Wi),e(_e,Ri),e(_e,$n),e($n,Vi),e(_e,Hi),e(_e,So),e(So,Ss),e(Ss,Bi),e(So,Ki),e(_e,Ji),e(_e,En),e(En,Yi),e(_e,Xi),e(D,Qi),e(D,Et),y($o,Et,null),e(Et,Zi),e(Et,Ge),e(Ge,ed),e(Ge,Eo),e(Eo,$s),e($s,td),e(Eo,od),e(Ge,nd),e(Ge,qn),e(qn,sd),e(Ge,rd),e(Ge,qo),e(qo,Es),e(Es,ad),e(qo,id),e(Ge,dd),e(D,cd),e(D,Be),y(Fo,Be,null),e(Be,ld),e(Be,qs),e(qs,pd),e(Be,hd),y(qt,Be,null),e(D,fd),e(D,Ke),y(zo,Ke,null),e(Ke,md),e(Ke,Po),e(Po,ud),e(Po,Fn),e(Fn,_d),e(Po,gd),e(Ke,Td),y(Ft,Ke,null),e(D,vd),e(D,zt),y(Co,zt,null),e(zt,bd),e(zt,jo),e(jo,xd),e(jo,zn),e(zn,kd),e(jo,yd),e(D,wd),e(D,Pt),y(Mo,Pt,null),e(Pt,Sd),e(Pt,No),e(No,$d),e(No,Pn),e(Pn,Ed),e(No,qd),e(D,Fd),e(D,Ct),y(Ao,Ct,null),e(Ct,zd),e(Ct,Fs),e(Fs,Pd),m(o,mr,u),m(o,lt,u),e(lt,jt),e(jt,zs),y(Do,zs,null),e(lt,Cd),e(lt,Ps),e(Ps,jd),m(o,ur,u),m(o,be,u),y(Io,be,null),e(be,Md),e(be,Lo),e(Lo,Nd),e(Lo,Cn),e(Cn,Ad),e(Lo,Dd),e(be,Id),e(be,Oo),e(Oo,Ld),e(Oo,Go),e(Go,Od),e(Oo,Gd),e(be,Ud),e(be,$e),y(Uo,$e,null),e($e,Wd),e($e,pt),e(pt,Rd),e(pt,jn),e(jn,Vd),e(pt,Hd),e(pt,Cs),e(Cs,Bd),e(pt,Kd),e($e,Jd),y(Mt,$e,null),e($e,Yd),y(Nt,$e,null),m(o,_r,u),m(o,ht,u),e(ht,At),e(At,js),y(Wo,js,null),e(ht,Xd),e(ht,Ms),e(Ms,Qd),m(o,gr,u),m(o,xe,u),y(Ro,xe,null),e(xe,Zd),e(xe,Vo),e(Vo,ec),e(Vo,Mn),e(Mn,tc),e(Vo,oc),e(xe,nc),e(xe,Ho),e(Ho,sc),e(Ho,Bo),e(Bo,rc),e(Ho,ac),e(xe,ic),e(xe,Ee),y(Ko,Ee,null),e(Ee,dc),e(Ee,ft),e(ft,cc),e(ft,Nn),e(Nn,lc),e(ft,pc),e(ft,Ns),e(Ns,hc),e(ft,fc),e(Ee,mc),y(Dt,Ee,null),e(Ee,uc),y(It,Ee,null),m(o,Tr,u),m(o,mt,u),e(mt,Lt),e(Lt,As),y(Jo,As,null),e(mt,_c),e(mt,Ds),e(Ds,gc),m(o,vr,u),m(o,he,u),y(Yo,he,null),e(he,Tc),e(he,Xo),e(Xo,vc),e(Xo,An),e(An,bc),e(Xo,xc),e(he,kc),e(he,Qo),e(Qo,yc),e(Qo,Zo),e(Zo,wc),e(Qo,Sc),e(he,$c),y(Ot,he,null),e(he,Ec),e(he,qe),y(en,qe,null),e(qe,qc),e(qe,ut),e(ut,Fc),e(ut,Dn),e(Dn,zc),e(ut,Pc),e(ut,Is),e(Is,Cc),e(ut,jc),e(qe,Mc),y(Gt,qe,null),e(qe,Nc),y(Ut,qe,null),m(o,br,u),m(o,_t,u),e(_t,Wt),e(Wt,Ls),y(tn,Ls,null),e(_t,Ac),e(_t,Os),e(Os,Dc),m(o,xr,u),m(o,fe,u),y(on,fe,null),e(fe,Ic),e(fe,nn),e(nn,Lc),e(nn,In),e(In,Oc),e(nn,Gc),e(fe,Uc),e(fe,sn),e(sn,Wc),e(sn,rn),e(rn,Rc),e(sn,Vc),e(fe,Hc),y(Rt,fe,null),e(fe,Bc),e(fe,Fe),y(an,Fe,null),e(Fe,Kc),e(Fe,gt),e(gt,Jc),e(gt,Ln),e(Ln,Yc),e(gt,Xc),e(gt,Gs),e(Gs,Qc),e(gt,Zc),e(Fe,el),y(Vt,Fe,null),e(Fe,tl),y(Ht,Fe,null),kr=!0},p(o,[u]){const dn={};u&2&&(dn.$$scope={dirty:u,ctx:o}),bt.$set(dn);const Us={};u&2&&(Us.$$scope={dirty:u,ctx:o}),qt.$set(Us);const Ws={};u&2&&(Ws.$$scope={dirty:u,ctx:o}),Ft.$set(Ws);const Rs={};u&2&&(Rs.$$scope={dirty:u,ctx:o}),Mt.$set(Rs);const cn={};u&2&&(cn.$$scope={dirty:u,ctx:o}),Nt.$set(cn);const Vs={};u&2&&(Vs.$$scope={dirty:u,ctx:o}),Dt.$set(Vs);const Hs={};u&2&&(Hs.$$scope={dirty:u,ctx:o}),It.$set(Hs);const Bs={};u&2&&(Bs.$$scope={dirty:u,ctx:o}),Ot.$set(Bs);const ke={};u&2&&(ke.$$scope={dirty:u,ctx:o}),Gt.$set(ke);const Ks={};u&2&&(Ks.$$scope={dirty:u,ctx:o}),Ut.$set(Ks);const Js={};u&2&&(Js.$$scope={dirty:u,ctx:o}),Rt.$set(Js);const Ys={};u&2&&(Ys.$$scope={dirty:u,ctx:o}),Vt.$set(Ys);const Xs={};u&2&&(Xs.$$scope={dirty:u,ctx:o}),Ht.$set(Xs)},i(o){kr||(w(d.$$.fragment,o),w(ee.$$.fragment,o),w(X.$$.fragment,o),w(no.$$.fragment,o),w(ro.$$.fragment,o),w(io.$$.fragment,o),w(co.$$.fragment,o),w(bt.$$.fragment,o),w(po.$$.fragment,o),w(ho.$$.fragment,o),w(mo.$$.fragment,o),w(uo.$$.fragment,o),w(go.$$.fragment,o),w(To.$$.fragment,o),w(vo.$$.fragment,o),w(bo.$$.fragment,o),w(ko.$$.fragment,o),w(yo.$$.fragment,o),w(wo.$$.fragment,o),w($o.$$.fragment,o),w(Fo.$$.fragment,o),w(qt.$$.fragment,o),w(zo.$$.fragment,o),w(Ft.$$.fragment,o),w(Co.$$.fragment,o),w(Mo.$$.fragment,o),w(Ao.$$.fragment,o),w(Do.$$.fragment,o),w(Io.$$.fragment,o),w(Uo.$$.fragment,o),w(Mt.$$.fragment,o),w(Nt.$$.fragment,o),w(Wo.$$.fragment,o),w(Ro.$$.fragment,o),w(Ko.$$.fragment,o),w(Dt.$$.fragment,o),w(It.$$.fragment,o),w(Jo.$$.fragment,o),w(Yo.$$.fragment,o),w(Ot.$$.fragment,o),w(en.$$.fragment,o),w(Gt.$$.fragment,o),w(Ut.$$.fragment,o),w(tn.$$.fragment,o),w(on.$$.fragment,o),w(Rt.$$.fragment,o),w(an.$$.fragment,o),w(Vt.$$.fragment,o),w(Ht.$$.fragment,o),kr=!0)},o(o){S(d.$$.fragment,o),S(ee.$$.fragment,o),S(X.$$.fragment,o),S(no.$$.fragment,o),S(ro.$$.fragment,o),S(io.$$.fragment,o),S(co.$$.fragment,o),S(bt.$$.fragment,o),S(po.$$.fragment,o),S(ho.$$.fragment,o),S(mo.$$.fragment,o),S(uo.$$.fragment,o),S(go.$$.fragment,o),S(To.$$.fragment,o),S(vo.$$.fragment,o),S(bo.$$.fragment,o),S(ko.$$.fragment,o),S(yo.$$.fragment,o),S(wo.$$.fragment,o),S($o.$$.fragment,o),S(Fo.$$.fragment,o),S(qt.$$.fragment,o),S(zo.$$.fragment,o),S(Ft.$$.fragment,o),S(Co.$$.fragment,o),S(Mo.$$.fragment,o),S(Ao.$$.fragment,o),S(Do.$$.fragment,o),S(Io.$$.fragment,o),S(Uo.$$.fragment,o),S(Mt.$$.fragment,o),S(Nt.$$.fragment,o),S(Wo.$$.fragment,o),S(Ro.$$.fragment,o),S(Ko.$$.fragment,o),S(Dt.$$.fragment,o),S(It.$$.fragment,o),S(Jo.$$.fragment,o),S(Yo.$$.fragment,o),S(Ot.$$.fragment,o),S(en.$$.fragment,o),S(Gt.$$.fragment,o),S(Ut.$$.fragment,o),S(tn.$$.fragment,o),S(on.$$.fragment,o),S(Rt.$$.fragment,o),S(an.$$.fragment,o),S(Vt.$$.fragment,o),S(Ht.$$.fragment,o),kr=!1},d(o){t(h),o&&t(b),o&&t(_),$(d),o&&t(F),o&&t(q),$(ee),o&&t(ye),o&&t(N),o&&t(we),o&&t(O),o&&t(Z),o&&t(Y),$(X),o&&t(Re),o&&t(ue),o&&t(Ve),o&&t(C),o&&t(er),o&&t(W),o&&t(tr),o&&t(mn),o&&t(or),$(no,o),o&&t(nr),o&&t(un),o&&t(sr),$(ro,o),o&&t(rr),o&&t(Tt),o&&t(ar),o&&t(st),$(io),o&&t(ir),o&&t(ve),$(co),$(bt),o&&t(dr),o&&t(it),$(po),o&&t(cr),o&&t(R),$(ho),$(mo),$(uo),$(go),$(To),o&&t(lr),o&&t(dt),$(vo),o&&t(pr),o&&t(pe),$(bo),$(ko),o&&t(hr),o&&t(ct),$(yo),o&&t(fr),o&&t(D),$(wo),$($o),$(Fo),$(qt),$(zo),$(Ft),$(Co),$(Mo),$(Ao),o&&t(mr),o&&t(lt),$(Do),o&&t(ur),o&&t(be),$(Io),$(Uo),$(Mt),$(Nt),o&&t(_r),o&&t(ht),$(Wo),o&&t(gr),o&&t(xe),$(Ro),$(Ko),$(Dt),$(It),o&&t(Tr),o&&t(mt),$(Jo),o&&t(vr),o&&t(he),$(Yo),$(Ot),$(en),$(Gt),$(Ut),o&&t(br),o&&t(_t),$(tn),o&&t(xr),o&&t(fe),$(on),$(Rt),$(an),$(Vt),$(Ht)}}}const fh={local:"speech2text",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.Speech2TextConfig",title:"Speech2TextConfig"},{local:"transformers.Speech2TextTokenizer",title:"Speech2TextTokenizer"},{local:"transformers.Speech2TextFeatureExtractor",title:"Speech2TextFeatureExtractor"},{local:"transformers.Speech2TextProcessor",title:"Speech2TextProcessor"},{local:"transformers.Speech2TextModel",title:"Speech2TextModel"},{local:"transformers.Speech2TextForConditionalGeneration",title:"Speech2TextForConditionalGeneration"},{local:"transformers.TFSpeech2TextModel",title:"TFSpeech2TextModel"},{local:"transformers.TFSpeech2TextForConditionalGeneration",title:"TFSpeech2TextForConditionalGeneration"}],title:"Speech2Text"};function mh(P){return Qp(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class xh extends Kp{constructor(h){super();Jp(this,h,mh,hh,Yp,{})}}export{xh as default,fh as metadata};
