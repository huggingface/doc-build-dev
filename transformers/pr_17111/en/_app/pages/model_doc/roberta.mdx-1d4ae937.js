...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nb=p(),Ft=n("div"),y(tr.$$.fragment),Ib=p(),$o=n("p"),Db=r("The "),ld=n("a"),Sb=r("RobertaForCausalLM"),Wb=r(" forward method, overrides the "),Uc=n("code"),Bb=r("__call__"),Ub=r(" special method."),Hb=p(),y(jn.$$.fragment),Qb=p(),y(Pn.$$.fragment),tf=p(),Fo=n("h2"),Ln=n("a"),Hc=n("span"),y(or.$$.fragment),Vb=p(),Qc=n("span"),Jb=r("RobertaForMaskedLM"),of=p(),ot=n("div"),y(nr.$$.fragment),Kb=p(),sr=n("p"),Gb=r("RoBERTa Model with a "),Vc=n("code"),Xb=r("language modeling"),Yb=r(" head on top."),Zb=p(),ar=n("p"),e1=r("This model inherits from "),dd=n("a"),t1=r("PreTrainedModel"),o1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),n1=p(),rr=n("p"),s1=r("This model is also a PyTorch "),ir=n("a"),a1=r("torch.nn.Module"),r1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),i1=p(),it=n("div"),y(lr.$$.fragment),l1=p(),xo=n("p"),d1=r("The "),cd=n("a"),c1=r("RobertaForMaskedLM"),p1=r(" forward method, overrides the "),Jc=n("code"),h1=r("__call__"),m1=r(" special method."),f1=p(),y(An.$$.fragment),u1=p(),y(On.$$.fragment),g1=p(),y(Nn.$$.fragment),nf=p(),Ro=n("h2"),In=n("a"),Kc=n("span"),y(dr.$$.fragment),_1=p(),Gc=n("span"),b1=r("RobertaForSequenceClassification"),sf=p(),nt=n("div"),y(cr.$$.fragment),k1=p(),Xc=n("p"),v1=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),y1=p(),pr=n("p"),T1=r("This model inherits from "),pd=n("a"),w1=r("PreTrainedModel"),$1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),F1=p(),hr=n("p"),x1=r("This model is also a PyTorch "),mr=n("a"),R1=r("torch.nn.Module"),M1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),E1=p(),Ue=n("div"),y(fr.$$.fragment),z1=p(),Mo=n("p"),C1=r("The "),hd=n("a"),q1=r("RobertaForSequenceClassification"),j1=r(" forward method, overrides the "),Yc=n("code"),P1=r("__call__"),L1=r(" special method."),A1=p(),y(Dn.$$.fragment),O1=p(),y(Sn.$$.fragment),N1=p(),y(Wn.$$.fragment),I1=p(),y(Bn.$$.fragment),D1=p(),y(Un.$$.fragment),af=p(),Eo=n("h2"),Hn=n("a"),Zc=n("span"),y(ur.$$.fragment),S1=p(),ep=n("span"),W1=r("RobertaForMultipleChoice"),rf=p(),st=n("div"),y(gr.$$.fragment),B1=p(),tp=n("p"),U1=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),H1=p(),_r=n("p"),Q1=r("This model inherits from "),md=n("a"),V1=r("PreTrainedModel"),J1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),K1=p(),br=n("p"),G1=r("This model is also a PyTorch "),kr=n("a"),X1=r("torch.nn.Module"),Y1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Z1=p(),xt=n("div"),y(vr.$$.fragment),ek=p(),zo=n("p"),tk=r("The "),fd=n("a"),ok=r("RobertaForMultipleChoice"),nk=r(" forward method, overrides the "),op=n("code"),sk=r("__call__"),ak=r(" special method."),rk=p(),y(Qn.$$.fragment),ik=p(),y(Vn.$$.fragment),lf=p(),Co=n("h2"),Jn=n("a"),np=n("span"),y(yr.$$.fragment),lk=p(),sp=n("span"),dk=r("RobertaForTokenClassification"),df=p(),at=n("div"),y(Tr.$$.fragment),ck=p(),ap=n("p"),pk=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),hk=p(),wr=n("p"),mk=r("This model inherits from "),ud=n("a"),fk=r("PreTrainedModel"),uk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gk=p(),$r=n("p"),_k=r("This model is also a PyTorch "),Fr=n("a"),bk=r("torch.nn.Module"),kk=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vk=p(),lt=n("div"),y(xr.$$.fragment),yk=p(),qo=n("p"),Tk=r("The "),gd=n("a"),wk=r("RobertaForTokenClassification"),$k=r(" forward method, overrides the "),rp=n("code"),Fk=r("__call__"),xk=r(" special method."),Rk=p(),y(Kn.$$.fragment),Mk=p(),y(Gn.$$.fragment),Ek=p(),y(Xn.$$.fragment),cf=p(),jo=n("h2"),Yn=n("a"),ip=n("span"),y(Rr.$$.fragment),zk=p(),lp=n("span"),Ck=r("RobertaForQuestionAnswering"),pf=p(),rt=n("div"),y(Mr.$$.fragment),qk=p(),Po=n("p"),jk=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=n("code"),Pk=r("span start logits"),Lk=r(" and "),cp=n("code"),Ak=r("span end logits"),Ok=r(")."),Nk=p(),Er=n("p"),Ik=r("This model inherits from "),_d=n("a"),Dk=r("PreTrainedModel"),Sk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wk=p(),zr=n("p"),Bk=r("This model is also a PyTorch "),Cr=n("a"),Uk=r("torch.nn.Module"),Hk=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qk=p(),dt=n("div"),y(qr.$$.fragment),Vk=p(),Lo=n("p"),Jk=r("The "),bd=n("a"),Kk=r("RobertaForQuestionAnswering"),Gk=r(" forward method, overrides the "),pp=n("code"),Xk=r("__call__"),Yk=r(" special method."),Zk=p(),y(Zn.$$.fragment),ev=p(),y(es.$$.fragment),tv=p(),y(ts.$$.fragment),hf=p(),Ao=n("h2"),os=n("a"),hp=n("span"),y(jr.$$.fragment),ov=p(),mp=n("span"),nv=r("TFRobertaModel"),mf=p(),Qe=n("div"),y(Pr.$$.fragment),sv=p(),fp=n("p"),av=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),rv=p(),Lr=n("p"),iv=r("This model inherits from "),kd=n("a"),lv=r("TFPreTrainedModel"),dv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zf.forEach(t),Nb=h(oo),Ft=s(oo,"DIV",{class:!0});var ta=a(Ft);T(tr.$$.fragment,ta),Ib=h(ta),$o=s(ta,"P",{});var Bd=a($o);Db=i(Bd,"The "),ld=s(Bd,"A",{href:!0});var P0=a(ld);Sb=i(P0,"RobertaForCausalLM"),P0.forEach(t),Wb=i(Bd," forward method, overrides the "),Uc=s(Bd,"CODE",{});var L0=a(Uc);Bb=i(L0,"__call__"),L0.forEach(t),Ub=i(Bd," special method."),Bd.forEach(t),Hb=h(ta),T(jn.$$.fragment,ta),Qb=h(ta),T(Pn.$$.fragment,ta),ta.forEach(t),oo.forEach(t),tf=h(o),Fo=s(o,"H2",{class:!0});var eu=a(Fo);Ln=s(eu,"A",{id:!0,class:!0,href:!0});var A0=a(Ln);Hc=s(A0,"SPAN",{});var O0=a(Hc);T(or.$$.fragment,O0),O0.forEach(t),A0.forEach(t),Vb=h(eu),Qc=s(eu,"SPAN",{});var N0=a(Qc);Jb=i(N0,"RobertaForMaskedLM"),N0.forEach(t),eu.forEach(t),of=h(o),ot=s(o,"DIV",{class:!0});var no=a(ot);T(nr.$$.fragment,no),Kb=h(no),sr=s(no,"P",{});var tu=a(sr);Gb=i(tu,"RoBERTa Model with a "),Vc=s(tu,"CODE",{});var I0=a(Vc);Xb=i(I0,"language modeling"),I0.forEach(t),Yb=i(tu," head on top."),tu.forEach(t),Zb=h(no),ar=s(no,"P",{});var ou=a(ar);e1=i(ou,"This model inherits from "),dd=s(ou,"A",{href:!0});var D0=a(dd);t1=i(D0,"PreTrainedModel"),D0.forEach(t),o1=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),n1=h(no),rr=s(no,"P",{});var nu=a(rr);s1=i(nu,"This model is also a PyTorch "),ir=s(nu,"A",{href:!0,rel:!0});var S0=a(ir);a1=i(S0,"torch.nn.Module"),S0.forEach(t),r1=i(nu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),i1=h(no),it=s(no,"DIV",{class:!0});var so=a(it);T(lr.$$.fragment,so),l1=h(so),xo=s(so,"P",{});var Ud=a(xo);d1=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var W0=a(cd);c1=i(W0,"RobertaForMaskedLM"),W0.forEach(t),p1=i(Ud," forward method, overrides the "),Jc=s(Ud,"CODE",{});var B0=a(Jc);h1=i(B0,"__call__"),B0.forEach(t),m1=i(Ud," special method."),Ud.forEach(t),f1=h(so),T(An.$$.fragment,so),u1=h(so),T(On.$$.fragment,so),g1=h(so),T(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nf=h(o),Ro=s(o,"H2",{class:!0});var su=a(Ro);In=s(su,"A",{id:!0,class:!0,href:!0});var U0=a(In);Kc=s(U0,"SPAN",{});var H0=a(Kc);T(dr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),_1=h(su),Gc=s(su,"SPAN",{});var Q0=a(Gc);b1=i(Q0,"RobertaForSequenceClassification"),Q0.forEach(t),su.forEach(t),sf=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);T(cr.$$.fragment,ao),k1=h(ao),Xc=s(ao,"P",{});var V0=a(Xc);v1=i(V0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V0.forEach(t),y1=h(ao),pr=s(ao,"P",{});var au=a(pr);T1=i(au,"This model inherits from "),pd=s(au,"A",{href:!0});var J0=a(pd);w1=i(J0,"PreTrainedModel"),J0.forEach(t),$1=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),F1=h(ao),hr=s(ao,"P",{});var ru=a(hr);x1=i(ru,"This model is also a PyTorch "),mr=s(ru,"A",{href:!0,rel:!0});var K0=a(mr);R1=i(K0,"torch.nn.Module"),K0.forEach(t),M1=i(ru,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),E1=h(ao),Ue=s(ao,"DIV",{class:!0});var ut=a(Ue);T(fr.$$.fragment,ut),z1=h(ut),Mo=s(ut,"P",{});var Hd=a(Mo);C1=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G0=a(hd);q1=i(G0,"RobertaForSequenceClassification"),G0.forEach(t),j1=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X0=a(Yc);P1=i(X0,"__call__"),X0.forEach(t),L1=i(Hd," special method."),Hd.forEach(t),A1=h(ut),T(Dn.$$.fragment,ut),O1=h(ut),T(Sn.$$.fragment,ut),N1=h(ut),T(Wn.$$.fragment,ut),I1=h(ut),T(Bn.$$.fragment,ut),D1=h(ut),T(Un.$$.fragment,ut),ut.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var iu=a(Eo);Hn=s(iu,"A",{id:!0,class:!0,href:!0});var Y0=a(Hn);Zc=s(Y0,"SPAN",{});var Z0=a(Zc);T(ur.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),S1=h(iu),ep=s(iu,"SPAN",{});var ex=a(ep);W1=i(ex,"RobertaForMultipleChoice"),ex.forEach(t),iu.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);T(gr.$$.fragment,ro),B1=h(ro),tp=s(ro,"P",{});var tx=a(tp);U1=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tx.forEach(t),H1=h(ro),_r=s(ro,"P",{});var lu=a(_r);Q1=i(lu,"This model inherits from "),md=s(lu,"A",{href:!0});var ox=a(md);V1=i(ox,"PreTrainedModel"),ox.forEach(t),J1=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),K1=h(ro),br=s(ro,"P",{});var du=a(br);G1=i(du,"This model is also a PyTorch "),kr=s(du,"A",{href:!0,rel:!0});var nx=a(kr);X1=i(nx,"torch.nn.Module"),nx.forEach(t),Y1=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Z1=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);T(vr.$$.fragment,oa),ek=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tk=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var sx=a(fd);ok=i(sx,"RobertaForMultipleChoice"),sx.forEach(t),nk=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var ax=a(op);sk=i(ax,"__call__"),ax.forEach(t),ak=i(Qd," special method."),Qd.forEach(t),rk=h(oa),T(Qn.$$.fragment,oa),ik=h(oa),T(Vn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),Co=s(o,"H2",{class:!0});var cu=a(Co);Jn=s(cu,"A",{id:!0,class:!0,href:!0});var rx=a(Jn);np=s(rx,"SPAN",{});var ix=a(np);T(yr.$$.fragment,ix),ix.forEach(t),rx.forEach(t),lk=h(cu),sp=s(cu,"SPAN",{});var lx=a(sp);dk=i(lx,"RobertaForTokenClassification"),lx.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);T(Tr.$$.fragment,io),ck=h(io),ap=s(io,"P",{});var dx=a(ap);pk=i(dx,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),hk=h(io),wr=s(io,"P",{});var pu=a(wr);mk=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var cx=a(ud);fk=i(cx,"PreTrainedModel"),cx.forEach(t),uk=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),gk=h(io),$r=s(io,"P",{});var hu=a($r);_k=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var px=a(Fr);bk=i(px,"torch.nn.Module"),px.forEach(t),kk=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vk=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);T(xr.$$.fragment,lo),yk=h(lo),qo=s(lo,"P",{});var Vd=a(qo);Tk=i(Vd,"The "),gd=s(Vd,"A",{href:!0});var hx=a(gd);wk=i(hx,"RobertaForTokenClassification"),hx.forEach(t),$k=i(Vd," forward method, overrides the "),rp=s(Vd,"CODE",{});var mx=a(rp);Fk=i(mx,"__call__"),mx.forEach(t),xk=i(Vd," special method."),Vd.forEach(t),Rk=h(lo),T(Kn.$$.fragment,lo),Mk=h(lo),T(Gn.$$.fragment,lo),Ek=h(lo),T(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var fx=a(Yn);ip=s(fx,"SPAN",{});var ux=a(ip);T(Rr.$$.fragment,ux),ux.forEach(t),fx.forEach(t),zk=h(mu),lp=s(mu,"SPAN",{});var gx=a(lp);Ck=i(gx,"RobertaForQuestionAnswering"),gx.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);T(Mr.$$.fragment,co),qk=h(co),Po=s(co,"P",{});var Jd=a(Po);jk=i(Jd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Jd,"CODE",{});var _x=a(dp);Pk=i(_x,"span start logits"),_x.forEach(t),Lk=i(Jd," and "),cp=s(Jd,"CODE",{});var bx=a(cp);Ak=i(bx,"span end logits"),bx.forEach(t),Ok=i(Jd,")."),Jd.forEach(t),Nk=h(co),Er=s(co,"P",{});var fu=a(Er);Ik=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var kx=a(_d);Dk=i(kx,"PreTrainedModel"),kx.forEach(t),Sk=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wk=h(co),zr=s(co,"P",{});var uu=a(zr);Bk=i(uu,"This model is also a PyTorch "),Cr=s(uu,"A",{href:!0,rel:!0});var vx=a(Cr);Uk=i(vx,"torch.nn.Module"),vx.forEach(t),Hk=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qk=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(qr.$$.fragment,po),Vk=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jk=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var yx=a(bd);Kk=i(yx,"RobertaForQuestionAnswering"),yx.forEach(t),Gk=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var Tx=a(pp);Xk=i(Tx,"__call__"),Tx.forEach(t),Yk=i(Kd," special method."),Kd.forEach(t),Zk=h(po),T(Zn.$$.fragment,po),ev=h(po),T(es.$$.fragment,po),tv=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var wx=a(os);hp=s(wx,"SPAN",{});var $x=a(hp);T(jr.$$.fragment,$x),$x.forEach(t),wx.forEach(t),ov=h(gu),mp=s(gu,"SPAN",{});var Fx=a(mp);nv=i(Fx,"TFRobertaModel"),Fx.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),sv=h(Ot),fp=s(Ot,"P",{});var xx=a(fp);av=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),rv=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iv=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var Rx=a(kd);lv=i(Rx,"TFPreTrainedModel"),Rx.forEach(t),dv=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
