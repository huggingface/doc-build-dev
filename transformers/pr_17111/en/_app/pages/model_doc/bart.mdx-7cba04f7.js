...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/tokenization_bart.py#L390",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
Whether the post processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/tokenization_bart_fast.py#L70"}}),Eo=new E({props:{anchor:"transformers.BartTokenizerFast.example",$$slots:{default:[aT]},$$scope:{ctx:F}}}),Po=new Fe({props:{$$slots:{default:[sT]},$$scope:{ctx:F}}}),Ma=new B({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/tokenization_bart_fast.py#L282",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17111/en/model_doc/bart#transformers.BartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_bart.py#L1307",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_bart.py#L1450",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_bart.py#L1576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_bart.py#L1725",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_tf_bart.py#L1142",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_tf_bart.py#L1251",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L999",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L1062",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L1331",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/bart/modeling_flax_bart.py#L1802",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ob=h(),ol=a("p"),Ib=i("Finally, this model supports inherent JAX features such as:"),Nb=h(),mt=a("ul"),nl=a("li"),sr=a("a"),Lb=i("Just-In-Time (JIT) compilation"),Db=h(),al=a("li"),rr=a("a"),Gb=i("Automatic Differentiation"),Wb=h(),sl=a("li"),ir=a("a"),Ub=i("Vectorization"),Rb=h(),rl=a("li"),dr=a("a"),Qb=i("Parallelization"),Hb=h(),Ze=a("div"),y(lr.$$.fragment),Vb=h(),mo=a("p"),Jb=i("The "),il=a("code"),Xb=i("FlaxBartPreTrainedModel"),Kb=i(" forward method, overrides the "),dl=a("code"),Zb=i("__call__"),Yb=i(" special method."),e1=h(),y(An.$$.fragment),t1=h(),y(Sn.$$.fragment),o1=h(),On=a("div"),y(cr.$$.fragment),n1=h(),y(In.$$.fragment),a1=h(),Nn=a("div"),y(pr.$$.fragment),s1=h(),y(Ln.$$.fragment),Bc=h(),fo=a("h2"),Dn=a("a"),ll=a("span"),y(hr.$$.fragment),r1=h(),cl=a("span"),i1=i("FlaxBartForCausalLM"),jc=h(),Z=a("div"),y(ur.$$.fragment),d1=h(),pl=a("p"),l1=i(`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
e.g for autoregressive tasks.`),c1=h(),mr=a("p"),p1=i("This model inherits from "),ni=a("a"),h1=i("FlaxPreTrainedModel"),u1=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),m1=h(),fr=a("p"),f1=i(`This model is also a Flax Linen
`),_r=a("a"),_1=i("flax.nn.Module"),g1=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),b1=h(),hl=a("p"),k1=i("Finally, this model supports inherent JAX features such as:"),y1=h(),ft=a("ul"),ul=a("li"),gr=a("a"),v1=i("Just-In-Time (JIT) compilation"),T1=h(),ml=a("li"),br=a("a"),w1=i("Automatic Differentiation"),$1=h(),fl=a("li"),kr=a("a"),x1=i("Vectorization"),F1=h(),_l=a("li"),yr=a("a"),z1=i("Parallelization"),q1=h(),Ye=a("div"),y(vr.$$.fragment),B1=h(),_o=a("p"),j1=i("The "),gl=a("code"),C1=i("FlaxBartDecoderPreTrainedModel"),M1=i(" forward method, overrides the "),bl=a("code"),E1=i("__call__"),P1=i(" special method."),A1=h(),y(Gn.$$.fragment),S1=h(),y(Wn.$$.fragment),this.h()},l(o){const b=Yv('[data-svelte="svelte-1phssyn"]',document.head);l=s(b,"META",{name:!0,content:!0}),b.forEach(t),g=u(o),m=s(o,"H1",{class:!0});var Tr=r(m);c=s(Tr,"A",{id:!0,class:!0,href:!0});var kl=r(c);_=s(kl,"SPAN",{});var yl=r(_);v(n.$$.fragment,yl),yl.forEach(t),kl.forEach(t),p=u(Tr),q=s(Tr,"SPAN",{});var vl=r(q);ne=d(vl,"BART"),vl.forEach(t),Tr.forEach(t),O=u(o),j=s(o,"P",{});var Un=r(j);le=s(Un,"STRONG",{});var Tl=r(le);_e=d(Tl,"DISCLAIMER:"),Tl.forEach(t),et=d(Un," If you see something strange, file a "),ge=s(Un,"A",{href:!0,rel:!0});var wl=r(ge);be=d(wl,"Github Issue"),wl.forEach(t),tt=d(Un,` and assign
...
`),jr=s(gt,"A",{href:!0});var Vl=r(jr);rh=d(Vl,"encode()"),Vl.forEach(t),ih=d(gt," to get the proper splitting."),gt.forEach(t),dh=u(Re),At=s(Re,"LI",{});var yo=r(At);lh=d(yo,"The forward pass of "),Cr=s(yo,"A",{href:!0});var L1=r(Cr);ch=d(L1,"BartModel"),L1.forEach(t),ph=d(yo," will create the "),zi=s(yo,"CODE",{});var D1=r(zi);hh=d(D1,"decoder_input_ids"),D1.forEach(t),uh=d(yo,` if they are not passed.
...
`),qi=s(ai,"CODE",{});var G1=r(qi);_h=d(G1,"forced_bos_token_id=0"),G1.forEach(t),gh=d(ai,`. This only works, however, if the string you pass to
`),Bi=s(ai,"CODE",{});var W1=r(Bi);bh=d(W1,"fairseq.encode"),W1.forEach(t),kh=d(ai," starts with a space."),ai.forEach(t),yh=u(Re),Mr=s(Re,"LI",{});var O1=r(Mr);Er=s(O1,"A",{href:!0});var U1=r(Er);vh=d(U1,"generate()"),U1.forEach(t),Th=d(O1,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),O1.forEach(t),wh=u(Re),Ot=s(Re,"LI",{});var si=r(Ot);$h=d(si,"Models that load the "),ji=s(si,"EM",{});var R1=r(ji);xh=d(R1,"facebook/bart-large-cnn"),R1.forEach(t),Fh=d(si," weights will not have a "),Ci=s(si,"CODE",{});var Q1=r(Ci);zh=d(Q1,"mask_token_id"),Q1.forEach(t),qh=d(si,`, or be able to perform
mask-filling tasks.`),si.forEach(t),Re.forEach(t),Zl=u(o),It=s(o,"H2",{class:!0});var Mc=r(It);wo=s(Mc,"A",{id:!0,class:!0,href:!0});var H1=r(wo);Mi=s(H1,"SPAN",{});var V1=r(Mi);v(ha.$$.fragment,V1),V1.forEach(t),H1.forEach(t),Bh=u(Mc),Ei=s(Mc,"SPAN",{});var J1=r(Ei);jh=d(J1,"Mask Filling"),J1.forEach(t),Mc.forEach(t),Yl=u(o),kt=s(o,"P",{});var ri=r(kt);Ch=d(ri,"The "),Pi=s(ri,"CODE",{});var X1=r(Pi);Mh=d(X1,"facebook/bart-base"),X1.forEach(t),Eh=d(ri," and "),Ai=s(ri,"CODE",{});var K1=r(Ai);Ph=d(K1,"facebook/bart-large"),K1.forEach(t),Ah=d(ri," checkpoints can be used to fill multi-token masks."),ri.forEach(t),ec=u(o),v(ua.$$.fragment,o),tc=u(o),Nt=s(o,"H2",{class:!0});var Ec=r(Nt);$o=s(Ec,"A",{id:!0,class:!0,href:!0});var Z1=r($o);Si=s(Z1,"SPAN",{});var Y1=r(Si);v(ma.$$.fragment,Y1),Y1.forEach(t),Z1.forEach(t),Sh=u(Ec),Oi=s(Ec,"SPAN",{});var ek=r(Oi);Oh=d(ek,"BartConfig"),ek.forEach(t),Ec.forEach(t),oc=u(o),Ge=s(o,"DIV",{class:!0});var Qn=r(Ge);v(fa.$$.fragment,Qn),Ih=u(Qn),Lt=s(Qn,"P",{});var ii=r(Lt);Nh=d(ii,"This is the configuration class to store the configuration of a "),Pr=s(ii,"A",{href:!0});var tk=r(Pr);Lh=d(tk,"BartModel"),tk.forEach(t),Dh=d(ii,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),_a=s(ii,"A",{href:!0,rel:!0});var ok=r(_a);Gh=d(ok,"facebook/bart-large"),ok.forEach(t),Wh=d(ii," architecture."),ii.forEach(t),Uh=u(Qn),Dt=s(Qn,"P",{});var di=r(Dt);Rh=d(di,"Configuration objects inherit from "),Ar=s(di,"A",{href:!0});var nk=r(Ar);Qh=d(nk,"PretrainedConfig"),nk.forEach(t),Hh=d(di,` and can be used to control the model outputs. Read the
documentation from `),Sr=s(di,"A",{href:!0});var ak=r(Sr);Vh=d(ak,"PretrainedConfig"),ak.forEach(t),Jh=d(di," for more information."),di.forEach(t),Xh=u(Qn),v(xo.$$.fragment,Qn),Qn.forEach(t),nc=u(o),Gt=s(o,"H2",{class:!0});var Pc=r(Gt);Fo=s(Pc,"A",{id:!0,class:!0,href:!0});var sk=r(Fo);Ii=s(sk,"SPAN",{});var rk=r(Ii);v(ga.$$.fragment,rk),rk.forEach(t),sk.forEach(t),Kh=u(Pc),Ni=s(Pc,"SPAN",{});var ik=r(Ni);Zh=d(ik,"BartTokenizer"),ik.forEach(t),Pc.forEach(t),ac=u(o),A=s(o,"DIV",{class:!0});var W=r(A);v(ba.$$.fragment,W),Yh=u(W),Li=s(W,"P",{});var dk=r(Li);eu=d(dk,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),dk.forEach(t),tu=u(W),Di=s(W,"P",{});var lk=r(Di);ou=d(lk,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),lk.forEach(t),nu=u(W),v(zo.$$.fragment,W),au=u(W),ka=s(W,"P",{});var Ac=r(ka);su=d(Ac,"You can get around that behavior by passing "),Gi=s(Ac,"CODE",{});var ck=r(Gi);ru=d(ck,"add_prefix_space=True"),ck.forEach(t),iu=d(Ac,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Ac.forEach(t),du=u(W),v(qo.$$.fragment,W),lu=u(W),ya=s(W,"P",{});var Sc=r(ya);cu=d(Sc,"This tokenizer inherits from "),Or=s(Sc,"A",{href:!0});var pk=r(Or);pu=d(pk,"PreTrainedTokenizer"),pk.forEach(t),hu=d(Sc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Sc.forEach(t),uu=u(W),yt=s(W,"DIV",{class:!0});var li=r(yt);v(va.$$.fragment,li),mu=u(li),Wi=s(li,"P",{});var hk=r(Wi);fu=d(hk,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),hk.forEach(t),_u=u(li),Ta=s(li,"UL",{});var Oc=r(Ta);Ir=s(Oc,"LI",{});var I1=r(Ir);gu=d(I1,"single sequence: "),Ui=s(I1,"CODE",{});var uk=r(Ui);bu=d(uk,"<s> X </s>"),uk.forEach(t),I1.forEach(t),ku=u(Oc),Nr=s(Oc,"LI",{});var N1=r(Nr);yu=d(N1,"pair of sequences: "),Ri=s(N1,"CODE",{});var mk=r(Ri);vu=d(mk,"<s> A </s></s> B </s>"),mk.forEach(t),N1.forEach(t),Oc.forEach(t),li.forEach(t),Tu=u(W),Bo=s(W,"DIV",{class:!0});var Ic=r(Bo);v(wa.$$.fragment,Ic),wu=u(Ic),Qi=s(Ic,"P",{});var fk=r(Qi);$u=d(fk,"Converts a sequence of tokens (string) in a single string."),fk.forEach(t),Ic.forEach(t),xu=u(W),jo=s(W,"DIV",{class:!0});var Nc=r(jo);v($a.$$.fragment,Nc),Fu=u(Nc),Hi=s(Nc,"P",{});var _k=r(Hi);zu=d(_k,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),_k.forEach(t),Nc.forEach(t),qu=u(W),Co=s(W,"DIV",{class:!0});var Lc=r(Co);v(xa.$$.fragment,Lc),Bu=u(Lc),Fa=s(Lc,"P",{});var Dc=r(Fa);ju=d(Dc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Vi=s(Dc,"CODE",{});var gk=r(Vi);Cu=d(gk,"prepare_for_model"),gk.forEach(t),Mu=d(Dc," method."),Dc.forEach(t),Lc.forEach(t),W.forEach(t),sc=u(o),Wt=s(o,"H2",{class:!0});var Gc=r(Wt);Mo=s(Gc,"A",{id:!0,class:!0,href:!0});var bk=r(Mo);Ji=s(bk,"SPAN",{});var kk=r(Ji);v(za.$$.fragment,kk),kk.forEach(t),bk.forEach(t),Eu=u(Gc),Xi=s(Gc,"SPAN",{});var yk=r(Xi);Pu=d(yk,"BartTokenizerFast"),yk.forEach(t),Gc.forEach(t),rc=u(o),U=s(o,"DIV",{class:!0});var ue=r(U);v(qa.$$.fragment,ue),Au=u(ue),Ba=s(ue,"P",{});var Wc=r(Ba);Su=d(Wc,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Ki=s(Wc,"EM",{});var vk=r(Ki);Ou=d(vk,"tokenizers"),vk.forEach(t),Iu=d(Wc,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),Wc.forEach(t),Nu=u(ue),Zi=s(ue,"P",{});var Tk=r(Zi);Lu=d(Tk,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Tk.forEach(t),Du=u(ue),v(Eo.$$.fragment,ue),Gu=u(ue),ja=s(ue,"P",{});var Uc=r(ja);Wu=d(Uc,"You can get around that behavior by passing "),Yi=s(Uc,"CODE",{});var wk=r(Yi);Uu=d(wk,"add_prefix_space=True"),wk.forEach(t),Ru=d(Uc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uc.forEach(t),Qu=u(ue),v(Po.$$.fragment,ue),Hu=u(ue),Ca=s(ue,"P",{});var Rc=r(Ca);Vu=d(Rc,"This tokenizer inherits from "),Lr=s(Rc,"A",{href:!0});var $k=r(Lr);Ju=d($k,"PreTrainedTokenizerFast"),$k.forEach(t),Xu=d(Rc,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Rc.forEach(t),Ku=u(ue),Ao=s(ue,"DIV",{class:!0});var Qc=r(Ao);v(Ma.$$.fragment,Qc),Zu=u(Qc),ed=s(Qc,"P",{});var xk=r(ed);Yu=d(xk,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),xk.forEach(t),Qc.forEach(t),ue.forEach(t),ic=u(o),Ut=s(o,"H2",{class:!0});var Hc=r(Ut);So=s(Hc,"A",{id:!0,class:!0,href:!0});var Fk=r(So);td=s(Fk,"SPAN",{});var zk=r(td);v(Ea.$$.fragment,zk),zk.forEach(t),Fk.forEach(t),em=u(Hc),od=s(Hc,"SPAN",{});var qk=r(od);tm=d(qk,"BartModel"),qk.forEach(t),Hc.forEach(t),dc=u(o),We=s(o,"DIV",{class:!0});var Hn=r(We);v(Pa.$$.fragment,Hn),om=u(Hn),Aa=s(Hn,"P",{});var Vc=r(Aa);nm=d(Vc,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Dr=s(Vc,"A",{href:!0});var Bk=r(Dr);am=d(Bk,"PreTrainedModel"),Bk.forEach(t),sm=d(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),rm=u(Hn),Sa=s(Hn,"P",{});var Jc=r(Sa);im=d(Jc,"This model is also a PyTorch "),Oa=s(Jc,"A",{href:!0,rel:!0});var jk=r(Oa);dm=d(jk,"torch.nn.Module"),jk.forEach(t),lm=d(Jc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jc.forEach(t),cm=u(Hn),Ve=s(Hn,"DIV",{class:!0});var Vn=r(Ve);v(Ia.$$.fragment,Vn),pm=u(Vn),Rt=s(Vn,"P",{});var ci=r(Rt);hm=d(ci,"The "),Gr=s(ci,"A",{href:!0});var Ck=r(Gr);um=d(Ck,"BartModel"),Ck.forEach(t),mm=d(ci," forward method, overrides the "),nd=s(ci,"CODE",{});var Mk=r(nd);fm=d(Mk,"__call__"),Mk.forEach(t),_m=d(ci," special method."),ci.forEach(t),gm=u(Vn),v(Oo.$$.fragment,Vn),bm=u(Vn),v(Io.$$.fragment,Vn),Vn.forEach(t),Hn.forEach(t),lc=u(o),Qt=s(o,"H2",{class:!0});var Xc=r(Qt);No=s(Xc,"A",{id:!0,class:!0,href:!0});var Ek=r(No);ad=s(Ek,"SPAN",{});var Pk=r(ad);v(Na.$$.fragment,Pk),Pk.forEach(t),Ek.forEach(t),km=u(Xc),sd=s(Xc,"SPAN",{});var Ak=r(sd);ym=d(Ak,"BartForConditionalGeneration"),Ak.forEach(t),Xc.forEach(t),cc=u(o),Ue=s(o,"DIV",{class:!0});var Jn=r(Ue);v(La.$$.fragment,Jn),vm=u(Jn),Da=s(Jn,"P",{});var Kc=r(Da);Tm=d(Kc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Wr=s(Kc,"A",{href:!0});var Sk=r(Wr);wm=d(Sk,"PreTrainedModel"),Sk.forEach(t),$m=d(Kc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kc.forEach(t),xm=u(Jn),Ga=s(Jn,"P",{});var Zc=r(Ga);Fm=d(Zc,"This model is also a PyTorch "),Wa=s(Zc,"A",{href:!0,rel:!0});var Ok=r(Wa);zm=d(Ok,"torch.nn.Module"),Ok.forEach(t),qm=d(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Bm=u(Jn),je=s(Jn,"DIV",{class:!0});var vt=r(je);v(Ua.$$.fragment,vt),jm=u(vt),Ht=s(vt,"P",{});var pi=r(Ht);Cm=d(pi,"The "),Ur=s(pi,"A",{href:!0});var Ik=r(Ur);Mm=d(Ik,"BartForConditionalGeneration"),Ik.forEach(t),Em=d(pi," forward method, overrides the "),rd=s(pi,"CODE",{});var Nk=r(rd);Pm=d(Nk,"__call__"),Nk.forEach(t),Am=d(pi," special method."),pi.forEach(t),Sm=u(vt),v(Lo.$$.fragment,vt),Om=u(vt),v(Do.$$.fragment,vt),Im=u(vt),v(Go.$$.fragment,vt),vt.forEach(t),Jn.forEach(t),pc=u(o),Vt=s(o,"H2",{class:!0});var Yc=r(Vt);Wo=s(Yc,"A",{id:!0,class:!0,href:!0});var Lk=r(Wo);id=s(Lk,"SPAN",{});var Dk=r(id);v(Ra.$$.fragment,Dk),Dk.forEach(t),Lk.forEach(t),Nm=u(Yc),dd=s(Yc,"SPAN",{});var Gk=r(dd);Lm=d(Gk,"BartForSequenceClassification"),Gk.forEach(t),Yc.forEach(t),hc=u(o),Te=s(o,"DIV",{class:!0});var Tt=r(Te);v(Qa.$$.fragment,Tt),Dm=u(Tt),ld=s(Tt,"P",{});var Wk=r(ld);Gm=d(Wk,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Wk.forEach(t),Wm=u(Tt),Ha=s(Tt,"P",{});var ep=r(Ha);Um=d(ep,"This model inherits from "),Rr=s(ep,"A",{href:!0});var Uk=r(Rr);Rm=d(Uk,"PreTrainedModel"),Uk.forEach(t),Qm=d(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Hm=u(Tt),Va=s(Tt,"P",{});var tp=r(Va);Vm=d(tp,"This model is also a PyTorch "),Ja=s(tp,"A",{href:!0,rel:!0});var Rk=r(Ja);Jm=d(Rk,"torch.nn.Module"),Rk.forEach(t),Xm=d(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Km=u(Tt),ee=s(Tt,"DIV",{class:!0});var Pe=r(ee);v(Xa.$$.fragment,Pe),Zm=u(Pe),Jt=s(Pe,"P",{});var hi=r(Jt);Ym=d(hi,"The "),Qr=s(hi,"A",{href:!0});var Qk=r(Qr);ef=d(Qk,"BartForSequenceClassification"),Qk.forEach(t),tf=d(hi," forward method, overrides the "),cd=s(hi,"CODE",{});var Hk=r(cd);of=d(Hk,"__call__"),Hk.forEach(t),nf=d(hi," special method."),hi.forEach(t),af=u(Pe),v(Uo.$$.fragment,Pe),sf=u(Pe),v(Ro.$$.fragment,Pe),rf=u(Pe),v(Qo.$$.fragment,Pe),df=u(Pe),v(Ho.$$.fragment,Pe),lf=u(Pe),v(Vo.$$.fragment,Pe),Pe.forEach(t),Tt.forEach(t),uc=u(o),Xt=s(o,"H2",{class:!0});var op=r(Xt);Jo=s(op,"A",{id:!0,class:!0,href:!0});var Vk=r(Jo);pd=s(Vk,"SPAN",{});var Jk=r(pd);v(Ka.$$.fragment,Jk),Jk.forEach(t),Vk.forEach(t),cf=u(op),hd=s(op,"SPAN",{});var Xk=r(hd);pf=d(Xk,"BartForQuestionAnswering"),Xk.forEach(t),op.forEach(t),mc=u(o),we=s(o,"DIV",{class:!0});var wt=r(we);v(Za.$$.fragment,wt),hf=u(wt),Kt=s(wt,"P",{});var ui=r(Kt);uf=d(ui,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),ud=s(ui,"CODE",{});var Kk=r(ud);mf=d(Kk,"span start logits"),Kk.forEach(t),ff=d(ui," and "),md=s(ui,"CODE",{});var Zk=r(md);_f=d(Zk,"span end logits"),Zk.forEach(t),gf=d(ui,")."),ui.forEach(t),bf=u(wt),Ya=s(wt,"P",{});var np=r(Ya);kf=d(np,"This model inherits from "),Hr=s(np,"A",{href:!0});var Yk=r(Hr);yf=d(Yk,"PreTrainedModel"),Yk.forEach(t),vf=d(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),Tf=u(wt),es=s(wt,"P",{});var ap=r(es);wf=d(ap,"This model is also a PyTorch "),ts=s(ap,"A",{href:!0,rel:!0});var ey=r(ts);$f=d(ey,"torch.nn.Module"),ey.forEach(t),xf=d(ap,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ap.forEach(t),Ff=u(wt),Ce=s(wt,"DIV",{class:!0});var $t=r(Ce);v(os.$$.fragment,$t),zf=u($t),Zt=s($t,"P",{});var mi=r(Zt);qf=d(mi,"The "),Vr=s(mi,"A",{href:!0});var ty=r(Vr);Bf=d(ty,"BartForQuestionAnswering"),ty.forEach(t),jf=d(mi," forward method, overrides the "),fd=s(mi,"CODE",{});var oy=r(fd);Cf=d(oy,"__call__"),oy.forEach(t),Mf=d(mi," special method."),mi.forEach(t),Ef=u($t),v(Xo.$$.fragment,$t),Pf=u($t),v(Ko.$$.fragment,$t),Af=u($t),v(Zo.$$.fragment,$t),$t.forEach(t),wt.forEach(t),fc=u(o),Yt=s(o,"H2",{class:!0});var sp=r(Yt);Yo=s(sp,"A",{id:!0,class:!0,href:!0});var ny=r(Yo);_d=s(ny,"SPAN",{});var ay=r(_d);v(ns.$$.fragment,ay),ay.forEach(t),ny.forEach(t),Sf=u(sp),gd=s(sp,"SPAN",{});var sy=r(gd);Of=d(sy,"BartForCausalLM"),sy.forEach(t),sp.forEach(t),_c=u(o),eo=s(o,"DIV",{class:!0});var rp=r(eo);v(as.$$.fragment,rp),If=u(rp),en=s(rp,"DIV",{class:!0});var ip=r(en);v(ss.$$.fragment,ip),Nf=u(ip),v(tn.$$.fragment,ip),ip.forEach(t),rp.forEach(t),gc=u(o),to=s(o,"H2",{class:!0});var dp=r(to);on=s(dp,"A",{id:!0,class:!0,href:!0});var ry=r(on);bd=s(ry,"SPAN",{});var iy=r(bd);v(rs.$$.fragment,iy),iy.forEach(t),ry.forEach(t),Lf=u(dp),kd=s(dp,"SPAN",{});var dy=r(kd);Df=d(dy,"TFBartModel"),dy.forEach(t),dp.forEach(t),bc=u(o),$e=s(o,"DIV",{class:!0});var xt=r($e);v(is.$$.fragment,xt),Gf=u(xt),ds=s(xt,"P",{});var lp=r(ds);Wf=d(lp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Jr=s(lp,"A",{href:!0});var ly=r(Jr);Uf=d(ly,"TFPreTrainedModel"),ly.forEach(t),Rf=d(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Qf=u(xt),ls=s(xt,"P",{});var cp=r(ls);Hf=d(cp,"This model is also a "),cs=s(cp,"A",{href:!0,rel:!0});var cy=r(cs);Vf=d(cy,"tf.keras.Model"),cy.forEach(t),Jf=d(cp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cp.forEach(t),Xf=u(xt),v(nn.$$.fragment,xt),Kf=u(xt),Je=s(xt,"DIV",{class:!0});var Xn=r(Je);v(ps.$$.fragment,Xn),Zf=u(Xn),oo=s(Xn,"P",{});var fi=r(oo);Yf=d(fi,"The "),Xr=s(fi,"A",{href:!0});var py=r(Xr);e_=d(py,"TFBartModel"),py.forEach(t),t_=d(fi," forward method, overrides the "),yd=s(fi,"CODE",{});var hy=r(yd);o_=d(hy,"__call__"),hy.forEach(t),n_=d(fi," special method."),fi.forEach(t),a_=u(Xn),v(an.$$.fragment,Xn),s_=u(Xn),v(sn.$$.fragment,Xn),Xn.forEach(t),xt.forEach(t),kc=u(o),no=s(o,"H2",{class:!0});var pp=r(no);rn=s(pp,"A",{id:!0,class:!0,href:!0});var uy=r(rn);vd=s(uy,"SPAN",{});var my=r(vd);v(hs.$$.fragment,my),my.forEach(t),uy.forEach(t),r_=u(pp),Td=s(pp,"SPAN",{});var fy=r(Td);i_=d(fy,"TFBartForConditionalGeneration"),fy.forEach(t),pp.forEach(t),yc=u(o),xe=s(o,"DIV",{class:!0});var Ft=r(xe);v(us.$$.fragment,Ft),d_=u(Ft),ms=s(Ft,"P",{});var hp=r(ms);l_=d(hp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Kr=s(hp,"A",{href:!0});var _y=r(Kr);c_=d(_y,"TFPreTrainedModel"),_y.forEach(t),p_=d(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),h_=u(Ft),fs=s(Ft,"P",{});var up=r(fs);u_=d(up,"This model is also a "),_s=s(up,"A",{href:!0,rel:!0});var gy=r(_s);m_=d(gy,"tf.keras.Model"),gy.forEach(t),f_=d(up,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),up.forEach(t),__=u(Ft),v(dn.$$.fragment,Ft),g_=u(Ft),Me=s(Ft,"DIV",{class:!0});var zt=r(Me);v(gs.$$.fragment,zt),b_=u(zt),ao=s(zt,"P",{});var _i=r(ao);k_=d(_i,"The "),Zr=s(_i,"A",{href:!0});var by=r(Zr);y_=d(by,"TFBartForConditionalGeneration"),by.forEach(t),v_=d(_i," forward method, overrides the "),wd=s(_i,"CODE",{});var ky=r(wd);T_=d(ky,"__call__"),ky.forEach(t),w_=d(_i," special method."),_i.forEach(t),$_=u(zt),v(ln.$$.fragment,zt),x_=u(zt),v(cn.$$.fragment,zt),F_=u(zt),v(pn.$$.fragment,zt),zt.forEach(t),Ft.forEach(t),vc=u(o),so=s(o,"H2",{class:!0});var mp=r(so);hn=s(mp,"A",{id:!0,class:!0,href:!0});var yy=r(hn);$d=s(yy,"SPAN",{});var vy=r($d);v(bs.$$.fragment,vy),vy.forEach(t),yy.forEach(t),z_=u(mp),xd=s(mp,"SPAN",{});var Ty=r(xd);q_=d(Ty,"FlaxBartModel"),Ty.forEach(t),mp.forEach(t),Tc=u(o),R=s(o,"DIV",{class:!0});var me=r(R);v(ks.$$.fragment,me),B_=u(me),ys=s(me,"P",{});var fp=r(ys);j_=d(fp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Yr=s(fp,"A",{href:!0});var wy=r(Yr);C_=d(wy,"FlaxPreTrainedModel"),wy.forEach(t),M_=d(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),E_=u(me),vs=s(me,"P",{});var _p=r(vs);P_=d(_p,`This model is also a Flax Linen
`),Ts=s(_p,"A",{href:!0,rel:!0});var $y=r(Ts);A_=d($y,"flax.nn.Module"),$y.forEach(t),S_=d(_p,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),_p.forEach(t),O_=u(me),Fd=s(me,"P",{});var xy=r(Fd);I_=d(xy,"Finally, this model supports inherent JAX features such as:"),xy.forEach(t),N_=u(me),pt=s(me,"UL",{});var Kn=r(pt);zd=s(Kn,"LI",{});var Fy=r(zd);ws=s(Fy,"A",{href:!0,rel:!0});var zy=r(ws);L_=d(zy,"Just-In-Time (JIT) compilation"),zy.forEach(t),Fy.forEach(t),D_=u(Kn),qd=s(Kn,"LI",{});var qy=r(qd);$s=s(qy,"A",{href:!0,rel:!0});var By=r($s);G_=d(By,"Automatic Differentiation"),By.forEach(t),qy.forEach(t),W_=u(Kn),Bd=s(Kn,"LI",{});var jy=r(Bd);xs=s(jy,"A",{href:!0,rel:!0});var Cy=r(xs);U_=d(Cy,"Vectorization"),Cy.forEach(t),jy.forEach(t),R_=u(Kn),jd=s(Kn,"LI",{});var My=r(jd);Fs=s(My,"A",{href:!0,rel:!0});var Ey=r(Fs);Q_=d(Ey,"Parallelization"),Ey.forEach(t),My.forEach(t),Kn.forEach(t),H_=u(me),Xe=s(me,"DIV",{class:!0});var Zn=r(Xe);v(zs.$$.fragment,Zn),V_=u(Zn),ro=s(Zn,"P",{});var gi=r(ro);J_=d(gi,"The "),Cd=s(gi,"CODE",{});var Py=r(Cd);X_=d(Py,"FlaxBartPreTrainedModel"),Py.forEach(t),K_=d(gi," forward method, overrides the "),Md=s(gi,"CODE",{});var Ay=r(Md);Z_=d(Ay,"__call__"),Ay.forEach(t),Y_=d(gi," special method."),gi.forEach(t),eg=u(Zn),v(un.$$.fragment,Zn),tg=u(Zn),v(mn.$$.fragment,Zn),Zn.forEach(t),og=u(me),fn=s(me,"DIV",{class:!0});var gp=r(fn);v(qs.$$.fragment,gp),ng=u(gp),v(_n.$$.fragment,gp),gp.forEach(t),ag=u(me),gn=s(me,"DIV",{class:!0});var bp=r(gn);v(Bs.$$.fragment,bp),sg=u(bp),v(bn.$$.fragment,bp),bp.forEach(t),me.forEach(t),wc=u(o),io=s(o,"H2",{class:!0});var kp=r(io);kn=s(kp,"A",{id:!0,class:!0,href:!0});var Sy=r(kn);Ed=s(Sy,"SPAN",{});var Oy=r(Ed);v(js.$$.fragment,Oy),Oy.forEach(t),Sy.forEach(t),rg=u(kp),Pd=s(kp,"SPAN",{});var Iy=r(Pd);ig=d(Iy,"FlaxBartForConditionalGeneration"),Iy.forEach(t),kp.forEach(t),$c=u(o),Q=s(o,"DIV",{class:!0});var fe=r(Q);v(Cs.$$.fragment,fe),dg=u(fe),Ms=s(fe,"P",{});var yp=r(Ms);lg=d(yp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ei=s(yp,"A",{href:!0});var Ny=r(ei);cg=d(Ny,"FlaxPreTrainedModel"),Ny.forEach(t),pg=d(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),hg=u(fe),Es=s(fe,"P",{});var vp=r(Es);ug=d(vp,`This model is also a Flax Linen
`),Ps=s(vp,"A",{href:!0,rel:!0});var Ly=r(Ps);mg=d(Ly,"flax.nn.Module"),Ly.forEach(t),fg=d(vp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),vp.forEach(t),_g=u(fe),Ad=s(fe,"P",{});var Dy=r(Ad);gg=d(Dy,"Finally, this model supports inherent JAX features such as:"),Dy.forEach(t),bg=u(fe),ht=s(fe,"UL",{});var Yn=r(ht);Sd=s(Yn,"LI",{});var Gy=r(Sd);As=s(Gy,"A",{href:!0,rel:!0});var Wy=r(As);kg=d(Wy,"Just-In-Time (JIT) compilation"),Wy.forEach(t),Gy.forEach(t),yg=u(Yn),Od=s(Yn,"LI",{});var Uy=r(Od);Ss=s(Uy,"A",{href:!0,rel:!0});var Ry=r(Ss);vg=d(Ry,"Automatic Differentiation"),Ry.forEach(t),Uy.forEach(t),Tg=u(Yn),Id=s(Yn,"LI",{});var Qy=r(Id);Os=s(Qy,"A",{href:!0,rel:!0});var Hy=r(Os);wg=d(Hy,"Vectorization"),Hy.forEach(t),Qy.forEach(t),$g=u(Yn),Nd=s(Yn,"LI",{});var Vy=r(Nd);Is=s(Vy,"A",{href:!0,rel:!0});var Jy=r(Is);xg=d(Jy,"Parallelization"),Jy.forEach(t),Vy.forEach(t),Yn.forEach(t),Fg=u(fe),Ee=s(fe,"DIV",{class:!0});var qt=r(Ee);v(Ns.$$.fragment,qt),zg=u(qt),lo=s(qt,"P",{});var bi=r(lo);qg=d(bi,"The "),Ld=s(bi,"CODE",{});var Xy=r(Ld);Bg=d(Xy,"FlaxBartPreTrainedModel"),Xy.forEach(t),jg=d(bi," forward method, overrides the "),Dd=s(bi,"CODE",{});var Ky=r(Dd);Cg=d(Ky,"__call__"),Ky.forEach(t),Mg=d(bi," special method."),bi.forEach(t),Eg=u(qt),v(yn.$$.fragment,qt),Pg=u(qt),v(vn.$$.fragment,qt),Ag=u(qt),v(Tn.$$.fragment,qt),qt.forEach(t),Sg=u(fe),wn=s(fe,"DIV",{class:!0});var Tp=r(wn);v(Ls.$$.fragment,Tp),Og=u(Tp),v($n.$$.fragment,Tp),Tp.forEach(t),Ig=u(fe),xn=s(fe,"DIV",{class:!0});var wp=r(xn);v(Ds.$$.fragment,wp),Ng=u(wp),v(Fn.$$.fragment,wp),wp.forEach(t),fe.forEach(t),xc=u(o),co=s(o,"H2",{class:!0});var $p=r(co);zn=s($p,"A",{id:!0,class:!0,href:!0});var Zy=r(zn);Gd=s(Zy,"SPAN",{});var Yy=r(Gd);v(Gs.$$.fragment,Yy),Yy.forEach(t),Zy.forEach(t),Lg=u($p),Wd=s($p,"SPAN",{});var ev=r(Wd);Dg=d(ev,"FlaxBartForSequenceClassification"),ev.forEach(t),$p.forEach(t),Fc=u(o),N=s(o,"DIV",{class:!0});var te=r(N);v(Ws.$$.fragment,te),Gg=u(te),Ud=s(te,"P",{});var tv=r(Ud);Wg=d(tv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
