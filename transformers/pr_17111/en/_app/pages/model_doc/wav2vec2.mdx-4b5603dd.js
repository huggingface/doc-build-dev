...
instance of <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L488",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L418",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17111/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17111/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_17111/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_17111/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1688",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777"}}),gn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",returnDescription:`
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",returnDescription:`
<p>A <a
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1055"}}),dr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L887",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1319"}}),qr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),R2=d(),kc=a("p"),H2=r("Finally, this model supports inherent JAX features such as:"),X2=d(),wt=a("ul"),Tc=a("li"),_r=a("a"),G2=r("Just-In-Time (JIT) compilation"),J2=d(),$c=a("li"),vr=a("a"),Z2=r("Automatic Differentiation"),K2=d(),xc=a("li"),br=a("a"),Q2=r("Vectorization"),Y2=d(),Wc=a("li"),wr=a("a"),e1=r("Parallelization"),t1=d(),tt=a("div"),w(yr.$$.fragment),o1=d(),_o=a("p"),a1=r("The "),Vc=a("code"),s1=r("FlaxWav2Vec2PreTrainedModel"),n1=r(" forward method, overrides the "),jc=a("code"),r1=r("__call__"),i1=r(" special method."),l1=d(),w(xa.$$.fragment),c1=d(),w(Wa.$$.fragment),Dd=d(),vo=a("h2"),Va=a("a"),Fc=a("span"),w(kr.$$.fragment),d1=d(),Cc=a("span"),p1=r("FlaxWav2Vec2ForPreTraining"),Sd=d(),Y=a("div"),w(Tr.$$.fragment),m1=d(),bo=a("p"),h1=r("Wav2Vec2 Model with a quantizer and "),Ec=a("code"),f1=r("VQ"),u1=r(` head on top.
Wav2Vec2 was proposed in `),$r=a("a"),g1=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),_1=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),v1=d(),xr=a("p"),b1=r("This model inherits from "),Ci=a("a"),w1=r("FlaxPreTrainedModel"),y1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),k1=d(),Wr=a("p"),T1=r(`This model is also a Flax Linen
`),Vr=a("a"),$1=r("flax.nn.Module"),x1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),W1=d(),qc=a("p"),V1=r("Finally, this model supports inherent JAX features such as:"),j1=d(),yt=a("ul"),Pc=a("li"),jr=a("a"),F1=r("Just-In-Time (JIT) compilation"),C1=d(),zc=a("li"),Fr=a("a"),E1=r("Automatic Differentiation"),q1=d(),Mc=a("li"),Cr=a("a"),P1=r("Vectorization"),z1=d(),Ac=a("li"),Er=a("a"),M1=r("Parallelization"),A1=d(),ot=a("div"),w(qr.$$.fragment),O1=d(),wo=a("p"),L1=r("The "),Ei=a("a"),D1=r("FlaxWav2Vec2ForPreTraining"),S1=r(" forward method, overrides the "),Oc=a("code"),N1=r("__call__"),I1=r(" special method."),B1=d(),w(ja.$$.fragment),U1=d(),w(Fa.$$.fragment),this.h()},l(o){const g=wk('[data-svelte="svelte-1phssyn"]',document.head);c=s(g,"META",{name:!0,content:!0}),g.forEach(t),b=p(o),f=s(o,"H1",{class:!0});var Pr=n(f);h=s(Pr,"A",{id:!0,class:!0,href:!0});var Lc=n(h);v=s(Lc,"SPAN",{});var Dc=n(v);y(l.$$.fragment,Dc),Dc.forEach(t),Lc.forEach(t),u=p(Pr),j=s(Pr,"SPAN",{});var Sc=n(j);D=i(Sc,"Wav2Vec2"),Sc.forEach(t),Pr.forEach(t),P=p(o),C=s(o,"H2",{class:!0});var zr=n(C);A=s(zr,"A",{id:!0,class:!0,href:!0});var Nc=n(A);O=s(Nc,"SPAN",{});var Ic=n(O);y(H.$$.fragment,Ic),Ic.forEach(t),Nc.forEach(t),S=p(zr),q=s(zr,"SPAN",{});var Bc=n(q);je=i(Bc,"Overview"),Bc.forEach(t),zr.forEach(t),ge=p(o),B=s(o,"P",{});var Mr=n(B);U=i(Mr,"The Wav2Vec2 model was proposed in "),_e=s(Mr,"A",{href:!0,rel:!0});var Uc=n(_e);Se=i(Uc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Uc.forEach(t),z=i(Mr," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Mr.forEach(t),I=p(o),Fe=s(o,"P",{});var Rc=n(Fe);ve=i(Rc,"The abstract from the paper is the following:"),Rc.forEach(t),Re=p(o),Ce=s(o,"P",{});var Hc=n(Ce);oe=s(Hc,"EM",{});var Xc=n(oe);lt=i(Xc,`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
transcribed speech can outperform the best semi-supervised methods while being conceptually simpler. wav2vec 2.0 masks
the speech input in the latent space and solves a contrastive task defined over a quantization of the latent
representations which are jointly learned. Experiments using all labeled data of Librispeech achieve 1.8/3.3 WER on the
clean/other test sets. When lowering the amount of labeled data to one hour, wav2vec 2.0 outperforms the previous state
...
documentation from `),Br=s(ko,"A",{href:!0});var sd=n(Br);fm=i(sd,"PretrainedConfig"),sd.forEach(t),um=i(ko," for more information."),ko.forEach(t),gm=p(kt),y(To.$$.fragment,kt),kt.forEach(t),nd=p(o),St=s(o,"H2",{class:!0});var Sr=n(St);$o=s(Sr,"A",{id:!0,class:!0,href:!0});var Z1=n($o);Yi=s(Z1,"SPAN",{});var K1=n(Yi);y(Ja.$$.fragment,K1),K1.forEach(t),Z1.forEach(t),_m=p(Sr),el=s(Sr,"SPAN",{});var Q1=n(el);vm=i(Q1,"Wav2Vec2CTCTokenizer"),Q1.forEach(t),Sr.forEach(t),rd=p(o),Z=s(o,"DIV",{class:!0});var Ae=n(Z);y(Za.$$.fragment,Ae),bm=p(Ae),tl=s(Ae,"P",{});var Y1=n(tl);wm=i(Y1,"Constructs a Wav2Vec2CTC tokenizer."),Y1.forEach(t),ym=p(Ae),Ka=s(Ae,"P",{});var Id=n(Ka);km=i(Id,"This tokenizer inherits from "),Ur=s(Id,"A",{href:!0});var eb=n(Ur);Tm=i(eb,"PreTrainedTokenizer"),eb.forEach(t),$m=i(Id,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),Id.forEach(t),xm=p(Ae),xo=s(Ae,"DIV",{class:!0});var Bd=n(xo);y(Qa.$$.fragment,Bd),Wm=p(Bd),ol=s(Bd,"P",{});var tb=n(ol);Vm=i(tb,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),tb.forEach(t),Bd.forEach(t),jm=p(Ae),Rr=s(Ae,"DIV",{class:!0});var ob=n(Rr);y(Ya.$$.fragment,ob),ob.forEach(t),Fm=p(Ae),Xe=s(Ae,"DIV",{class:!0});var Ca=n(Xe);y(es.$$.fragment,Ca),Cm=p(Ca),al=s(Ca,"P",{});var ab=n(al);Em=i(ab,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),ab.forEach(t),qm=p(Ca),ts=s(Ca,"P",{});var Ud=n(ts);Pm=i(Ud,"Similar to doing "),sl=s(Ud,"CODE",{});var sb=n(sl);zm=i(sb,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),sb.forEach(t),Mm=i(Ud,"."),Ud.forEach(t),Am=p(Ca),y(Wo.$$.fragment,Ca),Ca.forEach(t),Om=p(Ae),Vo=s(Ae,"DIV",{class:!0});var Rd=n(Vo);y(os.$$.fragment,Rd),Lm=p(Rd),nl=s(Rd,"P",{});var nb=n(nl);Dm=i(nb,"Convert a list of lists of token ids into a list of strings by calling decode."),nb.forEach(t),Rd.forEach(t),Ae.forEach(t),id=p(o),Nt=s(o,"H2",{class:!0});var Hd=n(Nt);jo=s(Hd,"A",{id:!0,class:!0,href:!0});var rb=n(jo);rl=s(rb,"SPAN",{});var ib=n(rl);y(as.$$.fragment,ib),ib.forEach(t),rb.forEach(t),Sm=p(Hd),il=s(Hd,"SPAN",{});var lb=n(il);Nm=i(lb,"Wav2Vec2FeatureExtractor"),lb.forEach(t),Hd.forEach(t),ld=p(o),Ue=s(o,"DIV",{class:!0});var Ea=n(Ue);y(ss.$$.fragment,Ea),Im=p(Ea),ll=s(Ea,"P",{});var cb=n(ll);Bm=i(cb,"Constructs a Wav2Vec2 feature extractor."),cb.forEach(t),Um=p(Ea),ns=s(Ea,"P",{});var Xd=n(ns);Rm=i(Xd,"This feature extractor inherits from "),Hr=s(Xd,"A",{href:!0});var db=n(Hr);Hm=i(db,"SequenceFeatureExtractor"),db.forEach(t),Xm=i(Xd,` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Xd.forEach(t),Gm=p(Ea),Fo=s(Ea,"DIV",{class:!0});var Gd=n(Fo);y(rs.$$.fragment,Gd),Jm=p(Gd),cl=s(Gd,"P",{});var pb=n(cl);Zm=i(pb,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),pb.forEach(t),Gd.forEach(t),Ea.forEach(t),cd=p(o),It=s(o,"H2",{class:!0});var Jd=n(It);Co=s(Jd,"A",{id:!0,class:!0,href:!0});var mb=n(Co);dl=s(mb,"SPAN",{});var hb=n(dl);y(is.$$.fragment,hb),hb.forEach(t),mb.forEach(t),Km=p(Jd),pl=s(Jd,"SPAN",{});var fb=n(pl);Qm=i(fb,"Wav2Vec2Processor"),fb.forEach(t),Jd.forEach(t),dd=p(o),M=s(o,"DIV",{class:!0});var R=n(M);y(ls.$$.fragment,R),Ym=p(R),ml=s(R,"P",{});var ub=n(ml);eh=i(ub,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),ub.forEach(t),th=p(R),Pe=s(R,"P",{});var Tt=n(Pe);Xr=s(Tt,"A",{href:!0});var gb=n(Xr);oh=i(gb,"Wav2Vec2Processor"),gb.forEach(t),ah=i(Tt," offers all the functionalities of "),Gr=s(Tt,"A",{href:!0});var _b=n(Gr);sh=i(_b,"Wav2Vec2FeatureExtractor"),_b.forEach(t),nh=i(Tt," and "),Jr=s(Tt,"A",{href:!0});var vb=n(Jr);rh=i(vb,"PreTrainedTokenizer"),vb.forEach(t),ih=i(Tt,`.
See the docstring of `),cs=s(Tt,"A",{href:!0});var R1=n(cs);hl=s(R1,"STRONG",{});var bb=n(hl);lh=i(bb,"call"),bb.forEach(t),ch=i(R1,"()"),R1.forEach(t),dh=i(Tt," and "),Zr=s(Tt,"A",{href:!0});var wb=n(Zr);ph=i(wb,"decode()"),wb.forEach(t),mh=i(Tt," for more information."),Tt.forEach(t),hh=p(R),Eo=s(R,"DIV",{class:!0});var Zd=n(Eo);y(ds.$$.fragment,Zd),fh=p(Zd),ht=s(Zd,"P",{});var qa=n(ht);uh=i(qa,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),ps=s(qa,"A",{href:!0});var H1=n(ps);fl=s(H1,"STRONG",{});var yb=n(fl);gh=i(yb,"call"),yb.forEach(t),_h=i(H1,"()"),H1.forEach(t),vh=i(qa,` and returns its output. If used in the context
`),Kr=s(qa,"A",{href:!0});var kb=n(Kr);bh=i(kb,"as_target_processor()"),kb.forEach(t),wh=i(qa,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),ms=s(qa,"A",{href:!0});var X1=n(ms);ul=s(X1,"STRONG",{});var Tb=n(ul);yh=i(Tb,"call"),Tb.forEach(t),kh=i(X1,"()"),X1.forEach(t),Th=i(qa,". Please refer to the docstring of the above two methods for more information."),qa.forEach(t),Zd.forEach(t),$h=p(R),qo=s(R,"DIV",{class:!0});var Kd=n(qo);y(hs.$$.fragment,Kd),xh=p(Kd),ft=s(Kd,"P",{});var Pa=n(ft);Wh=i(Pa,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Qr=s(Pa,"A",{href:!0});var $b=n(Qr);Vh=i($b,"pad()"),$b.forEach(t),jh=i(Pa,` and returns its output. If used in the context
`),Yr=s(Pa,"A",{href:!0});var xb=n(Yr);Fh=i(xb,"as_target_processor()"),xb.forEach(t),Ch=i(Pa,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),ei=s(Pa,"A",{href:!0});var Wb=n(ei);Eh=i(Wb,"pad()"),Wb.forEach(t),qh=i(Pa,". Please refer to the docstring of the above two methods for more information."),Pa.forEach(t),Kd.forEach(t),Ph=p(R),ti=s(R,"DIV",{class:!0});var Vb=n(ti);y(fs.$$.fragment,Vb),Vb.forEach(t),zh=p(R),Wt=s(R,"DIV",{class:!0});var qi=n(Wt);y(us.$$.fragment,qi),Mh=p(qi),gs=s(qi,"P",{});var Qd=n(gs);Ah=i(Qd,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),oi=s(Qd,"A",{href:!0});var jb=n(oi);Oh=i(jb,"from_pretrained()"),jb.forEach(t),Lh=i(Qd," method."),Qd.forEach(t),Dh=p(qi),y(Po.$$.fragment,qi),qi.forEach(t),Sh=p(R),zo=s(R,"DIV",{class:!0});var Yd=n(zo);y(_s.$$.fragment,Yd),Nh=p(Yd),vs=s(Yd,"P",{});var ep=n(vs);Ih=i(ep,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),ai=s(ep,"A",{href:!0});var Fb=n(ai);Bh=i(Fb,"batch_decode()"),Fb.forEach(t),Uh=i(ep,`. Please
refer to the docstring of this method for more information.`),ep.forEach(t),Yd.forEach(t),Rh=p(R),Mo=s(R,"DIV",{class:!0});var tp=n(Mo);y(bs.$$.fragment,tp),Hh=p(tp),ws=s(tp,"P",{});var op=n(ws);Xh=i(op,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),si=s(op,"A",{href:!0});var Cb=n(si);Gh=i(Cb,"decode()"),Cb.forEach(t),Jh=i(op,`. Please refer
to the docstring of this method for more information.`),op.forEach(t),tp.forEach(t),Zh=p(R),Ao=s(R,"DIV",{class:!0});var ap=n(Ao);y(ys.$$.fragment,ap),Kh=p(ap),gl=s(ap,"P",{});var Eb=n(gl);Qh=i(Eb,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),Eb.forEach(t),ap.forEach(t),R.forEach(t),pd=p(o),Bt=s(o,"H2",{class:!0});var sp=n(Bt);Oo=s(sp,"A",{id:!0,class:!0,href:!0});var qb=n(Oo);_l=s(qb,"SPAN",{});var Pb=n(_l);y(ks.$$.fragment,Pb),Pb.forEach(t),qb.forEach(t),Yh=p(sp),vl=s(sp,"SPAN",{});var zb=n(vl);ef=i(zb,"Wav2Vec2ProcessorWithLM"),zb.forEach(t),sp.forEach(t),md=p(o),N=s(o,"DIV",{class:!0});var te=n(N);y(Ts.$$.fragment,te),tf=p(te),bl=s(te,"P",{});var Mb=n(bl);of=i(Mb,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor, a Wav2Vec2 CTC tokenizer and a decoder
with language model support into a single processor for language model boosted speech recognition decoding.`),Mb.forEach(t),af=p(te),Lo=s(te,"DIV",{class:!0});var np=n(Lo);y($s.$$.fragment,np),sf=p(np),ut=s(np,"P",{});var za=n(ut);nf=i(za,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),xs=s(za,"A",{href:!0});var G1=n(xs);wl=s(G1,"STRONG",{});var Ab=n(wl);rf=i(Ab,"call"),Ab.forEach(t),lf=i(G1,"()"),G1.forEach(t),cf=i(za,` and returns its output. If used in the context
`),ni=s(za,"A",{href:!0});var Ob=n(ni);df=i(Ob,"as_target_processor()"),Ob.forEach(t),pf=i(za,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),Ws=s(za,"A",{href:!0});var J1=n(Ws);yl=s(J1,"STRONG",{});var Lb=n(yl);mf=i(Lb,"call"),Lb.forEach(t),hf=i(J1,"()"),J1.forEach(t),ff=i(za,`. Please refer to the docstring of the above two
...
`),ri=s(Ma,"A",{href:!0});var Db=n(ri);vf=i(Db,"pad()"),Db.forEach(t),bf=i(Ma,` and returns its output. If used in the context
`),ii=s(Ma,"A",{href:!0});var Sb=n(ii);wf=i(Sb,"as_target_processor()"),Sb.forEach(t),yf=i(Ma,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),li=s(Ma,"A",{href:!0});var Nb=n(li);kf=i(Nb,"pad()"),Nb.forEach(t),Tf=i(Ma,`. Please refer to the docstring of the above two methods
for more information.`),Ma.forEach(t),rp.forEach(t),$f=p(te),Vt=s(te,"DIV",{class:!0});var Pi=n(Vt);y(js.$$.fragment,Pi),xf=p(Pi),Fs=s(Pi,"P",{});var ip=n(Fs);Wf=i(ip,"Instantiate a "),ci=s(ip,"A",{href:!0});var Ib=n(ci);Vf=i(Ib,"Wav2Vec2ProcessorWithLM"),Ib.forEach(t),jf=i(ip," from a pretrained Wav2Vec2 processor."),ip.forEach(t),Ff=p(Pi),y(So.$$.fragment,Pi),Pi.forEach(t),Cf=p(te),di=s(te,"DIV",{class:!0});var Bb=n(di);y(Cs.$$.fragment,Bb),Bb.forEach(t),Ef=p(te),jt=s(te,"DIV",{class:!0});var zi=n(jt);y(Es.$$.fragment,zi),qf=p(zi),kl=s(zi,"P",{});var Ub=n(kl);Pf=i(Ub,"Batch decode output logits to audio transcription with language model support."),Ub.forEach(t),zf=p(zi),y(No.$$.fragment,zi),zi.forEach(t),Mf=p(te),Ft=s(te,"DIV",{class:!0});var Mi=n(Ft);y(qs.$$.fragment,Mi),Af=p(Mi),Tl=s(Mi,"P",{});var Rb=n(Tl);Of=i(Rb,"Decode output logits to audio transcription with language model support."),Rb.forEach(t),Lf=p(Mi),y(Io.$$.fragment,Mi),Mi.forEach(t),Df=p(te),Bo=s(te,"DIV",{class:!0});var lp=n(Bo);y(Ps.$$.fragment,lp),Sf=p(lp),$l=s(lp,"P",{});var Hb=n($l);Nf=i(Hb,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),Hb.forEach(t),lp.forEach(t),te.forEach(t),hd=p(o),Ut=s(o,"H2",{class:!0});var cp=n(Ut);Uo=s(cp,"A",{id:!0,class:!0,href:!0});var Xb=n(Uo);xl=s(Xb,"SPAN",{});var Gb=n(xl);y(zs.$$.fragment,Gb),Gb.forEach(t),Xb.forEach(t),If=p(cp),Wl=s(cp,"SPAN",{});var Jb=n(Wl);Bf=i(Jb,"Wav2Vec2 specific outputs"),Jb.forEach(t),cp.forEach(t),fd=p(o),Rt=s(o,"DIV",{class:!0});var dp=n(Rt);y(Ms.$$.fragment,dp),Uf=p(dp),As=s(dp,"P",{});var pp=n(As);Rf=i(pp,"Output type of "),Vl=s(pp,"CODE",{});var Zb=n(Vl);Hf=i(Zb,"Wav2Vec2DecoderWithLM"),Zb.forEach(t),Xf=i(pp,", with transcription."),pp.forEach(t),dp.forEach(t),ud=p(o),Ht=s(o,"DIV",{class:!0});var mp=n(Ht);y(Os.$$.fragment,mp),Gf=p(mp),Ls=s(mp,"P",{});var hp=n(Ls);Jf=i(hp,"Output type of "),jl=s(hp,"CODE",{});var Kb=n(jl);Zf=i(Kb,"Wav2Vec2BaseModelOutput"),Kb.forEach(t),Kf=i(hp,", with potential hidden states and attentions."),hp.forEach(t),mp.forEach(t),gd=p(o),Xt=s(o,"DIV",{class:!0});var fp=n(Xt);y(Ds.$$.fragment,fp),Qf=p(fp),Ss=s(fp,"P",{});var up=n(Ss);Yf=i(up,"Output type of "),pi=s(up,"A",{href:!0});var Qb=n(pi);eu=i(Qb,"Wav2Vec2ForPreTraining"),Qb.forEach(t),tu=i(up,", with potential hidden states and attentions."),up.forEach(t),fp.forEach(t),_d=p(o),_t=s(o,"DIV",{class:!0});var Ai=n(_t);y(Ns.$$.fragment,Ai),ou=p(Ai),Is=s(Ai,"P",{});var gp=n(Is);au=i(gp,"Output type of "),Fl=s(gp,"CODE",{});var Yb=n(Fl);su=i(Yb,"FlaxWav2Vec2BaseModelOutput"),Yb.forEach(t),nu=i(gp,", with potential hidden states and attentions."),gp.forEach(t),ru=p(Ai),Ro=s(Ai,"DIV",{class:!0});var _p=n(Ro);y(Bs.$$.fragment,_p),iu=p(_p),Cl=s(_p,"P",{});var ew=n(Cl);lu=i(ew,"\u201CReturns a new object replacing the specified fields with new values."),ew.forEach(t),_p.forEach(t),Ai.forEach(t),vd=p(o),vt=s(o,"DIV",{class:!0});var Oi=n(vt);y(Us.$$.fragment,Oi),cu=p(Oi),Rs=s(Oi,"P",{});var vp=n(Rs);du=i(vp,"Output type of "),El=s(vp,"CODE",{});var tw=n(El);pu=i(tw,"FlaxWav2Vec2ForPreTrainingOutput"),tw.forEach(t),mu=i(vp,", with potential hidden states and attentions."),vp.forEach(t),hu=p(Oi),Ho=s(Oi,"DIV",{class:!0});var bp=n(Ho);y(Hs.$$.fragment,bp),fu=p(bp),ql=s(bp,"P",{});var ow=n(ql);uu=i(ow,"\u201CReturns a new object replacing the specified fields with new values."),ow.forEach(t),bp.forEach(t),Oi.forEach(t),bd=p(o),Gt=s(o,"H2",{class:!0});var wp=n(Gt);Xo=s(wp,"A",{id:!0,class:!0,href:!0});var aw=n(Xo);Pl=s(aw,"SPAN",{});var sw=n(Pl);y(Xs.$$.fragment,sw),sw.forEach(t),aw.forEach(t),gu=p(wp),zl=s(wp,"SPAN",{});var nw=n(zl);_u=i(nw,"Wav2Vec2Model"),nw.forEach(t),wp.forEach(t),wd=p(o),xe=s(o,"DIV",{class:!0});var Ct=n(xe);y(Gs.$$.fragment,Ct),vu=p(Ct),Js=s(Ct,"P",{});var yp=n(Js);bu=i(yp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Zs=s(yp,"A",{href:!0,rel:!0});var rw=n(Zs);wu=i(rw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),rw.forEach(t),yu=i(yp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),yp.forEach(t),ku=p(Ct),Ks=s(Ct,"P",{});var kp=n(Ks);Tu=i(kp,"This model inherits from "),mi=s(kp,"A",{href:!0});var iw=n(mi);$u=i(iw,"PreTrainedModel"),iw.forEach(t),xu=i(kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),kp.forEach(t),Wu=p(Ct),Qs=s(Ct,"P",{});var Tp=n(Qs);Vu=i(Tp,"This model is a PyTorch "),Ys=s(Tp,"A",{href:!0,rel:!0});var lw=n(Ys);ju=i(lw,"torch.nn.Module"),lw.forEach(t),Fu=i(Tp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),Cu=p(Ct),Ge=s(Ct,"DIV",{class:!0});var Aa=n(Ge);y(en.$$.fragment,Aa),Eu=p(Aa),Jt=s(Aa,"P",{});var Li=n(Jt);qu=i(Li,"The "),hi=s(Li,"A",{href:!0});var cw=n(hi);Pu=i(cw,"Wav2Vec2Model"),cw.forEach(t),zu=i(Li," forward method, overrides the "),Ml=s(Li,"CODE",{});var dw=n(Ml);Mu=i(dw,"__call__"),dw.forEach(t),Au=i(Li," special method."),Li.forEach(t),Ou=p(Aa),y(Go.$$.fragment,Aa),Lu=p(Aa),y(Jo.$$.fragment,Aa),Aa.forEach(t),Ct.forEach(t),yd=p(o),Zt=s(o,"H2",{class:!0});var $p=n(Zt);Zo=s($p,"A",{id:!0,class:!0,href:!0});var pw=n(Zo);Al=s(pw,"SPAN",{});var mw=n(Al);y(tn.$$.fragment,mw),mw.forEach(t),pw.forEach(t),Du=p($p),Ol=s($p,"SPAN",{});var hw=n(Ol);Su=i(hw,"Wav2Vec2ForCTC"),hw.forEach(t),$p.forEach(t),kd=p(o),We=s(o,"DIV",{class:!0});var Et=n(We);y(on.$$.fragment,Et),Nu=p(Et),Kt=s(Et,"P",{});var Di=n(Kt);Iu=i(Di,"Wav2Vec2 Model with a "),Ll=s(Di,"CODE",{});var fw=n(Ll);Bu=i(fw,"language modeling"),fw.forEach(t),Uu=i(Di,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),an=s(Di,"A",{href:!0,rel:!0});var uw=n(an);Ru=i(uw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),uw.forEach(t),Hu=i(Di,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Di.forEach(t),Xu=p(Et),sn=s(Et,"P",{});var xp=n(sn);Gu=i(xp,"This model inherits from "),fi=s(xp,"A",{href:!0});var gw=n(fi);Ju=i(gw,"PreTrainedModel"),gw.forEach(t),Zu=i(xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),xp.forEach(t),Ku=p(Et),nn=s(Et,"P",{});var Wp=n(nn);Qu=i(Wp,"This model is a PyTorch "),rn=s(Wp,"A",{href:!0,rel:!0});var _w=n(rn);Yu=i(_w,"torch.nn.Module"),_w.forEach(t),eg=i(Wp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wp.forEach(t),tg=p(Et),ze=s(Et,"DIV",{class:!0});var qt=n(ze);y(ln.$$.fragment,qt),og=p(qt),Qt=s(qt,"P",{});var Si=n(Qt);ag=i(Si,"The "),ui=s(Si,"A",{href:!0});var vw=n(ui);sg=i(vw,"Wav2Vec2ForCTC"),vw.forEach(t),ng=i(Si," forward method, overrides the "),Dl=s(Si,"CODE",{});var bw=n(Dl);rg=i(bw,"__call__"),bw.forEach(t),ig=i(Si," special method."),Si.forEach(t),lg=p(qt),y(Ko.$$.fragment,qt),cg=p(qt),y(Qo.$$.fragment,qt),dg=p(qt),y(Yo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),Td=p(o),Yt=s(o,"H2",{class:!0});var Vp=n(Yt);ea=s(Vp,"A",{id:!0,class:!0,href:!0});var ww=n(ea);Sl=s(ww,"SPAN",{});var yw=n(Sl);y(cn.$$.fragment,yw),yw.forEach(t),ww.forEach(t),pg=p(Vp),Nl=s(Vp,"SPAN",{});var kw=n(Nl);mg=i(kw,"Wav2Vec2ForSequenceClassification"),kw.forEach(t),Vp.forEach(t),$d=p(o),ne=s(o,"DIV",{class:!0});var at=n(ne);y(dn.$$.fragment,at),hg=p(at),Il=s(at,"P",{});var Tw=n(Il);fg=i(Tw,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),Tw.forEach(t),ug=p(at),pn=s(at,"P",{});var jp=n(pn);gg=i(jp,"Wav2Vec2 was proposed in "),mn=s(jp,"A",{href:!0,rel:!0});var $w=n(mn);_g=i($w,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),$w.forEach(t),vg=i(jp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),jp.forEach(t),bg=p(at),hn=s(at,"P",{});var Fp=n(hn);wg=i(Fp,"This model inherits from "),gi=s(Fp,"A",{href:!0});var xw=n(gi);yg=i(xw,"PreTrainedModel"),xw.forEach(t),kg=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Fp.forEach(t),Tg=p(at),fn=s(at,"P",{});var Cp=n(fn);$g=i(Cp,"This model is a PyTorch "),un=s(Cp,"A",{href:!0,rel:!0});var Ww=n(un);xg=i(Ww,"torch.nn.Module"),Ww.forEach(t),Wg=i(Cp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cp.forEach(t),Vg=p(at),Me=s(at,"DIV",{class:!0});var Pt=n(Me);y(gn.$$.fragment,Pt),jg=p(Pt),eo=s(Pt,"P",{});var Ni=n(eo);Fg=i(Ni,"The "),_i=s(Ni,"A",{href:!0});var Vw=n(_i);Cg=i(Vw,"Wav2Vec2ForSequenceClassification"),Vw.forEach(t),Eg=i(Ni," forward method, overrides the "),Bl=s(Ni,"CODE",{});var jw=n(Bl);qg=i(jw,"__call__"),jw.forEach(t),Pg=i(Ni," special method."),Ni.forEach(t),zg=p(Pt),y(ta.$$.fragment,Pt),Mg=p(Pt),y(oa.$$.fragment,Pt),Ag=p(Pt),y(aa.$$.fragment,Pt),Pt.forEach(t),at.forEach(t),xd=p(o),to=s(o,"H2",{class:!0});var Ep=n(to);sa=s(Ep,"A",{id:!0,class:!0,href:!0});var Fw=n(sa);Ul=s(Fw,"SPAN",{});var Cw=n(Ul);y(_n.$$.fragment,Cw),Cw.forEach(t),Fw.forEach(t),Og=p(Ep),Rl=s(Ep,"SPAN",{});var Ew=n(Rl);Lg=i(Ew,"Wav2Vec2ForAudioFrameClassification"),Ew.forEach(t),Ep.forEach(t),Wd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(vn.$$.fragment,st),Dg=p(st),Hl=s(st,"P",{});var qw=n(Hl);Sg=i(qw,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),qw.forEach(t),Ng=p(st),bn=s(st,"P",{});var qp=n(bn);Ig=i(qp,"Wav2Vec2 was proposed in "),wn=s(qp,"A",{href:!0,rel:!0});var Pw=n(wn);Bg=i(Pw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Pw.forEach(t),Ug=i(qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),qp.forEach(t),Rg=p(st),yn=s(st,"P",{});var Pp=n(yn);Hg=i(Pp,"This model inherits from "),vi=s(Pp,"A",{href:!0});var zw=n(vi);Xg=i(zw,"PreTrainedModel"),zw.forEach(t),Gg=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Pp.forEach(t),Jg=p(st),kn=s(st,"P",{});var zp=n(kn);Zg=i(zp,"This model is a PyTorch "),Tn=s(zp,"A",{href:!0,rel:!0});var Mw=n(Tn);Kg=i(Mw,"torch.nn.Module"),Mw.forEach(t),Qg=i(zp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zp.forEach(t),Yg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y($n.$$.fragment,Oa),e_=p(Oa),oo=s(Oa,"P",{});var Ii=n(oo);t_=i(Ii,"The "),bi=s(Ii,"A",{href:!0});var Aw=n(bi);o_=i(Aw,"Wav2Vec2ForAudioFrameClassification"),Aw.forEach(t),a_=i(Ii," forward method, overrides the "),Xl=s(Ii,"CODE",{});var Ow=n(Xl);s_=i(Ow,"__call__"),Ow.forEach(t),n_=i(Ii," special method."),Ii.forEach(t),r_=p(Oa),y(na.$$.fragment,Oa),i_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Vd=p(o),ao=s(o,"H2",{class:!0});var Mp=n(ao);ia=s(Mp,"A",{id:!0,class:!0,href:!0});var Lw=n(ia);Gl=s(Lw,"SPAN",{});var Dw=n(Gl);y(xn.$$.fragment,Dw),Dw.forEach(t),Lw.forEach(t),l_=p(Mp),Jl=s(Mp,"SPAN",{});var Sw=n(Jl);c_=i(Sw,"Wav2Vec2ForXVector"),Sw.forEach(t),Mp.forEach(t),jd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(Wn.$$.fragment,nt),d_=p(nt),Zl=s(nt,"P",{});var Nw=n(Zl);p_=i(Nw,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Nw.forEach(t),m_=p(nt),Vn=s(nt,"P",{});var Ap=n(Vn);h_=i(Ap,"Wav2Vec2 was proposed in "),jn=s(Ap,"A",{href:!0,rel:!0});var Iw=n(jn);f_=i(Iw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Iw.forEach(t),u_=i(Ap,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ap.forEach(t),g_=p(nt),Fn=s(nt,"P",{});var Op=n(Fn);__=i(Op,"This model inherits from "),wi=s(Op,"A",{href:!0});var Bw=n(wi);v_=i(Bw,"PreTrainedModel"),Bw.forEach(t),b_=i(Op,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Op.forEach(t),w_=p(nt),Cn=s(nt,"P",{});var Lp=n(Cn);y_=i(Lp,"This model is a PyTorch "),En=s(Lp,"A",{href:!0,rel:!0});var Uw=n(En);k_=i(Uw,"torch.nn.Module"),Uw.forEach(t),T_=i(Lp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lp.forEach(t),$_=p(nt),Ze=s(nt,"DIV",{class:!0});var La=n(Ze);y(qn.$$.fragment,La),x_=p(La),so=s(La,"P",{});var Bi=n(so);W_=i(Bi,"The "),yi=s(Bi,"A",{href:!0});var Rw=n(yi);V_=i(Rw,"Wav2Vec2ForXVector"),Rw.forEach(t),j_=i(Bi," forward method, overrides the "),Kl=s(Bi,"CODE",{});var Hw=n(Kl);F_=i(Hw,"__call__"),Hw.forEach(t),C_=i(Bi," special method."),Bi.forEach(t),E_=p(La),y(la.$$.fragment,La),q_=p(La),y(ca.$$.fragment,La),La.forEach(t),nt.forEach(t),Fd=p(o),no=s(o,"H2",{class:!0});var Dp=n(no);da=s(Dp,"A",{id:!0,class:!0,href:!0});var Xw=n(da);Ql=s(Xw,"SPAN",{});var Gw=n(Ql);y(Pn.$$.fragment,Gw),Gw.forEach(t),Xw.forEach(t),P_=p(Dp),Yl=s(Dp,"SPAN",{});var Jw=n(Yl);z_=i(Jw,"Wav2Vec2ForPreTraining"),Jw.forEach(t),Dp.forEach(t),Cd=p(o),Ve=s(o,"DIV",{class:!0});var zt=n(Ve);y(zn.$$.fragment,zt),M_=p(zt),ro=s(zt,"P",{});var Ui=n(ro);A_=i(Ui,"Wav2Vec2 Model with a quantizer and "),ec=s(Ui,"CODE",{});var Zw=n(ec);O_=i(Zw,"VQ"),Zw.forEach(t),L_=i(Ui,` head on top.
Wav2Vec2 was proposed in `),Mn=s(Ui,"A",{href:!0,rel:!0});var Kw=n(Mn);D_=i(Kw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Kw.forEach(t),S_=i(Ui,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ui.forEach(t),N_=p(zt),An=s(zt,"P",{});var Sp=n(An);I_=i(Sp,"This model inherits from "),ki=s(Sp,"A",{href:!0});var Qw=n(ki);B_=i(Qw,"PreTrainedModel"),Qw.forEach(t),U_=i(Sp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sp.forEach(t),R_=p(zt),On=s(zt,"P",{});var Np=n(On);H_=i(Np,"This model is a PyTorch "),Ln=s(Np,"A",{href:!0,rel:!0});var Yw=n(Ln);X_=i(Yw,"torch.nn.Module"),Yw.forEach(t),G_=i(Np,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
