...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17111/en/model_doc/data2vec#transformers.Data2VecAudioConfig"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1334",returnDescription:`
<p>A <a
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1077",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1167"}}),Cn=new C({props:{name:"forward",anchor:"transformers.Data2VecAudioForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Data2VecAudioForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1212",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1449"}}),Sn=new C({props:{name:"forward",anchor:"transformers.Data2VecAudioForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Data2VecAudioForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1511",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L740",returnDescription:`
<p>A <a
...
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17111/en/model_doc/data2vec#transformers.Data2VecTextConfig"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L881"}}),es=new C({props:{name:"forward",anchor:"transformers.Data2VecTextForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.Data2VecTextForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L907",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1033"}}),is=new C({props:{name:"forward",anchor:"transformers.Data2VecTextForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.Data2VecTextForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1062",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1177",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1374",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17111/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
>transformers.modeling_outputs.TokenClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1464"}}),Is=new C({props:{name:"forward",anchor:"transformers.Data2VecTextForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.Data2VecTextForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_text.py#L1478",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_vision.py#L673",returnDescription:`
<p>A <code>transformers.models.data2vec.modeling_data2vec_vision.Data2VecVisionModelOutputWithPooling</code> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17111/en/model_doc/data2vec#transformers.Data2VecVisionConfig"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_vision.py#L773",returnDescription:`
...
Ground truth semantic segmentation maps for computing the loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code>, a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_data2vec_vision.py#L1122",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_tf_data2vec_vision.py#L875",returnDescription:`
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/data2vec/modeling_tf_data2vec_vision.py#L930",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Z2=u(),pe=r("div"),w(Is.$$.fragment),e1=u(),Qt=r("p"),t1=n("The "),ni=r("a"),o1=n("Data2VecTextForQuestionAnswering"),a1=n(" forward method, overrides the "),Rl=r("code"),n1=n("__call__"),s1=n(" special method."),r1=u(),w(ea.$$.fragment),i1=u(),w(ta.$$.fragment),l1=u(),w(oa.$$.fragment),$c=u(),Gt=r("h2"),aa=r("a"),Ql=r("span"),w(Ns.$$.fragment),d1=u(),Gl=r("span"),c1=n("Data2VecVisionModel"),yc=u(),Qe=r("div"),w(Os.$$.fragment),p1=u(),Ws=r("p"),h1=n(`The bare Data2VecVision Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Bs=r("a"),m1=n("torch.nn.Module"),u1=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),f1=u(),Fe=r("div"),w(Hs.$$.fragment),g1=u(),Xt=r("p"),_1=n("The "),si=r("a"),v1=n("Data2VecVisionModel"),b1=n(" forward method, overrides the "),Xl=r("code"),w1=n("__call__"),k1=n(" special method."),T1=u(),w(na.$$.fragment),$1=u(),w(sa.$$.fragment),Vc=u(),Ut=r("h2"),ra=r("a"),Ul=r("span"),w(Rs.$$.fragment),y1=u(),Jl=r("span"),V1=n("Data2VecVisionForImageClassification"),xc=u(),ge=r("div"),w(Qs.$$.fragment),x1=u(),Kl=r("p"),D1=n(`Data2VecVision Model transformer with an image classification head on top (a linear layer on top of the average of
the final hidden states of the patch tokens) e.g. for ImageNet.`),F1=u(),Gs=r("p"),C1=n("This model is a PyTorch "),Xs=r("a"),A1=n("torch.nn.Module"),M1=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),j1=u(),Ce=r("div"),w(Us.$$.fragment),E1=u(),Jt=r("p"),q1=n("The "),ri=r("a"),z1=n("Data2VecVisionForImageClassification"),P1=n(" forward method, overrides the "),Yl=r("code"),S1=n("__call__"),L1=n(" special method."),I1=u(),w(ia.$$.fragment),N1=u(),w(la.$$.fragment),Dc=u(),Kt=r("h2"),da=r("a"),Zl=r("span"),w(Js.$$.fragment),O1=u(),ed=r("span"),W1=n("Data2VecVisionForSemanticSegmentation"),Fc=u(),_e=r("div"),w(Ks.$$.fragment),B1=u(),td=r("p"),H1=n("Data2VecVision Model transformer with a semantic segmentation head on top e.g. for ADE20k, CityScapes."),R1=u(),Ys=r("p"),Q1=n("This model is a PyTorch "),Zs=r("a"),G1=n("torch.nn.Module"),X1=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),U1=u(),Ae=r("div"),w(er.$$.fragment),J1=u(),Yt=r("p"),K1=n("The "),ii=r("a"),Y1=n("Data2VecVisionForSemanticSegmentation"),Z1=n(" forward method, overrides the "),od=r("code"),ev=n("__call__"),tv=n(" special method."),ov=u(),w(ca.$$.fragment),av=u(),w(pa.$$.fragment),Cc=u(),Zt=r("h2"),ha=r("a"),ad=r("span"),w(tr.$$.fragment),nv=u(),nd=r("span"),sv=n("TFData2VecVisionModel"),Ac=u(),se=r("div"),w(or.$$.fragment),rv=u(),ar=r("p"),iv=n(`The bare Data2VecVision Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),li=r("a"),lv=n("TFPreTrainedModel"),dv=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.).`),cv=u(),nr=r("p"),pv=n("This model is also a "),sr=r("a"),hv=n("tf.keras.Model"),mv=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),uv=u(),w(ma.$$.fragment),fv=u(),Me=r("div"),w(rr.$$.fragment),gv=u(),eo=r("p"),_v=n("The "),di=r("a"),vv=n("TFData2VecVisionModel"),bv=n(" forward method, overrides the "),sd=r("code"),wv=n("__call__"),kv=n(" special method."),Tv=u(),w(ua.$$.fragment),$v=u(),w(fa.$$.fragment),Mc=u(),to=r("h2"),ga=r("a"),rd=r("span"),w(ir.$$.fragment),yv=u(),id=r("span"),Vv=n("TFData2VecVisionForImageClassification"),jc=u(),K=r("div"),w(lr.$$.fragment),xv=u(),ld=r("p"),Dv=n(`Data2VecVision Model transformer with an image classification head on top (a linear layer on top of the average of
the final hidden states of the patch tokens) e.g. for ImageNet.`),Fv=u(),dr=r("p"),Cv=n("This model inherits from "),ci=r("a"),Av=n("TFPreTrainedModel"),Mv=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.).`),jv=u(),cr=r("p"),Ev=n("This model is also a "),pr=r("a"),qv=n("tf.keras.Model"),zv=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pv=u(),w(_a.$$.fragment),Sv=u(),je=r("div"),w(hr.$$.fragment),Lv=u(),oo=r("p"),Iv=n("The "),pi=r("a"),Nv=n("TFData2VecVisionForImageClassification"),Ov=n(" forward method, overrides the "),dd=r("code"),Wv=n("__call__"),Bv=n(" special method."),Hv=u(),w(va.$$.fragment),Rv=u(),w(ba.$$.fragment),this.h()},l(o){const _=Gk('[data-svelte="svelte-1phssyn"]',document.head);d=i(_,"META",{name:!0,content:!0}),_.forEach(t),g=f(o),c=i(o,"H1",{class:!0});var mr=l(c);h=i(mr,"A",{id:!0,class:!0,href:!0});var cd=l(h);v=i(cd,"SPAN",{});var pd=l(v);k(a.$$.fragment,pd),pd.forEach(t),cd.forEach(t),p=f(mr),D=i(mr,"SPAN",{});var hd=l(D);Oe=s(hd,"Data2Vec"),hd.forEach(t),mr.forEach(t),re=f(o),A=i(o,"H2",{class:!0});var ur=l(A);Y=i(ur,"A",{id:!0,class:!0,href:!0});var md=l(Y);N=i(md,"SPAN",{});var ud=l(N);k(ee.$$.fragment,ud),ud.forEach(t),md.forEach(t),We=f(ur),O=i(ur,"SPAN",{});var fd=l(O);Be=s(fd,"Overview"),fd.forEach(t),ur.forEach(t),ve=f(o),F=i(o,"P",{});var fr=l(F);z=s(fr,"The Data2Vec model was proposed in "),W=i(fr,"A",{href:!0,rel:!0});var gd=l(W);dt=s(gd,"data2vec: A General Framework for Self-supervised Learning in Speech, Vision and Language"),gd.forEach(t),ct=s(fr,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and Michael Auli.
Data2Vec proposes a unified framework for self-supervised learning across different data modalities - text, audio and images.
...
documentation from `),Ar=i(no,"A",{href:!0});var Sd=l(Ar);Fh=s(Sd,"PretrainedConfig"),Sd.forEach(t),Ch=s(no," for more information."),no.forEach(t),Ah=f(Ue),k(ro.$$.fragment,Ue),Ue.forEach(t),Ud=f(o),ut=i(o,"H2",{class:!0});var kr=l(ut);io=i(kr,"A",{id:!0,class:!0,href:!0});var Ld=l(io);Oi=i(Ld,"SPAN",{});var Id=l(Oi);k(Qa.$$.fragment,Id),Id.forEach(t),Ld.forEach(t),Mh=f(kr),Wi=i(kr,"SPAN",{});var Nd=l(Wi);jh=s(Nd,"Data2VecAudioConfig"),Nd.forEach(t),kr.forEach(t),Jd=f(o),fe=i(o,"DIV",{class:!0});var Ke=l(fe);k(Ga.$$.fragment,Ke),Eh=f(Ke),ft=i(Ke,"P",{});var hi=l(ft);qh=s(hi,"This is the configuration class to store the configuration of a "),Mr=i(hi,"A",{href:!0});var Qv=l(Mr);zh=s(Qv,"Data2VecAudioModel"),Qv.forEach(t),Ph=s(hi,`. It is used to instantiate
an Data2VecAudio model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Data2VecAudio
`),Xa=i(hi,"A",{href:!0,rel:!0});var Gv=l(Xa);Sh=s(Gv,"facebook/data2vec-audio-base-960h"),Gv.forEach(t),Lh=s(hi," architecture."),hi.forEach(t),Ih=f(Ke),gt=i(Ke,"P",{});var mi=l(gt);Nh=s(mi,"Configuration objects inherit from "),jr=i(mi,"A",{href:!0});var Xv=l(jr);Oh=s(Xv,"PretrainedConfig"),Xv.forEach(t),Wh=s(mi,` and can be used to control the model outputs. Read the
documentation from `),Er=i(mi,"A",{href:!0});var Uv=l(Er);Bh=s(Uv,"PretrainedConfig"),Uv.forEach(t),Hh=s(mi," for more information."),mi.forEach(t),Rh=f(Ke),k(lo.$$.fragment,Ke),Ke.forEach(t),Kd=f(o),_t=i(o,"H2",{class:!0});var qc=l(_t);co=i(qc,"A",{id:!0,class:!0,href:!0});var Jv=l(co);Bi=i(Jv,"SPAN",{});var Kv=l(Bi);k(Ua.$$.fragment,Kv),Kv.forEach(t),Jv.forEach(t),Qh=f(qc),Hi=i(qc,"SPAN",{});var Yv=l(Hi);Gh=s(Yv,"Data2VecVisionConfig"),Yv.forEach(t),qc.forEach(t),Yd=f(o),Re=i(o,"DIV",{class:!0});var ui=l(Re);k(Ja.$$.fragment,ui),Xh=f(ui),vt=i(ui,"P",{});var fi=l(vt);Uh=s(fi,"This is the configuration class to store the configuration of a "),qr=i(fi,"A",{href:!0});var Zv=l(qr);Jh=s(Zv,"Data2VecVisionModel"),Zv.forEach(t),Kh=s(fi,`. It is used to instantiate
an Data2VecVision model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Data2VecVision
`),Ka=i(fi,"A",{href:!0,rel:!0});var eb=l(Ka);Yh=s(eb,"facebook/data2vec-vision-base"),eb.forEach(t),Zh=s(fi," architecture."),fi.forEach(t),em=f(ui),k(po.$$.fragment,ui),ui.forEach(t),Zd=f(o),bt=i(o,"H2",{class:!0});var zc=l(bt);ho=i(zc,"A",{id:!0,class:!0,href:!0});var tb=l(ho);Ri=i(tb,"SPAN",{});var ob=l(Ri);k(Ya.$$.fragment,ob),ob.forEach(t),tb.forEach(t),tm=f(zc),Qi=i(zc,"SPAN",{});var ab=l(Qi);om=s(ab,"Data2VecAudioModel"),ab.forEach(t),zc.forEach(t),ec=f(o),te=i(o,"DIV",{class:!0});var Ze=l(te);k(Za.$$.fragment,Ze),am=f(Ze),en=i(Ze,"P",{});var Pc=l(en);nm=s(Pc,`The bare Data2VecAudio Model transformer outputting raw hidden-states without any specific head on top.
Data2VecAudio was proposed in `),tn=i(Pc,"A",{href:!0,rel:!0});var nb=l(tn);sm=s(nb,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),nb.forEach(t),rm=s(Pc,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
Michael Auli.`),Pc.forEach(t),im=f(Ze),on=i(Ze,"P",{});var Sc=l(on);lm=s(Sc,"This model inherits from "),zr=i(Sc,"A",{href:!0});var sb=l(zr);dm=s(sb,"PreTrainedModel"),sb.forEach(t),cm=s(Sc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sc.forEach(t),pm=f(Ze),an=i(Ze,"P",{});var Lc=l(an);hm=s(Lc,"This model is a PyTorch "),nn=i(Lc,"A",{href:!0,rel:!0});var rb=l(nn);mm=s(rb,"torch.nn.Module"),rb.forEach(t),um=s(Lc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lc.forEach(t),fm=f(Ze),Te=i(Ze,"DIV",{class:!0});var wa=l(Te);k(sn.$$.fragment,wa),gm=f(wa),wt=i(wa,"P",{});var gi=l(wt);_m=s(gi,"The "),Pr=i(gi,"A",{href:!0});var ib=l(Pr);vm=s(ib,"Data2VecAudioModel"),ib.forEach(t),bm=s(gi," forward method, overrides the "),Gi=i(gi,"CODE",{});var lb=l(Gi);wm=s(lb,"__call__"),lb.forEach(t),km=s(gi," special method."),gi.forEach(t),Tm=f(wa),k(mo.$$.fragment,wa),$m=f(wa),k(uo.$$.fragment,wa),wa.forEach(t),Ze.forEach(t),tc=f(o),kt=i(o,"H2",{class:!0});var Ic=l(kt);fo=i(Ic,"A",{id:!0,class:!0,href:!0});var db=l(fo);Xi=i(db,"SPAN",{});var cb=l(Xi);k(rn.$$.fragment,cb),cb.forEach(t),db.forEach(t),ym=f(Ic),Ui=i(Ic,"SPAN",{});var pb=l(Ui);Vm=s(pb,"Data2VecAudioForAudioFrameClassification"),pb.forEach(t),Ic.forEach(t),oc=f(o),B=i(o,"DIV",{class:!0});var Ee=l(B);k(ln.$$.fragment,Ee),xm=f(Ee),Ji=i(Ee,"P",{});var hb=l(Ji);Dm=s(hb,"Data2VecAudio Model with a frame classification head on top for tasks like Speaker Diarization."),hb.forEach(t),Fm=f(Ee),dn=i(Ee,"P",{});var Nc=l(dn);Cm=s(Nc,"Data2VecAudio was proposed in "),cn=i(Nc,"A",{href:!0,rel:!0});var mb=l(cn);Am=s(mb,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),mb.forEach(t),Mm=s(Nc,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
Michael Auli.`),Nc.forEach(t),jm=f(Ee),pn=i(Ee,"P",{});var Oc=l(pn);Em=s(Oc,"This model inherits from "),Sr=i(Oc,"A",{href:!0});var ub=l(Sr);qm=s(ub,"PreTrainedModel"),ub.forEach(t),zm=s(Oc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Oc.forEach(t),Pm=f(Ee),hn=i(Ee,"P",{});var Wc=l(hn);Sm=s(Wc,"This model is a PyTorch "),mn=i(Wc,"A",{href:!0,rel:!0});var fb=l(mn);Lm=s(fb,"torch.nn.Module"),fb.forEach(t),Im=s(Wc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wc.forEach(t),Nm=f(Ee),$e=i(Ee,"DIV",{class:!0});var ka=l($e);k(un.$$.fragment,ka),Om=f(ka),Tt=i(ka,"P",{});var _i=l(Tt);Wm=s(_i,"The "),Lr=i(_i,"A",{href:!0});var gb=l(Lr);Bm=s(gb,"Data2VecAudioForAudioFrameClassification"),gb.forEach(t),Hm=s(_i," forward method, overrides the "),Ki=i(_i,"CODE",{});var _b=l(Ki);Rm=s(_b,"__call__"),_b.forEach(t),Qm=s(_i," special method."),_i.forEach(t),Gm=f(ka),k(go.$$.fragment,ka),Xm=f(ka),k(_o.$$.fragment,ka),ka.forEach(t),Ee.forEach(t),ac=f(o),$t=i(o,"H2",{class:!0});var Bc=l($t);vo=i(Bc,"A",{id:!0,class:!0,href:!0});var vb=l(vo);Yi=i(vb,"SPAN",{});var bb=l(Yi);k(fn.$$.fragment,bb),bb.forEach(t),vb.forEach(t),Um=f(Bc),Zi=i(Bc,"SPAN",{});var wb=l(Zi);Jm=s(wb,"Data2VecAudioForCTC"),wb.forEach(t),Bc.forEach(t),nc=f(o),oe=i(o,"DIV",{class:!0});var et=l(oe);k(gn.$$.fragment,et),Km=f(et),yt=i(et,"P",{});var vi=l(yt);Ym=s(vi,"Data2VecAudio Model with a "),el=i(vi,"CODE",{});var kb=l(el);Zm=s(kb,"language modeling"),kb.forEach(t),eu=s(vi,` head on top for Connectionist Temporal Classification (CTC).
Data2VecAudio was proposed in `),_n=i(vi,"A",{href:!0,rel:!0});var Tb=l(_n);tu=s(Tb,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),Tb.forEach(t),ou=s(vi,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
Michael Auli.`),vi.forEach(t),au=f(et),vn=i(et,"P",{});var Hc=l(vn);nu=s(Hc,"This model inherits from "),Ir=i(Hc,"A",{href:!0});var $b=l(Ir);su=s($b,"PreTrainedModel"),$b.forEach(t),ru=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Hc.forEach(t),iu=f(et),bn=i(et,"P",{});var Rc=l(bn);lu=s(Rc,"This model is a PyTorch "),wn=i(Rc,"A",{href:!0,rel:!0});var yb=l(wn);du=s(yb,"torch.nn.Module"),yb.forEach(t),cu=s(Rc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Rc.forEach(t),pu=f(et),ie=i(et,"DIV",{class:!0});var tt=l(ie);k(kn.$$.fragment,tt),hu=f(tt),Vt=i(tt,"P",{});var bi=l(Vt);mu=s(bi,"The "),Nr=i(bi,"A",{href:!0});var Vb=l(Nr);uu=s(Vb,"Data2VecAudioForCTC"),Vb.forEach(t),fu=s(bi," forward method, overrides the "),tl=i(bi,"CODE",{});var xb=l(tl);gu=s(xb,"__call__"),xb.forEach(t),_u=s(bi," special method."),bi.forEach(t),vu=f(tt),k(bo.$$.fragment,tt),bu=f(tt),k(wo.$$.fragment,tt),wu=f(tt),k(ko.$$.fragment,tt),tt.forEach(t),et.forEach(t),sc=f(o),xt=i(o,"H2",{class:!0});var Qc=l(xt);To=i(Qc,"A",{id:!0,class:!0,href:!0});var Db=l(To);ol=i(Db,"SPAN",{});var Fb=l(ol);k(Tn.$$.fragment,Fb),Fb.forEach(t),Db.forEach(t),ku=f(Qc),al=i(Qc,"SPAN",{});var Cb=l(al);Tu=s(Cb,"Data2VecAudioForSequenceClassification"),Cb.forEach(t),Qc.forEach(t),rc=f(o),H=i(o,"DIV",{class:!0});var qe=l(H);k($n.$$.fragment,qe),$u=f(qe),nl=i(qe,"P",{});var Ab=l(nl);yu=s(Ab,`Data2VecAudio Model with a sequence classification head on top (a linear layer over the pooled output) for tasks
like SUPERB Keyword Spotting.`),Ab.forEach(t),Vu=f(qe),yn=i(qe,"P",{});var Gc=l(yn);xu=s(Gc,"Data2VecAudio was proposed in "),Vn=i(Gc,"A",{href:!0,rel:!0});var Mb=l(Vn);Du=s(Mb,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),Mb.forEach(t),Fu=s(Gc,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
Michael Auli.`),Gc.forEach(t),Cu=f(qe),xn=i(qe,"P",{});var Xc=l(xn);Au=s(Xc,"This model inherits from "),Or=i(Xc,"A",{href:!0});var jb=l(Or);Mu=s(jb,"PreTrainedModel"),jb.forEach(t),ju=s(Xc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Xc.forEach(t),Eu=f(qe),Dn=i(qe,"P",{});var Uc=l(Dn);qu=s(Uc,"This model is a PyTorch "),Fn=i(Uc,"A",{href:!0,rel:!0});var Eb=l(Fn);zu=s(Eb,"torch.nn.Module"),Eb.forEach(t),Pu=s(Uc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Uc.forEach(t),Su=f(qe),le=i(qe,"DIV",{class:!0});var ot=l(le);k(Cn.$$.fragment,ot),Lu=f(ot),Dt=i(ot,"P",{});var wi=l(Dt);Iu=s(wi,"The "),Wr=i(wi,"A",{href:!0});var qb=l(Wr);Nu=s(qb,"Data2VecAudioForSequenceClassification"),qb.forEach(t),Ou=s(wi," forward method, overrides the "),sl=i(wi,"CODE",{});var zb=l(sl);Wu=s(zb,"__call__"),zb.forEach(t),Bu=s(wi," special method."),wi.forEach(t),Hu=f(ot),k($o.$$.fragment,ot),Ru=f(ot),k(yo.$$.fragment,ot),Qu=f(ot),k(Vo.$$.fragment,ot),ot.forEach(t),qe.forEach(t),ic=f(o),Ft=i(o,"H2",{class:!0});var Jc=l(Ft);xo=i(Jc,"A",{id:!0,class:!0,href:!0});var Pb=l(xo);rl=i(Pb,"SPAN",{});var Sb=l(rl);k(An.$$.fragment,Sb),Sb.forEach(t),Pb.forEach(t),Gu=f(Jc),il=i(Jc,"SPAN",{});var Lb=l(il);Xu=s(Lb,"Data2VecAudioForXVector"),Lb.forEach(t),Jc.forEach(t),lc=f(o),R=i(o,"DIV",{class:!0});var ze=l(R);k(Mn.$$.fragment,ze),Uu=f(ze),ll=i(ze,"P",{});var Ib=l(ll);Ju=s(Ib,"Data2VecAudio Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Ib.forEach(t),Ku=f(ze),jn=i(ze,"P",{});var Kc=l(jn);Yu=s(Kc,"Data2VecAudio was proposed in "),En=i(Kc,"A",{href:!0,rel:!0});var Nb=l(En);Zu=s(Nb,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),Nb.forEach(t),ef=s(Kc,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
Michael Auli.`),Kc.forEach(t),tf=f(ze),qn=i(ze,"P",{});var Yc=l(qn);of=s(Yc,"This model inherits from "),Br=i(Yc,"A",{href:!0});var Ob=l(Br);af=s(Ob,"PreTrainedModel"),Ob.forEach(t),nf=s(Yc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Yc.forEach(t),sf=f(ze),zn=i(ze,"P",{});var Zc=l(zn);rf=s(Zc,"This model is a PyTorch "),Pn=i(Zc,"A",{href:!0,rel:!0});var Wb=l(Pn);lf=s(Wb,"torch.nn.Module"),Wb.forEach(t),df=s(Zc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Zc.forEach(t),cf=f(ze),ye=i(ze,"DIV",{class:!0});var Ta=l(ye);k(Sn.$$.fragment,Ta),pf=f(Ta),Ct=i(Ta,"P",{});var ki=l(Ct);hf=s(ki,"The "),Hr=i(ki,"A",{href:!0});var Bb=l(Hr);mf=s(Bb,"Data2VecAudioForXVector"),Bb.forEach(t),uf=s(ki," forward method, overrides the "),dl=i(ki,"CODE",{});var Hb=l(dl);ff=s(Hb,"__call__"),Hb.forEach(t),gf=s(ki," special method."),ki.forEach(t),_f=f(Ta),k(Do.$$.fragment,Ta),vf=f(Ta),k(Fo.$$.fragment,Ta),Ta.forEach(t),ze.forEach(t),dc=f(o),At=i(o,"H2",{class:!0});var ep=l(At);Co=i(ep,"A",{id:!0,class:!0,href:!0});var Rb=l(Co);cl=i(Rb,"SPAN",{});var Qb=l(cl);k(Ln.$$.fragment,Qb),Qb.forEach(t),Rb.forEach(t),bf=f(ep),pl=i(ep,"SPAN",{});var Gb=l(pl);wf=s(Gb,"Data2VecTextModel"),Gb.forEach(t),ep.forEach(t),cc=f(o),P=i(o,"DIV",{class:!0});var Z=l(P);k(In.$$.fragment,Z),kf=f(Z),Nn=i(Z,"P",{});var tp=l(Nn);Tf=s(tp,`The bare Data2VecText Model for text transformer outputting raw hidden-states without any specific head on top.
Data2VecText was proposed in `),On=i(tp,"A",{href:!0,rel:!0});var Xb=l(On);$f=s(Xb,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),Xb.forEach(t),yf=s(tp,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
Michael Auli.`),tp.forEach(t),Vf=f(Z),Wn=i(Z,"P",{});var op=l(Wn);xf=s(op,"This model inherits from "),Rr=i(op,"A",{href:!0});var Ub=l(Rr);Df=s(Ub,"PreTrainedModel"),Ub.forEach(t),Ff=s(op,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),op.forEach(t),Cf=f(Z),Bn=i(Z,"P",{});var ap=l(Bn);Af=s(ap,"This model is also a PyTorch "),Hn=i(ap,"A",{href:!0,rel:!0});var Jb=l(Hn);Mf=s(Jb,"torch.nn.Module"),Jb.forEach(t),jf=s(ap,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),hl=i(np,"EM",{});var Kb=l(hl);zf=s(Kb,`Attention is
all you need`),Kb.forEach(t),Pf=s(np,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),np.forEach(t),Sf=f(Z),Q=i(Z,"P",{});var he=l(Q);Lf=s(he,"To behave as an decoder the model needs to be initialized with the "),ml=i(he,"CODE",{});var Yb=l(ml);If=s(Yb,"is_decoder"),Yb.forEach(t),Nf=s(he,` argument of the configuration set
to `),ul=i(he,"CODE",{});var Zb=l(ul);Of=s(Zb,"True"),Zb.forEach(t),Wf=s(he,". To be used in a Seq2Seq model, the model needs to initialized with both "),fl=i(he,"CODE",{});var ew=l(fl);Bf=s(ew,"is_decoder"),ew.forEach(t),Hf=s(he,` argument and
