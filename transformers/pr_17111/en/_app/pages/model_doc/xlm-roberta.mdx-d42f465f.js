...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L194",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L220",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L248",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L305"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L155",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L181",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17111/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17111/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17111/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17111/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17111/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17111/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
alongside usage examples.`),Jb=c(),Mt=n("div"),T(Ua.$$.fragment),Kb=c(),vo=n("p"),Gb=r("The "),Ql=n("a"),Yb=r("RobertaForMultipleChoice"),Zb=r(" forward method, overrides the "),jc=n("code"),e1=r("__call__"),t1=r(" special method."),o1=c(),T(Mn.$$.fragment),n1=c(),T(Fn.$$.fragment),gm=c(),To=n("h2"),xn=n("a"),Xc=n("span"),T(Qa.$$.fragment),s1=c(),Pc=n("span"),a1=r("XLMRobertaForTokenClassification"),_m=c(),Ye=n("div"),T(Ha.$$.fragment),r1=c(),Ac=n("p"),i1=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),l1=c(),Va=n("p"),d1=r("This model inherits from "),Hl=n("a"),c1=r("PreTrainedModel"),p1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),h1=c(),Ja=n("p"),m1=r("This model is also a PyTorch "),Ka=n("a"),u1=r("torch.nn.Module"),f1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),g1=c(),Ga=n("p"),_1=r("This class overrides "),Vl=n("a"),b1=r("RobertaForTokenClassification"),k1=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),v1=c(),it=n("div"),T(Ya.$$.fragment),T1=c(),yo=n("p"),y1=r("The "),Jl=n("a"),w1=r("RobertaForTokenClassification"),$1=r(" forward method, overrides the "),Oc=n("code"),M1=r("__call__"),F1=r(" special method."),x1=c(),T(Rn.$$.fragment),R1=c(),T(Ln.$$.fragment),L1=c(),T(En.$$.fragment),bm=c(),wo=n("h2"),zn=n("a"),Nc=n("span"),T(Za.$$.fragment),E1=c(),Ic=n("span"),z1=r("XLMRobertaForQuestionAnswering"),km=c(),Ze=n("div"),T(er.$$.fragment),q1=c(),$o=n("p"),C1=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Dc=n("code"),j1=r("span start logits"),X1=r(" and "),Sc=n("code"),P1=r("span end logits"),A1=r(")."),O1=c(),tr=n("p"),N1=r("This model inherits from "),Kl=n("a"),I1=r("PreTrainedModel"),D1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),S1=c(),or=n("p"),W1=r("This model is also a PyTorch "),nr=n("a"),B1=r("torch.nn.Module"),U1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Q1=c(),sr=n("p"),H1=r("This class overrides "),Gl=n("a"),V1=r("RobertaForQuestionAnswering"),J1=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),K1=c(),lt=n("div"),T(ar.$$.fragment),G1=c(),Mo=n("p"),Y1=r("The "),Yl=n("a"),Z1=r("RobertaForQuestionAnswering"),ek=r(" forward method, overrides the "),Wc=n("code"),tk=r("__call__"),ok=r(" special method."),nk=c(),T(qn.$$.fragment),sk=c(),T(Cn.$$.fragment),ak=c(),T(jn.$$.fragment),vm=c(),Fo=n("h2"),Xn=n("a"),Bc=n("span"),T(rr.$$.fragment),rk=c(),Uc=n("span"),ik=r("TFXLMRobertaModel"),Tm=c(),Oe=n("div"),T(ir.$$.fragment),lk=c(),Qc=n("p"),dk=r("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),ck=c(),lr=n("p"),pk=r("This model inherits from "),Zl=n("a"),hk=r("TFPreTrainedModel"),mk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uk=c(),dr=n("p"),fk=r("This model is also a "),cr=n("a"),gk=r("tf.keras.Model"),_k=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bk=c(),T(Pn.$$.fragment),kk=c(),pr=n("p"),vk=r("This class overrides "),ed=n("a"),Tk=r("TFRobertaModel"),yk=r(`. Please check the superclass for the appropriate documentation alongside
usage examples.`),wk=c(),Ft=n("div"),T(hr.$$.fragment),$k=c(),xo=n("p"),Mk=r("The "),td=n("a"),Fk=r("TFRobertaModel"),xk=r(" forward method, overrides the "),Hc=n("code"),Rk=r("__call__"),Lk=r(" special method."),Ek=c(),T(An.$$.fragment),zk=c(),T(On.$$.fragment),ym=c(),Ro=n("h2"),Nn=n("a"),Vc=n("span"),T(mr.$$.fragment),qk=c(),Jc=n("span"),Ck=r("TFXLMRobertaForMaskedLM"),wm=c(),Ne=n("div"),T(ur.$$.fragment),jk=c(),fr=n("p"),Xk=r("XLM-RoBERTa Model with a "),Kc=n("code"),Pk=r("language modeling"),Ak=r(" head on top."),Ok=c(),gr=n("p"),Nk=r("This model inherits from "),od=n("a"),Ik=r("TFPreTrainedModel"),Dk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sk=c(),_r=n("p"),Wk=r("This model is also a "),br=n("a"),Bk=r("tf.keras.Model"),Uk=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qk=c(),T(In.$$.fragment),Hk=c(),kr=n("p"),Vk=r("This class overrides "),nd=n("a"),Jk=r("TFRobertaForMaskedLM"),Kk=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Gk=c(),dt=n("div"),T(vr.$$.fragment),Yk=c(),Lo=n("p"),Zk=r("The "),sd=n("a"),ev=r("TFRobertaForMaskedLM"),tv=r(" forward method, overrides the "),Gc=n("code"),ov=r("__call__"),nv=r(" special method."),sv=c(),T(Dn.$$.fragment),av=c(),T(Sn.$$.fragment),rv=c(),T(Wn.$$.fragment),$m=c(),Eo=n("h2"),Bn=n("a"),Yc=n("span"),T(Tr.$$.fragment),iv=c(),Zc=n("span"),lv=r("TFXLMRobertaForSequenceClassification"),Mm=c(),Ie=n("div"),T(yr.$$.fragment),dv=c(),ep=n("p"),cv=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
alongside usage examples.`),gu.forEach(t),Jb=p(Ot),Mt=s(Ot,"DIV",{class:!0});var Ls=a(Mt);y(Ua.$$.fragment,Ls),Kb=p(Ls),vo=s(Ls,"P",{});var Xd=a(vo);Gb=i(Xd,"The "),Ql=s(Xd,"A",{href:!0});var dF=a(Ql);Yb=i(dF,"RobertaForMultipleChoice"),dF.forEach(t),Zb=i(Xd," forward method, overrides the "),jc=s(Xd,"CODE",{});var cF=a(jc);e1=i(cF,"__call__"),cF.forEach(t),t1=i(Xd," special method."),Xd.forEach(t),o1=p(Ls),y(Mn.$$.fragment,Ls),n1=p(Ls),y(Fn.$$.fragment,Ls),Ls.forEach(t),Ot.forEach(t),gm=p(o),To=s(o,"H2",{class:!0});var _u=a(To);xn=s(_u,"A",{id:!0,class:!0,href:!0});var pF=a(xn);Xc=s(pF,"SPAN",{});var hF=a(Xc);y(Qa.$$.fragment,hF),hF.forEach(t),pF.forEach(t),s1=p(_u),Pc=s(_u,"SPAN",{});var mF=a(Pc);a1=i(mF,"XLMRobertaForTokenClassification"),mF.forEach(t),_u.forEach(t),_m=p(o),Ye=s(o,"DIV",{class:!0});var Nt=a(Ye);y(Ha.$$.fragment,Nt),r1=p(Nt),Ac=s(Nt,"P",{});var uF=a(Ac);i1=i(uF,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),uF.forEach(t),l1=p(Nt),Va=s(Nt,"P",{});var bu=a(Va);d1=i(bu,"This model inherits from "),Hl=s(bu,"A",{href:!0});var fF=a(Hl);c1=i(fF,"PreTrainedModel"),fF.forEach(t),p1=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bu.forEach(t),h1=p(Nt),Ja=s(Nt,"P",{});var ku=a(Ja);m1=i(ku,"This model is also a PyTorch "),Ka=s(ku,"A",{href:!0,rel:!0});var gF=a(Ka);u1=i(gF,"torch.nn.Module"),gF.forEach(t),f1=i(ku,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ku.forEach(t),g1=p(Nt),Ga=s(Nt,"P",{});var vu=a(Ga);_1=i(vu,"This class overrides "),Vl=s(vu,"A",{href:!0});var _F=a(Vl);b1=i(_F,"RobertaForTokenClassification"),_F.forEach(t),k1=i(vu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),vu.forEach(t),v1=p(Nt),it=s(Nt,"DIV",{class:!0});var eo=a(it);y(Ya.$$.fragment,eo),T1=p(eo),yo=s(eo,"P",{});var Pd=a(yo);y1=i(Pd,"The "),Jl=s(Pd,"A",{href:!0});var bF=a(Jl);w1=i(bF,"RobertaForTokenClassification"),bF.forEach(t),$1=i(Pd," forward method, overrides the "),Oc=s(Pd,"CODE",{});var kF=a(Oc);M1=i(kF,"__call__"),kF.forEach(t),F1=i(Pd," special method."),Pd.forEach(t),x1=p(eo),y(Rn.$$.fragment,eo),R1=p(eo),y(Ln.$$.fragment,eo),L1=p(eo),y(En.$$.fragment,eo),eo.forEach(t),Nt.forEach(t),bm=p(o),wo=s(o,"H2",{class:!0});var Tu=a(wo);zn=s(Tu,"A",{id:!0,class:!0,href:!0});var vF=a(zn);Nc=s(vF,"SPAN",{});var TF=a(Nc);y(Za.$$.fragment,TF),TF.forEach(t),vF.forEach(t),E1=p(Tu),Ic=s(Tu,"SPAN",{});var yF=a(Ic);z1=i(yF,"XLMRobertaForQuestionAnswering"),yF.forEach(t),Tu.forEach(t),km=p(o),Ze=s(o,"DIV",{class:!0});var It=a(Ze);y(er.$$.fragment,It),q1=p(It),$o=s(It,"P",{});var Ad=a($o);C1=i(Ad,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Dc=s(Ad,"CODE",{});var wF=a(Dc);j1=i(wF,"span start logits"),wF.forEach(t),X1=i(Ad," and "),Sc=s(Ad,"CODE",{});var $F=a(Sc);P1=i($F,"span end logits"),$F.forEach(t),A1=i(Ad,")."),Ad.forEach(t),O1=p(It),tr=s(It,"P",{});var yu=a(tr);N1=i(yu,"This model inherits from "),Kl=s(yu,"A",{href:!0});var MF=a(Kl);I1=i(MF,"PreTrainedModel"),MF.forEach(t),D1=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),S1=p(It),or=s(It,"P",{});var wu=a(or);W1=i(wu,"This model is also a PyTorch "),nr=s(wu,"A",{href:!0,rel:!0});var FF=a(nr);B1=i(FF,"torch.nn.Module"),FF.forEach(t),U1=i(wu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wu.forEach(t),Q1=p(It),sr=s(It,"P",{});var $u=a(sr);H1=i($u,"This class overrides "),Gl=s($u,"A",{href:!0});var xF=a(Gl);V1=i(xF,"RobertaForQuestionAnswering"),xF.forEach(t),J1=i($u,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),$u.forEach(t),K1=p(It),lt=s(It,"DIV",{class:!0});var to=a(lt);y(ar.$$.fragment,to),G1=p(to),Mo=s(to,"P",{});var Od=a(Mo);Y1=i(Od,"The "),Yl=s(Od,"A",{href:!0});var RF=a(Yl);Z1=i(RF,"RobertaForQuestionAnswering"),RF.forEach(t),ek=i(Od," forward method, overrides the "),Wc=s(Od,"CODE",{});var LF=a(Wc);tk=i(LF,"__call__"),LF.forEach(t),ok=i(Od," special method."),Od.forEach(t),nk=p(to),y(qn.$$.fragment,to),sk=p(to),y(Cn.$$.fragment,to),ak=p(to),y(jn.$$.fragment,to),to.forEach(t),It.forEach(t),vm=p(o),Fo=s(o,"H2",{class:!0});var Mu=a(Fo);Xn=s(Mu,"A",{id:!0,class:!0,href:!0});var EF=a(Xn);Bc=s(EF,"SPAN",{});var zF=a(Bc);y(rr.$$.fragment,zF),zF.forEach(t),EF.forEach(t),rk=p(Mu),Uc=s(Mu,"SPAN",{});var qF=a(Uc);ik=i(qF,"TFXLMRobertaModel"),qF.forEach(t),Mu.forEach(t),Tm=p(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(ir.$$.fragment,ut),lk=p(ut),Qc=s(ut,"P",{});var CF=a(Qc);dk=i(CF,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),CF.forEach(t),ck=p(ut),lr=s(ut,"P",{});var Fu=a(lr);pk=i(Fu,"This model inherits from "),Zl=s(Fu,"A",{href:!0});var jF=a(Zl);hk=i(jF,"TFPreTrainedModel"),jF.forEach(t),mk=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fu.forEach(t),uk=p(ut),dr=s(ut,"P",{});var xu=a(dr);fk=i(xu,"This model is also a "),cr=s(xu,"A",{href:!0,rel:!0});var XF=a(cr);gk=i(XF,"tf.keras.Model"),XF.forEach(t),_k=i(xu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xu.forEach(t),bk=p(ut),y(Pn.$$.fragment,ut),kk=p(ut),pr=s(ut,"P",{});var Ru=a(pr);vk=i(Ru,"This class overrides "),ed=s(Ru,"A",{href:!0});var PF=a(ed);Tk=i(PF,"TFRobertaModel"),PF.forEach(t),yk=i(Ru,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Ru.forEach(t),wk=p(ut),Ft=s(ut,"DIV",{class:!0});var Es=a(Ft);y(hr.$$.fragment,Es),$k=p(Es),xo=s(Es,"P",{});var Nd=a(xo);Mk=i(Nd,"The "),td=s(Nd,"A",{href:!0});var AF=a(td);Fk=i(AF,"TFRobertaModel"),AF.forEach(t),xk=i(Nd," forward method, overrides the "),Hc=s(Nd,"CODE",{});var OF=a(Hc);Rk=i(OF,"__call__"),OF.forEach(t),Lk=i(Nd," special method."),Nd.forEach(t),Ek=p(Es),y(An.$$.fragment,Es),zk=p(Es),y(On.$$.fragment,Es),Es.forEach(t),ut.forEach(t),ym=p(o),Ro=s(o,"H2",{class:!0});var Lu=a(Ro);Nn=s(Lu,"A",{id:!0,class:!0,href:!0});var NF=a(Nn);Vc=s(NF,"SPAN",{});var IF=a(Vc);y(mr.$$.fragment,IF),IF.forEach(t),NF.forEach(t),qk=p(Lu),Jc=s(Lu,"SPAN",{});var DF=a(Jc);Ck=i(DF,"TFXLMRobertaForMaskedLM"),DF.forEach(t),Lu.forEach(t),wm=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(ur.$$.fragment,ft),jk=p(ft),fr=s(ft,"P",{});var Eu=a(fr);Xk=i(Eu,"XLM-RoBERTa Model with a "),Kc=s(Eu,"CODE",{});var SF=a(Kc);Pk=i(SF,"language modeling"),SF.forEach(t),Ak=i(Eu," head on top."),Eu.forEach(t),Ok=p(ft),gr=s(ft,"P",{});var zu=a(gr);Nk=i(zu,"This model inherits from "),od=s(zu,"A",{href:!0});var WF=a(od);Ik=i(WF,"TFPreTrainedModel"),WF.forEach(t),Dk=i(zu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zu.forEach(t),Sk=p(ft),_r=s(ft,"P",{});var qu=a(_r);Wk=i(qu,"This model is also a "),br=s(qu,"A",{href:!0,rel:!0});var BF=a(br);Bk=i(BF,"tf.keras.Model"),BF.forEach(t),Uk=i(qu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qu.forEach(t),Qk=p(ft),y(In.$$.fragment,ft),Hk=p(ft),kr=s(ft,"P",{});var Cu=a(kr);Vk=i(Cu,"This class overrides "),nd=s(Cu,"A",{href:!0});var UF=a(nd);Jk=i(UF,"TFRobertaForMaskedLM"),UF.forEach(t),Kk=i(Cu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Cu.forEach(t),Gk=p(ft),dt=s(ft,"DIV",{class:!0});var oo=a(dt);y(vr.$$.fragment,oo),Yk=p(oo),Lo=s(oo,"P",{});var Id=a(Lo);Zk=i(Id,"The "),sd=s(Id,"A",{href:!0});var QF=a(sd);ev=i(QF,"TFRobertaForMaskedLM"),QF.forEach(t),tv=i(Id," forward method, overrides the "),Gc=s(Id,"CODE",{});var HF=a(Gc);ov=i(HF,"__call__"),HF.forEach(t),nv=i(Id," special method."),Id.forEach(t),sv=p(oo),y(Dn.$$.fragment,oo),av=p(oo),y(Sn.$$.fragment,oo),rv=p(oo),y(Wn.$$.fragment,oo),oo.forEach(t),ft.forEach(t),$m=p(o),Eo=s(o,"H2",{class:!0});var ju=a(Eo);Bn=s(ju,"A",{id:!0,class:!0,href:!0});var VF=a(Bn);Yc=s(VF,"SPAN",{});var JF=a(Yc);y(Tr.$$.fragment,JF),JF.forEach(t),VF.forEach(t),iv=p(ju),Zc=s(ju,"SPAN",{});var KF=a(Zc);lv=i(KF,"TFXLMRobertaForSequenceClassification"),KF.forEach(t),ju.forEach(t),Mm=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(yr.$$.fragment,gt),dv=p(gt),ep=s(gt,"P",{});var GF=a(ep);cv=i(GF,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
