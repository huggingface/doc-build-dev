import{S as zd,i as Fd,s as xd,e as n,k as h,w as y,t as i,M as Cd,c as s,d as t,m as g,a,x as w,h as d,b as p,G as e,g as b,y as k,q as B,o as T,B as $,v as Ed,L as V}from"../../chunks/vendor-316217a5.js";import{T as rs}from"../../chunks/Tip-27e9fea0.js";import{D as Q}from"../../chunks/Docstring-1fe4a33a.js";import{C as J}from"../../chunks/CodeBlock-8418a95e.js";import{I as G}from"../../chunks/IconCopyLink-40460835.js";import{E as K}from"../../chunks/ExampleCodeBlock-32fc0037.js";function Md(P){let l,_,c,u,v;return u=new J({props:{code:"",highlighted:""}}),{c(){l=n("p"),_=i("Example:"),c=h(),y(u.$$.fragment)},l(r){l=s(r,"P",{});var m=a(l);_=d(m,"Example:"),m.forEach(t),c=g(r),w(u.$$.fragment,r)},m(r,m){b(r,l,m),e(l,_),b(r,c,m),k(u,r,m),v=!0},p:V,i(r){v||(B(u.$$.fragment,r),v=!0)},o(r){T(u.$$.fragment,r),v=!1},d(r){r&&t(l),r&&t(c),$(u,r)}}}function jd(P){let l,_,c,u,v;return{c(){l=n("p"),_=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=i("Module"),v=i(`
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17379/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_17379/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17379/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17379/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2516",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17379/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2787",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17379/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
