import{S as H_,i as K_,s as X_,e as s,k as p,w as v,t as n,M as Y_,c as r,d as t,m as u,a as i,x as y,h as a,b as l,F as e,g as m,y as b,q as L,o as w,B as k,v as Z_,L as pa}from"../../chunks/vendor-6b77c823.js";import{T as Ci}from"../../chunks/Tip-39098574.js";import{D as A}from"../../chunks/Docstring-1088f2fb.js";import{C as G}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ie}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as da}from"../../chunks/ExampleCodeBlock-5212b321.js";function J_(P){let h,T,_,g,x;return g=new G({props:{code:`from transformers import LayoutLMv2Model, LayoutLMv2Config
...
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var O=i(_);g=a(O,"Module"),O.forEach(t),x=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=s("p"),T=n("Examples:"),_=p(),v(g.$$.fragment)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Examples:"),f.forEach(t),_=u(d),y(g.$$.fragment,d)},m(d,f){m(d,h,f),e(h,T),m(d,_,f),b(g,d,f),x=!0},p:pa,i(d){x||(L(g.$$.fragment,d),x=!0)},o(d){w(g.$$.fragment,d),x=!1},d(d){d&&t(h),d&&t(_),k(g,d)}}}function cv(P){let h,T,_,g,x,d,f,O,ji,sr,xe,We,ua,Mo,Ii,ma,Ai,rr,pe,Oi,$o,Di,Ni,Jt,Si,Ri,ir,ue,H,Ui,Eo,Wi,Bi,zo,Vi,Qi,qo,Gi,Hi,Fo,Ki,Xi,Yi,Po,Zi,Co,Ji,el,ol,jo,tl,Io,nl,al,lr,en,sl,cr,on,ha,rl,dr,tn,il,pr,W,fa,ll,cl,Ao,dl,Oo,pl,ul,ml,Do,hl,No,fl,gl,_l,Te,vl,So,yl,bl,Ro,Ll,wl,kl,M,xl,ga,Tl,Ml,nn,$l,El,_a,zl,ql,va,Fl,Pl,ya,Cl,jl,ba,Il,Al,La,Ol,Dl,wa,Nl,Sl,ka,Rl,Ul,an,Wl,Bl,Uo,Vl,Ql,Wo,Gl,Hl,ur,Bo,mr,me,Kl,xa,Xl,Yl,Ta,Zl,Jl,hr,Vo,fr,Be,ec,sn,oc,tc,gr,he,I,nc,rn,ac,sc,Ma,rc,ic,$a,lc,cc,ln,dc,pc,Ea,uc,mc,za,hc,fc,qa,gc,_c,vc,Qo,yc,cn,bc,Lc,wc,Go,kc,Fa,xc,Tc,_r,Ve,Mc,dn,$c,Ec,vr,Me,Qe,Pa,Ho,zc,Ca,qc,yr,B,Fc,pn,Pc,Cc,un,jc,Ic,mn,Ac,Oc,hn,Dc,Nc,br,Ko,Lr,E,Sc,fn,Rc,Uc,gn,Wc,Bc,ja,Vc,Qc,_n,Gc,Hc,vn,Kc,Xc,Ia,Yc,Zc,Aa,Jc,ed,Oa,od,td,Da,nd,ad,Na,sd,rd,wr,R,yn,id,ld,Xo,cd,dd,bn,pd,ud,Sa,md,hd,Ra,fd,gd,kr,Ln,_d,xr,wn,Ua,vd,Tr,kn,yd,Mr,Yo,$r,xn,Wa,bd,Er,fe,Ld,Ba,wd,kd,Va,xd,Td,zr,Zo,qr,Tn,Qa,Md,Fr,V,$d,Ga,Ed,zd,Ha,qd,Fd,Ka,Pd,Cd,Xa,jd,Id,Pr,Jo,Cr,Mn,Ya,Ad,jr,$n,Od,Ir,et,Ar,En,Za,Dd,Or,zn,Nd,Dr,ot,Nr,$e,Ge,Ja,tt,Sd,es,Rd,Sr,K,nt,Ud,Ee,Wd,qn,Bd,Vd,at,Qd,Gd,Hd,ze,Kd,Fn,Xd,Yd,Pn,Zd,Jd,ep,He,Rr,qe,Ke,os,st,op,ts,tp,Ur,X,rt,np,ns,ap,sp,it,rp,as,ip,lp,cp,ge,lt,dp,ss,pp,up,Xe,Wr,Fe,Ye,rs,ct,mp,is,hp,Br,D,dt,fp,N,gp,Cn,_p,vp,ls,yp,bp,cs,Lp,wp,ds,kp,xp,ps,Tp,Mp,us,$p,Ep,zp,pt,qp,jn,Fp,Pp,Cp,In,An,jp,Ip,Ap,Ze,ut,Op,ms,Dp,Np,On,mt,Vr,Pe,Je,hs,ht,Sp,fs,Rp,Qr,Y,ft,Up,gt,Wp,gs,Bp,Vp,Qp,_t,Gp,Dn,Hp,Kp,Xp,eo,vt,Yp,_s,Zp,Gr,Ce,oo,vs,yt,Jp,ys,eu,Hr,U,bt,ou,bs,tu,nu,Nn,Sn,au,su,ru,F,iu,Rn,lu,cu,Un,du,pu,Wn,uu,mu,Ls,hu,fu,ws,gu,_u,ks,vu,yu,xs,bu,Lu,Ts,wu,ku,Ms,xu,Tu,Mu,_e,Lt,$u,$,Eu,$s,zu,qu,wt,Es,Fu,Pu,Cu,Bn,ju,Iu,zs,Au,Ou,qs,Du,Nu,kt,Fs,Su,Ru,Uu,Ps,Wu,Bu,Vn,Vu,Qu,Cs,Gu,Hu,js,Ku,Xu,Is,Yu,Zu,As,Ju,em,om,Os,tm,Kr,je,to,Ds,xt,nm,Ns,am,Xr,le,Tt,sm,Mt,rm,$t,im,lm,cm,te,Et,dm,Ie,pm,Qn,um,mm,Ss,hm,fm,gm,no,_m,ao,Yr,Ae,so,Rs,zt,vm,Us,ym,Zr,Z,qt,bm,Ft,Lm,Pt,wm,km,xm,Ct,Tm,jt,Mm,$m,Em,ne,It,zm,Oe,qm,Gn,Fm,Pm,Ws,Cm,jm,Im,ro,Am,io,Jr,De,lo,Bs,At,Om,Vs,Dm,ei,J,Ot,Nm,ee,Sm,Dt,Rm,Um,Nt,Wm,Bm,St,Vm,Qm,Rt,Gm,Hm,Km,Ut,Xm,Wt,Ym,Zm,Jm,ae,Bt,eh,Ne,oh,Hn,th,nh,Qs,ah,sh,rh,co,ih,po,oi,Se,uo,Gs,Vt,lh,Hs,ch,ti,oe,Qt,dh,ce,ph,Gt,uh,mh,Ks,hh,fh,Xs,gh,_h,vh,Ht,yh,Kt,bh,Lh,wh,se,Xt,kh,Re,xh,Kn,Th,Mh,Ys,$h,Eh,zh,mo,qh,ho,ni;return d=new ie({}),Mo=new ie({}),Bo=new G({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Model">LayoutLMv2Model</a> or
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
...
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LayoutLMv2Tokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16919/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L365"}}),mt=new A({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L345"}}),ht=new ie({}),ft=new A({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),Lt=new A({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),xt=new ie({}),Tt=new A({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L708"}}),Et=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_16919/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L953"}}),It=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_16919/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16919/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L967",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1136",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1245",returnDescription:`
<p>A <a
...
`}}),mo=new Ci({props:{$$slots:{default:[iv]},$$scope:{ctx:P}}}),ho=new da({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[lv]},$$scope:{ctx:P}}}),{c(){h=s("meta"),T=p(),_=s("h1"),g=s("a"),x=s("span"),v(d.$$.fragment),f=p(),O=s("span"),ji=n("LayoutLMV2"),sr=p(),xe=s("h2"),We=s("a"),ua=s("span"),v(Mo.$$.fragment),Ii=p(),ma=s("span"),Ai=n("Overview"),rr=p(),pe=s("p"),Oi=n("The LayoutLMV2 model was proposed in "),$o=s("a"),Di=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ni=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
...
documents for testing).`),Yi=p(),Po=s("li"),Zi=n("document image classification: the "),Co=s("a"),Ji=n("RVL-CDIP"),el=n(` dataset (a collection of
400,000 images belonging to one of 16 classes).`),ol=p(),jo=s("li"),tl=n("document visual question answering: the "),Io=s("a"),nl=n("DocVQA"),al=n(` dataset (a collection of 50,000
...
the self-attention layers. Details can be found on page 5 of the `),Oo=s("a"),pl=n("paper"),ul=n("."),ml=p(),Do=s("li"),hl=n("Demo notebooks on how to use the LayoutLMv2 model on RVL-CDIP, FUNSD, DocVQA, CORD can be found "),No=s("a"),fl=n("here"),gl=n("."),_l=p(),Te=s("li"),vl=n("LayoutLMv2 uses Facebook AI\u2019s "),So=s("a"),yl=n("Detectron2"),bl=n(` package for its visual
...
`),dn=s("a"),$c=n("LayoutXLM\u2019s documentation page"),Ec=n("."),vr=p(),Me=s("h2"),Qe=s("a"),Pa=s("span"),v(Ho.$$.fragment),zc=p(),Ca=s("span"),qc=n("Usage: LayoutLMv2Processor"),yr=p(),B=s("p"),Fc=n("The easiest way to prepare data for the model is to use "),pn=s("a"),Pc=n("LayoutLMv2Processor"),Cc=n(`, which internally
combines a feature extractor (`),un=s("a"),jc=n("LayoutLMv2FeatureExtractor"),Ic=n(`) and a tokenizer
(`),mn=s("a"),Ac=n("LayoutLMv2Tokenizer"),Oc=n(" or "),hn=s("a"),Dc=n("LayoutLMv2TokenizerFast"),Nc=n(`). The feature extractor
...
initialize the tokenizer with `),Ka=s("code"),Pd=n("only_label_first_subword"),Cd=n(" set to "),Xa=s("code"),jd=n("False"),Id=n("."),Pr=p(),v(Jo.$$.fragment),Cr=p(),Mn=s("p"),Ya=s("strong"),Ad=n("Use case 4: visual question answering (inference), apply_ocr=True"),jr=p(),$n=s("p"),Od=n(`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. By default, the
processor will apply OCR on the image, and create [CLS] question tokens [SEP] word tokens [SEP].`),Ir=p(),v(et.$$.fragment),Ar=p(),En=s("p"),Za=s("strong"),Dd=n("Use case 5: visual question answering (inference), apply_ocr=False"),Or=p(),zn=s("p"),Nd=n(`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. If you want to
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Dr=p(),v(ot.$$.fragment),Nr=p(),$e=s("h2"),Ge=s("a"),Ja=s("span"),v(tt.$$.fragment),Sd=p(),es=s("span"),Rd=n("LayoutLMv2Config"),Sr=p(),K=s("div"),v(nt.$$.fragment),Ud=p(),Ee=s("p"),Wd=n("This is the configuration class to store the configuration of a "),qn=s("a"),Bd=n("LayoutLMv2Model"),Vd=n(`. It is used to instantiate an
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),cp=p(),ge=s("div"),v(lt.$$.fragment),dp=p(),ss=s("p"),pp=n("Main method to prepare for the model one or several image(s)."),up=p(),v(Xe.$$.fragment),Wr=p(),Fe=s("h2"),Ye=s("a"),rs=s("span"),v(ct.$$.fragment),mp=p(),is=s("span"),hp=n("LayoutLMv2Tokenizer"),Br=p(),D=s("div"),v(dt.$$.fragment),fp=p(),N=s("p"),gp=n("Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Cn=s("a"),_p=n("LayoutLMv2Tokenizer"),vp=n(` can be used to turn words, word-level
...
optional `),us=s("code"),$p=n("labels"),Ep=n(" (for token classification)."),zp=p(),pt=s("p"),qp=n("This tokenizer inherits from "),jn=s("a"),Fp=n("PreTrainedTokenizer"),Pp=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Cp=p(),In=s("p"),An=s("a"),jp=n("LayoutLMv2Tokenizer"),Ip=n(` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),Ap=p(),Ze=s("div"),v(ut.$$.fragment),Op=p(),ms=s("p"),Dp=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),Np=p(),On=s("div"),v(mt.$$.fragment),Vr=p(),Pe=s("h2"),Je=s("a"),hs=s("span"),v(ht.$$.fragment),Sp=p(),fs=s("span"),Rp=n("LayoutLMv2TokenizerFast"),Qr=p(),Y=s("div"),v(ft.$$.fragment),Up=p(),gt=s("p"),Wp=n("Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),gs=s("em"),Bp=n("tokenizers"),Vp=n(" library). Based on WordPiece."),Qp=p(),_t=s("p"),Gp=n("This tokenizer inherits from "),Dn=s("a"),Hp=n("PreTrainedTokenizerFast"),Kp=n(` which contains most of the main methods. Users should
...
sequences with word-level normalized bounding boxes and optional labels.`),Gr=p(),Ce=s("h2"),oo=s("a"),vs=s("span"),v(yt.$$.fragment),Jp=p(),ys=s("span"),eu=n("LayoutLMv2Processor"),Hr=p(),U=s("div"),v(bt.$$.fragment),ou=p(),bs=s("p"),tu=n(`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
...
into token-level `),Ms=s("code"),xu=n("labels"),Tu=n(" for token classification tasks (such as FUNSD, CORD)."),Mu=p(),_e=s("div"),v(Lt.$$.fragment),$u=p(),$=s("p"),Eu=n("This method first forwards the "),$s=s("code"),zu=n("images"),qu=n(" argument to "),wt=s("a"),Es=s("strong"),Fu=n("call"),Pu=n("()"),Cu=n(`. In case
`),Bn=s("a"),ju=n("LayoutLMv2FeatureExtractor"),Iu=n(" was initialized with "),zs=s("code"),Au=n("apply_ocr"),Ou=n(" set to "),qs=s("code"),Du=n("True"),Nu=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=s("a"),Fs=s("strong"),Su=n("call"),Ru=n("()"),Uu=n(` and returns the output,
together with resized `),Ps=s("code"),Wu=n("images"),Bu=n(". In case "),Vn=s("a"),Vu=n("LayoutLMv2FeatureExtractor"),Qu=n(" was initialized with "),Cs=s("code"),Gu=n("apply_ocr"),Hu=n(` set to
`),js=s("code"),Ku=n("False"),Xu=n(", it passes the words ("),Is=s("code"),Yu=n("text"),Zu=n("/"),As=s("code"),Ju=n("text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),em=n("."),om=p(),Os=s("p"),tm=n("Please refer to the docstring of the above two methods for more information."),Kr=p(),je=s("h2"),to=s("a"),Ds=s("span"),v(xt.$$.fragment),nm=p(),Ns=s("span"),am=n("LayoutLMv2Model"),Xr=p(),le=s("div"),v(Tt.$$.fragment),sm=p(),Mt=s("p"),rm=n(`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
...
`),Pt=s("a"),wm=n("RVL-CDIP"),km=n(" dataset."),xm=p(),Ct=s("p"),Tm=n("This model is a PyTorch "),jt=s("a"),Mm=n("torch.nn.Module"),$m=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Em=p(),ne=s("div"),v(It.$$.fragment),zm=p(),Oe=s("p"),qm=n("The "),Gn=s("a"),Fm=n("LayoutLMv2ForSequenceClassification"),Pm=n(" forward method, overrides the "),Ws=s("code"),Cm=n("__call__"),jm=n(" special method."),Im=p(),v(ro.$$.fragment),Am=p(),v(io.$$.fragment),Jr=p(),De=s("h2"),lo=s("a"),Bs=s("span"),v(At.$$.fragment),Om=p(),Vs=s("span"),Dm=n("LayoutLMv2ForTokenClassification"),ei=p(),J=s("div"),v(Ot.$$.fragment),Nm=p(),ee=s("p"),Sm=n(`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
`),Dt=s("a"),Rm=n("FUNSD"),Um=n(", "),Nt=s("a"),Wm=n("SROIE"),Bm=n(`,
...
collection of 199 annotated forms comprising more than 30,000 words), the `),zo=r(ve,"A",{href:!0,rel:!0});var Oh=i(zo);Vi=a(Oh,"CORD"),Oh.forEach(t),Qi=a(ve,`
dataset (a collection of 800 receipts for training, 100 for validation and 100 for testing), the `),qo=r(ve,"A",{href:!0,rel:!0});var Dh=i(qo);Gi=a(Dh,"SROIE"),Dh.forEach(t),Hi=a(ve,` dataset (a collection of 626 receipts for training and 347 receipts for testing)
...
agreements from the EDGAR database, including 254 documents for training, 83 documents for validation, and 203
documents for testing).`),ve.forEach(t),Yi=u(Xn),Po=r(Xn,"LI",{});var ai=i(Po);Zi=a(ai,"document image classification: the "),Co=r(ai,"A",{href:!0,rel:!0});var Sh=i(Co);Ji=a(Sh,"RVL-CDIP"),Sh.forEach(t),el=a(ai,` dataset (a collection of
400,000 images belonging to one of 16 classes).`),ai.forEach(t),ol=u(Xn),jo=r(Xn,"LI",{});var si=i(jo);tl=a(si,"document visual question answering: the "),Io=r(si,"A",{href:!0,rel:!0});var Rh=i(Io);nl=a(Rh,"DocVQA"),Rh.forEach(t),al=a(si,` dataset (a collection of 50,000
...
the self-attention layers. Details can be found on page 5 of the `),Oo=r(ri,"A",{href:!0,rel:!0});var Gh=i(Oo);pl=a(Gh,"paper"),Gh.forEach(t),ul=a(ri,"."),ri.forEach(t),ml=u(ye),Do=r(ye,"LI",{});var ii=i(Do);hl=a(ii,"Demo notebooks on how to use the LayoutLMv2 model on RVL-CDIP, FUNSD, DocVQA, CORD can be found "),No=r(ii,"A",{href:!0,rel:!0});var Hh=i(No);fl=a(Hh,"here"),Hh.forEach(t),gl=a(ii,"."),ii.forEach(t),_l=u(ye),Te=r(ye,"LI",{});var Yn=i(Te);vl=a(Yn,"LayoutLMv2 uses Facebook AI\u2019s "),So=r(Yn,"A",{href:!0,rel:!0});var Kh=i(So);yl=a(Kh,"Detectron2"),Kh.forEach(t),bl=a(Yn,` package for its visual
...
`),_a=r(z,"CODE",{});var Jh=i(_a);zl=a(Jh,"image"),Jh.forEach(t),ql=a(z," and "),va=r(z,"CODE",{});var ef=i(va);Fl=a(ef,"bbox"),ef.forEach(t),Pl=a(z,". The "),ya=r(z,"CODE",{});var of=i(ya);Cl=a(of,"image"),of.forEach(t),jl=a(z,` input corresponds to the original document image in which the text
tokens occur. The model expects each document image to be of size 224x224. This means that if you have a batch of
...
`),dn=r(pi,"A",{href:!0});var wf=i(dn);$c=a(wf,"LayoutXLM\u2019s documentation page"),wf.forEach(t),Ec=a(pi,"."),pi.forEach(t),vr=u(o),Me=r(o,"H2",{class:!0});var ui=i(Me);Qe=r(ui,"A",{id:!0,class:!0,href:!0});var kf=i(Qe);Pa=r(kf,"SPAN",{});var xf=i(Pa);y(Ho.$$.fragment,xf),xf.forEach(t),kf.forEach(t),zc=u(ui),Ca=r(ui,"SPAN",{});var Tf=i(Ca);qc=a(Tf,"Usage: LayoutLMv2Processor"),Tf.forEach(t),ui.forEach(t),yr=u(o),B=r(o,"P",{});var be=i(B);Fc=a(be,"The easiest way to prepare data for the model is to use "),pn=r(be,"A",{href:!0});var Mf=i(pn);Pc=a(Mf,"LayoutLMv2Processor"),Mf.forEach(t),Cc=a(be,`, which internally
combines a feature extractor (`),un=r(be,"A",{href:!0});var $f=i(un);jc=a($f,"LayoutLMv2FeatureExtractor"),$f.forEach(t),Ic=a(be,`) and a tokenizer
(`),mn=r(be,"A",{href:!0});var Ef=i(mn);Ac=a(Ef,"LayoutLMv2Tokenizer"),Ef.forEach(t),Oc=a(be," or "),hn=r(be,"A",{href:!0});var zf=i(hn);Dc=a(zf,"LayoutLMv2TokenizerFast"),zf.forEach(t),Nc=a(be,`). The feature extractor
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),be.forEach(t),br=u(o),y(Ko.$$.fragment,o),Lr=u(o),E=r(o,"P",{});var C=i(E);Sc=a(C,"In short, one can provide a document image (and possibly additional data) to "),fn=r(C,"A",{href:!0});var qf=i(fn);Rc=a(qf,"LayoutLMv2Processor"),qf.forEach(t),Uc=a(C,`,
and it will create the inputs expected by the model. Internally, the processor first uses
...
which are turned into token-level `),Na=r(C,"CODE",{});var Nf=i(Na);sd=a(Nf,"labels"),Nf.forEach(t),rd=a(C,"."),C.forEach(t),wr=u(o),R=r(o,"P",{});var de=i(R);yn=r(de,"A",{href:!0});var Sf=i(yn);id=a(Sf,"LayoutLMv2Processor"),Sf.forEach(t),ld=a(de," uses "),Xo=r(de,"A",{href:!0,rel:!0});var Rf=i(Xo);cd=a(Rf,"PyTesseract"),Rf.forEach(t),dd=a(de,`, a Python
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
...
initialize the tokenizer with `),Ka=r(Le,"CODE",{});var ng=i(Ka);Pd=a(ng,"only_label_first_subword"),ng.forEach(t),Cd=a(Le," set to "),Xa=r(Le,"CODE",{});var ag=i(Xa);jd=a(ag,"False"),ag.forEach(t),Id=a(Le,"."),Le.forEach(t),Pr=u(o),y(Jo.$$.fragment,o),Cr=u(o),Mn=r(o,"P",{});var sg=i(Mn);Ya=r(sg,"STRONG",{});var rg=i(Ya);Ad=a(rg,"Use case 4: visual question answering (inference), apply_ocr=True"),rg.forEach(t),sg.forEach(t),jr=u(o),$n=r(o,"P",{});var ig=i($n);Od=a(ig,`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. By default, the
processor will apply OCR on the image, and create [CLS] question tokens [SEP] word tokens [SEP].`),ig.forEach(t),Ir=u(o),y(et.$$.fragment,o),Ar=u(o),En=r(o,"P",{});var lg=i(En);Za=r(lg,"STRONG",{});var cg=i(Za);Dd=a(cg,"Use case 5: visual question answering (inference), apply_ocr=False"),cg.forEach(t),lg.forEach(t),Or=u(o),zn=r(o,"P",{});var dg=i(zn);Nd=a(dg,`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. If you want to
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),dg.forEach(t),Dr=u(o),y(ot.$$.fragment,o),Nr=u(o),$e=r(o,"H2",{class:!0});var mi=i($e);Ge=r(mi,"A",{id:!0,class:!0,href:!0});var pg=i(Ge);Ja=r(pg,"SPAN",{});var ug=i(Ja);y(tt.$$.fragment,ug),ug.forEach(t),pg.forEach(t),Sd=u(mi),es=r(mi,"SPAN",{});var mg=i(es);Rd=a(mg,"LayoutLMv2Config"),mg.forEach(t),mi.forEach(t),Sr=u(o),K=r(o,"DIV",{class:!0});var fo=i(K);y(nt.$$.fragment,fo),Ud=u(fo),Ee=r(fo,"P",{});var oa=i(Ee);Wd=a(oa,"This is the configuration class to store the configuration of a "),qn=r(oa,"A",{href:!0});var hg=i(qn);Bd=a(hg,"LayoutLMv2Model"),hg.forEach(t),Vd=a(oa,`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),fi.forEach(t),cp=u(go),ge=r(go,"DIV",{class:!0});var na=i(ge);y(lt.$$.fragment,na),dp=u(na),ss=r(na,"P",{});var kg=i(ss);pp=a(kg,"Main method to prepare for the model one or several image(s)."),kg.forEach(t),up=u(na),y(Xe.$$.fragment,na),na.forEach(t),go.forEach(t),Wr=u(o),Fe=r(o,"H2",{class:!0});var gi=i(Fe);Ye=r(gi,"A",{id:!0,class:!0,href:!0});var xg=i(Ye);rs=r(xg,"SPAN",{});var Tg=i(rs);y(ct.$$.fragment,Tg),Tg.forEach(t),xg.forEach(t),mp=u(gi),is=r(gi,"SPAN",{});var Mg=i(is);hp=a(Mg,"LayoutLMv2Tokenizer"),Mg.forEach(t),gi.forEach(t),Br=u(o),D=r(o,"DIV",{class:!0});var re=i(D);y(dt.$$.fragment,re),fp=u(re),N=r(re,"P",{});var Q=i(N);gp=a(Q,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Cn=r(Q,"A",{href:!0});var $g=i(Cn);_p=a($g,"LayoutLMv2Tokenizer"),$g.forEach(t),vp=a(Q,` can be used to turn words, word-level
...
optional `),us=r(Q,"CODE",{});var Pg=i(us);$p=a(Pg,"labels"),Pg.forEach(t),Ep=a(Q," (for token classification)."),Q.forEach(t),zp=u(re),pt=r(re,"P",{});var _i=i(pt);qp=a(_i,"This tokenizer inherits from "),jn=r(_i,"A",{href:!0});var Cg=i(jn);Fp=a(Cg,"PreTrainedTokenizer"),Cg.forEach(t),Pp=a(_i,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),_i.forEach(t),Cp=u(re),In=r(re,"P",{});var Fh=i(In);An=r(Fh,"A",{href:!0});var jg=i(An);jp=a(jg,"LayoutLMv2Tokenizer"),jg.forEach(t),Ip=a(Fh,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),Fh.forEach(t),Ap=u(re),Ze=r(re,"DIV",{class:!0});var vi=i(Ze);y(ut.$$.fragment,vi),Op=u(vi),ms=r(vi,"P",{});var Ig=i(ms);Dp=a(Ig,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),Ig.forEach(t),vi.forEach(t),Np=u(re),On=r(re,"DIV",{class:!0});var Ag=i(On);y(mt.$$.fragment,Ag),Ag.forEach(t),re.forEach(t),Vr=u(o),Pe=r(o,"H2",{class:!0});var yi=i(Pe);Je=r(yi,"A",{id:!0,class:!0,href:!0});var Og=i(Je);hs=r(Og,"SPAN",{});var Dg=i(hs);y(ht.$$.fragment,Dg),Dg.forEach(t),Og.forEach(t),Sp=u(yi),fs=r(yi,"SPAN",{});var Ng=i(fs);Rp=a(Ng,"LayoutLMv2TokenizerFast"),Ng.forEach(t),yi.forEach(t),Qr=u(o),Y=r(o,"DIV",{class:!0});var _o=i(Y);y(ft.$$.fragment,_o),Up=u(_o),gt=r(_o,"P",{});var bi=i(gt);Wp=a(bi,"Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),gs=r(bi,"EM",{});var Sg=i(gs);Bp=a(Sg,"tokenizers"),Sg.forEach(t),Vp=a(bi," library). Based on WordPiece."),bi.forEach(t),Qp=u(_o),_t=r(_o,"P",{});var Li=i(_t);Gp=a(Li,"This tokenizer inherits from "),Dn=r(Li,"A",{href:!0});var Rg=i(Dn);Hp=a(Rg,"PreTrainedTokenizerFast"),Rg.forEach(t),Kp=a(Li,` which contains most of the main methods. Users should
...
sequences with word-level normalized bounding boxes and optional labels.`),Ug.forEach(t),wi.forEach(t),_o.forEach(t),Gr=u(o),Ce=r(o,"H2",{class:!0});var ki=i(Ce);oo=r(ki,"A",{id:!0,class:!0,href:!0});var Wg=i(oo);vs=r(Wg,"SPAN",{});var Bg=i(vs);y(yt.$$.fragment,Bg),Bg.forEach(t),Wg.forEach(t),Jp=u(ki),ys=r(ki,"SPAN",{});var Vg=i(ys);eu=a(Vg,"LayoutLMv2Processor"),Vg.forEach(t),ki.forEach(t),Hr=u(o),U=r(o,"DIV",{class:!0});var we=i(U);y(bt.$$.fragment,we),ou=u(we),bs=r(we,"P",{});var Qg=i(bs);tu=a(Qg,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),Qg.forEach(t),nu=u(we),Nn=r(we,"P",{});var Ph=i(Nn);Sn=r(Ph,"A",{href:!0});var Gg=i(Sn);au=a(Gg,"LayoutLMv2Processor"),Gg.forEach(t),su=a(Ph," offers all the functionalities you need to prepare data for the model."),Ph.forEach(t),ru=u(we),F=r(we,"P",{});var j=i(F);iu=a(j,"It first uses "),Rn=r(j,"A",{href:!0});var Hg=i(Rn);lu=a(Hg,"LayoutLMv2FeatureExtractor"),Hg.forEach(t),cu=a(j,` to resize document images to a fixed size, and optionally applies OCR
to get words and normalized bounding boxes. These are then provided to `),Un=r(j,"A",{href:!0});var Kg=i(Un);du=a(Kg,"LayoutLMv2Tokenizer"),Kg.forEach(t),pu=a(j,` or
`),Wn=r(j,"A",{href:!0});var Xg=i(Wn);uu=a(Xg,"LayoutLMv2TokenizerFast"),Xg.forEach(t),mu=a(j,", which turns the words and bounding boxes into token-level "),Ls=r(j,"CODE",{});var Yg=i(Ls);hu=a(Yg,"input_ids"),Yg.forEach(t),fu=a(j,`,
`),ws=r(j,"CODE",{});var Zg=i(ws);gu=a(Zg,"attention_mask"),Zg.forEach(t),_u=a(j,", "),ks=r(j,"CODE",{});var Jg=i(ks);vu=a(Jg,"token_type_ids"),Jg.forEach(t),yu=a(j,", "),xs=r(j,"CODE",{});var e_=i(xs);bu=a(e_,"bbox"),e_.forEach(t),Lu=a(j,". Optionally, one can provide integer "),Ts=r(j,"CODE",{});var o_=i(Ts);wu=a(o_,"word_labels"),o_.forEach(t),ku=a(j,`, which are turned
into token-level `),Ms=r(j,"CODE",{});var t_=i(Ms);xu=a(t_,"labels"),t_.forEach(t),Tu=a(j," for token classification tasks (such as FUNSD, CORD)."),j.forEach(t),Mu=u(we),_e=r(we,"DIV",{class:!0});var aa=i(_e);y(Lt.$$.fragment,aa),$u=u(aa),$=r(aa,"P",{});var q=i($);Eu=a(q,"This method first forwards the "),$s=r(q,"CODE",{});var n_=i($s);zu=a(n_,"images"),n_.forEach(t),qu=a(q," argument to "),wt=r(q,"A",{href:!0});var Ch=i(wt);Es=r(Ch,"STRONG",{});var a_=i(Es);Fu=a(a_,"call"),a_.forEach(t),Pu=a(Ch,"()"),Ch.forEach(t),Cu=a(q,`. In case
`),Bn=r(q,"A",{href:!0});var s_=i(Bn);ju=a(s_,"LayoutLMv2FeatureExtractor"),s_.forEach(t),Iu=a(q," was initialized with "),zs=r(q,"CODE",{});var r_=i(zs);Au=a(r_,"apply_ocr"),r_.forEach(t),Ou=a(q," set to "),qs=r(q,"CODE",{});var i_=i(qs);Du=a(i_,"True"),i_.forEach(t),Nu=a(q,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=r(q,"A",{href:!0});var jh=i(kt);Fs=r(jh,"STRONG",{});var l_=i(Fs);Su=a(l_,"call"),l_.forEach(t),Ru=a(jh,"()"),jh.forEach(t),Uu=a(q,` and returns the output,
together with resized `),Ps=r(q,"CODE",{});var c_=i(Ps);Wu=a(c_,"images"),c_.forEach(t),Bu=a(q,". In case "),Vn=r(q,"A",{href:!0});var d_=i(Vn);Vu=a(d_,"LayoutLMv2FeatureExtractor"),d_.forEach(t),Qu=a(q," was initialized with "),Cs=r(q,"CODE",{});var p_=i(Cs);Gu=a(p_,"apply_ocr"),p_.forEach(t),Hu=a(q,` set to
`),js=r(q,"CODE",{});var u_=i(js);Ku=a(u_,"False"),u_.forEach(t),Xu=a(q,", it passes the words ("),Is=r(q,"CODE",{});var m_=i(Is);Yu=a(m_,"text"),m_.forEach(t),Zu=a(q,"/"),As=r(q,"CODE",{});var h_=i(As);Ju=a(h_,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_16919/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),h_.forEach(t),em=a(q,"."),q.forEach(t),om=u(aa),Os=r(aa,"P",{});var f_=i(Os);tm=a(f_,"Please refer to the docstring of the above two methods for more information."),f_.forEach(t),aa.forEach(t),we.forEach(t),Kr=u(o),je=r(o,"H2",{class:!0});var xi=i(je);to=r(xi,"A",{id:!0,class:!0,href:!0});var g_=i(to);Ds=r(g_,"SPAN",{});var __=i(Ds);y(xt.$$.fragment,__),__.forEach(t),g_.forEach(t),nm=u(xi),Ns=r(xi,"SPAN",{});var v_=i(Ns);am=a(v_,"LayoutLMv2Model"),v_.forEach(t),xi.forEach(t),Xr=u(o),le=r(o,"DIV",{class:!0});var sa=i(le);y(Tt.$$.fragment,sa),sm=u(sa),Mt=r(sa,"P",{});var Ti=i(Mt);rm=a(Ti,`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
...
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
`),Pt=r($i,"A",{href:!0,rel:!0});var T_=i(Pt);wm=a(T_,"RVL-CDIP"),T_.forEach(t),km=a($i," dataset."),$i.forEach(t),xm=u(yo),Ct=r(yo,"P",{});var Ei=i(Ct);Tm=a(Ei,"This model is a PyTorch "),jt=r(Ei,"A",{href:!0,rel:!0});var M_=i(jt);Mm=a(M_,"torch.nn.Module"),M_.forEach(t),$m=a(Ei,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Em=u(yo),ne=r(yo,"DIV",{class:!0});var bo=i(ne);y(It.$$.fragment,bo),zm=u(bo),Oe=r(bo,"P",{});var ia=i(Oe);qm=a(ia,"The "),Gn=r(ia,"A",{href:!0});var $_=i(Gn);Fm=a($_,"LayoutLMv2ForSequenceClassification"),$_.forEach(t),Pm=a(ia," forward method, overrides the "),Ws=r(ia,"CODE",{});var E_=i(Ws);Cm=a(E_,"__call__"),E_.forEach(t),jm=a(ia," special method."),ia.forEach(t),Im=u(bo),y(ro.$$.fragment,bo),Am=u(bo),y(io.$$.fragment,bo),bo.forEach(t),yo.forEach(t),Jr=u(o),De=r(o,"H2",{class:!0});var zi=i(De);lo=r(zi,"A",{id:!0,class:!0,href:!0});var z_=i(lo);Bs=r(z_,"SPAN",{});var q_=i(Bs);y(At.$$.fragment,q_),q_.forEach(t),z_.forEach(t),Om=u(zi),Vs=r(zi,"SPAN",{});var F_=i(Vs);Dm=a(F_,"LayoutLMv2ForTokenClassification"),F_.forEach(t),zi.forEach(t),ei=u(o),J=r(o,"DIV",{class:!0});var Lo=i(J);y(Ot.$$.fragment,Lo),Nm=u(Lo),ee=r(Lo,"P",{});var ke=i(ee);Sm=a(ke,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
`),Dt=r(ke,"A",{href:!0,rel:!0});var P_=i(Dt);Rm=a(P_,"FUNSD"),P_.forEach(t),Um=a(ke,", "),Nt=r(ke,"A",{href:!0,rel:!0});var C_=i(Nt);Wm=a(C_,"SROIE"),C_.forEach(t),Bm=a(ke,`,
`),St=r(ke,"A",{href:!0,rel:!0});var j_=i(St);Vm=a(j_,"CORD"),j_.forEach(t),Qm=a(ke," and "),Rt=r(ke,"A",{href:!0,rel:!0});var I_=i(Rt);Gm=a(I_,"Kleister-NDA"),I_.forEach(t),Hm=a(ke,"."),ke.forEach(t),Km=u(Lo),Ut=r(Lo,"P",{});var qi=i(Ut);Xm=a(qi,"This model is a PyTorch "),Wt=r(qi,"A",{href:!0,rel:!0});var A_=i(Wt);Ym=a(A_,"torch.nn.Module"),A_.forEach(t),Zm=a(qi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qi.forEach(t),Jm=u(Lo),ae=r(Lo,"DIV",{class:!0});var wo=i(ae);y(Bt.$$.fragment,wo),eh=u(wo),Ne=r(wo,"P",{});var la=i(Ne);oh=a(la,"The "),Hn=r(la,"A",{href:!0});var O_=i(Hn);th=a(O_,"LayoutLMv2ForTokenClassification"),O_.forEach(t),nh=a(la," forward method, overrides the "),Qs=r(la,"CODE",{});var D_=i(Qs);ah=a(D_,"__call__"),D_.forEach(t),sh=a(la," special method."),la.forEach(t),rh=u(wo),y(co.$$.fragment,wo),ih=u(wo),y(po.$$.fragment,wo),wo.forEach(t),Lo.forEach(t),oi=u(o),Se=r(o,"H2",{class:!0});var Fi=i(Se);uo=r(Fi,"A",{id:!0,class:!0,href:!0});var N_=i(uo);Gs=r(N_,"SPAN",{});var S_=i(Gs);y(Vt.$$.fragment,S_),S_.forEach(t),N_.forEach(t),lh=u(Fi),Hs=r(Fi,"SPAN",{});var R_=i(Hs);ch=a(R_,"LayoutLMv2ForQuestionAnswering"),R_.forEach(t),Fi.forEach(t),ti=u(o),oe=r(o,"DIV",{class:!0});var ko=i(oe);y(Qt.$$.fragment,ko),dh=u(ko),ce=r(ko,"P",{});var xo=i(ce);ph=a(xo,`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
