import{S as ds,i as cs,s as is,e as a,k as h,w as k,t as n,M as ls,c as s,d as o,m,a as c,x as E,h as t,b as l,F as e,g as b,y as S,q as x,o as $,B as T,v as ps,L as en}from"../../chunks/vendor-6b77c823.js";import{T as ss}from"../../chunks/Tip-39098574.js";import{D as ee}from"../../chunks/Docstring-1088f2fb.js";import{C as on}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Tn}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Xo}from"../../chunks/ExampleCodeBlock-5212b321.js";function hs(q){let i,v,u,p,g;return p=new on({props:{code:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),{c(){i=a("p"),v=n("Example:"),u=h(),k(p.$$.fragment)},l(d){i=s(d,"P",{});var f=c(i);v=t(f,"Example:"),f.forEach(o),u=m(d),E(p.$$.fragment,d)},m(d,f){b(d,i,f),e(i,v),b(d,u,f),S(p,d,f),g=!0},p:en,i(d){g||(x(p.$$.fragment,d),g=!0)},o(d){$(p.$$.fragment,d),g=!1},d(d){d&&o(i),d&&o(u),T(p,d)}}}function gs(q){let i,v,u,p,g;return{c(){i=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=n("Module"),g=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){i=s(d,"P",{});var f=c(i);v=t(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var N=c(u);p=t(N,"Module"),N.forEach(o),g=t(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_16919/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_16919/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L441",returnDescription:`
<p>A <a
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L631",returnDescription:`
<p>A <a
...
`),Qe=a("a"),Hn=n("Speech2Text2"),Gn=n("."),an=h(),R=a("h2"),oe=a("a"),To=a("span"),k(ve.$$.fragment),Jn=h(),Mo=a("span"),Yn=n("SpeechEncoderDecoderConfig"),sn=h(),j=a("div"),k(be.$$.fragment),Zn=h(),ne=a("p"),Xe=a("a"),Kn=n("SpeechEncoderDecoderConfig"),Qn=n(` is the configuration class to store the configuration of a
...
documentation from `),no=a("a"),at=n("PretrainedConfig"),st=n(" for more information."),dt=h(),k(te.$$.fragment),ct=h(),re=a("div"),k(ye.$$.fragment),it=h(),we=a("p"),lt=n("Instantiate a "),to=a("a"),pt=n("SpeechEncoderDecoderConfig"),ht=n(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),mt=h(),ae=a("div"),k(ke.$$.fragment),ft=h(),H=a("p"),ut=n("Serializes this instance to a Python dictionary. Override the default "),Do=a("em"),gt=n("to_dict()"),_t=n(" from "),jo=a("em"),vt=n("PretrainedConfig"),bt=n("."),dn=h(),G=a("h2"),se=a("a"),qo=a("span"),k(Ee.$$.fragment),yt=h(),Po=a("span"),wt=n("SpeechEncoderDecoderModel"),cn=h(),y=a("div"),k(Se.$$.fragment),kt=h(),J=a("p"),Et=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
...
:meth`),Co=a("em"),Kt=n("~transformers.AutoModelForCausalLM.from_pretrained"),Qt=n(" class method for the decoder."),Xt=h(),F=a("div"),k(Pe.$$.fragment),er=h(),Y=a("p"),or=n("The "),io=a("a"),nr=n("SpeechEncoderDecoderModel"),tr=n(" forward method, overrides the "),Ao=a("code"),rr=n("__call__"),ar=n(" special method."),sr=h(),k(de.$$.fragment),dr=h(),k(ce.$$.fragment),cr=h(),C=a("div"),k(ze.$$.fragment),ir=h(),Lo=a("p"),lr=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=a("code"),ur=n("model.train()"),gr=n("."),_r=h(),k(ie.$$.fragment),ln=h(),K=a("h2"),le=a("a"),Vo=a("span"),k(Fe.$$.fragment),vr=h(),Wo=a("span"),br=n("FlaxSpeechEncoderDecoderModel"),pn=h(),w=a("div"),k(Ce.$$.fragment),yr=h(),Q=a("p"),wr=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),lo=a("a"),kr=n("from_pretrained()"),Er=n(` function and the decoder is loaded via
...
encoder and :meth`),Ro=a("em"),Yr=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Zr=n(" class method for the decoder."),Kr=h(),A=a("div"),k(Be.$$.fragment),Qr=h(),X=a("p"),Xr=n("The "),fo=a("a"),ea=n("FlaxSpeechEncoderDecoderModel"),oa=n(" forward method, overrides the "),Uo=a("code"),na=n("__call__"),ta=n(" special method."),ra=h(),k(pe.$$.fragment),aa=h(),k(he.$$.fragment),sa=h(),B=a("div"),k(Re.$$.fragment),da=h(),Ho=a("p"),ca=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ia=h(),k(me.$$.fragment),this.h()},l(r){const _=ls('[data-svelte="svelte-1phssyn"]',document.head);i=s(_,"META",{name:!0,content:!0}),_.forEach(o),v=m(r),u=s(r,"H1",{class:!0});var Ue=c(u);p=s(Ue,"A",{id:!0,class:!0,href:!0});var Go=c(p);g=s(Go,"SPAN",{});var Jo=c(g);E(d.$$.fragment,Jo),Jo.forEach(o),Go.forEach(o),f=m(Ue),N=s(Ue,"SPAN",{});var Yo=c(N);Mn=t(Yo,"Speech Encoder Decoder Models"),Yo.forEach(o),Ue.forEach(o),nn=m(r),P=s(r,"P",{});var z=c(P);Dn=t(z,"The "),Je=s(z,"A",{href:!0});var Zo=c(Je);jn=t(Zo,"SpeechEncoderDecoderModel"),Zo.forEach(o),qn=t(z,` can be used to initialize a speech-sequence-to-text-sequence model
...
`),Qe=s(go,"A",{href:!0});var ua=c(Qe);Hn=t(ua,"Speech2Text2"),ua.forEach(o),Gn=t(go,"."),go.forEach(o),an=m(r),R=s(r,"H2",{class:!0});var mn=c(R);oe=s(mn,"A",{id:!0,class:!0,href:!0});var ga=c(oe);To=s(ga,"SPAN",{});var _a=c(To);E(ve.$$.fragment,_a),_a.forEach(o),ga.forEach(o),Jn=m(mn),Mo=s(mn,"SPAN",{});var va=c(Mo);Yn=t(va,"SpeechEncoderDecoderConfig"),va.forEach(o),mn.forEach(o),sn=m(r),j=s(r,"DIV",{class:!0});var L=c(j);E(be.$$.fragment,L),Zn=m(L),ne=s(L,"P",{});var Qo=c(ne);Xe=s(Qo,"A",{href:!0});var ba=c(Xe);Kn=t(ba,"SpeechEncoderDecoderConfig"),ba.forEach(o),Qn=t(Qo,` is the configuration class to store the configuration of a
...
documentation from `),no=s(_o,"A",{href:!0});var ka=c(no);at=t(ka,"PretrainedConfig"),ka.forEach(o),st=t(_o," for more information."),_o.forEach(o),dt=m(L),E(te.$$.fragment,L),ct=m(L),re=s(L,"DIV",{class:!0});var fn=c(re);E(ye.$$.fragment,fn),it=m(fn),we=s(fn,"P",{});var un=c(we);lt=t(un,"Instantiate a "),to=s(un,"A",{href:!0});var Ea=c(to);pt=t(Ea,"SpeechEncoderDecoderConfig"),Ea.forEach(o),ht=t(un,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),un.forEach(o),fn.forEach(o),mt=m(L),ae=s(L,"DIV",{class:!0});var gn=c(ae);E(ke.$$.fragment,gn),ft=m(gn),H=s(gn,"P",{});var vo=c(H);ut=t(vo,"Serializes this instance to a Python dictionary. Override the default "),Do=s(vo,"EM",{});var Sa=c(Do);gt=t(Sa,"to_dict()"),Sa.forEach(o),_t=t(vo," from "),jo=s(vo,"EM",{});var xa=c(jo);vt=t(xa,"PretrainedConfig"),xa.forEach(o),bt=t(vo,"."),vo.forEach(o),gn.forEach(o),L.forEach(o),dn=m(r),G=s(r,"H2",{class:!0});var _n=c(G);se=s(_n,"A",{id:!0,class:!0,href:!0});var $a=c(se);qo=s($a,"SPAN",{});var Ta=c(qo);E(Ee.$$.fragment,Ta),Ta.forEach(o),$a.forEach(o),yt=m(_n),Po=s(_n,"SPAN",{});var Ma=c(Po);wt=t(Ma,"SpeechEncoderDecoderModel"),Ma.forEach(o),_n.forEach(o),cn=m(r),y=s(r,"DIV",{class:!0});var M=c(y);E(Se.$$.fragment,M),kt=m(M),J=s(M,"P",{});var bo=c(J);Et=t(bo,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
:meth`),Co=s(He,"EM",{});var Na=c(Co);Kt=t(Na,"~transformers.AutoModelForCausalLM.from_pretrained"),Na.forEach(o),Qt=t(He," class method for the decoder."),He.forEach(o),Xt=m(M),F=s(M,"DIV",{class:!0});var fe=c(F);E(Pe.$$.fragment,fe),er=m(fe),Y=s(fe,"P",{});var yo=c(Y);or=t(yo,"The "),io=s(yo,"A",{href:!0});var Ia=c(io);nr=t(Ia,"SpeechEncoderDecoderModel"),Ia.forEach(o),tr=t(yo," forward method, overrides the "),Ao=s(yo,"CODE",{});var Va=c(Ao);rr=t(Va,"__call__"),Va.forEach(o),ar=t(yo," special method."),yo.forEach(o),sr=m(fe),E(de.$$.fragment,fe),dr=m(fe),E(ce.$$.fragment,fe),fe.forEach(o),cr=m(M),C=s(M,"DIV",{class:!0});var ue=c(C);E(ze.$$.fragment,ue),ir=m(ue),Lo=s(ue,"P",{});var Wa=c(Lo);lr=t(Wa,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=s(wo,"CODE",{});var Ba=c(Io);ur=t(Ba,"model.train()"),Ba.forEach(o),gr=t(wo,"."),wo.forEach(o),_r=m(ue),E(ie.$$.fragment,ue),ue.forEach(o),M.forEach(o),ln=m(r),K=s(r,"H2",{class:!0});var kn=c(K);le=s(kn,"A",{id:!0,class:!0,href:!0});var Ra=c(le);Vo=s(Ra,"SPAN",{});var Ua=c(Vo);E(Fe.$$.fragment,Ua),Ua.forEach(o),Ra.forEach(o),vr=m(kn),Wo=s(kn,"SPAN",{});var Ha=c(Wo);br=t(Ha,"FlaxSpeechEncoderDecoderModel"),Ha.forEach(o),kn.forEach(o),pn=m(r),w=s(r,"DIV",{class:!0});var D=c(w);E(Ce.$$.fragment,D),yr=m(D),Q=s(D,"P",{});var ko=c(Q);wr=t(ko,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),lo=s(ko,"A",{href:!0});var Ga=c(lo);kr=t(Ga,"from_pretrained()"),Ga.forEach(o),Er=t(ko,` function and the decoder is loaded via
`),po=s(ko,"A",{href:!0});var Ja=c(po);Sr=t(Ja,"from_pretrained()"),Ja.forEach(o),xr=t(ko,` function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),ko.forEach(o),$r=m(D),Ae=s(D,"P",{});var En=c(Ae);Tr=t(En,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Le=s(En,"A",{href:!0,rel:!0});var Ya=c(Le);Mr=t(Ya,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Ya.forEach(o),Dr=t(En,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),En.forEach(o),jr=m(D),Ne=s(D,"P",{});var Sn=c(Ne);qr=t(Sn,"Additionally, in "),Ie=s(Sn,"A",{href:!0,rel:!0});var Za=c(Ie);Pr=t(Za,`Large-Scale Self- and Semi-Supervised Learning for Speech
