import{S as pw,i as hw,s as uw,e as a,k as d,w as f,t as o,M as mw,c as r,d as n,m as l,a as i,x as _,h as s,b as c,F as e,g as p,y as g,q as T,o as b,B as v,v as fw}from"../../chunks/vendor-6b77c823.js";import{T as yt}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-1088f2fb.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Te}from"../../chunks/IconCopyLink-7a11ce68.js";function _w(L){let u,z,k,w,$;return{c(){u=a("p"),z=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=a("code"),w=o("Module"),$=o(`
...
Whether or not to return a <a href="/docs/transformers/pr_16919/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1301"}}),xs=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1313"}}),zs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1539",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1495"}}),Is=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1508"}}),Ss=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1752"}}),Ks=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16919/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16919/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16919/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16919/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1810",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1773"}}),Js=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Xs=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_t5.py#L1784"}}),Qs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16919/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16919/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16919/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_tf_t5.py#L1134",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_tf_t5.py#L1309",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16919/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16919/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16919/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_tf_t5.py#L1618",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/t5/modeling_flax_t5.py#L958",returnDescription:`
<p>A <a
...
directory.`),tp.forEach(n),oc=l(t),sr=r(t,"UL",{});var Xk=i(sr);Ni=r(Xk,"LI",{});var Qk=i(Ni);su=s(Qk,"Supervised training"),Qk.forEach(n),Xk.forEach(n),sc=l(t),ar=r(t,"P",{});var e1=i(ar);au=s(e1,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),e1.forEach(n),ac=l(t),_($o.$$.fragment,t),rc=l(t),oe=r(t,"P",{});var ye=i(oe);ru=s(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Oi=r(ye,"CODE",{});var t1=i(Oi);iu=s(t1,"input_ids"),t1.forEach(n),du=s(ye,` (which are the
`),Li=r(ye,"CODE",{});var n1=i(Li);lu=s(n1,"input_ids"),n1.forEach(n),cu=s(ye," of the encoded input sequence) and "),Ai=r(ye,"CODE",{});var o1=i(Ai);pu=s(o1,"labels"),o1.forEach(n),hu=s(ye," (which are the "),Ii=r(ye,"CODE",{});var s1=i(Ii);uu=s(s1,"input_ids"),s1.forEach(n),mu=s(ye,` of the encoded
target sequence). The model will automatically create the `),Di=r(ye,"CODE",{});var a1=i(Di);fu=s(a1,"decoder_input_ids"),a1.forEach(n),_u=s(ye," based on the "),Si=r(ye,"CODE",{});var r1=i(Si);gu=s(r1,"labels"),r1.forEach(n),Tu=s(ye,`, by
shifting them one position to the right and prepending the `),Gi=r(ye,"CODE",{});var i1=i(Gi);bu=s(i1,"config.decoder_start_token_id"),i1.forEach(n),vu=s(ye,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Ui=r(Ur,"CODE",{});var d1=i(Ui);yu=s(d1,"max_source_length"),d1.forEach(n),wu=s(Ur," and "),Wi=r(Ur,"CODE",{});var l1=i(Wi);xu=s(l1,"max_target_length"),l1.forEach(n),$u=s(Ur,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Ur.forEach(n),dc=l(t),fe=r(t,"P",{});var tt=i(fe);zu=s(tt,"In addition, we must make sure that padding token id\u2019s of the "),Ri=r(tt,"CODE",{});var c1=i(Ri);ju=s(c1,"labels"),c1.forEach(n),qu=s(tt,` are not taken into account by the loss
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Bi=r(tt,"CODE",{});var p1=i(Bi);Eu=s(p1,"ignore_index"),p1.forEach(n),Fu=s(tt,`
of the `),Hi=r(tt,"CODE",{});var h1=i(Hi);Mu=s(h1,"CrossEntropyLoss"),h1.forEach(n),Cu=s(tt,". In Flax, one can use the "),Vi=r(tt,"CODE",{});var u1=i(Vi);Pu=s(u1,"decoder_attention_mask"),u1.forEach(n),Nu=s(tt,` to ignore padded tokens from
the loss (see the `),zo=r(tt,"A",{href:!0,rel:!0});var m1=i(zo);Ou=s(m1,"Flax summarization script"),m1.forEach(n),Lu=s(tt,` for details). We also pass
`),Ki=r(tt,"CODE",{});var f1=i(Ki);Au=s(f1,"attention_mask"),f1.forEach(n),Iu=s(tt,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),tt.forEach(n),lc=l(t),_(jo.$$.fragment,t),cc=l(t),rr=r(t,"P",{});var _1=i(rr);Du=s(_1,"Additional training tips:"),_1.forEach(n),pc=l(t),ir=r(t,"UL",{});var g1=i(ir);qo=r(g1,"LI",{});var np=i(qo);Su=s(np,"T5 models need a slightly higher learning rate than the default one set in the "),Yi=r(np,"CODE",{});var T1=i(Yi);Gu=s(T1,"Trainer"),T1.forEach(n),Uu=s(np,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),np.forEach(n),g1.forEach(n),hc=l(t),zt=r(t,"P",{});var Wr=i(zt);Wu=s(Wr,"According to "),Eo=r(Wr,"A",{href:!0,rel:!0});var b1=i(Eo);Ru=s(b1,"this forum post"),b1.forEach(n),Bu=s(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Fo=r(Wr,"A",{href:!0,rel:!0});var v1=i(Fo);Hu=s(v1,"paper"),v1.forEach(n),Vu=s(Wr,` for the task prefixes
...
`),Zi=r(op,"EM",{});var k1=i(Zi);Yu=s(k1,"pad_to_multiple_of"),k1.forEach(n),Zu=s(op,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),op.forEach(n),mc=l(t),dr=r(t,"A",{id:!0}),i(dr).forEach(n),fc=l(t),Kt=r(t,"H2",{class:!0});var sp=i(Kt);qn=r(sp,"A",{id:!0,class:!0,href:!0});var y1=i(qn);Ji=r(y1,"SPAN",{});var w1=i(Ji);_(Mo.$$.fragment,w1),w1.forEach(n),y1.forEach(n),Ju=l(sp),Xi=r(sp,"SPAN",{});var x1=i(Xi);Xu=s(x1,"Inference"),x1.forEach(n),sp.forEach(n),_c=l(t),mt=r(t,"P",{});var ao=i(mt);Qu=s(ao,"At inference time, it is recommended to use "),lr=r(ao,"A",{href:!0});var $1=i(lr);em=s($1,"generate()"),$1.forEach(n),tm=s(ao,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),Co=r(ao,"A",{href:!0,rel:!0});var z1=i(Co);nm=s(z1,"this blog post"),z1.forEach(n),om=s(ao,` to know all the details about generating text with Transformers.
There\u2019s also `),Po=r(ao,"A",{href:!0,rel:!0});var j1=i(Po);sm=s(j1,"this blog post"),j1.forEach(n),am=s(ao,` which explains how
generation works in general in encoder-decoder models.`),ao.forEach(n),gc=l(t),_(No.$$.fragment,t),Tc=l(t),Ue=r(t,"P",{});var Nt=i(Ue);rm=s(Nt,"Note that T5 uses the "),Qi=r(Nt,"CODE",{});var q1=i(Qi);im=s(q1,"pad_token_id"),q1.forEach(n),dm=s(Nt," as the "),ed=r(Nt,"CODE",{});var E1=i(ed);lm=s(E1,"decoder_start_token_id"),E1.forEach(n),cm=s(Nt,`, so when doing generation without using
`),cr=r(Nt,"A",{href:!0});var F1=i(cr);pm=s(F1,"generate()"),F1.forEach(n),hm=s(Nt,", make sure you start it with the "),td=r(Nt,"CODE",{});var M1=i(td);um=s(M1,"pad_token_id"),M1.forEach(n),mm=s(Nt,"."),Nt.forEach(n),bc=l(t),pr=r(t,"P",{});var C1=i(pr);fm=s(C1,"The example above only shows a single example. You can also do batched inference, like so:"),C1.forEach(n),vc=l(t),_(Oo.$$.fragment,t),kc=l(t),hr=r(t,"P",{});var P1=i(hr);_m=s(P1,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),P1.forEach(n),yc=l(t),_(Lo.$$.fragment,t),wc=l(t),ur=r(t,"A",{id:!0}),i(ur).forEach(n),xc=l(t),Yt=r(t,"H2",{class:!0});var ap=i(Yt);En=r(ap,"A",{id:!0,class:!0,href:!0});var N1=i(En);nd=r(N1,"SPAN",{});var O1=i(nd);_(Ao.$$.fragment,O1),O1.forEach(n),N1.forEach(n),gm=l(ap),od=r(ap,"SPAN",{});var L1=i(od);Tm=s(L1,"Performance"),L1.forEach(n),ap.forEach(n),$c=l(t),ft=r(t,"P",{});var ro=i(ft);bm=s(ro,"If you\u2019d like a faster training and inference performance, install "),Io=r(ro,"A",{href:!0,rel:!0});var A1=i(Io);vm=s(A1,"apex"),A1.forEach(n),km=s(ro," and then the model will automatically use "),sd=r(ro,"CODE",{});var I1=i(sd);ym=s(I1,"apex.normalization.FusedRMSNorm"),I1.forEach(n),wm=s(ro," instead of "),ad=r(ro,"CODE",{});var D1=i(ad);xm=s(D1,"T5LayerNorm"),D1.forEach(n),$m=s(ro,". The former uses an optimized fused kernel which is several times faster than the latter."),ro.forEach(n),zc=l(t),Zt=r(t,"H2",{class:!0});var rp=i(Zt);Fn=r(rp,"A",{id:!0,class:!0,href:!0});var S1=i(Fn);rd=r(S1,"SPAN",{});var G1=i(rd);_(Do.$$.fragment,G1),G1.forEach(n),S1.forEach(n),zm=l(rp),id=r(rp,"SPAN",{});var U1=i(id);jm=s(U1,"Example scripts"),U1.forEach(n),rp.forEach(n),jc=l(t),mr=r(t,"P",{});var W1=i(mr);qm=s(W1,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),W1.forEach(n),qc=l(t),Mn=r(t,"UL",{});var ip=i(Mn);dd=r(ip,"LI",{});var R1=i(dd);Jt=r(R1,"P",{});var Rr=i(Jt);Em=s(Rr,"pre-training: the "),So=r(Rr,"A",{href:!0,rel:!0});var B1=i(So);Fm=s(B1,"run_t5_mlm_flax.py"),B1.forEach(n),Mm=s(Rr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Go=r(Rr,"A",{href:!0,rel:!0});var H1=i(Go);Cm=s(H1,"t5_tokenizer_model.py"),H1.forEach(n),Pm=s(Rr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Rr.forEach(n),R1.forEach(n),Nm=l(ip),ld=r(ip,"LI",{});var V1=i(ld);Ae=r(V1,"P",{});var bt=i(Ae);Om=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),Uo=r(bt,"A",{href:!0,rel:!0});var K1=i(Uo);Lm=s(K1,"PyTorch"),K1.forEach(n),Am=s(bt,", "),Wo=r(bt,"A",{href:!0,rel:!0});var Y1=i(Wo);Im=s(Y1,"Tensorflow"),Y1.forEach(n),Dm=s(bt,", and "),Ro=r(bt,"A",{href:!0,rel:!0});var Z1=i(Ro);Sm=s(Z1,"Flax"),Z1.forEach(n),Gm=s(bt,`) and translation scripts
(`),Bo=r(bt,"A",{href:!0,rel:!0});var J1=i(Bo);Um=s(J1,"PyTorch"),J1.forEach(n),Wm=s(bt," and "),Ho=r(bt,"A",{href:!0,rel:!0});var X1=i(Ho);Rm=s(X1,"Tensorflow"),X1.forEach(n),Bm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(n),V1.forEach(n),ip.forEach(n),Ec=l(t),Xt=r(t,"H2",{class:!0});var dp=i(Xt);Cn=r(dp,"A",{id:!0,class:!0,href:!0});var Q1=i(Cn);cd=r(Q1,"SPAN",{});var ey=i(cd);_(Vo.$$.fragment,ey),ey.forEach(n),Q1.forEach(n),Hm=l(dp),pd=r(dp,"SPAN",{});var ty=i(pd);Vm=s(ty,"T5Config"),ty.forEach(n),dp.forEach(n),Fc=l(t),vt=r(t,"DIV",{class:!0});var Br=i(vt);_(Ko.$$.fragment,Br),Km=l(Br),kt=r(Br,"P",{});var io=i(kt);Ym=s(io,"This is the configuration class to store the configuration of a "),fr=r(io,"A",{href:!0});var ny=i(fr);Zm=s(ny,"T5Model"),ny.forEach(n),Jm=s(io," or a "),_r=r(io,"A",{href:!0});var oy=i(_r);Xm=s(oy,"TFT5Model"),oy.forEach(n),Qm=s(io,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
use of token type ids, therefore a list of zeros is returned.`),_y.forEach(n),fp.forEach(n),Lf=l(nt),yr=r(nt,"DIV",{class:!0});var gy=i(yr);_(rs.$$.fragment,gy),gy.forEach(n),nt.forEach(n),Pc=l(t),tn=r(t,"H2",{class:!0});var _p=i(tn);Ln=r(_p,"A",{id:!0,class:!0,href:!0});var Ty=i(Ln);bd=r(Ty,"SPAN",{});var by=i(bd);_(is.$$.fragment,by),by.forEach(n),Ty.forEach(n),Af=l(_p),vd=r(_p,"SPAN",{});var vy=i(vd);If=s(vy,"T5TokenizerFast"),vy.forEach(n),_p.forEach(n),Nc=l(t),Ie=r(t,"DIV",{class:!0});var Ot=i(Ie);_(ds.$$.fragment,Ot),Df=l(Ot),nn=r(Ot,"P",{});var Kr=i(nn);Sf=s(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),kd=r(Kr,"EM",{});var ky=i(kd);Gf=s(ky,"tokenizers"),ky.forEach(n),Uf=s(Kr,` library). Based on
...
adding special tokens. A sequence has the following format:`),xy.forEach(n),Xf=l(Yr),hs=r(Yr,"UL",{});var Tp=i(hs);xr=r(Tp,"LI",{});var Vv=i(xr);Qf=s(Vv,"single sequence: "),wd=r(Vv,"CODE",{});var $y=i(wd);e_=s($y,"X </s>"),$y.forEach(n),Vv.forEach(n),t_=l(Tp),$r=r(Tp,"LI",{});var Kv=i($r);n_=s(Kv,"pair of sequences: "),xd=r(Kv,"CODE",{});var zy=i(xd);o_=s(zy,"A </s> B </s>"),zy.forEach(n),Kv.forEach(n),Tp.forEach(n),Yr.forEach(n),s_=l(Ot),An=r(Ot,"DIV",{class:!0});var bp=i(An);_(us.$$.fragment,bp),a_=l(bp),$d=r(bp,"P",{});var jy=i($d);r_=s(jy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),jy.forEach(n),bp.forEach(n),Ot.forEach(n),Oc=l(t),on=r(t,"H2",{class:!0});var vp=i(on);In=r(vp,"A",{id:!0,class:!0,href:!0});var qy=i(In);zd=r(qy,"SPAN",{});var Ey=i(zd);_(ms.$$.fragment,Ey),Ey.forEach(n),qy.forEach(n),i_=l(vp),jd=r(vp,"SPAN",{});var Fy=i(jd);d_=s(Fy,"T5Model"),Fy.forEach(n),vp.forEach(n),Lc=l(t),J=r(t,"DIV",{class:!0});var we=i(J);_(fs.$$.fragment,we),l_=l(we),qd=r(we,"P",{});var My=i(qd);c_=s(My,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),My.forEach(n),p_=l(we),_s=r(we,"P",{});var kp=i(_s);h_=s(kp,"The T5 model was proposed in "),gs=r(kp,"A",{href:!0,rel:!0});var Cy=i(gs);u_=s(Cy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Cy.forEach(n),m_=s(kp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),kp.forEach(n),f_=l(we),Ts=r(we,"P",{});var yp=i(Ts);__=s(yp,"This model inherits from "),zr=r(yp,"A",{href:!0});var Py=i(zr);g_=s(Py,"PreTrainedModel"),Py.forEach(n),T_=s(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(n),b_=l(we),bs=r(we,"P",{});var wp=i(bs);v_=s(wp,"This model is also a PyTorch "),vs=r(wp,"A",{href:!0,rel:!0});var Ny=i(vs);k_=s(Ny,"torch.nn.Module"),Ny.forEach(n),y_=s(wp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wp.forEach(n),w_=l(we),We=r(we,"DIV",{class:!0});var Lt=i(We);_(ks.$$.fragment,Lt),x_=l(Lt),sn=r(Lt,"P",{});var Zr=i(sn);$_=s(Zr,"The "),jr=r(Zr,"A",{href:!0});var Oy=i(jr);z_=s(Oy,"T5Model"),Oy.forEach(n),j_=s(Zr," forward method, overrides the "),Ed=r(Zr,"CODE",{});var Ly=i(Ed);q_=s(Ly,"__call__"),Ly.forEach(n),E_=s(Zr," special method."),Zr.forEach(n),F_=l(Lt),_(Dn.$$.fragment,Lt),M_=l(Lt),Fd=r(Lt,"P",{});var Ay=i(Fd);C_=s(Ay,"Example:"),Ay.forEach(n),P_=l(Lt),_(ys.$$.fragment,Lt),Lt.forEach(n),N_=l(we),Re=r(we,"DIV",{class:!0});var At=i(Re);_(ws.$$.fragment,At),O_=l(At),Md=r(At,"P",{});var Iy=i(Md);L_=s(Iy,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Iy.forEach(n),A_=l(At),Cd=r(At,"P",{});var Dy=i(Cd);I_=s(Dy,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qp.forEach(n),hg=l(xe),Be=r(xe,"DIV",{class:!0});var It=i(Be);_(Os.$$.fragment,It),ug=l(It),rn=r(It,"P",{});var Jr=i(rn);mg=s(Jr,"The "),Er=r(Jr,"A",{href:!0});var Zy=i(Er);fg=s(Zy,"T5ForConditionalGeneration"),Zy.forEach(n),_g=s(Jr," forward method, overrides the "),Dd=r(Jr,"CODE",{});var Jy=i(Dd);gg=s(Jy,"__call__"),Jy.forEach(n),Tg=s(Jr," special method."),Jr.forEach(n),bg=l(It),_(Gn.$$.fragment,It),vg=l(It),Sd=r(It,"P",{});var Xy=i(Sd);kg=s(Xy,"Examples:"),Xy.forEach(n),yg=l(It),_(Ls.$$.fragment,It),It.forEach(n),wg=l(xe),He=r(xe,"DIV",{class:!0});var Dt=i(He);_(As.$$.fragment,Dt),xg=l(Dt),Gd=r(Dt,"P",{});var Qy=i(Gd);$g=s(Qy,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Qy.forEach(n),zg=l(Dt),Ud=r(Dt,"P",{});var e5=i(Ud);jg=s(e5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),e5.forEach(n),qg=l(Dt),Wd=r(Dt,"P",{});var t5=i(Wd);Eg=s(t5,"Example:"),t5.forEach(n),Fg=l(Dt),_(Is.$$.fragment,Dt),Dt.forEach(n),Mg=l(xe),gt=r(xe,"DIV",{class:!0});var co=i(gt);_(Ds.$$.fragment,co),Cg=l(co),Rd=r(co,"P",{});var n5=i(Rd);Pg=s(n5,"Moves the model to cpu from a model parallel state."),n5.forEach(n),Ng=l(co),Bd=r(co,"P",{});var o5=i(Bd);Og=s(o5,"Example:"),o5.forEach(n),Lg=l(co),_(Ss.$$.fragment,co),co.forEach(n),xe.forEach(n),Dc=l(t),dn=r(t,"H2",{class:!0});var Ep=i(dn);Un=r(Ep,"A",{id:!0,class:!0,href:!0});var s5=i(Un);Hd=r(s5,"SPAN",{});var a5=i(Hd);_(Gs.$$.fragment,a5),a5.forEach(n),s5.forEach(n),Ag=l(Ep),Vd=r(Ep,"SPAN",{});var r5=i(Vd);Ig=s(r5,"T5EncoderModel"),r5.forEach(n),Ep.forEach(n),Sc=l(t),Q=r(t,"DIV",{class:!0});var $e=i(Q);_(Us.$$.fragment,$e),Dg=l($e),Kd=r($e,"P",{});var i5=i(Kd);Sg=s(i5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),i5.forEach(n),Gg=l($e),Ws=r($e,"P",{});var Fp=i(Ws);Ug=s(Fp,"The T5 model was proposed in "),Rs=r(Fp,"A",{href:!0,rel:!0});var d5=i(Rs);Wg=s(d5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),d5.forEach(n),Rg=s(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(n),Bg=l($e),Bs=r($e,"P",{});var Mp=i(Bs);Hg=s(Mp,"This model inherits from "),Fr=r(Mp,"A",{href:!0});var l5=i(Fr);Vg=s(l5,"PreTrainedModel"),l5.forEach(n),Kg=s(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(n),Yg=l($e),Hs=r($e,"P",{});var Cp=i(Hs);Zg=s(Cp,"This model is also a PyTorch "),Vs=r(Cp,"A",{href:!0,rel:!0});var c5=i(Vs);Jg=s(c5,"torch.nn.Module"),c5.forEach(n),Xg=s(Cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cp.forEach(n),Qg=l($e),Ve=r($e,"DIV",{class:!0});var St=i(Ve);_(Ks.$$.fragment,St),eT=l(St),ln=r(St,"P",{});var Xr=i(ln);tT=s(Xr,"The "),Mr=r(Xr,"A",{href:!0});var p5=i(Mr);nT=s(p5,"T5EncoderModel"),p5.forEach(n),oT=s(Xr," forward method, overrides the "),Yd=r(Xr,"CODE",{});var h5=i(Yd);sT=s(h5,"__call__"),h5.forEach(n),aT=s(Xr," special method."),Xr.forEach(n),rT=l(St),_(Wn.$$.fragment,St),iT=l(St),Zd=r(St,"P",{});var u5=i(Zd);dT=s(u5,"Example:"),u5.forEach(n),lT=l(St),_(Ys.$$.fragment,St),St.forEach(n),cT=l($e),Ke=r($e,"DIV",{class:!0});var Gt=i(Ke);_(Zs.$$.fragment,Gt),pT=l(Gt),Jd=r(Gt,"P",{});var m5=i(Jd);hT=s(m5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),m5.forEach(n),uT=l(Gt),Xd=r(Gt,"P",{});var f5=i(Xd);mT=s(f5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),f5.forEach(n),fT=l(Gt),Qd=r(Gt,"P",{});var _5=i(Qd);_T=s(_5,"Example:"),_5.forEach(n),gT=l(Gt),_(Js.$$.fragment,Gt),Gt.forEach(n),TT=l($e),Tt=r($e,"DIV",{class:!0});var po=i(Tt);_(Xs.$$.fragment,po),bT=l(po),el=r(po,"P",{});var g5=i(el);vT=s(g5,"Moves the model to cpu from a model parallel state."),g5.forEach(n),kT=l(po),tl=r(po,"P",{});var T5=i(tl);yT=s(T5,"Example:"),T5.forEach(n),wT=l(po),_(Qs.$$.fragment,po),po.forEach(n),$e.forEach(n),Gc=l(t),cn=r(t,"H2",{class:!0});var Pp=i(cn);Rn=r(Pp,"A",{id:!0,class:!0,href:!0});var b5=i(Rn);nl=r(b5,"SPAN",{});var v5=i(nl);_(ea.$$.fragment,v5),v5.forEach(n),b5.forEach(n),xT=l(Pp),ol=r(Pp,"SPAN",{});var k5=i(ol);$T=s(k5,"TFT5Model"),k5.forEach(n),Pp.forEach(n),Uc=l(t),de=r(t,"DIV",{class:!0});var ot=i(de);_(ta.$$.fragment,ot),zT=l(ot),sl=r(ot,"P",{});var y5=i(sl);jT=s(y5,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),y5.forEach(n),qT=l(ot),na=r(ot,"P",{});var Np=i(na);ET=s(Np,"The T5 model was proposed in "),oa=r(Np,"A",{href:!0,rel:!0});var w5=i(oa);FT=s(w5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
