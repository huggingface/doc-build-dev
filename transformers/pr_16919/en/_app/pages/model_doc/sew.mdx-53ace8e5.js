import{S as ls,i as cs,s as ds,e as a,k as h,w as b,t as i,M as ps,c as s,d as o,m as u,a as r,x as E,h as l,b as p,F as e,g as _,y,q as $,o as S,B as W,v as ms,L as _t}from"../../chunks/vendor-6b77c823.js";import{T as ba}from"../../chunks/Tip-39098574.js";import{D as Qe}from"../../chunks/Docstring-1088f2fb.js";import{C as vt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ut}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as gt}from"../../chunks/ExampleCodeBlock-5212b321.js";function fs(k){let c,v,d,m,w;return m=new vt({props:{code:`from transformers import SEWModel, SEWConfig
...
`}}),ae=new ba({props:{$$slots:{default:[hs]},$$scope:{ctx:k}}}),se=new gt({props:{anchor:"transformers.SEWModel.forward.example",$$slots:{default:[us]},$$scope:{ctx:k}}}),qe=new ut({}),Pe=new Qe({props:{name:"class transformers.SEWForCTC",anchor:"transformers.SEWForCTC",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.SEWForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/sew#transformers.SEWConfig">SEWConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/sew/modeling_sew.py#L969"}}),De=new Qe({props:{name:"forward",anchor:"transformers.SEWForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],parametersDescription:[{anchor:"transformers.SEWForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16919/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/sew/modeling_sew.py#L1100"}}),Re=new Qe({props:{name:"forward",anchor:"transformers.SEWForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],parametersDescription:[{anchor:"transformers.SEWForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16919/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),pe=new ba({props:{$$slots:{default:[ws]},$$scope:{ctx:k}}}),me=new gt({props:{anchor:"transformers.SEWForSequenceClassification.forward.example",$$slots:{default:[bs]},$$scope:{ctx:k}}}),fe=new gt({props:{anchor:"transformers.SEWForSequenceClassification.forward.example-2",$$slots:{default:[Es]},$$scope:{ctx:k}}}),{c(){c=a("meta"),v=h(),d=a("h1"),m=a("a"),w=a("span"),b(n.$$.fragment),g=h(),j=a("span"),bo=i("SEW"),Nt=h(),O=a("h2"),G=a("a"),wt=a("span"),b(ge.$$.fragment),Eo=h(),bt=a("span"),yo=i("Overview"),Kt=h(),X=a("p"),$o=i("SEW (Squeezed and Efficient Wav2Vec) was proposed in "),_e=a("a"),So=i(`Performance-Efficiency Trade-offs in Unsupervised Pre-training
...
`),Ze=a("a"),Po=i("Wav2Vec2CTCTokenizer"),Fo=i("."),Jt=h(),ee=a("p"),Mo=i("This model was contributed by "),we=a("a"),zo=i("anton-l"),Ao=i("."),Qt=h(),I=a("h2"),te=a("a"),$t=a("span"),b(be.$$.fragment),Do=h(),St=a("span"),Lo=i("SEWConfig"),Yt=h(),F=a("div"),b(Ee.$$.fragment),Vo=h(),N=a("p"),Oo=i("This is the configuration class to store the configuration of a "),et=a("a"),Io=i("SEWModel"),No=i(`. It is used to instantiate a SEW model
...
documentation from `),ot=a("a"),Qo=i("PretrainedConfig"),Yo=i(" for more information."),Go=h(),b(oe.$$.fragment),Gt=h(),H=a("h2"),ne=a("a"),Wt=a("span"),b($e.$$.fragment),Xo=h(),kt=a("span"),Zo=i("SEWModel"),Xt=h(),T=a("div"),b(Se.$$.fragment),en=h(),We=a("p"),tn=i(`The bare SEW Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),fn=h(),M=a("div"),b(je.$$.fragment),hn=h(),R=a("p"),un=i("The "),at=a("a"),gn=i("SEWModel"),_n=i(" forward method, overrides the "),Ct=a("code"),vn=i("__call__"),wn=i(" special method."),bn=h(),b(ae.$$.fragment),En=h(),b(se.$$.fragment),Zt=h(),U=a("h2"),re=a("a"),Tt=a("span"),b(qe.$$.fragment),yn=h(),xt=a("span"),$n=i("SEWForCTC"),eo=h(),x=a("div"),b(Pe.$$.fragment),Sn=h(),B=a("p"),Wn=i("SEW Model with a "),jt=a("code"),kn=i("language modeling"),Cn=i(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ln=h(),q=a("div"),b(De.$$.fragment),Vn=h(),J=a("p"),On=i("The "),rt=a("a"),In=i("SEWForCTC"),Nn=i(" forward method, overrides the "),qt=a("code"),Kn=i("__call__"),Hn=i(" special method."),Rn=h(),b(ie.$$.fragment),Un=h(),b(le.$$.fragment),Bn=h(),b(ce.$$.fragment),to=h(),Q=a("h2"),de=a("a"),Pt=a("span"),b(Le.$$.fragment),Jn=h(),Ft=a("span"),Qn=i("SEWForSequenceClassification"),oo=h(),C=a("div"),b(Ve.$$.fragment),Yn=h(),Mt=a("p"),Gn=i(`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),Xn=h(),Oe=a("p"),Zn=i("SEW was proposed in "),Ie=a("a"),ea=i(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
documentation from `),ot=s(dt,"A",{href:!0});var za=r(ot);Qo=l(za,"PretrainedConfig"),za.forEach(o),Yo=l(dt," for more information."),dt.forEach(o),Go=u(he),E(oe.$$.fragment,he),he.forEach(o),Gt=u(t),H=s(t,"H2",{class:!0});var lo=r(H);ne=s(lo,"A",{id:!0,class:!0,href:!0});var Aa=r(ne);Wt=s(Aa,"SPAN",{});var Da=r(Wt);E($e.$$.fragment,Da),Da.forEach(o),Aa.forEach(o),Xo=u(lo),kt=s(lo,"SPAN",{});var La=r(kt);Zo=l(La,"SEWModel"),La.forEach(o),lo.forEach(o),Xt=u(t),T=s(t,"DIV",{class:!0});var A=r(T);E(Se.$$.fragment,A),en=u(A),We=s(A,"P",{});var co=r(We);tn=l(co,`The bare SEW Model transformer outputting raw hidden-states without any specific head on top.
