...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/roberta/modeling_tf_roberta.py#L1174",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),e1=p(),br=n("p"),t1=r("This model is also a PyTorch "),kr=n("a"),o1=r("torch.nn.Module"),n1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),s1=p(),lt=n("div"),y(Tr.$$.fragment),a1=p(),zo=n("p"),r1=r("The "),Kl=n("a"),i1=r("RobertaForQuestionAnswering"),l1=r(" forward method, overrides the "),Dc=n("code"),d1=r("__call__"),c1=r(" special method."),p1=p(),y(Vn.$$.fragment),h1=p(),y(Jn.$$.fragment),m1=p(),y(Kn.$$.fragment),Em=p(),qo=n("h2"),Gn=n("a"),Sc=n("span"),y(yr.$$.fragment),f1=p(),Wc=n("span"),u1=r("TFRobertaModel"),zm=p(),He=n("div"),y(vr.$$.fragment),g1=p(),Uc=n("p"),_1=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),b1=p(),wr=n("p"),k1=r("This model inherits from "),Gl=n("a"),T1=r("TFPreTrainedModel"),y1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),v1=p(),$r=n("p"),w1=r("This model is also a "),Fr=n("a"),$1=r("tf.keras.Model"),F1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),x1=p(),y(Xn.$$.fragment),R1=p(),Ft=n("div"),y(xr.$$.fragment),M1=p(),Co=n("p"),E1=r("The "),Xl=n("a"),z1=r("TFRobertaModel"),q1=r(" forward method, overrides the "),Bc=n("code"),C1=r("__call__"),j1=r(" special method."),P1=p(),y(Yn.$$.fragment),L1=p(),y(Zn.$$.fragment),qm=p(),jo=n("h2"),es=n("a"),Hc=n("span"),y(Rr.$$.fragment),A1=p(),Qc=n("span"),O1=r("TFRobertaForCausalLM"),Cm=p(),Po=n("div"),y(Mr.$$.fragment),N1=p(),xt=n("div"),y(Er.$$.fragment),I1=p(),Lo=n("p"),D1=r("The "),Yl=n("a"),S1=r("TFRobertaForCausalLM"),W1=r(" forward method, overrides the "),Vc=n("code"),U1=r("__call__"),B1=r(" special method."),H1=p(),y(ts.$$.fragment),Q1=p(),y(os.$$.fragment),jm=p(),Ao=n("h2"),ns=n("a"),Jc=n("span"),y(zr.$$.fragment),V1=p(),Kc=n("span"),J1=r("TFRobertaForMaskedLM"),Pm=p(),Qe=n("div"),y(qr.$$.fragment),K1=p(),Cr=n("p"),G1=r("RoBERTa Model with a "),Gc=n("code"),X1=r("language modeling"),Y1=r(" head on top."),Z1=p(),jr=n("p"),eT=r("This model inherits from "),Zl=n("a"),tT=r("TFPreTrainedModel"),oT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nT=p(),Pr=n("p"),sT=r("This model is also a "),Lr=n("a"),aT=r("tf.keras.Model"),rT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),iT=p(),y(ss.$$.fragment),lT=p(),dt=n("div"),y(Ar.$$.fragment),dT=p(),Oo=n("p"),cT=r("The "),ed=n("a"),pT=r("TFRobertaForMaskedLM"),hT=r(" forward method, overrides the "),Xc=n("code"),mT=r("__call__"),fT=r(" special method."),uT=p(),y(as.$$.fragment),gT=p(),y(rs.$$.fragment),_T=p(),y(is.$$.fragment),Lm=p(),No=n("h2"),ls=n("a"),Yc=n("span"),y(Or.$$.fragment),bT=p(),Zc=n("span"),kT=r("TFRobertaForSequenceClassification"),Am=p(),Ve=n("div"),y(Nr.$$.fragment),TT=p(),ep=n("p"),yT=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),vT=p(),Ir=n("p"),wT=r("This model inherits from "),td=n("a"),$T=r("TFPreTrainedModel"),FT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xT=p(),Dr=n("p"),RT=r("This model is also a "),Sr=n("a"),MT=r("tf.keras.Model"),ET=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zT=p(),y(ds.$$.fragment),qT=p(),ct=n("div"),y(Wr.$$.fragment),CT=p(),Io=n("p"),jT=r("The "),od=n("a"),PT=r("TFRobertaForSequenceClassification"),LT=r(" forward method, overrides the "),tp=n("code"),AT=r("__call__"),OT=r(" special method."),NT=p(),y(cs.$$.fragment),IT=p(),y(ps.$$.fragment),DT=p(),y(hs.$$.fragment),Om=p(),Do=n("h2"),ms=n("a"),op=n("span"),y(Ur.$$.fragment),ST=p(),np=n("span"),WT=r("TFRobertaForMultipleChoice"),Nm=p(),Je=n("div"),y(Br.$$.fragment),UT=p(),sp=n("p"),BT=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ZT=p(),y(fs.$$.fragment),ey=p(),Rt=n("div"),y(Jr.$$.fragment),ty=p(),So=n("p"),oy=r("The "),sd=n("a"),ny=r("TFRobertaForMultipleChoice"),sy=r(" forward method, overrides the "),ap=n("code"),ay=r("__call__"),ry=r(" special method."),iy=p(),y(us.$$.fragment),ly=p(),y(gs.$$.fragment),Im=p(),Wo=n("h2"),_s=n("a"),rp=n("span"),y(Kr.$$.fragment),dy=p(),ip=n("span"),cy=r("TFRobertaForTokenClassification"),Dm=p(),Ke=n("div"),y(Gr.$$.fragment),py=p(),lp=n("p"),hy=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_y=p(),Yr=n("p"),by=r("This model is also a "),Zr=n("a"),ky=r("tf.keras.Model"),Ty=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yy=p(),y(bs.$$.fragment),vy=p(),pt=n("div"),y(ei.$$.fragment),wy=p(),Uo=n("p"),$y=r("The "),rd=n("a"),Fy=r("TFRobertaForTokenClassification"),xy=r(" forward method, overrides the "),dp=n("code"),Ry=r("__call__"),My=r(" special method."),Ey=p(),y(ks.$$.fragment),zy=p(),y(Ts.$$.fragment),qy=p(),y(ys.$$.fragment),Sm=p(),Bo=n("h2"),vs=n("a"),cp=n("span"),y(ti.$$.fragment),Cy=p(),pp=n("span"),jy=r("TFRobertaForQuestionAnswering"),Wm=p(),Ge=n("div"),y(oi.$$.fragment),Py=p(),Ho=n("p"),Ly=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jy=p(),y(ws.$$.fragment),Ky=p(),ht=n("div"),y(ri.$$.fragment),Gy=p(),Qo=n("p"),Xy=r("The "),ld=n("a"),Yy=r("TFRobertaForQuestionAnswering"),Zy=r(" forward method, overrides the "),fp=n("code"),ev=r("__call__"),tv=r(" special method."),ov=p(),y($s.$$.fragment),nv=p(),y(Fs.$$.fragment),sv=p(),y(xs.$$.fragment),Um=p(),Vo=n("h2"),Rs=n("a"),up=n("span"),y(ii.$$.fragment),av=p(),gp=n("span"),rv=r("FlaxRobertaModel"),Bm=p(),Oe=n("div"),y(li.$$.fragment),iv=p(),_p=n("p"),lv=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),dv=p(),di=n("p"),cv=r("This model inherits from "),dd=n("a"),pv=r("FlaxPreTrainedModel"),hv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mv=p(),ci=n("p"),fv=r("This model is also a Flax Linen "),pi=n("a"),uv=r("flax.linen.Module"),gv=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_v=p(),bp=n("p"),bv=r("Finally, this model supports inherent JAX features such as:"),kv=p(),Dt=n("ul"),kp=n("li"),hi=n("a"),Tv=r("Just-In-Time (JIT) compilation"),yv=p(),Tp=n("li"),mi=n("a"),vv=r("Automatic Differentiation"),wv=p(),yp=n("li"),fi=n("a"),$v=r("Vectorization"),Fv=p(),vp=n("li"),ui=n("a"),xv=r("Parallelization"),Rv=p(),Mt=n("div"),y(gi.$$.fragment),Mv=p(),Jo=n("p"),Ev=r("The "),wp=n("code"),zv=r("FlaxRobertaPreTrainedModel"),qv=r(" forward method, overrides the "),$p=n("code"),Cv=r("__call__"),jv=r(" special method."),Pv=p(),y(Ms.$$.fragment),Lv=p(),y(Es.$$.fragment),Hm=p(),Ko=n("h2"),zs=n("a"),Fp=n("span"),y(_i.$$.fragment),Av=p(),xp=n("span"),Ov=r("FlaxRobertaForMaskedLM"),Qm=p(),Ne=n("div"),y(bi.$$.fragment),Nv=p(),ki=n("p"),Iv=r("RoBERTa Model with a "),Rp=n("code"),Dv=r("language modeling"),Sv=r(" head on top."),Wv=p(),Ti=n("p"),Uv=r("This model inherits from "),cd=n("a"),Bv=r("FlaxPreTrainedModel"),Hv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Qv=p(),yi=n("p"),Vv=r("This model is also a Flax Linen "),vi=n("a"),Jv=r("flax.linen.Module"),Kv=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gv=p(),Mp=n("p"),Xv=r("Finally, this model supports inherent JAX features such as:"),Yv=p(),St=n("ul"),Ep=n("li"),wi=n("a"),Zv=r("Just-In-Time (JIT) compilation"),ew=p(),zp=n("li"),$i=n("a"),tw=r("Automatic Differentiation"),ow=p(),qp=n("li"),Fi=n("a"),nw=r("Vectorization"),sw=p(),Cp=n("li"),xi=n("a"),aw=r("Parallelization"),rw=p(),Et=n("div"),y(Ri.$$.fragment),iw=p(),Go=n("p"),lw=r("The "),jp=n("code"),dw=r("FlaxRobertaPreTrainedModel"),cw=r(" forward method, overrides the "),Pp=n("code"),pw=r("__call__"),hw=r(" special method."),mw=p(),y(qs.$$.fragment),fw=p(),y(Cs.$$.fragment),Vm=p(),Xo=n("h2"),js=n("a"),Lp=n("span"),y(Mi.$$.fragment),uw=p(),Ap=n("span"),gw=r("FlaxRobertaForSequenceClassification"),Jm=p(),Ie=n("div"),y(Ei.$$.fragment),_w=p(),Op=n("p"),bw=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),kw=p(),zi=n("p"),Tw=r("This model inherits from "),pd=n("a"),yw=r("FlaxPreTrainedModel"),vw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ww=p(),qi=n("p"),$w=r("This model is also a Flax Linen "),Ci=n("a"),Fw=r("flax.linen.Module"),xw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Rw=p(),Np=n("p"),Mw=r("Finally, this model supports inherent JAX features such as:"),Ew=p(),Wt=n("ul"),Ip=n("li"),ji=n("a"),zw=r("Just-In-Time (JIT) compilation"),qw=p(),Dp=n("li"),Pi=n("a"),Cw=r("Automatic Differentiation"),jw=p(),Sp=n("li"),Li=n("a"),Pw=r("Vectorization"),Lw=p(),Wp=n("li"),Ai=n("a"),Aw=r("Parallelization"),Ow=p(),zt=n("div"),y(Oi.$$.fragment),Nw=p(),Yo=n("p"),Iw=r("The "),Up=n("code"),Dw=r("FlaxRobertaPreTrainedModel"),Sw=r(" forward method, overrides the "),Bp=n("code"),Ww=r("__call__"),Uw=r(" special method."),Bw=p(),y(Ps.$$.fragment),Hw=p(),y(Ls.$$.fragment),Km=p(),Zo=n("h2"),As=n("a"),Hp=n("span"),y(Ni.$$.fragment),Qw=p(),Qp=n("span"),Vw=r("FlaxRobertaForMultipleChoice"),Gm=p(),De=n("div"),y(Ii.$$.fragment),Jw=p(),Vp=n("p"),Kw=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Gw=p(),Di=n("p"),Xw=r("This model inherits from "),hd=n("a"),Yw=r("FlaxPreTrainedModel"),Zw=r(`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qf.forEach(t),e1=h(no),br=s(no,"P",{});var Cf=a(br);t1=i(Cf,"This model is also a PyTorch "),kr=s(Cf,"A",{href:!0,rel:!0});var t0=a(kr);o1=i(t0,"torch.nn.Module"),t0.forEach(t),n1=i(Cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cf.forEach(t),s1=h(no),lt=s(no,"DIV",{class:!0});var so=a(lt);v(Tr.$$.fragment,so),a1=h(so),zo=s(so,"P",{});var Fd=a(zo);r1=i(Fd,"The "),Kl=s(Fd,"A",{href:!0});var o0=a(Kl);i1=i(o0,"RobertaForQuestionAnswering"),o0.forEach(t),l1=i(Fd," forward method, overrides the "),Dc=s(Fd,"CODE",{});var n0=a(Dc);d1=i(n0,"__call__"),n0.forEach(t),c1=i(Fd," special method."),Fd.forEach(t),p1=h(so),v(Vn.$$.fragment,so),h1=h(so),v(Jn.$$.fragment,so),m1=h(so),v(Kn.$$.fragment,so),so.forEach(t),no.forEach(t),Em=h(o),qo=s(o,"H2",{class:!0});var jf=a(qo);Gn=s(jf,"A",{id:!0,class:!0,href:!0});var s0=a(Gn);Sc=s(s0,"SPAN",{});var a0=a(Sc);v(yr.$$.fragment,a0),a0.forEach(t),s0.forEach(t),f1=h(jf),Wc=s(jf,"SPAN",{});var r0=a(Wc);u1=i(r0,"TFRobertaModel"),r0.forEach(t),jf.forEach(t),zm=h(o),He=s(o,"DIV",{class:!0});var Pt=a(He);v(vr.$$.fragment,Pt),g1=h(Pt),Uc=s(Pt,"P",{});var i0=a(Uc);_1=i(i0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),i0.forEach(t),b1=h(Pt),wr=s(Pt,"P",{});var Pf=a(wr);k1=i(Pf,"This model inherits from "),Gl=s(Pf,"A",{href:!0});var l0=a(Gl);T1=i(l0,"TFPreTrainedModel"),l0.forEach(t),y1=i(Pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pf.forEach(t),v1=h(Pt),$r=s(Pt,"P",{});var Lf=a($r);w1=i(Lf,"This model is also a "),Fr=s(Lf,"A",{href:!0,rel:!0});var d0=a(Fr);$1=i(d0,"tf.keras.Model"),d0.forEach(t),F1=i(Lf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lf.forEach(t),x1=h(Pt),v(Xn.$$.fragment,Pt),R1=h(Pt),Ft=s(Pt,"DIV",{class:!0});var Js=a(Ft);v(xr.$$.fragment,Js),M1=h(Js),Co=s(Js,"P",{});var xd=a(Co);E1=i(xd,"The "),Xl=s(xd,"A",{href:!0});var c0=a(Xl);z1=i(c0,"TFRobertaModel"),c0.forEach(t),q1=i(xd," forward method, overrides the "),Bc=s(xd,"CODE",{});var p0=a(Bc);C1=i(p0,"__call__"),p0.forEach(t),j1=i(xd," special method."),xd.forEach(t),P1=h(Js),v(Yn.$$.fragment,Js),L1=h(Js),v(Zn.$$.fragment,Js),Js.forEach(t),Pt.forEach(t),qm=h(o),jo=s(o,"H2",{class:!0});var Af=a(jo);es=s(Af,"A",{id:!0,class:!0,href:!0});var h0=a(es);Hc=s(h0,"SPAN",{});var m0=a(Hc);v(Rr.$$.fragment,m0),m0.forEach(t),h0.forEach(t),A1=h(Af),Qc=s(Af,"SPAN",{});var f0=a(Qc);O1=i(f0,"TFRobertaForCausalLM"),f0.forEach(t),Af.forEach(t),Cm=h(o),Po=s(o,"DIV",{class:!0});var Of=a(Po);v(Mr.$$.fragment,Of),N1=h(Of),xt=s(Of,"DIV",{class:!0});var Ks=a(xt);v(Er.$$.fragment,Ks),I1=h(Ks),Lo=s(Ks,"P",{});var Rd=a(Lo);D1=i(Rd,"The "),Yl=s(Rd,"A",{href:!0});var u0=a(Yl);S1=i(u0,"TFRobertaForCausalLM"),u0.forEach(t),W1=i(Rd," forward method, overrides the "),Vc=s(Rd,"CODE",{});var g0=a(Vc);U1=i(g0,"__call__"),g0.forEach(t),B1=i(Rd," special method."),Rd.forEach(t),H1=h(Ks),v(ts.$$.fragment,Ks),Q1=h(Ks),v(os.$$.fragment,Ks),Ks.forEach(t),Of.forEach(t),jm=h(o),Ao=s(o,"H2",{class:!0});var Nf=a(Ao);ns=s(Nf,"A",{id:!0,class:!0,href:!0});var _0=a(ns);Jc=s(_0,"SPAN",{});var b0=a(Jc);v(zr.$$.fragment,b0),b0.forEach(t),_0.forEach(t),V1=h(Nf),Kc=s(Nf,"SPAN",{});var k0=a(Kc);J1=i(k0,"TFRobertaForMaskedLM"),k0.forEach(t),Nf.forEach(t),Pm=h(o),Qe=s(o,"DIV",{class:!0});var Lt=a(Qe);v(qr.$$.fragment,Lt),K1=h(Lt),Cr=s(Lt,"P",{});var If=a(Cr);G1=i(If,"RoBERTa Model with a "),Gc=s(If,"CODE",{});var T0=a(Gc);X1=i(T0,"language modeling"),T0.forEach(t),Y1=i(If," head on top."),If.forEach(t),Z1=h(Lt),jr=s(Lt,"P",{});var Df=a(jr);eT=i(Df,"This model inherits from "),Zl=s(Df,"A",{href:!0});var y0=a(Zl);tT=i(y0,"TFPreTrainedModel"),y0.forEach(t),oT=i(Df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Df.forEach(t),nT=h(Lt),Pr=s(Lt,"P",{});var Sf=a(Pr);sT=i(Sf,"This model is also a "),Lr=s(Sf,"A",{href:!0,rel:!0});var v0=a(Lr);aT=i(v0,"tf.keras.Model"),v0.forEach(t),rT=i(Sf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sf.forEach(t),iT=h(Lt),v(ss.$$.fragment,Lt),lT=h(Lt),dt=s(Lt,"DIV",{class:!0});var ao=a(dt);v(Ar.$$.fragment,ao),dT=h(ao),Oo=s(ao,"P",{});var Md=a(Oo);cT=i(Md,"The "),ed=s(Md,"A",{href:!0});var w0=a(ed);pT=i(w0,"TFRobertaForMaskedLM"),w0.forEach(t),hT=i(Md," forward method, overrides the "),Xc=s(Md,"CODE",{});var $0=a(Xc);mT=i($0,"__call__"),$0.forEach(t),fT=i(Md," special method."),Md.forEach(t),uT=h(ao),v(as.$$.fragment,ao),gT=h(ao),v(rs.$$.fragment,ao),_T=h(ao),v(is.$$.fragment,ao),ao.forEach(t),Lt.forEach(t),Lm=h(o),No=s(o,"H2",{class:!0});var Wf=a(No);ls=s(Wf,"A",{id:!0,class:!0,href:!0});var F0=a(ls);Yc=s(F0,"SPAN",{});var x0=a(Yc);v(Or.$$.fragment,x0),x0.forEach(t),F0.forEach(t),bT=h(Wf),Zc=s(Wf,"SPAN",{});var R0=a(Zc);kT=i(R0,"TFRobertaForSequenceClassification"),R0.forEach(t),Wf.forEach(t),Am=h(o),Ve=s(o,"DIV",{class:!0});var At=a(Ve);v(Nr.$$.fragment,At),TT=h(At),ep=s(At,"P",{});var M0=a(ep);yT=i(M0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),M0.forEach(t),vT=h(At),Ir=s(At,"P",{});var Uf=a(Ir);wT=i(Uf,"This model inherits from "),td=s(Uf,"A",{href:!0});var E0=a(td);$T=i(E0,"TFPreTrainedModel"),E0.forEach(t),FT=i(Uf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uf.forEach(t),xT=h(At),Dr=s(At,"P",{});var Bf=a(Dr);RT=i(Bf,"This model is also a "),Sr=s(Bf,"A",{href:!0,rel:!0});var z0=a(Sr);MT=i(z0,"tf.keras.Model"),z0.forEach(t),ET=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),zT=h(At),v(ds.$$.fragment,At),qT=h(At),ct=s(At,"DIV",{class:!0});var ro=a(ct);v(Wr.$$.fragment,ro),CT=h(ro),Io=s(ro,"P",{});var Ed=a(Io);jT=i(Ed,"The "),od=s(Ed,"A",{href:!0});var q0=a(od);PT=i(q0,"TFRobertaForSequenceClassification"),q0.forEach(t),LT=i(Ed," forward method, overrides the "),tp=s(Ed,"CODE",{});var C0=a(tp);AT=i(C0,"__call__"),C0.forEach(t),OT=i(Ed," special method."),Ed.forEach(t),NT=h(ro),v(cs.$$.fragment,ro),IT=h(ro),v(ps.$$.fragment,ro),DT=h(ro),v(hs.$$.fragment,ro),ro.forEach(t),At.forEach(t),Om=h(o),Do=s(o,"H2",{class:!0});var Hf=a(Do);ms=s(Hf,"A",{id:!0,class:!0,href:!0});var j0=a(ms);op=s(j0,"SPAN",{});var P0=a(op);v(Ur.$$.fragment,P0),P0.forEach(t),j0.forEach(t),ST=h(Hf),np=s(Hf,"SPAN",{});var L0=a(np);WT=i(L0,"TFRobertaForMultipleChoice"),L0.forEach(t),Hf.forEach(t),Nm=h(o),Je=s(o,"DIV",{class:!0});var Ot=a(Je);v(Br.$$.fragment,Ot),UT=h(Ot),sp=s(Ot,"P",{});var A0=a(sp);BT=i(A0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),A0.forEach(t),HT=h(Ot),Hr=s(Ot,"P",{});var Qf=a(Hr);QT=i(Qf,"This model inherits from "),nd=s(Qf,"A",{href:!0});var O0=a(nd);VT=i(O0,"TFPreTrainedModel"),O0.forEach(t),JT=i(Qf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qf.forEach(t),KT=h(Ot),Qr=s(Ot,"P",{});var Vf=a(Qr);GT=i(Vf,"This model is also a "),Vr=s(Vf,"A",{href:!0,rel:!0});var N0=a(Vr);XT=i(N0,"tf.keras.Model"),N0.forEach(t),YT=i(Vf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vf.forEach(t),ZT=h(Ot),v(fs.$$.fragment,Ot),ey=h(Ot),Rt=s(Ot,"DIV",{class:!0});var Gs=a(Rt);v(Jr.$$.fragment,Gs),ty=h(Gs),So=s(Gs,"P",{});var zd=a(So);oy=i(zd,"The "),sd=s(zd,"A",{href:!0});var I0=a(sd);ny=i(I0,"TFRobertaForMultipleChoice"),I0.forEach(t),sy=i(zd," forward method, overrides the "),ap=s(zd,"CODE",{});var D0=a(ap);ay=i(D0,"__call__"),D0.forEach(t),ry=i(zd," special method."),zd.forEach(t),iy=h(Gs),v(us.$$.fragment,Gs),ly=h(Gs),v(gs.$$.fragment,Gs),Gs.forEach(t),Ot.forEach(t),Im=h(o),Wo=s(o,"H2",{class:!0});var Jf=a(Wo);_s=s(Jf,"A",{id:!0,class:!0,href:!0});var S0=a(_s);rp=s(S0,"SPAN",{});var W0=a(rp);v(Kr.$$.fragment,W0),W0.forEach(t),S0.forEach(t),dy=h(Jf),ip=s(Jf,"SPAN",{});var U0=a(ip);cy=i(U0,"TFRobertaForTokenClassification"),U0.forEach(t),Jf.forEach(t),Dm=h(o),Ke=s(o,"DIV",{class:!0});var Nt=a(Ke);v(Gr.$$.fragment,Nt),py=h(Nt),lp=s(Nt,"P",{});var B0=a(lp);hy=i(B0,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),B0.forEach(t),my=h(Nt),Xr=s(Nt,"P",{});var Kf=a(Xr);fy=i(Kf,"This model inherits from "),ad=s(Kf,"A",{href:!0});var H0=a(ad);uy=i(H0,"TFPreTrainedModel"),H0.forEach(t),gy=i(Kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kf.forEach(t),_y=h(Nt),Yr=s(Nt,"P",{});var Gf=a(Yr);by=i(Gf,"This model is also a "),Zr=s(Gf,"A",{href:!0,rel:!0});var Q0=a(Zr);ky=i(Q0,"tf.keras.Model"),Q0.forEach(t),Ty=i(Gf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gf.forEach(t),yy=h(Nt),v(bs.$$.fragment,Nt),vy=h(Nt),pt=s(Nt,"DIV",{class:!0});var io=a(pt);v(ei.$$.fragment,io),wy=h(io),Uo=s(io,"P",{});var qd=a(Uo);$y=i(qd,"The "),rd=s(qd,"A",{href:!0});var V0=a(rd);Fy=i(V0,"TFRobertaForTokenClassification"),V0.forEach(t),xy=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var J0=a(dp);Ry=i(J0,"__call__"),J0.forEach(t),My=i(qd," special method."),qd.forEach(t),Ey=h(io),v(ks.$$.fragment,io),zy=h(io),v(Ts.$$.fragment,io),qy=h(io),v(ys.$$.fragment,io),io.forEach(t),Nt.forEach(t),Sm=h(o),Bo=s(o,"H2",{class:!0});var Xf=a(Bo);vs=s(Xf,"A",{id:!0,class:!0,href:!0});var K0=a(vs);cp=s(K0,"SPAN",{});var G0=a(cp);v(ti.$$.fragment,G0),G0.forEach(t),K0.forEach(t),Cy=h(Xf),pp=s(Xf,"SPAN",{});var X0=a(pp);jy=i(X0,"TFRobertaForQuestionAnswering"),X0.forEach(t),Xf.forEach(t),Wm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);v(oi.$$.fragment,It),Py=h(It),Ho=s(It,"P",{});var Cd=a(Ho);Ly=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var Y0=a(hp);Ay=i(Y0,"span start logits"),Y0.forEach(t),Oy=i(Cd," and "),mp=s(Cd,"CODE",{});var Z0=a(mp);Ny=i(Z0,"span end logits"),Z0.forEach(t),Iy=i(Cd,")."),Cd.forEach(t),Dy=h(It),ni=s(It,"P",{});var Yf=a(ni);Sy=i(Yf,"This model inherits from "),id=s(Yf,"A",{href:!0});var ex=a(id);Wy=i(ex,"TFPreTrainedModel"),ex.forEach(t),Uy=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yf.forEach(t),By=h(It),si=s(It,"P",{});var Zf=a(si);Hy=i(Zf,"This model is also a "),ai=s(Zf,"A",{href:!0,rel:!0});var tx=a(ai);Qy=i(tx,"tf.keras.Model"),tx.forEach(t),Vy=i(Zf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zf.forEach(t),Jy=h(It),v(ws.$$.fragment,It),Ky=h(It),ht=s(It,"DIV",{class:!0});var lo=a(ht);v(ri.$$.fragment,lo),Gy=h(lo),Qo=s(lo,"P",{});var jd=a(Qo);Xy=i(jd,"The "),ld=s(jd,"A",{href:!0});var ox=a(ld);Yy=i(ox,"TFRobertaForQuestionAnswering"),ox.forEach(t),Zy=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var nx=a(fp);ev=i(nx,"__call__"),nx.forEach(t),tv=i(jd," special method."),jd.forEach(t),ov=h(lo),v($s.$$.fragment,lo),nv=h(lo),v(Fs.$$.fragment,lo),sv=h(lo),v(xs.$$.fragment,lo),lo.forEach(t),It.forEach(t),Um=h(o),Vo=s(o,"H2",{class:!0});var eu=a(Vo);Rs=s(eu,"A",{id:!0,class:!0,href:!0});var sx=a(Rs);up=s(sx,"SPAN",{});var ax=a(up);v(ii.$$.fragment,ax),ax.forEach(t),sx.forEach(t),av=h(eu),gp=s(eu,"SPAN",{});var rx=a(gp);rv=i(rx,"FlaxRobertaModel"),rx.forEach(t),eu.forEach(t),Bm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);v(li.$$.fragment,ut),iv=h(ut),_p=s(ut,"P",{});var ix=a(_p);lv=i(ix,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),ix.forEach(t),dv=h(ut),di=s(ut,"P",{});var tu=a(di);cv=i(tu,"This model inherits from "),dd=s(tu,"A",{href:!0});var lx=a(dd);pv=i(lx,"FlaxPreTrainedModel"),lx.forEach(t),hv=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tu.forEach(t),mv=h(ut),ci=s(ut,"P",{});var ou=a(ci);fv=i(ou,"This model is also a Flax Linen "),pi=s(ou,"A",{href:!0,rel:!0});var dx=a(pi);uv=i(dx,"flax.linen.Module"),dx.forEach(t),gv=i(ou,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ou.forEach(t),_v=h(ut),bp=s(ut,"P",{});var cx=a(bp);bv=i(cx,"Finally, this model supports inherent JAX features such as:"),cx.forEach(t),kv=h(ut),Dt=s(ut,"UL",{});var Xs=a(Dt);kp=s(Xs,"LI",{});var px=a(kp);hi=s(px,"A",{href:!0,rel:!0});var hx=a(hi);Tv=i(hx,"Just-In-Time (JIT) compilation"),hx.forEach(t),px.forEach(t),yv=h(Xs),Tp=s(Xs,"LI",{});var mx=a(Tp);mi=s(mx,"A",{href:!0,rel:!0});var fx=a(mi);vv=i(fx,"Automatic Differentiation"),fx.forEach(t),mx.forEach(t),wv=h(Xs),yp=s(Xs,"LI",{});var ux=a(yp);fi=s(ux,"A",{href:!0,rel:!0});var gx=a(fi);$v=i(gx,"Vectorization"),gx.forEach(t),ux.forEach(t),Fv=h(Xs),vp=s(Xs,"LI",{});var _x=a(vp);ui=s(_x,"A",{href:!0,rel:!0});var bx=a(ui);xv=i(bx,"Parallelization"),bx.forEach(t),_x.forEach(t),Xs.forEach(t),Rv=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);v(gi.$$.fragment,Ys),Mv=h(Ys),Jo=s(Ys,"P",{});var Pd=a(Jo);Ev=i(Pd,"The "),wp=s(Pd,"CODE",{});var kx=a(wp);zv=i(kx,"FlaxRobertaPreTrainedModel"),kx.forEach(t),qv=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var Tx=a($p);Cv=i(Tx,"__call__"),Tx.forEach(t),jv=i(Pd," special method."),Pd.forEach(t),Pv=h(Ys),v(Ms.$$.fragment,Ys),Lv=h(Ys),v(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Hm=h(o),Ko=s(o,"H2",{class:!0});var nu=a(Ko);zs=s(nu,"A",{id:!0,class:!0,href:!0});var yx=a(zs);Fp=s(yx,"SPAN",{});var vx=a(Fp);v(_i.$$.fragment,vx),vx.forEach(t),yx.forEach(t),Av=h(nu),xp=s(nu,"SPAN",{});var wx=a(xp);Ov=i(wx,"FlaxRobertaForMaskedLM"),wx.forEach(t),nu.forEach(t),Qm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);v(bi.$$.fragment,gt),Nv=h(gt),ki=s(gt,"P",{});var su=a(ki);Iv=i(su,"RoBERTa Model with a "),Rp=s(su,"CODE",{});var $x=a(Rp);Dv=i($x,"language modeling"),$x.forEach(t),Sv=i(su," head on top."),su.forEach(t),Wv=h(gt),Ti=s(gt,"P",{});var au=a(Ti);Uv=i(au,"This model inherits from "),cd=s(au,"A",{href:!0});var Fx=a(cd);Bv=i(Fx,"FlaxPreTrainedModel"),Fx.forEach(t),Hv=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),au.forEach(t),Qv=h(gt),yi=s(gt,"P",{});var ru=a(yi);Vv=i(ru,"This model is also a Flax Linen "),vi=s(ru,"A",{href:!0,rel:!0});var xx=a(vi);Jv=i(xx,"flax.linen.Module"),xx.forEach(t),Kv=i(ru,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ru.forEach(t),Gv=h(gt),Mp=s(gt,"P",{});var Rx=a(Mp);Xv=i(Rx,"Finally, this model supports inherent JAX features such as:"),Rx.forEach(t),Yv=h(gt),St=s(gt,"UL",{});var Zs=a(St);Ep=s(Zs,"LI",{});var Mx=a(Ep);wi=s(Mx,"A",{href:!0,rel:!0});var Ex=a(wi);Zv=i(Ex,"Just-In-Time (JIT) compilation"),Ex.forEach(t),Mx.forEach(t),ew=h(Zs),zp=s(Zs,"LI",{});var zx=a(zp);$i=s(zx,"A",{href:!0,rel:!0});var qx=a($i);tw=i(qx,"Automatic Differentiation"),qx.forEach(t),zx.forEach(t),ow=h(Zs),qp=s(Zs,"LI",{});var Cx=a(qp);Fi=s(Cx,"A",{href:!0,rel:!0});var jx=a(Fi);nw=i(jx,"Vectorization"),jx.forEach(t),Cx.forEach(t),sw=h(Zs),Cp=s(Zs,"LI",{});var Px=a(Cp);xi=s(Px,"A",{href:!0,rel:!0});var Lx=a(xi);aw=i(Lx,"Parallelization"),Lx.forEach(t),Px.forEach(t),Zs.forEach(t),rw=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);v(Ri.$$.fragment,ea),iw=h(ea),Go=s(ea,"P",{});var Ld=a(Go);lw=i(Ld,"The "),jp=s(Ld,"CODE",{});var Ax=a(jp);dw=i(Ax,"FlaxRobertaPreTrainedModel"),Ax.forEach(t),cw=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var Ox=a(Pp);pw=i(Ox,"__call__"),Ox.forEach(t),hw=i(Ld," special method."),Ld.forEach(t),mw=h(ea),v(qs.$$.fragment,ea),fw=h(ea),v(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Vm=h(o),Xo=s(o,"H2",{class:!0});var iu=a(Xo);js=s(iu,"A",{id:!0,class:!0,href:!0});var Nx=a(js);Lp=s(Nx,"SPAN",{});var Ix=a(Lp);v(Mi.$$.fragment,Ix),Ix.forEach(t),Nx.forEach(t),uw=h(iu),Ap=s(iu,"SPAN",{});var Dx=a(Ap);gw=i(Dx,"FlaxRobertaForSequenceClassification"),Dx.forEach(t),iu.forEach(t),Jm=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);v(Ei.$$.fragment,_t),_w=h(_t),Op=s(_t,"P",{});var Sx=a(Op);bw=i(Sx,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Sx.forEach(t),kw=h(_t),zi=s(_t,"P",{});var lu=a(zi);Tw=i(lu,"This model inherits from "),pd=s(lu,"A",{href:!0});var Wx=a(pd);yw=i(Wx,"FlaxPreTrainedModel"),Wx.forEach(t),vw=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),lu.forEach(t),ww=h(_t),qi=s(_t,"P",{});var du=a(qi);$w=i(du,"This model is also a Flax Linen "),Ci=s(du,"A",{href:!0,rel:!0});var Ux=a(Ci);Fw=i(Ux,"flax.linen.Module"),Ux.forEach(t),xw=i(du,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),du.forEach(t),Rw=h(_t),Np=s(_t,"P",{});var Bx=a(Np);Mw=i(Bx,"Finally, this model supports inherent JAX features such as:"),Bx.forEach(t),Ew=h(_t),Wt=s(_t,"UL",{});var ta=a(Wt);Ip=s(ta,"LI",{});var Hx=a(Ip);ji=s(Hx,"A",{href:!0,rel:!0});var Qx=a(ji);zw=i(Qx,"Just-In-Time (JIT) compilation"),Qx.forEach(t),Hx.forEach(t),qw=h(ta),Dp=s(ta,"LI",{});var Vx=a(Dp);Pi=s(Vx,"A",{href:!0,rel:!0});var Jx=a(Pi);Cw=i(Jx,"Automatic Differentiation"),Jx.forEach(t),Vx.forEach(t),jw=h(ta),Sp=s(ta,"LI",{});var Kx=a(Sp);Li=s(Kx,"A",{href:!0,rel:!0});var Gx=a(Li);Pw=i(Gx,"Vectorization"),Gx.forEach(t),Kx.forEach(t),Lw=h(ta),Wp=s(ta,"LI",{});var Xx=a(Wp);Ai=s(Xx,"A",{href:!0,rel:!0});var Yx=a(Ai);Aw=i(Yx,"Parallelization"),Yx.forEach(t),Xx.forEach(t),ta.forEach(t),Ow=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);v(Oi.$$.fragment,oa),Nw=h(oa),Yo=s(oa,"P",{});var Ad=a(Yo);Iw=i(Ad,"The "),Up=s(Ad,"CODE",{});var Zx=a(Up);Dw=i(Zx,"FlaxRobertaPreTrainedModel"),Zx.forEach(t),Sw=i(Ad," forward method, overrides the "),Bp=s(Ad,"CODE",{});var eR=a(Bp);Ww=i(eR,"__call__"),eR.forEach(t),Uw=i(Ad," special method."),Ad.forEach(t),Bw=h(oa),v(Ps.$$.fragment,oa),Hw=h(oa),v(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Km=h(o),Zo=s(o,"H2",{class:!0});var cu=a(Zo);As=s(cu,"A",{id:!0,class:!0,href:!0});var tR=a(As);Hp=s(tR,"SPAN",{});var oR=a(Hp);v(Ni.$$.fragment,oR),oR.forEach(t),tR.forEach(t),Qw=h(cu),Qp=s(cu,"SPAN",{});var nR=a(Qp);Vw=i(nR,"FlaxRobertaForMultipleChoice"),nR.forEach(t),cu.forEach(t),Gm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);v(Ii.$$.fragment,bt),Jw=h(bt),Vp=s(bt,"P",{});var sR=a(Vp);Kw=i(sR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),sR.forEach(t),Gw=h(bt),Di=s(bt,"P",{});var pu=a(Di);Xw=i(pu,"This model inherits from "),hd=s(pu,"A",{href:!0});var aR=a(hd);Yw=i(aR,"FlaxPreTrainedModel"),aR.forEach(t),Zw=i(pu,`. Check the superclass documentation for the generic methods the
