...
tabby, tabby cat`}}),{c(){d=a("p"),b=n("Example:"),m=f(),v(h.$$.fragment)},l(l){d=r(l,"P",{});var p=s(d);b=i(p,"Example:"),p.forEach(o),m=u(l),w(h.$$.fragment,l)},m(l,p){_(l,d,p),e(d,b),_(l,m,p),$(h,l,p),T=!0},p:Co,i(l){T||(y(h.$$.fragment,l),T=!0)},o(l){D(h.$$.fragment,l),T=!1},d(l){l&&o(d),l&&o(m),k(h,l)}}}function pi(x){let d,b,m,h,T,l,p,E,ha,Po,le,zo,J,de,Vt,qe,pa,Bt,ma,qo,q,fa,Ae,ua,ga,mt,_a,Ta,Ne,ba,va,Ao,ft,wa,No,ut,Ht,$a,Lo,gt,ya,Oo,C,Rt,Da,ka,G,xa,_t,Ea,Ia,Tt,Fa,Ma,Ca,Ut,ja,Pa,Jt,za,qa,I,Aa,bt,Na,La,vt,Oa,Wa,Gt,Sa,Va,Kt,Ba,Ha,Xt,Ra,Ua,Zt,Ja,Ga,wt,Ka,Xa,Wo,ce,Za,Le,Qa,Ya,So,K,he,Qt,Oe,er,Yt,tr,Vo,j,We,or,X,ar,$t,rr,sr,Se,nr,ir,lr,Z,dr,yt,cr,hr,Dt,pr,mr,fr,pe,Bo,Q,me,eo,Ve,ur,to,gr,Ho,P,Be,_r,oo,Tr,br,He,vr,kt,wr,$r,yr,R,Re,Dr,ao,kr,xr,fe,Ro,Y,ue,ro,Ue,Er,so,Ir,Uo,S,Je,Fr,Ge,Mr,Ke,Cr,jr,Pr,A,Xe,zr,ee,qr,xt,Ar,Nr,no,Lr,Or,Wr,ge,Sr,_e,Jo,te,Te,io,Ze,Vr,lo,Br,Go,V,Qe,Hr,oe,Rr,co,Ur,Jr,Ye,Gr,Kr,Xr,N,et,Zr,ae,Qr,Et,Yr,es,ho,ts,os,as,be,rs,ve,Ko,re,we,po,tt,ss,mo,ns,Xo,z,ot,is,fo,ls,ds,at,cs,rt,hs,ps,ms,L,st,fs,se,us,It,gs,_s,uo,Ts,bs,vs,$e,ws,ye,Zo,ne,De,go,nt,$s,_o,ys,Qo,F,it,Ds,To,ks,xs,bo,Es,Is,vo,Fs,Ms,lt,Cs,dt,js,Ps,zs,O,ct,qs,ie,As,Ft,Ns,Ls,wo,Os,Ws,Ss,ke,Vs,xe,Yo;return l=new ze({}),le=new St({props:{$$slots:{default:[ti]},$$scope:{ctx:x}}}),qe=new ze({}),Oe=new ze({}),We=new H({props:{name:"class transformers.DeiTConfig",anchor:"transformers.DeiTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DeiTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/deit/feature_extraction_deit.py#L91",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16919/en/model_doc/deit#transformers.DeiTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/deit/modeling_deit.py#L588",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/deit/modeling_deit.py#L695",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16919/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/deit/modeling_deit.py#L849",returnDescription:`
...
`}}),ke=new St({props:{$$slots:{default:[ci]},$$scope:{ctx:x}}}),xe=new Mo({props:{anchor:"transformers.DeiTForImageClassificationWithTeacher.forward.example",$$slots:{default:[hi]},$$scope:{ctx:x}}}),{c(){d=a("meta"),b=f(),m=a("h1"),h=a("a"),T=a("span"),v(l.$$.fragment),p=f(),E=a("span"),ha=n("DeiT"),Po=f(),v(le.$$.fragment),zo=f(),J=a("h2"),de=a("a"),Vt=a("span"),v(qe.$$.fragment),pa=f(),Bt=a("span"),ma=n("Overview"),qo=f(),q=a("p"),fa=n("The DeiT model was proposed in "),Ae=a("a"),ua=n("Training data-efficient image transformers & distillation through attention"),ga=n(` by Hugo Touvron, Matthieu Cord, Matthijs Douze, Francisco Massa, Alexandre
...
should refer to this superclass for more information regarding those methods.`),yr=f(),R=a("div"),v(Re.$$.fragment),Dr=f(),ao=a("p"),kr=n("Main method to prepare for the model one or several image(s)."),xr=f(),v(fe.$$.fragment),Ro=f(),Y=a("h2"),ue=a("a"),ro=a("span"),v(Ue.$$.fragment),Er=f(),so=a("span"),Ir=n("DeiTModel"),Uo=f(),S=a("div"),v(Je.$$.fragment),Fr=f(),Ge=a("p"),Mr=n(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
...
contrast with the original ViT model, which used external data like the JFT-300M dataset/Imagenet-21k for
pre-training.`),Qs.forEach(o),qa=u(U),I=r(U,"LI",{});var M=s(I);Aa=i(M,`The authors of DeiT also released more efficiently trained ViT models, which you can directly plug into
