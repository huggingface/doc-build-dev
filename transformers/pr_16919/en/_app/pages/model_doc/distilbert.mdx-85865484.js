...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16919/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_distilbert.py#L627",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_distilbert.py#L725",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_distilbert.py#L1053",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_distilbert.py#L958",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_distilbert.py#L841",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_tf_distilbert.py#L543",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_tf_distilbert.py#L658",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_tf_distilbert.py#L759",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_tf_distilbert.py#L959",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_tf_distilbert.py#L854",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1086",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),b1=p(),la=o("p"),k1=a("This model is also a "),da=o("a"),v1=a("tf.keras.Model"),T1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
general usage and behavior.`),U1=p(),Sd=o("p"),H1=a("Finally, this model supports inherent JAX features such as:"),K1=p(),Mt=o("ul"),Id=o("li"),ga=o("a"),V1=a("Just-In-Time (JIT) compilation"),J1=p(),Wd=o("li"),_a=o("a"),G1=a("Automatic Differentiation"),X1=p(),Qd=o("li"),ba=o("a"),Y1=a("Vectorization"),Z1=p(),Rd=o("li"),ka=o("a"),ek=a("Parallelization"),tk=p(),gt=o("div"),T(va.$$.fragment),sk=p(),zs=o("p"),ok=a("The "),Ud=o("code"),nk=a("FlaxDistilBertPreTrainedModel"),rk=a(" forward method, overrides the "),Hd=o("code"),ak=a("__call__"),ik=a(" special method."),lk=p(),T(Go.$$.fragment),dk=p(),T(Xo.$$.fragment),ih=p(),js=o("h2"),Yo=o("a"),Kd=o("span"),T(Ta.$$.fragment),ck=p(),Vd=o("span"),pk=a("FlaxDistilBertForMaskedLM"),lh=p(),Ee=o("div"),T($a.$$.fragment),hk=p(),wa=o("p"),uk=a("DistilBert Model with a "),Jd=o("code"),fk=a("language modeling"),mk=a(" head on top."),gk=p(),ya=o("p"),_k=a("This model inherits from "),il=o("a"),bk=a("FlaxPreTrainedModel"),kk=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),vk=p(),Fa=o("p"),Tk=a("This model is also a Flax Linen "),Da=o("a"),$k=a("flax.linen.Module"),wk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xk=p(),Pa=o("p"),Yk=a("This model is also a Flax Linen "),Aa=o("a"),Zk=a("flax.linen.Module"),ev=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tv=p(),ac=o("p"),sv=a("Finally, this model supports inherent JAX features such as:"),ov=p(),zt=o("ul"),ic=o("li"),Oa=o("a"),nv=a("Just-In-Time (JIT) compilation"),rv=p(),lc=o("li"),Na=o("a"),av=a("Automatic Differentiation"),iv=p(),dc=o("li"),La=o("a"),lv=a("Vectorization"),dv=p(),cc=o("li"),Sa=o("a"),cv=a("Parallelization"),pv=p(),bt=o("div"),T(Ia.$$.fragment),hv=p(),Ps=o("p"),uv=a("The "),pc=o("code"),fv=a("FlaxDistilBertPreTrainedModel"),mv=a(" forward method, overrides the "),hc=o("code"),gv=a("__call__"),_v=a(" special method."),bv=p(),T(sn.$$.fragment),kv=p(),T(on.$$.fragment),ph=p(),As=o("h2"),nn=o("a"),uc=o("span"),T(Wa.$$.fragment),vv=p(),fc=o("span"),Tv=a("FlaxDistilBertForMultipleChoice"),hh=p(),je=o("div"),T(Qa.$$.fragment),$v=p(),mc=o("p"),wv=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),yv=p(),Ra=o("p"),Fv=a("This model inherits from "),dl=o("a"),Dv=a("FlaxPreTrainedModel"),xv=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Bv=p(),Ua=o("p"),Mv=a("This model is also a Flax Linen "),Ha=o("a"),Ev=a("flax.linen.Module"),zv=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),jv=p(),gc=o("p"),Cv=a("Finally, this model supports inherent JAX features such as:"),qv=p(),jt=o("ul"),_c=o("li"),Ka=o("a"),Pv=a("Just-In-Time (JIT) compilation"),Av=p(),bc=o("li"),Va=o("a"),Ov=a("Automatic Differentiation"),Nv=p(),kc=o("li"),Ja=o("a"),Lv=a("Vectorization"),Sv=p(),vc=o("li"),Ga=o("a"),Iv=a("Parallelization"),Wv=p(),kt=o("div"),T(Xa.$$.fragment),Qv=p(),Os=o("p"),Rv=a("The "),Tc=o("code"),Uv=a("FlaxDistilBertPreTrainedModel"),Hv=a(" forward method, overrides the "),$c=o("code"),Kv=a("__call__"),Vv=a(" special method."),Jv=p(),T(rn.$$.fragment),Gv=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),Xv=p(),yc=o("span"),Yv=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=o("div"),T(Za.$$.fragment),Zv=p(),Fc=o("p"),eT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
pooled output) e.g. for GLUE tasks.`),C$.forEach(t),bm=h(Rt),ar=n(Rt,"P",{});var Bh=r(ar);km=i(Bh,"This model inherits from "),Si=n(Bh,"A",{href:!0});var q$=r(Si);vm=i(q$,"PreTrainedModel"),q$.forEach(t),Tm=i(Bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),p_=h($t),$($o.$$.fragment,$t),h_=h($t),ft=n($t,"DIV",{class:!0});var bn=r(ft);$(Cr.$$.fragment,bn),u_=h(bn),bs=n(bn,"P",{});var kl=r(bs);f_=i(kl,"The "),Ji=n(kl,"A",{href:!0});var mw=r(Ji);m_=i(mw,"TFDistilBertModel"),mw.forEach(t),g_=i(kl," forward method, overrides the "),md=n(kl,"CODE",{});var gw=r(md);__=i(gw,"__call__"),gw.forEach(t),b_=i(kl," special method."),kl.forEach(t),k_=h(bn),$(wo.$$.fragment,bn),v_=h(bn),$(yo.$$.fragment,bn),bn.forEach(t),$t.forEach(t),Jp=h(s),ks=n(s,"H2",{class:!0});var Wh=r(ks);Fo=n(Wh,"A",{id:!0,class:!0,href:!0});var _w=r(Fo);gd=n(_w,"SPAN",{});var bw=r(gd);$(qr.$$.fragment,bw),bw.forEach(t),_w.forEach(t),T_=h(Wh),_d=n(Wh,"SPAN",{});var kw=r(_d);$_=i(kw,"TFDistilBertForMaskedLM"),kw.forEach(t),Wh.forEach(t),Gp=h(s),Oe=n(s,"DIV",{class:!0});var wt=r(Oe);$(Pr.$$.fragment,wt),w_=h(wt),Ar=n(wt,"P",{});var Qh=r(Ar);y_=i(Qh,"DistilBert Model with a "),bd=n(Qh,"CODE",{});var vw=r(bd);F_=i(vw,"masked language modeling"),vw.forEach(t),D_=i(Qh," head on top."),Qh.forEach(t),x_=h(wt),Or=n(wt,"P",{});var Rh=r(Or);B_=i(Rh,"This model inherits from "),Gi=n(Rh,"A",{href:!0});var Tw=r(Gi);M_=i(Tw,"TFPreTrainedModel"),Tw.forEach(t),E_=i(Rh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),P_=h(wt),$(Do.$$.fragment,wt),A_=h(wt),Xe=n(wt,"DIV",{class:!0});var Gt=r(Xe);$(Sr.$$.fragment,Gt),O_=h(Gt),vs=n(Gt,"P",{});var vl=r(vs);N_=i(vl,"The "),Xi=n(vl,"A",{href:!0});var ww=r(Xi);L_=i(ww,"TFDistilBertForMaskedLM"),ww.forEach(t),S_=i(vl," forward method, overrides the "),kd=n(vl,"CODE",{});var yw=r(kd);I_=i(yw,"__call__"),yw.forEach(t),W_=i(vl," special method."),vl.forEach(t),Q_=h(Gt),$(xo.$$.fragment,Gt),R_=h(Gt),$(Bo.$$.fragment,Gt),U_=h(Gt),$(Mo.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Xp=h(s),Ts=n(s,"H2",{class:!0});var Hh=r(Ts);Eo=n(Hh,"A",{id:!0,class:!0,href:!0});var Fw=r(Eo);vd=n(Fw,"SPAN",{});var Dw=r(vd);$(Ir.$$.fragment,Dw),Dw.forEach(t),Fw.forEach(t),H_=h(Hh),Td=n(Hh,"SPAN",{});var xw=r(Td);K_=i(xw,"TFDistilBertForSequenceClassification"),xw.forEach(t),Hh.forEach(t),Yp=h(s),Ne=n(s,"DIV",{class:!0});var yt=r(Ne);$(Wr.$$.fragment,yt),V_=h(yt),$d=n(yt,"P",{});var Bw=r($d);J_=i(Bw,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
a softmax) e.g. for RocStories/SWAG tasks.`),Aw.forEach(t),kb=h(Ft),Jr=n(Ft,"P",{});var Gh=r(Jr);vb=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var Ow=r(el);Tb=i(Ow,"TFPreTrainedModel"),Ow.forEach(t),$b=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),xb=h(Ft),$(Ao.$$.fragment,Ft),Bb=h(Ft),mt=n(Ft,"DIV",{class:!0});var kn=r(mt);$(Yr.$$.fragment,kn),Mb=h(kn),ys=n(kn,"P",{});var $l=r(ys);Eb=i($l,"The "),tl=n($l,"A",{href:!0});var Lw=r(tl);zb=i(Lw,"TFDistilBertForMultipleChoice"),Lw.forEach(t),jb=i($l," forward method, overrides the "),xd=n($l,"CODE",{});var Sw=r(xd);Cb=i(Sw,"__call__"),Sw.forEach(t),qb=i($l," special method."),$l.forEach(t),Pb=h(kn),$(Oo.$$.fragment,kn),Ab=h(kn),$(No.$$.fragment,kn),kn.forEach(t),Ft.forEach(t),th=h(s),Fs=n(s,"H2",{class:!0});var Yh=r(Fs);Lo=n(Yh,"A",{id:!0,class:!0,href:!0});var Iw=r(Lo);Bd=n(Iw,"SPAN",{});var Ww=r(Bd);$(Zr.$$.fragment,Ww),Ww.forEach(t),Iw.forEach(t),Ob=h(Yh),Md=n(Yh,"SPAN",{});var Qw=r(Md);Nb=i(Qw,"TFDistilBertForTokenClassification"),Qw.forEach(t),Yh.forEach(t),sh=h(s),Se=n(s,"DIV",{class:!0});var Dt=r(Se);$(ea.$$.fragment,Dt),Lb=h(Dt),Ed=n(Dt,"P",{});var Rw=r(Ed);Sb=i(Rw,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),b1=h(xt),la=n(xt,"P",{});var ou=r(la);k1=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var ty=r(da);v1=i(ty,"tf.keras.Model"),ty.forEach(t),T1=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),U1=h(st),Sd=n(st,"P",{});var cy=r(Sd);H1=i(cy,"Finally, this model supports inherent JAX features such as:"),cy.forEach(t),K1=h(st),Mt=n(st,"UL",{});var vn=r(Mt);Id=n(vn,"LI",{});var py=r(Id);ga=n(py,"A",{href:!0,rel:!0});var hy=r(ga);V1=i(hy,"Just-In-Time (JIT) compilation"),hy.forEach(t),py.forEach(t),J1=h(vn),Wd=n(vn,"LI",{});var uy=r(Wd);_a=n(uy,"A",{href:!0,rel:!0});var fy=r(_a);G1=i(fy,"Automatic Differentiation"),fy.forEach(t),uy.forEach(t),X1=h(vn),Qd=n(vn,"LI",{});var my=r(Qd);ba=n(my,"A",{href:!0,rel:!0});var gy=r(ba);Y1=i(gy,"Vectorization"),gy.forEach(t),my.forEach(t),Z1=h(vn),Rd=n(vn,"LI",{});var _y=r(Rd);ka=n(_y,"A",{href:!0,rel:!0});var by=r(ka);ek=i(by,"Parallelization"),by.forEach(t),_y.forEach(t),vn.forEach(t),tk=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(va.$$.fragment,Tn),sk=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ok=i(Dl,"The "),Ud=n(Dl,"CODE",{});var ky=r(Ud);nk=i(ky,"FlaxDistilBertPreTrainedModel"),ky.forEach(t),rk=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var vy=r(Hd);ak=i(vy,"__call__"),vy.forEach(t),ik=i(Dl," special method."),Dl.forEach(t),lk=h(Tn),$(Go.$$.fragment,Tn),dk=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var Ty=r(Yo);Kd=n(Ty,"SPAN",{});var $y=r(Kd);$(Ta.$$.fragment,$y),$y.forEach(t),Ty.forEach(t),ck=h(iu),Vd=n(iu,"SPAN",{});var wy=r(Vd);pk=i(wy,"FlaxDistilBertForMaskedLM"),wy.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hk=h(ot),wa=n(ot,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yy=r(Jd);fk=i(yy,"language modeling"),yy.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(ot),ya=n(ot,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Fy=r(il);bk=i(Fy,"FlaxPreTrainedModel"),Fy.forEach(t),kk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),vk=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tk=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var Dy=r(Da);$k=i(Dy,"flax.linen.Module"),Dy.forEach(t),wk=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Qy=r(Aa);Zk=i(Qy,"flax.linen.Module"),Qy.forEach(t),ev=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tv=h(nt),ac=n(nt,"P",{});var Ry=r(ac);sv=i(Ry,"Finally, this model supports inherent JAX features such as:"),Ry.forEach(t),ov=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uy=r(ic);Oa=n(Uy,"A",{href:!0,rel:!0});var Hy=r(Oa);nv=i(Hy,"Just-In-Time (JIT) compilation"),Hy.forEach(t),Uy.forEach(t),rv=h(yn),lc=n(yn,"LI",{});var Ky=r(lc);Na=n(Ky,"A",{href:!0,rel:!0});var Vy=r(Na);av=i(Vy,"Automatic Differentiation"),Vy.forEach(t),Ky.forEach(t),iv=h(yn),dc=n(yn,"LI",{});var Jy=r(dc);La=n(Jy,"A",{href:!0,rel:!0});var Gy=r(La);lv=i(Gy,"Vectorization"),Gy.forEach(t),Jy.forEach(t),dv=h(yn),cc=n(yn,"LI",{});var Xy=r(cc);Sa=n(Xy,"A",{href:!0,rel:!0});var Yy=r(Sa);cv=i(Yy,"Parallelization"),Yy.forEach(t),Xy.forEach(t),yn.forEach(t),pv=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hv=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uv=i(Bl,"The "),pc=n(Bl,"CODE",{});var Zy=r(pc);fv=i(Zy,"FlaxDistilBertPreTrainedModel"),Zy.forEach(t),mv=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var e2=r(hc);gv=i(e2,"__call__"),e2.forEach(t),_v=i(Bl," special method."),Bl.forEach(t),bv=h(Fn),$(sn.$$.fragment,Fn),kv=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var t2=r(nn);uc=n(t2,"SPAN",{});var s2=r(uc);$(Wa.$$.fragment,s2),s2.forEach(t),t2.forEach(t),vv=h(fu),fc=n(fu,"SPAN",{});var o2=r(fc);Tv=i(o2,"FlaxDistilBertForMultipleChoice"),o2.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$v=h(rt),mc=n(rt,"P",{});var n2=r(mc);wv=i(n2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),n2.forEach(t),yv=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);Fv=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var r2=r(dl);Dv=i(r2,"FlaxPreTrainedModel"),r2.forEach(t),xv=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),Bv=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);Mv=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var a2=r(Ha);Ev=i(a2,"flax.linen.Module"),a2.forEach(t),zv=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jv=h(rt),gc=n(rt,"P",{});var i2=r(gc);Cv=i(i2,"Finally, this model supports inherent JAX features such as:"),i2.forEach(t),qv=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var l2=r(_c);Ka=n(l2,"A",{href:!0,rel:!0});var d2=r(Ka);Pv=i(d2,"Just-In-Time (JIT) compilation"),d2.forEach(t),l2.forEach(t),Av=h(Dn),bc=n(Dn,"LI",{});var c2=r(bc);Va=n(c2,"A",{href:!0,rel:!0});var p2=r(Va);Ov=i(p2,"Automatic Differentiation"),p2.forEach(t),c2.forEach(t),Nv=h(Dn),kc=n(Dn,"LI",{});var h2=r(kc);Ja=n(h2,"A",{href:!0,rel:!0});var u2=r(Ja);Lv=i(u2,"Vectorization"),u2.forEach(t),h2.forEach(t),Sv=h(Dn),vc=n(Dn,"LI",{});var f2=r(vc);Ga=n(f2,"A",{href:!0,rel:!0});var m2=r(Ga);Iv=i(m2,"Parallelization"),m2.forEach(t),f2.forEach(t),Dn.forEach(t),Wv=h(rt),kt=n(rt,"DIV",{class:!0});var xn=r(kt);$(Xa.$$.fragment,xn),Qv=h(xn),Os=n(xn,"P",{});var Ml=r(Os);Rv=i(Ml,"The "),Tc=n(Ml,"CODE",{});var g2=r(Tc);Uv=i(g2,"FlaxDistilBertPreTrainedModel"),g2.forEach(t),Hv=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _2=r($c);Kv=i(_2,"__call__"),_2.forEach(t),Vv=i(Ml," special method."),Ml.forEach(t),Jv=h(xn),$(rn.$$.fragment,xn),Gv=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var b2=r(ln);wc=n(b2,"SPAN",{});var k2=r(wc);$(Ya.$$.fragment,k2),k2.forEach(t),b2.forEach(t),Xv=h(_u),yc=n(_u,"SPAN",{});var v2=r(yc);Yv=i(v2,"FlaxDistilBertForTokenClassification"),v2.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Zv=h(at),Fc=n(at,"P",{});var T2=r(Fc);eT=i(T2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),bu.forEach(t),rT=h(at),ti=n(at,"P",{});var ku=r(ti);aT=i(ku,"This model is also a Flax Linen "),si=n(ku,"A",{href:!0,rel:!0});var w2=r(si);iT=i(w2,"flax.linen.Module"),w2.forEach(t),lT=i(ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ku.forEach(t),dT=h(at),Dc=n(at,"P",{});var y2=r(Dc);cT=i(y2,"Finally, this model supports inherent JAX features such as:"),y2.forEach(t),pT=h(at),Ct=n(at,"UL",{});var Bn=r(Ct);xc=n(Bn,"LI",{});var F2=r(xc);oi=n(F2,"A",{href:!0,rel:!0});var D2=r(oi);hT=i(D2,"Just-In-Time (JIT) compilation"),D2.forEach(t),F2.forEach(t),uT=h(Bn),Bc=n(Bn,"LI",{});var x2=r(Bc);ni=n(x2,"A",{href:!0,rel:!0});var B2=r(ni);fT=i(B2,"Automatic Differentiation"),B2.forEach(t),x2.forEach(t),mT=h(Bn),Mc=n(Bn,"LI",{});var M2=r(Mc);ri=n(M2,"A",{href:!0,rel:!0});var E2=r(ri);gT=i(E2,"Vectorization"),E2.forEach(t),M2.forEach(t),_T=h(Bn),Ec=n(Bn,"LI",{});var z2=r(Ec);ai=n(z2,"A",{href:!0,rel:!0});var j2=r(ai);bT=i(j2,"Parallelization"),j2.forEach(t),z2.forEach(t),Bn.forEach(t),kT=h(at),vt=n(at,"DIV",{class:!0});var Mn=r(vt);$(ii.$$.fragment,Mn),vT=h(Mn),Ls=n(Mn,"P",{});var El=r(Ls);TT=i(El,"The "),zc=n(El,"CODE",{});var C2=r(zc);$T=i(C2,"FlaxDistilBertPreTrainedModel"),C2.forEach(t),wT=i(El," forward method, overrides the "),jc=n(El,"CODE",{});var q2=r(jc);yT=i(q2,"__call__"),q2.forEach(t),FT=i(El," special method."),El.forEach(t),DT=h(Mn),$(dn.$$.fragment,Mn),xT=h(Mn),$(cn.$$.fragment,Mn),Mn.forEach(t),at.forEach(t),mh=h(s),Ss=n(s,"H2",{class:!0});var vu=r(Ss);pn=n(vu,"A",{id:!0,class:!0,href:!0});var P2=r(pn);Cc=n(P2,"SPAN",{});var A2=r(Cc);$(li.$$.fragment,A2),A2.forEach(t),P2.forEach(t),BT=h(vu),qc=n(vu,"SPAN",{});var O2=r(qc);MT=i(O2,"FlaxDistilBertForQuestionAnswering"),O2.forEach(t),vu.forEach(t),gh=h(s),qe=n(s,"DIV",{class:!0});var it=r(qe);$(di.$$.fragment,it),ET=h(it),Is=n(it,"P",{});var zl=r(Is);zT=i(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
