...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){w(d,c,h),_=!0},p:j,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Om(B){let d,_,c,h,k,n,p,F,Ta,ls,ge,Re,Qn,Et,ya,Gn,Ba,ds,He,Fa,jt,za,xa,cs,nn,Pa,ps,rn,Vn,qa,hs,sn,Ca,ms,Ue,Ea,At,ja,Aa,us,oe,Sa,St,Na,La,Nt,Ia,Oa,fs,an,Da,gs,ln,Wa,_s,Lt,bs,dn,Ra,ks,It,vs,cn,Ha,Ms,ne,Ua,Jn,Qa,Ga,Kn,Va,Ja,ws,Ot,$s,Dt,Ts,re,Ka,Wt,Ya,Xa,Rt,Za,ei,ys,_e,Qe,Yn,Ht,ti,Xn,oi,Bs,J,Ut,ni,be,ri,pn,si,ai,Qt,ii,li,di,ke,ci,hn,pi,hi,mn,mi,ui,fi,Ge,Fs,ve,Ve,Zn,Gt,gi,er,_i,zs,x,Vt,bi,tr,ki,vi,Jt,Mi,un,wi,$i,Ti,Kt,yi,Yt,Bi,Fi,zi,Xt,xi,Zt,Pi,qi,Ci,C,Ei,or,ji,Ai,nr,Si,Ni,rr,Li,Ii,sr,Oi,Di,ar,Wi,Ri,ir,Hi,Ui,Qi,K,eo,Gi,Me,Vi,fn,Ji,Ki,lr,Yi,Xi,Zi,Je,el,Ke,xs,we,Ye,dr,to,tl,cr,ol,Ps,A,oo,nl,no,rl,pr,sl,al,il,ro,ll,gn,dl,cl,pl,so,hl,ao,ml,ul,fl,R,io,gl,$e,_l,_n,bl,kl,hr,vl,Ml,wl,Xe,$l,Ze,Tl,et,qs,Te,tt,mr,lo,yl,ur,Bl,Cs,S,co,Fl,po,zl,fr,xl,Pl,ql,ho,Cl,bn,El,jl,Al,mo,Sl,uo,Nl,Ll,Il,Y,fo,Ol,ye,Dl,kn,Wl,Rl,gr,Hl,Ul,Ql,ot,Gl,nt,Es,Be,rt,_r,go,Vl,br,Jl,js,N,_o,Kl,bo,Yl,kr,Xl,Zl,ed,ko,td,vn,od,nd,rd,vo,sd,Mo,ad,id,ld,X,wo,dd,Fe,cd,Mn,pd,hd,vr,md,ud,fd,st,gd,at,As,ze,it,Mr,$o,_d,wr,bd,Ss,L,To,kd,xe,vd,$r,Md,wd,Tr,$d,Td,yd,yo,Bd,wn,Fd,zd,xd,Bo,Pd,Fo,qd,Cd,Ed,Z,zo,jd,Pe,Ad,$n,Sd,Nd,yr,Ld,Id,Od,lt,Dd,dt,Ns,qe,ct,Br,xo,Wd,Fr,Rd,Ls,I,Po,Hd,zr,Ud,Qd,qo,Gd,Tn,Vd,Jd,Kd,Co,Yd,Eo,Xd,Zd,ec,q,jo,tc,Ce,oc,yn,nc,rc,xr,sc,ac,ic,pt,lc,ht,dc,mt,cc,ut,pc,ft,Is,Ee,gt,Pr,Ao,hc,qr,mc,Os,O,So,uc,Cr,fc,gc,No,_c,Bn,bc,kc,vc,Lo,Mc,Io,wc,$c,Tc,ee,Oo,yc,je,Bc,Fn,Fc,zc,Er,xc,Pc,qc,_t,Cc,bt,Ds,Ae,kt,jr,Do,Ec,Ar,jc,Ws,D,Wo,Ac,Sr,Sc,Nc,Ro,Lc,zn,Ic,Oc,Dc,Ho,Wc,Uo,Rc,Hc,Uc,H,Qo,Qc,Se,Gc,xn,Vc,Jc,Nr,Kc,Yc,Xc,vt,Zc,Mt,ep,wt,Rs,Ne,$t,Lr,Go,tp,Ir,op,Hs,W,Vo,np,Le,rp,Or,sp,ap,Dr,ip,lp,dp,Jo,cp,Pn,pp,hp,mp,Ko,up,Yo,fp,gp,_p,U,Xo,bp,Ie,kp,qn,vp,Mp,Wr,wp,$p,Tp,Tt,yp,yt,Bp,Bt,Us;return n=new te({}),Et=new te({}),Lt=new z({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L874",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1288",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1139",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1384",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1028",returnDescription:`
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1489",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1586",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1684",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1765",returnDescription:`
<p>A <a
...
`}}),Tt=new We({props:{$$slots:{default:[Nm]},$$scope:{ctx:B}}}),yt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example",$$slots:{default:[Lm]},$$scope:{ctx:B}}}),Bt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example-2",$$slots:{default:[Im]},$$scope:{ctx:B}}}),{c(){d=a("meta"),_=m(),c=a("h1"),h=a("a"),k=a("span"),v(n.$$.fragment),p=m(),F=a("span"),Ta=r("MegatronBERT"),ls=m(),ge=a("h2"),Re=a("a"),Qn=a("span"),v(Et.$$.fragment),ya=m(),Gn=a("span"),Ba=r("Overview"),ds=m(),He=a("p"),Fa=r("The MegatronBERT model was proposed in "),jt=a("a"),za=r(`Megatron-LM: Training Multi-Billion Parameter Language Models Using Model
...
`),Qt=a("a"),ii=r("megatron-bert-uncased-345m"),li=r(" architecture."),di=m(),ke=a("p"),ci=r("Configuration objects inherit from "),hn=a("a"),pi=r("PretrainedConfig"),hi=r(` and can be used to control the model outputs. Read the
documentation from `),mn=a("a"),mi=r("PretrainedConfig"),ui=r(" for more information."),fi=m(),v(Ge.$$.fragment),Fs=m(),ve=a("h2"),Ve=a("a"),Zn=a("span"),v(Gt.$$.fragment),gi=m(),er=a("span"),_i=r("MegatronBertModel"),zs=m(),x=a("div"),v(Vt.$$.fragment),bi=m(),tr=a("p"),ki=r("The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),vi=m(),Jt=a("p"),Mi=r("This model inherits from "),un=a("a"),wi=r("PreTrainedModel"),$i=r(`. Check the superclass documentation for the generic methods the
...
`),sr=a("code"),Oi=r("add_cross_attention"),Di=r(" set to "),ar=a("code"),Wi=r("True"),Ri=r("; an "),ir=a("code"),Hi=r("encoder_hidden_states"),Ui=r(" is then expected as an input to the forward pass."),Qi=m(),K=a("div"),v(eo.$$.fragment),Gi=m(),Me=a("p"),Vi=r("The "),fn=a("a"),Ji=r("MegatronBertModel"),Ki=r(" forward method, overrides the "),lr=a("code"),Yi=r("__call__"),Xi=r(" special method."),Zi=m(),v(Je.$$.fragment),el=m(),v(Ke.$$.fragment),xs=m(),we=a("h2"),Ye=a("a"),dr=a("span"),v(to.$$.fragment),tl=m(),cr=a("span"),ol=r("MegatronBertForMaskedLM"),Ps=m(),A=a("div"),v(oo.$$.fragment),nl=m(),no=a("p"),rl=r("MegatronBert Model with a "),pr=a("code"),sl=r("language modeling"),al=r(" head on top."),il=m(),ro=a("p"),ll=r("This model inherits from "),gn=a("a"),dl=r("PreTrainedModel"),cl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Il=m(),Y=a("div"),v(fo.$$.fragment),Ol=m(),ye=a("p"),Dl=r("The "),kn=a("a"),Wl=r("MegatronBertForCausalLM"),Rl=r(" forward method, overrides the "),gr=a("code"),Hl=r("__call__"),Ul=r(" special method."),Ql=m(),v(ot.$$.fragment),Gl=m(),v(nt.$$.fragment),Es=m(),Be=a("h2"),rt=a("a"),_r=a("span"),v(go.$$.fragment),Vl=m(),br=a("span"),Jl=r("MegatronBertForNextSentencePrediction"),js=m(),N=a("div"),v(_o.$$.fragment),Kl=m(),bo=a("p"),Yl=r("MegatronBert Model with a "),kr=a("code"),Xl=r("next sentence prediction (classification)"),Zl=r(" head on top."),ed=m(),ko=a("p"),td=r("This model inherits from "),vn=a("a"),od=r("PreTrainedModel"),nd=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc=m(),H=a("div"),v(Qo.$$.fragment),Qc=m(),Se=a("p"),Gc=r("The "),xn=a("a"),Vc=r("MegatronBertForTokenClassification"),Jc=r(" forward method, overrides the "),Nr=a("code"),Kc=r("__call__"),Yc=r(" special method."),Xc=m(),v(vt.$$.fragment),Zc=m(),v(Mt.$$.fragment),ep=m(),v(wt.$$.fragment),Rs=m(),Ne=a("h2"),$t=a("a"),Lr=a("span"),v(Go.$$.fragment),tp=m(),Ir=a("span"),op=r("MegatronBertForQuestionAnswering"),Hs=m(),W=a("div"),v(Vo.$$.fragment),np=m(),Le=a("p"),rp=r(`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
easily be loaded by Hugging Face Transformers and our port of the BERT code.`),as.forEach(o),Ms=u(t),ne=i(t,"P",{});var De=l(ne);Ua=s(De,"The following commands allow you to do the conversion. We assume that the folder "),Jn=i(De,"CODE",{});var is=l(Jn);Qa=s(is,"models/megatron_bert"),is.forEach(o),Ga=s(De,` contains
`),Kn=i(De,"CODE",{});var Fp=l(Kn);Va=s(Fp,"megatron_bert_345m_v0_1_{cased, uncased}.zip"),Fp.forEach(o),Ja=s(De," and that the commands are run from inside that folder:"),De.forEach(o),ws=u(t),M(Ot.$$.fragment,t),$s=u(t),M(Dt.$$.fragment,t),Ts=u(t),re=i(t,"P",{});var Cn=l(re);Ka=s(Cn,"This model was contributed by "),Wt=i(Cn,"A",{href:!0,rel:!0});var zp=l(Wt);Ya=s(zp,"jdemouth"),zp.forEach(o),Xa=s(Cn,". The original code can be found "),Rt=i(Cn,"A",{href:!0,rel:!0});var xp=l(Rt);Za=s(xp,"here"),xp.forEach(o),ei=s(Cn,`. That repository contains a multi-GPU and multi-node implementation of the
Megatron Language models. In particular, it contains a hybrid model parallel approach using \u201Ctensor parallel\u201D and
...
MEGATRON_BERT model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MEGATRON_BERT
`),Qt=i(En,"A",{href:!0,rel:!0});var jp=l(Qt);ii=s(jp,"megatron-bert-uncased-345m"),jp.forEach(o),li=s(En," architecture."),En.forEach(o),di=u(Ft),ke=i(Ft,"P",{});var jn=l(ke);ci=s(jn,"Configuration objects inherit from "),hn=i(jn,"A",{href:!0});var Ap=l(hn);pi=s(Ap,"PretrainedConfig"),Ap.forEach(o),hi=s(jn,` and can be used to control the model outputs. Read the
documentation from `),mn=i(jn,"A",{href:!0});var Sp=l(mn);mi=s(Sp,"PretrainedConfig"),Sp.forEach(o),ui=s(jn," for more information."),jn.forEach(o),fi=u(Ft),M(Ge.$$.fragment,Ft),Ft.forEach(o),Fs=u(t),ve=i(t,"H2",{class:!0});var Gs=l(ve);Ve=i(Gs,"A",{id:!0,class:!0,href:!0});var Np=l(Ve);Zn=i(Np,"SPAN",{});var Lp=l(Zn);M(Gt.$$.fragment,Lp),Lp.forEach(o),Np.forEach(o),gi=u(Gs),er=i(Gs,"SPAN",{});var Ip=l(er);_i=s(Ip,"MegatronBertModel"),Ip.forEach(o),Gs.forEach(o),zs=u(t),x=i(t,"DIV",{class:!0});var Q=l(x);M(Vt.$$.fragment,Q),bi=u(Q),tr=i(Q,"P",{});var Op=l(tr);ki=s(Op,"The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),Op.forEach(o),vi=u(Q),Jt=i(Q,"P",{});var Vs=l(Jt);Mi=s(Vs,"This model inherits from "),un=i(Vs,"A",{href:!0});var Dp=l(un);wi=s(Dp,"PreTrainedModel"),Dp.forEach(o),$i=s(Vs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vs.forEach(o),Ti=u(Q),Kt=i(Q,"P",{});var Js=l(Kt);yi=s(Js,"This model is also a PyTorch "),Yt=i(Js,"A",{href:!0,rel:!0});var Wp=l(Yt);Bi=s(Wp,"torch.nn.Module"),Wp.forEach(o),Fi=s(Js,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
pooled output) e.g. for GLUE tasks.`),jh.forEach(o),Qd=u(ce),qo=i(ce,"P",{});var ma=l(qo);Gd=s(ma,"This model inherits from "),Tn=i(ma,"A",{href:!0});var Ah=l(Tn);Vd=s(Ah,"PreTrainedModel"),Ah.forEach(o),Jd=s(ma,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),va.forEach(o),Uc=u(he),H=i(he,"DIV",{class:!0});var me=l(H);M(Qo.$$.fragment,me),Qc=u(me),Se=i(me,"P",{});var Rn=l(Se);Gc=s(Rn,"The "),xn=i(Rn,"A",{href:!0});var Zh=l(xn);Vc=s(Zh,"MegatronBertForTokenClassification"),Zh.forEach(o),Jc=s(Rn," forward method, overrides the "),Nr=i(Rn,"CODE",{});var em=l(Nr);Kc=s(em,"__call__"),em.forEach(o),Yc=s(Rn," special method."),Rn.forEach(o),Xc=u(me),M(vt.$$.fragment,me),Zc=u(me),M(Mt.$$.fragment,me),ep=u(me),M(wt.$$.fragment,me),me.forEach(o),he.forEach(o),Rs=u(t),Ne=i(t,"H2",{class:!0});var Ma=l(Ne);$t=i(Ma,"A",{id:!0,class:!0,href:!0});var tm=l($t);Lr=i(tm,"SPAN",{});var om=l(Lr);M(Go.$$.fragment,om),om.forEach(o),tm.forEach(o),tp=u(Ma),Ir=i(Ma,"SPAN",{});var nm=l(Ir);op=s(nm,"MegatronBertForQuestionAnswering"),nm.forEach(o),Ma.forEach(o),Hs=u(t),W=i(t,"DIV",{class:!0});var ue=l(W);M(Vo.$$.fragment,ue),np=u(ue),Le=i(ue,"P",{});var Hn=l(Le);rp=s(Hn,`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
