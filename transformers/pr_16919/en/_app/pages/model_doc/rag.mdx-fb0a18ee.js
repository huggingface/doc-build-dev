import{S as Eb,i as jb,s as Gb,e as s,k as p,w as T,t as o,M as Mb,c as a,d as t,m as h,a as d,x as w,h as n,b as l,F as e,g as v,y as k,q,o as y,B as x,v as Ab,L as cn}from"../../chunks/vendor-6b77c823.js";import{T as ge}from"../../chunks/Tip-39098574.js";import{D as G}from"../../chunks/Docstring-1088f2fb.js";import{C as ln}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _e}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as dn}from"../../chunks/ExampleCodeBlock-5212b321.js";function Pb(F){let c,b,u,g,f;return g=new ln({props:{code:`# To load the default "wiki_dpr" dataset with 21M passages from wikipedia (index name is 'compressed' or 'exact')
...
<span class="hljs-meta">... </span>    doc_scores=doc_scores,
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_string = tokenizer.batch_decode(generated, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){c=s("p"),b=o("Example:"),u=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var m=d(c);b=n(m,"Example:"),m.forEach(t),u=h(i),w(g.$$.fragment,i)},m(i,m){v(i,c,m),e(c,b),v(i,u,m),k(g,i,m),f=!0},p:cn,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(u),x(g,i)}}}function eT(F){let c,b,u,g,f,i,m,R,ti,Wa,qe,Ye,jr,Bt,oi,Gr,ni,Ha,pn,ri,Ba,Je,si,Qt,ai,di,Qa,hn,ii,Ua,mn,Mr,ci,Va,Xe,li,Ut,pi,hi,Ka,ye,Ze,Ar,Vt,mi,Pr,ui,Ya,ee,Kt,gi,de,un,_i,fi,Nr,vi,bi,gn,Ti,wi,_n,ki,qi,yi,et,Yt,xi,Jt,Ri,fn,Fi,$i,zi,tt,Xt,Ei,Zt,ji,vn,Gi,Mi,Ja,xe,ot,Cr,eo,Ai,Sr,Pi,Xa,Re,to,Ni,nt,oo,Ci,Lr,Si,Za,Fe,rt,Dr,no,Li,Ir,Di,ed,$e,ro,Ii,Or,Oi,td,so,ao,od,ze,st,Wr,io,Wi,Hr,Hi,nd,Z,co,Bi,Br,Qi,Ui,at,Vi,dt,lo,Ki,Qr,Yi,Ji,it,po,Xi,Ee,Zi,Ur,ec,tc,Vr,oc,nc,rc,ct,ho,sc,mo,ac,Kr,dc,ic,rd,je,lt,Yr,uo,cc,Jr,lc,sd,L,go,pc,Ge,hc,bn,mc,uc,Xr,gc,_c,fc,pt,vc,Zr,bc,Tc,te,wc,es,kc,qc,Tn,yc,xc,ts,Rc,Fc,wn,$c,zc,Ec,M,jc,kn,Gc,Mc,os,Ac,Pc,ns,Nc,Cc,rs,Sc,Lc,ss,Dc,Ic,qn,Oc,Wc,as,Hc,Bc,yn,Qc,Uc,xn,Vc,Kc,ds,Yc,Jc,Xc,_o,Zc,Rn,el,tl,ol,fo,nl,vo,rl,sl,al,ie,bo,dl,Me,il,Fn,cl,ll,is,pl,hl,ml,ht,ul,mt,ad,Ae,ut,cs,To,gl,ls,_l,dd,E,wo,fl,Pe,vl,$n,bl,Tl,ps,wl,kl,ql,gt,yl,hs,xl,Rl,ms,Fl,$l,oe,zl,us,El,jl,zn,Gl,Ml,gs,Al,Pl,En,Nl,Cl,Sl,A,Ll,jn,Dl,Il,_s,Ol,Wl,fs,Hl,Bl,vs,Ql,Ul,bs,Vl,Kl,Gn,Yl,Jl,Ts,Xl,Zl,Mn,ep,tp,An,op,np,ws,rp,sp,ap,ko,dp,Pn,ip,cp,lp,qo,pp,yo,hp,mp,up,ce,xo,gp,Ne,_p,Nn,fp,vp,ks,bp,Tp,wp,_t,kp,ft,qp,vt,Ro,yp,Fo,xp,Cn,Rp,Fp,id,Ce,bt,qs,$o,$p,ys,zp,cd,j,zo,Ep,Se,jp,Sn,Gp,Mp,xs,Ap,Pp,Np,Tt,Cp,Rs,Sp,Lp,Fs,Dp,Ip,ne,Op,$s,Wp,Hp,Ln,Bp,Qp,zs,Up,Vp,Dn,Kp,Yp,Jp,P,Xp,In,Zp,eh,Es,th,oh,js,nh,rh,Gs,sh,ah,Ms,dh,ih,On,ch,lh,As,ph,hh,Wn,mh,uh,Hn,gh,_h,Ps,fh,vh,bh,Eo,Th,Bn,wh,kh,qh,jo,yh,Go,xh,Rh,Fh,le,Mo,$h,Le,zh,Qn,Eh,jh,Ns,Gh,Mh,Ah,wt,Ph,kt,Nh,qt,Ao,Ch,Cs,Sh,ld,De,yt,Ss,Po,Lh,Ls,Dh,pd,N,No,Ih,Ie,Oh,Un,Wh,Hh,Ds,Bh,Qh,Uh,xt,Vh,Is,Kh,Yh,re,Jh,Os,Xh,Zh,Vn,em,tm,Ws,om,nm,Kn,rm,sm,am,D,dm,Yn,im,cm,Hs,lm,pm,Bs,hm,mm,Qs,um,gm,Us,_m,fm,Jn,vm,bm,Vs,Tm,wm,Xn,km,qm,Ks,ym,xm,Rm,Co,Fm,Zn,$m,zm,Em,So,jm,Lo,Gm,Mm,Am,Ys,Pm,Nm,pe,Do,Cm,Oe,Sm,er,Lm,Dm,Js,Im,Om,Wm,Rt,Hm,Ft,hd,We,$t,Xs,Io,Bm,Zs,Qm,md,$,Oo,Um,He,Vm,tr,Km,Ym,ea,Jm,Xm,Zm,zt,eu,ta,tu,ou,oa,nu,ru,se,su,na,au,du,or,iu,cu,ra,lu,pu,nr,hu,mu,uu,I,gu,rr,_u,fu,sa,vu,bu,aa,Tu,wu,da,ku,qu,ia,yu,xu,sr,Ru,Fu,ca,$u,zu,ar,Eu,ju,la,Gu,Mu,Au,Wo,Pu,dr,Nu,Cu,Su,Ho,Lu,Bo,Du,Iu,Ou,pa,Wu,Hu,he,Qo,Bu,Be,Qu,ir,Uu,Vu,ha,Ku,Yu,Ju,Et,Xu,jt,Zu,Gt,Uo,eg,Vo,tg,cr,og,ng,ud,Qe,Mt,ma,Ko,rg,ua,sg,gd,z,Yo,ag,Ue,dg,lr,ig,cg,ga,lg,pg,hg,At,mg,_a,ug,gg,fa,_g,fg,ae,vg,va,bg,Tg,pr,wg,kg,ba,qg,yg,hr,xg,Rg,Fg,O,$g,mr,zg,Eg,Ta,jg,Gg,wa,Mg,Ag,ka,Pg,Ng,qa,Cg,Sg,ur,Lg,Dg,ya,Ig,Og,gr,Wg,Hg,xa,Bg,Qg,Ug,Jo,Vg,_r,Kg,Yg,Jg,Xo,Xg,Zo,Zg,e_,t_,Ra,o_,n_,me,en,r_,Ve,s_,fr,a_,d_,Fa,i_,c_,l_,Pt,p_,Nt,h_,Ct,tn,m_,$a,u_,_d;return i=new _e({}),Bt=new _e({}),Vt=new _e({}),Kt=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"doc_sep"},{anchor:"transformers.RagConfig.n_docs",description:`<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to 5) &#x2014;
...
<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"retrieval_batch_size"},{anchor:"transformers.RagConfig.dataset",description:`<strong>dataset</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;wiki_dpr&quot;</code>) &#x2014;
...
generator_tokenizer.`,name:"question_encoder_tokenizer"},{anchor:"transformers.RagRetriever.generator_tokenizer",description:`<strong>generator_tokenizer</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
...
Prefix added at the beginning of each input, typically used with T5-based models.`,name:"prefix"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/retrieval_rag.py#L466",returnDescription:`
...
The number of docs retrieved per query.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/retrieval_rag.py#L538",returnDescription:`
...
<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.RagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L493"}}),pt=new ge({props:{$$slots:{default:[Nb]},$$scope:{ctx:F}}}),bo=new G({props:{name:"forward",anchor:"transformers.RagModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"}],parametersDescription:[{anchor:"transformers.RagModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
...
<code>context_attention_mask</code>. See returned tensors for more detail.`,name:"output_retrieved(bool,"},{anchor:"transformers.RagModel.forward.n_docs",description:"<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to `config.n_docs&#x201C;) &#x2014;\nNumber of documents to retrieve and/or number of documents for which to generate an answer.",name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L536",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagConfig"
...
`}}),ht=new ge({props:{$$slots:{default:[Cb]},$$scope:{ctx:F}}}),mt=new dn({props:{anchor:"transformers.RagModel.forward.example",$$slots:{default:[Sb]},$$scope:{ctx:F}}}),To=new _e({}),wo=new G({props:{name:"class transformers.RagSequenceForGeneration",anchor:"transformers.RagSequenceForGeneration",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L766",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16919/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_16919/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L908",returnDescription:`
<p>The generated
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L1134"}}),Tt=new ge({props:{$$slots:{default:[Ob]},$$scope:{ctx:F}}}),Mo=new G({props:{name:"forward",anchor:"transformers.RagTokenForGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"doc_scores",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"do_marginalize",val:" = None"},{name:"reduce_loss",val:" = None"},{name:"labels",val:" = None"},{name:"n_docs",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagTokenForGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
obtain the indices.</p>
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L1233",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16919/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
crash. Note that using <code>remove_invalid_values</code> can slow down generation.`,name:"remove_invalid_values"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_rag.py#L1375",returnDescription:`
<p>The generated
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.TFRagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_tf_rag.py#L483"}}),xt=new ge({props:{$$slots:{default:[Bb]},$$scope:{ctx:F}}}),Do=new G({props:{name:"call",anchor:"transformers.TFRagModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFRagModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
...
Whether or not to return a <code>TFRetrievAugLMOutput</code> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.TFRagModel.call.n_docs",description:"<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to `config.n_docs&#x201C;) &#x2014;\nNumber of documents to retrieve and/or number of documents for which to generate an answer.",name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_tf_rag.py#L534",returnDescription:`
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagSequenceForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_tf_rag.py#L1406",returnDescription:`
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16919/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_tf_rag.py#L820",returnDescription:`
<p>A <code>transformers.models.rag.modeling_tf_rag.TFRetrievAugLMMarginOutput</code> or a tuple of <code>tf.Tensor</code> (if
<code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various elements depending on the
configuration (<a
  href="/docs/transformers/pr_16919/en/model_doc/rag#transformers.RagConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_16919/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_specific_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"return_dict_in_generate"}],source:"https://github.com/huggingface/transformers/blob/pr_16919/src/transformers/models/rag/modeling_tf_rag.py#L975",returnDescription:`
<p>The generated sequences. The
...
decoder model configuration.`),zi=p(),tt=s("div"),T(Xt.$$.fragment),Ei=p(),Zt=s("p"),ji=o("Serializes this instance to a Python dictionary. Override the default "),vn=s("a"),Gi=o("to_dict()"),Mi=o("."),Ja=p(),xe=s("h2"),ot=s("a"),Cr=s("span"),T(eo.$$.fragment),Ai=p(),Sr=s("span"),Pi=o("RagTokenizer"),Xa=p(),Re=s("div"),T(to.$$.fragment),Ni=p(),nt=s("div"),T(oo.$$.fragment),Ci=p(),Lr=s("p"),Si=o(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Za=p(),Fe=s("h2"),rt=s("a"),Dr=s("span"),T(no.$$.fragment),Li=p(),Ir=s("span"),Di=o("Rag specific outputs"),ed=p(),$e=s("div"),T(ro.$$.fragment),Ii=p(),Or=s("p"),Oi=o("Base class for retriever augmented marginalized models outputs."),td=p(),so=s("div"),T(ao.$$.fragment),od=p(),ze=s("h2"),st=s("a"),Wr=s("span"),T(io.$$.fragment),Wi=p(),Hr=s("span"),Hi=o("RagRetriever"),nd=p(),Z=s("div"),T(co.$$.fragment),Bi=p(),Br=s("p"),Qi=o(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
any `),gs=s("em"),Al=o("seq2seq"),Pl=o(" model, preferably "),En=s("a"),Nl=o("BartForConditionalGeneration"),Cl=o("."),Sl=p(),A=s("p"),Ll=o("The model can be initialized with a "),jn=s("a"),Dl=o("RagRetriever"),Il=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up=p(),ce=s("div"),T(xo.$$.fragment),gp=p(),Ne=s("p"),_p=o("The "),Nn=s("a"),fp=o("RagSequenceForGeneration"),vp=o(" forward method, overrides the "),ks=s("code"),bp=o("__call__"),Tp=o(" special method."),wp=p(),T(_t.$$.fragment),kp=p(),T(ft.$$.fragment),qp=p(),vt=s("div"),T(Ro.$$.fragment),yp=p(),Fo=s("p"),xp=o("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Cn=s("a"),Rp=o("generate()"),Fp=o("`\ndocumentation for more information on how to set other generate input parameters."),id=p(),Ce=s("h2"),bt=s("a"),qs=s("span"),T($o.$$.fragment),$p=p(),ys=s("span"),zp=o("RagTokenForGeneration"),cd=p(),j=s("div"),T(zo.$$.fragment),Ep=p(),Se=s("p"),jp=o("The "),Sn=s("a"),Gp=o("RagTokenForGeneration"),Mp=o(" forward method, overrides the "),xs=s("code"),Ap=o("__call__"),Pp=o(" special method."),Np=p(),T(Tt.$$.fragment),Cp=p(),Rs=s("p"),Sp=o("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Lp=p(),Fs=s("p"),Dp=o(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Ip=p(),ne=s("p"),Op=o("The question encoder can be any "),$s=s("em"),Wp=o("autoencoding"),Hp=o(" model, preferably "),Ln=s("a"),Bp=o("DPRQuestionEncoder"),Qp=o(`, and the generator can be
any `),zs=s("em"),Up=o("seq2seq"),Vp=o(" model, preferably "),Dn=s("a"),Kp=o("BartForConditionalGeneration"),Yp=o("."),Jp=p(),P=s("p"),Xp=o("The model can be initialized with a "),In=s("a"),Zp=o("RagRetriever"),eh=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
It has been tested with `),On=s("a"),ch=o("DPRQuestionEncoder"),lh=o(" as the "),As=s("code"),ph=o("question_encoder"),hh=o(" and "),Wn=s("a"),mh=o("BartForConditionalGeneration"),uh=o(` or
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fh=p(),le=s("div"),T(Mo.$$.fragment),$h=p(),Le=s("p"),zh=o("The "),Qn=s("a"),Eh=o("RagTokenForGeneration"),jh=o(" forward method, overrides the "),Ns=s("code"),Gh=o("__call__"),Mh=o(" special method."),Ah=p(),T(wt.$$.fragment),Ph=p(),T(kt.$$.fragment),Nh=p(),qt=s("div"),T(Ao.$$.fragment),Ch=p(),Cs=s("p"),Sh=o("Implements RAG token decoding."),ld=p(),De=s("h2"),yt=s("a"),Ss=s("span"),T(Po.$$.fragment),Lh=p(),Ls=s("span"),Dh=o("TFRagModel"),pd=p(),N=s("div"),T(No.$$.fragment),Ih=p(),Ie=s("p"),Oh=o("The "),Un=s("a"),Wh=o("TFRagModel"),Hh=o(" forward method, overrides the "),Ds=s("code"),Bh=o("__call__"),Qh=o(" special method."),Uh=p(),T(xt.$$.fragment),Vh=p(),Is=s("p"),Kh=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
the generator.`),Yh=p(),re=s("p"),Jh=o("The question encoder can be any "),Os=s("em"),Xh=o("autoencoding"),Zh=o(" model, preferably "),Vn=s("a"),em=o("TFDPRQuestionEncoder"),tm=o(`, and the generator can be
any `),Ws=s("em"),om=o("seq2seq"),nm=o(" model, preferably "),Kn=s("a"),rm=o("TFBartForConditionalGeneration"),sm=o("."),am=p(),D=s("p"),dm=o("The model can be initialized with a "),Yn=s("a"),im=o("RagRetriever"),cm=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),Ks=s("code"),ym=o("generator"),xm=o("."),Rm=p(),Co=s("p"),Fm=o("This model inherits from "),Zn=s("a"),$m=o("TFPreTrainedModel"),zm=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em=p(),So=s("p"),jm=o("This model is also a Tensorflow "),Lo=s("a"),Gm=o("tf.keras.Model"),Mm=o(`
...
SavedModel format.`),Nm=p(),pe=s("div"),T(Do.$$.fragment),Cm=p(),Oe=s("p"),Sm=o("The "),er=s("a"),Lm=o("TFRagModel"),Dm=o(" forward method, overrides the "),Js=s("code"),Im=o("__call__"),Om=o(" special method."),Wm=p(),T(Rt.$$.fragment),Hm=p(),T(Ft.$$.fragment),hd=p(),We=s("h2"),$t=s("a"),Xs=s("span"),T(Io.$$.fragment),Bm=p(),Zs=s("span"),Qm=o("TFRagSequenceForGeneration"),md=p(),$=s("div"),T(Oo.$$.fragment),Um=p(),He=s("p"),Vm=o("The "),tr=s("a"),Km=o("TFRagSequenceForGeneration"),Ym=o(" forward method, overrides the "),ea=s("code"),Jm=o("__call__"),Xm=o(" special method."),Zm=p(),T(zt.$$.fragment),eu=p(),ta=s("p"),tu=o("A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),ou=p(),oa=s("p"),nu=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
any `),ra=s("em"),lu=o("seq2seq"),pu=o(" model, preferably "),nr=s("a"),hu=o("TFBartForConditionalGeneration"),mu=o("."),uu=p(),I=s("p"),gu=o("The model can be initialized with a "),rr=s("a"),_u=o("RagRetriever"),fu=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),la=s("code"),Gu=o("generator"),Mu=o("."),Au=p(),Wo=s("p"),Pu=o("This model inherits from "),dr=s("a"),Nu=o("TFPreTrainedModel"),Cu=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Su=p(),Ho=s("p"),Lu=o("This model is also a Tensorflow "),Bo=s("a"),Du=o("tf.keras.Model"),Iu=o(`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Ou=p(),pa=s("p"),Wu=o(`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
...
any `),ba=s("em"),qg=o("seq2seq"),yg=o(" model, preferably "),hr=s("a"),xg=o("TFBartForConditionalGeneration"),Rg=o("."),Fg=p(),O=s("p"),$g=o("The model can be initialized with a "),mr=s("a"),zg=o("RagRetriever"),Eg=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Karpukhin, Naman Goyal, Heinrich K\xFCttler, Mike Lewis, Wen-tau Yih, Tim Rockt\xE4schel, Sebastian Riedel, Douwe Kiela.`),rn.forEach(t),Qa=h(r),hn=a(r,"P",{});var Ca=d(hn);ii=n(Ca,"The abstract from the paper is the following:"),Ca.forEach(t),Ua=h(r),mn=a(r,"P",{});var Sa=d(mn);Mr=a(Sa,"EM",{});var La=d(Mr);ci=n(La,`Large pre-trained language models have been shown to store factual knowledge in their parameters, and achieve
state-of-the-art results when fine-tuned on downstream NLP tasks. However, their ability to access and precisely
manipulate knowledge is still limited, and hence on knowledge-intensive tasks, their performance lags behind
task-specific architectures. Additionally, providing provenance for their decisions and updating their world knowledge
remain open research problems. Pre-trained models with a differentiable access mechanism to explicit nonparametric
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),La.forEach(t),Sa.forEach(t),Va=h(r),Xe=a(r,"P",{});var sn=d(Xe);li=n(sn,"This model was contributed by "),Ut=a(sn,"A",{href:!0,rel:!0});var Da=d(Ut);pi=n(Da,"ola13"),Da.forEach(t),hi=n(sn,"."),sn.forEach(t),Ka=h(r),ye=a(r,"H2",{class:!0});var an=d(ye);Ze=a(an,"A",{id:!0,class:!0,href:!0});var Ia=d(Ze);Ar=a(Ia,"SPAN",{});var Oa=d(Ar);w(Vt.$$.fragment,Oa),Oa.forEach(t),Ia.forEach(t),mi=h(an),Pr=a(an,"SPAN",{});var g_=d(Pr);ui=n(g_,"RagConfig"),g_.forEach(t),an.forEach(t),Ya=h(r),ee=a(r,"DIV",{class:!0});var St=d(ee);w(Kt.$$.fragment,St),gi=h(St),de=a(St,"P",{});var Ke=d(de);un=a(Ke,"A",{href:!0});var __=d(un);_i=n(__,"RagConfig"),__.forEach(t),fi=n(Ke," stores the configuration of a "),Nr=a(Ke,"EM",{});var f_=d(Nr);vi=n(f_,"RagModel"),f_.forEach(t),bi=n(Ke,". Configuration objects inherit from "),gn=a(Ke,"A",{href:!0});var v_=d(gn);Ti=n(v_,"PretrainedConfig"),v_.forEach(t),wi=n(Ke,` and
can be used to control the model outputs. Read the documentation from `),_n=a(Ke,"A",{href:!0});var b_=d(_n);ki=n(b_,"PretrainedConfig"),b_.forEach(t),qi=n(Ke," for more information."),Ke.forEach(t),yi=h(St),et=a(St,"DIV",{class:!0});var fd=d(et);w(Yt.$$.fragment,fd),xi=h(fd),Jt=a(fd,"P",{});var vd=d(Jt);Ri=n(vd,"Instantiate a "),fn=a(vd,"A",{href:!0});var T_=d(fn);Fi=n(T_,"EncoderDecoderConfig"),T_.forEach(t),$i=n(vd,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),vd.forEach(t),fd.forEach(t),zi=h(St),tt=a(St,"DIV",{class:!0});var bd=d(tt);w(Xt.$$.fragment,bd),Ei=h(bd),Zt=a(bd,"P",{});var Td=d(Zt);ji=n(Td,"Serializes this instance to a Python dictionary. Override the default "),vn=a(Td,"A",{href:!0});var w_=d(vn);Gi=n(w_,"to_dict()"),w_.forEach(t),Mi=n(Td,"."),Td.forEach(t),bd.forEach(t),St.forEach(t),Ja=h(r),xe=a(r,"H2",{class:!0});var wd=d(xe);ot=a(wd,"A",{id:!0,class:!0,href:!0});var k_=d(ot);Cr=a(k_,"SPAN",{});var q_=d(Cr);w(eo.$$.fragment,q_),q_.forEach(t),k_.forEach(t),Ai=h(wd),Sr=a(wd,"SPAN",{});var y_=d(Sr);Pi=n(y_,"RagTokenizer"),y_.forEach(t),wd.forEach(t),Xa=h(r),Re=a(r,"DIV",{class:!0});var kd=d(Re);w(to.$$.fragment,kd),Ni=h(kd),nt=a(kd,"DIV",{class:!0});var qd=d(nt);w(oo.$$.fragment,qd),Ci=h(qd),Lr=a(qd,"P",{});var x_=d(Lr);Si=n(x_,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),x_.forEach(t),qd.forEach(t),kd.forEach(t),Za=h(r),Fe=a(r,"H2",{class:!0});var yd=d(Fe);rt=a(yd,"A",{id:!0,class:!0,href:!0});var R_=d(rt);Dr=a(R_,"SPAN",{});var F_=d(Dr);w(no.$$.fragment,F_),F_.forEach(t),R_.forEach(t),Li=h(yd),Ir=a(yd,"SPAN",{});var $_=d(Ir);Di=n($_,"Rag specific outputs"),$_.forEach(t),yd.forEach(t),ed=h(r),$e=a(r,"DIV",{class:!0});var xd=d($e);w(ro.$$.fragment,xd),Ii=h(xd),Or=a(xd,"P",{});var z_=d(Or);Oi=n(z_,"Base class for retriever augmented marginalized models outputs."),z_.forEach(t),xd.forEach(t),td=h(r),so=a(r,"DIV",{class:!0});var E_=d(so);w(ao.$$.fragment,E_),E_.forEach(t),od=h(r),ze=a(r,"H2",{class:!0});var Rd=d(ze);st=a(Rd,"A",{id:!0,class:!0,href:!0});var j_=d(st);Wr=a(j_,"SPAN",{});var G_=d(Wr);w(io.$$.fragment,G_),G_.forEach(t),j_.forEach(t),Wi=h(Rd),Hr=a(Rd,"SPAN",{});var M_=d(Hr);Hi=n(M_,"RagRetriever"),M_.forEach(t),Rd.forEach(t),nd=h(r),Z=a(r,"DIV",{class:!0});var ue=d(Z);w(co.$$.fragment,ue),Bi=h(ue),Br=a(ue,"P",{});var A_=d(Br);Qi=n(A_,`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
contents, and it formats them to be used with a RagModel.`),A_.forEach(t),Ui=h(ue),w(at.$$.fragment,ue),Vi=h(ue),dt=a(ue,"DIV",{class:!0});var Fd=d(dt);w(lo.$$.fragment,Fd),Ki=h(Fd),Qr=a(Fd,"P",{});var P_=d(Qr);Yi=n(P_,"Retriever initialization function. It loads the index into memory."),P_.forEach(t),Fd.forEach(t),Ji=h(ue),it=a(ue,"DIV",{class:!0});var $d=d(it);w(po.$$.fragment,$d),Xi=h($d),Ee=a($d,"P",{});var vr=d(Ee);Zi=n(vr,"Postprocessing retrieved "),Ur=a(vr,"CODE",{});var N_=d(Ur);ec=n(N_,"docs"),N_.forEach(t),tc=n(vr," and combining them with "),Vr=a(vr,"CODE",{});var C_=d(Vr);oc=n(C_,"input_strings"),C_.forEach(t),nc=n(vr,"."),vr.forEach(t),$d.forEach(t),rc=h(ue),ct=a(ue,"DIV",{class:!0});var zd=d(ct);w(ho.$$.fragment,zd),sc=h(zd),mo=a(zd,"P",{});var Ed=d(mo);ac=n(Ed,"Retrieves documents for specified "),Kr=a(Ed,"CODE",{});var S_=d(Kr);dc=n(S_,"question_hidden_states"),S_.forEach(t),ic=n(Ed,"."),Ed.forEach(t),zd.forEach(t),ue.forEach(t),rd=h(r),je=a(r,"H2",{class:!0});var jd=d(je);lt=a(jd,"A",{id:!0,class:!0,href:!0});var L_=d(lt);Yr=a(L_,"SPAN",{});var D_=d(Yr);w(uo.$$.fragment,D_),D_.forEach(t),L_.forEach(t),cc=h(jd),Jr=a(jd,"SPAN",{});var I_=d(Jr);lc=n(I_,"RagModel"),I_.forEach(t),jd.forEach(t),sd=h(r),L=a(r,"DIV",{class:!0});var X=d(L);w(go.$$.fragment,X),pc=h(X),Ge=a(X,"P",{});var br=d(Ge);hc=n(br,"The "),bn=a(br,"A",{href:!0});var O_=d(bn);mc=n(O_,"RagModel"),O_.forEach(t),uc=n(br," forward method, overrides the "),Xr=a(br,"CODE",{});var W_=d(Xr);gc=n(W_,"__call__"),W_.forEach(t),_c=n(br," special method."),br.forEach(t),fc=h(X),w(pt.$$.fragment,X),vc=h(X),Zr=a(X,"P",{});var H_=d(Zr);bc=n(H_,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
any `),gs=a(ve,"EM",{});var bf=d(gs);Al=n(bf,"seq2seq"),bf.forEach(t),Pl=n(ve," model, preferably "),En=a(ve,"A",{href:!0});var Tf=d(En);Nl=n(Tf,"BartForConditionalGeneration"),Tf.forEach(t),Cl=n(ve,"."),ve.forEach(t),Sl=h(H),A=a(H,"P",{});var B=d(A);Ll=n(B,"The model can be initialized with a "),jn=a(B,"A",{href:!0});var wf=d(jn);Dl=n(wf,"RagRetriever"),wf.forEach(t),Il=n(B,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd.forEach(t),up=h(H),ce=a(H,"DIV",{class:!0});var Dt=d(ce);w(xo.$$.fragment,Dt),gp=h(Dt),Ne=a(Dt,"P",{});var kr=d(Ne);_p=n(kr,"The "),Nn=a(kr,"A",{href:!0});var Mf=d(Nn);fp=n(Mf,"RagSequenceForGeneration"),Mf.forEach(t),vp=n(kr," forward method, overrides the "),ks=a(kr,"CODE",{});var Af=d(ks);bp=n(Af,"__call__"),Af.forEach(t),Tp=n(kr," special method."),kr.forEach(t),wp=h(Dt),w(_t.$$.fragment,Dt),kp=h(Dt),w(ft.$$.fragment,Dt),Dt.forEach(t),qp=h(H),vt=a(H,"DIV",{class:!0});var Cd=d(vt);w(Ro.$$.fragment,Cd),yp=h(Cd),Fo=a(Cd,"P",{});var Sd=d(Fo);xp=n(Sd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Cn=a(Sd,"A",{href:!0});var Pf=d(Cn);Rp=n(Pf,"generate()"),Pf.forEach(t),Fp=n(Sd,"`\ndocumentation for more information on how to set other generate input parameters."),Sd.forEach(t),Cd.forEach(t),H.forEach(t),id=h(r),Ce=a(r,"H2",{class:!0});var Ld=d(Ce);bt=a(Ld,"A",{id:!0,class:!0,href:!0});var Nf=d(bt);qs=a(Nf,"SPAN",{});var Cf=d(qs);w($o.$$.fragment,Cf),Cf.forEach(t),Nf.forEach(t),$p=h(Ld),ys=a(Ld,"SPAN",{});var Sf=d(ys);zp=n(Sf,"RagTokenForGeneration"),Sf.forEach(t),Ld.forEach(t),cd=h(r),j=a(r,"DIV",{class:!0});var Q=d(j);w(zo.$$.fragment,Q),Ep=h(Q),Se=a(Q,"P",{});var qr=d(Se);jp=n(qr,"The "),Sn=a(qr,"A",{href:!0});var Lf=d(Sn);Gp=n(Lf,"RagTokenForGeneration"),Lf.forEach(t),Mp=n(qr," forward method, overrides the "),xs=a(qr,"CODE",{});var Df=d(xs);Ap=n(Df,"__call__"),Df.forEach(t),Pp=n(qr," special method."),qr.forEach(t),Np=h(Q),w(Tt.$$.fragment,Q),Cp=h(Q),Rs=a(Q,"P",{});var If=d(Rs);Sp=n(If,"A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),If.forEach(t),Lp=h(Q),Fs=a(Q,"P",{});var Of=d(Fs);Dp=n(Of,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Of.forEach(t),Ip=h(Q),ne=a(Q,"P",{});var be=d(ne);Op=n(be,"The question encoder can be any "),$s=a(be,"EM",{});var Wf=d($s);Wp=n(Wf,"autoencoding"),Wf.forEach(t),Hp=n(be," model, preferably "),Ln=a(be,"A",{href:!0});var Hf=d(Ln);Bp=n(Hf,"DPRQuestionEncoder"),Hf.forEach(t),Qp=n(be,`, and the generator can be
any `),zs=a(be,"EM",{});var Bf=d(zs);Up=n(Bf,"seq2seq"),Bf.forEach(t),Vp=n(be," model, preferably "),Dn=a(be,"A",{href:!0});var Qf=d(Dn);Kp=n(Qf,"BartForConditionalGeneration"),Qf.forEach(t),Yp=n(be,"."),be.forEach(t),Jp=h(Q),P=a(Q,"P",{});var U=d(P);Xp=n(U,"The model can be initialized with a "),In=a(U,"A",{href:!0});var Uf=d(In);Zp=n(Uf,"RagRetriever"),Uf.forEach(t),eh=n(U,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
It has been tested with `),On=a(U,"A",{href:!0});var Xf=d(On);ch=n(Xf,"DPRQuestionEncoder"),Xf.forEach(t),lh=n(U," as the "),As=a(U,"CODE",{});var Zf=d(As);ph=n(Zf,"question_encoder"),Zf.forEach(t),hh=n(U," and "),Wn=a(U,"A",{href:!0});var ev=d(Wn);mh=n(ev,"BartForConditionalGeneration"),ev.forEach(t),uh=n(U,` or
`),Hn=a(U,"A",{href:!0});var tv=d(Hn);gh=n(tv,"T5ForConditionalGeneration"),tv.forEach(t),_h=n(U," as the "),Ps=a(U,"CODE",{});var ov=d(Ps);fh=n(ov,"generator"),ov.forEach(t),vh=n(U,"."),U.forEach(t),bh=h(Q),Eo=a(Q,"P",{});var Dd=d(Eo);Th=n(Dd,"This model inherits from "),Bn=a(Dd,"A",{href:!0});var nv=d(Bn);wh=n(nv,"PreTrainedModel"),nv.forEach(t),kh=n(Dd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dd.forEach(t),qh=h(Q),jo=a(Q,"P",{});var Id=d(jo);yh=n(Id,"This model is also a PyTorch "),Go=a(Id,"A",{href:!0,rel:!0});var rv=d(Go);xh=n(rv,"torch.nn.Module"),rv.forEach(t),Rh=n(Id,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Id.forEach(t),Fh=h(Q),le=a(Q,"DIV",{class:!0});var It=d(le);w(Mo.$$.fragment,It),$h=h(It),Le=a(It,"P",{});var yr=d(Le);zh=n(yr,"The "),Qn=a(yr,"A",{href:!0});var sv=d(Qn);Eh=n(sv,"RagTokenForGeneration"),sv.forEach(t),jh=n(yr," forward method, overrides the "),Ns=a(yr,"CODE",{});var av=d(Ns);Gh=n(av,"__call__"),av.forEach(t),Mh=n(yr," special method."),yr.forEach(t),Ah=h(It),w(wt.$$.fragment,It),Ph=h(It),w(kt.$$.fragment,It),It.forEach(t),Nh=h(Q),qt=a(Q,"DIV",{class:!0});var Od=d(qt);w(Ao.$$.fragment,Od),Ch=h(Od),Cs=a(Od,"P",{});var dv=d(Cs);Sh=n(dv,"Implements RAG token decoding."),dv.forEach(t),Od.forEach(t),Q.forEach(t),ld=h(r),De=a(r,"H2",{class:!0});var Wd=d(De);yt=a(Wd,"A",{id:!0,class:!0,href:!0});var iv=d(yt);Ss=a(iv,"SPAN",{});var cv=d(Ss);w(Po.$$.fragment,cv),cv.forEach(t),iv.forEach(t),Lh=h(Wd),Ls=a(Wd,"SPAN",{});var lv=d(Ls);Dh=n(lv,"TFRagModel"),lv.forEach(t),Wd.forEach(t),pd=h(r),N=a(r,"DIV",{class:!0});var V=d(N);w(No.$$.fragment,V),Ih=h(V),Ie=a(V,"P",{});var xr=d(Ie);Oh=n(xr,"The "),Un=a(xr,"A",{href:!0});var pv=d(Un);Wh=n(pv,"TFRagModel"),pv.forEach(t),Hh=n(xr," forward method, overrides the "),Ds=a(xr,"CODE",{});var hv=d(Ds);Bh=n(hv,"__call__"),hv.forEach(t),Qh=n(xr," special method."),xr.forEach(t),Uh=h(V),w(xt.$$.fragment,V),Vh=h(V),Is=a(V,"P",{});var mv=d(Is);Kh=n(mv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),mv.forEach(t),Yh=h(V),re=a(V,"P",{});var Te=d(re);Jh=n(Te,"The question encoder can be any "),Os=a(Te,"EM",{});var uv=d(Os);Xh=n(uv,"autoencoding"),uv.forEach(t),Zh=n(Te," model, preferably "),Vn=a(Te,"A",{href:!0});var gv=d(Vn);em=n(gv,"TFDPRQuestionEncoder"),gv.forEach(t),tm=n(Te,`, and the generator can be
any `),Ws=a(Te,"EM",{});var _v=d(Ws);om=n(_v,"seq2seq"),_v.forEach(t),nm=n(Te," model, preferably "),Kn=a(Te,"A",{href:!0});var fv=d(Kn);rm=n(fv,"TFBartForConditionalGeneration"),fv.forEach(t),sm=n(Te,"."),Te.forEach(t),am=h(V),D=a(V,"P",{});var K=d(D);dm=n(K,"The model can be initialized with a "),Yn=a(K,"A",{href:!0});var vv=d(Yn);im=n(vv,"RagRetriever"),vv.forEach(t),cm=n(K,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),Ks=a(K,"CODE",{});var Rv=d(Ks);ym=n(Rv,"generator"),Rv.forEach(t),xm=n(K,"."),K.forEach(t),Rm=h(V),Co=a(V,"P",{});var Hd=d(Co);Fm=n(Hd,"This model inherits from "),Zn=a(Hd,"A",{href:!0});var Fv=d(Zn);$m=n(Fv,"TFPreTrainedModel"),Fv.forEach(t),zm=n(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(t),Em=h(V),So=a(V,"P",{});var Bd=d(So);jm=n(Bd,"This model is also a Tensorflow "),Lo=a(Bd,"A",{href:!0,rel:!0});var $v=d(Lo);Gm=n($v,"tf.keras.Model"),$v.forEach(t),Mm=n(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
SavedModel format.`),zv.forEach(t),Nm=h(V),pe=a(V,"DIV",{class:!0});var Ot=d(pe);w(Do.$$.fragment,Ot),Cm=h(Ot),Oe=a(Ot,"P",{});var Rr=d(Oe);Sm=n(Rr,"The "),er=a(Rr,"A",{href:!0});var Ev=d(er);Lm=n(Ev,"TFRagModel"),Ev.forEach(t),Dm=n(Rr," forward method, overrides the "),Js=a(Rr,"CODE",{});var jv=d(Js);Im=n(jv,"__call__"),jv.forEach(t),Om=n(Rr," special method."),Rr.forEach(t),Wm=h(Ot),w(Rt.$$.fragment,Ot),Hm=h(Ot),w(Ft.$$.fragment,Ot),Ot.forEach(t),V.forEach(t),hd=h(r),We=a(r,"H2",{class:!0});var Qd=d(We);$t=a(Qd,"A",{id:!0,class:!0,href:!0});var Gv=d($t);Xs=a(Gv,"SPAN",{});var Mv=d(Xs);w(Io.$$.fragment,Mv),Mv.forEach(t),Gv.forEach(t),Bm=h(Qd),Zs=a(Qd,"SPAN",{});var Av=d(Zs);Qm=n(Av,"TFRagSequenceForGeneration"),Av.forEach(t),Qd.forEach(t),md=h(r),$=a(r,"DIV",{class:!0});var C=d($);w(Oo.$$.fragment,C),Um=h(C),He=a(C,"P",{});var Fr=d(He);Vm=n(Fr,"The "),tr=a(Fr,"A",{href:!0});var Pv=d(tr);Km=n(Pv,"TFRagSequenceForGeneration"),Pv.forEach(t),Ym=n(Fr," forward method, overrides the "),ea=a(Fr,"CODE",{});var Nv=d(ea);Jm=n(Nv,"__call__"),Nv.forEach(t),Xm=n(Fr," special method."),Fr.forEach(t),Zm=h(C),w(zt.$$.fragment,C),eu=h(C),ta=a(C,"P",{});var Cv=d(ta);tu=n(Cv,"A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),Cv.forEach(t),ou=h(C),oa=a(C,"P",{});var Sv=d(oa);nu=n(Sv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Sv.forEach(t),ru=h(C),se=a(C,"P",{});var we=d(se);su=n(we,"The question encoder can be any "),na=a(we,"EM",{});var Lv=d(na);au=n(Lv,"autoencoding"),Lv.forEach(t),du=n(we," model, preferably "),or=a(we,"A",{href:!0});var Dv=d(or);iu=n(Dv,"TFDPRQuestionEncoder"),Dv.forEach(t),cu=n(we,`, and the generator can be
any `),ra=a(we,"EM",{});var Iv=d(ra);lu=n(Iv,"seq2seq"),Iv.forEach(t),pu=n(we," model, preferably "),nr=a(we,"A",{href:!0});var Ov=d(nr);hu=n(Ov,"TFBartForConditionalGeneration"),Ov.forEach(t),mu=n(we,"."),we.forEach(t),uu=h(C),I=a(C,"P",{});var Y=d(I);gu=n(Y,"The model can be initialized with a "),rr=a(Y,"A",{href:!0});var Wv=d(rr);_u=n(Wv,"RagRetriever"),Wv.forEach(t),fu=n(Y,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),la=a(Y,"CODE",{});var Jv=d(la);Gu=n(Jv,"generator"),Jv.forEach(t),Mu=n(Y,"."),Y.forEach(t),Au=h(C),Wo=a(C,"P",{});var Ud=d(Wo);Pu=n(Ud,"This model inherits from "),dr=a(Ud,"A",{href:!0});var Xv=d(dr);Nu=n(Xv,"TFPreTrainedModel"),Xv.forEach(t),Cu=n(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),Su=h(C),Ho=a(C,"P",{});var Vd=d(Ho);Lu=n(Vd,"This model is also a Tensorflow "),Bo=a(Vd,"A",{href:!0,rel:!0});var Zv=d(Bo);Du=n(Zv,"tf.keras.Model"),Zv.forEach(t),Iu=n(Vd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Vd.forEach(t),Ou=h(C),pa=a(C,"P",{});var eb=d(pa);Wu=n(eb,`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),eb.forEach(t),Hu=h(C),he=a(C,"DIV",{class:!0});var Wt=d(he);w(Qo.$$.fragment,Wt),Bu=h(Wt),Be=a(Wt,"P",{});var $r=d(Be);Qu=n($r,"The "),ir=a($r,"A",{href:!0});var tb=d(ir);Uu=n(tb,"TFRagSequenceForGeneration"),tb.forEach(t),Vu=n($r," forward method, overrides the "),ha=a($r,"CODE",{});var ob=d(ha);Ku=n(ob,"__call__"),ob.forEach(t),Yu=n($r," special method."),$r.forEach(t),Ju=h(Wt),w(Et.$$.fragment,Wt),Xu=h(Wt),w(jt.$$.fragment,Wt),Wt.forEach(t),Zu=h(C),Gt=a(C,"DIV",{class:!0});var Kd=d(Gt);w(Uo.$$.fragment,Kd),eg=h(Kd),Vo=a(Kd,"P",{});var Yd=d(Vo);tg=n(Yd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),cr=a(Yd,"A",{href:!0});var nb=d(cr);og=n(nb,"generate()"),nb.forEach(t),ng=n(Yd,"`\ndocumentation for more information on how to set other generate input parameters"),Yd.forEach(t),Kd.forEach(t),C.forEach(t),ud=h(r),Qe=a(r,"H2",{class:!0});var Jd=d(Qe);Mt=a(Jd,"A",{id:!0,class:!0,href:!0});var rb=d(Mt);ma=a(rb,"SPAN",{});var sb=d(ma);w(Ko.$$.fragment,sb),sb.forEach(t),rb.forEach(t),rg=h(Jd),ua=a(Jd,"SPAN",{});var ab=d(ua);sg=n(ab,"TFRagTokenForGeneration"),ab.forEach(t),Jd.forEach(t),gd=h(r),z=a(r,"DIV",{class:!0});var S=d(z);w(Yo.$$.fragment,S),ag=h(S),Ue=a(S,"P",{});var zr=d(Ue);dg=n(zr,"The "),lr=a(zr,"A",{href:!0});var db=d(lr);ig=n(db,"TFRagTokenForGeneration"),db.forEach(t),cg=n(zr," forward method, overrides the "),ga=a(zr,"CODE",{});var ib=d(ga);lg=n(ib,"__call__"),ib.forEach(t),pg=n(zr," special method."),zr.forEach(t),hg=h(S),w(At.$$.fragment,S),mg=h(S),_a=a(S,"P",{});var cb=d(_a);ug=n(cb,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),cb.forEach(t),gg=h(S),fa=a(S,"P",{});var lb=d(fa);_g=n(lb,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),lb.forEach(t),fg=h(S),ae=a(S,"P",{});var ke=d(ae);vg=n(ke,"The question encoder can be any "),va=a(ke,"EM",{});var pb=d(va);bg=n(pb,"autoencoding"),pb.forEach(t),Tg=n(ke," model, preferably "),pr=a(ke,"A",{href:!0});var hb=d(pr);wg=n(hb,"TFDPRQuestionEncoder"),hb.forEach(t),kg=n(ke,`, and the generator can be
any `),ba=a(ke,"EM",{});var mb=d(ba);qg=n(mb,"seq2seq"),mb.forEach(t),yg=n(ke," model, preferably "),hr=a(ke,"A",{href:!0});var ub=d(hr);xg=n(ub,"TFBartForConditionalGeneration"),ub.forEach(t),Rg=n(ke,"."),ke.forEach(t),Fg=h(S),O=a(S,"P",{});var J=d(O);$g=n(J,"The model can be initialized with a "),mr=a(J,"A",{href:!0});var gb=d(mr);zg=n(gb,"RagRetriever"),gb.forEach(t),Eg=n(J,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
