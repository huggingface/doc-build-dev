import{S as rc,i as ac,s as sc,e as r,k as c,w as u,t,M as dc,c as a,d as o,m as l,a as s,x as g,h as n,b as i,F as e,g as y,y as _,q as v,o as b,B as T,v as ic}from"../../chunks/vendor-6b77c823.js";import{T as Dd}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C as wo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Yt}from"../../chunks/IconCopyLink-7a11ce68.js";function cc(pe){let p,P,f,V,z;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),V=t("Module"),z=t(`
...
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(j,"CODE",{});var C=s(f);V=n(C,"Module"),C.forEach(o),z=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(w,j){y(w,p,j),e(p,P),e(p,f),e(f,V),e(p,z)},d(w){w&&o(p)}}}function mc(pe){let p,P,f,V,z,w,j,C,Dn,Jt,h,qn,Eo,$n,Fn,mt,zn,Pn,ko,Cn,An,xo,Sn,In,jo,Ln,Nn,Mo,On,Rn,ht,Bn,Wn,Vo,Gn,Un,Do,Hn,Zn,qo,Yn,Jn,$o,Kn,Qn,Kt,me,Xn,xe,er,or,Qt,W,tr,Fo,nr,rr,zo,ar,sr,Xt,Q,he,ft,je,dr,ut,ir,en,F,Me,cr,fe,Po,lr,pr,Co,mr,hr,fr,X,ur,Ao,gr,_r,So,vr,br,Tr,gt,yr,wr,Ve,Er,ue,De,kr,qe,xr,Io,jr,Mr,Vr,ge,$e,Dr,ee,qr,_t,$r,Fr,vt,zr,Pr,on,oe,_e,bt,Fe,Cr,Tt,Ar,tn,E,ze,Sr,te,Ir,Lo,Lr,Nr,No,Or,Rr,Br,Pe,Wr,Ce,Gr,Ur,Hr,Ae,Zr,Se,Yr,Jr,Kr,yt,Qr,Xr,Ie,ea,Oo,oa,ta,na,Le,ra,Ne,aa,sa,da,G,Ro,ia,ca,wt,la,pa,Et,ma,ha,fa,A,Oe,ua,ne,ga,Bo,_a,va,kt,ba,Ta,ya,ve,wa,xt,Ea,ka,Re,xa,S,Be,ja,jt,Ma,Va,re,Da,Mt,qa,$a,Vt,Fa,za,Pa,Dt,Ca,Aa,We,nn,ae,be,qt,Ge,Sa,$t,Ia,rn,k,Ue,La,se,Na,Wo,Oa,Ra,Go,Ba,Wa,Ga,He,Ua,Ze,Ha,Za,Ya,Ye,Ja,Je,Ka,Qa,Xa,Ft,es,os,Ke,ts,Uo,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Ho,ls,ps,Zo,ms,hs,Yo,fs,us,gs,I,eo,_s,de,vs,Jo,bs,Ts,zt,ys,ws,Es,Te,ks,Pt,xs,js,oo,Ms,O,to,Vs,Ct,Ds,qs,At,$s,Fs,no,an,ie,ye,St,ro,zs,It,Ps,sn,x,ao,Cs,ce,As,Ko,Ss,Is,Qo,Ls,Ns,Os,so,Rs,io,Bs,Ws,Gs,co,Us,lo,Hs,Zs,Ys,Lt,Js,Ks,po,Qs,Xo,Xs,ed,od,mo,td,ho,nd,rd,ad,H,et,sd,dd,Nt,id,cd,Ot,ld,pd,md,L,fo,hd,le,fd,ot,ud,gd,Rt,_d,vd,bd,we,Td,Bt,yd,wd,uo,Ed,R,go,kd,Wt,xd,jd,Gt,Md,Vd,_o,dn;return w=new Yt({}),je=new Yt({}),Me=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27"}}),Ve=new wo({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L400",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L245"}}),We=new wo({props:{code:`from transformers import VisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),Ge=new Yt({}),Ue=new B({props:{name:"class transformers.TFVisionEncoderDecoderModel",anchor:"transformers.TFVisionEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFVisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16880/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L176"}}),eo=new B({props:{name:"call",anchor:"transformers.TFVisionEncoderDecoderModel.call",parameters:[{name:"pixel_values",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFVisionEncoderDecoderModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
<li>Without a prefix which will be input as <code>**encoder_kwargs</code> for the encoder forward function.</li>
<li>With a <em>decoder_</em> prefix which will be input as <code>**decoder_kwargs</code> for the decoder forward function.</li>
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L513",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L348"}}),no=new wo({props:{code:`from transformers import TFVisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),ro=new Yt({}),ao=new B({props:{name:"class transformers.FlaxVisionEncoderDecoderModel",anchor:"transformers.FlaxVisionEncoderDecoderModel",parameters:[{name:"config",val:": VisionEncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxVisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L599",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16880/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L724"}}),_o=new wo({props:{code:`from transformers import FlaxVisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){p=r("meta"),P=c(),f=r("h1"),V=r("a"),z=r("span"),u(w.$$.fragment),j=c(),C=r("span"),Dn=t("Vision Encoder Decoder Models"),Jt=c(),h=r("p"),qn=t("The "),Eo=r("a"),$n=t("VisionEncoderDecoderModel"),Fn=t(` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),mt=r("em"),zn=t("e.g."),Pn=c(),ko=r("a"),Cn=t("ViT"),An=t(", "),xo=r("a"),Sn=t("BEiT"),In=t(", "),jo=r("a"),Ln=t("DeiT"),Nn=t(", "),Mo=r("a"),On=t("Swin"),Rn=t(`)
and any pretrained language model as the decoder (`),ht=r("em"),Bn=t("e.g."),Wn=c(),Vo=r("a"),Gn=t("RoBERTa"),Un=t(", "),Do=r("a"),Hn=t("GPT2"),Zn=t(", "),qo=r("a"),Yn=t("BERT"),Jn=t(", "),$o=r("a"),Kn=t("DistilBERT"),Qn=t(")."),Kt=c(),me=r("p"),Xn=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
Zhoujun Li, Furu Wei.`),Qt=c(),W=r("p"),tr=t("An example of how to use a "),Fo=r("a"),nr=t("VisionEncoderDecoderModel"),rr=t(" for inference can be seen in "),zo=r("a"),ar=t("TrOCR"),sr=t("."),Xt=c(),Q=r("h2"),he=r("a"),ft=r("span"),u(je.$$.fragment),dr=c(),ut=r("span"),ir=t("VisionEncoderDecoderConfig"),en=c(),F=r("div"),u(Me.$$.fragment),cr=c(),fe=r("p"),Po=r("a"),lr=t("VisionEncoderDecoderConfig"),pr=t(` is the configuration class to store the configuration of a
`),Co=r("a"),mr=t("VisionEncoderDecoderModel"),hr=t(`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
decoder when created with the `),Zo=r("a"),ms=t("from_pretrained()"),hs=t(` class method for the encoder and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),od=c(),mo=r("p"),td=t(`This model is also a Flax Linen
`),ho=r("a"),nd=t("flax.nn.Module"),rd=t(` subclass. Use it as a
...
for the encoder and :meth`),Ot=r("em"),ld=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),pd=t(" class method for the decoder."),md=c(),L=r("div"),u(fo.$$.fragment),hd=c(),le=r("p"),fd=t("The "),ot=r("a"),ud=t("FlaxVisionEncoderDecoderModel"),gd=t(" forward method, overrides the "),Rt=r("code"),_d=t("__call__"),vd=t(" special method."),bd=c(),u(we.$$.fragment),Td=c(),Bt=r("p"),yd=t("Examples:"),wd=c(),u(uo.$$.fragment),Ed=c(),R=r("div"),u(go.$$.fragment),kd=c(),Wt=r("p"),xd=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),jd=c(),Gt=r("p"),Md=t("Example:"),Vd=c(),u(_o.$$.fragment),this.h()},l(d){const m=dc('[data-svelte="svelte-1phssyn"]',document.head);p=a(m,"META",{name:!0,content:!0}),m.forEach(o),P=l(d),f=a(d,"H1",{class:!0});var vo=s(f);V=a(vo,"A",{id:!0,class:!0,href:!0});var Ut=s(V);z=a(Ut,"SPAN",{});var Ht=s(z);g(w.$$.fragment,Ht),Ht.forEach(o),Ut.forEach(o),j=l(vo),C=a(vo,"SPAN",{});var qd=s(C);Dn=n(qd,"Vision Encoder Decoder Models"),qd.forEach(o),vo.forEach(o),Jt=l(d),h=a(d,"P",{});var M=s(h);qn=n(M,"The "),Eo=a(M,"A",{href:!0});var $d=s(Eo);$n=n($d,"VisionEncoderDecoderModel"),$d.forEach(o),Fn=n(M,` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),mt=a(M,"EM",{});var Fd=s(mt);zn=n(Fd,"e.g."),Fd.forEach(o),Pn=l(M),ko=a(M,"A",{href:!0});var zd=s(ko);Cn=n(zd,"ViT"),zd.forEach(o),An=n(M,", "),xo=a(M,"A",{href:!0});var Pd=s(xo);Sn=n(Pd,"BEiT"),Pd.forEach(o),In=n(M,", "),jo=a(M,"A",{href:!0});var Cd=s(jo);Ln=n(Cd,"DeiT"),Cd.forEach(o),Nn=n(M,", "),Mo=a(M,"A",{href:!0});var Ad=s(Mo);On=n(Ad,"Swin"),Ad.forEach(o),Rn=n(M,`)
and any pretrained language model as the decoder (`),ht=a(M,"EM",{});var Sd=s(ht);Bn=n(Sd,"e.g."),Sd.forEach(o),Wn=l(M),Vo=a(M,"A",{href:!0});var Id=s(Vo);Gn=n(Id,"RoBERTa"),Id.forEach(o),Un=n(M,", "),Do=a(M,"A",{href:!0});var Ld=s(Do);Hn=n(Ld,"GPT2"),Ld.forEach(o),Zn=n(M,", "),qo=a(M,"A",{href:!0});var Nd=s(qo);Yn=n(Nd,"BERT"),Nd.forEach(o),Jn=n(M,", "),$o=a(M,"A",{href:!0});var Od=s($o);Kn=n(Od,"DistilBERT"),Od.forEach(o),Qn=n(M,")."),M.forEach(o),Kt=l(d),me=a(d,"P",{});var cn=s(me);Xn=n(cn,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
Zhoujun Li, Furu Wei.`),cn.forEach(o),Qt=l(d),W=a(d,"P",{});var tt=s(W);tr=n(tt,"An example of how to use a "),Fo=a(tt,"A",{href:!0});var Bd=s(Fo);nr=n(Bd,"VisionEncoderDecoderModel"),Bd.forEach(o),rr=n(tt," for inference can be seen in "),zo=a(tt,"A",{href:!0});var Wd=s(zo);ar=n(Wd,"TrOCR"),Wd.forEach(o),sr=n(tt,"."),tt.forEach(o),Xt=l(d),Q=a(d,"H2",{class:!0});var ln=s(Q);he=a(ln,"A",{id:!0,class:!0,href:!0});var Gd=s(he);ft=a(Gd,"SPAN",{});var Ud=s(ft);g(je.$$.fragment,Ud),Ud.forEach(o),Gd.forEach(o),dr=l(ln),ut=a(ln,"SPAN",{});var Hd=s(ut);ir=n(Hd,"VisionEncoderDecoderConfig"),Hd.forEach(o),ln.forEach(o),en=l(d),F=a(d,"DIV",{class:!0});var N=s(F);g(Me.$$.fragment,N),cr=l(N),fe=a(N,"P",{});var Zt=s(fe);Po=a(Zt,"A",{href:!0});var Zd=s(Po);lr=n(Zd,"VisionEncoderDecoderConfig"),Zd.forEach(o),pr=n(Zt,` is the configuration class to store the configuration of a
`),Co=a(Zt,"A",{href:!0});var Yd=s(Co);mr=n(Yd,"VisionEncoderDecoderModel"),Yd.forEach(o),hr=n(Zt,`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
documentation from `),So=a(nt,"A",{href:!0});var Kd=s(So);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(nt," for more information."),nt.forEach(o),Tr=l(N),gt=a(N,"P",{});var Qd=s(gt);yr=n(Qd,"Examples:"),Qd.forEach(o),wr=l(N),g(Ve.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(De.$$.fragment,pn),kr=l(pn),qe=a(pn,"P",{});var mn=s(qe);xr=n(mn,"Instantiate a "),Io=a(mn,"A",{href:!0});var Xd=s(Io);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Mr=n(mn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),mn.forEach(o),pn.forEach(o),Vr=l(N),ge=a(N,"DIV",{class:!0});var hn=s(ge);g($e.$$.fragment,hn),Dr=l(hn),ee=a(hn,"P",{});var rt=s(ee);qr=n(rt,"Serializes this instance to a Python dictionary. Override the default "),_t=a(rt,"EM",{});var ei=s(_t);$r=n(ei,"to_dict()"),ei.forEach(o),Fr=n(rt," from "),vt=a(rt,"EM",{});var oi=s(vt);zr=n(oi,"PretrainedConfig"),oi.forEach(o),Pr=n(rt,"."),rt.forEach(o),hn.forEach(o),N.forEach(o),on=l(d),oe=a(d,"H2",{class:!0});var fn=s(oe);_e=a(fn,"A",{id:!0,class:!0,href:!0});var ti=s(_e);bt=a(ti,"SPAN",{});var ni=s(bt);g(Fe.$$.fragment,ni),ni.forEach(o),ti.forEach(o),Cr=l(fn),Tt=a(fn,"SPAN",{});var ri=s(Tt);Ar=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),fn.forEach(o),tn=l(d),E=a(d,"DIV",{class:!0});var D=s(E);g(ze.$$.fragment,D),Sr=l(D),te=a(D,"P",{});var at=s(te);Ir=n(at,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
the model, you need to first set it back in training mode with `),Vt=a(dt,"CODE",{});var Ti=s(Vt);Fa=n(Ti,"model.train()"),Ti.forEach(o),za=n(dt,"."),dt.forEach(o),Pa=l(Y),Dt=a(Y,"P",{});var yi=s(Dt);Ca=n(yi,"Example:"),yi.forEach(o),Aa=l(Y),g(We.$$.fragment,Y),Y.forEach(o),D.forEach(o),nn=l(d),ae=a(d,"H2",{class:!0});var bn=s(ae);be=a(bn,"A",{id:!0,class:!0,href:!0});var wi=s(be);qt=a(wi,"SPAN",{});var Ei=s(qt);g(Ge.$$.fragment,Ei),Ei.forEach(o),wi.forEach(o),Sa=l(bn),$t=a(bn,"SPAN",{});var ki=s($t);Ia=n(ki,"TFVisionEncoderDecoderModel"),ki.forEach(o),bn.forEach(o),rn=l(d),k=a(d,"DIV",{class:!0});var q=s(k);g(Ue.$$.fragment,q),La=l(q),se=a(q,"P",{});var it=s(se);Na=n(it,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Zo=a(To,"A",{href:!0});var zi=s(Zo);ms=n(zi,"from_pretrained()"),zi.forEach(o),hs=n(To,` class method for the encoder and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mn.forEach(o),od=l($),mo=a($,"P",{});var Vn=s(mo);td=n(Vn,`This model is also a Flax Linen
`),ho=a(Vn,"A",{href:!0,rel:!0});var Yi=s(ho);nd=n(Yi,"flax.nn.Module"),Yi.forEach(o),rd=n(Vn,` subclass. Use it as a
...
for the encoder and :meth`),Ot=a(yo,"EM",{});var Qi=s(Ot);ld=n(Qi,"~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Qi.forEach(o),pd=n(yo," class method for the decoder."),yo.forEach(o),md=l($),L=a($,"DIV",{class:!0});var K=s(L);g(fo.$$.fragment,K),hd=l(K),le=a(K,"P",{});var pt=s(le);fd=n(pt,"The "),ot=a(pt,"A",{href:!0});var Xi=s(ot);ud=n(Xi,"FlaxVisionEncoderDecoderModel"),Xi.forEach(o),gd=n(pt," forward method, overrides the "),Rt=a(pt,"CODE",{});var ec=s(Rt);_d=n(ec,"__call__"),ec.forEach(o),vd=n(pt," special method."),pt.forEach(o),bd=l(K),g(we.$$.fragment,K),Td=l(K),Bt=a(K,"P",{});var oc=s(Bt);yd=n(oc,"Examples:"),oc.forEach(o),wd=l(K),g(uo.$$.fragment,K),K.forEach(o),Ed=l($),R=a($,"DIV",{class:!0});var ke=s(R);g(go.$$.fragment,ke),kd=l(ke),Wt=a(ke,"P",{});var tc=s(Wt);xd=n(tc,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),tc.forEach(o),jd=l(ke),Gt=a(ke,"P",{});var nc=s(Gt);Md=n(nc,"Example:"),nc.forEach(o),Vd=l(ke),g(_o.$$.fragment,ke),ke.forEach(o),$.forEach(o),this.h()},h(){i(p,"name","hf:doc:metadata"),i(p,"content",JSON.stringify(hc)),i(V,"id","vision-encoder-decoder-models"),i(V,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(V,"href","#vision-encoder-decoder-models"),i(f,"class","relative group"),i(Eo,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(ko,"href","vit"),i(xo,"href","beit"),i(jo,"href","deit"),i(Mo,"href","swin"),i(Vo,"href","roberta"),i(Do,"href","gpt2"),i(qo,"href","bert"),i($o,"href","distilbert"),i(xe,"href","https://arxiv.org/abs/2109.10282"),i(xe,"rel","nofollow"),i(Fo,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(zo,"href","trocr"),i(he,"id","transformers.VisionEncoderDecoderConfig"),i(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(he,"href","#transformers.VisionEncoderDecoderConfig"),i(Q,"class","relative group"),i(Po,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"),i(Co,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(Ao,"href","/docs/transformers/pr_16880/en/main_classes/configuration#transformers.PretrainedConfig"),i(So,"href","/docs/transformers/pr_16880/en/main_classes/configuration#transformers.PretrainedConfig"),i(Io,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"),i(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(_e,"id","transformers.VisionEncoderDecoderModel"),i(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(_e,"href","#transformers.VisionEncoderDecoderModel"),i(oe,"class","relative group"),i(Lo,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(No,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Ce,"href","https://arxiv.org/abs/1907.12461"),i(Ce,"rel","nofollow"),i(Se,"href","https://arxiv.org/abs/2109.10282"),i(Se,"rel","nofollow"),i(Oo,"href","/docs/transformers/pr_16880/en/main_classes/model#transformers.PreTrainedModel"),i(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),i(Ne,"rel","nofollow"),i(Ro,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(Bo,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(be,"id","transformers.TFVisionEncoderDecoderModel"),i(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(be,"href","#transformers.TFVisionEncoderDecoderModel"),i(ae,"class","relative group"),i(Wo,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Go,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Ze,"href","https://arxiv.org/abs/1907.12461"),i(Ze,"rel","nofollow"),i(Je,"href","https://arxiv.org/abs/2109.10282"),i(Je,"rel","nofollow"),i(Uo,"href","/docs/transformers/pr_16880/en/main_classes/model#transformers.TFPreTrainedModel"),i(Xe,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),i(Xe,"rel","nofollow"),i(Ho,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel"),i(Zo,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Yo,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Jo,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel"),i(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(k,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(ye,"id","transformers.FlaxVisionEncoderDecoderModel"),i(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(ye,"href","#transformers.FlaxVisionEncoderDecoderModel"),i(ie,"class","relative group"),i(Ko,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(Qo,"href","/docs/transformers/pr_16880/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),i(io,"href","https://arxiv.org/abs/1907.12461"),i(io,"rel","nofollow"),i(lo,"href","https://arxiv.org/abs/2109.10282"),i(lo,"rel","nofollow"),i(Xo,"href","/docs/transformers/pr_16880/en/main_classes/model#transformers.FlaxPreTrainedModel"),i(ho,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),i(ho,"rel","nofollow"),i(et,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel"),i(ot,"href","/docs/transformers/pr_16880/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel"),i(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),i(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(d,m){e(document.head,p),y(d,P,m),y(d,f,m),e(f,V),e(V,z),_(w,z,null),e(f,j),e(f,C),e(C,Dn),y(d,Jt,m),y(d,h,m),e(h,qn),e(h,Eo),e(Eo,$n),e(h,Fn),e(h,mt),e(mt,zn),e(h,Pn),e(h,ko),e(ko,Cn),e(h,An),e(h,xo),e(xo,Sn),e(h,In),e(h,jo),e(jo,Ln),e(h,Nn),e(h,Mo),e(Mo,On),e(h,Rn),e(h,ht),e(ht,Bn),e(h,Wn),e(h,Vo),e(Vo,Gn),e(h,Un),e(h,Do),e(Do,Hn),e(h,Zn),e(h,qo),e(qo,Yn),e(h,Jn),e(h,$o),e($o,Kn),e(h,Qn),y(d,Kt,m),y(d,me,m),e(me,Xn),e(me,xe),e(xe,er),e(me,or),y(d,Qt,m),y(d,W,m),e(W,tr),e(W,Fo),e(Fo,nr),e(W,rr),e(W,zo),e(zo,ar),e(W,sr),y(d,Xt,m),y(d,Q,m),e(Q,he),e(he,ft),_(je,ft,null),e(Q,dr),e(Q,ut),e(ut,ir),y(d,en,m),y(d,F,m),_(Me,F,null),e(F,cr),e(F,fe),e(fe,Po),e(Po,lr),e(fe,pr),e(fe,Co),e(Co,mr),e(fe,hr),e(F,fr),e(F,X),e(X,ur),e(X,Ao),e(Ao,gr),e(X,_r),e(X,So),e(So,vr),e(X,br),e(F,Tr),e(F,gt),e(gt,yr),e(F,wr),_(Ve,F,null),e(F,Er),e(F,ue),_(De,ue,null),e(ue,kr),e(ue,qe),e(qe,xr),e(qe,Io),e(Io,jr),e(qe,Mr),e(F,Vr),e(F,ge),_($e,ge,null),e(ge,Dr),e(ge,ee),e(ee,qr),e(ee,_t),e(_t,$r),e(ee,Fr),e(ee,vt),e(vt,zr),e(ee,Pr),y(d,on,m),y(d,oe,m),e(oe,_e),e(_e,bt),_(Fe,bt,null),e(oe,Cr),e(oe,Tt),e(Tt,Ar),y(d,tn,m),y(d,E,m),_(ze,E,null),e(E,Sr),e(E,te),e(te,Ir),e(te,Lo),e(Lo,Lr),e(te,Nr),e(te,No),e(No,Or),e(te,Rr),e(E,Br),e(E,Pe),e(Pe,Wr),e(Pe,Ce),e(Ce,Gr),e(Pe,Ur),e(E,Hr),e(E,Ae),e(Ae,Zr),e(Ae,Se),e(Se,Yr),e(Ae,Jr),e(E,Kr),e(E,yt),e(yt,Qr),e(E,Xr),e(E,Ie),e(Ie,ea),e(Ie,Oo),e(Oo,oa),e(Ie,ta),e(E,na),e(E,Le),e(Le,ra),e(Le,Ne),e(Ne,aa),e(Le,sa),e(E,da),e(E,G),e(G,Ro),e(Ro,ia),e(G,ca),e(G,wt),e(wt,la),e(G,pa),e(G,Et),e(Et,ma),e(G,ha),e(E,fa),e(E,A),_(Oe,A,null),e(A,ua),e(A,ne),e(ne,ga),e(ne,Bo),e(Bo,_a),e(ne,va),e(ne,kt),e(kt,ba),e(ne,Ta),e(A,ya),_(ve,A,null),e(A,wa),e(A,xt),e(xt,Ea),e(A,ka),_(Re,A,null),e(E,xa),e(E,S),_(Be,S,null),e(S,ja),e(S,jt),e(jt,Ma),e(S,Va),e(S,re),e(re,Da),e(re,Mt),e(Mt,qa),e(re,$a),e(re,Vt),e(Vt,Fa),e(re,za),e(S,Pa),e(S,Dt),e(Dt,Ca),e(S,Aa),_(We,S,null),y(d,nn,m),y(d,ae,m),e(ae,be),e(be,qt),_(Ge,qt,null),e(ae,Sa),e(ae,$t),e($t,Ia),y(d,rn,m),y(d,k,m),_(Ue,k,null),e(k,La),e(k,se),e(se,Na),e(se,Wo),e(Wo,Oa),e(se,Ra),e(se,Go),e(Go,Ba),e(se,Wa),e(k,Ga),e(k,He),e(He,Ua),e(He,Ze),e(Ze,Ha),e(He,Za),e(k,Ya),e(k,Ye),e(Ye,Ja),e(Ye,Je),e(Je,Ka),e(Ye,Qa),e(k,Xa),e(k,Ft),e(Ft,es),e(k,os),e(k,Ke),e(Ke,ts),e(Ke,Uo),e(Uo,ns),e(Ke,rs),e(k,as),e(k,Qe),e(Qe,ss),e(Qe,Xe),e(Xe,ds),e(Qe,is),e(k,cs),e(k,U),e(U,Ho),e(Ho,ls),e(U,ps),e(U,Zo),e(Zo,ms),e(U,hs),e(U,Yo),e(Yo,fs),e(U,us),e(k,gs),e(k,I),_(eo,I,null),e(I,_s),e(I,de),e(de,vs),e(de,Jo),e(Jo,bs),e(de,Ts),e(de,zt),e(zt,ys),e(de,ws),e(I,Es),_(Te,I,null),e(I,ks),e(I,Pt),e(Pt,xs),e(I,js),_(oo,I,null),e(k,Ms),e(k,O),_(to,O,null),e(O,Vs),e(O,Ct),e(Ct,Ds),e(O,qs),e(O,At),e(At,$s),e(O,Fs),_(no,O,null),y(d,an,m),y(d,ie,m),e(ie,ye),e(ye,St),_(ro,St,null),e(ie,zs),e(ie,It),e(It,Ps),y(d,sn,m),y(d,x,m),_(ao,x,null),e(x,Cs),e(x,ce),e(ce,As),e(ce,Ko),e(Ko,Ss),e(ce,Is),e(ce,Qo),e(Qo,Ls),e(ce,Ns),e(x,Os),e(x,so),e(so,Rs),e(so,io),e(io,Bs),e(so,Ws),e(x,Gs),e(x,co),e(co,Us),e(co,lo),e(lo,Hs),e(co,Zs),e(x,Ys),e(x,Lt),e(Lt,Js),e(x,Ks),e(x,po),e(po,Qs),e(po,Xo),e(Xo,Xs),e(po,ed),e(x,od),e(x,mo),e(mo,td),e(mo,ho),e(ho,nd),e(mo,rd),e(x,ad),e(x,H),e(H,et),e(et,sd),e(H,dd),e(H,Nt),e(Nt,id),e(H,cd),e(H,Ot),e(Ot,ld),e(H,pd),e(x,md),e(x,L),_(fo,L,null),e(L,hd),e(L,le),e(le,fd),e(le,ot),e(ot,ud),e(le,gd),e(le,Rt),e(Rt,_d),e(le,vd),e(L,bd),_(we,L,null),e(L,Td),e(L,Bt),e(Bt,yd),e(L,wd),_(uo,L,null),e(x,Ed),e(x,R),_(go,R,null),e(R,kd),e(R,Wt),e(Wt,xd),e(R,jd),e(R,Gt),e(Gt,Md),e(R,Vd),_(_o,R,null),dn=!0},p(d,[m]){const vo={};m&2&&(vo.$$scope={dirty:m,ctx:d}),ve.$set(vo);const Ut={};m&2&&(Ut.$$scope={dirty:m,ctx:d}),Te.$set(Ut);const Ht={};m&2&&(Ht.$$scope={dirty:m,ctx:d}),we.$set(Ht)},i(d){dn||(v(w.$$.fragment,d),v(je.$$.fragment,d),v(Me.$$.fragment,d),v(Ve.$$.fragment,d),v(De.$$.fragment,d),v($e.$$.fragment,d),v(Fe.$$.fragment,d),v(ze.$$.fragment,d),v(Oe.$$.fragment,d),v(ve.$$.fragment,d),v(Re.$$.fragment,d),v(Be.$$.fragment,d),v(We.$$.fragment,d),v(Ge.$$.fragment,d),v(Ue.$$.fragment,d),v(eo.$$.fragment,d),v(Te.$$.fragment,d),v(oo.$$.fragment,d),v(to.$$.fragment,d),v(no.$$.fragment,d),v(ro.$$.fragment,d),v(ao.$$.fragment,d),v(fo.$$.fragment,d),v(we.$$.fragment,d),v(uo.$$.fragment,d),v(go.$$.fragment,d),v(_o.$$.fragment,d),dn=!0)},o(d){b(w.$$.fragment,d),b(je.$$.fragment,d),b(Me.$$.fragment,d),b(Ve.$$.fragment,d),b(De.$$.fragment,d),b($e.$$.fragment,d),b(Fe.$$.fragment,d),b(ze.$$.fragment,d),b(Oe.$$.fragment,d),b(ve.$$.fragment,d),b(Re.$$.fragment,d),b(Be.$$.fragment,d),b(We.$$.fragment,d),b(Ge.$$.fragment,d),b(Ue.$$.fragment,d),b(eo.$$.fragment,d),b(Te.$$.fragment,d),b(oo.$$.fragment,d),b(to.$$.fragment,d),b(no.$$.fragment,d),b(ro.$$.fragment,d),b(ao.$$.fragment,d),b(fo.$$.fragment,d),b(we.$$.fragment,d),b(uo.$$.fragment,d),b(go.$$.fragment,d),b(_o.$$.fragment,d),dn=!1},d(d){o(p),d&&o(P),d&&o(f),T(w),d&&o(Jt),d&&o(h),d&&o(Kt),d&&o(me),d&&o(Qt),d&&o(W),d&&o(Xt),d&&o(Q),T(je),d&&o(en),d&&o(F),T(Me),T(Ve),T(De),T($e),d&&o(on),d&&o(oe),T(Fe),d&&o(tn),d&&o(E),T(ze),T(Oe),T(ve),T(Re),T(Be),T(We),d&&o(nn),d&&o(ae),T(Ge),d&&o(rn),d&&o(k),T(Ue),T(eo),T(Te),T(oo),T(to),T(no),d&&o(an),d&&o(ie),T(ro),d&&o(sn),d&&o(x),T(ao),T(fo),T(we),T(uo),T(go),T(_o)}}}const hc={local:"vision-encoder-decoder-models",sections:[{local:"transformers.VisionEncoderDecoderConfig",title:"VisionEncoderDecoderConfig"},{local:"transformers.VisionEncoderDecoderModel",title:"VisionEncoderDecoderModel"},{local:"transformers.TFVisionEncoderDecoderModel",title:"TFVisionEncoderDecoderModel"},{local:"transformers.FlaxVisionEncoderDecoderModel",title:"FlaxVisionEncoderDecoderModel"}],title:"Vision Encoder Decoder Models"};function fc(pe){return ic(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Tc extends rc{constructor(p){super();ac(this,p,fc,mc,sc,{})}}export{Tc as default,hc as metadata};
