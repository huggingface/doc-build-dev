...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16227/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16227/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16227/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16227/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16227/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16227/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xT=d(),Ic=n("p"),zT=r("Finally, this model supports inherent JAX features such as:"),qT=d(),_t=n("ul"),Nc=n("li"),Mr=n("a"),BT=r("Just-In-Time (JIT) compilation"),$T=d(),Oc=n("li"),wr=n("a"),FT=r("Automatic Differentiation"),jT=d(),Dc=n("li"),xr=n("a"),ET=r("Vectorization"),PT=d(),Lc=n("li"),zr=n("a"),CT=r("Parallelization"),ST=d(),Oe=n("div"),m(qr.$$.fragment),AT=d(),jo=n("p"),IT=r("The "),Gc=n("code"),NT=r("FlaxMBartPreTrainedModel"),OT=r("forward method, overrides the "),Wc=n("code"),DT=r("__call__"),LT=r(" special method."),GT=d(),m(vn.$$.fragment),WT=d(),Rc=n("p"),RT=r("Example:"),UT=d(),m(Br.$$.fragment),XT=d(),qt=n("div"),m($r.$$.fragment),HT=d(),Uc=n("p"),VT=r("Example:"),QT=d(),m(Fr.$$.fragment),JT=d(),Bt=n("div"),m(jr.$$.fragment),KT=d(),Xc=n("p"),ZT=r("Example:"),YT=d(),m(Er.$$.fragment),dh=d(),Eo=n("h2"),yn=n("a"),Hc=n("span"),m(Pr.$$.fragment),e2=d(),Vc=n("span"),t2=r("FlaxMBartForQuestionAnswering"),lh=d(),N=n("div"),m(Cr.$$.fragment),o2=d(),Po=n("p"),n2=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Qc=n("code"),a2=r("span start logits"),s2=r(" and "),Jc=n("code"),r2=r("span end logits"),i2=r(")."),d2=d(),Sr=n("p"),l2=r("This model inherits from "),ji=n("a"),c2=r("FlaxPreTrainedModel"),p2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),h2=d(),Ar=n("p"),u2=r(`This model is also a Flax Linen
`),Ir=n("a"),m2=r("flax.nn.Module"),f2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),_2=d(),Kc=n("p"),g2=r("Finally, this model supports inherent JAX features such as:"),k2=d(),gt=n("ul"),Zc=n("li"),Nr=n("a"),b2=r("Just-In-Time (JIT) compilation"),v2=d(),Yc=n("li"),Or=n("a"),y2=r("Automatic Differentiation"),T2=d(),ep=n("li"),Dr=n("a"),M2=r("Vectorization"),w2=d(),tp=n("li"),Lr=n("a"),x2=r("Parallelization"),z2=d(),De=n("div"),m(Gr.$$.fragment),q2=d(),Co=n("p"),B2=r("The "),op=n("code"),$2=r("FlaxMBartPreTrainedModel"),F2=r("forward method, overrides the "),np=n("code"),j2=r("__call__"),E2=r(" special method."),P2=d(),m(Tn.$$.fragment),C2=d(),ap=n("p"),S2=r("Example:"),A2=d(),m(Wr.$$.fragment),I2=d(),$t=n("div"),m(Rr.$$.fragment),N2=d(),sp=n("p"),O2=r("Example:"),D2=d(),m(Ur.$$.fragment),L2=d(),Ft=n("div"),m(Xr.$$.fragment),G2=d(),rp=n("p"),W2=r("Example:"),R2=d(),m(Hr.$$.fragment),this.h()},l(o){const p=Az('[data-svelte="svelte-1phssyn"]',document.head);u=a(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(o),v=a(o,"H1",{class:!0});var Vr=s(v);M=a(Vr,"A",{id:!0,class:!0,href:!0});var ip=s(M);x=a(ip,"SPAN",{});var dp=s(x);f(T.$$.fragment,dp),dp.forEach(t),ip.forEach(t),y=l(Vr),B=a(Vr,"SPAN",{});var lp=s(B);st=i(lp,"MBart and MBart-50"),lp.forEach(t),Vr.forEach(t),je=l(o),j=a(o,"P",{});var Mn=s(j);Ue=a(Mn,"STRONG",{});var cp=s(Ue);_e=i(cp,"DISCLAIMER:"),cp.forEach(t),rt=i(Mn," If you see something strange, file a "),ge=a(Mn,"A",{href:!0,rel:!0});var pp=s(ge);ke=i(pp,"Github Issue"),pp.forEach(t),it=i(Mn,` and assign
@patrickvonplaten`),Mn.forEach(t),Ke=l(o),Q=a(o,"H2",{class:!0});var Qr=s(Q);O=a(Qr,"A",{id:!0,class:!0,href:!0});var hp=s(O);Xe=a(hp,"SPAN",{});var up=s(Xe);f(ae.$$.fragment,up),up.forEach(t),hp.forEach(t),P=l(Qr),A=a(Qr,"SPAN",{});var mp=s(A);dt=i(mp,"Overview of MBart"),mp.forEach(t),Qr.forEach(t),ce=l(o),pe=a(o,"P",{});var Jr=s(pe);lt=i(Jr,"The MBart model was presented in "),J=a(Jr,"A",{href:!0,rel:!0});var X2=s(J);ct=i(X2,"Multilingual Denoising Pre-training for Neural Machine Translation"),X2.forEach(t),pt=i(Jr,` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
Ghazvininejad, Mike Lewis, Luke Zettlemoyer.`),Jr.forEach(t),D=l(o),Ee=a(o,"P",{});var H2=s(Ee);be=i(H2,`According to the abstract, MBART is a sequence-to-sequence denoising auto-encoder pretrained on large-scale monolingual
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),H2.forEach(t),Ze=l(o),se=a(o,"P",{});var fp=s(se);ve=i(fp,"This model was contributed by "),ye=a(fp,"A",{href:!0,rel:!0});var V2=s(ye);ht=i(V2,"valhalla"),V2.forEach(t),re=i(fp,". The Authors\u2019 code can be found "),Te=a(fp,"A",{href:!0,rel:!0});var Q2=s(Te);Me=i(Q2,"here"),Q2.forEach(t),fp.forEach(t),Ye=l(o),w=a(o,"H3",{class:!0});var ph=s(w);$=a(ph,"A",{id:!0,class:!0,href:!0});var J2=s($);we=a(J2,"SPAN",{});var K2=s(we);f(He.$$.fragment,K2),K2.forEach(t),J2.forEach(t),Ut=l(ph),K=a(ph,"SPAN",{});var Z2=s(K);Xt=i(Z2,"Training of MBart"),Z2.forEach(t),ph.forEach(t),kt=l(o),X=a(o,"P",{});var jt=s(X);ie=i(jt,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),de=a(jt,"CODE",{});var Y2=s(de);Ht=i(Y2,"X [eos, src_lang_code]"),Y2.forEach(t),Vt=i(jt," where "),le=a(jt,"CODE",{});var e1=s(le);Qt=i(e1,"X"),e1.forEach(t),Jt=i(jt,` is the source text. The
target text format is `),Ve=a(jt,"CODE",{});var t1=s(Ve);Kt=i(t1,"[tgt_lang_code] X [eos]"),t1.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o1=s(rd);Pu=i(o1,"bos"),o1.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var U2=s(Cn);id=a(U2,"STRONG",{});var n1=s(id);Au=i(n1,"call"),n1.forEach(t),Iu=i(U2,"()"),U2.forEach(t),Nu=i(Ei,` will encode source text format, and it should be wrapped
