import{S as vc,i as bc,s as wc,e as s,k as h,w,t as r,M as Cc,c as i,d as t,m as u,a as l,x as C,h as n,b as d,G as e,g as b,y,q as k,o as $,B as T,v as yc,L as ke}from"../../chunks/vendor-hf-doc-builder.js";import{T as St}from"../../chunks/Tip-hf-doc-builder.js";import{D as z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as $e}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ee}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ye}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function kc(V){let c,_,m,f,v;return f=new $e({props:{code:`from transformers import Wav2Vec2ConformerModel, Wav2Vec2ConformerConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){c=s("p"),_=r("Example:"),m=h(),w(f.$$.fragment)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Example:"),p.forEach(t),m=u(a),C(f.$$.fragment,a)},m(a,p){b(a,c,p),e(c,_),b(a,m,p),y(f,a,p),v=!0},p:ke,i(a){v||(k(f.$$.fragment,a),v=!0)},o(a){$(f.$$.fragment,a),v=!1},d(a){a&&t(c),a&&t(m),T(f,a)}}}function $c(V){let c,_,m,f,v;return{c(){c=s("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),f=r("Module"),v=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(a,p){b(a,c,p),e(c,_),e(c,m),e(m,f),e(c,v)},d(a){a&&t(c)}}}function Tc(V){let c,_,m,f,v;return f=new $e({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2ConformerModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">1024</span>]`}}),{c(){c=s("p"),_=r("Example:"),m=h(),w(f.$$.fragment)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Example:"),p.forEach(t),m=u(a),C(f.$$.fragment,a)},m(a,p){b(a,c,p),e(c,_),b(a,m,p),y(f,a,p),v=!0},p:ke,i(a){v||(k(f.$$.fragment,a),v=!0)},o(a){$(f.$$.fragment,a),v=!1},d(a){a&&t(c),a&&t(m),T(f,a)}}}function Vc(V){let c,_,m,f,v;return{c(){c=s("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),f=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(p,"CODE",{});var W=l(m);f=n(W,"Module"),W.forEach(t),v=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(a,p){b(a,c,p),e(c,_),e(c,m),e(m,f),e(c,v)},d(a){a&&t(c)}}}function Wc(V){let c,_,m,f,v;return f=new $e({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2ConformerForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;MISTER QUILTER IS THE APOSTLE OF THE MIDDLE CLASSES AND WE ARE GLAD TO WELCOME HIS GOSPEL&#x27;</span>`}}),{c(){c=s("p"),_=r("Example:"),m=h(),w(f.$$.fragment)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Example:"),p.forEach(t),m=u(a),C(f.$$.fragment,a)},m(a,p){b(a,c,p),e(c,_),b(a,m,p),y(f,a,p),v=!0},p:ke,i(a){v||(k(f.$$.fragment,a),v=!0)},o(a){$(f.$$.fragment,a),v=!1},d(a){a&&t(c),a&&t(m),T(f,a)}}}function jc(V){let c,_;return c=new $e({props:{code:`with processor.as_target_processor():
...
<span class="hljs-number">64.21</span>`}}),{c(){w(c.$$.fragment)},l(m){C(c.$$.fragment,m)},m(m,f){y(c,m,f),_=!0},p:ke,i(m){_||(k(c.$$.fragment,m),_=!0)},o(m){$(c.$$.fragment,m),_=!1},d(m){T(c,m)}}}function Fc(V){let c,_,m,f,v;return{c(){c=s("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),f=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(p,"CODE",{});var W=l(m);f=n(W,"Module"),W.forEach(t),v=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(a,p){b(a,c,p),e(c,_),e(c,m),e(m,f),e(c,v)},d(a){a&&t(c)}}}function xc(V){let c,_,m,f,v;return f=new $e({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ConformerForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){c=s("p"),_=r("Example:"),m=h(),w(f.$$.fragment)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Example:"),p.forEach(t),m=u(a),C(f.$$.fragment,a)},m(a,p){b(a,c,p),e(c,_),b(a,m,p),y(f,a,p),v=!0},p:ke,i(a){v||(k(f.$$.fragment,a),v=!0)},o(a){$(f.$$.fragment,a),v=!1},d(a){a&&t(c),a&&t(m),T(f,a)}}}function qc(V){let c,_;return c=new $e({props:{code:`# compute loss - target_label is e.g. "down"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">0.68</span>`}}),{c(){w(c.$$.fragment)},l(m){C(c.$$.fragment,m)},m(m,f){y(c,m,f),_=!0},p:ke,i(m){_||(k(c.$$.fragment,m),_=!0)},o(m){$(c.$$.fragment,m),_=!1},d(m){T(c,m)}}}function Ec(V){let c,_,m,f,v;return{c(){c=s("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),f=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(p,"CODE",{});var W=l(m);f=n(W,"Module"),W.forEach(t),v=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(a,p){b(a,c,p),e(c,_),e(c,m),e(m,f),e(c,v)},d(a){a&&t(c)}}}function Pc(V){let c,_,m,f,v;return f=new $e({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ConformerForAudioFrameClassification
from datasets import load_dataset
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">0</span>]`}}),{c(){c=s("p"),_=r("Example:"),m=h(),w(f.$$.fragment)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Example:"),p.forEach(t),m=u(a),C(f.$$.fragment,a)},m(a,p){b(a,c,p),e(c,_),b(a,m,p),y(f,a,p),v=!0},p:ke,i(a){v||(k(f.$$.fragment,a),v=!0)},o(a){$(f.$$.fragment,a),v=!1},d(a){a&&t(c),a&&t(m),T(f,a)}}}function Mc(V){let c,_,m,f,v;return{c(){c=s("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),f=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(p,"CODE",{});var W=l(m);f=n(W,"Module"),W.forEach(t),v=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(a,p){b(a,c,p),e(c,_),e(c,m),e(m,f),e(c,v)},d(a){a&&t(c)}}}function Ac(V){let c,_,m,f,v;return f=new $e({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ConformerForXVector
from datasets import load_dataset
import torch
...
<span class="hljs-number">1.0</span>`}}),{c(){c=s("p"),_=r("Example:"),m=h(),w(f.$$.fragment)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Example:"),p.forEach(t),m=u(a),C(f.$$.fragment,a)},m(a,p){b(a,c,p),e(c,_),b(a,m,p),y(f,a,p),v=!0},p:ke,i(a){v||(k(f.$$.fragment,a),v=!0)},o(a){$(f.$$.fragment,a),v=!1},d(a){a&&t(c),a&&t(m),T(f,a)}}}function zc(V){let c,_,m,f,v;return{c(){c=s("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),f=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=i(a,"P",{});var p=l(c);_=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(p,"CODE",{});var W=l(m);f=n(W,"Module"),W.forEach(t),v=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(a,p){b(a,c,p),e(c,_),e(c,m),e(m,f),e(c,v)},d(a){a&&t(c)}}}function Sc(V){let c,_,m,f,v;return f=new $e({props:{code:`import torch
...
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17650/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_17650/en/model_doc/wav2vec2#transformers.modeling_outputs.Wav2Vec2BaseModelOutput"
>transformers.modeling_outputs.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17650/en/model_doc/wav2vec2-conformer#transformers.Wav2Vec2ConformerConfig"
...
`}}),qe=new St({props:{$$slots:{default:[$c]},$$scope:{ctx:V}}}),Ee=new ye({props:{anchor:"transformers.Wav2Vec2ConformerModel.forward.example",$$slots:{default:[Tc]},$$scope:{ctx:V}}}),yo=new ee({}),ko=new z({props:{name:"class transformers.Wav2Vec2ConformerForCTC",anchor:"transformers.Wav2Vec2ConformerForCTC",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ConformerForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17650/en/model_doc/wav2vec2-conformer#transformers.Wav2Vec2ConformerConfig">Wav2Vec2ConformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17650/src/transformers/models/wav2vec2_conformer/modeling_wav2vec2_conformer.py#L1628",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17650/src/transformers/models/wav2vec2_conformer/modeling_wav2vec2_conformer.py#L1754",returnDescription:`
<p>A <a
...
`}}),Oe=new St({props:{$$slots:{default:[Fc]},$$scope:{ctx:V}}}),De=new ye({props:{anchor:"transformers.Wav2Vec2ConformerForSequenceClassification.forward.example",$$slots:{default:[xc]},$$scope:{ctx:V}}}),Le=new ye({props:{anchor:"transformers.Wav2Vec2ConformerForSequenceClassification.forward.example-2",$$slots:{default:[qc]},$$scope:{ctx:V}}}),So=new ee({}),Oo=new z({props:{name:"class transformers.Wav2Vec2ConformerForAudioFrameClassification",anchor:"transformers.Wav2Vec2ConformerForAudioFrameClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ConformerForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17650/en/model_doc/wav2vec2-conformer#transformers.Wav2Vec2ConformerConfig">Wav2Vec2ConformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17650/src/transformers/models/wav2vec2_conformer/modeling_wav2vec2_conformer.py#L1869",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17650/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
`}}),Ie=new St({props:{$$slots:{default:[Ec]},$$scope:{ctx:V}}}),Xe=new ye({props:{anchor:"transformers.Wav2Vec2ConformerForAudioFrameClassification.forward.example",$$slots:{default:[Pc]},$$scope:{ctx:V}}}),Ho=new ee({}),Ro=new z({props:{name:"class transformers.Wav2Vec2ConformerForXVector",anchor:"transformers.Wav2Vec2ConformerForXVector",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ConformerForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17650/en/model_doc/wav2vec2-conformer#transformers.Wav2Vec2ConformerConfig">Wav2Vec2ConformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17650/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17650/src/transformers/models/wav2vec2_conformer/modeling_wav2vec2_conformer.py#L1990"}}),Jo=new z({props:{name:"forward",anchor:"transformers.Wav2Vec2ConformerForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ConformerForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17650/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17650/src/transformers/models/wav2vec2_conformer/modeling_wav2vec2_conformer.py#L2043",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17650/en/main_classes/output#transformers.modeling_outputs.XVectorOutput"
...
`}}),He=new St({props:{$$slots:{default:[Mc]},$$scope:{ctx:V}}}),Re=new ye({props:{anchor:"transformers.Wav2Vec2ConformerForXVector.forward.example",$$slots:{default:[Ac]},$$scope:{ctx:V}}}),Yo=new ee({}),et=new z({props:{name:"class transformers.Wav2Vec2ConformerForPreTraining",anchor:"transformers.Wav2Vec2ConformerForPreTraining",parameters:[{name:"config",val:": Wav2Vec2ConformerConfig"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ConformerForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17650/en/model_doc/wav2vec2-conformer#transformers.Wav2Vec2ConformerConfig">Wav2Vec2ConformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17650/src/transformers/models/wav2vec2_conformer/modeling_wav2vec2_conformer.py#L1443",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17650/en/model_doc/wav2vec2-conformer#transformers.models.wav2vec2_conformer.modeling_wav2vec2_conformer.Wav2Vec2ConformerForPreTrainingOutput"
...
`}}),Ze=new St({props:{$$slots:{default:[zc]},$$scope:{ctx:V}}}),Qe=new ye({props:{anchor:"transformers.Wav2Vec2ConformerForPreTraining.forward.example",$$slots:{default:[Sc]},$$scope:{ctx:V}}}),{c(){c=s("meta"),_=h(),m=s("h1"),f=s("a"),v=s("span"),w(a.$$.fragment),p=h(),W=s("span"),kn=r("Wav2Vec2-Conformer"),Wr=h(),oe=s("h2"),Te=s("a"),Ot=s("span"),w(oo.$$.fragment),$n=h(),Dt=s("span"),Tn=r("Overview"),jr=h(),Ve=s("p"),Vn=r("The Wav2Vec2-Conformer weights were released by the Meta AI team within the "),to=s("a"),Wn=r("Fairseq library"),jn=r("."),Fr=h(),ct=s("p"),Fn=r("Tips:"),xr=h(),U=s("ul"),H=s("li"),xn=r("Wav2Vec2-Conformer follows the same architecture as Wav2Vec2, but replaces the "),Lt=s("em"),qn=r("Attention"),En=r("-block with a "),Nt=s("em"),Pn=r("Conformer"),Mn=r(`-block
...
library implements for all its model (such as downloading or saving etc.).`),Ta=h(),bo=s("p"),Va=r("This model is a PyTorch "),wo=s("a"),Wa=r("nn.Module"),ja=r(` sub-class. Use it as a
...
Auli.`),Ra=h(),To=s("p"),Ua=r("This model inherits from "),gt=s("a"),Za=r("PreTrainedModel"),Qa=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Ka=h(),Vo=s("p"),Ga=r("This model is a PyTorch "),Wo=s("a"),Ja=r("nn.Module"),Ya=r(` sub-class. Use it as a
...
library implements for all its model (such as downloading or saving etc.).`),ys=h(),Mo=s("p"),ks=r("This model is a PyTorch "),Ao=s("a"),$s=r("nn.Module"),Ts=r(` sub-class. Use it as a
regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and behavior.`),Vs=h(),A=s("div"),w(zo.$$.fragment),Ws=h(),fe=s("p"),js=r("The "),bt=s("a"),Fs=r("Wav2Vec2ConformerForSequenceClassification"),xs=r(" forward method, overrides the "),nr=s("code"),qs=r("__call__"),Es=r(" special method."),Ps=h(),w(Oe.$$.fragment),Ms=h(),w(De.$$.fragment),As=h(),w(Le.$$.fragment),Ir=h(),he=s("h2"),Ne=s("a"),ar=s("span"),w(So.$$.fragment),zs=h(),sr=s("span"),Ss=r("Wav2Vec2ConformerForAudioFrameClassification"),Xr=h(),F=s("div"),w(Oo.$$.fragment),Os=h(),ir=s("p"),Ds=r("Wav2Vec2Conformer Model with a frame classification head on top for tasks like Speaker Diarization."),Ls=h(),Do=s("p"),Ns=r("Wav2Vec2Conformer was proposed in "),Lo=s("a"),Is=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and behavior.`),Zi=h(),N=s("div"),w(at.$$.fragment),Qi=h(),we=s("p"),Ki=r("The "),Tt=s("a"),Gi=r("Wav2Vec2ConformerForPreTraining"),Ji=r(" forward method, overrides the "),gr=s("code"),Yi=r("__call__"),el=r(" special method."),ol=h(),w(Ze.$$.fragment),tl=h(),w(Qe.$$.fragment),this.h()},l(o){const g=Cc('[data-svelte="svelte-1phssyn"]',document.head);c=i(g,"META",{name:!0,content:!0}),g.forEach(t),_=u(o),m=i(o,"H1",{class:!0});var st=l(m);f=i(st,"A",{id:!0,class:!0,href:!0});var _r=l(f);v=i(_r,"SPAN",{});var vr=l(v);C(a.$$.fragment,vr),vr.forEach(t),_r.forEach(t),p=u(st),W=i(st,"SPAN",{});var br=l(W);kn=n(br,"Wav2Vec2-Conformer"),br.forEach(t),st.forEach(t),Wr=u(o),oe=i(o,"H2",{class:!0});var it=l(oe);Te=i(it,"A",{id:!0,class:!0,href:!0});var wr=l(Te);Ot=i(wr,"SPAN",{});var Cr=l(Ot);C(oo.$$.fragment,Cr),Cr.forEach(t),wr.forEach(t),$n=u(it),Dt=i(it,"SPAN",{});var yr=l(Dt);Tn=n(yr,"Overview"),yr.forEach(t),it.forEach(t),jr=u(o),Ve=i(o,"P",{});var lt=l(Ve);Vn=n(lt,"The Wav2Vec2-Conformer weights were released by the Meta AI team within the "),to=i(lt,"A",{href:!0,rel:!0});var kr=l(to);Wn=n(kr,"Fairseq library"),kr.forEach(t),jn=n(lt,"."),lt.forEach(t),Fr=u(o),ct=i(o,"P",{});var $r=l(ct);Fn=n($r,"Tips:"),$r.forEach(t),xr=u(o),U=i(o,"UL",{});var Ce=l(U);H=i(Ce,"LI",{});var R=l(H);xn=n(R,"Wav2Vec2-Conformer follows the same architecture as Wav2Vec2, but replaces the "),Lt=i(R,"EM",{});var Tr=l(Lt);qn=n(Tr,"Attention"),Tr.forEach(t),En=n(R,"-block with a "),Nt=i(R,"EM",{});var Vr=l(Nt);Pn=n(Vr,"Conformer"),Vr.forEach(t),Mn=n(R,`-block
...
rotary position embeddings by setting the correct `),Xt=i(Qr,"CODE",{});var al=l(Xt);Nn=n(al,"config.position_embeddings_type"),al.forEach(t),In=n(Qr,"."),Qr.forEach(t),Ce.forEach(t),qr=u(o),Z=i(o,"P",{});var Vt=l(Z);Xn=n(Vt,"This model was contributed by "),ao=i(Vt,"A",{href:!0,rel:!0});var sl=l(ao);Bn=n(sl,"patrickvonplaten"),sl.forEach(t),Hn=n(Vt,`.
The original code can be found `),so=i(Vt,"A",{href:!0,rel:!0});var il=l(so);Rn=n(il,"here"),il.forEach(t),Un=n(Vt,"."),Vt.forEach(t),Er=u(o),te=i(o,"H2",{class:!0});var Kr=l(te);We=i(Kr,"A",{id:!0,class:!0,href:!0});var ll=l(We);Bt=i(ll,"SPAN",{});var cl=l(Bt);C(io.$$.fragment,cl),cl.forEach(t),ll.forEach(t),Zn=u(Kr),Ht=i(Kr,"SPAN",{});var dl=l(Ht);Qn=n(dl,"Wav2Vec2ConformerConfig"),dl.forEach(t),Kr.forEach(t),Pr=u(o),S=i(o,"DIV",{class:!0});var Ke=l(S);C(lo.$$.fragment,Ke),Kn=u(Ke),re=i(Ke,"P",{});var Wt=l(re);Gn=n(Wt,"This is the configuration class to store the configuration of a "),dt=i(Wt,"A",{href:!0});var ml=l(dt);Jn=n(ml,"Wav2Vec2ConformerModel"),ml.forEach(t),Yn=n(Wt,`. It is used to
instantiate an Wav2Vec2Conformer model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Wav2Vec2Conformer
...
library implements for all its model (such as downloading or saving etc.).`),tn.forEach(t),Ta=u(Q),bo=i(Q,"P",{});var rn=l(bo);Va=n(rn,"This model is a PyTorch "),wo=i(rn,"A",{href:!0,rel:!0});var $l=l(wo);Wa=n($l,"nn.Module"),$l.forEach(t),ja=n(rn,` sub-class. Use it as a
regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and behavior.`),rn.forEach(t),Fa=u(Q),O=i(Q,"DIV",{class:!0});var Ge=l(O);C(Co.$$.fragment,Ge),xa=u(Ge),le=i(Ge,"P",{});var Ft=l(le);qa=n(Ft,"The "),ut=i(Ft,"A",{href:!0});var Tl=l(ut);Ea=n(Tl,"Wav2Vec2ConformerModel"),Tl.forEach(t),Pa=n(Ft," forward method, overrides the "),Kt=i(Ft,"CODE",{});var Vl=l(Kt);Ma=n(Vl,"__call__"),Vl.forEach(t),Aa=n(Ft," special method."),Ft.forEach(t),za=u(Ge),C(qe.$$.fragment,Ge),Sa=u(Ge),C(Ee.$$.fragment,Ge),Ge.forEach(t),Q.forEach(t),Or=u(o),ce=i(o,"H2",{class:!0});var nn=l(ce);Pe=i(nn,"A",{id:!0,class:!0,href:!0});var Wl=l(Pe);Gt=i(Wl,"SPAN",{});var jl=l(Gt);C(yo.$$.fragment,jl),jl.forEach(t),Wl.forEach(t),Oa=u(nn),Jt=i(nn,"SPAN",{});var Fl=l(Jt);Da=n(Fl,"Wav2Vec2ConformerForCTC"),Fl.forEach(t),nn.forEach(t),Dr=u(o),E=i(o,"DIV",{class:!0});var K=l(E);C(ko.$$.fragment,K),La=u(K),de=i(K,"P",{});var xt=l(de);Na=n(xt,"Wav2Vec2Conformer Model with a "),Yt=i(xt,"CODE",{});var xl=l(Yt);Ia=n(xl,"language modeling"),xl.forEach(t),Xa=n(xt,` head on top for Connectionist Temporal Classification (CTC).
...
Auli.`),xt.forEach(t),Ra=u(K),To=i(K,"P",{});var an=l(To);Ua=n(an,"This model inherits from "),gt=i(an,"A",{href:!0});var El=l(gt);Za=n(El,"PreTrainedModel"),El.forEach(t),Qa=n(an,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),an.forEach(t),Ka=u(K),Vo=i(K,"P",{});var sn=l(Vo);Ga=n(sn,"This model is a PyTorch "),Wo=i(sn,"A",{href:!0,rel:!0});var Pl=l(Wo);Ja=n(Pl,"nn.Module"),Pl.forEach(t),Ya=n(sn,` sub-class. Use it as a
