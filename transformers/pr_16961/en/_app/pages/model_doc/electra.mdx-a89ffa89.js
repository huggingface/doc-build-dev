...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16961/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16961/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16961/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16961/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16961/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16961/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16961/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
pooled output) e.g. for GLUE tasks.`),Xk=c(),cr=n("p"),Yk=r("This model inherits from "),fd=n("a"),Zk=r("PreTrainedModel"),e1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),t1=c(),pr=n("p"),o1=r("This model is also a PyTorch "),hr=n("a"),n1=r("torch.nn.Module"),s1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),a1=c(),Re=n("div"),b(mr.$$.fragment),r1=c(),jo=n("p"),i1=r("The "),ud=n("a"),l1=r("ElectraForSequenceClassification"),d1=r(" forward method, overrides the "),Qc=n("code"),c1=r("__call__"),p1=r(" special method."),h1=c(),b(In.$$.fragment),m1=c(),b(Sn.$$.fragment),f1=c(),b(Dn.$$.fragment),u1=c(),b(Wn.$$.fragment),g1=c(),b(Un.$$.fragment),cf=c(),qo=n("h2"),Rn=n("a"),Vc=n("span"),b(fr.$$.fragment),_1=c(),Bc=n("span"),k1=r("ElectraForMultipleChoice"),pf=c(),ot=n("div"),b(ur.$$.fragment),T1=c(),Kc=n("p"),v1=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),z1=c(),Ft=n("div"),b(Tr.$$.fragment),C1=c(),Po=n("p"),j1=r("The "),_d=n("a"),q1=r("ElectraForMultipleChoice"),P1=r(" forward method, overrides the "),Jc=n("code"),A1=r("__call__"),O1=r(" special method."),L1=c(),b(Hn.$$.fragment),N1=c(),b(Qn.$$.fragment),hf=c(),Ao=n("h2"),Vn=n("a"),Gc=n("span"),b(vr.$$.fragment),I1=c(),Xc=n("span"),S1=r("ElectraForTokenClassification"),mf=c(),Ve=n("div"),b(br.$$.fragment),D1=c(),Yc=n("p"),W1=r("Electra model with a token classification head on top."),U1=c(),Zc=n("p"),R1=r("Both the discriminator and generator may be loaded into this model."),H1=c(),yr=n("p"),Q1=r("This model inherits from "),kd=n("a"),V1=r("PreTrainedModel"),B1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),K1=c(),Er=n("p"),J1=r("This model is also a PyTorch "),wr=n("a"),G1=r("torch.nn.Module"),X1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Y1=c(),at=n("div"),b($r.$$.fragment),Z1=c(),Oo=n("p"),eT=r("The "),Td=n("a"),tT=r("ElectraForTokenClassification"),oT=r(" forward method, overrides the "),ep=n("code"),nT=r("__call__"),sT=r(" special method."),aT=c(),b(Bn.$$.fragment),rT=c(),b(Kn.$$.fragment),iT=c(),b(Jn.$$.fragment),ff=c(),Lo=n("h2"),Gn=n("a"),tp=n("span"),b(Fr.$$.fragment),lT=c(),op=n("span"),dT=r("ElectraForQuestionAnswering"),uf=c(),nt=n("div"),b(xr.$$.fragment),cT=c(),No=n("p"),pT=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),np=n("code"),hT=r("span start logits"),mT=r(" and "),sp=n("code"),fT=r("span end logits"),uT=r(")."),gT=c(),Mr=n("p"),_T=r("This model inherits from "),vd=n("a"),kT=r("PreTrainedModel"),TT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vT=c(),zr=n("p"),bT=r("This model is also a PyTorch "),Cr=n("a"),yT=r("torch.nn.Module"),ET=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
behavior.`),VT=c(),b(ts.$$.fragment),BT=c(),xt=n("div"),b(Nr.$$.fragment),KT=c(),Do=n("p"),JT=r("The "),Ed=n("a"),GT=r("TFElectraModel"),XT=r(" forward method, overrides the "),dp=n("code"),YT=r("__call__"),ZT=r(" special method."),ev=c(),b(os.$$.fragment),tv=c(),b(ns.$$.fragment),kf=c(),Wo=n("h2"),ss=n("a"),cp=n("span"),b(Ir.$$.fragment),ov=c(),pp=n("span"),nv=r("TFElectraForPreTraining"),Tf=c(),Oe=n("div"),b(Sr.$$.fragment),sv=c(),hp=n("p"),av=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),rv=c(),mp=n("p"),iv=r(`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),lv=c(),Dr=n("p"),dv=r("This model inherits from "),wd=n("a"),cv=r("TFPreTrainedModel"),pv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hv=c(),Wr=n("p"),mv=r("This model is also a "),Ur=n("a"),fv=r("tf.keras.Model"),uv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gv=c(),b(as.$$.fragment),_v=c(),Mt=n("div"),b(Rr.$$.fragment),kv=c(),Uo=n("p"),Tv=r("The "),$d=n("a"),vv=r("TFElectraForPreTraining"),bv=r(" forward method, overrides the "),fp=n("code"),yv=r("__call__"),Ev=r(" special method."),wv=c(),b(rs.$$.fragment),$v=c(),b(is.$$.fragment),vf=c(),Ro=n("h2"),ls=n("a"),up=n("span"),b(Hr.$$.fragment),Fv=c(),gp=n("span"),xv=r("TFElectraForMaskedLM"),bf=c(),Le=n("div"),b(Qr.$$.fragment),Mv=c(),_p=n("p"),zv=r("Electra model with a language modeling head on top."),Cv=c(),kp=n("p"),jv=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),qv=c(),Vr=n("p"),Pv=r("This model inherits from "),Fd=n("a"),Av=r("TFPreTrainedModel"),Ov=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lv=c(),Br=n("p"),Nv=r("This model is also a "),Kr=n("a"),Iv=r("tf.keras.Model"),Sv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dv=c(),b(ds.$$.fragment),Wv=c(),it=n("div"),b(Jr.$$.fragment),Uv=c(),Ho=n("p"),Rv=r("The "),xd=n("a"),Hv=r("TFElectraForMaskedLM"),Qv=r(" forward method, overrides the "),Tp=n("code"),Vv=r("__call__"),Bv=r(" special method."),Kv=c(),b(cs.$$.fragment),Jv=c(),b(ps.$$.fragment),Gv=c(),b(hs.$$.fragment),yf=c(),Qo=n("h2"),ms=n("a"),vp=n("span"),b(Gr.$$.fragment),Xv=c(),bp=n("span"),Yv=r("TFElectraForSequenceClassification"),Ef=c(),Ke=n("div"),b(Xr.$$.fragment),Zv=c(),yp=n("p"),eb=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),db=c(),b(fs.$$.fragment),cb=c(),lt=n("div"),b(ti.$$.fragment),pb=c(),Vo=n("p"),hb=r("The "),zd=n("a"),mb=r("TFElectraForSequenceClassification"),fb=r(" forward method, overrides the "),Ep=n("code"),ub=r("__call__"),gb=r(" special method."),_b=c(),b(us.$$.fragment),kb=c(),b(gs.$$.fragment),Tb=c(),b(_s.$$.fragment),wf=c(),Bo=n("h2"),ks=n("a"),wp=n("span"),b(oi.$$.fragment),vb=c(),$p=n("span"),bb=r("TFElectraForMultipleChoice"),$f=c(),Je=n("div"),b(ni.$$.fragment),yb=c(),Fp=n("p"),Eb=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qb=c(),b(Ts.$$.fragment),Pb=c(),zt=n("div"),b(ii.$$.fragment),Ab=c(),Ko=n("p"),Ob=r("The "),jd=n("a"),Lb=r("TFElectraForMultipleChoice"),Nb=r(" forward method, overrides the "),xp=n("code"),Ib=r("__call__"),Sb=r(" special method."),Db=c(),b(vs.$$.fragment),Wb=c(),b(bs.$$.fragment),Ff=c(),Jo=n("h2"),ys=n("a"),Mp=n("span"),b(li.$$.fragment),Ub=c(),zp=n("span"),Rb=r("TFElectraForTokenClassification"),xf=c(),Ne=n("div"),b(di.$$.fragment),Hb=c(),Cp=n("p"),Qb=r("Electra model with a token classification head on top."),Vb=c(),jp=n("p"),Bb=r("Both the discriminator and generator may be loaded into this model."),Kb=c(),ci=n("p"),Jb=r("This model inherits from "),qd=n("a"),Gb=r("TFPreTrainedModel"),Xb=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yb=c(),pi=n("p"),Zb=r("This model is also a "),hi=n("a"),ey=r("tf.keras.Model"),ty=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),oy=c(),b(Es.$$.fragment),ny=c(),dt=n("div"),b(mi.$$.fragment),sy=c(),Go=n("p"),ay=r("The "),Pd=n("a"),ry=r("TFElectraForTokenClassification"),iy=r(" forward method, overrides the "),qp=n("code"),ly=r("__call__"),dy=r(" special method."),cy=c(),b(ws.$$.fragment),py=c(),b($s.$$.fragment),hy=c(),b(Fs.$$.fragment),Mf=c(),Xo=n("h2"),xs=n("a"),Pp=n("span"),b(fi.$$.fragment),my=c(),Ap=n("span"),fy=r("TFElectraForQuestionAnswering"),zf=c(),Ge=n("div"),b(ui.$$.fragment),uy=c(),Yo=n("p"),gy=r(`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=n("code"),_y=r("span start logits"),ky=r(" and "),Lp=n("code"),Ty=r("span end logits"),vy=r(")."),by=c(),gi=n("p"),yy=r("This model inherits from "),Ad=n("a"),Ey=r("TFPreTrainedModel"),wy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$y=c(),_i=n("p"),Fy=r("This model is also a "),ki=n("a"),xy=r("tf.keras.Model"),My=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zy=c(),b(Ms.$$.fragment),Cy=c(),ct=n("div"),b(Ti.$$.fragment),jy=c(),Zo=n("p"),qy=r("The "),Od=n("a"),Py=r("TFElectraForQuestionAnswering"),Ay=r(" forward method, overrides the "),Np=n("code"),Oy=r("__call__"),Ly=r(" special method."),Ny=c(),b(zs.$$.fragment),Iy=c(),b(Cs.$$.fragment),Sy=c(),b(js.$$.fragment),Cf=c(),en=n("h2"),qs=n("a"),Ip=n("span"),b(vi.$$.fragment),Dy=c(),Sp=n("span"),Wy=r("FlaxElectraModel"),jf=c(),Ie=n("div"),b(bi.$$.fragment),Uy=c(),Dp=n("p"),Ry=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),Hy=c(),yi=n("p"),Qy=r("This model inherits from "),Ld=n("a"),Vy=r("FlaxPreTrainedModel"),By=r(`. Check the superclass documentation for the generic methods the
...
pooled output) e.g. for GLUE tasks.`),LF.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var du=a(cr);Yk=i(du,"This model inherits from "),fd=s(du,"A",{href:!0});var NF=a(fd);Zk=i(NF,"PreTrainedModel"),NF.forEach(t),e1=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),du.forEach(t),t1=p(ro),pr=s(ro,"P",{});var cu=a(pr);o1=i(cu,"This model is also a PyTorch "),hr=s(cu,"A",{href:!0,rel:!0});var IF=a(hr);n1=i(IF,"torch.nn.Module"),IF.forEach(t),s1=i(cu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cu.forEach(t),a1=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),r1=p(pt),jo=s(pt,"P",{});var Bd=a(jo);i1=i(Bd,"The "),ud=s(Bd,"A",{href:!0});var SF=a(ud);l1=i(SF,"ElectraForSequenceClassification"),SF.forEach(t),d1=i(Bd," forward method, overrides the "),Qc=s(Bd,"CODE",{});var DF=a(Qc);c1=i(DF,"__call__"),DF.forEach(t),p1=i(Bd," special method."),Bd.forEach(t),h1=p(pt),y(In.$$.fragment,pt),m1=p(pt),y(Sn.$$.fragment,pt),f1=p(pt),y(Dn.$$.fragment,pt),u1=p(pt),y(Wn.$$.fragment,pt),g1=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),cf=p(o),qo=s(o,"H2",{class:!0});var pu=a(qo);Rn=s(pu,"A",{id:!0,class:!0,href:!0});var WF=a(Rn);Vc=s(WF,"SPAN",{});var UF=a(Vc);y(fr.$$.fragment,UF),UF.forEach(t),WF.forEach(t),_1=p(pu),Bc=s(pu,"SPAN",{});var RF=a(Bc);k1=i(RF,"ElectraForMultipleChoice"),RF.forEach(t),pu.forEach(t),pf=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(ur.$$.fragment,io),T1=p(io),Kc=s(io,"P",{});var HF=a(Kc);v1=i(HF,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),HF.forEach(t),b1=p(io),gr=s(io,"P",{});var hu=a(gr);y1=i(hu,"This model inherits from "),gd=s(hu,"A",{href:!0});var QF=a(gd);E1=i(QF,"PreTrainedModel"),QF.forEach(t),w1=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hu.forEach(t),$1=p(io),_r=s(io,"P",{});var mu=a(_r);F1=i(mu,"This model is also a PyTorch "),kr=s(mu,"A",{href:!0,rel:!0});var VF=a(kr);x1=i(VF,"torch.nn.Module"),VF.forEach(t),M1=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),z1=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(Tr.$$.fragment,sa),C1=p(sa),Po=s(sa,"P",{});var Kd=a(Po);j1=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var BF=a(_d);q1=i(BF,"ElectraForMultipleChoice"),BF.forEach(t),P1=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var KF=a(Jc);A1=i(KF,"__call__"),KF.forEach(t),O1=i(Kd," special method."),Kd.forEach(t),L1=p(sa),y(Hn.$$.fragment,sa),N1=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),hf=p(o),Ao=s(o,"H2",{class:!0});var fu=a(Ao);Vn=s(fu,"A",{id:!0,class:!0,href:!0});var JF=a(Vn);Gc=s(JF,"SPAN",{});var GF=a(Gc);y(vr.$$.fragment,GF),GF.forEach(t),JF.forEach(t),I1=p(fu),Xc=s(fu,"SPAN",{});var XF=a(Xc);S1=i(XF,"ElectraForTokenClassification"),XF.forEach(t),fu.forEach(t),mf=p(o),Ve=s(o,"DIV",{class:!0});var St=a(Ve);y(br.$$.fragment,St),D1=p(St),Yc=s(St,"P",{});var YF=a(Yc);W1=i(YF,"Electra model with a token classification head on top."),YF.forEach(t),U1=p(St),Zc=s(St,"P",{});var ZF=a(Zc);R1=i(ZF,"Both the discriminator and generator may be loaded into this model."),ZF.forEach(t),H1=p(St),yr=s(St,"P",{});var uu=a(yr);Q1=i(uu,"This model inherits from "),kd=s(uu,"A",{href:!0});var e0=a(kd);V1=i(e0,"PreTrainedModel"),e0.forEach(t),B1=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),K1=p(St),Er=s(St,"P",{});var gu=a(Er);J1=i(gu,"This model is also a PyTorch "),wr=s(gu,"A",{href:!0,rel:!0});var t0=a(wr);G1=i(t0,"torch.nn.Module"),t0.forEach(t),X1=i(gu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gu.forEach(t),Y1=p(St),at=s(St,"DIV",{class:!0});var lo=a(at);y($r.$$.fragment,lo),Z1=p(lo),Oo=s(lo,"P",{});var Jd=a(Oo);eT=i(Jd,"The "),Td=s(Jd,"A",{href:!0});var o0=a(Td);tT=i(o0,"ElectraForTokenClassification"),o0.forEach(t),oT=i(Jd," forward method, overrides the "),ep=s(Jd,"CODE",{});var n0=a(ep);nT=i(n0,"__call__"),n0.forEach(t),sT=i(Jd," special method."),Jd.forEach(t),aT=p(lo),y(Bn.$$.fragment,lo),rT=p(lo),y(Kn.$$.fragment,lo),iT=p(lo),y(Jn.$$.fragment,lo),lo.forEach(t),St.forEach(t),ff=p(o),Lo=s(o,"H2",{class:!0});var _u=a(Lo);Gn=s(_u,"A",{id:!0,class:!0,href:!0});var s0=a(Gn);tp=s(s0,"SPAN",{});var a0=a(tp);y(Fr.$$.fragment,a0),a0.forEach(t),s0.forEach(t),lT=p(_u),op=s(_u,"SPAN",{});var r0=a(op);dT=i(r0,"ElectraForQuestionAnswering"),r0.forEach(t),_u.forEach(t),uf=p(o),nt=s(o,"DIV",{class:!0});var co=a(nt);y(xr.$$.fragment,co),cT=p(co),No=s(co,"P",{});var Gd=a(No);pT=i(Gd,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),np=s(Gd,"CODE",{});var i0=a(np);hT=i(i0,"span start logits"),i0.forEach(t),mT=i(Gd," and "),sp=s(Gd,"CODE",{});var l0=a(sp);fT=i(l0,"span end logits"),l0.forEach(t),uT=i(Gd,")."),Gd.forEach(t),gT=p(co),Mr=s(co,"P",{});var ku=a(Mr);_T=i(ku,"This model inherits from "),vd=s(ku,"A",{href:!0});var d0=a(vd);kT=i(d0,"PreTrainedModel"),d0.forEach(t),TT=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),vT=p(co),zr=s(co,"P",{});var Tu=a(zr);bT=i(Tu,"This model is also a PyTorch "),Cr=s(Tu,"A",{href:!0,rel:!0});var c0=a(Cr);yT=i(c0,"torch.nn.Module"),c0.forEach(t),ET=i(Tu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tu.forEach(t),wT=p(co),rt=s(co,"DIV",{class:!0});var po=a(rt);y(jr.$$.fragment,po),$T=p(po),Io=s(po,"P",{});var Xd=a(Io);FT=i(Xd,"The "),bd=s(Xd,"A",{href:!0});var p0=a(bd);xT=i(p0,"ElectraForQuestionAnswering"),p0.forEach(t),MT=i(Xd," forward method, overrides the "),ap=s(Xd,"CODE",{});var h0=a(ap);zT=i(h0,"__call__"),h0.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=p(po),y(Xn.$$.fragment,po),qT=p(po),y(Yn.$$.fragment,po),PT=p(po),y(Zn.$$.fragment,po),po.forEach(t),co.forEach(t),gf=p(o),So=s(o,"H2",{class:!0});var vu=a(So);es=s(vu,"A",{id:!0,class:!0,href:!0});var m0=a(es);rp=s(m0,"SPAN",{});var f0=a(rp);y(qr.$$.fragment,f0),f0.forEach(t),m0.forEach(t),AT=p(vu),ip=s(vu,"SPAN",{});var u0=a(ip);OT=i(u0,"TFElectraModel"),u0.forEach(t),vu.forEach(t),_f=p(o),Be=s(o,"DIV",{class:!0});var Dt=a(Be);y(Pr.$$.fragment,Dt),LT=p(Dt),lp=s(Dt,"P",{});var g0=a(lp);NT=i(g0,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),g0.forEach(t),IT=p(Dt),Ar=s(Dt,"P",{});var bu=a(Ar);ST=i(bu,"This model inherits from "),yd=s(bu,"A",{href:!0});var _0=a(yd);DT=i(_0,"TFPreTrainedModel"),_0.forEach(t),WT=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yu.forEach(t),VT=p(Dt),y(ts.$$.fragment,Dt),BT=p(Dt),xt=s(Dt,"DIV",{class:!0});var aa=a(xt);y(Nr.$$.fragment,aa),KT=p(aa),Do=s(aa,"P",{});var Yd=a(Do);JT=i(Yd,"The "),Ed=s(Yd,"A",{href:!0});var T0=a(Ed);GT=i(T0,"TFElectraModel"),T0.forEach(t),XT=i(Yd," forward method, overrides the "),dp=s(Yd,"CODE",{});var v0=a(dp);YT=i(v0,"__call__"),v0.forEach(t),ZT=i(Yd," special method."),Yd.forEach(t),ev=p(aa),y(os.$$.fragment,aa),tv=p(aa),y(ns.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),kf=p(o),Wo=s(o,"H2",{class:!0});var Eu=a(Wo);ss=s(Eu,"A",{id:!0,class:!0,href:!0});var b0=a(ss);cp=s(b0,"SPAN",{});var y0=a(cp);y(Ir.$$.fragment,y0),y0.forEach(t),b0.forEach(t),ov=p(Eu),pp=s(Eu,"SPAN",{});var E0=a(pp);nv=i(E0,"TFElectraForPreTraining"),E0.forEach(t),Eu.forEach(t),Tf=p(o),Oe=s(o,"DIV",{class:!0});var ht=a(Oe);y(Sr.$$.fragment,ht),sv=p(ht),hp=s(ht,"P",{});var w0=a(hp);av=i(w0,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),w0.forEach(t),rv=p(ht),mp=s(ht,"P",{});var $0=a(mp);iv=i($0,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),$0.forEach(t),lv=p(ht),Dr=s(ht,"P",{});var wu=a(Dr);dv=i(wu,"This model inherits from "),wd=s(wu,"A",{href:!0});var F0=a(wd);cv=i(F0,"TFPreTrainedModel"),F0.forEach(t),pv=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),hv=p(ht),Wr=s(ht,"P",{});var $u=a(Wr);mv=i($u,"This model is also a "),Ur=s($u,"A",{href:!0,rel:!0});var x0=a(Ur);fv=i(x0,"tf.keras.Model"),x0.forEach(t),uv=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),gv=p(ht),y(as.$$.fragment,ht),_v=p(ht),Mt=s(ht,"DIV",{class:!0});var ra=a(Mt);y(Rr.$$.fragment,ra),kv=p(ra),Uo=s(ra,"P",{});var Zd=a(Uo);Tv=i(Zd,"The "),$d=s(Zd,"A",{href:!0});var M0=a($d);vv=i(M0,"TFElectraForPreTraining"),M0.forEach(t),bv=i(Zd," forward method, overrides the "),fp=s(Zd,"CODE",{});var z0=a(fp);yv=i(z0,"__call__"),z0.forEach(t),Ev=i(Zd," special method."),Zd.forEach(t),wv=p(ra),y(rs.$$.fragment,ra),$v=p(ra),y(is.$$.fragment,ra),ra.forEach(t),ht.forEach(t),vf=p(o),Ro=s(o,"H2",{class:!0});var Fu=a(Ro);ls=s(Fu,"A",{id:!0,class:!0,href:!0});var C0=a(ls);up=s(C0,"SPAN",{});var j0=a(up);y(Hr.$$.fragment,j0),j0.forEach(t),C0.forEach(t),Fv=p(Fu),gp=s(Fu,"SPAN",{});var q0=a(gp);xv=i(q0,"TFElectraForMaskedLM"),q0.forEach(t),Fu.forEach(t),bf=p(o),Le=s(o,"DIV",{class:!0});var mt=a(Le);y(Qr.$$.fragment,mt),Mv=p(mt),_p=s(mt,"P",{});var P0=a(_p);zv=i(P0,"Electra model with a language modeling head on top."),P0.forEach(t),Cv=p(mt),kp=s(mt,"P",{});var A0=a(kp);jv=i(A0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),A0.forEach(t),qv=p(mt),Vr=s(mt,"P",{});var xu=a(Vr);Pv=i(xu,"This model inherits from "),Fd=s(xu,"A",{href:!0});var O0=a(Fd);Av=i(O0,"TFPreTrainedModel"),O0.forEach(t),Ov=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),Lv=p(mt),Br=s(mt,"P",{});var Mu=a(Br);Nv=i(Mu,"This model is also a "),Kr=s(Mu,"A",{href:!0,rel:!0});var L0=a(Kr);Iv=i(L0,"tf.keras.Model"),L0.forEach(t),Sv=i(Mu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mu.forEach(t),Dv=p(mt),y(ds.$$.fragment,mt),Wv=p(mt),it=s(mt,"DIV",{class:!0});var ho=a(it);y(Jr.$$.fragment,ho),Uv=p(ho),Ho=s(ho,"P",{});var ec=a(Ho);Rv=i(ec,"The "),xd=s(ec,"A",{href:!0});var N0=a(xd);Hv=i(N0,"TFElectraForMaskedLM"),N0.forEach(t),Qv=i(ec," forward method, overrides the "),Tp=s(ec,"CODE",{});var I0=a(Tp);Vv=i(I0,"__call__"),I0.forEach(t),Bv=i(ec," special method."),ec.forEach(t),Kv=p(ho),y(cs.$$.fragment,ho),Jv=p(ho),y(ps.$$.fragment,ho),Gv=p(ho),y(hs.$$.fragment,ho),ho.forEach(t),mt.forEach(t),yf=p(o),Qo=s(o,"H2",{class:!0});var zu=a(Qo);ms=s(zu,"A",{id:!0,class:!0,href:!0});var S0=a(ms);vp=s(S0,"SPAN",{});var D0=a(vp);y(Gr.$$.fragment,D0),D0.forEach(t),S0.forEach(t),Xv=p(zu),bp=s(zu,"SPAN",{});var W0=a(bp);Yv=i(W0,"TFElectraForSequenceClassification"),W0.forEach(t),zu.forEach(t),Ef=p(o),Ke=s(o,"DIV",{class:!0});var Wt=a(Ke);y(Xr.$$.fragment,Wt),Zv=p(Wt),yp=s(Wt,"P",{});var U0=a(yp);eb=i(U0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),U0.forEach(t),tb=p(Wt),Yr=s(Wt,"P",{});var Cu=a(Yr);ob=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var R0=a(Md);nb=i(R0,"TFPreTrainedModel"),R0.forEach(t),sb=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),ab=p(Wt),Zr=s(Wt,"P",{});var ju=a(Zr);rb=i(ju,"This model is also a "),ei=s(ju,"A",{href:!0,rel:!0});var H0=a(ei);ib=i(H0,"tf.keras.Model"),H0.forEach(t),lb=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),db=p(Wt),y(fs.$$.fragment,Wt),cb=p(Wt),lt=s(Wt,"DIV",{class:!0});var mo=a(lt);y(ti.$$.fragment,mo),pb=p(mo),Vo=s(mo,"P",{});var tc=a(Vo);hb=i(tc,"The "),zd=s(tc,"A",{href:!0});var Q0=a(zd);mb=i(Q0,"TFElectraForSequenceClassification"),Q0.forEach(t),fb=i(tc," forward method, overrides the "),Ep=s(tc,"CODE",{});var V0=a(Ep);ub=i(V0,"__call__"),V0.forEach(t),gb=i(tc," special method."),tc.forEach(t),_b=p(mo),y(us.$$.fragment,mo),kb=p(mo),y(gs.$$.fragment,mo),Tb=p(mo),y(_s.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),wf=p(o),Bo=s(o,"H2",{class:!0});var qu=a(Bo);ks=s(qu,"A",{id:!0,class:!0,href:!0});var B0=a(ks);wp=s(B0,"SPAN",{});var K0=a(wp);y(oi.$$.fragment,K0),K0.forEach(t),B0.forEach(t),vb=p(qu),$p=s(qu,"SPAN",{});var J0=a($p);bb=i(J0,"TFElectraForMultipleChoice"),J0.forEach(t),qu.forEach(t),$f=p(o),Je=s(o,"DIV",{class:!0});var Ut=a(Je);y(ni.$$.fragment,Ut),yb=p(Ut),Fp=s(Ut,"P",{});var G0=a(Fp);Eb=i(G0,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),G0.forEach(t),wb=p(Ut),si=s(Ut,"P",{});var Pu=a(si);$b=i(Pu,"This model inherits from "),Cd=s(Pu,"A",{href:!0});var X0=a(Cd);Fb=i(X0,"TFPreTrainedModel"),X0.forEach(t),xb=i(Pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pu.forEach(t),Mb=p(Ut),ai=s(Ut,"P",{});var Au=a(ai);zb=i(Au,"This model is also a "),ri=s(Au,"A",{href:!0,rel:!0});var Y0=a(ri);Cb=i(Y0,"tf.keras.Model"),Y0.forEach(t),jb=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),qb=p(Ut),y(Ts.$$.fragment,Ut),Pb=p(Ut),zt=s(Ut,"DIV",{class:!0});var ia=a(zt);y(ii.$$.fragment,ia),Ab=p(ia),Ko=s(ia,"P",{});var oc=a(Ko);Ob=i(oc,"The "),jd=s(oc,"A",{href:!0});var Z0=a(jd);Lb=i(Z0,"TFElectraForMultipleChoice"),Z0.forEach(t),Nb=i(oc," forward method, overrides the "),xp=s(oc,"CODE",{});var ex=a(xp);Ib=i(ex,"__call__"),ex.forEach(t),Sb=i(oc," special method."),oc.forEach(t),Db=p(ia),y(vs.$$.fragment,ia),Wb=p(ia),y(bs.$$.fragment,ia),ia.forEach(t),Ut.forEach(t),Ff=p(o),Jo=s(o,"H2",{class:!0});var Ou=a(Jo);ys=s(Ou,"A",{id:!0,class:!0,href:!0});var tx=a(ys);Mp=s(tx,"SPAN",{});var ox=a(Mp);y(li.$$.fragment,ox),ox.forEach(t),tx.forEach(t),Ub=p(Ou),zp=s(Ou,"SPAN",{});var nx=a(zp);Rb=i(nx,"TFElectraForTokenClassification"),nx.forEach(t),Ou.forEach(t),xf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(di.$$.fragment,ft),Hb=p(ft),Cp=s(ft,"P",{});var sx=a(Cp);Qb=i(sx,"Electra model with a token classification head on top."),sx.forEach(t),Vb=p(ft),jp=s(ft,"P",{});var ax=a(jp);Bb=i(ax,"Both the discriminator and generator may be loaded into this model."),ax.forEach(t),Kb=p(ft),ci=s(ft,"P",{});var Lu=a(ci);Jb=i(Lu,"This model inherits from "),qd=s(Lu,"A",{href:!0});var rx=a(qd);Gb=i(rx,"TFPreTrainedModel"),rx.forEach(t),Xb=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),Yb=p(ft),pi=s(ft,"P",{});var Nu=a(pi);Zb=i(Nu,"This model is also a "),hi=s(Nu,"A",{href:!0,rel:!0});var ix=a(hi);ey=i(ix,"tf.keras.Model"),ix.forEach(t),ty=i(Nu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nu.forEach(t),oy=p(ft),y(Es.$$.fragment,ft),ny=p(ft),dt=s(ft,"DIV",{class:!0});var fo=a(dt);y(mi.$$.fragment,fo),sy=p(fo),Go=s(fo,"P",{});var nc=a(Go);ay=i(nc,"The "),Pd=s(nc,"A",{href:!0});var lx=a(Pd);ry=i(lx,"TFElectraForTokenClassification"),lx.forEach(t),iy=i(nc," forward method, overrides the "),qp=s(nc,"CODE",{});var dx=a(qp);ly=i(dx,"__call__"),dx.forEach(t),dy=i(nc," special method."),nc.forEach(t),cy=p(fo),y(ws.$$.fragment,fo),py=p(fo),y($s.$$.fragment,fo),hy=p(fo),y(Fs.$$.fragment,fo),fo.forEach(t),ft.forEach(t),Mf=p(o),Xo=s(o,"H2",{class:!0});var Iu=a(Xo);xs=s(Iu,"A",{id:!0,class:!0,href:!0});var cx=a(xs);Pp=s(cx,"SPAN",{});var px=a(Pp);y(fi.$$.fragment,px),px.forEach(t),cx.forEach(t),my=p(Iu),Ap=s(Iu,"SPAN",{});var hx=a(Ap);fy=i(hx,"TFElectraForQuestionAnswering"),hx.forEach(t),Iu.forEach(t),zf=p(o),Ge=s(o,"DIV",{class:!0});var Rt=a(Ge);y(ui.$$.fragment,Rt),uy=p(Rt),Yo=s(Rt,"P",{});var sc=a(Yo);gy=i(sc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(sc,"CODE",{});var mx=a(Op);_y=i(mx,"span start logits"),mx.forEach(t),ky=i(sc," and "),Lp=s(sc,"CODE",{});var fx=a(Lp);Ty=i(fx,"span end logits"),fx.forEach(t),vy=i(sc,")."),sc.forEach(t),by=p(Rt),gi=s(Rt,"P",{});var Su=a(gi);yy=i(Su,"This model inherits from "),Ad=s(Su,"A",{href:!0});var ux=a(Ad);Ey=i(ux,"TFPreTrainedModel"),ux.forEach(t),wy=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Su.forEach(t),$y=p(Rt),_i=s(Rt,"P",{});var Du=a(_i);Fy=i(Du,"This model is also a "),ki=s(Du,"A",{href:!0,rel:!0});var gx=a(ki);xy=i(gx,"tf.keras.Model"),gx.forEach(t),My=i(Du,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Du.forEach(t),zy=p(Rt),y(Ms.$$.fragment,Rt),Cy=p(Rt),ct=s(Rt,"DIV",{class:!0});var uo=a(ct);y(Ti.$$.fragment,uo),jy=p(uo),Zo=s(uo,"P",{});var ac=a(Zo);qy=i(ac,"The "),Od=s(ac,"A",{href:!0});var _x=a(Od);Py=i(_x,"TFElectraForQuestionAnswering"),_x.forEach(t),Ay=i(ac," forward method, overrides the "),Np=s(ac,"CODE",{});var kx=a(Np);Oy=i(kx,"__call__"),kx.forEach(t),Ly=i(ac," special method."),ac.forEach(t),Ny=p(uo),y(zs.$$.fragment,uo),Iy=p(uo),y(Cs.$$.fragment,uo),Sy=p(uo),y(js.$$.fragment,uo),uo.forEach(t),Rt.forEach(t),Cf=p(o),en=s(o,"H2",{class:!0});var Wu=a(en);qs=s(Wu,"A",{id:!0,class:!0,href:!0});var Tx=a(qs);Ip=s(Tx,"SPAN",{});var vx=a(Ip);y(vi.$$.fragment,vx),vx.forEach(t),Tx.forEach(t),Dy=p(Wu),Sp=s(Wu,"SPAN",{});var bx=a(Sp);Wy=i(bx,"FlaxElectraModel"),bx.forEach(t),Wu.forEach(t),jf=p(o),Ie=s(o,"DIV",{class:!0});var ut=a(Ie);y(bi.$$.fragment,ut),Uy=p(ut),Dp=s(ut,"P",{});var yx=a(Dp);Ry=i(yx,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),yx.forEach(t),Hy=p(ut),yi=s(ut,"P",{});var Uu=a(yi);Qy=i(Uu,"This model inherits from "),Ld=s(Uu,"A",{href:!0});var Ex=a(Ld);Vy=i(Ex,"FlaxPreTrainedModel"),Ex.forEach(t),By=i(Uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Uu.forEach(t),Ky=p(ut),Ei=s(ut,"P",{});var Ru=a(Ei);Jy=i(Ru,`This model is also a Flax Linen
`),wi=s(Ru,"A",{href:!0,rel:!0});var wx=a(wi);Gy=i(wx,"flax.nn.Module"),wx.forEach(t),Xy=i(Ru,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ru.forEach(t),Yy=p(ut),Wp=s(ut,"P",{});var $x=a(Wp);Zy=i($x,"Finally, this model supports inherent JAX features such as:"),$x.forEach(t),eE=p(ut),Qt=s(ut,"UL",{});var la=a(Qt);Up=s(la,"LI",{});var Fx=a(Up);$i=s(Fx,"A",{href:!0,rel:!0});var xx=a($i);tE=i(xx,"Just-In-Time (JIT) compilation"),xx.forEach(t),Fx.forEach(t),oE=p(la),Rp=s(la,"LI",{});var Mx=a(Rp);Fi=s(Mx,"A",{href:!0,rel:!0});var zx=a(Fi);nE=i(zx,"Automatic Differentiation"),zx.forEach(t),Mx.forEach(t),sE=p(la),Hp=s(la,"LI",{});var Cx=a(Hp);xi=s(Cx,"A",{href:!0,rel:!0});var jx=a(xi);aE=i(jx,"Vectorization"),jx.forEach(t),Cx.forEach(t),rE=p(la),Qp=s(la,"LI",{});var qx=a(Qp);Mi=s(qx,"A",{href:!0,rel:!0});var Px=a(Mi);iE=i(Px,"Parallelization"),Px.forEach(t),qx.forEach(t),la.forEach(t),lE=p(ut),Ct=s(ut,"DIV",{class:!0});var da=a(Ct);y(zi.$$.fragment,da),dE=p(da),tn=s(da,"P",{});var rc=a(tn);cE=i(rc,"The "),Vp=s(rc,"CODE",{});var Ax=a(Vp);pE=i(Ax,"FlaxElectraPreTrainedModel"),Ax.forEach(t),hE=i(rc," forward method, overrides the "),Bp=s(rc,"CODE",{});var Ox=a(Bp);mE=i(Ox,"__call__"),Ox.forEach(t),fE=i(rc," special method."),rc.forEach(t),uE=p(da),y(Ps.$$.fragment,da),gE=p(da),y(As.$$.fragment,da),da.forEach(t),ut.forEach(t),qf=p(o),on=s(o,"H2",{class:!0});var Hu=a(on);Os=s(Hu,"A",{id:!0,class:!0,href:!0});var Lx=a(Os);Kp=s(Lx,"SPAN",{});var Nx=a(Kp);y(Ci.$$.fragment,Nx),Nx.forEach(t),Lx.forEach(t),_E=p(Hu),Jp=s(Hu,"SPAN",{});var Ix=a(Jp);kE=i(Ix,"FlaxElectraForPreTraining"),Ix.forEach(t),Hu.forEach(t),Pf=p(o),Pe=s(o,"DIV",{class:!0});var Xe=a(Pe);y(ji.$$.fragment,Xe),TE=p(Xe),Gp=s(Xe,"P",{});var Sx=a(Gp);vE=i(Sx,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),Sx.forEach(t),bE=p(Xe),Xp=s(Xe,"P",{});var Dx=a(Xp);yE=i(Dx,"It is recommended to load the discriminator checkpoint into that model."),Dx.forEach(t),EE=p(Xe),qi=s(Xe,"P",{});var Qu=a(qi);wE=i(Qu,"This model inherits from "),Nd=s(Qu,"A",{href:!0});var Wx=a(Nd);$E=i(Wx,"FlaxPreTrainedModel"),Wx.forEach(t),FE=i(Qu,`. Check the superclass documentation for the generic methods the
