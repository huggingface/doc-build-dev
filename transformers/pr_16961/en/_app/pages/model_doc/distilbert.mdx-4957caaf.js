...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16961/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16961/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16961/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16961/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16961/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16961/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16961/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16961/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
linear layer on top of the hidden-states output to compute `),qd=o("code"),c1=a("span start logits"),p1=a(" and "),Pd=o("code"),h1=a("span end logits"),u1=a(")."),m1=p(),ia=o("p"),f1=a("This model inherits from "),nl=o("a"),g1=a("TFPreTrainedModel"),_1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),b1=p(),la=o("p"),v1=a("This model is also a "),da=o("a"),k1=a("tf.keras.Model"),T1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$1=p(),T(Uo.$$.fragment),w1=p(),et=o("div"),T(ca.$$.fragment),y1=p(),Ms=o("p"),F1=a("The "),rl=o("a"),D1=a("TFDistilBertForQuestionAnswering"),x1=a(" forward method, overrides the "),Ad=o("code"),B1=a("__call__"),M1=a(" special method."),E1=p(),T(Ho.$$.fragment),z1=p(),T(Vo.$$.fragment),j1=p(),T(Ko.$$.fragment),rh=p(),Es=o("h2"),Jo=o("a"),Od=o("span"),T(pa.$$.fragment),C1=p(),Nd=o("span"),q1=a("FlaxDistilBertModel"),ah=p(),Me=o("div"),T(ha.$$.fragment),P1=p(),Ld=o("p"),A1=a("The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),O1=p(),ua=o("p"),N1=a("This model inherits from "),al=o("a"),L1=a("FlaxPreTrainedModel"),S1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),I1=p(),ma=o("p"),W1=a("This model is also a Flax Linen "),fa=o("a"),Q1=a("flax.linen.Module"),R1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),U1=p(),Sd=o("p"),H1=a("Finally, this model supports inherent JAX features such as:"),V1=p(),Mt=o("ul"),Id=o("li"),ga=o("a"),K1=a("Just-In-Time (JIT) compilation"),J1=p(),Wd=o("li"),_a=o("a"),G1=a("Automatic Differentiation"),X1=p(),Qd=o("li"),ba=o("a"),Y1=a("Vectorization"),Z1=p(),Rd=o("li"),va=o("a"),ev=a("Parallelization"),tv=p(),gt=o("div"),T(ka.$$.fragment),sv=p(),zs=o("p"),ov=a("The "),Ud=o("code"),nv=a("FlaxDistilBertPreTrainedModel"),rv=a(" forward method, overrides the "),Hd=o("code"),av=a("__call__"),iv=a(" special method."),lv=p(),T(Go.$$.fragment),dv=p(),T(Xo.$$.fragment),ih=p(),js=o("h2"),Yo=o("a"),Vd=o("span"),T(Ta.$$.fragment),cv=p(),Kd=o("span"),pv=a("FlaxDistilBertForMaskedLM"),lh=p(),Ee=o("div"),T($a.$$.fragment),hv=p(),wa=o("p"),uv=a("DistilBert Model with a "),Jd=o("code"),mv=a("language modeling"),fv=a(" head on top."),gv=p(),ya=o("p"),_v=a("This model inherits from "),il=o("a"),bv=a("FlaxPreTrainedModel"),vv=a(`. Check the superclass documentation for the generic methods the
...
pooled output) e.g. for GLUE tasks.`),Vv=p(),qa=o("p"),Kv=a("This model inherits from "),ll=o("a"),Jv=a("FlaxPreTrainedModel"),Gv=a(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tk=p(),ac=o("p"),sk=a("Finally, this model supports inherent JAX features such as:"),ok=p(),zt=o("ul"),ic=o("li"),Oa=o("a"),nk=a("Just-In-Time (JIT) compilation"),rk=p(),lc=o("li"),Na=o("a"),ak=a("Automatic Differentiation"),ik=p(),dc=o("li"),La=o("a"),lk=a("Vectorization"),dk=p(),cc=o("li"),Sa=o("a"),ck=a("Parallelization"),pk=p(),bt=o("div"),T(Ia.$$.fragment),hk=p(),Ps=o("p"),uk=a("The "),pc=o("code"),mk=a("FlaxDistilBertPreTrainedModel"),fk=a(" forward method, overrides the "),hc=o("code"),gk=a("__call__"),_k=a(" special method."),bk=p(),T(sn.$$.fragment),vk=p(),T(on.$$.fragment),ph=p(),As=o("h2"),nn=o("a"),uc=o("span"),T(Wa.$$.fragment),kk=p(),mc=o("span"),Tk=a("FlaxDistilBertForMultipleChoice"),hh=p(),je=o("div"),T(Qa.$$.fragment),$k=p(),fc=o("p"),wk=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),jk=p(),gc=o("p"),Ck=a("Finally, this model supports inherent JAX features such as:"),qk=p(),jt=o("ul"),_c=o("li"),Va=o("a"),Pk=a("Just-In-Time (JIT) compilation"),Ak=p(),bc=o("li"),Ka=o("a"),Ok=a("Automatic Differentiation"),Nk=p(),vc=o("li"),Ja=o("a"),Lk=a("Vectorization"),Sk=p(),kc=o("li"),Ga=o("a"),Ik=a("Parallelization"),Wk=p(),vt=o("div"),T(Xa.$$.fragment),Qk=p(),Os=o("p"),Rk=a("The "),Tc=o("code"),Uk=a("FlaxDistilBertPreTrainedModel"),Hk=a(" forward method, overrides the "),$c=o("code"),Vk=a("__call__"),Kk=a(" special method."),Jk=p(),T(rn.$$.fragment),Gk=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),Xk=p(),yc=o("span"),Yk=a("FlaxDistilBertForTokenClassification"),mh=p(),Ce=o("div"),T(Za.$$.fragment),Zk=p(),Fc=o("p"),eT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),dT=p(),Dc=o("p"),cT=a("Finally, this model supports inherent JAX features such as:"),pT=p(),Ct=o("ul"),xc=o("li"),oi=o("a"),hT=a("Just-In-Time (JIT) compilation"),uT=p(),Bc=o("li"),ni=o("a"),mT=a("Automatic Differentiation"),fT=p(),Mc=o("li"),ri=o("a"),gT=a("Vectorization"),_T=p(),Ec=o("li"),ai=o("a"),bT=a("Parallelization"),vT=p(),kt=o("div"),T(ii.$$.fragment),kT=p(),Ls=o("p"),TT=a("The "),zc=o("code"),$T=a("FlaxDistilBertPreTrainedModel"),wT=a(" forward method, overrides the "),jc=o("code"),yT=a("__call__"),FT=a(" special method."),DT=p(),T(dn.$$.fragment),xT=p(),T(cn.$$.fragment),fh=p(),Ss=o("h2"),pn=o("a"),Cc=o("span"),T(li.$$.fragment),BT=p(),qc=o("span"),MT=a("FlaxDistilBertForQuestionAnswering"),gh=p(),qe=o("div"),T(di.$$.fragment),ET=p(),Is=o("p"),zT=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
and wordpiece.`),mn.forEach(t),om=h(St),Sn=n(St,"P",{});var yi=r(Sn);nm=i(yi,"Refer to superclass "),ji=n(yi,"A",{href:!0});var yp=r(ji);rm=i(yp,"BertTokenizer"),yp.forEach(t),am=i(yi," for usage examples and documentation concerning parameters."),yi.forEach(t),St.forEach(t),Cp=h(s),os=n(s,"H2",{class:!0});var Fi=r(os);Ks=n(Fi,"A",{id:!0,class:!0,href:!0});var Fp=r(Ks);Nl=n(Fp,"SPAN",{});var Dp=r(Nl);$(In.$$.fragment,Dp),Dp.forEach(t),Fp.forEach(t),im=h(Fi),Ll=n(Fi,"SPAN",{});var d$=r(Ll);lm=i(d$,"DistilBertTokenizerFast"),d$.forEach(t),Fi.forEach(t),qp=h(s),ct=n(s,"DIV",{class:!0});var fn=r(ct);$(Wn.$$.fragment,fn),dm=h(fn),Qn=n(fn,"P",{});var bh=r(Qn);cm=i(bh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Sl=n(bh,"EM",{});var c$=r(Sl);pm=i(c$,"tokenizers"),c$.forEach(t),hm=i(bh," library)."),bh.forEach(t),um=h(fn),Js=n(fn,"P",{});var xp=r(Js);Ci=n(xp,"A",{href:!0});var p$=r(Ci);mm=i(p$,"DistilBertTokenizerFast"),p$.forEach(t),fm=i(xp," is identical to "),qi=n(xp,"A",{href:!0});var h$=r(qi);gm=i(h$,"BertTokenizerFast"),h$.forEach(t),_m=i(xp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),xp.forEach(t),bm=h(fn),Rn=n(fn,"P",{});var vh=r(Rn);vm=i(vh,"Refer to superclass "),Pi=n(vh,"A",{href:!0});var u$=r(Pi);km=i(u$,"BertTokenizerFast"),u$.forEach(t),Tm=i(vh," for usage examples and documentation concerning parameters."),vh.forEach(t),fn.forEach(t),Pp=h(s),ns=n(s,"H2",{class:!0});var kh=r(ns);Gs=n(kh,"A",{id:!0,class:!0,href:!0});var m$=r(Gs);Il=n(m$,"SPAN",{});var f$=r(Il);$(Un.$$.fragment,f$),f$.forEach(t),m$.forEach(t),$m=h(kh),Wl=n(kh,"SPAN",{});var g$=r(Wl);wm=i(g$,"DistilBertModel"),g$.forEach(t),kh.forEach(t),Ap=h(s),We=n(s,"DIV",{class:!0});var It=r(We);$(Hn.$$.fragment,It),ym=h(It),Ql=n(It,"P",{});var _$=r(Ql);Fm=i(_$,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),_$.forEach(t),Dm=h(It),Vn=n(It,"P",{});var Th=r(Vn);xm=i(Th,"This model inherits from "),Ai=n(Th,"A",{href:!0});var b$=r(Ai);Bm=i(b$,"PreTrainedModel"),b$.forEach(t),Mm=i(Th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Th.forEach(t),Em=h(It),Kn=n(It,"P",{});var $h=r(Kn);zm=i($h,"This model is also a PyTorch "),Jn=n($h,"A",{href:!0,rel:!0});var v$=r(Jn);jm=i(v$,"torch.nn.Module"),v$.forEach(t),Cm=i($h,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),qm=h(It),ht=n(It,"DIV",{class:!0});var gn=r(ht);$(Gn.$$.fragment,gn),Pm=h(gn),rs=n(gn,"P",{});var hl=r(rs);Am=i(hl,"The "),Oi=n(hl,"A",{href:!0});var k$=r(Oi);Om=i(k$,"DistilBertModel"),k$.forEach(t),Nm=i(hl," forward method, overrides the "),Rl=n(hl,"CODE",{});var T$=r(Rl);Lm=i(T$,"__call__"),T$.forEach(t),Sm=i(hl," special method."),hl.forEach(t),Im=h(gn),$(Xs.$$.fragment,gn),Wm=h(gn),$(Ys.$$.fragment,gn),gn.forEach(t),It.forEach(t),Op=h(s),as=n(s,"H2",{class:!0});var wh=r(as);Zs=n(wh,"A",{id:!0,class:!0,href:!0});var $$=r(Zs);Ul=n($$,"SPAN",{});var w$=r(Ul);$(Xn.$$.fragment,w$),w$.forEach(t),$$.forEach(t),Qm=h(wh),Hl=n(wh,"SPAN",{});var y$=r(Hl);Rm=i(y$,"DistilBertForMaskedLM"),y$.forEach(t),wh.forEach(t),Np=h(s),Qe=n(s,"DIV",{class:!0});var Wt=r(Qe);$(Yn.$$.fragment,Wt),Um=h(Wt),Zn=n(Wt,"P",{});var yh=r(Zn);Hm=i(yh,"DistilBert Model with a "),Vl=n(yh,"CODE",{});var F$=r(Vl);Vm=i(F$,"masked language modeling"),F$.forEach(t),Km=i(yh," head on top."),yh.forEach(t),Jm=h(Wt),er=n(Wt,"P",{});var Fh=r(er);Gm=i(Fh,"This model inherits from "),Ni=n(Fh,"A",{href:!0});var D$=r(Ni);Xm=i(D$,"PreTrainedModel"),D$.forEach(t),Ym=i(Fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fh.forEach(t),Zm=h(Wt),tr=n(Wt,"P",{});var Dh=r(tr);ef=i(Dh,"This model is also a PyTorch "),sr=n(Dh,"A",{href:!0,rel:!0});var x$=r(sr);tf=i(x$,"torch.nn.Module"),x$.forEach(t),sf=i(Dh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dh.forEach(t),of=h(Wt),Ke=n(Wt,"DIV",{class:!0});var Qt=r(Ke);$(or.$$.fragment,Qt),nf=h(Qt),is=n(Qt,"P",{});var ul=r(is);rf=i(ul,"The "),Li=n(ul,"A",{href:!0});var B$=r(Li);af=i(B$,"DistilBertForMaskedLM"),B$.forEach(t),lf=i(ul," forward method, overrides the "),Kl=n(ul,"CODE",{});var M$=r(Kl);df=i(M$,"__call__"),M$.forEach(t),cf=i(ul," special method."),ul.forEach(t),pf=h(Qt),$(eo.$$.fragment,Qt),hf=h(Qt),$(to.$$.fragment,Qt),uf=h(Qt),$(so.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),Lp=h(s),ls=n(s,"H2",{class:!0});var xh=r(ls);oo=n(xh,"A",{id:!0,class:!0,href:!0});var E$=r(oo);Jl=n(E$,"SPAN",{});var z$=r(Jl);$(nr.$$.fragment,z$),z$.forEach(t),E$.forEach(t),mf=h(xh),Gl=n(xh,"SPAN",{});var j$=r(Gl);ff=i(j$,"DistilBertForSequenceClassification"),j$.forEach(t),xh.forEach(t),Sp=h(s),Re=n(s,"DIV",{class:!0});var Rt=r(Re);$(rr.$$.fragment,Rt),gf=h(Rt),Xl=n(Rt,"P",{});var C$=r(Xl);_f=i(C$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C$.forEach(t),bf=h(Rt),ar=n(Rt,"P",{});var Bh=r(ar);vf=i(Bh,"This model inherits from "),Si=n(Bh,"A",{href:!0});var q$=r(Si);kf=i(q$,"PreTrainedModel"),q$.forEach(t),Tf=i(Bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bh.forEach(t),$f=h(Rt),ir=n(Rt,"P",{});var Mh=r(ir);wf=i(Mh,"This model is also a PyTorch "),lr=n(Mh,"A",{href:!0,rel:!0});var P$=r(lr);yf=i(P$,"torch.nn.Module"),P$.forEach(t),Ff=i(Mh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mh.forEach(t),Df=h(Rt),Pe=n(Rt,"DIV",{class:!0});var tt=r(Pe);$(dr.$$.fragment,tt),xf=h(tt),ds=n(tt,"P",{});var ml=r(ds);Bf=i(ml,"The "),Ii=n(ml,"A",{href:!0});var A$=r(Ii);Mf=i(A$,"DistilBertForSequenceClassification"),A$.forEach(t),Ef=i(ml," forward method, overrides the "),Yl=n(ml,"CODE",{});var O$=r(Yl);zf=i(O$,"__call__"),O$.forEach(t),jf=i(ml," special method."),ml.forEach(t),Cf=h(tt),$(no.$$.fragment,tt),qf=h(tt),$(ro.$$.fragment,tt),Pf=h(tt),$(ao.$$.fragment,tt),Af=h(tt),$(io.$$.fragment,tt),Of=h(tt),$(lo.$$.fragment,tt),tt.forEach(t),Rt.forEach(t),Ip=h(s),cs=n(s,"H2",{class:!0});var Eh=r(cs);co=n(Eh,"A",{id:!0,class:!0,href:!0});var N$=r(co);Zl=n(N$,"SPAN",{});var L$=r(Zl);$(cr.$$.fragment,L$),L$.forEach(t),N$.forEach(t),Nf=h(Eh),ed=n(Eh,"SPAN",{});var S$=r(ed);Lf=i(S$,"DistilBertForMultipleChoice"),S$.forEach(t),Eh.forEach(t),Wp=h(s),Ue=n(s,"DIV",{class:!0});var Ut=r(Ue);$(pr.$$.fragment,Ut),Sf=h(Ut),td=n(Ut,"P",{});var I$=r(td);If=i(I$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),I$.forEach(t),Wf=h(Ut),hr=n(Ut,"P",{});var zh=r(hr);Qf=i(zh,"This model inherits from "),Wi=n(zh,"A",{href:!0});var W$=r(Wi);Rf=i(W$,"PreTrainedModel"),W$.forEach(t),Uf=i(zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zh.forEach(t),Hf=h(Ut),ur=n(Ut,"P",{});var jh=r(ur);Vf=i(jh,"This model is also a PyTorch "),mr=n(jh,"A",{href:!0,rel:!0});var Q$=r(mr);Kf=i(Q$,"torch.nn.Module"),Q$.forEach(t),Jf=i(jh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jh.forEach(t),Gf=h(Ut),ut=n(Ut,"DIV",{class:!0});var _n=r(ut);$(fr.$$.fragment,_n),Xf=h(_n),ps=n(_n,"P",{});var fl=r(ps);Yf=i(fl,"The "),Qi=n(fl,"A",{href:!0});var R$=r(Qi);Zf=i(R$,"DistilBertForMultipleChoice"),R$.forEach(t),eg=i(fl," forward method, overrides the "),sd=n(fl,"CODE",{});var U$=r(sd);tg=i(U$,"__call__"),U$.forEach(t),sg=i(fl," special method."),fl.forEach(t),og=h(_n),$(po.$$.fragment,_n),ng=h(_n),$(ho.$$.fragment,_n),_n.forEach(t),Ut.forEach(t),Qp=h(s),hs=n(s,"H2",{class:!0});var Ch=r(hs);uo=n(Ch,"A",{id:!0,class:!0,href:!0});var H$=r(uo);od=n(H$,"SPAN",{});var V$=r(od);$(gr.$$.fragment,V$),V$.forEach(t),H$.forEach(t),rg=h(Ch),nd=n(Ch,"SPAN",{});var K$=r(nd);ag=i(K$,"DistilBertForTokenClassification"),K$.forEach(t),Ch.forEach(t),Rp=h(s),He=n(s,"DIV",{class:!0});var Ht=r(He);$(_r.$$.fragment,Ht),ig=h(Ht),rd=n(Ht,"P",{});var J$=r(rd);lg=i(J$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qh.forEach(t),ug=h(Ht),vr=n(Ht,"P",{});var Ph=r(vr);mg=i(Ph,"This model is also a PyTorch "),kr=n(Ph,"A",{href:!0,rel:!0});var X$=r(kr);fg=i(X$,"torch.nn.Module"),X$.forEach(t),gg=i(Ph,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Vt=r(Je);$(Tr.$$.fragment,Vt),bg=h(Vt),us=n(Vt,"P",{});var gl=r(us);vg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var Y$=r(Ui);kg=i(Y$,"DistilBertForTokenClassification"),Y$.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var Z$=r(ad);$g=i(Z$,"__call__"),Z$.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Vt),$(mo.$$.fragment,Vt),Fg=h(Vt),$(fo.$$.fragment,Vt),Dg=h(Vt),$(go.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),Up=h(s),ms=n(s,"H2",{class:!0});var Ah=r(ms);_o=n(Ah,"A",{id:!0,class:!0,href:!0});var ew=r(_o);id=n(ew,"SPAN",{});var tw=r(id);$($r.$$.fragment,tw),tw.forEach(t),ew.forEach(t),xg=h(Ah),ld=n(Ah,"SPAN",{});var sw=r(ld);Bg=i(sw,"DistilBertForQuestionAnswering"),sw.forEach(t),Ah.forEach(t),Hp=h(s),Ve=n(s,"DIV",{class:!0});var Kt=r(Ve);$(wr.$$.fragment,Kt),Mg=h(Kt),fs=n(Kt,"P",{});var _l=r(fs);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kh.forEach(t),nb=h(yt),$(zo.$$.fragment,yt),rb=h(yt),Ye=n(yt,"DIV",{class:!0});var Xt=r(Ye);$(Hr.$$.fragment,Xt),ab=h(Xt),$s=n(Xt,"P",{});var Tl=r($s);ib=i(Tl,"The "),Zi=n(Tl,"A",{href:!0});var zw=r(Zi);lb=i(zw,"TFDistilBertForSequenceClassification"),zw.forEach(t),db=i(Tl," forward method, overrides the "),wd=n(Tl,"CODE",{});var jw=r(wd);cb=i(jw,"__call__"),jw.forEach(t),pb=i(Tl," special method."),Tl.forEach(t),hb=h(Xt),$(jo.$$.fragment,Xt),ub=h(Xt),$(Co.$$.fragment,Xt),mb=h(Xt),$(qo.$$.fragment,Xt),Xt.forEach(t),yt.forEach(t),Zp=h(s),ws=n(s,"H2",{class:!0});var Jh=r(ws);Po=n(Jh,"A",{id:!0,class:!0,href:!0});var Cw=r(Po);yd=n(Cw,"SPAN",{});var qw=r(yd);$(Vr.$$.fragment,qw),qw.forEach(t),Cw.forEach(t),fb=h(Jh),Fd=n(Jh,"SPAN",{});var Pw=r(Fd);gb=i(Pw,"TFDistilBertForMultipleChoice"),Pw.forEach(t),Jh.forEach(t),eh=h(s),Le=n(s,"DIV",{class:!0});var Ft=r(Le);$(Kr.$$.fragment,Ft),_b=h(Ft),Dd=n(Ft,"P",{});var Aw=r(Dd);bb=i(Aw,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Ub=h(Dt),sa=n(Dt,"P",{});var eu=r(sa);Hb=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var Hw=r(oa);Vb=i(Hw,"tf.keras.Model"),Hw.forEach(t),Kb=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Dt),$(So.$$.fragment,Dt),Gb=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Yb=i(wl,"The "),ol=n(wl,"A",{href:!0});var Vw=r(ol);Zb=i(Vw,"TFDistilBertForTokenClassification"),Vw.forEach(t),e1=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Kw=r(zd);t1=i(Kw,"__call__"),Kw.forEach(t),s1=i(wl," special method."),wl.forEach(t),o1=h(Yt),$(Io.$$.fragment,Yt),n1=h(Yt),$(Wo.$$.fragment,Yt),r1=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Ro);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),a1=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);i1=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),l1=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);d1=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);c1=i(Yw,"span start logits"),Yw.forEach(t),p1=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);h1=i(Zw,"span end logits"),Zw.forEach(t),u1=i(yl,")."),yl.forEach(t),m1=h(xt),ia=n(xt,"P",{});var su=r(ia);f1=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var ey=r(nl);g1=i(ey,"TFPreTrainedModel"),ey.forEach(t),_1=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$1=h(xt),$(Uo.$$.fragment,xt),w1=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),y1=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);F1=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var sy=r(rl);D1=i(sy,"TFDistilBertForQuestionAnswering"),sy.forEach(t),x1=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var oy=r(Ad);B1=i(oy,"__call__"),oy.forEach(t),M1=i(Fl," special method."),Fl.forEach(t),E1=h(Zt),$(Ho.$$.fragment,Zt),z1=h(Zt),$(Vo.$$.fragment,Zt),j1=h(Zt),$(Ko.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var ny=r(Jo);Od=n(ny,"SPAN",{});var ry=r(Od);$(pa.$$.fragment,ry),ry.forEach(t),ny.forEach(t),C1=h(nu),Nd=n(nu,"SPAN",{});var ay=r(Nd);q1=i(ay,"FlaxDistilBertModel"),ay.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),P1=h(st),Ld=n(st,"P",{});var iy=r(Ld);A1=i(iy,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iy.forEach(t),O1=h(st),ua=n(st,"P",{});var ru=r(ua);N1=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var ly=r(al);L1=i(ly,"FlaxPreTrainedModel"),ly.forEach(t),S1=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),I1=h(st),ma=n(st,"P",{});var au=r(ma);W1=i(au,"This model is also a Flax Linen "),fa=n(au,"A",{href:!0,rel:!0});var dy=r(fa);Q1=i(dy,"flax.linen.Module"),dy.forEach(t),R1=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),U1=h(st),Sd=n(st,"P",{});var cy=r(Sd);H1=i(cy,"Finally, this model supports inherent JAX features such as:"),cy.forEach(t),V1=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var py=r(Id);ga=n(py,"A",{href:!0,rel:!0});var hy=r(ga);K1=i(hy,"Just-In-Time (JIT) compilation"),hy.forEach(t),py.forEach(t),J1=h(kn),Wd=n(kn,"LI",{});var uy=r(Wd);_a=n(uy,"A",{href:!0,rel:!0});var my=r(_a);G1=i(my,"Automatic Differentiation"),my.forEach(t),uy.forEach(t),X1=h(kn),Qd=n(kn,"LI",{});var fy=r(Qd);ba=n(fy,"A",{href:!0,rel:!0});var gy=r(ba);Y1=i(gy,"Vectorization"),gy.forEach(t),fy.forEach(t),Z1=h(kn),Rd=n(kn,"LI",{});var _y=r(Rd);va=n(_y,"A",{href:!0,rel:!0});var by=r(va);ev=i(by,"Parallelization"),by.forEach(t),_y.forEach(t),kn.forEach(t),tv=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sv=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ov=i(Dl,"The "),Ud=n(Dl,"CODE",{});var vy=r(Ud);nv=i(vy,"FlaxDistilBertPreTrainedModel"),vy.forEach(t),rv=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var ky=r(Hd);av=i(ky,"__call__"),ky.forEach(t),iv=i(Dl," special method."),Dl.forEach(t),lv=h(Tn),$(Go.$$.fragment,Tn),dv=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var Ty=r(Yo);Vd=n(Ty,"SPAN",{});var $y=r(Vd);$(Ta.$$.fragment,$y),$y.forEach(t),Ty.forEach(t),cv=h(iu),Kd=n(iu,"SPAN",{});var wy=r(Kd);pv=i(wy,"FlaxDistilBertForMaskedLM"),wy.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hv=h(ot),wa=n(ot,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yy=r(Jd);mv=i(yy,"language modeling"),yy.forEach(t),fv=i(lu," head on top."),lu.forEach(t),gv=h(ot),ya=n(ot,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Fy=r(il);bv=i(Fy,"FlaxPreTrainedModel"),Fy.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var Ry=r(ac);sk=i(Ry,"Finally, this model supports inherent JAX features such as:"),Ry.forEach(t),ok=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uy=r(ic);Oa=n(Uy,"A",{href:!0,rel:!0});var Hy=r(Oa);nk=i(Hy,"Just-In-Time (JIT) compilation"),Hy.forEach(t),Uy.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var Vy=r(lc);Na=n(Vy,"A",{href:!0,rel:!0});var Ky=r(Na);ak=i(Ky,"Automatic Differentiation"),Ky.forEach(t),Vy.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var Jy=r(dc);La=n(Jy,"A",{href:!0,rel:!0});var Gy=r(La);lk=i(Gy,"Vectorization"),Gy.forEach(t),Jy.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var Xy=r(cc);Sa=n(Xy,"A",{href:!0,rel:!0});var Yy=r(Sa);ck=i(Yy,"Parallelization"),Yy.forEach(t),Xy.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hk=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uk=i(Bl,"The "),pc=n(Bl,"CODE",{});var Zy=r(pc);mk=i(Zy,"FlaxDistilBertPreTrainedModel"),Zy.forEach(t),fk=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var e2=r(hc);gk=i(e2,"__call__"),e2.forEach(t),_k=i(Bl," special method."),Bl.forEach(t),bk=h(Fn),$(sn.$$.fragment,Fn),vk=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var mu=r(As);nn=n(mu,"A",{id:!0,class:!0,href:!0});var t2=r(nn);uc=n(t2,"SPAN",{});var s2=r(uc);$(Wa.$$.fragment,s2),s2.forEach(t),t2.forEach(t),kk=h(mu),mc=n(mu,"SPAN",{});var o2=r(mc);Tk=i(o2,"FlaxDistilBertForMultipleChoice"),o2.forEach(t),mu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),fc=n(rt,"P",{});var n2=r(fc);wk=i(n2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),n2.forEach(t),yk=h(rt),Ra=n(rt,"P",{});var fu=r(Ra);Fk=i(fu,"This model inherits from "),dl=n(fu,"A",{href:!0});var r2=r(dl);Dk=i(r2,"FlaxPreTrainedModel"),r2.forEach(t),xk=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),fu.forEach(t),Bk=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);Mk=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var a2=r(Ha);Ek=i(a2,"flax.linen.Module"),a2.forEach(t),zk=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jk=h(rt),gc=n(rt,"P",{});var i2=r(gc);Ck=i(i2,"Finally, this model supports inherent JAX features such as:"),i2.forEach(t),qk=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var l2=r(_c);Va=n(l2,"A",{href:!0,rel:!0});var d2=r(Va);Pk=i(d2,"Just-In-Time (JIT) compilation"),d2.forEach(t),l2.forEach(t),Ak=h(Dn),bc=n(Dn,"LI",{});var c2=r(bc);Ka=n(c2,"A",{href:!0,rel:!0});var p2=r(Ka);Ok=i(p2,"Automatic Differentiation"),p2.forEach(t),c2.forEach(t),Nk=h(Dn),vc=n(Dn,"LI",{});var h2=r(vc);Ja=n(h2,"A",{href:!0,rel:!0});var u2=r(Ja);Lk=i(u2,"Vectorization"),u2.forEach(t),h2.forEach(t),Sk=h(Dn),kc=n(Dn,"LI",{});var m2=r(kc);Ga=n(m2,"A",{href:!0,rel:!0});var f2=r(Ga);Ik=i(f2,"Parallelization"),f2.forEach(t),m2.forEach(t),Dn.forEach(t),Wk=h(rt),vt=n(rt,"DIV",{class:!0});var xn=r(vt);$(Xa.$$.fragment,xn),Qk=h(xn),Os=n(xn,"P",{});var Ml=r(Os);Rk=i(Ml,"The "),Tc=n(Ml,"CODE",{});var g2=r(Tc);Uk=i(g2,"FlaxDistilBertPreTrainedModel"),g2.forEach(t),Hk=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _2=r($c);Vk=i(_2,"__call__"),_2.forEach(t),Kk=i(Ml," special method."),Ml.forEach(t),Jk=h(xn),$(rn.$$.fragment,xn),Gk=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var b2=r(ln);wc=n(b2,"SPAN",{});var v2=r(wc);$(Ya.$$.fragment,v2),v2.forEach(t),b2.forEach(t),Xk=h(_u),yc=n(_u,"SPAN",{});var k2=r(yc);Yk=i(k2,"FlaxDistilBertForTokenClassification"),k2.forEach(t),_u.forEach(t),mh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Zk=h(at),Fc=n(at,"P",{});var T2=r(Fc);eT=i(T2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
