...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_33/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_33/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_33/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_33/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_33/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_33/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_33/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_33/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_33/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_33/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_33/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_33/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_33/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_33/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_33/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),YM.forEach(t),Ze=l(o),re=a(o,"P",{});var kp=s(re);Te=i(kp,"This model was contributed by "),Me=a(kp,"A",{href:!0,rel:!0});var ew=s(Me);ut=i(ew,"valhalla"),ew.forEach(t),ie=i(kp,". The Authors\u2019 code can be found "),we=a(kp,"A",{href:!0,rel:!0});var tw=s(we);xe=i(tw,"here"),tw.forEach(t),kp.forEach(t),Ye=l(o),M=a(o,"H3",{class:!0});var mh=s(M);F=a(mh,"A",{id:!0,class:!0,href:!0});var ow=s(F);ze=a(ow,"SPAN",{});var nw=s(ze);m(He.$$.fragment,nw),nw.forEach(t),ow.forEach(t),Ut=l(mh),Z=a(mh,"SPAN",{});var aw=s(Z);Xt=i(aw,"Training of MBart"),aw.forEach(t),mh.forEach(t),bt=l(o),H=a(o,"P",{});var Et=s(H);de=i(Et,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
target text format is `),Ve=a(Et,"CODE",{});var iw=s(Ve);Kt=i(iw,"[tgt_lang_code] X [eos]"),iw.forEach(t),Su=i(Et,". "),ld=a(Et,"CODE",{});var dw=s(ld);Au=i(dw,"bos"),dw.forEach(t),Ou=i(Et," is never used."),Et.forEach(t),bp=l(o),yt=a(o,"P",{});var Si=s(yt);Iu=i(Si,"The regular "),Cn=a(Si,"A",{href:!0});var KM=s(Cn);cd=a(KM,"STRONG",{});var lw=s(cd);Nu=i(lw,"call"),lw.forEach(t),Du=i(KM,"()"),KM.forEach(t),Lu=i(Si,` will encode source text format, and it should be wrapped
inside the context manager `),ti=a(Si,"A",{href:!0});var cw=s(ti);Gu=i(cw,"as_target_tokenizer()"),cw.forEach(t),Wu=i(Si," to encode target text format."),Si.forEach(t),yp=l(o),oi=a(o,"UL",{});var pw=s(oi);pd=a(pw,"LI",{});var hw=s(pd);Ru=i(hw,"Supervised training"),hw.forEach(t),pw.forEach(t),vp=l(o),m(Sn.$$.fragment,o),Tp=l(o),ni=a(o,"UL",{});var uw=s(ni);An=a(uw,"LI",{});var fh=s(An);hd=a(fh,"P",{});var mw=s(hd);Uu=i(mw,"Generation"),mw.forEach(t),Xu=l(fh),Zt=a(fh,"P",{});var Ai=s(Zt);Hu=i(Ai,"While generating the target text set the "),ud=a(Ai,"CODE",{});var fw=s(ud);Vu=i(fw,"decoder_start_token_id"),fw.forEach(t),Qu=i(Ai,` to the target language id. The following
example shows how to translate English to Romanian using the `),md=a(Ai,"EM",{});var _w=s(md);Ju=i(_w,"facebook/mbart-large-en-ro"),_w.forEach(t),Ku=i(Ai," model."),Ai.forEach(t),fh.forEach(t),uw.forEach(t),Mp=l(o),m(On.$$.fragment,o),wp=l(o),Yt=a(o,"H2",{class:!0});var _h=s(Yt);So=a(_h,"A",{id:!0,class:!0,href:!0});var gw=s(So);fd=a(gw,"SPAN",{});var kw=s(fd);m(In.$$.fragment,kw),kw.forEach(t),gw.forEach(t),Zu=l(_h),_d=a(_h,"SPAN",{});var bw=s(_d);Yu=i(bw,"Overview of MBart-50"),bw.forEach(t),_h.forEach(t),xp=l(o),vt=a(o,"P",{});var Oi=s(vt);em=i(Oi,"MBart-50 was introduced in the "),Nn=a(Oi,"A",{href:!0,rel:!0});var yw=s(Nn);tm=i(yw,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),yw.forEach(t),om=i(Oi,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Oi.forEach(t),zp=l(o),ai=a(o,"P",{});var Tw=s(ai);sm=i(Tw,"According to the abstract"),Tw.forEach(t),qp=l(o),si=a(o,"P",{});var Mw=s(si);kd=a(Mw,"EM",{});var ww=s(kd);rm=i(ww,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),ww.forEach(t),Mw.forEach(t),Bp=l(o),eo=a(o,"H3",{class:!0});var gh=s(eo);Ao=a(gh,"A",{id:!0,class:!0,href:!0});var xw=s(Ao);bd=a(xw,"SPAN",{});var zw=s(bd);m(Dn.$$.fragment,zw),zw.forEach(t),xw.forEach(t),im=l(gh),yd=a(gh,"SPAN",{});var qw=s(yd);dm=i(qw,"Training of MBart-50"),qw.forEach(t),gh.forEach(t),$p=l(o),et=a(o,"P",{});var wn=s(et);lm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),vd=a(wn,"CODE",{});var Bw=s(vd);cm=i(Bw,"[lang_code] X [eos]"),Bw.forEach(t),pm=i(wn,", where "),Td=a(wn,"CODE",{});var $w=s(Td);hm=i($w,"lang_code"),$w.forEach(t),um=i(wn,` is source
language id for source text and target language id for target text, with `),Md=a(wn,"CODE",{});var Fw=s(Md);mm=i(Fw,"X"),Fw.forEach(t),fm=i(wn,` being the source or target text
respectively.`),wn.forEach(t),Fp=l(o),Oo=a(o,"P",{});var kh=s(Oo);_m=i(kh,"MBart-50 has its own tokenizer "),ri=a(kh,"A",{href:!0});var jw=s(ri);gm=i(jw,"MBart50Tokenizer"),jw.forEach(t),km=i(kh,"."),kh.forEach(t),jp=l(o),ii=a(o,"UL",{});var Ew=s(ii);wd=a(Ew,"LI",{});var Pw=s(wd);bm=i(Pw,"Supervised training"),Pw.forEach(t),Ew.forEach(t),Ep=l(o),m(Ln.$$.fragment,o),Pp=l(o),di=a(o,"UL",{});var Cw=s(di);Gn=a(Cw,"LI",{});var bh=s(Gn);xd=a(bh,"P",{});var Sw=s(xd);ym=i(Sw,"Generation"),Sw.forEach(t),vm=l(bh),qe=a(bh,"P",{});var nt=s(qe);Tm=i(nt,"To generate using the mBART-50 multilingual translation models, "),zd=a(nt,"CODE",{});var Aw=s(zd);Mm=i(Aw,"eos_token_id"),Aw.forEach(t),wm=i(nt,` is used as the
...
target language id as the first generated token, pass the `),Bd=a(nt,"EM",{});var Iw=s(Bd);qm=i(Iw,"forced_bos_token_id"),Iw.forEach(t),Bm=i(nt," parameter to the "),$d=a(nt,"EM",{});var Nw=s($d);$m=i(Nw,"generate"),Nw.forEach(t),Fm=i(nt,` method.
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Fd=a(nt,"EM",{});var Dw=s(Fd);jm=i(Dw,"facebook/mbart-50-large-many-to-many"),Dw.forEach(t),Em=i(nt," checkpoint."),nt.forEach(t),bh.forEach(t),Cw.forEach(t),Cp=l(o),m(Wn.$$.fragment,o),Sp=l(o),to=a(o,"H2",{class:!0});var yh=s(to);Io=a(yh,"A",{id:!0,class:!0,href:!0});var Lw=s(Io);jd=a(Lw,"SPAN",{});var Gw=s(jd);m(Rn.$$.fragment,Gw),Gw.forEach(t),Lw.forEach(t),Pm=l(yh),Ed=a(yh,"SPAN",{});var Ww=s(Ed);Cm=i(Ww,"MBartConfig"),Ww.forEach(t),yh.forEach(t),Ap=l(o),Be=a(o,"DIV",{class:!0});var Pt=s(Be);m(Un.$$.fragment,Pt),Sm=l(Pt),oo=a(Pt,"P",{});var Ii=s(oo);Am=i(Ii,"This is the configuration class to store the configuration of a "),li=a(Ii,"A",{href:!0});var Rw=s(li);Om=i(Rw,"MBartModel"),Rw.forEach(t),Im=i(Ii,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Ii,"A",{href:!0,rel:!0});var Uw=s(Xn);Nm=i(Uw,"facebook/mbart-large-cc25"),Uw.forEach(t),Dm=i(Ii," architecture."),Ii.forEach(t),Lm=l(Pt),no=a(Pt,"P",{});var Ni=s(no);Gm=i(Ni,"Configuration objects inherit from "),ci=a(Ni,"A",{href:!0});var Xw=s(ci);Wm=i(Xw,"PretrainedConfig"),Xw.forEach(t),Rm=i(Ni,` and can be used to control the model outputs. Read the
documentation from `),pi=a(Ni,"A",{href:!0});var Hw=s(pi);Um=i(Hw,"PretrainedConfig"),Hw.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Hm=l(Pt),Pd=a(Pt,"P",{});var Vw=s(Pd);Vm=i(Vw,"Example:"),Vw.forEach(t),Qm=l(Pt),m(Hn.$$.fragment,Pt),Pt.forEach(t),Op=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var Qw=s(No);Cd=a(Qw,"SPAN",{});var Jw=s(Cd);m(Vn.$$.fragment,Jw),Jw.forEach(t),Qw.forEach(t),Jm=l(vh),Sd=a(vh,"SPAN",{});var Kw=s(Sd);Km=i(Kw,"MBartTokenizer"),Kw.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Qn.$$.fragment,me),Zm=l(me),Ad=a(me,"P",{});var Zw=s(Ad);Ym=i(Zw,"Construct an MBART tokenizer."),Zw.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Yw=s(hi);of=i(Yw,"RobertaTokenizer"),Yw.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var e1=s(ui);af=i(e1,"XLNetTokenizer"),e1.forEach(t),sf=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var t1=s(Jn);rf=i(t1,"SentencePiece"),t1.forEach(t),df=i(xn,"."),xn.forEach(t),lf=l(me),Kn=a(me,"P",{});var Th=s(Kn);cf=i(Th,"The tokenization method is "),Od=a(Th,"CODE",{});var o1=s(Od);pf=i(o1,"<tokens> <eos> <language code>"),o1.forEach(t),hf=i(Th," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Th.forEach(t),uf=l(me),Id=a(me,"P",{});var n1=s(Id);mf=i(n1,"Examples:"),n1.forEach(t),ff=l(me),m(Zn.$$.fragment,me),_f=l(me),Do=a(me,"DIV",{class:!0});var Mh=s(Do);m(Yn.$$.fragment,Mh),gf=l(Mh),Nd=a(Mh,"P",{});var a1=s(Nd);kf=i(a1,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
methods.`),ei.forEach(t),Qf=l(V),da=a(V,"P",{});var $h=s(da);Jf=i($h,"The tokenization method is "),Qd=a($h,"CODE",{});var b1=s(Qd);Kf=i(b1,"<tokens> <eos> <language code>"),b1.forEach(t),Zf=i($h," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$h.forEach(t),Yf=l(V),Jd=a(V,"P",{});var y1=s(Jd);e_=i(y1,"Examples:"),y1.forEach(t),t_=l(V),m(la.$$.fragment,V),o_=l(V),Se=a(V,"DIV",{class:!0});var Ct=s(Se);m(ca.$$.fragment,Ct),n_=l(Ct),Kd=a(Ct,"P",{});var v1=s(Kd);a_=i(v1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),v1.forEach(t),s_=l(Ct),pa=a(Ct,"P",{});var Fh=s(pa);r_=i(Fh,"An MBART sequence has the following format, where "),Zd=a(Fh,"CODE",{});var T1=s(Zd);i_=i(T1,"X"),T1.forEach(t),d_=i(Fh," represents the sequence:"),Fh.forEach(t),l_=l(Ct),ha=a(Ct,"UL",{});var jh=s(ha);ua=a(jh,"LI",{});var Eh=s(ua);Yd=a(Eh,"CODE",{});var M1=s(Yd);c_=i(M1,"input_ids"),M1.forEach(t),p_=i(Eh," (for encoder) "),el=a(Eh,"CODE",{});var w1=s(el);h_=i(w1,"X [eos, src_lang_code]"),w1.forEach(t),Eh.forEach(t),u_=l(jh),ma=a(jh,"LI",{});var Ph=s(ma);tl=a(Ph,"CODE",{});var x1=s(tl);m_=i(x1,"decoder_input_ids"),x1.forEach(t),f_=i(Ph,": (for decoder) "),ol=a(Ph,"CODE",{});var z1=s(ol);__=i(z1,"X [eos, tgt_lang_code]"),z1.forEach(t),Ph.forEach(t),jh.forEach(t),g_=l(Ct),nl=a(Ct,"P",{});var q1=s(nl);k_=i(q1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),q1.forEach(t),Ct.forEach(t),b_=l(V),Go=a(V,"DIV",{class:!0});var Ch=s(Go);m(fa.$$.fragment,Ch),y_=l(Ch),al=a(Ch,"P",{});var B1=s(al);v_=i(B1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),B1.forEach(t),Ch.forEach(t),T_=l(V),Wo=a(V,"DIV",{class:!0});var Sh=s(Wo);m(_a.$$.fragment,Sh),M_=l(Sh),sl=a(Sh,"P",{});var $1=s(sl);w_=i($1,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$1.forEach(t),Sh.forEach(t),x_=l(V),Ro=a(V,"DIV",{class:!0});var Ah=s(Ro);m(ga.$$.fragment,Ah),z_=l(Ah),rl=a(Ah,"P",{});var F1=s(rl);q_=i(F1,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),F1.forEach(t),Ah.forEach(t),V.forEach(t),Lp=l(o),io=a(o,"H2",{class:!0});var Oh=s(io);Uo=a(Oh,"A",{id:!0,class:!0,href:!0});var j1=s(Uo);il=a(j1,"SPAN",{});var E1=s(il);m(ka.$$.fragment,E1),E1.forEach(t),j1.forEach(t),B_=l(Oh),dl=a(Oh,"SPAN",{});var P1=s(dl);$_=i(P1,"MBart50Tokenizer"),P1.forEach(t),Oh.forEach(t),Gp=l(o),S=a(o,"DIV",{class:!0});var Q=s(S);m(ba.$$.fragment,Q),F_=l(Q),ya=a(Q,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var C1=s(va);E_=i(C1,"SentencePiece"),C1.forEach(t),P_=i(Ih,"."),Ih.forEach(t),C_=l(Q),Ta=a(Q,"P",{});var Nh=s(Ta);S_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var S1=s(gi);A_=i(S1,"PreTrainedTokenizer"),S1.forEach(t),O_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(Q),ll=a(Q,"P",{});var A1=s(ll);N_=i(A1,"Examples:"),A1.forEach(t),D_=l(Q),m(Ma.$$.fragment,Q),L_=l(Q),ot=a(Q,"DIV",{class:!0});var qn=s(ot);m(wa.$$.fragment,qn),G_=l(qn),xa=a(qn,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=a(Dh,"CODE",{});var O1=s(cl);R_=i(O1,"X"),O1.forEach(t),U_=i(Dh," represents the sequence:"),Dh.forEach(t),X_=l(qn),za=a(qn,"UL",{});var Lh=s(za);qa=a(Lh,"LI",{});var Gh=s(qa);pl=a(Gh,"CODE",{});var I1=s(pl);H_=i(I1,"input_ids"),I1.forEach(t),V_=i(Gh," (for encoder) "),hl=a(Gh,"CODE",{});var N1=s(hl);Q_=i(N1,"[src_lang_code] X [eos]"),N1.forEach(t),Gh.forEach(t),J_=l(Lh),Ba=a(Lh,"LI",{});var Wh=s(Ba);ul=a(Wh,"CODE",{});var D1=s(ul);K_=i(D1,"labels"),D1.forEach(t),Z_=i(Wh,": (for decoder) "),ml=a(Wh,"CODE",{});var L1=s(ml);Y_=i(L1,"[tgt_lang_code] X [eos]"),L1.forEach(t),Wh.forEach(t),Lh.forEach(t),eg=l(qn),fl=a(qn,"P",{});var G1=s(fl);tg=i(G1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),G1.forEach(t),qn.forEach(t),og=l(Q),Xo=a(Q,"DIV",{class:!0});var Rh=s(Xo);m($a.$$.fragment,Rh),ng=l(Rh),_l=a(Rh,"P",{});var W1=s(_l);ag=i(W1,"Converts a sequence of tokens (strings for sub-words) in a single string."),W1.forEach(t),Rh.forEach(t),sg=l(Q),Ho=a(Q,"DIV",{class:!0});var Uh=s(Ho);m(Fa.$$.fragment,Uh),rg=l(Uh),ja=a(Uh,"P",{});var Xh=s(ja);ig=i(Xh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),gl=a(Xh,"CODE",{});var R1=s(gl);dg=i(R1,"prepare_for_model"),R1.forEach(t),lg=i(Xh," method."),Xh.forEach(t),Uh.forEach(t),cg=l(Q),Vo=a(Q,"DIV",{class:!0});var Hh=s(Vo);m(Ea.$$.fragment,Hh),pg=l(Hh),kl=a(Hh,"P",{});var U1=s(kl);hg=i(U1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),U1.forEach(t),Hh.forEach(t),ug=l(Q),Qo=a(Q,"DIV",{class:!0});var Vh=s(Qo);m(Pa.$$.fragment,Vh),mg=l(Vh),bl=a(Vh,"P",{});var X1=s(bl);fg=i(X1,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),X1.forEach(t),Vh.forEach(t),Q.forEach(t),Wp=l(o),lo=a(o,"H2",{class:!0});var Qh=s(lo);Jo=a(Qh,"A",{id:!0,class:!0,href:!0});var H1=s(Jo);yl=a(H1,"SPAN",{});var V1=s(yl);m(Ca.$$.fragment,V1),V1.forEach(t),H1.forEach(t),_g=l(Qh),vl=a(Qh,"SPAN",{});var Q1=s(vl);gg=i(Q1,"MBart50TokenizerFast"),Q1.forEach(t),Qh.forEach(t),Rp=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);m(Sa.$$.fragment,fe),kg=l(fe),co=a(fe,"P",{});var Li=s(co);bg=i(Li,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=a(Li,"EM",{});var J1=s(Tl);yg=i(J1,"tokenizers"),J1.forEach(t),vg=i(Li,` library). Based on
