...
<a href="/docs/transformers/pr_33/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new re({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_33/en/model_doc/distilbert#transformers.DistilBertConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),lr=new be({}),dr=new Q({props:{name:"class transformers.TFDistilBertModel",anchor:"transformers.TFDistilBertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/distilbert/modeling_tf_distilbert.py#L538",parametersDescription:[{anchor:"transformers.TFDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_33/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_33/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new ge({props:{$$slots:{default:[P2]},$$scope:{ctx:j}}}),ur=new Q({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/distilbert/modeling_tf_distilbert.py#L543",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_33/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_33/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),jr=new be({}),Cr=new Q({props:{name:"class transformers.TFDistilBertForMultipleChoice",anchor:"transformers.TFDistilBertForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/distilbert/modeling_tf_distilbert.py#L933",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_33/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_33/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new ge({props:{$$slots:{default:[L2]},$$scope:{ctx:j}}}),Or=new Q({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_33/src/transformers/models/distilbert/modeling_tf_distilbert.py#L959",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_33/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_33/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_33/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_33/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}]}}),jo=new ge({props:{$$slots:{default:[Q2]},$$scope:{ctx:j}}}),pa=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertModel
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Rw=l(),Oc=o("p"),Uw=a("Finally, this model supports inherent JAX features such as:"),Hw=l(),Nt=o("ul"),Nc=o("li"),Xa=o("a"),Qw=a("Just-In-Time (JIT) compilation"),Kw=l(),Ic=o("li"),Ya=o("a"),Vw=a("Automatic Differentiation"),Jw=l(),Lc=o("li"),Za=o("a"),Gw=a("Vectorization"),Xw=l(),Sc=o("li"),ei=o("a"),Yw=a("Parallelization"),Zw=l(),dt=o("div"),b(ti.$$.fragment),ey=l(),Hs=o("p"),ty=a("The "),Wc=o("code"),sy=a("FlaxDistilBertPreTrainedModel"),oy=a("forward method, overrides the "),Rc=o("code"),ny=a("__call__"),ry=a(" special method."),ay=l(),b(Lo.$$.fragment),iy=l(),Uc=o("p"),ly=a("Example:"),dy=l(),b(si.$$.fragment),dh=l(),Qs=o("h2"),So=o("a"),Hc=o("span"),b(oi.$$.fragment),cy=l(),Qc=o("span"),py=a("FlaxDistilBertForQuestionAnswering"),ch=l(),Ce=o("div"),b(ni.$$.fragment),hy=l(),Ks=o("p"),uy=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Kc=o("code"),fy=a("span start logits"),my=a(" and "),Vc=o("code"),gy=a("span end logits"),_y=a(")."),vy=l(),ri=o("p"),by=a("This model inherits from "),ol=o("a"),ky=a("FlaxPreTrainedModel"),Ty=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),wy=l(),ai=o("p"),yy=a("This model is also a Flax Linen "),ii=o("a"),$y=a("flax.linen.Module"),Dy=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Fy=l(),Jc=o("p"),By=a("Finally, this model supports inherent JAX features such as:"),My=l(),It=o("ul"),Gc=o("li"),li=o("a"),Ey=a("Just-In-Time (JIT) compilation"),xy=l(),Xc=o("li"),di=o("a"),zy=a("Automatic Differentiation"),jy=l(),Yc=o("li"),ci=o("a"),Cy=a("Vectorization"),Py=l(),Zc=o("li"),pi=o("a"),qy=a("Parallelization"),Ay=l(),ct=o("div"),b(hi.$$.fragment),Oy=l(),Vs=o("p"),Ny=a("The "),ep=o("code"),Iy=a("FlaxDistilBertPreTrainedModel"),Ly=a("forward method, overrides the "),tp=o("code"),Sy=a("__call__"),Wy=a(" special method."),Ry=l(),b(Wo.$$.fragment),Uy=l(),sp=o("p"),Hy=a("Example:"),Qy=l(),b(ui.$$.fragment),this.h()},l(s){const m=F2('[data-svelte="svelte-1phssyn"]',document.head);p=n(m,"META",{name:!0,content:!0}),m.forEach(t),F=d(s),g=n(s,"H1",{class:!0});var fi=r(g);v=n(fi,"A",{id:!0,class:!0,href:!0});var op=r(v);D=n(op,"SPAN",{});var np=r(D);k(_.$$.fragment,np),np.forEach(t),op.forEach(t),f=d(fi),B=n(fi,"SPAN",{});var rp=r(B);ce=i(rp,"DistilBERT"),rp.forEach(t),fi.forEach(t),K=d(s),E=n(s,"H2",{class:!0});var mi=r(E);G=n(mi,"A",{id:!0,class:!0,href:!0});var ap=r(G);L=n(ap,"SPAN",{});var ip=r(L);k(X.$$.fragment,ip),ip.forEach(t),ap.forEach(t),pe=d(mi),S=n(mi,"SPAN",{});var lp=r(S);he=i(lp,"Overview"),lp.forEach(t),mi.forEach(t),ae=d(s),N=n(s,"P",{});var Lt=r(N);q=i(Lt,"The DistilBERT model was proposed in the blog post "),Y=n(Lt,"A",{href:!0,rel:!0});var dp=r(Y);V=i(dp,`Smaller, faster, cheaper, lighter: Introducing DistilBERT, a
...
necessary though, just let us know if you need this option.`),_i.forEach(t),gi.forEach(t),wp=d(s),bt=n(s,"P",{});var Wt=r(bt);wu=i(Wt,"This model was contributed by "),Yo=n(Wt,"A",{href:!0,rel:!0});var Ky=r(Yo);yu=i(Ky,"victorsanh"),Ky.forEach(t),$u=i(Wt,`. This model jax version was
contributed by `),Zo=n(Wt,"A",{href:!0,rel:!0});var Vy=r(Zo);Du=i(Vy,"kamalkraj"),Vy.forEach(t),Fu=i(Wt,". The original code can be found "),en=n(Wt,"A",{href:!0,rel:!0});var Jy=r(en);Bu=i(Jy,"here"),Jy.forEach(t),Mu=i(Wt,"."),Wt.forEach(t),yp=d(s),as=n(s,"H2",{class:!0});var hh=r(as);Js=n(hh,"A",{id:!0,class:!0,href:!0});var Gy=r(Js);Fl=n(Gy,"SPAN",{});var Xy=r(Fl);k(tn.$$.fragment,Xy),Xy.forEach(t),Gy.forEach(t),Eu=d(hh),Bl=n(hh,"SPAN",{});var Yy=r(Bl);xu=i(Yy,"DistilBertConfig"),Yy.forEach(t),hh.forEach(t),$p=d(s),Ve=n(s,"DIV",{class:!0});var Rt=r(Ve);k(sn.$$.fragment,Rt),zu=d(Rt),Ct=n(Rt,"P",{});var Ro=r(Ct);ju=i(Ro,"This is the configuration class to store the configuration of a "),vi=n(Ro,"A",{href:!0});var Zy=r(vi);Cu=i(Zy,"DistilBertModel"),Zy.forEach(t),Pu=i(Ro," or a "),bi=n(Ro,"A",{href:!0});var e1=r(bi);qu=i(e1,"TFDistilBertModel"),e1.forEach(t),Au=i(Ro,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
`),on=n(Ro,"A",{href:!0,rel:!0});var t1=r(on);Ou=i(t1,"distilbert-base-uncased"),t1.forEach(t),Nu=i(Ro," architecture."),Ro.forEach(t),Iu=d(Rt),is=n(Rt,"P",{});var nl=r(is);Lu=i(nl,"Configuration objects inherit from "),ki=n(nl,"A",{href:!0});var s1=r(ki);Su=i(s1,"PretrainedConfig"),s1.forEach(t),Wu=i(nl,` and can be used to control the model outputs. Read the
documentation from `),Ti=n(nl,"A",{href:!0});var o1=r(Ti);Ru=i(o1,"PretrainedConfig"),o1.forEach(t),Uu=i(nl," for more information."),nl.forEach(t),Hu=d(Rt),Ml=n(Rt,"P",{});var n1=r(Ml);Qu=i(n1,"Examples:"),n1.forEach(t),Ku=d(Rt),k(nn.$$.fragment,Rt),Rt.forEach(t),Dp=d(s),ls=n(s,"H2",{class:!0});var uh=r(ls);Gs=n(uh,"A",{id:!0,class:!0,href:!0});var r1=r(Gs);El=n(r1,"SPAN",{});var a1=r(El);k(rn.$$.fragment,a1),a1.forEach(t),r1.forEach(t),Vu=d(uh),xl=n(uh,"SPAN",{});var i1=r(xl);Ju=i(i1,"DistilBertTokenizer"),i1.forEach(t),uh.forEach(t),Fp=d(s),_t=n(s,"DIV",{class:!0});var Uo=r(_t);k(an.$$.fragment,Uo),Gu=d(Uo),zl=n(Uo,"P",{});var l1=r(zl);Xu=i(l1,"Construct a DistilBERT tokenizer."),l1.forEach(t),Yu=d(Uo),Xs=n(Uo,"P",{});var kp=r(Xs);wi=n(kp,"A",{href:!0});var d1=r(wi);Zu=i(d1,"DistilBertTokenizer"),d1.forEach(t),ef=i(kp," is identical to "),yi=n(kp,"A",{href:!0});var c1=r(yi);tf=i(c1,"BertTokenizer"),c1.forEach(t),sf=i(kp,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),kp.forEach(t),of=d(Uo),ln=n(Uo,"P",{});var fh=r(ln);nf=i(fh,"Refer to superclass "),$i=n(fh,"A",{href:!0});var p1=r($i);rf=i(p1,"BertTokenizer"),p1.forEach(t),af=i(fh," for usage examples and documentation concerning parameters."),fh.forEach(t),Uo.forEach(t),Bp=d(s),ds=n(s,"H2",{class:!0});var mh=r(ds);Ys=n(mh,"A",{id:!0,class:!0,href:!0});var h1=r(Ys);jl=n(h1,"SPAN",{});var u1=r(jl);k(dn.$$.fragment,u1),u1.forEach(t),h1.forEach(t),lf=d(mh),Cl=n(mh,"SPAN",{});var f1=r(Cl);df=i(f1,"DistilBertTokenizerFast"),f1.forEach(t),mh.forEach(t),Mp=d(s),vt=n(s,"DIV",{class:!0});var Ho=r(vt);k(cn.$$.fragment,Ho),cf=d(Ho),pn=n(Ho,"P",{});var gh=r(pn);pf=i(gh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Pl=n(gh,"EM",{});var m1=r(Pl);hf=i(m1,"tokenizers"),m1.forEach(t),uf=i(gh," library)."),gh.forEach(t),ff=d(Ho),Zs=n(Ho,"P",{});var Tp=r(Zs);Di=n(Tp,"A",{href:!0});var g1=r(Di);mf=i(g1,"DistilBertTokenizerFast"),g1.forEach(t),gf=i(Tp," is identical to "),Fi=n(Tp,"A",{href:!0});var _1=r(Fi);_f=i(_1,"BertTokenizerFast"),_1.forEach(t),vf=i(Tp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Tp.forEach(t),bf=d(Ho),hn=n(Ho,"P",{});var _h=r(hn);kf=i(_h,"Refer to superclass "),Bi=n(_h,"A",{href:!0});var v1=r(Bi);Tf=i(v1,"BertTokenizerFast"),v1.forEach(t),wf=i(_h," for usage examples and documentation concerning parameters."),_h.forEach(t),Ho.forEach(t),Ep=d(s),cs=n(s,"H2",{class:!0});var vh=r(cs);eo=n(vh,"A",{id:!0,class:!0,href:!0});var b1=r(eo);ql=n(b1,"SPAN",{});var k1=r(ql);k(un.$$.fragment,k1),k1.forEach(t),b1.forEach(t),yf=d(vh),Al=n(vh,"SPAN",{});var T1=r(Al);$f=i(T1,"DistilBertModel"),T1.forEach(t),vh.forEach(t),xp=d(s),Je=n(s,"DIV",{class:!0});var Ut=r(Je);k(fn.$$.fragment,Ut),Df=d(Ut),Ol=n(Ut,"P",{});var w1=r(Ol);Ff=i(w1,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),w1.forEach(t),Bf=d(Ut),mn=n(Ut,"P",{});var bh=r(mn);Mf=i(bh,"This model inherits from "),Mi=n(bh,"A",{href:!0});var y1=r(Mi);Ef=i(y1,"PreTrainedModel"),y1.forEach(t),xf=i(bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bh.forEach(t),zf=d(Ut),gn=n(Ut,"P",{});var kh=r(gn);jf=i(kh,"This model is also a PyTorch "),_n=n(kh,"A",{href:!0,rel:!0});var $1=r(_n);Cf=i($1,"torch.nn.Module"),$1.forEach(t),Pf=i(kh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kh.forEach(t),qf=d(Ut),tt=n(Ut,"DIV",{class:!0});var Ht=r(tt);k(vn.$$.fragment,Ht),Af=d(Ht),ps=n(Ht,"P",{});var rl=r(ps);Of=i(rl,"The "),Ei=n(rl,"A",{href:!0});var D1=r(Ei);Nf=i(D1,"DistilBertModel"),D1.forEach(t),If=i(rl," forward method, overrides the "),Nl=n(rl,"CODE",{});var F1=r(Nl);Lf=i(F1,"__call__"),F1.forEach(t),Sf=i(rl," special method."),rl.forEach(t),Wf=d(Ht),k(to.$$.fragment,Ht),Rf=d(Ht),Il=n(Ht,"P",{});var B1=r(Il);Uf=i(B1,"Example:"),B1.forEach(t),Hf=d(Ht),k(bn.$$.fragment,Ht),Ht.forEach(t),Ut.forEach(t),zp=d(s),hs=n(s,"H2",{class:!0});var Th=r(hs);so=n(Th,"A",{id:!0,class:!0,href:!0});var M1=r(so);Ll=n(M1,"SPAN",{});var E1=r(Ll);k(kn.$$.fragment,E1),E1.forEach(t),M1.forEach(t),Qf=d(Th),Sl=n(Th,"SPAN",{});var x1=r(Sl);Kf=i(x1,"DistilBertForMaskedLM"),x1.forEach(t),Th.forEach(t),jp=d(s),Ge=n(s,"DIV",{class:!0});var Qt=r(Ge);k(Tn.$$.fragment,Qt),Vf=d(Qt),wn=n(Qt,"P",{});var wh=r(wn);Jf=i(wh,"DistilBert Model with a "),Wl=n(wh,"CODE",{});var z1=r(Wl);Gf=i(z1,"masked language modeling"),z1.forEach(t),Xf=i(wh," head on top."),wh.forEach(t),Yf=d(Qt),yn=n(Qt,"P",{});var yh=r(yn);Zf=i(yh,"This model inherits from "),xi=n(yh,"A",{href:!0});var j1=r(xi);em=i(j1,"PreTrainedModel"),j1.forEach(t),tm=i(yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yh.forEach(t),sm=d(Qt),$n=n(Qt,"P",{});var $h=r($n);om=i($h,"This model is also a PyTorch "),Dn=n($h,"A",{href:!0,rel:!0});var C1=r(Dn);nm=i(C1,"torch.nn.Module"),C1.forEach(t),rm=i($h,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),am=d(Qt),Se=n(Qt,"DIV",{class:!0});var kt=r(Se);k(Fn.$$.fragment,kt),im=d(kt),us=n(kt,"P",{});var al=r(us);lm=i(al,"The "),zi=n(al,"A",{href:!0});var P1=r(zi);dm=i(P1,"DistilBertForMaskedLM"),P1.forEach(t),cm=i(al," forward method, overrides the "),Rl=n(al,"CODE",{});var q1=r(Rl);pm=i(q1,"__call__"),q1.forEach(t),hm=i(al," special method."),al.forEach(t),um=d(kt),k(oo.$$.fragment,kt),fm=d(kt),Ul=n(kt,"P",{});var A1=r(Ul);mm=i(A1,"Example:"),A1.forEach(t),gm=d(kt),k(Bn.$$.fragment,kt),_m=d(kt),k(Mn.$$.fragment,kt),kt.forEach(t),Qt.forEach(t),Cp=d(s),fs=n(s,"H2",{class:!0});var Dh=r(fs);no=n(Dh,"A",{id:!0,class:!0,href:!0});var O1=r(no);Hl=n(O1,"SPAN",{});var N1=r(Hl);k(En.$$.fragment,N1),N1.forEach(t),O1.forEach(t),vm=d(Dh),Ql=n(Dh,"SPAN",{});var I1=r(Ql);bm=i(I1,"DistilBertForSequenceClassification"),I1.forEach(t),Dh.forEach(t),Pp=d(s),Xe=n(s,"DIV",{class:!0});var Kt=r(Xe);k(xn.$$.fragment,Kt),km=d(Kt),Kl=n(Kt,"P",{});var L1=r(Kl);Tm=i(L1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),L1.forEach(t),wm=d(Kt),zn=n(Kt,"P",{});var Fh=r(zn);ym=i(Fh,"This model inherits from "),ji=n(Fh,"A",{href:!0});var S1=r(ji);$m=i(S1,"PreTrainedModel"),S1.forEach(t),Dm=i(Fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fh.forEach(t),Fm=d(Kt),jn=n(Kt,"P",{});var Bh=r(jn);Bm=i(Bh,"This model is also a PyTorch "),Cn=n(Bh,"A",{href:!0,rel:!0});var W1=r(Cn);Mm=i(W1,"torch.nn.Module"),W1.forEach(t),Em=i(Bh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh.forEach(t),xm=d(Kt),ke=n(Kt,"DIV",{class:!0});var Pe=r(ke);k(Pn.$$.fragment,Pe),zm=d(Pe),ms=n(Pe,"P",{});var il=r(ms);jm=i(il,"The "),Ci=n(il,"A",{href:!0});var R1=r(Ci);Cm=i(R1,"DistilBertForSequenceClassification"),R1.forEach(t),Pm=i(il," forward method, overrides the "),Vl=n(il,"CODE",{});var U1=r(Vl);qm=i(U1,"__call__"),U1.forEach(t),Am=i(il," special method."),il.forEach(t),Om=d(Pe),k(ro.$$.fragment,Pe),Nm=d(Pe),Jl=n(Pe,"P",{});var H1=r(Jl);Im=i(H1,"Example of single-label classification:"),H1.forEach(t),Lm=d(Pe),k(qn.$$.fragment,Pe),Sm=d(Pe),k(An.$$.fragment,Pe),Wm=d(Pe),Gl=n(Pe,"P",{});var Q1=r(Gl);Rm=i(Q1,"Example of multi-label classification:"),Q1.forEach(t),Um=d(Pe),k(On.$$.fragment,Pe),Hm=d(Pe),k(Nn.$$.fragment,Pe),Pe.forEach(t),Kt.forEach(t),qp=d(s),gs=n(s,"H2",{class:!0});var Mh=r(gs);ao=n(Mh,"A",{id:!0,class:!0,href:!0});var K1=r(ao);Xl=n(K1,"SPAN",{});var V1=r(Xl);k(In.$$.fragment,V1),V1.forEach(t),K1.forEach(t),Qm=d(Mh),Yl=n(Mh,"SPAN",{});var J1=r(Yl);Km=i(J1,"DistilBertForMultipleChoice"),J1.forEach(t),Mh.forEach(t),Ap=d(s),Ye=n(s,"DIV",{class:!0});var Vt=r(Ye);k(Ln.$$.fragment,Vt),Vm=d(Vt),Zl=n(Vt,"P",{});var G1=r(Zl);Jm=i(G1,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),G1.forEach(t),Gm=d(Vt),Sn=n(Vt,"P",{});var Eh=r(Sn);Xm=i(Eh,"This model inherits from "),Pi=n(Eh,"A",{href:!0});var X1=r(Pi);Ym=i(X1,"PreTrainedModel"),X1.forEach(t),Zm=i(Eh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eh.forEach(t),eg=d(Vt),Wn=n(Vt,"P",{});var xh=r(Wn);tg=i(xh,"This model is also a PyTorch "),Rn=n(xh,"A",{href:!0,rel:!0});var Y1=r(Rn);sg=i(Y1,"torch.nn.Module"),Y1.forEach(t),og=i(xh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Vt),st=n(Vt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),qi=n(ll,"A",{href:!0});var Z1=r(qi);ig=i(Z1,"DistilBertForMultipleChoice"),Z1.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var e$=r(ed);dg=i(e$,"__call__"),e$.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var t$=r(td);ug=i(t$,"Examples:"),t$.forEach(t),fg=d(Jt),k(Hn.$$.fragment,Jt),Jt.forEach(t),Vt.forEach(t),Op=d(s),vs=n(s,"H2",{class:!0});var zh=r(vs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var s$=r(lo);sd=n(s$,"SPAN",{});var o$=r(sd);k(Qn.$$.fragment,o$),o$.forEach(t),s$.forEach(t),mg=d(zh),od=n(zh,"SPAN",{});var n$=r(od);gg=i(n$,"DistilBertForTokenClassification"),n$.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Kn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var r$=r(nd);vg=i(r$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
