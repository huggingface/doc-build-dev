import{S as Fi,i as zi,s as Pi,e as s,k as m,w as T,t,M as Ci,c as d,d as o,m as h,a as i,x as w,h as n,b as c,F as e,g as b,y,q as E,o as k,B as x,v as Ai,L as wo}from"../../chunks/vendor-6b77c823.js";import{T as gd}from"../../chunks/Tip-39098574.js";import{D as R}from"../../chunks/Docstring-1088f2fb.js";import{C as yo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Jt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as To}from"../../chunks/ExampleCodeBlock-5212b321.js";function Si(q){let l,v,u,p,g;return p=new yo({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),{c(){l=s("p"),v=t("Example:"),u=m(),T(p.$$.fragment)},l(a){l=d(a,"P",{});var f=i(l);v=n(f,"Example:"),f.forEach(o),u=h(a),w(p.$$.fragment,a)},m(a,f){b(a,l,f),e(l,v),b(a,u,f),y(p,a,f),g=!0},p:wo,i(a){g||(E(p.$$.fragment,a),g=!0)},o(a){k(p.$$.fragment,a),g=!1},d(a){a&&o(l),a&&o(u),x(p,a)}}}function Wi(q){let l,v,u,p,g;return{c(){l=s("p"),v=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=t("Module"),g=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){l=d(a,"P",{});var f=i(l);v=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=d(f,"CODE",{});var A=i(u);p=n(A,"Module"),A.forEach(o),g=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){b(a,l,f),e(l,v),e(l,u),e(u,p),e(l,g)},d(a){a&&o(l)}}}function Gi(q){let l,v,u,p,g;return p=new yo({props:{code:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){l=s("p"),v=t("Example:"),u=m(),T(p.$$.fragment)},l(a){l=d(a,"P",{});var f=i(l);v=n(f,"Example:"),f.forEach(o),u=h(a),w(p.$$.fragment,a)},m(a,f){b(a,l,f),e(l,v),b(a,u,f),y(p,a,f),g=!0},p:wo,i(a){g||(E(p.$$.fragment,a),g=!0)},o(a){k(p.$$.fragment,a),g=!1},d(a){a&&o(l),a&&o(u),x(p,a)}}}function Hi(q){let l,v,u,p,g,a,f,A,Dn,Kt,$,qn,Eo,Fn,zn,ft,Pn,Cn,ko,An,Sn,xo,In,Ln,$o,Nn,On,Mo,Rn,Bn,ut,Wn,Gn,jo,Un,Hn,Vo,Zn,Yn,Do,Jn,Kn,qo,Qn,Xn,Qt,ie,er,De,or,tr,Xt,B,nr,Fo,rr,ar,zo,sr,dr,en,Y,ce,gt,qe,ir,_t,cr,on,C,Fe,lr,le,Po,pr,mr,Co,hr,fr,ur,J,gr,Ao,_r,vr,So,br,Tr,wr,pe,yr,me,ze,Er,Pe,kr,Io,xr,$r,Mr,he,Ce,jr,K,Vr,vt,Dr,qr,bt,Fr,zr,tn,Q,fe,Tt,Ae,Pr,wt,Cr,nn,j,Se,Ar,X,Sr,Lo,Ir,Lr,No,Nr,Or,Rr,Ie,Br,Le,Wr,Gr,Ur,Ne,Hr,Oe,Zr,Yr,Jr,yt,Kr,Qr,Re,Xr,Oo,ea,oa,ta,Be,na,We,ra,aa,sa,W,Ro,da,ia,Et,ca,la,kt,pa,ma,ha,S,Ge,fa,ee,ua,Bo,ga,_a,xt,va,ba,Ta,ue,wa,ge,ya,I,Ue,Ea,$t,ka,xa,oe,$a,Mt,Ma,ja,jt,Va,Da,qa,_e,rn,te,ve,Vt,He,Fa,Dt,za,an,V,Ze,Pa,ne,Ca,Wo,Aa,Sa,Go,Ia,La,Na,Ye,Oa,Je,Ra,Ba,Wa,Ke,Ga,Qe,Ua,Ha,Za,qt,Ya,Ja,Xe,Ka,Uo,Qa,Xa,es,eo,os,oo,ts,ns,rs,G,Ho,as,ss,Zo,ds,is,Yo,cs,ls,ps,L,to,ms,re,hs,Jo,fs,us,Ft,gs,_s,vs,be,bs,Te,Ts,U,no,ws,zt,ys,Es,we,sn,ae,ye,Pt,ro,ks,Ct,xs,dn,D,ao,$s,se,Ms,Ko,js,Vs,Qo,Ds,qs,Fs,so,zs,io,Ps,Cs,As,co,Ss,lo,Is,Ls,Ns,At,Os,Rs,po,Bs,Xo,Ws,Gs,Us,mo,Hs,ho,Zs,Ys,Js,H,et,Ks,Qs,St,Xs,ed,It,od,td,nd,N,fo,rd,de,ad,ot,sd,dd,Lt,id,cd,ld,Ee,pd,ke,md,Z,uo,hd,Nt,fd,ud,xe,cn;return a=new Jt({}),qe=new Jt({}),Fe=new R({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16948/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16948/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27"}}),pe=new To({props:{anchor:"transformers.VisionEncoderDecoderConfig.example",$$slots:{default:[Si]},$$scope:{ctx:q}}}),ze=new R({props:{name:"from_encoder_decoder_configs",anchor:"transformers.VisionEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L93",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_16948/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"
>VisionEncoderDecoderConfig</a></p>
`}}),Ce=new R({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L110",returnDescription:`
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L400",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/pr_16948/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_16948/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16948/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16948/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<li>Without a prefix which will be input as <code>**encoder_kwargs</code> for the encoder forward function.</li>
<li>With a <em>decoder_</em> prefix which will be input as <code>**decoder_kwargs</code> for the decoder forward function.</li>
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L513",returnDescription:`
<p>A <a
...
example is <code>google/vit-base-patch16-224-in21k</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16948/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L599",returnDescription:`
<p>A <a
...
and any pretrained language model as the decoder (`),ut=s("em"),Wn=t("e.g."),Gn=m(),jo=s("a"),Un=t("RoBERTa"),Hn=t(", "),Vo=s("a"),Zn=t("GPT2"),Yn=t(", "),Do=s("a"),Jn=t("BERT"),Kn=t(", "),qo=s("a"),Qn=t("DistilBERT"),Xn=t(")."),Qt=m(),ie=s("p"),er=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
tasks was shown in `),Le=s("a"),Wr=t(`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Gr=t(` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
...
etc.)`),ta=m(),Be=s("p"),na=t("This model is also a PyTorch "),We=s("a"),ra=t("torch.nn.Module"),aa=t(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa=m(),W=s("p"),Ro=s("a"),da=t("VisionEncoderDecoderModel"),ia=t(` is a generic model class that will be instantiated as a transformer architecture with
...
:meth`),kt=s("em"),pa=t("~transformers.AutoModelForCausalLM.from_pretrained"),ma=t(" class method for the decoder."),ha=m(),S=s("div"),T(Ge.$$.fragment),fa=m(),ee=s("p"),ua=t("The "),Bo=s("a"),ga=t("VisionEncoderDecoderModel"),_a=t(" forward method, overrides the "),xt=s("code"),va=t("__call__"),ba=t(" special method."),Ta=m(),T(ue.$$.fragment),wa=m(),T(ge.$$.fragment),ya=m(),I=s("div"),T(Ue.$$.fragment),Ea=m(),$t=s("p"),ka=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Wo=s("a"),Aa=t("from_pretrained()"),Sa=t(" function and the decoder is loaded via "),Go=s("a"),Ia=t("from_pretrained()"),La=t(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),Wa=m(),Ke=s("p"),Ga=t("Additionally, in "),Qe=s("a"),Ua=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
behavior.`),rs=m(),G=s("p"),Ho=s("a"),as=t("TFVisionEncoderDecoderModel"),ss=t(` is a generic model class that will be instantiated as a transformer architecture
...
other models (see the examples for more information).`),Rs=m(),po=s("p"),Bs=t("This model inherits from "),Xo=s("a"),Ws=t("FlaxPreTrainedModel"),Gs=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
checkpoints.`),ud=m(),T(xe.$$.fragment),this.h()},l(r){const _=Ci('[data-svelte="svelte-1phssyn"]',document.head);l=d(_,"META",{name:!0,content:!0}),_.forEach(o),v=h(r),u=d(r,"H1",{class:!0});var go=i(u);p=d(go,"A",{id:!0,class:!0,href:!0});var Ot=i(p);g=d(Ot,"SPAN",{});var Rt=i(g);w(a.$$.fragment,Rt),Rt.forEach(o),Ot.forEach(o),f=h(go),A=d(go,"SPAN",{});var Bt=i(A);Dn=n(Bt,"Vision Encoder Decoder Models"),Bt.forEach(o),go.forEach(o),Kt=h(r),$=d(r,"P",{});var M=i($);qn=n(M,"The "),Eo=d(M,"A",{href:!0});var Wt=i(Eo);Fn=n(Wt,"VisionEncoderDecoderModel"),Wt.forEach(o),zn=n(M,` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),ft=d(M,"EM",{});var Gt=i(ft);Pn=n(Gt,"e.g."),Gt.forEach(o),Cn=h(M),ko=d(M,"A",{href:!0});var Ut=i(ko);An=n(Ut,"ViT"),Ut.forEach(o),Sn=n(M,", "),xo=d(M,"A",{href:!0});var Ht=i(xo);In=n(Ht,"BEiT"),Ht.forEach(o),Ln=n(M,", "),$o=d(M,"A",{href:!0});var Zt=i($o);Nn=n(Zt,"DeiT"),Zt.forEach(o),On=n(M,", "),Mo=d(M,"A",{href:!0});var _d=i(Mo);Rn=n(_d,"Swin"),_d.forEach(o),Bn=n(M,`)
and any pretrained language model as the decoder (`),ut=d(M,"EM",{});var vd=i(ut);Wn=n(vd,"e.g."),vd.forEach(o),Gn=h(M),jo=d(M,"A",{href:!0});var bd=i(jo);Un=n(bd,"RoBERTa"),bd.forEach(o),Hn=n(M,", "),Vo=d(M,"A",{href:!0});var Td=i(Vo);Zn=n(Td,"GPT2"),Td.forEach(o),Yn=n(M,", "),Do=d(M,"A",{href:!0});var wd=i(Do);Jn=n(wd,"BERT"),wd.forEach(o),Kn=n(M,", "),qo=d(M,"A",{href:!0});var yd=i(qo);Qn=n(yd,"DistilBERT"),yd.forEach(o),Xn=n(M,")."),M.forEach(o),Qt=h(r),ie=d(r,"P",{});var ln=i(ie);er=n(ln,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
tasks was shown in `),Le=d(gn,"A",{href:!0,rel:!0});var Od=i(Le);Wr=n(Od,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Od.forEach(o),Gr=n(gn,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
...
other models (see the examples for more information).`),Bd.forEach(o),Qr=h(F),Re=d(F,"P",{});var vn=i(Re);Xr=n(vn,"This model inherits from "),Oo=d(vn,"A",{href:!0});var Wd=i(Oo);ea=n(Wd,"PreTrainedModel"),Wd.forEach(o),oa=n(vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vn.forEach(o),ta=h(F),Be=d(F,"P",{});var bn=i(Be);na=n(bn,"This model is also a PyTorch "),We=d(bn,"A",{href:!0,rel:!0});var Gd=i(We);ra=n(Gd,"torch.nn.Module"),Gd.forEach(o),aa=n(bn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bn.forEach(o),sa=h(F),W=d(F,"P",{});var _o=i(W);Ro=d(_o,"A",{href:!0});var Ud=i(Ro);da=n(Ud,"VisionEncoderDecoderModel"),Ud.forEach(o),ia=n(_o,` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
...
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Wo=d(it,"A",{href:!0});var ni=i(Wo);Aa=n(ni,"from_pretrained()"),ni.forEach(o),Sa=n(it," function and the decoder is loaded via "),Go=d(it,"A",{href:!0});var ri=i(Go);Ia=n(ri,"from_pretrained()"),ri.forEach(o),La=n(it,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),wn.forEach(o),Wa=h(z),Ke=d(z,"P",{});var yn=i(Ke);Ga=n(yn,"Additionally, in "),Qe=d(yn,"A",{href:!0,rel:!0});var si=i(Qe);Ua=n(si,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kn.forEach(o),rs=h(z),G=d(z,"P",{});var vo=i(G);Ho=d(vo,"A",{href:!0});var li=i(Ho);as=n(li,"TFVisionEncoderDecoderModel"),li.forEach(o),ss=n(vo,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
...
other models (see the examples for more information).`),Ei.forEach(o),Rs=h(P),po=d(P,"P",{});var jn=i(po);Bs=n(jn,"This model inherits from "),Xo=d(jn,"A",{href:!0});var ki=i(Xo);Ws=n(ki,"FlaxPreTrainedModel"),ki.forEach(o),Gs=n(jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
