...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function mf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
...
<span class="hljs-number">0.76</span>`}}),{c(){k(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,p){b(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function kf(j){let d,T,c,p,y;return p=new pe({props:{code:`import torch
from transformers import GPT2Tokenizer, GPTJForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),T=n("Example of multi-label classification:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example of multi-label classification:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function wf(j){let d,T;return d=new pe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=r(z,"CODE",{});var Ie=i(W);me=s(Ie,"model(inputs)"),Ie.forEach(t),re=s(z,"."),z.forEach(t),L=u(v),I=r(v,"P",{});var Me=i(I);ee=s(Me,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),N=r(D,"CODE",{});var Le=i(N);_e=s(Le,"model([input_ids, attention_mask])"),Le.forEach(t),de=s(D," or "),S=r(D,"CODE",{});var ve=i(S);U=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),D.forEach(t),Te=u(A),C=r(A,"LI",{});var ke=i(C);ye=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,G){g(v,d,G),e(d,T),g(v,c,G),g(v,p,G),e(p,y),e(y,l),e(p,m),e(p,x),e(x,he),g(v,K,G),g(v,J,G),e(J,X),e(J,O),e(O,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,L,G),g(v,I,G),e(I,ee),g(v,te,G),g(v,E,G),e(E,M),e(M,fe),e(M,B),e(B,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,S),e(S,U),e(E,Te),e(E,C),e(C,ye),e(C,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(L),v&&t(I),v&&t(te),v&&t(E)}}}function jf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Gf(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),L=h(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),L=h(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),te=u(v),E=r(v,"UL",{});var A=i(E);M=r(A,"LI",{});var Q=i(M);fe=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var ce=i(B);ie=s(ce,"input_ids"),ce.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Pe=i(H);oe=s(Pe,"model(inputs_ids)"),Pe.forEach(t),Q.forEach(t),ge=u(A),q=r(A,"LI",{});var D=i(q);le=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Le=i(N);_e=s(Le,"model([input_ids, attention_mask])"),Le.forEach(t),de=s(D," or "),S=r(D,"CODE",{});var ve=i(S);U=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),D.forEach(t),Te=u(A),C=r(A,"LI",{});var ke=i(C);ye=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,G){g(v,d,G),e(d,T),g(v,c,G),g(v,p,G),e(p,y),e(y,l),e(p,m),e(p,x),e(x,he),g(v,K,G),g(v,J,G),e(J,X),e(J,O),e(O,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,L,G),g(v,I,G),e(I,ee),g(v,te,G),g(v,E,G),e(E,M),e(M,fe),e(M,B),e(B,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,S),e(S,U),e(E,Te),e(E,C),e(C,ye),e(C,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(L),v&&t(I),v&&t(te),v&&t(E)}}}function qf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){k(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,p){b(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),L=h(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),te=u(v),E=r(v,"UL",{});var A=i(E);M=r(A,"LI",{});var Q=i(M);fe=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var ce=i(B);ie=s(ce,"input_ids"),ce.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Pe=i(H);oe=s(Pe,"model(inputs_ids)"),Pe.forEach(t),Q.forEach(t),ge=u(A),q=r(A,"LI",{});var D=i(q);le=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Le=i(N);_e=s(Le,"model([input_ids, attention_mask])"),Le.forEach(t),de=s(D," or "),S=r(D,"CODE",{});var ve=i(S);U=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),D.forEach(t),Te=u(A),C=r(A,"LI",{});var ke=i(C);ye=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,G){g(v,d,G),e(d,T),g(v,c,G),g(v,p,G),e(p,y),e(y,l),e(p,m),e(p,x),e(x,he),g(v,K,G),g(v,J,G),e(J,X),e(J,O),e(O,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,L,G),g(v,I,G),e(I,ee),g(v,te,G),g(v,E,G),e(E,M),e(M,fe),e(M,B),e(B,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,S),e(S,U),e(E,Te),e(E,C),e(C,ye),e(C,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(L),v&&t(I),v&&t(te),v&&t(E)}}}function If(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Lf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJForQuestionAnswering
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predict_answer_tokens = inputs.input_ids[<span class="hljs-number">0</span>, answer_start_index : answer_end_index + <span class="hljs-number">1</span>]
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predict_answer_tokens)
`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Nf(j){let d,T;return d=new pe({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,p){b(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Sf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Df(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Of(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne,v,G,V,Ce,ze,z,Ae,Ie,Me,A,Q,ce,Pe,D,Le,ve,ke,Ne,ta,ct,Ni,Ro,Si,Di,oa,Oi,Wi,na,Ui,Qi,Ir,wt,Ht,sa,Vo,Bi,aa,Hi,Lr,Rt,Ri,_s,Vi,Ki,Nr,Ko,Sr,Ts,Xi,Dr,Xo,Or,bt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,ys,ol,nl,en,sl,al,vs,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Qr,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,yl,ws,vl,kl,ca,wl,bl,$l,Yt,Pl,Zt,Br,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,xl,ua,Gl,Jl,dn,El,cn,Ml,ql,Cl,tt,pn,zl,jt,Al,bs,Il,Ll,ma,Nl,Sl,Dl,to,Ol,oo,Rr,xt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Ql,_a,Bl,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,ya,ed,td,va,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,Gt,hd,Fs,ud,md,wa,fd,gd,_d,so,Td,ao,yd,ro,vd,io,kd,lo,Kr,Jt,co,ba,_n,wd,$a,bd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,xd,Gd,Jd,yn,Ed,vn,Md,qd,Cd,Se,kn,zd,Mt,Ad,js,Id,Ld,ja,Nd,Sd,Dd,po,Od,ho,Wd,uo,Yr,qt,mo,xa,wn,Ud,Ga,Qd,Zr,je,bn,Bd,Ja,Hd,Rd,$n,Vd,xs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,Ct,ac,Gs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,zt,To,Ma,xn,hc,qa,uc,ti,xe,Gn,mc,Ca,fc,gc,Jn,_c,Js,Tc,yc,vc,En,kc,Mn,wc,bc,$c,yo,Pc,nt,qn,Fc,At,jc,Es,xc,Gc,za,Jc,Ec,Mc,vo,qc,ko,oi,It,wo,Aa,Cn,Cc,Ia,zc,ni,se,zn,Ac,La,Ic,Lc,Ms,qs,Nc,Sc,Dc,Ye,Oc,Na,Wc,Uc,Sa,Qc,Bc,Da,Hc,Rc,Oa,Vc,Kc,Xc,An,Yc,Cs,Zc,ep,tp,In,op,Ln,np,sp,ap,bo,rp,De,Nn,ip,Lt,lp,zs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,Sn,gp,Qa,_p,ai,Ge,Dn,Tp,St,yp,Ba,vp,kp,Ha,wp,bp,$p,On,Pp,As,Fp,jp,xp,Wn,Gp,Un,Jp,Ep,Mp,xo,qp,Oe,Qn,Cp,Dt,zp,Is,Ap,Ip,Ra,Lp,Np,Sp,Go,Dp,Jo,Op,Eo,ri,Ot,Mo,Va,Bn,Wp,Ka,Up,ii,we,Hn,Qp,Xa,Bp,Hp,Rn,Rp,Ls,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,yh,Co,li,Ut,zo,ar,os,vh,rr,kh,di,be,ns,wh,ir,bh,$h,ss,Ph,Ns,Fh,jh,xh,as,Gh,rs,Jh,Eh,Mh,lr,qh,Ch,mt,dr,is,zh,Ah,cr,ls,Ih,Lh,pr,ds,Nh,Sh,hr,cs,Dh,Oh,at,ps,Wh,Qt,Uh,ur,Qh,Bh,mr,Hh,Rh,Vh,Ao,Kh,Io,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/configuration_gptj.py#L33"}}),Kt=new Je({props:{anchor:"transformers.GPTJConfig.example",$$slots:{default:[uf]},$$scope:{ctx:j}}}),tn=new He({}),on=new ae({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16948/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16948/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_gptj.py#L471"}}),an=new ae({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16948/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_gptj.py#L712"}}),pn=new ae({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16948/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16948/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_gptj.py#L781",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_gptj.py#L903",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16948/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_gptj.py#L1014"}}),kn=new ae({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16948/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16948/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_gptj.py#L1030",returnDescription:`
<p>A <a
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_tf_gptj.py#L652",returnDescription:`
<p>A <a
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_tf_gptj.py#L759",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_tf_gptj.py#L863",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16948/src/transformers/models/gptj/modeling_tf_gptj.py#L986",returnDescription:`
<p>A <a
...
causal language model trained on `),M=a("a"),fe=n("the Pile"),B=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),S=a("ul"),U=a("li"),Te=n("To load "),C=a("a"),ye=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
behavior.`),_l=h(),et=a("div"),k(an.$$.fragment),Tl=h(),Pt=a("p"),yl=n("The "),ws=a("a"),vl=n("GPTJModel"),kl=n(" forward method, overrides the "),ca=a("code"),wl=n("__call__"),bl=n(" special method."),$l=h(),k(Yt.$$.fragment),Pl=h(),k(Zt.$$.fragment),Br=h(),Ft=a("h2"),eo=a("a"),pa=a("span"),k(rn.$$.fragment),Fl=h(),ha=a("span"),jl=n("GPTJForCausalLM"),Hr=h(),Ve=a("div"),k(ln.$$.fragment),xl=h(),ua=a("p"),Gl=n("The GPT-J Model transformer with a language modeling head on top."),Jl=h(),dn=a("p"),El=n("This model is a PyTorch "),cn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc=h(),En=a("p"),kc=n("This model is also a "),Mn=a("a"),wc=n("tf.keras.Model"),bc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$c=h(),k(yo.$$.fragment),Pc=h(),nt=a("div"),k(qn.$$.fragment),Fc=h(),At=a("p"),jc=n("The "),Es=a("a"),xc=n("TFGPTJForCausalLM"),Gc=n(" forward method, overrides the "),za=a("code"),Jc=n("__call__"),Ec=n(" special method."),Mc=h(),k(vo.$$.fragment),qc=h(),k(ko.$$.fragment),oi=h(),It=a("h2"),wo=a("a"),Aa=a("span"),k(Cn.$$.fragment),Cc=h(),Ia=a("span"),zc=n("TFGPTJForSequenceClassification"),ni=h(),se=a("div"),k(zn.$$.fragment),Ac=h(),La=a("p"),Ic=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Lc=h(),Ms=a("p"),qs=a("a"),Nc=n("GPTJForSequenceClassification"),Sc=n(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(bo.$$.fragment),rp=h(),De=a("div"),k(Nn.$$.fragment),ip=h(),Lt=a("p"),lp=n("The "),zs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(Sn.$$.fragment),gp=h(),Qa=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),Ge=a("div"),k(Dn.$$.fragment),Tp=h(),St=a("p"),yp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ba=a("code"),vp=n("span start logits"),kp=n(" and "),Ha=a("code"),wp=n("span end logits"),bp=n(")."),$p=h(),On=a("p"),Pp=n("This model inherits from "),As=a("a"),Fp=n("TFPreTrainedModel"),jp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
train/fine-tune the model on TPU and then convert the model to Transformers format for inference. Instructions for
that could be found `),ve=r(Ss,"A",{href:!0,rel:!0});var Er=i(ve);ke=s(Er,"here"),Er.forEach(t),Ss.forEach(t),Jr.forEach(t),Ne=u(fs),ta=r(fs,"LI",{});var Mr=i(ta);ct=r(Mr,"P",{});var ft=i(ct);Ni=s(ft,`Although the embedding matrix has a size of 50400, only 50257 entries are used by the GPT-2 tokenizer. These extra
tokens are added for the sake of efficiency on TPUs. To avoid the mis-match between embedding matrix size and vocab
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mi.forEach(t),_l=u(Os),et=r(Os,"DIV",{class:!0});var Lo=i(et);w(an.$$.fragment,Lo),Tl=u(Lo),Pt=r(Lo,"P",{});var Ws=i(Pt);yl=s(Ws,"The "),ws=r(Ws,"A",{href:!0});var mu=i(ws);vl=s(mu,"GPTJModel"),mu.forEach(t),kl=s(Ws," forward method, overrides the "),ca=r(Ws,"CODE",{});var fu=i(ca);wl=s(fu,"__call__"),fu.forEach(t),bl=s(Ws," special method."),Ws.forEach(t),$l=u(Lo),w(Yt.$$.fragment,Lo),Pl=u(Lo),w(Zt.$$.fragment,Lo),Lo.forEach(t),Os.forEach(t),Br=u(o),Ft=r(o,"H2",{class:!0});var fi=i(Ft);eo=r(fi,"A",{id:!0,class:!0,href:!0});var gu=i(eo);pa=r(gu,"SPAN",{});var _u=i(pa);w(rn.$$.fragment,_u),_u.forEach(t),gu.forEach(t),Fl=u(fi),ha=r(fi,"SPAN",{});var Tu=i(ha);jl=s(Tu,"GPTJForCausalLM"),Tu.forEach(t),fi.forEach(t),Hr=u(o),Ve=r(o,"DIV",{class:!0});var No=i(Ve);w(ln.$$.fragment,No),xl=u(No),ua=r(No,"P",{});var yu=i(ua);Gl=s(yu,"The GPT-J Model transformer with a language modeling head on top."),yu.forEach(t),Jl=u(No),dn=r(No,"P",{});var gi=i(dn);El=s(gi,"This model is a PyTorch "),cn=r(gi,"A",{href:!0,rel:!0});var vu=i(cn);Ml=s(vu,"torch.nn.Module"),vu.forEach(t),ql=s(gi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pi.forEach(t),vc=u(lt),En=r(lt,"P",{});var Fi=i(En);kc=s(Fi,"This model is also a "),Mn=r(Fi,"A",{href:!0,rel:!0});var om=i(Mn);wc=s(om,"tf.keras.Model"),om.forEach(t),bc=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),$c=u(lt),w(yo.$$.fragment,lt),Pc=u(lt),nt=r(lt,"DIV",{class:!0});var Wo=i(nt);w(qn.$$.fragment,Wo),Fc=u(Wo),At=r(Wo,"P",{});var Vs=i(At);jc=s(Vs,"The "),Es=r(Vs,"A",{href:!0});var nm=i(Es);xc=s(nm,"TFGPTJForCausalLM"),nm.forEach(t),Gc=s(Vs," forward method, overrides the "),za=r(Vs,"CODE",{});var sm=i(za);Jc=s(sm,"__call__"),sm.forEach(t),Ec=s(Vs," special method."),Vs.forEach(t),Mc=u(Wo),w(vo.$$.fragment,Wo),qc=u(Wo),w(ko.$$.fragment,Wo),Wo.forEach(t),lt.forEach(t),oi=u(o),It=r(o,"H2",{class:!0});var ji=i(It);wo=r(ji,"A",{id:!0,class:!0,href:!0});var am=i(wo);Aa=r(am,"SPAN",{});var rm=i(Aa);w(Cn.$$.fragment,rm),rm.forEach(t),am.forEach(t),Cc=u(ji),Ia=r(ji,"SPAN",{});var im=i(Ia);zc=s(im,"TFGPTJForSequenceClassification"),im.forEach(t),ji.forEach(t),ni=u(o),se=r(o,"DIV",{class:!0});var qe=i(se);w(zn.$$.fragment,qe),Ac=u(qe),La=r(qe,"P",{});var lm=i(La);Ic=s(lm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),lm.forEach(t),Lc=u(qe),Ms=r(qe,"P",{});var Yh=i(Ms);qs=r(Yh,"A",{href:!0});var dm=i(qs);Nc=s(dm,"GPTJForSequenceClassification"),dm.forEach(t),Sc=s(Yh,` uses the last token in order to do the classification, as other causal models
(e.g. GPT, GPT-2, GPT-Neo) do.`),Yh.forEach(t),Dc=u(qe),Ye=r(qe,"P",{});var yt=i(Ye);Oc=s(yt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
no `),Sa=r(yt,"CODE",{});var pm=i(Sa);Qc=s(pm,"pad_token_id"),pm.forEach(t),Bc=s(yt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Da=r(yt,"CODE",{});var hm=i(Da);Hc=s(hm,"inputs_embeds"),hm.forEach(t),Rc=s(yt," are passed instead of "),Oa=r(yt,"CODE",{});var um=i(Oa);Vc=s(um,"input_ids"),um.forEach(t),Kc=s(yt,`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gi.forEach(t),ap=u(qe),w(bo.$$.fragment,qe),rp=u(qe),De=r(qe,"DIV",{class:!0});var vt=i(De);w(Nn.$$.fragment,vt),ip=u(vt),Lt=r(vt,"P",{});var Ks=i(Lt);lp=s(Ks,"The "),zs=r(Ks,"A",{href:!0});var gm=i(zs);dp=s(gm,"TFGPTJForSequenceClassification"),gm.forEach(t),cp=s(Ks," forward method, overrides the "),Wa=r(Ks,"CODE",{});var _m=i(Wa);pp=s(_m,"__call__"),_m.forEach(t),hp=s(Ks," special method."),Ks.forEach(t),up=u(vt),w($o.$$.fragment,vt),mp=u(vt),w(Po.$$.fragment,vt),fp=u(vt),w(Fo.$$.fragment,vt),vt.forEach(t),qe.forEach(t),si=u(o),Nt=r(o,"H2",{class:!0});var Ji=i(Nt);jo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tm=i(jo);Ua=r(Tm,"SPAN",{});var ym=i(Ua);w(Sn.$$.fragment,ym),ym.forEach(t),Tm.forEach(t),gp=u(Ji),Qa=r(Ji,"SPAN",{});var vm=i(Qa);_p=s(vm,"TFGPTJForQuestionAnswering"),vm.forEach(t),Ji.forEach(t),ai=u(o),Ge=r(o,"DIV",{class:!0});var dt=i(Ge);w(Dn.$$.fragment,dt),Tp=u(dt),St=r(dt,"P",{});var Xs=i(St);yp=s(Xs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
