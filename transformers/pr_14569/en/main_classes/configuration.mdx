...
<docstring><name>class transformers.PretrainedConfig</name><anchor>transformers.PretrainedConfig</anchor><source>https://github.com/huggingface/transformers/blob/pr_14569/src/transformers/configuration_utils.py#L53</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **name_or_path** (`str`, *optional*, defaults to `""`) --
...
<div class="docstring">
<docstring><name>dict\_torch\_dtype\_to\_str</name><anchor>transformers.PretrainedConfig.dict_torch_dtype_to_str</anchor><source>https://github.com/huggingface/transformers/blob/pr_14569/src/transformers/configuration_utils.py#L855</source><parameters>[{"name": "d", "val": ": typing.Dict[str, typing.Any]"}]</parameters></docstring>
