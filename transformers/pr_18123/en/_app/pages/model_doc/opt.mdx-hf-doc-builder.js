import{S as Il,i as Sl,s as Al,e as n,k as p,w as y,t as i,M as Dl,c as s,d as t,m as u,a,x as k,h as l,b as m,G as e,g,y as w,q as $,o as P,B as O,v as Wl,L as Ie}from"../../chunks/vendor-hf-doc-builder.js";import{T as Zn}from"../../chunks/Tip-hf-doc-builder.js";import{D as se}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Se}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ue}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ne}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Gl(F){let d,v,h,c,T;return c=new Se({props:{code:`from transformers import OPTModel, OPTConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(r,f){g(r,d,f),e(d,v),e(d,h),e(h,c),e(d,T)},d(r){r&&t(d)}}}function Ul(F){let d,v,h,c,T;return c=new Se({props:{code:`from transformers import OPTTokenizer, OPTModel
import torch
...
last_hidden_states = outputs.last_hidden_state`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> OPTTokenizer, OPTModel
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){y(d.$$.fragment)},l(h){k(d.$$.fragment,h)},m(h,c){w(d,h,c),v=!0},p:Ie,i(h){v||($(d.$$.fragment,h),v=!0)},o(h){P(d.$$.fragment,h),v=!1},d(h){O(d,h)}}}function Xl(F){let d,v,h,c,T,r,f,z,$e,ae,M,K,W,X,Pe,G,Oe,Te,A,H,Y,pe,E,L,re,Q,ve,ie,U,Fe,be,j,Me,J,Z,ee,te,ue,xe,B,ze,q,Ce;return{c(){d=n("p"),v=i("TF 2.0 models accepts two formats as inputs:"),h=p(),c=n("ul"),T=n("li"),r=i("having all inputs as keyword arguments (like PyTorch models), or"),f=p(),z=n("li"),$e=i("having all inputs as a list, tuple or dict in the first positional arguments."),ae=p(),M=n("p"),K=i("This second option is useful when using "),W=n("code"),X=i("tf.keras.Model.fit"),Pe=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=n("code"),Oe=i("model(inputs)"),Te=i("."),A=p(),H=n("p"),Y=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),q=s(je,"CODE",{});var Ze=a(q);Ce=l(Ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ze.forEach(t),je.forEach(t),N.forEach(t)},m(b,x){g(b,d,x),e(d,v),g(b,h,x),g(b,c,x),e(c,T),e(T,r),e(c,f),e(c,z),e(z,$e),g(b,ae,x),g(b,M,x),e(M,K),e(M,W),e(W,X),e(M,Pe),e(M,G),e(G,Oe),e(M,Te),g(b,A,x),g(b,H,x),e(H,Y),g(b,pe,x),g(b,E,x),e(E,L),e(L,re),e(L,Q),e(Q,ve),e(L,ie),e(L,U),e(U,Fe),e(E,be),e(E,j),e(j,Me),e(j,J),e(J,Z),e(j,ee),e(j,te),e(te,ue),e(E,xe),e(E,B),e(B,ze),e(B,q),e(q,Ce)},d(b){b&&t(d),b&&t(h),b&&t(c),b&&t(ae),b&&t(M),b&&t(A),b&&t(H),b&&t(pe),b&&t(E)}}}function Yl(F){let d,v,h,c,T;return{c(){d=n("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),c=i("Module"),T=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var f=a(d);v=l(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(f,"CODE",{});var z=a(h);c=l(z,"Module"),z.forEach(t),T=l(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(r,f){g(r,d,f),e(d,v),e(d,h),e(h,c),e(d,T)},d(r){r&&t(d)}}}function Ql(F){let d,v,h,c,T;return c=new Se({props:{code:`from transformers import GPT2Tokenizer, TFOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),v=i("Example:"),h=p(),y(c.$$.fragment)},l(r){d=s(r,"P",{});var f=a(d);v=l(f,"Example:"),f.forEach(t),h=u(r),k(c.$$.fragment,r)},m(r,f){g(r,d,f),e(d,v),g(r,h,f),w(c,r,f),T=!0},p:Ie,i(r){T||($(c.$$.fragment,r),T=!0)},o(r){P(c.$$.fragment,r),T=!1},d(r){r&&t(d),r&&t(h),O(c,r)}}}function ed(F){let d,v,h,c,T,r,f,z,$e,ae,M,K,W,X,Pe,G,Oe,Te,A,H,Y,pe,E,L,re,Q,ve,ie,U,Fe,be,j,Me,J,Z,ee,te,ue,xe,B,ze,q,Ce;return{c(){d=n("p"),v=i("TF 2.0 models accepts two formats as inputs:"),h=p(),c=n("ul"),T=n("li"),r=i("having all inputs as keyword arguments (like PyTorch models), or"),f=p(),z=n("li"),$e=i("having all inputs as a list, tuple or dict in the first positional arguments."),ae=p(),M=n("p"),K=i("This second option is useful when using "),W=n("code"),X=i("tf.keras.Model.fit"),Pe=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=n("code"),Oe=i("model(inputs)"),Te=i("."),A=p(),H=n("p"),Y=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=p(),E=n("ul"),L=n("li"),re=i("a single Tensor with "),Q=n("code"),ve=i("input_ids"),ie=i(" only and nothing else: "),U=n("code"),Fe=i("model(input_ids)"),be=p(),j=n("li"),Me=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=n("code"),Z=i("model([input_ids, attention_mask])"),ee=i(" or "),te=n("code"),ue=i("model([input_ids, attention_mask, token_type_ids])"),xe=p(),B=n("li"),ze=i(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),Ce=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){d=s(b,"P",{});var x=a(d);v=l(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),h=u(b),c=s(b,"UL",{});var he=a(c);T=s(he,"LI",{});var Ee=a(T);r=l(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),f=u(he),z=s(he,"LI",{});var Be=a(z);$e=l(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),he.forEach(t),ae=u(b),M=s(b,"P",{});var V=a(M);K=l(V,"This second option is useful when using "),W=s(V,"CODE",{});var qe=a(W);X=l(qe,"tf.keras.Model.fit"),qe.forEach(t),Pe=l(V,` method which currently requires having all the
...
first positional argument :`),Re.forEach(t),pe=u(b),E=s(b,"UL",{});var N=a(E);L=s(N,"LI",{});var oe=a(L);re=l(oe,"a single Tensor with "),Q=s(oe,"CODE",{});var Ke=a(Q);ve=l(Ke,"input_ids"),Ke.forEach(t),ie=l(oe," only and nothing else: "),U=s(oe,"CODE",{});var Ae=a(U);Fe=l(Ae,"model(input_ids)"),Ae.forEach(t),oe.forEach(t),be=u(N),j=s(N,"LI",{});var C=a(j);Me=l(C,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=s(C,"CODE",{});var Je=a(J);Z=l(Je,"model([input_ids, attention_mask])"),Je.forEach(t),ee=l(C," or "),te=s(C,"CODE",{});var me=a(te);ue=l(me,"model([input_ids, attention_mask, token_type_ids])"),me.forEach(t),C.forEach(t),xe=u(N),B=s(N,"LI",{});var je=a(B);ze=l(je,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(je,"CODE",{});var Ze=a(q);Ce=l(Ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ze.forEach(t),je.forEach(t),N.forEach(t)},m(b,x){g(b,d,x),e(d,v),g(b,h,x),g(b,c,x),e(c,T),e(T,r),e(c,f),e(c,z),e(z,$e),g(b,ae,x),g(b,M,x),e(M,K),e(M,W),e(W,X),e(M,Pe),e(M,G),e(G,Oe),e(M,Te),g(b,A,x),g(b,H,x),e(H,Y),g(b,pe,x),g(b,E,x),e(E,L),e(L,re),e(L,Q),e(Q,ve),e(L,ie),e(L,U),e(U,Fe),e(E,be),e(E,j),e(j,Me),e(j,J),e(J,Z),e(j,ee),e(j,te),e(te,ue),e(E,xe),e(E,B),e(B,ze),e(B,q),e(q,Ce)},d(b){b&&t(d),b&&t(h),b&&t(c),b&&t(ae),b&&t(M),b&&t(A),b&&t(H),b&&t(pe),b&&t(E)}}}function td(F){let d,v,h,c,T;return c=new Se({props:{code:`from transformers import GPT2Tokenizer, TFOPTForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generate_ids = model.generate(inputs.input_ids, max_length=<span class="hljs-number">30</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(generate_ids, skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">False</span>)[<span class="hljs-number">0</span>]
<span class="hljs-string">&quot;Hey, are you consciours? Can you talk to me?\\nI&#x27;m not consciours, but I can talk to you.&quot;</span>`}}),{c(){d=n("p"),v=i("Example:"),h=p(),y(c.$$.fragment)},l(r){d=s(r,"P",{});var f=a(d);v=l(f,"Example:"),f.forEach(t),h=u(r),k(c.$$.fragment,r)},m(r,f){g(r,d,f),e(d,v),g(r,h,f),w(c,r,f),T=!0},p:Ie,i(r){T||($(c.$$.fragment,r),T=!0)},o(r){P(c.$$.fragment,r),T=!1},d(r){r&&t(d),r&&t(h),O(c,r)}}}function od(F){let d,v,h,c,T;return c=new Se({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=n("p"),v=i("Example:"),h=p(),y(c.$$.fragment)},l(r){d=s(r,"P",{});var f=a(d);v=l(f,"Example:"),f.forEach(t),h=u(r),k(c.$$.fragment,r)},m(r,f){g(r,d,f),e(d,v),g(r,h,f),w(c,r,f),T=!0},p:Ie,i(r){T||($(c.$$.fragment,r),T=!0)},o(r){P(c.$$.fragment,r),T=!1},d(r){r&&t(d),r&&t(h),O(c,r)}}}function sd(F){let d,v,h,c,T,r,f,z,$e,ae,M,K,W,X,Pe,G,Oe,Te,A,H,Y,pe,E,L,re,Q,ve,ie,U,Fe,be,j,Me,J,Z,ee,te,ue,xe,B,ze,q,Ce,b,x,he,Ee,Be,V,qe,Ve,Re,N,oe,Ke,Ae,C,Je,me,je,Ze,Bt,Ss,As,Vt,Ds,Ws,Rt,Gs,Hs,Xn,Xe,ut,ln,Kt,Us,dn,Bs,Yn,fe,Jt,Vs,Ye,Rs,Ho,Ks,Js,Zt,Zs,Xs,Ys,Qe,Qs,Uo,ea,ta,Bo,oa,na,sa,ht,Qn,et,mt,cn,Xt,aa,pn,ra,es,ge,Yt,ia,Qt,la,Vo,da,ca,pa,eo,ua,to,ha,ma,fa,ye,oo,ga,tt,_a,Ro,Ta,va,un,ba,ya,ka,ft,wa,gt,ts,ot,_t,hn,no,$a,mn,Pa,os,nt,so,Oa,Tt,ao,Fa,vt,ns,st,bt,fn,ro,Ma,gn,xa,ss,I,io,za,_n,Ca,Ea,Ko,Jo,qa,ja,La,_e,Na,Tn,Ia,Sa,vn,Aa,Da,bn,Wa,Ga,yn,Ha,Ua,Ba,lo,Va,Zo,Ra,Ka,Ja,co,Za,po,Xa,Ya,Qa,D,uo,er,at,tr,Xo,or,nr,kn,sr,ar,rr,yt,ir,kt,lr,wt,dr,$t,cr,Pt,as,rt,Ot,wn,ho,pr,$n,ur,rs,ne,mo,hr,fo,mr,Yo,fr,gr,_r,go,Tr,_o,vr,br,yr,Ft,kr,ke,To,wr,it,$r,Qo,Pr,Or,Pn,Fr,Mr,xr,Mt,zr,xt,is,lt,zt,On,vo,Cr,Fn,Er,ls,R,bo,qr,Mn,jr,Lr,yo,Nr,en,Ir,Sr,Ar,ko,Dr,wo,Wr,Gr,Hr,Ct,Ur,Et,$o,Br,qt,ds,dt,jt,xn,Po,Vr,zn,Rr,cs,ct,Oo,Kr,Lt,Fo,Jr,Nt,ps,pt,It,Cn,Mo,Zr,En,Xr,us,S,xo,Yr,qn,Qr,ei,zo,ti,tn,oi,ni,si,Co,ai,Eo,ri,ii,li,jn,di,ci,Le,Ln,qo,pi,ui,Nn,jo,hi,mi,In,Lo,fi,gi,Sn,No,_i,Ti,St,Io,vi,At,hs;return r=new Ue({}),X=new Ue({}),Kt=new Ue({}),Jt=new se({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"_remove_final_layer_norm",val:" = False"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
Vocabulary size of the OPT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTModel">OPTModel</a>`,name:"vocab_size"},{anchor:"transformers.OPTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>Indices can be obtained using <code>OPTTokenizer</code>. See <a href="/docs/transformers/pr_18123/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18123/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18123/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_opt.py#L745",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18123/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_18123/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_opt.py#L828",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18123/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
`}}),vt=new Ne({props:{anchor:"transformers.OPTForCausalLM.forward.example",$$slots:{default:[Bl]},$$scope:{ctx:F}}}),ro=new Ue({}),io=new se({props:{name:"class transformers.OPTForSequenceClassification",anchor:"transformers.OPTForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.OPTForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTConfig">OPTConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_18123/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_opt.py#L996"}}),uo=new se({props:{name:"forward",anchor:"transformers.OPTForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.OPTForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18123/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_18123/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18123/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_opt.py#L1012",returnDescription:`
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_tf_opt.py#L796",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18123/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Whether or not to return a <a href="/docs/transformers/pr_18123/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_tf_opt.py#L895",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18123/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<a href="/docs/transformers/pr_18123/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_flax_opt.py#L769"}}),Io=new se({props:{name:"__call__",anchor:"transformers.FlaxOPTForCausalLM.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"deterministic",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/vr_18123/src/transformers/models/opt/modeling_flax_opt.py#L585",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18123/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
and behavior.`),fa=p(),ye=n("div"),y(oo.$$.fragment),ga=p(),tt=n("p"),_a=i("The "),Ro=n("a"),Ta=i("OPTModel"),va=i(" forward method, overrides the "),un=n("code"),ba=i("__call__"),ya=i(" special method."),ka=p(),y(ft.$$.fragment),wa=p(),y(gt.$$.fragment),ts=p(),ot=n("h2"),_t=n("a"),hn=n("span"),y(no.$$.fragment),$a=p(),mn=n("span"),Pa=i("OPTForCausalLM"),os=p(),nt=n("div"),y(so.$$.fragment),Oa=p(),Tt=n("div"),y(ao.$$.fragment),Fa=p(),y(vt.$$.fragment),ns=p(),st=n("h2"),bt=n("a"),fn=n("span"),y(ro.$$.fragment),Ma=p(),gn=n("span"),xa=i("OPTForSequenceClassification"),ss=p(),I=n("div"),y(io.$$.fragment),za=p(),_n=n("p"),Ca=i("The OPT Model transformer with a sequence classification head on top (linear layer)."),Ea=p(),Ko=n("p"),Jo=n("a"),qa=i("OPTForSequenceClassification"),ja=i(` uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.`),La=p(),_e=n("p"),Na=i(`Since it does classification on the last token, it requires to know the position of the last token. If a
`),Tn=n("code"),Ia=i("pad_token_id"),Sa=i(` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),vn=n("code"),Aa=i("pad_token_id"),Da=i(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),bn=n("code"),Wa=i("inputs_embeds"),Ga=i(" are passed instead of "),yn=n("code"),Ha=i("input_ids"),Ua=i(`, it does the same (take the last value in
each row of the batch).`),Ba=p(),lo=n("p"),Va=i("This model inherits from "),Zo=n("a"),Ra=i("PreTrainedModel"),Ka=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ja=p(),co=n("p"),Za=i("This model is also a PyTorch "),po=n("a"),Xa=i("torch.nn.Module"),Ya=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qa=p(),D=n("div"),y(uo.$$.fragment),er=p(),at=n("p"),tr=i("The "),Xo=n("a"),or=i("OPTForSequenceClassification"),nr=i(" forward method, overrides the "),kn=n("code"),sr=i("__call__"),ar=i(" special method."),rr=p(),y(yt.$$.fragment),ir=p(),y(kt.$$.fragment),lr=p(),y(wt.$$.fragment),dr=p(),y($t.$$.fragment),cr=p(),y(Pt.$$.fragment),as=p(),rt=n("h2"),Ot=n("a"),wn=n("span"),y(ho.$$.fragment),pr=p(),$n=n("span"),ur=i("TFOPTModel"),rs=p(),ne=n("div"),y(mo.$$.fragment),hr=p(),fo=n("p"),mr=i(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Yo=n("a"),fr=i("TFPreTrainedModel"),gr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_r=p(),go=n("p"),Tr=i("This model is also a "),_o=n("a"),vr=i("tf.keras.Model"),br=i(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yr=p(),y(Ft.$$.fragment),kr=p(),ke=n("div"),y(To.$$.fragment),wr=p(),it=n("p"),$r=i("The "),Qo=n("a"),Pr=i("TFOPTModel"),Or=i(" forward method, overrides the "),Pn=n("code"),Fr=i("__call__"),Mr=i(" special method."),xr=p(),y(Mt.$$.fragment),zr=p(),y(xt.$$.fragment),is=p(),lt=n("h2"),zt=n("a"),On=n("span"),y(vo.$$.fragment),Cr=p(),Fn=n("span"),Er=i("TFOPTForCausalLM"),ls=p(),R=n("div"),y(bo.$$.fragment),qr=p(),Mn=n("p"),jr=i("The OPT Model transformer with a language modeling head on top."),Lr=p(),yo=n("p"),Nr=i("This model inherits from "),en=n("a"),Ir=i("TFPreTrainedModel"),Sr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ar=p(),ko=n("p"),Dr=i("This model is also a "),wo=n("a"),Wr=i("tf.keras.Model"),Gr=i(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hr=p(),y(Ct.$$.fragment),Ur=p(),Et=n("div"),y($o.$$.fragment),Br=p(),y(qt.$$.fragment),ds=p(),dt=n("h2"),jt=n("a"),xn=n("span"),y(Po.$$.fragment),Vr=p(),zn=n("span"),Rr=i("FlaxOPTModel"),cs=p(),ct=n("div"),y(Oo.$$.fragment),Kr=p(),Lt=n("div"),y(Fo.$$.fragment),Jr=p(),y(Nt.$$.fragment),ps=p(),pt=n("h2"),It=n("a"),Cn=n("span"),y(Mo.$$.fragment),Zr=p(),En=n("span"),Xr=i("FlaxOPTForCausalLM"),us=p(),S=n("div"),y(xo.$$.fragment),Yr=p(),qn=n("p"),Qr=i(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),li=p(),jn=n("p"),di=i("Finally, this model supports inherent JAX features such as:"),ci=p(),Le=n("ul"),Ln=n("li"),qo=n("a"),pi=i("Just-In-Time (JIT) compilation"),ui=p(),Nn=n("li"),jo=n("a"),hi=i("Automatic Differentiation"),mi=p(),In=n("li"),Lo=n("a"),fi=i("Vectorization"),gi=p(),Sn=n("li"),No=n("a"),_i=i("Parallelization"),Ti=p(),St=n("div"),y(Io.$$.fragment),vi=p(),y(At.$$.fragment),this.h()},l(o){const _=Dl('[data-svelte="svelte-1phssyn"]',document.head);d=s(_,"META",{name:!0,content:!0}),_.forEach(t),v=u(o),h=s(o,"H1",{class:!0});var So=a(h);c=s(So,"A",{id:!0,class:!0,href:!0});var An=a(c);T=s(An,"SPAN",{});var Dn=a(T);k(r.$$.fragment,Dn),Dn.forEach(t),An.forEach(t),f=u(So),z=s(So,"SPAN",{});var Wn=a(z);$e=l(Wn,"OPT"),Wn.forEach(t),So.forEach(t),ae=u(o),M=s(o,"H2",{class:!0});var Ao=a(M);K=s(Ao,"A",{id:!0,class:!0,href:!0});var Gn=a(K);W=s(Gn,"SPAN",{});var Hn=a(W);k(X.$$.fragment,Hn),Hn.forEach(t),Gn.forEach(t),Pe=u(Ao),G=s(Ao,"SPAN",{});var Un=a(G);Oe=l(Un,"Overview"),Un.forEach(t),Ao.forEach(t),Te=u(o),A=s(o,"P",{});var Do=a(A);H=l(Do,"The OPT model was proposed in "),Y=s(Do,"A",{href:!0,rel:!0});var Bn=a(Y);pe=l(Bn,"Open Pre-trained Transformer Language Models"),Bn.forEach(t),E=l(Do,` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Do.forEach(t),L=u(o),re=s(o,"P",{});var Vn=a(re);Q=l(Vn,"The abstract from the paper is the following:"),Vn.forEach(t),ve=u(o),ie=s(o,"P",{});var Rn=a(ie);U=s(Rn,"EM",{});var Kn=a(U);Fe=l(Kn,"Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),Kn.forEach(t),Rn.forEach(t),be=u(o),j=s(o,"P",{});var Jn=a(j);Me=l(Jn,"Tips:"),Jn.forEach(t),J=u(o),Z=s(o,"UL",{});var Wo=a(Z);ee=s(Wo,"LI",{});var Go=a(ee);te=l(Go,"OPT has the same architecture as "),ue=s(Go,"CODE",{});var yi=a(ue);xe=l(yi,"BartDecoder"),yi.forEach(t),B=l(Go,"."),Go.forEach(t),ze=u(Wo),q=s(Wo,"LI",{});var De=a(q);Ce=l(De,"Contrary to GPT2, OPT adds the EOS token "),b=s(De,"CODE",{});var ki=a(b);x=l(ki,"</s>"),ki.forEach(t),he=l(De," to the beginning of every prompt. "),Ee=s(De,"STRONG",{});var wi=a(Ee);Be=l(wi,"Note"),wi.forEach(t),V=l(De,": Make sure to pass "),qe=s(De,"CODE",{});var $i=a(qe);Ve=l($i,"use_fast=False"),$i.forEach(t),Re=l(De," when loading OPT\u2019s tokenizer with "),N=s(De,"A",{href:!0});var Pi=a(N);oe=l(Pi,"AutoTokenizer"),Pi.forEach(t),Ke=l(De," to get the correct tokenizer."),De.forEach(t),Wo.forEach(t),Ae=u(o),C=s(o,"P",{});var We=a(C);Je=l(We,"This model was contributed by "),me=s(We,"A",{href:!0,rel:!0});var Oi=a(me);je=l(Oi,"Arthur Zucker"),Oi.forEach(t),Ze=l(We,", "),Bt=s(We,"A",{href:!0,rel:!0});var Fi=a(Bt);Ss=l(Fi,"Younes Belkada"),Fi.forEach(t),As=l(We,", and "),Vt=s(We,"A",{href:!0,rel:!0});var Mi=a(Vt);Ds=l(Mi,"Patrick Von Platen"),Mi.forEach(t),Ws=l(We,`.
The original code can be found `),Rt=s(We,"A",{href:!0,rel:!0});var xi=a(Rt);Gs=l(xi,"here"),xi.forEach(t),Hs=l(We,"."),We.forEach(t),Xn=u(o),Xe=s(o,"H2",{class:!0});var ms=a(Xe);ut=s(ms,"A",{id:!0,class:!0,href:!0});var zi=a(ut);ln=s(zi,"SPAN",{});var Ci=a(ln);k(Kt.$$.fragment,Ci),Ci.forEach(t),zi.forEach(t),Us=u(ms),dn=s(ms,"SPAN",{});var Ei=a(dn);Bs=l(Ei,"OPTConfig"),Ei.forEach(t),ms.forEach(t),Yn=u(o),fe=s(o,"DIV",{class:!0});var Dt=a(fe);k(Jt.$$.fragment,Dt),Vs=u(Dt),Ye=s(Dt,"P",{});var on=a(Ye);Rs=l(on,"This is the configuration class to store the configuration of a "),Ho=s(on,"A",{href:!0});var qi=a(Ho);Ks=l(qi,"OPTModel"),qi.forEach(t),Js=l(on,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
...
documentation from `),Bo=s(nn,"A",{href:!0});var Ni=a(Bo);oa=l(Ni,"PretrainedConfig"),Ni.forEach(t),na=l(nn," for more information."),nn.forEach(t),sa=u(Dt),k(ht.$$.fragment,Dt),Dt.forEach(t),Qn=u(o),et=s(o,"H2",{class:!0});var fs=a(et);mt=s(fs,"A",{id:!0,class:!0,href:!0});var Ii=a(mt);cn=s(Ii,"SPAN",{});var Si=a(cn);k(Xt.$$.fragment,Si),Si.forEach(t),Ii.forEach(t),aa=u(fs),pn=s(fs,"SPAN",{});var Ai=a(pn);ra=l(Ai,"OPTModel"),Ai.forEach(t),fs.forEach(t),es=u(o),ge=s(o,"DIV",{class:!0});var Wt=a(ge);k(Yt.$$.fragment,Wt),ia=u(Wt),Qt=s(Wt,"P",{});var gs=a(Qt);la=l(gs,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_s.forEach(t),fa=u(Wt),ye=s(Wt,"DIV",{class:!0});var Gt=a(ye);k(oo.$$.fragment,Gt),ga=u(Gt),tt=s(Gt,"P",{});var sn=a(tt);_a=l(sn,"The "),Ro=s(sn,"A",{href:!0});var Gi=a(Ro);Ta=l(Gi,"OPTModel"),Gi.forEach(t),va=l(sn," forward method, overrides the "),un=s(sn,"CODE",{});var Hi=a(un);ba=l(Hi,"__call__"),Hi.forEach(t),ya=l(sn," special method."),sn.forEach(t),ka=u(Gt),k(ft.$$.fragment,Gt),wa=u(Gt),k(gt.$$.fragment,Gt),Gt.forEach(t),Wt.forEach(t),ts=u(o),ot=s(o,"H2",{class:!0});var Ts=a(ot);_t=s(Ts,"A",{id:!0,class:!0,href:!0});var Ui=a(_t);hn=s(Ui,"SPAN",{});var Bi=a(hn);k(no.$$.fragment,Bi),Bi.forEach(t),Ui.forEach(t),$a=u(Ts),mn=s(Ts,"SPAN",{});var Vi=a(mn);Pa=l(Vi,"OPTForCausalLM"),Vi.forEach(t),Ts.forEach(t),os=u(o),nt=s(o,"DIV",{class:!0});var vs=a(nt);k(so.$$.fragment,vs),Oa=u(vs),Tt=s(vs,"DIV",{class:!0});var bs=a(Tt);k(ao.$$.fragment,bs),Fa=u(bs),k(vt.$$.fragment,bs),bs.forEach(t),vs.forEach(t),ns=u(o),st=s(o,"H2",{class:!0});var ys=a(st);bt=s(ys,"A",{id:!0,class:!0,href:!0});var Ri=a(bt);fn=s(Ri,"SPAN",{});var Ki=a(fn);k(ro.$$.fragment,Ki),Ki.forEach(t),Ri.forEach(t),Ma=u(ys),gn=s(ys,"SPAN",{});var Ji=a(gn);xa=l(Ji,"OPTForSequenceClassification"),Ji.forEach(t),ys.forEach(t),ss=u(o),I=s(o,"DIV",{class:!0});var le=a(I);k(io.$$.fragment,le),za=u(le),_n=s(le,"P",{});var Zi=a(_n);Ca=l(Zi,"The OPT Model transformer with a sequence classification head on top (linear layer)."),Zi.forEach(t),Ea=u(le),Ko=s(le,"P",{});var bi=a(Ko);Jo=s(bi,"A",{href:!0});var Xi=a(Jo);qa=l(Xi,"OPTForSequenceClassification"),Xi.forEach(t),ja=l(bi,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.`),bi.forEach(t),La=u(le),_e=s(le,"P",{});var Ge=a(_e);Na=l(Ge,`Since it does classification on the last token, it requires to know the position of the last token. If a
`),Tn=s(Ge,"CODE",{});var Yi=a(Tn);Ia=l(Yi,"pad_token_id"),Yi.forEach(t),Sa=l(Ge,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),vn=s(Ge,"CODE",{});var Qi=a(vn);Aa=l(Qi,"pad_token_id"),Qi.forEach(t),Da=l(Ge,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),bn=s(Ge,"CODE",{});var el=a(bn);Wa=l(el,"inputs_embeds"),el.forEach(t),Ga=l(Ge," are passed instead of "),yn=s(Ge,"CODE",{});var tl=a(yn);Ha=l(tl,"input_ids"),tl.forEach(t),Ua=l(Ge,`, it does the same (take the last value in
each row of the batch).`),Ge.forEach(t),Ba=u(le),lo=s(le,"P",{});var ks=a(lo);Va=l(ks,"This model inherits from "),Zo=s(ks,"A",{href:!0});var ol=a(Zo);Ra=l(ol,"PreTrainedModel"),ol.forEach(t),Ka=l(ks,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ks.forEach(t),Ja=u(le),co=s(le,"P",{});var ws=a(co);Za=l(ws,"This model is also a PyTorch "),po=s(ws,"A",{href:!0,rel:!0});var nl=a(po);Xa=l(nl,"torch.nn.Module"),nl.forEach(t),Ya=l(ws,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ws.forEach(t),Qa=u(le),D=s(le,"DIV",{class:!0});var de=a(D);k(uo.$$.fragment,de),er=u(de),at=s(de,"P",{});var an=a(at);tr=l(an,"The "),Xo=s(an,"A",{href:!0});var sl=a(Xo);or=l(sl,"OPTForSequenceClassification"),sl.forEach(t),nr=l(an," forward method, overrides the "),kn=s(an,"CODE",{});var al=a(kn);sr=l(al,"__call__"),al.forEach(t),ar=l(an," special method."),an.forEach(t),rr=u(de),k(yt.$$.fragment,de),ir=u(de),k(kt.$$.fragment,de),lr=u(de),k(wt.$$.fragment,de),dr=u(de),k($t.$$.fragment,de),cr=u(de),k(Pt.$$.fragment,de),de.forEach(t),le.forEach(t),as=u(o),rt=s(o,"H2",{class:!0});var $s=a(rt);Ot=s($s,"A",{id:!0,class:!0,href:!0});var rl=a(Ot);wn=s(rl,"SPAN",{});var il=a(wn);k(ho.$$.fragment,il),il.forEach(t),rl.forEach(t),pr=u($s),$n=s($s,"SPAN",{});var ll=a($n);ur=l(ll,"TFOPTModel"),ll.forEach(t),$s.forEach(t),rs=u(o),ne=s(o,"DIV",{class:!0});var He=a(ne);k(mo.$$.fragment,He),hr=u(He),fo=s(He,"P",{});var Ps=a(fo);mr=l(Ps,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Yo=s(Ps,"A",{href:!0});var dl=a(Yo);fr=l(dl,"TFPreTrainedModel"),dl.forEach(t),gr=l(Ps,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ps.forEach(t),_r=u(He),go=s(He,"P",{});var Os=a(go);Tr=l(Os,"This model is also a "),_o=s(Os,"A",{href:!0,rel:!0});var cl=a(_o);vr=l(cl,"tf.keras.Model"),cl.forEach(t),br=l(Os,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Os.forEach(t),yr=u(He),k(Ft.$$.fragment,He),kr=u(He),ke=s(He,"DIV",{class:!0});var Ht=a(ke);k(To.$$.fragment,Ht),wr=u(Ht),it=s(Ht,"P",{});var rn=a(it);$r=l(rn,"The "),Qo=s(rn,"A",{href:!0});var pl=a(Qo);Pr=l(pl,"TFOPTModel"),pl.forEach(t),Or=l(rn," forward method, overrides the "),Pn=s(rn,"CODE",{});var ul=a(Pn);Fr=l(ul,"__call__"),ul.forEach(t),Mr=l(rn," special method."),rn.forEach(t),xr=u(Ht),k(Mt.$$.fragment,Ht),zr=u(Ht),k(xt.$$.fragment,Ht),Ht.forEach(t),He.forEach(t),is=u(o),lt=s(o,"H2",{class:!0});var Fs=a(lt);zt=s(Fs,"A",{id:!0,class:!0,href:!0});var hl=a(zt);On=s(hl,"SPAN",{});var ml=a(On);k(vo.$$.fragment,ml),ml.forEach(t),hl.forEach(t),Cr=u(Fs),Fn=s(Fs,"SPAN",{});var fl=a(Fn);Er=l(fl,"TFOPTForCausalLM"),fl.forEach(t),Fs.forEach(t),ls=u(o),R=s(o,"DIV",{class:!0});var we=a(R);k(bo.$$.fragment,we),qr=u(we),Mn=s(we,"P",{});var gl=a(Mn);jr=l(gl,"The OPT Model transformer with a language modeling head on top."),gl.forEach(t),Lr=u(we),yo=s(we,"P",{});var Ms=a(yo);Nr=l(Ms,"This model inherits from "),en=s(Ms,"A",{href:!0});var _l=a(en);Ir=l(_l,"TFPreTrainedModel"),_l.forEach(t),Sr=l(Ms,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ms.forEach(t),Ar=u(we),ko=s(we,"P",{});var xs=a(ko);Dr=l(xs,"This model is also a "),wo=s(xs,"A",{href:!0,rel:!0});var Tl=a(wo);Wr=l(Tl,"tf.keras.Model"),Tl.forEach(t),Gr=l(xs,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xs.forEach(t),Hr=u(we),k(Ct.$$.fragment,we),Ur=u(we),Et=s(we,"DIV",{class:!0});var zs=a(Et);k($o.$$.fragment,zs),Br=u(zs),k(qt.$$.fragment,zs),zs.forEach(t),we.forEach(t),ds=u(o),dt=s(o,"H2",{class:!0});var Cs=a(dt);jt=s(Cs,"A",{id:!0,class:!0,href:!0});var vl=a(jt);xn=s(vl,"SPAN",{});var bl=a(xn);k(Po.$$.fragment,bl),bl.forEach(t),vl.forEach(t),Vr=u(Cs),zn=s(Cs,"SPAN",{});var yl=a(zn);Rr=l(yl,"FlaxOPTModel"),yl.forEach(t),Cs.forEach(t),cs=u(o),ct=s(o,"DIV",{class:!0});var Es=a(ct);k(Oo.$$.fragment,Es),Kr=u(Es),Lt=s(Es,"DIV",{class:!0});var qs=a(Lt);k(Fo.$$.fragment,qs),Jr=u(qs),k(Nt.$$.fragment,qs),qs.forEach(t),Es.forEach(t),ps=u(o),pt=s(o,"H2",{class:!0});var js=a(pt);It=s(js,"A",{id:!0,class:!0,href:!0});var kl=a(It);Cn=s(kl,"SPAN",{});var wl=a(Cn);k(Mo.$$.fragment,wl),wl.forEach(t),kl.forEach(t),Zr=u(js),En=s(js,"SPAN",{});var $l=a(En);Xr=l($l,"FlaxOPTForCausalLM"),$l.forEach(t),js.forEach(t),us=u(o),S=s(o,"DIV",{class:!0});var ce=a(S);k(xo.$$.fragment,ce),Yr=u(ce),qn=s(ce,"P",{});var Pl=a(qn);Qr=l(Pl,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ns.forEach(t),li=u(ce),jn=s(ce,"P",{});var Ml=a(jn);di=l(Ml,"Finally, this model supports inherent JAX features such as:"),Ml.forEach(t),ci=u(ce),Le=s(ce,"UL",{});var Ut=a(Le);Ln=s(Ut,"LI",{});var xl=a(Ln);qo=s(xl,"A",{href:!0,rel:!0});var zl=a(qo);pi=l(zl,"Just-In-Time (JIT) compilation"),zl.forEach(t),xl.forEach(t),ui=u(Ut),Nn=s(Ut,"LI",{});var Cl=a(Nn);jo=s(Cl,"A",{href:!0,rel:!0});var El=a(jo);hi=l(El,"Automatic Differentiation"),El.forEach(t),Cl.forEach(t),mi=u(Ut),In=s(Ut,"LI",{});var ql=a(In);Lo=s(ql,"A",{href:!0,rel:!0});var jl=a(Lo);fi=l(jl,"Vectorization"),jl.forEach(t),ql.forEach(t),gi=u(Ut),Sn=s(Ut,"LI",{});var Ll=a(Sn);No=s(Ll,"A",{href:!0,rel:!0});var Nl=a(No);_i=l(Nl,"Parallelization"),Nl.forEach(t),Ll.forEach(t),Ut.forEach(t),Ti=u(ce),St=s(ce,"DIV",{class:!0});var Is=a(St);k(Io.$$.fragment,Is),vi=u(Is),k(At.$$.fragment,Is),Is.forEach(t),ce.forEach(t),this.h()},h(){m(d,"name","hf:doc:metadata"),m(d,"content",JSON.stringify(ad)),m(c,"id","opt"),m(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(c,"href","#opt"),m(h,"class","relative group"),m(K,"id","overview"),m(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(K,"href","#overview"),m(M,"class","relative group"),m(Y,"href","https://arxiv.org/pdf/2205.01068"),m(Y,"rel","nofollow"),m(N,"href","/docs/transformers/pr_18123/en/model_doc/auto#transformers.AutoTokenizer"),m(me,"href","https://huggingface.co/ArthurZ"),m(me,"rel","nofollow"),m(Bt,"href","https://huggingface.co/ybelkada"),m(Bt,"rel","nofollow"),m(Vt,"href","https://huggingface.co/patrickvonplaten"),m(Vt,"rel","nofollow"),m(Rt,"href","https://github.com/facebookresearch/metaseq"),m(Rt,"rel","nofollow"),m(ut,"id","transformers.OPTConfig"),m(ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ut,"href","#transformers.OPTConfig"),m(Xe,"class","relative group"),m(Ho,"href","/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTModel"),m(Zt,"href","https://huggingface.co/facebook/opt-350m"),m(Zt,"rel","nofollow"),m(Uo,"href","/docs/transformers/pr_18123/en/main_classes/configuration#transformers.PretrainedConfig"),m(Bo,"href","/docs/transformers/pr_18123/en/main_classes/configuration#transformers.PretrainedConfig"),m(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(mt,"id","transformers.OPTModel"),m(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(mt,"href","#transformers.OPTModel"),m(et,"class","relative group"),m(Vo,"href","/docs/transformers/pr_18123/en/main_classes/model#transformers.PreTrainedModel"),m(to,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(to,"rel","nofollow"),m(Ro,"href","/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTModel"),m(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(_t,"id","transformers.OPTForCausalLM"),m(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(_t,"href","#transformers.OPTForCausalLM"),m(ot,"class","relative group"),m(Tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(bt,"id","transformers.OPTForSequenceClassification"),m(bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(bt,"href","#transformers.OPTForSequenceClassification"),m(st,"class","relative group"),m(Jo,"href","/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTForSequenceClassification"),m(Zo,"href","/docs/transformers/pr_18123/en/main_classes/model#transformers.PreTrainedModel"),m(po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(po,"rel","nofollow"),m(Xo,"href","/docs/transformers/pr_18123/en/model_doc/opt#transformers.OPTForSequenceClassification"),m(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ot,"id","transformers.TFOPTModel"),m(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ot,"href","#transformers.TFOPTModel"),m(rt,"class","relative group"),m(Yo,"href","/docs/transformers/pr_18123/en/main_classes/model#transformers.TFPreTrainedModel"),m(_o,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(_o,"rel","nofollow"),m(Qo,"href","/docs/transformers/pr_18123/en/model_doc/opt#transformers.TFOPTModel"),m(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(zt,"id","transformers.TFOPTForCausalLM"),m(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(zt,"href","#transformers.TFOPTForCausalLM"),m(lt,"class","relative group"),m(en,"href","/docs/transformers/pr_18123/en/main_classes/model#transformers.TFPreTrainedModel"),m(wo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(wo,"rel","nofollow"),m(Et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(jt,"id","transformers.FlaxOPTModel"),m(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(jt,"href","#transformers.FlaxOPTModel"),m(dt,"class","relative group"),m(Lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(It,"id","transformers.FlaxOPTForCausalLM"),m(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(It,"href","#transformers.FlaxOPTForCausalLM"),m(pt,"class","relative group"),m(tn,"href","/docs/transformers/pr_18123/en/main_classes/model#transformers.FlaxPreTrainedModel"),m(Eo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),m(Eo,"rel","nofollow"),m(qo,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),m(qo,"rel","nofollow"),m(jo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),m(jo,"rel","nofollow"),m(Lo,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),m(Lo,"rel","nofollow"),m(No,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),m(No,"rel","nofollow"),m(St,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,d),g(o,v,_),g(o,h,_),e(h,c),e(c,T),w(r,T,null),e(h,f),e(h,z),e(z,$e),g(o,ae,_),g(o,M,_),e(M,K),e(K,W),w(X,W,null),e(M,Pe),e(M,G),e(G,Oe),g(o,Te,_),g(o,A,_),e(A,H),e(A,Y),e(Y,pe),e(A,E),g(o,L,_),g(o,re,_),e(re,Q),g(o,ve,_),g(o,ie,_),e(ie,U),e(U,Fe),g(o,be,_),g(o,j,_),e(j,Me),g(o,J,_),g(o,Z,_),e(Z,ee),e(ee,te),e(ee,ue),e(ue,xe),e(ee,B),e(Z,ze),e(Z,q),e(q,Ce),e(q,b),e(b,x),e(q,he),e(q,Ee),e(Ee,Be),e(q,V),e(q,qe),e(qe,Ve),e(q,Re),e(q,N),e(N,oe),e(q,Ke),g(o,Ae,_),g(o,C,_),e(C,Je),e(C,me),e(me,je),e(C,Ze),e(C,Bt),e(Bt,Ss),e(C,As),e(C,Vt),e(Vt,Ds),e(C,Ws),e(C,Rt),e(Rt,Gs),e(C,Hs),g(o,Xn,_),g(o,Xe,_),e(Xe,ut),e(ut,ln),w(Kt,ln,null),e(Xe,Us),e(Xe,dn),e(dn,Bs),g(o,Yn,_),g(o,fe,_),w(Jt,fe,null),e(fe,Vs),e(fe,Ye),e(Ye,Rs),e(Ye,Ho),e(Ho,Ks),e(Ye,Js),e(Ye,Zt),e(Zt,Zs),e(Ye,Xs),e(fe,Ys),e(fe,Qe),e(Qe,Qs),e(Qe,Uo),e(Uo,ea),e(Qe,ta),e(Qe,Bo),e(Bo,oa),e(Qe,na),e(fe,sa),w(ht,fe,null),g(o,Qn,_),g(o,et,_),e(et,mt),e(mt,cn),w(Xt,cn,null),e(et,aa),e(et,pn),e(pn,ra),g(o,es,_),g(o,ge,_),w(Yt,ge,null),e(ge,ia),e(ge,Qt),e(Qt,la),e(Qt,Vo),e(Vo,da),e(Qt,ca),e(ge,pa),e(ge,eo),e(eo,ua),e(eo,to),e(to,ha),e(eo,ma),e(ge,fa),e(ge,ye),w(oo,ye,null),e(ye,ga),e(ye,tt),e(tt,_a),e(tt,Ro),e(Ro,Ta),e(tt,va),e(tt,un),e(un,ba),e(tt,ya),e(ye,ka),w(ft,ye,null),e(ye,wa),w(gt,ye,null),g(o,ts,_),g(o,ot,_),e(ot,_t),e(_t,hn),w(no,hn,null),e(ot,$a),e(ot,mn),e(mn,Pa),g(o,os,_),g(o,nt,_),w(so,nt,null),e(nt,Oa),e(nt,Tt),w(ao,Tt,null),e(Tt,Fa),w(vt,Tt,null),g(o,ns,_),g(o,st,_),e(st,bt),e(bt,fn),w(ro,fn,null),e(st,Ma),e(st,gn),e(gn,xa),g(o,ss,_),g(o,I,_),w(io,I,null),e(I,za),e(I,_n),e(_n,Ca),e(I,Ea),e(I,Ko),e(Ko,Jo),e(Jo,qa),e(Ko,ja),e(I,La),e(I,_e),e(_e,Na),e(_e,Tn),e(Tn,Ia),e(_e,Sa),e(_e,vn),e(vn,Aa),e(_e,Da),e(_e,bn),e(bn,Wa),e(_e,Ga),e(_e,yn),e(yn,Ha),e(_e,Ua),e(I,Ba),e(I,lo),e(lo,Va),e(lo,Zo),e(Zo,Ra),e(lo,Ka),e(I,Ja),e(I,co),e(co,Za),e(co,po),e(po,Xa),e(co,Ya),e(I,Qa),e(I,D),w(uo,D,null),e(D,er),e(D,at),e(at,tr),e(at,Xo),e(Xo,or),e(at,nr),e(at,kn),e(kn,sr),e(at,ar),e(D,rr),w(yt,D,null),e(D,ir),w(kt,D,null),e(D,lr),w(wt,D,null),e(D,dr),w($t,D,null),e(D,cr),w(Pt,D,null),g(o,as,_),g(o,rt,_),e(rt,Ot),e(Ot,wn),w(ho,wn,null),e(rt,pr),e(rt,$n),e($n,ur),g(o,rs,_),g(o,ne,_),w(mo,ne,null),e(ne,hr),e(ne,fo),e(fo,mr),e(fo,Yo),e(Yo,fr),e(fo,gr),e(ne,_r),e(ne,go),e(go,Tr),e(go,_o),e(_o,vr),e(go,br),e(ne,yr),w(Ft,ne,null),e(ne,kr),e(ne,ke),w(To,ke,null),e(ke,wr),e(ke,it),e(it,$r),e(it,Qo),e(Qo,Pr),e(it,Or),e(it,Pn),e(Pn,Fr),e(it,Mr),e(ke,xr),w(Mt,ke,null),e(ke,zr),w(xt,ke,null),g(o,is,_),g(o,lt,_),e(lt,zt),e(zt,On),w(vo,On,null),e(lt,Cr),e(lt,Fn),e(Fn,Er),g(o,ls,_),g(o,R,_),w(bo,R,null),e(R,qr),e(R,Mn),e(Mn,jr),e(R,Lr),e(R,yo),e(yo,Nr),e(yo,en),e(en,Ir),e(yo,Sr),e(R,Ar),e(R,ko),e(ko,Dr),e(ko,wo),e(wo,Wr),e(ko,Gr),e(R,Hr),w(Ct,R,null),e(R,Ur),e(R,Et),w($o,Et,null),e(Et,Br),w(qt,Et,null),g(o,ds,_),g(o,dt,_),e(dt,jt),e(jt,xn),w(Po,xn,null),e(dt,Vr),e(dt,zn),e(zn,Rr),g(o,cs,_),g(o,ct,_),w(Oo,ct,null),e(ct,Kr),e(ct,Lt),w(Fo,Lt,null),e(Lt,Jr),w(Nt,Lt,null),g(o,ps,_),g(o,pt,_),e(pt,It),e(It,Cn),w(Mo,Cn,null),e(pt,Zr),e(pt,En),e(En,Xr),g(o,us,_),g(o,S,_),w(xo,S,null),e(S,Yr),e(S,qn),e(qn,Qr),e(S,ei),e(S,zo),e(zo,ti),e(zo,tn),e(tn,oi),e(zo,ni),e(S,si),e(S,Co),e(Co,ai),e(Co,Eo),e(Eo,ri),e(Co,ii),e(S,li),e(S,jn),e(jn,di),e(S,ci),e(S,Le),e(Le,Ln),e(Ln,qo),e(qo,pi),e(Le,ui),e(Le,Nn),e(Nn,jo),e(jo,hi),e(Le,mi),e(Le,In),e(In,Lo),e(Lo,fi),e(Le,gi),e(Le,Sn),e(Sn,No),e(No,_i),e(S,Ti),e(S,St),w(Io,St,null),e(St,vi),w(At,St,null),hs=!0},p(o,[_]){const So={};_&2&&(So.$$scope={dirty:_,ctx:o}),ht.$set(So);const An={};_&2&&(An.$$scope={dirty:_,ctx:o}),ft.$set(An);const Dn={};_&2&&(Dn.$$scope={dirty:_,ctx:o}),gt.$set(Dn);const Wn={};_&2&&(Wn.$$scope={dirty:_,ctx:o}),vt.$set(Wn);const Ao={};_&2&&(Ao.$$scope={dirty:_,ctx:o}),yt.$set(Ao);const Gn={};_&2&&(Gn.$$scope={dirty:_,ctx:o}),kt.$set(Gn);const Hn={};_&2&&(Hn.$$scope={dirty:_,ctx:o}),wt.$set(Hn);const Un={};_&2&&(Un.$$scope={dirty:_,ctx:o}),$t.$set(Un);const Do={};_&2&&(Do.$$scope={dirty:_,ctx:o}),Pt.$set(Do);const Bn={};_&2&&(Bn.$$scope={dirty:_,ctx:o}),Ft.$set(Bn);const Vn={};_&2&&(Vn.$$scope={dirty:_,ctx:o}),Mt.$set(Vn);const Rn={};_&2&&(Rn.$$scope={dirty:_,ctx:o}),xt.$set(Rn);const Kn={};_&2&&(Kn.$$scope={dirty:_,ctx:o}),Ct.$set(Kn);const Jn={};_&2&&(Jn.$$scope={dirty:_,ctx:o}),qt.$set(Jn);const Wo={};_&2&&(Wo.$$scope={dirty:_,ctx:o}),Nt.$set(Wo);const Go={};_&2&&(Go.$$scope={dirty:_,ctx:o}),At.$set(Go)},i(o){hs||($(r.$$.fragment,o),$(X.$$.fragment,o),$(Kt.$$.fragment,o),$(Jt.$$.fragment,o),$(ht.$$.fragment,o),$(Xt.$$.fragment,o),$(Yt.$$.fragment,o),$(oo.$$.fragment,o),$(ft.$$.fragment,o),$(gt.$$.fragment,o),$(no.$$.fragment,o),$(so.$$.fragment,o),$(ao.$$.fragment,o),$(vt.$$.fragment,o),$(ro.$$.fragment,o),$(io.$$.fragment,o),$(uo.$$.fragment,o),$(yt.$$.fragment,o),$(kt.$$.fragment,o),$(wt.$$.fragment,o),$($t.$$.fragment,o),$(Pt.$$.fragment,o),$(ho.$$.fragment,o),$(mo.$$.fragment,o),$(Ft.$$.fragment,o),$(To.$$.fragment,o),$(Mt.$$.fragment,o),$(xt.$$.fragment,o),$(vo.$$.fragment,o),$(bo.$$.fragment,o),$(Ct.$$.fragment,o),$($o.$$.fragment,o),$(qt.$$.fragment,o),$(Po.$$.fragment,o),$(Oo.$$.fragment,o),$(Fo.$$.fragment,o),$(Nt.$$.fragment,o),$(Mo.$$.fragment,o),$(xo.$$.fragment,o),$(Io.$$.fragment,o),$(At.$$.fragment,o),hs=!0)},o(o){P(r.$$.fragment,o),P(X.$$.fragment,o),P(Kt.$$.fragment,o),P(Jt.$$.fragment,o),P(ht.$$.fragment,o),P(Xt.$$.fragment,o),P(Yt.$$.fragment,o),P(oo.$$.fragment,o),P(ft.$$.fragment,o),P(gt.$$.fragment,o),P(no.$$.fragment,o),P(so.$$.fragment,o),P(ao.$$.fragment,o),P(vt.$$.fragment,o),P(ro.$$.fragment,o),P(io.$$.fragment,o),P(uo.$$.fragment,o),P(yt.$$.fragment,o),P(kt.$$.fragment,o),P(wt.$$.fragment,o),P($t.$$.fragment,o),P(Pt.$$.fragment,o),P(ho.$$.fragment,o),P(mo.$$.fragment,o),P(Ft.$$.fragment,o),P(To.$$.fragment,o),P(Mt.$$.fragment,o),P(xt.$$.fragment,o),P(vo.$$.fragment,o),P(bo.$$.fragment,o),P(Ct.$$.fragment,o),P($o.$$.fragment,o),P(qt.$$.fragment,o),P(Po.$$.fragment,o),P(Oo.$$.fragment,o),P(Fo.$$.fragment,o),P(Nt.$$.fragment,o),P(Mo.$$.fragment,o),P(xo.$$.fragment,o),P(Io.$$.fragment,o),P(At.$$.fragment,o),hs=!1},d(o){t(d),o&&t(v),o&&t(h),O(r),o&&t(ae),o&&t(M),O(X),o&&t(Te),o&&t(A),o&&t(L),o&&t(re),o&&t(ve),o&&t(ie),o&&t(be),o&&t(j),o&&t(J),o&&t(Z),o&&t(Ae),o&&t(C),o&&t(Xn),o&&t(Xe),O(Kt),o&&t(Yn),o&&t(fe),O(Jt),O(ht),o&&t(Qn),o&&t(et),O(Xt),o&&t(es),o&&t(ge),O(Yt),O(oo),O(ft),O(gt),o&&t(ts),o&&t(ot),O(no),o&&t(os),o&&t(nt),O(so),O(ao),O(vt),o&&t(ns),o&&t(st),O(ro),o&&t(ss),o&&t(I),O(io),O(uo),O(yt),O(kt),O(wt),O($t),O(Pt),o&&t(as),o&&t(rt),O(ho),o&&t(rs),o&&t(ne),O(mo),O(Ft),O(To),O(Mt),O(xt),o&&t(is),o&&t(lt),O(vo),o&&t(ls),o&&t(R),O(bo),O(Ct),O($o),O(qt),o&&t(ds),o&&t(dt),O(Po),o&&t(cs),o&&t(ct),O(Oo),O(Fo),O(Nt),o&&t(ps),o&&t(pt),O(Mo),o&&t(us),o&&t(S),O(xo),O(Io),O(At)}}}const ad={local:"opt",sections:[{local:"overview",title:"Overview"},{local:"transformers.OPTConfig",title:"OPTConfig"},{local:"transformers.OPTModel",title:"OPTModel"},{local:"transformers.OPTForCausalLM",title:"OPTForCausalLM"},{local:"transformers.OPTForSequenceClassification",title:"OPTForSequenceClassification"},{local:"transformers.TFOPTModel",title:"TFOPTModel"},{local:"transformers.TFOPTForCausalLM",title:"TFOPTForCausalLM"},{local:"transformers.FlaxOPTModel",title:"FlaxOPTModel"},{local:"transformers.FlaxOPTForCausalLM",title:"FlaxOPTForCausalLM"}],title:"OPT"};function rd(F){return Wl(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class hd extends Il{constructor(d){super();Sl(this,d,rd,sd,Al,{})}}export{hd as default,ad as metadata};
