...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(r,m){f(r,d,m),e(d,y),e(d,_),e(_,c),e(d,v)},d(r){r&&t(d)}}}function di(C){let d,y,_,c,v;return c=new yo({props:{code:`from transformers import OPTTokenizer, OPTModel
import torch
