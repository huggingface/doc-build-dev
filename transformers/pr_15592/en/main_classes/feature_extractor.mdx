...
<docstring><name>class transformers.FeatureExtractionMixin</name><anchor>transformers.FeatureExtractionMixin</anchor><source>https://github.com/huggingface/transformers/blob/pr_15592/src/transformers/feature_extraction_utils.py#L202</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters></docstring>
