import{S as hT,i as fT,s as gT,e as r,k as c,w as v,t as n,Y as Oo,M as uT,c as a,d as t,m as p,a as i,x as T,h as s,Z as Po,b as _,G as e,g as f,y,q as $,o as L,B as x,v as _T,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ae}from"../../chunks/Tip-hf-doc-builder.js";import{D as Q}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Le}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ce}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function wT(M){let l,k,m,h,b;return h=new Le({props:{code:`from transformers import LongformerConfig, LongformerModel
...
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,m,F),f(w,h,F),e(h,b),e(b,d),e(h,u),e(h,E),e(E,me),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,B),e(B,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(m),w&&t(h),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function AT(M){let l,k,m,h,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var E=i(m);h=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=p(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=p(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=a(I,"CODE",{});var ke=i(B);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=p(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,m,F),f(w,h,F),e(h,b),e(b,d),e(h,u),e(h,E),e(E,me),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,B),e(B,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(m),w&&t(h),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function ST(M){let l,k,m,h,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var E=i(m);h=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-number">0.44</span>`}}),{c(){v(l.$$.fragment)},l(m){T(l.$$.fragment,m)},m(m,h){y(l,m,h),k=!0},p:je,i(m){k||($(l.$$.fragment,m),k=!0)},o(m){L(l.$$.fragment,m),k=!1},d(m){x(l,m)}}}function QT(M){let l,k,m,h,b,d,u,E,me,J,z,Z,S,ee,he,D,fe,le,G,P,te,X,q,j,ne,U,de,se,W,ge,ce,C,ue,B,re,K,H,ae,_e,N,ie,R,we;return{c(){l=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),m=c(),h=r("ul"),b=r("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=r("p"),Z=n("This second option is useful when using "),S=r("code"),ee=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=r("ul"),j=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ge=n("model(inputs_ids)"),ce=c(),C=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){l=a(w,"P",{});var F=i(l);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),m=p(w),h=a(w,"UL",{});var Y=i(h);b=a(Y,"LI",{});var Te=i(b);d=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),u=p(Y),E=a(Y,"LI",{});var pe=i(E);me=s(pe,"having all inputs as a list, tuple or dict in the first positional arguments."),pe.forEach(t),Y.forEach(t),J=p(w),z=a(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=a(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(t),he=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=p(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=p(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=a(I,"CODE",{});var ke=i(B);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=p(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,m,F),f(w,h,F),e(h,b),e(b,d),e(h,u),e(h,E),e(E,me),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,B),e(B,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(m),w&&t(h),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function BT(M){let l,k,m,h,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var E=i(m);h=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=p(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=p(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=a(I,"CODE",{});var ke=i(B);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=p(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,m,F),f(w,h,F),e(h,b),e(b,d),e(h,u),e(h,E),e(E,me),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,B),e(B,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(m),w&&t(h),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function VT(M){let l,k,m,h,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var E=i(m);h=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=p(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=p(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=a(I,"CODE",{});var ke=i(B);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=p(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,m,F),f(w,h,F),e(h,b),e(b,d),e(h,u),e(h,E),e(E,me),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,B),e(B,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(m),w&&t(h),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function XT(M){let l,k,m,h,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var E=i(m);h=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=p(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=p(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=a(I,"CODE",{});var ke=i(B);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=p(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,m,F),f(w,h,F),e(h,b),e(b,d),e(h,u),e(h,E),e(E,me),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,B),e(B,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(m),w&&t(h),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function ty(M){let l,k,m,h,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var E=i(m);h=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Whether or not to return a <a href="/docs/transformers/pr_17814/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_longformer.py#L1616",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.LongformerConfig"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_longformer.py#L1759",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_longformer.py#L1868",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_longformer.py#L2223",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_longformer.py#L2137",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
`}}),pn=new Ae({props:{$$slots:{default:[qT]},$$scope:{ctx:M}}}),mn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[CT]},$$scope:{ctx:M}}}),hn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[jT]},$$scope:{ctx:M}}}),Zs=new Oe({}),er=new Q({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_longformer.py#L1996",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17814/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_tf_longformer.py#L2101",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_tf_longformer.py#L2196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_tf_longformer.py#L2347",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_tf_longformer.py#L2587",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17814/src/transformers/models/longformer/modeling_tf_longformer.py#L2456",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17814/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
`),w=r("code"),F=n("</s>"),Y=n(")."),Te=c(),pe=r("p"),A=n("This model was contributed by "),be=r("a"),xe=n("beltagy"),Fe=n(". The Authors\u2019 code can be found "),O=r("a"),V=n("here"),Me=n("."),ye=c(),I=r("h2"),ke=r("a"),ve=r("span"),v(oe.$$.fragment),Ee=c(),ti=r("span"),Qp=n("Longformer Self Attention"),fd=c(),$e=r("p"),Bp=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
trained and should be used as follows:`),Wd=c(),v(Jn.$$.fragment),Qd=c(),Pt=r("h2"),Do=r("a"),hi=r("span"),v(Xn.$$.fragment),Tm=c(),fi=r("span"),ym=n("LongformerConfig"),Bd=c(),He=r("div"),v(Yn.$$.fragment),$m=c(),Nt=r("p"),Lm=n("This is the configuration class to store the configuration of a "),Yr=r("a"),xm=n("LongformerModel"),Fm=n(" or a "),Zr=r("a"),Mm=n("TFLongformerModel"),Em=n(`. It
...
parent class for more information.`),Qm=c(),v(Wo.$$.fragment),Ud=c(),St=r("h2"),Qo=r("a"),gi=r("span"),v(es.$$.fragment),Bm=c(),ui=r("span"),Um=n("LongformerTokenizer"),Hd=c(),gt=r("div"),v(ts.$$.fragment),Hm=c(),_i=r("p"),Rm=n("Construct a Longformer tokenizer."),Vm=c(),Bo=r("p"),na=r("a"),Gm=n("LongformerTokenizer"),Km=n(" is identical to "),sa=r("a"),Jm=n("RobertaTokenizer"),Xm=n(`. Refer to the superclass for usage examples and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tg=c(),Ne=r("div"),v(Ds.$$.fragment),og=c(),lo=r("p"),ng=n("The "),ha=r("a"),sg=n("LongformerForSequenceClassification"),rg=n(" forward method, overrides the "),Ji=r("code"),ag=n("__call__"),ig=n(" special method."),lg=c(),v(tn.$$.fragment),dg=c(),v(on.$$.fragment),cg=c(),v(nn.$$.fragment),pg=c(),v(sn.$$.fragment),mg=c(),v(rn.$$.fragment),gc=c(),co=r("h2"),an=r("a"),Xi=r("span"),v(Ws.$$.fragment),hg=c(),Yi=r("span"),fg=n("LongformerForMultipleChoice"),uc=c(),Ge=r("div"),v(Qs.$$.fragment),gg=c(),Zi=r("p"),ug=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ak=c(),v(Wn.$$.fragment),ik=c(),lt=r("div"),v(Br.$$.fragment),lk=c(),zo=r("p"),dk=n("The "),Ca=r("a"),ck=n("TFLongformerForMultipleChoice"),pk=n(" forward method, overrides the "),Pl=r("code"),mk=n("__call__"),hk=n(" special method."),fk=c(),v(Qn.$$.fragment),gk=c(),v(Bn.$$.fragment),this.h()},l(o){const g=uT('[data-svelte="svelte-1phssyn"]',document.head);l=a(g,"META",{name:!0,content:!0}),g.forEach(t),k=p(o),m=a(o,"H1",{class:!0});var Ur=i(m);h=a(Ur,"A",{id:!0,class:!0,href:!0});var Nl=i(h);b=a(Nl,"SPAN",{});var Al=i(b);T(d.$$.fragment,Al),Al.forEach(t),Nl.forEach(t),u=p(Ur),E=a(Ur,"SPAN",{});var Il=i(E);me=s(Il,"Longformer"),Il.forEach(t),Ur.forEach(t),J=p(o),z=a(o,"H2",{class:!0});var Hr=i(z);Z=a(Hr,"A",{id:!0,class:!0,href:!0});var Sl=i(Z);S=a(Sl,"SPAN",{});var Dl=i(S);T(ee.$$.fragment,Dl),Dl.forEach(t),Sl.forEach(t),he=p(Hr),D=a(Hr,"SPAN",{});var Wl=i(D);fe=s(Wl,"Overview"),Wl.forEach(t),Hr.forEach(t),le=p(o),G=a(o,"P",{});var Rr=i(G);P=s(Rr,"The Longformer model was presented in "),te=a(Rr,"A",{href:!0,rel:!0});var Ql=i(te);X=s(Ql,"Longformer: The Long-Document Transformer"),Ql.forEach(t),q=s(Rr," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Rr.forEach(t),j=p(o),ne=a(o,"P",{});var Bl=i(ne);U=s(Bl,"The abstract from the paper is the following:"),Bl.forEach(t),de=p(o),se=a(o,"P",{});var Ul=i(se);W=a(Ul,"EM",{});var Hl=i(W);ge=s(Hl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
trained and should be used as follows:`),pd.forEach(t),Wd=p(o),T(Jn.$$.fragment,o),Qd=p(o),Pt=a(o,"H2",{class:!0});var Ac=i(Pt);Do=a(Ac,"A",{id:!0,class:!0,href:!0});var yk=i(Do);hi=a(yk,"SPAN",{});var $k=i(hi);T(Xn.$$.fragment,$k),$k.forEach(t),yk.forEach(t),Tm=p(Ac),fi=a(Ac,"SPAN",{});var Lk=i(fi);ym=s(Lk,"LongformerConfig"),Lk.forEach(t),Ac.forEach(t),Bd=p(o),He=a(o,"DIV",{class:!0});var Tt=i(He);T(Yn.$$.fragment,Tt),$m=p(Tt),Nt=a(Tt,"P",{});var ja=i(Nt);Lm=s(ja,"This is the configuration class to store the configuration of a "),Yr=a(ja,"A",{href:!0});var xk=i(Yr);xm=s(xk,"LongformerModel"),xk.forEach(t),Fm=s(ja," or a "),Zr=a(ja,"A",{href:!0});var Fk=i(Zr);Mm=s(Fk,"TFLongformerModel"),Fk.forEach(t),Em=s(ja,`. It
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dp.forEach(t),qf=p(yt),Be=a(yt,"DIV",{class:!0});var dt=i(Be);T(Os.$$.fragment,dt),Cf=p(dt),ao=a(dt,"P",{});var Da=i(ao);jf=s(Da,"The "),pa=a(Da,"A",{href:!0});var $b=i(pa);Of=s($b,"LongformerForMaskedLM"),$b.forEach(t),Pf=s(Da," forward method, overrides the "),Hi=a(Da,"CODE",{});var Lb=i(Hi);Nf=s(Lb,"__call__"),Lb.forEach(t),Af=s(Da," special method."),Da.forEach(t),If=p(dt),T(Xo.$$.fragment,dt),Sf=p(dt),T(Yo.$$.fragment,dt),Df=p(dt),Ri=a(dt,"P",{});var xb=i(Ri);Wf=s(xb,"Let\u2019s try a very long input."),xb.forEach(t),Qf=p(dt),T(Zo.$$.fragment,dt),dt.forEach(t),yt.forEach(t),hc=p(o),io=a(o,"H2",{class:!0});var cp=i(io);en=a(cp,"A",{id:!0,class:!0,href:!0});var Fb=i(en);Vi=a(Fb,"SPAN",{});var Mb=i(Vi);T(Ps.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),Bf=p(cp),Gi=a(cp,"SPAN",{});var Eb=i(Gi);Uf=s(Eb,"LongformerForSequenceClassification"),Eb.forEach(t),cp.forEach(t),fc=p(o),Ve=a(o,"DIV",{class:!0});var $t=i(Ve);T(Ns.$$.fragment,$t),Hf=p($t),Ki=a($t,"P",{});var zb=i(Ki);Rf=s(zb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gp.forEach(t),Lg=p(Lt),at=a(Lt,"DIV",{class:!0});var Hn=i(at);T(Rs.$$.fragment,Hn),xg=p(Hn),po=a(Hn,"P",{});var Qa=i(po);Fg=s(Qa,"The "),ga=a(Qa,"A",{href:!0});var Wb=i(ga);Mg=s(Wb,"LongformerForMultipleChoice"),Wb.forEach(t),Eg=s(Qa," forward method, overrides the "),el=a(Qa,"CODE",{});var Qb=i(el);zg=s(Qb,"__call__"),Qb.forEach(t),qg=s(Qa," special method."),Qa.forEach(t),Cg=p(Hn),T(ln.$$.fragment,Hn),jg=p(Hn),T(dn.$$.fragment,Hn),Hn.forEach(t),Lt.forEach(t),_c=p(o),mo=a(o,"H2",{class:!0});var up=i(mo);cn=a(up,"A",{id:!0,class:!0,href:!0});var Bb=i(cn);tl=a(Bb,"SPAN",{});var Ub=i(tl);T(Vs.$$.fragment,Ub),Ub.forEach(t),Bb.forEach(t),Og=p(up),ol=a(up,"SPAN",{});var Hb=i(ol);Pg=s(Hb,"LongformerForTokenClassification"),Hb.forEach(t),up.forEach(t),wc=p(o),Ke=a(o,"DIV",{class:!0});var xt=i(Ke);T(Gs.$$.fragment,xt),Ng=p(xt),nl=a(xt,"P",{});var Rb=i(nl);Ag=s(Rb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Su=p(Ue),T(wn.$$.fragment,Ue),Du=p(Ue),wo=a(Ue,"P",{});var Ra=i(wo);Wu=s(Ra,"This class copies code from "),va=a(Ra,"A",{href:!0});var mv=i(va);Qu=s(mv,"TFRobertaModel"),mv.forEach(t),Bu=s(Ra,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qp.forEach(t),W_=p(pt),yr=a(pt,"P",{});var Cp=i(yr);Q_=s(Cp,"This model is also a "),$r=a(Cp,"A",{href:!0,rel:!0});var qv=i($r);B_=s(qv,"tf.keras.Model"),qv.forEach(t),U_=s(Cp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),fw=p(mt),T(qn.$$.fragment,mt),gw=p(mt),tt=a(mt,"DIV",{class:!0});var qt=i(tt);T(qr.$$.fragment,qt),uw=p(qt),xo=a(qt,"P",{});var Ya=i(xo);_w=s(Ya,"The "),Ma=a(Ya,"A",{href:!0});var Dv=i(Ma);ww=s(Dv,"TFLongformerForSequenceClassification"),Dv.forEach(t),kw=s(Ya," forward method, overrides the "),Fl=a(Ya,"CODE",{});var Wv=i(Fl);bw=s(Wv,"__call__"),Wv.forEach(t),vw=s(Ya," special method."),Ya.forEach(t),Tw=p(qt),T(Cn.$$.fragment,qt),yw=p(qt),T(jn.$$.fragment,qt),$w=p(qt),T(On.$$.fragment,qt),qt.forEach(t),mt.forEach(t),Ec=p(o),Fo=a(o,"H2",{class:!0});var Np=i(Fo);Pn=a(Np,"A",{id:!0,class:!0,href:!0});var Qv=i(Pn);Ml=a(Qv,"SPAN",{});var Bv=i(Ml);T(Cr.$$.fragment,Bv),Bv.forEach(t),Qv.forEach(t),Lw=p(Np),El=a(Np,"SPAN",{});var Uv=i(El);xw=s(Uv,"TFLongformerForTokenClassification"),Uv.forEach(t),Np.forEach(t),zc=p(o),We=a(o,"DIV",{class:!0});var ht=i(We);T(jr.$$.fragment,ht),Fw=p(ht),zl=a(ht,"P",{});var Hv=i(zl);Mw=s(Hv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ip.forEach(t),Aw=p(ht),T(Nn.$$.fragment,ht),Iw=p(ht),ot=a(ht,"DIV",{class:!0});var Ct=i(ot);T(Ar.$$.fragment,Ct),Sw=p(Ct),Mo=a(Ct,"P",{});var Za=i(Mo);Dw=s(Za,"The "),za=a(Za,"A",{href:!0});var Gv=i(za);Ww=s(Gv,"TFLongformerForTokenClassification"),Gv.forEach(t),Qw=s(Za," forward method, overrides the "),ql=a(Za,"CODE",{});var Kv=i(ql);Bw=s(Kv,"__call__"),Kv.forEach(t),Uw=s(Za," special method."),Za.forEach(t),Hw=p(Ct),T(An.$$.fragment,Ct),Rw=p(Ct),T(In.$$.fragment,Ct),Vw=p(Ct),T(Sn.$$.fragment,Ct),Ct.forEach(t),ht.forEach(t),qc=p(o),Eo=a(o,"H2",{class:!0});var Sp=i(Eo);Dn=a(Sp,"A",{id:!0,class:!0,href:!0});var Jv=i(Dn);Cl=a(Jv,"SPAN",{});var Xv=i(Cl);T(Ir.$$.fragment,Xv),Xv.forEach(t),Jv.forEach(t),Gw=p(Sp),jl=a(Sp,"SPAN",{});var Yv=i(jl);Kw=s(Yv,"TFLongformerForMultipleChoice"),Yv.forEach(t),Sp.forEach(t),Cc=p(o),Qe=a(o,"DIV",{class:!0});var ft=i(Qe);T(Sr.$$.fragment,ft),Jw=p(ft),Ol=a(ft,"P",{});var Zv=i(Ol);Xw=s(Zv,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
