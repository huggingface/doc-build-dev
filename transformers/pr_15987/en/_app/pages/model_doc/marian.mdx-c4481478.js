import{S as nf,i as of,s as sf,e as o,k as d,w as k,t as r,M as af,c as s,d as t,m as l,a,x as v,h as i,b as c,F as e,g as h,y as T,q as M,o as b,B as y}from"../../chunks/vendor-4833417e.js";import{T as pn}from"../../chunks/Tip-fffd6df1.js";import{D as V}from"../../chunks/Docstring-4f315ed9.js";import{C as je}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as he}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function rf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var j=a(f);_=i(j,"Module"),j.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function lf(C){let u,z,f,_,w,x,g,j,Le,ue,E,ke,X,Se,Q,ee,Oe,$e,G,L,Ee,I,q,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),_=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),j=o("li"),Le=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ke=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Oe=r("model(inputs)"),$e=r("."),G=d(),L=o("p"),Ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),O=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var $=a(u);z=i($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=l(m),_=s(m,"UL",{});var be=a(_);w=s(be,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),g=l(be),j=s(be,"LI",{});var ye=a(j);Le=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),ue=l(m),E=s(m,"P",{});var D=a(E);ke=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Se=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=s(D,"CODE",{});var at=a(ee);Oe=i(at,"model(inputs)"),at.forEach(t),$e=i(D,"."),D.forEach(t),G=l(m),L=s(m,"P",{});var We=a(L);Ee=i(We,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),A.forEach(t)},m(m,$){h(m,u,$),e(u,z),h(m,f,$),h(m,_,$),e(_,w),e(w,x),e(_,g),e(_,j),e(j,Le),h(m,ue,$),h(m,E,$),e(E,ke),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,$e),h(m,G,$),h(m,L,$),e(L,Ee),h(m,I,$),h(m,q,$),e(q,F),e(F,te),e(F,ne),e(ne,ve),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(E),m&&t(G),m&&t(L),m&&t(I),m&&t(q)}}}function cf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var j=a(f);_=i(j,"Module"),j.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function pf(C){let u,z,f,_,w,x,g,j,Le,ue,E,ke,X,Se,Q,ee,Oe,$e,G,L,Ee,I,q,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),_=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),j=o("li"),Le=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ke=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Oe=r("model(inputs)"),$e=r("."),G=d(),L=o("p"),Ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),I=d(),q=o("ul"),F=o("li"),te=r("a single Tensor with "),ne=o("code"),ve=r("input_ids"),He=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),Te=d(),N=o("li"),De=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=o("code"),Me=r("model([input_ids, attention_mask])"),se=r(" or "),ae=o("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),Ue=d(),S=o("li"),Re=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var $=a(u);z=i($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=l(m),_=s(m,"UL",{});var be=a(_);w=s(be,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),g=l(be),j=s(be,"LI",{});var ye=a(j);Le=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),ue=l(m),E=s(m,"P",{});var D=a(E);ke=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Se=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
...
first positional argument :`),We.forEach(t),I=l(m),q=s(m,"UL",{});var A=a(q);F=s(A,"LI",{});var ie=a(F);te=i(ie,"a single Tensor with "),ne=s(ie,"CODE",{});var rt=a(ne);ve=i(rt,"input_ids"),rt.forEach(t),He=i(ie," only and nothing else: "),J=s(ie,"CODE",{});var Be=a(J);P=i(Be,"model(input_ids)"),Be.forEach(t),ie.forEach(t),Te=l(A),N=s(A,"LI",{});var U=a(N);De=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(A),S=s(A,"LI",{});var de=a(S);Re=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),A.forEach(t)},m(m,$){h(m,u,$),e(u,z),h(m,f,$),h(m,_,$),e(_,w),e(w,x),e(_,g),e(_,j),e(j,Le),h(m,ue,$),h(m,E,$),e(E,ke),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,$e),h(m,G,$),h(m,L,$),e(L,Ee),h(m,I,$),h(m,q,$),e(q,F),e(F,te),e(F,ne),e(ne,ve),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(E),m&&t(G),m&&t(L),m&&t(I),m&&t(q)}}}function hf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var j=a(f);_=i(j,"Module"),j.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var j=a(f);_=i(j,"Module"),j.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function ff(C){let u,z,f,_,w,x,g,j,Le,ue,E,ke,X,Se,Q,ee,Oe,$e,G,L,Ee,I,q,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H,m,$,be,ot,ye,D,st,at,We,A,ie,rt,Be,U,it,dt,de,xe,wi,Xo,zi,ji,$i,lt,hn,Ei,Ps,qi,Pi,Fi,un,Ni,Fs,Ci,Ii,Ai,ct,Li,Ns,Si,Oi,Cs,Hi,Di,Ui,Is,mn,Ri,As,Wi,Bi,Vi,Ls,fn,Gi,_n,Ji,Yi,er,pt,Ct,Ss,gn,Ki,Os,Zi,tr,qe,Qo,Xi,Hs,Qi,ed,kn,td,vn,nd,od,sd,ht,ad,Ds,rd,id,Us,dd,ld,cd,Rs,pd,nr,ut,It,Ws,Tn,hd,Bs,ud,or,Je,Vs,md,fd,Gs,Mn,_d,gd,Js,bn,kd,sr,mt,At,Ys,yn,vd,Ks,Td,ar,Pe,xn,Md,Zs,bd,yd,xd,wn,wd,Xs,zd,jd,$d,zn,Ed,jn,qd,Pd,Fd,$n,Nd,Qs,Cd,Id,rr,Lt,Ad,En,Ld,Sd,ir,qn,dr,es,Od,lr,Pn,cr,ft,St,ea,Fn,Hd,ta,Dd,pr,ts,Ud,hr,Nn,ur,ns,Rd,mr,Cn,fr,_t,Ot,na,In,Wd,oa,Bd,_r,le,An,Vd,gt,Gd,os,Jd,Yd,Ln,Kd,Zd,Xd,kt,Qd,ss,el,tl,as,nl,ol,sl,sa,al,rl,Sn,gr,vt,Ht,aa,On,il,ra,dl,kr,R,Hn,ll,Dn,cl,Un,pl,hl,ul,Rn,ml,rs,fl,_l,gl,ia,kl,vl,Wn,Tl,Dt,Bn,Ml,da,bl,vr,Tt,Ut,la,Vn,yl,ca,xl,Tr,we,Gn,wl,Jn,zl,is,jl,$l,El,Yn,ql,Kn,Pl,Fl,Nl,me,Zn,Cl,Mt,Il,ds,Al,Ll,pa,Sl,Ol,Hl,Rt,Dl,ha,Ul,Rl,Xn,Mr,bt,Wt,ua,Qn,Wl,ma,Bl,br,ze,eo,Vl,to,Gl,ls,Jl,Yl,Kl,no,Zl,oo,Xl,Ql,ec,Y,so,tc,yt,nc,cs,oc,sc,fa,ac,rc,ic,Bt,dc,ao,lc,ro,cc,pc,hc,_a,uc,mc,io,yr,xt,Vt,ga,lo,fc,ka,_c,xr,wt,co,gc,Ye,po,kc,va,vc,Tc,ho,wr,zt,Gt,Ta,uo,Mc,Ma,bc,zr,ce,mo,yc,fo,xc,ps,wc,zc,jc,_o,$c,go,Ec,qc,Pc,Jt,Fc,fe,ko,Nc,jt,Cc,hs,Ic,Ac,ba,Lc,Sc,Oc,Yt,Hc,ya,Dc,Uc,vo,jr,$t,Kt,xa,To,Rc,wa,Wc,$r,pe,Mo,Bc,bo,Vc,us,Gc,Jc,Yc,yo,Kc,xo,Zc,Xc,Qc,Zt,ep,K,wo,tp,Et,np,ms,op,sp,za,ap,rp,ip,Xt,dp,zo,lp,jo,cp,pp,hp,ja,up,mp,$o,Er,qt,Qt,$a,Eo,fp,Ea,_p,qr,W,qo,gp,Po,kp,fs,vp,Tp,Mp,Fo,bp,No,yp,xp,wp,qa,zp,jp,Ve,Pa,Co,$p,Ep,Fa,Io,qp,Pp,Na,Ao,Fp,Np,Ca,Lo,Cp,Ip,_e,So,Ap,Pt,Lp,Ia,Sp,Op,Aa,Hp,Dp,Up,en,Rp,La,Wp,Bp,Oo,Pr,Ft,tn,Sa,Ho,Vp,Oa,Gp,Fr,B,Do,Jp,Uo,Yp,_s,Kp,Zp,Xp,Ro,Qp,Wo,eh,th,nh,Ha,oh,sh,Ge,Da,Bo,ah,rh,Ua,Vo,ih,dh,Ra,Go,lh,ch,Wa,Jo,ph,hh,ge,Yo,uh,Nt,mh,Ba,fh,_h,Va,gh,kh,vh,nn,Th,Ga,Mh,bh,Ko,Nr;return x=new he({}),te=new he({}),gn=new he({}),Tn=new he({}),yn=new he({}),qn=new je({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
[<span class="hljs-string">&quot;c&#x27;est une phrase en anglais que nous voulons traduire en fran\xE7ais&quot;</span>,
 ...
 <span class="hljs-string">&#x27;Y esto al espa\xF1ol&#x27;</span>]`}}),Pn=new je({props:{code:`from huggingface_hub import list_models
...
old_style_multi_models = [<span class="hljs-string">f&quot;<span class="hljs-subst">{org}</span>/<span class="hljs-subst">{s}</span>&quot;</span> <span class="hljs-keyword">for</span> s <span class="hljs-keyword">in</span> suffix <span class="hljs-keyword">if</span> s != s.lower()]`}}),Fn=new he({}),Nn=new je({props:{code:`['Helsinki-NLP/opus-mt-NORTH_EU-NORTH_EU',
...
}`}}),Cn=new je({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),Sn=new je({props:{code:`from transformers import MarianModel, MarianConfig
...
`}}),Rt=new pn({props:{$$slots:{default:[rf]},$$scope:{ctx:C}}}),Xn=new je({props:{code:`from transformers import MarianTokenizer, MarianModel
...
`}}),Bt=new pn({props:{$$slots:{default:[df]},$$scope:{ctx:C}}}),io=new je({props:{code:`from transformers import MarianTokenizer, MarianMTModel
...
<span class="hljs-string">&quot;Where&#x27;s the bus stop?&quot;</span>`}}),lo=new he({}),co=new V({props:{name:"class transformers.MarianForCausalLM",anchor:"transformers.MarianForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/marian/modeling_marian.py#L1407"}}),po=new V({props:{name:"forward",anchor:"transformers.MarianForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/marian/modeling_marian.py#L1438",parametersDescription:[{anchor:"transformers.MarianForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),ho=new je({props:{code:`from transformers import MarianTokenizer, MarianForCausalLM
...
`}}),Yt=new pn({props:{$$slots:{default:[cf]},$$scope:{ctx:C}}}),vo=new je({props:{code:`from transformers import MarianTokenizer, TFMarianModel
...
`}}),Xt=new pn({props:{$$slots:{default:[hf]},$$scope:{ctx:C}}}),$o=new je({props:{code:`from transformers import MarianTokenizer, TFMarianMTModel
...
`}}),en=new pn({props:{$$slots:{default:[uf]},$$scope:{ctx:C}}}),Oo=new je({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
`}}),nn=new pn({props:{$$slots:{default:[mf]},$$scope:{ctx:C}}}),Ko=new je({props:{code:`from transformers import MarianTokenizer, FlaxMarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){u=o("meta"),z=d(),f=o("h1"),_=o("a"),w=o("span"),k(x.$$.fragment),g=d(),j=o("span"),Le=r("MarianMT"),ue=d(),E=o("p"),ke=o("strong"),X=r("Bugs:"),Se=r(" If you see something strange, file a "),Q=o("a"),ee=r("Github Issue"),Oe=r(`
and assign @patrickvonplaten.`),$e=d(),G=o("p"),L=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),Ee=d(),I=o("h2"),q=o("a"),F=o("span"),k(te.$$.fragment),ne=d(),ve=o("span"),He=r("Implementation Notes"),J=d(),P=o("ul"),Te=o("li"),N=o("p"),De=r("Each model is about 298 MB on disk, there are more than 1,000 models."),oe=d(),Me=o("li"),se=o("p"),ae=r("The list of supported language pairs can be found "),re=o("a"),Ue=r("here"),S=r("."),Re=d(),O=o("li"),H=o("p"),m=r("Models were originally trained by "),$=o("a"),be=r("J\xF6rg Tiedemann"),ot=r(" using the "),ye=o("a"),D=r("Marian"),st=r(" C++ library, which supports fast training and translation."),at=d(),We=o("li"),A=o("p"),ie=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),rt=d(),Be=o("li"),U=o("p"),it=r("The 80 opus models that require BPE preprocessing are not supported."),dt=d(),de=o("li"),xe=o("p"),wi=r("The modeling code is the same as "),Xo=o("a"),zi=r("BartForConditionalGeneration"),ji=r(" with a few minor modifications:"),$i=d(),lt=o("ul"),hn=o("li"),Ei=r("static (sinusoid) positional embeddings ("),Ps=o("code"),qi=r("MarianConfig.static_position_embeddings=True"),Pi=r(")"),Fi=d(),un=o("li"),Ni=r("no layernorm_embedding ("),Fs=o("code"),Ci=r("MarianConfig.normalize_embedding=False"),Ii=r(")"),Ai=d(),ct=o("li"),Li=r("the model starts generating with "),Ns=o("code"),Si=r("pad_token_id"),Oi=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
...
language to the `),Xs=o("code"),zd=r("src_text"),jd=r("."),$d=d(),zn=o("li"),Ed=r("You can see a models\u2019s supported language codes in its model card, under target constituents, like in "),jn=o("a"),qd=r("opus-mt-en-roa"),Pd=r("."),Fd=d(),$n=o("li"),Nd=r("Note that if a model is only multilingual on the source side, like "),Qs=o("code"),Cd=r("Helsinki-NLP/opus-mt-roa-en"),Id=r(`, no language
...
This model inherits from `),is=o("a"),jl=r("PreTrainedModel"),$l=r(`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc=d(),_o=o("p"),$c=r("This model is also a "),go=o("a"),Ec=r("tf.keras.Model"),qc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pc=d(),k(Jt.$$.fragment),Fc=d(),fe=o("div"),k(ko.$$.fragment),Nc=d(),jt=o("p"),Cc=r("The "),hs=o("a"),Ic=r("TFMarianModel"),Ac=r(" forward method, overrides the "),ba=o("code"),Lc=r("__call__"),Sc=r(" special method."),Oc=d(),k(Yt.$$.fragment),Hc=d(),ya=o("p"),Dc=r("Example:"),Uc=d(),k(vo.$$.fragment),jr=d(),$t=o("h2"),Kt=o("a"),xa=o("span"),k(To.$$.fragment),Rc=d(),wa=o("span"),Wc=r("TFMarianMTModel"),$r=d(),pe=o("div"),k(Mo.$$.fragment),Bc=d(),bo=o("p"),Vc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
models are listed `),jo=o("a"),cp=r("here"),pp=r("."),hp=d(),ja=o("p"),up=r("Examples:"),mp=d(),k($o.$$.fragment),Er=d(),qt=o("h2"),Qt=o("a"),$a=o("span"),k(Eo.$$.fragment),fp=d(),Ea=o("span"),_p=r("FlaxMarianModel"),qr=d(),W=o("div"),k(qo.$$.fragment),gp=d(),Po=o("p"),kp=r(`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),nh=d(),Ha=o("p"),oh=r("Finally, this model supports inherent JAX features such as:"),sh=d(),Ge=o("ul"),Da=o("li"),Bo=o("a"),ah=r("Just-In-Time (JIT) compilation"),rh=d(),Ua=o("li"),Vo=o("a"),ih=r("Automatic Differentiation"),dh=d(),Ra=o("li"),Go=o("a"),lh=r("Vectorization"),ch=d(),Wa=o("li"),Jo=o("a"),ph=r("Parallelization"),hh=d(),ge=o("div"),k(Yo.$$.fragment),uh=d(),Nt=o("p"),mh=r("The "),Ba=o("code"),fh=r("FlaxMarianPreTrainedModel"),_h=r("forward method, overrides the "),Va=o("code"),gh=r("__call__"),kh=r(" special method."),vh=d(),k(nn.$$.fragment),Th=d(),Ga=o("p"),Mh=r("Example:"),bh=d(),k(Ko.$$.fragment),this.h()},l(n){const p=af('[data-svelte="svelte-1phssyn"]',document.head);u=s(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(n),f=s(n,"H1",{class:!0});var Zo=a(f);_=s(Zo,"A",{id:!0,class:!0,href:!0});var Ja=a(_);w=s(Ja,"SPAN",{});var Ya=a(w);v(x.$$.fragment,Ya),Ya.forEach(t),Ja.forEach(t),g=l(Zo),j=s(Zo,"SPAN",{});var Ka=a(j);Le=i(Ka,"MarianMT"),Ka.forEach(t),Zo.forEach(t),ue=l(n),E=s(n,"P",{});var on=a(E);ke=s(on,"STRONG",{});var Za=a(ke);X=i(Za,"Bugs:"),Za.forEach(t),Se=i(on," If you see something strange, file a "),Q=s(on,"A",{href:!0,rel:!0});var Xa=a(Q);ee=i(Xa,"Github Issue"),Xa.forEach(t),Oe=i(on,`
and assign @patrickvonplaten.`),on.forEach(t),$e=l(n),G=s(n,"P",{});var Qa=a(G);L=i(Qa,"Translations should be similar, but not identical to output in the test set linked to in each model card."),Qa.forEach(t),Ee=l(n),I=s(n,"H2",{class:!0});var Cr=a(I);q=s(Cr,"A",{id:!0,class:!0,href:!0});var xh=a(q);F=s(xh,"SPAN",{});var wh=a(F);v(te.$$.fragment,wh),wh.forEach(t),xh.forEach(t),ne=l(Cr),ve=s(Cr,"SPAN",{});var zh=a(ve);He=i(zh,"Implementation Notes"),zh.forEach(t),Cr.forEach(t),J=l(n),P=s(n,"UL",{});var Z=a(P);Te=s(Z,"LI",{});var jh=a(Te);N=s(jh,"P",{});var $h=a(N);De=i($h,"Each model is about 298 MB on disk, there are more than 1,000 models."),$h.forEach(t),jh.forEach(t),oe=l(Z),Me=s(Z,"LI",{});var Eh=a(Me);se=s(Eh,"P",{});var Ir=a(se);ae=i(Ir,"The list of supported language pairs can be found "),re=s(Ir,"A",{href:!0,rel:!0});var qh=a(re);Ue=i(qh,"here"),qh.forEach(t),S=i(Ir,"."),Ir.forEach(t),Eh.forEach(t),Re=l(Z),O=s(Z,"LI",{});var Ph=a(O);H=s(Ph,"P",{});var gs=a(H);m=i(gs,"Models were originally trained by "),$=s(gs,"A",{href:!0,rel:!0});var Fh=a($);be=i(Fh,"J\xF6rg Tiedemann"),Fh.forEach(t),ot=i(gs," using the "),ye=s(gs,"A",{href:!0,rel:!0});var Nh=a(ye);D=i(Nh,"Marian"),Nh.forEach(t),st=i(gs," C++ library, which supports fast training and translation."),gs.forEach(t),Ph.forEach(t),at=l(Z),We=s(Z,"LI",{});var Ch=a(We);A=s(Ch,"P",{});var Ih=a(A);ie=i(Ih,`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),Ih.forEach(t),Ch.forEach(t),rt=l(Z),Be=s(Z,"LI",{});var Ah=a(Be);U=s(Ah,"P",{});var Lh=a(U);it=i(Lh,"The 80 opus models that require BPE preprocessing are not supported."),Lh.forEach(t),Ah.forEach(t),dt=l(Z),de=s(Z,"LI",{});var Ar=a(de);xe=s(Ar,"P",{});var Lr=a(xe);wi=i(Lr,"The modeling code is the same as "),Xo=s(Lr,"A",{href:!0});var Sh=a(Xo);zi=i(Sh,"BartForConditionalGeneration"),Sh.forEach(t),ji=i(Lr," with a few minor modifications:"),Lr.forEach(t),$i=l(Ar),lt=s(Ar,"UL",{});var ks=a(lt);hn=s(ks,"LI",{});var Sr=a(hn);Ei=i(Sr,"static (sinusoid) positional embeddings ("),Ps=s(Sr,"CODE",{});var Oh=a(Ps);qi=i(Oh,"MarianConfig.static_position_embeddings=True"),Oh.forEach(t),Pi=i(Sr,")"),Sr.forEach(t),Fi=l(ks),un=s(ks,"LI",{});var Or=a(un);Ni=i(Or,"no layernorm_embedding ("),Fs=s(Or,"CODE",{});var Hh=a(Fs);Ci=i(Hh,"MarianConfig.normalize_embedding=False"),Hh.forEach(t),Ii=i(Or,")"),Or.forEach(t),Ai=l(ks),ct=s(ks,"LI",{});var vs=a(ct);Li=i(vs,"the model starts generating with "),Ns=s(vs,"CODE",{});var Dh=a(Ns);Si=i(Dh,"pad_token_id"),Dh.forEach(t),Oi=i(vs,` (which has 0 as a token_embedding) as the prefix (Bart uses
...
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),Ln=s(bs,"A",{href:!0,rel:!0});var ju=a(Ln);Kd=i(ju,"Helsinki-NLP/opus-mt-en-de"),ju.forEach(t),Zd=i(bs," architecture."),bs.forEach(t),Xd=l(Ke),kt=s(Ke,"P",{});var ys=a(kt);Qd=i(ys,"Configuration objects inherit from "),ss=s(ys,"A",{href:!0});var $u=a(ss);el=i($u,"PretrainedConfig"),$u.forEach(t),tl=i(ys,` and can be used to control the model outputs. Read the
...
This model inherits from `),is=s(si,"A",{href:!0});var Du=a(is);jl=i(Du,"PreTrainedModel"),Du.forEach(t),$l=i(si,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ui.forEach(t),jc=l(Xe),_o=s(Xe,"P",{});var mi=a(_o);$c=i(mi,"This model is also a "),go=s(mi,"A",{href:!0,rel:!0});var lm=a(go);Ec=i(lm,"tf.keras.Model"),lm.forEach(t),qc=i(mi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mi.forEach(t),Pc=l(Xe),v(Jt.$$.fragment,Xe),Fc=l(Xe),fe=s(Xe,"DIV",{class:!0});var Qe=a(fe);v(ko.$$.fragment,Qe),Nc=l(Qe),jt=s(Qe,"P",{});var js=a(jt);Cc=i(js,"The "),hs=s(js,"A",{href:!0});var cm=a(hs);Ic=i(cm,"TFMarianModel"),cm.forEach(t),Ac=i(js," forward method, overrides the "),ba=s(js,"CODE",{});var pm=a(ba);Lc=i(pm,"__call__"),pm.forEach(t),Sc=i(js," special method."),js.forEach(t),Oc=l(Qe),v(Yt.$$.fragment,Qe),Hc=l(Qe),ya=s(Qe,"P",{});var hm=a(ya);Dc=i(hm,"Example:"),hm.forEach(t),Uc=l(Qe),v(vo.$$.fragment,Qe),Qe.forEach(t),Xe.forEach(t),jr=l(n),$t=s(n,"H2",{class:!0});var fi=a($t);Kt=s(fi,"A",{id:!0,class:!0,href:!0});var um=a(Kt);xa=s(um,"SPAN",{});var mm=a(xa);v(To.$$.fragment,mm),mm.forEach(t),um.forEach(t),Rc=l(fi),wa=s(fi,"SPAN",{});var fm=a(wa);Wc=i(fm,"TFMarianMTModel"),fm.forEach(t),fi.forEach(t),$r=l(n),pe=s(n,"DIV",{class:!0});var et=a(pe);v(Mo.$$.fragment,et),Bc=l(et),bo=s(et,"P",{});var _i=a(bo);Vc=i(_i,`The MARIAN Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gi.forEach(t),Qc=l(et),v(Zt.$$.fragment,et),ep=l(et),K=s(et,"DIV",{class:!0});var Ce=a(K);v(wo.$$.fragment,Ce),tp=l(Ce),Et=s(Ce,"P",{});var $s=a(Et);np=i($s,"The "),ms=s($s,"A",{href:!0});var km=a(ms);op=i(km,"TFMarianMTModel"),km.forEach(t),sp=i($s," forward method, overrides the "),za=s($s,"CODE",{});var vm=a(za);ap=i(vm,"__call__"),vm.forEach(t),rp=i($s," special method."),$s.forEach(t),ip=l(Ce),v(Xt.$$.fragment,Ce),dp=l(Ce),zo=s(Ce,"P",{});var ki=a(zo);lp=i(ki,`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),jo=s(ki,"A",{href:!0,rel:!0});var Tm=a(jo);cp=i(Tm,"here"),Tm.forEach(t),pp=i(ki,"."),ki.forEach(t),hp=l(Ce),ja=s(Ce,"P",{});var Mm=a(ja);up=i(Mm,"Examples:"),Mm.forEach(t),mp=l(Ce),v($o.$$.fragment,Ce),Ce.forEach(t),et.forEach(t),Er=l(n),qt=s(n,"H2",{class:!0});var vi=a(qt);Qt=s(vi,"A",{id:!0,class:!0,href:!0});var bm=a(Qt);$a=s(bm,"SPAN",{});var ym=a($a);v(Eo.$$.fragment,ym),ym.forEach(t),bm.forEach(t),fp=l(vi),Ea=s(vi,"SPAN",{});var xm=a(Ea);_p=i(xm,"FlaxMarianModel"),xm.forEach(t),vi.forEach(t),qr=l(n),W=s(n,"DIV",{class:!0});var Ie=a(W);v(qo.$$.fragment,Ie),gp=l(Ie),Po=s(Ie,"P",{});var Ti=a(Po);kp=i(Ti,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
