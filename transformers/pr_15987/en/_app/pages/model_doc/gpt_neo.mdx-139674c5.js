...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var $=a(m);k=i($,"Module"),$.forEach(o),N=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,w),e(p,m),e(m,k),e(p,N)},d(g){g&&o(p)}}}function rd(O){let p,w,m,k,N,g,f,$,Jn,ln,oe,Te,ro,Ie,Rn,io,Xn,dn,J,Kn,Ae,Qn,Yn,Le,Zn,es,cn,Lt,ts,pn,ve,os,Se,ns,ss,hn,ne,ye,lo,De,as,co,rs,un,Pe,is,po,ls,ds,mn,Be,fn,se,be,ho,Oe,cs,uo,ps,gn,z,We,hs,ae,us,St,ms,fs,Ue,gs,_s,Ts,re,vs,Dt,ys,Ps,Bt,bs,ks,ws,mo,Ns,$s,He,_n,ie,ke,fo,Ve,Gs,go,xs,Tn,F,Je,Ms,_o,Es,zs,Re,Fs,Ot,qs,Cs,js,Xe,Is,Ke,As,Ls,Ss,C,Qe,Ds,le,Bs,Wt,Os,Ws,To,Us,Hs,Vs,we,Js,vo,Rs,Xs,Ye,vn,de,Ne,yo,Ze,Ks,Po,Qs,yn,q,et,Ys,bo,Zs,ea,tt,ta,Ut,oa,na,sa,ot,aa,nt,ra,ia,la,j,st,da,ce,ca,Ht,pa,ha,ko,ua,ma,fa,$e,ga,wo,_a,Ta,at,Pn,pe,Ge,No,rt,va,$o,ya,bn,G,it,Pa,Go,ba,ka,Vt,Jt,wa,Na,$a,W,Ga,xo,xa,Ma,Mo,Ea,za,Eo,Fa,qa,zo,Ca,ja,Ia,lt,Aa,Rt,La,Sa,Da,dt,Ba,ct,Oa,Wa,Ua,E,pt,Ha,he,Va,Xt,Ja,Ra,Fo,Xa,Ka,Qa,xe,Ya,qo,Za,er,ht,tr,Co,or,nr,ut,kn,ue,Me,jo,mt,sr,Io,ar,wn,x,ft,rr,Ao,ir,lr,gt,dr,Kt,cr,pr,hr,_t,ur,Tt,mr,fr,gr,Lo,_r,Tr,U,So,vt,vr,yr,Do,yt,Pr,br,Bo,Pt,kr,wr,Oo,bt,Nr,$r,I,kt,Gr,me,xr,Wo,Mr,Er,Uo,zr,Fr,qr,Ee,Cr,Ho,jr,Ir,wt,Nn,fe,ze,Vo,Nt,Ar,Jo,Lr,$n,M,$t,Sr,Ro,Dr,Br,Gt,Or,Qt,Wr,Ur,Hr,xt,Vr,Mt,Jr,Rr,Xr,Xo,Kr,Qr,H,Ko,Et,Yr,Zr,Qo,zt,ei,ti,Yo,Ft,oi,ni,Zo,qt,si,ai,A,Ct,ri,ge,ii,en,li,di,tn,ci,pi,hi,Fe,ui,on,mi,fi,jt,Gn;return g=new _e({}),Ie=new _e({}),De=new _e({}),Be=new je({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}]}}),He=new je({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=n("meta"),w=d(),m=n("h1"),k=n("a"),N=n("span"),_(g.$$.fragment),f=d(),$=n("span"),Jn=r("GPT Neo"),ln=d(),oe=n("h2"),Te=n("a"),ro=n("span"),_(Ie.$$.fragment),Rn=d(),io=n("span"),Xn=r("Overview"),dn=d(),J=n("p"),Kn=r("The GPTNeo model was released in the "),Ae=n("a"),Qn=r("EleutherAI/gpt-neo"),Yn=r(` repository by Sid
...
`),Ue=n("a"),gs=r("gpt-neo-1.3B"),_s=r(" architecture."),Ts=d(),re=n("p"),vs=r("Configuration objects inherit from "),Dt=n("a"),ys=r("PretrainedConfig"),Ps=r(` and can be used to control the model outputs. Read the
documentation from `),Bt=n("a"),bs=r("PretrainedConfig"),ks=r(" for more information."),ws=d(),mo=n("p"),Ns=r("Example:"),$s=d(),_(He.$$.fragment),_n=d(),ie=n("h2"),ke=n("a"),fo=n("span"),_(Ve.$$.fragment),Gs=d(),go=n("span"),xs=r("GPTNeoModel"),Tn=d(),F=n("div"),_(Je.$$.fragment),Ms=d(),_o=n("p"),Es=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),zs=d(),Re=n("p"),Fs=r("This model inherits from "),Ot=n("a"),qs=r("PreTrainedModel"),Cs=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),js=d(),Xe=n("p"),Is=r("This model is also a PyTorch "),Ke=n("a"),As=r("torch.nn.Module"),Ls=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ss=d(),C=n("div"),_(Qe.$$.fragment),Ds=d(),le=n("p"),Bs=r("The "),Wt=n("a"),Os=r("GPTNeoModel"),Ws=r(" forward method, overrides the "),To=n("code"),Us=r("__call__"),Hs=r(" special method."),Vs=d(),_(we.$$.fragment),Js=d(),vo=n("p"),Rs=r("Example:"),Xs=d(),_(Ye.$$.fragment),vn=d(),de=n("h2"),Ne=n("a"),yo=n("span"),_(Ze.$$.fragment),Ks=d(),Po=n("span"),Qs=r("GPTNeoForCausalLM"),yn=d(),q=n("div"),_(et.$$.fragment),Ys=d(),bo=n("p"),Zs=r(`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),ea=d(),tt=n("p"),ta=r("This model inherits from "),Ut=n("a"),oa=r("PreTrainedModel"),na=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sa=d(),ot=n("p"),aa=r("This model is also a PyTorch "),nt=n("a"),ra=r("torch.nn.Module"),ia=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),la=d(),j=n("div"),_(st.$$.fragment),da=d(),ce=n("p"),ca=r("The "),Ht=n("a"),pa=r("GPTNeoForCausalLM"),ha=r(" forward method, overrides the "),ko=n("code"),ua=r("__call__"),ma=r(" special method."),fa=d(),_($e.$$.fragment),ga=d(),wo=n("p"),_a=r("Example:"),Ta=d(),_(at.$$.fragment),Pn=d(),pe=n("h2"),Ge=n("a"),No=n("span"),_(rt.$$.fragment),va=d(),$o=n("span"),ya=r("GPTNeoForSequenceClassification"),bn=d(),G=n("div"),_(it.$$.fragment),Pa=d(),Go=n("p"),ba=r("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ka=d(),Vt=n("p"),Jt=n("a"),wa=r("GPTNeoForSequenceClassification"),Na=r(` uses the last token in order to do the classification, as other causal models
...
each row of the batch).`),Ia=d(),lt=n("p"),Aa=r("This model inherits from "),Rt=n("a"),La=r("PreTrainedModel"),Sa=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Da=d(),dt=n("p"),Ba=r("This model is also a PyTorch "),ct=n("a"),Oa=r("torch.nn.Module"),Wa=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ua=d(),E=n("div"),_(pt.$$.fragment),Ha=d(),he=n("p"),Va=r("The "),Xt=n("a"),Ja=r("GPTNeoForSequenceClassification"),Ra=r(" forward method, overrides the "),Fo=n("code"),Xa=r("__call__"),Ka=r(" special method."),Qa=d(),_(xe.$$.fragment),Ya=d(),qo=n("p"),Za=r("Example of single-label classification:"),er=d(),_(ht.$$.fragment),tr=d(),Co=n("p"),or=r("Example of multi-label classification:"),nr=d(),_(ut.$$.fragment),kn=d(),ue=n("h2"),Me=n("a"),jo=n("span"),_(mt.$$.fragment),sr=d(),Io=n("span"),ar=r("FlaxGPTNeoModel"),wn=d(),x=n("div"),_(ft.$$.fragment),rr=d(),Ao=n("p"),ir=r("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),lr=d(),gt=n("p"),dr=r("This model inherits from "),Kt=n("a"),cr=r("FlaxPreTrainedModel"),pr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hr=d(),_t=n("p"),ur=r(`This model is also a Flax Linen
`),Tt=n("a"),mr=r("flax.nn.Module"),fr=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gr=d(),Lo=n("p"),_r=r("Finally, this model supports inherent JAX features such as:"),Tr=d(),U=n("ul"),So=n("li"),vt=n("a"),vr=r("Just-In-Time (JIT) compilation"),yr=d(),Do=n("li"),yt=n("a"),Pr=r("Automatic Differentiation"),br=d(),Bo=n("li"),Pt=n("a"),kr=r("Vectorization"),wr=d(),Oo=n("li"),bt=n("a"),Nr=r("Parallelization"),$r=d(),I=n("div"),_(kt.$$.fragment),Gr=d(),me=n("p"),xr=r("The "),Wo=n("code"),Mr=r("FlaxGPTNeoPreTrainedModel"),Er=r("forward method, overrides the "),Uo=n("code"),zr=r("__call__"),Fr=r(" special method."),qr=d(),_(Ee.$$.fragment),Cr=d(),Ho=n("p"),jr=r("Example:"),Ir=d(),_(wt.$$.fragment),Nn=d(),fe=n("h2"),ze=n("a"),Vo=n("span"),_(Nt.$$.fragment),Ar=d(),Jo=n("span"),Lr=r("FlaxGPTNeoForCausalLM"),$n=d(),M=n("div"),_($t.$$.fragment),Sr=d(),Ro=n("p"),Dr=r(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Br=d(),Gt=n("p"),Or=r("This model inherits from "),Qt=n("a"),Wr=r("FlaxPreTrainedModel"),Ur=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hr=d(),xt=n("p"),Vr=r(`This model is also a Flax Linen
`),Mt=n("a"),Jr=r("flax.nn.Module"),Rr=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Xr=d(),Xo=n("p"),Kr=r("Finally, this model supports inherent JAX features such as:"),Qr=d(),H=n("ul"),Ko=n("li"),Et=n("a"),Yr=r("Just-In-Time (JIT) compilation"),Zr=d(),Qo=n("li"),zt=n("a"),ei=r("Automatic Differentiation"),ti=d(),Yo=n("li"),Ft=n("a"),oi=r("Vectorization"),ni=d(),Zo=n("li"),qt=n("a"),si=r("Parallelization"),ai=d(),A=n("div"),_(Ct.$$.fragment),ri=d(),ge=n("p"),ii=r("The "),en=n("code"),li=r("FlaxGPTNeoPreTrainedModel"),di=r("forward method, overrides the "),tn=n("code"),ci=r("__call__"),pi=r(" special method."),hi=d(),_(Fe.$$.fragment),ui=d(),on=n("p"),mi=r("Example:"),fi=d(),_(jt.$$.fragment),this.h()},l(t){const h=ed('[data-svelte="svelte-1phssyn"]',document.head);p=s(h,"META",{name:!0,content:!0}),h.forEach(o),w=c(t),m=s(t,"H1",{class:!0});var It=a(m);k=s(It,"A",{id:!0,class:!0,href:!0});var nn=a(k);N=s(nn,"SPAN",{});var sn=a(N);T(g.$$.fragment,sn),sn.forEach(o),nn.forEach(o),f=c(It),$=s(It,"SPAN",{});var an=a($);Jn=i(an,"GPT Neo"),an.forEach(o),It.forEach(o),ln=c(t),oe=s(t,"H2",{class:!0});var At=a(oe);Te=s(At,"A",{id:!0,class:!0,href:!0});var _i=a(Te);ro=s(_i,"SPAN",{});var Ti=a(ro);T(Ie.$$.fragment,Ti),Ti.forEach(o),_i.forEach(o),Rn=c(At),io=s(At,"SPAN",{});var vi=a(io);Xn=i(vi,"Overview"),vi.forEach(o),At.forEach(o),dn=c(t),J=s(t,"P",{});var Yt=a(J);Kn=i(Yt,"The GPTNeo model was released in the "),Ae=s(Yt,"A",{href:!0,rel:!0});var yi=a(Ae);Qn=i(yi,"EleutherAI/gpt-neo"),yi.forEach(o),Yn=i(Yt,` repository by Sid
Black, Stella Biderman, Leo Gao, Phil Wang and Connor Leahy. It is a GPT2 like causal language model trained on the
...
Neo model according to the specified arguments, defining the model architecture. Instantiating a configuration with
the defaults will yield a similar configuration to that of the GPTNeo
`),Ue=s(Zt,"A",{href:!0,rel:!0});var Fi=a(Ue);gs=i(Fi,"gpt-neo-1.3B"),Fi.forEach(o),_s=i(Zt," architecture."),Zt.forEach(o),Ts=c(R),re=s(R,"P",{});var eo=a(re);vs=i(eo,"Configuration objects inherit from "),Dt=s(eo,"A",{href:!0});var qi=a(Dt);ys=i(qi,"PretrainedConfig"),qi.forEach(o),Ps=i(eo,` and can be used to control the model outputs. Read the
documentation from `),Bt=s(eo,"A",{href:!0});var Ci=a(Bt);bs=i(Ci,"PretrainedConfig"),Ci.forEach(o),ks=i(eo," for more information."),eo.forEach(o),ws=c(R),mo=s(R,"P",{});var ji=a(mo);Ns=i(ji,"Example:"),ji.forEach(o),$s=c(R),T(He.$$.fragment,R),R.forEach(o),_n=c(t),ie=s(t,"H2",{class:!0});var Fn=a(ie);ke=s(Fn,"A",{id:!0,class:!0,href:!0});var Ii=a(ke);fo=s(Ii,"SPAN",{});var Ai=a(fo);T(Ve.$$.fragment,Ai),Ai.forEach(o),Ii.forEach(o),Gs=c(Fn),go=s(Fn,"SPAN",{});var Li=a(go);xs=i(Li,"GPTNeoModel"),Li.forEach(o),Fn.forEach(o),Tn=c(t),F=s(t,"DIV",{class:!0});var X=a(F);T(Je.$$.fragment,X),Ms=c(X),_o=s(X,"P",{});var Si=a(_o);Es=i(Si,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Si.forEach(o),zs=c(X),Re=s(X,"P",{});var qn=a(Re);Fs=i(qn,"This model inherits from "),Ot=s(qn,"A",{href:!0});var Di=a(Ot);qs=i(Di,"PreTrainedModel"),Di.forEach(o),Cs=i(qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qn.forEach(o),js=c(X),Xe=s(X,"P",{});var Cn=a(Xe);Is=i(Cn,"This model is also a PyTorch "),Ke=s(Cn,"A",{href:!0,rel:!0});var Bi=a(Ke);As=i(Bi,"torch.nn.Module"),Bi.forEach(o),Ls=i(Cn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cn.forEach(o),Ss=c(X),C=s(X,"DIV",{class:!0});var K=a(C);T(Qe.$$.fragment,K),Ds=c(K),le=s(K,"P",{});var to=a(le);Bs=i(to,"The "),Wt=s(to,"A",{href:!0});var Oi=a(Wt);Os=i(Oi,"GPTNeoModel"),Oi.forEach(o),Ws=i(to," forward method, overrides the "),To=s(to,"CODE",{});var Wi=a(To);Us=i(Wi,"__call__"),Wi.forEach(o),Hs=i(to," special method."),to.forEach(o),Vs=c(K),T(we.$$.fragment,K),Js=c(K),vo=s(K,"P",{});var Ui=a(vo);Rs=i(Ui,"Example:"),Ui.forEach(o),Xs=c(K),T(Ye.$$.fragment,K),K.forEach(o),X.forEach(o),vn=c(t),de=s(t,"H2",{class:!0});var jn=a(de);Ne=s(jn,"A",{id:!0,class:!0,href:!0});var Hi=a(Ne);yo=s(Hi,"SPAN",{});var Vi=a(yo);T(Ze.$$.fragment,Vi),Vi.forEach(o),Hi.forEach(o),Ks=c(jn),Po=s(jn,"SPAN",{});var Ji=a(Po);Qs=i(Ji,"GPTNeoForCausalLM"),Ji.forEach(o),jn.forEach(o),yn=c(t),q=s(t,"DIV",{class:!0});var Q=a(q);T(et.$$.fragment,Q),Ys=c(Q),bo=s(Q,"P",{});var Ri=a(bo);Zs=i(Ri,`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Ri.forEach(o),ea=c(Q),tt=s(Q,"P",{});var In=a(tt);ta=i(In,"This model inherits from "),Ut=s(In,"A",{href:!0});var Xi=a(Ut);oa=i(Xi,"PreTrainedModel"),Xi.forEach(o),na=i(In,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),In.forEach(o),sa=c(Q),ot=s(Q,"P",{});var An=a(ot);aa=i(An,"This model is also a PyTorch "),nt=s(An,"A",{href:!0,rel:!0});var Ki=a(nt);ra=i(Ki,"torch.nn.Module"),Ki.forEach(o),ia=i(An,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),An.forEach(o),la=c(Q),j=s(Q,"DIV",{class:!0});var Y=a(j);T(st.$$.fragment,Y),da=c(Y),ce=s(Y,"P",{});var oo=a(ce);ca=i(oo,"The "),Ht=s(oo,"A",{href:!0});var Qi=a(Ht);pa=i(Qi,"GPTNeoForCausalLM"),Qi.forEach(o),ha=i(oo," forward method, overrides the "),ko=s(oo,"CODE",{});var Yi=a(ko);ua=i(Yi,"__call__"),Yi.forEach(o),ma=i(oo," special method."),oo.forEach(o),fa=c(Y),T($e.$$.fragment,Y),ga=c(Y),wo=s(Y,"P",{});var Zi=a(wo);_a=i(Zi,"Example:"),Zi.forEach(o),Ta=c(Y),T(at.$$.fragment,Y),Y.forEach(o),Q.forEach(o),Pn=c(t),pe=s(t,"H2",{class:!0});var Ln=a(pe);Ge=s(Ln,"A",{id:!0,class:!0,href:!0});var el=a(Ge);No=s(el,"SPAN",{});var tl=a(No);T(rt.$$.fragment,tl),tl.forEach(o),el.forEach(o),va=c(Ln),$o=s(Ln,"SPAN",{});var ol=a($o);ya=i(ol,"GPTNeoForSequenceClassification"),ol.forEach(o),Ln.forEach(o),bn=c(t),G=s(t,"DIV",{class:!0});var L=a(G);T(it.$$.fragment,L),Pa=c(L),Go=s(L,"P",{});var nl=a(Go);ba=i(nl,"The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),nl.forEach(o),ka=c(L),Vt=s(L,"P",{});var gi=a(Vt);Jt=s(gi,"A",{href:!0});var sl=a(Jt);wa=i(sl,"GPTNeoForSequenceClassification"),sl.forEach(o),Na=i(gi,` uses the last token in order to do the classification, as other causal models
...
each row of the batch).`),Z.forEach(o),Ia=c(L),lt=s(L,"P",{});var Sn=a(lt);Aa=i(Sn,"This model inherits from "),Rt=s(Sn,"A",{href:!0});var dl=a(Rt);La=i(dl,"PreTrainedModel"),dl.forEach(o),Sa=i(Sn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wn.forEach(o),gr=c(D),Lo=s(D,"P",{});var Pl=a(Lo);_r=i(Pl,"Finally, this model supports inherent JAX features such as:"),Pl.forEach(o),Tr=c(D),U=s(D,"UL",{});var qe=a(U);So=s(qe,"LI",{});var bl=a(So);vt=s(bl,"A",{href:!0,rel:!0});var kl=a(vt);vr=i(kl,"Just-In-Time (JIT) compilation"),kl.forEach(o),bl.forEach(o),yr=c(qe),Do=s(qe,"LI",{});var wl=a(Do);yt=s(wl,"A",{href:!0,rel:!0});var Nl=a(yt);Pr=i(Nl,"Automatic Differentiation"),Nl.forEach(o),wl.forEach(o),br=c(qe),Bo=s(qe,"LI",{});var $l=a(Bo);Pt=s($l,"A",{href:!0,rel:!0});var Gl=a(Pt);kr=i(Gl,"Vectorization"),Gl.forEach(o),$l.forEach(o),wr=c(qe),Oo=s(qe,"LI",{});var xl=a(Oo);bt=s(xl,"A",{href:!0,rel:!0});var Ml=a(bt);Nr=i(Ml,"Parallelization"),Ml.forEach(o),xl.forEach(o),qe.forEach(o),$r=c(D),I=s(D,"DIV",{class:!0});var ee=a(I);T(kt.$$.fragment,ee),Gr=c(ee),me=s(ee,"P",{});var so=a(me);xr=i(so,"The "),Wo=s(so,"CODE",{});var El=a(Wo);Mr=i(El,"FlaxGPTNeoPreTrainedModel"),El.forEach(o),Er=i(so,"forward method, overrides the "),Uo=s(so,"CODE",{});var zl=a(Uo);zr=i(zl,"__call__"),zl.forEach(o),Fr=i(so," special method."),so.forEach(o),qr=c(ee),T(Ee.$$.fragment,ee),Cr=c(ee),Ho=s(ee,"P",{});var Fl=a(Ho);jr=i(Fl,"Example:"),Fl.forEach(o),Ir=c(ee),T(wt.$$.fragment,ee),ee.forEach(o),D.forEach(o),Nn=c(t),fe=s(t,"H2",{class:!0});var Un=a(fe);ze=s(Un,"A",{id:!0,class:!0,href:!0});var ql=a(ze);Vo=s(ql,"SPAN",{});var Cl=a(Vo);T(Nt.$$.fragment,Cl),Cl.forEach(o),ql.forEach(o),Ar=c(Un),Jo=s(Un,"SPAN",{});var jl=a(Jo);Lr=i(jl,"FlaxGPTNeoForCausalLM"),jl.forEach(o),Un.forEach(o),$n=c(t),M=s(t,"DIV",{class:!0});var B=a(M);T($t.$$.fragment,B),Sr=c(B),Ro=s(B,"P",{});var Il=a(Ro);Dr=i(Il,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Il.forEach(o),Br=c(B),Gt=s(B,"P",{});var Hn=a(Gt);Or=i(Hn,"This model inherits from "),Qt=s(Hn,"A",{href:!0});var Al=a(Qt);Wr=i(Al,"FlaxPreTrainedModel"),Al.forEach(o),Ur=i(Hn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hn.forEach(o),Hr=c(B),xt=s(B,"P",{});var Vn=a(xt);Vr=i(Vn,`This model is also a Flax Linen
`),Mt=s(Vn,"A",{href:!0,rel:!0});var Ll=a(Mt);Jr=i(Ll,"flax.nn.Module"),Ll.forEach(o),Rr=i(Vn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vn.forEach(o),Xr=c(B),Xo=s(B,"P",{});var Sl=a(Xo);Kr=i(Sl,"Finally, this model supports inherent JAX features such as:"),Sl.forEach(o),Qr=c(B),H=s(B,"UL",{});var Ce=a(H);Ko=s(Ce,"LI",{});var Dl=a(Ko);Et=s(Dl,"A",{href:!0,rel:!0});var Bl=a(Et);Yr=i(Bl,"Just-In-Time (JIT) compilation"),Bl.forEach(o),Dl.forEach(o),Zr=c(Ce),Qo=s(Ce,"LI",{});var Ol=a(Qo);zt=s(Ol,"A",{href:!0,rel:!0});var Wl=a(zt);ei=i(Wl,"Automatic Differentiation"),Wl.forEach(o),Ol.forEach(o),ti=c(Ce),Yo=s(Ce,"LI",{});var Ul=a(Yo);Ft=s(Ul,"A",{href:!0,rel:!0});var Hl=a(Ft);oi=i(Hl,"Vectorization"),Hl.forEach(o),Ul.forEach(o),ni=c(Ce),Zo=s(Ce,"LI",{});var Vl=a(Zo);qt=s(Vl,"A",{href:!0,rel:!0});var Jl=a(qt);si=i(Jl,"Parallelization"),Jl.forEach(o),Vl.forEach(o),Ce.forEach(o),ai=c(B),A=s(B,"DIV",{class:!0});var te=a(A);T(Ct.$$.fragment,te),ri=c(te),ge=s(te,"P",{});var ao=a(ge);ii=i(ao,"The "),en=s(ao,"CODE",{});var Rl=a(en);li=i(Rl,"FlaxGPTNeoPreTrainedModel"),Rl.forEach(o),di=i(ao,"forward method, overrides the "),tn=s(ao,"CODE",{});var Xl=a(tn);ci=i(Xl,"__call__"),Xl.forEach(o),pi=i(ao," special method."),ao.forEach(o),hi=c(te),T(Fe.$$.fragment,te),ui=c(te),on=s(te,"P",{});var Kl=a(on);mi=i(Kl,"Example:"),Kl.forEach(o),fi=c(te),T(jt.$$.fragment,te),te.forEach(o),B.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(id)),l(k,"id","gpt-neo"),l(k,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(k,"href","#gpt-neo"),l(m,"class","relative group"),l(Te,"id","overview"),l(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Te,"href","#overview"),l(oe,"class","relative group"),l(Ae,"href","https://github.com/EleutherAI/gpt-neo"),l(Ae,"rel","nofollow"),l(Le,"href","https://pile.eleuther.ai/"),l(Le,"rel","nofollow"),l(Se,"href","https://huggingface.co/valhalla"),l(Se,"rel","nofollow"),l(ye,"id","generation"),l(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ye,"href","#generation"),l(ne,"class","relative group"),l(be,"id","transformers.GPTNeoConfig"),l(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(be,"href","#transformers.GPTNeoConfig"),l(se,"class","relative group"),l(St,"href","/docs/transformers/pr_15987/en/model_doc/gpt_neo#transformers.GPTNeoModel"),l(Ue,"href","https://huggingface.co/EleutherAI/gpt-neo-1.3B"),l(Ue,"rel","nofollow"),l(Dt,"href","/docs/transformers/pr_15987/en/main_classes/configuration#transformers.PretrainedConfig"),l(Bt,"href","/docs/transformers/pr_15987/en/main_classes/configuration#transformers.PretrainedConfig"),l(z,"class","docstring"),l(ke,"id","transformers.GPTNeoModel"),l(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ke,"href","#transformers.GPTNeoModel"),l(ie,"class","relative group"),l(Ot,"href","/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel"),l(Ke,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ke,"rel","nofollow"),l(Wt,"href","/docs/transformers/pr_15987/en/model_doc/gpt_neo#transformers.GPTNeoModel"),l(C,"class","docstring"),l(F,"class","docstring"),l(Ne,"id","transformers.GPTNeoForCausalLM"),l(Ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ne,"href","#transformers.GPTNeoForCausalLM"),l(de,"class","relative group"),l(Ut,"href","/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel"),l(nt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(nt,"rel","nofollow"),l(Ht,"href","/docs/transformers/pr_15987/en/model_doc/gpt_neo#transformers.GPTNeoForCausalLM"),l(j,"class","docstring"),l(q,"class","docstring"),l(Ge,"id","transformers.GPTNeoForSequenceClassification"),l(Ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ge,"href","#transformers.GPTNeoForSequenceClassification"),l(pe,"class","relative group"),l(Jt,"href","/docs/transformers/pr_15987/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification"),l(Rt,"href","/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel"),l(ct,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(ct,"rel","nofollow"),l(Xt,"href","/docs/transformers/pr_15987/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification"),l(E,"class","docstring"),l(G,"class","docstring"),l(Me,"id","transformers.FlaxGPTNeoModel"),l(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Me,"href","#transformers.FlaxGPTNeoModel"),l(ue,"class","relative group"),l(Kt,"href","/docs/transformers/pr_15987/en/main_classes/model#transformers.FlaxPreTrainedModel"),l(Tt,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),l(Tt,"rel","nofollow"),l(vt,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),l(vt,"rel","nofollow"),l(yt,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),l(yt,"rel","nofollow"),l(Pt,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),l(Pt,"rel","nofollow"),l(bt,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),l(bt,"rel","nofollow"),l(I,"class","docstring"),l(x,"class","docstring"),l(ze,"id","transformers.FlaxGPTNeoForCausalLM"),l(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ze,"href","#transformers.FlaxGPTNeoForCausalLM"),l(fe,"class","relative group"),l(Qt,"href","/docs/transformers/pr_15987/en/main_classes/model#transformers.FlaxPreTrainedModel"),l(Mt,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),l(Mt,"rel","nofollow"),l(Et,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),l(Et,"rel","nofollow"),l(zt,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),l(zt,"rel","nofollow"),l(Ft,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),l(Ft,"rel","nofollow"),l(qt,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),l(qt,"rel","nofollow"),l(A,"class","docstring"),l(M,"class","docstring")},m(t,h){e(document.head,p),u(t,w,h),u(t,m,h),e(m,k),e(k,N),v(g,N,null),e(m,f),e(m,$),e($,Jn),u(t,ln,h),u(t,oe,h),e(oe,Te),e(Te,ro),v(Ie,ro,null),e(oe,Rn),e(oe,io),e(io,Xn),u(t,dn,h),u(t,J,h),e(J,Kn),e(J,Ae),e(Ae,Qn),e(J,Yn),e(J,Le),e(Le,Zn),e(J,es),u(t,cn,h),u(t,Lt,h),e(Lt,ts),u(t,pn,h),u(t,ve,h),e(ve,os),e(ve,Se),e(Se,ns),e(ve,ss),u(t,hn,h),u(t,ne,h),e(ne,ye),e(ye,lo),v(De,lo,null),e(ne,as),e(ne,co),e(co,rs),u(t,un,h),u(t,Pe,h),e(Pe,is),e(Pe,po),e(po,ls),e(Pe,ds),u(t,mn,h),v(Be,t,h),u(t,fn,h),u(t,se,h),e(se,be),e(be,ho),v(Oe,ho,null),e(se,cs),e(se,uo),e(uo,ps),u(t,gn,h),u(t,z,h),v(We,z,null),e(z,hs),e(z,ae),e(ae,us),e(ae,St),e(St,ms),e(ae,fs),e(ae,Ue),e(Ue,gs),e(ae,_s),e(z,Ts),e(z,re),e(re,vs),e(re,Dt),e(Dt,ys),e(re,Ps),e(re,Bt),e(Bt,bs),e(re,ks),e(z,ws),e(z,mo),e(mo,Ns),e(z,$s),v(He,z,null),u(t,_n,h),u(t,ie,h),e(ie,ke),e(ke,fo),v(Ve,fo,null),e(ie,Gs),e(ie,go),e(go,xs),u(t,Tn,h),u(t,F,h),v(Je,F,null),e(F,Ms),e(F,_o),e(_o,Es),e(F,zs),e(F,Re),e(Re,Fs),e(Re,Ot),e(Ot,qs),e(Re,Cs),e(F,js),e(F,Xe),e(Xe,Is),e(Xe,Ke),e(Ke,As),e(Xe,Ls),e(F,Ss),e(F,C),v(Qe,C,null),e(C,Ds),e(C,le),e(le,Bs),e(le,Wt),e(Wt,Os),e(le,Ws),e(le,To),e(To,Us),e(le,Hs),e(C,Vs),v(we,C,null),e(C,Js),e(C,vo),e(vo,Rs),e(C,Xs),v(Ye,C,null),u(t,vn,h),u(t,de,h),e(de,Ne),e(Ne,yo),v(Ze,yo,null),e(de,Ks),e(de,Po),e(Po,Qs),u(t,yn,h),u(t,q,h),v(et,q,null),e(q,Ys),e(q,bo),e(bo,Zs),e(q,ea),e(q,tt),e(tt,ta),e(tt,Ut),e(Ut,oa),e(tt,na),e(q,sa),e(q,ot),e(ot,aa),e(ot,nt),e(nt,ra),e(ot,ia),e(q,la),e(q,j),v(st,j,null),e(j,da),e(j,ce),e(ce,ca),e(ce,Ht),e(Ht,pa),e(ce,ha),e(ce,ko),e(ko,ua),e(ce,ma),e(j,fa),v($e,j,null),e(j,ga),e(j,wo),e(wo,_a),e(j,Ta),v(at,j,null),u(t,Pn,h),u(t,pe,h),e(pe,Ge),e(Ge,No),v(rt,No,null),e(pe,va),e(pe,$o),e($o,ya),u(t,bn,h),u(t,G,h),v(it,G,null),e(G,Pa),e(G,Go),e(Go,ba),e(G,ka),e(G,Vt),e(Vt,Jt),e(Jt,wa),e(Vt,Na),e(G,$a),e(G,W),e(W,Ga),e(W,xo),e(xo,xa),e(W,Ma),e(W,Mo),e(Mo,Ea),e(W,za),e(W,Eo),e(Eo,Fa),e(W,qa),e(W,zo),e(zo,Ca),e(W,ja),e(G,Ia),e(G,lt),e(lt,Aa),e(lt,Rt),e(Rt,La),e(lt,Sa),e(G,Da),e(G,dt),e(dt,Ba),e(dt,ct),e(ct,Oa),e(dt,Wa),e(G,Ua),e(G,E),v(pt,E,null),e(E,Ha),e(E,he),e(he,Va),e(he,Xt),e(Xt,Ja),e(he,Ra),e(he,Fo),e(Fo,Xa),e(he,Ka),e(E,Qa),v(xe,E,null),e(E,Ya),e(E,qo),e(qo,Za),e(E,er),v(ht,E,null),e(E,tr),e(E,Co),e(Co,or),e(E,nr),v(ut,E,null),u(t,kn,h),u(t,ue,h),e(ue,Me),e(Me,jo),v(mt,jo,null),e(ue,sr),e(ue,Io),e(Io,ar),u(t,wn,h),u(t,x,h),v(ft,x,null),e(x,rr),e(x,Ao),e(Ao,ir),e(x,lr),e(x,gt),e(gt,dr),e(gt,Kt),e(Kt,cr),e(gt,pr),e(x,hr),e(x,_t),e(_t,ur),e(_t,Tt),e(Tt,mr),e(_t,fr),e(x,gr),e(x,Lo),e(Lo,_r),e(x,Tr),e(x,U),e(U,So),e(So,vt),e(vt,vr),e(U,yr),e(U,Do),e(Do,yt),e(yt,Pr),e(U,br),e(U,Bo),e(Bo,Pt),e(Pt,kr),e(U,wr),e(U,Oo),e(Oo,bt),e(bt,Nr),e(x,$r),e(x,I),v(kt,I,null),e(I,Gr),e(I,me),e(me,xr),e(me,Wo),e(Wo,Mr),e(me,Er),e(me,Uo),e(Uo,zr),e(me,Fr),e(I,qr),v(Ee,I,null),e(I,Cr),e(I,Ho),e(Ho,jr),e(I,Ir),v(wt,I,null),u(t,Nn,h),u(t,fe,h),e(fe,ze),e(ze,Vo),v(Nt,Vo,null),e(fe,Ar),e(fe,Jo),e(Jo,Lr),u(t,$n,h),u(t,M,h),v($t,M,null),e(M,Sr),e(M,Ro),e(Ro,Dr),e(M,Br),e(M,Gt),e(Gt,Or),e(Gt,Qt),e(Qt,Wr),e(Gt,Ur),e(M,Hr),e(M,xt),e(xt,Vr),e(xt,Mt),e(Mt,Jr),e(xt,Rr),e(M,Xr),e(M,Xo),e(Xo,Kr),e(M,Qr),e(M,H),e(H,Ko),e(Ko,Et),e(Et,Yr),e(H,Zr),e(H,Qo),e(Qo,zt),e(zt,ei),e(H,ti),e(H,Yo),e(Yo,Ft),e(Ft,oi),e(H,ni),e(H,Zo),e(Zo,qt),e(qt,si),e(M,ai),e(M,A),v(Ct,A,null),e(A,ri),e(A,ge),e(ge,ii),e(ge,en),e(en,li),e(ge,di),e(ge,tn),e(tn,ci),e(ge,pi),e(A,hi),v(Fe,A,null),e(A,ui),e(A,on),e(on,mi),e(A,fi),v(jt,A,null),Gn=!0},p(t,[h]){const It={};h&2&&(It.$$scope={dirty:h,ctx:t}),we.$set(It);const nn={};h&2&&(nn.$$scope={dirty:h,ctx:t}),$e.$set(nn);const sn={};h&2&&(sn.$$scope={dirty:h,ctx:t}),xe.$set(sn);const an={};h&2&&(an.$$scope={dirty:h,ctx:t}),Ee.$set(an);const At={};h&2&&(At.$$scope={dirty:h,ctx:t}),Fe.$set(At)},i(t){Gn||(y(g.$$.fragment,t),y(Ie.$$.fragment,t),y(De.$$.fragment,t),y(Be.$$.fragment,t),y(Oe.$$.fragment,t),y(We.$$.fragment,t),y(He.$$.fragment,t),y(Ve.$$.fragment,t),y(Je.$$.fragment,t),y(Qe.$$.fragment,t),y(we.$$.fragment,t),y(Ye.$$.fragment,t),y(Ze.$$.fragment,t),y(et.$$.fragment,t),y(st.$$.fragment,t),y($e.$$.fragment,t),y(at.$$.fragment,t),y(rt.$$.fragment,t),y(it.$$.fragment,t),y(pt.$$.fragment,t),y(xe.$$.fragment,t),y(ht.$$.fragment,t),y(ut.$$.fragment,t),y(mt.$$.fragment,t),y(ft.$$.fragment,t),y(kt.$$.fragment,t),y(Ee.$$.fragment,t),y(wt.$$.fragment,t),y(Nt.$$.fragment,t),y($t.$$.fragment,t),y(Ct.$$.fragment,t),y(Fe.$$.fragment,t),y(jt.$$.fragment,t),Gn=!0)},o(t){P(g.$$.fragment,t),P(Ie.$$.fragment,t),P(De.$$.fragment,t),P(Be.$$.fragment,t),P(Oe.$$.fragment,t),P(We.$$.fragment,t),P(He.$$.fragment,t),P(Ve.$$.fragment,t),P(Je.$$.fragment,t),P(Qe.$$.fragment,t),P(we.$$.fragment,t),P(Ye.$$.fragment,t),P(Ze.$$.fragment,t),P(et.$$.fragment,t),P(st.$$.fragment,t),P($e.$$.fragment,t),P(at.$$.fragment,t),P(rt.$$.fragment,t),P(it.$$.fragment,t),P(pt.$$.fragment,t),P(xe.$$.fragment,t),P(ht.$$.fragment,t),P(ut.$$.fragment,t),P(mt.$$.fragment,t),P(ft.$$.fragment,t),P(kt.$$.fragment,t),P(Ee.$$.fragment,t),P(wt.$$.fragment,t),P(Nt.$$.fragment,t),P($t.$$.fragment,t),P(Ct.$$.fragment,t),P(Fe.$$.fragment,t),P(jt.$$.fragment,t),Gn=!1},d(t){o(p),t&&o(w),t&&o(m),b(g),t&&o(ln),t&&o(oe),b(Ie),t&&o(dn),t&&o(J),t&&o(cn),t&&o(Lt),t&&o(pn),t&&o(ve),t&&o(hn),t&&o(ne),b(De),t&&o(un),t&&o(Pe),t&&o(mn),b(Be,t),t&&o(fn),t&&o(se),b(Oe),t&&o(gn),t&&o(z),b(We),b(He),t&&o(_n),t&&o(ie),b(Ve),t&&o(Tn),t&&o(F),b(Je),b(Qe),b(we),b(Ye),t&&o(vn),t&&o(de),b(Ze),t&&o(yn),t&&o(q),b(et),b(st),b($e),b(at),t&&o(Pn),t&&o(pe),b(rt),t&&o(bn),t&&o(G),b(it),b(pt),b(xe),b(ht),b(ut),t&&o(kn),t&&o(ue),b(mt),t&&o(wn),t&&o(x),b(ft),b(kt),b(Ee),b(wt),t&&o(Nn),t&&o(fe),b(Nt),t&&o($n),t&&o(M),b($t),b(Ct),b(Fe),b(jt)}}}const id={local:"gpt-neo",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTNeoConfig",title:"GPTNeoConfig"},{local:"transformers.GPTNeoModel",title:"GPTNeoModel"},{local:"transformers.GPTNeoForCausalLM",title:"GPTNeoForCausalLM"},{local:"transformers.GPTNeoForSequenceClassification",title:"GPTNeoForSequenceClassification"},{local:"transformers.FlaxGPTNeoModel",title:"FlaxGPTNeoModel"},{local:"transformers.FlaxGPTNeoForCausalLM",title:"FlaxGPTNeoForCausalLM"}],title:"GPT Neo"};function ld(O,p,w){let{fw:m}=p;return O.$$set=k=>{"fw"in k&&w(0,m=k.fw)},[m]}class fd extends Ql{constructor(p){super();Yl(this,p,ld,rd,Zl,{fw:0})}}export{fd as default,id as metadata};
