import{S as zm,i as Fm,s as $m,e as n,k as i,w as m,t as r,M as xm,c as s,d as t,m as l,a,x as _,h as d,b as c,F as e,g as h,y as g,q as v,o as T,B as k}from"../../chunks/vendor-4833417e.js";import{T as go}from"../../chunks/Tip-fffd6df1.js";import{D as $}from"../../chunks/Docstring-4f315ed9.js";import{C as At}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as fe}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Mm(j){let u,L,b,w,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),q=r(`
...
`),Y=s(de,"CODE",{});var it=a(Y);x=d(it,"model([input_ids, attention_mask])"),it.forEach(t),M=d(de," or "),G=s(de,"CODE",{});var ie=a(G);Ge=d(ie,"model([input_ids, attention_mask, token_type_ids])"),ie.forEach(t),de.forEach(t),Qe=l(X),N=s(X,"LI",{});var Ue=a(N);He=d(Ue,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=s(Ue,"CODE",{});var We=a(se);De=d(We,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),We.forEach(t),Ue.forEach(t),X.forEach(t)},m(f,F){h(f,u,F),e(u,L),h(f,b,F),h(f,w,F),e(w,q),e(q,E),e(w,y),e(w,D),e(D,Ae),h(f,me,F),h(f,z,F),e(z,Z),e(z,W),e(W,te),e(z,Ne),e(z,R),e(R,je),e(z,Me),h(f,B,F),h(f,V,F),e(V,oe),h(f,Le,F),h(f,S,F),e(S,P),e(P,_e),e(P,ne),e(ne,Se),e(P,ge),e(P,K),e(K,Ie),e(S,Ce),e(S,C),e(C,Be),e(C,Y),e(Y,x),e(C,M),e(C,G),e(G,Ge),e(S,Qe),e(S,N),e(N,He),e(N,se),e(se,De)},d(f){f&&t(u),f&&t(b),f&&t(w),f&&t(me),f&&t(z),f&&t(B),f&&t(V),f&&t(Le),f&&t(S)}}}function Am(j){let u,L,b,w,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(E){u=s(E,"P",{});var y=a(u);L=d(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var D=a(b);w=d(D,"Module"),D.forEach(t),q=d(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(E){u=s(E,"P",{});var y=a(u);L=d(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var D=a(b);w=d(D,"Module"),D.forEach(t),q=d(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,L),e(u,b),e(b,w),e(u,q)},d(E){E&&t(u)}}}function Im(j){let u,L,b,w,q,E,y,D,Ae,me,z,Z,W,te,Ne,R,je,Me,B,V,oe,Le,S,P,_e,ne,Se,ge,K,Ie,Ce,C,Be,Y,x,M,G,Ge,Qe,N,He,se,De,f,F,ae,nt,st,I,at,rt,Oe,X,re,Pe,dt,de,it,ie,Ue,We,Sd,Cd,$s,Od,Pd,Ad,ze,Nd,xs,jd,Id,Ms,Bd,Gd,Wn,Qd,Hd,Ss,Ud,Wd,Rd,J,Vd,Cs,Kd,Xd,Os,Jd,Zd,Rn,Yd,ei,Ps,ti,oi,As,ni,si,Ns,ai,ri,di,lt,ii,js,li,ci,Is,hi,pi,ui,vo,fi,To,mi,_i,gi,ko,vi,bo,Ti,ki,ur,Nt,bi,wo,wi,yi,fr,ct,jt,Bs,yo,Ei,Gs,qi,mr,O,Eo,Li,ht,Di,Vn,zi,Fi,qo,$i,xi,Mi,pt,Si,Kn,Ci,Oi,Xn,Pi,Ai,Ni,Qs,ji,Ii,Lo,Bi,Hs,Us,Ws,Rs,Gi,Qi,Vs,Ks,Xs,It,Bt,Js,Do,Hi,Zs,Ui,Wi,Ys,ea,zo,Gt,Qt,ta,Fo,Ri,oa,Vi,Ki,na,Xi,Ji,sa,aa,ra,Ht,Ut,da,$o,Zi,ia,Yi,_r,ut,Wt,la,xo,el,ca,tl,gr,A,Mo,ol,ha,nl,sl,Rt,Jn,al,rl,Zn,dl,il,ll,So,cl,Yn,hl,pl,ul,Re,Co,fl,pa,ml,_l,Oo,es,gl,ua,vl,Tl,ts,kl,fa,bl,wl,Vt,Po,yl,Ao,El,ma,ql,Ll,Dl,Kt,No,zl,_a,Fl,$l,os,jo,vr,ft,Xt,ga,Io,xl,va,Ml,Tr,Fe,Bo,Sl,Go,Cl,Ta,Ol,Pl,Al,Jt,ns,Nl,jl,ss,Il,Bl,Gl,Qo,Ql,as,Hl,Ul,kr,mt,Zt,ka,Ho,Wl,ba,Rl,br,_t,Uo,Vl,wa,Kl,wr,gt,Wo,Xl,ya,Jl,yr,vt,Ro,Zl,Ea,Yl,Er,Tt,Vo,ec,qa,tc,qr,kt,Ko,oc,La,nc,Lr,bt,Xo,sc,Da,ac,Dr,wt,Jo,rc,za,dc,zr,yt,Zo,ic,Fa,lc,Fr,Et,Yt,$a,Yo,cc,xa,hc,$r,$e,en,pc,tn,uc,rs,fc,mc,_c,on,gc,nn,vc,Tc,kc,ve,sn,bc,qt,wc,ds,yc,Ec,Ma,qc,Lc,Dc,eo,zc,Sa,Fc,$c,an,xr,Lt,to,Ca,rn,xc,Oa,Mc,Mr,xe,dn,Sc,ln,Cc,is,Oc,Pc,Ac,cn,Nc,hn,jc,Ic,Bc,Q,pn,Gc,Dt,Qc,ls,Hc,Uc,Pa,Wc,Rc,Vc,oo,Kc,Aa,Xc,Jc,un,Zc,Na,Yc,eh,fn,Sr,zt,no,ja,mn,th,Ia,oh,Cr,le,_n,nh,Ba,sh,ah,gn,rh,cs,dh,ih,lh,vn,ch,Tn,hh,ph,uh,H,kn,fh,Ft,mh,hs,_h,gh,Ga,vh,Th,kh,so,bh,Qa,wh,yh,bn,Eh,Ha,qh,Lh,wn,Or,$t,ao,Ua,yn,Dh,Wa,zh,Pr,ce,En,Fh,xt,$h,Ra,xh,Mh,Va,Sh,Ch,Oh,qn,Ph,ps,Ah,Nh,jh,Ln,Ih,Dn,Bh,Gh,Qh,Te,zn,Hh,Mt,Uh,us,Wh,Rh,Ka,Vh,Kh,Xh,ro,Jh,Xa,Zh,Yh,Fn,Ar,St,io,Ja,$n,ep,Za,tp,Nr,he,xn,op,Mn,np,fs,sp,ap,rp,Sn,dp,Cn,ip,lp,cp,lo,hp,ke,On,pp,Ct,up,ms,fp,mp,Ya,_p,gp,vp,co,Tp,er,kp,bp,Pn,jr,Ot,ho,tr,An,wp,or,yp,Ir,pe,Nn,Ep,jn,qp,_s,Lp,Dp,zp,In,Fp,Bn,$p,xp,Mp,po,Sp,be,Gn,Cp,Pt,Op,gs,Pp,Ap,nr,Np,jp,Ip,uo,Bp,sr,Gp,Qp,Qn,Br;return E=new fe({}),te=new fe({}),yo=new fe({}),Eo=new $({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),eo=new go({props:{$$slots:{default:[Mm]},$$scope:{ctx:j}}}),an=new At({props:{code:`from transformers import LEDTokenizer, LEDModel
import torch
...
`}}),oo=new go({props:{$$slots:{default:[Sm]},$$scope:{ctx:j}}}),un=new At({props:{code:`from transformers import LEDTokenizer, LEDForConditionalGeneration
...
`}}),so=new go({props:{$$slots:{default:[Cm]},$$scope:{ctx:j}}}),bn=new At({props:{code:`import torch
...
`}}),ro=new go({props:{$$slots:{default:[Om]},$$scope:{ctx:j}}}),Fn=new At({props:{code:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
`}}),co=new go({props:{$$slots:{default:[Am]},$$scope:{ctx:j}}}),Pn=new At({props:{code:`from transformers import LEDTokenizer, TFLEDModel
...
`}}),uo=new go({props:{$$slots:{default:[jm]},$$scope:{ctx:j}}}),Qn=new At({props:{code:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
...
`),Pe=n("a"),dt=r("BartTokenizer"),de=r("."),it=i(),ie=n("li"),Ue=r("LED works very well on long-range "),We=n("em"),Sd=r("sequence-to-sequence"),Cd=r(" tasks where the "),$s=n("code"),Od=r("input_ids"),Pd=r(` largely exceed a length of
...
gained, when `),Wn=n("a"),Qd=r("LEDTokenizer"),Hd=r(" is used with the "),Ss=n("code"),Ud=r("pad_to_multiple_of"),Wd=r(" argument."),Rd=i(),J=n("li"),Vd=r("LED makes use of "),Cs=n("em"),Kd=r("global attention"),Xd=r(" by means of the "),Os=n("code"),Jd=r("global_attention_mask"),Zd=r(` (see
...
documentation from `),Xn=n("a"),Pi=r("PretrainedConfig"),Ai=r(" for more information."),Ni=i(),Qs=n("p"),ji=r("Example:"),Ii=i(),m(Lo.$$.fragment),Bi=i(),Hs=n("blockquote"),Us=n("blockquote"),Ws=n("blockquote"),Rs=n("p"),Gi=r("from transformers import LEDModel, LEDConfig"),Qi=i(),Vs=n("blockquote"),Ks=n("blockquote"),Xs=n("blockquote"),It=n("h1"),Bt=n("a"),Js=n("span"),m(Do.$$.fragment),Hi=i(),Zs=n("span"),Ui=r("Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Wi=i(),Ys=n("blockquote"),ea=n("blockquote"),zo=n("blockquote"),Gt=n("h1"),Qt=n("a"),ta=n("span"),m(Fo.$$.fragment),Ri=i(),oa=n("span"),Vi=r("Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Ki=i(),na=n("p"),Xi=r("LEDModel(configuration)"),Ji=i(),sa=n("blockquote"),aa=n("blockquote"),ra=n("blockquote"),Ht=n("h1"),Ut=n("a"),da=n("span"),m($o.$$.fragment),Zi=i(),ia=n("span"),Yi=r("Accessing the model configuration >>> configuration = model.config"),_r=i(),ut=n("h2"),Wt=n("a"),la=n("span"),m(xo.$$.fragment),el=i(),ca=n("span"),tl=r("LEDTokenizer"),gr=i(),A=n("div"),m(Mo.$$.fragment),ol=i(),ha=n("p"),nl=r("Construct a LED tokenizer."),sl=i(),Rt=n("p"),Jn=n("a"),al=r("LEDTokenizer"),rl=r(" is identical to "),Zn=n("a"),dl=r("BartTokenizer"),il=r(` and runs end-to-end tokenization: punctuation splitting and
...
and wordpiece.`),Gl=i(),Qo=n("p"),Ql=r("Refer to superclass "),as=n("a"),Hl=r("BartTokenizerFast"),Ul=r(" for usage examples and documentation concerning parameters."),kr=i(),mt=n("h2"),Zt=n("a"),ka=n("span"),m(Ho.$$.fragment),Wl=i(),ba=n("span"),Rl=r("LED specific outputs"),br=i(),_t=n("div"),m(Uo.$$.fragment),Vl=i(),wa=n("p"),Kl=r("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),wr=i(),gt=n("div"),m(Wo.$$.fragment),Xl=i(),ya=n("p"),Jl=r(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bc=i(),Q=n("div"),m(pn.$$.fragment),Gc=i(),Dt=n("p"),Qc=r("The "),ls=n("a"),Hc=r("LEDForConditionalGeneration"),Uc=r(" forward method, overrides the "),Pa=n("code"),Wc=r("__call__"),Rc=r(" special method."),Vc=i(),m(oo.$$.fragment),Kc=i(),Aa=n("p"),Xc=r("Conditional generation example:"),Jc=i(),m(un.$$.fragment),Zc=i(),Na=n("p"),Yc=r("Summarization example:"),eh=i(),m(fn.$$.fragment),Sr=i(),zt=n("h2"),no=n("a"),ja=n("span"),m(mn.$$.fragment),th=i(),Ia=n("span"),oh=r("LEDForSequenceClassification"),Cr=i(),le=n("div"),m(_n.$$.fragment),nh=i(),Ba=n("p"),sh=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uh=i(),H=n("div"),m(kn.$$.fragment),fh=i(),Ft=n("p"),mh=r("The "),hs=n("a"),_h=r("LEDForSequenceClassification"),gh=r(" forward method, overrides the "),Ga=n("code"),vh=r("__call__"),Th=r(" special method."),kh=i(),m(so.$$.fragment),bh=i(),Qa=n("p"),wh=r("Example of single-label classification:"),yh=i(),m(bn.$$.fragment),Eh=i(),Ha=n("p"),qh=r("Example of multi-label classification:"),Lh=i(),m(wn.$$.fragment),Or=i(),$t=n("h2"),ao=n("a"),Ua=n("span"),m(yn.$$.fragment),Dh=i(),Wa=n("span"),zh=r("LEDForQuestionAnswering"),Pr=i(),ce=n("div"),m(En.$$.fragment),Fh=i(),xt=n("p"),$h=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qh=i(),Te=n("div"),m(zn.$$.fragment),Hh=i(),Mt=n("p"),Uh=r("The "),us=n("a"),Wh=r("LEDForQuestionAnswering"),Rh=r(" forward method, overrides the "),Ka=n("code"),Vh=r("__call__"),Kh=r(" special method."),Xh=i(),m(ro.$$.fragment),Jh=i(),Xa=n("p"),Zh=r("Example:"),Yh=i(),m(Fn.$$.fragment),Ar=i(),St=n("h2"),io=n("a"),Ja=n("span"),m($n.$$.fragment),ep=i(),Za=n("span"),tp=r("TFLEDModel"),Nr=i(),he=n("div"),m(xn.$$.fragment),op=i(),Mn=n("p"),np=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
`),Pe=s(ue,"A",{href:!0});var nu=a(Pe);dt=d(nu,"BartTokenizer"),nu.forEach(t),de=d(ue,"."),ue.forEach(t),it=l(we),ie=s(we,"LI",{});var vs=a(ie);Ue=d(vs,"LED works very well on long-range "),We=s(vs,"EM",{});var su=a(We);Sd=d(su,"sequence-to-sequence"),su.forEach(t),Cd=d(vs," tasks where the "),$s=s(vs,"CODE",{});var au=a($s);Od=d(au,"input_ids"),au.forEach(t),Pd=d(vs,` largely exceed a length of
...
`),Is=s(Ts,"CODE",{});var gu=a(Is);hi=d(gu,"model.gradient_checkpointing_enable()"),gu.forEach(t),pi=d(Ts,"."),Ts.forEach(t),ui=l(we),vo=s(we,"LI",{});var Qr=a(vo);fi=d(Qr,"A notebook showing how to evaluate LED, can be accessed "),To=s(Qr,"A",{href:!0,rel:!0});var vu=a(To);mi=d(vu,"here"),vu.forEach(t),_i=d(Qr,"."),Qr.forEach(t),gi=l(we),ko=s(we,"LI",{});var Hr=a(ko);vi=d(Hr,"A notebook showing how to fine-tune LED, can be accessed "),bo=s(Hr,"A",{href:!0,rel:!0});var Tu=a(bo);Ti=d(Tu,"here"),Tu.forEach(t),ki=d(Hr,"."),Hr.forEach(t),we.forEach(t),ur=l(o),Nt=s(o,"P",{});var Ur=a(Nt);bi=d(Ur,"This model was contributed by "),wo=s(Ur,"A",{href:!0,rel:!0});var ku=a(wo);wi=d(ku,"patrickvonplaten"),ku.forEach(t),yi=d(Ur,"."),Ur.forEach(t),fr=l(o),ct=s(o,"H2",{class:!0});var Wr=a(ct);jt=s(Wr,"A",{id:!0,class:!0,href:!0});var bu=a(jt);Bs=s(bu,"SPAN",{});var wu=a(Bs);_(yo.$$.fragment,wu),wu.forEach(t),bu.forEach(t),Ei=l(Wr),Gs=s(Wr,"SPAN",{});var yu=a(Gs);qi=d(yu,"LEDConfig"),yu.forEach(t),Wr.forEach(t),mr=l(o),O=s(o,"DIV",{class:!0});var U=a(O);_(Eo.$$.fragment,U),Li=l(U),ht=s(U,"P",{});var ks=a(ht);Di=d(ks,"This is the configuration class to store the configuration of a "),Vn=s(ks,"A",{href:!0});var Eu=a(Vn);zi=d(Eu,"LEDModel"),Eu.forEach(t),Fi=d(ks,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),qo=s(ks,"A",{href:!0,rel:!0});var qu=a(qo);$i=d(qu,"allenai/led-base-16384"),qu.forEach(t),xi=d(ks," architecture."),ks.forEach(t),Mi=l(U),pt=s(U,"P",{});var bs=a(pt);Si=d(bs,"Configuration objects inherit from "),Kn=s(bs,"A",{href:!0});var Lu=a(Kn);Ci=d(Lu,"PretrainedConfig"),Lu.forEach(t),Oi=d(bs,` and can be used to control the model outputs. Read the
documentation from `),Xn=s(bs,"A",{href:!0});var Du=a(Xn);Pi=d(Du,"PretrainedConfig"),Du.forEach(t),Ai=d(bs," for more information."),bs.forEach(t),Ni=l(U),Qs=s(U,"P",{});var zu=a(Qs);ji=d(zu,"Example:"),zu.forEach(t),Ii=l(U),_(Lo.$$.fragment,U),Bi=l(U),Hs=s(U,"BLOCKQUOTE",{});var Fu=a(Hs);Us=s(Fu,"BLOCKQUOTE",{});var $u=a(Us);Ws=s($u,"BLOCKQUOTE",{});var xu=a(Ws);Rs=s(xu,"P",{});var Mu=a(Rs);Gi=d(Mu,"from transformers import LEDModel, LEDConfig"),Mu.forEach(t),xu.forEach(t),$u.forEach(t),Fu.forEach(t),Qi=l(U),Vs=s(U,"BLOCKQUOTE",{});var Su=a(Vs);Ks=s(Su,"BLOCKQUOTE",{});var Cu=a(Ks);Xs=s(Cu,"BLOCKQUOTE",{});var Ou=a(Xs);It=s(Ou,"H1",{class:!0});var Rr=a(It);Bt=s(Rr,"A",{id:!0,class:!0,href:!0});var Pu=a(Bt);Js=s(Pu,"SPAN",{});var Au=a(Js);_(Do.$$.fragment,Au),Au.forEach(t),Pu.forEach(t),Hi=l(Rr),Zs=s(Rr,"SPAN",{});var Nu=a(Zs);Ui=d(Nu,"Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Nu.forEach(t),Rr.forEach(t),Ou.forEach(t),Cu.forEach(t),Su.forEach(t),Wi=l(U),Ys=s(U,"BLOCKQUOTE",{});var ju=a(Ys);ea=s(ju,"BLOCKQUOTE",{});var Iu=a(ea);zo=s(Iu,"BLOCKQUOTE",{});var Vr=a(zo);Gt=s(Vr,"H1",{class:!0});var Kr=a(Gt);Qt=s(Kr,"A",{id:!0,class:!0,href:!0});var Bu=a(Qt);ta=s(Bu,"SPAN",{});var Gu=a(ta);_(Fo.$$.fragment,Gu),Gu.forEach(t),Bu.forEach(t),Ri=l(Kr),oa=s(Kr,"SPAN",{});var Qu=a(oa);Vi=d(Qu,"Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Qu.forEach(t),Kr.forEach(t),Ki=l(Vr),na=s(Vr,"P",{});var Hu=a(na);Xi=d(Hu,"LEDModel(configuration)"),Hu.forEach(t),Vr.forEach(t),Iu.forEach(t),ju.forEach(t),Ji=l(U),sa=s(U,"BLOCKQUOTE",{});var Uu=a(sa);aa=s(Uu,"BLOCKQUOTE",{});var Wu=a(aa);ra=s(Wu,"BLOCKQUOTE",{});var Ru=a(ra);Ht=s(Ru,"H1",{class:!0});var Xr=a(Ht);Ut=s(Xr,"A",{id:!0,class:!0,href:!0});var Vu=a(Ut);da=s(Vu,"SPAN",{});var Ku=a(da);_($o.$$.fragment,Ku),Ku.forEach(t),Vu.forEach(t),Zi=l(Xr),ia=s(Xr,"SPAN",{});var Xu=a(ia);Yi=d(Xu,"Accessing the model configuration >>> configuration = model.config"),Xu.forEach(t),Xr.forEach(t),Ru.forEach(t),Wu.forEach(t),Uu.forEach(t),U.forEach(t),_r=l(o),ut=s(o,"H2",{class:!0});var Jr=a(ut);Wt=s(Jr,"A",{id:!0,class:!0,href:!0});var Ju=a(Wt);la=s(Ju,"SPAN",{});var Zu=a(la);_(xo.$$.fragment,Zu),Zu.forEach(t),Ju.forEach(t),el=l(Jr),ca=s(Jr,"SPAN",{});var Yu=a(ca);tl=d(Yu,"LEDTokenizer"),Yu.forEach(t),Jr.forEach(t),gr=l(o),A=s(o,"DIV",{class:!0});var ee=a(A);_(Mo.$$.fragment,ee),ol=l(ee),ha=s(ee,"P",{});var ef=a(ha);nl=d(ef,"Construct a LED tokenizer."),ef.forEach(t),sl=l(ee),Rt=s(ee,"P",{});var hr=a(Rt);Jn=s(hr,"A",{href:!0});var tf=a(Jn);al=d(tf,"LEDTokenizer"),tf.forEach(t),rl=d(hr," is identical to "),Zn=s(hr,"A",{href:!0});var of=a(Zn);dl=d(of,"BartTokenizer"),of.forEach(t),il=d(hr,` and runs end-to-end tokenization: punctuation splitting and
...
and wordpiece.`),pr.forEach(t),Gl=l(fo),Qo=s(fo,"P",{});var ad=a(Qo);Ql=d(ad,"Refer to superclass "),as=s(ad,"A",{href:!0});var gf=a(as);Hl=d(gf,"BartTokenizerFast"),gf.forEach(t),Ul=d(ad," for usage examples and documentation concerning parameters."),ad.forEach(t),fo.forEach(t),kr=l(o),mt=s(o,"H2",{class:!0});var rd=a(mt);Zt=s(rd,"A",{id:!0,class:!0,href:!0});var vf=a(Zt);ka=s(vf,"SPAN",{});var Tf=a(ka);_(Ho.$$.fragment,Tf),Tf.forEach(t),vf.forEach(t),Wl=l(rd),ba=s(rd,"SPAN",{});var kf=a(ba);Rl=d(kf,"LED specific outputs"),kf.forEach(t),rd.forEach(t),br=l(o),_t=s(o,"DIV",{class:!0});var dd=a(_t);_(Uo.$$.fragment,dd),Vl=l(dd),wa=s(dd,"P",{});var bf=a(wa);Kl=d(bf,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),bf.forEach(t),dd.forEach(t),wr=l(o),gt=s(o,"DIV",{class:!0});var id=a(gt);_(Wo.$$.fragment,id),Xl=l(id),ya=s(id,"P",{});var wf=a(ya);Jl=d(wf,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd.forEach(t),Bc=l(_o),Q=s(_o,"DIV",{class:!0});var Ee=a(Q);_(pn.$$.fragment,Ee),Gc=l(Ee),Dt=s(Ee,"P",{});var Es=a(Dt);Qc=d(Es,"The "),ls=s(Es,"A",{href:!0});var Gf=a(ls);Hc=d(Gf,"LEDForConditionalGeneration"),Gf.forEach(t),Uc=d(Es," forward method, overrides the "),Pa=s(Es,"CODE",{});var Qf=a(Pa);Wc=d(Qf,"__call__"),Qf.forEach(t),Rc=d(Es," special method."),Es.forEach(t),Vc=l(Ee),_(oo.$$.fragment,Ee),Kc=l(Ee),Aa=s(Ee,"P",{});var Hf=a(Aa);Xc=d(Hf,"Conditional generation example:"),Hf.forEach(t),Jc=l(Ee),_(un.$$.fragment,Ee),Zc=l(Ee),Na=s(Ee,"P",{});var Uf=a(Na);Yc=d(Uf,"Summarization example:"),Uf.forEach(t),eh=l(Ee),_(fn.$$.fragment,Ee),Ee.forEach(t),_o.forEach(t),Sr=l(o),zt=s(o,"H2",{class:!0});var bd=a(zt);no=s(bd,"A",{id:!0,class:!0,href:!0});var Wf=a(no);ja=s(Wf,"SPAN",{});var Rf=a(ja);_(mn.$$.fragment,Rf),Rf.forEach(t),Wf.forEach(t),th=l(bd),Ia=s(bd,"SPAN",{});var Vf=a(Ia);oh=d(Vf,"LEDForSequenceClassification"),Vf.forEach(t),bd.forEach(t),Cr=l(o),le=s(o,"DIV",{class:!0});var Xe=a(le);_(_n.$$.fragment,Xe),nh=l(Xe),Ba=s(Xe,"P",{});var Kf=a(Ba);sh=d(Kf,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
