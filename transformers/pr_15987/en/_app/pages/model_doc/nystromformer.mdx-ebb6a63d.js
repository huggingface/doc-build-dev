...
the latter silently ignores them.`)},l(g){m=n(g,"P",{});var u=r(m);N=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n(u,"CODE",{});var M=r(h);T=i(M,"Module"),M.forEach(t),$=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(g,u){f(g,m,u),e(m,N),e(m,h),e(h,T),e(m,$)},d(g){g&&t(m)}}}function Ci(q){let m,N,h,T,$,g,u,M,vs,Wt,Y,ue,Xo,Pe,bs,et,ws,Bt,ge,Ts,Se,ot,Ns,$s,Qt,qo,Ms,Ut,Fo,tt,zs,Ht,Q,qs,Ie,Fs,Cs,Le,js,xs,Rt,Z,_e,st,De,As,nt,Es,Vt,F,Oe,Ps,K,Ss,Co,Is,Ls,We,Ds,Os,Ws,X,Bs,jo,Qs,Us,xo,Hs,Rs,Vs,rt,Gs,Js,Be,Gt,ee,ye,at,Qe,Ys,it,Zs,Jt,W,Ue,Ks,He,Xs,Re,en,on,tn,C,Ve,sn,oe,nn,Ao,rn,an,lt,ln,dn,cn,ke,mn,dt,pn,hn,Ge,Yt,te,ve,ct,Je,fn,mt,un,Zt,B,Ye,gn,se,_n,pt,yn,kn,Ze,vn,bn,wn,j,Ke,Tn,ne,Nn,Eo,$n,Mn,ht,zn,qn,Fn,be,Cn,ft,jn,xn,Xe,Kt,re,we,ut,eo,An,gt,En,Xt,S,oo,Pn,_t,Sn,In,to,Ln,so,Dn,On,Wn,z,no,Bn,ae,Qn,Po,Un,Hn,yt,Rn,Vn,Gn,Te,Jn,kt,Yn,Zn,ro,Kn,vt,Xn,er,ao,es,ie,Ne,bt,io,or,wt,tr,os,I,lo,sr,Tt,nr,rr,co,ar,mo,ir,lr,dr,x,po,cr,le,mr,So,pr,hr,Nt,fr,ur,gr,$e,_r,$t,yr,kr,ho,ts,de,Me,Mt,fo,vr,zt,br,ss,L,uo,wr,qt,Tr,Nr,go,$r,_o,Mr,zr,qr,A,yo,Fr,ce,Cr,Io,jr,xr,Ft,Ar,Er,Pr,ze,Sr,Ct,Ir,Lr,ko,ns,me,qe,jt,vo,Dr,xt,Or,rs,D,bo,Wr,pe,Br,At,Qr,Ur,Et,Hr,Rr,Vr,wo,Gr,To,Jr,Yr,Zr,E,No,Kr,he,Xr,Lo,ea,oa,Pt,ta,sa,na,Fe,ra,St,aa,ia,$o,as;return g=new fe({}),Pe=new fe({}),De=new fe({}),Oe=new O({props:{name:"class transformers.NystromformerConfig",anchor:"transformers.NystromformerConfig",parameters:[{name:"vocab_size",val:" = 30000"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu_new'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 510"},{name:"type_vocab_size",val:" = 2"},{name:"segment_means_seq_len",val:" = 64"},{name:"num_landmarks",val:" = 64"},{name:"conv_kernel_size",val:" = 65"},{name:"inv_coeff_init_option",val:" = False"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/nystromformer/configuration_nystromformer.py#L29",parametersDescription:[{anchor:"transformers.NystromformerConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30000) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),no=new O({props:{name:"forward",anchor:"transformers.NystromformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/nystromformer/modeling_nystromformer.py#L782",parametersDescription:[{anchor:"transformers.NystromformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15987/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),po=new O({props:{name:"forward",anchor:"transformers.NystromformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/nystromformer/modeling_nystromformer.py#L877",parametersDescription:[{anchor:"transformers.NystromformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15987/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new O({props:{name:"forward",anchor:"transformers.NystromformerForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/nystromformer/modeling_nystromformer.py#L974",parametersDescription:[{anchor:"transformers.NystromformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15987/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new O({props:{name:"forward",anchor:"transformers.NystromformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/nystromformer/modeling_nystromformer.py#L1054",parametersDescription:[{anchor:"transformers.NystromformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15987/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Fung, Yin Li, and Vikas Singh.`),Qt=d(),qo=s("p"),Ms=a("The abstract from the paper is the following:"),Ut=d(),Fo=s("p"),tt=s("em"),zs=a(`Transformers have emerged as a powerful tool for a broad range of natural language processing tasks. A key component
...
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Ht=d(),Q=s("p"),qs=a("This model was contributed by "),Ie=s("a"),Fs=a("novice03"),Cs=a(". The original code can be found "),Le=s("a"),js=a("here"),xs=a("."),Rt=d(),Z=s("h2"),_e=s("a"),st=s("span"),_(De.$$.fragment),As=d(),nt=s("span"),Es=a("NystromformerConfig"),Vt=d(),F=s("div"),_(Oe.$$.fragment),Ps=d(),K=s("p"),Ss=a("This is the configuration class to store the configuration of a "),Co=s("a"),Is=a("NystromformerModel"),Ls=a(`. It is used to instantiate
...
`),We=s("a"),Ds=a("uw-madison/nystromformer-512"),Os=a(" architecture."),Ws=d(),X=s("p"),Bs=a("Configuration objects inherit from "),jo=s("a"),Qs=a("PretrainedConfig"),Us=a(` and can be used to control the model outputs. Read the
documentation from `),xo=s("a"),Hs=a("PretrainedConfig"),Rs=a(" for more information."),Vs=d(),rt=s("p"),Gs=a("Example:"),Js=d(),_(Be.$$.fragment),Gt=d(),ee=s("h2"),ye=s("a"),at=s("span"),_(Qe.$$.fragment),Ys=d(),it=s("span"),Zs=a("NystromformerModel"),Jt=d(),W=s("div"),_(Ue.$$.fragment),Ks=d(),He=s("p"),Xs=a(`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
...
pooled output) e.g. for GLUE tasks.`),In=d(),to=s("p"),Ln=a("This model is a PyTorch "),so=s("a"),Dn=a("torch.nn.Module"),On=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wn=d(),z=s("div"),_(no.$$.fragment),Bn=d(),ae=s("p"),Qn=a("The "),Po=s("a"),Un=a("NystromformerForSequenceClassification"),Hn=a(" forward method, overrides the "),yt=s("code"),Rn=a("__call__"),Vn=a(" special method."),Gn=d(),_(Te.$$.fragment),Jn=d(),kt=s("p"),Yn=a("Example of single-label classification:"),Zn=d(),_(ro.$$.fragment),Kn=d(),vt=s("p"),Xn=a("Example of multi-label classification:"),er=d(),_(ao.$$.fragment),es=d(),ie=s("h2"),Ne=s("a"),bt=s("span"),_(io.$$.fragment),or=d(),wt=s("span"),tr=a("NystromformerForMultipleChoice"),os=d(),I=s("div"),_(lo.$$.fragment),sr=d(),Tt=s("p"),nr=a(`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qr=d(),A=s("div"),_(yo.$$.fragment),Fr=d(),ce=s("p"),Cr=a("The "),Io=s("a"),jr=a("NystromformerForTokenClassification"),xr=a(" forward method, overrides the "),Ft=s("code"),Ar=a("__call__"),Er=a(" special method."),Pr=d(),_(ze.$$.fragment),Sr=d(),Ct=s("p"),Ir=a("Example:"),Lr=d(),_(ko.$$.fragment),ns=d(),me=s("h2"),qe=s("a"),jt=s("span"),_(vo.$$.fragment),Dr=d(),xt=s("span"),Or=a("NystromformerForQuestionAnswering"),rs=d(),D=s("div"),_(bo.$$.fragment),Wr=d(),pe=s("p"),Br=a(`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),At=s("code"),Qr=a("span start logits"),Ur=a(" and "),Et=s("code"),Hr=a("span end logits"),Rr=a(")."),Vr=d(),wo=s("p"),Gr=a("This model is a PyTorch "),To=s("a"),Jr=a("torch.nn.Module"),Yr=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Zr=d(),E=s("div"),_(No.$$.fragment),Kr=d(),he=s("p"),Xr=a("The "),Lo=s("a"),ea=a("NystromformerForQuestionAnswering"),oa=a(" forward method, overrides the "),Pt=s("code"),ta=a("__call__"),sa=a(" special method."),na=d(),_(Fe.$$.fragment),ra=d(),St=s("p"),aa=a("Example:"),ia=d(),_($o.$$.fragment),this.h()},l(o){const p=Ti('[data-svelte="svelte-1phssyn"]',document.head);m=n(p,"META",{name:!0,content:!0}),p.forEach(t),N=c(o),h=n(o,"H1",{class:!0});var Mo=r(h);T=n(Mo,"A",{id:!0,class:!0,href:!0});var It=r(T);$=n(It,"SPAN",{});var Lt=r($);y(g.$$.fragment,Lt),Lt.forEach(t),It.forEach(t),u=c(Mo),M=n(Mo,"SPAN",{});var Dt=r(M);vs=i(Dt,"Nystr\xF6mformer"),Dt.forEach(t),Mo.forEach(t),Wt=c(o),Y=n(o,"H2",{class:!0});var zo=r(Y);ue=n(zo,"A",{id:!0,class:!0,href:!0});var Ot=r(ue);Xo=n(Ot,"SPAN",{});var la=r(Xo);y(Pe.$$.fragment,la),la.forEach(t),Ot.forEach(t),bs=c(zo),et=n(zo,"SPAN",{});var da=r(et);ws=i(da,"Overview"),da.forEach(t),zo.forEach(t),Bt=c(o),ge=n(o,"P",{});var is=r(ge);Ts=i(is,"The Nystr\xF6mformer model was proposed in "),Se=n(is,"A",{href:!0,rel:!0});var ca=r(Se);ot=n(ca,"EM",{});var ma=r(ot);Ns=i(ma,"Nystr\xF6mformer: A Nystr\xF6m-Based Algorithm for Approximating Self-Attention"),ma.forEach(t),ca.forEach(t),$s=i(is,` by Yunyang Xiong, Zhanpeng Zeng, Rudrasis Chakraborty, Mingxing Tan, Glenn
...
sequence length, and find that our Nystr\xF6mformer performs comparably, or in a few cases, even slightly better, than
standard self-attention. On longer sequence tasks in the Long Range Arena (LRA) benchmark, Nystr\xF6mformer performs
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),fa.forEach(t),ha.forEach(t),Ht=c(o),Q=n(o,"P",{});var Do=r(Q);qs=i(Do,"This model was contributed by "),Ie=n(Do,"A",{href:!0,rel:!0});var ua=r(Ie);Fs=i(ua,"novice03"),ua.forEach(t),Cs=i(Do,". The original code can be found "),Le=n(Do,"A",{href:!0,rel:!0});var ga=r(Le);js=i(ga,"here"),ga.forEach(t),xs=i(Do,"."),Do.forEach(t),Rt=c(o),Z=n(o,"H2",{class:!0});var ls=r(Z);_e=n(ls,"A",{id:!0,class:!0,href:!0});var _a=r(_e);st=n(_a,"SPAN",{});var ya=r(st);y(De.$$.fragment,ya),ya.forEach(t),_a.forEach(t),As=c(ls),nt=n(ls,"SPAN",{});var ka=r(nt);Es=i(ka,"NystromformerConfig"),ka.forEach(t),ls.forEach(t),Vt=c(o),F=n(o,"DIV",{class:!0});var U=r(F);y(Oe.$$.fragment,U),Ps=c(U),K=n(U,"P",{});var Oo=r(K);Ss=i(Oo,"This is the configuration class to store the configuration of a "),Co=n(Oo,"A",{href:!0});var va=r(Co);Is=i(va,"NystromformerModel"),va.forEach(t),Ls=i(Oo,`. It is used to instantiate
an Nystromformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Nystromformer
`),We=n(Oo,"A",{href:!0,rel:!0});var ba=r(We);Ds=i(ba,"uw-madison/nystromformer-512"),ba.forEach(t),Os=i(Oo," architecture."),Oo.forEach(t),Ws=c(U),X=n(U,"P",{});var Wo=r(X);Bs=i(Wo,"Configuration objects inherit from "),jo=n(Wo,"A",{href:!0});var wa=r(jo);Qs=i(wa,"PretrainedConfig"),wa.forEach(t),Us=i(Wo,` and can be used to control the model outputs. Read the
documentation from `),xo=n(Wo,"A",{href:!0});var Ta=r(xo);Hs=i(Ta,"PretrainedConfig"),Ta.forEach(t),Rs=i(Wo," for more information."),Wo.forEach(t),Vs=c(U),rt=n(U,"P",{});var Na=r(rt);Gs=i(Na,"Example:"),Na.forEach(t),Js=c(U),y(Be.$$.fragment,U),U.forEach(t),Gt=c(o),ee=n(o,"H2",{class:!0});var ds=r(ee);ye=n(ds,"A",{id:!0,class:!0,href:!0});var $a=r(ye);at=n($a,"SPAN",{});var Ma=r(at);y(Qe.$$.fragment,Ma),Ma.forEach(t),$a.forEach(t),Ys=c(ds),it=n(ds,"SPAN",{});var za=r(it);Zs=i(za,"NystromformerModel"),za.forEach(t),ds.forEach(t),Jt=c(o),W=n(o,"DIV",{class:!0});var Bo=r(W);y(Ue.$$.fragment,Bo),Ks=c(Bo),He=n(Bo,"P",{});var cs=r(He);Xs=i(cs,`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Re=n(cs,"A",{href:!0,rel:!0});var qa=r(Re);en=i(qa,"torch.nn.Module"),qa.forEach(t),on=i(cs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),cs.forEach(t),tn=c(Bo),C=n(Bo,"DIV",{class:!0});var H=r(C);y(Ve.$$.fragment,H),sn=c(H),oe=n(H,"P",{});var Qo=r(oe);nn=i(Qo,"The "),Ao=n(Qo,"A",{href:!0});var Fa=r(Ao);rn=i(Fa,"NystromformerModel"),Fa.forEach(t),an=i(Qo," forward method, overrides the "),lt=n(Qo,"CODE",{});var Ca=r(lt);ln=i(Ca,"__call__"),Ca.forEach(t),dn=i(Qo," special method."),Qo.forEach(t),cn=c(H),y(ke.$$.fragment,H),mn=c(H),dt=n(H,"P",{});var ja=r(dt);pn=i(ja,"Example:"),ja.forEach(t),hn=c(H),y(Ge.$$.fragment,H),H.forEach(t),Bo.forEach(t),Yt=c(o),te=n(o,"H2",{class:!0});var ms=r(te);ve=n(ms,"A",{id:!0,class:!0,href:!0});var xa=r(ve);ct=n(xa,"SPAN",{});var Aa=r(ct);y(Je.$$.fragment,Aa),Aa.forEach(t),xa.forEach(t),fn=c(ms),mt=n(ms,"SPAN",{});var Ea=r(mt);un=i(Ea,"NystromformerForMaskedLM"),Ea.forEach(t),ms.forEach(t),Zt=c(o),B=n(o,"DIV",{class:!0});var Uo=r(B);y(Ye.$$.fragment,Uo),gn=c(Uo),se=n(Uo,"P",{});var Ho=r(se);_n=i(Ho,"Nystr\xF6mformer Model with a "),pt=n(Ho,"CODE",{});var Pa=r(pt);yn=i(Pa,"language modeling"),Pa.forEach(t),kn=i(Ho,` head on top.
This model is a PyTorch `),Ze=n(Ho,"A",{href:!0,rel:!0});var Sa=r(Ze);vn=i(Sa,"torch.nn.Module"),Sa.forEach(t),bn=i(Ho,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ho.forEach(t),wn=c(Uo),j=n(Uo,"DIV",{class:!0});var R=r(j);y(Ke.$$.fragment,R),Tn=c(R),ne=n(R,"P",{});var Ro=r(ne);Nn=i(Ro,"The "),Eo=n(Ro,"A",{href:!0});var Ia=r(Eo);$n=i(Ia,"NystromformerForMaskedLM"),Ia.forEach(t),Mn=i(Ro," forward method, overrides the "),ht=n(Ro,"CODE",{});var La=r(ht);zn=i(La,"__call__"),La.forEach(t),qn=i(Ro," special method."),Ro.forEach(t),Fn=c(R),y(be.$$.fragment,R),Cn=c(R),ft=n(R,"P",{});var Da=r(ft);jn=i(Da,"Example:"),Da.forEach(t),xn=c(R),y(Xe.$$.fragment,R),R.forEach(t),Uo.forEach(t),Kt=c(o),re=n(o,"H2",{class:!0});var ps=r(re);we=n(ps,"A",{id:!0,class:!0,href:!0});var Oa=r(we);ut=n(Oa,"SPAN",{});var Wa=r(ut);y(eo.$$.fragment,Wa),Wa.forEach(t),Oa.forEach(t),An=c(ps),gt=n(ps,"SPAN",{});var Ba=r(gt);En=i(Ba,"NystromformerForSequenceClassification"),Ba.forEach(t),ps.forEach(t),Xt=c(o),S=n(o,"DIV",{class:!0});var Ce=r(S);y(oo.$$.fragment,Ce),Pn=c(Ce),_t=n(Ce,"P",{});var Qa=r(_t);Sn=i(Qa,`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Qa.forEach(t),In=c(Ce),to=n(Ce,"P",{});var hs=r(to);Ln=i(hs,"This model is a PyTorch "),so=n(hs,"A",{href:!0,rel:!0});var Ua=r(so);Dn=i(Ua,"torch.nn.Module"),Ua.forEach(t),On=i(hs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),hs.forEach(t),Wn=c(Ce),z=n(Ce,"DIV",{class:!0});var P=r(z);y(no.$$.fragment,P),Bn=c(P),ae=n(P,"P",{});var Vo=r(ae);Qn=i(Vo,"The "),Po=n(Vo,"A",{href:!0});var Ha=r(Po);Un=i(Ha,"NystromformerForSequenceClassification"),Ha.forEach(t),Hn=i(Vo," forward method, overrides the "),yt=n(Vo,"CODE",{});var Ra=r(yt);Rn=i(Ra,"__call__"),Ra.forEach(t),Vn=i(Vo," special method."),Vo.forEach(t),Gn=c(P),y(Te.$$.fragment,P),Jn=c(P),kt=n(P,"P",{});var Va=r(kt);Yn=i(Va,"Example of single-label classification:"),Va.forEach(t),Zn=c(P),y(ro.$$.fragment,P),Kn=c(P),vt=n(P,"P",{});var Ga=r(vt);Xn=i(Ga,"Example of multi-label classification:"),Ga.forEach(t),er=c(P),y(ao.$$.fragment,P),P.forEach(t),Ce.forEach(t),es=c(o),ie=n(o,"H2",{class:!0});var fs=r(ie);Ne=n(fs,"A",{id:!0,class:!0,href:!0});var Ja=r(Ne);bt=n(Ja,"SPAN",{});var Ya=r(bt);y(io.$$.fragment,Ya),Ya.forEach(t),Ja.forEach(t),or=c(fs),wt=n(fs,"SPAN",{});var Za=r(wt);tr=i(Za,"NystromformerForMultipleChoice"),Za.forEach(t),fs.forEach(t),os=c(o),I=n(o,"DIV",{class:!0});var je=r(I);y(lo.$$.fragment,je),sr=c(je),Tt=n(je,"P",{});var Ka=r(Tt);nr=i(Ka,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_s.forEach(t),qr=c(xe),A=n(xe,"DIV",{class:!0});var G=r(A);y(yo.$$.fragment,G),Fr=c(G),ce=n(G,"P",{});var Jo=r(ce);Cr=i(Jo,"The "),Io=n(Jo,"A",{href:!0});var li=r(Io);jr=i(li,"NystromformerForTokenClassification"),li.forEach(t),xr=i(Jo," forward method, overrides the "),Ft=n(Jo,"CODE",{});var di=r(Ft);Ar=i(di,"__call__"),di.forEach(t),Er=i(Jo," special method."),Jo.forEach(t),Pr=c(G),y(ze.$$.fragment,G),Sr=c(G),Ct=n(G,"P",{});var ci=r(Ct);Ir=i(ci,"Example:"),ci.forEach(t),Lr=c(G),y(ko.$$.fragment,G),G.forEach(t),xe.forEach(t),ns=c(o),me=n(o,"H2",{class:!0});var ys=r(me);qe=n(ys,"A",{id:!0,class:!0,href:!0});var mi=r(qe);jt=n(mi,"SPAN",{});var pi=r(jt);y(vo.$$.fragment,pi),pi.forEach(t),mi.forEach(t),Dr=c(ys),xt=n(ys,"SPAN",{});var hi=r(xt);Or=i(hi,"NystromformerForQuestionAnswering"),hi.forEach(t),ys.forEach(t),rs=c(o),D=n(o,"DIV",{class:!0});var Ae=r(D);y(bo.$$.fragment,Ae),Wr=c(Ae),pe=n(Ae,"P",{});var Yo=r(pe);Br=i(Yo,`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),At=n(Yo,"CODE",{});var fi=r(At);Qr=i(fi,"span start logits"),fi.forEach(t),Ur=i(Yo," and "),Et=n(Yo,"CODE",{});var ui=r(Et);Hr=i(ui,"span end logits"),ui.forEach(t),Rr=i(Yo,")."),Yo.forEach(t),Vr=c(Ae),wo=n(Ae,"P",{});var ks=r(wo);Gr=i(ks,"This model is a PyTorch "),To=n(ks,"A",{href:!0,rel:!0});var gi=r(To);Jr=i(gi,"torch.nn.Module"),gi.forEach(t),Yr=i(ks,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ks.forEach(t),Zr=c(Ae),E=n(Ae,"DIV",{class:!0});var J=r(E);y(No.$$.fragment,J),Kr=c(J),he=n(J,"P",{});var Zo=r(he);Xr=i(Zo,"The "),Lo=n(Zo,"A",{href:!0});var _i=r(Lo);ea=i(_i,"NystromformerForQuestionAnswering"),_i.forEach(t),oa=i(Zo," forward method, overrides the "),Pt=n(Zo,"CODE",{});var yi=r(Pt);ta=i(yi,"__call__"),yi.forEach(t),sa=i(Zo," special method."),Zo.forEach(t),na=c(J),y(Fe.$$.fragment,J),ra=c(J),St=n(J,"P",{});var ki=r(St);aa=i(ki,"Example:"),ki.forEach(t),ia=c(J),y($o.$$.fragment,J),J.forEach(t),Ae.forEach(t),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(ji)),l(T,"id","nystrmformer"),l(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(T,"href","#nystrmformer"),l(h,"class","relative group"),l(ue,"id","overview"),l(ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ue,"href","#overview"),l(Y,"class","relative group"),l(Se,"href","https://arxiv.org/abs/2102.03902"),l(Se,"rel","nofollow"),l(Ie,"href","https://huggingface.co/novice03"),l(Ie,"rel","nofollow"),l(Le,"href","https://github.com/mlpen/Nystromformer"),l(Le,"rel","nofollow"),l(_e,"id","transformers.NystromformerConfig"),l(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(_e,"href","#transformers.NystromformerConfig"),l(Z,"class","relative group"),l(Co,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerModel"),l(We,"href","https://huggingface.co/uw-madison/nystromformer-512"),l(We,"rel","nofollow"),l(jo,"href","/docs/transformers/pr_15987/en/main_classes/configuration#transformers.PretrainedConfig"),l(xo,"href","/docs/transformers/pr_15987/en/main_classes/configuration#transformers.PretrainedConfig"),l(F,"class","docstring"),l(ye,"id","transformers.NystromformerModel"),l(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ye,"href","#transformers.NystromformerModel"),l(ee,"class","relative group"),l(Re,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Re,"rel","nofollow"),l(Ao,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerModel"),l(C,"class","docstring"),l(W,"class","docstring"),l(ve,"id","transformers.NystromformerForMaskedLM"),l(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ve,"href","#transformers.NystromformerForMaskedLM"),l(te,"class","relative group"),l(Ze,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ze,"rel","nofollow"),l(Eo,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerForMaskedLM"),l(j,"class","docstring"),l(B,"class","docstring"),l(we,"id","transformers.NystromformerForSequenceClassification"),l(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(we,"href","#transformers.NystromformerForSequenceClassification"),l(re,"class","relative group"),l(so,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(so,"rel","nofollow"),l(Po,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerForSequenceClassification"),l(z,"class","docstring"),l(S,"class","docstring"),l(Ne,"id","transformers.NystromformerForMultipleChoice"),l(Ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ne,"href","#transformers.NystromformerForMultipleChoice"),l(ie,"class","relative group"),l(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(mo,"rel","nofollow"),l(So,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerForMultipleChoice"),l(x,"class","docstring"),l(I,"class","docstring"),l(Me,"id","transformers.NystromformerForTokenClassification"),l(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Me,"href","#transformers.NystromformerForTokenClassification"),l(de,"class","relative group"),l(_o,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(_o,"rel","nofollow"),l(Io,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerForTokenClassification"),l(A,"class","docstring"),l(L,"class","docstring"),l(qe,"id","transformers.NystromformerForQuestionAnswering"),l(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(qe,"href","#transformers.NystromformerForQuestionAnswering"),l(me,"class","relative group"),l(To,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(To,"rel","nofollow"),l(Lo,"href","/docs/transformers/pr_15987/en/model_doc/nystromformer#transformers.NystromformerForQuestionAnswering"),l(E,"class","docstring"),l(D,"class","docstring")},m(o,p){e(document.head,m),f(o,N,p),f(o,h,p),e(h,T),e(T,$),k(g,$,null),e(h,u),e(h,M),e(M,vs),f(o,Wt,p),f(o,Y,p),e(Y,ue),e(ue,Xo),k(Pe,Xo,null),e(Y,bs),e(Y,et),e(et,ws),f(o,Bt,p),f(o,ge,p),e(ge,Ts),e(ge,Se),e(Se,ot),e(ot,Ns),e(ge,$s),f(o,Qt,p),f(o,qo,p),e(qo,Ms),f(o,Ut,p),f(o,Fo,p),e(Fo,tt),e(tt,zs),f(o,Ht,p),f(o,Q,p),e(Q,qs),e(Q,Ie),e(Ie,Fs),e(Q,Cs),e(Q,Le),e(Le,js),e(Q,xs),f(o,Rt,p),f(o,Z,p),e(Z,_e),e(_e,st),k(De,st,null),e(Z,As),e(Z,nt),e(nt,Es),f(o,Vt,p),f(o,F,p),k(Oe,F,null),e(F,Ps),e(F,K),e(K,Ss),e(K,Co),e(Co,Is),e(K,Ls),e(K,We),e(We,Ds),e(K,Os),e(F,Ws),e(F,X),e(X,Bs),e(X,jo),e(jo,Qs),e(X,Us),e(X,xo),e(xo,Hs),e(X,Rs),e(F,Vs),e(F,rt),e(rt,Gs),e(F,Js),k(Be,F,null),f(o,Gt,p),f(o,ee,p),e(ee,ye),e(ye,at),k(Qe,at,null),e(ee,Ys),e(ee,it),e(it,Zs),f(o,Jt,p),f(o,W,p),k(Ue,W,null),e(W,Ks),e(W,He),e(He,Xs),e(He,Re),e(Re,en),e(He,on),e(W,tn),e(W,C),k(Ve,C,null),e(C,sn),e(C,oe),e(oe,nn),e(oe,Ao),e(Ao,rn),e(oe,an),e(oe,lt),e(lt,ln),e(oe,dn),e(C,cn),k(ke,C,null),e(C,mn),e(C,dt),e(dt,pn),e(C,hn),k(Ge,C,null),f(o,Yt,p),f(o,te,p),e(te,ve),e(ve,ct),k(Je,ct,null),e(te,fn),e(te,mt),e(mt,un),f(o,Zt,p),f(o,B,p),k(Ye,B,null),e(B,gn),e(B,se),e(se,_n),e(se,pt),e(pt,yn),e(se,kn),e(se,Ze),e(Ze,vn),e(se,bn),e(B,wn),e(B,j),k(Ke,j,null),e(j,Tn),e(j,ne),e(ne,Nn),e(ne,Eo),e(Eo,$n),e(ne,Mn),e(ne,ht),e(ht,zn),e(ne,qn),e(j,Fn),k(be,j,null),e(j,Cn),e(j,ft),e(ft,jn),e(j,xn),k(Xe,j,null),f(o,Kt,p),f(o,re,p),e(re,we),e(we,ut),k(eo,ut,null),e(re,An),e(re,gt),e(gt,En),f(o,Xt,p),f(o,S,p),k(oo,S,null),e(S,Pn),e(S,_t),e(_t,Sn),e(S,In),e(S,to),e(to,Ln),e(to,so),e(so,Dn),e(to,On),e(S,Wn),e(S,z),k(no,z,null),e(z,Bn),e(z,ae),e(ae,Qn),e(ae,Po),e(Po,Un),e(ae,Hn),e(ae,yt),e(yt,Rn),e(ae,Vn),e(z,Gn),k(Te,z,null),e(z,Jn),e(z,kt),e(kt,Yn),e(z,Zn),k(ro,z,null),e(z,Kn),e(z,vt),e(vt,Xn),e(z,er),k(ao,z,null),f(o,es,p),f(o,ie,p),e(ie,Ne),e(Ne,bt),k(io,bt,null),e(ie,or),e(ie,wt),e(wt,tr),f(o,os,p),f(o,I,p),k(lo,I,null),e(I,sr),e(I,Tt),e(Tt,nr),e(I,rr),e(I,co),e(co,ar),e(co,mo),e(mo,ir),e(co,lr),e(I,dr),e(I,x),k(po,x,null),e(x,cr),e(x,le),e(le,mr),e(le,So),e(So,pr),e(le,hr),e(le,Nt),e(Nt,fr),e(le,ur),e(x,gr),k($e,x,null),e(x,_r),e(x,$t),e($t,yr),e(x,kr),k(ho,x,null),f(o,ts,p),f(o,de,p),e(de,Me),e(Me,Mt),k(fo,Mt,null),e(de,vr),e(de,zt),e(zt,br),f(o,ss,p),f(o,L,p),k(uo,L,null),e(L,wr),e(L,qt),e(qt,Tr),e(L,Nr),e(L,go),e(go,$r),e(go,_o),e(_o,Mr),e(go,zr),e(L,qr),e(L,A),k(yo,A,null),e(A,Fr),e(A,ce),e(ce,Cr),e(ce,Io),e(Io,jr),e(ce,xr),e(ce,Ft),e(Ft,Ar),e(ce,Er),e(A,Pr),k(ze,A,null),e(A,Sr),e(A,Ct),e(Ct,Ir),e(A,Lr),k(ko,A,null),f(o,ns,p),f(o,me,p),e(me,qe),e(qe,jt),k(vo,jt,null),e(me,Dr),e(me,xt),e(xt,Or),f(o,rs,p),f(o,D,p),k(bo,D,null),e(D,Wr),e(D,pe),e(pe,Br),e(pe,At),e(At,Qr),e(pe,Ur),e(pe,Et),e(Et,Hr),e(pe,Rr),e(D,Vr),e(D,wo),e(wo,Gr),e(wo,To),e(To,Jr),e(wo,Yr),e(D,Zr),e(D,E),k(No,E,null),e(E,Kr),e(E,he),e(he,Xr),e(he,Lo),e(Lo,ea),e(he,oa),e(he,Pt),e(Pt,ta),e(he,sa),e(E,na),k(Fe,E,null),e(E,ra),e(E,St),e(St,aa),e(E,ia),k($o,E,null),as=!0},p(o,[p]){const Mo={};p&2&&(Mo.$$scope={dirty:p,ctx:o}),ke.$set(Mo);const It={};p&2&&(It.$$scope={dirty:p,ctx:o}),be.$set(It);const Lt={};p&2&&(Lt.$$scope={dirty:p,ctx:o}),Te.$set(Lt);const Dt={};p&2&&(Dt.$$scope={dirty:p,ctx:o}),$e.$set(Dt);const zo={};p&2&&(zo.$$scope={dirty:p,ctx:o}),ze.$set(zo);const Ot={};p&2&&(Ot.$$scope={dirty:p,ctx:o}),Fe.$set(Ot)},i(o){as||(v(g.$$.fragment,o),v(Pe.$$.fragment,o),v(De.$$.fragment,o),v(Oe.$$.fragment,o),v(Be.$$.fragment,o),v(Qe.$$.fragment,o),v(Ue.$$.fragment,o),v(Ve.$$.fragment,o),v(ke.$$.fragment,o),v(Ge.$$.fragment,o),v(Je.$$.fragment,o),v(Ye.$$.fragment,o),v(Ke.$$.fragment,o),v(be.$$.fragment,o),v(Xe.$$.fragment,o),v(eo.$$.fragment,o),v(oo.$$.fragment,o),v(no.$$.fragment,o),v(Te.$$.fragment,o),v(ro.$$.fragment,o),v(ao.$$.fragment,o),v(io.$$.fragment,o),v(lo.$$.fragment,o),v(po.$$.fragment,o),v($e.$$.fragment,o),v(ho.$$.fragment,o),v(fo.$$.fragment,o),v(uo.$$.fragment,o),v(yo.$$.fragment,o),v(ze.$$.fragment,o),v(ko.$$.fragment,o),v(vo.$$.fragment,o),v(bo.$$.fragment,o),v(No.$$.fragment,o),v(Fe.$$.fragment,o),v($o.$$.fragment,o),as=!0)},o(o){b(g.$$.fragment,o),b(Pe.$$.fragment,o),b(De.$$.fragment,o),b(Oe.$$.fragment,o),b(Be.$$.fragment,o),b(Qe.$$.fragment,o),b(Ue.$$.fragment,o),b(Ve.$$.fragment,o),b(ke.$$.fragment,o),b(Ge.$$.fragment,o),b(Je.$$.fragment,o),b(Ye.$$.fragment,o),b(Ke.$$.fragment,o),b(be.$$.fragment,o),b(Xe.$$.fragment,o),b(eo.$$.fragment,o),b(oo.$$.fragment,o),b(no.$$.fragment,o),b(Te.$$.fragment,o),b(ro.$$.fragment,o),b(ao.$$.fragment,o),b(io.$$.fragment,o),b(lo.$$.fragment,o),b(po.$$.fragment,o),b($e.$$.fragment,o),b(ho.$$.fragment,o),b(fo.$$.fragment,o),b(uo.$$.fragment,o),b(yo.$$.fragment,o),b(ze.$$.fragment,o),b(ko.$$.fragment,o),b(vo.$$.fragment,o),b(bo.$$.fragment,o),b(No.$$.fragment,o),b(Fe.$$.fragment,o),b($o.$$.fragment,o),as=!1},d(o){t(m),o&&t(N),o&&t(h),w(g),o&&t(Wt),o&&t(Y),w(Pe),o&&t(Bt),o&&t(ge),o&&t(Qt),o&&t(qo),o&&t(Ut),o&&t(Fo),o&&t(Ht),o&&t(Q),o&&t(Rt),o&&t(Z),w(De),o&&t(Vt),o&&t(F),w(Oe),w(Be),o&&t(Gt),o&&t(ee),w(Qe),o&&t(Jt),o&&t(W),w(Ue),w(Ve),w(ke),w(Ge),o&&t(Yt),o&&t(te),w(Je),o&&t(Zt),o&&t(B),w(Ye),w(Ke),w(be),w(Xe),o&&t(Kt),o&&t(re),w(eo),o&&t(Xt),o&&t(S),w(oo),w(no),w(Te),w(ro),w(ao),o&&t(es),o&&t(ie),w(io),o&&t(os),o&&t(I),w(lo),w(po),w($e),w(ho),o&&t(ts),o&&t(de),w(fo),o&&t(ss),o&&t(L),w(uo),w(yo),w(ze),w(ko),o&&t(ns),o&&t(me),w(vo),o&&t(rs),o&&t(D),w(bo),w(No),w(Fe),w($o)}}}const ji={local:"nystrmformer",sections:[{local:"overview",title:"Overview"},{local:"transformers.NystromformerConfig",title:"NystromformerConfig"},{local:"transformers.NystromformerModel",title:"NystromformerModel"},{local:"transformers.NystromformerForMaskedLM",title:"NystromformerForMaskedLM"},{local:"transformers.NystromformerForSequenceClassification",title:"NystromformerForSequenceClassification"},{local:"transformers.NystromformerForMultipleChoice",title:"NystromformerForMultipleChoice"},{local:"transformers.NystromformerForTokenClassification",title:"NystromformerForTokenClassification"},{local:"transformers.NystromformerForQuestionAnswering",title:"NystromformerForQuestionAnswering"}],title:"Nystr\xF6mformer"};function xi(q,m,N){let{fw:h}=m;return q.$$set=T=>{"fw"in T&&N(0,h=T.fw)},[h]}class Di extends vi{constructor(m){super();bi(this,m,xi,Ci,wi,{fw:0})}}export{Di as default,ji as metadata};
