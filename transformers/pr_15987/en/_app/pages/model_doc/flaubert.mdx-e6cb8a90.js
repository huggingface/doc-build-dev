...
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Db(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),G=l(),z=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
...
first positional argument :`),Y=l(),x=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,G,T),u(c,z,T),e(z,J),e(z,H),e(H,Z),e(z,de),e(z,Q),e(Q,ce),e(z,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,Y,T),u(c,x,T),e(x,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(x,re),e(x,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(x,ge),e(x,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(G),c&&t(z),c&&t(U),c&&t(X),c&&t(Y),c&&t(x)}}}function Wb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Ob(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),G=l(),z=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Y=l(),x=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),G=d(c),z=r(c,"P",{});var P=i(z);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),Y=d(c),x=r(c,"UL",{});var A=i(x);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,G,T),u(c,z,T),e(z,J),e(z,H),e(H,Z),e(z,de),e(z,Q),e(Q,ce),e(z,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,Y,T),u(c,x,T),e(x,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(x,re),e(x,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(x,ge),e(x,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(G),c&&t(z),c&&t(U),c&&t(X),c&&t(Y),c&&t(x)}}}function Hb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Qb(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),G=l(),z=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Y=l(),x=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),G=d(c),z=r(c,"P",{});var P=i(z);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),Y=d(c),x=r(c,"UL",{});var A=i(x);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,G,T),u(c,z,T),e(z,J),e(z,H),e(H,Z),e(z,de),e(z,Q),e(Q,ce),e(z,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,Y,T),u(c,x,T),e(x,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(x,re),e(x,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(x,ge),e(x,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(G),c&&t(z),c&&t(U),c&&t(X),c&&t(Y),c&&t(x)}}}function Bb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Rb(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),G=l(),z=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Y=l(),x=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),G=d(c),z=r(c,"P",{});var P=i(z);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),Y=d(c),x=r(c,"UL",{});var A=i(x);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,G,T),u(c,z,T),e(z,J),e(z,H),e(H,Z),e(z,de),e(z,Q),e(Q,ce),e(z,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,Y,T),u(c,x,T),e(x,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(x,re),e(x,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(x,ge),e(x,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(G),c&&t(z),c&&t(U),c&&t(X),c&&t(Y),c&&t(x)}}}function Ub(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Vb(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),G=l(),z=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Y=l(),x=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),G=d(c),z=r(c,"P",{});var P=i(z);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),Y=d(c),x=r(c,"UL",{});var A=i(x);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,G,T),u(c,z,T),e(z,J),e(z,H),e(H,Z),e(z,de),e(z,Q),e(Q,ce),e(z,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,Y,T),u(c,x,T),e(x,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(x,re),e(x,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(x,ge),e(x,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(G),c&&t(z),c&&t(U),c&&t(X),c&&t(Y),c&&t(x)}}}function Gb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Yb(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),G=l(),z=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Y=l(),x=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),G=d(c),z=r(c,"P",{});var P=i(z);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),Y=d(c),x=r(c,"UL",{});var A=i(x);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,G,T),u(c,z,T),e(z,J),e(z,H),e(H,Z),e(z,de),e(z,Q),e(Q,ce),e(z,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,Y,T),u(c,x,T),e(x,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(x,re),e(x,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(x,ge),e(x,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(G),c&&t(z),c&&t(U),c&&t(X),c&&t(Y),c&&t(x)}}}function Kb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Jb(O){let p,k,m,g,v,b,f,w,le,G,z,J,H,Z,de,Q,ce,se,U,X,ee,Y,x,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,K,S,ne,c,T,V,we,Te,P,ke,ye,_e,A,D,Fe,Me,W,$e,Le,be,ve,Jl,Bs,Zl,ed,Rs,td,od,zi,Ct,co,Ba,Ro,nd,Ra,sd,xi,st,Uo,ad,Ua,rd,id,_t,Va,ld,dd,Ga,cd,pd,bt,hd,Ya,ud,md,Ka,fd,gd,Ja,_d,bd,vd,Vo,kd,Za,Td,wd,yd,Go,Fd,Us,Md,$d,qi,Pt,po,er,Yo,Ld,tr,Ed,Ci,He,Ko,zd,or,xd,qd,Jo,Cd,Vs,Pd,jd,Xd,Zo,Ad,en,Sd,Nd,Id,Qe,tn,Dd,jt,Wd,Gs,Od,Hd,nr,Qd,Bd,Rd,ho,Ud,sr,Vd,Gd,on,Pi,Xt,uo,ar,nn,Yd,rr,Kd,ji,xe,sn,Jd,ir,Zd,ec,an,tc,Ys,oc,nc,sc,rn,ac,ln,rc,ic,lc,dn,dc,Ks,cc,pc,hc,Be,cn,uc,At,mc,Js,fc,gc,lr,_c,bc,vc,mo,kc,dr,Tc,wc,pn,Xi,St,fo,cr,hn,yc,pr,Fc,Ai,qe,un,Mc,hr,$c,Lc,mn,Ec,Zs,zc,xc,qc,fn,Cc,gn,Pc,jc,Xc,_n,Ac,ea,Sc,Nc,Ic,ze,bn,Dc,Nt,Wc,ta,Oc,Hc,ur,Qc,Bc,Rc,go,Uc,mr,Vc,Gc,vn,Yc,fr,Kc,Jc,kn,Si,It,_o,gr,Tn,Zc,_r,ep,Ni,Ce,wn,tp,br,op,np,yn,sp,oa,ap,rp,ip,Fn,lp,Mn,dp,cp,pp,$n,hp,na,up,mp,fp,Re,Ln,gp,Dt,_p,sa,bp,vp,vr,kp,Tp,wp,bo,yp,kr,Fp,Mp,En,Ii,Wt,vo,Tr,zn,$p,wr,Lp,Di,Pe,xn,Ep,yr,zp,xp,qn,qp,aa,Cp,Pp,jp,Cn,Xp,Pn,Ap,Sp,Np,jn,Ip,ra,Dp,Wp,Op,Ue,Xn,Hp,Ot,Qp,ia,Bp,Rp,Fr,Up,Vp,Gp,ko,Yp,Mr,Kp,Jp,An,Wi,Ht,To,$r,Sn,Zp,Lr,eh,Oi,je,Nn,th,Qt,oh,Er,nh,sh,zr,ah,rh,ih,In,lh,la,dh,ch,ph,Dn,hh,Wn,uh,mh,fh,On,gh,da,_h,bh,vh,Ve,Hn,kh,Bt,Th,ca,wh,yh,xr,Fh,Mh,$h,wo,Lh,qr,Eh,zh,Qn,Hi,Rt,yo,Cr,Bn,xh,Pr,qh,Qi,Xe,Rn,Ch,Ut,Ph,jr,jh,Xh,Xr,Ah,Sh,Nh,Un,Ih,pa,Dh,Wh,Oh,Vn,Hh,Gn,Qh,Bh,Rh,Yn,Uh,ha,Vh,Gh,Yh,Ge,Kn,Kh,Vt,Jh,ua,Zh,eu,Ar,tu,ou,nu,Fo,su,Sr,au,ru,Jn,Bi,Gt,Mo,Nr,Zn,iu,Ir,lu,Ri,Ae,es,du,Dr,cu,pu,ts,hu,ma,uu,mu,fu,os,gu,ns,_u,bu,vu,$o,ku,Ye,ss,Tu,Yt,wu,fa,yu,Fu,Wr,Mu,$u,Lu,Lo,Eu,Or,zu,xu,as,Ui,Kt,Eo,Hr,rs,qu,Qr,Cu,Vi,Se,is,Pu,Br,ju,Xu,ls,Au,ga,Su,Nu,Iu,ds,Du,cs,Wu,Ou,Hu,zo,Qu,Ke,ps,Bu,Jt,Ru,_a,Uu,Vu,Rr,Gu,Yu,Ku,xo,Ju,Ur,Zu,em,hs,Gi,Zt,qo,Vr,us,tm,Gr,om,Yi,Ne,ms,nm,Yr,sm,am,fs,rm,ba,im,lm,dm,gs,cm,_s,pm,hm,um,Co,mm,Je,bs,fm,eo,gm,va,_m,bm,Kr,vm,km,Tm,Po,wm,Jr,ym,Fm,vs,Ki,to,jo,Zr,ks,Mm,ei,$m,Ji,Ie,Ts,Lm,ti,Em,zm,ws,xm,ka,qm,Cm,Pm,ys,jm,Fs,Xm,Am,Sm,Xo,Nm,Ze,Ms,Im,oo,Dm,Ta,Wm,Om,oi,Hm,Qm,Bm,Ao,Rm,ni,Um,Vm,$s,Zi,no,So,si,Ls,Gm,ai,Ym,el,De,Es,Km,ri,Jm,Zm,zs,ef,wa,tf,of,nf,xs,sf,qs,af,rf,lf,No,df,et,Cs,cf,so,pf,ya,hf,uf,ii,mf,ff,gf,Io,_f,li,bf,vf,Ps,tl,ao,Do,di,js,kf,ci,Tf,ol,We,Xs,wf,ro,yf,pi,Ff,Mf,hi,$f,Lf,Ef,As,zf,Fa,xf,qf,Cf,Ss,Pf,Ns,jf,Xf,Af,Wo,Sf,tt,Is,Nf,io,If,Ma,Df,Wf,ui,Of,Hf,Qf,Oo,Bf,mi,Rf,Uf,Ds,nl;return b=new Oe({}),Z=new Oe({}),c=new Oe({}),ke=new ie({props:{name:"class transformers.FlaubertConfig",anchor:"transformers.FlaubertConfig",parameters:[{name:"layerdrop",val:" = 0.0"},{name:"pre_norm",val:" = False"},{name:"pad_token_id",val:" = 2"},{name:"bos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/flaubert/configuration_flaubert.py#L31",parametersDescription:[{anchor:"transformers.FlaubertConfig.pre_norm",description:`<strong>pre_norm</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
`}}),Io=new Ee({props:{$$slots:{default:[Gb]},$$scope:{ctx:O}}}),Ps=new nt({props:{code:`from transformers import XLMTokenizer, TFXLMForTokenClassification
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15987/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wo=new Ee({props:{$$slots:{default:[Yb]},$$scope:{ctx:O}}}),Is=new ie({props:{name:"call",anchor:"transformers.TFXLMForQuestionAnsweringSimple.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15987/src/transformers/models/xlm/modeling_tf_xlm.py#L1327",parametersDescription:[{anchor:"transformers.TFXLMForQuestionAnsweringSimple.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15987/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15987/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&quot; &quot;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] + <span class="hljs-number">1</span>])`}}),{c(){p=a("meta"),k=l(),m=a("h1"),g=a("a"),v=a("span"),y(b.$$.fragment),f=l(),w=a("span"),le=o("FlauBERT"),G=l(),z=a("h2"),J=a("a"),H=a("span"),y(Z.$$.fragment),de=l(),Q=a("span"),ce=o("Overview"),se=l(),U=a("p"),X=o("The FlauBERT model was proposed in the paper "),ee=a("a"),Y=o("FlauBERT: Unsupervised Language Model Pre-training for French"),x=o(` by Hang Le et al. It\u2019s a transformer model pretrained using a masked language
...
documentation from `),Rs=a("a"),td=o("PretrainedConfig"),od=o(" for more information."),zi=l(),Ct=a("h2"),co=a("a"),Ba=a("span"),y(Ro.$$.fragment),nd=l(),Ra=a("span"),sd=o("FlaubertTokenizer"),xi=l(),st=a("div"),y(Uo.$$.fragment),ad=l(),Ua=a("p"),rd=o("Construct a Flaubert tokenizer. Based on Byte-Pair Encoding. The tokenization process is the following:"),id=l(),_t=a("ul"),Va=a("li"),ld=o("Moses preprocessing and tokenization."),dd=l(),Ga=a("li"),cd=o("Normalizing all inputs text."),pd=l(),bt=a("li"),hd=o("The arguments "),Ya=a("code"),ud=o("special_tokens"),md=o(" and the function "),Ka=a("code"),fd=o("set_special_tokens"),gd=o(`, can be used to add additional symbols (like
\u201D`),Ja=a("strong"),_d=o("classify"),bd=o("\u201D) to a vocabulary."),vd=l(),Vo=a("li"),kd=o("The argument "),Za=a("code"),Td=o("do_lowercase"),wd=o(" controls lower casing (automatically set for pretrained vocabularies)."),yd=l(),Go=a("p"),Fd=o("This tokenizer inherits from "),Us=a("a"),Md=o("XLMTokenizer"),$d=o(`. Please check the superclass for usage examples and documentation
regarding arguments.`),qi=l(),Pt=a("h2"),po=a("a"),er=a("span"),y(Yo.$$.fragment),Ld=l(),tr=a("span"),Ed=o("FlaubertModel"),Ci=l(),He=a("div"),y(Ko.$$.fragment),zd=l(),or=a("p"),xd=o("The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),qd=l(),Jo=a("p"),Cd=o("This model inherits from "),Vs=a("a"),Pd=o("PreTrainedModel"),jd=o(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Id=l(),Qe=a("div"),y(tn.$$.fragment),Dd=l(),jt=a("p"),Wd=o("The "),Gs=a("a"),Od=o("FlaubertModel"),Hd=o(" forward method, overrides the "),nr=a("code"),Qd=o("__call__"),Bd=o(" special method."),Rd=l(),y(ho.$$.fragment),Ud=l(),sr=a("p"),Vd=o("Example:"),Gd=l(),y(on.$$.fragment),Pi=l(),Xt=a("h2"),uo=a("a"),ar=a("span"),y(nn.$$.fragment),Yd=l(),rr=a("span"),Kd=o("FlaubertWithLMHeadModel"),ji=l(),xe=a("div"),y(sn.$$.fragment),Jd=l(),ir=a("p"),Zd=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
documentation alongside usage examples.`),Ic=l(),ze=a("div"),y(bn.$$.fragment),Dc=l(),Nt=a("p"),Wc=o("The "),ta=a("a"),Oc=o("XLMForSequenceClassification"),Hc=o(" forward method, overrides the "),ur=a("code"),Qc=o("__call__"),Bc=o(" special method."),Rc=l(),y(go.$$.fragment),Uc=l(),mr=a("p"),Vc=o("Example of single-label classification:"),Gc=l(),y(vn.$$.fragment),Yc=l(),fr=a("p"),Kc=o("Example of multi-label classification:"),Jc=l(),y(kn.$$.fragment),Si=l(),It=a("h2"),_o=a("a"),gr=a("span"),y(Tn.$$.fragment),Zc=l(),_r=a("span"),ep=o("FlaubertForMultipleChoice"),Ni=l(),Ce=a("div"),y(wn.$$.fragment),tp=l(),br=a("p"),op=o(`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
alongside usage examples.`),Op=l(),Ue=a("div"),y(Xn.$$.fragment),Hp=l(),Ot=a("p"),Qp=o("The "),ia=a("a"),Bp=o("XLMForTokenClassification"),Rp=o(" forward method, overrides the "),Fr=a("code"),Up=o("__call__"),Vp=o(" special method."),Gp=l(),y(ko.$$.fragment),Yp=l(),Mr=a("p"),Kp=o("Example:"),Jp=l(),y(An.$$.fragment),Wi=l(),Ht=a("h2"),To=a("a"),$r=a("span"),y(Sn.$$.fragment),Zp=l(),Lr=a("span"),eh=o("FlaubertForQuestionAnsweringSimple"),Oi=l(),je=a("div"),y(Nn.$$.fragment),th=l(),Qt=a("p"),oh=o(`Flaubert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oh=l(),Vn=a("p"),Hh=o("This model is also a PyTorch "),Gn=a("a"),Qh=o("torch.nn.Module"),Bh=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rh=l(),Yn=a("p"),Uh=o("This class overrides "),ha=a("a"),Vh=o("XLMForQuestionAnswering"),Gh=o(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Yh=l(),Ge=a("div"),y(Kn.$$.fragment),Kh=l(),Vt=a("p"),Jh=o("The "),ua=a("a"),Zh=o("XLMForQuestionAnswering"),eu=o(" forward method, overrides the "),Ar=a("code"),tu=o("__call__"),ou=o(" special method."),nu=l(),y(Fo.$$.fragment),su=l(),Sr=a("p"),au=o("Example:"),ru=l(),y(Jn.$$.fragment),Bi=l(),Gt=a("h2"),Mo=a("a"),Nr=a("span"),y(Zn.$$.fragment),iu=l(),Ir=a("span"),lu=o("TFFlaubertModel"),Ri=l(),Ae=a("div"),y(es.$$.fragment),du=l(),Dr=a("p"),cu=o("The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),pu=l(),ts=a("p"),hu=o("This model inherits from "),ma=a("a"),uu=o("TFPreTrainedModel"),mu=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu=l(),os=a("p"),gu=o("This model is also a "),ns=a("a"),_u=o("tf.keras.Model"),bu=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vu=l(),y($o.$$.fragment),ku=l(),Ye=a("div"),y(ss.$$.fragment),Tu=l(),Yt=a("p"),wu=o("The "),fa=a("a"),yu=o("TFFlaubertModel"),Fu=o(" forward method, overrides the "),Wr=a("code"),Mu=o("__call__"),$u=o(" special method."),Lu=l(),y(Lo.$$.fragment),Eu=l(),Or=a("p"),zu=o("Example:"),xu=l(),y(as.$$.fragment),Ui=l(),Kt=a("h2"),Eo=a("a"),Hr=a("span"),y(rs.$$.fragment),qu=l(),Qr=a("span"),Cu=o("TFFlaubertWithLMHeadModel"),Vi=l(),Se=a("div"),y(is.$$.fragment),Pu=l(),Br=a("p"),ju=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hu=l(),y(zo.$$.fragment),Qu=l(),Ke=a("div"),y(ps.$$.fragment),Bu=l(),Jt=a("p"),Ru=o("The "),_a=a("a"),Uu=o("TFFlaubertWithLMHeadModel"),Vu=o(" forward method, overrides the "),Rr=a("code"),Gu=o("__call__"),Yu=o(" special method."),Ku=l(),y(xo.$$.fragment),Ju=l(),Ur=a("p"),Zu=o("Example:"),em=l(),y(hs.$$.fragment),Gi=l(),Zt=a("h2"),qo=a("a"),Vr=a("span"),y(us.$$.fragment),tm=l(),Gr=a("span"),om=o("TFFlaubertForSequenceClassification"),Yi=l(),Ne=a("div"),y(ms.$$.fragment),nm=l(),Yr=a("p"),sm=o(`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),um=l(),y(Co.$$.fragment),mm=l(),Je=a("div"),y(bs.$$.fragment),fm=l(),eo=a("p"),gm=o("The "),va=a("a"),_m=o("TFXLMForSequenceClassification"),bm=o(" forward method, overrides the "),Kr=a("code"),vm=o("__call__"),km=o(" special method."),Tm=l(),y(Po.$$.fragment),wm=l(),Jr=a("p"),ym=o("Example:"),Fm=l(),y(vs.$$.fragment),Ki=l(),to=a("h2"),jo=a("a"),Zr=a("span"),y(ks.$$.fragment),Mm=l(),ei=a("span"),$m=o("TFFlaubertForMultipleChoice"),Ji=l(),Ie=a("div"),y(Ts.$$.fragment),Lm=l(),ti=a("p"),Em=o(`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sm=l(),y(Xo.$$.fragment),Nm=l(),Ze=a("div"),y(Ms.$$.fragment),Im=l(),oo=a("p"),Dm=o("The "),Ta=a("a"),Wm=o("TFXLMForMultipleChoice"),Om=o(" forward method, overrides the "),oi=a("code"),Hm=o("__call__"),Qm=o(" special method."),Bm=l(),y(Ao.$$.fragment),Rm=l(),ni=a("p"),Um=o("Example:"),Vm=l(),y($s.$$.fragment),Zi=l(),no=a("h2"),So=a("a"),si=a("span"),y(Ls.$$.fragment),Gm=l(),ai=a("span"),Ym=o("TFFlaubertForTokenClassification"),el=l(),De=a("div"),y(Es.$$.fragment),Km=l(),ri=a("p"),Jm=o(`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dl.forEach(t),Id=d(vt),Qe=r(vt,"DIV",{class:!0});var kt=i(Qe);F(tn.$$.fragment,kt),Dd=d(kt),jt=r(kt,"P",{});var za=i(jt);Wd=n(za,"The "),Gs=r(za,"A",{href:!0});var gg=i(Gs);Od=n(gg,"FlaubertModel"),gg.forEach(t),Hd=n(za," forward method, overrides the "),nr=r(za,"CODE",{});var _g=i(nr);Qd=n(_g,"__call__"),_g.forEach(t),Bd=n(za," special method."),za.forEach(t),Rd=d(kt),F(ho.$$.fragment,kt),Ud=d(kt),sr=r(kt,"P",{});var bg=i(sr);Vd=n(bg,"Example:"),bg.forEach(t),Gd=d(kt),F(on.$$.fragment,kt),kt.forEach(t),vt.forEach(t),Pi=d(s),Xt=r(s,"H2",{class:!0});var cl=i(Xt);uo=r(cl,"A",{id:!0,class:!0,href:!0});var vg=i(uo);ar=r(vg,"SPAN",{});var kg=i(ar);F(nn.$$.fragment,kg),kg.forEach(t),vg.forEach(t),Yd=d(cl),rr=r(cl,"SPAN",{});var Tg=i(rr);Kd=n(Tg,"FlaubertWithLMHeadModel"),Tg.forEach(t),cl.forEach(t),ji=d(s),xe=r(s,"DIV",{class:!0});var at=i(xe);F(sn.$$.fragment,at),Jd=d(at),ir=r(at,"P",{});var wg=i(ir);Zd=n(wg,`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),wg.forEach(t),ec=d(at),an=r(at,"P",{});var pl=i(an);tc=n(pl,"This model inherits from "),Ys=r(pl,"A",{href:!0});var yg=i(Ys);oc=n(yg,"PreTrainedModel"),yg.forEach(t),nc=n(pl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
alongside usage examples.`),Tl.forEach(t),fp=d(it),Re=r(it,"DIV",{class:!0});var wt=i(Re);F(Ln.$$.fragment,wt),gp=d(wt),Dt=r(wt,"P",{});var Ca=i(Dt);_p=n(Ca,"The "),sa=r(Ca,"A",{href:!0});var Ug=i(sa);bp=n(Ug,"XLMForMultipleChoice"),Ug.forEach(t),vp=n(Ca," forward method, overrides the "),vr=r(Ca,"CODE",{});var Vg=i(vr);kp=n(Vg,"__call__"),Vg.forEach(t),Tp=n(Ca," special method."),Ca.forEach(t),wp=d(wt),F(bo.$$.fragment,wt),yp=d(wt),kr=r(wt,"P",{});var Gg=i(kr);Fp=n(Gg,"Example:"),Gg.forEach(t),Mp=d(wt),F(En.$$.fragment,wt),wt.forEach(t),it.forEach(t),Ii=d(s),Wt=r(s,"H2",{class:!0});var wl=i(Wt);vo=r(wl,"A",{id:!0,class:!0,href:!0});var Yg=i(vo);Tr=r(Yg,"SPAN",{});var Kg=i(Tr);F(zn.$$.fragment,Kg),Kg.forEach(t),Yg.forEach(t),$p=d(wl),wr=r(wl,"SPAN",{});var Jg=i(wr);Lp=n(Jg,"FlaubertForTokenClassification"),Jg.forEach(t),wl.forEach(t),Di=d(s),Pe=r(s,"DIV",{class:!0});var lt=i(Pe);F(xn.$$.fragment,lt),Ep=d(lt),yr=r(lt,"P",{});var Zg=i(yr);zp=n(Zg,`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
alongside usage examples.`),Ml.forEach(t),Op=d(lt),Ue=r(lt,"DIV",{class:!0});var yt=i(Ue);F(Xn.$$.fragment,yt),Hp=d(yt),Ot=r(yt,"P",{});var Pa=i(Ot);Qp=n(Pa,"The "),ia=r(Pa,"A",{href:!0});var n_=i(ia);Bp=n(n_,"XLMForTokenClassification"),n_.forEach(t),Rp=n(Pa," forward method, overrides the "),Fr=r(Pa,"CODE",{});var s_=i(Fr);Up=n(s_,"__call__"),s_.forEach(t),Vp=n(Pa," special method."),Pa.forEach(t),Gp=d(yt),F(ko.$$.fragment,yt),Yp=d(yt),Mr=r(yt,"P",{});var a_=i(Mr);Kp=n(a_,"Example:"),a_.forEach(t),Jp=d(yt),F(An.$$.fragment,yt),yt.forEach(t),lt.forEach(t),Wi=d(s),Ht=r(s,"H2",{class:!0});var $l=i(Ht);To=r($l,"A",{id:!0,class:!0,href:!0});var r_=i(To);$r=r(r_,"SPAN",{});var i_=i($r);F(Sn.$$.fragment,i_),i_.forEach(t),r_.forEach(t),Zp=d($l),Lr=r($l,"SPAN",{});var l_=i(Lr);eh=n(l_,"FlaubertForQuestionAnsweringSimple"),l_.forEach(t),$l.forEach(t),Oi=d(s),je=r(s,"DIV",{class:!0});var dt=i(je);F(Nn.$$.fragment,dt),th=d(dt),Qt=r(dt,"P",{});var ja=i(Qt);oh=n(ja,`Flaubert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ql.forEach(t),Oh=d(ct),Vn=r(ct,"P",{});var Cl=i(Vn);Hh=n(Cl,"This model is also a PyTorch "),Gn=r(Cl,"A",{href:!0,rel:!0});var y_=i(Gn);Qh=n(y_,"torch.nn.Module"),y_.forEach(t),Bh=n(Cl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl.forEach(t),Rh=d(ct),Yn=r(ct,"P",{});var Pl=i(Yn);Uh=n(Pl,"This class overrides "),ha=r(Pl,"A",{href:!0});var F_=i(ha);Vh=n(F_,"XLMForQuestionAnswering"),F_.forEach(t),Gh=n(Pl,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Pl.forEach(t),Yh=d(ct),Ge=r(ct,"DIV",{class:!0});var Mt=i(Ge);F(Kn.$$.fragment,Mt),Kh=d(Mt),Vt=r(Mt,"P",{});var Sa=i(Vt);Jh=n(Sa,"The "),ua=r(Sa,"A",{href:!0});var M_=i(ua);Zh=n(M_,"XLMForQuestionAnswering"),M_.forEach(t),eu=n(Sa," forward method, overrides the "),Ar=r(Sa,"CODE",{});var $_=i(Ar);tu=n($_,"__call__"),$_.forEach(t),ou=n(Sa," special method."),Sa.forEach(t),nu=d(Mt),F(Fo.$$.fragment,Mt),su=d(Mt),Sr=r(Mt,"P",{});var L_=i(Sr);au=n(L_,"Example:"),L_.forEach(t),ru=d(Mt),F(Jn.$$.fragment,Mt),Mt.forEach(t),ct.forEach(t),Bi=d(s),Gt=r(s,"H2",{class:!0});var jl=i(Gt);Mo=r(jl,"A",{id:!0,class:!0,href:!0});var E_=i(Mo);Nr=r(E_,"SPAN",{});var z_=i(Nr);F(Zn.$$.fragment,z_),z_.forEach(t),E_.forEach(t),iu=d(jl),Ir=r(jl,"SPAN",{});var x_=i(Ir);lu=n(x_,"TFFlaubertModel"),x_.forEach(t),jl.forEach(t),Ri=d(s),Ae=r(s,"DIV",{class:!0});var pt=i(Ae);F(es.$$.fragment,pt),du=d(pt),Dr=r(pt,"P",{});var q_=i(Dr);cu=n(q_,"The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),q_.forEach(t),pu=d(pt),ts=r(pt,"P",{});var Xl=i(ts);hu=n(Xl,"This model inherits from "),ma=r(Xl,"A",{href:!0});var C_=i(ma);uu=n(C_,"TFPreTrainedModel"),C_.forEach(t),mu=n(Xl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Il.forEach(t),Hu=d(ht),F(zo.$$.fragment,ht),Qu=d(ht),Ke=r(ht,"DIV",{class:!0});var Lt=i(Ke);F(ps.$$.fragment,Lt),Bu=d(Lt),Jt=r(Lt,"P",{});var Ia=i(Jt);Ru=n(Ia,"The "),_a=r(Ia,"A",{href:!0});var H_=i(_a);Uu=n(H_,"TFFlaubertWithLMHeadModel"),H_.forEach(t),Vu=n(Ia," forward method, overrides the "),Rr=r(Ia,"CODE",{});var Q_=i(Rr);Gu=n(Q_,"__call__"),Q_.forEach(t),Yu=n(Ia," special method."),Ia.forEach(t),Ku=d(Lt),F(xo.$$.fragment,Lt),Ju=d(Lt),Ur=r(Lt,"P",{});var B_=i(Ur);Zu=n(B_,"Example:"),B_.forEach(t),em=d(Lt),F(hs.$$.fragment,Lt),Lt.forEach(t),ht.forEach(t),Gi=d(s),Zt=r(s,"H2",{class:!0});var Dl=i(Zt);qo=r(Dl,"A",{id:!0,class:!0,href:!0});var R_=i(qo);Vr=r(R_,"SPAN",{});var U_=i(Vr);F(us.$$.fragment,U_),U_.forEach(t),R_.forEach(t),tm=d(Dl),Gr=r(Dl,"SPAN",{});var V_=i(Gr);om=n(V_,"TFFlaubertForSequenceClassification"),V_.forEach(t),Dl.forEach(t),Yi=d(s),Ne=r(s,"DIV",{class:!0});var ut=i(Ne);F(ms.$$.fragment,ut),nm=d(ut),Yr=r(ut,"P",{});var G_=i(Yr);sm=n(G_,`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
e.g. for GLUE tasks.`),G_.forEach(t),am=d(ut),fs=r(ut,"P",{});var Wl=i(fs);rm=n(Wl,"This model inherits from "),ba=r(Wl,"A",{href:!0});var Y_=i(ba);im=n(Y_,"TFPreTrainedModel"),Y_.forEach(t),lm=n(Wl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
