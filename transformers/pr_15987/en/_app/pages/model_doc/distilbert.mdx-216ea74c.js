...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),PT=l(),Kd=o("p"),qT=a("Finally, this model supports inherent JAX features such as:"),AT=l(),Et=o("ul"),Gd=o("li"),da=o("a"),IT=a("Just-In-Time (JIT) compilation"),NT=l(),Xd=o("li"),ca=o("a"),LT=a("Automatic Differentiation"),ST=l(),Yd=o("li"),pa=o("a"),OT=a("Vectorization"),WT=l(),Zd=o("li"),ha=o("a"),RT=a("Parallelization"),HT=l(),rt=o("div"),T(ua.$$.fragment),QT=l(),Ls=o("p"),UT=a("The "),ec=o("code"),VT=a("FlaxDistilBertPreTrainedModel"),JT=a("forward method, overrides the "),tc=o("code"),KT=a("__call__"),GT=a(" special method."),XT=l(),T(Po.$$.fragment),YT=l(),sc=o("p"),ZT=a("Example:"),e1=l(),T(fa.$$.fragment),Jp=l(),Ss=o("h2"),qo=o("a"),oc=o("span"),T(ma.$$.fragment),t1=l(),nc=o("span"),s1=a("FlaxDistilBertForSequenceClassification"),Kp=l(),Me=o("div"),T(ga.$$.fragment),o1=l(),rc=o("p"),n1=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),d1=l(),va=o("p"),c1=a("This model is also a Flax Linen "),ba=o("a"),p1=a("flax.linen.Module"),h1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u1=l(),ac=o("p"),f1=a("Finally, this model supports inherent JAX features such as:"),m1=l(),Mt=o("ul"),ic=o("li"),Ta=o("a"),g1=a("Just-In-Time (JIT) compilation"),_1=l(),lc=o("li"),ka=o("a"),v1=a("Automatic Differentiation"),b1=l(),dc=o("li"),wa=o("a"),T1=a("Vectorization"),k1=l(),cc=o("li"),$a=o("a"),w1=a("Parallelization"),$1=l(),at=o("div"),T(Da.$$.fragment),D1=l(),Os=o("p"),F1=a("The "),pc=o("code"),y1=a("FlaxDistilBertPreTrainedModel"),B1=a("forward method, overrides the "),hc=o("code"),E1=a("__call__"),M1=a(" special method."),z1=l(),T(Ao.$$.fragment),x1=l(),uc=o("p"),j1=a("Example:"),C1=l(),T(Fa.$$.fragment),Gp=l(),Ws=o("h2"),Io=o("a"),fc=o("span"),T(ya.$$.fragment),P1=l(),mc=o("span"),q1=a("FlaxDistilBertForMultipleChoice"),Xp=l(),ze=o("div"),T(Ba.$$.fragment),A1=l(),gc=o("p"),I1=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),N1=l(),Ea=o("p"),L1=a("This model inherits from "),Ui=o("a"),S1=a("FlaxPreTrainedModel"),O1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),W1=l(),Ma=o("p"),R1=a("This model is also a Flax Linen "),za=o("a"),H1=a("flax.linen.Module"),Q1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),U1=l(),_c=o("p"),V1=a("Finally, this model supports inherent JAX features such as:"),J1=l(),zt=o("ul"),vc=o("li"),xa=o("a"),K1=a("Just-In-Time (JIT) compilation"),G1=l(),bc=o("li"),ja=o("a"),X1=a("Automatic Differentiation"),Y1=l(),Tc=o("li"),Ca=o("a"),Z1=a("Vectorization"),ek=l(),kc=o("li"),Pa=o("a"),tk=a("Parallelization"),sk=l(),it=o("div"),T(qa.$$.fragment),ok=l(),Rs=o("p"),nk=a("The "),wc=o("code"),rk=a("FlaxDistilBertPreTrainedModel"),ak=a("forward method, overrides the "),$c=o("code"),ik=a("__call__"),lk=a(" special method."),dk=l(),T(No.$$.fragment),ck=l(),Dc=o("p"),pk=a("Example:"),hk=l(),T(Aa.$$.fragment),Yp=l(),Hs=o("h2"),Lo=o("a"),Fc=o("span"),T(Ia.$$.fragment),uk=l(),yc=o("span"),fk=a("FlaxDistilBertForTokenClassification"),Zp=l(),xe=o("div"),T(Na.$$.fragment),mk=l(),Bc=o("p"),gk=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zh.forEach(t),PT=d(ht),Kd=n(ht,"P",{});var E2=r(Kd);qT=i(E2,"Finally, this model supports inherent JAX features such as:"),E2.forEach(t),AT=d(ht),Et=n(ht,"UL",{});var Vo=r(Et);Gd=n(Vo,"LI",{});var M2=r(Gd);da=n(M2,"A",{href:!0,rel:!0});var z2=r(da);IT=i(z2,"Just-In-Time (JIT) compilation"),z2.forEach(t),M2.forEach(t),NT=d(Vo),Xd=n(Vo,"LI",{});var x2=r(Xd);ca=n(x2,"A",{href:!0,rel:!0});var j2=r(ca);LT=i(j2,"Automatic Differentiation"),j2.forEach(t),x2.forEach(t),ST=d(Vo),Yd=n(Vo,"LI",{});var C2=r(Yd);pa=n(C2,"A",{href:!0,rel:!0});var P2=r(pa);OT=i(P2,"Vectorization"),P2.forEach(t),C2.forEach(t),WT=d(Vo),Zd=n(Vo,"LI",{});var q2=r(Zd);ha=n(q2,"A",{href:!0,rel:!0});var A2=r(ha);RT=i(A2,"Parallelization"),A2.forEach(t),q2.forEach(t),Vo.forEach(t),HT=d(ht),rt=n(ht,"DIV",{class:!0});var ts=r(rt);k(ua.$$.fragment,ts),QT=d(ts),Ls=n(ts,"P",{});var pl=r(Ls);UT=i(pl,"The "),ec=n(pl,"CODE",{});var I2=r(ec);VT=i(I2,"FlaxDistilBertPreTrainedModel"),I2.forEach(t),JT=i(pl,"forward method, overrides the "),tc=n(pl,"CODE",{});var N2=r(tc);KT=i(N2,"__call__"),N2.forEach(t),GT=i(pl," special method."),pl.forEach(t),XT=d(ts),k(Po.$$.fragment,ts),YT=d(ts),sc=n(ts,"P",{});var L2=r(sc);ZT=i(L2,"Example:"),L2.forEach(t),e1=d(ts),k(fa.$$.fragment,ts),ts.forEach(t),ht.forEach(t),Jp=d(s),Ss=n(s,"H2",{class:!0});var eu=r(Ss);qo=n(eu,"A",{id:!0,class:!0,href:!0});var S2=r(qo);oc=n(S2,"SPAN",{});var O2=r(oc);k(ma.$$.fragment,O2),O2.forEach(t),S2.forEach(t),t1=d(eu),nc=n(eu,"SPAN",{});var W2=r(nc);s1=i(W2,"FlaxDistilBertForSequenceClassification"),W2.forEach(t),eu.forEach(t),Kp=d(s),Me=n(s,"DIV",{class:!0});var ut=r(Me);k(ga.$$.fragment,ut),o1=d(ut),rc=n(ut,"P",{});var R2=r(rc);n1=i(R2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),R2.forEach(t),r1=d(ut),_a=n(ut,"P",{});var tu=r(_a);a1=i(tu,"This model inherits from "),Qi=n(tu,"A",{href:!0});var H2=r(Qi);i1=i(H2,"FlaxPreTrainedModel"),H2.forEach(t),l1=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tu.forEach(t),d1=d(ut),va=n(ut,"P",{});var su=r(va);c1=i(su,"This model is also a Flax Linen "),ba=n(su,"A",{href:!0,rel:!0});var Q2=r(ba);p1=i(Q2,"flax.linen.Module"),Q2.forEach(t),h1=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),u1=d(ut),ac=n(ut,"P",{});var U2=r(ac);f1=i(U2,"Finally, this model supports inherent JAX features such as:"),U2.forEach(t),m1=d(ut),Mt=n(ut,"UL",{});var Jo=r(Mt);ic=n(Jo,"LI",{});var V2=r(ic);Ta=n(V2,"A",{href:!0,rel:!0});var J2=r(Ta);g1=i(J2,"Just-In-Time (JIT) compilation"),J2.forEach(t),V2.forEach(t),_1=d(Jo),lc=n(Jo,"LI",{});var K2=r(lc);ka=n(K2,"A",{href:!0,rel:!0});var G2=r(ka);v1=i(G2,"Automatic Differentiation"),G2.forEach(t),K2.forEach(t),b1=d(Jo),dc=n(Jo,"LI",{});var X2=r(dc);wa=n(X2,"A",{href:!0,rel:!0});var Y2=r(wa);T1=i(Y2,"Vectorization"),Y2.forEach(t),X2.forEach(t),k1=d(Jo),cc=n(Jo,"LI",{});var Z2=r(cc);$a=n(Z2,"A",{href:!0,rel:!0});var eF=r($a);w1=i(eF,"Parallelization"),eF.forEach(t),Z2.forEach(t),Jo.forEach(t),$1=d(ut),at=n(ut,"DIV",{class:!0});var ss=r(at);k(Da.$$.fragment,ss),D1=d(ss),Os=n(ss,"P",{});var hl=r(Os);F1=i(hl,"The "),pc=n(hl,"CODE",{});var tF=r(pc);y1=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),B1=i(hl,"forward method, overrides the "),hc=n(hl,"CODE",{});var sF=r(hc);E1=i(sF,"__call__"),sF.forEach(t),M1=i(hl," special method."),hl.forEach(t),z1=d(ss),k(Ao.$$.fragment,ss),x1=d(ss),uc=n(ss,"P",{});var oF=r(uc);j1=i(oF,"Example:"),oF.forEach(t),C1=d(ss),k(Fa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),Gp=d(s),Ws=n(s,"H2",{class:!0});var ou=r(Ws);Io=n(ou,"A",{id:!0,class:!0,href:!0});var nF=r(Io);fc=n(nF,"SPAN",{});var rF=r(fc);k(ya.$$.fragment,rF),rF.forEach(t),nF.forEach(t),P1=d(ou),mc=n(ou,"SPAN",{});var aF=r(mc);q1=i(aF,"FlaxDistilBertForMultipleChoice"),aF.forEach(t),ou.forEach(t),Xp=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);k(Ba.$$.fragment,ft),A1=d(ft),gc=n(ft,"P",{});var iF=r(gc);I1=i(iF,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),iF.forEach(t),N1=d(ft),Ea=n(ft,"P",{});var nu=r(Ea);L1=i(nu,"This model inherits from "),Ui=n(nu,"A",{href:!0});var lF=r(Ui);S1=i(lF,"FlaxPreTrainedModel"),lF.forEach(t),O1=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),W1=d(ft),Ma=n(ft,"P",{});var ru=r(Ma);R1=i(ru,"This model is also a Flax Linen "),za=n(ru,"A",{href:!0,rel:!0});var dF=r(za);H1=i(dF,"flax.linen.Module"),dF.forEach(t),Q1=i(ru,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ru.forEach(t),U1=d(ft),_c=n(ft,"P",{});var cF=r(_c);V1=i(cF,"Finally, this model supports inherent JAX features such as:"),cF.forEach(t),J1=d(ft),zt=n(ft,"UL",{});var Ko=r(zt);vc=n(Ko,"LI",{});var pF=r(vc);xa=n(pF,"A",{href:!0,rel:!0});var hF=r(xa);K1=i(hF,"Just-In-Time (JIT) compilation"),hF.forEach(t),pF.forEach(t),G1=d(Ko),bc=n(Ko,"LI",{});var uF=r(bc);ja=n(uF,"A",{href:!0,rel:!0});var fF=r(ja);X1=i(fF,"Automatic Differentiation"),fF.forEach(t),uF.forEach(t),Y1=d(Ko),Tc=n(Ko,"LI",{});var mF=r(Tc);Ca=n(mF,"A",{href:!0,rel:!0});var gF=r(Ca);Z1=i(gF,"Vectorization"),gF.forEach(t),mF.forEach(t),ek=d(Ko),kc=n(Ko,"LI",{});var _F=r(kc);Pa=n(_F,"A",{href:!0,rel:!0});var vF=r(Pa);tk=i(vF,"Parallelization"),vF.forEach(t),_F.forEach(t),Ko.forEach(t),sk=d(ft),it=n(ft,"DIV",{class:!0});var os=r(it);k(qa.$$.fragment,os),ok=d(os),Rs=n(os,"P",{});var ul=r(Rs);nk=i(ul,"The "),wc=n(ul,"CODE",{});var bF=r(wc);rk=i(bF,"FlaxDistilBertPreTrainedModel"),bF.forEach(t),ak=i(ul,"forward method, overrides the "),$c=n(ul,"CODE",{});var TF=r($c);ik=i(TF,"__call__"),TF.forEach(t),lk=i(ul," special method."),ul.forEach(t),dk=d(os),k(No.$$.fragment,os),ck=d(os),Dc=n(os,"P",{});var kF=r(Dc);pk=i(kF,"Example:"),kF.forEach(t),hk=d(os),k(Aa.$$.fragment,os),os.forEach(t),ft.forEach(t),Yp=d(s),Hs=n(s,"H2",{class:!0});var au=r(Hs);Lo=n(au,"A",{id:!0,class:!0,href:!0});var wF=r(Lo);Fc=n(wF,"SPAN",{});var $F=r(Fc);k(Ia.$$.fragment,$F),$F.forEach(t),wF.forEach(t),uk=d(au),yc=n(au,"SPAN",{});var DF=r(yc);fk=i(DF,"FlaxDistilBertForTokenClassification"),DF.forEach(t),au.forEach(t),Zp=d(s),xe=n(s,"DIV",{class:!0});var mt=r(xe);k(Na.$$.fragment,mt),mk=d(mt),Bc=n(mt,"P",{});var FF=r(Bc);gk=i(FF,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
