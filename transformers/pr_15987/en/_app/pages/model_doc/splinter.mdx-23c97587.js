...
doesn\u2019t (`),Ut=o("em"),Io=a("tau/splinter-base"),Co=a(" and "),Bt=o("em"),Do=a("tau/splinter-large"),Lo=a(`). This is done to support randomly initializing this layer at
fine-tuning, as it is shown to yield better results for some cases in the paper.`),qn=d(),D=o("p"),No=a("This model was contributed by "),ze=o("a"),jo=a("yuvalkirstain"),Qo=a(" and "),qe=o("a"),Oo=a("oriram"),Wo=a(". The original code can be found "),$e=o("a"),Uo=a("here"),Bo=a("."),$n=d(),K=o("h2"),ae=o("a"),Ht=o("span"),m(Ee.$$.fragment),Ho=d(),Vt=o("span"),Vo=a("SplinterConfig"),En=d(),z=o("div"),m(xe.$$.fragment),Jo=d(),R=o("p"),Ko=a("This is the configuration class to store the configuration of a "),mt=o("a"),Ro=a("SplinterModel"),Go=a(`. It is used to instantiate an
...
the success of your model, especially in a few-shot setting.`),On.forEach(n),Eo=c(fe),P=s(fe,"LI",{});var U=r(P);xo=i(U,`Please note there are two different checkpoints for each size of Splinter. Both are basically the same, except that
one also has the pretrained wights of the QASS layer (`),Ot=s(U,"EM",{});var ha=r(Ot);Ao=i(ha,"tau/splinter-base-qass"),ha.forEach(n),Po=i(U," and "),Wt=s(U,"EM",{});var ua=r(Wt);Fo=i(ua,"tau/splinter-large-qass"),ua.forEach(n),Mo=i(U,`) and one
doesn\u2019t (`),Ut=s(U,"EM",{});var fa=r(Ut);Io=i(fa,"tau/splinter-base"),fa.forEach(n),Co=i(U," and "),Bt=s(U,"EM",{});var ma=r(Bt);Do=i(ma,"tau/splinter-large"),ma.forEach(n),Lo=i(U,`). This is done to support randomly initializing this layer at
fine-tuning, as it is shown to yield better results for some cases in the paper.`),U.forEach(n),fe.forEach(n),qn=c(t),D=s(t,"P",{});var ge=r(D);No=i(ge,"This model was contributed by "),ze=s(ge,"A",{href:!0,rel:!0});var ga=r(ze);jo=i(ga,"yuvalkirstain"),ga.forEach(n),Qo=i(ge," and "),qe=s(ge,"A",{href:!0,rel:!0});var _a=r(qe);Oo=i(_a,"oriram"),_a.forEach(n),Wo=i(ge,". The original code can be found "),$e=s(ge,"A",{href:!0,rel:!0});var ka=r($e);Uo=i(ka,"here"),ka.forEach(n),Bo=i(ge,"."),ge.forEach(n),$n=c(t),K=s(t,"H2",{class:!0});var Wn=r(K);ae=s(Wn,"A",{id:!0,class:!0,href:!0});var va=r(ae);Ht=s(va,"SPAN",{});var wa=r(Ht);g(Ee.$$.fragment,wa),wa.forEach(n),va.forEach(n),Ho=c(Wn),Vt=s(Wn,"SPAN",{});var ba=r(Vt);Vo=i(ba,"SplinterConfig"),ba.forEach(n),Wn.forEach(n),En=c(t),z=s(t,"DIV",{class:!0});var B=r(z);g(xe.$$.fragment,B),Jo=c(B),R=s(B,"P",{});var xt=r(R);Ko=i(xt,"This is the configuration class to store the configuration of a "),mt=s(xt,"A",{href:!0});var Sa=r(mt);Ro=i(Sa,"SplinterModel"),Sa.forEach(n),Go=i(xt,`. It is used to instantiate an
Splinter model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Splinter
`),Ae=s(xt,"A",{href:!0,rel:!0});var ya=r(Ae);Xo=i(ya,"tau/splinter-base"),ya.forEach(n),Yo=i(xt," architecture."),xt.forEach(n),Zo=c(B),G=s(B,"P",{});var At=r(G);es=i(At,"Configuration objects inherit from "),gt=s(At,"A",{href:!0});var Ta=r(gt);ts=i(Ta,"PretrainedConfig"),Ta.forEach(n),ns=i(At,` and can be used to control the model outputs. Read the
documentation from `),_t=s(At,"A",{href:!0});var za=r(_t);os=i(za,"PretrainedConfig"),za.forEach(n),ss=i(At," for more information."),At.forEach(n),rs=c(B),Jt=s(B,"P",{});var qa=r(Jt);as=i(qa,"Example:"),qa.forEach(n),is=c(B),g(Pe.$$.fragment,B),B.forEach(n),xn=c(t),X=s(t,"H2",{class:!0});var Un=r(X);ie=s(Un,"A",{id:!0,class:!0,href:!0});var $a=r(ie);Kt=s($a,"SPAN",{});var Ea=r(Kt);g(Fe.$$.fragment,Ea),Ea.forEach(n),$a.forEach(n),ls=c(Un),Rt=s(Un,"SPAN",{});var xa=r(Rt);ds=i(xa,"SplinterTokenizer"),xa.forEach(n),Un.forEach(n),An=c(t),y=s(t,"DIV",{class:!0});var x=r(y);g(Me.$$.fragment,x),cs=c(x),Gt=s(x,"P",{});var Aa=r(Gt);ps=i(Aa,"Construct a Splinter tokenizer. Based on WordPiece."),Aa.forEach(n),hs=c(x),Ie=s(x,"P",{});var Bn=r(Ie);us=i(Bn,"This tokenizer inherits from "),kt=s(Bn,"A",{href:!0});var Pa=r(kt);fs=i(Pa,"PreTrainedTokenizer"),Pa.forEach(n),ms=i(Bn,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bn.forEach(n),gs=c(x),Q=s(x,"DIV",{class:!0});var Pt=r(Q);g(Ce.$$.fragment,Pt),_s=c(Pt),Xt=s(Pt,"P",{});var Fa=r(Xt);ks=i(Fa,`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
