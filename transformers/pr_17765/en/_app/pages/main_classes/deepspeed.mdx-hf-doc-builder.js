...
`),Rp=o("a"),Q6=a("deepspeed-zero-inference"),e5=a("."),Aj=u(),Ip=o("p"),s5=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),Tj=u(),Up=o("a"),Sj=u(),qs=o("h2"),gt=o("a"),Kh=o("span"),f(so.$$.fragment),t5=u(),Jh=o("span"),a5=a("Trainer Deepspeed Integration"),Cj=u(),Gp=o("a"),xj=u(),Es=o("h3"),bt=o("a"),Xh=o("span"),f(to.$$.fragment),n5=u(),Qh=o("span"),o5=a("Installation"),Rj=u(),Mp=o("p"),l5=a("Install the library via pypi:"),Ij=u(),f(ao.$$.fragment),Uj=u(),Se=o("p"),r5=a("or via "),ef=o("code"),p5=a("transformers"),i5=a("\u2019 "),sf=o("code"),u5=a("extras"),c5=a(":"),Gj=u(),f(no.$$.fragment),Mj=u(),Ce=o("p"),h5=a("or find more details on "),oo=o("a"),f5=a("the DeepSpeed\u2019s GitHub page"),d5=a(` and
`),lo=o("a"),m5=a("advanced install"),_5=a("."),Lj=u(),qt=o("p"),v5=a("If you\u2019re still struggling with the build, first make sure to read "),Lp=o("a"),j5=a("zero-install-notes"),w5=a("."),Zj=u(),Zp=o("p"),y5=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Nj=u(),Np=o("p"),g5=a("To make a local build for DeepSpeed:"),Hj=u(),f(ro.$$.fragment),Bj=u(),xe=o("p"),b5=a("If you intend to use NVMe offload you will also need to include "),tf=o("code"),q5=a("DS_BUILD_AIO=1"),E5=a(` in the instructions above (and also
install `),af=o("em"),$5=a("libaio-dev"),k5=a(" system-wide)."),Wj=u(),Et=o("p"),P5=a("Edit "),nf=o("code"),z5=a("TORCH_CUDA_ARCH_LIST"),D5=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),Fj=u(),f(po.$$.fragment),Vj=u(),ke=o("p"),O5=a("So if you get "),of=o("code"),A5=a("8, 6"),T5=a(", then use "),lf=o("code"),S5=a('TORCH_CUDA_ARCH_LIST="8.6"'),C5=a(`. If you have multiple different cards, you can list all
of them like so `),rf=o("code"),x5=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Yj=u(),Hp=o("p"),R5=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Kj=u(),f(io.$$.fragment),Jj=u(),Re=o("p"),I5=a("it will generate something like "),pf=o("code"),U5=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),G5=a(` which now you can install
as `),uf=o("code"),M5=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),L5=a(" locally or on any other machine."),Xj=u(),$t=o("p"),Z5=a("Again, remember to ensure to adjust "),cf=o("code"),N5=a("TORCH_CUDA_ARCH_LIST"),H5=a(" to the target architectures."),Qj=u(),Ie=o("p"),B5=a("You can find the complete list of NVIDIA GPUs and their corresponding "),hf=o("strong"),W5=a("Compute Capabilities"),F5=a(` (same as arch in this
context) `),uo=o("a"),V5=a("here"),Y5=a("."),ew=u(),Bp=o("p"),K5=a("You can check the archs pytorch was built with using:"),sw=u(),f(co.$$.fragment),tw=u(),Wp=o("p"),J5=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),aw=u(),f(ho.$$.fragment),nw=u(),Fp=o("p"),X5=a("If the output is:"),ow=u(),f(fo.$$.fragment),lw=u(),kt=o("p"),Q5=a("then you know that this card\u2019s arch is "),ff=o("code"),e$=a("8.6"),s$=a("."),rw=u(),Pt=o("p"),t$=a("You can also leave "),df=o("code"),a$=a("TORCH_CUDA_ARCH_LIST"),n$=a(` out completely and then the build program will automatically query the
...
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(R0,"A",{href:!0});var YU=r(Rp);Q6=n(YU,"deepspeed-zero-inference"),YU.forEach(t),e5=n(R0,"."),R0.forEach(t),VU.forEach(t),Aj=c(e),Ip=l(e,"P",{});var KU=r(Ip);s5=n(KU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),KU.forEach(t),Tj=c(e),Up=l(e,"A",{id:!0}),r(Up).forEach(t),Sj=c(e),qs=l(e,"H2",{class:!0});var I0=r(qs);gt=l(I0,"A",{id:!0,class:!0,href:!0});var JU=r(gt);Kh=l(JU,"SPAN",{});var XU=r(Kh);d(so.$$.fragment,XU),XU.forEach(t),JU.forEach(t),t5=c(I0),Jh=l(I0,"SPAN",{});var QU=r(Jh);a5=n(QU,"Trainer Deepspeed Integration"),QU.forEach(t),I0.forEach(t),Cj=c(e),Gp=l(e,"A",{id:!0}),r(Gp).forEach(t),xj=c(e),Es=l(e,"H3",{class:!0});var U0=r(Es);bt=l(U0,"A",{id:!0,class:!0,href:!0});var eG=r(bt);Xh=l(eG,"SPAN",{});var sG=r(Xh);d(to.$$.fragment,sG),sG.forEach(t),eG.forEach(t),n5=c(U0),Qh=l(U0,"SPAN",{});var tG=r(Qh);o5=n(tG,"Installation"),tG.forEach(t),U0.forEach(t),Rj=c(e),Mp=l(e,"P",{});var aG=r(Mp);l5=n(aG,"Install the library via pypi:"),aG.forEach(t),Ij=c(e),d(ao.$$.fragment,e),Uj=c(e),Se=l(e,"P",{});var Kc=r(Se);r5=n(Kc,"or via "),ef=l(Kc,"CODE",{});var nG=r(ef);p5=n(nG,"transformers"),nG.forEach(t),i5=n(Kc,"\u2019 "),sf=l(Kc,"CODE",{});var oG=r(sf);u5=n(oG,"extras"),oG.forEach(t),c5=n(Kc,":"),Kc.forEach(t),Gj=c(e),d(no.$$.fragment,e),Mj=c(e),Ce=l(e,"P",{});var Jc=r(Ce);h5=n(Jc,"or find more details on "),oo=l(Jc,"A",{href:!0,rel:!0});var lG=r(oo);f5=n(lG,"the DeepSpeed\u2019s GitHub page"),lG.forEach(t),d5=n(Jc,` and
`),lo=l(Jc,"A",{href:!0,rel:!0});var rG=r(lo);m5=n(rG,"advanced install"),rG.forEach(t),_5=n(Jc,"."),Jc.forEach(t),Lj=c(e),qt=l(e,"P",{});var G0=r(qt);v5=n(G0,"If you\u2019re still struggling with the build, first make sure to read "),Lp=l(G0,"A",{href:!0});var pG=r(Lp);j5=n(pG,"zero-install-notes"),pG.forEach(t),w5=n(G0,"."),G0.forEach(t),Zj=c(e),Zp=l(e,"P",{});var iG=r(Zp);y5=n(iG,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),iG.forEach(t),Nj=c(e),Np=l(e,"P",{});var uG=r(Np);g5=n(uG,"To make a local build for DeepSpeed:"),uG.forEach(t),Hj=c(e),d(ro.$$.fragment,e),Bj=c(e),xe=l(e,"P",{});var Xc=r(xe);b5=n(Xc,"If you intend to use NVMe offload you will also need to include "),tf=l(Xc,"CODE",{});var cG=r(tf);q5=n(cG,"DS_BUILD_AIO=1"),cG.forEach(t),E5=n(Xc,` in the instructions above (and also
install `),af=l(Xc,"EM",{});var hG=r(af);$5=n(hG,"libaio-dev"),hG.forEach(t),k5=n(Xc," system-wide)."),Xc.forEach(t),Wj=c(e),Et=l(e,"P",{});var M0=r(Et);P5=n(M0,"Edit "),nf=l(M0,"CODE",{});var fG=r(nf);z5=n(fG,"TORCH_CUDA_ARCH_LIST"),fG.forEach(t),D5=n(M0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),M0.forEach(t),Fj=c(e),d(po.$$.fragment,e),Vj=c(e),ke=l(e,"P",{});var yp=r(ke);O5=n(yp,"So if you get "),of=l(yp,"CODE",{});var dG=r(of);A5=n(dG,"8, 6"),dG.forEach(t),T5=n(yp,", then use "),lf=l(yp,"CODE",{});var mG=r(lf);S5=n(mG,'TORCH_CUDA_ARCH_LIST="8.6"'),mG.forEach(t),C5=n(yp,`. If you have multiple different cards, you can list all
of them like so `),rf=l(yp,"CODE",{});var _G=r(rf);x5=n(_G,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),_G.forEach(t),yp.forEach(t),Yj=c(e),Hp=l(e,"P",{});var vG=r(Hp);R5=n(vG,"If you need to use the same setup on multiple machines, make a binary wheel:"),vG.forEach(t),Kj=c(e),d(io.$$.fragment,e),Jj=c(e),Re=l(e,"P",{});var Qc=r(Re);I5=n(Qc,"it will generate something like "),pf=l(Qc,"CODE",{});var jG=r(pf);U5=n(jG,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),jG.forEach(t),G5=n(Qc,` which now you can install
as `),uf=l(Qc,"CODE",{});var wG=r(uf);M5=n(wG,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wG.forEach(t),L5=n(Qc," locally or on any other machine."),Qc.forEach(t),Xj=c(e),$t=l(e,"P",{});var L0=r($t);Z5=n(L0,"Again, remember to ensure to adjust "),cf=l(L0,"CODE",{});var yG=r(cf);N5=n(yG,"TORCH_CUDA_ARCH_LIST"),yG.forEach(t),H5=n(L0," to the target architectures."),L0.forEach(t),Qj=c(e),Ie=l(e,"P",{});var eh=r(Ie);B5=n(eh,"You can find the complete list of NVIDIA GPUs and their corresponding "),hf=l(eh,"STRONG",{});var gG=r(hf);W5=n(gG,"Compute Capabilities"),gG.forEach(t),F5=n(eh,` (same as arch in this
context) `),uo=l(eh,"A",{href:!0,rel:!0});var bG=r(uo);V5=n(bG,"here"),bG.forEach(t),Y5=n(eh,"."),eh.forEach(t),ew=c(e),Bp=l(e,"P",{});var qG=r(Bp);K5=n(qG,"You can check the archs pytorch was built with using:"),qG.forEach(t),sw=c(e),d(co.$$.fragment,e),tw=c(e),Wp=l(e,"P",{});var EG=r(Wp);J5=n(EG,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),EG.forEach(t),aw=c(e),d(ho.$$.fragment,e),nw=c(e),Fp=l(e,"P",{});var $G=r(Fp);X5=n($G,"If the output is:"),$G.forEach(t),ow=c(e),d(fo.$$.fragment,e),lw=c(e),kt=l(e,"P",{});var Z0=r(kt);Q5=n(Z0,"then you know that this card\u2019s arch is "),ff=l(Z0,"CODE",{});var kG=r(ff);e$=n(kG,"8.6"),kG.forEach(t),s$=n(Z0,"."),Z0.forEach(t),rw=c(e),Pt=l(e,"P",{});var N0=r(Pt);t$=n(N0,"You can also leave "),df=l(N0,"CODE",{});var PG=r(df);a$=n(PG,"TORCH_CUDA_ARCH_LIST"),PG.forEach(t),n$=n(N0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
