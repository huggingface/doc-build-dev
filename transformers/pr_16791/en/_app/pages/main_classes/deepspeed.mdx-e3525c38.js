...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16791/src/transformers/deepspeed.py#L39"}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16791/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16791/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16791/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16791/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
the file system before passing it to `),zi=o("a"),p9=a("TrainingArguments"),i9=a("."),Uw=u(),Oi=o("p"),u9=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c9=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),Cs=o("h3"),ta=o("a"),vd=o("span"),f(Xo.$$.fragment),h9=u(),jd=o("span"),f9=a("Shared Configuration"),Hw=u(),f(aa.$$.fragment),Bw=u(),Me=o("p"),d9=a("Some configuration values are required by both the "),Si=o("a"),m9=a("Trainer"),_9=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v9=a("Trainer"),j9=a(" command line arguments."),Ww=u(),na=o("p"),g9=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),w9=a("Trainer"),y9=a(` do the majority
of configuration for you.`),Fw=u(),Ze=o("p"),b9=a("Therefore, in the rest of this guide you will find a special configuration value: "),gd=o("code"),E9=a("auto"),q9=a(`, which when set will be
...
difficult to detect ways. You have been warned.`),Vw=u(),Ii=o("p"),P9=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Yw=u(),oa=o("p"),D9=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z9=a("TrainingArguments"),O9=a(" based on that. The steps are:"),Kw=u(),la=o("ol"),wd=o("li"),T9=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A9=u(),Qo=o("li"),S9=a("Create the "),Gi=o("a"),C9=a("TrainingArguments"),x9=a(" object based on these values"),Jw=u(),le=o("p"),R9=a("Do note that some values, such as "),yd=o("code"),I9=a("scheduler.params.total_num_steps"),U9=a(` are calculated by
`),Li=o("a"),G9=a("Trainer"),L9=a(" during "),bd=o("code"),M9=a("train"),Z9=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),xs=o("h3"),ra=o("a"),Ed=o("span"),f(el.$$.fragment),N9=u(),qd=o("span"),H9=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B9=a("Zero Redundancy Optimizer (ZeRO)"),W9=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sy=u(),Ne=o("p"),F9=a("The "),$d=o("code"),V9=a("zero_optimization"),Y9=a(" section of the configuration file is the most important part ("),al=o("a"),K9=a("docs"),J9=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ty=u(),pa=o("p"),X9=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q9=a("Trainer"),e8=a(` provides
no equivalent command line arguments.`),ay=u(),Ni=o("p"),s8=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),ny=u(),Hi=o("a"),oy=u(),Rs=o("h4"),ia=o("a"),kd=o("span"),f(nl.$$.fragment),t8=u(),Pd=o("span"),a8=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),n8=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Dd=o("strong"),o8=a("Performance tuning:"),iy=u(),He=o("ul"),Is=o("li"),l8=a("enabling "),zd=o("code"),r8=a("offload_optimizer"),p8=a(" should reduce GPU RAM usage (it requires "),Od=o("code"),i8=a('"stage": 2'),u8=a(")"),c8=u(),L=o("li"),Td=o("code"),h8=a('"overlap_comm": true'),f8=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=o("code"),d8=a("overlap_comm"),m8=a(` uses 4.5x
...
footprint (`),xd=o("code"),w8=a("5e8 x 2Bytes x 2 x 4.5"),y8=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
...
important, getting a slightly slower training time could be a good trade.`),uy=u(),Be=o("p"),k8=a("Additionally, "),Ud=o("code"),P8=a("deepspeed==0.4.4"),D8=a(" added a new option "),Gd=o("code"),z8=a("round_robin_gradients"),O8=a(" which you can enable with:"),cy=u(),f(ll.$$.fragment),hy=u(),Fi=o("p"),T8=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fy=u(),Vi=o("a"),dy=u(),Us=o("h4"),ua=o("a"),Ld=o("span"),f(rl.$$.fragment),A8=u(),Md=o("span"),S8=a("ZeRO-3 Config"),my=u(),Yi=o("p"),C8=a("The following is an example of configuration for ZeRO stage 3:"),_y=u(),f(pl.$$.fragment),vy=u(),K=o("p"),x8=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
...
NVMe is discussed further down.`),jy=u(),We=o("p"),H8=a("Pinned memory is enabled with "),Wd=o("code"),B8=a("pin_memory"),W8=a(" set to "),Fd=o("code"),F8=a("true"),V8=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gy=u(),Ki=o("p"),Vd=o("strong"),Y8=a("Performance tuning:"),wy=u(),ca=o("ul"),il=o("li"),Yd=o("code"),K8=a("stage3_max_live_parameters"),J8=a(": "),Kd=o("code"),X8=a("1e9"),Q8=u(),ul=o("li"),Jd=o("code"),ek=a("stage3_max_reuse_distance"),sk=a(": "),Xd=o("code"),tk=a("1e9"),yy=u(),M=o("p"),ak=a("If hitting OOM reduce "),Qd=o("code"),nk=a("stage3_max_live_parameters"),ok=a(" and "),em=o("code"),lk=a("stage3_max_reuse_distance"),rk=a(`. They should have minimal impact
...
`),tm=o("code"),uk=a("stage3_max_live_parameters"),ck=a(" and "),am=o("code"),hk=a("stage3_max_reuse_distance"),fk=a(", so it\u2019s not additive, it\u2019s just 2GB total."),by=u(),ze=o("p"),nm=o("code"),dk=a("stage3_max_live_parameters"),mk=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
...
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ey=u(),Ji=o("p"),wk=a("The following configuration values depend on the model\u2019s hidden size:"),qy=u(),Fe=o("ul"),cl=o("li"),rm=o("code"),yk=a("reduce_bucket_size"),bk=a(": "),pm=o("code"),Ek=a("hidden_size*hidden_size"),qk=u(),hl=o("li"),im=o("code"),$k=a("stage3_prefetch_bucket_size"),kk=a(": "),um=o("code"),Pk=a("0.9 * hidden_size * hidden_size"),Dk=u(),fl=o("li"),cm=o("code"),zk=a("stage3_param_persistence_threshold"),Ok=a(": "),hm=o("code"),Tk=a("10 * hidden_size"),$y=u(),Ve=o("p"),Ak=a("therefore set these values to "),fm=o("code"),Sk=a("auto"),Ck=a(" and the "),Xi=o("a"),xk=a("Trainer"),Rk=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),ky=u(),dl=o("p"),dm=o("code"),Ik=a("stage3_gather_16bit_weights_on_model_save"),Uk=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Py=u(),re=o("p"),Gk=a("If you\u2019re migrating from ZeRO-2 configuration note that "),mm=o("code"),Lk=a("allgather_partitions"),Mk=a(", "),_m=o("code"),Zk=a("allgather_bucket_size"),Nk=a(` and
...
be ignored.`),Dy=u(),Qi=o("ul"),ml=o("li"),jm=o("code"),Wk=a("sub_group_size"),Fk=a(": "),gm=o("code"),Vk=a("1e9"),zy=u(),Oe=o("p"),wm=o("code"),Yk=a("sub_group_size"),Kk=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),ym=o("code"),Jk=a("sub_group_size"),Xk=a(` and each buckets is updated one at a time. When used with NVMe offload in
...
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(ye,"A",{href:!0});var BM=r(Pi);e9=n(BM,"Trainer"),BM.forEach(t),s9=n(ye," via "),Di=l(ye,"A",{href:!0});var WM=r(Di);t9=n(WM,"TrainingArguments"),WM.forEach(t),a9=n(ye," then for the "),md=l(ye,"CODE",{});var FM=r(md);n9=n(FM,"deepspeed"),FM.forEach(t),o9=n(ye,` argument you can
pass a nested `),_d=l(ye,"CODE",{});var VM=r(_d);l9=n(VM,"dict"),VM.forEach(t),r9=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(ye,"A",{href:!0});var YM=r(zi);p9=n(YM,"TrainingArguments"),YM.forEach(t),i9=n(ye,"."),ye.forEach(t),Uw=c(e),Oi=l(e,"P",{});var KM=r(Oi);u9=n(KM,"To summarize you can do:"),KM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"P",{});var JM=r(Ti);c9=n(JM,"or:"),JM.forEach(t),Mw=c(e),d(Jo.$$.fragment,e),Zw=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Nw=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);ta=l(GE,"A",{id:!0,class:!0,href:!0});var XM=r(ta);vd=l(XM,"SPAN",{});var QM=r(vd);d(Xo.$$.fragment,QM),QM.forEach(t),XM.forEach(t),h9=c(GE),jd=l(GE,"SPAN",{});var eZ=r(jd);f9=n(eZ,"Shared Configuration"),eZ.forEach(t),GE.forEach(t),Hw=c(e),d(aa.$$.fragment,e),Bw=c(e),Me=l(e,"P",{});var vh=r(Me);d9=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var sZ=r(Si);m9=n(sZ,"Trainer"),sZ.forEach(t),_9=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var tZ=r(Ci);v9=n(tZ,"Trainer"),tZ.forEach(t),j9=n(vh," command line arguments."),vh.forEach(t),Ww=c(e),na=l(e,"P",{});var LE=r(na);g9=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var aZ=r(xi);w9=n(aZ,"Trainer"),aZ.forEach(t),y9=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fw=c(e),Ze=l(e,"P",{});var jh=r(Ze);b9=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),gd=l(jh,"CODE",{});var nZ=r(gd);E9=n(nZ,"auto"),nZ.forEach(t),q9=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
...
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vw=c(e),Ii=l(e,"P",{});var lZ=r(Ii);P9=n(lZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),lZ.forEach(t),Yw=c(e),oa=l(e,"P",{});var ME=r(oa);D9=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var rZ=r(Ui);z9=n(rZ,"TrainingArguments"),rZ.forEach(t),O9=n(ME," based on that. The steps are:"),ME.forEach(t),Kw=c(e),la=l(e,"OL",{});var ZE=r(la);wd=l(ZE,"LI",{});var pZ=r(wd);T9=n(pZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),pZ.forEach(t),A9=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S9=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var iZ=r(Gi);C9=n(iZ,"TrainingArguments"),iZ.forEach(t),x9=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jw=c(e),le=l(e,"P",{});var Hn=r(le);R9=n(Hn,"Do note that some values, such as "),yd=l(Hn,"CODE",{});var uZ=r(yd);I9=n(uZ,"scheduler.params.total_num_steps"),uZ.forEach(t),U9=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var cZ=r(Li);G9=n(cZ,"Trainer"),cZ.forEach(t),L9=n(Hn," during "),bd=l(Hn,"CODE",{});var hZ=r(bd);M9=n(hZ,"train"),hZ.forEach(t),Z9=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qw=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);ra=l(HE,"A",{id:!0,class:!0,href:!0});var fZ=r(ra);Ed=l(fZ,"SPAN",{});var dZ=r(Ed);d(el.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),N9=c(HE),qd=l(HE,"SPAN",{});var mZ=r(qd);H9=n(mZ,"ZeRO"),mZ.forEach(t),HE.forEach(t),ey=c(e),sl=l(e,"P",{});var wG=r(sl);tl=l(wG,"A",{href:!0,rel:!0});var _Z=r(tl);B9=n(_Z,"Zero Redundancy Optimizer (ZeRO)"),_Z.forEach(t),W9=n(wG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),ty=c(e),pa=l(e,"P",{});var BE=r(pa);X9=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q9=n(gZ,"Trainer"),gZ.forEach(t),e8=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),ay=c(e),Ni=l(e,"P",{});var wZ=r(Ni);s8=n(wZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),wZ.forEach(t),ny=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),oy=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);ia=l(WE,"A",{id:!0,class:!0,href:!0});var yZ=r(ia);kd=l(yZ,"SPAN",{});var bZ=r(kd);d(nl.$$.fragment,bZ),bZ.forEach(t),yZ.forEach(t),t8=c(WE),Pd=l(WE,"SPAN",{});var EZ=r(Pd);a8=n(EZ,"ZeRO-2 Config"),EZ.forEach(t),WE.forEach(t),ly=c(e),Bi=l(e,"P",{});var qZ=r(Bi);n8=n(qZ,"The following is an example of configuration for ZeRO stage 2:"),qZ.forEach(t),ry=c(e),d(ol.$$.fragment,e),py=c(e),Wi=l(e,"P",{});var $Z=r(Wi);Dd=l($Z,"STRONG",{});var kZ=r(Dd);o8=n(kZ,"Performance tuning:"),kZ.forEach(t),$Z.forEach(t),iy=c(e),He=l(e,"UL",{});var wh=r(He);Is=l(wh,"LI",{});var yh=r(Is);l8=n(yh,"enabling "),zd=l(yh,"CODE",{});var PZ=r(zd);r8=n(PZ,"offload_optimizer"),PZ.forEach(t),p8=n(yh," should reduce GPU RAM usage (it requires "),Od=l(yh,"CODE",{});var DZ=r(Od);i8=n(DZ,'"stage": 2'),DZ.forEach(t),u8=n(yh,")"),yh.forEach(t),c8=c(wh),L=l(wh,"LI",{});var te=r(L);Td=l(te,"CODE",{});var zZ=r(Td);h8=n(zZ,'"overlap_comm": true'),zZ.forEach(t),f8=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=l(te,"CODE",{});var OZ=r(Ad);d8=n(OZ,"overlap_comm"),OZ.forEach(t),m8=n(te,` uses 4.5x
...
footprint (`),xd=l(te,"CODE",{});var SZ=r(xd);w8=n(SZ,"5e8 x 2Bytes x 2 x 4.5"),SZ.forEach(t),y8=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
...
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Sp.forEach(t),Ey=c(e),Ji=l(e,"P",{});var iN=r(Ji);wk=n(iN,"The following configuration values depend on the model\u2019s hidden size:"),iN.forEach(t),qy=c(e),Fe=l(e,"UL",{});var qh=r(Fe);cl=l(qh,"LI",{});var JE=r(cl);rm=l(JE,"CODE",{});var uN=r(rm);yk=n(uN,"reduce_bucket_size"),uN.forEach(t),bk=n(JE,": "),pm=l(JE,"CODE",{});var cN=r(pm);Ek=n(cN,"hidden_size*hidden_size"),cN.forEach(t),JE.forEach(t),qk=c(qh),hl=l(qh,"LI",{});var XE=r(hl);im=l(XE,"CODE",{});var hN=r(im);$k=n(hN,"stage3_prefetch_bucket_size"),hN.forEach(t),kk=n(XE,": "),um=l(XE,"CODE",{});var fN=r(um);Pk=n(fN,"0.9 * hidden_size * hidden_size"),fN.forEach(t),XE.forEach(t),Dk=c(qh),fl=l(qh,"LI",{});var QE=r(fl);cm=l(QE,"CODE",{});var dN=r(cm);zk=n(dN,"stage3_param_persistence_threshold"),dN.forEach(t),Ok=n(QE,": "),hm=l(QE,"CODE",{});var mN=r(hm);Tk=n(mN,"10 * hidden_size"),mN.forEach(t),QE.forEach(t),qh.forEach(t),$y=c(e),Ve=l(e,"P",{});var $h=r(Ve);Ak=n($h,"therefore set these values to "),fm=l($h,"CODE",{});var _N=r(fm);Sk=n(_N,"auto"),_N.forEach(t),Ck=n($h," and the "),Xi=l($h,"A",{href:!0});var vN=r(Xi);xk=n(vN,"Trainer"),vN.forEach(t),Rk=n($h,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),$h.forEach(t),ky=c(e),dl=l(e,"P",{});var yG=r(dl);dm=l(yG,"CODE",{});var jN=r(dm);Ik=n(jN,"stage3_gather_16bit_weights_on_model_save"),jN.forEach(t),Uk=n(yG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),yG.forEach(t),Py=c(e),re=l(e,"P",{});var Bn=r(re);Gk=n(Bn,"If you\u2019re migrating from ZeRO-2 configuration note that "),mm=l(Bn,"CODE",{});var gN=r(mm);Lk=n(gN,"allgather_partitions"),gN.forEach(t),Mk=n(Bn,", "),_m=l(Bn,"CODE",{});var wN=r(_m);Zk=n(wN,"allgather_bucket_size"),wN.forEach(t),Nk=n(Bn,` and
`),vm=l(Bn,"CODE",{});var yN=r(vm);Hk=n(yN,"reduce_scatter"),yN.forEach(t),Bk=n(Bn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Bn.forEach(t),Dy=c(e),Qi=l(e,"UL",{});var bN=r(Qi);ml=l(bN,"LI",{});var eq=r(ml);jm=l(eq,"CODE",{});var EN=r(jm);Wk=n(EN,"sub_group_size"),EN.forEach(t),Fk=n(eq,": "),gm=l(eq,"CODE",{});var qN=r(gm);Vk=n(qN,"1e9"),qN.forEach(t),eq.forEach(t),bN.forEach(t),zy=c(e),Oe=l(e,"P",{});var Cp=r(Oe);wm=l(Cp,"CODE",{});var $N=r(wm);Yk=n($N,"sub_group_size"),$N.forEach(t),Kk=n(Cp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),ym=l(Cp,"CODE",{});var kN=r(ym);Jk=n(kN,"sub_group_size"),kN.forEach(t),Xk=n(Cp,` and each buckets is updated one at a time. When used with NVMe offload in
