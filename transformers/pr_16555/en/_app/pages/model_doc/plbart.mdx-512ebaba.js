...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var j=s(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function ol(me){let u,B,v,L,z;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),L=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var j=s(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function nl(me){let u,B,v,L,z;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),L=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var j=s(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function al(me){let u,B,v,L,z,T,y,j,ta,an,I,io,oa,na,je,aa,sa,Fe,ra,ia,sn,Y,fe,lo,Ee,da,co,la,rn,W,ca,Me,pa,ha,po,ua,ma,dn,Mt,fa,ln,St,ho,ga,cn,G,_a,Se,ba,ka,Ae,va,Ta,pn,Z,ge,uo,Ne,ya,mo,wa,hn,F,Pa,fo,La,qa,go,za,Ba,_o,$a,xa,bo,Ca,ja,un,_e,Fa,Oe,Ea,Ma,mn,R,Sa,Ie,ko,Aa,Na,Oa,At,Ia,Da,fn,Nt,vo,Xa,gn,De,_n,Ot,Xe,To,Wa,Ga,ee,Ra,yo,Ha,Ua,wo,Va,Ja,bn,We,kn,te,be,Po,Ge,Ka,Lo,Qa,vn,x,Re,Ya,oe,Za,It,es,ts,He,os,ns,as,ne,ss,Dt,rs,is,Xt,ds,ls,cs,qo,ps,hs,Ue,Tn,ae,ke,zo,Ve,us,Bo,ms,yn,P,Je,fs,$o,gs,_s,D,bs,Wt,ks,vs,Gt,Ts,ys,Ke,ws,Ps,Ls,Qe,qs,xo,zs,Bs,$s,Co,xs,Cs,Ye,js,ve,Ze,Fs,jo,Es,Ms,N,et,Ss,tt,As,Fo,Ns,Os,Is,ot,nt,Eo,Ds,Xs,Mo,Ws,Gs,at,So,Rs,Hs,Ao,Us,Vs,No,Js,wn,se,Te,Oo,st,Ks,Io,Qs,Pn,S,rt,Ys,it,Zs,Rt,er,tr,or,dt,nr,lt,ar,sr,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,ye,mr,Xo,fr,gr,pt,Ln,ie,we,Wo,ht,_r,Go,br,qn,A,ut,kr,mt,vr,Ut,Tr,yr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Cr,Ro,jr,Fr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Or,Bn,C,vt,Ir,Jo,Dr,Xr,Tt,Wr,Jt,Gr,Rr,Hr,yt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,ai,Qo,si,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ct,fi,tn,gi,_i,jt,Cn;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
`}}),st=new ue({}),rt=new O({props:{name:"class transformers.PLBartModel",anchor:"transformers.PLBartModel",parameters:[{name:"config",val:": PLBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16555/src/transformers/models/plbart/modeling_plbart.py#L1110",parametersDescription:[{anchor:"transformers.PLBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16555/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ct=new O({props:{name:"forward",anchor:"transformers.PLBartModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16555/src/transformers/models/plbart/modeling_plbart.py#L1136",parametersDescription:[{anchor:"transformers.PLBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
See <a href="/docs/transformers/pr_16555/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16555/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16555/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16555/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16555/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),qt=new X({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),zt=new X({props:{code:`import torch
from transformers import PLBartTokenizer, PLBartForSequenceClassification
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(T.$$.fragment),y=l(),j=n("span"),ta=r("PLBart"),an=l(),I=n("p"),io=n("strong"),oa=r("DISCLAIMER:"),na=r(" If you see something strange, file a "),je=n("a"),aa=r("Github Issue"),sa=r(` and assign
`),Fe=n("a"),ra=r("@gchhablani"),ia=r("."),sn=l(),Y=n("h2"),fe=n("a"),lo=n("span"),m(Ee.$$.fragment),da=l(),co=n("span"),la=r("Overview of PLBart"),rn=l(),W=n("p"),ca=r("The PLBART model was proposed in "),Me=n("a"),pa=r("Unified Pre-training for Program Understanding and Generation"),ha=r(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
even with limited annotations.`),cn=l(),G=n("p"),_a=r("This model was contributed by "),Se=n("a"),ba=r("gchhablani"),ka=r(". The Authors\u2019 code can be found "),Ae=n("a"),va=r("here"),Ta=r("."),pn=l(),Z=n("h3"),ge=n("a"),uo=n("span"),m(Ne.$$.fragment),ya=l(),mo=n("span"),wa=r("Training of PLBart"),hn=l(),F=n("p"),Pa=r(`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
...
target text format is `),_o=n("code"),$a=r("[tgt_lang_code] X [eos]"),xa=r(". "),bo=n("code"),Ca=r("bos"),ja=r(" is never used."),un=l(),_e=n("p"),Fa=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=n("a"),Ea=r("the paper"),Ma=r(" to learn more about this."),mn=l(),R=n("p"),Sa=r("In cases where the language code is needed, The regular "),Ie=n("a"),ko=n("strong"),Aa=r("call"),Na=r("()"),Oa=r(` will encode source text format, and it should be wrapped
inside the context manager `),At=n("a"),Ia=r("as_target_tokenizer()"),Da=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xa=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),Ot=n("ul"),Xe=n("li"),To=n("p"),Wa=r("Generation"),Ga=l(),ee=n("p"),Ra=r("While generating the target text set the "),yo=n("code"),Ha=r("decoder_start_token_id"),Ua=r(` to the target language id. The following
example shows how to translate Python to English using the `),wo=n("code"),Va=r("uclanlp/plbart-python-en_XX"),Ja=r(" model."),bn=l(),m(We.$$.fragment),kn=l(),te=n("h2"),be=n("a"),Po=n("span"),m(Ge.$$.fragment),Ka=l(),Lo=n("span"),Qa=r("PLBartConfig"),vn=l(),x=n("div"),m(Re.$$.fragment),Ya=l(),oe=n("p"),Za=r("This is the configuration class to store the configuration of a "),It=n("a"),es=r("PLBartModel"),ts=r(`. It is used to instantiate an
...
documentation from `),Xt=n("a"),ds=r("PretrainedConfig"),ls=r(" for more information."),cs=l(),qo=n("p"),ps=r("Example:"),hs=l(),m(Ue.$$.fragment),Tn=l(),ae=n("h2"),ke=n("a"),zo=n("span"),m(Ve.$$.fragment),us=l(),Bo=n("span"),ms=r("PLBartTokenizer"),yn=l(),P=n("div"),m(Je.$$.fragment),fs=l(),$o=n("p"),gs=r("Construct an PLBART tokenizer."),_s=l(),D=n("p"),bs=r("Adapted from "),Wt=n("a"),ks=r("RobertaTokenizer"),vs=r(" and "),Gt=n("a"),Ts=r("XLNetTokenizer"),ys=r(`. Based on
`),Ke=n("a"),ws=r("SentencePiece"),Ps=r("."),Ls=l(),Qe=n("p"),qs=r("The tokenization method is "),xo=n("code"),zs=r("<tokens> <eos> <language code>"),Bs=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$s=l(),Co=n("p"),xs=r("Examples:"),Cs=l(),m(Ye.$$.fragment),js=l(),ve=n("div"),m(Ze.$$.fragment),Fs=l(),jo=n("p"),Es=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An PLBART sequence has the following format, where `),Fo=n("code"),Ns=r("X"),Os=r(" represents the sequence:"),Is=l(),ot=n("ul"),nt=n("li"),Eo=n("code"),Ds=r("input_ids"),Xs=r(" (for encoder) "),Mo=n("code"),Ws=r("X [eos, src_lang_code]"),Gs=l(),at=n("li"),So=n("code"),Rs=r("decoder_input_ids"),Hs=r(": (for decoder) "),Ao=n("code"),Us=r("X [eos, tgt_lang_code]"),Vs=l(),No=n("p"),Js=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),wn=l(),se=n("h2"),Te=n("a"),Oo=n("span"),m(st.$$.fragment),Ks=l(),Io=n("span"),Qs=r("PLBartModel"),Pn=l(),S=n("div"),m(rt.$$.fragment),Ys=l(),it=n("p"),Zs=r(`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=l(),M=n("div"),m(_t.$$.fragment),Br=l(),de=n("p"),$r=r("The "),Vt=n("a"),xr=r("PLBartForConditionalGeneration"),Cr=r(" forward method, overrides the "),Ro=n("code"),jr=r("__call__"),Fr=r(" special method."),Er=l(),m(Pe.$$.fragment),Mr=l(),Ho=n("p"),Sr=r("Mask-filling example:"),Ar=l(),m(bt.$$.fragment),zn=l(),le=n("h2"),Le=n("a"),Uo=n("span"),m(kt.$$.fragment),Nr=l(),Vo=n("span"),Or=r("PLBartForSequenceClassification"),Bn=l(),C=n("div"),m(vt.$$.fragment),Ir=l(),Jo=n("p"),Dr=r(`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Xr=l(),Tt=n("p"),Wr=r("This model inherits from "),Jt=n("a"),Gr=r("PreTrainedModel"),Rr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hr=l(),yt=n("p"),Ur=r("This model is also a PyTorch "),wt=n("a"),Vr=r("torch.nn.Module"),Jr=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kr=l(),w=n("div"),m(Pt.$$.fragment),Qr=l(),ce=n("p"),Yr=r("The "),Kt=n("a"),Zr=r("PLBartForSequenceClassification"),ei=r(" forward method, overrides the "),Ko=n("code"),ti=r("__call__"),oi=r(" special method."),ni=l(),m(qe.$$.fragment),ai=l(),Qo=n("p"),si=r("Example of single-label classification:"),ri=l(),m(Lt.$$.fragment),ii=l(),m(qt.$$.fragment),di=l(),Yo=n("p"),li=r("Example of multi-label classification:"),ci=l(),m(zt.$$.fragment),pi=l(),m(Bt.$$.fragment),$n=l(),pe=n("h2"),ze=n("a"),Zo=n("span"),m($t.$$.fragment),hi=l(),en=n("span"),ui=r("PLBartForCausalLM"),xn=l(),he=n("div"),m(xt.$$.fragment),mi=l(),H=n("div"),m(Ct.$$.fragment),fi=l(),tn=n("p"),gi=r("Example:"),_i=l(),m(jt.$$.fragment),this.h()},l(t){const p=Zd('[data-svelte="svelte-1phssyn"]',document.head);u=a(p,"META",{name:!0,content:!0}),p.forEach(o),B=c(t),v=a(t,"H1",{class:!0});var Ft=s(v);L=a(Ft,"A",{id:!0,class:!0,href:!0});var on=s(L);z=a(on,"SPAN",{});var nn=s(z);f(T.$$.fragment,nn),nn.forEach(o),on.forEach(o),y=c(Ft),j=a(Ft,"SPAN",{});var vi=s(j);ta=i(vi,"PLBart"),vi.forEach(o),Ft.forEach(o),an=c(t),I=a(t,"P",{});var Et=s(I);io=a(Et,"STRONG",{});var Ti=s(io);oa=i(Ti,"DISCLAIMER:"),Ti.forEach(o),na=i(Et," If you see something strange, file a "),je=a(Et,"A",{href:!0,rel:!0});var yi=s(je);aa=i(yi,"Github Issue"),yi.forEach(o),sa=i(Et,` and assign
`),Fe=a(Et,"A",{href:!0,rel:!0});var wi=s(Fe);ra=i(wi,"@gchhablani"),wi.forEach(o),ia=i(Et,"."),Et.forEach(o),sn=c(t),Y=a(t,"H2",{class:!0});var jn=s(Y);fe=a(jn,"A",{id:!0,class:!0,href:!0});var Pi=s(fe);lo=a(Pi,"SPAN",{});var Li=s(lo);f(Ee.$$.fragment,Li),Li.forEach(o),Pi.forEach(o),da=c(jn),co=a(jn,"SPAN",{});var qi=s(co);la=i(qi,"Overview of PLBart"),qi.forEach(o),jn.forEach(o),rn=c(t),W=a(t,"P",{});var Qt=s(W);ca=i(Qt,"The PLBART model was proposed in "),Me=a(Qt,"A",{href:!0,rel:!0});var zi=s(Me);pa=i(zi,"Unified Pre-training for Program Understanding and Generation"),zi.forEach(o),ha=i(Qt,` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
on Java, Python and English.`),Qt.forEach(o),dn=c(t),Mt=a(t,"P",{});var $i=s(Mt);fa=i($i,"According to the abstract"),$i.forEach(o),ln=c(t),St=a(t,"P",{});var xi=s(St);ho=a(xi,"EM",{});var Ci=s(ho);ga=i(Ci,`Code summarization and generation empower conversion between programming language (PL) and natural language (NL),
while code translation avails the migration of legacy code from one PL to another. This paper introduces PLBART,
a sequence-to-sequence model capable of performing a broad spectrum of program and language understanding and generation tasks.
PLBART is pre-trained on an extensive collection of Java and Python functions and associated NL text via denoising autoencoding.
Experiments on code summarization in the English language, code generation, and code translation in seven programming languages
...
Furthermore, analysis reveals that PLBART learns program syntax, style (e.g., identifier naming convention), logical flow
(e.g., if block inside an else block is equivalent to else if block) that are crucial to program semantics and thus excels
even with limited annotations.`),Ci.forEach(o),xi.forEach(o),cn=c(t),G=a(t,"P",{});var Yt=s(G);_a=i(Yt,"This model was contributed by "),Se=a(Yt,"A",{href:!0,rel:!0});var ji=s(Se);ba=i(ji,"gchhablani"),ji.forEach(o),ka=i(Yt,". The Authors\u2019 code can be found "),Ae=a(Yt,"A",{href:!0,rel:!0});var Fi=s(Ae);va=i(Fi,"here"),Fi.forEach(o),Ta=i(Yt,"."),Yt.forEach(o),pn=c(t),Z=a(t,"H3",{class:!0});var Fn=s(Z);ge=a(Fn,"A",{id:!0,class:!0,href:!0});var Ei=s(ge);uo=a(Ei,"SPAN",{});var Mi=s(uo);f(Ne.$$.fragment,Mi),Mi.forEach(o),Ei.forEach(o),ya=c(Fn),mo=a(Fn,"SPAN",{});var Si=s(mo);wa=i(Si,"Training of PLBart"),Si.forEach(o),Fn.forEach(o),hn=c(t),F=a(t,"P",{});var U=s(F);Pa=i(U,`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
target text format is `),_o=a(U,"CODE",{});var Oi=s(_o);$a=i(Oi,"[tgt_lang_code] X [eos]"),Oi.forEach(o),xa=i(U,". "),bo=a(U,"CODE",{});var Ii=s(bo);Ca=i(Ii,"bos"),Ii.forEach(o),ja=i(U," is never used."),U.forEach(o),un=c(t),_e=a(t,"P",{});var En=s(_e);Fa=i(En,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=a(En,"A",{href:!0,rel:!0});var Di=s(Oe);Ea=i(Di,"the paper"),Di.forEach(o),Ma=i(En," to learn more about this."),En.forEach(o),mn=c(t),R=a(t,"P",{});var Zt=s(R);Sa=i(Zt,"In cases where the language code is needed, The regular "),Ie=a(Zt,"A",{href:!0});var bi=s(Ie);ko=a(bi,"STRONG",{});var Xi=s(ko);Aa=i(Xi,"call"),Xi.forEach(o),Na=i(bi,"()"),bi.forEach(o),Oa=i(Zt,` will encode source text format, and it should be wrapped
inside the context manager `),At=a(Zt,"A",{href:!0});var Wi=s(At);Ia=i(Wi,"as_target_tokenizer()"),Wi.forEach(o),Da=i(Zt," to encode target text format."),Zt.forEach(o),fn=c(t),Nt=a(t,"UL",{});var Gi=s(Nt);vo=a(Gi,"LI",{});var Ri=s(vo);Xa=i(Ri,"Supervised training"),Ri.forEach(o),Gi.forEach(o),gn=c(t),f(De.$$.fragment,t),_n=c(t),Ot=a(t,"UL",{});var Hi=s(Ot);Xe=a(Hi,"LI",{});var Mn=s(Xe);To=a(Mn,"P",{});var Ui=s(To);Wa=i(Ui,"Generation"),Ui.forEach(o),Ga=c(Mn),ee=a(Mn,"P",{});var eo=s(ee);Ra=i(eo,"While generating the target text set the "),yo=a(eo,"CODE",{});var Vi=s(yo);Ha=i(Vi,"decoder_start_token_id"),Vi.forEach(o),Ua=i(eo,` to the target language id. The following
example shows how to translate Python to English using the `),wo=a(eo,"CODE",{});var Ji=s(wo);Va=i(Ji,"uclanlp/plbart-python-en_XX"),Ji.forEach(o),Ja=i(eo," model."),eo.forEach(o),Mn.forEach(o),Hi.forEach(o),bn=c(t),f(We.$$.fragment,t),kn=c(t),te=a(t,"H2",{class:!0});var Sn=s(te);be=a(Sn,"A",{id:!0,class:!0,href:!0});var Ki=s(be);Po=a(Ki,"SPAN",{});var Qi=s(Po);f(Ge.$$.fragment,Qi),Qi.forEach(o),Ki.forEach(o),Ka=c(Sn),Lo=a(Sn,"SPAN",{});var Yi=s(Lo);Qa=i(Yi,"PLBartConfig"),Yi.forEach(o),Sn.forEach(o),vn=c(t),x=a(t,"DIV",{class:!0});var V=s(x);f(Re.$$.fragment,V),Ya=c(V),oe=a(V,"P",{});var to=s(oe);Za=i(to,"This is the configuration class to store the configuration of a "),It=a(to,"A",{href:!0});var Zi=s(It);es=i(Zi,"PLBartModel"),Zi.forEach(o),ts=i(to,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
documentation from `),Xt=a(oo,"A",{href:!0});var od=s(Xt);ds=i(od,"PretrainedConfig"),od.forEach(o),ls=i(oo," for more information."),oo.forEach(o),cs=c(V),qo=a(V,"P",{});var nd=s(qo);ps=i(nd,"Example:"),nd.forEach(o),hs=c(V),f(Ue.$$.fragment,V),V.forEach(o),Tn=c(t),ae=a(t,"H2",{class:!0});var An=s(ae);ke=a(An,"A",{id:!0,class:!0,href:!0});var ad=s(ke);zo=a(ad,"SPAN",{});var sd=s(zo);f(Ve.$$.fragment,sd),sd.forEach(o),ad.forEach(o),us=c(An),Bo=a(An,"SPAN",{});var rd=s(Bo);ms=i(rd,"PLBartTokenizer"),rd.forEach(o),An.forEach(o),yn=c(t),P=a(t,"DIV",{class:!0});var $=s(P);f(Je.$$.fragment,$),fs=c($),$o=a($,"P",{});var id=s($o);gs=i(id,"Construct an PLBART tokenizer."),id.forEach(o),_s=c($),D=a($,"P",{});var Be=s(D);bs=i(Be,"Adapted from "),Wt=a(Be,"A",{href:!0});var dd=s(Wt);ks=i(dd,"RobertaTokenizer"),dd.forEach(o),vs=i(Be," and "),Gt=a(Be,"A",{href:!0});var ld=s(Gt);Ts=i(ld,"XLNetTokenizer"),ld.forEach(o),ys=i(Be,`. Based on
`),Ke=a(Be,"A",{href:!0,rel:!0});var cd=s(Ke);ws=i(cd,"SentencePiece"),cd.forEach(o),Ps=i(Be,"."),Be.forEach(o),Ls=c($),Qe=a($,"P",{});var Nn=s(Qe);qs=i(Nn,"The tokenization method is "),xo=a(Nn,"CODE",{});var pd=s(xo);zs=i(pd,"<tokens> <eos> <language code>"),pd.forEach(o),Bs=i(Nn," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Nn.forEach(o),$s=c($),Co=a($,"P",{});var hd=s(Co);xs=i(hd,"Examples:"),hd.forEach(o),Cs=c($),f(Ye.$$.fragment,$),js=c($),ve=a($,"DIV",{class:!0});var On=s(ve);f(Ze.$$.fragment,On),Fs=c(On),jo=a(On,"P",{});var ud=s(jo);Es=i(ud,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An PLBART sequence has the following format, where `),Fo=a(In,"CODE",{});var md=s(Fo);Ns=i(md,"X"),md.forEach(o),Os=i(In," represents the sequence:"),In.forEach(o),Is=c($e),ot=a($e,"UL",{});var Dn=s(ot);nt=a(Dn,"LI",{});var Xn=s(nt);Eo=a(Xn,"CODE",{});var fd=s(Eo);Ds=i(fd,"input_ids"),fd.forEach(o),Xs=i(Xn," (for encoder) "),Mo=a(Xn,"CODE",{});var gd=s(Mo);Ws=i(gd,"X [eos, src_lang_code]"),gd.forEach(o),Xn.forEach(o),Gs=c(Dn),at=a(Dn,"LI",{});var Wn=s(at);So=a(Wn,"CODE",{});var _d=s(So);Rs=i(_d,"decoder_input_ids"),_d.forEach(o),Hs=i(Wn,": (for decoder) "),Ao=a(Wn,"CODE",{});var bd=s(Ao);Us=i(bd,"X [eos, tgt_lang_code]"),bd.forEach(o),Wn.forEach(o),Dn.forEach(o),Vs=c($e),No=a($e,"P",{});var kd=s(No);Js=i(kd,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),se=a(t,"H2",{class:!0});var Gn=s(se);Te=a(Gn,"A",{id:!0,class:!0,href:!0});var vd=s(Te);Oo=a(vd,"SPAN",{});var Td=s(Oo);f(st.$$.fragment,Td),Td.forEach(o),vd.forEach(o),Ks=c(Gn),Io=a(Gn,"SPAN",{});var yd=s(Io);Qs=i(yd,"PLBartModel"),yd.forEach(o),Gn.forEach(o),Pn=c(t),S=a(t,"DIV",{class:!0});var xe=s(S);f(rt.$$.fragment,xe),Ys=c(xe),it=a(xe,"P",{});var Rn=s(it);Zs=i(Rn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Rt=a(Rn,"A",{href:!0});var wd=s(Rt);er=i(wd,"PreTrainedModel"),wd.forEach(o),tr=i(Rn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rn.forEach(o),or=c(xe),dt=a(xe,"P",{});var Hn=s(dt);nr=i(Hn,"This model is also a PyTorch "),lt=a(Hn,"A",{href:!0,rel:!0});var Pd=s(lt);ar=i(Pd,"torch.nn.Module"),Pd.forEach(o),sr=i(Hn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hn.forEach(o),rr=c(xe),E=a(xe,"DIV",{class:!0});var J=s(E);f(ct.$$.fragment,J),ir=c(J),re=a(J,"P",{});var no=s(re);dr=i(no,"The "),Ht=a(no,"A",{href:!0});var Ld=s(Ht);lr=i(Ld,"PLBartModel"),Ld.forEach(o),cr=i(no," forward method, overrides the "),Do=a(no,"CODE",{});var qd=s(Do);pr=i(qd,"__call__"),qd.forEach(o),hr=i(no," special method."),no.forEach(o),ur=c(J),f(ye.$$.fragment,J),mr=c(J),Xo=a(J,"P",{});var zd=s(Xo);fr=i(zd,"Example:"),zd.forEach(o),gr=c(J),f(pt.$$.fragment,J),J.forEach(o),xe.forEach(o),Ln=c(t),ie=a(t,"H2",{class:!0});var Un=s(ie);we=a(Un,"A",{id:!0,class:!0,href:!0});var Bd=s(we);Wo=a(Bd,"SPAN",{});var $d=s(Wo);f(ht.$$.fragment,$d),$d.forEach(o),Bd.forEach(o),_r=c(Un),Go=a(Un,"SPAN",{});var xd=s(Go);br=i(xd,"PLBartForConditionalGeneration"),xd.forEach(o),Un.forEach(o),qn=c(t),A=a(t,"DIV",{class:!0});var Ce=s(A);f(ut.$$.fragment,Ce),kr=c(Ce),mt=a(Ce,"P",{});var Vn=s(mt);vr=i(Vn,`The PLBART Model with a language modeling head. Can be used for code-to-text, text-to-code and code-to-code.
This model inherits from `),Ut=a(Vn,"A",{href:!0});var Cd=s(Ut);Tr=i(Cd,"PreTrainedModel"),Cd.forEach(o),yr=i(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vn.forEach(o),wr=c(Ce),ft=a(Ce,"P",{});var Jn=s(ft);Pr=i(Jn,"This model is also a PyTorch "),gt=a(Jn,"A",{href:!0,rel:!0});var jd=s(gt);Lr=i(jd,"torch.nn.Module"),jd.forEach(o),qr=i(Jn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jn.forEach(o),zr=c(Ce),M=a(Ce,"DIV",{class:!0});var K=s(M);f(_t.$$.fragment,K),Br=c(K),de=a(K,"P",{});var ao=s(de);$r=i(ao,"The "),Vt=a(ao,"A",{href:!0});var Fd=s(Vt);xr=i(Fd,"PLBartForConditionalGeneration"),Fd.forEach(o),Cr=i(ao," forward method, overrides the "),Ro=a(ao,"CODE",{});var Ed=s(Ro);jr=i(Ed,"__call__"),Ed.forEach(o),Fr=i(ao," special method."),ao.forEach(o),Er=c(K),f(Pe.$$.fragment,K),Mr=c(K),Ho=a(K,"P",{});var Md=s(Ho);Sr=i(Md,"Mask-filling example:"),Md.forEach(o),Ar=c(K),f(bt.$$.fragment,K),K.forEach(o),Ce.forEach(o),zn=c(t),le=a(t,"H2",{class:!0});var Kn=s(le);Le=a(Kn,"A",{id:!0,class:!0,href:!0});var Sd=s(Le);Uo=a(Sd,"SPAN",{});var Ad=s(Uo);f(kt.$$.fragment,Ad),Ad.forEach(o),Sd.forEach(o),Nr=c(Kn),Vo=a(Kn,"SPAN",{});var Nd=s(Vo);Or=i(Nd,"PLBartForSequenceClassification"),Nd.forEach(o),Kn.forEach(o),Bn=c(t),C=a(t,"DIV",{class:!0});var Q=s(C);f(vt.$$.fragment,Q),Ir=c(Q),Jo=a(Q,"P",{});var Od=s(Jo);Dr=i(Od,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Od.forEach(o),Xr=c(Q),Tt=a(Q,"P",{});var Qn=s(Tt);Wr=i(Qn,"This model inherits from "),Jt=a(Qn,"A",{href:!0});var Id=s(Jt);Gr=i(Id,"PreTrainedModel"),Id.forEach(o),Rr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qn.forEach(o),Hr=c(Q),yt=a(Q,"P",{});var Yn=s(yt);Ur=i(Yn,"This model is also a PyTorch "),wt=a(Yn,"A",{href:!0,rel:!0});var Dd=s(wt);Vr=i(Dd,"torch.nn.Module"),Dd.forEach(o),Jr=i(Yn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yn.forEach(o),Kr=c(Q),w=a(Q,"DIV",{class:!0});var q=s(w);f(Pt.$$.fragment,q),Qr=c(q),ce=a(q,"P",{});var so=s(ce);Yr=i(so,"The "),Kt=a(so,"A",{href:!0});var Xd=s(Kt);Zr=i(Xd,"PLBartForSequenceClassification"),Xd.forEach(o),ei=i(so," forward method, overrides the "),Ko=a(so,"CODE",{});var Wd=s(Ko);ti=i(Wd,"__call__"),Wd.forEach(o),oi=i(so," special method."),so.forEach(o),ni=c(q),f(qe.$$.fragment,q),ai=c(q),Qo=a(q,"P",{});var Gd=s(Qo);si=i(Gd,"Example of single-label classification:"),Gd.forEach(o),ri=c(q),f(Lt.$$.fragment,q),ii=c(q),f(qt.$$.fragment,q),di=c(q),Yo=a(q,"P",{});var Rd=s(Yo);li=i(Rd,"Example of multi-label classification:"),Rd.forEach(o),ci=c(q),f(zt.$$.fragment,q),pi=c(q),f(Bt.$$.fragment,q),q.forEach(o),Q.forEach(o),$n=c(t),pe=a(t,"H2",{class:!0});var Zn=s(pe);ze=a(Zn,"A",{id:!0,class:!0,href:!0});var Hd=s(ze);Zo=a(Hd,"SPAN",{});var Ud=s(Zo);f($t.$$.fragment,Ud),Ud.forEach(o),Hd.forEach(o),hi=c(Zn),en=a(Zn,"SPAN",{});var Vd=s(en);ui=i(Vd,"PLBartForCausalLM"),Vd.forEach(o),Zn.forEach(o),xn=c(t),he=a(t,"DIV",{class:!0});var ea=s(he);f(xt.$$.fragment,ea),mi=c(ea),H=a(ea,"DIV",{class:!0});var ro=s(H);f(Ct.$$.fragment,ro),fi=c(ro),tn=a(ro,"P",{});var Jd=s(tn);gi=i(Jd,"Example:"),Jd.forEach(o),_i=c(ro),f(jt.$$.fragment,ro),ro.forEach(o),ea.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(sl)),d(L,"id","plbart"),d(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(L,"href","#plbart"),d(v,"class","relative group"),d(je,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),d(je,"rel","nofollow"),d(Fe,"href","https://www.github.com/gchhablani"),d(Fe,"rel","nofollow"),d(fe,"id","overview-of-plbart"),d(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(fe,"href","#overview-of-plbart"),d(Y,"class","relative group"),d(Me,"href","https://arxiv.org/abs/2103.06333"),d(Me,"rel","nofollow"),d(Se,"href","https://huggingface.co/gchhablani"),d(Se,"rel","nofollow"),d(Ae,"href","https://github.com/wasiahmad/PLBART"),d(Ae,"rel","nofollow"),d(ge,"id","training-of-plbart"),d(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ge,"href","#training-of-plbart"),d(Z,"class","relative group"),d(Oe,"href","https://arxiv.org/abs/2103.06333"),d(Oe,"rel","nofollow"),d(Ie,"href","/docs/transformers/pr_16555/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__"),d(At,"href","/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartTokenizer.as_target_tokenizer"),d(be,"id","transformers.PLBartConfig"),d(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(be,"href","#transformers.PLBartConfig"),d(te,"class","relative group"),d(It,"href","/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartModel"),d(He,"href","https://huggingface.co/uclanlp/plbart-base"),d(He,"rel","nofollow"),d(Dt,"href","/docs/transformers/pr_16555/en/main_classes/configuration#transformers.PretrainedConfig"),d(Xt,"href","/docs/transformers/pr_16555/en/main_classes/configuration#transformers.PretrainedConfig"),d(x,"class","docstring"),d(ke,"id","transformers.PLBartTokenizer"),d(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ke,"href","#transformers.PLBartTokenizer"),d(ae,"class","relative group"),d(Wt,"href","/docs/transformers/pr_16555/en/model_doc/roberta#transformers.RobertaTokenizer"),d(Gt,"href","/docs/transformers/pr_16555/en/model_doc/xlnet#transformers.XLNetTokenizer"),d(Ke,"href","https://github.com/google/sentencepiece"),d(Ke,"rel","nofollow"),d(ve,"class","docstring"),d(N,"class","docstring"),d(P,"class","docstring"),d(Te,"id","transformers.PLBartModel"),d(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Te,"href","#transformers.PLBartModel"),d(se,"class","relative group"),d(Rt,"href","/docs/transformers/pr_16555/en/main_classes/model#transformers.PreTrainedModel"),d(lt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(lt,"rel","nofollow"),d(Ht,"href","/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartModel"),d(E,"class","docstring"),d(S,"class","docstring"),d(we,"id","transformers.PLBartForConditionalGeneration"),d(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(we,"href","#transformers.PLBartForConditionalGeneration"),d(ie,"class","relative group"),d(Ut,"href","/docs/transformers/pr_16555/en/main_classes/model#transformers.PreTrainedModel"),d(gt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(gt,"rel","nofollow"),d(Vt,"href","/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartForConditionalGeneration"),d(M,"class","docstring"),d(A,"class","docstring"),d(Le,"id","transformers.PLBartForSequenceClassification"),d(Le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Le,"href","#transformers.PLBartForSequenceClassification"),d(le,"class","relative group"),d(Jt,"href","/docs/transformers/pr_16555/en/main_classes/model#transformers.PreTrainedModel"),d(wt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(wt,"rel","nofollow"),d(Kt,"href","/docs/transformers/pr_16555/en/model_doc/plbart#transformers.PLBartForSequenceClassification"),d(w,"class","docstring"),d(C,"class","docstring"),d(ze,"id","transformers.PLBartForCausalLM"),d(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ze,"href","#transformers.PLBartForCausalLM"),d(pe,"class","relative group"),d(H,"class","docstring"),d(he,"class","docstring")},m(t,p){e(document.head,u),h(t,B,p),h(t,v,p),e(v,L),e(L,z),g(T,z,null),e(v,y),e(v,j),e(j,ta),h(t,an,p),h(t,I,p),e(I,io),e(io,oa),e(I,na),e(I,je),e(je,aa),e(I,sa),e(I,Fe),e(Fe,ra),e(I,ia),h(t,sn,p),h(t,Y,p),e(Y,fe),e(fe,lo),g(Ee,lo,null),e(Y,da),e(Y,co),e(co,la),h(t,rn,p),h(t,W,p),e(W,ca),e(W,Me),e(Me,pa),e(W,ha),e(W,po),e(po,ua),e(W,ma),h(t,dn,p),h(t,Mt,p),e(Mt,fa),h(t,ln,p),h(t,St,p),e(St,ho),e(ho,ga),h(t,cn,p),h(t,G,p),e(G,_a),e(G,Se),e(Se,ba),e(G,ka),e(G,Ae),e(Ae,va),e(G,Ta),h(t,pn,p),h(t,Z,p),e(Z,ge),e(ge,uo),g(Ne,uo,null),e(Z,ya),e(Z,mo),e(mo,wa),h(t,hn,p),h(t,F,p),e(F,Pa),e(F,fo),e(fo,La),e(F,qa),e(F,go),e(go,za),e(F,Ba),e(F,_o),e(_o,$a),e(F,xa),e(F,bo),e(bo,Ca),e(F,ja),h(t,un,p),h(t,_e,p),e(_e,Fa),e(_e,Oe),e(Oe,Ea),e(_e,Ma),h(t,mn,p),h(t,R,p),e(R,Sa),e(R,Ie),e(Ie,ko),e(ko,Aa),e(Ie,Na),e(R,Oa),e(R,At),e(At,Ia),e(R,Da),h(t,fn,p),h(t,Nt,p),e(Nt,vo),e(vo,Xa),h(t,gn,p),g(De,t,p),h(t,_n,p),h(t,Ot,p),e(Ot,Xe),e(Xe,To),e(To,Wa),e(Xe,Ga),e(Xe,ee),e(ee,Ra),e(ee,yo),e(yo,Ha),e(ee,Ua),e(ee,wo),e(wo,Va),e(ee,Ja),h(t,bn,p),g(We,t,p),h(t,kn,p),h(t,te,p),e(te,be),e(be,Po),g(Ge,Po,null),e(te,Ka),e(te,Lo),e(Lo,Qa),h(t,vn,p),h(t,x,p),g(Re,x,null),e(x,Ya),e(x,oe),e(oe,Za),e(oe,It),e(It,es),e(oe,ts),e(oe,He),e(He,os),e(oe,ns),e(x,as),e(x,ne),e(ne,ss),e(ne,Dt),e(Dt,rs),e(ne,is),e(ne,Xt),e(Xt,ds),e(ne,ls),e(x,cs),e(x,qo),e(qo,ps),e(x,hs),g(Ue,x,null),h(t,Tn,p),h(t,ae,p),e(ae,ke),e(ke,zo),g(Ve,zo,null),e(ae,us),e(ae,Bo),e(Bo,ms),h(t,yn,p),h(t,P,p),g(Je,P,null),e(P,fs),e(P,$o),e($o,gs),e(P,_s),e(P,D),e(D,bs),e(D,Wt),e(Wt,ks),e(D,vs),e(D,Gt),e(Gt,Ts),e(D,ys),e(D,Ke),e(Ke,ws),e(D,Ps),e(P,Ls),e(P,Qe),e(Qe,qs),e(Qe,xo),e(xo,zs),e(Qe,Bs),e(P,$s),e(P,Co),e(Co,xs),e(P,Cs),g(Ye,P,null),e(P,js),e(P,ve),g(Ze,ve,null),e(ve,Fs),e(ve,jo),e(jo,Es),e(P,Ms),e(P,N),g(et,N,null),e(N,Ss),e(N,tt),e(tt,As),e(tt,Fo),e(Fo,Ns),e(tt,Os),e(N,Is),e(N,ot),e(ot,nt),e(nt,Eo),e(Eo,Ds),e(nt,Xs),e(nt,Mo),e(Mo,Ws),e(ot,Gs),e(ot,at),e(at,So),e(So,Rs),e(at,Hs),e(at,Ao),e(Ao,Us),e(N,Vs),e(N,No),e(No,Js),h(t,wn,p),h(t,se,p),e(se,Te),e(Te,Oo),g(st,Oo,null),e(se,Ks),e(se,Io),e(Io,Qs),h(t,Pn,p),h(t,S,p),g(rt,S,null),e(S,Ys),e(S,it),e(it,Zs),e(it,Rt),e(Rt,er),e(it,tr),e(S,or),e(S,dt),e(dt,nr),e(dt,lt),e(lt,ar),e(dt,sr),e(S,rr),e(S,E),g(ct,E,null),e(E,ir),e(E,re),e(re,dr),e(re,Ht),e(Ht,lr),e(re,cr),e(re,Do),e(Do,pr),e(re,hr),e(E,ur),g(ye,E,null),e(E,mr),e(E,Xo),e(Xo,fr),e(E,gr),g(pt,E,null),h(t,Ln,p),h(t,ie,p),e(ie,we),e(we,Wo),g(ht,Wo,null),e(ie,_r),e(ie,Go),e(Go,br),h(t,qn,p),h(t,A,p),g(ut,A,null),e(A,kr),e(A,mt),e(mt,vr),e(mt,Ut),e(Ut,Tr),e(mt,yr),e(A,wr),e(A,ft),e(ft,Pr),e(ft,gt),e(gt,Lr),e(ft,qr),e(A,zr),e(A,M),g(_t,M,null),e(M,Br),e(M,de),e(de,$r),e(de,Vt),e(Vt,xr),e(de,Cr),e(de,Ro),e(Ro,jr),e(de,Fr),e(M,Er),g(Pe,M,null),e(M,Mr),e(M,Ho),e(Ho,Sr),e(M,Ar),g(bt,M,null),h(t,zn,p),h(t,le,p),e(le,Le),e(Le,Uo),g(kt,Uo,null),e(le,Nr),e(le,Vo),e(Vo,Or),h(t,Bn,p),h(t,C,p),g(vt,C,null),e(C,Ir),e(C,Jo),e(Jo,Dr),e(C,Xr),e(C,Tt),e(Tt,Wr),e(Tt,Jt),e(Jt,Gr),e(Tt,Rr),e(C,Hr),e(C,yt),e(yt,Ur),e(yt,wt),e(wt,Vr),e(yt,Jr),e(C,Kr),e(C,w),g(Pt,w,null),e(w,Qr),e(w,ce),e(ce,Yr),e(ce,Kt),e(Kt,Zr),e(ce,ei),e(ce,Ko),e(Ko,ti),e(ce,oi),e(w,ni),g(qe,w,null),e(w,ai),e(w,Qo),e(Qo,si),e(w,ri),g(Lt,w,null),e(w,ii),g(qt,w,null),e(w,di),e(w,Yo),e(Yo,li),e(w,ci),g(zt,w,null),e(w,pi),g(Bt,w,null),h(t,$n,p),h(t,pe,p),e(pe,ze),e(ze,Zo),g($t,Zo,null),e(pe,hi),e(pe,en),e(en,ui),h(t,xn,p),h(t,he,p),g(xt,he,null),e(he,mi),e(he,H),g(Ct,H,null),e(H,fi),e(H,tn),e(tn,gi),e(H,_i),g(jt,H,null),Cn=!0},p(t,[p]){const Ft={};p&2&&(Ft.$$scope={dirty:p,ctx:t}),ye.$set(Ft);const on={};p&2&&(on.$$scope={dirty:p,ctx:t}),Pe.$set(on);const nn={};p&2&&(nn.$$scope={dirty:p,ctx:t}),qe.$set(nn)},i(t){Cn||(_(T.$$.fragment,t),_(Ee.$$.fragment,t),_(Ne.$$.fragment,t),_(De.$$.fragment,t),_(We.$$.fragment,t),_(Ge.$$.fragment,t),_(Re.$$.fragment,t),_(Ue.$$.fragment,t),_(Ve.$$.fragment,t),_(Je.$$.fragment,t),_(Ye.$$.fragment,t),_(Ze.$$.fragment,t),_(et.$$.fragment,t),_(st.$$.fragment,t),_(rt.$$.fragment,t),_(ct.$$.fragment,t),_(ye.$$.fragment,t),_(pt.$$.fragment,t),_(ht.$$.fragment,t),_(ut.$$.fragment,t),_(_t.$$.fragment,t),_(Pe.$$.fragment,t),_(bt.$$.fragment,t),_(kt.$$.fragment,t),_(vt.$$.fragment,t),_(Pt.$$.fragment,t),_(qe.$$.fragment,t),_(Lt.$$.fragment,t),_(qt.$$.fragment,t),_(zt.$$.fragment,t),_(Bt.$$.fragment,t),_($t.$$.fragment,t),_(xt.$$.fragment,t),_(Ct.$$.fragment,t),_(jt.$$.fragment,t),Cn=!0)},o(t){b(T.$$.fragment,t),b(Ee.$$.fragment,t),b(Ne.$$.fragment,t),b(De.$$.fragment,t),b(We.$$.fragment,t),b(Ge.$$.fragment,t),b(Re.$$.fragment,t),b(Ue.$$.fragment,t),b(Ve.$$.fragment,t),b(Je.$$.fragment,t),b(Ye.$$.fragment,t),b(Ze.$$.fragment,t),b(et.$$.fragment,t),b(st.$$.fragment,t),b(rt.$$.fragment,t),b(ct.$$.fragment,t),b(ye.$$.fragment,t),b(pt.$$.fragment,t),b(ht.$$.fragment,t),b(ut.$$.fragment,t),b(_t.$$.fragment,t),b(Pe.$$.fragment,t),b(bt.$$.fragment,t),b(kt.$$.fragment,t),b(vt.$$.fragment,t),b(Pt.$$.fragment,t),b(qe.$$.fragment,t),b(Lt.$$.fragment,t),b(qt.$$.fragment,t),b(zt.$$.fragment,t),b(Bt.$$.fragment,t),b($t.$$.fragment,t),b(xt.$$.fragment,t),b(Ct.$$.fragment,t),b(jt.$$.fragment,t),Cn=!1},d(t){o(u),t&&o(B),t&&o(v),k(T),t&&o(an),t&&o(I),t&&o(sn),t&&o(Y),k(Ee),t&&o(rn),t&&o(W),t&&o(dn),t&&o(Mt),t&&o(ln),t&&o(St),t&&o(cn),t&&o(G),t&&o(pn),t&&o(Z),k(Ne),t&&o(hn),t&&o(F),t&&o(un),t&&o(_e),t&&o(mn),t&&o(R),t&&o(fn),t&&o(Nt),t&&o(gn),k(De,t),t&&o(_n),t&&o(Ot),t&&o(bn),k(We,t),t&&o(kn),t&&o(te),k(Ge),t&&o(vn),t&&o(x),k(Re),k(Ue),t&&o(Tn),t&&o(ae),k(Ve),t&&o(yn),t&&o(P),k(Je),k(Ye),k(Ze),k(et),t&&o(wn),t&&o(se),k(st),t&&o(Pn),t&&o(S),k(rt),k(ct),k(ye),k(pt),t&&o(Ln),t&&o(ie),k(ht),t&&o(qn),t&&o(A),k(ut),k(_t),k(Pe),k(bt),t&&o(zn),t&&o(le),k(kt),t&&o(Bn),t&&o(C),k(vt),k(Pt),k(qe),k(Lt),k(qt),k(zt),k(Bt),t&&o($n),t&&o(pe),k($t),t&&o(xn),t&&o(he),k(xt),k(Ct),k(jt)}}}const sl={local:"plbart",sections:[{local:"overview-of-plbart",sections:[{local:"training-of-plbart",title:"Training of PLBart"}],title:"Overview of PLBart"},{local:"transformers.PLBartConfig",title:"PLBartConfig"},{local:"transformers.PLBartTokenizer",title:"PLBartTokenizer"},{local:"transformers.PLBartModel",title:"PLBartModel"},{local:"transformers.PLBartForConditionalGeneration",title:"PLBartForConditionalGeneration"},{local:"transformers.PLBartForSequenceClassification",title:"PLBartForSequenceClassification"},{local:"transformers.PLBartForCausalLM",title:"PLBartForCausalLM"}],title:"PLBart"};function rl(me){return el(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class hl extends Kd{constructor(u){super();Qd(this,u,rl,al,Yd,{})}}export{hl as default,sl as metadata};
