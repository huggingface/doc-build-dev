...
When using `lr=None` with [Trainer](/docs/transformers/pr_15335/en/main_classes/trainer#transformers.Trainer) you will most likely need to use `AdafactorSchedule`
