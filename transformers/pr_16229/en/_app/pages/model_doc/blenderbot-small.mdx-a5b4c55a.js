import{S as Hm,i as Km,s as Qm,e as n,k as l,w as f,t as r,M as Vm,c as a,d as t,m as i,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as y,v as Jm}from"../../chunks/vendor-6b77c823.js";import{T as zn}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-abef54e3.js";import{C as rt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Fe}from"../../chunks/IconCopyLink-7a11ce68.js";function Xm(Y){let u,x,v,T,B;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){u=a(S,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,u,w),e(u,x),e(u,v),e(v,T),e(u,B)},d(S){S&&t(u)}}}function Ym(Y){let u,x,v,T,B;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){u=a(S,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,u,w),e(u,x),e(u,v),e(v,T),e(u,B)},d(S){S&&t(u)}}}function Zm(Y){let u,x,v,T,B,S,w,q,Ce,me,z,je,U,Oe,Pe,W,Le,Ne,K,Q,Ie,Z,C,P,fe,ae,$e,V,A,Te,se,L,we,re,Me,ee,de,le,Ae,J,Ee,R,De;return{c(){u=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=l(),z=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
...
`),re=n("code"),Me=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Ee=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=a(m,"P",{});var F=s(u);x=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),v=i(m),T=a(m,"UL",{});var ie=s(T);B=a(ie,"LI",{});var dt=s(B);S=d(dt,"having all inputs as keyword arguments (like PyTorch models), or"),dt.forEach(t),w=i(ie),q=a(ie,"LI",{});var Re=s(q);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(t),ie.forEach(t),me=i(m),z=a(m,"P",{});var j=s(z);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var lt=s(U);Oe=d(lt,"tf.keras.Model.fit"),lt.forEach(t),Pe=d(j,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a(j,"CODE",{});var Se=s(W);Le=d(Se,"model(inputs)"),Se.forEach(t),Ne=d(j,"."),j.forEach(t),K=i(m),Q=a(m,"P",{});var it=s(Q);Ie=d(it,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),it.forEach(t),Z=i(m),C=a(m,"UL",{});var X=s(C);P=a(X,"LI",{});var D=s(P);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var ct=s(ae);$e=d(ct,"input_ids"),ct.forEach(t),V=d(D," only and nothing else: "),A=a(D,"CODE",{});var pt=s(A);Te=d(pt,"model(input_ids)"),pt.forEach(t),D.forEach(t),se=i(X),L=a(X,"LI",{});var te=s(L);we=d(te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(te,"CODE",{});var ce=s(re);Me=d(ce,"model([input_ids, attention_mask])"),ce.forEach(t),ee=d(te," or "),de=a(te,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(t),te.forEach(t),Ae=i(X),J=a(X,"LI",{});var Be=s(J);Ee=d(Be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(Be,"CODE",{});var ze=s(R);De=d(ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ze.forEach(t),Be.forEach(t),X.forEach(t)},m(m,F){p(m,u,F),e(u,x),p(m,v,F),p(m,T,F),e(T,B),e(B,S),e(T,w),e(T,q),e(q,Ce),p(m,me,F),p(m,z,F),e(z,je),e(z,U),e(U,Oe),e(z,Pe),e(z,W),e(W,Le),e(z,Ne),p(m,K,F),p(m,Q,F),e(Q,Ie),p(m,Z,F),p(m,C,F),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,V),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Me),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Ee),e(J,R),e(R,De)},d(m){m&&t(u),m&&t(v),m&&t(T),m&&t(me),m&&t(z),m&&t(K),m&&t(Q),m&&t(Z),m&&t(C)}}}function ef(Y){let u,x,v,T,B;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){u=a(S,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,u,w),e(u,x),e(u,v),e(v,T),e(u,B)},d(S){S&&t(u)}}}function tf(Y){let u,x,v,T,B,S,w,q,Ce,me,z,je,U,Oe,Pe,W,Le,Ne,K,Q,Ie,Z,C,P,fe,ae,$e,V,A,Te,se,L,we,re,Me,ee,de,le,Ae,J,Ee,R,De;return{c(){u=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=l(),z=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),K=l(),Q=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),P=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),V=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Me=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Ee=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=a(m,"P",{});var F=s(u);x=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),v=i(m),T=a(m,"UL",{});var ie=s(T);B=a(ie,"LI",{});var dt=s(B);S=d(dt,"having all inputs as keyword arguments (like PyTorch models), or"),dt.forEach(t),w=i(ie),q=a(ie,"LI",{});var Re=s(q);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(t),ie.forEach(t),me=i(m),z=a(m,"P",{});var j=s(z);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var lt=s(U);Oe=d(lt,"tf.keras.Model.fit"),lt.forEach(t),Pe=d(j,` method which currently requires having all the
...
first positional argument :`),it.forEach(t),Z=i(m),C=a(m,"UL",{});var X=s(C);P=a(X,"LI",{});var D=s(P);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var ct=s(ae);$e=d(ct,"input_ids"),ct.forEach(t),V=d(D," only and nothing else: "),A=a(D,"CODE",{});var pt=s(A);Te=d(pt,"model(input_ids)"),pt.forEach(t),D.forEach(t),se=i(X),L=a(X,"LI",{});var te=s(L);we=d(te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(te,"CODE",{});var ce=s(re);Me=d(ce,"model([input_ids, attention_mask])"),ce.forEach(t),ee=d(te," or "),de=a(te,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(t),te.forEach(t),Ae=i(X),J=a(X,"LI",{});var Be=s(J);Ee=d(Be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(Be,"CODE",{});var ze=s(R);De=d(ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ze.forEach(t),Be.forEach(t),X.forEach(t)},m(m,F){p(m,u,F),e(u,x),p(m,v,F),p(m,T,F),e(T,B),e(B,S),e(T,w),e(T,q),e(q,Ce),p(m,me,F),p(m,z,F),e(z,je),e(z,U),e(U,Oe),e(z,Pe),e(z,W),e(W,Le),e(z,Ne),p(m,K,F),p(m,Q,F),e(Q,Ie),p(m,Z,F),p(m,C,F),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,V),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Me),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Ee),e(J,R),e(R,De)},d(m){m&&t(u),m&&t(v),m&&t(T),m&&t(me),m&&t(z),m&&t(K),m&&t(Q),m&&t(Z),m&&t(C)}}}function of(Y){let u,x,v,T,B;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){u=a(S,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,u,w),e(u,x),e(u,v),e(v,T),e(u,B)},d(S){S&&t(u)}}}function nf(Y){let u,x,v,T,B;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){u=a(S,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,u,w),e(u,x),e(u,v),e(v,T),e(u,B)},d(S){S&&t(u)}}}function af(Y){let u,x,v,T,B,S,w,q,Ce,me,z,je,U,Oe,Pe,W,Le,Ne,K,Q,Ie,Z,C,P,fe,ae,$e,V,A,Te,se,L,we,re,Me,ee,de,le,Ae,J,Ee,R,De,m,F,ie,dt,Re,j,lt,Se,it,X,D,ct,pt,te,ce,_e,Be,ze,hd,la,ud,mr,pe,eo,md,ht,fd,xn,_d,gd,to,bd,kd,yd,ut,vd,qn,Td,wd,Fn,Sd,Bd,zd,ia,xd,qd,oo,fr,mt,$t,ca,no,Fd,pa,$d,_r,G,ao,Md,ha,Ed,Cd,so,jd,$n,Od,Pd,Ld,He,ro,Nd,ua,Id,Ad,ma,Dd,Gd,Mt,lo,Ud,ft,Wd,fa,Rd,Hd,_a,Kd,Qd,Vd,Ke,io,Jd,Mn,Xd,En,Yd,Zd,ga,el,tl,Cn,co,gr,_t,Et,ba,po,ol,ka,nl,br,Ge,ho,al,uo,sl,ya,rl,dl,ll,Ct,mo,il,va,cl,kr,gt,jt,Ta,fo,pl,wa,hl,yr,xe,_o,ul,go,ml,jn,fl,_l,gl,bo,bl,ko,kl,yl,vl,ge,yo,Tl,bt,wl,On,Sl,Bl,Sa,zl,xl,ql,Ot,Fl,Ba,$l,Ml,vo,vr,kt,Pt,za,To,El,xa,Cl,Tr,qe,wo,jl,So,Ol,Pn,Pl,Ll,Nl,Bo,Il,zo,Al,Dl,Gl,be,xo,Ul,yt,Wl,Ln,Rl,Hl,qa,Kl,Ql,Vl,Lt,Jl,Fa,Xl,Yl,qo,wr,vt,Nt,$a,Fo,Zl,Ma,ei,Sr,Tt,$o,ti,Qe,Mo,oi,Ea,ni,ai,Eo,Br,wt,It,Ca,Co,si,ja,ri,zr,he,jo,di,Oo,li,Nn,ii,ci,pi,Po,hi,Lo,ui,mi,fi,At,_i,ke,No,gi,St,bi,In,ki,yi,Oa,vi,Ti,wi,Dt,Si,Pa,Bi,zi,Io,xr,Bt,Gt,La,Ao,xi,Na,qi,qr,ue,Do,Fi,Go,$i,An,Mi,Ei,Ci,Uo,ji,Wo,Oi,Pi,Li,Ut,Ni,O,Ro,Ii,zt,Ai,Dn,Di,Gi,Ia,Ui,Wi,Ri,Wt,Hi,Aa,Ki,Qi,Da,Ga,Ua,Wa,Vi,Ji,Ra,Ha,Ka,Qa,Xi,Yi,Va,Ja,Xa,Ya,Zi,ec,Za,es,ts,Ho,tc,os,oc,nc,ac,ns,as,ss,rs,sc,Fr,xt,Rt,ds,Ko,rc,ls,dc,$r,N,Qo,lc,Vo,ic,Gn,cc,pc,hc,Jo,uc,Xo,mc,fc,_c,is,gc,bc,Ue,cs,Yo,kc,yc,ps,Zo,vc,Tc,hs,en,wc,Sc,us,tn,Bc,zc,Ve,on,xc,ms,qc,Fc,nn,$c,Je,an,Mc,fs,Ec,Cc,sn,jc,Xe,rn,Oc,_s,Pc,Lc,dn,Mr,qt,Ht,gs,ln,Nc,bs,Ic,Er,I,cn,Ac,pn,Dc,Un,Gc,Uc,Wc,hn,Rc,un,Hc,Kc,Qc,ks,Vc,Jc,We,ys,mn,Xc,Yc,vs,fn,Zc,ep,Ts,_n,tp,op,ws,gn,np,ap,$,bn,sp,Ft,rp,Ss,dp,lp,Bs,ip,cp,pp,Kt,hp,zs,up,mp,xs,qs,Fs,$s,fp,_p,Ms,Es,Cs,js,gp,bp,Os,Ps,Ls,Ns,kp,yp,Is,As,kn,Qt,Vt,Ds,yn,vp,Gs,Tp,wp,Us,Sp,Bp,Ws,zp,xp,Rs,Hs,Ks,Qs,qp,Fp,Vs,Js,Xs,Ys,$p,Mp,Zs,er,tr,or,Ep,Cp,nr,ar,sr,rr,jp,Op,Ye,vn,Pp,dr,Lp,Np,Tn,Ip,Ze,wn,Ap,lr,Dp,Gp,Sn,Cr;return S=new Fe({}),se=new Fe({}),ze=new Fe({}),eo=new E({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L36",parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig"
...
`}}),Ot=new zn({props:{$$slots:{default:[Xm]},$$scope:{ctx:Y}}}),vo=new rt({props:{code:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallModel
...
`}}),Lt=new zn({props:{$$slots:{default:[Ym]},$$scope:{ctx:Y}}}),qo=new rt({props:{code:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallForConditionalGeneration
...
`}}),Dt=new zn({props:{$$slots:{default:[ef]},$$scope:{ctx:Y}}}),Io=new rt({props:{code:`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallModel
...
`}}),Wt=new zn({props:{$$slots:{default:[of]},$$scope:{ctx:Y}}}),Ko=new Fe({}),Qo=new E({props:{name:"class transformers.FlaxBlenderbotSmallModel",anchor:"transformers.FlaxBlenderbotSmallModel",parameters:[{name:"config",val:": BlenderbotSmallConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1203",parametersDescription:[{anchor:"transformers.FlaxBlenderbotSmallModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig">BlenderbotSmallConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),bn=new E({props:{name:"__call__",anchor:"transformers.FlaxBlenderbotSmallPreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1139",parametersDescription:[{anchor:"transformers.FlaxBlenderbotSmallPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallTokenizer">BlenderbotSmallTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Kt=new zn({props:{$$slots:{default:[nf]},$$scope:{ctx:Y}}}),yn=new Fe({}),vn=new E({props:{name:"encode",anchor:"transformers.FlaxBlenderbotSmallPreTrainedModel.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L960",parametersDescription:[{anchor:"transformers.FlaxBlenderbotSmallPreTrainedModel.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallTokenizer">BlenderbotSmallTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("meta"),x=l(),v=n("h1"),T=n("a"),B=n("span"),f(S.$$.fragment),w=l(),q=n("span"),Ce=r("Blenderbot Small"),me=l(),z=n("p"),je=r("Note that "),U=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
`),fe=n("a"),ae=r("BlenderbotForConditionalGeneration"),$e=l(),V=n("h2"),A=n("a"),Te=n("span"),f(se.$$.fragment),L=l(),we=n("span"),re=r("Overview"),Me=l(),ee=n("p"),de=r("The Blender chatbot model was proposed in "),le=n("a"),Ae=r("Recipes for building an open-domain chatbot"),J=r(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
failure cases of our models.`),Re=l(),j=n("p"),lt=r("This model was contributed by "),Se=n("a"),it=r("patrickvonplaten"),X=r(`. The authors\u2019 code can be
...
`),to=n("a"),bd=r("facebook/blenderbot_small-90M"),kd=r(" architecture."),yd=l(),ut=n("p"),vd=r("Configuration objects inherit from "),qn=n("a"),Td=r("PretrainedConfig"),wd=r(` and can be used to control the model outputs. Read the
documentation from `),Fn=n("a"),Sd=r("PretrainedConfig"),Bd=r(" for more information."),zd=l(),ia=n("p"),xd=r("Example:"),qd=l(),f(oo.$$.fragment),fr=l(),mt=n("h2"),$t=n("a"),ca=n("span"),f(no.$$.fragment),Fd=l(),pa=n("span"),$d=r("BlenderbotSmallTokenizer"),_r=l(),G=n("div"),f(ao.$$.fragment),Md=l(),ha=n("p"),Ed=r("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),Cd=l(),so=n("p"),jd=r("This tokenizer inherits from "),$n=n("a"),Od=r("PreTrainedTokenizer"),Pd=r(` which contains most of the main methods. Users should refer to
...
IDs?`),Zd=l(),ga=n("p"),el=r("Should be overridden in a subclass if the model has a special way of building those."),tl=l(),Cn=n("div"),f(co.$$.fragment),gr=l(),_t=n("h2"),Et=n("a"),ba=n("span"),f(po.$$.fragment),ol=l(),ka=n("span"),nl=r("BlenderbotSmallTokenizerFast"),br=l(),Ge=n("div"),f(ho.$$.fragment),al=l(),uo=n("p"),sl=r("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ya=n("em"),rl=r("tokenizers"),dl=r(" library)."),ll=l(),Ct=n("div"),f(mo.$$.fragment),il=l(),va=n("p"),cl=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),kr=l(),gt=n("h2"),jt=n("a"),Ta=n("span"),f(fo.$$.fragment),pl=l(),wa=n("span"),hl=r("BlenderbotSmallModel"),yr=l(),xe=n("div"),f(_o.$$.fragment),ul=l(),go=n("p"),ml=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pi=l(),Po=n("p"),hi=r("This model is also a "),Lo=n("a"),ui=r("tf.keras.Model"),mi=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fi=l(),f(At.$$.fragment),_i=l(),ke=n("div"),f(No.$$.fragment),gi=l(),St=n("p"),bi=r("The "),In=n("a"),ki=r("TFBlenderbotSmallModel"),yi=r(" forward method, overrides the "),Oa=n("code"),vi=r("__call__"),Ti=r(" special method."),wi=l(),f(Dt.$$.fragment),Si=l(),Pa=n("p"),Bi=r("Example:"),zi=l(),f(Io.$$.fragment),xr=l(),Bt=n("h2"),Gt=n("a"),La=n("span"),f(Ao.$$.fragment),xi=l(),Na=n("span"),qi=r("TFBlenderbotSmallForConditionalGeneration"),qr=l(),ue=n("div"),f(Do.$$.fragment),Fi=l(),Go=n("p"),$i=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Qc=l(),ks=n("p"),Vc=r("Finally, this model supports inherent JAX features such as:"),Jc=l(),We=n("ul"),ys=n("li"),mn=n("a"),Xc=r("Just-In-Time (JIT) compilation"),Yc=l(),vs=n("li"),fn=n("a"),Zc=r("Automatic Differentiation"),ep=l(),Ts=n("li"),_n=n("a"),tp=r("Vectorization"),op=l(),ws=n("li"),gn=n("a"),np=r("Parallelization"),ap=l(),$=n("div"),f(bn.$$.fragment),sp=l(),Ft=n("p"),rp=r("The "),Ss=n("code"),dp=r("FlaxBlenderbotSmallPreTrainedModel"),lp=r("forward method, overrides the "),Bs=n("code"),ip=r("__call__"),cp=r(" special method."),pp=l(),f(Kt.$$.fragment),hp=l(),zs=n("p"),up=r("Summarization example:"),mp=l(),xs=n("blockquote"),qs=n("blockquote"),Fs=n("blockquote"),$s=n("p"),fp=r("from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration"),_p=l(),Ms=n("blockquote"),Es=n("blockquote"),Cs=n("blockquote"),js=n("p"),gp=r(`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Cp=l(),nr=n("blockquote"),ar=n("blockquote"),sr=n("blockquote"),rr=n("p"),jp=r("tokenizer.decode(predictions).split()"),Op=l(),Ye=n("div"),f(vn.$$.fragment),Pp=l(),dr=n("p"),Lp=r("Example:"),Np=l(),f(Tn.$$.fragment),Ip=l(),Ze=n("div"),f(wn.$$.fragment),Ap=l(),lr=n("p"),Dp=r("Example:"),Gp=l(),f(Sn.$$.fragment),this.h()},l(o){const h=Vm('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(t),x=i(o),v=a(o,"H1",{class:!0});var Bn=s(v);T=a(Bn,"A",{id:!0,class:!0,href:!0});var ir=s(T);B=a(ir,"SPAN",{});var cr=s(B);_(S.$$.fragment,cr),cr.forEach(t),ir.forEach(t),w=i(Bn),q=a(Bn,"SPAN",{});var pr=s(q);Ce=d(pr,"Blenderbot Small"),pr.forEach(t),Bn.forEach(t),me=i(o),z=a(o,"P",{});var ye=s(z);je=d(ye,"Note that "),U=a(ye,"A",{href:!0});var hr=s(U);Oe=d(hr,"BlenderbotSmallModel"),hr.forEach(t),Pe=d(ye,` and
`),W=a(ye,"A",{href:!0});var ur=s(W);Le=d(ur,"BlenderbotSmallForConditionalGeneration"),ur.forEach(t),Ne=d(ye,` are only used in combination with the checkpoint
`),K=a(ye,"A",{href:!0,rel:!0});var Wp=s(K);Q=d(Wp,"facebook/blenderbot-90M"),Wp.forEach(t),Ie=d(ye,`. Larger Blenderbot checkpoints should
instead be used with `),Z=a(ye,"A",{href:!0});var Rp=s(Z);C=d(Rp,"BlenderbotModel"),Rp.forEach(t),P=d(ye,` and
`),fe=a(ye,"A",{href:!0});var Hp=s(fe);ae=d(Hp,"BlenderbotForConditionalGeneration"),Hp.forEach(t),ye.forEach(t),$e=i(o),V=a(o,"H2",{class:!0});var jr=s(V);A=a(jr,"A",{id:!0,class:!0,href:!0});var Kp=s(A);Te=a(Kp,"SPAN",{});var Qp=s(Te);_(se.$$.fragment,Qp),Qp.forEach(t),Kp.forEach(t),L=i(jr),we=a(jr,"SPAN",{});var Vp=s(we);re=d(Vp,"Overview"),Vp.forEach(t),jr.forEach(t),Me=i(o),ee=a(o,"P",{});var Or=s(ee);de=d(Or,"The Blender chatbot model was proposed in "),le=a(Or,"A",{href:!0,rel:!0});var Jp=s(le);Ae=d(Jp,"Recipes for building an open-domain chatbot"),Jp.forEach(t),J=d(Or,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),Zp.forEach(t),Yp.forEach(t),Re=i(o),j=a(o,"P",{});var Wn=s(j);lt=d(Wn,"This model was contributed by "),Se=a(Wn,"A",{href:!0,rel:!0});var eh=s(Se);it=d(eh,"patrickvonplaten"),eh.forEach(t),X=d(Wn,`. The authors\u2019 code can be
found `),D=a(Wn,"A",{href:!0,rel:!0});var th=s(D);ct=d(th,"here"),th.forEach(t),pt=d(Wn," ."),Wn.forEach(t),te=i(o),ce=a(o,"H2",{class:!0});var Pr=s(ce);_e=a(Pr,"A",{id:!0,class:!0,href:!0});var oh=s(_e);Be=a(oh,"SPAN",{});var nh=s(Be);_(ze.$$.fragment,nh),nh.forEach(t),oh.forEach(t),hd=i(Pr),la=a(Pr,"SPAN",{});var ah=s(la);ud=d(ah,"BlenderbotSmallConfig"),ah.forEach(t),Pr.forEach(t),mr=i(o),pe=a(o,"DIV",{class:!0});var et=s(pe);_(eo.$$.fragment,et),md=i(et),ht=a(et,"P",{});var Rn=s(ht);fd=d(Rn,"This is the configuration class to store the configuration of a "),xn=a(Rn,"A",{href:!0});var sh=s(xn);_d=d(sh,"BlenderbotSmallModel"),sh.forEach(t),gd=d(Rn,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
`),to=a(Rn,"A",{href:!0,rel:!0});var rh=s(to);bd=d(rh,"facebook/blenderbot_small-90M"),rh.forEach(t),kd=d(Rn," architecture."),Rn.forEach(t),yd=i(et),ut=a(et,"P",{});var Hn=s(ut);vd=d(Hn,"Configuration objects inherit from "),qn=a(Hn,"A",{href:!0});var dh=s(qn);Td=d(dh,"PretrainedConfig"),dh.forEach(t),wd=d(Hn,` and can be used to control the model outputs. Read the
documentation from `),Fn=a(Hn,"A",{href:!0});var lh=s(Fn);Sd=d(lh,"PretrainedConfig"),lh.forEach(t),Bd=d(Hn," for more information."),Hn.forEach(t),zd=i(et),ia=a(et,"P",{});var ih=s(ia);xd=d(ih,"Example:"),ih.forEach(t),qd=i(et),_(oo.$$.fragment,et),et.forEach(t),fr=i(o),mt=a(o,"H2",{class:!0});var Lr=s(mt);$t=a(Lr,"A",{id:!0,class:!0,href:!0});var ch=s($t);ca=a(ch,"SPAN",{});var ph=s(ca);_(no.$$.fragment,ph),ph.forEach(t),ch.forEach(t),Fd=i(Lr),pa=a(Lr,"SPAN",{});var hh=s(pa);$d=d(hh,"BlenderbotSmallTokenizer"),hh.forEach(t),Lr.forEach(t),_r=i(o),G=a(o,"DIV",{class:!0});var ve=s(G);_(ao.$$.fragment,ve),Md=i(ve),ha=a(ve,"P",{});var uh=s(ha);Ed=d(uh,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),uh.forEach(t),Cd=i(ve),so=a(ve,"P",{});var Nr=s(so);jd=d(Nr,"This tokenizer inherits from "),$n=a(Nr,"A",{href:!0});var mh=s($n);Od=d(mh,"PreTrainedTokenizer"),mh.forEach(t),Pd=d(Nr,` which contains most of the main methods. Users should refer to
the superclass for more information regarding methods.`),Nr.forEach(t),Ld=i(ve),He=a(ve,"DIV",{class:!0});var Kn=s(He);_(ro.$$.fragment,Kn),Nd=i(Kn),ua=a(Kn,"P",{});var fh=s(ua);Id=d(fh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),fh.forEach(t),Ad=i(Kn),ma=a(Kn,"P",{});var _h=s(ma);Dd=d(_h,"This implementation does not add special tokens and this method should be overridden in a subclass."),_h.forEach(t),Kn.forEach(t),Gd=i(ve),Mt=a(ve,"DIV",{class:!0});var Ir=s(Mt);_(lo.$$.fragment,Ir),Ud=i(Ir),ft=a(Ir,"P",{});var Qn=s(ft);Wd=d(Qn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yr.forEach(t),pi=i(nt),Po=a(nt,"P",{});var Zr=s(Po);hi=d(Zr,"This model is also a "),Lo=a(Zr,"A",{href:!0,rel:!0});var Xh=s(Lo);ui=d(Xh,"tf.keras.Model"),Xh.forEach(t),mi=d(Zr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zr.forEach(t),fi=i(nt),_(At.$$.fragment,nt),_i=i(nt),ke=a(nt,"DIV",{class:!0});var at=s(ke);_(No.$$.fragment,at),gi=i(at),St=a(at,"P",{});var ea=s(St);bi=d(ea,"The "),In=a(ea,"A",{href:!0});var Yh=s(In);ki=d(Yh,"TFBlenderbotSmallModel"),Yh.forEach(t),yi=d(ea," forward method, overrides the "),Oa=a(ea,"CODE",{});var Zh=s(Oa);vi=d(Zh,"__call__"),Zh.forEach(t),Ti=d(ea," special method."),ea.forEach(t),wi=i(at),_(Dt.$$.fragment,at),Si=i(at),Pa=a(at,"P",{});var eu=s(Pa);Bi=d(eu,"Example:"),eu.forEach(t),zi=i(at),_(Io.$$.fragment,at),at.forEach(t),nt.forEach(t),xr=i(o),Bt=a(o,"H2",{class:!0});var ed=s(Bt);Gt=a(ed,"A",{id:!0,class:!0,href:!0});var tu=s(Gt);La=a(tu,"SPAN",{});var ou=s(La);_(Ao.$$.fragment,ou),ou.forEach(t),tu.forEach(t),xi=i(ed),Na=a(ed,"SPAN",{});var nu=s(Na);qi=d(nu,"TFBlenderbotSmallForConditionalGeneration"),nu.forEach(t),ed.forEach(t),qr=i(o),ue=a(o,"DIV",{class:!0});var st=s(ue);_(Do.$$.fragment,st),Fi=i(st),Go=a(st,"P",{});var td=s(Go);$i=d(td,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),td.forEach(t),Ci=i(st),Uo=a(st,"P",{});var od=s(Uo);ji=d(od,"This model is also a "),Wo=a(od,"A",{href:!0,rel:!0});var su=s(Wo);Oi=d(su,"tf.keras.Model"),su.forEach(t),Pi=d(od,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019)`),_u.forEach(t),fu.forEach(t),mu.forEach(t),uu.forEach(t),Yi=i(H),Va=a(H,"BLOCKQUOTE",{});var gu=s(Va);Ja=a(gu,"BLOCKQUOTE",{});var bu=s(Ja);Xa=a(bu,"BLOCKQUOTE",{});var ku=s(Xa);Ya=a(ku,"P",{});var yu=s(Ya);Zi=d(yu,`reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0]) what kind of carbs do they eat? i don\u2019t know much about carbs.`),yu.forEach(t),ku.forEach(t),bu.forEach(t),gu.forEach(t),ec=i(H),Za=a(H,"BLOCKQUOTE",{});var vu=s(Za);es=a(vu,"BLOCKQUOTE",{});var Tu=s(es);ts=a(Tu,"BLOCKQUOTE",{});var wu=s(ts);Ho=a(wu,"P",{});var nd=s(Ho);tc=d(nd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(t),wu.forEach(t),Tu.forEach(t),vu.forEach(t),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var Bu=s(ns);as=a(Bu,"BLOCKQUOTE",{});var zu=s(as);ss=a(zu,"BLOCKQUOTE",{});var xu=s(ss);rs=a(xu,"P",{});var qu=s(rs);sc=d(qu,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),qu.forEach(t),xu.forEach(t),zu.forEach(t),Bu.forEach(t),H.forEach(t),st.forEach(t),Fr=i(o),xt=a(o,"H2",{class:!0});var ad=s(xt);Rt=a(ad,"A",{id:!0,class:!0,href:!0});var Fu=s(Rt);ds=a(Fu,"SPAN",{});var $u=s(ds);_(Ko.$$.fragment,$u),$u.forEach(t),Fu.forEach(t),rc=i(ad),ls=a(ad,"SPAN",{});var Mu=s(ls);dc=d(Mu,"FlaxBlenderbotSmallModel"),Mu.forEach(t),ad.forEach(t),$r=i(o),N=a(o,"DIV",{class:!0});var oe=s(N);_(Qo.$$.fragment,oe),lc=i(oe),Vo=a(oe,"P",{});var sd=s(Vo);ic=d(sd,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),id.forEach(t),Qc=i(ne),ks=a(ne,"P",{});var Xu=s(ks);Vc=d(Xu,"Finally, this model supports inherent JAX features such as:"),Xu.forEach(t),Jc=i(ne),We=a(ne,"UL",{});var Zt=s(We);ys=a(Zt,"LI",{});var Yu=s(ys);mn=a(Yu,"A",{href:!0,rel:!0});var Zu=s(mn);Xc=d(Zu,"Just-In-Time (JIT) compilation"),Zu.forEach(t),Yu.forEach(t),Yc=i(Zt),vs=a(Zt,"LI",{});var em=s(vs);fn=a(em,"A",{href:!0,rel:!0});var tm=s(fn);Zc=d(tm,"Automatic Differentiation"),tm.forEach(t),em.forEach(t),ep=i(Zt),Ts=a(Zt,"LI",{});var om=s(Ts);_n=a(om,"A",{href:!0,rel:!0});var nm=s(_n);tp=d(nm,"Vectorization"),nm.forEach(t),om.forEach(t),op=i(Zt),ws=a(Zt,"LI",{});var am=s(ws);gn=a(am,"A",{href:!0,rel:!0});var sm=s(gn);np=d(sm,"Parallelization"),sm.forEach(t),am.forEach(t),Zt.forEach(t),ap=i(ne),$=a(ne,"DIV",{class:!0});var M=s($);_(bn.$$.fragment,M),sp=i(M),Ft=a(M,"P",{});var sa=s(Ft);rp=d(sa,"The "),Ss=a(sa,"CODE",{});var rm=s(Ss);dp=d(rm,"FlaxBlenderbotSmallPreTrainedModel"),rm.forEach(t),lp=d(sa,"forward method, overrides the "),Bs=a(sa,"CODE",{});var dm=s(Bs);ip=d(dm,"__call__"),dm.forEach(t),cp=d(sa," special method."),sa.forEach(t),pp=i(M),_(Kt.$$.fragment,M),hp=i(M),zs=a(M,"P",{});var lm=s(zs);up=d(lm,"Summarization example:"),lm.forEach(t),mp=i(M),xs=a(M,"BLOCKQUOTE",{});var im=s(xs);qs=a(im,"BLOCKQUOTE",{});var cm=s(qs);Fs=a(cm,"BLOCKQUOTE",{});var pm=s(Fs);$s=a(pm,"P",{});var hm=s($s);fp=d(hm,"from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration"),hm.forEach(t),pm.forEach(t),cm.forEach(t),im.forEach(t),_p=i(M),Ms=a(M,"BLOCKQUOTE",{});var um=s(Ms);Es=a(um,"BLOCKQUOTE",{});var mm=s(Es);Cs=a(mm,"BLOCKQUOTE",{});var fm=s(Cs);js=a(fm,"P",{});var _m=s(js);gp=d(_m,`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019)`),_m.forEach(t),fm.forEach(t),mm.forEach(t),um.forEach(t),bp=i(M),Os=a(M,"BLOCKQUOTE",{});var gm=s(Os);Ps=a(gm,"BLOCKQUOTE",{});var bm=s(Ps);Ls=a(bm,"BLOCKQUOTE",{});var km=s(Ls);Ns=a(km,"P",{});var ym=s(Ns);kp=d(ym,`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),ym.forEach(t),km.forEach(t),bm.forEach(t),gm.forEach(t),yp=i(M),Is=a(M,"BLOCKQUOTE",{});var vm=s(Is);As=a(vm,"BLOCKQUOTE",{});var Tm=s(As);kn=a(Tm,"BLOCKQUOTE",{});var cd=s(kn);Qt=a(cd,"H1",{class:!0});var pd=s(Qt);Vt=a(pd,"A",{id:!0,class:!0,href:!0});var wm=s(Vt);Ds=a(wm,"SPAN",{});var Sm=s(Ds);_(yn.$$.fragment,Sm),Sm.forEach(t),wm.forEach(t),vp=i(pd),Gs=a(pd,"SPAN",{});var Bm=s(Gs);Tp=d(Bm,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),Bm.forEach(t),pd.forEach(t),wp=i(cd),Us=a(cd,"P",{});var zm=s(Us);Sp=d(zm,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),zm.forEach(t),cd.forEach(t),Tm.forEach(t),vm.forEach(t),Bp=i(M),Ws=a(M,"P",{});var xm=s(Ws);zp=d(xm,"Mask filling example:"),xm.forEach(t),xp=i(M),Rs=a(M,"BLOCKQUOTE",{});var qm=s(Rs);Hs=a(qm,"BLOCKQUOTE",{});var Fm=s(Hs);Ks=a(Fm,"BLOCKQUOTE",{});var $m=s(Ks);Qs=a($m,"P",{});var Mm=s(Qs);qp=d(Mm,`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>> TXT = \u201CMy friends are
<mask> but they eat too many carbs.\u201D`),Mm.forEach(t),$m.forEach(t),Fm.forEach(t),qm.forEach(t),Fp=i(M),Vs=a(M,"BLOCKQUOTE",{});var Em=s(Vs);Js=a(Em,"BLOCKQUOTE",{});var Cm=s(Js);Xs=a(Cm,"BLOCKQUOTE",{});var jm=s(Xs);Ys=a(jm,"P",{});var Om=s(Ys);$p=d(Om,`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
input_ids = tokenizer([TXT], return_tensors=\u2018np\u2019)[\u2018input_ids\u2019] >>> logits = model(input_ids).logits`),Om.forEach(t),jm.forEach(t),Cm.forEach(t),Em.forEach(t),Mp=i(M),Zs=a(M,"BLOCKQUOTE",{});var Pm=s(Zs);er=a(Pm,"BLOCKQUOTE",{});var Lm=s(er);tr=a(Lm,"BLOCKQUOTE",{});var Nm=s(tr);or=a(Nm,"P",{});var Im=s(or);Ep=d(Im,`masked_index = (input_ids[0] == tokenizer.mask_token_id).nonzero().item() >>> probs =
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Im.forEach(t),Nm.forEach(t),Lm.forEach(t),Pm.forEach(t),Cp=i(M),nr=a(M,"BLOCKQUOTE",{});var Am=s(nr);ar=a(Am,"BLOCKQUOTE",{});var Dm=s(ar);sr=a(Dm,"BLOCKQUOTE",{});var Gm=s(sr);rr=a(Gm,"P",{});var Um=s(rr);jp=d(Um,"tokenizer.decode(predictions).split()"),Um.forEach(t),Gm.forEach(t),Dm.forEach(t),Am.forEach(t),M.forEach(t),Op=i(ne),Ye=a(ne,"DIV",{class:!0});var ra=s(Ye);_(vn.$$.fragment,ra),Pp=i(ra),dr=a(ra,"P",{});var Wm=s(dr);Lp=d(Wm,"Example:"),Wm.forEach(t),Np=i(ra),_(Tn.$$.fragment,ra),ra.forEach(t),Ip=i(ne),Ze=a(ne,"DIV",{class:!0});var da=s(Ze);_(wn.$$.fragment,da),Ap=i(da),lr=a(da,"P",{});var Rm=s(lr);Dp=d(Rm,"Example:"),Rm.forEach(t),Gp=i(da),_(Sn.$$.fragment,da),da.forEach(t),ne.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(sf)),c(T,"id","blenderbot-small"),c(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(T,"href","#blenderbot-small"),c(v,"class","relative group"),c(U,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel"),c(W,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForConditionalGeneration"),c(K,"href","https://huggingface.co/facebook/blenderbot-90M"),c(K,"rel","nofollow"),c(Z,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot#transformers.BlenderbotModel"),c(fe,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration"),c(A,"id","overview"),c(A,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(A,"href","#overview"),c(V,"class","relative group"),c(le,"href","https://arxiv.org/pdf/2004.13637.pdf"),c(le,"rel","nofollow"),c(Se,"href","https://huggingface.co/patrickvonplaten"),c(Se,"rel","nofollow"),c(D,"href","https://github.com/facebookresearch/ParlAI"),c(D,"rel","nofollow"),c(_e,"id","transformers.BlenderbotSmallConfig"),c(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_e,"href","#transformers.BlenderbotSmallConfig"),c(ce,"class","relative group"),c(xn,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel"),c(to,"href","https://huggingface.co/facebook/blenderbot_small-90M"),c(to,"rel","nofollow"),c(qn,"href","/docs/transformers/pr_16229/en/main_classes/configuration#transformers.PretrainedConfig"),c(Fn,"href","/docs/transformers/pr_16229/en/main_classes/configuration#transformers.PretrainedConfig"),c(pe,"class","docstring"),c($t,"id","transformers.BlenderbotSmallTokenizer"),c($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($t,"href","#transformers.BlenderbotSmallTokenizer"),c(mt,"class","relative group"),c($n,"href","/docs/transformers/pr_16229/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(He,"class","docstring"),c(Mt,"class","docstring"),c(En,"href","../glossary#token-type-ids"),c(Ke,"class","docstring"),c(Cn,"class","docstring"),c(G,"class","docstring"),c(Et,"id","transformers.BlenderbotSmallTokenizerFast"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.BlenderbotSmallTokenizerFast"),c(_t,"class","relative group"),c(Ct,"class","docstring"),c(Ge,"class","docstring"),c(jt,"id","transformers.BlenderbotSmallModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.BlenderbotSmallModel"),c(gt,"class","relative group"),c(jn,"href","/docs/transformers/pr_16229/en/main_classes/model#transformers.PreTrainedModel"),c(ko,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ko,"rel","nofollow"),c(On,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel"),c(ge,"class","docstring"),c(xe,"class","docstring"),c(Pt,"id","transformers.BlenderbotSmallForConditionalGeneration"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.BlenderbotSmallForConditionalGeneration"),c(kt,"class","relative group"),c(Pn,"href","/docs/transformers/pr_16229/en/main_classes/model#transformers.PreTrainedModel"),c(zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(zo,"rel","nofollow"),c(Ln,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForConditionalGeneration"),c(be,"class","docstring"),c(qe,"class","docstring"),c(Nt,"id","transformers.BlenderbotSmallForCausalLM"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.BlenderbotSmallForCausalLM"),c(vt,"class","relative group"),c(Qe,"class","docstring"),c(Tt,"class","docstring"),c(It,"id","transformers.TFBlenderbotSmallModel"),c(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(It,"href","#transformers.TFBlenderbotSmallModel"),c(wt,"class","relative group"),c(Nn,"href","/docs/transformers/pr_16229/en/main_classes/model#transformers.TFPreTrainedModel"),c(Lo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Lo,"rel","nofollow"),c(In,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.TFBlenderbotSmallModel"),c(ke,"class","docstring"),c(he,"class","docstring"),c(Gt,"id","transformers.TFBlenderbotSmallForConditionalGeneration"),c(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gt,"href","#transformers.TFBlenderbotSmallForConditionalGeneration"),c(Bt,"class","relative group"),c(An,"href","/docs/transformers/pr_16229/en/main_classes/model#transformers.TFPreTrainedModel"),c(Wo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Wo,"rel","nofollow"),c(Dn,"href","/docs/transformers/pr_16229/en/model_doc/blenderbot-small#transformers.TFBlenderbotSmallForConditionalGeneration"),c(O,"class","docstring"),c(ue,"class","docstring"),c(Rt,"id","transformers.FlaxBlenderbotSmallModel"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.FlaxBlenderbotSmallModel"),c(xt,"class","relative group"),c(Gn,"href","/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Xo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Xo,"rel","nofollow"),c(Yo,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Yo,"rel","nofollow"),c(Zo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Zo,"rel","nofollow"),c(en,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(en,"rel","nofollow"),c(tn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(tn,"rel","nofollow"),c(Ve,"class","docstring"),c(Je,"class","docstring"),c(Xe,"class","docstring"),c(N,"class","docstring"),c(Ht,"id","transformers.FlaxBlenderbotSmallForConditionalGeneration"),c(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ht,"href","#transformers.FlaxBlenderbotSmallForConditionalGeneration"),c(qt,"class","relative group"),c(Un,"href","/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(un,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(un,"rel","nofollow"),c(mn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(mn,"rel","nofollow"),c(fn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(fn,"rel","nofollow"),c(_n,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(_n,"rel","nofollow"),c(gn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(gn,"rel","nofollow"),c(Vt,"id","generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),c(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Vt,"href","#generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),c(Qt,"class","relative group"),c($,"class","docstring"),c(Ye,"class","docstring"),c(Ze,"class","docstring"),c(I,"class","docstring")},m(o,h){e(document.head,u),p(o,x,h),p(o,v,h),e(v,T),e(T,B),g(S,B,null),e(v,w),e(v,q),e(q,Ce),p(o,me,h),p(o,z,h),e(z,je),e(z,U),e(U,Oe),e(z,Pe),e(z,W),e(W,Le),e(z,Ne),e(z,K),e(K,Q),e(z,Ie),e(z,Z),e(Z,C),e(z,P),e(z,fe),e(fe,ae),p(o,$e,h),p(o,V,h),e(V,A),e(A,Te),g(se,Te,null),e(V,L),e(V,we),e(we,re),p(o,Me,h),p(o,ee,h),e(ee,de),e(ee,le),e(le,Ae),e(ee,J),p(o,Ee,h),p(o,R,h),e(R,De),p(o,m,h),p(o,F,h),e(F,ie),e(ie,dt),p(o,Re,h),p(o,j,h),e(j,lt),e(j,Se),e(Se,it),e(j,X),e(j,D),e(D,ct),e(j,pt),p(o,te,h),p(o,ce,h),e(ce,_e),e(_e,Be),g(ze,Be,null),e(ce,hd),e(ce,la),e(la,ud),p(o,mr,h),p(o,pe,h),g(eo,pe,null),e(pe,md),e(pe,ht),e(ht,fd),e(ht,xn),e(xn,_d),e(ht,gd),e(ht,to),e(to,bd),e(ht,kd),e(pe,yd),e(pe,ut),e(ut,vd),e(ut,qn),e(qn,Td),e(ut,wd),e(ut,Fn),e(Fn,Sd),e(ut,Bd),e(pe,zd),e(pe,ia),e(ia,xd),e(pe,qd),g(oo,pe,null),p(o,fr,h),p(o,mt,h),e(mt,$t),e($t,ca),g(no,ca,null),e(mt,Fd),e(mt,pa),e(pa,$d),p(o,_r,h),p(o,G,h),g(ao,G,null),e(G,Md),e(G,ha),e(ha,Ed),e(G,Cd),e(G,so),e(so,jd),e(so,$n),e($n,Od),e(so,Pd),e(G,Ld),e(G,He),g(ro,He,null),e(He,Nd),e(He,ua),e(ua,Id),e(He,Ad),e(He,ma),e(ma,Dd),e(G,Gd),e(G,Mt),g(lo,Mt,null),e(Mt,Ud),e(Mt,ft),e(ft,Wd),e(ft,fa),e(fa,Rd),e(ft,Hd),e(ft,_a),e(_a,Kd),e(ft,Qd),e(G,Vd),e(G,Ke),g(io,Ke,null),e(Ke,Jd),e(Ke,Mn),e(Mn,Xd),e(Mn,En),e(En,Yd),e(Ke,Zd),e(Ke,ga),e(ga,el),e(G,tl),e(G,Cn),g(co,Cn,null),p(o,gr,h),p(o,_t,h),e(_t,Et),e(Et,ba),g(po,ba,null),e(_t,ol),e(_t,ka),e(ka,nl),p(o,br,h),p(o,Ge,h),g(ho,Ge,null),e(Ge,al),e(Ge,uo),e(uo,sl),e(uo,ya),e(ya,rl),e(uo,dl),e(Ge,ll),e(Ge,Ct),g(mo,Ct,null),e(Ct,il),e(Ct,va),e(va,cl),p(o,kr,h),p(o,gt,h),e(gt,jt),e(jt,Ta),g(fo,Ta,null),e(gt,pl),e(gt,wa),e(wa,hl),p(o,yr,h),p(o,xe,h),g(_o,xe,null),e(xe,ul),e(xe,go),e(go,ml),e(go,jn),e(jn,fl),e(go,_l),e(xe,gl),e(xe,bo),e(bo,bl),e(bo,ko),e(ko,kl),e(bo,yl),e(xe,vl),e(xe,ge),g(yo,ge,null),e(ge,Tl),e(ge,bt),e(bt,wl),e(bt,On),e(On,Sl),e(bt,Bl),e(bt,Sa),e(Sa,zl),e(bt,xl),e(ge,ql),g(Ot,ge,null),e(ge,Fl),e(ge,Ba),e(Ba,$l),e(ge,Ml),g(vo,ge,null),p(o,vr,h),p(o,kt,h),e(kt,Pt),e(Pt,za),g(To,za,null),e(kt,El),e(kt,xa),e(xa,Cl),p(o,Tr,h),p(o,qe,h),g(wo,qe,null),e(qe,jl),e(qe,So),e(So,Ol),e(So,Pn),e(Pn,Pl),e(So,Ll),e(qe,Nl),e(qe,Bo),e(Bo,Il),e(Bo,zo),e(zo,Al),e(Bo,Dl),e(qe,Gl),e(qe,be),g(xo,be,null),e(be,Ul),e(be,yt),e(yt,Wl),e(yt,Ln),e(Ln,Rl),e(yt,Hl),e(yt,qa),e(qa,Kl),e(yt,Ql),e(be,Vl),g(Lt,be,null),e(be,Jl),e(be,Fa),e(Fa,Xl),e(be,Yl),g(qo,be,null),p(o,wr,h),p(o,vt,h),e(vt,Nt),e(Nt,$a),g(Fo,$a,null),e(vt,Zl),e(vt,Ma),e(Ma,ei),p(o,Sr,h),p(o,Tt,h),g($o,Tt,null),e(Tt,ti),e(Tt,Qe),g(Mo,Qe,null),e(Qe,oi),e(Qe,Ea),e(Ea,ni),e(Qe,ai),g(Eo,Qe,null),p(o,Br,h),p(o,wt,h),e(wt,It),e(It,Ca),g(Co,Ca,null),e(wt,si),e(wt,ja),e(ja,ri),p(o,zr,h),p(o,he,h),g(jo,he,null),e(he,di),e(he,Oo),e(Oo,li),e(Oo,Nn),e(Nn,ii),e(Oo,ci),e(he,pi),e(he,Po),e(Po,hi),e(Po,Lo),e(Lo,ui),e(Po,mi),e(he,fi),g(At,he,null),e(he,_i),e(he,ke),g(No,ke,null),e(ke,gi),e(ke,St),e(St,bi),e(St,In),e(In,ki),e(St,yi),e(St,Oa),e(Oa,vi),e(St,Ti),e(ke,wi),g(Dt,ke,null),e(ke,Si),e(ke,Pa),e(Pa,Bi),e(ke,zi),g(Io,ke,null),p(o,xr,h),p(o,Bt,h),e(Bt,Gt),e(Gt,La),g(Ao,La,null),e(Bt,xi),e(Bt,Na),e(Na,qi),p(o,qr,h),p(o,ue,h),g(Do,ue,null),e(ue,Fi),e(ue,Go),e(Go,$i),e(Go,An),e(An,Mi),e(Go,Ei),e(ue,Ci),e(ue,Uo),e(Uo,ji),e(Uo,Wo),e(Wo,Oi),e(Uo,Pi),e(ue,Li),g(Ut,ue,null),e(ue,Ni),e(ue,O),g(Ro,O,null),e(O,Ii),e(O,zt),e(zt,Ai),e(zt,Dn),e(Dn,Di),e(zt,Gi),e(zt,Ia),e(Ia,Ui),e(zt,Wi),e(O,Ri),g(Wt,O,null),e(O,Hi),e(O,Aa),e(Aa,Ki),e(O,Qi),e(O,Da),e(Da,Ga),e(Ga,Ua),e(Ua,Wa),e(Wa,Vi),e(O,Ji),e(O,Ra),e(Ra,Ha),e(Ha,Ka),e(Ka,Qa),e(Qa,Xi),e(O,Yi),e(O,Va),e(Va,Ja),e(Ja,Xa),e(Xa,Ya),e(Ya,Zi),e(O,ec),e(O,Za),e(Za,es),e(es,ts),e(ts,Ho),e(Ho,tc),e(Ho,os),e(os,oc),e(Ho,nc),e(O,ac),e(O,ns),e(ns,as),e(as,ss),e(ss,rs),e(rs,sc),p(o,Fr,h),p(o,xt,h),e(xt,Rt),e(Rt,ds),g(Ko,ds,null),e(xt,rc),e(xt,ls),e(ls,dc),p(o,$r,h),p(o,N,h),g(Qo,N,null),e(N,lc),e(N,Vo),e(Vo,ic),e(Vo,Gn),e(Gn,cc),e(Vo,pc),e(N,hc),e(N,Jo),e(Jo,uc),e(Jo,Xo),e(Xo,mc),e(Jo,fc),e(N,_c),e(N,is),e(is,gc),e(N,bc),e(N,Ue),e(Ue,cs),e(cs,Yo),e(Yo,kc),e(Ue,yc),e(Ue,ps),e(ps,Zo),e(Zo,vc),e(Ue,Tc),e(Ue,hs),e(hs,en),e(en,wc),e(Ue,Sc),e(Ue,us),e(us,tn),e(tn,Bc),e(N,zc),e(N,Ve),g(on,Ve,null),e(Ve,xc),e(Ve,ms),e(ms,qc),e(Ve,Fc),g(nn,Ve,null),e(N,$c),e(N,Je),g(an,Je,null),e(Je,Mc),e(Je,fs),e(fs,Ec),e(Je,Cc),g(sn,Je,null),e(N,jc),e(N,Xe),g(rn,Xe,null),e(Xe,Oc),e(Xe,_s),e(_s,Pc),e(Xe,Lc),g(dn,Xe,null),p(o,Mr,h),p(o,qt,h),e(qt,Ht),e(Ht,gs),g(ln,gs,null),e(qt,Nc),e(qt,bs),e(bs,Ic),p(o,Er,h),p(o,I,h),g(cn,I,null),e(I,Ac),e(I,pn),e(pn,Dc),e(pn,Un),e(Un,Gc),e(pn,Uc),e(I,Wc),e(I,hn),e(hn,Rc),e(hn,un),e(un,Hc),e(hn,Kc),e(I,Qc),e(I,ks),e(ks,Vc),e(I,Jc),e(I,We),e(We,ys),e(ys,mn),e(mn,Xc),e(We,Yc),e(We,vs),e(vs,fn),e(fn,Zc),e(We,ep),e(We,Ts),e(Ts,_n),e(_n,tp),e(We,op),e(We,ws),e(ws,gn),e(gn,np),e(I,ap),e(I,$),g(bn,$,null),e($,sp),e($,Ft),e(Ft,rp),e(Ft,Ss),e(Ss,dp),e(Ft,lp),e(Ft,Bs),e(Bs,ip),e(Ft,cp),e($,pp),g(Kt,$,null),e($,hp),e($,zs),e(zs,up),e($,mp),e($,xs),e(xs,qs),e(qs,Fs),e(Fs,$s),e($s,fp),e($,_p),e($,Ms),e(Ms,Es),e(Es,Cs),e(Cs,js),e(js,gp),e($,bp),e($,Os),e(Os,Ps),e(Ps,Ls),e(Ls,Ns),e(Ns,kp),e($,yp),e($,Is),e(Is,As),e(As,kn),e(kn,Qt),e(Qt,Vt),e(Vt,Ds),g(yn,Ds,null),e(Qt,vp),e(Qt,Gs),e(Gs,Tp),e(kn,wp),e(kn,Us),e(Us,Sp),e($,Bp),e($,Ws),e(Ws,zp),e($,xp),e($,Rs),e(Rs,Hs),e(Hs,Ks),e(Ks,Qs),e(Qs,qp),e($,Fp),e($,Vs),e(Vs,Js),e(Js,Xs),e(Xs,Ys),e(Ys,$p),e($,Mp),e($,Zs),e(Zs,er),e(er,tr),e(tr,or),e(or,Ep),e($,Cp),e($,nr),e(nr,ar),e(ar,sr),e(sr,rr),e(rr,jp),e(I,Op),e(I,Ye),g(vn,Ye,null),e(Ye,Pp),e(Ye,dr),e(dr,Lp),e(Ye,Np),g(Tn,Ye,null),e(I,Ip),e(I,Ze),g(wn,Ze,null),e(Ze,Ap),e(Ze,lr),e(lr,Dp),e(Ze,Gp),g(Sn,Ze,null),Cr=!0},p(o,[h]){const Bn={};h&2&&(Bn.$$scope={dirty:h,ctx:o}),Ot.$set(Bn);const ir={};h&2&&(ir.$$scope={dirty:h,ctx:o}),Lt.$set(ir);const cr={};h&2&&(cr.$$scope={dirty:h,ctx:o}),At.$set(cr);const pr={};h&2&&(pr.$$scope={dirty:h,ctx:o}),Dt.$set(pr);const ye={};h&2&&(ye.$$scope={dirty:h,ctx:o}),Ut.$set(ye);const hr={};h&2&&(hr.$$scope={dirty:h,ctx:o}),Wt.$set(hr);const ur={};h&2&&(ur.$$scope={dirty:h,ctx:o}),Kt.$set(ur)},i(o){Cr||(b(S.$$.fragment,o),b(se.$$.fragment,o),b(ze.$$.fragment,o),b(eo.$$.fragment,o),b(oo.$$.fragment,o),b(no.$$.fragment,o),b(ao.$$.fragment,o),b(ro.$$.fragment,o),b(lo.$$.fragment,o),b(io.$$.fragment,o),b(co.$$.fragment,o),b(po.$$.fragment,o),b(ho.$$.fragment,o),b(mo.$$.fragment,o),b(fo.$$.fragment,o),b(_o.$$.fragment,o),b(yo.$$.fragment,o),b(Ot.$$.fragment,o),b(vo.$$.fragment,o),b(To.$$.fragment,o),b(wo.$$.fragment,o),b(xo.$$.fragment,o),b(Lt.$$.fragment,o),b(qo.$$.fragment,o),b(Fo.$$.fragment,o),b($o.$$.fragment,o),b(Mo.$$.fragment,o),b(Eo.$$.fragment,o),b(Co.$$.fragment,o),b(jo.$$.fragment,o),b(At.$$.fragment,o),b(No.$$.fragment,o),b(Dt.$$.fragment,o),b(Io.$$.fragment,o),b(Ao.$$.fragment,o),b(Do.$$.fragment,o),b(Ut.$$.fragment,o),b(Ro.$$.fragment,o),b(Wt.$$.fragment,o),b(Ko.$$.fragment,o),b(Qo.$$.fragment,o),b(on.$$.fragment,o),b(nn.$$.fragment,o),b(an.$$.fragment,o),b(sn.$$.fragment,o),b(rn.$$.fragment,o),b(dn.$$.fragment,o),b(ln.$$.fragment,o),b(cn.$$.fragment,o),b(bn.$$.fragment,o),b(Kt.$$.fragment,o),b(yn.$$.fragment,o),b(vn.$$.fragment,o),b(Tn.$$.fragment,o),b(wn.$$.fragment,o),b(Sn.$$.fragment,o),Cr=!0)},o(o){k(S.$$.fragment,o),k(se.$$.fragment,o),k(ze.$$.fragment,o),k(eo.$$.fragment,o),k(oo.$$.fragment,o),k(no.$$.fragment,o),k(ao.$$.fragment,o),k(ro.$$.fragment,o),k(lo.$$.fragment,o),k(io.$$.fragment,o),k(co.$$.fragment,o),k(po.$$.fragment,o),k(ho.$$.fragment,o),k(mo.$$.fragment,o),k(fo.$$.fragment,o),k(_o.$$.fragment,o),k(yo.$$.fragment,o),k(Ot.$$.fragment,o),k(vo.$$.fragment,o),k(To.$$.fragment,o),k(wo.$$.fragment,o),k(xo.$$.fragment,o),k(Lt.$$.fragment,o),k(qo.$$.fragment,o),k(Fo.$$.fragment,o),k($o.$$.fragment,o),k(Mo.$$.fragment,o),k(Eo.$$.fragment,o),k(Co.$$.fragment,o),k(jo.$$.fragment,o),k(At.$$.fragment,o),k(No.$$.fragment,o),k(Dt.$$.fragment,o),k(Io.$$.fragment,o),k(Ao.$$.fragment,o),k(Do.$$.fragment,o),k(Ut.$$.fragment,o),k(Ro.$$.fragment,o),k(Wt.$$.fragment,o),k(Ko.$$.fragment,o),k(Qo.$$.fragment,o),k(on.$$.fragment,o),k(nn.$$.fragment,o),k(an.$$.fragment,o),k(sn.$$.fragment,o),k(rn.$$.fragment,o),k(dn.$$.fragment,o),k(ln.$$.fragment,o),k(cn.$$.fragment,o),k(bn.$$.fragment,o),k(Kt.$$.fragment,o),k(yn.$$.fragment,o),k(vn.$$.fragment,o),k(Tn.$$.fragment,o),k(wn.$$.fragment,o),k(Sn.$$.fragment,o),Cr=!1},d(o){t(u),o&&t(x),o&&t(v),y(S),o&&t(me),o&&t(z),o&&t($e),o&&t(V),y(se),o&&t(Me),o&&t(ee),o&&t(Ee),o&&t(R),o&&t(m),o&&t(F),o&&t(Re),o&&t(j),o&&t(te),o&&t(ce),y(ze),o&&t(mr),o&&t(pe),y(eo),y(oo),o&&t(fr),o&&t(mt),y(no),o&&t(_r),o&&t(G),y(ao),y(ro),y(lo),y(io),y(co),o&&t(gr),o&&t(_t),y(po),o&&t(br),o&&t(Ge),y(ho),y(mo),o&&t(kr),o&&t(gt),y(fo),o&&t(yr),o&&t(xe),y(_o),y(yo),y(Ot),y(vo),o&&t(vr),o&&t(kt),y(To),o&&t(Tr),o&&t(qe),y(wo),y(xo),y(Lt),y(qo),o&&t(wr),o&&t(vt),y(Fo),o&&t(Sr),o&&t(Tt),y($o),y(Mo),y(Eo),o&&t(Br),o&&t(wt),y(Co),o&&t(zr),o&&t(he),y(jo),y(At),y(No),y(Dt),y(Io),o&&t(xr),o&&t(Bt),y(Ao),o&&t(qr),o&&t(ue),y(Do),y(Ut),y(Ro),y(Wt),o&&t(Fr),o&&t(xt),y(Ko),o&&t($r),o&&t(N),y(Qo),y(on),y(nn),y(an),y(sn),y(rn),y(dn),o&&t(Mr),o&&t(qt),y(ln),o&&t(Er),o&&t(I),y(cn),y(bn),y(Kt),y(yn),y(vn),y(Tn),y(wn),y(Sn)}}}const sf={local:"blenderbot-small",sections:[{local:"overview",title:"Overview"},{local:"transformers.BlenderbotSmallConfig",title:"BlenderbotSmallConfig"},{local:"transformers.BlenderbotSmallTokenizer",title:"BlenderbotSmallTokenizer"},{local:"transformers.BlenderbotSmallTokenizerFast",title:"BlenderbotSmallTokenizerFast"},{local:"transformers.BlenderbotSmallModel",title:"BlenderbotSmallModel"},{local:"transformers.BlenderbotSmallForConditionalGeneration",title:"BlenderbotSmallForConditionalGeneration"},{local:"transformers.BlenderbotSmallForCausalLM",title:"BlenderbotSmallForCausalLM"},{local:"transformers.TFBlenderbotSmallModel",title:"TFBlenderbotSmallModel"},{local:"transformers.TFBlenderbotSmallForConditionalGeneration",title:"TFBlenderbotSmallForConditionalGeneration"},{local:"transformers.FlaxBlenderbotSmallModel",title:"FlaxBlenderbotSmallModel"},{local:"transformers.FlaxBlenderbotSmallForConditionalGeneration",title:"FlaxBlenderbotForConditionalGeneration"}],title:"Blenderbot Small"};function rf(Y){return Jm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class uf extends Hm{constructor(u){super();Km(this,u,rf,af,Qm,{})}}export{uf as default,sf as metadata};
