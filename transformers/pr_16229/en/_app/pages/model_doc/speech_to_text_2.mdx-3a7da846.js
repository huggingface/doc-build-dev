import{S as ic,i as cc,s as lc,e as a,k as l,w as m,t as s,M as dc,c as n,d as o,m as d,a as i,x as u,h as r,b as c,F as e,g as h,y as _,q as g,o as v,B as T}from"../../chunks/vendor-6b77c823.js";import{T as nc}from"../../chunks/Tip-39098574.js";import{D as L}from"../../chunks/Docstring-abef54e3.js";import{C as Ps}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as gt}from"../../chunks/IconCopyLink-7a11ce68.js";function pc(ye){let f,q,k,w,D,S,B,I;return{c(){f=a("p"),q=s(`This class method is simply calling the feature extractor
`),k=a("a"),w=s("from_pretrained()"),D=s(` and the tokenizer
`),S=a("code"),B=s("from_pretrained"),I=s(` methods. Please refer to the docstrings of the
...
`),S=n(b,"CODE",{});var M=i(S);B=r(M,"from_pretrained"),M.forEach(o),I=r(b,` methods. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/pr_16229/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){h(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,B),e(f,I)},d(P){P&&o(f)}}}function hc(ye){let f,q,k,w,D,S,B,I;return{c(){f=a("p"),q=s("This class method is simply calling "),k=a("a"),w=s("save_pretrained()"),D=s(` and
`),S=a("code"),B=s("save_pretrained"),I=s(`. Please refer to the docstrings of the methods
...
`),S=n(b,"CODE",{});var M=i(S);B=r(M,"save_pretrained"),M.forEach(o),I=r(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/pr_16229/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,B),e(f,I)},d(P){P&&o(f)}}}function fc(ye){let f,q,k,w,D,S,B,I,P,b,j,M,so,$e,js,ro,Cs,Lo,R,qs,vt,Ms,Fs,Ee,As,Ls,Do,y,Ds,ao,Is,Ws,no,Vs,Ns,Tt,Bs,Os,kt,Us,Hs,xt,Rs,Js,io,Gs,Ks,Io,ie,Qs,ze,Xs,Ys,Wo,ce,Zs,Pe,er,tr,Vo,bt,or,No,J,je,sr,Ce,rr,ar,nr,qe,ir,wt,cr,lr,dr,Me,pr,Fe,hr,fr,Bo,ee,le,co,Ae,mr,lo,ur,Oo,G,_r,St,gr,vr,yt,Tr,kr,Uo,z,xr,$t,br,wr,Et,Sr,yr,zt,$r,Er,Pt,zr,Pr,jt,jr,Cr,Ho,Ct,po,qr,Ro,Le,Jo,qt,De,ho,Mr,Fr,fo,Ar,Go,Ie,Ko,de,Lr,We,Dr,Ir,Qo,te,pe,mo,Ve,Wr,uo,Vr,Xo,C,Ne,Nr,oe,Br,Mt,Or,Ur,Be,Hr,Rr,Jr,se,Gr,Ft,Kr,Qr,At,Xr,Yr,Zr,_o,ea,ta,Oe,Yo,re,he,go,Ue,oa,vo,sa,Zo,E,He,ra,To,aa,na,Re,ia,Lt,ca,la,da,fe,Je,pa,ko,ha,fa,K,Ge,ma,xo,ua,_a,Ke,ga,bo,va,Ta,ka,Dt,Qe,es,ae,me,wo,Xe,xa,So,ba,ts,x,Ye,wa,yo,Sa,ya,F,It,$a,Ea,Wt,za,Pa,Vt,ja,Ca,Ze,$o,qa,Ma,Fa,Nt,Aa,La,Da,ue,et,Ia,O,Wa,Eo,Va,Na,Bt,Ba,Oa,tt,zo,Ua,Ha,Ra,Ja,Q,ot,Ga,Po,Ka,Qa,_e,Xa,X,st,Ya,rt,Za,Ot,en,tn,on,ge,sn,ve,at,rn,nt,an,Ut,nn,cn,ln,Te,it,dn,ct,pn,Ht,hn,fn,mn,ke,lt,un,jo,_n,os,ne,xe,Co,dt,gn,qo,vn,ss,W,pt,Tn,U,kn,Rt,xn,bn,Mo,wn,Sn,Jt,yn,$n,En,ht,zn,ft,Pn,jn,Cn,Y,mt,qn,Fo,Mn,Fn,ut,rs;return S=new gt({}),$e=new gt({}),Ae=new gt({}),Le=new Ps({props:{code:`import torch
...
`,returnType:`
<p><code>str</code></p>
`}}),Qe=new L({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L235"}}),Xe=new gt({}),Ye=new L({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23",parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
<a href="/docs/transformers/pr_16229/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both
<a href="/docs/transformers/pr_16229/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16229/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("meta"),q=l(),k=a("h1"),w=a("a"),D=a("span"),m(S.$$.fragment),B=l(),I=a("span"),P=s("Speech2Text2"),b=l(),j=a("h2"),M=a("a"),so=a("span"),m($e.$$.fragment),js=l(),ro=a("span"),Cs=s("Overview"),Lo=l(),R=a("p"),qs=s("The Speech2Text2 model is used together with "),vt=a("a"),Ms=s("Wav2Vec2"),Fs=s(` for Speech Translation models proposed in
...
`),Tt=a("a"),Bs=s("Wav2Vec2"),Os=s(" or "),kt=a("a"),Us=s("HuBERT"),Hs=s(` for Speech-to-Text tasks. Please refer to the
...
`),Be=a("a"),Hr=s("facebook/s2t-small-librispeech-asr"),Rr=s(" architecture."),Jr=l(),se=a("p"),Gr=s("Configuration objects inherit from "),Ft=a("a"),Kr=s("PretrainedConfig"),Qr=s(` and can be used to control the model outputs. Read the
documentation from `),At=a("a"),Xr=s("PretrainedConfig"),Yr=s(" for more information."),Zr=l(),_o=a("p"),ea=s("Example:"),ta=l(),m(Oe.$$.fragment),Yo=l(),re=a("h2"),he=a("a"),go=a("span"),m(Ue.$$.fragment),oa=l(),vo=a("span"),sa=s("Speech2TextTokenizer"),Zo=l(),E=a("div"),m(He.$$.fragment),ra=l(),To=a("p"),aa=s("Constructs a Speech2Text2Tokenizer."),na=l(),Re=a("p"),ia=s("This tokenizer inherits from "),Lt=a("a"),ca=s("PreTrainedTokenizer"),la=s(` which contains some of the main methods. Users should refer to
...
See the `),Ze=a("a"),$o=a("strong"),qa=s("call"),Ma=s("()"),Fa=s(" and "),Nt=a("a"),Aa=s("decode()"),La=s(" for more information."),Da=l(),ue=a("div"),m(et.$$.fragment),Ia=l(),O=a("p"),Wa=s(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
can be reloaded using the `),Ot=a("a"),en=s("from_pretrained()"),tn=s(" method."),on=l(),m(ge.$$.fragment),sn=l(),ve=a("div"),m(at.$$.fragment),rn=l(),nt=a("p"),an=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ut=a("a"),nn=s("batch_decode()"),cn=s(`. Please
...
`),Tt=n(A,"A",{href:!0});var Rn=i(Tt);Bs=r(Rn,"Wav2Vec2"),Rn.forEach(o),Os=r(A," or "),kt=n(A,"A",{href:!0});var Jn=i(kt);Us=r(Jn,"HuBERT"),Jn.forEach(o),Hs=r(A,` for Speech-to-Text tasks. Please refer to the
...
See the `),Ze=n(H,"A",{href:!0});var An=i(Ze);$o=n(An,"STRONG",{});var Bi=i($o);qa=r(Bi,"call"),Bi.forEach(o),Ma=r(An,"()"),An.forEach(o),Fa=r(H," and "),Nt=n(H,"A",{href:!0});var Oi=i(Nt);Aa=r(Oi,"decode()"),Oi.forEach(o),La=r(H," for more information."),H.forEach(o),Da=d($),ue=n($,"DIV",{class:!0});var ks=i(ue);u(et.$$.fragment,ks),Ia=d(ks),O=n(ks,"P",{});var be=i(O);Wa=r(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
`),Eo=n(be,"CODE",{});var Ui=i(Eo);Va=r(Ui,"__call__()"),Ui.forEach(o),Na=r(be,`and returns its output. If used in the context
`),Bt=n(be,"A",{href:!0});var Hi=i(Bt);Ba=r(Hi,"as_target_processor()"),Hi.forEach(o),Oa=r(be,` this method forwards all its arguments to
