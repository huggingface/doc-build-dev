...
`}}),on=new je({props:{$$slots:{default:[ew]},$$scope:{ctx:j}}}),Xa=new M({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration
...
`}}),an=new je({props:{$$slots:{default:[tw]},$$scope:{ctx:j}}}),ds=new M({props:{code:`from transformers import BartTokenizer, FlaxBartModel
...
`}}),rn=new je({props:{$$slots:{default:[ow]},$$scope:{ctx:j}}}),ws=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
`}}),ln=new je({props:{$$slots:{default:[nw]},$$scope:{ctx:j}}}),Ns=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
`}}),pn=new je({props:{$$slots:{default:[aw]},$$scope:{ctx:j}}}),er=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
<p><a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),un=new je({props:{$$slots:{default:[sw]},$$scope:{ctx:j}}}),fr=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForCausalLM
...
`),os=a(Bp,"A",{href:!0,rel:!0});var e2=s(os);rg=i(e2,"flax.nn.Module"),e2.forEach(t),ig=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),dg=l(ge),Ld=a(ge,"P",{});var t2=s(Ld);lg=i(t2,"Finally, this model supports inherent JAX features such as:"),t2.forEach(t),cg=l(ge),ht=a(ge,"UL",{});var bn=s(ht);Dd=a(bn,"LI",{});var o2=s(Dd);ns=a(o2,"A",{href:!0,rel:!0});var n2=s(ns);pg=i(n2,"Just-In-Time (JIT) compilation"),n2.forEach(t),o2.forEach(t),hg=l(bn),Gd=a(bn,"LI",{});var a2=s(Gd);as=a(a2,"A",{href:!0,rel:!0});var s2=s(as);ug=i(s2,"Automatic Differentiation"),s2.forEach(t),a2.forEach(t),mg=l(bn),Wd=a(bn,"LI",{});var r2=s(Wd);ss=a(r2,"A",{href:!0,rel:!0});var i2=s(ss);fg=i(i2,"Vectorization"),i2.forEach(t),r2.forEach(t),_g=l(bn),Ud=a(bn,"LI",{});var d2=s(Ud);rs=a(d2,"A",{href:!0,rel:!0});var l2=s(rs);gg=i(l2,"Parallelization"),l2.forEach(t),d2.forEach(t),bn.forEach(t),kg=l(ge),Oe=a(ge,"DIV",{class:!0});var St=s(Oe);f(is.$$.fragment,St),bg=l(St),bo=a(St,"P",{});var hi=s(bo);yg=i(hi,"The "),Rd=a(hi,"CODE",{});var c2=s(Rd);Tg=i(c2,"FlaxBartPreTrainedModel"),c2.forEach(t),vg=i(hi,"forward method, overrides the "),Hd=a(hi,"CODE",{});var p2=s(Hd);wg=i(p2,"__call__"),p2.forEach(t),xg=i(hi," special method."),hi.forEach(t),zg=l(St),f(an.$$.fragment,St),Fg=l(St),Qd=a(St,"P",{});var h2=s(Qd);Bg=i(h2,"Example:"),h2.forEach(t),qg=l(St),f(ds.$$.fragment,St),St.forEach(t),$g=l(ge),Tt=a(ge,"DIV",{class:!0});var ui=s(Tt);f(ls.$$.fragment,ui),jg=l(ui),Vd=a(ui,"P",{});var u2=s(Vd);Mg=i(u2,"Example:"),u2.forEach(t),Pg=l(ui),f(cs.$$.fragment,ui),ui.forEach(t),Eg=l(ge),vt=a(ge,"DIV",{class:!0});var mi=s(vt);f(ps.$$.fragment,mi),Cg=l(mi),Jd=a(mi,"P",{});var m2=s(Jd);Ag=i(m2,"Example:"),m2.forEach(t),Og=l(mi),f(hs.$$.fragment,mi),mi.forEach(t),ge.forEach(t),Pc=l(o),yo=a(o,"H2",{class:!0});var qp=s(yo);sn=a(qp,"A",{id:!0,class:!0,href:!0});var f2=s(sn);Xd=a(f2,"SPAN",{});var _2=s(Xd);f(us.$$.fragment,_2),_2.forEach(t),f2.forEach(t),Sg=l(qp),Kd=a(qp,"SPAN",{});var g2=s(Kd);Ig=i(g2,"FlaxBartForConditionalGeneration"),g2.forEach(t),qp.forEach(t),Ec=l(o),R=a(o,"DIV",{class:!0});var ke=s(R);f(ms.$$.fragment,ke),Ng=l(ke),fs=a(ke,"P",{});var $p=s(fs);Lg=i($p,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rr=a($p,"A",{href:!0});var k2=s(Rr);Dg=i(k2,"FlaxPreTrainedModel"),k2.forEach(t),Gg=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),Wg=l(ke),_s=a(ke,"P",{});var jp=s(_s);Ug=i(jp,`This model is also a Flax Linen
`),gs=a(jp,"A",{href:!0,rel:!0});var b2=s(gs);Rg=i(b2,"flax.nn.Module"),b2.forEach(t),Hg=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(ke),Zd=a(ke,"P",{});var y2=s(Zd);Vg=i(y2,"Finally, this model supports inherent JAX features such as:"),y2.forEach(t),Jg=l(ke),ut=a(ke,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var T2=s(Yd);ks=a(T2,"A",{href:!0,rel:!0});var v2=s(ks);Xg=i(v2,"Just-In-Time (JIT) compilation"),v2.forEach(t),T2.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var w2=s(el);bs=a(w2,"A",{href:!0,rel:!0});var x2=s(bs);Zg=i(x2,"Automatic Differentiation"),x2.forEach(t),w2.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var z2=s(tl);ys=a(z2,"A",{href:!0,rel:!0});var F2=s(ys);ek=i(F2,"Vectorization"),F2.forEach(t),z2.forEach(t),tk=l(yn),ol=a(yn,"LI",{});var B2=s(ol);Ts=a(B2,"A",{href:!0,rel:!0});var q2=s(Ts);ok=i(q2,"Parallelization"),q2.forEach(t),B2.forEach(t),yn.forEach(t),nk=l(ke),te=a(ke,"DIV",{class:!0});var Ge=s(te);f(vs.$$.fragment,Ge),ak=l(Ge),To=a(Ge,"P",{});var fi=s(To);sk=i(fi,"The "),nl=a(fi,"CODE",{});var $2=s(nl);rk=i($2,"FlaxBartPreTrainedModel"),$2.forEach(t),ik=i(fi,"forward method, overrides the "),al=a(fi,"CODE",{});var j2=s(al);dk=i(j2,"__call__"),j2.forEach(t),lk=i(fi," special method."),fi.forEach(t),ck=l(Ge),f(rn.$$.fragment,Ge),pk=l(Ge),sl=a(Ge,"P",{});var M2=s(sl);hk=i(M2,"Summarization example:"),M2.forEach(t),uk=l(Ge),f(ws.$$.fragment,Ge),mk=l(Ge),rl=a(Ge,"P",{});var P2=s(rl);fk=i(P2,"Mask filling example:"),P2.forEach(t),_k=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gk=l(ke),wt=a(ke,"DIV",{class:!0});var _i=s(wt);f(zs.$$.fragment,_i),kk=l(_i),il=a(_i,"P",{});var E2=s(il);bk=i(E2,"Example:"),E2.forEach(t),yk=l(_i),f(Fs.$$.fragment,_i),_i.forEach(t),Tk=l(ke),xt=a(ke,"DIV",{class:!0});var gi=s(xt);f(Bs.$$.fragment,gi),vk=l(gi),dl=a(gi,"P",{});var C2=s(dl);wk=i(C2,"Example:"),C2.forEach(t),xk=l(gi),f(qs.$$.fragment,gi),gi.forEach(t),ke.forEach(t),Cc=l(o),vo=a(o,"H2",{class:!0});var Mp=s(vo);dn=a(Mp,"A",{id:!0,class:!0,href:!0});var A2=s(dn);ll=a(A2,"SPAN",{});var O2=s(ll);f($s.$$.fragment,O2),O2.forEach(t),A2.forEach(t),zk=l(Mp),cl=a(Mp,"SPAN",{});var S2=s(cl);Fk=i(S2,"FlaxBartForSequenceClassification"),S2.forEach(t),Mp.forEach(t),Ac=l(o),S=a(o,"DIV",{class:!0});var ne=s(S);f(js.$$.fragment,ne),Bk=l(ne),pl=a(ne,"P",{});var I2=s(pl);qk=i(I2,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),I2.forEach(t),$k=l(ne),Ms=a(ne,"P",{});var Pp=s(Ms);jk=i(Pp,"This model inherits from "),Hr=a(Pp,"A",{href:!0});var N2=s(Hr);Mk=i(N2,"FlaxPreTrainedModel"),N2.forEach(t),Pk=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pp.forEach(t),Ek=l(ne),Ps=a(ne,"P",{});var Ep=s(Ps);Ck=i(Ep,`This model is also a Flax Linen
`),Es=a(Ep,"A",{href:!0,rel:!0});var L2=s(Es);Ak=i(L2,"flax.nn.Module"),L2.forEach(t),Ok=i(Ep,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ep.forEach(t),Sk=l(ne),hl=a(ne,"P",{});var D2=s(hl);Ik=i(D2,"Finally, this model supports inherent JAX features such as:"),D2.forEach(t),Nk=l(ne),mt=a(ne,"UL",{});var Tn=s(mt);ul=a(Tn,"LI",{});var G2=s(ul);Cs=a(G2,"A",{href:!0,rel:!0});var W2=s(Cs);Lk=i(W2,"Just-In-Time (JIT) compilation"),W2.forEach(t),G2.forEach(t),Dk=l(Tn),ml=a(Tn,"LI",{});var U2=s(ml);As=a(U2,"A",{href:!0,rel:!0});var R2=s(As);Gk=i(R2,"Automatic Differentiation"),R2.forEach(t),U2.forEach(t),Wk=l(Tn),fl=a(Tn,"LI",{});var H2=s(fl);Os=a(H2,"A",{href:!0,rel:!0});var Q2=s(Os);Uk=i(Q2,"Vectorization"),Q2.forEach(t),H2.forEach(t),Rk=l(Tn),_l=a(Tn,"LI",{});var V2=s(_l);Ss=a(V2,"A",{href:!0,rel:!0});var J2=s(Ss);Hk=i(J2,"Parallelization"),J2.forEach(t),V2.forEach(t),Tn.forEach(t),Qk=l(ne),Se=a(ne,"DIV",{class:!0});var It=s(Se);f(Is.$$.fragment,It),Vk=l(It),wo=a(It,"P",{});var ki=s(wo);Jk=i(ki,"The "),gl=a(ki,"CODE",{});var X2=s(gl);Xk=i(X2,"FlaxBartPreTrainedModel"),X2.forEach(t),Kk=i(ki,"forward method, overrides the "),kl=a(ki,"CODE",{});var K2=s(kl);Zk=i(K2,"__call__"),K2.forEach(t),Yk=i(ki," special method."),ki.forEach(t),eb=l(It),f(ln.$$.fragment,It),tb=l(It),bl=a(It,"P",{});var Z2=s(bl);ob=i(Z2,"Example:"),Z2.forEach(t),nb=l(It),f(Ns.$$.fragment,It),It.forEach(t),ab=l(ne),zt=a(ne,"DIV",{class:!0});var bi=s(zt);f(Ls.$$.fragment,bi),sb=l(bi),yl=a(bi,"P",{});var Y2=s(yl);rb=i(Y2,"Example:"),Y2.forEach(t),ib=l(bi),f(Ds.$$.fragment,bi),bi.forEach(t),db=l(ne),Ft=a(ne,"DIV",{class:!0});var yi=s(Ft);f(Gs.$$.fragment,yi),lb=l(yi),Tl=a(yi,"P",{});var e1=s(Tl);cb=i(e1,"Example:"),e1.forEach(t),pb=l(yi),f(Ws.$$.fragment,yi),yi.forEach(t),ne.forEach(t),Oc=l(o),xo=a(o,"H2",{class:!0});var Cp=s(xo);cn=a(Cp,"A",{id:!0,class:!0,href:!0});var t1=s(cn);vl=a(t1,"SPAN",{});var o1=s(vl);f(Us.$$.fragment,o1),o1.forEach(t),t1.forEach(t),hb=l(Cp),wl=a(Cp,"SPAN",{});var n1=s(wl);ub=i(n1,"FlaxBartForQuestionAnswering"),n1.forEach(t),Cp.forEach(t),Sc=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);f(Rs.$$.fragment,ae),mb=l(ae),zo=a(ae,"P",{});var Ti=s(zo);fb=i(Ti,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
