...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jT=d(),Dc=n("p"),ET=r("Finally, this model supports inherent JAX features such as:"),PT=d(),gt=n("ul"),Lc=n("li"),zr=n("a"),CT=r("Just-In-Time (JIT) compilation"),ST=d(),Gc=n("li"),qr=n("a"),AT=r("Automatic Differentiation"),OT=d(),Wc=n("li"),Br=n("a"),IT=r("Vectorization"),NT=d(),Rc=n("li"),$r=n("a"),DT=r("Parallelization"),LT=d(),De=n("div"),u(Fr.$$.fragment),GT=d(),jo=n("p"),WT=r("The "),Uc=n("code"),RT=r("FlaxMBartPreTrainedModel"),UT=r("forward method, overrides the "),Xc=n("code"),XT=r("__call__"),HT=r(" special method."),VT=d(),u(yn.$$.fragment),QT=d(),Hc=n("p"),JT=r("Example:"),KT=d(),u(jr.$$.fragment),ZT=d(),Bt=n("div"),u(Er.$$.fragment),YT=d(),Vc=n("p"),e2=r("Example:"),t2=d(),u(Pr.$$.fragment),o2=d(),$t=n("div"),u(Cr.$$.fragment),n2=d(),Qc=n("p"),a2=r("Example:"),s2=d(),u(Sr.$$.fragment),ph=d(),Eo=n("h2"),vn=n("a"),Jc=n("span"),u(Ar.$$.fragment),r2=d(),Kc=n("span"),i2=r("FlaxMBartForQuestionAnswering"),hh=d(),I=n("div"),u(Or.$$.fragment),d2=d(),Po=n("p"),l2=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Zc=n("code"),c2=r("span start logits"),p2=r(" and "),Yc=n("code"),h2=r("span end logits"),u2=r(")."),m2=d(),Ir=n("p"),f2=r("This model inherits from "),Ci=n("a"),_2=r("FlaxPreTrainedModel"),g2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),k2=d(),Nr=n("p"),b2=r(`This model is also a Flax Linen
`),Dr=n("a"),y2=r("flax.nn.Module"),v2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),T2=d(),ep=n("p"),M2=r("Finally, this model supports inherent JAX features such as:"),w2=d(),kt=n("ul"),tp=n("li"),Lr=n("a"),x2=r("Just-In-Time (JIT) compilation"),z2=d(),op=n("li"),Gr=n("a"),q2=r("Automatic Differentiation"),B2=d(),np=n("li"),Wr=n("a"),$2=r("Vectorization"),F2=d(),ap=n("li"),Rr=n("a"),j2=r("Parallelization"),E2=d(),Le=n("div"),u(Ur.$$.fragment),P2=d(),Co=n("p"),C2=r("The "),sp=n("code"),S2=r("FlaxMBartPreTrainedModel"),A2=r("forward method, overrides the "),rp=n("code"),O2=r("__call__"),I2=r(" special method."),N2=d(),u(Tn.$$.fragment),D2=d(),ip=n("p"),L2=r("Example:"),G2=d(),u(Xr.$$.fragment),W2=d(),Ft=n("div"),u(Hr.$$.fragment),R2=d(),dp=n("p"),U2=r("Example:"),X2=d(),u(Vr.$$.fragment),H2=d(),jt=n("div"),u(Qr.$$.fragment),V2=d(),lp=n("p"),Q2=r("Example:"),J2=d(),u(Jr.$$.fragment),this.h()},l(o){const p=Gz('[data-svelte="svelte-1phssyn"]',document.head);b=a(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(o),v=a(o,"H1",{class:!0});var Kr=s(v);w=a(Kr,"A",{id:!0,class:!0,href:!0});var cp=s(w);x=a(cp,"SPAN",{});var pp=s(x);m(T.$$.fragment,pp),pp.forEach(t),cp.forEach(t),y=l(Kr),B=a(Kr,"SPAN",{});var hp=s(B);rt=i(hp,"MBart and MBart-50"),hp.forEach(t),Kr.forEach(t),Pe=l(o),j=a(o,"P",{});var Mn=s(j);Ue=a(Mn,"STRONG",{});var up=s(Ue);ke=i(up,"DISCLAIMER:"),up.forEach(t),it=i(Mn," If you see something strange, file a "),be=a(Mn,"A",{href:!0,rel:!0});var mp=s(be);ye=i(mp,"Github Issue"),mp.forEach(t),dt=i(Mn,` and assign
@patrickvonplaten`),Mn.forEach(t),Ke=l(o),J=a(o,"H2",{class:!0});var Zr=s(J);N=a(Zr,"A",{id:!0,class:!0,href:!0});var fp=s(N);Xe=a(fp,"SPAN",{});var _p=s(Xe);m(se.$$.fragment,_p),_p.forEach(t),fp.forEach(t),P=l(Zr),A=a(Zr,"SPAN",{});var gp=s(A);lt=i(gp,"Overview of MBart"),gp.forEach(t),Zr.forEach(t),pe=l(o),he=a(o,"P",{});var Yr=s(he);ct=i(Yr,"The MBart model was presented in "),K=a(Yr,"A",{href:!0,rel:!0});var Z2=s(K);pt=i(Z2,"Multilingual Denoising Pre-training for Neural Machine Translation"),Z2.forEach(t),ht=i(Yr,` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
Ghazvininejad, Mike Lewis, Luke Zettlemoyer.`),Yr.forEach(t),D=l(o),Ce=a(o,"P",{});var Y2=s(Ce);ve=i(Y2,`According to the abstract, MBART is a sequence-to-sequence denoising auto-encoder pretrained on large-scale monolingual
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
...
target text format is `),Ve=a(Et,"CODE",{});var iM=s(Ve);Kt=i(iM,"[tgt_lang_code] X [eos]"),iM.forEach(t),Su=i(Et,". "),ld=a(Et,"CODE",{});var dM=s(ld);Au=i(dM,"bos"),dM.forEach(t),Ou=i(Et," is never used."),Et.forEach(t),bp=l(o),yt=a(o,"P",{});var Si=s(yt);Iu=i(Si,"The regular "),Cn=a(Si,"A",{href:!0});var K2=s(Cn);cd=a(K2,"STRONG",{});var lM=s(cd);Nu=i(lM,"call"),lM.forEach(t),Du=i(K2,"()"),K2.forEach(t),Lu=i(Si,` will encode source text format, and it should be wrapped
...
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Bg=l(fe),Ml=a(fe,"P",{});var Y1=s(Ml);$g=i(Y1,"Examples:"),Y1.forEach(t),Fg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Eg=l(St),wl=a(St,"P",{});var ew=s(wl);Pg=i(ew,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
