...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wa=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ti=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hi=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),zT=l(),mc=o("p"),jT=a("Finally, this model supports inherent JAX features such as:"),CT=l(),At=o("ul"),gc=o("li"),Ea=o("a"),PT=a("Just-In-Time (JIT) compilation"),qT=l(),_c=o("li"),xa=o("a"),AT=a("Automatic Differentiation"),OT=l(),vc=o("li"),za=o("a"),NT=a("Vectorization"),IT=l(),bc=o("li"),ja=o("a"),LT=a("Parallelization"),ST=l(),it=o("div"),b(Ca.$$.fragment),WT=l(),Ss=o("p"),RT=a("The "),kc=o("code"),UT=a("FlaxDistilBertPreTrainedModel"),HT=a("forward method, overrides the "),Tc=o("code"),QT=a("__call__"),KT=a(" special method."),VT=l(),b(Ao.$$.fragment),JT=l(),wc=o("p"),GT=a("Example:"),XT=l(),b(Pa.$$.fragment),rh=l(),Ws=o("h2"),Oo=o("a"),yc=o("span"),b(qa.$$.fragment),YT=l(),$c=o("span"),ZT=a("FlaxDistilBertForMultipleChoice"),ah=l(),ze=o("div"),b(Aa.$$.fragment),e2=l(),Dc=o("p"),t2=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),s2=l(),Oa=o("p"),o2=a("This model inherits from "),tl=o("a"),n2=a("FlaxPreTrainedModel"),r2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),a2=l(),Na=o("p"),i2=a("This model is also a Flax Linen "),Ia=o("a"),l2=a("flax.linen.Module"),d2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),c2=l(),Fc=o("p"),p2=a("Finally, this model supports inherent JAX features such as:"),h2=l(),Ot=o("ul"),Bc=o("li"),La=o("a"),u2=a("Just-In-Time (JIT) compilation"),f2=l(),Mc=o("li"),Sa=o("a"),m2=a("Automatic Differentiation"),g2=l(),Ec=o("li"),Wa=o("a"),_2=a("Vectorization"),v2=l(),xc=o("li"),Ra=o("a"),b2=a("Parallelization"),k2=l(),lt=o("div"),b(Ua.$$.fragment),T2=l(),Rs=o("p"),w2=a("The "),zc=o("code"),y2=a("FlaxDistilBertPreTrainedModel"),$2=a("forward method, overrides the "),jc=o("code"),D2=a("__call__"),F2=a(" special method."),B2=l(),b(No.$$.fragment),M2=l(),Cc=o("p"),E2=a("Example:"),x2=l(),b(Ha.$$.fragment),ih=l(),Us=o("h2"),Io=o("a"),Pc=o("span"),b(Qa.$$.fragment),z2=l(),qc=o("span"),j2=a("FlaxDistilBertForTokenClassification"),lh=l(),je=o("div"),b(Ka.$$.fragment),C2=l(),Ac=o("p"),P2=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),q2=l(),Va=o("p"),A2=a("This model inherits from "),sl=o("a"),O2=a("FlaxPreTrainedModel"),N2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),I2=l(),Ja=o("p"),L2=a("This model is also a Flax Linen "),Ga=o("a"),S2=a("flax.linen.Module"),W2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),R2=l(),Oc=o("p"),U2=a("Finally, this model supports inherent JAX features such as:"),H2=l(),Nt=o("ul"),Nc=o("li"),Xa=o("a"),Q2=a("Just-In-Time (JIT) compilation"),K2=l(),Ic=o("li"),Ya=o("a"),V2=a("Automatic Differentiation"),J2=l(),Lc=o("li"),Za=o("a"),G2=a("Vectorization"),X2=l(),Sc=o("li"),ei=o("a"),Y2=a("Parallelization"),Z2=l(),dt=o("div"),b(ti.$$.fragment),ew=l(),Hs=o("p"),tw=a("The "),Wc=o("code"),sw=a("FlaxDistilBertPreTrainedModel"),ow=a("forward method, overrides the "),Rc=o("code"),nw=a("__call__"),rw=a(" special method."),aw=l(),b(Lo.$$.fragment),iw=l(),Uc=o("p"),lw=a("Example:"),dw=l(),b(si.$$.fragment),dh=l(),Qs=o("h2"),So=o("a"),Hc=o("span"),b(oi.$$.fragment),cw=l(),Qc=o("span"),pw=a("FlaxDistilBertForQuestionAnswering"),ch=l(),Ce=o("div"),b(ni.$$.fragment),hw=l(),Ks=o("p"),uw=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zT=d(ut),mc=n(ut,"P",{});var cD=r(mc);jT=i(cD,"Finally, this model supports inherent JAX features such as:"),cD.forEach(t),CT=d(ut),At=n(ut,"UL",{});var Vo=r(At);gc=n(Vo,"LI",{});var pD=r(gc);Ea=n(pD,"A",{href:!0,rel:!0});var hD=r(Ea);PT=i(hD,"Just-In-Time (JIT) compilation"),hD.forEach(t),pD.forEach(t),qT=d(Vo),_c=n(Vo,"LI",{});var uD=r(_c);xa=n(uD,"A",{href:!0,rel:!0});var fD=r(xa);AT=i(fD,"Automatic Differentiation"),fD.forEach(t),uD.forEach(t),OT=d(Vo),vc=n(Vo,"LI",{});var mD=r(vc);za=n(mD,"A",{href:!0,rel:!0});var gD=r(za);NT=i(gD,"Vectorization"),gD.forEach(t),mD.forEach(t),IT=d(Vo),bc=n(Vo,"LI",{});var _D=r(bc);ja=n(_D,"A",{href:!0,rel:!0});var vD=r(ja);LT=i(vD,"Parallelization"),vD.forEach(t),_D.forEach(t),Vo.forEach(t),ST=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),WT=d(ss),Ss=n(ss,"P",{});var Tl=r(Ss);RT=i(Tl,"The "),kc=n(Tl,"CODE",{});var bD=r(kc);UT=i(bD,"FlaxDistilBertPreTrainedModel"),bD.forEach(t),HT=i(Tl,"forward method, overrides the "),Tc=n(Tl,"CODE",{});var kD=r(Tc);QT=i(kD,"__call__"),kD.forEach(t),KT=i(Tl," special method."),Tl.forEach(t),VT=d(ss),k(Ao.$$.fragment,ss),JT=d(ss),wc=n(ss,"P",{});var TD=r(wc);GT=i(TD,"Example:"),TD.forEach(t),XT=d(ss),k(Pa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var wD=r(Oo);yc=n(wD,"SPAN",{});var yD=r(yc);k(qa.$$.fragment,yD),yD.forEach(t),wD.forEach(t),YT=d(hu),$c=n(hu,"SPAN",{});var $D=r($c);ZT=i($D,"FlaxDistilBertForMultipleChoice"),$D.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);k(Aa.$$.fragment,ft),e2=d(ft),Dc=n(ft,"P",{});var DD=r(Dc);t2=i(DD,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),DD.forEach(t),s2=d(ft),Oa=n(ft,"P",{});var uu=r(Oa);o2=i(uu,"This model inherits from "),tl=n(uu,"A",{href:!0});var FD=r(tl);n2=i(FD,"FlaxPreTrainedModel"),FD.forEach(t),r2=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),uu.forEach(t),a2=d(ft),Na=n(ft,"P",{});var fu=r(Na);i2=i(fu,"This model is also a Flax Linen "),Ia=n(fu,"A",{href:!0,rel:!0});var BD=r(Ia);l2=i(BD,"flax.linen.Module"),BD.forEach(t),d2=i(fu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),fu.forEach(t),c2=d(ft),Fc=n(ft,"P",{});var MD=r(Fc);p2=i(MD,"Finally, this model supports inherent JAX features such as:"),MD.forEach(t),h2=d(ft),Ot=n(ft,"UL",{});var Jo=r(Ot);Bc=n(Jo,"LI",{});var ED=r(Bc);La=n(ED,"A",{href:!0,rel:!0});var xD=r(La);u2=i(xD,"Just-In-Time (JIT) compilation"),xD.forEach(t),ED.forEach(t),f2=d(Jo),Mc=n(Jo,"LI",{});var zD=r(Mc);Sa=n(zD,"A",{href:!0,rel:!0});var jD=r(Sa);m2=i(jD,"Automatic Differentiation"),jD.forEach(t),zD.forEach(t),g2=d(Jo),Ec=n(Jo,"LI",{});var CD=r(Ec);Wa=n(CD,"A",{href:!0,rel:!0});var PD=r(Wa);_2=i(PD,"Vectorization"),PD.forEach(t),CD.forEach(t),v2=d(Jo),xc=n(Jo,"LI",{});var qD=r(xc);Ra=n(qD,"A",{href:!0,rel:!0});var AD=r(Ra);b2=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Jo.forEach(t),k2=d(ft),lt=n(ft,"DIV",{class:!0});var os=r(lt);k(Ua.$$.fragment,os),T2=d(os),Rs=n(os,"P",{});var wl=r(Rs);w2=i(wl,"The "),zc=n(wl,"CODE",{});var OD=r(zc);y2=i(OD,"FlaxDistilBertPreTrainedModel"),OD.forEach(t),$2=i(wl,"forward method, overrides the "),jc=n(wl,"CODE",{});var ND=r(jc);D2=i(ND,"__call__"),ND.forEach(t),F2=i(wl," special method."),wl.forEach(t),B2=d(os),k(No.$$.fragment,os),M2=d(os),Cc=n(os,"P",{});var ID=r(Cc);E2=i(ID,"Example:"),ID.forEach(t),x2=d(os),k(Ha.$$.fragment,os),os.forEach(t),ft.forEach(t),ih=d(s),Us=n(s,"H2",{class:!0});var mu=r(Us);Io=n(mu,"A",{id:!0,class:!0,href:!0});var LD=r(Io);Pc=n(LD,"SPAN",{});var SD=r(Pc);k(Qa.$$.fragment,SD),SD.forEach(t),LD.forEach(t),z2=d(mu),qc=n(mu,"SPAN",{});var WD=r(qc);j2=i(WD,"FlaxDistilBertForTokenClassification"),WD.forEach(t),mu.forEach(t),lh=d(s),je=n(s,"DIV",{class:!0});var mt=r(je);k(Ka.$$.fragment,mt),C2=d(mt),Ac=n(mt,"P",{});var RD=r(Ac);P2=i(RD,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),RD.forEach(t),q2=d(mt),Va=n(mt,"P",{});var gu=r(Va);A2=i(gu,"This model inherits from "),sl=n(gu,"A",{href:!0});var UD=r(sl);O2=i(UD,"FlaxPreTrainedModel"),UD.forEach(t),N2=i(gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),gu.forEach(t),I2=d(mt),Ja=n(mt,"P",{});var _u=r(Ja);L2=i(_u,"This model is also a Flax Linen "),Ga=n(_u,"A",{href:!0,rel:!0});var HD=r(Ga);S2=i(HD,"flax.linen.Module"),HD.forEach(t),W2=i(_u,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_u.forEach(t),R2=d(mt),Oc=n(mt,"P",{});var QD=r(Oc);U2=i(QD,"Finally, this model supports inherent JAX features such as:"),QD.forEach(t),H2=d(mt),Nt=n(mt,"UL",{});var Go=r(Nt);Nc=n(Go,"LI",{});var KD=r(Nc);Xa=n(KD,"A",{href:!0,rel:!0});var VD=r(Xa);Q2=i(VD,"Just-In-Time (JIT) compilation"),VD.forEach(t),KD.forEach(t),K2=d(Go),Ic=n(Go,"LI",{});var JD=r(Ic);Ya=n(JD,"A",{href:!0,rel:!0});var GD=r(Ya);V2=i(GD,"Automatic Differentiation"),GD.forEach(t),JD.forEach(t),J2=d(Go),Lc=n(Go,"LI",{});var XD=r(Lc);Za=n(XD,"A",{href:!0,rel:!0});var YD=r(Za);G2=i(YD,"Vectorization"),YD.forEach(t),XD.forEach(t),X2=d(Go),Sc=n(Go,"LI",{});var ZD=r(Sc);ei=n(ZD,"A",{href:!0,rel:!0});var eF=r(ei);Y2=i(eF,"Parallelization"),eF.forEach(t),ZD.forEach(t),Go.forEach(t),Z2=d(mt),dt=n(mt,"DIV",{class:!0});var ns=r(dt);k(ti.$$.fragment,ns),ew=d(ns),Hs=n(ns,"P",{});var yl=r(Hs);tw=i(yl,"The "),Wc=n(yl,"CODE",{});var tF=r(Wc);sw=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),ow=i(yl,"forward method, overrides the "),Rc=n(yl,"CODE",{});var sF=r(Rc);nw=i(sF,"__call__"),sF.forEach(t),rw=i(yl," special method."),yl.forEach(t),aw=d(ns),k(Lo.$$.fragment,ns),iw=d(ns),Uc=n(ns,"P",{});var oF=r(Uc);lw=i(oF,"Example:"),oF.forEach(t),dw=d(ns),k(si.$$.fragment,ns),ns.forEach(t),mt.forEach(t),dh=d(s),Qs=n(s,"H2",{class:!0});var vu=r(Qs);So=n(vu,"A",{id:!0,class:!0,href:!0});var nF=r(So);Hc=n(nF,"SPAN",{});var rF=r(Hc);k(oi.$$.fragment,rF),rF.forEach(t),nF.forEach(t),cw=d(vu),Qc=n(vu,"SPAN",{});var aF=r(Qc);pw=i(aF,"FlaxDistilBertForQuestionAnswering"),aF.forEach(t),vu.forEach(t),ch=d(s),Ce=n(s,"DIV",{class:!0});var gt=r(Ce);k(ni.$$.fragment,gt),hw=d(gt),Ks=n(gt,"P",{});var $l=r(Ks);uw=i($l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
