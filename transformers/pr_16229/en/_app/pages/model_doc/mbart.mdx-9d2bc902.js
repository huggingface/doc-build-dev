...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Ma=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),mr=new q({props:{name:"__call__",anchor:"transformers.FlaxMBartForConditionalGeneration.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1202",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predictions).split()`}}),gr=new q({props:{name:"encode",anchor:"transformers.FlaxMBartForConditionalGeneration.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1026",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Br=new q({props:{name:"__call__",anchor:"transformers.FlaxMBartForSequenceClassification.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1202",parametersDescription:[{anchor:"transformers.FlaxMBartForSequenceClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Cr=new q({props:{name:"encode",anchor:"transformers.FlaxMBartForSequenceClassification.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1026",parametersDescription:[{anchor:"transformers.FlaxMBartForSequenceClassification.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),Pr=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForSequenceClassification.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1089",parametersDescription:[{anchor:"transformers.FlaxMBartForSequenceClassification.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16229/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ur=new q({props:{name:"__call__",anchor:"transformers.FlaxMBartForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1202",parametersDescription:[{anchor:"transformers.FlaxMBartForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16229/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16229/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),Vr=new q({props:{name:"encode",anchor:"transformers.FlaxMBartForQuestionAnswering.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1026",parametersDescription:[{anchor:"transformers.FlaxMBartForQuestionAnswering.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),Hr=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForQuestionAnswering.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16229/src/transformers/models/mbart/modeling_flax_mbart.py#L1089",parametersDescription:[{anchor:"transformers.FlaxMBartForQuestionAnswering.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16229/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16229/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16229/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lv=d(),zc=n("p"),Gv=r("Finally, this model supports inherent JAX features such as:"),Wv=d(),_t=n("ul"),qc=n("li"),cr=n("a"),Rv=r("Just-In-Time (JIT) compilation"),Uv=d(),Fc=n("li"),pr=n("a"),Xv=r("Automatic Differentiation"),Vv=d(),$c=n("li"),hr=n("a"),Qv=r("Vectorization"),Hv=d(),Bc=n("li"),ur=n("a"),Jv=r("Parallelization"),Kv=d(),te=n("div"),u(mr.$$.fragment),Zv=d(),$o=n("p"),Yv=r("The "),jc=n("code"),e2=r("FlaxMBartPreTrainedModel"),t2=r("forward method, overrides the "),Cc=n("code"),o2=r("__call__"),n2=r(" special method."),a2=d(),u(kn.$$.fragment),s2=d(),Ec=n("p"),r2=r("Summarization example:"),i2=d(),u(fr.$$.fragment),d2=d(),Pc=n("p"),l2=r("Mask filling example:"),c2=d(),u(_r.$$.fragment),p2=d(),zt=n("div"),u(gr.$$.fragment),h2=d(),Sc=n("p"),u2=r("Example:"),m2=d(),u(kr.$$.fragment),f2=d(),qt=n("div"),u(br.$$.fragment),_2=d(),Ac=n("p"),g2=r("Example:"),k2=d(),u(yr.$$.fragment),lh=d(),Bo=n("h2"),bn=n("a"),Oc=n("span"),u(vr.$$.fragment),b2=d(),Ic=n("span"),y2=r("FlaxMBartForSequenceClassification"),ch=d(),O=n("div"),u(Tr.$$.fragment),v2=d(),Nc=n("p"),T2=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),w2=d(),wr=n("p"),M2=r("This model inherits from "),Ei=n("a"),x2=r("FlaxPreTrainedModel"),z2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),q2=d(),Mr=n("p"),F2=r(`This model is also a Flax Linen
`),xr=n("a"),$2=r("flax.nn.Module"),B2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),j2=d(),Dc=n("p"),C2=r("Finally, this model supports inherent JAX features such as:"),E2=d(),gt=n("ul"),Lc=n("li"),zr=n("a"),P2=r("Just-In-Time (JIT) compilation"),S2=d(),Gc=n("li"),qr=n("a"),A2=r("Automatic Differentiation"),O2=d(),Wc=n("li"),Fr=n("a"),I2=r("Vectorization"),N2=d(),Rc=n("li"),$r=n("a"),D2=r("Parallelization"),L2=d(),De=n("div"),u(Br.$$.fragment),G2=d(),jo=n("p"),W2=r("The "),Uc=n("code"),R2=r("FlaxMBartPreTrainedModel"),U2=r("forward method, overrides the "),Xc=n("code"),X2=r("__call__"),V2=r(" special method."),Q2=d(),u(yn.$$.fragment),H2=d(),Vc=n("p"),J2=r("Example:"),K2=d(),u(jr.$$.fragment),Z2=d(),Ft=n("div"),u(Cr.$$.fragment),Y2=d(),Qc=n("p"),eT=r("Example:"),tT=d(),u(Er.$$.fragment),oT=d(),$t=n("div"),u(Pr.$$.fragment),nT=d(),Hc=n("p"),aT=r("Example:"),sT=d(),u(Sr.$$.fragment),ph=d(),Co=n("h2"),vn=n("a"),Jc=n("span"),u(Ar.$$.fragment),rT=d(),Kc=n("span"),iT=r("FlaxMBartForQuestionAnswering"),hh=d(),I=n("div"),u(Or.$$.fragment),dT=d(),Eo=n("p"),lT=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Zc=n("code"),cT=r("span start logits"),pT=r(" and "),Yc=n("code"),hT=r("span end logits"),uT=r(")."),mT=d(),Ir=n("p"),fT=r("This model inherits from "),Pi=n("a"),_T=r("FlaxPreTrainedModel"),gT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kT=d(),Nr=n("p"),bT=r(`This model is also a Flax Linen
`),Dr=n("a"),yT=r("flax.nn.Module"),vT=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),TT=d(),ep=n("p"),wT=r("Finally, this model supports inherent JAX features such as:"),MT=d(),kt=n("ul"),tp=n("li"),Lr=n("a"),xT=r("Just-In-Time (JIT) compilation"),zT=d(),op=n("li"),Gr=n("a"),qT=r("Automatic Differentiation"),FT=d(),np=n("li"),Wr=n("a"),$T=r("Vectorization"),BT=d(),ap=n("li"),Rr=n("a"),jT=r("Parallelization"),CT=d(),Le=n("div"),u(Ur.$$.fragment),ET=d(),Po=n("p"),PT=r("The "),sp=n("code"),ST=r("FlaxMBartPreTrainedModel"),AT=r("forward method, overrides the "),rp=n("code"),OT=r("__call__"),IT=r(" special method."),NT=d(),u(Tn.$$.fragment),DT=d(),ip=n("p"),LT=r("Example:"),GT=d(),u(Xr.$$.fragment),WT=d(),Bt=n("div"),u(Vr.$$.fragment),RT=d(),dp=n("p"),UT=r("Example:"),XT=d(),u(Qr.$$.fragment),VT=d(),jt=n("div"),u(Hr.$$.fragment),QT=d(),lp=n("p"),HT=r("Example:"),JT=d(),u(Jr.$$.fragment),this.h()},l(o){const p=Gz('[data-svelte="svelte-1phssyn"]',document.head);b=a(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(o),v=a(o,"H1",{class:!0});var Kr=s(v);M=a(Kr,"A",{id:!0,class:!0,href:!0});var cp=s(M);x=a(cp,"SPAN",{});var pp=s(x);m(T.$$.fragment,pp),pp.forEach(t),cp.forEach(t),y=l(Kr),F=a(Kr,"SPAN",{});var hp=s(F);rt=i(hp,"MBart and MBart-50"),hp.forEach(t),Kr.forEach(t),Ee=l(o),j=a(o,"P",{});var wn=s(j);Ue=a(wn,"STRONG",{});var up=s(Ue);ke=i(up,"DISCLAIMER:"),up.forEach(t),it=i(wn," If you see something strange, file a "),be=a(wn,"A",{href:!0,rel:!0});var mp=s(be);ye=i(mp,"Github Issue"),mp.forEach(t),dt=i(wn,` and assign
@patrickvonplaten`),wn.forEach(t),Ke=l(o),J=a(o,"H2",{class:!0});var Zr=s(J);N=a(Zr,"A",{id:!0,class:!0,href:!0});var fp=s(N);Xe=a(fp,"SPAN",{});var _p=s(Xe);m(se.$$.fragment,_p),_p.forEach(t),fp.forEach(t),E=l(Zr),A=a(Zr,"SPAN",{});var gp=s(A);lt=i(gp,"Overview of MBart"),gp.forEach(t),Zr.forEach(t),pe=l(o),he=a(o,"P",{});var Yr=s(he);ct=i(Yr,"The MBart model was presented in "),K=a(Yr,"A",{href:!0,rel:!0});var ZT=s(K);pt=i(ZT,"Multilingual Denoising Pre-training for Neural Machine Translation"),ZT.forEach(t),ht=i(Yr,` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
Ghazvininejad, Mike Lewis, Luke Zettlemoyer.`),Yr.forEach(t),D=l(o),Pe=a(o,"P",{});var YT=s(Pe);ve=i(YT,`According to the abstract, MBART is a sequence-to-sequence denoising auto-encoder pretrained on large-scale monolingual
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),YT.forEach(t),Ze=l(o),re=a(o,"P",{});var kp=s(re);Te=i(kp,"This model was contributed by "),we=a(kp,"A",{href:!0,rel:!0});var e1=s(we);ut=i(e1,"valhalla"),e1.forEach(t),ie=i(kp,". The Authors\u2019 code can be found "),Me=a(kp,"A",{href:!0,rel:!0});var t1=s(Me);xe=i(t1,"here"),t1.forEach(t),kp.forEach(t),Ye=l(o),w=a(o,"H3",{class:!0});var mh=s(w);B=a(mh,"A",{id:!0,class:!0,href:!0});var o1=s(B);ze=a(o1,"SPAN",{});var n1=s(ze);m(Ve.$$.fragment,n1),n1.forEach(t),o1.forEach(t),Ut=l(mh),Z=a(mh,"SPAN",{});var a1=s(Z);Xt=i(a1,"Training of MBart"),a1.forEach(t),mh.forEach(t),bt=l(o),V=a(o,"P",{});var Ct=s(V);de=i(Ct,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),le=a(Ct,"CODE",{});var s1=s(le);Vt=i(s1,"X [eos, src_lang_code]"),s1.forEach(t),Qt=i(Ct," where "),ce=a(Ct,"CODE",{});var r1=s(ce);Ht=i(r1,"X"),r1.forEach(t),Jt=i(Ct,` is the source text. The
target text format is `),Qe=a(Ct,"CODE",{});var i1=s(Qe);Kt=i(i1,"[tgt_lang_code] X [eos]"),i1.forEach(t),Su=i(Ct,". "),ld=a(Ct,"CODE",{});var d1=s(ld);Au=i(d1,"bos"),d1.forEach(t),Ou=i(Ct," is never used."),Ct.forEach(t),bp=l(o),yt=a(o,"P",{});var Si=s(yt);Iu=i(Si,"The regular "),Pn=a(Si,"A",{href:!0});var KT=s(Pn);cd=a(KT,"STRONG",{});var l1=s(cd);Nu=i(l1,"call"),l1.forEach(t),Du=i(KT,"()"),KT.forEach(t),Lu=i(Si,` will encode source text format, and it should be wrapped
inside the context manager `),ti=a(Si,"A",{href:!0});var c1=s(ti);Gu=i(c1,"as_target_tokenizer()"),c1.forEach(t),Wu=i(Si," to encode target text format."),Si.forEach(t),yp=l(o),oi=a(o,"UL",{});var p1=s(oi);pd=a(p1,"LI",{});var h1=s(pd);Ru=i(h1,"Supervised training"),h1.forEach(t),p1.forEach(t),vp=l(o),m(Sn.$$.fragment,o),Tp=l(o),ni=a(o,"UL",{});var u1=s(ni);An=a(u1,"LI",{});var fh=s(An);hd=a(fh,"P",{});var m1=s(hd);Uu=i(m1,"Generation"),m1.forEach(t),Xu=l(fh),Zt=a(fh,"P",{});var Ai=s(Zt);Vu=i(Ai,"While generating the target text set the "),ud=a(Ai,"CODE",{});var f1=s(ud);Qu=i(f1,"decoder_start_token_id"),f1.forEach(t),Hu=i(Ai,` to the target language id. The following
example shows how to translate English to Romanian using the `),md=a(Ai,"EM",{});var _1=s(md);Ju=i(_1,"facebook/mbart-large-en-ro"),_1.forEach(t),Ku=i(Ai," model."),Ai.forEach(t),fh.forEach(t),u1.forEach(t),wp=l(o),m(On.$$.fragment,o),Mp=l(o),Yt=a(o,"H2",{class:!0});var _h=s(Yt);So=a(_h,"A",{id:!0,class:!0,href:!0});var g1=s(So);fd=a(g1,"SPAN",{});var k1=s(fd);m(In.$$.fragment,k1),k1.forEach(t),g1.forEach(t),Zu=l(_h),_d=a(_h,"SPAN",{});var b1=s(_d);Yu=i(b1,"Overview of MBart-50"),b1.forEach(t),_h.forEach(t),xp=l(o),vt=a(o,"P",{});var Oi=s(vt);em=i(Oi,"MBart-50 was introduced in the "),Nn=a(Oi,"A",{href:!0,rel:!0});var y1=s(Nn);tm=i(y1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),y1.forEach(t),om=i(Oi,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),gd=a(Oi,"EM",{});var v1=s(gd);nm=i(v1,"mbart-large-cc25"),v1.forEach(t),am=i(Oi,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Oi.forEach(t),zp=l(o),ai=a(o,"P",{});var T1=s(ai);sm=i(T1,"According to the abstract"),T1.forEach(t),qp=l(o),si=a(o,"P",{});var w1=s(si);kd=a(w1,"EM",{});var M1=s(kd);rm=i(M1,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),M1.forEach(t),w1.forEach(t),Fp=l(o),eo=a(o,"H3",{class:!0});var gh=s(eo);Ao=a(gh,"A",{id:!0,class:!0,href:!0});var x1=s(Ao);bd=a(x1,"SPAN",{});var z1=s(bd);m(Dn.$$.fragment,z1),z1.forEach(t),x1.forEach(t),im=l(gh),yd=a(gh,"SPAN",{});var q1=s(yd);dm=i(q1,"Training of MBart-50"),q1.forEach(t),gh.forEach(t),$p=l(o),et=a(o,"P",{});var Mn=s(et);lm=i(Mn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),vd=a(Mn,"CODE",{});var F1=s(vd);cm=i(F1,"[lang_code] X [eos]"),F1.forEach(t),pm=i(Mn,", where "),Td=a(Mn,"CODE",{});var $1=s(Td);hm=i($1,"lang_code"),$1.forEach(t),um=i(Mn,` is source
language id for source text and target language id for target text, with `),wd=a(Mn,"CODE",{});var B1=s(wd);mm=i(B1,"X"),B1.forEach(t),fm=i(Mn,` being the source or target text
respectively.`),Mn.forEach(t),Bp=l(o),Oo=a(o,"P",{});var kh=s(Oo);_m=i(kh,"MBart-50 has its own tokenizer "),ri=a(kh,"A",{href:!0});var j1=s(ri);gm=i(j1,"MBart50Tokenizer"),j1.forEach(t),km=i(kh,"."),kh.forEach(t),jp=l(o),ii=a(o,"UL",{});var C1=s(ii);Md=a(C1,"LI",{});var E1=s(Md);bm=i(E1,"Supervised training"),E1.forEach(t),C1.forEach(t),Cp=l(o),m(Ln.$$.fragment,o),Ep=l(o),di=a(o,"UL",{});var P1=s(di);Gn=a(P1,"LI",{});var bh=s(Gn);xd=a(bh,"P",{});var S1=s(xd);ym=i(S1,"Generation"),S1.forEach(t),vm=l(bh),qe=a(bh,"P",{});var nt=s(qe);Tm=i(nt,"To generate using the mBART-50 multilingual translation models, "),zd=a(nt,"CODE",{});var A1=s(zd);wm=i(A1,"eos_token_id"),A1.forEach(t),Mm=i(nt,` is used as the
`),qd=a(nt,"CODE",{});var O1=s(qd);xm=i(O1,"decoder_start_token_id"),O1.forEach(t),zm=i(nt,` and the target language id is forced as the first generated token. To force the
target language id as the first generated token, pass the `),Fd=a(nt,"EM",{});var I1=s(Fd);qm=i(I1,"forced_bos_token_id"),I1.forEach(t),Fm=i(nt," parameter to the "),$d=a(nt,"EM",{});var N1=s($d);$m=i(N1,"generate"),N1.forEach(t),Bm=i(nt,` method.
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Bd=a(nt,"EM",{});var D1=s(Bd);jm=i(D1,"facebook/mbart-50-large-many-to-many"),D1.forEach(t),Cm=i(nt," checkpoint."),nt.forEach(t),bh.forEach(t),P1.forEach(t),Pp=l(o),m(Wn.$$.fragment,o),Sp=l(o),to=a(o,"H2",{class:!0});var yh=s(to);Io=a(yh,"A",{id:!0,class:!0,href:!0});var L1=s(Io);jd=a(L1,"SPAN",{});var G1=s(jd);m(Rn.$$.fragment,G1),G1.forEach(t),L1.forEach(t),Em=l(yh),Cd=a(yh,"SPAN",{});var W1=s(Cd);Pm=i(W1,"MBartConfig"),W1.forEach(t),yh.forEach(t),Ap=l(o),Fe=a(o,"DIV",{class:!0});var Et=s(Fe);m(Un.$$.fragment,Et),Sm=l(Et),oo=a(Et,"P",{});var Ii=s(oo);Am=i(Ii,"This is the configuration class to store the configuration of a "),li=a(Ii,"A",{href:!0});var R1=s(li);Om=i(R1,"MBartModel"),R1.forEach(t),Im=i(Ii,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Ii,"A",{href:!0,rel:!0});var U1=s(Xn);Nm=i(U1,"facebook/mbart-large-cc25"),U1.forEach(t),Dm=i(Ii," architecture."),Ii.forEach(t),Lm=l(Et),no=a(Et,"P",{});var Ni=s(no);Gm=i(Ni,"Configuration objects inherit from "),ci=a(Ni,"A",{href:!0});var X1=s(ci);Wm=i(X1,"PretrainedConfig"),X1.forEach(t),Rm=i(Ni,` and can be used to control the model outputs. Read the
documentation from `),pi=a(Ni,"A",{href:!0});var V1=s(pi);Um=i(V1,"PretrainedConfig"),V1.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Vm=l(Et),Ed=a(Et,"P",{});var Q1=s(Ed);Qm=i(Q1,"Example:"),Q1.forEach(t),Hm=l(Et),m(Vn.$$.fragment,Et),Et.forEach(t),Op=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var H1=s(No);Pd=a(H1,"SPAN",{});var J1=s(Pd);m(Qn.$$.fragment,J1),J1.forEach(t),H1.forEach(t),Jm=l(vh),Sd=a(vh,"SPAN",{});var K1=s(Sd);Km=i(K1,"MBartTokenizer"),K1.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Hn.$$.fragment,me),Zm=l(me),Ad=a(me,"P",{});var Z1=s(Ad);Ym=i(Z1,"Construct an MBART tokenizer."),Z1.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Y1=s(hi);of=i(Y1,"RobertaTokenizer"),Y1.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var ew=s(ui);af=i(ew,"XLNetTokenizer"),ew.forEach(t),sf=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var tw=s(Jn);rf=i(tw,"SentencePiece"),tw.forEach(t),df=i(xn,"."),xn.forEach(t),lf=l(me),Kn=a(me,"P",{});var Th=s(Kn);cf=i(Th,"The tokenization method is "),Od=a(Th,"CODE",{});var ow=s(Od);pf=i(ow,"<tokens> <eos> <language code>"),ow.forEach(t),hf=i(Th," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Th.forEach(t),uf=l(me),Id=a(me,"P",{});var nw=s(Id);mf=i(nw,"Examples:"),nw.forEach(t),ff=l(me),m(Zn.$$.fragment,me),_f=l(me),Do=a(me,"DIV",{class:!0});var wh=s(Do);m(Yn.$$.fragment,wh),gf=l(wh),Nd=a(wh,"P",{});var aw=s(Nd);kf=i(aw,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),aw.forEach(t),wh.forEach(t),bf=l(me),tt=a(me,"DIV",{class:!0});var zn=s(tt);m(ea.$$.fragment,zn),yf=l(zn),ta=a(zn,"P",{});var Mh=s(ta);vf=i(Mh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Dd=a(Mh,"CODE",{});var sw=s(Dd);Tf=i(sw,"X"),sw.forEach(t),wf=i(Mh," represents the sequence:"),Mh.forEach(t),Mf=l(zn),oa=a(zn,"UL",{});var xh=s(oa);na=a(xh,"LI",{});var zh=s(na);Ld=a(zh,"CODE",{});var rw=s(Ld);xf=i(rw,"input_ids"),rw.forEach(t),zf=i(zh," (for encoder) "),Gd=a(zh,"CODE",{});var iw=s(Gd);qf=i(iw,"X [eos, src_lang_code]"),iw.forEach(t),zh.forEach(t),Ff=l(xh),aa=a(xh,"LI",{});var qh=s(aa);Wd=a(qh,"CODE",{});var dw=s(Wd);$f=i(dw,"decoder_input_ids"),dw.forEach(t),Bf=i(qh,": (for decoder) "),Rd=a(qh,"CODE",{});var lw=s(Rd);jf=i(lw,"X [eos, tgt_lang_code]"),lw.forEach(t),qh.forEach(t),xh.forEach(t),Cf=l(zn),Ud=a(zn,"P",{});var cw=s(Ud);Ef=i(cw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),cw.forEach(t),zn.forEach(t),me.forEach(t),Np=l(o),so=a(o,"H2",{class:!0});var Fh=s(so);Lo=a(Fh,"A",{id:!0,class:!0,href:!0});var pw=s(Lo);Xd=a(pw,"SPAN",{});var hw=s(Xd);m(sa.$$.fragment,hw),hw.forEach(t),pw.forEach(t),Pf=l(Fh),Vd=a(Fh,"SPAN",{});var uw=s(Vd);Sf=i(uw,"MBartTokenizerFast"),uw.forEach(t),Fh.forEach(t),Dp=l(o),P=a(o,"DIV",{class:!0});var Q=s(P);m(ra.$$.fragment,Q),Af=l(Q),ro=a(Q,"P",{});var Di=s(ro);Of=i(Di,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Qd=a(Di,"EM",{});var mw=s(Qd);If=i(mw,"tokenizers"),mw.forEach(t),Nf=i(Di,` library). Based on
`),ia=a(Di,"A",{href:!0,rel:!0});var fw=s(ia);Df=i(fw,"BPE"),fw.forEach(t),Lf=i(Di,"."),Di.forEach(t),Gf=l(Q),Tt=a(Q,"P",{});var ei=s(Tt);mi=a(ei,"A",{href:!0});var _w=s(mi);Wf=i(_w,"MBartTokenizerFast"),_w.forEach(t),Rf=i(ei," is a subclass of "),fi=a(ei,"A",{href:!0});var gw=s(fi);Uf=i(gw,"XLMRobertaTokenizerFast"),gw.forEach(t),Xf=i(ei,`. Refer to superclass
`),_i=a(ei,"A",{href:!0});var kw=s(_i);Vf=i(kw,"XLMRobertaTokenizerFast"),kw.forEach(t),Qf=i(ei,` for usage examples and documentation concerning the initialization parameters and other
methods.`),ei.forEach(t),Hf=l(Q),da=a(Q,"P",{});var $h=s(da);Jf=i($h,"The tokenization method is "),Hd=a($h,"CODE",{});var bw=s(Hd);Kf=i(bw,"<tokens> <eos> <language code>"),bw.forEach(t),Zf=i($h," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$h.forEach(t),Yf=l(Q),Jd=a(Q,"P",{});var yw=s(Jd);e_=i(yw,"Examples:"),yw.forEach(t),t_=l(Q),m(la.$$.fragment,Q),o_=l(Q),Se=a(Q,"DIV",{class:!0});var Pt=s(Se);m(ca.$$.fragment,Pt),n_=l(Pt),Kd=a(Pt,"P",{});var vw=s(Kd);a_=i(vw,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),vw.forEach(t),s_=l(Pt),pa=a(Pt,"P",{});var Bh=s(pa);r_=i(Bh,"An MBART sequence has the following format, where "),Zd=a(Bh,"CODE",{});var Tw=s(Zd);i_=i(Tw,"X"),Tw.forEach(t),d_=i(Bh," represents the sequence:"),Bh.forEach(t),l_=l(Pt),ha=a(Pt,"UL",{});var jh=s(ha);ua=a(jh,"LI",{});var Ch=s(ua);Yd=a(Ch,"CODE",{});var ww=s(Yd);c_=i(ww,"input_ids"),ww.forEach(t),p_=i(Ch," (for encoder) "),el=a(Ch,"CODE",{});var Mw=s(el);h_=i(Mw,"X [eos, src_lang_code]"),Mw.forEach(t),Ch.forEach(t),u_=l(jh),ma=a(jh,"LI",{});var Eh=s(ma);tl=a(Eh,"CODE",{});var xw=s(tl);m_=i(xw,"decoder_input_ids"),xw.forEach(t),f_=i(Eh,": (for decoder) "),ol=a(Eh,"CODE",{});var zw=s(ol);__=i(zw,"X [eos, tgt_lang_code]"),zw.forEach(t),Eh.forEach(t),jh.forEach(t),g_=l(Pt),nl=a(Pt,"P",{});var qw=s(nl);k_=i(qw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),qw.forEach(t),Pt.forEach(t),b_=l(Q),Go=a(Q,"DIV",{class:!0});var Ph=s(Go);m(fa.$$.fragment,Ph),y_=l(Ph),al=a(Ph,"P",{});var Fw=s(al);v_=i(Fw,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),Fw.forEach(t),Ph.forEach(t),T_=l(Q),Wo=a(Q,"DIV",{class:!0});var Sh=s(Wo);m(_a.$$.fragment,Sh),w_=l(Sh),sl=a(Sh,"P",{});var $w=s(sl);M_=i($w,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$w.forEach(t),Sh.forEach(t),x_=l(Q),Ro=a(Q,"DIV",{class:!0});var Ah=s(Ro);m(ga.$$.fragment,Ah),z_=l(Ah),rl=a(Ah,"P",{});var Bw=s(rl);q_=i(Bw,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),Bw.forEach(t),Ah.forEach(t),Q.forEach(t),Lp=l(o),io=a(o,"H2",{class:!0});var Oh=s(io);Uo=a(Oh,"A",{id:!0,class:!0,href:!0});var jw=s(Uo);il=a(jw,"SPAN",{});var Cw=s(il);m(ka.$$.fragment,Cw),Cw.forEach(t),jw.forEach(t),F_=l(Oh),dl=a(Oh,"SPAN",{});var Ew=s(dl);$_=i(Ew,"MBart50Tokenizer"),Ew.forEach(t),Oh.forEach(t),Gp=l(o),S=a(o,"DIV",{class:!0});var H=s(S);m(ba.$$.fragment,H),B_=l(H),ya=a(H,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var Pw=s(va);C_=i(Pw,"SentencePiece"),Pw.forEach(t),E_=i(Ih,"."),Ih.forEach(t),P_=l(H),Ta=a(H,"P",{});var Nh=s(Ta);S_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var Sw=s(gi);A_=i(Sw,"PreTrainedTokenizer"),Sw.forEach(t),O_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(H),ll=a(H,"P",{});var Aw=s(ll);N_=i(Aw,"Examples:"),Aw.forEach(t),D_=l(H),m(wa.$$.fragment,H),L_=l(H),ot=a(H,"DIV",{class:!0});var qn=s(ot);m(Ma.$$.fragment,qn),G_=l(qn),xa=a(qn,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=a(Dh,"CODE",{});var Ow=s(cl);R_=i(Ow,"X"),Ow.forEach(t),U_=i(Dh," represents the sequence:"),Dh.forEach(t),X_=l(qn),za=a(qn,"UL",{});var Lh=s(za);qa=a(Lh,"LI",{});var Gh=s(qa);pl=a(Gh,"CODE",{});var Iw=s(pl);V_=i(Iw,"input_ids"),Iw.forEach(t),Q_=i(Gh," (for encoder) "),hl=a(Gh,"CODE",{});var Nw=s(hl);H_=i(Nw,"[src_lang_code] X [eos]"),Nw.forEach(t),Gh.forEach(t),J_=l(Lh),Fa=a(Lh,"LI",{});var Wh=s(Fa);ul=a(Wh,"CODE",{});var Dw=s(ul);K_=i(Dw,"labels"),Dw.forEach(t),Z_=i(Wh,": (for decoder) "),ml=a(Wh,"CODE",{});var Lw=s(ml);Y_=i(Lw,"[tgt_lang_code] X [eos]"),Lw.forEach(t),Wh.forEach(t),Lh.forEach(t),eg=l(qn),fl=a(qn,"P",{});var Gw=s(fl);tg=i(Gw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Gw.forEach(t),qn.forEach(t),og=l(H),Xo=a(H,"DIV",{class:!0});var Rh=s(Xo);m($a.$$.fragment,Rh),ng=l(Rh),_l=a(Rh,"P",{});var Ww=s(_l);ag=i(Ww,"Converts a sequence of tokens (strings for sub-words) in a single string."),Ww.forEach(t),Rh.forEach(t),sg=l(H),Vo=a(H,"DIV",{class:!0});var Uh=s(Vo);m(Ba.$$.fragment,Uh),rg=l(Uh),ja=a(Uh,"P",{});var Xh=s(ja);ig=i(Xh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),gl=a(Xh,"CODE",{});var Rw=s(gl);dg=i(Rw,"prepare_for_model"),Rw.forEach(t),lg=i(Xh," method."),Xh.forEach(t),Uh.forEach(t),cg=l(H),Qo=a(H,"DIV",{class:!0});var Vh=s(Qo);m(Ca.$$.fragment,Vh),pg=l(Vh),kl=a(Vh,"P",{});var Uw=s(kl);hg=i(Uw,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),Uw.forEach(t),Vh.forEach(t),ug=l(H),Ho=a(H,"DIV",{class:!0});var Qh=s(Ho);m(Ea.$$.fragment,Qh),mg=l(Qh),bl=a(Qh,"P",{});var Xw=s(bl);fg=i(Xw,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),Xw.forEach(t),Qh.forEach(t),H.forEach(t),Wp=l(o),lo=a(o,"H2",{class:!0});var Hh=s(lo);Jo=a(Hh,"A",{id:!0,class:!0,href:!0});var Vw=s(Jo);yl=a(Vw,"SPAN",{});var Qw=s(yl);m(Pa.$$.fragment,Qw),Qw.forEach(t),Vw.forEach(t),_g=l(Hh),vl=a(Hh,"SPAN",{});var Hw=s(vl);gg=i(Hw,"MBart50TokenizerFast"),Hw.forEach(t),Hh.forEach(t),Rp=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);m(Sa.$$.fragment,fe),kg=l(fe),co=a(fe,"P",{});var Li=s(co);bg=i(Li,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=a(Li,"EM",{});var Jw=s(Tl);yg=i(Jw,"tokenizers"),Jw.forEach(t),vg=i(Li,` library). Based on
`),Aa=a(Li,"A",{href:!0,rel:!0});var Kw=s(Aa);Tg=i(Kw,"BPE"),Kw.forEach(t),wg=i(Li,"."),Li.forEach(t),Mg=l(fe),Oa=a(fe,"P",{});var Jh=s(Oa);xg=i(Jh,"This tokenizer inherits from "),ki=a(Jh,"A",{href:!0});var Zw=s(ki);zg=i(Zw,"PreTrainedTokenizerFast"),Zw.forEach(t),qg=i(Jh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Fg=l(fe),wl=a(fe,"P",{});var Yw=s(wl);$g=i(Yw,"Examples:"),Yw.forEach(t),Bg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Cg=l(St),Ml=a(St,"P",{});var eM=s(Ml);Eg=i(eM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),eM.forEach(t),Pg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var tM=s(xl);Ag=i(tM,"X"),tM.forEach(t),Og=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var oM=s(zl);Ng=i(oM,"input_ids"),oM.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var nM=s(ql);Lg=i(nM,"[src_lang_code] X [eos]"),nM.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Fl=a(eu,"CODE",{});var aM=s(Fl);Wg=i(aM,"labels"),aM.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var sM=s($l);Ug=i(sM,"[tgt_lang_code] X [eos]"),sM.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Bl=a(St,"P",{});var rM=s(Bl);Vg=i(rM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),rM.forEach(t),St.forEach(t),Qg=l(fe),Ko=a(fe,"DIV",{class:!0});var tu=s(Ko);m(Ra.$$.fragment,tu),Hg=l(tu),jl=a(tu,"P",{});var iM=s(jl);Jg=i(iM,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),iM.forEach(t),tu.forEach(t),Kg=l(fe),Zo=a(fe,"DIV",{class:!0});var ou=s(Zo);m(Ua.$$.fragment,ou),Zg=l(ou),Cl=a(ou,"P",{});var dM=s(Cl);Yg=i(dM,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),dM.forEach(t),ou.forEach(t),fe.forEach(t),Up=l(o),po=a(o,"H2",{class:!0});var nu=s(po);Yo=a(nu,"A",{id:!0,class:!0,href:!0});var lM=s(Yo);El=a(lM,"SPAN",{});var cM=s(El);m(Xa.$$.fragment,cM),cM.forEach(t),lM.forEach(t),ek=l(nu),Pl=a(nu,"SPAN",{});var pM=s(Pl);tk=i(pM,"MBartModel"),pM.forEach(t),nu.forEach(t),Xp=l(o),He=a(o,"DIV",{class:!0});var Fn=s(He);m(Va.$$.fragment,Fn),ok=l(Fn),Qa=a(Fn,"P",{});var au=s(Qa);nk=i(au,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),bi=a(au,"A",{href:!0});var hM=s(bi);ak=i(hM,"PreTrainedModel"),hM.forEach(t),sk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),rk=l(Fn),Ha=a(Fn,"P",{});var su=s(Ha);ik=i(su,"This model is also a PyTorch "),Ja=a(su,"A",{href:!0,rel:!0});var uM=s(Ja);dk=i(uM,"torch.nn.Module"),uM.forEach(t),lk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Fn),Oe=a(Fn,"DIV",{class:!0});var At=s(Oe);m(Ka.$$.fragment,At),pk=l(At),ho=a(At,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var mM=s(yi);uk=i(mM,"MBartModel"),mM.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var fM=s(Sl);fk=i(fM,"__call__"),fM.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(At),m(en.$$.fragment,At),kk=l(At),Al=a(At,"P",{});var _M=s(Al);bk=i(_M,"Example:"),_M.forEach(t),yk=l(At),m(Za.$$.fragment,At),At.forEach(t),Fn.forEach(t),Vp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var gM=s(tn);Ol=a(gM,"SPAN",{});var kM=s(Ol);m(Ya.$$.fragment,kM),kM.forEach(t),gM.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var bM=s(Il);Tk=i(bM,"MBartForConditionalGeneration"),bM.forEach(t),ru.forEach(t),Qp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),wk=l($n),ts=a($n,"P",{});var iu=s(ts);Mk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),vi=a(iu,"A",{href:!0});var yM=s(vi);xk=i(yM,"PreTrainedModel"),yM.forEach(t),zk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),qk=l($n),os=a($n,"P",{});var du=s(os);Fk=i(du,"This model is also a PyTorch "),ns=a(du,"A",{href:!0,rel:!0});var vM=s(ns);$k=i(vM,"torch.nn.Module"),vM.forEach(t),Bk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ck=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Ek=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var TM=s(Ti);Pk=i(TM,"MBartForConditionalGeneration"),TM.forEach(t),Sk=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var wM=s(Nl);Ak=i(wM,"__call__"),wM.forEach(t),Ok=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var MM=s(Dl);Dk=i(MM,"Translation example:"),MM.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var xM=s(Ll);Wk=i(xM,"Mask filling example:"),xM.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Hp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var zM=s(nn);Gl=a(zM,"SPAN",{});var qM=s(Gl);m(is.$$.fragment,qM),qM.forEach(t),zM.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var FM=s(Wl);Xk=i(FM,"MBartForQuestionAnswering"),FM.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);m(ds.$$.fragment,Ot),Vk=l(Ot),_o=a(Ot,"P",{});var Ri=s(_o);Qk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $M=s(Rl);Hk=i($M,"span start logits"),$M.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var BM=s(Ul);Kk=i(BM,"span end logits"),BM.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(Ot),ls=a(Ot,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),wi=a(cu,"A",{href:!0});var jM=s(wi);tb=i(jM,"PreTrainedModel"),jM.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(Ot),cs=a(Ot,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var CM=s(ps);sb=i(CM,"torch.nn.Module"),CM.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(Ot),ue=a(Ot,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),Mi=a(Ui,"A",{href:!0});var EM=s(Mi);cb=i(EM,"MBartForQuestionAnswering"),EM.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var PM=s(Xl);hb=i(PM,"__call__"),PM.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Vl=a(at,"P",{});var SM=s(Vl);_b=i(SM,"Example:"),SM.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),Ot.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var AM=s(sn);Ql=a(AM,"SPAN",{});var OM=s(Ql);m(fs.$$.fragment,OM),OM.forEach(t),AM.forEach(t),bb=l(hu),Hl=a(hu,"SPAN",{});var IM=s(Hl);yb=i(IM,"MBartForSequenceClassification"),IM.forEach(t),hu.forEach(t),Zp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var NM=s(Jl);Tb=i(NM,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),NM.forEach(t),wb=l(It),gs=a(It,"P",{});var uu=s(gs);Mb=i(uu,"This model inherits from "),xi=a(uu,"A",{href:!0});var DM=s(xi);xb=i(DM,"PreTrainedModel"),DM.forEach(t),zb=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),qb=l(It),ks=a(It,"P",{});var mu=s(ks);Fb=i(mu,"This model is also a PyTorch "),bs=a(mu,"A",{href:!0,rel:!0});var LM=s(bs);$b=i(LM,"torch.nn.Module"),LM.forEach(t),Bb=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),jb=l(It),L=a(It,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Cb=l(oe),bo=a(oe,"P",{});var Xi=s(bo);Eb=i(Xi,"The "),zi=a(Xi,"A",{href:!0});var GM=s(zi);Pb=i(GM,"MBartForSequenceClassification"),GM.forEach(t),Sb=i(Xi," forward method, overrides the "),Kl=a(Xi,"CODE",{});var WM=s(Kl);Ab=i(WM,"__call__"),WM.forEach(t),Ob=i(Xi," special method."),Xi.forEach(t),Ib=l(oe),m(rn.$$.fragment,oe),Nb=l(oe),Zl=a(oe,"P",{});var RM=s(Zl);Db=i(RM,"Example of single-label classification:"),RM.forEach(t),Lb=l(oe),m(vs.$$.fragment,oe),Gb=l(oe),m(Ts.$$.fragment,oe),Wb=l(oe),Yl=a(oe,"P",{});var UM=s(Yl);Rb=i(UM,"Example of multi-label classification:"),UM.forEach(t),Ub=l(oe),m(ws.$$.fragment,oe),Xb=l(oe),m(Ms.$$.fragment,oe),oe.forEach(t),It.forEach(t),Yp=l(o),yo=a(o,"H2",{class:!0});var fu=s(yo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var XM=s(dn);ec=a(XM,"SPAN",{});var VM=s(ec);m(xs.$$.fragment,VM),VM.forEach(t),XM.forEach(t),Vb=l(fu),tc=a(fu,"SPAN",{});var QM=s(tc);Qb=i(QM,"MBartForCausalLM"),QM.forEach(t),fu.forEach(t),eh=l(o),vo=a(o,"DIV",{class:!0});var _u=s(vo);m(zs.$$.fragment,_u),Hb=l(_u),wt=a(_u,"DIV",{class:!0});var Vi=s(wt);m(qs.$$.fragment,Vi),Jb=l(Vi),oc=a(Vi,"P",{});var HM=s(oc);Kb=i(HM,"Example:"),HM.forEach(t),Zb=l(Vi),m(Fs.$$.fragment,Vi),Vi.forEach(t),_u.forEach(t),th=l(o),To=a(o,"H2",{class:!0});var gu=s(To);ln=a(gu,"A",{id:!0,class:!0,href:!0});var JM=s(ln);nc=a(JM,"SPAN",{});var KM=s(nc);m($s.$$.fragment,KM),KM.forEach(t),JM.forEach(t),Yb=l(gu),ac=a(gu,"SPAN",{});var ZM=s(ac);ey=i(ZM,"TFMBartModel"),ZM.forEach(t),gu.forEach(t),oh=l(o),je=a(o,"DIV",{class:!0});var Nt=s(je);m(Bs.$$.fragment,Nt),ty=l(Nt),js=a(Nt,"P",{});var ku=s(js);oy=i(ku,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(ku,"A",{href:!0});var YM=s(qi);ny=i(YM,"TFPreTrainedModel"),YM.forEach(t),ay=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
