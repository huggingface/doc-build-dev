import{S as rc,i as ac,s as sc,e as r,k as c,w as u,t,L as dc,c as a,d as o,m as l,a as s,x as g,h as n,b as i,J as e,g as w,y as _,q as v,o as b,B as T}from"../../chunks/vendor-9e2b328e.js";import{T as Vd}from"../../chunks/Tip-76f97a76.js";import{D as B}from"../../chunks/Docstring-50fd6873.js";import{C as yo}from"../../chunks/CodeBlock-88e23343.js";import{I as Jt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function ic(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(j,"CODE",{});var C=s(m);M=n(C,"Module"),C.forEach(o),F=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function cc(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(j,"CODE",{});var C=s(m);M=n(C,"Module"),C.forEach(o),F=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function lc(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(j,"CODE",{});var C=s(m);M=n(C,"Module"),C.forEach(o),F=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function pc(Q){let p,P,m,M,F,y,j,C,Vn,Yt,f,$n,Eo,qn,zn,rt,Pn,Fn,ko,Cn,An,xo,In,Sn,jo,Ln,Nn,Do,On,Rn,at,Bn,Gn,Mo,Wn,Un,Vo,Hn,Zn,$o,Jn,Yn,qo,Kn,Qn,Kt,he,Xn,xe,er,or,Qt,G,tr,zo,nr,rr,Po,ar,sr,Xt,X,me,st,je,dr,dt,ir,en,z,De,cr,fe,Fo,lr,pr,Co,hr,mr,fr,ee,ur,Ao,gr,_r,Io,vr,br,Tr,it,wr,yr,Me,Er,ue,Ve,kr,$e,xr,So,jr,Dr,Mr,ge,qe,Vr,oe,$r,ct,qr,zr,lt,Pr,Fr,on,te,_e,pt,ze,Cr,ht,Ar,tn,E,Pe,Ir,ne,Sr,mt,Lr,Nr,ft,Or,Rr,Br,Fe,Gr,Ce,Wr,Ur,Hr,Ae,Zr,Ie,Jr,Yr,Kr,ut,Qr,Xr,Se,ea,Lo,oa,ta,na,Le,ra,Ne,aa,sa,da,W,No,ia,ca,gt,la,pa,_t,ha,ma,fa,A,Oe,ua,re,ga,Oo,_a,va,vt,ba,Ta,wa,ve,ya,bt,Ea,ka,Re,xa,I,Be,ja,Tt,Da,Ma,ae,Va,wt,$a,qa,yt,za,Pa,Fa,Et,Ca,Aa,Ge,nn,se,be,kt,We,Ia,xt,Sa,rn,k,Ue,La,de,Na,jt,Oa,Ra,Dt,Ba,Ga,Wa,He,Ua,Ze,Ha,Za,Ja,Je,Ya,Ye,Ka,Qa,Xa,Mt,es,os,Ke,ts,Ro,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Bo,ls,ps,Vt,hs,ms,$t,fs,us,gs,S,eo,_s,ie,vs,Go,bs,Ts,qt,ws,ys,Es,Te,ks,zt,xs,js,oo,Ds,O,to,Ms,Pt,Vs,$s,Ft,qs,zs,no,an,ce,we,Ct,ro,Ps,At,Fs,sn,x,ao,Cs,le,As,It,Is,Ss,St,Ls,Ns,Os,so,Rs,io,Bs,Gs,Ws,co,Us,lo,Hs,Zs,Js,Lt,Ys,Ks,po,Qs,Wo,Xs,ed,od,ho,td,mo,nd,rd,ad,H,Uo,sd,dd,Nt,id,cd,Ot,ld,pd,hd,L,fo,md,pe,fd,Ho,ud,gd,Rt,_d,vd,bd,ye,Td,Bt,wd,yd,uo,Ed,R,go,kd,Gt,xd,jd,Wt,Dd,Md,_o,dn;return y=new Jt({}),je=new Jt({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_15818/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_15818/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}]}}),Me=new yo({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_15818/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"
>VisionEncoderDecoderConfig</a></p>
`}}),qe=new B({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L110",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, any]</code></p>
`}}),ze=new Jt({}),Pe=new B({props:{name:"class transformers.VisionEncoderDecoderModel",anchor:"transformers.VisionEncoderDecoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"decoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L149",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15818/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15818/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oe=new B({props:{name:"forward",anchor:"transformers.VisionEncoderDecoderModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L401",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15818/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15818/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15818/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),ve=new Vd({props:{$$slots:{default:[ic]},$$scope:{ctx:Q}}}),Re=new yo({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests
...
<a href="/docs/transformers/pr_15818/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Ge=new yo({props:{code:`from transformers import VisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),We=new Jt({}),Ue=new B({props:{name:"class transformers.TFVisionEncoderDecoderModel",anchor:"transformers.TFVisionEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L176",parametersDescription:[{anchor:"transformers.TFVisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15818/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15818/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),eo=new B({props:{name:"call",anchor:"transformers.TFVisionEncoderDecoderModel.call",parameters:[{name:"pixel_values",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L513",parametersDescription:[{anchor:"transformers.TFVisionEncoderDecoderModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_15818/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),Te=new Vd({props:{$$slots:{default:[cc]},$$scope:{ctx:Q}}}),oo=new yo({props:{code:`from transformers import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
from PIL import Image
import requests
...
example is <code>google/vit-base-patch16-224-in21k</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15818/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),ro=new Jt({}),ao=new B({props:{name:"class transformers.FlaxVisionEncoderDecoderModel",anchor:"transformers.FlaxVisionEncoderDecoderModel",parameters:[{name:"config",val:": VisionEncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15818/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L268",parametersDescription:[{anchor:"transformers.FlaxVisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15818/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p>A <a
  href="/docs/transformers/pr_15818/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),ye=new Vd({props:{$$slots:{default:[lc]},$$scope:{ctx:Q}}}),uo=new yo({props:{code:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){p=r("meta"),P=c(),m=r("h1"),M=r("a"),F=r("span"),u(y.$$.fragment),j=c(),C=r("span"),Vn=t("Vision Encoder Decoder Models"),Yt=c(),f=r("p"),$n=t("The "),Eo=r("a"),qn=t("VisionEncoderDecoderModel"),zn=t(` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),rt=r("em"),Pn=t("e.g."),Fn=c(),ko=r("a"),Cn=t("ViT"),An=t(", "),xo=r("a"),In=t("BEiT"),Sn=t(", "),jo=r("a"),Ln=t("DeiT"),Nn=t(", "),Do=r("a"),On=t("Swin"),Rn=t(`)
and any pretrained language model as the decoder (`),at=r("em"),Bn=t("e.g."),Gn=c(),Mo=r("a"),Wn=t("RoBERTa"),Un=t(", "),Vo=r("a"),Hn=t("GPT2"),Zn=t(", "),$o=r("a"),Jn=t("BERT"),Yn=t(", "),qo=r("a"),Kn=t("DistilBERT"),Qn=t(")."),Kt=c(),he=r("p"),Xn=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
specified arguments, defining the encoder and decoder configs.`),fr=c(),ee=r("p"),ur=t("Configuration objects inherit from "),Ao=r("a"),gr=t("PretrainedConfig"),_r=t(` and can be used to control the model outputs. Read the
documentation from `),Io=r("a"),vr=t("PretrainedConfig"),br=t(" for more information."),Tr=c(),it=r("p"),wr=t("Examples:"),yr=c(),u(Me.$$.fragment),Er=c(),ue=r("div"),u(Ve.$$.fragment),kr=c(),$e=r("p"),xr=t("Instantiate a "),So=r("a"),jr=t("VisionEncoderDecoderConfig"),Dr=t(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),Mr=c(),ge=r("div"),u(qe.$$.fragment),Vr=c(),oe=r("p"),$r=t("Serializes this instance to a Python dictionary. Override the default "),ct=r("em"),qr=t("to_dict()"),zr=t(" from "),lt=r("em"),Pr=t("PretrainedConfig"),Fr=t("."),on=c(),te=r("h2"),_e=r("a"),pt=r("span"),u(ze.$$.fragment),Cr=c(),ht=r("span"),Ar=t("VisionEncoderDecoderModel"),tn=c(),E=r("div"),u(Pe.$$.fragment),Ir=c(),ne=r("p"),Sr=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),mt=r("code"),Lr=t("from_pretrained()"),Nr=t("function and the decoder is loaded via "),ft=r("code"),Or=t("from_pretrained()"),Rr=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),Br=c(),Fe=r("p"),Gr=t(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Hr=c(),Ae=r("p"),Zr=t("Additionally, in "),Ie=r("a"),Jr=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Yr=t(` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),Kr=c(),ut=r("p"),Qr=t(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Xr=c(),Se=r("p"),ea=t("This model inherits from "),Lo=r("a"),oa=t("PreTrainedModel"),ta=t(`. Check the superclass documentation for the generic methods the
...
and behavior.`),da=c(),W=r("p"),No=r("a"),ia=t("VisionEncoderDecoderModel"),ca=t(` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
:meth`),gt=r("em"),la=t("~transformers.AutoModel.from_pretrained"),pa=t(` class method for the encoder and
:meth`),_t=r("em"),ha=t("~transformers.AutoModelForCausalLM.from_pretrained"),ma=t(" class method for the decoder."),fa=c(),A=r("div"),u(Oe.$$.fragment),ua=c(),re=r("p"),ga=t("The "),Oo=r("a"),_a=t("VisionEncoderDecoderModel"),va=t(" forward method, overrides the "),vt=r("code"),ba=t("__call__"),Ta=t(" special method."),wa=c(),u(ve.$$.fragment),ya=c(),bt=r("p"),Ea=t("Examples:"),ka=c(),u(Re.$$.fragment),xa=c(),I=r("div"),u(Be.$$.fragment),ja=c(),Tt=r("p"),Da=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Ma=c(),ae=r("p"),Va=t("The model is set in evaluation mode by default using "),wt=r("code"),$a=t("model.eval()"),qa=t(` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),yt=r("code"),za=t("model.train()"),Pa=t("."),Fa=c(),Et=r("p"),Ca=t("Example:"),Aa=c(),u(Ge.$$.fragment),nn=c(),se=r("h2"),be=r("a"),kt=r("span"),u(We.$$.fragment),Ia=c(),xt=r("span"),Sa=t("TFVisionEncoderDecoderModel"),rn=c(),k=r("div"),u(Ue.$$.fragment),La=c(),de=r("p"),Na=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),jt=r("code"),Oa=t("from_pretrained()"),Ra=t("function and the decoder is loaded via "),Dt=r("code"),Ba=t("from_pretrained()"),Ga=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),Ja=c(),Je=r("p"),Ya=t("Additionally, in "),Ye=r("a"),Ka=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Qa=t(` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),Xa=c(),Mt=r("p"),es=t(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),os=c(),Ke=r("p"),ts=t("This model inherits from "),Ro=r("a"),ns=t("TFPreTrainedModel"),rs=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),as=c(),Qe=r("p"),ss=t("This model is also a "),Xe=r("a"),ds=t("tf.keras.Model"),is=t(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cs=c(),U=r("p"),Bo=r("a"),ls=t("TFVisionEncoderDecoderModel"),ps=t(` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Vt=r("code"),hs=t("from_pretrained()"),ms=t(`class method for the encoder and
`),$t=r("code"),fs=t("from_pretrained()"),us=t("class method for the decoder."),gs=c(),S=r("div"),u(eo.$$.fragment),_s=c(),ie=r("p"),vs=t("The "),Go=r("a"),bs=t("TFVisionEncoderDecoderModel"),Ts=t(" forward method, overrides the "),qt=r("code"),ws=t("__call__"),ys=t(" special method."),Es=c(),u(Te.$$.fragment),ks=c(),zt=r("p"),xs=t("Examples:"),js=c(),u(oo.$$.fragment),Ds=c(),O=r("div"),u(to.$$.fragment),Ms=c(),Pt=r("p"),Vs=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),$s=c(),Ft=r("p"),qs=t("Example:"),zs=c(),u(no.$$.fragment),an=c(),ce=r("h2"),we=r("a"),Ct=r("span"),u(ro.$$.fragment),Ps=c(),At=r("span"),Fs=t("FlaxVisionEncoderDecoderModel"),sn=c(),x=r("div"),u(ao.$$.fragment),Cs=c(),le=r("p"),As=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),It=r("code"),Is=t("from_pretrained()"),Ss=t("function and the decoder is loaded via "),St=r("code"),Ls=t("from_pretrained()"),Ns=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
character recognition (OCR) yields a significant performance improvement.`),Js=c(),Lt=r("p"),Ys=t(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Ks=c(),po=r("p"),Qs=t("This model inherits from "),Wo=r("a"),Xs=t("FlaxPreTrainedModel"),ed=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),od=c(),ho=r("p"),td=t(`This model is also a Flax Linen
`),mo=r("a"),nd=t("flax.nn.Module"),rd=t(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ad=c(),H=r("p"),Uo=r("a"),sd=t("FlaxVisionEncoderDecoderModel"),dd=t(` is a generic model class that will be instantiated as a transformer architecture
...
for the encoder and :meth`),Ot=r("em"),ld=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),pd=t(" class method for the decoder."),hd=c(),L=r("div"),u(fo.$$.fragment),md=c(),pe=r("p"),fd=t("The "),Ho=r("a"),ud=t("FlaxVisionEncoderDecoderModel"),gd=t(" forward method, overrides the "),Rt=r("code"),_d=t("__call__"),vd=t(" special method."),bd=c(),u(ye.$$.fragment),Td=c(),Bt=r("p"),wd=t("Examples:"),yd=c(),u(uo.$$.fragment),Ed=c(),R=r("div"),u(go.$$.fragment),kd=c(),Gt=r("p"),xd=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),jd=c(),Wt=r("p"),Dd=t("Example:"),Md=c(),u(_o.$$.fragment),this.h()},l(d){const h=dc('[data-svelte="svelte-1phssyn"]',document.head);p=a(h,"META",{name:!0,content:!0}),h.forEach(o),P=l(d),m=a(d,"H1",{class:!0});var vo=s(m);M=a(vo,"A",{id:!0,class:!0,href:!0});var Ut=s(M);F=a(Ut,"SPAN",{});var Ht=s(F);g(y.$$.fragment,Ht),Ht.forEach(o),Ut.forEach(o),j=l(vo),C=a(vo,"SPAN",{});var $d=s(C);Vn=n($d,"Vision Encoder Decoder Models"),$d.forEach(o),vo.forEach(o),Yt=l(d),f=a(d,"P",{});var D=s(f);$n=n(D,"The "),Eo=a(D,"A",{href:!0});var qd=s(Eo);qn=n(qd,"VisionEncoderDecoderModel"),qd.forEach(o),zn=n(D,` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),rt=a(D,"EM",{});var zd=s(rt);Pn=n(zd,"e.g."),zd.forEach(o),Fn=l(D),ko=a(D,"A",{href:!0});var Pd=s(ko);Cn=n(Pd,"ViT"),Pd.forEach(o),An=n(D,", "),xo=a(D,"A",{href:!0});var Fd=s(xo);In=n(Fd,"BEiT"),Fd.forEach(o),Sn=n(D,", "),jo=a(D,"A",{href:!0});var Cd=s(jo);Ln=n(Cd,"DeiT"),Cd.forEach(o),Nn=n(D,", "),Do=a(D,"A",{href:!0});var Ad=s(Do);On=n(Ad,"Swin"),Ad.forEach(o),Rn=n(D,`)
and any pretrained language model as the decoder (`),at=a(D,"EM",{});var Id=s(at);Bn=n(Id,"e.g."),Id.forEach(o),Gn=l(D),Mo=a(D,"A",{href:!0});var Sd=s(Mo);Wn=n(Sd,"RoBERTa"),Sd.forEach(o),Un=n(D,", "),Vo=a(D,"A",{href:!0});var Ld=s(Vo);Hn=n(Ld,"GPT2"),Ld.forEach(o),Zn=n(D,", "),$o=a(D,"A",{href:!0});var Nd=s($o);Jn=n(Nd,"BERT"),Nd.forEach(o),Yn=n(D,", "),qo=a(D,"A",{href:!0});var Od=s(qo);Kn=n(Od,"DistilBERT"),Od.forEach(o),Qn=n(D,")."),D.forEach(o),Kt=l(d),he=a(d,"P",{});var cn=s(he);Xn=n(cn,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
Zhoujun Li, Furu Wei.`),cn.forEach(o),Qt=l(d),G=a(d,"P",{});var Zo=s(G);tr=n(Zo,"An example of how to use a "),zo=a(Zo,"A",{href:!0});var Bd=s(zo);nr=n(Bd,"VisionEncoderDecoderModel"),Bd.forEach(o),rr=n(Zo," for inference can be seen in "),Po=a(Zo,"A",{href:!0});var Gd=s(Po);ar=n(Gd,"TrOCR"),Gd.forEach(o),sr=n(Zo,"."),Zo.forEach(o),Xt=l(d),X=a(d,"H2",{class:!0});var ln=s(X);me=a(ln,"A",{id:!0,class:!0,href:!0});var Wd=s(me);st=a(Wd,"SPAN",{});var Ud=s(st);g(je.$$.fragment,Ud),Ud.forEach(o),Wd.forEach(o),dr=l(ln),dt=a(ln,"SPAN",{});var Hd=s(dt);ir=n(Hd,"VisionEncoderDecoderConfig"),Hd.forEach(o),ln.forEach(o),en=l(d),z=a(d,"DIV",{class:!0});var N=s(z);g(De.$$.fragment,N),cr=l(N),fe=a(N,"P",{});var Zt=s(fe);Fo=a(Zt,"A",{href:!0});var Zd=s(Fo);lr=n(Zd,"VisionEncoderDecoderConfig"),Zd.forEach(o),pr=n(Zt,` is the configuration class to store the configuration of a
`),Co=a(Zt,"A",{href:!0});var Jd=s(Co);hr=n(Jd,"VisionEncoderDecoderModel"),Jd.forEach(o),mr=n(Zt,`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
specified arguments, defining the encoder and decoder configs.`),Zt.forEach(o),fr=l(N),ee=a(N,"P",{});var Jo=s(ee);ur=n(Jo,"Configuration objects inherit from "),Ao=a(Jo,"A",{href:!0});var Yd=s(Ao);gr=n(Yd,"PretrainedConfig"),Yd.forEach(o),_r=n(Jo,` and can be used to control the model outputs. Read the
documentation from `),Io=a(Jo,"A",{href:!0});var Kd=s(Io);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(Jo," for more information."),Jo.forEach(o),Tr=l(N),it=a(N,"P",{});var Qd=s(it);wr=n(Qd,"Examples:"),Qd.forEach(o),yr=l(N),g(Me.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(Ve.$$.fragment,pn),kr=l(pn),$e=a(pn,"P",{});var hn=s($e);xr=n(hn,"Instantiate a "),So=a(hn,"A",{href:!0});var Xd=s(So);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Dr=n(hn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),hn.forEach(o),pn.forEach(o),Mr=l(N),ge=a(N,"DIV",{class:!0});var mn=s(ge);g(qe.$$.fragment,mn),Vr=l(mn),oe=a(mn,"P",{});var Yo=s(oe);$r=n(Yo,"Serializes this instance to a Python dictionary. Override the default "),ct=a(Yo,"EM",{});var ei=s(ct);qr=n(ei,"to_dict()"),ei.forEach(o),zr=n(Yo," from "),lt=a(Yo,"EM",{});var oi=s(lt);Pr=n(oi,"PretrainedConfig"),oi.forEach(o),Fr=n(Yo,"."),Yo.forEach(o),mn.forEach(o),N.forEach(o),on=l(d),te=a(d,"H2",{class:!0});var fn=s(te);_e=a(fn,"A",{id:!0,class:!0,href:!0});var ti=s(_e);pt=a(ti,"SPAN",{});var ni=s(pt);g(ze.$$.fragment,ni),ni.forEach(o),ti.forEach(o),Cr=l(fn),ht=a(fn,"SPAN",{});var ri=s(ht);Ar=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),fn.forEach(o),tn=l(d),E=a(d,"DIV",{class:!0});var V=s(E);g(Pe.$$.fragment,V),Ir=l(V),ne=a(V,"P",{});var Ko=s(ne);Sr=n(Ko,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),mt=a(Ko,"CODE",{});var ai=s(mt);Lr=n(ai,"from_pretrained()"),ai.forEach(o),Nr=n(Ko,"function and the decoder is loaded via "),ft=a(Ko,"CODE",{});var si=s(ft);Or=n(si,"from_pretrained()"),si.forEach(o),Rr=n(Ko,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),Ko.forEach(o),Br=l(V),Fe=a(V,"P",{});var un=s(Fe);Gr=n(un,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),un.forEach(o),Hr=l(V),Ae=a(V,"P",{});var gn=s(Ae);Zr=n(gn,"Additionally, in "),Ie=a(gn,"A",{href:!0,rel:!0});var ii=s(Ie);Jr=n(ii,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),ii.forEach(o),Yr=n(gn,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),gn.forEach(o),Kr=l(V),ut=a(V,"P",{});var ci=s(ut);Qr=n(ci,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),ci.forEach(o),Xr=l(V),Se=a(V,"P",{});var _n=s(Se);ea=n(_n,"This model inherits from "),Lo=a(_n,"A",{href:!0});var li=s(Lo);oa=n(li,"PreTrainedModel"),li.forEach(o),ta=n(_n,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_n.forEach(o),na=l(V),Le=a(V,"P",{});var vn=s(Le);ra=n(vn,"This model is also a PyTorch "),Ne=a(vn,"A",{href:!0,rel:!0});var pi=s(Ne);aa=n(pi,"torch.nn.Module"),pi.forEach(o),sa=n(vn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vn.forEach(o),da=l(V),W=a(V,"P",{});var bo=s(W);No=a(bo,"A",{href:!0});var hi=s(No);ia=n(hi,"VisionEncoderDecoderModel"),hi.forEach(o),ca=n(bo,` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
:meth`),gt=a(bo,"EM",{});var mi=s(gt);la=n(mi,"~transformers.AutoModel.from_pretrained"),mi.forEach(o),pa=n(bo,` class method for the encoder and
:meth`),_t=a(bo,"EM",{});var fi=s(_t);ha=n(fi,"~transformers.AutoModelForCausalLM.from_pretrained"),fi.forEach(o),ma=n(bo," class method for the decoder."),bo.forEach(o),fa=l(V),A=a(V,"DIV",{class:!0});var Z=s(A);g(Oe.$$.fragment,Z),ua=l(Z),re=a(Z,"P",{});var Qo=s(re);ga=n(Qo,"The "),Oo=a(Qo,"A",{href:!0});var ui=s(Oo);_a=n(ui,"VisionEncoderDecoderModel"),ui.forEach(o),va=n(Qo," forward method, overrides the "),vt=a(Qo,"CODE",{});var gi=s(vt);ba=n(gi,"__call__"),gi.forEach(o),Ta=n(Qo," special method."),Qo.forEach(o),wa=l(Z),g(ve.$$.fragment,Z),ya=l(Z),bt=a(Z,"P",{});var _i=s(bt);Ea=n(_i,"Examples:"),_i.forEach(o),ka=l(Z),g(Re.$$.fragment,Z),Z.forEach(o),xa=l(V),I=a(V,"DIV",{class:!0});var J=s(I);g(Be.$$.fragment,J),ja=l(J),Tt=a(J,"P",{});var vi=s(Tt);Da=n(vi,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),vi.forEach(o),Ma=l(J),ae=a(J,"P",{});var Xo=s(ae);Va=n(Xo,"The model is set in evaluation mode by default using "),wt=a(Xo,"CODE",{});var bi=s(wt);$a=n(bi,"model.eval()"),bi.forEach(o),qa=n(Xo,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),yt=a(Xo,"CODE",{});var Ti=s(yt);za=n(Ti,"model.train()"),Ti.forEach(o),Pa=n(Xo,"."),Xo.forEach(o),Fa=l(J),Et=a(J,"P",{});var wi=s(Et);Ca=n(wi,"Example:"),wi.forEach(o),Aa=l(J),g(Ge.$$.fragment,J),J.forEach(o),V.forEach(o),nn=l(d),se=a(d,"H2",{class:!0});var bn=s(se);be=a(bn,"A",{id:!0,class:!0,href:!0});var yi=s(be);kt=a(yi,"SPAN",{});var Ei=s(kt);g(We.$$.fragment,Ei),Ei.forEach(o),yi.forEach(o),Ia=l(bn),xt=a(bn,"SPAN",{});var ki=s(xt);Sa=n(ki,"TFVisionEncoderDecoderModel"),ki.forEach(o),bn.forEach(o),rn=l(d),k=a(d,"DIV",{class:!0});var $=s(k);g(Ue.$$.fragment,$),La=l($),de=a($,"P",{});var et=s(de);Na=n(et,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),jt=a(et,"CODE",{});var xi=s(jt);Oa=n(xi,"from_pretrained()"),xi.forEach(o),Ra=n(et,"function and the decoder is loaded via "),Dt=a(et,"CODE",{});var ji=s(Dt);Ba=n(ji,"from_pretrained()"),ji.forEach(o),Ga=n(et,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),et.forEach(o),Wa=l($),He=a($,"P",{});var Tn=s(He);Ua=n(Tn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Ze=a(Tn,"A",{href:!0,rel:!0});var Di=s(Ze);Ha=n(Di,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Di.forEach(o),Za=n(Tn,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),Tn.forEach(o),Ja=l($),Je=a($,"P",{});var wn=s(Je);Ya=n(wn,"Additionally, in "),Ye=a(wn,"A",{href:!0,rel:!0});var Mi=s(Ye);Ka=n(Mi,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Mi.forEach(o),Qa=n(wn,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),wn.forEach(o),Xa=l($),Mt=a($,"P",{});var Vi=s(Mt);es=n(Vi,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Vi.forEach(o),os=l($),Ke=a($,"P",{});var yn=s(Ke);ts=n(yn,"This model inherits from "),Ro=a(yn,"A",{href:!0});var $i=s(Ro);ns=n($i,"TFPreTrainedModel"),$i.forEach(o),rs=n(yn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yn.forEach(o),as=l($),Qe=a($,"P",{});var En=s(Qe);ss=n(En,"This model is also a "),Xe=a(En,"A",{href:!0,rel:!0});var qi=s(Xe);ds=n(qi,"tf.keras.Model"),qi.forEach(o),is=n(En,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),En.forEach(o),cs=l($),U=a($,"P",{});var To=s(U);Bo=a(To,"A",{href:!0});var zi=s(Bo);ls=n(zi,"TFVisionEncoderDecoderModel"),zi.forEach(o),ps=n(To,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Vt=a(To,"CODE",{});var Pi=s(Vt);hs=n(Pi,"from_pretrained()"),Pi.forEach(o),ms=n(To,`class method for the encoder and
`),$t=a(To,"CODE",{});var Fi=s($t);fs=n(Fi,"from_pretrained()"),Fi.forEach(o),us=n(To,"class method for the decoder."),To.forEach(o),gs=l($),S=a($,"DIV",{class:!0});var Y=s(S);g(eo.$$.fragment,Y),_s=l(Y),ie=a(Y,"P",{});var ot=s(ie);vs=n(ot,"The "),Go=a(ot,"A",{href:!0});var Ci=s(Go);bs=n(Ci,"TFVisionEncoderDecoderModel"),Ci.forEach(o),Ts=n(ot," forward method, overrides the "),qt=a(ot,"CODE",{});var Ai=s(qt);ws=n(Ai,"__call__"),Ai.forEach(o),ys=n(ot," special method."),ot.forEach(o),Es=l(Y),g(Te.$$.fragment,Y),ks=l(Y),zt=a(Y,"P",{});var Ii=s(zt);xs=n(Ii,"Examples:"),Ii.forEach(o),js=l(Y),g(oo.$$.fragment,Y),Y.forEach(o),Ds=l($),O=a($,"DIV",{class:!0});var Ee=s(O);g(to.$$.fragment,Ee),Ms=l(Ee),Pt=a(Ee,"P",{});var Si=s(Pt);Vs=n(Si,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Si.forEach(o),$s=l(Ee),Ft=a(Ee,"P",{});var Li=s(Ft);qs=n(Li,"Example:"),Li.forEach(o),zs=l(Ee),g(no.$$.fragment,Ee),Ee.forEach(o),$.forEach(o),an=l(d),ce=a(d,"H2",{class:!0});var kn=s(ce);we=a(kn,"A",{id:!0,class:!0,href:!0});var Ni=s(we);Ct=a(Ni,"SPAN",{});var Oi=s(Ct);g(ro.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),Ps=l(kn),At=a(kn,"SPAN",{});var Ri=s(At);Fs=n(Ri,"FlaxVisionEncoderDecoderModel"),Ri.forEach(o),kn.forEach(o),sn=l(d),x=a(d,"DIV",{class:!0});var q=s(x);g(ao.$$.fragment,q),Cs=l(q),le=a(q,"P",{});var tt=s(le);As=n(tt,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),It=a(tt,"CODE",{});var Bi=s(It);Is=n(Bi,"from_pretrained()"),Bi.forEach(o),Ss=n(tt,"function and the decoder is loaded via "),St=a(tt,"CODE",{});var Gi=s(St);Ls=n(Gi,"from_pretrained()"),Gi.forEach(o),Ns=n(tt,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),tt.forEach(o),Os=l(q),so=a(q,"P",{});var xn=s(so);Rs=n(xn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),xn.forEach(o),Ws=l(q),co=a(q,"P",{});var jn=s(co);Us=n(jn,"Additionally, in "),lo=a(jn,"A",{href:!0,rel:!0});var Ui=s(lo);Hs=n(Ui,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Ui.forEach(o),Zs=n(jn,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),jn.forEach(o),Js=l(q),Lt=a(q,"P",{});var Hi=s(Lt);Ys=n(Hi,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Hi.forEach(o),Ks=l(q),po=a(q,"P",{});var Dn=s(po);Qs=n(Dn,"This model inherits from "),Wo=a(Dn,"A",{href:!0});var Zi=s(Wo);Xs=n(Zi,"FlaxPreTrainedModel"),Zi.forEach(o),ed=n(Dn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dn.forEach(o),od=l(q),ho=a(q,"P",{});var Mn=s(ho);td=n(Mn,`This model is also a Flax Linen
`),mo=a(Mn,"A",{href:!0,rel:!0});var Ji=s(mo);nd=n(Ji,"flax.nn.Module"),Ji.forEach(o),rd=n(Mn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mn.forEach(o),ad=l(q),H=a(q,"P",{});var wo=s(H);Uo=a(wo,"A",{href:!0});var Yi=s(Uo);sd=n(Yi,"FlaxVisionEncoderDecoderModel"),Yi.forEach(o),dd=n(wo,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
