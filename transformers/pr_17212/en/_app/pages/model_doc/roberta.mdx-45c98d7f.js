...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17212/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17212/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17212/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),K1=p(),y(cs.$$.fragment),G1=p(),ct=n("div"),y(Jr.$$.fragment),X1=p(),Wo=n("p"),Y1=r("The "),wd=n("a"),Z1=r("TFRobertaForMaskedLM"),e2=r(" forward method, overrides the "),Tp=n("code"),t2=r("__call__"),o2=r(" special method."),n2=p(),y(ps.$$.fragment),s2=p(),y(hs.$$.fragment),a2=p(),y(ms.$$.fragment),bf=p(),Bo=n("h2"),fs=n("a"),wp=n("span"),y(Kr.$$.fragment),r2=p(),$p=n("span"),i2=r("TFRobertaForSequenceClassification"),kf=p(),Je=n("div"),y(Gr.$$.fragment),l2=p(),Fp=n("p"),d2=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),c2=p(),Xr=n("p"),p2=r("This model inherits from "),$d=n("a"),h2=r("TFPreTrainedModel"),m2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),f2=p(),Yr=n("p"),u2=r("This model is also a "),Zr=n("a"),g2=r("tf.keras.Model"),_2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),b2=p(),y(us.$$.fragment),k2=p(),pt=n("div"),y(ei.$$.fragment),v2=p(),Uo=n("p"),y2=r("The "),Fd=n("a"),T2=r("TFRobertaForSequenceClassification"),w2=r(" forward method, overrides the "),xp=n("code"),$2=r("__call__"),F2=r(" special method."),x2=p(),y(gs.$$.fragment),R2=p(),y(_s.$$.fragment),M2=p(),y(bs.$$.fragment),vf=p(),Ho=n("h2"),ks=n("a"),Rp=n("span"),y(ti.$$.fragment),E2=p(),Mp=n("span"),z2=r("TFRobertaForMultipleChoice"),yf=p(),Ke=n("div"),y(oi.$$.fragment),C2=p(),Ep=n("p"),q2=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),j2=p(),ni=n("p"),P2=r("This model inherits from "),xd=n("a"),L2=r("TFPreTrainedModel"),A2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),O2=p(),si=n("p"),N2=r("This model is also a "),ai=n("a"),I2=r("tf.keras.Model"),D2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),S2=p(),y(vs.$$.fragment),W2=p(),Et=n("div"),y(ri.$$.fragment),B2=p(),Qo=n("p"),U2=r("The "),Rd=n("a"),H2=r("TFRobertaForMultipleChoice"),Q2=r(" forward method, overrides the "),zp=n("code"),V2=r("__call__"),J2=r(" special method."),K2=p(),y(ys.$$.fragment),G2=p(),y(Ts.$$.fragment),Tf=p(),Vo=n("h2"),ws=n("a"),Cp=n("span"),y(ii.$$.fragment),X2=p(),qp=n("span"),Y2=r("TFRobertaForTokenClassification"),wf=p(),Ge=n("div"),y(li.$$.fragment),Z2=p(),jp=n("p"),ey=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dy=p(),y($s.$$.fragment),cy=p(),ht=n("div"),y(hi.$$.fragment),py=p(),Jo=n("p"),hy=r("The "),Ed=n("a"),my=r("TFRobertaForTokenClassification"),fy=r(" forward method, overrides the "),Pp=n("code"),uy=r("__call__"),gy=r(" special method."),_y=p(),y(Fs.$$.fragment),by=p(),y(xs.$$.fragment),ky=p(),y(Rs.$$.fragment),$f=p(),Ko=n("h2"),Ms=n("a"),Lp=n("span"),y(mi.$$.fragment),vy=p(),Ap=n("span"),yy=r("TFRobertaForQuestionAnswering"),Ff=p(),Xe=n("div"),y(fi.$$.fragment),Ty=p(),Go=n("p"),wy=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ay=p(),y(Es.$$.fragment),Oy=p(),mt=n("div"),y(bi.$$.fragment),Ny=p(),Xo=n("p"),Iy=r("The "),Cd=n("a"),Dy=r("TFRobertaForQuestionAnswering"),Sy=r(" forward method, overrides the "),Ip=n("code"),Wy=r("__call__"),By=r(" special method."),Uy=p(),y(zs.$$.fragment),Hy=p(),y(Cs.$$.fragment),Qy=p(),y(qs.$$.fragment),xf=p(),Yo=n("h2"),js=n("a"),Dp=n("span"),y(ki.$$.fragment),Vy=p(),Sp=n("span"),Jy=r("FlaxRobertaModel"),Rf=p(),Oe=n("div"),y(vi.$$.fragment),Ky=p(),Wp=n("p"),Gy=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Xy=p(),yi=n("p"),Yy=r("This model inherits from "),qd=n("a"),Zy=r("FlaxPreTrainedModel"),eT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tT=p(),Ti=n("p"),oT=r("This model is also a Flax Linen "),wi=n("a"),nT=r("flax.linen.Module"),sT=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),aT=p(),Bp=n("p"),rT=r("Finally, this model supports inherent JAX features such as:"),iT=p(),Ut=n("ul"),Up=n("li"),$i=n("a"),lT=r("Just-In-Time (JIT) compilation"),dT=p(),Hp=n("li"),Fi=n("a"),cT=r("Automatic Differentiation"),pT=p(),Qp=n("li"),xi=n("a"),hT=r("Vectorization"),mT=p(),Vp=n("li"),Ri=n("a"),fT=r("Parallelization"),uT=p(),zt=n("div"),y(Mi.$$.fragment),gT=p(),Zo=n("p"),_T=r("The "),Jp=n("code"),bT=r("FlaxRobertaPreTrainedModel"),kT=r(" forward method, overrides the "),Kp=n("code"),vT=r("__call__"),yT=r(" special method."),TT=p(),y(Ps.$$.fragment),wT=p(),y(Ls.$$.fragment),Mf=p(),en=n("h2"),As=n("a"),Gp=n("span"),y(Ei.$$.fragment),$T=p(),Xp=n("span"),FT=r("FlaxRobertaForCausalLM"),Ef=p(),Ne=n("div"),y(zi.$$.fragment),xT=p(),Yp=n("p"),RT=r(`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),MT=p(),Ci=n("p"),ET=r("This model inherits from "),jd=n("a"),zT=r("FlaxPreTrainedModel"),CT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),qT=p(),qi=n("p"),jT=r("This model is also a Flax Linen "),ji=n("a"),PT=r("flax.linen.Module"),LT=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),AT=p(),Zp=n("p"),OT=r("Finally, this model supports inherent JAX features such as:"),NT=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),IT=r("Just-In-Time (JIT) compilation"),DT=p(),th=n("li"),Li=n("a"),ST=r("Automatic Differentiation"),WT=p(),oh=n("li"),Ai=n("a"),BT=r("Vectorization"),UT=p(),nh=n("li"),Oi=n("a"),HT=r("Parallelization"),QT=p(),Ct=n("div"),y(Ni.$$.fragment),VT=p(),tn=n("p"),JT=r("The "),sh=n("code"),KT=r("FlaxRobertaPreTrainedModel"),GT=r(" forward method, overrides the "),ah=n("code"),XT=r("__call__"),YT=r(" special method."),ZT=p(),y(Os.$$.fragment),ew=p(),y(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),y(Ii.$$.fragment),tw=p(),ih=n("span"),ow=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),y(Di.$$.fragment),nw=p(),Si=n("p"),sw=r("RoBERTa Model with a "),lh=n("code"),aw=r("language modeling"),rw=r(" head on top."),iw=p(),Wi=n("p"),lw=r("This model inherits from "),Pd=n("a"),dw=r("FlaxPreTrainedModel"),cw=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uw=p(),dh=n("p"),gw=r("Finally, this model supports inherent JAX features such as:"),_w=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),bw=r("Just-In-Time (JIT) compilation"),kw=p(),ph=n("li"),Qi=n("a"),vw=r("Automatic Differentiation"),yw=p(),hh=n("li"),Vi=n("a"),Tw=r("Vectorization"),ww=p(),mh=n("li"),Ji=n("a"),$w=r("Parallelization"),Fw=p(),qt=n("div"),y(Ki.$$.fragment),xw=p(),nn=n("p"),Rw=r("The "),fh=n("code"),Mw=r("FlaxRobertaPreTrainedModel"),Ew=r(" forward method, overrides the "),uh=n("code"),zw=r("__call__"),Cw=r(" special method."),qw=p(),y(Ds.$$.fragment),jw=p(),y(Ss.$$.fragment),qf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),y(Gi.$$.fragment),Pw=p(),_h=n("span"),Lw=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),y(Xi.$$.fragment),Aw=p(),bh=n("p"),Ow=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qw=p(),kh=n("p"),Vw=r("Finally, this model supports inherent JAX features such as:"),Jw=p(),Vt=n("ul"),vh=n("li"),tl=n("a"),Kw=r("Just-In-Time (JIT) compilation"),Gw=p(),yh=n("li"),ol=n("a"),Xw=r("Automatic Differentiation"),Yw=p(),Th=n("li"),nl=n("a"),Zw=r("Vectorization"),e$=p(),wh=n("li"),sl=n("a"),t$=r("Parallelization"),o$=p(),jt=n("div"),y(al.$$.fragment),n$=p(),an=n("p"),s$=r("The "),$h=n("code"),a$=r("FlaxRobertaPreTrainedModel"),r$=r(" forward method, overrides the "),Fh=n("code"),i$=r("__call__"),l$=r(" special method."),d$=p(),y(Bs.$$.fragment),c$=p(),y(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),y(rl.$$.fragment),p$=p(),Rh=n("span"),h$=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),y(il.$$.fragment),m$=p(),Mh=n("p"),f$=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),K1=h(Nt),T(cs.$$.fragment,Nt),G1=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Jr.$$.fragment,ho),X1=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y1=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var Wx=a(wd);Z1=i(Wx,"TFRobertaForMaskedLM"),Wx.forEach(t),e2=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var Bx=a(Tp);t2=i(Bx,"__call__"),Bx.forEach(t),o2=i(Yd," special method."),Yd.forEach(t),n2=h(ho),T(ps.$$.fragment,ho),s2=h(ho),T(hs.$$.fragment,ho),a2=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var Ux=a(fs);wp=s(Ux,"SPAN",{});var Hx=a(wp);T(Kr.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),r2=h(Fu),$p=s(Fu,"SPAN",{});var Qx=a($p);i2=i(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);T(Gr.$$.fragment,It),l2=h(It),Fp=s(It,"P",{});var Vx=a(Fp);d2=i(Vx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Vx.forEach(t),c2=h(It),Xr=s(It,"P",{});var xu=a(Xr);p2=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var Jx=a($d);h2=i(Jx,"TFPreTrainedModel"),Jx.forEach(t),m2=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),f2=h(It),Yr=s(It,"P",{});var Ru=a(Yr);u2=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var Kx=a(Zr);g2=i(Kx,"tf.keras.Model"),Kx.forEach(t),_2=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),b2=h(It),T(us.$$.fragment,It),k2=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),v2=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);y2=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);T2=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),w2=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$2=i(Xx,"__call__"),Xx.forEach(t),F2=i(Zd," special method."),Zd.forEach(t),x2=h(mo),T(gs.$$.fragment,mo),R2=h(mo),T(_s.$$.fragment,mo),M2=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);T(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),E2=h(Mu),Mp=s(Mu,"SPAN",{});var eR=a(Mp);z2=i(eR,"TFRobertaForMultipleChoice"),eR.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),C2=h(Dt),Ep=s(Dt,"P",{});var tR=a(Ep);q2=i(tR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tR.forEach(t),j2=h(Dt),ni=s(Dt,"P",{});var Eu=a(ni);P2=i(Eu,"This model inherits from "),xd=s(Eu,"A",{href:!0});var oR=a(xd);L2=i(oR,"TFPreTrainedModel"),oR.forEach(t),A2=i(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu.forEach(t),O2=h(Dt),si=s(Dt,"P",{});var zu=a(si);N2=i(zu,"This model is also a "),ai=s(zu,"A",{href:!0,rel:!0});var nR=a(ai);I2=i(nR,"tf.keras.Model"),nR.forEach(t),D2=i(zu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),S2=h(Dt),T(vs.$$.fragment,Dt),W2=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),B2=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);U2=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sR=a(Rd);H2=i(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),Q2=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var aR=a(zp);V2=i(aR,"__call__"),aR.forEach(t),J2=i(ec," special method."),ec.forEach(t),K2=h(aa),T(ys.$$.fragment,aa),G2=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var rR=a(ws);Cp=s(rR,"SPAN",{});var iR=a(Cp);T(ii.$$.fragment,iR),iR.forEach(t),rR.forEach(t),X2=h(Cu),qp=s(Cu,"SPAN",{});var lR=a(qp);Y2=i(lR,"TFRobertaForTokenClassification"),lR.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),Z2=h(St),jp=s(St,"P",{});var dR=a(jp);ey=i(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),T($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),py=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hR=a(Ed);my=i(hR,"TFRobertaForTokenClassification"),hR.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mR=a(Pp);uy=i(mR,"__call__"),mR.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),T(Fs.$$.fragment,fo),by=h(fo),T(xs.$$.fragment,fo),ky=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fR=a(Ms);Lp=s(fR,"SPAN",{});var uR=a(Lp);T(mi.$$.fragment,uR),uR.forEach(t),fR.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var gR=a(Ap);yy=i(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),Ty=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),T(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),Cd=s(nc,"A",{href:!0});var yR=a(Cd);Dy=i(yR,"TFRobertaForQuestionAnswering"),yR.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var TR=a(Ip);Wy=i(TR,"__call__"),TR.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),T(zs.$$.fragment,uo),Hy=h(uo),T(Cs.$$.fragment,uo),Qy=h(uo),T(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);T(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),Vy=h(Ou),Sp=s(Ou,"SPAN",{});var FR=a(Sp);Jy=i(FR,"FlaxRobertaModel"),FR.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);Gy=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),Xy=h(gt),yi=s(gt,"P",{});var Nu=a(yi);Yy=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var RR=a(qd);Zy=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),eT=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tT=h(gt),Ti=s(gt,"P",{});var Iu=a(Ti);oT=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var MR=a(wi);nT=i(MR,"flax.linen.Module"),MR.forEach(t),sT=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aT=h(gt),Bp=s(gt,"P",{});var ER=a(Bp);rT=i(ER,"Finally, this model supports inherent JAX features such as:"),ER.forEach(t),iT=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zR=a(Up);$i=s(zR,"A",{href:!0,rel:!0});var CR=a($i);lT=i(CR,"Just-In-Time (JIT) compilation"),CR.forEach(t),zR.forEach(t),dT=h(ra),Hp=s(ra,"LI",{});var qR=a(Hp);Fi=s(qR,"A",{href:!0,rel:!0});var jR=a(Fi);cT=i(jR,"Automatic Differentiation"),jR.forEach(t),qR.forEach(t),pT=h(ra),Qp=s(ra,"LI",{});var PR=a(Qp);xi=s(PR,"A",{href:!0,rel:!0});var LR=a(xi);hT=i(LR,"Vectorization"),LR.forEach(t),PR.forEach(t),mT=h(ra),Vp=s(ra,"LI",{});var AR=a(Vp);Ri=s(AR,"A",{href:!0,rel:!0});var OR=a(Ri);fT=i(OR,"Parallelization"),OR.forEach(t),AR.forEach(t),ra.forEach(t),uT=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);T(Mi.$$.fragment,ia),gT=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_T=i(sc,"The "),Jp=s(sc,"CODE",{});var NR=a(Jp);bT=i(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),kT=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var IR=a(Kp);vT=i(IR,"__call__"),IR.forEach(t),yT=i(sc," special method."),sc.forEach(t),TT=h(ia),T(Ps.$$.fragment,ia),wT=h(ia),T(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var DR=a(As);Gp=s(DR,"SPAN",{});var SR=a(Gp);T(Ei.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$T=h(Du),Xp=s(Du,"SPAN",{});var WR=a(Xp);FT=i(WR,"FlaxRobertaForCausalLM"),WR.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);T(zi.$$.fragment,_t),xT=h(_t),Yp=s(_t,"P",{});var BR=a(Yp);RT=i(BR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),BR.forEach(t),MT=h(_t),Ci=s(_t,"P",{});var Su=a(Ci);ET=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var UR=a(jd);zT=i(UR,"FlaxPreTrainedModel"),UR.forEach(t),CT=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),qT=h(_t),qi=s(_t,"P",{});var Wu=a(qi);jT=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var HR=a(ji);PT=i(HR,"flax.linen.Module"),HR.forEach(t),LT=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),AT=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);OT=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),NT=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var VR=a(eh);Pi=s(VR,"A",{href:!0,rel:!0});var JR=a(Pi);IT=i(JR,"Just-In-Time (JIT) compilation"),JR.forEach(t),VR.forEach(t),DT=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);ST=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),WT=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);BT=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),UT=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var eM=a(Oi);HT=i(eM,"Parallelization"),eM.forEach(t),ZR.forEach(t),la.forEach(t),QT=h(_t),Ct=s(_t,"DIV",{class:!0});var da=a(Ct);T(Ni.$$.fragment,da),VT=h(da),tn=s(da,"P",{});var ac=a(tn);JT=i(ac,"The "),sh=s(ac,"CODE",{});var tM=a(sh);KT=i(tM,"FlaxRobertaPreTrainedModel"),tM.forEach(t),GT=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oM=a(ah);XT=i(oM,"__call__"),oM.forEach(t),YT=i(ac," special method."),ac.forEach(t),ZT=h(da),T(Os.$$.fragment,da),ew=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nM=a(Is);rh=s(nM,"SPAN",{});var sM=a(rh);T(Ii.$$.fragment,sM),sM.forEach(t),nM.forEach(t),tw=h(Bu),ih=s(Bu,"SPAN",{});var aM=a(ih);ow=i(aM,"FlaxRobertaForMaskedLM"),aM.forEach(t),Bu.forEach(t),Cf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),nw=h(bt),Si=s(bt,"P",{});var Uu=a(Si);sw=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rM=a(lh);aw=i(rM,"language modeling"),rM.forEach(t),rw=i(Uu," head on top."),Uu.forEach(t),iw=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);lw=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iM=a(Pd);dw=i(iM,"FlaxPreTrainedModel"),iM.forEach(t),cw=i(Hu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),uw=h(bt),dh=s(bt,"P",{});var dM=a(dh);gw=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_w=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);bw=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),kw=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);vw=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),yw=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Vi=s(fM,"A",{href:!0,rel:!0});var uM=a(Vi);Tw=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),ww=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Ji=s(gM,"A",{href:!0,rel:!0});var _M=a(Ji);$w=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),Fw=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);T(Ki.$$.fragment,pa),xw=h(pa),nn=s(pa,"P",{});var rc=a(nn);Rw=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);Mw=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),Ew=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);zw=i(kM,"__call__"),kM.forEach(t),Cw=i(rc," special method."),rc.forEach(t),qw=h(pa),T(Ds.$$.fragment,pa),jw=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var yM=a(gh);T(Gi.$$.fragment,yM),yM.forEach(t),vM.forEach(t),Pw=h(Vu),_h=s(Vu,"SPAN",{});var TM=a(_h);Lw=i(TM,"FlaxRobertaForSequenceClassification"),TM.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),Aw=h(kt),bh=s(kt,"P",{});var wM=a(bh);Ow=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wM.forEach(t),Nw=h(kt),Yi=s(kt,"P",{});var Ju=a(Yi);Iw=i(Ju,"This model inherits from "),Ld=s(Ju,"A",{href:!0});var $M=a(Ld);Dw=i($M,"FlaxPreTrainedModel"),$M.forEach(t),Sw=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ju.forEach(t),Ww=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);Bw=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var FM=a(el);Uw=i(FM,"flax.linen.Module"),FM.forEach(t),Hw=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Qw=h(kt),kh=s(kt,"P",{});var xM=a(kh);Vw=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),Jw=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);Kw=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),Gw=h(ha),yh=s(ha,"LI",{});var EM=a(yh);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);Xw=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Yw=h(ha),Th=s(ha,"LI",{});var CM=a(Th);nl=s(CM,"A",{href:!0,rel:!0});var qM=a(nl);Zw=i(qM,"Vectorization"),qM.forEach(t),CM.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t$=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n$=h(ma),an=s(ma,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a$=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i$=i(AM,"__call__"),AM.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ma),T(Bs.$$.fragment,ma),c$=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);T(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p$=h(Gu),Rh=s(Gu,"SPAN",{});var IM=a(Rh);h$=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m$=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f$=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
