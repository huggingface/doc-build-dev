...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),up=new y({}),{c(){g=o("meta"),S=u(),b=o("h1"),k=o("a"),X=o("span"),f(z.$$.fragment),C=u(),Q=o("span"),x=a("DeepSpeed Integration"),te=u(),T=o("p"),q=o("a"),E=a("DeepSpeed"),gs=a(" implements everything described in the "),W=o("a"),bs=a("ZeRO paper"),c5=a(". Currently it provides full support for:"),yj=u(),R=o("ol"),Mh=o("li"),h5=a("Optimizer state partitioning (ZeRO stage 1)"),f5=u(),Lh=o("li"),d5=a("Gradient partitioning (ZeRO stage 2)"),m5=u(),Zh=o("li"),_5=a("Parameter partitioning (ZeRO stage 3)"),v5=u(),Nh=o("li"),j5=a("Custom mixed precision training handling"),w5=u(),Hh=o("li"),y5=a("A range of fast CUDA-extension-based optimizers"),g5=u(),Bh=o("li"),b5=a("ZeRO-Offload to CPU and NVMe"),gj=u(),Te=o("p"),q5=a("ZeRO-Offload has its own dedicated paper: "),Kn=o("a"),E5=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),$5=a(". And NVMe-support is described in the paper "),Jn=o("a"),k5=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),P5=a("."),bj=u(),kp=o("p"),z5=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),qj=u(),Pp=o("p"),D5=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Ej=u(),wt=o("p"),O5=a("\u{1F917} Transformers integrates "),Xn=o("a"),A5=a("DeepSpeed"),T5=a(" via 2 options:"),$j=u(),yt=o("ol"),Qn=o("li"),S5=a("Integration of the core DeepSpeed features via "),zp=o("a"),C5=a("Trainer"),x5=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),R5=u(),F=o("li"),I5=a("If you don\u2019t use "),Dp=o("a"),U5=a("Trainer"),G5=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Wh=o("code"),M5=a("from_pretrained"),L5=a(" and "),Fh=o("code"),Z5=a("from_config"),N5=a(` include integration of essential
parts of DeepSpeed like `),Vh=o("code"),H5=a("zero.Init"),B5=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=o("a"),W5=a("deepspeed-non-trainer-integration"),F5=a("."),kj=u(),Ap=o("p"),V5=a("What is integrated:"),Pj=u(),Tp=o("p"),Y5=a("Training:"),zj=u(),Sp=o("ol"),Yh=o("li"),K5=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),Dj=u(),Cp=o("p"),J5=a("Inference:"),Oj=u(),xp=o("ol"),eo=o("li"),X5=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=o("a"),Q5=a("deepspeed-zero-inference"),e6=a("."),Aj=u(),Ip=o("p"),s6=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),jp=o("a"),mU=a("DeepSpeed GitHub"),_U=a("."),this.h()},l(e){const p=AY('[data-svelte="svelte-1phssyn"]',document.head);g=l(p,"META",{name:!0,content:!0}),p.forEach(t),S=c(e),b=l(e,"H1",{class:!0});var wp=r(b);k=l(wp,"A",{id:!0,class:!0,href:!0});var mj=r(k);X=l(mj,"SPAN",{});var _j=r(X);d(z.$$.fragment,_j),_j.forEach(t),mj.forEach(t),C=c(wp),Q=l(wp,"SPAN",{});var qU=r(Q);x=n(qU,"DeepSpeed Integration"),qU.forEach(t),wp.forEach(t),te=c(e),T=l(e,"P",{});var vj=r(T);q=l(vj,"A",{href:!0,rel:!0});var EU=r(q);E=n(EU,"DeepSpeed"),EU.forEach(t),gs=n(vj," implements everything described in the "),W=l(vj,"A",{href:!0,rel:!0});var $U=r(W);bs=n($U,"ZeRO paper"),$U.forEach(t),c5=n(vj,". Currently it provides full support for:"),vj.forEach(t),yj=c(e),R=l(e,"OL",{});var ve=r(R);Mh=l(ve,"LI",{});var kU=r(Mh);h5=n(kU,"Optimizer state partitioning (ZeRO stage 1)"),kU.forEach(t),f5=c(ve),Lh=l(ve,"LI",{});var PU=r(Lh);d5=n(PU,"Gradient partitioning (ZeRO stage 2)"),PU.forEach(t),m5=c(ve),Zh=l(ve,"LI",{});var zU=r(Zh);_5=n(zU,"Parameter partitioning (ZeRO stage 3)"),zU.forEach(t),v5=c(ve),Nh=l(ve,"LI",{});var DU=r(Nh);j5=n(DU,"Custom mixed precision training handling"),DU.forEach(t),w5=c(ve),Hh=l(ve,"LI",{});var OU=r(Hh);y5=n(OU,"A range of fast CUDA-extension-based optimizers"),OU.forEach(t),g5=c(ve),Bh=l(ve,"LI",{});var AU=r(Bh);b5=n(AU,"ZeRO-Offload to CPU and NVMe"),AU.forEach(t),ve.forEach(t),gj=c(e),Te=l(e,"P",{});var Yc=r(Te);q5=n(Yc,"ZeRO-Offload has its own dedicated paper: "),Kn=l(Yc,"A",{href:!0,rel:!0});var TU=r(Kn);E5=n(TU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),TU.forEach(t),$5=n(Yc,". And NVMe-support is described in the paper "),Jn=l(Yc,"A",{href:!0,rel:!0});var SU=r(Jn);k5=n(SU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),SU.forEach(t),P5=n(Yc,"."),Yc.forEach(t),bj=c(e),kp=l(e,"P",{});var CU=r(kp);z5=n(CU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),CU.forEach(t),qj=c(e),Pp=l(e,"P",{});var xU=r(Pp);D5=n(xU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),xU.forEach(t),Ej=c(e),wt=l(e,"P",{});var S0=r(wt);O5=n(S0,"\u{1F917} Transformers integrates "),Xn=l(S0,"A",{href:!0,rel:!0});var RU=r(Xn);A5=n(RU,"DeepSpeed"),RU.forEach(t),T5=n(S0," via 2 options:"),S0.forEach(t),$j=c(e),yt=l(e,"OL",{});var C0=r(yt);Qn=l(C0,"LI",{});var x0=r(Qn);S5=n(x0,"Integration of the core DeepSpeed features via "),zp=l(x0,"A",{href:!0});var IU=r(zp);C5=n(IU,"Trainer"),IU.forEach(t),x5=n(x0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),x0.forEach(t),R5=c(C0),F=l(C0,"LI",{});var je=r(F);I5=n(je,"If you don\u2019t use "),Dp=l(je,"A",{href:!0});var UU=r(Dp);U5=n(UU,"Trainer"),UU.forEach(t),G5=n(je,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Wh=l(je,"CODE",{});var GU=r(Wh);M5=n(GU,"from_pretrained"),GU.forEach(t),L5=n(je," and "),Fh=l(je,"CODE",{});var MU=r(Fh);Z5=n(MU,"from_config"),MU.forEach(t),N5=n(je,` include integration of essential
parts of DeepSpeed like `),Vh=l(je,"CODE",{});var LU=r(Vh);H5=n(LU,"zero.Init"),LU.forEach(t),B5=n(je,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=l(je,"A",{href:!0});var ZU=r(Op);W5=n(ZU,"deepspeed-non-trainer-integration"),ZU.forEach(t),F5=n(je,"."),je.forEach(t),C0.forEach(t),kj=c(e),Ap=l(e,"P",{});var NU=r(Ap);V5=n(NU,"What is integrated:"),NU.forEach(t),Pj=c(e),Tp=l(e,"P",{});var HU=r(Tp);Y5=n(HU,"Training:"),HU.forEach(t),zj=c(e),Sp=l(e,"OL",{});var BU=r(Sp);Yh=l(BU,"LI",{});var WU=r(Yh);K5=n(WU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),WU.forEach(t),BU.forEach(t),Dj=c(e),Cp=l(e,"P",{});var FU=r(Cp);J5=n(FU,"Inference:"),FU.forEach(t),Oj=c(e),xp=l(e,"OL",{});var VU=r(xp);eo=l(VU,"LI",{});var R0=r(eo);X5=n(R0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(R0,"A",{href:!0});var YU=r(Rp);Q5=n(YU,"deepspeed-zero-inference"),YU.forEach(t),e6=n(R0,"."),R0.forEach(t),VU.forEach(t),Aj=c(e),Ip=l(e,"P",{});var KU=r(Ip);s6=n(KU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
