...
`),G=r(ye,"CODE",{});var Ae=i(G);ke=s(Ae,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ae.forEach(t),ye.forEach(t),D.forEach(t)},m(_,R){g(_,d,R),e(d,v),g(_,c,R),g(_,p,R),e(p,b),e(b,l),e(p,m),e(p,E),e(E,fe),g(_,Q,R),g(_,F,R),e(F,J),e(F,A),e(A,Y),e(F,ge),e(F,H),e(H,_e),e(F,ce),g(_,P,R),g(_,S,R),e(S,Z),g(_,oe,R),g(_,q,R),e(q,z),e(z,Te),e(z,U),e(U,pe),e(z,ne),e(z,V),e(V,he),e(q,se),e(q,x),e(x,ve),e(x,W),e(W,ae),e(x,be),e(x,B),e(B,I),e(q,ee),e(q,O),e(O,te),e(O,G),e(G,ke)},d(_){_&&t(d),_&&t(c),_&&t(p),_&&t(Q),_&&t(F),_&&t(P),_&&t(S),_&&t(oe),_&&t(q)}}}function xc(M){let d,v,c,p,b;return{c(){d=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),v=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example:"),m.forEach(t),c=u(l),y(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),C(p,l,m),b=!0},p:Ye,i(l){b||(w(p.$$.fragment,l),b=!0)},o(l){$(p.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function Pc(M){let d,v,c,p,b,l,m,E,fe,Q,F,J,A,Y,ge,H,_e,ce,P,S,Z,oe,q,z,Te,U,pe,ne,V,he,se,x,ve,W,ae,be,B,I,ee,O,te,G,ke;return{c(){d=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=h(),F=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=h(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=h(),q=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),he=n("model(inputs_ids)"),se=h(),x=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),be=n(" or "),B=a("code"),I=n("model([input_ids, attention_mask, token_type_ids])"),ee=h(),O=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ke=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(_){d=r(_,"P",{});var R=i(d);v=s(R,"TF 2.0 models accepts two formats as inputs:"),R.forEach(t),c=u(_),p=r(_,"UL",{});var re=i(p);b=r(re,"LI",{});var Se=i(b);l=s(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),m=u(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=u(_),F=r(_,"P",{});var N=i(F);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),v=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example:"),m.forEach(t),c=u(l),y(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),C(p,l,m),b=!0},p:Ye,i(l){b||(w(p.$$.fragment,l),b=!0)},o(l){$(p.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function Oc(M){let d,v,c,p,b,l,m,E,fe,Q,F,J,A,Y,ge,H,_e,ce,P,S,Z,oe,q,z,Te,U,pe,ne,V,he,se,x,ve,W,ae,be,B,I,ee,O,te,G,ke;return{c(){d=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=h(),F=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=h(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=h(),q=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),he=n("model(inputs_ids)"),se=h(),x=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),be=n(" or "),B=a("code"),I=n("model([input_ids, attention_mask, token_type_ids])"),ee=h(),O=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ke=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(_){d=r(_,"P",{});var R=i(d);v=s(R,"TF 2.0 models accepts two formats as inputs:"),R.forEach(t),c=u(_),p=r(_,"UL",{});var re=i(p);b=r(re,"LI",{});var Se=i(b);l=s(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),m=u(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=u(_),F=r(_,"P",{});var N=i(F);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all the
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18175/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_18175/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18175/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_18175/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18175/en/model_doc/ctrl#transformers.CTRLConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18175/src/transformers/models/ctrl/modeling_ctrl.py#L531",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18175/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18175/src/transformers/models/ctrl/modeling_ctrl.py#L657",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18175/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18175/src/transformers/models/ctrl/modeling_tf_ctrl.py#L521",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18175/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18175/src/transformers/models/ctrl/modeling_tf_ctrl.py#L635",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18175/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18175/src/transformers/models/ctrl/modeling_tf_ctrl.py#L746",returnDescription:`
<p>A <a
...
and behavior.`),dr=h(),He=a("div"),k(ko.$$.fragment),cr=h(),ht=a("p"),pr=n("The "),pn=a("a"),hr=n("CTRLModel"),ur=n(" forward method, overrides the "),Wn=a("code"),mr=n("__call__"),fr=n(" special method."),gr=h(),k(Ft.$$.fragment),_r=h(),k(Et.$$.fragment),Os=h(),ut=a("h2"),qt=a("a"),Bn=a("span"),k(yo.$$.fragment),Tr=h(),Un=a("span"),vr=n("CTRLLMHeadModel"),Ns=h(),we=a("div"),k(Co.$$.fragment),br=h(),Vn=a("p"),kr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ea.forEach(t),dr=u(ot),He=r(ot,"DIV",{class:!0});var oo=i(He);y(ko.$$.fragment,oo),cr=u(oo),ht=r(oo,"P",{});var Rn=i(ht);pr=s(Rn,"The "),pn=r(Rn,"A",{href:!0});var bd=i(pn);hr=s(bd,"CTRLModel"),bd.forEach(t),ur=s(Rn," forward method, overrides the "),Wn=r(Rn,"CODE",{});var kd=i(Wn);mr=s(kd,"__call__"),kd.forEach(t),fr=s(Rn," special method."),Rn.forEach(t),gr=u(oo),y(Ft.$$.fragment,oo),_r=u(oo),y(Et.$$.fragment,oo),oo.forEach(t),ot.forEach(t),Os=u(o),ut=r(o,"H2",{class:!0});var ta=i(ut);qt=r(ta,"A",{id:!0,class:!0,href:!0});var yd=i(qt);Bn=r(yd,"SPAN",{});var Cd=i(Bn);y(yo.$$.fragment,Cd),Cd.forEach(t),yd.forEach(t),Tr=u(ta),Un=r(ta,"SPAN",{});var wd=i(Un);vr=s(wd,"CTRLLMHeadModel"),wd.forEach(t),ta.forEach(t),Ns=u(o),we=r(o,"DIV",{class:!0});var nt=i(we);y(Co.$$.fragment,nt),br=u(nt),Vn=r(nt,"P",{});var $d=i(Vn);kr=s($d,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oa.forEach(t),Lr=u(nt),$o=r(nt,"P",{});var na=i($o);Rr=s(na,"This model is also a PyTorch "),Lo=r(na,"A",{href:!0,rel:!0});var Rd=i(Lo);Mr=s(Rd,"torch.nn.Module"),Rd.forEach(t),Fr=s(na,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),na.forEach(t),Er=u(nt),We=r(nt,"DIV",{class:!0});var no=i(We);y(Ro.$$.fragment,no),qr=u(no),mt=r(no,"P",{});var Mn=i(mt);zr=s(Mn,"The "),un=r(Mn,"A",{href:!0});var Md=i(un);xr=s(Md,"CTRLLMHeadModel"),Md.forEach(t),jr=s(Mn," forward method, overrides the "),Gn=r(Mn,"CODE",{});var Fd=i(Gn);Pr=s(Fd,"__call__"),Fd.forEach(t),Sr=s(Mn," special method."),Mn.forEach(t),Ir=u(no),y(zt.$$.fragment,no),Or=u(no),y(xt.$$.fragment,no),no.forEach(t),nt.forEach(t),Ds=u(o),ft=r(o,"H2",{class:!0});var sa=i(ft);jt=r(sa,"A",{id:!0,class:!0,href:!0});var Ed=i(jt);Kn=r(Ed,"SPAN",{});var qd=i(Kn);y(Mo.$$.fragment,qd),qd.forEach(t),Ed.forEach(t),Nr=u(sa),Xn=r(sa,"SPAN",{});var zd=i(Xn);Dr=s(zd,"CTRLForSequenceClassification"),zd.forEach(t),sa.forEach(t),As=u(o),$e=r(o,"DIV",{class:!0});var st=i($e);y(Fo.$$.fragment,st),Ar=u(st),Le=r(st,"P",{});var Ve=i(Le);Hr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ra.forEach(t),ii=u(st),ie=r(st,"DIV",{class:!0});var ze=i(ie);y(xo.$$.fragment,ze),li=u(ze),gt=r(ze,"P",{});var Fn=i(gt);di=s(Fn,"The "),gn=r(Fn,"A",{href:!0});var Dd=i(gn);ci=s(Dd,"CTRLForSequenceClassification"),Dd.forEach(t),pi=s(Fn," forward method, overrides the "),es=r(Fn,"CODE",{});var Ad=i(es);hi=s(Ad,"__call__"),Ad.forEach(t),ui=s(Fn," special method."),Fn.forEach(t),mi=u(ze),y(Pt.$$.fragment,ze),fi=u(ze),y(St.$$.fragment,ze),gi=u(ze),y(It.$$.fragment,ze),_i=u(ze),y(Ot.$$.fragment,ze),Ti=u(ze),y(Nt.$$.fragment,ze),ze.forEach(t),st.forEach(t),Hs=u(o),_t=r(o,"H2",{class:!0});var ia=i(_t);Dt=r(ia,"A",{id:!0,class:!0,href:!0});var Hd=i(Dt);ts=r(Hd,"SPAN",{});var Wd=i(ts);y(jo.$$.fragment,Wd),Wd.forEach(t),Hd.forEach(t),vi=u(ia),os=r(ia,"SPAN",{});var Bd=i(os);bi=s(Bd,"TFCTRLModel"),Bd.forEach(t),ia.forEach(t),Ws=u(o),le=r(o,"DIV",{class:!0});var Ge=i(le);y(Po.$$.fragment,Ge),ki=u(Ge),ns=r(Ge,"P",{});var Ud=i(ns);yi=s(Ud,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Ud.forEach(t),Ci=u(Ge),So=r(Ge,"P",{});var la=i(So);wi=s(la,"This model inherits from "),_n=r(la,"A",{href:!0});var Vd=i(_n);$i=s(Vd,"TFPreTrainedModel"),Vd.forEach(t),Li=s(la,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
each row of the batch).`),at.forEach(t),Ll=u(me),Ko=r(me,"P",{});var ma=i(Ko);Rl=s(ma,"This model inherits from "),Cn=r(ma,"A",{href:!0});var uc=i(Cn);Ml=s(uc,"TFPreTrainedModel"),uc.forEach(t),Fl=s(ma,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
