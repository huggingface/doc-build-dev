...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = AutoModelForMultipleChoice.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>)`}}),K=new zl({props:{$$slots:{default:[Pl]},$$scope:{ctx:ts}}}),vs=new A({props:{code:`training_args = TrainingArguments(
    output_dir="./results",
