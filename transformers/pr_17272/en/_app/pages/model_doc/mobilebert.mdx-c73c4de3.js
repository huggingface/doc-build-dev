...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17272/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_17272/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17272/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L843",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17272/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L1255",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L1466",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L1568",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_mobilebert.py#L1358",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<a href="/docs/transformers/pr_17272/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17272/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Hf=m(Ot),Ze=a(Ot,"DIV",{class:!0});var St=i(Ze);y(gr.$$.fragment,St),Qf=m(St),ho=a(St,"P",{});var vi=i(ho);Kf=s(vi,"The "),Ga=a(vi,"A",{href:!0});var Jk=i(Ga);Vf=s(Jk,"MobileBertForQuestionAnswering"),Jk.forEach(t),Gf=s(vi," forward method, overrides the "),vl=a(vi,"CODE",{});var Zk=i(vl);Yf=s(Zk,"__call__"),Zk.forEach(t),Jf=s(vi," special method."),vi.forEach(t),Zf=m(St),y(mn.$$.fragment,St),Xf=m(St),y(un.$$.fragment,St),eg=m(St),y(fn.$$.fragment,St),St.forEach(t),Ot.forEach(t),ic=m(o),mo=a(o,"H2",{class:!0});var op=i(mo);gn=a(op,"A",{id:!0,class:!0,href:!0});var Xk=i(gn);yl=a(Xk,"SPAN",{});var e2=i(yl);y(_r.$$.fragment,e2),e2.forEach(t),Xk.forEach(t),tg=m(op),wl=a(op,"SPAN",{});var t2=i(wl);og=s(t2,"TFMobileBertModel"),t2.forEach(t),op.forEach(t),lc=m(o),Ne=a(o,"DIV",{class:!0});var gt=i(Ne);y(br.$$.fragment,gt),ng=m(gt),Ml=a(gt,"P",{});var o2=i(Ml);sg=s(o2,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),o2.forEach(t),rg=m(gt),Tr=a(gt,"P",{});var np=i(Tr);ag=s(np,"This model inherits from "),Ya=a(np,"A",{href:!0});var n2=i(Ya);ig=s(n2,"TFPreTrainedModel"),n2.forEach(t),lg=s(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),dg=m(gt),kr=a(gt,"P",{});var sp=i(kr);cg=s(sp,"This model is also a "),vr=a(sp,"A",{href:!0,rel:!0});var s2=i(vr);pg=s(s2,"tf.keras.Model"),s2.forEach(t),hg=s(sp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sp.forEach(t),mg=m(gt),y(_n.$$.fragment,gt),ug=m(gt),pt=a(gt,"DIV",{class:!0});var ns=i(pt);y(yr.$$.fragment,ns),fg=m(ns),uo=a(ns,"P",{});var yi=i(uo);gg=s(yi,"The "),Ja=a(yi,"A",{href:!0});var r2=i(Ja);_g=s(r2,"TFMobileBertModel"),r2.forEach(t),bg=s(yi," forward method, overrides the "),$l=a(yi,"CODE",{});var a2=i($l);Tg=s(a2,"__call__"),a2.forEach(t),kg=s(yi," special method."),yi.forEach(t),vg=m(ns),y(bn.$$.fragment,ns),yg=m(ns),y(Tn.$$.fragment,ns),ns.forEach(t),gt.forEach(t),dc=m(o),fo=a(o,"H2",{class:!0});var rp=i(fo);kn=a(rp,"A",{id:!0,class:!0,href:!0});var i2=i(kn);Fl=a(i2,"SPAN",{});var l2=i(Fl);y(wr.$$.fragment,l2),l2.forEach(t),i2.forEach(t),wg=m(rp),Bl=a(rp,"SPAN",{});var d2=i(Bl);Mg=s(d2,"TFMobileBertForPreTraining"),d2.forEach(t),rp.forEach(t),cc=m(o),Oe=a(o,"DIV",{class:!0});var _t=i(Oe);y(Mr.$$.fragment,_t),$g=m(_t),go=a(_t,"P",{});var wi=i(go);Fg=s(wi,"MobileBert Model with two heads on top as done during the pretraining: a "),El=a(wi,"CODE",{});var c2=i(El);Bg=s(c2,"masked language modeling"),c2.forEach(t),Eg=s(wi,` head and a
`),xl=a(wi,"CODE",{});var p2=i(xl);xg=s(p2,"next sentence prediction (classification)"),p2.forEach(t),zg=s(wi," head."),wi.forEach(t),Pg=m(_t),$r=a(_t,"P",{});var ap=i($r);qg=s(ap,"This model inherits from "),Za=a(ap,"A",{href:!0});var h2=i(Za);Cg=s(h2,"TFPreTrainedModel"),h2.forEach(t),jg=s(ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ap.forEach(t),Ng=m(_t),Fr=a(_t,"P",{});var ip=i(Fr);Og=s(ip,"This model is also a "),Br=a(ip,"A",{href:!0,rel:!0});var m2=i(Br);Sg=s(m2,"tf.keras.Model"),m2.forEach(t),Ag=s(ip,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=m(_t),y(vn.$$.fragment,_t),Lg=m(_t),ht=a(_t,"DIV",{class:!0});var ss=i(ht);y(Er.$$.fragment,ss),Dg=m(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var u2=i(Xa);Rg=s(u2,"TFMobileBertForPreTraining"),u2.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var f2=i(zl);Hg=s(f2,"__call__"),f2.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=m(ss),y(yn.$$.fragment,ss),Vg=m(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=m(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var g2=i(Mn);Pl=a(g2,"SPAN",{});var _2=i(Pl);y(xr.$$.fragment,_2),_2.forEach(t),g2.forEach(t),Gg=m(lp),ql=a(lp,"SPAN",{});var b2=i(ql);Yg=s(b2,"TFMobileBertForMaskedLM"),b2.forEach(t),lp.forEach(t),hc=m(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=m(bt),Pr=a(bt,"P",{});var dp=i(Pr);Zg=s(dp,"MobileBert Model with a "),Cl=a(dp,"CODE",{});var T2=i(Cl);Xg=s(T2,"language modeling"),T2.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=m(bt),qr=a(bt,"P",{});var cp=i(qr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var k2=i(ei);n_=s(k2,"TFPreTrainedModel"),k2.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cp.forEach(t),r_=m(bt),Cr=a(bt,"P",{});var pp=i(Cr);a_=s(pp,"This model is also a "),jr=a(pp,"A",{href:!0,rel:!0});var v2=i(jr);i_=s(v2,"tf.keras.Model"),v2.forEach(t),l_=s(pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=m(bt),y($n.$$.fragment,bt),c_=m(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);y(Nr.$$.fragment,At),p_=m(At),To=a(At,"P",{});var $i=i(To);h_=s($i,"The "),ti=a($i,"A",{href:!0});var y2=i(ti);m_=s(y2,"TFMobileBertForMaskedLM"),y2.forEach(t),u_=s($i," forward method, overrides the "),jl=a($i,"CODE",{});var w2=i(jl);f_=s(w2,"__call__"),w2.forEach(t),g_=s($i," special method."),$i.forEach(t),__=m(At),y(Fn.$$.fragment,At),b_=m(At),y(Bn.$$.fragment,At),T_=m(At),y(En.$$.fragment,At),At.forEach(t),bt.forEach(t),mc=m(o),ko=a(o,"H2",{class:!0});var hp=i(ko);xn=a(hp,"A",{id:!0,class:!0,href:!0});var M2=i(xn);Nl=a(M2,"SPAN",{});var $2=i(Nl);y(Or.$$.fragment,$2),$2.forEach(t),M2.forEach(t),k_=m(hp),Ol=a(hp,"SPAN",{});var F2=i(Ol);v_=s(F2,"TFMobileBertForNextSentencePrediction"),F2.forEach(t),hp.forEach(t),uc=m(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);y(Sr.$$.fragment,Tt),y_=m(Tt),Ar=a(Tt,"P",{});var mp=i(Ar);w_=s(mp,"MobileBert Model with a "),Sl=a(mp,"CODE",{});var B2=i(Sl);M_=s(B2,"next sentence prediction (classification)"),B2.forEach(t),$_=s(mp," head on top."),mp.forEach(t),F_=m(Tt),Ir=a(Tt,"P",{});var up=i(Ir);B_=s(up,"This model inherits from "),oi=a(up,"A",{href:!0});var E2=i(oi);E_=s(E2,"TFPreTrainedModel"),E2.forEach(t),x_=s(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=m(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);P_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var x2=i(Dr);q_=s(x2,"tf.keras.Model"),x2.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var z2=i(ni);A_=s(z2,"TFMobileBertForNextSentencePrediction"),z2.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var P2=i(Al);L_=s(P2,"__call__"),P2.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(Pn.$$.fragment,rs),R_=m(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var q2=i(Cn);Il=a(q2,"SPAN",{});var C2=i(Il);y(Rr.$$.fragment,C2),C2.forEach(t),q2.forEach(t),U_=m(gp),Ll=a(gp,"SPAN",{});var j2=i(Ll);H_=s(j2,"TFMobileBertForSequenceClassification"),j2.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Dl=a(kt,"P",{});var N2=i(Dl);K_=s(N2,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),N2.forEach(t),V_=m(kt),Hr=a(kt,"P",{});var _p=i(Hr);G_=s(_p,"This model inherits from "),si=a(_p,"A",{href:!0});var O2=i(si);Y_=s(O2,"TFPreTrainedModel"),O2.forEach(t),J_=s(_p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),Z_=m(kt),Qr=a(kt,"P",{});var bp=i(Qr);X_=s(bp,"This model is also a "),Kr=a(bp,"A",{href:!0,rel:!0});var S2=i(Kr);eb=s(S2,"tf.keras.Model"),S2.forEach(t),tb=s(bp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bp.forEach(t),ob=m(kt),y(jn.$$.fragment,kt),nb=m(kt),et=a(kt,"DIV",{class:!0});var It=i(et);y(Vr.$$.fragment,It),sb=m(It),wo=a(It,"P",{});var Bi=i(wo);rb=s(Bi,"The "),ri=a(Bi,"A",{href:!0});var A2=i(ri);ab=s(A2,"TFMobileBertForSequenceClassification"),A2.forEach(t),ib=s(Bi," forward method, overrides the "),Wl=a(Bi,"CODE",{});var I2=i(Wl);lb=s(I2,"__call__"),I2.forEach(t),db=s(Bi," special method."),Bi.forEach(t),cb=m(It),y(Nn.$$.fragment,It),pb=m(It),y(On.$$.fragment,It),hb=m(It),y(Sn.$$.fragment,It),It.forEach(t),kt.forEach(t),_c=m(o),Mo=a(o,"H2",{class:!0});var Tp=i(Mo);An=a(Tp,"A",{id:!0,class:!0,href:!0});var L2=i(An);Rl=a(L2,"SPAN",{});var D2=i(Rl);y(Gr.$$.fragment,D2),D2.forEach(t),L2.forEach(t),mb=m(Tp),Ul=a(Tp,"SPAN",{});var W2=i(Ul);ub=s(W2,"TFMobileBertForMultipleChoice"),W2.forEach(t),Tp.forEach(t),bc=m(o),Le=a(o,"DIV",{class:!0});var vt=i(Le);y(Yr.$$.fragment,vt),fb=m(vt),Hl=a(vt,"P",{});var R2=i(Hl);gb=s(R2,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),R2.forEach(t),_b=m(vt),Jr=a(vt,"P",{});var kp=i(Jr);bb=s(kp,"This model inherits from "),ai=a(kp,"A",{href:!0});var U2=i(ai);Tb=s(U2,"TFPreTrainedModel"),U2.forEach(t),kb=s(kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kp.forEach(t),vb=m(vt),Zr=a(vt,"P",{});var vp=i(Zr);yb=s(vp,"This model is also a "),Xr=a(vp,"A",{href:!0,rel:!0});var H2=i(Xr);wb=s(H2,"tf.keras.Model"),H2.forEach(t),Mb=s(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),$b=m(vt),y(In.$$.fragment,vt),Fb=m(vt),ut=a(vt,"DIV",{class:!0});var as=i(ut);y(ea.$$.fragment,as),Bb=m(as),$o=a(as,"P",{});var Ei=i($o);Eb=s(Ei,"The "),ii=a(Ei,"A",{href:!0});var Q2=i(ii);xb=s(Q2,"TFMobileBertForMultipleChoice"),Q2.forEach(t),zb=s(Ei," forward method, overrides the "),Ql=a(Ei,"CODE",{});var K2=i(Ql);Pb=s(K2,"__call__"),K2.forEach(t),qb=s(Ei," special method."),Ei.forEach(t),Cb=m(as),y(Ln.$$.fragment,as),jb=m(as),y(Dn.$$.fragment,as),as.forEach(t),vt.forEach(t),Tc=m(o),Fo=a(o,"H2",{class:!0});var yp=i(Fo);Wn=a(yp,"A",{id:!0,class:!0,href:!0});var V2=i(Wn);Kl=a(V2,"SPAN",{});var G2=i(Kl);y(ta.$$.fragment,G2),G2.forEach(t),V2.forEach(t),Nb=m(yp),Vl=a(yp,"SPAN",{});var Y2=i(Vl);Ob=s(Y2,"TFMobileBertForTokenClassification"),Y2.forEach(t),yp.forEach(t),kc=m(o),De=a(o,"DIV",{class:!0});var yt=i(De);y(oa.$$.fragment,yt),Sb=m(yt),Gl=a(yt,"P",{});var J2=i(Gl);Ab=s(J2,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),J2.forEach(t),Ib=m(yt),na=a(yt,"P",{});var wp=i(na);Lb=s(wp,"This model inherits from "),li=a(wp,"A",{href:!0});var Z2=i(li);Db=s(Z2,"TFPreTrainedModel"),Z2.forEach(t),Wb=s(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),Rb=m(yt),sa=a(yt,"P",{});var Mp=i(sa);Ub=s(Mp,"This model is also a "),ra=a(Mp,"A",{href:!0,rel:!0});var X2=i(ra);Hb=s(X2,"tf.keras.Model"),X2.forEach(t),Qb=s(Mp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
