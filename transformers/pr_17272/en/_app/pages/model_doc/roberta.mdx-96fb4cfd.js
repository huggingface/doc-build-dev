...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/tokenization_roberta.py#L396",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17272/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17272/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17272/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17272/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17272/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u1=h(bt),dh=s(bt,"P",{});var d7=a(dh);g1=i(d7,"Finally, this model supports inherent JAX features such as:"),d7.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var c7=a(ch);Hi=s(c7,"A",{href:!0,rel:!0});var p7=a(Hi);b1=i(p7,"Just-In-Time (JIT) compilation"),p7.forEach(t),c7.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var h7=a(ph);Qi=s(h7,"A",{href:!0,rel:!0});var m7=a(Qi);v1=i(m7,"Automatic Differentiation"),m7.forEach(t),h7.forEach(t),y1=h(ca),hh=s(ca,"LI",{});var f7=a(hh);Vi=s(f7,"A",{href:!0,rel:!0});var u7=a(Vi);T1=i(u7,"Vectorization"),u7.forEach(t),f7.forEach(t),w1=h(ca),mh=s(ca,"LI",{});var g7=a(mh);Ji=s(g7,"A",{href:!0,rel:!0});var _7=a(Ji);$1=i(_7,"Parallelization"),_7.forEach(t),g7.forEach(t),ca.forEach(t),F1=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);T(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var b7=a(fh);M1=i(b7,"FlaxRobertaPreTrainedModel"),b7.forEach(t),E1=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var k7=a(uh);z1=i(k7,"__call__"),k7.forEach(t),C1=i(rc," special method."),rc.forEach(t),q1=h(pa),T(Ds.$$.fragment,pa),j1=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var v7=a(Ws);gh=s(v7,"SPAN",{});var y7=a(gh);T(Gi.$$.fragment,y7),y7.forEach(t),v7.forEach(t),P1=h(Vu),_h=s(Vu,"SPAN",{});var T7=a(_h);L1=i(T7,"FlaxRobertaForSequenceClassification"),T7.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var w7=a(bh);O1=i(w7,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),w7.forEach(t),N1=h(kt),Yi=s(kt,"P",{});var Ju=a(Yi);I1=i(Ju,"This model inherits from "),Ld=s(Ju,"A",{href:!0});var $7=a(Ld);D1=i($7,"FlaxPreTrainedModel"),$7.forEach(t),S1=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ju.forEach(t),W1=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B1=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var F7=a(el);U1=i(F7,"flax.linen.Module"),F7.forEach(t),H1=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var x7=a(kh);V1=i(x7,"Finally, this model supports inherent JAX features such as:"),x7.forEach(t),J1=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var R7=a(vh);tl=s(R7,"A",{href:!0,rel:!0});var M7=a(tl);K1=i(M7,"Just-In-Time (JIT) compilation"),M7.forEach(t),R7.forEach(t),G1=h(ha),yh=s(ha,"LI",{});var E7=a(yh);ol=s(E7,"A",{href:!0,rel:!0});var z7=a(ol);X1=i(z7,"Automatic Differentiation"),z7.forEach(t),E7.forEach(t),Y1=h(ha),Th=s(ha,"LI",{});var C7=a(Th);nl=s(C7,"A",{href:!0,rel:!0});var q7=a(nl);Z1=i(q7,"Vectorization"),q7.forEach(t),C7.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var j7=a(wh);sl=s(j7,"A",{href:!0,rel:!0});var P7=a(sl);t$=i(P7,"Parallelization"),P7.forEach(t),j7.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n$=h(ma),an=s(ma,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var L7=a($h);a$=i(L7,"FlaxRobertaPreTrainedModel"),L7.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A7=a(Fh);i$=i(A7,"__call__"),A7.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ma),T(Bs.$$.fragment,ma),c$=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var O7=a(Hs);xh=s(O7,"SPAN",{});var N7=a(xh);T(rl.$$.fragment,N7),N7.forEach(t),O7.forEach(t),p$=h(Gu),Rh=s(Gu,"SPAN",{});var I7=a(Rh);h$=i(I7,"FlaxRobertaForMultipleChoice"),I7.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m$=h(vt),Mh=s(vt,"P",{});var D7=a(Mh);f$=i(D7,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var B7=a(Eh);$$=i(B7,"Finally, this model supports inherent JAX features such as:"),B7.forEach(t),F$=h(vt),Jt=s(vt,"UL",{});var fa=a(Jt);zh=s(fa,"LI",{});var U7=a(zh);pl=s(U7,"A",{href:!0,rel:!0});var H7=a(pl);x$=i(H7,"Just-In-Time (JIT) compilation"),H7.forEach(t),U7.forEach(t),R$=h(fa),Ch=s(fa,"LI",{});var Q7=a(Ch);hl=s(Q7,"A",{href:!0,rel:!0});var V7=a(hl);M$=i(V7,"Automatic Differentiation"),V7.forEach(t),Q7.forEach(t),E$=h(fa),qh=s(fa,"LI",{});var J7=a(qh);ml=s(J7,"A",{href:!0,rel:!0});var K7=a(ml);z$=i(K7,"Vectorization"),K7.forEach(t),J7.forEach(t),C$=h(fa),jh=s(fa,"LI",{});var G7=a(jh);fl=s(G7,"A",{href:!0,rel:!0});var X7=a(fl);q$=i(X7,"Parallelization"),X7.forEach(t),G7.forEach(t),fa.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);T(ul.$$.fragment,ua),P$=h(ua),ln=s(ua,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var Y7=a(Ph);A$=i(Y7,"FlaxRobertaPreTrainedModel"),Y7.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var Z7=a(Lh);N$=i(Z7,"__call__"),Z7.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(ua),T(Qs.$$.fragment,ua),S$=h(ua),T(Vs.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Js=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Js);Ah=s(eM,"SPAN",{});var tM=a(Ah);T(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W$=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B$=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var yt=a(We);T(_l.$$.fragment,yt),U$=h(yt),Nh=s(yt,"P",{});var nM=a(Nh);H$=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q$=h(yt),bl=s(yt,"P",{});var eg=a(bl);V$=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);J$=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K$=i(eg,`. Check the superclass documentation for the generic methods the
