import{S as ql,i as Nl,s as Sl,e as n,k as m,w,t as a,M as Ol,c as s,d as o,m as p,a as r,x,h as i,b as c,N as Dl,G as e,g as _,y as k,q as T,o as y,B as $,v as Wl,L as vo}from"../../chunks/vendor-hf-doc-builder.js";import{T as go}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as bo}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as G}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _o}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Bl(V){let d,b,g,h,v;return h=new bo({props:{code:`from transformers import ViLTModel, ViLTConfig
...
The vocabulary size of the modalities passed when calling <a href="/docs/transformers/pr_17658/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>. This is used after concatening the
...
</ul>`,name:"pad_and_return_pixel_mask"},{anchor:"transformers.ViltFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17658/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>, defaults to <code>&apos;np&apos;</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/feature_extraction_vilt.py#L181",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17658/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17658/en/model_doc/vilt#transformers.ViltFeatureExtractor">ViltFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_17658/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L761",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17658/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17658/en/model_doc/vilt#transformers.ViltConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17658/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L898"}}),Tt=new j({props:{name:"forward",anchor:"transformers.ViltForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17658/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_17658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17658/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
loss is only computed for the tokens with labels in <em>[0, &#x2026;, config.vocab_size]</em>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17658/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17658/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L1070"}}),Ft=new j({props:{name:"forward",anchor:"transformers.ViltForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17658/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_17658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17658/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
answers are applicable, where 1.0 is the highest score.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L1088",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17658/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17658/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L1280"}}),Mt=new j({props:{name:"forward",anchor:"transformers.ViltForImagesAndTextClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17658/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_17658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17658/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Binary classification labels.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L1299",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17658/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L1181"}}),At=new j({props:{name:"forward",anchor:"transformers.ViltForImageAndTextRetrieval.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17658/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_17658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17658/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Labels are currently not supported.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17658/src/transformers/models/vilt/modeling_vilt.py#L1193",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17658/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),$n=m(),Ot=n("p"),vs=a("Tips:"),Vn=m(),C=n("ul"),tt=n("li"),bs=a("The quickest way to get started with ViLT is by checking the "),ot=n("a"),ws=a("example notebooks"),xs=a(`
(which showcase both inference and fine-tuning on custom data).`),ks=m(),W=n("li"),Ts=a("ViLT is a model that takes both "),To=n("code"),ys=a("pixel_values"),$s=a(" and "),yo=n("code"),Vs=a("input_ids"),Fs=a(" as input. One can use "),Dt=n("a"),js=a("ViltProcessor"),Es=a(` to prepare data for the model.
...
which pixel values are real and which are padding. `),Wt=n("a"),As=a("ViltProcessor"),Ls=a(" automatically creates this for you."),Cs=m(),Vo=n("li"),qs=a(`The design of ViLT is very similar to that of a standard Vision Transformer (ViT). The only difference is that the model includes
additional embedding layers for the language modality.`),Fn=m(),ge=n("img"),jn=m(),_e=n("small"),Ns=a("ViLT architecture. Taken from the "),Bt=n("a"),Ss=a("original paper"),Os=a("."),En=m(),U=n("p"),Ds=a("This model was contributed by "),nt=n("a"),Ws=a("nielsr"),Bs=a(". The original code can be found "),st=n("a"),Rs=a("here"),Qs=a("."),Mn=m(),Z=n("h2"),ve=n("a"),Fo=n("span"),w(rt.$$.fragment),Us=m(),jo=n("span"),Hs=a("ViltConfig"),Pn=m(),M=n("div"),w(at.$$.fragment),Ks=m(),Y=n("p"),Gs=a("This is the configuration class to store the configuration of a "),Eo=n("code"),Js=a("ViLTModel"),Xs=a(`. It is used to instantiate an ViLT
...
documentation from `),Qt=n("a"),sr=a("PretrainedConfig"),rr=a(" for more information."),ar=m(),w(be.$$.fragment),In=m(),te=n("h2"),we=n("a"),Mo=n("span"),w(lt.$$.fragment),ir=m(),Po=n("span"),lr=a("ViltFeatureExtractor"),zn=m(),P=n("div"),w(dt.$$.fragment),dr=m(),Io=n("p"),cr=a("Constructs a ViLT feature extractor."),mr=m(),ct=n("p"),pr=a("This feature extractor inherits from "),Ut=n("a"),hr=a("FeatureExtractionMixin"),fr=a(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ur=m(),H=n("div"),w(mt.$$.fragment),gr=m(),zo=n("p"),_r=a("Main method to prepare for the model one or several image(s)."),vr=m(),w(xe.$$.fragment),An=m(),oe=n("h2"),ke=n("a"),Ao=n("span"),w(pt.$$.fragment),br=m(),Lo=n("span"),wr=a("ViltProcessor"),Ln=m(),I=n("div"),w(ht.$$.fragment),xr=m(),Co=n("p"),kr=a("Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Tr=m(),E=n("p"),Ht=n("a"),yr=a("ViltProcessor"),$r=a(" offers all the functionalities of "),Kt=n("a"),Vr=a("ViltFeatureExtractor"),Fr=a(" and "),Gt=n("a"),jr=a("BertTokenizerFast"),Er=a(`. See the
docstring of `),ft=n("a"),qo=n("strong"),Mr=a("call"),Pr=a("()"),Ir=a(" and "),No=n("code"),zr=a("decode()"),Ar=a(" for more information."),Lr=m(),K=n("div"),w(ut.$$.fragment),Cr=m(),ne=n("p"),qr=a("This method uses "),Te=n("a"),Nr=a("ViltFeatureExtractor."),So=n("strong"),Sr=a("call"),Or=a("()"),Dr=a(` method to prepare image(s) for the model, and
`),ye=n("a"),Wr=a("BertTokenizerFast."),Oo=n("strong"),Br=a("call"),Rr=a("()"),Qr=a(" to prepare text for the model."),Ur=m(),Do=n("p"),Hr=a("Please refer to the docstring of the above two methods for more information."),Cn=m(),se=n("h2"),$e=n("a"),Wo=n("span"),w(gt.$$.fragment),Kr=m(),Bo=n("span"),Gr=a("ViltModel"),qn=m(),B=n("div"),w(_t.$$.fragment),Jr=m(),vt=n("p"),Xr=a(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),ea=m(),q=n("div"),w(bt.$$.fragment),ta=m(),re=n("p"),oa=a("The "),Jt=n("a"),na=a("ViltModel"),sa=a(" forward method, overrides the "),Qo=n("code"),ra=a("__call__"),aa=a(" special method."),ia=m(),w(Ve.$$.fragment),la=m(),w(Fe.$$.fragment),Nn=m(),ae=n("h2"),je=n("a"),Uo=n("span"),w(wt.$$.fragment),da=m(),Ho=n("span"),ca=a("ViltForMaskedLM"),Sn=m(),z=n("div"),w(xt.$$.fragment),ma=m(),Ko=n("p"),pa=a("ViLT Model with a language modeling head on top as done during pretraining."),ha=m(),kt=n("p"),fa=a("This model is a PyTorch "),Go=n("code"),ua=a("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),ga=a(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_a=m(),N=n("div"),w(Tt.$$.fragment),va=m(),ie=n("p"),ba=a("The "),Xt=n("a"),wa=a("ViltForMaskedLM"),xa=a(" forward method, overrides the "),Jo=n("code"),ka=a("__call__"),Ta=a(" special method."),ya=m(),w(Ee.$$.fragment),$a=m(),w(Me.$$.fragment),On=m(),le=n("h2"),Pe=n("a"),Xo=n("span"),w(yt.$$.fragment),Va=m(),Zo=n("span"),Fa=a("ViltForQuestionAnswering"),Dn=m(),A=n("div"),w($t.$$.fragment),ja=m(),Yo=n("p"),Ea=a(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Aa=m(),S=n("div"),w(Ft.$$.fragment),La=m(),de=n("p"),Ca=a("The "),Zt=n("a"),qa=a("ViltForQuestionAnswering"),Na=a(" forward method, overrides the "),tn=n("code"),Sa=a("__call__"),Oa=a(" special method."),Da=m(),w(Ie.$$.fragment),Wa=m(),w(ze.$$.fragment),Wn=m(),ce=n("h2"),Ae=n("a"),on=n("span"),w(jt.$$.fragment),Ba=m(),nn=n("span"),Ra=a("ViltForImagesAndTextClassification"),Bn=m(),R=n("div"),w(Et.$$.fragment),Qa=m(),sn=n("p"),Ua=a("Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Ha=m(),O=n("div"),w(Mt.$$.fragment),Ka=m(),me=n("p"),Ga=a("The "),Yt=n("a"),Ja=a("ViltForImagesAndTextClassification"),Xa=a(" forward method, overrides the "),rn=n("code"),Za=a("__call__"),Ya=a(" special method."),ei=m(),w(Le.$$.fragment),ti=m(),w(Ce.$$.fragment),Rn=m(),pe=n("h2"),qe=n("a"),an=n("span"),w(Pt.$$.fragment),oi=m(),ln=n("span"),ni=a("ViltForImageAndTextRetrieval"),Qn=m(),L=n("div"),w(It.$$.fragment),si=m(),dn=n("p"),ri=a(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ci=m(),D=n("div"),w(At.$$.fragment),mi=m(),he=n("p"),pi=a("The "),eo=n("a"),hi=a("ViltForImageAndTextRetrieval"),fi=a(" forward method, overrides the "),mn=n("code"),ui=a("__call__"),gi=a(" special method."),_i=m(),w(Ne.$$.fragment),vi=m(),w(Se.$$.fragment),this.h()},l(t){const u=Ol('[data-svelte="svelte-1phssyn"]',document.head);d=s(u,"META",{name:!0,content:!0}),u.forEach(o),b=p(t),g=s(t,"H1",{class:!0});var Lt=r(g);h=s(Lt,"A",{id:!0,class:!0,href:!0});var pn=r(h);v=s(pn,"SPAN",{});var hn=r(v);x(l.$$.fragment,hn),hn.forEach(o),pn.forEach(o),f=p(Lt),F=s(Lt,"SPAN",{});var fn=r(F);cs=i(fn,"ViLT"),fn.forEach(o),Lt.forEach(o),xn=p(t),J=s(t,"H2",{class:!0});var Ct=r(J);fe=s(Ct,"A",{id:!0,class:!0,href:!0});var un=r(fe);wo=s(un,"SPAN",{});var gn=r(wo);x(Ye.$$.fragment,gn),gn.forEach(o),un.forEach(o),ms=p(Ct),xo=s(Ct,"SPAN",{});var _n=r(xo);ps=i(_n,"Overview"),_n.forEach(o),Ct.forEach(o),kn=p(t),ue=s(t,"P",{});var qt=r(ue);hs=i(qt,"The ViLT model was proposed in "),et=s(qt,"A",{href:!0,rel:!0});var vn=r(et);fs=i(vn,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),vn.forEach(o),us=i(qt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),qt.forEach(o),Tn=p(t),Nt=s(t,"P",{});var bn=r(Nt);gs=i(bn,"The abstract from the paper is the following:"),bn.forEach(o),yn=p(t),St=s(t,"P",{});var wn=r(St);ko=s(wn,"EM",{});var xi=r(ko);_s=i(xi,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
which pixel values are real and which are padding. `),Wt=s(to,"A",{href:!0});var ji=r(Wt);As=i(ji,"ViltProcessor"),ji.forEach(o),Ls=i(to," automatically creates this for you."),to.forEach(o),Cs=p(Oe),Vo=s(Oe,"LI",{});var Ei=r(Vo);qs=i(Ei,`The design of ViLT is very similar to that of a standard Vision Transformer (ViT). The only difference is that the model includes
additional embedding layers for the language modality.`),Ei.forEach(o),Oe.forEach(o),Fn=p(t),ge=s(t,"IMG",{src:!0,alt:!0,width:!0}),jn=p(t),_e=s(t,"SMALL",{});var Kn=r(_e);Ns=i(Kn,"ViLT architecture. Taken from the "),Bt=s(Kn,"A",{href:!0});var Mi=r(Bt);Ss=i(Mi,"original paper"),Mi.forEach(o),Os=i(Kn,"."),Kn.forEach(o),En=p(t),U=s(t,"P",{});var oo=r(U);Ds=i(oo,"This model was contributed by "),nt=s(oo,"A",{href:!0,rel:!0});var Pi=r(nt);Ws=i(Pi,"nielsr"),Pi.forEach(o),Bs=i(oo,". The original code can be found "),st=s(oo,"A",{href:!0,rel:!0});var Ii=r(st);Rs=i(Ii,"here"),Ii.forEach(o),Qs=i(oo,"."),oo.forEach(o),Mn=p(t),Z=s(t,"H2",{class:!0});var Gn=r(Z);ve=s(Gn,"A",{id:!0,class:!0,href:!0});var zi=r(ve);Fo=s(zi,"SPAN",{});var Ai=r(Fo);x(rt.$$.fragment,Ai),Ai.forEach(o),zi.forEach(o),Us=p(Gn),jo=s(Gn,"SPAN",{});var Li=r(jo);Hs=i(Li,"ViltConfig"),Li.forEach(o),Gn.forEach(o),Pn=p(t),M=s(t,"DIV",{class:!0});var We=r(M);x(at.$$.fragment,We),Ks=p(We),Y=s(We,"P",{});var no=r(Y);Gs=i(no,"This is the configuration class to store the configuration of a "),Eo=s(no,"CODE",{});var Ci=r(Eo);Js=i(Ci,"ViLTModel"),Ci.forEach(o),Xs=i(no,`. It is used to instantiate an ViLT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViLT
`),it=s(no,"A",{href:!0,rel:!0});var qi=r(it);Zs=i(qi,"dandelin/vilt-b32-mlm"),qi.forEach(o),Ys=i(no," architecture."),no.forEach(o),er=p(We),ee=s(We,"P",{});var so=r(ee);tr=i(so,"Configuration objects inherit from "),Rt=s(so,"A",{href:!0});var Ni=r(Rt);or=i(Ni,"PretrainedConfig"),Ni.forEach(o),nr=i(so,` and can be used to control the model outputs. Read the
documentation from `),Qt=s(so,"A",{href:!0});var Si=r(Qt);sr=i(Si,"PretrainedConfig"),Si.forEach(o),rr=i(so," for more information."),so.forEach(o),ar=p(We),x(be.$$.fragment,We),We.forEach(o),In=p(t),te=s(t,"H2",{class:!0});var Jn=r(te);we=s(Jn,"A",{id:!0,class:!0,href:!0});var Oi=r(we);Mo=s(Oi,"SPAN",{});var Di=r(Mo);x(lt.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),ir=p(Jn),Po=s(Jn,"SPAN",{});var Wi=r(Po);lr=i(Wi,"ViltFeatureExtractor"),Wi.forEach(o),Jn.forEach(o),zn=p(t),P=s(t,"DIV",{class:!0});var Be=r(P);x(dt.$$.fragment,Be),dr=p(Be),Io=s(Be,"P",{});var Bi=r(Io);cr=i(Bi,"Constructs a ViLT feature extractor."),Bi.forEach(o),mr=p(Be),ct=s(Be,"P",{});var Xn=r(ct);pr=i(Xn,"This feature extractor inherits from "),Ut=s(Xn,"A",{href:!0});var Ri=r(Ut);hr=i(Ri,"FeatureExtractionMixin"),Ri.forEach(o),fr=i(Xn,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Xn.forEach(o),ur=p(Be),H=s(Be,"DIV",{class:!0});var ro=r(H);x(mt.$$.fragment,ro),gr=p(ro),zo=s(ro,"P",{});var Qi=r(zo);_r=i(Qi,"Main method to prepare for the model one or several image(s)."),Qi.forEach(o),vr=p(ro),x(xe.$$.fragment,ro),ro.forEach(o),Be.forEach(o),An=p(t),oe=s(t,"H2",{class:!0});var Zn=r(oe);ke=s(Zn,"A",{id:!0,class:!0,href:!0});var Ui=r(ke);Ao=s(Ui,"SPAN",{});var Hi=r(Ao);x(pt.$$.fragment,Hi),Hi.forEach(o),Ui.forEach(o),br=p(Zn),Lo=s(Zn,"SPAN",{});var Ki=r(Lo);wr=i(Ki,"ViltProcessor"),Ki.forEach(o),Zn.forEach(o),Ln=p(t),I=s(t,"DIV",{class:!0});var Re=r(I);x(ht.$$.fragment,Re),xr=p(Re),Co=s(Re,"P",{});var Gi=r(Co);kr=i(Gi,"Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Gi.forEach(o),Tr=p(Re),E=s(Re,"P",{});var Q=r(E);Ht=s(Q,"A",{href:!0});var Ji=r(Ht);yr=i(Ji,"ViltProcessor"),Ji.forEach(o),$r=i(Q," offers all the functionalities of "),Kt=s(Q,"A",{href:!0});var Xi=r(Kt);Vr=i(Xi,"ViltFeatureExtractor"),Xi.forEach(o),Fr=i(Q," and "),Gt=s(Q,"A",{href:!0});var Zi=r(Gt);jr=i(Zi,"BertTokenizerFast"),Zi.forEach(o),Er=i(Q,`. See the
docstring of `),ft=s(Q,"A",{href:!0});var bi=r(ft);qo=s(bi,"STRONG",{});var Yi=r(qo);Mr=i(Yi,"call"),Yi.forEach(o),Pr=i(bi,"()"),bi.forEach(o),Ir=i(Q," and "),No=s(Q,"CODE",{});var el=r(No);zr=i(el,"decode()"),el.forEach(o),Ar=i(Q," for more information."),Q.forEach(o),Lr=p(Re),K=s(Re,"DIV",{class:!0});var ao=r(K);x(ut.$$.fragment,ao),Cr=p(ao),ne=s(ao,"P",{});var io=r(ne);qr=i(io,"This method uses "),Te=s(io,"A",{href:!0});var Yn=r(Te);Nr=i(Yn,"ViltFeatureExtractor."),So=s(Yn,"STRONG",{});var tl=r(So);Sr=i(tl,"call"),tl.forEach(o),Or=i(Yn,"()"),Yn.forEach(o),Dr=i(io,` method to prepare image(s) for the model, and
`),ye=s(io,"A",{href:!0});var es=r(ye);Wr=i(es,"BertTokenizerFast."),Oo=s(es,"STRONG",{});var ol=r(Oo);Br=i(ol,"call"),ol.forEach(o),Rr=i(es,"()"),es.forEach(o),Qr=i(io," to prepare text for the model."),io.forEach(o),Ur=p(ao),Do=s(ao,"P",{});var nl=r(Do);Hr=i(nl,"Please refer to the docstring of the above two methods for more information."),nl.forEach(o),ao.forEach(o),Re.forEach(o),Cn=p(t),se=s(t,"H2",{class:!0});var ts=r(se);$e=s(ts,"A",{id:!0,class:!0,href:!0});var sl=r($e);Wo=s(sl,"SPAN",{});var rl=r(Wo);x(gt.$$.fragment,rl),rl.forEach(o),sl.forEach(o),Kr=p(ts),Bo=s(ts,"SPAN",{});var al=r(Bo);Gr=i(al,"ViltModel"),al.forEach(o),ts.forEach(o),qn=p(t),B=s(t,"DIV",{class:!0});var lo=r(B);x(_t.$$.fragment,lo),Jr=p(lo),vt=s(lo,"P",{});var os=r(vt);Xr=i(os,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),os.forEach(o),ea=p(lo),q=s(lo,"DIV",{class:!0});var Qe=r(q);x(bt.$$.fragment,Qe),ta=p(Qe),re=s(Qe,"P",{});var co=r(re);oa=i(co,"The "),Jt=s(co,"A",{href:!0});var ll=r(Jt);na=i(ll,"ViltModel"),ll.forEach(o),sa=i(co," forward method, overrides the "),Qo=s(co,"CODE",{});var dl=r(Qo);ra=i(dl,"__call__"),dl.forEach(o),aa=i(co," special method."),co.forEach(o),ia=p(Qe),x(Ve.$$.fragment,Qe),la=p(Qe),x(Fe.$$.fragment,Qe),Qe.forEach(o),lo.forEach(o),Nn=p(t),ae=s(t,"H2",{class:!0});var ns=r(ae);je=s(ns,"A",{id:!0,class:!0,href:!0});var cl=r(je);Uo=s(cl,"SPAN",{});var ml=r(Uo);x(wt.$$.fragment,ml),ml.forEach(o),cl.forEach(o),da=p(ns),Ho=s(ns,"SPAN",{});var pl=r(Ho);ca=i(pl,"ViltForMaskedLM"),pl.forEach(o),ns.forEach(o),Sn=p(t),z=s(t,"DIV",{class:!0});var Ue=r(z);x(xt.$$.fragment,Ue),ma=p(Ue),Ko=s(Ue,"P",{});var hl=r(Ko);pa=i(hl,"ViLT Model with a language modeling head on top as done during pretraining."),hl.forEach(o),ha=p(Ue),kt=s(Ue,"P",{});var ss=r(kt);fa=i(ss,"This model is a PyTorch "),Go=s(ss,"CODE",{});var fl=r(Go);ua=i(fl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),fl.forEach(o),ga=i(ss,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ss.forEach(o),_a=p(Ue),N=s(Ue,"DIV",{class:!0});var He=r(N);x(Tt.$$.fragment,He),va=p(He),ie=s(He,"P",{});var mo=r(ie);ba=i(mo,"The "),Xt=s(mo,"A",{href:!0});var ul=r(Xt);wa=i(ul,"ViltForMaskedLM"),ul.forEach(o),xa=i(mo," forward method, overrides the "),Jo=s(mo,"CODE",{});var gl=r(Jo);ka=i(gl,"__call__"),gl.forEach(o),Ta=i(mo," special method."),mo.forEach(o),ya=p(He),x(Ee.$$.fragment,He),$a=p(He),x(Me.$$.fragment,He),He.forEach(o),Ue.forEach(o),On=p(t),le=s(t,"H2",{class:!0});var rs=r(le);Pe=s(rs,"A",{id:!0,class:!0,href:!0});var _l=r(Pe);Xo=s(_l,"SPAN",{});var vl=r(Xo);x(yt.$$.fragment,vl),vl.forEach(o),_l.forEach(o),Va=p(rs),Zo=s(rs,"SPAN",{});var bl=r(Zo);Fa=i(bl,"ViltForQuestionAnswering"),bl.forEach(o),rs.forEach(o),Dn=p(t),A=s(t,"DIV",{class:!0});var Ke=r(A);x($t.$$.fragment,Ke),ja=p(Ke),Yo=s(Ke,"P",{});var wl=r(Yo);Ea=i(wl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
token) for visual question answering, e.g. for VQAv2.`),wl.forEach(o),Ma=p(Ke),Vt=s(Ke,"P",{});var as=r(Vt);Pa=i(as,"This model is a PyTorch "),en=s(as,"CODE",{});var xl=r(en);Ia=i(xl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),xl.forEach(o),za=i(as,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),as.forEach(o),Aa=p(Ke),S=s(Ke,"DIV",{class:!0});var Ge=r(S);x(Ft.$$.fragment,Ge),La=p(Ge),de=s(Ge,"P",{});var po=r(de);Ca=i(po,"The "),Zt=s(po,"A",{href:!0});var kl=r(Zt);qa=i(kl,"ViltForQuestionAnswering"),kl.forEach(o),Na=i(po," forward method, overrides the "),tn=s(po,"CODE",{});var Tl=r(tn);Sa=i(Tl,"__call__"),Tl.forEach(o),Oa=i(po," special method."),po.forEach(o),Da=p(Ge),x(Ie.$$.fragment,Ge),Wa=p(Ge),x(ze.$$.fragment,Ge),Ge.forEach(o),Ke.forEach(o),Wn=p(t),ce=s(t,"H2",{class:!0});var is=r(ce);Ae=s(is,"A",{id:!0,class:!0,href:!0});var yl=r(Ae);on=s(yl,"SPAN",{});var $l=r(on);x(jt.$$.fragment,$l),$l.forEach(o),yl.forEach(o),Ba=p(is),nn=s(is,"SPAN",{});var Vl=r(nn);Ra=i(Vl,"ViltForImagesAndTextClassification"),Vl.forEach(o),is.forEach(o),Bn=p(t),R=s(t,"DIV",{class:!0});var ho=r(R);x(Et.$$.fragment,ho),Qa=p(ho),sn=s(ho,"P",{});var Fl=r(sn);Ua=i(Fl,"Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Fl.forEach(o),Ha=p(ho),O=s(ho,"DIV",{class:!0});var Je=r(O);x(Mt.$$.fragment,Je),Ka=p(Je),me=s(Je,"P",{});var fo=r(me);Ga=i(fo,"The "),Yt=s(fo,"A",{href:!0});var jl=r(Yt);Ja=i(jl,"ViltForImagesAndTextClassification"),jl.forEach(o),Xa=i(fo," forward method, overrides the "),rn=s(fo,"CODE",{});var El=r(rn);Za=i(El,"__call__"),El.forEach(o),Ya=i(fo," special method."),fo.forEach(o),ei=p(Je),x(Le.$$.fragment,Je),ti=p(Je),x(Ce.$$.fragment,Je),Je.forEach(o),ho.forEach(o),Rn=p(t),pe=s(t,"H2",{class:!0});var ls=r(pe);qe=s(ls,"A",{id:!0,class:!0,href:!0});var Ml=r(qe);an=s(Ml,"SPAN",{});var Pl=r(an);x(Pt.$$.fragment,Pl),Pl.forEach(o),Ml.forEach(o),oi=p(ls),ln=s(ls,"SPAN",{});var Il=r(ln);ni=i(Il,"ViltForImageAndTextRetrieval"),Il.forEach(o),ls.forEach(o),Qn=p(t),L=s(t,"DIV",{class:!0});var Xe=r(L);x(It.$$.fragment,Xe),si=p(Xe),dn=s(Xe,"P",{});var zl=r(dn);ri=i(zl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
