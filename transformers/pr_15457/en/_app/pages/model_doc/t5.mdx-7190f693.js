...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/tokenization_t5.py#L223",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/tokenization_t5.py#L163",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/tokenization_t5.py#L201",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/tokenization_t5_fast.py#L165",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15457/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15457/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_15457/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15457/en/model_doc/t5#transformers.T5Config"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1301"}}),xs=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1313"}}),zs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1539",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1495"}}),Is=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1508"}}),Ss=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_15457/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1810",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1773"}}),Js=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Xs=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_t5.py#L1784"}}),Qs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_tf_t5.py#L1134",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15457/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_tf_t5.py#L1309",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15457/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15457/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15457/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_tf_t5.py#L1618",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/pr_15457/src/transformers/models/t5/modeling_flax_t5.py#L958",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15457/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_15457/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15457/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_15457/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_5=d(),f(Kn.$$.fragment),g5=d(),Ze=a("div"),f(ga.$$.fragment),T5=d(),un=a("p"),b5=o("The "),Or=a("a"),v5=o("TFT5ForConditionalGeneration"),k5=o(" forward method, overrides the "),cl=a("code"),y5=o("__call__"),w5=o(" special method."),x5=d(),f(Yn.$$.fragment),$5=d(),pl=a("p"),z5=o("Examples:"),j5=d(),f(Ta.$$.fragment),Bc=d(),mn=a("h2"),Zn=a("a"),hl=a("span"),f(ba.$$.fragment),q5=d(),ul=a("span"),E5=o("TFT5EncoderModel"),Hc=d(),ce=a("div"),f(va.$$.fragment),F5=d(),ml=a("p"),M5=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),C5=d(),ka=a("p"),P5=o("The T5 model was proposed in "),ya=a("a"),N5=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),R5=d(),f(Jn.$$.fragment),B5=d(),Je=a("div"),f(za.$$.fragment),H5=d(),fn=a("p"),V5=o("The "),Ar=a("a"),K5=o("TFT5EncoderModel"),Y5=o(" forward method, overrides the "),fl=a("code"),Z5=o("__call__"),J5=o(" special method."),X5=d(),f(Xn.$$.fragment),Q5=d(),_l=a("p"),eb=o("Examples:"),tb=d(),f(ja.$$.fragment),Vc=d(),_n=a("h2"),Qn=a("a"),gl=a("span"),f(qa.$$.fragment),nb=d(),Tl=a("span"),ob=o("FlaxT5Model"),Kc=d(),rt=a("div"),f(Ea.$$.fragment),sb=d(),Xe=a("div"),f(Fa.$$.fragment),ab=d(),gn=a("p"),rb=o("The "),bl=a("code"),ib=o("FlaxT5PreTrainedModel"),db=o(" forward method, overrides the "),vl=a("code"),lb=o("__call__"),cb=o(" special method."),pb=d(),f(eo.$$.fragment),hb=d(),kl=a("p"),ub=o("Example:"),mb=d(),f(Ma.$$.fragment),fb=d(),Et=a("div"),f(Ca.$$.fragment),_b=d(),yl=a("p"),gb=o("Example:"),Tb=d(),f(Pa.$$.fragment),bb=d(),Ft=a("div"),f(Na.$$.fragment),vb=d(),wl=a("p"),kb=o("Example:"),yb=d(),f(Oa.$$.fragment),Yc=d(),Tn=a("h2"),to=a("a"),xl=a("span"),f(La.$$.fragment),wb=d(),$l=a("span"),xb=o("FlaxT5ForConditionalGeneration"),Zc=d(),it=a("div"),f(Aa.$$.fragment),$b=d(),Qe=a("div"),f(Ia.$$.fragment),zb=d(),bn=a("p"),jb=o("The "),zl=a("code"),qb=o("FlaxT5PreTrainedModel"),Eb=o(" forward method, overrides the "),jl=a("code"),Fb=o("__call__"),Mb=o(" special method."),Cb=d(),f(no.$$.fragment),Pb=d(),ql=a("p"),Nb=o("Example:"),Ob=d(),f(Da.$$.fragment),Lb=d(),Mt=a("div"),f(Sa.$$.fragment),Ab=d(),El=a("p"),Ib=o("Example:"),Db=d(),f(Ga.$$.fragment),Sb=d(),Ct=a("div"),f(Ua.$$.fragment),Gb=d(),Fl=a("p"),Ub=o("Example:"),Wb=d(),f(Wa.$$.fragment),this.h()},l(t){const h=mw('[data-svelte="svelte-1phssyn"]',document.head);u=r(h,"META",{name:!0,content:!0}),h.forEach(n),z=l(t),k=r(t,"H1",{class:!0});var Ra=i(k);w=r(Ra,"A",{id:!0,class:!0,href:!0});var Ml=i(w);$=r(Ml,"SPAN",{});var Cl=i($);_(x.$$.fragment,Cl),Cl.forEach(n),Ml.forEach(n),y=l(Ra),j=r(Ra,"SPAN",{});var Pl=i(j);ze=s(Pl,"T5"),Pl.forEach(n),Ra.forEach(n),se=l(t),q=r(t,"H2",{class:!0});var Ba=i(q);ee=r(Ba,"A",{id:!0,class:!0,href:!0});var Nl=i(ee);G=r(Nl,"SPAN",{});var Ol=i(G);_(ae.$$.fragment,Ol),Ol.forEach(n),Nl.forEach(n),je=l(Ba),U=r(Ba,"SPAN",{});var Ll=i(U);qe=s(Ll,"Overview"),Ll.forEach(n),Ba.forEach(n),be=l(t),W=r(t,"P",{});var Ha=i(W);A=s(Ha,"The T5 model was presented in "),re=r(Ha,"A",{href:!0,rel:!0});var Al=i(re);pe=s(Al,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Al.forEach(n),F=s(Ha,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),Ha.forEach(n),P=l(t),he=r(t,"P",{});var Il=i(he);K=s(Il,"The abstract from the paper is the following:"),Il.forEach(n),ve=l(t),ue=r(t,"P",{});var Yb=i(ue);R=r(Yb,"EM",{});var Zb=i(R);Ee=s(Zb,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),Zb.forEach(n),Yb.forEach(n),ke=l(t),C=r(t,"P",{});var Jb=i(C);Fe=s(Jb,"Tips:"),Jb.forEach(n),H=l(t),V=r(t,"UL",{});var Ir=i(V);_e=r(Ir,"LI",{});var Xb=i(_e);N=r(Xb,"P",{});var Dr=i(N);Me=s(Dr,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),ge=r(Dr,"EM",{});var Qb=i(ge);I=s(Qb,"translate English to German: \u2026"),Qb.forEach(n),Ce=s(Dr,`,
for summarization: `),B=r(Dr,"EM",{});var ev=i(B);Pe=s(ev,"summarize: \u2026"),ev.forEach(n),m=s(Dr,"."),Dr.forEach(n),Xb.forEach(n),E=l(Ir),te=r(Ir,"LI",{});var tv=i(te);De=r(tv,"P",{});var nv=i(De);dt=s(nv,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),nv.forEach(n),tv.forEach(n),D=l(Ir),Se=r(Ir,"LI",{});var ov=i(Se);ne=r(ov,"P",{});var oo=i(ne);lt=s(oo,"See the "),O=r(oo,"A",{href:!0});var sv=i(O);Y=s(sv,"training"),sv.forEach(n),ct=s(oo,", "),Ne=r(oo,"A",{href:!0});var av=i(Ne);Z=s(av,"inference"),av.forEach(n),pt=s(oo," and "),Oe=r(oo,"A",{href:!0});var rv=i(Oe);Le=s(rv,"scripts"),rv.forEach(n),ht=s(oo," sections below for all details regarding usage."),oo.forEach(n),ov.forEach(n),Ir.forEach(n),Ul=l(t),Va=r(t,"P",{});var iv=i(Va);Kp=s(iv,"T5 comes in different sizes:"),iv.forEach(n),Wl=l(t),Ge=r(t,"UL",{});var Pt=i(Ge);di=r(Pt,"LI",{});var dv=i(di);li=r(dv,"P",{});var lv=i(li);mo=r(lv,"A",{href:!0,rel:!0});var cv=i(mo);Yp=s(cv,"t5-small"),cv.forEach(n),lv.forEach(n),dv.forEach(n),Zp=l(Pt),ci=r(Pt,"LI",{});var pv=i(ci);pi=r(pv,"P",{});var hv=i(pi);fo=r(hv,"A",{href:!0,rel:!0});var uv=i(fo);Jp=s(uv,"t5-base"),uv.forEach(n),hv.forEach(n),pv.forEach(n),Xp=l(Pt),hi=r(Pt,"LI",{});var mv=i(hi);ui=r(mv,"P",{});var fv=i(ui);_o=r(fv,"A",{href:!0,rel:!0});var _v=i(_o);Qp=s(_v,"t5-large"),_v.forEach(n),fv.forEach(n),mv.forEach(n),eh=l(Pt),mi=r(Pt,"LI",{});var gv=i(mi);fi=r(gv,"P",{});var Tv=i(fi);go=r(Tv,"A",{href:!0,rel:!0});var bv=i(go);th=s(bv,"t5-3b"),bv.forEach(n),Tv.forEach(n),gv.forEach(n),nh=l(Pt),_i=r(Pt,"LI",{});var vv=i(_i);Ka=r(vv,"P",{});var Rb=i(Ka);To=r(Rb,"A",{href:!0,rel:!0});var kv=i(To);oh=s(kv,"t5-11b"),kv.forEach(n),sh=s(Rb,"."),Rb.forEach(n),vv.forEach(n),Pt.forEach(n),Rl=l(t),Ya=r(t,"P",{});var yv=i(Ya);ah=s(yv,"Based on the original T5 model, Google has released some follow-up works:"),yv.forEach(n),Bl=l(t),wt=r(t,"UL",{});var Sr=i(wt);gi=r(Sr,"LI",{});var wv=i(gi);vn=r(wv,"P",{});var Dl=i(vn);Ti=r(Dl,"STRONG",{});var xv=i(Ti);rh=s(xv,"T5v1.1"),xv.forEach(n),ih=s(Dl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Za=r(Dl,"A",{href:!0});var $v=i(Za);dh=s($v,"here"),$v.forEach(n),lh=s(Dl,"."),Dl.forEach(n),wv.forEach(n),ch=l(Sr),bi=r(Sr,"LI",{});var zv=i(bi);kn=r(zv,"P",{});var Sl=i(kn);vi=r(Sl,"STRONG",{});var jv=i(vi);ph=s(jv,"mT5"),jv.forEach(n),hh=s(Sl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),Ja=r(Sl,"A",{href:!0});var qv=i(Ja);uh=s(qv,"here"),qv.forEach(n),mh=s(Sl,"."),Sl.forEach(n),zv.forEach(n),fh=l(Sr),ki=r(Sr,"LI",{});var Ev=i(ki);yn=r(Ev,"P",{});var Gl=i(yn);yi=r(Gl,"STRONG",{});var Fv=i(yi);_h=s(Fv,"byT5"),Fv.forEach(n),gh=s(Gl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Xa=r(Gl,"A",{href:!0});var Mv=i(Xa);Th=s(Mv,"here"),Mv.forEach(n),bh=s(Gl,"."),Gl.forEach(n),Ev.forEach(n),Sr.forEach(n),Hl=l(t),wn=r(t,"P",{});var Xc=i(wn);vh=s(Xc,"All checkpoints can be found on the "),bo=r(Xc,"A",{href:!0,rel:!0});var Cv=i(bo);kh=s(Cv,"hub"),Cv.forEach(n),yh=s(Xc,"."),Xc.forEach(n),Vl=l(t),xt=r(t,"P",{});var Gr=i(xt);wh=s(Gr,"This model was contributed by "),vo=r(Gr,"A",{href:!0,rel:!0});var Pv=i(vo);xh=s(Pv,"thomwolf"),Pv.forEach(n),$h=s(Gr,". The original code can be found "),ko=r(Gr,"A",{href:!0,rel:!0});var Nv=i(ko);zh=s(Nv,"here"),Nv.forEach(n),jh=s(Gr,"."),Gr.forEach(n),Kl=l(t),Qa=r(t,"A",{id:!0}),i(Qa).forEach(n),Yl=l(t),Vt=r(t,"H2",{class:!0});var Qc=i(Vt);xn=r(Qc,"A",{id:!0,class:!0,href:!0});var Ov=i(xn);wi=r(Ov,"SPAN",{});var Lv=i(wi);_(yo.$$.fragment,Lv),Lv.forEach(n),Ov.forEach(n),qh=l(Qc),xi=r(Qc,"SPAN",{});var Av=i(xi);Eh=s(Av,"Training"),Av.forEach(n),Qc.forEach(n),Zl=l(t),ut=r(t,"P",{});var so=i(ut);Fh=s(so,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),$i=r(so,"CODE",{});var Iv=i($i);Mh=s(Iv,"input_ids"),Iv.forEach(n),Ch=s(so,`. The target sequence is shifted to the right, i.e., prepended by a
start-sequence token and fed to the decoder using the `),zi=r(so,"CODE",{});var Dv=i(zi);Ph=s(Dv,"decoder_input_ids"),Dv.forEach(n),Nh=s(so,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),ji=r(so,"CODE",{});var Sv=i(ji);Oh=s(Sv,"labels"),Sv.forEach(n),Lh=s(so,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),so.forEach(n),Jl=l(t),$n=r(t,"P",{});var ep=i($n);Ah=s(ep,"One can use "),er=r(ep,"A",{href:!0});var Gv=i(er);Ih=s(Gv,"T5ForConditionalGeneration"),Gv.forEach(n),Dh=s(ep,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),ep.forEach(n),Xl=l(t),tr=r(t,"UL",{});var Uv=i(tr);qi=r(Uv,"LI",{});var Wv=i(qi);Sh=s(Wv,"Unsupervised denoising training"),Wv.forEach(n),Uv.forEach(n),Ql=l(t),me=r(t,"P",{});var et=i(me);Gh=s(et,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Ei=r(et,"EM",{});var Rv=i(Ei);Uh=s(Rv,"a.k.a"),Rv.forEach(n),Wh=s(et,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=r(et,"EM",{});var Bv=i(Fi);Rh=s(Bv,"real"),Bv.forEach(n),Bh=s(et,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Mi=r(et,"CODE",{});var Hv=i(Mi);Hh=s(Hv,"<extra_id_0>"),Hv.forEach(n),Vh=s(et,`,
`),Ci=r(et,"CODE",{});var Vv=i(Ci);Kh=s(Vv,"<extra_id_1>"),Vv.forEach(n),Yh=s(et,", \u2026 up to "),Pi=r(et,"CODE",{});var Kv=i(Pi);Zh=s(Kv,"<extra_id_99>"),Kv.forEach(n),Jh=s(et,`. As a default, 100 sentinel tokens are available in
`),nr=r(et,"A",{href:!0});var Yv=i(nr);Xh=s(Yv,"T5Tokenizer"),Yv.forEach(n),Qh=s(et,"."),et.forEach(n),ec=l(t),or=r(t,"P",{});var Zv=i(or);eu=s(Zv,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Zv.forEach(n),tc=l(t),_(wo.$$.fragment,t),nc=l(t),zn=r(t,"P",{});var tp=i(zn);tu=s(tp,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),xo=r(tp,"A",{href:!0,rel:!0});var Jv=i(xo);nu=s(Jv,"run_t5_mlm_flax.py"),Jv.forEach(n),ou=s(tp,` script in the Examples
directory.`),tp.forEach(n),oc=l(t),sr=r(t,"UL",{});var Xv=i(sr);Ni=r(Xv,"LI",{});var Qv=i(Ni);su=s(Qv,"Supervised training"),Qv.forEach(n),Xv.forEach(n),sc=l(t),ar=r(t,"P",{});var ek=i(ar);au=s(ek,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),ek.forEach(n),ac=l(t),_($o.$$.fragment,t),rc=l(t),oe=r(t,"P",{});var ye=i(oe);ru=s(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Oi=r(ye,"CODE",{});var tk=i(Oi);iu=s(tk,"input_ids"),tk.forEach(n),du=s(ye,` (which are the
`),Li=r(ye,"CODE",{});var nk=i(Li);lu=s(nk,"input_ids"),nk.forEach(n),cu=s(ye," of the encoded input sequence) and "),Ai=r(ye,"CODE",{});var ok=i(Ai);pu=s(ok,"labels"),ok.forEach(n),hu=s(ye," (which are the "),Ii=r(ye,"CODE",{});var sk=i(Ii);uu=s(sk,"input_ids"),sk.forEach(n),mu=s(ye,` of the encoded
target sequence). The model will automatically create the `),Di=r(ye,"CODE",{});var ak=i(Di);fu=s(ak,"decoder_input_ids"),ak.forEach(n),_u=s(ye," based on the "),Si=r(ye,"CODE",{});var rk=i(Si);gu=s(rk,"labels"),rk.forEach(n),Tu=s(ye,`, by
shifting them one position to the right and prepending the `),Gi=r(ye,"CODE",{});var ik=i(Gi);bu=s(ik,"config.decoder_start_token_id"),ik.forEach(n),vu=s(ye,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Ui=r(Ur,"CODE",{});var dk=i(Ui);yu=s(dk,"max_source_length"),dk.forEach(n),wu=s(Ur," and "),Wi=r(Ur,"CODE",{});var lk=i(Wi);xu=s(lk,"max_target_length"),lk.forEach(n),$u=s(Ur,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Ur.forEach(n),dc=l(t),fe=r(t,"P",{});var tt=i(fe);zu=s(tt,"In addition, we must make sure that padding token id\u2019s of the "),Ri=r(tt,"CODE",{});var ck=i(Ri);ju=s(ck,"labels"),ck.forEach(n),qu=s(tt,` are not taken into account by the loss
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Bi=r(tt,"CODE",{});var pk=i(Bi);Eu=s(pk,"ignore_index"),pk.forEach(n),Fu=s(tt,`
of the `),Hi=r(tt,"CODE",{});var hk=i(Hi);Mu=s(hk,"CrossEntropyLoss"),hk.forEach(n),Cu=s(tt,". In Flax, one can use the "),Vi=r(tt,"CODE",{});var uk=i(Vi);Pu=s(uk,"decoder_attention_mask"),uk.forEach(n),Nu=s(tt,` to ignore padded tokens from
the loss (see the `),zo=r(tt,"A",{href:!0,rel:!0});var mk=i(zo);Ou=s(mk,"Flax summarization script"),mk.forEach(n),Lu=s(tt,` for details). We also pass
`),Ki=r(tt,"CODE",{});var fk=i(Ki);Au=s(fk,"attention_mask"),fk.forEach(n),Iu=s(tt,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),tt.forEach(n),lc=l(t),_(jo.$$.fragment,t),cc=l(t),rr=r(t,"P",{});var _k=i(rr);Du=s(_k,"Additional training tips:"),_k.forEach(n),pc=l(t),ir=r(t,"UL",{});var gk=i(ir);qo=r(gk,"LI",{});var np=i(qo);Su=s(np,"T5 models need a slightly higher learning rate than the default one set in the "),Yi=r(np,"CODE",{});var Tk=i(Yi);Gu=s(Tk,"Trainer"),Tk.forEach(n),Uu=s(np,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),np.forEach(n),gk.forEach(n),hc=l(t),zt=r(t,"P",{});var Wr=i(zt);Wu=s(Wr,"According to "),Eo=r(Wr,"A",{href:!0,rel:!0});var bk=i(Eo);Ru=s(bk,"this forum post"),bk.forEach(n),Bu=s(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Fo=r(Wr,"A",{href:!0,rel:!0});var vk=i(Fo);Hu=s(vk,"paper"),vk.forEach(n),Vu=s(Wr,` for the task prefixes
...
`),Zi=r(op,"EM",{});var kk=i(Zi);Yu=s(kk,"pad_to_multiple_of"),kk.forEach(n),Zu=s(op,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),op.forEach(n),mc=l(t),dr=r(t,"A",{id:!0}),i(dr).forEach(n),fc=l(t),Kt=r(t,"H2",{class:!0});var sp=i(Kt);qn=r(sp,"A",{id:!0,class:!0,href:!0});var yk=i(qn);Ji=r(yk,"SPAN",{});var wk=i(Ji);_(Mo.$$.fragment,wk),wk.forEach(n),yk.forEach(n),Ju=l(sp),Xi=r(sp,"SPAN",{});var xk=i(Xi);Xu=s(xk,"Inference"),xk.forEach(n),sp.forEach(n),_c=l(t),mt=r(t,"P",{});var ao=i(mt);Qu=s(ao,"At inference time, it is recommended to use "),lr=r(ao,"A",{href:!0});var $k=i(lr);em=s($k,"generate()"),$k.forEach(n),tm=s(ao,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),Co=r(ao,"A",{href:!0,rel:!0});var zk=i(Co);nm=s(zk,"this blog post"),zk.forEach(n),om=s(ao,` to know all the details about generating text with Transformers.
There\u2019s also `),Po=r(ao,"A",{href:!0,rel:!0});var jk=i(Po);sm=s(jk,"this blog post"),jk.forEach(n),am=s(ao,` which explains how
generation works in general in encoder-decoder models.`),ao.forEach(n),gc=l(t),_(No.$$.fragment,t),Tc=l(t),Ue=r(t,"P",{});var Nt=i(Ue);rm=s(Nt,"Note that T5 uses the "),Qi=r(Nt,"CODE",{});var qk=i(Qi);im=s(qk,"pad_token_id"),qk.forEach(n),dm=s(Nt," as the "),ed=r(Nt,"CODE",{});var Ek=i(ed);lm=s(Ek,"decoder_start_token_id"),Ek.forEach(n),cm=s(Nt,`, so when doing generation without using
`),cr=r(Nt,"A",{href:!0});var Fk=i(cr);pm=s(Fk,"generate()"),Fk.forEach(n),hm=s(Nt,", make sure you start it with the "),td=r(Nt,"CODE",{});var Mk=i(td);um=s(Mk,"pad_token_id"),Mk.forEach(n),mm=s(Nt,"."),Nt.forEach(n),bc=l(t),pr=r(t,"P",{});var Ck=i(pr);fm=s(Ck,"The example above only shows a single example. You can also do batched inference, like so:"),Ck.forEach(n),vc=l(t),_(Oo.$$.fragment,t),kc=l(t),hr=r(t,"P",{});var Pk=i(hr);_m=s(Pk,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),Pk.forEach(n),yc=l(t),_(Lo.$$.fragment,t),wc=l(t),ur=r(t,"A",{id:!0}),i(ur).forEach(n),xc=l(t),Yt=r(t,"H2",{class:!0});var ap=i(Yt);En=r(ap,"A",{id:!0,class:!0,href:!0});var Nk=i(En);nd=r(Nk,"SPAN",{});var Ok=i(nd);_(Ao.$$.fragment,Ok),Ok.forEach(n),Nk.forEach(n),gm=l(ap),od=r(ap,"SPAN",{});var Lk=i(od);Tm=s(Lk,"Performance"),Lk.forEach(n),ap.forEach(n),$c=l(t),ft=r(t,"P",{});var ro=i(ft);bm=s(ro,"If you\u2019d like a faster training and inference performance, install "),Io=r(ro,"A",{href:!0,rel:!0});var Ak=i(Io);vm=s(Ak,"apex"),Ak.forEach(n),km=s(ro," and then the model will automatically use "),sd=r(ro,"CODE",{});var Ik=i(sd);ym=s(Ik,"apex.normalization.FusedRMSNorm"),Ik.forEach(n),wm=s(ro," instead of "),ad=r(ro,"CODE",{});var Dk=i(ad);xm=s(Dk,"T5LayerNorm"),Dk.forEach(n),$m=s(ro,". The former uses an optimized fused kernel which is several times faster than the latter."),ro.forEach(n),zc=l(t),Zt=r(t,"H2",{class:!0});var rp=i(Zt);Fn=r(rp,"A",{id:!0,class:!0,href:!0});var Sk=i(Fn);rd=r(Sk,"SPAN",{});var Gk=i(rd);_(Do.$$.fragment,Gk),Gk.forEach(n),Sk.forEach(n),zm=l(rp),id=r(rp,"SPAN",{});var Uk=i(id);jm=s(Uk,"Example scripts"),Uk.forEach(n),rp.forEach(n),jc=l(t),mr=r(t,"P",{});var Wk=i(mr);qm=s(Wk,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Wk.forEach(n),qc=l(t),Mn=r(t,"UL",{});var ip=i(Mn);dd=r(ip,"LI",{});var Rk=i(dd);Jt=r(Rk,"P",{});var Rr=i(Jt);Em=s(Rr,"pre-training: the "),So=r(Rr,"A",{href:!0,rel:!0});var Bk=i(So);Fm=s(Bk,"run_t5_mlm_flax.py"),Bk.forEach(n),Mm=s(Rr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Go=r(Rr,"A",{href:!0,rel:!0});var Hk=i(Go);Cm=s(Hk,"t5_tokenizer_model.py"),Hk.forEach(n),Pm=s(Rr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Rr.forEach(n),Rk.forEach(n),Nm=l(ip),ld=r(ip,"LI",{});var Vk=i(ld);Ae=r(Vk,"P",{});var bt=i(Ae);Om=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),Uo=r(bt,"A",{href:!0,rel:!0});var Kk=i(Uo);Lm=s(Kk,"PyTorch"),Kk.forEach(n),Am=s(bt,", "),Wo=r(bt,"A",{href:!0,rel:!0});var Yk=i(Wo);Im=s(Yk,"Tensorflow"),Yk.forEach(n),Dm=s(bt,", and "),Ro=r(bt,"A",{href:!0,rel:!0});var Zk=i(Ro);Sm=s(Zk,"Flax"),Zk.forEach(n),Gm=s(bt,`) and translation scripts
(`),Bo=r(bt,"A",{href:!0,rel:!0});var Jk=i(Bo);Um=s(Jk,"PyTorch"),Jk.forEach(n),Wm=s(bt," and "),Ho=r(bt,"A",{href:!0,rel:!0});var Xk=i(Ho);Rm=s(Xk,"Tensorflow"),Xk.forEach(n),Bm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(n),Vk.forEach(n),ip.forEach(n),Ec=l(t),Xt=r(t,"H2",{class:!0});var dp=i(Xt);Cn=r(dp,"A",{id:!0,class:!0,href:!0});var Qk=i(Cn);cd=r(Qk,"SPAN",{});var ey=i(cd);_(Vo.$$.fragment,ey),ey.forEach(n),Qk.forEach(n),Hm=l(dp),pd=r(dp,"SPAN",{});var ty=i(pd);Vm=s(ty,"T5Config"),ty.forEach(n),dp.forEach(n),Fc=l(t),vt=r(t,"DIV",{class:!0});var Br=i(vt);_(Ko.$$.fragment,Br),Km=l(Br),kt=r(Br,"P",{});var io=i(kt);Ym=s(io,"This is the configuration class to store the configuration of a "),fr=r(io,"A",{href:!0});var ny=i(fr);Zm=s(ny,"T5Model"),ny.forEach(n),Jm=s(io," or a "),_r=r(io,"A",{href:!0});var oy=i(_r);Xm=s(oy,"TFT5Model"),oy.forEach(n),Qm=s(io,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
adding special tokens. A sequence has the following format:`),hy.forEach(n),yf=l(Vr),ns=r(Vr,"UL",{});var hp=i(ns);vr=r(hp,"LI",{});var Bb=i(vr);wf=s(Bb,"single sequence: "),fd=r(Bb,"CODE",{});var uy=i(fd);xf=s(uy,"X </s>"),uy.forEach(n),Bb.forEach(n),$f=l(hp),kr=r(hp,"LI",{});var Hb=i(kr);zf=s(Hb,"pair of sequences: "),_d=r(Hb,"CODE",{});var my=i(_d);jf=s(my,"A </s> B </s>"),my.forEach(n),Hb.forEach(n),hp.forEach(n),Vr.forEach(n),qf=l(nt),Nn=r(nt,"DIV",{class:!0});var up=i(Nn);_(os.$$.fragment,up),Ef=l(up),ss=r(up,"P",{});var mp=i(ss);Ff=s(mp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
adding special tokens. A sequence has the following format:`),xy.forEach(n),Xf=l(Yr),hs=r(Yr,"UL",{});var Tp=i(hs);xr=r(Tp,"LI",{});var Vb=i(xr);Qf=s(Vb,"single sequence: "),wd=r(Vb,"CODE",{});var $y=i(wd);e_=s($y,"X </s>"),$y.forEach(n),Vb.forEach(n),t_=l(Tp),$r=r(Tp,"LI",{});var Kb=i($r);n_=s(Kb,"pair of sequences: "),xd=r(Kb,"CODE",{});var zy=i(xd);o_=s(zy,"A </s> B </s>"),zy.forEach(n),Kb.forEach(n),Tp.forEach(n),Yr.forEach(n),s_=l(Ot),An=r(Ot,"DIV",{class:!0});var bp=i(An);_(us.$$.fragment,bp),a_=l(bp),$d=r(bp,"P",{});var jy=i($d);r_=s(jy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gp.forEach(n),_5=l(st),_(Kn.$$.fragment,st),g5=l(st),Ze=r(st,"DIV",{class:!0});var Wt=i(Ze);_(ga.$$.fragment,Wt),T5=l(Wt),un=r(Wt,"P",{});var ei=i(un);b5=s(ei,"The "),Or=r(ei,"A",{href:!0});var L1=i(Or);v5=s(L1,"TFT5ForConditionalGeneration"),L1.forEach(n),k5=s(ei," forward method, overrides the "),cl=r(ei,"CODE",{});var A1=i(cl);y5=s(A1,"__call__"),A1.forEach(n),w5=s(ei," special method."),ei.forEach(n),x5=l(Wt),_(Yn.$$.fragment,Wt),$5=l(Wt),pl=r(Wt,"P",{});var I1=i(pl);z5=s(I1,"Examples:"),I1.forEach(n),j5=l(Wt),_(Ta.$$.fragment,Wt),Wt.forEach(n),st.forEach(n),Bc=l(t),mn=r(t,"H2",{class:!0});var Up=i(mn);Zn=r(Up,"A",{id:!0,class:!0,href:!0});var D1=i(Zn);hl=r(D1,"SPAN",{});var S1=i(hl);_(ba.$$.fragment,S1),S1.forEach(n),D1.forEach(n),q5=l(Up),ul=r(Up,"SPAN",{});var G1=i(ul);E5=s(G1,"TFT5EncoderModel"),G1.forEach(n),Up.forEach(n),Hc=l(t),ce=r(t,"DIV",{class:!0});var at=i(ce);_(va.$$.fragment,at),F5=l(at),ml=r(at,"P",{});var U1=i(ml);M5=s(U1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),U1.forEach(n),C5=l(at),ka=r(at,"P",{});var Wp=i(ka);P5=s(Wp,"The T5 model was proposed in "),ya=r(Wp,"A",{href:!0,rel:!0});var W1=i(ya);N5=s(W1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
