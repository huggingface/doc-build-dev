...
<docstring><name>class transformers.TFSharedEmbeddings</name><anchor>transformers.TFSharedEmbeddings</anchor><source>https://github.com/huggingface/transformers/blob/pr_15612/src/transformers/modeling_tf_utils.py#L1830</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_size** (`int`) --
...
<div class="docstring">
<docstring><name>call</name><anchor>transformers.TFSharedEmbeddings.call</anchor><source>https://github.com/huggingface/transformers/blob/pr_15612/src/transformers/modeling_tf_utils.py#L1875</source><parameters>[{"name": "inputs", "val": ": Tensor"}, {"name": "mode", "val": ": str = 'embedding'"}]</parameters><paramsdesc>- **inputs** (`tf.Tensor`) --
...
<docstring><name>class transformers.TFSequenceSummary</name><anchor>transformers.TFSequenceSummary</anchor><source>https://github.com/huggingface/transformers/blob/pr_15612/src/transformers/modeling_tf_utils.py#L1928</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/pr_15612/en/main_classes/configuration#transformers.PretrainedConfig)) --
  The config used by the model. Relevant arguments in the config class of the model are (refer to the actual
  config class of your model for the default values it uses):
...
<div class="docstring">
<docstring><name>register\_for\_auto\_class</name><anchor>transformers.TFSequenceSummary.register_for_auto_class</anchor><source>https://github.com/huggingface/transformers/blob/pr_15612/src/transformers/modeling_tf_utils.py#L2041</source><parameters>[{"name": "auto_class", "val": " = 'TFAutoModel'"}]</parameters><paramsdesc>- **auto_class** (`str` or `type`, *optional*, defaults to `"TFAutoModel"`) --
