import{S as iM,i as lM,s as dM,e as o,k as l,w as c,t as r,M as pM,c as s,d as t,m as d,a,x as m,h as i,b as p,F as e,g as v,y as u,q as g,o as h,B as _}from"../../chunks/vendor-4833417e.js";import{T as Fp}from"../../chunks/Tip-fffd6df1.js";import{D as f}from"../../chunks/Docstring-7b52c3d4.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function cM(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var j=a(x);E=i(j,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),j.forEach(t)},m(T,j){v(T,x,j),e(x,E)},d(T){T&&t(x)}}}function mM(ee){let x,E,T,j,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),j=r("\u201Coffline-mode\u201D"),te=r(` to
use this method in a firewalled environment.`),this.h()},l(A){x=s(A,"P",{});var I=a(x);E=i(I,"Activate the special "),T=s(I,"A",{href:!0,rel:!0});var Me=a(T);j=i(Me,"\u201Coffline-mode\u201D"),Me.forEach(t),te=i(I,` to
use this method in a firewalled environment.`),I.forEach(t),this.h()},h(){p(T,"href","https://huggingface.co/transformers/installation.html#offline-mode"),p(T,"rel","nofollow")},m(A,I){v(A,x,I),e(x,E),e(x,T),e(T,j),e(x,te)},d(A){A&&t(x)}}}function uM(ee){let x,E;return{c(){x=o("p"),E=r("This API is experimental and may have some slight breaking changes in the next releases.")},l(T){x=s(T,"P",{});var j=a(x);E=i(j,"This API is experimental and may have some slight breaking changes in the next releases."),j.forEach(t)},m(T,j){v(T,x,j),e(x,E)},d(T){T&&t(x)}}}function gM(ee){let x,E,T,j,te;return{c(){x=o("p"),E=r("Passing "),T=o("code"),j=r("use_auth_token=True"),te=r(" is required when you want to use a private model.")},l(A){x=s(A,"P",{});var I=a(x);E=i(I,"Passing "),T=s(I,"CODE",{});var Me=a(T);j=i(Me,"use_auth_token=True"),Me.forEach(t),te=i(I," is required when you want to use a private model."),I.forEach(t)},m(A,I){v(A,x,I),e(x,E),e(x,T),e(T,j),e(x,te)},d(A){A&&t(x)}}}function hM(ee){let x,E;return{c(){x=o("p"),E=r("This API is experimental and may have some slight breaking changes in the next releases.")},l(T){x=s(T,"P",{});var j=a(x);E=i(j,"This API is experimental and may have some slight breaking changes in the next releases."),j.forEach(t)},m(T,j){v(T,x,j),e(x,E)},d(T){T&&t(x)}}}function _M(ee){let x,E,T,j,te,A,I,Me,Am,Op,ie,Gm,Aa,Sm,Nm,Ga,Cm,Im,Sa,Bm,Wm,Dp,nt,Na,Um,Hm,Ca,Vm,Xm,zp,wt,Ir,Rm,Ym,Br,Km,Ap,B,Zm,Ia,Jm,Qm,Wr,eu,tu,Ba,nu,ou,Wa,su,au,Ua,ru,iu,Gp,ot,Tt,Ur,Hn,lu,Hr,du,Sp,w,Vn,pu,Vr,cu,mu,Ha,Va,uu,gu,hu,Xn,Xr,_u,fu,Rr,bu,vu,Yr,yu,ku,ne,Kr,Ae,Zr,xu,wu,Xa,Tu,$u,Ra,ju,Mu,Pu,Rn,Ge,Jr,Eu,Lu,Qr,qu,Fu,ei,Ou,Du,zu,st,$t,ti,Au,Gu,Ya,Su,Nu,Cu,jt,ni,Iu,Bu,oi,Wu,Uu,Hu,Mt,si,Vu,Xu,ai,Ru,Yu,Ku,ri,Pt,ii,Zu,Ju,li,Qu,eg,tg,di,Et,pi,ng,og,ci,sg,ag,rg,mi,V,ui,ig,lg,gi,dg,pg,hi,cg,mg,_i,ug,gg,fi,hg,_g,fg,le,Yn,bg,Kn,vg,bi,yg,kg,xg,vi,wg,Tg,Zn,$g,D,Jn,jg,yi,Mg,Pg,at,Eg,ki,Lg,qg,xi,Fg,Og,Dg,Qn,zg,wi,Ag,Gg,Sg,eo,Ng,Ti,Cg,Ig,Bg,Lt,Wg,qt,Ug,$i,Hg,Vg,to,Xg,Ft,no,Rg,ji,Yg,Kg,Ot,oo,Zg,Mi,Jg,Qg,Se,so,eh,Pi,th,nh,Ei,oh,sh,Ne,ao,ah,Li,rh,ih,qi,lh,dh,Dt,ro,ph,Fi,ch,mh,zt,io,uh,Oi,gh,hh,At,lo,_h,Di,fh,bh,Ce,po,vh,zi,yh,kh,Gt,xh,Ie,co,wh,mo,Th,Ai,$h,jh,Mh,uo,Ph,Gi,Eh,Lh,qh,St,go,Fh,ho,Oh,Si,Dh,zh,Ah,Nt,_o,Gh,Ni,Sh,Nh,Be,fo,Ch,Ci,Ih,Bh,bo,Wh,Ii,Uh,Hh,Np,Ka,Cp,rt,Ct,Bi,vo,Vh,Wi,Xh,Ip,de,Rh,Ui,Yh,Kh,Hi,Zh,Jh,Vi,Qh,e_,Bp,yo,Wp,We,t_,Xi,n_,o_,Ri,s_,a_,Up,ko,Hp,It,r_,Yi,i_,l_,Vp,xo,Xp,Za,d_,Rp,it,Bt,Ki,wo,p_,Zi,c_,Yp,L,To,m_,$o,u_,Ji,g_,h_,__,Ue,jo,f_,Qi,b_,v_,lt,y_,el,k_,x_,tl,w_,T_,$_,Wt,Mo,j_,nl,M_,P_,Ut,Po,E_,dt,L_,ol,q_,F_,Eo,O_,D_,z_,Ht,Lo,A_,sl,G_,S_,Vt,qo,N_,al,C_,I_,Xt,Fo,B_,rl,W_,U_,Rt,Oo,H_,il,V_,X_,Yt,Do,R_,pt,Y_,ll,K_,Z_,Ja,J_,Q_,Kp,ct,Kt,dl,zo,ef,pl,tf,Zp,y,Ao,nf,cl,of,sf,Qa,er,af,rf,lf,Go,ml,df,pf,ul,cf,mf,gl,uf,gf,mt,He,hl,hf,_f,tr,ff,bf,nr,vf,yf,kf,Zt,_l,xf,wf,fl,Tf,$f,jf,X,bl,Mf,Pf,vl,Ef,Lf,yl,qf,Ff,kl,Of,Df,xl,zf,Af,Gf,pe,So,Sf,No,Nf,wl,Cf,If,Bf,Tl,Wf,Uf,Co,Hf,Jt,Io,Vf,$l,Xf,Rf,S,Bo,Yf,jl,Kf,Zf,Wo,Jf,Ml,Qf,eb,tb,Uo,nb,Pl,ob,sb,ab,Qt,rb,El,ib,lb,Ho,db,en,Vo,pb,Ll,cb,mb,tn,Xo,ub,ql,gb,hb,nn,Ro,_b,Fl,fb,bb,on,Yo,vb,Ol,yb,kb,sn,Ko,xb,Dl,wb,Tb,an,Zo,$b,zl,jb,Mb,rn,Jo,Pb,Al,Eb,Lb,ln,Qo,qb,Gl,Fb,Ob,Ve,es,Db,ts,zb,Sl,Ab,Gb,Sb,ns,Nb,Nl,Cb,Ib,Bb,dn,os,Wb,ss,Ub,or,Hb,Vb,Xb,pn,as,Rb,Cl,Yb,Kb,cn,rs,Zb,Il,Jb,Qb,mn,is,ev,Bl,tv,nv,un,ls,ov,Wl,sv,av,gn,ds,rv,Ul,iv,lv,hn,ps,dv,Hl,pv,cv,ce,cs,mv,oe,uv,Vl,gv,hv,Xl,_v,fv,Rl,bv,vv,Yl,yv,kv,xv,ut,wv,Kl,Tv,$v,Zl,jv,Mv,Pv,gt,Ev,Jl,Lv,qv,Ql,Fv,Ov,Jp,ht,_n,ed,ms,Dv,td,zv,Qp,Pe,us,Av,gs,Gv,nd,Sv,Nv,Cv,fn,hs,Iv,od,Bv,ec,_t,bn,sd,_s,Wv,ad,Uv,tc,M,fs,Hv,rd,Vv,Xv,sr,ar,Rv,Yv,Kv,id,Zv,Jv,ft,Xe,ld,Qv,e1,rr,t1,n1,ir,o1,s1,a1,vn,dd,r1,i1,pd,l1,d1,p1,R,cd,c1,m1,md,u1,g1,ud,h1,_1,gd,f1,b1,hd,v1,y1,k1,me,bs,x1,vs,w1,_d,T1,$1,j1,fd,M1,P1,ys,E1,W,ks,L1,bd,q1,F1,xs,O1,vd,D1,z1,A1,ws,G1,yd,S1,N1,C1,kd,I1,B1,Ts,W1,Re,$s,U1,xd,H1,V1,yn,X1,kn,js,R1,Ms,Y1,wd,K1,Z1,J1,Y,Ps,Q1,se,ey,Td,ty,ny,$d,oy,sy,jd,ay,ry,Md,iy,ly,dy,Pd,py,cy,Ed,my,uy,Es,gy,K,Ls,hy,ae,_y,Ld,fy,by,qd,vy,yy,Fd,ky,xy,Od,wy,Ty,$y,Dd,jy,My,zd,Py,Ey,qs,Ly,ue,Fs,qy,re,Fy,Ad,Oy,Dy,Gd,zy,Ay,Sd,Gy,Sy,Nd,Ny,Cy,Iy,Cd,By,Wy,Os,nc,bt,xn,Id,Ds,Uy,Bd,Hy,oc,P,zs,Vy,As,Xy,lr,Ry,Yy,Ky,wn,Gs,Zy,Ss,Jy,dr,Qy,e2,t2,ge,Ns,n2,Wd,o2,s2,Ud,a2,r2,Cs,i2,he,Is,l2,Hd,d2,p2,Vd,c2,m2,Bs,u2,Tn,Ws,g2,Xd,h2,_2,_e,Us,f2,Rd,b2,v2,Yd,y2,k2,Hs,x2,U,Vs,w2,Kd,T2,$2,vt,j2,Zd,M2,P2,pr,E2,L2,q2,Xs,F2,Rs,O2,D2,z2,Jd,A2,G2,Ys,S2,fe,Ks,N2,Qd,C2,I2,ep,B2,W2,Zs,U2,be,Js,H2,tp,V2,X2,np,R2,Y2,Qs,K2,$n,ea,Z2,ta,J2,cr,Q2,ek,tk,ve,na,nk,op,ok,sk,sp,ak,rk,oa,sc,G,sa,ik,aa,lk,mr,dk,pk,ck,jn,ra,mk,ia,uk,ur,gk,hk,_k,N,la,fk,ap,bk,vk,da,yk,pa,kk,xk,wk,Ee,Tk,rp,$k,jk,ip,Mk,Pk,gr,Ek,Lk,qk,ca,Fk,ma,Ok,Dk,zk,lp,Ak,Gk,ua,Sk,ye,ga,Nk,dp,Ck,Ik,pp,Bk,Wk,ha,Uk,Mn,_a,Hk,fa,Vk,hr,Xk,Rk,Yk,ke,ba,Kk,cp,Zk,Jk,mp,Qk,ex,va,ac,Le,ya,tx,ka,nx,_r,ox,sx,ax,H,xa,rx,up,ix,lx,yt,dx,gp,px,cx,fr,mx,ux,gx,wa,hx,Ta,_x,fx,bx,hp,vx,yx,$a,rc,kt,Pn,_p,ja,kx,fp,xx,ic,qe,Ma,wx,bp,Tx,$x,xe,Pa,jx,Ea,Mx,vp,Px,Ex,Lx,yp,qx,Fx,La,lc;return A=new xt({}),Hn=new xt({}),Vn=new f({props:{name:"class transformers.PreTrainedModel",anchor:"transformers.PreTrainedModel",parameters:[{name:"config",val:": PretrainedConfig"},{name:"*inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L423"}}),Yn=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
<a href="/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Lt=new Fp({props:{$$slots:{default:[cM]},$$scope:{ctx:ee}}}),qt=new Fp({props:{$$slots:{default:[mM]},$$scope:{ctx:ee}}}),to=new O({props:{code:`from transformers import BertConfig, BertModel
...
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Do=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_utils.py#L194"}}),zo=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Qt=new Fp({props:{$$slots:{default:[gM]},$$scope:{ctx:ee}}}),Ho=new O({props:{code:`from transformers import BertConfig, TFBertModel
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_15921/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_15921/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/generation_tf_utils.py#L2016",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15921/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
<p><a
  href="/docs/transformers/pr_15921/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a>.</p>
`}}),$a=new O({props:{code:`from transformers import AutoTokenizer, FlaxAutoModelForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ja=new xt({}),Ma=new f({props:{name:"class transformers.file_utils.PushToHubMixin",anchor:"transformers.file_utils.PushToHubMixin",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/file_utils.py#L2820"}}),Pa=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15921/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your {object} in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
<span class="hljs-comment"># Make a change to an existing repo that has been cloned locally in *my-finetuned-bert*.</span>
{<span class="hljs-built_in">object</span>}.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),{c(){x=o("meta"),E=l(),T=o("h1"),j=o("a"),te=o("span"),c(A.$$.fragment),I=l(),Me=o("span"),Am=r("Models"),Op=l(),ie=o("p"),Gm=r("The base classes "),Aa=o("a"),Sm=r("PreTrainedModel"),Nm=r(", "),Ga=o("a"),Cm=r("TFPreTrainedModel"),Im=r(`, and
...
S3 repository).`),Dp=l(),nt=o("p"),Na=o("a"),Um=r("PreTrainedModel"),Hm=r(" and "),Ca=o("a"),Vm=r("TFPreTrainedModel"),Xm=r(` also implement a few methods which
are common among all the models to:`),zp=l(),wt=o("ul"),Ir=o("li"),Rm=r("resize the input token embeddings when new tokens are added to the vocabulary"),Ym=l(),Br=o("li"),Km=r("prune the attention heads of the model."),Ap=l(),B=o("p"),Zm=r("The other methods that are common to each model are defined in "),Ia=o("a"),Jm=r("ModuleUtilsMixin"),Qm=r(`
...
`),bi=o("code"),yg=r("repo_path_or_name"),kg=r("."),xg=l(),vi=o("p"),wg=r("Examples:"),Tg=l(),c(Zn.$$.fragment),$g=l(),D=o("div"),c(Jn.$$.fragment),jg=l(),yi=o("p"),Mg=r("Instantiate a pretrained pytorch model from a pre-trained model configuration."),Pg=l(),at=o("p"),Eg=r("The model is set in evaluation mode by default using "),ki=o("code"),Lg=r("model.eval()"),qg=r(` (Dropout modules are deactivated). To train
the model, you should first set it back in training mode with `),xi=o("code"),Fg=r("model.train()"),Og=r("."),Dg=l(),Qn=o("p"),zg=r("The warning "),wi=o("em"),Ag=r("Weights from XXX not initialized from pretrained model"),Gg=r(` means that the weights of XXX do not come
...
weights are discarded.`),Bg=l(),c(Lt.$$.fragment),Wg=l(),c(qt.$$.fragment),Ug=l(),$i=o("p"),Hg=r("Examples:"),Vg=l(),c(to.$$.fragment),Xg=l(),Ft=o("div"),c(no.$$.fragment),Rg=l(),ji=o("p"),Yg=r("Returns the model\u2019s input embeddings."),Kg=l(),Ot=o("div"),c(oo.$$.fragment),Zg=l(),Mi=o("p"),Jg=r("Returns the model\u2019s output embeddings."),Qg=l(),Se=o("div"),c(so.$$.fragment),eh=l(),Pi=o("p"),th=r("Deactivates gradient checkpointing for the current model."),nh=l(),Ei=o("p"),oh=r(`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
...
activations\u201D.`),dh=l(),Dt=o("div"),c(ro.$$.fragment),ph=l(),Fi=o("p"),ch=r("If needed prunes and maybe initializes weights."),mh=l(),zt=o("div"),c(io.$$.fragment),uh=l(),Oi=o("p"),gh=r(`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),hh=l(),At=o("div"),c(lo.$$.fragment),_h=l(),Di=o("p"),fh=r("Prunes heads of the base model."),bh=l(),Ce=o("div"),c(po.$$.fragment),vh=l(),zi=o("p"),yh=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),kh=l(),c(Gt.$$.fragment),xh=l(),Ie=o("div"),c(co.$$.fragment),wh=l(),mo=o("p"),Th=r("Resizes input token embeddings matrix of the model if "),Ai=o("code"),$h=r("new_num_tokens != config.vocab_size"),jh=r("."),Mh=l(),uo=o("p"),Ph=r("Takes care of tying weights embeddings afterwards if the model class has a "),Gi=o("code"),Eh=r("tie_weights()"),Lh=r(" method."),qh=l(),St=o("div"),c(go.$$.fragment),Fh=l(),ho=o("p"),Oh=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=o("code"),Dh=r("[from_pretrained()](/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),zh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
and then `),Ri=o("code"),s_=r("dtype"),a_=r(" will be automatically derived from the model\u2019s weights:"),Up=l(),c(ko.$$.fragment),Hp=l(),It=o("p"),r_=r("Models instantiated from scratch can also be told which "),Yi=o("code"),i_=r("dtype"),l_=r(" to use with:"),Vp=l(),c(xo.$$.fragment),Xp=l(),Za=o("p"),d_=r("Due to Pytorch design, this functionality is only available for floating dtypes."),Rp=l(),it=o("h2"),Bt=o("a"),Ki=o("span"),c(wo.$$.fragment),p_=l(),Zi=o("span"),c_=r("ModuleUtilsMixin"),Yp=l(),L=o("div"),c(To.$$.fragment),m_=l(),$o=o("p"),u_=r("A few utilities for "),Ji=o("code"),g_=r("torch.nn.Modules"),h_=r(", to be used as a mixin."),__=l(),Ue=o("div"),c(jo.$$.fragment),f_=l(),Qi=o("p"),b_=r("Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),v_=l(),lt=o("p"),y_=r("Increase in memory consumption is stored in a "),el=o("code"),k_=r("mem_rss_diff"),x_=r(` attribute for each module and can be reset to zero
with `),tl=o("code"),w_=r("model.reset_memory_hooks_state()"),T_=r("."),$_=l(),Wt=o("div"),c(Mo.$$.fragment),j_=l(),nl=o("p"),M_=r("Helper function to estimate the total number of tokens from the model inputs."),P_=l(),Ut=o("div"),c(Po.$$.fragment),E_=l(),dt=o("p"),L_=r(`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
tokens (valid if `),ol=o("code"),q_=r("12 * d_model << sequence_length"),F_=r(") as laid out in "),Eo=o("a"),O_=r(`this
paper`),D_=r(` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),z_=l(),Ht=o("div"),c(Lo.$$.fragment),A_=l(),sl=o("p"),G_=r("Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),S_=l(),Vt=o("div"),c(qo.$$.fragment),N_=l(),al=o("p"),C_=r("Prepare the head mask if needed."),I_=l(),Xt=o("div"),c(Fo.$$.fragment),B_=l(),rl=o("p"),W_=r("Invert an attention mask (e.g., switches 0. and 1.)."),U_=l(),Rt=o("div"),c(Oo.$$.fragment),H_=l(),il=o("p"),V_=r("Get number of (optionally, trainable or non-embeddings) parameters in the module."),X_=l(),Yt=o("div"),c(Do.$$.fragment),R_=l(),pt=o("p"),Y_=r("Reset the "),ll=o("code"),K_=r("mem_rss_diff"),Z_=r(" attribute of each module (see "),Ja=o("a"),J_=r("add_memory_hooks()"),Q_=r(")."),Kp=l(),ct=o("h2"),Kt=o("a"),dl=o("span"),c(zo.$$.fragment),ef=l(),pl=o("span"),tf=r("TFPreTrainedModel"),Zp=l(),y=o("div"),c(Ao.$$.fragment),nf=l(),cl=o("p"),of=r("Base class for all TF models."),sf=l(),Qa=o("p"),er=o("a"),af=r("TFPreTrainedModel"),rf=r(` takes care of storing the configuration of the models and handles methods for loading,
...
for this model architecture.`),kf=l(),Zt=o("li"),_l=o("strong"),xf=r("base_model_prefix"),wf=r(" ("),fl=o("code"),Tf=r("str"),$f=r(`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),jf=l(),X=o("li"),bl=o("strong"),Mf=r("main_input_name"),Pf=r(" ("),vl=o("code"),Ef=r("str"),Lf=r(") \u2014 The name of the principal input to the model (often "),yl=o("code"),qf=r("input_ids"),Ff=r(` for NLP
models, `),kl=o("code"),Of=r("pixel_values"),Df=r(" for vision models and "),xl=o("code"),zf=r("input_values"),Af=r(" for speech models)."),Gf=l(),pe=o("div"),c(So.$$.fragment),Sf=l(),No=o("p"),Nf=r(`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=o("code"),Cf=r("repo_path_or_name"),If=r("."),Bf=l(),Tl=o("p"),Wf=r("Examples:"),Uf=l(),c(Co.$$.fragment),Hf=l(),Jt=o("div"),c(Io.$$.fragment),Vf=l(),$l=o("p"),Xf=r(`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),Rf=l(),S=o("div"),c(Bo.$$.fragment),Yf=l(),jl=o("p"),Kf=r("Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),Zf=l(),Wo=o("p"),Jf=r("The warning "),Ml=o("em"),Qf=r("Weights from XXX not initialized from pretrained model"),eb=r(` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),ab=l(),c(Qt.$$.fragment),rb=l(),El=o("p"),ib=r("Examples:"),lb=l(),c(Ho.$$.fragment),db=l(),en=o("div"),c(Vo.$$.fragment),pb=l(),Ll=o("p"),cb=r("Dict of bias attached to an LM head. The key represents the name of the bias attribute."),mb=l(),tn=o("div"),c(Xo.$$.fragment),ub=l(),ql=o("p"),gb=r("Returns the model\u2019s input embeddings layer."),hb=l(),nn=o("div"),c(Ro.$$.fragment),_b=l(),Fl=o("p"),fb=r("The LM Head layer. This method must be overwritten by all the models that have a lm head."),bb=l(),on=o("div"),c(Yo.$$.fragment),vb=l(),Ol=o("p"),yb=r("Returns the model\u2019s output embeddings"),kb=l(),sn=o("div"),c(Ko.$$.fragment),xb=l(),Dl=o("p"),wb=r(`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),Tb=l(),an=o("div"),c(Zo.$$.fragment),$b=l(),zl=o("p"),jb=r("Get the concatenated _prefix name of the bias from the model name to the parent layer"),Mb=l(),rn=o("div"),c(Jo.$$.fragment),Pb=l(),Al=o("p"),Eb=r(`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),Lb=l(),ln=o("div"),c(Qo.$$.fragment),qb=l(),Gl=o("p"),Fb=r("Prunes heads of the base model."),Ob=l(),Ve=o("div"),c(es.$$.fragment),Db=l(),ts=o("p"),zb=r("Resizes input token embeddings matrix of the model if "),Sl=o("code"),Ab=r("new_num_tokens != config.vocab_size"),Gb=r("."),Sb=l(),ns=o("p"),Nb=r("Takes care of tying weights embeddings afterwards if the model class has a "),Nl=o("code"),Cb=r("tie_weights()"),Ib=r(" method."),Bb=l(),dn=o("div"),c(os.$$.fragment),Wb=l(),ss=o("p"),Ub=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
...
backwards pass. In this case, `),Kl=o("code"),Tv=r("data"),$v=r(" is a singleton tuple containing "),Zl=o("code"),jv=r("(inputs,)"),Mv=r("."),Pv=l(),gt=o("p"),Ev=r(`This is possible under the aforementioned circumstances because our overriden compile function can set an
...
name matching) containing the loss that was used to train the pre-trained model.`),Jp=l(),ht=o("h2"),_n=o("a"),ed=o("span"),c(ms.$$.fragment),Dv=l(),td=o("span"),zv=r("TFModelUtilsMixin"),Qp=l(),Pe=o("div"),c(us.$$.fragment),Av=l(),gs=o("p"),Gv=r("A few utilities for "),nd=o("code"),Sv=r("tf.keras.Model"),Nv=r(", to be used as a mixin."),Cv=l(),fn=o("div"),c(hs.$$.fragment),Iv=l(),od=o("p"),Bv=r("Get the number of (optionally, trainable) parameters in the model."),ec=l(),_t=o("h2"),bn=o("a"),sd=o("span"),c(_s.$$.fragment),Wv=l(),ad=o("span"),Uv=r("FlaxPreTrainedModel"),tc=l(),M=o("div"),c(fs.$$.fragment),Hv=l(),rd=o("p"),Vv=r("Base class for all models."),Xv=l(),sr=o("p"),ar=o("a"),Rv=r("FlaxPreTrainedModel"),Yv=r(` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),Kv=l(),id=o("p"),Zv=r("Class attributes (overridden by derived classes):"),Jv=l(),ft=o("ul"),Xe=o("li"),ld=o("strong"),Qv=r("config_class"),e1=r(" ("),rr=o("a"),t1=r("PretrainedConfig"),n1=r(") \u2014 A subclass of "),ir=o("a"),o1=r("PretrainedConfig"),s1=r(` to use as configuration class
for this model architecture.`),a1=l(),vn=o("li"),dd=o("strong"),r1=r("base_model_prefix"),i1=r(" ("),pd=o("code"),l1=r("str"),d1=r(`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),p1=l(),R=o("li"),cd=o("strong"),c1=r("main_input_name"),m1=r(" ("),md=o("code"),u1=r("str"),g1=r(") \u2014 The name of the principal input to the model (often "),ud=o("code"),h1=r("input_ids"),_1=r(` for NLP
models, `),gd=o("code"),f1=r("pixel_values"),b1=r(" for vision models and "),hd=o("code"),v1=r("input_values"),y1=r(" for speech models)."),k1=l(),me=o("div"),c(bs.$$.fragment),x1=l(),vs=o("p"),w1=r(`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=o("code"),T1=r("repo_path_or_name"),$1=r("."),j1=l(),fd=o("p"),M1=r("Examples:"),P1=l(),c(ys.$$.fragment),E1=l(),W=o("div"),c(ks.$$.fragment),L1=l(),bd=o("p"),q1=r("Instantiate a pretrained flax model from a pre-trained model configuration."),F1=l(),xs=o("p"),O1=r("The warning "),vd=o("em"),D1=r("Weights from XXX not initialized from pretrained model"),z1=r(` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),A1=l(),ws=o("p"),G1=r("The warning "),yd=o("em"),S1=r("Weights from XXX not used in YYY"),N1=r(` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),C1=l(),kd=o("p"),I1=r("Examples:"),B1=l(),c(Ts.$$.fragment),W1=l(),Re=o("div"),c($s.$$.fragment),U1=l(),xd=o("p"),H1=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V1=l(),c(yn.$$.fragment),X1=l(),kn=o("div"),c(js.$$.fragment),R1=l(),Ms=o("p"),Y1=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=o("code"),K1=r("[from_pretrained()](/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Z1=r(" class method"),J1=l(),Y=o("div"),c(Ps.$$.fragment),Q1=l(),se=o("p"),ey=r("Cast the floating-point "),Td=o("code"),ty=r("params"),ny=r(" to "),$d=o("code"),oy=r("jax.numpy.bfloat16"),sy=r(". This returns a new "),jd=o("code"),ay=r("params"),ry=r(` tree and does not cast
the `),Md=o("code"),iy=r("params"),ly=r(" in place."),dy=l(),Pd=o("p"),py=r(`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),cy=l(),Ed=o("p"),my=r("Examples:"),uy=l(),c(Es.$$.fragment),gy=l(),K=o("div"),c(Ls.$$.fragment),hy=l(),ae=o("p"),_y=r("Cast the floating-point "),Ld=o("code"),fy=r("parmas"),by=r(" to "),qd=o("code"),vy=r("jax.numpy.float16"),yy=r(". This returns a new "),Fd=o("code"),ky=r("params"),xy=r(` tree and does not cast the
`),Od=o("code"),wy=r("params"),Ty=r(" in place."),$y=l(),Dd=o("p"),jy=r(`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),My=l(),zd=o("p"),Py=r("Examples:"),Ey=l(),c(qs.$$.fragment),Ly=l(),ue=o("div"),c(Fs.$$.fragment),qy=l(),re=o("p"),Fy=r("Cast the floating-point "),Ad=o("code"),Oy=r("parmas"),Dy=r(" to "),Gd=o("code"),zy=r("jax.numpy.float32"),Ay=r(`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=o("code"),Gy=r("params"),Sy=r(" tree and does not cast the "),Nd=o("code"),Ny=r("params"),Cy=r(" in place."),Iy=l(),Cd=o("p"),By=r("Examples:"),Wy=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(Ds.$$.fragment),Uy=l(),Bd=o("span"),Hy=r("Generation"),oc=l(),P=o("div"),c(zs.$$.fragment),Vy=l(),As=o("p"),Xy=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),Ry=r("PreTrainedModel"),Yy=r("."),Ky=l(),wn=o("div"),c(Gs.$$.fragment),Zy=l(),Ss=o("p"),Jy=r("Implement in subclasses of "),dr=o("a"),Qy=r("PreTrainedModel"),e2=r(" for custom behavior to adjust the logits in the generate method."),t2=l(),ge=o("div"),c(Ns.$$.fragment),n2=l(),Wd=o("p"),o2=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),s2=l(),Ud=o("p"),a2=r("Examples:"),r2=l(),c(Cs.$$.fragment),i2=l(),he=o("div"),c(Is.$$.fragment),l2=l(),Hd=o("p"),d2=r("Generates sequences for models with a language modeling head using beam search decoding."),p2=l(),Vd=o("p"),c2=r("Examples:"),m2=l(),c(Bs.$$.fragment),u2=l(),Tn=o("div"),c(Ws.$$.fragment),g2=l(),Xd=o("p"),h2=r(`compute the transition probabilities of sequences given generation
scores and beam indices`),_2=l(),_e=o("div"),c(Us.$$.fragment),f2=l(),Rd=o("p"),b2=r("Generates sequences for models with a language modeling head using beam search decoding."),v2=l(),Yd=o("p"),y2=r("Examples:"),k2=l(),c(Hs.$$.fragment),x2=l(),U=o("div"),c(Vs.$$.fragment),w2=l(),Kd=o("p"),T2=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),$2=l(),vt=o("p"),j2=r("Apart from "),Zd=o("code"),M2=r("inputs"),P2=r(`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=o("a"),E2=r("PretrainedConfig"),L2=r(" of the model. The default values indicated are the default values of those config."),q2=l(),Xs=o("p"),F2=r("Most of these parameters are explained in more detail in "),Rs=o("a"),O2=r(`this blog
post`),D2=r("."),z2=l(),Jd=o("p"),A2=r("Examples:"),G2=l(),c(Ys.$$.fragment),S2=l(),fe=o("div"),c(Ks.$$.fragment),N2=l(),Qd=o("p"),C2=r("Generates sequences for models with a language modeling head using greedy decoding."),I2=l(),ep=o("p"),B2=r("Examples:"),W2=l(),c(Zs.$$.fragment),U2=l(),be=o("div"),c(Js.$$.fragment),H2=l(),tp=o("p"),V2=r("Generates sequences for models with a language modeling head using beam search decoding."),X2=l(),np=o("p"),R2=r("Examples:"),Y2=l(),c(Qs.$$.fragment),K2=l(),$n=o("div"),c(ea.$$.fragment),Z2=l(),ta=o("p"),J2=r("Implement in subclasses of "),cr=o("a"),Q2=r("PreTrainedModel"),ek=r(" for custom behavior to prepare inputs in the generate method."),tk=l(),ve=o("div"),c(na.$$.fragment),nk=l(),op=o("p"),ok=r("Generates sequences for models with a language modeling head using multinomial sampling."),sk=l(),sp=o("p"),ak=r("Examples:"),rk=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),ik=l(),aa=o("p"),lk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),dk=r("TFPreTrainedModel"),pk=r("."),ck=l(),jn=o("div"),c(ra.$$.fragment),mk=l(),ia=o("p"),uk=r("Implement in subclasses of "),ur=o("a"),gk=r("PreTrainedModel"),hk=r(" for custom behavior to adjust the logits in the generate method."),_k=l(),N=o("div"),c(la.$$.fragment),fk=l(),ap=o("p"),bk=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),vk=l(),da=o("p"),yk=r("Adapted in part from "),pa=o("a"),kk=r(`Facebook\u2019s XLM beam search
code`),xk=r("."),wk=l(),Ee=o("p"),Tk=r("Apart from "),rp=o("code"),$k=r("input_ids"),jk=r(" and "),ip=o("code"),Mk=r("attention_mask"),Pk=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),Ek=r("PretrainedConfig"),Lk=r(` of the model. The default values indicated are the default
values of those config.`),qk=l(),ca=o("p"),Fk=r("Most of these parameters are explained in more detail in "),ma=o("a"),Ok=r(`this blog
post`),Dk=r("."),zk=l(),lp=o("p"),Ak=r("Examples:"),Gk=l(),c(ua.$$.fragment),Sk=l(),ye=o("div"),c(ga.$$.fragment),Nk=l(),dp=o("p"),Ck=r("Generates sequences for models with a language modeling head using greedy decoding."),Ik=l(),pp=o("p"),Bk=r("Examples:"),Wk=l(),c(ha.$$.fragment),Uk=l(),Mn=o("div"),c(_a.$$.fragment),Hk=l(),fa=o("p"),Vk=r("Implement in subclasses of "),hr=o("a"),Xk=r("TFPreTrainedModel"),Rk=r(" for custom behavior to prepare inputs in the generate method."),Yk=l(),ke=o("div"),c(ba.$$.fragment),Kk=l(),cp=o("p"),Zk=r("Generates sequences for models with a language modeling head using multinomial sampling."),Jk=l(),mp=o("p"),Qk=r("Examples:"),ex=l(),c(va.$$.fragment),ac=l(),Le=o("div"),c(ya.$$.fragment),tx=l(),ka=o("p"),nx=r("A class containing all of the functions supporting generation, to be used as a mixin in "),_r=o("a"),ox=r("FlaxPreTrainedModel"),sx=r("."),ax=l(),H=o("div"),c(xa.$$.fragment),rx=l(),up=o("p"),ix=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),lx=l(),yt=o("p"),dx=r("Apart from "),gp=o("code"),px=r("input_ids"),cx=r(`, all the arguments below will default to the value of the attribute of the same name
inside the `),fr=o("a"),mx=r("PretrainedConfig"),ux=r(` of the model. The default values indicated are the default values of those
config.`),gx=l(),wa=o("p"),hx=r("Most of these parameters are explained in more detail in "),Ta=o("a"),_x=r(`this blog
post`),fx=r("."),bx=l(),hp=o("p"),vx=r("Examples:"),yx=l(),c($a.$$.fragment),rc=l(),kt=o("h2"),Pn=o("a"),_p=o("span"),c(ja.$$.fragment),kx=l(),fp=o("span"),xx=r("Pushing to the Hub"),ic=l(),qe=o("div"),c(Ma.$$.fragment),wx=l(),bp=o("p"),Tx=r("A Mixin containing the functionality to push a model or tokenizer to the hub."),$x=l(),xe=o("div"),c(Pa.$$.fragment),jx=l(),Ea=o("p"),Mx=r(`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vp=o("code"),Px=r("repo_path_or_name"),Ex=r("."),Lx=l(),yp=o("p"),qx=r("Examples:"),Fx=l(),c(La.$$.fragment),this.h()},l(n){const b=pM('[data-svelte="svelte-1phssyn"]',document.head);x=s(b,"META",{name:!0,content:!0}),b.forEach(t),E=d(n),T=s(n,"H1",{class:!0});var qa=a(T);j=s(qa,"A",{id:!0,class:!0,href:!0});var kp=a(j);te=s(kp,"SPAN",{});var xp=a(te);m(A.$$.fragment,xp),xp.forEach(t),kp.forEach(t),I=d(qa),Me=s(qa,"SPAN",{});var wp=a(Me);Am=i(wp,"Models"),wp.forEach(t),qa.forEach(t),Op=d(n),ie=s(n,"P",{});var Fe=a(ie);Gm=i(Fe,"The base classes "),Aa=s(Fe,"A",{href:!0});var Ax=a(Aa);Sm=i(Ax,"PreTrainedModel"),Ax.forEach(t),Nm=i(Fe,", "),Ga=s(Fe,"A",{href:!0});var Gx=a(Ga);Cm=i(Gx,"TFPreTrainedModel"),Gx.forEach(t),Im=i(Fe,`, and
`),Sa=s(Fe,"A",{href:!0});var Sx=a(Sa);Bm=i(Sx,"FlaxPreTrainedModel"),Sx.forEach(t),Wm=i(Fe,` implement the common methods for loading/saving a model either from a local
file or directory, or from a pretrained model configuration provided by the library (downloaded from HuggingFace\u2019s AWS
S3 repository).`),Fe.forEach(t),Dp=d(n),nt=s(n,"P",{});var Tp=a(nt);Na=s(Tp,"A",{href:!0});var Nx=a(Na);Um=i(Nx,"PreTrainedModel"),Nx.forEach(t),Hm=i(Tp," and "),Ca=s(Tp,"A",{href:!0});var Cx=a(Ca);Vm=i(Cx,"TFPreTrainedModel"),Cx.forEach(t),Xm=i(Tp,` also implement a few methods which
are common among all the models to:`),Tp.forEach(t),zp=d(n),wt=s(n,"UL",{});var dc=a(wt);Ir=s(dc,"LI",{});var Ix=a(Ir);Rm=i(Ix,"resize the input token embeddings when new tokens are added to the vocabulary"),Ix.forEach(t),Ym=d(dc),Br=s(dc,"LI",{});var Bx=a(Br);Km=i(Bx,"prune the attention heads of the model."),Bx.forEach(t),dc.forEach(t),Ap=d(n),B=s(n,"P",{});var we=a(B);Zm=i(we,"The other methods that are common to each model are defined in "),Ia=s(we,"A",{href:!0});var Wx=a(Ia);Jm=i(Wx,"ModuleUtilsMixin"),Wx.forEach(t),Qm=i(we,`
(for the PyTorch models) and `),Wr=s(we,"CODE",{});var Ux=a(Wr);eu=i(Ux,"TFModuleUtilsMixin"),Ux.forEach(t),tu=i(we,` (for the TensorFlow models) or
for text generation, `),Ba=s(we,"A",{href:!0});var Hx=a(Ba);nu=i(Hx,"GenerationMixin"),Hx.forEach(t),ou=i(we,` (for the PyTorch models),
`),Wa=s(we,"A",{href:!0});var Vx=a(Wa);su=i(Vx,"TFGenerationMixin"),Vx.forEach(t),au=i(we,` (for the TensorFlow models) and
`),Ua=s(we,"A",{href:!0});var Xx=a(Ua);ru=i(Xx,"FlaxGenerationMixin"),Xx.forEach(t),iu=i(we," (for the Flax/JAX models)."),we.forEach(t),Gp=d(n),ot=s(n,"H2",{class:!0});var pc=a(ot);Tt=s(pc,"A",{id:!0,class:!0,href:!0});var Rx=a(Tt);Ur=s(Rx,"SPAN",{});var Yx=a(Ur);m(Hn.$$.fragment,Yx),Yx.forEach(t),Rx.forEach(t),lu=d(pc),Hr=s(pc,"SPAN",{});var Kx=a(Hr);du=i(Kx,"PreTrainedModel"),Kx.forEach(t),pc.forEach(t),Sp=d(n),w=s(n,"DIV",{class:!0});var $=a(w);m(Vn.$$.fragment,$),pu=d($),Vr=s($,"P",{});var Zx=a(Vr);cu=i(Zx,"Base class for all models."),Zx.forEach(t),mu=d($),Ha=s($,"P",{});var Ox=a(Ha);Va=s(Ox,"A",{href:!0});var Jx=a(Va);uu=i(Jx,"PreTrainedModel"),Jx.forEach(t),gu=i(Ox,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),Ox.forEach(t),hu=d($),Xn=s($,"UL",{});var cc=a(Xn);Xr=s(cc,"LI",{});var Qx=a(Xr);_u=i(Qx,"resize the input embeddings,"),Qx.forEach(t),fu=d(cc),Rr=s(cc,"LI",{});var ew=a(Rr);bu=i(ew,"prune heads in the self-attention heads."),ew.forEach(t),cc.forEach(t),vu=d($),Yr=s($,"P",{});var tw=a(Yr);yu=i(tw,"Class attributes (overridden by derived classes):"),tw.forEach(t),ku=d($),ne=s($,"UL",{});var Ye=a(ne);Kr=s(Ye,"LI",{});var nw=a(Kr);Ae=s(nw,"P",{});var Fa=a(Ae);Zr=s(Fa,"STRONG",{});var ow=a(Zr);xu=i(ow,"config_class"),ow.forEach(t),wu=i(Fa," ("),Xa=s(Fa,"A",{href:!0});var sw=a(Xa);Tu=i(sw,"PretrainedConfig"),sw.forEach(t),$u=i(Fa,") \u2014 A subclass of "),Ra=s(Fa,"A",{href:!0});var aw=a(Ra);ju=i(aw,"PretrainedConfig"),aw.forEach(t),Mu=i(Fa,` to use as configuration class
for this model architecture.`),Fa.forEach(t),nw.forEach(t),Pu=d(Ye),Rn=s(Ye,"LI",{});var mc=a(Rn);Ge=s(mc,"P",{});var Oa=a(Ge);Jr=s(Oa,"STRONG",{});var rw=a(Jr);Eu=i(rw,"load_tf_weights"),rw.forEach(t),Lu=i(Oa," ("),Qr=s(Oa,"CODE",{});var iw=a(Qr);qu=i(iw,"Callable"),iw.forEach(t),Fu=i(Oa,") \u2014 A python "),ei=s(Oa,"EM",{});var lw=a(ei);Ou=i(lw,"method"),lw.forEach(t),Du=i(Oa,` for loading a TensorFlow checkpoint in a PyTorch model,
taking as arguments:`),Oa.forEach(t),zu=d(mc),st=s(mc,"UL",{});var br=a(st);$t=s(br,"LI",{});var $p=a($t);ti=s($p,"STRONG",{});var dw=a(ti);Au=i(dw,"model"),dw.forEach(t),Gu=i($p," ("),Ya=s($p,"A",{href:!0});var pw=a(Ya);Su=i(pw,"PreTrainedModel"),pw.forEach(t),Nu=i($p,") \u2014 An instance of the model on which to load the TensorFlow checkpoint."),$p.forEach(t),Cu=d(br),jt=s(br,"LI",{});var jp=a(jt);ni=s(jp,"STRONG",{});var cw=a(ni);Iu=i(cw,"config"),cw.forEach(t),Bu=i(jp," ("),oi=s(jp,"CODE",{});var mw=a(oi);Wu=i(mw,"PreTrainedConfig"),mw.forEach(t),Uu=i(jp,") \u2014 An instance of the configuration associated to the model."),jp.forEach(t),Hu=d(br),Mt=s(br,"LI",{});var Mp=a(Mt);si=s(Mp,"STRONG",{});var uw=a(si);Vu=i(uw,"path"),uw.forEach(t),Xu=i(Mp," ("),ai=s(Mp,"CODE",{});var gw=a(ai);Ru=i(gw,"str"),gw.forEach(t),Yu=i(Mp,") \u2014 A path to the TensorFlow checkpoint."),Mp.forEach(t),br.forEach(t),mc.forEach(t),Ku=d(Ye),ri=s(Ye,"LI",{});var hw=a(ri);Pt=s(hw,"P",{});var Pp=a(Pt);ii=s(Pp,"STRONG",{});var _w=a(ii);Zu=i(_w,"base_model_prefix"),_w.forEach(t),Ju=i(Pp," ("),li=s(Pp,"CODE",{});var fw=a(li);Qu=i(fw,"str"),fw.forEach(t),eg=i(Pp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Pp.forEach(t),hw.forEach(t),tg=d(Ye),di=s(Ye,"LI",{});var bw=a(di);Et=s(bw,"P",{});var Ep=a(Et);pi=s(Ep,"STRONG",{});var vw=a(pi);ng=i(vw,"is_parallelizable"),vw.forEach(t),og=i(Ep," ("),ci=s(Ep,"CODE",{});var yw=a(ci);sg=i(yw,"bool"),yw.forEach(t),ag=i(Ep,") \u2014 A flag indicating whether this model supports model parallelization."),Ep.forEach(t),bw.forEach(t),rg=d(Ye),mi=s(Ye,"LI",{});var kw=a(mi);V=s(kw,"P",{});var Oe=a(V);ui=s(Oe,"STRONG",{});var xw=a(ui);ig=i(xw,"main_input_name"),xw.forEach(t),lg=i(Oe," ("),gi=s(Oe,"CODE",{});var ww=a(gi);dg=i(ww,"str"),ww.forEach(t),pg=i(Oe,") \u2014 The name of the principal input to the model (often "),hi=s(Oe,"CODE",{});var Tw=a(hi);cg=i(Tw,"input_ids"),Tw.forEach(t),mg=i(Oe,` for NLP
models, `),_i=s(Oe,"CODE",{});var $w=a(_i);ug=i($w,"pixel_values"),$w.forEach(t),gg=i(Oe," for vision models and "),fi=s(Oe,"CODE",{});var jw=a(fi);hg=i(jw,"input_values"),jw.forEach(t),_g=i(Oe," for speech models)."),Oe.forEach(t),kw.forEach(t),Ye.forEach(t),fg=d($),le=s($,"DIV",{class:!0});var En=a(le);m(Yn.$$.fragment,En),bg=d(En),Kn=s(En,"P",{});var uc=a(Kn);vg=i(uc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),bi=s(uc,"CODE",{});var Mw=a(bi);yg=i(Mw,"repo_path_or_name"),Mw.forEach(t),kg=i(uc,"."),uc.forEach(t),xg=d(En),vi=s(En,"P",{});var Pw=a(vi);wg=i(Pw,"Examples:"),Pw.forEach(t),Tg=d(En),m(Zn.$$.fragment,En),En.forEach(t),$g=d($),D=s($,"DIV",{class:!0});var C=a(D);m(Jn.$$.fragment,C),jg=d(C),yi=s(C,"P",{});var Ew=a(yi);Mg=i(Ew,"Instantiate a pretrained pytorch model from a pre-trained model configuration."),Ew.forEach(t),Pg=d(C),at=s(C,"P",{});var vr=a(at);Eg=i(vr,"The model is set in evaluation mode by default using "),ki=s(vr,"CODE",{});var Lw=a(ki);Lg=i(Lw,"model.eval()"),Lw.forEach(t),qg=i(vr,` (Dropout modules are deactivated). To train
the model, you should first set it back in training mode with `),xi=s(vr,"CODE",{});var qw=a(xi);Fg=i(qw,"model.train()"),qw.forEach(t),Og=i(vr,"."),vr.forEach(t),Dg=d(C),Qn=s(C,"P",{});var gc=a(Qn);zg=i(gc,"The warning "),wi=s(gc,"EM",{});var Fw=a(wi);Ag=i(Fw,"Weights from XXX not initialized from pretrained model"),Fw.forEach(t),Gg=i(gc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),gc.forEach(t),Sg=d(C),eo=s(C,"P",{});var hc=a(eo);Ng=i(hc,"The warning "),Ti=s(hc,"EM",{});var Ow=a(Ti);Cg=i(Ow,"Weights from XXX not used in YYY"),Ow.forEach(t),Ig=i(hc,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),hc.forEach(t),Bg=d(C),m(Lt.$$.fragment,C),Wg=d(C),m(qt.$$.fragment,C),Ug=d(C),$i=s(C,"P",{});var Dw=a($i);Hg=i(Dw,"Examples:"),Dw.forEach(t),Vg=d(C),m(to.$$.fragment,C),C.forEach(t),Xg=d($),Ft=s($,"DIV",{class:!0});var _c=a(Ft);m(no.$$.fragment,_c),Rg=d(_c),ji=s(_c,"P",{});var zw=a(ji);Yg=i(zw,"Returns the model\u2019s input embeddings."),zw.forEach(t),_c.forEach(t),Kg=d($),Ot=s($,"DIV",{class:!0});var fc=a(Ot);m(oo.$$.fragment,fc),Zg=d(fc),Mi=s(fc,"P",{});var Aw=a(Mi);Jg=i(Aw,"Returns the model\u2019s output embeddings."),Aw.forEach(t),fc.forEach(t),Qg=d($),Se=s($,"DIV",{class:!0});var yr=a(Se);m(so.$$.fragment,yr),eh=d(yr),Pi=s(yr,"P",{});var Gw=a(Pi);th=i(Gw,"Deactivates gradient checkpointing for the current model."),Gw.forEach(t),nh=d(yr),Ei=s(yr,"P",{});var Sw=a(Ei);oh=i(Sw,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Sw.forEach(t),yr.forEach(t),sh=d($),Ne=s($,"DIV",{class:!0});var kr=a(Ne);m(ao.$$.fragment,kr),ah=d(kr),Li=s(kr,"P",{});var Nw=a(Li);rh=i(Nw,"Activates gradient checkpointing for the current model."),Nw.forEach(t),ih=d(kr),qi=s(kr,"P",{});var Cw=a(qi);lh=i(Cw,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Cw.forEach(t),kr.forEach(t),dh=d($),Dt=s($,"DIV",{class:!0});var bc=a(Dt);m(ro.$$.fragment,bc),ph=d(bc),Fi=s(bc,"P",{});var Iw=a(Fi);ch=i(Iw,"If needed prunes and maybe initializes weights."),Iw.forEach(t),bc.forEach(t),mh=d($),zt=s($,"DIV",{class:!0});var vc=a(zt);m(io.$$.fragment,vc),uh=d(vc),Oi=s(vc,"P",{});var Bw=a(Oi);gh=i(Bw,`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),Bw.forEach(t),vc.forEach(t),hh=d($),At=s($,"DIV",{class:!0});var yc=a(At);m(lo.$$.fragment,yc),_h=d(yc),Di=s(yc,"P",{});var Ww=a(Di);fh=i(Ww,"Prunes heads of the base model."),Ww.forEach(t),yc.forEach(t),bh=d($),Ce=s($,"DIV",{class:!0});var xr=a(Ce);m(po.$$.fragment,xr),vh=d(xr),zi=s(xr,"P",{});var Uw=a(zi);yh=i(Uw,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Uw.forEach(t),kh=d(xr),m(Gt.$$.fragment,xr),xr.forEach(t),xh=d($),Ie=s($,"DIV",{class:!0});var wr=a(Ie);m(co.$$.fragment,wr),wh=d(wr),mo=s(wr,"P",{});var kc=a(mo);Th=i(kc,"Resizes input token embeddings matrix of the model if "),Ai=s(kc,"CODE",{});var Hw=a(Ai);$h=i(Hw,"new_num_tokens != config.vocab_size"),Hw.forEach(t),jh=i(kc,"."),kc.forEach(t),Mh=d(wr),uo=s(wr,"P",{});var xc=a(uo);Ph=i(xc,"Takes care of tying weights embeddings afterwards if the model class has a "),Gi=s(xc,"CODE",{});var Vw=a(Gi);Eh=i(Vw,"tie_weights()"),Vw.forEach(t),Lh=i(xc," method."),xc.forEach(t),wr.forEach(t),qh=d($),St=s($,"DIV",{class:!0});var wc=a(St);m(go.$$.fragment,wc),Fh=d(wc),ho=s(wc,"P",{});var Tc=a(ho);Oh=i(Tc,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=s(Tc,"CODE",{});var Xw=a(Si);Dh=i(Xw,"[from_pretrained()](/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Xw.forEach(t),zh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d($),Nt=s($,"DIV",{class:!0});var $c=a(Nt);m(_o.$$.fragment,$c),Gh=d($c),Ni=s($c,"P",{});var Rw=a(Ni);Sh=i(Rw,"Set model\u2019s input embeddings."),Rw.forEach(t),$c.forEach(t),Nh=d($),Be=s($,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var Yw=a(Ci);Ih=i(Yw,"Tie the weights between the input embeddings and the output embeddings."),Yw.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var jc=a(bo);Wh=i(jc,"If the "),Ii=s(jc,"CODE",{});var Kw=a(Ii);Uh=i(Kw,"torchscript"),Kw.forEach(t),Hh=i(jc,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),jc.forEach(t),Tr.forEach(t),$.forEach(t),Np=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cp=d(n),rt=s(n,"H3",{class:!0});var Mc=a(rt);Ct=s(Mc,"A",{id:!0,class:!0,href:!0});var Zw=a(Ct);Bi=s(Zw,"SPAN",{});var Jw=a(Bi);m(vo.$$.fragment,Jw),Jw.forEach(t),Zw.forEach(t),Vh=d(Mc),Wi=s(Mc,"SPAN",{});var Qw=a(Wi);Xh=i(Qw,"Model Instantiation dtype"),Qw.forEach(t),Mc.forEach(t),Ip=d(n),de=s(n,"P",{});var Ln=a(de);Rh=i(Ln,"Under Pytorch a model normally gets instantiated with "),Ui=s(Ln,"CODE",{});var eT=a(Ui);Yh=i(eT,"torch.float32"),eT.forEach(t),Kh=i(Ln,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(Ln,"CODE",{});var tT=a(Hi);Zh=i(tT,"dtype"),tT.forEach(t),Jh=i(Ln," using "),Vi=s(Ln,"CODE",{});var nT=a(Vi);Qh=i(nT,"torch_dtype"),nT.forEach(t),e_=i(Ln," argument:"),Ln.forEach(t),Bp=d(n),m(yo.$$.fragment,n),Wp=d(n),We=s(n,"P",{});var $r=a(We);t_=i($r,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s($r,"CODE",{});var oT=a(Xi);n_=i(oT,'"auto"'),oT.forEach(t),o_=i($r,`,
and then `),Ri=s($r,"CODE",{});var sT=a(Ri);s_=i(sT,"dtype"),sT.forEach(t),a_=i($r," will be automatically derived from the model\u2019s weights:"),$r.forEach(t),Up=d(n),m(ko.$$.fragment,n),Hp=d(n),It=s(n,"P",{});var Pc=a(It);r_=i(Pc,"Models instantiated from scratch can also be told which "),Yi=s(Pc,"CODE",{});var aT=a(Yi);i_=i(aT,"dtype"),aT.forEach(t),l_=i(Pc," to use with:"),Pc.forEach(t),Vp=d(n),m(xo.$$.fragment,n),Xp=d(n),Za=s(n,"P",{});var rT=a(Za);d_=i(rT,"Due to Pytorch design, this functionality is only available for floating dtypes."),rT.forEach(t),Rp=d(n),it=s(n,"H2",{class:!0});var Ec=a(it);Bt=s(Ec,"A",{id:!0,class:!0,href:!0});var iT=a(Bt);Ki=s(iT,"SPAN",{});var lT=a(Ki);m(wo.$$.fragment,lT),lT.forEach(t),iT.forEach(t),p_=d(Ec),Zi=s(Ec,"SPAN",{});var dT=a(Zi);c_=i(dT,"ModuleUtilsMixin"),dT.forEach(t),Ec.forEach(t),Yp=d(n),L=s(n,"DIV",{class:!0});var z=a(L);m(To.$$.fragment,z),m_=d(z),$o=s(z,"P",{});var Lc=a($o);u_=i(Lc,"A few utilities for "),Ji=s(Lc,"CODE",{});var pT=a(Ji);g_=i(pT,"torch.nn.Modules"),pT.forEach(t),h_=i(Lc,", to be used as a mixin."),Lc.forEach(t),__=d(z),Ue=s(z,"DIV",{class:!0});var jr=a(Ue);m(jo.$$.fragment,jr),f_=d(jr),Qi=s(jr,"P",{});var cT=a(Qi);b_=i(cT,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),cT.forEach(t),v_=d(jr),lt=s(jr,"P",{});var Mr=a(lt);y_=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var mT=a(el);k_=i(mT,"mem_rss_diff"),mT.forEach(t),x_=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var uT=a(tl);w_=i(uT,"model.reset_memory_hooks_state()"),uT.forEach(t),T_=i(Mr,"."),Mr.forEach(t),jr.forEach(t),$_=d(z),Wt=s(z,"DIV",{class:!0});var qc=a(Wt);m(Mo.$$.fragment,qc),j_=d(qc),nl=s(qc,"P",{});var gT=a(nl);M_=i(gT,"Helper function to estimate the total number of tokens from the model inputs."),gT.forEach(t),qc.forEach(t),P_=d(z),Ut=s(z,"DIV",{class:!0});var Fc=a(Ut);m(Po.$$.fragment,Fc),E_=d(Fc),dt=s(Fc,"P",{});var Pr=a(dt);L_=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
tokens (valid if `),ol=s(Pr,"CODE",{});var hT=a(ol);q_=i(hT,"12 * d_model << sequence_length"),hT.forEach(t),F_=i(Pr,") as laid out in "),Eo=s(Pr,"A",{href:!0,rel:!0});var _T=a(Eo);O_=i(_T,`this
paper`),_T.forEach(t),D_=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fc.forEach(t),z_=d(z),Ht=s(z,"DIV",{class:!0});var Oc=a(Ht);m(Lo.$$.fragment,Oc),A_=d(Oc),sl=s(Oc,"P",{});var fT=a(sl);G_=i(fT,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),fT.forEach(t),Oc.forEach(t),S_=d(z),Vt=s(z,"DIV",{class:!0});var Dc=a(Vt);m(qo.$$.fragment,Dc),N_=d(Dc),al=s(Dc,"P",{});var bT=a(al);C_=i(bT,"Prepare the head mask if needed."),bT.forEach(t),Dc.forEach(t),I_=d(z),Xt=s(z,"DIV",{class:!0});var zc=a(Xt);m(Fo.$$.fragment,zc),B_=d(zc),rl=s(zc,"P",{});var vT=a(rl);W_=i(vT,"Invert an attention mask (e.g., switches 0. and 1.)."),vT.forEach(t),zc.forEach(t),U_=d(z),Rt=s(z,"DIV",{class:!0});var Ac=a(Rt);m(Oo.$$.fragment,Ac),H_=d(Ac),il=s(Ac,"P",{});var yT=a(il);V_=i(yT,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),yT.forEach(t),Ac.forEach(t),X_=d(z),Yt=s(z,"DIV",{class:!0});var Gc=a(Yt);m(Do.$$.fragment,Gc),R_=d(Gc),pt=s(Gc,"P",{});var Er=a(pt);Y_=i(Er,"Reset the "),ll=s(Er,"CODE",{});var kT=a(ll);K_=i(kT,"mem_rss_diff"),kT.forEach(t),Z_=i(Er," attribute of each module (see "),Ja=s(Er,"A",{href:!0});var xT=a(Ja);J_=i(xT,"add_memory_hooks()"),xT.forEach(t),Q_=i(Er,")."),Er.forEach(t),Gc.forEach(t),z.forEach(t),Kp=d(n),ct=s(n,"H2",{class:!0});var Sc=a(ct);Kt=s(Sc,"A",{id:!0,class:!0,href:!0});var wT=a(Kt);dl=s(wT,"SPAN",{});var TT=a(dl);m(zo.$$.fragment,TT),TT.forEach(t),wT.forEach(t),ef=d(Sc),pl=s(Sc,"SPAN",{});var $T=a(pl);tf=i($T,"TFPreTrainedModel"),$T.forEach(t),Sc.forEach(t),Zp=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),nf=d(k),cl=s(k,"P",{});var jT=a(cl);of=i(jT,"Base class for all TF models."),jT.forEach(t),sf=d(k),Qa=s(k,"P",{});var Dx=a(Qa);er=s(Dx,"A",{href:!0});var MT=a(er);af=i(MT,"TFPreTrainedModel"),MT.forEach(t),rf=i(Dx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),Dx.forEach(t),lf=d(k),Go=s(k,"UL",{});var Nc=a(Go);ml=s(Nc,"LI",{});var PT=a(ml);df=i(PT,"resize the input embeddings,"),PT.forEach(t),pf=d(Nc),ul=s(Nc,"LI",{});var ET=a(ul);cf=i(ET,"prune heads in the self-attention heads."),ET.forEach(t),Nc.forEach(t),mf=d(k),gl=s(k,"P",{});var LT=a(gl);uf=i(LT,"Class attributes (overridden by derived classes):"),LT.forEach(t),gf=d(k),mt=s(k,"UL",{});var Lr=a(mt);He=s(Lr,"LI",{});var Da=a(He);hl=s(Da,"STRONG",{});var qT=a(hl);hf=i(qT,"config_class"),qT.forEach(t),_f=i(Da," ("),tr=s(Da,"A",{href:!0});var FT=a(tr);ff=i(FT,"PretrainedConfig"),FT.forEach(t),bf=i(Da,") \u2014 A subclass of "),nr=s(Da,"A",{href:!0});var OT=a(nr);vf=i(OT,"PretrainedConfig"),OT.forEach(t),yf=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),kf=d(Lr),Zt=s(Lr,"LI",{});var Lp=a(Zt);_l=s(Lp,"STRONG",{});var DT=a(_l);xf=i(DT,"base_model_prefix"),DT.forEach(t),wf=i(Lp," ("),fl=s(Lp,"CODE",{});var zT=a(fl);Tf=i(zT,"str"),zT.forEach(t),$f=i(Lp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Lp.forEach(t),jf=d(Lr),X=s(Lr,"LI",{});var De=a(X);bl=s(De,"STRONG",{});var AT=a(bl);Mf=i(AT,"main_input_name"),AT.forEach(t),Pf=i(De," ("),vl=s(De,"CODE",{});var GT=a(vl);Ef=i(GT,"str"),GT.forEach(t),Lf=i(De,") \u2014 The name of the principal input to the model (often "),yl=s(De,"CODE",{});var ST=a(yl);qf=i(ST,"input_ids"),ST.forEach(t),Ff=i(De,` for NLP
models, `),kl=s(De,"CODE",{});var NT=a(kl);Of=i(NT,"pixel_values"),NT.forEach(t),Df=i(De," for vision models and "),xl=s(De,"CODE",{});var CT=a(xl);zf=i(CT,"input_values"),CT.forEach(t),Af=i(De," for speech models)."),De.forEach(t),Lr.forEach(t),Gf=d(k),pe=s(k,"DIV",{class:!0});var qn=a(pe);m(So.$$.fragment,qn),Sf=d(qn),No=s(qn,"P",{});var Cc=a(No);Nf=i(Cc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=s(Cc,"CODE",{});var IT=a(wl);Cf=i(IT,"repo_path_or_name"),IT.forEach(t),If=i(Cc,"."),Cc.forEach(t),Bf=d(qn),Tl=s(qn,"P",{});var BT=a(Tl);Wf=i(BT,"Examples:"),BT.forEach(t),Uf=d(qn),m(Co.$$.fragment,qn),qn.forEach(t),Hf=d(k),Jt=s(k,"DIV",{class:!0});var Ic=a(Jt);m(Io.$$.fragment,Ic),Vf=d(Ic),$l=s(Ic,"P",{});var WT=a($l);Xf=i(WT,`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),WT.forEach(t),Ic.forEach(t),Rf=d(k),S=s(k,"DIV",{class:!0});var Z=a(S);m(Bo.$$.fragment,Z),Yf=d(Z),jl=s(Z,"P",{});var UT=a(jl);Kf=i(UT,"Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),UT.forEach(t),Zf=d(Z),Wo=s(Z,"P",{});var Bc=a(Wo);Jf=i(Bc,"The warning "),Ml=s(Bc,"EM",{});var HT=a(Ml);Qf=i(HT,"Weights from XXX not initialized from pretrained model"),HT.forEach(t),eb=i(Bc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),Bc.forEach(t),tb=d(Z),Uo=s(Z,"P",{});var Wc=a(Uo);nb=i(Wc,"The warning "),Pl=s(Wc,"EM",{});var VT=a(Pl);ob=i(VT,"Weights from XXX not used in YYY"),VT.forEach(t),sb=i(Wc,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),Wc.forEach(t),ab=d(Z),m(Qt.$$.fragment,Z),rb=d(Z),El=s(Z,"P",{});var XT=a(El);ib=i(XT,"Examples:"),XT.forEach(t),lb=d(Z),m(Ho.$$.fragment,Z),Z.forEach(t),db=d(k),en=s(k,"DIV",{class:!0});var Uc=a(en);m(Vo.$$.fragment,Uc),pb=d(Uc),Ll=s(Uc,"P",{});var RT=a(Ll);cb=i(RT,"Dict of bias attached to an LM head. The key represents the name of the bias attribute."),RT.forEach(t),Uc.forEach(t),mb=d(k),tn=s(k,"DIV",{class:!0});var Hc=a(tn);m(Xo.$$.fragment,Hc),ub=d(Hc),ql=s(Hc,"P",{});var YT=a(ql);gb=i(YT,"Returns the model\u2019s input embeddings layer."),YT.forEach(t),Hc.forEach(t),hb=d(k),nn=s(k,"DIV",{class:!0});var Vc=a(nn);m(Ro.$$.fragment,Vc),_b=d(Vc),Fl=s(Vc,"P",{});var KT=a(Fl);fb=i(KT,"The LM Head layer. This method must be overwritten by all the models that have a lm head."),KT.forEach(t),Vc.forEach(t),bb=d(k),on=s(k,"DIV",{class:!0});var Xc=a(on);m(Yo.$$.fragment,Xc),vb=d(Xc),Ol=s(Xc,"P",{});var ZT=a(Ol);yb=i(ZT,"Returns the model\u2019s output embeddings"),ZT.forEach(t),Xc.forEach(t),kb=d(k),sn=s(k,"DIV",{class:!0});var Rc=a(sn);m(Ko.$$.fragment,Rc),xb=d(Rc),Dl=s(Rc,"P",{});var JT=a(Dl);wb=i(JT,`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),JT.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),$b=d(Yc),zl=s(Yc,"P",{});var QT=a(zl);jb=i(QT,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),QT.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var e$=a(Al);Eb=i(e$,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),e$.forEach(t),Kc.forEach(t),Lb=d(k),ln=s(k,"DIV",{class:!0});var Zc=a(ln);m(Qo.$$.fragment,Zc),qb=d(Zc),Gl=s(Zc,"P",{});var t$=a(Gl);Fb=i(t$,"Prunes heads of the base model."),t$.forEach(t),Zc.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),Db=d(qr),ts=s(qr,"P",{});var Jc=a(ts);zb=i(Jc,"Resizes input token embeddings matrix of the model if "),Sl=s(Jc,"CODE",{});var n$=a(Sl);Ab=i(n$,"new_num_tokens != config.vocab_size"),n$.forEach(t),Gb=i(Jc,"."),Jc.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qc=a(ns);Nb=i(Qc,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qc,"CODE",{});var o$=a(Nl);Cb=i(o$,"tie_weights()"),o$.forEach(t),Ib=i(Qc," method."),Qc.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),or=s(tm,"A",{href:!0});var s$=a(or);Hb=i(s$,"from_pretrained()"),s$.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),pn=s(k,"DIV",{class:!0});var nm=a(pn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var a$=a(Cl);Yb=i(a$,"Method used for serving the model."),a$.forEach(t),nm.forEach(t),Kb=d(k),cn=s(k,"DIV",{class:!0});var om=a(cn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var r$=a(Il);Jb=i(r$,"Prepare the output of the saved model. Each model must implement this function."),r$.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),ev=d(sm),Bl=s(sm,"P",{});var i$=a(Bl);tv=i(i$,"Set all the bias in the LM head."),i$.forEach(t),sm.forEach(t),nv=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),ov=d(am),Wl=s(am,"P",{});var l$=a(Wl);sv=i(l$,"Set model\u2019s input embeddings"),l$.forEach(t),am.forEach(t),av=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),rv=d(rm),Ul=s(rm,"P",{});var d$=a(Ul);iv=i(d$,"Set model\u2019s output embeddings"),d$.forEach(t),rm.forEach(t),lv=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(ps.$$.fragment,im),dv=d(im),Hl=s(im,"P",{});var p$=a(Hl);pv=i(p$,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),p$.forEach(t),im.forEach(t),cv=d(k),ce=s(k,"DIV",{class:!0});var Fn=a(ce);m(cs.$$.fragment,Fn),mv=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);uv=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var c$=a(Vl);gv=i(c$,"train_step"),c$.forEach(t),hv=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var m$=a(Xl);_v=i(m$,"train_step"),m$.forEach(t),fv=i(Ke,`. In
this case, it expects the same `),Rl=s(Ke,"CODE",{});var u$=a(Rl);bv=i(u$,"data"),u$.forEach(t),vv=i(Ke," as the original function (i.e. "),Yl=s(Ke,"CODE",{});var g$=a(Yl);yv=i(g$,"(inputs, labels)"),g$.forEach(t),kv=i(Ke,")."),Ke.forEach(t),xv=d(Fn),ut=s(Fn,"P",{});var Fr=a(ut);wv=i(Fr,`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h$=a(Kl);Tv=i(h$,"data"),h$.forEach(t),$v=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _$=a(Zl);jv=i(_$,"(inputs,)"),_$.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var f$=a(Jl);Lv=i(f$,"loss"),f$.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b$=a(Ql);Fv=i(b$,"loss"),b$.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v$=a(_n);ed=s(v$,"SPAN",{});var y$=a(ed);m(ms.$$.fragment,y$),y$.forEach(t),v$.forEach(t),Dv=d(lm),td=s(lm,"SPAN",{});var k$=a(td);zv=i(k$,"TFModelUtilsMixin"),k$.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var Dr=a(Pe);m(us.$$.fragment,Dr),Av=d(Dr),gs=s(Dr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x$=a(nd);Sv=i(x$,"tf.keras.Model"),x$.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(Dr),fn=s(Dr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),Iv=d(pm),od=s(pm,"P",{});var w$=a(od);Bv=i(w$,"Get the number of (optionally, trainable) parameters in the model."),w$.forEach(t),pm.forEach(t),Dr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T$=a(bn);sd=s(T$,"SPAN",{});var $$=a(sd);m(_s.$$.fragment,$$),$$.forEach(t),T$.forEach(t),Wv=d(cm),ad=s(cm,"SPAN",{});var j$=a(ad);Uv=i(j$,"FlaxPreTrainedModel"),j$.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var M$=a(rd);Vv=i(M$,"Base class for all models."),M$.forEach(t),Xv=d(q),sr=s(q,"P",{});var zx=a(sr);ar=s(zx,"A",{href:!0});var P$=a(ar);Rv=i(P$,"FlaxPreTrainedModel"),P$.forEach(t),Yv=i(zx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),zx.forEach(t),Kv=d(q),id=s(q,"P",{});var E$=a(id);Zv=i(E$,"Class attributes (overridden by derived classes):"),E$.forEach(t),Jv=d(q),ft=s(q,"UL",{});var zr=a(ft);Xe=s(zr,"LI",{});var za=a(Xe);ld=s(za,"STRONG",{});var L$=a(ld);Qv=i(L$,"config_class"),L$.forEach(t),e1=i(za," ("),rr=s(za,"A",{href:!0});var q$=a(rr);t1=i(q$,"PretrainedConfig"),q$.forEach(t),n1=i(za,") \u2014 A subclass of "),ir=s(za,"A",{href:!0});var F$=a(ir);o1=i(F$,"PretrainedConfig"),F$.forEach(t),s1=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),a1=d(zr),vn=s(zr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O$=a(dd);r1=i(O$,"base_model_prefix"),O$.forEach(t),i1=i(qp," ("),pd=s(qp,"CODE",{});var D$=a(pd);l1=i(D$,"str"),D$.forEach(t),d1=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),p1=d(zr),R=s(zr,"LI",{});var ze=a(R);cd=s(ze,"STRONG",{});var z$=a(cd);c1=i(z$,"main_input_name"),z$.forEach(t),m1=i(ze," ("),md=s(ze,"CODE",{});var A$=a(md);u1=i(A$,"str"),A$.forEach(t),g1=i(ze,") \u2014 The name of the principal input to the model (often "),ud=s(ze,"CODE",{});var G$=a(ud);h1=i(G$,"input_ids"),G$.forEach(t),_1=i(ze,` for NLP
models, `),gd=s(ze,"CODE",{});var S$=a(gd);f1=i(S$,"pixel_values"),S$.forEach(t),b1=i(ze," for vision models and "),hd=s(ze,"CODE",{});var N$=a(hd);v1=i(N$,"input_values"),N$.forEach(t),y1=i(ze," for speech models)."),ze.forEach(t),zr.forEach(t),k1=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),x1=d(On),vs=s(On,"P",{});var mm=a(vs);w1=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C$=a(_d);T1=i(C$,"repo_path_or_name"),C$.forEach(t),$1=i(mm,"."),mm.forEach(t),j1=d(On),fd=s(On,"P",{});var I$=a(fd);M1=i(I$,"Examples:"),I$.forEach(t),P1=d(On),m(ys.$$.fragment,On),On.forEach(t),E1=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),L1=d(Te),bd=s(Te,"P",{});var B$=a(bd);q1=i(B$,"Instantiate a pretrained flax model from a pre-trained model configuration."),B$.forEach(t),F1=d(Te),xs=s(Te,"P",{});var um=a(xs);O1=i(um,"The warning "),vd=s(um,"EM",{});var W$=a(vd);D1=i(W$,"Weights from XXX not initialized from pretrained model"),W$.forEach(t),z1=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),A1=d(Te),ws=s(Te,"P",{});var gm=a(ws);G1=i(gm,"The warning "),yd=s(gm,"EM",{});var U$=a(yd);S1=i(U$,"Weights from XXX not used in YYY"),U$.forEach(t),N1=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),C1=d(Te),kd=s(Te,"P",{});var H$=a(kd);I1=i(H$,"Examples:"),H$.forEach(t),B1=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),W1=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m($s.$$.fragment,Ar),U1=d(Ar),xd=s(Ar,"P",{});var V$=a(xd);H1=i(V$,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V$.forEach(t),V1=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),X1=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m(js.$$.fragment,hm),R1=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Y1=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X$=a(wd);K1=i(X$,"[from_pretrained()](/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X$.forEach(t),Z1=i(_m," class method"),_m.forEach(t),hm.forEach(t),J1=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Q1=d(Ze),se=s(Ze,"P",{});var Je=a(se);ey=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R$=a(Td);ty=i(R$,"params"),R$.forEach(t),ny=i(Je," to "),$d=s(Je,"CODE",{});var Y$=a($d);oy=i(Y$,"jax.numpy.bfloat16"),Y$.forEach(t),sy=i(Je,". This returns a new "),jd=s(Je,"CODE",{});var K$=a(jd);ay=i(K$,"params"),K$.forEach(t),ry=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Z$=a(Md);iy=i(Z$,"params"),Z$.forEach(t),ly=i(Je," in place."),Je.forEach(t),dy=d(Ze),Pd=s(Ze,"P",{});var J$=a(Pd);py=i(J$,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),J$.forEach(t),cy=d(Ze),Ed=s(Ze,"P",{});var Q$=a(Ed);my=i(Q$,"Examples:"),Q$.forEach(t),uy=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),gy=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),hy=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_y=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var ej=a(Ld);fy=i(ej,"parmas"),ej.forEach(t),by=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);vy=i(tj,"jax.numpy.float16"),tj.forEach(t),yy=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);ky=i(nj,"params"),nj.forEach(t),xy=i(et,` tree and does not cast the
`),Od=s(et,"CODE",{});var oj=a(Od);wy=i(oj,"params"),oj.forEach(t),Ty=i(et," in place."),et.forEach(t),$y=d(Qe),Dd=s(Qe,"P",{});var sj=a(Dd);jy=i(sj,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),sj.forEach(t),My=d(Qe),zd=s(Qe,"P",{});var aj=a(zd);Py=i(aj,"Examples:"),aj.forEach(t),Ey=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),Ly=d(q),ue=s(q,"DIV",{class:!0});var Dn=a(ue);m(Fs.$$.fragment,Dn),qy=d(Dn),re=s(Dn,"P",{});var tt=a(re);Fy=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var rj=a(Ad);Oy=i(rj,"parmas"),rj.forEach(t),Dy=i(tt," to "),Gd=s(tt,"CODE",{});var ij=a(Gd);zy=i(ij,"jax.numpy.float32"),ij.forEach(t),Ay=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var lj=a(Sd);Gy=i(lj,"params"),lj.forEach(t),Sy=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var dj=a(Nd);Ny=i(dj,"params"),dj.forEach(t),Cy=i(tt," in place."),tt.forEach(t),Iy=d(Dn),Cd=s(Dn,"P",{});var pj=a(Cd);By=i(pj,"Examples:"),pj.forEach(t),Wy=d(Dn),m(Os.$$.fragment,Dn),Dn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var cj=a(xn);Id=s(cj,"SPAN",{});var mj=a(Id);m(Ds.$$.fragment,mj),mj.forEach(t),cj.forEach(t),Uy=d(fm),Bd=s(fm,"SPAN",{});var uj=a(Bd);Hy=i(uj,"Generation"),uj.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(zs.$$.fragment,F),Vy=d(F),As=s(F,"P",{});var bm=a(As);Xy=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var gj=a(lr);Ry=i(gj,"PreTrainedModel"),gj.forEach(t),Yy=i(bm,"."),bm.forEach(t),Ky=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Zy=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);Jy=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var hj=a(dr);Qy=i(hj,"PreTrainedModel"),hj.forEach(t),e2=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),t2=d(F),ge=s(F,"DIV",{class:!0});var zn=a(ge);m(Ns.$$.fragment,zn),n2=d(zn),Wd=s(zn,"P",{});var _j=a(Wd);o2=i(_j,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_j.forEach(t),s2=d(zn),Ud=s(zn,"P",{});var fj=a(Ud);a2=i(fj,"Examples:"),fj.forEach(t),r2=d(zn),m(Cs.$$.fragment,zn),zn.forEach(t),i2=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),l2=d(An),Hd=s(An,"P",{});var bj=a(Hd);d2=i(bj,"Generates sequences for models with a language modeling head using beam search decoding."),bj.forEach(t),p2=d(An),Vd=s(An,"P",{});var vj=a(Vd);c2=i(vj,"Examples:"),vj.forEach(t),m2=d(An),m(Bs.$$.fragment,An),An.forEach(t),u2=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),g2=d(km),Xd=s(km,"P",{});var yj=a(Xd);h2=i(yj,`compute the transition probabilities of sequences given generation
scores and beam indices`),yj.forEach(t),km.forEach(t),_2=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),f2=d(Gn),Rd=s(Gn,"P",{});var kj=a(Rd);b2=i(kj,"Generates sequences for models with a language modeling head using beam search decoding."),kj.forEach(t),v2=d(Gn),Yd=s(Gn,"P",{});var xj=a(Yd);y2=i(xj,"Examples:"),xj.forEach(t),k2=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),x2=d(F),U=s(F,"DIV",{class:!0});var $e=a(U);m(Vs.$$.fragment,$e),w2=d($e),Kd=s($e,"P",{});var wj=a(Kd);T2=i(wj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),wj.forEach(t),$2=d($e),vt=s($e,"P",{});var Gr=a(vt);j2=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var Tj=a(Zd);M2=i(Tj,"inputs"),Tj.forEach(t),P2=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var $j=a(pr);E2=i($j,"PretrainedConfig"),$j.forEach(t),L2=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),q2=d($e),Xs=s($e,"P",{});var xm=a(Xs);F2=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var jj=a(Rs);O2=i(jj,`this blog
post`),jj.forEach(t),D2=i(xm,"."),xm.forEach(t),z2=d($e),Jd=s($e,"P",{});var Mj=a(Jd);A2=i(Mj,"Examples:"),Mj.forEach(t),G2=d($e),m(Ys.$$.fragment,$e),$e.forEach(t),S2=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),N2=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);C2=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),I2=d(Sn),ep=s(Sn,"P",{});var Ej=a(ep);B2=i(Ej,"Examples:"),Ej.forEach(t),W2=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),U2=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),H2=d(Nn),tp=s(Nn,"P",{});var Lj=a(tp);V2=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),X2=d(Nn),np=s(Nn,"P",{});var qj=a(np);R2=i(qj,"Examples:"),qj.forEach(t),Y2=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),K2=d(F),$n=s(F,"DIV",{class:!0});var wm=a($n);m(ea.$$.fragment,wm),Z2=d(wm),ta=s(wm,"P",{});var Tm=a(ta);J2=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Q2=i(Fj,"PreTrainedModel"),Fj.forEach(t),ek=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tk=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nk=d(Cn),op=s(Cn,"P",{});var Oj=a(op);ok=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),sk=d(Cn),sp=s(Cn,"P",{});var Dj=a(sp);ak=i(Dj,"Examples:"),Dj.forEach(t),rk=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),ik=d(J),aa=s(J,"P",{});var $m=a(aa);lk=i($m,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s($m,"A",{href:!0});var zj=a(mr);dk=i(zj,"TFPreTrainedModel"),zj.forEach(t),pk=i($m,"."),$m.forEach(t),ck=d(J),jn=s(J,"DIV",{class:!0});var jm=a(jn);m(ra.$$.fragment,jm),mk=d(jm),ia=s(jm,"P",{});var Mm=a(ia);uk=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);gk=i(Aj,"PreTrainedModel"),Aj.forEach(t),hk=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),jm.forEach(t),_k=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fk=d(Q),ap=s(Q,"P",{});var Gj=a(ap);bk=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),Gj.forEach(t),vk=d(Q),da=s(Q,"P",{});var Pm=a(da);yk=i(Pm,"Adapted in part from "),pa=s(Pm,"A",{href:!0,rel:!0});var Sj=a(pa);kk=i(Sj,`Facebook\u2019s XLM beam search
code`),Sj.forEach(t),xk=i(Pm,"."),Pm.forEach(t),wk=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tk=i(In,"Apart from "),rp=s(In,"CODE",{});var Nj=a(rp);$k=i(Nj,"input_ids"),Nj.forEach(t),jk=i(In," and "),ip=s(In,"CODE",{});var Cj=a(ip);Mk=i(Cj,"attention_mask"),Cj.forEach(t),Pk=i(In,`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=s(In,"A",{href:!0});var Ij=a(gr);Ek=i(Ij,"PretrainedConfig"),Ij.forEach(t),Lk=i(In,` of the model. The default values indicated are the default
values of those config.`),In.forEach(t),qk=d(Q),ca=s(Q,"P",{});var Em=a(ca);Fk=i(Em,"Most of these parameters are explained in more detail in "),ma=s(Em,"A",{href:!0,rel:!0});var Bj=a(ma);Ok=i(Bj,`this blog
post`),Bj.forEach(t),Dk=i(Em,"."),Em.forEach(t),zk=d(Q),lp=s(Q,"P",{});var Wj=a(lp);Ak=i(Wj,"Examples:"),Wj.forEach(t),Gk=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),Sk=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),Nk=d(Bn),dp=s(Bn,"P",{});var Uj=a(dp);Ck=i(Uj,"Generates sequences for models with a language modeling head using greedy decoding."),Uj.forEach(t),Ik=d(Bn),pp=s(Bn,"P",{});var Hj=a(pp);Bk=i(Hj,"Examples:"),Hj.forEach(t),Wk=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),Uk=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(_a.$$.fragment,Lm),Hk=d(Lm),fa=s(Lm,"P",{});var qm=a(fa);Vk=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var Vj=a(hr);Xk=i(Vj,"TFPreTrainedModel"),Vj.forEach(t),Rk=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Yk=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),Kk=d(Wn),cp=s(Wn,"P",{});var Xj=a(cp);Zk=i(Xj,"Generates sequences for models with a language modeling head using multinomial sampling."),Xj.forEach(t),Jk=d(Wn),mp=s(Wn,"P",{});var Rj=a(mp);Qk=i(Rj,"Examples:"),Rj.forEach(t),ex=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),tx=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nx=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Yj=a(_r);ox=i(Yj,"FlaxPreTrainedModel"),Yj.forEach(t),sx=i(Fm,"."),Fm.forEach(t),ax=d(Sr),H=s(Sr,"DIV",{class:!0});var je=a(H);m(xa.$$.fragment,je),rx=d(je),up=s(je,"P",{});var Kj=a(up);ix=i(Kj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),Kj.forEach(t),lx=d(je),yt=s(je,"P",{});var Nr=a(yt);dx=i(Nr,"Apart from "),gp=s(Nr,"CODE",{});var Zj=a(gp);px=i(Zj,"input_ids"),Zj.forEach(t),cx=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
inside the `),fr=s(Nr,"A",{href:!0});var Jj=a(fr);mx=i(Jj,"PretrainedConfig"),Jj.forEach(t),ux=i(Nr,` of the model. The default values indicated are the default values of those
config.`),Nr.forEach(t),gx=d(je),wa=s(je,"P",{});var Om=a(wa);hx=i(Om,"Most of these parameters are explained in more detail in "),Ta=s(Om,"A",{href:!0,rel:!0});var Qj=a(Ta);_x=i(Qj,`this blog
post`),Qj.forEach(t),fx=i(Om,"."),Om.forEach(t),bx=d(je),hp=s(je,"P",{});var eM=a(hp);vx=i(eM,"Examples:"),eM.forEach(t),yx=d(je),m($a.$$.fragment,je),je.forEach(t),Sr.forEach(t),rc=d(n),kt=s(n,"H2",{class:!0});var Dm=a(kt);Pn=s(Dm,"A",{id:!0,class:!0,href:!0});var tM=a(Pn);_p=s(tM,"SPAN",{});var nM=a(_p);m(ja.$$.fragment,nM),nM.forEach(t),tM.forEach(t),kx=d(Dm),fp=s(Dm,"SPAN",{});var oM=a(fp);xx=i(oM,"Pushing to the Hub"),oM.forEach(t),Dm.forEach(t),ic=d(n),qe=s(n,"DIV",{class:!0});var Cr=a(qe);m(Ma.$$.fragment,Cr),wx=d(Cr),bp=s(Cr,"P",{});var sM=a(bp);Tx=i(sM,"A Mixin containing the functionality to push a model or tokenizer to the hub."),sM.forEach(t),$x=d(Cr),xe=s(Cr,"DIV",{class:!0});var Un=a(xe);m(Pa.$$.fragment,Un),jx=d(Un),Ea=s(Un,"P",{});var zm=a(Ea);Mx=i(zm,`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vp=s(zm,"CODE",{});var aM=a(vp);Px=i(aM,"repo_path_or_name"),aM.forEach(t),Ex=i(zm,"."),zm.forEach(t),Lx=d(Un),yp=s(Un,"P",{});var rM=a(yp);qx=i(rM,"Examples:"),rM.forEach(t),Fx=d(Un),m(La.$$.fragment,Un),Un.forEach(t),Cr.forEach(t),this.h()},h(){p(x,"name","hf:doc:metadata"),p(x,"content",JSON.stringify(fM)),p(j,"id","models"),p(j,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(j,"href","#models"),p(T,"class","relative group"),p(Aa,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(Ga,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel"),p(Sa,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Na,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(Ca,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel"),p(Ia,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin"),p(Ba,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.generation_utils.GenerationMixin"),p(Wa,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.generation_tf_utils.TFGenerationMixin"),p(Ua,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.generation_flax_utils.FlaxGenerationMixin"),p(Tt,"id","transformers.PreTrainedModel"),p(Tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Tt,"href","#transformers.PreTrainedModel"),p(ot,"class","relative group"),p(Va,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(Xa,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ra,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ya,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(le,"class","docstring"),p(D,"class","docstring"),p(Ft,"class","docstring"),p(Ot,"class","docstring"),p(Se,"class","docstring"),p(Ne,"class","docstring"),p(Dt,"class","docstring"),p(zt,"class","docstring"),p(At,"class","docstring"),p(Ce,"class","docstring"),p(Ie,"class","docstring"),p(St,"class","docstring"),p(Nt,"class","docstring"),p(Be,"class","docstring"),p(w,"class","docstring"),p(Ka,"id","from_pretrained-torch-dtype"),p(Ct,"id","model-instantiation-dtype"),p(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ct,"href","#model-instantiation-dtype"),p(rt,"class","relative group"),p(Bt,"id","transformers.modeling_utils.ModuleUtilsMixin"),p(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Bt,"href","#transformers.modeling_utils.ModuleUtilsMixin"),p(it,"class","relative group"),p(Ue,"class","docstring"),p(Wt,"class","docstring"),p(Eo,"href","https://arxiv.org/pdf/2001.08361.pdf"),p(Eo,"rel","nofollow"),p(Ut,"class","docstring"),p(Ht,"class","docstring"),p(Vt,"class","docstring"),p(Xt,"class","docstring"),p(Rt,"class","docstring"),p(Ja,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks"),p(Yt,"class","docstring"),p(L,"class","docstring"),p(Kt,"id","transformers.TFPreTrainedModel"),p(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Kt,"href","#transformers.TFPreTrainedModel"),p(ct,"class","relative group"),p(er,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel"),p(tr,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(nr,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(pe,"class","docstring"),p(Jt,"class","docstring"),p(S,"class","docstring"),p(en,"class","docstring"),p(tn,"class","docstring"),p(nn,"class","docstring"),p(on,"class","docstring"),p(sn,"class","docstring"),p(an,"class","docstring"),p(rn,"class","docstring"),p(ln,"class","docstring"),p(Ve,"class","docstring"),p(or,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained"),p(dn,"class","docstring"),p(pn,"class","docstring"),p(cn,"class","docstring"),p(mn,"class","docstring"),p(un,"class","docstring"),p(gn,"class","docstring"),p(hn,"class","docstring"),p(ce,"class","docstring"),p(y,"class","docstring"),p(_n,"id","transformers.modeling_tf_utils.TFModelUtilsMixin"),p(_n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(_n,"href","#transformers.modeling_tf_utils.TFModelUtilsMixin"),p(ht,"class","relative group"),p(fn,"class","docstring"),p(Pe,"class","docstring"),p(bn,"id","transformers.FlaxPreTrainedModel"),p(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(bn,"href","#transformers.FlaxPreTrainedModel"),p(_t,"class","relative group"),p(ar,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(rr,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(ir,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(me,"class","docstring"),p(W,"class","docstring"),p(Re,"class","docstring"),p(kn,"class","docstring"),p(Y,"class","docstring"),p(K,"class","docstring"),p(ue,"class","docstring"),p(M,"class","docstring"),p(xn,"id","transformers.generation_utils.GenerationMixin"),p(xn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(xn,"href","#transformers.generation_utils.GenerationMixin"),p(bt,"class","relative group"),p(lr,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(dr,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(wn,"class","docstring"),p(ge,"class","docstring"),p(he,"class","docstring"),p(Tn,"class","docstring"),p(_e,"class","docstring"),p(pr,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(Rs,"href","https://huggingface.co/blog/how-to-generate"),p(Rs,"rel","nofollow"),p(U,"class","docstring"),p(fe,"class","docstring"),p(be,"class","docstring"),p(cr,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p($n,"class","docstring"),p(ve,"class","docstring"),p(P,"class","docstring"),p(mr,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel"),p(ur,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.PreTrainedModel"),p(jn,"class","docstring"),p(pa,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),p(pa,"rel","nofollow"),p(gr,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(ma,"href","https://huggingface.co/blog/how-to-generate"),p(ma,"rel","nofollow"),p(N,"class","docstring"),p(ye,"class","docstring"),p(hr,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.TFPreTrainedModel"),p(Mn,"class","docstring"),p(ke,"class","docstring"),p(G,"class","docstring"),p(_r,"href","/docs/transformers/pr_15921/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(fr,"href","/docs/transformers/pr_15921/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ta,"href","https://huggingface.co/blog/how-to-generate"),p(Ta,"rel","nofollow"),p(H,"class","docstring"),p(Le,"class","docstring"),p(Pn,"id","transformers.file_utils.PushToHubMixin"),p(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Pn,"href","#transformers.file_utils.PushToHubMixin"),p(kt,"class","relative group"),p(xe,"class","docstring"),p(qe,"class","docstring")},m(n,b){e(document.head,x),v(n,E,b),v(n,T,b),e(T,j),e(j,te),u(A,te,null),e(T,I),e(T,Me),e(Me,Am),v(n,Op,b),v(n,ie,b),e(ie,Gm),e(ie,Aa),e(Aa,Sm),e(ie,Nm),e(ie,Ga),e(Ga,Cm),e(ie,Im),e(ie,Sa),e(Sa,Bm),e(ie,Wm),v(n,Dp,b),v(n,nt,b),e(nt,Na),e(Na,Um),e(nt,Hm),e(nt,Ca),e(Ca,Vm),e(nt,Xm),v(n,zp,b),v(n,wt,b),e(wt,Ir),e(Ir,Rm),e(wt,Ym),e(wt,Br),e(Br,Km),v(n,Ap,b),v(n,B,b),e(B,Zm),e(B,Ia),e(Ia,Jm),e(B,Qm),e(B,Wr),e(Wr,eu),e(B,tu),e(B,Ba),e(Ba,nu),e(B,ou),e(B,Wa),e(Wa,su),e(B,au),e(B,Ua),e(Ua,ru),e(B,iu),v(n,Gp,b),v(n,ot,b),e(ot,Tt),e(Tt,Ur),u(Hn,Ur,null),e(ot,lu),e(ot,Hr),e(Hr,du),v(n,Sp,b),v(n,w,b),u(Vn,w,null),e(w,pu),e(w,Vr),e(Vr,cu),e(w,mu),e(w,Ha),e(Ha,Va),e(Va,uu),e(Ha,gu),e(w,hu),e(w,Xn),e(Xn,Xr),e(Xr,_u),e(Xn,fu),e(Xn,Rr),e(Rr,bu),e(w,vu),e(w,Yr),e(Yr,yu),e(w,ku),e(w,ne),e(ne,Kr),e(Kr,Ae),e(Ae,Zr),e(Zr,xu),e(Ae,wu),e(Ae,Xa),e(Xa,Tu),e(Ae,$u),e(Ae,Ra),e(Ra,ju),e(Ae,Mu),e(ne,Pu),e(ne,Rn),e(Rn,Ge),e(Ge,Jr),e(Jr,Eu),e(Ge,Lu),e(Ge,Qr),e(Qr,qu),e(Ge,Fu),e(Ge,ei),e(ei,Ou),e(Ge,Du),e(Rn,zu),e(Rn,st),e(st,$t),e($t,ti),e(ti,Au),e($t,Gu),e($t,Ya),e(Ya,Su),e($t,Nu),e(st,Cu),e(st,jt),e(jt,ni),e(ni,Iu),e(jt,Bu),e(jt,oi),e(oi,Wu),e(jt,Uu),e(st,Hu),e(st,Mt),e(Mt,si),e(si,Vu),e(Mt,Xu),e(Mt,ai),e(ai,Ru),e(Mt,Yu),e(ne,Ku),e(ne,ri),e(ri,Pt),e(Pt,ii),e(ii,Zu),e(Pt,Ju),e(Pt,li),e(li,Qu),e(Pt,eg),e(ne,tg),e(ne,di),e(di,Et),e(Et,pi),e(pi,ng),e(Et,og),e(Et,ci),e(ci,sg),e(Et,ag),e(ne,rg),e(ne,mi),e(mi,V),e(V,ui),e(ui,ig),e(V,lg),e(V,gi),e(gi,dg),e(V,pg),e(V,hi),e(hi,cg),e(V,mg),e(V,_i),e(_i,ug),e(V,gg),e(V,fi),e(fi,hg),e(V,_g),e(w,fg),e(w,le),u(Yn,le,null),e(le,bg),e(le,Kn),e(Kn,vg),e(Kn,bi),e(bi,yg),e(Kn,kg),e(le,xg),e(le,vi),e(vi,wg),e(le,Tg),u(Zn,le,null),e(w,$g),e(w,D),u(Jn,D,null),e(D,jg),e(D,yi),e(yi,Mg),e(D,Pg),e(D,at),e(at,Eg),e(at,ki),e(ki,Lg),e(at,qg),e(at,xi),e(xi,Fg),e(at,Og),e(D,Dg),e(D,Qn),e(Qn,zg),e(Qn,wi),e(wi,Ag),e(Qn,Gg),e(D,Sg),e(D,eo),e(eo,Ng),e(eo,Ti),e(Ti,Cg),e(eo,Ig),e(D,Bg),u(Lt,D,null),e(D,Wg),u(qt,D,null),e(D,Ug),e(D,$i),e($i,Hg),e(D,Vg),u(to,D,null),e(w,Xg),e(w,Ft),u(no,Ft,null),e(Ft,Rg),e(Ft,ji),e(ji,Yg),e(w,Kg),e(w,Ot),u(oo,Ot,null),e(Ot,Zg),e(Ot,Mi),e(Mi,Jg),e(w,Qg),e(w,Se),u(so,Se,null),e(Se,eh),e(Se,Pi),e(Pi,th),e(Se,nh),e(Se,Ei),e(Ei,oh),e(w,sh),e(w,Ne),u(ao,Ne,null),e(Ne,ah),e(Ne,Li),e(Li,rh),e(Ne,ih),e(Ne,qi),e(qi,lh),e(w,dh),e(w,Dt),u(ro,Dt,null),e(Dt,ph),e(Dt,Fi),e(Fi,ch),e(w,mh),e(w,zt),u(io,zt,null),e(zt,uh),e(zt,Oi),e(Oi,gh),e(w,hh),e(w,At),u(lo,At,null),e(At,_h),e(At,Di),e(Di,fh),e(w,bh),e(w,Ce),u(po,Ce,null),e(Ce,vh),e(Ce,zi),e(zi,yh),e(Ce,kh),u(Gt,Ce,null),e(w,xh),e(w,Ie),u(co,Ie,null),e(Ie,wh),e(Ie,mo),e(mo,Th),e(mo,Ai),e(Ai,$h),e(mo,jh),e(Ie,Mh),e(Ie,uo),e(uo,Ph),e(uo,Gi),e(Gi,Eh),e(uo,Lh),e(w,qh),e(w,St),u(go,St,null),e(St,Fh),e(St,ho),e(ho,Oh),e(ho,Si),e(Si,Dh),e(ho,zh),e(w,Ah),e(w,Nt),u(_o,Nt,null),e(Nt,Gh),e(Nt,Ni),e(Ni,Sh),e(w,Nh),e(w,Be),u(fo,Be,null),e(Be,Ch),e(Be,Ci),e(Ci,Ih),e(Be,Bh),e(Be,bo),e(bo,Wh),e(bo,Ii),e(Ii,Uh),e(bo,Hh),v(n,Np,b),v(n,Ka,b),v(n,Cp,b),v(n,rt,b),e(rt,Ct),e(Ct,Bi),u(vo,Bi,null),e(rt,Vh),e(rt,Wi),e(Wi,Xh),v(n,Ip,b),v(n,de,b),e(de,Rh),e(de,Ui),e(Ui,Yh),e(de,Kh),e(de,Hi),e(Hi,Zh),e(de,Jh),e(de,Vi),e(Vi,Qh),e(de,e_),v(n,Bp,b),u(yo,n,b),v(n,Wp,b),v(n,We,b),e(We,t_),e(We,Xi),e(Xi,n_),e(We,o_),e(We,Ri),e(Ri,s_),e(We,a_),v(n,Up,b),u(ko,n,b),v(n,Hp,b),v(n,It,b),e(It,r_),e(It,Yi),e(Yi,i_),e(It,l_),v(n,Vp,b),u(xo,n,b),v(n,Xp,b),v(n,Za,b),e(Za,d_),v(n,Rp,b),v(n,it,b),e(it,Bt),e(Bt,Ki),u(wo,Ki,null),e(it,p_),e(it,Zi),e(Zi,c_),v(n,Yp,b),v(n,L,b),u(To,L,null),e(L,m_),e(L,$o),e($o,u_),e($o,Ji),e(Ji,g_),e($o,h_),e(L,__),e(L,Ue),u(jo,Ue,null),e(Ue,f_),e(Ue,Qi),e(Qi,b_),e(Ue,v_),e(Ue,lt),e(lt,y_),e(lt,el),e(el,k_),e(lt,x_),e(lt,tl),e(tl,w_),e(lt,T_),e(L,$_),e(L,Wt),u(Mo,Wt,null),e(Wt,j_),e(Wt,nl),e(nl,M_),e(L,P_),e(L,Ut),u(Po,Ut,null),e(Ut,E_),e(Ut,dt),e(dt,L_),e(dt,ol),e(ol,q_),e(dt,F_),e(dt,Eo),e(Eo,O_),e(dt,D_),e(L,z_),e(L,Ht),u(Lo,Ht,null),e(Ht,A_),e(Ht,sl),e(sl,G_),e(L,S_),e(L,Vt),u(qo,Vt,null),e(Vt,N_),e(Vt,al),e(al,C_),e(L,I_),e(L,Xt),u(Fo,Xt,null),e(Xt,B_),e(Xt,rl),e(rl,W_),e(L,U_),e(L,Rt),u(Oo,Rt,null),e(Rt,H_),e(Rt,il),e(il,V_),e(L,X_),e(L,Yt),u(Do,Yt,null),e(Yt,R_),e(Yt,pt),e(pt,Y_),e(pt,ll),e(ll,K_),e(pt,Z_),e(pt,Ja),e(Ja,J_),e(pt,Q_),v(n,Kp,b),v(n,ct,b),e(ct,Kt),e(Kt,dl),u(zo,dl,null),e(ct,ef),e(ct,pl),e(pl,tf),v(n,Zp,b),v(n,y,b),u(Ao,y,null),e(y,nf),e(y,cl),e(cl,of),e(y,sf),e(y,Qa),e(Qa,er),e(er,af),e(Qa,rf),e(y,lf),e(y,Go),e(Go,ml),e(ml,df),e(Go,pf),e(Go,ul),e(ul,cf),e(y,mf),e(y,gl),e(gl,uf),e(y,gf),e(y,mt),e(mt,He),e(He,hl),e(hl,hf),e(He,_f),e(He,tr),e(tr,ff),e(He,bf),e(He,nr),e(nr,vf),e(He,yf),e(mt,kf),e(mt,Zt),e(Zt,_l),e(_l,xf),e(Zt,wf),e(Zt,fl),e(fl,Tf),e(Zt,$f),e(mt,jf),e(mt,X),e(X,bl),e(bl,Mf),e(X,Pf),e(X,vl),e(vl,Ef),e(X,Lf),e(X,yl),e(yl,qf),e(X,Ff),e(X,kl),e(kl,Of),e(X,Df),e(X,xl),e(xl,zf),e(X,Af),e(y,Gf),e(y,pe),u(So,pe,null),e(pe,Sf),e(pe,No),e(No,Nf),e(No,wl),e(wl,Cf),e(No,If),e(pe,Bf),e(pe,Tl),e(Tl,Wf),e(pe,Uf),u(Co,pe,null),e(y,Hf),e(y,Jt),u(Io,Jt,null),e(Jt,Vf),e(Jt,$l),e($l,Xf),e(y,Rf),e(y,S),u(Bo,S,null),e(S,Yf),e(S,jl),e(jl,Kf),e(S,Zf),e(S,Wo),e(Wo,Jf),e(Wo,Ml),e(Ml,Qf),e(Wo,eb),e(S,tb),e(S,Uo),e(Uo,nb),e(Uo,Pl),e(Pl,ob),e(Uo,sb),e(S,ab),u(Qt,S,null),e(S,rb),e(S,El),e(El,ib),e(S,lb),u(Ho,S,null),e(y,db),e(y,en),u(Vo,en,null),e(en,pb),e(en,Ll),e(Ll,cb),e(y,mb),e(y,tn),u(Xo,tn,null),e(tn,ub),e(tn,ql),e(ql,gb),e(y,hb),e(y,nn),u(Ro,nn,null),e(nn,_b),e(nn,Fl),e(Fl,fb),e(y,bb),e(y,on),u(Yo,on,null),e(on,vb),e(on,Ol),e(Ol,yb),e(y,kb),e(y,sn),u(Ko,sn,null),e(sn,xb),e(sn,Dl),e(Dl,wb),e(y,Tb),e(y,an),u(Zo,an,null),e(an,$b),e(an,zl),e(zl,jb),e(y,Mb),e(y,rn),u(Jo,rn,null),e(rn,Pb),e(rn,Al),e(Al,Eb),e(y,Lb),e(y,ln),u(Qo,ln,null),e(ln,qb),e(ln,Gl),e(Gl,Fb),e(y,Ob),e(y,Ve),u(es,Ve,null),e(Ve,Db),e(Ve,ts),e(ts,zb),e(ts,Sl),e(Sl,Ab),e(ts,Gb),e(Ve,Sb),e(Ve,ns),e(ns,Nb),e(ns,Nl),e(Nl,Cb),e(ns,Ib),e(y,Bb),e(y,dn),u(os,dn,null),e(dn,Wb),e(dn,ss),e(ss,Ub),e(ss,or),e(or,Hb),e(ss,Vb),e(y,Xb),e(y,pn),u(as,pn,null),e(pn,Rb),e(pn,Cl),e(Cl,Yb),e(y,Kb),e(y,cn),u(rs,cn,null),e(cn,Zb),e(cn,Il),e(Il,Jb),e(y,Qb),e(y,mn),u(is,mn,null),e(mn,ev),e(mn,Bl),e(Bl,tv),e(y,nv),e(y,un),u(ls,un,null),e(un,ov),e(un,Wl),e(Wl,sv),e(y,av),e(y,gn),u(ds,gn,null),e(gn,rv),e(gn,Ul),e(Ul,iv),e(y,lv),e(y,hn),u(ps,hn,null),e(hn,dv),e(hn,Hl),e(Hl,pv),e(y,cv),e(y,ce),u(cs,ce,null),e(ce,mv),e(ce,oe),e(oe,uv),e(oe,Vl),e(Vl,gv),e(oe,hv),e(oe,Xl),e(Xl,_v),e(oe,fv),e(oe,Rl),e(Rl,bv),e(oe,vv),e(oe,Yl),e(Yl,yv),e(oe,kv),e(ce,xv),e(ce,ut),e(ut,wv),e(ut,Kl),e(Kl,Tv),e(ut,$v),e(ut,Zl),e(Zl,jv),e(ut,Mv),e(ce,Pv),e(ce,gt),e(gt,Ev),e(gt,Jl),e(Jl,Lv),e(gt,qv),e(gt,Ql),e(Ql,Fv),e(gt,Ov),v(n,Jp,b),v(n,ht,b),e(ht,_n),e(_n,ed),u(ms,ed,null),e(ht,Dv),e(ht,td),e(td,zv),v(n,Qp,b),v(n,Pe,b),u(us,Pe,null),e(Pe,Av),e(Pe,gs),e(gs,Gv),e(gs,nd),e(nd,Sv),e(gs,Nv),e(Pe,Cv),e(Pe,fn),u(hs,fn,null),e(fn,Iv),e(fn,od),e(od,Bv),v(n,ec,b),v(n,_t,b),e(_t,bn),e(bn,sd),u(_s,sd,null),e(_t,Wv),e(_t,ad),e(ad,Uv),v(n,tc,b),v(n,M,b),u(fs,M,null),e(M,Hv),e(M,rd),e(rd,Vv),e(M,Xv),e(M,sr),e(sr,ar),e(ar,Rv),e(sr,Yv),e(M,Kv),e(M,id),e(id,Zv),e(M,Jv),e(M,ft),e(ft,Xe),e(Xe,ld),e(ld,Qv),e(Xe,e1),e(Xe,rr),e(rr,t1),e(Xe,n1),e(Xe,ir),e(ir,o1),e(Xe,s1),e(ft,a1),e(ft,vn),e(vn,dd),e(dd,r1),e(vn,i1),e(vn,pd),e(pd,l1),e(vn,d1),e(ft,p1),e(ft,R),e(R,cd),e(cd,c1),e(R,m1),e(R,md),e(md,u1),e(R,g1),e(R,ud),e(ud,h1),e(R,_1),e(R,gd),e(gd,f1),e(R,b1),e(R,hd),e(hd,v1),e(R,y1),e(M,k1),e(M,me),u(bs,me,null),e(me,x1),e(me,vs),e(vs,w1),e(vs,_d),e(_d,T1),e(vs,$1),e(me,j1),e(me,fd),e(fd,M1),e(me,P1),u(ys,me,null),e(M,E1),e(M,W),u(ks,W,null),e(W,L1),e(W,bd),e(bd,q1),e(W,F1),e(W,xs),e(xs,O1),e(xs,vd),e(vd,D1),e(xs,z1),e(W,A1),e(W,ws),e(ws,G1),e(ws,yd),e(yd,S1),e(ws,N1),e(W,C1),e(W,kd),e(kd,I1),e(W,B1),u(Ts,W,null),e(M,W1),e(M,Re),u($s,Re,null),e(Re,U1),e(Re,xd),e(xd,H1),e(Re,V1),u(yn,Re,null),e(M,X1),e(M,kn),u(js,kn,null),e(kn,R1),e(kn,Ms),e(Ms,Y1),e(Ms,wd),e(wd,K1),e(Ms,Z1),e(M,J1),e(M,Y),u(Ps,Y,null),e(Y,Q1),e(Y,se),e(se,ey),e(se,Td),e(Td,ty),e(se,ny),e(se,$d),e($d,oy),e(se,sy),e(se,jd),e(jd,ay),e(se,ry),e(se,Md),e(Md,iy),e(se,ly),e(Y,dy),e(Y,Pd),e(Pd,py),e(Y,cy),e(Y,Ed),e(Ed,my),e(Y,uy),u(Es,Y,null),e(M,gy),e(M,K),u(Ls,K,null),e(K,hy),e(K,ae),e(ae,_y),e(ae,Ld),e(Ld,fy),e(ae,by),e(ae,qd),e(qd,vy),e(ae,yy),e(ae,Fd),e(Fd,ky),e(ae,xy),e(ae,Od),e(Od,wy),e(ae,Ty),e(K,$y),e(K,Dd),e(Dd,jy),e(K,My),e(K,zd),e(zd,Py),e(K,Ey),u(qs,K,null),e(M,Ly),e(M,ue),u(Fs,ue,null),e(ue,qy),e(ue,re),e(re,Fy),e(re,Ad),e(Ad,Oy),e(re,Dy),e(re,Gd),e(Gd,zy),e(re,Ay),e(re,Sd),e(Sd,Gy),e(re,Sy),e(re,Nd),e(Nd,Ny),e(re,Cy),e(ue,Iy),e(ue,Cd),e(Cd,By),e(ue,Wy),u(Os,ue,null),v(n,nc,b),v(n,bt,b),e(bt,xn),e(xn,Id),u(Ds,Id,null),e(bt,Uy),e(bt,Bd),e(Bd,Hy),v(n,oc,b),v(n,P,b),u(zs,P,null),e(P,Vy),e(P,As),e(As,Xy),e(As,lr),e(lr,Ry),e(As,Yy),e(P,Ky),e(P,wn),u(Gs,wn,null),e(wn,Zy),e(wn,Ss),e(Ss,Jy),e(Ss,dr),e(dr,Qy),e(Ss,e2),e(P,t2),e(P,ge),u(Ns,ge,null),e(ge,n2),e(ge,Wd),e(Wd,o2),e(ge,s2),e(ge,Ud),e(Ud,a2),e(ge,r2),u(Cs,ge,null),e(P,i2),e(P,he),u(Is,he,null),e(he,l2),e(he,Hd),e(Hd,d2),e(he,p2),e(he,Vd),e(Vd,c2),e(he,m2),u(Bs,he,null),e(P,u2),e(P,Tn),u(Ws,Tn,null),e(Tn,g2),e(Tn,Xd),e(Xd,h2),e(P,_2),e(P,_e),u(Us,_e,null),e(_e,f2),e(_e,Rd),e(Rd,b2),e(_e,v2),e(_e,Yd),e(Yd,y2),e(_e,k2),u(Hs,_e,null),e(P,x2),e(P,U),u(Vs,U,null),e(U,w2),e(U,Kd),e(Kd,T2),e(U,$2),e(U,vt),e(vt,j2),e(vt,Zd),e(Zd,M2),e(vt,P2),e(vt,pr),e(pr,E2),e(vt,L2),e(U,q2),e(U,Xs),e(Xs,F2),e(Xs,Rs),e(Rs,O2),e(Xs,D2),e(U,z2),e(U,Jd),e(Jd,A2),e(U,G2),u(Ys,U,null),e(P,S2),e(P,fe),u(Ks,fe,null),e(fe,N2),e(fe,Qd),e(Qd,C2),e(fe,I2),e(fe,ep),e(ep,B2),e(fe,W2),u(Zs,fe,null),e(P,U2),e(P,be),u(Js,be,null),e(be,H2),e(be,tp),e(tp,V2),e(be,X2),e(be,np),e(np,R2),e(be,Y2),u(Qs,be,null),e(P,K2),e(P,$n),u(ea,$n,null),e($n,Z2),e($n,ta),e(ta,J2),e(ta,cr),e(cr,Q2),e(ta,ek),e(P,tk),e(P,ve),u(na,ve,null),e(ve,nk),e(ve,op),e(op,ok),e(ve,sk),e(ve,sp),e(sp,ak),e(ve,rk),u(oa,ve,null),v(n,sc,b),v(n,G,b),u(sa,G,null),e(G,ik),e(G,aa),e(aa,lk),e(aa,mr),e(mr,dk),e(aa,pk),e(G,ck),e(G,jn),u(ra,jn,null),e(jn,mk),e(jn,ia),e(ia,uk),e(ia,ur),e(ur,gk),e(ia,hk),e(G,_k),e(G,N),u(la,N,null),e(N,fk),e(N,ap),e(ap,bk),e(N,vk),e(N,da),e(da,yk),e(da,pa),e(pa,kk),e(da,xk),e(N,wk),e(N,Ee),e(Ee,Tk),e(Ee,rp),e(rp,$k),e(Ee,jk),e(Ee,ip),e(ip,Mk),e(Ee,Pk),e(Ee,gr),e(gr,Ek),e(Ee,Lk),e(N,qk),e(N,ca),e(ca,Fk),e(ca,ma),e(ma,Ok),e(ca,Dk),e(N,zk),e(N,lp),e(lp,Ak),e(N,Gk),u(ua,N,null),e(G,Sk),e(G,ye),u(ga,ye,null),e(ye,Nk),e(ye,dp),e(dp,Ck),e(ye,Ik),e(ye,pp),e(pp,Bk),e(ye,Wk),u(ha,ye,null),e(G,Uk),e(G,Mn),u(_a,Mn,null),e(Mn,Hk),e(Mn,fa),e(fa,Vk),e(fa,hr),e(hr,Xk),e(fa,Rk),e(G,Yk),e(G,ke),u(ba,ke,null),e(ke,Kk),e(ke,cp),e(cp,Zk),e(ke,Jk),e(ke,mp),e(mp,Qk),e(ke,ex),u(va,ke,null),v(n,ac,b),v(n,Le,b),u(ya,Le,null),e(Le,tx),e(Le,ka),e(ka,nx),e(ka,_r),e(_r,ox),e(ka,sx),e(Le,ax),e(Le,H),u(xa,H,null),e(H,rx),e(H,up),e(up,ix),e(H,lx),e(H,yt),e(yt,dx),e(yt,gp),e(gp,px),e(yt,cx),e(yt,fr),e(fr,mx),e(yt,ux),e(H,gx),e(H,wa),e(wa,hx),e(wa,Ta),e(Ta,_x),e(wa,fx),e(H,bx),e(H,hp),e(hp,vx),e(H,yx),u($a,H,null),v(n,rc,b),v(n,kt,b),e(kt,Pn),e(Pn,_p),u(ja,_p,null),e(kt,kx),e(kt,fp),e(fp,xx),v(n,ic,b),v(n,qe,b),u(Ma,qe,null),e(qe,wx),e(qe,bp),e(bp,Tx),e(qe,$x),e(qe,xe),u(Pa,xe,null),e(xe,jx),e(xe,Ea),e(Ea,Mx),e(Ea,vp),e(vp,Px),e(Ea,Ex),e(xe,Lx),e(xe,yp),e(yp,qx),e(xe,Fx),u(La,xe,null),lc=!0},p(n,[b]){const qa={};b&2&&(qa.$$scope={dirty:b,ctx:n}),Lt.$set(qa);const kp={};b&2&&(kp.$$scope={dirty:b,ctx:n}),qt.$set(kp);const xp={};b&2&&(xp.$$scope={dirty:b,ctx:n}),Gt.$set(xp);const wp={};b&2&&(wp.$$scope={dirty:b,ctx:n}),Qt.$set(wp);const Fe={};b&2&&(Fe.$$scope={dirty:b,ctx:n}),yn.$set(Fe)},i(n){lc||(g(A.$$.fragment,n),g(Hn.$$.fragment,n),g(Vn.$$.fragment,n),g(Yn.$$.fragment,n),g(Zn.$$.fragment,n),g(Jn.$$.fragment,n),g(Lt.$$.fragment,n),g(qt.$$.fragment,n),g(to.$$.fragment,n),g(no.$$.fragment,n),g(oo.$$.fragment,n),g(so.$$.fragment,n),g(ao.$$.fragment,n),g(ro.$$.fragment,n),g(io.$$.fragment,n),g(lo.$$.fragment,n),g(po.$$.fragment,n),g(Gt.$$.fragment,n),g(co.$$.fragment,n),g(go.$$.fragment,n),g(_o.$$.fragment,n),g(fo.$$.fragment,n),g(vo.$$.fragment,n),g(yo.$$.fragment,n),g(ko.$$.fragment,n),g(xo.$$.fragment,n),g(wo.$$.fragment,n),g(To.$$.fragment,n),g(jo.$$.fragment,n),g(Mo.$$.fragment,n),g(Po.$$.fragment,n),g(Lo.$$.fragment,n),g(qo.$$.fragment,n),g(Fo.$$.fragment,n),g(Oo.$$.fragment,n),g(Do.$$.fragment,n),g(zo.$$.fragment,n),g(Ao.$$.fragment,n),g(So.$$.fragment,n),g(Co.$$.fragment,n),g(Io.$$.fragment,n),g(Bo.$$.fragment,n),g(Qt.$$.fragment,n),g(Ho.$$.fragment,n),g(Vo.$$.fragment,n),g(Xo.$$.fragment,n),g(Ro.$$.fragment,n),g(Yo.$$.fragment,n),g(Ko.$$.fragment,n),g(Zo.$$.fragment,n),g(Jo.$$.fragment,n),g(Qo.$$.fragment,n),g(es.$$.fragment,n),g(os.$$.fragment,n),g(as.$$.fragment,n),g(rs.$$.fragment,n),g(is.$$.fragment,n),g(ls.$$.fragment,n),g(ds.$$.fragment,n),g(ps.$$.fragment,n),g(cs.$$.fragment,n),g(ms.$$.fragment,n),g(us.$$.fragment,n),g(hs.$$.fragment,n),g(_s.$$.fragment,n),g(fs.$$.fragment,n),g(bs.$$.fragment,n),g(ys.$$.fragment,n),g(ks.$$.fragment,n),g(Ts.$$.fragment,n),g($s.$$.fragment,n),g(yn.$$.fragment,n),g(js.$$.fragment,n),g(Ps.$$.fragment,n),g(Es.$$.fragment,n),g(Ls.$$.fragment,n),g(qs.$$.fragment,n),g(Fs.$$.fragment,n),g(Os.$$.fragment,n),g(Ds.$$.fragment,n),g(zs.$$.fragment,n),g(Gs.$$.fragment,n),g(Ns.$$.fragment,n),g(Cs.$$.fragment,n),g(Is.$$.fragment,n),g(Bs.$$.fragment,n),g(Ws.$$.fragment,n),g(Us.$$.fragment,n),g(Hs.$$.fragment,n),g(Vs.$$.fragment,n),g(Ys.$$.fragment,n),g(Ks.$$.fragment,n),g(Zs.$$.fragment,n),g(Js.$$.fragment,n),g(Qs.$$.fragment,n),g(ea.$$.fragment,n),g(na.$$.fragment,n),g(oa.$$.fragment,n),g(sa.$$.fragment,n),g(ra.$$.fragment,n),g(la.$$.fragment,n),g(ua.$$.fragment,n),g(ga.$$.fragment,n),g(ha.$$.fragment,n),g(_a.$$.fragment,n),g(ba.$$.fragment,n),g(va.$$.fragment,n),g(ya.$$.fragment,n),g(xa.$$.fragment,n),g($a.$$.fragment,n),g(ja.$$.fragment,n),g(Ma.$$.fragment,n),g(Pa.$$.fragment,n),g(La.$$.fragment,n),lc=!0)},o(n){h(A.$$.fragment,n),h(Hn.$$.fragment,n),h(Vn.$$.fragment,n),h(Yn.$$.fragment,n),h(Zn.$$.fragment,n),h(Jn.$$.fragment,n),h(Lt.$$.fragment,n),h(qt.$$.fragment,n),h(to.$$.fragment,n),h(no.$$.fragment,n),h(oo.$$.fragment,n),h(so.$$.fragment,n),h(ao.$$.fragment,n),h(ro.$$.fragment,n),h(io.$$.fragment,n),h(lo.$$.fragment,n),h(po.$$.fragment,n),h(Gt.$$.fragment,n),h(co.$$.fragment,n),h(go.$$.fragment,n),h(_o.$$.fragment,n),h(fo.$$.fragment,n),h(vo.$$.fragment,n),h(yo.$$.fragment,n),h(ko.$$.fragment,n),h(xo.$$.fragment,n),h(wo.$$.fragment,n),h(To.$$.fragment,n),h(jo.$$.fragment,n),h(Mo.$$.fragment,n),h(Po.$$.fragment,n),h(Lo.$$.fragment,n),h(qo.$$.fragment,n),h(Fo.$$.fragment,n),h(Oo.$$.fragment,n),h(Do.$$.fragment,n),h(zo.$$.fragment,n),h(Ao.$$.fragment,n),h(So.$$.fragment,n),h(Co.$$.fragment,n),h(Io.$$.fragment,n),h(Bo.$$.fragment,n),h(Qt.$$.fragment,n),h(Ho.$$.fragment,n),h(Vo.$$.fragment,n),h(Xo.$$.fragment,n),h(Ro.$$.fragment,n),h(Yo.$$.fragment,n),h(Ko.$$.fragment,n),h(Zo.$$.fragment,n),h(Jo.$$.fragment,n),h(Qo.$$.fragment,n),h(es.$$.fragment,n),h(os.$$.fragment,n),h(as.$$.fragment,n),h(rs.$$.fragment,n),h(is.$$.fragment,n),h(ls.$$.fragment,n),h(ds.$$.fragment,n),h(ps.$$.fragment,n),h(cs.$$.fragment,n),h(ms.$$.fragment,n),h(us.$$.fragment,n),h(hs.$$.fragment,n),h(_s.$$.fragment,n),h(fs.$$.fragment,n),h(bs.$$.fragment,n),h(ys.$$.fragment,n),h(ks.$$.fragment,n),h(Ts.$$.fragment,n),h($s.$$.fragment,n),h(yn.$$.fragment,n),h(js.$$.fragment,n),h(Ps.$$.fragment,n),h(Es.$$.fragment,n),h(Ls.$$.fragment,n),h(qs.$$.fragment,n),h(Fs.$$.fragment,n),h(Os.$$.fragment,n),h(Ds.$$.fragment,n),h(zs.$$.fragment,n),h(Gs.$$.fragment,n),h(Ns.$$.fragment,n),h(Cs.$$.fragment,n),h(Is.$$.fragment,n),h(Bs.$$.fragment,n),h(Ws.$$.fragment,n),h(Us.$$.fragment,n),h(Hs.$$.fragment,n),h(Vs.$$.fragment,n),h(Ys.$$.fragment,n),h(Ks.$$.fragment,n),h(Zs.$$.fragment,n),h(Js.$$.fragment,n),h(Qs.$$.fragment,n),h(ea.$$.fragment,n),h(na.$$.fragment,n),h(oa.$$.fragment,n),h(sa.$$.fragment,n),h(ra.$$.fragment,n),h(la.$$.fragment,n),h(ua.$$.fragment,n),h(ga.$$.fragment,n),h(ha.$$.fragment,n),h(_a.$$.fragment,n),h(ba.$$.fragment,n),h(va.$$.fragment,n),h(ya.$$.fragment,n),h(xa.$$.fragment,n),h($a.$$.fragment,n),h(ja.$$.fragment,n),h(Ma.$$.fragment,n),h(Pa.$$.fragment,n),h(La.$$.fragment,n),lc=!1},d(n){t(x),n&&t(E),n&&t(T),_(A),n&&t(Op),n&&t(ie),n&&t(Dp),n&&t(nt),n&&t(zp),n&&t(wt),n&&t(Ap),n&&t(B),n&&t(Gp),n&&t(ot),_(Hn),n&&t(Sp),n&&t(w),_(Vn),_(Yn),_(Zn),_(Jn),_(Lt),_(qt),_(to),_(no),_(oo),_(so),_(ao),_(ro),_(io),_(lo),_(po),_(Gt),_(co),_(go),_(_o),_(fo),n&&t(Np),n&&t(Ka),n&&t(Cp),n&&t(rt),_(vo),n&&t(Ip),n&&t(de),n&&t(Bp),_(yo,n),n&&t(Wp),n&&t(We),n&&t(Up),_(ko,n),n&&t(Hp),n&&t(It),n&&t(Vp),_(xo,n),n&&t(Xp),n&&t(Za),n&&t(Rp),n&&t(it),_(wo),n&&t(Yp),n&&t(L),_(To),_(jo),_(Mo),_(Po),_(Lo),_(qo),_(Fo),_(Oo),_(Do),n&&t(Kp),n&&t(ct),_(zo),n&&t(Zp),n&&t(y),_(Ao),_(So),_(Co),_(Io),_(Bo),_(Qt),_(Ho),_(Vo),_(Xo),_(Ro),_(Yo),_(Ko),_(Zo),_(Jo),_(Qo),_(es),_(os),_(as),_(rs),_(is),_(ls),_(ds),_(ps),_(cs),n&&t(Jp),n&&t(ht),_(ms),n&&t(Qp),n&&t(Pe),_(us),_(hs),n&&t(ec),n&&t(_t),_(_s),n&&t(tc),n&&t(M),_(fs),_(bs),_(ys),_(ks),_(Ts),_($s),_(yn),_(js),_(Ps),_(Es),_(Ls),_(qs),_(Fs),_(Os),n&&t(nc),n&&t(bt),_(Ds),n&&t(oc),n&&t(P),_(zs),_(Gs),_(Ns),_(Cs),_(Is),_(Bs),_(Ws),_(Us),_(Hs),_(Vs),_(Ys),_(Ks),_(Zs),_(Js),_(Qs),_(ea),_(na),_(oa),n&&t(sc),n&&t(G),_(sa),_(ra),_(la),_(ua),_(ga),_(ha),_(_a),_(ba),_(va),n&&t(ac),n&&t(Le),_(ya),_(xa),_($a),n&&t(rc),n&&t(kt),_(ja),n&&t(ic),n&&t(qe),_(Ma),_(Pa),_(La)}}}const fM={local:"models",sections:[{local:"transformers.PreTrainedModel",sections:[{local:"model-instantiation-dtype",title:"Model Instantiation dtype"}],title:"PreTrainedModel"},{local:"transformers.modeling_utils.ModuleUtilsMixin",title:"ModuleUtilsMixin"},{local:"transformers.TFPreTrainedModel",title:"TFPreTrainedModel"},{local:"transformers.modeling_tf_utils.TFModelUtilsMixin",title:"TFModelUtilsMixin"},{local:"transformers.FlaxPreTrainedModel",title:"FlaxPreTrainedModel"},{local:"transformers.generation_utils.GenerationMixin",title:"Generation"},{local:"transformers.file_utils.PushToHubMixin",title:"Pushing to the Hub"}],title:"Models"};function bM(ee,x,E){let{fw:T}=x;return ee.$$set=j=>{"fw"in j&&E(0,T=j.fw)},[T]}class $M extends iM{constructor(x){super();lM(this,x,bM,_M,dM,{fw:0})}}export{$M as default,fM as metadata};
