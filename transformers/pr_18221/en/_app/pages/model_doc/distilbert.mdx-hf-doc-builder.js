...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18221/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),jk=p(),gc=o("p"),Ck=a("Finally, this model supports inherent JAX features such as:"),qk=p(),jt=o("ul"),_c=o("li"),Ka=o("a"),Pk=a("Just-In-Time (JIT) compilation"),Ak=p(),bc=o("li"),Va=o("a"),Ok=a("Automatic Differentiation"),Nk=p(),vc=o("li"),Ja=o("a"),Lk=a("Vectorization"),Sk=p(),kc=o("li"),Ga=o("a"),Ik=a("Parallelization"),Wk=p(),vt=o("div"),T(Xa.$$.fragment),Qk=p(),Os=o("p"),Rk=a("The "),Tc=o("code"),Uk=a("FlaxDistilBertPreTrainedModel"),Hk=a(" forward method, overrides the "),$c=o("code"),Kk=a("__call__"),Vk=a(" special method."),Jk=p(),T(rn.$$.fragment),Gk=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),Xk=p(),yc=o("span"),Yk=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=o("div"),T(Za.$$.fragment),Zk=p(),Fc=o("p"),e2=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),t2=p(),ei=o("p"),s2=a("This model inherits from "),cl=o("a"),o2=a("FlaxPreTrainedModel"),n2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),r2=p(),ti=o("p"),a2=a("This model is also a Flax Linen "),si=o("a"),i2=a("flax.linen.Module"),l2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),d2=p(),Dc=o("p"),c2=a("Finally, this model supports inherent JAX features such as:"),p2=p(),Ct=o("ul"),xc=o("li"),oi=o("a"),h2=a("Just-In-Time (JIT) compilation"),u2=p(),Bc=o("li"),ni=o("a"),f2=a("Automatic Differentiation"),m2=p(),Mc=o("li"),ri=o("a"),g2=a("Vectorization"),_2=p(),Ec=o("li"),ai=o("a"),b2=a("Parallelization"),v2=p(),kt=o("div"),T(ii.$$.fragment),k2=p(),Ls=o("p"),T2=a("The "),zc=o("code"),$2=a("FlaxDistilBertPreTrainedModel"),w2=a(" forward method, overrides the "),jc=o("code"),y2=a("__call__"),F2=a(" special method."),D2=p(),T(dn.$$.fragment),x2=p(),T(cn.$$.fragment),mh=p(),Ss=o("h2"),pn=o("a"),Cc=o("span"),T(li.$$.fragment),B2=p(),qc=o("span"),M2=a("FlaxDistilBertForQuestionAnswering"),gh=p(),qe=o("div"),T(di.$$.fragment),E2=p(),Is=o("p"),z2=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Pc=o("code"),j2=a("span start logits"),C2=a(" and "),Ac=o("code"),q2=a("span end logits"),P2=a(")."),A2=p(),ci=o("p"),O2=a("This model inherits from "),pl=o("a"),N2=a("FlaxPreTrainedModel"),L2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),S2=p(),pi=o("p"),I2=a("This model is also a Flax Linen "),hi=o("a"),W2=a("flax.linen.Module"),Q2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),R2=p(),Oc=o("p"),U2=a("Finally, this model supports inherent JAX features such as:"),H2=p(),qt=o("ul"),Nc=o("li"),ui=o("a"),K2=a("Just-In-Time (JIT) compilation"),V2=p(),Lc=o("li"),fi=o("a"),J2=a("Automatic Differentiation"),G2=p(),Sc=o("li"),mi=o("a"),X2=a("Vectorization"),Y2=p(),Ic=o("li"),gi=o("a"),Z2=a("Parallelization"),eT=p(),Tt=o("div"),T(_i.$$.fragment),tT=p(),Ws=o("p"),sT=a("The "),Wc=o("code"),oT=a("FlaxDistilBertPreTrainedModel"),nT=a(" forward method, overrides the "),Qc=o("code"),rT=a("__call__"),aT=a(" special method."),iT=p(),T(hn.$$.fragment),lT=p(),T(un.$$.fragment),this.h()},l(s){const v=sF('[data-svelte="svelte-1phssyn"]',document.head);d=n(v,"META",{name:!0,content:!0}),v.forEach(t),g=h(s),c=n(s,"H1",{class:!0});var bi=r(c);u=n(bi,"A",{id:!0,class:!0,href:!0});var Rc=r(u);_=n(Rc,"SPAN",{});var Uc=r(_);$(l.$$.fragment,Uc),Uc.forEach(t),Rc.forEach(t),f=h(bi),B=n(bi,"SPAN",{});var Hc=r(B);he=i(Hc,"DistilBERT"),Hc.forEach(t),bi.forEach(t),K=h(s),E=n(s,"H2",{class:!0});var vi=r(E);G=n(vi,"A",{id:!0,class:!0,href:!0});var Kc=r(G);S=n(Kc,"SPAN",{});var Vc=r(S);$(X.$$.fragment,Vc),Vc.forEach(t),Kc.forEach(t),ue=h(vi),I=n(vi,"SPAN",{});var Jc=r(I);fe=i(Jc,"Overview"),Jc.forEach(t),vi.forEach(t),le=h(s),N=n(s,"P",{});var Pt=r(N);P=i(Pt,"The DistilBERT model was proposed in the blog post "),Y=n(Pt,"A",{href:!0,rel:!0});var Gc=r(Y);V=i(Gc,`Smaller, faster, cheaper, lighter: Introducing DistilBERT, a
...
and wordpiece.`),fn.forEach(t),of=h(St),Sn=n(St,"P",{});var yi=r(Sn);nf=i(yi,"Refer to superclass "),ji=n(yi,"A",{href:!0});var yp=r(ji);rf=i(yp,"BertTokenizer"),yp.forEach(t),af=i(yi," for usage examples and documentation concerning parameters."),yi.forEach(t),St.forEach(t),Cp=h(s),os=n(s,"H2",{class:!0});var Fi=r(os);Vs=n(Fi,"A",{id:!0,class:!0,href:!0});var Fp=r(Vs);Nl=n(Fp,"SPAN",{});var Dp=r(Nl);$(In.$$.fragment,Dp),Dp.forEach(t),Fp.forEach(t),lf=h(Fi),Ll=n(Fi,"SPAN",{});var dT=r(Ll);df=i(dT,"DistilBertTokenizerFast"),dT.forEach(t),Fi.forEach(t),qp=h(s),ct=n(s,"DIV",{class:!0});var mn=r(ct);$(Wn.$$.fragment,mn),cf=h(mn),Qn=n(mn,"P",{});var bh=r(Qn);pf=i(bh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Sl=n(bh,"EM",{});var cT=r(Sl);hf=i(cT,"tokenizers"),cT.forEach(t),uf=i(bh," library)."),bh.forEach(t),ff=h(mn),Js=n(mn,"P",{});var xp=r(Js);Ci=n(xp,"A",{href:!0});var pT=r(Ci);mf=i(pT,"DistilBertTokenizerFast"),pT.forEach(t),gf=i(xp," is identical to "),qi=n(xp,"A",{href:!0});var hT=r(qi);_f=i(hT,"BertTokenizerFast"),hT.forEach(t),bf=i(xp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),xp.forEach(t),vf=h(mn),Rn=n(mn,"P",{});var vh=r(Rn);kf=i(vh,"Refer to superclass "),Pi=n(vh,"A",{href:!0});var uT=r(Pi);Tf=i(uT,"BertTokenizerFast"),uT.forEach(t),$f=i(vh," for usage examples and documentation concerning parameters."),vh.forEach(t),mn.forEach(t),Pp=h(s),ns=n(s,"H2",{class:!0});var kh=r(ns);Gs=n(kh,"A",{id:!0,class:!0,href:!0});var fT=r(Gs);Il=n(fT,"SPAN",{});var mT=r(Il);$(Un.$$.fragment,mT),mT.forEach(t),fT.forEach(t),wf=h(kh),Wl=n(kh,"SPAN",{});var gT=r(Wl);yf=i(gT,"DistilBertModel"),gT.forEach(t),kh.forEach(t),Ap=h(s),We=n(s,"DIV",{class:!0});var It=r(We);$(Hn.$$.fragment,It),Ff=h(It),Ql=n(It,"P",{});var _T=r(Ql);Df=i(_T,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),_T.forEach(t),xf=h(It),Kn=n(It,"P",{});var Th=r(Kn);Bf=i(Th,"This model inherits from "),Ai=n(Th,"A",{href:!0});var bT=r(Ai);Mf=i(bT,"PreTrainedModel"),bT.forEach(t),Ef=i(Th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Th.forEach(t),zf=h(It),Vn=n(It,"P",{});var $h=r(Vn);jf=i($h,"This model is also a PyTorch "),Jn=n($h,"A",{href:!0,rel:!0});var vT=r(Jn);Cf=i(vT,"torch.nn.Module"),vT.forEach(t),qf=i($h,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),Pf=h(It),ht=n(It,"DIV",{class:!0});var gn=r(ht);$(Gn.$$.fragment,gn),Af=h(gn),rs=n(gn,"P",{});var hl=r(rs);Of=i(hl,"The "),Oi=n(hl,"A",{href:!0});var kT=r(Oi);Nf=i(kT,"DistilBertModel"),kT.forEach(t),Lf=i(hl," forward method, overrides the "),Rl=n(hl,"CODE",{});var TT=r(Rl);Sf=i(TT,"__call__"),TT.forEach(t),If=i(hl," special method."),hl.forEach(t),Wf=h(gn),$(Xs.$$.fragment,gn),Qf=h(gn),$(Ys.$$.fragment,gn),gn.forEach(t),It.forEach(t),Op=h(s),as=n(s,"H2",{class:!0});var wh=r(as);Zs=n(wh,"A",{id:!0,class:!0,href:!0});var $T=r(Zs);Ul=n($T,"SPAN",{});var wT=r(Ul);$(Xn.$$.fragment,wT),wT.forEach(t),$T.forEach(t),Rf=h(wh),Hl=n(wh,"SPAN",{});var yT=r(Hl);Uf=i(yT,"DistilBertForMaskedLM"),yT.forEach(t),wh.forEach(t),Np=h(s),Qe=n(s,"DIV",{class:!0});var Wt=r(Qe);$(Yn.$$.fragment,Wt),Hf=h(Wt),Zn=n(Wt,"P",{});var yh=r(Zn);Kf=i(yh,"DistilBert Model with a "),Kl=n(yh,"CODE",{});var FT=r(Kl);Vf=i(FT,"masked language modeling"),FT.forEach(t),Jf=i(yh," head on top."),yh.forEach(t),Gf=h(Wt),er=n(Wt,"P",{});var Fh=r(er);Xf=i(Fh,"This model inherits from "),Ni=n(Fh,"A",{href:!0});var DT=r(Ni);Yf=i(DT,"PreTrainedModel"),DT.forEach(t),Zf=i(Fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fh.forEach(t),em=h(Wt),tr=n(Wt,"P",{});var Dh=r(tr);tm=i(Dh,"This model is also a PyTorch "),sr=n(Dh,"A",{href:!0,rel:!0});var xT=r(sr);sm=i(xT,"torch.nn.Module"),xT.forEach(t),om=i(Dh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dh.forEach(t),nm=h(Wt),Ve=n(Wt,"DIV",{class:!0});var Qt=r(Ve);$(or.$$.fragment,Qt),rm=h(Qt),is=n(Qt,"P",{});var ul=r(is);am=i(ul,"The "),Li=n(ul,"A",{href:!0});var BT=r(Li);im=i(BT,"DistilBertForMaskedLM"),BT.forEach(t),lm=i(ul," forward method, overrides the "),Vl=n(ul,"CODE",{});var MT=r(Vl);dm=i(MT,"__call__"),MT.forEach(t),cm=i(ul," special method."),ul.forEach(t),pm=h(Qt),$(eo.$$.fragment,Qt),hm=h(Qt),$(to.$$.fragment,Qt),um=h(Qt),$(so.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),Lp=h(s),ls=n(s,"H2",{class:!0});var xh=r(ls);oo=n(xh,"A",{id:!0,class:!0,href:!0});var ET=r(oo);Jl=n(ET,"SPAN",{});var zT=r(Jl);$(nr.$$.fragment,zT),zT.forEach(t),ET.forEach(t),fm=h(xh),Gl=n(xh,"SPAN",{});var jT=r(Gl);mm=i(jT,"DistilBertForSequenceClassification"),jT.forEach(t),xh.forEach(t),Sp=h(s),Re=n(s,"DIV",{class:!0});var Rt=r(Re);$(rr.$$.fragment,Rt),gm=h(Rt),Xl=n(Rt,"P",{});var CT=r(Xl);_m=i(CT,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),CT.forEach(t),bm=h(Rt),ar=n(Rt,"P",{});var Bh=r(ar);vm=i(Bh,"This model inherits from "),Si=n(Bh,"A",{href:!0});var qT=r(Si);km=i(qT,"PreTrainedModel"),qT.forEach(t),Tm=i(Bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bh.forEach(t),$m=h(Rt),ir=n(Rt,"P",{});var Mh=r(ir);wm=i(Mh,"This model is also a PyTorch "),lr=n(Mh,"A",{href:!0,rel:!0});var PT=r(lr);ym=i(PT,"torch.nn.Module"),PT.forEach(t),Fm=i(Mh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mh.forEach(t),Dm=h(Rt),Pe=n(Rt,"DIV",{class:!0});var tt=r(Pe);$(dr.$$.fragment,tt),xm=h(tt),ds=n(tt,"P",{});var fl=r(ds);Bm=i(fl,"The "),Ii=n(fl,"A",{href:!0});var AT=r(Ii);Mm=i(AT,"DistilBertForSequenceClassification"),AT.forEach(t),Em=i(fl," forward method, overrides the "),Yl=n(fl,"CODE",{});var OT=r(Yl);zm=i(OT,"__call__"),OT.forEach(t),jm=i(fl," special method."),fl.forEach(t),Cm=h(tt),$(no.$$.fragment,tt),qm=h(tt),$(ro.$$.fragment,tt),Pm=h(tt),$(ao.$$.fragment,tt),Am=h(tt),$(io.$$.fragment,tt),Om=h(tt),$(lo.$$.fragment,tt),tt.forEach(t),Rt.forEach(t),Ip=h(s),cs=n(s,"H2",{class:!0});var Eh=r(cs);co=n(Eh,"A",{id:!0,class:!0,href:!0});var NT=r(co);Zl=n(NT,"SPAN",{});var LT=r(Zl);$(cr.$$.fragment,LT),LT.forEach(t),NT.forEach(t),Nm=h(Eh),ed=n(Eh,"SPAN",{});var ST=r(ed);Lm=i(ST,"DistilBertForMultipleChoice"),ST.forEach(t),Eh.forEach(t),Wp=h(s),Ue=n(s,"DIV",{class:!0});var Ut=r(Ue);$(pr.$$.fragment,Ut),Sm=h(Ut),td=n(Ut,"P",{});var IT=r(td);Im=i(IT,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zh.forEach(t),Hm=h(Ut),ur=n(Ut,"P",{});var jh=r(ur);Km=i(jh,"This model is also a PyTorch "),fr=n(jh,"A",{href:!0,rel:!0});var QT=r(fr);Vm=i(QT,"torch.nn.Module"),QT.forEach(t),Jm=i(jh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jh.forEach(t),Gm=h(Ut),ut=n(Ut,"DIV",{class:!0});var _n=r(ut);$(mr.$$.fragment,_n),Xm=h(_n),ps=n(_n,"P",{});var ml=r(ps);Ym=i(ml,"The "),Qi=n(ml,"A",{href:!0});var RT=r(Qi);Zm=i(RT,"DistilBertForMultipleChoice"),RT.forEach(t),eg=i(ml," forward method, overrides the "),sd=n(ml,"CODE",{});var UT=r(sd);tg=i(UT,"__call__"),UT.forEach(t),sg=i(ml," special method."),ml.forEach(t),og=h(_n),$(po.$$.fragment,_n),ng=h(_n),$(ho.$$.fragment,_n),_n.forEach(t),Ut.forEach(t),Qp=h(s),hs=n(s,"H2",{class:!0});var Ch=r(hs);uo=n(Ch,"A",{id:!0,class:!0,href:!0});var HT=r(uo);od=n(HT,"SPAN",{});var KT=r(od);$(gr.$$.fragment,KT),KT.forEach(t),HT.forEach(t),rg=h(Ch),nd=n(Ch,"SPAN",{});var VT=r(nd);ag=i(VT,"DistilBertForTokenClassification"),VT.forEach(t),Ch.forEach(t),Rp=h(s),He=n(s,"DIV",{class:!0});var Ht=r(He);$(_r.$$.fragment,Ht),ig=h(Ht),rd=n(Ht,"P",{});var JT=r(rd);lg=i(JT,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Kt=r(Je);$(Tr.$$.fragment,Kt),bg=h(Kt),us=n(Kt,"P",{});var gl=r(us);vg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var YT=r(Ui);kg=i(YT,"DistilBertForTokenClassification"),YT.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var ZT=r(ad);$g=i(ZT,"__call__"),ZT.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Kt),$(fo.$$.fragment,Kt),Fg=h(Kt),$(mo.$$.fragment,Kt),Dg=h(Kt),$(go.$$.fragment,Kt),Kt.forEach(t),Ht.forEach(t),Up=h(s),fs=n(s,"H2",{class:!0});var Ah=r(fs);_o=n(Ah,"A",{id:!0,class:!0,href:!0});var e$=r(_o);id=n(e$,"SPAN",{});var t$=r(id);$($r.$$.fragment,t$),t$.forEach(t),e$.forEach(t),xg=h(Ah),ld=n(Ah,"SPAN",{});var s$=r(ld);Bg=i(s$,"DistilBertForQuestionAnswering"),s$.forEach(t),Ah.forEach(t),Hp=h(s),Ke=n(s,"DIV",{class:!0});var Vt=r(Ke);$(wr.$$.fragment,Vt),Mg=h(Vt),ms=n(Vt,"P",{});var _l=r(ms);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(_l,"CODE",{});var o$=r(dd);zg=i(o$,"span start logits"),o$.forEach(t),jg=i(_l," and "),cd=n(_l,"CODE",{});var n$=r(cd);Cg=i(n$,"span end logits"),n$.forEach(t),qg=i(_l,")."),_l.forEach(t),Pg=h(Vt),yr=n(Vt,"P",{});var Oh=r(yr);Ag=i(Oh,"This model inherits from "),Hi=n(Oh,"A",{href:!0});var r$=r(Hi);Og=i(r$,"PreTrainedModel"),r$.forEach(t),Ng=i(Oh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oh.forEach(t),Lg=h(Vt),Fr=n(Vt,"P",{});var Nh=r(Fr);Sg=i(Nh,"This model is also a PyTorch "),Dr=n(Nh,"A",{href:!0,rel:!0});var a$=r(Dr);Ig=i(a$,"torch.nn.Module"),a$.forEach(t),Wg=i(Nh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh.forEach(t),Qg=h(Vt),Ge=n(Vt,"DIV",{class:!0});var Jt=r(Ge);$(xr.$$.fragment,Jt),Rg=h(Jt),gs=n(Jt,"P",{});var bl=r(gs);Ug=i(bl,"The "),Ki=n(bl,"A",{href:!0});var i$=r(Ki);Hg=i(i$,"DistilBertForQuestionAnswering"),i$.forEach(t),Kg=i(bl," forward method, overrides the "),pd=n(bl,"CODE",{});var l$=r(pd);Vg=i(l$,"__call__"),l$.forEach(t),Jg=i(bl," special method."),bl.forEach(t),Gg=h(Jt),$(bo.$$.fragment,Jt),Xg=h(Jt),$(vo.$$.fragment,Jt),Yg=h(Jt),$(ko.$$.fragment,Jt),Jt.forEach(t),Vt.forEach(t),Kp=h(s),_s=n(s,"H2",{class:!0});var Lh=r(_s);To=n(Lh,"A",{id:!0,class:!0,href:!0});var d$=r(To);hd=n(d$,"SPAN",{});var c$=r(hd);$(Br.$$.fragment,c$),c$.forEach(t),d$.forEach(t),Zg=h(Lh),ud=n(Lh,"SPAN",{});var p$=r(ud);e_=i(p$,"TFDistilBertModel"),p$.forEach(t),Lh.forEach(t),Vp=h(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);$(Mr.$$.fragment,$t),t_=h($t),fd=n($t,"P",{});var h$=r(fd);s_=i(h$,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),h$.forEach(t),o_=h($t),Er=n($t,"P",{});var Sh=r(Er);n_=i(Sh,"This model inherits from "),Vi=n(Sh,"A",{href:!0});var u$=r(Vi);r_=i(u$,"TFPreTrainedModel"),u$.forEach(t),a_=i(Sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),p_=h($t),$($o.$$.fragment,$t),h_=h($t),ft=n($t,"DIV",{class:!0});var bn=r(ft);$(Cr.$$.fragment,bn),u_=h(bn),bs=n(bn,"P",{});var vl=r(bs);f_=i(vl,"The "),Ji=n(vl,"A",{href:!0});var m$=r(Ji);m_=i(m$,"TFDistilBertModel"),m$.forEach(t),g_=i(vl," forward method, overrides the "),md=n(vl,"CODE",{});var g$=r(md);__=i(g$,"__call__"),g$.forEach(t),b_=i(vl," special method."),vl.forEach(t),v_=h(bn),$(wo.$$.fragment,bn),k_=h(bn),$(yo.$$.fragment,bn),bn.forEach(t),$t.forEach(t),Jp=h(s),vs=n(s,"H2",{class:!0});var Wh=r(vs);Fo=n(Wh,"A",{id:!0,class:!0,href:!0});var _$=r(Fo);gd=n(_$,"SPAN",{});var b$=r(gd);$(qr.$$.fragment,b$),b$.forEach(t),_$.forEach(t),T_=h(Wh),_d=n(Wh,"SPAN",{});var v$=r(_d);$_=i(v$,"TFDistilBertForMaskedLM"),v$.forEach(t),Wh.forEach(t),Gp=h(s),Oe=n(s,"DIV",{class:!0});var wt=r(Oe);$(Pr.$$.fragment,wt),w_=h(wt),Ar=n(wt,"P",{});var Qh=r(Ar);y_=i(Qh,"DistilBert Model with a "),bd=n(Qh,"CODE",{});var k$=r(bd);F_=i(k$,"masked language modeling"),k$.forEach(t),D_=i(Qh," head on top."),Qh.forEach(t),x_=h(wt),Or=n(wt,"P",{});var Rh=r(Or);B_=i(Rh,"This model inherits from "),Gi=n(Rh,"A",{href:!0});var T$=r(Gi);M_=i(T$,"TFPreTrainedModel"),T$.forEach(t),E_=i(Rh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),P_=h(wt),$(Do.$$.fragment,wt),A_=h(wt),Xe=n(wt,"DIV",{class:!0});var Gt=r(Xe);$(Sr.$$.fragment,Gt),O_=h(Gt),ks=n(Gt,"P",{});var kl=r(ks);N_=i(kl,"The "),Xi=n(kl,"A",{href:!0});var w$=r(Xi);L_=i(w$,"TFDistilBertForMaskedLM"),w$.forEach(t),S_=i(kl," forward method, overrides the "),vd=n(kl,"CODE",{});var y$=r(vd);I_=i(y$,"__call__"),y$.forEach(t),W_=i(kl," special method."),kl.forEach(t),Q_=h(Gt),$(xo.$$.fragment,Gt),R_=h(Gt),$(Bo.$$.fragment,Gt),U_=h(Gt),$(Mo.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Xp=h(s),Ts=n(s,"H2",{class:!0});var Hh=r(Ts);Eo=n(Hh,"A",{id:!0,class:!0,href:!0});var F$=r(Eo);kd=n(F$,"SPAN",{});var D$=r(kd);$(Ir.$$.fragment,D$),D$.forEach(t),F$.forEach(t),H_=h(Hh),Td=n(Hh,"SPAN",{});var x$=r(Td);K_=i(x$,"TFDistilBertForSequenceClassification"),x$.forEach(t),Hh.forEach(t),Yp=h(s),Ne=n(s,"DIV",{class:!0});var yt=r(Ne);$(Wr.$$.fragment,yt),V_=h(yt),$d=n(yt,"P",{});var B$=r($d);J_=i(B$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),B$.forEach(t),G_=h(yt),Qr=n(yt,"P",{});var Kh=r(Qr);X_=i(Kh,"This model inherits from "),Yi=n(Kh,"A",{href:!0});var M$=r(Yi);Y_=i(M$,"TFPreTrainedModel"),M$.forEach(t),Z_=i(Kh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kh.forEach(t),eb=h(yt),Rr=n(yt,"P",{});var Vh=r(Rr);tb=i(Vh,"This model is also a "),Ur=n(Vh,"A",{href:!0,rel:!0});var E$=r(Ur);sb=i(E$,"tf.keras.Model"),E$.forEach(t),ob=i(Vh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vh.forEach(t),nb=h(yt),$(zo.$$.fragment,yt),rb=h(yt),Ye=n(yt,"DIV",{class:!0});var Xt=r(Ye);$(Hr.$$.fragment,Xt),ab=h(Xt),$s=n(Xt,"P",{});var Tl=r($s);ib=i(Tl,"The "),Zi=n(Tl,"A",{href:!0});var z$=r(Zi);lb=i(z$,"TFDistilBertForSequenceClassification"),z$.forEach(t),db=i(Tl," forward method, overrides the "),wd=n(Tl,"CODE",{});var j$=r(wd);cb=i(j$,"__call__"),j$.forEach(t),pb=i(Tl," special method."),Tl.forEach(t),hb=h(Xt),$(jo.$$.fragment,Xt),ub=h(Xt),$(Co.$$.fragment,Xt),fb=h(Xt),$(qo.$$.fragment,Xt),Xt.forEach(t),yt.forEach(t),Zp=h(s),ws=n(s,"H2",{class:!0});var Jh=r(ws);Po=n(Jh,"A",{id:!0,class:!0,href:!0});var C$=r(Po);yd=n(C$,"SPAN",{});var q$=r(yd);$(Kr.$$.fragment,q$),q$.forEach(t),C$.forEach(t),mb=h(Jh),Fd=n(Jh,"SPAN",{});var P$=r(Fd);gb=i(P$,"TFDistilBertForMultipleChoice"),P$.forEach(t),Jh.forEach(t),eh=h(s),Le=n(s,"DIV",{class:!0});var Ft=r(Le);$(Vr.$$.fragment,Ft),_b=h(Ft),Dd=n(Ft,"P",{});var A$=r(Dd);bb=i(A$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),A$.forEach(t),vb=h(Ft),Jr=n(Ft,"P",{});var Gh=r(Jr);kb=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var O$=r(el);Tb=i(O$,"TFPreTrainedModel"),O$.forEach(t),$b=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),wb=h(Ft),Gr=n(Ft,"P",{});var Xh=r(Gr);yb=i(Xh,"This model is also a "),Xr=n(Xh,"A",{href:!0,rel:!0});var N$=r(Xr);Fb=i(N$,"tf.keras.Model"),N$.forEach(t),Db=i(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),xb=h(Ft),$(Ao.$$.fragment,Ft),Bb=h(Ft),mt=n(Ft,"DIV",{class:!0});var vn=r(mt);$(Yr.$$.fragment,vn),Mb=h(vn),ys=n(vn,"P",{});var $l=r(ys);Eb=i($l,"The "),tl=n($l,"A",{href:!0});var L$=r(tl);zb=i(L$,"TFDistilBertForMultipleChoice"),L$.forEach(t),jb=i($l," forward method, overrides the "),xd=n($l,"CODE",{});var S$=r(xd);Cb=i(S$,"__call__"),S$.forEach(t),qb=i($l," special method."),$l.forEach(t),Pb=h(vn),$(Oo.$$.fragment,vn),Ab=h(vn),$(No.$$.fragment,vn),vn.forEach(t),Ft.forEach(t),th=h(s),Fs=n(s,"H2",{class:!0});var Yh=r(Fs);Lo=n(Yh,"A",{id:!0,class:!0,href:!0});var I$=r(Lo);Bd=n(I$,"SPAN",{});var W$=r(Bd);$(Zr.$$.fragment,W$),W$.forEach(t),I$.forEach(t),Ob=h(Yh),Md=n(Yh,"SPAN",{});var Q$=r(Md);Nb=i(Q$,"TFDistilBertForTokenClassification"),Q$.forEach(t),Yh.forEach(t),sh=h(s),Se=n(s,"DIV",{class:!0});var Dt=r(Se);$(ea.$$.fragment,Dt),Lb=h(Dt),Ed=n(Dt,"P",{});var R$=r(Ed);Sb=i(R$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R$.forEach(t),Ib=h(Dt),ta=n(Dt,"P",{});var Zh=r(ta);Wb=i(Zh,"This model inherits from "),sl=n(Zh,"A",{href:!0});var U$=r(sl);Qb=i(U$,"TFPreTrainedModel"),U$.forEach(t),Rb=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Ub=h(Dt),sa=n(Dt,"P",{});var eu=r(sa);Hb=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var H$=r(oa);Kb=i(H$,"tf.keras.Model"),H$.forEach(t),Vb=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Dt),$(So.$$.fragment,Dt),Gb=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Yb=i(wl,"The "),ol=n(wl,"A",{href:!0});var K$=r(ol);Zb=i(K$,"TFDistilBertForTokenClassification"),K$.forEach(t),e1=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var V$=r(zd);t1=i(V$,"__call__"),V$.forEach(t),s1=i(wl," special method."),wl.forEach(t),o1=h(Yt),$(Io.$$.fragment,Yt),n1=h(Yt),$(Wo.$$.fragment,Yt),r1=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var J$=r(Ro);jd=n(J$,"SPAN",{});var G$=r(jd);$(ra.$$.fragment,G$),G$.forEach(t),J$.forEach(t),a1=h(tu),Cd=n(tu,"SPAN",{});var X$=r(Cd);i1=i(X$,"TFDistilBertForQuestionAnswering"),X$.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),l1=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);d1=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y$=r(qd);c1=i(Y$,"span start logits"),Y$.forEach(t),p1=i(yl," and "),Pd=n(yl,"CODE",{});var Z$=r(Pd);h1=i(Z$,"span end logits"),Z$.forEach(t),u1=i(yl,")."),yl.forEach(t),f1=h(xt),ia=n(xt,"P",{});var su=r(ia);m1=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var ew=r(nl);g1=i(ew,"TFPreTrainedModel"),ew.forEach(t),_1=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),b1=h(xt),la=n(xt,"P",{});var ou=r(la);v1=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var tw=r(da);k1=i(tw,"tf.keras.Model"),tw.forEach(t),T1=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$1=h(xt),$(Uo.$$.fragment,xt),w1=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),y1=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);F1=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var sw=r(rl);D1=i(sw,"TFDistilBertForQuestionAnswering"),sw.forEach(t),x1=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var ow=r(Ad);B1=i(ow,"__call__"),ow.forEach(t),M1=i(Fl," special method."),Fl.forEach(t),E1=h(Zt),$(Ho.$$.fragment,Zt),z1=h(Zt),$(Ko.$$.fragment,Zt),j1=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var nw=r(Jo);Od=n(nw,"SPAN",{});var rw=r(Od);$(pa.$$.fragment,rw),rw.forEach(t),nw.forEach(t),C1=h(nu),Nd=n(nu,"SPAN",{});var aw=r(Nd);q1=i(aw,"FlaxDistilBertModel"),aw.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),P1=h(st),Ld=n(st,"P",{});var iw=r(Ld);A1=i(iw,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iw.forEach(t),O1=h(st),ua=n(st,"P",{});var ru=r(ua);N1=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var lw=r(al);L1=i(lw,"FlaxPreTrainedModel"),lw.forEach(t),S1=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),I1=h(st),fa=n(st,"P",{});var au=r(fa);W1=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var dw=r(ma);Q1=i(dw,"flax.linen.Module"),dw.forEach(t),R1=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),U1=h(st),Sd=n(st,"P",{});var cw=r(Sd);H1=i(cw,"Finally, this model supports inherent JAX features such as:"),cw.forEach(t),K1=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var pw=r(Id);ga=n(pw,"A",{href:!0,rel:!0});var hw=r(ga);V1=i(hw,"Just-In-Time (JIT) compilation"),hw.forEach(t),pw.forEach(t),J1=h(kn),Wd=n(kn,"LI",{});var uw=r(Wd);_a=n(uw,"A",{href:!0,rel:!0});var fw=r(_a);G1=i(fw,"Automatic Differentiation"),fw.forEach(t),uw.forEach(t),X1=h(kn),Qd=n(kn,"LI",{});var mw=r(Qd);ba=n(mw,"A",{href:!0,rel:!0});var gw=r(ba);Y1=i(gw,"Vectorization"),gw.forEach(t),mw.forEach(t),Z1=h(kn),Rd=n(kn,"LI",{});var _w=r(Rd);va=n(_w,"A",{href:!0,rel:!0});var bw=r(va);ev=i(bw,"Parallelization"),bw.forEach(t),_w.forEach(t),kn.forEach(t),tv=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sv=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ov=i(Dl,"The "),Ud=n(Dl,"CODE",{});var vw=r(Ud);nv=i(vw,"FlaxDistilBertPreTrainedModel"),vw.forEach(t),rv=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var kw=r(Hd);av=i(kw,"__call__"),kw.forEach(t),iv=i(Dl," special method."),Dl.forEach(t),lv=h(Tn),$(Go.$$.fragment,Tn),dv=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var Tw=r(Yo);Kd=n(Tw,"SPAN",{});var $w=r(Kd);$(Ta.$$.fragment,$w),$w.forEach(t),Tw.forEach(t),cv=h(iu),Vd=n(iu,"SPAN",{});var ww=r(Vd);pv=i(ww,"FlaxDistilBertForMaskedLM"),ww.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hv=h(ot),wa=n(ot,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yw=r(Jd);fv=i(yw,"language modeling"),yw.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(ot),ya=n(ot,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Fw=r(il);bv=i(Fw,"FlaxPreTrainedModel"),Fw.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kv=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tv=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var Dw=r(Da);$v=i(Dw,"flax.linen.Module"),Dw.forEach(t),wv=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yv=h(ot),Gd=n(ot,"P",{});var xw=r(Gd);Fv=i(xw,"Finally, this model supports inherent JAX features such as:"),xw.forEach(t),Dv=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var Bw=r(Xd);xa=n(Bw,"A",{href:!0,rel:!0});var Mw=r(xa);xv=i(Mw,"Just-In-Time (JIT) compilation"),Mw.forEach(t),Bw.forEach(t),Bv=h($n),Yd=n($n,"LI",{});var Ew=r(Yd);Ba=n(Ew,"A",{href:!0,rel:!0});var zw=r(Ba);Mv=i(zw,"Automatic Differentiation"),zw.forEach(t),Ew.forEach(t),Ev=h($n),Zd=n($n,"LI",{});var jw=r(Zd);Ma=n(jw,"A",{href:!0,rel:!0});var Cw=r(Ma);zv=i(Cw,"Vectorization"),Cw.forEach(t),jw.forEach(t),jv=h($n),ec=n($n,"LI",{});var qw=r(ec);Ea=n(qw,"A",{href:!0,rel:!0});var Pw=r(Ea);Cv=i(Pw,"Parallelization"),Pw.forEach(t),qw.forEach(t),$n.forEach(t),qv=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pv=h(wn),Cs=n(wn,"P",{});var xl=r(Cs);Av=i(xl,"The "),tc=n(xl,"CODE",{});var Aw=r(tc);Ov=i(Aw,"FlaxDistilBertPreTrainedModel"),Aw.forEach(t),Nv=i(xl," forward method, overrides the "),sc=n(xl,"CODE",{});var Ow=r(sc);Lv=i(Ow,"__call__"),Ow.forEach(t),Sv=i(xl," special method."),xl.forEach(t),Iv=h(wn),$(Zo.$$.fragment,wn),Wv=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var Nw=r(tn);oc=n(Nw,"SPAN",{});var Lw=r(oc);$(ja.$$.fragment,Lw),Lw.forEach(t),Nw.forEach(t),Qv=h(pu),nc=n(pu,"SPAN",{});var Sw=r(nc);Rv=i(Sw,"FlaxDistilBertForSequenceClassification"),Sw.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uv=h(nt),rc=n(nt,"P",{});var Iw=r(rc);Hv=i(Iw,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Iw.forEach(t),Kv=h(nt),qa=n(nt,"P",{});var hu=r(qa);Vv=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var Ww=r(ll);Jv=i(Ww,"FlaxPreTrainedModel"),Ww.forEach(t),Gv=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xv=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yv=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Qw=r(Aa);Zv=i(Qw,"flax.linen.Module"),Qw.forEach(t),ek=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var Rw=r(ac);sk=i(Rw,"Finally, this model supports inherent JAX features such as:"),Rw.forEach(t),ok=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uw=r(ic);Oa=n(Uw,"A",{href:!0,rel:!0});var Hw=r(Oa);nk=i(Hw,"Just-In-Time (JIT) compilation"),Hw.forEach(t),Uw.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var Kw=r(lc);Na=n(Kw,"A",{href:!0,rel:!0});var Vw=r(Na);ak=i(Vw,"Automatic Differentiation"),Vw.forEach(t),Kw.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var Jw=r(dc);La=n(Jw,"A",{href:!0,rel:!0});var Gw=r(La);lk=i(Gw,"Vectorization"),Gw.forEach(t),Jw.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var Xw=r(cc);Sa=n(Xw,"A",{href:!0,rel:!0});var Yw=r(Sa);ck=i(Yw,"Parallelization"),Yw.forEach(t),Xw.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hk=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uk=i(Bl,"The "),pc=n(Bl,"CODE",{});var Zw=r(pc);fk=i(Zw,"FlaxDistilBertPreTrainedModel"),Zw.forEach(t),mk=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var ey=r(hc);gk=i(ey,"__call__"),ey.forEach(t),_k=i(Bl," special method."),Bl.forEach(t),bk=h(Fn),$(sn.$$.fragment,Fn),vk=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kk=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);Tk=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),mc=n(rt,"P",{});var ny=r(mc);wk=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
