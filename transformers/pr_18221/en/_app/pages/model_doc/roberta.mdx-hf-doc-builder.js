...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18221/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ay=p(),T(Es.$$.fragment),Oy=p(),mt=n("div"),T(bi.$$.fragment),Ny=p(),Xo=n("p"),Iy=r("The "),qd=n("a"),Dy=r("TFRobertaForQuestionAnswering"),Sy=r(" forward method, overrides the "),Ip=n("code"),Wy=r("__call__"),By=r(" special method."),Uy=p(),T(zs.$$.fragment),Hy=p(),T(qs.$$.fragment),Qy=p(),T(Cs.$$.fragment),xf=p(),Yo=n("h2"),js=n("a"),Dp=n("span"),T(ki.$$.fragment),Jy=p(),Sp=n("span"),Vy=r("FlaxRobertaModel"),Rf=p(),Oe=n("div"),T(vi.$$.fragment),Ky=p(),Wp=n("p"),Gy=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Xy=p(),Ti=n("p"),Yy=r("This model inherits from "),Cd=n("a"),Zy=r("FlaxPreTrainedModel"),e2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),t2=p(),yi=n("p"),o2=r("This model is also a Flax Linen "),wi=n("a"),n2=r("flax.linen.Module"),s2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),a2=p(),Bp=n("p"),r2=r("Finally, this model supports inherent JAX features such as:"),i2=p(),Ut=n("ul"),Up=n("li"),$i=n("a"),l2=r("Just-In-Time (JIT) compilation"),d2=p(),Hp=n("li"),Fi=n("a"),c2=r("Automatic Differentiation"),p2=p(),Qp=n("li"),xi=n("a"),h2=r("Vectorization"),m2=p(),Jp=n("li"),Ri=n("a"),f2=r("Parallelization"),u2=p(),zt=n("div"),T(Mi.$$.fragment),g2=p(),Zo=n("p"),_2=r("The "),Vp=n("code"),b2=r("FlaxRobertaPreTrainedModel"),k2=r(" forward method, overrides the "),Kp=n("code"),v2=r("__call__"),T2=r(" special method."),y2=p(),T(Ps.$$.fragment),w2=p(),T(Ls.$$.fragment),Mf=p(),en=n("h2"),As=n("a"),Gp=n("span"),T(Ei.$$.fragment),$2=p(),Xp=n("span"),F2=r("FlaxRobertaForCausalLM"),Ef=p(),Ne=n("div"),T(zi.$$.fragment),x2=p(),Yp=n("p"),R2=r(`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),M2=p(),qi=n("p"),E2=r("This model inherits from "),jd=n("a"),z2=r("FlaxPreTrainedModel"),q2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),C2=p(),Ci=n("p"),j2=r("This model is also a Flax Linen "),ji=n("a"),P2=r("flax.linen.Module"),L2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A2=p(),Zp=n("p"),O2=r("Finally, this model supports inherent JAX features such as:"),N2=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I2=r("Just-In-Time (JIT) compilation"),D2=p(),th=n("li"),Li=n("a"),S2=r("Automatic Differentiation"),W2=p(),oh=n("li"),Ai=n("a"),B2=r("Vectorization"),U2=p(),nh=n("li"),Oi=n("a"),H2=r("Parallelization"),Q2=p(),qt=n("div"),T(Ni.$$.fragment),J2=p(),tn=n("p"),V2=r("The "),sh=n("code"),K2=r("FlaxRobertaPreTrainedModel"),G2=r(" forward method, overrides the "),ah=n("code"),X2=r("__call__"),Y2=r(" special method."),Z2=p(),T(Os.$$.fragment),ew=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),tw=p(),ih=n("span"),ow=r("FlaxRobertaForMaskedLM"),qf=p(),Ie=n("div"),T(Di.$$.fragment),nw=p(),Si=n("p"),sw=r("RoBERTa Model with a "),lh=n("code"),aw=r("language modeling"),rw=r(" head on top."),iw=p(),Wi=n("p"),lw=r("This model inherits from "),Pd=n("a"),dw=r("FlaxPreTrainedModel"),cw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),pw=p(),Bi=n("p"),hw=r("This model is also a Flax Linen "),Ui=n("a"),mw=r("flax.linen.Module"),fw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uw=p(),dh=n("p"),gw=r("Finally, this model supports inherent JAX features such as:"),_w=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),bw=r("Just-In-Time (JIT) compilation"),kw=p(),ph=n("li"),Qi=n("a"),vw=r("Automatic Differentiation"),Tw=p(),hh=n("li"),Ji=n("a"),yw=r("Vectorization"),ww=p(),mh=n("li"),Vi=n("a"),$w=r("Parallelization"),Fw=p(),Ct=n("div"),T(Ki.$$.fragment),xw=p(),nn=n("p"),Rw=r("The "),fh=n("code"),Mw=r("FlaxRobertaPreTrainedModel"),Ew=r(" forward method, overrides the "),uh=n("code"),zw=r("__call__"),qw=r(" special method."),Cw=p(),T(Ds.$$.fragment),jw=p(),T(Ss.$$.fragment),Cf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),T(Gi.$$.fragment),Pw=p(),_h=n("span"),Lw=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),T(Xi.$$.fragment),Aw=p(),bh=n("p"),Ow=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Nw=p(),Yi=n("p"),Iw=r("This model inherits from "),Ld=n("a"),Dw=r("FlaxPreTrainedModel"),Sw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ww=p(),Zi=n("p"),Bw=r("This model is also a Flax Linen "),el=n("a"),Uw=r("flax.linen.Module"),Hw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qw=p(),kh=n("p"),Jw=r("Finally, this model supports inherent JAX features such as:"),Vw=p(),Jt=n("ul"),vh=n("li"),tl=n("a"),Kw=r("Just-In-Time (JIT) compilation"),Gw=p(),Th=n("li"),ol=n("a"),Xw=r("Automatic Differentiation"),Yw=p(),yh=n("li"),nl=n("a"),Zw=r("Vectorization"),e$=p(),wh=n("li"),sl=n("a"),t$=r("Parallelization"),o$=p(),jt=n("div"),T(al.$$.fragment),n$=p(),an=n("p"),s$=r("The "),$h=n("code"),a$=r("FlaxRobertaPreTrainedModel"),r$=r(" forward method, overrides the "),Fh=n("code"),i$=r("__call__"),l$=r(" special method."),d$=p(),T(Bs.$$.fragment),c$=p(),T(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),T(rl.$$.fragment),p$=p(),Rh=n("span"),h$=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),T(il.$$.fragment),m$=p(),Mh=n("p"),f$=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k$=p(),dl=n("p"),v$=r("This model is also a Flax Linen "),cl=n("a"),T$=r("flax.linen.Module"),y$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w$=p(),Eh=n("p"),$$=r("Finally, this model supports inherent JAX features such as:"),F$=p(),Vt=n("ul"),zh=n("li"),pl=n("a"),x$=r("Just-In-Time (JIT) compilation"),R$=p(),qh=n("li"),hl=n("a"),M$=r("Automatic Differentiation"),E$=p(),Ch=n("li"),ml=n("a"),z$=r("Vectorization"),q$=p(),jh=n("li"),fl=n("a"),C$=r("Parallelization"),j$=p(),Pt=n("div"),T(ul.$$.fragment),P$=p(),ln=n("p"),L$=r("The "),Ph=n("code"),A$=r("FlaxRobertaPreTrainedModel"),O$=r(" forward method, overrides the "),Lh=n("code"),N$=r("__call__"),I$=r(" special method."),D$=p(),T(Qs.$$.fragment),S$=p(),T(Js.$$.fragment),Af=p(),dn=n("h2"),Vs=n("a"),Ah=n("span"),T(gl.$$.fragment),W$=p(),Oh=n("span"),B$=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),T(_l.$$.fragment),U$=p(),Nh=n("p"),H$=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),qd=s(nc,"A",{href:!0});var TR=a(qd);Dy=i(TR,"TFRobertaForQuestionAnswering"),TR.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yR=a(Ip);Wy=i(yR,"__call__"),yR.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(qs.$$.fragment,uo),Qy=h(uo),y(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);y(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),Jy=h(Ou),Sp=s(Ou,"SPAN",{});var FR=a(Sp);Vy=i(FR,"FlaxRobertaModel"),FR.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);Gy=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var RR=a(Cd);Zy=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),e2=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),t2=h(gt),yi=s(gt,"P",{});var Iu=a(yi);o2=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var MR=a(wi);n2=i(MR,"flax.linen.Module"),MR.forEach(t),s2=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),a2=h(gt),Bp=s(gt,"P",{});var ER=a(Bp);r2=i(ER,"Finally, this model supports inherent JAX features such as:"),ER.forEach(t),i2=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zR=a(Up);$i=s(zR,"A",{href:!0,rel:!0});var qR=a($i);l2=i(qR,"Just-In-Time (JIT) compilation"),qR.forEach(t),zR.forEach(t),d2=h(ra),Hp=s(ra,"LI",{});var CR=a(Hp);Fi=s(CR,"A",{href:!0,rel:!0});var jR=a(Fi);c2=i(jR,"Automatic Differentiation"),jR.forEach(t),CR.forEach(t),p2=h(ra),Qp=s(ra,"LI",{});var PR=a(Qp);xi=s(PR,"A",{href:!0,rel:!0});var LR=a(xi);h2=i(LR,"Vectorization"),LR.forEach(t),PR.forEach(t),m2=h(ra),Jp=s(ra,"LI",{});var AR=a(Jp);Ri=s(AR,"A",{href:!0,rel:!0});var OR=a(Ri);f2=i(OR,"Parallelization"),OR.forEach(t),AR.forEach(t),ra.forEach(t),u2=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),g2=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_2=i(sc,"The "),Vp=s(sc,"CODE",{});var NR=a(Vp);b2=i(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),k2=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var IR=a(Kp);v2=i(IR,"__call__"),IR.forEach(t),T2=i(sc," special method."),sc.forEach(t),y2=h(ia),y(Ps.$$.fragment,ia),w2=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var DR=a(As);Gp=s(DR,"SPAN",{});var SR=a(Gp);y(Ei.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$2=h(Du),Xp=s(Du,"SPAN",{});var WR=a(Xp);F2=i(WR,"FlaxRobertaForCausalLM"),WR.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),x2=h(_t),Yp=s(_t,"P",{});var BR=a(Yp);R2=i(BR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),BR.forEach(t),M2=h(_t),qi=s(_t,"P",{});var Su=a(qi);E2=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var UR=a(jd);z2=i(UR,"FlaxPreTrainedModel"),UR.forEach(t),q2=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),C2=h(_t),Ci=s(_t,"P",{});var Wu=a(Ci);j2=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var HR=a(ji);P2=i(HR,"flax.linen.Module"),HR.forEach(t),L2=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),A2=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);O2=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),N2=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);I2=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),D2=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);S2=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),W2=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);B2=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),U2=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var eM=a(Oi);H2=i(eM,"Parallelization"),eM.forEach(t),ZR.forEach(t),la.forEach(t),Q2=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),J2=h(da),tn=s(da,"P",{});var ac=a(tn);V2=i(ac,"The "),sh=s(ac,"CODE",{});var tM=a(sh);K2=i(tM,"FlaxRobertaPreTrainedModel"),tM.forEach(t),G2=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oM=a(ah);X2=i(oM,"__call__"),oM.forEach(t),Y2=i(ac," special method."),ac.forEach(t),Z2=h(da),y(Os.$$.fragment,da),ew=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nM=a(Is);rh=s(nM,"SPAN",{});var sM=a(rh);y(Ii.$$.fragment,sM),sM.forEach(t),nM.forEach(t),tw=h(Bu),ih=s(Bu,"SPAN",{});var aM=a(ih);ow=i(aM,"FlaxRobertaForMaskedLM"),aM.forEach(t),Bu.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),nw=h(bt),Si=s(bt,"P",{});var Uu=a(Si);sw=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rM=a(lh);aw=i(rM,"language modeling"),rM.forEach(t),rw=i(Uu," head on top."),Uu.forEach(t),iw=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);lw=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iM=a(Pd);dw=i(iM,"FlaxPreTrainedModel"),iM.forEach(t),cw=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hu.forEach(t),pw=h(bt),Bi=s(bt,"P",{});var Qu=a(Bi);hw=i(Qu,"This model is also a Flax Linen "),Ui=s(Qu,"A",{href:!0,rel:!0});var lM=a(Ui);mw=i(lM,"flax.linen.Module"),lM.forEach(t),fw=i(Qu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),uw=h(bt),dh=s(bt,"P",{});var dM=a(dh);gw=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_w=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);bw=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),kw=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);vw=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),Tw=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Ji=s(fM,"A",{href:!0,rel:!0});var uM=a(Ji);yw=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),ww=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Vi=s(gM,"A",{href:!0,rel:!0});var _M=a(Vi);$w=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),Fw=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),xw=h(pa),nn=s(pa,"P",{});var rc=a(nn);Rw=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);Mw=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),Ew=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);zw=i(kM,"__call__"),kM.forEach(t),qw=i(rc," special method."),rc.forEach(t),Cw=h(pa),y(Ds.$$.fragment,pa),jw=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var TM=a(gh);y(Gi.$$.fragment,TM),TM.forEach(t),vM.forEach(t),Pw=h(Ju),_h=s(Ju,"SPAN",{});var yM=a(_h);Lw=i(yM,"FlaxRobertaForSequenceClassification"),yM.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),Aw=h(kt),bh=s(kt,"P",{});var wM=a(bh);Ow=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wM.forEach(t),Nw=h(kt),Yi=s(kt,"P",{});var Vu=a(Yi);Iw=i(Vu,"This model inherits from "),Ld=s(Vu,"A",{href:!0});var $M=a(Ld);Dw=i($M,"FlaxPreTrainedModel"),$M.forEach(t),Sw=i(Vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vu.forEach(t),Ww=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);Bw=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var FM=a(el);Uw=i(FM,"flax.linen.Module"),FM.forEach(t),Hw=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Qw=h(kt),kh=s(kt,"P",{});var xM=a(kh);Jw=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),Vw=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);Kw=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),Gw=h(ha),Th=s(ha,"LI",{});var EM=a(Th);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);Xw=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Yw=h(ha),yh=s(ha,"LI",{});var qM=a(yh);nl=s(qM,"A",{href:!0,rel:!0});var CM=a(nl);Zw=i(CM,"Vectorization"),CM.forEach(t),qM.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t$=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n$=h(ma),an=s(ma,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a$=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i$=i(AM,"__call__"),AM.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ma),y(Bs.$$.fragment,ma),c$=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);y(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p$=h(Gu),Rh=s(Gu,"SPAN",{});var IM=a(Rh);h$=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m$=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f$=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k$=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v$=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WM=a(cl);T$=i(WM,"flax.linen.Module"),WM.forEach(t),y$=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var BM=a(Eh);$$=i(BM,"Finally, this model supports inherent JAX features such as:"),BM.forEach(t),F$=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UM=a(zh);pl=s(UM,"A",{href:!0,rel:!0});var HM=a(pl);x$=i(HM,"Just-In-Time (JIT) compilation"),HM.forEach(t),UM.forEach(t),R$=h(fa),qh=s(fa,"LI",{});var QM=a(qh);hl=s(QM,"A",{href:!0,rel:!0});var JM=a(hl);M$=i(JM,"Automatic Differentiation"),JM.forEach(t),QM.forEach(t),E$=h(fa),Ch=s(fa,"LI",{});var VM=a(Ch);ml=s(VM,"A",{href:!0,rel:!0});var KM=a(ml);z$=i(KM,"Vectorization"),KM.forEach(t),VM.forEach(t),q$=h(fa),jh=s(fa,"LI",{});var GM=a(jh);fl=s(GM,"A",{href:!0,rel:!0});var XM=a(fl);C$=i(XM,"Parallelization"),XM.forEach(t),GM.forEach(t),fa.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P$=h(ua),ln=s(ua,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var YM=a(Ph);A$=i(YM,"FlaxRobertaPreTrainedModel"),YM.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZM=a(Lh);N$=i(ZM,"__call__"),ZM.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(ua),y(Qs.$$.fragment,ua),S$=h(ua),y(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eE=a(Vs);Ah=s(eE,"SPAN",{});var tE=a(Ah);y(gl.$$.fragment,tE),tE.forEach(t),eE.forEach(t),W$=h(Zu),Oh=s(Zu,"SPAN",{});var oE=a(Oh);B$=i(oE,"FlaxRobertaForTokenClassification"),oE.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U$=h(Tt),Nh=s(Tt,"P",{});var nE=a(Nh);H$=i(nE,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nE.forEach(t),Q$=h(Tt),bl=s(Tt,"P",{});var eg=a(bl);J$=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sE=a(Od);V$=i(sE,"FlaxPreTrainedModel"),sE.forEach(t),K$=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G$=h(Tt),kl=s(Tt,"P",{});var tg=a(kl);X$=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aE=a(vl);Y$=i(aE,"flax.linen.Module"),aE.forEach(t),Z$=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
