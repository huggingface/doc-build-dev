...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17770/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17770/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17770/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17770/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17770/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17770/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17770/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17770/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17770/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tf.forEach(t),tw=p(Tt),Rp=s(Tt,"P",{});var e7=a(Rp);ow=i(e7,"Finally, this model supports inherent JAX features such as:"),e7.forEach(t),nw=p(Tt),Wt=s(Tt,"UL",{});var js=a(Wt);Lp=s(js,"LI",{});var t7=a(Lp);ci=s(t7,"A",{href:!0,rel:!0});var o7=a(ci);sw=i(o7,"Just-In-Time (JIT) compilation"),o7.forEach(t),t7.forEach(t),aw=p(js),Ep=s(js,"LI",{});var n7=a(Ep);pi=s(n7,"A",{href:!0,rel:!0});var s7=a(pi);rw=i(s7,"Automatic Differentiation"),s7.forEach(t),n7.forEach(t),iw=p(js),zp=s(js,"LI",{});var a7=a(zp);hi=s(a7,"A",{href:!0,rel:!0});var r7=a(hi);lw=i(r7,"Vectorization"),r7.forEach(t),a7.forEach(t),dw=p(js),qp=s(js,"LI",{});var i7=a(qp);mi=s(i7,"A",{href:!0,rel:!0});var l7=a(mi);cw=i(l7,"Parallelization"),l7.forEach(t),i7.forEach(t),js.forEach(t),pw=p(Tt),ui=s(Tt,"P",{});var of=a(ui);hw=i(of,"This class overrides "),kd=s(of,"A",{href:!0});var d7=a(kd);mw=i(d7,"FlaxRobertaForMaskedLM"),d7.forEach(t),uw=i(of,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),of.forEach(t),fw=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Xs=a(Lt);y(fi.$$.fragment,Xs),gw=p(Xs),Wo=s(Xs,"P",{});var Vd=a(Wo);_w=i(Vd,"The "),Cp=s(Vd,"CODE",{});var c7=a(Cp);bw=i(c7,"FlaxRobertaPreTrainedModel"),c7.forEach(t),kw=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var p7=a(jp);vw=i(p7,"__call__"),p7.forEach(t),Tw=i(Vd," special method."),Vd.forEach(t),yw=p(Xs),y(ms.$$.fragment,Xs),ww=p(Xs),y(us.$$.fragment,Xs),Xs.forEach(t),Tt.forEach(t),Pm=p(o),Bo=s(o,"H2",{class:!0});var nf=a(Bo);fs=s(nf,"A",{id:!0,class:!0,href:!0});var h7=a(fs);Xp=s(h7,"SPAN",{});var m7=a(Xp);y(gi.$$.fragment,m7),m7.forEach(t),h7.forEach(t),$w=p(nf),Pp=s(nf,"SPAN",{});var u7=a(Pp);Mw=i(u7,"FlaxXLMRobertaForSequenceClassification"),u7.forEach(t),nf.forEach(t),Am=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(_i.$$.fragment,tt),Fw=p(tt),Ap=s(tt,"P",{});var f7=a(Ap);xw=i(f7,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),f7.forEach(t),Rw=p(tt),bi=s(tt,"P",{});var sf=a(bi);Lw=i(sf,"This model inherits from "),vd=s(sf,"A",{href:!0});var g7=a(vd);Ew=i(g7,"FlaxPreTrainedModel"),g7.forEach(t),zw=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sf.forEach(t),qw=p(tt),ki=s(tt,"P",{});var af=a(ki);Cw=i(af,"This model is also a Flax Linen "),vi=s(af,"A",{href:!0,rel:!0});var _7=a(vi);jw=i(_7,"flax.linen.Module"),_7.forEach(t),Xw=i(af,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),Pw=p(tt),Op=s(tt,"P",{});var b7=a(Op);Aw=i(b7,"Finally, this model supports inherent JAX features such as:"),b7.forEach(t),Ow=p(tt),Bt=s(tt,"UL",{});var Ps=a(Bt);Np=s(Ps,"LI",{});var k7=a(Np);Ti=s(k7,"A",{href:!0,rel:!0});var v7=a(Ti);Nw=i(v7,"Just-In-Time (JIT) compilation"),v7.forEach(t),k7.forEach(t),Iw=p(Ps),Ip=s(Ps,"LI",{});var T7=a(Ip);yi=s(T7,"A",{href:!0,rel:!0});var y7=a(yi);Dw=i(y7,"Automatic Differentiation"),y7.forEach(t),T7.forEach(t),Sw=p(Ps),Dp=s(Ps,"LI",{});var w7=a(Dp);wi=s(w7,"A",{href:!0,rel:!0});var $7=a(wi);Ww=i($7,"Vectorization"),$7.forEach(t),w7.forEach(t),Bw=p(Ps),Sp=s(Ps,"LI",{});var M7=a(Sp);$i=s(M7,"A",{href:!0,rel:!0});var F7=a($i);Uw=i(F7,"Parallelization"),F7.forEach(t),M7.forEach(t),Ps.forEach(t),Qw=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);Hw=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var x7=a(Td);Vw=i(x7,"FlaxRobertaForSequenceClassification"),x7.forEach(t),Jw=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),Kw=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),Gw=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Yw=i(Jd,"The "),Wp=s(Jd,"CODE",{});var R7=a(Wp);Zw=i(R7,"FlaxRobertaPreTrainedModel"),R7.forEach(t),e$=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var L7=a(Bp);t$=i(L7,"__call__"),L7.forEach(t),o$=i(Jd," special method."),Jd.forEach(t),n$=p(As),y(gs.$$.fragment,As),s$=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var E7=a(bs);Up=s(E7,"SPAN",{});var z7=a(Up);y(xi.$$.fragment,z7),z7.forEach(t),E7.forEach(t),a$=p(lf),Qp=s(lf,"SPAN",{});var q7=a(Qp);r$=i(q7,"FlaxXLMRobertaForMultipleChoice"),q7.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i$=p(ot),Hp=s(ot,"P",{});var C7=a(Hp);l$=i(C7,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),C7.forEach(t),d$=p(ot),Li=s(ot,"P",{});var df=a(Li);c$=i(df,"This model inherits from "),yd=s(df,"A",{href:!0});var j7=a(yd);p$=i(j7,"FlaxPreTrainedModel"),j7.forEach(t),h$=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),df.forEach(t),m$=p(ot),Ei=s(ot,"P",{});var cf=a(Ei);u$=i(cf,"This model is also a Flax Linen "),zi=s(cf,"A",{href:!0,rel:!0});var X7=a(zi);f$=i(X7,"flax.linen.Module"),X7.forEach(t),g$=i(cf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),_$=p(ot),Vp=s(ot,"P",{});var P7=a(Vp);b$=i(P7,"Finally, this model supports inherent JAX features such as:"),P7.forEach(t),k$=p(ot),Ut=s(ot,"UL",{});var Os=a(Ut);Jp=s(Os,"LI",{});var A7=a(Jp);qi=s(A7,"A",{href:!0,rel:!0});var O7=a(qi);v$=i(O7,"Just-In-Time (JIT) compilation"),O7.forEach(t),A7.forEach(t),T$=p(Os),Kp=s(Os,"LI",{});var N7=a(Kp);Ci=s(N7,"A",{href:!0,rel:!0});var I7=a(Ci);y$=i(I7,"Automatic Differentiation"),I7.forEach(t),N7.forEach(t),w$=p(Os),Gp=s(Os,"LI",{});var D7=a(Gp);ji=s(D7,"A",{href:!0,rel:!0});var S7=a(ji);$$=i(S7,"Vectorization"),S7.forEach(t),D7.forEach(t),M$=p(Os),Yp=s(Os,"LI",{});var W7=a(Yp);Xi=s(W7,"A",{href:!0,rel:!0});var B7=a(Xi);F$=i(B7,"Parallelization"),B7.forEach(t),W7.forEach(t),Os.forEach(t),x$=p(ot),Pi=s(ot,"P",{});var pf=a(Pi);R$=i(pf,"This class overrides "),wd=s(pf,"A",{href:!0});var U7=a(wd);L$=i(U7,"FlaxRobertaForMultipleChoice"),U7.forEach(t),E$=i(pf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),pf.forEach(t),z$=p(ot),zt=s(ot,"DIV",{class:!0});var Ns=a(zt);y(Ai.$$.fragment,Ns),q$=p(Ns),Ho=s(Ns,"P",{});var Kd=a(Ho);C$=i(Kd,"The "),Zp=s(Kd,"CODE",{});var Q7=a(Zp);j$=i(Q7,"FlaxRobertaPreTrainedModel"),Q7.forEach(t),X$=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var H7=a(eh);P$=i(H7,"__call__"),H7.forEach(t),A$=i(Kd," special method."),Kd.forEach(t),O$=p(Ns),y(ks.$$.fragment,Ns),N$=p(Ns),y(vs.$$.fragment,Ns),Ns.forEach(t),ot.forEach(t),Im=p(o),Vo=s(o,"H2",{class:!0});var hf=a(Vo);Ts=s(hf,"A",{id:!0,class:!0,href:!0});var V7=a(Ts);th=s(V7,"SPAN",{});var J7=a(th);y(Oi.$$.fragment,J7),J7.forEach(t),V7.forEach(t),I$=p(hf),oh=s(hf,"SPAN",{});var K7=a(oh);D$=i(K7,"FlaxXLMRobertaForTokenClassification"),K7.forEach(t),hf.forEach(t),Dm=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ni.$$.fragment,nt),S$=p(nt),nh=s(nt,"P",{});var G7=a(nh);W$=i(G7,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),G7.forEach(t),B$=p(nt),Ii=s(nt,"P",{});var mf=a(Ii);U$=i(mf,"This model inherits from "),$d=s(mf,"A",{href:!0});var Y7=a($d);Q$=i(Y7,"FlaxPreTrainedModel"),Y7.forEach(t),H$=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mf.forEach(t),V$=p(nt),Di=s(nt,"P",{});var uf=a(Di);J$=i(uf,"This model is also a Flax Linen "),Si=s(uf,"A",{href:!0,rel:!0});var Z7=a(Si);K$=i(Z7,"flax.linen.Module"),Z7.forEach(t),G$=i(uf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
