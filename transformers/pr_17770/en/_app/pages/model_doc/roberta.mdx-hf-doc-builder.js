...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17770/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17770/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17770/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17770/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17770/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17770/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17770/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17770/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ut=a(Ue);y(fr.$$.fragment,ut),zk=h(ut),Mo=s(ut,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var GF=a(hd);Ck=i(GF,"RobertaForSequenceClassification"),GF.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var XF=a(Yc);Pk=i(XF,"__call__"),XF.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ut),y(Dn.$$.fragment,ut),Ok=h(ut),y(Sn.$$.fragment,ut),Nk=h(ut),y(Wn.$$.fragment,ut),Ik=h(ut),y(Bn.$$.fragment,ut),Dk=h(ut),y(Un.$$.fragment,ut),ut.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var iu=a(Eo);Hn=s(iu,"A",{id:!0,class:!0,href:!0});var YF=a(Hn);Zc=s(YF,"SPAN",{});var ZF=a(Zc);y(ur.$$.fragment,ZF),ZF.forEach(t),YF.forEach(t),Sk=h(iu),ep=s(iu,"SPAN",{});var e7=a(ep);Wk=i(e7,"RobertaForMultipleChoice"),e7.forEach(t),iu.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);y(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t7=a(tp);Uk=i(t7,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t7.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lu=a(_r);Qk=i(lu,"This model inherits from "),md=s(lu,"A",{href:!0});var o7=a(md);Jk=i(o7,"PreTrainedModel"),o7.forEach(t),Vk=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),Kk=h(ro),br=s(ro,"P",{});var du=a(br);Gk=i(du,"This model is also a PyTorch "),kr=s(du,"A",{href:!0,rel:!0});var n7=a(kr);Xk=i(n7,"torch.nn.Module"),n7.forEach(t),Yk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s7=a(fd);ov=i(s7,"RobertaForMultipleChoice"),s7.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a7=a(op);sv=i(a7,"__call__"),a7.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var r7=a(Vn);np=s(r7,"SPAN",{});var i7=a(np);y(Tr.$$.fragment,i7),i7.forEach(t),r7.forEach(t),lv=h(cu),sp=s(cu,"SPAN",{});var l7=a(sp);dv=i(l7,"RobertaForTokenClassification"),l7.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d7=a(ap);pv=i(d7,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d7.forEach(t),hv=h(io),wr=s(io,"P",{});var pu=a(wr);mv=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var c7=a(ud);fv=i(c7,"PreTrainedModel"),c7.forEach(t),uv=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),gv=h(io),$r=s(io,"P",{});var hu=a($r);_v=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var p7=a(Fr);bv=i(p7,"torch.nn.Module"),p7.forEach(t),kv=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h7=a(gd);wv=i(h7,"RobertaForTokenClassification"),h7.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var m7=a(rp);Fv=i(m7,"__call__"),m7.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f7=a(Yn);ip=s(f7,"SPAN",{});var u7=a(ip);y(Rr.$$.fragment,u7),u7.forEach(t),f7.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var g7=a(lp);qv=i(g7,"RobertaForQuestionAnswering"),g7.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _7=a(dp);Pv=i(_7,"span start logits"),_7.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b7=a(cp);Av=i(b7,"span end logits"),b7.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fu=a(Er);Iv=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k7=a(_d);Dv=i(k7,"PreTrainedModel"),k7.forEach(t),Sv=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wv=h(co),zr=s(co,"P",{});var uu=a(zr);Bv=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var v7=a(qr);Uv=i(v7,"torch.nn.Module"),v7.forEach(t),Hv=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T7=a(bd);Kv=i(T7,"RobertaForQuestionAnswering"),T7.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y7=a(pp);Xv=i(y7,"__call__"),y7.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w7=a(os);hp=s(w7,"SPAN",{});var $7=a(hp);y(jr.$$.fragment,$7),$7.forEach(t),w7.forEach(t),oT=h(gu),mp=s(gu,"SPAN",{});var F7=a(mp);nT=i(F7,"TFRobertaModel"),F7.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),fp=s(Ot,"P",{});var x7=a(fp);aT=i(x7,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x7.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iT=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R7=a(kd);lT=i(R7,"TFPreTrainedModel"),R7.forEach(t),dT=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);pT=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M7=a(Or);hT=i(M7,"tf.keras.Model"),M7.forEach(t),mT=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fT=h(Ot),y(ns.$$.fragment,Ot),uT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E7=a(vd);bT=i(E7,"TFRobertaModel"),E7.forEach(t),kT=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z7=a(up);vT=i(z7,"__call__"),z7.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var q7=a(rs);gp=s(q7,"SPAN",{});var C7=a(gp);y(Ir.$$.fragment,C7),C7.forEach(t),q7.forEach(t),$T=h(ku),_p=s(ku,"SPAN",{});var j7=a(_p);FT=i(j7,"TFRobertaForCausalLM"),j7.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),xT=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P7=a(Td);ET=i(P7,"TFRobertaForCausalLM"),P7.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L7=a(bp);qT=i(L7,"__call__"),L7.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var A7=a(ds);kp=s(A7,"SPAN",{});var O7=a(kp);y(Wr.$$.fragment,O7),O7.forEach(t),A7.forEach(t),LT=h(Tu),vp=s(Tu,"SPAN",{});var N7=a(vp);AT=i(N7,"TFRobertaForMaskedLM"),N7.forEach(t),Tu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);NT=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var I7=a(Tp);IT=i(I7,"language modeling"),I7.forEach(t),DT=i(yu," head on top."),yu.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);WT=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var D7=a(yd);BT=i(D7,"TFPreTrainedModel"),D7.forEach(t),UT=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);QT=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var S7=a(Jr);JT=i(S7,"tf.keras.Model"),S7.forEach(t),VT=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W7=a(wd);ZT=i(W7,"TFRobertaForMaskedLM"),W7.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B7=a(yp);ty=i(B7,"__call__"),B7.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U7=a(fs);wp=s(U7,"SPAN",{});var H7=a(wp);y(Kr.$$.fragment,H7),H7.forEach(t),U7.forEach(t),ry=h(Fu),$p=s(Fu,"SPAN",{});var Q7=a($p);iy=i(Q7,"TFRobertaForSequenceClassification"),Q7.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var J7=a(Fp);dy=i(J7,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J7.forEach(t),cy=h(It),Xr=s(It,"P",{});var xu=a(Xr);py=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var V7=a($d);hy=i(V7,"TFPreTrainedModel"),V7.forEach(t),my=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fy=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uy=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var K7=a(Zr);gy=i(K7,"tf.keras.Model"),K7.forEach(t),_y=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),by=h(It),y(us.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vy=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G7=a(Fd);yy=i(G7,"TFRobertaForSequenceClassification"),G7.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X7=a(xp);$y=i(X7,"__call__"),X7.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(mo),y(gs.$$.fragment,mo),Ry=h(mo),y(_s.$$.fragment,mo),My=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y7=a(ks);Rp=s(Y7,"SPAN",{});var Z7=a(Rp);y(ti.$$.fragment,Z7),Z7.forEach(t),Y7.forEach(t),Ey=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),Sy=h(Dt),y(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);Hy=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);Jy=i(ax,"__call__"),ax.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),y(Ts.$$.fragment,aa),Gy=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var rx=a(ws);qp=s(rx,"SPAN",{});var ix=a(qp);y(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),Xy=h(qu),Cp=s(qu,"SPAN",{});var lx=a(Cp);Yy=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var dx=a(jp);ew=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dw=h(St),y($s.$$.fragment,St),cw=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),pw=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hw=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);mw=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fw=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mx=a(Pp);uw=i(mx,"__call__"),mx.forEach(t),gw=i(tc," special method."),tc.forEach(t),_w=h(fo),y(Fs.$$.fragment,fo),bw=h(fo),y(xs.$$.fragment,fo),kw=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var ux=a(Lp);y(mi.$$.fragment,ux),ux.forEach(t),fx.forEach(t),vw=h(Pu),Ap=s(Pu,"SPAN",{});var gx=a(Ap);Tw=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yw=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);ww=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Aw=h(Wt),y(Es.$$.fragment,Wt),Ow=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Nw=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),qd=s(nc,"A",{href:!0});var Tx=a(qd);Dw=i(Tx,"TFRobertaForQuestionAnswering"),Tx.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yx=a(Ip);Ww=i(yx,"__call__"),yx.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(uo),y(zs.$$.fragment,uo),Hw=h(uo),y(qs.$$.fragment,uo),Qw=h(uo),y(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);y(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),Jw=h(Ou),Sp=s(Ou,"SPAN",{});var Fx=a(Sp);Vw=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);Gw=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),Xw=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yw=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var Rx=a(Cd);Zw=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),e1=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),t1=h(gt),yi=s(gt,"P",{});var Iu=a(yi);o1=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var Mx=a(wi);n1=i(Mx,"flax.linen.Module"),Mx.forEach(t),s1=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),a1=h(gt),Bp=s(gt,"P",{});var Ex=a(Bp);r1=i(Ex,"Finally, this model supports inherent JAX features such as:"),Ex.forEach(t),i1=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zx=a(Up);$i=s(zx,"A",{href:!0,rel:!0});var qx=a($i);l1=i(qx,"Just-In-Time (JIT) compilation"),qx.forEach(t),zx.forEach(t),d1=h(ra),Hp=s(ra,"LI",{});var Cx=a(Hp);Fi=s(Cx,"A",{href:!0,rel:!0});var jx=a(Fi);c1=i(jx,"Automatic Differentiation"),jx.forEach(t),Cx.forEach(t),p1=h(ra),Qp=s(ra,"LI",{});var Px=a(Qp);xi=s(Px,"A",{href:!0,rel:!0});var Lx=a(xi);h1=i(Lx,"Vectorization"),Lx.forEach(t),Px.forEach(t),m1=h(ra),Jp=s(ra,"LI",{});var Ax=a(Jp);Ri=s(Ax,"A",{href:!0,rel:!0});var Ox=a(Ri);f1=i(Ox,"Parallelization"),Ox.forEach(t),Ax.forEach(t),ra.forEach(t),u1=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),g1=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_1=i(sc,"The "),Vp=s(sc,"CODE",{});var Nx=a(Vp);b1=i(Nx,"FlaxRobertaPreTrainedModel"),Nx.forEach(t),k1=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var Ix=a(Kp);v1=i(Ix,"__call__"),Ix.forEach(t),T1=i(sc," special method."),sc.forEach(t),y1=h(ia),y(Ps.$$.fragment,ia),w1=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var Dx=a(As);Gp=s(Dx,"SPAN",{});var Sx=a(Gp);y(Ei.$$.fragment,Sx),Sx.forEach(t),Dx.forEach(t),$1=h(Du),Xp=s(Du,"SPAN",{});var Wx=a(Xp);F1=i(Wx,"FlaxRobertaForCausalLM"),Wx.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),x1=h(_t),Yp=s(_t,"P",{});var Bx=a(Yp);R1=i(Bx,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k0=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v0=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WR=a(cl);T0=i(WR,"flax.linen.Module"),WR.forEach(t),y0=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w0=h(vt),Eh=s(vt,"P",{});var BR=a(Eh);$0=i(BR,"Finally, this model supports inherent JAX features such as:"),BR.forEach(t),F0=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UR=a(zh);pl=s(UR,"A",{href:!0,rel:!0});var HR=a(pl);x0=i(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R0=h(fa),qh=s(fa,"LI",{});var QR=a(qh);hl=s(QR,"A",{href:!0,rel:!0});var JR=a(hl);M0=i(JR,"Automatic Differentiation"),JR.forEach(t),QR.forEach(t),E0=h(fa),Ch=s(fa,"LI",{});var VR=a(Ch);ml=s(VR,"A",{href:!0,rel:!0});var KR=a(ml);z0=i(KR,"Vectorization"),KR.forEach(t),VR.forEach(t),q0=h(fa),jh=s(fa,"LI",{});var GR=a(jh);fl=s(GR,"A",{href:!0,rel:!0});var XR=a(fl);C0=i(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),fa.forEach(t),j0=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P0=h(ua),ln=s(ua,"P",{});var lc=a(ln);L0=i(lc,"The "),Ph=s(lc,"CODE",{});var YR=a(Ph);A0=i(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O0=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZR=a(Lh);N0=i(ZR,"__call__"),ZR.forEach(t),I0=i(lc," special method."),lc.forEach(t),D0=h(ua),y(Qs.$$.fragment,ua),S0=h(ua),y(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Vs);Ah=s(eM,"SPAN",{});var tM=a(Ah);y(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W0=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B0=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U0=h(Tt),Nh=s(Tt,"P",{});var nM=a(Nh);H0=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
