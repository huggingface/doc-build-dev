...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17811/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17811/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17811/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17811/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17811/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bk=c(),at=n("div"),b(kr.$$.fragment),yk=c(),Po=n("p"),Ek=r("The "),Ld=n("a"),wk=r("ElectraForMaskedLM"),$k=r(" forward method, overrides the "),hp=n("code"),Fk=r("__call__"),xk=r(" special method."),Mk=c(),b(Sn.$$.fragment),zk=c(),b(Wn.$$.fragment),jk=c(),b(Un.$$.fragment),Uu=c(),Ao=n("h2"),Rn=n("a"),mp=n("span"),b(vr.$$.fragment),Ck=c(),up=n("span"),qk=r("ElectraForSequenceClassification"),Ru=c(),ot=n("div"),b(Tr.$$.fragment),Pk=c(),fp=n("p"),Ak=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_k=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);kk=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var Q0=a(_r);vk=i(Q0,"torch.nn.Module"),Q0.forEach(t),Tk=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),bk=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),yk=p(co),Po=s(co,"P",{});var gc=a(Po);Ek=i(gc,"The "),Ld=s(gc,"A",{href:!0});var B0=a(Ld);wk=i(B0,"ElectraForMaskedLM"),B0.forEach(t),$k=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V0=a(hp);Fk=i(V0,"__call__"),V0.forEach(t),xk=i(gc," special method."),gc.forEach(t),Mk=p(co),y(Sn.$$.fragment,co),zk=p(co),y(Wn.$$.fragment,co),jk=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Rf=a(Ao);Rn=s(Rf,"A",{id:!0,class:!0,href:!0});var K0=a(Rn);mp=s(K0,"SPAN",{});var J0=a(mp);y(vr.$$.fragment,J0),J0.forEach(t),K0.forEach(t),Ck=p(Rf),up=s(Rf,"SPAN",{});var G0=a(up);qk=i(G0,"ElectraForSequenceClassification"),G0.forEach(t),Rf.forEach(t),Ru=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),Pk=p(po),fp=s(po,"P",{});var X0=a(fp);Ak=i(X0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
