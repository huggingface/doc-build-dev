...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17811/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_mbart.py#L1448",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_mbart.py#L1727",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17811/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kk=p(),y(kn.$$.fragment),Zk=p(),Ce=a("div"),y(dr.$$.fragment),Yk=p(),po=a("p"),e1=i("The "),Ai=a("a"),t1=i("TFMBartForConditionalGeneration"),o1=i(" forward method, overrides the "),Ul=a("code"),n1=i("__call__"),a1=i(" special method."),s1=p(),y(yn.$$.fragment),r1=p(),y(vn.$$.fragment),i1=p(),y(Tn.$$.fragment),Qp=p(),uo=a("h2"),wn=a("a"),Xl=a("span"),y(lr.$$.fragment),d1=p(),Ql=a("span"),l1=i("FlaxMBartModel"),Hp=p(),W=a("div"),y(cr.$$.fragment),c1=p(),pr=a("p"),p1=i(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
example shows how to translate English to Romanian using the `),ld=s(To,"EM",{});var np=r(ld);Uh=d(np,"facebook/mbart-large-en-ro"),np.forEach(t),Xh=d(To," model."),To.forEach(t),ii.forEach(t),ep.forEach(t),pp=u(o),v(ka.$$.fragment,o),up=u(o),Nt=s(o,"H2",{class:!0});var di=r(Nt);Mo=s(di,"A",{id:!0,class:!0,href:!0});var ap=r(Mo);cd=s(ap,"SPAN",{});var sp=r(cd);v(ya.$$.fragment,sp),sp.forEach(t),ap.forEach(t),Qh=u(di),pd=s(di,"SPAN",{});var rp=r(pd);Hh=d(rp,"Overview of MBart-50"),rp.forEach(t),di.forEach(t),hp=u(o),yt=s(o,"P",{});var wo=r(yt);Vh=d(wo,"MBart-50 was introduced in the "),va=s(wo,"A",{href:!0,rel:!0});var Lv=r(va);Jh=d(Lv,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),Lv.forEach(t),Kh=d(wo,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),wo.forEach(t),mp=u(o),ui=s(o,"P",{});var Wv=r(ui);em=d(Wv,"According to the abstract"),Wv.forEach(t),fp=u(o),hi=s(o,"P",{});var Rv=r(hi);hd=s(Rv,"EM",{});var Uv=r(hd);tm=d(Uv,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),Uv.forEach(t),Rv.forEach(t),_p=u(o),Dt=s(o,"H3",{class:!0});var ou=r(Dt);$o=s(ou,"A",{id:!0,class:!0,href:!0});var Xv=r($o);md=s(Xv,"SPAN",{});var Qv=r(md);v(Ta.$$.fragment,Qv),Qv.forEach(t),Xv.forEach(t),om=u(ou),fd=s(ou,"SPAN",{});var Hv=r(fd);nm=d(Hv,"Training of MBart-50"),Hv.forEach(t),ou.forEach(t),gp=u(o),Ve=s(o,"P",{});var ea=r(Ve);am=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lh.forEach(t),Kk=u(qt),v(kn.$$.fragment,qt),Zk=u(qt),Ce=s(qt,"DIV",{class:!0});var Ft=r(Ce);v(dr.$$.fragment,Ft),Yk=u(Ft),po=s(Ft,"P",{});var Zi=r(po);e1=d(Zi,"The "),Ai=s(Zi,"A",{href:!0});var fM=r(Ai);t1=d(fM,"TFMBartForConditionalGeneration"),fM.forEach(t),o1=d(Zi," forward method, overrides the "),Ul=s(Zi,"CODE",{});var _M=r(Ul);n1=d(_M,"__call__"),_M.forEach(t),a1=d(Zi," special method."),Zi.forEach(t),s1=u(Ft),v(yn.$$.fragment,Ft),r1=u(Ft),v(vn.$$.fragment,Ft),i1=u(Ft),v(Tn.$$.fragment,Ft),Ft.forEach(t),qt.forEach(t),Qp=u(o),uo=s(o,"H2",{class:!0});var ch=r(uo);wn=s(ch,"A",{id:!0,class:!0,href:!0});var gM=r(wn);Xl=s(gM,"SPAN",{});var bM=r(Xl);v(lr.$$.fragment,bM),bM.forEach(t),gM.forEach(t),d1=u(ch),Ql=s(ch,"SPAN",{});var kM=r(Ql);l1=d(kM,"FlaxMBartModel"),kM.forEach(t),ch.forEach(t),Hp=u(o),W=s(o,"DIV",{class:!0});var pe=r(W);v(cr.$$.fragment,pe),c1=u(pe),pr=s(pe,"P",{});var ph=r(pr);p1=d(ph,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),uh.forEach(t),b1=u(pe),Hl=s(pe,"P",{});var TM=r(Hl);k1=d(TM,"Finally, this model supports inherent JAX features such as:"),TM.forEach(t),y1=u(pe),mt=s(pe,"UL",{});var la=r(mt);Vl=s(la,"LI",{});var wM=r(Vl);mr=s(wM,"A",{href:!0,rel:!0});var MM=r(mr);v1=d(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),wM.forEach(t),T1=u(la),Jl=s(la,"LI",{});var $M=r(Jl);fr=s($M,"A",{href:!0,rel:!0});var xM=r(fr);w1=d(xM,"Automatic Differentiation"),xM.forEach(t),$M.forEach(t),M1=u(la),Kl=s(la,"LI",{});var zM=r(Kl);_r=s(zM,"A",{href:!0,rel:!0});var qM=r(_r);$1=d(qM,"Vectorization"),qM.forEach(t),zM.forEach(t),x1=u(la),Zl=s(la,"LI",{});var FM=r(Zl);gr=s(FM,"A",{href:!0,rel:!0});var BM=r(gr);z1=d(BM,"Parallelization"),BM.forEach(t),FM.forEach(t),la.forEach(t),q1=u(pe),et=s(pe,"DIV",{class:!0});var ca=r(et);v(br.$$.fragment,ca),F1=u(ca),ho=s(ca,"P",{});var Yi=r(ho);B1=d(Yi,"The "),Yl=s(Yi,"CODE",{});var jM=r(Yl);j1=d(jM,"FlaxMBartPreTrainedModel"),jM.forEach(t),E1=d(Yi," forward method, overrides the "),ec=s(Yi,"CODE",{});var EM=r(ec);C1=d(EM,"__call__"),EM.forEach(t),P1=d(Yi," special method."),Yi.forEach(t),S1=u(ca),v(Mn.$$.fragment,ca),A1=u(ca),v($n.$$.fragment,ca),ca.forEach(t),O1=u(pe),xn=s(pe,"DIV",{class:!0});var hh=r(xn);v(kr.$$.fragment,hh),I1=u(hh),v(zn.$$.fragment,hh),hh.forEach(t),N1=u(pe),qn=s(pe,"DIV",{class:!0});var mh=r(qn);v(yr.$$.fragment,mh),D1=u(mh),v(Fn.$$.fragment,mh),mh.forEach(t),pe.forEach(t),Vp=u(o),mo=s(o,"H2",{class:!0});var fh=r(mo);Bn=s(fh,"A",{id:!0,class:!0,href:!0});var CM=r(Bn);tc=s(CM,"SPAN",{});var PM=r(tc);v(vr.$$.fragment,PM),PM.forEach(t),CM.forEach(t),L1=u(fh),oc=s(fh,"SPAN",{});var SM=r(oc);G1=d(SM,"FlaxMBartForConditionalGeneration"),SM.forEach(t),fh.forEach(t),Jp=u(o),R=s(o,"DIV",{class:!0});var ue=r(R);v(Tr.$$.fragment,ue),W1=u(ue),wr=s(ue,"P",{});var _h=r(wr);R1=d(_h,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ii=s(_h,"A",{href:!0});var AM=r(Ii);U1=d(AM,"FlaxPreTrainedModel"),AM.forEach(t),X1=d(_h,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
