...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17811/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_17811/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17811/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L1255",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L1466",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L1568",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_mobilebert.py#L1358",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17811/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
splitting and wordpiece.`),Sd.forEach(t),uh=m(Bt),us=a(Bt,"P",{});var Mc=i(us);fh=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var j1=i(Pa);gh=s(j1,"BertTokenizerFast"),j1.forEach(t),_h=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=m(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var C1=i(Ao);Ii=a(C1,"SPAN",{});var N1=i(Ii);y(fs.$$.fragment,N1),N1.forEach(t),C1.forEach(t),bh=m($c),Li=a($c,"SPAN",{});var O1=i(Li);Th=s(O1,"MobileBert specific outputs"),O1.forEach(t),$c.forEach(t),Rd=m(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),kh=m(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vh=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var S1=i(qa);yh=s(S1,"MobileBertForPreTraining"),S1.forEach(t),wh=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=m(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mh=m(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$h=s(xc,"Output type of "),ja=a(xc,"A",{href:!0});var A1=i(ja);Fh=s(A1,"TFMobileBertForPreTraining"),A1.forEach(t),Bh=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=m(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var I1=i(Io);Di=a(I1,"SPAN",{});var L1=i(Di);y(ks.$$.fragment,L1),L1.forEach(t),I1.forEach(t),Eh=m(zc),Wi=a(zc,"SPAN",{});var D1=i(Wi);xh=s(D1,"MobileBertModel"),D1.forEach(t),zc.forEach(t),Qd=m(o),Ce=a(o,"DIV",{class:!0});var ft=i(Ce);y(vs.$$.fragment,ft),zh=m(ft),Ri=a(ft,"P",{});var W1=i(Ri);Ph=s(W1,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),W1.forEach(t),qh=m(ft),ys=a(ft,"P",{});var Pc=i(ys);jh=s(Pc,"This model inherits from "),Ca=a(Pc,"A",{href:!0});var R1=i(Ca);Ch=s(R1,"PreTrainedModel"),R1.forEach(t),Nh=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=m(qt),je=a(qt,"DIV",{class:!0});var nt=i(je);y(Zs.$$.fragment,nt),Eu=m(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var FT=i(Ra);zu=s(FT,"MobileBertForSequenceClassification"),FT.forEach(t),Pu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var BT=i(ll);qu=s(BT,"__call__"),BT.forEach(t),ju=s(_i," special method."),_i.forEach(t),Cu=m(nt),y(Xo.$$.fragment,nt),Nu=m(nt),y(en.$$.fragment,nt),Ou=m(nt),y(tn.$$.fragment,nt),Su=m(nt),y(on.$$.fragment,nt),Au=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var ET=i(sn);dl=a(ET,"SPAN",{});var xT=i(dl);y(Xs.$$.fragment,xT),xT.forEach(t),ET.forEach(t),Iu=m(Kc),cl=a(Kc,"SPAN",{});var zT=i(cl);Lu=s(zT,"MobileBertForMultipleChoice"),zT.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var jt=i(Ke);y(er.$$.fragment,jt),Du=m(jt),pl=a(jt,"P",{});var PT=i(pl);Wu=s(PT,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),PT.forEach(t),Ru=m(jt),tr=a(jt,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qT=i(Ua);Hu=s(qT,"PreTrainedModel"),qT.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Ku=m(jt),or=a(jt,"P",{});var Gc=i(or);Vu=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var jT=i(nr);Gu=s(jT,"torch.nn.Module"),jT.forEach(t),Yu=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Ju=m(jt),ct=a(jt,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Zu=m(os),ao=a(os,"P",{});var bi=i(ao);Xu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var CT=i(Ha);ef=s(CT,"MobileBertForMultipleChoice"),CT.forEach(t),tf=s(bi," forward method, overrides the "),hl=a(bi,"CODE",{});var NT=i(hl);of=s(NT,"__call__"),NT.forEach(t),nf=s(bi," special method."),bi.forEach(t),sf=m(os),y(rn.$$.fragment,os),rf=m(os),y(an.$$.fragment,os),os.forEach(t),jt.forEach(t),nc=m(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var OT=i(ln);ml=a(OT,"SPAN",{});var ST=i(ml);y(rr.$$.fragment,ST),ST.forEach(t),OT.forEach(t),af=m(Yc),ul=a(Yc,"SPAN",{});var AT=i(ul);lf=s(AT,"MobileBertForTokenClassification"),AT.forEach(t),Yc.forEach(t),sc=m(o),Ve=a(o,"DIV",{class:!0});var Ct=i(Ve);y(ar.$$.fragment,Ct),df=m(Ct),fl=a(Ct,"P",{});var IT=i(fl);cf=s(IT,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),IT.forEach(t),pf=m(Ct),ir=a(Ct,"P",{});var Jc=i(ir);hf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var LT=i(Qa);mf=s(LT,"PreTrainedModel"),LT.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=m(Ct),lr=a(Ct,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var DT=i(dr);_f=s(DT,"torch.nn.Module"),DT.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=m(Ct),Je=a(Ct,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),kf=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var WT=i(Ka);yf=s(WT,"MobileBertForTokenClassification"),WT.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var RT=i(gl);Mf=s(RT,"__call__"),RT.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=m(Nt),y(dn.$$.fragment,Nt),Bf=m(Nt),y(cn.$$.fragment,Nt),Ef=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),Ct.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var UT=i(hn);_l=a(UT,"SPAN",{});var HT=i(_l);y(pr.$$.fragment,HT),HT.forEach(t),UT.forEach(t),xf=m(Xc),bl=a(Xc,"SPAN",{});var QT=i(bl);zf=s(QT,"MobileBertForQuestionAnswering"),QT.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pf=m(Ot),po=a(Ot,"P",{});var ki=i(po);qf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var KT=i(Tl);jf=s(KT,"span start logits"),KT.forEach(t),Cf=s(ki," and "),kl=a(ki,"CODE",{});var VT=i(kl);Nf=s(VT,"span end logits"),VT.forEach(t),Of=s(ki,")."),ki.forEach(t),Sf=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Af=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var GT=i(Va);If=s(GT,"PreTrainedModel"),GT.forEach(t),Lf=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
