...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17811/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17811/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),n1=p(),T(zo.$$.fragment),r1=p(),Ye=o("div"),T(Hr.$$.fragment),a1=p(),$s=o("p"),i1=a("The "),Zi=o("a"),l1=a("TFDistilBertForSequenceClassification"),d1=a(" forward method, overrides the "),wd=o("code"),c1=a("__call__"),p1=a(" special method."),h1=p(),T(jo.$$.fragment),u1=p(),T(Co.$$.fragment),f1=p(),T(qo.$$.fragment),Zp=p(),ws=o("h2"),Po=o("a"),yd=o("span"),T(Kr.$$.fragment),m1=p(),Dd=o("span"),g1=a("TFDistilBertForMultipleChoice"),eh=p(),Le=o("div"),T(Vr.$$.fragment),_1=p(),Fd=o("p"),b1=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),w1=p(),Gr=o("p"),y1=a("This model is also a "),Xr=o("a"),D1=a("tf.keras.Model"),F1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),B1=p(),T(Ao.$$.fragment),x1=p(),mt=o("div"),T(Yr.$$.fragment),M1=p(),ys=o("p"),E1=a("The "),tl=o("a"),z1=a("TFDistilBertForMultipleChoice"),j1=a(" forward method, overrides the "),Bd=o("code"),C1=a("__call__"),q1=a(" special method."),P1=p(),T(Oo.$$.fragment),A1=p(),T(No.$$.fragment),th=p(),Ds=o("h2"),Lo=o("a"),xd=o("span"),T(Zr.$$.fragment),O1=p(),Md=o("span"),N1=a("TFDistilBertForTokenClassification"),sh=p(),Se=o("div"),T(ea.$$.fragment),L1=p(),Ed=o("p"),S1=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),J1=p(),T(So.$$.fragment),G1=p(),Ze=o("div"),T(na.$$.fragment),X1=p(),Fs=o("p"),Y1=a("The "),ol=o("a"),Z1=a("TFDistilBertForTokenClassification"),eb=a(" forward method, overrides the "),zd=o("code"),tb=a("__call__"),sb=a(" special method."),ob=p(),T(Io.$$.fragment),nb=p(),T(Wo.$$.fragment),rb=p(),T(Qo.$$.fragment),oh=p(),Bs=o("h2"),Ro=o("a"),jd=o("span"),T(ra.$$.fragment),ab=p(),Cd=o("span"),ib=a("TFDistilBertForQuestionAnswering"),nh=p(),Ie=o("div"),T(aa.$$.fragment),lb=p(),xs=o("p"),db=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$b=p(),T(Uo.$$.fragment),wb=p(),et=o("div"),T(ca.$$.fragment),yb=p(),Ms=o("p"),Db=a("The "),rl=o("a"),Fb=a("TFDistilBertForQuestionAnswering"),Bb=a(" forward method, overrides the "),Ad=o("code"),xb=a("__call__"),Mb=a(" special method."),Eb=p(),T(Ho.$$.fragment),zb=p(),T(Ko.$$.fragment),jb=p(),T(Vo.$$.fragment),rh=p(),Es=o("h2"),Jo=o("a"),Od=o("span"),T(pa.$$.fragment),Cb=p(),Nd=o("span"),qb=a("FlaxDistilBertModel"),ah=p(),Me=o("div"),T(ha.$$.fragment),Pb=p(),Ld=o("p"),Ab=a("The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),Ob=p(),ua=o("p"),Nb=a("This model inherits from "),al=o("a"),Lb=a("FlaxPreTrainedModel"),Sb=a(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),B1=h(Dt),$(Ao.$$.fragment,Dt),x1=h(Dt),mt=n(Dt,"DIV",{class:!0});var vn=r(mt);$(Yr.$$.fragment,vn),M1=h(vn),ys=n(vn,"P",{});var $l=r(ys);E1=i($l,"The "),tl=n($l,"A",{href:!0});var Lw=r(tl);z1=i(Lw,"TFDistilBertForMultipleChoice"),Lw.forEach(t),j1=i($l," forward method, overrides the "),Bd=n($l,"CODE",{});var Sw=r(Bd);C1=i(Sw,"__call__"),Sw.forEach(t),q1=i($l," special method."),$l.forEach(t),P1=h(vn),$(Oo.$$.fragment,vn),A1=h(vn),$(No.$$.fragment,vn),vn.forEach(t),Dt.forEach(t),th=h(s),Ds=n(s,"H2",{class:!0});var Yh=r(Ds);Lo=n(Yh,"A",{id:!0,class:!0,href:!0});var Iw=r(Lo);xd=n(Iw,"SPAN",{});var Ww=r(xd);$(Zr.$$.fragment,Ww),Ww.forEach(t),Iw.forEach(t),O1=h(Yh),Md=n(Yh,"SPAN",{});var Qw=r(Md);N1=i(Qw,"TFDistilBertForTokenClassification"),Qw.forEach(t),Yh.forEach(t),sh=h(s),Se=n(s,"DIV",{class:!0});var Ft=r(Se);$(ea.$$.fragment,Ft),L1=h(Ft),Ed=n(Ft,"P",{});var Rw=r(Ed);S1=i(Rw,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Rw.forEach(t),I1=h(Ft),ta=n(Ft,"P",{});var Zh=r(ta);W1=i(Zh,"This model inherits from "),sl=n(Zh,"A",{href:!0});var Uw=r(sl);Q1=i(Uw,"TFPreTrainedModel"),Uw.forEach(t),R1=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),U1=h(Ft),sa=n(Ft,"P",{});var eu=r(sa);H1=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var Hw=r(oa);K1=i(Hw,"tf.keras.Model"),Hw.forEach(t),V1=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),J1=h(Ft),$(So.$$.fragment,Ft),G1=h(Ft),Ze=n(Ft,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),X1=h(Yt),Fs=n(Yt,"P",{});var wl=r(Fs);Y1=i(wl,"The "),ol=n(wl,"A",{href:!0});var Kw=r(ol);Z1=i(Kw,"TFDistilBertForTokenClassification"),Kw.forEach(t),eb=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Vw=r(zd);tb=i(Vw,"__call__"),Vw.forEach(t),sb=i(wl," special method."),wl.forEach(t),ob=h(Yt),$(Io.$$.fragment,Yt),nb=h(Yt),$(Wo.$$.fragment,Yt),rb=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Ft.forEach(t),oh=h(s),Bs=n(s,"H2",{class:!0});var tu=r(Bs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Ro);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),ab=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);ib=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var Bt=r(Ie);$(aa.$$.fragment,Bt),lb=h(Bt),xs=n(Bt,"P",{});var yl=r(xs);db=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);cb=i(Yw,"span start logits"),Yw.forEach(t),pb=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);hb=i(Zw,"span end logits"),Zw.forEach(t),ub=i(yl,")."),yl.forEach(t),fb=h(Bt),ia=n(Bt,"P",{});var su=r(ia);mb=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var ey=r(nl);gb=i(ey,"TFPreTrainedModel"),ey.forEach(t),_b=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bb=h(Bt),la=n(Bt,"P",{});var ou=r(la);vb=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var ty=r(da);kb=i(ty,"tf.keras.Model"),ty.forEach(t),Tb=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$b=h(Bt),$(Uo.$$.fragment,Bt),wb=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yb=h(Zt),Ms=n(Zt,"P",{});var Dl=r(Ms);Db=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var sy=r(rl);Fb=i(sy,"TFDistilBertForQuestionAnswering"),sy.forEach(t),Bb=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var oy=r(Ad);xb=i(oy,"__call__"),oy.forEach(t),Mb=i(Dl," special method."),Dl.forEach(t),Eb=h(Zt),$(Ho.$$.fragment,Zt),zb=h(Zt),$(Ko.$$.fragment,Zt),jb=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var ny=r(Jo);Od=n(ny,"SPAN",{});var ry=r(Od);$(pa.$$.fragment,ry),ry.forEach(t),ny.forEach(t),Cb=h(nu),Nd=n(nu,"SPAN",{});var ay=r(Nd);qb=i(ay,"FlaxDistilBertModel"),ay.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pb=h(st),Ld=n(st,"P",{});var iy=r(Ld);Ab=i(iy,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iy.forEach(t),Ob=h(st),ua=n(st,"P",{});var ru=r(ua);Nb=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var ly=r(al);Lb=i(ly,"FlaxPreTrainedModel"),ly.forEach(t),Sb=i(ru,`. Check the superclass documentation for the generic methods the
