import{S as rc,i as ac,s as sc,e as r,k as c,w as u,t,M as dc,c as a,d as o,m as l,a as s,x as g,h as n,b as i,F as e,g as w,y as _,q as v,o as b,B as T}from"../../chunks/vendor-6b77c823.js";import{T as Vd}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-abef54e3.js";import{C as yo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Yt}from"../../chunks/IconCopyLink-7a11ce68.js";function ic(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16215/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16215/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16215/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_16215/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_16215/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
example is <code>google/vit-base-patch16-224-in21k</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16215/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_16215/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
:meth`),_t=r("em"),ha=t("~transformers.AutoModelForCausalLM.from_pretrained"),ma=t(" class method for the decoder."),fa=c(),A=r("div"),u(Oe.$$.fragment),ua=c(),re=r("p"),ga=t("The "),Oo=r("a"),_a=t("VisionEncoderDecoderModel"),va=t(" forward method, overrides the "),vt=r("code"),ba=t("__call__"),Ta=t(" special method."),wa=c(),u(ve.$$.fragment),ya=c(),bt=r("p"),Ea=t("Examples:"),ka=c(),u(Re.$$.fragment),xa=c(),S=r("div"),u(Be.$$.fragment),ja=c(),Tt=r("p"),Da=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),yt=r("code"),za=t("model.train()"),Pa=t("."),Fa=c(),Et=r("p"),Ca=t("Example:"),Aa=c(),u(Ge.$$.fragment),nn=c(),se=r("h2"),be=r("a"),kt=r("span"),u(We.$$.fragment),Sa=c(),xt=r("span"),Ia=t("TFVisionEncoderDecoderModel"),rn=c(),k=r("div"),u(Ue.$$.fragment),La=c(),de=r("p"),Na=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
checkpoints.`),Ii.forEach(o),$s=l(Ee),Ft=a(Ee,"P",{});var Li=s(Ft);qs=n(Li,"Example:"),Li.forEach(o),zs=l(Ee),g(no.$$.fragment,Ee),Ee.forEach(o),$.forEach(o),an=l(d),ce=a(d,"H2",{class:!0});var kn=s(ce);we=a(kn,"A",{id:!0,class:!0,href:!0});var Ni=s(we);Ct=a(Ni,"SPAN",{});var Oi=s(Ct);g(ro.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),Ps=l(kn),At=a(kn,"SPAN",{});var Ri=s(At);Fs=n(Ri,"FlaxVisionEncoderDecoderModel"),Ri.forEach(o),kn.forEach(o),sn=l(d),x=a(d,"DIV",{class:!0});var q=s(x);g(ao.$$.fragment,q),Cs=l(q),le=a(q,"P",{});var tt=s(le);As=n(tt,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
