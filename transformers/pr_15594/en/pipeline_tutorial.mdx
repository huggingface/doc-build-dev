...
* Use a [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) for inference.
* Use a specific tokenizer or model.
* Use a [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) for audio and vision tasks.

<Tip>

Take a look at the [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) documentation for a complete list of supported taska.
...
1. Start by creating a [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) and specify an inference task:
...
2. Pass your input text to the [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline):
...
Create a [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) for your task, and specify the model and tokenizer you've loaded:
...
Pass your input text to the [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) to generate some text:
...
The flexibility of the [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) means it can also be extended to audio tasks.
...
Pass the audio file to the [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline):
...
Finally, using a [pipeline()](/docs/transformers/pr_15594/en/main_classes/pipelines#transformers.pipeline) for vision tasks is practically identical.
