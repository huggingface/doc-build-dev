...
One can use [T5ForConditionalGeneration](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5ForConditionalGeneration) (or the Tensorflow/Flax variant), which includes the
...
- Unsupervised denoising training
  ...
  [T5Tokenizer](/docs/transformers/pr_15382/en/model_doc/mt5#transformers.T5Tokenizer).
...
At inference time, it is recommended to use [generate()](/docs/transformers/pr_15382/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate). This
...
[generate()](/docs/transformers/pr_15382/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate), make sure you start it with the `pad_token_id`.
...
This is the configuration class to store the configuration of a [T5Model](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5Model) or a [TFT5Model](/docs/transformers/pr_15382/en/model_doc/t5#transformers.TFT5Model). It is used to
...
<docstring><name>forward</name><anchor>transformers.T5Model.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15382/src/transformers/models/t5/modeling_t5.py#L1321</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "decoder_input_ids", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "decoder_head_mask", "val": " = None"}, {"name": "cross_attn_head_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [T5Tokenizer](/docs/transformers/pr_15382/en/model_doc/mt5#transformers.T5Tokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/pr_15382/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and
  [PreTrainedTokenizer.__call__()](/docs/transformers/pr_15382/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for detail.
...
elements depending on the configuration ([T5Config](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5Config)) and inputs.
...
The [T5Model](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5Model) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>deparallelize</name><anchor>transformers.T5Model.deparallelize</anchor><source>https://github.com/huggingface/transformers/blob/pr_15382/src/transformers/models/t5/modeling_t5.py#L1289</source><parameters>[]</parameters></docstring>
...
- **encoder_attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [T5ForConditionalGeneration](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>deparallelize</name><anchor>transformers.T5ForConditionalGeneration.deparallelize</anchor><source>https://github.com/huggingface/transformers/blob/pr_15382/src/transformers/models/t5/modeling_t5.py#L1484</source><parameters>[]</parameters></docstring>
...
The [T5EncoderModel](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>deparallelize</name><anchor>transformers.T5EncoderModel.deparallelize</anchor><source>https://github.com/huggingface/transformers/blob/pr_15382/src/transformers/models/t5/modeling_t5.py#L1760</source><parameters>[]</parameters></docstring>
...
configuration ([T5Config](/docs/transformers/pr_15382/en/model_doc/t5#transformers.T5Config)) and inputs.
...
- **encoder_attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [TFT5Model](/docs/transformers/pr_15382/en/model_doc/t5#transformers.TFT5Model) forward method, overrides the `__call__` special method.
...
- **encoder_attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [TFT5ForConditionalGeneration](/docs/transformers/pr_15382/en/model_doc/t5#transformers.TFT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
<docstring><name>call</name><anchor>transformers.TFT5EncoderModel.call</anchor><source>https://github.com/huggingface/transformers/blob/pr_15382/src/transformers/models/t5/modeling_tf_t5.py#L1618</source><parameters>[{"name": "input_ids", "val": ""}, {"name": "attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}, {"name": "training", "val": " = False"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **inputs** (`tf.Tensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [T5Tokenizer](/docs/transformers/pr_15382/en/model_doc/mt5#transformers.T5Tokenizer). See [PreTrainedTokenizer.__call__()](/docs/transformers/pr_15382/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) and
  [PreTrainedTokenizer.encode()](/docs/transformers/pr_15382/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) for details.
...
- **attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TFT5EncoderModel](/docs/transformers/pr_15382/en/model_doc/t5#transformers.TFT5EncoderModel) forward method, overrides the `__call__` special method.
...
- **output_hidden_states** (`bool`, *optional*) --
  ...
  more detail.
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/pr_15382/en/main_classes/output#transformers.file_utils.ModelOutput) instead of a plain tuple.</paramsdesc><paramgroups>0</paramgroups><rettype>[transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions](/docs/transformers/pr_15382/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions) or `tuple(torch.FloatTensor)`</rettype><retdesc>A [transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions](/docs/transformers/pr_15382/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`&amp;lt;class 'transformers.models.t5.configuration_t5.T5Config'>`) and inputs.
...
- **output_hidden_states** (`bool`, *optional*) --
  ...
  more detail.
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/pr_15382/en/main_classes/output#transformers.file_utils.ModelOutput) instead of a plain tuple.</paramsdesc><paramgroups>0</paramgroups><rettype>[transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions](/docs/transformers/pr_15382/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions) or `tuple(torch.FloatTensor)`</rettype><retdesc>A [transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions](/docs/transformers/pr_15382/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`&amp;lt;class 'transformers.models.t5.configuration_t5.T5Config'>`) and inputs.
