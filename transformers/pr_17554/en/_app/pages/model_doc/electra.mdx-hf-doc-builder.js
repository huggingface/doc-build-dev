...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17554/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17554/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17554/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17554/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17554/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17554/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Qs=new ye({props:{$$slots:{default:[uj]},$$scope:{ctx:x}}}),Bs=new ie({props:{anchor:"transformers.FlaxElectraForCausalLM.__call__.example",$$slots:{default:[fj]},$$scope:{ctx:x}}}),il=new we({}),ll=new I({props:{name:"class transformers.FlaxElectraForMaskedLM",anchor:"transformers.FlaxElectraForMaskedLM",parameters:[{name:"config",val:": ElectraConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17554/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),bv=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),yv=p(co),Po=s(co,"P",{});var gc=a(Po);Ev=i(gc,"The "),Ld=s(gc,"A",{href:!0});var B0=a(Ld);wv=i(B0,"ElectraForMaskedLM"),B0.forEach(t),$v=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V0=a(hp);Fv=i(V0,"__call__"),V0.forEach(t),xv=i(gc," special method."),gc.forEach(t),Mv=p(co),y(Sn.$$.fragment,co),zv=p(co),y(Wn.$$.fragment,co),jv=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Rf=a(Ao);Rn=s(Rf,"A",{id:!0,class:!0,href:!0});var K0=a(Rn);mp=s(K0,"SPAN",{});var J0=a(mp);y(vr.$$.fragment,J0),J0.forEach(t),K0.forEach(t),Cv=p(Rf),up=s(Rf,"SPAN",{});var G0=a(up);qv=i(G0,"ElectraForSequenceClassification"),G0.forEach(t),Rf.forEach(t),Ru=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),Pv=p(po),fp=s(po,"P",{});var X0=a(fp);Av=i(X0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qf.forEach(t),Rv=p(po),He=s(po,"DIV",{class:!0});var ht=a(He);y(wr.$$.fragment,ht),Hv=p(ht),Oo=s(ht,"P",{});var _c=a(Oo);Qv=i(_c,"The "),Id=s(_c,"A",{href:!0});var e5=a(Id);Bv=i(e5,"ElectraForSequenceClassification"),e5.forEach(t),Vv=i(_c," forward method, overrides the "),gp=s(_c,"CODE",{});var t5=a(gp);Kv=i(t5,"__call__"),t5.forEach(t),Jv=i(_c," special method."),_c.forEach(t),Gv=p(ht),y(Hn.$$.fragment,ht),Xv=p(ht),y(Qn.$$.fragment,ht),Yv=p(ht),y(Bn.$$.fragment,ht),Zv=p(ht),y(Vn.$$.fragment,ht),eT=p(ht),y(Kn.$$.fragment,ht),ht.forEach(t),po.forEach(t),Hu=p(o),Lo=s(o,"H2",{class:!0});var Bf=a(Lo);Jn=s(Bf,"A",{id:!0,class:!0,href:!0});var o5=a(Jn);_p=s(o5,"SPAN",{});var n5=a(_p);y($r.$$.fragment,n5),n5.forEach(t),o5.forEach(t),tT=p(Bf),kp=s(Bf,"SPAN",{});var s5=a(kp);oT=i(s5,"ElectraForMultipleChoice"),s5.forEach(t),Bf.forEach(t),Qu=p(o),nt=s(o,"DIV",{class:!0});var ho=a(nt);y(Fr.$$.fragment,ho),nT=p(ho),vp=s(ho,"P",{});var a5=a(vp);sT=i(a5,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg.forEach(t),lb=p(uo),it=s(uo,"DIV",{class:!0});var fo=a(it);y(Ur.$$.fragment,fo),db=p(fo),Uo=s(fo,"P",{});var bc=a(Uo);cb=i(bc,"The "),Hd=s(bc,"A",{href:!0});var F5=a(Hd);pb=i(F5,"ElectraForQuestionAnswering"),F5.forEach(t),hb=i(bc," forward method, overrides the "),jp=s(bc,"CODE",{});var x5=a(jp);mb=i(x5,"__call__"),x5.forEach(t),ub=i(bc," special method."),bc.forEach(t),fb=p(fo),y(ns.$$.fragment,fo),gb=p(fo),y(ss.$$.fragment,fo),_b=p(fo),y(as.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Gu=p(o),Ro=s(o,"H2",{class:!0});var tg=a(Ro);rs=s(tg,"A",{id:!0,class:!0,href:!0});var M5=a(rs);Cp=s(M5,"SPAN",{});var z5=a(Cp);y(Rr.$$.fragment,z5),z5.forEach(t),M5.forEach(t),kb=p(tg),qp=s(tg,"SPAN",{});var j5=a(qp);vb=i(j5,"TFElectraModel"),j5.forEach(t),tg.forEach(t),Xu=p(o),Ke=s(o,"DIV",{class:!0});var Rt=a(Ke);y(Hr.$$.fragment,Rt),Tb=p(Rt),Pp=s(Rt,"P",{});var C5=a(Pp);bb=i(C5,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),C5.forEach(t),yb=p(Rt),Qr=s(Rt,"P",{});var og=a(Qr);Eb=i(og,"This model inherits from "),Qd=s(og,"A",{href:!0});var q5=a(Qd);wb=i(q5,"TFPreTrainedModel"),q5.forEach(t),$b=i(og,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),og.forEach(t),Fb=p(Rt),Br=s(Rt,"P",{});var ng=a(Br);xb=i(ng,"This model is also a "),Vr=s(ng,"A",{href:!0,rel:!0});var P5=a(Vr);Mb=i(P5,"tf.keras.Model"),P5.forEach(t),zb=i(ng,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ng.forEach(t),jb=p(Rt),y(is.$$.fragment,Rt),Cb=p(Rt),zt=s(Rt,"DIV",{class:!0});var ua=a(zt);y(Kr.$$.fragment,ua),qb=p(ua),Ho=s(ua,"P",{});var yc=a(Ho);Pb=i(yc,"The "),Bd=s(yc,"A",{href:!0});var A5=a(Bd);Ab=i(A5,"TFElectraModel"),A5.forEach(t),Ob=i(yc," forward method, overrides the "),Ap=s(yc,"CODE",{});var O5=a(Ap);Lb=i(O5,"__call__"),O5.forEach(t),Nb=i(yc," special method."),yc.forEach(t),Ib=p(ua),y(ls.$$.fragment,ua),Db=p(ua),y(ds.$$.fragment,ua),ua.forEach(t),Rt.forEach(t),Yu=p(o),Qo=s(o,"H2",{class:!0});var sg=a(Qo);cs=s(sg,"A",{id:!0,class:!0,href:!0});var L5=a(cs);Op=s(L5,"SPAN",{});var N5=a(Op);y(Jr.$$.fragment,N5),N5.forEach(t),L5.forEach(t),Sb=p(sg),Lp=s(sg,"SPAN",{});var I5=a(Lp);Wb=i(I5,"TFElectraForPreTraining"),I5.forEach(t),sg.forEach(t),Zu=p(o),Oe=s(o,"DIV",{class:!0});var mt=a(Oe);y(Gr.$$.fragment,mt),Ub=p(mt),Np=s(mt,"P",{});var D5=a(Np);Rb=i(D5,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),D5.forEach(t),Hb=p(mt),Ip=s(mt,"P",{});var S5=a(Ip);Qb=i(S5,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),S5.forEach(t),Bb=p(mt),Xr=s(mt,"P",{});var ag=a(Xr);Vb=i(ag,"This model inherits from "),Vd=s(ag,"A",{href:!0});var W5=a(Vd);Kb=i(W5,"TFPreTrainedModel"),W5.forEach(t),Jb=i(ag,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rg.forEach(t),ey=p(mt),y(ps.$$.fragment,mt),ty=p(mt),jt=s(mt,"DIV",{class:!0});var fa=a(jt);y(ei.$$.fragment,fa),oy=p(fa),Bo=s(fa,"P",{});var Ec=a(Bo);ny=i(Ec,"The "),Kd=s(Ec,"A",{href:!0});var R5=a(Kd);sy=i(R5,"TFElectraForPreTraining"),R5.forEach(t),ay=i(Ec," forward method, overrides the "),Dp=s(Ec,"CODE",{});var H5=a(Dp);ry=i(H5,"__call__"),H5.forEach(t),iy=i(Ec," special method."),Ec.forEach(t),ly=p(fa),y(hs.$$.fragment,fa),dy=p(fa),y(ms.$$.fragment,fa),fa.forEach(t),mt.forEach(t),ef=p(o),Vo=s(o,"H2",{class:!0});var ig=a(Vo);us=s(ig,"A",{id:!0,class:!0,href:!0});var Q5=a(us);Sp=s(Q5,"SPAN",{});var B5=a(Sp);y(ti.$$.fragment,B5),B5.forEach(t),Q5.forEach(t),cy=p(ig),Wp=s(ig,"SPAN",{});var V5=a(Wp);py=i(V5,"TFElectraForMaskedLM"),V5.forEach(t),ig.forEach(t),tf=p(o),Le=s(o,"DIV",{class:!0});var ut=a(Le);y(oi.$$.fragment,ut),hy=p(ut),Up=s(ut,"P",{});var K5=a(Up);my=i(K5,"Electra model with a language modeling head on top."),K5.forEach(t),uy=p(ut),Rp=s(ut,"P",{});var J5=a(Rp);fy=i(J5,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
`),tl=s(jg,"A",{href:!0,rel:!0});var T4=a(tl);Hw=i(T4,"flax.nn.Module"),T4.forEach(t),Qw=i(jg,` subclass. Use it as a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$$=p(kt),Rh=s(kt,"P",{});var I4=a(Rh);F$=i(I4,"Finally, this model supports inherent JAX features such as:"),I4.forEach(t),x$=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var D4=a(Hh);ml=s(D4,"A",{href:!0,rel:!0});var S4=a(ml);M$=i(S4,"Just-In-Time (JIT) compilation"),S4.forEach(t),D4.forEach(t),z$=p(Ea),Qh=s(Ea,"LI",{});var W4=a(Qh);ul=s(W4,"A",{href:!0,rel:!0});var U4=a(ul);j$=i(U4,"Automatic Differentiation"),U4.forEach(t),W4.forEach(t),C$=p(Ea),Bh=s(Ea,"LI",{});var R4=a(Bh);fl=s(R4,"A",{href:!0,rel:!0});var H4=a(fl);q$=i(H4,"Vectorization"),H4.forEach(t),R4.forEach(t),P$=p(Ea),Vh=s(Ea,"LI",{});var Q4=a(Vh);gl=s(Q4,"A",{href:!0,rel:!0});var B4=a(gl);A$=i(B4,"Parallelization"),B4.forEach(t),Q4.forEach(t),Ea.forEach(t),O$=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L$=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N$=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V4=a(Kh);I$=i(V4,"FlaxElectraPreTrainedModel"),V4.forEach(t),D$=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K4=a(Jh);S$=i(K4,"__call__"),K4.forEach(t),W$=i(Pc," special method."),Pc.forEach(t),U$=p(wa),y(Ks.$$.fragment,wa),R$=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J4=a(Gs);Gh=s(J4,"SPAN",{});var G4=a(Gh);y(kl.$$.fragment,G4),G4.forEach(t),J4.forEach(t),H$=p(Og),Xh=s(Og,"SPAN",{});var X4=a(Xh);Q$=i(X4,"FlaxElectraForSequenceClassification"),X4.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),B$=p(vt),Yh=s(vt,"P",{});var Y4=a(Yh);V$=i(Y4,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rg.forEach(t),hF=p(Ze),Tm=s(Ze,"P",{});var LM=a(Tm);mF=i(LM,"Finally, this model supports inherent JAX features such as:"),LM.forEach(t),uF=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var NM=a(bm);Rl=s(NM,"A",{href:!0,rel:!0});var IM=a(Rl);fF=i(IM,"Just-In-Time (JIT) compilation"),IM.forEach(t),NM.forEach(t),gF=p(za),ym=s(za,"LI",{});var DM=a(ym);Hl=s(DM,"A",{href:!0,rel:!0});var SM=a(Hl);_F=i(SM,"Automatic Differentiation"),SM.forEach(t),DM.forEach(t),kF=p(za),Em=s(za,"LI",{});var WM=a(Em);Ql=s(WM,"A",{href:!0,rel:!0});var UM=a(Ql);vF=i(UM,"Vectorization"),UM.forEach(t),WM.forEach(t),TF=p(za),wm=s(za,"LI",{});var RM=a(wm);Bl=s(RM,"A",{href:!0,rel:!0});var HM=a(Bl);bF=i(HM,"Parallelization"),HM.forEach(t),RM.forEach(t),za.forEach(t),yF=p(Ze),It=s(Ze,"DIV",{class:!0});var ja=a(It);y(Vl.$$.fragment,ja),EF=p(ja),kn=s(ja,"P",{});var Lc=a(kn);wF=i(Lc,"The "),$m=s(Lc,"CODE",{});var QM=a($m);$F=i(QM,"FlaxElectraPreTrainedModel"),QM.forEach(t),FF=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var BM=a(Fm);xF=i(BM,"__call__"),BM.forEach(t),MF=i(Lc," special method."),Lc.forEach(t),zF=p(ja),y(na.$$.fragment,ja),jF=p(ja),y(sa.$$.fragment,ja),ja.forEach(t),Ze.forEach(t),$f=p(o),vn=s(o,"H2",{class:!0});var Hg=a(vn);aa=s(Hg,"A",{id:!0,class:!0,href:!0});var VM=a(aa);xm=s(VM,"SPAN",{});var KM=a(xm);y(Kl.$$.fragment,KM),KM.forEach(t),VM.forEach(t),CF=p(Hg),Mm=s(Hg,"SPAN",{});var JM=a(Mm);qF=i(JM,"FlaxElectraForQuestionAnswering"),JM.forEach(t),Hg.forEach(t),Ff=p(o),Re=s(o,"DIV",{class:!0});var bt=a(Re);y(Jl.$$.fragment,bt),PF=p(bt),Tn=s(bt,"P",{});var Nc=a(Tn);AF=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=s(Nc,"CODE",{});var GM=a(zm);OF=i(GM,"span start logits"),GM.forEach(t),LF=i(Nc," and "),jm=s(Nc,"CODE",{});var XM=a(jm);NF=i(XM,"span end logits"),XM.forEach(t),IF=i(Nc,")."),Nc.forEach(t),DF=p(bt),Gl=s(bt,"P",{});var Qg=a(Gl);SF=i(Qg,"This model inherits from "),hc=s(Qg,"A",{href:!0});var YM=a(hc);WF=i(YM,"FlaxPreTrainedModel"),YM.forEach(t),UF=i(Qg,`. Check the superclass documentation for the generic methods the
...
`),Yl=s(Bg,"A",{href:!0,rel:!0});var ZM=a(Yl);QF=i(ZM,"flax.nn.Module"),ZM.forEach(t),BF=i(Bg,` subclass. Use it as a
