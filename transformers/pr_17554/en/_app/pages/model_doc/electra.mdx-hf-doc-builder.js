...
<a href="/docs/transformers/pr_17554/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17554/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17554/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dg.forEach(t),wy=p(ut),y(fs.$$.fragment,ut),$y=p(ut),lt=s(ut,"DIV",{class:!0});var go=a(lt);y(ri.$$.fragment,go),Fy=p(go),Ko=s(go,"P",{});var wc=a(Ko);xy=i(wc,"The "),Gd=s(wc,"A",{href:!0});var Yx=a(Gd);My=i(Yx,"TFElectraForMaskedLM"),Yx.forEach(t),zy=i(wc," forward method, overrides the "),Hp=s(wc,"CODE",{});var Zx=a(Hp);Cy=i(Zx,"__call__"),Zx.forEach(t),jy=i(wc," special method."),wc.forEach(t),qy=p(go),y(gs.$$.fragment,go),Py=p(go),y(_s.$$.fragment,go),Ay=p(go),y(ks.$$.fragment,go),go.forEach(t),ut.forEach(t),of=p(o),Jo=s(o,"H2",{class:!0});var cg=a(Jo);vs=s(cg,"A",{id:!0,class:!0,href:!0});var e5=a(vs);Bp=s(e5,"SPAN",{});var t5=a(Bp);y(ii.$$.fragment,t5),t5.forEach(t),e5.forEach(t),Oy=p(cg),Qp=s(cg,"SPAN",{});var o5=a(Qp);Ly=i(o5,"TFElectraForSequenceClassification"),o5.forEach(t),cg.forEach(t),nf=p(o),Je=s(o,"DIV",{class:!0});var Ht=a(Je);y(li.$$.fragment,Ht),Ny=p(Ht),Vp=s(Ht,"P",{});var n5=a(Vp);Iy=i(n5,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),n5.forEach(t),Dy=p(Ht),di=s(Ht,"P",{});var pg=a(di);Sy=i(pg,"This model inherits from "),Xd=s(pg,"A",{href:!0});var s5=a(Xd);Wy=i(s5,"TFPreTrainedModel"),s5.forEach(t),Uy=i(pg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pg.forEach(t),Ry=p(Ht),ci=s(Ht,"P",{});var hg=a(ci);Hy=i(hg,"This model is also a "),pi=s(hg,"A",{href:!0,rel:!0});var a5=a(pi);By=i(a5,"tf.keras.Model"),a5.forEach(t),Qy=i(hg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg.forEach(t),Vy=p(Ht),y(Ts.$$.fragment,Ht),Ky=p(Ht),dt=s(Ht,"DIV",{class:!0});var _o=a(dt);y(hi.$$.fragment,_o),Jy=p(_o),Go=s(_o,"P",{});var $c=a(Go);Gy=i($c,"The "),Yd=s($c,"A",{href:!0});var r5=a(Yd);Xy=i(r5,"TFElectraForSequenceClassification"),r5.forEach(t),Yy=i($c," forward method, overrides the "),Kp=s($c,"CODE",{});var i5=a(Kp);Zy=i(i5,"__call__"),i5.forEach(t),e1=i($c," special method."),$c.forEach(t),t1=p(_o),y(bs.$$.fragment,_o),o1=p(_o),y(ys.$$.fragment,_o),n1=p(_o),y(Es.$$.fragment,_o),_o.forEach(t),Ht.forEach(t),sf=p(o),Xo=s(o,"H2",{class:!0});var mg=a(Xo);ws=s(mg,"A",{id:!0,class:!0,href:!0});var l5=a(ws);Jp=s(l5,"SPAN",{});var d5=a(Jp);y(mi.$$.fragment,d5),d5.forEach(t),l5.forEach(t),s1=p(mg),Gp=s(mg,"SPAN",{});var c5=a(Gp);a1=i(c5,"TFElectraForMultipleChoice"),c5.forEach(t),mg.forEach(t),af=p(o),Ge=s(o,"DIV",{class:!0});var Bt=a(Ge);y(ui.$$.fragment,Bt),r1=p(Bt),Xp=s(Bt,"P",{});var p5=a(Xp);i1=i(p5,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),p5.forEach(t),l1=p(Bt),fi=s(Bt,"P",{});var ug=a(fi);d1=i(ug,"This model inherits from "),Zd=s(ug,"A",{href:!0});var h5=a(Zd);c1=i(h5,"TFPreTrainedModel"),h5.forEach(t),p1=i(ug,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ug.forEach(t),h1=p(Bt),gi=s(Bt,"P",{});var fg=a(gi);m1=i(fg,"This model is also a "),_i=s(fg,"A",{href:!0,rel:!0});var m5=a(_i);u1=i(m5,"tf.keras.Model"),m5.forEach(t),f1=i(fg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),g1=p(Bt),y($s.$$.fragment,Bt),_1=p(Bt),jt=s(Bt,"DIV",{class:!0});var ga=a(jt);y(ki.$$.fragment,ga),k1=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);v1=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u5=a(ec);T1=i(u5,"TFElectraForMultipleChoice"),u5.forEach(t),b1=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f5=a(Yp);y1=i(f5,"__call__"),f5.forEach(t),E1=i(Fc," special method."),Fc.forEach(t),w1=p(ga),y(Fs.$$.fragment,ga),$1=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Bt.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g5=a(Ms);Zp=s(g5,"SPAN",{});var _5=a(Zp);y(vi.$$.fragment,_5),_5.forEach(t),g5.forEach(t),F1=p(gg),eh=s(gg,"SPAN",{});var k5=a(eh);x1=i(k5,"TFElectraForTokenClassification"),k5.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),M1=p(ft),th=s(ft,"P",{});var v5=a(th);z1=i(v5,"Electra model with a token classification head on top."),v5.forEach(t),C1=p(ft),oh=s(ft,"P",{});var T5=a(oh);j1=i(T5,"Both the discriminator and generator may be loaded into this model."),T5.forEach(t),q1=p(ft),bi=s(ft,"P",{});var _g=a(bi);P1=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b5=a(tc);A1=i(b5,"TFPreTrainedModel"),b5.forEach(t),O1=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_g.forEach(t),L1=p(ft),yi=s(ft,"P",{});var kg=a(yi);N1=i(kg,"This model is also a "),Ei=s(kg,"A",{href:!0,rel:!0});var y5=a(Ei);I1=i(y5,"tf.keras.Model"),y5.forEach(t),D1=i(kg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),S1=p(ft),y(zs.$$.fragment,ft),W1=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),U1=p(ko),en=s(ko,"P",{});var xc=a(en);R1=i(xc,"The "),oc=s(xc,"A",{href:!0});var E5=a(oc);H1=i(E5,"TFElectraForTokenClassification"),E5.forEach(t),B1=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w5=a(nh);Q1=i(w5,"__call__"),w5.forEach(t),V1=i(xc," special method."),xc.forEach(t),K1=p(ko),y(Cs.$$.fragment,ko),J1=p(ko),y(js.$$.fragment,ko),G1=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $5=a(Ps);sh=s($5,"SPAN",{});var F5=a(sh);y($i.$$.fragment,F5),F5.forEach(t),$5.forEach(t),X1=p(vg),ah=s(vg,"SPAN",{});var x5=a(ah);Y1=i(x5,"TFElectraForQuestionAnswering"),x5.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Qt=a(Xe);y(Fi.$$.fragment,Qt),Z1=p(Qt),on=s(Qt,"P",{});var Mc=a(on);eE=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M5=a(rh);tE=i(M5,"span start logits"),M5.forEach(t),oE=i(Mc," and "),ih=s(Mc,"CODE",{});var z5=a(ih);nE=i(z5,"span end logits"),z5.forEach(t),sE=i(Mc,")."),Mc.forEach(t),aE=p(Qt),xi=s(Qt,"P",{});var Tg=a(xi);rE=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var C5=a(nc);iE=i(C5,"TFPreTrainedModel"),C5.forEach(t),lE=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dE=p(Qt),Mi=s(Qt,"P",{});var bg=a(Mi);cE=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var j5=a(zi);pE=i(j5,"tf.keras.Model"),j5.forEach(t),hE=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mE=p(Qt),y(As.$$.fragment,Qt),uE=p(Qt),pt=s(Qt,"DIV",{class:!0});var vo=a(pt);y(Ci.$$.fragment,vo),fE=p(vo),nn=s(vo,"P",{});var zc=a(nn);gE=i(zc,"The "),sc=s(zc,"A",{href:!0});var q5=a(sc);_E=i(q5,"TFElectraForQuestionAnswering"),q5.forEach(t),kE=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P5=a(lh);vE=i(P5,"__call__"),P5.forEach(t),TE=i(zc," special method."),zc.forEach(t),bE=p(vo),y(Os.$$.fragment,vo),yE=p(vo),y(Ls.$$.fragment,vo),EE=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Qt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A5=a(Is);dh=s(A5,"SPAN",{});var O5=a(dh);y(ji.$$.fragment,O5),O5.forEach(t),A5.forEach(t),wE=p(yg),ch=s(yg,"SPAN",{});var L5=a(ch);$E=i(L5,"FlaxElectraModel"),L5.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),FE=p(gt),ph=s(gt,"P",{});var N5=a(ph);xE=i(N5,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N5.forEach(t),ME=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zE=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I5=a(ac);CE=i(I5,"FlaxPreTrainedModel"),I5.forEach(t),jE=i(Eg,`. Check the superclass documentation for the generic methods the
...
`),Oi=s(wg,"A",{href:!0,rel:!0});var D5=a(Oi);AE=i(D5,"flax.nn.Module"),D5.forEach(t),OE=i(wg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wg.forEach(t),LE=p(gt),hh=s(gt,"P",{});var S5=a(hh);NE=i(S5,"Finally, this model supports inherent JAX features such as:"),S5.forEach(t),IE=p(gt),Kt=s(gt,"UL",{});var _a=a(Kt);mh=s(_a,"LI",{});var W5=a(mh);Li=s(W5,"A",{href:!0,rel:!0});var U5=a(Li);DE=i(U5,"Just-In-Time (JIT) compilation"),U5.forEach(t),W5.forEach(t),SE=p(_a),uh=s(_a,"LI",{});var R5=a(uh);Ni=s(R5,"A",{href:!0,rel:!0});var H5=a(Ni);WE=i(H5,"Automatic Differentiation"),H5.forEach(t),R5.forEach(t),UE=p(_a),fh=s(_a,"LI",{});var B5=a(fh);Ii=s(B5,"A",{href:!0,rel:!0});var Q5=a(Ii);RE=i(Q5,"Vectorization"),Q5.forEach(t),B5.forEach(t),HE=p(_a),gh=s(_a,"LI",{});var V5=a(gh);Di=s(V5,"A",{href:!0,rel:!0});var K5=a(Di);BE=i(K5,"Parallelization"),K5.forEach(t),V5.forEach(t),_a.forEach(t),QE=p(gt),qt=s(gt,"DIV",{class:!0});var ka=a(qt);y(Si.$$.fragment,ka),VE=p(ka),an=s(ka,"P",{});var Cc=a(an);KE=i(Cc,"The "),_h=s(Cc,"CODE",{});var J5=a(_h);JE=i(J5,"FlaxElectraPreTrainedModel"),J5.forEach(t),GE=i(Cc," forward method, overrides the "),kh=s(Cc,"CODE",{});var G5=a(kh);XE=i(G5,"__call__"),G5.forEach(t),YE=i(Cc," special method."),Cc.forEach(t),ZE=p(ka),y(Ds.$$.fragment,ka),ew=p(ka),y(Ss.$$.fragment,ka),ka.forEach(t),gt.forEach(t),mf=p(o),rn=s(o,"H2",{class:!0});var $g=a(rn);Ws=s($g,"A",{id:!0,class:!0,href:!0});var X5=a(Ws);vh=s(X5,"SPAN",{});var Y5=a(vh);y(Wi.$$.fragment,Y5),Y5.forEach(t),X5.forEach(t),tw=p($g),Th=s($g,"SPAN",{});var Z5=a(Th);ow=i(Z5,"FlaxElectraForPreTraining"),Z5.forEach(t),$g.forEach(t),uf=p(o),Pe=s(o,"DIV",{class:!0});var Ye=a(Pe);y(Ui.$$.fragment,Ye),nw=p(Ye),bh=s(Ye,"P",{});var e4=a(bh);sw=i(e4,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),e4.forEach(t),aw=p(Ye),yh=s(Ye,"P",{});var t4=a(yh);rw=i(t4,"It is recommended to load the discriminator checkpoint into that model."),t4.forEach(t),iw=p(Ye),Ri=s(Ye,"P",{});var Fg=a(Ri);lw=i(Fg,"This model inherits from "),rc=s(Fg,"A",{href:!0});var o4=a(rc);dw=i(o4,"FlaxPreTrainedModel"),o4.forEach(t),cw=i(Fg,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$$=p(kt),Rh=s(kt,"P",{});var I4=a(Rh);F$=i(I4,"Finally, this model supports inherent JAX features such as:"),I4.forEach(t),x$=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var D4=a(Hh);ml=s(D4,"A",{href:!0,rel:!0});var S4=a(ml);M$=i(S4,"Just-In-Time (JIT) compilation"),S4.forEach(t),D4.forEach(t),z$=p(Ea),Bh=s(Ea,"LI",{});var W4=a(Bh);ul=s(W4,"A",{href:!0,rel:!0});var U4=a(ul);C$=i(U4,"Automatic Differentiation"),U4.forEach(t),W4.forEach(t),j$=p(Ea),Qh=s(Ea,"LI",{});var R4=a(Qh);fl=s(R4,"A",{href:!0,rel:!0});var H4=a(fl);q$=i(H4,"Vectorization"),H4.forEach(t),R4.forEach(t),P$=p(Ea),Vh=s(Ea,"LI",{});var B4=a(Vh);gl=s(B4,"A",{href:!0,rel:!0});var Q4=a(gl);A$=i(Q4,"Parallelization"),Q4.forEach(t),B4.forEach(t),Ea.forEach(t),O$=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L$=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N$=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V4=a(Kh);I$=i(V4,"FlaxElectraPreTrainedModel"),V4.forEach(t),D$=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K4=a(Jh);S$=i(K4,"__call__"),K4.forEach(t),W$=i(Pc," special method."),Pc.forEach(t),U$=p(wa),y(Ks.$$.fragment,wa),R$=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J4=a(Gs);Gh=s(J4,"SPAN",{});var G4=a(Gh);y(kl.$$.fragment,G4),G4.forEach(t),J4.forEach(t),H$=p(Og),Xh=s(Og,"SPAN",{});var X4=a(Xh);B$=i(X4,"FlaxElectraForSequenceClassification"),X4.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q$=p(vt),Yh=s(vt,"P",{});var Y4=a(Yh);V$=i(Y4,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
