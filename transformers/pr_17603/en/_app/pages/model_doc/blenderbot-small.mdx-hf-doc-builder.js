...
tensors in the first argument of the model call function: `),R=a(O,"CODE",{});var ye=r(R);Le=l(ye,"model(inputs)"),ye.forEach(o),Ne=l(O,"."),O.forEach(o),V=c(x),Q=a(x,"P",{});var oo=r(Q);Ie=l(oo,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Th(z){let p,k,f,u,b,d,h,F,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,Fe,H,De;return{c(){p=n("p"),k=s("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),F=n("li"),Ce=s("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=s("This second option is useful when using "),W=n("code"),Oe=s("tf.keras.Model.fit"),Pe=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Le=s("model(inputs)"),Ne=s("."),V=i(),Q=n("p"),Ie=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=s("a single Tensor with "),ae=n("code"),Be=s("input_ids"),J=s(" only and nothing else: "),D=n("code"),be=s("model(input_ids)"),re=i(),N=n("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=n("code"),ze=s("model([input_ids, attention_mask])"),ee=s(" or "),le=n("code"),de=s("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),Fe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var q=r(p);k=l(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),f=c(x),u=a(x,"UL",{});var ie=r(u);b=a(ie,"LI",{});var Ze=r(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),F=a(ie,"LI",{});var Re=r(F);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=r(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=r(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Fh(z){let p,k,f,u,b;return u=new Ye({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function qh(z){let p,k,f,u,b,d,h,F,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,Fe,H,De,x,q,ie,Ze,Re,O,eo,ye,oo,Y,G,to,no,oe,ce,fe,ve,Te,ml,sa,ul,cs,we,ut,hl,ao,fl,En,_l,gl,ht,bl,kl,yl,ro,vl,Mn,Tl,wl,Cn,Sl,$l,xl,wo,ps,so,So,la,ft,Bl,da,zl,ms,U,_t,Fl,ia,ql,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,$o,kt,Dl,lo,Gl,ma,Ul,Wl,ua,Rl,Hl,Kl,Ke,yt,Vl,On,Ql,Pn,Jl,Xl,ha,Yl,Zl,Ln,vt,us,io,xo,fa,Tt,ed,_a,od,hs,Ge,wt,td,St,nd,ga,ad,rd,sd,Bo,$t,ld,ba,dd,fs,co,zo,ka,xt,id,ya,cd,_s,Se,Bt,pd,zt,md,Nn,ud,hd,fd,Ft,_d,qt,gd,bd,kd,qe,Et,yd,po,vd,In,Td,wd,va,Sd,$d,xd,Fo,Bd,qo,gs,mo,Eo,Ta,Mt,zd,wa,Fd,bs,$e,Ct,qd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,uo,Ad,Dn,Dd,Gd,Sa,Ud,Wd,Rd,Mo,Hd,Co,ks,ho,jo,$a,Nt,Kd,xa,Vd,ys,fo,It,Qd,Oo,At,Jd,Po,vs,_o,Lo,Ba,Dt,Xd,za,Yd,Ts,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,ri,si,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,Fa,ui,hi,fi,Io,_i,Ao,ws,bo,Do,qa,Kt,gi,Ea,bi,Ss,me,Vt,ki,Qt,yi,Wn,vi,Ti,wi,Jt,Si,Xt,$i,xi,Bi,Go,zi,P,Yt,Fi,ko,qi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Va,Zt,Ri,Qa,Hi,Ki,Vi,Ja,Xa,Ya,Za,Qi,$s,yo,Wo,er,en,Ji,or,Xi,xs,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,rc,sc,tr,lc,dc,Ue,nr,rn,ic,cc,ar,sn,pc,mc,rr,ln,uc,hc,sr,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Vo,yc,Qo,mn,vc,Jo,Bs,vo,Xo,lr,un,Tc,dr,wc,zs,A,hn,Sc,fn,$c,Kn,xc,Bc,zc,_n,Fc,gn,qc,Ec,Mc,ir,Cc,jc,We,cr,bn,Oc,Pc,pr,kn,Lc,Nc,mr,yn,Ic,Ac,ur,vn,Dc,Gc,E,Tn,Uc,To,Wc,hr,Rc,Hc,fr,Kc,Vc,Qc,Yo,Jc,_r,Xc,Yc,gr,br,kr,yr,Zc,ep,vr,Tr,wr,Sr,op,tp,$r,xr,Br,zr,np,ap,Fr,qr,wn,Zo,et,Er,Sn,rp,Mr,sp,lp,Cr,dp,ip,jr,cp,pp,Or,Pr,Lr,Nr,mp,up,Ir,Ar,Dr,Gr,hp,fp,Ur,Wr,Rr,Hr,_p,gp,Kr,Vr,Qr,Jr,bp,kp,ot,$n,yp,tt,vp,nt,xn,Tp,at,Fs;return d=new xe({}),re=new xe({}),Te=new xe({}),ut=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"encoder_normalize_before",val:" = False"},{name:"decoder_normalize_before",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L98",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_17603/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1125",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17603/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17603/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1268",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17603/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1435",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17603/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17603/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1141",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17603/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1249",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17603/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L972",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17603/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17603/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1035",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17603/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17603/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17603/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1307",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17603/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[Fh]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),y(d.$$.fragment),h=i(),F=n("span"),Ce=s("Blenderbot Small"),ue=i(),B=n("p"),je=s("Note that "),W=n("a"),Oe=s("BlenderbotSmallModel"),Pe=s(` and
...
special tokens using the tokenizer `),ma=n("code"),Ul=s("prepare_for_model"),Wl=s(" or "),ua=n("code"),Rl=s("encode_plus"),Hl=s(" methods."),Kl=i(),Ke=n("div"),y(yt.$$.fragment),Vl=i(),On=n("p"),Ql=s("Create the token type IDs corresponding to the sequences passed. "),Pn=n("a"),Jl=s(`What are token type
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),y(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=s("The "),Dn=n("a"),Dd=s("BlenderbotSmallForConditionalGeneration"),Gd=s(" forward method, overrides the "),Sa=n("code"),Ud=s("__call__"),Wd=s(" special method."),Rd=i(),y(Mo.$$.fragment),Hd=i(),y(Co.$$.fragment),ks=i(),ho=n("h2"),jo=n("a"),$a=n("span"),y(Nt.$$.fragment),Kd=i(),xa=n("span"),Vd=s("BlenderbotSmallForCausalLM"),ys=i(),fo=n("div"),y(It.$$.fragment),Qd=i(),Oo=n("div"),y(At.$$.fragment),Jd=i(),y(Po.$$.fragment),vs=i(),_o=n("h2"),Lo=n("a"),Ba=n("span"),y(Dt.$$.fragment),Xd=i(),za=n("span"),Yd=s("TFBlenderbotSmallModel"),Ts=i(),pe=n("div"),y(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=s(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Kr=n("blockquote"),Vr=n("blockquote"),Qr=n("blockquote"),Jr=n("p"),bp=s("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),y($n.$$.fragment),yp=i(),y(tt.$$.fragment),vp=i(),nt=n("div"),y(xn.$$.fragment),Tp=i(),y(at.$$.fragment),this.h()},l(t){const g=ph('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var Bn=r(f);u=a(Bn,"A",{id:!0,class:!0,href:!0});var Xr=r(u);b=a(Xr,"SPAN",{});var Yr=r(b);v(d.$$.fragment,Yr),Yr.forEach(o),Xr.forEach(o),h=c(Bn),F=a(Bn,"SPAN",{});var Zr=r(F);Ce=l(Zr,"Blenderbot Small"),Zr.forEach(o),Bn.forEach(o),ue=c(t),B=a(t,"P",{});var _e=r(B);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var es=r(W);Oe=l(es,"BlenderbotSmallModel"),es.forEach(o),Pe=l(_e,` and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(o),kd=c(st),qe=a(st,"DIV",{class:!0});var lt=r(qe);v(Et.$$.fragment,lt),yd=c(lt),po=a(lt,"P",{});var oa=r(po);vd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=r(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),va=a(oa,"CODE",{});var am=r(va);Sd=l(am,"__call__"),am.forEach(o),$d=l(oa," special method."),oa.forEach(o),xd=c(lt),v(Fo.$$.fragment,lt),Bd=c(lt),v(qo.$$.fragment,lt),lt.forEach(o),st.forEach(o),gs=c(t),mo=a(t,"H2",{class:!0});var As=r(mo);Eo=a(As,"A",{id:!0,class:!0,href:!0});var rm=r(Eo);Ta=a(rm,"SPAN",{});var sm=r(Ta);v(Mt.$$.fragment,sm),sm.forEach(o),rm.forEach(o),zd=c(As),wa=a(As,"SPAN",{});var lm=r(wa);Fd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),As.forEach(o),bs=c(t),$e=a(t,"DIV",{class:!0});var dt=r($e);v(Ct.$$.fragment,dt),qd=c(dt),jt=a(dt,"P",{});var Ds=r(jt);Ed=l(Ds,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gs.forEach(o),Nd=c(dt),Ee=a(dt,"DIV",{class:!0});var it=r(Ee);v(Lt.$$.fragment,it),Id=c(it),uo=a(it,"P",{});var ta=r(uo);Ad=l(ta,"The "),Dn=a(ta,"A",{href:!0});var cm=r(Dn);Dd=l(cm,"BlenderbotSmallForConditionalGeneration"),cm.forEach(o),Gd=l(ta," forward method, overrides the "),Sa=a(ta,"CODE",{});var pm=r(Sa);Ud=l(pm,"__call__"),pm.forEach(o),Wd=l(ta," special method."),ta.forEach(o),Rd=c(it),v(Mo.$$.fragment,it),Hd=c(it),v(Co.$$.fragment,it),it.forEach(o),dt.forEach(o),ks=c(t),ho=a(t,"H2",{class:!0});var Us=r(ho);jo=a(Us,"A",{id:!0,class:!0,href:!0});var mm=r(jo);$a=a(mm,"SPAN",{});var um=r($a);v(Nt.$$.fragment,um),um.forEach(o),mm.forEach(o),Kd=c(Us),xa=a(Us,"SPAN",{});var hm=r(xa);Vd=l(hm,"BlenderbotSmallForCausalLM"),hm.forEach(o),Us.forEach(o),ys=c(t),fo=a(t,"DIV",{class:!0});var Ws=r(fo);v(It.$$.fragment,Ws),Qd=c(Ws),Oo=a(Ws,"DIV",{class:!0});var Rs=r(Oo);v(At.$$.fragment,Rs),Jd=c(Rs),v(Po.$$.fragment,Rs),Rs.forEach(o),Ws.forEach(o),vs=c(t),_o=a(t,"H2",{class:!0});var Hs=r(_o);Lo=a(Hs,"A",{id:!0,class:!0,href:!0});var fm=r(Lo);Ba=a(fm,"SPAN",{});var _m=r(Ba);v(Dt.$$.fragment,_m),_m.forEach(o),fm.forEach(o),Xd=c(Hs),za=a(Hs,"SPAN",{});var gm=r(za);Yd=l(gm,"TFBlenderbotSmallModel"),gm.forEach(o),Hs.forEach(o),Ts=c(t),pe=a(t,"DIV",{class:!0});var Ve=r(pe);v(Gt.$$.fragment,Ve),Zd=c(Ve),Ut=a(Ve,"P",{});var Ks=r(Ut);ei=l(Ks,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vs.forEach(o),li=c(Ve),v(No.$$.fragment,Ve),di=c(Ve),Me=a(Ve,"DIV",{class:!0});var ct=r(Me);v(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=r(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var ym=r(Un);pi=l(ym,"TFBlenderbotSmallModel"),ym.forEach(o),mi=l(na," forward method, overrides the "),Fa=a(na,"CODE",{});var vm=r(Fa);ui=l(vm,"__call__"),vm.forEach(o),hi=l(na," special method."),na.forEach(o),fi=c(ct),v(Io.$$.fragment,ct),_i=c(ct),v(Ao.$$.fragment,ct),ct.forEach(o),Ve.forEach(o),ws=c(t),bo=a(t,"H2",{class:!0});var Qs=r(bo);Do=a(Qs,"A",{id:!0,class:!0,href:!0});var Tm=r(Do);qa=a(Tm,"SPAN",{});var wm=r(qa);v(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Qs),Ea=a(Qs,"SPAN",{});var Sm=r(Ea);bi=l(Sm,"TFBlenderbotSmallForConditionalGeneration"),Sm.forEach(o),Qs.forEach(o),Ss=c(t),me=a(t,"DIV",{class:!0});var Qe=r(me);v(Vt.$$.fragment,Qe),ki=c(Qe),Qt=a(Qe,"P",{});var Js=r(Qt);yi=l(Js,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Js.forEach(o),wi=c(Qe),Jt=a(Qe,"P",{});var Xs=r(Jt);Si=l(Xs,"This model is also a "),Xt=a(Xs,"A",{href:!0,rel:!0});var xm=r(Xt);$i=l(xm,"tf.keras.Model"),xm.forEach(o),xi=l(Xs,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xs.forEach(o),Bi=c(Qe),v(Go.$$.fragment,Qe),zi=c(Qe),P=a(Qe,"DIV",{class:!0});var K=r(P);v(Yt.$$.fragment,K),Fi=c(K),ko=a(K,"P",{});var aa=r(ko);qi=l(aa,"The "),Rn=a(aa,"A",{href:!0});var Bm=r(Rn);Ei=l(Bm,"TFBlenderbotSmallForConditionalGeneration"),Bm.forEach(o),Mi=l(aa," forward method, overrides the "),Ma=a(aa,"CODE",{});var zm=r(Ma);Ci=l(zm,"__call__"),zm.forEach(o),ji=l(aa," special method."),aa.forEach(o),Oi=c(K),v(Uo.$$.fragment,K),Pi=c(K),Ca=a(K,"P",{});var Fm=r(Ca);Li=l(Fm,"Conversation example::"),Fm.forEach(o),Ni=c(K),ja=a(K,"BLOCKQUOTE",{});var qm=r(ja);Oa=a(qm,"BLOCKQUOTE",{});var Em=r(Oa);Pa=a(Em,"BLOCKQUOTE",{});var Mm=r(Pa);La=a(Mm,"P",{});var Cm=r(La);Ii=l(Cm,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
