...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_16792/src/transformers/models/mluke/tokenization_mluke.py#L366",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/pr_16792/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_16792/src/transformers/models/mluke/tokenization_mluke.py#L1493"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),E(U.$$.fragment),We=p(),le=o("span"),Ke=i("mLUKE"),_e=p(),v=o("h2"),T=o("a"),ce=o("span"),E(S.$$.fragment),Re=p(),de=o("span"),De=i("Overview"),ge=p(),f=o("p"),Fe=i("The mLUKE model was proposed in "),W=o("a"),Oe=i("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=i(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
