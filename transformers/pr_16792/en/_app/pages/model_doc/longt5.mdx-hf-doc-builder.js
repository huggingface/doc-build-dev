...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),v(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,fo,Ke,ca,_o,pa,kn,fe,ua,Ze,ha,ma,vn,Vt,ga,yn,Yt,To,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,ka,va,bo,ya,wa,ko,$a,xa,vo,La,za,yo,qa,ja,Fa,Qe,Ma,wo,Ca,Ea,Oa,Xe,Pa,$o,Ga,Sa,Na,j,Aa,xo,Ia,Da,Lo,Ba,Wa,zo,Ua,Ha,qo,Va,Ya,jo,Ra,Ja,Fo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,ks,vs,zn,te,_e,No,st,ys,Ao,ws,qn,K,rt,$s,Z,xs,Zt,Ls,zs,Qt,qs,js,dt,Fs,Ms,Cs,oe,Es,Xt,Os,Ps,eo,Gs,Ss,jn,ne,Te,Io,it,Ns,Do,As,Fn,F,lt,Is,Bo,Ds,Bs,ct,Ws,pt,Us,Hs,Vs,ut,Ys,to,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Wo,sr,rr,dr,be,ir,ke,Mn,se,ve,Uo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,kt,_r,Tr,br,vt,kr,no,vr,yr,wr,yt,$r,wt,xr,Lr,zr,B,$t,qr,re,jr,ao,Fr,Mr,Yo,Cr,Er,Or,ye,Pr,we,En,de,$e,Ro,xt,Gr,Jo,Sr,On,C,Lt,Nr,Ko,Ar,Ir,zt,Dr,qt,Br,Wr,Ur,jt,Hr,so,Vr,Yr,Rr,Ft,Jr,Mt,Kr,Zr,Qr,W,Ct,Xr,ie,ed,ro,td,od,Zo,nd,ad,sd,xe,rd,Le,Pn,le,ze,Qo,Et,dd,Xo,id,Gn,N,Ot,ld,U,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,je,Td,Fe,Gt,bd,Me,kd,Ce,St,vd,Ee,Sn,pe,Oe,on,Nt,yd,nn,wd,Nn,A,At,$d,H,It,xd,ue,Ld,an,zd,qd,sn,jd,Fd,Md,Pe,Cd,Ge,Ed,Se,Dt,Od,Ne,Pd,Ae,Bt,Gd,Ie,An;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16792/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16792/src/transformers/models/longt5/modeling_longt5.py#L2119"}}),Ct=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16792/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16792/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16792/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
`),dt=r("a"),Fs=a("google/LongT5-Local-Base"),Ms=a(" architecture."),Cs=u(),oe=r("p"),Es=a("Configuration objects inherit from "),Xt=r("a"),Os=a("PretrainedConfig"),Ps=a(` and can be used to control the model outputs. Read the
documentation from `),eo=r("a"),Gs=a("PretrainedConfig"),Ss=a(" for more information."),jn=u(),ne=r("h2"),Te=r("a"),Io=r("span"),k(it.$$.fragment),Ns=u(),Do=r("span"),As=a("LongT5Model"),Fn=u(),F=r("div"),k(lt.$$.fragment),Is=u(),Bo=r("p"),Ds=a("The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Bs=u(),ct=r("p"),Ws=a("The LongT5 model was proposed in "),pt=r("a"),Us=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=u(),B=r("div"),k($t.$$.fragment),qr=u(),re=r("p"),jr=a("The "),ao=r("a"),Fr=a("LongT5ForConditionalGeneration"),Mr=a(" forward method, overrides the "),Yo=r("code"),Cr=a("__call__"),Er=a(" special method."),Or=u(),k(ye.$$.fragment),Pr=u(),k(we.$$.fragment),En=u(),de=r("h2"),$e=r("a"),Ro=r("span"),k(xt.$$.fragment),Gr=u(),Jo=r("span"),Sr=a("LongT5EncoderModel"),On=u(),C=r("div"),k(Lt.$$.fragment),Nr=u(),Ko=r("p"),Ar=a("The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Ir=u(),zt=r("p"),Dr=a("The LongT5 model was proposed in "),qt=r("a"),Br=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
input sequence exceeds commonly used 512 tokens. It is capable of handling input sequences of a length up to 16,384 tokens.`),Dn.forEach(o),Na=h(V),j=d(V,"LI",{});var S=i(j);Aa=s(S,"For "),xo=d(S,"EM",{});var Hd=i(xo);Ia=s(Hd,"Local Attention"),Hd.forEach(o),Da=s(S,", the sparse sliding-window local attention operation allows a given token to attend only "),Lo=d(S,"CODE",{});var Vd=i(Lo);Ba=s(Vd,"r"),Vd.forEach(o),Wa=s(S,`
...
documentation from `),eo=d(co,"A",{href:!0});var mi=i(eo);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),jn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);v(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),Ns=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);As=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),Fn=h(t),F=d(t,"DIV",{class:!0});var Y=i(F);v(lt.$$.fragment,Y),Is=h(Y),Bo=d(Y,"P",{});var Ti=i(Bo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Bs=h(Y),ct=d(Y,"P",{});var Hn=i(ct);Ws=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
