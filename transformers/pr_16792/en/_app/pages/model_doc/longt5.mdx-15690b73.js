...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),b=i("Example:"),u=m(),y(p.$$.fragment)},l(n){d=s(n,"P",{});var c=r(d);b=l(c,"Example:"),c.forEach(t),u=f(n),v(p.$$.fragment,n)},m(n,c){T(n,d,c),e(d,b),T(n,u,c),k(p,n,c),_=!0},p:se,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(u),x(p,n)}}}function fd(L){let d,b,u,p,_,n,c,z,Ln,At,U,de,tt,Be,zn,nt,qn,It,ie,Fn,We,jn,Mn,Dt,Oo,Cn,Bt,Po,at,En,Wt,So,On,Ht,No,Pn,Ut,H,Sn,He,Nn,Gn,Ue,An,In,Vt,V,le,st,Ve,Dn,rt,Bn,Yt,B,Ye,Wn,W,Hn,Go,Un,Vn,Ao,Yn,Rn,Re,Jn,Kn,Zn,Y,Qn,Io,Xn,ea,Do,oa,ta,Rt,R,ce,dt,Je,na,it,aa,Jt,q,Ke,sa,lt,ra,da,Ze,ia,Qe,la,ca,pa,Xe,ua,Bo,ha,ma,fa,eo,ga,oo,_a,Ta,ba,O,to,ya,J,va,Wo,ka,wa,ct,$a,xa,La,pe,za,ue,Kt,K,he,pt,no,qa,ut,Fa,Zt,F,ao,ja,so,Ma,ht,Ca,Ea,Oa,ro,Pa,io,Sa,Na,Ga,lo,Aa,Ho,Ia,Da,Ba,co,Wa,po,Ha,Ua,Va,P,uo,Ya,Z,Ra,Uo,Ja,Ka,mt,Za,Qa,Xa,me,es,fe,Qt,Q,ge,ft,ho,os,gt,ts,Xt,j,mo,ns,_t,as,ss,fo,rs,go,ds,is,ls,_o,cs,Vo,ps,us,hs,To,ms,bo,fs,gs,_s,S,yo,Ts,X,bs,Yo,ys,vs,Tt,ks,ws,$s,_e,xs,Te,en,ee,be,bt,vo,Ls,yt,zs,on,C,ko,qs,N,wo,Fs,oe,js,vt,Ms,Cs,kt,Es,Os,Ps,ye,Ss,ve,Ns,ke,$o,Gs,we,As,$e,xo,Is,xe,tn,te,Le,wt,Lo,Ds,$t,Bs,nn,E,zo,Ws,G,qo,Hs,ne,Us,xt,Vs,Ys,Lt,Rs,Js,Ks,ze,Zs,qe,Qs,Fe,Fo,Xs,je,er,Me,jo,or,Ce,an;return n=new De({}),Be=new De({}),Ve=new De({}),Ye=new M({props:{name:"class transformers.LongT5Config",anchor:"transformers.LongT5Config",parameters:[{name:"vocab_size",val:" = 32128"},{name:"d_model",val:" = 512"},{name:"d_kv",val:" = 64"},{name:"d_ff",val:" = 2048"},{name:"num_layers",val:" = 6"},{name:"num_decoder_layers",val:" = None"},{name:"num_heads",val:" = 8"},{name:"local_radius",val:" = 127"},{name:"global_block_size",val:" = 16"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"relative_attention_max_distance",val:" = 128"},{name:"dropout_rate",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_factor",val:" = 1.0"},{name:"feed_forward_proj",val:" = 'relu'"},{name:"is_encoder_decoder",val:" = True"},{name:"encoder_attention_type",val:" = 'local'"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 0"},{name:"eos_token_id",val:" = 1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LongT5Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32128) &#x2014;
...
Transient-Global attention.`),Dt=m(),Oo=a("p"),Cn=i("The abstract from the paper is the following:"),Bt=m(),Po=a("p"),at=a("em"),En=i(`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
...
question answering tasks.`),Wt=m(),So=a("p"),On=i("Tips:"),Ht=m(),No=a("p"),Pn=i("<INSERT TIPS ABOUT MODEL HERE>"),Ut=m(),H=a("p"),Sn=i("This model was contributed by "),He=a("a"),Nn=i("stancld"),Gn=i(`.
...
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
Transient-Global attention.`),Eo.forEach(t),Dt=f(o),Oo=s(o,"P",{});var Ot=r(Oo);Cn=l(Ot,"The abstract from the paper is the following:"),Ot.forEach(t),Bt=f(o),Po=s(o,"P",{});var Pt=r(Po);at=s(Pt,"EM",{});var St=r(at);En=l(St,`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
performance of Transformer-based neural models. In this paper, we present a new model, called LongT5, with which we
explore the effects of scaling both the input length and model size at the same time. Specifically, we integrated
attention ideas from long-input transformers (ETC), and adopted pre-training strategies from summarization pre-training
(PEGASUS) into the scalable T5 architecture. The result is a new attention mechanism we call {\\em Transient Global}
(TGlobal), which mimics ETC\u2019s local/global attention mechanism, but without requiring additional side-inputs. We are
able to achieve state-of-the-art results on several summarization tasks and outperform the original T5 models on
question answering tasks.`),St.forEach(t),Pt.forEach(t),Wt=f(o),So=s(o,"P",{});var Nt=r(So);On=l(Nt,"Tips:"),Nt.forEach(t),Ht=f(o),No=s(o,"P",{});var tr=r(No);Pn=l(tr,"<INSERT TIPS ABOUT MODEL HERE>"),tr.forEach(t),Ut=f(o),H=s(o,"P",{});var Ro=r(H);Sn=l(Ro,"This model was contributed by "),He=s(Ro,"A",{href:!0,rel:!0});var nr=r(He);Nn=l(nr,"stancld"),nr.forEach(t),Gn=l(Ro,`.
