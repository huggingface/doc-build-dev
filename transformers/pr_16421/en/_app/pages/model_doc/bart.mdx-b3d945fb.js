import{S as Lw,i as Dw,s as Gw,e as n,k as d,w as m,t as r,M as Ww,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as u,y as _,q as g,o as k,B as b,v as Uw}from"../../chunks/vendor-6b77c823.js";import{T as je}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as M}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Q}from"../../chunks/IconCopyLink-7a11ce68.js";function Rw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("When used with "),T=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer will add a space before each word (even the first one).")},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"When used with "),T=a(y,"CODE",{});var B=s(T);w=i(B,"is_split_into_words=True"),B.forEach(t),x=i(y,", this tokenizer will add a space before each word (even the first one)."),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Hw(j){let p,z,T,w,x,v,y,B;return{c(){p=n("p"),z=r("When used with "),T=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer needs to be instantiated with "),v=n("code"),y=r("add_prefix_space=True"),B=r(".")},l(se){p=a(se,"P",{});var A=s(p);z=i(A,"When used with "),T=a(A,"CODE",{});var $=s(T);w=i($,"is_split_into_words=True"),$.forEach(t),x=i(A,", this tokenizer needs to be instantiated with "),v=a(A,"CODE",{});var pe=s(v);y=i(pe,"add_prefix_space=True"),pe.forEach(t),B=i(A,"."),A.forEach(t)},m(se,A){u(se,p,A),e(p,z),e(p,T),e(T,w),e(p,x),e(p,v),e(v,y),e(p,B)},d(se){se&&t(p)}}}function Qw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Yw(j){let p,z,T,w,x,v,y,B,se,A,$,pe,be,tt,ye,Te,ot,Ze,V,N,Ue,re,C,O,nt,he,ue,at,J,st,rt,L,Me,ve,Ye,Z,ie,it,dt,X,lt,we,Re;return{c(){p=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),T=d(),w=n("ul"),x=n("li"),v=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),se=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),pe=r("This second option is useful when using "),be=n("code"),tt=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),Te=n("code"),ot=r("model(inputs)"),Ze=r("."),V=d(),N=n("p"),Ue=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=d(),C=n("ul"),O=n("li"),nt=r("a single Tensor with "),he=n("code"),ue=r("input_ids"),at=r(" only and nothing else: "),J=n("code"),st=r("model(input_ids)"),rt=d(),L=n("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ve=n("code"),Ye=r("model([input_ids, attention_mask])"),Z=r(" or "),ie=n("code"),it=r("model([input_ids, attention_mask, token_type_ids])"),dt=d(),X=n("li"),lt=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),we=n("code"),Re=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(F){p=a(F,"P",{});var P=s(p);z=i(P,"TF 2.0 models accepts two formats as inputs:"),P.forEach(t),T=l(F),w=a(F,"UL",{});var H=s(w);x=a(H,"LI",{});var Dt=s(x);v=i(Dt,"having all inputs as keyword arguments (like PyTorch models), or"),Dt.forEach(t),y=l(H),B=a(H,"LI",{});var He=s(B);se=i(He,"having all inputs as a list, tuple or dict in the first positional arguments."),He.forEach(t),H.forEach(t),A=l(F),$=a(F,"P",{});var de=s($);pe=i(de,"This second option is useful when using "),be=a(de,"CODE",{});var Gt=s(be);tt=i(Gt,"tf.keras.Model.fit"),Gt.forEach(t),ye=i(de,` method which currently requires having all the
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16421/en/model_doc/bart#transformers.BartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
`}}),Jo=new je({props:{$$slots:{default:[Xw]},$$scope:{ctx:j}}}),Ma=new M({props:{code:`from transformers import BartTokenizer, BartForQuestionAnswering
import torch
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),on=new je({props:{$$slots:{default:[e2]},$$scope:{ctx:j}}}),Xa=new M({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
`}}),an=new je({props:{$$slots:{default:[t2]},$$scope:{ctx:j}}}),ds=new M({props:{code:`from transformers import BartTokenizer, FlaxBartModel
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),rn=new je({props:{$$slots:{default:[o2]},$$scope:{ctx:j}}}),ws=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),Bs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16421/src/transformers/models/bart/modeling_flax_bart.py#L1319",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16421/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16421/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16421/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
`}}),ln=new je({props:{$$slots:{default:[n2]},$$scope:{ctx:j}}}),Ns=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
Whether or not to return a <a href="/docs/transformers/pr_16421/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
`}}),pn=new je({props:{$$slots:{default:[a2]},$$scope:{ctx:j}}}),er=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
<p><a
  href="/docs/transformers/pr_16421/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),un=new je({props:{$$slots:{default:[s2]},$$scope:{ctx:j}}}),fr=new M({props:{code:`from transformers import BartTokenizer, FlaxBartForCausalLM
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(ke),Zd=a(ke,"P",{});var y1=s(Zd);Vg=i(y1,"Finally, this model supports inherent JAX features such as:"),y1.forEach(t),Jg=l(ke),ut=a(ke,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var T1=s(Yd);ks=a(T1,"A",{href:!0,rel:!0});var v1=s(ks);Xg=i(v1,"Just-In-Time (JIT) compilation"),v1.forEach(t),T1.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var w1=s(el);bs=a(w1,"A",{href:!0,rel:!0});var x1=s(bs);Zg=i(x1,"Automatic Differentiation"),x1.forEach(t),w1.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var z1=s(tl);ys=a(z1,"A",{href:!0,rel:!0});var F1=s(ys);ek=i(F1,"Vectorization"),F1.forEach(t),z1.forEach(t),tk=l(yn),ol=a(yn,"LI",{});var B1=s(ol);Ts=a(B1,"A",{href:!0,rel:!0});var q1=s(Ts);ok=i(q1,"Parallelization"),q1.forEach(t),B1.forEach(t),yn.forEach(t),nk=l(ke),te=a(ke,"DIV",{class:!0});var Ge=s(te);f(vs.$$.fragment,Ge),ak=l(Ge),To=a(Ge,"P",{});var fi=s(To);sk=i(fi,"The "),nl=a(fi,"CODE",{});var $1=s(nl);rk=i($1,"FlaxBartPreTrainedModel"),$1.forEach(t),ik=i(fi,"forward method, overrides the "),al=a(fi,"CODE",{});var j1=s(al);dk=i(j1,"__call__"),j1.forEach(t),lk=i(fi," special method."),fi.forEach(t),ck=l(Ge),f(rn.$$.fragment,Ge),pk=l(Ge),sl=a(Ge,"P",{});var M1=s(sl);hk=i(M1,"Summarization example:"),M1.forEach(t),uk=l(Ge),f(ws.$$.fragment,Ge),mk=l(Ge),rl=a(Ge,"P",{});var P1=s(rl);fk=i(P1,"Mask filling example:"),P1.forEach(t),_k=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gk=l(ke),wt=a(ke,"DIV",{class:!0});var _i=s(wt);f(zs.$$.fragment,_i),kk=l(_i),il=a(_i,"P",{});var E1=s(il);bk=i(E1,"Example:"),E1.forEach(t),yk=l(_i),f(Fs.$$.fragment,_i),_i.forEach(t),Tk=l(ke),xt=a(ke,"DIV",{class:!0});var gi=s(xt);f(Bs.$$.fragment,gi),vk=l(gi),dl=a(gi,"P",{});var C1=s(dl);wk=i(C1,"Example:"),C1.forEach(t),xk=l(gi),f(qs.$$.fragment,gi),gi.forEach(t),ke.forEach(t),Cc=l(o),vo=a(o,"H2",{class:!0});var Mp=s(vo);dn=a(Mp,"A",{id:!0,class:!0,href:!0});var A1=s(dn);ll=a(A1,"SPAN",{});var O1=s(ll);f($s.$$.fragment,O1),O1.forEach(t),A1.forEach(t),zk=l(Mp),cl=a(Mp,"SPAN",{});var S1=s(cl);Fk=i(S1,"FlaxBartForSequenceClassification"),S1.forEach(t),Mp.forEach(t),Ac=l(o),S=a(o,"DIV",{class:!0});var ne=s(S);f(js.$$.fragment,ne),Bk=l(ne),pl=a(ne,"P",{});var I1=s(pl);qk=i(I1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
`),Vs=a(Op,"A",{href:!0,rel:!0});var iw=s(Vs);Fb=i(iw,"flax.nn.Module"),iw.forEach(t),Bb=i(Op,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Op.forEach(t),qb=l(ae),Fl=a(ae,"P",{});var dw=s(Fl);$b=i(dw,"Finally, this model supports inherent JAX features such as:"),dw.forEach(t),jb=l(ae),ft=a(ae,"UL",{});var vn=s(ft);Bl=a(vn,"LI",{});var lw=s(Bl);Js=a(lw,"A",{href:!0,rel:!0});var cw=s(Js);Mb=i(cw,"Just-In-Time (JIT) compilation"),cw.forEach(t),lw.forEach(t),Pb=l(vn),ql=a(vn,"LI",{});var pw=s(ql);Xs=a(pw,"A",{href:!0,rel:!0});var hw=s(Xs);Eb=i(hw,"Automatic Differentiation"),hw.forEach(t),pw.forEach(t),Cb=l(vn),$l=a(vn,"LI",{});var uw=s($l);Ks=a(uw,"A",{href:!0,rel:!0});var mw=s(Ks);Ab=i(mw,"Vectorization"),mw.forEach(t),uw.forEach(t),Ob=l(vn),jl=a(vn,"LI",{});var fw=s(jl);Zs=a(fw,"A",{href:!0,rel:!0});var _w=s(Zs);Sb=i(_w,"Parallelization"),_w.forEach(t),fw.forEach(t),vn.forEach(t),Ib=l(ae),Ie=a(ae,"DIV",{class:!0});var Nt=s(Ie);f(Ys.$$.fragment,Nt),Nb=l(Nt),Fo=a(Nt,"P",{});var vi=s(Fo);Lb=i(vi,"The "),Ml=a(vi,"CODE",{});var gw=s(Ml);Db=i(gw,"FlaxBartPreTrainedModel"),gw.forEach(t),Gb=i(vi,"forward method, overrides the "),Pl=a(vi,"CODE",{});var kw=s(Pl);Wb=i(kw,"__call__"),kw.forEach(t),Ub=i(vi," special method."),vi.forEach(t),Rb=l(Nt),f(pn.$$.fragment,Nt),Hb=l(Nt),El=a(Nt,"P",{});var bw=s(El);Qb=i(bw,"Example:"),bw.forEach(t),Vb=l(Nt),f(er.$$.fragment,Nt),Nt.forEach(t),Jb=l(ae),Bt=a(ae,"DIV",{class:!0});var wi=s(Bt);f(tr.$$.fragment,wi),Xb=l(wi),Cl=a(wi,"P",{});var yw=s(Cl);Kb=i(yw,"Example:"),yw.forEach(t),Zb=l(wi),f(or.$$.fragment,wi),wi.forEach(t),Yb=l(ae),qt=a(ae,"DIV",{class:!0});var xi=s(qt);f(nr.$$.fragment,xi),ey=l(xi),Al=a(xi,"P",{});var Tw=s(Al);ty=i(Tw,"Example:"),Tw.forEach(t),oy=l(xi),f(ar.$$.fragment,xi),xi.forEach(t),ae.forEach(t),Ic=l(o),Bo=a(o,"H2",{class:!0});var Sp=s(Bo);hn=a(Sp,"A",{id:!0,class:!0,href:!0});var vw=s(hn);Ol=a(vw,"SPAN",{});var ww=s(Ol);f(sr.$$.fragment,ww),ww.forEach(t),vw.forEach(t),ny=l(Sp),Sl=a(Sp,"SPAN",{});var xw=s(Sl);ay=i(xw,"FlaxBartForCausalLM"),xw.forEach(t),Sp.forEach(t),Nc=l(o),K=a(o,"DIV",{class:!0});var We=s(K);f(rr.$$.fragment,We),sy=l(We),Il=a(We,"P",{});var zw=s(Il);ry=i(zw,`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
