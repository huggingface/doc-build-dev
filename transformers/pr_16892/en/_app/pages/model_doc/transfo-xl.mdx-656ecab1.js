import{S as zf,i as Pf,s as jf,e as n,k as l,w as v,t as r,M as Of,c as s,d as t,m as d,a,x as b,h as i,b as c,F as e,g as f,y as w,q as y,o as L,B as k,v as Sf}from"../../chunks/vendor-6b77c823.js";import{T as it}from"../../chunks/Tip-39098574.js";import{D as te}from"../../chunks/Docstring-1088f2fb.js";import{C as Qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ge}from"../../chunks/IconCopyLink-7a11ce68.js";function Nf(R){let h,M,u,g,$,_,T,X,I,W;return{c(){h=n("p"),M=r("TransformerXL does "),u=n("strong"),g=r("not"),$=r(" work with "),_=n("em"),T=r("torch.nn.DataParallel"),X=r(" due to a bug in PyTorch, see "),I=n("a"),W=r("issue #36035"),this.h()},l(x){h=s(x,"P",{});var z=a(h);M=i(z,"TransformerXL does "),u=s(z,"STRONG",{});var O=a(u);g=i(O,"not"),O.forEach(t),$=i(z," work with "),_=s(z,"EM",{});var K=a(_);T=i(K,"torch.nn.DataParallel"),K.forEach(t),X=i(z," due to a bug in PyTorch, see "),I=s(z,"A",{href:!0,rel:!0});var ae=a(I);W=i(ae,"issue #36035"),ae.forEach(t),z.forEach(t),this.h()},h(){c(I,"href","https://github.com/pytorch/pytorch/issues/36035"),c(I,"rel","nofollow")},m(x,z){f(x,h,z),e(h,M),e(h,u),e(u,g),e(h,$),e(h,_),e(_,T),e(h,X),e(h,I),e(I,W)},d(x){x&&t(h)}}}function Af(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function If(R){let h,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,pe,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),pe=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=s(p,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(p),g=s(p,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(p),x=s(p,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
tensors in the first argument of the model call function: `),V=s(H,"CODE",{});var he=a(V);$e=i(he,"model(inputs)"),he.forEach(t),ge=i(H,"."),H.forEach(t),U=d(p),N=s(p,"P",{});var He=a(N);ne=i(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),re=d(p),F=s(p,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),pe=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(p,E){f(p,h,E),e(h,M),f(p,u,E),f(p,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(p,W,E),f(p,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(p,U,E),f(p,N,E),e(N,ne),f(p,re,E),f(p,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,pe),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(p){p&&t(h),p&&t(u),p&&t(g),p&&t(W),p&&t(x),p&&t(U),p&&t(N),p&&t(re),p&&t(F)}}}function Wf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Vf(R){let h,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,pe,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),pe=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=s(p,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(p),g=s(p,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(p),x=s(p,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(p),F=s(p,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),pe=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(p,E){f(p,h,E),e(h,M),f(p,u,E),f(p,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(p,W,E),f(p,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(p,U,E),f(p,N,E),e(N,ne),f(p,re,E),f(p,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,pe),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(p){p&&t(h),p&&t(u),p&&t(g),p&&t(W),p&&t(x),p&&t(U),p&&t(N),p&&t(re),p&&t(F)}}}function Uf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Bf(R){let h,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,pe,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),pe=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=s(p,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(p),g=s(p,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(p),x=s(p,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(p),F=s(p,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),pe=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(p,E){f(p,h,E),e(h,M),f(p,u,E),f(p,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(p,W,E),f(p,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(p,U,E),f(p,N,E),e(N,ne),f(p,re,E),f(p,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,pe),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(p){p&&t(h),p&&t(u),p&&t(g),p&&t(W),p&&t(x),p&&t(U),p&&t(N),p&&t(re),p&&t(F)}}}function Rf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Kf(R){let h,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,pe,A,ve,j,Ee,p,E,de,be,Ve,H,Ae,he,He,P,S,Ce,we,J,ze,Ue,ye,D,Kt,Da,Ye,Ia,cn,Wa,Va,fn,Ua,Ba,Gt,Ra,Ka,Ga,lt,Ya,pn,Qa,Za,hn,Ja,er,tr,Hn,or,nr,Yt,Ws,dt,Mt,Dn,Qt,sr,In,ar,Vs,De,Zt,rr,Jt,ir,eo,lr,dr,cr,to,fr,mn,pr,hr,mr,un,oo,Us,ct,Et,Wn,no,ur,Vn,gr,Bs,ft,so,_r,Un,Tr,Rs,pt,ao,vr,Bn,br,Ks,ht,ro,wr,Rn,yr,Gs,mt,io,Lr,Kn,kr,Ys,ut,Ft,Gn,lo,$r,Yn,xr,Qs,Fe,co,Xr,Qn,Mr,Er,fo,Fr,gn,qr,Cr,zr,po,Pr,ho,jr,Or,Sr,Pe,mo,Nr,gt,Ar,_n,Hr,Dr,Zn,Ir,Wr,Vr,qt,Ur,Jn,Br,Rr,uo,Zs,_t,Ct,es,go,Kr,ts,Gr,Js,qe,_o,Yr,os,Qr,Zr,To,Jr,Tn,ei,ti,oi,vo,ni,bo,si,ai,ri,je,wo,ii,Tt,li,vn,di,ci,ns,fi,pi,hi,zt,mi,ss,ui,gi,yo,ea,vt,Pt,as,Lo,_i,rs,Ti,ta,se,ko,vi,is,bi,wi,bn,wn,yi,Li,ki,Ie,$i,ls,xi,Xi,ds,Mi,Ei,cs,Fi,qi,fs,Ci,zi,Pi,$o,ji,yn,Oi,Si,Ni,xo,Ai,Xo,Hi,Di,Ii,Y,Mo,Wi,bt,Vi,Ln,Ui,Bi,ps,Ri,Ki,Gi,jt,Yi,hs,Qi,Zi,Eo,Ji,Fo,el,ms,tl,ol,qo,nl,Co,oa,wt,Ot,us,zo,sl,gs,al,na,me,Po,rl,_s,il,ll,jo,dl,kn,cl,fl,pl,Oo,hl,So,ml,ul,gl,St,_l,Oe,No,Tl,yt,vl,$n,bl,wl,Ts,yl,Ll,kl,Nt,$l,vs,xl,Xl,Ao,sa,Lt,At,bs,Ho,Ml,ws,El,aa,ue,Do,Fl,ys,ql,Cl,Io,zl,xn,Pl,jl,Ol,Wo,Sl,Vo,Nl,Al,Hl,Ht,Dl,Se,Uo,Il,kt,Wl,Xn,Vl,Ul,Ls,Bl,Rl,Kl,Dt,Gl,ks,Yl,Ql,Bo,ra,$t,It,$s,Ro,Zl,xs,Jl,ia,ee,Ko,ed,Xs,td,od,Mn,En,nd,sd,ad,We,rd,Ms,id,ld,Es,dd,cd,Fs,fd,pd,qs,hd,md,ud,Go,gd,Fn,_d,Td,vd,Yo,bd,Qo,wd,yd,Ld,Wt,kd,Le,Zo,$d,xt,xd,qn,Xd,Md,Cs,Ed,Fd,qd,Vt,Cd,zs,zd,Pd,Jo,jd,en,la,Xt,Ut,Ps,tn,Od,js,Sd,da,on,nn,ca,sn,an,fa;return _=new Ge({}),K=new Ge({}),he=new it({props:{warning:!0,$$slots:{default:[Nf]},$$scope:{ctx:R}}}),we=new Ge({}),Kt=new te({props:{name:"class transformers.TransfoXLConfig",anchor:"transformers.TransfoXLConfig",parameters:[{name:"vocab_size",val:" = 267735"},{name:"cutoffs",val:" = [20000, 40000, 200000]"},{name:"d_model",val:" = 1024"},{name:"d_embed",val:" = 1024"},{name:"n_head",val:" = 16"},{name:"d_head",val:" = 64"},{name:"d_inner",val:" = 4096"},{name:"div_val",val:" = 4"},{name:"pre_lnorm",val:" = False"},{name:"n_layer",val:" = 18"},{name:"mem_len",val:" = 1600"},{name:"clamp_len",val:" = 1000"},{name:"same_length",val:" = True"},{name:"proj_share_all_but_first",val:" = True"},{name:"attn_type",val:" = 0"},{name:"sample_softmax",val:" = -1"},{name:"adaptive",val:" = True"},{name:"dropout",val:" = 0.1"},{name:"dropatt",val:" = 0.0"},{name:"untie_r",val:" = True"},{name:"init",val:" = 'normal'"},{name:"init_range",val:" = 0.01"},{name:"proj_init_std",val:" = 0.01"},{name:"init_std",val:" = 0.02"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 267735) &#x2014;
...
The epsilon to use in the layer normalization layers`,name:"layer_norm_epsilon"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29"}}),Yt=new Qe({props:{code:`from transformers import TransfoXLConfig, TransfoXLModel
...
The language of this tokenizer (used for mose preprocessing).`,name:"language"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/tokenization_transfo_xl.py#L114"}}),oo=new te({props:{name:"save_vocabulary",anchor:"transformers.TransfoXLTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/tokenization_transfo_xl.py#L300"}}),no=new Ge({}),so=new te({props:{name:"class transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput",anchor:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput",parameters:[{name:"last_hidden_state",val:": FloatTensor"},{name:"mems",val:": typing.List[torch.FloatTensor] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L607"}}),ao=new te({props:{name:"class transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput",anchor:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput",parameters:[{name:"losses",val:": typing.Optional[torch.FloatTensor] = None"},{name:"prediction_scores",val:": FloatTensor = None"},{name:"mems",val:": typing.List[torch.FloatTensor] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"}],parametersDescription:[{anchor:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput.losses",description:`<strong>losses</strong> (<code>torch.FloatTensor</code> of shape <em>(batch_size, sequence_length-1)</em>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
Reduced language modeling loss.`,name:"loss"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L672"}}),ro=new te({props:{name:"class transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput",anchor:"transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput",parameters:[{name:"last_hidden_state",val:": Tensor = None"},{name:"mems",val:": typing.List[tensorflow.python.framework.ops.Tensor] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L700"}}),io=new te({props:{name:"class transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput",anchor:"transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput",parameters:[{name:"prediction_scores",val:": Tensor = None"},{name:"mems",val:": typing.List[tensorflow.python.framework.ops.Tensor] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput.losses",description:`<strong>losses</strong> (<code>tf.Tensor</code> of shape <em>(batch_size, sequence_length-1)</em>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
Tuple of <code>tf.Tensor</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L731"}}),lo=new Ge({}),co=new te({props:{name:"class transformers.TransfoXLModel",anchor:"transformers.TransfoXLModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L771"}}),mo=new te({props:{name:"forward",anchor:"transformers.TransfoXLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TransfoXLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16892/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16892/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L875",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),go=new Ge({}),_o=new te({props:{name:"class transformers.TransfoXLLMHeadModel",anchor:"transformers.TransfoXLLMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1013"}}),wo=new te({props:{name:"forward",anchor:"transformers.TransfoXLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16892/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16892/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1065",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Lo=new Ge({}),ko=new te({props:{name:"class transformers.TransfoXLForSequenceClassification",anchor:"transformers.TransfoXLForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1198"}}),Mo=new te({props:{name:"forward",anchor:"transformers.TransfoXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"mems",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.TransfoXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16892/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16892/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1209",returnDescription:`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>num_labels = <span class="hljs-built_in">len</span>(model.config.id2label)
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TransfoXLForSequenceClassification.from_pretrained(
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;transfo-xl-wt103&quot;</span>, num_labels=num_labels, problem_type=<span class="hljs-string">&quot;multi_label_classification&quot;</span>
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),zo=new Ge({}),Po=new te({props:{name:"class transformers.TFTransfoXLModel",anchor:"transformers.TFTransfoXLModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTransfoXLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L877"}}),St=new it({props:{$$slots:{default:[If]},$$scope:{ctx:R}}}),No=new te({props:{name:"call",anchor:"transformers.TFTransfoXLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16892/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16892/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L882",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ho=new Ge({}),Do=new te({props:{name:"class transformers.TFTransfoXLLMHeadModel",anchor:"transformers.TFTransfoXLLMHeadModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L933"}}),Ht=new it({props:{$$slots:{default:[Vf]},$$scope:{ctx:R}}}),Uo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16892/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16892/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16892/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L961",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput"
...
`}}),Dt=new it({props:{$$slots:{default:[Uf]},$$scope:{ctx:R}}}),Bo=new Qe({props:{code:`from transformers import TransfoXLTokenizer, TFTransfoXLLMHeadModel
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ro=new Ge({}),Ko=new te({props:{name:"class transformers.TFTransfoXLForSequenceClassification",anchor:"transformers.TFTransfoXLForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTransfoXLForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1055"}}),Wt=new it({props:{$$slots:{default:[Bf]},$$scope:{ctx:R}}}),Zo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"mems",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16892/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16892/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16892/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16892/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1070",returnDescription:`
...
inputs and outputs (tied).`),C=l(),ie=n("p"),Q=r("The abstract from the paper is the following:"),_e=l(),le=n("p"),B=n("em"),xe=r(`Transformers have a potential of learning longer-term dependency, but are limited by a fixed-length context in the
...
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Me=l(),pe=n("li"),A=r("Transformer-XL is one of the few models that has no sequence length limit."),ve=l(),j=n("p"),Ee=r("This model was contributed by "),p=n("a"),E=r("thomwolf"),de=r(". The original code can be found "),be=n("a"),Ve=r("here"),H=r("."),Ae=l(),v(he.$$.fragment),He=l(),P=n("h2"),S=n("a"),Ce=n("span"),v(we.$$.fragment),J=l(),ze=n("span"),Ue=r("TransfoXLConfig"),ye=l(),D=n("div"),v(Kt.$$.fragment),Da=l(),Ye=n("p"),Ia=r("This is the configuration class to store the configuration of a "),cn=n("a"),Wa=r("TransfoXLModel"),Va=r(" or a "),fn=n("a"),Ua=r("TFTransfoXLModel"),Ba=r(`. It is
...
XL`),Ka=r(" architecture."),Ga=l(),lt=n("p"),Ya=r("Configuration objects inherit from "),pn=n("a"),Qa=r("PretrainedConfig"),Za=r(` and can be used to control the model outputs. Read the
documentation from `),hn=n("a"),Ja=r("PretrainedConfig"),er=r(" for more information."),tr=l(),Hn=n("p"),or=r("Examples:"),nr=l(),v(Yt.$$.fragment),Ws=l(),dt=n("h2"),Mt=n("a"),Dn=n("span"),v(Qt.$$.fragment),sr=l(),In=n("span"),ar=r("TransfoXLTokenizer"),Vs=l(),De=n("div"),v(Zt.$$.fragment),rr=l(),Jt=n("p"),ir=r("Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=n("a"),lr=r(`the original
code`),dr=r(`. The Transformer-XL tokenizer is a word-level tokenizer (no
sub-word tokenization).`),cr=l(),to=n("p"),fr=r("This tokenizer inherits from "),mn=n("a"),pr=r("PreTrainedTokenizer"),hr=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),mr=l(),un=n("div"),v(oo.$$.fragment),Us=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Vn=n("span"),gr=r("TransfoXL specific outputs"),Bs=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Un=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),pt=n("div"),v(ao.$$.fragment),vr=l(),Bn=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),ht=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),mt=n("div"),v(io.$$.fragment),Lr=l(),Kn=n("p"),kr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),Cr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zr=l(),po=n("p"),Pr=r("This model is also a PyTorch "),ho=n("a"),jr=r("torch.nn.Module"),Or=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sr=l(),Pe=n("div"),v(mo.$$.fragment),Nr=l(),gt=n("p"),Ar=r("The "),_n=n("a"),Hr=r("TransfoXLModel"),Dr=r(" forward method, overrides the "),Zn=n("code"),Ir=r("__call__"),Wr=r(" special method."),Vr=l(),v(qt.$$.fragment),Ur=l(),Jn=n("p"),Br=r("Example:"),Rr=l(),v(uo.$$.fragment),Zs=l(),_t=n("h2"),Ct=n("a"),es=n("span"),v(go.$$.fragment),Kr=l(),ts=n("span"),Gr=r("TransfoXLLMHeadModel"),Js=l(),qe=n("div"),v(_o.$$.fragment),Yr=l(),os=n("p"),Qr=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Vi=r("The "),Ln=n("a"),Ui=r("TransfoXLForSequenceClassification"),Bi=r(" forward method, overrides the "),ps=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),hs=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ms=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(Co.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(zo.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),me=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),kn=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pl=l(),Oo=n("p"),hl=r("This model is also a "),So=n("a"),ml=r("tf.keras.Model"),ul=r(` subclass. Use it
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hl=l(),v(Ht.$$.fragment),Dl=l(),Se=n("div"),v(Uo.$$.fragment),Il=l(),kt=n("p"),Wl=r("The "),Xn=n("a"),Vl=r("TFTransfoXLLMHeadModel"),Ul=r(" forward method, overrides the "),Ls=n("code"),Bl=r("__call__"),Rl=r(" special method."),Kl=l(),v(Dt.$$.fragment),Gl=l(),ks=n("p"),Yl=r("Example:"),Ql=l(),v(Bo.$$.fragment),ra=l(),$t=n("h2"),It=n("a"),$s=n("span"),v(Ro.$$.fragment),Zl=l(),xs=n("span"),Jl=r("TFTransfoXLForSequenceClassification"),ia=l(),ee=n("div"),v(Ko.$$.fragment),ed=l(),Xs=n("p"),td=r("The Transfo XL Model transformer with a sequence classification head on top (linear layer)."),od=l(),Mn=n("p"),En=n("a"),nd=r("TFTransfoXLForSequenceClassification"),sd=r(` uses the last token in order to do the classification, as other causal
...
padding tokens when `),Fs=n("code"),fd=r("inputs_embeds"),pd=r(" are passed instead of "),qs=n("code"),hd=r("input_ids"),md=r(`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ld=l(),v(Wt.$$.fragment),kd=l(),Le=n("div"),v(Zo.$$.fragment),$d=l(),xt=n("p"),xd=r("The "),qn=n("a"),Xd=r("TFTransfoXLForSequenceClassification"),Md=r(" forward method, overrides the "),Cs=n("code"),Ed=r("__call__"),Fd=r(" special method."),qd=l(),v(Vt.$$.fragment),Cd=l(),zs=n("p"),zd=r("Example:"),Pd=l(),v(Jo.$$.fragment),jd=l(),v(en.$$.fragment),la=l(),Xt=n("h2"),Ut=n("a"),Ps=n("span"),v(tn.$$.fragment),Od=l(),js=n("span"),Sd=r("Internal Layers"),da=l(),on=n("div"),v(nn.$$.fragment),ca=l(),sn=n("div"),v(an.$$.fragment),this.h()},l(o){const m=Of('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),M=d(o),u=s(o,"H1",{class:!0});var rn=a(u);g=s(rn,"A",{id:!0,class:!0,href:!0});var Os=a(g);$=s(Os,"SPAN",{});var Ss=a($);b(_.$$.fragment,Ss),Ss.forEach(t),Os.forEach(t),T=d(rn),X=s(rn,"SPAN",{});var Ns=a(X);I=i(Ns,"Transformer XL"),Ns.forEach(t),rn.forEach(t),W=d(o),x=s(o,"H2",{class:!0});var ln=a(x);z=s(ln,"A",{id:!0,class:!0,href:!0});var As=a(z);O=s(As,"SPAN",{});var Hs=a(O);b(K.$$.fragment,Hs),Hs.forEach(t),As.forEach(t),ae=d(ln),V=s(ln,"SPAN",{});var Ds=a(V);$e=i(Ds,"Overview"),Ds.forEach(t),ln.forEach(t),ge=d(o),U=s(o,"P",{});var dn=a(U);N=i(dn,"The Transformer-XL model was proposed in "),ne=s(dn,"A",{href:!0,rel:!0});var Is=a(ne);re=i(Is,"Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context"),Is.forEach(t),F=i(dn,` by Zihang Dai, Zhilin Yang, Yiming Yang, Jaime Carbonell, Quoc V. Le, Ruslan
Salakhutdinov. It\u2019s a causal (uni-directional) transformer with relative positioning (sinuso\xEFdal) embeddings which can
reuse previously computed hidden-states to attend to longer context (memory). This model also uses adaptive softmax
inputs and outputs (tied).`),dn.forEach(t),C=d(o),ie=s(o,"P",{});var Hd=a(ie);Q=i(Hd,"The abstract from the paper is the following:"),Hd.forEach(t),_e=d(o),le=s(o,"P",{});var Dd=a(le);B=s(Dd,"EM",{});var Id=a(B);xe=i(Id,`Transformers have a potential of learning longer-term dependency, but are limited by a fixed-length context in the
setting of language modeling. We propose a novel neural architecture Transformer-XL that enables learning dependency
beyond a fixed length without disrupting temporal coherence. It consists of a segment-level recurrence mechanism and a
novel positional encoding scheme. Our method not only enables capturing longer-term dependency, but also resolves the
context fragmentation problem. As a result, Transformer-XL learns dependency that is 80% longer than RNNs and 450%
...
bpc/perplexity to 0.99 on enwiki8, 1.08 on text8, 18.3 on WikiText-103, 21.8 on One Billion Word, and 54.5 on Penn
Treebank (without finetuning). When trained only on WikiText-103, Transformer-XL manages to generate reasonably
coherent, novel text articles with thousands of tokens.`),Id.forEach(t),Dd.forEach(t),Te=d(o),q=s(o,"P",{});var Wd=a(q);Xe=i(Wd,"Tips:"),Wd.forEach(t),G=d(o),oe=s(o,"UL",{});var pa=a(oe);fe=s(pa,"LI",{});var Vd=a(fe);Z=i(Vd,`Transformer-XL uses relative sinusoidal positional embeddings. Padding can be done on the left or on the right. The
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Vd.forEach(t),Me=d(pa),pe=s(pa,"LI",{});var Ud=a(pe);A=i(Ud,"Transformer-XL is one of the few models that has no sequence length limit."),Ud.forEach(t),pa.forEach(t),ve=d(o),j=s(o,"P",{});var Cn=a(j);Ee=i(Cn,"This model was contributed by "),p=s(Cn,"A",{href:!0,rel:!0});var Bd=a(p);E=i(Bd,"thomwolf"),Bd.forEach(t),de=i(Cn,". The original code can be found "),be=s(Cn,"A",{href:!0,rel:!0});var Rd=a(be);Ve=i(Rd,"here"),Rd.forEach(t),H=i(Cn,"."),Cn.forEach(t),Ae=d(o),b(he.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var ha=a(P);S=s(ha,"A",{id:!0,class:!0,href:!0});var Kd=a(S);Ce=s(Kd,"SPAN",{});var Gd=a(Ce);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(ha),ze=s(ha,"SPAN",{});var Yd=a(ze);Ue=i(Yd,"TransfoXLConfig"),Yd.forEach(t),ha.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Bt=a(Ye);Ia=i(Bt,"This is the configuration class to store the configuration of a "),cn=s(Bt,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Va=i(Bt," or a "),fn=s(Bt,"A",{href:!0});var Zd=a(fn);Ua=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Ba=i(Bt,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa.forEach(t),ri=d(tt),je=s(tt,"DIV",{class:!0});var ot=a(je);b(wo.$$.fragment,ot),ii=d(ot),Tt=s(ot,"P",{});var jn=a(Tt);li=i(jn,"The "),vn=s(jn,"A",{href:!0});var qc=a(vn);di=i(qc,"TransfoXLLMHeadModel"),qc.forEach(t),ci=i(jn," forward method, overrides the "),ns=s(jn,"CODE",{});var Cc=a(ns);fi=i(Cc,"__call__"),Cc.forEach(t),pi=i(jn," special method."),jn.forEach(t),hi=d(ot),b(zt.$$.fragment,ot),mi=d(ot),ss=s(ot,"P",{});var zc=a(ss);ui=i(zc,"Example:"),zc.forEach(t),gi=d(ot),b(yo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),ea=d(o),vt=s(o,"H2",{class:!0});var Ma=a(vt);Pt=s(Ma,"A",{id:!0,class:!0,href:!0});var Pc=a(Pt);as=s(Pc,"SPAN",{});var jc=a(as);b(Lo.$$.fragment,jc),jc.forEach(t),Pc.forEach(t),_i=d(Ma),rs=s(Ma,"SPAN",{});var Oc=a(rs);Ti=i(Oc,"TransfoXLForSequenceClassification"),Oc.forEach(t),Ma.forEach(t),ta=d(o),se=s(o,"DIV",{class:!0});var Ne=a(se);b(ko.$$.fragment,Ne),vi=d(Ne),is=s(Ne,"P",{});var Sc=a(is);bi=i(Sc,"The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),Sc.forEach(t),wi=d(Ne),bn=s(Ne,"P",{});var Nd=a(bn);wn=s(Nd,"A",{href:!0});var Nc=a(wn);yi=i(Nc,"TransfoXLForSequenceClassification"),Nc.forEach(t),Li=i(Nd,` uses the last token in order to do the classification, as other causal
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Vi=i(On,"The "),Ln=s(On,"A",{href:!0});var Uc=a(Ln);Ui=i(Uc,"TransfoXLForSequenceClassification"),Uc.forEach(t),Bi=i(On," forward method, overrides the "),ps=s(On,"CODE",{});var Bc=a(ps);Ri=i(Bc,"__call__"),Bc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),hs=s(ce,"P",{});var Rc=a(hs);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ms=s(ce,"P",{});var Kc=a(ms);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(Co.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(zo.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),me=s(o,"DIV",{class:!0});var Be=a(me);b(Po.$$.fragment,Be),rl=d(Be),_s=s(Be,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Be),jo=s(Be,"P",{});var Ca=a(jo);dl=i(Ca,"This model inherits from "),kn=s(Ca,"A",{href:!0});var Jc=a(kn);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(Ca,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ca.forEach(t),pl=d(Be),Oo=s(Be,"P",{});var za=a(Oo);hl=i(za,"This model is also a "),So=s(za,"A",{href:!0,rel:!0});var ef=a(So);ml=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(za,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),za.forEach(t),gl=d(Be),b(St.$$.fragment,Be),_l=d(Be),Oe=s(Be,"DIV",{class:!0});var st=a(Oe);b(No.$$.fragment,st),Tl=d(st),yt=s(st,"P",{});var Sn=a(yt);vl=i(Sn,"The "),$n=s(Sn,"A",{href:!0});var tf=a($n);bl=i(tf,"TFTransfoXLModel"),tf.forEach(t),wl=i(Sn," forward method, overrides the "),Ts=s(Sn,"CODE",{});var of=a(Ts);yl=i(of,"__call__"),of.forEach(t),Ll=i(Sn," special method."),Sn.forEach(t),kl=d(st),b(Nt.$$.fragment,st),$l=d(st),vs=s(st,"P",{});var nf=a(vs);xl=i(nf,"Example:"),nf.forEach(t),Xl=d(st),b(Ao.$$.fragment,st),st.forEach(t),Be.forEach(t),sa=d(o),Lt=s(o,"H2",{class:!0});var Pa=a(Lt);At=s(Pa,"A",{id:!0,class:!0,href:!0});var sf=a(At);bs=s(sf,"SPAN",{});var af=a(bs);b(Ho.$$.fragment,af),af.forEach(t),sf.forEach(t),Ml=d(Pa),ws=s(Pa,"SPAN",{});var rf=a(ws);El=i(rf,"TFTransfoXLLMHeadModel"),rf.forEach(t),Pa.forEach(t),aa=d(o),ue=s(o,"DIV",{class:!0});var Re=a(ue);b(Do.$$.fragment,Re),Fl=d(Re),ys=s(Re,"P",{});var lf=a(ys);ql=i(lf,`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oa.forEach(t),Hl=d(Re),b(Ht.$$.fragment,Re),Dl=d(Re),Se=s(Re,"DIV",{class:!0});var at=a(Se);b(Uo.$$.fragment,at),Il=d(at),kt=s(at,"P",{});var Nn=a(kt);Wl=i(Nn,"The "),Xn=s(Nn,"A",{href:!0});var ff=a(Xn);Vl=i(ff,"TFTransfoXLLMHeadModel"),ff.forEach(t),Ul=i(Nn," forward method, overrides the "),Ls=s(Nn,"CODE",{});var pf=a(Ls);Bl=i(pf,"__call__"),pf.forEach(t),Rl=i(Nn," special method."),Nn.forEach(t),Kl=d(at),b(Dt.$$.fragment,at),Gl=d(at),ks=s(at,"P",{});var hf=a(ks);Yl=i(hf,"Example:"),hf.forEach(t),Ql=d(at),b(Bo.$$.fragment,at),at.forEach(t),Re.forEach(t),ra=d(o),$t=s(o,"H2",{class:!0});var Sa=a($t);It=s(Sa,"A",{id:!0,class:!0,href:!0});var mf=a(It);$s=s(mf,"SPAN",{});var uf=a($s);b(Ro.$$.fragment,uf),uf.forEach(t),mf.forEach(t),Zl=d(Sa),xs=s(Sa,"SPAN",{});var gf=a(xs);Jl=i(gf,"TFTransfoXLForSequenceClassification"),gf.forEach(t),Sa.forEach(t),ia=d(o),ee=s(o,"DIV",{class:!0});var ke=a(ee);b(Ko.$$.fragment,ke),ed=d(ke),Xs=s(ke,"P",{});var _f=a(Xs);td=i(_f,"The Transfo XL Model transformer with a sequence classification head on top (linear layer)."),_f.forEach(t),od=d(ke),Mn=s(ke,"P",{});var Ad=a(Mn);En=s(Ad,"A",{href:!0});var Tf=a(En);nd=i(Tf,"TFTransfoXLForSequenceClassification"),Tf.forEach(t),sd=i(Ad,` uses the last token in order to do the classification, as other causal
...
padding tokens when `),Fs=s(rt,"CODE",{});var wf=a(Fs);fd=i(wf,"inputs_embeds"),wf.forEach(t),pd=i(rt," are passed instead of "),qs=s(rt,"CODE",{});var yf=a(qs);hd=i(yf,"input_ids"),yf.forEach(t),md=i(rt,`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aa.forEach(t),Ld=d(ke),b(Wt.$$.fragment,ke),kd=d(ke),Le=s(ke,"DIV",{class:!0});var Ke=a(Le);b(Zo.$$.fragment,Ke),$d=d(Ke),xt=s(Ke,"P",{});var An=a(xt);xd=i(An,"The "),qn=s(An,"A",{href:!0});var $f=a(qn);Xd=i($f,"TFTransfoXLForSequenceClassification"),$f.forEach(t),Md=i(An," forward method, overrides the "),Cs=s(An,"CODE",{});var xf=a(Cs);Ed=i(xf,"__call__"),xf.forEach(t),Fd=i(An," special method."),An.forEach(t),qd=d(Ke),b(Vt.$$.fragment,Ke),Cd=d(Ke),zs=s(Ke,"P",{});var Xf=a(zs);zd=i(Xf,"Example:"),Xf.forEach(t),Pd=d(Ke),b(Jo.$$.fragment,Ke),jd=d(Ke),b(en.$$.fragment,Ke),Ke.forEach(t),ke.forEach(t),la=d(o),Xt=s(o,"H2",{class:!0});var Ha=a(Xt);Ut=s(Ha,"A",{id:!0,class:!0,href:!0});var Mf=a(Ut);Ps=s(Mf,"SPAN",{});var Ef=a(Ps);b(tn.$$.fragment,Ef),Ef.forEach(t),Mf.forEach(t),Od=d(Ha),js=s(Ha,"SPAN",{});var Ff=a(js);Sd=i(Ff,"Internal Layers"),Ff.forEach(t),Ha.forEach(t),da=d(o),on=s(o,"DIV",{class:!0});var qf=a(on);b(nn.$$.fragment,qf),qf.forEach(t),ca=d(o),sn=s(o,"DIV",{class:!0});var Cf=a(sn);b(an.$$.fragment,Cf),Cf.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(Gf)),c(g,"id","transformer-xl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#transformer-xl"),c(u,"class","relative group"),c(z,"id","overview"),c(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(z,"href","#overview"),c(x,"class","relative group"),c(ne,"href","https://arxiv.org/abs/1901.02860"),c(ne,"rel","nofollow"),c(p,"href","https://huggingface.co/thomwolf"),c(p,"rel","nofollow"),c(be,"href","https://github.com/kimiyoung/transformer-xl"),c(be,"rel","nofollow"),c(S,"id","transformers.TransfoXLConfig"),c(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(S,"href","#transformers.TransfoXLConfig"),c(P,"class","relative group"),c(cn,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLModel"),c(fn,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TFTransfoXLModel"),c(Gt,"href","https://huggingface.co/transfo-xl-wt103"),c(Gt,"rel","nofollow"),c(pn,"href","/docs/transformers/pr_16892/en/main_classes/configuration#transformers.PretrainedConfig"),c(hn,"href","/docs/transformers/pr_16892/en/main_classes/configuration#transformers.PretrainedConfig"),c(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Mt,"id","transformers.TransfoXLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.TransfoXLTokenizer"),c(dt,"class","relative group"),c(eo,"href","https://github.com/kimiyoung/transformer-xl"),c(eo,"rel","nofollow"),c(mn,"href","/docs/transformers/pr_16892/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(un,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Et,"id","transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(ct,"class","relative group"),c(ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ft,"id","transformers.TransfoXLModel"),c(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ft,"href","#transformers.TransfoXLModel"),c(ut,"class","relative group"),c(gn,"href","/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel"),c(ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ho,"rel","nofollow"),c(_n,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLModel"),c(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ct,"id","transformers.TransfoXLLMHeadModel"),c(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ct,"href","#transformers.TransfoXLLMHeadModel"),c(_t,"class","relative group"),c(Tn,"href","/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel"),c(bo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(bo,"rel","nofollow"),c(vn,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLLMHeadModel"),c(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Pt,"id","transformers.TransfoXLForSequenceClassification"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.TransfoXLForSequenceClassification"),c(vt,"class","relative group"),c(wn,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLForSequenceClassification"),c(yn,"href","/docs/transformers/pr_16892/en/main_classes/model#transformers.PreTrainedModel"),c(Xo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Xo,"rel","nofollow"),c(Ln,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TransfoXLForSequenceClassification"),c(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ot,"id","transformers.TFTransfoXLModel"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.TFTransfoXLModel"),c(wt,"class","relative group"),c(kn,"href","/docs/transformers/pr_16892/en/main_classes/model#transformers.TFPreTrainedModel"),c(So,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(So,"rel","nofollow"),c($n,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TFTransfoXLModel"),c(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(At,"id","transformers.TFTransfoXLLMHeadModel"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.TFTransfoXLLMHeadModel"),c(Lt,"class","relative group"),c(xn,"href","/docs/transformers/pr_16892/en/main_classes/model#transformers.TFPreTrainedModel"),c(Vo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Vo,"rel","nofollow"),c(Xn,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TFTransfoXLLMHeadModel"),c(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(It,"id","transformers.TFTransfoXLForSequenceClassification"),c(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(It,"href","#transformers.TFTransfoXLForSequenceClassification"),c($t,"class","relative group"),c(En,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TFTransfoXLForSequenceClassification"),c(Fn,"href","/docs/transformers/pr_16892/en/main_classes/model#transformers.TFPreTrainedModel"),c(Qo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Qo,"rel","nofollow"),c(qn,"href","/docs/transformers/pr_16892/en/model_doc/transfo-xl#transformers.TFTransfoXLForSequenceClassification"),c(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ut,"id","transformers.AdaptiveEmbedding"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.AdaptiveEmbedding"),c(Xt,"class","relative group"),c(on,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(sn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,m){e(document.head,h),f(o,M,m),f(o,u,m),e(u,g),e(g,$),w(_,$,null),e(u,T),e(u,X),e(X,I),f(o,W,m),f(o,x,m),e(x,z),e(z,O),w(K,O,null),e(x,ae),e(x,V),e(V,$e),f(o,ge,m),f(o,U,m),e(U,N),e(U,ne),e(ne,re),e(U,F),f(o,C,m),f(o,ie,m),e(ie,Q),f(o,_e,m),f(o,le,m),e(le,B),e(B,xe),f(o,Te,m),f(o,q,m),e(q,Xe),f(o,G,m),f(o,oe,m),e(oe,fe),e(fe,Z),e(oe,Me),e(oe,pe),e(pe,A),f(o,ve,m),f(o,j,m),e(j,Ee),e(j,p),e(p,E),e(j,de),e(j,be),e(be,Ve),e(j,H),f(o,Ae,m),w(he,o,m),f(o,He,m),f(o,P,m),e(P,S),e(S,Ce),w(we,Ce,null),e(P,J),e(P,ze),e(ze,Ue),f(o,ye,m),f(o,D,m),w(Kt,D,null),e(D,Da),e(D,Ye),e(Ye,Ia),e(Ye,cn),e(cn,Wa),e(Ye,Va),e(Ye,fn),e(fn,Ua),e(Ye,Ba),e(Ye,Gt),e(Gt,Ra),e(Ye,Ka),e(D,Ga),e(D,lt),e(lt,Ya),e(lt,pn),e(pn,Qa),e(lt,Za),e(lt,hn),e(hn,Ja),e(lt,er),e(D,tr),e(D,Hn),e(Hn,or),e(D,nr),w(Yt,D,null),f(o,Ws,m),f(o,dt,m),e(dt,Mt),e(Mt,Dn),w(Qt,Dn,null),e(dt,sr),e(dt,In),e(In,ar),f(o,Vs,m),f(o,De,m),w(Zt,De,null),e(De,rr),e(De,Jt),e(Jt,ir),e(Jt,eo),e(eo,lr),e(Jt,dr),e(De,cr),e(De,to),e(to,fr),e(to,mn),e(mn,pr),e(to,hr),e(De,mr),e(De,un),w(oo,un,null),f(o,Us,m),f(o,ct,m),e(ct,Et),e(Et,Wn),w(no,Wn,null),e(ct,ur),e(ct,Vn),e(Vn,gr),f(o,Bs,m),f(o,ft,m),w(so,ft,null),e(ft,_r),e(ft,Un),e(Un,Tr),f(o,Rs,m),f(o,pt,m),w(ao,pt,null),e(pt,vr),e(pt,Bn),e(Bn,br),f(o,Ks,m),f(o,ht,m),w(ro,ht,null),e(ht,wr),e(ht,Rn),e(Rn,yr),f(o,Gs,m),f(o,mt,m),w(io,mt,null),e(mt,Lr),e(mt,Kn),e(Kn,kr),f(o,Ys,m),f(o,ut,m),e(ut,Ft),e(Ft,Gn),w(lo,Gn,null),e(ut,$r),e(ut,Yn),e(Yn,xr),f(o,Qs,m),f(o,Fe,m),w(co,Fe,null),e(Fe,Xr),e(Fe,Qn),e(Qn,Mr),e(Fe,Er),e(Fe,fo),e(fo,Fr),e(fo,gn),e(gn,qr),e(fo,Cr),e(Fe,zr),e(Fe,po),e(po,Pr),e(po,ho),e(ho,jr),e(po,Or),e(Fe,Sr),e(Fe,Pe),w(mo,Pe,null),e(Pe,Nr),e(Pe,gt),e(gt,Ar),e(gt,_n),e(_n,Hr),e(gt,Dr),e(gt,Zn),e(Zn,Ir),e(gt,Wr),e(Pe,Vr),w(qt,Pe,null),e(Pe,Ur),e(Pe,Jn),e(Jn,Br),e(Pe,Rr),w(uo,Pe,null),f(o,Zs,m),f(o,_t,m),e(_t,Ct),e(Ct,es),w(go,es,null),e(_t,Kr),e(_t,ts),e(ts,Gr),f(o,Js,m),f(o,qe,m),w(_o,qe,null),e(qe,Yr),e(qe,os),e(os,Qr),e(qe,Zr),e(qe,To),e(To,Jr),e(To,Tn),e(Tn,ei),e(To,ti),e(qe,oi),e(qe,vo),e(vo,ni),e(vo,bo),e(bo,si),e(vo,ai),e(qe,ri),e(qe,je),w(wo,je,null),e(je,ii),e(je,Tt),e(Tt,li),e(Tt,vn),e(vn,di),e(Tt,ci),e(Tt,ns),e(ns,fi),e(Tt,pi),e(je,hi),w(zt,je,null),e(je,mi),e(je,ss),e(ss,ui),e(je,gi),w(yo,je,null),f(o,ea,m),f(o,vt,m),e(vt,Pt),e(Pt,as),w(Lo,as,null),e(vt,_i),e(vt,rs),e(rs,Ti),f(o,ta,m),f(o,se,m),w(ko,se,null),e(se,vi),e(se,is),e(is,bi),e(se,wi),e(se,bn),e(bn,wn),e(wn,yi),e(bn,Li),e(se,ki),e(se,Ie),e(Ie,$i),e(Ie,ls),e(ls,xi),e(Ie,Xi),e(Ie,ds),e(ds,Mi),e(Ie,Ei),e(Ie,cs),e(cs,Fi),e(Ie,qi),e(Ie,fs),e(fs,Ci),e(Ie,zi),e(se,Pi),e(se,$o),e($o,ji),e($o,yn),e(yn,Oi),e($o,Si),e(se,Ni),e(se,xo),e(xo,Ai),e(xo,Xo),e(Xo,Hi),e(xo,Di),e(se,Ii),e(se,Y),w(Mo,Y,null),e(Y,Wi),e(Y,bt),e(bt,Vi),e(bt,Ln),e(Ln,Ui),e(bt,Bi),e(bt,ps),e(ps,Ri),e(bt,Ki),e(Y,Gi),w(jt,Y,null),e(Y,Yi),e(Y,hs),e(hs,Qi),e(Y,Zi),w(Eo,Y,null),e(Y,Ji),w(Fo,Y,null),e(Y,el),e(Y,ms),e(ms,tl),e(Y,ol),w(qo,Y,null),e(Y,nl),w(Co,Y,null),f(o,oa,m),f(o,wt,m),e(wt,Ot),e(Ot,us),w(zo,us,null),e(wt,sl),e(wt,gs),e(gs,al),f(o,na,m),f(o,me,m),w(Po,me,null),e(me,rl),e(me,_s),e(_s,il),e(me,ll),e(me,jo),e(jo,dl),e(jo,kn),e(kn,cl),e(jo,fl),e(me,pl),e(me,Oo),e(Oo,hl),e(Oo,So),e(So,ml),e(Oo,ul),e(me,gl),w(St,me,null),e(me,_l),e(me,Oe),w(No,Oe,null),e(Oe,Tl),e(Oe,yt),e(yt,vl),e(yt,$n),e($n,bl),e(yt,wl),e(yt,Ts),e(Ts,yl),e(yt,Ll),e(Oe,kl),w(Nt,Oe,null),e(Oe,$l),e(Oe,vs),e(vs,xl),e(Oe,Xl),w(Ao,Oe,null),f(o,sa,m),f(o,Lt,m),e(Lt,At),e(At,bs),w(Ho,bs,null),e(Lt,Ml),e(Lt,ws),e(ws,El),f(o,aa,m),f(o,ue,m),w(Do,ue,null),e(ue,Fl),e(ue,ys),e(ys,ql),e(ue,Cl),e(ue,Io),e(Io,zl),e(Io,xn),e(xn,Pl),e(Io,jl),e(ue,Ol),e(ue,Wo),e(Wo,Sl),e(Wo,Vo),e(Vo,Nl),e(Wo,Al),e(ue,Hl),w(Ht,ue,null),e(ue,Dl),e(ue,Se),w(Uo,Se,null),e(Se,Il),e(Se,kt),e(kt,Wl),e(kt,Xn),e(Xn,Vl),e(kt,Ul),e(kt,Ls),e(Ls,Bl),e(kt,Rl),e(Se,Kl),w(Dt,Se,null),e(Se,Gl),e(Se,ks),e(ks,Yl),e(Se,Ql),w(Bo,Se,null),f(o,ra,m),f(o,$t,m),e($t,It),e(It,$s),w(Ro,$s,null),e($t,Zl),e($t,xs),e(xs,Jl),f(o,ia,m),f(o,ee,m),w(Ko,ee,null),e(ee,ed),e(ee,Xs),e(Xs,td),e(ee,od),e(ee,Mn),e(Mn,En),e(En,nd),e(Mn,sd),e(ee,ad),e(ee,We),e(We,rd),e(We,Ms),e(Ms,id),e(We,ld),e(We,Es),e(Es,dd),e(We,cd),e(We,Fs),e(Fs,fd),e(We,pd),e(We,qs),e(qs,hd),e(We,md),e(ee,ud),e(ee,Go),e(Go,gd),e(Go,Fn),e(Fn,_d),e(Go,Td),e(ee,vd),e(ee,Yo),e(Yo,bd),e(Yo,Qo),e(Qo,wd),e(Yo,yd),e(ee,Ld),w(Wt,ee,null),e(ee,kd),e(ee,Le),w(Zo,Le,null),e(Le,$d),e(Le,xt),e(xt,xd),e(xt,qn),e(qn,Xd),e(xt,Md),e(xt,Cs),e(Cs,Ed),e(xt,Fd),e(Le,qd),w(Vt,Le,null),e(Le,Cd),e(Le,zs),e(zs,zd),e(Le,Pd),w(Jo,Le,null),e(Le,jd),w(en,Le,null),f(o,la,m),f(o,Xt,m),e(Xt,Ut),e(Ut,Ps),w(tn,Ps,null),e(Xt,Od),e(Xt,js),e(js,Sd),f(o,da,m),f(o,on,m),w(nn,on,null),f(o,ca,m),f(o,sn,m),w(an,sn,null),fa=!0},p(o,[m]){const rn={};m&2&&(rn.$$scope={dirty:m,ctx:o}),he.$set(rn);const Os={};m&2&&(Os.$$scope={dirty:m,ctx:o}),qt.$set(Os);const Ss={};m&2&&(Ss.$$scope={dirty:m,ctx:o}),zt.$set(Ss);const Ns={};m&2&&(Ns.$$scope={dirty:m,ctx:o}),jt.$set(Ns);const ln={};m&2&&(ln.$$scope={dirty:m,ctx:o}),St.$set(ln);const As={};m&2&&(As.$$scope={dirty:m,ctx:o}),Nt.$set(As);const Hs={};m&2&&(Hs.$$scope={dirty:m,ctx:o}),Ht.$set(Hs);const Ds={};m&2&&(Ds.$$scope={dirty:m,ctx:o}),Dt.$set(Ds);const dn={};m&2&&(dn.$$scope={dirty:m,ctx:o}),Wt.$set(dn);const Is={};m&2&&(Is.$$scope={dirty:m,ctx:o}),Vt.$set(Is)},i(o){fa||(y(_.$$.fragment,o),y(K.$$.fragment,o),y(he.$$.fragment,o),y(we.$$.fragment,o),y(Kt.$$.fragment,o),y(Yt.$$.fragment,o),y(Qt.$$.fragment,o),y(Zt.$$.fragment,o),y(oo.$$.fragment,o),y(no.$$.fragment,o),y(so.$$.fragment,o),y(ao.$$.fragment,o),y(ro.$$.fragment,o),y(io.$$.fragment,o),y(lo.$$.fragment,o),y(co.$$.fragment,o),y(mo.$$.fragment,o),y(qt.$$.fragment,o),y(uo.$$.fragment,o),y(go.$$.fragment,o),y(_o.$$.fragment,o),y(wo.$$.fragment,o),y(zt.$$.fragment,o),y(yo.$$.fragment,o),y(Lo.$$.fragment,o),y(ko.$$.fragment,o),y(Mo.$$.fragment,o),y(jt.$$.fragment,o),y(Eo.$$.fragment,o),y(Fo.$$.fragment,o),y(qo.$$.fragment,o),y(Co.$$.fragment,o),y(zo.$$.fragment,o),y(Po.$$.fragment,o),y(St.$$.fragment,o),y(No.$$.fragment,o),y(Nt.$$.fragment,o),y(Ao.$$.fragment,o),y(Ho.$$.fragment,o),y(Do.$$.fragment,o),y(Ht.$$.fragment,o),y(Uo.$$.fragment,o),y(Dt.$$.fragment,o),y(Bo.$$.fragment,o),y(Ro.$$.fragment,o),y(Ko.$$.fragment,o),y(Wt.$$.fragment,o),y(Zo.$$.fragment,o),y(Vt.$$.fragment,o),y(Jo.$$.fragment,o),y(en.$$.fragment,o),y(tn.$$.fragment,o),y(nn.$$.fragment,o),y(an.$$.fragment,o),fa=!0)},o(o){L(_.$$.fragment,o),L(K.$$.fragment,o),L(he.$$.fragment,o),L(we.$$.fragment,o),L(Kt.$$.fragment,o),L(Yt.$$.fragment,o),L(Qt.$$.fragment,o),L(Zt.$$.fragment,o),L(oo.$$.fragment,o),L(no.$$.fragment,o),L(so.$$.fragment,o),L(ao.$$.fragment,o),L(ro.$$.fragment,o),L(io.$$.fragment,o),L(lo.$$.fragment,o),L(co.$$.fragment,o),L(mo.$$.fragment,o),L(qt.$$.fragment,o),L(uo.$$.fragment,o),L(go.$$.fragment,o),L(_o.$$.fragment,o),L(wo.$$.fragment,o),L(zt.$$.fragment,o),L(yo.$$.fragment,o),L(Lo.$$.fragment,o),L(ko.$$.fragment,o),L(Mo.$$.fragment,o),L(jt.$$.fragment,o),L(Eo.$$.fragment,o),L(Fo.$$.fragment,o),L(qo.$$.fragment,o),L(Co.$$.fragment,o),L(zo.$$.fragment,o),L(Po.$$.fragment,o),L(St.$$.fragment,o),L(No.$$.fragment,o),L(Nt.$$.fragment,o),L(Ao.$$.fragment,o),L(Ho.$$.fragment,o),L(Do.$$.fragment,o),L(Ht.$$.fragment,o),L(Uo.$$.fragment,o),L(Dt.$$.fragment,o),L(Bo.$$.fragment,o),L(Ro.$$.fragment,o),L(Ko.$$.fragment,o),L(Wt.$$.fragment,o),L(Zo.$$.fragment,o),L(Vt.$$.fragment,o),L(Jo.$$.fragment,o),L(en.$$.fragment,o),L(tn.$$.fragment,o),L(nn.$$.fragment,o),L(an.$$.fragment,o),fa=!1},d(o){t(h),o&&t(M),o&&t(u),k(_),o&&t(W),o&&t(x),k(K),o&&t(ge),o&&t(U),o&&t(C),o&&t(ie),o&&t(_e),o&&t(le),o&&t(Te),o&&t(q),o&&t(G),o&&t(oe),o&&t(ve),o&&t(j),o&&t(Ae),k(he,o),o&&t(He),o&&t(P),k(we),o&&t(ye),o&&t(D),k(Kt),k(Yt),o&&t(Ws),o&&t(dt),k(Qt),o&&t(Vs),o&&t(De),k(Zt),k(oo),o&&t(Us),o&&t(ct),k(no),o&&t(Bs),o&&t(ft),k(so),o&&t(Rs),o&&t(pt),k(ao),o&&t(Ks),o&&t(ht),k(ro),o&&t(Gs),o&&t(mt),k(io),o&&t(Ys),o&&t(ut),k(lo),o&&t(Qs),o&&t(Fe),k(co),k(mo),k(qt),k(uo),o&&t(Zs),o&&t(_t),k(go),o&&t(Js),o&&t(qe),k(_o),k(wo),k(zt),k(yo),o&&t(ea),o&&t(vt),k(Lo),o&&t(ta),o&&t(se),k(ko),k(Mo),k(jt),k(Eo),k(Fo),k(qo),k(Co),o&&t(oa),o&&t(wt),k(zo),o&&t(na),o&&t(me),k(Po),k(St),k(No),k(Nt),k(Ao),o&&t(sa),o&&t(Lt),k(Ho),o&&t(aa),o&&t(ue),k(Do),k(Ht),k(Uo),k(Dt),k(Bo),o&&t(ra),o&&t($t),k(Ro),o&&t(ia),o&&t(ee),k(Ko),k(Wt),k(Zo),k(Vt),k(Jo),k(en),o&&t(la),o&&t(Xt),k(tn),o&&t(da),o&&t(on),k(nn),o&&t(ca),o&&t(sn),k(an)}}}const Gf={local:"transformer-xl",sections:[{local:"overview",title:"Overview"},{local:"transformers.TransfoXLConfig",title:"TransfoXLConfig"},{local:"transformers.TransfoXLTokenizer",title:"TransfoXLTokenizer"},{local:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput",title:"TransfoXL specific outputs"},{local:"transformers.TransfoXLModel",title:"TransfoXLModel"},{local:"transformers.TransfoXLLMHeadModel",title:"TransfoXLLMHeadModel"},{local:"transformers.TransfoXLForSequenceClassification",title:"TransfoXLForSequenceClassification"},{local:"transformers.TFTransfoXLModel",title:"TFTransfoXLModel"},{local:"transformers.TFTransfoXLLMHeadModel",title:"TFTransfoXLLMHeadModel"},{local:"transformers.TFTransfoXLForSequenceClassification",title:"TFTransfoXLForSequenceClassification"},{local:"transformers.AdaptiveEmbedding",title:"Internal Layers"}],title:"Transformer XL"};function Yf(R){return Sf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class op extends zf{constructor(h){super();Pf(this,h,Yf,Kf,jf,{})}}export{op as default,Gf as metadata};
