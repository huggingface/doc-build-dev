...
<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new ye({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),rn=new ve({}),an=new U({props:{name:"class transformers.DistilBertTokenizer",anchor:"transformers.DistilBertTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/tokenization_distilbert.py#L56"}}),dn=new ve({}),cn=new U({props:{name:"class transformers.DistilBertTokenizerFast",anchor:"transformers.DistilBertTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/tokenization_distilbert_fast.py#L65"}}),un=new ve({}),fn=new U({props:{name:"class transformers.DistilBertModel",anchor:"transformers.DistilBertModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L435",parametersDescription:[{anchor:"transformers.DistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new U({props:{name:"forward",anchor:"transformers.DistilBertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L507",parametersDescription:[{anchor:"transformers.DistilBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Tn=new ve({}),kn=new U({props:{name:"class transformers.DistilBertForMaskedLM",anchor:"transformers.DistilBertForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L563",parametersDescription:[{anchor:"transformers.DistilBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yn=new U({props:{name:"forward",anchor:"transformers.DistilBertForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L603",parametersDescription:[{anchor:"transformers.DistilBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),An=new ve({}),In=new U({props:{name:"class transformers.DistilBertForMultipleChoice",anchor:"transformers.DistilBertForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L997",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),On=new U({props:{name:"forward",anchor:"transformers.DistilBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L1029",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Rn=new ve({}),Hn=new U({props:{name:"class transformers.DistilBertForTokenClassification",anchor:"transformers.DistilBertForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L902",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jn=new U({props:{name:"forward",anchor:"transformers.DistilBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_distilbert.py#L934",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),or=new ve({}),nr=new U({props:{name:"class transformers.TFDistilBertModel",anchor:"transformers.TFDistilBertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L536",parametersDescription:[{anchor:"transformers.TFDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new me({props:{$$slots:{default:[my]},$$scope:{ctx:j}}}),lr=new U({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L541",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),vr=new ve({}),br=new U({props:{name:"class transformers.TFDistilBertForSequenceClassification",anchor:"transformers.TFDistilBertForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L740",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new me({props:{$$slots:{default:[by]},$$scope:{ctx:j}}}),$r=new U({props:{name:"call",anchor:"transformers.TFDistilBertForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L757",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Fr=new ve({}),yr=new U({props:{name:"class transformers.TFDistilBertForMultipleChoice",anchor:"transformers.TFDistilBertForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L931",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new me({props:{$$slots:{default:[ky]},$$scope:{ctx:j}}}),zr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L957",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jr=new ve({}),Cr=new U({props:{name:"class transformers.TFDistilBertForTokenClassification",anchor:"transformers.TFDistilBertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L841",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new me({props:{$$slots:{default:[$y]},$$scope:{ctx:j}}}),Ir=new U({props:{name:"call",anchor:"transformers.TFDistilBertForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L852",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Lr=new ve({}),Sr=new U({props:{name:"class transformers.TFDistilBertForQuestionAnswering",anchor:"transformers.TFDistilBertForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1073",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Mo=new me({props:{$$slots:{default:[Fy]},$$scope:{ctx:j}}}),Hr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1084",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ua=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Da=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qa=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oi=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_36/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_36/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
general usage and behavior.`),Zb=l(),Nd=o("p"),eT=a("Finally, this model supports inherent JAX features such as:"),tT=l(),Bt=o("ul"),Ld=o("li"),Xr=o("a"),sT=a("Just-In-Time (JIT) compilation"),oT=l(),Sd=o("li"),Yr=o("a"),nT=a("Automatic Differentiation"),rT=l(),Od=o("li"),Zr=o("a"),aT=a("Vectorization"),iT=l(),Wd=o("li"),ea=o("a"),lT=a("Parallelization"),dT=l(),nt=o("div"),T(ta.$$.fragment),cT=l(),Is=o("p"),pT=a("The "),Rd=o("code"),hT=a("FlaxDistilBertPreTrainedModel"),uT=a("forward method, overrides the "),Hd=o("code"),fT=a("__call__"),mT=a(" special method."),gT=l(),T(jo.$$.fragment),_T=l(),Qd=o("p"),vT=a("Example:"),bT=l(),T(sa.$$.fragment),Up=l(),Ns=o("h2"),Co=o("a"),Ud=o("span"),T(oa.$$.fragment),TT=l(),Vd=o("span"),kT=a("FlaxDistilBertForMaskedLM"),Vp=l(),Ee=o("div"),T(na.$$.fragment),wT=l(),ra=o("p"),$T=a("DistilBert Model with a "),Jd=o("code"),DT=a("language modeling"),FT=a(" head on top."),yT=l(),aa=o("p"),BT=a("This model inherits from "),Hi=o("a"),ET=a("FlaxPreTrainedModel"),MT=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),zT=l(),ia=o("p"),xT=a("This model is also a Flax Linen "),la=o("a"),jT=a("flax.linen.Module"),CT=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),PT=l(),Kd=o("p"),qT=a("Finally, this model supports inherent JAX features such as:"),AT=l(),Et=o("ul"),Gd=o("li"),da=o("a"),IT=a("Just-In-Time (JIT) compilation"),NT=l(),Xd=o("li"),ca=o("a"),LT=a("Automatic Differentiation"),ST=l(),Yd=o("li"),pa=o("a"),OT=a("Vectorization"),WT=l(),Zd=o("li"),ha=o("a"),RT=a("Parallelization"),HT=l(),rt=o("div"),T(ua.$$.fragment),QT=l(),Ls=o("p"),UT=a("The "),ec=o("code"),VT=a("FlaxDistilBertPreTrainedModel"),JT=a("forward method, overrides the "),tc=o("code"),KT=a("__call__"),GT=a(" special method."),XT=l(),T(Po.$$.fragment),YT=l(),sc=o("p"),ZT=a("Example:"),ek=l(),T(fa.$$.fragment),Jp=l(),Ss=o("h2"),qo=o("a"),oc=o("span"),T(ma.$$.fragment),tk=l(),nc=o("span"),sk=a("FlaxDistilBertForSequenceClassification"),Kp=l(),Me=o("div"),T(ga.$$.fragment),ok=l(),rc=o("p"),nk=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),dk=l(),va=o("p"),ck=a("This model is also a Flax Linen "),ba=o("a"),pk=a("flax.linen.Module"),hk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uk=l(),ac=o("p"),fk=a("Finally, this model supports inherent JAX features such as:"),mk=l(),Mt=o("ul"),ic=o("li"),Ta=o("a"),gk=a("Just-In-Time (JIT) compilation"),_k=l(),lc=o("li"),ka=o("a"),vk=a("Automatic Differentiation"),bk=l(),dc=o("li"),wa=o("a"),Tk=a("Vectorization"),kk=l(),cc=o("li"),$a=o("a"),wk=a("Parallelization"),$k=l(),at=o("div"),T(Da.$$.fragment),Dk=l(),Os=o("p"),Fk=a("The "),pc=o("code"),yk=a("FlaxDistilBertPreTrainedModel"),Bk=a("forward method, overrides the "),hc=o("code"),Ek=a("__call__"),Mk=a(" special method."),zk=l(),T(Ao.$$.fragment),xk=l(),uc=o("p"),jk=a("Example:"),Ck=l(),T(Fa.$$.fragment),Gp=l(),Ws=o("h2"),Io=o("a"),fc=o("span"),T(ya.$$.fragment),Pk=l(),mc=o("span"),qk=a("FlaxDistilBertForMultipleChoice"),Xp=l(),ze=o("div"),T(Ba.$$.fragment),Ak=l(),gc=o("p"),Ik=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Nk=l(),Ea=o("p"),Lk=a("This model inherits from "),Ui=o("a"),Sk=a("FlaxPreTrainedModel"),Ok=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Wk=l(),Ma=o("p"),Rk=a("This model is also a Flax Linen "),za=o("a"),Hk=a("flax.linen.Module"),Qk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Uk=l(),_c=o("p"),Vk=a("Finally, this model supports inherent JAX features such as:"),Jk=l(),zt=o("ul"),vc=o("li"),xa=o("a"),Kk=a("Just-In-Time (JIT) compilation"),Gk=l(),bc=o("li"),ja=o("a"),Xk=a("Automatic Differentiation"),Yk=l(),Tc=o("li"),Ca=o("a"),Zk=a("Vectorization"),ew=l(),kc=o("li"),Pa=o("a"),tw=a("Parallelization"),sw=l(),it=o("div"),T(qa.$$.fragment),ow=l(),Rs=o("p"),nw=a("The "),wc=o("code"),rw=a("FlaxDistilBertPreTrainedModel"),aw=a("forward method, overrides the "),$c=o("code"),iw=a("__call__"),lw=a(" special method."),dw=l(),T(No.$$.fragment),cw=l(),Dc=o("p"),pw=a("Example:"),hw=l(),T(Aa.$$.fragment),Yp=l(),Hs=o("h2"),Lo=o("a"),Fc=o("span"),T(Ia.$$.fragment),uw=l(),yc=o("span"),fw=a("FlaxDistilBertForTokenClassification"),Zp=l(),xe=o("div"),T(Na.$$.fragment),mw=l(),Bc=o("p"),gw=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),_w=l(),La=o("p"),vw=a("This model inherits from "),Vi=o("a"),bw=a("FlaxPreTrainedModel"),Tw=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),kw=l(),Sa=o("p"),ww=a("This model is also a Flax Linen "),Oa=o("a"),$w=a("flax.linen.Module"),Dw=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Fw=l(),Ec=o("p"),yw=a("Finally, this model supports inherent JAX features such as:"),Bw=l(),xt=o("ul"),Mc=o("li"),Wa=o("a"),Ew=a("Just-In-Time (JIT) compilation"),Mw=l(),zc=o("li"),Ra=o("a"),zw=a("Automatic Differentiation"),xw=l(),xc=o("li"),Ha=o("a"),jw=a("Vectorization"),Cw=l(),jc=o("li"),Qa=o("a"),Pw=a("Parallelization"),qw=l(),lt=o("div"),T(Ua.$$.fragment),Aw=l(),Qs=o("p"),Iw=a("The "),Cc=o("code"),Nw=a("FlaxDistilBertPreTrainedModel"),Lw=a("forward method, overrides the "),Pc=o("code"),Sw=a("__call__"),Ow=a(" special method."),Ww=l(),T(So.$$.fragment),Rw=l(),qc=o("p"),Hw=a("Example:"),Qw=l(),T(Va.$$.fragment),eh=l(),Us=o("h2"),Oo=o("a"),Ac=o("span"),T(Ja.$$.fragment),Uw=l(),Ic=o("span"),Vw=a("FlaxDistilBertForQuestionAnswering"),th=l(),je=o("div"),T(Ka.$$.fragment),Jw=l(),Vs=o("p"),Kw=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Nc=o("code"),Gw=a("span start logits"),Xw=a(" and "),Lc=o("code"),Yw=a("span end logits"),Zw=a(")."),e1=l(),Ga=o("p"),t1=a("This model inherits from "),Ji=o("a"),s1=a("FlaxPreTrainedModel"),o1=a(`. Check the superclass documentation for the generic methods the
...
necessary though, just let us know if you need this option.`),li.forEach(t),ii.forEach(t),up=d(s),bt=n(s,"P",{});var qt=r(bt);uu=i(qt,"This model was contributed by "),Yo=n(qt,"A",{href:!0,rel:!0});var M1=r(Yo);fu=i(M1,"victorsanh"),M1.forEach(t),mu=i(qt,`. This model jax version was
contributed by `),Zo=n(qt,"A",{href:!0,rel:!0});var z1=r(Zo);gu=i(z1,"kamalkraj"),z1.forEach(t),_u=i(qt,". The original code can be found "),en=n(qt,"A",{href:!0,rel:!0});var x1=r(en);vu=i(x1,"here"),x1.forEach(t),bu=i(qt,"."),qt.forEach(t),fp=d(s),as=n(s,"H2",{class:!0});var oh=r(as);Ks=n(oh,"A",{id:!0,class:!0,href:!0});var j1=r(Ks);_l=n(j1,"SPAN",{});var C1=r(_l);k(tn.$$.fragment,C1),C1.forEach(t),j1.forEach(t),Tu=d(oh),vl=n(oh,"SPAN",{});var P1=r(vl);ku=i(P1,"DistilBertConfig"),P1.forEach(t),oh.forEach(t),mp=d(s),Se=n(s,"DIV",{class:!0});var At=r(Se);k(sn.$$.fragment,At),wu=d(At),yt=n(At,"P",{});var Ro=r(yt);$u=i(Ro,"This is the configuration class to store the configuration of a "),di=n(Ro,"A",{href:!0});var q1=r(di);Du=i(q1,"DistilBertModel"),q1.forEach(t),Fu=i(Ro," or a "),ci=n(Ro,"A",{href:!0});var A1=r(ci);yu=i(A1,"TFDistilBertModel"),A1.forEach(t),Bu=i(Ro,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
`),on=n(Ro,"A",{href:!0,rel:!0});var I1=r(on);Eu=i(I1,"distilbert-base-uncased"),I1.forEach(t),Mu=i(Ro," architecture."),Ro.forEach(t),zu=d(At),is=n(At,"P",{});var Ki=r(is);xu=i(Ki,"Configuration objects inherit from "),pi=n(Ki,"A",{href:!0});var N1=r(pi);ju=i(N1,"PretrainedConfig"),N1.forEach(t),Cu=i(Ki,` and can be used to control the model outputs. Read the
documentation from `),hi=n(Ki,"A",{href:!0});var L1=r(hi);Pu=i(L1,"PretrainedConfig"),L1.forEach(t),qu=i(Ki," for more information."),Ki.forEach(t),Au=d(At),bl=n(At,"P",{});var S1=r(bl);Iu=i(S1,"Examples:"),S1.forEach(t),Nu=d(At),k(nn.$$.fragment,At),At.forEach(t),gp=d(s),ls=n(s,"H2",{class:!0});var nh=r(ls);Gs=n(nh,"A",{id:!0,class:!0,href:!0});var O1=r(Gs);Tl=n(O1,"SPAN",{});var W1=r(Tl);k(rn.$$.fragment,W1),W1.forEach(t),O1.forEach(t),Lu=d(nh),kl=n(nh,"SPAN",{});var R1=r(kl);Su=i(R1,"DistilBertTokenizer"),R1.forEach(t),nh.forEach(t),_p=d(s),_t=n(s,"DIV",{class:!0});var Ho=r(_t);k(an.$$.fragment,Ho),Ou=d(Ho),wl=n(Ho,"P",{});var H1=r(wl);Wu=i(H1,"Construct a DistilBERT tokenizer."),H1.forEach(t),Ru=d(Ho),Xs=n(Ho,"P",{});var pp=r(Xs);ui=n(pp,"A",{href:!0});var Q1=r(ui);Hu=i(Q1,"DistilBertTokenizer"),Q1.forEach(t),Qu=i(pp," is identical to "),fi=n(pp,"A",{href:!0});var U1=r(fi);Uu=i(U1,"BertTokenizer"),U1.forEach(t),Vu=i(pp,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),pp.forEach(t),Ju=d(Ho),ln=n(Ho,"P",{});var rh=r(ln);Ku=i(rh,"Refer to superclass "),mi=n(rh,"A",{href:!0});var V1=r(mi);Gu=i(V1,"BertTokenizer"),V1.forEach(t),Xu=i(rh," for usage examples and documentation concerning parameters."),rh.forEach(t),Ho.forEach(t),vp=d(s),ds=n(s,"H2",{class:!0});var ah=r(ds);Ys=n(ah,"A",{id:!0,class:!0,href:!0});var J1=r(Ys);$l=n(J1,"SPAN",{});var K1=r($l);k(dn.$$.fragment,K1),K1.forEach(t),J1.forEach(t),Yu=d(ah),Dl=n(ah,"SPAN",{});var G1=r(Dl);Zu=i(G1,"DistilBertTokenizerFast"),G1.forEach(t),ah.forEach(t),bp=d(s),vt=n(s,"DIV",{class:!0});var Qo=r(vt);k(cn.$$.fragment,Qo),ef=d(Qo),pn=n(Qo,"P",{});var ih=r(pn);tf=i(ih,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Fl=n(ih,"EM",{});var X1=r(Fl);sf=i(X1,"tokenizers"),X1.forEach(t),of=i(ih," library)."),ih.forEach(t),nf=d(Qo),Zs=n(Qo,"P",{});var hp=r(Zs);gi=n(hp,"A",{href:!0});var Y1=r(gi);rf=i(Y1,"DistilBertTokenizerFast"),Y1.forEach(t),af=i(hp," is identical to "),_i=n(hp,"A",{href:!0});var Z1=r(_i);lf=i(Z1,"BertTokenizerFast"),Z1.forEach(t),df=i(hp,` and runs end-to-end tokenization: punctuation
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kh.forEach(t),Zb=d(pt),Nd=n(pt,"P",{});var c2=r(Nd);eT=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),tT=d(pt),Bt=n(pt,"UL",{});var Uo=r(Bt);Ld=n(Uo,"LI",{});var p2=r(Ld);Xr=n(p2,"A",{href:!0,rel:!0});var h2=r(Xr);sT=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),oT=d(Uo),Sd=n(Uo,"LI",{});var u2=r(Sd);Yr=n(u2,"A",{href:!0,rel:!0});var f2=r(Yr);nT=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),rT=d(Uo),Od=n(Uo,"LI",{});var m2=r(Od);Zr=n(m2,"A",{href:!0,rel:!0});var g2=r(Zr);aT=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),iT=d(Uo),Wd=n(Uo,"LI",{});var _2=r(Wd);ea=n(_2,"A",{href:!0,rel:!0});var v2=r(ea);lT=i(v2,"Parallelization"),v2.forEach(t),_2.forEach(t),Uo.forEach(t),dT=d(pt),nt=n(pt,"DIV",{class:!0});var es=r(nt);k(ta.$$.fragment,es),cT=d(es),Is=n(es,"P",{});var cl=r(Is);pT=i(cl,"The "),Rd=n(cl,"CODE",{});var b2=r(Rd);hT=i(b2,"FlaxDistilBertPreTrainedModel"),b2.forEach(t),uT=i(cl,"forward method, overrides the "),Hd=n(cl,"CODE",{});var T2=r(Hd);fT=i(T2,"__call__"),T2.forEach(t),mT=i(cl," special method."),cl.forEach(t),gT=d(es),k(jo.$$.fragment,es),_T=d(es),Qd=n(es,"P",{});var k2=r(Qd);vT=i(k2,"Example:"),k2.forEach(t),bT=d(es),k(sa.$$.fragment,es),es.forEach(t),pt.forEach(t),Up=d(s),Ns=n(s,"H2",{class:!0});var Gh=r(Ns);Co=n(Gh,"A",{id:!0,class:!0,href:!0});var w2=r(Co);Ud=n(w2,"SPAN",{});var $2=r(Ud);k(oa.$$.fragment,$2),$2.forEach(t),w2.forEach(t),TT=d(Gh),Vd=n(Gh,"SPAN",{});var D2=r(Vd);kT=i(D2,"FlaxDistilBertForMaskedLM"),D2.forEach(t),Gh.forEach(t),Vp=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(na.$$.fragment,ht),wT=d(ht),ra=n(ht,"P",{});var Xh=r(ra);$T=i(Xh,"DistilBert Model with a "),Jd=n(Xh,"CODE",{});var F2=r(Jd);DT=i(F2,"language modeling"),F2.forEach(t),FT=i(Xh," head on top."),Xh.forEach(t),yT=d(ht),aa=n(ht,"P",{});var Yh=r(aa);BT=i(Yh,"This model inherits from "),Hi=n(Yh,"A",{href:!0});var y2=r(Hi);ET=i(y2,"FlaxPreTrainedModel"),y2.forEach(t),MT=i(Yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yh.forEach(t),zT=d(ht),ia=n(ht,"P",{});var Zh=r(ia);xT=i(Zh,"This model is also a Flax Linen "),la=n(Zh,"A",{href:!0,rel:!0});var B2=r(la);jT=i(B2,"flax.linen.Module"),B2.forEach(t),CT=i(Zh,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zh.forEach(t),PT=d(ht),Kd=n(ht,"P",{});var E2=r(Kd);qT=i(E2,"Finally, this model supports inherent JAX features such as:"),E2.forEach(t),AT=d(ht),Et=n(ht,"UL",{});var Vo=r(Et);Gd=n(Vo,"LI",{});var M2=r(Gd);da=n(M2,"A",{href:!0,rel:!0});var z2=r(da);IT=i(z2,"Just-In-Time (JIT) compilation"),z2.forEach(t),M2.forEach(t),NT=d(Vo),Xd=n(Vo,"LI",{});var x2=r(Xd);ca=n(x2,"A",{href:!0,rel:!0});var j2=r(ca);LT=i(j2,"Automatic Differentiation"),j2.forEach(t),x2.forEach(t),ST=d(Vo),Yd=n(Vo,"LI",{});var C2=r(Yd);pa=n(C2,"A",{href:!0,rel:!0});var P2=r(pa);OT=i(P2,"Vectorization"),P2.forEach(t),C2.forEach(t),WT=d(Vo),Zd=n(Vo,"LI",{});var q2=r(Zd);ha=n(q2,"A",{href:!0,rel:!0});var A2=r(ha);RT=i(A2,"Parallelization"),A2.forEach(t),q2.forEach(t),Vo.forEach(t),HT=d(ht),rt=n(ht,"DIV",{class:!0});var ts=r(rt);k(ua.$$.fragment,ts),QT=d(ts),Ls=n(ts,"P",{});var pl=r(Ls);UT=i(pl,"The "),ec=n(pl,"CODE",{});var I2=r(ec);VT=i(I2,"FlaxDistilBertPreTrainedModel"),I2.forEach(t),JT=i(pl,"forward method, overrides the "),tc=n(pl,"CODE",{});var N2=r(tc);KT=i(N2,"__call__"),N2.forEach(t),GT=i(pl," special method."),pl.forEach(t),XT=d(ts),k(Po.$$.fragment,ts),YT=d(ts),sc=n(ts,"P",{});var L2=r(sc);ZT=i(L2,"Example:"),L2.forEach(t),ek=d(ts),k(fa.$$.fragment,ts),ts.forEach(t),ht.forEach(t),Jp=d(s),Ss=n(s,"H2",{class:!0});var eu=r(Ss);qo=n(eu,"A",{id:!0,class:!0,href:!0});var S2=r(qo);oc=n(S2,"SPAN",{});var O2=r(oc);k(ma.$$.fragment,O2),O2.forEach(t),S2.forEach(t),tk=d(eu),nc=n(eu,"SPAN",{});var W2=r(nc);sk=i(W2,"FlaxDistilBertForSequenceClassification"),W2.forEach(t),eu.forEach(t),Kp=d(s),Me=n(s,"DIV",{class:!0});var ut=r(Me);k(ga.$$.fragment,ut),ok=d(ut),rc=n(ut,"P",{});var R2=r(rc);nk=i(R2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tu.forEach(t),dk=d(ut),va=n(ut,"P",{});var su=r(va);ck=i(su,"This model is also a Flax Linen "),ba=n(su,"A",{href:!0,rel:!0});var Q2=r(ba);pk=i(Q2,"flax.linen.Module"),Q2.forEach(t),hk=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),uk=d(ut),ac=n(ut,"P",{});var U2=r(ac);fk=i(U2,"Finally, this model supports inherent JAX features such as:"),U2.forEach(t),mk=d(ut),Mt=n(ut,"UL",{});var Jo=r(Mt);ic=n(Jo,"LI",{});var V2=r(ic);Ta=n(V2,"A",{href:!0,rel:!0});var J2=r(Ta);gk=i(J2,"Just-In-Time (JIT) compilation"),J2.forEach(t),V2.forEach(t),_k=d(Jo),lc=n(Jo,"LI",{});var K2=r(lc);ka=n(K2,"A",{href:!0,rel:!0});var G2=r(ka);vk=i(G2,"Automatic Differentiation"),G2.forEach(t),K2.forEach(t),bk=d(Jo),dc=n(Jo,"LI",{});var X2=r(dc);wa=n(X2,"A",{href:!0,rel:!0});var Y2=r(wa);Tk=i(Y2,"Vectorization"),Y2.forEach(t),X2.forEach(t),kk=d(Jo),cc=n(Jo,"LI",{});var Z2=r(cc);$a=n(Z2,"A",{href:!0,rel:!0});var eF=r($a);wk=i(eF,"Parallelization"),eF.forEach(t),Z2.forEach(t),Jo.forEach(t),$k=d(ut),at=n(ut,"DIV",{class:!0});var ss=r(at);k(Da.$$.fragment,ss),Dk=d(ss),Os=n(ss,"P",{});var hl=r(Os);Fk=i(hl,"The "),pc=n(hl,"CODE",{});var tF=r(pc);yk=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),Bk=i(hl,"forward method, overrides the "),hc=n(hl,"CODE",{});var sF=r(hc);Ek=i(sF,"__call__"),sF.forEach(t),Mk=i(hl," special method."),hl.forEach(t),zk=d(ss),k(Ao.$$.fragment,ss),xk=d(ss),uc=n(ss,"P",{});var oF=r(uc);jk=i(oF,"Example:"),oF.forEach(t),Ck=d(ss),k(Fa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),Gp=d(s),Ws=n(s,"H2",{class:!0});var ou=r(Ws);Io=n(ou,"A",{id:!0,class:!0,href:!0});var nF=r(Io);fc=n(nF,"SPAN",{});var rF=r(fc);k(ya.$$.fragment,rF),rF.forEach(t),nF.forEach(t),Pk=d(ou),mc=n(ou,"SPAN",{});var aF=r(mc);qk=i(aF,"FlaxDistilBertForMultipleChoice"),aF.forEach(t),ou.forEach(t),Xp=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);k(Ba.$$.fragment,ft),Ak=d(ft),gc=n(ft,"P",{});var iF=r(gc);Ik=i(iF,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ru.forEach(t),Uk=d(ft),_c=n(ft,"P",{});var cF=r(_c);Vk=i(cF,"Finally, this model supports inherent JAX features such as:"),cF.forEach(t),Jk=d(ft),zt=n(ft,"UL",{});var Ko=r(zt);vc=n(Ko,"LI",{});var pF=r(vc);xa=n(pF,"A",{href:!0,rel:!0});var hF=r(xa);Kk=i(hF,"Just-In-Time (JIT) compilation"),hF.forEach(t),pF.forEach(t),Gk=d(Ko),bc=n(Ko,"LI",{});var uF=r(bc);ja=n(uF,"A",{href:!0,rel:!0});var fF=r(ja);Xk=i(fF,"Automatic Differentiation"),fF.forEach(t),uF.forEach(t),Yk=d(Ko),Tc=n(Ko,"LI",{});var mF=r(Tc);Ca=n(mF,"A",{href:!0,rel:!0});var gF=r(Ca);Zk=i(gF,"Vectorization"),gF.forEach(t),mF.forEach(t),ew=d(Ko),kc=n(Ko,"LI",{});var _F=r(kc);Pa=n(_F,"A",{href:!0,rel:!0});var vF=r(Pa);tw=i(vF,"Parallelization"),vF.forEach(t),_F.forEach(t),Ko.forEach(t),sw=d(ft),it=n(ft,"DIV",{class:!0});var os=r(it);k(qa.$$.fragment,os),ow=d(os),Rs=n(os,"P",{});var ul=r(Rs);nw=i(ul,"The "),wc=n(ul,"CODE",{});var bF=r(wc);rw=i(bF,"FlaxDistilBertPreTrainedModel"),bF.forEach(t),aw=i(ul,"forward method, overrides the "),$c=n(ul,"CODE",{});var TF=r($c);iw=i(TF,"__call__"),TF.forEach(t),lw=i(ul," special method."),ul.forEach(t),dw=d(os),k(No.$$.fragment,os),cw=d(os),Dc=n(os,"P",{});var kF=r(Dc);pw=i(kF,"Example:"),kF.forEach(t),hw=d(os),k(Aa.$$.fragment,os),os.forEach(t),ft.forEach(t),Yp=d(s),Hs=n(s,"H2",{class:!0});var au=r(Hs);Lo=n(au,"A",{id:!0,class:!0,href:!0});var wF=r(Lo);Fc=n(wF,"SPAN",{});var $F=r(Fc);k(Ia.$$.fragment,$F),$F.forEach(t),wF.forEach(t),uw=d(au),yc=n(au,"SPAN",{});var DF=r(yc);fw=i(DF,"FlaxDistilBertForTokenClassification"),DF.forEach(t),au.forEach(t),Zp=d(s),xe=n(s,"DIV",{class:!0});var mt=r(xe);k(Na.$$.fragment,mt),mw=d(mt),Bc=n(mt,"P",{});var FF=r(Bc);gw=i(FF,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Fw=d(mt),Ec=n(mt,"P",{});var EF=r(Ec);yw=i(EF,"Finally, this model supports inherent JAX features such as:"),EF.forEach(t),Bw=d(mt),xt=n(mt,"UL",{});var Go=r(xt);Mc=n(Go,"LI",{});var MF=r(Mc);Wa=n(MF,"A",{href:!0,rel:!0});var zF=r(Wa);Ew=i(zF,"Just-In-Time (JIT) compilation"),zF.forEach(t),MF.forEach(t),Mw=d(Go),zc=n(Go,"LI",{});var xF=r(zc);Ra=n(xF,"A",{href:!0,rel:!0});var jF=r(Ra);zw=i(jF,"Automatic Differentiation"),jF.forEach(t),xF.forEach(t),xw=d(Go),xc=n(Go,"LI",{});var CF=r(xc);Ha=n(CF,"A",{href:!0,rel:!0});var PF=r(Ha);jw=i(PF,"Vectorization"),PF.forEach(t),CF.forEach(t),Cw=d(Go),jc=n(Go,"LI",{});var qF=r(jc);Qa=n(qF,"A",{href:!0,rel:!0});var AF=r(Qa);Pw=i(AF,"Parallelization"),AF.forEach(t),qF.forEach(t),Go.forEach(t),qw=d(mt),lt=n(mt,"DIV",{class:!0});var ns=r(lt);k(Ua.$$.fragment,ns),Aw=d(ns),Qs=n(ns,"P",{});var fl=r(Qs);Iw=i(fl,"The "),Cc=n(fl,"CODE",{});var IF=r(Cc);Nw=i(IF,"FlaxDistilBertPreTrainedModel"),IF.forEach(t),Lw=i(fl,"forward method, overrides the "),Pc=n(fl,"CODE",{});var NF=r(Pc);Sw=i(NF,"__call__"),NF.forEach(t),Ow=i(fl," special method."),fl.forEach(t),Ww=d(ns),k(So.$$.fragment,ns),Rw=d(ns),qc=n(ns,"P",{});var LF=r(qc);Hw=i(LF,"Example:"),LF.forEach(t),Qw=d(ns),k(Va.$$.fragment,ns),ns.forEach(t),mt.forEach(t),eh=d(s),Us=n(s,"H2",{class:!0});var du=r(Us);Oo=n(du,"A",{id:!0,class:!0,href:!0});var SF=r(Oo);Ac=n(SF,"SPAN",{});var OF=r(Ac);k(Ja.$$.fragment,OF),OF.forEach(t),SF.forEach(t),Uw=d(du),Ic=n(du,"SPAN",{});var WF=r(Ic);Vw=i(WF,"FlaxDistilBertForQuestionAnswering"),WF.forEach(t),du.forEach(t),th=d(s),je=n(s,"DIV",{class:!0});var gt=r(je);k(Ka.$$.fragment,gt),Jw=d(gt),Vs=n(gt,"P",{});var ml=r(Vs);Kw=i(ml,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Nc=n(ml,"CODE",{});var RF=r(Nc);Gw=i(RF,"span start logits"),RF.forEach(t),Xw=i(ml," and "),Lc=n(ml,"CODE",{});var HF=r(Lc);Yw=i(HF,"span end logits"),HF.forEach(t),Zw=i(ml,")."),ml.forEach(t),e1=d(gt),Ga=n(gt,"P",{});var cu=r(Ga);t1=i(cu,"This model inherits from "),Ji=n(cu,"A",{href:!0});var QF=r(Ji);s1=i(QF,"FlaxPreTrainedModel"),QF.forEach(t),o1=i(cu,`. Check the superclass documentation for the generic methods the
