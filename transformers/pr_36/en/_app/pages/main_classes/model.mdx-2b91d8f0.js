...
<a href="/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),go=new f({props:{name:"save_pretrained",anchor:"transformers.PreTrainedModel.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"save_config",val:": bool = True"},{name:"state_dict",val:": typing.Optional[dict] = None"},{name:"save_function",val:": typing.Callable = <function save at 0x7ff5b54d6dc0>"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L999",parametersDescription:[{anchor:"transformers.PreTrainedModel.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7ff54c0f80e0>"}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),zo=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_utils.py#L194"}}),Do=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_36/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_36/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_36/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),wd=o("code"),Ky=r("[from_pretrained()](/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Zy=r(" class method"),Jy=l(),Y=o("div"),c(Ps.$$.fragment),Qy=l(),se=o("p"),ek=r("Cast the floating-point "),Td=o("code"),tk=r("params"),nk=r(" to "),jd=o("code"),ok=r("jax.numpy.bfloat16"),sk=r(". This returns a new "),$d=o("code"),ak=r("params"),rk=r(` tree and does not cast
the `),Md=o("code"),ik=r("params"),lk=r(" in place."),dk=l(),Pd=o("p"),pk=r(`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),ck=l(),Ed=o("p"),mk=r("Examples:"),uk=l(),c(Es.$$.fragment),gk=l(),K=o("div"),c(Ls.$$.fragment),hk=l(),ae=o("p"),_k=r("Cast the floating-point "),Ld=o("code"),fk=r("parmas"),bk=r(" to "),qd=o("code"),vk=r("jax.numpy.float16"),yk=r(". This returns a new "),Fd=o("code"),kk=r("params"),xk=r(` tree and does not cast the
`),Od=o("code"),wk=r("params"),Tk=r(" in place."),jk=l(),zd=o("p"),$k=r(`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),Mk=l(),Dd=o("p"),Pk=r("Examples:"),Ek=l(),c(qs.$$.fragment),Lk=l(),ue=o("div"),c(Fs.$$.fragment),qk=l(),re=o("p"),Fk=r("Cast the floating-point "),Ad=o("code"),Ok=r("parmas"),zk=r(" to "),Gd=o("code"),Dk=r("jax.numpy.float32"),Ak=r(`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=o("code"),Gk=r("params"),Sk=r(" tree and does not cast the "),Nd=o("code"),Nk=r("params"),Ck=r(" in place."),Ik=l(),Cd=o("p"),Bk=r("Examples:"),Wk=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(zs.$$.fragment),Uk=l(),Bd=o("span"),Hk=r("Generation"),oc=l(),P=o("div"),c(Ds.$$.fragment),Vk=l(),As=o("p"),Xk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),Rk=r("PreTrainedModel"),Yk=r("."),Kk=l(),wn=o("div"),c(Gs.$$.fragment),Zk=l(),Ss=o("p"),Jk=r("Implement in subclasses of "),dr=o("a"),Qk=r("PreTrainedModel"),ex=r(" for custom behavior to adjust the logits in the generate method."),tx=l(),ge=o("div"),c(Ns.$$.fragment),nx=l(),Wd=o("p"),ox=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),sx=l(),Ud=o("p"),ax=r("Examples:"),rx=l(),c(Cs.$$.fragment),ix=l(),he=o("div"),c(Is.$$.fragment),lx=l(),Hd=o("p"),dx=r("Generates sequences for models with a language modeling head using beam search decoding."),px=l(),Vd=o("p"),cx=r("Examples:"),mx=l(),c(Bs.$$.fragment),ux=l(),Tn=o("div"),c(Ws.$$.fragment),gx=l(),Xd=o("p"),hx=r(`compute the transition probabilities of sequences given generation
scores and beam indices`),_x=l(),_e=o("div"),c(Us.$$.fragment),fx=l(),Rd=o("p"),bx=r("Generates sequences for models with a language modeling head using beam search decoding."),vx=l(),Yd=o("p"),yx=r("Examples:"),kx=l(),c(Hs.$$.fragment),xx=l(),U=o("div"),c(Vs.$$.fragment),wx=l(),Kd=o("p"),Tx=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),jx=l(),vt=o("p"),$x=r("Apart from "),Zd=o("code"),Mx=r("inputs"),Px=r(`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=o("a"),Ex=r("PretrainedConfig"),Lx=r(" of the model. The default values indicated are the default values of those config."),qx=l(),Xs=o("p"),Fx=r("Most of these parameters are explained in more detail in "),Rs=o("a"),Ox=r(`this blog
post`),zx=r("."),Dx=l(),Jd=o("p"),Ax=r("Examples:"),Gx=l(),c(Ys.$$.fragment),Sx=l(),fe=o("div"),c(Ks.$$.fragment),Nx=l(),Qd=o("p"),Cx=r("Generates sequences for models with a language modeling head using greedy decoding."),Ix=l(),ep=o("p"),Bx=r("Examples:"),Wx=l(),c(Zs.$$.fragment),Ux=l(),be=o("div"),c(Js.$$.fragment),Hx=l(),tp=o("p"),Vx=r("Generates sequences for models with a language modeling head using beam search decoding."),Xx=l(),np=o("p"),Rx=r("Examples:"),Yx=l(),c(Qs.$$.fragment),Kx=l(),jn=o("div"),c(ea.$$.fragment),Zx=l(),ta=o("p"),Jx=r("Implement in subclasses of "),cr=o("a"),Qx=r("PreTrainedModel"),ew=r(" for custom behavior to prepare inputs in the generate method."),tw=l(),ve=o("div"),c(na.$$.fragment),nw=l(),op=o("p"),ow=r("Generates sequences for models with a language modeling head using multinomial sampling."),sw=l(),sp=o("p"),aw=r("Examples:"),rw=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),iw=l(),aa=o("p"),lw=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),dw=r("TFPreTrainedModel"),pw=r("."),cw=l(),$n=o("div"),c(ra.$$.fragment),mw=l(),ia=o("p"),uw=r("Implement in subclasses of "),ur=o("a"),gw=r("PreTrainedModel"),hw=r(" for custom behavior to adjust the logits in the generate method."),_w=l(),N=o("div"),c(la.$$.fragment),fw=l(),ap=o("p"),bw=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),vw=l(),da=o("p"),yw=r("Adapted in part from "),pa=o("a"),kw=r(`Facebook\u2019s XLM beam search
code`),xw=r("."),ww=l(),Ee=o("p"),Tw=r("Apart from "),rp=o("code"),jw=r("input_ids"),$w=r(" and "),ip=o("code"),Mw=r("attention_mask"),Pw=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),Ew=r("PretrainedConfig"),Lw=r(` of the model. The default values indicated are the default
values of those config.`),qw=l(),ca=o("p"),Fw=r("Most of these parameters are explained in more detail in "),ma=o("a"),Ow=r(`this blog
post`),zw=r("."),Dw=l(),lp=o("p"),Aw=r("Examples:"),Gw=l(),c(ua.$$.fragment),Sw=l(),ye=o("div"),c(ga.$$.fragment),Nw=l(),dp=o("p"),Cw=r("Generates sequences for models with a language modeling head using greedy decoding."),Iw=l(),pp=o("p"),Bw=r("Examples:"),Ww=l(),c(ha.$$.fragment),Uw=l(),Mn=o("div"),c(_a.$$.fragment),Hw=l(),fa=o("p"),Vw=r("Implement in subclasses of "),hr=o("a"),Xw=r("TFPreTrainedModel"),Rw=r(" for custom behavior to prepare inputs in the generate method."),Yw=l(),ke=o("div"),c(ba.$$.fragment),Kw=l(),cp=o("p"),Zw=r("Generates sequences for models with a language modeling head using multinomial sampling."),Jw=l(),mp=o("p"),Qw=r("Examples:"),e1=l(),c(va.$$.fragment),ac=l(),Le=o("div"),c(ya.$$.fragment),t1=l(),ka=o("p"),n1=r("A class containing all of the functions supporting generation, to be used as a mixin in "),_r=o("a"),o1=r("FlaxPreTrainedModel"),s1=r("."),a1=l(),H=o("div"),c(xa.$$.fragment),r1=l(),up=o("p"),i1=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),l1=l(),yt=o("p"),d1=r("Apart from "),gp=o("code"),p1=r("input_ids"),c1=r(`, all the arguments below will default to the value of the attribute of the same name
inside the `),fr=o("a"),m1=r("PretrainedConfig"),u1=r(` of the model. The default values indicated are the default values of those
config.`),g1=l(),wa=o("p"),h1=r("Most of these parameters are explained in more detail in "),Ta=o("a"),_1=r(`this blog
post`),f1=r("."),b1=l(),hp=o("p"),v1=r("Examples:"),y1=l(),c(ja.$$.fragment),rc=l(),kt=o("h2"),Pn=o("a"),_p=o("span"),c($a.$$.fragment),k1=l(),fp=o("span"),x1=r("Pushing to the Hub"),ic=l(),qe=o("div"),c(Ma.$$.fragment),w1=l(),bp=o("p"),T1=r("A Mixin containing the functionality to push a model or tokenizer to the hub."),j1=l(),xe=o("div"),c(Pa.$$.fragment),$1=l(),Ea=o("p"),M1=r(`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vp=o("code"),P1=r("repo_path_or_name"),E1=r("."),L1=l(),yp=o("p"),q1=r("Examples:"),F1=l(),c(La.$$.fragment),this.h()},l(n){const b=pM('[data-svelte="svelte-1phssyn"]',document.head);x=s(b,"META",{name:!0,content:!0}),b.forEach(t),E=d(n),T=s(n,"H1",{class:!0});var qa=a(T);$=s(qa,"A",{id:!0,class:!0,href:!0});var kp=a($);te=s(kp,"SPAN",{});var xp=a(te);m(A.$$.fragment,xp),xp.forEach(t),kp.forEach(t),I=d(qa),Me=s(qa,"SPAN",{});var wp=a(Me);Am=i(wp,"Models"),wp.forEach(t),qa.forEach(t),Op=d(n),ie=s(n,"P",{});var Fe=a(ie);Gm=i(Fe,"The base classes "),Aa=s(Fe,"A",{href:!0});var A1=a(Aa);Sm=i(A1,"PreTrainedModel"),A1.forEach(t),Nm=i(Fe,", "),Ga=s(Fe,"A",{href:!0});var G1=a(Ga);Cm=i(G1,"TFPreTrainedModel"),G1.forEach(t),Im=i(Fe,`, and
`),Sa=s(Fe,"A",{href:!0});var S1=a(Sa);Bm=i(S1,"FlaxPreTrainedModel"),S1.forEach(t),Wm=i(Fe,` implement the common methods for loading/saving a model either from a local
file or directory, or from a pretrained model configuration provided by the library (downloaded from HuggingFace\u2019s AWS
S3 repository).`),Fe.forEach(t),zp=d(n),nt=s(n,"P",{});var Tp=a(nt);Na=s(Tp,"A",{href:!0});var N1=a(Na);Um=i(N1,"PreTrainedModel"),N1.forEach(t),Hm=i(Tp," and "),Ca=s(Tp,"A",{href:!0});var C1=a(Ca);Vm=i(C1,"TFPreTrainedModel"),C1.forEach(t),Xm=i(Tp,` also implement a few methods which
are common among all the models to:`),Tp.forEach(t),Dp=d(n),wt=s(n,"UL",{});var dc=a(wt);Ir=s(dc,"LI",{});var I1=a(Ir);Rm=i(I1,"resize the input token embeddings when new tokens are added to the vocabulary"),I1.forEach(t),Ym=d(dc),Br=s(dc,"LI",{});var B1=a(Br);Km=i(B1,"prune the attention heads of the model."),B1.forEach(t),dc.forEach(t),Ap=d(n),B=s(n,"P",{});var we=a(B);Zm=i(we,"The other methods that are common to each model are defined in "),Ia=s(we,"A",{href:!0});var W1=a(Ia);Jm=i(W1,"ModuleUtilsMixin"),W1.forEach(t),Qm=i(we,`
(for the PyTorch models) and `),Wr=s(we,"CODE",{});var U1=a(Wr);eu=i(U1,"TFModuleUtilsMixin"),U1.forEach(t),tu=i(we,` (for the TensorFlow models) or
for text generation, `),Ba=s(we,"A",{href:!0});var H1=a(Ba);nu=i(H1,"GenerationMixin"),H1.forEach(t),ou=i(we,` (for the PyTorch models),
`),Wa=s(we,"A",{href:!0});var V1=a(Wa);su=i(V1,"TFGenerationMixin"),V1.forEach(t),au=i(we,` (for the TensorFlow models) and
`),Ua=s(we,"A",{href:!0});var X1=a(Ua);ru=i(X1,"FlaxGenerationMixin"),X1.forEach(t),iu=i(we," (for the Flax/JAX models)."),we.forEach(t),Gp=d(n),ot=s(n,"H2",{class:!0});var pc=a(ot);Tt=s(pc,"A",{id:!0,class:!0,href:!0});var R1=a(Tt);Ur=s(R1,"SPAN",{});var Y1=a(Ur);m(Hn.$$.fragment,Y1),Y1.forEach(t),R1.forEach(t),lu=d(pc),Hr=s(pc,"SPAN",{});var K1=a(Hr);du=i(K1,"PreTrainedModel"),K1.forEach(t),pc.forEach(t),Sp=d(n),w=s(n,"DIV",{class:!0});var j=a(w);m(Vn.$$.fragment,j),pu=d(j),Vr=s(j,"P",{});var Z1=a(Vr);cu=i(Z1,"Base class for all models."),Z1.forEach(t),mu=d(j),Ha=s(j,"P",{});var O1=a(Ha);Va=s(O1,"A",{href:!0});var J1=a(Va);uu=i(J1,"PreTrainedModel"),J1.forEach(t),gu=i(O1,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),O1.forEach(t),hu=d(j),Xn=s(j,"UL",{});var cc=a(Xn);Xr=s(cc,"LI",{});var Q1=a(Xr);_u=i(Q1,"resize the input embeddings,"),Q1.forEach(t),fu=d(cc),Rr=s(cc,"LI",{});var eT=a(Rr);bu=i(eT,"prune heads in the self-attention heads."),eT.forEach(t),cc.forEach(t),vu=d(j),Yr=s(j,"P",{});var tT=a(Yr);yu=i(tT,"Class attributes (overridden by derived classes):"),tT.forEach(t),ku=d(j),ne=s(j,"UL",{});var Ye=a(ne);Kr=s(Ye,"LI",{});var nT=a(Kr);Ae=s(nT,"P",{});var Fa=a(Ae);Zr=s(Fa,"STRONG",{});var oT=a(Zr);xu=i(oT,"config_class"),oT.forEach(t),wu=i(Fa," ("),Xa=s(Fa,"A",{href:!0});var sT=a(Xa);Tu=i(sT,"PretrainedConfig"),sT.forEach(t),ju=i(Fa,") \u2014 A subclass of "),Ra=s(Fa,"A",{href:!0});var aT=a(Ra);$u=i(aT,"PretrainedConfig"),aT.forEach(t),Mu=i(Fa,` to use as configuration class
...
`),Si=s(Tc,"CODE",{});var XT=a(Si);zh=i(XT,"[from_pretrained()](/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),Dh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),wd=s(_m,"CODE",{});var Xj=a(wd);Ky=i(Xj,"[from_pretrained()](/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Xj.forEach(t),Zy=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);ek=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var Rj=a(Td);tk=i(Rj,"params"),Rj.forEach(t),nk=i(Je," to "),jd=s(Je,"CODE",{});var Yj=a(jd);ok=i(Yj,"jax.numpy.bfloat16"),Yj.forEach(t),sk=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var Kj=a($d);ak=i(Kj,"params"),Kj.forEach(t),rk=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Zj=a(Md);ik=i(Zj,"params"),Zj.forEach(t),lk=i(Je," in place."),Je.forEach(t),dk=d(Ze),Pd=s(Ze,"P",{});var Jj=a(Pd);pk=i(Jj,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),Jj.forEach(t),ck=d(Ze),Ed=s(Ze,"P",{});var Qj=a(Ed);mk=i(Qj,"Examples:"),Qj.forEach(t),uk=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),gk=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),hk=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_k=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var e$=a(Ld);fk=i(e$,"parmas"),e$.forEach(t),bk=i(et," to "),qd=s(et,"CODE",{});var t$=a(qd);vk=i(t$,"jax.numpy.float16"),t$.forEach(t),yk=i(et,". This returns a new "),Fd=s(et,"CODE",{});var n$=a(Fd);kk=i(n$,"params"),n$.forEach(t),xk=i(et,` tree and does not cast the
`),Od=s(et,"CODE",{});var o$=a(Od);wk=i(o$,"params"),o$.forEach(t),Tk=i(et," in place."),et.forEach(t),jk=d(Qe),zd=s(Qe,"P",{});var s$=a(zd);$k=i(s$,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),s$.forEach(t),Mk=d(Qe),Dd=s(Qe,"P",{});var a$=a(Dd);Pk=i(a$,"Examples:"),a$.forEach(t),Ek=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),Lk=d(q),ue=s(q,"DIV",{class:!0});var zn=a(ue);m(Fs.$$.fragment,zn),qk=d(zn),re=s(zn,"P",{});var tt=a(re);Fk=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var r$=a(Ad);Ok=i(r$,"parmas"),r$.forEach(t),zk=i(tt," to "),Gd=s(tt,"CODE",{});var i$=a(Gd);Dk=i(i$,"jax.numpy.float32"),i$.forEach(t),Ak=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var l$=a(Sd);Gk=i(l$,"params"),l$.forEach(t),Sk=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var d$=a(Nd);Nk=i(d$,"params"),d$.forEach(t),Ck=i(tt," in place."),tt.forEach(t),Ik=d(zn),Cd=s(zn,"P",{});var p$=a(Cd);Bk=i(p$,"Examples:"),p$.forEach(t),Wk=d(zn),m(Os.$$.fragment,zn),zn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var c$=a(xn);Id=s(c$,"SPAN",{});var m$=a(Id);m(zs.$$.fragment,m$),m$.forEach(t),c$.forEach(t),Uk=d(fm),Bd=s(fm,"SPAN",{});var u$=a(Bd);Hk=i(u$,"Generation"),u$.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(Ds.$$.fragment,F),Vk=d(F),As=s(F,"P",{});var bm=a(As);Xk=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var g$=a(lr);Rk=i(g$,"PreTrainedModel"),g$.forEach(t),Yk=i(bm,"."),bm.forEach(t),Kk=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Zk=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);Jk=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var h$=a(dr);Qk=i(h$,"PreTrainedModel"),h$.forEach(t),ex=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),tx=d(F),ge=s(F,"DIV",{class:!0});var Dn=a(ge);m(Ns.$$.fragment,Dn),nx=d(Dn),Wd=s(Dn,"P",{});var _$=a(Wd);ox=i(_$,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_$.forEach(t),sx=d(Dn),Ud=s(Dn,"P",{});var f$=a(Ud);ax=i(f$,"Examples:"),f$.forEach(t),rx=d(Dn),m(Cs.$$.fragment,Dn),Dn.forEach(t),ix=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),lx=d(An),Hd=s(An,"P",{});var b$=a(Hd);dx=i(b$,"Generates sequences for models with a language modeling head using beam search decoding."),b$.forEach(t),px=d(An),Vd=s(An,"P",{});var v$=a(Vd);cx=i(v$,"Examples:"),v$.forEach(t),mx=d(An),m(Bs.$$.fragment,An),An.forEach(t),ux=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),gx=d(km),Xd=s(km,"P",{});var y$=a(Xd);hx=i(y$,`compute the transition probabilities of sequences given generation
scores and beam indices`),y$.forEach(t),km.forEach(t),_x=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),fx=d(Gn),Rd=s(Gn,"P",{});var k$=a(Rd);bx=i(k$,"Generates sequences for models with a language modeling head using beam search decoding."),k$.forEach(t),vx=d(Gn),Yd=s(Gn,"P",{});var x$=a(Yd);yx=i(x$,"Examples:"),x$.forEach(t),kx=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),xx=d(F),U=s(F,"DIV",{class:!0});var je=a(U);m(Vs.$$.fragment,je),wx=d(je),Kd=s(je,"P",{});var w$=a(Kd);Tx=i(w$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),w$.forEach(t),jx=d(je),vt=s(je,"P",{});var Gr=a(vt);$x=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var T$=a(Zd);Mx=i(T$,"inputs"),T$.forEach(t),Px=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var j$=a(pr);Ex=i(j$,"PretrainedConfig"),j$.forEach(t),Lx=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),qx=d(je),Xs=s(je,"P",{});var xm=a(Xs);Fx=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var $$=a(Rs);Ox=i($$,`this blog
post`),$$.forEach(t),zx=i(xm,"."),xm.forEach(t),Dx=d(je),Jd=s(je,"P",{});var M$=a(Jd);Ax=i(M$,"Examples:"),M$.forEach(t),Gx=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sx=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),Nx=d(Sn),Qd=s(Sn,"P",{});var P$=a(Qd);Cx=i(P$,"Generates sequences for models with a language modeling head using greedy decoding."),P$.forEach(t),Ix=d(Sn),ep=s(Sn,"P",{});var E$=a(ep);Bx=i(E$,"Examples:"),E$.forEach(t),Wx=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Ux=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hx=d(Nn),tp=s(Nn,"P",{});var L$=a(tp);Vx=i(L$,"Generates sequences for models with a language modeling head using beam search decoding."),L$.forEach(t),Xx=d(Nn),np=s(Nn,"P",{});var q$=a(np);Rx=i(q$,"Examples:"),q$.forEach(t),Yx=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kx=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zx=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jx=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var F$=a(cr);Qx=i(F$,"PreTrainedModel"),F$.forEach(t),ew=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tw=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nw=d(Cn),op=s(Cn,"P",{});var O$=a(op);ow=i(O$,"Generates sequences for models with a language modeling head using multinomial sampling."),O$.forEach(t),sw=d(Cn),sp=s(Cn,"P",{});var z$=a(sp);aw=i(z$,"Examples:"),z$.forEach(t),rw=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),iw=d(J),aa=s(J,"P",{});var jm=a(aa);lw=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var D$=a(mr);dw=i(D$,"TFPreTrainedModel"),D$.forEach(t),pw=i(jm,"."),jm.forEach(t),cw=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),mw=d($m),ia=s($m,"P",{});var Mm=a(ia);uw=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var A$=a(ur);gw=i(A$,"PreTrainedModel"),A$.forEach(t),hw=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_w=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fw=d(Q),ap=s(Q,"P",{});var G$=a(ap);bw=i(G$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),G$.forEach(t),vw=d(Q),da=s(Q,"P",{});var Pm=a(da);yw=i(Pm,"Adapted in part from "),pa=s(Pm,"A",{href:!0,rel:!0});var S$=a(pa);kw=i(S$,`Facebook\u2019s XLM beam search
code`),S$.forEach(t),xw=i(Pm,"."),Pm.forEach(t),ww=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tw=i(In,"Apart from "),rp=s(In,"CODE",{});var N$=a(rp);jw=i(N$,"input_ids"),N$.forEach(t),$w=i(In," and "),ip=s(In,"CODE",{});var C$=a(ip);Mw=i(C$,"attention_mask"),C$.forEach(t),Pw=i(In,`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=s(In,"A",{href:!0});var I$=a(gr);Ew=i(I$,"PretrainedConfig"),I$.forEach(t),Lw=i(In,` of the model. The default values indicated are the default
values of those config.`),In.forEach(t),qw=d(Q),ca=s(Q,"P",{});var Em=a(ca);Fw=i(Em,"Most of these parameters are explained in more detail in "),ma=s(Em,"A",{href:!0,rel:!0});var B$=a(ma);Ow=i(B$,`this blog
post`),B$.forEach(t),zw=i(Em,"."),Em.forEach(t),Dw=d(Q),lp=s(Q,"P",{});var W$=a(lp);Aw=i(W$,"Examples:"),W$.forEach(t),Gw=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),Sw=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),Nw=d(Bn),dp=s(Bn,"P",{});var U$=a(dp);Cw=i(U$,"Generates sequences for models with a language modeling head using greedy decoding."),U$.forEach(t),Iw=d(Bn),pp=s(Bn,"P",{});var H$=a(pp);Bw=i(H$,"Examples:"),H$.forEach(t),Ww=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),Uw=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(_a.$$.fragment,Lm),Hw=d(Lm),fa=s(Lm,"P",{});var qm=a(fa);Vw=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var V$=a(hr);Xw=i(V$,"TFPreTrainedModel"),V$.forEach(t),Rw=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Yw=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),Kw=d(Wn),cp=s(Wn,"P",{});var X$=a(cp);Zw=i(X$,"Generates sequences for models with a language modeling head using multinomial sampling."),X$.forEach(t),Jw=d(Wn),mp=s(Wn,"P",{});var R$=a(mp);Qw=i(R$,"Examples:"),R$.forEach(t),e1=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),t1=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);n1=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Y$=a(_r);o1=i(Y$,"FlaxPreTrainedModel"),Y$.forEach(t),s1=i(Fm,"."),Fm.forEach(t),a1=d(Sr),H=s(Sr,"DIV",{class:!0});var $e=a(H);m(xa.$$.fragment,$e),r1=d($e),up=s($e,"P",{});var K$=a(up);i1=i(K$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),K$.forEach(t),l1=d($e),yt=s($e,"P",{});var Nr=a(yt);d1=i(Nr,"Apart from "),gp=s(Nr,"CODE",{});var Z$=a(gp);p1=i(Z$,"input_ids"),Z$.forEach(t),c1=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
inside the `),fr=s(Nr,"A",{href:!0});var J$=a(fr);m1=i(J$,"PretrainedConfig"),J$.forEach(t),u1=i(Nr,` of the model. The default values indicated are the default values of those
config.`),Nr.forEach(t),g1=d($e),wa=s($e,"P",{});var Om=a(wa);h1=i(Om,"Most of these parameters are explained in more detail in "),Ta=s(Om,"A",{href:!0,rel:!0});var Q$=a(Ta);_1=i(Q$,`this blog
post`),Q$.forEach(t),f1=i(Om,"."),Om.forEach(t),b1=d($e),hp=s($e,"P",{});var eM=a(hp);v1=i(eM,"Examples:"),eM.forEach(t),y1=d($e),m(ja.$$.fragment,$e),$e.forEach(t),Sr.forEach(t),rc=d(n),kt=s(n,"H2",{class:!0});var zm=a(kt);Pn=s(zm,"A",{id:!0,class:!0,href:!0});var tM=a(Pn);_p=s(tM,"SPAN",{});var nM=a(_p);m($a.$$.fragment,nM),nM.forEach(t),tM.forEach(t),k1=d(zm),fp=s(zm,"SPAN",{});var oM=a(fp);x1=i(oM,"Pushing to the Hub"),oM.forEach(t),zm.forEach(t),ic=d(n),qe=s(n,"DIV",{class:!0});var Cr=a(qe);m(Ma.$$.fragment,Cr),w1=d(Cr),bp=s(Cr,"P",{});var sM=a(bp);T1=i(sM,"A Mixin containing the functionality to push a model or tokenizer to the hub."),sM.forEach(t),j1=d(Cr),xe=s(Cr,"DIV",{class:!0});var Un=a(xe);m(Pa.$$.fragment,Un),$1=d(Un),Ea=s(Un,"P",{});var Dm=a(Ea);M1=i(Dm,`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vp=s(Dm,"CODE",{});var aM=a(vp);P1=i(aM,"repo_path_or_name"),aM.forEach(t),E1=i(Dm,"."),Dm.forEach(t),L1=d(Un),yp=s(Un,"P",{});var rM=a(yp);q1=i(rM,"Examples:"),rM.forEach(t),F1=d(Un),m(La.$$.fragment,Un),Un.forEach(t),Cr.forEach(t),this.h()},h(){p(x,"name","hf:doc:metadata"),p(x,"content",JSON.stringify(fM)),p($,"id","models"),p($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p($,"href","#models"),p(T,"class","relative group"),p(Aa,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(Ga,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel"),p(Sa,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Na,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(Ca,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel"),p(Ia,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin"),p(Ba,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.generation_utils.GenerationMixin"),p(Wa,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.generation_tf_utils.TFGenerationMixin"),p(Ua,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.generation_flax_utils.FlaxGenerationMixin"),p(Tt,"id","transformers.PreTrainedModel"),p(Tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Tt,"href","#transformers.PreTrainedModel"),p(ot,"class","relative group"),p(Va,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(Xa,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ra,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ya,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(le,"class","docstring"),p(z,"class","docstring"),p(Ft,"class","docstring"),p(Ot,"class","docstring"),p(Se,"class","docstring"),p(Ne,"class","docstring"),p(zt,"class","docstring"),p(Dt,"class","docstring"),p(At,"class","docstring"),p(Ce,"class","docstring"),p(Ie,"class","docstring"),p(St,"class","docstring"),p(Nt,"class","docstring"),p(Be,"class","docstring"),p(w,"class","docstring"),p(Ka,"id","from_pretrained-torch-dtype"),p(Ct,"id","model-instantiation-dtype"),p(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ct,"href","#model-instantiation-dtype"),p(rt,"class","relative group"),p(Bt,"id","transformers.modeling_utils.ModuleUtilsMixin"),p(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Bt,"href","#transformers.modeling_utils.ModuleUtilsMixin"),p(it,"class","relative group"),p(Ue,"class","docstring"),p(Wt,"class","docstring"),p(Eo,"href","https://arxiv.org/pdf/2001.08361.pdf"),p(Eo,"rel","nofollow"),p(Ut,"class","docstring"),p(Ht,"class","docstring"),p(Vt,"class","docstring"),p(Xt,"class","docstring"),p(Rt,"class","docstring"),p(Ja,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks"),p(Yt,"class","docstring"),p(L,"class","docstring"),p(Kt,"id","transformers.TFPreTrainedModel"),p(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Kt,"href","#transformers.TFPreTrainedModel"),p(ct,"class","relative group"),p(er,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel"),p(tr,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(nr,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(pe,"class","docstring"),p(Jt,"class","docstring"),p(S,"class","docstring"),p(en,"class","docstring"),p(tn,"class","docstring"),p(nn,"class","docstring"),p(on,"class","docstring"),p(sn,"class","docstring"),p(an,"class","docstring"),p(rn,"class","docstring"),p(ln,"class","docstring"),p(Ve,"class","docstring"),p(or,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained"),p(dn,"class","docstring"),p(pn,"class","docstring"),p(cn,"class","docstring"),p(mn,"class","docstring"),p(un,"class","docstring"),p(gn,"class","docstring"),p(hn,"class","docstring"),p(ce,"class","docstring"),p(y,"class","docstring"),p(_n,"id","transformers.modeling_tf_utils.TFModelUtilsMixin"),p(_n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(_n,"href","#transformers.modeling_tf_utils.TFModelUtilsMixin"),p(ht,"class","relative group"),p(fn,"class","docstring"),p(Pe,"class","docstring"),p(bn,"id","transformers.FlaxPreTrainedModel"),p(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(bn,"href","#transformers.FlaxPreTrainedModel"),p(_t,"class","relative group"),p(ar,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(rr,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(ir,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(me,"class","docstring"),p(W,"class","docstring"),p(Re,"class","docstring"),p(kn,"class","docstring"),p(Y,"class","docstring"),p(K,"class","docstring"),p(ue,"class","docstring"),p(M,"class","docstring"),p(xn,"id","transformers.generation_utils.GenerationMixin"),p(xn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(xn,"href","#transformers.generation_utils.GenerationMixin"),p(bt,"class","relative group"),p(lr,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(dr,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(wn,"class","docstring"),p(ge,"class","docstring"),p(he,"class","docstring"),p(Tn,"class","docstring"),p(_e,"class","docstring"),p(pr,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(Rs,"href","https://huggingface.co/blog/how-to-generate"),p(Rs,"rel","nofollow"),p(U,"class","docstring"),p(fe,"class","docstring"),p(be,"class","docstring"),p(cr,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p(jn,"class","docstring"),p(ve,"class","docstring"),p(P,"class","docstring"),p(mr,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel"),p(ur,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.PreTrainedModel"),p($n,"class","docstring"),p(pa,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),p(pa,"rel","nofollow"),p(gr,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(ma,"href","https://huggingface.co/blog/how-to-generate"),p(ma,"rel","nofollow"),p(N,"class","docstring"),p(ye,"class","docstring"),p(hr,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.TFPreTrainedModel"),p(Mn,"class","docstring"),p(ke,"class","docstring"),p(G,"class","docstring"),p(_r,"href","/docs/transformers/pr_36/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(fr,"href","/docs/transformers/pr_36/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ta,"href","https://huggingface.co/blog/how-to-generate"),p(Ta,"rel","nofollow"),p(H,"class","docstring"),p(Le,"class","docstring"),p(Pn,"id","transformers.file_utils.PushToHubMixin"),p(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Pn,"href","#transformers.file_utils.PushToHubMixin"),p(kt,"class","relative group"),p(xe,"class","docstring"),p(qe,"class","docstring")},m(n,b){e(document.head,x),v(n,E,b),v(n,T,b),e(T,$),e($,te),u(A,te,null),e(T,I),e(T,Me),e(Me,Am),v(n,Op,b),v(n,ie,b),e(ie,Gm),e(ie,Aa),e(Aa,Sm),e(ie,Nm),e(ie,Ga),e(Ga,Cm),e(ie,Im),e(ie,Sa),e(Sa,Bm),e(ie,Wm),v(n,zp,b),v(n,nt,b),e(nt,Na),e(Na,Um),e(nt,Hm),e(nt,Ca),e(Ca,Vm),e(nt,Xm),v(n,Dp,b),v(n,wt,b),e(wt,Ir),e(Ir,Rm),e(wt,Ym),e(wt,Br),e(Br,Km),v(n,Ap,b),v(n,B,b),e(B,Zm),e(B,Ia),e(Ia,Jm),e(B,Qm),e(B,Wr),e(Wr,eu),e(B,tu),e(B,Ba),e(Ba,nu),e(B,ou),e(B,Wa),e(Wa,su),e(B,au),e(B,Ua),e(Ua,ru),e(B,iu),v(n,Gp,b),v(n,ot,b),e(ot,Tt),e(Tt,Ur),u(Hn,Ur,null),e(ot,lu),e(ot,Hr),e(Hr,du),v(n,Sp,b),v(n,w,b),u(Vn,w,null),e(w,pu),e(w,Vr),e(Vr,cu),e(w,mu),e(w,Ha),e(Ha,Va),e(Va,uu),e(Ha,gu),e(w,hu),e(w,Xn),e(Xn,Xr),e(Xr,_u),e(Xn,fu),e(Xn,Rr),e(Rr,bu),e(w,vu),e(w,Yr),e(Yr,yu),e(w,ku),e(w,ne),e(ne,Kr),e(Kr,Ae),e(Ae,Zr),e(Zr,xu),e(Ae,wu),e(Ae,Xa),e(Xa,Tu),e(Ae,ju),e(Ae,Ra),e(Ra,$u),e(Ae,Mu),e(ne,Pu),e(ne,Rn),e(Rn,Ge),e(Ge,Jr),e(Jr,Eu),e(Ge,Lu),e(Ge,Qr),e(Qr,qu),e(Ge,Fu),e(Ge,ei),e(ei,Ou),e(Ge,zu),e(Rn,Du),e(Rn,st),e(st,jt),e(jt,ti),e(ti,Au),e(jt,Gu),e(jt,Ya),e(Ya,Su),e(jt,Nu),e(st,Cu),e(st,$t),e($t,ni),e(ni,Iu),e($t,Bu),e($t,oi),e(oi,Wu),e($t,Uu),e(st,Hu),e(st,Mt),e(Mt,si),e(si,Vu),e(Mt,Xu),e(Mt,ai),e(ai,Ru),e(Mt,Yu),e(ne,Ku),e(ne,ri),e(ri,Pt),e(Pt,ii),e(ii,Zu),e(Pt,Ju),e(Pt,li),e(li,Qu),e(Pt,eg),e(ne,tg),e(ne,di),e(di,Et),e(Et,pi),e(pi,ng),e(Et,og),e(Et,ci),e(ci,sg),e(Et,ag),e(ne,rg),e(ne,mi),e(mi,V),e(V,ui),e(ui,ig),e(V,lg),e(V,gi),e(gi,dg),e(V,pg),e(V,hi),e(hi,cg),e(V,mg),e(V,_i),e(_i,ug),e(V,gg),e(V,fi),e(fi,hg),e(V,_g),e(w,fg),e(w,le),u(Yn,le,null),e(le,bg),e(le,Kn),e(Kn,vg),e(Kn,bi),e(bi,yg),e(Kn,kg),e(le,xg),e(le,vi),e(vi,wg),e(le,Tg),u(Zn,le,null),e(w,jg),e(w,z),u(Jn,z,null),e(z,$g),e(z,yi),e(yi,Mg),e(z,Pg),e(z,at),e(at,Eg),e(at,ki),e(ki,Lg),e(at,qg),e(at,xi),e(xi,Fg),e(at,Og),e(z,zg),e(z,Qn),e(Qn,Dg),e(Qn,wi),e(wi,Ag),e(Qn,Gg),e(z,Sg),e(z,eo),e(eo,Ng),e(eo,Ti),e(Ti,Cg),e(eo,Ig),e(z,Bg),u(Lt,z,null),e(z,Wg),u(qt,z,null),e(z,Ug),e(z,ji),e(ji,Hg),e(z,Vg),u(to,z,null),e(w,Xg),e(w,Ft),u(no,Ft,null),e(Ft,Rg),e(Ft,$i),e($i,Yg),e(w,Kg),e(w,Ot),u(oo,Ot,null),e(Ot,Zg),e(Ot,Mi),e(Mi,Jg),e(w,Qg),e(w,Se),u(so,Se,null),e(Se,eh),e(Se,Pi),e(Pi,th),e(Se,nh),e(Se,Ei),e(Ei,oh),e(w,sh),e(w,Ne),u(ao,Ne,null),e(Ne,ah),e(Ne,Li),e(Li,rh),e(Ne,ih),e(Ne,qi),e(qi,lh),e(w,dh),e(w,zt),u(ro,zt,null),e(zt,ph),e(zt,Fi),e(Fi,ch),e(w,mh),e(w,Dt),u(io,Dt,null),e(Dt,uh),e(Dt,Oi),e(Oi,gh),e(w,hh),e(w,At),u(lo,At,null),e(At,_h),e(At,zi),e(zi,fh),e(w,bh),e(w,Ce),u(po,Ce,null),e(Ce,vh),e(Ce,Di),e(Di,yh),e(Ce,kh),u(Gt,Ce,null),e(w,xh),e(w,Ie),u(co,Ie,null),e(Ie,wh),e(Ie,mo),e(mo,Th),e(mo,Ai),e(Ai,jh),e(mo,$h),e(Ie,Mh),e(Ie,uo),e(uo,Ph),e(uo,Gi),e(Gi,Eh),e(uo,Lh),e(w,qh),e(w,St),u(go,St,null),e(St,Fh),e(St,ho),e(ho,Oh),e(ho,Si),e(Si,zh),e(ho,Dh),e(w,Ah),e(w,Nt),u(_o,Nt,null),e(Nt,Gh),e(Nt,Ni),e(Ni,Sh),e(w,Nh),e(w,Be),u(fo,Be,null),e(Be,Ch),e(Be,Ci),e(Ci,Ih),e(Be,Bh),e(Be,bo),e(bo,Wh),e(bo,Ii),e(Ii,Uh),e(bo,Hh),v(n,Np,b),v(n,Ka,b),v(n,Cp,b),v(n,rt,b),e(rt,Ct),e(Ct,Bi),u(vo,Bi,null),e(rt,Vh),e(rt,Wi),e(Wi,Xh),v(n,Ip,b),v(n,de,b),e(de,Rh),e(de,Ui),e(Ui,Yh),e(de,Kh),e(de,Hi),e(Hi,Zh),e(de,Jh),e(de,Vi),e(Vi,Qh),e(de,e_),v(n,Bp,b),u(yo,n,b),v(n,Wp,b),v(n,We,b),e(We,t_),e(We,Xi),e(Xi,n_),e(We,o_),e(We,Ri),e(Ri,s_),e(We,a_),v(n,Up,b),u(ko,n,b),v(n,Hp,b),v(n,It,b),e(It,r_),e(It,Yi),e(Yi,i_),e(It,l_),v(n,Vp,b),u(xo,n,b),v(n,Xp,b),v(n,Za,b),e(Za,d_),v(n,Rp,b),v(n,it,b),e(it,Bt),e(Bt,Ki),u(wo,Ki,null),e(it,p_),e(it,Zi),e(Zi,c_),v(n,Yp,b),v(n,L,b),u(To,L,null),e(L,m_),e(L,jo),e(jo,u_),e(jo,Ji),e(Ji,g_),e(jo,h_),e(L,__),e(L,Ue),u($o,Ue,null),e(Ue,f_),e(Ue,Qi),e(Qi,b_),e(Ue,v_),e(Ue,lt),e(lt,y_),e(lt,el),e(el,k_),e(lt,x_),e(lt,tl),e(tl,w_),e(lt,T_),e(L,j_),e(L,Wt),u(Mo,Wt,null),e(Wt,$_),e(Wt,nl),e(nl,M_),e(L,P_),e(L,Ut),u(Po,Ut,null),e(Ut,E_),e(Ut,dt),e(dt,L_),e(dt,ol),e(ol,q_),e(dt,F_),e(dt,Eo),e(Eo,O_),e(dt,z_),e(L,D_),e(L,Ht),u(Lo,Ht,null),e(Ht,A_),e(Ht,sl),e(sl,G_),e(L,S_),e(L,Vt),u(qo,Vt,null),e(Vt,N_),e(Vt,al),e(al,C_),e(L,I_),e(L,Xt),u(Fo,Xt,null),e(Xt,B_),e(Xt,rl),e(rl,W_),e(L,U_),e(L,Rt),u(Oo,Rt,null),e(Rt,H_),e(Rt,il),e(il,V_),e(L,X_),e(L,Yt),u(zo,Yt,null),e(Yt,R_),e(Yt,pt),e(pt,Y_),e(pt,ll),e(ll,K_),e(pt,Z_),e(pt,Ja),e(Ja,J_),e(pt,Q_),v(n,Kp,b),v(n,ct,b),e(ct,Kt),e(Kt,dl),u(Do,dl,null),e(ct,ef),e(ct,pl),e(pl,tf),v(n,Zp,b),v(n,y,b),u(Ao,y,null),e(y,nf),e(y,cl),e(cl,of),e(y,sf),e(y,Qa),e(Qa,er),e(er,af),e(Qa,rf),e(y,lf),e(y,Go),e(Go,ml),e(ml,df),e(Go,pf),e(Go,ul),e(ul,cf),e(y,mf),e(y,gl),e(gl,uf),e(y,gf),e(y,mt),e(mt,He),e(He,hl),e(hl,hf),e(He,_f),e(He,tr),e(tr,ff),e(He,bf),e(He,nr),e(nr,vf),e(He,yf),e(mt,kf),e(mt,Zt),e(Zt,_l),e(_l,xf),e(Zt,wf),e(Zt,fl),e(fl,Tf),e(Zt,jf),e(mt,$f),e(mt,X),e(X,bl),e(bl,Mf),e(X,Pf),e(X,vl),e(vl,Ef),e(X,Lf),e(X,yl),e(yl,qf),e(X,Ff),e(X,kl),e(kl,Of),e(X,zf),e(X,xl),e(xl,Df),e(X,Af),e(y,Gf),e(y,pe),u(So,pe,null),e(pe,Sf),e(pe,No),e(No,Nf),e(No,wl),e(wl,Cf),e(No,If),e(pe,Bf),e(pe,Tl),e(Tl,Wf),e(pe,Uf),u(Co,pe,null),e(y,Hf),e(y,Jt),u(Io,Jt,null),e(Jt,Vf),e(Jt,jl),e(jl,Xf),e(y,Rf),e(y,S),u(Bo,S,null),e(S,Yf),e(S,$l),e($l,Kf),e(S,Zf),e(S,Wo),e(Wo,Jf),e(Wo,Ml),e(Ml,Qf),e(Wo,eb),e(S,tb),e(S,Uo),e(Uo,nb),e(Uo,Pl),e(Pl,ob),e(Uo,sb),e(S,ab),u(Qt,S,null),e(S,rb),e(S,El),e(El,ib),e(S,lb),u(Ho,S,null),e(y,db),e(y,en),u(Vo,en,null),e(en,pb),e(en,Ll),e(Ll,cb),e(y,mb),e(y,tn),u(Xo,tn,null),e(tn,ub),e(tn,ql),e(ql,gb),e(y,hb),e(y,nn),u(Ro,nn,null),e(nn,_b),e(nn,Fl),e(Fl,fb),e(y,bb),e(y,on),u(Yo,on,null),e(on,vb),e(on,Ol),e(Ol,yb),e(y,kb),e(y,sn),u(Ko,sn,null),e(sn,xb),e(sn,zl),e(zl,wb),e(y,Tb),e(y,an),u(Zo,an,null),e(an,jb),e(an,Dl),e(Dl,$b),e(y,Mb),e(y,rn),u(Jo,rn,null),e(rn,Pb),e(rn,Al),e(Al,Eb),e(y,Lb),e(y,ln),u(Qo,ln,null),e(ln,qb),e(ln,Gl),e(Gl,Fb),e(y,Ob),e(y,Ve),u(es,Ve,null),e(Ve,zb),e(Ve,ts),e(ts,Db),e(ts,Sl),e(Sl,Ab),e(ts,Gb),e(Ve,Sb),e(Ve,ns),e(ns,Nb),e(ns,Nl),e(Nl,Cb),e(ns,Ib),e(y,Bb),e(y,dn),u(os,dn,null),e(dn,Wb),e(dn,ss),e(ss,Ub),e(ss,or),e(or,Hb),e(ss,Vb),e(y,Xb),e(y,pn),u(as,pn,null),e(pn,Rb),e(pn,Cl),e(Cl,Yb),e(y,Kb),e(y,cn),u(rs,cn,null),e(cn,Zb),e(cn,Il),e(Il,Jb),e(y,Qb),e(y,mn),u(is,mn,null),e(mn,ev),e(mn,Bl),e(Bl,tv),e(y,nv),e(y,un),u(ls,un,null),e(un,ov),e(un,Wl),e(Wl,sv),e(y,av),e(y,gn),u(ds,gn,null),e(gn,rv),e(gn,Ul),e(Ul,iv),e(y,lv),e(y,hn),u(ps,hn,null),e(hn,dv),e(hn,Hl),e(Hl,pv),e(y,cv),e(y,ce),u(cs,ce,null),e(ce,mv),e(ce,oe),e(oe,uv),e(oe,Vl),e(Vl,gv),e(oe,hv),e(oe,Xl),e(Xl,_v),e(oe,fv),e(oe,Rl),e(Rl,bv),e(oe,vv),e(oe,Yl),e(Yl,yv),e(oe,kv),e(ce,xv),e(ce,ut),e(ut,wv),e(ut,Kl),e(Kl,Tv),e(ut,jv),e(ut,Zl),e(Zl,$v),e(ut,Mv),e(ce,Pv),e(ce,gt),e(gt,Ev),e(gt,Jl),e(Jl,Lv),e(gt,qv),e(gt,Ql),e(Ql,Fv),e(gt,Ov),v(n,Jp,b),v(n,ht,b),e(ht,_n),e(_n,ed),u(ms,ed,null),e(ht,zv),e(ht,td),e(td,Dv),v(n,Qp,b),v(n,Pe,b),u(us,Pe,null),e(Pe,Av),e(Pe,gs),e(gs,Gv),e(gs,nd),e(nd,Sv),e(gs,Nv),e(Pe,Cv),e(Pe,fn),u(hs,fn,null),e(fn,Iv),e(fn,od),e(od,Bv),v(n,ec,b),v(n,_t,b),e(_t,bn),e(bn,sd),u(_s,sd,null),e(_t,Wv),e(_t,ad),e(ad,Uv),v(n,tc,b),v(n,M,b),u(fs,M,null),e(M,Hv),e(M,rd),e(rd,Vv),e(M,Xv),e(M,sr),e(sr,ar),e(ar,Rv),e(sr,Yv),e(M,Kv),e(M,id),e(id,Zv),e(M,Jv),e(M,ft),e(ft,Xe),e(Xe,ld),e(ld,Qv),e(Xe,ey),e(Xe,rr),e(rr,ty),e(Xe,ny),e(Xe,ir),e(ir,oy),e(Xe,sy),e(ft,ay),e(ft,vn),e(vn,dd),e(dd,ry),e(vn,iy),e(vn,pd),e(pd,ly),e(vn,dy),e(ft,py),e(ft,R),e(R,cd),e(cd,cy),e(R,my),e(R,md),e(md,uy),e(R,gy),e(R,ud),e(ud,hy),e(R,_y),e(R,gd),e(gd,fy),e(R,by),e(R,hd),e(hd,vy),e(R,yy),e(M,ky),e(M,me),u(bs,me,null),e(me,xy),e(me,vs),e(vs,wy),e(vs,_d),e(_d,Ty),e(vs,jy),e(me,$y),e(me,fd),e(fd,My),e(me,Py),u(ys,me,null),e(M,Ey),e(M,W),u(ks,W,null),e(W,Ly),e(W,bd),e(bd,qy),e(W,Fy),e(W,xs),e(xs,Oy),e(xs,vd),e(vd,zy),e(xs,Dy),e(W,Ay),e(W,ws),e(ws,Gy),e(ws,yd),e(yd,Sy),e(ws,Ny),e(W,Cy),e(W,kd),e(kd,Iy),e(W,By),u(Ts,W,null),e(M,Wy),e(M,Re),u(js,Re,null),e(Re,Uy),e(Re,xd),e(xd,Hy),e(Re,Vy),u(yn,Re,null),e(M,Xy),e(M,kn),u($s,kn,null),e(kn,Ry),e(kn,Ms),e(Ms,Yy),e(Ms,wd),e(wd,Ky),e(Ms,Zy),e(M,Jy),e(M,Y),u(Ps,Y,null),e(Y,Qy),e(Y,se),e(se,ek),e(se,Td),e(Td,tk),e(se,nk),e(se,jd),e(jd,ok),e(se,sk),e(se,$d),e($d,ak),e(se,rk),e(se,Md),e(Md,ik),e(se,lk),e(Y,dk),e(Y,Pd),e(Pd,pk),e(Y,ck),e(Y,Ed),e(Ed,mk),e(Y,uk),u(Es,Y,null),e(M,gk),e(M,K),u(Ls,K,null),e(K,hk),e(K,ae),e(ae,_k),e(ae,Ld),e(Ld,fk),e(ae,bk),e(ae,qd),e(qd,vk),e(ae,yk),e(ae,Fd),e(Fd,kk),e(ae,xk),e(ae,Od),e(Od,wk),e(ae,Tk),e(K,jk),e(K,zd),e(zd,$k),e(K,Mk),e(K,Dd),e(Dd,Pk),e(K,Ek),u(qs,K,null),e(M,Lk),e(M,ue),u(Fs,ue,null),e(ue,qk),e(ue,re),e(re,Fk),e(re,Ad),e(Ad,Ok),e(re,zk),e(re,Gd),e(Gd,Dk),e(re,Ak),e(re,Sd),e(Sd,Gk),e(re,Sk),e(re,Nd),e(Nd,Nk),e(re,Ck),e(ue,Ik),e(ue,Cd),e(Cd,Bk),e(ue,Wk),u(Os,ue,null),v(n,nc,b),v(n,bt,b),e(bt,xn),e(xn,Id),u(zs,Id,null),e(bt,Uk),e(bt,Bd),e(Bd,Hk),v(n,oc,b),v(n,P,b),u(Ds,P,null),e(P,Vk),e(P,As),e(As,Xk),e(As,lr),e(lr,Rk),e(As,Yk),e(P,Kk),e(P,wn),u(Gs,wn,null),e(wn,Zk),e(wn,Ss),e(Ss,Jk),e(Ss,dr),e(dr,Qk),e(Ss,ex),e(P,tx),e(P,ge),u(Ns,ge,null),e(ge,nx),e(ge,Wd),e(Wd,ox),e(ge,sx),e(ge,Ud),e(Ud,ax),e(ge,rx),u(Cs,ge,null),e(P,ix),e(P,he),u(Is,he,null),e(he,lx),e(he,Hd),e(Hd,dx),e(he,px),e(he,Vd),e(Vd,cx),e(he,mx),u(Bs,he,null),e(P,ux),e(P,Tn),u(Ws,Tn,null),e(Tn,gx),e(Tn,Xd),e(Xd,hx),e(P,_x),e(P,_e),u(Us,_e,null),e(_e,fx),e(_e,Rd),e(Rd,bx),e(_e,vx),e(_e,Yd),e(Yd,yx),e(_e,kx),u(Hs,_e,null),e(P,xx),e(P,U),u(Vs,U,null),e(U,wx),e(U,Kd),e(Kd,Tx),e(U,jx),e(U,vt),e(vt,$x),e(vt,Zd),e(Zd,Mx),e(vt,Px),e(vt,pr),e(pr,Ex),e(vt,Lx),e(U,qx),e(U,Xs),e(Xs,Fx),e(Xs,Rs),e(Rs,Ox),e(Xs,zx),e(U,Dx),e(U,Jd),e(Jd,Ax),e(U,Gx),u(Ys,U,null),e(P,Sx),e(P,fe),u(Ks,fe,null),e(fe,Nx),e(fe,Qd),e(Qd,Cx),e(fe,Ix),e(fe,ep),e(ep,Bx),e(fe,Wx),u(Zs,fe,null),e(P,Ux),e(P,be),u(Js,be,null),e(be,Hx),e(be,tp),e(tp,Vx),e(be,Xx),e(be,np),e(np,Rx),e(be,Yx),u(Qs,be,null),e(P,Kx),e(P,jn),u(ea,jn,null),e(jn,Zx),e(jn,ta),e(ta,Jx),e(ta,cr),e(cr,Qx),e(ta,ew),e(P,tw),e(P,ve),u(na,ve,null),e(ve,nw),e(ve,op),e(op,ow),e(ve,sw),e(ve,sp),e(sp,aw),e(ve,rw),u(oa,ve,null),v(n,sc,b),v(n,G,b),u(sa,G,null),e(G,iw),e(G,aa),e(aa,lw),e(aa,mr),e(mr,dw),e(aa,pw),e(G,cw),e(G,$n),u(ra,$n,null),e($n,mw),e($n,ia),e(ia,uw),e(ia,ur),e(ur,gw),e(ia,hw),e(G,_w),e(G,N),u(la,N,null),e(N,fw),e(N,ap),e(ap,bw),e(N,vw),e(N,da),e(da,yw),e(da,pa),e(pa,kw),e(da,xw),e(N,ww),e(N,Ee),e(Ee,Tw),e(Ee,rp),e(rp,jw),e(Ee,$w),e(Ee,ip),e(ip,Mw),e(Ee,Pw),e(Ee,gr),e(gr,Ew),e(Ee,Lw),e(N,qw),e(N,ca),e(ca,Fw),e(ca,ma),e(ma,Ow),e(ca,zw),e(N,Dw),e(N,lp),e(lp,Aw),e(N,Gw),u(ua,N,null),e(G,Sw),e(G,ye),u(ga,ye,null),e(ye,Nw),e(ye,dp),e(dp,Cw),e(ye,Iw),e(ye,pp),e(pp,Bw),e(ye,Ww),u(ha,ye,null),e(G,Uw),e(G,Mn),u(_a,Mn,null),e(Mn,Hw),e(Mn,fa),e(fa,Vw),e(fa,hr),e(hr,Xw),e(fa,Rw),e(G,Yw),e(G,ke),u(ba,ke,null),e(ke,Kw),e(ke,cp),e(cp,Zw),e(ke,Jw),e(ke,mp),e(mp,Qw),e(ke,e1),u(va,ke,null),v(n,ac,b),v(n,Le,b),u(ya,Le,null),e(Le,t1),e(Le,ka),e(ka,n1),e(ka,_r),e(_r,o1),e(ka,s1),e(Le,a1),e(Le,H),u(xa,H,null),e(H,r1),e(H,up),e(up,i1),e(H,l1),e(H,yt),e(yt,d1),e(yt,gp),e(gp,p1),e(yt,c1),e(yt,fr),e(fr,m1),e(yt,u1),e(H,g1),e(H,wa),e(wa,h1),e(wa,Ta),e(Ta,_1),e(wa,f1),e(H,b1),e(H,hp),e(hp,v1),e(H,y1),u(ja,H,null),v(n,rc,b),v(n,kt,b),e(kt,Pn),e(Pn,_p),u($a,_p,null),e(kt,k1),e(kt,fp),e(fp,x1),v(n,ic,b),v(n,qe,b),u(Ma,qe,null),e(qe,w1),e(qe,bp),e(bp,T1),e(qe,j1),e(qe,xe),u(Pa,xe,null),e(xe,$1),e(xe,Ea),e(Ea,M1),e(Ea,vp),e(vp,P1),e(Ea,E1),e(xe,L1),e(xe,yp),e(yp,q1),e(xe,F1),u(La,xe,null),lc=!0},p(n,[b]){const qa={};b&2&&(qa.$$scope={dirty:b,ctx:n}),Lt.$set(qa);const kp={};b&2&&(kp.$$scope={dirty:b,ctx:n}),qt.$set(kp);const xp={};b&2&&(xp.$$scope={dirty:b,ctx:n}),Gt.$set(xp);const wp={};b&2&&(wp.$$scope={dirty:b,ctx:n}),Qt.$set(wp);const Fe={};b&2&&(Fe.$$scope={dirty:b,ctx:n}),yn.$set(Fe)},i(n){lc||(g(A.$$.fragment,n),g(Hn.$$.fragment,n),g(Vn.$$.fragment,n),g(Yn.$$.fragment,n),g(Zn.$$.fragment,n),g(Jn.$$.fragment,n),g(Lt.$$.fragment,n),g(qt.$$.fragment,n),g(to.$$.fragment,n),g(no.$$.fragment,n),g(oo.$$.fragment,n),g(so.$$.fragment,n),g(ao.$$.fragment,n),g(ro.$$.fragment,n),g(io.$$.fragment,n),g(lo.$$.fragment,n),g(po.$$.fragment,n),g(Gt.$$.fragment,n),g(co.$$.fragment,n),g(go.$$.fragment,n),g(_o.$$.fragment,n),g(fo.$$.fragment,n),g(vo.$$.fragment,n),g(yo.$$.fragment,n),g(ko.$$.fragment,n),g(xo.$$.fragment,n),g(wo.$$.fragment,n),g(To.$$.fragment,n),g($o.$$.fragment,n),g(Mo.$$.fragment,n),g(Po.$$.fragment,n),g(Lo.$$.fragment,n),g(qo.$$.fragment,n),g(Fo.$$.fragment,n),g(Oo.$$.fragment,n),g(zo.$$.fragment,n),g(Do.$$.fragment,n),g(Ao.$$.fragment,n),g(So.$$.fragment,n),g(Co.$$.fragment,n),g(Io.$$.fragment,n),g(Bo.$$.fragment,n),g(Qt.$$.fragment,n),g(Ho.$$.fragment,n),g(Vo.$$.fragment,n),g(Xo.$$.fragment,n),g(Ro.$$.fragment,n),g(Yo.$$.fragment,n),g(Ko.$$.fragment,n),g(Zo.$$.fragment,n),g(Jo.$$.fragment,n),g(Qo.$$.fragment,n),g(es.$$.fragment,n),g(os.$$.fragment,n),g(as.$$.fragment,n),g(rs.$$.fragment,n),g(is.$$.fragment,n),g(ls.$$.fragment,n),g(ds.$$.fragment,n),g(ps.$$.fragment,n),g(cs.$$.fragment,n),g(ms.$$.fragment,n),g(us.$$.fragment,n),g(hs.$$.fragment,n),g(_s.$$.fragment,n),g(fs.$$.fragment,n),g(bs.$$.fragment,n),g(ys.$$.fragment,n),g(ks.$$.fragment,n),g(Ts.$$.fragment,n),g(js.$$.fragment,n),g(yn.$$.fragment,n),g($s.$$.fragment,n),g(Ps.$$.fragment,n),g(Es.$$.fragment,n),g(Ls.$$.fragment,n),g(qs.$$.fragment,n),g(Fs.$$.fragment,n),g(Os.$$.fragment,n),g(zs.$$.fragment,n),g(Ds.$$.fragment,n),g(Gs.$$.fragment,n),g(Ns.$$.fragment,n),g(Cs.$$.fragment,n),g(Is.$$.fragment,n),g(Bs.$$.fragment,n),g(Ws.$$.fragment,n),g(Us.$$.fragment,n),g(Hs.$$.fragment,n),g(Vs.$$.fragment,n),g(Ys.$$.fragment,n),g(Ks.$$.fragment,n),g(Zs.$$.fragment,n),g(Js.$$.fragment,n),g(Qs.$$.fragment,n),g(ea.$$.fragment,n),g(na.$$.fragment,n),g(oa.$$.fragment,n),g(sa.$$.fragment,n),g(ra.$$.fragment,n),g(la.$$.fragment,n),g(ua.$$.fragment,n),g(ga.$$.fragment,n),g(ha.$$.fragment,n),g(_a.$$.fragment,n),g(ba.$$.fragment,n),g(va.$$.fragment,n),g(ya.$$.fragment,n),g(xa.$$.fragment,n),g(ja.$$.fragment,n),g($a.$$.fragment,n),g(Ma.$$.fragment,n),g(Pa.$$.fragment,n),g(La.$$.fragment,n),lc=!0)},o(n){h(A.$$.fragment,n),h(Hn.$$.fragment,n),h(Vn.$$.fragment,n),h(Yn.$$.fragment,n),h(Zn.$$.fragment,n),h(Jn.$$.fragment,n),h(Lt.$$.fragment,n),h(qt.$$.fragment,n),h(to.$$.fragment,n),h(no.$$.fragment,n),h(oo.$$.fragment,n),h(so.$$.fragment,n),h(ao.$$.fragment,n),h(ro.$$.fragment,n),h(io.$$.fragment,n),h(lo.$$.fragment,n),h(po.$$.fragment,n),h(Gt.$$.fragment,n),h(co.$$.fragment,n),h(go.$$.fragment,n),h(_o.$$.fragment,n),h(fo.$$.fragment,n),h(vo.$$.fragment,n),h(yo.$$.fragment,n),h(ko.$$.fragment,n),h(xo.$$.fragment,n),h(wo.$$.fragment,n),h(To.$$.fragment,n),h($o.$$.fragment,n),h(Mo.$$.fragment,n),h(Po.$$.fragment,n),h(Lo.$$.fragment,n),h(qo.$$.fragment,n),h(Fo.$$.fragment,n),h(Oo.$$.fragment,n),h(zo.$$.fragment,n),h(Do.$$.fragment,n),h(Ao.$$.fragment,n),h(So.$$.fragment,n),h(Co.$$.fragment,n),h(Io.$$.fragment,n),h(Bo.$$.fragment,n),h(Qt.$$.fragment,n),h(Ho.$$.fragment,n),h(Vo.$$.fragment,n),h(Xo.$$.fragment,n),h(Ro.$$.fragment,n),h(Yo.$$.fragment,n),h(Ko.$$.fragment,n),h(Zo.$$.fragment,n),h(Jo.$$.fragment,n),h(Qo.$$.fragment,n),h(es.$$.fragment,n),h(os.$$.fragment,n),h(as.$$.fragment,n),h(rs.$$.fragment,n),h(is.$$.fragment,n),h(ls.$$.fragment,n),h(ds.$$.fragment,n),h(ps.$$.fragment,n),h(cs.$$.fragment,n),h(ms.$$.fragment,n),h(us.$$.fragment,n),h(hs.$$.fragment,n),h(_s.$$.fragment,n),h(fs.$$.fragment,n),h(bs.$$.fragment,n),h(ys.$$.fragment,n),h(ks.$$.fragment,n),h(Ts.$$.fragment,n),h(js.$$.fragment,n),h(yn.$$.fragment,n),h($s.$$.fragment,n),h(Ps.$$.fragment,n),h(Es.$$.fragment,n),h(Ls.$$.fragment,n),h(qs.$$.fragment,n),h(Fs.$$.fragment,n),h(Os.$$.fragment,n),h(zs.$$.fragment,n),h(Ds.$$.fragment,n),h(Gs.$$.fragment,n),h(Ns.$$.fragment,n),h(Cs.$$.fragment,n),h(Is.$$.fragment,n),h(Bs.$$.fragment,n),h(Ws.$$.fragment,n),h(Us.$$.fragment,n),h(Hs.$$.fragment,n),h(Vs.$$.fragment,n),h(Ys.$$.fragment,n),h(Ks.$$.fragment,n),h(Zs.$$.fragment,n),h(Js.$$.fragment,n),h(Qs.$$.fragment,n),h(ea.$$.fragment,n),h(na.$$.fragment,n),h(oa.$$.fragment,n),h(sa.$$.fragment,n),h(ra.$$.fragment,n),h(la.$$.fragment,n),h(ua.$$.fragment,n),h(ga.$$.fragment,n),h(ha.$$.fragment,n),h(_a.$$.fragment,n),h(ba.$$.fragment,n),h(va.$$.fragment,n),h(ya.$$.fragment,n),h(xa.$$.fragment,n),h(ja.$$.fragment,n),h($a.$$.fragment,n),h(Ma.$$.fragment,n),h(Pa.$$.fragment,n),h(La.$$.fragment,n),lc=!1},d(n){t(x),n&&t(E),n&&t(T),_(A),n&&t(Op),n&&t(ie),n&&t(zp),n&&t(nt),n&&t(Dp),n&&t(wt),n&&t(Ap),n&&t(B),n&&t(Gp),n&&t(ot),_(Hn),n&&t(Sp),n&&t(w),_(Vn),_(Yn),_(Zn),_(Jn),_(Lt),_(qt),_(to),_(no),_(oo),_(so),_(ao),_(ro),_(io),_(lo),_(po),_(Gt),_(co),_(go),_(_o),_(fo),n&&t(Np),n&&t(Ka),n&&t(Cp),n&&t(rt),_(vo),n&&t(Ip),n&&t(de),n&&t(Bp),_(yo,n),n&&t(Wp),n&&t(We),n&&t(Up),_(ko,n),n&&t(Hp),n&&t(It),n&&t(Vp),_(xo,n),n&&t(Xp),n&&t(Za),n&&t(Rp),n&&t(it),_(wo),n&&t(Yp),n&&t(L),_(To),_($o),_(Mo),_(Po),_(Lo),_(qo),_(Fo),_(Oo),_(zo),n&&t(Kp),n&&t(ct),_(Do),n&&t(Zp),n&&t(y),_(Ao),_(So),_(Co),_(Io),_(Bo),_(Qt),_(Ho),_(Vo),_(Xo),_(Ro),_(Yo),_(Ko),_(Zo),_(Jo),_(Qo),_(es),_(os),_(as),_(rs),_(is),_(ls),_(ds),_(ps),_(cs),n&&t(Jp),n&&t(ht),_(ms),n&&t(Qp),n&&t(Pe),_(us),_(hs),n&&t(ec),n&&t(_t),_(_s),n&&t(tc),n&&t(M),_(fs),_(bs),_(ys),_(ks),_(Ts),_(js),_(yn),_($s),_(Ps),_(Es),_(Ls),_(qs),_(Fs),_(Os),n&&t(nc),n&&t(bt),_(zs),n&&t(oc),n&&t(P),_(Ds),_(Gs),_(Ns),_(Cs),_(Is),_(Bs),_(Ws),_(Us),_(Hs),_(Vs),_(Ys),_(Ks),_(Zs),_(Js),_(Qs),_(ea),_(na),_(oa),n&&t(sc),n&&t(G),_(sa),_(ra),_(la),_(ua),_(ga),_(ha),_(_a),_(ba),_(va),n&&t(ac),n&&t(Le),_(ya),_(xa),_(ja),n&&t(rc),n&&t(kt),_($a),n&&t(ic),n&&t(qe),_(Ma),_(Pa),_(La)}}}const fM={local:"models",sections:[{local:"transformers.PreTrainedModel",sections:[{local:"model-instantiation-dtype",title:"Model Instantiation dtype"}],title:"PreTrainedModel"},{local:"transformers.modeling_utils.ModuleUtilsMixin",title:"ModuleUtilsMixin"},{local:"transformers.TFPreTrainedModel",title:"TFPreTrainedModel"},{local:"transformers.modeling_tf_utils.TFModelUtilsMixin",title:"TFModelUtilsMixin"},{local:"transformers.FlaxPreTrainedModel",title:"FlaxPreTrainedModel"},{local:"transformers.generation_utils.GenerationMixin",title:"Generation"},{local:"transformers.file_utils.PushToHubMixin",title:"Pushing to the Hub"}],title:"Models"};function bM(ee,x,E){let{fw:T}=x;return ee.$$set=$=>{"fw"in $&&E(0,T=$.fw)},[T]}class jM extends iM{constructor(x){super();lM(this,x,bM,_M,dM,{fw:0})}}export{jM as default,fM as metadata};
