...
`}}),ra=new As({props:{$$slots:{default:[s2]},$$scope:{ctx:U}}}),io=new Ft({props:{codee:`from transformers import TapasTokenizer, TapasForSequenceClassification
...
`}}),pa=new As({props:{$$slots:{default:[a2]},$$scope:{ctx:U}}}),go=new Ft({props:{codee:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
