...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}]}}),Yt=new Vt({props:{codee:`from transformers import CTRLModel, CTRLConfig
...
`}}),Et=new Lt({props:{$$slots:{default:[Uc]},$$scope:{ctx:B}}}),co=new Vt({props:{codee:`from transformers import CTRLTokenizer, CTRLModel
import torch
...
`}}),qt=new Lt({props:{$$slots:{default:[Vc]},$$scope:{ctx:B}}}),_o=new Vt({props:{codee:`import torch
...
`}}),Pt=new Lt({props:{$$slots:{default:[Gc]},$$scope:{ctx:B}}}),wo=new Vt({props:{codee:`from transformers import CTRLTokenizer, CTRLForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Lo=new Vt({props:{codee:`from transformers import CTRLTokenizer, CTRLForSequenceClassification
import torch
...
`}}),jt=new Lt({props:{$$slots:{default:[Xc]},$$scope:{ctx:B}}}),zo=new Vt({props:{codee:`from transformers import CTRLTokenizer, TFCTRLModel
...
`}}),Dt=new Lt({props:{$$slots:{default:[Qc]},$$scope:{ctx:B}}}),Do=new Vt({props:{codee:`from transformers import CTRLTokenizer, TFCTRLLMHeadModel
import tensorflow as tf
...
`}}),Ot=new Lt({props:{$$slots:{default:[Zc]},$$scope:{ctx:B}}}),Vo=new Vt({props:{codee:`from transformers import CTRLTokenizer, TFCTRLForSequenceClassification
import tensorflow as tf
