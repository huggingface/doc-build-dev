import{S as ij,i as lj,s as dj,e as o,k as l,w as c,t as r,M as pj,c as s,d as t,m as d,a,x as m,h as i,b as p,F as e,g as v,y as u,q as g,o as h,B as _}from"../../chunks/vendor-4833417e.js";import{T as Fp}from"../../chunks/Tip-fffd6df1.js";import{D as f}from"../../chunks/Docstring-7b52c3d4.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function cj(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var j=a(x);E=i(j,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),j.forEach(t)},m(T,j){v(T,x,j),e(x,E)},d(T){T&&t(x)}}}function mj(ee){let x,E,T,j,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),j=r("\u201Coffline-mode\u201D"),te=r(` to
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15900/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_15900/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Lt=new Fp({props:{$$slots:{default:[cj]},$$scope:{ctx:ee}}}),qt=new Fp({props:{$$slots:{default:[mj]},$$scope:{ctx:ee}}}),to=new O({props:{code:`from transformers import BertConfig, BertModel
...
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15900/src/transformers/modeling_utils.py#L601",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15900/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15900/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_15900/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Qt=new Fp({props:{$$slots:{default:[gj]},$$scope:{ctx:ee}}}),Ho=new O({props:{code:`from transformers import BertConfig, TFBertModel
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15900/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15900/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15900/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15900/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15900/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15900/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_15900/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_15900/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_15900/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15900/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),Dh=r("[from_pretrained()](/docs/transformers/pr_15900/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),zh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
model parameters to fp32 precision. This returns a new `),Sd=o("code"),G1=r("params"),S1=r(" tree and does not cast the "),Nd=o("code"),N1=r("params"),C1=r(" in place."),I1=l(),Cd=o("p"),B1=r("Examples:"),W1=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(Ds.$$.fragment),U1=l(),Bd=o("span"),H1=r("Generation"),oc=l(),P=o("div"),c(zs.$$.fragment),V1=l(),As=o("p"),X1=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),R1=r("PreTrainedModel"),Y1=r("."),K1=l(),wn=o("div"),c(Gs.$$.fragment),Z1=l(),Ss=o("p"),J1=r("Implement in subclasses of "),dr=o("a"),Q1=r("PreTrainedModel"),e0=r(" for custom behavior to adjust the logits in the generate method."),t0=l(),ge=o("div"),c(Ns.$$.fragment),n0=l(),Wd=o("p"),o0=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),s0=l(),Ud=o("p"),a0=r("Examples:"),r0=l(),c(Cs.$$.fragment),i0=l(),he=o("div"),c(Is.$$.fragment),l0=l(),Hd=o("p"),d0=r("Generates sequences for models with a language modeling head using beam search decoding."),p0=l(),Vd=o("p"),c0=r("Examples:"),m0=l(),c(Bs.$$.fragment),u0=l(),Tn=o("div"),c(Ws.$$.fragment),g0=l(),Xd=o("p"),h0=r(`compute the transition probabilities of sequences given generation
scores and beam indices`),_0=l(),_e=o("div"),c(Us.$$.fragment),f0=l(),Rd=o("p"),b0=r("Generates sequences for models with a language modeling head using beam search decoding."),v0=l(),Yd=o("p"),y0=r("Examples:"),k0=l(),c(Hs.$$.fragment),x0=l(),U=o("div"),c(Vs.$$.fragment),w0=l(),Kd=o("p"),T0=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),$0=l(),vt=o("p"),j0=r("Apart from "),Zd=o("code"),M0=r("inputs"),P0=r(`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=o("a"),E0=r("PretrainedConfig"),L0=r(" of the model. The default values indicated are the default values of those config."),q0=l(),Xs=o("p"),F0=r("Most of these parameters are explained in more detail in "),Rs=o("a"),O0=r(`this blog
post`),D0=r("."),z0=l(),Jd=o("p"),A0=r("Examples:"),G0=l(),c(Ys.$$.fragment),S0=l(),fe=o("div"),c(Ks.$$.fragment),N0=l(),Qd=o("p"),C0=r("Generates sequences for models with a language modeling head using greedy decoding."),I0=l(),ep=o("p"),B0=r("Examples:"),W0=l(),c(Zs.$$.fragment),U0=l(),be=o("div"),c(Js.$$.fragment),H0=l(),tp=o("p"),V0=r("Generates sequences for models with a language modeling head using beam search decoding."),X0=l(),np=o("p"),R0=r("Examples:"),Y0=l(),c(Qs.$$.fragment),K0=l(),$n=o("div"),c(ea.$$.fragment),Z0=l(),ta=o("p"),J0=r("Implement in subclasses of "),cr=o("a"),Q0=r("PreTrainedModel"),ek=r(" for custom behavior to prepare inputs in the generate method."),tk=l(),ve=o("div"),c(na.$$.fragment),nk=l(),op=o("p"),ok=r("Generates sequences for models with a language modeling head using multinomial sampling."),sk=l(),sp=o("p"),ak=r("Examples:"),rk=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),ik=l(),aa=o("p"),lk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),dk=r("TFPreTrainedModel"),pk=r("."),ck=l(),jn=o("div"),c(ra.$$.fragment),mk=l(),ia=o("p"),uk=r("Implement in subclasses of "),ur=o("a"),gk=r("PreTrainedModel"),hk=r(" for custom behavior to adjust the logits in the generate method."),_k=l(),N=o("div"),c(la.$$.fragment),fk=l(),ap=o("p"),bk=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
embeddings`),JT.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),$b=d(Yc),zl=s(Yc,"P",{});var QT=a(zl);jb=i(QT,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),QT.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var e2=a(Al);Eb=i(e2,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),e2.forEach(t),Kc.forEach(t),Lb=d(k),ln=s(k,"DIV",{class:!0});var Zc=a(ln);m(Qo.$$.fragment,Zc),qb=d(Zc),Gl=s(Zc,"P",{});var t2=a(Gl);Fb=i(t2,"Prunes heads of the base model."),t2.forEach(t),Zc.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),Db=d(qr),ts=s(qr,"P",{});var Jc=a(ts);zb=i(Jc,"Resizes input token embeddings matrix of the model if "),Sl=s(Jc,"CODE",{});var n2=a(Sl);Ab=i(n2,"new_num_tokens != config.vocab_size"),n2.forEach(t),Gb=i(Jc,"."),Jc.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qc=a(ns);Nb=i(Qc,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qc,"CODE",{});var o2=a(Nl);Cb=i(o2,"tie_weights()"),o2.forEach(t),Ib=i(Qc," method."),Qc.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
...
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h2=a(Kl);Tv=i(h2,"data"),h2.forEach(t),$v=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _2=a(Zl);jv=i(_2,"(inputs,)"),_2.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
...
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v2=a(_n);ed=s(v2,"SPAN",{});var y2=a(ed);m(ms.$$.fragment,y2),y2.forEach(t),v2.forEach(t),Dv=d(lm),td=s(lm,"SPAN",{});var k2=a(td);zv=i(k2,"TFModelUtilsMixin"),k2.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var Dr=a(Pe);m(us.$$.fragment,Dr),Av=d(Dr),gs=s(Dr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x2=a(nd);Sv=i(x2,"tf.keras.Model"),x2.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(Dr),fn=s(Dr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),Iv=d(pm),od=s(pm,"P",{});var w2=a(od);Bv=i(w2,"Get the number of (optionally, trainable) parameters in the model."),w2.forEach(t),pm.forEach(t),Dr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T2=a(bn);sd=s(T2,"SPAN",{});var $2=a(sd);m(_s.$$.fragment,$2),$2.forEach(t),T2.forEach(t),Wv=d(cm),ad=s(cm,"SPAN",{});var j2=a(ad);Uv=i(j2,"FlaxPreTrainedModel"),j2.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var M2=a(rd);Vv=i(M2,"Base class for all models."),M2.forEach(t),Xv=d(q),sr=s(q,"P",{});var zx=a(sr);ar=s(zx,"A",{href:!0});var P2=a(ar);Rv=i(P2,"FlaxPreTrainedModel"),P2.forEach(t),Yv=i(zx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),zx.forEach(t),Kv=d(q),id=s(q,"P",{});var E2=a(id);Zv=i(E2,"Class attributes (overridden by derived classes):"),E2.forEach(t),Jv=d(q),ft=s(q,"UL",{});var zr=a(ft);Xe=s(zr,"LI",{});var za=a(Xe);ld=s(za,"STRONG",{});var L2=a(ld);Qv=i(L2,"config_class"),L2.forEach(t),ey=i(za," ("),rr=s(za,"A",{href:!0});var q2=a(rr);ty=i(q2,"PretrainedConfig"),q2.forEach(t),ny=i(za,") \u2014 A subclass of "),ir=s(za,"A",{href:!0});var F2=a(ir);oy=i(F2,"PretrainedConfig"),F2.forEach(t),sy=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),ay=d(zr),vn=s(zr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O2=a(dd);ry=i(O2,"base_model_prefix"),O2.forEach(t),iy=i(qp," ("),pd=s(qp,"CODE",{});var D2=a(pd);ly=i(D2,"str"),D2.forEach(t),dy=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),py=d(zr),R=s(zr,"LI",{});var ze=a(R);cd=s(ze,"STRONG",{});var z2=a(cd);cy=i(z2,"main_input_name"),z2.forEach(t),my=i(ze," ("),md=s(ze,"CODE",{});var A2=a(md);uy=i(A2,"str"),A2.forEach(t),gy=i(ze,") \u2014 The name of the principal input to the model (often "),ud=s(ze,"CODE",{});var G2=a(ud);hy=i(G2,"input_ids"),G2.forEach(t),_y=i(ze,` for NLP
models, `),gd=s(ze,"CODE",{});var S2=a(gd);fy=i(S2,"pixel_values"),S2.forEach(t),by=i(ze," for vision models and "),hd=s(ze,"CODE",{});var N2=a(hd);vy=i(N2,"input_values"),N2.forEach(t),yy=i(ze," for speech models)."),ze.forEach(t),zr.forEach(t),ky=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xy=d(On),vs=s(On,"P",{});var mm=a(vs);wy=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C2=a(_d);Ty=i(C2,"repo_path_or_name"),C2.forEach(t),$y=i(mm,"."),mm.forEach(t),jy=d(On),fd=s(On,"P",{});var I2=a(fd);My=i(I2,"Examples:"),I2.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ey=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ly=d(Te),bd=s(Te,"P",{});var B2=a(bd);qy=i(B2,"Instantiate a pretrained flax model from a pre-trained model configuration."),B2.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var W2=a(vd);Dy=i(W2,"Weights from XXX not initialized from pretrained model"),W2.forEach(t),zy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),gm.forEach(t),Cy=d(Te),kd=s(Te,"P",{});var H2=a(kd);Iy=i(H2,"Examples:"),H2.forEach(t),By=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),Wy=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m($s.$$.fragment,Ar),Uy=d(Ar),xd=s(Ar,"P",{});var V2=a(xd);Hy=i(V2,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V2.forEach(t),Vy=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xy=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m(js.$$.fragment,hm),Ry=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Yy=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X2=a(wd);Ky=i(X2,"[from_pretrained()](/docs/transformers/pr_15900/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X2.forEach(t),Zy=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);e1=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R2=a(Td);t1=i(R2,"params"),R2.forEach(t),n1=i(Je," to "),$d=s(Je,"CODE",{});var Y2=a($d);o1=i(Y2,"jax.numpy.bfloat16"),Y2.forEach(t),s1=i(Je,". This returns a new "),jd=s(Je,"CODE",{});var K2=a(jd);a1=i(K2,"params"),K2.forEach(t),r1=i(Je,` tree and does not cast
...
`),Od=s(et,"CODE",{});var o$=a(Od);w1=i(o$,"params"),o$.forEach(t),T1=i(et," in place."),et.forEach(t),$1=d(Qe),Dd=s(Qe,"P",{});var s$=a(Dd);j1=i(s$,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),s$.forEach(t),M1=d(Qe),zd=s(Qe,"P",{});var a$=a(zd);P1=i(a$,"Examples:"),a$.forEach(t),E1=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),L1=d(q),ue=s(q,"DIV",{class:!0});var Dn=a(ue);m(Fs.$$.fragment,Dn),q1=d(Dn),re=s(Dn,"P",{});var tt=a(re);F1=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var r$=a(Ad);O1=i(r$,"parmas"),r$.forEach(t),D1=i(tt," to "),Gd=s(tt,"CODE",{});var i$=a(Gd);z1=i(i$,"jax.numpy.float32"),i$.forEach(t),A1=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var l$=a(Sd);G1=i(l$,"params"),l$.forEach(t),S1=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var d$=a(Nd);N1=i(d$,"params"),d$.forEach(t),C1=i(tt," in place."),tt.forEach(t),I1=d(Dn),Cd=s(Dn,"P",{});var p$=a(Cd);B1=i(p$,"Examples:"),p$.forEach(t),W1=d(Dn),m(Os.$$.fragment,Dn),Dn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var c$=a(xn);Id=s(c$,"SPAN",{});var m$=a(Id);m(Ds.$$.fragment,m$),m$.forEach(t),c$.forEach(t),U1=d(fm),Bd=s(fm,"SPAN",{});var u$=a(Bd);H1=i(u$,"Generation"),u$.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(zs.$$.fragment,F),V1=d(F),As=s(F,"P",{});var bm=a(As);X1=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var g$=a(lr);R1=i(g$,"PreTrainedModel"),g$.forEach(t),Y1=i(bm,"."),bm.forEach(t),K1=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Z1=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);J1=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var h$=a(dr);Q1=i(h$,"PreTrainedModel"),h$.forEach(t),e0=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),t0=d(F),ge=s(F,"DIV",{class:!0});var zn=a(ge);m(Ns.$$.fragment,zn),n0=d(zn),Wd=s(zn,"P",{});var _$=a(Wd);o0=i(_$,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_$.forEach(t),s0=d(zn),Ud=s(zn,"P",{});var f$=a(Ud);a0=i(f$,"Examples:"),f$.forEach(t),r0=d(zn),m(Cs.$$.fragment,zn),zn.forEach(t),i0=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),l0=d(An),Hd=s(An,"P",{});var b$=a(Hd);d0=i(b$,"Generates sequences for models with a language modeling head using beam search decoding."),b$.forEach(t),p0=d(An),Vd=s(An,"P",{});var v$=a(Vd);c0=i(v$,"Examples:"),v$.forEach(t),m0=d(An),m(Bs.$$.fragment,An),An.forEach(t),u0=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),g0=d(km),Xd=s(km,"P",{});var y$=a(Xd);h0=i(y$,`compute the transition probabilities of sequences given generation
scores and beam indices`),y$.forEach(t),km.forEach(t),_0=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),f0=d(Gn),Rd=s(Gn,"P",{});var k$=a(Rd);b0=i(k$,"Generates sequences for models with a language modeling head using beam search decoding."),k$.forEach(t),v0=d(Gn),Yd=s(Gn,"P",{});var x$=a(Yd);y0=i(x$,"Examples:"),x$.forEach(t),k0=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),x0=d(F),U=s(F,"DIV",{class:!0});var $e=a(U);m(Vs.$$.fragment,$e),w0=d($e),Kd=s($e,"P",{});var w$=a(Kd);T0=i(w$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),w$.forEach(t),$0=d($e),vt=s($e,"P",{});var Gr=a(vt);j0=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var T$=a(Zd);M0=i(T$,"inputs"),T$.forEach(t),P0=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var $$=a(pr);E0=i($$,"PretrainedConfig"),$$.forEach(t),L0=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),q0=d($e),Xs=s($e,"P",{});var xm=a(Xs);F0=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var j$=a(Rs);O0=i(j$,`this blog
post`),j$.forEach(t),D0=i(xm,"."),xm.forEach(t),z0=d($e),Jd=s($e,"P",{});var M$=a(Jd);A0=i(M$,"Examples:"),M$.forEach(t),G0=d($e),m(Ys.$$.fragment,$e),$e.forEach(t),S0=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),N0=d(Sn),Qd=s(Sn,"P",{});var P$=a(Qd);C0=i(P$,"Generates sequences for models with a language modeling head using greedy decoding."),P$.forEach(t),I0=d(Sn),ep=s(Sn,"P",{});var E$=a(ep);B0=i(E$,"Examples:"),E$.forEach(t),W0=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),U0=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),H0=d(Nn),tp=s(Nn,"P",{});var L$=a(tp);V0=i(L$,"Generates sequences for models with a language modeling head using beam search decoding."),L$.forEach(t),X0=d(Nn),np=s(Nn,"P",{});var q$=a(np);R0=i(q$,"Examples:"),q$.forEach(t),Y0=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),K0=d(F),$n=s(F,"DIV",{class:!0});var wm=a($n);m(ea.$$.fragment,wm),Z0=d(wm),ta=s(wm,"P",{});var Tm=a(ta);J0=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var F$=a(cr);Q0=i(F$,"PreTrainedModel"),F$.forEach(t),ek=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tk=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nk=d(Cn),op=s(Cn,"P",{});var O$=a(op);ok=i(O$,"Generates sequences for models with a language modeling head using multinomial sampling."),O$.forEach(t),sk=d(Cn),sp=s(Cn,"P",{});var D$=a(sp);ak=i(D$,"Examples:"),D$.forEach(t),rk=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),ik=d(J),aa=s(J,"P",{});var $m=a(aa);lk=i($m,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s($m,"A",{href:!0});var z$=a(mr);dk=i(z$,"TFPreTrainedModel"),z$.forEach(t),pk=i($m,"."),$m.forEach(t),ck=d(J),jn=s(J,"DIV",{class:!0});var jm=a(jn);m(ra.$$.fragment,jm),mk=d(jm),ia=s(jm,"P",{});var Mm=a(ia);uk=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var A$=a(ur);gk=i(A$,"PreTrainedModel"),A$.forEach(t),hk=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),jm.forEach(t),_k=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fk=d(Q),ap=s(Q,"P",{});var G$=a(ap);bk=i(G$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),S$.forEach(t),xk=i(Pm,"."),Pm.forEach(t),wk=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tk=i(In,"Apart from "),rp=s(In,"CODE",{});var N$=a(rp);$k=i(N$,"input_ids"),N$.forEach(t),jk=i(In," and "),ip=s(In,"CODE",{});var C$=a(ip);Mk=i(C$,"attention_mask"),C$.forEach(t),Pk=i(In,`, all the arguments below will default to the value of the attribute
...
post`),B$.forEach(t),Dk=i(Em,"."),Em.forEach(t),zk=d(Q),lp=s(Q,"P",{});var W$=a(lp);Ak=i(W$,"Examples:"),W$.forEach(t),Gk=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),Sk=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),Nk=d(Bn),dp=s(Bn,"P",{});var U$=a(dp);Ck=i(U$,"Generates sequences for models with a language modeling head using greedy decoding."),U$.forEach(t),Ik=d(Bn),pp=s(Bn,"P",{});var H$=a(pp);Bk=i(H$,"Examples:"),H$.forEach(t),Wk=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),Uk=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(_a.$$.fragment,Lm),Hk=d(Lm),fa=s(Lm,"P",{});var qm=a(fa);Vk=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var V$=a(hr);Xk=i(V$,"TFPreTrainedModel"),V$.forEach(t),Rk=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Yk=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),Kk=d(Wn),cp=s(Wn,"P",{});var X$=a(cp);Zk=i(X$,"Generates sequences for models with a language modeling head using multinomial sampling."),X$.forEach(t),Jk=d(Wn),mp=s(Wn,"P",{});var R$=a(mp);Qk=i(R$,"Examples:"),R$.forEach(t),ex=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),tx=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nx=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Y$=a(_r);ox=i(Y$,"FlaxPreTrainedModel"),Y$.forEach(t),sx=i(Fm,"."),Fm.forEach(t),ax=d(Sr),H=s(Sr,"DIV",{class:!0});var je=a(H);m(xa.$$.fragment,je),rx=d(je),up=s(je,"P",{});var K$=a(up);ix=i(K$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),K$.forEach(t),lx=d(je),yt=s(je,"P",{});var Nr=a(yt);dx=i(Nr,"Apart from "),gp=s(Nr,"CODE",{});var Z$=a(gp);px=i(Z$,"input_ids"),Z$.forEach(t),cx=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
