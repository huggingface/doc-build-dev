...
</ul>`,name:"config"}]}}),Lt=new Fp({props:{$$slots:{default:[cj]},$$scope:{ctx:ee}}}),qt=new Fp({props:{$$slots:{default:[mj]},$$scope:{ctx:ee}}}),to=new O({props:{codee:`from transformers import BertConfig, BertModel
...
</ul>`,name:"config"}]}}),Qt=new Fp({props:{$$slots:{default:[gj]},$$scope:{ctx:ee}}}),Ho=new O({props:{codee:`from transformers import BertConfig, TFBertModel
