...
This is the configuration class to store the configuration of a [MT5Model](/docs/transformers/pr_15446/en/model_doc/mt5#transformers.MT5Model) or a [TFMT5Model](/docs/transformers/pr_15446/en/model_doc/mt5#transformers.TFMT5Model). It is used to
...
<div class="docstring">
<docstring><name>convert\_tokens\_to\_string</name><anchor>transformers.T5Tokenizer.convert_tokens_to_string</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/t5/tokenization_t5.py#L284</source><parameters>[{"name": "tokens", "val": ""}]</parameters></docstring>
...
See [T5Tokenizer](/docs/transformers/pr_15446/en/model_doc/mt5#transformers.T5Tokenizer) for all details.
...
See [T5TokenizerFast](/docs/transformers/pr_15446/en/model_doc/mt5#transformers.T5TokenizerFast) for all details.
...
<docstring><name>class transformers.MT5Model</name><anchor>transformers.MT5Model</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/mt5/modeling_mt5.py#L28</source><parameters>[{"name": "config", "val": ": T5Config"}]</parameters></docstring>

This class overrides [T5Model](/docs/transformers/pr_15446/en/model_doc/t5#transformers.T5Model). Please check the superclass for the appropriate documentation alongside usage
examples.
...
<docstring><name>class transformers.MT5ForConditionalGeneration</name><anchor>transformers.MT5ForConditionalGeneration</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/mt5/modeling_mt5.py#L62</source><parameters>[{"name": "config", "val": ""}]</parameters></docstring>

This class overrides [T5ForConditionalGeneration](/docs/transformers/pr_15446/en/model_doc/t5#transformers.T5ForConditionalGeneration). Please check the superclass for the appropriate documentation
...
<docstring><name>class transformers.MT5EncoderModel</name><anchor>transformers.MT5EncoderModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/mt5/modeling_mt5.py#L94</source><parameters>[{"name": "config", "val": ": T5Config"}]</parameters></docstring>

This class overrides [T5EncoderModel](/docs/transformers/pr_15446/en/model_doc/t5#transformers.T5EncoderModel). Please check the superclass for the appropriate documentation alongside
usage examples.
...
<docstring><name>class transformers.TFMT5Model</name><anchor>transformers.TFMT5Model</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/mt5/modeling_tf_mt5.py#L28</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This class overrides [TFT5Model](/docs/transformers/pr_15446/en/model_doc/t5#transformers.TFT5Model). Please check the superclass for the appropriate documentation alongside usage
examples.
...
<docstring><name>class transformers.TFMT5ForConditionalGeneration</name><anchor>transformers.TFMT5ForConditionalGeneration</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/mt5/modeling_tf_mt5.py#L53</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This class overrides [TFT5ForConditionalGeneration](/docs/transformers/pr_15446/en/model_doc/t5#transformers.TFT5ForConditionalGeneration). Please check the superclass for the appropriate
...
<docstring><name>class transformers.TFMT5EncoderModel</name><anchor>transformers.TFMT5EncoderModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/mt5/modeling_tf_mt5.py#L79</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This class overrides [TFT5EncoderModel](/docs/transformers/pr_15446/en/model_doc/t5#transformers.TFT5EncoderModel). Please check the superclass for the appropriate documentation alongside
usage examples.
...
This class overrides [FlaxT5ForConditionalGeneration](/docs/transformers/pr_15446/en/model_doc/t5#transformers.FlaxT5ForConditionalGeneration). Please check the superclass for the appropriate
documentation alongside usage examples.
