...
[generate()](/docs/transformers/pr_15446/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to autoregressively generate text given the input image.
...
[TrOCRProcessor](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor) wraps [`ViTFeatureExtractor`/`DeiTFeatureExtractor`] and [`RobertaTokenizer`/`XLMRobertaTokenizer`]
...
This is the configuration class to store the configuration of a [TrOCRForCausalLM](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRForCausalLM). It is used to instantiate an
...
<docstring><name>class transformers.TrOCRProcessor</name><anchor>transformers.TrOCRProcessor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/processing_trocr.py#L28</source><parameters>[{"name": "feature_extractor", "val": ""}, {"name": "tokenizer", "val": ""}]</parameters><paramsdesc>- **feature_extractor** ([`ViTFeatureExtractor`/`DeiTFeatureExtractor`]) --
...
[TrOCRProcessor](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor) offers all the functionalities of [`ViTFeatureExtractor`/`DeiTFeatureExtractor`] and
[`RobertaTokenizer`/`XLMRobertaTokenizer`]. See the [__call__()](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor.__call__) and [decode()](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor.decode) for
more information.
...
<div class="docstring">
<docstring><name>\_\_call\_\_</name><anchor>transformers.TrOCRProcessor.__call__</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/processing_trocr.py#L114</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor's
`__call__()`and returns its output. If used in the context
[as_target_processor()](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor.as_target_processor) this method forwards all its arguments to TrOCRTokenizer's
`__call__`. Please refer to the doctsring of the above two methods for more information.


</div>
<div class="docstring">
<docstring><name>from\_pretrained</name><anchor>transformers.TrOCRProcessor.from_pretrained</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/processing_trocr.py#L81</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  This can be either:
...
Instantiate a [TrOCRProcessor](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor) from a pretrained TrOCR processor.
...
can be re-loaded using the [from_pretrained()](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRProcessor.from_pretrained) class method.
...
<div class="docstring">
<docstring><name>batch\_decode</name><anchor>transformers.TrOCRProcessor.batch_decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/processing_trocr.py#L123</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to TrOCRTokenizer's [batch_decode()](/docs/transformers/pr_15446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode). Please refer
to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>decode</name><anchor>transformers.TrOCRProcessor.decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/processing_trocr.py#L130</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to TrOCRTokenizer's [decode()](/docs/transformers/pr_15446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode). Please refer to the
docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>as\_target\_processor</name><anchor>transformers.TrOCRProcessor.as_target_processor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/processing_trocr.py#L137</source><parameters>[]</parameters></docstring>
...
<docstring><name>class transformers.TrOCRForCausalLM</name><anchor>transformers.TrOCRForCausalLM</anchor><source>https://github.com/huggingface/transformers/blob/pr_15446/src/transformers/models/trocr/modeling_trocr.py#L776</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([TrOCRConfig](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRConfig)) --
...
The TrOCR Decoder with a language modeling head. Can be used as the decoder part of [EncoderDecoderModel](/docs/transformers/pr_15446/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) and `VisionEncoderDecoder`.
...
elements depending on the configuration ([TrOCRConfig](/docs/transformers/pr_15446/en/model_doc/trocr#transformers.TrOCRConfig)) and inputs.
