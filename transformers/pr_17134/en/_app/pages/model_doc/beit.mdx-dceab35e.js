import{S as rh,i as sh,s as nh,e as a,k as p,w,t as n,M as ih,c as r,d as t,m,a as s,x,h as i,b as d,F as e,g as _,y as $,q as y,o as T,B,v as lh,L as yt}from"../../chunks/vendor-6b77c823.js";import{T as xt}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-1088f2fb.js";import{C as Tt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Q}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as $t}from"../../chunks/ExampleCodeBlock-5212b321.js";function dh(F){let c,v,u,f,b;return f=new Tt({props:{code:`from transformers import BeitModel, BeitConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),{c(){c=a("p"),v=n("Example:"),u=p(),w(f.$$.fragment)},l(l){c=r(l,"P",{});var h=s(c);v=i(h,"Example:"),h.forEach(t),u=m(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,u,h),$(f,l,h),b=!0},p:yt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(u),B(f,l)}}}function Bh(F){let c,v,u,f,b,l,h,E,tn,es,ce,ze,za,Bt,on,Aa,an,ts,W,rn,Ft,sn,nn,Et,ln,dn,kt,cn,pn,os,Xo,mn,as,Ko,qa,hn,rs,Yo,fn,ss,C,k,un,Qo,gn,_n,Zo,bn,vn,Mt,wn,xn,ea,$n,yn,ta,Tn,Bn,oa,Fn,En,aa,kn,Mn,In,It,jn,jt,Pn,Cn,zn,Pt,An,ra,qn,Ln,Nn,pe,Sn,La,On,Dn,Ct,Vn,Wn,Un,me,Rn,zt,Hn,Jn,At,Gn,Xn,Kn,S,Yn,Na,Qn,Zn,Sa,ei,ti,sa,oi,ai,Oa,ri,si,ns,U,ni,qt,ii,li,Lt,di,ci,Nt,pi,mi,is,he,Ae,Da,St,hi,Va,fi,ls,fe,Ot,ui,Dt,gi,na,_i,bi,ds,ue,Vt,vi,Wt,wi,ia,xi,$i,cs,ge,qe,Wa,Ut,yi,Ua,Ti,ps,Z,Rt,Bi,_e,Fi,la,Ei,ki,Ht,Mi,Ii,ji,Le,ms,be,Ne,Ra,Jt,Pi,Ha,Ci,hs,O,Gt,zi,Ja,Ai,qi,Xt,Li,da,Ni,Si,Oi,ie,Kt,Di,Ga,Vi,Wi,Se,fs,ve,Oe,Xa,Yt,Ui,Ka,Ri,us,ee,Qt,Hi,Zt,Ji,eo,Gi,Xi,Ki,R,to,Yi,we,Qi,ca,Zi,el,Ya,tl,ol,al,De,rl,Ve,gs,xe,We,Qa,oo,sl,Za,nl,_s,te,ao,il,oe,ll,pa,dl,cl,ma,pl,ml,ro,hl,fl,ul,H,so,gl,$e,_l,ha,bl,vl,er,wl,xl,$l,Ue,yl,Re,bs,ye,He,tr,no,Tl,or,Bl,vs,D,io,Fl,ar,El,kl,lo,Ml,co,Il,jl,Pl,J,po,Cl,Te,zl,fa,Al,ql,rr,Ll,Nl,Sl,Je,Ol,Ge,ws,Be,Xe,sr,mo,Dl,nr,Vl,xs,V,ho,Wl,ir,Ul,Rl,fo,Hl,uo,Jl,Gl,Xl,G,go,Kl,Fe,Yl,ua,Ql,Zl,lr,ed,td,od,Ke,ad,Ye,$s,Ee,Qe,dr,_o,rd,cr,sd,ys,M,bo,nd,pr,id,ld,vo,dd,ga,cd,pd,md,wo,hd,xo,fd,ud,gd,mr,_d,bd,ae,hr,$o,vd,wd,fr,yo,xd,$d,ur,To,yd,Td,gr,Bo,Bd,Fd,X,Fo,Ed,ke,kd,_r,Md,Id,br,jd,Pd,Cd,Ze,zd,et,Ts,Me,tt,vr,Eo,Ad,wr,qd,Bs,I,ko,Ld,xr,Nd,Sd,Mo,Od,_a,Dd,Vd,Wd,Io,Ud,jo,Rd,Hd,Jd,$r,Gd,Xd,re,yr,Po,Kd,Yd,Tr,Co,Qd,Zd,Br,zo,ec,tc,Fr,Ao,oc,ac,A,qo,rc,Ie,sc,Er,nc,ic,kr,lc,dc,cc,ot,pc,je,mc,Mr,hc,fc,Ir,uc,gc,_c,at,Fs,Pe,rt,jr,Lo,bc,Pr,vc,Es,j,No,wc,Cr,xc,$c,So,yc,ba,Tc,Bc,Fc,Oo,Ec,Do,kc,Mc,Ic,zr,jc,Pc,se,Ar,Vo,Cc,zc,qr,Wo,Ac,qc,Lr,Uo,Lc,Nc,Nr,Ro,Sc,Oc,K,Ho,Dc,Ce,Vc,Sr,Wc,Uc,Or,Rc,Hc,Jc,st,Gc,nt,ks;return l=new Q({}),Bt=new Q({}),St=new Q({}),Ot=new P({props:{name:"class transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",parameters:[{name:"last_hidden_state",val:": FloatTensor = None"},{name:"pooler_output",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/feature_extraction_beit.py#L97",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17134/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Whether or not to return a <a href="/docs/transformers/pr_17134/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/modeling_beit.py#L657",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17134/en/model_doc/beit#transformers.models.beit.modeling_beit.BeitModelOutputWithPooling"
>transformers.models.beit.modeling_beit.BeitModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17134/en/model_doc/beit#transformers.BeitConfig"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/modeling_beit.py#L756",returnDescription:`
<p>A <a
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/modeling_beit.py#L855",returnDescription:`
...
Ground truth semantic segmentation maps for computing the loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code>, a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/modeling_beit.py#L1195",returnDescription:`
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17134/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17134/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/modeling_flax_beit.py#L743"}}),Fo=new P({props:{name:"__call__",anchor:"transformers.FlaxBeitModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"bool_masked_pos",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17134/src/transformers/models/beit/modeling_flax_beit.py#L629",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17134/en/model_doc/beit#transformers.models.beit.modeling_flax_beit.FlaxBeitModelOutputWithPooling"
...
`),ra=a("a"),qn=n("BeitFeatureExtractor"),Ln=n(" to resize (or rescale) and normalize images for the model."),Nn=p(),pe=a("li"),Sn=n(`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
...
`),Sa=a("code"),ei=n("use_relative_position_bias"),ti=n(" attribute of "),sa=a("a"),oi=n("BeitConfig"),ai=n(" to "),Oa=a("code"),ri=n("True"),si=n(` in order to add
...
contributed by `),Lt=a("a"),di=n("kamalkraj"),ci=n(". The original code can be found "),Nt=a("a"),pi=n("here"),mi=n("."),is=p(),he=a("h2"),Ae=a("a"),Da=a("span"),w(St.$$.fragment),hi=p(),Va=a("span"),fi=n("BEiT specific outputs"),ls=p(),fe=a("div"),w(Ot.$$.fragment),ui=p(),Dt=a("p"),gi=n("Class for outputs of "),na=a("a"),_i=n("BeitModel"),bi=n("."),ds=p(),ue=a("div"),w(Vt.$$.fragment),vi=p(),Wt=a("p"),wi=n("Class for outputs of "),ia=a("a"),xi=n("FlaxBeitModel"),$i=n("."),cs=p(),ge=a("h2"),qe=a("a"),Wa=a("span"),w(Ut.$$.fragment),yi=p(),Ua=a("span"),Ti=n("BeitConfig"),ps=p(),Z=a("div"),w(Rt.$$.fragment),Bi=p(),_e=a("p"),Fi=n("This is the configuration class to store the configuration of a "),la=a("a"),Ei=n("BeitModel"),ki=n(`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),Ht=a("a"),Mi=n("microsoft/beit-base-patch16-224-pt22k"),Ii=n(" architecture."),ji=p(),w(Le.$$.fragment),ms=p(),be=a("h2"),Ne=a("a"),Ra=a("span"),w(Jt.$$.fragment),Pi=p(),Ha=a("span"),Ci=n("BeitFeatureExtractor"),hs=p(),O=a("div"),w(Gt.$$.fragment),zi=p(),Ja=a("p"),Ai=n("Constructs a BEiT feature extractor."),qi=p(),Xt=a("p"),Li=n("This feature extractor inherits from "),da=a("a"),Ni=n("FeatureExtractionMixin"),Si=n(` which contains most of
the main methods. Users should refer to this superclass for more information regarding those methods.`),Oi=p(),ie=a("div"),w(Kt.$$.fragment),Di=p(),Ga=a("p"),Vi=n("Main method to prepare for the model one or several image(s)."),Wi=p(),w(Se.$$.fragment),fs=p(),ve=a("h2"),Oe=a("a"),Xa=a("span"),w(Yt.$$.fragment),Ui=p(),Ka=a("span"),Ri=n("BeitModel"),us=p(),ee=a("div"),w(Qt.$$.fragment),Hi=p(),Zt=a("p"),Ji=n(`The bare Beit Model transformer outputting raw hidden-states without any specific head on top.
...
Boolean masked positions. Indicates which patches are masked (1) and which aren\u2019t (0).`),_c=p(),w(at.$$.fragment),Fs=p(),Pe=a("h2"),rt=a("a"),jr=a("span"),w(Lo.$$.fragment),bc=p(),Pr=a("span"),vc=n("FlaxBeitForImageClassification"),Es=p(),j=a("div"),w(No.$$.fragment),wc=p(),Cr=a("p"),xc=n(`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
...
`),ra=r(Is,"A",{href:!0});var ap=s(ra);qn=i(ap,"BeitFeatureExtractor"),ap.forEach(t),Ln=i(Is," to resize (or rescale) and normalize images for the model."),Is.forEach(t),Nn=m(Y),pe=r(Y,"LI",{});var va=s(pe);Sn=i(va,`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
...
images and 1,000 classes).`),wa.forEach(t),Kn=m(Y),S=r(Y,"LI",{});var le=s(S);Yn=i(le,`BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
relative position bias among the several self-attention layers. During fine-tuning, each layer\u2019s relative position
bias is initialized with the shared relative position bias obtained after pre-training. Note that, if one wants to
pre-train a model from scratch, one needs to either set the `),Na=r(le,"CODE",{});var lp=s(Na);Qn=i(lp,"use_relative_position_bias"),lp.forEach(t),Zn=i(le,` or the
`),Sa=r(le,"CODE",{});var dp=s(Sa);ei=i(dp,"use_relative_position_bias"),dp.forEach(t),ti=i(le," attribute of "),sa=r(le,"A",{href:!0});var cp=s(sa);oi=i(cp,"BeitConfig"),cp.forEach(t),ai=i(le," to "),Oa=r(le,"CODE",{});var pp=s(Oa);ri=i(pp,"True"),pp.forEach(t),si=i(le,` in order to add
...
contributed by `),Lt=r(it,"A",{href:!0,rel:!0});var hp=s(Lt);di=i(hp,"kamalkraj"),hp.forEach(t),ci=i(it,". The original code can be found "),Nt=r(it,"A",{href:!0,rel:!0});var fp=s(Nt);pi=i(fp,"here"),fp.forEach(t),mi=i(it,"."),it.forEach(t),is=m(o),he=r(o,"H2",{class:!0});var js=s(he);Ae=r(js,"A",{id:!0,class:!0,href:!0});var up=s(Ae);Da=r(up,"SPAN",{});var gp=s(Da);x(St.$$.fragment,gp),gp.forEach(t),up.forEach(t),hi=m(js),Va=r(js,"SPAN",{});var _p=s(Va);fi=i(_p,"BEiT specific outputs"),_p.forEach(t),js.forEach(t),ls=m(o),fe=r(o,"DIV",{class:!0});var Ps=s(fe);x(Ot.$$.fragment,Ps),ui=m(Ps),Dt=r(Ps,"P",{});var Cs=s(Dt);gi=i(Cs,"Class for outputs of "),na=r(Cs,"A",{href:!0});var bp=s(na);_i=i(bp,"BeitModel"),bp.forEach(t),bi=i(Cs,"."),Cs.forEach(t),Ps.forEach(t),ds=m(o),ue=r(o,"DIV",{class:!0});var zs=s(ue);x(Vt.$$.fragment,zs),vi=m(zs),Wt=r(zs,"P",{});var As=s(Wt);wi=i(As,"Class for outputs of "),ia=r(As,"A",{href:!0});var vp=s(ia);xi=i(vp,"FlaxBeitModel"),vp.forEach(t),$i=i(As,"."),As.forEach(t),zs.forEach(t),cs=m(o),ge=r(o,"H2",{class:!0});var qs=s(ge);qe=r(qs,"A",{id:!0,class:!0,href:!0});var wp=s(qe);Wa=r(wp,"SPAN",{});var xp=s(Wa);x(Ut.$$.fragment,xp),xp.forEach(t),wp.forEach(t),yi=m(qs),Ua=r(qs,"SPAN",{});var $p=s(Ua);Ti=i($p,"BeitConfig"),$p.forEach(t),qs.forEach(t),ps=m(o),Z=r(o,"DIV",{class:!0});var xa=s(Z);x(Rt.$$.fragment,xa),Bi=m(xa),_e=r(xa,"P",{});var $a=s(_e);Fi=i($a,"This is the configuration class to store the configuration of a "),la=r($a,"A",{href:!0});var yp=s(la);Ei=i(yp,"BeitModel"),yp.forEach(t),ki=i($a,`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),Ht=r($a,"A",{href:!0,rel:!0});var Tp=s(Ht);Mi=i(Tp,"microsoft/beit-base-patch16-224-pt22k"),Tp.forEach(t),Ii=i($a," architecture."),$a.forEach(t),ji=m(xa),x(Le.$$.fragment,xa),xa.forEach(t),ms=m(o),be=r(o,"H2",{class:!0});var Ls=s(be);Ne=r(Ls,"A",{id:!0,class:!0,href:!0});var Bp=s(Ne);Ra=r(Bp,"SPAN",{});var Fp=s(Ra);x(Jt.$$.fragment,Fp),Fp.forEach(t),Bp.forEach(t),Pi=m(Ls),Ha=r(Ls,"SPAN",{});var Ep=s(Ha);Ci=i(Ep,"BeitFeatureExtractor"),Ep.forEach(t),Ls.forEach(t),hs=m(o),O=r(o,"DIV",{class:!0});var lt=s(O);x(Gt.$$.fragment,lt),zi=m(lt),Ja=r(lt,"P",{});var kp=s(Ja);Ai=i(kp,"Constructs a BEiT feature extractor."),kp.forEach(t),qi=m(lt),Xt=r(lt,"P",{});var Ns=s(Xt);Li=i(Ns,"This feature extractor inherits from "),da=r(Ns,"A",{href:!0});var Mp=s(da);Ni=i(Mp,"FeatureExtractionMixin"),Mp.forEach(t),Si=i(Ns,` which contains most of
the main methods. Users should refer to this superclass for more information regarding those methods.`),Ns.forEach(t),Oi=m(lt),ie=r(lt,"DIV",{class:!0});var ya=s(ie);x(Kt.$$.fragment,ya),Di=m(ya),Ga=r(ya,"P",{});var Ip=s(Ga);Vi=i(Ip,"Main method to prepare for the model one or several image(s)."),Ip.forEach(t),Wi=m(ya),x(Se.$$.fragment,ya),ya.forEach(t),lt.forEach(t),fs=m(o),ve=r(o,"H2",{class:!0});var Ss=s(ve);Oe=r(Ss,"A",{id:!0,class:!0,href:!0});var jp=s(Oe);Xa=r(jp,"SPAN",{});var Pp=s(Xa);x(Yt.$$.fragment,Pp),Pp.forEach(t),jp.forEach(t),Ui=m(Ss),Ka=r(Ss,"SPAN",{});var Cp=s(Ka);Ri=i(Cp,"BeitModel"),Cp.forEach(t),Ss.forEach(t),us=m(o),ee=r(o,"DIV",{class:!0});var Ta=s(ee);x(Qt.$$.fragment,Ta),Hi=m(Ta),Zt=r(Ta,"P",{});var Os=s(Zt);Ji=i(Os,`The bare Beit Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),eo=r(Os,"A",{href:!0,rel:!0});var zp=s(eo);Gi=i(zp,"torch.nn.Module"),zp.forEach(t),Xi=i(Os,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(t),Ki=m(Ta),R=r(Ta,"DIV",{class:!0});var dt=s(R);x(to.$$.fragment,dt),Yi=m(dt),we=r(dt,"P",{});var Ba=s(we);Qi=i(Ba,"The "),ca=r(Ba,"A",{href:!0});var Ap=s(ca);Zi=i(Ap,"BeitModel"),Ap.forEach(t),el=i(Ba," forward method, overrides the "),Ya=r(Ba,"CODE",{});var qp=s(Ya);tl=i(qp,"__call__"),qp.forEach(t),ol=i(Ba," special method."),Ba.forEach(t),al=m(dt),x(De.$$.fragment,dt),rl=m(dt),x(Ve.$$.fragment,dt),dt.forEach(t),Ta.forEach(t),gs=m(o),xe=r(o,"H2",{class:!0});var Ds=s(xe);We=r(Ds,"A",{id:!0,class:!0,href:!0});var Lp=s(We);Qa=r(Lp,"SPAN",{});var Np=s(Qa);x(oo.$$.fragment,Np),Np.forEach(t),Lp.forEach(t),sl=m(Ds),Za=r(Ds,"SPAN",{});var Sp=s(Za);nl=i(Sp,"BeitForMaskedImageModeling"),Sp.forEach(t),Ds.forEach(t),_s=m(o),te=r(o,"DIV",{class:!0});var Fa=s(te);x(ao.$$.fragment,Fa),il=m(Fa),oe=r(Fa,"P",{});var ct=s(oe);ll=i(ct,`Beit Model transformer with a \u2018language\u2019 modeling head on top. BEiT does masked image modeling by predicting
visual tokens of a Vector-Quantize Variational Autoencoder (VQ-VAE), whereas other vision models like ViT and DeiT
