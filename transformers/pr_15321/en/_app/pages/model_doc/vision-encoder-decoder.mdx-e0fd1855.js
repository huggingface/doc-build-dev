import{S as rc,i as ac,s as sc,e as r,k as c,w as u,t,M as dc,c as a,d as o,m as l,a as s,x as g,h as n,b as i,F as e,g as w,y as _,q as v,o as b,B as T}from"../../chunks/vendor-4833417e.js";import{T as Vd}from"../../chunks/Tip-fffd6df1.js";import{D as B}from"../../chunks/Docstring-44c5af16.js";import{C as yo}from"../../chunks/CodeBlock-90ffda97.js";import{I as Yt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function ic(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
...
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(j,"CODE",{});var C=s(m);M=n(C,"Module"),C.forEach(o),F=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function pc(Q){let p,P,m,M,F,y,j,C,Vn,Jt,f,$n,Eo,qn,zn,rt,Pn,Fn,ko,Cn,An,xo,In,Sn,jo,Ln,Nn,Do,On,Rn,at,Bn,Gn,Mo,Wn,Un,Vo,Hn,Zn,$o,Yn,Jn,qo,Kn,Qn,Kt,he,Xn,xe,er,or,Qt,G,tr,zo,nr,rr,Po,ar,sr,Xt,X,me,st,je,dr,dt,ir,en,z,De,cr,fe,Fo,lr,pr,Co,hr,mr,fr,ee,ur,Ao,gr,_r,Io,vr,br,Tr,it,wr,yr,Me,Er,ue,Ve,kr,$e,xr,So,jr,Dr,Mr,ge,qe,Vr,oe,$r,ct,qr,zr,lt,Pr,Fr,on,te,_e,pt,ze,Cr,ht,Ar,tn,E,Pe,Ir,ne,Sr,mt,Lr,Nr,ft,Or,Rr,Br,Fe,Gr,Ce,Wr,Ur,Hr,Ae,Zr,Ie,Yr,Jr,Kr,ut,Qr,Xr,Se,ea,Lo,oa,ta,na,Le,ra,Ne,aa,sa,da,W,No,ia,ca,gt,la,pa,_t,ha,ma,fa,A,Oe,ua,re,ga,Oo,_a,va,vt,ba,Ta,wa,ve,ya,bt,Ea,ka,Re,xa,I,Be,ja,Tt,Da,Ma,ae,Va,wt,$a,qa,yt,za,Pa,Fa,Et,Ca,Aa,Ge,nn,se,be,kt,We,Ia,xt,Sa,rn,k,Ue,La,de,Na,jt,Oa,Ra,Dt,Ba,Ga,Wa,He,Ua,Ze,Ha,Za,Ya,Ye,Ja,Je,Ka,Qa,Xa,Mt,es,os,Ke,ts,Ro,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Bo,ls,ps,Vt,hs,ms,$t,fs,us,gs,S,eo,_s,ie,vs,Go,bs,Ts,qt,ws,ys,Es,Te,ks,zt,xs,js,oo,Ds,O,to,Ms,Pt,Vs,$s,Ft,qs,zs,no,an,ce,we,Ct,ro,Ps,At,Fs,sn,x,ao,Cs,le,As,It,Is,Ss,St,Ls,Ns,Os,so,Rs,io,Bs,Gs,Ws,co,Us,lo,Hs,Zs,Ys,Lt,Js,Ks,po,Qs,Wo,Xs,ed,od,ho,td,mo,nd,rd,ad,H,Uo,sd,dd,Nt,id,cd,Ot,ld,pd,hd,L,fo,md,pe,fd,Ho,ud,gd,Rt,_d,vd,bd,ye,Td,Bt,wd,yd,uo,Ed,R,go,kd,Gt,xd,jd,Wt,Dd,Md,_o,dn;return y=new Yt({}),je=new Yt({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15321/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_15321/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_15321/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15321/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15321/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15321/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_15321/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_15321/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
example is <code>google/vit-base-patch16-224-in21k</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15321/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_15321/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Zhou, Wei Li, Peter J. Liu.`),Hr=c(),Ae=r("p"),Zr=t("Additionally, in "),Ie=r("a"),Yr=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
specified arguments, defining the encoder and decoder configs.`),Zt.forEach(o),fr=l(N),ee=a(N,"P",{});var Yo=s(ee);ur=n(Yo,"Configuration objects inherit from "),Ao=a(Yo,"A",{href:!0});var Jd=s(Ao);gr=n(Jd,"PretrainedConfig"),Jd.forEach(o),_r=n(Yo,` and can be used to control the model outputs. Read the
documentation from `),Io=a(Yo,"A",{href:!0});var Kd=s(Io);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(Yo," for more information."),Yo.forEach(o),Tr=l(N),it=a(N,"P",{});var Qd=s(it);wr=n(Qd,"Examples:"),Qd.forEach(o),yr=l(N),g(Me.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(Ve.$$.fragment,pn),kr=l(pn),$e=a(pn,"P",{});var hn=s($e);xr=n(hn,"Instantiate a "),So=a(hn,"A",{href:!0});var Xd=s(So);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Dr=n(hn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),hn.forEach(o),pn.forEach(o),Mr=l(N),ge=a(N,"DIV",{class:!0});var mn=s(ge);g(qe.$$.fragment,mn),Vr=l(mn),oe=a(mn,"P",{});var Jo=s(oe);$r=n(Jo,"Serializes this instance to a Python dictionary. Override the default "),ct=a(Jo,"EM",{});var ei=s(ct);qr=n(ei,"to_dict()"),ei.forEach(o),zr=n(Jo," from "),lt=a(Jo,"EM",{});var oi=s(lt);Pr=n(oi,"PretrainedConfig"),oi.forEach(o),Fr=n(Jo,"."),Jo.forEach(o),mn.forEach(o),N.forEach(o),on=l(d),te=a(d,"H2",{class:!0});var fn=s(te);_e=a(fn,"A",{id:!0,class:!0,href:!0});var ti=s(_e);pt=a(ti,"SPAN",{});var ni=s(pt);g(ze.$$.fragment,ni),ni.forEach(o),ti.forEach(o),Cr=l(fn),ht=a(fn,"SPAN",{});var ri=s(ht);Ar=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),fn.forEach(o),tn=l(d),E=a(d,"DIV",{class:!0});var V=s(E);g(Pe.$$.fragment,V),Ir=l(V),ne=a(V,"P",{});var Ko=s(ne);Sr=n(Ko,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),un.forEach(o),Hr=l(V),Ae=a(V,"P",{});var gn=s(Ae);Zr=n(gn,"Additionally, in "),Ie=a(gn,"A",{href:!0,rel:!0});var ii=s(Ie);Yr=n(ii,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
:meth`),_t=a(bo,"EM",{});var fi=s(_t);ha=n(fi,"~transformers.AutoModelForCausalLM.from_pretrained"),fi.forEach(o),ma=n(bo," class method for the decoder."),bo.forEach(o),fa=l(V),A=a(V,"DIV",{class:!0});var Z=s(A);g(Oe.$$.fragment,Z),ua=l(Z),re=a(Z,"P",{});var Qo=s(re);ga=n(Qo,"The "),Oo=a(Qo,"A",{href:!0});var ui=s(Oo);_a=n(ui,"VisionEncoderDecoderModel"),ui.forEach(o),va=n(Qo," forward method, overrides the "),vt=a(Qo,"CODE",{});var gi=s(vt);ba=n(gi,"__call__"),gi.forEach(o),Ta=n(Qo," special method."),Qo.forEach(o),wa=l(Z),g(ve.$$.fragment,Z),ya=l(Z),bt=a(Z,"P",{});var _i=s(bt);Ea=n(_i,"Examples:"),_i.forEach(o),ka=l(Z),g(Re.$$.fragment,Z),Z.forEach(o),xa=l(V),I=a(V,"DIV",{class:!0});var Y=s(I);g(Be.$$.fragment,Y),ja=l(Y),Tt=a(Y,"P",{});var vi=s(Tt);Da=n(vi,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),vi.forEach(o),Ma=l(Y),ae=a(Y,"P",{});var Xo=s(ae);Va=n(Xo,"The model is set in evaluation mode by default using "),wt=a(Xo,"CODE",{});var bi=s(wt);$a=n(bi,"model.eval()"),bi.forEach(o),qa=n(Xo,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),yt=a(Xo,"CODE",{});var Ti=s(yt);za=n(Ti,"model.train()"),Ti.forEach(o),Pa=n(Xo,"."),Xo.forEach(o),Fa=l(Y),Et=a(Y,"P",{});var wi=s(Et);Ca=n(wi,"Example:"),wi.forEach(o),Aa=l(Y),g(Ge.$$.fragment,Y),Y.forEach(o),V.forEach(o),nn=l(d),se=a(d,"H2",{class:!0});var bn=s(se);be=a(bn,"A",{id:!0,class:!0,href:!0});var yi=s(be);kt=a(yi,"SPAN",{});var Ei=s(kt);g(We.$$.fragment,Ei),Ei.forEach(o),yi.forEach(o),Ia=l(bn),xt=a(bn,"SPAN",{});var ki=s(xt);Sa=n(ki,"TFVisionEncoderDecoderModel"),ki.forEach(o),bn.forEach(o),rn=l(d),k=a(d,"DIV",{class:!0});var $=s(k);g(Ue.$$.fragment,$),La=l($),de=a($,"P",{});var et=s(de);Na=n(et,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
`),$t=a(To,"CODE",{});var Fi=s($t);fs=n(Fi,"from_pretrained()"),Fi.forEach(o),us=n(To,"class method for the decoder."),To.forEach(o),gs=l($),S=a($,"DIV",{class:!0});var J=s(S);g(eo.$$.fragment,J),_s=l(J),ie=a(J,"P",{});var ot=s(ie);vs=n(ot,"The "),Go=a(ot,"A",{href:!0});var Ci=s(Go);bs=n(Ci,"TFVisionEncoderDecoderModel"),Ci.forEach(o),Ts=n(ot," forward method, overrides the "),qt=a(ot,"CODE",{});var Ai=s(qt);ws=n(Ai,"__call__"),Ai.forEach(o),ys=n(ot," special method."),ot.forEach(o),Es=l(J),g(Te.$$.fragment,J),ks=l(J),zt=a(J,"P",{});var Ii=s(zt);xs=n(Ii,"Examples:"),Ii.forEach(o),js=l(J),g(oo.$$.fragment,J),J.forEach(o),Ds=l($),O=a($,"DIV",{class:!0});var Ee=s(O);g(to.$$.fragment,Ee),Ms=l(Ee),Pt=a(Ee,"P",{});var Si=s(Pt);Vs=n(Si,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
