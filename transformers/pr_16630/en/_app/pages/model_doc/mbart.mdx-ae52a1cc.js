...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16630/en/model_doc/mbart#transformers.MBartConfig"
...
separator.`),YM.forEach(t),Pt.forEach(t),Wg=l(fe),Jo=a(fe,"DIV",{class:!0});var Yh=s(Jo);m(Ua.$$.fragment,Yh),Ug=l(Yh),ql=a(Yh,"P",{});var e0=s(ql);Rg=i(e0,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),e0.forEach(t),Yh.forEach(t),Xg=l(fe),Ko=a(fe,"DIV",{class:!0});var eu=s(Ko);m(Ra.$$.fragment,eu),Qg=l(eu),$l=a(eu,"P",{});var t0=s($l);Hg=i(t0,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),t0.forEach(t),eu.forEach(t),fe.forEach(t),Gp=l(o),co=a(o,"H2",{class:!0});var tu=s(co);Zo=a(tu,"A",{id:!0,class:!0,href:!0});var o0=s(Zo);Bl=a(o0,"SPAN",{});var n0=s(Bl);m(Xa.$$.fragment,n0),n0.forEach(t),o0.forEach(t),Vg=l(tu),jl=a(tu,"SPAN",{});var a0=s(jl);Jg=i(a0,"MBartModel"),a0.forEach(t),tu.forEach(t),Wp=l(o),Ve=a(o,"DIV",{class:!0});var Fn=s(Ve);m(Qa.$$.fragment,Fn),Kg=l(Fn),Ha=a(Fn,"P",{});var ou=s(Ha);Zg=i(ou,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),tk=l(Fn),Va=a(Fn,"P",{});var nu=s(Va);ok=i(nu,"This model is also a PyTorch "),Ja=a(nu,"A",{href:!0,rel:!0});var r0=s(Ja);nk=i(r0,"torch.nn.Module"),r0.forEach(t),ak=i(nu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),sk=l(Fn),Oe=a(Fn,"DIV",{class:!0});var St=s(Oe);m(Ka.$$.fragment,St),rk=l(St),po=a(St,"P",{});var Ni=s(po);ik=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var i0=s(gi);dk=i(i0,"MBartModel"),i0.forEach(t),lk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var d0=s(El);ck=i(d0,"__call__"),d0.forEach(t),pk=i(Ni," special method."),Ni.forEach(t),hk=l(St),m(Yo.$$.fragment,St),uk=l(St),Cl=a(St,"P",{});var l0=s(Cl);mk=i(l0,"Example:"),l0.forEach(t),fk=l(St),m(Za.$$.fragment,St),St.forEach(t),Fn.forEach(t),Up=l(o),ho=a(o,"H2",{class:!0});var au=s(ho);en=a(au,"A",{id:!0,class:!0,href:!0});var c0=s(en);Pl=a(c0,"SPAN",{});var p0=s(Pl);m(Ya.$$.fragment,p0),p0.forEach(t),c0.forEach(t),_k=l(au),Sl=a(au,"SPAN",{});var h0=s(Sl);gk=i(h0,"MBartForConditionalGeneration"),h0.forEach(t),au.forEach(t),Rp=l(o),Je=a(o,"DIV",{class:!0});var qn=s(Je);m(es.$$.fragment,qn),kk=l(qn),ts=a(qn,"P",{});var su=s(ts);bk=i(su,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lu.forEach(t),ob=l(At),ue=a(At,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),nb=l(at),_o=a(at,"P",{});var Gi=s(_o);ab=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var z0=s(vi);sb=i(z0,"MBartForQuestionAnswering"),z0.forEach(t),rb=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var F0=s(Wl);ib=i(F0,"__call__"),F0.forEach(t),db=i(Gi," special method."),Gi.forEach(t),lb=l(at),m(nn.$$.fragment,at),cb=l(at),Ul=a(at,"P",{});var q0=s(Ul);pb=i(q0,"Example:"),q0.forEach(t),hb=l(at),m(us.$$.fragment,at),ub=l(at),m(ms.$$.fragment,at),at.forEach(t),At.forEach(t),Hp=l(o),go=a(o,"H2",{class:!0});var cu=s(go);an=a(cu,"A",{id:!0,class:!0,href:!0});var $0=s(an);Rl=a($0,"SPAN",{});var B0=s(Rl);m(fs.$$.fragment,B0),B0.forEach(t),$0.forEach(t),mb=l(cu),Xl=a(cu,"SPAN",{});var j0=s(Xl);fb=i(j0,"MBartForSequenceClassification"),j0.forEach(t),cu.forEach(t),Vp=l(o),Be=a(o,"DIV",{class:!0});var Ot=s(Be);m(_s.$$.fragment,Ot),_b=l(Ot),Ql=a(Ot,"P",{});var E0=s(Ql);gb=i(E0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),E0.forEach(t),kb=l(Ot),gs=a(Ot,"P",{});var pu=s(gs);bb=i(pu,"This model inherits from "),Ti=a(pu,"A",{href:!0});var C0=s(Ti);yb=i(C0,"PreTrainedModel"),C0.forEach(t),vb=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),zb=l(Ot),L=a(Ot,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Fb=l(oe),ko=a(oe,"P",{});var Wi=s(ko);qb=i(Wi,"The "),wi=a(Wi,"A",{href:!0});var S0=s(wi);$b=i(S0,"MBartForSequenceClassification"),S0.forEach(t),Bb=i(Wi," forward method, overrides the "),Hl=a(Wi,"CODE",{});var A0=s(Hl);jb=i(A0,"__call__"),A0.forEach(t),Eb=i(Wi," special method."),Wi.forEach(t),Cb=l(oe),m(sn.$$.fragment,oe),Pb=l(oe),Vl=a(oe,"P",{});var O0=s(Vl);Sb=i(O0,"Example of single-label classification:"),O0.forEach(t),Ab=l(oe),m(vs.$$.fragment,oe),Ob=l(oe),m(Ts.$$.fragment,oe),Ib=l(oe),Jl=a(oe,"P",{});var I0=s(Jl);Nb=i(I0,"Example of multi-label classification:"),I0.forEach(t),Db=l(oe),m(ws.$$.fragment,oe),Lb=l(oe),m(Ms.$$.fragment,oe),oe.forEach(t),Ot.forEach(t),Jp=l(o),bo=a(o,"H2",{class:!0});var uu=s(bo);rn=a(uu,"A",{id:!0,class:!0,href:!0});var N0=s(rn);Kl=a(N0,"SPAN",{});var D0=s(Kl);m(xs.$$.fragment,D0),D0.forEach(t),N0.forEach(t),Gb=l(uu),Zl=a(uu,"SPAN",{});var L0=s(Zl);Wb=i(L0,"MBartForCausalLM"),L0.forEach(t),uu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var mu=s(yo);m(zs.$$.fragment,mu),Ub=l(mu),Tt=a(mu,"DIV",{class:!0});var Ui=s(Tt);m(Fs.$$.fragment,Ui),Rb=l(Ui),Yl=a(Ui,"P",{});var G0=s(Yl);Xb=i(G0,"Example:"),G0.forEach(t),Qb=l(Ui),m(qs.$$.fragment,Ui),Ui.forEach(t),mu.forEach(t),Zp=l(o),vo=a(o,"H2",{class:!0});var fu=s(vo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var W0=s(dn);ec=a(W0,"SPAN",{});var U0=s(ec);m($s.$$.fragment,U0),U0.forEach(t),W0.forEach(t),Hb=l(fu),tc=a(fu,"SPAN",{});var R0=s(tc);Vb=i(R0,"TFMBartModel"),R0.forEach(t),fu.forEach(t),Yp=l(o),je=a(o,"DIV",{class:!0});var It=s(je);m(Bs.$$.fragment,It),Jb=l(It),js=a(It,"P",{});var _u=s(js);Kb=i(_u,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),ey=l(It),Es=a(It,"P",{});var gu=s(Es);ty=i(gu,"This model is also a "),Cs=a(gu,"A",{href:!0,rel:!0});var Q0=s(Cs);oy=i(Q0,"tf.keras.Model"),Q0.forEach(t),ny=i(gu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gu.forEach(t),ay=l(It),m(ln.$$.fragment,It),sy=l(It),Ie=a(It,"DIV",{class:!0});var Nt=s(Ie);m(Ps.$$.fragment,Nt),ry=l(Nt),To=a(Nt,"P",{});var Ri=s(To);iy=i(Ri,"The "),xi=a(Ri,"A",{href:!0});var H0=s(xi);dy=i(H0,"TFMBartModel"),H0.forEach(t),ly=i(Ri," forward method, overrides the "),oc=a(Ri,"CODE",{});var V0=s(oc);cy=i(V0,"__call__"),V0.forEach(t),py=i(Ri," special method."),Ri.forEach(t),hy=l(Nt),m(cn.$$.fragment,Nt),uy=l(Nt),nc=a(Nt,"P",{});var J0=s(nc);my=i(J0,"Example:"),J0.forEach(t),fy=l(Nt),m(Ss.$$.fragment,Nt),Nt.forEach(t),It.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var ku=s(wo);pn=a(ku,"A",{id:!0,class:!0,href:!0});var K0=s(pn);ac=a(K0,"SPAN",{});var Z0=s(ac);m(As.$$.fragment,Z0),Z0.forEach(t),K0.forEach(t),_y=l(ku),sc=a(ku,"SPAN",{});var Y0=s(sc);gy=i(Y0,"TFMBartForConditionalGeneration"),Y0.forEach(t),ku.forEach(t),th=l(o),Ee=a(o,"DIV",{class:!0});var Dt=s(Ee);m(Os.$$.fragment,Dt),ky=l(Dt),Is=a(Dt,"P",{});var bu=s(Is);by=i(bu,`The MBART Model with a language modeling head. Can be used for summarization.
