import{S as Gc,i as Kc,s as Xc,e as a,k as l,w as k,t as n,M as Jc,c as r,d as t,m as d,a as i,x as b,h as s,b as c,F as e,g as u,y,q as C,o as w,B as L,v as Qc}from"../../chunks/vendor-6b77c823.js";import{T as $t}from"../../chunks/Tip-39098574.js";import{D as Fe}from"../../chunks/Docstring-af1d0ae0.js";import{C as Qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as dt}from"../../chunks/IconCopyLink-7a11ce68.js";function Yc(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
...
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function tp(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,P,x,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),P=l(),x=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
tensors in the first argument of the model call function: `),A=r(O,"CODE",{});var Ae=i(A);ve=s(Ae,"model(inputs)"),Ae.forEach(t),pe=s(O,"."),O.forEach(t),P=d(p),x=r(p,"P",{});var He=i(x);ee=s(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var N=i(F);q=r(N,"LI",{});var j=i(q);ke=s(j,"a single Tensor with "),U=r(j,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(j," only and nothing else: "),V=r(j,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),j.forEach(t),ae=d(N),z=r(N,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,P,$),u(p,x,$),e(x,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(P),p&&t(x),p&&t(ne),p&&t(F)}}}function op(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,P,x,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),P=l(),x=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),ye=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var De=i(v);T=s(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var O=i(R);Q=s(O,"This second option is useful when using "),D=r(O,"CODE",{});var qe=i(D);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(O,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var N=i(F);q=r(N,"LI",{});var j=i(q);ke=s(j,"a single Tensor with "),U=r(j,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(j," only and nothing else: "),V=r(j,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),j.forEach(t),ae=d(N),z=r(N,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ye=s(K," or "),W=r(K,"CODE",{});var je=i(W);S=s(je,"model([input_ids, attention_mask, token_type_ids])"),je.forEach(t),K.forEach(t),te=d(N),I=r(N,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,P,$),u(p,x,$),e(x,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(P),p&&t(x),p&&t(ne),p&&t(F)}}}function sp(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ap(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,P,x,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),P=l(),x=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),ye=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var De=i(v);T=s(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var O=i(R);Q=s(O,"This second option is useful when using "),D=r(O,"CODE",{});var qe=i(D);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(O,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var N=i(F);q=r(N,"LI",{});var j=i(q);ke=s(j,"a single Tensor with "),U=r(j,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(j," only and nothing else: "),V=r(j,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),j.forEach(t),ae=d(N),z=r(N,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ye=s(K," or "),W=r(K,"CODE",{});var je=i(W);S=s(je,"model([input_ids, attention_mask, token_type_ids])"),je.forEach(t),K.forEach(t),te=d(N),I=r(N,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,P,$),u(p,x,$),e(x,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(P),p&&t(x),p&&t(ne),p&&t(F)}}}function rp(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ip(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,P,x,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce,p,$,ie,De,me,O,qe,Ae,He,N,j,We,ze,K,Be,je,we,Ue,En,ma,fa,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,ya,Ms,ct,Rt,qn,Xt,Ca,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,ja,pt,Pa,tn,xa,Sa,on,Ia,Oa,Na,jn,Da,Aa,Yt,Fs,ht,Mt,Pn,Zt,Ha,xn,Wa,qs,Oe,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,On,Ya,js,$e,so,Za,Nn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,Pe,lo,cr,mt,pr,rn,hr,ur,Dn,mr,fr,gr,Ft,_r,An,Tr,vr,co,Ps,ft,qt,Hn,po,kr,Wn,br,xs,Re,ho,yr,Bn,Cr,wr,uo,Lr,ln,$r,Rr,Mr,mo,Er,fo,Fr,qr,zr,xe,go,jr,gt,Pr,dn,xr,Sr,Un,Ir,Or,Nr,zt,Dr,Vn,Ar,Hr,_o,Ss,_t,jt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,pn,ai,ri,ii,bo,li,yo,di,ci,pi,B,Co,hi,Tt,ui,hn,mi,fi,Zn,gi,_i,Ti,Pt,vi,es,ki,bi,wo,yi,Lo,Ci,ts,wi,Li,$o,$i,Ro,Os,vt,xt,os,Mo,Ri,ns,Mi,Ns,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,ji,Pi,xi,qo,Si,zo,Ii,Oi,Ni,St,Di,Se,jo,Ai,kt,Hi,mn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,Po,Ds,bt,Ot,is,xo,Qi,ls,Yi,As,ce,So,Zi,ds,el,tl,Io,ol,fn,nl,sl,al,Oo,rl,No,il,ll,dl,Nt,cl,Ie,Do,pl,yt,hl,gn,ul,ml,cs,fl,gl,_l,Dt,Tl,ps,vl,kl,Ao,Hs,Ct,At,hs,Ho,bl,us,yl,Ws,X,Wo,Cl,ms,wl,Ll,_n,Tn,$l,Rl,Ml,Ne,El,fs,Fl,ql,gs,zl,jl,_s,Pl,xl,Ts,Sl,Il,Ol,Bo,Nl,vn,Dl,Al,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,fe,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
token instead.`,name:"unk_token"}]}}),oo=new Fe({props:{name:"save_vocabulary",anchor:"transformers.CTRLTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/tokenization_ctrl.py#L227"}}),no=new dt({}),so=new Fe({props:{name:"class transformers.CTRLModel",anchor:"transformers.CTRLModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_ctrl.py#L319",parametersDescription:[{anchor:"transformers.CTRLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Fe({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_ctrl.py#L352",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_16762/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16762/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">5</span>, <span class="hljs-number">1280</span>]`}}),po=new dt({}),ho=new Fe({props:{name:"class transformers.CTRLLMHeadModel",anchor:"transformers.CTRLLMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_ctrl.py#L509",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),go=new Fe({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_ctrl.py#L531",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16762/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),jo=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_tf_ctrl.py#L521",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16762/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),xo=new dt({}),So=new Fe({props:{name:"class transformers.TFCTRLLMHeadModel",anchor:"transformers.TFCTRLLMHeadModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_tf_ctrl.py#L610",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new $t({props:{$$slots:{default:[np]},$$scope:{ctx:J}}}),Do=new Fe({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_tf_ctrl.py#L631",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16762/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[ap]},$$scope:{ctx:J}}}),Go=new Fe({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16762/src/transformers/models/ctrl/modeling_tf_ctrl.py#L742",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),{c(){h=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),k(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),D=a("span"),k(Z.$$.fragment),Te=l(),A=a("span"),ve=n("Overview"),pe=l(),P=a("p"),x=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ke=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
TensorFlow models accepts `),je=a("code"),we=n("past"),Ue=n(" as input. Using the "),En=a("code"),ma=n("past_key_values"),fa=n(` value prevents the model from re-computing
...
`),Kt=a("a"),ba=n("here"),ya=n("."),Ms=l(),ct=a("h2"),Rt=a("a"),qn=a("span"),k(Xt.$$.fragment),Ca=l(),zn=a("span"),wa=n("CTRLConfig"),Es=l(),Le=a("div"),k(Jt.$$.fragment),La=l(),Je=a("p"),$a=n("This is the configuration class to store the configuration of a "),Zo=a("a"),Ra=n("CTRLModel"),Ma=n(" or a "),en=a("a"),Ea=n("TFCTRLModel"),Fa=n(`. It is used to
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
`),Qt=a("a"),qa=n("ctrl"),za=n(" architecture from SalesForce."),ja=l(),pt=a("p"),Pa=n("Configuration objects inherit from "),tn=a("a"),xa=n("PretrainedConfig"),Sa=n(` and can be used to control the model outputs. Read the
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Oa=n(" for more information."),Na=l(),jn=a("p"),Da=n("Examples:"),Aa=l(),k(Yt.$$.fragment),Fs=l(),ht=a("h2"),Mt=a("a"),Pn=a("span"),k(Zt.$$.fragment),Ha=l(),xn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Oe=a("div"),k(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ja=l(),sn=a("div"),k(oo.$$.fragment),zs=l(),ut=a("h2"),Et=a("a"),In=a("span"),k(no.$$.fragment),Qa=l(),On=a("span"),Ya=n("CTRLModel"),js=l(),$e=a("div"),k(so.$$.fragment),Za=l(),Nn=a("p"),er=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),tr=l(),ao=a("p"),or=n("This model inherits from "),an=a("a"),nr=n("PreTrainedModel"),sr=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),dr=l(),Pe=a("div"),k(lo.$$.fragment),cr=l(),mt=a("p"),pr=n("The "),rn=a("a"),hr=n("CTRLModel"),ur=n(" forward method, overrides the "),Dn=a("code"),mr=n("__call__"),fr=n(" special method."),gr=l(),k(Ft.$$.fragment),_r=l(),An=a("p"),Tr=n("Example:"),vr=l(),k(co.$$.fragment),Ps=l(),ft=a("h2"),qt=a("a"),Hn=a("span"),k(po.$$.fragment),kr=l(),Wn=a("span"),br=n("CTRLLMHeadModel"),xs=l(),Re=a("div"),k(ho.$$.fragment),yr=l(),Bn=a("p"),Cr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=l(),xe=a("div"),k(go.$$.fragment),jr=l(),gt=a("p"),Pr=n("The "),dn=a("a"),xr=n("CTRLLMHeadModel"),Sr=n(" forward method, overrides the "),Un=a("code"),Ir=n("__call__"),Or=n(" special method."),Nr=l(),k(zt.$$.fragment),Dr=l(),Vn=a("p"),Ar=n("Example:"),Hr=l(),k(_o.$$.fragment),Ss=l(),_t=a("h2"),jt=a("a"),Gn=a("span"),k(To.$$.fragment),Wr=l(),Kn=a("span"),Br=n("CTRLForSequenceClassification"),Is=l(),Me=a("div"),k(vo.$$.fragment),Ur=l(),Ee=a("p"),Vr=n(`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),k(Co.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(Pt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),yi=l(),k(Lo.$$.fragment),Ci=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Os=l(),vt=a("h2"),xt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ns=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),ji=n("TFPreTrainedModel"),Pi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xi=l(),qo=a("p"),Si=n("This model is also a "),zo=a("a"),Ii=n("tf.keras.Model"),Oi=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ni=l(),k(St.$$.fragment),Di=l(),Se=a("div"),k(jo.$$.fragment),Ai=l(),kt=a("p"),Hi=n("The "),mn=a("a"),Wi=n("TFCTRLModel"),Bi=n(" forward method, overrides the "),as=a("code"),Ui=n("__call__"),Vi=n(" special method."),Gi=l(),k(It.$$.fragment),Ki=l(),rs=a("p"),Xi=n("Example:"),Ji=l(),k(Po.$$.fragment),Ds=l(),bt=a("h2"),Ot=a("a"),is=a("span"),k(xo.$$.fragment),Qi=l(),ls=a("span"),Yi=n("TFCTRLLMHeadModel"),As=l(),ce=a("div"),k(So.$$.fragment),Zi=l(),ds=a("p"),el=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
padding tokens when `),_s=a("code"),Pl=n("inputs_embeds"),xl=n(" are passed instead of "),Ts=a("code"),Sl=n("input_ids"),Il=n(`, it does the same (take the last value in
...
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),qe=r(Vs,"EM",{});var md=i(qe);Ae=s(md,"run_generation.py"),md.forEach(t),He=s(Vs," example script."),Vs.forEach(t),N=d(Bt),j=r(Bt,"LI",{});var Ze=i(j);We=s(Ze,"The PyTorch models can take the "),ze=r(Ze,"CODE",{});var fd=i(ze);K=s(fd,"past_key_values"),fd.forEach(t),Be=s(Ze,` as input, which is the previously computed key/value attention pairs.
TensorFlow models accepts `),je=r(Ze,"CODE",{});var gd=i(je);we=s(gd,"past"),gd.forEach(t),Ue=s(Ze," as input. Using the "),En=r(Ze,"CODE",{});var _d=i(En);ma=s(_d,"past_key_values"),_d.forEach(t),fa=s(Ze,` value prevents the model from re-computing
...
`),Kt=r(bn,"A",{href:!0,rel:!0});var bd=i(Kt);ba=s(bd,"here"),bd.forEach(t),ya=s(bn,"."),bn.forEach(t),Ms=d(o),ct=r(o,"H2",{class:!0});var Gs=i(ct);Rt=r(Gs,"A",{id:!0,class:!0,href:!0});var yd=i(Rt);qn=r(yd,"SPAN",{});var Cd=i(qn);b(Xt.$$.fragment,Cd),Cd.forEach(t),yd.forEach(t),Ca=d(Gs),zn=r(Gs,"SPAN",{});var wd=i(zn);wa=s(wd,"CTRLConfig"),wd.forEach(t),Gs.forEach(t),Es=d(o),Le=r(o,"DIV",{class:!0});var et=i(Le);b(Jt.$$.fragment,et),La=d(et),Je=r(et,"P",{});var Ut=i(Je);$a=s(Ut,"This is the configuration class to store the configuration of a "),Zo=r(Ut,"A",{href:!0});var Ld=i(Zo);Ra=s(Ld,"CTRLModel"),Ld.forEach(t),Ma=s(Ut," or a "),en=r(Ut,"A",{href:!0});var $d=i(en);Ea=s($d,"TFCTRLModel"),$d.forEach(t),Fa=s(Ut,`. It is used to
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
`),Qt=r(Ut,"A",{href:!0,rel:!0});var Rd=i(Qt);qa=s(Rd,"ctrl"),Rd.forEach(t),za=s(Ut," architecture from SalesForce."),Ut.forEach(t),ja=d(et),pt=r(et,"P",{});var yn=i(pt);Pa=s(yn,"Configuration objects inherit from "),tn=r(yn,"A",{href:!0});var Md=i(tn);xa=s(Md,"PretrainedConfig"),Md.forEach(t),Sa=s(yn,` and can be used to control the model outputs. Read the
documentation from `),on=r(yn,"A",{href:!0});var Ed=i(on);Ia=s(Ed,"PretrainedConfig"),Ed.forEach(t),Oa=s(yn," for more information."),yn.forEach(t),Na=d(et),jn=r(et,"P",{});var Fd=i(jn);Da=s(Fd,"Examples:"),Fd.forEach(t),Aa=d(et),b(Yt.$$.fragment,et),et.forEach(t),Fs=d(o),ht=r(o,"H2",{class:!0});var Ks=i(ht);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);Pn=r(qd,"SPAN",{});var zd=i(Pn);b(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),xn=r(Ks,"SPAN",{});var jd=i(xn);Wa=s(jd,"CTRLTokenizer"),jd.forEach(t),Ks.forEach(t),qs=d(o),Oe=r(o,"DIV",{class:!0});var Vt=i(Oe);b(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var Pd=i(Sn);Ua=s(Pd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Pd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var xd=i(nn);Ka=s(xd,"PreTrainedTokenizer"),xd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Xs.forEach(t),Ja=d(Vt),sn=r(Vt,"DIV",{class:!0});var Sd=i(sn);b(oo.$$.fragment,Sd),Sd.forEach(t),Vt.forEach(t),zs=d(o),ut=r(o,"H2",{class:!0});var Js=i(ut);Et=r(Js,"A",{id:!0,class:!0,href:!0});var Id=i(Et);In=r(Id,"SPAN",{});var Od=i(In);b(no.$$.fragment,Od),Od.forEach(t),Id.forEach(t),Qa=d(Js),On=r(Js,"SPAN",{});var Nd=i(On);Ya=s(Nd,"CTRLModel"),Nd.forEach(t),Js.forEach(t),js=d(o),$e=r(o,"DIV",{class:!0});var tt=i($e);b(so.$$.fragment,tt),Za=d(tt),Nn=r(tt,"P",{});var Dd=i(Nn);er=s(Dd,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Dd.forEach(t),tr=d(tt),ao=r(tt,"P",{});var Qs=i(ao);or=s(Qs,"This model inherits from "),an=r(Qs,"A",{href:!0});var Ad=i(an);nr=s(Ad,"PreTrainedModel"),Ad.forEach(t),sr=s(Qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),Pe=r(tt,"DIV",{class:!0});var ot=i(Pe);b(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var Cn=i(mt);pr=s(Cn,"The "),rn=r(Cn,"A",{href:!0});var Wd=i(rn);hr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(Cn," forward method, overrides the "),Dn=r(Cn,"CODE",{});var Bd=i(Dn);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(Cn," special method."),Cn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),An=r(ot,"P",{});var Ud=i(An);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),Ps=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(po.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),xs=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(ho.$$.fragment,nt),yr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);Cr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta.forEach(t),zr=d(nt),xe=r(nt,"DIV",{class:!0});var st=i(xe);b(go.$$.fragment,st),jr=d(st),gt=r(st,"P",{});var wn=i(gt);Pr=s(wn,"The "),dn=r(wn,"A",{href:!0});var Yd=i(dn);xr=s(Yd,"CTRLLMHeadModel"),Yd.forEach(t),Sr=s(wn," forward method, overrides the "),Un=r(wn,"CODE",{});var Zd=i(Un);Ir=s(Zd,"__call__"),Zd.forEach(t),Or=s(wn," special method."),wn.forEach(t),Nr=d(st),b(zt.$$.fragment,st),Dr=d(st),Vn=r(st,"P",{});var ec=i(Vn);Ar=s(ec,"Example:"),ec.forEach(t),Hr=d(st),b(_o.$$.fragment,st),st.forEach(t),nt.forEach(t),Ss=d(o),_t=r(o,"H2",{class:!0});var oa=i(_t);jt=r(oa,"A",{id:!0,class:!0,href:!0});var tc=i(jt);Gn=r(tc,"SPAN",{});var oc=i(Gn);b(To.$$.fragment,oc),oc.forEach(t),tc.forEach(t),Wr=d(oa),Kn=r(oa,"SPAN",{});var nc=i(Kn);Br=s(nc,"CTRLForSequenceClassification"),nc.forEach(t),oa.forEach(t),Is=d(o),Me=r(o,"DIV",{class:!0});var at=i(Me);b(vo.$$.fragment,at),Ur=d(at),Ee=r(at,"P",{});var Ve=i(Ee);Vr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(t),pi=d(at),B=r(at,"DIV",{class:!0});var le=i(B);b(Co.$$.fragment,le),hi=d(le),Tt=r(le,"P",{});var Ln=i(Tt);ui=s(Ln,"The "),hn=r(Ln,"A",{href:!0});var pc=i(hn);mi=s(pc,"CTRLForSequenceClassification"),pc.forEach(t),fi=s(Ln," forward method, overrides the "),Zn=r(Ln,"CODE",{});var hc=i(Zn);gi=s(hc,"__call__"),hc.forEach(t),_i=s(Ln," special method."),Ln.forEach(t),Ti=d(le),b(Pt.$$.fragment,le),vi=d(le),es=r(le,"P",{});var uc=i(es);ki=s(uc,"Example of single-label classification:"),uc.forEach(t),bi=d(le),b(wo.$$.fragment,le),yi=d(le),b(Lo.$$.fragment,le),Ci=d(le),ts=r(le,"P",{});var mc=i(ts);wi=s(mc,"Example of multi-label classification:"),mc.forEach(t),Li=d(le),b($o.$$.fragment,le),$i=d(le),b(Ro.$$.fragment,le),le.forEach(t),at.forEach(t),Os=d(o),vt=r(o,"H2",{class:!0});var aa=i(vt);xt=r(aa,"A",{id:!0,class:!0,href:!0});var fc=i(xt);os=r(fc,"SPAN",{});var gc=i(os);b(Mo.$$.fragment,gc),gc.forEach(t),fc.forEach(t),Ri=d(aa),ns=r(aa,"SPAN",{});var _c=i(ns);Mi=s(_c,"TFCTRLModel"),_c.forEach(t),aa.forEach(t),Ns=d(o),de=r(o,"DIV",{class:!0});var Ge=i(de);b(Eo.$$.fragment,Ge),Ei=d(Ge),ss=r(Ge,"P",{});var Tc=i(ss);Fi=s(Tc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Tc.forEach(t),qi=d(Ge),Fo=r(Ge,"P",{});var ra=i(Fo);zi=s(ra,"This model inherits from "),un=r(ra,"A",{href:!0});var vc=i(un);ji=s(vc,"TFPreTrainedModel"),vc.forEach(t),Pi=s(ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ra.forEach(t),xi=d(Ge),qo=r(Ge,"P",{});var ia=i(qo);Si=s(ia,"This model is also a "),zo=r(ia,"A",{href:!0,rel:!0});var kc=i(zo);Ii=s(kc,"tf.keras.Model"),kc.forEach(t),Oi=s(ia,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ia.forEach(t),Ni=d(Ge),b(St.$$.fragment,Ge),Di=d(Ge),Se=r(Ge,"DIV",{class:!0});var rt=i(Se);b(jo.$$.fragment,rt),Ai=d(rt),kt=r(rt,"P",{});var $n=i(kt);Hi=s($n,"The "),mn=r($n,"A",{href:!0});var bc=i(mn);Wi=s(bc,"TFCTRLModel"),bc.forEach(t),Bi=s($n," forward method, overrides the "),as=r($n,"CODE",{});var yc=i(as);Ui=s(yc,"__call__"),yc.forEach(t),Vi=s($n," special method."),$n.forEach(t),Gi=d(rt),b(It.$$.fragment,rt),Ki=d(rt),rs=r(rt,"P",{});var Cc=i(rs);Xi=s(Cc,"Example:"),Cc.forEach(t),Ji=d(rt),b(Po.$$.fragment,rt),rt.forEach(t),Ge.forEach(t),Ds=d(o),bt=r(o,"H2",{class:!0});var la=i(bt);Ot=r(la,"A",{id:!0,class:!0,href:!0});var wc=i(Ot);is=r(wc,"SPAN",{});var Lc=i(is);b(xo.$$.fragment,Lc),Lc.forEach(t),wc.forEach(t),Qi=d(la),ls=r(la,"SPAN",{});var $c=i(ls);Yi=s($c,"TFCTRLLMHeadModel"),$c.forEach(t),la.forEach(t),As=d(o),ce=r(o,"DIV",{class:!0});var Ke=i(ce);b(So.$$.fragment,Ke),Zi=d(Ke),ds=r(Ke,"P",{});var Rc=i(ds);el=s(Rc,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
padding tokens when `),_s=r(lt,"CODE",{});var Dc=i(_s);Pl=s(Dc,"inputs_embeds"),Dc.forEach(t),xl=s(lt," are passed instead of "),Ts=r(lt,"CODE",{});var Ac=i(Ts);Sl=s(Ac,"input_ids"),Ac.forEach(t),Il=s(lt,`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ua.forEach(t),Vl=d(ge),b(Ht.$$.fragment,ge),Gl=d(ge),fe=r(ge,"DIV",{class:!0});var Xe=i(fe);b(Go.$$.fragment,Xe),Kl=d(Xe),wt=r(Xe,"P",{});var Mn=i(wt);Xl=s(Mn,"The "),kn=r(Mn,"A",{href:!0});var Bc=i(kn);Jl=s(Bc,"TFCTRLForSequenceClassification"),Bc.forEach(t),Ql=s(Mn," forward method, overrides the "),vs=r(Mn,"CODE",{});var Uc=i(vs);Yl=s(Uc,"__call__"),Uc.forEach(t),Zl=s(Mn," special method."),Mn.forEach(t),ed=d(Xe),b(Wt.$$.fragment,Xe),td=d(Xe),ks=r(Xe,"P",{});var Vc=i(ks);od=s(Vc,"Example:"),Vc.forEach(t),nd=d(Xe),b(Ko.$$.fragment,Xe),sd=d(Xe),b(Xo.$$.fragment,Xe),Xe.forEach(t),ge.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(lp)),c(g,"id","ctrl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#ctrl"),c(f,"class","relative group"),c(Q,"id","overview"),c(Q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Q,"href","#overview"),c(R,"class","relative group"),c(ee,"href","https://arxiv.org/abs/1909.05858"),c(ee,"rel","nofollow"),c(oe,"href","https://github.com/salesforce/ctrl"),c(oe,"rel","nofollow"),c(Yo,"href","model_doc/ctrl#transformers.CTRLModel.forward"),c(Gt,"href","https://huggingface.co/keskarnitishr"),c(Gt,"rel","nofollow"),c(Kt,"href","https://github.com/salesforce/ctrl"),c(Kt,"rel","nofollow"),c(Rt,"id","transformers.CTRLConfig"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.CTRLConfig"),c(ct,"class","relative group"),c(Zo,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLModel"),c(en,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Qt,"href","https://huggingface.co/ctrl"),c(Qt,"rel","nofollow"),c(tn,"href","/docs/transformers/pr_16762/en/main_classes/configuration#transformers.PretrainedConfig"),c(on,"href","/docs/transformers/pr_16762/en/main_classes/configuration#transformers.PretrainedConfig"),c(Le,"class","docstring"),c(Mt,"id","transformers.CTRLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.CTRLTokenizer"),c(ht,"class","relative group"),c(nn,"href","/docs/transformers/pr_16762/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(sn,"class","docstring"),c(Oe,"class","docstring"),c(Et,"id","transformers.CTRLModel"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.CTRLModel"),c(ut,"class","relative group"),c(an,"href","/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel"),c(io,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(io,"rel","nofollow"),c(rn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLModel"),c(Pe,"class","docstring"),c($e,"class","docstring"),c(qt,"id","transformers.CTRLLMHeadModel"),c(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qt,"href","#transformers.CTRLLMHeadModel"),c(ft,"class","relative group"),c(ln,"href","/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel"),c(fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fo,"rel","nofollow"),c(dn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLLMHeadModel"),c(xe,"class","docstring"),c(Re,"class","docstring"),c(jt,"id","transformers.CTRLForSequenceClassification"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.CTRLForSequenceClassification"),c(_t,"class","relative group"),c(cn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(pn,"href","/docs/transformers/pr_16762/en/main_classes/model#transformers.PreTrainedModel"),c(yo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(yo,"rel","nofollow"),c(hn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(B,"class","docstring"),c(Me,"class","docstring"),c(xt,"id","transformers.TFCTRLModel"),c(xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xt,"href","#transformers.TFCTRLModel"),c(vt,"class","relative group"),c(un,"href","/docs/transformers/pr_16762/en/main_classes/model#transformers.TFPreTrainedModel"),c(zo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(zo,"rel","nofollow"),c(mn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Se,"class","docstring"),c(de,"class","docstring"),c(Ot,"id","transformers.TFCTRLLMHeadModel"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.TFCTRLLMHeadModel"),c(bt,"class","relative group"),c(fn,"href","/docs/transformers/pr_16762/en/main_classes/model#transformers.TFPreTrainedModel"),c(No,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(No,"rel","nofollow"),c(gn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.TFCTRLLMHeadModel"),c(Ie,"class","docstring"),c(ce,"class","docstring"),c(At,"id","transformers.TFCTRLForSequenceClassification"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.TFCTRLForSequenceClassification"),c(Ct,"class","relative group"),c(Tn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(vn,"href","/docs/transformers/pr_16762/en/main_classes/model#transformers.TFPreTrainedModel"),c(Vo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Vo,"rel","nofollow"),c(kn,"href","/docs/transformers/pr_16762/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(fe,"class","docstring"),c(X,"class","docstring")},m(o,m){e(document.head,h),u(o,E,m),u(o,f,m),e(f,g),e(g,v),y(T,v,null),e(f,_),e(f,M),e(M,_e),u(o,Y,m),u(o,R,m),e(R,Q),e(Q,D),y(Z,D,null),e(R,Te),e(R,A),e(A,ve),u(o,pe,m),u(o,P,m),e(P,x),e(P,ee),e(ee,ne),e(P,F),e(P,q),e(q,ke),e(P,U),u(o,he,m),u(o,se,m),e(se,V),u(o,ue,m),u(o,ae,m),e(ae,z),e(z,be),u(o,H,m),u(o,re,m),e(re,ye),u(o,W,m),u(o,S,m),e(S,te),e(te,I),e(te,oe),e(oe,G),e(te,Ce),e(S,p),e(S,$),e($,ie),e(S,De),e(S,me),e(me,O),e(me,qe),e(qe,Ae),e(me,He),e(S,N),e(S,j),e(j,We),e(j,ze),e(ze,K),e(j,Be),e(j,je),e(je,we),e(j,Ue),e(j,En),e(En,ma),e(j,fa),e(j,Yo),e(Yo,Fn),e(Fn,ga),e(j,_a),u(o,Rs,m),u(o,Ye,m),e(Ye,Ta),e(Ye,Gt),e(Gt,va),e(Ye,ka),e(Ye,Kt),e(Kt,ba),e(Ye,ya),u(o,Ms,m),u(o,ct,m),e(ct,Rt),e(Rt,qn),y(Xt,qn,null),e(ct,Ca),e(ct,zn),e(zn,wa),u(o,Es,m),u(o,Le,m),y(Jt,Le,null),e(Le,La),e(Le,Je),e(Je,$a),e(Je,Zo),e(Zo,Ra),e(Je,Ma),e(Je,en),e(en,Ea),e(Je,Fa),e(Je,Qt),e(Qt,qa),e(Je,za),e(Le,ja),e(Le,pt),e(pt,Pa),e(pt,tn),e(tn,xa),e(pt,Sa),e(pt,on),e(on,Ia),e(pt,Oa),e(Le,Na),e(Le,jn),e(jn,Da),e(Le,Aa),y(Yt,Le,null),u(o,Fs,m),u(o,ht,m),e(ht,Mt),e(Mt,Pn),y(Zt,Pn,null),e(ht,Ha),e(ht,xn),e(xn,Wa),u(o,qs,m),u(o,Oe,m),y(eo,Oe,null),e(Oe,Ba),e(Oe,Sn),e(Sn,Ua),e(Oe,Va),e(Oe,to),e(to,Ga),e(to,nn),e(nn,Ka),e(to,Xa),e(Oe,Ja),e(Oe,sn),y(oo,sn,null),u(o,zs,m),u(o,ut,m),e(ut,Et),e(Et,In),y(no,In,null),e(ut,Qa),e(ut,On),e(On,Ya),u(o,js,m),u(o,$e,m),y(so,$e,null),e($e,Za),e($e,Nn),e(Nn,er),e($e,tr),e($e,ao),e(ao,or),e(ao,an),e(an,nr),e(ao,sr),e($e,ar),e($e,ro),e(ro,rr),e(ro,io),e(io,ir),e(ro,lr),e($e,dr),e($e,Pe),y(lo,Pe,null),e(Pe,cr),e(Pe,mt),e(mt,pr),e(mt,rn),e(rn,hr),e(mt,ur),e(mt,Dn),e(Dn,mr),e(mt,fr),e(Pe,gr),y(Ft,Pe,null),e(Pe,_r),e(Pe,An),e(An,Tr),e(Pe,vr),y(co,Pe,null),u(o,Ps,m),u(o,ft,m),e(ft,qt),e(qt,Hn),y(po,Hn,null),e(ft,kr),e(ft,Wn),e(Wn,br),u(o,xs,m),u(o,Re,m),y(ho,Re,null),e(Re,yr),e(Re,Bn),e(Bn,Cr),e(Re,wr),e(Re,uo),e(uo,Lr),e(uo,ln),e(ln,$r),e(uo,Rr),e(Re,Mr),e(Re,mo),e(mo,Er),e(mo,fo),e(fo,Fr),e(mo,qr),e(Re,zr),e(Re,xe),y(go,xe,null),e(xe,jr),e(xe,gt),e(gt,Pr),e(gt,dn),e(dn,xr),e(gt,Sr),e(gt,Un),e(Un,Ir),e(gt,Or),e(xe,Nr),y(zt,xe,null),e(xe,Dr),e(xe,Vn),e(Vn,Ar),e(xe,Hr),y(_o,xe,null),u(o,Ss,m),u(o,_t,m),e(_t,jt),e(jt,Gn),y(To,Gn,null),e(_t,Wr),e(_t,Kn),e(Kn,Br),u(o,Is,m),u(o,Me,m),y(vo,Me,null),e(Me,Ur),e(Me,Ee),e(Ee,Vr),e(Ee,cn),e(cn,Gr),e(Ee,Kr),e(Ee,Xn),e(Xn,Xr),e(Ee,Jr),e(Ee,Jn),e(Jn,Qr),e(Ee,Yr),e(Ee,Qn),e(Qn,Zr),e(Ee,ei),e(Ee,Yn),e(Yn,ti),e(Ee,oi),e(Me,ni),e(Me,ko),e(ko,si),e(ko,pn),e(pn,ai),e(ko,ri),e(Me,ii),e(Me,bo),e(bo,li),e(bo,yo),e(yo,di),e(bo,ci),e(Me,pi),e(Me,B),y(Co,B,null),e(B,hi),e(B,Tt),e(Tt,ui),e(Tt,hn),e(hn,mi),e(Tt,fi),e(Tt,Zn),e(Zn,gi),e(Tt,_i),e(B,Ti),y(Pt,B,null),e(B,vi),e(B,es),e(es,ki),e(B,bi),y(wo,B,null),e(B,yi),y(Lo,B,null),e(B,Ci),e(B,ts),e(ts,wi),e(B,Li),y($o,B,null),e(B,$i),y(Ro,B,null),u(o,Os,m),u(o,vt,m),e(vt,xt),e(xt,os),y(Mo,os,null),e(vt,Ri),e(vt,ns),e(ns,Mi),u(o,Ns,m),u(o,de,m),y(Eo,de,null),e(de,Ei),e(de,ss),e(ss,Fi),e(de,qi),e(de,Fo),e(Fo,zi),e(Fo,un),e(un,ji),e(Fo,Pi),e(de,xi),e(de,qo),e(qo,Si),e(qo,zo),e(zo,Ii),e(qo,Oi),e(de,Ni),y(St,de,null),e(de,Di),e(de,Se),y(jo,Se,null),e(Se,Ai),e(Se,kt),e(kt,Hi),e(kt,mn),e(mn,Wi),e(kt,Bi),e(kt,as),e(as,Ui),e(kt,Vi),e(Se,Gi),y(It,Se,null),e(Se,Ki),e(Se,rs),e(rs,Xi),e(Se,Ji),y(Po,Se,null),u(o,Ds,m),u(o,bt,m),e(bt,Ot),e(Ot,is),y(xo,is,null),e(bt,Qi),e(bt,ls),e(ls,Yi),u(o,As,m),u(o,ce,m),y(So,ce,null),e(ce,Zi),e(ce,ds),e(ds,el),e(ce,tl),e(ce,Io),e(Io,ol),e(Io,fn),e(fn,nl),e(Io,sl),e(ce,al),e(ce,Oo),e(Oo,rl),e(Oo,No),e(No,il),e(Oo,ll),e(ce,dl),y(Nt,ce,null),e(ce,cl),e(ce,Ie),y(Do,Ie,null),e(Ie,pl),e(Ie,yt),e(yt,hl),e(yt,gn),e(gn,ul),e(yt,ml),e(yt,cs),e(cs,fl),e(yt,gl),e(Ie,_l),y(Dt,Ie,null),e(Ie,Tl),e(Ie,ps),e(ps,vl),e(Ie,kl),y(Ao,Ie,null),u(o,Hs,m),u(o,Ct,m),e(Ct,At),e(At,hs),y(Ho,hs,null),e(Ct,bl),e(Ct,us),e(us,yl),u(o,Ws,m),u(o,X,m),y(Wo,X,null),e(X,Cl),e(X,ms),e(ms,wl),e(X,Ll),e(X,_n),e(_n,Tn),e(Tn,$l),e(_n,Rl),e(X,Ml),e(X,Ne),e(Ne,El),e(Ne,fs),e(fs,Fl),e(Ne,ql),e(Ne,gs),e(gs,zl),e(Ne,jl),e(Ne,_s),e(_s,Pl),e(Ne,xl),e(Ne,Ts),e(Ts,Sl),e(Ne,Il),e(X,Ol),e(X,Bo),e(Bo,Nl),e(Bo,vn),e(vn,Dl),e(Bo,Al),e(X,Hl),e(X,Uo),e(Uo,Wl),e(Uo,Vo),e(Vo,Bl),e(Uo,Ul),e(X,Vl),y(Ht,X,null),e(X,Gl),e(X,fe),y(Go,fe,null),e(fe,Kl),e(fe,wt),e(wt,Xl),e(wt,kn),e(kn,Jl),e(wt,Ql),e(wt,vs),e(vs,Yl),e(wt,Zl),e(fe,ed),y(Wt,fe,null),e(fe,td),e(fe,ks),e(ks,od),e(fe,nd),y(Ko,fe,null),e(fe,sd),y(Xo,fe,null),Bs=!0},p(o,[m]){const Jo={};m&2&&(Jo.$$scope={dirty:m,ctx:o}),Ft.$set(Jo);const bs={};m&2&&(bs.$$scope={dirty:m,ctx:o}),zt.$set(bs);const ys={};m&2&&(ys.$$scope={dirty:m,ctx:o}),Pt.$set(ys);const Cs={};m&2&&(Cs.$$scope={dirty:m,ctx:o}),St.$set(Cs);const Qo={};m&2&&(Qo.$$scope={dirty:m,ctx:o}),It.$set(Qo);const ws={};m&2&&(ws.$$scope={dirty:m,ctx:o}),Nt.$set(ws);const Ls={};m&2&&(Ls.$$scope={dirty:m,ctx:o}),Dt.$set(Ls);const $s={};m&2&&($s.$$scope={dirty:m,ctx:o}),Ht.$set($s);const Lt={};m&2&&(Lt.$$scope={dirty:m,ctx:o}),Wt.$set(Lt)},i(o){Bs||(C(T.$$.fragment,o),C(Z.$$.fragment,o),C(Xt.$$.fragment,o),C(Jt.$$.fragment,o),C(Yt.$$.fragment,o),C(Zt.$$.fragment,o),C(eo.$$.fragment,o),C(oo.$$.fragment,o),C(no.$$.fragment,o),C(so.$$.fragment,o),C(lo.$$.fragment,o),C(Ft.$$.fragment,o),C(co.$$.fragment,o),C(po.$$.fragment,o),C(ho.$$.fragment,o),C(go.$$.fragment,o),C(zt.$$.fragment,o),C(_o.$$.fragment,o),C(To.$$.fragment,o),C(vo.$$.fragment,o),C(Co.$$.fragment,o),C(Pt.$$.fragment,o),C(wo.$$.fragment,o),C(Lo.$$.fragment,o),C($o.$$.fragment,o),C(Ro.$$.fragment,o),C(Mo.$$.fragment,o),C(Eo.$$.fragment,o),C(St.$$.fragment,o),C(jo.$$.fragment,o),C(It.$$.fragment,o),C(Po.$$.fragment,o),C(xo.$$.fragment,o),C(So.$$.fragment,o),C(Nt.$$.fragment,o),C(Do.$$.fragment,o),C(Dt.$$.fragment,o),C(Ao.$$.fragment,o),C(Ho.$$.fragment,o),C(Wo.$$.fragment,o),C(Ht.$$.fragment,o),C(Go.$$.fragment,o),C(Wt.$$.fragment,o),C(Ko.$$.fragment,o),C(Xo.$$.fragment,o),Bs=!0)},o(o){w(T.$$.fragment,o),w(Z.$$.fragment,o),w(Xt.$$.fragment,o),w(Jt.$$.fragment,o),w(Yt.$$.fragment,o),w(Zt.$$.fragment,o),w(eo.$$.fragment,o),w(oo.$$.fragment,o),w(no.$$.fragment,o),w(so.$$.fragment,o),w(lo.$$.fragment,o),w(Ft.$$.fragment,o),w(co.$$.fragment,o),w(po.$$.fragment,o),w(ho.$$.fragment,o),w(go.$$.fragment,o),w(zt.$$.fragment,o),w(_o.$$.fragment,o),w(To.$$.fragment,o),w(vo.$$.fragment,o),w(Co.$$.fragment,o),w(Pt.$$.fragment,o),w(wo.$$.fragment,o),w(Lo.$$.fragment,o),w($o.$$.fragment,o),w(Ro.$$.fragment,o),w(Mo.$$.fragment,o),w(Eo.$$.fragment,o),w(St.$$.fragment,o),w(jo.$$.fragment,o),w(It.$$.fragment,o),w(Po.$$.fragment,o),w(xo.$$.fragment,o),w(So.$$.fragment,o),w(Nt.$$.fragment,o),w(Do.$$.fragment,o),w(Dt.$$.fragment,o),w(Ao.$$.fragment,o),w(Ho.$$.fragment,o),w(Wo.$$.fragment,o),w(Ht.$$.fragment,o),w(Go.$$.fragment,o),w(Wt.$$.fragment,o),w(Ko.$$.fragment,o),w(Xo.$$.fragment,o),Bs=!1},d(o){t(h),o&&t(E),o&&t(f),L(T),o&&t(Y),o&&t(R),L(Z),o&&t(pe),o&&t(P),o&&t(he),o&&t(se),o&&t(ue),o&&t(ae),o&&t(H),o&&t(re),o&&t(W),o&&t(S),o&&t(Rs),o&&t(Ye),o&&t(Ms),o&&t(ct),L(Xt),o&&t(Es),o&&t(Le),L(Jt),L(Yt),o&&t(Fs),o&&t(ht),L(Zt),o&&t(qs),o&&t(Oe),L(eo),L(oo),o&&t(zs),o&&t(ut),L(no),o&&t(js),o&&t($e),L(so),L(lo),L(Ft),L(co),o&&t(Ps),o&&t(ft),L(po),o&&t(xs),o&&t(Re),L(ho),L(go),L(zt),L(_o),o&&t(Ss),o&&t(_t),L(To),o&&t(Is),o&&t(Me),L(vo),L(Co),L(Pt),L(wo),L(Lo),L($o),L(Ro),o&&t(Os),o&&t(vt),L(Mo),o&&t(Ns),o&&t(de),L(Eo),L(St),L(jo),L(It),L(Po),o&&t(Ds),o&&t(bt),L(xo),o&&t(As),o&&t(ce),L(So),L(Nt),L(Do),L(Dt),L(Ao),o&&t(Hs),o&&t(Ct),L(Ho),o&&t(Ws),o&&t(X),L(Wo),L(Ht),L(Go),L(Wt),L(Ko),L(Xo)}}}const lp={local:"ctrl",sections:[{local:"overview",title:"Overview"},{local:"transformers.CTRLConfig",title:"CTRLConfig"},{local:"transformers.CTRLTokenizer",title:"CTRLTokenizer"},{local:"transformers.CTRLModel",title:"CTRLModel"},{local:"transformers.CTRLLMHeadModel",title:"CTRLLMHeadModel"},{local:"transformers.CTRLForSequenceClassification",title:"CTRLForSequenceClassification"},{local:"transformers.TFCTRLModel",title:"TFCTRLModel"},{local:"transformers.TFCTRLLMHeadModel",title:"TFCTRLLMHeadModel"},{local:"transformers.TFCTRLForSequenceClassification",title:"TFCTRLForSequenceClassification"}],title:"CTRL"};function dp(J){return Qc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class fp extends Gc{constructor(h){super();Kc(this,h,dp,ip,Xc,{})}}export{fp as default,lp as metadata};
