...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18242/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18242/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18242/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),Sy=h(Dt),y(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s4=a(Rd);Hy=i(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a4=a(zp);Jy=i(a4,"__call__"),a4.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),y(Ts.$$.fragment,aa),Gy=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var r4=a(ws);qp=s(r4,"SPAN",{});var i4=a(qp);y(ii.$$.fragment,i4),i4.forEach(t),r4.forEach(t),Xy=h(qu),Cp=s(qu,"SPAN",{});var l4=a(Cp);Yy=i(l4,"TFRobertaForTokenClassification"),l4.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var d4=a(jp);e2=i(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),t2=h(St),di=s(St,"P",{});var Cu=a(di);o2=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var c4=a(Md);n2=i(c4,"TFPreTrainedModel"),c4.forEach(t),s2=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),a2=h(St),ci=s(St,"P",{});var ju=a(ci);r2=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p4=a(pi);i2=i(p4,"tf.keras.Model"),p4.forEach(t),l2=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),d2=h(St),y($s.$$.fragment,St),c2=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),p2=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);h2=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h4=a(Ed);m2=i(h4,"TFRobertaForTokenClassification"),h4.forEach(t),f2=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m4=a(Pp);u2=i(m4,"__call__"),m4.forEach(t),g2=i(tc," special method."),tc.forEach(t),_2=h(fo),y(Fs.$$.fragment,fo),b2=h(fo),y(xs.$$.fragment,fo),k2=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f4=a(Ms);Lp=s(f4,"SPAN",{});var u4=a(Lp);y(mi.$$.fragment,u4),u4.forEach(t),f4.forEach(t),v2=h(Pu),Ap=s(Pu,"SPAN",{});var g4=a(Ap);T2=i(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),y2=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);w2=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _4=a(Op);$2=i(_4,"span start logits"),_4.forEach(t),F2=i(oc," and "),Np=s(oc,"CODE",{});var b4=a(Np);x2=i(b4,"span end logits"),b4.forEach(t),R2=i(oc,")."),oc.forEach(t),M2=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);E2=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k4=a(zd);z2=i(k4,"TFPreTrainedModel"),k4.forEach(t),q2=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),C2=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);j2=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v4=a(_i);P2=i(v4,"tf.keras.Model"),v4.forEach(t),L2=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),A2=h(Wt),y(Es.$$.fragment,Wt),O2=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),N2=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);I2=i(nc,"The "),qd=s(nc,"A",{href:!0});var T4=a(qd);D2=i(T4,"TFRobertaForQuestionAnswering"),T4.forEach(t),S2=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y4=a(Ip);W2=i(y4,"__call__"),y4.forEach(t),B2=i(nc," special method."),nc.forEach(t),U2=h(uo),y(zs.$$.fragment,uo),H2=h(uo),y(qs.$$.fragment,uo),Q2=h(uo),y(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w4=a(js);Dp=s(w4,"SPAN",{});var $4=a(Dp);y(ki.$$.fragment,$4),$4.forEach(t),w4.forEach(t),J2=h(Ou),Sp=s(Ou,"SPAN",{});var F4=a(Sp);V2=i(F4,"FlaxRobertaModel"),F4.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),K2=h(gt),Wp=s(gt,"P",{});var x4=a(Wp);G2=i(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),X2=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Y2=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var R4=a(Cd);Z2=i(R4,"FlaxPreTrainedModel"),R4.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var BR=a(Eh);$$=i(BR,"Finally, this model supports inherent JAX features such as:"),BR.forEach(t),F$=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UR=a(zh);pl=s(UR,"A",{href:!0,rel:!0});var HR=a(pl);x$=i(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R$=h(fa),qh=s(fa,"LI",{});var QR=a(qh);hl=s(QR,"A",{href:!0,rel:!0});var JR=a(hl);M$=i(JR,"Automatic Differentiation"),JR.forEach(t),QR.forEach(t),E$=h(fa),Ch=s(fa,"LI",{});var VR=a(Ch);ml=s(VR,"A",{href:!0,rel:!0});var KR=a(ml);z$=i(KR,"Vectorization"),KR.forEach(t),VR.forEach(t),q$=h(fa),jh=s(fa,"LI",{});var GR=a(jh);fl=s(GR,"A",{href:!0,rel:!0});var XR=a(fl);C$=i(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),fa.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P$=h(ua),ln=s(ua,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var YR=a(Ph);A$=i(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZR=a(Lh);N$=i(ZR,"__call__"),ZR.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(ua),y(Qs.$$.fragment,ua),S$=h(ua),y(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Vs);Ah=s(eM,"SPAN",{});var tM=a(Ah);y(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W$=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B$=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U$=h(Tt),Nh=s(Tt,"P",{});var nM=a(Nh);H$=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q$=h(Tt),bl=s(Tt,"P",{});var eg=a(bl);J$=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);V$=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K$=i(eg,`. Check the superclass documentation for the generic methods the
