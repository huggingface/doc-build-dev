...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16176/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16176/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16176/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),sa=new ye({}),ra=new j({props:{name:"class transformers.TFRobertaForMaskedLM",anchor:"transformers.TFRobertaForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_tf_roberta.py#L1055",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16176/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qn=new fe({props:{$$slots:{default:[zE]},$$scope:{ctx:q}}}),ca=new j({props:{name:"call",anchor:"transformers.TFRobertaForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_tf_roberta.py#L1072",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ha=new ye({}),ua=new j({props:{name:"class transformers.TFRobertaForSequenceClassification",anchor:"transformers.TFRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_tf_roberta.py#L1319",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16176/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new fe({props:{$$slots:{default:[qE]},$$scope:{ctx:q}}}),_a=new j({props:{name:"call",anchor:"transformers.TFRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_tf_roberta.py#L1330",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ka=new ye({}),Ta=new j({props:{name:"class transformers.TFRobertaForMultipleChoice",anchor:"transformers.TFRobertaForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_tf_roberta.py#L1402",parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16176/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Yn=new fe({props:{$$slots:{default:[PE]},$$scope:{ctx:q}}}),$a=new j({props:{name:"call",anchor:"transformers.TFRobertaForMultipleChoice.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16176/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16176/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16176/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),Cy=d(At),y(ts.$$.fragment,At),Py=d(At),mt=s(At,"DIV",{class:!0});var ho=r(mt);y(qa.$$.fragment,ho),jy=d(ho),Zo=s(ho,"P",{});var hd=r(Zo);Ly=i(hd,"The "),Il=s(hd,"A",{href:!0});var ZR=r(Il);Ay=i(ZR,"TFRobertaForTokenClassification"),ZR.forEach(t),Oy=i(hd," forward method, overrides the "),sp=s(hd,"CODE",{});var e6=r(sp);Ny=i(e6,"__call__"),e6.forEach(t),Iy=i(hd," special method."),hd.forEach(t),Dy=d(ho),y(os.$$.fragment,ho),Sy=d(ho),rp=s(ho,"P",{});var t6=r(rp);Wy=i(t6,"Example:"),t6.forEach(t),By=d(ho),y(Ca.$$.fragment,ho),ho.forEach(t),At.forEach(t),Fu=d(o),en=s(o,"H2",{class:!0});var Sf=r(en);ns=s(Sf,"A",{id:!0,class:!0,href:!0});var o6=r(ns);ap=s(o6,"SPAN",{});var n6=r(ap);y(Pa.$$.fragment,n6),n6.forEach(t),o6.forEach(t),Uy=d(Sf),ip=s(Sf,"SPAN",{});var s6=r(ip);Hy=i(s6,"TFRobertaForQuestionAnswering"),s6.forEach(t),Sf.forEach(t),Ru=d(o),Ke=s(o,"DIV",{class:!0});var Ot=r(Ke);y(ja.$$.fragment,Ot),Qy=d(Ot),tn=s(Ot,"P",{});var ud=r(tn);Vy=i(ud,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),lp=s(ud,"CODE",{});var r6=r(lp);Jy=i(r6,"span start logits"),r6.forEach(t),Ky=i(ud," and "),dp=s(ud,"CODE",{});var a6=r(dp);Gy=i(a6,"span end logits"),a6.forEach(t),Xy=i(ud,")."),ud.forEach(t),Yy=d(Ot),La=s(Ot,"P",{});var Wf=r(La);Zy=i(Wf,"This model inherits from "),Dl=s(Wf,"A",{href:!0});var i6=r(Dl);ev=i(i6,"TFPreTrainedModel"),i6.forEach(t),tv=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),ov=d(Ot),Aa=s(Ot,"P",{});var Bf=r(Aa);nv=i(Bf,"This model is also a "),Oa=s(Bf,"A",{href:!0,rel:!0});var l6=r(Oa);sv=i(l6,"tf.keras.Model"),l6.forEach(t),rv=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),av=d(Ot),y(ss.$$.fragment,Ot),iv=d(Ot),gt=s(Ot,"DIV",{class:!0});var uo=r(gt);y(Na.$$.fragment,uo),lv=d(uo),on=s(uo,"P",{});var fd=r(on);dv=i(fd,"The "),Sl=s(fd,"A",{href:!0});var d6=r(Sl);cv=i(d6,"TFRobertaForQuestionAnswering"),d6.forEach(t),pv=i(fd," forward method, overrides the "),cp=s(fd,"CODE",{});var c6=r(cp);hv=i(c6,"__call__"),c6.forEach(t),uv=i(fd," special method."),fd.forEach(t),fv=d(uo),y(rs.$$.fragment,uo),mv=d(uo),pp=s(uo,"P",{});var p6=r(pp);gv=i(p6,"Example:"),p6.forEach(t),_v=d(uo),y(Ia.$$.fragment,uo),uo.forEach(t),Ot.forEach(t),Mu=d(o),nn=s(o,"H2",{class:!0});var Uf=r(nn);as=s(Uf,"A",{id:!0,class:!0,href:!0});var h6=r(as);hp=s(h6,"SPAN",{});var u6=r(hp);y(Da.$$.fragment,u6),u6.forEach(t),h6.forEach(t),bv=d(Uf),up=s(Uf,"SPAN",{});var f6=r(up);kv=i(f6,"FlaxRobertaModel"),f6.forEach(t),Uf.forEach(t),Eu=d(o),Le=s(o,"DIV",{class:!0});var Ft=r(Le);y(Sa.$$.fragment,Ft),Tv=d(Ft),fp=s(Ft,"P",{});var m6=r(fp);yv=i(m6,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),m6.forEach(t),vv=d(Ft),Wa=s(Ft,"P",{});var Hf=r(Wa);wv=i(Hf,"This model inherits from "),Wl=s(Hf,"A",{href:!0});var g6=r(Wl);$v=i(g6,"FlaxPreTrainedModel"),g6.forEach(t),Fv=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),Rv=d(Ft),Ba=s(Ft,"P",{});var Qf=r(Ba);Mv=i(Qf,"This model is also a Flax Linen "),Ua=s(Qf,"A",{href:!0,rel:!0});var _6=r(Ua);Ev=i(_6,"flax.linen.Module"),_6.forEach(t),zv=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),xv=d(Ft),mp=s(Ft,"P",{});var b6=r(mp);qv=i(b6,"Finally, this model supports inherent JAX features such as:"),b6.forEach(t),Cv=d(Ft),Nt=s(Ft,"UL",{});var bs=r(Nt);gp=s(bs,"LI",{});var k6=r(gp);Ha=s(k6,"A",{href:!0,rel:!0});var T6=r(Ha);Pv=i(T6,"Just-In-Time (JIT) compilation"),T6.forEach(t),k6.forEach(t),jv=d(bs),_p=s(bs,"LI",{});var y6=r(_p);Qa=s(y6,"A",{href:!0,rel:!0});var v6=r(Qa);Lv=i(v6,"Automatic Differentiation"),v6.forEach(t),y6.forEach(t),Av=d(bs),bp=s(bs,"LI",{});var w6=r(bp);Va=s(w6,"A",{href:!0,rel:!0});var $6=r(Va);Ov=i($6,"Vectorization"),$6.forEach(t),w6.forEach(t),Nv=d(bs),kp=s(bs,"LI",{});var F6=r(kp);Ja=s(F6,"A",{href:!0,rel:!0});var R6=r(Ja);Iv=i(R6,"Parallelization"),R6.forEach(t),F6.forEach(t),bs.forEach(t),Dv=d(Ft),_t=s(Ft,"DIV",{class:!0});var fo=r(_t);y(Ka.$$.fragment,fo),Sv=d(fo),sn=s(fo,"P",{});var md=r(sn);Wv=i(md,"The "),Tp=s(md,"CODE",{});var M6=r(Tp);Bv=i(M6,"FlaxRobertaPreTrainedModel"),M6.forEach(t),Uv=i(md,"forward method, overrides the "),yp=s(md,"CODE",{});var E6=r(yp);Hv=i(E6,"__call__"),E6.forEach(t),Qv=i(md," special method."),md.forEach(t),Vv=d(fo),y(is.$$.fragment,fo),Jv=d(fo),vp=s(fo,"P",{});var z6=r(vp);Kv=i(z6,"Example:"),z6.forEach(t),Gv=d(fo),y(Ga.$$.fragment,fo),fo.forEach(t),Ft.forEach(t),zu=d(o),rn=s(o,"H2",{class:!0});var Vf=r(rn);ls=s(Vf,"A",{id:!0,class:!0,href:!0});var x6=r(ls);wp=s(x6,"SPAN",{});var q6=r(wp);y(Xa.$$.fragment,q6),q6.forEach(t),x6.forEach(t),Xv=d(Vf),$p=s(Vf,"SPAN",{});var C6=r($p);Yv=i(C6,"FlaxRobertaForMaskedLM"),C6.forEach(t),Vf.forEach(t),xu=d(o),Ae=s(o,"DIV",{class:!0});var Rt=r(Ae);y(Ya.$$.fragment,Rt),Zv=d(Rt),Za=s(Rt,"P",{});var Jf=r(Za);ew=i(Jf,"RoBERTa Model with a "),Fp=s(Jf,"CODE",{});var P6=r(Fp);tw=i(P6,"language modeling"),P6.forEach(t),ow=i(Jf," head on top."),Jf.forEach(t),nw=d(Rt),ei=s(Rt,"P",{});var Kf=r(ei);sw=i(Kf,"This model inherits from "),Bl=s(Kf,"A",{href:!0});var j6=r(Bl);rw=i(j6,"FlaxPreTrainedModel"),j6.forEach(t),aw=i(Kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kf.forEach(t),iw=d(Rt),ti=s(Rt,"P",{});var Gf=r(ti);lw=i(Gf,"This model is also a Flax Linen "),oi=s(Gf,"A",{href:!0,rel:!0});var L6=r(oi);dw=i(L6,"flax.linen.Module"),L6.forEach(t),cw=i(Gf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gf.forEach(t),pw=d(Rt),Rp=s(Rt,"P",{});var A6=r(Rp);hw=i(A6,"Finally, this model supports inherent JAX features such as:"),A6.forEach(t),uw=d(Rt),It=s(Rt,"UL",{});var ks=r(It);Mp=s(ks,"LI",{});var O6=r(Mp);ni=s(O6,"A",{href:!0,rel:!0});var N6=r(ni);fw=i(N6,"Just-In-Time (JIT) compilation"),N6.forEach(t),O6.forEach(t),mw=d(ks),Ep=s(ks,"LI",{});var I6=r(Ep);si=s(I6,"A",{href:!0,rel:!0});var D6=r(si);gw=i(D6,"Automatic Differentiation"),D6.forEach(t),I6.forEach(t),_w=d(ks),zp=s(ks,"LI",{});var S6=r(zp);ri=s(S6,"A",{href:!0,rel:!0});var W6=r(ri);bw=i(W6,"Vectorization"),W6.forEach(t),S6.forEach(t),kw=d(ks),xp=s(ks,"LI",{});var B6=r(xp);ai=s(B6,"A",{href:!0,rel:!0});var U6=r(ai);Tw=i(U6,"Parallelization"),U6.forEach(t),B6.forEach(t),ks.forEach(t),yw=d(Rt),bt=s(Rt,"DIV",{class:!0});var mo=r(bt);y(ii.$$.fragment,mo),vw=d(mo),an=s(mo,"P",{});var gd=r(an);ww=i(gd,"The "),qp=s(gd,"CODE",{});var H6=r(qp);$w=i(H6,"FlaxRobertaPreTrainedModel"),H6.forEach(t),Fw=i(gd,"forward method, overrides the "),Cp=s(gd,"CODE",{});var Q6=r(Cp);Rw=i(Q6,"__call__"),Q6.forEach(t),Mw=i(gd," special method."),gd.forEach(t),Ew=d(mo),y(ds.$$.fragment,mo),zw=d(mo),Pp=s(mo,"P",{});var V6=r(Pp);xw=i(V6,"Example:"),V6.forEach(t),qw=d(mo),y(li.$$.fragment,mo),mo.forEach(t),Rt.forEach(t),qu=d(o),ln=s(o,"H2",{class:!0});var Xf=r(ln);cs=s(Xf,"A",{id:!0,class:!0,href:!0});var J6=r(cs);jp=s(J6,"SPAN",{});var K6=r(jp);y(di.$$.fragment,K6),K6.forEach(t),J6.forEach(t),Cw=d(Xf),Lp=s(Xf,"SPAN",{});var G6=r(Lp);Pw=i(G6,"FlaxRobertaForSequenceClassification"),G6.forEach(t),Xf.forEach(t),Cu=d(o),Oe=s(o,"DIV",{class:!0});var Mt=r(Oe);y(ci.$$.fragment,Mt),jw=d(Mt),Ap=s(Mt,"P",{});var X6=r(Ap);Lw=i(X6,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X6.forEach(t),Aw=d(Mt),pi=s(Mt,"P",{});var Yf=r(pi);Ow=i(Yf,"This model inherits from "),Ul=s(Yf,"A",{href:!0});var Y6=r(Ul);Nw=i(Y6,"FlaxPreTrainedModel"),Y6.forEach(t),Iw=i(Yf,`. Check the superclass documentation for the generic methods the
...
softmax) e.g. for RocStories/SWAG tasks.`),mM.forEach(t),m$=d(Et),vi=s(Et,"P",{});var tm=r(vi);g$=i(tm,"This model inherits from "),Hl=s(tm,"A",{href:!0});var gM=r(Hl);_$=i(gM,"FlaxPreTrainedModel"),gM.forEach(t),b$=i(tm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tm.forEach(t),k$=d(Et),wi=s(Et,"P",{});var om=r(wi);T$=i(om,"This model is also a Flax Linen "),$i=s(om,"A",{href:!0,rel:!0});var _M=r($i);y$=i(_M,"flax.linen.Module"),_M.forEach(t),v$=i(om,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),om.forEach(t),w$=d(Et),Jp=s(Et,"P",{});var bM=r(Jp);$$=i(bM,"Finally, this model supports inherent JAX features such as:"),bM.forEach(t),F$=d(Et),St=s(Et,"UL",{});var ys=r(St);Kp=s(ys,"LI",{});var kM=r(Kp);Fi=s(kM,"A",{href:!0,rel:!0});var TM=r(Fi);R$=i(TM,"Just-In-Time (JIT) compilation"),TM.forEach(t),kM.forEach(t),M$=d(ys),Gp=s(ys,"LI",{});var yM=r(Gp);Ri=s(yM,"A",{href:!0,rel:!0});var vM=r(Ri);E$=i(vM,"Automatic Differentiation"),vM.forEach(t),yM.forEach(t),z$=d(ys),Xp=s(ys,"LI",{});var wM=r(Xp);Mi=s(wM,"A",{href:!0,rel:!0});var $M=r(Mi);x$=i($M,"Vectorization"),$M.forEach(t),wM.forEach(t),q$=d(ys),Yp=s(ys,"LI",{});var FM=r(Yp);Ei=s(FM,"A",{href:!0,rel:!0});var RM=r(Ei);C$=i(RM,"Parallelization"),RM.forEach(t),FM.forEach(t),ys.forEach(t),P$=d(Et),Tt=s(Et,"DIV",{class:!0});var _o=r(Tt);y(zi.$$.fragment,_o),j$=d(_o),pn=s(_o,"P",{});var bd=r(pn);L$=i(bd,"The "),Zp=s(bd,"CODE",{});var MM=r(Zp);A$=i(MM,"FlaxRobertaPreTrainedModel"),MM.forEach(t),O$=i(bd,"forward method, overrides the "),eh=s(bd,"CODE",{});var EM=r(eh);N$=i(EM,"__call__"),EM.forEach(t),I$=i(bd," special method."),bd.forEach(t),D$=d(_o),y(us.$$.fragment,_o),S$=d(_o),th=s(_o,"P",{});var zM=r(th);W$=i(zM,"Example:"),zM.forEach(t),B$=d(_o),y(xi.$$.fragment,_o),_o.forEach(t),Et.forEach(t),Lu=d(o),hn=s(o,"H2",{class:!0});var nm=r(hn);fs=s(nm,"A",{id:!0,class:!0,href:!0});var xM=r(fs);oh=s(xM,"SPAN",{});var qM=r(oh);y(qi.$$.fragment,qM),qM.forEach(t),xM.forEach(t),U$=d(nm),nh=s(nm,"SPAN",{});var CM=r(nh);H$=i(CM,"FlaxRobertaForTokenClassification"),CM.forEach(t),nm.forEach(t),Au=d(o),Ie=s(o,"DIV",{class:!0});var zt=r(Ie);y(Ci.$$.fragment,zt),Q$=d(zt),sh=s(zt,"P",{});var PM=r(sh);V$=i(PM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),PM.forEach(t),J$=d(zt),Pi=s(zt,"P",{});var sm=r(Pi);K$=i(sm,"This model inherits from "),Ql=s(sm,"A",{href:!0});var jM=r(Ql);G$=i(jM,"FlaxPreTrainedModel"),jM.forEach(t),X$=i(sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sm.forEach(t),Y$=d(zt),ji=s(zt,"P",{});var rm=r(ji);Z$=i(rm,"This model is also a Flax Linen "),Li=s(rm,"A",{href:!0,rel:!0});var LM=r(Li);eF=i(LM,"flax.linen.Module"),LM.forEach(t),tF=i(rm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),rm.forEach(t),oF=d(zt),rh=s(zt,"P",{});var AM=r(rh);nF=i(AM,"Finally, this model supports inherent JAX features such as:"),AM.forEach(t),sF=d(zt),Wt=s(zt,"UL",{});var vs=r(Wt);ah=s(vs,"LI",{});var OM=r(ah);Ai=s(OM,"A",{href:!0,rel:!0});var NM=r(Ai);rF=i(NM,"Just-In-Time (JIT) compilation"),NM.forEach(t),OM.forEach(t),aF=d(vs),ih=s(vs,"LI",{});var IM=r(ih);Oi=s(IM,"A",{href:!0,rel:!0});var DM=r(Oi);iF=i(DM,"Automatic Differentiation"),DM.forEach(t),IM.forEach(t),lF=d(vs),lh=s(vs,"LI",{});var SM=r(lh);Ni=s(SM,"A",{href:!0,rel:!0});var WM=r(Ni);dF=i(WM,"Vectorization"),WM.forEach(t),SM.forEach(t),cF=d(vs),dh=s(vs,"LI",{});var BM=r(dh);Ii=s(BM,"A",{href:!0,rel:!0});var UM=r(Ii);pF=i(UM,"Parallelization"),UM.forEach(t),BM.forEach(t),vs.forEach(t),hF=d(zt),yt=s(zt,"DIV",{class:!0});var bo=r(yt);y(Di.$$.fragment,bo),uF=d(bo),un=s(bo,"P",{});var kd=r(un);fF=i(kd,"The "),ch=s(kd,"CODE",{});var HM=r(ch);mF=i(HM,"FlaxRobertaPreTrainedModel"),HM.forEach(t),gF=i(kd,"forward method, overrides the "),ph=s(kd,"CODE",{});var QM=r(ph);_F=i(QM,"__call__"),QM.forEach(t),bF=i(kd," special method."),kd.forEach(t),kF=d(bo),y(ms.$$.fragment,bo),TF=d(bo),hh=s(bo,"P",{});var VM=r(hh);yF=i(VM,"Example:"),VM.forEach(t),vF=d(bo),y(Si.$$.fragment,bo),bo.forEach(t),zt.forEach(t),Ou=d(o),fn=s(o,"H2",{class:!0});var am=r(fn);gs=s(am,"A",{id:!0,class:!0,href:!0});var JM=r(gs);uh=s(JM,"SPAN",{});var KM=r(uh);y(Wi.$$.fragment,KM),KM.forEach(t),JM.forEach(t),wF=d(am),fh=s(am,"SPAN",{});var GM=r(fh);$F=i(GM,"FlaxRobertaForQuestionAnswering"),GM.forEach(t),am.forEach(t),Nu=d(o),De=s(o,"DIV",{class:!0});var xt=r(De);y(Bi.$$.fragment,xt),FF=d(xt),mn=s(xt,"P",{});var Td=r(mn);RF=i(Td,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),mh=s(Td,"CODE",{});var XM=r(mh);MF=i(XM,"span start logits"),XM.forEach(t),EF=i(Td," and "),gh=s(Td,"CODE",{});var YM=r(gh);zF=i(YM,"span end logits"),YM.forEach(t),xF=i(Td,")."),Td.forEach(t),qF=d(xt),Ui=s(xt,"P",{});var im=r(Ui);CF=i(im,"This model inherits from "),Vl=s(im,"A",{href:!0});var ZM=r(Vl);PF=i(ZM,"FlaxPreTrainedModel"),ZM.forEach(t),jF=i(im,`. Check the superclass documentation for the generic methods the
