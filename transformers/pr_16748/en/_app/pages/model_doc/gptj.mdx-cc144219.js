...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function dg(I){let p,F,f,_,y,T,g,j,ue,K,J,X,O,Z,me,W,fe,ie,L,A,ee,te,x,E,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
...
first positional argument :`),te=l(),x=a("ul"),E=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,J,G),e(J,X),e(J,O),e(O,Z),e(J,me),e(J,W),e(W,fe),e(J,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,E),e(E,ge),e(E,B),e(B,le),e(E,Y),e(E,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ye),e(x,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(J),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function cg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,y,T,g,j,ue,K,J,X,O,Z,me,W,fe,ie,L,A,ee,te,x,E,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=a("ul"),E=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),J=r(h,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Ee.forEach(t),te=d(h),x=r(h,"UL",{});var z=i(x);E=r(z,"LI",{});var Q=i(E);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,J,G),e(J,X),e(J,O),e(O,Z),e(J,me),e(J,W),e(W,fe),e(J,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,E),e(E,ge),e(E,B),e(B,le),e(E,Y),e(E,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ye),e(x,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(J),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function hg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,y,T,g,j,ue,K,J,X,O,Z,me,W,fe,ie,L,A,ee,te,x,E,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=a("ul"),E=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),J=r(h,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Ee.forEach(t),te=d(h),x=r(h,"UL",{});var z=i(x);E=r(z,"LI",{});var Q=i(E);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,J,G),e(J,X),e(J,O),e(O,Z),e(J,me),e(J,W),e(W,fe),e(J,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,E),e(E,ge),e(E,B),e(B,le),e(E,Y),e(E,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ye),e(x,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(J),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function mg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,y,T,g,j,ue,K,J,X,O,Z,me,W,fe,ie,L,A,ee,te,x,E,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=a("ul"),E=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),J=r(h,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Ee.forEach(t),te=d(h),x=r(h,"UL",{});var z=i(x);E=r(z,"LI",{});var Q=i(E);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,J,G),e(J,X),e(J,O),e(O,Z),e(J,me),e(J,W),e(W,fe),e(J,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,E),e(E,ge),e(E,B),e(B,le),e(E,Y),e(E,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ye),e(x,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(J),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function gg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function yg(I){let p,F,f,_,y,T,g,j,ue,K,J,X,O,Z,me,W,fe,ie,L,A,ee,te,x,E,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se,h,G,V,Ae,Ie,C,Le,Ne,Ee,z,Q,pe,Fe,D,Se,ke,we,De,Ks,pt,Ai,xo,Ii,Li,Xs,Ni,Si,Ys,Di,Oi,Mr,$t,Kt,Zs,Eo,Wi,ea,Ui,qr,Xt,Qi,ms,Bi,Hi,Cr,Mo,zr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,Co,Vi,oa,Ki,Lr,Ye,zo,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Nr,jt,Zt,sa,Lo,cl,aa,pl,Sr,ht,No,hl,So,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,ys,yl,vl,ra,kl,wl,bl,eo,Pl,ia,$l,Fl,Wo,Dr,Jt,to,la,Uo,jl,da,Gl,Or,et,Qo,Jl,ca,xl,El,Bo,Ml,Ho,ql,Cl,zl,We,Ro,Al,xt,Il,vs,Ll,Nl,pa,Sl,Dl,Ol,oo,Wl,ha,Ul,Ql,Vo,Wr,Et,no,ua,Ko,Bl,ma,Hl,Ur,je,Xo,Rl,fa,Vl,Kl,ks,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,ya,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,bs,gd,_d,va,Td,yd,vd,so,kd,ka,wd,bd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Qr,qt,ao,ba,an,Jd,Pa,xd,Br,ot,rn,Ed,Ct,Md,$a,qd,Cd,Fa,zd,Ad,Id,ln,Ld,dn,Nd,Sd,Dd,Me,cn,Od,zt,Wd,Ps,Ud,Qd,ja,Bd,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,Ja,un,Zd,xa,ec,Rr,Ge,mn,tc,Ea,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,Ue,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,yc,co,vc,qa,kc,wc,yn,Vr,Lt,po,Ca,vn,bc,za,Pc,Kr,Je,kn,$c,Aa,Fc,jc,wn,Gc,js,Jc,xc,Ec,bn,Mc,Pn,qc,Cc,zc,ho,Ac,Qe,$n,Ic,Nt,Lc,Gs,Nc,Sc,Ia,Dc,Oc,Wc,uo,Uc,La,Qc,Bc,Fn,Xr,St,mo,Na,jn,Hc,Sa,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,Js,xs,Yc,Zc,ep,nt,tp,Oa,op,np,Wa,sp,ap,Ua,rp,ip,Qa,lp,dp,cp,Jn,pp,Es,hp,up,mp,xn,fp,En,gp,_p,Tp,fo,yp,qe,Mn,vp,Dt,kp,Ms,wp,bp,Ba,Pp,$p,Fp,go,jp,Ha,Gp,Jp,qn,xp,Cn,Zr,Ot,_o,Ra,zn,Ep,Va,Mp,ei,xe,An,qp,Wt,Cp,Ka,zp,Ap,Xa,Ip,Lp,Np,In,Sp,qs,Dp,Op,Wp,Ln,Up,Nn,Qp,Bp,Hp,To,Rp,Ce,Sn,Vp,Ut,Kp,Cs,Xp,Yp,Ya,Zp,eh,th,yo,oh,Za,nh,sh,Dn,ah,On,ti,Qt,vo,er,Wn,rh,tr,ih,oi,be,Un,lh,or,dh,ch,Qn,ph,zs,hh,uh,mh,Bn,fh,Hn,gh,_h,Th,nr,yh,vh,ut,sr,Rn,kh,wh,ar,Vn,bh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Be,Yn,Jh,Bt,xh,lr,Eh,Mh,dr,qh,Ch,zh,ko,Ah,cr,Ih,Lh,Zn,ni,Ht,wo,pr,es,Nh,hr,Sh,si,Pe,ts,Dh,ur,Oh,Wh,os,Uh,As,Qh,Bh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,yr,cu,pu,vr,hu,uu,mu,bo,fu,kr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),z=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Lo=new Xe({}),No=new re({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_gptj.py#L469",parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16748/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16748/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oo=new re({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_gptj.py#L525",parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16748/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16748/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16748/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16748/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16748/en/model_doc/gptj#transformers.GPTJConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Uo=new Xe({}),Qo=new re({props:{name:"class transformers.GPTJForCausalLM",anchor:"transformers.GPTJForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_gptj.py#L710",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16748/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16748/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_gptj.py#L779",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16748/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16748/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16748/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16748/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16748/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16748/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16748/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),vn=new Xe({}),kn=new re({props:{name:"class transformers.TFGPTJForCausalLM",anchor:"transformers.TFGPTJForCausalLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_tf_gptj.py#L717",parametersDescription:[{anchor:"transformers.TFGPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16748/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16748/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new Ke({props:{$$slots:{default:[pg]},$$scope:{ctx:I}}}),$n=new re({props:{name:"call",anchor:"transformers.TFGPTJForCausalLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_tf_gptj.py#L759",parametersDescription:[{anchor:"transformers.TFGPTJForCausalLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16748/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16748/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jn=new Xe({}),Gn=new re({props:{name:"class transformers.TFGPTJForSequenceClassification",anchor:"transformers.TFGPTJForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_tf_gptj.py#L849",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16748/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16748/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new Ke({props:{$$slots:{default:[ug]},$$scope:{ctx:I}}}),Mn=new re({props:{name:"call",anchor:"transformers.TFGPTJForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16748/src/transformers/models/gptj/modeling_tf_gptj.py#L863",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16748/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16748/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16748/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16748/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16748/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16748/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=a("meta"),F=l(),f=a("h1"),_=a("a"),y=a("span"),v(T.$$.fragment),g=l(),j=a("span"),ue=n("GPT-J"),K=l(),J=a("h2"),X=a("a"),O=a("span"),v(Z.$$.fragment),me=l(),W=a("span"),fe=n("Overview"),ie=l(),L=a("p"),A=n("The GPT-J model was released in the "),ee=a("a"),te=n("kingoflolz/mesh-transformer-jax"),x=n(` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
...
size, the tokenizer for `),xo=a("a"),Ii=n("GPT-J"),Li=n(` contains 143 extra tokens
...
behavior.`),gl=l(),Oe=a("div"),v(Oo.$$.fragment),_l=l(),Gt=a("p"),Tl=n("The "),ys=a("a"),yl=n("GPTJModel"),vl=n(" forward method, overrides the "),ra=a("code"),kl=n("__call__"),wl=n(" special method."),bl=l(),v(eo.$$.fragment),Pl=l(),ia=a("p"),$l=n("Example:"),Fl=l(),v(Wo.$$.fragment),Dr=l(),Jt=a("h2"),to=a("a"),la=a("span"),v(Uo.$$.fragment),jl=l(),da=a("span"),Gl=n("GPTJForCausalLM"),Or=l(),et=a("div"),v(Qo.$$.fragment),Jl=l(),ca=a("p"),xl=n("The GPT-J Model transformer with a language modeling head on top."),El=l(),Bo=a("p"),Ml=n("This model is a PyTorch "),Ho=a("a"),ql=n("torch.nn.Module"),Cl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=l(),We=a("div"),v(Ro.$$.fragment),Al=l(),xt=a("p"),Il=n("The "),vs=a("a"),Ll=n("GPTJForCausalLM"),Nl=n(" forward method, overrides the "),pa=a("code"),Sl=n("__call__"),Dl=n(" special method."),Ol=l(),v(oo.$$.fragment),Wl=l(),ha=a("p"),Ul=n("Example:"),Ql=l(),v(Vo.$$.fragment),Wr=l(),Et=a("h2"),no=a("a"),ua=a("span"),v(Ko.$$.fragment),Bl=l(),ma=a("span"),Hl=n("GPTJForSequenceClassification"),Ur=l(),je=a("div"),v(Xo.$$.fragment),Rl=l(),fa=a("p"),Vl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Kl=l(),ks=a("p"),ws=a("a"),Xl=n("GPTJForSequenceClassification"),Yl=n(` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),v(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),bs=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),va=a("code"),Td=n("__call__"),yd=n(" special method."),vd=l(),v(so.$$.fragment),kd=l(),ka=a("p"),wd=n("Example of single-label classification:"),bd=l(),v(tn.$$.fragment),Pd=l(),v(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),v(nn.$$.fragment),Gd=l(),v(sn.$$.fragment),Qr=l(),qt=a("h2"),ao=a("a"),ba=a("span"),v(an.$$.fragment),Jd=l(),Pa=a("span"),xd=n("GPTJForQuestionAnswering"),Br=l(),ot=a("div"),v(rn.$$.fragment),Ed=l(),Ct=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
behavior.`),pc=l(),v(lo.$$.fragment),hc=l(),Ue=a("div"),v(Tn.$$.fragment),uc=l(),It=a("p"),mc=n("The "),Fs=a("a"),fc=n("TFGPTJModel"),gc=n(" forward method, overrides the "),Ma=a("code"),_c=n("__call__"),Tc=n(" special method."),yc=l(),v(co.$$.fragment),vc=l(),qa=a("p"),kc=n("Example:"),wc=l(),v(yn.$$.fragment),Vr=l(),Lt=a("h2"),po=a("a"),Ca=a("span"),v(vn.$$.fragment),bc=l(),za=a("span"),Pc=n("TFGPTJForCausalLM"),Kr=l(),Je=a("div"),v(kn.$$.fragment),$c=l(),Aa=a("p"),Fc=n("The GPT-J Model transformer with a language modeling head on top."),jc=l(),wn=a("p"),Gc=n("This model inherits from "),js=a("a"),Jc=n("TFPreTrainedModel"),xc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ec=l(),bn=a("p"),Mc=n("This model is also a "),Pn=a("a"),qc=n("tf.keras.Model"),Cc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zc=l(),v(ho.$$.fragment),Ac=l(),Qe=a("div"),v($n.$$.fragment),Ic=l(),Nt=a("p"),Lc=n("The "),Gs=a("a"),Nc=n("TFGPTJForCausalLM"),Sc=n(" forward method, overrides the "),Ia=a("code"),Dc=n("__call__"),Oc=n(" special method."),Wc=l(),v(uo.$$.fragment),Uc=l(),La=a("p"),Qc=n("Example:"),Bc=l(),v(Fn.$$.fragment),Xr=l(),St=a("h2"),mo=a("a"),Na=a("span"),v(jn.$$.fragment),Hc=l(),Sa=a("span"),Rc=n("TFGPTJForSequenceClassification"),Yr=l(),ae=a("div"),v(Gn.$$.fragment),Vc=l(),Da=a("p"),Kc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Xc=l(),Js=a("p"),xs=a("a"),Yc=n("GPTJForSequenceClassification"),Zc=n(` uses the last token in order to do the classification, as other causal models
...
each row of the batch).`),cp=l(),Jn=a("p"),pp=n("This model inherits from "),Es=a("a"),hp=n("TFPreTrainedModel"),up=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mp=l(),xn=a("p"),fp=n("This model is also a "),En=a("a"),gp=n("tf.keras.Model"),_p=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),v(fo.$$.fragment),yp=l(),qe=a("div"),v(Mn.$$.fragment),vp=l(),Dt=a("p"),kp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),bp=n(" forward method, overrides the "),Ba=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),v(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),Jp=l(),v(qn.$$.fragment),xp=l(),v(Cn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),v(zn.$$.fragment),Ep=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),xe=a("div"),v(An.$$.fragment),qp=l(),Wt=a("p"),Cp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vi.forEach(t),pc=d(rt),k(lo.$$.fragment,rt),hc=d(rt),Ue=r(rt,"DIV",{class:!0});var vt=i(Ue);k(Tn.$$.fragment,vt),uc=d(vt),It=r(vt,"P",{});var Ws=i(It);mc=s(Ws,"The "),Fs=r(Ws,"A",{href:!0});var zm=i(Fs);fc=s(zm,"TFGPTJModel"),zm.forEach(t),gc=s(Ws," forward method, overrides the "),Ma=r(Ws,"CODE",{});var Am=i(Ma);_c=s(Am,"__call__"),Am.forEach(t),Tc=s(Ws," special method."),Ws.forEach(t),yc=d(vt),k(co.$$.fragment,vt),vc=d(vt),qa=r(vt,"P",{});var Im=i(qa);kc=s(Im,"Example:"),Im.forEach(t),wc=d(vt),k(yn.$$.fragment,vt),vt.forEach(t),rt.forEach(t),Vr=d(o),Lt=r(o,"H2",{class:!0});var ki=i(Lt);po=r(ki,"A",{id:!0,class:!0,href:!0});var Lm=i(po);Ca=r(Lm,"SPAN",{});var Nm=i(Ca);k(vn.$$.fragment,Nm),Nm.forEach(t),Lm.forEach(t),bc=d(ki),za=r(ki,"SPAN",{});var Sm=i(za);Pc=s(Sm,"TFGPTJForCausalLM"),Sm.forEach(t),ki.forEach(t),Kr=d(o),Je=r(o,"DIV",{class:!0});var it=i(Je);k(kn.$$.fragment,it),$c=d(it),Aa=r(it,"P",{});var Dm=i(Aa);Fc=s(Dm,"The GPT-J Model transformer with a language modeling head on top."),Dm.forEach(t),jc=d(it),wn=r(it,"P",{});var wi=i(wn);Gc=s(wi,"This model inherits from "),js=r(wi,"A",{href:!0});var Om=i(js);Jc=s(Om,"TFPreTrainedModel"),Om.forEach(t),xc=s(wi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
each row of the batch).`),wt.forEach(t),cp=d(ze),Jn=r(ze,"P",{});var $i=i(Jn);pp=s($i,"This model inherits from "),Es=r($i,"A",{href:!0});var of=i(Es);hp=s(of,"TFPreTrainedModel"),of.forEach(t),up=s($i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$i.forEach(t),mp=d(ze),xn=r(ze,"P",{});var Fi=i(xn);fp=s(Fi,"This model is also a "),En=r(Fi,"A",{href:!0,rel:!0});var nf=i(En);gp=s(nf,"tf.keras.Model"),nf.forEach(t),_p=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(ze),k(fo.$$.fragment,ze),yp=d(ze),qe=r(ze,"DIV",{class:!0});var lt=i(qe);k(Mn.$$.fragment,lt),vp=d(lt),Dt=r(lt,"P",{});var Qs=i(Dt);kp=s(Qs,"The "),Ms=r(Qs,"A",{href:!0});var sf=i(Ms);wp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),bp=s(Qs," forward method, overrides the "),Ba=r(Qs,"CODE",{});var af=i(Ba);Pp=s(af,"__call__"),af.forEach(t),$p=s(Qs," special method."),Qs.forEach(t),Fp=d(lt),k(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),Jp=d(lt),k(qn.$$.fragment,lt),xp=d(lt),k(Cn.$$.fragment,lt),lt.forEach(t),ze.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);k(zn.$$.fragment,df),df.forEach(t),lf.forEach(t),Ep=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),xe=r(o,"DIV",{class:!0});var dt=i(xe);k(An.$$.fragment,dt),qp=d(dt),Wt=r(dt,"P",{});var Bs=i(Wt);Cp=s(Bs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gi.forEach(t),Wp=d(dt),Ln=r(dt,"P",{});var Ji=i(Ln);Up=s(Ji,"This model is also a "),Nn=r(Ji,"A",{href:!0,rel:!0});var mf=i(Nn);Qp=s(mf,"tf.keras.Model"),mf.forEach(t),Bp=s(Ji,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ji.forEach(t),Hp=d(dt),k(To.$$.fragment,dt),Rp=d(dt),Ce=r(dt,"DIV",{class:!0});var ct=i(Ce);k(Sn.$$.fragment,ct),Vp=d(ct),Ut=r(ct,"P",{});var Hs=i(Ut);Kp=s(Hs,"The "),Cs=r(Hs,"A",{href:!0});var ff=i(Cs);Xp=s(ff,"TFGPTJForQuestionAnswering"),ff.forEach(t),Yp=s(Hs," forward method, overrides the "),Ya=r(Hs,"CODE",{});var gf=i(Ya);Zp=s(gf,"__call__"),gf.forEach(t),eh=s(Hs," special method."),Hs.forEach(t),th=d(ct),k(yo.$$.fragment,ct),oh=d(ct),Za=r(ct,"P",{});var _f=i(Za);nh=s(_f,"Example:"),_f.forEach(t),sh=d(ct),k(Dn.$$.fragment,ct),ah=d(ct),k(On.$$.fragment,ct),ct.forEach(t),dt.forEach(t),ti=d(o),Qt=r(o,"H2",{class:!0});var xi=i(Qt);vo=r(xi,"A",{id:!0,class:!0,href:!0});var Tf=i(vo);er=r(Tf,"SPAN",{});var yf=i(er);k(Wn.$$.fragment,yf),yf.forEach(t),Tf.forEach(t),rh=d(xi),tr=r(xi,"SPAN",{});var vf=i(tr);ih=s(vf,"FlaxGPTJModel"),vf.forEach(t),xi.forEach(t),oi=d(o),be=r(o,"DIV",{class:!0});var Re=i(be);k(Un.$$.fragment,Re),lh=d(Re),or=r(Re,"P",{});var kf=i(or);dh=s(kf,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),kf.forEach(t),ch=d(Re),Qn=r(Re,"P",{});var Ei=i(Qn);ph=s(Ei,"This model inherits from "),zs=r(Ei,"A",{href:!0});var wf=i(zs);hh=s(wf,"FlaxPreTrainedModel"),wf.forEach(t),uh=s(Ei,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
