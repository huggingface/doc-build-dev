...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_18053/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_18053/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_18053/src/transformers/tokenization_utils_base.py#L2429",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18053/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18053/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L506",returnDescription:`
<p>The
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18053/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L450",returnDescription:`
<p>The decoded
...
sequences.`),Ro=c(),$=n("div"),E(Z.$$.fragment),Oo=c(),be=n("p"),Uo=s("Convert a list of lists of token ids into a list of strings by calling decode."),Bo=c(),_=n("div"),E(G.$$.fragment),Mo=c(),Te=n("p"),Ho=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Xo=c(),J=n("p"),jo=s("Similar to doing "),we=n("code"),Qo=s("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Zo=s("."),Go=c(),re=n("div"),E(K.$$.fragment),this.h()},l(e){const d=Lt('[data-svelte="svelte-1phssyn"]',document.head);v=r(d,"META",{name:!0,content:!0}),d.forEach(t),ze=l(e),k=r(e,"H1",{class:!0});var De=a(k);w=r(De,"A",{id:!0,class:!0,href:!0});var et=a(w);se=r(et,"SPAN",{});var ot=a(se);q(N.$$.fragment,ot),ot.forEach(t),et.forEach(t),Ge=l(De),ie=r(De,"SPAN",{});var tt=a(ie);Je=i(tt,"Wav2Vec2Phoneme"),tt.forEach(t),De.forEach(t),Ce=l(e),b=r(e,"H2",{class:!0});var Se=a(b);y=r(Se,"A",{id:!0,class:!0,href:!0});var nt=a(y);ce=r(nt,"SPAN",{});var rt=a(ce);q(D.$$.fragment,rt),rt.forEach(t),nt.forEach(t),Ke=l(Se),le=r(Se,"SPAN",{});var at=a(le);Ye=i(at,"Overview"),at.forEach(t),Se.forEach(t),Pe=l(e),z=r(e,"P",{});var Re=a(z);eo=i(Re,"The Wav2Vec2Phoneme model was proposed in "),S=r(Re,"A",{href:!0,rel:!0});var st=a(S);oo=i(st,`Simple and Effective Zero-shot Cross-lingual Phoneme Recognition (Xu et al.,
...
sequences.`),Ct.forEach(t),je.forEach(t),Ro=l(f),$=r(f,"DIV",{class:!0});var Qe=a($);q(Z.$$.fragment,Qe),Oo=l(Qe),be=r(Qe,"P",{});var Pt=a(be);Uo=i(Pt,"Convert a list of lists of token ids into a list of strings by calling decode."),Pt.forEach(t),Qe.forEach(t),Bo=l(f),_=r(f,"DIV",{class:!0});var ae=a(_);q(G.$$.fragment,ae),Mo=l(ae),Te=r(ae,"P",{});var xt=a(Te);Ho=i(xt,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),xt.forEach(t),Xo=l(ae),J=r(ae,"P",{});var Ze=a(J);jo=i(Ze,"Similar to doing "),we=r(Ze,"CODE",{});var Wt=a(we);Qo=i(Wt,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Wt.forEach(t),Zo=i(Ze,"."),Ze.forEach(t),ae.forEach(t),Go=l(f),re=r(f,"DIV",{class:!0});var Vt=a(re);q(K.$$.fragment,Vt),Vt.forEach(t),f.forEach(t),this.h()},h(){p(v,"name","hf:doc:metadata"),p(v,"content",JSON.stringify(Nt)),p(w,"id","wav2vec2phoneme"),p(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(w,"href","#wav2vec2phoneme"),p(k,"class","relative group"),p(y,"id","overview"),p(y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(y,"href","#overview"),p(b,"class","relative group"),p(S,"href","https://arxiv.org/abs/2109.11680"),p(S,"rel","nofollow"),p(te,"href","/docs/transformers/pr_18053/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer"),p(O,"href","https://huggingface.co/models?other=phoneme-recognition"),p(O,"rel","nofollow"),p(B,"href","https://huggingface.co/patrickvonplaten"),p(B,"rel","nofollow"),p(M,"href","https://github.com/pytorch/fairseq/tree/master/fairseq/models/wav2vec"),p(M,"rel","nofollow"),p(W,"id","transformers.Wav2Vec2PhonemeCTCTokenizer"),p(W,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(W,"href","#transformers.Wav2Vec2PhonemeCTCTokenizer"),p(T,"class","relative group"),p(ne,"href","/docs/transformers/pr_18053/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p($,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(_,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,d){o(document.head,v),h(e,ze,d),h(e,k,d),o(k,w),o(w,se),L(N,se,null),o(k,Ge),o(k,ie),o(ie,Je),h(e,Ce,d),h(e,b,d),o(b,y),o(y,ce),L(D,ce,null),o(b,Ke),o(b,le),o(le,Ye),h(e,Pe,d),h(e,z,d),o(z,eo),o(z,S),o(S,oo),o(z,to),h(e,xe,d),h(e,Y,d),o(Y,no),h(e,We,d),h(e,ee,d),o(ee,de),o(de,ro),h(e,Ve,d),h(e,oe,d),o(oe,ao),h(e,$e,d),h(e,u,d),o(u,pe),o(pe,so),o(u,io),o(u,he),o(he,co),o(u,lo),o(u,R),o(R,po),o(R,te),o(te,ho),o(R,mo),o(u,uo),o(u,me),o(me,fo),o(u,_o),o(u,ue),o(ue,go),h(e,Ee,d),h(e,C,d),o(C,vo),o(C,O),o(O,ko),o(C,bo),h(e,qe,d),h(e,U,d),o(U,To),o(U,B),o(B,wo),h(e,Le,d),h(e,P,d),o(P,yo),o(P,M),o(M,zo),o(P,Co),h(e,Fe,d),h(e,x,d),o(x,Po),o(x,fe),o(fe,xo),o(x,Wo),h(e,Ie,d),h(e,T,d),o(T,W),o(W,_e),L(H,_e,null),o(T,Vo),o(T,ge),o(ge,$o),h(e,Ae,d),h(e,m,d),L(X,m,null),o(m,Eo),o(m,ve),o(ve,qo),o(m,Lo),o(m,j),o(j,Fo),o(j,ne),o(ne,Io),o(j,Ao),o(m,No),o(m,V),L(Q,V,null),o(V,Do),o(V,ke),o(ke,So),o(m,Ro),o(m,$),L(Z,$,null),o($,Oo),o($,be),o(be,Uo),o(m,Bo),o(m,_),L(G,_,null),o(_,Mo),o(_,Te),o(Te,Ho),o(_,Xo),o(_,J),o(J,jo),o(J,we),o(we,Qo),o(J,Zo),o(m,Go),o(m,re),L(K,re,null),Ne=!0},p:Ft,i(e){Ne||(F(N.$$.fragment,e),F(D.$$.fragment,e),F(H.$$.fragment,e),F(X.$$.fragment,e),F(Q.$$.fragment,e),F(Z.$$.fragment,e),F(G.$$.fragment,e),F(K.$$.fragment,e),Ne=!0)},o(e){I(N.$$.fragment,e),I(D.$$.fragment,e),I(H.$$.fragment,e),I(X.$$.fragment,e),I(Q.$$.fragment,e),I(Z.$$.fragment,e),I(G.$$.fragment,e),I(K.$$.fragment,e),Ne=!1},d(e){t(v),e&&t(ze),e&&t(k),A(N),e&&t(Ce),e&&t(b),A(D),e&&t(Pe),e&&t(z),e&&t(xe),e&&t(Y),e&&t(We),e&&t(ee),e&&t(Ve),e&&t(oe),e&&t($e),e&&t(u),e&&t(Ee),e&&t(C),e&&t(qe),e&&t(U),e&&t(Le),e&&t(P),e&&t(Fe),e&&t(x),e&&t(Ie),e&&t(T),A(H),e&&t(Ae),e&&t(m),A(X),A(Q),A(Z),A(G),A(K)}}}const Nt={local:"wav2vec2phoneme",sections:[{local:"overview",title:"Overview"},{local:"transformers.Wav2Vec2PhonemeCTCTokenizer",title:"Wav2Vec2PhonemeCTCTokenizer"}],title:"Wav2Vec2Phoneme"};function Dt(Yo){return It(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ut extends $t{constructor(v){super();Et(this,v,Dt,At,qt,{})}}export{Ut as default,Nt as metadata};
