...
When using `lr=None` with [Trainer](/docs/transformers/pr_15463/en/main_classes/trainer#transformers.Trainer) you will most likely need to use `AdafactorSchedule`scheduler as following:
...
<div class="docstring">
<docstring><name>step</name><anchor>transformers.Adafactor.step</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/optimization.py#L531</source><parameters>[{"name": "closure", "val": " = None"}]</parameters><paramsdesc>- **closure** (callable, optional) -- A closure that reevaluates the model
...
<div class="docstring">
<docstring><name>from\_config</name><anchor>transformers.AdamWeightDecay.from_config</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/optimization_tf.py#L209</source><parameters>[{"name": "config", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.GradientAccumulator</name><anchor>transformers.GradientAccumulator</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/optimization_tf.py#L282</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>reset</name><anchor>transformers.GradientAccumulator.reset</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/optimization_tf.py#L344</source><parameters>[]</parameters></docstring>
