...
[generate()](/docs/transformers/pr_15463/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to autoregressively generate text given the input image.
...
[TrOCRProcessor](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor) wraps [`ViTFeatureExtractor`/`DeiTFeatureExtractor`] and [`RobertaTokenizer`/`XLMRobertaTokenizer`]
...
<docstring><name>class transformers.TrOCRConfig</name><anchor>transformers.TrOCRConfig</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/models/trocr/configuration_trocr.py#L29</source><parameters>[{"name": "vocab_size", "val": " = 50265"}, {"name": "d_model", "val": " = 1024"}, {"name": "decoder_layers", "val": " = 12"}, {"name": "decoder_attention_heads", "val": " = 16"}, {"name": "decoder_ffn_dim", "val": " = 4096"}, {"name": "activation_function", "val": " = 'gelu'"}, {"name": "max_position_embeddings", "val": " = 512"}, {"name": "dropout", "val": " = 0.1"}, {"name": "attention_dropout", "val": " = 0.0"}, {"name": "activation_dropout", "val": " = 0.0"}, {"name": "decoder_start_token_id", "val": " = 2"}, {"name": "classifier_dropout", "val": " = 0.0"}, {"name": "init_std", "val": " = 0.02"}, {"name": "decoder_layerdrop", "val": " = 0.0"}, {"name": "use_cache", "val": " = False"}, {"name": "scale_embedding", "val": " = False"}, {"name": "use_learned_position_embeddings", "val": " = True"}, {"name": "layernorm_embedding", "val": " = True"}, {"name": "pad_token_id", "val": " = 1"}, {"name": "bos_token_id", "val": " = 0"}, {"name": "eos_token_id", "val": " = 2"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_size** (`int`, *optional*, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [TrOCRForCausalLM](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRForCausalLM).
...
This is the configuration class to store the configuration of a [TrOCRForCausalLM](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRForCausalLM). It is used to instantiate an
...
[TrOCRProcessor](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor) offers all the functionalities of [`ViTFeatureExtractor`/`DeiTFeatureExtractor`] and
[`RobertaTokenizer`/`XLMRobertaTokenizer`]. See the [__call__()](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor.__call__) and [decode()](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor.decode) for
more information.
...
<div class="docstring">
<docstring><name>\_\_call\_\_</name><anchor>transformers.TrOCRProcessor.__call__</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/models/trocr/processing_trocr.py#L114</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor's
`__call__()`and returns its output. If used in the context
[as_target_processor()](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor.as_target_processor) this method forwards all its arguments to TrOCRTokenizer's
...
Instantiate a [TrOCRProcessor](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor) from a pretrained TrOCR processor.
...
can be re-loaded using the [from_pretrained()](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRProcessor.from_pretrained) class method.
...
<div class="docstring">
<docstring><name>batch\_decode</name><anchor>transformers.TrOCRProcessor.batch_decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/models/trocr/processing_trocr.py#L123</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to TrOCRTokenizer's [batch_decode()](/docs/transformers/pr_15463/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode). Please refer
to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>decode</name><anchor>transformers.TrOCRProcessor.decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/models/trocr/processing_trocr.py#L130</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to TrOCRTokenizer's [decode()](/docs/transformers/pr_15463/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode). Please refer to the
docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>as\_target\_processor</name><anchor>transformers.TrOCRProcessor.as_target_processor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/models/trocr/processing_trocr.py#L137</source><parameters>[]</parameters></docstring>
...
The TrOCR Decoder with a language modeling head. Can be used as the decoder part of [EncoderDecoderModel](/docs/transformers/pr_15463/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) and `VisionEncoderDecoder`.
...
<docstring><name>forward</name><anchor>transformers.TrOCRForCausalLM.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15463/src/transformers/models/trocr/modeling_trocr.py#L807</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "encoder_hidden_states", "val": " = None"}, {"name": "encoder_attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "cross_attn_head_mask", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using `TrOCRTokenizer`. See [PreTrainedTokenizer.encode()](/docs/transformers/pr_15463/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and
...
elements depending on the configuration ([TrOCRConfig](/docs/transformers/pr_15463/en/model_doc/trocr#transformers.TrOCRConfig)) and inputs.
