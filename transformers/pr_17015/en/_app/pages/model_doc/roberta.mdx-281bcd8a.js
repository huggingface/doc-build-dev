...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17015/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17015/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17015/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17015/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17015/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17015/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17015/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17015/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17015/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
behavior.`),zv=p(),T(Xn.$$.fragment),qv=p(),Ft=n("div"),T(Rr.$$.fragment),Cv=p(),jo=n("p"),jv=r("The "),Xl=n("a"),Pv=r("TFRobertaModel"),Lv=r(" forward method, overrides the "),Uc=n("code"),Av=r("__call__"),Ov=r(" special method."),Nv=p(),T(Yn.$$.fragment),Iv=p(),T(Zn.$$.fragment),Cm=p(),Po=n("h2"),es=n("a"),Hc=n("span"),T(Mr.$$.fragment),Dv=p(),Qc=n("span"),Sv=r("TFRobertaForCausalLM"),jm=p(),Lo=n("div"),T(Er.$$.fragment),Wv=p(),xt=n("div"),T(zr.$$.fragment),Bv=p(),Ao=n("p"),Uv=r("The "),Yl=n("a"),Hv=r("TFRobertaForCausalLM"),Qv=r(" forward method, overrides the "),Vc=n("code"),Vv=r("__call__"),Jv=r(" special method."),Kv=p(),T(ts.$$.fragment),Gv=p(),T(os.$$.fragment),Pm=p(),Oo=n("h2"),ns=n("a"),Jc=n("span"),T(qr.$$.fragment),Xv=p(),Kc=n("span"),Yv=r("TFRobertaForMaskedLM"),Lm=p(),Qe=n("div"),T(Cr.$$.fragment),Zv=p(),jr=n("p"),e1=r("RoBERTa Model with a "),Gc=n("code"),t1=r("language modeling"),o1=r(" head on top."),n1=p(),Pr=n("p"),s1=r("This model inherits from "),Zl=n("a"),a1=r("TFPreTrainedModel"),r1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),i1=p(),Lr=n("p"),l1=r("This model is also a "),Ar=n("a"),d1=r("tf.keras.Model"),c1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),p1=p(),T(ss.$$.fragment),h1=p(),dt=n("div"),T(Or.$$.fragment),m1=p(),No=n("p"),f1=r("The "),ed=n("a"),u1=r("TFRobertaForMaskedLM"),g1=r(" forward method, overrides the "),Xc=n("code"),_1=r("__call__"),b1=r(" special method."),k1=p(),T(as.$$.fragment),v1=p(),T(rs.$$.fragment),T1=p(),T(is.$$.fragment),Am=p(),Io=n("h2"),ls=n("a"),Yc=n("span"),T(Nr.$$.fragment),y1=p(),Zc=n("span"),w1=r("TFRobertaForSequenceClassification"),Om=p(),Ve=n("div"),T(Ir.$$.fragment),$1=p(),ep=n("p"),F1=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),x1=p(),Dr=n("p"),R1=r("This model inherits from "),td=n("a"),M1=r("TFPreTrainedModel"),E1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z1=p(),Sr=n("p"),q1=r("This model is also a "),Wr=n("a"),C1=r("tf.keras.Model"),j1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),P1=p(),T(ds.$$.fragment),L1=p(),ct=n("div"),T(Br.$$.fragment),A1=p(),Do=n("p"),O1=r("The "),od=n("a"),N1=r("TFRobertaForSequenceClassification"),I1=r(" forward method, overrides the "),tp=n("code"),D1=r("__call__"),S1=r(" special method."),W1=p(),T(cs.$$.fragment),B1=p(),T(ps.$$.fragment),U1=p(),T(hs.$$.fragment),Nm=p(),So=n("h2"),ms=n("a"),op=n("span"),T(Ur.$$.fragment),H1=p(),np=n("span"),Q1=r("TFRobertaForMultipleChoice"),Im=p(),Je=n("div"),T(Hr.$$.fragment),V1=p(),sp=n("p"),J1=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),K1=p(),Qr=n("p"),G1=r("This model inherits from "),nd=n("a"),X1=r("TFPreTrainedModel"),Y1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Z1=p(),Vr=n("p"),eT=r("This model is also a "),Jr=n("a"),tT=r("tf.keras.Model"),oT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nT=p(),T(fs.$$.fragment),sT=p(),Rt=n("div"),T(Kr.$$.fragment),aT=p(),Wo=n("p"),rT=r("The "),sd=n("a"),iT=r("TFRobertaForMultipleChoice"),lT=r(" forward method, overrides the "),ap=n("code"),dT=r("__call__"),cT=r(" special method."),pT=p(),T(us.$$.fragment),hT=p(),T(gs.$$.fragment),Dm=p(),Bo=n("h2"),_s=n("a"),rp=n("span"),T(Gr.$$.fragment),mT=p(),ip=n("span"),fT=r("TFRobertaForTokenClassification"),Sm=p(),Ke=n("div"),T(Xr.$$.fragment),uT=p(),lp=n("p"),gT=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),_T=p(),Yr=n("p"),bT=r("This model inherits from "),ad=n("a"),kT=r("TFPreTrainedModel"),vT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),TT=p(),Zr=n("p"),yT=r("This model is also a "),ei=n("a"),wT=r("tf.keras.Model"),$T=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),FT=p(),T(bs.$$.fragment),xT=p(),pt=n("div"),T(ti.$$.fragment),RT=p(),Uo=n("p"),MT=r("The "),rd=n("a"),ET=r("TFRobertaForTokenClassification"),zT=r(" forward method, overrides the "),dp=n("code"),qT=r("__call__"),CT=r(" special method."),jT=p(),T(ks.$$.fragment),PT=p(),T(vs.$$.fragment),LT=p(),T(Ts.$$.fragment),Wm=p(),Ho=n("h2"),ys=n("a"),cp=n("span"),T(oi.$$.fragment),AT=p(),pp=n("span"),OT=r("TFRobertaForQuestionAnswering"),Bm=p(),Ge=n("div"),T(ni.$$.fragment),NT=p(),Qo=n("p"),IT=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),DT=r("span start logits"),ST=r(" and "),mp=n("code"),WT=r("span end logits"),BT=r(")."),UT=p(),si=n("p"),HT=r("This model inherits from "),id=n("a"),QT=r("TFPreTrainedModel"),VT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),JT=p(),ai=n("p"),KT=r("This model is also a "),ri=n("a"),GT=r("tf.keras.Model"),XT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),YT=p(),T(ws.$$.fragment),ZT=p(),ht=n("div"),T(ii.$$.fragment),ey=p(),Vo=n("p"),ty=r("The "),ld=n("a"),oy=r("TFRobertaForQuestionAnswering"),ny=r(" forward method, overrides the "),fp=n("code"),sy=r("__call__"),ay=r(" special method."),ry=p(),T($s.$$.fragment),iy=p(),T(Fs.$$.fragment),ly=p(),T(xs.$$.fragment),Um=p(),Jo=n("h2"),Rs=n("a"),up=n("span"),T(li.$$.fragment),dy=p(),gp=n("span"),cy=r("FlaxRobertaModel"),Hm=p(),Oe=n("div"),T(di.$$.fragment),py=p(),_p=n("p"),hy=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),my=p(),ci=n("p"),fy=r("This model inherits from "),dd=n("a"),uy=r("FlaxPreTrainedModel"),gy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),_y=p(),pi=n("p"),by=r("This model is also a Flax Linen "),hi=n("a"),ky=r("flax.linen.Module"),vy=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ty=p(),bp=n("p"),yy=r("Finally, this model supports inherent JAX features such as:"),wy=p(),St=n("ul"),kp=n("li"),mi=n("a"),$y=r("Just-In-Time (JIT) compilation"),Fy=p(),vp=n("li"),fi=n("a"),xy=r("Automatic Differentiation"),Ry=p(),Tp=n("li"),ui=n("a"),My=r("Vectorization"),Ey=p(),yp=n("li"),gi=n("a"),zy=r("Parallelization"),qy=p(),Mt=n("div"),T(_i.$$.fragment),Cy=p(),Ko=n("p"),jy=r("The "),wp=n("code"),Py=r("FlaxRobertaPreTrainedModel"),Ly=r(" forward method, overrides the "),$p=n("code"),Ay=r("__call__"),Oy=r(" special method."),Ny=p(),T(Ms.$$.fragment),Iy=p(),T(Es.$$.fragment),Qm=p(),Go=n("h2"),zs=n("a"),Fp=n("span"),T(bi.$$.fragment),Dy=p(),xp=n("span"),Sy=r("FlaxRobertaForMaskedLM"),Vm=p(),Ne=n("div"),T(ki.$$.fragment),Wy=p(),vi=n("p"),By=r("RoBERTa Model with a "),Rp=n("code"),Uy=r("language modeling"),Hy=r(" head on top."),Qy=p(),Ti=n("p"),Vy=r("This model inherits from "),cd=n("a"),Jy=r("FlaxPreTrainedModel"),Ky=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gy=p(),yi=n("p"),Xy=r("This model is also a Flax Linen "),wi=n("a"),Yy=r("flax.linen.Module"),Zy=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ew=p(),Mp=n("p"),tw=r("Finally, this model supports inherent JAX features such as:"),ow=p(),Wt=n("ul"),Ep=n("li"),$i=n("a"),nw=r("Just-In-Time (JIT) compilation"),sw=p(),zp=n("li"),Fi=n("a"),aw=r("Automatic Differentiation"),rw=p(),qp=n("li"),xi=n("a"),iw=r("Vectorization"),lw=p(),Cp=n("li"),Ri=n("a"),dw=r("Parallelization"),cw=p(),Et=n("div"),T(Mi.$$.fragment),pw=p(),Xo=n("p"),hw=r("The "),jp=n("code"),mw=r("FlaxRobertaPreTrainedModel"),fw=r(" forward method, overrides the "),Pp=n("code"),uw=r("__call__"),gw=r(" special method."),_w=p(),T(qs.$$.fragment),bw=p(),T(Cs.$$.fragment),Jm=p(),Yo=n("h2"),js=n("a"),Lp=n("span"),T(Ei.$$.fragment),kw=p(),Ap=n("span"),vw=r("FlaxRobertaForSequenceClassification"),Km=p(),Ie=n("div"),T(zi.$$.fragment),Tw=p(),Op=n("p"),yw=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),ww=p(),qi=n("p"),$w=r("This model inherits from "),pd=n("a"),Fw=r("FlaxPreTrainedModel"),xw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Rw=p(),Ci=n("p"),Mw=r("This model is also a Flax Linen "),ji=n("a"),Ew=r("flax.linen.Module"),zw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),qw=p(),Np=n("p"),Cw=r("Finally, this model supports inherent JAX features such as:"),jw=p(),Bt=n("ul"),Ip=n("li"),Pi=n("a"),Pw=r("Just-In-Time (JIT) compilation"),Lw=p(),Dp=n("li"),Li=n("a"),Aw=r("Automatic Differentiation"),Ow=p(),Sp=n("li"),Ai=n("a"),Nw=r("Vectorization"),Iw=p(),Wp=n("li"),Oi=n("a"),Dw=r("Parallelization"),Sw=p(),zt=n("div"),T(Ni.$$.fragment),Ww=p(),Zo=n("p"),Bw=r("The "),Bp=n("code"),Uw=r("FlaxRobertaPreTrainedModel"),Hw=r(" forward method, overrides the "),Up=n("code"),Qw=r("__call__"),Vw=r(" special method."),Jw=p(),T(Ps.$$.fragment),Kw=p(),T(Ls.$$.fragment),Gm=p(),en=n("h2"),As=n("a"),Hp=n("span"),T(Ii.$$.fragment),Gw=p(),Qp=n("span"),Xw=r("FlaxRobertaForMultipleChoice"),Xm=p(),De=n("div"),T(Di.$$.fragment),Yw=p(),Vp=n("p"),Zw=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),I$=p(),sh=n("p"),D$=r("Finally, this model supports inherent JAX features such as:"),S$=p(),Ht=n("ul"),ah=n("li"),el=n("a"),W$=r("Just-In-Time (JIT) compilation"),B$=p(),rh=n("li"),tl=n("a"),U$=r("Automatic Differentiation"),H$=p(),ih=n("li"),ol=n("a"),Q$=r("Vectorization"),V$=p(),lh=n("li"),nl=n("a"),J$=r("Parallelization"),K$=p(),Ct=n("div"),T(sl.$$.fragment),G$=p(),nn=n("p"),X$=r("The "),dh=n("code"),Y$=r("FlaxRobertaPreTrainedModel"),Z$=r(" forward method, overrides the "),ch=n("code"),e0=r("__call__"),t0=r(" special method."),o0=p(),T(Ds.$$.fragment),n0=p(),T(Ss.$$.fragment),ef=p(),sn=n("h2"),Ws=n("a"),ph=n("span"),T(al.$$.fragment),s0=p(),hh=n("span"),a0=r("FlaxRobertaForQuestionAnswering"),tf=p(),We=n("div"),T(rl.$$.fragment),r0=p(),an=n("p"),i0=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),mh=n("code"),l0=r("span start logits"),d0=r(" and "),fh=n("code"),c0=r("span end logits"),p0=r(")."),h0=p(),il=n("p"),m0=r("This model inherits from "),fd=n("a"),f0=r("FlaxPreTrainedModel"),u0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),g0=p(),ll=n("p"),_0=r("This model is also a Flax Linen "),dl=n("a"),b0=r("flax.linen.Module"),k0=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),v0=p(),uh=n("p"),T0=r("Finally, this model supports inherent JAX features such as:"),y0=p(),Qt=n("ul"),gh=n("li"),cl=n("a"),w0=r("Just-In-Time (JIT) compilation"),$0=p(),_h=n("li"),pl=n("a"),F0=r("Automatic Differentiation"),x0=p(),bh=n("li"),hl=n("a"),R0=r("Vectorization"),M0=p(),kh=n("li"),ml=n("a"),E0=r("Parallelization"),z0=p(),jt=n("div"),T(fl.$$.fragment),q0=p(),rn=n("p"),C0=r("The "),vh=n("code"),j0=r("FlaxRobertaPreTrainedModel"),P0=r(" forward method, overrides the "),Th=n("code"),L0=r("__call__"),A0=r(" special method."),O0=p(),T(Bs.$$.fragment),N0=p(),T(Us.$$.fragment),this.h()},l(o){const b=rM('[data-svelte="svelte-1phssyn"]',document.head);d=s(b,"META",{name:!0,content:!0}),b.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var ul=a(c);m=s(ul,"A",{id:!0,class:!0,href:!0});var yh=a(m);_=s(yh,"SPAN",{});var wh=a(_);y(l.$$.fragment,wh),wh.forEach(t),yh.forEach(t),f=h(ul),M=s(ul,"SPAN",{});var $h=a(M);Y=i($h,"RoBERTa"),$h.forEach(t),ul.forEach(t),I=h(o),z=s(o,"H2",{class:!0});var gl=a(z);X=s(gl,"A",{id:!0,class:!0,href:!0});var Fh=a(X);D=s(Fh,"SPAN",{});var xh=a(D);y(se.$$.fragment,xh),xh.forEach(t),Fh.forEach(t),be=h(gl),S=s(gl,"SPAN",{});var Rh=a(S);ke=i(Rh,"Overview"),Rh.forEach(t),gl.forEach(t),fe=h(o),K=s(o,"P",{});var _l=a(K);A=i(_l,"The RoBERTa model was proposed in "),ae=s(_l,"A",{href:!0,rel:!0});var Mh=a(ae);Z=i(Mh,"RoBERTa: A Robustly Optimized BERT Pretraining Approach"),Mh.forEach(t),q=i(_l,` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
...
special tokens using the tokenizer `),Xd=s(sf,"CODE",{});var I0=a(Xd);Fg=i(I0,"prepare_for_model"),I0.forEach(t),xg=i(sf," method."),sf.forEach(t),nf.forEach(t),Rg=h($e),bn=s($e,"DIV",{class:!0});var af=a(bn);y(ya.$$.fragment,af),Mg=h(af),Yd=s(af,"P",{});var D0=a(Yd);Eg=i(D0,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),D0.forEach(t),af.forEach(t),zg=h($e),jl=s($e,"DIV",{class:!0});var S0=a(jl);y(wa.$$.fragment,S0),S0.forEach(t),$e.forEach(t),fm=h(o),go=s(o,"H2",{class:!0});var rf=a(go);kn=s(rf,"A",{id:!0,class:!0,href:!0});var W0=a(kn);Zd=s(W0,"SPAN",{});var B0=a(Zd);y($a.$$.fragment,B0),B0.forEach(t),W0.forEach(t),qg=h(rf),ec=s(rf,"SPAN",{});var U0=a(ec);Cg=i(U0,"RobertaTokenizerFast"),U0.forEach(t),rf.forEach(t),um=h(o),Le=s(o,"DIV",{class:!0});var Xe=a(Le);y(Fa.$$.fragment,Xe),jg=h(Xe),xa=s(Xe,"P",{});var lf=a(xa);Pg=i(lf,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),tc=s(lf,"EM",{});var H0=a(tc);Lg=i(H0,"tokenizers"),H0.forEach(t),Ag=i(lf,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),lf.forEach(t),Og=h(Xe),oc=s(Xe,"P",{});var Q0=a(oc);Ng=i(Q0,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Q0.forEach(t),Ig=h(Xe),y(vn.$$.fragment,Xe),Dg=h(Xe),Ra=s(Xe,"P",{});var df=a(Ra);Sg=i(df,"You can get around that behavior by passing "),nc=s(df,"CODE",{});var V0=a(nc);Wg=i(V0,"add_prefix_space=True"),V0.forEach(t),Bg=i(df,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),df.forEach(t),Ug=h(Xe),y(Tn.$$.fragment,Xe),Hg=h(Xe),Ma=s(Xe,"P",{});var cf=a(Ma);Qg=i(cf,"This tokenizer inherits from "),Pl=s(cf,"A",{href:!0});var J0=a(Pl);Vg=i(J0,"PreTrainedTokenizerFast"),J0.forEach(t),Jg=i(cf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),cf.forEach(t),Kg=h(Xe),Ll=s(Xe,"DIV",{class:!0});var K0=a(Ll);y(Ea.$$.fragment,K0),K0.forEach(t),Xe.forEach(t),gm=h(o),_o=s(o,"H2",{class:!0});var pf=a(_o);yn=s(pf,"A",{id:!0,class:!0,href:!0});var G0=a(yn);sc=s(G0,"SPAN",{});var X0=a(sc);y(za.$$.fragment,X0),X0.forEach(t),G0.forEach(t),Gg=h(pf),ac=s(pf,"SPAN",{});var Y0=a(ac);Xg=i(Y0,"RobertaModel"),Y0.forEach(t),pf.forEach(t),_m=h(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(qa.$$.fragment,Ye),Yg=h(Ye),rc=s(Ye,"P",{});var Z0=a(rc);Zg=i(Z0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Z0.forEach(t),e_=h(Ye),Ca=s(Ye,"P",{});var hf=a(Ca);t_=i(hf,"This model inherits from "),Al=s(hf,"A",{href:!0});var e2=a(Al);o_=i(e2,"PreTrainedModel"),e2.forEach(t),n_=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),s_=h(Ye),ja=s(Ye,"P",{});var mf=a(ja);a_=i(mf,"This model is also a PyTorch "),Pa=s(mf,"A",{href:!0,rel:!0});var t2=a(Pa);r_=i(t2,"torch.nn.Module"),t2.forEach(t),i_=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),ic=s(ff,"EM",{});var o2=a(ic);c_=i(o2,`Attention is
all you need`),o2.forEach(t),p_=i(ff,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),ff.forEach(t),h_=h(Ye),Ue=s(Ye,"P",{});var mt=a(Ue);m_=i(mt,"To behave as an decoder the model needs to be initialized with the "),lc=s(mt,"CODE",{});var n2=a(lc);f_=i(n2,"is_decoder"),n2.forEach(t),u_=i(mt,` argument of the configuration set
to `),dc=s(mt,"CODE",{});var s2=a(dc);g_=i(s2,"True"),s2.forEach(t),__=i(mt,". To be used in a Seq2Seq model, the model needs to initialized with both "),cc=s(mt,"CODE",{});var a2=a(cc);b_=i(a2,"is_decoder"),a2.forEach(t),k_=i(mt,` argument and
`),pc=s(mt,"CODE",{});var r2=a(pc);v_=i(r2,"add_cross_attention"),r2.forEach(t),T_=i(mt," set to "),hc=s(mt,"CODE",{});var i2=a(hc);y_=i(i2,"True"),i2.forEach(t),w_=i(mt,"; an "),mc=s(mt,"CODE",{});var l2=a(mc);$_=i(l2,"encoder_hidden_states"),l2.forEach(t),F_=i(mt," is then expected as an input to the forward pass."),mt.forEach(t),x_=h(Ye),wn=s(Ye,"P",{});var lm=a(wn);R_=i(lm,".. _"),fc=s(lm,"EM",{});var d2=a(fc);M_=i(d2,"Attention is all you need"),d2.forEach(t),E_=i(lm,": "),Aa=s(lm,"A",{href:!0,rel:!0});var c2=a(Aa);z_=i(c2,"https://arxiv.org/abs/1706.03762"),c2.forEach(t),lm.forEach(t),q_=h(Ye),yt=s(Ye,"DIV",{class:!0});var Hs=a(yt);y(Oa.$$.fragment,Hs),C_=h(Hs),bo=s(Hs,"P",{});var bd=a(bo);j_=i(bd,"The "),Ol=s(bd,"A",{href:!0});var p2=a(Ol);P_=i(p2,"RobertaModel"),p2.forEach(t),L_=i(bd," forward method, overrides the "),uc=s(bd,"CODE",{});var h2=a(uc);A_=i(h2,"__call__"),h2.forEach(t),O_=i(bd," special method."),bd.forEach(t),N_=h(Hs),y($n.$$.fragment,Hs),I_=h(Hs),y(Fn.$$.fragment,Hs),Hs.forEach(t),Ye.forEach(t),bm=h(o),ko=s(o,"H2",{class:!0});var uf=a(ko);xn=s(uf,"A",{id:!0,class:!0,href:!0});var m2=a(xn);gc=s(m2,"SPAN",{});var f2=a(gc);y(Na.$$.fragment,f2),f2.forEach(t),m2.forEach(t),D_=h(uf),_c=s(uf,"SPAN",{});var u2=a(_c);S_=i(u2,"RobertaForCausalLM"),u2.forEach(t),uf.forEach(t),km=h(o),et=s(o,"DIV",{class:!0});var Yt=a(et);y(Ia.$$.fragment,Yt),W_=h(Yt),Da=s(Yt,"P",{});var gf=a(Da);B_=i(gf,"RoBERTa Model with a "),bc=s(gf,"CODE",{});var g2=a(bc);U_=i(g2,"language modeling"),g2.forEach(t),H_=i(gf," head on top for CLM fine-tuning."),gf.forEach(t),Q_=h(Yt),Sa=s(Yt,"P",{});var _f=a(Sa);V_=i(_f,"This model inherits from "),Nl=s(_f,"A",{href:!0});var _2=a(Nl);J_=i(_2,"PreTrainedModel"),_2.forEach(t),K_=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),G_=h(Yt),Wa=s(Yt,"P",{});var bf=a(Wa);X_=i(bf,"This model is also a PyTorch "),Ba=s(bf,"A",{href:!0,rel:!0});var b2=a(Ba);Y_=i(b2,"torch.nn.Module"),b2.forEach(t),Z_=i(bf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bf.forEach(t),eb=h(Yt),wt=s(Yt,"DIV",{class:!0});var Qs=a(wt);y(Ua.$$.fragment,Qs),tb=h(Qs),vo=s(Qs,"P",{});var kd=a(vo);ob=i(kd,"The "),Il=s(kd,"A",{href:!0});var k2=a(Il);nb=i(k2,"RobertaForCausalLM"),k2.forEach(t),sb=i(kd," forward method, overrides the "),kc=s(kd,"CODE",{});var v2=a(kc);ab=i(v2,"__call__"),v2.forEach(t),rb=i(kd," special method."),kd.forEach(t),ib=h(Qs),y(Rn.$$.fragment,Qs),lb=h(Qs),y(Mn.$$.fragment,Qs),Qs.forEach(t),Yt.forEach(t),vm=h(o),To=s(o,"H2",{class:!0});var kf=a(To);En=s(kf,"A",{id:!0,class:!0,href:!0});var T2=a(En);vc=s(T2,"SPAN",{});var y2=a(vc);y(Ha.$$.fragment,y2),y2.forEach(t),T2.forEach(t),db=h(kf),Tc=s(kf,"SPAN",{});var w2=a(Tc);cb=i(w2,"RobertaForMaskedLM"),w2.forEach(t),kf.forEach(t),Tm=h(o),tt=s(o,"DIV",{class:!0});var Zt=a(tt);y(Qa.$$.fragment,Zt),pb=h(Zt),Va=s(Zt,"P",{});var vf=a(Va);hb=i(vf,"RoBERTa Model with a "),yc=s(vf,"CODE",{});var $2=a(yc);mb=i($2,"language modeling"),$2.forEach(t),fb=i(vf," head on top."),vf.forEach(t),ub=h(Zt),Ja=s(Zt,"P",{});var Tf=a(Ja);gb=i(Tf,"This model inherits from "),Dl=s(Tf,"A",{href:!0});var F2=a(Dl);_b=i(F2,"PreTrainedModel"),F2.forEach(t),bb=i(Tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tf.forEach(t),kb=h(Zt),Ka=s(Zt,"P",{});var yf=a(Ka);vb=i(yf,"This model is also a PyTorch "),Ga=s(yf,"A",{href:!0,rel:!0});var x2=a(Ga);Tb=i(x2,"torch.nn.Module"),x2.forEach(t),yb=i(yf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yf.forEach(t),wb=h(Zt),rt=s(Zt,"DIV",{class:!0});var eo=a(rt);y(Xa.$$.fragment,eo),$b=h(eo),yo=s(eo,"P",{});var vd=a(yo);Fb=i(vd,"The "),Sl=s(vd,"A",{href:!0});var R2=a(Sl);xb=i(R2,"RobertaForMaskedLM"),R2.forEach(t),Rb=i(vd," forward method, overrides the "),wc=s(vd,"CODE",{});var M2=a(wc);Mb=i(M2,"__call__"),M2.forEach(t),Eb=i(vd," special method."),vd.forEach(t),zb=h(eo),y(zn.$$.fragment,eo),qb=h(eo),y(qn.$$.fragment,eo),Cb=h(eo),y(Cn.$$.fragment,eo),eo.forEach(t),Zt.forEach(t),ym=h(o),wo=s(o,"H2",{class:!0});var wf=a(wo);jn=s(wf,"A",{id:!0,class:!0,href:!0});var E2=a(jn);$c=s(E2,"SPAN",{});var z2=a($c);y(Ya.$$.fragment,z2),z2.forEach(t),E2.forEach(t),jb=h(wf),Fc=s(wf,"SPAN",{});var q2=a(Fc);Pb=i(q2,"RobertaForSequenceClassification"),q2.forEach(t),wf.forEach(t),wm=h(o),ot=s(o,"DIV",{class:!0});var to=a(ot);y(Za.$$.fragment,to),Lb=h(to),xc=s(to,"P",{});var C2=a(xc);Ab=i(C2,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C2.forEach(t),Ob=h(to),er=s(to,"P",{});var $f=a(er);Nb=i($f,"This model inherits from "),Wl=s($f,"A",{href:!0});var j2=a(Wl);Ib=i(j2,"PreTrainedModel"),j2.forEach(t),Db=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),Sb=h(to),tr=s(to,"P",{});var Ff=a(tr);Wb=i(Ff,"This model is also a PyTorch "),or=s(Ff,"A",{href:!0,rel:!0});var P2=a(or);Bb=i(P2,"torch.nn.Module"),P2.forEach(t),Ub=i(Ff,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ff.forEach(t),Hb=h(to),Be=s(to,"DIV",{class:!0});var ft=a(Be);y(nr.$$.fragment,ft),Qb=h(ft),$o=s(ft,"P",{});var Td=a($o);Vb=i(Td,"The "),Bl=s(Td,"A",{href:!0});var L2=a(Bl);Jb=i(L2,"RobertaForSequenceClassification"),L2.forEach(t),Kb=i(Td," forward method, overrides the "),Rc=s(Td,"CODE",{});var A2=a(Rc);Gb=i(A2,"__call__"),A2.forEach(t),Xb=i(Td," special method."),Td.forEach(t),Yb=h(ft),y(Pn.$$.fragment,ft),Zb=h(ft),y(Ln.$$.fragment,ft),ek=h(ft),y(An.$$.fragment,ft),tk=h(ft),y(On.$$.fragment,ft),ok=h(ft),y(Nn.$$.fragment,ft),ft.forEach(t),to.forEach(t),$m=h(o),Fo=s(o,"H2",{class:!0});var xf=a(Fo);In=s(xf,"A",{id:!0,class:!0,href:!0});var O2=a(In);Mc=s(O2,"SPAN",{});var N2=a(Mc);y(sr.$$.fragment,N2),N2.forEach(t),O2.forEach(t),nk=h(xf),Ec=s(xf,"SPAN",{});var I2=a(Ec);sk=i(I2,"RobertaForMultipleChoice"),I2.forEach(t),xf.forEach(t),Fm=h(o),nt=s(o,"DIV",{class:!0});var oo=a(nt);y(ar.$$.fragment,oo),ak=h(oo),zc=s(oo,"P",{});var D2=a(zc);rk=i(D2,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D2.forEach(t),ik=h(oo),rr=s(oo,"P",{});var Rf=a(rr);lk=i(Rf,"This model inherits from "),Ul=s(Rf,"A",{href:!0});var S2=a(Ul);dk=i(S2,"PreTrainedModel"),S2.forEach(t),ck=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),pk=h(oo),ir=s(oo,"P",{});var Mf=a(ir);hk=i(Mf,"This model is also a PyTorch "),lr=s(Mf,"A",{href:!0,rel:!0});var W2=a(lr);mk=i(W2,"torch.nn.Module"),W2.forEach(t),fk=i(Mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mf.forEach(t),uk=h(oo),$t=s(oo,"DIV",{class:!0});var Vs=a($t);y(dr.$$.fragment,Vs),gk=h(Vs),xo=s(Vs,"P",{});var yd=a(xo);_k=i(yd,"The "),Hl=s(yd,"A",{href:!0});var B2=a(Hl);bk=i(B2,"RobertaForMultipleChoice"),B2.forEach(t),kk=i(yd," forward method, overrides the "),qc=s(yd,"CODE",{});var U2=a(qc);vk=i(U2,"__call__"),U2.forEach(t),Tk=i(yd," special method."),yd.forEach(t),yk=h(Vs),y(Dn.$$.fragment,Vs),wk=h(Vs),y(Sn.$$.fragment,Vs),Vs.forEach(t),oo.forEach(t),xm=h(o),Ro=s(o,"H2",{class:!0});var Ef=a(Ro);Wn=s(Ef,"A",{id:!0,class:!0,href:!0});var H2=a(Wn);Cc=s(H2,"SPAN",{});var Q2=a(Cc);y(cr.$$.fragment,Q2),Q2.forEach(t),H2.forEach(t),$k=h(Ef),jc=s(Ef,"SPAN",{});var V2=a(jc);Fk=i(V2,"RobertaForTokenClassification"),V2.forEach(t),Ef.forEach(t),Rm=h(o),st=s(o,"DIV",{class:!0});var no=a(st);y(pr.$$.fragment,no),xk=h(no),Pc=s(no,"P",{});var J2=a(Pc);Rk=i(J2,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J2.forEach(t),Mk=h(no),hr=s(no,"P",{});var zf=a(hr);Ek=i(zf,"This model inherits from "),Ql=s(zf,"A",{href:!0});var K2=a(Ql);zk=i(K2,"PreTrainedModel"),K2.forEach(t),qk=i(zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zf.forEach(t),Ck=h(no),mr=s(no,"P",{});var qf=a(mr);jk=i(qf,"This model is also a PyTorch "),fr=s(qf,"A",{href:!0,rel:!0});var G2=a(fr);Pk=i(G2,"torch.nn.Module"),G2.forEach(t),Lk=i(qf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf.forEach(t),Ak=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(ur.$$.fragment,so),Ok=h(so),Mo=s(so,"P",{});var wd=a(Mo);Nk=i(wd,"The "),Vl=s(wd,"A",{href:!0});var X2=a(Vl);Ik=i(X2,"RobertaForTokenClassification"),X2.forEach(t),Dk=i(wd," forward method, overrides the "),Lc=s(wd,"CODE",{});var Y2=a(Lc);Sk=i(Y2,"__call__"),Y2.forEach(t),Wk=i(wd," special method."),wd.forEach(t),Bk=h(so),y(Bn.$$.fragment,so),Uk=h(so),y(Un.$$.fragment,so),Hk=h(so),y(Hn.$$.fragment,so),so.forEach(t),no.forEach(t),Mm=h(o),Eo=s(o,"H2",{class:!0});var Cf=a(Eo);Qn=s(Cf,"A",{id:!0,class:!0,href:!0});var Z2=a(Qn);Ac=s(Z2,"SPAN",{});var eF=a(Ac);y(gr.$$.fragment,eF),eF.forEach(t),Z2.forEach(t),Qk=h(Cf),Oc=s(Cf,"SPAN",{});var tF=a(Oc);Vk=i(tF,"RobertaForQuestionAnswering"),tF.forEach(t),Cf.forEach(t),Em=h(o),at=s(o,"DIV",{class:!0});var ao=a(at);y(_r.$$.fragment,ao),Jk=h(ao),zo=s(ao,"P",{});var $d=a(zo);Kk=i($d,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Nc=s($d,"CODE",{});var oF=a(Nc);Gk=i(oF,"span start logits"),oF.forEach(t),Xk=i($d," and "),Ic=s($d,"CODE",{});var nF=a(Ic);Yk=i(nF,"span end logits"),nF.forEach(t),Zk=i($d,")."),$d.forEach(t),ev=h(ao),br=s(ao,"P",{});var jf=a(br);tv=i(jf,"This model inherits from "),Jl=s(jf,"A",{href:!0});var sF=a(Jl);ov=i(sF,"PreTrainedModel"),sF.forEach(t),nv=i(jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jf.forEach(t),sv=h(ao),kr=s(ao,"P",{});var Pf=a(kr);av=i(Pf,"This model is also a PyTorch "),vr=s(Pf,"A",{href:!0,rel:!0});var aF=a(vr);rv=i(aF,"torch.nn.Module"),aF.forEach(t),iv=i(Pf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pf.forEach(t),lv=h(ao),lt=s(ao,"DIV",{class:!0});var ro=a(lt);y(Tr.$$.fragment,ro),dv=h(ro),qo=s(ro,"P",{});var Fd=a(qo);cv=i(Fd,"The "),Kl=s(Fd,"A",{href:!0});var rF=a(Kl);pv=i(rF,"RobertaForQuestionAnswering"),rF.forEach(t),hv=i(Fd," forward method, overrides the "),Dc=s(Fd,"CODE",{});var iF=a(Dc);mv=i(iF,"__call__"),iF.forEach(t),fv=i(Fd," special method."),Fd.forEach(t),uv=h(ro),y(Vn.$$.fragment,ro),gv=h(ro),y(Jn.$$.fragment,ro),_v=h(ro),y(Kn.$$.fragment,ro),ro.forEach(t),ao.forEach(t),zm=h(o),Co=s(o,"H2",{class:!0});var Lf=a(Co);Gn=s(Lf,"A",{id:!0,class:!0,href:!0});var lF=a(Gn);Sc=s(lF,"SPAN",{});var dF=a(Sc);y(yr.$$.fragment,dF),dF.forEach(t),lF.forEach(t),bv=h(Lf),Wc=s(Lf,"SPAN",{});var cF=a(Wc);kv=i(cF,"TFRobertaModel"),cF.forEach(t),Lf.forEach(t),qm=h(o),He=s(o,"DIV",{class:!0});var Pt=a(He);y(wr.$$.fragment,Pt),vv=h(Pt),Bc=s(Pt,"P",{});var pF=a(Bc);Tv=i(pF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),pF.forEach(t),yv=h(Pt),$r=s(Pt,"P",{});var Af=a($r);wv=i(Af,"This model inherits from "),Gl=s(Af,"A",{href:!0});var hF=a(Gl);$v=i(hF,"TFPreTrainedModel"),hF.forEach(t),Fv=i(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),xv=h(Pt),Fr=s(Pt,"P",{});var Of=a(Fr);Rv=i(Of,"This model is also a "),xr=s(Of,"A",{href:!0,rel:!0});var mF=a(xr);Mv=i(mF,"tf.keras.Model"),mF.forEach(t),Ev=i(Of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),zv=h(Pt),y(Xn.$$.fragment,Pt),qv=h(Pt),Ft=s(Pt,"DIV",{class:!0});var Js=a(Ft);y(Rr.$$.fragment,Js),Cv=h(Js),jo=s(Js,"P",{});var xd=a(jo);jv=i(xd,"The "),Xl=s(xd,"A",{href:!0});var fF=a(Xl);Pv=i(fF,"TFRobertaModel"),fF.forEach(t),Lv=i(xd," forward method, overrides the "),Uc=s(xd,"CODE",{});var uF=a(Uc);Av=i(uF,"__call__"),uF.forEach(t),Ov=i(xd," special method."),xd.forEach(t),Nv=h(Js),y(Yn.$$.fragment,Js),Iv=h(Js),y(Zn.$$.fragment,Js),Js.forEach(t),Pt.forEach(t),Cm=h(o),Po=s(o,"H2",{class:!0});var Nf=a(Po);es=s(Nf,"A",{id:!0,class:!0,href:!0});var gF=a(es);Hc=s(gF,"SPAN",{});var _F=a(Hc);y(Mr.$$.fragment,_F),_F.forEach(t),gF.forEach(t),Dv=h(Nf),Qc=s(Nf,"SPAN",{});var bF=a(Qc);Sv=i(bF,"TFRobertaForCausalLM"),bF.forEach(t),Nf.forEach(t),jm=h(o),Lo=s(o,"DIV",{class:!0});var If=a(Lo);y(Er.$$.fragment,If),Wv=h(If),xt=s(If,"DIV",{class:!0});var Ks=a(xt);y(zr.$$.fragment,Ks),Bv=h(Ks),Ao=s(Ks,"P",{});var Rd=a(Ao);Uv=i(Rd,"The "),Yl=s(Rd,"A",{href:!0});var kF=a(Yl);Hv=i(kF,"TFRobertaForCausalLM"),kF.forEach(t),Qv=i(Rd," forward method, overrides the "),Vc=s(Rd,"CODE",{});var vF=a(Vc);Vv=i(vF,"__call__"),vF.forEach(t),Jv=i(Rd," special method."),Rd.forEach(t),Kv=h(Ks),y(ts.$$.fragment,Ks),Gv=h(Ks),y(os.$$.fragment,Ks),Ks.forEach(t),If.forEach(t),Pm=h(o),Oo=s(o,"H2",{class:!0});var Df=a(Oo);ns=s(Df,"A",{id:!0,class:!0,href:!0});var TF=a(ns);Jc=s(TF,"SPAN",{});var yF=a(Jc);y(qr.$$.fragment,yF),yF.forEach(t),TF.forEach(t),Xv=h(Df),Kc=s(Df,"SPAN",{});var wF=a(Kc);Yv=i(wF,"TFRobertaForMaskedLM"),wF.forEach(t),Df.forEach(t),Lm=h(o),Qe=s(o,"DIV",{class:!0});var Lt=a(Qe);y(Cr.$$.fragment,Lt),Zv=h(Lt),jr=s(Lt,"P",{});var Sf=a(jr);e1=i(Sf,"RoBERTa Model with a "),Gc=s(Sf,"CODE",{});var $F=a(Gc);t1=i($F,"language modeling"),$F.forEach(t),o1=i(Sf," head on top."),Sf.forEach(t),n1=h(Lt),Pr=s(Lt,"P",{});var Wf=a(Pr);s1=i(Wf,"This model inherits from "),Zl=s(Wf,"A",{href:!0});var FF=a(Zl);a1=i(FF,"TFPreTrainedModel"),FF.forEach(t),r1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),i1=h(Lt),Lr=s(Lt,"P",{});var Bf=a(Lr);l1=i(Bf,"This model is also a "),Ar=s(Bf,"A",{href:!0,rel:!0});var xF=a(Ar);d1=i(xF,"tf.keras.Model"),xF.forEach(t),c1=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),p1=h(Lt),y(ss.$$.fragment,Lt),h1=h(Lt),dt=s(Lt,"DIV",{class:!0});var io=a(dt);y(Or.$$.fragment,io),m1=h(io),No=s(io,"P",{});var Md=a(No);f1=i(Md,"The "),ed=s(Md,"A",{href:!0});var RF=a(ed);u1=i(RF,"TFRobertaForMaskedLM"),RF.forEach(t),g1=i(Md," forward method, overrides the "),Xc=s(Md,"CODE",{});var MF=a(Xc);_1=i(MF,"__call__"),MF.forEach(t),b1=i(Md," special method."),Md.forEach(t),k1=h(io),y(as.$$.fragment,io),v1=h(io),y(rs.$$.fragment,io),T1=h(io),y(is.$$.fragment,io),io.forEach(t),Lt.forEach(t),Am=h(o),Io=s(o,"H2",{class:!0});var Uf=a(Io);ls=s(Uf,"A",{id:!0,class:!0,href:!0});var EF=a(ls);Yc=s(EF,"SPAN",{});var zF=a(Yc);y(Nr.$$.fragment,zF),zF.forEach(t),EF.forEach(t),y1=h(Uf),Zc=s(Uf,"SPAN",{});var qF=a(Zc);w1=i(qF,"TFRobertaForSequenceClassification"),qF.forEach(t),Uf.forEach(t),Om=h(o),Ve=s(o,"DIV",{class:!0});var At=a(Ve);y(Ir.$$.fragment,At),$1=h(At),ep=s(At,"P",{});var CF=a(ep);F1=i(CF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),CF.forEach(t),x1=h(At),Dr=s(At,"P",{});var Hf=a(Dr);R1=i(Hf,"This model inherits from "),td=s(Hf,"A",{href:!0});var jF=a(td);M1=i(jF,"TFPreTrainedModel"),jF.forEach(t),E1=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),z1=h(At),Sr=s(At,"P",{});var Qf=a(Sr);q1=i(Qf,"This model is also a "),Wr=s(Qf,"A",{href:!0,rel:!0});var PF=a(Wr);C1=i(PF,"tf.keras.Model"),PF.forEach(t),j1=i(Qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qf.forEach(t),P1=h(At),y(ds.$$.fragment,At),L1=h(At),ct=s(At,"DIV",{class:!0});var lo=a(ct);y(Br.$$.fragment,lo),A1=h(lo),Do=s(lo,"P",{});var Ed=a(Do);O1=i(Ed,"The "),od=s(Ed,"A",{href:!0});var LF=a(od);N1=i(LF,"TFRobertaForSequenceClassification"),LF.forEach(t),I1=i(Ed," forward method, overrides the "),tp=s(Ed,"CODE",{});var AF=a(tp);D1=i(AF,"__call__"),AF.forEach(t),S1=i(Ed," special method."),Ed.forEach(t),W1=h(lo),y(cs.$$.fragment,lo),B1=h(lo),y(ps.$$.fragment,lo),U1=h(lo),y(hs.$$.fragment,lo),lo.forEach(t),At.forEach(t),Nm=h(o),So=s(o,"H2",{class:!0});var Vf=a(So);ms=s(Vf,"A",{id:!0,class:!0,href:!0});var OF=a(ms);op=s(OF,"SPAN",{});var NF=a(op);y(Ur.$$.fragment,NF),NF.forEach(t),OF.forEach(t),H1=h(Vf),np=s(Vf,"SPAN",{});var IF=a(np);Q1=i(IF,"TFRobertaForMultipleChoice"),IF.forEach(t),Vf.forEach(t),Im=h(o),Je=s(o,"DIV",{class:!0});var Ot=a(Je);y(Hr.$$.fragment,Ot),V1=h(Ot),sp=s(Ot,"P",{});var DF=a(sp);J1=i(DF,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DF.forEach(t),K1=h(Ot),Qr=s(Ot,"P",{});var Jf=a(Qr);G1=i(Jf,"This model inherits from "),nd=s(Jf,"A",{href:!0});var SF=a(nd);X1=i(SF,"TFPreTrainedModel"),SF.forEach(t),Y1=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),Z1=h(Ot),Vr=s(Ot,"P",{});var Kf=a(Vr);eT=i(Kf,"This model is also a "),Jr=s(Kf,"A",{href:!0,rel:!0});var WF=a(Jr);tT=i(WF,"tf.keras.Model"),WF.forEach(t),oT=i(Kf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kf.forEach(t),nT=h(Ot),y(fs.$$.fragment,Ot),sT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var Gs=a(Rt);y(Kr.$$.fragment,Gs),aT=h(Gs),Wo=s(Gs,"P",{});var zd=a(Wo);rT=i(zd,"The "),sd=s(zd,"A",{href:!0});var BF=a(sd);iT=i(BF,"TFRobertaForMultipleChoice"),BF.forEach(t),lT=i(zd," forward method, overrides the "),ap=s(zd,"CODE",{});var UF=a(ap);dT=i(UF,"__call__"),UF.forEach(t),cT=i(zd," special method."),zd.forEach(t),pT=h(Gs),y(us.$$.fragment,Gs),hT=h(Gs),y(gs.$$.fragment,Gs),Gs.forEach(t),Ot.forEach(t),Dm=h(o),Bo=s(o,"H2",{class:!0});var Gf=a(Bo);_s=s(Gf,"A",{id:!0,class:!0,href:!0});var HF=a(_s);rp=s(HF,"SPAN",{});var QF=a(rp);y(Gr.$$.fragment,QF),QF.forEach(t),HF.forEach(t),mT=h(Gf),ip=s(Gf,"SPAN",{});var VF=a(ip);fT=i(VF,"TFRobertaForTokenClassification"),VF.forEach(t),Gf.forEach(t),Sm=h(o),Ke=s(o,"DIV",{class:!0});var Nt=a(Ke);y(Xr.$$.fragment,Nt),uT=h(Nt),lp=s(Nt,"P",{});var JF=a(lp);gT=i(JF,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),JF.forEach(t),_T=h(Nt),Yr=s(Nt,"P",{});var Xf=a(Yr);bT=i(Xf,"This model inherits from "),ad=s(Xf,"A",{href:!0});var KF=a(ad);kT=i(KF,"TFPreTrainedModel"),KF.forEach(t),vT=i(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xf.forEach(t),TT=h(Nt),Zr=s(Nt,"P",{});var Yf=a(Zr);yT=i(Yf,"This model is also a "),ei=s(Yf,"A",{href:!0,rel:!0});var GF=a(ei);wT=i(GF,"tf.keras.Model"),GF.forEach(t),$T=i(Yf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),FT=h(Nt),y(bs.$$.fragment,Nt),xT=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),RT=h(co),Uo=s(co,"P",{});var qd=a(Uo);MT=i(qd,"The "),rd=s(qd,"A",{href:!0});var XF=a(rd);ET=i(XF,"TFRobertaForTokenClassification"),XF.forEach(t),zT=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var YF=a(dp);qT=i(YF,"__call__"),YF.forEach(t),CT=i(qd," special method."),qd.forEach(t),jT=h(co),y(ks.$$.fragment,co),PT=h(co),y(vs.$$.fragment,co),LT=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var ZF=a(ys);cp=s(ZF,"SPAN",{});var ex=a(cp);y(oi.$$.fragment,ex),ex.forEach(t),ZF.forEach(t),AT=h(Zf),pp=s(Zf,"SPAN",{});var tx=a(pp);OT=i(tx,"TFRobertaForQuestionAnswering"),tx.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),NT=h(It),Qo=s(It,"P",{});var Cd=a(Qo);IT=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var ox=a(hp);DT=i(ox,"span start logits"),ox.forEach(t),ST=i(Cd," and "),mp=s(Cd,"CODE",{});var nx=a(mp);WT=i(nx,"span end logits"),nx.forEach(t),BT=i(Cd,")."),Cd.forEach(t),UT=h(It),si=s(It,"P",{});var eu=a(si);HT=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var sx=a(id);QT=i(sx,"TFPreTrainedModel"),sx.forEach(t),VT=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),JT=h(It),ai=s(It,"P",{});var tu=a(ai);KT=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var ax=a(ri);GT=i(ax,"tf.keras.Model"),ax.forEach(t),XT=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),YT=h(It),y(ws.$$.fragment,It),ZT=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ey=h(po),Vo=s(po,"P",{});var jd=a(Vo);ty=i(jd,"The "),ld=s(jd,"A",{href:!0});var rx=a(ld);oy=i(rx,"TFRobertaForQuestionAnswering"),rx.forEach(t),ny=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var ix=a(fp);sy=i(ix,"__call__"),ix.forEach(t),ay=i(jd," special method."),jd.forEach(t),ry=h(po),y($s.$$.fragment,po),iy=h(po),y(Fs.$$.fragment,po),ly=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var lx=a(Rs);up=s(lx,"SPAN",{});var dx=a(up);y(li.$$.fragment,dx),dx.forEach(t),lx.forEach(t),dy=h(ou),gp=s(ou,"SPAN",{});var cx=a(gp);cy=i(cx,"FlaxRobertaModel"),cx.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),py=h(ut),_p=s(ut,"P",{});var px=a(_p);hy=i(px,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),px.forEach(t),my=h(ut),ci=s(ut,"P",{});var nu=a(ci);fy=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var hx=a(dd);uy=i(hx,"FlaxPreTrainedModel"),hx.forEach(t),gy=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),_y=h(ut),pi=s(ut,"P",{});var su=a(pi);by=i(su,"This model is also a Flax Linen "),hi=s(su,"A",{href:!0,rel:!0});var mx=a(hi);ky=i(mx,"flax.linen.Module"),mx.forEach(t),vy=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),Ty=h(ut),bp=s(ut,"P",{});var fx=a(bp);yy=i(fx,"Finally, this model supports inherent JAX features such as:"),fx.forEach(t),wy=h(ut),St=s(ut,"UL",{});var Xs=a(St);kp=s(Xs,"LI",{});var ux=a(kp);mi=s(ux,"A",{href:!0,rel:!0});var gx=a(mi);$y=i(gx,"Just-In-Time (JIT) compilation"),gx.forEach(t),ux.forEach(t),Fy=h(Xs),vp=s(Xs,"LI",{});var _x=a(vp);fi=s(_x,"A",{href:!0,rel:!0});var bx=a(fi);xy=i(bx,"Automatic Differentiation"),bx.forEach(t),_x.forEach(t),Ry=h(Xs),Tp=s(Xs,"LI",{});var kx=a(Tp);ui=s(kx,"A",{href:!0,rel:!0});var vx=a(ui);My=i(vx,"Vectorization"),vx.forEach(t),kx.forEach(t),Ey=h(Xs),yp=s(Xs,"LI",{});var Tx=a(yp);gi=s(Tx,"A",{href:!0,rel:!0});var yx=a(gi);zy=i(yx,"Parallelization"),yx.forEach(t),Tx.forEach(t),Xs.forEach(t),qy=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);y(_i.$$.fragment,Ys),Cy=h(Ys),Ko=s(Ys,"P",{});var Pd=a(Ko);jy=i(Pd,"The "),wp=s(Pd,"CODE",{});var wx=a(wp);Py=i(wx,"FlaxRobertaPreTrainedModel"),wx.forEach(t),Ly=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var $x=a($p);Ay=i($x,"__call__"),$x.forEach(t),Oy=i(Pd," special method."),Pd.forEach(t),Ny=h(Ys),y(Ms.$$.fragment,Ys),Iy=h(Ys),y(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Qm=h(o),Go=s(o,"H2",{class:!0});var au=a(Go);zs=s(au,"A",{id:!0,class:!0,href:!0});var Fx=a(zs);Fp=s(Fx,"SPAN",{});var xx=a(Fp);y(bi.$$.fragment,xx),xx.forEach(t),Fx.forEach(t),Dy=h(au),xp=s(au,"SPAN",{});var Rx=a(xp);Sy=i(Rx,"FlaxRobertaForMaskedLM"),Rx.forEach(t),au.forEach(t),Vm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);y(ki.$$.fragment,gt),Wy=h(gt),vi=s(gt,"P",{});var ru=a(vi);By=i(ru,"RoBERTa Model with a "),Rp=s(ru,"CODE",{});var Mx=a(Rp);Uy=i(Mx,"language modeling"),Mx.forEach(t),Hy=i(ru," head on top."),ru.forEach(t),Qy=h(gt),Ti=s(gt,"P",{});var iu=a(Ti);Vy=i(iu,"This model inherits from "),cd=s(iu,"A",{href:!0});var Ex=a(cd);Jy=i(Ex,"FlaxPreTrainedModel"),Ex.forEach(t),Ky=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Gy=h(gt),yi=s(gt,"P",{});var lu=a(yi);Xy=i(lu,"This model is also a Flax Linen "),wi=s(lu,"A",{href:!0,rel:!0});var zx=a(wi);Yy=i(zx,"flax.linen.Module"),zx.forEach(t),Zy=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),ew=h(gt),Mp=s(gt,"P",{});var qx=a(Mp);tw=i(qx,"Finally, this model supports inherent JAX features such as:"),qx.forEach(t),ow=h(gt),Wt=s(gt,"UL",{});var Zs=a(Wt);Ep=s(Zs,"LI",{});var Cx=a(Ep);$i=s(Cx,"A",{href:!0,rel:!0});var jx=a($i);nw=i(jx,"Just-In-Time (JIT) compilation"),jx.forEach(t),Cx.forEach(t),sw=h(Zs),zp=s(Zs,"LI",{});var Px=a(zp);Fi=s(Px,"A",{href:!0,rel:!0});var Lx=a(Fi);aw=i(Lx,"Automatic Differentiation"),Lx.forEach(t),Px.forEach(t),rw=h(Zs),qp=s(Zs,"LI",{});var Ax=a(qp);xi=s(Ax,"A",{href:!0,rel:!0});var Ox=a(xi);iw=i(Ox,"Vectorization"),Ox.forEach(t),Ax.forEach(t),lw=h(Zs),Cp=s(Zs,"LI",{});var Nx=a(Cp);Ri=s(Nx,"A",{href:!0,rel:!0});var Ix=a(Ri);dw=i(Ix,"Parallelization"),Ix.forEach(t),Nx.forEach(t),Zs.forEach(t),cw=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);y(Mi.$$.fragment,ea),pw=h(ea),Xo=s(ea,"P",{});var Ld=a(Xo);hw=i(Ld,"The "),jp=s(Ld,"CODE",{});var Dx=a(jp);mw=i(Dx,"FlaxRobertaPreTrainedModel"),Dx.forEach(t),fw=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var Sx=a(Pp);uw=i(Sx,"__call__"),Sx.forEach(t),gw=i(Ld," special method."),Ld.forEach(t),_w=h(ea),y(qs.$$.fragment,ea),bw=h(ea),y(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Jm=h(o),Yo=s(o,"H2",{class:!0});var du=a(Yo);js=s(du,"A",{id:!0,class:!0,href:!0});var Wx=a(js);Lp=s(Wx,"SPAN",{});var Bx=a(Lp);y(Ei.$$.fragment,Bx),Bx.forEach(t),Wx.forEach(t),kw=h(du),Ap=s(du,"SPAN",{});var Ux=a(Ap);vw=i(Ux,"FlaxRobertaForSequenceClassification"),Ux.forEach(t),du.forEach(t),Km=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);y(zi.$$.fragment,_t),Tw=h(_t),Op=s(_t,"P",{});var Hx=a(Op);yw=i(Hx,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Hx.forEach(t),ww=h(_t),qi=s(_t,"P",{});var cu=a(qi);$w=i(cu,"This model inherits from "),pd=s(cu,"A",{href:!0});var Qx=a(pd);Fw=i(Qx,"FlaxPreTrainedModel"),Qx.forEach(t),xw=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),Rw=h(_t),Ci=s(_t,"P",{});var pu=a(Ci);Mw=i(pu,"This model is also a Flax Linen "),ji=s(pu,"A",{href:!0,rel:!0});var Vx=a(ji);Ew=i(Vx,"flax.linen.Module"),Vx.forEach(t),zw=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),qw=h(_t),Np=s(_t,"P",{});var Jx=a(Np);Cw=i(Jx,"Finally, this model supports inherent JAX features such as:"),Jx.forEach(t),jw=h(_t),Bt=s(_t,"UL",{});var ta=a(Bt);Ip=s(ta,"LI",{});var Kx=a(Ip);Pi=s(Kx,"A",{href:!0,rel:!0});var Gx=a(Pi);Pw=i(Gx,"Just-In-Time (JIT) compilation"),Gx.forEach(t),Kx.forEach(t),Lw=h(ta),Dp=s(ta,"LI",{});var Xx=a(Dp);Li=s(Xx,"A",{href:!0,rel:!0});var Yx=a(Li);Aw=i(Yx,"Automatic Differentiation"),Yx.forEach(t),Xx.forEach(t),Ow=h(ta),Sp=s(ta,"LI",{});var Zx=a(Sp);Ai=s(Zx,"A",{href:!0,rel:!0});var eR=a(Ai);Nw=i(eR,"Vectorization"),eR.forEach(t),Zx.forEach(t),Iw=h(ta),Wp=s(ta,"LI",{});var tR=a(Wp);Oi=s(tR,"A",{href:!0,rel:!0});var oR=a(Oi);Dw=i(oR,"Parallelization"),oR.forEach(t),tR.forEach(t),ta.forEach(t),Sw=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);y(Ni.$$.fragment,oa),Ww=h(oa),Zo=s(oa,"P",{});var Ad=a(Zo);Bw=i(Ad,"The "),Bp=s(Ad,"CODE",{});var nR=a(Bp);Uw=i(nR,"FlaxRobertaPreTrainedModel"),nR.forEach(t),Hw=i(Ad," forward method, overrides the "),Up=s(Ad,"CODE",{});var sR=a(Up);Qw=i(sR,"__call__"),sR.forEach(t),Vw=i(Ad," special method."),Ad.forEach(t),Jw=h(oa),y(Ps.$$.fragment,oa),Kw=h(oa),y(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Gm=h(o),en=s(o,"H2",{class:!0});var hu=a(en);As=s(hu,"A",{id:!0,class:!0,href:!0});var aR=a(As);Hp=s(aR,"SPAN",{});var rR=a(Hp);y(Ii.$$.fragment,rR),rR.forEach(t),aR.forEach(t),Gw=h(hu),Qp=s(hu,"SPAN",{});var iR=a(Qp);Xw=i(iR,"FlaxRobertaForMultipleChoice"),iR.forEach(t),hu.forEach(t),Xm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);y(Di.$$.fragment,bt),Yw=h(bt),Vp=s(bt,"P",{});var lR=a(Vp);Zw=i(lR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
