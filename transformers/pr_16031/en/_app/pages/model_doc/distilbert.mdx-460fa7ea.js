...
<a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new ye({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new U({props:{name:"forward",anchor:"transformers.DistilBertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_distilbert.py#L507",parametersDescription:[{anchor:"transformers.DistilBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16031/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),On=new U({props:{name:"forward",anchor:"transformers.DistilBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_distilbert.py#L1029",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jn=new U({props:{name:"forward",anchor:"transformers.DistilBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_distilbert.py#L934",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new me({props:{$$slots:{default:[mF]},$$scope:{ctx:j}}}),lr=new U({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_tf_distilbert.py#L541",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new me({props:{$$slots:{default:[bF]},$$scope:{ctx:j}}}),$r=new U({props:{name:"call",anchor:"transformers.TFDistilBertForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_tf_distilbert.py#L757",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new me({props:{$$slots:{default:[kF]},$$scope:{ctx:j}}}),zr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_tf_distilbert.py#L957",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new me({props:{$$slots:{default:[$F]},$$scope:{ctx:j}}}),Ir=new U({props:{name:"call",anchor:"transformers.TFDistilBertForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_tf_distilbert.py#L852",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Mo=new me({props:{$$slots:{default:[FF]},$$scope:{ctx:j}}}),Hr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1084",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ua=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Da=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qa=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16031/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oi=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16031/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16031/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16031/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
pooled output) e.g. for GLUE tasks.`),Z_=l(),Tr=o("p"),e1=a("This model inherits from "),qi=o("a"),t1=a("TFPreTrainedModel"),s1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),o1=l(),kr=o("p"),n1=a("This model is also a "),wr=o("a"),r1=a("tf.keras.Model"),a1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),i1=l(),T(To.$$.fragment),l1=l(),et=o("div"),T($r.$$.fragment),d1=l(),Es=o("p"),c1=a("The "),Ai=o("a"),p1=a("TFDistilBertForSequenceClassification"),h1=a(" forward method, overrides the "),_d=o("code"),u1=a("__call__"),f1=a(" special method."),m1=l(),T(ko.$$.fragment),g1=l(),vd=o("p"),_1=a("Example:"),v1=l(),T(Dr.$$.fragment),Np=l(),Ms=o("h2"),wo=o("a"),bd=o("span"),T(Fr.$$.fragment),b1=l(),Td=o("span"),T1=a("TFDistilBertForMultipleChoice"),Lp=l(),Ie=o("div"),T(yr.$$.fragment),k1=l(),kd=o("p"),w1=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),B1=l(),Er=o("p"),E1=a("This model is also a "),Mr=o("a"),M1=a("tf.keras.Model"),z1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),x1=l(),T($o.$$.fragment),j1=l(),tt=o("div"),T(zr.$$.fragment),C1=l(),zs=o("p"),P1=a("The "),Ni=o("a"),q1=a("TFDistilBertForMultipleChoice"),A1=a(" forward method, overrides the "),wd=o("code"),I1=a("__call__"),N1=a(" special method."),L1=l(),T(Do.$$.fragment),S1=l(),$d=o("p"),O1=a("Example:"),W1=l(),T(xr.$$.fragment),Sp=l(),xs=o("h2"),Fo=o("a"),Dd=o("span"),T(jr.$$.fragment),R1=l(),Fd=o("span"),H1=a("TFDistilBertForTokenClassification"),Op=l(),Ne=o("div"),T(Cr.$$.fragment),Q1=l(),yd=o("p"),U1=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),V1=l(),Pr=o("p"),J1=a("This model inherits from "),Li=o("a"),K1=a("TFPreTrainedModel"),G1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),X1=l(),qr=o("p"),Y1=a("This model is also a "),Ar=o("a"),Z1=a("tf.keras.Model"),ev=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tv=l(),T(yo.$$.fragment),sv=l(),st=o("div"),T(Ir.$$.fragment),ov=l(),js=o("p"),nv=a("The "),Si=o("a"),rv=a("TFDistilBertForTokenClassification"),av=a(" forward method, overrides the "),Bd=o("code"),iv=a("__call__"),lv=a(" special method."),dv=l(),T(Bo.$$.fragment),cv=l(),Ed=o("p"),pv=a("Example:"),hv=l(),T(Nr.$$.fragment),Wp=l(),Cs=o("h2"),Eo=o("a"),Md=o("span"),T(Lr.$$.fragment),uv=l(),zd=o("span"),fv=a("TFDistilBertForQuestionAnswering"),Rp=l(),Le=o("div"),T(Sr.$$.fragment),mv=l(),Ps=o("p"),gv=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),xd=o("code"),_v=a("span start logits"),vv=a(" and "),jd=o("code"),bv=a("span end logits"),Tv=a(")."),kv=l(),Or=o("p"),wv=a("This model inherits from "),Oi=o("a"),$v=a("TFPreTrainedModel"),Dv=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fv=l(),Wr=o("p"),yv=a("This model is also a "),Rr=o("a"),Bv=a("tf.keras.Model"),Ev=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mv=l(),T(Mo.$$.fragment),zv=l(),ot=o("div"),T(Hr.$$.fragment),xv=l(),qs=o("p"),jv=a("The "),Wi=o("a"),Cv=a("TFDistilBertForQuestionAnswering"),Pv=a(" forward method, overrides the "),Cd=o("code"),qv=a("__call__"),Av=a(" special method."),Iv=l(),T(zo.$$.fragment),Nv=l(),Pd=o("p"),Lv=a("Example:"),Sv=l(),T(Qr.$$.fragment),Hp=l(),As=o("h2"),xo=o("a"),qd=o("span"),T(Ur.$$.fragment),Ov=l(),Ad=o("span"),Wv=a("FlaxDistilBertModel"),Qp=l(),Be=o("div"),T(Vr.$$.fragment),Rv=l(),Id=o("p"),Hv=a("The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),Qv=l(),Jr=o("p"),Uv=a("This model inherits from "),Ri=o("a"),Vv=a("FlaxPreTrainedModel"),Jv=a(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Zv=l(),Nd=o("p"),eb=a("Finally, this model supports inherent JAX features such as:"),tb=l(),Bt=o("ul"),Ld=o("li"),Xr=o("a"),sb=a("Just-In-Time (JIT) compilation"),ob=l(),Sd=o("li"),Yr=o("a"),nb=a("Automatic Differentiation"),rb=l(),Od=o("li"),Zr=o("a"),ab=a("Vectorization"),ib=l(),Wd=o("li"),ea=o("a"),lb=a("Parallelization"),db=l(),nt=o("div"),T(ta.$$.fragment),cb=l(),Is=o("p"),pb=a("The "),Rd=o("code"),hb=a("FlaxDistilBertPreTrainedModel"),ub=a("forward method, overrides the "),Hd=o("code"),fb=a("__call__"),mb=a(" special method."),gb=l(),T(jo.$$.fragment),_b=l(),Qd=o("p"),vb=a("Example:"),bb=l(),T(sa.$$.fragment),Up=l(),Ns=o("h2"),Co=o("a"),Ud=o("span"),T(oa.$$.fragment),Tb=l(),Vd=o("span"),kb=a("FlaxDistilBertForMaskedLM"),Vp=l(),Ee=o("div"),T(na.$$.fragment),wb=l(),ra=o("p"),$b=a("DistilBert Model with a "),Jd=o("code"),Db=a("language modeling"),Fb=a(" head on top."),yb=l(),aa=o("p"),Bb=a("This model inherits from "),Hi=o("a"),Eb=a("FlaxPreTrainedModel"),Mb=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),zb=l(),ia=o("p"),xb=a("This model is also a Flax Linen "),la=o("a"),jb=a("flax.linen.Module"),Cb=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Pb=l(),Kd=o("p"),qb=a("Finally, this model supports inherent JAX features such as:"),Ab=l(),Et=o("ul"),Gd=o("li"),da=o("a"),Ib=a("Just-In-Time (JIT) compilation"),Nb=l(),Xd=o("li"),ca=o("a"),Lb=a("Automatic Differentiation"),Sb=l(),Yd=o("li"),pa=o("a"),Ob=a("Vectorization"),Wb=l(),Zd=o("li"),ha=o("a"),Rb=a("Parallelization"),Hb=l(),rt=o("div"),T(ua.$$.fragment),Qb=l(),Ls=o("p"),Ub=a("The "),ec=o("code"),Vb=a("FlaxDistilBertPreTrainedModel"),Jb=a("forward method, overrides the "),tc=o("code"),Kb=a("__call__"),Gb=a(" special method."),Xb=l(),T(Po.$$.fragment),Yb=l(),sc=o("p"),Zb=a("Example:"),eT=l(),T(fa.$$.fragment),Jp=l(),Ss=o("h2"),qo=o("a"),oc=o("span"),T(ma.$$.fragment),tT=l(),nc=o("span"),sT=a("FlaxDistilBertForSequenceClassification"),Kp=l(),Me=o("div"),T(ga.$$.fragment),oT=l(),rc=o("p"),nT=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
pooled output) e.g. for GLUE tasks.`),D$.forEach(t),Z_=d(wt),Tr=n(wt,"P",{});var Ah=r(Tr);e1=i(Ah,"This model inherits from "),qi=n(Ah,"A",{href:!0});var F$=r(qi);t1=i(F$,"TFPreTrainedModel"),F$.forEach(t),s1=i(Ah,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),i1=d(wt),k(To.$$.fragment,wt),l1=d(wt),et=n(wt,"DIV",{class:!0});var Gt=r(et);k($r.$$.fragment,Gt),d1=d(Gt),Es=n(Gt,"P",{});var rl=r(Es);c1=i(rl,"The "),Ai=n(rl,"A",{href:!0});var B$=r(Ai);p1=i(B$,"TFDistilBertForSequenceClassification"),B$.forEach(t),h1=i(rl," forward method, overrides the "),_d=n(rl,"CODE",{});var E$=r(_d);u1=i(E$,"__call__"),E$.forEach(t),f1=i(rl," special method."),rl.forEach(t),m1=d(Gt),k(ko.$$.fragment,Gt),g1=d(Gt),vd=n(Gt,"P",{});var M$=r(vd);_1=i(M$,"Example:"),M$.forEach(t),v1=d(Gt),k(Dr.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Np=d(s),Ms=n(s,"H2",{class:!0});var Nh=r(Ms);wo=n(Nh,"A",{id:!0,class:!0,href:!0});var z$=r(wo);bd=n(z$,"SPAN",{});var x$=r(bd);k(Fr.$$.fragment,x$),x$.forEach(t),z$.forEach(t),b1=d(Nh),Td=n(Nh,"SPAN",{});var j$=r(Td);T1=i(j$,"TFDistilBertForMultipleChoice"),j$.forEach(t),Nh.forEach(t),Lp=d(s),Ie=n(s,"DIV",{class:!0});var $t=r(Ie);k(yr.$$.fragment,$t),k1=d($t),kd=n($t,"P",{});var C$=r(kd);w1=i(C$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),C$.forEach(t),$1=d($t),Br=n($t,"P",{});var Lh=r(Br);D1=i(Lh,"This model inherits from "),Ii=n(Lh,"A",{href:!0});var P$=r(Ii);F1=i(P$,"TFPreTrainedModel"),P$.forEach(t),y1=i(Lh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sh.forEach(t),x1=d($t),k($o.$$.fragment,$t),j1=d($t),tt=n($t,"DIV",{class:!0});var Xt=r(tt);k(zr.$$.fragment,Xt),C1=d(Xt),zs=n(Xt,"P",{});var al=r(zs);P1=i(al,"The "),Ni=n(al,"A",{href:!0});var A$=r(Ni);q1=i(A$,"TFDistilBertForMultipleChoice"),A$.forEach(t),A1=i(al," forward method, overrides the "),wd=n(al,"CODE",{});var I$=r(wd);I1=i(I$,"__call__"),I$.forEach(t),N1=i(al," special method."),al.forEach(t),L1=d(Xt),k(Do.$$.fragment,Xt),S1=d(Xt),$d=n(Xt,"P",{});var N$=r($d);O1=i(N$,"Example:"),N$.forEach(t),W1=d(Xt),k(xr.$$.fragment,Xt),Xt.forEach(t),$t.forEach(t),Sp=d(s),xs=n(s,"H2",{class:!0});var Oh=r(xs);Fo=n(Oh,"A",{id:!0,class:!0,href:!0});var L$=r(Fo);Dd=n(L$,"SPAN",{});var S$=r(Dd);k(jr.$$.fragment,S$),S$.forEach(t),L$.forEach(t),R1=d(Oh),Fd=n(Oh,"SPAN",{});var O$=r(Fd);H1=i(O$,"TFDistilBertForTokenClassification"),O$.forEach(t),Oh.forEach(t),Op=d(s),Ne=n(s,"DIV",{class:!0});var Dt=r(Ne);k(Cr.$$.fragment,Dt),Q1=d(Dt),yd=n(Dt,"P",{});var W$=r(yd);U1=i(W$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),tv=d(Dt),k(yo.$$.fragment,Dt),sv=d(Dt),st=n(Dt,"DIV",{class:!0});var Yt=r(st);k(Ir.$$.fragment,Yt),ov=d(Yt),js=n(Yt,"P",{});var il=r(js);nv=i(il,"The "),Si=n(il,"A",{href:!0});var Q$=r(Si);rv=i(Q$,"TFDistilBertForTokenClassification"),Q$.forEach(t),av=i(il," forward method, overrides the "),Bd=n(il,"CODE",{});var U$=r(Bd);iv=i(U$,"__call__"),U$.forEach(t),lv=i(il," special method."),il.forEach(t),dv=d(Yt),k(Bo.$$.fragment,Yt),cv=d(Yt),Ed=n(Yt,"P",{});var V$=r(Ed);pv=i(V$,"Example:"),V$.forEach(t),hv=d(Yt),k(Nr.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),Wp=d(s),Cs=n(s,"H2",{class:!0});var Hh=r(Cs);Eo=n(Hh,"A",{id:!0,class:!0,href:!0});var J$=r(Eo);Md=n(J$,"SPAN",{});var K$=r(Md);k(Lr.$$.fragment,K$),K$.forEach(t),J$.forEach(t),uv=d(Hh),zd=n(Hh,"SPAN",{});var G$=r(zd);fv=i(G$,"TFDistilBertForQuestionAnswering"),G$.forEach(t),Hh.forEach(t),Rp=d(s),Le=n(s,"DIV",{class:!0});var Ft=r(Le);k(Sr.$$.fragment,Ft),mv=d(Ft),Ps=n(Ft,"P",{});var ll=r(Ps);gv=i(ll,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),xd=n(ll,"CODE",{});var X$=r(xd);_v=i(X$,"span start logits"),X$.forEach(t),vv=i(ll," and "),jd=n(ll,"CODE",{});var Y$=r(jd);bv=i(Y$,"span end logits"),Y$.forEach(t),Tv=i(ll,")."),ll.forEach(t),kv=d(Ft),Or=n(Ft,"P",{});var Qh=r(Or);wv=i(Qh,"This model inherits from "),Oi=n(Qh,"A",{href:!0});var Z$=r(Oi);$v=i(Z$,"TFPreTrainedModel"),Z$.forEach(t),Dv=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),Mv=d(Ft),k(Mo.$$.fragment,Ft),zv=d(Ft),ot=n(Ft,"DIV",{class:!0});var Zt=r(ot);k(Hr.$$.fragment,Zt),xv=d(Zt),qs=n(Zt,"P",{});var dl=r(qs);jv=i(dl,"The "),Wi=n(dl,"A",{href:!0});var tD=r(Wi);Cv=i(tD,"TFDistilBertForQuestionAnswering"),tD.forEach(t),Pv=i(dl," forward method, overrides the "),Cd=n(dl,"CODE",{});var sD=r(Cd);qv=i(sD,"__call__"),sD.forEach(t),Av=i(dl," special method."),dl.forEach(t),Iv=d(Zt),k(zo.$$.fragment,Zt),Nv=d(Zt),Pd=n(Zt,"P",{});var oD=r(Pd);Lv=i(oD,"Example:"),oD.forEach(t),Sv=d(Zt),k(Qr.$$.fragment,Zt),Zt.forEach(t),Ft.forEach(t),Hp=d(s),As=n(s,"H2",{class:!0});var Vh=r(As);xo=n(Vh,"A",{id:!0,class:!0,href:!0});var nD=r(xo);qd=n(nD,"SPAN",{});var rD=r(qd);k(Ur.$$.fragment,rD),rD.forEach(t),nD.forEach(t),Ov=d(Vh),Ad=n(Vh,"SPAN",{});var aD=r(Ad);Wv=i(aD,"FlaxDistilBertModel"),aD.forEach(t),Vh.forEach(t),Qp=d(s),Be=n(s,"DIV",{class:!0});var pt=r(Be);k(Vr.$$.fragment,pt),Rv=d(pt),Id=n(pt,"P",{});var iD=r(Id);Hv=i(iD,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iD.forEach(t),Qv=d(pt),Jr=n(pt,"P",{});var Jh=r(Jr);Uv=i(Jh,"This model inherits from "),Ri=n(Jh,"A",{href:!0});var lD=r(Ri);Vv=i(lD,"FlaxPreTrainedModel"),lD.forEach(t),Jv=i(Jh,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kh.forEach(t),Zv=d(pt),Nd=n(pt,"P",{});var cD=r(Nd);eb=i(cD,"Finally, this model supports inherent JAX features such as:"),cD.forEach(t),tb=d(pt),Bt=n(pt,"UL",{});var Uo=r(Bt);Ld=n(Uo,"LI",{});var pD=r(Ld);Xr=n(pD,"A",{href:!0,rel:!0});var hD=r(Xr);sb=i(hD,"Just-In-Time (JIT) compilation"),hD.forEach(t),pD.forEach(t),ob=d(Uo),Sd=n(Uo,"LI",{});var uD=r(Sd);Yr=n(uD,"A",{href:!0,rel:!0});var fD=r(Yr);nb=i(fD,"Automatic Differentiation"),fD.forEach(t),uD.forEach(t),rb=d(Uo),Od=n(Uo,"LI",{});var mD=r(Od);Zr=n(mD,"A",{href:!0,rel:!0});var gD=r(Zr);ab=i(gD,"Vectorization"),gD.forEach(t),mD.forEach(t),ib=d(Uo),Wd=n(Uo,"LI",{});var _D=r(Wd);ea=n(_D,"A",{href:!0,rel:!0});var vD=r(ea);lb=i(vD,"Parallelization"),vD.forEach(t),_D.forEach(t),Uo.forEach(t),db=d(pt),nt=n(pt,"DIV",{class:!0});var es=r(nt);k(ta.$$.fragment,es),cb=d(es),Is=n(es,"P",{});var cl=r(Is);pb=i(cl,"The "),Rd=n(cl,"CODE",{});var bD=r(Rd);hb=i(bD,"FlaxDistilBertPreTrainedModel"),bD.forEach(t),ub=i(cl,"forward method, overrides the "),Hd=n(cl,"CODE",{});var TD=r(Hd);fb=i(TD,"__call__"),TD.forEach(t),mb=i(cl," special method."),cl.forEach(t),gb=d(es),k(jo.$$.fragment,es),_b=d(es),Qd=n(es,"P",{});var kD=r(Qd);vb=i(kD,"Example:"),kD.forEach(t),bb=d(es),k(sa.$$.fragment,es),es.forEach(t),pt.forEach(t),Up=d(s),Ns=n(s,"H2",{class:!0});var Gh=r(Ns);Co=n(Gh,"A",{id:!0,class:!0,href:!0});var wD=r(Co);Ud=n(wD,"SPAN",{});var $D=r(Ud);k(oa.$$.fragment,$D),$D.forEach(t),wD.forEach(t),Tb=d(Gh),Vd=n(Gh,"SPAN",{});var DD=r(Vd);kb=i(DD,"FlaxDistilBertForMaskedLM"),DD.forEach(t),Gh.forEach(t),Vp=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(na.$$.fragment,ht),wb=d(ht),ra=n(ht,"P",{});var Xh=r(ra);$b=i(Xh,"DistilBert Model with a "),Jd=n(Xh,"CODE",{});var FD=r(Jd);Db=i(FD,"language modeling"),FD.forEach(t),Fb=i(Xh," head on top."),Xh.forEach(t),yb=d(ht),aa=n(ht,"P",{});var Yh=r(aa);Bb=i(Yh,"This model inherits from "),Hi=n(Yh,"A",{href:!0});var yD=r(Hi);Eb=i(yD,"FlaxPreTrainedModel"),yD.forEach(t),Mb=i(Yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yh.forEach(t),zb=d(ht),ia=n(ht,"P",{});var Zh=r(ia);xb=i(Zh,"This model is also a Flax Linen "),la=n(Zh,"A",{href:!0,rel:!0});var BD=r(la);jb=i(BD,"flax.linen.Module"),BD.forEach(t),Cb=i(Zh,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zh.forEach(t),Pb=d(ht),Kd=n(ht,"P",{});var ED=r(Kd);qb=i(ED,"Finally, this model supports inherent JAX features such as:"),ED.forEach(t),Ab=d(ht),Et=n(ht,"UL",{});var Vo=r(Et);Gd=n(Vo,"LI",{});var MD=r(Gd);da=n(MD,"A",{href:!0,rel:!0});var zD=r(da);Ib=i(zD,"Just-In-Time (JIT) compilation"),zD.forEach(t),MD.forEach(t),Nb=d(Vo),Xd=n(Vo,"LI",{});var xD=r(Xd);ca=n(xD,"A",{href:!0,rel:!0});var jD=r(ca);Lb=i(jD,"Automatic Differentiation"),jD.forEach(t),xD.forEach(t),Sb=d(Vo),Yd=n(Vo,"LI",{});var CD=r(Yd);pa=n(CD,"A",{href:!0,rel:!0});var PD=r(pa);Ob=i(PD,"Vectorization"),PD.forEach(t),CD.forEach(t),Wb=d(Vo),Zd=n(Vo,"LI",{});var qD=r(Zd);ha=n(qD,"A",{href:!0,rel:!0});var AD=r(ha);Rb=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Vo.forEach(t),Hb=d(ht),rt=n(ht,"DIV",{class:!0});var ts=r(rt);k(ua.$$.fragment,ts),Qb=d(ts),Ls=n(ts,"P",{});var pl=r(Ls);Ub=i(pl,"The "),ec=n(pl,"CODE",{});var ID=r(ec);Vb=i(ID,"FlaxDistilBertPreTrainedModel"),ID.forEach(t),Jb=i(pl,"forward method, overrides the "),tc=n(pl,"CODE",{});var ND=r(tc);Kb=i(ND,"__call__"),ND.forEach(t),Gb=i(pl," special method."),pl.forEach(t),Xb=d(ts),k(Po.$$.fragment,ts),Yb=d(ts),sc=n(ts,"P",{});var LD=r(sc);Zb=i(LD,"Example:"),LD.forEach(t),eT=d(ts),k(fa.$$.fragment,ts),ts.forEach(t),ht.forEach(t),Jp=d(s),Ss=n(s,"H2",{class:!0});var eu=r(Ss);qo=n(eu,"A",{id:!0,class:!0,href:!0});var SD=r(qo);oc=n(SD,"SPAN",{});var OD=r(oc);k(ma.$$.fragment,OD),OD.forEach(t),SD.forEach(t),tT=d(eu),nc=n(eu,"SPAN",{});var WD=r(nc);sT=i(WD,"FlaxDistilBertForSequenceClassification"),WD.forEach(t),eu.forEach(t),Kp=d(s),Me=n(s,"DIV",{class:!0});var ut=r(Me);k(ga.$$.fragment,ut),oT=d(ut),rc=n(ut,"P",{});var RD=r(rc);nT=i(RD,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
