...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15969/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15969/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15969/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15969/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15969/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),np=new y({}),{c(){w=o("meta"),M=u(),b=o("h1"),$=o("a"),ms=o("span"),f(F.$$.fragment),Nn=u(),_s=o("span"),vs=a("DeepSpeed Integration"),ht=u(),V=o("p"),Y=o("a"),Z=a("DeepSpeed"),yp=a(" implements everything described in the "),$e=o("a"),wp=a("ZeRO paper"),ZE=a(". Currently it provides full support for:"),pj=u(),D=o("ol"),Ch=o("li"),NE=a("Optimizer state partitioning (ZeRO stage 1)"),HE=u(),xh=o("li"),BE=a("Gradient partitioning (ZeRO stage 2)"),WE=u(),Rh=o("li"),FE=a("Parameter partitioning (ZeRO stage 3)"),VE=u(),Ih=o("li"),YE=a("Custom mixed precision training handling"),KE=u(),Uh=o("li"),JE=a("A range of fast CUDA-extension-based optimizers"),XE=u(),Gh=o("li"),QE=a("ZeRO-Offload to CPU and NVMe"),ij=u(),ke=o("p"),e5=a("ZeRO-Offload has its own dedicated paper: "),Hn=o("a"),s5=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),t5=a(". And NVMe-support is described in the paper "),Bn=o("a"),a5=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),n5=a("."),uj=u(),bp=o("p"),o5=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),cj=u(),qp=o("p"),l5=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),hj=u(),ft=o("p"),r5=a("\u{1F917} Transformers integrates "),Wn=o("a"),p5=a("DeepSpeed"),i5=a(" via 2 options:"),fj=u(),dt=o("ol"),Fn=o("li"),u5=a("Integration of the core DeepSpeed features via "),Ep=o("a"),c5=a("Trainer"),h5=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),f5=u(),L=o("li"),d5=a("If you don\u2019t use "),$p=o("a"),m5=a("Trainer"),_5=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Lh=o("code"),v5=a("from_pretrained"),j5=a(" and "),Mh=o("code"),g5=a("from_config"),y5=a(` include integration of essential
parts of DeepSpeed like `),Zh=o("code"),w5=a("zero.Init"),b5=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),kp=o("a"),q5=a("deepspeed-non-trainer-integration"),E5=a("."),dj=u(),Pp=o("p"),$5=a("What is integrated:"),mj=u(),zp=o("p"),k5=a("Training:"),_j=u(),Dp=o("ol"),Nh=o("li"),P5=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),vj=u(),Op=o("p"),z5=a("Inference:"),jj=u(),Tp=o("ol"),Vn=o("li"),D5=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Ap=o("a"),O5=a("deepspeed-zero-inference"),T5=a("."),gj=u(),Sp=o("p"),A5=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),yj=u(),Cp=o("a"),wj=u(),js=o("h2"),mt=o("a"),Hh=o("span"),f(Yn.$$.fragment),S5=u(),Bh=o("span"),C5=a("Trainer Deepspeed Integration"),bj=u(),xp=o("a"),qj=u(),gs=o("h3"),_t=o("a"),Wh=o("span"),f(Kn.$$.fragment),x5=u(),Fh=o("span"),R5=a("Installation"),Ej=u(),Rp=o("p"),I5=a("Install the library via pypi:"),$j=u(),f(Jn.$$.fragment),kj=u(),Pe=o("p"),U5=a("or via "),Vh=o("code"),G5=a("transformers"),L5=a("\u2019 "),Yh=o("code"),M5=a("extras"),Z5=a(":"),Pj=u(),f(Xn.$$.fragment),zj=u(),ze=o("p"),N5=a("or find more details on "),Qn=o("a"),H5=a("the DeepSpeed\u2019s GitHub page"),B5=a(` and
`),eo=o("a"),W5=a("advanced install"),F5=a("."),Dj=u(),vt=o("p"),V5=a("If you\u2019re still struggling with the build, first make sure to read "),Ip=o("a"),Y5=a("zero-install-notes"),K5=a("."),Oj=u(),Up=o("p"),J5=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Tj=u(),Gp=o("p"),X5=a("To make a local build for DeepSpeed:"),Aj=u(),f(so.$$.fragment),Sj=u(),De=o("p"),Q5=a("If you intend to use NVMe offload you will also need to include "),Kh=o("code"),e6=a("DS_BUILD_AIO=1"),s6=a(` in the instructions above (and also
install `),Jh=o("em"),t6=a("libaio-dev"),a6=a(" system-wide)."),Cj=u(),jt=o("p"),n6=a("Edit "),Xh=o("code"),o6=a("TORCH_CUDA_ARCH_LIST"),l6=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),xj=u(),f(to.$$.fragment),Rj=u(),ge=o("p"),r6=a("So if you get "),Qh=o("code"),p6=a("8, 6"),i6=a(", then use "),ef=o("code"),u6=a('TORCH_CUDA_ARCH_LIST="8.6"'),c6=a(`. If you have multiple different cards, you can list all
of them like so `),sf=o("code"),h6=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Ij=u(),Lp=o("p"),f6=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Uj=u(),f(ao.$$.fragment),Gj=u(),Oe=o("p"),d6=a("it will generate something like "),tf=o("code"),m6=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_6=a(` which now you can install
as `),af=o("code"),v6=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),j6=a(" locally or on any other machine."),Lj=u(),gt=o("p"),g6=a("Again, remember to ensure to adjust "),nf=o("code"),y6=a("TORCH_CUDA_ARCH_LIST"),w6=a(" to the target architectures."),Mj=u(),Te=o("p"),b6=a("You can find the complete list of NVIDIA GPUs and their corresponding "),of=o("strong"),q6=a("Compute Capabilities"),E6=a(` (same as arch in this
context) `),no=o("a"),$6=a("here"),k6=a("."),Zj=u(),Mp=o("p"),P6=a("You can check the archs pytorch was built with using:"),Nj=u(),f(oo.$$.fragment),Hj=u(),Zp=o("p"),z6=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Bj=u(),f(lo.$$.fragment),Wj=u(),Np=o("p"),D6=a("If the output is:"),Fj=u(),f(ro.$$.fragment),Vj=u(),yt=o("p"),O6=a("then you know that this card\u2019s arch is "),lf=o("code"),T6=a("8.6"),A6=a("."),Yj=u(),wt=o("p"),S6=a("You can also leave "),rf=o("code"),C6=a("TORCH_CUDA_ARCH_LIST"),x6=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Kj=u(),bt=o("p"),R6=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),po=o("a"),I6=a("Deepspeed"),U6=a(","),Jj=u(),Hp=o("a"),Xj=u(),ys=o("h3"),qt=o("a"),pf=o("span"),f(io.$$.fragment),G6=u(),uf=o("span"),L6=a("Deployment with multiple GPUs"),Qj=u(),Et=o("p"),M6=a("To deploy this feature with multiple GPUs adjust the "),Bp=o("a"),Z6=a("Trainer"),N6=a(` command line arguments as
following:`),eg=u(),$t=o("ol"),ws=o("li"),H6=a("replace "),cf=o("code"),B6=a("python -m torch.distributed.launch"),W6=a(" with "),hf=o("code"),F6=a("deepspeed"),V6=a("."),Y6=u(),ye=o("li"),K6=a("add a new argument "),ff=o("code"),J6=a("--deepspeed ds_config.json"),X6=a(", where "),df=o("code"),Q6=a("ds_config.json"),e$=a(` is the DeepSpeed configuration file as
documented `),uo=o("a"),s$=a("here"),t$=a(". The file naming is up to you."),sg=u(),Wp=o("p"),a$=a("Therefore, if your original command line looked as follows:"),tg=u(),f(co.$$.fragment),ag=u(),Fp=o("p"),n$=a("Now it should be:"),ng=u(),f(ho.$$.fragment),og=u(),O=o("p"),o$=a("Unlike, "),mf=o("code"),l$=a("torch.distributed.launch"),r$=a(" where you have to specify how many GPUs to use with "),_f=o("code"),p$=a("--nproc_per_node"),i$=a(`, with the
`),vf=o("code"),u$=a("deepspeed"),c$=a(" launcher you don\u2019t have to use the corresponding "),jf=o("code"),h$=a("--num_gpus"),f$=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),fo=o("a"),d$=a("here"),m$=a("."),lg=u(),J=o("p"),_$=a("In fact, you can continue using "),gf=o("code"),v$=a("-m torch.distributed.launch"),j$=a(` with DeepSpeed as long as you don\u2019t need to use
`),yf=o("code"),g$=a("deepspeed"),y$=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),wf=o("code"),w$=a("deepspeed"),b$=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),rg=u(),kt=o("p"),q$=a("Here is an example of running "),bf=o("code"),E$=a("run_translation.py"),$$=a(" under DeepSpeed deploying all available GPUs:"),pg=u(),f(mo.$$.fragment),ig=u(),Pt=o("p"),k$=a("Note that in the DeepSpeed documentation you are likely to see "),qf=o("code"),P$=a("--deepspeed --deepspeed_config ds_config.json"),z$=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),ug=u(),zt=o("p"),D$=a("For some practical usage examples, please, see this "),_o=o("a"),O$=a("post"),T$=a("."),cg=u(),Vp=o("a"),hg=u(),bs=o("h3"),Dt=o("a"),Ef=o("span"),f(vo.$$.fragment),A$=u(),$f=o("span"),S$=a("Deployment with one GPU"),fg=u(),Ot=o("p"),C$=a("To deploy DeepSpeed with one GPU adjust the "),Yp=o("a"),x$=a("Trainer"),R$=a(" command line arguments as follows:"),dg=u(),f(jo.$$.fragment),mg=u(),Ae=o("p"),I$=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),kf=o("code"),U$=a("--num_gpus=1"),G$=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),go=o("a"),L$=a("documentation"),M$=a(" discusses the launcher options."),_g=u(),Kp=o("p"),Z$=a("Why would you want to use DeepSpeed with just one GPU?"),vg=u(),Tt=o("ol"),Pf=o("li"),N$=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),H$=u(),zf=o("li"),B$=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),jg=u(),Jp=o("p"),W$=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),gg=u(),f(yo.$$.fragment),yg=u(),Xp=o("p"),F$=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),wg=u(),At=o("p"),V$=a("For a practical usage example of this type of deployment, please, see this "),wo=o("a"),Y$=a("post"),K$=a("."),bg=u(),Qp=o("p"),J$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),qg=u(),ei=o("p"),X$=a("Notes:"),Eg=u(),si=o("ul"),qs=o("li"),bo=o("p"),Q$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=o("code"),e4=a("CUDA_VISIBLE_DEVICES"),s4=a(` to limit
...
to the console, so you can see exactly what was the final configuration passed to it.`),Xg=u(),ui=o("a"),Qg=u(),ks=o("h3"),Ht=o("a"),Bf=o("span"),f(Ro.$$.fragment),Q4=u(),Wf=o("span"),e9=a("Passing Configuration"),ey=u(),T=o("p"),s9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ci=o("a"),t9=a("Trainer"),a9=a(" via "),hi=o("a"),n9=a("TrainingArguments"),o9=a(" then for the "),Ff=o("code"),l9=a("deepspeed"),r9=a(` argument you can
pass a nested `),Vf=o("code"),p9=a("dict"),i9=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),fi=o("a"),u9=a("TrainingArguments"),c9=a("."),sy=u(),di=o("p"),h9=a("To summarize you can do:"),ty=u(),f(Io.$$.fragment),ay=u(),mi=o("p"),f9=a("or:"),ny=u(),f(Uo.$$.fragment),oy=u(),_i=o("a"),ly=u(),Ps=o("h3"),Bt=o("a"),Yf=o("span"),f(Go.$$.fragment),d9=u(),Kf=o("span"),m9=a("Shared Configuration"),ry=u(),f(Wt.$$.fragment),py=u(),Ce=o("p"),_9=a("Some configuration values are required by both the "),vi=o("a"),v9=a("Trainer"),j9=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),ji=o("a"),g9=a("Trainer"),y9=a(" command line arguments."),iy=u(),Ft=o("p"),w9=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),gi=o("a"),b9=a("Trainer"),q9=a(` do the majority
of configuration for you.`),uy=u(),xe=o("p"),E9=a("Therefore, in the rest of this guide you will find a special configuration value: "),Jf=o("code"),$9=a("auto"),k9=a(`, which when set will be
...
`),yi=o("a"),P9=a("Trainer"),z9=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),cy=u(),wi=o("p"),D9=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),hy=u(),Vt=o("p"),O9=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),bi=o("a"),T9=a("TrainingArguments"),A9=a(" based on that. The steps are:"),fy=u(),Yt=o("ol"),Xf=o("li"),S9=a("Create or load the DeepSpeed configuration to be used as a master configuration"),C9=u(),Lo=o("li"),x9=a("Create the "),qi=o("a"),R9=a("TrainingArguments"),I9=a(" object based on these values"),dy=u(),Q=o("p"),U9=a("Do note that some values, such as "),Qf=o("code"),G9=a("scheduler.params.total_num_steps"),L9=a(` are calculated by
`),Ei=o("a"),M9=a("Trainer"),Z9=a(" during "),ed=o("code"),N9=a("train"),H9=a(", but you can of course do the math yourself."),my=u(),$i=o("a"),_y=u(),zs=o("h3"),Kt=o("a"),sd=o("span"),f(Mo.$$.fragment),B9=u(),td=o("span"),W9=a("ZeRO"),vy=u(),Zo=o("p"),No=o("a"),F9=a("Zero Redundancy Optimizer (ZeRO)"),V9=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),jy=u(),Re=o("p"),Y9=a("The "),ad=o("code"),K9=a("zero_optimization"),J9=a(" section of the configuration file is the most important part ("),Ho=o("a"),X9=a("docs"),Q9=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gy=u(),Jt=o("p"),e8=a("This section has to be configured exclusively via DeepSpeed configuration - the "),ki=o("a"),s8=a("Trainer"),t8=a(` provides
no equivalent command line arguments.`),yy=u(),Pi=o("p"),a8=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),wy=u(),zi=o("a"),by=u(),Ds=o("h4"),Xt=o("a"),nd=o("span"),f(Bo.$$.fragment),n8=u(),od=o("span"),o8=a("ZeRO-2 Config"),qy=u(),Di=o("p"),l8=a("The following is an example of configuration for ZeRO stage 2:"),Ey=u(),f(Wo.$$.fragment),$y=u(),Oi=o("p"),ld=o("strong"),r8=a("Performance tuning:"),ky=u(),Ie=o("ul"),Os=o("li"),p8=a("enabling "),rd=o("code"),i8=a("offload_optimizer"),u8=a(" should reduce GPU RAM usage (it requires "),pd=o("code"),c8=a('"stage": 2'),h8=a(")"),f8=u(),A=o("li"),id=o("code"),d8=a('"overlap_comm": true'),m8=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),ud=o("code"),_8=a("overlap_comm"),v8=a(` uses 4.5x
the `),cd=o("code"),j8=a("allgather_bucket_size"),g8=a(" and "),hd=o("code"),y8=a("reduce_bucket_size"),w8=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),fd=o("code"),b8=a("5e8 x 2Bytes x 2 x 4.5"),q8=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),dd=o("code"),E8=a("2e8"),$8=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),k8=u(),md=o("li"),P8=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),Py=u(),Ue=o("p"),z8=a("Additionally, "),_d=o("code"),D8=a("deepspeed==0.4.4"),O8=a(" added a new option "),vd=o("code"),T8=a("round_robin_gradients"),A8=a(" which you can enable with:"),zy=u(),f(Fo.$$.fragment),Dy=u(),Ti=o("p"),S8=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Oy=u(),Ai=o("a"),Ty=u(),Ts=o("h4"),Qt=o("a"),jd=o("span"),f(Vo.$$.fragment),C8=u(),gd=o("span"),x8=a("ZeRO-3 Config"),Ay=u(),Si=o("p"),R8=a("The following is an example of configuration for ZeRO stage 3:"),Sy=u(),f(Yo.$$.fragment),Cy=u(),N=o("p"),I8=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),yd=o("code"),U8=a('"device": "cpu"'),G8=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),wd=o("code"),L8=a("none"),M8=a(" instead of "),bd=o("code"),Z8=a("cpu"),N8=a(" for the "),qd=o("code"),H8=a("device"),B8=a(` entry. Offloading to
NVMe is discussed further down.`),xy=u(),Ge=o("p"),W8=a("Pinned memory is enabled with "),Ed=o("code"),F8=a("pin_memory"),V8=a(" set to "),$d=o("code"),Y8=a("true"),K8=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Ry=u(),Ci=o("p"),kd=o("strong"),J8=a("Performance tuning:"),Iy=u(),ea=o("ul"),Ko=o("li"),Pd=o("code"),X8=a("stage3_max_live_parameters"),Q8=a(": "),zd=o("code"),e7=a("1e9"),s7=u(),Jo=o("li"),Dd=o("code"),t7=a("stage3_max_reuse_distance"),a7=a(": "),Od=o("code"),n7=a("1e9"),Uy=u(),S=o("p"),o7=a("If hitting OOM reduce "),Td=o("code"),l7=a("stage3_max_live_parameters"),r7=a(" and "),Ad=o("code"),p7=a("stage3_max_reuse_distance"),i7=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Sd=o("code"),u7=a("1e9"),c7=a(` would consume ~2GB. The memory is shared by
`),Cd=o("code"),h7=a("stage3_max_live_parameters"),f7=a(" and "),xd=o("code"),d7=a("stage3_max_reuse_distance"),m7=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Gy=u(),we=o("p"),Rd=o("code"),_7=a("stage3_max_live_parameters"),v7=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Id=o("code"),j7=a("stage3_max_reuse_distance"),g7=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Ud=o("code"),y7=a("stage3_max_reuse_distance"),w7=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ly=u(),xi=o("p"),b7=a("The following configuration values depend on the model\u2019s hidden size:"),My=u(),Le=o("ul"),Xo=o("li"),Gd=o("code"),q7=a("reduce_bucket_size"),E7=a(": "),Ld=o("code"),$7=a("hidden_size*hidden_size"),k7=u(),Qo=o("li"),Md=o("code"),P7=a("stage3_prefetch_bucket_size"),z7=a(": "),Zd=o("code"),D7=a("0.9 * hidden_size * hidden_size"),O7=u(),el=o("li"),Nd=o("code"),T7=a("stage3_param_persistence_threshold"),A7=a(": "),Hd=o("code"),S7=a("10 * hidden_size"),Zy=u(),Me=o("p"),C7=a("therefore set these values to "),Bd=o("code"),x7=a("auto"),R7=a(" and the "),Ri=o("a"),I7=a("Trainer"),U7=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),Ny=u(),sl=o("p"),Wd=o("code"),G7=a("stage3_gather_fp16_weights_on_model_save"),L7=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Hy=u(),ee=o("p"),M7=a("If you\u2019re migrating from ZeRO-2 configuration note that "),Fd=o("code"),Z7=a("allgather_partitions"),N7=a(", "),Vd=o("code"),H7=a("allgather_bucket_size"),B7=a(` and
`),Yd=o("code"),W7=a("reduce_scatter"),F7=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),By=u(),Ii=o("ul"),tl=o("li"),Kd=o("code"),V7=a("sub_group_size"),Y7=a(": "),Jd=o("code"),K7=a("1e9"),Wy=u(),be=o("p"),Xd=o("code"),J7=a("sub_group_size"),X7=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),Qd=o("code"),Q7=a("sub_group_size"),ek=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),em=o("code"),sk=a("sub_group_size"),tk=a(` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Fy=u(),Ze=o("p"),ak=a("You can leave "),sm=o("code"),nk=a("sub_group_size"),ok=a(" to its default value of "),tm=o("em"),lk=a("1e9"),rk=a(` when not using NVMe offload. You may want to change its
default value in the following cases:`),Vy=u(),sa=o("ol"),al=o("li"),pk=a("Running into OOM during optimizer step: Reduce "),am=o("code"),ik=a("sub_group_size"),uk=a(" to reduce memory utilization of temporary buffers"),ck=u(),nl=o("li"),hk=a("Optimizer Step is taking a long time: Increase "),nm=o("code"),fk=a("sub_group_size"),dk=a(` to improve bandwidth utilization as a result of
the increased data buffers.`),Yy=u(),Ui=o("a"),Ky=u(),As=o("h3"),ta=o("a"),om=o("span"),f(ol.$$.fragment),mk=u(),lm=o("span"),_k=a("NVMe Support"),Jy=u(),Gi=o("p"),vk=a(`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
...
process. ZeRO-Infinity requires ZeRO-3 enabled.`),Xy=u(),Li=o("p"),jk=a("The following configuration example enables NVMe to offload both optimizer states and the params:"),Qy=u(),f(ll.$$.fragment),ew=u(),aa=o("p"),gk=a(`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),rm=o("em"),yk=a("\u201Cdevice\u201D: \u201Ccpu\u201D"),wk=a(")."),sw=u(),Ne=o("p"),bk=a("Here is the full documentation for offloading "),rl=o("a"),qk=a("optimizer states"),Ek=a(" and "),pl=o("a"),$k=a("parameters"),kk=a("."),tw=u(),na=o("p"),Pk=a("Make sure that your "),pm=o("code"),zk=a("nvme_path"),Dk=a(` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),aw=u(),He=o("p"),Ok=a("In order to figure out the optimal "),im=o("code"),Tk=a("aio"),Ak=a(` configuration block you must run a benchmark on your target setup, as
`),il=o("a"),Sk=a("explained here"),Ck=a("."),nw=u(),Mi=o("a"),ow=u(),Ss=o("h4"),oa=o("a"),um=o("span"),f(ul.$$.fragment),xk=u(),cm=o("span"),Rk=a("ZeRO-2 vs ZeRO-3 Performance"),lw=u(),Zi=o("p"),Ik=a(`ZeRO-3 is likely to be slower than ZeRO-2 if everything else is configured the same because the former has to gather
...
at a cost of speed.`),rw=u(),Ni=o("p"),Uk=a("It\u2019s possible to adjust ZeRO-3 configuration to make it perform closer to ZeRO-2:"),pw=u(),la=o("ul"),Cs=o("li"),Gk=a("set "),hm=o("code"),Lk=a("stage3_param_persistence_threshold"),Mk=a(" to a very large number - larger than the largest parameter, e.g., "),fm=o("code"),Zk=a("6 * hidden_size * hidden_size"),Nk=a(". This will keep the parameters on the GPUs."),Hk=u(),cl=o("li"),Bk=a("turn off "),dm=o("code"),Wk=a("offload_params"),Fk=a(" since ZeRO-2 doesn\u2019t have that option."),iw=u(),Be=o("p"),Vk=a("The performance will likely improve significantly with just "),mm=o("code"),Yk=a("offload_params"),Kk=a(` turned off, even if you don\u2019t change
`),_m=o("code"),Jk=a("stage3_param_persistence_threshold"),Xk=a(`. Of course, these changes will impact the size of the model you can train. So
these help you to trade scalability for speed depending on your needs.`),uw=u(),Hi=o("a"),cw=u(),xs=o("h4"),ra=o("a"),vm=o("span"),f(hl.$$.fragment),Qk=u(),jm=o("span"),eP=a("ZeRO-2 Example"),hw=u(),pa=o("p"),sP=a("Here is a full ZeRO-2 auto-configuration file "),gm=o("code"),tP=a("ds_config_zero2.json"),aP=a(":"),fw=u(),f(fl.$$.fragment),dw=u(),ia=o("p"),nP=a(`Here is a full ZeRO-2 all-enabled manually set configuration file. It is here mainly for you to see what the typical
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),hp=o("a"),NI=a("DeepSpeed GitHub"),HI=a("."),this.h()},l(e){const p=FV('[data-svelte="svelte-1phssyn"]',document.head);w=l(p,"META",{name:!0,content:!0}),p.forEach(t),M=c(e),b=l(e,"H1",{class:!0});var fp=r(b);$=l(fp,"A",{id:!0,class:!0,href:!0});var tj=r($);ms=l(tj,"SPAN",{});var KI=r(ms);d(F.$$.fragment,KI),KI.forEach(t),tj.forEach(t),Nn=c(fp),_s=l(fp,"SPAN",{});var JI=r(_s);vs=n(JI,"DeepSpeed Integration"),JI.forEach(t),fp.forEach(t),ht=c(e),V=l(e,"P",{});var aj=r(V);Y=l(aj,"A",{href:!0,rel:!0});var XI=r(Y);Z=n(XI,"DeepSpeed"),XI.forEach(t),yp=n(aj," implements everything described in the "),$e=l(aj,"A",{href:!0,rel:!0});var QI=r($e);wp=n(QI,"ZeRO paper"),QI.forEach(t),ZE=n(aj,". Currently it provides full support for:"),aj.forEach(t),pj=c(e),D=l(e,"OL",{});var ue=r(D);Ch=l(ue,"LI",{});var eU=r(Ch);NE=n(eU,"Optimizer state partitioning (ZeRO stage 1)"),eU.forEach(t),HE=c(ue),xh=l(ue,"LI",{});var sU=r(xh);BE=n(sU,"Gradient partitioning (ZeRO stage 2)"),sU.forEach(t),WE=c(ue),Rh=l(ue,"LI",{});var tU=r(Rh);FE=n(tU,"Parameter partitioning (ZeRO stage 3)"),tU.forEach(t),VE=c(ue),Ih=l(ue,"LI",{});var aU=r(Ih);YE=n(aU,"Custom mixed precision training handling"),aU.forEach(t),KE=c(ue),Uh=l(ue,"LI",{});var nU=r(Uh);JE=n(nU,"A range of fast CUDA-extension-based optimizers"),nU.forEach(t),XE=c(ue),Gh=l(ue,"LI",{});var oU=r(Gh);QE=n(oU,"ZeRO-Offload to CPU and NVMe"),oU.forEach(t),ue.forEach(t),ij=c(e),ke=l(e,"P",{});var Zc=r(ke);e5=n(Zc,"ZeRO-Offload has its own dedicated paper: "),Hn=l(Zc,"A",{href:!0,rel:!0});var lU=r(Hn);s5=n(lU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),lU.forEach(t),t5=n(Zc,". And NVMe-support is described in the paper "),Bn=l(Zc,"A",{href:!0,rel:!0});var rU=r(Bn);a5=n(rU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),rU.forEach(t),n5=n(Zc,"."),Zc.forEach(t),uj=c(e),bp=l(e,"P",{});var pU=r(bp);o5=n(pU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),pU.forEach(t),cj=c(e),qp=l(e,"P",{});var iU=r(qp);l5=n(iU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),iU.forEach(t),hj=c(e),ft=l(e,"P",{});var i0=r(ft);r5=n(i0,"\u{1F917} Transformers integrates "),Wn=l(i0,"A",{href:!0,rel:!0});var uU=r(Wn);p5=n(uU,"DeepSpeed"),uU.forEach(t),i5=n(i0," via 2 options:"),i0.forEach(t),fj=c(e),dt=l(e,"OL",{});var u0=r(dt);Fn=l(u0,"LI",{});var c0=r(Fn);u5=n(c0,"Integration of the core DeepSpeed features via "),Ep=l(c0,"A",{href:!0});var cU=r(Ep);c5=n(cU,"Trainer"),cU.forEach(t),h5=n(c0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),c0.forEach(t),f5=c(u0),L=l(u0,"LI",{});var ce=r(L);d5=n(ce,"If you don\u2019t use "),$p=l(ce,"A",{href:!0});var hU=r($p);m5=n(hU,"Trainer"),hU.forEach(t),_5=n(ce,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Lh=l(ce,"CODE",{});var fU=r(Lh);v5=n(fU,"from_pretrained"),fU.forEach(t),j5=n(ce," and "),Mh=l(ce,"CODE",{});var dU=r(Mh);g5=n(dU,"from_config"),dU.forEach(t),y5=n(ce,` include integration of essential
parts of DeepSpeed like `),Zh=l(ce,"CODE",{});var mU=r(Zh);w5=n(mU,"zero.Init"),mU.forEach(t),b5=n(ce,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),kp=l(ce,"A",{href:!0});var _U=r(kp);q5=n(_U,"deepspeed-non-trainer-integration"),_U.forEach(t),E5=n(ce,"."),ce.forEach(t),u0.forEach(t),dj=c(e),Pp=l(e,"P",{});var vU=r(Pp);$5=n(vU,"What is integrated:"),vU.forEach(t),mj=c(e),zp=l(e,"P",{});var jU=r(zp);k5=n(jU,"Training:"),jU.forEach(t),_j=c(e),Dp=l(e,"OL",{});var gU=r(Dp);Nh=l(gU,"LI",{});var yU=r(Nh);P5=n(yU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),yU.forEach(t),gU.forEach(t),vj=c(e),Op=l(e,"P",{});var wU=r(Op);z5=n(wU,"Inference:"),wU.forEach(t),jj=c(e),Tp=l(e,"OL",{});var bU=r(Tp);Vn=l(bU,"LI",{});var h0=r(Vn);D5=n(h0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Ap=l(h0,"A",{href:!0});var qU=r(Ap);O5=n(qU,"deepspeed-zero-inference"),qU.forEach(t),T5=n(h0,"."),h0.forEach(t),bU.forEach(t),gj=c(e),Sp=l(e,"P",{});var EU=r(Sp);A5=n(EU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),EU.forEach(t),yj=c(e),Cp=l(e,"A",{id:!0}),r(Cp).forEach(t),wj=c(e),js=l(e,"H2",{class:!0});var f0=r(js);mt=l(f0,"A",{id:!0,class:!0,href:!0});var $U=r(mt);Hh=l($U,"SPAN",{});var kU=r(Hh);d(Yn.$$.fragment,kU),kU.forEach(t),$U.forEach(t),S5=c(f0),Bh=l(f0,"SPAN",{});var PU=r(Bh);C5=n(PU,"Trainer Deepspeed Integration"),PU.forEach(t),f0.forEach(t),bj=c(e),xp=l(e,"A",{id:!0}),r(xp).forEach(t),qj=c(e),gs=l(e,"H3",{class:!0});var d0=r(gs);_t=l(d0,"A",{id:!0,class:!0,href:!0});var zU=r(_t);Wh=l(zU,"SPAN",{});var DU=r(Wh);d(Kn.$$.fragment,DU),DU.forEach(t),zU.forEach(t),x5=c(d0),Fh=l(d0,"SPAN",{});var OU=r(Fh);R5=n(OU,"Installation"),OU.forEach(t),d0.forEach(t),Ej=c(e),Rp=l(e,"P",{});var TU=r(Rp);I5=n(TU,"Install the library via pypi:"),TU.forEach(t),$j=c(e),d(Jn.$$.fragment,e),kj=c(e),Pe=l(e,"P",{});var Nc=r(Pe);U5=n(Nc,"or via "),Vh=l(Nc,"CODE",{});var AU=r(Vh);G5=n(AU,"transformers"),AU.forEach(t),L5=n(Nc,"\u2019 "),Yh=l(Nc,"CODE",{});var SU=r(Yh);M5=n(SU,"extras"),SU.forEach(t),Z5=n(Nc,":"),Nc.forEach(t),Pj=c(e),d(Xn.$$.fragment,e),zj=c(e),ze=l(e,"P",{});var Hc=r(ze);N5=n(Hc,"or find more details on "),Qn=l(Hc,"A",{href:!0,rel:!0});var CU=r(Qn);H5=n(CU,"the DeepSpeed\u2019s GitHub page"),CU.forEach(t),B5=n(Hc,` and
`),eo=l(Hc,"A",{href:!0,rel:!0});var xU=r(eo);W5=n(xU,"advanced install"),xU.forEach(t),F5=n(Hc,"."),Hc.forEach(t),Dj=c(e),vt=l(e,"P",{});var m0=r(vt);V5=n(m0,"If you\u2019re still struggling with the build, first make sure to read "),Ip=l(m0,"A",{href:!0});var RU=r(Ip);Y5=n(RU,"zero-install-notes"),RU.forEach(t),K5=n(m0,"."),m0.forEach(t),Oj=c(e),Up=l(e,"P",{});var IU=r(Up);J5=n(IU,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),IU.forEach(t),Tj=c(e),Gp=l(e,"P",{});var UU=r(Gp);X5=n(UU,"To make a local build for DeepSpeed:"),UU.forEach(t),Aj=c(e),d(so.$$.fragment,e),Sj=c(e),De=l(e,"P",{});var Bc=r(De);Q5=n(Bc,"If you intend to use NVMe offload you will also need to include "),Kh=l(Bc,"CODE",{});var GU=r(Kh);e6=n(GU,"DS_BUILD_AIO=1"),GU.forEach(t),s6=n(Bc,` in the instructions above (and also
install `),Jh=l(Bc,"EM",{});var LU=r(Jh);t6=n(LU,"libaio-dev"),LU.forEach(t),a6=n(Bc," system-wide)."),Bc.forEach(t),Cj=c(e),jt=l(e,"P",{});var _0=r(jt);n6=n(_0,"Edit "),Xh=l(_0,"CODE",{});var MU=r(Xh);o6=n(MU,"TORCH_CUDA_ARCH_LIST"),MU.forEach(t),l6=n(_0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_0.forEach(t),xj=c(e),d(to.$$.fragment,e),Rj=c(e),ge=l(e,"P",{});var dp=r(ge);r6=n(dp,"So if you get "),Qh=l(dp,"CODE",{});var ZU=r(Qh);p6=n(ZU,"8, 6"),ZU.forEach(t),i6=n(dp,", then use "),ef=l(dp,"CODE",{});var NU=r(ef);u6=n(NU,'TORCH_CUDA_ARCH_LIST="8.6"'),NU.forEach(t),c6=n(dp,`. If you have multiple different cards, you can list all
of them like so `),sf=l(dp,"CODE",{});var HU=r(sf);h6=n(HU,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),HU.forEach(t),dp.forEach(t),Ij=c(e),Lp=l(e,"P",{});var BU=r(Lp);f6=n(BU,"If you need to use the same setup on multiple machines, make a binary wheel:"),BU.forEach(t),Uj=c(e),d(ao.$$.fragment,e),Gj=c(e),Oe=l(e,"P",{});var Wc=r(Oe);d6=n(Wc,"it will generate something like "),tf=l(Wc,"CODE",{});var WU=r(tf);m6=n(WU,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),WU.forEach(t),_6=n(Wc,` which now you can install
as `),af=l(Wc,"CODE",{});var FU=r(af);v6=n(FU,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),FU.forEach(t),j6=n(Wc," locally or on any other machine."),Wc.forEach(t),Lj=c(e),gt=l(e,"P",{});var v0=r(gt);g6=n(v0,"Again, remember to ensure to adjust "),nf=l(v0,"CODE",{});var VU=r(nf);y6=n(VU,"TORCH_CUDA_ARCH_LIST"),VU.forEach(t),w6=n(v0," to the target architectures."),v0.forEach(t),Mj=c(e),Te=l(e,"P",{});var Fc=r(Te);b6=n(Fc,"You can find the complete list of NVIDIA GPUs and their corresponding "),of=l(Fc,"STRONG",{});var YU=r(of);q6=n(YU,"Compute Capabilities"),YU.forEach(t),E6=n(Fc,` (same as arch in this
context) `),no=l(Fc,"A",{href:!0,rel:!0});var KU=r(no);$6=n(KU,"here"),KU.forEach(t),k6=n(Fc,"."),Fc.forEach(t),Zj=c(e),Mp=l(e,"P",{});var JU=r(Mp);P6=n(JU,"You can check the archs pytorch was built with using:"),JU.forEach(t),Nj=c(e),d(oo.$$.fragment,e),Hj=c(e),Zp=l(e,"P",{});var XU=r(Zp);z6=n(XU,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),XU.forEach(t),Bj=c(e),d(lo.$$.fragment,e),Wj=c(e),Np=l(e,"P",{});var QU=r(Np);D6=n(QU,"If the output is:"),QU.forEach(t),Fj=c(e),d(ro.$$.fragment,e),Vj=c(e),yt=l(e,"P",{});var j0=r(yt);O6=n(j0,"then you know that this card\u2019s arch is "),lf=l(j0,"CODE",{});var eG=r(lf);T6=n(eG,"8.6"),eG.forEach(t),A6=n(j0,"."),j0.forEach(t),Yj=c(e),wt=l(e,"P",{});var g0=r(wt);S6=n(g0,"You can also leave "),rf=l(g0,"CODE",{});var sG=r(rf);C6=n(sG,"TORCH_CUDA_ARCH_LIST"),sG.forEach(t),x6=n(g0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),g0.forEach(t),Kj=c(e),bt=l(e,"P",{});var y0=r(bt);R6=n(y0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),po=l(y0,"A",{href:!0,rel:!0});var tG=r(po);I6=n(tG,"Deepspeed"),tG.forEach(t),U6=n(y0,","),y0.forEach(t),Jj=c(e),Hp=l(e,"A",{id:!0}),r(Hp).forEach(t),Xj=c(e),ys=l(e,"H3",{class:!0});var w0=r(ys);qt=l(w0,"A",{id:!0,class:!0,href:!0});var aG=r(qt);pf=l(aG,"SPAN",{});var nG=r(pf);d(io.$$.fragment,nG),nG.forEach(t),aG.forEach(t),G6=c(w0),uf=l(w0,"SPAN",{});var oG=r(uf);L6=n(oG,"Deployment with multiple GPUs"),oG.forEach(t),w0.forEach(t),Qj=c(e),Et=l(e,"P",{});var b0=r(Et);M6=n(b0,"To deploy this feature with multiple GPUs adjust the "),Bp=l(b0,"A",{href:!0});var lG=r(Bp);Z6=n(lG,"Trainer"),lG.forEach(t),N6=n(b0,` command line arguments as
following:`),b0.forEach(t),eg=c(e),$t=l(e,"OL",{});var q0=r($t);ws=l(q0,"LI",{});var Vc=r(ws);H6=n(Vc,"replace "),cf=l(Vc,"CODE",{});var rG=r(cf);B6=n(rG,"python -m torch.distributed.launch"),rG.forEach(t),W6=n(Vc," with "),hf=l(Vc,"CODE",{});var pG=r(hf);F6=n(pG,"deepspeed"),pG.forEach(t),V6=n(Vc,"."),Vc.forEach(t),Y6=c(q0),ye=l(q0,"LI",{});var Pn=r(ye);K6=n(Pn,"add a new argument "),ff=l(Pn,"CODE",{});var iG=r(ff);J6=n(iG,"--deepspeed ds_config.json"),iG.forEach(t),X6=n(Pn,", where "),df=l(Pn,"CODE",{});var uG=r(df);Q6=n(uG,"ds_config.json"),uG.forEach(t),e$=n(Pn,` is the DeepSpeed configuration file as
documented `),uo=l(Pn,"A",{href:!0,rel:!0});var cG=r(uo);s$=n(cG,"here"),cG.forEach(t),t$=n(Pn,". The file naming is up to you."),Pn.forEach(t),q0.forEach(t),sg=c(e),Wp=l(e,"P",{});var hG=r(Wp);a$=n(hG,"Therefore, if your original command line looked as follows:"),hG.forEach(t),tg=c(e),d(co.$$.fragment,e),ag=c(e),Fp=l(e,"P",{});var fG=r(Fp);n$=n(fG,"Now it should be:"),fG.forEach(t),ng=c(e),d(ho.$$.fragment,e),og=c(e),O=l(e,"P",{});var he=r(O);o$=n(he,"Unlike, "),mf=l(he,"CODE",{});var dG=r(mf);l$=n(dG,"torch.distributed.launch"),dG.forEach(t),r$=n(he," where you have to specify how many GPUs to use with "),_f=l(he,"CODE",{});var mG=r(_f);p$=n(mG,"--nproc_per_node"),mG.forEach(t),i$=n(he,`, with the
`),vf=l(he,"CODE",{});var _G=r(vf);u$=n(_G,"deepspeed"),_G.forEach(t),c$=n(he," launcher you don\u2019t have to use the corresponding "),jf=l(he,"CODE",{});var vG=r(jf);h$=n(vG,"--num_gpus"),vG.forEach(t),f$=n(he,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),fo=l(he,"A",{href:!0,rel:!0});var jG=r(fo);d$=n(jG,"here"),jG.forEach(t),m$=n(he,"."),he.forEach(t),lg=c(e),J=l(e,"P",{});var zn=r(J);_$=n(zn,"In fact, you can continue using "),gf=l(zn,"CODE",{});var gG=r(gf);v$=n(gG,"-m torch.distributed.launch"),gG.forEach(t),j$=n(zn,` with DeepSpeed as long as you don\u2019t need to use
`),yf=l(zn,"CODE",{});var yG=r(yf);g$=n(yG,"deepspeed"),yG.forEach(t),y$=n(zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),wf=l(zn,"CODE",{});var wG=r(wf);w$=n(wG,"deepspeed"),wG.forEach(t),b$=n(zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),zn.forEach(t),rg=c(e),kt=l(e,"P",{});var E0=r(kt);q$=n(E0,"Here is an example of running "),bf=l(E0,"CODE",{});var bG=r(bf);E$=n(bG,"run_translation.py"),bG.forEach(t),$$=n(E0," under DeepSpeed deploying all available GPUs:"),E0.forEach(t),pg=c(e),d(mo.$$.fragment,e),ig=c(e),Pt=l(e,"P",{});var $0=r(Pt);k$=n($0,"Note that in the DeepSpeed documentation you are likely to see "),qf=l($0,"CODE",{});var qG=r(qf);P$=n(qG,"--deepspeed --deepspeed_config ds_config.json"),qG.forEach(t),z$=n($0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),$0.forEach(t),ug=c(e),zt=l(e,"P",{});var k0=r(zt);D$=n(k0,"For some practical usage examples, please, see this "),_o=l(k0,"A",{href:!0,rel:!0});var EG=r(_o);O$=n(EG,"post"),EG.forEach(t),T$=n(k0,"."),k0.forEach(t),cg=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),hg=c(e),bs=l(e,"H3",{class:!0});var P0=r(bs);Dt=l(P0,"A",{id:!0,class:!0,href:!0});var $G=r(Dt);Ef=l($G,"SPAN",{});var kG=r(Ef);d(vo.$$.fragment,kG),kG.forEach(t),$G.forEach(t),A$=c(P0),$f=l(P0,"SPAN",{});var PG=r($f);S$=n(PG,"Deployment with one GPU"),PG.forEach(t),P0.forEach(t),fg=c(e),Ot=l(e,"P",{});var z0=r(Ot);C$=n(z0,"To deploy DeepSpeed with one GPU adjust the "),Yp=l(z0,"A",{href:!0});var zG=r(Yp);x$=n(zG,"Trainer"),zG.forEach(t),R$=n(z0," command line arguments as follows:"),z0.forEach(t),dg=c(e),d(jo.$$.fragment,e),mg=c(e),Ae=l(e,"P",{});var Yc=r(Ae);I$=n(Yc,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),kf=l(Yc,"CODE",{});var DG=r(kf);U$=n(DG,"--num_gpus=1"),DG.forEach(t),G$=n(Yc,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),go=l(Yc,"A",{href:!0,rel:!0});var OG=r(go);L$=n(OG,"documentation"),OG.forEach(t),M$=n(Yc," discusses the launcher options."),Yc.forEach(t),_g=c(e),Kp=l(e,"P",{});var TG=r(Kp);Z$=n(TG,"Why would you want to use DeepSpeed with just one GPU?"),TG.forEach(t),vg=c(e),Tt=l(e,"OL",{});var D0=r(Tt);Pf=l(D0,"LI",{});var AG=r(Pf);N$=n(AG,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),AG.forEach(t),H$=c(D0),zf=l(D0,"LI",{});var SG=r(zf);B$=n(SG,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),SG.forEach(t),D0.forEach(t),jg=c(e),Jp=l(e,"P",{});var CG=r(Jp);W$=n(CG,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),CG.forEach(t),gg=c(e),d(yo.$$.fragment,e),yg=c(e),Xp=l(e,"P",{});var xG=r(Xp);F$=n(xG,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),xG.forEach(t),wg=c(e),At=l(e,"P",{});var O0=r(At);V$=n(O0,"For a practical usage example of this type of deployment, please, see this "),wo=l(O0,"A",{href:!0,rel:!0});var RG=r(wo);Y$=n(RG,"post"),RG.forEach(t),K$=n(O0,"."),O0.forEach(t),bg=c(e),Qp=l(e,"P",{});var IG=r(Qp);J$=n(IG,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),IG.forEach(t),qg=c(e),ei=l(e,"P",{});var UG=r(ei);X$=n(UG,"Notes:"),UG.forEach(t),Eg=c(e),si=l(e,"UL",{});var GG=r(si);qs=l(GG,"LI",{});var Kc=r(qs);bo=l(Kc,"P",{});var T0=r(bo);Q$=n(T0,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=l(T0,"CODE",{});var LG=r(Df);e4=n(LG,"CUDA_VISIBLE_DEVICES"),LG.forEach(t),s4=n(T0,` to limit
...
to the console, so you can see exactly what was the final configuration passed to it.`),Z0.forEach(t),Xg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Qg=c(e),ks=l(e,"H3",{class:!0});var N0=r(ks);Ht=l(N0,"A",{id:!0,class:!0,href:!0});var fL=r(Ht);Bf=l(fL,"SPAN",{});var dL=r(Bf);d(Ro.$$.fragment,dL),dL.forEach(t),fL.forEach(t),Q4=c(N0),Wf=l(N0,"SPAN",{});var mL=r(Wf);e9=n(mL,"Passing Configuration"),mL.forEach(t),N0.forEach(t),ey=c(e),T=l(e,"P",{});var fe=r(T);s9=n(fe,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ci=l(fe,"A",{href:!0});var _L=r(ci);t9=n(_L,"Trainer"),_L.forEach(t),a9=n(fe," via "),hi=l(fe,"A",{href:!0});var vL=r(hi);n9=n(vL,"TrainingArguments"),vL.forEach(t),o9=n(fe," then for the "),Ff=l(fe,"CODE",{});var jL=r(Ff);l9=n(jL,"deepspeed"),jL.forEach(t),r9=n(fe,` argument you can
pass a nested `),Vf=l(fe,"CODE",{});var gL=r(Vf);p9=n(gL,"dict"),gL.forEach(t),i9=n(fe,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),fi=l(fe,"A",{href:!0});var yL=r(fi);u9=n(yL,"TrainingArguments"),yL.forEach(t),c9=n(fe,"."),fe.forEach(t),sy=c(e),di=l(e,"P",{});var wL=r(di);h9=n(wL,"To summarize you can do:"),wL.forEach(t),ty=c(e),d(Io.$$.fragment,e),ay=c(e),mi=l(e,"P",{});var bL=r(mi);f9=n(bL,"or:"),bL.forEach(t),ny=c(e),d(Uo.$$.fragment,e),oy=c(e),_i=l(e,"A",{id:!0}),r(_i).forEach(t),ly=c(e),Ps=l(e,"H3",{class:!0});var H0=r(Ps);Bt=l(H0,"A",{id:!0,class:!0,href:!0});var qL=r(Bt);Yf=l(qL,"SPAN",{});var EL=r(Yf);d(Go.$$.fragment,EL),EL.forEach(t),qL.forEach(t),d9=c(H0),Kf=l(H0,"SPAN",{});var $L=r(Kf);m9=n($L,"Shared Configuration"),$L.forEach(t),H0.forEach(t),ry=c(e),d(Wt.$$.fragment,e),py=c(e),Ce=l(e,"P",{});var Xc=r(Ce);_9=n(Xc,"Some configuration values are required by both the "),vi=l(Xc,"A",{href:!0});var kL=r(vi);v9=n(kL,"Trainer"),kL.forEach(t),j9=n(Xc,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),ji=l(Xc,"A",{href:!0});var PL=r(ji);g9=n(PL,"Trainer"),PL.forEach(t),y9=n(Xc," command line arguments."),Xc.forEach(t),iy=c(e),Ft=l(e,"P",{});var B0=r(Ft);w9=n(B0,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),gi=l(B0,"A",{href:!0});var zL=r(gi);b9=n(zL,"Trainer"),zL.forEach(t),q9=n(B0,` do the majority
of configuration for you.`),B0.forEach(t),uy=c(e),xe=l(e,"P",{});var Qc=r(xe);E9=n(Qc,"Therefore, in the rest of this guide you will find a special configuration value: "),Jf=l(Qc,"CODE",{});var DL=r(Jf);$9=n(DL,"auto"),DL.forEach(t),k9=n(Qc,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),yi=l(Qc,"A",{href:!0});var OL=r(yi);P9=n(OL,"Trainer"),OL.forEach(t),z9=n(Qc,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),Qc.forEach(t),cy=c(e),wi=l(e,"P",{});var TL=r(wi);D9=n(TL,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),TL.forEach(t),hy=c(e),Vt=l(e,"P",{});var W0=r(Vt);O9=n(W0,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),bi=l(W0,"A",{href:!0});var AL=r(bi);T9=n(AL,"TrainingArguments"),AL.forEach(t),A9=n(W0," based on that. The steps are:"),W0.forEach(t),fy=c(e),Yt=l(e,"OL",{});var F0=r(Yt);Xf=l(F0,"LI",{});var SL=r(Xf);S9=n(SL,"Create or load the DeepSpeed configuration to be used as a master configuration"),SL.forEach(t),C9=c(F0),Lo=l(F0,"LI",{});var V0=r(Lo);x9=n(V0,"Create the "),qi=l(V0,"A",{href:!0});var CL=r(qi);R9=n(CL,"TrainingArguments"),CL.forEach(t),I9=n(V0," object based on these values"),V0.forEach(t),F0.forEach(t),dy=c(e),Q=l(e,"P",{});var On=r(Q);U9=n(On,"Do note that some values, such as "),Qf=l(On,"CODE",{});var xL=r(Qf);G9=n(xL,"scheduler.params.total_num_steps"),xL.forEach(t),L9=n(On,` are calculated by
`),Ei=l(On,"A",{href:!0});var RL=r(Ei);M9=n(RL,"Trainer"),RL.forEach(t),Z9=n(On," during "),ed=l(On,"CODE",{});var IL=r(ed);N9=n(IL,"train"),IL.forEach(t),H9=n(On,", but you can of course do the math yourself."),On.forEach(t),my=c(e),$i=l(e,"A",{id:!0}),r($i).forEach(t),_y=c(e),zs=l(e,"H3",{class:!0});var Y0=r(zs);Kt=l(Y0,"A",{id:!0,class:!0,href:!0});var UL=r(Kt);sd=l(UL,"SPAN",{});var GL=r(sd);d(Mo.$$.fragment,GL),GL.forEach(t),UL.forEach(t),B9=c(Y0),td=l(Y0,"SPAN",{});var LL=r(td);W9=n(LL,"ZeRO"),LL.forEach(t),Y0.forEach(t),vy=c(e),Zo=l(e,"P",{});var BI=r(Zo);No=l(BI,"A",{href:!0,rel:!0});var ML=r(No);F9=n(ML,"Zero Redundancy Optimizer (ZeRO)"),ML.forEach(t),V9=n(BI,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),BI.forEach(t),jy=c(e),Re=l(e,"P",{});var eh=r(Re);Y9=n(eh,"The "),ad=l(eh,"CODE",{});var ZL=r(ad);K9=n(ZL,"zero_optimization"),ZL.forEach(t),J9=n(eh," section of the configuration file is the most important part ("),Ho=l(eh,"A",{href:!0,rel:!0});var NL=r(Ho);X9=n(NL,"docs"),NL.forEach(t),Q9=n(eh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),eh.forEach(t),gy=c(e),Jt=l(e,"P",{});var K0=r(Jt);e8=n(K0,"This section has to be configured exclusively via DeepSpeed configuration - the "),ki=l(K0,"A",{href:!0});var HL=r(ki);s8=n(HL,"Trainer"),HL.forEach(t),t8=n(K0,` provides
no equivalent command line arguments.`),K0.forEach(t),yy=c(e),Pi=l(e,"P",{});var BL=r(Pi);a8=n(BL,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),BL.forEach(t),wy=c(e),zi=l(e,"A",{id:!0}),r(zi).forEach(t),by=c(e),Ds=l(e,"H4",{class:!0});var J0=r(Ds);Xt=l(J0,"A",{id:!0,class:!0,href:!0});var WL=r(Xt);nd=l(WL,"SPAN",{});var FL=r(nd);d(Bo.$$.fragment,FL),FL.forEach(t),WL.forEach(t),n8=c(J0),od=l(J0,"SPAN",{});var VL=r(od);o8=n(VL,"ZeRO-2 Config"),VL.forEach(t),J0.forEach(t),qy=c(e),Di=l(e,"P",{});var YL=r(Di);l8=n(YL,"The following is an example of configuration for ZeRO stage 2:"),YL.forEach(t),Ey=c(e),d(Wo.$$.fragment,e),$y=c(e),Oi=l(e,"P",{});var KL=r(Oi);ld=l(KL,"STRONG",{});var JL=r(ld);r8=n(JL,"Performance tuning:"),JL.forEach(t),KL.forEach(t),ky=c(e),Ie=l(e,"UL",{});var sh=r(Ie);Os=l(sh,"LI",{});var th=r(Os);p8=n(th,"enabling "),rd=l(th,"CODE",{});var XL=r(rd);i8=n(XL,"offload_optimizer"),XL.forEach(t),u8=n(th," should reduce GPU RAM usage (it requires "),pd=l(th,"CODE",{});var QL=r(pd);c8=n(QL,'"stage": 2'),QL.forEach(t),h8=n(th,")"),th.forEach(t),f8=c(sh),A=l(sh,"LI",{});var K=r(A);id=l(K,"CODE",{});var eM=r(id);d8=n(eM,'"overlap_comm": true'),eM.forEach(t),m8=n(K," trades off increased GPU RAM usage to lower all-reduce latency. "),ud=l(K,"CODE",{});var sM=r(ud);_8=n(sM,"overlap_comm"),sM.forEach(t),v8=n(K,` uses 4.5x
the `),cd=l(K,"CODE",{});var tM=r(cd);j8=n(tM,"allgather_bucket_size"),tM.forEach(t),g8=n(K," and "),hd=l(K,"CODE",{});var aM=r(hd);y8=n(aM,"reduce_bucket_size"),aM.forEach(t),w8=n(K,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),fd=l(K,"CODE",{});var nM=r(fd);b8=n(nM,"5e8 x 2Bytes x 2 x 4.5"),nM.forEach(t),q8=n(K,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),dd=l(K,"CODE",{});var oM=r(dd);E8=n(oM,"2e8"),oM.forEach(t),$8=n(K,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),K.forEach(t),k8=c(sh),md=l(sh,"LI",{});var lM=r(md);P8=n(lM,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),lM.forEach(t),sh.forEach(t),Py=c(e),Ue=l(e,"P",{});var ah=r(Ue);z8=n(ah,"Additionally, "),_d=l(ah,"CODE",{});var rM=r(_d);D8=n(rM,"deepspeed==0.4.4"),rM.forEach(t),O8=n(ah," added a new option "),vd=l(ah,"CODE",{});var pM=r(vd);T8=n(pM,"round_robin_gradients"),pM.forEach(t),A8=n(ah," which you can enable with:"),ah.forEach(t),zy=c(e),d(Fo.$$.fragment,e),Dy=c(e),Ti=l(e,"P",{});var iM=r(Ti);S8=n(iM,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),iM.forEach(t),Oy=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Ty=c(e),Ts=l(e,"H4",{class:!0});var X0=r(Ts);Qt=l(X0,"A",{id:!0,class:!0,href:!0});var uM=r(Qt);jd=l(uM,"SPAN",{});var cM=r(jd);d(Vo.$$.fragment,cM),cM.forEach(t),uM.forEach(t),C8=c(X0),gd=l(X0,"SPAN",{});var hM=r(gd);x8=n(hM,"ZeRO-3 Config"),hM.forEach(t),X0.forEach(t),Ay=c(e),Si=l(e,"P",{});var fM=r(Si);R8=n(fM,"The following is an example of configuration for ZeRO stage 3:"),fM.forEach(t),Sy=c(e),d(Yo.$$.fragment,e),Cy=c(e),N=l(e,"P",{});var hs=r(N);I8=n(hs,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),yd=l(hs,"CODE",{});var dM=r(yd);U8=n(dM,'"device": "cpu"'),dM.forEach(t),G8=n(hs,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),wd=l(hs,"CODE",{});var mM=r(wd);L8=n(mM,"none"),mM.forEach(t),M8=n(hs," instead of "),bd=l(hs,"CODE",{});var _M=r(bd);Z8=n(_M,"cpu"),_M.forEach(t),N8=n(hs," for the "),qd=l(hs,"CODE",{});var vM=r(qd);H8=n(vM,"device"),vM.forEach(t),B8=n(hs,` entry. Offloading to
NVMe is discussed further down.`),hs.forEach(t),xy=c(e),Ge=l(e,"P",{});var nh=r(Ge);W8=n(nh,"Pinned memory is enabled with "),Ed=l(nh,"CODE",{});var jM=r(Ed);F8=n(jM,"pin_memory"),jM.forEach(t),V8=n(nh," set to "),$d=l(nh,"CODE",{});var gM=r($d);Y8=n(gM,"true"),gM.forEach(t),K8=n(nh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),nh.forEach(t),Ry=c(e),Ci=l(e,"P",{});var yM=r(Ci);kd=l(yM,"STRONG",{});var wM=r(kd);J8=n(wM,"Performance tuning:"),wM.forEach(t),yM.forEach(t),Iy=c(e),ea=l(e,"UL",{});var Q0=r(ea);Ko=l(Q0,"LI",{});var eq=r(Ko);Pd=l(eq,"CODE",{});var bM=r(Pd);X8=n(bM,"stage3_max_live_parameters"),bM.forEach(t),Q8=n(eq,": "),zd=l(eq,"CODE",{});var qM=r(zd);e7=n(qM,"1e9"),qM.forEach(t),eq.forEach(t),s7=c(Q0),Jo=l(Q0,"LI",{});var sq=r(Jo);Dd=l(sq,"CODE",{});var EM=r(Dd);t7=n(EM,"stage3_max_reuse_distance"),EM.forEach(t),a7=n(sq,": "),Od=l(sq,"CODE",{});var $M=r(Od);n7=n($M,"1e9"),$M.forEach(t),sq.forEach(t),Q0.forEach(t),Uy=c(e),S=l(e,"P",{});var de=r(S);o7=n(de,"If hitting OOM reduce "),Td=l(de,"CODE",{});var kM=r(Td);l7=n(kM,"stage3_max_live_parameters"),kM.forEach(t),r7=n(de," and "),Ad=l(de,"CODE",{});var PM=r(Ad);p7=n(PM,"stage3_max_reuse_distance"),PM.forEach(t),i7=n(de,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Sd=l(de,"CODE",{});var zM=r(Sd);u7=n(zM,"1e9"),zM.forEach(t),c7=n(de,` would consume ~2GB. The memory is shared by
`),Cd=l(de,"CODE",{});var DM=r(Cd);h7=n(DM,"stage3_max_live_parameters"),DM.forEach(t),f7=n(de," and "),xd=l(de,"CODE",{});var OM=r(xd);d7=n(OM,"stage3_max_reuse_distance"),OM.forEach(t),m7=n(de,", so it\u2019s not additive, it\u2019s just 2GB total."),de.forEach(t),Gy=c(e),we=l(e,"P",{});var mp=r(we);Rd=l(mp,"CODE",{});var TM=r(Rd);_7=n(TM,"stage3_max_live_parameters"),TM.forEach(t),v7=n(mp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Id=l(mp,"CODE",{});var AM=r(Id);j7=n(AM,"stage3_max_reuse_distance"),AM.forEach(t),g7=n(mp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Ud=l(mp,"CODE",{});var SM=r(Ud);y7=n(SM,"stage3_max_reuse_distance"),SM.forEach(t),w7=n(mp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),mp.forEach(t),Ly=c(e),xi=l(e,"P",{});var CM=r(xi);b7=n(CM,"The following configuration values depend on the model\u2019s hidden size:"),CM.forEach(t),My=c(e),Le=l(e,"UL",{});var oh=r(Le);Xo=l(oh,"LI",{});var tq=r(Xo);Gd=l(tq,"CODE",{});var xM=r(Gd);q7=n(xM,"reduce_bucket_size"),xM.forEach(t),E7=n(tq,": "),Ld=l(tq,"CODE",{});var RM=r(Ld);$7=n(RM,"hidden_size*hidden_size"),RM.forEach(t),tq.forEach(t),k7=c(oh),Qo=l(oh,"LI",{});var aq=r(Qo);Md=l(aq,"CODE",{});var IM=r(Md);P7=n(IM,"stage3_prefetch_bucket_size"),IM.forEach(t),z7=n(aq,": "),Zd=l(aq,"CODE",{});var UM=r(Zd);D7=n(UM,"0.9 * hidden_size * hidden_size"),UM.forEach(t),aq.forEach(t),O7=c(oh),el=l(oh,"LI",{});var nq=r(el);Nd=l(nq,"CODE",{});var GM=r(Nd);T7=n(GM,"stage3_param_persistence_threshold"),GM.forEach(t),A7=n(nq,": "),Hd=l(nq,"CODE",{});var LM=r(Hd);S7=n(LM,"10 * hidden_size"),LM.forEach(t),nq.forEach(t),oh.forEach(t),Zy=c(e),Me=l(e,"P",{});var lh=r(Me);C7=n(lh,"therefore set these values to "),Bd=l(lh,"CODE",{});var MM=r(Bd);x7=n(MM,"auto"),MM.forEach(t),R7=n(lh," and the "),Ri=l(lh,"A",{href:!0});var ZM=r(Ri);I7=n(ZM,"Trainer"),ZM.forEach(t),U7=n(lh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),lh.forEach(t),Ny=c(e),sl=l(e,"P",{});var WI=r(sl);Wd=l(WI,"CODE",{});var NM=r(Wd);G7=n(NM,"stage3_gather_fp16_weights_on_model_save"),NM.forEach(t),L7=n(WI,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),WI.forEach(t),Hy=c(e),ee=l(e,"P",{});var Tn=r(ee);M7=n(Tn,"If you\u2019re migrating from ZeRO-2 configuration note that "),Fd=l(Tn,"CODE",{});var HM=r(Fd);Z7=n(HM,"allgather_partitions"),HM.forEach(t),N7=n(Tn,", "),Vd=l(Tn,"CODE",{});var BM=r(Vd);H7=n(BM,"allgather_bucket_size"),BM.forEach(t),B7=n(Tn,` and
`),Yd=l(Tn,"CODE",{});var WM=r(Yd);W7=n(WM,"reduce_scatter"),WM.forEach(t),F7=n(Tn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Tn.forEach(t),By=c(e),Ii=l(e,"UL",{});var FM=r(Ii);tl=l(FM,"LI",{});var oq=r(tl);Kd=l(oq,"CODE",{});var VM=r(Kd);V7=n(VM,"sub_group_size"),VM.forEach(t),Y7=n(oq,": "),Jd=l(oq,"CODE",{});var YM=r(Jd);K7=n(YM,"1e9"),YM.forEach(t),oq.forEach(t),FM.forEach(t),Wy=c(e),be=l(e,"P",{});var _p=r(be);Xd=l(_p,"CODE",{});var KM=r(Xd);J7=n(KM,"sub_group_size"),KM.forEach(t),X7=n(_p,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),Qd=l(_p,"CODE",{});var JM=r(Qd);Q7=n(JM,"sub_group_size"),JM.forEach(t),ek=n(_p,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),em=l(_p,"CODE",{});var XM=r(em);sk=n(XM,"sub_group_size"),XM.forEach(t),tk=n(_p,` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),_p.forEach(t),Fy=c(e),Ze=l(e,"P",{});var rh=r(Ze);ak=n(rh,"You can leave "),sm=l(rh,"CODE",{});var QM=r(sm);nk=n(QM,"sub_group_size"),QM.forEach(t),ok=n(rh," to its default value of "),tm=l(rh,"EM",{});var eZ=r(tm);lk=n(eZ,"1e9"),eZ.forEach(t),rk=n(rh,` when not using NVMe offload. You may want to change its
default value in the following cases:`),rh.forEach(t),Vy=c(e),sa=l(e,"OL",{});var lq=r(sa);al=l(lq,"LI",{});var rq=r(al);pk=n(rq,"Running into OOM during optimizer step: Reduce "),am=l(rq,"CODE",{});var sZ=r(am);ik=n(sZ,"sub_group_size"),sZ.forEach(t),uk=n(rq," to reduce memory utilization of temporary buffers"),rq.forEach(t),ck=c(lq),nl=l(lq,"LI",{});var pq=r(nl);hk=n(pq,"Optimizer Step is taking a long time: Increase "),nm=l(pq,"CODE",{});var tZ=r(nm);fk=n(tZ,"sub_group_size"),tZ.forEach(t),dk=n(pq,` to improve bandwidth utilization as a result of
the increased data buffers.`),pq.forEach(t),lq.forEach(t),Yy=c(e),Ui=l(e,"A",{id:!0}),r(Ui).forEach(t),Ky=c(e),As=l(e,"H3",{class:!0});var iq=r(As);ta=l(iq,"A",{id:!0,class:!0,href:!0});var aZ=r(ta);om=l(aZ,"SPAN",{});var nZ=r(om);d(ol.$$.fragment,nZ),nZ.forEach(t),aZ.forEach(t),mk=c(iq),lm=l(iq,"SPAN",{});var oZ=r(lm);_k=n(oZ,"NVMe Support"),oZ.forEach(t),iq.forEach(t),Jy=c(e),Gi=l(e,"P",{});var lZ=r(Gi);vk=n(lZ,`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
smart partitioning and tiling algorithms each GPU needs to send and receive very small amounts of data during
offloading so modern NVMe proved to be fit to allow for an even larger total memory pool available to your training
process. ZeRO-Infinity requires ZeRO-3 enabled.`),lZ.forEach(t),Xy=c(e),Li=l(e,"P",{});var rZ=r(Li);jk=n(rZ,"The following configuration example enables NVMe to offload both optimizer states and the params:"),rZ.forEach(t),Qy=c(e),d(ll.$$.fragment,e),ew=c(e),aa=l(e,"P",{});var uq=r(aa);gk=n(uq,`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),rm=l(uq,"EM",{});var pZ=r(rm);yk=n(pZ,"\u201Cdevice\u201D: \u201Ccpu\u201D"),pZ.forEach(t),wk=n(uq,")."),uq.forEach(t),sw=c(e),Ne=l(e,"P",{});var ph=r(Ne);bk=n(ph,"Here is the full documentation for offloading "),rl=l(ph,"A",{href:!0,rel:!0});var iZ=r(rl);qk=n(iZ,"optimizer states"),iZ.forEach(t),Ek=n(ph," and "),pl=l(ph,"A",{href:!0,rel:!0});var uZ=r(pl);$k=n(uZ,"parameters"),uZ.forEach(t),kk=n(ph,"."),ph.forEach(t),tw=c(e),na=l(e,"P",{});var cq=r(na);Pk=n(cq,"Make sure that your "),pm=l(cq,"CODE",{});var cZ=r(pm);zk=n(cZ,"nvme_path"),cZ.forEach(t),Dk=n(cq,` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),cq.forEach(t),aw=c(e),He=l(e,"P",{});var ih=r(He);Ok=n(ih,"In order to figure out the optimal "),im=l(ih,"CODE",{});var hZ=r(im);Tk=n(hZ,"aio"),hZ.forEach(t),Ak=n(ih,` configuration block you must run a benchmark on your target setup, as
`),il=l(ih,"A",{href:!0,rel:!0});var fZ=r(il);Sk=n(fZ,"explained here"),fZ.forEach(t),Ck=n(ih,"."),ih.forEach(t),nw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),ow=c(e),Ss=l(e,"H4",{class:!0});var hq=r(Ss);oa=l(hq,"A",{id:!0,class:!0,href:!0});var dZ=r(oa);um=l(dZ,"SPAN",{});var mZ=r(um);d(ul.$$.fragment,mZ),mZ.forEach(t),dZ.forEach(t),xk=c(hq),cm=l(hq,"SPAN",{});var _Z=r(cm);Rk=n(_Z,"ZeRO-2 vs ZeRO-3 Performance"),_Z.forEach(t),hq.forEach(t),lw=c(e),Zi=l(e,"P",{});var vZ=r(Zi);Ik=n(vZ,`ZeRO-3 is likely to be slower than ZeRO-2 if everything else is configured the same because the former has to gather
model weights in addition to what ZeRO-2 does. If ZeRO-2 meets your needs and you don\u2019t need to scale beyond a few GPUs
then you may choose to stick to it. It\u2019s important to understand that ZeRO-3 enables a much higher scalability capacity
at a cost of speed.`),vZ.forEach(t),rw=c(e),Ni=l(e,"P",{});var jZ=r(Ni);Uk=n(jZ,"It\u2019s possible to adjust ZeRO-3 configuration to make it perform closer to ZeRO-2:"),jZ.forEach(t),pw=c(e),la=l(e,"UL",{});var fq=r(la);Cs=l(fq,"LI",{});var uh=r(Cs);Gk=n(uh,"set "),hm=l(uh,"CODE",{});var gZ=r(hm);Lk=n(gZ,"stage3_param_persistence_threshold"),gZ.forEach(t),Mk=n(uh," to a very large number - larger than the largest parameter, e.g., "),fm=l(uh,"CODE",{});var yZ=r(fm);Zk=n(yZ,"6 * hidden_size * hidden_size"),yZ.forEach(t),Nk=n(uh,". This will keep the parameters on the GPUs."),uh.forEach(t),Hk=c(fq),cl=l(fq,"LI",{});var dq=r(cl);Bk=n(dq,"turn off "),dm=l(dq,"CODE",{});var wZ=r(dm);Wk=n(wZ,"offload_params"),wZ.forEach(t),Fk=n(dq," since ZeRO-2 doesn\u2019t have that option."),dq.forEach(t),fq.forEach(t),iw=c(e),Be=l(e,"P",{});var ch=r(Be);Vk=n(ch,"The performance will likely improve significantly with just "),mm=l(ch,"CODE",{});var bZ=r(mm);Yk=n(bZ,"offload_params"),bZ.forEach(t),Kk=n(ch,` turned off, even if you don\u2019t change
`),_m=l(ch,"CODE",{});var qZ=r(_m);Jk=n(qZ,"stage3_param_persistence_threshold"),qZ.forEach(t),Xk=n(ch,`. Of course, these changes will impact the size of the model you can train. So
these help you to trade scalability for speed depending on your needs.`),ch.forEach(t),uw=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),cw=c(e),xs=l(e,"H4",{class:!0});var mq=r(xs);ra=l(mq,"A",{id:!0,class:!0,href:!0});var EZ=r(ra);vm=l(EZ,"SPAN",{});var $Z=r(vm);d(hl.$$.fragment,$Z),$Z.forEach(t),EZ.forEach(t),Qk=c(mq),jm=l(mq,"SPAN",{});var kZ=r(jm);eP=n(kZ,"ZeRO-2 Example"),kZ.forEach(t),mq.forEach(t),hw=c(e),pa=l(e,"P",{});var _q=r(pa);sP=n(_q,"Here is a full ZeRO-2 auto-configuration file "),gm=l(_q,"CODE",{});var PZ=r(gm);tP=n(PZ,"ds_config_zero2.json"),PZ.forEach(t),aP=n(_q,":"),_q.forEach(t),fw=c(e),d(fl.$$.fragment,e),dw=c(e),ia=l(e,"P",{});var vq=r(ia);nP=n(vq,`Here is a full ZeRO-2 all-enabled manually set configuration file. It is here mainly for you to see what the typical
