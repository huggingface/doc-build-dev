import{S as Es,i as Ss,s as Ws,e as n,k as c,w as _,t as r,M as Ts,c as a,d as o,m as d,a as s,x as v,h as i,b as l,F as e,g as f,y as w,q as b,o as y,B as E,v as ks}from"../../chunks/vendor-6b77c823.js";import{T as ka}from"../../chunks/Tip-39098574.js";import{D as Je}from"../../chunks/Docstring-af1d0ae0.js";import{C as ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ht}from"../../chunks/IconCopyLink-7a11ce68.js";function Cs(X){let m,k,h,S,W;return{c(){m=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),S=r("Module"),W=r(`
...
instance of <a href="/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWForCTC">SEWForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWForCTC">SEWForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16755/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWConfig"
...
<p>A <a
  href="/docs/transformers/pr_16755/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<span class="hljs-number">0.42</span>`}}),Ae=new ht({}),De=new Je({props:{name:"class transformers.SEWForSequenceClassification",anchor:"transformers.SEWForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16755/src/transformers/models/sew/modeling_sew.py#L1100",parametersDescription:[{anchor:"transformers.SEWForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWConfig">SEWConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16755/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ke=new Je({props:{name:"forward",anchor:"transformers.SEWForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16755/src/transformers/models/sew/modeling_sew.py#L1145",parametersDescription:[{anchor:"transformers.SEWForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16755/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),ce=new ka({props:{$$slots:{default:[js]},$$scope:{ctx:X}}}),He=new ft({props:{code:`from transformers import Wav2Vec2FeatureExtractor, SEWForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">9.52</span>`}}),{c(){m=n("meta"),k=c(),h=n("h1"),S=n("a"),W=n("span"),_(u.$$.fragment),g=c(),P=n("span"),vo=r("SEW"),Ot=c(),I=n("h2"),Z=n("a"),ut=n("span"),_(de.$$.fragment),wo=c(),gt=n("span"),bo=r("Overview"),Vt=c(),ee=n("p"),yo=r("SEW (Squeezed and Efficient Wav2Vec) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training
for Speech Recognition`),So=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q.
Weinberger, Yoav Artzi.`),Lt=c(),Qe=n("p"),Wo=r("The abstract from the paper is the following:"),It=c(),Be=n("p"),_t=n("em"),To=r(`This paper is a study of performance-efficiency trade-offs in pre-trained models for automatic speech recognition
(ASR). We focus on wav2vec 2.0, and formalize several architecture designs that influence both the model performance
and its efficiency. Putting together all our observations, we introduce SEW (Squeezed and Efficient Wav2vec), a
pre-trained model architecture with significant improvements along both performance and efficiency dimensions across a
variety of training setups. For example, under the 100h-960h semi-supervised setup on LibriSpeech, SEW achieves a 1.9x
inference speedup compared to wav2vec 2.0, with a 13.5% relative reduction in word error rate. With a similar inference
time, SEW reduces word error rate by 25-50% across different model sizes.`),Nt=c(),Ye=n("p"),ko=r("Tips:"),Kt=c(),te=n("ul"),vt=n("li"),Co=r("SEW is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),$o=c(),me=n("li"),jo=r(`SEWForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded using
`),Ge=n("a"),qo=r("Wav2Vec2CTCTokenizer"),xo=r("."),Ht=c(),oe=n("p"),Po=r("This model was contributed by "),fe=n("a"),Fo=r("anton-l"),Mo=r("."),Rt=c(),N=n("h2"),ne=n("a"),wt=n("span"),_(he.$$.fragment),zo=c(),bt=n("span"),Ao=r("SEWConfig"),Ut=c(),j=n("div"),_(ue.$$.fragment),Do=c(),K=n("p"),Oo=r("This is the configuration class to store the configuration of a "),Xe=n("a"),Vo=r("SEWModel"),Lo=r(`. It is used to instantiate a SEW model
...
documentation from `),et=n("a"),Jo=r("PretrainedConfig"),Qo=r(" for more information."),Bo=c(),yt=n("p"),Yo=r("Example:"),Go=c(),_(_e.$$.fragment),Jt=c(),R=n("h2"),ae=n("a"),Et=n("span"),_(ve.$$.fragment),Xo=c(),St=n("span"),Zo=r("SEWModel"),Qt=c(),q=n("div"),_(we.$$.fragment),en=c(),be=n("p"),tn=r(`The bare SEW Model transformer outputting raw hidden-states without any specific head on top.
...
Yoav Artzi.`),an=c(),Ee=n("p"),sn=r("This model inherits from "),tt=n("a"),rn=r("PreTrainedModel"),ln=r(`. Check the superclass documentation for the generic methods the
...
behavior.`),fn=c(),F=n("div"),_(Te.$$.fragment),hn=c(),U=n("p"),un=r("The "),ot=n("a"),gn=r("SEWModel"),_n=r(" forward method, overrides the "),Wt=n("code"),vn=r("__call__"),wn=r(" special method."),bn=c(),_(se.$$.fragment),yn=c(),Tt=n("p"),En=r("Example:"),Sn=c(),_(ke.$$.fragment),Bt=c(),J=n("h2"),re=n("a"),kt=n("span"),_(Ce.$$.fragment),Wn=c(),Ct=n("span"),Tn=r("SEWForCTC"),Yt=c(),x=n("div"),_($e.$$.fragment),kn=c(),Q=n("p"),Cn=r("SEW Model with a "),$t=n("code"),$n=r("language modeling"),jn=r(` head on top for Connectionist Temporal Classification (CTC).
...
library implements for all its model (such as downloading or saving etc.).`),An=c(),xe=n("p"),Dn=r("This model is a PyTorch "),Pe=n("a"),On=r("torch.nn.Module"),Vn=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ln=c(),C=n("div"),_(Fe.$$.fragment),In=c(),B=n("p"),Nn=r("The "),at=n("a"),Kn=r("SEWForCTC"),Hn=r(" forward method, overrides the "),jt=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=c(),_(ie.$$.fragment),Qn=c(),qt=n("p"),Bn=r("Example:"),Yn=c(),_(Me.$$.fragment),Gn=c(),_(ze.$$.fragment),Gt=c(),Y=n("h2"),le=n("a"),xt=n("span"),_(Ae.$$.fragment),Xn=c(),Pt=n("span"),Zn=r("SEWForSequenceClassification"),Xt=c(),T=n("div"),_(De.$$.fragment),ea=c(),Ft=n("p"),ta=r(`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),oa=c(),Oe=n("p"),na=r("SEW was proposed in "),Ve=n("a"),aa=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),sa=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),ra=c(),Le=n("p"),ia=r("This model inherits from "),st=n("a"),la=r("PreTrainedModel"),ca=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),da=c(),Ie=n("p"),pa=r("This model is a PyTorch "),Ne=n("a"),ma=r("torch.nn.Module"),fa=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ha=c(),$=n("div"),_(Ke.$$.fragment),ua=c(),G=n("p"),ga=r("The "),rt=n("a"),_a=r("SEWForSequenceClassification"),va=r(" forward method, overrides the "),Mt=n("code"),wa=r("__call__"),ba=r(" special method."),ya=c(),_(ce.$$.fragment),Ea=c(),zt=n("p"),Sa=r("Example:"),Wa=c(),_(He.$$.fragment),Ta=c(),_(Re.$$.fragment),this.h()},l(t){const p=Ts('[data-svelte="svelte-1phssyn"]',document.head);m=a(p,"META",{name:!0,content:!0}),p.forEach(o),k=d(t),h=a(t,"H1",{class:!0});var Ue=s(h);S=a(Ue,"A",{id:!0,class:!0,href:!0});var At=s(S);W=a(At,"SPAN",{});var Dt=s(W);v(u.$$.fragment,Dt),Dt.forEach(o),At.forEach(o),g=d(Ue),P=a(Ue,"SPAN",{});var Ca=s(P);vo=i(Ca,"SEW"),Ca.forEach(o),Ue.forEach(o),Ot=d(t),I=a(t,"H2",{class:!0});var eo=s(I);Z=a(eo,"A",{id:!0,class:!0,href:!0});var $a=s(Z);ut=a($a,"SPAN",{});var ja=s(ut);v(de.$$.fragment,ja),ja.forEach(o),$a.forEach(o),wo=d(eo),gt=a(eo,"SPAN",{});var qa=s(gt);bo=i(qa,"Overview"),qa.forEach(o),eo.forEach(o),Vt=d(t),ee=a(t,"P",{});var to=s(ee);yo=i(to,"SEW (Squeezed and Efficient Wav2Vec) was proposed in "),pe=a(to,"A",{href:!0,rel:!0});var xa=s(pe);Eo=i(xa,`Performance-Efficiency Trade-offs in Unsupervised Pre-training
for Speech Recognition`),xa.forEach(o),So=i(to,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q.
Weinberger, Yoav Artzi.`),to.forEach(o),Lt=d(t),Qe=a(t,"P",{});var Pa=s(Qe);Wo=i(Pa,"The abstract from the paper is the following:"),Pa.forEach(o),It=d(t),Be=a(t,"P",{});var Fa=s(Be);_t=a(Fa,"EM",{});var Ma=s(_t);To=i(Ma,`This paper is a study of performance-efficiency trade-offs in pre-trained models for automatic speech recognition
(ASR). We focus on wav2vec 2.0, and formalize several architecture designs that influence both the model performance
and its efficiency. Putting together all our observations, we introduce SEW (Squeezed and Efficient Wav2vec), a
pre-trained model architecture with significant improvements along both performance and efficiency dimensions across a
variety of training setups. For example, under the 100h-960h semi-supervised setup on LibriSpeech, SEW achieves a 1.9x
inference speedup compared to wav2vec 2.0, with a 13.5% relative reduction in word error rate. With a similar inference
time, SEW reduces word error rate by 25-50% across different model sizes.`),Ma.forEach(o),Fa.forEach(o),Nt=d(t),Ye=a(t,"P",{});var za=s(Ye);ko=i(za,"Tips:"),za.forEach(o),Kt=d(t),te=a(t,"UL",{});var oo=s(te);vt=a(oo,"LI",{});var Aa=s(vt);Co=i(Aa,"SEW is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),Aa.forEach(o),$o=d(oo),me=a(oo,"LI",{});var no=s(me);jo=i(no,`SEWForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded using
`),Ge=a(no,"A",{href:!0});var Da=s(Ge);qo=i(Da,"Wav2Vec2CTCTokenizer"),Da.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=d(t),oe=a(t,"P",{});var ao=s(oe);Po=i(ao,"This model was contributed by "),fe=a(ao,"A",{href:!0,rel:!0});var Oa=s(fe);Fo=i(Oa,"anton-l"),Oa.forEach(o),Mo=i(ao,"."),ao.forEach(o),Rt=d(t),N=a(t,"H2",{class:!0});var so=s(N);ne=a(so,"A",{id:!0,class:!0,href:!0});var Va=s(ne);wt=a(Va,"SPAN",{});var La=s(wt);v(he.$$.fragment,La),La.forEach(o),Va.forEach(o),zo=d(so),bt=a(so,"SPAN",{});var Ia=s(bt);Ao=i(Ia,"SEWConfig"),Ia.forEach(o),so.forEach(o),Ut=d(t),j=a(t,"DIV",{class:!0});var D=s(j);v(ue.$$.fragment,D),Do=d(D),K=a(D,"P",{});var it=s(K);Oo=i(it,"This is the configuration class to store the configuration of a "),Xe=a(it,"A",{href:!0});var Na=s(Xe);Vo=i(Na,"SEWModel"),Na.forEach(o),Lo=i(it,`. It is used to instantiate a SEW model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW
`),ge=a(it,"A",{href:!0,rel:!0});var Ka=s(ge);Io=i(Ka,"asapp/sew-tiny-100k"),Ka.forEach(o),No=i(it," architecture."),it.forEach(o),Ko=d(D),H=a(D,"P",{});var lt=s(H);Ho=i(lt,"Configuration objects inherit from "),Ze=a(lt,"A",{href:!0});var Ha=s(Ze);Ro=i(Ha,"PretrainedConfig"),Ha.forEach(o),Uo=i(lt,` and can be used to control the model outputs. Read the
documentation from `),et=a(lt,"A",{href:!0});var Ra=s(et);Jo=i(Ra,"PretrainedConfig"),Ra.forEach(o),Qo=i(lt," for more information."),lt.forEach(o),Bo=d(D),yt=a(D,"P",{});var Ua=s(yt);Yo=i(Ua,"Example:"),Ua.forEach(o),Go=d(D),v(_e.$$.fragment,D),D.forEach(o),Jt=d(t),R=a(t,"H2",{class:!0});var ro=s(R);ae=a(ro,"A",{id:!0,class:!0,href:!0});var Ja=s(ae);Et=a(Ja,"SPAN",{});var Qa=s(Et);v(ve.$$.fragment,Qa),Qa.forEach(o),Ja.forEach(o),Xo=d(ro),St=a(ro,"SPAN",{});var Ba=s(St);Zo=i(Ba,"SEWModel"),Ba.forEach(o),ro.forEach(o),Qt=d(t),q=a(t,"DIV",{class:!0});var O=s(q);v(we.$$.fragment,O),en=d(O),be=a(O,"P",{});var io=s(be);tn=i(io,`The bare SEW Model transformer outputting raw hidden-states without any specific head on top.
...
Yoav Artzi.`),io.forEach(o),an=d(O),Ee=a(O,"P",{});var lo=s(Ee);sn=i(lo,"This model inherits from "),tt=a(lo,"A",{href:!0});var Ga=s(tt);rn=i(Ga,"PreTrainedModel"),Ga.forEach(o),ln=i(lo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),lo.forEach(o),cn=d(O),Se=a(O,"P",{});var co=s(Se);dn=i(co,"This model is a PyTorch "),We=a(co,"A",{href:!0,rel:!0});var Xa=s(We);pn=i(Xa,"torch.nn.Module"),Xa.forEach(o),mn=i(co,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=d(O),F=a(O,"DIV",{class:!0});var V=s(F);v(Te.$$.fragment,V),hn=d(V),U=a(V,"P",{});var ct=s(U);un=i(ct,"The "),ot=a(ct,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWModel"),Za.forEach(o),_n=i(ct," forward method, overrides the "),Wt=a(ct,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(ct," special method."),ct.forEach(o),bn=d(V),v(se.$$.fragment,V),yn=d(V),Tt=a(V,"P",{});var ts=s(Tt);En=i(ts,"Example:"),ts.forEach(o),Sn=d(V),v(ke.$$.fragment,V),V.forEach(o),O.forEach(o),Bt=d(t),J=a(t,"H2",{class:!0});var po=s(J);re=a(po,"A",{id:!0,class:!0,href:!0});var os=s(re);kt=a(os,"SPAN",{});var ns=s(kt);v(Ce.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=d(po),Ct=a(po,"SPAN",{});var as=s(Ct);Tn=i(as,"SEWForCTC"),as.forEach(o),po.forEach(o),Yt=d(t),x=a(t,"DIV",{class:!0});var L=s(x);v($e.$$.fragment,L),kn=d(L),Q=a(L,"P",{});var dt=s(Q);Cn=i(dt,"SEW Model with a "),$t=a(dt,"CODE",{});var ss=s($t);$n=i(ss,"language modeling"),ss.forEach(o),jn=i(dt,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),dt.forEach(o),Pn=d(L),qe=a(L,"P",{});var mo=s(qe);Fn=i(mo,"This model inherits from "),nt=a(mo,"A",{href:!0});var is=s(nt);Mn=i(is,"PreTrainedModel"),is.forEach(o),zn=i(mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),mo.forEach(o),An=d(L),xe=a(L,"P",{});var fo=s(xe);Dn=i(fo,"This model is a PyTorch "),Pe=a(fo,"A",{href:!0,rel:!0});var ls=s(Pe);On=i(ls,"torch.nn.Module"),ls.forEach(o),Vn=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Ln=d(L),C=a(L,"DIV",{class:!0});var M=s(C);v(Fe.$$.fragment,M),In=d(M),B=a(M,"P",{});var pt=s(B);Nn=i(pt,"The "),at=a(pt,"A",{href:!0});var cs=s(at);Kn=i(cs,"SEWForCTC"),cs.forEach(o),Hn=i(pt," forward method, overrides the "),jt=a(pt,"CODE",{});var ds=s(jt);Rn=i(ds,"__call__"),ds.forEach(o),Un=i(pt," special method."),pt.forEach(o),Jn=d(M),v(ie.$$.fragment,M),Qn=d(M),qt=a(M,"P",{});var ps=s(qt);Bn=i(ps,"Example:"),ps.forEach(o),Yn=d(M),v(Me.$$.fragment,M),Gn=d(M),v(ze.$$.fragment,M),M.forEach(o),L.forEach(o),Gt=d(t),Y=a(t,"H2",{class:!0});var ho=s(Y);le=a(ho,"A",{id:!0,class:!0,href:!0});var ms=s(le);xt=a(ms,"SPAN",{});var fs=s(xt);v(Ae.$$.fragment,fs),fs.forEach(o),ms.forEach(o),Xn=d(ho),Pt=a(ho,"SPAN",{});var hs=s(Pt);Zn=i(hs,"SEWForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=d(t),T=a(t,"DIV",{class:!0});var z=s(T);v(De.$$.fragment,z),ea=d(z),Ft=a(z,"P",{});var us=s(Ft);ta=i(us,`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),us.forEach(o),oa=d(z),Oe=a(z,"P",{});var uo=s(Oe);na=i(uo,"SEW was proposed in "),Ve=a(uo,"A",{href:!0,rel:!0});var gs=s(Ve);aa=i(gs,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),gs.forEach(o),sa=i(uo,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),uo.forEach(o),ra=d(z),Le=a(z,"P",{});var go=s(Le);ia=i(go,"This model inherits from "),st=a(go,"A",{href:!0});var _s=s(st);la=i(_s,"PreTrainedModel"),_s.forEach(o),ca=i(go,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),go.forEach(o),da=d(z),Ie=a(z,"P",{});var _o=s(Ie);pa=i(_o,"This model is a PyTorch "),Ne=a(_o,"A",{href:!0,rel:!0});var vs=s(Ne);ma=i(vs,"torch.nn.Module"),vs.forEach(o),fa=i(_o,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),ha=d(z),$=a(z,"DIV",{class:!0});var A=s($);v(Ke.$$.fragment,A),ua=d(A),G=a(A,"P",{});var mt=s(G);ga=i(mt,"The "),rt=a(mt,"A",{href:!0});var ws=s(rt);_a=i(ws,"SEWForSequenceClassification"),ws.forEach(o),va=i(mt," forward method, overrides the "),Mt=a(mt,"CODE",{});var bs=s(Mt);wa=i(bs,"__call__"),bs.forEach(o),ba=i(mt," special method."),mt.forEach(o),ya=d(A),v(ce.$$.fragment,A),Ea=d(A),zt=a(A,"P",{});var ys=s(zt);Sa=i(ys,"Example:"),ys.forEach(o),Wa=d(A),v(He.$$.fragment,A),Ta=d(A),v(Re.$$.fragment,A),A.forEach(o),z.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(xs)),l(S,"id","sew"),l(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(S,"href","#sew"),l(h,"class","relative group"),l(Z,"id","overview"),l(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Z,"href","#overview"),l(I,"class","relative group"),l(pe,"href","https://arxiv.org/abs/2109.06870"),l(pe,"rel","nofollow"),l(Ge,"href","/docs/transformers/pr_16755/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(fe,"href","https://huggingface.co/anton-l"),l(fe,"rel","nofollow"),l(ne,"id","transformers.SEWConfig"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SEWConfig"),l(N,"class","relative group"),l(Xe,"href","/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWModel"),l(ge,"href","https://huggingface.co/asapp/sew-tiny-100k"),l(ge,"rel","nofollow"),l(Ze,"href","/docs/transformers/pr_16755/en/main_classes/configuration#transformers.PretrainedConfig"),l(et,"href","/docs/transformers/pr_16755/en/main_classes/configuration#transformers.PretrainedConfig"),l(j,"class","docstring"),l(ae,"id","transformers.SEWModel"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.SEWModel"),l(R,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2109.06870"),l(ye,"rel","nofollow"),l(tt,"href","/docs/transformers/pr_16755/en/main_classes/model#transformers.PreTrainedModel"),l(We,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(We,"rel","nofollow"),l(ot,"href","/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWModel"),l(F,"class","docstring"),l(q,"class","docstring"),l(re,"id","transformers.SEWForCTC"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SEWForCTC"),l(J,"class","relative group"),l(je,"href","https://arxiv.org/abs/2109.06870"),l(je,"rel","nofollow"),l(nt,"href","/docs/transformers/pr_16755/en/main_classes/model#transformers.PreTrainedModel"),l(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Pe,"rel","nofollow"),l(at,"href","/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWForCTC"),l(C,"class","docstring"),l(x,"class","docstring"),l(le,"id","transformers.SEWForSequenceClassification"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.SEWForSequenceClassification"),l(Y,"class","relative group"),l(Ve,"href","https://arxiv.org/abs/2109.06870"),l(Ve,"rel","nofollow"),l(st,"href","/docs/transformers/pr_16755/en/main_classes/model#transformers.PreTrainedModel"),l(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ne,"rel","nofollow"),l(rt,"href","/docs/transformers/pr_16755/en/model_doc/sew#transformers.SEWForSequenceClassification"),l($,"class","docstring"),l(T,"class","docstring")},m(t,p){e(document.head,m),f(t,k,p),f(t,h,p),e(h,S),e(S,W),w(u,W,null),e(h,g),e(h,P),e(P,vo),f(t,Ot,p),f(t,I,p),e(I,Z),e(Z,ut),w(de,ut,null),e(I,wo),e(I,gt),e(gt,bo),f(t,Vt,p),f(t,ee,p),e(ee,yo),e(ee,pe),e(pe,Eo),e(ee,So),f(t,Lt,p),f(t,Qe,p),e(Qe,Wo),f(t,It,p),f(t,Be,p),e(Be,_t),e(_t,To),f(t,Nt,p),f(t,Ye,p),e(Ye,ko),f(t,Kt,p),f(t,te,p),e(te,vt),e(vt,Co),e(te,$o),e(te,me),e(me,jo),e(me,Ge),e(Ge,qo),e(me,xo),f(t,Ht,p),f(t,oe,p),e(oe,Po),e(oe,fe),e(fe,Fo),e(oe,Mo),f(t,Rt,p),f(t,N,p),e(N,ne),e(ne,wt),w(he,wt,null),e(N,zo),e(N,bt),e(bt,Ao),f(t,Ut,p),f(t,j,p),w(ue,j,null),e(j,Do),e(j,K),e(K,Oo),e(K,Xe),e(Xe,Vo),e(K,Lo),e(K,ge),e(ge,Io),e(K,No),e(j,Ko),e(j,H),e(H,Ho),e(H,Ze),e(Ze,Ro),e(H,Uo),e(H,et),e(et,Jo),e(H,Qo),e(j,Bo),e(j,yt),e(yt,Yo),e(j,Go),w(_e,j,null),f(t,Jt,p),f(t,R,p),e(R,ae),e(ae,Et),w(ve,Et,null),e(R,Xo),e(R,St),e(St,Zo),f(t,Qt,p),f(t,q,p),w(we,q,null),e(q,en),e(q,be),e(be,tn),e(be,ye),e(ye,on),e(be,nn),e(q,an),e(q,Ee),e(Ee,sn),e(Ee,tt),e(tt,rn),e(Ee,ln),e(q,cn),e(q,Se),e(Se,dn),e(Se,We),e(We,pn),e(Se,mn),e(q,fn),e(q,F),w(Te,F,null),e(F,hn),e(F,U),e(U,un),e(U,ot),e(ot,gn),e(U,_n),e(U,Wt),e(Wt,vn),e(U,wn),e(F,bn),w(se,F,null),e(F,yn),e(F,Tt),e(Tt,En),e(F,Sn),w(ke,F,null),f(t,Bt,p),f(t,J,p),e(J,re),e(re,kt),w(Ce,kt,null),e(J,Wn),e(J,Ct),e(Ct,Tn),f(t,Yt,p),f(t,x,p),w($e,x,null),e(x,kn),e(x,Q),e(Q,Cn),e(Q,$t),e($t,$n),e(Q,jn),e(Q,je),e(je,qn),e(Q,xn),e(x,Pn),e(x,qe),e(qe,Fn),e(qe,nt),e(nt,Mn),e(qe,zn),e(x,An),e(x,xe),e(xe,Dn),e(xe,Pe),e(Pe,On),e(xe,Vn),e(x,Ln),e(x,C),w(Fe,C,null),e(C,In),e(C,B),e(B,Nn),e(B,at),e(at,Kn),e(B,Hn),e(B,jt),e(jt,Rn),e(B,Un),e(C,Jn),w(ie,C,null),e(C,Qn),e(C,qt),e(qt,Bn),e(C,Yn),w(Me,C,null),e(C,Gn),w(ze,C,null),f(t,Gt,p),f(t,Y,p),e(Y,le),e(le,xt),w(Ae,xt,null),e(Y,Xn),e(Y,Pt),e(Pt,Zn),f(t,Xt,p),f(t,T,p),w(De,T,null),e(T,ea),e(T,Ft),e(Ft,ta),e(T,oa),e(T,Oe),e(Oe,na),e(Oe,Ve),e(Ve,aa),e(Oe,sa),e(T,ra),e(T,Le),e(Le,ia),e(Le,st),e(st,la),e(Le,ca),e(T,da),e(T,Ie),e(Ie,pa),e(Ie,Ne),e(Ne,ma),e(Ie,fa),e(T,ha),e(T,$),w(Ke,$,null),e($,ua),e($,G),e(G,ga),e(G,rt),e(rt,_a),e(G,va),e(G,Mt),e(Mt,wa),e(G,ba),e($,ya),w(ce,$,null),e($,Ea),e($,zt),e(zt,Sa),e($,Wa),w(He,$,null),e($,Ta),w(Re,$,null),Zt=!0},p(t,[p]){const Ue={};p&2&&(Ue.$$scope={dirty:p,ctx:t}),se.$set(Ue);const At={};p&2&&(At.$$scope={dirty:p,ctx:t}),ie.$set(At);const Dt={};p&2&&(Dt.$$scope={dirty:p,ctx:t}),ce.$set(Dt)},i(t){Zt||(b(u.$$.fragment,t),b(de.$$.fragment,t),b(he.$$.fragment,t),b(ue.$$.fragment,t),b(_e.$$.fragment,t),b(ve.$$.fragment,t),b(we.$$.fragment,t),b(Te.$$.fragment,t),b(se.$$.fragment,t),b(ke.$$.fragment,t),b(Ce.$$.fragment,t),b($e.$$.fragment,t),b(Fe.$$.fragment,t),b(ie.$$.fragment,t),b(Me.$$.fragment,t),b(ze.$$.fragment,t),b(Ae.$$.fragment,t),b(De.$$.fragment,t),b(Ke.$$.fragment,t),b(ce.$$.fragment,t),b(He.$$.fragment,t),b(Re.$$.fragment,t),Zt=!0)},o(t){y(u.$$.fragment,t),y(de.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(we.$$.fragment,t),y(Te.$$.fragment,t),y(se.$$.fragment,t),y(ke.$$.fragment,t),y(Ce.$$.fragment,t),y($e.$$.fragment,t),y(Fe.$$.fragment,t),y(ie.$$.fragment,t),y(Me.$$.fragment,t),y(ze.$$.fragment,t),y(Ae.$$.fragment,t),y(De.$$.fragment,t),y(Ke.$$.fragment,t),y(ce.$$.fragment,t),y(He.$$.fragment,t),y(Re.$$.fragment,t),Zt=!1},d(t){o(m),t&&o(k),t&&o(h),E(u),t&&o(Ot),t&&o(I),E(de),t&&o(Vt),t&&o(ee),t&&o(Lt),t&&o(Qe),t&&o(It),t&&o(Be),t&&o(Nt),t&&o(Ye),t&&o(Kt),t&&o(te),t&&o(Ht),t&&o(oe),t&&o(Rt),t&&o(N),E(he),t&&o(Ut),t&&o(j),E(ue),E(_e),t&&o(Jt),t&&o(R),E(ve),t&&o(Qt),t&&o(q),E(we),E(Te),E(se),E(ke),t&&o(Bt),t&&o(J),E(Ce),t&&o(Yt),t&&o(x),E($e),E(Fe),E(ie),E(Me),E(ze),t&&o(Gt),t&&o(Y),E(Ae),t&&o(Xt),t&&o(T),E(De),E(Ke),E(ce),E(He),E(Re)}}}const xs={local:"sew",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWConfig",title:"SEWConfig"},{local:"transformers.SEWModel",title:"SEWModel"},{local:"transformers.SEWForCTC",title:"SEWForCTC"},{local:"transformers.SEWForSequenceClassification",title:"SEWForSequenceClassification"}],title:"SEW"};function Ps(X){return ks(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Os extends Es{constructor(m){super();Ss(this,m,Ps,qs,Ws,{})}}export{Os as default,xs as metadata};
