import{S as hi,i as mi,s as pi,e as s,k as c,w as C,t as o,M as fi,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ui,G as e,g as p,y as k,q as $,o as y,B as O,v as gi,L as ci}from"../../chunks/vendor-hf-doc-builder.js";import{T as li}from"../../chunks/Tip-hf-doc-builder.js";import{D as Z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Bs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as jt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as di}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function _i(S){let f,E,u,g,T;return g=new Bs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/pr_17743/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,R){p(j,f,R),e(f,E),e(f,u),e(u,g),e(f,T),e(f,m),e(m,_),e(f,D)},d(j){j&&r(f)}}}function bi(S){let f,E,u,g,T;return g=new Bs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("p"),E=o("Example:"),u=c(),C(g.$$.fragment)},l(m){f=n(m,"P",{});var _=i(f);E=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){p(m,f,_),e(f,E),p(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(f),m&&r(u),O(g,m)}}}function Ci(S){let f,E,u,g,T,m,_,D,j,R,z,F,zt,$e,ro,Lt,oo,ur,W,ao,ye,so,no,Oe,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,mo,it,po,fo,br,ae,uo,Dt,go,_o,Cr,H,vo,Re,To,bo,Ee,Co,wo,wr,lt,ko,kr,B,xe,$o,Pe,yo,Oo,Ro,I,Eo,Me,xo,Po,je,Mo,jo,ze,zo,Lo,Fo,Le,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,yr,U,No,It,So,Wo,ct,Ho,Bo,Or,v,Uo,Vt,Go,Xo,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Ht,oa,aa,Bt,sa,na,Ut,ia,la,Gt,da,ca,Rr,mt,Xt,ha,Er,De,xr,ne,ma,qe,pa,fa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,pt,Ta,ba,Ve,Ca,wa,ka,Q,$a,ft,ya,Oa,ut,Ra,Ea,xa,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,zr,b,Se,ja,Qt,za,La,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ha,We,ar,Ba,Ua,Ga,_t,Xa,Za,Ja,ce,He,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,G,Be,ns,ir,is,ls,he,ds,X,Ue,cs,Ge,hs,Tt,ms,ps,fs,me,us,pe,Xe,gs,Ze,_s,bt,vs,Ts,bs,fe,Je,Cs,Ye,ws,Ct,ks,$s,ys,ue,Ke,Os,lr,Rs,Lr,te,ge,dr,Qe,Es,cr,xs,Fr,A,et,Ps,N,Ms,wt,js,zs,hr,Ls,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return m=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Bs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17743/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/processing_trocr.py#L23"}}),He=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/processing_trocr.py#L44"}}),Be=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_17743/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/processing_utils.py#L94"}}),me=new li({props:{$$slots:{default:[Ti]},$$scope:{ctx:S}}}),Xe=new Z({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/processing_trocr.py#L53"}}),Je=new Z({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/processing_trocr.py#L60"}}),Ke=new Z({props:{name:"as_target_processor",anchor:"transformers.TrOCRProcessor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/processing_trocr.py#L67"}}),Qe=new jt({}),et=new Z({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17743/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17743/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/modeling_trocr.py#L782"}}),ot=new Z({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/pr_17743/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_17743/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17743/src/transformers/models/trocr/modeling_trocr.py#L813",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17743/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
>transformers.modeling_outputs.CausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17743/en/model_doc/trocr#transformers.TrOCRConfig"
...
tasks.`),vr=c(),re=s("img"),Tr=c(),oe=s("small"),mo=o("TrOCR architecture. Taken from the "),it=s("a"),po=o("original paper"),fo=o("."),br=c(),ae=s("p"),uo=o("Please refer to the "),Dt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),Cr=c(),H=s("p"),vo=o("This model was contributed by "),Re=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
`),Ee=s("a"),Co=o("here"),wo=o("."),wr=c(),lt=s("p"),ko=o("Tips:"),kr=c(),B=s("ul"),xe=s("li"),$o=o("The quickest way to get started with TrOCR is by checking the "),Pe=s("a"),yo=o(`tutorial
...
can be reloaded using the `),Tt=s("a"),ms=o("from_pretrained()"),ps=o(" method."),fs=c(),C(me.$$.fragment),us=c(),pe=s("div"),C(Xe.$$.fragment),gs=c(),Ze=s("p"),_s=o("This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=s("a"),vs=o("batch_decode()"),Ts=o(`. Please refer
...
can be reloaded using the `),Tt=n(Gr,"A",{href:!0});var Yn=i(Tt);ms=a(Yn,"from_pretrained()"),Yn.forEach(r),ps=a(Gr," method."),Gr.forEach(r),fs=h(Mt),w(me.$$.fragment,Mt),Mt.forEach(r),us=h(M),pe=n(M,"DIV",{class:!0});var Xr=i(pe);w(Xe.$$.fragment,Xr),gs=h(Xr),Ze=n(Xr,"P",{});var Zr=i(Ze);_s=a(Zr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=n(Zr,"A",{href:!0});var Kn=i(bt);vs=a(Kn,"batch_decode()"),Kn.forEach(r),Ts=a(Zr,`. Please refer
