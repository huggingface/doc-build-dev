import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as i,M as sn,c as s,d as n,m as u,a as r,x as $,h as a,b as l,G as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-316217a5.js";import{D as xt}from"../../chunks/Docstring-1fe4a33a.js";import{C as en}from"../../chunks/CodeBlock-8418a95e.js";import{I as qt}from"../../chunks/IconCopyLink-40460835.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,_e,v,T,ce,S,Re,de,De,ge,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,G,Ye,ve,J,pe,He,be,Q,Ve,we,R,Te,L,Ge,Z,Je,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,_,nt,F,ot,st,O,rt,it,ze,b,q,ue,B,at,me,lt,Me,m,j,ct,h,dt,te,pt,ut,ne,mt,ht,X,ft,_t,gt,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Ee;return U=new qt({}),S=new qt({}),R=new en({props:{code:`from transformers import LukeModel
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.MLukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17153/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17153/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17153/src/transformers/models/mluke/tokenization_mluke.py#L367",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17153/en/main_classes/tokenizer#transformers.BatchEncoding"
...
`),X=s(M,"A",{href:!0,rel:!0});var Gt=r(X);ft=a(Gt,"SentencePiece"),Gt.forEach(n),_t=a(M,"."),M.forEach(n),gt=u(g),C=s(g,"P",{});var Ue=r(C);kt=a(Ue,"This tokenizer inherits from "),oe=s(Ue,"A",{href:!0});var Jt=r(oe);yt=a(Jt,"PreTrainedTokenizer"),Jt.forEach(n),vt=a(Ue,` which contains most of the main methods. Users should refer to
