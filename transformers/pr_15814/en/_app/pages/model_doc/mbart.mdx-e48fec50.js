...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(expected_translation_romanian, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs[<span class="hljs-string">&quot;labels&quot;</span>] = labels[<span class="hljs-string">&quot;input_ids&quot;</span>]`}}),la=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart/tokenization_mbart_fast.py#L163",parametersDescription:[{anchor:"transformers.MBartTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Ma=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ra=new q({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L221"}}),Wa=new q({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L236"}}),Ua=new U({}),Xa=new q({props:{name:"class transformers.MBartModel",anchor:"transformers.MBartModel",parameters:[{name:"config",val:": MBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart/modeling_mbart.py#L1123",parametersDescription:[{anchor:"transformers.MBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15814/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15814/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ja=new q({props:{name:"forward",anchor:"transformers.MBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart/modeling_mbart.py#L1150",parametersDescription:[{anchor:"transformers.MBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15814/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15814/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15814/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Es=new U({}),Ps=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart/modeling_tf_mbart.py#L1311",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15814/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15814/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[L2]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15814/src/transformers/models/mbart/modeling_tf_mbart.py#L1344",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15814/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15814/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15814/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15814/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15814/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15814/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15814/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15814/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ey=d(),Tc=n("p"),Py=r("Finally, this model supports inherent JAX features such as:"),Cy=d(),ft=n("ul"),Mc=n("li"),rr=n("a"),Sy=r("Just-In-Time (JIT) compilation"),Ay=d(),wc=n("li"),ir=n("a"),Iy=r("Automatic Differentiation"),Ny=d(),xc=n("li"),dr=n("a"),Oy=r("Vectorization"),Dy=d(),zc=n("li"),lr=n("a"),Ly=r("Parallelization"),Gy=d(),te=n("div"),m(cr.$$.fragment),Ry=d(),Bo=n("p"),Wy=r("The "),qc=n("code"),Uy=r("FlaxMBartPreTrainedModel"),Xy=r("forward method, overrides the "),Bc=n("code"),Hy=r("__call__"),Vy=r(" special method."),Qy=d(),m(gn.$$.fragment),Jy=d(),$c=n("p"),Ky=r("Summarization example:"),Zy=d(),m(pr.$$.fragment),Yy=d(),Fc=n("p"),e1=r("Mask filling example:"),t1=d(),m(ur.$$.fragment),o1=d(),xt=n("div"),m(hr.$$.fragment),n1=d(),jc=n("p"),a1=r("Example:"),s1=d(),m(mr.$$.fragment),r1=d(),zt=n("div"),m(fr.$$.fragment),i1=d(),Ec=n("p"),d1=r("Example:"),l1=d(),m(_r.$$.fragment),su=d(),$o=n("h2"),kn=n("a"),Pc=n("span"),m(gr.$$.fragment),c1=d(),Cc=n("span"),p1=r("FlaxMBartForSequenceClassification"),ru=d(),I=n("div"),m(kr.$$.fragment),u1=d(),Sc=n("p"),h1=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),m1=d(),br=n("p"),f1=r("This model inherits from "),$i=n("a"),_1=r("FlaxPreTrainedModel"),g1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),k1=d(),vr=n("p"),b1=r(`This model is also a Flax Linen
`),yr=n("a"),v1=r("flax.nn.Module"),y1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),T1=d(),Ac=n("p"),M1=r("Finally, this model supports inherent JAX features such as:"),w1=d(),_t=n("ul"),Ic=n("li"),Tr=n("a"),x1=r("Just-In-Time (JIT) compilation"),z1=d(),Nc=n("li"),Mr=n("a"),q1=r("Automatic Differentiation"),B1=d(),Oc=n("li"),wr=n("a"),$1=r("Vectorization"),F1=d(),Dc=n("li"),xr=n("a"),j1=r("Parallelization"),E1=d(),Oe=n("div"),m(zr.$$.fragment),P1=d(),Fo=n("p"),C1=r("The "),Lc=n("code"),S1=r("FlaxMBartPreTrainedModel"),A1=r("forward method, overrides the "),Gc=n("code"),I1=r("__call__"),N1=r(" special method."),O1=d(),m(bn.$$.fragment),D1=d(),Rc=n("p"),L1=r("Example:"),G1=d(),m(qr.$$.fragment),R1=d(),qt=n("div"),m(Br.$$.fragment),W1=d(),Wc=n("p"),U1=r("Example:"),X1=d(),m($r.$$.fragment),H1=d(),Bt=n("div"),m(Fr.$$.fragment),V1=d(),Uc=n("p"),Q1=r("Example:"),J1=d(),m(jr.$$.fragment),iu=d(),jo=n("h2"),vn=n("a"),Xc=n("span"),m(Er.$$.fragment),K1=d(),Hc=n("span"),Z1=r("FlaxMBartForQuestionAnswering"),du=d(),N=n("div"),m(Pr.$$.fragment),Y1=d(),Eo=n("p"),eT=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mh.forEach(t),Ey=l(fe),Tc=a(fe,"P",{});var $z=s(Tc);Py=i($z,"Finally, this model supports inherent JAX features such as:"),$z.forEach(t),Cy=l(fe),ft=a(fe,"UL",{});var Fn=s(ft);Mc=a(Fn,"LI",{});var Fz=s(Mc);rr=a(Fz,"A",{href:!0,rel:!0});var jz=s(rr);Sy=i(jz,"Just-In-Time (JIT) compilation"),jz.forEach(t),Fz.forEach(t),Ay=l(Fn),wc=a(Fn,"LI",{});var Ez=s(wc);ir=a(Ez,"A",{href:!0,rel:!0});var Pz=s(ir);Iy=i(Pz,"Automatic Differentiation"),Pz.forEach(t),Ez.forEach(t),Ny=l(Fn),xc=a(Fn,"LI",{});var Cz=s(xc);dr=a(Cz,"A",{href:!0,rel:!0});var Sz=s(dr);Oy=i(Sz,"Vectorization"),Sz.forEach(t),Cz.forEach(t),Dy=l(Fn),zc=a(Fn,"LI",{});var Az=s(zc);lr=a(Az,"A",{href:!0,rel:!0});var Iz=s(lr);Ly=i(Iz,"Parallelization"),Iz.forEach(t),Az.forEach(t),Fn.forEach(t),Gy=l(fe),te=a(fe,"DIV",{class:!0});var We=s(te);f(cr.$$.fragment,We),Ry=l(We),Bo=a(We,"P",{});var Qi=s(Bo);Wy=i(Qi,"The "),qc=a(Qi,"CODE",{});var Nz=s(qc);Uy=i(Nz,"FlaxMBartPreTrainedModel"),Nz.forEach(t),Xy=i(Qi,"forward method, overrides the "),Bc=a(Qi,"CODE",{});var Oz=s(Bc);Hy=i(Oz,"__call__"),Oz.forEach(t),Vy=i(Qi," special method."),Qi.forEach(t),Qy=l(We),f(gn.$$.fragment,We),Jy=l(We),$c=a(We,"P",{});var Dz=s($c);Ky=i(Dz,"Summarization example:"),Dz.forEach(t),Zy=l(We),f(pr.$$.fragment,We),Yy=l(We),Fc=a(We,"P",{});var Lz=s(Fc);e1=i(Lz,"Mask filling example:"),Lz.forEach(t),t1=l(We),f(ur.$$.fragment,We),We.forEach(t),o1=l(fe),xt=a(fe,"DIV",{class:!0});var Ji=s(xt);f(hr.$$.fragment,Ji),n1=l(Ji),jc=a(Ji,"P",{});var Gz=s(jc);a1=i(Gz,"Example:"),Gz.forEach(t),s1=l(Ji),f(mr.$$.fragment,Ji),Ji.forEach(t),r1=l(fe),zt=a(fe,"DIV",{class:!0});var Ki=s(zt);f(fr.$$.fragment,Ki),i1=l(Ki),Ec=a(Ki,"P",{});var Rz=s(Ec);d1=i(Rz,"Example:"),Rz.forEach(t),l1=l(Ki),f(_r.$$.fragment,Ki),Ki.forEach(t),fe.forEach(t),su=l(o),$o=a(o,"H2",{class:!0});var wh=s($o);kn=a(wh,"A",{id:!0,class:!0,href:!0});var Wz=s(kn);Pc=a(Wz,"SPAN",{});var Uz=s(Pc);f(gr.$$.fragment,Uz),Uz.forEach(t),Wz.forEach(t),c1=l(wh),Cc=a(wh,"SPAN",{});var Xz=s(Cc);p1=i(Xz,"FlaxMBartForSequenceClassification"),Xz.forEach(t),wh.forEach(t),ru=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(kr.$$.fragment,oe),u1=l(oe),Sc=a(oe,"P",{});var Hz=s(Sc);h1=i(Hz,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Hz.forEach(t),m1=l(oe),br=a(oe,"P",{});var xh=s(br);f1=i(xh,"This model inherits from "),$i=a(xh,"A",{href:!0});var Vz=s($i);_1=i(Vz,"FlaxPreTrainedModel"),Vz.forEach(t),g1=i(xh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh.forEach(t),k1=l(oe),vr=a(oe,"P",{});var zh=s(vr);b1=i(zh,`This model is also a Flax Linen
`),yr=a(zh,"A",{href:!0,rel:!0});var Qz=s(yr);v1=i(Qz,"flax.nn.Module"),Qz.forEach(t),y1=i(zh,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zh.forEach(t),T1=l(oe),Ac=a(oe,"P",{});var Jz=s(Ac);M1=i(Jz,"Finally, this model supports inherent JAX features such as:"),Jz.forEach(t),w1=l(oe),_t=a(oe,"UL",{});var jn=s(_t);Ic=a(jn,"LI",{});var Kz=s(Ic);Tr=a(Kz,"A",{href:!0,rel:!0});var Zz=s(Tr);x1=i(Zz,"Just-In-Time (JIT) compilation"),Zz.forEach(t),Kz.forEach(t),z1=l(jn),Nc=a(jn,"LI",{});var Yz=s(Nc);Mr=a(Yz,"A",{href:!0,rel:!0});var e2=s(Mr);q1=i(e2,"Automatic Differentiation"),e2.forEach(t),Yz.forEach(t),B1=l(jn),Oc=a(jn,"LI",{});var t2=s(Oc);wr=a(t2,"A",{href:!0,rel:!0});var o2=s(wr);$1=i(o2,"Vectorization"),o2.forEach(t),t2.forEach(t),F1=l(jn),Dc=a(jn,"LI",{});var n2=s(Dc);xr=a(n2,"A",{href:!0,rel:!0});var a2=s(xr);j1=i(a2,"Parallelization"),a2.forEach(t),n2.forEach(t),jn.forEach(t),E1=l(oe),Oe=a(oe,"DIV",{class:!0});var Rt=s(Oe);f(zr.$$.fragment,Rt),P1=l(Rt),Fo=a(Rt,"P",{});var Zi=s(Fo);C1=i(Zi,"The "),Lc=a(Zi,"CODE",{});var s2=s(Lc);S1=i(s2,"FlaxMBartPreTrainedModel"),s2.forEach(t),A1=i(Zi,"forward method, overrides the "),Gc=a(Zi,"CODE",{});var r2=s(Gc);I1=i(r2,"__call__"),r2.forEach(t),N1=i(Zi," special method."),Zi.forEach(t),O1=l(Rt),f(bn.$$.fragment,Rt),D1=l(Rt),Rc=a(Rt,"P",{});var i2=s(Rc);L1=i(i2,"Example:"),i2.forEach(t),G1=l(Rt),f(qr.$$.fragment,Rt),Rt.forEach(t),R1=l(oe),qt=a(oe,"DIV",{class:!0});var Yi=s(qt);f(Br.$$.fragment,Yi),W1=l(Yi),Wc=a(Yi,"P",{});var d2=s(Wc);U1=i(d2,"Example:"),d2.forEach(t),X1=l(Yi),f($r.$$.fragment,Yi),Yi.forEach(t),H1=l(oe),Bt=a(oe,"DIV",{class:!0});var ed=s(Bt);f(Fr.$$.fragment,ed),V1=l(ed),Uc=a(ed,"P",{});var l2=s(Uc);Q1=i(l2,"Example:"),l2.forEach(t),J1=l(ed),f(jr.$$.fragment,ed),ed.forEach(t),oe.forEach(t),iu=l(o),jo=a(o,"H2",{class:!0});var qh=s(jo);vn=a(qh,"A",{id:!0,class:!0,href:!0});var c2=s(vn);Xc=a(c2,"SPAN",{});var p2=s(Xc);f(Er.$$.fragment,p2),p2.forEach(t),c2.forEach(t),K1=l(qh),Hc=a(qh,"SPAN",{});var u2=s(Hc);Z1=i(u2,"FlaxMBartForQuestionAnswering"),u2.forEach(t),qh.forEach(t),du=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Pr.$$.fragment,ne),Y1=l(ne),Eo=a(ne,"P",{});var td=s(Eo);eT=i(td,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
