...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17353/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17353/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17353/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17353/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17353/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17353/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17353/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17353/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17353/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);T(xr.$$.fragment,lo),yv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);Tv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h3=a(gd);wv=i(h3,"RobertaForTokenClassification"),h3.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var m3=a(rp);Fv=i(m3,"__call__"),m3.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),T(Kn.$$.fragment,lo),Mv=h(lo),T(Gn.$$.fragment,lo),Ev=h(lo),T(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f3=a(Yn);ip=s(f3,"SPAN",{});var u3=a(ip);T(Rr.$$.fragment,u3),u3.forEach(t),f3.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var g3=a(lp);qv=i(g3,"RobertaForQuestionAnswering"),g3.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);T(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _3=a(dp);Pv=i(_3,"span start logits"),_3.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b3=a(cp);Av=i(b3,"span end logits"),b3.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fu=a(Er);Iv=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k3=a(_d);Dv=i(k3,"PreTrainedModel"),k3.forEach(t),Sv=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wv=h(co),zr=s(co,"P",{});var uu=a(zr);Bv=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var v3=a(qr);Uv=i(v3,"torch.nn.Module"),v3.forEach(t),Hv=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fy=h(Ot),T(ns.$$.fragment,Ot),uy=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),gy=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_y=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E3=a(vd);by=i(E3,"TFRobertaModel"),E3.forEach(t),ky=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z3=a(up);vy=i(z3,"__call__"),z3.forEach(t),yy=i(Gd," special method."),Gd.forEach(t),Ty=h(na),T(ss.$$.fragment,na),wy=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var q3=a(rs);gp=s(q3,"SPAN",{});var C3=a(gp);T(Ir.$$.fragment,C3),C3.forEach(t),q3.forEach(t),$y=h(ku),_p=s(ku,"SPAN",{});var j3=a(_p);Fy=i(j3,"TFRobertaForCausalLM"),j3.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),xy=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),Ry=h(sa),Do=s(sa,"P",{});var Xd=a(Do);My=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var P3=a(yd);Ey=i(P3,"TFRobertaForCausalLM"),P3.forEach(t),zy=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L3=a(bp);qy=i(L3,"__call__"),L3.forEach(t),Cy=i(Xd," special method."),Xd.forEach(t),jy=h(sa),T(is.$$.fragment,sa),Py=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var A3=a(ds);kp=s(A3,"SPAN",{});var O3=a(kp);T(Wr.$$.fragment,O3),O3.forEach(t),A3.forEach(t),Ly=h(yu),vp=s(yu,"SPAN",{});var N3=a(vp);Ay=i(N3,"TFRobertaForMaskedLM"),N3.forEach(t),yu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);T(Br.$$.fragment,Nt),Oy=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);Ny=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var I3=a(yp);Iy=i(I3,"language modeling"),I3.forEach(t),Dy=i(Tu," head on top."),Tu.forEach(t),Sy=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wy=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var D3=a(Td);By=i(D3,"TFPreTrainedModel"),D3.forEach(t),Uy=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Hy=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Qy=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var S3=a(Jr);Jy=i(S3,"tf.keras.Model"),S3.forEach(t),Vy=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),Ky=h(Nt),T(cs.$$.fragment,Nt),Gy=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Vr.$$.fragment,ho),Xy=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yy=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W3=a(wd);Zy=i(W3,"TFRobertaForMaskedLM"),W3.forEach(t),eT=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var B3=a(Tp);tT=i(B3,"__call__"),B3.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),T(ps.$$.fragment,ho),sT=h(ho),T(hs.$$.fragment,ho),aT=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U3=a(fs);wp=s(U3,"SPAN",{});var H3=a(wp);T(Kr.$$.fragment,H3),H3.forEach(t),U3.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Q3=a($p);iT=i(Q3,"TFRobertaForSequenceClassification"),Q3.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);T(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var J3=a(Fp);dT=i(J3,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J3.forEach(t),cT=h(It),Xr=s(It,"P",{});var xu=a(Xr);pT=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var V3=a($d);hT=i(V3,"TFPreTrainedModel"),V3.forEach(t),mT=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),T(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G3=a(Fd);TT=i(G3,"TFRobertaForSequenceClassification"),G3.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X3=a(xp);$T=i(X3,"__call__"),X3.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),T(gs.$$.fragment,mo),RT=h(mo),T(_s.$$.fragment,mo),MT=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y3=a(ks);Rp=s(Y3,"SPAN",{});var Z3=a(Rp);T(ti.$$.fragment,Z3),Z3.forEach(t),Y3.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);CT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
