import{S as fa,i as ga,s as _a,e as s,k as l,w as g,t as n,M as ba,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as y,v as va}from"../../chunks/vendor-6b77c823.js";import{T as ma}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-1088f2fb.js";import{C as Qt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as yt}from"../../chunks/IconCopyLink-7a11ce68.js";function ka(Ve){let u,D,m,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=i(u);D=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(T,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(w,T){p(w,u,T),e(u,D),e(u,m),e(m,B),e(u,j)},d(w){w&&o(u)}}}function ya(Ve){let u,D,m,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=i(u);D=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(T,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(w,T){p(w,u,T),e(u,D),e(u,m),e(m,B),e(u,j)},d(w){w&&o(u)}}}function wa(Ve){let u,D,m,B,j,w,T,S,So,Xt,R,Z,wt,de,Ao,Tt,Mo,Yt,A,No,Je,Lo,Fo,le,Io,Oo,Zt,Ke,Ro,eo,Qe,Et,Wo,to,Xe,Uo,oo,Ye,ce,Ho,Ze,Vo,Jo,no,he,ro,et,pe,Ko,tt,Qo,Xo,so,ue,ao,ot,Yo,io,ee,M,nt,Zo,en,rt,tn,on,Bt,nn,rn,sn,zt,an,lo,N,dn,me,ln,cn,fe,hn,pn,co,W,te,$t,ge,un,Gt,mn,ho,$,_e,fn,U,gn,qt,_n,bn,be,vn,kn,yn,H,wn,st,Tn,En,at,Bn,zn,$n,Pt,Gn,qn,ve,po,V,oe,xt,ke,Pn,jt,xn,uo,C,ye,jn,we,Cn,Te,Dn,Sn,An,Ee,Mn,it,Nn,Ln,Fn,dt,Be,mo,J,ne,Ct,ze,In,Dt,On,fo,f,$e,Rn,St,Wn,Un,Ge,Hn,lt,Vn,Jn,Kn,qe,Qn,Pe,Xn,Yn,Zn,xe,er,je,tr,or,nr,K,rr,ct,sr,ar,Ce,ir,dr,lr,E,cr,At,hr,pr,Mt,ur,mr,Nt,fr,gr,Lt,_r,br,Ft,vr,kr,It,yr,wr,Tr,q,De,Er,Q,Br,ht,zr,$r,Ot,Gr,qr,Pr,re,xr,Rt,jr,Cr,Se,go,X,se,Wt,Ae,Dr,Ut,Sr,_o,G,Me,Ar,Ne,Mr,Ht,Nr,Lr,Fr,Le,Ir,pt,Or,Rr,Wr,Fe,Ur,Ie,Hr,Vr,Jr,P,Oe,Kr,Y,Qr,ut,Xr,Yr,Vt,Zr,es,ts,ae,os,Jt,ns,rs,Re,bo;return w=new yt({}),de=new yt({}),he=new Qt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),ue=new Qt({props:{code:`# instantiate sentence fusion model
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/bert_generation/configuration_bert_generation.py#L20"}}),ve=new Qt({props:{code:`from transformers import BertGenerationConfig, BertGenerationEncoder
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/bert_generation/tokenization_bert_generation.py#L41"}}),Be=new He({props:{name:"save_vocabulary",anchor:"transformers.BertGenerationTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/bert_generation/tokenization_bert_generation.py#L155"}}),ze=new yt({}),$e=new He({props:{name:"class transformers.BertGenerationEncoder",anchor:"transformers.BertGenerationEncoder",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BertGenerationEncoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16900/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16900/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/bert_generation/modeling_bert_generation.py#L253"}}),De=new He({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16900/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
`}}),re=new ma({props:{$$slots:{default:[ka]},$$scope:{ctx:Ve}}}),Se=new Qt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationEncoder
import torch
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/bert_generation/modeling_bert_generation.py#L461",returnDescription:`
<p>A <a
...
`}}),ae=new ma({props:{$$slots:{default:[ya]},$$scope:{ctx:Ve}}}),Re=new Qt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),D=l(),m=s("h1"),B=s("a"),j=s("span"),g(w.$$.fragment),T=l(),S=s("span"),So=n("BertGeneration"),Xt=l(),R=s("h2"),Z=s("a"),wt=s("span"),g(de.$$.fragment),Ao=l(),Tt=s("span"),Mo=n("Overview"),Yt=l(),A=s("p"),No=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),no=l(),g(he.$$.fragment),ro=l(),et=s("ul"),pe=s("li"),Ko=n("Pretrained "),tt=s("a"),Qo=n("EncoderDecoderModel"),Xo=n(" are also directly available in the model hub, e.g.,"),so=l(),g(ue.$$.fragment),ao=l(),ot=s("p"),Yo=n("Tips:"),io=l(),ee=s("ul"),M=s("li"),nt=s("a"),Zo=n("BertGenerationEncoder"),en=n(" and "),rt=s("a"),tn=n("BertGenerationDecoder"),on=n(` should be used in
...
Therefore, no EOS token should be added to the end of the input.`),lo=l(),N=s("p"),dn=n("This model was contributed by "),me=s("a"),ln=n("patrickvonplaten"),cn=n(`. The original code can be
found `),fe=s("a"),hn=n("here"),pn=n("."),co=l(),W=s("h2"),te=s("a"),$t=s("span"),g(ge.$$.fragment),un=l(),Gt=s("span"),mn=n("BertGenerationConfig"),ho=l(),$=s("div"),g(_e.$$.fragment),fn=l(),U=s("p"),gn=n("This is the configuration class to store the configuration of a "),qt=s("code"),_n=n("BertGenerationPreTrainedModel"),bn=n(`. It is used to
...
documentation from `),at=s("a"),Bn=n("PretrainedConfig"),zn=n(" for more information."),$n=l(),Pt=s("p"),Gn=n("Examples:"),qn=l(),g(ve.$$.fragment),po=l(),V=s("h2"),oe=s("a"),xt=s("span"),g(ke.$$.fragment),Pn=l(),jt=s("span"),xn=n("BertGenerationTokenizer"),uo=l(),C=s("div"),g(ye.$$.fragment),jn=l(),we=s("p"),Cn=n("Construct a BertGeneration tokenizer. Based on "),Te=s("a"),Dn=n("SentencePiece"),Sn=n("."),An=l(),Ee=s("p"),Mn=n("This tokenizer inherits from "),it=s("a"),Nn=n("PreTrainedTokenizer"),Ln=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Fn=l(),dt=s("div"),g(Be.$$.fragment),mo=l(),J=s("h2"),ne=s("a"),Ct=s("span"),g(ze.$$.fragment),In=l(),Dt=s("span"),On=n("BertGenerationEncoder"),fo=l(),f=s("div"),g($e.$$.fragment),Rn=l(),St=s("p"),Wn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Un=l(),Ge=s("p"),Hn=n("This model inherits from "),lt=s("a"),Vn=n("PreTrainedModel"),Jn=n(`. Check the superclass documentation for the generic methods the
...
to `),Mt=s("code"),ur=n("True"),mr=n(". To be used in a Seq2Seq model, the model needs to initialized with both "),Nt=s("code"),fr=n("is_decoder"),gr=n(` argument and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr=l(),P=s("div"),g(Oe.$$.fragment),Kr=l(),Y=s("p"),Qr=n("The "),ut=s("a"),Xr=n("BertGenerationDecoder"),Yr=n(" forward method, overrides the "),Vt=s("code"),Zr=n("__call__"),es=n(" special method."),ts=l(),g(ae.$$.fragment),os=l(),Jt=s("p"),ns=n("Example:"),rs=l(),g(Re.$$.fragment),this.h()},l(t){const h=ba('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),D=c(t),m=a(t,"H1",{class:!0});var We=i(m);B=a(We,"A",{id:!0,class:!0,href:!0});var Kt=i(B);j=a(Kt,"SPAN",{});var ss=i(j);_(w.$$.fragment,ss),ss.forEach(o),Kt.forEach(o),T=c(We),S=a(We,"SPAN",{});var as=i(S);So=r(as,"BertGeneration"),as.forEach(o),We.forEach(o),Xt=c(t),R=a(t,"H2",{class:!0});var vo=i(R);Z=a(vo,"A",{id:!0,class:!0,href:!0});var is=i(Z);wt=a(is,"SPAN",{});var ds=i(wt);_(de.$$.fragment,ds),ds.forEach(o),is.forEach(o),Ao=c(vo),Tt=a(vo,"SPAN",{});var ls=i(Tt);Mo=r(ls,"Overview"),ls.forEach(o),vo.forEach(o),Yt=c(t),A=a(t,"P",{});var mt=i(A);No=r(mt,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Je=a(mt,"A",{href:!0});var cs=i(Je);Lo=r(cs,"EncoderDecoderModel"),cs.forEach(o),Fo=r(mt," as proposed in "),le=a(mt,"A",{href:!0,rel:!0});var hs=i(le);Io=r(hs,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),hs.forEach(o),Oo=r(mt," by Sascha Rothe, Shashi Narayan, Aliaksei Severyn."),mt.forEach(o),Zt=c(t),Ke=a(t,"P",{});var ps=i(Ke);Ro=r(ps,"The abstract from the paper is the following:"),ps.forEach(o),eo=c(t),Qe=a(t,"P",{});var us=i(Qe);Et=a(us,"EM",{});var ms=i(Et);Wo=r(ms,`Unsupervised pretraining of large neural models has recently revolutionized Natural Language Processing. By
warm-starting from the publicly released checkpoints, NLP practitioners have pushed the state-of-the-art on multiple
benchmarks while saving significant amounts of compute time. So far the focus has been mainly on the Natural Language
Understanding tasks. In this paper, we demonstrate the efficacy of pre-trained checkpoints for Sequence Generation. We
developed a Transformer-based sequence-to-sequence model that is compatible with publicly available pre-trained BERT,
GPT-2 and RoBERTa checkpoints and conducted an extensive empirical study on the utility of initializing our model, both
encoder and decoder, with these checkpoints. Our models result in new state-of-the-art results on Machine Translation,
Text Summarization, Sentence Splitting, and Sentence Fusion.`),ms.forEach(o),us.forEach(o),to=c(t),Xe=a(t,"P",{});var fs=i(Xe);Uo=r(fs,"Usage:"),fs.forEach(o),oo=c(t),Ye=a(t,"UL",{});var gs=i(Ye);ce=a(gs,"LI",{});var ko=i(ce);Ho=r(ko,"The model can be used in combination with the "),Ze=a(ko,"A",{href:!0});var _s=i(Ze);Vo=r(_s,"EncoderDecoderModel"),_s.forEach(o),Jo=r(ko,` to leverage two pretrained
BERT checkpoints for subsequent fine-tuning.`),ko.forEach(o),gs.forEach(o),no=c(t),_(he.$$.fragment,t),ro=c(t),et=a(t,"UL",{});var bs=i(et);pe=a(bs,"LI",{});var yo=i(pe);Ko=r(yo,"Pretrained "),tt=a(yo,"A",{href:!0});var vs=i(tt);Qo=r(vs,"EncoderDecoderModel"),vs.forEach(o),Xo=r(yo," are also directly available in the model hub, e.g.,"),yo.forEach(o),bs.forEach(o),so=c(t),_(ue.$$.fragment,t),ao=c(t),ot=a(t,"P",{});var ks=i(ot);Yo=r(ks,"Tips:"),ks.forEach(o),io=c(t),ee=a(t,"UL",{});var wo=i(ee);M=a(wo,"LI",{});var Ue=i(M);nt=a(Ue,"A",{href:!0});var ys=i(nt);Zo=r(ys,"BertGenerationEncoder"),ys.forEach(o),en=r(Ue," and "),rt=a(Ue,"A",{href:!0});var ws=i(rt);tn=r(ws,"BertGenerationDecoder"),ws.forEach(o),on=r(Ue,` should be used in
...
Therefore, no EOS token should be added to the end of the input.`),Es.forEach(o),wo.forEach(o),lo=c(t),N=a(t,"P",{});var ft=i(N);dn=r(ft,"This model was contributed by "),me=a(ft,"A",{href:!0,rel:!0});var Bs=i(me);ln=r(Bs,"patrickvonplaten"),Bs.forEach(o),cn=r(ft,`. The original code can be
found `),fe=a(ft,"A",{href:!0,rel:!0});var zs=i(fe);hn=r(zs,"here"),zs.forEach(o),pn=r(ft,"."),ft.forEach(o),co=c(t),W=a(t,"H2",{class:!0});var To=i(W);te=a(To,"A",{id:!0,class:!0,href:!0});var $s=i(te);$t=a($s,"SPAN",{});var Gs=i($t);_(ge.$$.fragment,Gs),Gs.forEach(o),$s.forEach(o),un=c(To),Gt=a(To,"SPAN",{});var qs=i(Gt);mn=r(qs,"BertGenerationConfig"),qs.forEach(o),To.forEach(o),ho=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(_e.$$.fragment,L),fn=c(L),U=a(L,"P",{});var gt=i(U);gn=r(gt,"This is the configuration class to store the configuration of a "),qt=a(gt,"CODE",{});var Ps=i(qt);_n=r(Ps,"BertGenerationPreTrainedModel"),Ps.forEach(o),bn=r(gt,`. It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the BertGeneration
...
to `),Mt=a(x,"CODE",{});var Xs=i(Mt);ur=r(Xs,"True"),Xs.forEach(o),mr=r(x,". To be used in a Seq2Seq model, the model needs to initialized with both "),Nt=a(x,"CODE",{});var Ys=i(Nt);fr=r(Ys,"is_decoder"),Ys.forEach(o),gr=r(x,` argument and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Do.forEach(o),Jr=c(I),P=a(I,"DIV",{class:!0});var O=i(P);_(Oe.$$.fragment,O),Kr=c(O),Y=a(O,"P",{});var kt=i(Y);Qr=r(kt,"The "),ut=a(kt,"A",{href:!0});var ha=i(ut);Xr=r(ha,"BertGenerationDecoder"),ha.forEach(o),Yr=r(kt," forward method, overrides the "),Vt=a(kt,"CODE",{});var pa=i(Vt);Zr=r(pa,"__call__"),pa.forEach(o),es=r(kt," special method."),kt.forEach(o),ts=c(O),_(ae.$$.fragment,O),os=c(O),Jt=a(O,"P",{});var ua=i(Jt);ns=r(ua,"Example:"),ua.forEach(o),rs=c(O),_(Re.$$.fragment,O),O.forEach(o),I.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(Ta)),d(B,"id","bertgeneration"),d(B,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(B,"href","#bertgeneration"),d(m,"class","relative group"),d(Z,"id","overview"),d(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Z,"href","#overview"),d(R,"class","relative group"),d(Je,"href","/docs/transformers/pr_16900/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(le,"href","https://arxiv.org/abs/1907.12461"),d(le,"rel","nofollow"),d(Ze,"href","/docs/transformers/pr_16900/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(tt,"href","/docs/transformers/pr_16900/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(nt,"href","/docs/transformers/pr_16900/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(rt,"href","/docs/transformers/pr_16900/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(me,"href","https://huggingface.co/patrickvonplaten"),d(me,"rel","nofollow"),d(fe,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(fe,"rel","nofollow"),d(te,"id","transformers.BertGenerationConfig"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationConfig"),d(W,"class","relative group"),d(be,"href","https://huggingface.co/google/bert_for_seq_generation_L-24_bbc_encoder"),d(be,"rel","nofollow"),d(st,"href","/docs/transformers/pr_16900/en/main_classes/configuration#transformers.PretrainedConfig"),d(at,"href","/docs/transformers/pr_16900/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(oe,"id","transformers.BertGenerationTokenizer"),d(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(oe,"href","#transformers.BertGenerationTokenizer"),d(V,"class","relative group"),d(Te,"href","https://github.com/google/sentencepiece"),d(Te,"rel","nofollow"),d(it,"href","/docs/transformers/pr_16900/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(ne,"id","transformers.BertGenerationEncoder"),d(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ne,"href","#transformers.BertGenerationEncoder"),d(J,"class","relative group"),d(lt,"href","/docs/transformers/pr_16900/en/main_classes/model#transformers.PreTrainedModel"),d(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Pe,"rel","nofollow"),d(je,"href","https://arxiv.org/abs/1706.03762"),d(je,"rel","nofollow"),d(ct,"href","/docs/transformers/pr_16900/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(Ce,"href","https://arxiv.org/abs/1907.12461"),d(Ce,"rel","nofollow"),d(ht,"href","/docs/transformers/pr_16900/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(f,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(se,"id","transformers.BertGenerationDecoder"),d(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(se,"href","#transformers.BertGenerationDecoder"),d(X,"class","relative group"),d(pt,"href","/docs/transformers/pr_16900/en/main_classes/model#transformers.PreTrainedModel"),d(Ie,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Ie,"rel","nofollow"),d(ut,"href","/docs/transformers/pr_16900/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,h){e(document.head,u),p(t,D,h),p(t,m,h),e(m,B),e(B,j),b(w,j,null),e(m,T),e(m,S),e(S,So),p(t,Xt,h),p(t,R,h),e(R,Z),e(Z,wt),b(de,wt,null),e(R,Ao),e(R,Tt),e(Tt,Mo),p(t,Yt,h),p(t,A,h),e(A,No),e(A,Je),e(Je,Lo),e(A,Fo),e(A,le),e(le,Io),e(A,Oo),p(t,Zt,h),p(t,Ke,h),e(Ke,Ro),p(t,eo,h),p(t,Qe,h),e(Qe,Et),e(Et,Wo),p(t,to,h),p(t,Xe,h),e(Xe,Uo),p(t,oo,h),p(t,Ye,h),e(Ye,ce),e(ce,Ho),e(ce,Ze),e(Ze,Vo),e(ce,Jo),p(t,no,h),b(he,t,h),p(t,ro,h),p(t,et,h),e(et,pe),e(pe,Ko),e(pe,tt),e(tt,Qo),e(pe,Xo),p(t,so,h),b(ue,t,h),p(t,ao,h),p(t,ot,h),e(ot,Yo),p(t,io,h),p(t,ee,h),e(ee,M),e(M,nt),e(nt,Zo),e(M,en),e(M,rt),e(rt,tn),e(M,on),e(M,Bt),e(Bt,nn),e(M,rn),e(ee,sn),e(ee,zt),e(zt,an),p(t,lo,h),p(t,N,h),e(N,dn),e(N,me),e(me,ln),e(N,cn),e(N,fe),e(fe,hn),e(N,pn),p(t,co,h),p(t,W,h),e(W,te),e(te,$t),b(ge,$t,null),e(W,un),e(W,Gt),e(Gt,mn),p(t,ho,h),p(t,$,h),b(_e,$,null),e($,fn),e($,U),e(U,gn),e(U,qt),e(qt,_n),e(U,bn),e(U,be),e(be,vn),e(U,kn),e($,yn),e($,H),e(H,wn),e(H,st),e(st,Tn),e(H,En),e(H,at),e(at,Bn),e(H,zn),e($,$n),e($,Pt),e(Pt,Gn),e($,qn),b(ve,$,null),p(t,po,h),p(t,V,h),e(V,oe),e(oe,xt),b(ke,xt,null),e(V,Pn),e(V,jt),e(jt,xn),p(t,uo,h),p(t,C,h),b(ye,C,null),e(C,jn),e(C,we),e(we,Cn),e(we,Te),e(Te,Dn),e(we,Sn),e(C,An),e(C,Ee),e(Ee,Mn),e(Ee,it),e(it,Nn),e(Ee,Ln),e(C,Fn),e(C,dt),b(Be,dt,null),p(t,mo,h),p(t,J,h),e(J,ne),e(ne,Ct),b(ze,Ct,null),e(J,In),e(J,Dt),e(Dt,On),p(t,fo,h),p(t,f,h),b($e,f,null),e(f,Rn),e(f,St),e(St,Wn),e(f,Un),e(f,Ge),e(Ge,Hn),e(Ge,lt),e(lt,Vn),e(Ge,Jn),e(f,Kn),e(f,qe),e(qe,Qn),e(qe,Pe),e(Pe,Xn),e(qe,Yn),e(f,Zn),e(f,xe),e(xe,er),e(xe,je),e(je,tr),e(xe,or),e(f,nr),e(f,K),e(K,rr),e(K,ct),e(ct,sr),e(K,ar),e(K,Ce),e(Ce,ir),e(K,dr),e(f,lr),e(f,E),e(E,cr),e(E,At),e(At,hr),e(E,pr),e(E,Mt),e(Mt,ur),e(E,mr),e(E,Nt),e(Nt,fr),e(E,gr),e(E,Lt),e(Lt,_r),e(E,br),e(E,Ft),e(Ft,vr),e(E,kr),e(E,It),e(It,yr),e(E,wr),e(f,Tr),e(f,q),b(De,q,null),e(q,Er),e(q,Q),e(Q,Br),e(Q,ht),e(ht,zr),e(Q,$r),e(Q,Ot),e(Ot,Gr),e(Q,qr),e(q,Pr),b(re,q,null),e(q,xr),e(q,Rt),e(Rt,jr),e(q,Cr),b(Se,q,null),p(t,go,h),p(t,X,h),e(X,se),e(se,Wt),b(Ae,Wt,null),e(X,Dr),e(X,Ut),e(Ut,Sr),p(t,_o,h),p(t,G,h),b(Me,G,null),e(G,Ar),e(G,Ne),e(Ne,Mr),e(Ne,Ht),e(Ht,Nr),e(Ne,Lr),e(G,Fr),e(G,Le),e(Le,Ir),e(Le,pt),e(pt,Or),e(Le,Rr),e(G,Wr),e(G,Fe),e(Fe,Ur),e(Fe,Ie),e(Ie,Hr),e(Fe,Vr),e(G,Jr),e(G,P),b(Oe,P,null),e(P,Kr),e(P,Y),e(Y,Qr),e(Y,ut),e(ut,Xr),e(Y,Yr),e(Y,Vt),e(Vt,Zr),e(Y,es),e(P,ts),b(ae,P,null),e(P,os),e(P,Jt),e(Jt,ns),e(P,rs),b(Re,P,null),bo=!0},p(t,[h]){const We={};h&2&&(We.$$scope={dirty:h,ctx:t}),re.$set(We);const Kt={};h&2&&(Kt.$$scope={dirty:h,ctx:t}),ae.$set(Kt)},i(t){bo||(v(w.$$.fragment,t),v(de.$$.fragment,t),v(he.$$.fragment,t),v(ue.$$.fragment,t),v(ge.$$.fragment,t),v(_e.$$.fragment,t),v(ve.$$.fragment,t),v(ke.$$.fragment,t),v(ye.$$.fragment,t),v(Be.$$.fragment,t),v(ze.$$.fragment,t),v($e.$$.fragment,t),v(De.$$.fragment,t),v(re.$$.fragment,t),v(Se.$$.fragment,t),v(Ae.$$.fragment,t),v(Me.$$.fragment,t),v(Oe.$$.fragment,t),v(ae.$$.fragment,t),v(Re.$$.fragment,t),bo=!0)},o(t){k(w.$$.fragment,t),k(de.$$.fragment,t),k(he.$$.fragment,t),k(ue.$$.fragment,t),k(ge.$$.fragment,t),k(_e.$$.fragment,t),k(ve.$$.fragment,t),k(ke.$$.fragment,t),k(ye.$$.fragment,t),k(Be.$$.fragment,t),k(ze.$$.fragment,t),k($e.$$.fragment,t),k(De.$$.fragment,t),k(re.$$.fragment,t),k(Se.$$.fragment,t),k(Ae.$$.fragment,t),k(Me.$$.fragment,t),k(Oe.$$.fragment,t),k(ae.$$.fragment,t),k(Re.$$.fragment,t),bo=!1},d(t){o(u),t&&o(D),t&&o(m),y(w),t&&o(Xt),t&&o(R),y(de),t&&o(Yt),t&&o(A),t&&o(Zt),t&&o(Ke),t&&o(eo),t&&o(Qe),t&&o(to),t&&o(Xe),t&&o(oo),t&&o(Ye),t&&o(no),y(he,t),t&&o(ro),t&&o(et),t&&o(so),y(ue,t),t&&o(ao),t&&o(ot),t&&o(io),t&&o(ee),t&&o(lo),t&&o(N),t&&o(co),t&&o(W),y(ge),t&&o(ho),t&&o($),y(_e),y(ve),t&&o(po),t&&o(V),y(ke),t&&o(uo),t&&o(C),y(ye),y(Be),t&&o(mo),t&&o(J),y(ze),t&&o(fo),t&&o(f),y($e),y(De),y(re),y(Se),t&&o(go),t&&o(X),y(Ae),t&&o(_o),t&&o(G),y(Me),y(Oe),y(ae),y(Re)}}}const Ta={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function Ea(Ve){return va(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Pa extends fa{constructor(u){super();ga(this,u,Ea,wa,_a,{})}}export{Pa as default,Ta as metadata};
