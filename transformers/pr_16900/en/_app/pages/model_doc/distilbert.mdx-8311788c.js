...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16900/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16900/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
contributed by `),Zo=n(Wt,"A",{href:!0,rel:!0});var K1=r(Zo);Fu=i(K1,"kamalkraj"),K1.forEach(t),Du=i(Wt,". The original code can be found "),en=n(Wt,"A",{href:!0,rel:!0});var J1=r(en);Bu=i(J1,"here"),J1.forEach(t),Mu=i(Wt,"."),Wt.forEach(t),yp=d(s),as=n(s,"H2",{class:!0});var hh=r(as);Js=n(hh,"A",{id:!0,class:!0,href:!0});var G1=r(Js);Dl=n(G1,"SPAN",{});var X1=r(Dl);k(tn.$$.fragment,X1),X1.forEach(t),G1.forEach(t),Eu=d(hh),Bl=n(hh,"SPAN",{});var Y1=r(Bl);xu=i(Y1,"DistilBertConfig"),Y1.forEach(t),hh.forEach(t),$p=d(s),Ke=n(s,"DIV",{class:!0});var Rt=r(Ke);k(sn.$$.fragment,Rt),zu=d(Rt),Ct=n(Rt,"P",{});var Ro=r(Ct);ju=i(Ro,"This is the configuration class to store the configuration of a "),bi=n(Ro,"A",{href:!0});var Z1=r(bi);Cu=i(Z1,"DistilBertModel"),Z1.forEach(t),qu=i(Ro," or a "),vi=n(Ro,"A",{href:!0});var e0=r(vi);Pu=i(e0,"TFDistilBertModel"),e0.forEach(t),Au=i(Ro,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
`),on=n(Ro,"A",{href:!0,rel:!0});var t0=r(on);Ou=i(t0,"distilbert-base-uncased"),t0.forEach(t),Nu=i(Ro," architecture."),Ro.forEach(t),Lu=d(Rt),is=n(Rt,"P",{});var nl=r(is);Su=i(nl,"Configuration objects inherit from "),ki=n(nl,"A",{href:!0});var s0=r(ki);Iu=i(s0,"PretrainedConfig"),s0.forEach(t),Wu=i(nl,` and can be used to control the model outputs. Read the
documentation from `),Ti=n(nl,"A",{href:!0});var o0=r(Ti);Ru=i(o0,"PretrainedConfig"),o0.forEach(t),Uu=i(nl," for more information."),nl.forEach(t),Qu=d(Rt),Ml=n(Rt,"P",{});var n0=r(Ml);Hu=i(n0,"Examples:"),n0.forEach(t),Vu=d(Rt),k(nn.$$.fragment,Rt),Rt.forEach(t),Fp=d(s),ls=n(s,"H2",{class:!0});var uh=r(ls);Gs=n(uh,"A",{id:!0,class:!0,href:!0});var r0=r(Gs);El=n(r0,"SPAN",{});var a0=r(El);k(rn.$$.fragment,a0),a0.forEach(t),r0.forEach(t),Ku=d(uh),xl=n(uh,"SPAN",{});var i0=r(xl);Ju=i(i0,"DistilBertTokenizer"),i0.forEach(t),uh.forEach(t),Dp=d(s),_t=n(s,"DIV",{class:!0});var Uo=r(_t);k(an.$$.fragment,Uo),Gu=d(Uo),zl=n(Uo,"P",{});var l0=r(zl);Xu=i(l0,"Construct a DistilBERT tokenizer."),l0.forEach(t),Yu=d(Uo),Xs=n(Uo,"P",{});var kp=r(Xs);wi=n(kp,"A",{href:!0});var d0=r(wi);Zu=i(d0,"DistilBertTokenizer"),d0.forEach(t),em=i(kp," is identical to "),yi=n(kp,"A",{href:!0});var c0=r(yi);tm=i(c0,"BertTokenizer"),c0.forEach(t),sm=i(kp,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),kp.forEach(t),om=d(Uo),ln=n(Uo,"P",{});var mh=r(ln);nm=i(mh,"Refer to superclass "),$i=n(mh,"A",{href:!0});var p0=r($i);rm=i(p0,"BertTokenizer"),p0.forEach(t),am=i(mh," for usage examples and documentation concerning parameters."),mh.forEach(t),Uo.forEach(t),Bp=d(s),ds=n(s,"H2",{class:!0});var fh=r(ds);Ys=n(fh,"A",{id:!0,class:!0,href:!0});var h0=r(Ys);jl=n(h0,"SPAN",{});var u0=r(jl);k(dn.$$.fragment,u0),u0.forEach(t),h0.forEach(t),im=d(fh),Cl=n(fh,"SPAN",{});var m0=r(Cl);lm=i(m0,"DistilBertTokenizerFast"),m0.forEach(t),fh.forEach(t),Mp=d(s),bt=n(s,"DIV",{class:!0});var Qo=r(bt);k(cn.$$.fragment,Qo),dm=d(Qo),pn=n(Qo,"P",{});var gh=r(pn);cm=i(gh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),ql=n(gh,"EM",{});var f0=r(ql);pm=i(f0,"tokenizers"),f0.forEach(t),hm=i(gh," library)."),gh.forEach(t),um=d(Qo),Zs=n(Qo,"P",{});var Tp=r(Zs);Fi=n(Tp,"A",{href:!0});var g0=r(Fi);mm=i(g0,"DistilBertTokenizerFast"),g0.forEach(t),fm=i(Tp," is identical to "),Di=n(Tp,"A",{href:!0});var _0=r(Di);gm=i(_0,"BertTokenizerFast"),_0.forEach(t),_m=i(Tp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Tp.forEach(t),bm=d(Qo),hn=n(Qo,"P",{});var _h=r(hn);vm=i(_h,"Refer to superclass "),Bi=n(_h,"A",{href:!0});var b0=r(Bi);km=i(b0,"BertTokenizerFast"),b0.forEach(t),Tm=i(_h," for usage examples and documentation concerning parameters."),_h.forEach(t),Qo.forEach(t),Ep=d(s),cs=n(s,"H2",{class:!0});var bh=r(cs);eo=n(bh,"A",{id:!0,class:!0,href:!0});var v0=r(eo);Pl=n(v0,"SPAN",{});var k0=r(Pl);k(un.$$.fragment,k0),k0.forEach(t),v0.forEach(t),wm=d(bh),Al=n(bh,"SPAN",{});var T0=r(Al);ym=i(T0,"DistilBertModel"),T0.forEach(t),bh.forEach(t),xp=d(s),Je=n(s,"DIV",{class:!0});var Ut=r(Je);k(mn.$$.fragment,Ut),$m=d(Ut),Ol=n(Ut,"P",{});var w0=r(Ol);Fm=i(w0,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),w0.forEach(t),Dm=d(Ut),fn=n(Ut,"P",{});var vh=r(fn);Bm=i(vh,"This model inherits from "),Mi=n(vh,"A",{href:!0});var y0=r(Mi);Mm=i(y0,"PreTrainedModel"),y0.forEach(t),Em=i(vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vh.forEach(t),xm=d(Ut),gn=n(Ut,"P",{});var kh=r(gn);zm=i(kh,"This model is also a PyTorch "),_n=n(kh,"A",{href:!0,rel:!0});var $0=r(_n);jm=i($0,"torch.nn.Module"),$0.forEach(t),Cm=i(kh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kh.forEach(t),qm=d(Ut),tt=n(Ut,"DIV",{class:!0});var Qt=r(tt);k(bn.$$.fragment,Qt),Pm=d(Qt),ps=n(Qt,"P",{});var rl=r(ps);Am=i(rl,"The "),Ei=n(rl,"A",{href:!0});var F0=r(Ei);Om=i(F0,"DistilBertModel"),F0.forEach(t),Nm=i(rl," forward method, overrides the "),Nl=n(rl,"CODE",{});var D0=r(Nl);Lm=i(D0,"__call__"),D0.forEach(t),Sm=i(rl," special method."),rl.forEach(t),Im=d(Qt),k(to.$$.fragment,Qt),Wm=d(Qt),Ll=n(Qt,"P",{});var B0=r(Ll);Rm=i(B0,"Example:"),B0.forEach(t),Um=d(Qt),k(vn.$$.fragment,Qt),Qt.forEach(t),Ut.forEach(t),zp=d(s),hs=n(s,"H2",{class:!0});var Th=r(hs);so=n(Th,"A",{id:!0,class:!0,href:!0});var M0=r(so);Sl=n(M0,"SPAN",{});var E0=r(Sl);k(kn.$$.fragment,E0),E0.forEach(t),M0.forEach(t),Qm=d(Th),Il=n(Th,"SPAN",{});var x0=r(Il);Hm=i(x0,"DistilBertForMaskedLM"),x0.forEach(t),Th.forEach(t),jp=d(s),Ge=n(s,"DIV",{class:!0});var Ht=r(Ge);k(Tn.$$.fragment,Ht),Vm=d(Ht),wn=n(Ht,"P",{});var wh=r(wn);Km=i(wh,"DistilBert Model with a "),Wl=n(wh,"CODE",{});var z0=r(Wl);Jm=i(z0,"masked language modeling"),z0.forEach(t),Gm=i(wh," head on top."),wh.forEach(t),Xm=d(Ht),yn=n(Ht,"P",{});var yh=r(yn);Ym=i(yh,"This model inherits from "),xi=n(yh,"A",{href:!0});var j0=r(xi);Zm=i(j0,"PreTrainedModel"),j0.forEach(t),ef=i(yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yh.forEach(t),tf=d(Ht),$n=n(Ht,"P",{});var $h=r($n);sf=i($h,"This model is also a PyTorch "),Fn=n($h,"A",{href:!0,rel:!0});var C0=r(Fn);of=i(C0,"torch.nn.Module"),C0.forEach(t),nf=i($h,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),rf=d(Ht),Ie=n(Ht,"DIV",{class:!0});var kt=r(Ie);k(Dn.$$.fragment,kt),af=d(kt),us=n(kt,"P",{});var al=r(us);lf=i(al,"The "),zi=n(al,"A",{href:!0});var q0=r(zi);df=i(q0,"DistilBertForMaskedLM"),q0.forEach(t),cf=i(al," forward method, overrides the "),Rl=n(al,"CODE",{});var P0=r(Rl);pf=i(P0,"__call__"),P0.forEach(t),hf=i(al," special method."),al.forEach(t),uf=d(kt),k(oo.$$.fragment,kt),mf=d(kt),Ul=n(kt,"P",{});var A0=r(Ul);ff=i(A0,"Example:"),A0.forEach(t),gf=d(kt),k(Bn.$$.fragment,kt),_f=d(kt),k(Mn.$$.fragment,kt),kt.forEach(t),Ht.forEach(t),Cp=d(s),ms=n(s,"H2",{class:!0});var Fh=r(ms);no=n(Fh,"A",{id:!0,class:!0,href:!0});var O0=r(no);Ql=n(O0,"SPAN",{});var N0=r(Ql);k(En.$$.fragment,N0),N0.forEach(t),O0.forEach(t),bf=d(Fh),Hl=n(Fh,"SPAN",{});var L0=r(Hl);vf=i(L0,"DistilBertForSequenceClassification"),L0.forEach(t),Fh.forEach(t),qp=d(s),Xe=n(s,"DIV",{class:!0});var Vt=r(Xe);k(xn.$$.fragment,Vt),kf=d(Vt),Vl=n(Vt,"P",{});var S0=r(Vl);Tf=i(S0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),S0.forEach(t),wf=d(Vt),zn=n(Vt,"P",{});var Dh=r(zn);yf=i(Dh,"This model inherits from "),ji=n(Dh,"A",{href:!0});var I0=r(ji);$f=i(I0,"PreTrainedModel"),I0.forEach(t),Ff=i(Dh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dh.forEach(t),Df=d(Vt),jn=n(Vt,"P",{});var Bh=r(jn);Bf=i(Bh,"This model is also a PyTorch "),Cn=n(Bh,"A",{href:!0,rel:!0});var W0=r(Cn);Mf=i(W0,"torch.nn.Module"),W0.forEach(t),Ef=i(Bh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh.forEach(t),xf=d(Vt),ke=n(Vt,"DIV",{class:!0});var qe=r(ke);k(qn.$$.fragment,qe),zf=d(qe),fs=n(qe,"P",{});var il=r(fs);jf=i(il,"The "),Ci=n(il,"A",{href:!0});var R0=r(Ci);Cf=i(R0,"DistilBertForSequenceClassification"),R0.forEach(t),qf=i(il," forward method, overrides the "),Kl=n(il,"CODE",{});var U0=r(Kl);Pf=i(U0,"__call__"),U0.forEach(t),Af=i(il," special method."),il.forEach(t),Of=d(qe),k(ro.$$.fragment,qe),Nf=d(qe),Jl=n(qe,"P",{});var Q0=r(Jl);Lf=i(Q0,"Example of single-label classification:"),Q0.forEach(t),Sf=d(qe),k(Pn.$$.fragment,qe),If=d(qe),k(An.$$.fragment,qe),Wf=d(qe),Gl=n(qe,"P",{});var H0=r(Gl);Rf=i(H0,"Example of multi-label classification:"),H0.forEach(t),Uf=d(qe),k(On.$$.fragment,qe),Qf=d(qe),k(Nn.$$.fragment,qe),qe.forEach(t),Vt.forEach(t),Pp=d(s),gs=n(s,"H2",{class:!0});var Mh=r(gs);ao=n(Mh,"A",{id:!0,class:!0,href:!0});var V0=r(ao);Xl=n(V0,"SPAN",{});var K0=r(Xl);k(Ln.$$.fragment,K0),K0.forEach(t),V0.forEach(t),Hf=d(Mh),Yl=n(Mh,"SPAN",{});var J0=r(Yl);Vf=i(J0,"DistilBertForMultipleChoice"),J0.forEach(t),Mh.forEach(t),Ap=d(s),Ye=n(s,"DIV",{class:!0});var Kt=r(Ye);k(Sn.$$.fragment,Kt),Kf=d(Kt),Zl=n(Kt,"P",{});var G0=r(Zl);Jf=i(G0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),G0.forEach(t),Gf=d(Kt),In=n(Kt,"P",{});var Eh=r(In);Xf=i(Eh,"This model inherits from "),qi=n(Eh,"A",{href:!0});var X0=r(qi);Yf=i(X0,"PreTrainedModel"),X0.forEach(t),Zf=i(Eh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eh.forEach(t),eg=d(Kt),Wn=n(Kt,"P",{});var xh=r(Wn);tg=i(xh,"This model is also a PyTorch "),Rn=n(xh,"A",{href:!0,rel:!0});var Y0=r(Rn);sg=i(Y0,"torch.nn.Module"),Y0.forEach(t),og=i(xh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Kt),st=n(Kt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),Pi=n(ll,"A",{href:!0});var Z0=r(Pi);ig=i(Z0,"DistilBertForMultipleChoice"),Z0.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var ey=r(ed);dg=i(ey,"__call__"),ey.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var ty=r(td);ug=i(ty,"Examples:"),ty.forEach(t),mg=d(Jt),k(Qn.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Op=d(s),bs=n(s,"H2",{class:!0});var zh=r(bs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var sy=r(lo);sd=n(sy,"SPAN",{});var oy=r(sd);k(Hn.$$.fragment,oy),oy.forEach(t),sy.forEach(t),fg=d(zh),od=n(zh,"SPAN",{});var ny=r(od);gg=i(ny,"DistilBertForTokenClassification"),ny.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Vn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var ry=r(nd);bg=i(ry,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
