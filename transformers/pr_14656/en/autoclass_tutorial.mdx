...
Load a tokenizer with [AutoTokenizer.from_pretrained()](/docs/transformers/pr_14656/en/model_doc/auto#transformers.AutoTokenizer.from_pretrained):
...
Load a feature extractor with [AutoFeatureExtractor.from_pretrained()](/docs/transformers/pr_14656/en/model_doc/auto#transformers.AutoFeatureExtractor.from_pretrained):
...
Load a processor with [AutoProcessor.from_pretrained()](/docs/transformers/pr_14656/en/model_doc/auto#transformers.AutoProcessor.from_pretrained):
