...
Whether or not to return a <a href="/docs/transformers/pr_17242/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17242/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<a href="/docs/transformers/pr_17242/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17242/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17242/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17242/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17242/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17242/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17242/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17242/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
general usage and behavior.`),Uv=p(),Sd=s("p"),Hv=a("Finally, this model supports inherent JAX features such as:"),Vv=p(),Mt=s("ul"),Id=s("li"),ga=s("a"),Kv=a("Just-In-Time (JIT) compilation"),Jv=p(),Wd=s("li"),_a=s("a"),Gv=a("Automatic Differentiation"),Xv=p(),Qd=s("li"),ba=s("a"),Yv=a("Vectorization"),Zv=p(),Rd=s("li"),va=s("a"),e2=a("Parallelization"),t2=p(),gt=s("div"),T(ka.$$.fragment),o2=p(),jo=s("p"),s2=a("The "),Ud=s("code"),n2=a("FlaxDistilBertPreTrainedModel"),r2=a(" forward method, overrides the "),Hd=s("code"),a2=a("__call__"),i2=a(" special method."),l2=p(),T(Gs.$$.fragment),d2=p(),T(Xs.$$.fragment),ih=p(),Co=s("h2"),Ys=s("a"),Vd=s("span"),T(Ta.$$.fragment),c2=p(),Kd=s("span"),p2=a("FlaxDistilBertForMaskedLM"),lh=p(),Ee=s("div"),T($a.$$.fragment),h2=p(),wa=s("p"),u2=a("DistilBert Model with a "),Jd=s("code"),f2=a("language modeling"),m2=a(" head on top."),g2=p(),ya=s("p"),_2=a("This model inherits from "),il=s("a"),b2=a("FlaxPreTrainedModel"),v2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k2=p(),Da=s("p"),T2=a("This model is also a Flax Linen "),Fa=s("a"),$2=a("flax.linen.Module"),w2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),y2=p(),Gd=s("p"),D2=a("Finally, this model supports inherent JAX features such as:"),F2=p(),Et=s("ul"),Xd=s("li"),Ba=s("a"),B2=a("Just-In-Time (JIT) compilation"),x2=p(),Yd=s("li"),xa=s("a"),M2=a("Automatic Differentiation"),E2=p(),Zd=s("li"),Ma=s("a"),z2=a("Vectorization"),j2=p(),ec=s("li"),Ea=s("a"),C2=a("Parallelization"),q2=p(),_t=s("div"),T(za.$$.fragment),P2=p(),qo=s("p"),A2=a("The "),tc=s("code"),O2=a("FlaxDistilBertPreTrainedModel"),N2=a(" forward method, overrides the "),oc=s("code"),L2=a("__call__"),S2=a(" special method."),I2=p(),T(Zs.$$.fragment),W2=p(),T(en.$$.fragment),dh=p(),Po=s("h2"),tn=s("a"),sc=s("span"),T(ja.$$.fragment),Q2=p(),nc=s("span"),R2=a("FlaxDistilBertForSequenceClassification"),ch=p(),ze=s("div"),T(Ca.$$.fragment),U2=p(),rc=s("p"),H2=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V2=p(),qa=s("p"),K2=a("This model inherits from "),ll=s("a"),J2=a("FlaxPreTrainedModel"),G2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),X2=p(),Pa=s("p"),Y2=a("This model is also a Flax Linen "),Aa=s("a"),Z2=a("flax.linen.Module"),ek=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);cv=i(Yw,"span start logits"),Yw.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);hv=i(Zw,"span end logits"),Zw.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(Bt),ia=n(Bt,"P",{});var ou=r(ia);mv=i(ou,"This model inherits from "),nl=n(ou,"A",{href:!0});var e1=r(nl);gv=i(e1,"TFPreTrainedModel"),e1.forEach(t),_v=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),bv=h(Bt),la=n(Bt,"P",{});var su=r(la);vv=i(su,"This model is also a "),da=n(su,"A",{href:!0,rel:!0});var t1=r(da);kv=i(t1,"tf.keras.Model"),t1.forEach(t),Tv=i(su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),su.forEach(t),$v=h(Bt),$(Us.$$.fragment,Bt),wv=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Eo=n(Zt,"P",{});var Dl=r(Eo);Dv=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var o1=r(rl);Fv=i(o1,"TFDistilBertForQuestionAnswering"),o1.forEach(t),Bv=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var s1=r(Ad);xv=i(s1,"__call__"),s1.forEach(t),Mv=i(Dl," special method."),Dl.forEach(t),Ev=h(Zt),$(Hs.$$.fragment,Zt),zv=h(Zt),$(Vs.$$.fragment,Zt),jv=h(Zt),$(Ks.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(o),zo=n(o,"H2",{class:!0});var nu=r(zo);Js=n(nu,"A",{id:!0,class:!0,href:!0});var n1=r(Js);Od=n(n1,"SPAN",{});var r1=r(Od);$(pa.$$.fragment,r1),r1.forEach(t),n1.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var a1=r(Nd);qv=i(a1,"FlaxDistilBertModel"),a1.forEach(t),nu.forEach(t),ah=h(o),Me=n(o,"DIV",{class:!0});var ot=r(Me);$(ha.$$.fragment,ot),Pv=h(ot),Ld=n(ot,"P",{});var i1=r(Ld);Av=i(i1,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i1.forEach(t),Ov=h(ot),ua=n(ot,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l1=r(al);Lv=i(l1,"FlaxPreTrainedModel"),l1.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(ot),fa=n(ot,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d1=r(ma);Qv=i(d1,"flax.linen.Module"),d1.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(ot),Sd=n(ot,"P",{});var c1=r(Sd);Hv=i(c1,"Finally, this model supports inherent JAX features such as:"),c1.forEach(t),Vv=h(ot),Mt=n(ot,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p1=r(Id);ga=n(p1,"A",{href:!0,rel:!0});var h1=r(ga);Kv=i(h1,"Just-In-Time (JIT) compilation"),h1.forEach(t),p1.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u1=r(Wd);_a=n(u1,"A",{href:!0,rel:!0});var f1=r(_a);Gv=i(f1,"Automatic Differentiation"),f1.forEach(t),u1.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m1=r(Qd);ba=n(m1,"A",{href:!0,rel:!0});var g1=r(ba);Yv=i(g1,"Vectorization"),g1.forEach(t),m1.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _1=r(Rd);va=n(_1,"A",{href:!0,rel:!0});var b1=r(va);e2=i(b1,"Parallelization"),b1.forEach(t),_1.forEach(t),kn.forEach(t),t2=h(ot),gt=n(ot,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),o2=h(Tn),jo=n(Tn,"P",{});var Fl=r(jo);s2=i(Fl,"The "),Ud=n(Fl,"CODE",{});var v1=r(Ud);n2=i(v1,"FlaxDistilBertPreTrainedModel"),v1.forEach(t),r2=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k1=r(Hd);a2=i(k1,"__call__"),k1.forEach(t),i2=i(Fl," special method."),Fl.forEach(t),l2=h(Tn),$(Gs.$$.fragment,Tn),d2=h(Tn),$(Xs.$$.fragment,Tn),Tn.forEach(t),ot.forEach(t),ih=h(o),Co=n(o,"H2",{class:!0});var iu=r(Co);Ys=n(iu,"A",{id:!0,class:!0,href:!0});var T1=r(Ys);Vd=n(T1,"SPAN",{});var $1=r(Vd);$(Ta.$$.fragment,$1),$1.forEach(t),T1.forEach(t),c2=h(iu),Kd=n(iu,"SPAN",{});var w1=r(Kd);p2=i(w1,"FlaxDistilBertForMaskedLM"),w1.forEach(t),iu.forEach(t),lh=h(o),Ee=n(o,"DIV",{class:!0});var st=r(Ee);$($a.$$.fragment,st),h2=h(st),wa=n(st,"P",{});var lu=r(wa);u2=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y1=r(Jd);f2=i(y1,"language modeling"),y1.forEach(t),m2=i(lu," head on top."),lu.forEach(t),g2=h(st),ya=n(st,"P",{});var du=r(ya);_2=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D1=r(il);b2=i(D1,"FlaxPreTrainedModel"),D1.forEach(t),v2=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),k2=h(st),Da=n(st,"P",{});var cu=r(Da);T2=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var F1=r(Fa);$2=i(F1,"flax.linen.Module"),F1.forEach(t),w2=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),y2=h(st),Gd=n(st,"P",{});var B1=r(Gd);D2=i(B1,"Finally, this model supports inherent JAX features such as:"),B1.forEach(t),F2=h(st),Et=n(st,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var x1=r(Xd);Ba=n(x1,"A",{href:!0,rel:!0});var M1=r(Ba);B2=i(M1,"Just-In-Time (JIT) compilation"),M1.forEach(t),x1.forEach(t),x2=h($n),Yd=n($n,"LI",{});var E1=r(Yd);xa=n(E1,"A",{href:!0,rel:!0});var z1=r(xa);M2=i(z1,"Automatic Differentiation"),z1.forEach(t),E1.forEach(t),E2=h($n),Zd=n($n,"LI",{});var j1=r(Zd);Ma=n(j1,"A",{href:!0,rel:!0});var C1=r(Ma);z2=i(C1,"Vectorization"),C1.forEach(t),j1.forEach(t),j2=h($n),ec=n($n,"LI",{});var q1=r(ec);Ea=n(q1,"A",{href:!0,rel:!0});var P1=r(Ea);C2=i(P1,"Parallelization"),P1.forEach(t),q1.forEach(t),$n.forEach(t),q2=h(st),_t=n(st,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),P2=h(wn),qo=n(wn,"P",{});var Bl=r(qo);A2=i(Bl,"The "),tc=n(Bl,"CODE",{});var A1=r(tc);O2=i(A1,"FlaxDistilBertPreTrainedModel"),A1.forEach(t),N2=i(Bl," forward method, overrides the "),oc=n(Bl,"CODE",{});var O1=r(oc);L2=i(O1,"__call__"),O1.forEach(t),S2=i(Bl," special method."),Bl.forEach(t),I2=h(wn),$(Zs.$$.fragment,wn),W2=h(wn),$(en.$$.fragment,wn),wn.forEach(t),st.forEach(t),dh=h(o),Po=n(o,"H2",{class:!0});var pu=r(Po);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N1=r(tn);sc=n(N1,"SPAN",{});var L1=r(sc);$(ja.$$.fragment,L1),L1.forEach(t),N1.forEach(t),Q2=h(pu),nc=n(pu,"SPAN",{});var S1=r(nc);R2=i(S1,"FlaxDistilBertForSequenceClassification"),S1.forEach(t),pu.forEach(t),ch=h(o),ze=n(o,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),U2=h(nt),rc=n(nt,"P",{});var I1=r(rc);H2=i(I1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I1.forEach(t),V2=h(nt),qa=n(nt,"P",{});var hu=r(qa);K2=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W1=r(ll);J2=i(W1,"FlaxPreTrainedModel"),W1.forEach(t),G2=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),X2=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Y2=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q1=r(Aa);Z2=i(Q1,"flax.linen.Module"),Q1.forEach(t),ek=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var R1=r(ac);ok=i(R1,"Finally, this model supports inherent JAX features such as:"),R1.forEach(t),sk=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U1=r(ic);Oa=n(U1,"A",{href:!0,rel:!0});var H1=r(Oa);nk=i(H1,"Just-In-Time (JIT) compilation"),H1.forEach(t),U1.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var V1=r(lc);Na=n(V1,"A",{href:!0,rel:!0});var K1=r(Na);ak=i(K1,"Automatic Differentiation"),K1.forEach(t),V1.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var J1=r(dc);La=n(J1,"A",{href:!0,rel:!0});var G1=r(La);lk=i(G1,"Vectorization"),G1.forEach(t),J1.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var X1=r(cc);Sa=n(X1,"A",{href:!0,rel:!0});var Y1=r(Sa);ck=i(Y1,"Parallelization"),Y1.forEach(t),X1.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),hk=h(Dn),Ao=n(Dn,"P",{});var xl=r(Ao);uk=i(xl,"The "),pc=n(xl,"CODE",{});var Z1=r(pc);fk=i(Z1,"FlaxDistilBertPreTrainedModel"),Z1.forEach(t),mk=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);gk=i(ey,"__call__"),ey.forEach(t),_k=i(xl," special method."),xl.forEach(t),bk=h(Dn),$(on.$$.fragment,Dn),vk=h(Dn),$(sn.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(o),Oo=n(o,"H2",{class:!0});var fu=r(Oo);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var oy=r(uc);$(Wa.$$.fragment,oy),oy.forEach(t),ty.forEach(t),kk=h(fu),fc=n(fu,"SPAN",{});var sy=r(fc);Tk=i(sy,"FlaxDistilBertForMultipleChoice"),sy.forEach(t),fu.forEach(t),hh=h(o),je=n(o,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),mc=n(rt,"P",{});var ny=r(mc);wk=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jk=h(rt),gc=n(rt,"P",{});var iy=r(gc);Ck=i(iy,"Finally, this model supports inherent JAX features such as:"),iy.forEach(t),qk=h(rt),jt=n(rt,"UL",{});var Fn=r(jt);_c=n(Fn,"LI",{});var ly=r(_c);Va=n(ly,"A",{href:!0,rel:!0});var dy=r(Va);Pk=i(dy,"Just-In-Time (JIT) compilation"),dy.forEach(t),ly.forEach(t),Ak=h(Fn),bc=n(Fn,"LI",{});var cy=r(bc);Ka=n(cy,"A",{href:!0,rel:!0});var py=r(Ka);Ok=i(py,"Automatic Differentiation"),py.forEach(t),cy.forEach(t),Nk=h(Fn),vc=n(Fn,"LI",{});var hy=r(vc);Ja=n(hy,"A",{href:!0,rel:!0});var uy=r(Ja);Lk=i(uy,"Vectorization"),uy.forEach(t),hy.forEach(t),Sk=h(Fn),kc=n(Fn,"LI",{});var fy=r(kc);Ga=n(fy,"A",{href:!0,rel:!0});var my=r(Ga);Ik=i(my,"Parallelization"),my.forEach(t),fy.forEach(t),Fn.forEach(t),Wk=h(rt),vt=n(rt,"DIV",{class:!0});var Bn=r(vt);$(Xa.$$.fragment,Bn),Qk=h(Bn),No=n(Bn,"P",{});var Ml=r(No);Rk=i(Ml,"The "),Tc=n(Ml,"CODE",{});var gy=r(Tc);Uk=i(gy,"FlaxDistilBertPreTrainedModel"),gy.forEach(t),Hk=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _y=r($c);Vk=i(_y,"__call__"),_y.forEach(t),Kk=i(Ml," special method."),Ml.forEach(t),Jk=h(Bn),$(rn.$$.fragment,Bn),Gk=h(Bn),$(an.$$.fragment,Bn),Bn.forEach(t),rt.forEach(t),uh=h(o),Lo=n(o,"H2",{class:!0});var _u=r(Lo);ln=n(_u,"A",{id:!0,class:!0,href:!0});var by=r(ln);wc=n(by,"SPAN",{});var vy=r(wc);$(Ya.$$.fragment,vy),vy.forEach(t),by.forEach(t),Xk=h(_u),yc=n(_u,"SPAN",{});var ky=r(yc);Yk=i(ky,"FlaxDistilBertForTokenClassification"),ky.forEach(t),_u.forEach(t),fh=h(o),Ce=n(o,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Zk=h(at),Dc=n(at,"P",{});var Ty=r(Dc);eT=i(Ty,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ty.forEach(t),tT=h(at),ei=n(at,"P",{});var bu=r(ei);oT=i(bu,"This model inherits from "),cl=n(bu,"A",{href:!0});var $y=r(cl);sT=i($y,"FlaxPreTrainedModel"),$y.forEach(t),nT=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),bu.forEach(t),rT=h(at),ti=n(at,"P",{});var vu=r(ti);aT=i(vu,"This model is also a Flax Linen "),oi=n(vu,"A",{href:!0,rel:!0});var wy=r(oi);iT=i(wy,"flax.linen.Module"),wy.forEach(t),lT=i(vu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),vu.forEach(t),dT=h(at),Fc=n(at,"P",{});var yy=r(Fc);cT=i(yy,"Finally, this model supports inherent JAX features such as:"),yy.forEach(t),pT=h(at),Ct=n(at,"UL",{});var xn=r(Ct);Bc=n(xn,"LI",{});var Dy=r(Bc);si=n(Dy,"A",{href:!0,rel:!0});var Fy=r(si);hT=i(Fy,"Just-In-Time (JIT) compilation"),Fy.forEach(t),Dy.forEach(t),uT=h(xn),xc=n(xn,"LI",{});var By=r(xc);ni=n(By,"A",{href:!0,rel:!0});var xy=r(ni);fT=i(xy,"Automatic Differentiation"),xy.forEach(t),By.forEach(t),mT=h(xn),Mc=n(xn,"LI",{});var My=r(Mc);ri=n(My,"A",{href:!0,rel:!0});var Ey=r(ri);gT=i(Ey,"Vectorization"),Ey.forEach(t),My.forEach(t),_T=h(xn),Ec=n(xn,"LI",{});var zy=r(Ec);ai=n(zy,"A",{href:!0,rel:!0});var jy=r(ai);bT=i(jy,"Parallelization"),jy.forEach(t),zy.forEach(t),xn.forEach(t),vT=h(at),kt=n(at,"DIV",{class:!0});var Mn=r(kt);$(ii.$$.fragment,Mn),kT=h(Mn),So=n(Mn,"P",{});var El=r(So);TT=i(El,"The "),zc=n(El,"CODE",{});var Cy=r(zc);$T=i(Cy,"FlaxDistilBertPreTrainedModel"),Cy.forEach(t),wT=i(El," forward method, overrides the "),jc=n(El,"CODE",{});var qy=r(jc);yT=i(qy,"__call__"),qy.forEach(t),DT=i(El," special method."),El.forEach(t),FT=h(Mn),$(dn.$$.fragment,Mn),BT=h(Mn),$(cn.$$.fragment,Mn),Mn.forEach(t),at.forEach(t),mh=h(o),Io=n(o,"H2",{class:!0});var ku=r(Io);pn=n(ku,"A",{id:!0,class:!0,href:!0});var Py=r(pn);Cc=n(Py,"SPAN",{});var Ay=r(Cc);$(li.$$.fragment,Ay),Ay.forEach(t),Py.forEach(t),xT=h(ku),qc=n(ku,"SPAN",{});var Oy=r(qc);MT=i(Oy,"FlaxDistilBertForQuestionAnswering"),Oy.forEach(t),ku.forEach(t),gh=h(o),qe=n(o,"DIV",{class:!0});var it=r(qe);$(di.$$.fragment,it),ET=h(it),Wo=n(it,"P",{});var zl=r(Wo);zT=i(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
