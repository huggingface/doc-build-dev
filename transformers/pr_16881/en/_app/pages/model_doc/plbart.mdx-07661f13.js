import{S as Kd,i as Qd,s as Yd,e as n,k as l,w as m,t as r,M as Zd,c as s,d as o,m as c,a,x as f,h as i,b as d,F as e,g as h,y as g,q as _,o as b,B as k,v as el}from"../../chunks/vendor-6b77c823.js";import{T as ki}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-1088f2fb.js";import{C as X}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ue}from"../../chunks/IconCopyLink-7a11ce68.js";function tl(me){let u,B,v,L,z;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),L=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var T=a(u);B=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(T,"CODE",{});var F=a(v);L=i(F,"Module"),F.forEach(o),z=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var T=a(u);B=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(T,"CODE",{});var F=a(v);L=i(F,"Module"),F.forEach(o),z=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(y,T){h(y,u,T),e(u,B),e(u,v),e(v,L),e(u,z)},d(y){y&&o(u)}}}function sl(me){let u,B,v,L,z,y,T,F,ts,sn,I,io,os,ns,Fe,ss,as,je,rs,is,an,Y,fe,lo,Ee,ds,co,ls,rn,W,cs,Me,ps,hs,po,us,ms,dn,Mt,fs,ln,St,ho,gs,cn,G,_s,Se,bs,ks,Ae,vs,ys,pn,Z,ge,uo,Ne,Ts,mo,ws,hn,j,Ps,fo,Ls,qs,go,zs,Bs,_o,$s,xs,bo,Cs,Fs,un,_e,js,Oe,Es,Ms,mn,R,Ss,Ie,ko,As,Ns,Os,At,Is,Ds,fn,Nt,vo,Xs,gn,De,_n,Ot,Xe,yo,Ws,Gs,ee,Rs,To,Hs,Us,wo,Vs,Js,bn,We,kn,te,be,Po,Ge,Ks,Lo,Qs,vn,x,Re,Ys,oe,Zs,It,ea,ta,He,oa,na,sa,ne,aa,Dt,ra,ia,Xt,da,la,ca,qo,pa,ha,Ue,yn,se,ke,zo,Ve,ua,Bo,ma,Tn,P,Je,fa,$o,ga,_a,D,ba,Wt,ka,va,Gt,ya,Ta,Ke,wa,Pa,La,Qe,qa,xo,za,Ba,$a,Co,xa,Ca,Ye,Fa,ve,Ze,ja,Fo,Ea,Ma,N,et,Sa,tt,Aa,jo,Na,Oa,Ia,ot,nt,Eo,Da,Xa,Mo,Wa,Ga,st,So,Ra,Ha,Ao,Ua,Va,No,Ja,wn,ae,ye,Oo,at,Ka,Io,Qa,Pn,S,rt,Ya,it,Za,Rt,er,tr,or,dt,nr,lt,sr,ar,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,Te,mr,Xo,fr,gr,pt,Ln,ie,we,Wo,ht,_r,Go,br,qn,A,ut,kr,mt,vr,Ut,yr,Tr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Cr,Ro,Fr,jr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Or,Bn,C,vt,Ir,Jo,Dr,Xr,yt,Wr,Jt,Gr,Rr,Hr,Tt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,si,Qo,ai,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ct,fi,tn,gi,_i,Ft,Cn;return y=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16881/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/configuration_plbart.py#L32"}}),Ue=new X({props:{code:`from transformers import PLBartModel, PLBartConfig
...
BPE-dropout.</li>
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/tokenization_plbart.py#L75"}}),Ye=new X({props:{code:`from transformers import PLBartTokenizer
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/tokenization_plbart.py#L302",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_16881/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/modeling_plbart.py#L1139",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16881/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16881/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/modeling_plbart.py#L1272",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16881/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/modeling_plbart.py#L1411",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16881/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16881/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16881/src/transformers/models/plbart/modeling_plbart.py#L1566",returnDescription:`
<p>A <a
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(y.$$.fragment),T=l(),F=n("span"),ts=r("PLBart"),sn=l(),I=n("p"),io=n("strong"),os=r("DISCLAIMER:"),ns=r(" If you see something strange, file a "),Fe=n("a"),ss=r("Github Issue"),as=r(` and assign
...
documentation from `),Xt=n("a"),da=r("PretrainedConfig"),la=r(" for more information."),ca=l(),qo=n("p"),pa=r("Example:"),ha=l(),m(Ue.$$.fragment),yn=l(),se=n("h2"),ke=n("a"),zo=n("span"),m(Ve.$$.fragment),ua=l(),Bo=n("span"),ma=r("PLBartTokenizer"),Tn=l(),P=n("div"),m(Je.$$.fragment),fa=l(),$o=n("p"),ga=r("Construct an PLBART tokenizer."),_a=l(),D=n("p"),ba=r("Adapted from "),Wt=n("a"),ka=r("RobertaTokenizer"),va=r(" and "),Gt=n("a"),ya=r("XLNetTokenizer"),Ta=r(`. Based on
`),Ke=n("a"),wa=r("SentencePiece"),Pa=r("."),La=l(),Qe=n("p"),qa=r("The tokenization method is "),xo=n("code"),za=r("<tokens> <eos> <language code>"),Ba=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$a=l(),Co=n("p"),xa=r("Examples:"),Ca=l(),m(Ye.$$.fragment),Fa=l(),ve=n("div"),m(Ze.$$.fragment),ja=l(),Fo=n("p"),Ea=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),ae=s(t,"H2",{class:!0});var Gn=a(ae);ye=s(Gn,"A",{id:!0,class:!0,href:!0});var vd=a(ye);Oo=s(vd,"SPAN",{});var yd=a(Oo);f(at.$$.fragment,yd),yd.forEach(o),vd.forEach(o),Ka=c(Gn),Io=s(Gn,"SPAN",{});var Td=a(Io);Qa=i(Td,"PLBartModel"),Td.forEach(o),Gn.forEach(o),Pn=c(t),S=s(t,"DIV",{class:!0});var xe=a(S);f(rt.$$.fragment,xe),Ya=c(xe),it=s(xe,"P",{});var Rn=a(it);Za=i(Rn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
