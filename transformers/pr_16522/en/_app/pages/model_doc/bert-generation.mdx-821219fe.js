...
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(y,w){p(y,u,w),e(u,D),e(u,m),e(m,B),e(u,x)},d(y){y&&o(u)}}}function ba(He){let u,D,m,B,x,y,w,S,Do,Kt,R,Y,kt,ie,So,Tt,Mo,Qt,M,Ao,Ve,No,Lo,de,Fo,Oo,Xt,Je,Io,Yt,Ke,yt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,N,an,ue,dn,ln,me,cn,hn,io,W,ee,Bt,fe,pn,zt,un,lo,$,ge,mn,_e,fn,$t,gn,_n,bn,U,vn,rt,kn,Tn,st,yn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,C,ke,qn,Te,Pn,ye,jn,xn,Cn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,jt,Be,Nn,xt,Ln,uo,f,ze,Fn,Ct,On,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,je,Yn,Zn,er,J,tr,lt,or,nr,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,mr,fr,Nt,gr,_r,Lt,br,vr,kr,q,Ce,Tr,K,yr,ct,wr,Er,Ft,Br,zr,$r,ne,Gr,Ot,qr,Pr,De,mo,Q,re,It,Se,jr,Rt,xr,fo,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Lr,Fr,Or,Le,Ir,Fe,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return y=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16522/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
<code>past_key_values</code>).`,name:"use_cache"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16522/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
`),At=s("code"),mr=n("add_cross_attention"),fr=n(" set to "),Nt=s("code"),gr=n("True"),_r=n("; an "),Lt=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),yr=n("The "),ct=s("a"),wr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Ft=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),Ot=s("p"),qr=n("Example:"),Pr=l(),g(De.$$.fragment),mo=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=n("BertGenerationDecoder"),fo=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=n("BertGeneration Model with a "),Wt=s("code"),Sr=n("language modeling"),Mr=n(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Nr=n("This model inherits from "),ht=s("a"),Lr=n("PreTrainedModel"),Fr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
