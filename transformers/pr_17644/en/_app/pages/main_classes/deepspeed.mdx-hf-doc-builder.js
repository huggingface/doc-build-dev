...
won\u2019t be possible on a single GPU.`),Yj=u(),qt=o("p"),o6=a("\u{1F917} Transformers integrates "),oo=o("a"),l6=a("DeepSpeed"),r6=a(" via 2 options:"),Kj=u(),$t=o("ol"),lo=o("li"),p6=a("Integration of the core DeepSpeed features via "),Lp=o("a"),i6=a("Trainer"),u6=a(`. This is an everything-done-for-you type
...
yourself, core functionality functions like `),pf=o("code"),m6=a("from_pretrained"),_6=a(" and "),uf=o("code"),v6=a("from_config"),j6=a(` include integration of essential
parts of DeepSpeed like `),cf=o("code"),g6=a("zero.Init"),y6=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=o("a"),w6=a("deepspeed-non-trainer-integration"),b6=a("."),Jj=u(),Np=o("p"),E6=a("What is integrated:"),Xj=u(),Hp=o("p"),q6=a("Training:"),Qj=u(),Bp=o("ol"),hf=o("li"),$6=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),eg=u(),Wp=o("p"),k6=a("Inference:"),sg=u(),Fp=o("ol"),ro=o("li"),P6=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),$s=o("h2"),kt=o("a"),ff=o("span"),f(po.$$.fragment),T6=u(),df=o("span"),A6=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),ks=o("h3"),Pt=o("a"),mf=o("span"),f(io.$$.fragment),S6=u(),_f=o("span"),C6=a("Installation"),rg=u(),Xp=o("p"),x6=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R6=a("or via "),vf=o("code"),I6=a("transformers"),U6=a("\u2019 "),jf=o("code"),G6=a("extras"),L6=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M6=a("or find more details on "),ho=o("a"),Z6=a("the DeepSpeed\u2019s GitHub page"),N6=a(` and
`),fo=o("a"),H6=a("advanced install"),B6=a("."),hg=u(),Dt=o("p"),W6=a("If you\u2019re still struggling with the build, first make sure to read "),Qp=o("a"),F6=a("zero-install-notes"),V6=a("."),fg=u(),ei=o("p"),Y6=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),dg=u(),si=o("p"),K6=a("To make a local build for DeepSpeed:"),mg=u(),f(mo.$$.fragment),_g=u(),Re=o("p"),J6=a("If you intend to use NVMe offload you will also need to include "),gf=o("code"),X6=a("DS_BUILD_AIO=1"),Q6=a(` in the instructions above (and also
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),jG=a("DeepSpeed GitHub"),gG=a("."),this.h()},l(e){const p=ZK('[data-svelte="svelte-1phssyn"]',document.head);w=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Gj=r(k);ee=l(Gj,"SPAN",{});var Lj=r(ee);d(z.$$.fragment,Lj),Lj.forEach(t),Gj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var kG=r(se);R=n(kG,"DeepSpeed Integration"),kG.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Mj=r(S);E=l(Mj,"A",{href:!0,rel:!0});var PG=r(E);q=n(PG,"DeepSpeed"),PG.forEach(t),Es=n(Mj," implements everything described in the "),V=l(Mj,"A",{href:!0,rel:!0});var DG=r(V);qs=n(DG,"ZeRO paper"),DG.forEach(t),L4=n(Mj,". Currently it provides full support for:"),Mj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);tf=l(je,"LI",{});var zG=r(tf);M4=n(zG,"Optimizer state partitioning (ZeRO stage 1)"),zG.forEach(t),Z4=c(je),af=l(je,"LI",{});var OG=r(af);N4=n(OG,"Gradient partitioning (ZeRO stage 2)"),OG.forEach(t),H4=c(je),nf=l(je,"LI",{});var TG=r(nf);B4=n(TG,"Parameter partitioning (ZeRO stage 3)"),TG.forEach(t),W4=c(je),of=l(je,"LI",{});var AG=r(of);F4=n(AG,"Custom mixed precision training handling"),AG.forEach(t),V4=c(je),lf=l(je,"LI",{});var SG=r(lf);Y4=n(SG,"A range of fast CUDA-extension-based optimizers"),SG.forEach(t),K4=c(je),rf=l(je,"LI",{});var CG=r(rf);J4=n(CG,"ZeRO-Offload to CPU and NVMe"),CG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X4=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var xG=r(ao);Q4=n(xG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),xG.forEach(t),e6=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var RG=r(no);s6=n(RG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),RG.forEach(t),t6=n(rh,"."),rh.forEach(t),Fj=c(e),Up=l(e,"P",{});var IG=r(Up);a6=n(IG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),IG.forEach(t),Vj=c(e),Gp=l(e,"P",{});var UG=r(Gp);n6=n(UG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),UG.forEach(t),Yj=c(e),qt=l(e,"P",{});var nE=r(qt);o6=n(nE,"\u{1F917} Transformers integrates "),oo=l(nE,"A",{href:!0,rel:!0});var GG=r(oo);l6=n(GG,"DeepSpeed"),GG.forEach(t),r6=n(nE," via 2 options:"),nE.forEach(t),Kj=c(e),$t=l(e,"OL",{});var oE=r($t);lo=l(oE,"LI",{});var lE=r(lo);p6=n(lE,"Integration of the core DeepSpeed features via "),Lp=l(lE,"A",{href:!0});var LG=r(Lp);i6=n(LG,"Trainer"),LG.forEach(t),u6=n(lE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),lE.forEach(t),c6=c(oE),Y=l(oE,"LI",{});var ge=r(Y);h6=n(ge,"If you don\u2019t use "),Mp=l(ge,"A",{href:!0});var MG=r(Mp);f6=n(MG,"Trainer"),MG.forEach(t),d6=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),pf=l(ge,"CODE",{});var ZG=r(pf);m6=n(ZG,"from_pretrained"),ZG.forEach(t),_6=n(ge," and "),uf=l(ge,"CODE",{});var NG=r(uf);v6=n(NG,"from_config"),NG.forEach(t),j6=n(ge,` include integration of essential
parts of DeepSpeed like `),cf=l(ge,"CODE",{});var HG=r(cf);g6=n(HG,"zero.Init"),HG.forEach(t),y6=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=l(ge,"A",{href:!0});var BG=r(Zp);w6=n(BG,"deepspeed-non-trainer-integration"),BG.forEach(t),b6=n(ge,"."),ge.forEach(t),oE.forEach(t),Jj=c(e),Np=l(e,"P",{});var WG=r(Np);E6=n(WG,"What is integrated:"),WG.forEach(t),Xj=c(e),Hp=l(e,"P",{});var FG=r(Hp);q6=n(FG,"Training:"),FG.forEach(t),Qj=c(e),Bp=l(e,"OL",{});var VG=r(Bp);hf=l(VG,"LI",{});var YG=r(hf);$6=n(YG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),YG.forEach(t),VG.forEach(t),eg=c(e),Wp=l(e,"P",{});var KG=r(Wp);k6=n(KG,"Inference:"),KG.forEach(t),sg=c(e),Fp=l(e,"OL",{});var JG=r(Fp);ro=l(JG,"LI",{});var rE=r(ro);P6=n(rE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=l(rE,"A",{href:!0});var XG=r(Vp);D6=n(XG,"deepspeed-zero-inference"),XG.forEach(t),z6=n(rE,"."),rE.forEach(t),JG.forEach(t),tg=c(e),Yp=l(e,"P",{});var QG=r(Yp);O6=n(QG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),QG.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),$s=l(e,"H2",{class:!0});var pE=r($s);kt=l(pE,"A",{id:!0,class:!0,href:!0});var eL=r(kt);ff=l(eL,"SPAN",{});var sL=r(ff);d(po.$$.fragment,sL),sL.forEach(t),eL.forEach(t),T6=c(pE),df=l(pE,"SPAN",{});var tL=r(df);A6=n(tL,"Trainer Deepspeed Integration"),tL.forEach(t),pE.forEach(t),og=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),lg=c(e),ks=l(e,"H3",{class:!0});var iE=r(ks);Pt=l(iE,"A",{id:!0,class:!0,href:!0});var aL=r(Pt);mf=l(aL,"SPAN",{});var nL=r(mf);d(io.$$.fragment,nL),nL.forEach(t),aL.forEach(t),S6=c(iE),_f=l(iE,"SPAN",{});var oL=r(_f);C6=n(oL,"Installation"),oL.forEach(t),iE.forEach(t),rg=c(e),Xp=l(e,"P",{});var lL=r(Xp);x6=n(lL,"Install the library via pypi:"),lL.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),Ce=l(e,"P",{});var ph=r(Ce);R6=n(ph,"or via "),vf=l(ph,"CODE",{});var rL=r(vf);I6=n(rL,"transformers"),rL.forEach(t),U6=n(ph,"\u2019 "),jf=l(ph,"CODE",{});var pL=r(jf);G6=n(pL,"extras"),pL.forEach(t),L6=n(ph,":"),ph.forEach(t),ug=c(e),d(co.$$.fragment,e),cg=c(e),xe=l(e,"P",{});var ih=r(xe);M6=n(ih,"or find more details on "),ho=l(ih,"A",{href:!0,rel:!0});var iL=r(ho);Z6=n(iL,"the DeepSpeed\u2019s GitHub page"),iL.forEach(t),N6=n(ih,` and
`),fo=l(ih,"A",{href:!0,rel:!0});var uL=r(fo);H6=n(uL,"advanced install"),uL.forEach(t),B6=n(ih,"."),ih.forEach(t),hg=c(e),Dt=l(e,"P",{});var uE=r(Dt);W6=n(uE,"If you\u2019re still struggling with the build, first make sure to read "),Qp=l(uE,"A",{href:!0});var cL=r(Qp);F6=n(cL,"zero-install-notes"),cL.forEach(t),V6=n(uE,"."),uE.forEach(t),fg=c(e),ei=l(e,"P",{});var hL=r(ei);Y6=n(hL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),hL.forEach(t),dg=c(e),si=l(e,"P",{});var fL=r(si);K6=n(fL,"To make a local build for DeepSpeed:"),fL.forEach(t),mg=c(e),d(mo.$$.fragment,e),_g=c(e),Re=l(e,"P",{});var uh=r(Re);J6=n(uh,"If you intend to use NVMe offload you will also need to include "),gf=l(uh,"CODE",{});var dL=r(gf);X6=n(dL,"DS_BUILD_AIO=1"),dL.forEach(t),Q6=n(uh,` in the instructions above (and also
