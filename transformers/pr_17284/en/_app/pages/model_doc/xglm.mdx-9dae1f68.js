...
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var X=a(g);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,h,u),e(h,v),e(h,g),e(g,m),e(h,k)},d(l){l&&t(h)}}}function Vd(x){let h,v,g,m,k;return m=new qn({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=n("p"),v=r("Example:"),g=c(),b(m.$$.fragment)},l(l){h=s(l,"P",{});var u=a(h);v=i(u,"Example:"),u.forEach(t),g=p(l),y(m.$$.fragment,l)},m(l,u){_(l,h,u),e(h,v),_(l,g,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){T(m.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(g),L(m,l)}}}function Ud(x){let h,v,g,m,k;return{c(){h=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=s(l,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var X=a(g);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/tokenization_xglm.py#L189",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/tokenization_xglm.py#L214",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/tokenization_xglm_fast.py#L139",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/tokenization_xglm_fast.py#L164",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_17284/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.</p>
<p>Args &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17284/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/modeling_xglm.py#L591",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17284/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17284/en/model_doc/xglm#transformers.XGLMConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/modeling_xglm.py#L852",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17284/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/modeling_flax_xglm.py#L625",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17284/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17284/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17284/src/transformers/models/xglm/modeling_flax_xglm.py#L625",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17284/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`}}),Pe=new ys({props:{$$slots:{default:[Jd]},$$scope:{ctx:x}}}),je=new Xn({props:{anchor:"transformers.FlaxXGLMForCausalLM.__call__.example",$$slots:{default:[Kd]},$$scope:{ctx:x}}}),{c(){h=n("meta"),v=c(),g=n("h1"),m=n("a"),k=n("span"),b(l.$$.fragment),u=c(),X=n("span"),Ms=r("XGLM"),Fn=c(),ee=n("h2"),fe=n("a"),zo=n("span"),b(Re.$$.fragment),ws=c(),Xo=n("span"),Ts=r("Overview"),En=c(),ge=n("p"),Ls=r("The XGLM model was proposed in "),Ve=n("a"),xs=r("Few-shot Learning with Multilingual Language Models"),$s=r(`
...
and behavior.`),hr=c(),Le=n("p"),ur=r("Transformer decoder consisting of "),Jo=n("em"),mr=r("config.num_layers"),fr=r(" layers. Each layer is a "),Ko=n("code"),gr=r("XGLMDecoderLayer"),_r=c(),I=n("div"),b(bt.$$.fragment),kr=c(),ie=n("p"),vr=r("The "),mo=n("a"),br=r("XGLMModel"),yr=r(" forward method, overrides the "),Zo=n("code"),Mr=r("__call__"),wr=r(" special method."),Tr=c(),b(xe.$$.fragment),Lr=c(),b($e.$$.fragment),Rn=c(),le=n("h2"),ze=n("a"),Qo=n("span"),b(yt.$$.fragment),xr=c(),Yo=n("span"),$r=r("XGLMForCausalLM"),Vn=c(),C=n("div"),b(Mt.$$.fragment),zr=c(),en=n("p"),Xr=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
showing in particular that it enables cross-lingual in-context learning on some tasks, while there is still room for improvement
on surface form robustness and adaptation to tasks that do not have a natural cloze form. Finally, we evaluate our models
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),rl.forEach(t),al.forEach(t),jn=p(o),U=s(o,"P",{});var vo=a(U);Gs=i(vo,"This model was contributed by "),Ue=s(vo,"A",{href:!0,rel:!0});var il=a(Ue);qs=i(il,"Suraj"),il.forEach(t),Fs=i(vo,". The original code can be found "),He=s(vo,"A",{href:!0,rel:!0});var ll=a(He);Es=i(ll,"here"),ll.forEach(t),Cs=i(vo,"."),vo.forEach(t),An=p(o),te=s(o,"H2",{class:!0});var Qn=a(te);_e=s(Qn,"A",{id:!0,class:!0,href:!0});var dl=a(_e);qo=s(dl,"SPAN",{});var cl=a(qo);y(Je.$$.fragment,cl),cl.forEach(t),dl.forEach(t),Ps=p(Qn),Fo=s(Qn,"SPAN",{});var pl=a(Fo);js=i(pl,"XGLMConfig"),pl.forEach(t),Qn.forEach(t),On=p(o),A=s(o,"DIV",{class:!0});var Ae=a(A);y(Ke.$$.fragment,Ae),As=p(Ae),oe=s(Ae,"P",{});var bo=a(oe);Os=i(bo,"This is the configuration class to store the configuration of a "),Qt=s(bo,"A",{href:!0});var hl=a(Qt);Is=i(hl,"XGLMModel"),hl.forEach(t),Ds=i(bo,`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
...
documentation from `),eo=s(yo,"A",{href:!0});var fl=a(eo);Us=i(fl,"PretrainedConfig"),fl.forEach(t),Hs=i(yo," for more information."),yo.forEach(t),Js=p(Ae),y(ke.$$.fragment,Ae),Ae.forEach(t),In=p(o),se=s(o,"H2",{class:!0});var Yn=a(se);ve=s(Yn,"A",{id:!0,class:!0,href:!0});var gl=a(ve);Eo=s(gl,"SPAN",{});var _l=a(Eo);y(Qe.$$.fragment,_l),_l.forEach(t),gl.forEach(t),Ks=p(Yn),Co=s(Yn,"SPAN",{});var kl=a(Co);Zs=i(kl,"XGLMTokenizer"),kl.forEach(t),Yn.forEach(t),Dn=p(o),$=s(o,"DIV",{class:!0});var P=a($);y(Ye.$$.fragment,P),Qs=p(P),B=s(P,"P",{});var Oe=a(B);Ys=i(Oe,"Adapted from "),to=s(Oe,"A",{href:!0});var vl=a(to);ea=i(vl,"RobertaTokenizer"),vl.forEach(t),ta=i(Oe," and "),oo=s(Oe,"A",{href:!0});var bl=a(oo);oa=i(bl,"XLNetTokenizer"),bl.forEach(t),na=i(Oe,`. Based on
