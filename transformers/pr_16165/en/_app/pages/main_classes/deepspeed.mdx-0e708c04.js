...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16165/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16165/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16165/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16165/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16165/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
install `),jf=o("em"),K$=a("libaio-dev"),J$=a(" system-wide)."),mg=u(),Dt=o("p"),X$=a("Edit "),gf=o("code"),Q$=a("TORCH_CUDA_ARCH_LIST"),e5=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_g=u(),f(mo.$$.fragment),vg=u(),Pe=o("p"),s5=a("So if you get "),wf=o("code"),t5=a("8, 6"),a5=a(", then use "),yf=o("code"),n5=a('TORCH_CUDA_ARCH_LIST="8.6"'),o5=a(`. If you have multiple different cards, you can list all
of them like so `),bf=o("code"),l5=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),jg=u(),si=o("p"),r5=a("If you need to use the same setup on multiple machines, make a binary wheel:"),gg=u(),f(_o.$$.fragment),wg=u(),Ie=o("p"),p5=a("it will generate something like "),Ef=o("code"),i5=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),u5=a(` which now you can install
as `),qf=o("code"),c5=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),h5=a(" locally or on any other machine."),yg=u(),zt=o("p"),f5=a("Again, remember to ensure to adjust "),$f=o("code"),d5=a("TORCH_CUDA_ARCH_LIST"),m5=a(" to the target architectures."),bg=u(),Ue=o("p"),_5=a("You can find the complete list of NVIDIA GPUs and their corresponding "),kf=o("strong"),v5=a("Compute Capabilities"),j5=a(` (same as arch in this
context) `),vo=o("a"),g5=a("here"),w5=a("."),Eg=u(),ti=o("p"),y5=a("You can check the archs pytorch was built with using:"),qg=u(),f(jo.$$.fragment),$g=u(),ai=o("p"),b5=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),E5=a("If the output is:"),Dg=u(),f(wo.$$.fragment),zg=u(),Ot=o("p"),q5=a("then you know that this card\u2019s arch is "),Pf=o("code"),$5=a("8.6"),k5=a("."),Og=u(),Tt=o("p"),P5=a("You can also leave "),Df=o("code"),D5=a("TORCH_CUDA_ARCH_LIST"),z5=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Tg=u(),At=o("p"),O5=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),yo=o("a"),T5=a("Deepspeed"),A5=a(","),Ag=u(),oi=o("a"),Sg=u(),Ds=o("h3"),St=o("a"),zf=o("span"),f(bo.$$.fragment),S5=u(),Of=o("span"),C5=a("Deployment with multiple GPUs"),Cg=u(),Ct=o("p"),x5=a("To deploy this feature with multiple GPUs adjust the "),li=o("a"),R5=a("Trainer"),I5=a(` command line arguments as
following:`),xg=u(),xt=o("ol"),zs=o("li"),U5=a("replace "),Tf=o("code"),G5=a("python -m torch.distributed.launch"),L5=a(" with "),Af=o("code"),M5=a("deepspeed"),Z5=a("."),N5=u(),De=o("li"),H5=a("add a new argument "),Sf=o("code"),B5=a("--deepspeed ds_config.json"),W5=a(", where "),Cf=o("code"),F5=a("ds_config.json"),V5=a(` is the DeepSpeed configuration file as
documented `),Eo=o("a"),Y5=a("here"),K5=a(". The file naming is up to you."),Rg=u(),ri=o("p"),J5=a("Therefore, if your original command line looked as follows:"),Ig=u(),f(qo.$$.fragment),Ug=u(),pi=o("p"),X5=a("Now it should be:"),Gg=u(),f($o.$$.fragment),Lg=u(),U=o("p"),Q5=a("Unlike, "),xf=o("code"),e4=a("torch.distributed.launch"),s4=a(" where you have to specify how many GPUs to use with "),Rf=o("code"),t4=a("--nproc_per_node"),a4=a(`, with the
`),If=o("code"),n4=a("deepspeed"),o4=a(" launcher you don\u2019t have to use the corresponding "),Uf=o("code"),l4=a("--num_gpus"),r4=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),ko=o("a"),p4=a("here"),i4=a("."),Mg=u(),ne=o("p"),u4=a("In fact, you can continue using "),Gf=o("code"),c4=a("-m torch.distributed.launch"),h4=a(` with DeepSpeed as long as you don\u2019t need to use
`),Lf=o("code"),f4=a("deepspeed"),d4=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Mf=o("code"),m4=a("deepspeed"),_4=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zg=u(),Rt=o("p"),v4=a("Here is an example of running "),Zf=o("code"),j4=a("run_translation.py"),g4=a(" under DeepSpeed deploying all available GPUs:"),Ng=u(),f(Po.$$.fragment),Hg=u(),It=o("p"),w4=a("Note that in the DeepSpeed documentation you are likely to see "),Nf=o("code"),y4=a("--deepspeed --deepspeed_config ds_config.json"),b4=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Bg=u(),Ut=o("p"),E4=a("For some practical usage examples, please, see this "),Do=o("a"),q4=a("post"),$4=a("."),Wg=u(),ii=o("a"),Fg=u(),Os=o("h3"),Gt=o("a"),Hf=o("span"),f(zo.$$.fragment),k4=u(),Bf=o("span"),P4=a("Deployment with one GPU"),Vg=u(),Lt=o("p"),D4=a("To deploy DeepSpeed with one GPU adjust the "),ui=o("a"),z4=a("Trainer"),O4=a(" command line arguments as follows:"),Yg=u(),f(Oo.$$.fragment),Kg=u(),Ge=o("p"),T4=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Wf=o("code"),A4=a("--num_gpus=1"),S4=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),To=o("a"),C4=a("documentation"),x4=a(" discusses the launcher options."),Jg=u(),ci=o("p"),R4=a("Why would you want to use DeepSpeed with just one GPU?"),Xg=u(),Mt=o("ol"),Ff=o("li"),I4=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),U4=u(),Vf=o("li"),G4=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),Qg=u(),hi=o("p"),L4=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),ew=u(),f(Ao.$$.fragment),sw=u(),fi=o("p"),M4=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),tw=u(),Zt=o("p"),Z4=a("For a practical usage example of this type of deployment, please, see this "),So=o("a"),N4=a("post"),H4=a("."),aw=u(),di=o("p"),B4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),nw=u(),mi=o("p"),W4=a("Notes:"),ow=u(),_i=o("ul"),Ts=o("li"),Co=o("p"),F4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Yf=o("code"),V4=a("CUDA_VISIBLE_DEVICES"),Y4=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),K4=u(),f(xo.$$.fragment),J4=u(),Kf=o("p"),X4=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),lw=u(),vi=o("a"),rw=u(),As=o("h3"),Nt=o("a"),Jf=o("span"),f(Ro.$$.fragment),Q4=u(),Xf=o("span"),e8=a("Deployment in Notebooks"),pw=u(),Ht=o("p"),s8=a("The problem with running notebook cells as a script is that there is no normal "),Qf=o("code"),t8=a("deepspeed"),a8=a(` launcher to rely on, so
...
install `),jf=l(ih,"EM",{});var rL=r(jf);K$=n(rL,"libaio-dev"),rL.forEach(t),J$=n(ih," system-wide)."),ih.forEach(t),mg=c(e),Dt=l(e,"P",{});var pE=r(Dt);X$=n(pE,"Edit "),gf=l(pE,"CODE",{});var pL=r(gf);Q$=n(pL,"TORCH_CUDA_ARCH_LIST"),pL.forEach(t),e5=n(pE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),pE.forEach(t),_g=c(e),d(mo.$$.fragment,e),vg=c(e),Pe=l(e,"P",{});var Tp=r(Pe);s5=n(Tp,"So if you get "),wf=l(Tp,"CODE",{});var iL=r(wf);t5=n(iL,"8, 6"),iL.forEach(t),a5=n(Tp,", then use "),yf=l(Tp,"CODE",{});var uL=r(yf);n5=n(uL,'TORCH_CUDA_ARCH_LIST="8.6"'),uL.forEach(t),o5=n(Tp,`. If you have multiple different cards, you can list all
of them like so `),bf=l(Tp,"CODE",{});var cL=r(bf);l5=n(cL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),cL.forEach(t),Tp.forEach(t),jg=c(e),si=l(e,"P",{});var hL=r(si);r5=n(hL,"If you need to use the same setup on multiple machines, make a binary wheel:"),hL.forEach(t),gg=c(e),d(_o.$$.fragment,e),wg=c(e),Ie=l(e,"P",{});var uh=r(Ie);p5=n(uh,"it will generate something like "),Ef=l(uh,"CODE",{});var fL=r(Ef);i5=n(fL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),fL.forEach(t),u5=n(uh,` which now you can install
as `),qf=l(uh,"CODE",{});var dL=r(qf);c5=n(dL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),dL.forEach(t),h5=n(uh," locally or on any other machine."),uh.forEach(t),yg=c(e),zt=l(e,"P",{});var iE=r(zt);f5=n(iE,"Again, remember to ensure to adjust "),$f=l(iE,"CODE",{});var mL=r($f);d5=n(mL,"TORCH_CUDA_ARCH_LIST"),mL.forEach(t),m5=n(iE," to the target architectures."),iE.forEach(t),bg=c(e),Ue=l(e,"P",{});var ch=r(Ue);_5=n(ch,"You can find the complete list of NVIDIA GPUs and their corresponding "),kf=l(ch,"STRONG",{});var _L=r(kf);v5=n(_L,"Compute Capabilities"),_L.forEach(t),j5=n(ch,` (same as arch in this
context) `),vo=l(ch,"A",{href:!0,rel:!0});var vL=r(vo);g5=n(vL,"here"),vL.forEach(t),w5=n(ch,"."),ch.forEach(t),Eg=c(e),ti=l(e,"P",{});var jL=r(ti);y5=n(jL,"You can check the archs pytorch was built with using:"),jL.forEach(t),qg=c(e),d(jo.$$.fragment,e),$g=c(e),ai=l(e,"P",{});var gL=r(ai);b5=n(gL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),gL.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var wL=r(ni);E5=n(wL,"If the output is:"),wL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),Ot=l(e,"P",{});var uE=r(Ot);q5=n(uE,"then you know that this card\u2019s arch is "),Pf=l(uE,"CODE",{});var yL=r(Pf);$5=n(yL,"8.6"),yL.forEach(t),k5=n(uE,"."),uE.forEach(t),Og=c(e),Tt=l(e,"P",{});var cE=r(Tt);P5=n(cE,"You can also leave "),Df=l(cE,"CODE",{});var bL=r(Df);D5=n(bL,"TORCH_CUDA_ARCH_LIST"),bL.forEach(t),z5=n(cE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),cE.forEach(t),Tg=c(e),At=l(e,"P",{});var hE=r(At);O5=n(hE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),yo=l(hE,"A",{href:!0,rel:!0});var EL=r(yo);T5=n(EL,"Deepspeed"),EL.forEach(t),A5=n(hE,","),hE.forEach(t),Ag=c(e),oi=l(e,"A",{id:!0}),r(oi).forEach(t),Sg=c(e),Ds=l(e,"H3",{class:!0});var fE=r(Ds);St=l(fE,"A",{id:!0,class:!0,href:!0});var qL=r(St);zf=l(qL,"SPAN",{});var $L=r(zf);d(bo.$$.fragment,$L),$L.forEach(t),qL.forEach(t),S5=c(fE),Of=l(fE,"SPAN",{});var kL=r(Of);C5=n(kL,"Deployment with multiple GPUs"),kL.forEach(t),fE.forEach(t),Cg=c(e),Ct=l(e,"P",{});var dE=r(Ct);x5=n(dE,"To deploy this feature with multiple GPUs adjust the "),li=l(dE,"A",{href:!0});var PL=r(li);R5=n(PL,"Trainer"),PL.forEach(t),I5=n(dE,` command line arguments as
following:`),dE.forEach(t),xg=c(e),xt=l(e,"OL",{});var mE=r(xt);zs=l(mE,"LI",{});var hh=r(zs);U5=n(hh,"replace "),Tf=l(hh,"CODE",{});var DL=r(Tf);G5=n(DL,"python -m torch.distributed.launch"),DL.forEach(t),L5=n(hh," with "),Af=l(hh,"CODE",{});var zL=r(Af);M5=n(zL,"deepspeed"),zL.forEach(t),Z5=n(hh,"."),hh.forEach(t),N5=c(mE),De=l(mE,"LI",{});var Ln=r(De);H5=n(Ln,"add a new argument "),Sf=l(Ln,"CODE",{});var OL=r(Sf);B5=n(OL,"--deepspeed ds_config.json"),OL.forEach(t),W5=n(Ln,", where "),Cf=l(Ln,"CODE",{});var TL=r(Cf);F5=n(TL,"ds_config.json"),TL.forEach(t),V5=n(Ln,` is the DeepSpeed configuration file as
documented `),Eo=l(Ln,"A",{href:!0,rel:!0});var AL=r(Eo);Y5=n(AL,"here"),AL.forEach(t),K5=n(Ln,". The file naming is up to you."),Ln.forEach(t),mE.forEach(t),Rg=c(e),ri=l(e,"P",{});var SL=r(ri);J5=n(SL,"Therefore, if your original command line looked as follows:"),SL.forEach(t),Ig=c(e),d(qo.$$.fragment,e),Ug=c(e),pi=l(e,"P",{});var CL=r(pi);X5=n(CL,"Now it should be:"),CL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),U=l(e,"P",{});var we=r(U);Q5=n(we,"Unlike, "),xf=l(we,"CODE",{});var xL=r(xf);e4=n(xL,"torch.distributed.launch"),xL.forEach(t),s4=n(we," where you have to specify how many GPUs to use with "),Rf=l(we,"CODE",{});var RL=r(Rf);t4=n(RL,"--nproc_per_node"),RL.forEach(t),a4=n(we,`, with the
`),If=l(we,"CODE",{});var IL=r(If);n4=n(IL,"deepspeed"),IL.forEach(t),o4=n(we," launcher you don\u2019t have to use the corresponding "),Uf=l(we,"CODE",{});var UL=r(Uf);l4=n(UL,"--num_gpus"),UL.forEach(t),r4=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),ko=l(we,"A",{href:!0,rel:!0});var GL=r(ko);p4=n(GL,"here"),GL.forEach(t),i4=n(we,"."),we.forEach(t),Mg=c(e),ne=l(e,"P",{});var Mn=r(ne);u4=n(Mn,"In fact, you can continue using "),Gf=l(Mn,"CODE",{});var LL=r(Gf);c4=n(LL,"-m torch.distributed.launch"),LL.forEach(t),h4=n(Mn,` with DeepSpeed as long as you don\u2019t need to use
`),Lf=l(Mn,"CODE",{});var ML=r(Lf);f4=n(ML,"deepspeed"),ML.forEach(t),d4=n(Mn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Mf=l(Mn,"CODE",{});var ZL=r(Mf);m4=n(ZL,"deepspeed"),ZL.forEach(t),_4=n(Mn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Mn.forEach(t),Zg=c(e),Rt=l(e,"P",{});var _E=r(Rt);v4=n(_E,"Here is an example of running "),Zf=l(_E,"CODE",{});var NL=r(Zf);j4=n(NL,"run_translation.py"),NL.forEach(t),g4=n(_E," under DeepSpeed deploying all available GPUs:"),_E.forEach(t),Ng=c(e),d(Po.$$.fragment,e),Hg=c(e),It=l(e,"P",{});var vE=r(It);w4=n(vE,"Note that in the DeepSpeed documentation you are likely to see "),Nf=l(vE,"CODE",{});var HL=r(Nf);y4=n(HL,"--deepspeed --deepspeed_config ds_config.json"),HL.forEach(t),b4=n(vE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),vE.forEach(t),Bg=c(e),Ut=l(e,"P",{});var jE=r(Ut);E4=n(jE,"For some practical usage examples, please, see this "),Do=l(jE,"A",{href:!0,rel:!0});var BL=r(Do);q4=n(BL,"post"),BL.forEach(t),$4=n(jE,"."),jE.forEach(t),Wg=c(e),ii=l(e,"A",{id:!0}),r(ii).forEach(t),Fg=c(e),Os=l(e,"H3",{class:!0});var gE=r(Os);Gt=l(gE,"A",{id:!0,class:!0,href:!0});var WL=r(Gt);Hf=l(WL,"SPAN",{});var FL=r(Hf);d(zo.$$.fragment,FL),FL.forEach(t),WL.forEach(t),k4=c(gE),Bf=l(gE,"SPAN",{});var VL=r(Bf);P4=n(VL,"Deployment with one GPU"),VL.forEach(t),gE.forEach(t),Vg=c(e),Lt=l(e,"P",{});var wE=r(Lt);D4=n(wE,"To deploy DeepSpeed with one GPU adjust the "),ui=l(wE,"A",{href:!0});var YL=r(ui);z4=n(YL,"Trainer"),YL.forEach(t),O4=n(wE," command line arguments as follows:"),wE.forEach(t),Yg=c(e),d(Oo.$$.fragment,e),Kg=c(e),Ge=l(e,"P",{});var fh=r(Ge);T4=n(fh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Wf=l(fh,"CODE",{});var KL=r(Wf);A4=n(KL,"--num_gpus=1"),KL.forEach(t),S4=n(fh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),To=l(fh,"A",{href:!0,rel:!0});var JL=r(To);C4=n(JL,"documentation"),JL.forEach(t),x4=n(fh," discusses the launcher options."),fh.forEach(t),Jg=c(e),ci=l(e,"P",{});var XL=r(ci);R4=n(XL,"Why would you want to use DeepSpeed with just one GPU?"),XL.forEach(t),Xg=c(e),Mt=l(e,"OL",{});var yE=r(Mt);Ff=l(yE,"LI",{});var QL=r(Ff);I4=n(QL,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),QL.forEach(t),U4=c(yE),Vf=l(yE,"LI",{});var eM=r(Vf);G4=n(eM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),eM.forEach(t),yE.forEach(t),Qg=c(e),hi=l(e,"P",{});var sM=r(hi);L4=n(sM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),sM.forEach(t),ew=c(e),d(Ao.$$.fragment,e),sw=c(e),fi=l(e,"P",{});var tM=r(fi);M4=n(tM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),tM.forEach(t),tw=c(e),Zt=l(e,"P",{});var bE=r(Zt);Z4=n(bE,"For a practical usage example of this type of deployment, please, see this "),So=l(bE,"A",{href:!0,rel:!0});var aM=r(So);N4=n(aM,"post"),aM.forEach(t),H4=n(bE,"."),bE.forEach(t),aw=c(e),di=l(e,"P",{});var nM=r(di);B4=n(nM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),nM.forEach(t),nw=c(e),mi=l(e,"P",{});var oM=r(mi);W4=n(oM,"Notes:"),oM.forEach(t),ow=c(e),_i=l(e,"UL",{});var lM=r(_i);Ts=l(lM,"LI",{});var dh=r(Ts);Co=l(dh,"P",{});var EE=r(Co);F4=n(EE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Yf=l(EE,"CODE",{});var rM=r(Yf);V4=n(rM,"CUDA_VISIBLE_DEVICES"),rM.forEach(t),Y4=n(EE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),EE.forEach(t),K4=c(dh),d(xo.$$.fragment,dh),J4=c(dh),Kf=l(dh,"P",{});var pM=r(Kf);X4=n(pM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pM.forEach(t),dh.forEach(t),lM.forEach(t),lw=c(e),vi=l(e,"A",{id:!0}),r(vi).forEach(t),rw=c(e),As=l(e,"H3",{class:!0});var qE=r(As);Nt=l(qE,"A",{id:!0,class:!0,href:!0});var iM=r(Nt);Jf=l(iM,"SPAN",{});var uM=r(Jf);d(Ro.$$.fragment,uM),uM.forEach(t),iM.forEach(t),Q4=c(qE),Xf=l(qE,"SPAN",{});var cM=r(Xf);e8=n(cM,"Deployment in Notebooks"),cM.forEach(t),qE.forEach(t),pw=c(e),Ht=l(e,"P",{});var $E=r(Ht);s8=n($E,"The problem with running notebook cells as a script is that there is no normal "),Qf=l($E,"CODE",{});var hM=r(Qf);t8=n(hM,"deepspeed"),hM.forEach(t),a8=n($E,` launcher to rely on, so
