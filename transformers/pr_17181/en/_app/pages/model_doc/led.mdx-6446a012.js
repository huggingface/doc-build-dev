...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17181/src/transformers/models/led/modeling_led.py#L2326",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17181/src/transformers/models/led/modeling_led.py#L2486",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17181/src/transformers/models/led/modeling_led.py#L2613",returnDescription:`
<p>A <a
...
This model inherits from `),os=a("a"),Ll=n("PreTrainedModel"),ql=n(`. See the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$l=c(),an=a("p"),Dl=n("This model is also a PyTorch "),rn=a("a"),Fl=n("torch.nn.Module"),zl=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage
and behavior.`),xl=c(),xe=a("div"),v(dn.$$.fragment),Sl=c(),Et=a("p"),Ml=n("The "),ns=a("a"),Cl=n("LEDModel"),Ol=n(" forward method, overrides the "),ia=a("code"),jl=n("__call__"),Al=n(" special method."),Pl=c(),v(Rt.$$.fragment),Nl=c(),v(Ut.$$.fragment),ir=c(),Lt=a("h2"),Xt=a("a"),la=a("span"),v(ln.$$.fragment),Il=c(),ca=a("span"),Gl=n("LEDForConditionalGeneration"),lr=c(),Le=a("div"),v(cn.$$.fragment),Bl=c(),hn=a("p"),Ql=n(`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ss=a("a"),Wl=n("PreTrainedModel"),Hl=n(`. See the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vl=c(),pn=a("p"),Rl=n("This model is also a PyTorch "),un=a("a"),Ul=n("torch.nn.Module"),Xl=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage
and behavior.`),Jl=c(),fe=a("div"),v(mn.$$.fragment),Zl=c(),qt=a("p"),Kl=n("The "),as=a("a"),Yl=n("LEDForConditionalGeneration"),ec=n(" forward method, overrides the "),ha=a("code"),tc=n("__call__"),oc=n(" special method."),nc=c(),v(Jt.$$.fragment),sc=c(),v(Zt.$$.fragment),ac=c(),v(Kt.$$.fragment),cr=c(),$t=a("h2"),Yt=a("a"),pa=a("span"),v(fn.$$.fragment),rc=c(),ua=a("span"),dc=n("LEDForSequenceClassification"),hr=c(),ie=a("div"),v(_n.$$.fragment),ic=c(),ma=a("p"),lc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),cc=c(),gn=a("p"),hc=n("This model inherits from "),rs=a("a"),pc=n("PreTrainedModel"),uc=n(`. See the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mc=c(),bn=a("p"),fc=n("This model is also a PyTorch "),Tn=a("a"),_c=n("torch.nn.Module"),gc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage
and behavior.`),bc=c(),B=a("div"),v(vn.$$.fragment),Tc=c(),Dt=a("p"),vc=n("The "),ds=a("a"),kc=n("LEDForSequenceClassification"),wc=n(" forward method, overrides the "),fa=a("code"),yc=n("__call__"),Ec=n(" special method."),Lc=c(),v(eo.$$.fragment),qc=c(),v(to.$$.fragment),$c=c(),v(oo.$$.fragment),Dc=c(),v(no.$$.fragment),Fc=c(),v(so.$$.fragment),pr=c(),Ft=a("h2"),ao=a("a"),_a=a("span"),v(kn.$$.fragment),zc=c(),ga=a("span"),xc=n("LEDForQuestionAnswering"),ur=c(),le=a("div"),v(wn.$$.fragment),Sc=c(),zt=a("p"),Mc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=a("code"),Cc=n("span start logits"),Oc=n(" and "),Ta=a("code"),jc=n("span end logits"),Ac=n(")."),Pc=c(),yn=a("p"),Nc=n("This model inherits from "),is=a("a"),Ic=n("PreTrainedModel"),Gc=n(`. See the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bc=c(),En=a("p"),Qc=n("This model is also a PyTorch "),Ln=a("a"),Wc=n("torch.nn.Module"),Hc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage
and behavior.`),Vc=c(),_e=a("div"),v(qn.$$.fragment),Rc=c(),xt=a("p"),Uc=n("The "),ls=a("a"),Xc=n("LEDForQuestionAnswering"),Jc=n(" forward method, overrides the "),va=a("code"),Zc=n("__call__"),Kc=n(" special method."),Yc=c(),v(ro.$$.fragment),eh=c(),v(io.$$.fragment),th=c(),v(lo.$$.fragment),mr=c(),St=a("h2"),co=a("a"),ka=a("span"),v($n.$$.fragment),oh=c(),wa=a("span"),nh=n("TFLEDModel"),fr=c(),ce=a("div"),v(Dn.$$.fragment),sh=c(),Fn=a("p"),ah=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),os=r(Br,"A",{href:!0});var Zp=d(os);Ll=s(Zp,"PreTrainedModel"),Zp.forEach(t),ql=s(Br,`. See the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Br.forEach(t),$l=h(vo),an=r(vo,"P",{});var Qr=d(an);Dl=s(Qr,"This model is also a PyTorch "),rn=r(Qr,"A",{href:!0,rel:!0});var Kp=d(rn);Fl=s(Kp,"torch.nn.Module"),Kp.forEach(t),zl=s(Qr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage
