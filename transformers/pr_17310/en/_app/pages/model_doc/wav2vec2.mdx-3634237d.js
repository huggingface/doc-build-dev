import{S as hy,i as fy,s as uy,e as a,k as d,w,t as r,M as gy,c as s,d as t,m as p,a as n,x as y,h as i,b as m,F as e,g as _,y as k,q as T,o as $,B as x,v as _y,L as fe}from"../../chunks/vendor-6b77c823.js";import{T as me}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-1088f2fb.js";import{C as ue}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ee}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as he}from"../../chunks/ExampleCodeBlock-5212b321.js";function vy(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2Model, Wav2Vec2Config
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a> or <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.TFWav2Vec2Model">TFWav2Vec2Model</a>. Vocabulary size of the
model. Defines the different tokens that can be represented by the <em>inputs_ids</em> passed to the forward
method of <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a>.`,name:"vocab_size"},{anchor:"transformers.Wav2Vec2Config.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
instance of <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2CTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17310/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17310/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/tokenization_utils_base.py#L2393",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17310/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17310/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_17310/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_17310/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_17310/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17310/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1264",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.modeling_outputs.Wav2Vec2BaseModelOutput"
>transformers.modeling_outputs.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1628",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17310/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1717"}}),un=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1762",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1883",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17310/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1995"}}),En=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2057",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_outputs.XVectorOutput"
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1388",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17310/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1582",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17310/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17310/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1058"}}),cr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17310/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17310/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17310/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17310/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),Er=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17310/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17310/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1325",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17310/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Ku=p(Et),ze=s(Et,"DIV",{class:!0});var qt=n(ze);y(rn.$$.fragment,qt),Qu=p(qt),Qt=s(qt,"P",{});var Di=n(Qt);Yu=i(Di,"The "),fi=s(Di,"A",{href:!0});var f1=n(fi);eg=i(f1,"Wav2Vec2ForCTC"),f1.forEach(t),tg=i(Di," forward method, overrides the "),Ll=s(Di,"CODE",{});var u1=n(Ll);og=i(u1,"__call__"),u1.forEach(t),ag=i(Di," special method."),Di.forEach(t),sg=p(qt),y(Ko.$$.fragment,qt),ng=p(qt),y(Qo.$$.fragment,qt),rg=p(qt),y(Yo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),kd=p(o),Yt=s(o,"H2",{class:!0});var xp=n(Yt);ea=s(xp,"A",{id:!0,class:!0,href:!0});var g1=n(ea);Dl=s(g1,"SPAN",{});var _1=n(Dl);y(ln.$$.fragment,_1),_1.forEach(t),g1.forEach(t),ig=p(xp),Sl=s(xp,"SPAN",{});var v1=n(Sl);lg=i(v1,"Wav2Vec2ForSequenceClassification"),v1.forEach(t),xp.forEach(t),Td=p(o),ne=s(o,"DIV",{class:!0});var at=n(ne);y(cn.$$.fragment,at),cg=p(at),Nl=s(at,"P",{});var b1=n(Nl);dg=i(b1,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jp.forEach(t),Tg=p(at),Me=s(at,"DIV",{class:!0});var Pt=n(Me);y(un.$$.fragment,Pt),$g=p(Pt),eo=s(Pt,"P",{});var Si=n(eo);xg=i(Si,"The "),gi=s(Si,"A",{href:!0});var T1=n(gi);Wg=i(T1,"Wav2Vec2ForSequenceClassification"),T1.forEach(t),Vg=i(Si," forward method, overrides the "),Il=s(Si,"CODE",{});var $1=n(Il);jg=i($1,"__call__"),$1.forEach(t),Fg=i(Si," special method."),Si.forEach(t),Cg=p(Pt),y(ta.$$.fragment,Pt),Eg=p(Pt),y(oa.$$.fragment,Pt),qg=p(Pt),y(aa.$$.fragment,Pt),Pt.forEach(t),at.forEach(t),$d=p(o),to=s(o,"H2",{class:!0});var Fp=n(to);sa=s(Fp,"A",{id:!0,class:!0,href:!0});var x1=n(sa);Bl=s(x1,"SPAN",{});var W1=n(Bl);y(gn.$$.fragment,W1),W1.forEach(t),x1.forEach(t),Pg=p(Fp),Ul=s(Fp,"SPAN",{});var V1=n(Ul);zg=i(V1,"Wav2Vec2ForAudioFrameClassification"),V1.forEach(t),Fp.forEach(t),xd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(_n.$$.fragment,st),Mg=p(st),Rl=s(st,"P",{});var j1=n(Rl);Ag=i(j1,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),j1.forEach(t),Og=p(st),vn=s(st,"P",{});var Cp=n(vn);Lg=i(Cp,"Wav2Vec2 was proposed in "),bn=s(Cp,"A",{href:!0,rel:!0});var F1=n(bn);Dg=i(F1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
library implements for all its model (such as downloading or saving etc.).`),Ep.forEach(t),Rg=p(st),yn=s(st,"P",{});var qp=n(yn);Hg=i(qp,"This model is a PyTorch "),kn=s(qp,"A",{href:!0,rel:!0});var E1=n(kn);Xg=i(E1,"torch.nn.Module"),E1.forEach(t),Gg=i(qp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qp.forEach(t),Jg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y(Tn.$$.fragment,Oa),Zg=p(Oa),oo=s(Oa,"P",{});var Ni=n(oo);Kg=i(Ni,"The "),vi=s(Ni,"A",{href:!0});var q1=n(vi);Qg=i(q1,"Wav2Vec2ForAudioFrameClassification"),q1.forEach(t),Yg=i(Ni," forward method, overrides the "),Hl=s(Ni,"CODE",{});var P1=n(Hl);e_=i(P1,"__call__"),P1.forEach(t),t_=i(Ni," special method."),Ni.forEach(t),o_=p(Oa),y(na.$$.fragment,Oa),a_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Wd=p(o),ao=s(o,"H2",{class:!0});var Pp=n(ao);ia=s(Pp,"A",{id:!0,class:!0,href:!0});var z1=n(ia);Xl=s(z1,"SPAN",{});var M1=n(Xl);y($n.$$.fragment,M1),M1.forEach(t),z1.forEach(t),s_=p(Pp),Gl=s(Pp,"SPAN",{});var A1=n(Gl);n_=i(A1,"Wav2Vec2ForXVector"),A1.forEach(t),Pp.forEach(t),Vd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(xn.$$.fragment,nt),r_=p(nt),Jl=s(nt,"P",{});var O1=n(Jl);i_=i(O1,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),O1.forEach(t),l_=p(nt),Wn=s(nt,"P",{});var zp=n(Wn);c_=i(zp,"Wav2Vec2 was proposed in "),Vn=s(zp,"A",{href:!0,rel:!0});var L1=n(Vn);d_=i(L1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dp.forEach(t),R_=p(zt),Ke=s(zt,"DIV",{class:!0});var Da=n(Ke);y(Ln.$$.fragment,Da),H_=p(Da),io=s(Da,"P",{});var Ui=n(io);X_=i(Ui,"The "),ki=s(Ui,"A",{href:!0});var Z1=n(ki);G_=i(Z1,"Wav2Vec2ForPreTraining"),Z1.forEach(t),J_=i(Ui," forward method, overrides the "),ec=s(Ui,"CODE",{});var K1=n(ec);Z_=i(K1,"__call__"),K1.forEach(t),K_=i(Ui," special method."),Ui.forEach(t),Q_=p(Da),y(pa.$$.fragment,Da),Y_=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),zt.forEach(t),Cd=p(o),lo=s(o,"H2",{class:!0});var Sp=n(lo);ha=s(Sp,"A",{id:!0,class:!0,href:!0});var Q1=n(ha);tc=s(Q1,"SPAN",{});var Y1=n(tc);y(Dn.$$.fragment,Y1),Y1.forEach(t),Q1.forEach(t),ev=p(Sp),oc=s(Sp,"SPAN",{});var e0=n(oc);tv=i(e0,"TFWav2Vec2Model"),e0.forEach(t),Sp.forEach(t),Ed=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Sn.$$.fragment,rt),ov=p(rt),ac=s(rt,"P",{});var t0=n(ac);av=i(t0,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),t0.forEach(t),sv=p(rt),Nn=s(rt,"P",{});var Np=n(Nn);nv=i(Np,"This model inherits from "),Ti=s(Np,"A",{href:!0});var o0=n(Ti);rv=i(o0,"TFPreTrainedModel"),o0.forEach(t),iv=i(Np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np.forEach(t),lv=p(rt),In=s(rt,"P",{});var Ip=n(In);cv=i(Ip,"This model is also a "),Bn=s(Ip,"A",{href:!0,rel:!0});var a0=n(Bn);dv=i(a0,"tf.keras.Model"),a0.forEach(t),pv=i(Ip,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ip.forEach(t),mv=p(rt),y(fa.$$.fragment,rt),hv=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Un.$$.fragment,Sa),fv=p(Sa),co=s(Sa,"P",{});var Ri=n(co);uv=i(Ri,"The "),$i=s(Ri,"A",{href:!0});var s0=n($i);gv=i(s0,"TFWav2Vec2Model"),s0.forEach(t),_v=i(Ri," forward method, overrides the "),sc=s(Ri,"CODE",{});var n0=n(sc);vv=i(n0,"__call__"),n0.forEach(t),bv=i(Ri," special method."),Ri.forEach(t),wv=p(Sa),y(ua.$$.fragment,Sa),yv=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),qd=p(o),po=s(o,"H2",{class:!0});var Bp=n(po);_a=s(Bp,"A",{id:!0,class:!0,href:!0});var r0=n(_a);nc=s(r0,"SPAN",{});var i0=n(nc);y(Rn.$$.fragment,i0),i0.forEach(t),r0.forEach(t),kv=p(Bp),rc=s(Bp,"SPAN",{});var l0=n(rc);Tv=i(l0,"TFWav2Vec2ForCTC"),l0.forEach(t),Bp.forEach(t),Pd=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Hn.$$.fragment,it),$v=p(it),Xn=s(it,"P",{});var Up=n(Xn);xv=i(Up,"TFWav2Vec2 Model with a "),ic=s(Up,"CODE",{});var c0=n(ic);Wv=i(c0,"language modeling"),c0.forEach(t),Vv=i(Up," head on top for Connectionist Temporal Classification (CTC)."),Up.forEach(t),jv=p(it),Gn=s(it,"P",{});var Rp=n(Gn);Fv=i(Rp,"This model inherits from "),xi=s(Rp,"A",{href:!0});var d0=n(xi);Cv=i(d0,"TFPreTrainedModel"),d0.forEach(t),Ev=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),qv=p(it),Jn=s(it,"P",{});var Hp=n(Jn);Pv=i(Hp,"This model is also a "),Zn=s(Hp,"A",{href:!0,rel:!0});var p0=n(Zn);zv=i(p0,"tf.keras.Model"),p0.forEach(t),Mv=i(Hp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp.forEach(t),Av=p(it),y(va.$$.fragment,it),Ov=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Kn.$$.fragment,Na),Lv=p(Na),mo=s(Na,"P",{});var Hi=n(mo);Dv=i(Hi,"The "),Wi=s(Hi,"A",{href:!0});var m0=n(Wi);Sv=i(m0,"TFWav2Vec2ForCTC"),m0.forEach(t),Nv=i(Hi," forward method, overrides the "),lc=s(Hi,"CODE",{});var h0=n(lc);Iv=i(h0,"__call__"),h0.forEach(t),Bv=i(Hi," special method."),Hi.forEach(t),Uv=p(Na),y(ba.$$.fragment,Na),Rv=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),zd=p(o),ho=s(o,"H2",{class:!0});var Xp=n(ho);ya=s(Xp,"A",{id:!0,class:!0,href:!0});var f0=n(ya);cc=s(f0,"SPAN",{});var u0=n(cc);y(Qn.$$.fragment,u0),u0.forEach(t),f0.forEach(t),Hv=p(Xp),dc=s(Xp,"SPAN",{});var g0=n(dc);Xv=i(g0,"FlaxWav2Vec2Model"),g0.forEach(t),Xp.forEach(t),Md=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(Yn.$$.fragment,Oe),Gv=p(Oe),er=s(Oe,"P",{});var Gp=n(er);Jv=i(Gp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),tr=s(Gp,"A",{href:!0,rel:!0});var _0=n(tr);Zv=i(_0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),_0.forEach(t),Kv=i(Gp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Gp.forEach(t),Qv=p(Oe),or=s(Oe,"P",{});var Jp=n(or);Yv=i(Jp,"This model inherits from "),Vi=s(Jp,"A",{href:!0});var v0=n(Vi);e2=i(v0,"FlaxPreTrainedModel"),v0.forEach(t),t2=i(Jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jp.forEach(t),o2=p(Oe),ar=s(Oe,"P",{});var Zp=n(ar);a2=i(Zp,`This model is also a Flax Linen
`),sr=s(Zp,"A",{href:!0,rel:!0});var b0=n(sr);s2=i(b0,"flax.nn.Module"),b0.forEach(t),n2=i(Zp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Zp.forEach(t),r2=p(Oe),pc=s(Oe,"P",{});var w0=n(pc);i2=i(w0,"Finally, this model supports inherent JAX features such as:"),w0.forEach(t),l2=p(Oe),bt=s(Oe,"UL",{});var Ia=n(bt);mc=s(Ia,"LI",{});var y0=n(mc);nr=s(y0,"A",{href:!0,rel:!0});var k0=n(nr);c2=i(k0,"Just-In-Time (JIT) compilation"),k0.forEach(t),y0.forEach(t),d2=p(Ia),hc=s(Ia,"LI",{});var T0=n(hc);rr=s(T0,"A",{href:!0,rel:!0});var $0=n(rr);p2=i($0,"Automatic Differentiation"),$0.forEach(t),T0.forEach(t),m2=p(Ia),fc=s(Ia,"LI",{});var x0=n(fc);ir=s(x0,"A",{href:!0,rel:!0});var W0=n(ir);h2=i(W0,"Vectorization"),W0.forEach(t),x0.forEach(t),f2=p(Ia),uc=s(Ia,"LI",{});var V0=n(uc);lr=s(V0,"A",{href:!0,rel:!0});var j0=n(lr);u2=i(j0,"Parallelization"),j0.forEach(t),V0.forEach(t),Ia.forEach(t),g2=p(Oe),et=s(Oe,"DIV",{class:!0});var Ba=n(et);y(cr.$$.fragment,Ba),_2=p(Ba),fo=s(Ba,"P",{});var Xi=n(fo);v2=i(Xi,"The "),gc=s(Xi,"CODE",{});var F0=n(gc);b2=i(F0,"FlaxWav2Vec2PreTrainedModel"),F0.forEach(t),w2=i(Xi," forward method, overrides the "),_c=s(Xi,"CODE",{});var C0=n(_c);y2=i(C0,"__call__"),C0.forEach(t),k2=i(Xi," special method."),Xi.forEach(t),T2=p(Ba),y(ka.$$.fragment,Ba),$2=p(Ba),y(Ta.$$.fragment,Ba),Ba.forEach(t),Oe.forEach(t),Ad=p(o),uo=s(o,"H2",{class:!0});var Kp=n(uo);$a=s(Kp,"A",{id:!0,class:!0,href:!0});var E0=n($a);vc=s(E0,"SPAN",{});var q0=n(vc);y(dr.$$.fragment,q0),q0.forEach(t),E0.forEach(t),x2=p(Kp),bc=s(Kp,"SPAN",{});var P0=n(bc);W2=i(P0,"FlaxWav2Vec2ForCTC"),P0.forEach(t),Kp.forEach(t),Od=p(o),Q=s(o,"DIV",{class:!0});var Le=n(Q);y(pr.$$.fragment,Le),V2=p(Le),go=s(Le,"P",{});var Gi=n(go);j2=i(Gi,"Wav2Vec2 Model with a "),wc=s(Gi,"CODE",{});var z0=n(wc);F2=i(z0,"language modeling"),z0.forEach(t),C2=i(Gi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),mr=s(Gi,"A",{href:!0,rel:!0});var M0=n(mr);E2=i(M0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),M0.forEach(t),q2=i(Gi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Gi.forEach(t),P2=p(Le),hr=s(Le,"P",{});var Qp=n(hr);z2=i(Qp,"This model inherits from "),ji=s(Qp,"A",{href:!0});var A0=n(ji);M2=i(A0,"FlaxPreTrainedModel"),A0.forEach(t),A2=i(Qp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qp.forEach(t),O2=p(Le),fr=s(Le,"P",{});var Yp=n(fr);L2=i(Yp,`This model is also a Flax Linen
`),ur=s(Yp,"A",{href:!0,rel:!0});var O0=n(ur);D2=i(O0,"flax.nn.Module"),O0.forEach(t),S2=i(Yp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Yp.forEach(t),N2=p(Le),yc=s(Le,"P",{});var L0=n(yc);I2=i(L0,"Finally, this model supports inherent JAX features such as:"),L0.forEach(t),B2=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);kc=s(Ua,"LI",{});var D0=n(kc);gr=s(D0,"A",{href:!0,rel:!0});var S0=n(gr);U2=i(S0,"Just-In-Time (JIT) compilation"),S0.forEach(t),D0.forEach(t),R2=p(Ua),Tc=s(Ua,"LI",{});var N0=n(Tc);_r=s(N0,"A",{href:!0,rel:!0});var I0=n(_r);H2=i(I0,"Automatic Differentiation"),I0.forEach(t),N0.forEach(t),X2=p(Ua),$c=s(Ua,"LI",{});var B0=n($c);vr=s(B0,"A",{href:!0,rel:!0});var U0=n(vr);G2=i(U0,"Vectorization"),U0.forEach(t),B0.forEach(t),J2=p(Ua),xc=s(Ua,"LI",{});var R0=n(xc);br=s(R0,"A",{href:!0,rel:!0});var H0=n(br);Z2=i(H0,"Parallelization"),H0.forEach(t),R0.forEach(t),Ua.forEach(t),K2=p(Le),tt=s(Le,"DIV",{class:!0});var Ra=n(tt);y(wr.$$.fragment,Ra),Q2=p(Ra),_o=s(Ra,"P",{});var Ji=n(_o);Y2=i(Ji,"The "),Wc=s(Ji,"CODE",{});var X0=n(Wc);eb=i(X0,"FlaxWav2Vec2PreTrainedModel"),X0.forEach(t),tb=i(Ji," forward method, overrides the "),Vc=s(Ji,"CODE",{});var G0=n(Vc);ob=i(G0,"__call__"),G0.forEach(t),ab=i(Ji," special method."),Ji.forEach(t),sb=p(Ra),y(xa.$$.fragment,Ra),nb=p(Ra),y(Wa.$$.fragment,Ra),Ra.forEach(t),Le.forEach(t),Ld=p(o),vo=s(o,"H2",{class:!0});var em=n(vo);Va=s(em,"A",{id:!0,class:!0,href:!0});var J0=n(Va);jc=s(J0,"SPAN",{});var Z0=n(jc);y(yr.$$.fragment,Z0),Z0.forEach(t),J0.forEach(t),rb=p(em),Fc=s(em,"SPAN",{});var K0=n(Fc);ib=i(K0,"FlaxWav2Vec2ForPreTraining"),K0.forEach(t),em.forEach(t),Dd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(kr.$$.fragment,De),lb=p(De),bo=s(De,"P",{});var Zi=n(bo);cb=i(Zi,"Wav2Vec2 Model with a quantizer and "),Cc=s(Zi,"CODE",{});var Q0=n(Cc);db=i(Q0,"VQ"),Q0.forEach(t),pb=i(Zi,` head on top.
Wav2Vec2 was proposed in `),Tr=s(Zi,"A",{href:!0,rel:!0});var Y0=n(Tr);mb=i(Y0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Y0.forEach(t),hb=i(Zi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
