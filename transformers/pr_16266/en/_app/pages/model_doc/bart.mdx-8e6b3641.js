...
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16266/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new H({}),da=new q({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16266/src/transformers/models/bart/modeling_bart.py#L1265",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16266/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16266/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new q({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16266/src/transformers/models/bart/modeling_bart.py#L1304",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16266/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16266/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16266/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16266/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16266/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16266/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16266/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16266/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16266/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16266/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16266/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16266/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16266/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
`),qi=a(Jr,"CODE",{});var tv=s(qi);_h=i(tv,"forced_bos_token_id=0"),tv.forEach(t),gh=i(Jr,`. This only works, however, if the string you pass to
`),$i=a(Jr,"CODE",{});var ov=s($i);kh=i(ov,"fairseq.encode"),ov.forEach(t),bh=i(Jr," starts with a space."),Jr.forEach(t),yh=l(qt),yr=a(qt,"LI",{});var jy=s(yr);vr=a(jy,"A",{href:!0});var nv=s(vr);vh=i(nv,"generate()"),nv.forEach(t),Th=i(jy,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),jy.forEach(t),wh=l(qt),Jt=a(qt,"LI",{});var Xr=s(Jt);xh=i(Xr,"Models that load the "),ji=a(Xr,"EM",{});var av=s(ji);zh=i(av,"facebook/bart-large-cnn"),av.forEach(t),Fh=i(Xr," weights will not have a "),Mi=a(Xr,"CODE",{});var sv=s(Mi);Bh=i(sv,"mask_token_id"),sv.forEach(t),qh=i(Xr,`, or be able to perform
mask-filling tasks.`),Xr.forEach(t),qt.forEach(t),ac=l(o),Xt=a(o,"H2",{class:!0});var Lc=s(Xt);Po=a(Lc,"A",{id:!0,class:!0,href:!0});var rv=s(Po);Pi=a(rv,"SPAN",{});var iv=s(Pi);f(jn.$$.fragment,iv),iv.forEach(t),rv.forEach(t),$h=l(Lc),Ei=a(Lc,"SPAN",{});var dv=s(Ei);jh=i(dv,"Mask Filling"),dv.forEach(t),Lc.forEach(t),sc=l(o),gt=a(o,"P",{});var Kr=s(gt);Mh=i(Kr,"The "),Ci=a(Kr,"CODE",{});var lv=s(Ci);Ph=i(lv,"facebook/bart-base"),lv.forEach(t),Eh=i(Kr," and "),Ai=a(Kr,"CODE",{});var cv=s(Ai);Ch=i(cv,"facebook/bart-large"),cv.forEach(t),Ah=i(Kr," checkpoints can be used to fill multi-token masks."),Kr.forEach(t),rc=l(o),f(Mn.$$.fragment,o),ic=l(o),Kt=a(o,"H2",{class:!0});var Gc=s(Kt);Eo=a(Gc,"A",{id:!0,class:!0,href:!0});var pv=s(Eo);Si=a(pv,"SPAN",{});var hv=s(Si);f(Pn.$$.fragment,hv),hv.forEach(t),pv.forEach(t),Sh=l(Gc),Ii=a(Gc,"SPAN",{});var uv=s(Ii);Ih=i(uv,"BartConfig"),uv.forEach(t),Gc.forEach(t),dc=l(o),we=a(o,"DIV",{class:!0});var $t=s(we);f(En.$$.fragment,$t),Oh=l($t),Zt=a($t,"P",{});var Zr=s(Zt);Nh=i(Zr,"This is the configuration class to store the configuration of a "),Tr=a(Zr,"A",{href:!0});var mv=s(Tr);Dh=i(mv,"BartModel"),mv.forEach(t),Lh=i(Zr,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Cn=a(Zr,"A",{href:!0,rel:!0});var fv=s(Cn);Gh=i(fv,"facebook/bart-large"),fv.forEach(t),Wh=i(Zr," architecture."),Zr.forEach(t),Rh=l($t),Yt=a($t,"P",{});var Yr=s(Yt);Uh=i(Yr,"Configuration objects inherit from "),wr=a(Yr,"A",{href:!0});var _v=s(wr);Hh=i(_v,"PretrainedConfig"),_v.forEach(t),Qh=i(Yr,` and can be used to control the model outputs. Read the
documentation from `),xr=a(Yr,"A",{href:!0});var gv=s(xr);Vh=i(gv,"PretrainedConfig"),gv.forEach(t),Jh=i(Yr," for more information."),Yr.forEach(t),Xh=l($t),Oi=a($t,"P",{});var kv=s(Oi);Kh=i(kv,"Example:"),kv.forEach(t),Zh=l($t),f(An.$$.fragment,$t),$t.forEach(t),lc=l(o),eo=a(o,"H2",{class:!0});var Wc=s(eo);Co=a(Wc,"A",{id:!0,class:!0,href:!0});var bv=s(Co);Ni=a(bv,"SPAN",{});var yv=s(Ni);f(Sn.$$.fragment,yv),yv.forEach(t),bv.forEach(t),Yh=l(Wc),Di=a(Wc,"SPAN",{});var vv=s(Di);eu=i(vv,"BartTokenizer"),vv.forEach(t),Wc.forEach(t),cc=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(In.$$.fragment,L),tu=l(L),Li=a(L,"P",{});var Tv=s(Li);ou=i(Tv,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),Tv.forEach(t),nu=l(L),Gi=a(L,"P",{});var wv=s(Gi);au=i(wv,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),wv.forEach(t),su=l(L),f(On.$$.fragment,L),ru=l(L),Nn=a(L,"P",{});var Rc=s(Nn);iu=i(Rc,"You can get around that behavior by passing "),Wi=a(Rc,"CODE",{});var xv=s(Wi);du=i(xv,"add_prefix_space=True"),xv.forEach(t),lu=i(Rc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Rc.forEach(t),cu=l(L),f(Ao.$$.fragment,L),pu=l(L),Dn=a(L,"P",{});var Uc=s(Dn);hu=i(Uc,"This tokenizer inherits from "),zr=a(Uc,"A",{href:!0});var zv=s(zr);uu=i(zv,"PreTrainedTokenizer"),zv.forEach(t),mu=i(Uc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Uc.forEach(t),fu=l(L),kt=a(L,"DIV",{class:!0});var ei=s(kt);f(Ln.$$.fragment,ei),_u=l(ei),Ri=a(ei,"P",{});var Fv=s(Ri);gu=i(Fv,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Fv.forEach(t),ku=l(ei),Gn=a(ei,"UL",{});var Hc=s(Gn);Fr=a(Hc,"LI",{});var My=s(Fr);bu=i(My,"single sequence: "),Ui=a(My,"CODE",{});var Bv=s(Ui);yu=i(Bv,"<s> X </s>"),Bv.forEach(t),My.forEach(t),vu=l(Hc),Br=a(Hc,"LI",{});var Py=s(Br);Tu=i(Py,"pair of sequences: "),Hi=a(Py,"CODE",{});var qv=s(Hi);wu=i(qv,"<s> A </s></s> B </s>"),qv.forEach(t),Py.forEach(t),Hc.forEach(t),ei.forEach(t),xu=l(L),So=a(L,"DIV",{class:!0});var Qc=s(So);f(Wn.$$.fragment,Qc),zu=l(Qc),Qi=a(Qc,"P",{});var $v=s(Qi);Fu=i($v,"Converts a sequence of tokens (string) in a single string."),$v.forEach(t),Qc.forEach(t),Bu=l(L),Io=a(L,"DIV",{class:!0});var Vc=s(Io);f(Rn.$$.fragment,Vc),qu=l(Vc),Vi=a(Vc,"P",{});var jv=s(Vi);$u=i(jv,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),jv.forEach(t),Vc.forEach(t),ju=l(L),Oo=a(L,"DIV",{class:!0});var Jc=s(Oo);f(Un.$$.fragment,Jc),Mu=l(Jc),Hn=a(Jc,"P",{});var Xc=s(Hn);Pu=i(Xc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ji=a(Xc,"CODE",{});var Mv=s(Ji);Eu=i(Mv,"prepare_for_model"),Mv.forEach(t),Cu=i(Xc," method."),Xc.forEach(t),Jc.forEach(t),L.forEach(t),pc=l(o),to=a(o,"H2",{class:!0});var Kc=s(to);No=a(Kc,"A",{id:!0,class:!0,href:!0});var Pv=s(No);Xi=a(Pv,"SPAN",{});var Ev=s(Xi);f(Qn.$$.fragment,Ev),Ev.forEach(t),Pv.forEach(t),Au=l(Kc),Ki=a(Kc,"SPAN",{});var Cv=s(Ki);Su=i(Cv,"BartTokenizerFast"),Cv.forEach(t),Kc.forEach(t),hc=l(o),G=a(o,"DIV",{class:!0});var me=s(G);f(Vn.$$.fragment,me),Iu=l(me),Jn=a(me,"P",{});var Zc=s(Jn);Ou=i(Zc,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Zi=a(Zc,"EM",{});var Av=s(Zi);Nu=i(Av,"tokenizers"),Av.forEach(t),Du=i(Zc,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),Zc.forEach(t),Lu=l(me),Yi=a(me,"P",{});var Sv=s(Yi);Gu=i(Sv,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),Sv.forEach(t),Wu=l(me),f(Xn.$$.fragment,me),Ru=l(me),Kn=a(me,"P",{});var Yc=s(Kn);Uu=i(Yc,"You can get around that behavior by passing "),ed=a(Yc,"CODE",{});var Iv=s(ed);Hu=i(Iv,"add_prefix_space=True"),Iv.forEach(t),Qu=i(Yc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Yc.forEach(t),Vu=l(me),f(Do.$$.fragment,me),Ju=l(me),Zn=a(me,"P",{});var ep=s(Zn);Xu=i(ep,"This tokenizer inherits from "),qr=a(ep,"A",{href:!0});var Ov=s(qr);Ku=i(Ov,"PreTrainedTokenizerFast"),Ov.forEach(t),Zu=i(ep,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ep.forEach(t),Yu=l(me),Lo=a(me,"DIV",{class:!0});var tp=s(Lo);f(Yn.$$.fragment,tp),em=l(tp),td=a(tp,"P",{});var Nv=s(td);tm=i(Nv,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Nv.forEach(t),tp.forEach(t),me.forEach(t),uc=l(o),oo=a(o,"H2",{class:!0});var op=s(oo);Go=a(op,"A",{id:!0,class:!0,href:!0});var Dv=s(Go);od=a(Dv,"SPAN",{});var Lv=s(od);f(ea.$$.fragment,Lv),Lv.forEach(t),Dv.forEach(t),om=l(op),nd=a(op,"SPAN",{});var Gv=s(nd);nm=i(Gv,"BartModel"),Gv.forEach(t),op.forEach(t),mc=l(o),Xe=a(o,"DIV",{class:!0});var gn=s(Xe);f(ta.$$.fragment,gn),am=l(gn),oa=a(gn,"P",{});var np=s(oa);sm=i(np,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),$r=a(np,"A",{href:!0});var Wv=s($r);rm=i(Wv,"PreTrainedModel"),Wv.forEach(t),im=i(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ap.forEach(t),hm=l(gn),Pe=a(gn,"DIV",{class:!0});var jt=s(Pe);f(sa.$$.fragment,jt),um=l(jt),no=a(jt,"P",{});var ti=s(no);mm=i(ti,"The "),jr=a(ti,"A",{href:!0});var Uv=s(jr);fm=i(Uv,"BartModel"),Uv.forEach(t),_m=i(ti," forward method, overrides the "),ad=a(ti,"CODE",{});var Hv=s(ad);gm=i(Hv,"__call__"),Hv.forEach(t),km=i(ti," special method."),ti.forEach(t),bm=l(jt),f(Wo.$$.fragment,jt),ym=l(jt),sd=a(jt,"P",{});var Qv=s(sd);vm=i(Qv,"Example:"),Qv.forEach(t),Tm=l(jt),f(ra.$$.fragment,jt),jt.forEach(t),gn.forEach(t),fc=l(o),ao=a(o,"H2",{class:!0});var sp=s(ao);Ro=a(sp,"A",{id:!0,class:!0,href:!0});var Vv=s(Ro);rd=a(Vv,"SPAN",{});var Jv=s(rd);f(ia.$$.fragment,Jv),Jv.forEach(t),Vv.forEach(t),wm=l(sp),id=a(sp,"SPAN",{});var Xv=s(id);xm=i(Xv,"BartForConditionalGeneration"),Xv.forEach(t),sp.forEach(t),_c=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),zm=l(kn),la=a(kn,"P",{});var rp=s(la);Fm=i(rp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mr=a(rp,"A",{href:!0});var Kv=s(Mr);Bm=i(Kv,"PreTrainedModel"),Kv.forEach(t),qm=i(rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rp.forEach(t),$m=l(kn),ca=a(kn,"P",{});var ip=s(ca);jm=i(ip,"This model is also a PyTorch "),pa=a(ip,"A",{href:!0,rel:!0});var Zv=s(pa);Mm=i(Zv,"torch.nn.Module"),Zv.forEach(t),Pm=i(ip,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),Em=l(kn),Z=a(kn,"DIV",{class:!0});var Ne=s(Z);f(ha.$$.fragment,Ne),Cm=l(Ne),so=a(Ne,"P",{});var oi=s(so);Am=i(oi,"The "),Pr=a(oi,"A",{href:!0});var Yv=s(Pr);Sm=i(Yv,"BartForConditionalGeneration"),Yv.forEach(t),Im=i(oi," forward method, overrides the "),dd=a(oi,"CODE",{});var eT=s(dd);Om=i(eT,"__call__"),eT.forEach(t),Nm=i(oi," special method."),oi.forEach(t),Dm=l(Ne),f(Uo.$$.fragment,Ne),Lm=l(Ne),ld=a(Ne,"P",{});var tT=s(ld);Gm=i(tT,"Summarization example:"),tT.forEach(t),Wm=l(Ne),f(ua.$$.fragment,Ne),Rm=l(Ne),cd=a(Ne,"P",{});var oT=s(cd);Um=i(oT,"Mask filling example:"),oT.forEach(t),Hm=l(Ne),f(ma.$$.fragment,Ne),Ne.forEach(t),kn.forEach(t),gc=l(o),ro=a(o,"H2",{class:!0});var dp=s(ro);Ho=a(dp,"A",{id:!0,class:!0,href:!0});var nT=s(Ho);pd=a(nT,"SPAN",{});var aT=s(pd);f(fa.$$.fragment,aT),aT.forEach(t),nT.forEach(t),Qm=l(dp),hd=a(dp,"SPAN",{});var sT=s(hd);Vm=i(sT,"BartForSequenceClassification"),sT.forEach(t),dp.forEach(t),kc=l(o),xe=a(o,"DIV",{class:!0});var Mt=s(xe);f(_a.$$.fragment,Mt),Jm=l(Mt),ud=a(Mt,"P",{});var rT=s(ud);Xm=i(rT,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),rT.forEach(t),Km=l(Mt),ga=a(Mt,"P",{});var lp=s(ga);Zm=i(lp,"This model inherits from "),Er=a(lp,"A",{href:!0});var iT=s(Er);Ym=i(iT,"PreTrainedModel"),iT.forEach(t),ef=i(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),sf=l(Mt),Y=a(Mt,"DIV",{class:!0});var De=s(Y);f(ya.$$.fragment,De),rf=l(De),io=a(De,"P",{});var ni=s(io);df=i(ni,"The "),Cr=a(ni,"A",{href:!0});var lT=s(Cr);lf=i(lT,"BartForSequenceClassification"),lT.forEach(t),cf=i(ni," forward method, overrides the "),md=a(ni,"CODE",{});var cT=s(md);pf=i(cT,"__call__"),cT.forEach(t),hf=i(ni," special method."),ni.forEach(t),uf=l(De),f(Qo.$$.fragment,De),mf=l(De),fd=a(De,"P",{});var pT=s(fd);ff=i(pT,"Example of single-label classification:"),pT.forEach(t),_f=l(De),f(va.$$.fragment,De),gf=l(De),_d=a(De,"P",{});var hT=s(_d);kf=i(hT,"Example of multi-label classification:"),hT.forEach(t),bf=l(De),f(Ta.$$.fragment,De),De.forEach(t),Mt.forEach(t),bc=l(o),lo=a(o,"H2",{class:!0});var pp=s(lo);Vo=a(pp,"A",{id:!0,class:!0,href:!0});var uT=s(Vo);gd=a(uT,"SPAN",{});var mT=s(gd);f(wa.$$.fragment,mT),mT.forEach(t),uT.forEach(t),yf=l(pp),kd=a(pp,"SPAN",{});var fT=s(kd);vf=i(fT,"BartForQuestionAnswering"),fT.forEach(t),pp.forEach(t),yc=l(o),ze=a(o,"DIV",{class:!0});var Pt=s(ze);f(xa.$$.fragment,Pt),Tf=l(Pt),co=a(Pt,"P",{});var ai=s(co);wf=i(ai,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),bd=a(ai,"CODE",{});var _T=s(bd);xf=i(_T,"span start logits"),_T.forEach(t),zf=i(ai," and "),yd=a(ai,"CODE",{});var gT=s(yd);Ff=i(gT,"span end logits"),gT.forEach(t),Bf=i(ai,")."),ai.forEach(t),qf=l(Pt),za=a(Pt,"P",{});var hp=s(za);$f=i(hp,"This model inherits from "),Ar=a(hp,"A",{href:!0});var kT=s(Ar);jf=i(kT,"PreTrainedModel"),kT.forEach(t),Mf=i(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),Pf=l(Pt),Fa=a(Pt,"P",{});var up=s(Fa);Ef=i(up,"This model is also a PyTorch "),Ba=a(up,"A",{href:!0,rel:!0});var bT=s(Ba);Cf=i(bT,"torch.nn.Module"),bT.forEach(t),Af=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),Sf=l(Pt),Ee=a(Pt,"DIV",{class:!0});var Et=s(Ee);f(qa.$$.fragment,Et),If=l(Et),po=a(Et,"P",{});var si=s(po);Of=i(si,"The "),Sr=a(si,"A",{href:!0});var yT=s(Sr);Nf=i(yT,"BartForQuestionAnswering"),yT.forEach(t),Df=i(si," forward method, overrides the "),vd=a(si,"CODE",{});var vT=s(vd);Lf=i(vT,"__call__"),vT.forEach(t),Gf=i(si," special method."),si.forEach(t),Wf=l(Et),f(Jo.$$.fragment,Et),Rf=l(Et),Td=a(Et,"P",{});var TT=s(Td);Uf=i(TT,"Example:"),TT.forEach(t),Hf=l(Et),f($a.$$.fragment,Et),Et.forEach(t),Pt.forEach(t),vc=l(o),ho=a(o,"H2",{class:!0});var mp=s(ho);Xo=a(mp,"A",{id:!0,class:!0,href:!0});var wT=s(Xo);wd=a(wT,"SPAN",{});var xT=s(wd);f(ja.$$.fragment,xT),xT.forEach(t),wT.forEach(t),Qf=l(mp),xd=a(mp,"SPAN",{});var zT=s(xd);Vf=i(zT,"BartForCausalLM"),zT.forEach(t),mp.forEach(t),Tc=l(o),uo=a(o,"DIV",{class:!0});var fp=s(uo);f(Ma.$$.fragment,fp),Jf=l(fp),bt=a(fp,"DIV",{class:!0});var ri=s(bt);f(Pa.$$.fragment,ri),Xf=l(ri),zd=a(ri,"P",{});var FT=s(zd);Kf=i(FT,"Example:"),FT.forEach(t),Zf=l(ri),f(Ea.$$.fragment,ri),ri.forEach(t),fp.forEach(t),wc=l(o),mo=a(o,"H2",{class:!0});var _p=s(mo);Ko=a(_p,"A",{id:!0,class:!0,href:!0});var BT=s(Ko);Fd=a(BT,"SPAN",{});var qT=s(Fd);f(Ca.$$.fragment,qT),qT.forEach(t),BT.forEach(t),Yf=l(_p),Bd=a(_p,"SPAN",{});var $T=s(Bd);e_=i($T,"TFBartModel"),$T.forEach(t),_p.forEach(t),xc=l(o),Fe=a(o,"DIV",{class:!0});var Ct=s(Fe);f(Aa.$$.fragment,Ct),t_=l(Ct),Sa=a(Ct,"P",{});var gp=s(Sa);o_=i(gp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ir=a(gp,"A",{href:!0});var jT=s(Ir);n_=i(jT,"TFPreTrainedModel"),jT.forEach(t),a_=i(gp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gp.forEach(t),s_=l(Ct),Ia=a(Ct,"P",{});var kp=s(Ia);r_=i(kp,"This model is also a "),Oa=a(kp,"A",{href:!0,rel:!0});var MT=s(Oa);i_=i(MT,"tf.keras.Model"),MT.forEach(t),d_=i(kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kp.forEach(t),l_=l(Ct),f(Zo.$$.fragment,Ct),c_=l(Ct),Ce=a(Ct,"DIV",{class:!0});var At=s(Ce);f(Na.$$.fragment,At),p_=l(At),fo=a(At,"P",{});var ii=s(fo);h_=i(ii,"The "),Or=a(ii,"A",{href:!0});var PT=s(Or);u_=i(PT,"TFBartModel"),PT.forEach(t),m_=i(ii," forward method, overrides the "),qd=a(ii,"CODE",{});var ET=s(qd);f_=i(ET,"__call__"),ET.forEach(t),__=i(ii," special method."),ii.forEach(t),g_=l(At),f(Yo.$$.fragment,At),k_=l(At),$d=a(At,"P",{});var CT=s($d);b_=i(CT,"Example:"),CT.forEach(t),y_=l(At),f(Da.$$.fragment,At),At.forEach(t),Ct.forEach(t),zc=l(o),_o=a(o,"H2",{class:!0});var bp=s(_o);en=a(bp,"A",{id:!0,class:!0,href:!0});var AT=s(en);jd=a(AT,"SPAN",{});var ST=s(jd);f(La.$$.fragment,ST),ST.forEach(t),AT.forEach(t),v_=l(bp),Md=a(bp,"SPAN",{});var IT=s(Md);T_=i(IT,"TFBartForConditionalGeneration"),IT.forEach(t),bp.forEach(t),Fc=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(Ga.$$.fragment,St),w_=l(St),Wa=a(St,"P",{});var yp=s(Wa);x_=i(yp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Nr=a(yp,"A",{href:!0});var OT=s(Nr);z_=i(OT,"TFPreTrainedModel"),OT.forEach(t),F_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),B_=l(St),Ra=a(St,"P",{});var vp=s(Ra);q_=i(vp,"This model is also a "),Ua=a(vp,"A",{href:!0,rel:!0});var NT=s(Ua);$_=i(NT,"tf.keras.Model"),NT.forEach(t),j_=i(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),M_=l(St),f(tn.$$.fragment,St),P_=l(St),ee=a(St,"DIV",{class:!0});var Le=s(ee);f(Ha.$$.fragment,Le),E_=l(Le),go=a(Le,"P",{});var di=s(go);C_=i(di,"The "),Dr=a(di,"A",{href:!0});var DT=s(Dr);A_=i(DT,"TFBartForConditionalGeneration"),DT.forEach(t),S_=i(di," forward method, overrides the "),Pd=a(di,"CODE",{});var LT=s(Pd);I_=i(LT,"__call__"),LT.forEach(t),O_=i(di," special method."),di.forEach(t),N_=l(Le),f(on.$$.fragment,Le),D_=l(Le),Ed=a(Le,"P",{});var GT=s(Ed);L_=i(GT,"Summarization example:"),GT.forEach(t),G_=l(Le),f(Qa.$$.fragment,Le),W_=l(Le),Cd=a(Le,"P",{});var WT=s(Cd);R_=i(WT,"Mask filling example:"),WT.forEach(t),U_=l(Le),f(Va.$$.fragment,Le),Le.forEach(t),St.forEach(t),Bc=l(o),ko=a(o,"H2",{class:!0});var Tp=s(ko);nn=a(Tp,"A",{id:!0,class:!0,href:!0});var RT=s(nn);Ad=a(RT,"SPAN",{});var UT=s(Ad);f(Ja.$$.fragment,UT),UT.forEach(t),RT.forEach(t),H_=l(Tp),Sd=a(Tp,"SPAN",{});var HT=s(Sd);Q_=i(HT,"FlaxBartModel"),HT.forEach(t),Tp.forEach(t),qc=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);f(Xa.$$.fragment,fe),V_=l(fe),Ka=a(fe,"P",{});var wp=s(Ka);J_=i(wp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xp.forEach(t),og=l(fe),Id=a(fe,"P",{});var JT=s(Id);ng=i(JT,"Finally, this model supports inherent JAX features such as:"),JT.forEach(t),ag=l(fe),pt=a(fe,"UL",{});var bn=s(pt);Od=a(bn,"LI",{});var XT=s(Od);es=a(XT,"A",{href:!0,rel:!0});var KT=s(es);sg=i(KT,"Just-In-Time (JIT) compilation"),KT.forEach(t),XT.forEach(t),rg=l(bn),Nd=a(bn,"LI",{});var ZT=s(Nd);ts=a(ZT,"A",{href:!0,rel:!0});var YT=s(ts);ig=i(YT,"Automatic Differentiation"),YT.forEach(t),ZT.forEach(t),dg=l(bn),Dd=a(bn,"LI",{});var e1=s(Dd);os=a(e1,"A",{href:!0,rel:!0});var t1=s(os);lg=i(t1,"Vectorization"),t1.forEach(t),e1.forEach(t),cg=l(bn),Ld=a(bn,"LI",{});var o1=s(Ld);ns=a(o1,"A",{href:!0,rel:!0});var n1=s(ns);pg=i(n1,"Parallelization"),n1.forEach(t),o1.forEach(t),bn.forEach(t),hg=l(fe),Ae=a(fe,"DIV",{class:!0});var It=s(Ae);f(as.$$.fragment,It),ug=l(It),bo=a(It,"P",{});var li=s(bo);mg=i(li,"The "),Gd=a(li,"CODE",{});var a1=s(Gd);fg=i(a1,"FlaxBartPreTrainedModel"),a1.forEach(t),_g=i(li,"forward method, overrides the "),Wd=a(li,"CODE",{});var s1=s(Wd);gg=i(s1,"__call__"),s1.forEach(t),kg=i(li," special method."),li.forEach(t),bg=l(It),f(an.$$.fragment,It),yg=l(It),Rd=a(It,"P",{});var r1=s(Rd);vg=i(r1,"Example:"),r1.forEach(t),Tg=l(It),f(ss.$$.fragment,It),It.forEach(t),wg=l(fe),yt=a(fe,"DIV",{class:!0});var ci=s(yt);f(rs.$$.fragment,ci),xg=l(ci),Ud=a(ci,"P",{});var i1=s(Ud);zg=i(i1,"Example:"),i1.forEach(t),Fg=l(ci),f(is.$$.fragment,ci),ci.forEach(t),Bg=l(fe),vt=a(fe,"DIV",{class:!0});var pi=s(vt);f(ds.$$.fragment,pi),qg=l(pi),Hd=a(pi,"P",{});var d1=s(Hd);$g=i(d1,"Example:"),d1.forEach(t),jg=l(pi),f(ls.$$.fragment,pi),pi.forEach(t),fe.forEach(t),$c=l(o),yo=a(o,"H2",{class:!0});var zp=s(yo);sn=a(zp,"A",{id:!0,class:!0,href:!0});var l1=s(sn);Qd=a(l1,"SPAN",{});var c1=s(Qd);f(cs.$$.fragment,c1),c1.forEach(t),l1.forEach(t),Mg=l(zp),Vd=a(zp,"SPAN",{});var p1=s(Vd);Pg=i(p1,"FlaxBartForConditionalGeneration"),p1.forEach(t),zp.forEach(t),jc=l(o),R=a(o,"DIV",{class:!0});var _e=s(R);f(ps.$$.fragment,_e),Eg=l(_e),hs=a(_e,"P",{});var Fp=s(hs);Cg=i(Fp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(Fp,"A",{href:!0});var h1=s(Gr);Ag=i(h1,"FlaxPreTrainedModel"),h1.forEach(t),Sg=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp.forEach(t),Ig=l(_e),us=a(_e,"P",{});var Bp=s(us);Og=i(Bp,`This model is also a Flax Linen
`),ms=a(Bp,"A",{href:!0,rel:!0});var u1=s(ms);Ng=i(u1,"flax.nn.Module"),u1.forEach(t),Dg=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),Lg=l(_e),Jd=a(_e,"P",{});var m1=s(Jd);Gg=i(m1,"Finally, this model supports inherent JAX features such as:"),m1.forEach(t),Wg=l(_e),ht=a(_e,"UL",{});var yn=s(ht);Xd=a(yn,"LI",{});var f1=s(Xd);fs=a(f1,"A",{href:!0,rel:!0});var _1=s(fs);Rg=i(_1,"Just-In-Time (JIT) compilation"),_1.forEach(t),f1.forEach(t),Ug=l(yn),Kd=a(yn,"LI",{});var g1=s(Kd);_s=a(g1,"A",{href:!0,rel:!0});var k1=s(_s);Hg=i(k1,"Automatic Differentiation"),k1.forEach(t),g1.forEach(t),Qg=l(yn),Zd=a(yn,"LI",{});var b1=s(Zd);gs=a(b1,"A",{href:!0,rel:!0});var y1=s(gs);Vg=i(y1,"Vectorization"),y1.forEach(t),b1.forEach(t),Jg=l(yn),Yd=a(yn,"LI",{});var v1=s(Yd);ks=a(v1,"A",{href:!0,rel:!0});var T1=s(ks);Xg=i(T1,"Parallelization"),T1.forEach(t),v1.forEach(t),yn.forEach(t),Kg=l(_e),te=a(_e,"DIV",{class:!0});var Ge=s(te);f(bs.$$.fragment,Ge),Zg=l(Ge),vo=a(Ge,"P",{});var hi=s(vo);Yg=i(hi,"The "),el=a(hi,"CODE",{});var w1=s(el);ek=i(w1,"FlaxBartPreTrainedModel"),w1.forEach(t),tk=i(hi,"forward method, overrides the "),tl=a(hi,"CODE",{});var x1=s(tl);ok=i(x1,"__call__"),x1.forEach(t),nk=i(hi," special method."),hi.forEach(t),ak=l(Ge),f(rn.$$.fragment,Ge),sk=l(Ge),ol=a(Ge,"P",{});var z1=s(ol);rk=i(z1,"Summarization example:"),z1.forEach(t),ik=l(Ge),f(ys.$$.fragment,Ge),dk=l(Ge),nl=a(Ge,"P",{});var F1=s(nl);lk=i(F1,"Mask filling example:"),F1.forEach(t),ck=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),pk=l(_e),Tt=a(_e,"DIV",{class:!0});var ui=s(Tt);f(Ts.$$.fragment,ui),hk=l(ui),al=a(ui,"P",{});var B1=s(al);uk=i(B1,"Example:"),B1.forEach(t),mk=l(ui),f(ws.$$.fragment,ui),ui.forEach(t),fk=l(_e),wt=a(_e,"DIV",{class:!0});var mi=s(wt);f(xs.$$.fragment,mi),_k=l(mi),sl=a(mi,"P",{});var q1=s(sl);gk=i(q1,"Example:"),q1.forEach(t),kk=l(mi),f(zs.$$.fragment,mi),mi.forEach(t),_e.forEach(t),Mc=l(o),To=a(o,"H2",{class:!0});var qp=s(To);dn=a(qp,"A",{id:!0,class:!0,href:!0});var $1=s(dn);rl=a($1,"SPAN",{});var j1=s(rl);f(Fs.$$.fragment,j1),j1.forEach(t),$1.forEach(t),bk=l(qp),il=a(qp,"SPAN",{});var M1=s(il);yk=i(M1,"FlaxBartForSequenceClassification"),M1.forEach(t),qp.forEach(t),Pc=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(Bs.$$.fragment,oe),vk=l(oe),dl=a(oe,"P",{});var P1=s(dl);Tk=i(P1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P1.forEach(t),wk=l(oe),qs=a(oe,"P",{});var $p=s(qs);xk=i($p,"This model inherits from "),Wr=a($p,"A",{href:!0});var E1=s(Wr);zk=i(E1,"FlaxPreTrainedModel"),E1.forEach(t),Fk=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),Bk=l(oe),$s=a(oe,"P",{});var jp=s($s);qk=i(jp,`This model is also a Flax Linen
`),js=a(jp,"A",{href:!0,rel:!0});var C1=s(js);$k=i(C1,"flax.nn.Module"),C1.forEach(t),jk=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Mk=l(oe),ll=a(oe,"P",{});var A1=s(ll);Pk=i(A1,"Finally, this model supports inherent JAX features such as:"),A1.forEach(t),Ek=l(oe),ut=a(oe,"UL",{});var vn=s(ut);cl=a(vn,"LI",{});var S1=s(cl);Ms=a(S1,"A",{href:!0,rel:!0});var I1=s(Ms);Ck=i(I1,"Just-In-Time (JIT) compilation"),I1.forEach(t),S1.forEach(t),Ak=l(vn),pl=a(vn,"LI",{});var O1=s(pl);Ps=a(O1,"A",{href:!0,rel:!0});var N1=s(Ps);Sk=i(N1,"Automatic Differentiation"),N1.forEach(t),O1.forEach(t),Ik=l(vn),hl=a(vn,"LI",{});var D1=s(hl);Es=a(D1,"A",{href:!0,rel:!0});var L1=s(Es);Ok=i(L1,"Vectorization"),L1.forEach(t),D1.forEach(t),Nk=l(vn),ul=a(vn,"LI",{});var G1=s(ul);Cs=a(G1,"A",{href:!0,rel:!0});var W1=s(Cs);Dk=i(W1,"Parallelization"),W1.forEach(t),G1.forEach(t),vn.forEach(t),Lk=l(oe),Se=a(oe,"DIV",{class:!0});var Ot=s(Se);f(As.$$.fragment,Ot),Gk=l(Ot),wo=a(Ot,"P",{});var fi=s(wo);Wk=i(fi,"The "),ml=a(fi,"CODE",{});var R1=s(ml);Rk=i(R1,"FlaxBartPreTrainedModel"),R1.forEach(t),Uk=i(fi,"forward method, overrides the "),fl=a(fi,"CODE",{});var U1=s(fl);Hk=i(U1,"__call__"),U1.forEach(t),Qk=i(fi," special method."),fi.forEach(t),Vk=l(Ot),f(ln.$$.fragment,Ot),Jk=l(Ot),_l=a(Ot,"P",{});var H1=s(_l);Xk=i(H1,"Example:"),H1.forEach(t),Kk=l(Ot),f(Ss.$$.fragment,Ot),Ot.forEach(t),Zk=l(oe),xt=a(oe,"DIV",{class:!0});var _i=s(xt);f(Is.$$.fragment,_i),Yk=l(_i),gl=a(_i,"P",{});var Q1=s(gl);eb=i(Q1,"Example:"),Q1.forEach(t),tb=l(_i),f(Os.$$.fragment,_i),_i.forEach(t),ob=l(oe),zt=a(oe,"DIV",{class:!0});var gi=s(zt);f(Ns.$$.fragment,gi),nb=l(gi),kl=a(gi,"P",{});var V1=s(kl);ab=i(V1,"Example:"),V1.forEach(t),sb=l(gi),f(Ds.$$.fragment,gi),gi.forEach(t),oe.forEach(t),Ec=l(o),xo=a(o,"H2",{class:!0});var Mp=s(xo);cn=a(Mp,"A",{id:!0,class:!0,href:!0});var J1=s(cn);bl=a(J1,"SPAN",{});var X1=s(bl);f(Ls.$$.fragment,X1),X1.forEach(t),J1.forEach(t),rb=l(Mp),yl=a(Mp,"SPAN",{});var K1=s(yl);ib=i(K1,"FlaxBartForQuestionAnswering"),K1.forEach(t),Mp.forEach(t),Cc=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);f(Gs.$$.fragment,ne),db=l(ne),zo=a(ne,"P",{});var ki=s(zo);lb=i(ki,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
