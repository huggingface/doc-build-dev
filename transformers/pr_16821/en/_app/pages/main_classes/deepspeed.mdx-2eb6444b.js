...
the file system before passing it to `),zi=o("a"),pk=a("TrainingArguments"),ik=a("."),Uy=u(),Oi=o("p"),uk=a("To summarize you can do:"),Gy=u(),f(Ko.$$.fragment),Ly=u(),Ti=o("p"),ck=a("or:"),My=u(),f(Jo.$$.fragment),Zy=u(),Ai=o("a"),Ny=u(),Cs=o("h3"),ta=o("a"),vd=o("span"),f(Xo.$$.fragment),hk=u(),jd=o("span"),fk=a("Shared Configuration"),Hy=u(),f(aa.$$.fragment),By=u(),Me=o("p"),dk=a("Some configuration values are required by both the "),Si=o("a"),mk=a("Trainer"),_k=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),vk=a("Trainer"),jk=a(" command line arguments."),Wy=u(),na=o("p"),gk=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),yk=a("Trainer"),wk=a(` do the majority
of configuration for you.`),Fy=u(),Ze=o("p"),bk=a("Therefore, in the rest of this guide you will find a special configuration value: "),gd=o("code"),Ek=a("auto"),qk=a(`, which when set will be
...
difficult to detect ways. You have been warned.`),Vy=u(),Ii=o("p"),Pk=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Yy=u(),oa=o("p"),Dk=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),zk=a("TrainingArguments"),Ok=a(" based on that. The steps are:"),Ky=u(),la=o("ol"),yd=o("li"),Tk=a("Create or load the DeepSpeed configuration to be used as a master configuration"),Ak=u(),Qo=o("li"),Sk=a("Create the "),Gi=o("a"),Ck=a("TrainingArguments"),xk=a(" object based on these values"),Jy=u(),le=o("p"),Rk=a("Do note that some values, such as "),wd=o("code"),Ik=a("scheduler.params.total_num_steps"),Uk=a(` are calculated by
`),Li=o("a"),Gk=a("Trainer"),Lk=a(" during "),bd=o("code"),Mk=a("train"),Zk=a(", but you can of course do the math yourself."),Xy=u(),Mi=o("a"),Qy=u(),xs=o("h3"),ra=o("a"),Ed=o("span"),f(el.$$.fragment),Nk=u(),qd=o("span"),Hk=a("ZeRO"),ew=u(),sl=o("p"),tl=o("a"),Bk=a("Zero Redundancy Optimizer (ZeRO)"),Wk=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sw=u(),Ne=o("p"),Fk=a("The "),$d=o("code"),Vk=a("zero_optimization"),Yk=a(" section of the configuration file is the most important part ("),al=o("a"),Kk=a("docs"),Jk=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),tw=u(),pa=o("p"),Xk=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Qk=a("Trainer"),e7=a(` provides
no equivalent command line arguments.`),aw=u(),Ni=o("p"),s7=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),nw=u(),Hi=o("a"),ow=u(),Rs=o("h4"),ia=o("a"),kd=o("span"),f(nl.$$.fragment),t7=u(),Pd=o("span"),a7=a("ZeRO-2 Config"),lw=u(),Bi=o("p"),n7=a("The following is an example of configuration for ZeRO stage 2:"),rw=u(),f(ol.$$.fragment),pw=u(),Wi=o("p"),Dd=o("strong"),o7=a("Performance tuning:"),iw=u(),He=o("ul"),Is=o("li"),l7=a("enabling "),zd=o("code"),r7=a("offload_optimizer"),p7=a(" should reduce GPU RAM usage (it requires "),Od=o("code"),i7=a('"stage": 2'),u7=a(")"),c7=u(),L=o("li"),Td=o("code"),h7=a('"overlap_comm": true'),f7=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=o("code"),d7=a("overlap_comm"),m7=a(` uses 4.5x
...
footprint (`),xd=o("code"),y7=a("5e8 x 2Bytes x 2 x 4.5"),w7=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
...
important, getting a slightly slower training time could be a good trade.`),uw=u(),Be=o("p"),k7=a("Additionally, "),Ud=o("code"),P7=a("deepspeed==0.4.4"),D7=a(" added a new option "),Gd=o("code"),z7=a("round_robin_gradients"),O7=a(" which you can enable with:"),cw=u(),f(ll.$$.fragment),hw=u(),Fi=o("p"),T7=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fw=u(),Vi=o("a"),dw=u(),Us=o("h4"),ua=o("a"),Ld=o("span"),f(rl.$$.fragment),A7=u(),Md=o("span"),S7=a("ZeRO-3 Config"),mw=u(),Yi=o("p"),C7=a("The following is an example of configuration for ZeRO stage 3:"),_w=u(),f(pl.$$.fragment),vw=u(),K=o("p"),x7=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
...
NVMe is discussed further down.`),jw=u(),We=o("p"),H7=a("Pinned memory is enabled with "),Wd=o("code"),B7=a("pin_memory"),W7=a(" set to "),Fd=o("code"),F7=a("true"),V7=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gw=u(),Ki=o("p"),Vd=o("strong"),Y7=a("Performance tuning:"),yw=u(),ca=o("ul"),il=o("li"),Yd=o("code"),K7=a("stage3_max_live_parameters"),J7=a(": "),Kd=o("code"),X7=a("1e9"),Q7=u(),ul=o("li"),Jd=o("code"),e9=a("stage3_max_reuse_distance"),s9=a(": "),Xd=o("code"),t9=a("1e9"),ww=u(),M=o("p"),a9=a("If hitting OOM reduce "),Qd=o("code"),n9=a("stage3_max_live_parameters"),o9=a(" and "),em=o("code"),l9=a("stage3_max_reuse_distance"),r9=a(`. They should have minimal impact
...
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(we,"A",{href:!0});var BM=r(Pi);ek=n(BM,"Trainer"),BM.forEach(t),sk=n(we," via "),Di=l(we,"A",{href:!0});var WM=r(Di);tk=n(WM,"TrainingArguments"),WM.forEach(t),ak=n(we," then for the "),md=l(we,"CODE",{});var FM=r(md);nk=n(FM,"deepspeed"),FM.forEach(t),ok=n(we,` argument you can
pass a nested `),_d=l(we,"CODE",{});var VM=r(_d);lk=n(VM,"dict"),VM.forEach(t),rk=n(we,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(we,"A",{href:!0});var YM=r(zi);pk=n(YM,"TrainingArguments"),YM.forEach(t),ik=n(we,"."),we.forEach(t),Uy=c(e),Oi=l(e,"P",{});var KM=r(Oi);uk=n(KM,"To summarize you can do:"),KM.forEach(t),Gy=c(e),d(Ko.$$.fragment,e),Ly=c(e),Ti=l(e,"P",{});var JM=r(Ti);ck=n(JM,"or:"),JM.forEach(t),My=c(e),d(Jo.$$.fragment,e),Zy=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Ny=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);ta=l(GE,"A",{id:!0,class:!0,href:!0});var XM=r(ta);vd=l(XM,"SPAN",{});var QM=r(vd);d(Xo.$$.fragment,QM),QM.forEach(t),XM.forEach(t),hk=c(GE),jd=l(GE,"SPAN",{});var eZ=r(jd);fk=n(eZ,"Shared Configuration"),eZ.forEach(t),GE.forEach(t),Hy=c(e),d(aa.$$.fragment,e),By=c(e),Me=l(e,"P",{});var vh=r(Me);dk=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var sZ=r(Si);mk=n(sZ,"Trainer"),sZ.forEach(t),_k=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var tZ=r(Ci);vk=n(tZ,"Trainer"),tZ.forEach(t),jk=n(vh," command line arguments."),vh.forEach(t),Wy=c(e),na=l(e,"P",{});var LE=r(na);gk=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var aZ=r(xi);yk=n(aZ,"Trainer"),aZ.forEach(t),wk=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fy=c(e),Ze=l(e,"P",{});var jh=r(Ze);bk=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),gd=l(jh,"CODE",{});var nZ=r(gd);Ek=n(nZ,"auto"),nZ.forEach(t),qk=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
...
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vy=c(e),Ii=l(e,"P",{});var lZ=r(Ii);Pk=n(lZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),lZ.forEach(t),Yy=c(e),oa=l(e,"P",{});var ME=r(oa);Dk=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var rZ=r(Ui);zk=n(rZ,"TrainingArguments"),rZ.forEach(t),Ok=n(ME," based on that. The steps are:"),ME.forEach(t),Ky=c(e),la=l(e,"OL",{});var ZE=r(la);yd=l(ZE,"LI",{});var pZ=r(yd);Tk=n(pZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),pZ.forEach(t),Ak=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);Sk=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var iZ=r(Gi);Ck=n(iZ,"TrainingArguments"),iZ.forEach(t),xk=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jy=c(e),le=l(e,"P",{});var Hn=r(le);Rk=n(Hn,"Do note that some values, such as "),wd=l(Hn,"CODE",{});var uZ=r(wd);Ik=n(uZ,"scheduler.params.total_num_steps"),uZ.forEach(t),Uk=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var cZ=r(Li);Gk=n(cZ,"Trainer"),cZ.forEach(t),Lk=n(Hn," during "),bd=l(Hn,"CODE",{});var hZ=r(bd);Mk=n(hZ,"train"),hZ.forEach(t),Zk=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xy=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qy=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);ra=l(HE,"A",{id:!0,class:!0,href:!0});var fZ=r(ra);Ed=l(fZ,"SPAN",{});var dZ=r(Ed);d(el.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),Nk=c(HE),qd=l(HE,"SPAN",{});var mZ=r(qd);Hk=n(mZ,"ZeRO"),mZ.forEach(t),HE.forEach(t),ew=c(e),sl=l(e,"P",{});var yG=r(sl);tl=l(yG,"A",{href:!0,rel:!0});var _Z=r(tl);Bk=n(_Z,"Zero Redundancy Optimizer (ZeRO)"),_Z.forEach(t),Wk=n(yG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),tw=c(e),pa=l(e,"P",{});var BE=r(pa);Xk=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Qk=n(gZ,"Trainer"),gZ.forEach(t),e7=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),aw=c(e),Ni=l(e,"P",{});var yZ=r(Ni);s7=n(yZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),yZ.forEach(t),nw=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),ow=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);ia=l(WE,"A",{id:!0,class:!0,href:!0});var wZ=r(ia);kd=l(wZ,"SPAN",{});var bZ=r(kd);d(nl.$$.fragment,bZ),bZ.forEach(t),wZ.forEach(t),t7=c(WE),Pd=l(WE,"SPAN",{});var EZ=r(Pd);a7=n(EZ,"ZeRO-2 Config"),EZ.forEach(t),WE.forEach(t),lw=c(e),Bi=l(e,"P",{});var qZ=r(Bi);n7=n(qZ,"The following is an example of configuration for ZeRO stage 2:"),qZ.forEach(t),rw=c(e),d(ol.$$.fragment,e),pw=c(e),Wi=l(e,"P",{});var $Z=r(Wi);Dd=l($Z,"STRONG",{});var kZ=r(Dd);o7=n(kZ,"Performance tuning:"),kZ.forEach(t),$Z.forEach(t),iw=c(e),He=l(e,"UL",{});var yh=r(He);Is=l(yh,"LI",{});var wh=r(Is);l7=n(wh,"enabling "),zd=l(wh,"CODE",{});var PZ=r(zd);r7=n(PZ,"offload_optimizer"),PZ.forEach(t),p7=n(wh," should reduce GPU RAM usage (it requires "),Od=l(wh,"CODE",{});var DZ=r(Od);i7=n(DZ,'"stage": 2'),DZ.forEach(t),u7=n(wh,")"),wh.forEach(t),c7=c(yh),L=l(yh,"LI",{});var te=r(L);Td=l(te,"CODE",{});var zZ=r(Td);h7=n(zZ,'"overlap_comm": true'),zZ.forEach(t),f7=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=l(te,"CODE",{});var OZ=r(Ad);d7=n(OZ,"overlap_comm"),OZ.forEach(t),m7=n(te,` uses 4.5x
...
footprint (`),xd=l(te,"CODE",{});var SZ=r(xd);y7=n(SZ,"5e8 x 2Bytes x 2 x 4.5"),SZ.forEach(t),w7=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
