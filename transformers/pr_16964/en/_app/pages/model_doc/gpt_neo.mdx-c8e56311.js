...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Ri(N){let d,_,p,m,T,n,f,x,Qn,un,Y,_e,ho,Re,Yn,uo,Zn,mn,J,es,Xe,ts,os,Ke,ns,ss,fn,Ht,as,gn,Te,rs,Qe,ls,is,_n,Z,ve,mo,Ye,ds,fo,cs,Tn,be,ps,go,hs,us,vn,Ze,bn,ee,ye,_o,et,ms,To,fs,yn,L,tt,gs,te,_s,Vt,Ts,vs,ot,bs,ys,ks,oe,$s,Ut,Ps,ws,Jt,Ns,xs,Gs,ke,kn,ne,$e,vo,nt,Fs,bo,Ms,$n,E,st,Cs,yo,Es,qs,at,zs,Rt,js,As,Is,rt,Ls,lt,Ss,Os,Ds,O,it,Bs,se,Ws,Xt,Hs,Vs,ko,Us,Js,Rs,Pe,Xs,we,Pn,ae,Ne,$o,dt,Ks,Po,Qs,wn,q,ct,Ys,wo,Zs,ea,pt,ta,Kt,oa,na,sa,ht,aa,ut,ra,la,ia,D,mt,da,re,ca,Qt,pa,ha,No,ua,ma,fa,xe,ga,Ge,Nn,le,Fe,xo,ft,_a,Go,Ta,xn,G,gt,va,Fo,ba,ya,Yt,Zt,ka,$a,Pa,S,wa,Mo,Na,xa,Co,Ga,Fa,Eo,Ma,Ca,qo,Ea,qa,za,_t,ja,eo,Aa,Ia,La,Tt,Sa,vt,Oa,Da,Ba,C,bt,Wa,ie,Ha,to,Va,Ua,zo,Ja,Ra,Xa,Me,Ka,Ce,Qa,Ee,Ya,qe,Za,ze,Gn,de,je,jo,yt,er,Ao,tr,Fn,F,kt,or,Io,nr,sr,$t,ar,oo,rr,lr,ir,Pt,dr,wt,cr,pr,hr,Lo,ur,mr,H,So,Nt,fr,gr,Oo,xt,_r,Tr,Do,Gt,vr,br,Bo,Ft,yr,kr,B,Mt,$r,ce,Pr,Wo,wr,Nr,Ho,xr,Gr,Fr,Ae,Mr,Ie,Mn,pe,Le,Vo,Ct,Cr,Uo,Er,Cn,M,Et,qr,Jo,zr,jr,qt,Ar,no,Ir,Lr,Sr,zt,Or,jt,Dr,Br,Wr,Ro,Hr,Vr,V,Xo,At,Ur,Jr,Ko,It,Rr,Xr,Qo,Lt,Kr,Qr,Yo,St,Yr,Zr,W,Ot,el,he,tl,Zo,ol,nl,en,sl,al,rl,Se,ll,Oe,En;return n=new me({}),Re=new me({}),Ye=new me({}),Ze=new Q({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16964/en/model_doc/gpt_neo#transformers.GPTNeoModel">GPTNeoModel</a>. Vocabulary size of the model. Defines the different
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/pr_16964/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16964/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16964/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L491",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16964/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16964/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16964/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L709",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16964/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L824",returnDescription:`
...
<p>A <a
  href="/docs/transformers/pr_16964/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ia=h(),D=s("div"),b(mt.$$.fragment),da=h(),re=s("p"),ca=l("The "),Qt=s("a"),pa=l("GPTNeoForCausalLM"),ha=l(" forward method, overrides the "),No=s("code"),ua=l("__call__"),ma=l(" special method."),fa=h(),b(xe.$$.fragment),ga=h(),b(Ge.$$.fragment),Nn=h(),le=s("h2"),Fe=s("a"),xo=s("span"),b(ft.$$.fragment),_a=h(),Go=s("span"),Ta=l("GPTNeoForSequenceClassification"),xn=h(),G=s("div"),b(gt.$$.fragment),va=h(),Fo=s("p"),ba=l("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ya=h(),Yt=s("p"),Zt=s("a"),ka=l("GPTNeoForSequenceClassification"),$a=l(` uses the last token in order to do the classification, as other causal models
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),hr=h(),Lo=s("p"),ur=l("Finally, this model supports inherent JAX features such as:"),mr=h(),H=s("ul"),So=s("li"),Nt=s("a"),fr=l("Just-In-Time (JIT) compilation"),gr=h(),Oo=s("li"),xt=s("a"),_r=l("Automatic Differentiation"),Tr=h(),Do=s("li"),Gt=s("a"),vr=l("Vectorization"),br=h(),Bo=s("li"),Ft=s("a"),yr=l("Parallelization"),kr=h(),B=s("div"),b(Mt.$$.fragment),$r=h(),ce=s("p"),Pr=l("The "),Wo=s("code"),wr=l("FlaxGPTNeoPreTrainedModel"),Nr=l(" forward method, overrides the "),Ho=s("code"),xr=l("__call__"),Gr=l(" special method."),Fr=h(),b(Ae.$$.fragment),Mr=h(),b(Ie.$$.fragment),Mn=h(),pe=s("h2"),Le=s("a"),Vo=s("span"),b(Ct.$$.fragment),Cr=h(),Uo=s("span"),Er=l("FlaxGPTNeoForCausalLM"),Cn=h(),M=s("div"),b(Et.$$.fragment),qr=h(),Jo=s("p"),zr=l(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
