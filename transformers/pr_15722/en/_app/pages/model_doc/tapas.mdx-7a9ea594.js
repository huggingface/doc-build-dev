...
`}}),pn=new ss({}),dn=new de({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_n=new de({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),bn=new ss({}),vn=new de({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new de({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),qn=new ss({}),En=new de({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$n=new de({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),Qn=new ss({}),On=new de({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[Vq]},$$scope:{ctx:U}}}),Hn=new de({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Gn=new ss({}),Rn=new de({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[Yq]},$$scope:{ctx:U}}}),Xn=new de({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),eo=new ss({}),so=new de({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[Xq]},$$scope:{ctx:U}}}),oo=new de({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
dependency in case you\u2019re using Tensorflow:`),Ar.forEach(s),_d=p(t),v(Fa.$$.fragment,t),Td=p(t),Cs=r(t,"P",{});var zr=i(Cs);Vu=n(zr,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),qo=r(zr,"A",{href:!0});var Yk=i(qo);Ku=n(Yk,"TapasConfig"),Yk.forEach(s),Yu=n(zr,", and then create a "),Eo=r(zr,"A",{href:!0});var Jk=i(Eo);Ju=n(Jk,"TapasForQuestionAnswering"),Jk.forEach(s),Xu=n(zr," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),zr.forEach(s),bd=p(t),v(Aa.$$.fragment,t),vd=p(t),Pt=r(t,"P",{});var Tc=i(Pt);Zu=n(Tc,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),za=r(Tc,"A",{href:!0,rel:!0});var Xk=i(za);em=n(Xk,"here"),Xk.forEach(s),sm=n(Tc," for more info."),Tc.forEach(s),wd=p(t),St=r(t,"P",{});var bc=i(St);tm=n(bc,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),$a=r(bc,"A",{href:!0,rel:!0});var Zk=i($a);am=n(Zk,"here"),Zk.forEach(s),nm=n(bc,"."),bc.forEach(s),yd=p(t),Fo=r(t,"P",{});var e2=i(Fo);ji=r(e2,"STRONG",{});var s2=i(ji);om=n(s2,"STEP 2: Prepare your data in the SQA format"),s2.forEach(s),e2.forEach(s),kd=p(t),Dt=r(t,"P",{});var vc=i(Dt);rm=n(vc,"Second, no matter what you picked above, you should prepare your dataset in the "),xa=r(vc,"A",{href:!0,rel:!0});var t2=i(xa);im=n(t2,"SQA"),t2.forEach(s),lm=n(vc," format. This format is a TSV/CSV file with the following columns:"),vc.forEach(s),jd=p(t),ie=r(t,"UL",{});var $e=i(ie);Ao=r($e,"LI",{});var Sy=i(Ao);qi=r(Sy,"CODE",{});var a2=i(qi);pm=n(a2,"id"),a2.forEach(s),dm=n(Sy,": optional, id of the table-question pair, for bookkeeping purposes."),Sy.forEach(s),cm=p($e),zo=r($e,"LI",{});var Dy=i(zo);Ei=r(Dy,"CODE",{});var n2=i(Ei);hm=n(n2,"annotator"),n2.forEach(s),um=n(Dy,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),Dy.forEach(s),mm=p($e),$o=r($e,"LI",{});var Ny=i($o);Fi=r(Ny,"CODE",{});var o2=i(Fi);fm=n(o2,"position"),o2.forEach(s),gm=n(Ny,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),Ny.forEach(s),_m=p($e),xo=r($e,"LI",{});var Ly=i(xo);Ai=r(Ly,"CODE",{});var r2=i(Ai);Tm=n(r2,"question"),r2.forEach(s),bm=n(Ly,": string"),Ly.forEach(s),vm=p($e),Co=r($e,"LI",{});var Qy=i(Co);zi=r(Qy,"CODE",{});var i2=i(zi);wm=n(i2,"table_file"),i2.forEach(s),ym=n(Qy,": string, name of a csv file containing the tabular data"),Qy.forEach(s),km=p($e),Mo=r($e,"LI",{});var Oy=i(Mo);$i=r(Oy,"CODE",{});var l2=i($i);jm=n(l2,"answer_coordinates"),l2.forEach(s),qm=n(Oy,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),Oy.forEach(s),Em=p($e),Po=r($e,"LI",{});var Iy=i(Po);xi=r(Iy,"CODE",{});var p2=i(xi);Fm=n(p2,"answer_text"),p2.forEach(s),Am=n(Iy,": list of one or more strings (each string being a cell value that is part of the answer)"),Iy.forEach(s),zm=p($e),So=r($e,"LI",{});var Wy=i(So);Ci=r(Wy,"CODE",{});var d2=i(Ci);$m=n(d2,"aggregation_label"),d2.forEach(s),xm=n(Wy,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),Wy.forEach(s),Cm=p($e),Do=r($e,"LI",{});var Uy=i(Do);Mi=r(Uy,"CODE",{});var c2=i(Mi);Mm=n(c2,"float_answer"),c2.forEach(s),Pm=n(Uy,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),Uy.forEach(s),$e.forEach(s),qd=p(t),We=r(t,"P",{});var ws=i(We);Sm=n(ws,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),Ca=r(ws,"A",{href:!0,rel:!0});var h2=i(Ca);Dm=n(h2,"here"),h2.forEach(s),Nm=n(ws,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),Ma=r(ws,"A",{href:!0,rel:!0});var u2=i(Ma);Lm=n(u2,"here"),u2.forEach(s),Qm=n(ws,". Interestingly, these conversion scripts are not perfect (the "),Pi=r(ws,"CODE",{});var m2=i(Pi);Om=n(m2,"answer_coordinates"),m2.forEach(s),Im=n(ws," and "),Si=r(ws,"CODE",{});var f2=i(Si);Wm=n(f2,"float_answer"),f2.forEach(s),Um=n(ws," fields are populated based on the "),Di=r(ws,"CODE",{});var g2=i(Di);Hm=n(g2,"answer_text"),g2.forEach(s),Bm=n(ws,"), meaning that WTQ and WikiSQL results could actually be improved."),ws.forEach(s),Ed=p(t),No=r(t,"P",{});var _2=i(No);Ni=r(_2,"STRONG",{});var T2=i(Ni);Gm=n(T2,"STEP 3: Convert your data into PyTorch/TensorFlow tensors using TapasTokenizer"),T2.forEach(s),_2.forEach(s),Fd=p(t),ze=r(t,"P",{});var cs=i(ze);Rm=n(cs,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),Lo=r(cs,"A",{href:!0});var b2=i(Lo);Vm=n(b2,"TapasTokenizer"),b2.forEach(s),Km=n(cs," to convert table-question pairs into "),Li=r(cs,"CODE",{});var v2=i(Li);Ym=n(v2,"input_ids"),v2.forEach(s),Jm=n(cs,", "),Qi=r(cs,"CODE",{});var w2=i(Qi);Xm=n(w2,"attention_mask"),w2.forEach(s),Zm=n(cs,", "),Oi=r(cs,"CODE",{});var y2=i(Oi);ef=n(y2,"token_type_ids"),y2.forEach(s),sf=n(cs," and so on. Again, based on which of the three cases you picked above, "),Qo=r(cs,"A",{href:!0});var k2=i(Qo);tf=n(k2,"TapasForQuestionAnswering"),k2.forEach(s),af=n(cs,"/"),Oo=r(cs,"A",{href:!0});var j2=i(Oo);nf=n(j2,"TFTapasForQuestionAnswering"),j2.forEach(s),of=n(cs,` requires different
inputs to be fine-tuned:`),cs.forEach(s),Ad=p(t),Nt=r(t,"TABLE",{});var wc=i(Nt);Ii=r(wc,"THEAD",{});var q2=i(Ii);Pa=r(q2,"TR",{});var yc=i(Pa);Wi=r(yc,"TH",{});var E2=i(Wi);Ui=r(E2,"STRONG",{});var F2=i(Ui);rf=n(F2,"Task"),F2.forEach(s),E2.forEach(s),lf=p(yc),Hi=r(yc,"TH",{});var A2=i(Hi);Bi=r(A2,"STRONG",{});var z2=i(Bi);pf=n(z2,"Required inputs"),z2.forEach(s),A2.forEach(s),yc.forEach(s),q2.forEach(s),df=p(wc),st=r(wc,"TBODY",{});var $r=i(st);Sa=r($r,"TR",{});var kc=i(Sa);Gi=r(kc,"TD",{});var $2=i(Gi);cf=n($2,"Conversational"),$2.forEach(s),hf=p(kc),zs=r(kc,"TD",{});var ua=i(zs);Ri=r(ua,"CODE",{});var x2=i(Ri);uf=n(x2,"input_ids"),x2.forEach(s),mf=n(ua,", "),Vi=r(ua,"CODE",{});var C2=i(Vi);ff=n(C2,"attention_mask"),C2.forEach(s),gf=n(ua,", "),Ki=r(ua,"CODE",{});var M2=i(Ki);_f=n(M2,"token_type_ids"),M2.forEach(s),Tf=n(ua,", "),Yi=r(ua,"CODE",{});var P2=i(Yi);bf=n(P2,"labels"),P2.forEach(s),ua.forEach(s),kc.forEach(s),vf=p($r),Da=r($r,"TR",{});var jc=i(Da);Ji=r(jc,"TD",{});var S2=i(Ji);wf=n(S2,"Weak supervision for aggregation"),S2.forEach(s),yf=p(jc),Pe=r(jc,"TD",{});var hs=i(Pe);Xi=r(hs,"CODE",{});var D2=i(Xi);kf=n(D2,"input_ids"),D2.forEach(s),jf=n(hs,", "),Zi=r(hs,"CODE",{});var N2=i(Zi);qf=n(N2,"attention_mask"),N2.forEach(s),Ef=n(hs,", "),el=r(hs,"CODE",{});var L2=i(el);Ff=n(L2,"token_type_ids"),L2.forEach(s),Af=n(hs,", "),sl=r(hs,"CODE",{});var Q2=i(sl);zf=n(Q2,"labels"),Q2.forEach(s),$f=n(hs,", "),tl=r(hs,"CODE",{});var O2=i(tl);xf=n(O2,"numeric_values"),O2.forEach(s),Cf=n(hs,", "),al=r(hs,"CODE",{});var I2=i(al);Mf=n(I2,"numeric_values_scale"),I2.forEach(s),Pf=n(hs,", "),nl=r(hs,"CODE",{});var W2=i(nl);Sf=n(W2,"float_answer"),W2.forEach(s),hs.forEach(s),jc.forEach(s),Df=p($r),Na=r($r,"TR",{});var qc=i(Na);ol=r(qc,"TD",{});var U2=i(ol);Nf=n(U2,"Strong supervision for aggregation"),U2.forEach(s),Lf=p(qc),ms=r(qc,"TD",{});var Ss=i(ms);rl=r(Ss,"CODE",{});var H2=i(rl);Qf=n(H2,"input ids"),H2.forEach(s),Of=n(Ss,", "),il=r(Ss,"CODE",{});var B2=i(il);If=n(B2,"attention mask"),B2.forEach(s),Wf=n(Ss,", "),ll=r(Ss,"CODE",{});var G2=i(ll);Uf=n(G2,"token type ids"),G2.forEach(s),Hf=n(Ss,", "),pl=r(Ss,"CODE",{});var R2=i(pl);Bf=n(R2,"labels"),R2.forEach(s),Gf=n(Ss,", "),dl=r(Ss,"CODE",{});var V2=i(dl);Rf=n(V2,"aggregation_labels"),V2.forEach(s),Ss.forEach(s),qc.forEach(s),$r.forEach(s),wc.forEach(s),zd=p(t),le=r(t,"P",{});var Ie=i(le);Io=r(Ie,"A",{href:!0});var K2=i(Io);Vf=n(K2,"TapasTokenizer"),K2.forEach(s),Kf=n(Ie," creates the "),cl=r(Ie,"CODE",{});var Y2=i(cl);Yf=n(Y2,"labels"),Y2.forEach(s),Jf=n(Ie,", "),hl=r(Ie,"CODE",{});var J2=i(hl);Xf=n(J2,"numeric_values"),J2.forEach(s),Zf=n(Ie," and "),ul=r(Ie,"CODE",{});var X2=i(ul);eg=n(X2,"numeric_values_scale"),X2.forEach(s),sg=n(Ie," based on the "),ml=r(Ie,"CODE",{});var Z2=i(ml);tg=n(Z2,"answer_coordinates"),Z2.forEach(s),ag=n(Ie," and "),fl=r(Ie,"CODE",{});var e1=i(fl);ng=n(e1,"answer_text"),e1.forEach(s),og=n(Ie," columns of the TSV file. The "),gl=r(Ie,"CODE",{});var s1=i(gl);rg=n(s1,"float_answer"),s1.forEach(s),ig=n(Ie," and "),_l=r(Ie,"CODE",{});var t1=i(_l);lg=n(t1,"aggregation_labels"),t1.forEach(s),pg=n(Ie," are already in the TSV file of step 2. Here\u2019s an example:"),Ie.forEach(s),$d=p(t),v(La.$$.fragment,t),xd=p(t),bs=r(t,"P",{});var ma=i(bs);dg=n(ma,"Note that "),Wo=r(ma,"A",{href:!0});var a1=i(Wo);cg=n(a1,"TapasTokenizer"),a1.forEach(s),hg=n(ma," expects the data of the table to be "),Tl=r(ma,"STRONG",{});var n1=i(Tl);ug=n(n1,"text-only"),n1.forEach(s),mg=n(ma,". You can use "),bl=r(ma,"CODE",{});var o1=i(bl);fg=n(o1,".astype(str)"),o1.forEach(s),gg=n(ma,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),ma.forEach(s),Cd=p(t),v(Qa.$$.fragment,t),Md=p(t),X=r(t,"P",{});var fe=i(X);_g=n(fe,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),vl=r(fe,"STRONG",{});var r1=i(vl);Tg=n(r1,"not conversational"),r1.forEach(s),bg=n(fe,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),wl=r(fe,"CODE",{});var i1=i(wl);vg=n(i1,"queries"),i1.forEach(s),wg=n(fe,", "),yl=r(fe,"CODE",{});var l1=i(yl);yg=n(l1,"answer_coordinates"),l1.forEach(s),kg=n(fe," and "),kl=r(fe,"CODE",{});var p1=i(kl);jg=n(p1,"answer_text"),p1.forEach(s),qg=n(fe," per table (in the order of their "),jl=r(fe,"CODE",{});var d1=i(jl);Eg=n(d1,"position"),d1.forEach(s),Fg=n(fe,`
index) and batch encode each table with its questions. This will make sure that the `),ql=r(fe,"CODE",{});var c1=i(ql);Ag=n(c1,"prev_labels"),c1.forEach(s),zg=n(fe," token types (see docs of "),Uo=r(fe,"A",{href:!0});var h1=i(Uo);$g=n(h1,"TapasTokenizer"),h1.forEach(s),xg=n(fe,") are set correctly. See "),Oa=r(fe,"A",{href:!0,rel:!0});var u1=i(Oa);Cg=n(u1,"this notebook"),u1.forEach(s),Mg=n(fe," for more info. See "),Ia=r(fe,"A",{href:!0,rel:!0});var m1=i(Ia);Pg=n(m1,"this notebook"),m1.forEach(s),Sg=n(fe," for more info regarding using the TensorFlow model."),fe.forEach(s),Pd=p(t),Ho=r(t,"P",{});var f1=i(Ho);El=r(f1,"STRONG",{});var g1=i(El);Dg=n(g1,"STEP 4: Train (fine-tune) TapasForQuestionAnswering/TFTapasForQuestionAnswering"),g1.forEach(s),f1.forEach(s),Sd=p(t),Ms=r(t,"P",{});var xr=i(Ms);Ng=n(xr,"You can then fine-tune "),Bo=r(xr,"A",{href:!0});var _1=i(Bo);Lg=n(_1,"TapasForQuestionAnswering"),_1.forEach(s),Qg=n(xr," or "),Go=r(xr,"A",{href:!0});var T1=i(Go);Og=n(T1,"TFTapasForQuestionAnswering"),T1.forEach(s),Ig=n(xr," as follows (shown here for the weak supervision for aggregation case):"),xr.forEach(s),Dd=p(t),v(Wa.$$.fragment,t),Nd=p(t),tt=r(t,"H2",{class:!0});var Ec=i(tt);Lt=r(Ec,"A",{id:!0,class:!0,href:!0});var b1=i(Lt);Fl=r(b1,"SPAN",{});var v1=i(Fl);v(Ua.$$.fragment,v1),v1.forEach(s),b1.forEach(s),Wg=p(Ec),Al=r(Ec,"SPAN",{});var w1=i(Al);Ug=n(w1,"Usage: inference"),w1.forEach(s),Ec.forEach(s),Ld=p(t),me=r(t,"P",{});var He=i(me);Hg=n(He,"Here we explain how you can use "),Ro=r(He,"A",{href:!0});var y1=i(Ro);Bg=n(y1,"TapasForQuestionAnswering"),y1.forEach(s),Gg=n(He," or "),Vo=r(He,"A",{href:!0});var k1=i(Vo);Rg=n(k1,"TFTapasForQuestionAnswering"),k1.forEach(s),Vg=n(He," for inference (i.e. making predictions on new data). For inference, only "),zl=r(He,"CODE",{});var j1=i(zl);Kg=n(j1,"input_ids"),j1.forEach(s),Yg=n(He,", "),$l=r(He,"CODE",{});var q1=i($l);Jg=n(q1,"attention_mask"),q1.forEach(s),Xg=n(He," and "),xl=r(He,"CODE",{});var E1=i(xl);Zg=n(E1,"token_type_ids"),E1.forEach(s),e_=n(He," (which you can obtain using "),Ko=r(He,"A",{href:!0});var F1=i(Ko);s_=n(F1,"TapasTokenizer"),F1.forEach(s),t_=n(He,") have to be provided to the model to obtain the logits. Next, you can use the handy "),Cl=r(He,"CODE",{});var A1=i(Cl);a_=n(A1,"convert_logits_to_predictions"),A1.forEach(s),n_=n(He," method to convert these into predicted coordinates and optional aggregation indices."),He.forEach(s),Qd=p(t),Qt=r(t,"P",{});var Fc=i(Qt);o_=n(Fc,"However, note that inference is "),Ml=r(Fc,"STRONG",{});var z1=i(Ml);r_=n(z1,"different"),z1.forEach(s),i_=n(Fc," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),Fc.forEach(s),Od=p(t),v(Ha.$$.fragment,t),Id=p(t),Ue=r(t,"P",{});var ys=i(Ue);l_=n(ys,"In case of a conversational set-up, then each table-question pair must be provided "),Pl=r(ys,"STRONG",{});var $1=i(Pl);p_=n($1,"sequentially"),$1.forEach(s),d_=n(ys," to the model, such that the "),Sl=r(ys,"CODE",{});var x1=i(Sl);c_=n(x1,"prev_labels"),x1.forEach(s),h_=n(ys," token types can be overwritten by the predicted "),Dl=r(ys,"CODE",{});var C1=i(Dl);u_=n(C1,"labels"),C1.forEach(s),m_=n(ys," of the previous table-question pair. Again, more info can be found in "),Ba=r(ys,"A",{href:!0,rel:!0});var M1=i(Ba);f_=n(M1,"this notebook"),M1.forEach(s),g_=n(ys," (for PyTorch) and "),Ga=r(ys,"A",{href:!0,rel:!0});var P1=i(Ga);__=n(P1,"this notebook"),P1.forEach(s),T_=n(ys," (for TensorFlow)."),ys.forEach(s),Wd=p(t),at=r(t,"H2",{class:!0});var Ac=i(at);Ot=r(Ac,"A",{id:!0,class:!0,href:!0});var S1=i(Ot);Nl=r(S1,"SPAN",{});var D1=i(Nl);v(Ra.$$.fragment,D1),D1.forEach(s),S1.forEach(s),b_=p(Ac),Ll=r(Ac,"SPAN",{});var N1=i(Ll);v_=n(N1,"TAPAS specific outputs"),N1.forEach(s),Ac.forEach(s),Ud=p(t),nt=r(t,"DIV",{class:!0});var zc=i(nt);v(Va.$$.fragment,zc),w_=p(zc),Ka=r(zc,"P",{});var $c=i(Ka);y_=n($c,"Output type of "),Yo=r($c,"A",{href:!0});var L1=i(Yo);k_=n(L1,"TapasForQuestionAnswering"),L1.forEach(s),j_=n($c,"."),$c.forEach(s),zc.forEach(s),Hd=p(t),ot=r(t,"H2",{class:!0});var xc=i(ot);It=r(xc,"A",{id:!0,class:!0,href:!0});var Q1=i(It);Ql=r(Q1,"SPAN",{});var O1=i(Ql);v(Ya.$$.fragment,O1),O1.forEach(s),Q1.forEach(s),q_=p(xc),Ol=r(xc,"SPAN",{});var I1=i(Ol);E_=n(I1,"TapasConfig"),I1.forEach(s),xc.forEach(s),Bd=p(t),Xe=r(t,"DIV",{class:!0});var Ds=i(Xe);v(Ja.$$.fragment,Ds),F_=p(Ds),fs=r(Ds,"P",{});var Ns=i(fs);A_=n(Ns,"This is the configuration class to store the configuration of a "),Jo=r(Ns,"A",{href:!0});var W1=i(Jo);z_=n(W1,"TapasModel"),W1.forEach(s),$_=n(Ns,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS `),Il=r(Ns,"EM",{});var U1=i(Il);x_=n(U1,"tapas-base-finetuned-sqa"),U1.forEach(s),C_=n(Ns,` architecture.
Configuration objects inherit from `),Wl=r(Ns,"CODE",{});var H1=i(Wl);M_=n(H1,"PreTrainedConfig"),H1.forEach(s),P_=n(Ns,` and can be used to control the model outputs. Read the
documentation from `),Xo=r(Ns,"A",{href:!0});var B1=i(Xo);S_=n(B1,"PretrainedConfig"),B1.forEach(s),D_=n(Ns," for more information."),Ns.forEach(s),N_=p(Ds),Xa=r(Ds,"P",{});var Cc=i(Xa);L_=n(Cc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Za=r(Cc,"A",{href:!0,rel:!0});var G1=i(Za);Q_=n(G1,"https://github.com/google-research/tapas/tree/master"),G1.forEach(s),O_=n(Cc,"."),Cc.forEach(s),I_=p(Ds),Ul=r(Ds,"P",{});var R1=i(Ul);W_=n(R1,"Example:"),R1.forEach(s),U_=p(Ds),v(en.$$.fragment,Ds),Ds.forEach(s),Gd=p(t),rt=r(t,"H2",{class:!0});var Mc=i(rt);Wt=r(Mc,"A",{id:!0,class:!0,href:!0});var V1=i(Wt);Hl=r(V1,"SPAN",{});var K1=i(Hl);v(sn.$$.fragment,K1),K1.forEach(s),V1.forEach(s),H_=p(Mc),Bl=r(Mc,"SPAN",{});var Y1=i(Bl);B_=n(Y1,"TapasTokenizer"),Y1.forEach(s),Mc.forEach(s),Rd=p(t),pe=r(t,"DIV",{class:!0});var Be=i(pe);v(tn.$$.fragment,Be),G_=p(Be),Gl=r(Be,"P",{});var J1=i(Gl);R_=n(J1,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),J1.forEach(s),V_=p(Be),ne=r(Be,"P",{});var ge=i(ne);K_=n(ge,"This tokenizer inherits from "),Zo=r(ge,"A",{href:!0});var X1=i(Zo);Y_=n(X1,"PreTrainedTokenizer"),X1.forEach(s),J_=n(ge,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),er=r(ge,"A",{href:!0});var Z1=i(er);X_=n(Z1,"TapasTokenizer"),Z1.forEach(s),Z_=n(ge,` creates several token type ids to
