...
<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new ye({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),rn=new ve({}),an=new U({props:{name:"class transformers.DistilBertTokenizer",anchor:"transformers.DistilBertTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/tokenization_distilbert.py#L56"}}),dn=new ve({}),cn=new U({props:{name:"class transformers.DistilBertTokenizerFast",anchor:"transformers.DistilBertTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/tokenization_distilbert_fast.py#L65"}}),un=new ve({}),fn=new U({props:{name:"class transformers.DistilBertModel",anchor:"transformers.DistilBertModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_distilbert.py#L435",parametersDescription:[{anchor:"transformers.DistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new U({props:{name:"forward",anchor:"transformers.DistilBertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_distilbert.py#L507",parametersDescription:[{anchor:"transformers.DistilBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),An=new ve({}),In=new U({props:{name:"class transformers.DistilBertForMultipleChoice",anchor:"transformers.DistilBertForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_distilbert.py#L997",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),On=new U({props:{name:"forward",anchor:"transformers.DistilBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_distilbert.py#L1029",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Rn=new ve({}),Hn=new U({props:{name:"class transformers.DistilBertForTokenClassification",anchor:"transformers.DistilBertForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_distilbert.py#L902",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vn=new U({props:{name:"forward",anchor:"transformers.DistilBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_distilbert.py#L934",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),sr=new ve({}),nr=new U({props:{name:"class transformers.TFDistilBertModel",anchor:"transformers.TFDistilBertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L536",parametersDescription:[{anchor:"transformers.TFDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fs=new me({props:{$$slots:{default:[my]},$$scope:{ctx:C}}}),lr=new U({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L541",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),cr=new ve({}),pr=new U({props:{name:"class transformers.TFDistilBertForMaskedLM",anchor:"transformers.TFDistilBertForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L636",parametersDescription:[{anchor:"transformers.TFDistilBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_s=new me({props:{$$slots:{default:[_y]},$$scope:{ctx:C}}}),gr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForMaskedLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L656",parametersDescription:[{anchor:"transformers.TFDistilBertForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),vr=new ve({}),Tr=new U({props:{name:"class transformers.TFDistilBertForSequenceClassification",anchor:"transformers.TFDistilBertForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L740",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new me({props:{$$slots:{default:[Ty]},$$scope:{ctx:C}}}),$r=new U({props:{name:"call",anchor:"transformers.TFDistilBertForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L757",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Fr=new ve({}),yr=new U({props:{name:"class transformers.TFDistilBertForMultipleChoice",anchor:"transformers.TFDistilBertForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L931",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$s=new me({props:{$$slots:{default:[ky]},$$scope:{ctx:C}}}),xr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L957",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Cr=new ve({}),jr=new U({props:{name:"class transformers.TFDistilBertForTokenClassification",anchor:"transformers.TFDistilBertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L841",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ys=new me({props:{$$slots:{default:[$y]},$$scope:{ctx:C}}}),Ir=new U({props:{name:"call",anchor:"transformers.TFDistilBertForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L852",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Sr=new ve({}),Nr=new U({props:{name:"class transformers.TFDistilBertForQuestionAnswering",anchor:"transformers.TFDistilBertForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1073",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Es=new me({props:{$$slots:{default:[Fy]},$$scope:{ctx:C}}}),Hr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1084",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ua=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Da=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qa=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),si=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15722/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15722/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15722/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
general usage and behavior.`),ZT=l(),Ld=s("p"),e2=a("Finally, this model supports inherent JAX features such as:"),t2=l(),Bt=s("ul"),Sd=s("li"),Xr=s("a"),o2=a("Just-In-Time (JIT) compilation"),s2=l(),Nd=s("li"),Yr=s("a"),n2=a("Automatic Differentiation"),r2=l(),Od=s("li"),Zr=s("a"),a2=a("Vectorization"),i2=l(),Wd=s("li"),ea=s("a"),l2=a("Parallelization"),d2=l(),nt=s("div"),b(ta.$$.fragment),c2=l(),Lo=s("p"),p2=a("The "),Rd=s("code"),h2=a("FlaxDistilBertPreTrainedModel"),u2=a("forward method, overrides the "),Hd=s("code"),f2=a("__call__"),m2=a(" special method."),g2=l(),b(Cs.$$.fragment),_2=l(),Qd=s("p"),v2=a("Example:"),T2=l(),b(oa.$$.fragment),Up=l(),So=s("h2"),js=s("a"),Ud=s("span"),b(sa.$$.fragment),b2=l(),Jd=s("span"),k2=a("FlaxDistilBertForMaskedLM"),Jp=l(),Me=s("div"),b(na.$$.fragment),w2=l(),ra=s("p"),$2=a("DistilBert Model with a "),Vd=s("code"),D2=a("language modeling"),F2=a(" head on top."),y2=l(),aa=s("p"),B2=a("This model inherits from "),Hi=s("a"),M2=a("FlaxPreTrainedModel"),E2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),x2=l(),ia=s("p"),z2=a("This model is also a Flax Linen "),la=s("a"),C2=a("flax.linen.Module"),j2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P2=l(),Kd=s("p"),q2=a("Finally, this model supports inherent JAX features such as:"),A2=l(),Mt=s("ul"),Gd=s("li"),da=s("a"),I2=a("Just-In-Time (JIT) compilation"),L2=l(),Xd=s("li"),ca=s("a"),S2=a("Automatic Differentiation"),N2=l(),Yd=s("li"),pa=s("a"),O2=a("Vectorization"),W2=l(),Zd=s("li"),ha=s("a"),R2=a("Parallelization"),H2=l(),rt=s("div"),b(ua.$$.fragment),Q2=l(),No=s("p"),U2=a("The "),ec=s("code"),J2=a("FlaxDistilBertPreTrainedModel"),V2=a("forward method, overrides the "),tc=s("code"),K2=a("__call__"),G2=a(" special method."),X2=l(),b(Ps.$$.fragment),Y2=l(),oc=s("p"),Z2=a("Example:"),eb=l(),b(fa.$$.fragment),Vp=l(),Oo=s("h2"),qs=s("a"),sc=s("span"),b(ma.$$.fragment),tb=l(),nc=s("span"),ob=a("FlaxDistilBertForSequenceClassification"),Kp=l(),Ee=s("div"),b(ga.$$.fragment),sb=l(),rc=s("p"),nb=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ub=l(),_c=s("p"),Jb=a("Finally, this model supports inherent JAX features such as:"),Vb=l(),xt=s("ul"),vc=s("li"),za=s("a"),Kb=a("Just-In-Time (JIT) compilation"),Gb=l(),Tc=s("li"),Ca=s("a"),Xb=a("Automatic Differentiation"),Yb=l(),bc=s("li"),ja=s("a"),Zb=a("Vectorization"),e1=l(),kc=s("li"),Pa=s("a"),t1=a("Parallelization"),o1=l(),it=s("div"),b(qa.$$.fragment),s1=l(),Ho=s("p"),n1=a("The "),wc=s("code"),r1=a("FlaxDistilBertPreTrainedModel"),a1=a("forward method, overrides the "),$c=s("code"),i1=a("__call__"),l1=a(" special method."),d1=l(),b(Ls.$$.fragment),c1=l(),Dc=s("p"),p1=a("Example:"),h1=l(),b(Aa.$$.fragment),Yp=l(),Qo=s("h2"),Ss=s("a"),Fc=s("span"),b(Ia.$$.fragment),u1=l(),yc=s("span"),f1=a("FlaxDistilBertForTokenClassification"),Zp=l(),ze=s("div"),b(La.$$.fragment),m1=l(),Bc=s("p"),g1=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),_1=l(),Sa=s("p"),v1=a("This model inherits from "),Ji=s("a"),T1=a("FlaxPreTrainedModel"),b1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k1=l(),Na=s("p"),w1=a("This model is also a Flax Linen "),Oa=s("a"),$1=a("flax.linen.Module"),D1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),F1=l(),Mc=s("p"),y1=a("Finally, this model supports inherent JAX features such as:"),B1=l(),zt=s("ul"),Ec=s("li"),Wa=s("a"),M1=a("Just-In-Time (JIT) compilation"),E1=l(),xc=s("li"),Ra=s("a"),x1=a("Automatic Differentiation"),z1=l(),zc=s("li"),Ha=s("a"),C1=a("Vectorization"),j1=l(),Cc=s("li"),Qa=s("a"),P1=a("Parallelization"),q1=l(),lt=s("div"),b(Ua.$$.fragment),A1=l(),Uo=s("p"),I1=a("The "),jc=s("code"),L1=a("FlaxDistilBertPreTrainedModel"),S1=a("forward method, overrides the "),Pc=s("code"),N1=a("__call__"),O1=a(" special method."),W1=l(),b(Ns.$$.fragment),R1=l(),qc=s("p"),H1=a("Example:"),Q1=l(),b(Ja.$$.fragment),eh=l(),Jo=s("h2"),Os=s("a"),Ac=s("span"),b(Va.$$.fragment),U1=l(),Ic=s("span"),J1=a("FlaxDistilBertForQuestionAnswering"),th=l(),Ce=s("div"),b(Ka.$$.fragment),V1=l(),Vo=s("p"),K1=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Lc=s("code"),G1=a("span start logits"),X1=a(" and "),Sc=s("code"),Y1=a("span end logits"),Z1=a(")."),ek=l(),Ga=s("p"),tk=a("This model inherits from "),Vi=s("a"),ok=a("FlaxPreTrainedModel"),sk=a(`. Check the superclass documentation for the generic methods the
...
necessary though, just let us know if you need this option.`),li.forEach(t),ii.forEach(t),up=d(o),Tt=n(o,"P",{});var qt=r(Tt);uu=i(qt,"This model was contributed by "),Ys=n(qt,"A",{href:!0,rel:!0});var Ek=r(Ys);fu=i(Ek,"victorsanh"),Ek.forEach(t),mu=i(qt,`. This model jax version was
contributed by `),Zs=n(qt,"A",{href:!0,rel:!0});var xk=r(Zs);gu=i(xk,"kamalkraj"),xk.forEach(t),_u=i(qt,". The original code can be found "),en=n(qt,"A",{href:!0,rel:!0});var zk=r(en);vu=i(zk,"here"),zk.forEach(t),Tu=i(qt,"."),qt.forEach(t),fp=d(o),ao=n(o,"H2",{class:!0});var sh=r(ao);Go=n(sh,"A",{id:!0,class:!0,href:!0});var Ck=r(Go);_l=n(Ck,"SPAN",{});var jk=r(_l);k(tn.$$.fragment,jk),jk.forEach(t),Ck.forEach(t),bu=d(sh),vl=n(sh,"SPAN",{});var Pk=r(vl);ku=i(Pk,"DistilBertConfig"),Pk.forEach(t),sh.forEach(t),mp=d(o),Ne=n(o,"DIV",{class:!0});var At=r(Ne);k(on.$$.fragment,At),wu=d(At),yt=n(At,"P",{});var Rs=r(yt);$u=i(Rs,"This is the configuration class to store the configuration of a "),di=n(Rs,"A",{href:!0});var qk=r(di);Du=i(qk,"DistilBertModel"),qk.forEach(t),Fu=i(Rs," or a "),ci=n(Rs,"A",{href:!0});var Ak=r(ci);yu=i(Ak,"TFDistilBertModel"),Ak.forEach(t),Bu=i(Rs,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
`),sn=n(Rs,"A",{href:!0,rel:!0});var Ik=r(sn);Mu=i(Ik,"distilbert-base-uncased"),Ik.forEach(t),Eu=i(Rs," architecture."),Rs.forEach(t),xu=d(At),io=n(At,"P",{});var Ki=r(io);zu=i(Ki,"Configuration objects inherit from "),pi=n(Ki,"A",{href:!0});var Lk=r(pi);Cu=i(Lk,"PretrainedConfig"),Lk.forEach(t),ju=i(Ki,` and can be used to control the model outputs. Read the
documentation from `),hi=n(Ki,"A",{href:!0});var Sk=r(hi);Pu=i(Sk,"PretrainedConfig"),Sk.forEach(t),qu=i(Ki," for more information."),Ki.forEach(t),Au=d(At),Tl=n(At,"P",{});var Nk=r(Tl);Iu=i(Nk,"Examples:"),Nk.forEach(t),Lu=d(At),k(nn.$$.fragment,At),At.forEach(t),gp=d(o),lo=n(o,"H2",{class:!0});var nh=r(lo);Xo=n(nh,"A",{id:!0,class:!0,href:!0});var Ok=r(Xo);bl=n(Ok,"SPAN",{});var Wk=r(bl);k(rn.$$.fragment,Wk),Wk.forEach(t),Ok.forEach(t),Su=d(nh),kl=n(nh,"SPAN",{});var Rk=r(kl);Nu=i(Rk,"DistilBertTokenizer"),Rk.forEach(t),nh.forEach(t),_p=d(o),_t=n(o,"DIV",{class:!0});var Hs=r(_t);k(an.$$.fragment,Hs),Ou=d(Hs),wl=n(Hs,"P",{});var Hk=r(wl);Wu=i(Hk,"Construct a DistilBERT tokenizer."),Hk.forEach(t),Ru=d(Hs),Yo=n(Hs,"P",{});var pp=r(Yo);ui=n(pp,"A",{href:!0});var Qk=r(ui);Hu=i(Qk,"DistilBertTokenizer"),Qk.forEach(t),Qu=i(pp," is identical to "),fi=n(pp,"A",{href:!0});var Uk=r(fi);Uu=i(Uk,"BertTokenizer"),Uk.forEach(t),Ju=i(pp,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),pp.forEach(t),Vu=d(Hs),ln=n(Hs,"P",{});var rh=r(ln);Ku=i(rh,"Refer to superclass "),mi=n(rh,"A",{href:!0});var Jk=r(mi);Gu=i(Jk,"BertTokenizer"),Jk.forEach(t),Xu=i(rh," for usage examples and documentation concerning parameters."),rh.forEach(t),Hs.forEach(t),vp=d(o),co=n(o,"H2",{class:!0});var ah=r(co);Zo=n(ah,"A",{id:!0,class:!0,href:!0});var Vk=r(Zo);$l=n(Vk,"SPAN",{});var Kk=r($l);k(dn.$$.fragment,Kk),Kk.forEach(t),Vk.forEach(t),Yu=d(ah),Dl=n(ah,"SPAN",{});var Gk=r(Dl);Zu=i(Gk,"DistilBertTokenizerFast"),Gk.forEach(t),ah.forEach(t),Tp=d(o),vt=n(o,"DIV",{class:!0});var Qs=r(vt);k(cn.$$.fragment,Qs),ef=d(Qs),pn=n(Qs,"P",{});var ih=r(pn);tf=i(ih,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Fl=n(ih,"EM",{});var Xk=r(Fl);of=i(Xk,"tokenizers"),Xk.forEach(t),sf=i(ih," library)."),ih.forEach(t),nf=d(Qs),es=n(Qs,"P",{});var hp=r(es);gi=n(hp,"A",{href:!0});var Yk=r(gi);rf=i(Yk,"DistilBertTokenizerFast"),Yk.forEach(t),af=i(hp," is identical to "),_i=n(hp,"A",{href:!0});var Zk=r(_i);lf=i(Zk,"BertTokenizerFast"),Zk.forEach(t),df=i(hp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),hp.forEach(t),cf=d(Qs),hn=n(Qs,"P",{});var lh=r(hn);pf=i(lh,"Refer to superclass "),vi=n(lh,"A",{href:!0});var ew=r(vi);hf=i(ew,"BertTokenizerFast"),ew.forEach(t),uf=i(lh," for usage examples and documentation concerning parameters."),lh.forEach(t),Qs.forEach(t),bp=d(o),po=n(o,"H2",{class:!0});var dh=r(po);ts=n(dh,"A",{id:!0,class:!0,href:!0});var tw=r(ts);yl=n(tw,"SPAN",{});var ow=r(yl);k(un.$$.fragment,ow),ow.forEach(t),tw.forEach(t),ff=d(dh),Bl=n(dh,"SPAN",{});var sw=r(Bl);mf=i(sw,"DistilBertModel"),sw.forEach(t),dh.forEach(t),kp=d(o),Oe=n(o,"DIV",{class:!0});var It=r(Oe);k(fn.$$.fragment,It),gf=d(It),Ml=n(It,"P",{});var nw=r(Ml);_f=i(nw,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),nw.forEach(t),vf=d(It),mn=n(It,"P",{});var ch=r(mn);Tf=i(ch,"This model inherits from "),Ti=n(ch,"A",{href:!0});var rw=r(Ti);bf=i(rw,"PreTrainedModel"),rw.forEach(t),kf=i(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ph.forEach(t),yf=d(It),Je=n(It,"DIV",{class:!0});var Lt=r(Je);k(vn.$$.fragment,Lt),Bf=d(Lt),ho=n(Lt,"P",{});var Gi=r(ho);Mf=i(Gi,"The "),bi=n(Gi,"A",{href:!0});var iw=r(bi);Ef=i(iw,"DistilBertModel"),iw.forEach(t),xf=i(Gi," forward method, overrides the "),El=n(Gi,"CODE",{});var lw=r(El);zf=i(lw,"__call__"),lw.forEach(t),Cf=i(Gi," special method."),Gi.forEach(t),jf=d(Lt),k(os.$$.fragment,Lt),Pf=d(Lt),xl=n(Lt,"P",{});var dw=r(xl);qf=i(dw,"Example:"),dw.forEach(t),Af=d(Lt),k(Tn.$$.fragment,Lt),Lt.forEach(t),It.forEach(t),wp=d(o),uo=n(o,"H2",{class:!0});var hh=r(uo);ss=n(hh,"A",{id:!0,class:!0,href:!0});var cw=r(ss);zl=n(cw,"SPAN",{});var pw=r(zl);k(bn.$$.fragment,pw),pw.forEach(t),cw.forEach(t),If=d(hh),Cl=n(hh,"SPAN",{});var hw=r(Cl);Lf=i(hw,"DistilBertForMaskedLM"),hw.forEach(t),hh.forEach(t),$p=d(o),We=n(o,"DIV",{class:!0});var St=r(We);k(kn.$$.fragment,St),Sf=d(St),wn=n(St,"P",{});var uh=r(wn);Nf=i(uh,"DistilBert Model with a "),jl=n(uh,"CODE",{});var uw=r(jl);Of=i(uw,"masked language modeling"),uw.forEach(t),Wf=i(uh," head on top."),uh.forEach(t),Rf=d(St),$n=n(St,"P",{});var fh=r($n);Hf=i(fh,"This model inherits from "),ki=n(fh,"A",{href:!0});var fw=r(ki);Qf=i(fw,"PreTrainedModel"),fw.forEach(t),Uf=i(fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fh.forEach(t),Jf=d(St),Dn=n(St,"P",{});var mh=r(Dn);Vf=i(mh,"This model is also a PyTorch "),Fn=n(mh,"A",{href:!0,rel:!0});var mw=r(Fn);Kf=i(mw,"torch.nn.Module"),mw.forEach(t),Gf=i(mh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mh.forEach(t),Xf=d(St),Ve=n(St,"DIV",{class:!0});var Nt=r(Ve);k(yn.$$.fragment,Nt),Yf=d(Nt),fo=n(Nt,"P",{});var Xi=r(fo);Zf=i(Xi,"The "),wi=n(Xi,"A",{href:!0});var gw=r(wi);em=i(gw,"DistilBertForMaskedLM"),gw.forEach(t),tm=i(Xi," forward method, overrides the "),Pl=n(Xi,"CODE",{});var _w=r(Pl);om=i(_w,"__call__"),_w.forEach(t),sm=i(Xi," special method."),Xi.forEach(t),nm=d(Nt),k(ns.$$.fragment,Nt),rm=d(Nt),ql=n(Nt,"P",{});var vw=r(ql);am=i(vw,"Example:"),vw.forEach(t),im=d(Nt),k(Bn.$$.fragment,Nt),Nt.forEach(t),St.forEach(t),Dp=d(o),mo=n(o,"H2",{class:!0});var gh=r(mo);rs=n(gh,"A",{id:!0,class:!0,href:!0});var Tw=r(rs);Al=n(Tw,"SPAN",{});var bw=r(Al);k(Mn.$$.fragment,bw),bw.forEach(t),Tw.forEach(t),lm=d(gh),Il=n(gh,"SPAN",{});var kw=r(Il);dm=i(kw,"DistilBertForSequenceClassification"),kw.forEach(t),gh.forEach(t),Fp=d(o),Re=n(o,"DIV",{class:!0});var Ot=r(Re);k(En.$$.fragment,Ot),cm=d(Ot),Ll=n(Ot,"P",{});var ww=r(Ll);pm=i(ww,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vh.forEach(t),bm=d(Ot),je=n(Ot,"DIV",{class:!0});var ct=r(je);k(jn.$$.fragment,ct),km=d(ct),go=n(ct,"P",{});var Yi=r(go);wm=i(Yi,"The "),Di=n(Yi,"A",{href:!0});var Fw=r(Di);$m=i(Fw,"DistilBertForSequenceClassification"),Fw.forEach(t),Dm=i(Yi," forward method, overrides the "),Sl=n(Yi,"CODE",{});var yw=r(Sl);Fm=i(yw,"__call__"),yw.forEach(t),ym=i(Yi," special method."),Yi.forEach(t),Bm=d(ct),k(as.$$.fragment,ct),Mm=d(ct),Nl=n(ct,"P",{});var Bw=r(Nl);Em=i(Bw,"Example of single-label classification:"),Bw.forEach(t),xm=d(ct),k(Pn.$$.fragment,ct),zm=d(ct),Ol=n(ct,"P",{});var Mw=r(Ol);Cm=i(Mw,"Example of multi-label classification:"),Mw.forEach(t),jm=d(ct),k(qn.$$.fragment,ct),ct.forEach(t),Ot.forEach(t),yp=d(o),_o=n(o,"H2",{class:!0});var Th=r(_o);is=n(Th,"A",{id:!0,class:!0,href:!0});var Ew=r(is);Wl=n(Ew,"SPAN",{});var xw=r(Wl);k(An.$$.fragment,xw),xw.forEach(t),Ew.forEach(t),Pm=d(Th),Rl=n(Th,"SPAN",{});var zw=r(Rl);qm=i(zw,"DistilBertForMultipleChoice"),zw.forEach(t),Th.forEach(t),Bp=d(o),He=n(o,"DIV",{class:!0});var Wt=r(He);k(In.$$.fragment,Wt),Am=d(Wt),Hl=n(Wt,"P",{});var Cw=r(Hl);Im=i(Cw,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kh.forEach(t),Um=d(Wt),Ke=n(Wt,"DIV",{class:!0});var Rt=r(Ke);k(On.$$.fragment,Rt),Jm=d(Rt),vo=n(Rt,"P",{});var Zi=r(vo);Vm=i(Zi,"The "),yi=n(Zi,"A",{href:!0});var qw=r(yi);Km=i(qw,"DistilBertForMultipleChoice"),qw.forEach(t),Gm=i(Zi," forward method, overrides the "),Ql=n(Zi,"CODE",{});var Aw=r(Ql);Xm=i(Aw,"__call__"),Aw.forEach(t),Ym=i(Zi," special method."),Zi.forEach(t),Zm=d(Rt),k(ls.$$.fragment,Rt),eg=d(Rt),Ul=n(Rt,"P",{});var Iw=r(Ul);tg=i(Iw,"Examples:"),Iw.forEach(t),og=d(Rt),k(Wn.$$.fragment,Rt),Rt.forEach(t),Wt.forEach(t),Mp=d(o),To=n(o,"H2",{class:!0});var wh=r(To);ds=n(wh,"A",{id:!0,class:!0,href:!0});var Lw=r(ds);Jl=n(Lw,"SPAN",{});var Sw=r(Jl);k(Rn.$$.fragment,Sw),Sw.forEach(t),Lw.forEach(t),sg=d(wh),Vl=n(wh,"SPAN",{});var Nw=r(Vl);ng=i(Nw,"DistilBertForTokenClassification"),Nw.forEach(t),wh.forEach(t),Ep=d(o),Qe=n(o,"DIV",{class:!0});var Ht=r(Qe);k(Hn.$$.fragment,Ht),rg=d(Ht),Kl=n(Ht,"P",{});var Ow=r(Kl);ag=i(Ow,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$h.forEach(t),pg=d(Ht),Un=n(Ht,"P",{});var Dh=r(Un);hg=i(Dh,"This model is also a PyTorch "),Jn=n(Dh,"A",{href:!0,rel:!0});var Rw=r(Jn);ug=i(Rw,"torch.nn.Module"),Rw.forEach(t),fg=i(Dh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dh.forEach(t),mg=d(Ht),Ge=n(Ht,"DIV",{class:!0});var Qt=r(Ge);k(Vn.$$.fragment,Qt),gg=d(Qt),bo=n(Qt,"P",{});var el=r(bo);_g=i(el,"The "),Mi=n(el,"A",{href:!0});var Hw=r(Mi);vg=i(Hw,"DistilBertForTokenClassification"),Hw.forEach(t),Tg=i(el," forward method, overrides the "),Gl=n(el,"CODE",{});var Qw=r(Gl);bg=i(Qw,"__call__"),Qw.forEach(t),kg=i(el," special method."),el.forEach(t),wg=d(Qt),k(cs.$$.fragment,Qt),$g=d(Qt),Xl=n(Qt,"P",{});var Uw=r(Xl);Dg=i(Uw,"Example:"),Uw.forEach(t),Fg=d(Qt),k(Kn.$$.fragment,Qt),Qt.forEach(t),Ht.forEach(t),xp=d(o),ko=n(o,"H2",{class:!0});var Fh=r(ko);ps=n(Fh,"A",{id:!0,class:!0,href:!0});var Jw=r(ps);Yl=n(Jw,"SPAN",{});var Vw=r(Yl);k(Gn.$$.fragment,Vw),Vw.forEach(t),Jw.forEach(t),yg=d(Fh),Zl=n(Fh,"SPAN",{});var Kw=r(Zl);Bg=i(Kw,"DistilBertForQuestionAnswering"),Kw.forEach(t),Fh.forEach(t),zp=d(o),Ue=n(o,"DIV",{class:!0});var Ut=r(Ue);k(Xn.$$.fragment,Ut),Mg=d(Ut),wo=n(Ut,"P",{});var tl=r(wo);Eg=i(tl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kh.forEach(t),ZT=d(pt),Ld=n(pt,"P",{});var cD=r(Ld);e2=i(cD,"Finally, this model supports inherent JAX features such as:"),cD.forEach(t),t2=d(pt),Bt=n(pt,"UL",{});var Us=r(Bt);Sd=n(Us,"LI",{});var pD=r(Sd);Xr=n(pD,"A",{href:!0,rel:!0});var hD=r(Xr);o2=i(hD,"Just-In-Time (JIT) compilation"),hD.forEach(t),pD.forEach(t),s2=d(Us),Nd=n(Us,"LI",{});var uD=r(Nd);Yr=n(uD,"A",{href:!0,rel:!0});var fD=r(Yr);n2=i(fD,"Automatic Differentiation"),fD.forEach(t),uD.forEach(t),r2=d(Us),Od=n(Us,"LI",{});var mD=r(Od);Zr=n(mD,"A",{href:!0,rel:!0});var gD=r(Zr);a2=i(gD,"Vectorization"),gD.forEach(t),mD.forEach(t),i2=d(Us),Wd=n(Us,"LI",{});var _D=r(Wd);ea=n(_D,"A",{href:!0,rel:!0});var vD=r(ea);l2=i(vD,"Parallelization"),vD.forEach(t),_D.forEach(t),Us.forEach(t),d2=d(pt),nt=n(pt,"DIV",{class:!0});var eo=r(nt);k(ta.$$.fragment,eo),c2=d(eo),Lo=n(eo,"P",{});var cl=r(Lo);p2=i(cl,"The "),Rd=n(cl,"CODE",{});var TD=r(Rd);h2=i(TD,"FlaxDistilBertPreTrainedModel"),TD.forEach(t),u2=i(cl,"forward method, overrides the "),Hd=n(cl,"CODE",{});var bD=r(Hd);f2=i(bD,"__call__"),bD.forEach(t),m2=i(cl," special method."),cl.forEach(t),g2=d(eo),k(Cs.$$.fragment,eo),_2=d(eo),Qd=n(eo,"P",{});var kD=r(Qd);v2=i(kD,"Example:"),kD.forEach(t),T2=d(eo),k(oa.$$.fragment,eo),eo.forEach(t),pt.forEach(t),Up=d(o),So=n(o,"H2",{class:!0});var Gh=r(So);js=n(Gh,"A",{id:!0,class:!0,href:!0});var wD=r(js);Ud=n(wD,"SPAN",{});var $D=r(Ud);k(sa.$$.fragment,$D),$D.forEach(t),wD.forEach(t),b2=d(Gh),Jd=n(Gh,"SPAN",{});var DD=r(Jd);k2=i(DD,"FlaxDistilBertForMaskedLM"),DD.forEach(t),Gh.forEach(t),Jp=d(o),Me=n(o,"DIV",{class:!0});var ht=r(Me);k(na.$$.fragment,ht),w2=d(ht),ra=n(ht,"P",{});var Xh=r(ra);$2=i(Xh,"DistilBert Model with a "),Vd=n(Xh,"CODE",{});var FD=r(Vd);D2=i(FD,"language modeling"),FD.forEach(t),F2=i(Xh," head on top."),Xh.forEach(t),y2=d(ht),aa=n(ht,"P",{});var Yh=r(aa);B2=i(Yh,"This model inherits from "),Hi=n(Yh,"A",{href:!0});var yD=r(Hi);M2=i(yD,"FlaxPreTrainedModel"),yD.forEach(t),E2=i(Yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yh.forEach(t),x2=d(ht),ia=n(ht,"P",{});var Zh=r(ia);z2=i(Zh,"This model is also a Flax Linen "),la=n(Zh,"A",{href:!0,rel:!0});var BD=r(la);C2=i(BD,"flax.linen.Module"),BD.forEach(t),j2=i(Zh,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zh.forEach(t),P2=d(ht),Kd=n(ht,"P",{});var MD=r(Kd);q2=i(MD,"Finally, this model supports inherent JAX features such as:"),MD.forEach(t),A2=d(ht),Mt=n(ht,"UL",{});var Js=r(Mt);Gd=n(Js,"LI",{});var ED=r(Gd);da=n(ED,"A",{href:!0,rel:!0});var xD=r(da);I2=i(xD,"Just-In-Time (JIT) compilation"),xD.forEach(t),ED.forEach(t),L2=d(Js),Xd=n(Js,"LI",{});var zD=r(Xd);ca=n(zD,"A",{href:!0,rel:!0});var CD=r(ca);S2=i(CD,"Automatic Differentiation"),CD.forEach(t),zD.forEach(t),N2=d(Js),Yd=n(Js,"LI",{});var jD=r(Yd);pa=n(jD,"A",{href:!0,rel:!0});var PD=r(pa);O2=i(PD,"Vectorization"),PD.forEach(t),jD.forEach(t),W2=d(Js),Zd=n(Js,"LI",{});var qD=r(Zd);ha=n(qD,"A",{href:!0,rel:!0});var AD=r(ha);R2=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Js.forEach(t),H2=d(ht),rt=n(ht,"DIV",{class:!0});var to=r(rt);k(ua.$$.fragment,to),Q2=d(to),No=n(to,"P",{});var pl=r(No);U2=i(pl,"The "),ec=n(pl,"CODE",{});var ID=r(ec);J2=i(ID,"FlaxDistilBertPreTrainedModel"),ID.forEach(t),V2=i(pl,"forward method, overrides the "),tc=n(pl,"CODE",{});var LD=r(tc);K2=i(LD,"__call__"),LD.forEach(t),G2=i(pl," special method."),pl.forEach(t),X2=d(to),k(Ps.$$.fragment,to),Y2=d(to),oc=n(to,"P",{});var SD=r(oc);Z2=i(SD,"Example:"),SD.forEach(t),eb=d(to),k(fa.$$.fragment,to),to.forEach(t),ht.forEach(t),Vp=d(o),Oo=n(o,"H2",{class:!0});var eu=r(Oo);qs=n(eu,"A",{id:!0,class:!0,href:!0});var ND=r(qs);sc=n(ND,"SPAN",{});var OD=r(sc);k(ma.$$.fragment,OD),OD.forEach(t),ND.forEach(t),tb=d(eu),nc=n(eu,"SPAN",{});var WD=r(nc);ob=i(WD,"FlaxDistilBertForSequenceClassification"),WD.forEach(t),eu.forEach(t),Kp=d(o),Ee=n(o,"DIV",{class:!0});var ut=r(Ee);k(ga.$$.fragment,ut),sb=d(ut),rc=n(ut,"P",{});var RD=r(rc);nb=i(RD,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tu.forEach(t),db=d(ut),va=n(ut,"P",{});var ou=r(va);cb=i(ou,"This model is also a Flax Linen "),Ta=n(ou,"A",{href:!0,rel:!0});var QD=r(Ta);pb=i(QD,"flax.linen.Module"),QD.forEach(t),hb=i(ou,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ou.forEach(t),ub=d(ut),ac=n(ut,"P",{});var UD=r(ac);fb=i(UD,"Finally, this model supports inherent JAX features such as:"),UD.forEach(t),mb=d(ut),Et=n(ut,"UL",{});var Vs=r(Et);ic=n(Vs,"LI",{});var JD=r(ic);ba=n(JD,"A",{href:!0,rel:!0});var VD=r(ba);gb=i(VD,"Just-In-Time (JIT) compilation"),VD.forEach(t),JD.forEach(t),_b=d(Vs),lc=n(Vs,"LI",{});var KD=r(lc);ka=n(KD,"A",{href:!0,rel:!0});var GD=r(ka);vb=i(GD,"Automatic Differentiation"),GD.forEach(t),KD.forEach(t),Tb=d(Vs),dc=n(Vs,"LI",{});var XD=r(dc);wa=n(XD,"A",{href:!0,rel:!0});var YD=r(wa);bb=i(YD,"Vectorization"),YD.forEach(t),XD.forEach(t),kb=d(Vs),cc=n(Vs,"LI",{});var ZD=r(cc);$a=n(ZD,"A",{href:!0,rel:!0});var eF=r($a);wb=i(eF,"Parallelization"),eF.forEach(t),ZD.forEach(t),Vs.forEach(t),$b=d(ut),at=n(ut,"DIV",{class:!0});var oo=r(at);k(Da.$$.fragment,oo),Db=d(oo),Wo=n(oo,"P",{});var hl=r(Wo);Fb=i(hl,"The "),pc=n(hl,"CODE",{});var tF=r(pc);yb=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),Bb=i(hl,"forward method, overrides the "),hc=n(hl,"CODE",{});var oF=r(hc);Mb=i(oF,"__call__"),oF.forEach(t),Eb=i(hl," special method."),hl.forEach(t),xb=d(oo),k(As.$$.fragment,oo),zb=d(oo),uc=n(oo,"P",{});var sF=r(uc);Cb=i(sF,"Example:"),sF.forEach(t),jb=d(oo),k(Fa.$$.fragment,oo),oo.forEach(t),ut.forEach(t),Gp=d(o),Ro=n(o,"H2",{class:!0});var su=r(Ro);Is=n(su,"A",{id:!0,class:!0,href:!0});var nF=r(Is);fc=n(nF,"SPAN",{});var rF=r(fc);k(ya.$$.fragment,rF),rF.forEach(t),nF.forEach(t),Pb=d(su),mc=n(su,"SPAN",{});var aF=r(mc);qb=i(aF,"FlaxDistilBertForMultipleChoice"),aF.forEach(t),su.forEach(t),Xp=d(o),xe=n(o,"DIV",{class:!0});var ft=r(xe);k(Ba.$$.fragment,ft),Ab=d(ft),gc=n(ft,"P",{});var iF=r(gc);Ib=i(iF,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ru.forEach(t),Ub=d(ft),_c=n(ft,"P",{});var cF=r(_c);Jb=i(cF,"Finally, this model supports inherent JAX features such as:"),cF.forEach(t),Vb=d(ft),xt=n(ft,"UL",{});var Ks=r(xt);vc=n(Ks,"LI",{});var pF=r(vc);za=n(pF,"A",{href:!0,rel:!0});var hF=r(za);Kb=i(hF,"Just-In-Time (JIT) compilation"),hF.forEach(t),pF.forEach(t),Gb=d(Ks),Tc=n(Ks,"LI",{});var uF=r(Tc);Ca=n(uF,"A",{href:!0,rel:!0});var fF=r(Ca);Xb=i(fF,"Automatic Differentiation"),fF.forEach(t),uF.forEach(t),Yb=d(Ks),bc=n(Ks,"LI",{});var mF=r(bc);ja=n(mF,"A",{href:!0,rel:!0});var gF=r(ja);Zb=i(gF,"Vectorization"),gF.forEach(t),mF.forEach(t),e1=d(Ks),kc=n(Ks,"LI",{});var _F=r(kc);Pa=n(_F,"A",{href:!0,rel:!0});var vF=r(Pa);t1=i(vF,"Parallelization"),vF.forEach(t),_F.forEach(t),Ks.forEach(t),o1=d(ft),it=n(ft,"DIV",{class:!0});var so=r(it);k(qa.$$.fragment,so),s1=d(so),Ho=n(so,"P",{});var ul=r(Ho);n1=i(ul,"The "),wc=n(ul,"CODE",{});var TF=r(wc);r1=i(TF,"FlaxDistilBertPreTrainedModel"),TF.forEach(t),a1=i(ul,"forward method, overrides the "),$c=n(ul,"CODE",{});var bF=r($c);i1=i(bF,"__call__"),bF.forEach(t),l1=i(ul," special method."),ul.forEach(t),d1=d(so),k(Ls.$$.fragment,so),c1=d(so),Dc=n(so,"P",{});var kF=r(Dc);p1=i(kF,"Example:"),kF.forEach(t),h1=d(so),k(Aa.$$.fragment,so),so.forEach(t),ft.forEach(t),Yp=d(o),Qo=n(o,"H2",{class:!0});var au=r(Qo);Ss=n(au,"A",{id:!0,class:!0,href:!0});var wF=r(Ss);Fc=n(wF,"SPAN",{});var $F=r(Fc);k(Ia.$$.fragment,$F),$F.forEach(t),wF.forEach(t),u1=d(au),yc=n(au,"SPAN",{});var DF=r(yc);f1=i(DF,"FlaxDistilBertForTokenClassification"),DF.forEach(t),au.forEach(t),Zp=d(o),ze=n(o,"DIV",{class:!0});var mt=r(ze);k(La.$$.fragment,mt),m1=d(mt),Bc=n(mt,"P",{});var FF=r(Bc);g1=i(FF,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),FF.forEach(t),_1=d(mt),Sa=n(mt,"P",{});var iu=r(Sa);v1=i(iu,"This model inherits from "),Ji=n(iu,"A",{href:!0});var yF=r(Ji);T1=i(yF,"FlaxPreTrainedModel"),yF.forEach(t),b1=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),k1=d(mt),Na=n(mt,"P",{});var lu=r(Na);w1=i(lu,"This model is also a Flax Linen "),Oa=n(lu,"A",{href:!0,rel:!0});var BF=r(Oa);$1=i(BF,"flax.linen.Module"),BF.forEach(t),D1=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),F1=d(mt),Mc=n(mt,"P",{});var MF=r(Mc);y1=i(MF,"Finally, this model supports inherent JAX features such as:"),MF.forEach(t),B1=d(mt),zt=n(mt,"UL",{});var Gs=r(zt);Ec=n(Gs,"LI",{});var EF=r(Ec);Wa=n(EF,"A",{href:!0,rel:!0});var xF=r(Wa);M1=i(xF,"Just-In-Time (JIT) compilation"),xF.forEach(t),EF.forEach(t),E1=d(Gs),xc=n(Gs,"LI",{});var zF=r(xc);Ra=n(zF,"A",{href:!0,rel:!0});var CF=r(Ra);x1=i(CF,"Automatic Differentiation"),CF.forEach(t),zF.forEach(t),z1=d(Gs),zc=n(Gs,"LI",{});var jF=r(zc);Ha=n(jF,"A",{href:!0,rel:!0});var PF=r(Ha);C1=i(PF,"Vectorization"),PF.forEach(t),jF.forEach(t),j1=d(Gs),Cc=n(Gs,"LI",{});var qF=r(Cc);Qa=n(qF,"A",{href:!0,rel:!0});var AF=r(Qa);P1=i(AF,"Parallelization"),AF.forEach(t),qF.forEach(t),Gs.forEach(t),q1=d(mt),lt=n(mt,"DIV",{class:!0});var no=r(lt);k(Ua.$$.fragment,no),A1=d(no),Uo=n(no,"P",{});var fl=r(Uo);I1=i(fl,"The "),jc=n(fl,"CODE",{});var IF=r(jc);L1=i(IF,"FlaxDistilBertPreTrainedModel"),IF.forEach(t),S1=i(fl,"forward method, overrides the "),Pc=n(fl,"CODE",{});var LF=r(Pc);N1=i(LF,"__call__"),LF.forEach(t),O1=i(fl," special method."),fl.forEach(t),W1=d(no),k(Ns.$$.fragment,no),R1=d(no),qc=n(no,"P",{});var SF=r(qc);H1=i(SF,"Example:"),SF.forEach(t),Q1=d(no),k(Ja.$$.fragment,no),no.forEach(t),mt.forEach(t),eh=d(o),Jo=n(o,"H2",{class:!0});var du=r(Jo);Os=n(du,"A",{id:!0,class:!0,href:!0});var NF=r(Os);Ac=n(NF,"SPAN",{});var OF=r(Ac);k(Va.$$.fragment,OF),OF.forEach(t),NF.forEach(t),U1=d(du),Ic=n(du,"SPAN",{});var WF=r(Ic);J1=i(WF,"FlaxDistilBertForQuestionAnswering"),WF.forEach(t),du.forEach(t),th=d(o),Ce=n(o,"DIV",{class:!0});var gt=r(Ce);k(Ka.$$.fragment,gt),V1=d(gt),Vo=n(gt,"P",{});var ml=r(Vo);K1=i(ml,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Lc=n(ml,"CODE",{});var RF=r(Lc);G1=i(RF,"span start logits"),RF.forEach(t),X1=i(ml," and "),Sc=n(ml,"CODE",{});var HF=r(Sc);Y1=i(HF,"span end logits"),HF.forEach(t),Z1=i(ml,")."),ml.forEach(t),ek=d(gt),Ga=n(gt,"P",{});var cu=r(Ga);tk=i(cu,"This model inherits from "),Vi=n(cu,"A",{href:!0});var QF=r(Vi);ok=i(QF,"FlaxPreTrainedModel"),QF.forEach(t),sk=i(cu,`. Check the superclass documentation for the generic methods the
