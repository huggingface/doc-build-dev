import{S as B$,i as j$,s as E$,e as a,k as p,w as y,t as i,M as C$,c as s,d as t,m as u,a as r,x as v,h as d,b as f,G as e,g as b,y as T,q as w,o as M,B as $,v as P$,L as P}from"../../chunks/vendor-hf-doc-builder.js";import{T as at}from"../../chunks/Tip-hf-doc-builder.js";import{D as q}from"../../chunks/Docstring-hf-doc-builder.js";import{C as B}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as U}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as C}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function S$(x){let l,k,m,c,g;return c=new B({props:{code:`from transformers import MBartModel, MBartConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),k=i("Example:"),m=p(),y(c.$$.fragment)},l(n){l=s(n,"P",{});var h=r(l);k=d(h,"Example:"),h.forEach(t),m=u(n),v(c.$$.fragment,n)},m(n,h){b(n,l,h),e(l,k),b(n,m,h),T(c,n,h),g=!0},p:P,i(n){g||(w(c.$$.fragment,n),g=!0)},o(n){M(c.$$.fragment,n),g=!1},d(n){n&&t(l),n&&t(m),$(c,n)}}}function nx(x){let l,k,m,c,g,n,h,F,st,ze,E,Ie,he,rt,me,fe,it,Xe,Q,L,Ne,ne,S,A,dt,le,ce,lt,H,ct,pt,G,qe,_e,Qe,ae,ge,be,ut,se,ke,ye,He;return{c(){l=a("p"),k=i("TF 2.0 models accepts two formats as inputs:"),m=p(),c=a("ul"),g=a("li"),n=i("having all inputs as keyword arguments (like PyTorch models), or"),h=p(),F=a("li"),st=i("having all inputs as a list, tuple or dict in the first positional arguments."),ze=p(),E=a("p"),Ie=i("This second option is useful when using "),he=a("code"),rt=i("tf.keras.Model.fit"),me=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),fe=a("code"),it=i("model(inputs)"),Xe=i("."),Q=p(),L=a("p"),Ne=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=p(),S=a("ul"),A=a("li"),dt=i("a single Tensor with "),le=a("code"),ce=i("input_ids"),lt=i(" only and nothing else: "),H=a("code"),ct=i("model(input_ids)"),pt=p(),G=a("li"),qe=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),_e=a("code"),Qe=i("model([input_ids, attention_mask])"),ae=i(" or "),ge=a("code"),be=i("model([input_ids, attention_mask, token_type_ids])"),ut=p(),se=a("li"),ke=i(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),He=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){l=s(z,"P",{});var j=r(l);k=d(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=u(z),c=s(z,"UL",{});var ve=r(c);g=s(ve,"LI",{});var De=r(g);n=d(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),h=u(ve),F=s(ve,"LI",{});var jt=r(F);st=d(jt,"having all inputs as a list, tuple or dict in the first positional arguments."),jt.forEach(t),ve.forEach(t),ze=u(z),E=s(z,"P",{});var V=r(E);Ie=d(V,"This second option is useful when using "),he=s(V,"CODE",{});var Et=r(he);rt=d(Et,"tf.keras.Model.fit"),Et.forEach(t),me=d(V,` method which currently requires having all the
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_mbart.py#L1172",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17961/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_mbart.py#L1448",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_mbart.py#L1727",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17961/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17961/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
<p><a
  href="/docs/transformers/pr_17961/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Kn=new C({props:{anchor:"transformers.FlaxMBartForQuestionAnswering.decode.example",$$slots:{default:[wx]},$$scope:{ctx:x}}}),{c(){l=a("meta"),k=p(),m=a("h1"),c=a("a"),g=a("span"),y(n.$$.fragment),h=p(),F=a("span"),st=i("MBart and MBart-50"),ze=p(),E=a("p"),Ie=a("strong"),he=i("DISCLAIMER:"),rt=i(" If you see something strange, file a "),me=a("a"),fe=i("Github Issue"),it=i(` and assign
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),$d=s(nt,"EM",{});var iT=r($d);xm=d(iT,"facebook/mbart-50-large-many-to-many"),iT.forEach(t),zm=d(nt," checkpoint."),nt.forEach(t),au.forEach(t),tT.forEach(t),Tp=u(o),v($a.$$.fragment,o),wp=u(o),Lt=s(o,"H2",{class:!0});var su=r(Lt);zo=s(su,"A",{id:!0,class:!0,href:!0});var dT=r(zo);xd=s(dT,"SPAN",{});var lT=r(xd);v(xa.$$.fragment,lT),lT.forEach(t),dT.forEach(t),qm=u(su),zd=s(su,"SPAN",{});var cT=r(zd);Fm=d(cT,"MBartConfig"),cT.forEach(t),su.forEach(t),Mp=u(o),Ge=s(o,"DIV",{class:!0});var ta=r(Ge);v(za.$$.fragment,ta),Bm=u(ta),Gt=s(ta,"P",{});var Gi=r(Gt);jm=d(Gi,"This is the configuration class to store the configuration of a "),gi=s(Gi,"A",{href:!0});var pT=r(gi);Em=d(pT,"MBartModel"),pT.forEach(t),Cm=d(Gi,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),qa=s(Gi,"A",{href:!0,rel:!0});var uT=r(qa);Pm=d(uT,"facebook/mbart-large-cc25"),uT.forEach(t),Sm=d(Gi," architecture."),Gi.forEach(t),Am=u(ta),Wt=s(ta,"P",{});var Wi=r(Wt);Om=d(Wi,"Configuration objects inherit from "),bi=s(Wi,"A",{href:!0});var hT=r(bi);Im=d(hT,"PretrainedConfig"),hT.forEach(t),Nm=d(Wi,` and can be used to control the model outputs. Read the
documentation from `),ki=s(Wi,"A",{href:!0});var mT=r(ki);Dm=d(mT,"PretrainedConfig"),mT.forEach(t),Lm=d(Wi," for more information."),Wi.forEach(t),Gm=u(ta),v(qo.$$.fragment,ta),ta.forEach(t),$p=u(o),Rt=s(o,"H2",{class:!0});var ru=r(Rt);Fo=s(ru,"A",{id:!0,class:!0,href:!0});var fT=r(Fo);qd=s(fT,"SPAN",{});var _T=r(qd);v(Fa.$$.fragment,_T),_T.forEach(t),fT.forEach(t),Wm=u(ru),Fd=s(ru,"SPAN",{});var gT=r(Fd);Rm=d(gT,"MBartTokenizer"),gT.forEach(t),ru.forEach(t),xp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(Ba.$$.fragment,Se),Um=u(Se),Bd=s(Se,"P",{});var bT=r(Bd);Xm=d(bT,"Construct an MBART tokenizer."),bT.forEach(t),Qm=u(Se),ht=s(Se,"P",{});var oa=r(ht);Hm=d(oa,"Adapted from "),yi=s(oa,"A",{href:!0});var kT=r(yi);Vm=d(kT,"RobertaTokenizer"),kT.forEach(t),Jm=d(oa," and "),vi=s(oa,"A",{href:!0});var yT=r(vi);Km=d(yT,"XLNetTokenizer"),yT.forEach(t),Zm=d(oa,`. Based on
...
adding special tokens. An MBART sequence has the following format, where `),Cd=s(lu,"CODE",{});var MT=r(Cd);hf=d(MT,"X"),MT.forEach(t),mf=d(lu," represents the sequence:"),lu.forEach(t),ff=u(na),Aa=s(na,"UL",{});var cu=r(Aa);Oa=s(cu,"LI",{});var pu=r(Oa);Pd=s(pu,"CODE",{});var $T=r(Pd);_f=d($T,"input_ids"),$T.forEach(t),gf=d(pu," (for encoder) "),Sd=s(pu,"CODE",{});var xT=r(Sd);bf=d(xT,"X [eos, src_lang_code]"),xT.forEach(t),pu.forEach(t),kf=u(cu),Ia=s(cu,"LI",{});var uu=r(Ia);Ad=s(uu,"CODE",{});var zT=r(Ad);yf=d(zT,"decoder_input_ids"),zT.forEach(t),vf=d(uu,": (for decoder) "),Od=s(uu,"CODE",{});var qT=r(Od);Tf=d(qT,"X [eos, tgt_lang_code]"),qT.forEach(t),uu.forEach(t),cu.forEach(t),wf=u(na),Id=s(na,"P",{});var FT=r(Id);Mf=d(FT,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),FT.forEach(t),na.forEach(t),Se.forEach(t),zp=u(o),Ut=s(o,"H2",{class:!0});var hu=r(Ut);Eo=s(hu,"A",{id:!0,class:!0,href:!0});var BT=r(Eo);Nd=s(BT,"SPAN",{});var jT=r(Nd);v(Na.$$.fragment,jT),jT.forEach(t),BT.forEach(t),$f=u(hu),Dd=s(hu,"SPAN",{});var ET=r(Dd);xf=d(ET,"MBartTokenizerFast"),ET.forEach(t),hu.forEach(t),qp=u(o),O=s(o,"DIV",{class:!0});var Y=r(O);v(Da.$$.fragment,Y),zf=u(Y),Xt=s(Y,"P",{});var Ri=r(Xt);qf=d(Ri,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ld=s(Ri,"EM",{});var CT=r(Ld);Ff=d(CT,"tokenizers"),CT.forEach(t),Bf=d(Ri,` library). Based on
...
refer to this superclass for more information regarding those methods.`),mu.forEach(t),Of=u(Y),Wa=s(Y,"P",{});var fu=r(Wa);If=d(fu,"The tokenization method is "),Gd=s(fu,"CODE",{});var AT=r(Gd);Nf=d(AT,"<tokens> <eos> <language code>"),AT.forEach(t),Df=d(fu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),fu.forEach(t),Lf=u(Y),v(Co.$$.fragment,Y),Gf=u(Y),Fe=s(Y,"DIV",{class:!0});var vt=r(Fe);v(Ra.$$.fragment,vt),Wf=u(vt),Wd=s(vt,"P",{});var OT=r(Wd);Rf=d(OT,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
adding special tokens. An MBART-50 sequence has the following format, where `),tl=s(xu,"CODE",{});var ZT=r(tl);q_=d(ZT,"X"),ZT.forEach(t),F_=d(xu," represents the sequence:"),xu.forEach(t),B_=u(aa),ss=s(aa,"UL",{});var zu=r(ss);rs=s(zu,"LI",{});var qu=r(rs);ol=s(qu,"CODE",{});var YT=r(ol);j_=d(YT,"input_ids"),YT.forEach(t),E_=d(qu," (for encoder) "),nl=s(qu,"CODE",{});var ew=r(nl);C_=d(ew,"[src_lang_code] X [eos]"),ew.forEach(t),qu.forEach(t),P_=u(zu),is=s(zu,"LI",{});var Fu=r(is);al=s(Fu,"CODE",{});var tw=r(al);S_=d(tw,"labels"),tw.forEach(t),A_=d(Fu,": (for decoder) "),sl=s(Fu,"CODE",{});var ow=r(sl);O_=d(ow,"[tgt_lang_code] X [eos]"),ow.forEach(t),Fu.forEach(t),zu.forEach(t),I_=u(aa),rl=s(aa,"P",{});var nw=r(rl);N_=d(nw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ru.forEach(t),Gg=u(sa),zs=s(sa,"P",{});var Uu=r(zs);Wg=d(Uu,"This model is also a PyTorch "),qs=s(Uu,"A",{href:!0,rel:!0});var zw=r(qs);Rg=d(zw,"torch.nn.Module"),zw.forEach(t),Ug=d(Uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uu.forEach(t),Xg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);v(Fs.$$.fragment,ra),Qg=u(ra),Kt=s(ra,"P",{});var Xi=r(Kt);Hg=d(Xi,"The "),xi=s(Xi,"A",{href:!0});var qw=r(xi);Vg=d(qw,"MBartModel"),qw.forEach(t),Jg=d(Xi," forward method, overrides the "),$l=s(Xi,"CODE",{});var Fw=r($l);Kg=d(Fw,"__call__"),Fw.forEach(t),Zg=d(Xi," special method."),Xi.forEach(t),Yg=u(ra),v(Ho.$$.fragment,ra),eb=u(ra),v(Vo.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Sp=u(o),Zt=s(o,"H2",{class:!0});var Xu=r(Zt);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var Bw=r(Jo);xl=s(Bw,"SPAN",{});var jw=r(xl);v(Bs.$$.fragment,jw),jw.forEach(t),Bw.forEach(t),tb=u(Xu),zl=s(Xu,"SPAN",{});var Ew=r(zl);ob=d(Ew,"MBartForConditionalGeneration"),Ew.forEach(t),Xu.forEach(t),Ap=u(o),Re=s(o,"DIV",{class:!0});var ia=r(Re);v(js.$$.fragment,ia),nb=u(ia),Es=s(ia,"P",{});var Qu=r(Es);ab=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hu.forEach(t),pb=u(ia),je=s(ia,"DIV",{class:!0});var wt=r(je);v(Ss.$$.fragment,wt),ub=u(wt),Yt=s(wt,"P",{});var Qi=r(Yt);hb=d(Qi,"The "),qi=s(Qi,"A",{href:!0});var Sw=r(qi);mb=d(Sw,"MBartForConditionalGeneration"),Sw.forEach(t),fb=d(Qi," forward method, overrides the "),ql=s(Qi,"CODE",{});var Aw=r(ql);_b=d(Aw,"__call__"),Aw.forEach(t),gb=d(Qi," special method."),Qi.forEach(t),bb=u(wt),v(Ko.$$.fragment,wt),kb=u(wt),v(Zo.$$.fragment,wt),yb=u(wt),v(Yo.$$.fragment,wt),wt.forEach(t),ia.forEach(t),Op=u(o),eo=s(o,"H2",{class:!0});var Vu=r(eo);en=s(Vu,"A",{id:!0,class:!0,href:!0});var Ow=r(en);Fl=s(Ow,"SPAN",{});var Iw=r(Fl);v(As.$$.fragment,Iw),Iw.forEach(t),Ow.forEach(t),vb=u(Vu),Bl=s(Vu,"SPAN",{});var Nw=r(Bl);Tb=d(Nw,"MBartForQuestionAnswering"),Nw.forEach(t),Vu.forEach(t),Ip=u(o),we=s(o,"DIV",{class:!0});var Mt=r(we);v(Os.$$.fragment,Mt),wb=u(Mt),to=s(Mt,"P",{});var Hi=r(to);Mb=d(Hi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),jl=s(Hi,"CODE",{});var Dw=r(jl);$b=d(Dw,"span start logits"),Dw.forEach(t),xb=d(Hi," and "),El=s(Hi,"CODE",{});var Lw=r(El);zb=d(Lw,"span end logits"),Lw.forEach(t),qb=d(Hi,")."),Hi.forEach(t),Fb=u(Mt),Is=s(Mt,"P",{});var Ju=r(Is);Bb=d(Ju,"This model inherits from "),Fi=s(Ju,"A",{href:!0});var Gw=r(Fi);jb=d(Gw,"PreTrainedModel"),Gw.forEach(t),Eb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(t),zk=u(zt),er=s(zt,"P",{});var rh=r(er);qk=d(rh,"This model is also a "),tr=s(rh,"A",{href:!0,rel:!0});var iM=r(tr);Fk=d(iM,"tf.keras.Model"),iM.forEach(t),Bk=d(rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rh.forEach(t),jk=u(zt),v(fn.$$.fragment,zt),Ek=u(zt),Ye=s(zt,"DIV",{class:!0});var da=r(Ye);v(or.$$.fragment,da),Ck=u(da),lo=s(da,"P",{});var Ki=r(lo);Pk=d(Ki,"The "),Pi=s(Ki,"A",{href:!0});var dM=r(Pi);Sk=d(dM,"TFMBartModel"),dM.forEach(t),Ak=d(Ki," forward method, overrides the "),Gl=s(Ki,"CODE",{});var lM=r(Gl);Ok=d(lM,"__call__"),lM.forEach(t),Ik=d(Ki," special method."),Ki.forEach(t),Nk=u(da),v(_n.$$.fragment,da),Dk=u(da),v(gn.$$.fragment,da),da.forEach(t),zt.forEach(t),Up=u(o),co=s(o,"H2",{class:!0});var ih=r(co);bn=s(ih,"A",{id:!0,class:!0,href:!0});var cM=r(bn);Wl=s(cM,"SPAN",{});var pM=r(Wl);v(nr.$$.fragment,pM),pM.forEach(t),cM.forEach(t),Lk=u(ih),Rl=s(ih,"SPAN",{});var uM=r(Rl);Gk=d(uM,"TFMBartForConditionalGeneration"),uM.forEach(t),ih.forEach(t),Xp=u(o),xe=s(o,"DIV",{class:!0});var qt=r(xe);v(ar.$$.fragment,qt),Wk=u(qt),sr=s(qt,"P",{});var dh=r(sr);Rk=d(dh,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dh.forEach(t),Qk=u(qt),rr=s(qt,"P",{});var lh=r(rr);Hk=d(lh,"This model is also a "),ir=s(lh,"A",{href:!0,rel:!0});var mM=r(ir);Vk=d(mM,"tf.keras.Model"),mM.forEach(t),Jk=d(lh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lh.forEach(t),Kk=u(qt),v(kn.$$.fragment,qt),Zk=u(qt),Ce=s(qt,"DIV",{class:!0});var Ft=r(Ce);v(dr.$$.fragment,Ft),Yk=u(Ft),po=s(Ft,"P",{});var Zi=r(po);ey=d(Zi,"The "),Ai=s(Zi,"A",{href:!0});var fM=r(Ai);ty=d(fM,"TFMBartForConditionalGeneration"),fM.forEach(t),oy=d(Zi," forward method, overrides the "),Ul=s(Zi,"CODE",{});var _M=r(Ul);ny=d(_M,"__call__"),_M.forEach(t),ay=d(Zi," special method."),Zi.forEach(t),sy=u(Ft),v(yn.$$.fragment,Ft),ry=u(Ft),v(vn.$$.fragment,Ft),iy=u(Ft),v(Tn.$$.fragment,Ft),Ft.forEach(t),qt.forEach(t),Qp=u(o),uo=s(o,"H2",{class:!0});var ch=r(uo);wn=s(ch,"A",{id:!0,class:!0,href:!0});var gM=r(wn);Xl=s(gM,"SPAN",{});var bM=r(Xl);v(lr.$$.fragment,bM),bM.forEach(t),gM.forEach(t),dy=u(ch),Ql=s(ch,"SPAN",{});var kM=r(Ql);ly=d(kM,"FlaxMBartModel"),kM.forEach(t),ch.forEach(t),Hp=u(o),W=s(o,"DIV",{class:!0});var pe=r(W);v(cr.$$.fragment,pe),cy=u(pe),pr=s(pe,"P",{});var ph=r(pr);py=d(ph,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
