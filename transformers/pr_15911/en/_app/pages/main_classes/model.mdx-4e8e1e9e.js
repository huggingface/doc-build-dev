...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15911/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_15911/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),go=new f({props:{name:"save_pretrained",anchor:"transformers.PreTrainedModel.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"save_config",val:": bool = True"},{name:"state_dict",val:": typing.Optional[dict] = None"},{name:"save_function",val:": typing.Callable = <function save at 0x7fe83c2549d0>"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L999",parametersDescription:[{anchor:"transformers.PreTrainedModel.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7fe7d2e4a400>"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Do=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_utils.py#L194"}}),zo=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15911/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_15911/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
<a href="/docs/transformers/pr_15911/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<ul>
<li><a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/generation_utils.py#L1612",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/generation_tf_utils.py#L2016",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15911/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),Dh=r("[from_pretrained()](/docs/transformers/pr_15911/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),zh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
backwards pass. In this case, `),Kl=o("code"),T1=r("data"),$1=r(" is a singleton tuple containing "),Zl=o("code"),j1=r("(inputs,)"),M1=r("."),P1=l(),gt=o("p"),E1=r(`This is possible under the aforementioned circumstances because our overriden compile function can set an
...
`),_d=o("code"),Tv=r("repo_path_or_name"),$v=r("."),jv=l(),fd=o("p"),Mv=r("Examples:"),Pv=l(),c(ys.$$.fragment),Ev=l(),W=o("div"),c(ks.$$.fragment),Lv=l(),bd=o("p"),qv=r("Instantiate a pretrained flax model from a pre-trained model configuration."),Fv=l(),xs=o("p"),Ov=r("The warning "),vd=o("em"),Dv=r("Weights from XXX not initialized from pretrained model"),zv=r(` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),Cv=l(),kd=o("p"),Iv=r("Examples:"),Bv=l(),c(Ts.$$.fragment),Wv=l(),Re=o("div"),c($s.$$.fragment),Uv=l(),xd=o("p"),Hv=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Vv=l(),c(yn.$$.fragment),Xv=l(),kn=o("div"),c(js.$$.fragment),Rv=l(),Ms=o("p"),Yv=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=o("code"),Kv=r("[from_pretrained()](/docs/transformers/pr_15911/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Zv=r(" class method"),Jv=l(),Y=o("div"),c(Ps.$$.fragment),Qv=l(),se=o("p"),ey=r("Cast the floating-point "),Td=o("code"),ty=r("params"),ny=r(" to "),$d=o("code"),oy=r("jax.numpy.bfloat16"),sy=r(". This returns a new "),jd=o("code"),ay=r("params"),ry=r(` tree and does not cast
...
`),Si=s(Tc,"CODE",{});var XT=a(Si);Dh=i(XT,"[from_pretrained()](/docs/transformers/pr_15911/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),zh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d($),Nt=s($,"DIV",{class:!0});var $c=a(Nt);m(_o.$$.fragment,$c),Gh=d($c),Ni=s($c,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),$c.forEach(t),Nh=d($),Be=s($,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var jc=a(bo);Wh=i(jc,"If the "),Ii=s(jc,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i(jc,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),or=s(tm,"A",{href:!0});var s$=a(or);Hb=i(s$,"from_pretrained()"),s$.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),pn=s(k,"DIV",{class:!0});var nm=a(pn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var a$=a(Cl);Yb=i(a$,"Method used for serving the model."),a$.forEach(t),nm.forEach(t),Kb=d(k),cn=s(k,"DIV",{class:!0});var om=a(cn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var r$=a(Il);Jb=i(r$,"Prepare the output of the saved model. Each model must implement this function."),r$.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),e1=d(sm),Bl=s(sm,"P",{});var i$=a(Bl);t1=i(i$,"Set all the bias in the LM head."),i$.forEach(t),sm.forEach(t),n1=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),o1=d(am),Wl=s(am,"P",{});var l$=a(Wl);s1=i(l$,"Set model\u2019s input embeddings"),l$.forEach(t),am.forEach(t),a1=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),r1=d(rm),Ul=s(rm,"P",{});var d$=a(Ul);i1=i(d$,"Set model\u2019s output embeddings"),d$.forEach(t),rm.forEach(t),l1=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(ps.$$.fragment,im),d1=d(im),Hl=s(im,"P",{});var p$=a(Hl);p1=i(p$,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),p$.forEach(t),im.forEach(t),c1=d(k),ce=s(k,"DIV",{class:!0});var Fn=a(ce);m(cs.$$.fragment,Fn),m1=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);u1=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var c$=a(Vl);g1=i(c$,"train_step"),c$.forEach(t),h1=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var m$=a(Xl);_1=i(m$,"train_step"),m$.forEach(t),f1=i(Ke,`. In
this case, it expects the same `),Rl=s(Ke,"CODE",{});var u$=a(Rl);b1=i(u$,"data"),u$.forEach(t),v1=i(Ke," as the original function (i.e. "),Yl=s(Ke,"CODE",{});var g$=a(Yl);y1=i(g$,"(inputs, labels)"),g$.forEach(t),k1=i(Ke,")."),Ke.forEach(t),x1=d(Fn),ut=s(Fn,"P",{});var Fr=a(ut);w1=i(Fr,`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h$=a(Kl);T1=i(h$,"data"),h$.forEach(t),$1=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _$=a(Zl);j1=i(_$,"(inputs,)"),_$.forEach(t),M1=i(Fr,"."),Fr.forEach(t),P1=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);E1=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var f$=a(Jl);L1=i(f$,"loss"),f$.forEach(t),q1=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b$=a(Ql);F1=i(b$,"loss"),b$.forEach(t),O1=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v$=a(_n);ed=s(v$,"SPAN",{});var y$=a(ed);m(ms.$$.fragment,y$),y$.forEach(t),v$.forEach(t),D1=d(lm),td=s(lm,"SPAN",{});var k$=a(td);z1=i(k$,"TFModelUtilsMixin"),k$.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var Dr=a(Pe);m(us.$$.fragment,Dr),A1=d(Dr),gs=s(Dr,"P",{});var dm=a(gs);G1=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x$=a(nd);S1=i(x$,"tf.keras.Model"),x$.forEach(t),N1=i(dm,", to be used as a mixin."),dm.forEach(t),C1=d(Dr),fn=s(Dr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),I1=d(pm),od=s(pm,"P",{});var w$=a(od);B1=i(w$,"Get the number of (optionally, trainable) parameters in the model."),w$.forEach(t),pm.forEach(t),Dr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T$=a(bn);sd=s(T$,"SPAN",{});var $$=a(sd);m(_s.$$.fragment,$$),$$.forEach(t),T$.forEach(t),W1=d(cm),ad=s(cm,"SPAN",{});var j$=a(ad);U1=i(j$,"FlaxPreTrainedModel"),j$.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),H1=d(q),rd=s(q,"P",{});var M$=a(rd);V1=i(M$,"Base class for all models."),M$.forEach(t),X1=d(q),sr=s(q,"P",{});var zw=a(sr);ar=s(zw,"A",{href:!0});var P$=a(ar);R1=i(P$,"FlaxPreTrainedModel"),P$.forEach(t),Y1=i(zw,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),zw.forEach(t),K1=d(q),id=s(q,"P",{});var E$=a(id);Z1=i(E$,"Class attributes (overridden by derived classes):"),E$.forEach(t),J1=d(q),ft=s(q,"UL",{});var zr=a(ft);Xe=s(zr,"LI",{});var za=a(Xe);ld=s(za,"STRONG",{});var L$=a(ld);Q1=i(L$,"config_class"),L$.forEach(t),ev=i(za," ("),rr=s(za,"A",{href:!0});var q$=a(rr);tv=i(q$,"PretrainedConfig"),q$.forEach(t),nv=i(za,") \u2014 A subclass of "),ir=s(za,"A",{href:!0});var F$=a(ir);ov=i(F$,"PretrainedConfig"),F$.forEach(t),sv=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),av=d(zr),vn=s(zr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O$=a(dd);rv=i(O$,"base_model_prefix"),O$.forEach(t),iv=i(qp," ("),pd=s(qp,"CODE",{});var D$=a(pd);lv=i(D$,"str"),D$.forEach(t),dv=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),pv=d(zr),R=s(zr,"LI",{});var ze=a(R);cd=s(ze,"STRONG",{});var z$=a(cd);cv=i(z$,"main_input_name"),z$.forEach(t),mv=i(ze," ("),md=s(ze,"CODE",{});var A$=a(md);uv=i(A$,"str"),A$.forEach(t),gv=i(ze,") \u2014 The name of the principal input to the model (often "),ud=s(ze,"CODE",{});var G$=a(ud);hv=i(G$,"input_ids"),G$.forEach(t),_v=i(ze,` for NLP
models, `),gd=s(ze,"CODE",{});var S$=a(gd);fv=i(S$,"pixel_values"),S$.forEach(t),bv=i(ze," for vision models and "),hd=s(ze,"CODE",{});var N$=a(hd);vv=i(N$,"input_values"),N$.forEach(t),yv=i(ze," for speech models)."),ze.forEach(t),zr.forEach(t),kv=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xv=d(On),vs=s(On,"P",{});var mm=a(vs);wv=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C$=a(_d);Tv=i(C$,"repo_path_or_name"),C$.forEach(t),$v=i(mm,"."),mm.forEach(t),jv=d(On),fd=s(On,"P",{});var I$=a(fd);Mv=i(I$,"Examples:"),I$.forEach(t),Pv=d(On),m(ys.$$.fragment,On),On.forEach(t),Ev=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Lv=d(Te),bd=s(Te,"P",{});var B$=a(bd);qv=i(B$,"Instantiate a pretrained flax model from a pre-trained model configuration."),B$.forEach(t),Fv=d(Te),xs=s(Te,"P",{});var um=a(xs);Ov=i(um,"The warning "),vd=s(um,"EM",{});var W$=a(vd);Dv=i(W$,"Weights from XXX not initialized from pretrained model"),W$.forEach(t),zv=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),Av=d(Te),ws=s(Te,"P",{});var gm=a(ws);Gv=i(gm,"The warning "),yd=s(gm,"EM",{});var U$=a(yd);Sv=i(U$,"Weights from XXX not used in YYY"),U$.forEach(t),Nv=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),Cv=d(Te),kd=s(Te,"P",{});var H$=a(kd);Iv=i(H$,"Examples:"),H$.forEach(t),Bv=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),Wv=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m($s.$$.fragment,Ar),Uv=d(Ar),xd=s(Ar,"P",{});var V$=a(xd);Hv=i(V$,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V$.forEach(t),Vv=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xv=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m(js.$$.fragment,hm),Rv=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Yv=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X$=a(wd);Kv=i(X$,"[from_pretrained()](/docs/transformers/pr_15911/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X$.forEach(t),Zv=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jv=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qv=d(Ze),se=s(Ze,"P",{});var Je=a(se);ey=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R$=a(Td);ty=i(R$,"params"),R$.forEach(t),ny=i(Je," to "),$d=s(Je,"CODE",{});var Y$=a($d);oy=i(Y$,"jax.numpy.bfloat16"),Y$.forEach(t),sy=i(Je,". This returns a new "),jd=s(Je,"CODE",{});var K$=a(jd);ay=i(K$,"params"),K$.forEach(t),ry=i(Je,` tree and does not cast
