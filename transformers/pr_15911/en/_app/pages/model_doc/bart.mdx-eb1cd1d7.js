...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Wn=new J({}),Rn=new F({props:{name:"class transformers.BartModel",anchor:"transformers.BartModel",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1123",parametersDescription:[{anchor:"transformers.BartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15911/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vn=new F({props:{name:"forward",anchor:"transformers.BartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1150",parametersDescription:[{anchor:"transformers.BartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Xn=new J({}),Kn=new F({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1249",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15911/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new F({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1288",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predictions).split()`}}),aa=new J({}),sa=new F({props:{name:"class transformers.BartForSequenceClassification",anchor:"transformers.BartForSequenceClassification",parameters:[{name:"config",val:": BartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1418",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15911/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),la=new F({props:{name:"forward",anchor:"transformers.BartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1431",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15911/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_15911/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),ba=new J({}),ya=new F({props:{name:"class transformers.BartForCausalLM",anchor:"transformers.BartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1671"}}),va=new F({props:{name:"forward",anchor:"transformers.BartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_bart.py#L1702",parametersDescription:[{anchor:"transformers.BartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),wa=new J({}),xa=new F({props:{name:"class transformers.TFBartModel",anchor:"transformers.TFBartModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_tf_bart.py#L1187",parametersDescription:[{anchor:"transformers.TFBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15911/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new De({props:{$$slots:{default:[dT]},$$scope:{ctx:j}}}),Fa=new F({props:{name:"call",anchor:"transformers.TFBartModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_tf_bart.py#L1202",parametersDescription:[{anchor:"transformers.TFBartModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ja=new J({}),Ma=new F({props:{name:"class transformers.TFBartForConditionalGeneration",anchor:"transformers.TFBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_tf_bart.py#L1296",parametersDescription:[{anchor:"transformers.TFBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15911/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qo=new De({props:{$$slots:{default:[cT]},$$scope:{ctx:j}}}),Aa=new F({props:{name:"call",anchor:"transformers.TFBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_tf_bart.py#L1331",parametersDescription:[{anchor:"transformers.TFBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15911/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),us=new F({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15911/src/transformers/models/bart/modeling_flax_bart.py#L1334",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15911/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15911/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_15911/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15911/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15911/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15911/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
documentation from `),or=a(Mr,"A",{href:!0});var Yb=s(or);lh=i(Yb,"PretrainedConfig"),Yb.forEach(t),ch=i(Mr," for more information."),Mr.forEach(t),ph=l(zt),fi=a(zt,"P",{});var e1=s(fi);hh=i(e1,"Example:"),e1.forEach(t),uh=l(zt),f(xn.$$.fragment,zt),zt.forEach(t),$l=l(o),Jt=a(o,"H2",{class:!0});var ic=s(Jt);Bo=a(ic,"A",{id:!0,class:!0,href:!0});var t1=s(Bo);_i=a(t1,"SPAN",{});var o1=s(_i);f(zn.$$.fragment,o1),o1.forEach(t),t1.forEach(t),mh=l(ic),gi=a(ic,"SPAN",{});var n1=s(gi);fh=i(n1,"BartTokenizer"),n1.forEach(t),ic.forEach(t),jl=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(Bn.$$.fragment,L),_h=l(L),ki=a(L,"P",{});var a1=s(ki);gh=i(a1,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),a1.forEach(t),kh=l(L),bi=a(L,"P",{});var s1=s(bi);bh=i(s1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),s1.forEach(t),yh=l(L),f(qn.$$.fragment,L),vh=l(L),Fn=a(L,"P",{});var dc=s(Fn);Th=i(dc,"You can get around that behavior by passing "),yi=a(dc,"CODE",{});var r1=s(yi);wh=i(r1,"add_prefix_space=True"),r1.forEach(t),xh=i(dc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),dc.forEach(t),zh=l(L),f(qo.$$.fragment,L),Bh=l(L),$n=a(L,"P",{});var lc=s($n);qh=i(lc,"This tokenizer inherits from "),nr=a(lc,"A",{href:!0});var i1=s(nr);Fh=i(i1,"PreTrainedTokenizer"),i1.forEach(t),$h=i(lc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),lc.forEach(t),jh=l(L),mt=a(L,"DIV",{class:!0});var Er=s(mt);f(jn.$$.fragment,Er),Mh=l(Er),vi=a(Er,"P",{});var d1=s(vi);Eh=i(d1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),d1.forEach(t),Ph=l(Er),Mn=a(Er,"UL",{});var cc=s(Mn);ar=a(cc,"LI",{});var ub=s(ar);Ch=i(ub,"single sequence: "),Ti=a(ub,"CODE",{});var l1=s(Ti);Ah=i(l1,"<s> X </s>"),l1.forEach(t),ub.forEach(t),Ih=l(cc),sr=a(cc,"LI",{});var mb=s(sr);Sh=i(mb,"pair of sequences: "),wi=a(mb,"CODE",{});var c1=s(wi);Nh=i(c1,"<s> A </s></s> B </s>"),c1.forEach(t),mb.forEach(t),cc.forEach(t),Er.forEach(t),Oh=l(L),Fo=a(L,"DIV",{class:!0});var pc=s(Fo);f(En.$$.fragment,pc),Dh=l(pc),xi=a(pc,"P",{});var p1=s(xi);Lh=i(p1,"Converts a sequence of tokens (string) in a single string."),p1.forEach(t),pc.forEach(t),Gh=l(L),$o=a(L,"DIV",{class:!0});var hc=s($o);f(Pn.$$.fragment,hc),Wh=l(hc),zi=a(hc,"P",{});var h1=s(zi);Rh=i(h1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),h1.forEach(t),hc.forEach(t),Uh=l(L),jo=a(L,"DIV",{class:!0});var uc=s(jo);f(Cn.$$.fragment,uc),Hh=l(uc),An=a(uc,"P",{});var mc=s(An);Qh=i(mc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Bi=a(mc,"CODE",{});var u1=s(Bi);Vh=i(u1,"prepare_for_model"),u1.forEach(t),Jh=i(mc," method."),mc.forEach(t),uc.forEach(t),L.forEach(t),Ml=l(o),Xt=a(o,"H2",{class:!0});var fc=s(Xt);Mo=a(fc,"A",{id:!0,class:!0,href:!0});var m1=s(Mo);qi=a(m1,"SPAN",{});var f1=s(qi);f(In.$$.fragment,f1),f1.forEach(t),m1.forEach(t),Xh=l(fc),Fi=a(fc,"SPAN",{});var _1=s(Fi);Kh=i(_1,"BartTokenizerFast"),_1.forEach(t),fc.forEach(t),El=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Sn.$$.fragment,ue),Zh=l(ue),Nn=a(ue,"P",{});var _c=s(Nn);Yh=i(_c,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),$i=a(_c,"EM",{});var g1=s($i);eu=i(g1,"tokenizers"),g1.forEach(t),tu=i(_c,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),_c.forEach(t),ou=l(ue),ji=a(ue,"P",{});var k1=s(ji);nu=i(k1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),k1.forEach(t),au=l(ue),f(On.$$.fragment,ue),su=l(ue),Dn=a(ue,"P",{});var gc=s(Dn);ru=i(gc,"You can get around that behavior by passing "),Mi=a(gc,"CODE",{});var b1=s(Mi);iu=i(b1,"add_prefix_space=True"),b1.forEach(t),du=i(gc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),gc.forEach(t),lu=l(ue),f(Eo.$$.fragment,ue),cu=l(ue),Ln=a(ue,"P",{});var kc=s(Ln);pu=i(kc,"This tokenizer inherits from "),rr=a(kc,"A",{href:!0});var y1=s(rr);hu=i(y1,"PreTrainedTokenizerFast"),y1.forEach(t),uu=i(kc,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),kc.forEach(t),mu=l(ue),Po=a(ue,"DIV",{class:!0});var bc=s(Po);f(Gn.$$.fragment,bc),fu=l(bc),Ei=a(bc,"P",{});var v1=s(Ei);_u=i(v1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),v1.forEach(t),bc.forEach(t),ue.forEach(t),Pl=l(o),Kt=a(o,"H2",{class:!0});var yc=s(Kt);Co=a(yc,"A",{id:!0,class:!0,href:!0});var T1=s(Co);Pi=a(T1,"SPAN",{});var w1=s(Pi);f(Wn.$$.fragment,w1),w1.forEach(t),T1.forEach(t),gu=l(yc),Ci=a(yc,"SPAN",{});var x1=s(Ci);ku=i(x1,"BartModel"),x1.forEach(t),yc.forEach(t),Cl=l(o),Qe=a(o,"DIV",{class:!0});var rn=s(Qe);f(Rn.$$.fragment,rn),bu=l(rn),Un=a(rn,"P",{});var vc=s(Un);yu=i(vc,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),ir=a(vc,"A",{href:!0});var z1=s(ir);vu=i(z1,"PreTrainedModel"),z1.forEach(t),Tu=i(vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc.forEach(t),wu=l(rn),Hn=a(rn,"P",{});var Tc=s(Hn);xu=i(Tc,"This model is also a PyTorch "),Qn=a(Tc,"A",{href:!0,rel:!0});var B1=s(Qn);zu=i(B1,"torch.nn.Module"),B1.forEach(t),Bu=i(Tc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),qu=l(rn),je=a(rn,"DIV",{class:!0});var Bt=s(je);f(Vn.$$.fragment,Bt),Fu=l(Bt),Zt=a(Bt,"P",{});var Pr=s(Zt);$u=i(Pr,"The "),dr=a(Pr,"A",{href:!0});var q1=s(dr);ju=i(q1,"BartModel"),q1.forEach(t),Mu=i(Pr," forward method, overrides the "),Ai=a(Pr,"CODE",{});var F1=s(Ai);Eu=i(F1,"__call__"),F1.forEach(t),Pu=i(Pr," special method."),Pr.forEach(t),Cu=l(Bt),f(Ao.$$.fragment,Bt),Au=l(Bt),Ii=a(Bt,"P",{});var $1=s(Ii);Iu=i($1,"Example:"),$1.forEach(t),Su=l(Bt),f(Jn.$$.fragment,Bt),Bt.forEach(t),rn.forEach(t),Al=l(o),Yt=a(o,"H2",{class:!0});var wc=s(Yt);Io=a(wc,"A",{id:!0,class:!0,href:!0});var j1=s(Io);Si=a(j1,"SPAN",{});var M1=s(Si);f(Xn.$$.fragment,M1),M1.forEach(t),j1.forEach(t),Nu=l(wc),Ni=a(wc,"SPAN",{});var E1=s(Ni);Ou=i(E1,"BartForConditionalGeneration"),E1.forEach(t),wc.forEach(t),Il=l(o),Ve=a(o,"DIV",{class:!0});var dn=s(Ve);f(Kn.$$.fragment,dn),Du=l(dn),Zn=a(dn,"P",{});var xc=s(Zn);Lu=i(xc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),lr=a(xc,"A",{href:!0});var P1=s(lr);Gu=i(P1,"PreTrainedModel"),P1.forEach(t),Wu=i(xc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xc.forEach(t),Ru=l(dn),Yn=a(dn,"P",{});var zc=s(Yn);Uu=i(zc,"This model is also a PyTorch "),ea=a(zc,"A",{href:!0,rel:!0});var C1=s(ea);Hu=i(C1,"torch.nn.Module"),C1.forEach(t),Qu=i(zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zc.forEach(t),Vu=l(dn),K=a(dn,"DIV",{class:!0});var Ie=s(K);f(ta.$$.fragment,Ie),Ju=l(Ie),eo=a(Ie,"P",{});var Cr=s(eo);Xu=i(Cr,"The "),cr=a(Cr,"A",{href:!0});var A1=s(cr);Ku=i(A1,"BartForConditionalGeneration"),A1.forEach(t),Zu=i(Cr," forward method, overrides the "),Oi=a(Cr,"CODE",{});var I1=s(Oi);Yu=i(I1,"__call__"),I1.forEach(t),em=i(Cr," special method."),Cr.forEach(t),tm=l(Ie),f(So.$$.fragment,Ie),om=l(Ie),Di=a(Ie,"P",{});var S1=s(Di);nm=i(S1,"Summarization example:"),S1.forEach(t),am=l(Ie),f(oa.$$.fragment,Ie),sm=l(Ie),Li=a(Ie,"P",{});var N1=s(Li);rm=i(N1,"Mask filling example:"),N1.forEach(t),im=l(Ie),f(na.$$.fragment,Ie),Ie.forEach(t),dn.forEach(t),Sl=l(o),to=a(o,"H2",{class:!0});var Bc=s(to);No=a(Bc,"A",{id:!0,class:!0,href:!0});var O1=s(No);Gi=a(O1,"SPAN",{});var D1=s(Gi);f(aa.$$.fragment,D1),D1.forEach(t),O1.forEach(t),dm=l(Bc),Wi=a(Bc,"SPAN",{});var L1=s(Wi);lm=i(L1,"BartForSequenceClassification"),L1.forEach(t),Bc.forEach(t),Nl=l(o),we=a(o,"DIV",{class:!0});var qt=s(we);f(sa.$$.fragment,qt),cm=l(qt),Ri=a(qt,"P",{});var G1=s(Ri);pm=i(G1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),G1.forEach(t),hm=l(qt),ra=a(qt,"P",{});var qc=s(ra);um=i(qc,"This model inherits from "),pr=a(qc,"A",{href:!0});var W1=s(pr);mm=i(W1,"PreTrainedModel"),W1.forEach(t),fm=i(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qc.forEach(t),_m=l(qt),ia=a(qt,"P",{});var Fc=s(ia);gm=i(Fc,"This model is also a PyTorch "),da=a(Fc,"A",{href:!0,rel:!0});var R1=s(da);km=i(R1,"torch.nn.Module"),R1.forEach(t),bm=i(Fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fc.forEach(t),ym=l(qt),Z=a(qt,"DIV",{class:!0});var Se=s(Z);f(la.$$.fragment,Se),vm=l(Se),oo=a(Se,"P",{});var Ar=s(oo);Tm=i(Ar,"The "),hr=a(Ar,"A",{href:!0});var U1=s(hr);wm=i(U1,"BartForSequenceClassification"),U1.forEach(t),xm=i(Ar," forward method, overrides the "),Ui=a(Ar,"CODE",{});var H1=s(Ui);zm=i(H1,"__call__"),H1.forEach(t),Bm=i(Ar," special method."),Ar.forEach(t),qm=l(Se),f(Oo.$$.fragment,Se),Fm=l(Se),Hi=a(Se,"P",{});var Q1=s(Hi);$m=i(Q1,"Example of single-label classification:"),Q1.forEach(t),jm=l(Se),f(ca.$$.fragment,Se),Mm=l(Se),Qi=a(Se,"P",{});var V1=s(Qi);Em=i(V1,"Example of multi-label classification:"),V1.forEach(t),Pm=l(Se),f(pa.$$.fragment,Se),Se.forEach(t),qt.forEach(t),Ol=l(o),no=a(o,"H2",{class:!0});var $c=s(no);Do=a($c,"A",{id:!0,class:!0,href:!0});var J1=s(Do);Vi=a(J1,"SPAN",{});var X1=s(Vi);f(ha.$$.fragment,X1),X1.forEach(t),J1.forEach(t),Cm=l($c),Ji=a($c,"SPAN",{});var K1=s(Ji);Am=i(K1,"BartForQuestionAnswering"),K1.forEach(t),$c.forEach(t),Dl=l(o),xe=a(o,"DIV",{class:!0});var Ft=s(xe);f(ua.$$.fragment,Ft),Im=l(Ft),ao=a(Ft,"P",{});var Ir=s(ao);Sm=i(Ir,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Xi=a(Ir,"CODE",{});var Z1=s(Xi);Nm=i(Z1,"span start logits"),Z1.forEach(t),Om=i(Ir," and "),Ki=a(Ir,"CODE",{});var Y1=s(Ki);Dm=i(Y1,"span end logits"),Y1.forEach(t),Lm=i(Ir,")."),Ir.forEach(t),Gm=l(Ft),ma=a(Ft,"P",{});var jc=s(ma);Wm=i(jc,"This model inherits from "),ur=a(jc,"A",{href:!0});var ey=s(ur);Rm=i(ey,"PreTrainedModel"),ey.forEach(t),Um=i(jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mc.forEach(t),Xm=l(Ft),Me=a(Ft,"DIV",{class:!0});var $t=s(Me);f(ga.$$.fragment,$t),Km=l($t),so=a($t,"P",{});var Sr=s(so);Zm=i(Sr,"The "),mr=a(Sr,"A",{href:!0});var oy=s(mr);Ym=i(oy,"BartForQuestionAnswering"),oy.forEach(t),ef=i(Sr," forward method, overrides the "),Zi=a(Sr,"CODE",{});var ny=s(Zi);tf=i(ny,"__call__"),ny.forEach(t),of=i(Sr," special method."),Sr.forEach(t),nf=l($t),f(Lo.$$.fragment,$t),af=l($t),Yi=a($t,"P",{});var ay=s(Yi);sf=i(ay,"Example:"),ay.forEach(t),rf=l($t),f(ka.$$.fragment,$t),$t.forEach(t),Ft.forEach(t),Ll=l(o),ro=a(o,"H2",{class:!0});var Ec=s(ro);Go=a(Ec,"A",{id:!0,class:!0,href:!0});var sy=s(Go);ed=a(sy,"SPAN",{});var ry=s(ed);f(ba.$$.fragment,ry),ry.forEach(t),sy.forEach(t),df=l(Ec),td=a(Ec,"SPAN",{});var iy=s(td);lf=i(iy,"BartForCausalLM"),iy.forEach(t),Ec.forEach(t),Gl=l(o),io=a(o,"DIV",{class:!0});var Pc=s(io);f(ya.$$.fragment,Pc),cf=l(Pc),ft=a(Pc,"DIV",{class:!0});var Nr=s(ft);f(va.$$.fragment,Nr),pf=l(Nr),od=a(Nr,"P",{});var dy=s(od);hf=i(dy,"Example:"),dy.forEach(t),uf=l(Nr),f(Ta.$$.fragment,Nr),Nr.forEach(t),Pc.forEach(t),Wl=l(o),lo=a(o,"H2",{class:!0});var Cc=s(lo);Wo=a(Cc,"A",{id:!0,class:!0,href:!0});var ly=s(Wo);nd=a(ly,"SPAN",{});var cy=s(nd);f(wa.$$.fragment,cy),cy.forEach(t),ly.forEach(t),mf=l(Cc),ad=a(Cc,"SPAN",{});var py=s(ad);ff=i(py,"TFBartModel"),py.forEach(t),Cc.forEach(t),Rl=l(o),ze=a(o,"DIV",{class:!0});var jt=s(ze);f(xa.$$.fragment,jt),_f=l(jt),za=a(jt,"P",{});var Ac=s(za);gf=i(Ac,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),yf=l(jt),Ba=a(jt,"P",{});var Ic=s(Ba);vf=i(Ic,"This model is also a "),qa=a(Ic,"A",{href:!0,rel:!0});var uy=s(qa);Tf=i(uy,"tf.keras.Model"),uy.forEach(t),wf=i(Ic,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic.forEach(t),xf=l(jt),f(Ro.$$.fragment,jt),zf=l(jt),Ee=a(jt,"DIV",{class:!0});var Mt=s(Ee);f(Fa.$$.fragment,Mt),Bf=l(Mt),co=a(Mt,"P",{});var Or=s(co);qf=i(Or,"The "),_r=a(Or,"A",{href:!0});var my=s(_r);Ff=i(my,"TFBartModel"),my.forEach(t),$f=i(Or," forward method, overrides the "),sd=a(Or,"CODE",{});var fy=s(sd);jf=i(fy,"__call__"),fy.forEach(t),Mf=i(Or," special method."),Or.forEach(t),Ef=l(Mt),f(Uo.$$.fragment,Mt),Pf=l(Mt),rd=a(Mt,"P",{});var _y=s(rd);Cf=i(_y,"Example:"),_y.forEach(t),Af=l(Mt),f($a.$$.fragment,Mt),Mt.forEach(t),jt.forEach(t),Ul=l(o),po=a(o,"H2",{class:!0});var Sc=s(po);Ho=a(Sc,"A",{id:!0,class:!0,href:!0});var gy=s(Ho);id=a(gy,"SPAN",{});var ky=s(id);f(ja.$$.fragment,ky),ky.forEach(t),gy.forEach(t),If=l(Sc),dd=a(Sc,"SPAN",{});var by=s(dd);Sf=i(by,"TFBartForConditionalGeneration"),by.forEach(t),Sc.forEach(t),Hl=l(o),Be=a(o,"DIV",{class:!0});var Et=s(Be);f(Ma.$$.fragment,Et),Nf=l(Et),Ea=a(Et,"P",{});var Nc=s(Ea);Of=i(Nc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),gr=a(Nc,"A",{href:!0});var yy=s(gr);Df=i(yy,"TFPreTrainedModel"),yy.forEach(t),Lf=i(Nc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nc.forEach(t),Gf=l(Et),Pa=a(Et,"P",{});var Oc=s(Pa);Wf=i(Oc,"This model is also a "),Ca=a(Oc,"A",{href:!0,rel:!0});var vy=s(Ca);Rf=i(vy,"tf.keras.Model"),vy.forEach(t),Uf=i(Oc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oc.forEach(t),Hf=l(Et),f(Qo.$$.fragment,Et),Qf=l(Et),Y=a(Et,"DIV",{class:!0});var Ne=s(Y);f(Aa.$$.fragment,Ne),Vf=l(Ne),ho=a(Ne,"P",{});var Dr=s(ho);Jf=i(Dr,"The "),kr=a(Dr,"A",{href:!0});var Ty=s(kr);Xf=i(Ty,"TFBartForConditionalGeneration"),Ty.forEach(t),Kf=i(Dr," forward method, overrides the "),ld=a(Dr,"CODE",{});var wy=s(ld);Zf=i(wy,"__call__"),wy.forEach(t),Yf=i(Dr," special method."),Dr.forEach(t),e_=l(Ne),f(Vo.$$.fragment,Ne),t_=l(Ne),cd=a(Ne,"P",{});var xy=s(cd);o_=i(xy,"Summarization example:"),xy.forEach(t),n_=l(Ne),f(Ia.$$.fragment,Ne),a_=l(Ne),pd=a(Ne,"P",{});var zy=s(pd);s_=i(zy,"Mask filling example:"),zy.forEach(t),r_=l(Ne),f(Sa.$$.fragment,Ne),Ne.forEach(t),Et.forEach(t),Ql=l(o),uo=a(o,"H2",{class:!0});var Dc=s(uo);Jo=a(Dc,"A",{id:!0,class:!0,href:!0});var By=s(Jo);hd=a(By,"SPAN",{});var qy=s(hd);f(Na.$$.fragment,qy),qy.forEach(t),By.forEach(t),i_=l(Dc),ud=a(Dc,"SPAN",{});var Fy=s(ud);d_=i(Fy,"FlaxBartModel"),Fy.forEach(t),Dc.forEach(t),Vl=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Oa.$$.fragment,me),l_=l(me),Da=a(me,"P",{});var Lc=s(Da);c_=i(Lc,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Gc.forEach(t),g_=l(me),md=a(me,"P",{});var My=s(md);k_=i(My,"Finally, this model supports inherent JAX features such as:"),My.forEach(t),b_=l(me),dt=a(me,"UL",{});var ln=s(dt);fd=a(ln,"LI",{});var Ey=s(fd);Wa=a(Ey,"A",{href:!0,rel:!0});var Py=s(Wa);y_=i(Py,"Just-In-Time (JIT) compilation"),Py.forEach(t),Ey.forEach(t),v_=l(ln),_d=a(ln,"LI",{});var Cy=s(_d);Ra=a(Cy,"A",{href:!0,rel:!0});var Ay=s(Ra);T_=i(Ay,"Automatic Differentiation"),Ay.forEach(t),Cy.forEach(t),w_=l(ln),gd=a(ln,"LI",{});var Iy=s(gd);Ua=a(Iy,"A",{href:!0,rel:!0});var Sy=s(Ua);x_=i(Sy,"Vectorization"),Sy.forEach(t),Iy.forEach(t),z_=l(ln),kd=a(ln,"LI",{});var Ny=s(kd);Ha=a(Ny,"A",{href:!0,rel:!0});var Oy=s(Ha);B_=i(Oy,"Parallelization"),Oy.forEach(t),Ny.forEach(t),ln.forEach(t),q_=l(me),Pe=a(me,"DIV",{class:!0});var Pt=s(Pe);f(Qa.$$.fragment,Pt),F_=l(Pt),mo=a(Pt,"P",{});var Lr=s(mo);$_=i(Lr,"The "),bd=a(Lr,"CODE",{});var Dy=s(bd);j_=i(Dy,"FlaxBartPreTrainedModel"),Dy.forEach(t),M_=i(Lr,"forward method, overrides the "),yd=a(Lr,"CODE",{});var Ly=s(yd);E_=i(Ly,"__call__"),Ly.forEach(t),P_=i(Lr," special method."),Lr.forEach(t),C_=l(Pt),f(Xo.$$.fragment,Pt),A_=l(Pt),vd=a(Pt,"P",{});var Gy=s(vd);I_=i(Gy,"Example:"),Gy.forEach(t),S_=l(Pt),f(Va.$$.fragment,Pt),Pt.forEach(t),N_=l(me),_t=a(me,"DIV",{class:!0});var Gr=s(_t);f(Ja.$$.fragment,Gr),O_=l(Gr),Td=a(Gr,"P",{});var Wy=s(Td);D_=i(Wy,"Example:"),Wy.forEach(t),L_=l(Gr),f(Xa.$$.fragment,Gr),Gr.forEach(t),G_=l(me),gt=a(me,"DIV",{class:!0});var Wr=s(gt);f(Ka.$$.fragment,Wr),W_=l(Wr),wd=a(Wr,"P",{});var Ry=s(wd);R_=i(Ry,"Example:"),Ry.forEach(t),U_=l(Wr),f(Za.$$.fragment,Wr),Wr.forEach(t),me.forEach(t),Jl=l(o),fo=a(o,"H2",{class:!0});var Wc=s(fo);Ko=a(Wc,"A",{id:!0,class:!0,href:!0});var Uy=s(Ko);xd=a(Uy,"SPAN",{});var Hy=s(xd);f(Ya.$$.fragment,Hy),Hy.forEach(t),Uy.forEach(t),H_=l(Wc),zd=a(Wc,"SPAN",{});var Qy=s(zd);Q_=i(Qy,"FlaxBartForConditionalGeneration"),Qy.forEach(t),Wc.forEach(t),Xl=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(es.$$.fragment,fe),V_=l(fe),ts=a(fe,"P",{});var Rc=s(ts);J_=i(Rc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),yr=a(Rc,"A",{href:!0});var Vy=s(yr);X_=i(Vy,"FlaxPreTrainedModel"),Vy.forEach(t),K_=i(Rc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
