...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16097/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16097/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16097/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16097/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16097/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
`),ki=o("a"),K7=a("Trainer"),J7=a(" via "),Pi=o("a"),X7=a("TrainingArguments"),Q7=a(" then for the "),fd=o("code"),e9=a("deepspeed"),s9=a(` argument you can
...
going to use.`),ty=u(),Ni=o("a"),ay=u(),Is=o("h4"),pa=o("a"),qd=o("span"),f(al.$$.fragment),X9=u(),$d=o("span"),Q9=a("ZeRO-2 Config"),ny=u(),Hi=o("p"),e8=a("The following is an example of configuration for ZeRO stage 2:"),oy=u(),f(nl.$$.fragment),ly=u(),Bi=o("p"),kd=o("strong"),s8=a("Performance tuning:"),ry=u(),He=o("ul"),Us=o("li"),t8=a("enabling "),Pd=o("code"),a8=a("offload_optimizer"),n8=a(" should reduce GPU RAM usage (it requires "),Dd=o("code"),o8=a('"stage": 2'),l8=a(")"),r8=u(),L=o("li"),zd=o("code"),p8=a('"overlap_comm": true'),i8=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Od=o("code"),u8=a("overlap_comm"),c8=a(` uses 4.5x
the `),Td=o("code"),h8=a("allgather_bucket_size"),f8=a(" and "),Ad=o("code"),d8=a("reduce_bucket_size"),m8=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Sd=o("code"),_8=a("5e8 x 2Bytes x 2 x 4.5"),v8=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Cd=o("code"),j8=a("2e8"),g8=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),w8=u(),xd=o("li"),y8=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),py=u(),Be=o("p"),b8=a("Additionally, "),Rd=o("code"),E8=a("deepspeed==0.4.4"),q8=a(" added a new option "),Id=o("code"),$8=a("round_robin_gradients"),k8=a(" which you can enable with:"),iy=u(),f(ol.$$.fragment),uy=u(),Wi=o("p"),P8=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),cy=u(),Fi=o("a"),hy=u(),Gs=o("h4"),ia=o("a"),Ud=o("span"),f(ll.$$.fragment),D8=u(),Gd=o("span"),z8=a("ZeRO-3 Config"),fy=u(),Vi=o("p"),O8=a("The following is an example of configuration for ZeRO stage 3:"),dy=u(),f(rl.$$.fragment),my=u(),K=o("p"),T8=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Ld=o("code"),A8=a('"device": "cpu"'),S8=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Md=o("code"),C8=a("none"),x8=a(" instead of "),Zd=o("code"),R8=a("cpu"),I8=a(" for the "),Nd=o("code"),U8=a("device"),G8=a(` entry. Offloading to
NVMe is discussed further down.`),_y=u(),We=o("p"),L8=a("Pinned memory is enabled with "),Hd=o("code"),M8=a("pin_memory"),Z8=a(" set to "),Bd=o("code"),N8=a("true"),H8=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),vy=u(),Yi=o("p"),Wd=o("strong"),B8=a("Performance tuning:"),jy=u(),ua=o("ul"),pl=o("li"),Fd=o("code"),W8=a("stage3_max_live_parameters"),F8=a(": "),Vd=o("code"),V8=a("1e9"),Y8=u(),il=o("li"),Yd=o("code"),K8=a("stage3_max_reuse_distance"),J8=a(": "),Kd=o("code"),X8=a("1e9"),gy=u(),M=o("p"),Q8=a("If hitting OOM reduce "),Jd=o("code"),ek=a("stage3_max_live_parameters"),sk=a(" and "),Xd=o("code"),tk=a("stage3_max_reuse_distance"),ak=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Qd=o("code"),nk=a("1e9"),ok=a(` would consume ~2GB. The memory is shared by
`),em=o("code"),lk=a("stage3_max_live_parameters"),rk=a(" and "),sm=o("code"),pk=a("stage3_max_reuse_distance"),ik=a(", so it\u2019s not additive, it\u2019s just 2GB total."),wy=u(),ze=o("p"),tm=o("code"),uk=a("stage3_max_live_parameters"),ck=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),am=o("code"),hk=a("stage3_max_reuse_distance"),fk=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),nm=o("code"),dk=a("stage3_max_reuse_distance"),mk=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),yy=u(),Ki=o("p"),_k=a("The following configuration values depend on the model\u2019s hidden size:"),by=u(),Fe=o("ul"),ul=o("li"),om=o("code"),vk=a("reduce_bucket_size"),jk=a(": "),lm=o("code"),gk=a("hidden_size*hidden_size"),wk=u(),cl=o("li"),rm=o("code"),yk=a("stage3_prefetch_bucket_size"),bk=a(": "),pm=o("code"),Ek=a("0.9 * hidden_size * hidden_size"),qk=u(),hl=o("li"),im=o("code"),$k=a("stage3_param_persistence_threshold"),kk=a(": "),um=o("code"),Pk=a("10 * hidden_size"),Ey=u(),Ve=o("p"),Dk=a("therefore set these values to "),cm=o("code"),zk=a("auto"),Ok=a(" and the "),Ji=o("a"),Tk=a("Trainer"),Ak=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),qy=u(),fl=o("p"),hm=o("code"),Sk=a("stage3_gather_16bit_weights_on_model_save"),Ck=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),$y=u(),re=o("p"),xk=a("If you\u2019re migrating from ZeRO-2 configuration note that "),fm=o("code"),Rk=a("allgather_partitions"),Ik=a(", "),dm=o("code"),Uk=a("allgather_bucket_size"),Gk=a(` and
`),mm=o("code"),Lk=a("reduce_scatter"),Mk=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),ky=u(),Xi=o("ul"),dl=o("li"),_m=o("code"),Zk=a("sub_group_size"),Nk=a(": "),vm=o("code"),Hk=a("1e9"),Py=u(),Oe=o("p"),jm=o("code"),Bk=a("sub_group_size"),Wk=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),gm=o("code"),Fk=a("sub_group_size"),Vk=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),wm=o("code"),Yk=a("sub_group_size"),Kk=a(` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Dy=u(),Ye=o("p"),Jk=a("You can leave "),ym=o("code"),Xk=a("sub_group_size"),Qk=a(" to its default value of "),bm=o("em"),eP=a("1e9"),sP=a(` when not using NVMe offload. You may want to change its
...
not using the command line interface to configure the training, and instead instantiate the
`),ki=l(ye,"A",{href:!0});var IM=r(ki);K7=n(IM,"Trainer"),IM.forEach(t),J7=n(ye," via "),Pi=l(ye,"A",{href:!0});var UM=r(Pi);X7=n(UM,"TrainingArguments"),UM.forEach(t),Q7=n(ye," then for the "),fd=l(ye,"CODE",{});var GM=r(fd);e9=n(GM,"deepspeed"),GM.forEach(t),s9=n(ye,` argument you can
...
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),hZ.forEach(t),ty=c(e),Ni=l(e,"A",{id:!0}),r(Ni).forEach(t),ay=c(e),Is=l(e,"H4",{class:!0});var NE=r(Is);pa=l(NE,"A",{id:!0,class:!0,href:!0});var fZ=r(pa);qd=l(fZ,"SPAN",{});var dZ=r(qd);d(al.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),X9=c(NE),$d=l(NE,"SPAN",{});var mZ=r($d);Q9=n(mZ,"ZeRO-2 Config"),mZ.forEach(t),NE.forEach(t),ny=c(e),Hi=l(e,"P",{});var _Z=r(Hi);e8=n(_Z,"The following is an example of configuration for ZeRO stage 2:"),_Z.forEach(t),oy=c(e),d(nl.$$.fragment,e),ly=c(e),Bi=l(e,"P",{});var vZ=r(Bi);kd=l(vZ,"STRONG",{});var jZ=r(kd);s8=n(jZ,"Performance tuning:"),jZ.forEach(t),vZ.forEach(t),ry=c(e),He=l(e,"UL",{});var gh=r(He);Us=l(gh,"LI",{});var wh=r(Us);t8=n(wh,"enabling "),Pd=l(wh,"CODE",{});var gZ=r(Pd);a8=n(gZ,"offload_optimizer"),gZ.forEach(t),n8=n(wh," should reduce GPU RAM usage (it requires "),Dd=l(wh,"CODE",{});var wZ=r(Dd);o8=n(wZ,'"stage": 2'),wZ.forEach(t),l8=n(wh,")"),wh.forEach(t),r8=c(gh),L=l(gh,"LI",{});var te=r(L);zd=l(te,"CODE",{});var yZ=r(zd);p8=n(yZ,'"overlap_comm": true'),yZ.forEach(t),i8=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Od=l(te,"CODE",{});var bZ=r(Od);u8=n(bZ,"overlap_comm"),bZ.forEach(t),c8=n(te,` uses 4.5x
the `),Td=l(te,"CODE",{});var EZ=r(Td);h8=n(EZ,"allgather_bucket_size"),EZ.forEach(t),f8=n(te," and "),Ad=l(te,"CODE",{});var qZ=r(Ad);d8=n(qZ,"reduce_bucket_size"),qZ.forEach(t),m8=n(te,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Sd=l(te,"CODE",{});var $Z=r(Sd);_8=n($Z,"5e8 x 2Bytes x 2 x 4.5"),$Z.forEach(t),v8=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Cd=l(te,"CODE",{});var kZ=r(Cd);j8=n(kZ,"2e8"),kZ.forEach(t),g8=n(te,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),w8=c(gh),xd=l(gh,"LI",{});var PZ=r(xd);y8=n(PZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),PZ.forEach(t),gh.forEach(t),py=c(e),Be=l(e,"P",{});var yh=r(Be);b8=n(yh,"Additionally, "),Rd=l(yh,"CODE",{});var DZ=r(Rd);E8=n(DZ,"deepspeed==0.4.4"),DZ.forEach(t),q8=n(yh," added a new option "),Id=l(yh,"CODE",{});var zZ=r(Id);$8=n(zZ,"round_robin_gradients"),zZ.forEach(t),k8=n(yh," which you can enable with:"),yh.forEach(t),iy=c(e),d(ol.$$.fragment,e),uy=c(e),Wi=l(e,"P",{});var OZ=r(Wi);P8=n(OZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),OZ.forEach(t),cy=c(e),Fi=l(e,"A",{id:!0}),r(Fi).forEach(t),hy=c(e),Gs=l(e,"H4",{class:!0});var HE=r(Gs);ia=l(HE,"A",{id:!0,class:!0,href:!0});var TZ=r(ia);Ud=l(TZ,"SPAN",{});var AZ=r(Ud);d(ll.$$.fragment,AZ),AZ.forEach(t),TZ.forEach(t),D8=c(HE),Gd=l(HE,"SPAN",{});var SZ=r(Gd);z8=n(SZ,"ZeRO-3 Config"),SZ.forEach(t),HE.forEach(t),fy=c(e),Vi=l(e,"P",{});var CZ=r(Vi);O8=n(CZ,"The following is an example of configuration for ZeRO stage 3:"),CZ.forEach(t),dy=c(e),d(rl.$$.fragment,e),my=c(e),K=l(e,"P",{});var ys=r(K);T8=n(ys,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Ld=l(ys,"CODE",{});var xZ=r(Ld);A8=n(xZ,'"device": "cpu"'),xZ.forEach(t),S8=n(ys,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Md=l(ys,"CODE",{});var RZ=r(Md);C8=n(RZ,"none"),RZ.forEach(t),x8=n(ys," instead of "),Zd=l(ys,"CODE",{});var IZ=r(Zd);R8=n(IZ,"cpu"),IZ.forEach(t),I8=n(ys," for the "),Nd=l(ys,"CODE",{});var UZ=r(Nd);U8=n(UZ,"device"),UZ.forEach(t),G8=n(ys,` entry. Offloading to
NVMe is discussed further down.`),ys.forEach(t),_y=c(e),We=l(e,"P",{});var bh=r(We);L8=n(bh,"Pinned memory is enabled with "),Hd=l(bh,"CODE",{});var GZ=r(Hd);M8=n(GZ,"pin_memory"),GZ.forEach(t),Z8=n(bh," set to "),Bd=l(bh,"CODE",{});var LZ=r(Bd);N8=n(LZ,"true"),LZ.forEach(t),H8=n(bh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),bh.forEach(t),vy=c(e),Yi=l(e,"P",{});var MZ=r(Yi);Wd=l(MZ,"STRONG",{});var ZZ=r(Wd);B8=n(ZZ,"Performance tuning:"),ZZ.forEach(t),MZ.forEach(t),jy=c(e),ua=l(e,"UL",{});var BE=r(ua);pl=l(BE,"LI",{});var WE=r(pl);Fd=l(WE,"CODE",{});var NZ=r(Fd);W8=n(NZ,"stage3_max_live_parameters"),NZ.forEach(t),F8=n(WE,": "),Vd=l(WE,"CODE",{});var HZ=r(Vd);V8=n(HZ,"1e9"),HZ.forEach(t),WE.forEach(t),Y8=c(BE),il=l(BE,"LI",{});var FE=r(il);Yd=l(FE,"CODE",{});var BZ=r(Yd);K8=n(BZ,"stage3_max_reuse_distance"),BZ.forEach(t),J8=n(FE,": "),Kd=l(FE,"CODE",{});var WZ=r(Kd);X8=n(WZ,"1e9"),WZ.forEach(t),FE.forEach(t),BE.forEach(t),gy=c(e),M=l(e,"P",{});var be=r(M);Q8=n(be,"If hitting OOM reduce "),Jd=l(be,"CODE",{});var FZ=r(Jd);ek=n(FZ,"stage3_max_live_parameters"),FZ.forEach(t),sk=n(be," and "),Xd=l(be,"CODE",{});var VZ=r(Xd);tk=n(VZ,"stage3_max_reuse_distance"),VZ.forEach(t),ak=n(be,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Qd=l(be,"CODE",{});var YZ=r(Qd);nk=n(YZ,"1e9"),YZ.forEach(t),ok=n(be,` would consume ~2GB. The memory is shared by
`),em=l(be,"CODE",{});var KZ=r(em);lk=n(KZ,"stage3_max_live_parameters"),KZ.forEach(t),rk=n(be," and "),sm=l(be,"CODE",{});var JZ=r(sm);pk=n(JZ,"stage3_max_reuse_distance"),JZ.forEach(t),ik=n(be,", so it\u2019s not additive, it\u2019s just 2GB total."),be.forEach(t),wy=c(e),ze=l(e,"P",{});var Ap=r(ze);tm=l(Ap,"CODE",{});var XZ=r(tm);uk=n(XZ,"stage3_max_live_parameters"),XZ.forEach(t),ck=n(Ap,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),am=l(Ap,"CODE",{});var QZ=r(am);hk=n(QZ,"stage3_max_reuse_distance"),QZ.forEach(t),fk=n(Ap,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),nm=l(Ap,"CODE",{});var eN=r(nm);dk=n(eN,"stage3_max_reuse_distance"),eN.forEach(t),mk=n(Ap,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ap.forEach(t),yy=c(e),Ki=l(e,"P",{});var sN=r(Ki);_k=n(sN,"The following configuration values depend on the model\u2019s hidden size:"),sN.forEach(t),by=c(e),Fe=l(e,"UL",{});var Eh=r(Fe);ul=l(Eh,"LI",{});var VE=r(ul);om=l(VE,"CODE",{});var tN=r(om);vk=n(tN,"reduce_bucket_size"),tN.forEach(t),jk=n(VE,": "),lm=l(VE,"CODE",{});var aN=r(lm);gk=n(aN,"hidden_size*hidden_size"),aN.forEach(t),VE.forEach(t),wk=c(Eh),cl=l(Eh,"LI",{});var YE=r(cl);rm=l(YE,"CODE",{});var nN=r(rm);yk=n(nN,"stage3_prefetch_bucket_size"),nN.forEach(t),bk=n(YE,": "),pm=l(YE,"CODE",{});var oN=r(pm);Ek=n(oN,"0.9 * hidden_size * hidden_size"),oN.forEach(t),YE.forEach(t),qk=c(Eh),hl=l(Eh,"LI",{});var KE=r(hl);im=l(KE,"CODE",{});var lN=r(im);$k=n(lN,"stage3_param_persistence_threshold"),lN.forEach(t),kk=n(KE,": "),um=l(KE,"CODE",{});var rN=r(um);Pk=n(rN,"10 * hidden_size"),rN.forEach(t),KE.forEach(t),Eh.forEach(t),Ey=c(e),Ve=l(e,"P",{});var qh=r(Ve);Dk=n(qh,"therefore set these values to "),cm=l(qh,"CODE",{});var pN=r(cm);zk=n(pN,"auto"),pN.forEach(t),Ok=n(qh," and the "),Ji=l(qh,"A",{href:!0});var iN=r(Ji);Tk=n(iN,"Trainer"),iN.forEach(t),Ak=n(qh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),qh.forEach(t),qy=c(e),fl=l(e,"P",{});var fG=r(fl);hm=l(fG,"CODE",{});var uN=r(hm);Sk=n(uN,"stage3_gather_16bit_weights_on_model_save"),uN.forEach(t),Ck=n(fG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),fG.forEach(t),$y=c(e),re=l(e,"P",{});var Hn=r(re);xk=n(Hn,"If you\u2019re migrating from ZeRO-2 configuration note that "),fm=l(Hn,"CODE",{});var cN=r(fm);Rk=n(cN,"allgather_partitions"),cN.forEach(t),Ik=n(Hn,", "),dm=l(Hn,"CODE",{});var hN=r(dm);Uk=n(hN,"allgather_bucket_size"),hN.forEach(t),Gk=n(Hn,` and
`),mm=l(Hn,"CODE",{});var fN=r(mm);Lk=n(fN,"reduce_scatter"),fN.forEach(t),Mk=n(Hn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Hn.forEach(t),ky=c(e),Xi=l(e,"UL",{});var dN=r(Xi);dl=l(dN,"LI",{});var JE=r(dl);_m=l(JE,"CODE",{});var mN=r(_m);Zk=n(mN,"sub_group_size"),mN.forEach(t),Nk=n(JE,": "),vm=l(JE,"CODE",{});var _N=r(vm);Hk=n(_N,"1e9"),_N.forEach(t),JE.forEach(t),dN.forEach(t),Py=c(e),Oe=l(e,"P",{});var Sp=r(Oe);jm=l(Sp,"CODE",{});var vN=r(jm);Bk=n(vN,"sub_group_size"),vN.forEach(t),Wk=n(Sp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),gm=l(Sp,"CODE",{});var jN=r(gm);Fk=n(jN,"sub_group_size"),jN.forEach(t),Vk=n(Sp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),wm=l(Sp,"CODE",{});var gN=r(wm);Yk=n(gN,"sub_group_size"),gN.forEach(t),Kk=n(Sp,` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Sp.forEach(t),Dy=c(e),Ye=l(e,"P",{});var $h=r(Ye);Jk=n($h,"You can leave "),ym=l($h,"CODE",{});var wN=r(ym);Xk=n(wN,"sub_group_size"),wN.forEach(t),Qk=n($h," to its default value of "),bm=l($h,"EM",{});var yN=r(bm);eP=n(yN,"1e9"),yN.forEach(t),sP=n($h,` when not using NVMe offload. You may want to change its
