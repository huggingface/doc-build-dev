...
If set to float &lt; 1, use typical sampling strategy (described in <a href="https://arxiv.org/abs/2202.00666" rel="nofollow">https://arxiv.org/abs/2202.00666</a>)
to pick tokens for generation.`,name:"typical_p"},{anchor:"transformers.generation_utils.GenerationMixin.generate.repetition_penalty",description:`<strong>repetition_penalty</strong> (<code>float</code>, <em>optional</em>, defaults to 1.0) &#x2014;
...
should be prefixed with *decoder</em>*.`,name:"log_decoder"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L853",returnDescription:`
<p>A <a
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L1563",returnDescription:`
<p><a
  href="/docs/transformers/pr_17196/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L1795",returnDescription:`
<p><a
  href="/docs/transformers/pr_17196/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L2051",returnDescription:`
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L2363",returnDescription:`
<p><a
  href="/docs/transformers/pr_17196/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L2685",returnDescription:`
<p><a
  href="/docs/transformers/pr_17196/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17196/src/transformers/generation_utils.py#L3050",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_17196/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
`),Un=s("code"),Aa=t("do_sample=True"),Pa=t("."),Da=m(),R=s("li"),Vn=s("em"),Na=t("beam-search decoding"),Ca=t(" by calling "),un=s("a"),Ia=t("beam_search()"),Ba=t(" if "),Kn=s("code"),Wa=t("num_beams>1"),Ha=t(` and
`),Zn=s("code"),Ra=t("do_sample=False"),Ua=t("."),Va=m(),U=s("li"),Xn=s("em"),Ka=t("beam-search multinomial sampling"),Za=t(" by calling "),_n=s("a"),Xa=t("beam_sample()"),Ja=t(` if
`),Jn=s("code"),Qa=t("num_beams>1"),Ya=t(" and "),Qn=s("code"),er=t("do_sample=True"),tr=t("."),nr=m(),V=s("li"),Yn=s("em"),or=t("diverse beam-search decoding"),sr=t(" by calling "),hn=s("a"),ar=t("group_beam_search()"),rr=t(`, if
`),eo=s("code"),ir=t("num_beams>1"),lr=t(" and "),to=s("code"),dr=t("num_beam_groups>1"),cr=t("."),pr=m(),K=s("li"),no=s("em"),mr=t("constrained beam-search decoding"),gr=t(" by calling "),fn=s("a"),ur=t("constrained_beam_search()"),_r=t(`,
if `),oo=s("code"),hr=t("constraints!=None"),fr=t(" or "),so=s("code"),br=t("force_words_ids!=None"),xr=t("."),kr=m(),E=s("div"),k(Lt.$$.fragment),vr=m(),ao=s("p"),yr=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),jr=m(),S=s("ul"),Z=s("li"),ro=s("em"),Mr=t("greedy decoding"),Lr=t(" by calling "),bn=s("a"),wr=t("greedy_search()"),$r=t(" if "),io=s("code"),Tr=t("num_beams=1"),Er=t(` and
`),lo=s("code"),Or=t("do_sample=False"),Gr=t("."),qr=m(),X=s("li"),co=s("em"),Sr=t("multinomial sampling"),Fr=t(" by calling "),xn=s("a"),zr=t("sample()"),Ar=t(" if "),po=s("code"),Pr=t("num_beams=1"),Dr=t(` and
`),mo=s("code"),Nr=t("do_sample=True"),Cr=t("."),Ir=m(),J=s("li"),go=s("em"),Br=t("typical decoding"),Wr=t(" by calling "),kn=s("a"),Hr=t("sample()"),Rr=t(" if "),uo=s("code"),Ur=t("typical_p < 1.0"),Vr=t(` and
...
post`),gc=t("."),uc=m(),k(xt.$$.fragment),this.h()},l(l){const b=km('[data-svelte="svelte-1phssyn"]',document.head);d=a(b,"META",{name:!0,content:!0}),b.forEach(o),f=g(l),u=a(l,"H1",{class:!0});var tn=r(u);c=a(tn,"A",{id:!0,class:!0,href:!0});var gs=r(c);_=a(gs,"SPAN",{});var us=r(_);v(i.$$.fragment,us),us.forEach(o),gs.forEach(o),p=g(tn),I=a(tn,"SPAN",{});var _s=r(I);q=n(_s,"Generation"),_s.forEach(o),tn.forEach(o),B=g(l),F=a(l,"P",{});var nn=r(F);P=n(nn,"Each framework has a generate method for auto-regressive text generation implemented in their respective "),$=a(nn,"CODE",{});var hs=r($);we=n(hs,"GenerationMixin"),hs.forEach(o),$e=n(nn," class:"),nn.forEach(o),fe=g(l),be=a(l,"UL",{});var Ae=r(be);Te=a(Ae,"LI",{});var Pe=r(Te);Vs=n(Pe,"PyTorch "),on=a(Pe,"A",{href:!0});var fs=r(on);Ks=n(fs,"generate()"),fs.forEach(o),Zs=n(Pe," is implemented in "),sn=a(Pe,"A",{href:!0});var bs=r(sn);Xs=n(bs,"GenerationMixin"),bs.forEach(o),Js=n(Pe,"."),Pe.forEach(o),Qs=g(Ae),Ee=a(Ae,"LI",{});var De=r(Ee);Ys=n(De,"TensorFlow "),an=a(De,"A",{href:!0});var xs=r(an);ea=n(xs,"generate()"),xs.forEach(o),ta=n(De," is implemented in "),rn=a(De,"A",{href:!0});var ks=r(rn);na=n(ks,"TFGenerationMixin"),ks.forEach(o),oa=n(De,"."),De.forEach(o),sa=g(Ae),Oe=a(Ae,"LI",{});var En=r(Oe);aa=n(En,"Flax/JAX "),ln=a(En,"A",{href:!0});var _c=r(ln);ra=n(_c,"generate()"),_c.forEach(o),ia=n(En," is implemented in "),dn=a(En,"A",{href:!0});var hc=r(dn);la=n(hc,"FlaxGenerationMixin"),hc.forEach(o),da=n(En,"."),En.forEach(o),Ae.forEach(o),vs=g(l),Ge=a(l,"H2",{class:!0});var Ts=r(Ge);st=a(Ts,"A",{id:!0,class:!0,href:!0});var fc=r(st);Nn=a(fc,"SPAN",{});var bc=r(Nn);v(vt.$$.fragment,bc),bc.forEach(o),fc.forEach(o),ca=g(Ts),Cn=a(Ts,"SPAN",{});var xc=r(Cn);pa=n(xc,"GenerationMixin"),xc.forEach(o),Ts.forEach(o),ys=g(l),T=a(l,"DIV",{class:!0});var O=r(T);v(yt.$$.fragment,O),ma=g(O),jt=a(O,"P",{});var Es=r(jt);ga=n(Es,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),cn=a(Es,"A",{href:!0});var kc=r(cn);ua=n(kc,"PreTrainedModel"),kc.forEach(o),_a=n(Es,"."),Es.forEach(o),ha=g(O),Mt=a(O,"P",{});var Os=r(Mt);fa=n(Os,"The class exposes "),pn=a(Os,"A",{href:!0});var vc=r(pn);ba=n(vc,"generate()"),vc.forEach(o),xa=n(Os,", which can be used for:"),Os.forEach(o),ka=g(O),D=a(O,"UL",{});var le=r(D);W=a(le,"LI",{});var Ne=r(W);In=a(Ne,"EM",{});var yc=r(In);va=n(yc,"greedy decoding"),yc.forEach(o),ya=n(Ne," by calling "),mn=a(Ne,"A",{href:!0});var jc=r(mn);ja=n(jc,"greedy_search()"),jc.forEach(o),Ma=n(Ne," if "),Bn=a(Ne,"CODE",{});var Mc=r(Bn);La=n(Mc,"num_beams=1"),Mc.forEach(o),wa=n(Ne,` and
`),Wn=a(Ne,"CODE",{});var Lc=r(Wn);$a=n(Lc,"do_sample=False"),Lc.forEach(o),Ta=n(Ne,"."),Ne.forEach(o),Ea=g(le),H=a(le,"LI",{});var Ce=r(H);Hn=a(Ce,"EM",{});var wc=r(Hn);Oa=n(wc,"multinomial sampling"),wc.forEach(o),Ga=n(Ce," by calling "),gn=a(Ce,"A",{href:!0});var $c=r(gn);qa=n($c,"sample()"),$c.forEach(o),Sa=n(Ce," if "),Rn=a(Ce,"CODE",{});var Tc=r(Rn);Fa=n(Tc,"num_beams=1"),Tc.forEach(o),za=n(Ce,` and
`),Un=a(Ce,"CODE",{});var Ec=r(Un);Aa=n(Ec,"do_sample=True"),Ec.forEach(o),Pa=n(Ce,"."),Ce.forEach(o),Da=g(le),R=a(le,"LI",{});var Ie=r(R);Vn=a(Ie,"EM",{});var Oc=r(Vn);Na=n(Oc,"beam-search decoding"),Oc.forEach(o),Ca=n(Ie," by calling "),un=a(Ie,"A",{href:!0});var Gc=r(un);Ia=n(Gc,"beam_search()"),Gc.forEach(o),Ba=n(Ie," if "),Kn=a(Ie,"CODE",{});var qc=r(Kn);Wa=n(qc,"num_beams>1"),qc.forEach(o),Ha=n(Ie,` and
`),Zn=a(Ie,"CODE",{});var Sc=r(Zn);Ra=n(Sc,"do_sample=False"),Sc.forEach(o),Ua=n(Ie,"."),Ie.forEach(o),Va=g(le),U=a(le,"LI",{});var Be=r(U);Xn=a(Be,"EM",{});var Fc=r(Xn);Ka=n(Fc,"beam-search multinomial sampling"),Fc.forEach(o),Za=n(Be," by calling "),_n=a(Be,"A",{href:!0});var zc=r(_n);Xa=n(zc,"beam_sample()"),zc.forEach(o),Ja=n(Be,` if
`),Jn=a(Be,"CODE",{});var Ac=r(Jn);Qa=n(Ac,"num_beams>1"),Ac.forEach(o),Ya=n(Be," and "),Qn=a(Be,"CODE",{});var Pc=r(Qn);er=n(Pc,"do_sample=True"),Pc.forEach(o),tr=n(Be,"."),Be.forEach(o),nr=g(le),V=a(le,"LI",{});var We=r(V);Yn=a(We,"EM",{});var Dc=r(Yn);or=n(Dc,"diverse beam-search decoding"),Dc.forEach(o),sr=n(We," by calling "),hn=a(We,"A",{href:!0});var Nc=r(hn);ar=n(Nc,"group_beam_search()"),Nc.forEach(o),rr=n(We,`, if
`),eo=a(We,"CODE",{});var Cc=r(eo);ir=n(Cc,"num_beams>1"),Cc.forEach(o),lr=n(We," and "),to=a(We,"CODE",{});var Ic=r(to);dr=n(Ic,"num_beam_groups>1"),Ic.forEach(o),cr=n(We,"."),We.forEach(o),pr=g(le),K=a(le,"LI",{});var He=r(K);no=a(He,"EM",{});var Bc=r(no);mr=n(Bc,"constrained beam-search decoding"),Bc.forEach(o),gr=n(He," by calling "),fn=a(He,"A",{href:!0});var Wc=r(fn);ur=n(Wc,"constrained_beam_search()"),Wc.forEach(o),_r=n(He,`,
if `),oo=a(He,"CODE",{});var Hc=r(oo);hr=n(Hc,"constraints!=None"),Hc.forEach(o),fr=n(He," or "),so=a(He,"CODE",{});var Rc=r(so);br=n(Rc,"force_words_ids!=None"),Rc.forEach(o),xr=n(He,"."),He.forEach(o),le.forEach(o),kr=g(O),E=a(O,"DIV",{class:!0});var G=r(E);v(Lt.$$.fragment,G),vr=g(G),ao=a(G,"P",{});var Uc=r(ao);yr=n(Uc,`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),Uc.forEach(o),jr=g(G),S=a(G,"UL",{});var C=r(S);Z=a(C,"LI",{});var Re=r(Z);ro=a(Re,"EM",{});var Vc=r(ro);Mr=n(Vc,"greedy decoding"),Vc.forEach(o),Lr=n(Re," by calling "),bn=a(Re,"A",{href:!0});var Kc=r(bn);wr=n(Kc,"greedy_search()"),Kc.forEach(o),$r=n(Re," if "),io=a(Re,"CODE",{});var Zc=r(io);Tr=n(Zc,"num_beams=1"),Zc.forEach(o),Er=n(Re,` and
`),lo=a(Re,"CODE",{});var Xc=r(lo);Or=n(Xc,"do_sample=False"),Xc.forEach(o),Gr=n(Re,"."),Re.forEach(o),qr=g(C),X=a(C,"LI",{});var Ue=r(X);co=a(Ue,"EM",{});var Jc=r(co);Sr=n(Jc,"multinomial sampling"),Jc.forEach(o),Fr=n(Ue," by calling "),xn=a(Ue,"A",{href:!0});var Qc=r(xn);zr=n(Qc,"sample()"),Qc.forEach(o),Ar=n(Ue," if "),po=a(Ue,"CODE",{});var Yc=r(po);Pr=n(Yc,"num_beams=1"),Yc.forEach(o),Dr=n(Ue,` and
`),mo=a(Ue,"CODE",{});var ep=r(mo);Nr=n(ep,"do_sample=True"),ep.forEach(o),Cr=n(Ue,"."),Ue.forEach(o),Ir=g(C),J=a(C,"LI",{});var Ve=r(J);go=a(Ve,"EM",{});var tp=r(go);Br=n(tp,"typical decoding"),tp.forEach(o),Wr=n(Ve," by calling "),kn=a(Ve,"A",{href:!0});var np=r(kn);Hr=n(np,"sample()"),np.forEach(o),Rr=n(Ve," if "),uo=a(Ve,"CODE",{});var op=r(uo);Ur=n(op,"typical_p < 1.0"),op.forEach(o),Vr=n(Ve,` and
`),_o=a(Ve,"CODE",{});var sp=r(_o);Kr=n(sp,"do_sample=True"),sp.forEach(o),Zr=n(Ve,"."),Ve.forEach(o),Xr=g(C),Q=a(C,"LI",{});var Ke=r(Q);ho=a(Ke,"EM",{});var ap=r(ho);Jr=n(ap,"beam-search decoding"),ap.forEach(o),Qr=n(Ke," by calling "),vn=a(Ke,"A",{href:!0});var rp=r(vn);Yr=n(rp,"beam_search()"),rp.forEach(o),ei=n(Ke," if "),fo=a(Ke,"CODE",{});var ip=r(fo);ti=n(ip,"num_beams>1"),ip.forEach(o),ni=n(Ke,` and
`),bo=a(Ke,"CODE",{});var lp=r(bo);oi=n(lp,"do_sample=False"),lp.forEach(o),si=n(Ke,"."),Ke.forEach(o),ai=g(C),Y=a(C,"LI",{});var Ze=r(Y);xo=a(Ze,"EM",{});var dp=r(xo);ri=n(dp,"beam-search multinomial sampling"),dp.forEach(o),ii=n(Ze," by calling "),yn=a(Ze,"A",{href:!0});var cp=r(yn);li=n(cp,"beam_sample()"),cp.forEach(o),di=n(Ze,` if
`),ko=a(Ze,"CODE",{});var pp=r(ko);ci=n(pp,"num_beams>1"),pp.forEach(o),pi=n(Ze," and "),vo=a(Ze,"CODE",{});var mp=r(vo);mi=n(mp,"do_sample=True"),mp.forEach(o),gi=n(Ze,"."),Ze.forEach(o),ui=g(C),ee=a(C,"LI",{});var Xe=r(ee);yo=a(Xe,"EM",{});var gp=r(yo);_i=n(gp,"diverse beam-search decoding"),gp.forEach(o),hi=n(Xe," by calling "),jn=a(Xe,"A",{href:!0});var up=r(jn);fi=n(up,"group_beam_search()"),up.forEach(o),bi=n(Xe,`, if
`),jo=a(Xe,"CODE",{});var _p=r(jo);xi=n(_p,"num_beams>1"),_p.forEach(o),ki=n(Xe," and "),Mo=a(Xe,"CODE",{});var hp=r(Mo);vi=n(hp,"num_beam_groups>1"),hp.forEach(o),yi=n(Xe,"."),Xe.forEach(o),ji=g(C),te=a(C,"LI",{});var Je=r(te);Lo=a(Je,"EM",{});var fp=r(Lo);Mi=n(fp,"constrained beam-search decoding"),fp.forEach(o),Li=n(Je,` by calling
...
`),$o=a(Je,"CODE",{});var kp=r($o);Oi=n(kp,"force_words_ids!=None"),kp.forEach(o),Gi=n(Je,"."),Je.forEach(o),C.forEach(o),qi=g(G),v(at.$$.fragment,G),Si=g(G),wt=a(G,"P",{});var Gs=r(wt);Fi=n(Gs,"Most of these parameters are explained in more detail in "),$t=a(Gs,"A",{href:!0,rel:!0});var vp=r($t);zi=n(vp,`this blog
