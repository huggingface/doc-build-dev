...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16018/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new H({}),da=new q({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16018/src/transformers/models/bart/modeling_bart.py#L1265",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16018/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16018/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new q({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16018/src/transformers/models/bart/modeling_bart.py#L1304",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16018/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16018/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16018/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16018/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16018/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16018/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16018/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16018/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16018/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),Em=l(kn),Z=a(kn,"DIV",{class:!0});var Ne=s(Z);f(ha.$$.fragment,Ne),Cm=l(Ne),so=a(Ne,"P",{});var oi=s(so);Am=i(oi,"The "),Pr=a(oi,"A",{href:!0});var Yv=s(Pr);Sm=i(Yv,"BartForConditionalGeneration"),Yv.forEach(t),Im=i(oi," forward method, overrides the "),dd=a(oi,"CODE",{});var e1=s(dd);Om=i(e1,"__call__"),e1.forEach(t),Nm=i(oi," special method."),oi.forEach(t),Dm=l(Ne),f(Uo.$$.fragment,Ne),Lm=l(Ne),ld=a(Ne,"P",{});var t1=s(ld);Gm=i(t1,"Summarization example:"),t1.forEach(t),Wm=l(Ne),f(ua.$$.fragment,Ne),Rm=l(Ne),cd=a(Ne,"P",{});var o1=s(cd);Um=i(o1,"Mask filling example:"),o1.forEach(t),Hm=l(Ne),f(ma.$$.fragment,Ne),Ne.forEach(t),kn.forEach(t),gc=l(o),ro=a(o,"H2",{class:!0});var dp=s(ro);Ho=a(dp,"A",{id:!0,class:!0,href:!0});var n1=s(Ho);pd=a(n1,"SPAN",{});var a1=s(pd);f(fa.$$.fragment,a1),a1.forEach(t),n1.forEach(t),Qm=l(dp),hd=a(dp,"SPAN",{});var s1=s(hd);Vm=i(s1,"BartForSequenceClassification"),s1.forEach(t),dp.forEach(t),kc=l(o),xe=a(o,"DIV",{class:!0});var Mt=s(xe);f(_a.$$.fragment,Mt),Jm=l(Mt),ud=a(Mt,"P",{});var r1=s(ud);Xm=i(r1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),r1.forEach(t),Km=l(Mt),ga=a(Mt,"P",{});var lp=s(ga);Zm=i(lp,"This model inherits from "),Er=a(lp,"A",{href:!0});var i1=s(Er);Ym=i(i1,"PreTrainedModel"),i1.forEach(t),ef=i(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),tf=l(Mt),ka=a(Mt,"P",{});var cp=s(ka);of=i(cp,"This model is also a PyTorch "),ba=a(cp,"A",{href:!0,rel:!0});var d1=s(ba);nf=i(d1,"torch.nn.Module"),d1.forEach(t),af=i(cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),sf=l(Mt),Y=a(Mt,"DIV",{class:!0});var De=s(Y);f(ya.$$.fragment,De),rf=l(De),io=a(De,"P",{});var ni=s(io);df=i(ni,"The "),Cr=a(ni,"A",{href:!0});var l1=s(Cr);lf=i(l1,"BartForSequenceClassification"),l1.forEach(t),cf=i(ni," forward method, overrides the "),md=a(ni,"CODE",{});var c1=s(md);pf=i(c1,"__call__"),c1.forEach(t),hf=i(ni," special method."),ni.forEach(t),uf=l(De),f(Qo.$$.fragment,De),mf=l(De),fd=a(De,"P",{});var p1=s(fd);ff=i(p1,"Example of single-label classification:"),p1.forEach(t),_f=l(De),f(va.$$.fragment,De),gf=l(De),_d=a(De,"P",{});var h1=s(_d);kf=i(h1,"Example of multi-label classification:"),h1.forEach(t),bf=l(De),f(Ta.$$.fragment,De),De.forEach(t),Mt.forEach(t),bc=l(o),lo=a(o,"H2",{class:!0});var pp=s(lo);Vo=a(pp,"A",{id:!0,class:!0,href:!0});var u1=s(Vo);gd=a(u1,"SPAN",{});var m1=s(gd);f(wa.$$.fragment,m1),m1.forEach(t),u1.forEach(t),yf=l(pp),kd=a(pp,"SPAN",{});var f1=s(kd);vf=i(f1,"BartForQuestionAnswering"),f1.forEach(t),pp.forEach(t),yc=l(o),ze=a(o,"DIV",{class:!0});var Pt=s(ze);f(xa.$$.fragment,Pt),Tf=l(Pt),co=a(Pt,"P",{});var ai=s(co);wf=i(ai,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),bd=a(ai,"CODE",{});var _1=s(bd);xf=i(_1,"span start logits"),_1.forEach(t),zf=i(ai," and "),yd=a(ai,"CODE",{});var g1=s(yd);Ff=i(g1,"span end logits"),g1.forEach(t),Bf=i(ai,")."),ai.forEach(t),qf=l(Pt),za=a(Pt,"P",{});var hp=s(za);$f=i(hp,"This model inherits from "),Ar=a(hp,"A",{href:!0});var k1=s(Ar);jf=i(k1,"PreTrainedModel"),k1.forEach(t),Mf=i(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),Pf=l(Pt),Fa=a(Pt,"P",{});var up=s(Fa);Ef=i(up,"This model is also a PyTorch "),Ba=a(up,"A",{href:!0,rel:!0});var b1=s(Ba);Cf=i(b1,"torch.nn.Module"),b1.forEach(t),Af=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),Sf=l(Pt),Ee=a(Pt,"DIV",{class:!0});var Et=s(Ee);f(qa.$$.fragment,Et),If=l(Et),po=a(Et,"P",{});var si=s(po);Of=i(si,"The "),Sr=a(si,"A",{href:!0});var y1=s(Sr);Nf=i(y1,"BartForQuestionAnswering"),y1.forEach(t),Df=i(si," forward method, overrides the "),vd=a(si,"CODE",{});var v1=s(vd);Lf=i(v1,"__call__"),v1.forEach(t),Gf=i(si," special method."),si.forEach(t),Wf=l(Et),f(Jo.$$.fragment,Et),Rf=l(Et),Td=a(Et,"P",{});var T1=s(Td);Uf=i(T1,"Example:"),T1.forEach(t),Hf=l(Et),f($a.$$.fragment,Et),Et.forEach(t),Pt.forEach(t),vc=l(o),ho=a(o,"H2",{class:!0});var mp=s(ho);Xo=a(mp,"A",{id:!0,class:!0,href:!0});var w1=s(Xo);wd=a(w1,"SPAN",{});var x1=s(wd);f(ja.$$.fragment,x1),x1.forEach(t),w1.forEach(t),Qf=l(mp),xd=a(mp,"SPAN",{});var z1=s(xd);Vf=i(z1,"BartForCausalLM"),z1.forEach(t),mp.forEach(t),Tc=l(o),uo=a(o,"DIV",{class:!0});var fp=s(uo);f(Ma.$$.fragment,fp),Jf=l(fp),bt=a(fp,"DIV",{class:!0});var ri=s(bt);f(Pa.$$.fragment,ri),Xf=l(ri),zd=a(ri,"P",{});var F1=s(zd);Kf=i(F1,"Example:"),F1.forEach(t),Zf=l(ri),f(Ea.$$.fragment,ri),ri.forEach(t),fp.forEach(t),wc=l(o),mo=a(o,"H2",{class:!0});var _p=s(mo);Ko=a(_p,"A",{id:!0,class:!0,href:!0});var B1=s(Ko);Fd=a(B1,"SPAN",{});var q1=s(Fd);f(Ca.$$.fragment,q1),q1.forEach(t),B1.forEach(t),Yf=l(_p),Bd=a(_p,"SPAN",{});var $1=s(Bd);e_=i($1,"TFBartModel"),$1.forEach(t),_p.forEach(t),xc=l(o),Fe=a(o,"DIV",{class:!0});var Ct=s(Fe);f(Aa.$$.fragment,Ct),t_=l(Ct),Sa=a(Ct,"P",{});var gp=s(Sa);o_=i(gp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ir=a(gp,"A",{href:!0});var j1=s(Ir);n_=i(j1,"TFPreTrainedModel"),j1.forEach(t),a_=i(gp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gp.forEach(t),s_=l(Ct),Ia=a(Ct,"P",{});var kp=s(Ia);r_=i(kp,"This model is also a "),Oa=a(kp,"A",{href:!0,rel:!0});var M1=s(Oa);i_=i(M1,"tf.keras.Model"),M1.forEach(t),d_=i(kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kp.forEach(t),l_=l(Ct),f(Zo.$$.fragment,Ct),c_=l(Ct),Ce=a(Ct,"DIV",{class:!0});var At=s(Ce);f(Na.$$.fragment,At),p_=l(At),fo=a(At,"P",{});var ii=s(fo);h_=i(ii,"The "),Or=a(ii,"A",{href:!0});var P1=s(Or);u_=i(P1,"TFBartModel"),P1.forEach(t),m_=i(ii," forward method, overrides the "),qd=a(ii,"CODE",{});var E1=s(qd);f_=i(E1,"__call__"),E1.forEach(t),__=i(ii," special method."),ii.forEach(t),g_=l(At),f(Yo.$$.fragment,At),k_=l(At),$d=a(At,"P",{});var C1=s($d);b_=i(C1,"Example:"),C1.forEach(t),y_=l(At),f(Da.$$.fragment,At),At.forEach(t),Ct.forEach(t),zc=l(o),_o=a(o,"H2",{class:!0});var bp=s(_o);en=a(bp,"A",{id:!0,class:!0,href:!0});var A1=s(en);jd=a(A1,"SPAN",{});var S1=s(jd);f(La.$$.fragment,S1),S1.forEach(t),A1.forEach(t),v_=l(bp),Md=a(bp,"SPAN",{});var I1=s(Md);T_=i(I1,"TFBartForConditionalGeneration"),I1.forEach(t),bp.forEach(t),Fc=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(Ga.$$.fragment,St),w_=l(St),Wa=a(St,"P",{});var yp=s(Wa);x_=i(yp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Nr=a(yp,"A",{href:!0});var O1=s(Nr);z_=i(O1,"TFPreTrainedModel"),O1.forEach(t),F_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),B_=l(St),Ra=a(St,"P",{});var vp=s(Ra);q_=i(vp,"This model is also a "),Ua=a(vp,"A",{href:!0,rel:!0});var N1=s(Ua);$_=i(N1,"tf.keras.Model"),N1.forEach(t),j_=i(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),M_=l(St),f(tn.$$.fragment,St),P_=l(St),ee=a(St,"DIV",{class:!0});var Le=s(ee);f(Ha.$$.fragment,Le),E_=l(Le),go=a(Le,"P",{});var di=s(go);C_=i(di,"The "),Dr=a(di,"A",{href:!0});var D1=s(Dr);A_=i(D1,"TFBartForConditionalGeneration"),D1.forEach(t),S_=i(di," forward method, overrides the "),Pd=a(di,"CODE",{});var L1=s(Pd);I_=i(L1,"__call__"),L1.forEach(t),O_=i(di," special method."),di.forEach(t),N_=l(Le),f(on.$$.fragment,Le),D_=l(Le),Ed=a(Le,"P",{});var G1=s(Ed);L_=i(G1,"Summarization example:"),G1.forEach(t),G_=l(Le),f(Qa.$$.fragment,Le),W_=l(Le),Cd=a(Le,"P",{});var W1=s(Cd);R_=i(W1,"Mask filling example:"),W1.forEach(t),U_=l(Le),f(Va.$$.fragment,Le),Le.forEach(t),St.forEach(t),Bc=l(o),ko=a(o,"H2",{class:!0});var Tp=s(ko);nn=a(Tp,"A",{id:!0,class:!0,href:!0});var R1=s(nn);Ad=a(R1,"SPAN",{});var U1=s(Ad);f(Ja.$$.fragment,U1),U1.forEach(t),R1.forEach(t),H_=l(Tp),Sd=a(Tp,"SPAN",{});var H1=s(Sd);Q_=i(H1,"FlaxBartModel"),H1.forEach(t),Tp.forEach(t),qc=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);f(Xa.$$.fragment,fe),V_=l(fe),Ka=a(fe,"P",{});var wp=s(Ka);J_=i(wp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Lr=a(wp,"A",{href:!0});var Q1=s(Lr);X_=i(Q1,"FlaxPreTrainedModel"),Q1.forEach(t),K_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),Z_=l(fe),Za=a(fe,"P",{});var xp=s(Za);Y_=i(xp,`This model is also a Flax Linen
`),Ya=a(xp,"A",{href:!0,rel:!0});var V1=s(Ya);eg=i(V1,"flax.nn.Module"),V1.forEach(t),tg=i(xp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xp.forEach(t),og=l(fe),Id=a(fe,"P",{});var J1=s(Id);ng=i(J1,"Finally, this model supports inherent JAX features such as:"),J1.forEach(t),ag=l(fe),pt=a(fe,"UL",{});var bn=s(pt);Od=a(bn,"LI",{});var X1=s(Od);es=a(X1,"A",{href:!0,rel:!0});var K1=s(es);sg=i(K1,"Just-In-Time (JIT) compilation"),K1.forEach(t),X1.forEach(t),rg=l(bn),Nd=a(bn,"LI",{});var Z1=s(Nd);ts=a(Z1,"A",{href:!0,rel:!0});var Y1=s(ts);ig=i(Y1,"Automatic Differentiation"),Y1.forEach(t),Z1.forEach(t),dg=l(bn),Dd=a(bn,"LI",{});var eT=s(Dd);os=a(eT,"A",{href:!0,rel:!0});var tT=s(os);lg=i(tT,"Vectorization"),tT.forEach(t),eT.forEach(t),cg=l(bn),Ld=a(bn,"LI",{});var oT=s(Ld);ns=a(oT,"A",{href:!0,rel:!0});var nT=s(ns);pg=i(nT,"Parallelization"),nT.forEach(t),oT.forEach(t),bn.forEach(t),hg=l(fe),Ae=a(fe,"DIV",{class:!0});var It=s(Ae);f(as.$$.fragment,It),ug=l(It),bo=a(It,"P",{});var li=s(bo);mg=i(li,"The "),Gd=a(li,"CODE",{});var aT=s(Gd);fg=i(aT,"FlaxBartPreTrainedModel"),aT.forEach(t),_g=i(li,"forward method, overrides the "),Wd=a(li,"CODE",{});var sT=s(Wd);gg=i(sT,"__call__"),sT.forEach(t),kg=i(li," special method."),li.forEach(t),bg=l(It),f(an.$$.fragment,It),yg=l(It),Rd=a(It,"P",{});var rT=s(Rd);vg=i(rT,"Example:"),rT.forEach(t),Tg=l(It),f(ss.$$.fragment,It),It.forEach(t),wg=l(fe),yt=a(fe,"DIV",{class:!0});var ci=s(yt);f(rs.$$.fragment,ci),xg=l(ci),Ud=a(ci,"P",{});var iT=s(Ud);zg=i(iT,"Example:"),iT.forEach(t),Fg=l(ci),f(is.$$.fragment,ci),ci.forEach(t),Bg=l(fe),vt=a(fe,"DIV",{class:!0});var pi=s(vt);f(ds.$$.fragment,pi),qg=l(pi),Hd=a(pi,"P",{});var dT=s(Hd);$g=i(dT,"Example:"),dT.forEach(t),jg=l(pi),f(ls.$$.fragment,pi),pi.forEach(t),fe.forEach(t),$c=l(o),yo=a(o,"H2",{class:!0});var zp=s(yo);sn=a(zp,"A",{id:!0,class:!0,href:!0});var lT=s(sn);Qd=a(lT,"SPAN",{});var cT=s(Qd);f(cs.$$.fragment,cT),cT.forEach(t),lT.forEach(t),Mg=l(zp),Vd=a(zp,"SPAN",{});var pT=s(Vd);Pg=i(pT,"FlaxBartForConditionalGeneration"),pT.forEach(t),zp.forEach(t),jc=l(o),R=a(o,"DIV",{class:!0});var _e=s(R);f(ps.$$.fragment,_e),Eg=l(_e),hs=a(_e,"P",{});var Fp=s(hs);Cg=i(Fp,`The BART Model with a language modeling head. Can be used for summarization.
