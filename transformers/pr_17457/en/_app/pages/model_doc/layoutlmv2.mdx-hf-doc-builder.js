import{S as Mv,i as $v,s as Ev,e as a,k as c,w as v,t as n,M as qv,c as r,d as o,m as p,a as i,x as y,h as s,b as l,G as e,g as u,y as b,q as L,o as w,B as k,v as zv,L as sn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Gi}from"../../chunks/Tip-hf-doc-builder.js";import{D}from"../../chunks/Docstring-hf-doc-builder.js";import{C as U}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as de}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as nn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function jv(j){let h,x,f,g,T;return g=new U({props:{code:`from transformers import LayoutLMv2Model, LayoutLMv2Config
...
(<span class="hljs-number">154</span>, <span class="hljs-number">287</span>)`}}),{c(){v(h.$$.fragment)},l(f){y(h.$$.fragment,f)},m(f,g){b(h,f,g),x=!0},p:sn,i(f){x||(L(h.$$.fragment,f),x=!0)},o(f){w(h.$$.fragment,f),x=!1},d(f){k(h,f)}}}function Uv(j){let h,x,f,g,T,m,_,O,Hi,gr,Me,Ve,_s,Et,Ki,vs,Xi,_r,me,Yi,qt,Zi,Ji,an,el,tl,vr,he,X,ol,zt,nl,sl,jt,al,rl,Ft,il,ll,Pt,dl,cl,pl,Ct,ul,It,ml,hl,fl,At,gl,Dt,_l,vl,yr,rn,yl,br,ln,ys,bl,Lr,se,Ll,bs,wl,kl,Ls,xl,Tl,ws,Ml,$l,wr,Ot,kr,dn,El,xr,cn,ql,Tr,V,ks,zl,jl,Nt,Fl,St,Pl,Cl,Il,Rt,Al,Ut,Dl,Ol,Nl,$e,Sl,Bt,Rl,Ul,Wt,Bl,Wl,Vl,M,Ql,xs,Gl,Hl,pn,Kl,Xl,Ts,Yl,Zl,Ms,Jl,ed,$s,td,od,Es,nd,sd,qs,ad,rd,zs,id,ld,js,dd,cd,un,pd,ud,Vt,md,hd,Qt,fd,gd,Mr,Gt,$r,fe,_d,Fs,vd,yd,Ps,bd,Ld,Er,Ht,qr,Qe,wd,mn,kd,xd,zr,ge,I,Td,hn,Md,$d,Cs,Ed,qd,Is,zd,jd,fn,Fd,Pd,As,Cd,Id,Ds,Ad,Dd,Os,Od,Nd,Sd,Kt,Rd,gn,Ud,Bd,Wd,Xt,Vd,Ns,Qd,Gd,jr,Ge,Hd,_n,Kd,Xd,Fr,Ee,He,Ss,Yt,Yd,Rs,Zd,Pr,Q,Jd,vn,ec,tc,yn,oc,nc,bn,sc,ac,Ln,rc,ic,Cr,Zt,Ir,E,lc,wn,dc,cc,kn,pc,uc,Us,mc,hc,xn,fc,gc,Tn,_c,vc,Bs,yc,bc,Ws,Lc,wc,Vs,kc,xc,Qs,Tc,Mc,Gs,$c,Ec,Ar,B,Mn,qc,zc,Jt,jc,Fc,$n,Pc,Cc,Hs,Ic,Ac,Ks,Dc,Oc,Dr,En,Nc,Or,qn,Xs,Sc,Nr,zn,Rc,Sr,eo,Rr,jn,Ys,Uc,Ur,_e,Bc,Zs,Wc,Vc,Js,Qc,Gc,Br,to,Wr,Fn,ea,Hc,Vr,G,Kc,ta,Xc,Yc,oa,Zc,Jc,na,ep,tp,sa,op,np,Qr,oo,Gr,Pn,aa,sp,Hr,Cn,ap,Kr,no,Xr,In,ra,rp,Yr,An,ip,Zr,so,Jr,qe,Ke,ia,ao,lp,la,dp,ei,Y,ro,cp,ze,pp,Dn,up,mp,io,hp,fp,gp,je,_p,On,vp,yp,Nn,bp,Lp,wp,Xe,ti,Fe,Ye,da,lo,kp,ca,xp,oi,Z,co,Tp,pa,Mp,$p,po,Ep,ua,qp,zp,jp,ve,uo,Fp,ma,Pp,Cp,Ze,ni,Pe,Je,ha,mo,Ip,fa,Ap,si,N,ho,Dp,S,Op,Sn,Np,Sp,ga,Rp,Up,_a,Bp,Wp,va,Vp,Qp,ya,Gp,Hp,ba,Kp,Xp,Yp,fo,Zp,Rn,Jp,eu,tu,Un,Bn,ou,nu,su,et,go,au,La,ru,iu,Wn,_o,ai,Ce,tt,wa,vo,lu,ka,du,ri,J,yo,cu,bo,pu,xa,uu,mu,hu,Lo,fu,Vn,gu,_u,vu,ot,wo,yu,Ta,bu,ii,Ie,nt,Ma,ko,Lu,$a,wu,li,W,xo,ku,Ea,xu,Tu,Qn,Gn,Mu,$u,Eu,F,qu,Hn,zu,ju,Kn,Fu,Pu,Xn,Cu,Iu,qa,Au,Du,za,Ou,Nu,ja,Su,Ru,Fa,Uu,Bu,Pa,Wu,Vu,Ca,Qu,Gu,Hu,ye,To,Ku,$,Xu,Ia,Yu,Zu,Mo,Aa,Ju,em,tm,Yn,om,nm,Da,sm,am,Oa,rm,im,$o,Na,lm,dm,cm,Sa,pm,um,Zn,mm,hm,Ra,fm,gm,Ua,_m,vm,Ba,ym,bm,Wa,Lm,wm,km,Va,xm,di,Ae,st,Qa,Eo,Tm,Ga,Mm,ci,ce,qo,$m,zo,Em,jo,qm,zm,jm,ae,Fo,Fm,De,Pm,Jn,Cm,Im,Ha,Am,Dm,Om,at,Nm,rt,pi,Oe,it,Ka,Po,Sm,Xa,Rm,ui,ee,Co,Um,Io,Bm,Ao,Wm,Vm,Qm,Do,Gm,Oo,Hm,Km,Xm,re,No,Ym,Ne,Zm,es,Jm,eh,Ya,th,oh,nh,lt,sh,dt,mi,Se,ct,Za,So,ah,Ja,rh,hi,te,Ro,ih,oe,lh,Uo,dh,ch,Bo,ph,uh,Wo,mh,hh,Vo,fh,gh,_h,Qo,vh,Go,yh,bh,Lh,ie,Ho,wh,Re,kh,ts,xh,Th,er,Mh,$h,Eh,pt,qh,ut,fi,Ue,mt,tr,Ko,zh,or,jh,gi,ne,Xo,Fh,pe,Ph,Yo,Ch,Ih,nr,Ah,Dh,sr,Oh,Nh,Sh,Zo,Rh,Jo,Uh,Bh,Wh,A,en,Vh,Be,Qh,os,Gh,Hh,ar,Kh,Xh,Yh,ht,Zh,rr,Jh,ef,ir,tf,of,ft,nf,gt,_i;return m=new de({}),Et=new de({}),Ot=new U({props:{code:`python -m pip install 'git+https://github.com/facebookresearch/detectron2.git'
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Model">LayoutLMv2Model</a> or
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17457/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a> with the following fields:</p>
<ul>
<li><strong>pixel_values</strong> \u2014 Pixel values to be fed to a model, of shape (batch_size, num_channels, height,
width).</li>
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LayoutLMv2Tokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17457/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L418"}}),_o=new D({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L398"}}),vo=new de({}),yo=new D({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),To=new D({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),Eo=new de({}),qo=new D({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17457/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L708"}}),Fo=new D({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_17457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_17457/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L806",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17457/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config"
...
`}}),at=new Gi({props:{$$slots:{default:[Pv]},$$scope:{ctx:j}}}),rt=new nn({props:{anchor:"transformers.LayoutLMv2Model.forward.example",$$slots:{default:[Cv]},$$scope:{ctx:j}}}),Po=new de({}),Co=new D({props:{name:"class transformers.LayoutLMv2ForSequenceClassification",anchor:"transformers.LayoutLMv2ForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17457/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L964"}}),No=new D({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_17457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L978",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17457/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1145"}}),Ho=new D({props:{name:"forward",anchor:"transformers.LayoutLMv2ForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_17457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17457/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1159",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17457/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1290",returnDescription:`
<p>A <a
...
`}}),ht=new Gi({props:{$$slots:{default:[Nv]},$$scope:{ctx:j}}}),ft=new nn({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[Sv]},$$scope:{ctx:j}}}),gt=new nn({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example-2",$$slots:{default:[Rv]},$$scope:{ctx:j}}}),{c(){h=a("meta"),x=c(),f=a("h1"),g=a("a"),T=a("span"),v(m.$$.fragment),_=c(),O=a("span"),Hi=n("LayoutLMV2"),gr=c(),Me=a("h2"),Ve=a("a"),_s=a("span"),v(Et.$$.fragment),Ki=c(),vs=a("span"),Xi=n("Overview"),_r=c(),me=a("p"),Yi=n("The LayoutLMV2 model was proposed in "),qt=a("a"),Zi=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ji=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
Dinei Florencio, Cha Zhang, Wanxiang Che, Min Zhang, Lidong Zhou. LayoutLMV2 improves `),an=a("a"),el=n("LayoutLM"),tl=n(` to obtain
state-of-the-art results across several document image understanding benchmarks:`),vr=c(),he=a("ul"),X=a("li"),ol=n("information extraction from scanned documents: the "),zt=a("a"),nl=n("FUNSD"),sl=n(` dataset (a
...
400,000 images belonging to one of 16 classes).`),fl=c(),At=a("li"),gl=n("document visual question answering: the "),Dt=a("a"),_l=n("DocVQA"),vl=n(` dataset (a collection of 50,000
...
following to install them:`),wr=c(),v(Ot.$$.fragment),kr=c(),dn=a("p"),El=n("(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),xr=c(),cn=a("p"),ql=n("Tips:"),Tr=c(),V=a("ul"),ks=a("li"),zl=n(`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
the self-attention layers. Details can be found on page 5 of the `),St=a("a"),Pl=n("paper"),Cl=n("."),Il=c(),Rt=a("li"),Al=n("Demo notebooks on how to use the LayoutLMv2 model on RVL-CDIP, FUNSD, DocVQA, CORD can be found "),Ut=a("a"),Dl=n("here"),Ol=n("."),Nl=c(),$e=a("li"),Sl=n("LayoutLMv2 uses Facebook AI\u2019s "),Bt=a("a"),Rl=n("Detectron2"),Ul=n(` package for its visual
backbone. See `),Wt=a("a"),Bl=n("this link"),Wl=n(` for installation
...
`),qs=a("code"),ad=n("torch.Tensor"),rd=n(" or a "),zs=a("code"),id=n("Detectron2.structures.ImageList"),ld=n(`. You don\u2019t need to normalize the channels, as this is
...
follows:`),Er=c(),v(Ht.$$.fragment),qr=c(),Qe=a("p"),wd=n("However, this model includes a brand new "),mn=a("a"),kd=n("LayoutLMv2Processor"),xd=n(` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
section below.`),zr=c(),ge=a("ul"),I=a("li"),Td=n("Internally, "),hn=a("a"),Md=n("LayoutLMv2Model"),$d=n(" will send the "),Cs=a("code"),Ed=n("image"),qd=n(` input through its visual backbone to
obtain a lower-resolution feature map, whose shape is equal to the `),Is=a("code"),zd=n("image_feature_pool_shape"),jd=n(` attribute of
...
will have a shape of `),As=a("code"),Cd=n("seq_length"),Id=n(" + "),Ds=a("code"),Ad=n("image_feature_pool_shape[0]"),Dd=n(` *
`),Os=a("code"),Od=n("config.image_feature_pool_shape[1]"),Nd=n("."),Sd=c(),Kt=a("li"),Rd=n("When calling "),gn=a("a"),Ud=n("from_pretrained()"),Bd=n(`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),Wd=c(),Xt=a("li"),Vd=n("If you want to train the model in a distributed environment, make sure to call "),Ns=a("code"),Qd=n("synchronize_batch_norm"),Gd=n(` on the
...
bounding boxes, as well to resize the image to a given size in order to get the `),Us=a("code"),mc=n("image"),hc=n(` input. The words and
normalized bounding boxes are then provided to `),xn=a("a"),fc=n("LayoutLMv2Tokenizer"),gc=n(` or
`),Tn=a("a"),_c=n("LayoutLMv2TokenizerFast"),vc=n(", which converts them to token-level "),Bs=a("code"),yc=n("input_ids"),bc=n(`,
`),Ws=a("code"),Lc=n("attention_mask"),wc=n(", "),Vs=a("code"),kc=n("token_type_ids"),xc=n(", "),Qs=a("code"),Tc=n("bbox"),Mc=n(`. Optionally, one can provide word labels to the processor,
which are turned into token-level `),Gs=a("code"),$c=n("labels"),Ec=n("."),Ar=c(),B=a("p"),Mn=a("a"),qc=n("LayoutLMv2Processor"),zc=n(" uses "),Jt=a("a"),jc=n("PyTesseract"),Fc=n(`, a Python
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),$n=a("a"),Pc=n("LayoutLMv2FeatureExtractor"),Cc=n(" with "),Hs=a("code"),Ic=n("apply_ocr"),Ac=n(" set to "),Ks=a("code"),Dc=n("False"),Oc=n("."),Dr=c(),En=a("p"),Nc=n(`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Or=c(),qn=a("p"),Xs=a("strong"),Sc=n(`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
True`),Nr=c(),zn=a("p"),Rc=n(`This is the simplest case, in which the processor (actually the feature extractor) will perform OCR on the image to get
the words and normalized bounding boxes.`),Sr=c(),v(eo.$$.fragment),Rr=c(),jn=a("p"),Ys=a("strong"),Uc=n("Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Ur=c(),_e=a("p"),Bc=n("In case one wants to do OCR themselves, one can initialize the feature extractor with "),Zs=a("code"),Wc=n("apply_ocr"),Vc=n(` set to
...
the processor.`),Br=c(),v(to.$$.fragment),Wr=c(),Fn=a("p"),ea=a("strong"),Hc=n("Use case 3: token classification (training), apply_ocr=False"),Vr=c(),G=a("p"),Kc=n(`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
processor will apply OCR on the image, and create [CLS] question tokens [SEP] word tokens [SEP].`),Kr=c(),v(no.$$.fragment),Xr=c(),In=a("p"),ra=a("strong"),rp=n("Use case 5: visual question answering (inference), apply_ocr=False"),Yr=c(),An=a("p"),ip=n(`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. If you want to
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Zr=c(),v(so.$$.fragment),Jr=c(),qe=a("h2"),Ke=a("a"),ia=a("span"),v(ao.$$.fragment),lp=c(),la=a("span"),dp=n("LayoutLMv2Config"),ei=c(),Y=a("div"),v(ro.$$.fragment),cp=c(),ze=a("p"),pp=n("This is the configuration class to store the configuration of a "),Dn=a("a"),up=n("LayoutLMv2Model"),mp=n(`. It is used to instantiate an
...
to apply OCR on them in order to get a list of words and normalized bounding boxes.`),$p=c(),po=a("p"),Ep=n("This feature extractor inherits from "),ua=a("code"),qp=n("PreTrainedFeatureExtractor()"),zp=n(` which contains most
of the main methods. Users should refer to this superclass for more information regarding those methods.`),jp=c(),ve=a("div"),v(uo.$$.fragment),Fp=c(),ma=a("p"),Pp=n("Main method to prepare for the model one or several image(s)."),Cp=c(),v(Ze.$$.fragment),ni=c(),Pe=a("h2"),Je=a("a"),ha=a("span"),v(mo.$$.fragment),Ip=c(),fa=a("span"),Ap=n("LayoutLMv2Tokenizer"),si=c(),N=a("div"),v(ho.$$.fragment),Dp=c(),S=a("p"),Op=n("Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Sn=a("a"),Np=n("LayoutLMv2Tokenizer"),Sp=n(` can be used to turn words, word-level
bounding boxes and optional word labels to token-level `),ga=a("code"),Rp=n("input_ids"),Up=n(", "),_a=a("code"),Bp=n("attention_mask"),Wp=n(", "),va=a("code"),Vp=n("token_type_ids"),Qp=n(", "),ya=a("code"),Gp=n("bbox"),Hp=n(`, and
...
this superclass for more information regarding those methods.`),tu=c(),Un=a("p"),Bn=a("a"),ou=n("LayoutLMv2Tokenizer"),nu=n(` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
...
sequences with word-level normalized bounding boxes and optional labels.`),ii=c(),Ie=a("h2"),nt=a("a"),Ma=a("span"),v(ko.$$.fragment),Lu=c(),$a=a("span"),wu=n("LayoutLMv2Processor"),li=c(),W=a("div"),v(xo.$$.fragment),ku=c(),Ea=a("p"),xu=n(`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),Tu=c(),Qn=a("p"),Gn=a("a"),Mu=n("LayoutLMv2Processor"),$u=n(" offers all the functionalities you need to prepare data for the model."),Eu=c(),F=a("p"),qu=n("It first uses "),Hn=a("a"),zu=n("LayoutLMv2FeatureExtractor"),ju=n(` to resize document images to a fixed size, and optionally applies OCR
to get words and normalized bounding boxes. These are then provided to `),Kn=a("a"),Fu=n("LayoutLMv2Tokenizer"),Pu=n(` or
`),Xn=a("a"),Cu=n("LayoutLMv2TokenizerFast"),Iu=n(", which turns the words and bounding boxes into token-level "),qa=a("code"),Au=n("input_ids"),Du=n(`,
`),za=a("code"),Ou=n("attention_mask"),Nu=n(", "),ja=a("code"),Su=n("token_type_ids"),Ru=n(", "),Fa=a("code"),Uu=n("bbox"),Bu=n(". Optionally, one can provide integer "),Pa=a("code"),Wu=n("word_labels"),Vu=n(`, which are turned
into token-level `),Ca=a("code"),Qu=n("labels"),Gu=n(" for token classification tasks (such as FUNSD, CORD)."),Hu=c(),ye=a("div"),v(To.$$.fragment),Ku=c(),$=a("p"),Xu=n("This method first forwards the "),Ia=a("code"),Yu=n("images"),Zu=n(" argument to "),Mo=a("a"),Aa=a("strong"),Ju=n("call"),em=n("()"),tm=n(`. In case
`),Yn=a("a"),om=n("LayoutLMv2FeatureExtractor"),nm=n(" was initialized with "),Da=a("code"),sm=n("apply_ocr"),am=n(" set to "),Oa=a("code"),rm=n("True"),im=n(`, it passes the obtained words and
...
`),Ua=a("code"),_m=n("False"),vm=n(", it passes the words ("),Ba=a("code"),ym=n("text"),bm=n("/"),Wa=a("code"),Lm=n("text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),wm=n("."),km=c(),Va=a("p"),xm=n("Please refer to the docstring of the above two methods for more information."),di=c(),Ae=a("h2"),st=a("a"),Qa=a("span"),v(Eo.$$.fragment),Tm=c(),Ga=a("span"),Mm=n("LayoutLMv2Model"),ci=c(),ce=a("div"),v(qo.$$.fragment),$m=c(),zo=a("p"),Em=n(`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),jo=a("a"),qm=n("torch.nn.Module"),zm=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jm=c(),ae=a("div"),v(Fo.$$.fragment),Fm=c(),De=a("p"),Pm=n("The "),Jn=a("a"),Cm=n("LayoutLMv2Model"),Im=n(" forward method, overrides the "),Ha=a("code"),Am=n("__call__"),Dm=n(" special method."),Om=c(),v(at.$$.fragment),Nm=c(),v(rt.$$.fragment),pi=c(),Oe=a("h2"),it=a("a"),Ka=a("span"),v(Po.$$.fragment),Sm=c(),Xa=a("span"),Rm=n("LayoutLMv2ForSequenceClassification"),ui=c(),ee=a("div"),v(Co.$$.fragment),Um=c(),Io=a("p"),Bm=n(`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
`),Ao=a("a"),Wm=n("RVL-CDIP"),Vm=n(" dataset."),Qm=c(),Do=a("p"),Gm=n("This model is a PyTorch "),Oo=a("a"),Hm=n("torch.nn.Module"),Km=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
`),Uo=a("a"),dh=n("FUNSD"),ch=n(", "),Bo=a("a"),ph=n("SROIE"),uh=n(`,
`),Wo=a("a"),mh=n("CORD"),hh=n(" and "),Vo=a("a"),fh=n("Kleister-NDA"),gh=n("."),_h=c(),Qo=a("p"),vh=n("This model is a PyTorch "),Go=a("a"),yh=n("torch.nn.Module"),bh=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lh=c(),ie=a("div"),v(Ho.$$.fragment),wh=c(),Re=a("p"),kh=n("The "),ts=a("a"),xh=n("LayoutLMv2ForTokenClassification"),Th=n(" forward method, overrides the "),er=a("code"),Mh=n("__call__"),$h=n(" special method."),Eh=c(),v(pt.$$.fragment),qh=c(),v(ut.$$.fragment),fi=c(),Ue=a("h2"),mt=a("a"),tr=a("span"),v(Ko.$$.fragment),zh=c(),or=a("span"),jh=n("LayoutLMv2ForQuestionAnswering"),gi=c(),ne=a("div"),v(Xo.$$.fragment),Fh=c(),pe=a("p"),Ph=n(`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
`),Yo=a("a"),Ch=n("DocVQA"),Ih=n(` (a linear layer on top of the text part of the hidden-states output to
compute `),nr=a("code"),Ah=n("span start logits"),Dh=n(" and "),sr=a("code"),Oh=n("span end logits"),Nh=n(")."),Sh=c(),Zo=a("p"),Rh=n("This model is a PyTorch "),Jo=a("a"),Uh=n("torch.nn.Module"),Bh=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wh=c(),A=a("div"),v(en.$$.fragment),Vh=c(),Be=a("p"),Qh=n("The "),os=a("a"),Gh=n("LayoutLMv2ForQuestionAnswering"),Hh=n(" forward method, overrides the "),ar=a("code"),Kh=n("__call__"),Xh=n(" special method."),Yh=c(),v(ht.$$.fragment),Zh=c(),rr=a("p"),Jh=n("Example:"),ef=c(),ir=a("p"),tf=n(`In this example below, we give the LayoutLMv2 model an image (of texts) and ask it a question. It will give us
a prediction of what it thinks the answer is (the span of the answer within the texts parsed from the image).`),of=c(),v(ft.$$.fragment),nf=c(),v(gt.$$.fragment),this.h()},l(t){const d=qv('[data-svelte="svelte-1phssyn"]',document.head);h=r(d,"META",{name:!0,content:!0}),d.forEach(o),x=p(t),f=r(t,"H1",{class:!0});var tn=i(f);g=r(tn,"A",{id:!0,class:!0,href:!0});var lr=i(g);T=r(lr,"SPAN",{});var dr=i(T);y(m.$$.fragment,dr),dr.forEach(o),lr.forEach(o),_=p(tn),O=r(tn,"SPAN",{});var cr=i(O);Hi=s(cr,"LayoutLMV2"),cr.forEach(o),tn.forEach(o),gr=p(t),Me=r(t,"H2",{class:!0});var on=i(Me);Ve=r(on,"A",{id:!0,class:!0,href:!0});var pr=i(Ve);_s=r(pr,"SPAN",{});var ur=i(_s);y(Et.$$.fragment,ur),ur.forEach(o),pr.forEach(o),Ki=p(on),vs=r(on,"SPAN",{});var mr=i(vs);Xi=s(mr,"Overview"),mr.forEach(o),on.forEach(o),_r=p(t),me=r(t,"P",{});var We=i(me);Yi=s(We,"The LayoutLMV2 model was proposed in "),qt=r(We,"A",{href:!0,rel:!0});var hr=i(qt);Zi=s(hr,"LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),hr.forEach(o),Ji=s(We,` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
Dinei Florencio, Cha Zhang, Wanxiang Che, Min Zhang, Lidong Zhou. LayoutLMV2 improves `),an=r(We,"A",{href:!0});var fr=i(an);el=s(fr,"LayoutLM"),fr.forEach(o),tl=s(We,` to obtain
state-of-the-art results across several document image understanding benchmarks:`),We.forEach(o),vr=p(t),he=r(t,"UL",{});var ns=i(he);X=r(ns,"LI",{});var be=i(X);ol=s(be,"information extraction from scanned documents: the "),zt=r(be,"A",{href:!0,rel:!0});var df=i(zt);nl=s(df,"FUNSD"),df.forEach(o),sl=s(be,` dataset (a
...
400,000 images belonging to one of 16 classes).`),vi.forEach(o),fl=p(ns),At=r(ns,"LI",{});var yi=i(At);gl=s(yi,"document visual question answering: the "),Dt=r(yi,"A",{href:!0,rel:!0});var hf=i(Dt);_l=s(hf,"DocVQA"),hf.forEach(o),vl=s(yi,` dataset (a collection of 50,000
...
following to install them:`),_t.forEach(o),wr=p(t),y(Ot.$$.fragment,t),kr=p(t),dn=r(t,"P",{});var Lf=i(dn);El=s(Lf,"(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),Lf.forEach(o),xr=p(t),cn=r(t,"P",{});var wf=i(cn);ql=s(wf,"Tips:"),wf.forEach(o),Tr=p(t),V=r(t,"UL",{});var Le=i(V);ks=r(Le,"LI",{});var kf=i(ks);zl=s(kf,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
the self-attention layers. Details can be found on page 5 of the `),St=r(bi,"A",{href:!0,rel:!0});var xf=i(St);Pl=s(xf,"paper"),xf.forEach(o),Cl=s(bi,"."),bi.forEach(o),Il=p(Le),Rt=r(Le,"LI",{});var Li=i(Rt);Al=s(Li,"Demo notebooks on how to use the LayoutLMv2 model on RVL-CDIP, FUNSD, DocVQA, CORD can be found "),Ut=r(Li,"A",{href:!0,rel:!0});var Tf=i(Ut);Dl=s(Tf,"here"),Tf.forEach(o),Ol=s(Li,"."),Li.forEach(o),Nl=p(Le),$e=r(Le,"LI",{});var ss=i($e);Sl=s(ss,"LayoutLMv2 uses Facebook AI\u2019s "),Bt=r(ss,"A",{href:!0,rel:!0});var Mf=i(Bt);Rl=s(Mf,"Detectron2"),Mf.forEach(o),Ul=s(ss,` package for its visual
backbone. See `),Wt=r(ss,"A",{href:!0,rel:!0});var $f=i(Wt);Bl=s($f,"this link"),$f.forEach(o),Wl=s(ss,` for installation
instructions.`),ss.forEach(o),Vl=p(Le),M=r(Le,"LI",{});var q=i(M);Ql=s(q,"In addition to "),xs=r(q,"CODE",{});var Ef=i(xs);Gl=s(Ef,"input_ids"),Ef.forEach(o),Hl=s(q,", "),pn=r(q,"A",{href:!0});var qf=i(pn);Kl=s(qf,"forward()"),qf.forEach(o),Xl=s(q,` expects 2 additional inputs, namely
`),Ts=r(q,"CODE",{});var zf=i(Ts);Yl=s(zf,"image"),zf.forEach(o),Zl=s(q," and "),Ms=r(q,"CODE",{});var jf=i(Ms);Jl=s(jf,"bbox"),jf.forEach(o),ed=s(q,". The "),$s=r(q,"CODE",{});var Ff=i($s);td=s(Ff,"image"),Ff.forEach(o),od=s(q,` input corresponds to the original document image in which the text
tokens occur. The model expects each document image to be of size 224x224. This means that if you have a batch of
document images, `),Es=r(q,"CODE",{});var Pf=i(Es);nd=s(Pf,"image"),Pf.forEach(o),sd=s(q,` should be a tensor of shape (batch_size, 3, 224, 224). This can be either a
`),qs=r(q,"CODE",{});var Cf=i(qs);ad=s(Cf,"torch.Tensor"),Cf.forEach(o),rd=s(q," or a "),zs=r(q,"CODE",{});var If=i(zs);id=s(If,"Detectron2.structures.ImageList"),If.forEach(o),ld=s(q,`. You don\u2019t need to normalize the channels, as this is
done by the model. Important to note is that the visual backbone expects BGR channels instead of RGB, as all models
in Detectron2 are pre-trained using the BGR format. The `),js=r(q,"CODE",{});var Af=i(js);dd=s(Af,"bbox"),Af.forEach(o),cd=s(q,` input are the bounding boxes (i.e. 2D-positions)
of the input text tokens. This is identical to `),un=r(q,"A",{href:!0});var Df=i(un);pd=s(Df,"LayoutLMModel"),Df.forEach(o),ud=s(q,`. These can be obtained using an
external OCR engine such as Google\u2019s `),Vt=r(q,"A",{href:!0,rel:!0});var Of=i(Vt);md=s(Of,"Tesseract"),Of.forEach(o),hd=s(q," (there\u2019s a "),Qt=r(q,"A",{href:!0,rel:!0});var Nf=i(Qt);fd=s(Nf,`Python
wrapper`),Nf.forEach(o),gd=s(q,` available). Each bounding box should be in (x0, y0, x1, y1)
format, where (x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1)
represents the position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on
a 0-1000 scale. To normalize, you can use the following function:`),q.forEach(o),Le.forEach(o),Mr=p(t),y(Gt.$$.fragment,t),$r=p(t),fe=r(t,"P",{});var as=i(fe);_d=s(as,"Here, "),Fs=r(as,"CODE",{});var Sf=i(Fs);vd=s(Sf,"width"),Sf.forEach(o),yd=s(as," and "),Ps=r(as,"CODE",{});var Rf=i(Ps);bd=s(Rf,"height"),Rf.forEach(o),Ld=s(as,` correspond to the width and height of the original document in which the token
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),as.forEach(o),Er=p(t),y(Ht.$$.fragment,t),qr=p(t),Qe=r(t,"P",{});var wi=i(Qe);wd=s(wi,"However, this model includes a brand new "),mn=r(wi,"A",{href:!0});var Uf=i(mn);kd=s(Uf,"LayoutLMv2Processor"),Uf.forEach(o),xd=s(wi,` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
section below.`),wi.forEach(o),zr=p(t),ge=r(t,"UL",{});var rs=i(ge);I=r(rs,"LI",{});var R=i(I);Td=s(R,"Internally, "),hn=r(R,"A",{href:!0});var Bf=i(hn);Md=s(Bf,"LayoutLMv2Model"),Bf.forEach(o),$d=s(R," will send the "),Cs=r(R,"CODE",{});var Wf=i(Cs);Ed=s(Wf,"image"),Wf.forEach(o),qd=s(R,` input through its visual backbone to
obtain a lower-resolution feature map, whose shape is equal to the `),Is=r(R,"CODE",{});var Vf=i(Is);zd=s(Vf,"image_feature_pool_shape"),Vf.forEach(o),jd=s(R,` attribute of
...
tokens, and send through the Transformer encoder. This means that the last hidden states of the model will have a
length of 512 + 49 = 561, if you pad the text tokens up to the max length. More generally, the last hidden states
will have a shape of `),As=r(R,"CODE",{});var Gf=i(As);Cd=s(Gf,"seq_length"),Gf.forEach(o),Id=s(R," + "),Ds=r(R,"CODE",{});var Hf=i(Ds);Ad=s(Hf,"image_feature_pool_shape[0]"),Hf.forEach(o),Dd=s(R,` *
`),Os=r(R,"CODE",{});var Kf=i(Os);Od=s(Kf,"config.image_feature_pool_shape[1]"),Kf.forEach(o),Nd=s(R,"."),R.forEach(o),Sd=p(rs),Kt=r(rs,"LI",{});var ki=i(Kt);Rd=s(ki,"When calling "),gn=r(ki,"A",{href:!0});var Xf=i(gn);Ud=s(Xf,"from_pretrained()"),Xf.forEach(o),Bd=s(ki,`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),ki.forEach(o),Wd=p(rs),Xt=r(rs,"LI",{});var xi=i(Xt);Vd=s(xi,"If you want to train the model in a distributed environment, make sure to call "),Ns=r(xi,"CODE",{});var Yf=i(Ns);Qd=s(Yf,"synchronize_batch_norm"),Yf.forEach(o),Gd=s(xi,` on the
...
bounding boxes, as well to resize the image to a given size in order to get the `),Us=r(P,"CODE",{});var lg=i(Us);mc=s(lg,"image"),lg.forEach(o),hc=s(P,` input. The words and
...
`),Tn=r(P,"A",{href:!0});var cg=i(Tn);_c=s(cg,"LayoutLMv2TokenizerFast"),cg.forEach(o),vc=s(P,", which converts them to token-level "),Bs=r(P,"CODE",{});var pg=i(Bs);yc=s(pg,"input_ids"),pg.forEach(o),bc=s(P,`,
`),Ws=r(P,"CODE",{});var ug=i(Ws);Lc=s(ug,"attention_mask"),ug.forEach(o),wc=s(P,", "),Vs=r(P,"CODE",{});var mg=i(Vs);kc=s(mg,"token_type_ids"),mg.forEach(o),xc=s(P,", "),Qs=r(P,"CODE",{});var hg=i(Qs);Tc=s(hg,"bbox"),hg.forEach(o),Mc=s(P,`. Optionally, one can provide word labels to the processor,
which are turned into token-level `),Gs=r(P,"CODE",{});var fg=i(Gs);$c=s(fg,"labels"),fg.forEach(o),Ec=s(P,"."),P.forEach(o),Ar=p(t),B=r(t,"P",{});var ue=i(B);Mn=r(ue,"A",{href:!0});var gg=i(Mn);qc=s(gg,"LayoutLMv2Processor"),gg.forEach(o),zc=s(ue," uses "),Jt=r(ue,"A",{href:!0,rel:!0});var _g=i(Jt);jc=s(_g,"PyTesseract"),_g.forEach(o),Fc=s(ue,`, a Python
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),$n=r(ue,"A",{href:!0});var vg=i($n);Pc=s(vg,"LayoutLMv2FeatureExtractor"),vg.forEach(o),Cc=s(ue," with "),Hs=r(ue,"CODE",{});var yg=i(Hs);Ic=s(yg,"apply_ocr"),yg.forEach(o),Ac=s(ue," set to "),Ks=r(ue,"CODE",{});var bg=i(Ks);Dc=s(bg,"False"),bg.forEach(o),Oc=s(ue,"."),ue.forEach(o),Dr=p(t),En=r(t,"P",{});var Lg=i(En);Nc=s(Lg,`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Lg.forEach(o),Or=p(t),qn=r(t,"P",{});var wg=i(qn);Xs=r(wg,"STRONG",{});var kg=i(Xs);Sc=s(kg,`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
True`),kg.forEach(o),wg.forEach(o),Nr=p(t),zn=r(t,"P",{});var xg=i(zn);Rc=s(xg,`This is the simplest case, in which the processor (actually the feature extractor) will perform OCR on the image to get
the words and normalized bounding boxes.`),xg.forEach(o),Sr=p(t),y(eo.$$.fragment,t),Rr=p(t),jn=r(t,"P",{});var Tg=i(jn);Ys=r(Tg,"STRONG",{});var Mg=i(Ys);Uc=s(Mg,"Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Mg.forEach(o),Tg.forEach(o),Ur=p(t),_e=r(t,"P",{});var is=i(_e);Bc=s(is,"In case one wants to do OCR themselves, one can initialize the feature extractor with "),Zs=r(is,"CODE",{});var $g=i(Zs);Wc=s($g,"apply_ocr"),$g.forEach(o),Vc=s(is,` set to
...
the processor.`),is.forEach(o),Br=p(t),y(to.$$.fragment,t),Wr=p(t),Fn=r(t,"P",{});var qg=i(Fn);ea=r(qg,"STRONG",{});var zg=i(ea);Hc=s(zg,"Use case 3: token classification (training), apply_ocr=False"),zg.forEach(o),qg.forEach(o),Vr=p(t),G=r(t,"P",{});var ke=i(G);Kc=s(ke,`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
initialize the tokenizer with `),na=r(ke,"CODE",{});var Pg=i(na);ep=s(Pg,"only_label_first_subword"),Pg.forEach(o),tp=s(ke," set to "),sa=r(ke,"CODE",{});var Cg=i(sa);op=s(Cg,"False"),Cg.forEach(o),np=s(ke,"."),ke.forEach(o),Qr=p(t),y(oo.$$.fragment,t),Gr=p(t),Pn=r(t,"P",{});var Ig=i(Pn);aa=r(Ig,"STRONG",{});var Ag=i(aa);sp=s(Ag,"Use case 4: visual question answering (inference), apply_ocr=True"),Ag.forEach(o),Ig.forEach(o),Hr=p(t),Cn=r(t,"P",{});var Dg=i(Cn);ap=s(Dg,`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. By default, the
processor will apply OCR on the image, and create [CLS] question tokens [SEP] word tokens [SEP].`),Dg.forEach(o),Kr=p(t),y(no.$$.fragment,t),Xr=p(t),In=r(t,"P",{});var Og=i(In);ra=r(Og,"STRONG",{});var Ng=i(ra);rp=s(Ng,"Use case 5: visual question answering (inference), apply_ocr=False"),Ng.forEach(o),Og.forEach(o),Yr=p(t),An=r(t,"P",{});var Sg=i(An);ip=s(Sg,`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. If you want to
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Sg.forEach(o),Zr=p(t),y(so.$$.fragment,t),Jr=p(t),qe=r(t,"H2",{class:!0});var $i=i(qe);Ke=r($i,"A",{id:!0,class:!0,href:!0});var Rg=i(Ke);ia=r(Rg,"SPAN",{});var Ug=i(ia);y(ao.$$.fragment,Ug),Ug.forEach(o),Rg.forEach(o),lp=p($i),la=r($i,"SPAN",{});var Bg=i(la);dp=s(Bg,"LayoutLMv2Config"),Bg.forEach(o),$i.forEach(o),ei=p(t),Y=r(t,"DIV",{class:!0});var vt=i(Y);y(ro.$$.fragment,vt),cp=p(vt),ze=r(vt,"P",{});var ls=i(ze);pp=s(ls,"This is the configuration class to store the configuration of a "),Dn=r(ls,"A",{href:!0});var Wg=i(Dn);up=s(Wg,"LayoutLMv2Model"),Wg.forEach(o),mp=s(ls,`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
...
to apply OCR on them in order to get a list of words and normalized bounding boxes.`),Yg.forEach(o),$p=p(yt),po=r(yt,"P",{});var qi=i(po);Ep=s(qi,"This feature extractor inherits from "),ua=r(qi,"CODE",{});var Zg=i(ua);qp=s(Zg,"PreTrainedFeatureExtractor()"),Zg.forEach(o),zp=s(qi,` which contains most
of the main methods. Users should refer to this superclass for more information regarding those methods.`),qi.forEach(o),jp=p(yt),ve=r(yt,"DIV",{class:!0});var cs=i(ve);y(uo.$$.fragment,cs),Fp=p(cs),ma=r(cs,"P",{});var Jg=i(ma);Pp=s(Jg,"Main method to prepare for the model one or several image(s)."),Jg.forEach(o),Cp=p(cs),y(Ze.$$.fragment,cs),cs.forEach(o),yt.forEach(o),ni=p(t),Pe=r(t,"H2",{class:!0});var zi=i(Pe);Je=r(zi,"A",{id:!0,class:!0,href:!0});var e_=i(Je);ha=r(e_,"SPAN",{});var t_=i(ha);y(mo.$$.fragment,t_),t_.forEach(o),e_.forEach(o),Ip=p(zi),fa=r(zi,"SPAN",{});var o_=i(fa);Ap=s(o_,"LayoutLMv2Tokenizer"),o_.forEach(o),zi.forEach(o),si=p(t),N=r(t,"DIV",{class:!0});var le=i(N);y(ho.$$.fragment,le),Dp=p(le),S=r(le,"P",{});var H=i(S);Op=s(H,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Sn=r(H,"A",{href:!0});var n_=i(Sn);Np=s(n_,"LayoutLMv2Tokenizer"),n_.forEach(o),Sp=s(H,` can be used to turn words, word-level
bounding boxes and optional word labels to token-level `),ga=r(H,"CODE",{});var s_=i(ga);Rp=s(s_,"input_ids"),s_.forEach(o),Up=s(H,", "),_a=r(H,"CODE",{});var a_=i(_a);Bp=s(a_,"attention_mask"),a_.forEach(o),Wp=s(H,", "),va=r(H,"CODE",{});var r_=i(va);Vp=s(r_,"token_type_ids"),r_.forEach(o),Qp=s(H,", "),ya=r(H,"CODE",{});var i_=i(ya);Gp=s(i_,"bbox"),i_.forEach(o),Hp=s(H,`, and
...
this superclass for more information regarding those methods.`),ji.forEach(o),tu=p(le),Un=r(le,"P",{});var sf=i(Un);Bn=r(sf,"A",{href:!0});var c_=i(Bn);ou=s(c_,"LayoutLMv2Tokenizer"),c_.forEach(o),nu=s(sf,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
...
sequences with word-level normalized bounding boxes and optional labels.`),p_.forEach(o),Fi.forEach(o),iu=p(le),Wn=r(le,"DIV",{class:!0});var u_=i(Wn);y(_o.$$.fragment,u_),u_.forEach(o),le.forEach(o),ai=p(t),Ce=r(t,"H2",{class:!0});var Pi=i(Ce);tt=r(Pi,"A",{id:!0,class:!0,href:!0});var m_=i(tt);wa=r(m_,"SPAN",{});var h_=i(wa);y(vo.$$.fragment,h_),h_.forEach(o),m_.forEach(o),lu=p(Pi),ka=r(Pi,"SPAN",{});var f_=i(ka);du=s(f_,"LayoutLMv2TokenizerFast"),f_.forEach(o),Pi.forEach(o),ri=p(t),J=r(t,"DIV",{class:!0});var bt=i(J);y(yo.$$.fragment,bt),cu=p(bt),bo=r(bt,"P",{});var Ci=i(bo);pu=s(Ci,"Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),xa=r(Ci,"EM",{});var g_=i(xa);uu=s(g_,"tokenizers"),g_.forEach(o),mu=s(Ci," library). Based on WordPiece."),Ci.forEach(o),hu=p(bt),Lo=r(bt,"P",{});var Ii=i(Lo);fu=s(Ii,"This tokenizer inherits from "),Vn=r(Ii,"A",{href:!0});var __=i(Vn);gu=s(__,"PreTrainedTokenizerFast"),__.forEach(o),_u=s(Ii,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Ii.forEach(o),vu=p(bt),ot=r(bt,"DIV",{class:!0});var Ai=i(ot);y(wo.$$.fragment,Ai),yu=p(Ai),Ta=r(Ai,"P",{});var v_=i(Ta);bu=s(v_,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),v_.forEach(o),Ai.forEach(o),bt.forEach(o),ii=p(t),Ie=r(t,"H2",{class:!0});var Di=i(Ie);nt=r(Di,"A",{id:!0,class:!0,href:!0});var y_=i(nt);Ma=r(y_,"SPAN",{});var b_=i(Ma);y(ko.$$.fragment,b_),b_.forEach(o),y_.forEach(o),Lu=p(Di),$a=r(Di,"SPAN",{});var L_=i($a);wu=s(L_,"LayoutLMv2Processor"),L_.forEach(o),Di.forEach(o),li=p(t),W=r(t,"DIV",{class:!0});var xe=i(W);y(xo.$$.fragment,xe),ku=p(xe),Ea=r(xe,"P",{});var w_=i(Ea);xu=s(w_,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),w_.forEach(o),Tu=p(xe),Qn=r(xe,"P",{});var af=i(Qn);Gn=r(af,"A",{href:!0});var k_=i(Gn);Mu=s(k_,"LayoutLMv2Processor"),k_.forEach(o),$u=s(af," offers all the functionalities you need to prepare data for the model."),af.forEach(o),Eu=p(xe),F=r(xe,"P",{});var C=i(F);qu=s(C,"It first uses "),Hn=r(C,"A",{href:!0});var x_=i(Hn);zu=s(x_,"LayoutLMv2FeatureExtractor"),x_.forEach(o),ju=s(C,` to resize document images to a fixed size, and optionally applies OCR
...
`),Xn=r(C,"A",{href:!0});var M_=i(Xn);Cu=s(M_,"LayoutLMv2TokenizerFast"),M_.forEach(o),Iu=s(C,", which turns the words and bounding boxes into token-level "),qa=r(C,"CODE",{});var $_=i(qa);Au=s($_,"input_ids"),$_.forEach(o),Du=s(C,`,
`),za=r(C,"CODE",{});var E_=i(za);Ou=s(E_,"attention_mask"),E_.forEach(o),Nu=s(C,", "),ja=r(C,"CODE",{});var q_=i(ja);Su=s(q_,"token_type_ids"),q_.forEach(o),Ru=s(C,", "),Fa=r(C,"CODE",{});var z_=i(Fa);Uu=s(z_,"bbox"),z_.forEach(o),Bu=s(C,". Optionally, one can provide integer "),Pa=r(C,"CODE",{});var j_=i(Pa);Wu=s(j_,"word_labels"),j_.forEach(o),Vu=s(C,`, which are turned
into token-level `),Ca=r(C,"CODE",{});var F_=i(Ca);Qu=s(F_,"labels"),F_.forEach(o),Gu=s(C," for token classification tasks (such as FUNSD, CORD)."),C.forEach(o),Hu=p(xe),ye=r(xe,"DIV",{class:!0});var ps=i(ye);y(To.$$.fragment,ps),Ku=p(ps),$=r(ps,"P",{});var z=i($);Xu=s(z,"This method first forwards the "),Ia=r(z,"CODE",{});var P_=i(Ia);Yu=s(P_,"images"),P_.forEach(o),Zu=s(z," argument to "),Mo=r(z,"A",{href:!0});var rf=i(Mo);Aa=r(rf,"STRONG",{});var C_=i(Aa);Ju=s(C_,"call"),C_.forEach(o),em=s(rf,"()"),rf.forEach(o),tm=s(z,`. In case
`),Yn=r(z,"A",{href:!0});var I_=i(Yn);om=s(I_,"LayoutLMv2FeatureExtractor"),I_.forEach(o),nm=s(z," was initialized with "),Da=r(z,"CODE",{});var A_=i(Da);sm=s(A_,"apply_ocr"),A_.forEach(o),am=s(z," set to "),Oa=r(z,"CODE",{});var D_=i(Oa);rm=s(D_,"True"),D_.forEach(o),im=s(z,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),$o=r(z,"A",{href:!0});var lf=i($o);Na=r(lf,"STRONG",{});var O_=i(Na);lm=s(O_,"call"),O_.forEach(o),dm=s(lf,"()"),lf.forEach(o),cm=s(z,` and returns the output,
together with resized `),Sa=r(z,"CODE",{});var N_=i(Sa);pm=s(N_,"images"),N_.forEach(o),um=s(z,". In case "),Zn=r(z,"A",{href:!0});var S_=i(Zn);mm=s(S_,"LayoutLMv2FeatureExtractor"),S_.forEach(o),hm=s(z," was initialized with "),Ra=r(z,"CODE",{});var R_=i(Ra);fm=s(R_,"apply_ocr"),R_.forEach(o),gm=s(z,` set to
`),Ua=r(z,"CODE",{});var U_=i(Ua);_m=s(U_,"False"),U_.forEach(o),vm=s(z,", it passes the words ("),Ba=r(z,"CODE",{});var B_=i(Ba);ym=s(B_,"text"),B_.forEach(o),bm=s(z,"/"),Wa=r(z,"CODE",{});var W_=i(Wa);Lm=s(W_,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_17457/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),W_.forEach(o),wm=s(z,"."),z.forEach(o),km=p(ps),Va=r(ps,"P",{});var V_=i(Va);xm=s(V_,"Please refer to the docstring of the above two methods for more information."),V_.forEach(o),ps.forEach(o),xe.forEach(o),di=p(t),Ae=r(t,"H2",{class:!0});var Oi=i(Ae);st=r(Oi,"A",{id:!0,class:!0,href:!0});var Q_=i(st);Qa=r(Q_,"SPAN",{});var G_=i(Qa);y(Eo.$$.fragment,G_),G_.forEach(o),Q_.forEach(o),Tm=p(Oi),Ga=r(Oi,"SPAN",{});var H_=i(Ga);Mm=s(H_,"LayoutLMv2Model"),H_.forEach(o),Oi.forEach(o),ci=p(t),ce=r(t,"DIV",{class:!0});var us=i(ce);y(qo.$$.fragment,us),$m=p(us),zo=r(us,"P",{});var Ni=i(zo);Em=s(Ni,`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),jo=r(Ni,"A",{href:!0,rel:!0});var K_=i(jo);qm=s(K_,"torch.nn.Module"),K_.forEach(o),zm=s(Ni,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ni.forEach(o),jm=p(us),ae=r(us,"DIV",{class:!0});var Lt=i(ae);y(Fo.$$.fragment,Lt),Fm=p(Lt),De=r(Lt,"P",{});var ms=i(De);Pm=s(ms,"The "),Jn=r(ms,"A",{href:!0});var X_=i(Jn);Cm=s(X_,"LayoutLMv2Model"),X_.forEach(o),Im=s(ms," forward method, overrides the "),Ha=r(ms,"CODE",{});var Y_=i(Ha);Am=s(Y_,"__call__"),Y_.forEach(o),Dm=s(ms," special method."),ms.forEach(o),Om=p(Lt),y(at.$$.fragment,Lt),Nm=p(Lt),y(rt.$$.fragment,Lt),Lt.forEach(o),us.forEach(o),pi=p(t),Oe=r(t,"H2",{class:!0});var Si=i(Oe);it=r(Si,"A",{id:!0,class:!0,href:!0});var Z_=i(it);Ka=r(Z_,"SPAN",{});var J_=i(Ka);y(Po.$$.fragment,J_),J_.forEach(o),Z_.forEach(o),Sm=p(Si),Xa=r(Si,"SPAN",{});var ev=i(Xa);Rm=s(ev,"LayoutLMv2ForSequenceClassification"),ev.forEach(o),Si.forEach(o),ui=p(t),ee=r(t,"DIV",{class:!0});var wt=i(ee);y(Co.$$.fragment,wt),Um=p(wt),Io=r(wt,"P",{});var Ri=i(Io);Bm=s(Ri,`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
`),Ao=r(Ri,"A",{href:!0,rel:!0});var tv=i(Ao);Wm=s(tv,"RVL-CDIP"),tv.forEach(o),Vm=s(Ri," dataset."),Ri.forEach(o),Qm=p(wt),Do=r(wt,"P",{});var Ui=i(Do);Gm=s(Ui,"This model is a PyTorch "),Oo=r(Ui,"A",{href:!0,rel:!0});var ov=i(Oo);Hm=s(ov,"torch.nn.Module"),ov.forEach(o),Km=s(Ui,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ui.forEach(o),Xm=p(wt),re=r(wt,"DIV",{class:!0});var kt=i(re);y(No.$$.fragment,kt),Ym=p(kt),Ne=r(kt,"P",{});var hs=i(Ne);Zm=s(hs,"The "),es=r(hs,"A",{href:!0});var nv=i(es);Jm=s(nv,"LayoutLMv2ForSequenceClassification"),nv.forEach(o),eh=s(hs," forward method, overrides the "),Ya=r(hs,"CODE",{});var sv=i(Ya);th=s(sv,"__call__"),sv.forEach(o),oh=s(hs," special method."),hs.forEach(o),nh=p(kt),y(lt.$$.fragment,kt),sh=p(kt),y(dt.$$.fragment,kt),kt.forEach(o),wt.forEach(o),mi=p(t),Se=r(t,"H2",{class:!0});var Bi=i(Se);ct=r(Bi,"A",{id:!0,class:!0,href:!0});var av=i(ct);Za=r(av,"SPAN",{});var rv=i(Za);y(So.$$.fragment,rv),rv.forEach(o),av.forEach(o),ah=p(Bi),Ja=r(Bi,"SPAN",{});var iv=i(Ja);rh=s(iv,"LayoutLMv2ForTokenClassification"),iv.forEach(o),Bi.forEach(o),hi=p(t),te=r(t,"DIV",{class:!0});var xt=i(te);y(Ro.$$.fragment,xt),ih=p(xt),oe=r(xt,"P",{});var Te=i(oe);lh=s(Te,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
`),Uo=r(Te,"A",{href:!0,rel:!0});var lv=i(Uo);dh=s(lv,"FUNSD"),lv.forEach(o),ch=s(Te,", "),Bo=r(Te,"A",{href:!0,rel:!0});var dv=i(Bo);ph=s(dv,"SROIE"),dv.forEach(o),uh=s(Te,`,
`),Wo=r(Te,"A",{href:!0,rel:!0});var cv=i(Wo);mh=s(cv,"CORD"),cv.forEach(o),hh=s(Te," and "),Vo=r(Te,"A",{href:!0,rel:!0});var pv=i(Vo);fh=s(pv,"Kleister-NDA"),pv.forEach(o),gh=s(Te,"."),Te.forEach(o),_h=p(xt),Qo=r(xt,"P",{});var Wi=i(Qo);vh=s(Wi,"This model is a PyTorch "),Go=r(Wi,"A",{href:!0,rel:!0});var uv=i(Go);yh=s(uv,"torch.nn.Module"),uv.forEach(o),bh=s(Wi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wi.forEach(o),Lh=p(xt),ie=r(xt,"DIV",{class:!0});var Tt=i(ie);y(Ho.$$.fragment,Tt),wh=p(Tt),Re=r(Tt,"P",{});var fs=i(Re);kh=s(fs,"The "),ts=r(fs,"A",{href:!0});var mv=i(ts);xh=s(mv,"LayoutLMv2ForTokenClassification"),mv.forEach(o),Th=s(fs," forward method, overrides the "),er=r(fs,"CODE",{});var hv=i(er);Mh=s(hv,"__call__"),hv.forEach(o),$h=s(fs," special method."),fs.forEach(o),Eh=p(Tt),y(pt.$$.fragment,Tt),qh=p(Tt),y(ut.$$.fragment,Tt),Tt.forEach(o),xt.forEach(o),fi=p(t),Ue=r(t,"H2",{class:!0});var Vi=i(Ue);mt=r(Vi,"A",{id:!0,class:!0,href:!0});var fv=i(mt);tr=r(fv,"SPAN",{});var gv=i(tr);y(Ko.$$.fragment,gv),gv.forEach(o),fv.forEach(o),zh=p(Vi),or=r(Vi,"SPAN",{});var _v=i(or);jh=s(_v,"LayoutLMv2ForQuestionAnswering"),_v.forEach(o),Vi.forEach(o),gi=p(t),ne=r(t,"DIV",{class:!0});var Mt=i(ne);y(Xo.$$.fragment,Mt),Fh=p(Mt),pe=r(Mt,"P",{});var $t=i(pe);Ph=s($t,`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
