import{S as vi,i as wi,s as bi,e as n,k as d,w as _,t as a,M as Ti,c as s,d as t,m as c,a as r,x as y,h as i,b as l,F as e,g as h,y as k,q as v,o as w,B as b}from"../../chunks/vendor-4833417e.js";import{T as Ko}from"../../chunks/Tip-fffd6df1.js";import{D as O}from"../../chunks/Docstring-44c5af16.js";import{C as je}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as he}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Ni(q){let m,N,f,T,$;return{c(){m=n("p"),N=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),$=a(`
...
the latter silently ignores them.`)},l(g){m=s(g,"P",{});var u=r(m);N=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var M=r(f);T=i(M,"Module"),M.forEach(t),$=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(g,u){h(g,m,u),e(m,N),e(m,f),e(f,T),e(m,$)},d(g){g&&t(m)}}}function Ci(q){let m,N,f,T,$,g,u,M,wn,Wt,Y,ue,Xo,Pe,bn,et,Tn,Bt,ge,Nn,Se,ot,$n,Mn,Qt,qo,zn,Ht,Fo,tt,qn,Ut,Q,Fn,Le,Cn,xn,Ie,An,En,Rt,Z,_e,nt,De,jn,st,Pn,Vt,F,Oe,Sn,K,Ln,Co,In,Dn,We,On,Wn,Bn,X,Qn,xo,Hn,Un,Ao,Rn,Vn,Gn,rt,Jn,Yn,Be,Gt,ee,ye,at,Qe,Zn,it,Kn,Jt,W,He,Xn,Ue,es,Re,os,ts,ns,C,Ve,ss,oe,rs,Eo,as,is,lt,ls,ds,cs,ke,ms,dt,ps,fs,Ge,Yt,te,ve,ct,Je,hs,mt,us,Zt,B,Ye,gs,ne,_s,pt,ys,ks,Ze,vs,ws,bs,x,Ke,Ts,se,Ns,jo,$s,Ms,ft,zs,qs,Fs,we,Cs,ht,xs,As,Xe,Kt,re,be,ut,eo,Es,gt,js,Xt,S,oo,Ps,_t,Ss,Ls,to,Is,no,Ds,Os,Ws,z,so,Bs,ae,Qs,Po,Hs,Us,yt,Rs,Vs,Gs,Te,Js,kt,Ys,Zs,ro,Ks,vt,Xs,er,ao,en,ie,Ne,wt,io,or,bt,tr,on,L,lo,nr,Tt,sr,rr,co,ar,mo,ir,lr,dr,A,po,cr,le,mr,So,pr,fr,Nt,hr,ur,gr,$e,_r,$t,yr,kr,fo,tn,de,Me,Mt,ho,vr,zt,wr,nn,I,uo,br,qt,Tr,Nr,go,$r,_o,Mr,zr,qr,E,yo,Fr,ce,Cr,Lo,xr,Ar,Ft,Er,jr,Pr,ze,Sr,Ct,Lr,Ir,ko,sn,me,qe,xt,vo,Dr,At,Or,rn,D,wo,Wr,pe,Br,Et,Qr,Hr,jt,Ur,Rr,Vr,bo,Gr,To,Jr,Yr,Zr,j,No,Kr,fe,Xr,Io,ea,oa,Pt,ta,na,sa,Fe,ra,St,aa,ia,$o,an;return g=new he({}),Pe=new he({}),De=new he({}),Oe=new O({props:{name:"class transformers.NystromformerConfig",anchor:"transformers.NystromformerConfig",parameters:[{name:"vocab_size",val:" = 30000"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu_new'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 510"},{name:"type_vocab_size",val:" = 2"},{name:"segment_means_seq_len",val:" = 64"},{name:"num_landmarks",val:" = 64"},{name:"conv_kernel_size",val:" = 65"},{name:"inv_coeff_init_option",val:" = False"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15836/src/transformers/models/nystromformer/configuration_nystromformer.py#L29",parametersDescription:[{anchor:"transformers.NystromformerConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30000) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_15836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ve=new O({props:{name:"forward",anchor:"transformers.NystromformerModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15836/src/transformers/models/nystromformer/modeling_nystromformer.py#L581",parametersDescription:[{anchor:"transformers.NystromformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15836/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15836/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15836/en/model_doc/nystromformer#transformers.NystromformerConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),so=new O({props:{name:"forward",anchor:"transformers.NystromformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15836/src/transformers/models/nystromformer/modeling_nystromformer.py#L782",parametersDescription:[{anchor:"transformers.NystromformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15836/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),po=new O({props:{name:"forward",anchor:"transformers.NystromformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15836/src/transformers/models/nystromformer/modeling_nystromformer.py#L877",parametersDescription:[{anchor:"transformers.NystromformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15836/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new O({props:{name:"forward",anchor:"transformers.NystromformerForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15836/src/transformers/models/nystromformer/modeling_nystromformer.py#L974",parametersDescription:[{anchor:"transformers.NystromformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15836/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new O({props:{name:"forward",anchor:"transformers.NystromformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15836/src/transformers/models/nystromformer/modeling_nystromformer.py#L1054",parametersDescription:[{anchor:"transformers.NystromformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15836/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Ut=d(),Q=n("p"),Fn=a("This model was contributed by "),Le=n("a"),Cn=a("novice03"),xn=a(". The original code can be found "),Ie=n("a"),An=a("here"),En=a("."),Rt=d(),Z=n("h2"),_e=n("a"),nt=n("span"),_(De.$$.fragment),jn=d(),st=n("span"),Pn=a("NystromformerConfig"),Vt=d(),F=n("div"),_(Oe.$$.fragment),Sn=d(),K=n("p"),Ln=a("This is the configuration class to store the configuration of a "),Co=n("a"),In=a("NystromformerModel"),Dn=a(`. It is used to instantiate
...
`),We=n("a"),On=a("uw-madison/nystromformer-512"),Wn=a(" architecture."),Bn=d(),X=n("p"),Qn=a("Configuration objects inherit from "),xo=n("a"),Hn=a("PretrainedConfig"),Un=a(` and can be used to control the model outputs. Read the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),bs=d(),x=n("div"),_(Ke.$$.fragment),Ts=d(),se=n("p"),Ns=a("The "),jo=n("a"),$s=a("NystromformerForMaskedLM"),Ms=a(" forward method, overrides the "),ft=n("code"),zs=a("__call__"),qs=a(" special method."),Fs=d(),_(we.$$.fragment),Cs=d(),ht=n("p"),xs=a("Example:"),As=d(),_(Xe.$$.fragment),Kt=d(),re=n("h2"),be=n("a"),ut=n("span"),_(eo.$$.fragment),Es=d(),gt=n("span"),js=a("NystromformerForSequenceClassification"),Xt=d(),S=n("div"),_(oo.$$.fragment),Ps=d(),_t=n("p"),Ss=a(`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qr=d(),E=n("div"),_(yo.$$.fragment),Fr=d(),ce=n("p"),Cr=a("The "),Lo=n("a"),xr=a("NystromformerForTokenClassification"),Ar=a(" forward method, overrides the "),Ft=n("code"),Er=a("__call__"),jr=a(" special method."),Pr=d(),_(ze.$$.fragment),Sr=d(),Ct=n("p"),Lr=a("Example:"),Ir=d(),_(ko.$$.fragment),sn=d(),me=n("h2"),qe=n("a"),xt=n("span"),_(vo.$$.fragment),Dr=d(),At=n("span"),Or=a("NystromformerForQuestionAnswering"),rn=d(),D=n("div"),_(wo.$$.fragment),Wr=d(),pe=n("p"),Br=a(`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),hn.forEach(t),Ws=c(Ce),z=s(Ce,"DIV",{class:!0});var P=r(z);y(so.$$.fragment,P),Bs=c(P),ae=s(P,"P",{});var Vo=r(ae);Qs=i(Vo,"The "),Po=s(Vo,"A",{href:!0});var Ua=r(Po);Hs=i(Ua,"NystromformerForSequenceClassification"),Ua.forEach(t),Us=i(Vo," forward method, overrides the "),yt=s(Vo,"CODE",{});var Ra=r(yt);Rs=i(Ra,"__call__"),Ra.forEach(t),Vs=i(Vo," special method."),Vo.forEach(t),Gs=c(P),y(Te.$$.fragment,P),Js=c(P),kt=s(P,"P",{});var Va=r(kt);Ys=i(Va,"Example of single-label classification:"),Va.forEach(t),Zs=c(P),y(ro.$$.fragment,P),Ks=c(P),vt=s(P,"P",{});var Ga=r(vt);Xs=i(Ga,"Example of multi-label classification:"),Ga.forEach(t),er=c(P),y(ao.$$.fragment,P),P.forEach(t),Ce.forEach(t),en=c(o),ie=s(o,"H2",{class:!0});var un=r(ie);Ne=s(un,"A",{id:!0,class:!0,href:!0});var Ja=r(Ne);wt=s(Ja,"SPAN",{});var Ya=r(wt);y(io.$$.fragment,Ya),Ya.forEach(t),Ja.forEach(t),or=c(un),bt=s(un,"SPAN",{});var Za=r(bt);tr=i(Za,"NystromformerForMultipleChoice"),Za.forEach(t),un.forEach(t),on=c(o),L=s(o,"DIV",{class:!0});var xe=r(L);y(lo.$$.fragment,xe),nr=c(xe),Tt=s(xe,"P",{});var Ka=r(Tt);sr=i(Ka,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Ka.forEach(t),rr=c(xe),co=s(xe,"P",{});var gn=r(co);ar=i(gn,"This model is a PyTorch "),mo=s(gn,"A",{href:!0,rel:!0});var Xa=r(mo);ir=i(Xa,"torch.nn.Module"),Xa.forEach(t),lr=i(gn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),gn.forEach(t),dr=c(xe),A=s(xe,"DIV",{class:!0});var V=r(A);y(po.$$.fragment,V),cr=c(V),le=s(V,"P",{});var Go=r(le);mr=i(Go,"The "),So=s(Go,"A",{href:!0});var ei=r(So);pr=i(ei,"NystromformerForMultipleChoice"),ei.forEach(t),fr=i(Go," forward method, overrides the "),Nt=s(Go,"CODE",{});var oi=r(Nt);hr=i(oi,"__call__"),oi.forEach(t),ur=i(Go," special method."),Go.forEach(t),gr=c(V),y($e.$$.fragment,V),_r=c(V),$t=s(V,"P",{});var ti=r($t);yr=i(ti,"Example:"),ti.forEach(t),kr=c(V),y(fo.$$.fragment,V),V.forEach(t),xe.forEach(t),tn=c(o),de=s(o,"H2",{class:!0});var _n=r(de);Me=s(_n,"A",{id:!0,class:!0,href:!0});var ni=r(Me);Mt=s(ni,"SPAN",{});var si=r(Mt);y(ho.$$.fragment,si),si.forEach(t),ni.forEach(t),vr=c(_n),zt=s(_n,"SPAN",{});var ri=r(zt);wr=i(ri,"NystromformerForTokenClassification"),ri.forEach(t),_n.forEach(t),nn=c(o),I=s(o,"DIV",{class:!0});var Ae=r(I);y(uo.$$.fragment,Ae),br=c(Ae),qt=s(Ae,"P",{});var ai=r(qt);Tr=i(ai,`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),yn.forEach(t),qr=c(Ae),E=s(Ae,"DIV",{class:!0});var G=r(E);y(yo.$$.fragment,G),Fr=c(G),ce=s(G,"P",{});var Jo=r(ce);Cr=i(Jo,"The "),Lo=s(Jo,"A",{href:!0});var li=r(Lo);xr=i(li,"NystromformerForTokenClassification"),li.forEach(t),Ar=i(Jo," forward method, overrides the "),Ft=s(Jo,"CODE",{});var di=r(Ft);Er=i(di,"__call__"),di.forEach(t),jr=i(Jo," special method."),Jo.forEach(t),Pr=c(G),y(ze.$$.fragment,G),Sr=c(G),Ct=s(G,"P",{});var ci=r(Ct);Lr=i(ci,"Example:"),ci.forEach(t),Ir=c(G),y(ko.$$.fragment,G),G.forEach(t),Ae.forEach(t),sn=c(o),me=s(o,"H2",{class:!0});var kn=r(me);qe=s(kn,"A",{id:!0,class:!0,href:!0});var mi=r(qe);xt=s(mi,"SPAN",{});var pi=r(xt);y(vo.$$.fragment,pi),pi.forEach(t),mi.forEach(t),Dr=c(kn),At=s(kn,"SPAN",{});var fi=r(At);Or=i(fi,"NystromformerForQuestionAnswering"),fi.forEach(t),kn.forEach(t),rn=c(o),D=s(o,"DIV",{class:!0});var Ee=r(D);y(wo.$$.fragment,Ee),Wr=c(Ee),pe=s(Ee,"P",{});var Yo=r(pe);Br=i(Yo,`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
