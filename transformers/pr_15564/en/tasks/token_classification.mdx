...
<h1 id="token-classification">Token classification</h1>
...
<h2 id="load-wnut-17-dataset">Load WNUT 17 dataset</h2>
...
Each label number in `ner_tags` represents an entity. Convert the label number to a label name for more information:
...
Use [DataCollatorForTokenClassification](/docs/transformers/pr_15564/en/main_classes/data_collator#transformers.DataCollatorForTokenClassification) to create a batch of examples. It will also *dynamically pad* your text and labels to the length of the longest element in its batch, so they are a uniform length. While it is possible to pad your text in the `tokenizer` function by setting `padding=True`, dynamic padding is more efficient.
...
Load DistilBERT with [AutoModelForTokenClassification](/docs/transformers/pr_15564/en/model_doc/auto#transformers.AutoModelForTokenClassification) along with the number of expected labels:
...
When you create a batch with [DataCollatorWithPadding](/docs/transformers/pr_15564/en/main_classes/data_collator#transformers.DataCollatorWithPadding), instruct the data collator to return `tf.Tensor`'s instead of PyTorch tensors:
...
Load DistilBERT with [TFAutoModelForTokenClassification](/docs/transformers/pr_15564/en/model_doc/auto#transformers.TFAutoModelForTokenClassification) along with the number of expected labels:
