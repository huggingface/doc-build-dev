...
Use [DefaultDataCollator](/docs/transformers/pr_15564/en/main_classes/data_collator#transformers.DefaultDataCollator) to create a batch of examples. Unlike other data collators in 🤗 Transformers, the `DefaultDataCollator` does not apply additional preprocessing such as padding.
...
When you create a batch with [DefaultDataCollator](/docs/transformers/pr_15564/en/main_classes/data_collator#transformers.DefaultDataCollator), instruct the data collator to return `tf.Tensor`'s instead of PyTorch tensors:
