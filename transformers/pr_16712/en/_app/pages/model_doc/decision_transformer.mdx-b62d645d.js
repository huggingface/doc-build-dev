...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),te=new Ie({}),oe=new Fe({props:{name:"class transformers.DecisionTransformerGPT2Model",anchor:"transformers.DecisionTransformerGPT2Model",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16712/src/transformers/models/decision_transformer/modeling_decision_transformer.py#L478"}}),re=new Fe({props:{name:"forward",anchor:"transformers.DecisionTransformerGPT2Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16712/src/transformers/models/decision_transformer/modeling_decision_transformer.py#L510"}}),ne=new Ie({}),se=new Fe({props:{name:"class transformers.DecisionTransformerModel",anchor:"transformers.DecisionTransformerModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16712/src/transformers/models/decision_transformer/modeling_decision_transformer.py#L799",parametersDescription:[{anchor:"transformers.DecisionTransformerModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16712/en/model_doc/decision_transformer#transformers.DecisionTransformerConfig">~DecisionTransformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16712/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),le=new Fe({props:{name:"forward",anchor:"transformers.DecisionTransformerModel.forward",parameters:[{name:"states",val:" = None"},{name:"actions",val:" = None"},{name:"rewards",val:" = None"},{name:"returns_to_go",val:" = None"},{name:"timesteps",val:" = None"},{name:"attention_mask",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_attentions",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16712/src/transformers/models/decision_transformer/modeling_decision_transformer.py#L832",parametersDescription:[{anchor:"transformers.DecisionTransformerModel.forward.states",description:`<strong>states</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, episode_length, state_dim)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16712/en/model_doc/decision_transformer#transformers.DecisionTransformerConfig"
...
Atari, OpenAI Gym, and Key-to-Door tasks.`),Ke=d(),pe=r("p"),_t=i("Tips:"),Ue=d(),ue=r("p"),vt=i("This version of the model is for tasks where the state is a vector, image-based states will come soon."),Ve=d(),x=r("p"),Tt=i("This model was contributed by "),J=r("a"),bt=i("edbeeching"),wt=i(". The original code can be found "),Q=r("a"),yt=i("here"),Dt=i("."),We=d(),A=r("h2"),O=r("a"),Ee=r("span"),T(X.$$.fragment),$t=d(),Me=r("span"),jt=i("DecisionTransformerConfig"),Je=d(),u=r("div"),T(Y.$$.fragment),kt=d(),Z=r("p"),xt=i("This is the configuration class to store the configuration of a "),ge=r("a"),Et=i("DecisionTransformerModel"),Mt=i(`. It is used to
...
setting. Refer to the paper for more details: `),ce=r("a"),Qt=i("https://arxiv.org/abs/2106.01345"),Xt=d(),g=r("div"),T(le.$$.fragment),Yt=d(),F=r("p"),Zt=i("The "),we=r("a"),eo=i("DecisionTransformerModel"),to=i(" forward method, overrides the "),qe=r("code"),oo=i("__call__"),ro=i(" special method."),no=d(),T(K.$$.fragment),so=d(),Le=r("p"),ao=i("Examples:"),io=d(),T(de.$$.fragment),this.h()},l(e){const l=Vo('[data-svelte="svelte-1phssyn"]',document.head);h=n(l,"META",{name:!0,content:!0}),l.forEach(o),I=m(e),p=n(e,"H1",{class:!0});var me=s(p);j=n(me,"A",{id:!0,class:!0,href:!0});var lo=s(j);P=n(lo,"SPAN",{});var mo=s(P);b(_.$$.fragment,mo),mo.forEach(o),lo.forEach(o),k=m(me),G=n(me,"SPAN",{});var fo=s(G);ct=c(fo,"Decision Transformer"),fo.forEach(o),me.forEach(o),Se=m(e),C=n(e,"H2",{class:!0});var tt=s(C);S=n(tt,"A",{id:!0,class:!0,href:!0});var ho=s(S);je=n(ho,"SPAN",{});var po=s(je);b(V.$$.fragment,po),po.forEach(o),ho.forEach(o),lt=m(tt),ke=n(tt,"SPAN",{});var uo=s(ke);dt=c(uo,"Overview"),uo.forEach(o),tt.forEach(o),Oe=m(e),z=n(e,"P",{});var Re=s(z);mt=c(Re,"The Decision Transformer model was proposed in "),W=n(Re,"A",{href:!0,rel:!0});var go=s(W);ft=c(go,"Decision Transformer: Reinforcement Learning via Sequence Modeling"),go.forEach(o),ht=n(Re,"BR",{}),pt=c(Re,`
by Lili Chen, Kevin Lu, Aravind Rajeswaran, Kimin Lee, Aditya Grover, Michael Laskin, Pieter Abbeel, Aravind Srinivas, Igor Mordatch.`),Re.forEach(o),He=m(e),fe=n(e,"P",{});var _o=s(fe);ut=c(_o,"The abstract from the paper is the following:"),_o.forEach(o),Be=m(e),he=n(e,"P",{});var vo=s(he);xe=n(vo,"EM",{});var To=s(xe);gt=c(To,`We introduce a framework that abstracts Reinforcement Learning (RL) as a sequence modeling problem.
This allows us to draw upon the simplicity and scalability of the Transformer architecture, and associated advances
in language modeling such as GPT-x and BERT. In particular, we present Decision Transformer, an architecture that
casts the problem of RL as conditional sequence modeling. Unlike prior approaches to RL that fit value functions or
compute policy gradients, Decision Transformer simply outputs the optimal actions by leveraging a causally masked
...
Decision Transformer model can generate future actions that achieve the desired return. Despite its simplicity,
Decision Transformer matches or exceeds the performance of state-of-the-art model-free offline RL baselines on
Atari, OpenAI Gym, and Key-to-Door tasks.`),To.forEach(o),vo.forEach(o),Ke=m(e),pe=n(e,"P",{});var bo=s(pe);_t=c(bo,"Tips:"),bo.forEach(o),Ue=m(e),ue=n(e,"P",{});var wo=s(ue);vt=c(wo,"This version of the model is for tasks where the state is a vector, image-based states will come soon."),wo.forEach(o),Ve=m(e),x=n(e,"P",{});var ye=s(x);Tt=c(ye,"This model was contributed by "),J=n(ye,"A",{href:!0,rel:!0});var yo=s(J);bt=c(yo,"edbeeching"),yo.forEach(o),wt=c(ye,". The original code can be found "),Q=n(ye,"A",{href:!0,rel:!0});var Do=s(Q);yt=c(Do,"here"),Do.forEach(o),Dt=c(ye,"."),ye.forEach(o),We=m(e),A=n(e,"H2",{class:!0});var ot=s(A);O=n(ot,"A",{id:!0,class:!0,href:!0});var $o=s(O);Ee=n($o,"SPAN",{});var jo=s(Ee);b(X.$$.fragment,jo),jo.forEach(o),$o.forEach(o),$t=m(ot),Me=n(ot,"SPAN",{});var ko=s(Me);jt=c(ko,"DecisionTransformerConfig"),ko.forEach(o),ot.forEach(o),Je=m(e),u=n(e,"DIV",{class:!0});var E=s(u);b(Y.$$.fragment,E),kt=m(E),Z=n(E,"P",{});var rt=s(Z);xt=c(rt,"This is the configuration class to store the configuration of a "),ge=n(rt,"A",{href:!0});var xo=s(ge);Et=c(xo,"DecisionTransformerModel"),xo.forEach(o),Mt=c(rt,`. It is used to
instantiate a Decision Transformer model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the standard
DecisionTransformer architecture. Many of the config options are used to instatiate the GPT2 model that is used as
