...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){c=s("p"),v=n("Example:"),u=m(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=h(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function _i(z){let c,v,u,p,_,a,f,A,$n,Ut,ie,xn,xo,Mn,Dn,Ht,ce,zn,Pe,qn,jn,Yt,le,Fn,Mo,Pn,An,Jt,O,Cn,Do,Sn,Nn,Ae,In,Ln,Zt,V,Bn,pt,On,Vn,mt,Wn,Rn,Kt,Ce,Qt,W,Gn,Se,Un,Hn,Ne,Yn,Jn,Xt,J,pe,ht,Ie,Zn,ft,Kn,en,P,Le,Qn,me,zo,Xn,er,qo,or,tr,nr,Z,rr,jo,ar,sr,Fo,dr,ir,cr,he,lr,fe,Be,pr,Oe,mr,Po,hr,fr,ur,ue,Ve,gr,K,_r,ut,br,vr,gt,yr,kr,on,Q,ge,_t,We,Tr,bt,wr,tn,x,Re,Er,X,$r,Ao,xr,Mr,Co,Dr,zr,qr,Ge,jr,Ue,Fr,Pr,Ar,vt,Cr,Sr,He,Nr,So,Ir,Lr,Br,Ye,Or,Je,Vr,Wr,Rr,R,No,Gr,Ur,yt,Hr,Yr,kt,Jr,Zr,Kr,C,Ze,Qr,ee,Xr,Io,ea,oa,Tt,ta,na,ra,_e,aa,be,sa,S,Ke,da,wt,ia,ca,oe,la,Et,pa,ma,$t,ha,fa,ua,ve,nn,te,ye,xt,Qe,ga,Mt,_a,rn,M,Xe,ba,ne,va,Lo,ya,ka,Bo,Ta,wa,Ea,eo,$a,oo,xa,Ma,Da,Dt,za,qa,to,ja,Oo,Fa,Pa,Aa,no,Ca,ro,Sa,Na,Ia,G,Vo,La,Ba,Wo,Oa,Va,Ro,Wa,Ra,Ga,N,ao,Ua,re,Ha,Go,Ya,Ja,zt,Za,Ka,Qa,ke,Xa,Te,es,U,so,os,qt,ts,ns,we,an,ae,Ee,jt,io,rs,Ft,as,sn,D,co,ss,se,ds,Uo,is,cs,Ho,ls,ps,ms,lo,hs,po,fs,us,gs,Pt,_s,bs,mo,vs,Yo,ys,ks,Ts,ho,ws,fo,Es,$s,xs,H,Jo,Ms,Ds,At,zs,qs,Ct,js,Fs,Ps,I,uo,As,de,Cs,Zo,Ss,Ns,St,Is,Ls,Bs,$e,Os,xe,Vs,Y,go,Ws,Nt,Rs,Gs,Me,dn;return a=new Gt({}),Ce=new Fe({props:{code:`# a workaround to load from pytorch checkpoint
...
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_17824/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_17824/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),he=new Eo({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[di]},$$scope:{ctx:z}}}),Be=new B({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_17824/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Ve=new B({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17824/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_17824/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17824/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_17824/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L495",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17824/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_17824/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L332"}}),we=new Eo({props:{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[hi]},$$scope:{ctx:z}}}),io=new Gt({}),co=new B({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17824/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17824/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L628",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17824/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_17824/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
any other models (see the examples for more information).`),Jt=m(),O=s("p"),Cn=n("An application of this architecture could be to leverage two pretrained "),Do=s("a"),Sn=n("BertModel"),Nn=n(` as the encoder
and decoder for a summarization model as was shown in: `),Ae=s("a"),In=n("Text Summarization with Pretrained Encoders"),Ln=n(" by Yang Liu and Mirella Lapata."),Zt=m(),V=s("p"),Bn=n("The "),pt=s("code"),On=n("from_pretrained()"),Vn=n(` currently doesn\u2019t support initializing the model from a
...
(see the examples for more information).`),qa=m(),to=s("p"),ja=n("This model inherits from "),Oo=s("a"),Fa=n("TFPreTrainedModel"),Pa=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
encoder and :meth`),Ct=s("em"),js=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Fs=n(" class method for the decoder."),Ps=m(),I=s("div"),y(uo.$$.fragment),As=m(),de=s("p"),Cs=n("The "),Zo=s("a"),Ss=n("FlaxEncoderDecoderModel"),Ns=n(" forward method, overrides the "),St=s("code"),Is=n("__call__"),Ls=n(" special method."),Bs=m(),y($e.$$.fragment),Os=m(),y(xe.$$.fragment),Vs=m(),Y=s("div"),y(go.$$.fragment),Ws=m(),Nt=s("p"),Rs=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Gs=m(),y(Me.$$.fragment),this.h()},l(t){const g=ai('[data-svelte="svelte-1phssyn"]',document.head);c=d(g,"META",{name:!0,content:!0}),g.forEach(o),v=h(t),u=d(t,"H1",{class:!0});var _o=i(u);p=d(_o,"A",{id:!0,class:!0,href:!0});var It=i(p);_=d(It,"SPAN",{});var Lt=i(_);k(a.$$.fragment,Lt),Lt.forEach(o),It.forEach(o),f=h(_o),A=d(_o,"SPAN",{});var Bt=i(A);$n=r(Bt,"Encoder Decoder Models"),Bt.forEach(o),_o.forEach(o),Ut=h(t),ie=d(t,"P",{});var bo=i(ie);xn=r(bo,"The "),xo=d(bo,"A",{href:!0});var Ot=i(xo);Mn=r(Ot,"EncoderDecoderModel"),Ot.forEach(o),Dn=r(bo,` can be used to initialize a sequence-to-sequence model with any
...
any other models (see the examples for more information).`),yo.forEach(o),Jt=h(t),O=d(t,"P",{});var Ko=i(O);Cn=r(Ko,"An application of this architecture could be to leverage two pretrained "),Do=d(Ko,"A",{href:!0});var Hs=i(Do);Sn=r(Hs,"BertModel"),Hs.forEach(o),Nn=r(Ko,` as the encoder
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),un.forEach(o),Br=h(q),Ye=d(q,"P",{});var gn=i(Ye);Or=r(gn,"This model is also a PyTorch "),Je=d(gn,"A",{href:!0,rel:!0});var _d=i(Je);Vr=r(_d,"torch.nn.Module"),_d.forEach(o),Wr=r(gn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Lo=d(at,"A",{href:!0});var zd=i(Lo);ya=r(zd,"from_pretrained()"),zd.forEach(o),ka=r(at," function and the decoder is loaded via "),Bo=d(at,"A",{href:!0});var qd=i(Bo);Ta=r(qd,"from_pretrained()"),qd.forEach(o),wa=r(at,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),Fd.forEach(o),qa=h(j),to=d(j,"P",{});var vn=i(to);ja=r(vn,"This model inherits from "),Oo=d(vn,"A",{href:!0});var Pd=i(Oo);Fa=r(Pd,"TFPreTrainedModel"),Pd.forEach(o),Pa=r(vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yn.forEach(o),Ia=h(j),G=d(j,"P",{});var To=i(G);Vo=d(To,"A",{href:!0});var Cd=i(Vo);La=r(Cd,"TFEncoderDecoderModel"),Cd.forEach(o),Ba=r(To,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
