...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/tokenization_t5.py#L223",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/tokenization_t5.py#L163",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/tokenization_t5.py#L201",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/tokenization_t5_fast.py#L165",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16654/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16654/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16654/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1344",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1300"}}),xs=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1312"}}),zs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1538",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1494"}}),Is=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1507"}}),Ss=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_16654/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1809",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1772"}}),Js=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Xs=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_t5.py#L1783"}}),Qs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_tf_t5.py#L1134",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_tf_t5.py#L1309",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_tf_t5.py#L1618",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/pr_16654/src/transformers/models/t5/modeling_flax_t5.py#L946",returnDescription:`
<p>A <a
...
directory.`),tp.forEach(n),oc=l(t),sr=r(t,"UL",{});var Xb=i(sr);Ni=r(Xb,"LI",{});var Qb=i(Ni);su=s(Qb,"Supervised training"),Qb.forEach(n),Xb.forEach(n),sc=l(t),ar=r(t,"P",{});var e5=i(ar);au=s(e5,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),e5.forEach(n),ac=l(t),_($o.$$.fragment,t),rc=l(t),oe=r(t,"P",{});var ye=i(oe);ru=s(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Oi=r(ye,"CODE",{});var t5=i(Oi);iu=s(t5,"input_ids"),t5.forEach(n),du=s(ye,` (which are the
`),Li=r(ye,"CODE",{});var n5=i(Li);lu=s(n5,"input_ids"),n5.forEach(n),cu=s(ye," of the encoded input sequence) and "),Ai=r(ye,"CODE",{});var o5=i(Ai);pu=s(o5,"labels"),o5.forEach(n),hu=s(ye," (which are the "),Ii=r(ye,"CODE",{});var s5=i(Ii);uu=s(s5,"input_ids"),s5.forEach(n),mu=s(ye,` of the encoded
target sequence). The model will automatically create the `),Di=r(ye,"CODE",{});var a5=i(Di);fu=s(a5,"decoder_input_ids"),a5.forEach(n),_u=s(ye," based on the "),Si=r(ye,"CODE",{});var r5=i(Si);gu=s(r5,"labels"),r5.forEach(n),Tu=s(ye,`, by
shifting them one position to the right and prepending the `),Gi=r(ye,"CODE",{});var i5=i(Gi);vu=s(i5,"config.decoder_start_token_id"),i5.forEach(n),ku=s(ye,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Ui=r(Ur,"CODE",{});var d5=i(Ui);yu=s(d5,"max_source_length"),d5.forEach(n),wu=s(Ur," and "),Wi=r(Ur,"CODE",{});var l5=i(Wi);xu=s(l5,"max_target_length"),l5.forEach(n),$u=s(Ur,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Ur.forEach(n),dc=l(t),fe=r(t,"P",{});var tt=i(fe);zu=s(tt,"In addition, we must make sure that padding token id\u2019s of the "),Ri=r(tt,"CODE",{});var c5=i(Ri);ju=s(c5,"labels"),c5.forEach(n),qu=s(tt,` are not taken into account by the loss
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Bi=r(tt,"CODE",{});var p5=i(Bi);Eu=s(p5,"ignore_index"),p5.forEach(n),Fu=s(tt,`
of the `),Hi=r(tt,"CODE",{});var h5=i(Hi);Mu=s(h5,"CrossEntropyLoss"),h5.forEach(n),Cu=s(tt,". In Flax, one can use the "),Vi=r(tt,"CODE",{});var u5=i(Vi);Pu=s(u5,"decoder_attention_mask"),u5.forEach(n),Nu=s(tt,` to ignore padded tokens from
the loss (see the `),zo=r(tt,"A",{href:!0,rel:!0});var m5=i(zo);Ou=s(m5,"Flax summarization script"),m5.forEach(n),Lu=s(tt,` for details). We also pass
`),Ki=r(tt,"CODE",{});var f5=i(Ki);Au=s(f5,"attention_mask"),f5.forEach(n),Iu=s(tt,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),tt.forEach(n),lc=l(t),_(jo.$$.fragment,t),cc=l(t),rr=r(t,"P",{});var _5=i(rr);Du=s(_5,"Additional training tips:"),_5.forEach(n),pc=l(t),ir=r(t,"UL",{});var g5=i(ir);qo=r(g5,"LI",{});var np=i(qo);Su=s(np,"T5 models need a slightly higher learning rate than the default one set in the "),Yi=r(np,"CODE",{});var T5=i(Yi);Gu=s(T5,"Trainer"),T5.forEach(n),Uu=s(np,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),np.forEach(n),g5.forEach(n),hc=l(t),zt=r(t,"P",{});var Wr=i(zt);Wu=s(Wr,"According to "),Eo=r(Wr,"A",{href:!0,rel:!0});var v5=i(Eo);Ru=s(v5,"this forum post"),v5.forEach(n),Bu=s(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Fo=r(Wr,"A",{href:!0,rel:!0});var k5=i(Fo);Hu=s(k5,"paper"),k5.forEach(n),Vu=s(Wr,` for the task prefixes
...
`),Zi=r(op,"EM",{});var b5=i(Zi);Yu=s(b5,"pad_to_multiple_of"),b5.forEach(n),Zu=s(op,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),op.forEach(n),mc=l(t),dr=r(t,"A",{id:!0}),i(dr).forEach(n),fc=l(t),Kt=r(t,"H2",{class:!0});var sp=i(Kt);qn=r(sp,"A",{id:!0,class:!0,href:!0});var y5=i(qn);Ji=r(y5,"SPAN",{});var w5=i(Ji);_(Mo.$$.fragment,w5),w5.forEach(n),y5.forEach(n),Ju=l(sp),Xi=r(sp,"SPAN",{});var x5=i(Xi);Xu=s(x5,"Inference"),x5.forEach(n),sp.forEach(n),_c=l(t),mt=r(t,"P",{});var ao=i(mt);Qu=s(ao,"At inference time, it is recommended to use "),lr=r(ao,"A",{href:!0});var $5=i(lr);em=s($5,"generate()"),$5.forEach(n),tm=s(ao,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),Co=r(ao,"A",{href:!0,rel:!0});var z5=i(Co);nm=s(z5,"this blog post"),z5.forEach(n),om=s(ao,` to know all the details about generating text with Transformers.
There\u2019s also `),Po=r(ao,"A",{href:!0,rel:!0});var j5=i(Po);sm=s(j5,"this blog post"),j5.forEach(n),am=s(ao,` which explains how
generation works in general in encoder-decoder models.`),ao.forEach(n),gc=l(t),_(No.$$.fragment,t),Tc=l(t),Ue=r(t,"P",{});var Nt=i(Ue);rm=s(Nt,"Note that T5 uses the "),Qi=r(Nt,"CODE",{});var q5=i(Qi);im=s(q5,"pad_token_id"),q5.forEach(n),dm=s(Nt," as the "),ed=r(Nt,"CODE",{});var E5=i(ed);lm=s(E5,"decoder_start_token_id"),E5.forEach(n),cm=s(Nt,`, so when doing generation without using
`),cr=r(Nt,"A",{href:!0});var F5=i(cr);pm=s(F5,"generate()"),F5.forEach(n),hm=s(Nt,", make sure you start it with the "),td=r(Nt,"CODE",{});var M5=i(td);um=s(M5,"pad_token_id"),M5.forEach(n),mm=s(Nt,"."),Nt.forEach(n),vc=l(t),pr=r(t,"P",{});var C5=i(pr);fm=s(C5,"The example above only shows a single example. You can also do batched inference, like so:"),C5.forEach(n),kc=l(t),_(Oo.$$.fragment,t),bc=l(t),hr=r(t,"P",{});var P5=i(hr);_m=s(P5,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),P5.forEach(n),yc=l(t),_(Lo.$$.fragment,t),wc=l(t),ur=r(t,"A",{id:!0}),i(ur).forEach(n),xc=l(t),Yt=r(t,"H2",{class:!0});var ap=i(Yt);En=r(ap,"A",{id:!0,class:!0,href:!0});var N5=i(En);nd=r(N5,"SPAN",{});var O5=i(nd);_(Ao.$$.fragment,O5),O5.forEach(n),N5.forEach(n),gm=l(ap),od=r(ap,"SPAN",{});var L5=i(od);Tm=s(L5,"Performance"),L5.forEach(n),ap.forEach(n),$c=l(t),ft=r(t,"P",{});var ro=i(ft);vm=s(ro,"If you\u2019d like a faster training and inference performance, install "),Io=r(ro,"A",{href:!0,rel:!0});var A5=i(Io);km=s(A5,"apex"),A5.forEach(n),bm=s(ro," and then the model will automatically use "),sd=r(ro,"CODE",{});var I5=i(sd);ym=s(I5,"apex.normalization.FusedRMSNorm"),I5.forEach(n),wm=s(ro," instead of "),ad=r(ro,"CODE",{});var D5=i(ad);xm=s(D5,"T5LayerNorm"),D5.forEach(n),$m=s(ro,". The former uses an optimized fused kernel which is several times faster than the latter."),ro.forEach(n),zc=l(t),Zt=r(t,"H2",{class:!0});var rp=i(Zt);Fn=r(rp,"A",{id:!0,class:!0,href:!0});var S5=i(Fn);rd=r(S5,"SPAN",{});var G5=i(rd);_(Do.$$.fragment,G5),G5.forEach(n),S5.forEach(n),zm=l(rp),id=r(rp,"SPAN",{});var U5=i(id);jm=s(U5,"Example scripts"),U5.forEach(n),rp.forEach(n),jc=l(t),mr=r(t,"P",{});var W5=i(mr);qm=s(W5,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),W5.forEach(n),qc=l(t),Mn=r(t,"UL",{});var ip=i(Mn);dd=r(ip,"LI",{});var R5=i(dd);Jt=r(R5,"P",{});var Rr=i(Jt);Em=s(Rr,"pre-training: the "),So=r(Rr,"A",{href:!0,rel:!0});var B5=i(So);Fm=s(B5,"run_t5_mlm_flax.py"),B5.forEach(n),Mm=s(Rr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Go=r(Rr,"A",{href:!0,rel:!0});var H5=i(Go);Cm=s(H5,"t5_tokenizer_model.py"),H5.forEach(n),Pm=s(Rr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Rr.forEach(n),R5.forEach(n),Nm=l(ip),ld=r(ip,"LI",{});var V5=i(ld);Ae=r(V5,"P",{});var vt=i(Ae);Om=s(vt,"fine-tuning: T5 is supported by the official summarization scripts ("),Uo=r(vt,"A",{href:!0,rel:!0});var K5=i(Uo);Lm=s(K5,"PyTorch"),K5.forEach(n),Am=s(vt,", "),Wo=r(vt,"A",{href:!0,rel:!0});var Y5=i(Wo);Im=s(Y5,"Tensorflow"),Y5.forEach(n),Dm=s(vt,", and "),Ro=r(vt,"A",{href:!0,rel:!0});var Z5=i(Ro);Sm=s(Z5,"Flax"),Z5.forEach(n),Gm=s(vt,`) and translation scripts
(`),Bo=r(vt,"A",{href:!0,rel:!0});var J5=i(Bo);Um=s(J5,"PyTorch"),J5.forEach(n),Wm=s(vt," and "),Ho=r(vt,"A",{href:!0,rel:!0});var X5=i(Ho);Rm=s(X5,"Tensorflow"),X5.forEach(n),Bm=s(vt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),vt.forEach(n),V5.forEach(n),ip.forEach(n),Ec=l(t),Xt=r(t,"H2",{class:!0});var dp=i(Xt);Cn=r(dp,"A",{id:!0,class:!0,href:!0});var Q5=i(Cn);cd=r(Q5,"SPAN",{});var ey=i(cd);_(Vo.$$.fragment,ey),ey.forEach(n),Q5.forEach(n),Hm=l(dp),pd=r(dp,"SPAN",{});var ty=i(pd);Vm=s(ty,"T5Config"),ty.forEach(n),dp.forEach(n),Fc=l(t),kt=r(t,"DIV",{class:!0});var Br=i(kt);_(Ko.$$.fragment,Br),Km=l(Br),bt=r(Br,"P",{});var io=i(bt);Ym=s(io,"This is the configuration class to store the configuration of a "),fr=r(io,"A",{href:!0});var ny=i(fr);Zm=s(ny,"T5Model"),ny.forEach(n),Jm=s(io," or a "),_r=r(io,"A",{href:!0});var oy=i(_r);Xm=s(oy,"TFT5Model"),oy.forEach(n),Qm=s(io,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
adding special tokens. A sequence has the following format:`),hy.forEach(n),yf=l(Vr),ns=r(Vr,"UL",{});var hp=i(ns);kr=r(hp,"LI",{});var Bk=i(kr);wf=s(Bk,"single sequence: "),fd=r(Bk,"CODE",{});var uy=i(fd);xf=s(uy,"X </s>"),uy.forEach(n),Bk.forEach(n),$f=l(hp),br=r(hp,"LI",{});var Hk=i(br);zf=s(Hk,"pair of sequences: "),_d=r(Hk,"CODE",{});var my=i(_d);jf=s(my,"A </s> B </s>"),my.forEach(n),Hk.forEach(n),hp.forEach(n),Vr.forEach(n),qf=l(nt),Nn=r(nt,"DIV",{class:!0});var up=i(Nn);_(os.$$.fragment,up),Ef=l(up),ss=r(up,"P",{});var mp=i(ss);Ff=s(mp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
adding special tokens. A sequence has the following format:`),xy.forEach(n),Xf=l(Yr),hs=r(Yr,"UL",{});var Tp=i(hs);xr=r(Tp,"LI",{});var Vk=i(xr);Qf=s(Vk,"single sequence: "),wd=r(Vk,"CODE",{});var $y=i(wd);e_=s($y,"X </s>"),$y.forEach(n),Vk.forEach(n),t_=l(Tp),$r=r(Tp,"LI",{});var Kk=i($r);n_=s(Kk,"pair of sequences: "),xd=r(Kk,"CODE",{});var zy=i(xd);o_=s(zy,"A </s> B </s>"),zy.forEach(n),Kk.forEach(n),Tp.forEach(n),Yr.forEach(n),s_=l(Ot),An=r(Ot,"DIV",{class:!0});var vp=i(An);_(us.$$.fragment,vp),a_=l(vp),$d=r(vp,"P",{});var jy=i($d);r_=s(jy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
