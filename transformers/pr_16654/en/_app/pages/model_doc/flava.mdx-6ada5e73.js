...
as well as vision-and-language multimodal tasks.`),Ra=d(),Ot=n("p"),rs=s("The abstract from the paper is the following:"),Ha=d(),Nt=n("p"),ss=s(`State-of-the-art vision and vision-and-language models rely on large-scale visio-linguistic pretraining for obtaining good performance on a variety
...
documentation from `),Bt=n("a"),Fs=s("PretrainedConfig"),Ls=s(" for more information."),Vs=d(),Sn=n("p"),ws=s("Example:"),ks=d(),p(vo.$$.fragment),Ts=d(),Se=n("div"),p(bo.$$.fragment),ys=d(),Fo=n("p"),$s=s("Instantiate a "),Rt=n("a"),xs=s("FLAVAConfig"),Ms=s(` (or a derived class) from flava text model configuration, flava image model
configuration and flava multimodal model configuration.`),Za=d(),me=n("h2"),Be=n("a"),Bn=n("span"),p(Lo.$$.fragment),Es=d(),Rn=n("span"),Cs=s("FLAVATextConfig"),Ja=d(),C=n("div"),p(Vo.$$.fragment),zs=d(),fe=n("p"),Ps=s("This is the configuration class to store the configuration of a "),Ht=n("a"),Is=s("FLAVATextModel"),js=s(`. It is used to instantiate an
...
documentation from `),Gt=n("a"),Bs=s("PretrainedConfig"),Rs=s(" for more information."),Hs=d(),Hn=n("p"),Us=s("Example:"),Gs=d(),p(ko.$$.fragment),Xa=d(),pe=n("h2"),Re=n("a"),Un=n("span"),p(To.$$.fragment),Ks=d(),Gn=n("span"),Zs=s("FLAVAImageConfig"),Qa=d(),z=n("div"),p(yo.$$.fragment),Js=d(),ge=n("p"),Xs=s("This is the configuration class to store the configuration of a "),Kt=n("a"),Qs=s("FLAVAImageModel"),Ys=s(`. It is used to instantiate an
FLAVA model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the FLAVA
`),$o=n("a"),ei=s("full"),oi=s(" architecture."),ti=d(),ue=n("p"),ni=s("Configuration objects inherit from "),Zt=n("a"),ai=s("PretrainedConfig"),ri=s(` and can be used to control the model outputs. Read the
documentation from `),Jt=n("a"),si=s("PretrainedConfig"),ii=s(" for more information."),li=d(),Kn=n("p"),di=s("Example:"),ci=d(),p(xo.$$.fragment),Ya=d(),_e=n("h2"),He=n("a"),Zn=n("span"),p(Mo.$$.fragment),mi=d(),Jn=n("span"),fi=s("FLAVAMultimodalConfig"),er=d(),P=n("div"),p(Eo.$$.fragment),hi=d(),Ae=n("p"),pi=s("This is the configuration class to store the configuration of a "),Xt=n("a"),gi=s("FLAVAMultimodalModel"),ui=s(`. It is used to instantiate
...
documentation from `),Yt=n("a"),Vi=s("PretrainedConfig"),wi=s(" for more information."),ki=d(),Xn=n("p"),Ti=s("Example:"),yi=d(),p(zo.$$.fragment),or=d(),be=n("h2"),Ue=n("a"),Qn=n("span"),p(Po.$$.fragment),$i=d(),Yn=n("span"),xi=s("FLAVACodebookConfig"),tr=d(),Io=n("div"),p(jo.$$.fragment),nr=d(),Fe=n("h2"),Ge=n("a"),ea=n("span"),p(qo.$$.fragment),Mi=d(),oa=n("span"),Ei=s("FLAVAProcessor"),ar=d(),I=n("div"),p(Oo.$$.fragment),Ci=d(),ta=n("p"),zi=s("Constructs a FLAVA processor which wraps a FLAVA feature extractor and a FLAVA tokenizer into a single processor."),Pi=d(),q=n("p"),en=n("a"),Ii=s("FLAVAProcessor"),ji=s(" offers all the functionalities of "),on=n("a"),qi=s("FLAVAFeatureExtractor"),Oi=s(" and "),na=n("code"),Ni=s("FLAVATokenizerFast"),Di=s(`. See the
`),aa=n("code"),Wi=s("__call__()"),Si=s(" and "),tn=n("a"),Bi=s("decode()"),Ri=s(" for more information."),Hi=d(),Ke=n("div"),p(No.$$.fragment),Ui=d(),Do=n("p"),Gi=s("This method forwards all its arguments to FLAVATokenizerFast\u2019s "),nn=n("a"),Ki=s("batch_decode()"),Zi=s(`. Please
refer to the docstring of this method for more information.`),Ji=d(),Ze=n("div"),p(Wo.$$.fragment),Xi=d(),So=n("p"),Qi=s("This method forwards all its arguments to FLAVATokenizerFast\u2019s "),an=n("a"),Yi=s("decode()"),el=s(`. Please refer to
the docstring of this method for more information.`),rr=d(),Le=n("h2"),Je=n("a"),ra=n("span"),p(Bo.$$.fragment),ol=d(),sa=n("span"),tl=s("FLAVAFeatureExtractor"),sr=d(),H=n("div"),p(Ro.$$.fragment),nl=d(),ia=n("p"),al=s("Constructs a FLAVA feature extractor."),rl=d(),Ho=n("p"),sl=s("This feature extractor inherits from "),rn=n("a"),il=s("FeatureExtractionMixin"),ll=s(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ir=d(),Ve=n("h2"),Xe=n("a"),la=n("span"),p(Uo.$$.fragment),dl=d(),da=n("span"),cl=s("FLAVACodebookFeatureExtractor"),lr=d(),Go=n("div"),p(Ko.$$.fragment),dr=d(),we=n("h2"),Qe=n("a"),ca=n("span"),p(Zo.$$.fragment),ml=d(),ma=n("span"),fl=s("FLAVAForPreTraining"),cr=d(),S=n("div"),p(Jo.$$.fragment),hl=d(),fa=n("p"),pl=s("The FLAVA model for pretraining which outputs losses, embeddings, logits and transformer outputs."),gl=d(),Xo=n("p"),ul=s("This model is a PyTorch "),Qo=n("a"),_l=s("torch.nn.Module"),Al=s(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vl=d(),J=n("div"),p(Yo.$$.fragment),bl=d(),ke=n("p"),Fl=s("The "),sn=n("a"),Ll=s("FLAVAForPreTraining"),Vl=s(" forward method, overrides the "),ha=n("code"),wl=s("__call__"),kl=s(" special method."),Tl=d(),p(Ye.$$.fragment),mr=d(),Te=n("h2"),eo=n("a"),pa=n("span"),p(et.$$.fragment),yl=d(),ga=n("span"),$l=s("FLAVAModel"),fr=d(),j=n("div"),p(ot.$$.fragment),xl=d(),tt=n("p"),Ml=s(`The bare FLAVA Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),nt=n("a"),El=s("torch.nn.Module"),Cl=s(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=d(),O=n("div"),p(at.$$.fragment),Pl=d(),ye=n("p"),Il=s("The "),ln=n("a"),jl=s("FLAVAModel"),ql=s(" forward method, overrides the "),ua=n("code"),Ol=s("__call__"),Nl=s(" special method."),Dl=d(),p(oo.$$.fragment),Wl=d(),_a=n("p"),Sl=s("Examples:"),Bl=d(),p(rt.$$.fragment),Rl=d(),X=n("div"),p(st.$$.fragment),Hl=d(),$e=n("p"),Ul=s("The "),dn=n("a"),Gl=s("FLAVAModel"),Kl=s(" forward method, overrides the "),Aa=n("code"),Zl=s("__call__"),Jl=s(" special method."),Xl=d(),p(to.$$.fragment),Ql=d(),Q=n("div"),p(it.$$.fragment),Yl=d(),xe=n("p"),ed=s("The "),cn=n("a"),od=s("FLAVAModel"),td=s(" forward method, overrides the "),va=n("code"),nd=s("__call__"),ad=s(" special method."),rd=d(),p(no.$$.fragment),hr=d(),Me=n("h2"),ao=n("a"),ba=n("span"),p(lt.$$.fragment),sd=d(),Fa=n("span"),id=s("FLAVACodebook"),pr=d(),x=n("div"),p(dt.$$.fragment),ld=d(),ct=n("p"),dd=s(`The FLAVA\u2019s codebook model inspired from DALL-E\u2019s original encoder. Outputs raw hidden states and can be used to
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Sd=d(),D=n("div"),p(Tt.$$.fragment),Bd=d(),Pe=n("p"),Rd=s("The "),gn=n("a"),Hd=s("FLAVAImageModel"),Ud=s(" forward method, overrides the "),xa=n("code"),Gd=s("__call__"),Kd=s(" special method."),Zd=d(),p(lo.$$.fragment),Jd=d(),Ma=n("p"),Xd=s("Example:"),Qd=d(),p(yt.$$.fragment),vr=d(),Ie=n("h2"),co=n("a"),Ea=n("span"),p($t.$$.fragment),Yd=d(),Ca=n("span"),ec=s("FLAVAMultimodalModel"),br=d(),K=n("div"),p(xt.$$.fragment),oc=d(),Mt=n("p"),tc=s(`The bare FLAVA Multimodal Model transformer outputting raw hidden-states without any specific head on top.
...
as well as vision-and-language multimodal tasks.`),Ac.forEach(t),Ra=c(o),Ot=a(o,"P",{});var vc=r(Ot);rs=i(vc,"The abstract from the paper is the following:"),vc.forEach(t),Ha=c(o),Nt=a(o,"P",{});var bc=r(Nt);ss=i(bc,`State-of-the-art vision and vision-and-language models rely on large-scale visio-linguistic pretraining for obtaining good performance on a variety
of downstream tasks. Generally, such models are often either cross-modal (contrastive) or multi-modal
(with earlier fusion) but not both; and they often only target specific modalities or tasks. A promising
direction would be to use a single holistic universal model, as a \u201Cfoundation\u201D, that targets all modalities
at once \u2014 a true vision and language foundation model should be good at vision tasks, language tasks, and
...
documentation from `),Bt=a(_n,"A",{href:!0});var $c=r(Bt);Fs=i($c,"PretrainedConfig"),$c.forEach(t),Ls=i(_n," for more information."),_n.forEach(t),Vs=c(B),Sn=a(B,"P",{});var xc=r(Sn);ws=i(xc,"Example:"),xc.forEach(t),ks=c(B),g(vo.$$.fragment,B),Ts=c(B),Se=a(B,"DIV",{class:!0});var kr=r(Se);g(bo.$$.fragment,kr),ys=c(kr),Fo=a(kr,"P",{});var Tr=r(Fo);$s=i(Tr,"Instantiate a "),Rt=a(Tr,"A",{href:!0});var Mc=r(Rt);xs=i(Mc,"FLAVAConfig"),Mc.forEach(t),Ms=i(Tr,` (or a derived class) from flava text model configuration, flava image model
configuration and flava multimodal model configuration.`),Tr.forEach(t),kr.forEach(t),B.forEach(t),Za=c(o),me=a(o,"H2",{class:!0});var yr=r(me);Be=a(yr,"A",{id:!0,class:!0,href:!0});var Ec=r(Be);Bn=a(Ec,"SPAN",{});var Cc=r(Bn);g(Lo.$$.fragment,Cc),Cc.forEach(t),Ec.forEach(t),Es=c(yr),Rn=a(yr,"SPAN",{});var zc=r(Rn);Cs=i(zc,"FLAVATextConfig"),zc.forEach(t),yr.forEach(t),Ja=c(o),C=a(o,"DIV",{class:!0});var Y=r(C);g(Vo.$$.fragment,Y),zs=c(Y),fe=a(Y,"P",{});var An=r(fe);Ps=i(An,"This is the configuration class to store the configuration of a "),Ht=a(An,"A",{href:!0});var Pc=r(Ht);Is=i(Pc,"FLAVATextModel"),Pc.forEach(t),js=i(An,`. It is used to instantiate an
FLAVA model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the FLAVA
