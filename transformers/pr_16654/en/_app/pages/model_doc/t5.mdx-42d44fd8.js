...
directory.`),tp.forEach(n),oc=l(t),sr=r(t,"UL",{});var Xk=i(sr);Ni=r(Xk,"LI",{});var Qk=i(Ni);su=s(Qk,"Supervised training"),Qk.forEach(n),Xk.forEach(n),sc=l(t),ar=r(t,"P",{});var e5=i(ar);au=s(e5,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
...
shifting them one position to the right and prepending the `),Gi=r(ye,"CODE",{});var i5=i(Gi);bu=s(i5,"config.decoder_start_token_id"),i5.forEach(n),vu=s(ye,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),np.forEach(n),g5.forEach(n),hc=l(t),zt=r(t,"P",{});var Wr=i(zt);Wu=s(Wr,"According to "),Eo=r(Wr,"A",{href:!0,rel:!0});var b5=i(Eo);Ru=s(b5,"this forum post"),b5.forEach(n),Bu=s(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Fo=r(Wr,"A",{href:!0,rel:!0});var v5=i(Fo);Hu=s(v5,"paper"),v5.forEach(n),Vu=s(Wr,` for the task prefixes
...
`),Zi=r(op,"EM",{});var k5=i(Zi);Yu=s(k5,"pad_to_multiple_of"),k5.forEach(n),Zu=s(op,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
...
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Rr.forEach(n),R5.forEach(n),Nm=l(ip),ld=r(ip,"LI",{});var V5=i(ld);Ae=r(V5,"P",{});var bt=i(Ae);Om=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),Uo=r(bt,"A",{href:!0,rel:!0});var K5=i(Uo);Lm=s(K5,"PyTorch"),K5.forEach(n),Am=s(bt,", "),Wo=r(bt,"A",{href:!0,rel:!0});var Y5=i(Wo);Im=s(Y5,"Tensorflow"),Y5.forEach(n),Dm=s(bt,", and "),Ro=r(bt,"A",{href:!0,rel:!0});var Z5=i(Ro);Sm=s(Z5,"Flax"),Z5.forEach(n),Gm=s(bt,`) and translation scripts
(`),Bo=r(bt,"A",{href:!0,rel:!0});var J5=i(Bo);Um=s(J5,"PyTorch"),J5.forEach(n),Wm=s(bt," and "),Ho=r(bt,"A",{href:!0,rel:!0});var X5=i(Ho);Rm=s(X5,"Tensorflow"),X5.forEach(n),Bm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(n),V5.forEach(n),ip.forEach(n),Ec=l(t),Xt=r(t,"H2",{class:!0});var dp=i(Xt);Cn=r(dp,"A",{id:!0,class:!0,href:!0});var Q5=i(Cn);cd=r(Q5,"SPAN",{});var ey=i(cd);_(Vo.$$.fragment,ey),ey.forEach(n),Q5.forEach(n),Hm=l(dp),pd=r(dp,"SPAN",{});var ty=i(pd);Vm=s(ty,"T5Config"),ty.forEach(n),dp.forEach(n),Fc=l(t),vt=r(t,"DIV",{class:!0});var Br=i(vt);_(Ko.$$.fragment,Br),Km=l(Br),kt=r(Br,"P",{});var io=i(kt);Ym=s(io,"This is the configuration class to store the configuration of a "),fr=r(io,"A",{href:!0});var ny=i(fr);Zm=s(ny,"T5Model"),ny.forEach(n),Jm=s(io," or a "),_r=r(io,"A",{href:!0});var oy=i(_r);Xm=s(oy,"TFT5Model"),oy.forEach(n),Qm=s(io,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
