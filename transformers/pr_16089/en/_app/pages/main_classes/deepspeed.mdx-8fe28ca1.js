...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16089/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16089/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16089/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16089/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16089/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
`),ki=o("a"),K8=a("Trainer"),J8=a(" via "),Pi=o("a"),X8=a("TrainingArguments"),Q8=a(" then for the "),fd=o("code"),e9=a("deepspeed"),s9=a(` argument you can
pass a nested `),dd=o("code"),t9=a("dict"),a9=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),Di=o("a"),n9=a("TrainingArguments"),o9=a("."),Rw=u(),zi=o("p"),l9=a("To summarize you can do:"),Iw=u(),f(Yo.$$.fragment),Uw=u(),Oi=o("p"),r9=a("or:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("a"),Mw=u(),xs=o("h3"),sa=o("a"),md=o("span"),f(Jo.$$.fragment),p9=u(),_d=o("span"),i9=a("Shared Configuration"),Zw=u(),f(ta.$$.fragment),Nw=u(),Me=o("p"),u9=a("Some configuration values are required by both the "),Ai=o("a"),c9=a("Trainer"),h9=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Si=o("a"),f9=a("Trainer"),d9=a(" command line arguments."),Hw=u(),aa=o("p"),m9=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),Ci=o("a"),_9=a("Trainer"),v9=a(` do the majority
of configuration for you.`),Bw=u(),Ze=o("p"),j9=a("Therefore, in the rest of this guide you will find a special configuration value: "),vd=o("code"),g9=a("auto"),w9=a(`, which when set will be
...
`),xi=o("a"),y9=a("Trainer"),b9=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),Ww=u(),Ri=o("p"),E9=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Fw=u(),na=o("p"),q9=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ii=o("a"),$9=a("TrainingArguments"),k9=a(" based on that. The steps are:"),Vw=u(),oa=o("ol"),jd=o("li"),P9=a("Create or load the DeepSpeed configuration to be used as a master configuration"),D9=u(),Xo=o("li"),z9=a("Create the "),Ui=o("a"),O9=a("TrainingArguments"),T9=a(" object based on these values"),Yw=u(),le=o("p"),A9=a("Do note that some values, such as "),gd=o("code"),S9=a("scheduler.params.total_num_steps"),C9=a(` are calculated by
`),Gi=o("a"),x9=a("Trainer"),R9=a(" during "),wd=o("code"),I9=a("train"),U9=a(", but you can of course do the math yourself."),Kw=u(),Li=o("a"),Jw=u(),Rs=o("h3"),la=o("a"),yd=o("span"),f(Qo.$$.fragment),G9=u(),bd=o("span"),L9=a("ZeRO"),Xw=u(),el=o("p"),sl=o("a"),M9=a("Zero Redundancy Optimizer (ZeRO)"),Z9=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),Qw=u(),Ne=o("p"),N9=a("The "),Ed=o("code"),H9=a("zero_optimization"),B9=a(" section of the configuration file is the most important part ("),tl=o("a"),W9=a("docs"),F9=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ey=u(),ra=o("p"),V9=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Mi=o("a"),Y9=a("Trainer"),K9=a(` provides
no equivalent command line arguments.`),sy=u(),Zi=o("p"),J9=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),ty=u(),Ni=o("a"),ay=u(),Is=o("h4"),pa=o("a"),qd=o("span"),f(al.$$.fragment),X9=u(),$d=o("span"),Q9=a("ZeRO-2 Config"),ny=u(),Hi=o("p"),ek=a("The following is an example of configuration for ZeRO stage 2:"),oy=u(),f(nl.$$.fragment),ly=u(),Bi=o("p"),kd=o("strong"),sk=a("Performance tuning:"),ry=u(),He=o("ul"),Us=o("li"),tk=a("enabling "),Pd=o("code"),ak=a("offload_optimizer"),nk=a(" should reduce GPU RAM usage (it requires "),Dd=o("code"),ok=a('"stage": 2'),lk=a(")"),rk=u(),L=o("li"),zd=o("code"),pk=a('"overlap_comm": true'),ik=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Od=o("code"),uk=a("overlap_comm"),ck=a(` uses 4.5x
...
not using the command line interface to configure the training, and instead instantiate the
`),ki=l(ye,"A",{href:!0});var IM=r(ki);K8=n(IM,"Trainer"),IM.forEach(t),J8=n(ye," via "),Pi=l(ye,"A",{href:!0});var UM=r(Pi);X8=n(UM,"TrainingArguments"),UM.forEach(t),Q8=n(ye," then for the "),fd=l(ye,"CODE",{});var GM=r(fd);e9=n(GM,"deepspeed"),GM.forEach(t),s9=n(ye,` argument you can
pass a nested `),dd=l(ye,"CODE",{});var LM=r(dd);t9=n(LM,"dict"),LM.forEach(t),a9=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),Di=l(ye,"A",{href:!0});var MM=r(Di);n9=n(MM,"TrainingArguments"),MM.forEach(t),o9=n(ye,"."),ye.forEach(t),Rw=c(e),zi=l(e,"P",{});var ZM=r(zi);l9=n(ZM,"To summarize you can do:"),ZM.forEach(t),Iw=c(e),d(Yo.$$.fragment,e),Uw=c(e),Oi=l(e,"P",{});var NM=r(Oi);r9=n(NM,"or:"),NM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"A",{id:!0}),r(Ti).forEach(t),Mw=c(e),xs=l(e,"H3",{class:!0});var RE=r(xs);sa=l(RE,"A",{id:!0,class:!0,href:!0});var HM=r(sa);md=l(HM,"SPAN",{});var BM=r(md);d(Jo.$$.fragment,BM),BM.forEach(t),HM.forEach(t),p9=c(RE),_d=l(RE,"SPAN",{});var WM=r(_d);i9=n(WM,"Shared Configuration"),WM.forEach(t),RE.forEach(t),Zw=c(e),d(ta.$$.fragment,e),Nw=c(e),Me=l(e,"P",{});var _h=r(Me);u9=n(_h,"Some configuration values are required by both the "),Ai=l(_h,"A",{href:!0});var FM=r(Ai);c9=n(FM,"Trainer"),FM.forEach(t),h9=n(_h,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Si=l(_h,"A",{href:!0});var VM=r(Si);f9=n(VM,"Trainer"),VM.forEach(t),d9=n(_h," command line arguments."),_h.forEach(t),Hw=c(e),aa=l(e,"P",{});var IE=r(aa);m9=n(IE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),Ci=l(IE,"A",{href:!0});var YM=r(Ci);_9=n(YM,"Trainer"),YM.forEach(t),v9=n(IE,` do the majority
of configuration for you.`),IE.forEach(t),Bw=c(e),Ze=l(e,"P",{});var vh=r(Ze);j9=n(vh,"Therefore, in the rest of this guide you will find a special configuration value: "),vd=l(vh,"CODE",{});var KM=r(vd);g9=n(KM,"auto"),KM.forEach(t),w9=n(vh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),xi=l(vh,"A",{href:!0});var JM=r(xi);y9=n(JM,"Trainer"),JM.forEach(t),b9=n(vh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),vh.forEach(t),Ww=c(e),Ri=l(e,"P",{});var XM=r(Ri);E9=n(XM,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),XM.forEach(t),Fw=c(e),na=l(e,"P",{});var UE=r(na);q9=n(UE,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ii=l(UE,"A",{href:!0});var QM=r(Ii);$9=n(QM,"TrainingArguments"),QM.forEach(t),k9=n(UE," based on that. The steps are:"),UE.forEach(t),Vw=c(e),oa=l(e,"OL",{});var GE=r(oa);jd=l(GE,"LI",{});var eZ=r(jd);P9=n(eZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),eZ.forEach(t),D9=c(GE),Xo=l(GE,"LI",{});var LE=r(Xo);z9=n(LE,"Create the "),Ui=l(LE,"A",{href:!0});var sZ=r(Ui);O9=n(sZ,"TrainingArguments"),sZ.forEach(t),T9=n(LE," object based on these values"),LE.forEach(t),GE.forEach(t),Yw=c(e),le=l(e,"P",{});var Nn=r(le);A9=n(Nn,"Do note that some values, such as "),gd=l(Nn,"CODE",{});var tZ=r(gd);S9=n(tZ,"scheduler.params.total_num_steps"),tZ.forEach(t),C9=n(Nn,` are calculated by
`),Gi=l(Nn,"A",{href:!0});var aZ=r(Gi);x9=n(aZ,"Trainer"),aZ.forEach(t),R9=n(Nn," during "),wd=l(Nn,"CODE",{});var nZ=r(wd);I9=n(nZ,"train"),nZ.forEach(t),U9=n(Nn,", but you can of course do the math yourself."),Nn.forEach(t),Kw=c(e),Li=l(e,"A",{id:!0}),r(Li).forEach(t),Jw=c(e),Rs=l(e,"H3",{class:!0});var ME=r(Rs);la=l(ME,"A",{id:!0,class:!0,href:!0});var oZ=r(la);yd=l(oZ,"SPAN",{});var lZ=r(yd);d(Qo.$$.fragment,lZ),lZ.forEach(t),oZ.forEach(t),G9=c(ME),bd=l(ME,"SPAN",{});var rZ=r(bd);L9=n(rZ,"ZeRO"),rZ.forEach(t),ME.forEach(t),Xw=c(e),el=l(e,"P",{});var hG=r(el);sl=l(hG,"A",{href:!0,rel:!0});var pZ=r(sl);M9=n(pZ,"Zero Redundancy Optimizer (ZeRO)"),pZ.forEach(t),Z9=n(hG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),hG.forEach(t),Qw=c(e),Ne=l(e,"P",{});var jh=r(Ne);N9=n(jh,"The "),Ed=l(jh,"CODE",{});var iZ=r(Ed);H9=n(iZ,"zero_optimization"),iZ.forEach(t),B9=n(jh," section of the configuration file is the most important part ("),tl=l(jh,"A",{href:!0,rel:!0});var uZ=r(tl);W9=n(uZ,"docs"),uZ.forEach(t),F9=n(jh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),jh.forEach(t),ey=c(e),ra=l(e,"P",{});var ZE=r(ra);V9=n(ZE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Mi=l(ZE,"A",{href:!0});var cZ=r(Mi);Y9=n(cZ,"Trainer"),cZ.forEach(t),K9=n(ZE,` provides
no equivalent command line arguments.`),ZE.forEach(t),sy=c(e),Zi=l(e,"P",{});var hZ=r(Zi);J9=n(hZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),hZ.forEach(t),ty=c(e),Ni=l(e,"A",{id:!0}),r(Ni).forEach(t),ay=c(e),Is=l(e,"H4",{class:!0});var NE=r(Is);pa=l(NE,"A",{id:!0,class:!0,href:!0});var fZ=r(pa);qd=l(fZ,"SPAN",{});var dZ=r(qd);d(al.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),X9=c(NE),$d=l(NE,"SPAN",{});var mZ=r($d);Q9=n(mZ,"ZeRO-2 Config"),mZ.forEach(t),NE.forEach(t),ny=c(e),Hi=l(e,"P",{});var _Z=r(Hi);ek=n(_Z,"The following is an example of configuration for ZeRO stage 2:"),_Z.forEach(t),oy=c(e),d(nl.$$.fragment,e),ly=c(e),Bi=l(e,"P",{});var vZ=r(Bi);kd=l(vZ,"STRONG",{});var jZ=r(kd);sk=n(jZ,"Performance tuning:"),jZ.forEach(t),vZ.forEach(t),ry=c(e),He=l(e,"UL",{});var gh=r(He);Us=l(gh,"LI",{});var wh=r(Us);tk=n(wh,"enabling "),Pd=l(wh,"CODE",{});var gZ=r(Pd);ak=n(gZ,"offload_optimizer"),gZ.forEach(t),nk=n(wh," should reduce GPU RAM usage (it requires "),Dd=l(wh,"CODE",{});var wZ=r(Dd);ok=n(wZ,'"stage": 2'),wZ.forEach(t),lk=n(wh,")"),wh.forEach(t),rk=c(gh),L=l(gh,"LI",{});var te=r(L);zd=l(te,"CODE",{});var yZ=r(zd);pk=n(yZ,'"overlap_comm": true'),yZ.forEach(t),ik=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Od=l(te,"CODE",{});var bZ=r(Od);uk=n(bZ,"overlap_comm"),bZ.forEach(t),ck=n(te,` uses 4.5x
