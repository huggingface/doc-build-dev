...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Uw=l(),Op=n("p"),Hw=a("Finally, this model supports inherent JAX features such as:"),Qw=l(),Dt=n("ul"),Np=n("li"),fi=n("a"),Vw=a("Just-In-Time (JIT) compilation"),Jw=l(),Ip=n("li"),mi=n("a"),Kw=a("Automatic Differentiation"),Gw=l(),Dp=n("li"),gi=n("a"),Xw=a("Vectorization"),Yw=l(),Sp=n("li"),_i=n("a"),Zw=a("Parallelization"),e4=l(),kt=n("div"),T(bi.$$.fragment),t4=l(),dn=n("p"),o4=a("The "),Wp=n("code"),n4=a("FlaxRobertaPreTrainedModel"),s4=a("forward method, overrides the "),Bp=n("code"),r4=a("__call__"),a4=a(" special method."),i4=l(),T(ps.$$.fragment),l4=l(),Up=n("p"),d4=a("Example:"),c4=l(),T(ki.$$.fragment),Pu=l(),cn=n("h2"),hs=n("a"),Hp=n("span"),T(Ti.$$.fragment),p4=l(),Qp=n("span"),h4=a("FlaxRobertaForMultipleChoice"),ju=l(),Ne=n("div"),T(yi.$$.fragment),u4=l(),Vp=n("p"),f4=a(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),m4=l(),vi=n("p"),g4=a("This model inherits from "),Hl=n("a"),_4=a("FlaxPreTrainedModel"),b4=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k4=l(),wi=n("p"),T4=a("This model is also a Flax Linen "),$i=n("a"),y4=a("flax.linen.Module"),v4=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w4=l(),Jp=n("p"),$4=a("Finally, this model supports inherent JAX features such as:"),F4=l(),St=n("ul"),Kp=n("li"),Fi=n("a"),R4=a("Just-In-Time (JIT) compilation"),M4=l(),Gp=n("li"),Ri=n("a"),E4=a("Automatic Differentiation"),z4=l(),Xp=n("li"),Mi=n("a"),x4=a("Vectorization"),q4=l(),Yp=n("li"),Ei=n("a"),C4=a("Parallelization"),P4=l(),Tt=n("div"),T(zi.$$.fragment),j4=l(),pn=n("p"),L4=a("The "),Zp=n("code"),A4=a("FlaxRobertaPreTrainedModel"),O4=a("forward method, overrides the "),eh=n("code"),N4=a("__call__"),I4=a(" special method."),D4=l(),T(us.$$.fragment),S4=l(),th=n("p"),W4=a("Example:"),B4=l(),T(xi.$$.fragment),Lu=l(),hn=n("h2"),fs=n("a"),oh=n("span"),T(qi.$$.fragment),U4=l(),nh=n("span"),H4=a("FlaxRobertaForTokenClassification"),Au=l(),Ie=n("div"),T(Ci.$$.fragment),Q4=l(),sh=n("p"),V4=a(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J4=l(),Pi=n("p"),K4=a("This model inherits from "),Ql=n("a"),G4=a("FlaxPreTrainedModel"),X4=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Y4=l(),ji=n("p"),Z4=a("This model is also a Flax Linen "),Li=n("a"),e$=a("flax.linen.Module"),t$=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zf.forEach(t),Uw=d(Mt),Op=s(Mt,"P",{});var eM=r(Op);Hw=i(eM,"Finally, this model supports inherent JAX features such as:"),eM.forEach(t),Qw=d(Mt),Dt=s(Mt,"UL",{});var Ts=r(Dt);Np=s(Ts,"LI",{});var tM=r(Np);fi=s(tM,"A",{href:!0,rel:!0});var oM=r(fi);Vw=i(oM,"Just-In-Time (JIT) compilation"),oM.forEach(t),tM.forEach(t),Jw=d(Ts),Ip=s(Ts,"LI",{});var nM=r(Ip);mi=s(nM,"A",{href:!0,rel:!0});var sM=r(mi);Kw=i(sM,"Automatic Differentiation"),sM.forEach(t),nM.forEach(t),Gw=d(Ts),Dp=s(Ts,"LI",{});var rM=r(Dp);gi=s(rM,"A",{href:!0,rel:!0});var aM=r(gi);Xw=i(aM,"Vectorization"),aM.forEach(t),rM.forEach(t),Yw=d(Ts),Sp=s(Ts,"LI",{});var iM=r(Sp);_i=s(iM,"A",{href:!0,rel:!0});var lM=r(_i);Zw=i(lM,"Parallelization"),lM.forEach(t),iM.forEach(t),Ts.forEach(t),e4=d(Mt),kt=s(Mt,"DIV",{class:!0});var go=r(kt);y(bi.$$.fragment,go),t4=d(go),dn=s(go,"P",{});var _d=r(dn);o4=i(_d,"The "),Wp=s(_d,"CODE",{});var dM=r(Wp);n4=i(dM,"FlaxRobertaPreTrainedModel"),dM.forEach(t),s4=i(_d,"forward method, overrides the "),Bp=s(_d,"CODE",{});var cM=r(Bp);r4=i(cM,"__call__"),cM.forEach(t),a4=i(_d," special method."),_d.forEach(t),i4=d(go),y(ps.$$.fragment,go),l4=d(go),Up=s(go,"P",{});var pM=r(Up);d4=i(pM,"Example:"),pM.forEach(t),c4=d(go),y(ki.$$.fragment,go),go.forEach(t),Mt.forEach(t),Pu=d(o),cn=s(o,"H2",{class:!0});var em=r(cn);hs=s(em,"A",{id:!0,class:!0,href:!0});var hM=r(hs);Hp=s(hM,"SPAN",{});var uM=r(Hp);y(Ti.$$.fragment,uM),uM.forEach(t),hM.forEach(t),p4=d(em),Qp=s(em,"SPAN",{});var fM=r(Qp);h4=i(fM,"FlaxRobertaForMultipleChoice"),fM.forEach(t),em.forEach(t),ju=d(o),Ne=s(o,"DIV",{class:!0});var Et=r(Ne);y(yi.$$.fragment,Et),u4=d(Et),Vp=s(Et,"P",{});var mM=r(Vp);f4=i(mM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),mM.forEach(t),m4=d(Et),vi=s(Et,"P",{});var tm=r(vi);g4=i(tm,"This model inherits from "),Hl=s(tm,"A",{href:!0});var gM=r(Hl);_4=i(gM,"FlaxPreTrainedModel"),gM.forEach(t),b4=i(tm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tm.forEach(t),k4=d(Et),wi=s(Et,"P",{});var om=r(wi);T4=i(om,"This model is also a Flax Linen "),$i=s(om,"A",{href:!0,rel:!0});var _M=r($i);y4=i(_M,"flax.linen.Module"),_M.forEach(t),v4=i(om,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),om.forEach(t),w4=d(Et),Jp=s(Et,"P",{});var bM=r(Jp);$4=i(bM,"Finally, this model supports inherent JAX features such as:"),bM.forEach(t),F4=d(Et),St=s(Et,"UL",{});var ys=r(St);Kp=s(ys,"LI",{});var kM=r(Kp);Fi=s(kM,"A",{href:!0,rel:!0});var TM=r(Fi);R4=i(TM,"Just-In-Time (JIT) compilation"),TM.forEach(t),kM.forEach(t),M4=d(ys),Gp=s(ys,"LI",{});var yM=r(Gp);Ri=s(yM,"A",{href:!0,rel:!0});var vM=r(Ri);E4=i(vM,"Automatic Differentiation"),vM.forEach(t),yM.forEach(t),z4=d(ys),Xp=s(ys,"LI",{});var wM=r(Xp);Mi=s(wM,"A",{href:!0,rel:!0});var $M=r(Mi);x4=i($M,"Vectorization"),$M.forEach(t),wM.forEach(t),q4=d(ys),Yp=s(ys,"LI",{});var FM=r(Yp);Ei=s(FM,"A",{href:!0,rel:!0});var RM=r(Ei);C4=i(RM,"Parallelization"),RM.forEach(t),FM.forEach(t),ys.forEach(t),P4=d(Et),Tt=s(Et,"DIV",{class:!0});var _o=r(Tt);y(zi.$$.fragment,_o),j4=d(_o),pn=s(_o,"P",{});var bd=r(pn);L4=i(bd,"The "),Zp=s(bd,"CODE",{});var MM=r(Zp);A4=i(MM,"FlaxRobertaPreTrainedModel"),MM.forEach(t),O4=i(bd,"forward method, overrides the "),eh=s(bd,"CODE",{});var EM=r(eh);N4=i(EM,"__call__"),EM.forEach(t),I4=i(bd," special method."),bd.forEach(t),D4=d(_o),y(us.$$.fragment,_o),S4=d(_o),th=s(_o,"P",{});var zM=r(th);W4=i(zM,"Example:"),zM.forEach(t),B4=d(_o),y(xi.$$.fragment,_o),_o.forEach(t),Et.forEach(t),Lu=d(o),hn=s(o,"H2",{class:!0});var nm=r(hn);fs=s(nm,"A",{id:!0,class:!0,href:!0});var xM=r(fs);oh=s(xM,"SPAN",{});var qM=r(oh);y(qi.$$.fragment,qM),qM.forEach(t),xM.forEach(t),U4=d(nm),nh=s(nm,"SPAN",{});var CM=r(nh);H4=i(CM,"FlaxRobertaForTokenClassification"),CM.forEach(t),nm.forEach(t),Au=d(o),Ie=s(o,"DIV",{class:!0});var zt=r(Ie);y(Ci.$$.fragment,zt),Q4=d(zt),sh=s(zt,"P",{});var PM=r(sh);V4=i(PM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),PM.forEach(t),J4=d(zt),Pi=s(zt,"P",{});var sm=r(Pi);K4=i(sm,"This model inherits from "),Ql=s(sm,"A",{href:!0});var jM=r(Ql);G4=i(jM,"FlaxPreTrainedModel"),jM.forEach(t),X4=i(sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sm.forEach(t),Y4=d(zt),ji=s(zt,"P",{});var rm=r(ji);Z4=i(rm,"This model is also a Flax Linen "),Li=s(rm,"A",{href:!0,rel:!0});var LM=r(Li);e$=i(LM,"flax.linen.Module"),LM.forEach(t),t$=i(rm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
