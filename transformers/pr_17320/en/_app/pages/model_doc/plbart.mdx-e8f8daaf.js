import{S as Pd,i as Ld,s as $d,e as n,k as u,w as v,t as i,M as qd,c as s,d as o,m,a,x as y,h as d,b as c,F as e,g as _,y as T,q as w,o as P,B as L,v as zd,L as ue}from"../../chunks/vendor-6b77c823.js";import{T as ii}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-1088f2fb.js";import{C as G}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as pe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as he}from"../../chunks/ExampleCodeBlock-5212b321.js";function Bd($){let l,b,p,f,k;return f=new G({props:{code:`from transformers import PLBartModel, PLBartConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(r,g){_(r,l,g),e(l,b),e(l,p),e(p,f),e(l,k)},d(r){r&&o(l)}}}function Cd($){let l,b,p,f,k;return f=new G({props:{code:`from transformers import PLBartTokenizer, PLBartModel
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17320/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/tokenization_plbart.py#L324",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ft=new pe({}),gt=new I({props:{name:"class transformers.PLBartModel",anchor:"transformers.PLBartModel",parameters:[{name:"config",val:": PLBartConfig"}],parametersDescription:[{anchor:"transformers.PLBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17320/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17320/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/modeling_plbart.py#L1118"}}),vt=new I({props:{name:"forward",anchor:"transformers.PLBartModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.PLBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17320/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
See <a href="/docs/transformers/pr_17320/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17320/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17320/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/modeling_plbart.py#L1144",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17320/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17320/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/modeling_plbart.py#L1277",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17320/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/modeling_plbart.py#L1416",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17320/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
`}}),Be=new ii({props:{$$slots:{default:[Md]},$$scope:{ctx:$}}}),xe=new he({props:{anchor:"transformers.PLBartForSequenceClassification.forward.example",$$slots:{default:[Sd]},$$scope:{ctx:$}}}),Fe=new he({props:{anchor:"transformers.PLBartForSequenceClassification.forward.example-2",$$slots:{default:[Ad]},$$scope:{ctx:$}}}),Ce=new he({props:{anchor:"transformers.PLBartForSequenceClassification.forward.example-3",$$slots:{default:[Nd]},$$scope:{ctx:$}}}),je=new he({props:{anchor:"transformers.PLBartForSequenceClassification.forward.example-4",$$slots:{default:[Od]},$$scope:{ctx:$}}}),jt=new pe({}),Et=new I({props:{name:"class transformers.PLBartForCausalLM",anchor:"transformers.PLBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/modeling_plbart.py#L1540"}}),Mt=new I({props:{name:"forward",anchor:"transformers.PLBartForCausalLM.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.PLBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17320/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a>. See <a href="/docs/transformers/pr_17320/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17320/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17320/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17320/src/transformers/models/plbart/modeling_plbart.py#L1571",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17320/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
`),it=n("a"),wa=i("SentencePiece"),Pa=i("."),La=u(),dt=n("p"),$a=i("The tokenization method is "),Fo=n("code"),qa=i("<tokens> <eos> <language code>"),za=i(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Ba=u(),v(ve.$$.fragment),xa=u(),ye=n("div"),v(lt.$$.fragment),Fa=u(),Co=n("p"),Ca=i(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wr=u(),O=n("div"),v($t.$$.fragment),Pr=u(),re=n("p"),Lr=i("The "),Qt=n("a"),$r=i("PLBartForConditionalGeneration"),qr=i(" forward method, overrides the "),Ro=n("code"),zr=i("__call__"),Br=i(" special method."),xr=u(),v($e.$$.fragment),Fr=u(),v(qe.$$.fragment),Bn=u(),ie=n("h2"),ze=n("a"),Wo=n("span"),v(qt.$$.fragment),Cr=u(),Ho=n("span"),jr=i("PLBartForSequenceClassification"),xn=u(),B=n("div"),v(zt.$$.fragment),Er=u(),Uo=n("p"),Mr=i(`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ir=u(),xt=n("p"),Dr=i("This model is also a PyTorch "),Ft=n("a"),Xr=i("torch.nn.Module"),Gr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr=u(),z=n("div"),v(Ct.$$.fragment),Wr=u(),de=n("p"),Hr=i("The "),Zt=n("a"),Ur=i("PLBartForSequenceClassification"),Vr=i(" forward method, overrides the "),Vo=n("code"),Jr=i("__call__"),Kr=i(" special method."),Qr=u(),v(Be.$$.fragment),Yr=u(),v(xe.$$.fragment),Zr=u(),v(Fe.$$.fragment),ei=u(),v(Ce.$$.fragment),ti=u(),v(je.$$.fragment),Fn=u(),le=n("h2"),Ee=n("a"),Jo=n("span"),v(jt.$$.fragment),oi=u(),Ko=n("span"),ni=i("PLBartForCausalLM"),Cn=u(),ce=n("div"),v(Et.$$.fragment),si=u(),Me=n("div"),v(Mt.$$.fragment),ai=u(),v(Se.$$.fragment),this.h()},l(t){const h=qd('[data-svelte="svelte-1phssyn"]',document.head);l=s(h,"META",{name:!0,content:!0}),h.forEach(o),b=m(t),p=s(t,"H1",{class:!0});var St=a(p);f=s(St,"A",{id:!0,class:!0,href:!0});var Qo=a(f);k=s(Qo,"SPAN",{});var Yo=a(k);y(r.$$.fragment,Yo),Yo.forEach(o),Qo.forEach(o),g=m(St),x=s(St,"SPAN",{});var Zo=a(x);ns=d(Zo,"PLBart"),Zo.forEach(o),St.forEach(o),rn=m(t),D=s(t,"P",{});var U=a(D);co=s(U,"STRONG",{});var en=a(co);ss=d(en,"DISCLAIMER:"),en.forEach(o),as=d(U," If you see something strange, file a "),Re=s(U,"A",{href:!0,rel:!0});var tn=a(Re);rs=d(tn,"Github Issue"),tn.forEach(o),is=d(U,` and assign
...
Furthermore, analysis reveals that PLBART learns program syntax, style (e.g., identifier naming convention), logical flow
(e.g., if block inside an else block is equivalent to else if block) that are crucial to program semantics and thus excels
even with limited annotations.`),hi.forEach(o),pi.forEach(o),hn=m(t),W=s(t,"P",{});var to=a(W);ks=d(to,"This model was contributed by "),Ve=s(to,"A",{href:!0,rel:!0});var ui=a(Ve);vs=d(ui,"gchhablani"),ui.forEach(o),ys=d(to,". The Authors\u2019 code can be found "),Je=s(to,"A",{href:!0,rel:!0});var mi=a(Je);Ts=d(mi,"here"),mi.forEach(o),ws=d(to,"."),to.forEach(o),un=m(t),Q=s(t,"H3",{class:!0});var En=a(Q);fe=s(En,"A",{id:!0,class:!0,href:!0});var fi=a(fe);fo=s(fi,"SPAN",{});var gi=a(fo);y(Ke.$$.fragment,gi),gi.forEach(o),fi.forEach(o),Ps=m(En),go=s(En,"SPAN",{});var _i=a(go);Ls=d(_i,"Training of PLBart"),_i.forEach(o),En.forEach(o),mn=m(t),F=s(t,"P",{});var V=a(F);$s=d(V,`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
example shows how to translate Python to English using the `),Lo=s(no,"CODE",{});var xi=a(Lo);Ks=d(xi,"uclanlp/plbart-python-en_XX"),xi.forEach(o),Qs=d(no," model."),no.forEach(o),Sn.forEach(o),qi.forEach(o),vn=m(t),y(tt.$$.fragment,t),yn=m(t),Z=s(t,"H2",{class:!0});var An=a(Z);_e=s(An,"A",{id:!0,class:!0,href:!0});var Fi=a(_e);$o=s(Fi,"SPAN",{});var Ci=a($o);y(ot.$$.fragment,Ci),Ci.forEach(o),Fi.forEach(o),Ys=m(An),qo=s(An,"SPAN",{});var ji=a(qo);Zs=d(ji,"PLBartConfig"),ji.forEach(o),An.forEach(o),Tn=m(t),E=s(t,"DIV",{class:!0});var Ae=a(E);y(nt.$$.fragment,Ae),ea=m(Ae),ee=s(Ae,"P",{});var so=a(ee);ta=d(so,"This is the configuration class to store the configuration of a "),Gt=s(so,"A",{href:!0});var Ei=a(Gt);oa=d(Ei,"PLBartModel"),Ei.forEach(o),na=d(so,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
documentation from `),Wt=s(ao,"A",{href:!0});var Ai=a(Wt);ca=d(Ai,"PretrainedConfig"),Ai.forEach(o),pa=d(ao," for more information."),ao.forEach(o),ha=m(Ae),y(be.$$.fragment,Ae),Ae.forEach(o),wn=m(t),oe=s(t,"H2",{class:!0});var Nn=a(oe);ke=s(Nn,"A",{id:!0,class:!0,href:!0});var Ni=a(ke);zo=s(Ni,"SPAN",{});var Oi=a(zo);y(at.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),ua=m(Nn),Bo=s(Nn,"SPAN",{});var Ii=a(Bo);ma=d(Ii,"PLBartTokenizer"),Ii.forEach(o),Nn.forEach(o),Pn=m(t),q=s(t,"DIV",{class:!0});var C=a(q);y(rt.$$.fragment,C),fa=m(C),xo=s(C,"P",{});var Di=a(xo);ga=d(Di,"Construct an PLBART tokenizer."),Di.forEach(o),_a=m(C),X=s(C,"P",{});var Ne=a(X);ba=d(Ne,"Adapted from "),Ht=s(Ne,"A",{href:!0});var Xi=a(Ht);ka=d(Xi,"RobertaTokenizer"),Xi.forEach(o),va=d(Ne," and "),Ut=s(Ne,"A",{href:!0});var Gi=a(Ut);ya=d(Gi,"XLNetTokenizer"),Gi.forEach(o),Ta=d(Ne,`. Based on
`),it=s(Ne,"A",{href:!0,rel:!0});var Ri=a(it);wa=d(Ri,"SentencePiece"),Ri.forEach(o),Pa=d(Ne,"."),Ne.forEach(o),La=m(C),dt=s(C,"P",{});var On=a(dt);$a=d(On,"The tokenization method is "),Fo=s(On,"CODE",{});var Wi=a(Fo);qa=d(Wi,"<tokens> <eos> <language code>"),Wi.forEach(o),za=d(On," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),On.forEach(o),Ba=m(C),y(ve.$$.fragment,C),xa=m(C),ye=s(C,"DIV",{class:!0});var In=a(ye);y(lt.$$.fragment,In),Fa=m(In),Co=s(In,"P",{});var Hi=a(Co);Ca=d(Hi,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Hi.forEach(o),In.forEach(o),ja=m(C),A=s(C,"DIV",{class:!0});var Oe=a(A);y(ct.$$.fragment,Oe),Ea=m(Oe),pt=s(Oe,"P",{});var Dn=a(pt);Ma=d(Dn,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),Yi.forEach(o),Oe.forEach(o),C.forEach(o),Ln=m(t),ne=s(t,"H2",{class:!0});var Wn=a(ne);Te=s(Wn,"A",{id:!0,class:!0,href:!0});var Zi=a(Te);Oo=s(Zi,"SPAN",{});var ed=a(Oo);y(ft.$$.fragment,ed),ed.forEach(o),Zi.forEach(o),Va=m(Wn),Io=s(Wn,"SPAN",{});var td=a(Io);Ja=d(td,"PLBartModel"),td.forEach(o),Wn.forEach(o),$n=m(t),M=s(t,"DIV",{class:!0});var Ie=a(M);y(gt.$$.fragment,Ie),Ka=m(Ie),_t=s(Ie,"P",{});var Hn=a(_t);Qa=d(Hn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kn.forEach(o),wr=m(Xe),O=s(Xe,"DIV",{class:!0});var Ge=a(O);y($t.$$.fragment,Ge),Pr=m(Ge),re=s(Ge,"P",{});var io=a(re);Lr=d(io,"The "),Qt=s(io,"A",{href:!0});var pd=a(Qt);$r=d(pd,"PLBartForConditionalGeneration"),pd.forEach(o),qr=d(io," forward method, overrides the "),Ro=s(io,"CODE",{});var hd=a(Ro);zr=d(hd,"__call__"),hd.forEach(o),Br=d(io," special method."),io.forEach(o),xr=m(Ge),y($e.$$.fragment,Ge),Fr=m(Ge),y(qe.$$.fragment,Ge),Ge.forEach(o),Xe.forEach(o),Bn=m(t),ie=s(t,"H2",{class:!0});var Qn=a(ie);ze=s(Qn,"A",{id:!0,class:!0,href:!0});var ud=a(ze);Wo=s(ud,"SPAN",{});var md=a(Wo);y(qt.$$.fragment,md),md.forEach(o),ud.forEach(o),Cr=m(Qn),Ho=s(Qn,"SPAN",{});var fd=a(Ho);jr=d(fd,"PLBartForSequenceClassification"),fd.forEach(o),Qn.forEach(o),xn=m(t),B=s(t,"DIV",{class:!0});var J=a(B);y(zt.$$.fragment,J),Er=m(J),Uo=s(J,"P",{});var gd=a(Uo);Mr=d(gd,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
