...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var V=n(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,p,u),e(p,v),e(p,m),e(m,g),e(p,T)},d(_){_&&t(p)}}}function km(I){let p,v,m,g,T,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae,E,M,z,Me,se,L,je,Te,Xo,tr,sn,Zo,Oa,or,nn,Qo,ar,rn,N,Vt,sr,Et,nr,rr,ir,Da,lr,dr,kt,cr,Yo,pr,hr,mr,Pe,fr,Sa,ur,gr,It,_r,vr,Tr,Ce,wr,Mt,br,yr,jt,$r,xr,Fr,qe,Vr,Pt,Er,kr,Ct,Ir,Mr,jr,Wa,Pr,ln,ea,Cr,dn,le,Ba,P,ta,qr,Ar,oa,zr,Nr,aa,Lr,Or,Ua,Dr,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,sa,Kr,Gr,Xr,Ka,na,ra,Zr,Qr,Yr,Ga,qt,ei,At,ti,oi,ai,Xa,ia,la,si,ni,cn,we,ri,zt,ii,li,Nt,di,ci,pn,et,pi,Lt,hi,mi,hn,Ae,tt,Za,Ot,fi,Qa,ui,mn,U,Dt,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,pa,Vi,Ei,ki,Ya,Ii,Mi,Wt,fn,Le,ot,es,Bt,ji,ts,Pi,un,ne,Ut,Ci,os,qi,Ai,Rt,zi,ha,Ni,Li,Oi,be,Ht,Di,as,Si,Wi,at,gn,Oe,st,ss,Jt,Bi,ns,Ui,_n,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,De,Zi,ma,Qi,Yi,rs,el,tl,ol,nt,al,is,sl,nl,Qt,vn,Se,rt,ls,Yt,rl,ds,il,Tn,fe,eo,ll,We,dl,cs,cl,pl,to,hl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,ps,Tl,wl,bl,it,yl,hs,$l,xl,ao,wn,Ue,lt,ms,so,Fl,fs,Vl,bn,re,no,El,us,kl,Il,ro,Ml,io,jl,Pl,Cl,K,lo,ql,Re,Al,ua,zl,Nl,gs,Ll,Ol,Dl,dt,Sl,_s,Wl,Bl,co,yn,He,ct,vs,po,Ul,Ts,Rl,$n,O,ho,Hl,ws,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,pt,ad,G,go,sd,Je,nd,_a,rd,id,bs,ld,dd,cd,ht,pd,ys,hd,md,_o,xn,Ke,mt,$s,vo,fd,xs,ud,Fn,D,To,gd,Fs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Vs,Pd,Cd,qd,ut,Ad,Es,zd,Nd,xo,Vn,Xe,gt,ks,Fo,Ld,Is,Od,En,q,Vo,Dd,Ms,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,qs,Po,ac,sc,As,Co,nc,rc,Z,qo,ic,Ze,lc,zs,dc,cc,Ns,pc,hc,mc,_t,fc,Ls,uc,gc,Ao,kn,Qe,vt,Os,zo,_c,Ds,vc,In,A,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Fc,Oo,Vc,Do,Ec,kc,Ic,Ws,Mc,jc,ge,Bs,So,Pc,Cc,Us,Wo,qc,Ac,Rs,Bo,zc,Nc,Hs,Uo,Lc,Oc,Q,Ro,Dc,Ye,Sc,Js,Wc,Bc,Ks,Uc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Mn;return _=new ve({}),k=new _e({props:{$$slots:{default:[_m]},$$scope:{ctx:I}}}),C=new ve({}),Ot=new ve({}),Dt=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16092/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16092/en/model_doc/vit#transformers.ViTConfig"
...
very good results compared to familiar convolutional architectures.`),Te=d(),Xo=a("p"),tr=r("The abstract from the paper is the following:"),sn=d(),Zo=a("p"),Oa=a("em"),or=r(`While the Transformer architecture has become the de-facto standard for natural language processing tasks, its
...
substantially fewer computational resources to train.`),nn=d(),Qo=a("p"),ar=r("Tips:"),rn=d(),N=a("ul"),Vt=a("li"),sr=r("Demo notebooks regarding inference as well as fine-tuning ViT on custom data can be found "),Et=a("a"),nr=r("here"),rr=r("."),ir=d(),Da=a("li"),lr=r(`To feed images to the Transformer encoder, each image is split into a sequence of fixed-size non-overlapping patches,
...
`),aa=a("a"),Lr=r("ViTForImageClassification"),Or=r(". There are 4 variants available (in 3 different sizes): "),Ua=a("em"),Dr=r("facebook/deit-tiny-patch16-224"),Sr=r(`,
...
go to him!`),hn=d(),Ae=a("h2"),tt=a("a"),Za=a("span"),w(Ot.$$.fragment),fi=d(),Qa=a("span"),ui=r("ViTConfig"),mn=d(),U=a("div"),w(Dt.$$.fragment),gi=d(),ze=a("p"),_i=r("This is the configuration class to store the configuration of a "),da=a("a"),vi=r("ViTModel"),Ti=r(`. It is used to instantiate an ViT
...
should refer to this superclass for more information regarding those methods.`),Oi=d(),be=a("div"),w(Ht.$$.fragment),Di=d(),as=a("p"),Si=r("Main method to prepare for the model one or several image(s)."),Wi=d(),w(at.$$.fragment),gn=d(),Oe=a("h2"),st=a("a"),ss=a("span"),w(Jt.$$.fragment),Bi=d(),ns=a("span"),Ui=r("ViTModel"),_n=d(),me=a("div"),w(Kt.$$.fragment),Ri=d(),Gt=a("p"),Hi=r(`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Xt=a("a"),Ji=r("torch.nn.Module"),Ki=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Gi=d(),H=a("div"),w(Zt.$$.fragment),Xi=d(),De=a("p"),Zi=r("The "),ma=a("a"),Qi=r("ViTModel"),Yi=r(" forward method, overrides the "),rs=a("code"),el=r("__call__"),tl=r(" special method."),ol=d(),w(nt.$$.fragment),al=d(),is=a("p"),sl=r("Example:"),nl=d(),w(Qt.$$.fragment),vn=d(),Se=a("h2"),rt=a("a"),ls=a("span"),w(Yt.$$.fragment),rl=d(),ds=a("span"),il=r("ViTForMaskedImageModeling"),Tn=d(),fe=a("div"),w(eo.$$.fragment),ll=d(),We=a("p"),dl=r("ViT Model with a decoder on top for masked image modeling, as proposed in "),cs=a("code"),cl=r("SimMIM <https://arxiv.org/abs/2111.09886>"),pl=r(`__.
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=d(),K=a("div"),w(lo.$$.fragment),ql=d(),Re=a("p"),Al=r("The "),ua=a("a"),zl=r("ViTForImageClassification"),Nl=r(" forward method, overrides the "),gs=a("code"),Ll=r("__call__"),Ol=r(" special method."),Dl=d(),w(dt.$$.fragment),Sl=d(),_s=a("p"),Wl=r("Example:"),Bl=d(),w(co.$$.fragment),yn=d(),He=a("h2"),ct=a("a"),vs=a("span"),w(po.$$.fragment),Ul=d(),Ts=a("span"),Rl=r("TFViTModel"),$n=d(),O=a("div"),w(ho.$$.fragment),Hl=d(),ws=a("p"),Jl=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Kl=d(),mo=a("p"),Gl=r("This model inherits from "),ga=a("a"),Xl=r("TFPreTrainedModel"),Zl=r(`. Check the superclass documentation for the generic methods the
...
behavior.`),od=d(),w(pt.$$.fragment),ad=d(),G=a("div"),w(go.$$.fragment),sd=d(),Je=a("p"),nd=r("The "),_a=a("a"),rd=r("TFViTModel"),id=r(" forward method, overrides the "),bs=a("code"),ld=r("__call__"),dd=r(" special method."),cd=d(),w(ht.$$.fragment),pd=d(),ys=a("p"),hd=r("Examples:"),md=d(),w(_o.$$.fragment),xn=d(),Ke=a("h2"),mt=a("a"),$s=a("span"),w(vo.$$.fragment),fd=d(),xs=a("span"),ud=r("TFViTForImageClassification"),Fn=d(),D=a("div"),w(To.$$.fragment),gd=d(),Fs=a("p"),_d=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),w(ft.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Id=r("The "),Ta=a("a"),Md=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),Vs=a("code"),Pd=r("__call__"),Cd=r(" special method."),qd=d(),w(ut.$$.fragment),Ad=d(),Es=a("p"),zd=r("Examples:"),Nd=d(),w(xo.$$.fragment),Vn=d(),Xe=a("h2"),gt=a("a"),ks=a("span"),w(Fo.$$.fragment),Ld=d(),Is=a("span"),Od=r("FlaxVitModel"),En=d(),q=a("div"),w(Vo.$$.fragment),Dd=d(),Ms=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),wa=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
`),aa=s(S,"A",{href:!0});var up=n(aa);Lr=i(up,"ViTForImageClassification"),up.forEach(t),Or=i(S,". There are 4 variants available (in 3 different sizes): "),Ua=s(S,"EM",{});var gp=n(Ua);Dr=i(gp,"facebook/deit-tiny-patch16-224"),gp.forEach(t),Sr=i(S,`,
...
go to him!`),qn.forEach(t),hn=c(o),Ae=s(o,"H2",{class:!0});var An=n(Ae);tt=s(An,"A",{id:!0,class:!0,href:!0});var Mp=n(tt);Za=s(Mp,"SPAN",{});var jp=n(Za);b(Ot.$$.fragment,jp),jp.forEach(t),Mp.forEach(t),fi=c(An),Qa=s(An,"SPAN",{});var Pp=n(Qa);ui=i(Pp,"ViTConfig"),Pp.forEach(t),An.forEach(t),mn=c(o),U=s(o,"DIV",{class:!0});var ye=n(U);b(Dt.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Va=n(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=s(Va,"A",{href:!0});var Cp=n(da);vi=i(Cp,"ViTModel"),Cp.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
documentation from `),pa=s(Ea,"A",{href:!0});var zp=n(pa);Vi=i(zp,"PretrainedConfig"),zp.forEach(t),Ei=i(Ea," for more information."),Ea.forEach(t),ki=c(ye),Ya=s(ye,"P",{});var Np=n(Ya);Ii=i(Np,"Example:"),Np.forEach(t),Mi=c(ye),b(Wt.$$.fragment,ye),ye.forEach(t),fn=c(o),Le=s(o,"H2",{class:!0});var zn=n(Le);ot=s(zn,"A",{id:!0,class:!0,href:!0});var Lp=n(ot);es=s(Lp,"SPAN",{});var Op=n(es);b(Bt.$$.fragment,Op),Op.forEach(t),Lp.forEach(t),ji=c(zn),ts=s(zn,"SPAN",{});var Dp=n(ts);Pi=i(Dp,"ViTFeatureExtractor"),Dp.forEach(t),zn.forEach(t),un=c(o),ne=s(o,"DIV",{class:!0});var bt=n(ne);b(Ut.$$.fragment,bt),Ci=c(bt),os=s(bt,"P",{});var Sp=n(os);qi=i(Sp,"Constructs a ViT feature extractor."),Sp.forEach(t),Ai=c(bt),Rt=s(bt,"P",{});var Nn=n(Rt);zi=i(Nn,"This feature extractor inherits from "),ha=s(Nn,"A",{href:!0});var Wp=n(ha);Ni=i(Wp,"FeatureExtractionMixin"),Wp.forEach(t),Li=i(Nn,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Nn.forEach(t),Oi=c(bt),be=s(bt,"DIV",{class:!0});var ka=n(be);b(Ht.$$.fragment,ka),Di=c(ka),as=s(ka,"P",{});var Bp=n(as);Si=i(Bp,"Main method to prepare for the model one or several image(s)."),Bp.forEach(t),Wi=c(ka),b(at.$$.fragment,ka),ka.forEach(t),bt.forEach(t),gn=c(o),Oe=s(o,"H2",{class:!0});var Ln=n(Oe);st=s(Ln,"A",{id:!0,class:!0,href:!0});var Up=n(st);ss=s(Up,"SPAN",{});var Rp=n(ss);b(Jt.$$.fragment,Rp),Rp.forEach(t),Up.forEach(t),Bi=c(Ln),ns=s(Ln,"SPAN",{});var Hp=n(ns);Ui=i(Hp,"ViTModel"),Hp.forEach(t),Ln.forEach(t),_n=c(o),me=s(o,"DIV",{class:!0});var Ia=n(me);b(Kt.$$.fragment,Ia),Ri=c(Ia),Gt=s(Ia,"P",{});var On=n(Gt);Hi=i(On,`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Xt=s(On,"A",{href:!0,rel:!0});var Jp=n(Xt);Ji=i(Jp,"torch.nn.Module"),Jp.forEach(t),Ki=i(On,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),On.forEach(t),Gi=c(Ia),H=s(Ia,"DIV",{class:!0});var $e=n(H);b(Zt.$$.fragment,$e),Xi=c($e),De=s($e,"P",{});var Ma=n(De);Zi=i(Ma,"The "),ma=s(Ma,"A",{href:!0});var Kp=n(ma);Qi=i(Kp,"ViTModel"),Kp.forEach(t),Yi=i(Ma," forward method, overrides the "),rs=s(Ma,"CODE",{});var Gp=n(rs);el=i(Gp,"__call__"),Gp.forEach(t),tl=i(Ma," special method."),Ma.forEach(t),ol=c($e),b(nt.$$.fragment,$e),al=c($e),is=s($e,"P",{});var Xp=n(is);sl=i(Xp,"Example:"),Xp.forEach(t),nl=c($e),b(Qt.$$.fragment,$e),$e.forEach(t),Ia.forEach(t),vn=c(o),Se=s(o,"H2",{class:!0});var Dn=n(Se);rt=s(Dn,"A",{id:!0,class:!0,href:!0});var Zp=n(rt);ls=s(Zp,"SPAN",{});var Qp=n(ls);b(Yt.$$.fragment,Qp),Qp.forEach(t),Zp.forEach(t),rl=c(Dn),ds=s(Dn,"SPAN",{});var Yp=n(ds);il=i(Yp,"ViTForMaskedImageModeling"),Yp.forEach(t),Dn.forEach(t),Tn=c(o),fe=s(o,"DIV",{class:!0});var ja=n(fe);b(eo.$$.fragment,ja),ll=c(ja),We=s(ja,"P",{});var Pa=n(We);dl=i(Pa,"ViT Model with a decoder on top for masked image modeling, as proposed in "),cs=s(Pa,"CODE",{});var eh=n(cs);cl=i(eh,"SimMIM <https://arxiv.org/abs/2111.09886>"),eh.forEach(t),pl=i(Pa,`__.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rn.forEach(t),od=c(de),b(pt.$$.fragment,de),ad=c(de),G=s(de,"DIV",{class:!0});var Ve=n(G);b(go.$$.fragment,Ve),sd=c(Ve),Je=s(Ve,"P",{});var Aa=n(Je);nd=i(Aa,"The "),_a=s(Aa,"A",{href:!0});var Th=n(_a);rd=i(Th,"TFViTModel"),Th.forEach(t),id=i(Aa," forward method, overrides the "),bs=s(Aa,"CODE",{});var wh=n(bs);ld=i(wh,"__call__"),wh.forEach(t),dd=i(Aa," special method."),Aa.forEach(t),cd=c(Ve),b(ht.$$.fragment,Ve),pd=c(Ve),ys=s(Ve,"P",{});var bh=n(ys);hd=i(bh,"Examples:"),bh.forEach(t),md=c(Ve),b(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),xn=c(o),Ke=s(o,"H2",{class:!0});var Hn=n(Ke);mt=s(Hn,"A",{id:!0,class:!0,href:!0});var yh=n(mt);$s=s(yh,"SPAN",{});var $h=n($s);b(vo.$$.fragment,$h),$h.forEach(t),yh.forEach(t),fd=c(Hn),xs=s(Hn,"SPAN",{});var xh=n(xs);ud=i(xh,"TFViTForImageClassification"),xh.forEach(t),Hn.forEach(t),Fn=c(o),D=s(o,"DIV",{class:!0});var ce=n(D);b(To.$$.fragment,ce),gd=c(ce),Fs=s(ce,"P",{});var Fh=n(Fs);_d=i(Fh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kn.forEach(t),Vd=c(ce),b(ft.$$.fragment,ce),Ed=c(ce),X=s(ce,"DIV",{class:!0});var Ee=n(X);b($o.$$.fragment,Ee),kd=c(Ee),Ge=s(Ee,"P",{});var za=n(Ge);Id=i(za,"The "),Ta=s(za,"A",{href:!0});var kh=n(Ta);Md=i(kh,"TFViTForImageClassification"),kh.forEach(t),jd=i(za," forward method, overrides the "),Vs=s(za,"CODE",{});var Ih=n(Vs);Pd=i(Ih,"__call__"),Ih.forEach(t),Cd=i(za," special method."),za.forEach(t),qd=c(Ee),b(ut.$$.fragment,Ee),Ad=c(Ee),Es=s(Ee,"P",{});var Mh=n(Es);zd=i(Mh,"Examples:"),Mh.forEach(t),Nd=c(Ee),b(xo.$$.fragment,Ee),Ee.forEach(t),ce.forEach(t),Vn=c(o),Xe=s(o,"H2",{class:!0});var Gn=n(Xe);gt=s(Gn,"A",{id:!0,class:!0,href:!0});var jh=n(gt);ks=s(jh,"SPAN",{});var Ph=n(ks);b(Fo.$$.fragment,Ph),Ph.forEach(t),jh.forEach(t),Ld=c(Gn),Is=s(Gn,"SPAN",{});var Ch=n(Is);Od=i(Ch,"FlaxVitModel"),Ch.forEach(t),Gn.forEach(t),En=c(o),q=s(o,"DIV",{class:!0});var ee=n(q);b(Vo.$$.fragment,ee),Dd=c(ee),Ms=s(ee,"P",{});var qh=n(Ms);Sd=i(qh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),qh.forEach(t),Wd=c(ee),Eo=s(ee,"P",{});var Xn=n(Eo);Bd=i(Xn,"This model inherits from "),wa=s(Xn,"A",{href:!0});var Ah=n(wa);Ud=i(Ah,"FlaxPreTrainedModel"),Ah.forEach(t),Rd=i(Xn,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zn.forEach(t),Xd=c(ee),js=s(ee,"P",{});var Nh=n(js);Zd=i(Nh,"Finally, this model supports inherent JAX features such as:"),Nh.forEach(t),Qd=c(ee),ue=s(ee,"UL",{});var $t=n(ue);Ps=s($t,"LI",{});var Lh=n(Ps);Mo=s(Lh,"A",{href:!0,rel:!0});var Oh=n(Mo);Yd=i(Oh,"Just-In-Time (JIT) compilation"),Oh.forEach(t),Lh.forEach(t),ec=c($t),Cs=s($t,"LI",{});var Dh=n(Cs);jo=s(Dh,"A",{href:!0,rel:!0});var Sh=n(jo);tc=i(Sh,"Automatic Differentiation"),Sh.forEach(t),Dh.forEach(t),oc=c($t),qs=s($t,"LI",{});var Wh=n(qs);Po=s(Wh,"A",{href:!0,rel:!0});var Bh=n(Po);ac=i(Bh,"Vectorization"),Bh.forEach(t),Wh.forEach(t),sc=c($t),As=s($t,"LI",{});var Uh=n(As);Co=s(Uh,"A",{href:!0,rel:!0});var Rh=n(Co);nc=i(Rh,"Parallelization"),Rh.forEach(t),Uh.forEach(t),$t.forEach(t),rc=c(ee),Z=s(ee,"DIV",{class:!0});var ke=n(Z);b(qo.$$.fragment,ke),ic=c(ke),Ze=s(ke,"P",{});var Na=n(Ze);lc=i(Na,"The "),zs=s(Na,"CODE",{});var Hh=n(zs);dc=i(Hh,"FlaxViTPreTrainedModel"),Hh.forEach(t),cc=i(Na,"forward method, overrides the "),Ns=s(Na,"CODE",{});var Jh=n(Ns);pc=i(Jh,"__call__"),Jh.forEach(t),hc=i(Na," special method."),Na.forEach(t),mc=c(ke),b(_t.$$.fragment,ke),fc=c(ke),Ls=s(ke,"P",{});var Kh=n(Ls);uc=i(Kh,"Examples:"),Kh.forEach(t),gc=c(ke),b(Ao.$$.fragment,ke),ke.forEach(t),ee.forEach(t),kn=c(o),Qe=s(o,"H2",{class:!0});var Qn=n(Qe);vt=s(Qn,"A",{id:!0,class:!0,href:!0});var Gh=n(vt);Os=s(Gh,"SPAN",{});var Xh=n(Os);b(zo.$$.fragment,Xh),Xh.forEach(t),Gh.forEach(t),_c=c(Qn),Ds=s(Qn,"SPAN",{});var Zh=n(Ds);vc=i(Zh,"FlaxViTForImageClassification"),Zh.forEach(t),Qn.forEach(t),In=c(o),A=s(o,"DIV",{class:!0});var te=n(A);b(No.$$.fragment,te),Tc=c(te),Ss=s(te,"P",{});var Qh=n(Ss);wc=i(Qh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
