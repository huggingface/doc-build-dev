...
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function W5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
model.parallelize(device_map)`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Example:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function B5(j){let p,b,g,u,T;return u=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function Y5(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,W,A,re,pe,C,N,he,K,ye,ue,R,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,B,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),W=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),R=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),be=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ke=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),E=r(te,"LI",{});var et=i(E);Ee=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),q=r(z,"P",{});var D=i(q);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),qe=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),R=r(Y,"CODE",{});var Le=i(R);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),be=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ke=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(Ie,"CODE",{});var st=i(B);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,W,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,R),e(R,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,B),e(B,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(W),z&&t(A),z&&t(pe),z&&t(C)}}}function Z5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function X5(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,W,A,re,pe,C,N,he,K,ye,ue,R,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,B,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),W=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),R=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),be=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ke=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),E=r(te,"LI",{});var et=i(E);Ee=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),q=r(z,"P",{});var D=i(q);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),qe=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),R=r(Y,"CODE",{});var Le=i(R);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),be=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ke=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(Ie,"CODE",{});var st=i(B);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,W,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,R),e(R,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,B),e(B,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(W),z&&t(A),z&&t(pe),z&&t(C)}}}function Q5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18131/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18131/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18131/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18131/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18131/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18131/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18131/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_t5.py#L1538",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_t5.py#L1809",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
`}}),Wn=new kt({props:{$$slots:{default:[U5]},$$scope:{ctx:j}}}),Rn=new ge({props:{anchor:"transformers.T5EncoderModel.forward.example",$$slots:{default:[W5]},$$scope:{ctx:j}}}),ma=new M({props:{name:"parallelize",anchor:"transformers.T5EncoderModel.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the t5 models have the
following number of attention modules:</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_tf_t5.py#L1146",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_tf_t5.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18131/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18131/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18131/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_tf_t5.py#L1569",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
behavior.`),ST=d(),k(Kn.$$.fragment),GT=d(),mt=a("div"),k(wa.$$.fragment),UT=d(),Qt=a("p"),WT=o("The "),Wr=a("a"),RT=o("TFT5Model"),BT=o(" forward method, overrides the "),rd=a("code"),HT=o("__call__"),VT=o(" special method."),KT=d(),k(Yn.$$.fragment),YT=d(),k(Zn.$$.fragment),Qc=d(),en=a("h2"),Jn=a("a"),id=a("span"),k($a.$$.fragment),ZT=d(),ld=a("span"),JT=o("TFT5ForConditionalGeneration"),ep=d(),de=a("div"),k(xa.$$.fragment),XT=d(),za=a("p"),QT=o("T5 Model with a "),dd=a("code"),e1=o("language modeling"),t1=o(" head on top."),n1=d(),ja=a("p"),o1=o("The T5 model was proposed in "),Ea=a("a"),s1=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),a1=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),r1=d(),qa=a("p"),i1=o("This model inherits from "),Rr=a("a"),l1=o("TFPreTrainedModel"),d1=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c1=d(),Fa=a("p"),p1=o("This model is also a "),Ma=a("a"),h1=o("tf.keras.Model"),u1=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),m1=d(),k(Xn.$$.fragment),f1=d(),ft=a("div"),k(Ca.$$.fragment),_1=d(),tn=a("p"),g1=o("The "),Br=a("a"),T1=o("TFT5ForConditionalGeneration"),b1=o(" forward method, overrides the "),cd=a("code"),k1=o("__call__"),v1=o(" special method."),y1=d(),k(Qn.$$.fragment),w1=d(),k(eo.$$.fragment),tp=d(),nn=a("h2"),to=a("a"),pd=a("span"),k(Pa.$$.fragment),$1=d(),hd=a("span"),x1=o("TFT5EncoderModel"),np=d(),ce=a("div"),k(Na.$$.fragment),z1=d(),ud=a("p"),j1=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),E1=d(),Oa=a("p"),q1=o("The T5 model was proposed in "),La=a("a"),F1=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),M1=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),C1=d(),Aa=a("p"),P1=o("This model inherits from "),Hr=a("a"),N1=o("TFPreTrainedModel"),O1=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),L1=d(),Ia=a("p"),A1=o("This model is also a "),Da=a("a"),I1=o("tf.keras.Model"),D1=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),S1=d(),k(no.$$.fragment),G1=d(),_t=a("div"),k(Sa.$$.fragment),U1=d(),on=a("p"),W1=o("The "),Vr=a("a"),R1=o("TFT5EncoderModel"),B1=o(" forward method, overrides the "),md=a("code"),H1=o("__call__"),V1=o(" special method."),K1=d(),k(oo.$$.fragment),Y1=d(),k(so.$$.fragment),op=d(),sn=a("h2"),ao=a("a"),fd=a("span"),k(Ga.$$.fragment),Z1=d(),_d=a("span"),J1=o("FlaxT5Model"),sp=d(),Je=a("div"),k(Ua.$$.fragment),X1=d(),gt=a("div"),k(Wa.$$.fragment),Q1=d(),an=a("p"),eb=o("The "),gd=a("code"),tb=o("FlaxT5PreTrainedModel"),nb=o(" forward method, overrides the "),Td=a("code"),ob=o("__call__"),sb=o(" special method."),ab=d(),k(ro.$$.fragment),rb=d(),k(io.$$.fragment),ib=d(),lo=a("div"),k(Ra.$$.fragment),lb=d(),k(co.$$.fragment),db=d(),po=a("div"),k(Ba.$$.fragment),cb=d(),k(ho.$$.fragment),ap=d(),rn=a("h2"),uo=a("a"),bd=a("span"),k(Ha.$$.fragment),pb=d(),kd=a("span"),hb=o("FlaxT5ForConditionalGeneration"),rp=d(),Xe=a("div"),k(Va.$$.fragment),ub=d(),Tt=a("div"),k(Ka.$$.fragment),mb=d(),ln=a("p"),fb=o("The "),vd=a("code"),_b=o("FlaxT5PreTrainedModel"),gb=o(" forward method, overrides the "),yd=a("code"),Tb=o("__call__"),bb=o(" special method."),kb=d(),k(mo.$$.fragment),vb=d(),k(fo.$$.fragment),yb=d(),_o=a("div"),k(Ya.$$.fragment),wb=d(),k(go.$$.fragment),$b=d(),To=a("div"),k(Za.$$.fragment),xb=d(),k(bo.$$.fragment),ip=d(),dn=a("h2"),ko=a("a"),wd=a("span"),k(Ja.$$.fragment),zb=d(),$d=a("span"),jb=o("FlaxT5EncoderModel"),lp=d(),cn=a("div"),k(Xa.$$.fragment),Eb=d(),Pt=a("div"),k(Qa.$$.fragment),qb=d(),pn=a("p"),Fb=o("The "),Kr=a("a"),Mb=o("FlaxT5EncoderModel"),Cb=o(" forward method, overrides the "),xd=a("code"),Pb=o("__call__"),Nb=o(" special method."),Ob=d(),k(vo.$$.fragment),this.h()},l(n){const f=C5('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),b=c(n),g=r(n,"H1",{class:!0});var er=i(g);u=r(er,"A",{id:!0,class:!0,href:!0});var zd=i(u);T=r(zd,"SPAN",{});var jd=i(T);v(l.$$.fragment,jd),jd.forEach(t),zd.forEach(t),_=c(er),E=r(er,"SPAN",{});var Ed=i(E);Ee=s(Ed,"T5"),Ed.forEach(t),er.forEach(t),se=c(n),q=r(n,"H2",{class:!0});var tr=i(q);ee=r(tr,"A",{id:!0,class:!0,href:!0});var qd=i(ee);G=r(qd,"SPAN",{});var Fd=i(G);v(ae.$$.fragment,Fd),Fd.forEach(t),qd.forEach(t),qe=c(tr),U=r(tr,"SPAN",{});var Md=i(U);Fe=s(Md,"Overview"),Md.forEach(t),tr.forEach(t),ve=c(n),W=r(n,"P",{});var nr=i(W);A=s(nr,"The T5 model was presented in "),re=r(nr,"A",{href:!0,rel:!0});var Cd=i(re);pe=s(Cd,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Cd.forEach(t),C=s(nr,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),B=r(un,"EM",{});var Dd=i(B);Oe=s(Dd,"summarize: \u2026"),Dd.forEach(t),z=s(un,"."),un.forEach(t),Ad.forEach(t),F=c(hn),te=r(hn,"LI",{});var Sd=i(te);Ge=r(Sd,"P",{});var Gd=i(Ge);et=s(Gd,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),Gd.forEach(t),Sd.forEach(t),D=c(hn),Ue=r(hn,"LI",{});var Ud=i(Ue);ne=r(Ud,"P",{});var wt=i(ne);tt=s(wt,"See the "),L=r(wt,"A",{href:!0});var Wd=i(L);Y=s(Wd,"training"),Wd.forEach(t),nt=s(wt,", "),Le=r(wt,"A",{href:!0});var Rd=i(Le);Z=s(Rd,"inference"),Rd.forEach(t),ot=s(wt," and "),Ae=r(wt,"A",{href:!0});var Bd=i(Ae);Ie=s(Bd,"scripts"),Bd.forEach(t),st=s(wt," sections below for all details regarding usage."),wt.forEach(t),Ud.forEach(t),hn.forEach(t),Xd=c(n),or=r(n,"P",{});var Hd=i(or);hh=s(Hd,"T5 comes in different sizes:"),Hd.forEach(t),Qd=c(n),We=r(n,"UL",{});var Qe=i(We);Ti=r(Qe,"LI",{});var Vd=i(Ti);bi=r(Vd,"P",{});var Kd=i(bi);Do=r(Kd,"A",{href:!0,rel:!0});var Gb=i(Do);uh=s(Gb,"t5-small"),Gb.forEach(t),Kd.forEach(t),Vd.forEach(t),mh=c(Qe),ki=r(Qe,"LI",{});var Ub=i(ki);vi=r(Ub,"P",{});var Wb=i(vi);So=r(Wb,"A",{href:!0,rel:!0});var Rb=i(So);fh=s(Rb,"t5-base"),Rb.forEach(t),Wb.forEach(t),Ub.forEach(t),_h=c(Qe),yi=r(Qe,"LI",{});var Bb=i(yi);wi=r(Bb,"P",{});var Hb=i(wi);Go=r(Hb,"A",{href:!0,rel:!0});var Vb=i(Go);gh=s(Vb,"t5-large"),Vb.forEach(t),Hb.forEach(t),Bb.forEach(t),Th=c(Qe),$i=r(Qe,"LI",{});var Kb=i($i);xi=r(Kb,"P",{});var Yb=i(xi);Uo=r(Yb,"A",{href:!0,rel:!0});var Zb=i(Uo);bh=s(Zb,"t5-3b"),Zb.forEach(t),Yb.forEach(t),Kb.forEach(t),kh=c(Qe),zi=r(Qe,"LI",{});var Jb=i(zi);sr=r(Jb,"P",{});var Lb=i(sr);Wo=r(Lb,"A",{href:!0,rel:!0});var Xb=i(Wo);vh=s(Xb,"t5-11b"),Xb.forEach(t),yh=s(Lb,"."),Lb.forEach(t),Jb.forEach(t),Qe.forEach(t),ec=c(n),ar=r(n,"P",{});var Qb=i(ar);wh=s(Qb,"Based on the original T5 model, Google has released some follow-up works:"),Qb.forEach(t),tc=c(n),$t=r(n,"UL",{});var Yr=i($t);ji=r(Yr,"LI",{});var ek=i(ji);mn=r(ek,"P",{});var Yd=i(mn);Ei=r(Yd,"STRONG",{});var tk=i(Ei);$h=s(tk,"T5v1.1"),tk.forEach(t),xh=s(Yd,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),lr=r(Jd,"A",{href:!0});var lk=i(lr);Lh=s(lk,"here"),lk.forEach(t),Ah=s(Jd,"."),Jd.forEach(t),rk.forEach(t),Yr.forEach(t),nc=c(n),gn=r(n,"P",{});var cp=i(gn);Ih=s(cp,"All checkpoints can be found on the "),Ro=r(cp,"A",{href:!0,rel:!0});var dk=i(Ro);Dh=s(dk,"hub"),dk.forEach(t),Sh=s(cp,"."),cp.forEach(t),oc=c(n),xt=r(n,"P",{});var Zr=i(xt);Gh=s(Zr,"This model was contributed by "),Bo=r(Zr,"A",{href:!0,rel:!0});var ck=i(Bo);Uh=s(ck,"thomwolf"),ck.forEach(t),Wh=s(Zr,". The original code can be found "),Ho=r(Zr,"A",{href:!0,rel:!0});var pk=i(Ho);Rh=s(pk,"here"),pk.forEach(t),Bh=s(Zr,"."),Zr.forEach(t),sc=c(n),dr=r(n,"A",{id:!0}),i(dr).forEach(t),ac=c(n),Lt=r(n,"H2",{class:!0});var pp=i(Lt);Tn=r(pp,"A",{id:!0,class:!0,href:!0});var hk=i(Tn);Pi=r(hk,"SPAN",{});var uk=i(Pi);v(Vo.$$.fragment,uk),uk.forEach(t),hk.forEach(t),Hh=c(pp),Ni=r(pp,"SPAN",{});var mk=i(Ni);Vh=s(mk,"Training"),mk.forEach(t),pp.forEach(t),rc=c(n),at=r(n,"P",{});var yo=i(at);Kh=s(yo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),hp.forEach(t),lc=c(n),pr=r(n,"UL",{});var bk=i(pr);Ii=r(bk,"LI",{});var kk=i(Ii);su=s(kk,"Unsupervised denoising training"),kk.forEach(t),bk.forEach(t),dc=c(n),me=r(n,"P",{});var Be=i(me);au=s(Be,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Di=r(Be,"EM",{});var vk=i(Di);ru=s(vk,"a.k.a"),vk.forEach(t),iu=s(Be,` unique mask tokens) and
...
processed as follows:`),jk.forEach(t),pc=c(n),v(Ko.$$.fragment,n),hc=c(n),kn=r(n,"P",{});var up=i(kn);bu=s(up,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Yo=r(up,"A",{href:!0,rel:!0});var Ek=i(Yo);ku=s(Ek,"run_t5_mlm_flax.py"),Ek.forEach(t),vu=s(up,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Mk.forEach(t),fc=c(n),v(Zo.$$.fragment,n),_c=c(n),oe=r(n,"P",{});var $e=i(oe);$u=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Bi=r($e,"CODE",{});var Ck=i(Bi);xu=s(Ck,"input_ids"),Ck.forEach(t),zu=s($e,` (which are the
...
ignored. The code example below illustrates all of this.`),He.forEach(t),bc=c(n),v(Xo.$$.fragment,n),kc=c(n),_r=r(n,"P",{});var Vk=i(_r);om=s(Vk,"Additional training tips:"),Vk.forEach(t),vc=c(n),gr=r(n,"UL",{});var Kk=i(gr);Qo=r(Kk,"LI",{});var mp=i(Qo);sm=s(mp,"T5 models need a slightly higher learning rate than the default one set in the "),al=r(mp,"CODE",{});var Yk=i(al);am=s(Yk,"Trainer"),Yk.forEach(t),rm=s(mp,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),fp.forEach(t),$c=c(n),Tr=r(n,"A",{id:!0}),i(Tr).forEach(t),xc=c(n),At=r(n,"H2",{class:!0});var _p=i(At);yn=r(_p,"A",{id:!0,class:!0,href:!0});var Qk=i(yn);il=r(Qk,"SPAN",{});var ev=i(il);v(ns.$$.fragment,ev),ev.forEach(t),Qk.forEach(t),fm=c(_p),ll=r(_p,"SPAN",{});var tv=i(ll);_m=s(tv,"Inference"),tv.forEach(t),_p.forEach(t),zc=c(n),rt=r(n,"P",{});var wo=i(rt);gm=s(wo,"At inference time, it is recommended to use "),br=r(wo,"A",{href:!0});var nv=i(br);Tm=s(nv,"generate()"),nv.forEach(t),bm=s(wo,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),os=r(wo,"A",{href:!0,rel:!0});var ov=i(os);km=s(ov,"this blog post"),ov.forEach(t),vm=s(wo,` to know all the details about generating text with Transformers.
There\u2019s also `),ss=r(wo,"A",{href:!0,rel:!0});var sv=i(ss);ym=s(sv,"this blog post"),sv.forEach(t),wm=s(wo,` which explains how
generation works in general in encoder-decoder models.`),wo.forEach(t),jc=c(n),v(as.$$.fragment,n),Ec=c(n),Re=r(n,"P",{});var Nt=i(Re);$m=s(Nt,"Note that T5 uses the "),dl=r(Nt,"CODE",{});var av=i(dl);xm=s(av,"pad_token_id"),av.forEach(t),zm=s(Nt," as the "),cl=r(Nt,"CODE",{});var rv=i(cl);jm=s(rv,"decoder_start_token_id"),rv.forEach(t),Em=s(Nt,`, so when doing generation without using
`),kr=r(Nt,"A",{href:!0});var iv=i(kr);qm=s(iv,"generate()"),iv.forEach(t),Fm=s(Nt,", make sure you start it with the "),pl=r(Nt,"CODE",{});var lv=i(pl);Mm=s(lv,"pad_token_id"),lv.forEach(t),Cm=s(Nt,"."),Nt.forEach(t),qc=c(n),vr=r(n,"P",{});var dv=i(vr);Pm=s(dv,"The example above only shows a single example. You can also do batched inference, like so:"),dv.forEach(t),Fc=c(n),v(rs.$$.fragment,n),Mc=c(n),yr=r(n,"P",{});var cv=i(yr);Nm=s(cv,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),cv.forEach(t),Cc=c(n),v(is.$$.fragment,n),Pc=c(n),wr=r(n,"A",{id:!0}),i(wr).forEach(t),Nc=c(n),It=r(n,"H2",{class:!0});var gp=i(It);wn=r(gp,"A",{id:!0,class:!0,href:!0});var pv=i(wn);hl=r(pv,"SPAN",{});var hv=i(hl);v(ls.$$.fragment,hv),hv.forEach(t),pv.forEach(t),Om=c(gp),ul=r(gp,"SPAN",{});var uv=i(ul);Lm=s(uv,"Performance"),uv.forEach(t),gp.forEach(t),Oc=c(n),it=r(n,"P",{});var $o=i(it);Am=s($o,"If you\u2019d like a faster training and inference performance, install "),ds=r($o,"A",{href:!0,rel:!0});var mv=i(ds);Im=s(mv,"apex"),mv.forEach(t),Dm=s($o," and then the model will automatically use "),ml=r($o,"CODE",{});var fv=i(ml);Sm=s(fv,"apex.normalization.FusedRMSNorm"),fv.forEach(t),Gm=s($o," instead of "),fl=r($o,"CODE",{});var _v=i(fl);Um=s(_v,"T5LayerNorm"),_v.forEach(t),Wm=s($o,". The former uses an optimized fused kernel which is several times faster than the latter."),$o.forEach(t),Lc=c(n),Dt=r(n,"H2",{class:!0});var Tp=i(Dt);$n=r(Tp,"A",{id:!0,class:!0,href:!0});var gv=i($n);_l=r(gv,"SPAN",{});var Tv=i(_l);v(cs.$$.fragment,Tv),Tv.forEach(t),gv.forEach(t),Rm=c(Tp),gl=r(Tp,"SPAN",{});var bv=i(gl);Bm=s(bv,"Example scripts"),bv.forEach(t),Tp.forEach(t),Ac=c(n),$r=r(n,"P",{});var kv=i($r);Hm=s(kv,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),kv.forEach(t),Ic=c(n),xn=r(n,"UL",{});var bp=i(xn);Tl=r(bp,"LI",{});var vv=i(Tl);St=r(vv,"P",{});var Qr=i(St);Vm=s(Qr,"pre-training: the "),ps=r(Qr,"A",{href:!0,rel:!0});var yv=i(ps);Km=s(yv,"run_t5_mlm_flax.py"),yv.forEach(t),Ym=s(Qr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),hs=r(Qr,"A",{href:!0,rel:!0});var wv=i(hs);Zm=s(wv,"t5_tokenizer_model.py"),wv.forEach(t),Jm=s(Qr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Qr.forEach(t),vv.forEach(t),Xm=c(bp),bl=r(bp,"LI",{});var $v=i(bl);De=r($v,"P",{});var bt=i(De);Qm=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),us=r(bt,"A",{href:!0,rel:!0});var xv=i(us);ef=s(xv,"PyTorch"),xv.forEach(t),tf=s(bt,", "),ms=r(bt,"A",{href:!0,rel:!0});var zv=i(ms);nf=s(zv,"Tensorflow"),zv.forEach(t),of=s(bt,", and "),fs=r(bt,"A",{href:!0,rel:!0});var jv=i(fs);sf=s(jv,"Flax"),jv.forEach(t),af=s(bt,`) and translation scripts
(`),_s=r(bt,"A",{href:!0,rel:!0});var Ev=i(_s);rf=s(Ev,"PyTorch"),Ev.forEach(t),lf=s(bt," and "),gs=r(bt,"A",{href:!0,rel:!0});var qv=i(gs);df=s(qv,"Tensorflow"),qv.forEach(t),cf=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),$v.forEach(t),bp.forEach(t),Dc=c(n),Gt=r(n,"H2",{class:!0});var kp=i(Gt);zn=r(kp,"A",{id:!0,class:!0,href:!0});var Fv=i(zn);kl=r(Fv,"SPAN",{});var Mv=i(kl);v(Ts.$$.fragment,Mv),Mv.forEach(t),Fv.forEach(t),pf=c(kp),vl=r(kp,"SPAN",{});var Cv=i(vl);hf=s(Cv,"T5Config"),Cv.forEach(t),kp.forEach(t),Sc=c(n),vt=r(n,"DIV",{class:!0});var ei=i(vt);v(bs.$$.fragment,ei),uf=c(ei),yt=r(ei,"P",{});var xo=i(yt);mf=s(xo,"This is the configuration class to store the configuration of a "),xr=r(xo,"A",{href:!0});var Pv=i(xr);ff=s(Pv,"T5Model"),Pv.forEach(t),_f=s(xo," or a "),zr=r(xo,"A",{href:!0});var Nv=i(zr);gf=s(Nv,"TFT5Model"),Nv.forEach(t),Tf=s(xo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ks=r(xo,"A",{href:!0,rel:!0});var Ov=i(ks);bf=s(Ov,"t5-small"),Ov.forEach(t),kf=s(xo," architecture."),xo.forEach(t),vf=c(ei),Ut=r(ei,"P",{});var ti=i(Ut);yf=s(ti,"Configuration objects inherit from "),jr=r(ti,"A",{href:!0});var Lv=i(jr);wf=s(Lv,"PretrainedConfig"),Lv.forEach(t),$f=s(ti,` and can be used to control the model outputs. Read the
documentation from `),Er=r(ti,"A",{href:!0});var Av=i(Er);xf=s(Av,"PretrainedConfig"),Av.forEach(t),zf=s(ti," for more information."),ti.forEach(t),ei.forEach(t),Gc=c(n),Wt=r(n,"H2",{class:!0});var vp=i(Wt);jn=r(vp,"A",{id:!0,class:!0,href:!0});var Iv=i(jn);yl=r(Iv,"SPAN",{});var Dv=i(yl);v(vs.$$.fragment,Dv),Dv.forEach(t),Iv.forEach(t),jf=c(vp),wl=r(vp,"SPAN",{});var Sv=i(wl);Ef=s(Sv,"T5Tokenizer"),Sv.forEach(t),vp.forEach(t),Uc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(ys.$$.fragment,Ve),qf=c(Ve),ws=r(Ve,"P",{});var yp=i(ws);Ff=s(yp,"Construct a T5 tokenizer. Based on "),$s=r(yp,"A",{href:!0,rel:!0});var Gv=i($s);Mf=s(Gv,"SentencePiece"),Gv.forEach(t),Cf=s(yp,"."),yp.forEach(t),Pf=c(Ve),xs=r(Ve,"P",{});var wp=i(xs);Nf=s(wp,"This tokenizer inherits from "),qr=r(wp,"A",{href:!0});var Uv=i(qr);Of=s(Uv,"PreTrainedTokenizer"),Uv.forEach(t),Lf=s(wp,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wp.forEach(t),Af=c(Ve),Et=r(Ve,"DIV",{class:!0});var ni=i(Et);v(zs.$$.fragment,ni),If=c(ni),$l=r(ni,"P",{});var Wv=i($l);Df=s(Wv,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),Wv.forEach(t),Sf=c(ni),js=r(ni,"UL",{});var $p=i(js);Fr=r($p,"LI",{});var Ab=i(Fr);Gf=s(Ab,"single sequence: "),xl=r(Ab,"CODE",{});var Rv=i(xl);Uf=s(Rv,"X </s>"),Rv.forEach(t),Ab.forEach(t),Wf=c($p),Mr=r($p,"LI",{});var Ib=i(Mr);Rf=s(Ib,"pair of sequences: "),zl=r(Ib,"CODE",{});var Bv=i(zl);Bf=s(Bv,"A </s> B </s>"),Bv.forEach(t),Ib.forEach(t),$p.forEach(t),ni.forEach(t),Hf=c(Ve),En=r(Ve,"DIV",{class:!0});var xp=i(En);v(Es.$$.fragment,xp),Vf=c(xp),qs=r(xp,"P",{});var zp=i(qs);Kf=s(zp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),jl=r(zp,"CODE",{});var Hv=i(jl);Yf=s(Hv,"prepare_for_model"),Hv.forEach(t),Zf=s(zp," method."),zp.forEach(t),xp.forEach(t),Jf=c(Ve),qn=r(Ve,"DIV",{class:!0});var jp=i(qn);v(Fs.$$.fragment,jp),Xf=c(jp),El=r(jp,"P",{});var Vv=i(El);Qf=s(Vv,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Vv.forEach(t),jp.forEach(t),e_=c(Ve),Cr=r(Ve,"DIV",{class:!0});var Kv=i(Cr);v(Ms.$$.fragment,Kv),Kv.forEach(t),Ve.forEach(t),Wc=c(n),Rt=r(n,"H2",{class:!0});var Ep=i(Rt);Fn=r(Ep,"A",{id:!0,class:!0,href:!0});var Yv=i(Fn);ql=r(Yv,"SPAN",{});var Zv=i(ql);v(Cs.$$.fragment,Zv),Zv.forEach(t),Yv.forEach(t),t_=c(Ep),Fl=r(Ep,"SPAN",{});var Jv=i(Fl);n_=s(Jv,"T5TokenizerFast"),Jv.forEach(t),Ep.forEach(t),Rc=c(n),Se=r(n,"DIV",{class:!0});var Ot=i(Se);v(Ps.$$.fragment,Ot),o_=c(Ot),Bt=r(Ot,"P",{});var oi=i(Bt);s_=s(oi,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),Ml=r(oi,"EM",{});var Xv=i(Ml);a_=s(Xv,"tokenizers"),Xv.forEach(t),r_=s(oi,` library). Based on
`),Ns=r(oi,"A",{href:!0,rel:!0});var Qv=i(Ns);i_=s(Qv,"Unigram"),Qv.forEach(t),l_=s(oi,"."),oi.forEach(t),d_=c(Ot),Os=r(Ot,"P",{});var qp=i(Os);c_=s(qp,"This tokenizer inherits from "),Pr=r(qp,"A",{href:!0});var ey=i(Pr);p_=s(ey,"PreTrainedTokenizerFast"),ey.forEach(t),h_=s(qp,` which contains most of the main methods. Users should
...
adding special tokens. A sequence has the following format:`),ty.forEach(t),__=c(si),As=r(si,"UL",{});var Fp=i(As);Nr=r(Fp,"LI",{});var Db=i(Nr);g_=s(Db,"single sequence: "),Pl=r(Db,"CODE",{});var ny=i(Pl);T_=s(ny,"X </s>"),ny.forEach(t),Db.forEach(t),b_=c(Fp),Or=r(Fp,"LI",{});var Sb=i(Or);k_=s(Sb,"pair of sequences: "),Nl=r(Sb,"CODE",{});var oy=i(Nl);v_=s(oy,"A </s> B </s>"),oy.forEach(t),Sb.forEach(t),Fp.forEach(t),si.forEach(t),y_=c(Ot),Mn=r(Ot,"DIV",{class:!0});var Mp=i(Mn);v(Is.$$.fragment,Mp),w_=c(Mp),Ol=r(Mp,"P",{});var sy=i(Ol);$_=s(sy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),sy.forEach(t),Mp.forEach(t),Ot.forEach(t),Bc=c(n),Ht=r(n,"H2",{class:!0});var Cp=i(Ht);Cn=r(Cp,"A",{id:!0,class:!0,href:!0});var ay=i(Cn);Ll=r(ay,"SPAN",{});var ry=i(Ll);v(Ds.$$.fragment,ry),ry.forEach(t),ay.forEach(t),x_=c(Cp),Al=r(Cp,"SPAN",{});var iy=i(Al);z_=s(iy,"T5Model"),iy.forEach(t),Cp.forEach(t),Hc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);v(Ss.$$.fragment,xe),j_=c(xe),Il=r(xe,"P",{});var ly=i(Il);E_=s(ly,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),ly.forEach(t),q_=c(xe),Gs=r(xe,"P",{});var Pp=i(Gs);F_=s(Pp,"The T5 model was proposed in "),Us=r(Pp,"A",{href:!0,rel:!0});var dy=i(Us);M_=s(dy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rp.forEach(t),aT=c(je),ht=r(je,"DIV",{class:!0});var Fo=i(ht);v(ua.$$.fragment,Fo),rT=c(Fo),Jt=r(Fo,"P",{});var di=i(Jt);iT=s(di,"The "),Gr=r(di,"A",{href:!0});var Ly=i(Gr);lT=s(Ly,"T5EncoderModel"),Ly.forEach(t),dT=s(di," forward method, overrides the "),Ql=r(di,"CODE",{});var Ay=i(Ql);cT=s(Ay,"__call__"),Ay.forEach(t),pT=s(di," special method."),di.forEach(t),hT=c(Fo),v(Wn.$$.fragment,Fo),uT=c(Fo),v(Rn.$$.fragment,Fo),Fo.forEach(t),mT=c(je),ut=r(je,"DIV",{class:!0});var Mo=i(ut);v(ma.$$.fragment,Mo),fT=c(Mo),ed=r(Mo,"P",{});var Iy=i(ed);_T=s(Iy,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Iy.forEach(t),gT=c(Mo),td=r(Mo,"P",{});var Dy=i(td);TT=s(Dy,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Dy.forEach(t),bT=c(Mo),v(Bn.$$.fragment,Mo),Mo.forEach(t),kT=c(je),Ct=r(je,"DIV",{class:!0});var ci=i(Ct);v(fa.$$.fragment,ci),vT=c(ci),nd=r(ci,"P",{});var Sy=i(nd);yT=s(Sy,"Moves the model to cpu from a model parallel state."),Sy.forEach(t),wT=c(ci),v(Hn.$$.fragment,ci),ci.forEach(t),je.forEach(t),Jc=c(n),Xt=r(n,"H2",{class:!0});var Bp=i(Xt);Vn=r(Bp,"A",{id:!0,class:!0,href:!0});var Gy=i(Vn);od=r(Gy,"SPAN",{});var Uy=i(od);v(_a.$$.fragment,Uy),Uy.forEach(t),Gy.forEach(t),$T=c(Bp),sd=r(Bp,"SPAN",{});var Wy=i(sd);xT=s(Wy,"TFT5Model"),Wy.forEach(t),Bp.forEach(t),Xc=c(n),le=r(n,"DIV",{class:!0});var Ke=i(le);v(ga.$$.fragment,Ke),zT=c(Ke),ad=r(Ke,"P",{});var Ry=i(ad);jT=s(Ry,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),Ry.forEach(t),ET=c(Ke),Ta=r(Ke,"P",{});var Hp=i(Ta);qT=s(Hp,"The T5 model was proposed in "),ba=r(Hp,"A",{href:!0,rel:!0});var By=i(ba);FT=s(By,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
