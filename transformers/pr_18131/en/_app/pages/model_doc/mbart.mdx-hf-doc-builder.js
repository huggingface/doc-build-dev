...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart50/tokenization_mbart50.py#L50"}}),Io=new C({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[I$]},$$scope:{ctx:x}}}),ns=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart50/tokenization_mbart50.py#L259",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ps=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart50/tokenization_mbart50.py#L350"}}),us=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart50/tokenization_mbart50.py#L356"}}),hs=new R({}),ms=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18131/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_mbart.py#L1448",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_mbart.py#L1727",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18131/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18131/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18131/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kk=p(),y(kn.$$.fragment),Zk=p(),Ce=a("div"),y(dr.$$.fragment),Yk=p(),po=a("p"),e1=i("The "),Ai=a("a"),t1=i("TFMBartForConditionalGeneration"),o1=i(" forward method, overrides the "),Rl=a("code"),n1=i("__call__"),a1=i(" special method."),s1=p(),y(yn.$$.fragment),r1=p(),y(vn.$$.fragment),i1=p(),y(Tn.$$.fragment),Qp=p(),uo=a("h2"),wn=a("a"),Xl=a("span"),y(lr.$$.fragment),d1=p(),Ql=a("span"),l1=i("FlaxMBartModel"),Hp=p(),W=a("div"),y(cr.$$.fragment),c1=p(),pr=a("p"),p1=i(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Oi=a("a"),u1=i("FlaxPreTrainedModel"),h1=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),m1=p(),ur=a("p"),f1=i(`This model is also a Flax Linen
`),hr=a("a"),_1=i("flax.nn.Module"),g1=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),b1=p(),Hl=a("p"),k1=i("Finally, this model supports inherent JAX features such as:"),y1=p(),mt=a("ul"),Vl=a("li"),mr=a("a"),v1=i("Just-In-Time (JIT) compilation"),T1=p(),Jl=a("li"),fr=a("a"),w1=i("Automatic Differentiation"),M1=p(),Kl=a("li"),_r=a("a"),$1=i("Vectorization"),x1=p(),Zl=a("li"),gr=a("a"),z1=i("Parallelization"),F1=p(),et=a("div"),y(br.$$.fragment),q1=p(),ho=a("p"),B1=i("The "),Yl=a("code"),j1=i("FlaxMBartPreTrainedModel"),E1=i(" forward method, overrides the "),ec=a("code"),C1=i("__call__"),P1=i(" special method."),S1=p(),y(Mn.$$.fragment),A1=p(),y($n.$$.fragment),O1=p(),xn=a("div"),y(kr.$$.fragment),I1=p(),y(zn.$$.fragment),N1=p(),Fn=a("div"),y(yr.$$.fragment),D1=p(),y(qn.$$.fragment),Vp=p(),mo=a("h2"),Bn=a("a"),tc=a("span"),y(vr.$$.fragment),L1=p(),oc=a("span"),G1=i("FlaxMBartForConditionalGeneration"),Jp=p(),U=a("div"),y(Tr.$$.fragment),W1=p(),wr=a("p"),U1=i(`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ii=a("a"),R1=i("FlaxPreTrainedModel"),X1=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Q1=p(),Mr=a("p"),H1=i(`This model is also a Flax Linen
`),$r=a("a"),V1=i("flax.nn.Module"),J1=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),K1=p(),nc=a("p"),Z1=i("Finally, this model supports inherent JAX features such as:"),Y1=p(),ft=a("ul"),ac=a("li"),xr=a("a"),ey=i("Just-In-Time (JIT) compilation"),ty=p(),sc=a("li"),zr=a("a"),oy=i("Automatic Differentiation"),ny=p(),rc=a("li"),Fr=a("a"),ay=i("Vectorization"),sy=p(),ic=a("li"),qr=a("a"),ry=i("Parallelization"),iy=p(),Pe=a("div"),y(Br.$$.fragment),dy=p(),fo=a("p"),ly=i("The "),dc=a("code"),cy=i("FlaxMBartPreTrainedModel"),py=i(" forward method, overrides the "),lc=a("code"),uy=i("__call__"),hy=i(" special method."),my=p(),y(jn.$$.fragment),fy=p(),y(En.$$.fragment),_y=p(),y(Cn.$$.fragment),gy=p(),Pn=a("div"),y(jr.$$.fragment),by=p(),y(Sn.$$.fragment),ky=p(),An=a("div"),y(Er.$$.fragment),yy=p(),y(On.$$.fragment),Kp=p(),_o=a("h2"),In=a("a"),cc=a("span"),y(Cr.$$.fragment),vy=p(),pc=a("span"),Ty=i("FlaxMBartForSequenceClassification"),Zp=p(),N=a("div"),y(Pr.$$.fragment),wy=p(),uc=a("p"),My=i(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cy=p(),hc=a("p"),Py=i("Finally, this model supports inherent JAX features such as:"),Sy=p(),_t=a("ul"),mc=a("li"),Ir=a("a"),Ay=i("Just-In-Time (JIT) compilation"),Oy=p(),fc=a("li"),Nr=a("a"),Iy=i("Automatic Differentiation"),Ny=p(),_c=a("li"),Dr=a("a"),Dy=i("Vectorization"),Ly=p(),gc=a("li"),Lr=a("a"),Gy=i("Parallelization"),Wy=p(),tt=a("div"),y(Gr.$$.fragment),Uy=p(),go=a("p"),Ry=i("The "),bc=a("code"),Xy=i("FlaxMBartPreTrainedModel"),Qy=i(" forward method, overrides the "),kc=a("code"),Hy=i("__call__"),Vy=i(" special method."),Jy=p(),y(Nn.$$.fragment),Ky=p(),y(Dn.$$.fragment),Zy=p(),Ln=a("div"),y(Wr.$$.fragment),Yy=p(),y(Gn.$$.fragment),ev=p(),Wn=a("div"),y(Ur.$$.fragment),tv=p(),y(Un.$$.fragment),Yp=p(),bo=a("h2"),Rn=a("a"),yc=a("span"),y(Rr.$$.fragment),ov=p(),vc=a("span"),nv=i("FlaxMBartForQuestionAnswering"),eu=p(),D=a("div"),y(Xr.$$.fragment),av=p(),ko=a("p"),sv=i(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Tc=a("code"),rv=i("span start logits"),iv=i(" and "),wc=a("code"),dv=i("span end logits"),lv=i(")."),cv=p(),Qr=a("p"),pv=i("This model inherits from "),Di=a("a"),uv=i("FlaxPreTrainedModel"),hv=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mv=p(),Hr=a("p"),fv=i(`This model is also a Flax Linen
`),Vr=a("a"),_v=i("flax.nn.Module"),gv=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bv=p(),Mc=a("p"),kv=i("Finally, this model supports inherent JAX features such as:"),yv=p(),gt=a("ul"),$c=a("li"),Jr=a("a"),vv=i("Just-In-Time (JIT) compilation"),Tv=p(),xc=a("li"),Kr=a("a"),wv=i("Automatic Differentiation"),Mv=p(),zc=a("li"),Zr=a("a"),$v=i("Vectorization"),xv=p(),Fc=a("li"),Yr=a("a"),zv=i("Parallelization"),Fv=p(),ot=a("div"),y(ei.$$.fragment),qv=p(),yo=a("p"),Bv=i("The "),qc=a("code"),jv=i("FlaxMBartPreTrainedModel"),Ev=i(" forward method, overrides the "),Bc=a("code"),Cv=i("__call__"),Pv=i(" special method."),Sv=p(),y(Xn.$$.fragment),Av=p(),y(Qn.$$.fragment),Ov=p(),Hn=a("div"),y(ti.$$.fragment),Iv=p(),y(Vn.$$.fragment),Nv=p(),Jn=a("div"),y(oi.$$.fragment),Dv=p(),y(Kn.$$.fragment),this.h()},l(o){const _=C$('[data-svelte="svelte-1phssyn"]',document.head);l=s(_,"META",{name:!0,content:!0}),_.forEach(t),k=u(o),m=s(o,"H1",{class:!0});var ni=r(m);c=s(ni,"A",{id:!0,class:!0,href:!0});var jc=r(c);g=s(jc,"SPAN",{});var Ec=r(g);v(n.$$.fragment,Ec),Ec.forEach(t),jc.forEach(t),h=u(ni),q=s(ni,"SPAN",{});var Cc=r(q);st=d(Cc,"MBart and MBart-50"),Cc.forEach(t),ni.forEach(t),ze=u(o),E=s(o,"P",{});var Zn=r(E);Ie=s(Zn,"STRONG",{});var Pc=r(Ie);he=d(Pc,"DISCLAIMER:"),Pc.forEach(t),rt=d(Zn," If you see something strange, file a "),me=s(Zn,"A",{href:!0,rel:!0});var Sc=r(me);fe=d(Sc,"Github Issue"),Sc.forEach(t),it=d(Zn,` and assign
...
example shows how to translate English to Romanian using the `),ld=s(To,"EM",{});var np=r(ld);Rh=d(np,"facebook/mbart-large-en-ro"),np.forEach(t),Xh=d(To," model."),To.forEach(t),ii.forEach(t),ep.forEach(t),pp=u(o),v(ka.$$.fragment,o),up=u(o),Nt=s(o,"H2",{class:!0});var di=r(Nt);Mo=s(di,"A",{id:!0,class:!0,href:!0});var ap=r(Mo);cd=s(ap,"SPAN",{});var sp=r(cd);v(ya.$$.fragment,sp),sp.forEach(t),ap.forEach(t),Qh=u(di),pd=s(di,"SPAN",{});var rp=r(pd);Hh=d(rp,"Overview of MBart-50"),rp.forEach(t),di.forEach(t),hp=u(o),yt=s(o,"P",{});var wo=r(yt);Vh=d(wo,"MBart-50 was introduced in the "),va=s(wo,"A",{href:!0,rel:!0});var Lv=r(va);Jh=d(Lv,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),Lv.forEach(t),Kh=d(wo,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),ud=s(wo,"EM",{});var Gv=r(ud);Zh=d(Gv,"mbart-large-cc25"),Gv.forEach(t),Yh=d(wo,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),wo.forEach(t),mp=u(o),ui=s(o,"P",{});var Wv=r(ui);em=d(Wv,"According to the abstract"),Wv.forEach(t),fp=u(o),hi=s(o,"P",{});var Uv=r(hi);hd=s(Uv,"EM",{});var Rv=r(hd);tm=d(Rv,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),Rv.forEach(t),Uv.forEach(t),_p=u(o),Dt=s(o,"H3",{class:!0});var ou=r(Dt);$o=s(ou,"A",{id:!0,class:!0,href:!0});var Xv=r($o);md=s(Xv,"SPAN",{});var Qv=r(md);v(Ta.$$.fragment,Qv),Qv.forEach(t),Xv.forEach(t),om=u(ou),fd=s(ou,"SPAN",{});var Hv=r(fd);nm=d(Hv,"Training of MBart-50"),Hv.forEach(t),ou.forEach(t),gp=u(o),Ve=s(o,"P",{});var ea=r(Ve);am=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),_d=s(ea,"CODE",{});var Vv=r(_d);sm=d(Vv,"[lang_code] X [eos]"),Vv.forEach(t),rm=d(ea,", where "),gd=s(ea,"CODE",{});var Jv=r(gd);im=d(Jv,"lang_code"),Jv.forEach(t),dm=d(ea,` is source
language id for source text and target language id for target text, with `),bd=s(ea,"CODE",{});var Kv=r(bd);lm=d(Kv,"X"),Kv.forEach(t),cm=d(ea,` being the source or target text
respectively.`),ea.forEach(t),bp=u(o),xo=s(o,"P",{});var nu=r(xo);pm=d(nu,"MBart-50 has its own tokenizer "),mi=s(nu,"A",{href:!0});var Zv=r(mi);um=d(Zv,"MBart50Tokenizer"),Zv.forEach(t),hm=d(nu,"."),nu.forEach(t),kp=u(o),fi=s(o,"UL",{});var Yv=r(fi);kd=s(Yv,"LI",{});var eT=r(kd);mm=d(eT,"Supervised training"),eT.forEach(t),Yv.forEach(t),yp=u(o),v(wa.$$.fragment,o),vp=u(o),_i=s(o,"UL",{});var tT=r(_i);Ma=s(tT,"LI",{});var au=r(Ma);yd=s(au,"P",{});var oT=r(yd);fm=d(oT,"Generation"),oT.forEach(t),_m=u(au),Te=s(au,"P",{});var nt=r(Te);gm=d(nt,"To generate using the mBART-50 multilingual translation models, "),vd=s(nt,"CODE",{});var nT=r(vd);bm=d(nT,"eos_token_id"),nT.forEach(t),km=d(nt,` is used as the
