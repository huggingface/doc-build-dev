...
model.parallelize(device_map)`}}),Es=new P({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1308"}}),qs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Gs=new P({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1503"}}),Bs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),ea=new P({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1779"}}),ta=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
behavior.`),OT=d(),f(Yn.$$.fragment),GT=d(),Je=o("div"),f(la.$$.fragment),BT=d(),_n=o("p"),UT=r("The "),xr=o("a"),WT=r("TFT5Model"),RT=r(" forward method, overrides the "),il=o("code"),HT=r("__call__"),VT=r(" special method."),KT=d(),f(Jn.$$.fragment),YT=d(),dl=o("p"),JT=r("Examples:"),ZT=d(),f(ca.$$.fragment),Fc=d(),gn=o("h2"),Zn=o("a"),ll=o("span"),f(pa.$$.fragment),XT=d(),cl=o("span"),QT=r("TFT5ForConditionalGeneration"),Mc=d(),le=o("div"),f(ha.$$.fragment),e5=d(),ua=o("p"),t5=r("T5 Model with a "),pl=o("code"),n5=r("language modeling"),o5=r(" head on top."),s5=d(),ma=o("p"),a5=r("The T5 model was proposed in "),fa=o("a"),r5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),i5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),d5=d(),_a=o("p"),l5=r("This model inherits from "),Er=o("a"),c5=r("TFPreTrainedModel"),p5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),h5=d(),ga=o("p"),u5=r("This model is also a "),Ta=o("a"),m5=r("tf.keras.Model"),f5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_5=d(),f(Xn.$$.fragment),g5=d(),Ze=o("div"),f(ka.$$.fragment),T5=d(),Tn=o("p"),k5=r("The "),qr=o("a"),v5=r("TFT5ForConditionalGeneration"),b5=r(" forward method, overrides the "),hl=o("code"),w5=r("__call__"),y5=r(" special method."),z5=d(),f(Qn.$$.fragment),$5=d(),ul=o("p"),x5=r("Examples:"),E5=d(),f(va.$$.fragment),Pc=d(),kn=o("h2"),eo=o("a"),ml=o("span"),f(ba.$$.fragment),q5=d(),fl=o("span"),j5=r("TFT5EncoderModel"),Cc=d(),ce=o("div"),f(wa.$$.fragment),F5=d(),_l=o("p"),M5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),P5=d(),ya=o("p"),C5=r("The T5 model was proposed in "),za=o("a"),A5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),N5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),L5=d(),$a=o("p"),I5=r("This model inherits from "),jr=o("a"),D5=r("TFPreTrainedModel"),S5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),O5=d(),xa=o("p"),G5=r("This model is also a "),Ea=o("a"),B5=r("tf.keras.Model"),U5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),W5=d(),f(to.$$.fragment),R5=d(),Xe=o("div"),f(qa.$$.fragment),H5=d(),vn=o("p"),V5=r("The "),Fr=o("a"),K5=r("TFT5EncoderModel"),Y5=r(" forward method, overrides the "),gl=o("code"),J5=r("__call__"),Z5=r(" special method."),X5=d(),f(no.$$.fragment),Q5=d(),Tl=o("p"),ek=r("Examples:"),tk=d(),f(ja.$$.fragment),Ac=d(),bn=o("h2"),oo=o("a"),kl=o("span"),f(Fa.$$.fragment),nk=d(),vl=o("span"),ok=r("FlaxT5Model"),Nc=d(),yt=o("div"),Qe=o("div"),f(Ma.$$.fragment),sk=d(),wn=o("p"),ak=r("The "),bl=o("code"),rk=r("FlaxT5PreTrainedModel"),ik=r("forward method, overrides the "),wl=o("code"),dk=r("__call__"),lk=r(" special method."),ck=d(),f(so.$$.fragment),pk=d(),yl=o("p"),hk=r("Example:"),uk=d(),f(Pa.$$.fragment),mk=d(),Mt=o("div"),f(Ca.$$.fragment),fk=d(),zl=o("p"),_k=r("Example:"),gk=d(),f(Aa.$$.fragment),Tk=d(),Pt=o("div"),f(Na.$$.fragment),kk=d(),$l=o("p"),vk=r("Example:"),bk=d(),f(La.$$.fragment),Lc=d(),yn=o("h2"),ao=o("a"),xl=o("span"),f(Ia.$$.fragment),wk=d(),El=o("span"),yk=r("FlaxT5ForConditionalGeneration"),Ic=d(),zt=o("div"),et=o("div"),f(Da.$$.fragment),zk=d(),zn=o("p"),$k=r("The "),ql=o("code"),xk=r("FlaxT5PreTrainedModel"),Ek=r("forward method, overrides the "),jl=o("code"),qk=r("__call__"),jk=r(" special method."),Fk=d(),f(ro.$$.fragment),Mk=d(),Fl=o("p"),Pk=r("Example:"),Ck=d(),f(Sa.$$.fragment),Ak=d(),Ct=o("div"),f(Oa.$$.fragment),Nk=d(),Ml=o("p"),Lk=r("Example:"),Ik=d(),f(Ga.$$.fragment),Dk=d(),At=o("div"),f(Ba.$$.fragment),Sk=d(),Pl=o("p"),Ok=r("Example:"),Gk=d(),f(Ua.$$.fragment),this.h()},l(n){const h=cy('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(n),b=s(n,"H1",{class:!0});var Wa=a(b);y=s(Wa,"A",{id:!0,class:!0,href:!0});var Cl=a(y);$=s(Cl,"SPAN",{});var Al=a($);_(z.$$.fragment,Al),Al.forEach(t),Cl.forEach(t),w=l(Wa),E=s(Wa,"SPAN",{});var Nl=a(E);Ee=i(Nl,"T5"),Nl.forEach(t),Wa.forEach(t),oe=l(n),q=s(n,"H2",{class:!0});var Ra=a(q);ee=s(Ra,"A",{id:!0,class:!0,href:!0});var Ll=a(ee);O=s(Ll,"SPAN",{});var Il=a(O);_(se.$$.fragment,Il),Il.forEach(t),Ll.forEach(t),qe=l(Ra),G=s(Ra,"SPAN",{});var Dl=a(G);je=i(Dl,"Overview"),Dl.forEach(t),Ra.forEach(t),ve=l(n),B=s(n,"P",{});var Ha=a(B);I=i(Ha,"The T5 model was presented in "),ae=s(Ha,"A",{href:!0,rel:!0});var Sl=a(ae);pe=i(Sl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Sl.forEach(t),F=i(Ha,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),Ha.forEach(t),C=l(n),he=s(n,"P",{});var Ol=a(he);K=i(Ol,"The abstract from the paper is the following:"),Ol.forEach(t),be=l(n),ue=s(n,"P",{});var Vk=a(ue);U=s(Vk,"EM",{});var Kk=a(U);Fe=i(Kk,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),Kk.forEach(t),Vk.forEach(t),we=l(n),M=s(n,"P",{});var Yk=a(M);Me=i(Yk,"Tips:"),Yk.forEach(t),H=l(n),V=s(n,"UL",{});var Mr=a(V);me=s(Mr,"LI",{});var Jk=a(me);A=s(Jk,"P",{});var Pr=a(A);Pe=i(Pr,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),fe=s(Pr,"EM",{});var Zk=a(fe);D=i(Zk,"translate English to German: \u2026"),Zk.forEach(t),Ce=i(Pr,`,
for summarization: `),W=s(Pr,"EM",{});var Xk=a(W);Ae=i(Xk,"summarize: \u2026"),Xk.forEach(t),m=i(Pr,"."),Pr.forEach(t),Jk.forEach(t),j=l(Mr),te=s(Mr,"LI",{});var Qk=a(te);Oe=s(Qk,"P",{});var ev=a(Oe);lt=i(ev,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ev.forEach(t),Qk.forEach(t),S=l(Mr),Ge=s(Mr,"LI",{});var tv=a(Ge);ne=s(tv,"P",{});var io=a(ne);ct=i(io,"See the "),N=s(io,"A",{href:!0});var nv=a(N);Y=i(nv,"training"),nv.forEach(t),pt=i(io,", "),Ne=s(io,"A",{href:!0});var ov=a(Ne);J=i(ov,"inference"),ov.forEach(t),ht=i(io," and "),Le=s(io,"A",{href:!0});var sv=a(Le);Ie=i(sv,"scripts"),sv.forEach(t),ut=i(io," sections below for all details regarding usage."),io.forEach(t),tv.forEach(t),Mr.forEach(t),Wl=l(n),Va=s(n,"P",{});var av=a(Va);Lp=i(av,"T5 comes in different sizes:"),av.forEach(t),Rl=l(n),Be=s(n,"UL",{});var Nt=a(Be);si=s(Nt,"LI",{});var rv=a(si);ai=s(rv,"P",{});var iv=a(ai);_o=s(iv,"A",{href:!0,rel:!0});var dv=a(_o);Ip=i(dv,"t5-small"),dv.forEach(t),iv.forEach(t),rv.forEach(t),Dp=l(Nt),ri=s(Nt,"LI",{});var lv=a(ri);ii=s(lv,"P",{});var cv=a(ii);go=s(cv,"A",{href:!0,rel:!0});var pv=a(go);Sp=i(pv,"t5-base"),pv.forEach(t),cv.forEach(t),lv.forEach(t),Op=l(Nt),di=s(Nt,"LI",{});var hv=a(di);li=s(hv,"P",{});var uv=a(li);To=s(uv,"A",{href:!0,rel:!0});var mv=a(To);Gp=i(mv,"t5-large"),mv.forEach(t),uv.forEach(t),hv.forEach(t),Bp=l(Nt),ci=s(Nt,"LI",{});var fv=a(ci);pi=s(fv,"P",{});var _v=a(pi);ko=s(_v,"A",{href:!0,rel:!0});var gv=a(ko);Up=i(gv,"t5-3b"),gv.forEach(t),_v.forEach(t),fv.forEach(t),Wp=l(Nt),hi=s(Nt,"LI",{});var Tv=a(hi);Ka=s(Tv,"P",{});var Bk=a(Ka);vo=s(Bk,"A",{href:!0,rel:!0});var kv=a(vo);Rp=i(kv,"t5-11b"),kv.forEach(t),Hp=i(Bk,"."),Bk.forEach(t),Tv.forEach(t),Nt.forEach(t),Hl=l(n),Ya=s(n,"P",{});var vv=a(Ya);Vp=i(vv,"Based on the original T5 model, Google has released some follow-up works:"),vv.forEach(t),Vl=l(n),xt=s(n,"UL",{});var Cr=a(xt);ui=s(Cr,"LI",{});var bv=a(ui);$n=s(bv,"P",{});var Gl=a($n);mi=s(Gl,"STRONG",{});var wv=a(mi);Kp=i(wv,"T5v1.1"),wv.forEach(t),Yp=i(Gl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Ja=s(Gl,"A",{href:!0});var yv=a(Ja);Jp=i(yv,"here"),yv.forEach(t),Zp=i(Gl,"."),Gl.forEach(t),bv.forEach(t),Xp=l(Cr),fi=s(Cr,"LI",{});var zv=a(fi);xn=s(zv,"P",{});var Bl=a(xn);_i=s(Bl,"STRONG",{});var $v=a(_i);Qp=i($v,"mT5"),$v.forEach(t),eh=i(Bl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),Za=s(Bl,"A",{href:!0});var xv=a(Za);th=i(xv,"here"),xv.forEach(t),nh=i(Bl,"."),Bl.forEach(t),zv.forEach(t),oh=l(Cr),gi=s(Cr,"LI",{});var Ev=a(gi);En=s(Ev,"P",{});var Ul=a(En);Ti=s(Ul,"STRONG",{});var qv=a(Ti);sh=i(qv,"byT5"),qv.forEach(t),ah=i(Ul,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Xa=s(Ul,"A",{href:!0});var jv=a(Xa);rh=i(jv,"here"),jv.forEach(t),ih=i(Ul,"."),Ul.forEach(t),Ev.forEach(t),Cr.forEach(t),Kl=l(n),qn=s(n,"P",{});var Sc=a(qn);dh=i(Sc,"All checkpoints can be found on the "),bo=s(Sc,"A",{href:!0,rel:!0});var Fv=a(bo);lh=i(Fv,"hub"),Fv.forEach(t),ch=i(Sc,"."),Sc.forEach(t),Yl=l(n),Et=s(n,"P",{});var Ar=a(Et);ph=i(Ar,"This model was contributed by "),wo=s(Ar,"A",{href:!0,rel:!0});var Mv=a(wo);hh=i(Mv,"thomwolf"),Mv.forEach(t),uh=i(Ar,". The original code can be found "),yo=s(Ar,"A",{href:!0,rel:!0});var Pv=a(yo);mh=i(Pv,"here"),Pv.forEach(t),fh=i(Ar,"."),Ar.forEach(t),Jl=l(n),Qa=s(n,"A",{id:!0}),a(Qa).forEach(t),Zl=l(n),Jt=s(n,"H2",{class:!0});var Oc=a(Jt);jn=s(Oc,"A",{id:!0,class:!0,href:!0});var Cv=a(jn);ki=s(Cv,"SPAN",{});var Av=a(ki);_(zo.$$.fragment,Av),Av.forEach(t),Cv.forEach(t),_h=l(Oc),vi=s(Oc,"SPAN",{});var Nv=a(vi);gh=i(Nv,"Training"),Nv.forEach(t),Oc.forEach(t),Xl=l(n),mt=s(n,"P",{});var lo=a(mt);Th=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),bi=s(lo,"CODE",{});var Lv=a(bi);kh=i(Lv,"input_ids"),Lv.forEach(t),vh=i(lo,`. The target sequence is shifted to the right, i.e., prepended by a
start-sequence token and fed to the decoder using the `),wi=s(lo,"CODE",{});var Iv=a(wi);bh=i(Iv,"decoder_input_ids"),Iv.forEach(t),wh=i(lo,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),yi=s(lo,"CODE",{});var Dv=a(yi);yh=i(Dv,"labels"),Dv.forEach(t),zh=i(lo,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),lo.forEach(t),Ql=l(n),Fn=s(n,"P",{});var Gc=a(Fn);$h=i(Gc,"One can use "),er=s(Gc,"A",{href:!0});var Sv=a(er);xh=i(Sv,"T5ForConditionalGeneration"),Sv.forEach(t),Eh=i(Gc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Gc.forEach(t),ec=l(n),Mn=s(n,"UL",{});var Bc=a(Mn);dt=s(Bc,"LI",{});var Lt=a(dt);zi=s(Lt,"P",{});var Ov=a(zi);qh=i(Ov,"Unsupervised denoising training"),Ov.forEach(t),jh=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Fh=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),$i=s(tt,"EM",{});var Gv=a($i);Mh=i(Gv,"a.k.a"),Gv.forEach(t),Ph=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),xi=s(tt,"EM",{});var Bv=a(xi);Ch=i(Bv,"real"),Bv.forEach(t),Ah=i(tt,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=s(tt,"CODE",{});var Uv=a(Ei);Nh=i(Uv,"<extra_id_0>"),Uv.forEach(t),Lh=i(tt,`,
`),qi=s(tt,"CODE",{});var Wv=a(qi);Ih=i(Wv,"<extra_id_1>"),Wv.forEach(t),Dh=i(tt,", \u2026 up to "),ji=s(tt,"CODE",{});var Rv=a(ji);Sh=i(Rv,"<extra_id_99>"),Rv.forEach(t),Oh=i(tt,`. As a default, 100 sentinel tokens are available in
`),tr=s(tt,"A",{href:!0});var Hv=a(tr);Gh=i(Hv,"T5Tokenizer"),Hv.forEach(t),Bh=i(tt,"."),tt.forEach(t),Uh=l(Lt),Fi=s(Lt,"P",{});var Vv=a(Fi);Wh=i(Vv,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Vv.forEach(t),Rh=l(Lt),_($o.$$.fragment,Lt),Hh=l(Lt),xo=s(Lt,"P",{});var Uc=a(xo);Vh=i(Uc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Eo=s(Uc,"A",{href:!0,rel:!0});var Kv=a(Eo);Kh=i(Kv,"run_t5_mlm_flax.py"),Kv.forEach(t),Yh=i(Uc,` script in the Examples
directory.`),Uc.forEach(t),Lt.forEach(t),Jh=l(Bc),ge=s(Bc,"LI",{});var nt=a(ge);Mi=s(nt,"P",{});var Yv=a(Mi);Zh=i(Yv,"Supervised training"),Yv.forEach(t),Xh=l(nt),Pi=s(nt,"P",{});var Jv=a(Pi);Qh=i(Jv,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Jv.forEach(t),eu=l(nt),_(qo.$$.fragment,nt),tu=l(nt),re=s(nt,"P",{});var ye=a(re);nu=i(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ci=s(ye,"CODE",{});var Zv=a(Ci);ou=i(Zv,"input_ids"),Zv.forEach(t),su=i(ye,` (which are the
`),Ai=s(ye,"CODE",{});var Xv=a(Ai);au=i(Xv,"input_ids"),Xv.forEach(t),ru=i(ye," of the encoded input sequence) and "),Ni=s(ye,"CODE",{});var Qv=a(Ni);iu=i(Qv,"labels"),Qv.forEach(t),du=i(ye," (which are the "),Li=s(ye,"CODE",{});var eb=a(Li);lu=i(eb,"input_ids"),eb.forEach(t),cu=i(ye,` of the encoded
target sequence). The model will automatically create the `),Ii=s(ye,"CODE",{});var tb=a(Ii);pu=i(tb,"decoder_input_ids"),tb.forEach(t),hu=i(ye," based on the "),Di=s(ye,"CODE",{});var nb=a(Di);uu=i(nb,"labels"),nb.forEach(t),mu=i(ye,`, by
shifting them one position to the right and prepending the `),Si=s(ye,"CODE",{});var ob=a(Si);fu=i(ob,"config.decoder_start_token_id"),ob.forEach(t),_u=i(ye,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Oi=s(Nr,"CODE",{});var sb=a(Oi);ku=i(sb,"max_source_length"),sb.forEach(t),vu=i(Nr," and "),Gi=s(Nr,"CODE",{});var ab=a(Gi);bu=i(ab,"max_target_length"),ab.forEach(t),wu=i(Nr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Nr.forEach(t),yu=l(nt),Te=s(nt,"P",{});var ot=a(Te);zu=i(ot,"In addition, we must make sure that padding token id\u2019s of the "),Bi=s(ot,"CODE",{});var rb=a(Bi);$u=i(rb,"labels"),rb.forEach(t),xu=i(ot,` are not taken into account by the loss
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Ui=s(ot,"CODE",{});var ib=a(Ui);Eu=i(ib,"ignore_index"),ib.forEach(t),qu=i(ot,`
of the `),Wi=s(ot,"CODE",{});var db=a(Wi);ju=i(db,"CrossEntropyLoss"),db.forEach(t),Fu=i(ot,". In Flax, one can use the "),Ri=s(ot,"CODE",{});var lb=a(Ri);Mu=i(lb,"decoder_attention_mask"),lb.forEach(t),Pu=i(ot,` to ignore padded tokens from
the loss (see the `),jo=s(ot,"A",{href:!0,rel:!0});var cb=a(jo);Cu=i(cb,"Flax summarization script"),cb.forEach(t),Au=i(ot,` for details). We also pass
`),Hi=s(ot,"CODE",{});var pb=a(Hi);Nu=i(pb,"attention_mask"),pb.forEach(t),Lu=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Iu=l(nt),_(Fo.$$.fragment,nt),nt.forEach(t),Bc.forEach(t),tc=l(n),nr=s(n,"P",{});var hb=a(nr);Du=i(hb,"Additional training tips:"),hb.forEach(t),nc=l(n),qt=s(n,"UL",{});var Lr=a(qt);Vi=s(Lr,"LI",{});var ub=a(Vi);Mo=s(ub,"P",{});var Wc=a(Mo);Su=i(Wc,"T5 models need a slightly higher learning rate than the default one set in the "),Ki=s(Wc,"CODE",{});var mb=a(Ki);Ou=i(mb,"Trainer"),mb.forEach(t),Gu=i(Wc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Wc.forEach(t),ub.forEach(t),Bu=l(Lr),Yi=s(Lr,"LI",{});var fb=a(Yi);Xt=s(fb,"P",{});var Ir=a(Xt);Uu=i(Ir,"According to "),Po=s(Ir,"A",{href:!0,rel:!0});var _b=a(Po);Wu=i(_b,"this forum post"),_b.forEach(t),Ru=i(Ir,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Co=s(Ir,"A",{href:!0,rel:!0});var gb=a(Co);Hu=i(gb,"paper"),gb.forEach(t),Vu=i(Ir,` for the task prefixes
used).`),Ir.forEach(t),fb.forEach(t),Ku=l(Lr),Ji=s(Lr,"LI",{});var Tb=a(Ji);Ao=s(Tb,"P",{});var Rc=a(Ao);Yu=i(Rc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
`),Zi=s(Rc,"EM",{});var kb=a(Zi);Ju=i(kb,"pad_to_multiple_of"),kb.forEach(t),Zu=i(Rc,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Rc.forEach(t),Tb.forEach(t),Lr.forEach(t),oc=l(n),or=s(n,"A",{id:!0}),a(or).forEach(t),sc=l(n),Qt=s(n,"H2",{class:!0});var Hc=a(Qt);Pn=s(Hc,"A",{id:!0,class:!0,href:!0});var vb=a(Pn);Xi=s(vb,"SPAN",{});var bb=a(Xi);_(No.$$.fragment,bb),bb.forEach(t),vb.forEach(t),Xu=l(Hc),Qi=s(Hc,"SPAN",{});var wb=a(Qi);Qu=i(wb,"Inference"),wb.forEach(t),Hc.forEach(t),ac=l(n),ft=s(n,"P",{});var co=a(ft);em=i(co,"At inference time, it is recommended to use "),sr=s(co,"A",{href:!0});var yb=a(sr);tm=i(yb,"generate()"),yb.forEach(t),nm=i(co,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),Lo=s(co,"A",{href:!0,rel:!0});var zb=a(Lo);om=i(zb,"this blog post"),zb.forEach(t),sm=i(co,` to know all the details about generating text with Transformers.
There\u2019s also `),Io=s(co,"A",{href:!0,rel:!0});var $b=a(Io);am=i($b,"this blog post"),$b.forEach(t),rm=i(co,` which explains how
generation works in general in encoder-decoder models.`),co.forEach(t),rc=l(n),_(Do.$$.fragment,n),ic=l(n),Ue=s(n,"P",{});var It=a(Ue);im=i(It,"Note that T5 uses the "),ed=s(It,"CODE",{});var xb=a(ed);dm=i(xb,"pad_token_id"),xb.forEach(t),lm=i(It," as the "),td=s(It,"CODE",{});var Eb=a(td);cm=i(Eb,"decoder_start_token_id"),Eb.forEach(t),pm=i(It,`, so when doing generation without using
`),ar=s(It,"A",{href:!0});var qb=a(ar);hm=i(qb,"generate()"),qb.forEach(t),um=i(It,", make sure you start it with the "),nd=s(It,"CODE",{});var jb=a(nd);mm=i(jb,"pad_token_id"),jb.forEach(t),fm=i(It,"."),It.forEach(t),dc=l(n),rr=s(n,"P",{});var Fb=a(rr);_m=i(Fb,"The example above only shows a single example. You can also do batched inference, like so:"),Fb.forEach(t),lc=l(n),_(So.$$.fragment,n),cc=l(n),ir=s(n,"A",{id:!0}),a(ir).forEach(t),pc=l(n),en=s(n,"H2",{class:!0});var Vc=a(en);Cn=s(Vc,"A",{id:!0,class:!0,href:!0});var Mb=a(Cn);od=s(Mb,"SPAN",{});var Pb=a(od);_(Oo.$$.fragment,Pb),Pb.forEach(t),Mb.forEach(t),gm=l(Vc),sd=s(Vc,"SPAN",{});var Cb=a(sd);Tm=i(Cb,"Performance"),Cb.forEach(t),Vc.forEach(t),hc=l(n),_t=s(n,"P",{});var po=a(_t);km=i(po,"If you\u2019d like a faster training and inference performance, install "),Go=s(po,"A",{href:!0,rel:!0});var Ab=a(Go);vm=i(Ab,"apex"),Ab.forEach(t),bm=i(po," and then the model will automatically use "),ad=s(po,"CODE",{});var Nb=a(ad);wm=i(Nb,"apex.normalization.FusedRMSNorm"),Nb.forEach(t),ym=i(po," instead of "),rd=s(po,"CODE",{});var Lb=a(rd);zm=i(Lb,"T5LayerNorm"),Lb.forEach(t),$m=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),uc=l(n),tn=s(n,"H2",{class:!0});var Kc=a(tn);An=s(Kc,"A",{id:!0,class:!0,href:!0});var Ib=a(An);id=s(Ib,"SPAN",{});var Db=a(id);_(Bo.$$.fragment,Db),Db.forEach(t),Ib.forEach(t),xm=l(Kc),dd=s(Kc,"SPAN",{});var Sb=a(dd);Em=i(Sb,"Example scripts"),Sb.forEach(t),Kc.forEach(t),mc=l(n),dr=s(n,"P",{});var Ob=a(dr);qm=i(Ob,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Ob.forEach(t),fc=l(n),Nn=s(n,"UL",{});var Yc=a(Nn);ld=s(Yc,"LI",{});var Gb=a(ld);nn=s(Gb,"P",{});var Dr=a(nn);jm=i(Dr,"pre-training: the "),Uo=s(Dr,"A",{href:!0,rel:!0});var Bb=a(Uo);Fm=i(Bb,"run_t5_mlm_flax.py"),Bb.forEach(t),Mm=i(Dr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Wo=s(Dr,"A",{href:!0,rel:!0});var Ub=a(Wo);Pm=i(Ub,"t5_tokenizer_model.py"),Ub.forEach(t),Cm=i(Dr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Dr.forEach(t),Gb.forEach(t),Am=l(Yc),cd=s(Yc,"LI",{});var Wb=a(cd);De=s(Wb,"P",{});var vt=a(De);Nm=i(vt,"fine-tuning: T5 is supported by the official summarization scripts ("),Ro=s(vt,"A",{href:!0,rel:!0});var Rb=a(Ro);Lm=i(Rb,"PyTorch"),Rb.forEach(t),Im=i(vt,", "),Ho=s(vt,"A",{href:!0,rel:!0});var Hb=a(Ho);Dm=i(Hb,"Tensorflow"),Hb.forEach(t),Sm=i(vt,", and "),Vo=s(vt,"A",{href:!0,rel:!0});var Vb=a(Vo);Om=i(Vb,"Flax"),Vb.forEach(t),Gm=i(vt,`) and translation scripts
(`),Ko=s(vt,"A",{href:!0,rel:!0});var Kb=a(Ko);Bm=i(Kb,"PyTorch"),Kb.forEach(t),Um=i(vt," and "),Yo=s(vt,"A",{href:!0,rel:!0});var Yb=a(Yo);Wm=i(Yb,"Tensorflow"),Yb.forEach(t),Rm=i(vt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),vt.forEach(t),Wb.forEach(t),Yc.forEach(t),_c=l(n),on=s(n,"H2",{class:!0});var Jc=a(on);Ln=s(Jc,"A",{id:!0,class:!0,href:!0});var Jb=a(Ln);pd=s(Jb,"SPAN",{});var Zb=a(pd);_(Jo.$$.fragment,Zb),Zb.forEach(t),Jb.forEach(t),Hm=l(Jc),hd=s(Jc,"SPAN",{});var Xb=a(hd);Vm=i(Xb,"T5Config"),Xb.forEach(t),Jc.forEach(t),gc=l(n),bt=s(n,"DIV",{class:!0});var Sr=a(bt);_(Zo.$$.fragment,Sr),Km=l(Sr),wt=s(Sr,"P",{});var ho=a(wt);Ym=i(ho,"This is the configuration class to store the configuration of a "),lr=s(ho,"A",{href:!0});var Qb=a(lr);Jm=i(Qb,"T5Model"),Qb.forEach(t),Zm=i(ho," or a "),cr=s(ho,"A",{href:!0});var e1=a(cr);Xm=i(e1,"TFT5Model"),e1.forEach(t),Qm=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
adding special tokens. A sequence has the following format:`),l1.forEach(t),wf=l(Gr),as=s(Gr,"UL",{});var ep=a(as);mr=s(ep,"LI",{});var Uk=a(mr);yf=i(Uk,"single sequence: "),_d=s(Uk,"CODE",{});var c1=a(_d);zf=i(c1,"X </s>"),c1.forEach(t),Uk.forEach(t),$f=l(ep),fr=s(ep,"LI",{});var Wk=a(fr);xf=i(Wk,"pair of sequences: "),gd=s(Wk,"CODE",{});var p1=a(gd);Ef=i(p1,"A </s> B </s>"),p1.forEach(t),Wk.forEach(t),ep.forEach(t),Gr.forEach(t),qf=l(st),Dn=s(st,"DIV",{class:!0});var tp=a(Dn);_(rs.$$.fragment,tp),jf=l(tp),is=s(tp,"P",{});var np=a(is);Ff=i(np,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
adding special tokens. A sequence has the following format:`),v1.forEach(t),Xf=l(Ur),ms=s(Ur,"UL",{});var rp=a(ms);gr=s(rp,"LI",{});var Rk=a(gr);Qf=i(Rk,"single sequence: "),$d=s(Rk,"CODE",{});var b1=a($d);e_=i(b1,"X </s>"),b1.forEach(t),Rk.forEach(t),t_=l(rp),Tr=s(rp,"LI",{});var Hk=a(Tr);n_=i(Hk,"pair of sequences: "),xd=s(Hk,"CODE",{});var w1=a(xd);o_=i(w1,"A </s> B </s>"),w1.forEach(t),Hk.forEach(t),rp.forEach(t),Ur.forEach(t),s_=l(Dt),Gn=s(Dt,"DIV",{class:!0});var ip=a(Gn);_(fs.$$.fragment,ip),a_=l(ip),Ed=s(ip,"P",{});var y1=a(Ed);r_=i(y1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
