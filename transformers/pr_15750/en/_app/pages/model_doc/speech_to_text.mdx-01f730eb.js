import{S as hh,i as fh,s as uh,e as a,k as c,w as T,t as n,L as mh,c as r,d as t,m as l,a as i,x as v,h as s,b as d,J as e,g as h,y as k,q as x,o as b,B as y}from"../../chunks/vendor-9e2b328e.js";import{T as Yt}from"../../chunks/Tip-76f97a76.js";import{D}from"../../chunks/Docstring-50fd6873.js";import{C as ln}from"../../chunks/CodeBlock-88e23343.js";import{I as We}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function _h(G){let p,$,m,_,S,g,w,E;return{c(){p=a("p"),$=n(`This class method is simply calling the feature extractor
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),W.forEach(t)},m(u,F){h(u,p,F),e(p,$),h(u,m,F),h(u,_,F),e(_,S),e(S,g),e(_,w),e(_,E),e(E,A),h(u,q,F),h(u,z,F),e(z,N),e(z,R),e(R,ee),e(z,Fe),e(z,V),e(V,Pe),e(z,$e),h(u,M,F),h(u,J,F),e(J,te),h(u,ye,F),h(u,j,F),e(j,C),e(C,je),e(C,oe),e(oe,ne),e(C,Ce),e(C,se),e(se,ae),e(j,Me),e(j,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(j,de),e(j,K),e(K,De),e(K,Z),e(Z,Y)},d(u){u&&t(p),u&&t(m),u&&t(_),u&&t(q),u&&t(z),u&&t(M),u&&t(J),u&&t(ye),u&&t(j)}}}function xh(G){let p,$,m,_,S;return{c(){p=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),_=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=r(g,"P",{});var w=i(p);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var E=i(m);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){h(g,p,w),e(p,$),e(p,m),e(m,_),e(p,S)},d(g){g&&t(p)}}}function bh(G){let p,$,m,_,S,g,w,E,A,q,z,N,R,ee,Fe,V,Pe,$e,M,J,te,ye,j,C,je,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){p=a("p"),$=n("TF 2.0 models accepts two formats as inputs:"),m=c(),_=a("ul"),S=a("li"),g=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),z=a("p"),N=n("This second option is useful when using "),R=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=a("code"),Pe=n("model(inputs)"),$e=n("."),M=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ye=c(),j=a("ul"),C=a("li"),je=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Ce=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Me=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),K=a("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){p=r(u,"P",{});var F=i(p);$=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),m=l(u),_=r(u,"UL",{});var X=i(_);S=r(X,"LI",{});var st=i(S);g=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),E=r(X,"LI",{});var Ne=i(E);A=s(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),X.forEach(t),q=l(u),z=r(u,"P",{});var Q=i(z);N=s(Q,"This second option is useful when using "),R=r(Q,"CODE",{});var Ue=i(R);ee=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Fe=s(Q,` method which currently requires having all the
...
first positional argument :`),at.forEach(t),ye=l(u),j=r(u,"UL",{});var W=i(j);C=r(W,"LI",{});var ce=i(C);je=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),Ce=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var He=i(se);ae=s(He,"model(input_ids)"),He.forEach(t),ce.forEach(t),Me=l(W),O=r(W,"LI",{});var P=i(O);Ee=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(P,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var ze=i(ie);Ie=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),P.forEach(t),de=l(W),K=r(W,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),W.forEach(t)},m(u,F){h(u,p,F),e(p,$),h(u,m,F),h(u,_,F),e(_,S),e(S,g),e(_,w),e(_,E),e(E,A),h(u,q,F),h(u,z,F),e(z,N),e(z,R),e(R,ee),e(z,Fe),e(z,V),e(V,Pe),e(z,$e),h(u,M,F),h(u,J,F),e(J,te),h(u,ye,F),h(u,j,F),e(j,C),e(C,je),e(C,oe),e(oe,ne),e(C,Ce),e(C,se),e(se,ae),e(j,Me),e(j,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(j,de),e(j,K),e(K,De),e(K,Z),e(Z,Y)},d(u){u&&t(p),u&&t(m),u&&t(_),u&&t(q),u&&t(z),u&&t(M),u&&t(J),u&&t(ye),u&&t(j)}}}function yh(G){let p,$,m,_,S;return{c(){p=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),_=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=r(g,"P",{});var w=i(p);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var E=i(m);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){h(g,p,w),e(p,$),e(p,m),e(m,_),e(p,S)},d(g){g&&t(p)}}}function wh(G){let p,$,m,_,S,g,w,E,A,q,z,N,R,ee,Fe,V,Pe,$e,M,J,te,ye,j,C,je,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,F,X,st,Ne,Q,Ue,_e,at,W,ce,rt,He,P,it,ze,Le,dt,pn,tr,or,hn,nr,sr,fn,ar,rr,Zs,U,ir,Yn,dr,cr,Xn,lr,pr,Qn,hr,fr,Zn,ur,mr,es,_r,gr,Xt,Tr,vr,ts,kr,ea,un,os,xr,ta,Qt,oa,mn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,Pr,jr,ds,Cr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,pe,no,Or,lt,Gr,_n,Wr,Ur,so,Hr,Br,Rr,pt,Vr,gn,Jr,Kr,Tn,Yr,Xr,Qr,ps,Zr,ei,ao,ia,ht,St,hs,ro,ti,fs,oi,da,H,io,ni,us,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,ms,pi,hi,Et,po,fi,ho,ui,_s,mi,_i,gi,Be,fo,Ti,kn,vi,xn,ki,xi,gs,bi,yi,bn,uo,ca,ft,zt,Ts,mo,wi,vs,Si,la,he,_o,$i,ks,Ei,zi,go,qi,yn,Fi,Pi,ji,xs,Ci,Mi,qt,To,Ai,bs,Ii,pa,ut,Ft,ys,vo,Di,ws,Ni,ha,I,ko,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Hi,Bi,$n,Ri,Vi,xo,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Pt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,Re,So,pd,qs,hd,fd,jt,ud,Ve,$o,md,Eo,_d,qn,gd,Td,vd,Ct,kd,Mt,zo,xd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,Po,Ed,Pn,zd,qd,Fd,It,jo,Pd,Fs,jd,fa,mt,Dt,Ps,Co,Cd,js,Md,ua,we,Mo,Ad,Ao,Id,jn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,Te,No,Hd,_t,Bd,Cn,Rd,Vd,Cs,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ma,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Uo,ic,Ho,dc,cc,lc,ve,Bo,pc,Tt,hc,An,fc,uc,Ds,mc,_c,gc,Ot,Tc,Ns,vc,kc,Ro,ga,vt,Gt,Ls,Vo,xc,Os,bc,Ta,fe,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,Pc,Wt,jc,ke,Qo,Cc,kt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,va,xt,Ht,Us,en,Uc,Hs,Hc,ka,ue,tn,Bc,on,Rc,Nn,Vc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Bt,el,xe,an,tl,bt,ol,Ln,nl,sl,Bs,al,rl,il,Rt,dl,Rs,cl,ll,rn,xa;return g=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
`}}),Nt=new Yt({props:{$$slots:{default:[Th]},$$scope:{ctx:G}}}),Lo=new ln({props:{code:`from transformers import Speech2TextTokenizer, Speech2TextModel
import torch
...
`}}),Ot=new Yt({props:{$$slots:{default:[vh]},$$scope:{ctx:G}}}),Ro=new ln({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
import soundfile as sf
...
`}}),Ut=new Yt({props:{$$slots:{default:[xh]},$$scope:{ctx:G}}}),Zo=new ln({props:{code:`from transformers import Speech2TextTokenizer, TFSpeech2TextModel
...
`}}),Rt=new Yt({props:{$$slots:{default:[yh]},$$scope:{ctx:G}}}),rn=new ln({props:{code:`import tensorflow as tf
...
`),so=a("a"),Hr=n("facebook/s2t-small-librispeech-asr"),Br=n(" architecture."),Rr=c(),pt=a("p"),Vr=n("Configuration objects inherit from "),gn=a("a"),Jr=n("PretrainedConfig"),Kr=n(` and can be used to control the model outputs. Read the
documentation from `),Tn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),ps=a("p"),Zr=n("Example:"),ei=c(),T(ao.$$.fragment),ia=c(),ht=a("h2"),St=a("a"),hs=a("span"),T(ro.$$.fragment),ti=c(),fs=a("span"),oi=n("Speech2TextTokenizer"),da=c(),H=a("div"),T(io.$$.fragment),ni=c(),us=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),vn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
...
IDs?`),xi=c(),gs=a("p"),bi=n("Should be overridden in a subclass if the model has a special way of building those."),yi=c(),bn=a("div"),T(uo.$$.fragment),ca=c(),ft=a("h2"),zt=a("a"),Ts=a("span"),T(mo.$$.fragment),wi=c(),vs=a("span"),Si=n("Speech2TextFeatureExtractor"),la=c(),he=a("div"),T(_o.$$.fragment),$i=c(),ks=a("p"),Ei=n("Constructs a Speech2Text feature extractor."),zi=c(),go=a("p"),qi=n("This feature extractor inherits from "),yn=a("a"),Fi=n("Speech2TextFeatureExtractor"),Pi=n(` which contains most of the main methods. Users
...
mean and variance normalization to the extracted features.`),Mi=c(),qt=a("div"),T(To.$$.fragment),Ai=c(),bs=a("p"),Ii=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),pa=c(),ut=a("h2"),Ft=a("a"),ys=a("span"),T(vo.$$.fragment),Di=c(),ws=a("span"),Ni=n("Speech2TextProcessor"),ha=c(),I=a("div"),T(ko.$$.fragment),Li=c(),Ss=a("p"),Oi=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),ld=c(),Re=a("div"),T(So.$$.fragment),pd=c(),qs=a("p"),hd=n("Instantiate a processor associated with a pretrained model."),fd=c(),T(jt.$$.fragment),ud=c(),Ve=a("div"),T($o.$$.fragment),md=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Bo.$$.fragment),pc=c(),Tt=a("p"),hc=n("The "),An=a("a"),fc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),Ds=a("code"),mc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),kc=c(),T(Ro.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Vo.$$.fragment),xc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),fe=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
checkpoint.`),qe.forEach(t),wa.forEach(t),Nl.forEach(t),na=l(o),v(eo.$$.fragment,o),sa=l(o),yt=r(o,"P",{});var Sa=i(yt);Ar=s(Sa,"See the "),to=r(Sa,"A",{href:!0,rel:!0});var Bl=i(to);Ir=s(Bl,"model hub"),Bl.forEach(t),Dr=s(Sa," to look for Speech2Text checkpoints."),Sa.forEach(t),aa=l(o),ct=r(o,"H2",{class:!0});var $a=i(ct);wt=r($a,"A",{id:!0,class:!0,href:!0});var Rl=i(wt);cs=r(Rl,"SPAN",{});var Vl=i(cs);v(oo.$$.fragment,Vl),Vl.forEach(t),Rl.forEach(t),Nr=l($a),ls=r($a,"SPAN",{});var Jl=i(ls);Lr=s(Jl,"Speech2TextConfig"),Jl.forEach(t),$a.forEach(t),ra=l(o),pe=r(o,"DIV",{class:!0});var Ye=i(pe);v(no.$$.fragment,Ye),Or=l(Ye),lt=r(Ye,"P",{});var Gn=i(lt);Gr=s(Gn,"This is the configuration class to store the configuration of a "),_n=r(Gn,"A",{href:!0});var Kl=i(_n);Wr=s(Kl,"Speech2TextModel"),Kl.forEach(t),Ur=s(Gn,`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
`),so=r(Gn,"A",{href:!0,rel:!0});var Yl=i(so);Hr=s(Yl,"facebook/s2t-small-librispeech-asr"),Yl.forEach(t),Br=s(Gn," architecture."),Gn.forEach(t),Rr=l(Ye),pt=r(Ye,"P",{});var Wn=i(pt);Vr=s(Wn,"Configuration objects inherit from "),gn=r(Wn,"A",{href:!0});var Xl=i(gn);Jr=s(Xl,"PretrainedConfig"),Xl.forEach(t),Kr=s(Wn,` and can be used to control the model outputs. Read the
documentation from `),Tn=r(Wn,"A",{href:!0});var Ql=i(Tn);Yr=s(Ql,"PretrainedConfig"),Ql.forEach(t),Xr=s(Wn," for more information."),Wn.forEach(t),Qr=l(Ye),ps=r(Ye,"P",{});var Zl=i(ps);Zr=s(Zl,"Example:"),Zl.forEach(t),ei=l(Ye),v(ao.$$.fragment,Ye),Ye.forEach(t),ia=l(o),ht=r(o,"H2",{class:!0});var Ea=i(ht);St=r(Ea,"A",{id:!0,class:!0,href:!0});var ep=i(St);hs=r(ep,"SPAN",{});var tp=i(hs);v(ro.$$.fragment,tp),tp.forEach(t),ep.forEach(t),ti=l(Ea),fs=r(Ea,"SPAN",{});var op=i(fs);oi=s(op,"Speech2TextTokenizer"),op.forEach(t),Ea.forEach(t),da=l(o),H=r(o,"DIV",{class:!0});var be=i(H);v(io.$$.fragment,be),ni=l(be),us=r(be,"P",{});var np=i(us);si=s(np,"Construct an Speech2Text tokenizer."),np.forEach(t),ai=l(be),co=r(be,"P",{});var za=i(co);ri=s(za,"This tokenizer inherits from "),vn=r(za,"A",{href:!0});var sp=i(vn);ii=s(sp,"PreTrainedTokenizer"),sp.forEach(t),di=s(za,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),za.forEach(t),ci=l(be),$t=r(be,"DIV",{class:!0});var qa=i($t);v(lo.$$.fragment,qa),li=l(qa),ms=r(qa,"P",{});var ap=i(ms);pi=s(ap,"Build model inputs from a sequence by appending eos_token_id."),ap.forEach(t),qa.forEach(t),hi=l(be),Et=r(be,"DIV",{class:!0});var Fa=i(Et);v(po.$$.fragment,Fa),fi=l(Fa),ho=r(Fa,"P",{});var Pa=i(ho);ui=s(Pa,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_s=r(Pa,"CODE",{});var rp=i(_s);mi=s(rp,"prepare_for_model"),rp.forEach(t),_i=s(Pa," method."),Pa.forEach(t),Fa.forEach(t),gi=l(be),Be=r(be,"DIV",{class:!0});var Un=i(Be);v(fo.$$.fragment,Un),Ti=l(Un),kn=r(Un,"P",{});var pl=i(kn);vi=s(pl,"Create the token type IDs corresponding to the sequences passed. "),xn=r(pl,"A",{href:!0});var ip=i(xn);ki=s(ip,`What are token type
IDs?`),ip.forEach(t),pl.forEach(t),xi=l(Un),gs=r(Un,"P",{});var dp=i(gs);bi=s(dp,"Should be overridden in a subclass if the model has a special way of building those."),dp.forEach(t),Un.forEach(t),yi=l(be),bn=r(be,"DIV",{class:!0});var cp=i(bn);v(uo.$$.fragment,cp),cp.forEach(t),be.forEach(t),ca=l(o),ft=r(o,"H2",{class:!0});var ja=i(ft);zt=r(ja,"A",{id:!0,class:!0,href:!0});var lp=i(zt);Ts=r(lp,"SPAN",{});var pp=i(Ts);v(mo.$$.fragment,pp),pp.forEach(t),lp.forEach(t),wi=l(ja),vs=r(ja,"SPAN",{});var hp=i(vs);Si=s(hp,"Speech2TextFeatureExtractor"),hp.forEach(t),ja.forEach(t),la=l(o),he=r(o,"DIV",{class:!0});var Xe=i(he);v(_o.$$.fragment,Xe),$i=l(Xe),ks=r(Xe,"P",{});var fp=i(ks);Ei=s(fp,"Constructs a Speech2Text feature extractor."),fp.forEach(t),zi=l(Xe),go=r(Xe,"P",{});var Ca=i(go);qi=s(Ca,"This feature extractor inherits from "),yn=r(Ca,"A",{href:!0});var up=i(yn);Fi=s(up,"Speech2TextFeatureExtractor"),up.forEach(t),Pi=s(Ca,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Ca.forEach(t),ji=l(Xe),xs=r(Xe,"P",{});var mp=i(xs);Ci=s(mp,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
mean and variance normalization to the extracted features.`),mp.forEach(t),Mi=l(Xe),qt=r(Xe,"DIV",{class:!0});var Ma=i(qt);v(To.$$.fragment,Ma),Ai=l(Ma),bs=r(Ma,"P",{});var _p=i(bs);Ii=s(_p,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_p.forEach(t),Ma.forEach(t),Xe.forEach(t),pa=l(o),ut=r(o,"H2",{class:!0});var Aa=i(ut);Ft=r(Aa,"A",{id:!0,class:!0,href:!0});var gp=i(Ft);ys=r(gp,"SPAN",{});var Tp=i(ys);v(vo.$$.fragment,Tp),Tp.forEach(t),gp.forEach(t),Di=l(Aa),ws=r(Aa,"SPAN",{});var vp=i(ws);Ni=s(vp,"Speech2TextProcessor"),vp.forEach(t),Aa.forEach(t),ha=l(o),I=r(o,"DIV",{class:!0});var B=i(I);v(ko.$$.fragment,B),Li=l(B),Ss=r(B,"P",{});var kp=i(Ss);Oi=s(kp,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
single processor.`),kp.forEach(t),Gi=l(B),ge=r(B,"P",{});var Ge=i(ge);wn=r(Ge,"A",{href:!0});var xp=i(wn);Wi=s(xp,"Speech2TextProcessor"),xp.forEach(t),Ui=s(Ge," offers all the functionalities of "),Sn=r(Ge,"A",{href:!0});var bp=i(Sn);Hi=s(bp,"Speech2TextFeatureExtractor"),bp.forEach(t),Bi=s(Ge,` and
`),$n=r(Ge,"A",{href:!0});var yp=i($n);Ri=s(yp,"Speech2TextTokenizer"),yp.forEach(t),Vi=s(Ge,". See the "),xo=r(Ge,"A",{href:!0});var hl=i(xo);$s=r(hl,"STRONG",{});var wp=i($s);Ji=s(wp,"call"),wp.forEach(t),Ki=s(hl,"()"),hl.forEach(t),Yi=s(Ge," and "),En=r(Ge,"A",{href:!0});var Sp=i(En);Xi=s(Sp,"decode()"),Sp.forEach(t),Qi=s(Ge,` for more
...
`),yo=r(Vt,"A",{href:!0});var fl=i(yo);Es=r(fl,"STRONG",{});var $p=i(Es);od=s($p,"call"),$p.forEach(t),nd=s(fl,"()"),fl.forEach(t),sd=s(Vt,` and returns its output. If used in the context
`),zn=r(Vt,"A",{href:!0});var Ep=i(zn);ad=s(Ep,"as_target_processor()"),Ep.forEach(t),rd=s(Vt,` this method forwards all its arguments to Speech2TextTokenizer\u2019s
`),wo=r(Vt,"A",{href:!0});var ul=i(wo);zs=r(ul,"STRONG",{});var zp=i(zs);id=s(zp,"call"),zp.forEach(t),dd=s(ul,"()"),ul.forEach(t),cd=s(Vt,`. Please refer to the doctsring of the above two methods for more
information.`),Vt.forEach(t),Ia.forEach(t),ld=l(B),Re=r(B,"DIV",{class:!0});var Hn=i(Re);v(So.$$.fragment,Hn),pd=l(Hn),qs=r(Hn,"P",{});var qp=i(qs);hd=s(qp,"Instantiate a processor associated with a pretrained model."),qp.forEach(t),fd=l(Hn),v(jt.$$.fragment,Hn),Hn.forEach(t),ud=l(B),Ve=r(B,"DIV",{class:!0});var Bn=i(Ve);v($o.$$.fragment,Bn),md=l(Bn),Eo=r(Bn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=r(Da,"A",{href:!0});var Fp=i(qn);gd=s(Fp,"from_pretrained()"),Fp.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Bn),v(Ct.$$.fragment,Bn),Bn.forEach(t),kd=l(B),Mt=r(B,"DIV",{class:!0});var Na=i(Mt);v(zo.$$.fragment,Na),xd=l(Na),qo=r(Na,"P",{});var La=i(qo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var Pp=i(Fn);yd=s(Pp,"batch_decode()"),Pp.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(B),At=r(B,"DIV",{class:!0});var Oa=i(At);v(Fo.$$.fragment,Oa),$d=l(Oa),Po=r(Oa,"P",{});var Ga=i(Po);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Pn=r(Ga,"A",{href:!0});var jp=i(Pn);zd=s(jp,"decode()"),jp.forEach(t),qd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(B),It=r(B,"DIV",{class:!0});var Wa=i(It);v(jo.$$.fragment,Wa),Pd=l(Wa),Fs=r(Wa,"P",{});var Cp=i(Fs);jd=s(Cp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Cp.forEach(t),Wa.forEach(t),B.forEach(t),fa=l(o),mt=r(o,"H2",{class:!0});var Ua=i(mt);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Mp=i(Dt);Ps=r(Mp,"SPAN",{});var Ap=i(Ps);v(Co.$$.fragment,Ap),Ap.forEach(t),Mp.forEach(t),Cd=l(Ua),js=r(Ua,"SPAN",{});var Ip=i(js);Md=s(Ip,"Speech2TextModel"),Ip.forEach(t),Ua.forEach(t),ua=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ha=i(Ao);Id=s(Ha,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),jn=r(Ha,"A",{href:!0});var Dp=i(jn);Dd=s(Dp,"PreTrainedModel"),Dp.forEach(t),Nd=s(Ha,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ha.forEach(t),Ld=l(Jt),Io=r(Jt,"P",{});var Ba=i(Io);Od=s(Ba,"This model is also a PyTorch "),Do=r(Ba,"A",{href:!0,rel:!0});var Np=i(Do);Gd=s(Np,"torch.nn.Module"),Np.forEach(t),Wd=s(Ba,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ba.forEach(t),Ud=l(Jt),Te=r(Jt,"DIV",{class:!0});var Qe=i(Te);v(No.$$.fragment,Qe),Hd=l(Qe),_t=r(Qe,"P",{});var Rn=i(_t);Bd=s(Rn,"The "),Cn=r(Rn,"A",{href:!0});var Lp=i(Cn);Rd=s(Lp,"Speech2TextModel"),Lp.forEach(t),Vd=s(Rn," forward method, overrides the "),Cs=r(Rn,"CODE",{});var Op=i(Cs);Jd=s(Op,"__call__"),Op.forEach(t),Kd=s(Rn," special method."),Rn.forEach(t),Yd=l(Qe),v(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gp=i(Ms);Qd=s(Gp,"Example:"),Gp.forEach(t),Zd=l(Qe),v(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ma=l(o),gt=r(o,"H2",{class:!0});var Ra=i(gt);Lt=r(Ra,"A",{id:!0,class:!0,href:!0});var Wp=i(Lt);As=r(Wp,"SPAN",{});var Up=i(As);v(Oo.$$.fragment,Up),Up.forEach(t),Wp.forEach(t),ec=l(Ra),Is=r(Ra,"SPAN",{});var Hp=i(Is);tc=s(Hp,"Speech2TextForConditionalGeneration"),Hp.forEach(t),Ra.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);v(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Va=i(Wo);nc=s(Va,`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mn=r(Va,"A",{href:!0});var Bp=i(Mn);sc=s(Bp,"PreTrainedModel"),Bp.forEach(t),ac=s(Va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Va.forEach(t),rc=l(Kt),Uo=r(Kt,"P",{});var Ja=i(Uo);ic=s(Ja,"This model is also a PyTorch "),Ho=r(Ja,"A",{href:!0,rel:!0});var Rp=i(Ho);dc=s(Rp,"torch.nn.Module"),Rp.forEach(t),cc=s(Ja,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ja.forEach(t),lc=l(Kt),ve=r(Kt,"DIV",{class:!0});var Ze=i(ve);v(Bo.$$.fragment,Ze),pc=l(Ze),Tt=r(Ze,"P",{});var Vn=i(Tt);hc=s(Vn,"The "),An=r(Vn,"A",{href:!0});var Vp=i(An);fc=s(Vp,"Speech2TextForConditionalGeneration"),Vp.forEach(t),uc=s(Vn," forward method, overrides the "),Ds=r(Vn,"CODE",{});var Jp=i(Ds);mc=s(Jp,"__call__"),Jp.forEach(t),_c=s(Vn," special method."),Vn.forEach(t),gc=l(Ze),v(Ot.$$.fragment,Ze),Tc=l(Ze),Ns=r(Ze,"P",{});var Kp=i(Ns);vc=s(Kp,"Example:"),Kp.forEach(t),kc=l(Ze),v(Ro.$$.fragment,Ze),Ze.forEach(t),Kt.forEach(t),ga=l(o),vt=r(o,"H2",{class:!0});var Ka=i(vt);Gt=r(Ka,"A",{id:!0,class:!0,href:!0});var Yp=i(Gt);Ls=r(Yp,"SPAN",{});var Xp=i(Ls);v(Vo.$$.fragment,Xp),Xp.forEach(t),Yp.forEach(t),xc=l(Ka),Os=r(Ka,"SPAN",{});var Qp=i(Os);bc=s(Qp,"TFSpeech2TextModel"),Qp.forEach(t),Ka.forEach(t),Ta=l(o),fe=r(o,"DIV",{class:!0});var et=i(fe);v(Jo.$$.fragment,et),yc=l(et),Ko=r(et,"P",{});var Ya=i(Ko);wc=s(Ya,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),Pc=l(et),v(Wt.$$.fragment,et),jc=l(et),ke=r(et,"DIV",{class:!0});var tt=i(ke);v(Qo.$$.fragment,tt),Cc=l(tt),kt=r(tt,"P",{});var Jn=i(kt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var th=i(Dn);Ac=s(th,"TFSpeech2TextModel"),th.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var oh=i(Gs);Dc=s(oh,"__call__"),oh.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),v(Ut.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var nh=i(Ws);Gc=s(nh,"Example:"),nh.forEach(t),Wc=l(tt),v(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),va=l(o),xt=r(o,"H2",{class:!0});var Qa=i(xt);Ht=r(Qa,"A",{id:!0,class:!0,href:!0});var sh=i(Ht);Us=r(sh,"SPAN",{});var ah=i(Us);v(en.$$.fragment,ah),ah.forEach(t),sh.forEach(t),Uc=l(Qa),Hs=r(Qa,"SPAN",{});var rh=i(Hs);Hc=s(rh,"TFSpeech2TextForConditionalGeneration"),rh.forEach(t),Qa.forEach(t),ka=l(o),ue=r(o,"DIV",{class:!0});var ot=i(ue);v(tn.$$.fragment,ot),Bc=l(ot),on=r(ot,"P",{});var Za=i(on);Rc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Nn=r(Za,"A",{href:!0});var ih=i(Nn);Vc=s(ih,"TFPreTrainedModel"),ih.forEach(t),Jc=s(Za,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
