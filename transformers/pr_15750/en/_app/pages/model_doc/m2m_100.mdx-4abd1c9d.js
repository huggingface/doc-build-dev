...
the latter silently ignores them.`)},l(w){m=s(w,"P",{});var q=a(m);E=i(q,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(q,"CODE",{});var N=a(v);y=i(N,"Module"),N.forEach(o),F=i(q,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),q.forEach(o)},m(w,q){p(w,m,q),e(m,E),e(m,v),e(v,y),e(m,F)},d(w){w&&o(m)}}}function mi(_e){let m,E,v,y,F,w,q,N,an,go,U,te,xt,ge,rn,Et,dn,ko,oe,ln,ke,cn,hn,Mo,it,pn,vo,dt,Ct,mn,bo,ne,un,Me,fn,_n,yo,V,se,jt,ve,gn,Pt,kn,wo,D,Mn,Ft,vn,bn,St,yn,wn,At,Tn,zn,To,C,qn,lt,$n,xn,Dt,En,Cn,Lt,jn,Pn,It,Fn,Sn,zo,ct,Nt,An,qo,be,$o,ht,ye,Gt,Dn,Ln,$,In,Ot,Nn,Gn,Bt,On,Bn,Wt,Wn,Hn,Ht,Un,Vn,Ut,Xn,Rn,xo,we,Eo,X,ae,Vt,Te,Jn,Xt,Kn,Co,x,ze,Zn,R,Qn,pt,Yn,es,qe,ts,os,ns,J,ss,mt,as,rs,ut,is,ds,ls,Rt,cs,hs,$e,jo,K,re,Jt,xe,ps,Kt,ms,Po,b,Ee,us,Ce,fs,je,_s,gs,ks,Pe,Ms,ft,vs,bs,ys,Zt,ws,Ts,Fe,zs,L,Se,qs,Ae,$s,Qt,xs,Es,Cs,De,Le,Yt,js,Ps,eo,Fs,Ss,Ie,to,As,Ds,oo,Ls,Is,no,Ns,Gs,ie,Ne,Os,Ge,Bs,so,Ws,Hs,Us,G,Oe,Vs,_t,Xs,gt,Rs,Js,ao,Ks,Zs,kt,Be,Fo,Z,de,ro,We,Qs,io,Ys,So,S,He,ea,Ue,ta,Mt,oa,na,sa,Ve,aa,Xe,ra,ia,da,j,Re,la,Q,ca,vt,ha,pa,lo,ma,ua,fa,le,_a,co,ga,ka,Je,Ao,Y,ce,ho,Ke,Ma,po,va,Do,A,Ze,ba,Qe,ya,bt,wa,Ta,za,Ye,qa,et,$a,xa,Ea,T,tt,Ca,ee,ja,yt,Pa,Fa,mo,Sa,Aa,Da,he,La,uo,Ia,Na,ot,Ga,fo,Oa,Ba,nt,Lo;return w=new rt({}),ge=new rt({}),ve=new rt({}),be=new at({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
examples. To install `),Lt=n("code"),jn=r("sentencepiece"),Pn=r(" run "),It=n("code"),Fn=r("pip install sentencepiece"),Sn=r("."),zo=d(),ct=n("ul"),Nt=n("li"),An=r("Supervised Training"),qo=d(),u(be.$$.fragment),$o=d(),ht=n("ul"),ye=n("li"),Gt=n("p"),Dn=r("Generation"),Ln=d(),$=n("p"),In=r("M2M100 uses the "),Ot=n("code"),Nn=r("eos_token_id"),Gn=r(" as the "),Bt=n("code"),On=r("decoder_start_token_id"),Bn=r(` for generation with the target language id
...
this superclass for more information regarding those methods.`),ys=d(),Zt=n("p"),ws=r("Examples:"),Ts=d(),u(Fe.$$.fragment),zs=d(),L=n("div"),u(Se.$$.fragment),qs=d(),Ae=n("p"),$s=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Qt=n("code"),xs=r("X"),Es=r(" represents the sequence:"),Cs=d(),De=n("ul"),Le=n("li"),Yt=n("code"),js=r("input_ids"),Ps=r(" (for encoder) "),eo=n("code"),Fs=r("X [eos, src_lang_code]"),Ss=d(),Ie=n("li"),to=n("code"),As=r("decoder_input_ids"),Ds=r(": (for decoder) "),oo=n("code"),Ls=r("X [eos, tgt_lang_code]"),Is=d(),no=n("p"),Ns=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=d(),T=n("div"),u(tt.$$.fragment),Ca=d(),ee=n("p"),ja=r("The "),yt=n("a"),Pa=r("M2M100ForConditionalGeneration"),Fa=r(" forward method, overrides the "),mo=n("code"),Sa=r("__call__"),Aa=r(" special method."),Da=d(),u(he.$$.fragment),La=d(),uo=n("p"),Ia=r("Example:"),Na=d(),u(ot.$$.fragment),Ga=d(),fo=n("p"),Oa=r("Translation example::"),Ba=d(),u(nt.$$.fragment),this.h()},l(t){const h=ci('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(o),E=l(t),v=s(t,"H1",{class:!0});var st=a(v);y=s(st,"A",{id:!0,class:!0,href:!0});var _o=a(y);F=s(_o,"SPAN",{});var Ha=a(F);f(w.$$.fragment,Ha),Ha.forEach(o),_o.forEach(o),q=l(st),N=s(st,"SPAN",{});var Ua=a(N);an=i(Ua,"M2M100"),Ua.forEach(o),st.forEach(o),go=l(t),U=s(t,"H2",{class:!0});var Io=a(U);te=s(Io,"A",{id:!0,class:!0,href:!0});var Va=a(te);xt=s(Va,"SPAN",{});var Xa=a(xt);f(ge.$$.fragment,Xa),Xa.forEach(o),Va.forEach(o),rn=l(Io),Et=s(Io,"SPAN",{});var Ra=a(Et);dn=i(Ra,"Overview"),Ra.forEach(o),Io.forEach(o),ko=l(t),oe=s(t,"P",{});var No=a(oe);ln=i(No,"The M2M100 model was proposed in "),ke=s(No,"A",{href:!0,rel:!0});var Ja=a(ke);cn=i(Ja,"Beyond English-Centric Multilingual Machine Translation"),Ja.forEach(o),hn=i(No,` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
Siddharth Goyal, Mandeep Baines, Onur Celebi, Guillaume Wenzek, Vishrav Chaudhary, Naman Goyal, Tom Birch, Vitaliy
...
examples. To install `),Lt=s(O,"CODE",{});var dr=a(Lt);jn=i(dr,"sentencepiece"),dr.forEach(o),Pn=i(O," run "),It=s(O,"CODE",{});var lr=a(It);Fn=i(lr,"pip install sentencepiece"),lr.forEach(o),Sn=i(O,"."),O.forEach(o),zo=l(t),ct=s(t,"UL",{});var cr=a(ct);Nt=s(cr,"LI",{});var hr=a(Nt);An=i(hr,"Supervised Training"),hr.forEach(o),cr.forEach(o),qo=l(t),f(be.$$.fragment,t),$o=l(t),ht=s(t,"UL",{});var pr=a(ht);ye=s(pr,"LI",{});var Bo=a(ye);Gt=s(Bo,"P",{});var mr=a(Gt);Dn=i(mr,"Generation"),mr.forEach(o),Ln=l(Bo),$=s(Bo,"P",{});var I=a($);In=i(I,"M2M100 uses the "),Ot=s(I,"CODE",{});var ur=a(Ot);Nn=i(ur,"eos_token_id"),ur.forEach(o),Gn=i(I," as the "),Bt=s(I,"CODE",{});var fr=a(Bt);On=i(fr,"decoder_start_token_id"),fr.forEach(o),Bn=i(I,` for generation with the target language id
being forced as the first generated token. To force the target language id as the first generated token, pass the
...
this superclass for more information regarding those methods.`),Vo.forEach(o),ys=l(z),Zt=s(z,"P",{});var Pr=a(Zt);ws=i(Pr,"Examples:"),Pr.forEach(o),Ts=l(z),f(Fe.$$.fragment,z),zs=l(z),L=s(z,"DIV",{class:!0});var me=a(L);f(Se.$$.fragment,me),qs=l(me),Ae=s(me,"P",{});var Xo=a(Ae);$s=i(Xo,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Qt=s(Xo,"CODE",{});var Fr=a(Qt);xs=i(Fr,"X"),Fr.forEach(o),Es=i(Xo," represents the sequence:"),Xo.forEach(o),Cs=l(me),De=s(me,"UL",{});var Ro=a(De);Le=s(Ro,"LI",{});var Jo=a(Le);Yt=s(Jo,"CODE",{});var Sr=a(Yt);js=i(Sr,"input_ids"),Sr.forEach(o),Ps=i(Jo," (for encoder) "),eo=s(Jo,"CODE",{});var Ar=a(eo);Fs=i(Ar,"X [eos, src_lang_code]"),Ar.forEach(o),Jo.forEach(o),Ss=l(Ro),Ie=s(Ro,"LI",{});var Ko=a(Ie);to=s(Ko,"CODE",{});var Dr=a(to);As=i(Dr,"decoder_input_ids"),Dr.forEach(o),Ds=i(Ko,": (for decoder) "),oo=s(Ko,"CODE",{});var Lr=a(oo);Ls=i(Lr,"X [eos, tgt_lang_code]"),Lr.forEach(o),Ko.forEach(o),Ro.forEach(o),Is=l(me),no=s(me,"P",{});var Ir=a(no);Ns=i(Ir,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Ir.forEach(o),me.forEach(o),Gs=l(z),ie=s(z,"DIV",{class:!0});var Zo=a(ie);f(Ne.$$.fragment,Zo),Os=l(Zo),Ge=s(Zo,"P",{});var Qo=a(Ge);Bs=i(Qo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
