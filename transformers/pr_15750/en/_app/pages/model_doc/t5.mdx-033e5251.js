import{S as uw,i as mw,s as fw,e as o,k as d,w as f,t as r,L as _w,c as s,d as t,m as l,a,x as _,h as i,b as c,J as e,g as p,y as g,q as T,o as k,B as v}from"../../chunks/vendor-9e2b328e.js";import{T as zt}from"../../chunks/Tip-76f97a76.js";import{D as M}from"../../chunks/Docstring-50fd6873.js";import{C as R}from"../../chunks/CodeBlock-88e23343.js";import{I as ke}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function gw(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function Tw(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function kw(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function vw(N){let u,x,b,w,z,$,y,E,Ee,oe,q,ee,O,se,qe,G,je,ve,B,I,ae,pe,F,C,he,K,be,ue,U,Fe,ye,P,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae;return{c(){u=o("p"),x=r("TF 2.0 models accepts two formats as inputs:"),b=d(),w=o("ul"),z=o("li"),$=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),E=o("li"),Ee=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),q=o("p"),ee=r("This second option is useful when using "),O=o("code"),se=r("tf.keras.Model.fit"),qe=r(` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var L=a(F);C=s(L,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),U=s(Y,"CODE",{});var Le=a(U);Fe=i(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),ye=l(L),P=s(L,"LI",{});var J=a(P);Me=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(J,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(J," or "),A=s(J,"CODE",{});var Ne=a(A);Pe=i(Ne,"model([input_ids, attention_mask, token_type_ids])"),Ne.forEach(t),J.forEach(t),fe=l(L),D=s(L,"LI",{});var Ie=a(D);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=s(Ie,"CODE",{});var ft=a(W);Ae=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),L.forEach(t)},m(m,j){p(m,u,j),e(u,x),p(m,b,j),p(m,w,j),e(w,z),e(z,$),e(w,y),e(w,E),e(E,Ee),p(m,oe,j),p(m,q,j),e(q,ee),e(q,O),e(O,se),e(q,qe),e(q,G),e(G,je),e(q,ve),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,U),e(U,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,A),e(A,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ae)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(q),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function bw(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function yw(N){let u,x,b,w,z,$,y,E,Ee,oe,q,ee,O,se,qe,G,je,ve,B,I,ae,pe,F,C,he,K,be,ue,U,Fe,ye,P,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae;return{c(){u=o("p"),x=r("TF 2.0 models accepts two formats as inputs:"),b=d(),w=o("ul"),z=o("li"),$=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),E=o("li"),Ee=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),q=o("p"),ee=r("This second option is useful when using "),O=o("code"),se=r("tf.keras.Model.fit"),qe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),ve=r("."),B=d(),I=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),C=o("li"),he=r("a single Tensor with "),K=o("code"),be=r("input_ids"),ue=r(" only and nothing else: "),U=o("code"),Fe=r("model(inputs_ids)"),ye=d(),P=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),A=o("code"),Pe=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),D=o("li"),Ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=o("code"),Ae=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);x=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),b=l(m),w=s(m,"UL",{});var te=a(w);z=s(te,"LI",{});var Oe=a(z);$=i(Oe,"having all inputs as keyword arguments (like PyTorch models), or"),Oe.forEach(t),y=l(te),E=s(te,"LI",{});var pt=a(E);Ee=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),q=s(m,"P",{});var S=a(q);ee=i(S,"This second option is useful when using "),O=s(S,"CODE",{});var Ge=a(O);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),qe=i(S,` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var L=a(F);C=s(L,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),U=s(Y,"CODE",{});var Le=a(U);Fe=i(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),ye=l(L),P=s(L,"LI",{});var J=a(P);Me=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(J,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(J," or "),A=s(J,"CODE",{});var Ne=a(A);Pe=i(Ne,"model([input_ids, attention_mask, token_type_ids])"),Ne.forEach(t),J.forEach(t),fe=l(L),D=s(L,"LI",{});var Ie=a(D);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=s(Ie,"CODE",{});var ft=a(W);Ae=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),L.forEach(t)},m(m,j){p(m,u,j),e(u,x),p(m,b,j),p(m,w,j),e(w,z),e(z,$),e(w,y),e(w,E),e(E,Ee),p(m,oe,j),p(m,q,j),e(q,ee),e(q,O),e(O,se),e(q,qe),e(q,G),e(G,je),e(q,ve),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,U),e(U,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,A),e(A,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ae)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(q),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function ww(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function $w(N){let u,x,b,w,z,$,y,E,Ee,oe,q,ee,O,se,qe,G,je,ve,B,I,ae,pe,F,C,he,K,be,ue,U,Fe,ye,P,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae;return{c(){u=o("p"),x=r("TF 2.0 models accepts two formats as inputs:"),b=d(),w=o("ul"),z=o("li"),$=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),E=o("li"),Ee=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),q=o("p"),ee=r("This second option is useful when using "),O=o("code"),se=r("tf.keras.Model.fit"),qe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),ve=r("."),B=d(),I=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),C=o("li"),he=r("a single Tensor with "),K=o("code"),be=r("input_ids"),ue=r(" only and nothing else: "),U=o("code"),Fe=r("model(inputs_ids)"),ye=d(),P=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),A=o("code"),Pe=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),D=o("li"),Ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=o("code"),Ae=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);x=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),b=l(m),w=s(m,"UL",{});var te=a(w);z=s(te,"LI",{});var Oe=a(z);$=i(Oe,"having all inputs as keyword arguments (like PyTorch models), or"),Oe.forEach(t),y=l(te),E=s(te,"LI",{});var pt=a(E);Ee=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),q=s(m,"P",{});var S=a(q);ee=i(S,"This second option is useful when using "),O=s(S,"CODE",{});var Ge=a(O);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),qe=i(S,` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var L=a(F);C=s(L,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),U=s(Y,"CODE",{});var Le=a(U);Fe=i(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),ye=l(L),P=s(L,"LI",{});var J=a(P);Me=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(J,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(J," or "),A=s(J,"CODE",{});var Ne=a(A);Pe=i(Ne,"model([input_ids, attention_mask, token_type_ids])"),Ne.forEach(t),J.forEach(t),fe=l(L),D=s(L,"LI",{});var Ie=a(D);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=s(Ie,"CODE",{});var ft=a(W);Ae=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),L.forEach(t)},m(m,j){p(m,u,j),e(u,x),p(m,b,j),p(m,w,j),e(w,z),e(z,$),e(w,y),e(w,E),e(E,Ee),p(m,oe,j),p(m,q,j),e(q,ee),e(q,O),e(O,se),e(q,qe),e(q,G),e(G,je),e(q,ve),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,U),e(U,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,A),e(A,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ae)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(q),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function zw(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function xw(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function Ew(N){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function qw(N){let u,x,b,w,z,$,y,E,Ee,oe,q,ee,O,se,qe,G,je,ve,B,I,ae,pe,F,C,he,K,be,ue,U,Fe,ye,P,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae,m,j,te,Oe,pt,S,Ge,ne,ht,L,Y,ut,Le,J,mt,Ne,Ie,ft,Vl,Xa,Sp,Kl,Be,di,li,To,Op,Gp,ci,pi,ko,Bp,Up,hi,ui,vo,Wp,Rp,mi,fi,bo,Hp,Vp,_i,Qa,yo,Kp,Yp,Yl,er,Jp,Jl,xt,gi,zn,Ti,Zp,Xp,tr,Qp,eh,th,ki,xn,vi,nh,oh,nr,sh,ah,rh,bi,En,yi,ih,dh,or,lh,ch,Zl,qn,ph,wo,hh,uh,Xl,Et,mh,$o,fh,_h,zo,gh,Th,Ql,sr,ec,Jt,jn,wi,xo,kh,$i,vh,tc,_t,bh,zi,yh,wh,xi,$h,zh,Ei,xh,Eh,nc,Fn,qh,ar,jh,Fh,oc,Mn,dt,qi,Mh,Ph,_e,Ch,ji,Ah,Lh,Fi,Nh,Ih,Mi,Dh,Sh,Pi,Oh,Gh,Ci,Bh,Uh,rr,Wh,Rh,Hh,Ai,Vh,Kh,Eo,Yh,qo,Jh,jo,Zh,Xh,Qh,ge,Li,eu,tu,Ni,nu,ou,Fo,su,re,au,Ii,ru,iu,Di,du,lu,Si,cu,pu,Oi,hu,uu,Gi,mu,fu,Bi,_u,gu,Ui,Tu,ku,vu,Zt,bu,Wi,yu,wu,Ri,$u,zu,xu,Te,Eu,Hi,qu,ju,Vi,Fu,Mu,Ki,Pu,Cu,Yi,Au,Lu,Mo,Nu,Iu,Ji,Du,Su,Ou,Po,sc,ir,Gu,ac,qt,Zi,Co,Bu,Xi,Uu,Wu,Ru,Qi,Xt,Hu,Ao,Vu,Ku,Lo,Yu,Ju,Zu,ed,No,Xu,td,Qu,em,rc,dr,ic,Qt,Pn,nd,Io,tm,od,nm,dc,gt,om,lr,sm,am,Do,rm,im,So,dm,lm,lc,Oo,cc,Ue,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,km,hc,Go,uc,hr,mc,en,Cn,id,Bo,vm,dd,bm,fc,Tt,ym,Uo,wm,$m,ld,zm,xm,cd,Em,qm,_c,tn,An,pd,Wo,jm,hd,Fm,gc,ur,Mm,Tc,Ln,ud,nn,Pm,Ro,Cm,Am,Ho,Lm,Nm,Im,md,De,Dm,Vo,Sm,Om,Ko,Gm,Bm,Yo,Um,Wm,Jo,Rm,Hm,Zo,Vm,Km,kc,on,Nn,fd,Xo,Ym,_d,Jm,vc,wt,Qo,Zm,$t,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,bc,an,In,gd,ts,hf,Td,uf,yc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,kf,Tr,vf,bf,yf,jt,rs,wf,kd,$f,zf,is,kr,xf,vd,Ef,qf,vr,jf,bd,Ff,Mf,Dn,ds,Pf,ls,Cf,yd,Af,Lf,Nf,Sn,cs,If,wd,Df,Sf,br,ps,wc,rn,On,$d,hs,Of,zd,Gf,$c,Se,us,Bf,dn,Uf,xd,Wf,Rf,ms,Hf,Vf,Kf,fs,Yf,yr,Jf,Zf,Xf,Ft,_s,Qf,Ed,e_,t_,gs,wr,n_,qd,o_,s_,$r,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,zc,ln,Bn,Md,ks,c_,Pd,p_,xc,Z,vs,h_,Cd,u_,m_,bs,f_,ys,__,g_,T_,ws,k_,zr,v_,b_,y_,$s,w_,zs,$_,z_,x_,We,xs,E_,cn,q_,xr,j_,F_,Ad,M_,P_,C_,Un,A_,Ld,L_,N_,Es,I_,Re,qs,D_,Nd,S_,O_,Id,G_,B_,Dd,U_,W_,js,R_,kt,Fs,H_,Sd,V_,K_,Od,Y_,J_,Ms,Ec,pn,Wn,Gd,Ps,Z_,Bd,X_,qc,X,Cs,Q_,As,eg,Ud,tg,ng,og,Ls,sg,Ns,ag,rg,ig,Is,dg,Er,lg,cg,pg,Ds,hg,Ss,ug,mg,fg,He,Os,_g,hn,gg,qr,Tg,kg,Wd,vg,bg,yg,Rn,wg,Rd,$g,zg,Gs,xg,Ve,Bs,Eg,Hd,qg,jg,Vd,Fg,Mg,Kd,Pg,Cg,Us,Ag,vt,Ws,Lg,Yd,Ng,Ig,Jd,Dg,Sg,Rs,jc,un,Hn,Zd,Hs,Og,Xd,Gg,Fc,Q,Vs,Bg,Qd,Ug,Wg,Ks,Rg,Ys,Hg,Vg,Kg,Js,Yg,jr,Jg,Zg,Xg,Zs,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,kT,vT,na,bT,bt,oa,yT,al,wT,$T,rl,zT,xT,sa,Mc,fn,Kn,il,aa,ET,dl,qT,Pc,de,ra,jT,ll,FT,MT,ia,PT,da,CT,AT,LT,la,NT,Mr,IT,DT,ST,ca,OT,pa,GT,BT,UT,Yn,WT,Je,ha,RT,_n,HT,Pr,VT,KT,cl,YT,JT,ZT,Jn,XT,pl,QT,e5,ua,Cc,gn,Zn,hl,ma,t5,ul,n5,Ac,le,fa,o5,_a,s5,ml,a5,r5,i5,ga,d5,Ta,l5,c5,p5,ka,h5,Cr,u5,m5,f5,va,_5,ba,g5,T5,k5,Xn,v5,Ze,ya,b5,Tn,y5,Ar,w5,$5,fl,z5,x5,E5,Qn,q5,_l,j5,F5,wa,Lc,kn,eo,gl,$a,M5,Tl,P5,Nc,ce,za,C5,kl,A5,L5,xa,N5,Ea,I5,D5,S5,qa,O5,Lr,G5,B5,U5,ja,W5,Fa,R5,H5,V5,to,K5,Xe,Ma,Y5,vn,J5,Nr,Z5,X5,vl,Q5,ek,tk,no,nk,bl,ok,sk,Pa,Ic,bn,oo,yl,Ca,ak,wl,rk,Dc,lt,Aa,ik,Qe,La,dk,yn,lk,$l,ck,pk,zl,hk,uk,mk,so,fk,xl,_k,gk,Na,Tk,Mt,Ia,kk,El,vk,bk,Da,yk,Pt,Sa,wk,ql,$k,zk,Oa,Sc,wn,ao,jl,Ga,xk,Fl,Ek,Oc,ct,Ba,qk,et,Ua,jk,$n,Fk,Ml,Mk,Pk,Pl,Ck,Ak,Lk,ro,Nk,Cl,Ik,Dk,Wa,Sk,Ct,Ra,Ok,Al,Gk,Bk,Ha,Uk,At,Va,Wk,Ll,Rk,Hk,Ka,Gc;return $=new ke({}),se=new ke({}),xo=new ke({}),Eo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
configuration. Check out the <a href="/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xs=new M({props:{name:"forward",anchor:"transformers.T5Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1340",parametersDescription:[{anchor:"transformers.T5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15750/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15750/en/model_doc/t5#transformers.T5Config"
...
`}}),Un=new zt({props:{$$slots:{default:[gw]},$$scope:{ctx:N}}}),Es=new R({props:{code:`from transformers import T5Tokenizer, T5Model
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1308"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Os=new M({props:{name:"forward",anchor:"transformers.T5ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1534",parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15750/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
`}}),Rn=new zt({props:{$$slots:{default:[Tw]},$$scope:{ctx:N}}}),Gs=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1503"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1805",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15750/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_15750/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15750/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
`}}),Vn=new zt({props:{$$slots:{default:[kw]},$$scope:{ctx:N}}}),ea=new R({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_t5.py#L1779"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Yn=new zt({props:{$$slots:{default:[vw]},$$scope:{ctx:N}}}),ha=new M({props:{name:"call",anchor:"transformers.TFT5Model.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_tf_t5.py#L1157",parametersDescription:[{anchor:"transformers.TFT5Model.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
...
`}}),Jn=new zt({props:{$$slots:{default:[bw]},$$scope:{ctx:N}}}),ua=new R({props:{code:`from transformers import T5Tokenizer, TFT5Model
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:N}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_tf_t5.py#L1355",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15750/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Qn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:N}}}),wa=new R({props:{code:`from transformers import T5Tokenizer, TFT5ForConditionalGeneration
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[$w]},$$scope:{ctx:N}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/t5/modeling_tf_t5.py#L1630",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15750/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15750/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15750/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
`}}),no=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:N}}}),Pa=new R({props:{code:`from transformers import T5Tokenizer, TFT5EncoderModel
...
`}}),so=new zt({props:{$$slots:{default:[xw]},$$scope:{ctx:N}}}),Na=new R({props:{code:`from transformers import T5Tokenizer, FlaxT5Model
...
<p><a
  href="/docs/transformers/pr_15750/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
>transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),ro=new zt({props:{$$slots:{default:[Ew]},$$scope:{ctx:N}}}),Wa=new R({props:{code:`from transformers import T5Tokenizer, FlaxT5ForConditionalGeneration
...
for summarization: `),W=o("em"),Ae=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Oe=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),S=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),L=o("a"),Y=r("training"),ut=r(", "),Le=o("a"),J=r("inference"),mt=r(" and "),Ne=o("a"),Ie=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Sp=r("T5 comes in different sizes:"),Kl=d(),Be=o("ul"),di=o("li"),li=o("p"),To=o("a"),Op=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),ko=o("a"),Bp=r("t5-base"),Up=d(),hi=o("li"),ui=o("p"),vo=o("a"),Wp=r("t5-large"),Rp=d(),mi=o("li"),fi=o("p"),bo=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),yo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Jp=r("Based on the original T5 model, Google has released some follow-up works:"),Jl=d(),xt=o("ul"),gi=o("li"),zn=o("p"),Ti=o("strong"),Zp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),or=o("a"),lh=r("here"),ch=r("."),Zl=d(),qn=o("p"),ph=r("All checkpoints can be found on the "),wo=o("a"),hh=r("hub"),uh=r("."),Xl=d(),Et=o("p"),mh=r("This model was contributed by "),$o=o("a"),fh=r("thomwolf"),_h=r(". The original code can be found "),zo=o("a"),gh=r("here"),Th=r("."),Ql=d(),sr=o("a"),ec=d(),Jt=o("h2"),jn=o("a"),wi=o("span"),f(xo.$$.fragment),kh=d(),$i=o("span"),vh=r("Training"),tc=d(),_t=o("p"),bh=r(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
language modeling head on top of the decoder.`),oc=d(),Mn=o("ul"),dt=o("li"),qi=o("p"),Mh=r("Unsupervised denoising training"),Ph=d(),_e=o("p"),Ch=r("In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=o("em"),Ah=r("a.k.a"),Lh=r(` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=o("em"),Nh=r("real"),Ih=r(` masked tokens. Each
...
processed as follows:`),Kh=d(),f(Eo.$$.fragment),Yh=d(),qo=o("p"),Jh=r("If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=o("a"),Zh=r("run_t5_mlm_flax.py"),Xh=r(` script in the Examples
directory.`),Qh=d(),ge=o("li"),Li=o("p"),eu=r("Supervised training"),tu=d(),Ni=o("p"),nu=r(`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
...
during T5\u2019s pre-training.`),vu=d(),Zt=o("p"),bu=r(`However, the example above only shows a single training example. In practice, one trains deep learning models in
...
of the `),Ki=o("code"),Pu=r("CrossEntropyLoss"),Cu=r(". In Flax, one can use the "),Yi=o("code"),Au=r("decoder_attention_mask"),Lu=r(` to ignore padded tokens from
the loss (see the `),Mo=o("a"),Nu=r("Flax summarization script"),Iu=r(` for details). We also pass
`),Ji=o("code"),Du=r("attention_mask"),Su=r(` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),Ou=d(),f(Po.$$.fragment),sc=d(),ir=o("p"),Gu=r("Additional training tips:"),ac=d(),qt=o("ul"),Zi=o("li"),Co=o("p"),Bu=r("T5 models need a slightly higher learning rate than the default one set in the "),Xi=o("code"),Uu=r("Trainer"),Wu=r(` when using the AdamW
...
pre-training mixture (see Appendix D of the `),Lo=o("a"),Yu=r("paper"),Ju=r(` for the task prefixes
used).`),Zu=d(),ed=o("li"),No=o("p"),Xu=r(`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=o("a"),Lm=r("t5_tokenizer_model.py"),Nm=r(`
...
(`),Jo=o("a"),Rm=r("PyTorch"),Hm=r(" and "),Zo=o("a"),Vm=r("Tensorflow"),Km=r(`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),kc=d(),on=o("h2"),Nn=o("a"),fd=o("span"),f(Xo.$$.fragment),Ym=d(),_d=o("span"),Jm=r("T5Config"),vc=d(),wt=o("div"),f(Qo.$$.fragment),Zm=d(),$t=o("p"),Xm=r("This is the configuration class to store the configuration of a "),mr=o("a"),Qm=r("T5Model"),ef=r(" or a "),fr=o("a"),tf=r("TFT5Model"),nf=r(`. It is used to
...
special tokens using the tokenizer `),yd=o("code"),Af=r("prepare_for_model"),Lf=r(" method."),Nf=d(),Sn=o("div"),f(cs.$$.fragment),If=d(),wd=o("p"),Df=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
`),ms=o("a"),Hf=r("Unigram"),Vf=r("."),Kf=d(),fs=o("p"),Yf=r("This tokenizer inherits from "),yr=o("a"),Jf=r("PreTrainedTokenizerFast"),Zf=r(` which contains most of the main methods. Users should
...
and behavior.`),x_=d(),We=o("div"),f(xs.$$.fragment),E_=d(),cn=o("p"),q_=r("The "),xr=o("a"),j_=r("T5Model"),F_=r(" forward method, overrides the "),Ad=o("code"),M_=r("__call__"),P_=r(" special method."),C_=d(),f(Un.$$.fragment),A_=d(),Ld=o("p"),L_=r("Example:"),N_=d(),f(Es.$$.fragment),I_=d(),Re=o("div"),f(qs.$$.fragment),D_=d(),Nd=o("p"),S_=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),O_=d(),Id=o("p"),G_=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),B_=d(),Dd=o("p"),U_=r("Example:"),W_=d(),f(js.$$.fragment),R_=d(),kt=o("div"),f(Fs.$$.fragment),H_=d(),Sd=o("p"),V_=r("Moves the model to cpu from a model parallel state."),K_=d(),Od=o("p"),Y_=r("Example:"),J_=d(),f(Ms.$$.fragment),Ec=d(),pn=o("h2"),Wn=o("a"),Gd=o("span"),f(Ps.$$.fragment),Z_=d(),Bd=o("span"),X_=r("T5ForConditionalGeneration"),qc=d(),X=o("div"),f(Cs.$$.fragment),Q_=d(),As=o("p"),eg=r("T5 Model with a "),Ud=o("code"),tg=r("language modeling"),ng=r(" head on top."),og=d(),Ls=o("p"),sg=r("The T5 model was proposed in "),Ns=o("a"),ag=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
it will evenly distribute blocks across all devices.`),Mg=d(),Kd=o("p"),Pg=r("Example:"),Cg=d(),f(Us.$$.fragment),Ag=d(),vt=o("div"),f(Ws.$$.fragment),Lg=d(),Yd=o("p"),Ng=r("Moves the model to cpu from a model parallel state."),Ig=d(),Jd=o("p"),Dg=r("Example:"),Sg=d(),f(Rs.$$.fragment),jc=d(),un=o("h2"),Hn=o("a"),Zd=o("span"),f(Hs.$$.fragment),Og=d(),Xd=o("span"),Gg=r("T5EncoderModel"),Fc=d(),Q=o("div"),f(Vs.$$.fragment),Bg=d(),Qd=o("p"),Ug=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Wg=d(),Ks=o("p"),Rg=r("The T5 model was proposed in "),Ys=o("a"),Hg=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Vg=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Kg=d(),Js=o("p"),Yg=r("This model inherits from "),jr=o("a"),Jg=r("PreTrainedModel"),Zg=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xg=d(),Zs=o("p"),Qg=r("This model is also a PyTorch "),Xs=o("a"),eT=r("torch.nn.Module"),tT=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),LT=d(),la=o("p"),NT=r("This model inherits from "),Mr=o("a"),IT=r("TFPreTrainedModel"),DT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ST=d(),ca=o("p"),OT=r("This model is also a "),pa=o("a"),GT=r("tf.keras.Model"),BT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),UT=d(),f(Yn.$$.fragment),WT=d(),Je=o("div"),f(ha.$$.fragment),RT=d(),_n=o("p"),HT=r("The "),Pr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),JT=r(" special method."),ZT=d(),f(Jn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),e5=d(),f(ua.$$.fragment),Cc=d(),gn=o("h2"),Zn=o("a"),hl=o("span"),f(ma.$$.fragment),t5=d(),ul=o("span"),n5=r("TFT5ForConditionalGeneration"),Ac=d(),le=o("div"),f(fa.$$.fragment),o5=d(),_a=o("p"),s5=r("T5 Model with a "),ml=o("code"),a5=r("language modeling"),r5=r(" head on top."),i5=d(),ga=o("p"),d5=r("The T5 model was proposed in "),Ta=o("a"),l5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),c5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),p5=d(),ka=o("p"),h5=r("This model inherits from "),Cr=o("a"),u5=r("TFPreTrainedModel"),m5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),f5=d(),va=o("p"),_5=r("This model is also a "),ba=o("a"),g5=r("tf.keras.Model"),T5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k5=d(),f(Xn.$$.fragment),v5=d(),Ze=o("div"),f(ya.$$.fragment),b5=d(),Tn=o("p"),y5=r("The "),Ar=o("a"),w5=r("TFT5ForConditionalGeneration"),$5=r(" forward method, overrides the "),fl=o("code"),z5=r("__call__"),x5=r(" special method."),E5=d(),f(Qn.$$.fragment),q5=d(),_l=o("p"),j5=r("Examples:"),F5=d(),f(wa.$$.fragment),Lc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f($a.$$.fragment),M5=d(),Tl=o("span"),P5=r("TFT5EncoderModel"),Nc=d(),ce=o("div"),f(za.$$.fragment),C5=d(),kl=o("p"),A5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),L5=d(),xa=o("p"),N5=r("The T5 model was proposed in "),Ea=o("a"),I5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),D5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),S5=d(),qa=o("p"),O5=r("This model inherits from "),Lr=o("a"),G5=r("TFPreTrainedModel"),B5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),U5=d(),ja=o("p"),W5=r("This model is also a "),Fa=o("a"),R5=r("tf.keras.Model"),H5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V5=d(),f(to.$$.fragment),K5=d(),Xe=o("div"),f(Ma.$$.fragment),Y5=d(),vn=o("p"),J5=r("The "),Nr=o("a"),Z5=r("TFT5EncoderModel"),X5=r(" forward method, overrides the "),vl=o("code"),Q5=r("__call__"),ek=r(" special method."),tk=d(),f(no.$$.fragment),nk=d(),bl=o("p"),ok=r("Examples:"),sk=d(),f(Pa.$$.fragment),Ic=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),ak=d(),wl=o("span"),rk=r("FlaxT5Model"),Dc=d(),lt=o("div"),f(Aa.$$.fragment),ik=d(),Qe=o("div"),f(La.$$.fragment),dk=d(),yn=o("p"),lk=r("The "),$l=o("code"),ck=r("FlaxT5PreTrainedModel"),pk=r("forward method, overrides the "),zl=o("code"),hk=r("__call__"),uk=r(" special method."),mk=d(),f(so.$$.fragment),fk=d(),xl=o("p"),_k=r("Example:"),gk=d(),f(Na.$$.fragment),Tk=d(),Mt=o("div"),f(Ia.$$.fragment),kk=d(),El=o("p"),vk=r("Example:"),bk=d(),f(Da.$$.fragment),yk=d(),Pt=o("div"),f(Sa.$$.fragment),wk=d(),ql=o("p"),$k=r("Example:"),zk=d(),f(Oa.$$.fragment),Sc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),xk=d(),Fl=o("span"),Ek=r("FlaxT5ForConditionalGeneration"),Oc=d(),ct=o("div"),f(Ba.$$.fragment),qk=d(),et=o("div"),f(Ua.$$.fragment),jk=d(),$n=o("p"),Fk=r("The "),Ml=o("code"),Mk=r("FlaxT5PreTrainedModel"),Pk=r("forward method, overrides the "),Pl=o("code"),Ck=r("__call__"),Ak=r(" special method."),Lk=d(),f(ro.$$.fragment),Nk=d(),Cl=o("p"),Ik=r("Example:"),Dk=d(),f(Wa.$$.fragment),Sk=d(),Ct=o("div"),f(Ra.$$.fragment),Ok=d(),Al=o("p"),Gk=r("Example:"),Bk=d(),f(Ha.$$.fragment),Uk=d(),At=o("div"),f(Va.$$.fragment),Wk=d(),Ll=o("p"),Rk=r("Example:"),Hk=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Nl=a(w);z=s(Nl,"SPAN",{});var Il=a(z);_($.$$.fragment,Il),Il.forEach(t),Nl.forEach(t),y=l(Ya),E=s(Ya,"SPAN",{});var Dl=a(E);Ee=i(Dl,"T5"),Dl.forEach(t),Ya.forEach(t),oe=l(n),q=s(n,"H2",{class:!0});var Ja=a(q);ee=s(Ja,"A",{id:!0,class:!0,href:!0});var Sl=a(ee);O=s(Sl,"SPAN",{});var Ol=a(O);_(se.$$.fragment,Ol),Ol.forEach(t),Sl.forEach(t),qe=l(Ja),G=s(Ja,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Ja.forEach(t),ve=l(n),B=s(n,"P",{});var Za=a(B);I=i(Za,"The T5 model was presented in "),ae=s(Za,"A",{href:!0,rel:!0});var Bl=a(ae);pe=i(Bl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Bl.forEach(t),F=i(Za,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),Za.forEach(t),C=l(n),he=s(n,"P",{});var Ul=a(he);K=i(Ul,"The abstract from the paper is the following:"),Ul.forEach(t),be=l(n),ue=s(n,"P",{});var Xk=a(ue);U=s(Xk,"EM",{});var Qk=a(U);Fe=i(Qk,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),Qk.forEach(t),Xk.forEach(t),ye=l(n),P=s(n,"P",{});var ev=a(P);Me=i(ev,"Tips:"),ev.forEach(t),H=l(n),V=s(n,"UL",{});var Ir=a(V);me=s(Ir,"LI",{});var tv=a(me);A=s(tv,"P",{});var Dr=a(A);Pe=i(Dr,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),fe=s(Dr,"EM",{});var nv=a(fe);D=i(nv,"translate English to German: \u2026"),nv.forEach(t),Ce=i(Dr,`,
for summarization: `),W=s(Dr,"EM",{});var ov=a(W);Ae=i(ov,"summarize: \u2026"),ov.forEach(t),m=i(Dr,"."),Dr.forEach(t),tv.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var sv=a(te);Oe=s(sv,"P",{});var av=a(Oe);pt=i(av,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),av.forEach(t),sv.forEach(t),S=l(Ir),Ge=s(Ir,"LI",{});var rv=a(Ge);ne=s(rv,"P",{});var io=a(ne);ht=i(io,"See the "),L=s(io,"A",{href:!0});var iv=a(L);Y=i(iv,"training"),iv.forEach(t),ut=i(io,", "),Le=s(io,"A",{href:!0});var dv=a(Le);J=i(dv,"inference"),dv.forEach(t),mt=i(io," and "),Ne=s(io,"A",{href:!0});var lv=a(Ne);Ie=i(lv,"scripts"),lv.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rv.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var cv=a(Xa);Sp=i(cv,"T5 comes in different sizes:"),cv.forEach(t),Kl=l(n),Be=s(n,"UL",{});var Lt=a(Be);di=s(Lt,"LI",{});var pv=a(di);li=s(pv,"P",{});var hv=a(li);To=s(hv,"A",{href:!0,rel:!0});var uv=a(To);Op=i(uv,"t5-small"),uv.forEach(t),hv.forEach(t),pv.forEach(t),Gp=l(Lt),ci=s(Lt,"LI",{});var mv=a(ci);pi=s(mv,"P",{});var fv=a(pi);ko=s(fv,"A",{href:!0,rel:!0});var _v=a(ko);Bp=i(_v,"t5-base"),_v.forEach(t),fv.forEach(t),mv.forEach(t),Up=l(Lt),hi=s(Lt,"LI",{});var gv=a(hi);ui=s(gv,"P",{});var Tv=a(ui);vo=s(Tv,"A",{href:!0,rel:!0});var kv=a(vo);Wp=i(kv,"t5-large"),kv.forEach(t),Tv.forEach(t),gv.forEach(t),Rp=l(Lt),mi=s(Lt,"LI",{});var vv=a(mi);fi=s(vv,"P",{});var bv=a(fi);bo=s(bv,"A",{href:!0,rel:!0});var yv=a(bo);Hp=i(yv,"t5-3b"),yv.forEach(t),bv.forEach(t),vv.forEach(t),Vp=l(Lt),_i=s(Lt,"LI",{});var wv=a(_i);Qa=s(wv,"P",{});var Vk=a(Qa);yo=s(Vk,"A",{href:!0,rel:!0});var $v=a(yo);Kp=i($v,"t5-11b"),$v.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),wv.forEach(t),Lt.forEach(t),Yl=l(n),er=s(n,"P",{});var zv=a(er);Jp=i(zv,"Based on the original T5 model, Google has released some follow-up works:"),zv.forEach(t),Jl=l(n),xt=s(n,"UL",{});var Sr=a(xt);gi=s(Sr,"LI",{});var xv=a(gi);zn=s(xv,"P",{});var Wl=a(zn);Ti=s(Wl,"STRONG",{});var Ev=a(Ti);Zp=i(Ev,"T5v1.1"),Ev.forEach(t),Xp=i(Wl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Wl,"A",{href:!0});var qv=a(tr);Qp=i(qv,"here"),qv.forEach(t),eh=i(Wl,"."),Wl.forEach(t),xv.forEach(t),th=l(Sr),ki=s(Sr,"LI",{});var jv=a(ki);xn=s(jv,"P",{});var Rl=a(xn);vi=s(Rl,"STRONG",{});var Fv=a(vi);nh=i(Fv,"mT5"),Fv.forEach(t),oh=i(Rl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var Mv=a(nr);sh=i(Mv,"here"),Mv.forEach(t),ah=i(Rl,"."),Rl.forEach(t),jv.forEach(t),rh=l(Sr),bi=s(Sr,"LI",{});var Pv=a(bi);En=s(Pv,"P",{});var Hl=a(En);yi=s(Hl,"STRONG",{});var Cv=a(yi);ih=i(Cv,"byT5"),Cv.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Av=a(or);lh=i(Av,"here"),Av.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pv.forEach(t),Sr.forEach(t),Zl=l(n),qn=s(n,"P",{});var Bc=a(qn);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var Lv=a(wo);hh=i(Lv,"hub"),Lv.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),Et=s(n,"P",{});var Or=a(Et);mh=i(Or,"This model was contributed by "),$o=s(Or,"A",{href:!0,rel:!0});var Nv=a($o);fh=i(Nv,"thomwolf"),Nv.forEach(t),_h=i(Or,". The original code can be found "),zo=s(Or,"A",{href:!0,rel:!0});var Iv=a(zo);gh=i(Iv,"here"),Iv.forEach(t),Th=i(Or,"."),Or.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Jt=s(n,"H2",{class:!0});var Uc=a(Jt);jn=s(Uc,"A",{id:!0,class:!0,href:!0});var Dv=a(jn);wi=s(Dv,"SPAN",{});var Sv=a(wi);_(xo.$$.fragment,Sv),Sv.forEach(t),Dv.forEach(t),kh=l(Uc),$i=s(Uc,"SPAN",{});var Ov=a($i);vh=i(Ov,"Training"),Ov.forEach(t),Uc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),zi=s(lo,"CODE",{});var Gv=a(zi);yh=i(Gv,"input_ids"),Gv.forEach(t),wh=i(lo,`. The target sequence is shifted to the right, i.e., prepended by a
start-sequence token and fed to the decoder using the `),xi=s(lo,"CODE",{});var Bv=a(xi);$h=i(Bv,"decoder_input_ids"),Bv.forEach(t),zh=i(lo,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),Ei=s(lo,"CODE",{});var Uv=a(Ei);xh=i(Uv,"labels"),Uv.forEach(t),Eh=i(lo,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),lo.forEach(t),nc=l(n),Fn=s(n,"P",{});var Wc=a(Fn);qh=i(Wc,"One can use "),ar=s(Wc,"A",{href:!0});var Wv=a(ar);jh=i(Wv,"T5ForConditionalGeneration"),Wv.forEach(t),Fh=i(Wc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Wc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Nt=a(dt);qi=s(Nt,"P",{});var Rv=a(qi);Mh=i(Rv,"Unsupervised denoising training"),Rv.forEach(t),Ph=l(Nt),_e=s(Nt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hv=a(ji);Ah=i(Hv,"a.k.a"),Hv.forEach(t),Lh=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var Vv=a(Fi);Nh=i(Vv,"real"),Vv.forEach(t),Ih=i(tt,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Mi=s(tt,"CODE",{});var Kv=a(Mi);Dh=i(Kv,"<extra_id_0>"),Kv.forEach(t),Sh=i(tt,`,
`),Pi=s(tt,"CODE",{});var Yv=a(Pi);Oh=i(Yv,"<extra_id_1>"),Yv.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Jv=a(Ci);Bh=i(Jv,"<extra_id_99>"),Jv.forEach(t),Uh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var Zv=a(rr);Wh=i(Zv,"T5Tokenizer"),Zv.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Nt),Ai=s(Nt,"P",{});var Xv=a(Ai);Vh=i(Xv,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Xv.forEach(t),Kh=l(Nt),_(Eo.$$.fragment,Nt),Yh=l(Nt),qo=s(Nt,"P",{});var Hc=a(qo);Jh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Qv=a(jo);Zh=i(Qv,"run_t5_mlm_flax.py"),Qv.forEach(t),Xh=i(Hc,` script in the Examples
directory.`),Hc.forEach(t),Nt.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Li=s(nt,"P",{});var eb=a(Li);eu=i(eb,"Supervised training"),eb.forEach(t),tu=l(nt),Ni=s(nt,"P",{});var tb=a(Ni);nu=i(tb,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
...
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
during T5\u2019s pre-training.`),we.forEach(t),vu=l(nt),Zt=s(nt,"P",{});var Gr=a(Zt);bu=i(Gr,`However, the example above only shows a single training example. In practice, one trains deep learning models in
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
...
of the `),Ki=s(ot,"CODE",{});var ub=a(Ki);Pu=i(ub,"CrossEntropyLoss"),ub.forEach(t),Cu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var mb=a(Yi);Au=i(mb,"decoder_attention_mask"),mb.forEach(t),Lu=i(ot,` to ignore padded tokens from
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var fb=a(Mo);Nu=i(fb,"Flax summarization script"),fb.forEach(t),Iu=i(ot,` for details). We also pass
`),Ji=s(ot,"CODE",{});var _b=a(Ji);Du=i(_b,"attention_mask"),_b.forEach(t),Su=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Ou=l(nt),_(Po.$$.fragment,nt),nt.forEach(t),Rc.forEach(t),sc=l(n),ir=s(n,"P",{});var gb=a(ir);Gu=i(gb,"Additional training tips:"),gb.forEach(t),ac=l(n),qt=s(n,"UL",{});var Br=a(qt);Zi=s(Br,"LI",{});var Tb=a(Zi);Co=s(Tb,"P",{});var Vc=a(Co);Bu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var kb=a(Xi);Uu=i(kb,"Trainer"),kb.forEach(t),Wu=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
...
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Lo=s(Ur,"A",{href:!0,rel:!0});var yb=a(Lo);Yu=i(yb,"paper"),yb.forEach(t),Ju=i(Ur,` for the task prefixes
used).`),Ur.forEach(t),vb.forEach(t),Zu=l(Br),ed=s(Br,"LI",{});var wb=a(ed);No=s(wb,"P",{});var Kc=a(No);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
`),cr=s(It,"A",{href:!0});var Cb=a(cr);fm=i(Cb,"generate()"),Cb.forEach(t),_m=i(It,", make sure you start it with the "),rd=s(It,"CODE",{});var Ab=a(rd);gm=i(Ab,"pad_token_id"),Ab.forEach(t),Tm=i(It,"."),It.forEach(t),pc=l(n),pr=s(n,"P",{});var Lb=a(pr);km=i(Lb,"The example above only shows a single example. You can also do batched inference, like so:"),Lb.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Jc=a(en);Cn=s(Jc,"A",{id:!0,class:!0,href:!0});var Nb=a(Cn);id=s(Nb,"SPAN",{});var Ib=a(id);_(Bo.$$.fragment,Ib),Ib.forEach(t),Nb.forEach(t),vm=l(Jc),dd=s(Jc,"SPAN",{});var Db=a(dd);bm=i(Db,"Performance"),Db.forEach(t),Jc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Uo=s(po,"A",{href:!0,rel:!0});var Sb=a(Uo);wm=i(Sb,"apex"),Sb.forEach(t),$m=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var Ob=a(ld);zm=i(Ob,"apex.normalization.FusedRMSNorm"),Ob.forEach(t),xm=i(po," instead of "),cd=s(po,"CODE",{});var Gb=a(cd);Em=i(Gb,"T5LayerNorm"),Gb.forEach(t),qm=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Zc=a(tn);An=s(Zc,"A",{id:!0,class:!0,href:!0});var Bb=a(An);pd=s(Bb,"SPAN",{});var Ub=a(pd);_(Wo.$$.fragment,Ub),Ub.forEach(t),Bb.forEach(t),jm=l(Zc),hd=s(Zc,"SPAN",{});var Wb=a(hd);Fm=i(Wb,"Example scripts"),Wb.forEach(t),Zc.forEach(t),gc=l(n),ur=s(n,"P",{});var Rb=a(ur);Mm=i(Rb,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rb.forEach(t),Tc=l(n),Ln=s(n,"UL",{});var Xc=a(Ln);ud=s(Xc,"LI",{});var Hb=a(ud);nn=s(Hb,"P",{});var Wr=a(nn);Pm=i(Wr,"pre-training: the "),Ro=s(Wr,"A",{href:!0,rel:!0});var Vb=a(Ro);Cm=i(Vb,"run_t5_mlm_flax.py"),Vb.forEach(t),Am=i(Wr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Wr,"A",{href:!0,rel:!0});var Kb=a(Ho);Lm=i(Kb,"t5_tokenizer_model.py"),Kb.forEach(t),Nm=i(Wr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Wr.forEach(t),Hb.forEach(t),Im=l(Xc),md=s(Xc,"LI",{});var Yb=a(md);De=s(Yb,"P",{});var yt=a(De);Dm=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Jb=a(Vo);Sm=i(Jb,"PyTorch"),Jb.forEach(t),Om=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var Zb=a(Ko);Gm=i(Zb,"Tensorflow"),Zb.forEach(t),Bm=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var Xb=a(Yo);Um=i(Xb,"Flax"),Xb.forEach(t),Wm=i(yt,`) and translation scripts
(`),Jo=s(yt,"A",{href:!0,rel:!0});var Qb=a(Jo);Rm=i(Qb,"PyTorch"),Qb.forEach(t),Hm=i(yt," and "),Zo=s(yt,"A",{href:!0,rel:!0});var e1=a(Zo);Vm=i(e1,"Tensorflow"),e1.forEach(t),Km=i(yt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),yt.forEach(t),Yb.forEach(t),Xc.forEach(t),kc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);Nn=s(Qc,"A",{id:!0,class:!0,href:!0});var t1=a(Nn);fd=s(t1,"SPAN",{});var n1=a(fd);_(Xo.$$.fragment,n1),n1.forEach(t),t1.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var o1=a(_d);Jm=i(o1,"T5Config"),o1.forEach(t),Qc.forEach(t),vc=l(n),wt=s(n,"DIV",{class:!0});var Rr=a(wt);_(Qo.$$.fragment,Rr),Zm=l(Rr),$t=s(Rr,"P",{});var ho=a($t);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var s1=a(mr);Qm=i(s1,"T5Model"),s1.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var a1=a(fr);tf=i(a1,"TFT5Model"),a1.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
this superclass for more information regarding those methods.`),np.forEach(t),yf=l(st),jt=s(st,"DIV",{class:!0});var Vr=a(jt);_(rs.$$.fragment,Vr),wf=l(Vr),kd=s(Vr,"P",{});var m1=a(kd);$f=i(m1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),m1.forEach(t),zf=l(Vr),is=s(Vr,"UL",{});var op=a(is);kr=s(op,"LI",{});var Kk=a(kr);xf=i(Kk,"single sequence: "),vd=s(Kk,"CODE",{});var f1=a(vd);Ef=i(f1,"X </s>"),f1.forEach(t),Kk.forEach(t),qf=l(op),vr=s(op,"LI",{});var Yk=a(vr);jf=i(Yk,"pair of sequences: "),bd=s(Yk,"CODE",{});var _1=a(bd);Ff=i(_1,"A </s> B </s>"),_1.forEach(t),Yk.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),Dn=s(st,"DIV",{class:!0});var sp=a(Dn);_(ds.$$.fragment,sp),Pf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Cf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var g1=a(yd);Af=i(g1,"prepare_for_model"),g1.forEach(t),Lf=i(ap," method."),ap.forEach(t),sp.forEach(t),Nf=l(st),Sn=s(st,"DIV",{class:!0});var rp=a(Sn);_(cs.$$.fragment,rp),If=l(rp),wd=s(rp,"P",{});var T1=a(wd);Df=i(T1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T1.forEach(t),rp.forEach(t),Sf=l(st),br=s(st,"DIV",{class:!0});var k1=a(br);_(ps.$$.fragment,k1),k1.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);On=s(ip,"A",{id:!0,class:!0,href:!0});var v1=a(On);$d=s(v1,"SPAN",{});var b1=a($d);_(hs.$$.fragment,b1),b1.forEach(t),v1.forEach(t),Of=l(ip),zd=s(ip,"SPAN",{});var y1=a(zd);Gf=i(y1,"T5TokenizerFast"),y1.forEach(t),ip.forEach(t),$c=l(n),Se=s(n,"DIV",{class:!0});var Dt=a(Se);_(us.$$.fragment,Dt),Bf=l(Dt),dn=s(Dt,"P",{});var Kr=a(dn);Uf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),xd=s(Kr,"EM",{});var w1=a(xd);Wf=i(w1,"tokenizers"),w1.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var $1=a(ms);Hf=i($1,"Unigram"),$1.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Dt),fs=s(Dt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),yr=s(dp,"A",{href:!0});var z1=a(yr);Jf=i(z1,"PreTrainedTokenizerFast"),z1.forEach(t),Zf=i(dp,` which contains most of the main methods. Users should
...
adding special tokens. A sequence has the following format:`),x1.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);wr=s(lp,"LI",{});var Jk=a(wr);n_=i(Jk,"single sequence: "),qd=s(Jk,"CODE",{});var E1=a(qd);o_=i(E1,"X </s>"),E1.forEach(t),Jk.forEach(t),s_=l(lp),$r=s(lp,"LI",{});var Zk=a($r);a_=i(Zk,"pair of sequences: "),jd=s(Zk,"CODE",{});var q1=a(jd);r_=i(q1,"A </s> B </s>"),q1.forEach(t),Zk.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(Dt),Gn=s(Dt,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var j1=a(Fd);l_=i(j1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j1.forEach(t),cp.forEach(t),Dt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var F1=a(Bn);Md=s(F1,"SPAN",{});var M1=a(Md);_(ks.$$.fragment,M1),M1.forEach(t),F1.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var P1=a(Pd);p_=i(P1,"T5Model"),P1.forEach(t),pp.forEach(t),xc=l(n),Z=s(n,"DIV",{class:!0});var $e=a(Z);_(vs.$$.fragment,$e),h_=l($e),Cd=s($e,"P",{});var C1=a(Cd);u_=i(C1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),C1.forEach(t),m_=l($e),bs=s($e,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var A1=a(ys);__=i(A1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),A1.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l($e),ws=s($e,"P",{});var up=a(ws);k_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var L1=a(zr);v_=i(L1,"PreTrainedModel"),L1.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),y_=l($e),$s=s($e,"P",{});var mp=a($s);w_=i(mp,"This model is also a PyTorch "),zs=s(mp,"A",{href:!0,rel:!0});var N1=a(zs);$_=i(N1,"torch.nn.Module"),N1.forEach(t),z_=i(mp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),x_=l($e),We=s($e,"DIV",{class:!0});var St=a(We);_(xs.$$.fragment,St),E_=l(St),cn=s(St,"P",{});var Jr=a(cn);q_=i(Jr,"The "),xr=s(Jr,"A",{href:!0});var I1=a(xr);j_=i(I1,"T5Model"),I1.forEach(t),F_=i(Jr," forward method, overrides the "),Ad=s(Jr,"CODE",{});var D1=a(Ad);M_=i(D1,"__call__"),D1.forEach(t),P_=i(Jr," special method."),Jr.forEach(t),C_=l(St),_(Un.$$.fragment,St),A_=l(St),Ld=s(St,"P",{});var S1=a(Ld);L_=i(S1,"Example:"),S1.forEach(t),N_=l(St),_(Es.$$.fragment,St),St.forEach(t),I_=l($e),Re=s($e,"DIV",{class:!0});var Ot=a(Re);_(qs.$$.fragment,Ot),D_=l(Ot),Nd=s(Ot,"P",{});var O1=a(Nd);S_=i(O1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),O1.forEach(t),O_=l(Ot),Id=s(Ot,"P",{});var G1=a(Id);G_=i(G1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G1.forEach(t),B_=l(Ot),Dd=s(Ot,"P",{});var B1=a(Dd);U_=i(B1,"Example:"),B1.forEach(t),W_=l(Ot),_(js.$$.fragment,Ot),Ot.forEach(t),R_=l($e),kt=s($e,"DIV",{class:!0});var uo=a(kt);_(Fs.$$.fragment,uo),H_=l(uo),Sd=s(uo,"P",{});var U1=a(Sd);V_=i(U1,"Moves the model to cpu from a model parallel state."),U1.forEach(t),K_=l(uo),Od=s(uo,"P",{});var W1=a(Od);Y_=i(W1,"Example:"),W1.forEach(t),J_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),$e.forEach(t),Ec=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Wn=s(fp,"A",{id:!0,class:!0,href:!0});var R1=a(Wn);Gd=s(R1,"SPAN",{});var H1=a(Gd);_(Ps.$$.fragment,H1),H1.forEach(t),R1.forEach(t),Z_=l(fp),Bd=s(fp,"SPAN",{});var V1=a(Bd);X_=i(V1,"T5ForConditionalGeneration"),V1.forEach(t),fp.forEach(t),qc=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),As=s(ze,"P",{});var _p=a(As);eg=i(_p,"T5 Model with a "),Ud=s(_p,"CODE",{});var K1=a(Ud);tg=i(K1,"language modeling"),K1.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),Ls=s(ze,"P",{});var gp=a(Ls);sg=i(gp,"The T5 model was proposed in "),Ns=s(gp,"A",{href:!0,rel:!0});var Y1=a(Ns);ag=i(Y1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Y1.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Is=s(ze,"P",{});var Tp=a(Is);dg=i(Tp,"This model inherits from "),Er=s(Tp,"A",{href:!0});var J1=a(Er);lg=i(J1,"PreTrainedModel"),J1.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ds=s(ze,"P",{});var kp=a(Ds);hg=i(kp,"This model is also a PyTorch "),Ss=s(kp,"A",{href:!0,rel:!0});var Z1=a(Ss);ug=i(Z1,"torch.nn.Module"),Z1.forEach(t),mg=i(kp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kp.forEach(t),fg=l(ze),He=s(ze,"DIV",{class:!0});var Gt=a(He);_(Os.$$.fragment,Gt),_g=l(Gt),hn=s(Gt,"P",{});var Zr=a(hn);gg=i(Zr,"The "),qr=s(Zr,"A",{href:!0});var X1=a(qr);Tg=i(X1,"T5ForConditionalGeneration"),X1.forEach(t),kg=i(Zr," forward method, overrides the "),Wd=s(Zr,"CODE",{});var Q1=a(Wd);vg=i(Q1,"__call__"),Q1.forEach(t),bg=i(Zr," special method."),Zr.forEach(t),yg=l(Gt),_(Rn.$$.fragment,Gt),wg=l(Gt),Rd=s(Gt,"P",{});var ey=a(Rd);$g=i(ey,"Examples:"),ey.forEach(t),zg=l(Gt),_(Gs.$$.fragment,Gt),Gt.forEach(t),xg=l(ze),Ve=s(ze,"DIV",{class:!0});var Bt=a(Ve);_(Bs.$$.fragment,Bt),Eg=l(Bt),Hd=s(Bt,"P",{});var ty=a(Hd);qg=i(ty,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),ty.forEach(t),jg=l(Bt),Vd=s(Bt,"P",{});var ny=a(Vd);Fg=i(ny,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),ny.forEach(t),Mg=l(Bt),Kd=s(Bt,"P",{});var oy=a(Kd);Pg=i(oy,"Example:"),oy.forEach(t),Cg=l(Bt),_(Us.$$.fragment,Bt),Bt.forEach(t),Ag=l(ze),vt=s(ze,"DIV",{class:!0});var mo=a(vt);_(Ws.$$.fragment,mo),Lg=l(mo),Yd=s(mo,"P",{});var sy=a(Yd);Ng=i(sy,"Moves the model to cpu from a model parallel state."),sy.forEach(t),Ig=l(mo),Jd=s(mo,"P",{});var ay=a(Jd);Dg=i(ay,"Example:"),ay.forEach(t),Sg=l(mo),_(Rs.$$.fragment,mo),mo.forEach(t),ze.forEach(t),jc=l(n),un=s(n,"H2",{class:!0});var vp=a(un);Hn=s(vp,"A",{id:!0,class:!0,href:!0});var ry=a(Hn);Zd=s(ry,"SPAN",{});var iy=a(Zd);_(Hs.$$.fragment,iy),iy.forEach(t),ry.forEach(t),Og=l(vp),Xd=s(vp,"SPAN",{});var dy=a(Xd);Gg=i(dy,"T5EncoderModel"),dy.forEach(t),vp.forEach(t),Fc=l(n),Q=s(n,"DIV",{class:!0});var xe=a(Q);_(Vs.$$.fragment,xe),Bg=l(xe),Qd=s(xe,"P",{});var ly=a(Qd);Ug=i(ly,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),ly.forEach(t),Wg=l(xe),Ks=s(xe,"P",{});var bp=a(Ks);Rg=i(bp,"The T5 model was proposed in "),Ys=s(bp,"A",{href:!0,rel:!0});var cy=a(Ys);Hg=i(cy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),cy.forEach(t),Vg=i(bp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),bp.forEach(t),Kg=l(xe),Js=s(xe,"P",{});var yp=a(Js);Yg=i(yp,"This model inherits from "),jr=s(yp,"A",{href:!0});var py=a(jr);Jg=i(py,"PreTrainedModel"),py.forEach(t),Zg=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),Xg=l(xe),Zs=s(xe,"P",{});var wp=a(Zs);Qg=i(wp,"This model is also a PyTorch "),Xs=s(wp,"A",{href:!0,rel:!0});var hy=a(Xs);eT=i(hy,"torch.nn.Module"),hy.forEach(t),tT=i(wp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),zp.forEach(t),LT=l(at),la=s(at,"P",{});var xp=a(la);NT=i(xp,"This model inherits from "),Mr=s(xp,"A",{href:!0});var xy=a(Mr);IT=i(xy,"TFPreTrainedModel"),xy.forEach(t),DT=i(xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ep.forEach(t),UT=l(at),_(Yn.$$.fragment,at),WT=l(at),Je=s(at,"DIV",{class:!0});var Rt=a(Je);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var qy=a(Pr);VT=i(qy,"TFT5Model"),qy.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var jy=a(cl);YT=i(jy,"__call__"),jy.forEach(t),JT=i(Qr," special method."),Qr.forEach(t),ZT=l(Rt),_(Jn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var Fy=a(pl);QT=i(Fy,"Examples:"),Fy.forEach(t),e5=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var qp=a(gn);Zn=s(qp,"A",{id:!0,class:!0,href:!0});var My=a(Zn);hl=s(My,"SPAN",{});var Py=a(hl);_(ma.$$.fragment,Py),Py.forEach(t),My.forEach(t),t5=l(qp),ul=s(qp,"SPAN",{});var Cy=a(ul);n5=i(Cy,"TFT5ForConditionalGeneration"),Cy.forEach(t),qp.forEach(t),Ac=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),o5=l(rt),_a=s(rt,"P",{});var jp=a(_a);s5=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var Ay=a(ml);a5=i(Ay,"language modeling"),Ay.forEach(t),r5=i(jp," head on top."),jp.forEach(t),i5=l(rt),ga=s(rt,"P",{});var Fp=a(ga);d5=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var Ly=a(Ta);l5=i(Ly,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ly.forEach(t),c5=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),p5=l(rt),ka=s(rt,"P",{});var Mp=a(ka);h5=i(Mp,"This model inherits from "),Cr=s(Mp,"A",{href:!0});var Ny=a(Cr);u5=i(Ny,"TFPreTrainedModel"),Ny.forEach(t),m5=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),f5=l(rt),va=s(rt,"P",{});var Pp=a(va);_5=i(Pp,"This model is also a "),ba=s(Pp,"A",{href:!0,rel:!0});var Iy=a(ba);g5=i(Iy,"tf.keras.Model"),Iy.forEach(t),T5=i(Pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),k5=l(rt),_(Xn.$$.fragment,rt),v5=l(rt),Ze=s(rt,"DIV",{class:!0});var Ht=a(Ze);_(ya.$$.fragment,Ht),b5=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);y5=i(ei,"The "),Ar=s(ei,"A",{href:!0});var Dy=a(Ar);w5=i(Dy,"TFT5ForConditionalGeneration"),Dy.forEach(t),$5=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var Sy=a(fl);z5=i(Sy,"__call__"),Sy.forEach(t),x5=i(ei," special method."),ei.forEach(t),E5=l(Ht),_(Qn.$$.fragment,Ht),q5=l(Ht),_l=s(Ht,"P",{});var Oy=a(_l);j5=i(Oy,"Examples:"),Oy.forEach(t),F5=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Lc=l(n),kn=s(n,"H2",{class:!0});var Cp=a(kn);eo=s(Cp,"A",{id:!0,class:!0,href:!0});var Gy=a(eo);gl=s(Gy,"SPAN",{});var By=a(gl);_($a.$$.fragment,By),By.forEach(t),Gy.forEach(t),M5=l(Cp),Tl=s(Cp,"SPAN",{});var Uy=a(Tl);P5=i(Uy,"TFT5EncoderModel"),Uy.forEach(t),Cp.forEach(t),Nc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),C5=l(it),kl=s(it,"P",{});var Wy=a(kl);A5=i(Wy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Wy.forEach(t),L5=l(it),xa=s(it,"P",{});var Ap=a(xa);N5=i(Ap,"The T5 model was proposed in "),Ea=s(Ap,"A",{href:!0,rel:!0});var Ry=a(Ea);I5=i(Ry,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ry.forEach(t),D5=i(Ap,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Ap.forEach(t),S5=l(it),qa=s(it,"P",{});var Lp=a(qa);O5=i(Lp,"This model inherits from "),Lr=s(Lp,"A",{href:!0});var Hy=a(Lr);G5=i(Hy,"TFPreTrainedModel"),Hy.forEach(t),B5=i(Lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lp.forEach(t),U5=l(it),ja=s(it,"P",{});var Np=a(ja);W5=i(Np,"This model is also a "),Fa=s(Np,"A",{href:!0,rel:!0});var Vy=a(Fa);R5=i(Vy,"tf.keras.Model"),Vy.forEach(t),H5=i(Np,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Np.forEach(t),V5=l(it),_(to.$$.fragment,it),K5=l(it),Xe=s(it,"DIV",{class:!0});var Vt=a(Xe);_(Ma.$$.fragment,Vt),Y5=l(Vt),vn=s(Vt,"P",{});var ti=a(vn);J5=i(ti,"The "),Nr=s(ti,"A",{href:!0});var Ky=a(Nr);Z5=i(Ky,"TFT5EncoderModel"),Ky.forEach(t),X5=i(ti," forward method, overrides the "),vl=s(ti,"CODE",{});var Yy=a(vl);Q5=i(Yy,"__call__"),Yy.forEach(t),ek=i(ti," special method."),ti.forEach(t),tk=l(Vt),_(no.$$.fragment,Vt),nk=l(Vt),bl=s(Vt,"P",{});var Jy=a(bl);ok=i(Jy,"Examples:"),Jy.forEach(t),sk=l(Vt),_(Pa.$$.fragment,Vt),Vt.forEach(t),it.forEach(t),Ic=l(n),bn=s(n,"H2",{class:!0});var Ip=a(bn);oo=s(Ip,"A",{id:!0,class:!0,href:!0});var Zy=a(oo);yl=s(Zy,"SPAN",{});var Xy=a(yl);_(Ca.$$.fragment,Xy),Xy.forEach(t),Zy.forEach(t),ak=l(Ip),wl=s(Ip,"SPAN",{});var Qy=a(wl);rk=i(Qy,"FlaxT5Model"),Qy.forEach(t),Ip.forEach(t),Dc=l(n),lt=s(n,"DIV",{class:!0});var _o=a(lt);_(Aa.$$.fragment,_o),ik=l(_o),Qe=s(_o,"DIV",{class:!0});var Kt=a(Qe);_(La.$$.fragment,Kt),dk=l(Kt),yn=s(Kt,"P",{});var ni=a(yn);lk=i(ni,"The "),$l=s(ni,"CODE",{});var ew=a($l);ck=i(ew,"FlaxT5PreTrainedModel"),ew.forEach(t),pk=i(ni,"forward method, overrides the "),zl=s(ni,"CODE",{});var tw=a(zl);hk=i(tw,"__call__"),tw.forEach(t),uk=i(ni," special method."),ni.forEach(t),mk=l(Kt),_(so.$$.fragment,Kt),fk=l(Kt),xl=s(Kt,"P",{});var nw=a(xl);_k=i(nw,"Example:"),nw.forEach(t),gk=l(Kt),_(Na.$$.fragment,Kt),Kt.forEach(t),Tk=l(_o),Mt=s(_o,"DIV",{class:!0});var oi=a(Mt);_(Ia.$$.fragment,oi),kk=l(oi),El=s(oi,"P",{});var ow=a(El);vk=i(ow,"Example:"),ow.forEach(t),bk=l(oi),_(Da.$$.fragment,oi),oi.forEach(t),yk=l(_o),Pt=s(_o,"DIV",{class:!0});var si=a(Pt);_(Sa.$$.fragment,si),wk=l(si),ql=s(si,"P",{});var sw=a(ql);$k=i(sw,"Example:"),sw.forEach(t),zk=l(si),_(Oa.$$.fragment,si),si.forEach(t),_o.forEach(t),Sc=l(n),wn=s(n,"H2",{class:!0});var Dp=a(wn);ao=s(Dp,"A",{id:!0,class:!0,href:!0});var aw=a(ao);jl=s(aw,"SPAN",{});var rw=a(jl);_(Ga.$$.fragment,rw),rw.forEach(t),aw.forEach(t),xk=l(Dp),Fl=s(Dp,"SPAN",{});var iw=a(Fl);Ek=i(iw,"FlaxT5ForConditionalGeneration"),iw.forEach(t),Dp.forEach(t),Oc=l(n),ct=s(n,"DIV",{class:!0});var go=a(ct);_(Ba.$$.fragment,go),qk=l(go),et=s(go,"DIV",{class:!0});var Yt=a(et);_(Ua.$$.fragment,Yt),jk=l(Yt),$n=s(Yt,"P",{});var ai=a($n);Fk=i(ai,"The "),Ml=s(ai,"CODE",{});var dw=a(Ml);Mk=i(dw,"FlaxT5PreTrainedModel"),dw.forEach(t),Pk=i(ai,"forward method, overrides the "),Pl=s(ai,"CODE",{});var lw=a(Pl);Ck=i(lw,"__call__"),lw.forEach(t),Ak=i(ai," special method."),ai.forEach(t),Lk=l(Yt),_(ro.$$.fragment,Yt),Nk=l(Yt),Cl=s(Yt,"P",{});var cw=a(Cl);Ik=i(cw,"Example:"),cw.forEach(t),Dk=l(Yt),_(Wa.$$.fragment,Yt),Yt.forEach(t),Sk=l(go),Ct=s(go,"DIV",{class:!0});var ri=a(Ct);_(Ra.$$.fragment,ri),Ok=l(ri),Al=s(ri,"P",{});var pw=a(Al);Gk=i(pw,"Example:"),pw.forEach(t),Bk=l(ri),_(Ha.$$.fragment,ri),ri.forEach(t),Uk=l(go),At=s(go,"DIV",{class:!0});var ii=a(At);_(Va.$$.fragment,ii),Wk=l(ii),Ll=s(ii,"P",{});var hw=a(Ll);Rk=i(hw,"Example:"),hw.forEach(t),Hk=l(ii),_(Ka.$$.fragment,ii),ii.forEach(t),go.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(jw)),c(w,"id","t5"),c(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(w,"href","#t5"),c(b,"class","relative group"),c(ee,"id","overview"),c(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ee,"href","#overview"),c(q,"class","relative group"),c(ae,"href","https://arxiv.org/pdf/1910.10683.pdf"),c(ae,"rel","nofollow"),c(L,"href","#training"),c(Le,"href","#inference"),c(Ne,"href","#scripts"),c(To,"href","https://huggingface.co/t5-small"),c(To,"rel","nofollow"),c(ko,"href","https://huggingface.co/t5-base"),c(ko,"rel","nofollow"),c(vo,"href","https://huggingface.co/t5-large"),c(vo,"rel","nofollow"),c(bo,"href","https://huggingface.co/t5-3b"),c(bo,"rel","nofollow"),c(yo,"href","https://huggingface.co/t5-11b"),c(yo,"rel","nofollow"),c(tr,"href","t5v1.1"),c(nr,"href","mt5"),c(or,"href","byt5"),c(wo,"href","https://huggingface.co/models?search=t5"),c(wo,"rel","nofollow"),c($o,"href","https://huggingface.co/thomwolf"),c($o,"rel","nofollow"),c(zo,"href","https://github.com/google-research/text-to-text-transfer-transformer"),c(zo,"rel","nofollow"),c(sr,"id","training"),c(jn,"id","training"),c(jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jn,"href","#training"),c(Jt,"class","relative group"),c(ar,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.T5ForConditionalGeneration"),c(rr,"href","/docs/transformers/pr_15750/en/model_doc/mt5#transformers.T5Tokenizer"),c(jo,"href","https://github.com/huggingface/transformers/tree/master/examples/flax/language-modeling"),c(jo,"rel","nofollow"),c(Mo,"href","https://github.com/huggingface/transformers/tree/master/examples/flax/summarization"),c(Mo,"rel","nofollow"),c(Ao,"href","https://discuss.huggingface.co/t/t5-finetuning-tips/684"),c(Ao,"rel","nofollow"),c(Lo,"href","https://arxiv.org/pdf/1910.10683.pdf"),c(Lo,"rel","nofollow"),c(dr,"id","inference"),c(Pn,"id","inference"),c(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pn,"href","#inference"),c(Qt,"class","relative group"),c(lr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate"),c(Do,"href","https://huggingface.co/blog/how-to-generate"),c(Do,"rel","nofollow"),c(So,"href","https://huggingface.co/blog/encoder-decoder#encoder-decoder"),c(So,"rel","nofollow"),c(cr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate"),c(hr,"id","scripts"),c(Cn,"id","performance"),c(Cn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Cn,"href","#performance"),c(en,"class","relative group"),c(Uo,"href","https://github.com/NVIDIA/apex#quick-start"),c(Uo,"rel","nofollow"),c(An,"id","example-scripts"),c(An,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(An,"href","#example-scripts"),c(tn,"class","relative group"),c(Ro,"href","https://github.com/huggingface/transformers/blob/master/examples/flax/language-modeling/run_t5_mlm_flax.py"),c(Ro,"rel","nofollow"),c(Ho,"href","https://github.com/huggingface/transformers/blob/master/examples/flax/language-modeling/t5_tokenizer_model.py"),c(Ho,"rel","nofollow"),c(Vo,"href","https://github.com/huggingface/transformers/tree/master/examples/pytorch/summarization"),c(Vo,"rel","nofollow"),c(Ko,"href","https://github.com/huggingface/transformers/tree/master/examples/tensorflow/summarization"),c(Ko,"rel","nofollow"),c(Yo,"href","https://github.com/huggingface/transformers/tree/master/examples/flax/summarization"),c(Yo,"rel","nofollow"),c(Jo,"href","https://github.com/huggingface/transformers/tree/master/examples/pytorch/translation"),c(Jo,"rel","nofollow"),c(Zo,"href","https://github.com/huggingface/transformers/tree/master/examples/tensorflow/translation"),c(Zo,"rel","nofollow"),c(Nn,"id","transformers.T5Config"),c(Nn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nn,"href","#transformers.T5Config"),c(on,"class","relative group"),c(mr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.T5Model"),c(fr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.TFT5Model"),c(es,"href","https://huggingface.co/t5-small"),c(es,"rel","nofollow"),c(_r,"href","/docs/transformers/pr_15750/en/main_classes/configuration#transformers.PretrainedConfig"),c(gr,"href","/docs/transformers/pr_15750/en/main_classes/configuration#transformers.PretrainedConfig"),c(wt,"class","docstring"),c(In,"id","transformers.T5Tokenizer"),c(In,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(In,"href","#transformers.T5Tokenizer"),c(an,"class","relative group"),c(ss,"href","https://github.com/google/sentencepiece"),c(ss,"rel","nofollow"),c(Tr,"href","/docs/transformers/pr_15750/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(jt,"class","docstring"),c(Dn,"class","docstring"),c(Sn,"class","docstring"),c(br,"class","docstring"),c(ie,"class","docstring"),c(On,"id","transformers.T5TokenizerFast"),c(On,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(On,"href","#transformers.T5TokenizerFast"),c(rn,"class","relative group"),c(ms,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),c(ms,"rel","nofollow"),c(yr,"href","/docs/transformers/pr_15750/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),c(Ft,"class","docstring"),c(Gn,"class","docstring"),c(Se,"class","docstring"),c(Bn,"id","transformers.T5Model"),c(Bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bn,"href","#transformers.T5Model"),c(ln,"class","relative group"),c(ys,"href","https://arxiv.org/abs/1910.10683"),c(ys,"rel","nofollow"),c(zr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel"),c(zs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(zs,"rel","nofollow"),c(xr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.T5Model"),c(We,"class","docstring"),c(Re,"class","docstring"),c(kt,"class","docstring"),c(Z,"class","docstring"),c(Wn,"id","transformers.T5ForConditionalGeneration"),c(Wn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wn,"href","#transformers.T5ForConditionalGeneration"),c(pn,"class","relative group"),c(Ns,"href","https://arxiv.org/abs/1910.10683"),c(Ns,"rel","nofollow"),c(Er,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel"),c(Ss,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ss,"rel","nofollow"),c(qr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.T5ForConditionalGeneration"),c(He,"class","docstring"),c(Ve,"class","docstring"),c(vt,"class","docstring"),c(X,"class","docstring"),c(Hn,"id","transformers.T5EncoderModel"),c(Hn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Hn,"href","#transformers.T5EncoderModel"),c(un,"class","relative group"),c(Ys,"href","https://arxiv.org/abs/1910.10683"),c(Ys,"rel","nofollow"),c(jr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.PreTrainedModel"),c(Xs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Xs,"rel","nofollow"),c(Fr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.T5EncoderModel"),c(Ke,"class","docstring"),c(Ye,"class","docstring"),c(bt,"class","docstring"),c(Q,"class","docstring"),c(Kn,"id","transformers.TFT5Model"),c(Kn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kn,"href","#transformers.TFT5Model"),c(fn,"class","relative group"),c(da,"href","https://arxiv.org/abs/1910.10683"),c(da,"rel","nofollow"),c(Mr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.TFPreTrainedModel"),c(pa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(pa,"rel","nofollow"),c(Pr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.TFT5Model"),c(Je,"class","docstring"),c(de,"class","docstring"),c(Zn,"id","transformers.TFT5ForConditionalGeneration"),c(Zn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zn,"href","#transformers.TFT5ForConditionalGeneration"),c(gn,"class","relative group"),c(Ta,"href","https://arxiv.org/abs/1910.10683"),c(Ta,"rel","nofollow"),c(Cr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.TFPreTrainedModel"),c(ba,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(ba,"rel","nofollow"),c(Ar,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.TFT5ForConditionalGeneration"),c(Ze,"class","docstring"),c(le,"class","docstring"),c(eo,"id","transformers.TFT5EncoderModel"),c(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(eo,"href","#transformers.TFT5EncoderModel"),c(kn,"class","relative group"),c(Ea,"href","https://arxiv.org/abs/1910.10683"),c(Ea,"rel","nofollow"),c(Lr,"href","/docs/transformers/pr_15750/en/main_classes/model#transformers.TFPreTrainedModel"),c(Fa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Fa,"rel","nofollow"),c(Nr,"href","/docs/transformers/pr_15750/en/model_doc/t5#transformers.TFT5EncoderModel"),c(Xe,"class","docstring"),c(ce,"class","docstring"),c(oo,"id","transformers.FlaxT5Model"),c(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(oo,"href","#transformers.FlaxT5Model"),c(bn,"class","relative group"),c(Qe,"class","docstring"),c(Mt,"class","docstring"),c(Pt,"class","docstring"),c(lt,"class","docstring"),c(ao,"id","transformers.FlaxT5ForConditionalGeneration"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.FlaxT5ForConditionalGeneration"),c(wn,"class","relative group"),c(et,"class","docstring"),c(Ct,"class","docstring"),c(At,"class","docstring"),c(ct,"class","docstring")},m(n,h){e(document.head,u),p(n,x,h),p(n,b,h),e(b,w),e(w,z),g($,z,null),e(b,y),e(b,E),e(E,Ee),p(n,oe,h),p(n,q,h),e(q,ee),e(ee,O),g(se,O,null),e(q,qe),e(q,G),e(G,je),p(n,ve,h),p(n,B,h),e(B,I),e(B,ae),e(ae,pe),e(B,F),p(n,C,h),p(n,he,h),e(he,K),p(n,be,h),p(n,ue,h),e(ue,U),e(U,Fe),p(n,ye,h),p(n,P,h),e(P,Me),p(n,H,h),p(n,V,h),e(V,me),e(me,A),e(A,Pe),e(A,fe),e(fe,D),e(A,Ce),e(A,W),e(W,Ae),e(A,m),e(V,j),e(V,te),e(te,Oe),e(Oe,pt),e(V,S),e(V,Ge),e(Ge,ne),e(ne,ht),e(ne,L),e(L,Y),e(ne,ut),e(ne,Le),e(Le,J),e(ne,mt),e(ne,Ne),e(Ne,Ie),e(ne,ft),p(n,Vl,h),p(n,Xa,h),e(Xa,Sp),p(n,Kl,h),p(n,Be,h),e(Be,di),e(di,li),e(li,To),e(To,Op),e(Be,Gp),e(Be,ci),e(ci,pi),e(pi,ko),e(ko,Bp),e(Be,Up),e(Be,hi),e(hi,ui),e(ui,vo),e(vo,Wp),e(Be,Rp),e(Be,mi),e(mi,fi),e(fi,bo),e(bo,Hp),e(Be,Vp),e(Be,_i),e(_i,Qa),e(Qa,yo),e(yo,Kp),e(Qa,Yp),p(n,Yl,h),p(n,er,h),e(er,Jp),p(n,Jl,h),p(n,xt,h),e(xt,gi),e(gi,zn),e(zn,Ti),e(Ti,Zp),e(zn,Xp),e(zn,tr),e(tr,Qp),e(zn,eh),e(xt,th),e(xt,ki),e(ki,xn),e(xn,vi),e(vi,nh),e(xn,oh),e(xn,nr),e(nr,sh),e(xn,ah),e(xt,rh),e(xt,bi),e(bi,En),e(En,yi),e(yi,ih),e(En,dh),e(En,or),e(or,lh),e(En,ch),p(n,Zl,h),p(n,qn,h),e(qn,ph),e(qn,wo),e(wo,hh),e(qn,uh),p(n,Xl,h),p(n,Et,h),e(Et,mh),e(Et,$o),e($o,fh),e(Et,_h),e(Et,zo),e(zo,gh),e(Et,Th),p(n,Ql,h),p(n,sr,h),p(n,ec,h),p(n,Jt,h),e(Jt,jn),e(jn,wi),g(xo,wi,null),e(Jt,kh),e(Jt,$i),e($i,vh),p(n,tc,h),p(n,_t,h),e(_t,bh),e(_t,zi),e(zi,yh),e(_t,wh),e(_t,xi),e(xi,$h),e(_t,zh),e(_t,Ei),e(Ei,xh),e(_t,Eh),p(n,nc,h),p(n,Fn,h),e(Fn,qh),e(Fn,ar),e(ar,jh),e(Fn,Fh),p(n,oc,h),p(n,Mn,h),e(Mn,dt),e(dt,qi),e(qi,Mh),e(dt,Ph),e(dt,_e),e(_e,Ch),e(_e,ji),e(ji,Ah),e(_e,Lh),e(_e,Fi),e(Fi,Nh),e(_e,Ih),e(_e,Mi),e(Mi,Dh),e(_e,Sh),e(_e,Pi),e(Pi,Oh),e(_e,Gh),e(_e,Ci),e(Ci,Bh),e(_e,Uh),e(_e,rr),e(rr,Wh),e(_e,Rh),e(dt,Hh),e(dt,Ai),e(Ai,Vh),e(dt,Kh),g(Eo,dt,null),e(dt,Yh),e(dt,qo),e(qo,Jh),e(qo,jo),e(jo,Zh),e(qo,Xh),e(Mn,Qh),e(Mn,ge),e(ge,Li),e(Li,eu),e(ge,tu),e(ge,Ni),e(Ni,nu),e(ge,ou),g(Fo,ge,null),e(ge,su),e(ge,re),e(re,au),e(re,Ii),e(Ii,ru),e(re,iu),e(re,Di),e(Di,du),e(re,lu),e(re,Si),e(Si,cu),e(re,pu),e(re,Oi),e(Oi,hu),e(re,uu),e(re,Gi),e(Gi,mu),e(re,fu),e(re,Bi),e(Bi,_u),e(re,gu),e(re,Ui),e(Ui,Tu),e(re,ku),e(ge,vu),e(ge,Zt),e(Zt,bu),e(Zt,Wi),e(Wi,yu),e(Zt,wu),e(Zt,Ri),e(Ri,$u),e(Zt,zu),e(ge,xu),e(ge,Te),e(Te,Eu),e(Te,Hi),e(Hi,qu),e(Te,ju),e(Te,Vi),e(Vi,Fu),e(Te,Mu),e(Te,Ki),e(Ki,Pu),e(Te,Cu),e(Te,Yi),e(Yi,Au),e(Te,Lu),e(Te,Mo),e(Mo,Nu),e(Te,Iu),e(Te,Ji),e(Ji,Du),e(Te,Su),e(ge,Ou),g(Po,ge,null),p(n,sc,h),p(n,ir,h),e(ir,Gu),p(n,ac,h),p(n,qt,h),e(qt,Zi),e(Zi,Co),e(Co,Bu),e(Co,Xi),e(Xi,Uu),e(Co,Wu),e(qt,Ru),e(qt,Qi),e(Qi,Xt),e(Xt,Hu),e(Xt,Ao),e(Ao,Vu),e(Xt,Ku),e(Xt,Lo),e(Lo,Yu),e(Xt,Ju),e(qt,Zu),e(qt,ed),e(ed,No),e(No,Xu),e(No,td),e(td,Qu),e(No,em),p(n,rc,h),p(n,dr,h),p(n,ic,h),p(n,Qt,h),e(Qt,Pn),e(Pn,nd),g(Io,nd,null),e(Qt,tm),e(Qt,od),e(od,nm),p(n,dc,h),p(n,gt,h),e(gt,om),e(gt,lr),e(lr,sm),e(gt,am),e(gt,Do),e(Do,rm),e(gt,im),e(gt,So),e(So,dm),e(gt,lm),p(n,lc,h),g(Oo,n,h),p(n,cc,h),p(n,Ue,h),e(Ue,cm),e(Ue,sd),e(sd,pm),e(Ue,hm),e(Ue,ad),e(ad,um),e(Ue,mm),e(Ue,cr),e(cr,fm),e(Ue,_m),e(Ue,rd),e(rd,gm),e(Ue,Tm),p(n,pc,h),p(n,pr,h),e(pr,km),p(n,hc,h),g(Go,n,h),p(n,uc,h),p(n,hr,h),p(n,mc,h),p(n,en,h),e(en,Cn),e(Cn,id),g(Bo,id,null),e(en,vm),e(en,dd),e(dd,bm),p(n,fc,h),p(n,Tt,h),e(Tt,ym),e(Tt,Uo),e(Uo,wm),e(Tt,$m),e(Tt,ld),e(ld,zm),e(Tt,xm),e(Tt,cd),e(cd,Em),e(Tt,qm),p(n,_c,h),p(n,tn,h),e(tn,An),e(An,pd),g(Wo,pd,null),e(tn,jm),e(tn,hd),e(hd,Fm),p(n,gc,h),p(n,ur,h),e(ur,Mm),p(n,Tc,h),p(n,Ln,h),e(Ln,ud),e(ud,nn),e(nn,Pm),e(nn,Ro),e(Ro,Cm),e(nn,Am),e(nn,Ho),e(Ho,Lm),e(nn,Nm),e(Ln,Im),e(Ln,md),e(md,De),e(De,Dm),e(De,Vo),e(Vo,Sm),e(De,Om),e(De,Ko),e(Ko,Gm),e(De,Bm),e(De,Yo),e(Yo,Um),e(De,Wm),e(De,Jo),e(Jo,Rm),e(De,Hm),e(De,Zo),e(Zo,Vm),e(De,Km),p(n,kc,h),p(n,on,h),e(on,Nn),e(Nn,fd),g(Xo,fd,null),e(on,Ym),e(on,_d),e(_d,Jm),p(n,vc,h),p(n,wt,h),g(Qo,wt,null),e(wt,Zm),e(wt,$t),e($t,Xm),e($t,mr),e(mr,Qm),e($t,ef),e($t,fr),e(fr,tf),e($t,nf),e($t,es),e(es,of),e($t,sf),e(wt,af),e(wt,sn),e(sn,rf),e(sn,_r),e(_r,df),e(sn,lf),e(sn,gr),e(gr,cf),e(sn,pf),p(n,bc,h),p(n,an,h),e(an,In),e(In,gd),g(ts,gd,null),e(an,hf),e(an,Td),e(Td,uf),p(n,yc,h),p(n,ie,h),g(ns,ie,null),e(ie,mf),e(ie,os),e(os,ff),e(os,ss),e(ss,_f),e(os,gf),e(ie,Tf),e(ie,as),e(as,kf),e(as,Tr),e(Tr,vf),e(as,bf),e(ie,yf),e(ie,jt),g(rs,jt,null),e(jt,wf),e(jt,kd),e(kd,$f),e(jt,zf),e(jt,is),e(is,kr),e(kr,xf),e(kr,vd),e(vd,Ef),e(is,qf),e(is,vr),e(vr,jf),e(vr,bd),e(bd,Ff),e(ie,Mf),e(ie,Dn),g(ds,Dn,null),e(Dn,Pf),e(Dn,ls),e(ls,Cf),e(ls,yd),e(yd,Af),e(ls,Lf),e(ie,Nf),e(ie,Sn),g(cs,Sn,null),e(Sn,If),e(Sn,wd),e(wd,Df),e(ie,Sf),e(ie,br),g(ps,br,null),p(n,wc,h),p(n,rn,h),e(rn,On),e(On,$d),g(hs,$d,null),e(rn,Of),e(rn,zd),e(zd,Gf),p(n,$c,h),p(n,Se,h),g(us,Se,null),e(Se,Bf),e(Se,dn),e(dn,Uf),e(dn,xd),e(xd,Wf),e(dn,Rf),e(dn,ms),e(ms,Hf),e(dn,Vf),e(Se,Kf),e(Se,fs),e(fs,Yf),e(fs,yr),e(yr,Jf),e(fs,Zf),e(Se,Xf),e(Se,Ft),g(_s,Ft,null),e(Ft,Qf),e(Ft,Ed),e(Ed,e_),e(Ft,t_),e(Ft,gs),e(gs,wr),e(wr,n_),e(wr,qd),e(qd,o_),e(gs,s_),e(gs,$r),e($r,a_),e($r,jd),e(jd,r_),e(Se,i_),e(Se,Gn),g(Ts,Gn,null),e(Gn,d_),e(Gn,Fd),e(Fd,l_),p(n,zc,h),p(n,ln,h),e(ln,Bn),e(Bn,Md),g(ks,Md,null),e(ln,c_),e(ln,Pd),e(Pd,p_),p(n,xc,h),p(n,Z,h),g(vs,Z,null),e(Z,h_),e(Z,Cd),e(Cd,u_),e(Z,m_),e(Z,bs),e(bs,f_),e(bs,ys),e(ys,__),e(bs,g_),e(Z,T_),e(Z,ws),e(ws,k_),e(ws,zr),e(zr,v_),e(ws,b_),e(Z,y_),e(Z,$s),e($s,w_),e($s,zs),e(zs,$_),e($s,z_),e(Z,x_),e(Z,We),g(xs,We,null),e(We,E_),e(We,cn),e(cn,q_),e(cn,xr),e(xr,j_),e(cn,F_),e(cn,Ad),e(Ad,M_),e(cn,P_),e(We,C_),g(Un,We,null),e(We,A_),e(We,Ld),e(Ld,L_),e(We,N_),g(Es,We,null),e(Z,I_),e(Z,Re),g(qs,Re,null),e(Re,D_),e(Re,Nd),e(Nd,S_),e(Re,O_),e(Re,Id),e(Id,G_),e(Re,B_),e(Re,Dd),e(Dd,U_),e(Re,W_),g(js,Re,null),e(Z,R_),e(Z,kt),g(Fs,kt,null),e(kt,H_),e(kt,Sd),e(Sd,V_),e(kt,K_),e(kt,Od),e(Od,Y_),e(kt,J_),g(Ms,kt,null),p(n,Ec,h),p(n,pn,h),e(pn,Wn),e(Wn,Gd),g(Ps,Gd,null),e(pn,Z_),e(pn,Bd),e(Bd,X_),p(n,qc,h),p(n,X,h),g(Cs,X,null),e(X,Q_),e(X,As),e(As,eg),e(As,Ud),e(Ud,tg),e(As,ng),e(X,og),e(X,Ls),e(Ls,sg),e(Ls,Ns),e(Ns,ag),e(Ls,rg),e(X,ig),e(X,Is),e(Is,dg),e(Is,Er),e(Er,lg),e(Is,cg),e(X,pg),e(X,Ds),e(Ds,hg),e(Ds,Ss),e(Ss,ug),e(Ds,mg),e(X,fg),e(X,He),g(Os,He,null),e(He,_g),e(He,hn),e(hn,gg),e(hn,qr),e(qr,Tg),e(hn,kg),e(hn,Wd),e(Wd,vg),e(hn,bg),e(He,yg),g(Rn,He,null),e(He,wg),e(He,Rd),e(Rd,$g),e(He,zg),g(Gs,He,null),e(X,xg),e(X,Ve),g(Bs,Ve,null),e(Ve,Eg),e(Ve,Hd),e(Hd,qg),e(Ve,jg),e(Ve,Vd),e(Vd,Fg),e(Ve,Mg),e(Ve,Kd),e(Kd,Pg),e(Ve,Cg),g(Us,Ve,null),e(X,Ag),e(X,vt),g(Ws,vt,null),e(vt,Lg),e(vt,Yd),e(Yd,Ng),e(vt,Ig),e(vt,Jd),e(Jd,Dg),e(vt,Sg),g(Rs,vt,null),p(n,jc,h),p(n,un,h),e(un,Hn),e(Hn,Zd),g(Hs,Zd,null),e(un,Og),e(un,Xd),e(Xd,Gg),p(n,Fc,h),p(n,Q,h),g(Vs,Q,null),e(Q,Bg),e(Q,Qd),e(Qd,Ug),e(Q,Wg),e(Q,Ks),e(Ks,Rg),e(Ks,Ys),e(Ys,Hg),e(Ks,Vg),e(Q,Kg),e(Q,Js),e(Js,Yg),e(Js,jr),e(jr,Jg),e(Js,Zg),e(Q,Xg),e(Q,Zs),e(Zs,Qg),e(Zs,Xs),e(Xs,eT),e(Zs,tT),e(Q,nT),e(Q,Ke),g(Qs,Ke,null),e(Ke,oT),e(Ke,mn),e(mn,sT),e(mn,Fr),e(Fr,aT),e(mn,rT),e(mn,el),e(el,iT),e(mn,dT),e(Ke,lT),g(Vn,Ke,null),e(Ke,cT),e(Ke,tl),e(tl,pT),e(Ke,hT),g(ea,Ke,null),e(Q,uT),e(Q,Ye),g(ta,Ye,null),e(Ye,mT),e(Ye,nl),e(nl,fT),e(Ye,_T),e(Ye,ol),e(ol,gT),e(Ye,TT),e(Ye,sl),e(sl,kT),e(Ye,vT),g(na,Ye,null),e(Q,bT),e(Q,bt),g(oa,bt,null),e(bt,yT),e(bt,al),e(al,wT),e(bt,$T),e(bt,rl),e(rl,zT),e(bt,xT),g(sa,bt,null),p(n,Mc,h),p(n,fn,h),e(fn,Kn),e(Kn,il),g(aa,il,null),e(fn,ET),e(fn,dl),e(dl,qT),p(n,Pc,h),p(n,de,h),g(ra,de,null),e(de,jT),e(de,ll),e(ll,FT),e(de,MT),e(de,ia),e(ia,PT),e(ia,da),e(da,CT),e(ia,AT),e(de,LT),e(de,la),e(la,NT),e(la,Mr),e(Mr,IT),e(la,DT),e(de,ST),e(de,ca),e(ca,OT),e(ca,pa),e(pa,GT),e(ca,BT),e(de,UT),g(Yn,de,null),e(de,WT),e(de,Je),g(ha,Je,null),e(Je,RT),e(Je,_n),e(_n,HT),e(_n,Pr),e(Pr,VT),e(_n,KT),e(_n,cl),e(cl,YT),e(_n,JT),e(Je,ZT),g(Jn,Je,null),e(Je,XT),e(Je,pl),e(pl,QT),e(Je,e5),g(ua,Je,null),p(n,Cc,h),p(n,gn,h),e(gn,Zn),e(Zn,hl),g(ma,hl,null),e(gn,t5),e(gn,ul),e(ul,n5),p(n,Ac,h),p(n,le,h),g(fa,le,null),e(le,o5),e(le,_a),e(_a,s5),e(_a,ml),e(ml,a5),e(_a,r5),e(le,i5),e(le,ga),e(ga,d5),e(ga,Ta),e(Ta,l5),e(ga,c5),e(le,p5),e(le,ka),e(ka,h5),e(ka,Cr),e(Cr,u5),e(ka,m5),e(le,f5),e(le,va),e(va,_5),e(va,ba),e(ba,g5),e(va,T5),e(le,k5),g(Xn,le,null),e(le,v5),e(le,Ze),g(ya,Ze,null),e(Ze,b5),e(Ze,Tn),e(Tn,y5),e(Tn,Ar),e(Ar,w5),e(Tn,$5),e(Tn,fl),e(fl,z5),e(Tn,x5),e(Ze,E5),g(Qn,Ze,null),e(Ze,q5),e(Ze,_l),e(_l,j5),e(Ze,F5),g(wa,Ze,null),p(n,Lc,h),p(n,kn,h),e(kn,eo),e(eo,gl),g($a,gl,null),e(kn,M5),e(kn,Tl),e(Tl,P5),p(n,Nc,h),p(n,ce,h),g(za,ce,null),e(ce,C5),e(ce,kl),e(kl,A5),e(ce,L5),e(ce,xa),e(xa,N5),e(xa,Ea),e(Ea,I5),e(xa,D5),e(ce,S5),e(ce,qa),e(qa,O5),e(qa,Lr),e(Lr,G5),e(qa,B5),e(ce,U5),e(ce,ja),e(ja,W5),e(ja,Fa),e(Fa,R5),e(ja,H5),e(ce,V5),g(to,ce,null),e(ce,K5),e(ce,Xe),g(Ma,Xe,null),e(Xe,Y5),e(Xe,vn),e(vn,J5),e(vn,Nr),e(Nr,Z5),e(vn,X5),e(vn,vl),e(vl,Q5),e(vn,ek),e(Xe,tk),g(no,Xe,null),e(Xe,nk),e(Xe,bl),e(bl,ok),e(Xe,sk),g(Pa,Xe,null),p(n,Ic,h),p(n,bn,h),e(bn,oo),e(oo,yl),g(Ca,yl,null),e(bn,ak),e(bn,wl),e(wl,rk),p(n,Dc,h),p(n,lt,h),g(Aa,lt,null),e(lt,ik),e(lt,Qe),g(La,Qe,null),e(Qe,dk),e(Qe,yn),e(yn,lk),e(yn,$l),e($l,ck),e(yn,pk),e(yn,zl),e(zl,hk),e(yn,uk),e(Qe,mk),g(so,Qe,null),e(Qe,fk),e(Qe,xl),e(xl,_k),e(Qe,gk),g(Na,Qe,null),e(lt,Tk),e(lt,Mt),g(Ia,Mt,null),e(Mt,kk),e(Mt,El),e(El,vk),e(Mt,bk),g(Da,Mt,null),e(lt,yk),e(lt,Pt),g(Sa,Pt,null),e(Pt,wk),e(Pt,ql),e(ql,$k),e(Pt,zk),g(Oa,Pt,null),p(n,Sc,h),p(n,wn,h),e(wn,ao),e(ao,jl),g(Ga,jl,null),e(wn,xk),e(wn,Fl),e(Fl,Ek),p(n,Oc,h),p(n,ct,h),g(Ba,ct,null),e(ct,qk),e(ct,et),g(Ua,et,null),e(et,jk),e(et,$n),e($n,Fk),e($n,Ml),e(Ml,Mk),e($n,Pk),e($n,Pl),e(Pl,Ck),e($n,Ak),e(et,Lk),g(ro,et,null),e(et,Nk),e(et,Cl),e(Cl,Ik),e(et,Dk),g(Wa,et,null),e(ct,Sk),e(ct,Ct),g(Ra,Ct,null),e(Ct,Ok),e(Ct,Al),e(Al,Gk),e(Ct,Bk),g(Ha,Ct,null),e(ct,Uk),e(ct,At),g(Va,At,null),e(At,Wk),e(At,Ll),e(Ll,Rk),e(At,Hk),g(Ka,At,null),Gc=!0},p(n,[h]){const Ya={};h&2&&(Ya.$$scope={dirty:h,ctx:n}),Un.$set(Ya);const Nl={};h&2&&(Nl.$$scope={dirty:h,ctx:n}),Rn.$set(Nl);const Il={};h&2&&(Il.$$scope={dirty:h,ctx:n}),Vn.$set(Il);const Dl={};h&2&&(Dl.$$scope={dirty:h,ctx:n}),Yn.$set(Dl);const Ja={};h&2&&(Ja.$$scope={dirty:h,ctx:n}),Jn.$set(Ja);const Sl={};h&2&&(Sl.$$scope={dirty:h,ctx:n}),Xn.$set(Sl);const Ol={};h&2&&(Ol.$$scope={dirty:h,ctx:n}),Qn.$set(Ol);const Gl={};h&2&&(Gl.$$scope={dirty:h,ctx:n}),to.$set(Gl);const Za={};h&2&&(Za.$$scope={dirty:h,ctx:n}),no.$set(Za);const Bl={};h&2&&(Bl.$$scope={dirty:h,ctx:n}),so.$set(Bl);const Ul={};h&2&&(Ul.$$scope={dirty:h,ctx:n}),ro.$set(Ul)},i(n){Gc||(T($.$$.fragment,n),T(se.$$.fragment,n),T(xo.$$.fragment,n),T(Eo.$$.fragment,n),T(Fo.$$.fragment,n),T(Po.$$.fragment,n),T(Io.$$.fragment,n),T(Oo.$$.fragment,n),T(Go.$$.fragment,n),T(Bo.$$.fragment,n),T(Wo.$$.fragment,n),T(Xo.$$.fragment,n),T(Qo.$$.fragment,n),T(ts.$$.fragment,n),T(ns.$$.fragment,n),T(rs.$$.fragment,n),T(ds.$$.fragment,n),T(cs.$$.fragment,n),T(ps.$$.fragment,n),T(hs.$$.fragment,n),T(us.$$.fragment,n),T(_s.$$.fragment,n),T(Ts.$$.fragment,n),T(ks.$$.fragment,n),T(vs.$$.fragment,n),T(xs.$$.fragment,n),T(Un.$$.fragment,n),T(Es.$$.fragment,n),T(qs.$$.fragment,n),T(js.$$.fragment,n),T(Fs.$$.fragment,n),T(Ms.$$.fragment,n),T(Ps.$$.fragment,n),T(Cs.$$.fragment,n),T(Os.$$.fragment,n),T(Rn.$$.fragment,n),T(Gs.$$.fragment,n),T(Bs.$$.fragment,n),T(Us.$$.fragment,n),T(Ws.$$.fragment,n),T(Rs.$$.fragment,n),T(Hs.$$.fragment,n),T(Vs.$$.fragment,n),T(Qs.$$.fragment,n),T(Vn.$$.fragment,n),T(ea.$$.fragment,n),T(ta.$$.fragment,n),T(na.$$.fragment,n),T(oa.$$.fragment,n),T(sa.$$.fragment,n),T(aa.$$.fragment,n),T(ra.$$.fragment,n),T(Yn.$$.fragment,n),T(ha.$$.fragment,n),T(Jn.$$.fragment,n),T(ua.$$.fragment,n),T(ma.$$.fragment,n),T(fa.$$.fragment,n),T(Xn.$$.fragment,n),T(ya.$$.fragment,n),T(Qn.$$.fragment,n),T(wa.$$.fragment,n),T($a.$$.fragment,n),T(za.$$.fragment,n),T(to.$$.fragment,n),T(Ma.$$.fragment,n),T(no.$$.fragment,n),T(Pa.$$.fragment,n),T(Ca.$$.fragment,n),T(Aa.$$.fragment,n),T(La.$$.fragment,n),T(so.$$.fragment,n),T(Na.$$.fragment,n),T(Ia.$$.fragment,n),T(Da.$$.fragment,n),T(Sa.$$.fragment,n),T(Oa.$$.fragment,n),T(Ga.$$.fragment,n),T(Ba.$$.fragment,n),T(Ua.$$.fragment,n),T(ro.$$.fragment,n),T(Wa.$$.fragment,n),T(Ra.$$.fragment,n),T(Ha.$$.fragment,n),T(Va.$$.fragment,n),T(Ka.$$.fragment,n),Gc=!0)},o(n){k($.$$.fragment,n),k(se.$$.fragment,n),k(xo.$$.fragment,n),k(Eo.$$.fragment,n),k(Fo.$$.fragment,n),k(Po.$$.fragment,n),k(Io.$$.fragment,n),k(Oo.$$.fragment,n),k(Go.$$.fragment,n),k(Bo.$$.fragment,n),k(Wo.$$.fragment,n),k(Xo.$$.fragment,n),k(Qo.$$.fragment,n),k(ts.$$.fragment,n),k(ns.$$.fragment,n),k(rs.$$.fragment,n),k(ds.$$.fragment,n),k(cs.$$.fragment,n),k(ps.$$.fragment,n),k(hs.$$.fragment,n),k(us.$$.fragment,n),k(_s.$$.fragment,n),k(Ts.$$.fragment,n),k(ks.$$.fragment,n),k(vs.$$.fragment,n),k(xs.$$.fragment,n),k(Un.$$.fragment,n),k(Es.$$.fragment,n),k(qs.$$.fragment,n),k(js.$$.fragment,n),k(Fs.$$.fragment,n),k(Ms.$$.fragment,n),k(Ps.$$.fragment,n),k(Cs.$$.fragment,n),k(Os.$$.fragment,n),k(Rn.$$.fragment,n),k(Gs.$$.fragment,n),k(Bs.$$.fragment,n),k(Us.$$.fragment,n),k(Ws.$$.fragment,n),k(Rs.$$.fragment,n),k(Hs.$$.fragment,n),k(Vs.$$.fragment,n),k(Qs.$$.fragment,n),k(Vn.$$.fragment,n),k(ea.$$.fragment,n),k(ta.$$.fragment,n),k(na.$$.fragment,n),k(oa.$$.fragment,n),k(sa.$$.fragment,n),k(aa.$$.fragment,n),k(ra.$$.fragment,n),k(Yn.$$.fragment,n),k(ha.$$.fragment,n),k(Jn.$$.fragment,n),k(ua.$$.fragment,n),k(ma.$$.fragment,n),k(fa.$$.fragment,n),k(Xn.$$.fragment,n),k(ya.$$.fragment,n),k(Qn.$$.fragment,n),k(wa.$$.fragment,n),k($a.$$.fragment,n),k(za.$$.fragment,n),k(to.$$.fragment,n),k(Ma.$$.fragment,n),k(no.$$.fragment,n),k(Pa.$$.fragment,n),k(Ca.$$.fragment,n),k(Aa.$$.fragment,n),k(La.$$.fragment,n),k(so.$$.fragment,n),k(Na.$$.fragment,n),k(Ia.$$.fragment,n),k(Da.$$.fragment,n),k(Sa.$$.fragment,n),k(Oa.$$.fragment,n),k(Ga.$$.fragment,n),k(Ba.$$.fragment,n),k(Ua.$$.fragment,n),k(ro.$$.fragment,n),k(Wa.$$.fragment,n),k(Ra.$$.fragment,n),k(Ha.$$.fragment,n),k(Va.$$.fragment,n),k(Ka.$$.fragment,n),Gc=!1},d(n){t(u),n&&t(x),n&&t(b),v($),n&&t(oe),n&&t(q),v(se),n&&t(ve),n&&t(B),n&&t(C),n&&t(he),n&&t(be),n&&t(ue),n&&t(ye),n&&t(P),n&&t(H),n&&t(V),n&&t(Vl),n&&t(Xa),n&&t(Kl),n&&t(Be),n&&t(Yl),n&&t(er),n&&t(Jl),n&&t(xt),n&&t(Zl),n&&t(qn),n&&t(Xl),n&&t(Et),n&&t(Ql),n&&t(sr),n&&t(ec),n&&t(Jt),v(xo),n&&t(tc),n&&t(_t),n&&t(nc),n&&t(Fn),n&&t(oc),n&&t(Mn),v(Eo),v(Fo),v(Po),n&&t(sc),n&&t(ir),n&&t(ac),n&&t(qt),n&&t(rc),n&&t(dr),n&&t(ic),n&&t(Qt),v(Io),n&&t(dc),n&&t(gt),n&&t(lc),v(Oo,n),n&&t(cc),n&&t(Ue),n&&t(pc),n&&t(pr),n&&t(hc),v(Go,n),n&&t(uc),n&&t(hr),n&&t(mc),n&&t(en),v(Bo),n&&t(fc),n&&t(Tt),n&&t(_c),n&&t(tn),v(Wo),n&&t(gc),n&&t(ur),n&&t(Tc),n&&t(Ln),n&&t(kc),n&&t(on),v(Xo),n&&t(vc),n&&t(wt),v(Qo),n&&t(bc),n&&t(an),v(ts),n&&t(yc),n&&t(ie),v(ns),v(rs),v(ds),v(cs),v(ps),n&&t(wc),n&&t(rn),v(hs),n&&t($c),n&&t(Se),v(us),v(_s),v(Ts),n&&t(zc),n&&t(ln),v(ks),n&&t(xc),n&&t(Z),v(vs),v(xs),v(Un),v(Es),v(qs),v(js),v(Fs),v(Ms),n&&t(Ec),n&&t(pn),v(Ps),n&&t(qc),n&&t(X),v(Cs),v(Os),v(Rn),v(Gs),v(Bs),v(Us),v(Ws),v(Rs),n&&t(jc),n&&t(un),v(Hs),n&&t(Fc),n&&t(Q),v(Vs),v(Qs),v(Vn),v(ea),v(ta),v(na),v(oa),v(sa),n&&t(Mc),n&&t(fn),v(aa),n&&t(Pc),n&&t(de),v(ra),v(Yn),v(ha),v(Jn),v(ua),n&&t(Cc),n&&t(gn),v(ma),n&&t(Ac),n&&t(le),v(fa),v(Xn),v(ya),v(Qn),v(wa),n&&t(Lc),n&&t(kn),v($a),n&&t(Nc),n&&t(ce),v(za),v(to),v(Ma),v(no),v(Pa),n&&t(Ic),n&&t(bn),v(Ca),n&&t(Dc),n&&t(lt),v(Aa),v(La),v(so),v(Na),v(Ia),v(Da),v(Sa),v(Oa),n&&t(Sc),n&&t(wn),v(Ga),n&&t(Oc),n&&t(ct),v(Ba),v(Ua),v(ro),v(Wa),v(Ra),v(Ha),v(Va),v(Ka)}}}const jw={local:"t5",sections:[{local:"overview",title:"Overview"},{local:"training",title:"Training"},{local:"inference",title:"Inference"},{local:"performance",title:"Performance"},{local:"example-scripts",title:"Example scripts"},{local:"transformers.T5Config",title:"T5Config"},{local:"transformers.T5Tokenizer",title:"T5Tokenizer"},{local:"transformers.T5TokenizerFast",title:"T5TokenizerFast"},{local:"transformers.T5Model",title:"T5Model"},{local:"transformers.T5ForConditionalGeneration",title:"T5ForConditionalGeneration"},{local:"transformers.T5EncoderModel",title:"T5EncoderModel"},{local:"transformers.TFT5Model",title:"TFT5Model"},{local:"transformers.TFT5ForConditionalGeneration",title:"TFT5ForConditionalGeneration"},{local:"transformers.TFT5EncoderModel",title:"TFT5EncoderModel"},{local:"transformers.FlaxT5Model",title:"FlaxT5Model"},{local:"transformers.FlaxT5ForConditionalGeneration",title:"FlaxT5ForConditionalGeneration"}],title:"T5"};function Fw(N,u,x){let{fw:b}=u;return N.$$set=w=>{"fw"in w&&x(0,b=w.fw)},[b]}class Iw extends uw{constructor(u){super();mw(this,u,Fw,qw,fw,{fw:0})}}export{Iw as default,jw as metadata};
