import{S as wl,i as Ll,s as ql,e as n,k as l,w as m,t as r,L as zl,c as a,d as o,m as c,a as s,x as f,h as i,b as d,J as e,g as h,y as _,q as g,o as b,B as k}from"../../chunks/vendor-9e2b328e.js";import{T as Mi}from"../../chunks/Tip-76f97a76.js";import{D}from"../../chunks/Docstring-50fd6873.js";import{C as Ce}from"../../chunks/CodeBlock-88e23343.js";import{I as ue}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Bl(J){let u,q,v,P,B;return{c(){u=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),P=r("Module"),B=r(`
...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);q=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var F=s(v);P=i(F,"Module"),F.forEach(o),B=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,q),e(u,v),e(v,P),e(u,B)},d(T){T&&o(u)}}}function Cl(J){let u,q,v,P,B,T,y,F,pa,fn,O,ao,ha,ua,Ee,ma,fa,Fe,_a,ga,_n,Y,me,so,Me,ba,ro,ka,gn,G,va,je,Ta,ya,io,Pa,wa,bn,Et,La,kn,Ft,lo,qa,vn,R,za,Se,Ba,$a,Ae,xa,Ca,Tn,Z,fe,co,Ne,Ea,po,Fa,yn,M,Ma,ho,ja,Sa,uo,Aa,Na,mo,Ia,Da,fo,Oa,Xa,Pn,_e,Ga,Ie,Ra,Wa,wn,W,Ua,De,_o,Ha,Va,Ka,Mt,Qa,Ja,Ln,jt,go,Ya,qn,Oe,zn,St,Xe,bo,Za,es,ee,ts,ko,os,ns,vo,as,ss,Bn,Ge,$n,te,ge,To,Re,rs,yo,is,xn,C,We,ds,oe,ls,At,cs,ps,Ue,hs,us,ms,ne,fs,Nt,_s,gs,It,bs,ks,vs,Po,Ts,ys,He,Cn,ae,be,wo,Ve,Ps,Lo,ws,En,w,Ke,Ls,qo,qs,zs,X,Bs,Dt,$s,xs,Ot,Cs,Es,Qe,Fs,Ms,js,Je,Ss,zo,As,Ns,Is,Bo,Ds,Os,Ye,Xs,ke,Ze,Gs,$o,Rs,Ws,I,et,Us,tt,Hs,xo,Vs,Ks,Qs,ot,nt,Co,Js,Ys,Eo,Zs,er,at,Fo,tr,or,Mo,nr,ar,jo,sr,Fn,se,ve,So,st,rr,Ao,ir,Mn,A,rt,dr,it,lr,Xt,cr,pr,hr,dt,ur,lt,mr,fr,_r,j,ct,gr,re,br,Gt,kr,vr,No,Tr,yr,Pr,Te,wr,Io,Lr,qr,pt,jn,ie,ye,Do,ht,zr,Oo,Br,Sn,N,ut,$r,mt,xr,Rt,Cr,Er,Fr,ft,Mr,_t,jr,Sr,Ar,L,gt,Nr,de,Ir,Wt,Dr,Or,Xo,Xr,Gr,Rr,Pe,Wr,Go,Ur,Hr,Ro,Wo,Uo,Ho,Vr,Kr,Vo,Ko,Qo,Jo,Qr,Jr,Yo,Yr,Zr,Zo,en,tn,on,ei,An,le,we,nn,bt,ti,an,oi,Nn,E,kt,ni,sn,ai,si,vt,ri,Ut,ii,di,li,Tt,ci,yt,pi,hi,ui,z,Pt,mi,ce,fi,Ht,_i,gi,rn,bi,ki,vi,Le,Ti,dn,yi,Pi,wt,wi,ln,Li,qi,Lt,In,pe,qe,cn,qt,zi,pn,Bi,Dn,he,zt,$i,U,Bt,xi,hn,Ci,Ei,$t,On;return T=new ue({}),Me=new ue({}),Ne=new ue({}),Oe=new Ce({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
inside the context manager `),Mt=n("a"),Qa=r("as_target_tokenizer()"),Ja=r(" to encode target text format."),Ln=l(),jt=n("ul"),go=n("li"),Ya=r("Supervised training"),qn=l(),m(Oe.$$.fragment),zn=l(),St=n("ul"),Xe=n("li"),bo=n("p"),Za=r("Generation"),es=l(),ee=n("p"),ts=r("While generating the target text set the "),ko=n("code"),os=r("decoder_start_token_id"),ns=r(` to the target language id. The following
example shows how to translate Python to English using the `),vo=n("code"),as=r("uclanlp/plbart-python-en_XX"),ss=r(" model."),Bn=l(),m(Ge.$$.fragment),$n=l(),te=n("h2"),ge=n("a"),To=n("span"),m(Re.$$.fragment),rs=l(),yo=n("span"),is=r("PLBartConfig"),xn=l(),C=n("div"),m(We.$$.fragment),ds=l(),oe=n("p"),ls=r("This is the configuration class to store the configuration of a "),At=n("a"),cs=r("PLBartModel"),ps=r(`. It is used to instantiate an
...
`),Ue=n("a"),hs=r("uclanlp/plbart-base"),us=r(" architecture."),ms=l(),ne=n("p"),fs=r("Configuration objects inherit from "),Nt=n("a"),_s=r("PretrainedConfig"),gs=r(` and can be used to control the model outputs. Read the
...
example shows how to translate Python to English using the `),vo=a(Jt,"CODE",{});var cd=s(vo);as=i(cd,"uclanlp/plbart-python-en_XX"),cd.forEach(o),ss=i(Jt," model."),Jt.forEach(o),Wn.forEach(o),id.forEach(o),Bn=c(t),f(Ge.$$.fragment,t),$n=c(t),te=a(t,"H2",{class:!0});var Un=s(te);ge=a(Un,"A",{id:!0,class:!0,href:!0});var pd=s(ge);To=a(pd,"SPAN",{});var hd=s(To);f(Re.$$.fragment,hd),hd.forEach(o),pd.forEach(o),rs=c(Un),yo=a(Un,"SPAN",{});var ud=s(yo);is=i(ud,"PLBartConfig"),ud.forEach(o),Un.forEach(o),xn=c(t),C=a(t,"DIV",{class:!0});var V=s(C);f(We.$$.fragment,V),ds=c(V),oe=a(V,"P",{});var Yt=s(oe);ls=i(Yt,"This is the configuration class to store the configuration of a "),At=a(Yt,"A",{href:!0});var md=s(At);cs=i(md,"PLBartModel"),md.forEach(o),ps=i(Yt,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
`),Ue=a(Yt,"A",{href:!0,rel:!0});var fd=s(Ue);hs=i(fd,"uclanlp/plbart-base"),fd.forEach(o),us=i(Yt," architecture."),Yt.forEach(o),ms=c(V),ne=a(V,"P",{});var Zt=s(ne);fs=i(Zt,"Configuration objects inherit from "),Nt=a(Zt,"A",{href:!0});var _d=s(Nt);_s=i(_d,"PretrainedConfig"),_d.forEach(o),gs=i(Zt,` and can be used to control the model outputs. Read the
