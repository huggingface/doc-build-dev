import{S as tn,i as nn,s as on,e as o,k as p,w as M,t as r,L as sn,c as s,d as n,m as u,a as i,x as $,h as a,b as l,J as t,g as d,y as A,K as rn,q as P,o as N,B as I}from"../../chunks/vendor-9e2b328e.js";import{D as xt}from"../../chunks/Docstring-50fd6873.js";import{C as en}from"../../chunks/CodeBlock-88e23343.js";import{I as zt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function an(Se){let g,V,h,f,le,U,Ke,ce,De,_e,b,T,de,W,Re,pe,Fe,ge,k,Oe,S,Be,je,K,Xe,Ce,ke,J,Ye,ye,G,He,ve,Q,ue,Ve,be,Z,Je,we,D,Te,L,Ge,ee,Qe,Ze,Le,R,qe,q,et,te,tt,nt,xe,y,ot,F,st,it,O,rt,at,ze,w,x,me,B,lt,he,ct,Ee,m,j,dt,_,pt,ne,ut,mt,oe,ht,ft,X,_t,gt,kt,C,yt,se,vt,bt,wt,z,Y,Tt,fe,Lt,qt,ie,H,Me;return U=new zt({}),W=new zt({}),D=new en({props:{code:`from transformers import LukeModel
...
<p><a
  href="/docs/transformers/pr_15750/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15750/src/transformers/models/mluke/tokenization_mluke.py#L1493"}}),{c(){g=o("meta"),V=p(),h=o("h1"),f=o("a"),le=o("span"),M(U.$$.fragment),Ke=p(),ce=o("span"),De=r("mLUKE"),_e=p(),b=o("h2"),T=o("a"),de=o("span"),M(W.$$.fragment),Re=p(),pe=o("span"),Fe=r("Overview"),ge=p(),k=o("p"),Oe=r("The mLUKE model was proposed in "),S=o("a"),Be=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),je=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
knowledge more likely than using only word representations.`),be=p(),Z=o("p"),Je=r("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),M(D.$$.fragment),Te=p(),L=o("p"),Ge=r("Note that mLUKE has its own tokenizer, "),ee=o("a"),Qe=r("MLukeTokenizer"),Ze=r(". You can initialize it as follows:"),Le=p(),M(R.$$.fragment),qe=p(),q=o("p"),et=r("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),te=o("a"),tt=r("LUKE\u2019s documentation page"),nt=r(` for all
tips, code examples and notebooks.`),xe=p(),y=o("p"),ot=r("This model was contributed by "),F=o("a"),st=r("ryo0634"),it=r(". The original code can be found "),O=o("a"),rt=r("here"),at=r("."),ze=p(),w=o("h2"),x=o("a"),me=o("span"),M(B.$$.fragment),lt=p(),he=o("span"),ct=r("MLukeTokenizer"),Ee=p(),m=o("div"),M(j.$$.fragment),dt=p(),_=o("p"),pt=r("Adapted from "),ne=o("a"),ut=r("XLMRobertaTokenizer"),mt=r(" and "),oe=o("a"),ht=r("LukeTokenizer"),ft=r(`. Based on
...
tips, code examples and notebooks.`),Ne.forEach(n),xe=u(e),y=s(e,"P",{});var ae=i(y);ot=a(ae,"This model was contributed by "),F=s(ae,"A",{href:!0,rel:!0});var Bt=i(F);st=a(Bt,"ryo0634"),Bt.forEach(n),it=a(ae,". The original code can be found "),O=s(ae,"A",{href:!0,rel:!0});var jt=i(O);rt=a(jt,"here"),jt.forEach(n),at=a(ae,"."),ae.forEach(n),ze=u(e),w=s(e,"H2",{class:!0});var Ie=i(w);x=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=i(x);me=s(Xt,"SPAN",{});var Ct=i(me);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),lt=u(Ie),he=s(Ie,"SPAN",{});var Yt=i(he);ct=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Ee=u(e),m=s(e,"DIV",{class:!0});var v=i(m);$(j.$$.fragment,v),dt=u(v),_=s(v,"P",{});var E=i(_);pt=a(E,"Adapted from "),ne=s(E,"A",{href:!0});var Ht=i(ne);ut=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),mt=a(E," and "),oe=s(E,"A",{href:!0});var Vt=i(oe);ht=a(Vt,"LukeTokenizer"),Vt.forEach(n),ft=a(E,`. Based on
`),X=s(E,"A",{href:!0,rel:!0});var Jt=i(X);_t=a(Jt,"SentencePiece"),Jt.forEach(n),gt=a(E,"."),E.forEach(n),kt=u(v),C=s(v,"P",{});var Ue=i(C);yt=a(Ue,"This tokenizer inherits from "),se=s(Ue,"A",{href:!0});var Gt=i(se);vt=a(Gt,"PreTrainedTokenizer"),Gt.forEach(n),bt=a(Ue,` which contains most of the main methods. Users should refer to
