...
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),L.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,_,j),e(_,w),e(w,x),e(_,g),e(_,$),e($,Ae),h(m,ue,j),h(m,E,j),e(E,ve),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,je),h(m,G,j),h(m,A,j),e(A,Ee),h(m,I,j),h(m,q,j),e(q,F),e(F,te),e(F,ne),e(ne,ke),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(E),m&&t(G),m&&t(A),m&&t(I),m&&t(q)}}}function cf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function pf(C){let u,z,f,_,w,x,g,$,Ae,ue,E,ve,X,Se,Q,ee,Oe,je,G,A,Ee,I,q,F,te,ne,ke,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),_=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=o("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ve=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Oe=r("model(inputs)"),je=r("."),G=d(),A=o("p"),Ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),I=d(),q=o("ul"),F=o("li"),te=r("a single Tensor with "),ne=o("code"),ke=r("input_ids"),He=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),Te=d(),N=o("li"),De=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=o("code"),Me=r("model([input_ids, attention_mask])"),se=r(" or "),ae=o("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),Ue=d(),S=o("li"),Re=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),f=l(m),_=s(m,"UL",{});var be=a(_);w=s(be,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),g=l(be),$=s(be,"LI",{});var ye=a($);Ae=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),ue=l(m),E=s(m,"P",{});var D=a(E);ve=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Se=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
...
first positional argument :`),We.forEach(t),I=l(m),q=s(m,"UL",{});var L=a(q);F=s(L,"LI",{});var ie=a(F);te=i(ie,"a single Tensor with "),ne=s(ie,"CODE",{});var rt=a(ne);ke=i(rt,"input_ids"),rt.forEach(t),He=i(ie," only and nothing else: "),J=s(ie,"CODE",{});var Be=a(J);P=i(Be,"model(input_ids)"),Be.forEach(t),ie.forEach(t),Te=l(L),N=s(L,"LI",{});var U=a(N);De=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(L),S=s(L,"LI",{});var de=a(S);Re=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),L.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,_,j),e(_,w),e(w,x),e(_,g),e(_,$),e($,Ae),h(m,ue,j),h(m,E,j),e(E,ve),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,je),h(m,G,j),h(m,A,j),e(A,Ee),h(m,I,j),h(m,q,j),e(q,F),e(F,te),e(F,ne),e(ne,ke),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(E),m&&t(G),m&&t(A),m&&t(I),m&&t(q)}}}function hf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function ff(C){let u,z,f,_,w,x,g,$,Ae,ue,E,ve,X,Se,Q,ee,Oe,je,G,A,Ee,I,q,F,te,ne,ke,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H,m,j,be,ot,ye,D,st,at,We,L,ie,rt,Be,U,it,dt,de,xe,wi,Xo,zi,$i,ji,lt,hn,Ei,Ps,qi,Pi,Fi,un,Ni,Fs,Ci,Ii,Li,ct,Ai,Ns,Si,Oi,Cs,Hi,Di,Ui,Is,mn,Ri,Ls,Wi,Bi,Vi,As,fn,Gi,_n,Ji,Yi,er,pt,Ct,Ss,gn,Ki,Os,Zi,tr,qe,Qo,Xi,Hs,Qi,ed,vn,td,kn,nd,od,sd,ht,ad,Ds,rd,id,Us,dd,ld,cd,Rs,pd,nr,ut,It,Ws,Tn,hd,Bs,ud,or,Je,Vs,md,fd,Gs,Mn,_d,gd,Js,bn,vd,sr,mt,Lt,Ys,yn,kd,Ks,Td,ar,Pe,xn,Md,Zs,bd,yd,xd,wn,wd,Xs,zd,$d,jd,zn,Ed,$n,qd,Pd,Fd,jn,Nd,Qs,Cd,Id,rr,At,Ld,En,Ad,Sd,ir,qn,dr,es,Od,lr,Pn,cr,ft,St,ea,Fn,Hd,ta,Dd,pr,ts,Ud,hr,Nn,ur,ns,Rd,mr,Cn,fr,_t,Ot,na,In,Wd,oa,Bd,_r,le,Ln,Vd,gt,Gd,os,Jd,Yd,An,Kd,Zd,Xd,vt,Qd,ss,el,tl,as,nl,ol,sl,sa,al,rl,Sn,gr,kt,Ht,aa,On,il,ra,dl,vr,R,Hn,ll,Dn,cl,Un,pl,hl,ul,Rn,ml,rs,fl,_l,gl,ia,vl,kl,Wn,Tl,Dt,Bn,Ml,da,bl,kr,Tt,Ut,la,Vn,yl,ca,xl,Tr,we,Gn,wl,Jn,zl,is,$l,jl,El,Yn,ql,Kn,Pl,Fl,Nl,me,Zn,Cl,Mt,Il,ds,Ll,Al,pa,Sl,Ol,Hl,Rt,Dl,ha,Ul,Rl,Xn,Mr,bt,Wt,ua,Qn,Wl,ma,Bl,br,ze,eo,Vl,to,Gl,ls,Jl,Yl,Kl,no,Zl,oo,Xl,Ql,ec,Y,so,tc,yt,nc,cs,oc,sc,fa,ac,rc,ic,Bt,dc,ao,lc,ro,cc,pc,hc,_a,uc,mc,io,yr,xt,Vt,ga,lo,fc,va,_c,xr,wt,co,gc,Ye,po,vc,ka,kc,Tc,ho,wr,zt,Gt,Ta,uo,Mc,Ma,bc,zr,ce,mo,yc,fo,xc,ps,wc,zc,$c,_o,jc,go,Ec,qc,Pc,Jt,Fc,fe,vo,Nc,$t,Cc,hs,Ic,Lc,ba,Ac,Sc,Oc,Yt,Hc,ya,Dc,Uc,ko,$r,jt,Kt,xa,To,Rc,wa,Wc,jr,pe,Mo,Bc,bo,Vc,us,Gc,Jc,Yc,yo,Kc,xo,Zc,Xc,Qc,Zt,ep,K,wo,tp,Et,np,ms,op,sp,za,ap,rp,ip,Xt,dp,zo,lp,$o,cp,pp,hp,$a,up,mp,jo,Er,qt,Qt,ja,Eo,fp,Ea,_p,qr,W,qo,gp,Po,vp,fs,kp,Tp,Mp,Fo,bp,No,yp,xp,wp,qa,zp,$p,Ve,Pa,Co,jp,Ep,Fa,Io,qp,Pp,Na,Lo,Fp,Np,Ca,Ao,Cp,Ip,_e,So,Lp,Pt,Ap,Ia,Sp,Op,La,Hp,Dp,Up,en,Rp,Aa,Wp,Bp,Oo,Pr,Ft,tn,Sa,Ho,Vp,Oa,Gp,Fr,B,Do,Jp,Uo,Yp,_s,Kp,Zp,Xp,Ro,Qp,Wo,eh,th,nh,Ha,oh,sh,Ge,Da,Bo,ah,rh,Ua,Vo,ih,dh,Ra,Go,lh,ch,Wa,Jo,ph,hh,ge,Yo,uh,Nt,mh,Ba,fh,_h,Va,gh,vh,kh,nn,Th,Ga,Mh,bh,Ko,Nr;return x=new he({}),te=new he({}),gn=new he({}),Tn=new he({}),yn=new he({}),qn=new $e({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),On=new he({}),Hn=new V({props:{name:"class transformers.MarianTokenizer",anchor:"transformers.MarianTokenizer",parameters:[{name:"source_spm",val:""},{name:"target_spm",val:""},{name:"vocab",val:" = None"},{name:"src_vocab_file",val:" = None"},{name:"tgt_vocab_file",val:" = None"},{name:"source_lang",val:" = None"},{name:"target_lang",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"model_max_length",val:" = 512"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"separate_vocabs",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15831/src/transformers/models/marian/tokenization_marian.py#L61",parametersDescription:[{anchor:"transformers.MarianTokenizer.source_spm",description:`<strong>source_spm</strong> (<code>str</code>) &#x2014;
...
<span class="hljs-string">&quot;Where is the bus stop ?&quot;</span>`}}),lo=new he({}),co=new V({props:{name:"class transformers.MarianForCausalLM",anchor:"transformers.MarianForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15831/src/transformers/models/marian/modeling_marian.py#L1408"}}),po=new V({props:{name:"forward",anchor:"transformers.MarianForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15831/src/transformers/models/marian/modeling_marian.py#L1439",parametersDescription:[{anchor:"transformers.MarianForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=d(),Y=o("div"),v(so.$$.fragment),tc=d(),yt=o("p"),nc=r("The "),cs=o("a"),oc=r("MarianMTModel"),sc=r(" forward method, overrides the "),fa=o("code"),ac=r("__call__"),rc=r(" special method."),ic=d(),v(Bt.$$.fragment),dc=d(),ao=o("p"),lc=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wp=d(),qa=o("p"),zp=r("Finally, this model supports inherent JAX features such as:"),$p=d(),Ve=o("ul"),Pa=o("li"),Co=o("a"),jp=r("Just-In-Time (JIT) compilation"),Ep=d(),Fa=o("li"),Io=o("a"),qp=r("Automatic Differentiation"),Pp=d(),Na=o("li"),Lo=o("a"),Fp=r("Vectorization"),Np=d(),Ca=o("li"),Ao=o("a"),Cp=r("Parallelization"),Ip=d(),_e=o("div"),v(So.$$.fragment),Lp=d(),Pt=o("p"),Ap=r("The "),Ia=o("code"),Sp=r("FlaxMarianPreTrainedModel"),Op=r("forward method, overrides the "),La=o("code"),Hp=r("__call__"),Dp=r(" special method."),Up=d(),v(en.$$.fragment),Rp=d(),Aa=o("p"),Wp=r("Example:"),Bp=d(),v(Oo.$$.fragment),Pr=d(),Ft=o("h2"),tn=o("a"),Sa=o("span"),v(Ho.$$.fragment),Vp=d(),Oa=o("span"),Gp=r("FlaxMarianMTModel"),Fr=d(),B=o("div"),v(Do.$$.fragment),Jp=d(),Uo=o("p"),Yp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
fine-tuning experiments and integration tests.`),su.forEach(t),fd=l(Ms),Gs=s(Ms,"LI",{});var au=a(Gs);Mn=s(au,"A",{href:!0,rel:!0});var ru=a(Mn);_d=i(ru,"Fine-tune on GPU"),ru.forEach(t),au.forEach(t),gd=l(Ms),Js=s(Ms,"LI",{});var iu=a(Js);bn=s(iu,"A",{href:!0,rel:!0});var du=a(bn);vd=i(du,"Fine-tune on GPU with pytorch-lightning"),du.forEach(t),iu.forEach(t),Ms.forEach(t),sr=l(n),mt=s(n,"H2",{class:!0});var Br=a(mt);Lt=s(Br,"A",{id:!0,class:!0,href:!0});var lu=a(Lt);Ys=s(lu,"SPAN",{});var cu=a(Ys);k(yn.$$.fragment,cu),cu.forEach(t),lu.forEach(t),kd=l(Br),Ks=s(Br,"SPAN",{});var pu=a(Ks);Td=i(pu,"Multilingual Models"),pu.forEach(t),Br.forEach(t),ar=l(n),Pe=s(n,"UL",{});var an=a(Pe);xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,"All model names use the following format: "),Zs=s(Vr,"CODE",{});var hu=a(Zs);bd=i(hu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),hu.forEach(t),yd=i(Vr,":"),Vr.forEach(t),xd=l(an),wn=s(an,"LI",{});var Gr=a(wn);wd=i(Gr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
this superclass for more information regarding those methods.`),ti.forEach(t),gl=l(Fe),ia=s(Fe,"P",{});var Lu=a(ia);vl=i(Lu,"Examples:"),Lu.forEach(t),kl=l(Fe),k(Wn.$$.fragment,Fe),Tl=l(Fe),Dt=s(Fe,"DIV",{class:!0});var ni=a(Dt);k(Bn.$$.fragment,ni),Ml=l(ni),da=s(ni,"P",{});var Au=a(da);bl=i(Au,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
