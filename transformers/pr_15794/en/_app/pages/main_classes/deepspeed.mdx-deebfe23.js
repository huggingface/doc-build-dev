import{S as eW,i as sW,s as tW,e as o,k as u,w as f,t as a,M as aW,c as l,d as t,m as c,a as r,x as d,h as n,b as h,F as s,g as i,y as m,q as _,o as v,B as j}from"../../chunks/vendor-22ad994f.js";import{T as QH}from"../../chunks/Tip-540f533b.js";import{D as Y1}from"../../chunks/Docstring-3bc3620c.js";import{C as g}from"../../chunks/CodeBlock-03069293.js";import{I as w}from"../../chunks/IconCopyLink-2eb9a001.js";import"../../chunks/CopyButton-f539c482.js";function nW($n){let y,Z;return{c(){y=o("p"),Z=a("This section is a must-read")},l(b){y=l(b,"P",{});var $=r(y);Z=n($,"This section is a must-read"),$.forEach(t)},m(b,$){i(b,y,$),s(y,Z)},d(b){b&&t(y)}}}function oW($n){let y,Z,b,$,hs,B,kn,fs,ds,ot,V;return{c(){y=o("p"),Z=a("Note, that once "),b=o("code"),$=a("load_state_dict_from_zero_checkpoint"),hs=a(" was run, the "),B=o("code"),kn=a("model"),fs=a(` will no longer be useable in the
...
following:`),Mv=u(),jt=o("ol"),js=o("li"),H0=a("replace "),mh=o("code"),W0=a("python -m torch.distributed.launch"),F0=a(" with "),_h=o("code"),B0=a("deepspeed"),V0=a("."),Y0=u(),ve=o("li"),K0=a("add a new argument "),vh=o("code"),J0=a("--deepspeed ds_config.json"),X0=a(", where "),jh=o("code"),Q0=a("ds_config.json"),e5=a(` is the DeepSpeed configuration file as
documented `),Bn=o("a"),s5=a("here"),t5=a(". The file naming is up to you."),Nv=u(),mp=o("p"),a5=a("Therefore, if your original command line looked as follows:"),Hv=u(),f(Vn.$$.fragment),Wv=u(),_p=o("p"),n5=a("Now it should be:"),Fv=u(),f(Yn.$$.fragment),Bv=u(),z=o("p"),o5=a("Unlike, "),gh=o("code"),l5=a("torch.distributed.launch"),r5=a(" where you have to specify how many GPUs to use with "),wh=o("code"),p5=a("--nproc_per_node"),i5=a(`, with the
`),yh=o("code"),u5=a("deepspeed"),c5=a(" launcher you don\u2019t have to use the corresponding "),bh=o("code"),h5=a("--num_gpus"),f5=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Kn=o("a"),d5=a("here"),m5=a("."),Vv=u(),J=o("p"),_5=a("In fact, you can continue using "),qh=o("code"),v5=a("-m torch.distributed.launch"),j5=a(` with DeepSpeed as long as you don\u2019t need to use
...
the `),$h=o("code"),y5=a("deepspeed"),b5=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Yv=u(),gt=o("p"),q5=a("Here is an example of running "),kh=o("code"),E5=a("run_translation.py"),$5=a(" under DeepSpeed deploying all available GPUs:"),Kv=u(),f(Jn.$$.fragment),Jv=u(),wt=o("p"),k5=a("Note that in the DeepSpeed documentation you are likely to see "),Dh=o("code"),D5=a("--deepspeed --deepspeed_config ds_config.json"),P5=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Xv=u(),yt=o("p"),O5=a("For some practical usage examples, please, see this "),Xn=o("a"),z5=a("post"),T5=a("."),Qv=u(),vp=o("a"),ej=u(),gs=o("h3"),bt=o("a"),Ph=o("span"),f(Qn.$$.fragment),A5=u(),Oh=o("span"),S5=a("Deployment with one GPU"),sj=u(),qt=o("p"),C5=a("To deploy DeepSpeed with one GPU adjust the "),jp=o("a"),x5=a("Trainer"),I5=a(" command line arguments as follows:"),tj=u(),f(eo.$$.fragment),aj=u(),Oe=o("p"),R5=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),zh=o("code"),U5=a("--num_gpus=1"),L5=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),so=o("a"),Z5=a("documentation"),G5=a(" discusses the launcher options."),nj=u(),gp=o("p"),M5=a("Why would you want to use DeepSpeed with just one GPU?"),oj=u(),Et=o("ol"),Th=o("li"),N5=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),H5=u(),Ah=o("li"),W5=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
...
find more details in the discussion below.`),ij=u(),$t=o("p"),V5=a("For a practical usage example of this type of deployment, please, see this "),ao=o("a"),Y5=a("post"),K5=a("."),uj=u(),bp=o("p"),J5=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),cj=u(),qp=o("p"),X5=a("Notes:"),hj=u(),Ep=o("ul"),ws=o("li"),no=o("p"),Q5=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Sh=o("code"),e4=a("CUDA_VISIBLE_DEVICES"),s4=a(` to limit
...
DeepSpeed docs.`),rg=u(),Ht=o("p"),e6=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Yp=o("a"),s6=a("Trainer"),t6=a(` provides
...
going to use.`),ig=u(),Jp=o("a"),ug=u(),ks=o("h4"),Wt=o("a"),pf=o("span"),f(Po.$$.fragment),n6=u(),uf=o("span"),o6=a("ZeRO-2 Config"),cg=u(),Xp=o("p"),l6=a("The following is an example of configuration for ZeRO stage 2:"),hg=u(),f(Oo.$$.fragment),fg=u(),Qp=o("p"),cf=o("strong"),r6=a("Performance tuning:"),dg=u(),Ce=o("ul"),Ds=o("li"),p6=a("enabling "),hf=o("code"),i6=a("offload_optimizer"),u6=a(" should reduce GPU RAM usage (it requires "),ff=o("code"),c6=a('"stage": 2'),h6=a(")"),f6=u(),A=o("li"),df=o("code"),d6=a('"overlap_comm": true'),m6=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),mf=o("code"),_6=a("overlap_comm"),v6=a(` uses 4.5x
the `),_f=o("code"),j6=a("allgather_bucket_size"),g6=a(" and "),vf=o("code"),w6=a("reduce_bucket_size"),y6=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),jf=o("code"),b6=a("5e8 x 2Bytes x 2 x 4.5"),q6=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),gf=o("code"),E6=a("2e8"),$6=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),k6=u(),wf=o("li"),D6=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),mg=u(),ei=o("a"),_g=u(),Ps=o("h4"),Ft=o("a"),yf=o("span"),f(zo.$$.fragment),P6=u(),bf=o("span"),O6=a("ZeRO-3 Config"),vg=u(),si=o("p"),z6=a("The following is an example of configuration for ZeRO stage 3:"),jg=u(),f(To.$$.fragment),gg=u(),M=o("p"),T6=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),qf=o("code"),A6=a('"device": "cpu"'),S6=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Ef=o("code"),C6=a("none"),x6=a(" instead of "),$f=o("code"),I6=a("cpu"),R6=a(" for the "),kf=o("code"),U6=a("device"),L6=a(` entry. Offloading to
NVMe is discussed further down.`),wg=u(),xe=o("p"),Z6=a("Pinned memory is enabled with "),Df=o("code"),G6=a("pin_memory"),M6=a(" set to "),Pf=o("code"),N6=a("true"),H6=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),yg=u(),ti=o("p"),Of=o("strong"),W6=a("Performance tuning:"),bg=u(),Bt=o("ul"),Ao=o("li"),zf=o("code"),F6=a("stage3_max_live_parameters"),B6=a(": "),Tf=o("code"),V6=a("1e9"),Y6=u(),So=o("li"),Af=o("code"),K6=a("stage3_max_reuse_distance"),J6=a(": "),Sf=o("code"),X6=a("1e9"),qg=u(),S=o("p"),Q6=a("If hitting OOM reduce "),Cf=o("code"),e9=a("stage3_max_live_parameters"),s9=a(" and "),xf=o("code"),t9=a("stage3_max_reuse_distance"),a9=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),If=o("code"),n9=a("1e9"),o9=a(` would consume ~2GB. The memory is shared by
`),Rf=o("code"),l9=a("stage3_max_live_parameters"),r9=a(" and "),Uf=o("code"),p9=a("stage3_max_reuse_distance"),i9=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Eg=u(),je=o("p"),Lf=o("code"),u9=a("stage3_max_live_parameters"),c9=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Zf=o("code"),h9=a("stage3_max_reuse_distance"),f9=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Gf=o("code"),d9=a("stage3_max_reuse_distance"),m9=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),$g=u(),ai=o("p"),_9=a("The following configuration values depend on the model\u2019s hidden size:"),kg=u(),Ie=o("ul"),Co=o("li"),Mf=o("code"),v9=a("reduce_bucket_size"),j9=a(": "),Nf=o("code"),g9=a("hidden_size*hidden_size"),w9=u(),xo=o("li"),Hf=o("code"),y9=a("stage3_prefetch_bucket_size"),b9=a(": "),Wf=o("code"),q9=a("0.9 * hidden_size * hidden_size"),E9=u(),Io=o("li"),Ff=o("code"),$9=a("stage3_param_persistence_threshold"),k9=a(": "),Bf=o("code"),D9=a("10 * hidden_size"),Dg=u(),Re=o("p"),P9=a("therefore set these values to "),Vf=o("code"),O9=a("auto"),z9=a(" and the "),ni=o("a"),T9=a("Trainer"),A9=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),Pg=u(),Ro=o("p"),Yf=o("code"),S9=a("stage3_gather_fp16_weights_on_model_save"),C9=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Og=u(),ee=o("p"),x9=a("If you\u2019re migrating from ZeRO-2 configuration note that "),Kf=o("code"),I9=a("allgather_partitions"),R9=a(", "),Jf=o("code"),U9=a("allgather_bucket_size"),L9=a(` and
`),Xf=o("code"),Z9=a("reduce_scatter"),G9=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),zg=u(),oi=o("ul"),Uo=o("li"),Qf=o("code"),M9=a("sub_group_size"),N9=a(": "),ed=o("code"),H9=a("1e9"),Tg=u(),ge=o("p"),sd=o("code"),W9=a("sub_group_size"),F9=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),td=o("code"),B9=a("sub_group_size"),V9=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),ad=o("code"),Y9=a("sub_group_size"),K9=a(` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Ag=u(),Ue=o("p"),J9=a("You can leave "),nd=o("code"),X9=a("sub_group_size"),Q9=a(" to its default value of "),od=o("em"),e7=a("1e9"),s7=a(` when not using NVMe offload. You may want to change its
default value in the following cases:`),Sg=u(),Vt=o("ol"),Lo=o("li"),t7=a("Running into OOM during optimizer step: Reduce "),ld=o("code"),a7=a("sub_group_size"),n7=a(" to reduce memory utilization of temporary buffers"),o7=u(),Zo=o("li"),l7=a("Optimizer Step is taking a long time: Increase "),rd=o("code"),r7=a("sub_group_size"),p7=a(` to improve bandwidth utilization as a result of
the increased data buffers.`),Cg=u(),li=o("a"),xg=u(),Os=o("h3"),Yt=o("a"),pd=o("span"),f(Go.$$.fragment),i7=u(),id=o("span"),u7=a("NVMe Support"),Ig=u(),ri=o("p"),c7=a(`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
...
process. ZeRO-Infinity requires ZeRO-3 enabled.`),Rg=u(),pi=o("p"),h7=a("The following configuration example enables NVMe to offload both optimizer states and the params:"),Ug=u(),f(Mo.$$.fragment),Lg=u(),Kt=o("p"),f7=a(`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),ud=o("em"),d7=a("\u201Cdevice\u201D: \u201Ccpu\u201D"),m7=a(")."),Zg=u(),Le=o("p"),_7=a("Here is the full documentation for offloading "),No=o("a"),v7=a("optimizer states"),j7=a(" and "),Ho=o("a"),g7=a("parameters"),w7=a("."),Gg=u(),Jt=o("p"),y7=a("Make sure that your "),cd=o("code"),b7=a("nvme_path"),q7=a(` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),Mg=u(),Ze=o("p"),E7=a("In order to figure out the optimal "),hd=o("code"),$7=a("aio"),k7=a(` configuration block you must run a benchmark on your target setup, as
`),Wo=o("a"),D7=a("explained here"),P7=a("."),Ng=u(),ii=o("a"),Hg=u(),zs=o("h4"),Xt=o("a"),fd=o("span"),f(Fo.$$.fragment),O7=u(),dd=o("span"),z7=a("ZeRO-2 vs ZeRO-3 Performance"),Wg=u(),ui=o("p"),T7=a(`ZeRO-3 is likely to be slower than ZeRO-2 if everything else is configured the same because the former has to gather
...
at a cost of speed.`),Fg=u(),ci=o("p"),A7=a("It\u2019s possible to adjust ZeRO-3 configuration to make it perform closer to ZeRO-2:"),Bg=u(),Qt=o("ul"),Ts=o("li"),S7=a("set "),md=o("code"),C7=a("stage3_param_persistence_threshold"),x7=a(" to a very large number - larger than the largest parameter, e.g., "),_d=o("code"),I7=a("6 * hidden_size * hidden_size"),R7=a(". This will keep the parameters on the GPUs."),U7=u(),Bo=o("li"),L7=a("turn off "),vd=o("code"),Z7=a("offload_params"),G7=a(" since ZeRO-2 doesn\u2019t have that option."),Vg=u(),Ge=o("p"),M7=a("The performance will likely improve significantly with just "),jd=o("code"),N7=a("offload_params"),H7=a(` turned off, even if you don\u2019t change
`),gd=o("code"),W7=a("stage3_param_persistence_threshold"),F7=a(`. Of course, these changes will impact the size of the model you can train. So
these help you to trade scalability for speed depending on your needs.`),Yg=u(),hi=o("a"),Kg=u(),As=o("h4"),ea=o("a"),wd=o("span"),f(Vo.$$.fragment),B7=u(),yd=o("span"),V7=a("ZeRO-2 Example"),Jg=u(),sa=o("p"),Y7=a("Here is a full ZeRO-2 auto-configuration file "),bd=o("code"),K7=a("ds_config_zero2.json"),J7=a(":"),Xg=u(),f(Yo.$$.fragment),Qg=u(),ta=o("p"),X7=a(`Here is a full ZeRO-2 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),qd=o("code"),Q7=a("auto"),e8=a(" settings in it."),ew=u(),f(Ko.$$.fragment),sw=u(),fi=o("a"),tw=u(),Ss=o("h4"),aa=o("a"),Ed=o("span"),f(Jo.$$.fragment),s8=u(),$d=o("span"),t8=a("ZeRO-3 Example"),aw=u(),na=o("p"),a8=a("Here is a full ZeRO-3 auto-configuration file "),kd=o("code"),n8=a("ds_config_zero3.json"),o8=a(":"),nw=u(),f(Xo.$$.fragment),ow=u(),oa=o("p"),l8=a(`Here is a full ZeRO-3 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),Dd=o("code"),r8=a("auto"),p8=a(" settings in it."),lw=u(),f(Qo.$$.fragment),rw=u(),Cs=o("h3"),la=o("a"),Pd=o("span"),f(el.$$.fragment),i8=u(),Od=o("span"),u8=a("Optimizer and Scheduler"),pw=u(),ra=o("p"),c8=a("As long as you don\u2019t enable "),zd=o("code"),h8=a("offload_optimizer"),f8=a(` you can mix and match DeepSpeed and HuggingFace schedulers and
optimizers, with the exception of using the combination of HuggingFace scheduler and DeepSpeed optimizer:`),iw=u(),di=o("p"),d8=a(`| Combos       | HF Scheduler | DS Scheduler |
| HF Optimizer | Yes          | Yes          |
| DS Optimizer | No           | Yes          |`),uw=u(),pa=o("p"),m8=a("It is possible to use a non-DeepSpeed optimizer when "),Td=o("code"),_8=a("offload_optimizer"),v8=a(` is enabled, as long as it has both CPU and
GPU implementation (except LAMB).`),cw=u(),mi=o("a"),hw=u(),xs=o("h4"),ia=o("a"),Ad=o("span"),f(sl.$$.fragment),j8=u(),Sd=o("span"),g8=a("Optimizer"),fw=u(),Me=o("p"),w8=a(`DeepSpeed\u2019s main optimizers are Adam, AdamW, OneBitAdam, and Lamb. These have been thoroughly tested with ZeRO and are
thus recommended to be used. It, however, can import other optimizers from `),Cd=o("code"),y8=a("torch"),b8=a(". The full documentation is "),tl=o("a"),q8=a("here"),E8=a("."),dw=u(),q=o("p"),$8=a("If you don\u2019t configure the "),xd=o("code"),k8=a("optimizer"),D8=a(" entry in the configuration file, the "),_i=o("a"),P8=a("Trainer"),O8=a(` will
automatically set it to `),Id=o("code"),z8=a("AdamW"),T8=a(` and will use the supplied values or the defaults for the following command line
arguments: `),Rd=o("code"),A8=a("--learning_rate"),S8=a(", "),Ud=o("code"),C8=a("--adam_beta1"),x8=a(", "),Ld=o("code"),I8=a("--adam_beta2"),R8=a(", "),Zd=o("code"),U8=a("--adam_epsilon"),L8=a(" and "),Gd=o("code"),Z8=a("--weight_decay"),G8=a("."),mw=u(),Ne=o("p"),M8=a("Here is an example of the auto-configured "),Md=o("code"),N8=a("optimizer"),H8=a(" entry for "),Nd=o("code"),W8=a("AdamW"),F8=a(":"),_w=u(),f(al.$$.fragment),vw=u(),vi=o("p"),B8=a(`Note that the command line arguments will set the values in the configuration file. This is so that there is one
definitive source of the values and to avoid hard to find errors when for example, the learning rate is set to
different values in different places. Command line rules. The values that get overridden are:`),jw=u(),se=o("ul"),nl=o("li"),Hd=o("code"),V8=a("lr"),Y8=a(" with the value of "),Wd=o("code"),K8=a("--learning_rate"),J8=u(),ol=o("li"),Fd=o("code"),X8=a("betas"),Q8=a(" with the value of "),Bd=o("code"),ek=a("--adam_beta1 --adam_beta2"),sk=u(),ll=o("li"),Vd=o("code"),tk=a("eps"),ak=a(" with the value of "),Yd=o("code"),nk=a("--adam_epsilon"),ok=u(),rl=o("li"),Kd=o("code"),lk=a("weight_decay"),rk=a(" with the value of "),Jd=o("code"),pk=a("--weight_decay"),gw=u(),ji=o("p"),ik=a("Therefore please remember to tune the shared hyperparameters on the command line."),ww=u(),gi=o("p"),uk=a("You can also set the values explicitly:"),yw=u(),f(pl.$$.fragment),bw=u(),ua=o("p"),ck=a("But then you\u2019re on your own synchronizing the "),wi=o("a"),hk=a("Trainer"),fk=a(` command line arguments and the DeepSpeed
...
documented `),Bn=l(hn,"A",{href:!0,rel:!0});var rI=r(Bn);s5=n(rI,"here"),rI.forEach(t),t5=n(hn,". The file naming is up to you."),hn.forEach(t),Ab.forEach(t),Nv=c(e),mp=l(e,"P",{});var pI=r(mp);a5=n(pI,"Therefore, if your original command line looked as follows:"),pI.forEach(t),Hv=c(e),d(Vn.$$.fragment,e),Wv=c(e),_p=l(e,"P",{});var iI=r(_p);n5=n(iI,"Now it should be:"),iI.forEach(t),Fv=c(e),d(Yn.$$.fragment,e),Bv=c(e),z=l(e,"P",{});var ue=r(z);o5=n(ue,"Unlike, "),gh=l(ue,"CODE",{});var uI=r(gh);l5=n(uI,"torch.distributed.launch"),uI.forEach(t),r5=n(ue," where you have to specify how many GPUs to use with "),wh=l(ue,"CODE",{});var cI=r(wh);p5=n(cI,"--nproc_per_node"),cI.forEach(t),i5=n(ue,`, with the
`),yh=l(ue,"CODE",{});var hI=r(yh);u5=n(hI,"deepspeed"),hI.forEach(t),c5=n(ue," launcher you don\u2019t have to use the corresponding "),bh=l(ue,"CODE",{});var fI=r(bh);h5=n(fI,"--num_gpus"),fI.forEach(t),f5=n(ue,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Kn=l(ue,"A",{href:!0,rel:!0});var dI=r(Kn);d5=n(dI,"here"),dI.forEach(t),m5=n(ue,"."),ue.forEach(t),Vv=c(e),J=l(e,"P",{});var fn=r(J);_5=n(fn,"In fact, you can continue using "),qh=l(fn,"CODE",{});var mI=r(qh);v5=n(mI,"-m torch.distributed.launch"),mI.forEach(t),j5=n(fn,` with DeepSpeed as long as you don\u2019t need to use
`),Eh=l(fn,"CODE",{});var _I=r(Eh);g5=n(_I,"deepspeed"),_I.forEach(t),w5=n(fn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),$h=l(fn,"CODE",{});var vI=r($h);y5=n(vI,"deepspeed"),vI.forEach(t),b5=n(fn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),fn.forEach(t),Yv=c(e),gt=l(e,"P",{});var Sb=r(gt);q5=n(Sb,"Here is an example of running "),kh=l(Sb,"CODE",{});var jI=r(kh);E5=n(jI,"run_translation.py"),jI.forEach(t),$5=n(Sb," under DeepSpeed deploying all available GPUs:"),Sb.forEach(t),Kv=c(e),d(Jn.$$.fragment,e),Jv=c(e),wt=l(e,"P",{});var Cb=r(wt);k5=n(Cb,"Note that in the DeepSpeed documentation you are likely to see "),Dh=l(Cb,"CODE",{});var gI=r(Dh);D5=n(gI,"--deepspeed --deepspeed_config ds_config.json"),gI.forEach(t),P5=n(Cb,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Cb.forEach(t),Xv=c(e),yt=l(e,"P",{});var xb=r(yt);O5=n(xb,"For some practical usage examples, please, see this "),Xn=l(xb,"A",{href:!0,rel:!0});var wI=r(Xn);z5=n(wI,"post"),wI.forEach(t),T5=n(xb,"."),xb.forEach(t),Qv=c(e),vp=l(e,"A",{id:!0}),r(vp).forEach(t),ej=c(e),gs=l(e,"H3",{class:!0});var Ib=r(gs);bt=l(Ib,"A",{id:!0,class:!0,href:!0});var yI=r(bt);Ph=l(yI,"SPAN",{});var bI=r(Ph);d(Qn.$$.fragment,bI),bI.forEach(t),yI.forEach(t),A5=c(Ib),Oh=l(Ib,"SPAN",{});var qI=r(Oh);S5=n(qI,"Deployment with one GPU"),qI.forEach(t),Ib.forEach(t),sj=c(e),qt=l(e,"P",{});var Rb=r(qt);C5=n(Rb,"To deploy DeepSpeed with one GPU adjust the "),jp=l(Rb,"A",{href:!0});var EI=r(jp);x5=n(EI,"Trainer"),EI.forEach(t),I5=n(Rb," command line arguments as follows:"),Rb.forEach(t),tj=c(e),d(eo.$$.fragment,e),aj=c(e),Oe=l(e,"P",{});var sc=r(Oe);R5=n(sc,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),zh=l(sc,"CODE",{});var $I=r(zh);U5=n($I,"--num_gpus=1"),$I.forEach(t),L5=n(sc,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),so=l(sc,"A",{href:!0,rel:!0});var kI=r(so);Z5=n(kI,"documentation"),kI.forEach(t),G5=n(sc," discusses the launcher options."),sc.forEach(t),nj=c(e),gp=l(e,"P",{});var DI=r(gp);M5=n(DI,"Why would you want to use DeepSpeed with just one GPU?"),DI.forEach(t),oj=c(e),Et=l(e,"OL",{});var Ub=r(Et);Th=l(Ub,"LI",{});var PI=r(Th);N5=n(PI,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),PI.forEach(t),H5=c(Ub),Ah=l(Ub,"LI",{});var OI=r(Ah);W5=n(OI,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),OI.forEach(t),Ub.forEach(t),lj=c(e),wp=l(e,"P",{});var zI=r(wp);F5=n(zI,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),zI.forEach(t),rj=c(e),d(to.$$.fragment,e),pj=c(e),yp=l(e,"P",{});var TI=r(yp);B5=n(TI,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),TI.forEach(t),ij=c(e),$t=l(e,"P",{});var Lb=r($t);V5=n(Lb,"For a practical usage example of this type of deployment, please, see this "),ao=l(Lb,"A",{href:!0,rel:!0});var AI=r(ao);Y5=n(AI,"post"),AI.forEach(t),K5=n(Lb,"."),Lb.forEach(t),uj=c(e),bp=l(e,"P",{});var SI=r(bp);J5=n(SI,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),SI.forEach(t),cj=c(e),qp=l(e,"P",{});var CI=r(qp);X5=n(CI,"Notes:"),CI.forEach(t),hj=c(e),Ep=l(e,"UL",{});var xI=r(Ep);ws=l(xI,"LI",{});var tc=r(ws);no=l(tc,"P",{});var Zb=r(no);Q5=n(Zb,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Sh=l(Zb,"CODE",{});var II=r(Sh);e4=n(II,"CUDA_VISIBLE_DEVICES"),II.forEach(t),s4=n(Zb,` to limit
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),lc.forEach(t),rg=c(e),Ht=l(e,"P",{});var o3=r(Ht);e6=n(o3,"This section has to be configured exclusively via DeepSpeed configuration - the "),Yp=l(o3,"A",{href:!0});var ZR=r(Yp);s6=n(ZR,"Trainer"),ZR.forEach(t),t6=n(o3,` provides
no equivalent command line arguments.`),o3.forEach(t),pg=c(e),Kp=l(e,"P",{});var GR=r(Kp);a6=n(GR,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),GR.forEach(t),ig=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),ug=c(e),ks=l(e,"H4",{class:!0});var l3=r(ks);Wt=l(l3,"A",{id:!0,class:!0,href:!0});var MR=r(Wt);pf=l(MR,"SPAN",{});var NR=r(pf);d(Po.$$.fragment,NR),NR.forEach(t),MR.forEach(t),n6=c(l3),uf=l(l3,"SPAN",{});var HR=r(uf);o6=n(HR,"ZeRO-2 Config"),HR.forEach(t),l3.forEach(t),cg=c(e),Xp=l(e,"P",{});var WR=r(Xp);l6=n(WR,"The following is an example of configuration for ZeRO stage 2:"),WR.forEach(t),hg=c(e),d(Oo.$$.fragment,e),fg=c(e),Qp=l(e,"P",{});var FR=r(Qp);cf=l(FR,"STRONG",{});var BR=r(cf);r6=n(BR,"Performance tuning:"),BR.forEach(t),FR.forEach(t),dg=c(e),Ce=l(e,"UL",{});var rc=r(Ce);Ds=l(rc,"LI",{});var pc=r(Ds);p6=n(pc,"enabling "),hf=l(pc,"CODE",{});var VR=r(hf);i6=n(VR,"offload_optimizer"),VR.forEach(t),u6=n(pc," should reduce GPU RAM usage (it requires "),ff=l(pc,"CODE",{});var YR=r(ff);c6=n(YR,'"stage": 2'),YR.forEach(t),h6=n(pc,")"),pc.forEach(t),f6=c(rc),A=l(rc,"LI",{});var K=r(A);df=l(K,"CODE",{});var KR=r(df);d6=n(KR,'"overlap_comm": true'),KR.forEach(t),m6=n(K," trades off increased GPU RAM usage to lower all-reduce latency. "),mf=l(K,"CODE",{});var JR=r(mf);_6=n(JR,"overlap_comm"),JR.forEach(t),v6=n(K,` uses 4.5x
the `),_f=l(K,"CODE",{});var XR=r(_f);j6=n(XR,"allgather_bucket_size"),XR.forEach(t),g6=n(K," and "),vf=l(K,"CODE",{});var QR=r(vf);w6=n(QR,"reduce_bucket_size"),QR.forEach(t),y6=n(K,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),jf=l(K,"CODE",{});var eU=r(jf);b6=n(eU,"5e8 x 2Bytes x 2 x 4.5"),eU.forEach(t),q6=n(K,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),gf=l(K,"CODE",{});var sU=r(gf);E6=n(sU,"2e8"),sU.forEach(t),$6=n(K,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),K.forEach(t),k6=c(rc),wf=l(rc,"LI",{});var tU=r(wf);D6=n(tU,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),tU.forEach(t),rc.forEach(t),mg=c(e),ei=l(e,"A",{id:!0}),r(ei).forEach(t),_g=c(e),Ps=l(e,"H4",{class:!0});var r3=r(Ps);Ft=l(r3,"A",{id:!0,class:!0,href:!0});var aU=r(Ft);yf=l(aU,"SPAN",{});var nU=r(yf);d(zo.$$.fragment,nU),nU.forEach(t),aU.forEach(t),P6=c(r3),bf=l(r3,"SPAN",{});var oU=r(bf);O6=n(oU,"ZeRO-3 Config"),oU.forEach(t),r3.forEach(t),vg=c(e),si=l(e,"P",{});var lU=r(si);z6=n(lU,"The following is an example of configuration for ZeRO stage 3:"),lU.forEach(t),jg=c(e),d(To.$$.fragment,e),gg=c(e),M=l(e,"P",{});var ps=r(M);T6=n(ps,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),qf=l(ps,"CODE",{});var rU=r(qf);A6=n(rU,'"device": "cpu"'),rU.forEach(t),S6=n(ps,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Ef=l(ps,"CODE",{});var pU=r(Ef);C6=n(pU,"none"),pU.forEach(t),x6=n(ps," instead of "),$f=l(ps,"CODE",{});var iU=r($f);I6=n(iU,"cpu"),iU.forEach(t),R6=n(ps," for the "),kf=l(ps,"CODE",{});var uU=r(kf);U6=n(uU,"device"),uU.forEach(t),L6=n(ps,` entry. Offloading to
NVMe is discussed further down.`),ps.forEach(t),wg=c(e),xe=l(e,"P",{});var ic=r(xe);Z6=n(ic,"Pinned memory is enabled with "),Df=l(ic,"CODE",{});var cU=r(Df);G6=n(cU,"pin_memory"),cU.forEach(t),M6=n(ic," set to "),Pf=l(ic,"CODE",{});var hU=r(Pf);N6=n(hU,"true"),hU.forEach(t),H6=n(ic,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),ic.forEach(t),yg=c(e),ti=l(e,"P",{});var fU=r(ti);Of=l(fU,"STRONG",{});var dU=r(Of);W6=n(dU,"Performance tuning:"),dU.forEach(t),fU.forEach(t),bg=c(e),Bt=l(e,"UL",{});var p3=r(Bt);Ao=l(p3,"LI",{});var i3=r(Ao);zf=l(i3,"CODE",{});var mU=r(zf);F6=n(mU,"stage3_max_live_parameters"),mU.forEach(t),B6=n(i3,": "),Tf=l(i3,"CODE",{});var _U=r(Tf);V6=n(_U,"1e9"),_U.forEach(t),i3.forEach(t),Y6=c(p3),So=l(p3,"LI",{});var u3=r(So);Af=l(u3,"CODE",{});var vU=r(Af);K6=n(vU,"stage3_max_reuse_distance"),vU.forEach(t),J6=n(u3,": "),Sf=l(u3,"CODE",{});var jU=r(Sf);X6=n(jU,"1e9"),jU.forEach(t),u3.forEach(t),p3.forEach(t),qg=c(e),S=l(e,"P",{});var he=r(S);Q6=n(he,"If hitting OOM reduce "),Cf=l(he,"CODE",{});var gU=r(Cf);e9=n(gU,"stage3_max_live_parameters"),gU.forEach(t),s9=n(he," and "),xf=l(he,"CODE",{});var wU=r(xf);t9=n(wU,"stage3_max_reuse_distance"),wU.forEach(t),a9=n(he,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),If=l(he,"CODE",{});var yU=r(If);n9=n(yU,"1e9"),yU.forEach(t),o9=n(he,` would consume ~2GB. The memory is shared by
`),Rf=l(he,"CODE",{});var bU=r(Rf);l9=n(bU,"stage3_max_live_parameters"),bU.forEach(t),r9=n(he," and "),Uf=l(he,"CODE",{});var qU=r(Uf);p9=n(qU,"stage3_max_reuse_distance"),qU.forEach(t),i9=n(he,", so it\u2019s not additive, it\u2019s just 2GB total."),he.forEach(t),Eg=c(e),je=l(e,"P",{});var Ur=r(je);Lf=l(Ur,"CODE",{});var EU=r(Lf);u9=n(EU,"stage3_max_live_parameters"),EU.forEach(t),c9=n(Ur,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Zf=l(Ur,"CODE",{});var $U=r(Zf);h9=n($U,"stage3_max_reuse_distance"),$U.forEach(t),f9=n(Ur,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Gf=l(Ur,"CODE",{});var kU=r(Gf);d9=n(kU,"stage3_max_reuse_distance"),kU.forEach(t),m9=n(Ur,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ur.forEach(t),$g=c(e),ai=l(e,"P",{});var DU=r(ai);_9=n(DU,"The following configuration values depend on the model\u2019s hidden size:"),DU.forEach(t),kg=c(e),Ie=l(e,"UL",{});var uc=r(Ie);Co=l(uc,"LI",{});var c3=r(Co);Mf=l(c3,"CODE",{});var PU=r(Mf);v9=n(PU,"reduce_bucket_size"),PU.forEach(t),j9=n(c3,": "),Nf=l(c3,"CODE",{});var OU=r(Nf);g9=n(OU,"hidden_size*hidden_size"),OU.forEach(t),c3.forEach(t),w9=c(uc),xo=l(uc,"LI",{});var h3=r(xo);Hf=l(h3,"CODE",{});var zU=r(Hf);y9=n(zU,"stage3_prefetch_bucket_size"),zU.forEach(t),b9=n(h3,": "),Wf=l(h3,"CODE",{});var TU=r(Wf);q9=n(TU,"0.9 * hidden_size * hidden_size"),TU.forEach(t),h3.forEach(t),E9=c(uc),Io=l(uc,"LI",{});var f3=r(Io);Ff=l(f3,"CODE",{});var AU=r(Ff);$9=n(AU,"stage3_param_persistence_threshold"),AU.forEach(t),k9=n(f3,": "),Bf=l(f3,"CODE",{});var SU=r(Bf);D9=n(SU,"10 * hidden_size"),SU.forEach(t),f3.forEach(t),uc.forEach(t),Dg=c(e),Re=l(e,"P",{});var cc=r(Re);P9=n(cc,"therefore set these values to "),Vf=l(cc,"CODE",{});var CU=r(Vf);O9=n(CU,"auto"),CU.forEach(t),z9=n(cc," and the "),ni=l(cc,"A",{href:!0});var xU=r(ni);T9=n(xU,"Trainer"),xU.forEach(t),A9=n(cc,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),cc.forEach(t),Pg=c(e),Ro=l(e,"P",{});var MC=r(Ro);Yf=l(MC,"CODE",{});var IU=r(Yf);S9=n(IU,"stage3_gather_fp16_weights_on_model_save"),IU.forEach(t),C9=n(MC,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),MC.forEach(t),Og=c(e),ee=l(e,"P",{});var _n=r(ee);x9=n(_n,"If you\u2019re migrating from ZeRO-2 configuration note that "),Kf=l(_n,"CODE",{});var RU=r(Kf);I9=n(RU,"allgather_partitions"),RU.forEach(t),R9=n(_n,", "),Jf=l(_n,"CODE",{});var UU=r(Jf);U9=n(UU,"allgather_bucket_size"),UU.forEach(t),L9=n(_n,` and
`),Xf=l(_n,"CODE",{});var LU=r(Xf);Z9=n(LU,"reduce_scatter"),LU.forEach(t),G9=n(_n,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),_n.forEach(t),zg=c(e),oi=l(e,"UL",{});var ZU=r(oi);Uo=l(ZU,"LI",{});var d3=r(Uo);Qf=l(d3,"CODE",{});var GU=r(Qf);M9=n(GU,"sub_group_size"),GU.forEach(t),N9=n(d3,": "),ed=l(d3,"CODE",{});var MU=r(ed);H9=n(MU,"1e9"),MU.forEach(t),d3.forEach(t),ZU.forEach(t),Tg=c(e),ge=l(e,"P",{});var Lr=r(ge);sd=l(Lr,"CODE",{});var NU=r(sd);W9=n(NU,"sub_group_size"),NU.forEach(t),F9=n(Lr,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),td=l(Lr,"CODE",{});var HU=r(td);B9=n(HU,"sub_group_size"),HU.forEach(t),V9=n(Lr,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),ad=l(Lr,"CODE",{});var WU=r(ad);Y9=n(WU,"sub_group_size"),WU.forEach(t),K9=n(Lr,` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Lr.forEach(t),Ag=c(e),Ue=l(e,"P",{});var hc=r(Ue);J9=n(hc,"You can leave "),nd=l(hc,"CODE",{});var FU=r(nd);X9=n(FU,"sub_group_size"),FU.forEach(t),Q9=n(hc," to its default value of "),od=l(hc,"EM",{});var BU=r(od);e7=n(BU,"1e9"),BU.forEach(t),s7=n(hc,` when not using NVMe offload. You may want to change its
default value in the following cases:`),hc.forEach(t),Sg=c(e),Vt=l(e,"OL",{});var m3=r(Vt);Lo=l(m3,"LI",{});var _3=r(Lo);t7=n(_3,"Running into OOM during optimizer step: Reduce "),ld=l(_3,"CODE",{});var VU=r(ld);a7=n(VU,"sub_group_size"),VU.forEach(t),n7=n(_3," to reduce memory utilization of temporary buffers"),_3.forEach(t),o7=c(m3),Zo=l(m3,"LI",{});var v3=r(Zo);l7=n(v3,"Optimizer Step is taking a long time: Increase "),rd=l(v3,"CODE",{});var YU=r(rd);r7=n(YU,"sub_group_size"),YU.forEach(t),p7=n(v3,` to improve bandwidth utilization as a result of
the increased data buffers.`),v3.forEach(t),m3.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Os=l(e,"H3",{class:!0});var j3=r(Os);Yt=l(j3,"A",{id:!0,class:!0,href:!0});var KU=r(Yt);pd=l(KU,"SPAN",{});var JU=r(pd);d(Go.$$.fragment,JU),JU.forEach(t),KU.forEach(t),i7=c(j3),id=l(j3,"SPAN",{});var XU=r(id);u7=n(XU,"NVMe Support"),XU.forEach(t),j3.forEach(t),Ig=c(e),ri=l(e,"P",{});var QU=r(ri);c7=n(QU,`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
smart partitioning and tiling algorithms each GPU needs to send and receive very small amounts of data during
offloading so modern NVMe proved to be fit to allow for an even larger total memory pool available to your training
process. ZeRO-Infinity requires ZeRO-3 enabled.`),QU.forEach(t),Rg=c(e),pi=l(e,"P",{});var eL=r(pi);h7=n(eL,"The following configuration example enables NVMe to offload both optimizer states and the params:"),eL.forEach(t),Ug=c(e),d(Mo.$$.fragment,e),Lg=c(e),Kt=l(e,"P",{});var g3=r(Kt);f7=n(g3,`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),ud=l(g3,"EM",{});var sL=r(ud);d7=n(sL,"\u201Cdevice\u201D: \u201Ccpu\u201D"),sL.forEach(t),m7=n(g3,")."),g3.forEach(t),Zg=c(e),Le=l(e,"P",{});var fc=r(Le);_7=n(fc,"Here is the full documentation for offloading "),No=l(fc,"A",{href:!0,rel:!0});var tL=r(No);v7=n(tL,"optimizer states"),tL.forEach(t),j7=n(fc," and "),Ho=l(fc,"A",{href:!0,rel:!0});var aL=r(Ho);g7=n(aL,"parameters"),aL.forEach(t),w7=n(fc,"."),fc.forEach(t),Gg=c(e),Jt=l(e,"P",{});var w3=r(Jt);y7=n(w3,"Make sure that your "),cd=l(w3,"CODE",{});var nL=r(cd);b7=n(nL,"nvme_path"),nL.forEach(t),q7=n(w3,` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),w3.forEach(t),Mg=c(e),Ze=l(e,"P",{});var dc=r(Ze);E7=n(dc,"In order to figure out the optimal "),hd=l(dc,"CODE",{});var oL=r(hd);$7=n(oL,"aio"),oL.forEach(t),k7=n(dc,` configuration block you must run a benchmark on your target setup, as
`),Wo=l(dc,"A",{href:!0,rel:!0});var lL=r(Wo);D7=n(lL,"explained here"),lL.forEach(t),P7=n(dc,"."),dc.forEach(t),Ng=c(e),ii=l(e,"A",{id:!0}),r(ii).forEach(t),Hg=c(e),zs=l(e,"H4",{class:!0});var y3=r(zs);Xt=l(y3,"A",{id:!0,class:!0,href:!0});var rL=r(Xt);fd=l(rL,"SPAN",{});var pL=r(fd);d(Fo.$$.fragment,pL),pL.forEach(t),rL.forEach(t),O7=c(y3),dd=l(y3,"SPAN",{});var iL=r(dd);z7=n(iL,"ZeRO-2 vs ZeRO-3 Performance"),iL.forEach(t),y3.forEach(t),Wg=c(e),ui=l(e,"P",{});var uL=r(ui);T7=n(uL,`ZeRO-3 is likely to be slower than ZeRO-2 if everything else is configured the same because the former has to gather
model weights in addition to what ZeRO-2 does. If ZeRO-2 meets your needs and you don\u2019t need to scale beyond a few GPUs
then you may choose to stick to it. It\u2019s important to understand that ZeRO-3 enables a much higher scalability capacity
at a cost of speed.`),uL.forEach(t),Fg=c(e),ci=l(e,"P",{});var cL=r(ci);A7=n(cL,"It\u2019s possible to adjust ZeRO-3 configuration to make it perform closer to ZeRO-2:"),cL.forEach(t),Bg=c(e),Qt=l(e,"UL",{});var b3=r(Qt);Ts=l(b3,"LI",{});var mc=r(Ts);S7=n(mc,"set "),md=l(mc,"CODE",{});var hL=r(md);C7=n(hL,"stage3_param_persistence_threshold"),hL.forEach(t),x7=n(mc," to a very large number - larger than the largest parameter, e.g., "),_d=l(mc,"CODE",{});var fL=r(_d);I7=n(fL,"6 * hidden_size * hidden_size"),fL.forEach(t),R7=n(mc,". This will keep the parameters on the GPUs."),mc.forEach(t),U7=c(b3),Bo=l(b3,"LI",{});var q3=r(Bo);L7=n(q3,"turn off "),vd=l(q3,"CODE",{});var dL=r(vd);Z7=n(dL,"offload_params"),dL.forEach(t),G7=n(q3," since ZeRO-2 doesn\u2019t have that option."),q3.forEach(t),b3.forEach(t),Vg=c(e),Ge=l(e,"P",{});var _c=r(Ge);M7=n(_c,"The performance will likely improve significantly with just "),jd=l(_c,"CODE",{});var mL=r(jd);N7=n(mL,"offload_params"),mL.forEach(t),H7=n(_c,` turned off, even if you don\u2019t change
`),gd=l(_c,"CODE",{});var _L=r(gd);W7=n(_L,"stage3_param_persistence_threshold"),_L.forEach(t),F7=n(_c,`. Of course, these changes will impact the size of the model you can train. So
these help you to trade scalability for speed depending on your needs.`),_c.forEach(t),Yg=c(e),hi=l(e,"A",{id:!0}),r(hi).forEach(t),Kg=c(e),As=l(e,"H4",{class:!0});var E3=r(As);ea=l(E3,"A",{id:!0,class:!0,href:!0});var vL=r(ea);wd=l(vL,"SPAN",{});var jL=r(wd);d(Vo.$$.fragment,jL),jL.forEach(t),vL.forEach(t),B7=c(E3),yd=l(E3,"SPAN",{});var gL=r(yd);V7=n(gL,"ZeRO-2 Example"),gL.forEach(t),E3.forEach(t),Jg=c(e),sa=l(e,"P",{});var $3=r(sa);Y7=n($3,"Here is a full ZeRO-2 auto-configuration file "),bd=l($3,"CODE",{});var wL=r(bd);K7=n(wL,"ds_config_zero2.json"),wL.forEach(t),J7=n($3,":"),$3.forEach(t),Xg=c(e),d(Yo.$$.fragment,e),Qg=c(e),ta=l(e,"P",{});var k3=r(ta);X7=n(k3,`Here is a full ZeRO-2 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),qd=l(k3,"CODE",{});var yL=r(qd);Q7=n(yL,"auto"),yL.forEach(t),e8=n(k3," settings in it."),k3.forEach(t),ew=c(e),d(Ko.$$.fragment,e),sw=c(e),fi=l(e,"A",{id:!0}),r(fi).forEach(t),tw=c(e),Ss=l(e,"H4",{class:!0});var D3=r(Ss);aa=l(D3,"A",{id:!0,class:!0,href:!0});var bL=r(aa);Ed=l(bL,"SPAN",{});var qL=r(Ed);d(Jo.$$.fragment,qL),qL.forEach(t),bL.forEach(t),s8=c(D3),$d=l(D3,"SPAN",{});var EL=r($d);t8=n(EL,"ZeRO-3 Example"),EL.forEach(t),D3.forEach(t),aw=c(e),na=l(e,"P",{});var P3=r(na);a8=n(P3,"Here is a full ZeRO-3 auto-configuration file "),kd=l(P3,"CODE",{});var $L=r(kd);n8=n($L,"ds_config_zero3.json"),$L.forEach(t),o8=n(P3,":"),P3.forEach(t),nw=c(e),d(Xo.$$.fragment,e),ow=c(e),oa=l(e,"P",{});var O3=r(oa);l8=n(O3,`Here is a full ZeRO-3 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),Dd=l(O3,"CODE",{});var kL=r(Dd);r8=n(kL,"auto"),kL.forEach(t),p8=n(O3," settings in it."),O3.forEach(t),lw=c(e),d(Qo.$$.fragment,e),rw=c(e),Cs=l(e,"H3",{class:!0});var z3=r(Cs);la=l(z3,"A",{id:!0,class:!0,href:!0});var DL=r(la);Pd=l(DL,"SPAN",{});var PL=r(Pd);d(el.$$.fragment,PL),PL.forEach(t),DL.forEach(t),i8=c(z3),Od=l(z3,"SPAN",{});var OL=r(Od);u8=n(OL,"Optimizer and Scheduler"),OL.forEach(t),z3.forEach(t),pw=c(e),ra=l(e,"P",{});var T3=r(ra);c8=n(T3,"As long as you don\u2019t enable "),zd=l(T3,"CODE",{});var zL=r(zd);h8=n(zL,"offload_optimizer"),zL.forEach(t),f8=n(T3,` you can mix and match DeepSpeed and HuggingFace schedulers and
optimizers, with the exception of using the combination of HuggingFace scheduler and DeepSpeed optimizer:`),T3.forEach(t),iw=c(e),di=l(e,"P",{});var TL=r(di);d8=n(TL,`| Combos       | HF Scheduler | DS Scheduler |
| HF Optimizer | Yes          | Yes          |
| DS Optimizer | No           | Yes          |`),TL.forEach(t),uw=c(e),pa=l(e,"P",{});var A3=r(pa);m8=n(A3,"It is possible to use a non-DeepSpeed optimizer when "),Td=l(A3,"CODE",{});var AL=r(Td);_8=n(AL,"offload_optimizer"),AL.forEach(t),v8=n(A3,` is enabled, as long as it has both CPU and
GPU implementation (except LAMB).`),A3.forEach(t),cw=c(e),mi=l(e,"A",{id:!0}),r(mi).forEach(t),hw=c(e),xs=l(e,"H4",{class:!0});var S3=r(xs);ia=l(S3,"A",{id:!0,class:!0,href:!0});var SL=r(ia);Ad=l(SL,"SPAN",{});var CL=r(Ad);d(sl.$$.fragment,CL),CL.forEach(t),SL.forEach(t),j8=c(S3),Sd=l(S3,"SPAN",{});var xL=r(Sd);g8=n(xL,"Optimizer"),xL.forEach(t),S3.forEach(t),fw=c(e),Me=l(e,"P",{});var vc=r(Me);w8=n(vc,`DeepSpeed\u2019s main optimizers are Adam, AdamW, OneBitAdam, and Lamb. These have been thoroughly tested with ZeRO and are
thus recommended to be used. It, however, can import other optimizers from `),Cd=l(vc,"CODE",{});var IL=r(Cd);y8=n(IL,"torch"),IL.forEach(t),b8=n(vc,". The full documentation is "),tl=l(vc,"A",{href:!0,rel:!0});var RL=r(tl);q8=n(RL,"here"),RL.forEach(t),E8=n(vc,"."),vc.forEach(t),dw=c(e),q=l(e,"P",{});var P=r(q);$8=n(P,"If you don\u2019t configure the "),xd=l(P,"CODE",{});var UL=r(xd);k8=n(UL,"optimizer"),UL.forEach(t),D8=n(P," entry in the configuration file, the "),_i=l(P,"A",{href:!0});var LL=r(_i);P8=n(LL,"Trainer"),LL.forEach(t),O8=n(P,` will
automatically set it to `),Id=l(P,"CODE",{});var ZL=r(Id);z8=n(ZL,"AdamW"),ZL.forEach(t),T8=n(P,` and will use the supplied values or the defaults for the following command line
arguments: `),Rd=l(P,"CODE",{});var GL=r(Rd);A8=n(GL,"--learning_rate"),GL.forEach(t),S8=n(P,", "),Ud=l(P,"CODE",{});var ML=r(Ud);C8=n(ML,"--adam_beta1"),ML.forEach(t),x8=n(P,", "),Ld=l(P,"CODE",{});var NL=r(Ld);I8=n(NL,"--adam_beta2"),NL.forEach(t),R8=n(P,", "),Zd=l(P,"CODE",{});var HL=r(Zd);U8=n(HL,"--adam_epsilon"),HL.forEach(t),L8=n(P," and "),Gd=l(P,"CODE",{});var WL=r(Gd);Z8=n(WL,"--weight_decay"),WL.forEach(t),G8=n(P,"."),P.forEach(t),mw=c(e),Ne=l(e,"P",{});var jc=r(Ne);M8=n(jc,"Here is an example of the auto-configured "),Md=l(jc,"CODE",{});var FL=r(Md);N8=n(FL,"optimizer"),FL.forEach(t),H8=n(jc," entry for "),Nd=l(jc,"CODE",{});var BL=r(Nd);W8=n(BL,"AdamW"),BL.forEach(t),F8=n(jc,":"),jc.forEach(t),_w=c(e),d(al.$$.fragment,e),vw=c(e),vi=l(e,"P",{});var VL=r(vi);B8=n(VL,`Note that the command line arguments will set the values in the configuration file. This is so that there is one
definitive source of the values and to avoid hard to find errors when for example, the learning rate is set to
different values in different places. Command line rules. The values that get overridden are:`),VL.forEach(t),jw=c(e),se=l(e,"UL",{});var vn=r(se);nl=l(vn,"LI",{});var C3=r(nl);Hd=l(C3,"CODE",{});var YL=r(Hd);V8=n(YL,"lr"),YL.forEach(t),Y8=n(C3," with the value of "),Wd=l(C3,"CODE",{});var KL=r(Wd);K8=n(KL,"--learning_rate"),KL.forEach(t),C3.forEach(t),J8=c(vn),ol=l(vn,"LI",{});var x3=r(ol);Fd=l(x3,"CODE",{});var JL=r(Fd);X8=n(JL,"betas"),JL.forEach(t),Q8=n(x3," with the value of "),Bd=l(x3,"CODE",{});var XL=r(Bd);ek=n(XL,"--adam_beta1 --adam_beta2"),XL.forEach(t),x3.forEach(t),sk=c(vn),ll=l(vn,"LI",{});var I3=r(ll);Vd=l(I3,"CODE",{});var QL=r(Vd);tk=n(QL,"eps"),QL.forEach(t),ak=n(I3," with the value of "),Yd=l(I3,"CODE",{});var eZ=r(Yd);nk=n(eZ,"--adam_epsilon"),eZ.forEach(t),I3.forEach(t),ok=c(vn),rl=l(vn,"LI",{});var R3=r(rl);Kd=l(R3,"CODE",{});var sZ=r(Kd);lk=n(sZ,"weight_decay"),sZ.forEach(t),rk=n(R3," with the value of "),Jd=l(R3,"CODE",{});var tZ=r(Jd);pk=n(tZ,"--weight_decay"),tZ.forEach(t),R3.forEach(t),vn.forEach(t),gw=c(e),ji=l(e,"P",{});var aZ=r(ji);ik=n(aZ,"Therefore please remember to tune the shared hyperparameters on the command line."),aZ.forEach(t),ww=c(e),gi=l(e,"P",{});var nZ=r(gi);uk=n(nZ,"You can also set the values explicitly:"),nZ.forEach(t),yw=c(e),d(pl.$$.fragment,e),bw=c(e),ua=l(e,"P",{});var U3=r(ua);ck=n(U3,"But then you\u2019re on your own synchronizing the "),wi=l(U3,"A",{href:!0});var oZ=r(wi);hk=n(oZ,"Trainer"),oZ.forEach(t),fk=n(U3,` command line arguments and the DeepSpeed
