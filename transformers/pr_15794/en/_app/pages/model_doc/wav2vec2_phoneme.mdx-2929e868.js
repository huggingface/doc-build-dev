import{S as Wt,i as Et,s as Vt,e as n,k as c,w as X,t as s,M as qt,c as r,d as t,m as l,a,x as j,h as i,b as p,F as o,g as h,y as Q,L as $t,q as Z,o as J,B as G}from"../../chunks/vendor-22ad994f.js";import{D as Qe}from"../../chunks/Docstring-3bc3620c.js";import{I as Ko}from"../../chunks/IconCopyLink-2eb9a001.js";function Lt(Ze){let v,K,_,g,ae,q,Je,se,Ge,ye,T,y,ie,$,Ke,ce,Ye,ze,z,eo,L,oo,to,Pe,Y,no,xe,ee,le,ro,Ce,oe,ao,We,u,de,so,io,pe,co,lo,F,po,te,ho,mo,uo,he,fo,_o,me,go,Ee,P,vo,I,ko,bo,Ve,A,To,B,wo,qe,x,yo,N,zo,Po,$e,C,xo,ue,Co,Wo,Le,w,W,fe,D,Eo,_e,Vo,Fe,m,S,qo,ge,$o,Lo,R,Fo,ne,Io,Ao,Bo,E,O,No,ve,Do,So,V,U,Ro,ke,Oo,Uo,k,M,Mo,be,Ho,Xo,H,jo,Te,Qo,Zo,Jo,we,Ie;return q=new Ko({}),$=new Ko({}),D=new Ko({}),S=new Qe({props:{name:"class transformers.Wav2Vec2PhonemeCTCTokenizer",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"phone_delimiter_token",val:" = ' '"},{name:"word_delimiter_token",val:" = None"},{name:"do_phonemize",val:" = True"},{name:"phonemizer_lang",val:" = 'en-us'"},{name:"phonemizer_backend",val:" = 'espeak'"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L87",parametersDescription:[{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),M=new Qe({props:{name:"decode",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.decode",parameters:[{name:"token_ids",val:": typing.Union[int, typing.List[int], ForwardRef('np.ndarray'), ForwardRef('torch.Tensor'), ForwardRef('tf.Tensor')]"},{name:"skip_special_tokens",val:": bool = False"},{name:"clean_up_tokenization_spaces",val:": bool = True"},{name:"output_char_offsets",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L430",parametersDescription:[{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.decode.token_ids",description:`<strong>token_ids</strong> (<code>Union[int, List[int], np.ndarray, torch.Tensor, tf.Tensor]</code>) &#x2014;
...
`}}),{c(){v=n("meta"),K=c(),_=n("h1"),g=n("a"),ae=n("span"),X(q.$$.fragment),Je=c(),se=n("span"),Ge=s("Wav2Vec2Phoneme"),ye=c(),T=n("h2"),y=n("a"),ie=n("span"),X($.$$.fragment),Ke=c(),ce=n("span"),Ye=s("Overview"),ze=c(),z=n("p"),eo=s("The Wav2Vec2Phoneme model was proposed in "),L=n("a"),oo=s(`Simple and Effective Zero-shot Cross-lingual Phoneme Recognition (Xu et al.,
...
tokens and clean up tokenization spaces.`),Xo=c(),H=n("p"),jo=s("Similar to doing "),Te=n("code"),Qo=s("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Zo=s("."),Jo=c(),we=n("div"),this.h()},l(e){const d=qt('[data-svelte="svelte-1phssyn"]',document.head);v=r(d,"META",{name:!0,content:!0}),d.forEach(t),K=l(e),_=r(e,"H1",{class:!0});var Ae=a(_);g=r(Ae,"A",{id:!0,class:!0,href:!0});var Yo=a(g);ae=r(Yo,"SPAN",{});var et=a(ae);j(q.$$.fragment,et),et.forEach(t),Yo.forEach(t),Je=l(Ae),se=r(Ae,"SPAN",{});var ot=a(se);Ge=i(ot,"Wav2Vec2Phoneme"),ot.forEach(t),Ae.forEach(t),ye=l(e),T=r(e,"H2",{class:!0});var Be=a(T);y=r(Be,"A",{id:!0,class:!0,href:!0});var tt=a(y);ie=r(tt,"SPAN",{});var nt=a(ie);j($.$$.fragment,nt),nt.forEach(t),tt.forEach(t),Ke=l(Be),ce=r(Be,"SPAN",{});var rt=a(ce);Ye=i(rt,"Overview"),rt.forEach(t),Be.forEach(t),ze=l(e),z=r(e,"P",{});var Ne=a(z);eo=i(Ne,"The Wav2Vec2Phoneme model was proposed in "),L=r(Ne,"A",{href:!0,rel:!0});var at=a(L);oo=i(at,`Simple and Effective Zero-shot Cross-lingual Phoneme Recognition (Xu et al.,
...
tokens and clean up tokenization spaces.`),xt.forEach(t),Xo=l(re),H=r(re,"P",{});var je=a(H);jo=i(je,"Similar to doing "),Te=r(je,"CODE",{});var Ct=a(Te);Qo=i(Ct,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Ct.forEach(t),Zo=i(je,"."),je.forEach(t),re.forEach(t),Jo=l(f),we=r(f,"DIV",{class:!0}),a(we).forEach(t),f.forEach(t),this.h()},h(){p(v,"name","hf:doc:metadata"),p(v,"content",JSON.stringify(Ft)),p(g,"id","wav2vec2phoneme"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#wav2vec2phoneme"),p(_,"class","relative group"),p(y,"id","overview"),p(y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(y,"href","#overview"),p(T,"class","relative group"),p(L,"href","https://arxiv.org/abs/2109.11680"),p(L,"rel","nofollow"),p(te,"href","/docs/transformers/pr_15794/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer"),p(I,"href","https://huggingface.co/models?other=phoneme-recognition"),p(I,"rel","nofollow"),p(B,"href","https://huggingface.co/patrickvonplaten"),p(B,"rel","nofollow"),p(N,"href","https://github.com/pytorch/fairseq/tree/master/fairseq/models/wav2vec"),p(N,"rel","nofollow"),p(W,"id","transformers.Wav2Vec2PhonemeCTCTokenizer"),p(W,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(W,"href","#transformers.Wav2Vec2PhonemeCTCTokenizer"),p(w,"class","relative group"),p(ne,"href","/docs/transformers/pr_15794/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(E,"class","docstring"),p(V,"class","docstring"),p(k,"class","docstring"),p(we,"class","docstring"),p(m,"class","docstring")},m(e,d){o(document.head,v),h(e,K,d),h(e,_,d),o(_,g),o(g,ae),Q(q,ae,null),o(_,Je),o(_,se),o(se,Ge),h(e,ye,d),h(e,T,d),o(T,y),o(y,ie),Q($,ie,null),o(T,Ke),o(T,ce),o(ce,Ye),h(e,ze,d),h(e,z,d),o(z,eo),o(z,L),o(L,oo),o(z,to),h(e,Pe,d),h(e,Y,d),o(Y,no),h(e,xe,d),h(e,ee,d),o(ee,le),o(le,ro),h(e,Ce,d),h(e,oe,d),o(oe,ao),h(e,We,d),h(e,u,d),o(u,de),o(de,so),o(u,io),o(u,pe),o(pe,co),o(u,lo),o(u,F),o(F,po),o(F,te),o(te,ho),o(F,mo),o(u,uo),o(u,he),o(he,fo),o(u,_o),o(u,me),o(me,go),h(e,Ee,d),h(e,P,d),o(P,vo),o(P,I),o(I,ko),o(P,bo),h(e,Ve,d),h(e,A,d),o(A,To),o(A,B),o(B,wo),h(e,qe,d),h(e,x,d),o(x,yo),o(x,N),o(N,zo),o(x,Po),h(e,$e,d),h(e,C,d),o(C,xo),o(C,ue),o(ue,Co),o(C,Wo),h(e,Le,d),h(e,w,d),o(w,W),o(W,fe),Q(D,fe,null),o(w,Eo),o(w,_e),o(_e,Vo),h(e,Fe,d),h(e,m,d),Q(S,m,null),o(m,qo),o(m,ge),o(ge,$o),o(m,Lo),o(m,R),o(R,Fo),o(R,ne),o(ne,Io),o(R,Ao),o(m,Bo),o(m,E),Q(O,E,null),o(E,No),o(E,ve),o(ve,Do),o(m,So),o(m,V),Q(U,V,null),o(V,Ro),o(V,ke),o(ke,Oo),o(m,Uo),o(m,k),Q(M,k,null),o(k,Mo),o(k,be),o(be,Ho),o(k,Xo),o(k,H),o(H,jo),o(H,Te),o(Te,Qo),o(H,Zo),o(m,Jo),o(m,we),Ie=!0},p:$t,i(e){Ie||(Z(q.$$.fragment,e),Z($.$$.fragment,e),Z(D.$$.fragment,e),Z(S.$$.fragment,e),Z(O.$$.fragment,e),Z(U.$$.fragment,e),Z(M.$$.fragment,e),Ie=!0)},o(e){J(q.$$.fragment,e),J($.$$.fragment,e),J(D.$$.fragment,e),J(S.$$.fragment,e),J(O.$$.fragment,e),J(U.$$.fragment,e),J(M.$$.fragment,e),Ie=!1},d(e){t(v),e&&t(K),e&&t(_),G(q),e&&t(ye),e&&t(T),G($),e&&t(ze),e&&t(z),e&&t(Pe),e&&t(Y),e&&t(xe),e&&t(ee),e&&t(Ce),e&&t(oe),e&&t(We),e&&t(u),e&&t(Ee),e&&t(P),e&&t(Ve),e&&t(A),e&&t(qe),e&&t(x),e&&t($e),e&&t(C),e&&t(Le),e&&t(w),G(D),e&&t(Fe),e&&t(m),G(S),G(O),G(U),G(M)}}}const Ft={local:"wav2vec2phoneme",sections:[{local:"overview",title:"Overview"},{local:"transformers.Wav2Vec2PhonemeCTCTokenizer",title:"Wav2Vec2PhonemeCTCTokenizer"}],title:"Wav2Vec2Phoneme"};function It(Ze,v,K){let{fw:_}=v;return Ze.$$set=g=>{"fw"in g&&K(0,_=g.fw)},[_]}class Dt extends Wt{constructor(v){super();Et(this,v,It,Lt,Vt,{fw:0})}}export{Dt as default,Ft as metadata};
