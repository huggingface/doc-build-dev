import{S as tp,i as np,s as op,e as a,k as l,w as g,t as o,M as sp,c as r,d as t,m as c,a as i,x as k,h as s,b as d,F as e,g as u,y,q as b,o as v,B as T}from"../../chunks/vendor-22ad994f.js";import{T as Ko}from"../../chunks/Tip-540f533b.js";import{D as K}from"../../chunks/Docstring-3bc3620c.js";import{C as In}from"../../chunks/CodeBlock-03069293.js";import{I as ze}from"../../chunks/IconCopyLink-2eb9a001.js";import"../../chunks/CopyButton-f539c482.js";function ap(O){let h,L,m,w,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),w=o("Module"),E=o(`
...
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var f=i(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(_){_&&t(h)}}}function cp(O){let h,L,m,w,E,_,f,z,Ds,Ro,le,xe,Sn,He,Bs,Nn,Ws,Ho,$e,Os,Ve,Us,Ks,Vo,Qt,Rs,Yo,Jt,Dn,Hs,Qo,Xt,Vs,Jo,R,Bn,Ye,Ys,Gt,Qs,Js,Xs,Wn,q,Gs,On,Zs,ea,Un,ta,na,Kn,oa,sa,Rn,aa,ra,Zt,ia,da,la,Qe,H,en,ca,pa,Hn,ha,ua,Vn,ma,fa,Yn,_a,ga,ka,Je,tn,Qn,ya,ba,va,nn,Jn,Ta,wa,La,U,Xn,Ea,za,ce,qe,on,xa,$a,Xe,qa,Ma,Ca,Me,sn,Fa,Pa,Ge,ja,Aa,Ia,an,rn,Sa,Na,Da,S,dn,Ba,Wa,Gn,Oa,Ua,Zn,Ka,Ra,eo,Ha,Va,to,Ya,Qa,Ja,pe,Xa,ln,Ga,Za,Ze,er,tr,nr,et,or,tt,sr,ar,Xo,cn,rr,Go,nt,Zo,V,ir,ot,dr,lr,st,cr,pr,at,hr,ur,es,he,Ce,no,rt,mr,oo,fr,ts,M,it,_r,dt,gr,pn,kr,yr,br,ue,vr,hn,Tr,wr,un,Lr,Er,zr,so,xr,$r,lt,ns,me,Fe,ao,ct,qr,ro,Mr,os,C,pt,Cr,io,Fr,Pr,x,jr,mn,Ar,Ir,fn,Sr,Nr,_n,Dr,Br,lo,Wr,Or,co,Ur,Kr,po,Rr,Hr,ho,Vr,Yr,Qr,Pe,ht,Jr,uo,Xr,Gr,mo,ss,fe,je,fo,ut,Zr,_o,ei,as,F,mt,ti,go,ni,oi,ft,si,gn,ai,ri,ii,_t,di,gt,li,ci,pi,N,kt,hi,_e,ui,kn,mi,fi,ko,_i,gi,ki,Ae,yi,yo,bi,vi,yt,rs,ge,Ie,bo,bt,Ti,vo,wi,is,P,vt,Li,To,Ei,zi,Tt,xi,yn,$i,qi,Mi,wt,Ci,Lt,Fi,Pi,ji,J,Et,Ai,ke,Ii,bn,Si,Ni,wo,Di,Bi,Wi,Se,ds,ye,Ne,Lo,zt,Oi,Eo,Ui,ls,j,xt,Ki,zo,Ri,Hi,$t,Vi,vn,Yi,Qi,Ji,qt,Xi,Mt,Gi,Zi,ed,D,Ct,td,be,nd,Tn,od,sd,xo,ad,rd,id,De,dd,$o,ld,cd,Ft,cs,ve,Be,qo,Pt,pd,Mo,hd,ps,A,jt,ud,Co,md,fd,At,_d,wn,gd,kd,yd,It,bd,St,vd,Td,wd,B,Nt,Ld,Te,Ed,Ln,zd,xd,Fo,$d,qd,Md,We,Cd,Po,Fd,Pd,Dt,hs,we,Oe,jo,Bt,jd,Ao,Ad,us,I,Wt,Id,Io,Sd,Nd,Ot,Dd,En,Bd,Wd,Od,Ut,Ud,Kt,Kd,Rd,Hd,W,Rt,Vd,Le,Yd,zn,Qd,Jd,So,Xd,Gd,Zd,Ue,el,No,tl,nl,Ht,ms;return _=new ze({}),He=new ze({}),nt=new In({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_15794/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_15794/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p><a
  href="/docs/transformers/pr_15794/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new ze({}),mt=new K({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kt=new K({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),bt=new ze({}),vt=new K({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L1132",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Et=new K({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"labels",val:" = None"},{name:"entity_labels",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Predicted <span class="hljs-keyword">class</span>: person`}}),Pt=new ze({}),jt=new K({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L1383",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new K({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Bt=new ze({}),Wt=new K({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L1503",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Rt=new K({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"entity_start_positions",val:" = None"},{name:"entity_end_positions",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15794/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
extractive and cloze-style question answering, entity typing, and relation classification.`),Vo=l(),Qt=a("p"),Rs=o("The abstract from the paper is the following:"),Yo=l(),Jt=a("p"),Dn=a("em"),Hs=o(`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
...
answering).`),Qo=l(),Xt=a("p"),Vs=o("Tips:"),Jo=l(),R=a("ul"),Bn=a("li"),Ye=a("p"),Ys=o("This implementation is the same as "),Gt=a("a"),Qs=o("RobertaModel"),Js=o(` with the addition of entity embeddings as well
...
`),Zt=a("a"),ia=o("LukeTokenizer"),da=o("."),la=l(),Qe=a("li"),H=a("p"),en=a("a"),ca=o("LukeTokenizer"),pa=o(" takes "),Hn=a("code"),ha=o("entities"),ua=o(" and "),Vn=a("code"),ma=o("entity_spans"),fa=o(` (character-based start and end
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),ka=l(),Je=a("ul"),tn=a("li"),Qn=a("em"),ya=o("Inputting [MASK] entities to compute entity representations"),ba=o(`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),va=l(),nn=a("li"),Jn=a("em"),Ta=o("Inputting Wikipedia entities to compute knowledge-enhanced token representations"),wa=o(`: LUKE learns rich information
...
This model places a linear head on top of the output entity representation.`),Ca=l(),Me=a("li"),sn=a("a"),Fa=o("LukeForEntityPairClassification"),Pa=o(`, for tasks to classify the relationship between two entities
...
`),to=a("code"),Ya=o('task="entity_span_classification"'),Qa=o(". Please refer to the example code of each head models."),Ja=l(),pe=a("p"),Xa=o("A demo notebook on how to fine-tune "),ln=a("a"),Ga=o("LukeForEntityPairClassification"),Za=o(` for relation
...
documentation from `),un=a("a"),Lr=o("PretrainedConfig"),Er=o(" for more information."),zr=l(),so=a("p"),xr=o("Examples:"),$r=l(),g(lt.$$.fragment),ns=l(),me=a("h2"),Fe=a("a"),ao=a("span"),g(ct.$$.fragment),qr=l(),ro=a("span"),Mr=o("LukeTokenizer"),os=l(),C=a("div"),g(pt.$$.fragment),Cr=l(),io=a("p"),Fr=o("Construct a LUKE tokenizer."),Pr=l(),x=a("p"),jr=o("This tokenizer inherits from "),mn=a("a"),Ar=o("RobertaTokenizer"),Ir=o(` which contains most of the main methods. Users should refer to
...
`),ho=a("code"),Vr=o("entity_position_ids"),Yr=o(" to be used by the LUKE model."),Qr=l(),Pe=a("div"),g(ht.$$.fragment),Jr=l(),uo=a("p"),Xr=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mi=l(),wt=a("p"),Ci=o("This model is also a PyTorch "),Lt=a("a"),Fi=o("torch.nn.Module"),Pi=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ji=l(),J=a("div"),g(Et.$$.fragment),Ai=l(),ke=a("p"),Ii=o("The "),bn=a("a"),Si=o("LukeForMaskedLM"),Ni=o(" forward method, overrides the "),wo=a("code"),Di=o("__call__"),Bi=o(" special method."),Wi=l(),g(Se.$$.fragment),ds=l(),ye=a("h2"),Ne=a("a"),Lo=a("span"),g(zt.$$.fragment),Oi=l(),Eo=a("span"),Ui=o("LukeForEntityClassification"),ls=l(),j=a("div"),g(xt.$$.fragment),Ki=l(),zo=a("p"),Ri=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Hi=l(),$t=a("p"),Vi=o("This model inherits from "),vn=a("a"),Yi=o("PreTrainedModel"),Qi=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ji=l(),qt=a("p"),Xi=o("This model is also a PyTorch "),Mt=a("a"),Gi=o("torch.nn.Module"),Zi=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ed=l(),D=a("div"),g(Ct.$$.fragment),td=l(),be=a("p"),nd=o("The "),Tn=a("a"),od=o("LukeForEntityClassification"),sd=o(" forward method, overrides the "),xo=a("code"),ad=o("__call__"),rd=o(" special method."),id=l(),g(De.$$.fragment),dd=l(),$o=a("p"),ld=o("Examples:"),cd=l(),g(Ft.$$.fragment),cs=l(),ve=a("h2"),Be=a("a"),qo=a("span"),g(Pt.$$.fragment),pd=l(),Mo=a("span"),hd=o("LukeForEntityPairClassification"),ps=l(),A=a("div"),g(jt.$$.fragment),ud=l(),Co=a("p"),md=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wd=l(),B=a("div"),g(Nt.$$.fragment),Ld=l(),Te=a("p"),Ed=o("The "),Ln=a("a"),zd=o("LukeForEntityPairClassification"),xd=o(" forward method, overrides the "),Fo=a("code"),$d=o("__call__"),qd=o(" special method."),Md=l(),g(We.$$.fragment),Cd=l(),Po=a("p"),Fd=o("Examples:"),Pd=l(),g(Dt.$$.fragment),hs=l(),we=a("h2"),Oe=a("a"),jo=a("span"),g(Bt.$$.fragment),jd=l(),Ao=a("span"),Ad=o("LukeForEntitySpanClassification"),us=l(),I=a("div"),g(Wt.$$.fragment),Id=l(),Io=a("p"),Sd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),hl.forEach(t),pl.forEach(t),Qo=c(n),Xt=r(n,"P",{});var ul=i(Xt);Vs=s(ul,"Tips:"),ul.forEach(t),Jo=c(n),R=r(n,"UL",{});var Ke=i(R);Bn=r(Ke,"LI",{});var ml=i(Bn);Ye=r(ml,"P",{});var _s=i(Ye);Ys=s(_s,"This implementation is the same as "),Gt=r(_s,"A",{href:!0});var fl=i(Gt);Qs=s(fl,"RobertaModel"),fl.forEach(t),Js=s(_s,` with the addition of entity embeddings as well
...
`),Zt=r(Y,"A",{href:!0});var vl=i(Zt);ia=s(vl,"LukeTokenizer"),vl.forEach(t),da=s(Y,"."),Y.forEach(t),_l.forEach(t),la=c(Ke),Qe=r(Ke,"LI",{});var gs=i(Qe);H=r(gs,"P",{});var Ee=i(H);en=r(Ee,"A",{href:!0});var Tl=i(en);ca=s(Tl,"LukeTokenizer"),Tl.forEach(t),pa=s(Ee," takes "),Hn=r(Ee,"CODE",{});var wl=i(Hn);ha=s(wl,"entities"),wl.forEach(t),ua=s(Ee," and "),Vn=r(Ee,"CODE",{});var Ll=i(Vn);ma=s(Ll,"entity_spans"),Ll.forEach(t),fa=s(Ee,` (character-based start and end
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),Ee.forEach(t),ka=c(gs),Je=r(gs,"UL",{});var ks=i(Je);tn=r(ks,"LI",{});var ol=i(tn);Qn=r(ol,"EM",{});var zl=i(Qn);ya=s(zl,"Inputting [MASK] entities to compute entity representations"),zl.forEach(t),ba=s(ol,`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),ol.forEach(t),va=c(ks),nn=r(ks,"LI",{});var sl=i(nn);Jn=r(sl,"EM",{});var xl=i(Jn);Ta=s(xl,"Inputting Wikipedia entities to compute knowledge-enhanced token representations"),xl.forEach(t),wa=s(sl,`: LUKE learns rich information
(or knowledge) about Wikipedia entities during pretraining and stores the information in its entity embedding. By
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
...
entity typing, e.g. the `),Xe=r(Oo,"A",{href:!0,rel:!0});var Ml=i(Xe);qa=s(Ml,"Open Entity dataset"),Ml.forEach(t),Ma=s(Oo,`.
This model places a linear head on top of the output entity representation.`),Oo.forEach(t),Ca=c(xn),Me=r(xn,"LI",{});var Uo=i(Me);sn=r(Uo,"A",{href:!0});var Cl=i(sn);Fa=s(Cl,"LukeForEntityPairClassification"),Cl.forEach(t),Pa=s(Uo,`, for tasks to classify the relationship between two entities
...
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),al.forEach(t),xn.forEach(t),Da=c(X),S=r(X,"P",{});var Q=i(S);dn=r(Q,"A",{href:!0});var jl=i(dn);Ba=s(jl,"LukeTokenizer"),jl.forEach(t),Wa=s(Q," has a "),Gn=r(Q,"CODE",{});var Al=i(Gn);Oa=s(Al,"task"),Al.forEach(t),Ua=s(Q,` argument, which enables you to easily create an input to these
head models by specifying `),Zn=r(Q,"CODE",{});var Il=i(Zn);Ka=s(Il,'task="entity_classification"'),Il.forEach(t),Ra=s(Q,", "),eo=r(Q,"CODE",{});var Sl=i(eo);Ha=s(Sl,'task="entity_pair_classification"'),Sl.forEach(t),Va=s(Q,`, or
`),to=r(Q,"CODE",{});var Nl=i(to);Ya=s(Nl,'task="entity_span_classification"'),Nl.forEach(t),Qa=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Ja=c(X),pe=r(X,"P",{});var $n=i(pe);Xa=s($n,"A demo notebook on how to fine-tune "),ln=r($n,"A",{href:!0});var Dl=i(ln);Ga=s(Dl,"LukeForEntityPairClassification"),Dl.forEach(t),Za=s($n,` for relation
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$s.forEach(t),Mi=c(ne),wt=r(ne,"P",{});var qs=i(wt);Ci=s(qs,"This model is also a PyTorch "),Lt=r(qs,"A",{href:!0,rel:!0});var Ec=i(Lt);Fi=s(Ec,"torch.nn.Module"),Ec.forEach(t),Pi=s(qs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qs.forEach(t),ji=c(ne),J=r(ne,"DIV",{class:!0});var Cn=i(J);k(Et.$$.fragment,Cn),Ai=c(Cn),ke=r(Cn,"P",{});var Fn=i(ke);Ii=s(Fn,"The "),bn=r(Fn,"A",{href:!0});var zc=i(bn);Si=s(zc,"LukeForMaskedLM"),zc.forEach(t),Ni=s(Fn," forward method, overrides the "),wo=r(Fn,"CODE",{});var xc=i(wo);Di=s(xc,"__call__"),xc.forEach(t),Bi=s(Fn," special method."),Fn.forEach(t),Wi=c(Cn),k(Se.$$.fragment,Cn),Cn.forEach(t),ne.forEach(t),ds=c(n),ye=r(n,"H2",{class:!0});var Ms=i(ye);Ne=r(Ms,"A",{id:!0,class:!0,href:!0});var $c=i(Ne);Lo=r($c,"SPAN",{});var qc=i(Lo);k(zt.$$.fragment,qc),qc.forEach(t),$c.forEach(t),Oi=c(Ms),Eo=r(Ms,"SPAN",{});var Mc=i(Eo);Ui=s(Mc,"LukeForEntityClassification"),Mc.forEach(t),Ms.forEach(t),ls=c(n),j=r(n,"DIV",{class:!0});var oe=i(j);k(xt.$$.fragment,oe),Ki=c(oe),zo=r(oe,"P",{});var Cc=i(zo);Ri=s(Cc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Cc.forEach(t),Hi=c(oe),$t=r(oe,"P",{});var Cs=i($t);Vi=s(Cs,"This model inherits from "),vn=r(Cs,"A",{href:!0});var Fc=i(vn);Yi=s(Fc,"PreTrainedModel"),Fc.forEach(t),Qi=s(Cs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cs.forEach(t),Ji=c(oe),qt=r(oe,"P",{});var Fs=i(qt);Xi=s(Fs,"This model is also a PyTorch "),Mt=r(Fs,"A",{href:!0,rel:!0});var Pc=i(Mt);Gi=s(Pc,"torch.nn.Module"),Pc.forEach(t),Zi=s(Fs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fs.forEach(t),ed=c(oe),D=r(oe,"DIV",{class:!0});var se=i(D);k(Ct.$$.fragment,se),td=c(se),be=r(se,"P",{});var Pn=i(be);nd=s(Pn,"The "),Tn=r(Pn,"A",{href:!0});var jc=i(Tn);od=s(jc,"LukeForEntityClassification"),jc.forEach(t),sd=s(Pn," forward method, overrides the "),xo=r(Pn,"CODE",{});var Ac=i(xo);ad=s(Ac,"__call__"),Ac.forEach(t),rd=s(Pn," special method."),Pn.forEach(t),id=c(se),k(De.$$.fragment,se),dd=c(se),$o=r(se,"P",{});var Ic=i($o);ld=s(Ic,"Examples:"),Ic.forEach(t),cd=c(se),k(Ft.$$.fragment,se),se.forEach(t),oe.forEach(t),cs=c(n),ve=r(n,"H2",{class:!0});var Ps=i(ve);Be=r(Ps,"A",{id:!0,class:!0,href:!0});var Sc=i(Be);qo=r(Sc,"SPAN",{});var Nc=i(qo);k(Pt.$$.fragment,Nc),Nc.forEach(t),Sc.forEach(t),pd=c(Ps),Mo=r(Ps,"SPAN",{});var Dc=i(Mo);hd=s(Dc,"LukeForEntityPairClassification"),Dc.forEach(t),Ps.forEach(t),ps=c(n),A=r(n,"DIV",{class:!0});var ae=i(A);k(jt.$$.fragment,ae),ud=c(ae),Co=r(ae,"P",{});var Bc=i(Co);md=s(Bc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),As.forEach(t),wd=c(ae),B=r(ae,"DIV",{class:!0});var re=i(B);k(Nt.$$.fragment,re),Ld=c(re),Te=r(re,"P",{});var jn=i(Te);Ed=s(jn,"The "),Ln=r(jn,"A",{href:!0});var Uc=i(Ln);zd=s(Uc,"LukeForEntityPairClassification"),Uc.forEach(t),xd=s(jn," forward method, overrides the "),Fo=r(jn,"CODE",{});var Kc=i(Fo);$d=s(Kc,"__call__"),Kc.forEach(t),qd=s(jn," special method."),jn.forEach(t),Md=c(re),k(We.$$.fragment,re),Cd=c(re),Po=r(re,"P",{});var Rc=i(Po);Fd=s(Rc,"Examples:"),Rc.forEach(t),Pd=c(re),k(Dt.$$.fragment,re),re.forEach(t),ae.forEach(t),hs=c(n),we=r(n,"H2",{class:!0});var Is=i(we);Oe=r(Is,"A",{id:!0,class:!0,href:!0});var Hc=i(Oe);jo=r(Hc,"SPAN",{});var Vc=i(jo);k(Bt.$$.fragment,Vc),Vc.forEach(t),Hc.forEach(t),jd=c(Is),Ao=r(Is,"SPAN",{});var Yc=i(Ao);Ad=s(Yc,"LukeForEntitySpanClassification"),Yc.forEach(t),Is.forEach(t),us=c(n),I=r(n,"DIV",{class:!0});var ie=i(I);k(Wt.$$.fragment,ie),Id=c(ie),Io=r(ie,"P",{});var Qc=i(Io);Sd=s(Qc,`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
such as named entity recognition.`),Qc.forEach(t),Nd=c(ie),Ot=r(ie,"P",{});var Ss=i(Ot);Dd=s(Ss,"This model inherits from "),En=r(Ss,"A",{href:!0});var Jc=i(En);Bd=s(Jc,"PreTrainedModel"),Jc.forEach(t),Wd=s(Ss,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
