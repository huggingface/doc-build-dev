import{S as Pc,i as xc,s as Sc,e as a,k as l,w,t as n,M as jc,c as r,d as t,m as d,a as i,x as L,h as s,b as c,F as e,g as u,y as $,q as R,o as M,B as E}from"../../chunks/vendor-22ad994f.js";import{T as wt}from"../../chunks/Tip-540f533b.js";import{D as Ie}from"../../chunks/Docstring-3bc3620c.js";import{C as Vt}from"../../chunks/CodeBlock-03069293.js";import{I as it}from"../../chunks/IconCopyLink-2eb9a001.js";import"../../chunks/CopyButton-f539c482.js";function Ic(B){let h,C,m,g,v;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,C),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Nc(B){let h,C,m,g,v;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,C),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Dc(B){let h,C,m,g,v;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,C),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Ac(B){let h,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,x,S,Z,oe,F,q,Te,U,pe,ne,V,he,se,z,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){h=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
...
tensors in the first argument of the model call function: `),H=r(N,"CODE",{});var He=i(H);_e=s(He,"model(inputs)"),He.forEach(t),ce=s(N,"."),N.forEach(t),x=d(p),S=r(p,"P",{});var Oe=i(S);Z=s(Oe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Oe.forEach(t),oe=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);pe=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Ee=i(V);he=s(Ee,"model(inputs_ids)"),Ee.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(p,k){u(p,h,k),e(h,C),u(p,m,k),u(p,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,me),u(p,Q,k),u(p,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(p,x,k),u(p,S,k),e(S,Z),u(p,oe,k),u(p,F,k),e(F,q),e(q,Te),e(q,U),e(U,pe),e(q,ne),e(q,V),e(V,he),e(F,se),e(F,z),e(z,ve),e(z,O),e(O,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Q),p&&t(b),p&&t(x),p&&t(S),p&&t(oe),p&&t(F)}}}function Hc(B){let h,C,m,g,v;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,C),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Oc(B){let h,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,x,S,Z,oe,F,q,Te,U,pe,ne,V,he,se,z,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){h=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),he=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var k=i(h);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(p),g=r(p,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);me=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(p),b=r(p,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),Oe.forEach(t),oe=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);pe=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Ee=i(V);he=s(Ee,"model(inputs_ids)"),Ee.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(p,k){u(p,h,k),e(h,C),u(p,m,k),u(p,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,me),u(p,Q,k),u(p,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(p,x,k),u(p,S,k),e(S,Z),u(p,oe,k),u(p,F,k),e(F,q),e(q,Te),e(q,U),e(U,pe),e(q,ne),e(q,V),e(V,he),e(F,se),e(F,z),e(z,ve),e(z,O),e(O,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Q),p&&t(b),p&&t(x),p&&t(S),p&&t(oe),p&&t(F)}}}function Wc(B){let h,C,m,g,v;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,C),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Bc(B){let h,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,x,S,Z,oe,F,q,Te,U,pe,ne,V,he,se,z,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){h=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),he=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var k=i(h);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(p),g=r(p,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);me=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(p),b=r(p,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),Oe.forEach(t),oe=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);pe=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Ee=i(V);he=s(Ee,"model(inputs_ids)"),Ee.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(p,k){u(p,h,k),e(h,C),u(p,m,k),u(p,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,me),u(p,Q,k),u(p,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(p,x,k),u(p,S,k),e(S,Z),u(p,oe,k),u(p,F,k),e(F,q),e(q,Te),e(q,U),e(U,pe),e(q,ne),e(q,V),e(V,he),e(F,se),e(F,z),e(z,ve),e(z,O),e(O,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Q),p&&t(b),p&&t(x),p&&t(S),p&&t(oe),p&&t(F)}}}function Uc(B){let h,C,m,g,v;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,C),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Vc(B){let h,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,x,S,Z,oe,F,q,Te,U,pe,ne,V,he,se,z,ve,O,ae,ke,W,j,ee,I,te,G,Ce,p,k,re,Ae,ue,N,Me,He,Oe,D,P,We,Ee,K,Be,Fe,be,Ue,Ko,la,da,Cs,Je,ca,Gt,pa,ha,Kt,ua,fa,bs,lt,Lt,wn,Xt,ma,Ln,ga,ys,ye,Jt,_a,Xe,Ta,Xo,va,ka,Jo,Ca,ba,Qt,ya,wa,La,dt,$a,Qo,Ra,Ma,Yo,Ea,Fa,qa,$n,za,Pa,Yt,ws,ct,$t,Rn,Zt,xa,Mn,Sa,Ls,Ne,eo,ja,En,Ia,Na,to,Da,Zo,Aa,Ha,Oa,Fn,$s,pt,Rt,qn,oo,Wa,zn,Ba,Rs,we,no,Ua,Pn,Va,Ga,so,Ka,en,Xa,Ja,Qa,ao,Ya,ro,Za,er,tr,qe,io,or,ht,nr,tn,sr,ar,xn,rr,ir,lr,Mt,dr,Sn,cr,pr,lo,Ms,ut,Et,jn,co,hr,In,ur,Es,Le,po,fr,Nn,mr,gr,ho,_r,on,Tr,vr,kr,uo,Cr,fo,br,yr,wr,ze,mo,Lr,ft,$r,nn,Rr,Mr,Dn,Er,Fr,qr,Ft,zr,An,Pr,xr,go,Fs,mt,qt,Hn,_o,Sr,On,jr,qs,$e,To,Ir,Re,Nr,sn,Dr,Ar,Wn,Hr,Or,Bn,Wr,Br,Un,Ur,Vr,Vn,Gr,Kr,Xr,vo,Jr,an,Qr,Yr,Zr,ko,ei,Co,ti,oi,ni,ie,bo,si,gt,ai,rn,ri,ii,Gn,li,di,ci,zt,pi,Kn,hi,ui,yo,fi,Xn,mi,gi,wo,zs,_t,Pt,Jn,Lo,_i,Qn,Ti,Ps,le,$o,vi,Yn,ki,Ci,Ro,bi,ln,yi,wi,Li,Mo,$i,Eo,Ri,Mi,Ei,xt,Fi,Pe,Fo,qi,Tt,zi,dn,Pi,xi,Zn,Si,ji,Ii,St,Ni,es,Di,Ai,qo,xs,vt,jt,ts,zo,Hi,os,Oi,Ss,de,Po,Wi,ns,Bi,Ui,xo,Vi,cn,Gi,Ki,Xi,So,Ji,jo,Qi,Yi,Zi,It,el,xe,Io,tl,kt,ol,pn,nl,sl,ss,al,rl,il,Nt,ll,as,dl,cl,No,js,Ct,Dt,rs,Do,pl,is,hl,Is,X,Ao,ul,ls,fl,ml,hn,un,gl,_l,Tl,De,vl,ds,kl,Cl,cs,bl,yl,ps,wl,Ll,hs,$l,Rl,Ml,Ho,El,fn,Fl,ql,zl,Oo,Pl,Wo,xl,Sl,jl,At,Il,Se,Bo,Nl,bt,Dl,mn,Al,Hl,us,Ol,Wl,Bl,Ht,Ul,fs,Vl,Gl,Uo,Ns;return T=new it({}),Y=new it({}),Xt=new it({}),Jt=new Ie({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),io=new Ie({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/modeling_ctrl.py#L354",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15794/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_15794/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15794/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15794/en/model_doc/ctrl#transformers.CTRLConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),co=new it({}),po=new Ie({props:{name:"class transformers.CTRLLMHeadModel",anchor:"transformers.CTRLLMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/modeling_ctrl.py#L494",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15794/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),mo=new Ie({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/modeling_ctrl.py#L516",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_15794/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xt=new wt({props:{$$slots:{default:[Ac]},$$scope:{ctx:B}}}),Fo=new Ie({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/modeling_tf_ctrl.py#L542",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_15794/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),It=new wt({props:{$$slots:{default:[Oc]},$$scope:{ctx:B}}}),Io=new Ie({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/modeling_tf_ctrl.py#L669",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_15794/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15794/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),At=new wt({props:{$$slots:{default:[Bc]},$$scope:{ctx:B}}}),Bo=new Ie({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15794/src/transformers/models/ctrl/modeling_tf_ctrl.py#L792",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=a("meta"),C=l(),m=a("h1"),g=a("a"),v=a("span"),w(T.$$.fragment),_=l(),y=a("span"),me=n("CTRL"),Q=l(),b=a("h2"),J=a("a"),A=a("span"),w(Y.$$.fragment),ge=l(),H=a("span"),_e=n("Overview"),ce=l(),x=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
this argument.`),Cs=l(),Je=a("p"),ca=n("This model was contributed by "),Gt=a("a"),pa=n("keskarnitishr"),ha=n(`. The original code can be found
...
this superclass for more information regarding those methods.`),Oa=l(),Fn=a("div"),$s=l(),pt=a("h2"),Rt=a("a"),qn=a("span"),w(oo.$$.fragment),Wa=l(),zn=a("span"),Ba=n("CTRLModel"),Rs=l(),we=a("div"),w(no.$$.fragment),Ua=l(),Pn=a("p"),Va=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Ga=l(),so=a("p"),Ka=n("This model inherits from "),en=a("a"),Xa=n("PreTrainedModel"),Ja=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),tr=l(),qe=a("div"),w(io.$$.fragment),or=l(),ht=a("p"),nr=n("The "),tn=a("a"),sr=n("CTRLModel"),ar=n(" forward method, overrides the "),xn=a("code"),rr=n("__call__"),ir=n(" special method."),lr=l(),w(Mt.$$.fragment),dr=l(),Sn=a("p"),cr=n("Example:"),pr=l(),w(lo.$$.fragment),Ms=l(),ut=a("h2"),Et=a("a"),jn=a("span"),w(co.$$.fragment),hr=l(),In=a("span"),ur=n("CTRLLMHeadModel"),Es=l(),Le=a("div"),w(po.$$.fragment),fr=l(),Nn=a("p"),mr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),gr=l(),ho=a("p"),_r=n("This model inherits from "),on=a("a"),Tr=n("PreTrainedModel"),vr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zi=l(),w(It.$$.fragment),el=l(),xe=a("div"),w(Io.$$.fragment),tl=l(),kt=a("p"),ol=n("The "),pn=a("a"),nl=n("TFCTRLLMHeadModel"),sl=n(" forward method, overrides the "),ss=a("code"),al=n("__call__"),rl=n(" special method."),il=l(),w(Nt.$$.fragment),ll=l(),as=a("p"),dl=n("Example:"),cl=l(),w(No.$$.fragment),js=l(),Ct=a("h2"),Dt=a("a"),rs=a("span"),w(Do.$$.fragment),pl=l(),is=a("span"),hl=n("TFCTRLForSequenceClassification"),Is=l(),X=a("div"),w(Ao.$$.fragment),ul=l(),ls=a("p"),fl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),ml=l(),hn=a("p"),un=a("a"),gl=n("TFCTRLForSequenceClassification"),_l=n(` uses the last token in order to do the classification, as other causal models
...
padding tokens when `),ps=a("code"),wl=n("inputs_embeds"),Ll=n(" are passed instead of "),hs=a("code"),$l=n("input_ids"),Rl=n(`, it does the same (take the last value in
...
more information.`),Ds.forEach(t),p=d(Ot),k=r(Ot,"LI",{});var od=i(k);re=s(od,`CTRL is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
...
this argument.`),Wt.forEach(t),Ot.forEach(t),Cs=d(o),Je=r(o,"P",{});var gn=i(Je);ca=s(gn,"This model was contributed by "),Gt=r(gn,"A",{href:!0,rel:!0});var id=i(Gt);pa=s(id,"keskarnitishr"),id.forEach(t),ha=s(gn,`. The original code can be found
`),Kt=r(gn,"A",{href:!0,rel:!0});var ld=i(Kt);ua=s(ld,"here"),ld.forEach(t),fa=s(gn,"."),gn.forEach(t),bs=d(o),lt=r(o,"H2",{class:!0});var Hs=i(lt);Lt=r(Hs,"A",{id:!0,class:!0,href:!0});var dd=i(Lt);wn=r(dd,"SPAN",{});var cd=i(wn);L(Xt.$$.fragment,cd),cd.forEach(t),dd.forEach(t),ma=d(Hs),Ln=r(Hs,"SPAN",{});var pd=i(Ln);ga=s(pd,"CTRLConfig"),pd.forEach(t),Hs.forEach(t),ys=d(o),ye=r(o,"DIV",{class:!0});var Qe=i(ye);L(Jt.$$.fragment,Qe),_a=d(Qe),Xe=r(Qe,"P",{});var Bt=i(Xe);Ta=s(Bt,"This is the configuration class to store the configuration of a "),Xo=r(Bt,"A",{href:!0});var hd=i(Xo);va=s(hd,"CTRLModel"),hd.forEach(t),ka=s(Bt," or a "),Jo=r(Bt,"A",{href:!0});var ud=i(Jo);Ca=s(ud,"TFCTRLModel"),ud.forEach(t),ba=s(Bt,`. It is used to
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
...
this superclass for more information regarding those methods.`),Ws.forEach(t),Oa=d(Ut),Fn=r(Ut,"DIV",{class:!0}),i(Fn).forEach(t),Ut.forEach(t),$s=d(o),pt=r(o,"H2",{class:!0});var Bs=i(pt);Rt=r(Bs,"A",{id:!0,class:!0,href:!0});var yd=i(Rt);qn=r(yd,"SPAN",{});var wd=i(qn);L(oo.$$.fragment,wd),wd.forEach(t),yd.forEach(t),Wa=d(Bs),zn=r(Bs,"SPAN",{});var Ld=i(zn);Ba=s(Ld,"CTRLModel"),Ld.forEach(t),Bs.forEach(t),Rs=d(o),we=r(o,"DIV",{class:!0});var Ye=i(we);L(no.$$.fragment,Ye),Ua=d(Ye),Pn=r(Ye,"P",{});var $d=i(Pn);Va=s($d,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),$d.forEach(t),Ga=d(Ye),so=r(Ye,"P",{});var Us=i(so);Ka=s(Us,"This model inherits from "),en=r(Us,"A",{href:!0});var Rd=i(en);Xa=s(Rd,"PreTrainedModel"),Rd.forEach(t),Ja=s(Us,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vs.forEach(t),tr=d(Ye),qe=r(Ye,"DIV",{class:!0});var Ze=i(qe);L(io.$$.fragment,Ze),or=d(Ze),ht=r(Ze,"P",{});var Tn=i(ht);nr=s(Tn,"The "),tn=r(Tn,"A",{href:!0});var Ed=i(tn);sr=s(Ed,"CTRLModel"),Ed.forEach(t),ar=s(Tn," forward method, overrides the "),xn=r(Tn,"CODE",{});var Fd=i(xn);rr=s(Fd,"__call__"),Fd.forEach(t),ir=s(Tn," special method."),Tn.forEach(t),lr=d(Ze),L(Mt.$$.fragment,Ze),dr=d(Ze),Sn=r(Ze,"P",{});var qd=i(Sn);cr=s(qd,"Example:"),qd.forEach(t),pr=d(Ze),L(lo.$$.fragment,Ze),Ze.forEach(t),Ye.forEach(t),Ms=d(o),ut=r(o,"H2",{class:!0});var Gs=i(ut);Et=r(Gs,"A",{id:!0,class:!0,href:!0});var zd=i(Et);jn=r(zd,"SPAN",{});var Pd=i(jn);L(co.$$.fragment,Pd),Pd.forEach(t),zd.forEach(t),hr=d(Gs),In=r(Gs,"SPAN",{});var xd=i(In);ur=s(xd,"CTRLLMHeadModel"),xd.forEach(t),Gs.forEach(t),Es=d(o),Le=r(o,"DIV",{class:!0});var et=i(Le);L(po.$$.fragment,et),fr=d(et),Nn=r(et,"P",{});var Sd=i(Nn);mr=s(Sd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Sd.forEach(t),gr=d(et),ho=r(et,"P",{});var Ks=i(ho);_r=s(Ks,"This model inherits from "),on=r(Ks,"A",{href:!0});var jd=i(on);Tr=s(jd,"PreTrainedModel"),jd.forEach(t),vr=s(Ks,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sa.forEach(t),Zi=d(Ke),L(It.$$.fragment,Ke),el=d(Ke),xe=r(Ke,"DIV",{class:!0});var st=i(xe);L(Io.$$.fragment,st),tl=d(st),kt=r(st,"P",{});var bn=i(kt);ol=s(bn,"The "),pn=r(bn,"A",{href:!0});var gc=i(pn);nl=s(gc,"TFCTRLLMHeadModel"),gc.forEach(t),sl=s(bn," forward method, overrides the "),ss=r(bn,"CODE",{});var _c=i(ss);al=s(_c,"__call__"),_c.forEach(t),rl=s(bn," special method."),bn.forEach(t),il=d(st),L(Nt.$$.fragment,st),ll=d(st),as=r(st,"P",{});var Tc=i(as);dl=s(Tc,"Example:"),Tc.forEach(t),cl=d(st),L(No.$$.fragment,st),st.forEach(t),Ke.forEach(t),js=d(o),Ct=r(o,"H2",{class:!0});var aa=i(Ct);Dt=r(aa,"A",{id:!0,class:!0,href:!0});var vc=i(Dt);rs=r(vc,"SPAN",{});var kc=i(rs);L(Do.$$.fragment,kc),kc.forEach(t),vc.forEach(t),pl=d(aa),is=r(aa,"SPAN",{});var Cc=i(is);hl=s(Cc,"TFCTRLForSequenceClassification"),Cc.forEach(t),aa.forEach(t),Is=d(o),X=r(o,"DIV",{class:!0});var fe=i(X);L(Ao.$$.fragment,fe),ul=d(fe),ls=r(fe,"P",{});var bc=i(ls);fl=s(bc,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),bc.forEach(t),ml=d(fe),hn=r(fe,"P",{});var Kl=i(hn);un=r(Kl,"A",{href:!0});var yc=i(un);gl=s(yc,"TFCTRLForSequenceClassification"),yc.forEach(t),_l=s(Kl,` uses the last token in order to do the classification, as other causal models
...
padding tokens when `),ps=r(at,"CODE",{});var $c=i(ps);wl=s($c,"inputs_embeds"),$c.forEach(t),Ll=s(at," are passed instead of "),hs=r(at,"CODE",{});var Rc=i(hs);$l=s(Rc,"input_ids"),Rc.forEach(t),Rl=s(at,`, it does the same (take the last value in
