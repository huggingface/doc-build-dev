...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L805"}}),Ka=new we({}),Ja=new I({props:{name:"class transformers.ElectraModel",anchor:"transformers.ElectraModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_17822/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L894"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17822/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17822/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L1043"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L1526"}}),rl=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForCausalLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L980"}}),_l=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L1353"}}),nd=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17822/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17822/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17822/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
layers on top of the hidden-states output to compute `),Mp=n("code"),GT=r("span start logits"),XT=r(" and "),zp=n("code"),YT=r("span end logits"),ZT=r(")."),e2=c(),Dr=n("p"),t2=r("This model inherits from "),Bd=n("a"),o2=r("PreTrainedModel"),n2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),s2=c(),Sr=n("p"),a2=r("This model is also a PyTorch "),Wr=n("a"),r2=r("torch.nn.Module"),i2=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),l2=c(),it=n("div"),b(Ur.$$.fragment),d2=c(),Uo=n("p"),c2=r("The "),Rd=n("a"),p2=r("ElectraForQuestionAnswering"),h2=r(" forward method, overrides the "),jp=n("code"),m2=r("__call__"),u2=r(" special method."),f2=c(),b(ns.$$.fragment),g2=c(),b(ss.$$.fragment),_2=c(),b(as.$$.fragment),Gu=c(),Bo=n("h2"),rs=n("a"),Cp=n("span"),b(Br.$$.fragment),k2=c(),qp=n("span"),v2=r("TFElectraModel"),Xu=c(),Ke=n("div"),b(Rr.$$.fragment),T2=c(),Pp=n("p"),b2=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),y2=c(),Hr=n("p"),E2=r("This model inherits from "),Hd=n("a"),w2=r("TFPreTrainedModel"),$2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),F2=c(),Qr=n("p"),x2=r("This model is also a "),Vr=n("a"),M2=r("tf.keras.Model"),z2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j2=c(),b(is.$$.fragment),C2=c(),zt=n("div"),b(Kr.$$.fragment),q2=c(),Ro=n("p"),P2=r("The "),Qd=n("a"),A2=r("TFElectraModel"),O2=r(" forward method, overrides the "),Ap=n("code"),L2=r("__call__"),N2=r(" special method."),I2=c(),b(ls.$$.fragment),D2=c(),b(ds.$$.fragment),Yu=c(),Ho=n("h2"),cs=n("a"),Op=n("span"),b(Jr.$$.fragment),S2=c(),Lp=n("span"),W2=r("TFElectraForPreTraining"),Zu=c(),Oe=n("div"),b(Gr.$$.fragment),U2=c(),Np=n("p"),B2=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),R2=c(),Ip=n("p"),H2=r(`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),L1=c(),hh=n("p"),N1=r("Finally, this model supports inherent JAX features such as:"),I1=c(),Kt=n("ul"),mh=n("li"),Li=n("a"),D1=r("Just-In-Time (JIT) compilation"),S1=c(),uh=n("li"),Ni=n("a"),W1=r("Automatic Differentiation"),U1=c(),fh=n("li"),Ii=n("a"),B1=r("Vectorization"),R1=c(),gh=n("li"),Di=n("a"),H1=r("Parallelization"),Q1=c(),qt=n("div"),b(Si.$$.fragment),V1=c(),an=n("p"),K1=r("The "),_h=n("code"),J1=r("FlaxElectraPreTrainedModel"),G1=r(" forward method, overrides the "),kh=n("code"),X1=r("__call__"),Y1=r(" special method."),Z1=c(),b(Ds.$$.fragment),eE=c(),b(Ss.$$.fragment),mf=c(),rn=n("h2"),Ws=n("a"),vh=n("span"),b(Wi.$$.fragment),tE=c(),Th=n("span"),oE=r("FlaxElectraForPreTraining"),uf=c(),Pe=n("div"),b(Ui.$$.fragment),nE=c(),bh=n("p"),sE=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),aE=c(),yh=n("p"),rE=r("It is recommended to load the discriminator checkpoint into that model."),iE=c(),Bi=n("p"),lE=r("This model inherits from "),rc=n("a"),dE=r("FlaxPreTrainedModel"),cE=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),pE=c(),Ri=n("p"),hE=r(`This model is also a Flax Linen
`),Hi=n("a"),mE=r("flax.nn.Module"),uE=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),fE=c(),Eh=n("p"),gE=r("Finally, this model supports inherent JAX features such as:"),_E=c(),Jt=n("ul"),wh=n("li"),Qi=n("a"),kE=r("Just-In-Time (JIT) compilation"),vE=c(),$h=n("li"),Vi=n("a"),TE=r("Automatic Differentiation"),bE=c(),Fh=n("li"),Ki=n("a"),yE=r("Vectorization"),EE=c(),xh=n("li"),Ji=n("a"),wE=r("Parallelization"),$E=c(),Pt=n("div"),b(Gi.$$.fragment),FE=c(),ln=n("p"),xE=r("The "),Mh=n("code"),ME=r("FlaxElectraPreTrainedModel"),zE=r(" forward method, overrides the "),zh=n("code"),jE=r("__call__"),CE=r(" special method."),qE=c(),b(Us.$$.fragment),PE=c(),b(Bs.$$.fragment),ff=c(),dn=n("h2"),Rs=n("a"),jh=n("span"),b(Xi.$$.fragment),AE=c(),Ch=n("span"),OE=r("FlaxElectraForCausalLM"),gf=c(),De=n("div"),b(Yi.$$.fragment),LE=c(),qh=n("p"),NE=r(`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),UE=c(),el=n("p"),BE=r(`This model is also a Flax Linen
`),tl=n("a"),RE=r("flax.nn.Module"),HE=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),QE=c(),Ph=n("p"),VE=r("Finally, this model supports inherent JAX features such as:"),KE=c(),Gt=n("ul"),Ah=n("li"),ol=n("a"),JE=r("Just-In-Time (JIT) compilation"),GE=c(),Oh=n("li"),nl=n("a"),XE=r("Automatic Differentiation"),YE=c(),Lh=n("li"),sl=n("a"),ZE=r("Vectorization"),ew=c(),Nh=n("li"),al=n("a"),tw=r("Parallelization"),ow=c(),At=n("div"),b(rl.$$.fragment),nw=c(),cn=n("p"),sw=r("The "),Ih=n("code"),aw=r("FlaxElectraPreTrainedModel"),rw=r(" forward method, overrides the "),Dh=n("code"),iw=r("__call__"),lw=r(" special method."),dw=c(),b(Hs.$$.fragment),cw=c(),b(Qs.$$.fragment),_f=c(),pn=n("h2"),Vs=n("a"),Sh=n("span"),b(il.$$.fragment),pw=c(),Wh=n("span"),hw=r("FlaxElectraForMaskedLM"),kf=c(),Se=n("div"),b(ll.$$.fragment),mw=c(),dl=n("p"),uw=r("Electra Model with a "),Uh=n("code"),fw=r("language modeling"),gw=r(" head on top."),_w=c(),cl=n("p"),kw=r("This model inherits from "),lc=n("a"),vw=r("FlaxPreTrainedModel"),Tw=r(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$w=c(),Bh=n("p"),Fw=r("Finally, this model supports inherent JAX features such as:"),xw=c(),Xt=n("ul"),Rh=n("li"),ml=n("a"),Mw=r("Just-In-Time (JIT) compilation"),zw=c(),Hh=n("li"),ul=n("a"),jw=r("Automatic Differentiation"),Cw=c(),Qh=n("li"),fl=n("a"),qw=r("Vectorization"),Pw=c(),Vh=n("li"),gl=n("a"),Aw=r("Parallelization"),Ow=c(),Ot=n("div"),b(_l.$$.fragment),Lw=c(),hn=n("p"),Nw=r("The "),Kh=n("code"),Iw=r("FlaxElectraPreTrainedModel"),Dw=r(" forward method, overrides the "),Jh=n("code"),Sw=r("__call__"),Ww=r(" special method."),Uw=c(),b(Ks.$$.fragment),Bw=c(),b(Js.$$.fragment),vf=c(),mn=n("h2"),Gs=n("a"),Gh=n("span"),b(kl.$$.fragment),Rw=c(),Xh=n("span"),Hw=r("FlaxElectraForSequenceClassification"),Tf=c(),We=n("div"),b(vl.$$.fragment),Qw=c(),Yh=n("p"),Vw=r(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg.forEach(t),l2=p(uo),it=s(uo,"DIV",{class:!0});var fo=a(it);y(Ur.$$.fragment,fo),d2=p(fo),Uo=s(fo,"P",{});var bc=a(Uo);c2=i(bc,"The "),Rd=s(bc,"A",{href:!0});var Fx=a(Rd);p2=i(Fx,"ElectraForQuestionAnswering"),Fx.forEach(t),h2=i(bc," forward method, overrides the "),jp=s(bc,"CODE",{});var xx=a(jp);m2=i(xx,"__call__"),xx.forEach(t),u2=i(bc," special method."),bc.forEach(t),f2=p(fo),y(ns.$$.fragment,fo),g2=p(fo),y(ss.$$.fragment,fo),_2=p(fo),y(as.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Gu=p(o),Bo=s(o,"H2",{class:!0});var tg=a(Bo);rs=s(tg,"A",{id:!0,class:!0,href:!0});var Mx=a(rs);Cp=s(Mx,"SPAN",{});var zx=a(Cp);y(Br.$$.fragment,zx),zx.forEach(t),Mx.forEach(t),k2=p(tg),qp=s(tg,"SPAN",{});var jx=a(qp);v2=i(jx,"TFElectraModel"),jx.forEach(t),tg.forEach(t),Xu=p(o),Ke=s(o,"DIV",{class:!0});var Bt=a(Ke);y(Rr.$$.fragment,Bt),T2=p(Bt),Pp=s(Bt,"P",{});var Cx=a(Pp);b2=i(Cx,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),Cx.forEach(t),y2=p(Bt),Hr=s(Bt,"P",{});var og=a(Hr);E2=i(og,"This model inherits from "),Hd=s(og,"A",{href:!0});var qx=a(Hd);w2=i(qx,"TFPreTrainedModel"),qx.forEach(t),$2=i(og,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),og.forEach(t),F2=p(Bt),Qr=s(Bt,"P",{});var ng=a(Qr);x2=i(ng,"This model is also a "),Vr=s(ng,"A",{href:!0,rel:!0});var Px=a(Vr);M2=i(Px,"tf.keras.Model"),Px.forEach(t),z2=i(ng,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ng.forEach(t),j2=p(Bt),y(is.$$.fragment,Bt),C2=p(Bt),zt=s(Bt,"DIV",{class:!0});var ua=a(zt);y(Kr.$$.fragment,ua),q2=p(ua),Ro=s(ua,"P",{});var yc=a(Ro);P2=i(yc,"The "),Qd=s(yc,"A",{href:!0});var Ax=a(Qd);A2=i(Ax,"TFElectraModel"),Ax.forEach(t),O2=i(yc," forward method, overrides the "),Ap=s(yc,"CODE",{});var Ox=a(Ap);L2=i(Ox,"__call__"),Ox.forEach(t),N2=i(yc," special method."),yc.forEach(t),I2=p(ua),y(ls.$$.fragment,ua),D2=p(ua),y(ds.$$.fragment,ua),ua.forEach(t),Bt.forEach(t),Yu=p(o),Ho=s(o,"H2",{class:!0});var sg=a(Ho);cs=s(sg,"A",{id:!0,class:!0,href:!0});var Lx=a(cs);Op=s(Lx,"SPAN",{});var Nx=a(Op);y(Jr.$$.fragment,Nx),Nx.forEach(t),Lx.forEach(t),S2=p(sg),Lp=s(sg,"SPAN",{});var Ix=a(Lp);W2=i(Ix,"TFElectraForPreTraining"),Ix.forEach(t),sg.forEach(t),Zu=p(o),Oe=s(o,"DIV",{class:!0});var mt=a(Oe);y(Gr.$$.fragment,mt),U2=p(mt),Np=s(mt,"P",{});var Dx=a(Np);B2=i(Dx,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),Dx.forEach(t),R2=p(mt),Ip=s(mt,"P",{});var Sx=a(Ip);H2=i(Sx,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var MM=a(rh);t1=i(MM,"span start logits"),MM.forEach(t),o1=i(Mc," and "),ih=s(Mc,"CODE",{});var zM=a(ih);n1=i(zM,"span end logits"),zM.forEach(t),s1=i(Mc,")."),Mc.forEach(t),a1=p(Qt),xi=s(Qt,"P",{});var Tg=a(xi);r1=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var jM=a(nc);i1=i(jM,"TFPreTrainedModel"),jM.forEach(t),l1=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),d1=p(Qt),Mi=s(Qt,"P",{});var bg=a(Mi);c1=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var CM=a(zi);p1=i(CM,"tf.keras.Model"),CM.forEach(t),h1=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),m1=p(Qt),y(As.$$.fragment,Qt),u1=p(Qt),pt=s(Qt,"DIV",{class:!0});var vo=a(pt);y(ji.$$.fragment,vo),f1=p(vo),nn=s(vo,"P",{});var zc=a(nn);g1=i(zc,"The "),sc=s(zc,"A",{href:!0});var qM=a(sc);_1=i(qM,"TFElectraForQuestionAnswering"),qM.forEach(t),k1=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var PM=a(lh);v1=i(PM,"__call__"),PM.forEach(t),T1=i(zc," special method."),zc.forEach(t),b1=p(vo),y(Os.$$.fragment,vo),y1=p(vo),y(Ls.$$.fragment,vo),E1=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Qt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var AM=a(Is);dh=s(AM,"SPAN",{});var OM=a(dh);y(Ci.$$.fragment,OM),OM.forEach(t),AM.forEach(t),w1=p(yg),ch=s(yg,"SPAN",{});var LM=a(ch);$1=i(LM,"FlaxElectraModel"),LM.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),F1=p(gt),ph=s(gt,"P",{});var NM=a(ph);x1=i(NM,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),NM.forEach(t),M1=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);z1=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var IM=a(ac);j1=i(IM,"FlaxPreTrainedModel"),IM.forEach(t),C1=i(Eg,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$w=p(kt),Bh=s(kt,"P",{});var Iz=a(Bh);Fw=i(Iz,"Finally, this model supports inherent JAX features such as:"),Iz.forEach(t),xw=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Rh=s(Ea,"LI",{});var Dz=a(Rh);ml=s(Dz,"A",{href:!0,rel:!0});var Sz=a(ml);Mw=i(Sz,"Just-In-Time (JIT) compilation"),Sz.forEach(t),Dz.forEach(t),zw=p(Ea),Hh=s(Ea,"LI",{});var Wz=a(Hh);ul=s(Wz,"A",{href:!0,rel:!0});var Uz=a(ul);jw=i(Uz,"Automatic Differentiation"),Uz.forEach(t),Wz.forEach(t),Cw=p(Ea),Qh=s(Ea,"LI",{});var Bz=a(Qh);fl=s(Bz,"A",{href:!0,rel:!0});var Rz=a(fl);qw=i(Rz,"Vectorization"),Rz.forEach(t),Bz.forEach(t),Pw=p(Ea),Vh=s(Ea,"LI",{});var Hz=a(Vh);gl=s(Hz,"A",{href:!0,rel:!0});var Qz=a(gl);Aw=i(Qz,"Parallelization"),Qz.forEach(t),Hz.forEach(t),Ea.forEach(t),Ow=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),Lw=p(wa),hn=s(wa,"P",{});var Pc=a(hn);Nw=i(Pc,"The "),Kh=s(Pc,"CODE",{});var Vz=a(Kh);Iw=i(Vz,"FlaxElectraPreTrainedModel"),Vz.forEach(t),Dw=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var Kz=a(Jh);Sw=i(Kz,"__call__"),Kz.forEach(t),Ww=i(Pc," special method."),Pc.forEach(t),Uw=p(wa),y(Ks.$$.fragment,wa),Bw=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var Jz=a(Gs);Gh=s(Jz,"SPAN",{});var Gz=a(Gh);y(kl.$$.fragment,Gz),Gz.forEach(t),Jz.forEach(t),Rw=p(Og),Xh=s(Og,"SPAN",{});var Xz=a(Xh);Hw=i(Xz,"FlaxElectraForSequenceClassification"),Xz.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Qw=p(vt),Yh=s(vt,"P",{});var Yz=a(Yh);Vw=i(Yz,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
