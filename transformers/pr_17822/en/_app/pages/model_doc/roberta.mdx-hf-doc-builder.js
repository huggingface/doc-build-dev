...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17822/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d2=p(),T($s.$$.fragment),c2=p(),ht=n("div"),T(hi.$$.fragment),p2=p(),Vo=n("p"),h2=r("The "),Ed=n("a"),u2=r("TFRobertaForTokenClassification"),f2=r(" forward method, overrides the "),Pp=n("code"),m2=r("__call__"),g2=r(" special method."),_2=p(),T(Fs.$$.fragment),b2=p(),T(xs.$$.fragment),k2=p(),T(Rs.$$.fragment),$f=p(),Ko=n("h2"),Ms=n("a"),Lp=n("span"),T(ui.$$.fragment),v2=p(),Ap=n("span"),T2=r("TFRobertaForQuestionAnswering"),Ff=p(),Xe=n("div"),T(fi.$$.fragment),y2=p(),Go=n("p"),w2=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=n("code"),$2=r("span start logits"),F2=r(" and "),Np=n("code"),x2=r("span end logits"),R2=r(")."),M2=p(),mi=n("p"),E2=r("This model inherits from "),zd=n("a"),z2=r("TFPreTrainedModel"),q2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q1=p(),kh=n("p"),J1=r("Finally, this model supports inherent JAX features such as:"),V1=p(),Jt=n("ul"),vh=n("li"),tl=n("a"),K1=r("Just-In-Time (JIT) compilation"),G1=p(),Th=n("li"),ol=n("a"),X1=r("Automatic Differentiation"),Y1=p(),yh=n("li"),nl=n("a"),Z1=r("Vectorization"),e$=p(),wh=n("li"),sl=n("a"),t$=r("Parallelization"),o$=p(),jt=n("div"),T(al.$$.fragment),n$=p(),an=n("p"),s$=r("The "),$h=n("code"),a$=r("FlaxRobertaPreTrainedModel"),r$=r(" forward method, overrides the "),Fh=n("code"),i$=r("__call__"),l$=r(" special method."),d$=p(),T(Bs.$$.fragment),c$=p(),T(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),T(rl.$$.fragment),p$=p(),Rh=n("span"),h$=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),T(il.$$.fragment),u$=p(),Mh=n("p"),f$=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),m$=p(),ll=n("p"),g$=r("This model inherits from "),Ad=n("a"),_$=r("FlaxPreTrainedModel"),b$=r(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zm.forEach(t),Sy=h(Dt),y(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sR=a(Rd);Hy=i(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var aR=a(zp);Jy=i(aR,"__call__"),aR.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),y(Ts.$$.fragment,aa),Gy=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qm=a(Jo);ws=s(qm,"A",{id:!0,class:!0,href:!0});var rR=a(ws);qp=s(rR,"SPAN",{});var iR=a(qp);y(ii.$$.fragment,iR),iR.forEach(t),rR.forEach(t),Xy=h(qm),Cp=s(qm,"SPAN",{});var lR=a(Cp);Yy=i(lR,"TFRobertaForTokenClassification"),lR.forEach(t),qm.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var dR=a(jp);e2=i(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dR.forEach(t),t2=h(St),di=s(St,"P",{});var Cm=a(di);o2=i(Cm,"This model inherits from "),Md=s(Cm,"A",{href:!0});var cR=a(Md);n2=i(cR,"TFPreTrainedModel"),cR.forEach(t),s2=i(Cm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cm.forEach(t),a2=h(St),ci=s(St,"P",{});var jm=a(ci);r2=i(jm,"This model is also a "),pi=s(jm,"A",{href:!0,rel:!0});var pR=a(pi);i2=i(pR,"tf.keras.Model"),pR.forEach(t),l2=i(jm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jm.forEach(t),d2=h(St),y($s.$$.fragment,St),c2=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),p2=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);h2=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hR=a(Ed);u2=i(hR,"TFRobertaForTokenClassification"),hR.forEach(t),f2=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var uR=a(Pp);m2=i(uR,"__call__"),uR.forEach(t),g2=i(tc," special method."),tc.forEach(t),_2=h(fo),y(Fs.$$.fragment,fo),b2=h(fo),y(xs.$$.fragment,fo),k2=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pm=a(Ko);Ms=s(Pm,"A",{id:!0,class:!0,href:!0});var fR=a(Ms);Lp=s(fR,"SPAN",{});var mR=a(Lp);y(ui.$$.fragment,mR),mR.forEach(t),fR.forEach(t),v2=h(Pm),Ap=s(Pm,"SPAN",{});var gR=a(Ap);T2=i(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Pm.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),y2=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);w2=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _R=a(Op);$2=i(_R,"span start logits"),_R.forEach(t),F2=i(oc," and "),Np=s(oc,"CODE",{});var bR=a(Np);x2=i(bR,"span end logits"),bR.forEach(t),R2=i(oc,")."),oc.forEach(t),M2=h(Wt),mi=s(Wt,"P",{});var Lm=a(mi);E2=i(Lm,"This model inherits from "),zd=s(Lm,"A",{href:!0});var kR=a(zd);z2=i(kR,"TFPreTrainedModel"),kR.forEach(t),q2=i(Lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lm.forEach(t),C2=h(Wt),gi=s(Wt,"P",{});var Am=a(gi);j2=i(Am,"This model is also a "),_i=s(Am,"A",{href:!0,rel:!0});var vR=a(_i);P2=i(vR,"tf.keras.Model"),vR.forEach(t),L2=i(Am,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Am.forEach(t),A2=h(Wt),y(Es.$$.fragment,Wt),O2=h(Wt),ut=s(Wt,"DIV",{class:!0});var mo=a(ut);y(bi.$$.fragment,mo),N2=h(mo),Xo=s(mo,"P",{});var nc=a(Xo);I2=i(nc,"The "),qd=s(nc,"A",{href:!0});var TR=a(qd);D2=i(TR,"TFRobertaForQuestionAnswering"),TR.forEach(t),S2=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yR=a(Ip);W2=i(yR,"__call__"),yR.forEach(t),B2=i(nc," special method."),nc.forEach(t),U2=h(mo),y(zs.$$.fragment,mo),H2=h(mo),y(qs.$$.fragment,mo),Q2=h(mo),y(Cs.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Om=a(Yo);js=s(Om,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);y(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),J2=h(Om),Sp=s(Om,"SPAN",{});var FR=a(Sp);V2=i(FR,"FlaxRobertaModel"),FR.forEach(t),Om.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),K2=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);G2=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),X2=h(gt),Ti=s(gt,"P",{});var Nm=a(Ti);Y2=i(Nm,"This model inherits from "),Cd=s(Nm,"A",{href:!0});var RR=a(Cd);Z2=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),ew=i(Nm,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Km.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var xM=a(kh);J1=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),V1=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);K1=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),G1=h(ha),Th=s(ha,"LI",{});var EM=a(Th);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);X1=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Y1=h(ha),yh=s(ha,"LI",{});var qM=a(yh);nl=s(qM,"A",{href:!0,rel:!0});var CM=a(nl);Z1=i(CM,"Vectorization"),CM.forEach(t),qM.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t$=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ua=a(jt);y(al.$$.fragment,ua),n$=h(ua),an=s(ua,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a$=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i$=i(AM,"__call__"),AM.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ua),y(Bs.$$.fragment,ua),c$=h(ua),y(Us.$$.fragment,ua),ua.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gm=a(rn);Hs=s(Gm,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);y(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p$=h(Gm),Rh=s(Gm,"SPAN",{});var IM=a(Rh);h$=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gm.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),u$=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f$=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DM.forEach(t),m$=h(vt),ll=s(vt,"P",{});var Xm=a(ll);g$=i(Xm,"This model inherits from "),Ad=s(Xm,"A",{href:!0});var SM=a(Ad);_$=i(SM,"FlaxPreTrainedModel"),SM.forEach(t),b$=i(Xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xm.forEach(t),k$=h(vt),dl=s(vt,"P",{});var Ym=a(dl);v$=i(Ym,"This model is also a Flax Linen "),cl=s(Ym,"A",{href:!0,rel:!0});var WM=a(cl);T$=i(WM,"flax.linen.Module"),WM.forEach(t),y$=i(Ym,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ym.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var BM=a(Eh);$$=i(BM,"Finally, this model supports inherent JAX features such as:"),BM.forEach(t),F$=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UM=a(zh);pl=s(UM,"A",{href:!0,rel:!0});var HM=a(pl);x$=i(HM,"Just-In-Time (JIT) compilation"),HM.forEach(t),UM.forEach(t),R$=h(fa),qh=s(fa,"LI",{});var QM=a(qh);hl=s(QM,"A",{href:!0,rel:!0});var JM=a(hl);M$=i(JM,"Automatic Differentiation"),JM.forEach(t),QM.forEach(t),E$=h(fa),Ch=s(fa,"LI",{});var VM=a(Ch);ul=s(VM,"A",{href:!0,rel:!0});var KM=a(ul);z$=i(KM,"Vectorization"),KM.forEach(t),VM.forEach(t),q$=h(fa),jh=s(fa,"LI",{});var GM=a(jh);fl=s(GM,"A",{href:!0,rel:!0});var XM=a(fl);C$=i(XM,"Parallelization"),XM.forEach(t),GM.forEach(t),fa.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var ma=a(Pt);y(ml.$$.fragment,ma),P$=h(ma),ln=s(ma,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var YM=a(Ph);A$=i(YM,"FlaxRobertaPreTrainedModel"),YM.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZM=a(Lh);N$=i(ZM,"__call__"),ZM.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(ma),y(Qs.$$.fragment,ma),S$=h(ma),y(Js.$$.fragment,ma),ma.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zm=a(dn);Vs=s(Zm,"A",{id:!0,class:!0,href:!0});var eE=a(Vs);Ah=s(eE,"SPAN",{});var tE=a(Ah);y(gl.$$.fragment,tE),tE.forEach(t),eE.forEach(t),W$=h(Zm),Oh=s(Zm,"SPAN",{});var oE=a(Oh);B$=i(oE,"FlaxRobertaForTokenClassification"),oE.forEach(t),Zm.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U$=h(Tt),Nh=s(Tt,"P",{});var nE=a(Nh);H$=i(nE,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
