...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart50/tokenization_mbart50.py#L48"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[I$]},$$scope:{ctx:x}}}),ns=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart50/tokenization_mbart50.py#L257",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ps=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),us=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),hs=new R({}),ms=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17119/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_mbart.py#L1301",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_mbart.py#L1570",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_mbart.py#L1443",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_mbart.py#L1722",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_tf_mbart.py#L1158",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_tf_mbart.py#L1266",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kk=p(),y(kn.$$.fragment),Zk=p(),Ee=a("div"),y(dr.$$.fragment),Yk=p(),po=a("p"),e1=i("The "),Ai=a("a"),t1=i("TFMBartForConditionalGeneration"),o1=i(" forward method, overrides the "),Rl=a("code"),n1=i("__call__"),a1=i(" special method."),s1=p(),y(yn.$$.fragment),r1=p(),y(vn.$$.fragment),i1=p(),y(Tn.$$.fragment),Qp=p(),uo=a("h2"),wn=a("a"),Xl=a("span"),y(lr.$$.fragment),d1=p(),Ql=a("span"),l1=i("FlaxMBartModel"),Vp=p(),W=a("div"),y(cr.$$.fragment),c1=p(),pr=a("p"),p1=i(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),b1=p(),Vl=a("p"),k1=i("Finally, this model supports inherent JAX features such as:"),y1=p(),mt=a("ul"),Hl=a("li"),mr=a("a"),v1=i("Just-In-Time (JIT) compilation"),T1=p(),Jl=a("li"),fr=a("a"),w1=i("Automatic Differentiation"),M1=p(),Kl=a("li"),_r=a("a"),$1=i("Vectorization"),x1=p(),Zl=a("li"),gr=a("a"),z1=i("Parallelization"),F1=p(),et=a("div"),y(br.$$.fragment),q1=p(),ho=a("p"),B1=i("The "),Yl=a("code"),j1=i("FlaxMBartPreTrainedModel"),C1=i(" forward method, overrides the "),ec=a("code"),E1=i("__call__"),P1=i(" special method."),S1=p(),y(Mn.$$.fragment),A1=p(),y($n.$$.fragment),O1=p(),xn=a("div"),y(kr.$$.fragment),I1=p(),y(zn.$$.fragment),N1=p(),Fn=a("div"),y(yr.$$.fragment),D1=p(),y(qn.$$.fragment),Hp=p(),mo=a("h2"),Bn=a("a"),tc=a("span"),y(vr.$$.fragment),L1=p(),oc=a("span"),G1=i("FlaxMBartForConditionalGeneration"),Jp=p(),U=a("div"),y(Tr.$$.fragment),W1=p(),wr=a("p"),U1=i(`The MMBart Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Q1=p(),Mr=a("p"),V1=i(`This model is also a Flax Linen
`),$r=a("a"),H1=i("flax.nn.Module"),J1=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),K1=p(),nc=a("p"),Z1=i("Finally, this model supports inherent JAX features such as:"),Y1=p(),ft=a("ul"),ac=a("li"),xr=a("a"),ey=i("Just-In-Time (JIT) compilation"),ty=p(),sc=a("li"),zr=a("a"),oy=i("Automatic Differentiation"),ny=p(),rc=a("li"),Fr=a("a"),ay=i("Vectorization"),sy=p(),ic=a("li"),qr=a("a"),ry=i("Parallelization"),iy=p(),Pe=a("div"),y(Br.$$.fragment),dy=p(),fo=a("p"),ly=i("The "),dc=a("code"),cy=i("FlaxMBartPreTrainedModel"),py=i(" forward method, overrides the "),lc=a("code"),uy=i("__call__"),hy=i(" special method."),my=p(),y(jn.$$.fragment),fy=p(),y(Cn.$$.fragment),_y=p(),y(En.$$.fragment),gy=p(),Pn=a("div"),y(jr.$$.fragment),by=p(),y(Sn.$$.fragment),ky=p(),An=a("div"),y(Cr.$$.fragment),yy=p(),y(On.$$.fragment),Kp=p(),_o=a("h2"),In=a("a"),cc=a("span"),y(Er.$$.fragment),vy=p(),pc=a("span"),Ty=i("FlaxMBartForSequenceClassification"),Zp=p(),N=a("div"),y(Pr.$$.fragment),wy=p(),uc=a("p"),My=i(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
example shows how to translate English to Romanian using the `),ld=s(To,"EM",{});var np=r(ld);Rh=d(np,"facebook/mbart-large-en-ro"),np.forEach(t),Xh=d(To," model."),To.forEach(t),ii.forEach(t),ep.forEach(t),pp=u(o),v(ka.$$.fragment,o),up=u(o),Nt=s(o,"H2",{class:!0});var di=r(Nt);Mo=s(di,"A",{id:!0,class:!0,href:!0});var ap=r(Mo);cd=s(ap,"SPAN",{});var sp=r(cd);v(ya.$$.fragment,sp),sp.forEach(t),ap.forEach(t),Qh=u(di),pd=s(di,"SPAN",{});var rp=r(pd);Vh=d(rp,"Overview of MBart-50"),rp.forEach(t),di.forEach(t),hp=u(o),yt=s(o,"P",{});var wo=r(yt);Hh=d(wo,"MBart-50 was introduced in the "),va=s(wo,"A",{href:!0,rel:!0});var Lv=r(va);Jh=d(Lv,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),Lv.forEach(t),Kh=d(wo,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),Rv.forEach(t),Uv.forEach(t),_p=u(o),Dt=s(o,"H3",{class:!0});var ou=r(Dt);$o=s(ou,"A",{id:!0,class:!0,href:!0});var Xv=r($o);md=s(Xv,"SPAN",{});var Qv=r(md);v(Ta.$$.fragment,Qv),Qv.forEach(t),Xv.forEach(t),om=u(ou),fd=s(ou,"SPAN",{});var Vv=r(fd);nm=d(Vv,"Training of MBart-50"),Vv.forEach(t),ou.forEach(t),gp=u(o),He=s(o,"P",{});var ea=r(He);am=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),_d=s(ea,"CODE",{});var Hv=r(_d);sm=d(Hv,"[lang_code] X [eos]"),Hv.forEach(t),rm=d(ea,", where "),gd=s(ea,"CODE",{});var Jv=r(gd);im=d(Jv,"lang_code"),Jv.forEach(t),dm=d(ea,` is source
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),uh.forEach(t),b1=u(pe),Vl=s(pe,"P",{});var TM=r(Vl);k1=d(TM,"Finally, this model supports inherent JAX features such as:"),TM.forEach(t),y1=u(pe),mt=s(pe,"UL",{});var la=r(mt);Hl=s(la,"LI",{});var wM=r(Hl);mr=s(wM,"A",{href:!0,rel:!0});var MM=r(mr);v1=d(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),wM.forEach(t),T1=u(la),Jl=s(la,"LI",{});var $M=r(Jl);fr=s($M,"A",{href:!0,rel:!0});var xM=r(fr);w1=d(xM,"Automatic Differentiation"),xM.forEach(t),$M.forEach(t),M1=u(la),Kl=s(la,"LI",{});var zM=r(Kl);_r=s(zM,"A",{href:!0,rel:!0});var FM=r(_r);$1=d(FM,"Vectorization"),FM.forEach(t),zM.forEach(t),x1=u(la),Zl=s(la,"LI",{});var qM=r(Zl);gr=s(qM,"A",{href:!0,rel:!0});var BM=r(gr);z1=d(BM,"Parallelization"),BM.forEach(t),qM.forEach(t),la.forEach(t),F1=u(pe),et=s(pe,"DIV",{class:!0});var ca=r(et);v(br.$$.fragment,ca),q1=u(ca),ho=s(ca,"P",{});var Yi=r(ho);B1=d(Yi,"The "),Yl=s(Yi,"CODE",{});var jM=r(Yl);j1=d(jM,"FlaxMBartPreTrainedModel"),jM.forEach(t),C1=d(Yi," forward method, overrides the "),ec=s(Yi,"CODE",{});var CM=r(ec);E1=d(CM,"__call__"),CM.forEach(t),P1=d(Yi," special method."),Yi.forEach(t),S1=u(ca),v(Mn.$$.fragment,ca),A1=u(ca),v($n.$$.fragment,ca),ca.forEach(t),O1=u(pe),xn=s(pe,"DIV",{class:!0});var hh=r(xn);v(kr.$$.fragment,hh),I1=u(hh),v(zn.$$.fragment,hh),hh.forEach(t),N1=u(pe),Fn=s(pe,"DIV",{class:!0});var mh=r(Fn);v(yr.$$.fragment,mh),D1=u(mh),v(qn.$$.fragment,mh),mh.forEach(t),pe.forEach(t),Hp=u(o),mo=s(o,"H2",{class:!0});var fh=r(mo);Bn=s(fh,"A",{id:!0,class:!0,href:!0});var EM=r(Bn);tc=s(EM,"SPAN",{});var PM=r(tc);v(vr.$$.fragment,PM),PM.forEach(t),EM.forEach(t),L1=u(fh),oc=s(fh,"SPAN",{});var SM=r(oc);G1=d(SM,"FlaxMBartForConditionalGeneration"),SM.forEach(t),fh.forEach(t),Jp=u(o),U=s(o,"DIV",{class:!0});var ue=r(U);v(Tr.$$.fragment,ue),W1=u(ue),wr=s(ue,"P",{});var _h=r(wr);U1=d(_h,`The MMBart Model with a language modeling head. Can be used for summarization.
