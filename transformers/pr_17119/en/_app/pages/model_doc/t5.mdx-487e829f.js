import{S as Yy,i as Zy,s as Jy,e as a,k as d,w as k,t as o,M as Xy,c as r,d as t,m as c,a as i,x as v,h as s,b as h,F as e,g as m,y,q as w,o as $,B as x,v as Qy,L as ge}from"../../chunks/vendor-6b77c823.js";import{T as wt}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-1088f2fb.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ke}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as _e}from"../../chunks/ExampleCodeBlock-5212b321.js";function e5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function f5(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,W,A,re,pe,M,N,he,K,ye,ue,B,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),W=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),B=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),be=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function T5(j){let p,b,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ve,W,A,re,pe,M,N,he,K,ye,ue,B,Me,we,P,Ce,H,V,Te,O,Pe,be,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),W=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),B=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),be=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17119/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17119/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17119/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_t5.py#L1348",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17119/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_t5.py#L1542",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_t5.py#L1813",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_t5.py#L1776"}}),Gn=new _e({props:{anchor:"transformers.T5EncoderModel.parallelize.example",$$slots:{default:[c5]},$$scope:{ctx:j}}}),da=new C({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_t5.py#L1787"}}),Un=new _e({props:{anchor:"transformers.T5EncoderModel.deparallelize.example",$$slots:{default:[p5]},$$scope:{ctx:j}}}),ca=new ke({}),pa=new C({props:{name:"class transformers.TFT5Model",anchor:"transformers.TFT5Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17119/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_tf_t5.py#L1140",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_tf_t5.py#L1316",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17119/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17119/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17119/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_tf_t5.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/t5/modeling_flax_t5.py#L958",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_17119/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),KT=d(),k(Kn.$$.fragment),YT=d(),ft=a("div"),k(za.$$.fragment),ZT=d(),en=a("p"),JT=o("The "),Lr=a("a"),XT=o("TFT5ForConditionalGeneration"),QT=o(" forward method, overrides the "),Xl=a("code"),e1=o("__call__"),t1=o(" special method."),n1=d(),k(Yn.$$.fragment),o1=d(),k(Zn.$$.fragment),Dc=d(),tn=a("h2"),Jn=a("a"),Ql=a("span"),k(ja.$$.fragment),s1=d(),ed=a("span"),a1=o("TFT5EncoderModel"),Sc=d(),ce=a("div"),k(qa.$$.fragment),r1=d(),td=a("p"),i1=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),l1=d(),Ea=a("p"),d1=o("The T5 model was proposed in "),Fa=a("a"),c1=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k1=d(),k(Xn.$$.fragment),v1=d(),_t=a("div"),k(Na.$$.fragment),y1=d(),nn=a("p"),w1=o("The "),Ir=a("a"),$1=o("TFT5EncoderModel"),x1=o(" forward method, overrides the "),nd=a("code"),z1=o("__call__"),j1=o(" special method."),q1=d(),k(Qn.$$.fragment),E1=d(),k(eo.$$.fragment),Gc=d(),on=a("h2"),to=a("a"),od=a("span"),k(Oa.$$.fragment),F1=d(),sd=a("span"),M1=o("FlaxT5Model"),Uc=d(),Je=a("div"),k(La.$$.fragment),C1=d(),gt=a("div"),k(Aa.$$.fragment),P1=d(),sn=a("p"),N1=o("The "),ad=a("code"),O1=o("FlaxT5PreTrainedModel"),L1=o(" forward method, overrides the "),rd=a("code"),A1=o("__call__"),I1=o(" special method."),D1=d(),k(no.$$.fragment),S1=d(),k(oo.$$.fragment),G1=d(),so=a("div"),k(Ia.$$.fragment),U1=d(),k(ao.$$.fragment),W1=d(),ro=a("div"),k(Da.$$.fragment),B1=d(),k(io.$$.fragment),Wc=d(),an=a("h2"),lo=a("a"),id=a("span"),k(Sa.$$.fragment),R1=d(),ld=a("span"),H1=o("FlaxT5ForConditionalGeneration"),Bc=d(),Xe=a("div"),k(Ga.$$.fragment),V1=d(),Tt=a("div"),k(Ua.$$.fragment),K1=d(),rn=a("p"),Y1=o("The "),dd=a("code"),Z1=o("FlaxT5PreTrainedModel"),J1=o(" forward method, overrides the "),cd=a("code"),X1=o("__call__"),Q1=o(" special method."),eb=d(),k(co.$$.fragment),tb=d(),k(po.$$.fragment),nb=d(),ho=a("div"),k(Wa.$$.fragment),ob=d(),k(uo.$$.fragment),sb=d(),mo=a("div"),k(Ba.$$.fragment),ab=d(),k(fo.$$.fragment),this.h()},l(n){const f=Xy('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),b=c(n),g=r(n,"H1",{class:!0});var Ra=i(g);u=r(Ra,"A",{id:!0,class:!0,href:!0});var pd=i(u);T=r(pd,"SPAN",{});var hd=i(T);v(l.$$.fragment,hd),hd.forEach(t),pd.forEach(t),_=c(Ra),q=r(Ra,"SPAN",{});var ud=i(q);qe=s(ud,"T5"),ud.forEach(t),Ra.forEach(t),se=c(n),E=r(n,"H2",{class:!0});var Ha=i(E);ee=r(Ha,"A",{id:!0,class:!0,href:!0});var md=i(ee);G=r(md,"SPAN",{});var fd=i(G);v(ae.$$.fragment,fd),fd.forEach(t),md.forEach(t),Ee=c(Ha),U=r(Ha,"SPAN",{});var _d=i(U);Fe=s(_d,"Overview"),_d.forEach(t),Ha.forEach(t),ve=c(n),W=r(n,"P",{});var Va=i(W);A=s(Va,"The T5 model was presented in "),re=r(Va,"A",{href:!0,rel:!0});var gd=i(re);pe=s(gd,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),gd.forEach(t),M=s(Va,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
the documentation of mT5 which can be found `),Xa=r(Nd,"A",{href:!0});var Fb=i(Xa);ph=s(Fb,"here"),Fb.forEach(t),hh=s(Nd,"."),Nd.forEach(t),qb.forEach(t),uh=c(Dr),bi=r(Dr,"LI",{});var Mb=i(bi);hn=r(Mb,"P",{});var Od=i(hn);ki=r(Od,"STRONG",{});var Cb=i(ki);mh=s(Cb,"byT5"),Cb.forEach(t),fh=s(Od,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Qa=r(Od,"A",{href:!0});var Pb=i(Qa);_h=s(Pb,"here"),Pb.forEach(t),gh=s(Od,"."),Od.forEach(t),Mb.forEach(t),Dr.forEach(t),Sd=c(n),un=r(n,"P",{});var Hc=i(un);Th=s(Hc,"All checkpoints can be found on the "),Io=r(Hc,"A",{href:!0,rel:!0});var Nb=i(Io);bh=s(Nb,"hub"),Nb.forEach(t),kh=s(Hc,"."),Hc.forEach(t),Gd=c(n),xt=r(n,"P",{});var Sr=i(xt);vh=s(Sr,"This model was contributed by "),Do=r(Sr,"A",{href:!0,rel:!0});var Ob=i(Do);yh=s(Ob,"thomwolf"),Ob.forEach(t),wh=s(Sr,". The original code can be found "),So=r(Sr,"A",{href:!0,rel:!0});var Lb=i(So);$h=s(Lb,"here"),Lb.forEach(t),xh=s(Sr,"."),Sr.forEach(t),Ud=c(n),er=r(n,"A",{id:!0}),i(er).forEach(t),Wd=c(n),Ot=r(n,"H2",{class:!0});var Vc=i(Ot);mn=r(Vc,"A",{id:!0,class:!0,href:!0});var Ab=i(mn);vi=r(Ab,"SPAN",{});var Ib=i(vi);v(Go.$$.fragment,Ib),Ib.forEach(t),Ab.forEach(t),zh=c(Vc),yi=r(Vc,"SPAN",{});var Db=i(yi);jh=s(Db,"Training"),Db.forEach(t),Vc.forEach(t),Bd=c(n),at=r(n,"P",{});var _o=i(at);qh=s(_o,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
processed as follows:`),Xb.forEach(t),Yd=c(n),v(Uo.$$.fragment,n),Zd=c(n),_n=r(n,"P",{});var Yc=i(_n);Qh=s(Yc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Wo=r(Yc,"A",{href:!0,rel:!0});var Qb=i(Wo);eu=s(Qb,"run_t5_mlm_flax.py"),Qb.forEach(t),tu=s(Yc,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),nk.forEach(t),Qd=c(n),v(Bo.$$.fragment,n),ec=c(n),oe=r(n,"P",{});var $e=i(oe);su=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=r($e,"CODE",{});var ok=i(Pi);au=s(ok,"input_ids"),ok.forEach(t),ru=s($e,` (which are the
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Si=r(Gr,"CODE",{});var ck=i(Si);ku=s(ck,"max_source_length"),ck.forEach(t),vu=s(Gr," and "),Gi=r(Gr,"CODE",{});var pk=i(Gi);yu=s(pk,"max_target_length"),pk.forEach(t),wu=s(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
...
ignored. The code example below illustrates all of this.`),He.forEach(t),oc=c(n),v(Ho.$$.fragment,n),sc=c(n),ir=r(n,"P",{});var Tk=i(ir);Au=s(Tk,"Additional training tips:"),Tk.forEach(t),ac=c(n),lr=r(n,"UL",{});var bk=i(lr);Vo=r(bk,"LI",{});var Zc=i(Vo);Iu=s(Zc,"T5 models need a slightly higher learning rate than the default one set in the "),Vi=r(Zc,"CODE",{});var kk=i(Vi);Du=s(kk,"Trainer"),kk.forEach(t),Su=s(Zc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Zc.forEach(t),bk.forEach(t),rc=c(n),jt=r(n,"P",{});var Ur=i(jt);Gu=s(Ur,"According to "),Ko=r(Ur,"A",{href:!0,rel:!0});var vk=i(Ko);Uu=s(vk,"this forum post"),vk.forEach(t),Wu=s(Ur,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Jc.forEach(t),lc=c(n),dr=r(n,"A",{id:!0}),i(dr).forEach(t),dc=c(n),Lt=r(n,"H2",{class:!0});var Xc=i(Lt);Tn=r(Xc,"A",{id:!0,class:!0,href:!0});var $k=i(Tn);Yi=r($k,"SPAN",{});var xk=i(Yi);v(Zo.$$.fragment,xk),xk.forEach(t),$k.forEach(t),Yu=c(Xc),Zi=r(Xc,"SPAN",{});var zk=i(Zi);Zu=s(zk,"Inference"),zk.forEach(t),Xc.forEach(t),cc=c(n),rt=r(n,"P",{});var go=i(rt);Ju=s(go,"At inference time, it is recommended to use "),cr=r(go,"A",{href:!0});var jk=i(cr);Xu=s(jk,"generate()"),jk.forEach(t),Qu=s(go,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
...
`),pr=r(Pt,"A",{href:!0});var Ck=i(pr);dm=s(Ck,"generate()"),Ck.forEach(t),cm=s(Pt,", make sure you start it with the "),Qi=r(Pt,"CODE",{});var Pk=i(Qi);pm=s(Pk,"pad_token_id"),Pk.forEach(t),hm=s(Pt,"."),Pt.forEach(t),uc=c(n),hr=r(n,"P",{});var Nk=i(hr);um=s(Nk,"The example above only shows a single example. You can also do batched inference, like so:"),Nk.forEach(t),mc=c(n),v(es.$$.fragment,n),fc=c(n),ur=r(n,"P",{});var Ok=i(ur);mm=s(Ok,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),Ok.forEach(t),_c=c(n),v(ts.$$.fragment,n),gc=c(n),mr=r(n,"A",{id:!0}),i(mr).forEach(t),Tc=c(n),At=r(n,"H2",{class:!0});var Qc=i(At);bn=r(Qc,"A",{id:!0,class:!0,href:!0});var Lk=i(bn);el=r(Lk,"SPAN",{});var Ak=i(el);v(ns.$$.fragment,Ak),Ak.forEach(t),Lk.forEach(t),fm=c(Qc),tl=r(Qc,"SPAN",{});var Ik=i(tl);_m=s(Ik,"Performance"),Ik.forEach(t),Qc.forEach(t),bc=c(n),it=r(n,"P",{});var To=i(it);gm=s(To,"If you\u2019d like a faster training and inference performance, install "),os=r(To,"A",{href:!0,rel:!0});var Dk=i(os);Tm=s(Dk,"apex"),Dk.forEach(t),bm=s(To," and then the model will automatically use "),nl=r(To,"CODE",{});var Sk=i(nl);km=s(Sk,"apex.normalization.FusedRMSNorm"),Sk.forEach(t),vm=s(To," instead of "),ol=r(To,"CODE",{});var Gk=i(ol);ym=s(Gk,"T5LayerNorm"),Gk.forEach(t),wm=s(To,". The former uses an optimized fused kernel which is several times faster than the latter."),To.forEach(t),kc=c(n),It=r(n,"H2",{class:!0});var ep=i(It);kn=r(ep,"A",{id:!0,class:!0,href:!0});var Uk=i(kn);sl=r(Uk,"SPAN",{});var Wk=i(sl);v(ss.$$.fragment,Wk),Wk.forEach(t),Uk.forEach(t),$m=c(ep),al=r(ep,"SPAN",{});var Bk=i(al);xm=s(Bk,"Example scripts"),Bk.forEach(t),ep.forEach(t),vc=c(n),fr=r(n,"P",{});var Rk=i(fr);zm=s(Rk,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rk.forEach(t),yc=c(n),vn=r(n,"UL",{});var tp=i(vn);rl=r(tp,"LI",{});var Hk=i(rl);Dt=r(Hk,"P",{});var Wr=i(Dt);jm=s(Wr,"pre-training: the "),as=r(Wr,"A",{href:!0,rel:!0});var Vk=i(as);qm=s(Vk,"run_t5_mlm_flax.py"),Vk.forEach(t),Em=s(Wr,`
...
(`),cs=r(bt,"A",{href:!0,rel:!0});var Qk=i(cs);Sm=s(Qk,"PyTorch"),Qk.forEach(t),Gm=s(bt," and "),ps=r(bt,"A",{href:!0,rel:!0});var ev=i(ps);Um=s(ev,"Tensorflow"),ev.forEach(t),Wm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),Yk.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var tv=i(yn);ll=r(tv,"SPAN",{});var nv=i(ll);v(hs.$$.fragment,nv),nv.forEach(t),tv.forEach(t),Bm=c(np),dl=r(np,"SPAN",{});var ov=i(dl);Rm=s(ov,"T5Config"),ov.forEach(t),np.forEach(t),$c=c(n),kt=r(n,"DIV",{class:!0});var Br=i(kt);v(us.$$.fragment,Br),Hm=c(Br),vt=r(Br,"P",{});var bo=i(vt);Vm=s(bo,"This is the configuration class to store the configuration of a "),_r=r(bo,"A",{href:!0});var sv=i(_r);Km=s(sv,"T5Model"),sv.forEach(t),Ym=s(bo," or a "),gr=r(bo,"A",{href:!0});var av=i(gr);Zm=s(av,"TFT5Model"),av.forEach(t),Jm=s(bo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(bo,"A",{href:!0,rel:!0});var rv=i(ms);Xm=s(rv,"t5-small"),rv.forEach(t),Qm=s(bo," architecture."),bo.forEach(t),ef=c(Br),Gt=r(Br,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var iv=i(Tr);nf=s(iv,"PretrainedConfig"),iv.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),br=r(Rr,"A",{href:!0});var lv=i(br);sf=s(lv,"PretrainedConfig"),lv.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Br.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var dv=i(wn);cl=r(dv,"SPAN",{});var cv=i(cl);v(fs.$$.fragment,cv),cv.forEach(t),dv.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var pv=i(pl);lf=s(pv,"T5Tokenizer"),pv.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var hv=i(Ts);pf=s(hv,"SentencePiece"),hv.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),bs=r(Ve,"P",{});var ap=i(bs);mf=s(ap,"This tokenizer inherits from "),kr=r(ap,"A",{href:!0});var uv=i(kr);ff=s(uv,"PreTrainedTokenizer"),uv.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ap.forEach(t),gf=c(Ve),qt=r(Ve,"DIV",{class:!0});var Hr=i(qt);v(ks.$$.fragment,Hr),Tf=c(Hr),hl=r(Hr,"P",{});var mv=i(hl);bf=s(mv,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),mv.forEach(t),kf=c(Hr),vs=r(Hr,"UL",{});var rp=i(vs);vr=r(rp,"LI",{});var ib=i(vr);vf=s(ib,"single sequence: "),ul=r(ib,"CODE",{});var fv=i(ul);yf=s(fv,"X </s>"),fv.forEach(t),ib.forEach(t),wf=c(rp),yr=r(rp,"LI",{});var lb=i(yr);$f=s(lb,"pair of sequences: "),ml=r(lb,"CODE",{});var _v=i(ml);xf=s(_v,"A </s> B </s>"),_v.forEach(t),lb.forEach(t),rp.forEach(t),Hr.forEach(t),zf=c(Ve),$n=r(Ve,"DIV",{class:!0});var ip=i($n);v(ys.$$.fragment,ip),jf=c(ip),ws=r(ip,"P",{});var lp=i(ws);qf=s(lp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fl=r(lp,"CODE",{});var gv=i(fl);Ef=s(gv,"prepare_for_model"),gv.forEach(t),Ff=s(lp," method."),lp.forEach(t),ip.forEach(t),Mf=c(Ve),xn=r(Ve,"DIV",{class:!0});var dp=i(xn);v($s.$$.fragment,dp),Cf=c(dp),_l=r(dp,"P",{});var Tv=i(_l);Pf=s(Tv,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Tv.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var bv=i(wr);v(xs.$$.fragment,bv),bv.forEach(t),Ve.forEach(t),jc=c(n),Wt=r(n,"H2",{class:!0});var cp=i(Wt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var kv=i(zn);gl=r(kv,"SPAN",{});var vv=i(gl);v(zs.$$.fragment,vv),vv.forEach(t),kv.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var yv=i(Tl);Lf=s(yv,"T5TokenizerFast"),yv.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);v(js.$$.fragment,Nt),Af=c(Nt),Bt=r(Nt,"P",{});var Vr=i(Bt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=r(Vr,"EM",{});var wv=i(bl);Df=s(wv,"tokenizers"),wv.forEach(t),Sf=s(Vr,` library). Based on
`),qs=r(Vr,"A",{href:!0,rel:!0});var $v=i(qs);Gf=s($v,"Unigram"),$v.forEach(t),Uf=s(Vr,"."),Vr.forEach(t),Wf=c(Nt),Es=r(Nt,"P",{});var pp=i(Es);Bf=s(pp,"This tokenizer inherits from "),$r=r(pp,"A",{href:!0});var xv=i($r);Rf=s(xv,"PreTrainedTokenizerFast"),xv.forEach(t),Hf=s(pp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),pp.forEach(t),Vf=c(Nt),Et=r(Nt,"DIV",{class:!0});var Kr=i(Et);v(Fs.$$.fragment,Kr),Kf=c(Kr),kl=r(Kr,"P",{});var zv=i(kl);Yf=s(zv,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),zv.forEach(t),Zf=c(Kr),Ms=r(Kr,"UL",{});var hp=i(Ms);xr=r(hp,"LI",{});var db=i(xr);Jf=s(db,"single sequence: "),vl=r(db,"CODE",{});var jv=i(vl);Xf=s(jv,"X </s>"),jv.forEach(t),db.forEach(t),Qf=c(hp),zr=r(hp,"LI",{});var cb=i(zr);e_=s(cb,"pair of sequences: "),yl=r(cb,"CODE",{});var qv=i(yl);t_=s(qv,"A </s> B </s>"),qv.forEach(t),cb.forEach(t),hp.forEach(t),Kr.forEach(t),n_=c(Nt),jn=r(Nt,"DIV",{class:!0});var up=i(jn);v(Cs.$$.fragment,up),o_=c(up),wl=r(up,"P",{});var Ev=i(wl);s_=s(Ev,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Ev.forEach(t),up.forEach(t),Nt.forEach(t),Ec=c(n),Rt=r(n,"H2",{class:!0});var mp=i(Rt);qn=r(mp,"A",{id:!0,class:!0,href:!0});var Fv=i(qn);$l=r(Fv,"SPAN",{});var Mv=i($l);v(Ps.$$.fragment,Mv),Mv.forEach(t),Fv.forEach(t),a_=c(mp),xl=r(mp,"SPAN",{});var Cv=i(xl);r_=s(Cv,"T5Model"),Cv.forEach(t),mp.forEach(t),Fc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);v(Ns.$$.fragment,xe),i_=c(xe),zl=r(xe,"P",{});var Pv=i(zl);l_=s(Pv,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Pv.forEach(t),d_=c(xe),Os=r(xe,"P",{});var fp=i(Os);c_=s(fp,"The T5 model was proposed in "),Ls=r(fp,"A",{href:!0,rel:!0});var Nv=i(Ls);p_=s(Nv,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Nv.forEach(t),h_=s(fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),fp.forEach(t),u_=c(xe),As=r(xe,"P",{});var _p=i(As);m_=s(_p,"This model inherits from "),jr=r(_p,"A",{href:!0});var Ov=i(jr);f_=s(Ov,"PreTrainedModel"),Ov.forEach(t),__=s(_p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),g_=c(xe),Is=r(xe,"P",{});var gp=i(Is);T_=s(gp,"This model is also a PyTorch "),Ds=r(gp,"A",{href:!0,rel:!0});var Lv=i(Ds);b_=s(Lv,"torch.nn.Module"),Lv.forEach(t),k_=s(gp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gp.forEach(t),v_=c(xe),lt=r(xe,"DIV",{class:!0});var ko=i(lt);v(Ss.$$.fragment,ko),y_=c(ko),Ht=r(ko,"P",{});var Yr=i(Ht);w_=s(Yr,"The "),qr=r(Yr,"A",{href:!0});var Av=i(qr);$_=s(Av,"T5Model"),Av.forEach(t),x_=s(Yr," forward method, overrides the "),jl=r(Yr,"CODE",{});var Iv=i(jl);z_=s(Iv,"__call__"),Iv.forEach(t),j_=s(Yr," special method."),Yr.forEach(t),q_=c(ko),v(En.$$.fragment,ko),E_=c(ko),v(Fn.$$.fragment,ko),ko.forEach(t),F_=c(xe),dt=r(xe,"DIV",{class:!0});var vo=i(dt);v(Gs.$$.fragment,vo),M_=c(vo),ql=r(vo,"P",{});var Dv=i(ql);C_=s(Dv,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Dv.forEach(t),P_=c(vo),El=r(vo,"P",{});var Sv=i(El);N_=s(Sv,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Sv.forEach(t),O_=c(vo),v(Mn.$$.fragment,vo),vo.forEach(t),L_=c(xe),Ft=r(xe,"DIV",{class:!0});var Zr=i(Ft);v(Us.$$.fragment,Zr),A_=c(Zr),Fl=r(Zr,"P",{});var Gv=i(Fl);I_=s(Gv,"Moves the model to cpu from a model parallel state."),Gv.forEach(t),D_=c(Zr),v(Cn.$$.fragment,Zr),Zr.forEach(t),xe.forEach(t),Mc=c(n),Vt=r(n,"H2",{class:!0});var Tp=i(Vt);Pn=r(Tp,"A",{id:!0,class:!0,href:!0});var Uv=i(Pn);Ml=r(Uv,"SPAN",{});var Wv=i(Ml);v(Ws.$$.fragment,Wv),Wv.forEach(t),Uv.forEach(t),S_=c(Tp),Cl=r(Tp,"SPAN",{});var Bv=i(Cl);G_=s(Bv,"T5ForConditionalGeneration"),Bv.forEach(t),Tp.forEach(t),Cc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);v(Bs.$$.fragment,ze),U_=c(ze),Rs=r(ze,"P",{});var bp=i(Rs);W_=s(bp,"T5 Model with a "),Pl=r(bp,"CODE",{});var Rv=i(Pl);B_=s(Rv,"language modeling"),Rv.forEach(t),R_=s(bp," head on top."),bp.forEach(t),H_=c(ze),Hs=r(ze,"P",{});var kp=i(Hs);V_=s(kp,"The T5 model was proposed in "),Vs=r(kp,"A",{href:!0,rel:!0});var Hv=i(Vs);K_=s(Hv,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Hv.forEach(t),Y_=s(kp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),kp.forEach(t),Z_=c(ze),Ks=r(ze,"P",{});var vp=i(Ks);J_=s(vp,"This model inherits from "),Er=r(vp,"A",{href:!0});var Vv=i(Er);X_=s(Vv,"PreTrainedModel"),Vv.forEach(t),Q_=s(vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vp.forEach(t),eg=c(ze),Ys=r(ze,"P",{});var yp=i(Ys);tg=s(yp,"This model is also a PyTorch "),Zs=r(yp,"A",{href:!0,rel:!0});var Kv=i(Zs);ng=s(Kv,"torch.nn.Module"),Kv.forEach(t),og=s(yp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yp.forEach(t),sg=c(ze),ct=r(ze,"DIV",{class:!0});var yo=i(ct);v(Js.$$.fragment,yo),ag=c(yo),Kt=r(yo,"P",{});var Jr=i(Kt);rg=s(Jr,"The "),Fr=r(Jr,"A",{href:!0});var Yv=i(Fr);ig=s(Yv,"T5ForConditionalGeneration"),Yv.forEach(t),lg=s(Jr," forward method, overrides the "),Nl=r(Jr,"CODE",{});var Zv=i(Nl);dg=s(Zv,"__call__"),Zv.forEach(t),cg=s(Jr," special method."),Jr.forEach(t),pg=c(yo),v(Nn.$$.fragment,yo),hg=c(yo),v(On.$$.fragment,yo),yo.forEach(t),ug=c(ze),pt=r(ze,"DIV",{class:!0});var wo=i(pt);v(Xs.$$.fragment,wo),mg=c(wo),Ol=r(wo,"P",{});var Jv=i(Ol);fg=s(Jv,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Jv.forEach(t),_g=c(wo),Ll=r(wo,"P",{});var Xv=i(Ll);gg=s(Xv,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Xv.forEach(t),Tg=c(wo),v(Ln.$$.fragment,wo),wo.forEach(t),bg=c(ze),Mt=r(ze,"DIV",{class:!0});var Xr=i(Mt);v(Qs.$$.fragment,Xr),kg=c(Xr),Al=r(Xr,"P",{});var Qv=i(Al);vg=s(Qv,"Moves the model to cpu from a model parallel state."),Qv.forEach(t),yg=c(Xr),v(An.$$.fragment,Xr),Xr.forEach(t),ze.forEach(t),Pc=c(n),Yt=r(n,"H2",{class:!0});var wp=i(Yt);In=r(wp,"A",{id:!0,class:!0,href:!0});var ey=i(In);Il=r(ey,"SPAN",{});var ty=i(Il);v(ea.$$.fragment,ty),ty.forEach(t),ey.forEach(t),wg=c(wp),Dl=r(wp,"SPAN",{});var ny=i(Dl);$g=s(ny,"T5EncoderModel"),ny.forEach(t),wp.forEach(t),Nc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);v(ta.$$.fragment,je),xg=c(je),Sl=r(je,"P",{});var oy=i(Sl);zg=s(oy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),oy.forEach(t),jg=c(je),na=r(je,"P",{});var $p=i(na);qg=s($p,"The T5 model was proposed in "),oa=r($p,"A",{href:!0,rel:!0});var sy=i(oa);Eg=s(sy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Op.forEach(t),KT=c(Ye),v(Kn.$$.fragment,Ye),YT=c(Ye),ft=r(Ye,"DIV",{class:!0});var jo=i(ft);v(za.$$.fragment,jo),ZT=c(jo),en=r(jo,"P",{});var ni=i(en);JT=s(ni,"The "),Lr=r(ni,"A",{href:!0});var qy=i(Lr);XT=s(qy,"TFT5ForConditionalGeneration"),qy.forEach(t),QT=s(ni," forward method, overrides the "),Xl=r(ni,"CODE",{});var Ey=i(Xl);e1=s(Ey,"__call__"),Ey.forEach(t),t1=s(ni," special method."),ni.forEach(t),n1=c(jo),v(Yn.$$.fragment,jo),o1=c(jo),v(Zn.$$.fragment,jo),jo.forEach(t),Ye.forEach(t),Dc=c(n),tn=r(n,"H2",{class:!0});var Lp=i(tn);Jn=r(Lp,"A",{id:!0,class:!0,href:!0});var Fy=i(Jn);Ql=r(Fy,"SPAN",{});var My=i(Ql);v(ja.$$.fragment,My),My.forEach(t),Fy.forEach(t),s1=c(Lp),ed=r(Lp,"SPAN",{});var Cy=i(ed);a1=s(Cy,"TFT5EncoderModel"),Cy.forEach(t),Lp.forEach(t),Sc=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);v(qa.$$.fragment,Ze),r1=c(Ze),td=r(Ze,"P",{});var Py=i(td);i1=s(Py,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Py.forEach(t),l1=c(Ze),Ea=r(Ze,"P",{});var Ap=i(Ea);d1=s(Ap,"The T5 model was proposed in "),Fa=r(Ap,"A",{href:!0,rel:!0});var Ny=i(Fa);c1=s(Ny,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
