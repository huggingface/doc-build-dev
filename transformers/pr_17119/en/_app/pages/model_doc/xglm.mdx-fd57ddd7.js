import{S as Ad,i as Od,s as Id,e as n,k as c,w as b,t as r,M as Dd,c as s,d as t,m as p,a,x as y,h as i,b as d,F as e,g as _,y as M,q as w,o as T,B as L,v as Nd,L as Gn}from"../../chunks/vendor-6b77c823.js";import{T as ys}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-1088f2fb.js";import{C as qn}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Xn}from"../../chunks/ExampleCodeBlock-5212b321.js";function Sd(x){let h,v,g,m,k;return m=new qn({props:{code:`from transformers import XGLMModel, XGLMConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/xglm/tokenization_xglm.py#L189",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/xglm/tokenization_xglm.py#L214",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/xglm/tokenization_xglm_fast.py#L139",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/xglm/tokenization_xglm_fast.py#L164",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.</p>
<p>Args &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17119/en/model_doc/xglm#transformers.XGLMConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/xglm/modeling_xglm.py#L852",returnDescription:`
<p>A <a
...
`}}),Xe=new ys({props:{$$slots:{default:[Rd]},$$scope:{ctx:x}}}),Ge=new Xn({props:{anchor:"transformers.XGLMForCausalLM.forward.example",$$slots:{default:[Ud]},$$scope:{ctx:x}}}),$t=new me({}),zt=new q({props:{name:"class transformers.FlaxXGLMModel",anchor:"transformers.FlaxXGLMModel",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17119/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
Whether or not to return a <a href="/docs/transformers/pr_17119/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/xglm/modeling_flax_xglm.py#L625",returnDescription:`
<p>A <a
...
`}}),Fe=new ys({props:{$$slots:{default:[Vd]},$$scope:{ctx:x}}}),Ee=new Xn({props:{anchor:"transformers.FlaxXGLMModel.__call__.example",$$slots:{default:[Hd]},$$scope:{ctx:x}}}),At=new me({}),Ot=new q({props:{name:"class transformers.FlaxXGLMForCausalLM",anchor:"transformers.FlaxXGLMForCausalLM",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17119/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),jn=c(),V=n("p"),Gs=r("This model was contributed by "),Ve=n("a"),qs=r("Suraj"),Fs=r(". The original code can be found "),He=n("a"),Es=r("here"),Ps=r("."),An=c(),te=n("h2"),_e=n("a"),qo=n("span"),b(Je.$$.fragment),Cs=c(),Fo=n("span"),js=r("XGLMConfig"),On=c(),A=n("div"),b(Ke.$$.fragment),As=c(),oe=n("p"),Os=r("This is the configuration class to store the configuration of a "),Qt=n("a"),Is=r("XGLMModel"),Ds=r(`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),Ze=n("a"),Ns=r("facebook/xglm-564M"),Ss=r(" architecture."),Ws=c(),ne=n("p"),Bs=r("Configuration objects inherit from "),Yt=n("a"),Rs=r("PretrainedConfig"),Us=r(` and can be used to control the model outputs. Read the
documentation from `),eo=n("a"),Vs=r("PretrainedConfig"),Hs=r(" for more information."),Js=c(),b(ke.$$.fragment),In=c(),se=n("h2"),ve=n("a"),Eo=n("span"),b(Qe.$$.fragment),Ks=c(),Po=n("span"),Zs=r("XGLMTokenizer"),Dn=c(),$=n("div"),b(Ye.$$.fragment),Qs=c(),B=n("p"),Ys=r("Adapted from "),to=n("a"),ea=r("RobertaTokenizer"),ta=r(" and "),oo=n("a"),oa=r("XLNetTokenizer"),na=r(`. Based on
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Or=c(),D=n("div"),b(xt.$$.fragment),Ir=c(),de=n("p"),Dr=r("The "),go=n("a"),Nr=r("XGLMForCausalLM"),Sr=r(" forward method, overrides the "),tn=n("code"),Wr=r("__call__"),Br=r(" special method."),Rr=c(),b(Xe.$$.fragment),Ur=c(),b(Ge.$$.fragment),Vn=c(),ce=n("h2"),qe=n("a"),on=n("span"),b($t.$$.fragment),Vr=c(),nn=n("span"),Hr=r("FlaxXGLMModel"),Hn=c(),G=n("div"),b(zt.$$.fragment),Jr=c(),Xt=n("p"),Kr=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
documentation from `),eo=s(yo,"A",{href:!0});var fl=a(eo);Vs=i(fl,"PretrainedConfig"),fl.forEach(t),Hs=i(yo," for more information."),yo.forEach(t),Js=p(Ae),y(ke.$$.fragment,Ae),Ae.forEach(t),In=p(o),se=s(o,"H2",{class:!0});var Yn=a(se);ve=s(Yn,"A",{id:!0,class:!0,href:!0});var gl=a(ve);Eo=s(gl,"SPAN",{});var _l=a(Eo);y(Qe.$$.fragment,_l),_l.forEach(t),gl.forEach(t),Ks=p(Yn),Po=s(Yn,"SPAN",{});var kl=a(Po);Zs=i(kl,"XGLMTokenizer"),kl.forEach(t),Yn.forEach(t),Dn=p(o),$=s(o,"DIV",{class:!0});var C=a($);y(Ye.$$.fragment,C),Qs=p(C),B=s(C,"P",{});var Oe=a(B);Ys=i(Oe,"Adapted from "),to=s(Oe,"A",{href:!0});var vl=a(to);ea=i(vl,"RobertaTokenizer"),vl.forEach(t),ta=i(Oe," and "),oo=s(Oe,"A",{href:!0});var bl=a(oo);oa=i(bl,"XLNetTokenizer"),bl.forEach(t),na=i(Oe,`. Based on
`),et=s(Oe,"A",{href:!0,rel:!0});var yl=a(et);sa=i(yl,"SentencePiece"),yl.forEach(t),aa=i(Oe,"."),Oe.forEach(t),ra=p(C),tt=s(C,"P",{});var es=a(tt);ia=i(es,"This tokenizer inherits from "),no=s(es,"A",{href:!0});var Ml=a(no);la=i(Ml,"PreTrainedTokenizer"),Ml.forEach(t),da=i(es,` which contains most of the main methods. Users should refer to
