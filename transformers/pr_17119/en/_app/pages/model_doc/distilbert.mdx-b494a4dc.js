...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17119/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17119/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),e1=p(),Rr=o("p"),t1=a("This model is also a "),Ur=o("a"),s1=a("tf.keras.Model"),o1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),n1=p(),T(zo.$$.fragment),r1=p(),Ye=o("div"),T(Hr.$$.fragment),a1=p(),$s=o("p"),i1=a("The "),Zi=o("a"),l1=a("TFDistilBertForSequenceClassification"),d1=a(" forward method, overrides the "),wd=o("code"),c1=a("__call__"),p1=a(" special method."),h1=p(),T(jo.$$.fragment),u1=p(),T(Co.$$.fragment),f1=p(),T(qo.$$.fragment),Zp=p(),ws=o("h2"),Po=o("a"),yd=o("span"),T(Kr.$$.fragment),m1=p(),Fd=o("span"),g1=a("TFDistilBertForMultipleChoice"),eh=p(),Le=o("div"),T(Vr.$$.fragment),_1=p(),Dd=o("p"),b1=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),v1=p(),Jr=o("p"),k1=a("This model inherits from "),el=o("a"),T1=a("TFPreTrainedModel"),$1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),w1=p(),Gr=o("p"),y1=a("This model is also a "),Xr=o("a"),F1=a("tf.keras.Model"),D1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),x1=p(),T(Ao.$$.fragment),B1=p(),mt=o("div"),T(Yr.$$.fragment),M1=p(),ys=o("p"),E1=a("The "),tl=o("a"),z1=a("TFDistilBertForMultipleChoice"),j1=a(" forward method, overrides the "),xd=o("code"),C1=a("__call__"),q1=a(" special method."),P1=p(),T(Oo.$$.fragment),A1=p(),T(No.$$.fragment),th=p(),Fs=o("h2"),Lo=o("a"),Bd=o("span"),T(Zr.$$.fragment),O1=p(),Md=o("span"),N1=a("TFDistilBertForTokenClassification"),sh=p(),Se=o("div"),T(ea.$$.fragment),L1=p(),Ed=o("p"),S1=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),I1=p(),ta=o("p"),W1=a("This model inherits from "),sl=o("a"),Q1=a("TFPreTrainedModel"),R1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),U1=p(),sa=o("p"),H1=a("This model is also a "),oa=o("a"),K1=a("tf.keras.Model"),V1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),J1=p(),T(So.$$.fragment),G1=p(),Ze=o("div"),T(na.$$.fragment),X1=p(),Ds=o("p"),Y1=a("The "),ol=o("a"),Z1=a("TFDistilBertForTokenClassification"),eb=a(" forward method, overrides the "),zd=o("code"),tb=a("__call__"),sb=a(" special method."),ob=p(),T(Io.$$.fragment),nb=p(),T(Wo.$$.fragment),rb=p(),T(Qo.$$.fragment),oh=p(),xs=o("h2"),Ro=o("a"),jd=o("span"),T(ra.$$.fragment),ab=p(),Cd=o("span"),ib=a("TFDistilBertForQuestionAnswering"),nh=p(),Ie=o("div"),T(aa.$$.fragment),lb=p(),Bs=o("p"),db=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bb=p(),la=o("p"),vb=a("This model is also a "),da=o("a"),kb=a("tf.keras.Model"),Tb=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kh.forEach(t),e1=h(yt),Rr=n(yt,"P",{});var Vh=r(Rr);t1=i(Vh,"This model is also a "),Ur=n(Vh,"A",{href:!0,rel:!0});var Ew=r(Ur);s1=i(Ew,"tf.keras.Model"),Ew.forEach(t),o1=i(Vh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vh.forEach(t),n1=h(yt),$(zo.$$.fragment,yt),r1=h(yt),Ye=n(yt,"DIV",{class:!0});var Xt=r(Ye);$(Hr.$$.fragment,Xt),a1=h(Xt),$s=n(Xt,"P",{});var Tl=r($s);i1=i(Tl,"The "),Zi=n(Tl,"A",{href:!0});var zw=r(Zi);l1=i(zw,"TFDistilBertForSequenceClassification"),zw.forEach(t),d1=i(Tl," forward method, overrides the "),wd=n(Tl,"CODE",{});var jw=r(wd);c1=i(jw,"__call__"),jw.forEach(t),p1=i(Tl," special method."),Tl.forEach(t),h1=h(Xt),$(jo.$$.fragment,Xt),u1=h(Xt),$(Co.$$.fragment,Xt),f1=h(Xt),$(qo.$$.fragment,Xt),Xt.forEach(t),yt.forEach(t),Zp=h(s),ws=n(s,"H2",{class:!0});var Jh=r(ws);Po=n(Jh,"A",{id:!0,class:!0,href:!0});var Cw=r(Po);yd=n(Cw,"SPAN",{});var qw=r(yd);$(Kr.$$.fragment,qw),qw.forEach(t),Cw.forEach(t),m1=h(Jh),Fd=n(Jh,"SPAN",{});var Pw=r(Fd);g1=i(Pw,"TFDistilBertForMultipleChoice"),Pw.forEach(t),Jh.forEach(t),eh=h(s),Le=n(s,"DIV",{class:!0});var Ft=r(Le);$(Vr.$$.fragment,Ft),_1=h(Ft),Dd=n(Ft,"P",{});var Aw=r(Dd);b1=i(Aw,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Aw.forEach(t),v1=h(Ft),Jr=n(Ft,"P",{});var Gh=r(Jr);k1=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var Ow=r(el);T1=i(Ow,"TFPreTrainedModel"),Ow.forEach(t),$1=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),w1=h(Ft),Gr=n(Ft,"P",{});var Xh=r(Gr);y1=i(Xh,"This model is also a "),Xr=n(Xh,"A",{href:!0,rel:!0});var Nw=r(Xr);F1=i(Nw,"tf.keras.Model"),Nw.forEach(t),D1=i(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),x1=h(Ft),$(Ao.$$.fragment,Ft),B1=h(Ft),mt=n(Ft,"DIV",{class:!0});var vn=r(mt);$(Yr.$$.fragment,vn),M1=h(vn),ys=n(vn,"P",{});var $l=r(ys);E1=i($l,"The "),tl=n($l,"A",{href:!0});var Lw=r(tl);z1=i(Lw,"TFDistilBertForMultipleChoice"),Lw.forEach(t),j1=i($l," forward method, overrides the "),xd=n($l,"CODE",{});var Sw=r(xd);C1=i(Sw,"__call__"),Sw.forEach(t),q1=i($l," special method."),$l.forEach(t),P1=h(vn),$(Oo.$$.fragment,vn),A1=h(vn),$(No.$$.fragment,vn),vn.forEach(t),Ft.forEach(t),th=h(s),Fs=n(s,"H2",{class:!0});var Yh=r(Fs);Lo=n(Yh,"A",{id:!0,class:!0,href:!0});var Iw=r(Lo);Bd=n(Iw,"SPAN",{});var Ww=r(Bd);$(Zr.$$.fragment,Ww),Ww.forEach(t),Iw.forEach(t),O1=h(Yh),Md=n(Yh,"SPAN",{});var Qw=r(Md);N1=i(Qw,"TFDistilBertForTokenClassification"),Qw.forEach(t),Yh.forEach(t),sh=h(s),Se=n(s,"DIV",{class:!0});var Dt=r(Se);$(ea.$$.fragment,Dt),L1=h(Dt),Ed=n(Dt,"P",{});var Rw=r(Ed);S1=i(Rw,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Rw.forEach(t),I1=h(Dt),ta=n(Dt,"P",{});var Zh=r(ta);W1=i(Zh,"This model inherits from "),sl=n(Zh,"A",{href:!0});var Uw=r(sl);Q1=i(Uw,"TFPreTrainedModel"),Uw.forEach(t),R1=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),U1=h(Dt),sa=n(Dt,"P",{});var eu=r(sa);H1=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var Hw=r(oa);K1=i(Hw,"tf.keras.Model"),Hw.forEach(t),V1=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),J1=h(Dt),$(So.$$.fragment,Dt),G1=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),X1=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Y1=i(wl,"The "),ol=n(wl,"A",{href:!0});var Kw=r(ol);Z1=i(Kw,"TFDistilBertForTokenClassification"),Kw.forEach(t),eb=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Vw=r(zd);tb=i(Vw,"__call__"),Vw.forEach(t),sb=i(wl," special method."),wl.forEach(t),ob=h(Yt),$(Io.$$.fragment,Yt),nb=h(Yt),$(Wo.$$.fragment,Yt),rb=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Ro);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),ab=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);ib=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),lb=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);db=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);cb=i(Yw,"span start logits"),Yw.forEach(t),pb=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);hb=i(Zw,"span end logits"),Zw.forEach(t),ub=i(yl,")."),yl.forEach(t),fb=h(xt),ia=n(xt,"P",{});var su=r(ia);mb=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var ey=r(nl);gb=i(ey,"TFPreTrainedModel"),ey.forEach(t),_b=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bb=h(xt),la=n(xt,"P",{});var ou=r(la);vb=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var ty=r(da);kb=i(ty,"tf.keras.Model"),ty.forEach(t),Tb=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$b=h(xt),$(Uo.$$.fragment,xt),wb=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yb=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);Fb=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var sy=r(rl);Db=i(sy,"TFDistilBertForQuestionAnswering"),sy.forEach(t),xb=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var oy=r(Ad);Bb=i(oy,"__call__"),oy.forEach(t),Mb=i(Fl," special method."),Fl.forEach(t),Eb=h(Zt),$(Ho.$$.fragment,Zt),zb=h(Zt),$(Ko.$$.fragment,Zt),jb=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var ny=r(Jo);Od=n(ny,"SPAN",{});var ry=r(Od);$(pa.$$.fragment,ry),ry.forEach(t),ny.forEach(t),Cb=h(nu),Nd=n(nu,"SPAN",{});var ay=r(Nd);qb=i(ay,"FlaxDistilBertModel"),ay.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pb=h(st),Ld=n(st,"P",{});var iy=r(Ld);Ab=i(iy,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iy.forEach(t),Ob=h(st),ua=n(st,"P",{});var ru=r(ua);Nb=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var ly=r(al);Lb=i(ly,"FlaxPreTrainedModel"),ly.forEach(t),Sb=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Ib=h(st),fa=n(st,"P",{});var au=r(fa);Wb=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var dy=r(ma);Qb=i(dy,"flax.linen.Module"),dy.forEach(t),Rb=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Ub=h(st),Sd=n(st,"P",{});var cy=r(Sd);Hb=i(cy,"Finally, this model supports inherent JAX features such as:"),cy.forEach(t),Kb=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var py=r(Id);ga=n(py,"A",{href:!0,rel:!0});var hy=r(ga);Vb=i(hy,"Just-In-Time (JIT) compilation"),hy.forEach(t),py.forEach(t),Jb=h(kn),Wd=n(kn,"LI",{});var uy=r(Wd);_a=n(uy,"A",{href:!0,rel:!0});var fy=r(_a);Gb=i(fy,"Automatic Differentiation"),fy.forEach(t),uy.forEach(t),Xb=h(kn),Qd=n(kn,"LI",{});var my=r(Qd);ba=n(my,"A",{href:!0,rel:!0});var gy=r(ba);Yb=i(gy,"Vectorization"),gy.forEach(t),my.forEach(t),Zb=h(kn),Rd=n(kn,"LI",{});var _y=r(Rd);va=n(_y,"A",{href:!0,rel:!0});var by=r(va);ev=i(by,"Parallelization"),by.forEach(t),_y.forEach(t),kn.forEach(t),tv=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sv=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ov=i(Dl,"The "),Ud=n(Dl,"CODE",{});var vy=r(Ud);nv=i(vy,"FlaxDistilBertPreTrainedModel"),vy.forEach(t),rv=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var ky=r(Hd);av=i(ky,"__call__"),ky.forEach(t),iv=i(Dl," special method."),Dl.forEach(t),lv=h(Tn),$(Go.$$.fragment,Tn),dv=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var Ty=r(Yo);Kd=n(Ty,"SPAN",{});var $y=r(Kd);$(Ta.$$.fragment,$y),$y.forEach(t),Ty.forEach(t),cv=h(iu),Vd=n(iu,"SPAN",{});var wy=r(Vd);pv=i(wy,"FlaxDistilBertForMaskedLM"),wy.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hv=h(ot),wa=n(ot,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yy=r(Jd);fv=i(yy,"language modeling"),yy.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(ot),ya=n(ot,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Fy=r(il);bv=i(Fy,"FlaxPreTrainedModel"),Fy.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
