import{S as Xv,i as Kv,s as Zv,e as a,k as u,w as y,t as i,M as Yv,c as s,d as t,m as h,a as r,x as v,h as d,b as f,G as e,g as k,y as T,q as w,o as $,B as x,v as eT,L as P}from"../../chunks/vendor-hf-doc-builder.js";import{T as Fe}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as V}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function tT(F){let l,g,m,c,_;return c=new C({props:{code:`from transformers import BartModel, BartConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/tokenization_bart.py#L390",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
Whether the post processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/tokenization_bart_fast.py#L70"}}),Eo=new E({props:{anchor:"transformers.BartTokenizerFast.example",$$slots:{default:[aT]},$$scope:{ctx:F}}}),Po=new Fe({props:{$$slots:{default:[sT]},$$scope:{ctx:F}}}),Ma=new B({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/tokenization_bart_fast.py#L283",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18114/en/model_doc/bart#transformers.BartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_bart.py#L1312",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_bart.py#L1455",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_bart.py#L1581",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_bart.py#L1730",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_tf_bart.py#L1182",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_tf_bart.py#L1293",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L999",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L1062",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L1331",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18114/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18114/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18114/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18114/src/transformers/models/bart/modeling_flax_bart.py#L1802",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18114/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),Tf=h(wt),es=s(wt,"P",{});var ap=r(es);wf=d(ap,"This model is also a PyTorch "),ts=s(ap,"A",{href:!0,rel:!0});var e1=r(ts);$f=d(e1,"torch.nn.Module"),e1.forEach(t),xf=d(ap,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ap.forEach(t),Ff=h(wt),Ce=s(wt,"DIV",{class:!0});var $t=r(Ce);v(os.$$.fragment,$t),zf=h($t),Zt=s($t,"P",{});var mi=r(Zt);qf=d(mi,"The "),Vr=s(mi,"A",{href:!0});var t1=r(Vr);Bf=d(t1,"BartForQuestionAnswering"),t1.forEach(t),jf=d(mi," forward method, overrides the "),fd=s(mi,"CODE",{});var o1=r(fd);Cf=d(o1,"__call__"),o1.forEach(t),Mf=d(mi," special method."),mi.forEach(t),Ef=h($t),v(Xo.$$.fragment,$t),Pf=h($t),v(Ko.$$.fragment,$t),Af=h($t),v(Zo.$$.fragment,$t),$t.forEach(t),wt.forEach(t),fc=h(o),Yt=s(o,"H2",{class:!0});var sp=r(Yt);Yo=s(sp,"A",{id:!0,class:!0,href:!0});var n1=r(Yo);_d=s(n1,"SPAN",{});var a1=r(_d);v(ns.$$.fragment,a1),a1.forEach(t),n1.forEach(t),Sf=h(sp),gd=s(sp,"SPAN",{});var s1=r(gd);Of=d(s1,"BartForCausalLM"),s1.forEach(t),sp.forEach(t),_c=h(o),eo=s(o,"DIV",{class:!0});var rp=r(eo);v(as.$$.fragment,rp),If=h(rp),en=s(rp,"DIV",{class:!0});var ip=r(en);v(ss.$$.fragment,ip),Nf=h(ip),v(tn.$$.fragment,ip),ip.forEach(t),rp.forEach(t),gc=h(o),to=s(o,"H2",{class:!0});var dp=r(to);on=s(dp,"A",{id:!0,class:!0,href:!0});var r1=r(on);bd=s(r1,"SPAN",{});var i1=r(bd);v(rs.$$.fragment,i1),i1.forEach(t),r1.forEach(t),Lf=h(dp),kd=s(dp,"SPAN",{});var d1=r(kd);Df=d(d1,"TFBartModel"),d1.forEach(t),dp.forEach(t),bc=h(o),$e=s(o,"DIV",{class:!0});var xt=r($e);v(is.$$.fragment,xt),Gf=h(xt),ds=s(xt,"P",{});var lp=r(ds);Wf=d(lp,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Qf=h(xt),ls=s(xt,"P",{});var cp=r(ls);Hf=d(cp,"This model is also a "),cs=s(cp,"A",{href:!0,rel:!0});var c1=r(cs);Vf=d(c1,"tf.keras.Model"),c1.forEach(t),Jf=d(cp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cp.forEach(t),Xf=h(xt),v(nn.$$.fragment,xt),Kf=h(xt),Je=s(xt,"DIV",{class:!0});var Xn=r(Je);v(ps.$$.fragment,Xn),Zf=h(Xn),oo=s(Xn,"P",{});var fi=r(oo);Yf=d(fi,"The "),Xr=s(fi,"A",{href:!0});var p1=r(Xr);e_=d(p1,"TFBartModel"),p1.forEach(t),t_=d(fi," forward method, overrides the "),yd=s(fi,"CODE",{});var u1=r(yd);o_=d(u1,"__call__"),u1.forEach(t),n_=d(fi," special method."),fi.forEach(t),a_=h(Xn),v(an.$$.fragment,Xn),s_=h(Xn),v(sn.$$.fragment,Xn),Xn.forEach(t),xt.forEach(t),kc=h(o),no=s(o,"H2",{class:!0});var pp=r(no);rn=s(pp,"A",{id:!0,class:!0,href:!0});var h1=r(rn);vd=s(h1,"SPAN",{});var m1=r(vd);v(us.$$.fragment,m1),m1.forEach(t),h1.forEach(t),r_=h(pp),Td=s(pp,"SPAN",{});var f1=r(Td);i_=d(f1,"TFBartForConditionalGeneration"),f1.forEach(t),pp.forEach(t),yc=h(o),xe=s(o,"DIV",{class:!0});var Ft=r(xe);v(hs.$$.fragment,Ft),d_=h(Ft),ms=s(Ft,"P",{});var up=r(ms);l_=d(up,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Kr=s(up,"A",{href:!0});var _1=r(Kr);c_=d(_1,"TFPreTrainedModel"),_1.forEach(t),p_=d(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),u_=h(Ft),fs=s(Ft,"P",{});var hp=r(fs);h_=d(hp,"This model is also a "),_s=s(hp,"A",{href:!0,rel:!0});var g1=r(_s);m_=d(g1,"tf.keras.Model"),g1.forEach(t),f_=d(hp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hp.forEach(t),__=h(Ft),v(dn.$$.fragment,Ft),g_=h(Ft),Me=s(Ft,"DIV",{class:!0});var zt=r(Me);v(gs.$$.fragment,zt),b_=h(zt),ao=s(zt,"P",{});var _i=r(ao);k_=d(_i,"The "),Zr=s(_i,"A",{href:!0});var b1=r(Zr);y_=d(b1,"TFBartForConditionalGeneration"),b1.forEach(t),v_=d(_i," forward method, overrides the "),wd=s(_i,"CODE",{});var k1=r(wd);T_=d(k1,"__call__"),k1.forEach(t),w_=d(_i," special method."),_i.forEach(t),$_=h(zt),v(ln.$$.fragment,zt),x_=h(zt),v(cn.$$.fragment,zt),F_=h(zt),v(pn.$$.fragment,zt),zt.forEach(t),Ft.forEach(t),vc=h(o),so=s(o,"H2",{class:!0});var mp=r(so);un=s(mp,"A",{id:!0,class:!0,href:!0});var y1=r(un);$d=s(y1,"SPAN",{});var v1=r($d);v(bs.$$.fragment,v1),v1.forEach(t),y1.forEach(t),z_=h(mp),xd=s(mp,"SPAN",{});var T1=r(xd);q_=d(T1,"FlaxBartModel"),T1.forEach(t),mp.forEach(t),Tc=h(o),R=s(o,"DIV",{class:!0});var me=r(R);v(ks.$$.fragment,me),B_=h(me),ys=s(me,"P",{});var fp=r(ys);j_=d(fp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),_p.forEach(t),O_=h(me),Fd=s(me,"P",{});var x1=r(Fd);I_=d(x1,"Finally, this model supports inherent JAX features such as:"),x1.forEach(t),N_=h(me),pt=s(me,"UL",{});var Kn=r(pt);zd=s(Kn,"LI",{});var F1=r(zd);ws=s(F1,"A",{href:!0,rel:!0});var z1=r(ws);L_=d(z1,"Just-In-Time (JIT) compilation"),z1.forEach(t),F1.forEach(t),D_=h(Kn),qd=s(Kn,"LI",{});var q1=r(qd);$s=s(q1,"A",{href:!0,rel:!0});var B1=r($s);G_=d(B1,"Automatic Differentiation"),B1.forEach(t),q1.forEach(t),W_=h(Kn),Bd=s(Kn,"LI",{});var j1=r(Bd);xs=s(j1,"A",{href:!0,rel:!0});var C1=r(xs);U_=d(C1,"Vectorization"),C1.forEach(t),j1.forEach(t),R_=h(Kn),jd=s(Kn,"LI",{});var M1=r(jd);Fs=s(M1,"A",{href:!0,rel:!0});var E1=r(Fs);Q_=d(E1,"Parallelization"),E1.forEach(t),M1.forEach(t),Kn.forEach(t),H_=h(me),Xe=s(me,"DIV",{class:!0});var Zn=r(Xe);v(zs.$$.fragment,Zn),V_=h(Zn),ro=s(Zn,"P",{});var gi=r(ro);J_=d(gi,"The "),Cd=s(gi,"CODE",{});var P1=r(Cd);X_=d(P1,"FlaxBartPreTrainedModel"),P1.forEach(t),K_=d(gi," forward method, overrides the "),Md=s(gi,"CODE",{});var A1=r(Md);Z_=d(A1,"__call__"),A1.forEach(t),Y_=d(gi," special method."),gi.forEach(t),eg=h(Zn),v(hn.$$.fragment,Zn),tg=h(Zn),v(mn.$$.fragment,Zn),Zn.forEach(t),og=h(me),fn=s(me,"DIV",{class:!0});var gp=r(fn);v(qs.$$.fragment,gp),ng=h(gp),v(_n.$$.fragment,gp),gp.forEach(t),ag=h(me),gn=s(me,"DIV",{class:!0});var bp=r(gn);v(Bs.$$.fragment,bp),sg=h(bp),v(bn.$$.fragment,bp),bp.forEach(t),me.forEach(t),wc=h(o),io=s(o,"H2",{class:!0});var kp=r(io);kn=s(kp,"A",{id:!0,class:!0,href:!0});var S1=r(kn);Ed=s(S1,"SPAN",{});var O1=r(Ed);v(js.$$.fragment,O1),O1.forEach(t),S1.forEach(t),rg=h(kp),Pd=s(kp,"SPAN",{});var I1=r(Pd);ig=d(I1,"FlaxBartForConditionalGeneration"),I1.forEach(t),kp.forEach(t),$c=h(o),Q=s(o,"DIV",{class:!0});var fe=r(Q);v(Cs.$$.fragment,fe),dg=h(fe),Ms=s(fe,"P",{});var yp=r(Ms);lg=d(yp,`The BART Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),vp.forEach(t),_g=h(fe),Ad=s(fe,"P",{});var D1=r(Ad);gg=d(D1,"Finally, this model supports inherent JAX features such as:"),D1.forEach(t),bg=h(fe),ut=s(fe,"UL",{});var Yn=r(ut);Sd=s(Yn,"LI",{});var G1=r(Sd);As=s(G1,"A",{href:!0,rel:!0});var W1=r(As);kg=d(W1,"Just-In-Time (JIT) compilation"),W1.forEach(t),G1.forEach(t),yg=h(Yn),Od=s(Yn,"LI",{});var U1=r(Od);Ss=s(U1,"A",{href:!0,rel:!0});var R1=r(Ss);vg=d(R1,"Automatic Differentiation"),R1.forEach(t),U1.forEach(t),Tg=h(Yn),Id=s(Yn,"LI",{});var Q1=r(Id);Os=s(Q1,"A",{href:!0,rel:!0});var H1=r(Os);wg=d(H1,"Vectorization"),H1.forEach(t),Q1.forEach(t),$g=h(Yn),Nd=s(Yn,"LI",{});var V1=r(Nd);Is=s(V1,"A",{href:!0,rel:!0});var J1=r(Is);xg=d(J1,"Parallelization"),J1.forEach(t),V1.forEach(t),Yn.forEach(t),Fg=h(fe),Ee=s(fe,"DIV",{class:!0});var qt=r(Ee);v(Ns.$$.fragment,qt),zg=h(qt),lo=s(qt,"P",{});var bi=r(lo);qg=d(bi,"The "),Ld=s(bi,"CODE",{});var X1=r(Ld);Bg=d(X1,"FlaxBartPreTrainedModel"),X1.forEach(t),jg=d(bi," forward method, overrides the "),Dd=s(bi,"CODE",{});var K1=r(Dd);Cg=d(K1,"__call__"),K1.forEach(t),Mg=d(bi," special method."),bi.forEach(t),Eg=h(qt),v(yn.$$.fragment,qt),Pg=h(qt),v(vn.$$.fragment,qt),Ag=h(qt),v(Tn.$$.fragment,qt),qt.forEach(t),Sg=h(fe),wn=s(fe,"DIV",{class:!0});var Tp=r(wn);v(Ls.$$.fragment,Tp),Og=h(Tp),v($n.$$.fragment,Tp),Tp.forEach(t),Ig=h(fe),xn=s(fe,"DIV",{class:!0});var wp=r(xn);v(Ds.$$.fragment,wp),Ng=h(wp),v(Fn.$$.fragment,wp),wp.forEach(t),fe.forEach(t),xc=h(o),co=s(o,"H2",{class:!0});var $p=r(co);zn=s($p,"A",{id:!0,class:!0,href:!0});var Z1=r(zn);Gd=s(Z1,"SPAN",{});var Y1=r(Gd);v(Gs.$$.fragment,Y1),Y1.forEach(t),Z1.forEach(t),Lg=h($p),Wd=s($p,"SPAN",{});var ev=r(Wd);Dg=d(ev,"FlaxBartForSequenceClassification"),ev.forEach(t),$p.forEach(t),Fc=h(o),N=s(o,"DIV",{class:!0});var te=r(N);v(Ws.$$.fragment,te),Gg=h(te),Ud=s(te,"P",{});var tv=r(Ud);Wg=d(tv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),tv.forEach(t),Ug=h(te),Us=s(te,"P",{});var xp=r(Us);Rg=d(xp,"This model inherits from "),ti=s(xp,"A",{href:!0});var ov=r(ti);Qg=d(ov,"FlaxPreTrainedModel"),ov.forEach(t),Hg=d(xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fp.forEach(t),Zg=h(te),Rd=s(te,"P",{});var av=r(Rd);Yg=d(av,"Finally, this model supports inherent JAX features such as:"),av.forEach(t),eb=h(te),ht=s(te,"UL",{});var ea=r(ht);Qd=s(ea,"LI",{});var sv=r(Qd);Hs=s(sv,"A",{href:!0,rel:!0});var rv=r(Hs);tb=d(rv,"Just-In-Time (JIT) compilation"),rv.forEach(t),sv.forEach(t),ob=h(ea),Hd=s(ea,"LI",{});var iv=r(Hd);Vs=s(iv,"A",{href:!0,rel:!0});var dv=r(Vs);nb=d(dv,"Automatic Differentiation"),dv.forEach(t),iv.forEach(t),ab=h(ea),Vd=s(ea,"LI",{});var lv=r(Vd);Js=s(lv,"A",{href:!0,rel:!0});var cv=r(Js);sb=d(cv,"Vectorization"),cv.forEach(t),lv.forEach(t),rb=h(ea),Jd=s(ea,"LI",{});var pv=r(Jd);Xs=s(pv,"A",{href:!0,rel:!0});var uv=r(Xs);ib=d(uv,"Parallelization"),uv.forEach(t),pv.forEach(t),ea.forEach(t),db=h(te),Ke=s(te,"DIV",{class:!0});var ta=r(Ke);v(Ks.$$.fragment,ta),lb=h(ta),po=s(ta,"P",{});var ki=r(po);cb=d(ki,"The "),Xd=s(ki,"CODE",{});var hv=r(Xd);pb=d(hv,"FlaxBartPreTrainedModel"),hv.forEach(t),ub=d(ki," forward method, overrides the "),Kd=s(ki,"CODE",{});var mv=r(Kd);hb=d(mv,"__call__"),mv.forEach(t),mb=d(ki," special method."),ki.forEach(t),fb=h(ta),v(qn.$$.fragment,ta),_b=h(ta),v(Bn.$$.fragment,ta),ta.forEach(t),gb=h(te),jn=s(te,"DIV",{class:!0});var zp=r(jn);v(Zs.$$.fragment,zp),bb=h(zp),v(Cn.$$.fragment,zp),zp.forEach(t),kb=h(te),Mn=s(te,"DIV",{class:!0});var qp=r(Mn);v(Ys.$$.fragment,qp),yb=h(qp),v(En.$$.fragment,qp),qp.forEach(t),te.forEach(t),zc=h(o),uo=s(o,"H2",{class:!0});var Bp=r(uo);Pn=s(Bp,"A",{id:!0,class:!0,href:!0});var fv=r(Pn);Zd=s(fv,"SPAN",{});var _v=r(Zd);v(er.$$.fragment,_v),_v.forEach(t),fv.forEach(t),vb=h(Bp),Yd=s(Bp,"SPAN",{});var gv=r(Yd);Tb=d(gv,"FlaxBartForQuestionAnswering"),gv.forEach(t),Bp.forEach(t),qc=h(o),L=s(o,"DIV",{class:!0});var oe=r(L);v(tr.$$.fragment,oe),wb=h(oe),ho=s(oe,"P",{});var yi=r(ho);$b=d(yi,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),el=s(yi,"CODE",{});var bv=r(el);xb=d(bv,"span start logits"),bv.forEach(t),Fb=d(yi," and "),tl=s(yi,"CODE",{});var kv=r(tl);zb=d(kv,"span end logits"),kv.forEach(t),qb=d(yi,")."),yi.forEach(t),Bb=h(oe),or=s(oe,"P",{});var jp=r(or);jb=d(jp,"This model inherits from "),oi=s(jp,"A",{href:!0});var yv=r(oi);Cb=d(yv,"FlaxPreTrainedModel"),yv.forEach(t),Mb=d(jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cp.forEach(t),Ob=h(oe),ol=s(oe,"P",{});var Tv=r(ol);Ib=d(Tv,"Finally, this model supports inherent JAX features such as:"),Tv.forEach(t),Nb=h(oe),mt=s(oe,"UL",{});var oa=r(mt);nl=s(oa,"LI",{});var wv=r(nl);sr=s(wv,"A",{href:!0,rel:!0});var $v=r(sr);Lb=d($v,"Just-In-Time (JIT) compilation"),$v.forEach(t),wv.forEach(t),Db=h(oa),al=s(oa,"LI",{});var xv=r(al);rr=s(xv,"A",{href:!0,rel:!0});var Fv=r(rr);Gb=d(Fv,"Automatic Differentiation"),Fv.forEach(t),xv.forEach(t),Wb=h(oa),sl=s(oa,"LI",{});var zv=r(sl);ir=s(zv,"A",{href:!0,rel:!0});var qv=r(ir);Ub=d(qv,"Vectorization"),qv.forEach(t),zv.forEach(t),Rb=h(oa),rl=s(oa,"LI",{});var Bv=r(rl);dr=s(Bv,"A",{href:!0,rel:!0});var jv=r(dr);Qb=d(jv,"Parallelization"),jv.forEach(t),Bv.forEach(t),oa.forEach(t),Hb=h(oe),Ze=s(oe,"DIV",{class:!0});var na=r(Ze);v(lr.$$.fragment,na),Vb=h(na),mo=s(na,"P",{});var vi=r(mo);Jb=d(vi,"The "),il=s(vi,"CODE",{});var Cv=r(il);Xb=d(Cv,"FlaxBartPreTrainedModel"),Cv.forEach(t),Kb=d(vi," forward method, overrides the "),dl=s(vi,"CODE",{});var Mv=r(dl);Zb=d(Mv,"__call__"),Mv.forEach(t),Yb=d(vi," special method."),vi.forEach(t),ek=h(na),v(An.$$.fragment,na),tk=h(na),v(Sn.$$.fragment,na),na.forEach(t),ok=h(oe),On=s(oe,"DIV",{class:!0});var Mp=r(On);v(cr.$$.fragment,Mp),nk=h(Mp),v(In.$$.fragment,Mp),Mp.forEach(t),ak=h(oe),Nn=s(oe,"DIV",{class:!0});var Ep=r(Nn);v(pr.$$.fragment,Ep),sk=h(Ep),v(Ln.$$.fragment,Ep),Ep.forEach(t),oe.forEach(t),Bc=h(o),fo=s(o,"H2",{class:!0});var Pp=r(fo);Dn=s(Pp,"A",{id:!0,class:!0,href:!0});var Ev=r(Dn);ll=s(Ev,"SPAN",{});var Pv=r(ll);v(ur.$$.fragment,Pv),Pv.forEach(t),Ev.forEach(t),rk=h(Pp),cl=s(Pp,"SPAN",{});var Av=r(cl);ik=d(Av,"FlaxBartForCausalLM"),Av.forEach(t),Pp.forEach(t),jc=h(o),Z=s(o,"DIV",{class:!0});var Ae=r(Z);v(hr.$$.fragment,Ae),dk=h(Ae),pl=s(Ae,"P",{});var Sv=r(pl);lk=d(Sv,`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
e.g for autoregressive tasks.`),Sv.forEach(t),ck=h(Ae),mr=s(Ae,"P",{});var Ap=r(mr);pk=d(Ap,"This model inherits from "),ni=s(Ap,"A",{href:!0});var Ov=r(ni);uk=d(Ov,"FlaxPreTrainedModel"),Ov.forEach(t),hk=d(Ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
