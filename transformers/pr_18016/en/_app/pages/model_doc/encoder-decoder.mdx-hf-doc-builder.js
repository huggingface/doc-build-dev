...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),v(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Example:"),g.forEach(t),_=p(i),y(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,$),u(i,_,g),k(f,i,g),b=!0},p:nt,i(i){b||(w(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),T(f,i)}}}function jp(q){let h,$,_,f,b,i,g,S,ra,tr,oe,we,Yt,eo,aa,Jt,sa,nr,Ee,da,rt,ia,ca,rr,Te,la,oo,pa,ma,ar,$e,ha,at,fa,ua,sr,H,ga,st,_a,ba,to,va,ya,dr,te,Me,Zt,no,ka,Kt,wa,ir,ne,dt,Ea,Ta,it,$a,Ma,cr,ro,lr,re,De,Qt,ao,Da,Xt,xa,pr,M,ct,za,qa,en,ja,Pa,on,Fa,Aa,tn,Ca,Sa,nn,Na,Ba,lt,Ia,La,xe,Oa,rn,Ra,Wa,an,Va,Ga,pt,Ha,Ua,mr,so,hr,ae,ze,sn,io,Ya,dn,Ja,fr,U,Za,cn,Ka,Qa,ln,Xa,es,ur,co,gr,se,qe,pn,lo,os,po,ts,mn,ns,rs,_r,de,hn,as,ss,fn,ds,is,br,mo,vr,ie,je,un,ho,cs,gn,ls,yr,N,ps,_n,ms,hs,bn,fs,us,vn,gs,_s,yn,bs,vs,kr,fo,wr,Pe,ys,uo,ks,ws,Er,Y,Es,go,Ts,$s,_o,Ms,Ds,Tr,ce,Fe,kn,bo,xs,wn,zs,$r,C,vo,qs,Ae,mt,js,Ps,ht,Fs,As,Cs,le,Ss,ft,Ns,Bs,ut,Is,Ls,Os,Ce,Rs,Se,yo,Ws,ko,Vs,gt,Gs,Hs,Us,Ne,wo,Ys,pe,Js,En,Zs,Ks,Tn,Qs,Xs,Mr,me,Be,$n,Eo,ed,Mn,od,Dr,D,To,td,he,nd,_t,rd,ad,bt,sd,dd,id,$o,cd,Mo,ld,pd,md,Dn,hd,fd,Do,ud,vt,gd,_d,bd,xo,vd,zo,yd,kd,wd,J,yt,Ed,Td,xn,$d,Md,zn,Dd,xd,zd,B,qo,qd,fe,jd,kt,Pd,Fd,qn,Ad,Cd,Sd,Ie,Nd,Le,Bd,I,jo,Id,jn,Ld,Od,ue,Rd,Pn,Wd,Vd,Fn,Gd,Hd,Ud,Oe,xr,ge,Re,An,Po,Yd,Cn,Jd,zr,x,Fo,Zd,_e,Kd,wt,Qd,Xd,Et,ei,oi,ti,Ao,ni,Co,ri,ai,si,Sn,di,ii,So,ci,Tt,li,pi,mi,No,hi,Bo,fi,ui,gi,Z,$t,_i,bi,Mt,vi,yi,Dt,ki,wi,Ei,L,Io,Ti,be,$i,xt,Mi,Di,Nn,xi,zi,qi,We,ji,Ve,Pi,K,Lo,Fi,Bn,Ai,Ci,Ge,qr,ve,He,In,Oo,Si,Ln,Ni,jr,z,Ro,Bi,ye,Ii,zt,Li,Oi,qt,Ri,Wi,Vi,Wo,Gi,Vo,Hi,Ui,Yi,On,Ji,Zi,Go,Ki,jt,Qi,Xi,ec,Ho,oc,Uo,tc,nc,rc,Q,Pt,ac,sc,Rn,dc,ic,Wn,cc,lc,pc,O,Yo,mc,ke,hc,Ft,fc,uc,Vn,gc,_c,bc,Ue,vc,Ye,yc,X,Jo,kc,Gn,wc,Ec,Je,Pr;return i=new G({}),eo=new G({}),no=new G({}),ro=new V({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_18016/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_18016/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18016/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Ce=new tt({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[kp]},$$scope:{ctx:q}}}),yo=new W({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18016/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),wo=new W({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_18016/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18016/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_18016/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18016/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18016/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),Ie=new $c({props:{$$slots:{default:[wp]},$$scope:{ctx:q}}}),Le=new tt({props:{anchor:"transformers.EncoderDecoderModel.forward.example",$$slots:{default:[Ep]},$$scope:{ctx:q}}}),jo=new W({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
<a href="/docs/transformers/pr_18016/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18016/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L495",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18016/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),We=new $c({props:{$$slots:{default:[$p]},$$scope:{ctx:q}}}),Ve=new tt({props:{anchor:"transformers.TFEncoderDecoderModel.call.example",$$slots:{default:[Mp]},$$scope:{ctx:q}}}),Lo=new W({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Information necessary to initiate the encoder. Can be either:</p>
<ul>
<li>A string, the <em>model id</em> of a pretrained model hosted inside a model repo on huggingface.co.
Valid model ids can be located at the root-level, like <code>bert-base-uncased</code>, or namespaced under a
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_18016/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18016/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L628",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18016/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_18016/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
and decoder for a summarization model as was shown in: `),to=a("a"),va=n("Text Summarization with Pretrained Encoders"),ya=n(" by Yang Liu and Mirella Lapata."),dr=l(),te=a("h2"),Me=a("a"),Zt=a("span"),v(no.$$.fragment),ka=l(),Kt=a("span"),wa=n("Randomly initializing [EncoderDecoderModel](/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) from model configurations."),ir=l(),ne=a("p"),dt=a("a"),Ea=n("EncoderDecoderModel"),Ta=n(" can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),it=a("a"),$a=n("BertModel"),Ma=n(" configuration for both the encoder and the decoder."),cr=l(),v(ro.$$.fragment),lr=l(),re=a("h2"),De=a("a"),Qt=a("span"),v(ao.$$.fragment),Da=l(),Xt=a("span"),xa=n("Initialising [EncoderDecoderModel](/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) from a pretrained encoder and a pretrained decoder."),pr=l(),M=a("p"),ct=a("a"),za=n("EncoderDecoderModel"),qa=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained auto-encoding model, "),en=a("em"),ja=n("e.g."),Pa=n(" BERT, can serve as the encoder and both pretrained auto-encoding models, "),on=a("em"),Fa=n("e.g."),Aa=n(" BERT, pretrained causal language models, "),tn=a("em"),Ca=n("e.g."),Sa=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),nn=a("em"),Na=n("e.g."),Ba=n(` decoder of BART, can be used as the decoder.
Depending on which architecture you choose as the decoder, the cross-attention layers might be randomly initialized.
Initializing `),lt=a("a"),Ia=n("EncoderDecoderModel"),La=n(" from a pretrained encoder and decoder checkpoint requires the model to be fine-tuned on a downstream task, as has been shown in "),xe=a("a"),Oa=n("the "),rn=a("em"),Ra=n("Warm-starting-encoder-decoder blog post"),Wa=n(`.
...
target sequence).`),kr=l(),v(fo.$$.fragment),wr=l(),Pe=a("p"),ys=n("Detailed "),uo=a("a"),ks=n("colab"),ws=n(" for training."),Er=l(),Y=a("p"),Es=n("This model was contributed by "),go=a("a"),Ts=n("thomwolf"),$s=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),_o=a("a"),Ms=n("ydshieh"),Ds=n("."),Tr=l(),ce=a("h2"),Fe=a("a"),kn=a("span"),v(bo.$$.fragment),xs=l(),wn=a("span"),zs=n("EncoderDecoderConfig"),$r=l(),C=a("div"),v(vo.$$.fragment),qs=l(),Ae=a("p"),mt=a("a"),js=n("EncoderDecoderConfig"),Ps=n(" is the configuration class to store the configuration of a "),ht=a("a"),Fs=n("EncoderDecoderModel"),As=n(`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Cs=l(),le=a("p"),Ss=n("Configuration objects inherit from "),ft=a("a"),Ns=n("PretrainedConfig"),Bs=n(` and can be used to control the model outputs. Read the
documentation from `),ut=a("a"),Is=n("PretrainedConfig"),Ls=n(" for more information."),Os=l(),v(Ce.$$.fragment),Rs=l(),Se=a("div"),v(yo.$$.fragment),Ws=l(),ko=a("p"),Vs=n("Instantiate a "),gt=a("a"),Gs=n("EncoderDecoderConfig"),Hs=n(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),Us=l(),Ne=a("div"),v(wo.$$.fragment),Ys=l(),pe=a("p"),Js=n("Serializes this instance to a Python dictionary. Override the default "),En=a("em"),Zs=n("to_dict()"),Ks=n(" from "),Tn=a("em"),Qs=n("PretrainedConfig"),Xs=n("."),Mr=l(),me=a("h2"),Be=a("a"),$n=a("span"),v(Eo.$$.fragment),ed=l(),Mn=a("span"),od=n("EncoderDecoderModel"),Dr=l(),D=a("div"),v(To.$$.fragment),td=l(),he=a("p"),nd=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
:meth`),zn=a("em"),Dd=n("~transformers.AutoModelForCausalLM.from_pretrained"),xd=n(" class method for the decoder."),zd=l(),B=a("div"),v(qo.$$.fragment),qd=l(),fe=a("p"),jd=n("The "),kt=a("a"),Pd=n("EncoderDecoderModel"),Fd=n(" forward method, overrides the "),qn=a("code"),Ad=n("__call__"),Cd=n(" special method."),Sd=l(),v(Ie.$$.fragment),Nd=l(),v(Le.$$.fragment),Bd=l(),I=a("div"),v(jo.$$.fragment),Id=l(),jn=a("p"),Ld=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Od=l(),ue=a("p"),Rd=n("The model is set in evaluation mode by default using "),Pn=a("code"),Wd=n("model.eval()"),Vd=n(` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),Fn=a("code"),Gd=n("model.train()"),Hd=n("."),Ud=l(),v(Oe.$$.fragment),xr=l(),ge=a("h2"),Re=a("a"),An=a("span"),v(Po.$$.fragment),Yd=l(),Cn=a("span"),Jd=n("TFEncoderDecoderModel"),zr=l(),x=a("div"),v(Fo.$$.fragment),Zd=l(),_e=a("p"),Kd=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mi=l(),No=a("p"),hi=n("This model is also a "),Bo=a("a"),fi=n("tf.keras.Model"),ui=n(` subclass. Use it
...
method for the decoder.`),Ei=l(),L=a("div"),v(Io.$$.fragment),Ti=l(),be=a("p"),$i=n("The "),xt=a("a"),Mi=n("TFEncoderDecoderModel"),Di=n(" forward method, overrides the "),Nn=a("code"),xi=n("__call__"),zi=n(" special method."),qi=l(),v(We.$$.fragment),ji=l(),v(Ve.$$.fragment),Pi=l(),K=a("div"),v(Lo.$$.fragment),Fi=l(),Bn=a("p"),Ai=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Ci=l(),v(Ge.$$.fragment),qr=l(),ve=a("h2"),He=a("a"),In=a("span"),v(Oo.$$.fragment),Si=l(),Ln=a("span"),Ni=n("FlaxEncoderDecoderModel"),jr=l(),z=a("div"),v(Ro.$$.fragment),Bi=l(),ye=a("p"),Ii=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),zt=a("a"),Li=n("from_pretrained()"),Oi=n(" function and the decoder is loaded via "),qt=a("a"),Ri=n("from_pretrained()"),Wi=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rc=l(),Q=a("p"),Pt=a("a"),ac=n("FlaxEncoderDecoderModel"),sc=n(` is a generic model class that will be instantiated as a transformer architecture with
...
encoder and :meth`),Wn=a("em"),cc=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),lc=n(" class method for the decoder."),pc=l(),O=a("div"),v(Yo.$$.fragment),mc=l(),ke=a("p"),hc=n("The "),Ft=a("a"),fc=n("FlaxEncoderDecoderModel"),uc=n(" forward method, overrides the "),Vn=a("code"),gc=n("__call__"),_c=n(" special method."),bc=l(),v(Ue.$$.fragment),vc=l(),v(Ye.$$.fragment),yc=l(),X=a("div"),v(Jo.$$.fragment),kc=l(),Gn=a("p"),wc=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),Qo.forEach(t),rr=p(o),Te=s(o,"P",{});var Fr=d(Te);la=r(Fr,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
was shown in `),oo=s(Fr,"A",{href:!0,rel:!0});var Mc=d(oo);pa=r(Mc,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Mc.forEach(t),ma=r(Fr,` by
Sascha Rothe, Shashi Narayan, Aliaksei Severyn.`),Fr.forEach(t),ar=p(o),$e=s(o,"P",{});var Ar=d($e);ha=r(Ar,"After such an "),at=s(Ar,"A",{href:!0});var Dc=d(at);fa=r(Dc,"EncoderDecoderModel"),Dc.forEach(t),ua=r(Ar,` has been trained/fine-tuned, it can be saved/loaded just like
...
target sequence).`),ee.forEach(t),kr=p(o),y(fo.$$.fragment,o),wr=p(o),Pe=s(o,"P",{});var Or=d(Pe);ys=r(Or,"Detailed "),uo=s(Or,"A",{href:!0,rel:!0});var ll=d(uo);ks=r(ll,"colab"),ll.forEach(t),ws=r(Or," for training."),Or.forEach(t),Er=p(o),Y=s(o,"P",{});var St=d(Y);Es=r(St,"This model was contributed by "),go=s(St,"A",{href:!0,rel:!0});var pl=d(go);Ts=r(pl,"thomwolf"),pl.forEach(t),$s=r(St,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),_o=s(St,"A",{href:!0,rel:!0});var ml=d(_o);Ms=r(ml,"ydshieh"),ml.forEach(t),Ds=r(St,"."),St.forEach(t),Tr=p(o),ce=s(o,"H2",{class:!0});var Rr=d(ce);Fe=s(Rr,"A",{id:!0,class:!0,href:!0});var hl=d(Fe);kn=s(hl,"SPAN",{});var fl=d(kn);y(bo.$$.fragment,fl),fl.forEach(t),hl.forEach(t),xs=p(Rr),wn=s(Rr,"SPAN",{});var ul=d(wn);zs=r(ul,"EncoderDecoderConfig"),ul.forEach(t),Rr.forEach(t),$r=p(o),C=s(o,"DIV",{class:!0});var R=d(C);y(vo.$$.fragment,R),qs=p(R),Ae=s(R,"P",{});var or=d(Ae);mt=s(or,"A",{href:!0});var gl=d(mt);js=r(gl,"EncoderDecoderConfig"),gl.forEach(t),Ps=r(or," is the configuration class to store the configuration of a "),ht=s(or,"A",{href:!0});var _l=d(ht);Fs=r(_l,"EncoderDecoderModel"),_l.forEach(t),As=r(or,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),or.forEach(t),Cs=p(R),le=s(R,"P",{});var Nt=d(le);Ss=r(Nt,"Configuration objects inherit from "),ft=s(Nt,"A",{href:!0});var bl=d(ft);Ns=r(bl,"PretrainedConfig"),bl.forEach(t),Bs=r(Nt,` and can be used to control the model outputs. Read the
documentation from `),ut=s(Nt,"A",{href:!0});var vl=d(ut);Is=r(vl,"PretrainedConfig"),vl.forEach(t),Ls=r(Nt," for more information."),Nt.forEach(t),Os=p(R),y(Ce.$$.fragment,R),Rs=p(R),Se=s(R,"DIV",{class:!0});var Wr=d(Se);y(yo.$$.fragment,Wr),Ws=p(Wr),ko=s(Wr,"P",{});var Vr=d(ko);Vs=r(Vr,"Instantiate a "),gt=s(Vr,"A",{href:!0});var yl=d(gt);Gs=r(yl,"EncoderDecoderConfig"),yl.forEach(t),Hs=r(Vr,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),Vr.forEach(t),Wr.forEach(t),Us=p(R),Ne=s(R,"DIV",{class:!0});var Gr=d(Ne);y(wo.$$.fragment,Gr),Ys=p(Gr),pe=s(Gr,"P",{});var Bt=d(pe);Js=r(Bt,"Serializes this instance to a Python dictionary. Override the default "),En=s(Bt,"EM",{});var kl=d(En);Zs=r(kl,"to_dict()"),kl.forEach(t),Ks=r(Bt," from "),Tn=s(Bt,"EM",{});var wl=d(Tn);Qs=r(wl,"PretrainedConfig"),wl.forEach(t),Xs=r(Bt,"."),Bt.forEach(t),Gr.forEach(t),R.forEach(t),Mr=p(o),me=s(o,"H2",{class:!0});var Hr=d(me);Be=s(Hr,"A",{id:!0,class:!0,href:!0});var El=d(Be);$n=s(El,"SPAN",{});var Tl=d($n);y(Eo.$$.fragment,Tl),Tl.forEach(t),El.forEach(t),ed=p(Hr),Mn=s(Hr,"SPAN",{});var $l=d(Mn);od=r($l,"EncoderDecoderModel"),$l.forEach(t),Hr.forEach(t),Dr=p(o),D=s(o,"DIV",{class:!0});var P=d(D);y(To.$$.fragment,P),td=p(P),he=s(P,"P",{});var It=d(he);nd=r(It,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),_t=s(It,"A",{href:!0});var Ml=d(_t);rd=r(Ml,"from_pretrained()"),Ml.forEach(t),ad=r(It," function and the decoder is loaded via "),bt=s(It,"A",{href:!0});var Dl=d(bt);sd=r(Dl,"from_pretrained()"),Dl.forEach(t),dd=r(It,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),It.forEach(t),id=p(P),$o=s(P,"P",{});var Ur=d($o);cd=r(Ur,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Ur.forEach(t),md=p(P),Dn=s(P,"P",{});var zl=d(Dn);hd=r(zl,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),zl.forEach(t),fd=p(P),Do=s(P,"P",{});var Yr=d(Do);ud=r(Yr,"This model inherits from "),vt=s(Yr,"A",{href:!0});var ql=d(vt);gd=r(ql,"PreTrainedModel"),ql.forEach(t),_d=r(Yr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yr.forEach(t),bd=p(P),xo=s(P,"P",{});var Jr=d(xo);vd=r(Jr,"This model is also a PyTorch "),zo=s(Jr,"A",{href:!0,rel:!0});var jl=d(zo);yd=r(jl,"torch.nn.Module"),jl.forEach(t),kd=r(Jr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr.forEach(t),wd=p(P),J=s(P,"P",{});var Xo=d(J);yt=s(Xo,"A",{href:!0});var Pl=d(yt);Ed=r(Pl,"EncoderDecoderModel"),Pl.forEach(t),Td=r(Xo,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),xn=s(Xo,"EM",{});var Fl=d(xn);$d=r(Fl,"~transformers.AutoModel.from_pretrained"),Fl.forEach(t),Md=r(Xo,` class method for the encoder and
:meth`),zn=s(Xo,"EM",{});var Al=d(zn);Dd=r(Al,"~transformers.AutoModelForCausalLM.from_pretrained"),Al.forEach(t),xd=r(Xo," class method for the decoder."),Xo.forEach(t),zd=p(P),B=s(P,"DIV",{class:!0});var Ze=d(B);y(qo.$$.fragment,Ze),qd=p(Ze),fe=s(Ze,"P",{});var Lt=d(fe);jd=r(Lt,"The "),kt=s(Lt,"A",{href:!0});var Cl=d(kt);Pd=r(Cl,"EncoderDecoderModel"),Cl.forEach(t),Fd=r(Lt," forward method, overrides the "),qn=s(Lt,"CODE",{});var Sl=d(qn);Ad=r(Sl,"__call__"),Sl.forEach(t),Cd=r(Lt," special method."),Lt.forEach(t),Sd=p(Ze),y(Ie.$$.fragment,Ze),Nd=p(Ze),y(Le.$$.fragment,Ze),Ze.forEach(t),Bd=p(P),I=s(P,"DIV",{class:!0});var Ke=d(I);y(jo.$$.fragment,Ke),Id=p(Ke),jn=s(Ke,"P",{});var Nl=d(jn);Ld=r(Nl,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Nl.forEach(t),Od=p(Ke),ue=s(Ke,"P",{});var Ot=d(ue);Rd=r(Ot,"The model is set in evaluation mode by default using "),Pn=s(Ot,"CODE",{});var Bl=d(Pn);Wd=r(Bl,"model.eval()"),Bl.forEach(t),Vd=r(Ot,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),Fn=s(Ot,"CODE",{});var Il=d(Fn);Gd=r(Il,"model.train()"),Il.forEach(t),Hd=r(Ot,"."),Ot.forEach(t),Ud=p(Ke),y(Oe.$$.fragment,Ke),Ke.forEach(t),P.forEach(t),xr=p(o),ge=s(o,"H2",{class:!0});var Zr=d(ge);Re=s(Zr,"A",{id:!0,class:!0,href:!0});var Ll=d(Re);An=s(Ll,"SPAN",{});var Ol=d(An);y(Po.$$.fragment,Ol),Ol.forEach(t),Ll.forEach(t),Yd=p(Zr),Cn=s(Zr,"SPAN",{});var Rl=d(Cn);Jd=r(Rl,"TFEncoderDecoderModel"),Rl.forEach(t),Zr.forEach(t),zr=p(o),x=s(o,"DIV",{class:!0});var F=d(x);y(Fo.$$.fragment,F),Zd=p(F),_e=s(F,"P",{});var Rt=d(_e);Kd=r(Rt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Rt.forEach(t),ti=p(F),Ao=s(F,"P",{});var Kr=d(Ao);ni=r(Kr,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Kr.forEach(t),si=p(F),Sn=s(F,"P",{});var Hl=d(Sn);di=r(Hl,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Hl.forEach(t),ii=p(F),So=s(F,"P",{});var Qr=d(So);ci=r(Qr,"This model inherits from "),Tt=s(Qr,"A",{href:!0});var Ul=d(Tt);li=r(Ul,"TFPreTrainedModel"),Ul.forEach(t),pi=r(Qr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr.forEach(t),mi=p(F),No=s(F,"P",{});var Xr=d(No);hi=r(Xr,"This model is also a "),Bo=s(Xr,"A",{href:!0,rel:!0});var Yl=d(Bo);fi=r(Yl,"tf.keras.Model"),Yl.forEach(t),ui=r(Xr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xr.forEach(t),gi=p(F),Z=s(F,"P",{});var et=d(Z);$t=s(et,"A",{href:!0});var Jl=d($t);_i=r(Jl,"TFEncoderDecoderModel"),Jl.forEach(t),bi=r(et,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),et.forEach(t),Ei=p(F),L=s(F,"DIV",{class:!0});var Qe=d(L);y(Io.$$.fragment,Qe),Ti=p(Qe),be=s(Qe,"P",{});var Wt=d(be);$i=r(Wt,"The "),xt=s(Wt,"A",{href:!0});var Ql=d(xt);Mi=r(Ql,"TFEncoderDecoderModel"),Ql.forEach(t),Di=r(Wt," forward method, overrides the "),Nn=s(Wt,"CODE",{});var Xl=d(Nn);xi=r(Xl,"__call__"),Xl.forEach(t),zi=r(Wt," special method."),Wt.forEach(t),qi=p(Qe),y(We.$$.fragment,Qe),ji=p(Qe),y(Ve.$$.fragment,Qe),Qe.forEach(t),Pi=p(F),K=s(F,"DIV",{class:!0});var Vt=d(K);y(Lo.$$.fragment,Vt),Fi=p(Vt),Bn=s(Vt,"P",{});var ep=d(Bn);Ai=r(ep,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ep.forEach(t),Ci=p(Vt),y(Ge.$$.fragment,Vt),Vt.forEach(t),F.forEach(t),qr=p(o),ve=s(o,"H2",{class:!0});var ea=d(ve);He=s(ea,"A",{id:!0,class:!0,href:!0});var op=d(He);In=s(op,"SPAN",{});var tp=d(In);y(Oo.$$.fragment,tp),tp.forEach(t),op.forEach(t),Si=p(ea),Ln=s(ea,"SPAN",{});var np=d(Ln);Ni=r(np,"FlaxEncoderDecoderModel"),np.forEach(t),ea.forEach(t),jr=p(o),z=s(o,"DIV",{class:!0});var A=d(z);y(Ro.$$.fragment,A),Bi=p(A),ye=s(A,"P",{});var Gt=d(ye);Ii=r(Gt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),zt=s(Gt,"A",{href:!0});var rp=d(zt);Li=r(rp,"from_pretrained()"),rp.forEach(t),Oi=r(Gt," function and the decoder is loaded via "),qt=s(Gt,"A",{href:!0});var ap=d(qt);Ri=r(ap,"from_pretrained()"),ap.forEach(t),Wi=r(Gt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),na.forEach(t),rc=p(A),Q=s(A,"P",{});var ot=d(Q);Pt=s(ot,"A",{href:!0});var lp=d(Pt);ac=r(lp,"FlaxEncoderDecoderModel"),lp.forEach(t),sc=r(ot,` is a generic model class that will be instantiated as a transformer architecture with
the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one as
...
encoder and :meth`),Wn=s(ot,"EM",{});var mp=d(Wn);cc=r(mp,"~transformers.FlaxAutoModelForCausalLM.from_pretrained"),mp.forEach(t),lc=r(ot," class method for the decoder."),ot.forEach(t),pc=p(A),O=s(A,"DIV",{class:!0});var Xe=d(O);y(Yo.$$.fragment,Xe),mc=p(Xe),ke=s(Xe,"P",{});var Ht=d(ke);hc=r(Ht,"The "),Ft=s(Ht,"A",{href:!0});var hp=d(Ft);fc=r(hp,"FlaxEncoderDecoderModel"),hp.forEach(t),uc=r(Ht," forward method, overrides the "),Vn=s(Ht,"CODE",{});var fp=d(Vn);gc=r(fp,"__call__"),fp.forEach(t),_c=r(Ht," special method."),Ht.forEach(t),bc=p(Xe),y(Ue.$$.fragment,Xe),vc=p(Xe),y(Ye.$$.fragment,Xe),Xe.forEach(t),yc=p(A),X=s(A,"DIV",{class:!0});var Ut=d(X);y(Jo.$$.fragment,Ut),kc=p(Ut),Gn=s(Ut,"P",{});var up=d(Gn);wc=r(up,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),up.forEach(t),Ec=p(Ut),y(Je.$$.fragment,Ut),Ut.forEach(t),A.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(Pp)),c(f,"id","encoder-decoder-models"),c(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(f,"href","#encoder-decoder-models"),c(_,"class","relative group"),c(we,"id","overview"),c(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(we,"href","#overview"),c(oe,"class","relative group"),c(rt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(oo,"href","https://arxiv.org/abs/1907.12461"),c(oo,"rel","nofollow"),c(at,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(st,"href","/docs/transformers/pr_18016/en/model_doc/bert#transformers.BertModel"),c(to,"href","https://arxiv.org/abs/1908.08345"),c(to,"rel","nofollow"),c(Me,"id","randomly-initializing-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-from-model-configurations"),c(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Me,"href","#randomly-initializing-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-from-model-configurations"),c(te,"class","relative group"),c(dt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(it,"href","/docs/transformers/pr_18016/en/model_doc/bert#transformers.BertModel"),c(De,"id","initialising-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-from-a-pretrained-encoder-and-a-pretrained-decoder"),c(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(De,"href","#initialising-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-from-a-pretrained-encoder-and-a-pretrained-decoder"),c(re,"class","relative group"),c(ct,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(lt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(xe,"href","https://huggingface.co/blog/warm-starting-encoder-decoder"),c(xe,"rel","nofollow"),c(pt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel.from_encoder_decoder_pretrained"),c(ze,"id","loading-an-existing-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-checkpoint"),c(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ze,"href","#loading-an-existing-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-checkpoint"),c(ae,"class","relative group"),c(qe,"id","loading-a-pytorch-checkpoint-into-tfencoderdecodermodel"),c(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qe,"href","#loading-a-pytorch-checkpoint-into-tfencoderdecodermodel"),c(se,"class","relative group"),c(je,"id","training"),c(je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(je,"href","#training"),c(ie,"class","relative group"),c(uo,"href","https://colab.research.google.com/drive/1WIk2bxglElfZewOHboPFNj8H44_VAyKE?usp=sharing#scrollTo=ZwQIEhKOrJpl"),c(uo,"rel","nofollow"),c(go,"href","https://github.com/thomwolf"),c(go,"rel","nofollow"),c(_o,"href","https://github.com/ydshieh"),c(_o,"rel","nofollow"),c(Fe,"id","transformers.EncoderDecoderConfig"),c(Fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Fe,"href","#transformers.EncoderDecoderConfig"),c(ce,"class","relative group"),c(mt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),c(ht,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(ft,"href","/docs/transformers/pr_18016/en/main_classes/configuration#transformers.PretrainedConfig"),c(ut,"href","/docs/transformers/pr_18016/en/main_classes/configuration#transformers.PretrainedConfig"),c(gt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),c(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Be,"id","transformers.EncoderDecoderModel"),c(Be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Be,"href","#transformers.EncoderDecoderModel"),c(me,"class","relative group"),c(_t,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(bt,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Mo,"href","https://arxiv.org/abs/1907.12461"),c(Mo,"rel","nofollow"),c(vt,"href","/docs/transformers/pr_18016/en/main_classes/model#transformers.PreTrainedModel"),c(zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(zo,"rel","nofollow"),c(yt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(kt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Re,"id","transformers.TFEncoderDecoderModel"),c(Re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Re,"href","#transformers.TFEncoderDecoderModel"),c(ge,"class","relative group"),c(wt,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Et,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Co,"href","https://arxiv.org/abs/1907.12461"),c(Co,"rel","nofollow"),c(Tt,"href","/docs/transformers/pr_18016/en/main_classes/model#transformers.TFPreTrainedModel"),c(Bo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Bo,"rel","nofollow"),c($t,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.TFEncoderDecoderModel"),c(Mt,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Dt,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(xt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.TFEncoderDecoderModel"),c(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(He,"id","transformers.FlaxEncoderDecoderModel"),c(He,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(He,"href","#transformers.FlaxEncoderDecoderModel"),c(ve,"class","relative group"),c(zt,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(qt,"href","/docs/transformers/pr_18016/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Vo,"href","https://arxiv.org/abs/1907.12461"),c(Vo,"rel","nofollow"),c(jt,"href","/docs/transformers/pr_18016/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Uo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Uo,"rel","nofollow"),c(Pt,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.FlaxEncoderDecoderModel"),c(Ft,"href","/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.FlaxEncoderDecoderModel"),c(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,m){e(document.head,h),u(o,$,m),u(o,_,m),e(_,f),e(f,b),k(i,b,null),e(_,g),e(_,S),e(S,ra),u(o,tr,m),u(o,oe,m),e(oe,we),e(we,Yt),k(eo,Yt,null),e(oe,aa),e(oe,Jt),e(Jt,sa),u(o,nr,m),u(o,Ee,m),e(Ee,da),e(Ee,rt),e(rt,ia),e(Ee,ca),u(o,rr,m),u(o,Te,m),e(Te,la),e(Te,oo),e(oo,pa),e(Te,ma),u(o,ar,m),u(o,$e,m),e($e,ha),e($e,at),e(at,fa),e($e,ua),u(o,sr,m),u(o,H,m),e(H,ga),e(H,st),e(st,_a),e(H,ba),e(H,to),e(to,va),e(H,ya),u(o,dr,m),u(o,te,m),e(te,Me),e(Me,Zt),k(no,Zt,null),e(te,ka),e(te,Kt),e(Kt,wa),u(o,ir,m),u(o,ne,m),e(ne,dt),e(dt,Ea),e(ne,Ta),e(ne,it),e(it,$a),e(ne,Ma),u(o,cr,m),k(ro,o,m),u(o,lr,m),u(o,re,m),e(re,De),e(De,Qt),k(ao,Qt,null),e(re,Da),e(re,Xt),e(Xt,xa),u(o,pr,m),u(o,M,m),e(M,ct),e(ct,za),e(M,qa),e(M,en),e(en,ja),e(M,Pa),e(M,on),e(on,Fa),e(M,Aa),e(M,tn),e(tn,Ca),e(M,Sa),e(M,nn),e(nn,Na),e(M,Ba),e(M,lt),e(lt,Ia),e(M,La),e(M,xe),e(xe,Oa),e(xe,rn),e(rn,Ra),e(M,Wa),e(M,an),e(an,Va),e(M,Ga),e(M,pt),e(pt,Ha),e(M,Ua),u(o,mr,m),k(so,o,m),u(o,hr,m),u(o,ae,m),e(ae,ze),e(ze,sn),k(io,sn,null),e(ae,Ya),e(ae,dn),e(dn,Ja),u(o,fr,m),u(o,U,m),e(U,Za),e(U,cn),e(cn,Ka),e(U,Qa),e(U,ln),e(ln,Xa),e(U,es),u(o,ur,m),k(co,o,m),u(o,gr,m),u(o,se,m),e(se,qe),e(qe,pn),k(lo,pn,null),e(se,os),e(se,po),e(po,ts),e(po,mn),e(mn,ns),e(po,rs),u(o,_r,m),u(o,de,m),e(de,hn),e(hn,as),e(de,ss),e(de,fn),e(fn,ds),e(de,is),u(o,br,m),k(mo,o,m),u(o,vr,m),u(o,ie,m),e(ie,je),e(je,un),k(ho,un,null),e(ie,cs),e(ie,gn),e(gn,ls),u(o,yr,m),u(o,N,m),e(N,ps),e(N,_n),e(_n,ms),e(N,hs),e(N,bn),e(bn,fs),e(N,us),e(N,vn),e(vn,gs),e(N,_s),e(N,yn),e(yn,bs),e(N,vs),u(o,kr,m),k(fo,o,m),u(o,wr,m),u(o,Pe,m),e(Pe,ys),e(Pe,uo),e(uo,ks),e(Pe,ws),u(o,Er,m),u(o,Y,m),e(Y,Es),e(Y,go),e(go,Ts),e(Y,$s),e(Y,_o),e(_o,Ms),e(Y,Ds),u(o,Tr,m),u(o,ce,m),e(ce,Fe),e(Fe,kn),k(bo,kn,null),e(ce,xs),e(ce,wn),e(wn,zs),u(o,$r,m),u(o,C,m),k(vo,C,null),e(C,qs),e(C,Ae),e(Ae,mt),e(mt,js),e(Ae,Ps),e(Ae,ht),e(ht,Fs),e(Ae,As),e(C,Cs),e(C,le),e(le,Ss),e(le,ft),e(ft,Ns),e(le,Bs),e(le,ut),e(ut,Is),e(le,Ls),e(C,Os),k(Ce,C,null),e(C,Rs),e(C,Se),k(yo,Se,null),e(Se,Ws),e(Se,ko),e(ko,Vs),e(ko,gt),e(gt,Gs),e(ko,Hs),e(C,Us),e(C,Ne),k(wo,Ne,null),e(Ne,Ys),e(Ne,pe),e(pe,Js),e(pe,En),e(En,Zs),e(pe,Ks),e(pe,Tn),e(Tn,Qs),e(pe,Xs),u(o,Mr,m),u(o,me,m),e(me,Be),e(Be,$n),k(Eo,$n,null),e(me,ed),e(me,Mn),e(Mn,od),u(o,Dr,m),u(o,D,m),k(To,D,null),e(D,td),e(D,he),e(he,nd),e(he,_t),e(_t,rd),e(he,ad),e(he,bt),e(bt,sd),e(he,dd),e(D,id),e(D,$o),e($o,cd),e($o,Mo),e(Mo,ld),e($o,pd),e(D,md),e(D,Dn),e(Dn,hd),e(D,fd),e(D,Do),e(Do,ud),e(Do,vt),e(vt,gd),e(Do,_d),e(D,bd),e(D,xo),e(xo,vd),e(xo,zo),e(zo,yd),e(xo,kd),e(D,wd),e(D,J),e(J,yt),e(yt,Ed),e(J,Td),e(J,xn),e(xn,$d),e(J,Md),e(J,zn),e(zn,Dd),e(J,xd),e(D,zd),e(D,B),k(qo,B,null),e(B,qd),e(B,fe),e(fe,jd),e(fe,kt),e(kt,Pd),e(fe,Fd),e(fe,qn),e(qn,Ad),e(fe,Cd),e(B,Sd),k(Ie,B,null),e(B,Nd),k(Le,B,null),e(D,Bd),e(D,I),k(jo,I,null),e(I,Id),e(I,jn),e(jn,Ld),e(I,Od),e(I,ue),e(ue,Rd),e(ue,Pn),e(Pn,Wd),e(ue,Vd),e(ue,Fn),e(Fn,Gd),e(ue,Hd),e(I,Ud),k(Oe,I,null),u(o,xr,m),u(o,ge,m),e(ge,Re),e(Re,An),k(Po,An,null),e(ge,Yd),e(ge,Cn),e(Cn,Jd),u(o,zr,m),u(o,x,m),k(Fo,x,null),e(x,Zd),e(x,_e),e(_e,Kd),e(_e,wt),e(wt,Qd),e(_e,Xd),e(_e,Et),e(Et,ei),e(_e,oi),e(x,ti),e(x,Ao),e(Ao,ni),e(Ao,Co),e(Co,ri),e(Ao,ai),e(x,si),e(x,Sn),e(Sn,di),e(x,ii),e(x,So),e(So,ci),e(So,Tt),e(Tt,li),e(So,pi),e(x,mi),e(x,No),e(No,hi),e(No,Bo),e(Bo,fi),e(No,ui),e(x,gi),e(x,Z),e(Z,$t),e($t,_i),e(Z,bi),e(Z,Mt),e(Mt,vi),e(Z,yi),e(Z,Dt),e(Dt,ki),e(Z,wi),e(x,Ei),e(x,L),k(Io,L,null),e(L,Ti),e(L,be),e(be,$i),e(be,xt),e(xt,Mi),e(be,Di),e(be,Nn),e(Nn,xi),e(be,zi),e(L,qi),k(We,L,null),e(L,ji),k(Ve,L,null),e(x,Pi),e(x,K),k(Lo,K,null),e(K,Fi),e(K,Bn),e(Bn,Ai),e(K,Ci),k(Ge,K,null),u(o,qr,m),u(o,ve,m),e(ve,He),e(He,In),k(Oo,In,null),e(ve,Si),e(ve,Ln),e(Ln,Ni),u(o,jr,m),u(o,z,m),k(Ro,z,null),e(z,Bi),e(z,ye),e(ye,Ii),e(ye,zt),e(zt,Li),e(ye,Oi),e(ye,qt),e(qt,Ri),e(ye,Wi),e(z,Vi),e(z,Wo),e(Wo,Gi),e(Wo,Vo),e(Vo,Hi),e(Wo,Ui),e(z,Yi),e(z,On),e(On,Ji),e(z,Zi),e(z,Go),e(Go,Ki),e(Go,jt),e(jt,Qi),e(Go,Xi),e(z,ec),e(z,Ho),e(Ho,oc),e(Ho,Uo),e(Uo,tc),e(Ho,nc),e(z,rc),e(z,Q),e(Q,Pt),e(Pt,ac),e(Q,sc),e(Q,Rn),e(Rn,dc),e(Q,ic),e(Q,Wn),e(Wn,cc),e(Q,lc),e(z,pc),e(z,O),k(Yo,O,null),e(O,mc),e(O,ke),e(ke,hc),e(ke,Ft),e(Ft,fc),e(ke,uc),e(ke,Vn),e(Vn,gc),e(ke,_c),e(O,bc),k(Ue,O,null),e(O,vc),k(Ye,O,null),e(z,yc),e(z,X),k(Jo,X,null),e(X,kc),e(X,Gn),e(Gn,wc),e(X,Ec),k(Je,X,null),Pr=!0},p(o,[m]){const Zo={};m&2&&(Zo.$$scope={dirty:m,ctx:o}),Ce.$set(Zo);const Hn={};m&2&&(Hn.$$scope={dirty:m,ctx:o}),Ie.$set(Hn);const Un={};m&2&&(Un.$$scope={dirty:m,ctx:o}),Le.$set(Un);const Yn={};m&2&&(Yn.$$scope={dirty:m,ctx:o}),Oe.$set(Yn);const Ko={};m&2&&(Ko.$$scope={dirty:m,ctx:o}),We.$set(Ko);const Jn={};m&2&&(Jn.$$scope={dirty:m,ctx:o}),Ve.$set(Jn);const Zn={};m&2&&(Zn.$$scope={dirty:m,ctx:o}),Ge.$set(Zn);const Kn={};m&2&&(Kn.$$scope={dirty:m,ctx:o}),Ue.$set(Kn);const Qo={};m&2&&(Qo.$$scope={dirty:m,ctx:o}),Ye.$set(Qo);const Qn={};m&2&&(Qn.$$scope={dirty:m,ctx:o}),Je.$set(Qn)},i(o){Pr||(w(i.$$.fragment,o),w(eo.$$.fragment,o),w(no.$$.fragment,o),w(ro.$$.fragment,o),w(ao.$$.fragment,o),w(so.$$.fragment,o),w(io.$$.fragment,o),w(co.$$.fragment,o),w(lo.$$.fragment,o),w(mo.$$.fragment,o),w(ho.$$.fragment,o),w(fo.$$.fragment,o),w(bo.$$.fragment,o),w(vo.$$.fragment,o),w(Ce.$$.fragment,o),w(yo.$$.fragment,o),w(wo.$$.fragment,o),w(Eo.$$.fragment,o),w(To.$$.fragment,o),w(qo.$$.fragment,o),w(Ie.$$.fragment,o),w(Le.$$.fragment,o),w(jo.$$.fragment,o),w(Oe.$$.fragment,o),w(Po.$$.fragment,o),w(Fo.$$.fragment,o),w(Io.$$.fragment,o),w(We.$$.fragment,o),w(Ve.$$.fragment,o),w(Lo.$$.fragment,o),w(Ge.$$.fragment,o),w(Oo.$$.fragment,o),w(Ro.$$.fragment,o),w(Yo.$$.fragment,o),w(Ue.$$.fragment,o),w(Ye.$$.fragment,o),w(Jo.$$.fragment,o),w(Je.$$.fragment,o),Pr=!0)},o(o){E(i.$$.fragment,o),E(eo.$$.fragment,o),E(no.$$.fragment,o),E(ro.$$.fragment,o),E(ao.$$.fragment,o),E(so.$$.fragment,o),E(io.$$.fragment,o),E(co.$$.fragment,o),E(lo.$$.fragment,o),E(mo.$$.fragment,o),E(ho.$$.fragment,o),E(fo.$$.fragment,o),E(bo.$$.fragment,o),E(vo.$$.fragment,o),E(Ce.$$.fragment,o),E(yo.$$.fragment,o),E(wo.$$.fragment,o),E(Eo.$$.fragment,o),E(To.$$.fragment,o),E(qo.$$.fragment,o),E(Ie.$$.fragment,o),E(Le.$$.fragment,o),E(jo.$$.fragment,o),E(Oe.$$.fragment,o),E(Po.$$.fragment,o),E(Fo.$$.fragment,o),E(Io.$$.fragment,o),E(We.$$.fragment,o),E(Ve.$$.fragment,o),E(Lo.$$.fragment,o),E(Ge.$$.fragment,o),E(Oo.$$.fragment,o),E(Ro.$$.fragment,o),E(Yo.$$.fragment,o),E(Ue.$$.fragment,o),E(Ye.$$.fragment,o),E(Jo.$$.fragment,o),E(Je.$$.fragment,o),Pr=!1},d(o){t(h),o&&t($),o&&t(_),T(i),o&&t(tr),o&&t(oe),T(eo),o&&t(nr),o&&t(Ee),o&&t(rr),o&&t(Te),o&&t(ar),o&&t($e),o&&t(sr),o&&t(H),o&&t(dr),o&&t(te),T(no),o&&t(ir),o&&t(ne),o&&t(cr),T(ro,o),o&&t(lr),o&&t(re),T(ao),o&&t(pr),o&&t(M),o&&t(mr),T(so,o),o&&t(hr),o&&t(ae),T(io),o&&t(fr),o&&t(U),o&&t(ur),T(co,o),o&&t(gr),o&&t(se),T(lo),o&&t(_r),o&&t(de),o&&t(br),T(mo,o),o&&t(vr),o&&t(ie),T(ho),o&&t(yr),o&&t(N),o&&t(kr),T(fo,o),o&&t(wr),o&&t(Pe),o&&t(Er),o&&t(Y),o&&t(Tr),o&&t(ce),T(bo),o&&t($r),o&&t(C),T(vo),T(Ce),T(yo),T(wo),o&&t(Mr),o&&t(me),T(Eo),o&&t(Dr),o&&t(D),T(To),T(qo),T(Ie),T(Le),T(jo),T(Oe),o&&t(xr),o&&t(ge),T(Po),o&&t(zr),o&&t(x),T(Fo),T(Io),T(We),T(Ve),T(Lo),T(Ge),o&&t(qr),o&&t(ve),T(Oo),o&&t(jr),o&&t(z),T(Ro),T(Yo),T(Ue),T(Ye),T(Jo),T(Je)}}}const Pp={local:"encoder-decoder-models",sections:[{local:"overview",title:"Overview"},{local:"randomly-initializing-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-from-model-configurations",title:"Randomly initializing [EncoderDecoderModel](/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) from model configurations."},{local:"initialising-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-from-a-pretrained-encoder-and-a-pretrained-decoder",title:"Initialising [EncoderDecoderModel](/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) from a pretrained encoder and a pretrained decoder."},{local:"loading-an-existing-encoderdecodermodeldocstransformerspr18016enmodeldocencoderdecodertransformersencoderdecodermodel-checkpoint",title:"Loading an existing [EncoderDecoderModel](/docs/transformers/pr_18016/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) checkpoint."},{local:"loading-a-pytorch-checkpoint-into-tfencoderdecodermodel",title:"Loading a PyTorch checkpoint into `TFEncoderDecoderModel`."},{local:"training",title:"Training"},{local:"transformers.EncoderDecoderConfig",title:"EncoderDecoderConfig"},{local:"transformers.EncoderDecoderModel",title:"EncoderDecoderModel"},{local:"transformers.TFEncoderDecoderModel",title:"TFEncoderDecoderModel"},{local:"transformers.FlaxEncoderDecoderModel",title:"FlaxEncoderDecoderModel"}],title:"Encoder Decoder Models"};function Fp(q){return yp(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Lp extends gp{constructor(h){super();_p(this,h,Fp,jp,bp,{})}}export{Lp as default,Pp as metadata};
