import{S as qc,i as zc,s as Ac,e as s,k as f,w as v,t as i,M as Nc,c as r,d as o,m as u,a as n,x as w,h as l,b as p,G as e,g as T,y as $,q as y,o as D,B as F,v as Oc,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as se}from"../../chunks/Tip-hf-doc-builder.js";import{D as M}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ce}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as X}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Lc(k){let d,b,m,h,_;return{c(){d=s("p"),b=i(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=s("a"),h=i("Github Issue"),_=i("."),this.h()},l(a){d=r(a,"P",{});var c=n(d);b=l(c,`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),b=i("Example:"),m=f(),v(h.$$.fragment)},l(a){d=r(a,"P",{});var c=n(d);b=l(c,"Example:"),c.forEach(o),m=u(a),w(h.$$.fragment,a)},m(a,c){T(a,d,c),e(d,b),T(a,m,c),$(h,a,c),_=!0},p:je,i(a){_||(y(h.$$.fragment,a),_=!0)},o(a){D(h.$$.fragment,a),_=!1},d(a){a&&o(d),a&&o(m),F(h,a)}}}function Sc(k){let d,b;return{c(){d=s("p"),b=i(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
PIL images.`)},l(m){d=r(m,"P",{});var h=n(d);b=l(h,`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var c=n(d);b=l(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(c,"CODE",{});var x=n(m);h=l(x,"Module"),x.forEach(o),_=l(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
tabby, tabby cat`}}),{c(){d=s("p"),b=i("Example:"),m=f(),v(h.$$.fragment)},l(a){d=r(a,"P",{});var c=n(d);b=l(c,"Example:"),c.forEach(o),m=u(a),w(h.$$.fragment,a)},m(a,c){T(a,d,c),e(d,b),T(a,m,c),$(h,a,c),_=!0},p:je,i(a){_||(y(h.$$.fragment,a),_=!0)},o(a){D(h.$$.fragment,a),_=!1},d(a){a&&o(d),a&&o(m),F(h,a)}}}function sh(k){let d,b,m,h,_,a,c,x,ir,us,Pe,gs,re,qe,ia,wt,lr,la,dr,_s,L,cr,$t,hr,pr,$o,mr,fr,yt,ur,gr,Ts,yo,_r,bs,Do,da,Tr,vs,Fo,br,ws,P,ca,vr,wr,ne,$r,ko,yr,Dr,xo,Fr,kr,xr,ha,Ir,Mr,pa,Er,jr,I,Cr,Io,Pr,qr,Mo,zr,Ar,ma,Nr,Or,fa,Lr,Wr,ua,Sr,Vr,ga,Br,Hr,Eo,Ur,Rr,$s,oe,Jr,Dt,Gr,Kr,Ft,Xr,Zr,ys,ie,ze,_a,kt,Qr,Ta,Yr,Ds,q,xt,en,le,tn,jo,on,an,It,sn,rn,nn,de,ln,Co,dn,cn,Po,hn,pn,mn,Ae,Fs,ce,Ne,ba,Mt,fn,va,un,ks,z,Et,gn,wa,_n,Tn,jt,bn,qo,vn,wn,$n,ae,Ct,yn,$a,Dn,Fn,Oe,xs,he,Le,ya,Pt,kn,Da,xn,Is,Z,qt,In,zt,Mn,At,En,jn,Cn,W,Nt,Pn,pe,qn,zo,zn,An,Fa,Nn,On,Ln,We,Wn,Se,Ms,me,Ve,ka,Ot,Sn,xa,Vn,Es,Q,Lt,Bn,fe,Hn,Wt,Un,Rn,St,Jn,Gn,Kn,S,Vt,Xn,ue,Zn,Ao,Qn,Yn,Ia,ei,ti,oi,Be,ai,He,js,ge,Ue,Ma,Bt,si,Ea,ri,Cs,A,Ht,ni,ja,ii,li,Ut,di,Rt,ci,hi,pi,V,Jt,mi,_e,fi,No,ui,gi,Ca,_i,Ti,bi,Re,vi,Je,Ps,Te,Ge,Pa,Gt,wi,qa,$i,qs,E,Kt,yi,za,Di,Fi,Aa,ki,xi,Na,Ii,Mi,Xt,Ei,Zt,ji,Ci,Pi,B,Qt,qi,be,zi,Oo,Ai,Ni,Oa,Oi,Li,Wi,Ke,Si,Xe,zs,ve,Ze,La,Yt,Vi,Wa,Bi,As,Y,eo,Hi,to,Ui,oo,Ri,Ji,Gi,H,ao,Ki,we,Xi,Lo,Zi,Qi,Sa,Yi,el,tl,Qe,ol,Ye,Ns,$e,et,Va,so,al,Ba,sl,Os,ee,ro,rl,ye,nl,no,il,ll,io,dl,cl,hl,U,lo,pl,De,ml,Wo,fl,ul,Ha,gl,_l,Tl,tt,bl,ot,Ls,Fe,at,Ua,co,vl,Ra,wl,Ws,N,ho,$l,Ja,yl,Dl,po,Fl,mo,kl,xl,Il,R,fo,Ml,ke,El,So,jl,Cl,Ga,Pl,ql,zl,st,Al,rt,Ss,xe,nt,Ka,uo,Nl,Xa,Ol,Vs,j,go,Ll,Za,Wl,Sl,Qa,Vl,Bl,Ya,Hl,Ul,_o,Rl,To,Jl,Gl,Kl,J,bo,Xl,Ie,Zl,Vo,Ql,Yl,es,ed,td,od,it,ad,lt,Bs;return a=new X({}),Pe=new se({props:{$$slots:{default:[Lc]},$$scope:{ctx:k}}}),wt=new X({}),kt=new X({}),xt=new M({props:{name:"class transformers.DeiTConfig",anchor:"transformers.DeiTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DeiTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/feature_extraction_deit.py#L91",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18134/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Whether or not to return a <a href="/docs/transformers/pr_18134/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_deit.py#L482",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18134/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18134/en/model_doc/deit#transformers.DeiTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_deit.py#L580",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_deit.py#L687",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18134/en/main_classes/output#transformers.modeling_outputs.ImageClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18134/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_deit.py#L841",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18134/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L641"}}),ao=new M({props:{name:"call",anchor:"transformers.TFDeiTModel.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFDeiTModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_18134/en/model_doc/deit#transformers.DeiTFeatureExtractor">DeiTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_18134/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L651",returnDescription:`
<p>A <a
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L768",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18134/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L875"}}),fo=new M({props:{name:"call",anchor:"transformers.TFDeiTForImageClassification.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFDeiTForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_18134/en/model_doc/deit#transformers.DeiTFeatureExtractor">DeiTFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L889",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18134/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L977"}}),bo=new M({props:{name:"call",anchor:"transformers.TFDeiTForImageClassificationWithTeacher.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFDeiTForImageClassificationWithTeacher.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_18134/en/model_doc/deit#transformers.DeiTFeatureExtractor">DeiTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_18134/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18134/src/transformers/models/deit/modeling_tf_deit.py#L996",returnDescription:`
...
compared to the original ViT models.`),Ts=f(),yo=s("p"),_r=i("The abstract from the paper is the following:"),bs=f(),Do=s("p"),da=s("em"),Tr=i(`Recently, neural networks purely based on attention were shown to address image understanding tasks such as image
...
models.`),vs=f(),Fo=s("p"),br=i("Tips:"),ws=f(),P=s("ul"),ca=s("li"),vr=i(`Compared to ViT, DeiT models use a so-called distillation token to effectively learn from a teacher (which, in the
...
prepare images for the model.`),$s=f(),oe=s("p"),Jr=i("This model was contributed by "),Dt=s("a"),Gr=i("nielsr"),Kr=i(". The TensorFlow version of this model was added by "),Ft=s("a"),Xr=i("amyeroberts"),Zr=i("."),ys=f(),ie=s("h2"),ze=s("a"),_a=s("span"),v(kt.$$.fragment),Qr=f(),Ta=s("span"),Yr=i("DeiTConfig"),Ds=f(),q=s("div"),v(xt.$$.fragment),en=f(),le=s("p"),tn=i("This is the configuration class to store the configuration of a "),jo=s("a"),on=i("DeiTModel"),an=i(`. It is used to instantiate an DeiT
...
documentation from `),Po=s("a"),hn=i("PretrainedConfig"),pn=i(" for more information."),mn=f(),v(Ae.$$.fragment),Fs=f(),ce=s("h2"),Ne=s("a"),ba=s("span"),v(Mt.$$.fragment),fn=f(),va=s("span"),un=i("DeiTFeatureExtractor"),ks=f(),z=s("div"),v(Et.$$.fragment),gn=f(),wa=s("p"),_n=i("Constructs a DeiT feature extractor."),Tn=f(),jt=s("p"),bn=i("This feature extractor inherits from "),qo=s("a"),vn=i("FeatureExtractionMixin"),wn=i(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),$n=f(),ae=s("div"),v(Ct.$$.fragment),yn=f(),$a=s("p"),Dn=i("Main method to prepare for the model one or several image(s)."),Fn=f(),v(Oe.$$.fragment),xs=f(),he=s("h2"),Le=s("a"),ya=s("span"),v(Pt.$$.fragment),kn=f(),Da=s("span"),xn=i("DeiTModel"),Is=f(),Z=s("div"),v(qt.$$.fragment),In=f(),zt=s("p"),Mn=i(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),At=s("a"),En=i("torch.nn.Module"),jn=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cn=f(),W=s("div"),v(Nt.$$.fragment),Pn=f(),pe=s("p"),qn=i("The "),zo=s("a"),zn=i("DeiTModel"),An=i(" forward method, overrides the "),Fa=s("code"),Nn=i("__call__"),On=i(" special method."),Ln=f(),v(We.$$.fragment),Wn=f(),v(Se.$$.fragment),Ms=f(),me=s("h2"),Ve=s("a"),ka=s("span"),v(Ot.$$.fragment),Sn=f(),xa=s("span"),Vn=i("DeiTForMaskedImageModeling"),Es=f(),Q=s("div"),v(Lt.$$.fragment),Bn=f(),fe=s("p"),Hn=i("DeiT Model with a decoder on top for masked image modeling, as proposed in "),Wt=s("a"),Un=i("SimMIM"),Rn=i(`.
This model is a PyTorch `),St=s("a"),Jn=i("torch.nn.Module"),Gn=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Kn=f(),S=s("div"),v(Vt.$$.fragment),Xn=f(),ue=s("p"),Zn=i("The "),Ao=s("a"),Qn=i("DeiTForMaskedImageModeling"),Yn=i(" forward method, overrides the "),Ia=s("code"),ei=i("__call__"),ti=i(" special method."),oi=f(),v(Be.$$.fragment),ai=f(),v(He.$$.fragment),js=f(),ge=s("h2"),Ue=s("a"),Ma=s("span"),v(Bt.$$.fragment),si=f(),Ea=s("span"),ri=i("DeiTForImageClassification"),Cs=f(),A=s("div"),v(Ht.$$.fragment),ni=f(),ja=s("p"),ii=i(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),li=f(),Ut=s("p"),di=i("This model is a PyTorch "),Rt=s("a"),ci=i("torch.nn.Module"),hi=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pi=f(),V=s("div"),v(Jt.$$.fragment),mi=f(),_e=s("p"),fi=i("The "),No=s("a"),ui=i("DeiTForImageClassification"),gi=i(" forward method, overrides the "),Ca=s("code"),_i=i("__call__"),Ti=i(" special method."),bi=f(),v(Re.$$.fragment),vi=f(),v(Je.$$.fragment),Ps=f(),Te=s("h2"),Ge=s("a"),Pa=s("span"),v(Gt.$$.fragment),wi=f(),qa=s("span"),$i=i("DeiTForImageClassificationWithTeacher"),qs=f(),E=s("div"),v(Kt.$$.fragment),yi=f(),za=s("p"),Di=i(`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pi=f(),B=s("div"),v(Qt.$$.fragment),qi=f(),be=s("p"),zi=i("The "),Oo=s("a"),Ai=i("DeiTForImageClassificationWithTeacher"),Ni=i(" forward method, overrides the "),Oa=s("code"),Oi=i("__call__"),Li=i(" special method."),Wi=f(),v(Ke.$$.fragment),Si=f(),v(Xe.$$.fragment),zs=f(),ve=s("h2"),Ze=s("a"),La=s("span"),v(Yt.$$.fragment),Vi=f(),Wa=s("span"),Bi=i("TFDeiTModel"),As=f(),Y=s("div"),v(eo.$$.fragment),Hi=f(),to=s("p"),Ui=i(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a TensorFlow
`),oo=s("a"),Ri=i("tf.keras.layers.Layer"),Ji=i(`. Use it as a regular
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),Gi=f(),H=s("div"),v(ao.$$.fragment),Ki=f(),we=s("p"),Xi=i("The "),Lo=s("a"),Zi=i("TFDeiTModel"),Qi=i(" forward method, overrides the "),Sa=s("code"),Yi=i("__call__"),el=i(" special method."),tl=f(),v(Qe.$$.fragment),ol=f(),v(Ye.$$.fragment),Ns=f(),$e=s("h2"),et=s("a"),Va=s("span"),v(so.$$.fragment),al=f(),Ba=s("span"),sl=i("TFDeiTForMaskedImageModeling"),Os=f(),ee=s("div"),v(ro.$$.fragment),rl=f(),ye=s("p"),nl=i("DeiT Model with a decoder on top for masked image modeling, as proposed in "),no=s("a"),il=i("SimMIM"),ll=i(`.
This model is a TensorFlow
`),io=s("a"),dl=i("tf.keras.layers.Layer"),cl=i(`. Use it as a regular
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),hl=f(),U=s("div"),v(lo.$$.fragment),pl=f(),De=s("p"),ml=i("The "),Wo=s("a"),fl=i("TFDeiTForMaskedImageModeling"),ul=i(" forward method, overrides the "),Ha=s("code"),gl=i("__call__"),_l=i(" special method."),Tl=f(),v(tt.$$.fragment),bl=f(),v(ot.$$.fragment),Ls=f(),Fe=s("h2"),at=s("a"),Ua=s("span"),v(co.$$.fragment),vl=f(),Ra=s("span"),wl=i("TFDeiTForImageClassification"),Ws=f(),N=s("div"),v(ho.$$.fragment),$l=f(),Ja=s("p"),yl=i(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),Il=f(),R=s("div"),v(fo.$$.fragment),Ml=f(),ke=s("p"),El=i("The "),So=s("a"),jl=i("TFDeiTForImageClassification"),Cl=i(" forward method, overrides the "),Ga=s("code"),Pl=i("__call__"),ql=i(" special method."),zl=f(),v(st.$$.fragment),Al=f(),v(rt.$$.fragment),Ss=f(),xe=s("h2"),nt=s("a"),Ka=s("span"),v(uo.$$.fragment),Nl=f(),Xa=s("span"),Ol=i("TFDeiTForImageClassificationWithTeacher"),Vs=f(),j=s("div"),v(go.$$.fragment),Ll=f(),Za=s("p"),Wl=i(`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
...
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),Kl=f(),J=s("div"),v(bo.$$.fragment),Xl=f(),Ie=s("p"),Zl=i("The "),Vo=s("a"),Ql=i("TFDeiTForImageClassificationWithTeacher"),Yl=i(" forward method, overrides the "),es=s("code"),ed=i("__call__"),td=i(" special method."),od=f(),v(it.$$.fragment),ad=f(),v(lt.$$.fragment),this.h()},l(t){const g=Nc('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(o),b=u(t),m=r(t,"H1",{class:!0});var vo=n(m);h=r(vo,"A",{id:!0,class:!0,href:!0});var ts=n(h);_=r(ts,"SPAN",{});var os=n(_);w(a.$$.fragment,os),os.forEach(o),ts.forEach(o),c=u(vo),x=r(vo,"SPAN",{});var as=n(x);ir=l(as,"DeiT"),as.forEach(o),vo.forEach(o),us=u(t),w(Pe.$$.fragment,t),gs=u(t),re=r(t,"H2",{class:!0});var wo=n(re);qe=r(wo,"A",{id:!0,class:!0,href:!0});var ss=n(qe);ia=r(ss,"SPAN",{});var rs=n(ia);w(wt.$$.fragment,rs),rs.forEach(o),ss.forEach(o),lr=u(wo),la=r(wo,"SPAN",{});var ns=n(la);dr=l(ns,"Overview"),ns.forEach(o),wo.forEach(o),_s=u(t),L=r(t,"P",{});var te=n(L);cr=l(te,"The DeiT model was proposed in "),$t=r(te,"A",{href:!0,rel:!0});var is=n($t);hr=l(is,"Training data-efficient image transformers & distillation through attention"),is.forEach(o),pr=l(te,` by Hugo Touvron, Matthieu Cord, Matthijs Douze, Francisco Massa, Alexandre
...
distillation, especially when using a convnet as a teacher. This leads us to report results competitive with convnets
for both Imagenet (where we obtain up to 85.2% accuracy) and when transferring to other tasks. We share our code and
models.`),ps.forEach(o),hs.forEach(o),vs=u(t),Fo=r(t,"P",{});var ms=n(Fo);br=l(ms,"Tips:"),ms.forEach(o),ws=u(t),P=r(t,"UL",{});var O=n(P);ca=r(O,"LI",{});var fs=n(ca);vr=l(fs,`Compared to ViT, DeiT models use a so-called distillation token to effectively learn from a teacher (which, in the
DeiT paper, is a ResNet like-model). The distillation token is learned through backpropagation, by interacting with
...
prepare images for the model.`),C.forEach(o),O.forEach(o),$s=u(t),oe=r(t,"P",{});var Bo=n(oe);Jr=l(Bo,"This model was contributed by "),Dt=r(Bo,"A",{href:!0,rel:!0});var ud=n(Dt);Gr=l(ud,"nielsr"),ud.forEach(o),Kr=l(Bo,". The TensorFlow version of this model was added by "),Ft=r(Bo,"A",{href:!0,rel:!0});var gd=n(Ft);Xr=l(gd,"amyeroberts"),gd.forEach(o),Zr=l(Bo,"."),Bo.forEach(o),ys=u(t),ie=r(t,"H2",{class:!0});var Hs=n(ie);ze=r(Hs,"A",{id:!0,class:!0,href:!0});var _d=n(ze);_a=r(_d,"SPAN",{});var Td=n(_a);w(kt.$$.fragment,Td),Td.forEach(o),_d.forEach(o),Qr=u(Hs),Ta=r(Hs,"SPAN",{});var bd=n(Ta);Yr=l(bd,"DeiTConfig"),bd.forEach(o),Hs.forEach(o),Ds=u(t),q=r(t,"DIV",{class:!0});var dt=n(q);w(xt.$$.fragment,dt),en=u(dt),le=r(dt,"P",{});var Ho=n(le);tn=l(Ho,"This is the configuration class to store the configuration of a "),jo=r(Ho,"A",{href:!0});var vd=n(jo);on=l(vd,"DeiTModel"),vd.forEach(o),an=l(Ho,`. It is used to instantiate an DeiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the DeiT
...
documentation from `),Po=r(Uo,"A",{href:!0});var yd=n(Po);hn=l(yd,"PretrainedConfig"),yd.forEach(o),pn=l(Uo," for more information."),Uo.forEach(o),mn=u(dt),w(Ae.$$.fragment,dt),dt.forEach(o),Fs=u(t),ce=r(t,"H2",{class:!0});var Us=n(ce);Ne=r(Us,"A",{id:!0,class:!0,href:!0});var Dd=n(Ne);ba=r(Dd,"SPAN",{});var Fd=n(ba);w(Mt.$$.fragment,Fd),Fd.forEach(o),Dd.forEach(o),fn=u(Us),va=r(Us,"SPAN",{});var kd=n(va);un=l(kd,"DeiTFeatureExtractor"),kd.forEach(o),Us.forEach(o),ks=u(t),z=r(t,"DIV",{class:!0});var ct=n(z);w(Et.$$.fragment,ct),gn=u(ct),wa=r(ct,"P",{});var xd=n(wa);_n=l(xd,"Constructs a DeiT feature extractor."),xd.forEach(o),Tn=u(ct),jt=r(ct,"P",{});var Rs=n(jt);bn=l(Rs,"This feature extractor inherits from "),qo=r(Rs,"A",{href:!0});var Id=n(qo);vn=l(Id,"FeatureExtractionMixin"),Id.forEach(o),wn=l(Rs,` which contains most of the main methods. Users
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ys.forEach(o),Pi=u(G),B=r(G,"DIV",{class:!0});var ut=n(B);w(Qt.$$.fragment,ut),qi=u(ut),be=r(ut,"P",{});var Yo=n(be);zi=l(Yo,"The "),Oo=r(Yo,"A",{href:!0});var ac=n(Oo);Ai=l(ac,"DeiTForImageClassificationWithTeacher"),ac.forEach(o),Ni=l(Yo," forward method, overrides the "),Oa=r(Yo,"CODE",{});var sc=n(Oa);Oi=l(sc,"__call__"),sc.forEach(o),Li=l(Yo," special method."),Yo.forEach(o),Wi=u(ut),w(Ke.$$.fragment,ut),Si=u(ut),w(Xe.$$.fragment,ut),ut.forEach(o),G.forEach(o),zs=u(t),ve=r(t,"H2",{class:!0});var er=n(ve);Ze=r(er,"A",{id:!0,class:!0,href:!0});var rc=n(Ze);La=r(rc,"SPAN",{});var nc=n(La);w(Yt.$$.fragment,nc),nc.forEach(o),rc.forEach(o),Vi=u(er),Wa=r(er,"SPAN",{});var ic=n(Wa);Bi=l(ic,"TFDeiTModel"),ic.forEach(o),er.forEach(o),As=u(t),Y=r(t,"DIV",{class:!0});var ea=n(Y);w(eo.$$.fragment,ea),Hi=u(ea),to=r(ea,"P",{});var tr=n(to);Ui=l(tr,`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a TensorFlow
...
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),aa.forEach(o),hl=u(oa),U=r(oa,"DIV",{class:!0});var _t=n(U);w(lo.$$.fragment,_t),pl=u(_t),De=r(_t,"P",{});var sa=n(De);ml=l(sa,"The "),Wo=r(sa,"A",{href:!0});var gc=n(Wo);fl=l(gc,"TFDeiTForMaskedImageModeling"),gc.forEach(o),ul=l(sa," forward method, overrides the "),Ha=r(sa,"CODE",{});var _c=n(Ha);gl=l(_c,"__call__"),_c.forEach(o),_l=l(sa," special method."),sa.forEach(o),Tl=u(_t),w(tt.$$.fragment,_t),bl=u(_t),w(ot.$$.fragment,_t),_t.forEach(o),oa.forEach(o),Ls=u(t),Fe=r(t,"H2",{class:!0});var ar=n(Fe);at=r(ar,"A",{id:!0,class:!0,href:!0});var Tc=n(at);Ua=r(Tc,"SPAN",{});var bc=n(Ua);w(co.$$.fragment,bc),bc.forEach(o),Tc.forEach(o),vl=u(ar),Ra=r(ar,"SPAN",{});var vc=n(Ra);wl=l(vc,"TFDeiTForImageClassification"),vc.forEach(o),ar.forEach(o),Ws=u(t),N=r(t,"DIV",{class:!0});var Tt=n(N);w(ho.$$.fragment,Tt),$l=u(Tt),Ja=r(Tt,"P",{});var wc=n(Ja);yl=l(wc,`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),sr.forEach(o),Il=u(Tt),R=r(Tt,"DIV",{class:!0});var bt=n(R);w(fo.$$.fragment,bt),Ml=u(bt),ke=r(bt,"P",{});var ra=n(ke);El=l(ra,"The "),So=r(ra,"A",{href:!0});var yc=n(So);jl=l(yc,"TFDeiTForImageClassification"),yc.forEach(o),Cl=l(ra," forward method, overrides the "),Ga=r(ra,"CODE",{});var Dc=n(Ga);Pl=l(Dc,"__call__"),Dc.forEach(o),ql=l(ra," special method."),ra.forEach(o),zl=u(bt),w(st.$$.fragment,bt),Al=u(bt),w(rt.$$.fragment,bt),bt.forEach(o),Tt.forEach(o),Ss=u(t),xe=r(t,"H2",{class:!0});var rr=n(xe);nt=r(rr,"A",{id:!0,class:!0,href:!0});var Fc=n(nt);Ka=r(Fc,"SPAN",{});var kc=n(Ka);w(uo.$$.fragment,kc),kc.forEach(o),Fc.forEach(o),Nl=u(rr),Xa=r(rr,"SPAN",{});var xc=n(Xa);Ol=l(xc,"TFDeiTForImageClassificationWithTeacher"),xc.forEach(o),rr.forEach(o),Vs=u(t),j=r(t,"DIV",{class:!0});var K=n(j);w(go.$$.fragment,K),Ll=u(K),Za=r(K,"P",{});var Ic=n(Za);Wl=l(Ic,`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
