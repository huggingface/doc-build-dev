...
important, getting a slightly slower training time could be a good trade.`),Gy=u(),He=o("p"),J7=a("Additionally, "),bd=o("code"),X7=a("deepspeed==0.4.4"),Q7=a(" added a new option "),qd=o("code"),e9=a("round_robin_gradients"),s9=a(" which you can enable with:"),My=u(),f(Qo.$$.fragment),Ly=u(),xi=o("p"),t9=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Zy=u(),Ri=o("a"),Ny=u(),Rs=o("h4"),oa=o("a"),Ed=o("span"),f(el.$$.fragment),a9=u(),$d=o("span"),n9=a("ZeRO-3 Config"),Hy=u(),Ii=o("p"),o9=a("The following is an example of configuration for ZeRO stage 3:"),By=u(),f(sl.$$.fragment),Wy=u(),V=o("p"),l9=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),kd=o("code"),r9=a('"device": "cpu"'),p9=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Pd=o("code"),i9=a("none"),u9=a(" instead of "),zd=o("code"),c9=a("cpu"),h9=a(" for the "),Dd=o("code"),f9=a("device"),d9=a(` entry. Offloading to
NVMe is discussed further down.`),Fy=u(),Be=o("p"),m9=a("Pinned memory is enabled with "),Od=o("code"),_9=a("pin_memory"),v9=a(" set to "),Ad=o("code"),j9=a("true"),w9=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Vy=u(),Ui=o("p"),Td=o("strong"),y9=a("Performance tuning:"),Yy=u(),la=o("ul"),tl=o("li"),Sd=o("code"),g9=a("stage3_max_live_parameters"),b9=a(": "),Cd=o("code"),q9=a("1e9"),E9=u(),al=o("li"),xd=o("code"),$9=a("stage3_max_reuse_distance"),k9=a(": "),Rd=o("code"),P9=a("1e9"),Ky=u(),M=o("p"),z9=a("If hitting OOM reduce "),Id=o("code"),D9=a("stage3_max_live_parameters"),O9=a(" and "),Ud=o("code"),A9=a("stage3_max_reuse_distance"),T9=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Gd=o("code"),S9=a("1e9"),C9=a(` would consume ~2GB. The memory is shared by
`),Md=o("code"),x9=a("stage3_max_live_parameters"),R9=a(" and "),Ld=o("code"),I9=a("stage3_max_reuse_distance"),U9=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Jy=u(),ze=o("p"),Zd=o("code"),G9=a("stage3_max_live_parameters"),M9=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Nd=o("code"),L9=a("stage3_max_reuse_distance"),Z9=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Hd=o("code"),N9=a("stage3_max_reuse_distance"),H9=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Xy=u(),Gi=o("p"),B9=a("The following configuration values depend on the model\u2019s hidden size:"),Qy=u(),We=o("ul"),nl=o("li"),Bd=o("code"),W9=a("reduce_bucket_size"),F9=a(": "),Wd=o("code"),V9=a("hidden_size*hidden_size"),Y9=u(),ol=o("li"),Fd=o("code"),K9=a("stage3_prefetch_bucket_size"),J9=a(": "),Vd=o("code"),X9=a("0.9 * hidden_size * hidden_size"),Q9=u(),ll=o("li"),Yd=o("code"),ek=a("stage3_param_persistence_threshold"),sk=a(": "),Kd=o("code"),tk=a("10 * hidden_size"),eg=u(),Fe=o("p"),ak=a("therefore set these values to "),Jd=o("code"),nk=a("auto"),ok=a(" and the "),Mi=o("a"),lk=a("Trainer"),rk=a(` will automatically assign the recommended
...
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),TL.forEach(t),ph.forEach(t),Gy=c(e),He=l(e,"P",{});var uh=r(He);J7=n(uh,"Additionally, "),bd=l(uh,"CODE",{});var SL=r(bd);X7=n(SL,"deepspeed==0.4.4"),SL.forEach(t),Q7=n(uh," added a new option "),qd=l(uh,"CODE",{});var CL=r(qd);e9=n(CL,"round_robin_gradients"),CL.forEach(t),s9=n(uh," which you can enable with:"),uh.forEach(t),My=c(e),d(Qo.$$.fragment,e),Ly=c(e),xi=l(e,"P",{});var xL=r(xi);t9=n(xL,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),xL.forEach(t),Zy=c(e),Ri=l(e,"A",{id:!0}),r(Ri).forEach(t),Ny=c(e),Rs=l(e,"H4",{class:!0});var bq=r(Rs);oa=l(bq,"A",{id:!0,class:!0,href:!0});var RL=r(oa);Ed=l(RL,"SPAN",{});var IL=r(Ed);d(el.$$.fragment,IL),IL.forEach(t),RL.forEach(t),a9=c(bq),$d=l(bq,"SPAN",{});var UL=r($d);n9=n(UL,"ZeRO-3 Config"),UL.forEach(t),bq.forEach(t),Hy=c(e),Ii=l(e,"P",{});var GL=r(Ii);o9=n(GL,"The following is an example of configuration for ZeRO stage 3:"),GL.forEach(t),By=c(e),d(sl.$$.fragment,e),Wy=c(e),V=l(e,"P",{});var ws=r(V);l9=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),kd=l(ws,"CODE",{});var ML=r(kd);r9=n(ML,'"device": "cpu"'),ML.forEach(t),p9=n(ws,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Pd=l(ws,"CODE",{});var LL=r(Pd);i9=n(LL,"none"),LL.forEach(t),u9=n(ws," instead of "),zd=l(ws,"CODE",{});var ZL=r(zd);c9=n(ZL,"cpu"),ZL.forEach(t),h9=n(ws," for the "),Dd=l(ws,"CODE",{});var NL=r(Dd);f9=n(NL,"device"),NL.forEach(t),d9=n(ws,` entry. Offloading to
NVMe is discussed further down.`),ws.forEach(t),Fy=c(e),Be=l(e,"P",{});var ch=r(Be);m9=n(ch,"Pinned memory is enabled with "),Od=l(ch,"CODE",{});var HL=r(Od);_9=n(HL,"pin_memory"),HL.forEach(t),v9=n(ch," set to "),Ad=l(ch,"CODE",{});var BL=r(Ad);j9=n(BL,"true"),BL.forEach(t),w9=n(ch,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),ch.forEach(t),Vy=c(e),Ui=l(e,"P",{});var WL=r(Ui);Td=l(WL,"STRONG",{});var FL=r(Td);y9=n(FL,"Performance tuning:"),FL.forEach(t),WL.forEach(t),Yy=c(e),la=l(e,"UL",{});var qq=r(la);tl=l(qq,"LI",{});var Eq=r(tl);Sd=l(Eq,"CODE",{});var VL=r(Sd);g9=n(VL,"stage3_max_live_parameters"),VL.forEach(t),b9=n(Eq,": "),Cd=l(Eq,"CODE",{});var YL=r(Cd);q9=n(YL,"1e9"),YL.forEach(t),Eq.forEach(t),E9=c(qq),al=l(qq,"LI",{});var $q=r(al);xd=l($q,"CODE",{});var KL=r(xd);$9=n(KL,"stage3_max_reuse_distance"),KL.forEach(t),k9=n($q,": "),Rd=l($q,"CODE",{});var JL=r(Rd);P9=n(JL,"1e9"),JL.forEach(t),$q.forEach(t),qq.forEach(t),Ky=c(e),M=l(e,"P",{});var ge=r(M);z9=n(ge,"If hitting OOM reduce "),Id=l(ge,"CODE",{});var XL=r(Id);D9=n(XL,"stage3_max_live_parameters"),XL.forEach(t),O9=n(ge," and "),Ud=l(ge,"CODE",{});var QL=r(Ud);A9=n(QL,"stage3_max_reuse_distance"),QL.forEach(t),T9=n(ge,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Gd=l(ge,"CODE",{});var eZ=r(Gd);S9=n(eZ,"1e9"),eZ.forEach(t),C9=n(ge,` would consume ~2GB. The memory is shared by
`),Md=l(ge,"CODE",{});var sZ=r(Md);x9=n(sZ,"stage3_max_live_parameters"),sZ.forEach(t),R9=n(ge," and "),Ld=l(ge,"CODE",{});var tZ=r(Ld);I9=n(tZ,"stage3_max_reuse_distance"),tZ.forEach(t),U9=n(ge,", so it\u2019s not additive, it\u2019s just 2GB total."),ge.forEach(t),Jy=c(e),ze=l(e,"P",{});var gp=r(ze);Zd=l(gp,"CODE",{});var aZ=r(Zd);G9=n(aZ,"stage3_max_live_parameters"),aZ.forEach(t),M9=n(gp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Nd=l(gp,"CODE",{});var nZ=r(Nd);L9=n(nZ,"stage3_max_reuse_distance"),nZ.forEach(t),Z9=n(gp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Hd=l(gp,"CODE",{});var oZ=r(Hd);N9=n(oZ,"stage3_max_reuse_distance"),oZ.forEach(t),H9=n(gp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),gp.forEach(t),Xy=c(e),Gi=l(e,"P",{});var lZ=r(Gi);B9=n(lZ,"The following configuration values depend on the model\u2019s hidden size:"),lZ.forEach(t),Qy=c(e),We=l(e,"UL",{});var hh=r(We);nl=l(hh,"LI",{});var kq=r(nl);Bd=l(kq,"CODE",{});var rZ=r(Bd);W9=n(rZ,"reduce_bucket_size"),rZ.forEach(t),F9=n(kq,": "),Wd=l(kq,"CODE",{});var pZ=r(Wd);V9=n(pZ,"hidden_size*hidden_size"),pZ.forEach(t),kq.forEach(t),Y9=c(hh),ol=l(hh,"LI",{});var Pq=r(ol);Fd=l(Pq,"CODE",{});var iZ=r(Fd);K9=n(iZ,"stage3_prefetch_bucket_size"),iZ.forEach(t),J9=n(Pq,": "),Vd=l(Pq,"CODE",{});var uZ=r(Vd);X9=n(uZ,"0.9 * hidden_size * hidden_size"),uZ.forEach(t),Pq.forEach(t),Q9=c(hh),ll=l(hh,"LI",{});var zq=r(ll);Yd=l(zq,"CODE",{});var cZ=r(Yd);ek=n(cZ,"stage3_param_persistence_threshold"),cZ.forEach(t),sk=n(zq,": "),Kd=l(zq,"CODE",{});var hZ=r(Kd);tk=n(hZ,"10 * hidden_size"),hZ.forEach(t),zq.forEach(t),hh.forEach(t),eg=c(e),Fe=l(e,"P",{});var fh=r(Fe);ak=n(fh,"therefore set these values to "),Jd=l(fh,"CODE",{});var fZ=r(Jd);nk=n(fZ,"auto"),fZ.forEach(t),ok=n(fh," and the "),Mi=l(fh,"A",{href:!0});var dZ=r(Mi);lk=n(dZ,"Trainer"),dZ.forEach(t),rk=n(fh,` will automatically assign the recommended
