import{S as Iq,i as Wq,s as Uq,e as o,k as l,w as b,t as a,M as Hq,c as r,d as s,m as p,a as i,x as v,h as n,b as d,N as Bq,F as e,g as c,y as w,q as y,o as k,B as j}from"../../chunks/vendor-4833417e.js";import{T as As}from"../../chunks/Tip-fffd6df1.js";import{D as le}from"../../chunks/Docstring-4f315ed9.js";import{C as Ft}from"../../chunks/CodeBlock-6a3d1b46.js";import{C as Gr}from"../../chunks/CodeBlockFw-27a176a0.js";import{I as ss}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Gq(U){let m,F,g,f,q;return{c(){m=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),f=a("Module"),q=a(`
...
`}}),pn=new le({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/tokenization_tapas.py#L397"}}),dn=new ss({}),cn=new le({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16070/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Tn=new le({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),vn=new ss({}),wn=new le({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16070/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),jn=new le({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),En=new ss({}),Fn=new le({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16070/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xn=new le({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),On=new ss({}),In=new le({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16070/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[Yq]},$$scope:{ctx:U}}}),Bn=new le({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16070/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Rn=new ss({}),Vn=new le({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16070/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[Xq]},$$scope:{ctx:U}}}),Zn=new le({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),so=new ss({}),to=new le({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16070/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[e2]},$$scope:{ctx:U}}}),ro=new le({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16070/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16070/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16070/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
inputs to be fine-tuned:`),cs.forEach(s),$d=p(t),Nt=r(t,"TABLE",{});var yc=i(Nt);Ui=r(yc,"THEAD",{});var E1=i(Ui);Pa=r(E1,"TR",{});var kc=i(Pa);Hi=r(kc,"TH",{});var F1=i(Hi);Bi=r(F1,"STRONG",{});var A1=i(Bi);ig=n(A1,"Task"),A1.forEach(s),F1.forEach(s),lg=p(kc),Gi=r(kc,"TH",{});var $1=i(Gi);Ri=r($1,"STRONG",{});var z1=i(Ri);pg=n(z1,"Required inputs"),z1.forEach(s),$1.forEach(s),kc.forEach(s),E1.forEach(s),dg=p(yc),st=r(yc,"TBODY",{});var Cr=i(st);Sa=r(Cr,"TR",{});var jc=i(Sa);Vi=r(jc,"TD",{});var x1=i(Vi);cg=n(x1,"Conversational"),x1.forEach(s),hg=p(jc),$s=r(jc,"TD",{});var ua=i($s);Ki=r(ua,"CODE",{});var C1=i(Ki);ug=n(C1,"input_ids"),C1.forEach(s),mg=n(ua,", "),Yi=r(ua,"CODE",{});var M1=i(Yi);gg=n(M1,"attention_mask"),M1.forEach(s),fg=n(ua,", "),Ji=r(ua,"CODE",{});var P1=i(Ji);_g=n(P1,"token_type_ids"),P1.forEach(s),Tg=n(ua,", "),Xi=r(ua,"CODE",{});var S1=i(Xi);bg=n(S1,"labels"),S1.forEach(s),ua.forEach(s),jc.forEach(s),vg=p(Cr),Da=r(Cr,"TR",{});var qc=i(Da);Zi=r(qc,"TD",{});var D1=i(Zi);wg=n(D1,"Weak supervision for aggregation"),D1.forEach(s),yg=p(qc),Pe=r(qc,"TD",{});var hs=i(Pe);el=r(hs,"CODE",{});var N1=i(el);kg=n(N1,"input_ids"),N1.forEach(s),jg=n(hs,", "),sl=r(hs,"CODE",{});var L1=i(sl);qg=n(L1,"attention_mask"),L1.forEach(s),Eg=n(hs,", "),tl=r(hs,"CODE",{});var Q1=i(tl);Fg=n(Q1,"token_type_ids"),Q1.forEach(s),Ag=n(hs,", "),al=r(hs,"CODE",{});var O1=i(al);$g=n(O1,"labels"),O1.forEach(s),zg=n(hs,", "),nl=r(hs,"CODE",{});var I1=i(nl);xg=n(I1,"numeric_values"),I1.forEach(s),Cg=n(hs,", "),ol=r(hs,"CODE",{});var W1=i(ol);Mg=n(W1,"numeric_values_scale"),W1.forEach(s),Pg=n(hs,", "),rl=r(hs,"CODE",{});var U1=i(rl);Sg=n(U1,"float_answer"),U1.forEach(s),hs.forEach(s),qc.forEach(s),Dg=p(Cr),Na=r(Cr,"TR",{});var Ec=i(Na);il=r(Ec,"TD",{});var H1=i(il);Ng=n(H1,"Strong supervision for aggregation"),H1.forEach(s),Lg=p(Ec),ms=r(Ec,"TD",{});var Ss=i(ms);ll=r(Ss,"CODE",{});var B1=i(ll);Qg=n(B1,"input ids"),B1.forEach(s),Og=n(Ss,", "),pl=r(Ss,"CODE",{});var G1=i(pl);Ig=n(G1,"attention mask"),G1.forEach(s),Wg=n(Ss,", "),dl=r(Ss,"CODE",{});var R1=i(dl);Ug=n(R1,"token type ids"),R1.forEach(s),Hg=n(Ss,", "),cl=r(Ss,"CODE",{});var V1=i(cl);Bg=n(V1,"labels"),V1.forEach(s),Gg=n(Ss,", "),hl=r(Ss,"CODE",{});var K1=i(hl);Rg=n(K1,"aggregation_labels"),K1.forEach(s),Ss.forEach(s),Ec.forEach(s),Cr.forEach(s),yc.forEach(s),zd=p(t),pe=r(t,"P",{});var Ie=i(pe);Wo=r(Ie,"A",{href:!0});var Y1=i(Wo);Vg=n(Y1,"TapasTokenizer"),Y1.forEach(s),Kg=n(Ie," creates the "),ul=r(Ie,"CODE",{});var J1=i(ul);Yg=n(J1,"labels"),J1.forEach(s),Jg=n(Ie,", "),ml=r(Ie,"CODE",{});var X1=i(ml);Xg=n(X1,"numeric_values"),X1.forEach(s),Zg=n(Ie," and "),gl=r(Ie,"CODE",{});var Z1=i(gl);ef=n(Z1,"numeric_values_scale"),Z1.forEach(s),sf=n(Ie," based on the "),fl=r(Ie,"CODE",{});var e0=i(fl);tf=n(e0,"answer_coordinates"),e0.forEach(s),af=n(Ie," and "),_l=r(Ie,"CODE",{});var s0=i(_l);nf=n(s0,"answer_text"),s0.forEach(s),of=n(Ie," columns of the TSV file. The "),Tl=r(Ie,"CODE",{});var t0=i(Tl);rf=n(t0,"float_answer"),t0.forEach(s),lf=n(Ie," and "),bl=r(Ie,"CODE",{});var a0=i(bl);pf=n(a0,"aggregation_labels"),a0.forEach(s),df=n(Ie," are already in the TSV file of step 2. Here\u2019s an example:"),Ie.forEach(s),xd=p(t),v(La.$$.fragment,t),Cd=p(t),bs=r(t,"P",{});var ma=i(bs);cf=n(ma,"Note that "),Uo=r(ma,"A",{href:!0});var n0=i(Uo);hf=n(n0,"TapasTokenizer"),n0.forEach(s),uf=n(ma," expects the data of the table to be "),vl=r(ma,"STRONG",{});var o0=i(vl);mf=n(o0,"text-only"),o0.forEach(s),gf=n(ma,". You can use "),wl=r(ma,"CODE",{});var r0=i(wl);ff=n(r0,".astype(str)"),r0.forEach(s),_f=n(ma,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),ma.forEach(s),Md=p(t),v(Qa.$$.fragment,t),Pd=p(t),X=r(t,"P",{});var ge=i(X);Tf=n(ge,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),yl=r(ge,"STRONG",{});var i0=i(yl);bf=n(i0,"not conversational"),i0.forEach(s),vf=n(ge,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),kl=r(ge,"CODE",{});var l0=i(kl);wf=n(l0,"queries"),l0.forEach(s),yf=n(ge,", "),jl=r(ge,"CODE",{});var p0=i(jl);kf=n(p0,"answer_coordinates"),p0.forEach(s),jf=n(ge," and "),ql=r(ge,"CODE",{});var d0=i(ql);qf=n(d0,"answer_text"),d0.forEach(s),Ef=n(ge," per table (in the order of their "),El=r(ge,"CODE",{});var c0=i(El);Ff=n(c0,"position"),c0.forEach(s),Af=n(ge,`
index) and batch encode each table with its questions. This will make sure that the `),Fl=r(ge,"CODE",{});var h0=i(Fl);$f=n(h0,"prev_labels"),h0.forEach(s),zf=n(ge," token types (see docs of "),Ho=r(ge,"A",{href:!0});var u0=i(Ho);xf=n(u0,"TapasTokenizer"),u0.forEach(s),Cf=n(ge,") are set correctly. See "),Oa=r(ge,"A",{href:!0,rel:!0});var m0=i(Oa);Mf=n(m0,"this notebook"),m0.forEach(s),Pf=n(ge," for more info. See "),Ia=r(ge,"A",{href:!0,rel:!0});var g0=i(Ia);Sf=n(g0,"this notebook"),g0.forEach(s),Df=n(ge," for more info regarding using the TensorFlow model."),ge.forEach(s),Sd=p(t),Bo=r(t,"P",{});var f0=i(Bo);Al=r(f0,"STRONG",{});var _0=i(Al);Nf=n(_0,"STEP 4: Train (fine-tune) TapasForQuestionAnswering/TFTapasForQuestionAnswering"),_0.forEach(s),f0.forEach(s),Dd=p(t),Ms=r(t,"P",{});var Mr=i(Ms);Lf=n(Mr,"You can then fine-tune "),Go=r(Mr,"A",{href:!0});var T0=i(Go);Qf=n(T0,"TapasForQuestionAnswering"),T0.forEach(s),Of=n(Mr," or "),Ro=r(Mr,"A",{href:!0});var b0=i(Ro);If=n(b0,"TFTapasForQuestionAnswering"),b0.forEach(s),Wf=n(Mr," as follows (shown here for the weak supervision for aggregation case):"),Mr.forEach(s),Nd=p(t),v(Wa.$$.fragment,t),Ld=p(t),tt=r(t,"H2",{class:!0});var Fc=i(tt);Lt=r(Fc,"A",{id:!0,class:!0,href:!0});var v0=i(Lt);$l=r(v0,"SPAN",{});var w0=i($l);v(Ua.$$.fragment,w0),w0.forEach(s),v0.forEach(s),Uf=p(Fc),zl=r(Fc,"SPAN",{});var y0=i(zl);Hf=n(y0,"Usage: inference"),y0.forEach(s),Fc.forEach(s),Qd=p(t),me=r(t,"P",{});var He=i(me);Bf=n(He,"Here we explain how you can use "),Vo=r(He,"A",{href:!0});var k0=i(Vo);Gf=n(k0,"TapasForQuestionAnswering"),k0.forEach(s),Rf=n(He," or "),Ko=r(He,"A",{href:!0});var j0=i(Ko);Vf=n(j0,"TFTapasForQuestionAnswering"),j0.forEach(s),Kf=n(He," for inference (i.e. making predictions on new data). For inference, only "),xl=r(He,"CODE",{});var q0=i(xl);Yf=n(q0,"input_ids"),q0.forEach(s),Jf=n(He,", "),Cl=r(He,"CODE",{});var E0=i(Cl);Xf=n(E0,"attention_mask"),E0.forEach(s),Zf=n(He," and "),Ml=r(He,"CODE",{});var F0=i(Ml);e_=n(F0,"token_type_ids"),F0.forEach(s),s_=n(He," (which you can obtain using "),Yo=r(He,"A",{href:!0});var A0=i(Yo);t_=n(A0,"TapasTokenizer"),A0.forEach(s),a_=n(He,") have to be provided to the model to obtain the logits. Next, you can use the handy "),Pl=r(He,"CODE",{});var $0=i(Pl);n_=n($0,"convert_logits_to_predictions"),$0.forEach(s),o_=n(He," method to convert these into predicted coordinates and optional aggregation indices."),He.forEach(s),Od=p(t),Qt=r(t,"P",{});var Ac=i(Qt);r_=n(Ac,"However, note that inference is "),Sl=r(Ac,"STRONG",{});var z0=i(Sl);i_=n(z0,"different"),z0.forEach(s),l_=n(Ac," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),Ac.forEach(s),Id=p(t),v(Ha.$$.fragment,t),Wd=p(t),Ue=r(t,"P",{});var ys=i(Ue);p_=n(ys,"In case of a conversational set-up, then each table-question pair must be provided "),Dl=r(ys,"STRONG",{});var x0=i(Dl);d_=n(x0,"sequentially"),x0.forEach(s),c_=n(ys," to the model, such that the "),Nl=r(ys,"CODE",{});var C0=i(Nl);h_=n(C0,"prev_labels"),C0.forEach(s),u_=n(ys," token types can be overwritten by the predicted "),Ll=r(ys,"CODE",{});var M0=i(Ll);m_=n(M0,"labels"),M0.forEach(s),g_=n(ys," of the previous table-question pair. Again, more info can be found in "),Ba=r(ys,"A",{href:!0,rel:!0});var P0=i(Ba);f_=n(P0,"this notebook"),P0.forEach(s),__=n(ys," (for PyTorch) and "),Ga=r(ys,"A",{href:!0,rel:!0});var S0=i(Ga);T_=n(S0,"this notebook"),S0.forEach(s),b_=n(ys," (for TensorFlow)."),ys.forEach(s),Ud=p(t),at=r(t,"H2",{class:!0});var $c=i(at);Ot=r($c,"A",{id:!0,class:!0,href:!0});var D0=i(Ot);Ql=r(D0,"SPAN",{});var N0=i(Ql);v(Ra.$$.fragment,N0),N0.forEach(s),D0.forEach(s),v_=p($c),Ol=r($c,"SPAN",{});var L0=i(Ol);w_=n(L0,"TAPAS specific outputs"),L0.forEach(s),$c.forEach(s),Hd=p(t),nt=r(t,"DIV",{class:!0});var zc=i(nt);v(Va.$$.fragment,zc),y_=p(zc),Ka=r(zc,"P",{});var xc=i(Ka);k_=n(xc,"Output type of "),Jo=r(xc,"A",{href:!0});var Q0=i(Jo);j_=n(Q0,"TapasForQuestionAnswering"),Q0.forEach(s),q_=n(xc,"."),xc.forEach(s),zc.forEach(s),Bd=p(t),ot=r(t,"H2",{class:!0});var Cc=i(ot);It=r(Cc,"A",{id:!0,class:!0,href:!0});var O0=i(It);Il=r(O0,"SPAN",{});var I0=i(Il);v(Ya.$$.fragment,I0),I0.forEach(s),O0.forEach(s),E_=p(Cc),Wl=r(Cc,"SPAN",{});var W0=i(Wl);F_=n(W0,"TapasConfig"),W0.forEach(s),Cc.forEach(s),Gd=p(t),Xe=r(t,"DIV",{class:!0});var Ds=i(Xe);v(Ja.$$.fragment,Ds),A_=p(Ds),gs=r(Ds,"P",{});var Ns=i(gs);$_=n(Ns,"This is the configuration class to store the configuration of a "),Xo=r(Ns,"A",{href:!0});var U0=i(Xo);z_=n(U0,"TapasModel"),U0.forEach(s),x_=n(Ns,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS `),Ul=r(Ns,"EM",{});var H0=i(Ul);C_=n(H0,"tapas-base-finetuned-sqa"),H0.forEach(s),M_=n(Ns,` architecture.
Configuration objects inherit from `),Hl=r(Ns,"CODE",{});var B0=i(Hl);P_=n(B0,"PreTrainedConfig"),B0.forEach(s),S_=n(Ns,` and can be used to control the model outputs. Read the
documentation from `),Zo=r(Ns,"A",{href:!0});var G0=i(Zo);D_=n(G0,"PretrainedConfig"),G0.forEach(s),N_=n(Ns," for more information."),Ns.forEach(s),L_=p(Ds),Xa=r(Ds,"P",{});var Mc=i(Xa);Q_=n(Mc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Za=r(Mc,"A",{href:!0,rel:!0});var R0=i(Za);O_=n(R0,"https://github.com/google-research/tapas/tree/master"),R0.forEach(s),I_=n(Mc,"."),Mc.forEach(s),W_=p(Ds),Bl=r(Ds,"P",{});var V0=i(Bl);U_=n(V0,"Example:"),V0.forEach(s),H_=p(Ds),v(en.$$.fragment,Ds),Ds.forEach(s),Rd=p(t),rt=r(t,"H2",{class:!0});var Pc=i(rt);Wt=r(Pc,"A",{id:!0,class:!0,href:!0});var K0=i(Wt);Gl=r(K0,"SPAN",{});var Y0=i(Gl);v(sn.$$.fragment,Y0),Y0.forEach(s),K0.forEach(s),B_=p(Pc),Rl=r(Pc,"SPAN",{});var J0=i(Rl);G_=n(J0,"TapasTokenizer"),J0.forEach(s),Pc.forEach(s),Vd=p(t),de=r(t,"DIV",{class:!0});var Be=i(de);v(tn.$$.fragment,Be),R_=p(Be),Vl=r(Be,"P",{});var X0=i(Vl);V_=n(X0,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),X0.forEach(s),K_=p(Be),ne=r(Be,"P",{});var fe=i(ne);Y_=n(fe,"This tokenizer inherits from "),er=r(fe,"A",{href:!0});var Z0=i(er);J_=n(Z0,"PreTrainedTokenizer"),Z0.forEach(s),X_=n(fe,` which contains most of the main methods. Users should refer to
