import{S as i4,i as l4,s as d4,e as o,k as l,w as c,t as r,M as p4,c as s,d as t,m as d,a,x as m,h as i,b as p,F as e,g as v,y as u,q as g,o as h,B as _}from"../../chunks/vendor-4833417e.js";import{T as Fp}from"../../chunks/Tip-fffd6df1.js";import{D as f}from"../../chunks/Docstring-7b52c3d4.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function c4(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var j=a(x);E=i(j,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),j.forEach(t)},m(T,j){v(T,x,j),e(x,E)},d(T){T&&t(x)}}}function m4(ee){let x,E,T,j,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),j=r("\u201Coffline-mode\u201D"),te=r(` to
...
<a href="/docs/transformers/pr_15749/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15749/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_15749/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),go=new f({props:{name:"save_pretrained",anchor:"transformers.PreTrainedModel.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"save_config",val:": bool = True"},{name:"state_dict",val:": typing.Optional[dict] = None"},{name:"save_function",val:": typing.Callable = <function save at 0x7f7fae6049d0>"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L999",parametersDescription:[{anchor:"transformers.PreTrainedModel.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7f7f45211360>"}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Do=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_utils.py#L194"}}),zo=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15749/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_15749/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_15749/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15749/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_15749/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_15749/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_15749/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/generation_utils.py#L1612",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_15749/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/generation_tf_utils.py#L2016",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15749/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),Dh=r("[from_pretrained()](/docs/transformers/pr_15749/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),zh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
model parameters to fp32 precision. This returns a new `),Sd=o("code"),G1=r("params"),S1=r(" tree and does not cast the "),Nd=o("code"),N1=r("params"),C1=r(" in place."),I1=l(),Cd=o("p"),B1=r("Examples:"),W1=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(Ds.$$.fragment),U1=l(),Bd=o("span"),H1=r("Generation"),oc=l(),P=o("div"),c(zs.$$.fragment),V1=l(),As=o("p"),X1=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),R1=r("PreTrainedModel"),Y1=r("."),K1=l(),wn=o("div"),c(Gs.$$.fragment),Z1=l(),Ss=o("p"),J1=r("Implement in subclasses of "),dr=o("a"),Q1=r("PreTrainedModel"),ek=r(" for custom behavior to adjust the logits in the generate method."),tk=l(),ge=o("div"),c(Ns.$$.fragment),nk=l(),Wd=o("p"),ok=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),sk=l(),Ud=o("p"),ak=r("Examples:"),rk=l(),c(Cs.$$.fragment),ik=l(),he=o("div"),c(Is.$$.fragment),lk=l(),Hd=o("p"),dk=r("Generates sequences for models with a language modeling head using beam search decoding."),pk=l(),Vd=o("p"),ck=r("Examples:"),mk=l(),c(Bs.$$.fragment),uk=l(),Tn=o("div"),c(Ws.$$.fragment),gk=l(),Xd=o("p"),hk=r(`compute the transition probabilities of sequences given generation
...
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),$k=l(),vt=o("p"),jk=r("Apart from "),Zd=o("code"),Mk=r("inputs"),Pk=r(`, all the arguments below will default to the value of the attribute of the same name inside
...
code`),xx=r("."),wx=l(),Ee=o("p"),Tx=r("Apart from "),rp=o("code"),$x=r("input_ids"),jx=r(" and "),ip=o("code"),Mx=r("attention_mask"),Px=r(`, all the arguments below will default to the value of the attribute
...
post`),fw=r("."),bw=l(),hp=o("p"),vw=r("Examples:"),yw=l(),c($a.$$.fragment),rc=l(),kt=o("h2"),Pn=o("a"),_p=o("span"),c(ja.$$.fragment),kw=l(),fp=o("span"),xw=r("Pushing to the Hub"),ic=l(),qe=o("div"),c(Ma.$$.fragment),ww=l(),bp=o("p"),Tw=r("A Mixin containing the functionality to push a model or tokenizer to the hub."),$w=l(),xe=o("div"),c(Pa.$$.fragment),jw=l(),Ea=o("p"),Mw=r(`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
`),Ua=s(we,"A",{href:!0});var Xw=a(Ua);ru=i(Xw,"FlaxGenerationMixin"),Xw.forEach(t),iu=i(we," (for the Flax/JAX models)."),we.forEach(t),Gp=d(n),ot=s(n,"H2",{class:!0});var pc=a(ot);Tt=s(pc,"A",{id:!0,class:!0,href:!0});var Rw=a(Tt);Ur=s(Rw,"SPAN",{});var Yw=a(Ur);m(Hn.$$.fragment,Yw),Yw.forEach(t),Rw.forEach(t),lu=d(pc),Hr=s(pc,"SPAN",{});var Kw=a(Hr);du=i(Kw,"PreTrainedModel"),Kw.forEach(t),pc.forEach(t),Sp=d(n),w=s(n,"DIV",{class:!0});var $=a(w);m(Vn.$$.fragment,$),pu=d($),Vr=s($,"P",{});var Zw=a(Vr);cu=i(Zw,"Base class for all models."),Zw.forEach(t),mu=d($),Ha=s($,"P",{});var Ow=a(Ha);Va=s(Ow,"A",{href:!0});var Jw=a(Va);uu=i(Jw,"PreTrainedModel"),Jw.forEach(t),gu=i(Ow,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),Ow.forEach(t),hu=d($),Xn=s($,"UL",{});var cc=a(Xn);Xr=s(cc,"LI",{});var Qw=a(Xr);_u=i(Qw,"resize the input embeddings,"),Qw.forEach(t),fu=d(cc),Rr=s(cc,"LI",{});var eT=a(Rr);bu=i(eT,"prune heads in the self-attention heads."),eT.forEach(t),cc.forEach(t),vu=d($),Yr=s($,"P",{});var tT=a(Yr);yu=i(tT,"Class attributes (overridden by derived classes):"),tT.forEach(t),ku=d($),ne=s($,"UL",{});var Ye=a(ne);Kr=s(Ye,"LI",{});var nT=a(Kr);Ae=s(nT,"P",{});var Fa=a(Ae);Zr=s(Fa,"STRONG",{});var oT=a(Zr);xu=i(oT,"config_class"),oT.forEach(t),wu=i(Fa," ("),Xa=s(Fa,"A",{href:!0});var sT=a(Xa);Tu=i(sT,"PretrainedConfig"),sT.forEach(t),$u=i(Fa,") \u2014 A subclass of "),Ra=s(Fa,"A",{href:!0});var aT=a(Ra);ju=i(aT,"PretrainedConfig"),aT.forEach(t),Mu=i(Fa,` to use as configuration class
for this model architecture.`),Fa.forEach(t),nT.forEach(t),Pu=d(Ye),Rn=s(Ye,"LI",{});var mc=a(Rn);Ge=s(mc,"P",{});var Oa=a(Ge);Jr=s(Oa,"STRONG",{});var rT=a(Jr);Eu=i(rT,"load_tf_weights"),rT.forEach(t),Lu=i(Oa," ("),Qr=s(Oa,"CODE",{});var iT=a(Qr);qu=i(iT,"Callable"),iT.forEach(t),Fu=i(Oa,") \u2014 A python "),ei=s(Oa,"EM",{});var lT=a(ei);Ou=i(lT,"method"),lT.forEach(t),Du=i(Oa,` for loading a TensorFlow checkpoint in a PyTorch model,
taking as arguments:`),Oa.forEach(t),zu=d(mc),st=s(mc,"UL",{});var br=a(st);$t=s(br,"LI",{});var $p=a($t);ti=s($p,"STRONG",{});var dT=a(ti);Au=i(dT,"model"),dT.forEach(t),Gu=i($p," ("),Ya=s($p,"A",{href:!0});var pT=a(Ya);Su=i(pT,"PreTrainedModel"),pT.forEach(t),Nu=i($p,") \u2014 An instance of the model on which to load the TensorFlow checkpoint."),$p.forEach(t),Cu=d(br),jt=s(br,"LI",{});var jp=a(jt);ni=s(jp,"STRONG",{});var cT=a(ni);Iu=i(cT,"config"),cT.forEach(t),Bu=i(jp," ("),oi=s(jp,"CODE",{});var mT=a(oi);Wu=i(mT,"PreTrainedConfig"),mT.forEach(t),Uu=i(jp,") \u2014 An instance of the configuration associated to the model."),jp.forEach(t),Hu=d(br),Mt=s(br,"LI",{});var Mp=a(Mt);si=s(Mp,"STRONG",{});var uT=a(si);Vu=i(uT,"path"),uT.forEach(t),Xu=i(Mp," ("),ai=s(Mp,"CODE",{});var gT=a(ai);Ru=i(gT,"str"),gT.forEach(t),Yu=i(Mp,") \u2014 A path to the TensorFlow checkpoint."),Mp.forEach(t),br.forEach(t),mc.forEach(t),Ku=d(Ye),ri=s(Ye,"LI",{});var hT=a(ri);Pt=s(hT,"P",{});var Pp=a(Pt);ii=s(Pp,"STRONG",{});var _T=a(ii);Zu=i(_T,"base_model_prefix"),_T.forEach(t),Ju=i(Pp," ("),li=s(Pp,"CODE",{});var fT=a(li);Qu=i(fT,"str"),fT.forEach(t),eg=i(Pp,`) \u2014 A string indicating the attribute associated to the base model in derived
...
models, `),_i=s(Oe,"CODE",{});var $T=a(_i);ug=i($T,"pixel_values"),$T.forEach(t),gg=i(Oe," for vision models and "),fi=s(Oe,"CODE",{});var jT=a(fi);hg=i(jT,"input_values"),jT.forEach(t),_g=i(Oe," for speech models)."),Oe.forEach(t),kT.forEach(t),Ye.forEach(t),fg=d($),le=s($,"DIV",{class:!0});var En=a(le);m(Yn.$$.fragment,En),bg=d(En),Kn=s(En,"P",{});var uc=a(Kn);vg=i(uc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),bi=s(uc,"CODE",{});var MT=a(bi);yg=i(MT,"repo_path_or_name"),MT.forEach(t),kg=i(uc,"."),uc.forEach(t),xg=d(En),vi=s(En,"P",{});var PT=a(vi);wg=i(PT,"Examples:"),PT.forEach(t),Tg=d(En),m(Zn.$$.fragment,En),En.forEach(t),$g=d($),D=s($,"DIV",{class:!0});var C=a(D);m(Jn.$$.fragment,C),jg=d(C),yi=s(C,"P",{});var ET=a(yi);Mg=i(ET,"Instantiate a pretrained pytorch model from a pre-trained model configuration."),ET.forEach(t),Pg=d(C),at=s(C,"P",{});var vr=a(at);Eg=i(vr,"The model is set in evaluation mode by default using "),ki=s(vr,"CODE",{});var LT=a(ki);Lg=i(LT,"model.eval()"),LT.forEach(t),qg=i(vr,` (Dropout modules are deactivated). To train
the model, you should first set it back in training mode with `),xi=s(vr,"CODE",{});var qT=a(xi);Fg=i(qT,"model.train()"),qT.forEach(t),Og=i(vr,"."),vr.forEach(t),Dg=d(C),Qn=s(C,"P",{});var gc=a(Qn);zg=i(gc,"The warning "),wi=s(gc,"EM",{});var FT=a(wi);Ag=i(FT,"Weights from XXX not initialized from pretrained model"),FT.forEach(t),Gg=i(gc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),hc.forEach(t),Bg=d(C),m(Lt.$$.fragment,C),Wg=d(C),m(qt.$$.fragment,C),Ug=d(C),$i=s(C,"P",{});var DT=a($i);Hg=i(DT,"Examples:"),DT.forEach(t),Vg=d(C),m(to.$$.fragment,C),C.forEach(t),Xg=d($),Ft=s($,"DIV",{class:!0});var _c=a(Ft);m(no.$$.fragment,_c),Rg=d(_c),ji=s(_c,"P",{});var zT=a(ji);Yg=i(zT,"Returns the model\u2019s input embeddings."),zT.forEach(t),_c.forEach(t),Kg=d($),Ot=s($,"DIV",{class:!0});var fc=a(Ot);m(oo.$$.fragment,fc),Zg=d(fc),Mi=s(fc,"P",{});var AT=a(Mi);Jg=i(AT,"Returns the model\u2019s output embeddings."),AT.forEach(t),fc.forEach(t),Qg=d($),Se=s($,"DIV",{class:!0});var yr=a(Se);m(so.$$.fragment,yr),eh=d(yr),Pi=s(yr,"P",{});var GT=a(Pi);th=i(GT,"Deactivates gradient checkpointing for the current model."),GT.forEach(t),nh=d(yr),Ei=s(yr,"P",{});var ST=a(Ei);oh=i(ST,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),ST.forEach(t),yr.forEach(t),sh=d($),Ne=s($,"DIV",{class:!0});var kr=a(Ne);m(ao.$$.fragment,kr),ah=d(kr),Li=s(kr,"P",{});var NT=a(Li);rh=i(NT,"Activates gradient checkpointing for the current model."),NT.forEach(t),ih=d(kr),qi=s(kr,"P",{});var CT=a(qi);lh=i(CT,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),CT.forEach(t),kr.forEach(t),dh=d($),Dt=s($,"DIV",{class:!0});var bc=a(Dt);m(ro.$$.fragment,bc),ph=d(bc),Fi=s(bc,"P",{});var IT=a(Fi);ch=i(IT,"If needed prunes and maybe initializes weights."),IT.forEach(t),bc.forEach(t),mh=d($),zt=s($,"DIV",{class:!0});var vc=a(zt);m(io.$$.fragment,vc),uh=d(vc),Oi=s(vc,"P",{});var BT=a(Oi);gh=i(BT,`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),BT.forEach(t),vc.forEach(t),hh=d($),At=s($,"DIV",{class:!0});var yc=a(At);m(lo.$$.fragment,yc),_h=d(yc),Di=s(yc,"P",{});var WT=a(Di);fh=i(WT,"Prunes heads of the base model."),WT.forEach(t),yc.forEach(t),bh=d($),Ce=s($,"DIV",{class:!0});var xr=a(Ce);m(po.$$.fragment,xr),vh=d(xr),zi=s(xr,"P",{});var UT=a(zi);yh=i(UT,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),UT.forEach(t),kh=d(xr),m(Gt.$$.fragment,xr),xr.forEach(t),xh=d($),Ie=s($,"DIV",{class:!0});var wr=a(Ie);m(co.$$.fragment,wr),wh=d(wr),mo=s(wr,"P",{});var kc=a(mo);Th=i(kc,"Resizes input token embeddings matrix of the model if "),Ai=s(kc,"CODE",{});var HT=a(Ai);$h=i(HT,"new_num_tokens != config.vocab_size"),HT.forEach(t),jh=i(kc,"."),kc.forEach(t),Mh=d(wr),uo=s(wr,"P",{});var xc=a(uo);Ph=i(xc,"Takes care of tying weights embeddings afterwards if the model class has a "),Gi=s(xc,"CODE",{});var VT=a(Gi);Eh=i(VT,"tie_weights()"),VT.forEach(t),Lh=i(xc," method."),xc.forEach(t),wr.forEach(t),qh=d($),St=s($,"DIV",{class:!0});var wc=a(St);m(go.$$.fragment,wc),Fh=d(wc),ho=s(wc,"P",{});var Tc=a(ho);Oh=i(Tc,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=s(Tc,"CODE",{});var XT=a(Si);Dh=i(XT,"[from_pretrained()](/docs/transformers/pr_15749/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),zh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d($),Nt=s($,"DIV",{class:!0});var $c=a(Nt);m(_o.$$.fragment,$c),Gh=d($c),Ni=s($c,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),$c.forEach(t),Nh=d($),Be=s($,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var jc=a(bo);Wh=i(jc,"If the "),Ii=s(jc,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i(jc,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),jc.forEach(t),Tr.forEach(t),$.forEach(t),Np=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cp=d(n),rt=s(n,"H3",{class:!0});var Mc=a(rt);Ct=s(Mc,"A",{id:!0,class:!0,href:!0});var ZT=a(Ct);Bi=s(ZT,"SPAN",{});var JT=a(Bi);m(vo.$$.fragment,JT),JT.forEach(t),ZT.forEach(t),Vh=d(Mc),Wi=s(Mc,"SPAN",{});var QT=a(Wi);Xh=i(QT,"Model Instantiation dtype"),QT.forEach(t),Mc.forEach(t),Ip=d(n),de=s(n,"P",{});var Ln=a(de);Rh=i(Ln,"Under Pytorch a model normally gets instantiated with "),Ui=s(Ln,"CODE",{});var e2=a(Ui);Yh=i(e2,"torch.float32"),e2.forEach(t),Kh=i(Ln,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(Ln,"CODE",{});var t2=a(Hi);Zh=i(t2,"dtype"),t2.forEach(t),Jh=i(Ln," using "),Vi=s(Ln,"CODE",{});var n2=a(Vi);Qh=i(n2,"torch_dtype"),n2.forEach(t),e_=i(Ln," argument:"),Ln.forEach(t),Bp=d(n),m(yo.$$.fragment,n),Wp=d(n),We=s(n,"P",{});var $r=a(We);t_=i($r,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s($r,"CODE",{});var o2=a(Xi);n_=i(o2,'"auto"'),o2.forEach(t),o_=i($r,`,
and then `),Ri=s($r,"CODE",{});var s2=a(Ri);s_=i(s2,"dtype"),s2.forEach(t),a_=i($r," will be automatically derived from the model\u2019s weights:"),$r.forEach(t),Up=d(n),m(ko.$$.fragment,n),Hp=d(n),It=s(n,"P",{});var Pc=a(It);r_=i(Pc,"Models instantiated from scratch can also be told which "),Yi=s(Pc,"CODE",{});var a2=a(Yi);i_=i(a2,"dtype"),a2.forEach(t),l_=i(Pc," to use with:"),Pc.forEach(t),Vp=d(n),m(xo.$$.fragment,n),Xp=d(n),Za=s(n,"P",{});var r2=a(Za);d_=i(r2,"Due to Pytorch design, this functionality is only available for floating dtypes."),r2.forEach(t),Rp=d(n),it=s(n,"H2",{class:!0});var Ec=a(it);Bt=s(Ec,"A",{id:!0,class:!0,href:!0});var i2=a(Bt);Ki=s(i2,"SPAN",{});var l2=a(Ki);m(wo.$$.fragment,l2),l2.forEach(t),i2.forEach(t),p_=d(Ec),Zi=s(Ec,"SPAN",{});var d2=a(Zi);c_=i(d2,"ModuleUtilsMixin"),d2.forEach(t),Ec.forEach(t),Yp=d(n),L=s(n,"DIV",{class:!0});var z=a(L);m(To.$$.fragment,z),m_=d(z),$o=s(z,"P",{});var Lc=a($o);u_=i(Lc,"A few utilities for "),Ji=s(Lc,"CODE",{});var p2=a(Ji);g_=i(p2,"torch.nn.Modules"),p2.forEach(t),h_=i(Lc,", to be used as a mixin."),Lc.forEach(t),__=d(z),Ue=s(z,"DIV",{class:!0});var jr=a(Ue);m(jo.$$.fragment,jr),f_=d(jr),Qi=s(jr,"P",{});var c2=a(Qi);b_=i(c2,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),c2.forEach(t),v_=d(jr),lt=s(jr,"P",{});var Mr=a(lt);y_=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var m2=a(el);k_=i(m2,"mem_rss_diff"),m2.forEach(t),x_=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var u2=a(tl);w_=i(u2,"model.reset_memory_hooks_state()"),u2.forEach(t),T_=i(Mr,"."),Mr.forEach(t),jr.forEach(t),$_=d(z),Wt=s(z,"DIV",{class:!0});var qc=a(Wt);m(Mo.$$.fragment,qc),j_=d(qc),nl=s(qc,"P",{});var g2=a(nl);M_=i(g2,"Helper function to estimate the total number of tokens from the model inputs."),g2.forEach(t),qc.forEach(t),P_=d(z),Ut=s(z,"DIV",{class:!0});var Fc=a(Ut);m(Po.$$.fragment,Fc),E_=d(Fc),dt=s(Fc,"P",{});var Pr=a(dt);L_=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
...
paper`),_2.forEach(t),D_=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fc.forEach(t),z_=d(z),Ht=s(z,"DIV",{class:!0});var Oc=a(Ht);m(Lo.$$.fragment,Oc),A_=d(Oc),sl=s(Oc,"P",{});var f2=a(sl);G_=i(f2,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),f2.forEach(t),Oc.forEach(t),S_=d(z),Vt=s(z,"DIV",{class:!0});var Dc=a(Vt);m(qo.$$.fragment,Dc),N_=d(Dc),al=s(Dc,"P",{});var b2=a(al);C_=i(b2,"Prepare the head mask if needed."),b2.forEach(t),Dc.forEach(t),I_=d(z),Xt=s(z,"DIV",{class:!0});var zc=a(Xt);m(Fo.$$.fragment,zc),B_=d(zc),rl=s(zc,"P",{});var v2=a(rl);W_=i(v2,"Invert an attention mask (e.g., switches 0. and 1.)."),v2.forEach(t),zc.forEach(t),U_=d(z),Rt=s(z,"DIV",{class:!0});var Ac=a(Rt);m(Oo.$$.fragment,Ac),H_=d(Ac),il=s(Ac,"P",{});var y2=a(il);V_=i(y2,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),y2.forEach(t),Ac.forEach(t),X_=d(z),Yt=s(z,"DIV",{class:!0});var Gc=a(Yt);m(Do.$$.fragment,Gc),R_=d(Gc),pt=s(Gc,"P",{});var Er=a(pt);Y_=i(Er,"Reset the "),ll=s(Er,"CODE",{});var k2=a(ll);K_=i(k2,"mem_rss_diff"),k2.forEach(t),Z_=i(Er," attribute of each module (see "),Ja=s(Er,"A",{href:!0});var x2=a(Ja);J_=i(x2,"add_memory_hooks()"),x2.forEach(t),Q_=i(Er,")."),Er.forEach(t),Gc.forEach(t),z.forEach(t),Kp=d(n),ct=s(n,"H2",{class:!0});var Sc=a(ct);Kt=s(Sc,"A",{id:!0,class:!0,href:!0});var w2=a(Kt);dl=s(w2,"SPAN",{});var T2=a(dl);m(zo.$$.fragment,T2),T2.forEach(t),w2.forEach(t),ef=d(Sc),pl=s(Sc,"SPAN",{});var $2=a(pl);tf=i($2,"TFPreTrainedModel"),$2.forEach(t),Sc.forEach(t),Zp=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),nf=d(k),cl=s(k,"P",{});var j2=a(cl);of=i(j2,"Base class for all TF models."),j2.forEach(t),sf=d(k),Qa=s(k,"P",{});var Dw=a(Qa);er=s(Dw,"A",{href:!0});var M2=a(er);af=i(M2,"TFPreTrainedModel"),M2.forEach(t),rf=i(Dw,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),Dw.forEach(t),lf=d(k),Go=s(k,"UL",{});var Nc=a(Go);ml=s(Nc,"LI",{});var P2=a(ml);df=i(P2,"resize the input embeddings,"),P2.forEach(t),pf=d(Nc),ul=s(Nc,"LI",{});var E2=a(ul);cf=i(E2,"prune heads in the self-attention heads."),E2.forEach(t),Nc.forEach(t),mf=d(k),gl=s(k,"P",{});var L2=a(gl);uf=i(L2,"Class attributes (overridden by derived classes):"),L2.forEach(t),gf=d(k),mt=s(k,"UL",{});var Lr=a(mt);He=s(Lr,"LI",{});var Da=a(He);hl=s(Da,"STRONG",{});var q2=a(hl);hf=i(q2,"config_class"),q2.forEach(t),_f=i(Da," ("),tr=s(Da,"A",{href:!0});var F2=a(tr);ff=i(F2,"PretrainedConfig"),F2.forEach(t),bf=i(Da,") \u2014 A subclass of "),nr=s(Da,"A",{href:!0});var O2=a(nr);vf=i(O2,"PretrainedConfig"),O2.forEach(t),yf=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),kf=d(Lr),Zt=s(Lr,"LI",{});var Lp=a(Zt);_l=s(Lp,"STRONG",{});var D2=a(_l);xf=i(D2,"base_model_prefix"),D2.forEach(t),wf=i(Lp," ("),fl=s(Lp,"CODE",{});var z2=a(fl);Tf=i(z2,"str"),z2.forEach(t),$f=i(Lp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Lp.forEach(t),jf=d(Lr),X=s(Lr,"LI",{});var De=a(X);bl=s(De,"STRONG",{});var A2=a(bl);Mf=i(A2,"main_input_name"),A2.forEach(t),Pf=i(De," ("),vl=s(De,"CODE",{});var G2=a(vl);Ef=i(G2,"str"),G2.forEach(t),Lf=i(De,") \u2014 The name of the principal input to the model (often "),yl=s(De,"CODE",{});var S2=a(yl);qf=i(S2,"input_ids"),S2.forEach(t),Ff=i(De,` for NLP
models, `),kl=s(De,"CODE",{});var N2=a(kl);Of=i(N2,"pixel_values"),N2.forEach(t),Df=i(De," for vision models and "),xl=s(De,"CODE",{});var C2=a(xl);zf=i(C2,"input_values"),C2.forEach(t),Af=i(De," for speech models)."),De.forEach(t),Lr.forEach(t),Gf=d(k),pe=s(k,"DIV",{class:!0});var qn=a(pe);m(So.$$.fragment,qn),Sf=d(qn),No=s(qn,"P",{});var Cc=a(No);Nf=i(Cc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=s(Cc,"CODE",{});var I2=a(wl);Cf=i(I2,"repo_path_or_name"),I2.forEach(t),If=i(Cc,"."),Cc.forEach(t),Bf=d(qn),Tl=s(qn,"P",{});var B2=a(Tl);Wf=i(B2,"Examples:"),B2.forEach(t),Uf=d(qn),m(Co.$$.fragment,qn),qn.forEach(t),Hf=d(k),Jt=s(k,"DIV",{class:!0});var Ic=a(Jt);m(Io.$$.fragment,Ic),Vf=d(Ic),$l=s(Ic,"P",{});var W2=a($l);Xf=i(W2,`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),W2.forEach(t),Ic.forEach(t),Rf=d(k),S=s(k,"DIV",{class:!0});var Z=a(S);m(Bo.$$.fragment,Z),Yf=d(Z),jl=s(Z,"P",{});var U2=a(jl);Kf=i(U2,"Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),U2.forEach(t),Zf=d(Z),Wo=s(Z,"P",{});var Bc=a(Wo);Jf=i(Bc,"The warning "),Ml=s(Bc,"EM",{});var H2=a(Ml);Qf=i(H2,"Weights from XXX not initialized from pretrained model"),H2.forEach(t),eb=i(Bc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
