...
Speech2Text2's [SpeechEncoderDecoderModel](/docs/transformers/pr_15749/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel) model accepts raw waveform input values from speech and
makes use of [generate()](/docs/transformers/pr_15749/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to translate the input speech
autoregressively to the target language.

The [Wav2Vec2FeatureExtractor](/docs/transformers/pr_15749/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor) class is responsible for preprocessing the input speech and
[Speech2Text2Tokenizer](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer) decodes the generated target tokens to the target string. The
[Speech2Text2Processor](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor) wraps [Wav2Vec2FeatureExtractor](/docs/transformers/pr_15749/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor) and
[Speech2Text2Tokenizer](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer) into a single instance to both extract the input features and decode the
predicted token ids.
...
This is the configuration class to store the configuration of a [Speech2Text2ForCausalLM](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2ForCausalLM). It is used to
...
<docstring><name>class transformers.Speech2Text2Tokenizer</name><anchor>transformers.Speech2Text2Tokenizer</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L67</source><parameters>[{"name": "vocab_file", "val": ""}, {"name": "bos_token", "val": " = '<s>'"}, {"name": "pad_token", "val": " = '<pad>'"}, {"name": "eos_token", "val": " = '</s>'"}, {"name": "unk_token", "val": " = '<unk>'"}, {"name": "do_lower_case", "val": " = False"}, {"name": "merges_file", "val": " = None"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_file** (`str`) --
...
<docstring><name>class transformers.Speech2Text2Processor</name><anchor>transformers.Speech2Text2Processor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23</source><parameters>[{"name": "feature_extractor", "val": ""}, {"name": "tokenizer", "val": ""}]</parameters><paramsdesc>- **feature_extractor** (`AutoFeatureExtractor`) --
  An instance of [AutoFeatureExtractor](/docs/transformers/pr_15749/en/model_doc/auto#transformers.AutoFeatureExtractor). The feature extractor is a required input.
- **tokenizer** (`Speech2Text2Tokenizer`) --
  An instance of [Speech2Text2Tokenizer](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer). The tokenizer is a required input.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
See the [__call__()](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor.__call__) and [decode()](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor.decode) for more information.
...
<div class="docstring">
<docstring><name>\_\_call\_\_</name><anchor>transformers.Speech2Text2Processor.__call__</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L44</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor's
`__call__()`and returns its output. If used in the context
[as_target_processor()](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor.as_target_processor) this method forwards all its arguments to
Speech2Text2Tokenizer's [__call__()](/docs/transformers/pr_15749/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__). Please refer to the doctsring of the above two
...
<div class="docstring">
<docstring><name>batch\_decode</name><anchor>transformers.Speech2Text2Processor.batch_decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L54</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to Speech2Text2Tokenizer's [batch_decode()](/docs/transformers/pr_15749/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode). Please
refer to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>decode</name><anchor>transformers.Speech2Text2Processor.decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L61</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to Speech2Text2Tokenizer's [decode()](/docs/transformers/pr_15749/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode). Please refer
to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>as\_target\_processor</name><anchor>transformers.Speech2Text2Processor.as_target_processor</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L68</source><parameters>[]</parameters></docstring>
...
The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of [EncoderDecoderModel](/docs/transformers/pr_15749/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) and `SpeechEncoderDecoder`.
...
<docstring><name>forward</name><anchor>transformers.Speech2Text2ForCausalLM.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15749/src/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py#L774</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "encoder_hidden_states", "val": " = None"}, {"name": "encoder_attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "cross_attn_head_mask", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [Speech2Text2Tokenizer](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/pr_15749/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and
...
elements depending on the configuration ([Speech2Text2Config](/docs/transformers/pr_15749/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config)) and inputs.
