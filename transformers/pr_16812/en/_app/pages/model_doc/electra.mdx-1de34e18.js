...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16812/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16812/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16812/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16812/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16812/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16812/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16812/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16812/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16812/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16812/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16812/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16812/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16812/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16812/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16812/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16812/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16812/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16812/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
pooled output) e.g. for GLUE tasks.`),LF.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var df=a(cr);Yk=i(df,"This model inherits from "),ud=s(df,"A",{href:!0});var NF=a(ud);Zk=i(NF,"PreTrainedModel"),NF.forEach(t),e1=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),t1=p(ro),pr=s(ro,"P",{});var cf=a(pr);o1=i(cf,"This model is also a PyTorch "),hr=s(cf,"A",{href:!0,rel:!0});var IF=a(hr);n1=i(IF,"torch.nn.Module"),IF.forEach(t),s1=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),a1=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),r1=p(pt),jo=s(pt,"P",{});var Vd=a(jo);i1=i(Vd,"The "),fd=s(Vd,"A",{href:!0});var SF=a(fd);l1=i(SF,"ElectraForSequenceClassification"),SF.forEach(t),d1=i(Vd," forward method, overrides the "),Qc=s(Vd,"CODE",{});var DF=a(Qc);c1=i(DF,"__call__"),DF.forEach(t),p1=i(Vd," special method."),Vd.forEach(t),h1=p(pt),y(In.$$.fragment,pt),m1=p(pt),y(Sn.$$.fragment,pt),u1=p(pt),y(Dn.$$.fragment,pt),f1=p(pt),y(Wn.$$.fragment,pt),g1=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),du=p(o),qo=s(o,"H2",{class:!0});var pf=a(qo);Rn=s(pf,"A",{id:!0,class:!0,href:!0});var WF=a(Rn);Bc=s(WF,"SPAN",{});var UF=a(Bc);y(ur.$$.fragment,UF),UF.forEach(t),WF.forEach(t),_1=p(pf),Vc=s(pf,"SPAN",{});var RF=a(Vc);k1=i(RF,"ElectraForMultipleChoice"),RF.forEach(t),pf.forEach(t),cu=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(fr.$$.fragment,io),v1=p(io),Kc=s(io,"P",{});var HF=a(Kc);T1=i(HF,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),HF.forEach(t),b1=p(io),gr=s(io,"P",{});var hf=a(gr);y1=i(hf,"This model inherits from "),gd=s(hf,"A",{href:!0});var QF=a(gd);E1=i(QF,"PreTrainedModel"),QF.forEach(t),w1=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),$1=p(io),_r=s(io,"P",{});var mf=a(_r);F1=i(mf,"This model is also a PyTorch "),kr=s(mf,"A",{href:!0,rel:!0});var BF=a(kr);x1=i(BF,"torch.nn.Module"),BF.forEach(t),M1=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mf.forEach(t),z1=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),C1=p(sa),Po=s(sa,"P",{});var Kd=a(Po);j1=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var VF=a(_d);q1=i(VF,"ElectraForMultipleChoice"),VF.forEach(t),P1=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var KF=a(Jc);A1=i(KF,"__call__"),KF.forEach(t),O1=i(Kd," special method."),Kd.forEach(t),L1=p(sa),y(Hn.$$.fragment,sa),N1=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),pu=p(o),Ao=s(o,"H2",{class:!0});var uf=a(Ao);Bn=s(uf,"A",{id:!0,class:!0,href:!0});var JF=a(Bn);Gc=s(JF,"SPAN",{});var GF=a(Gc);y(Tr.$$.fragment,GF),GF.forEach(t),JF.forEach(t),I1=p(uf),Xc=s(uf,"SPAN",{});var XF=a(Xc);S1=i(XF,"ElectraForTokenClassification"),XF.forEach(t),uf.forEach(t),hu=p(o),Be=s(o,"DIV",{class:!0});var St=a(Be);y(br.$$.fragment,St),D1=p(St),Yc=s(St,"P",{});var YF=a(Yc);W1=i(YF,"Electra model with a token classification head on top."),YF.forEach(t),U1=p(St),Zc=s(St,"P",{});var ZF=a(Zc);R1=i(ZF,"Both the discriminator and generator may be loaded into this model."),ZF.forEach(t),H1=p(St),yr=s(St,"P",{});var ff=a(yr);Q1=i(ff,"This model inherits from "),kd=s(ff,"A",{href:!0});var e0=a(kd);B1=i(e0,"PreTrainedModel"),e0.forEach(t),V1=i(ff,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ff.forEach(t),K1=p(St),Er=s(St,"P",{});var gf=a(Er);J1=i(gf,"This model is also a PyTorch "),wr=s(gf,"A",{href:!0,rel:!0});var t0=a(wr);G1=i(t0,"torch.nn.Module"),t0.forEach(t),X1=i(gf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gf.forEach(t),Y1=p(St),at=s(St,"DIV",{class:!0});var lo=a(at);y($r.$$.fragment,lo),Z1=p(lo),Oo=s(lo,"P",{});var Jd=a(Oo);ev=i(Jd,"The "),vd=s(Jd,"A",{href:!0});var o0=a(vd);tv=i(o0,"ElectraForTokenClassification"),o0.forEach(t),ov=i(Jd," forward method, overrides the "),ep=s(Jd,"CODE",{});var n0=a(ep);nv=i(n0,"__call__"),n0.forEach(t),sv=i(Jd," special method."),Jd.forEach(t),av=p(lo),y(Vn.$$.fragment,lo),rv=p(lo),y(Kn.$$.fragment,lo),iv=p(lo),y(Jn.$$.fragment,lo),lo.forEach(t),St.forEach(t),mu=p(o),Lo=s(o,"H2",{class:!0});var _f=a(Lo);Gn=s(_f,"A",{id:!0,class:!0,href:!0});var s0=a(Gn);tp=s(s0,"SPAN",{});var a0=a(tp);y(Fr.$$.fragment,a0),a0.forEach(t),s0.forEach(t),lv=p(_f),op=s(_f,"SPAN",{});var r0=a(op);dv=i(r0,"ElectraForQuestionAnswering"),r0.forEach(t),_f.forEach(t),uu=p(o),nt=s(o,"DIV",{class:!0});var co=a(nt);y(xr.$$.fragment,co),cv=p(co),No=s(co,"P",{});var Gd=a(No);pv=i(Gd,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),np=s(Gd,"CODE",{});var i0=a(np);hv=i(i0,"span start logits"),i0.forEach(t),mv=i(Gd," and "),sp=s(Gd,"CODE",{});var l0=a(sp);uv=i(l0,"span end logits"),l0.forEach(t),fv=i(Gd,")."),Gd.forEach(t),gv=p(co),Mr=s(co,"P",{});var kf=a(Mr);_v=i(kf,"This model inherits from "),Td=s(kf,"A",{href:!0});var d0=a(Td);kv=i(d0,"PreTrainedModel"),d0.forEach(t),vv=i(kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kf.forEach(t),Tv=p(co),zr=s(co,"P",{});var vf=a(zr);bv=i(vf,"This model is also a PyTorch "),Cr=s(vf,"A",{href:!0,rel:!0});var c0=a(Cr);yv=i(c0,"torch.nn.Module"),c0.forEach(t),Ev=i(vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),wv=p(co),rt=s(co,"DIV",{class:!0});var po=a(rt);y(jr.$$.fragment,po),$v=p(po),Io=s(po,"P",{});var Xd=a(Io);Fv=i(Xd,"The "),bd=s(Xd,"A",{href:!0});var p0=a(bd);xv=i(p0,"ElectraForQuestionAnswering"),p0.forEach(t),Mv=i(Xd," forward method, overrides the "),ap=s(Xd,"CODE",{});var h0=a(ap);zv=i(h0,"__call__"),h0.forEach(t),Cv=i(Xd," special method."),Xd.forEach(t),jv=p(po),y(Xn.$$.fragment,po),qv=p(po),y(Yn.$$.fragment,po),Pv=p(po),y(Zn.$$.fragment,po),po.forEach(t),co.forEach(t),fu=p(o),So=s(o,"H2",{class:!0});var Tf=a(So);es=s(Tf,"A",{id:!0,class:!0,href:!0});var m0=a(es);rp=s(m0,"SPAN",{});var u0=a(rp);y(qr.$$.fragment,u0),u0.forEach(t),m0.forEach(t),Av=p(Tf),ip=s(Tf,"SPAN",{});var f0=a(ip);Ov=i(f0,"TFElectraModel"),f0.forEach(t),Tf.forEach(t),gu=p(o),Ve=s(o,"DIV",{class:!0});var Dt=a(Ve);y(Pr.$$.fragment,Dt),Lv=p(Dt),lp=s(Dt,"P",{});var g0=a(lp);Nv=i(g0,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),g0.forEach(t),Iv=p(Dt),Ar=s(Dt,"P",{});var bf=a(Ar);Sv=i(bf,"This model inherits from "),yd=s(bf,"A",{href:!0});var _0=a(yd);Dv=i(_0,"TFPreTrainedModel"),_0.forEach(t),Wv=i(bf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yf.forEach(t),Bv=p(Dt),y(ts.$$.fragment,Dt),Vv=p(Dt),xt=s(Dt,"DIV",{class:!0});var aa=a(xt);y(Nr.$$.fragment,aa),Kv=p(aa),Do=s(aa,"P",{});var Yd=a(Do);Jv=i(Yd,"The "),Ed=s(Yd,"A",{href:!0});var v0=a(Ed);Gv=i(v0,"TFElectraModel"),v0.forEach(t),Xv=i(Yd," forward method, overrides the "),dp=s(Yd,"CODE",{});var T0=a(dp);Yv=i(T0,"__call__"),T0.forEach(t),Zv=i(Yd," special method."),Yd.forEach(t),eT=p(aa),y(os.$$.fragment,aa),tT=p(aa),y(ns.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),_u=p(o),Wo=s(o,"H2",{class:!0});var Ef=a(Wo);ss=s(Ef,"A",{id:!0,class:!0,href:!0});var b0=a(ss);cp=s(b0,"SPAN",{});var y0=a(cp);y(Ir.$$.fragment,y0),y0.forEach(t),b0.forEach(t),oT=p(Ef),pp=s(Ef,"SPAN",{});var E0=a(pp);nT=i(E0,"TFElectraForPreTraining"),E0.forEach(t),Ef.forEach(t),ku=p(o),Oe=s(o,"DIV",{class:!0});var ht=a(Oe);y(Sr.$$.fragment,ht),sT=p(ht),hp=s(ht,"P",{});var w0=a(hp);aT=i(w0,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),w0.forEach(t),rT=p(ht),mp=s(ht,"P",{});var $0=a(mp);iT=i($0,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),$0.forEach(t),lT=p(ht),Dr=s(ht,"P",{});var wf=a(Dr);dT=i(wf,"This model inherits from "),wd=s(wf,"A",{href:!0});var F0=a(wd);cT=i(F0,"TFPreTrainedModel"),F0.forEach(t),pT=i(wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wf.forEach(t),hT=p(ht),Wr=s(ht,"P",{});var $f=a(Wr);mT=i($f,"This model is also a "),Ur=s($f,"A",{href:!0,rel:!0});var x0=a(Ur);uT=i(x0,"tf.keras.Model"),x0.forEach(t),fT=i($f,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$f.forEach(t),gT=p(ht),y(as.$$.fragment,ht),_T=p(ht),Mt=s(ht,"DIV",{class:!0});var ra=a(Mt);y(Rr.$$.fragment,ra),kT=p(ra),Uo=s(ra,"P",{});var Zd=a(Uo);vT=i(Zd,"The "),$d=s(Zd,"A",{href:!0});var M0=a($d);TT=i(M0,"TFElectraForPreTraining"),M0.forEach(t),bT=i(Zd," forward method, overrides the "),up=s(Zd,"CODE",{});var z0=a(up);yT=i(z0,"__call__"),z0.forEach(t),ET=i(Zd," special method."),Zd.forEach(t),wT=p(ra),y(rs.$$.fragment,ra),$T=p(ra),y(is.$$.fragment,ra),ra.forEach(t),ht.forEach(t),vu=p(o),Ro=s(o,"H2",{class:!0});var Ff=a(Ro);ls=s(Ff,"A",{id:!0,class:!0,href:!0});var C0=a(ls);fp=s(C0,"SPAN",{});var j0=a(fp);y(Hr.$$.fragment,j0),j0.forEach(t),C0.forEach(t),FT=p(Ff),gp=s(Ff,"SPAN",{});var q0=a(gp);xT=i(q0,"TFElectraForMaskedLM"),q0.forEach(t),Ff.forEach(t),Tu=p(o),Le=s(o,"DIV",{class:!0});var mt=a(Le);y(Qr.$$.fragment,mt),MT=p(mt),_p=s(mt,"P",{});var P0=a(_p);zT=i(P0,"Electra model with a language modeling head on top."),P0.forEach(t),CT=p(mt),kp=s(mt,"P",{});var A0=a(kp);jT=i(A0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),A0.forEach(t),qT=p(mt),Br=s(mt,"P",{});var xf=a(Br);PT=i(xf,"This model inherits from "),Fd=s(xf,"A",{href:!0});var O0=a(Fd);AT=i(O0,"TFPreTrainedModel"),O0.forEach(t),OT=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xf.forEach(t),LT=p(mt),Vr=s(mt,"P",{});var Mf=a(Vr);NT=i(Mf,"This model is also a "),Kr=s(Mf,"A",{href:!0,rel:!0});var L0=a(Kr);IT=i(L0,"tf.keras.Model"),L0.forEach(t),ST=i(Mf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mf.forEach(t),DT=p(mt),y(ds.$$.fragment,mt),WT=p(mt),it=s(mt,"DIV",{class:!0});var ho=a(it);y(Jr.$$.fragment,ho),UT=p(ho),Ho=s(ho,"P",{});var ec=a(Ho);RT=i(ec,"The "),xd=s(ec,"A",{href:!0});var N0=a(xd);HT=i(N0,"TFElectraForMaskedLM"),N0.forEach(t),QT=i(ec," forward method, overrides the "),vp=s(ec,"CODE",{});var I0=a(vp);BT=i(I0,"__call__"),I0.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=p(ho),y(cs.$$.fragment,ho),JT=p(ho),y(ps.$$.fragment,ho),GT=p(ho),y(hs.$$.fragment,ho),ho.forEach(t),mt.forEach(t),bu=p(o),Qo=s(o,"H2",{class:!0});var zf=a(Qo);ms=s(zf,"A",{id:!0,class:!0,href:!0});var S0=a(ms);Tp=s(S0,"SPAN",{});var D0=a(Tp);y(Gr.$$.fragment,D0),D0.forEach(t),S0.forEach(t),XT=p(zf),bp=s(zf,"SPAN",{});var W0=a(bp);YT=i(W0,"TFElectraForSequenceClassification"),W0.forEach(t),zf.forEach(t),yu=p(o),Ke=s(o,"DIV",{class:!0});var Wt=a(Ke);y(Xr.$$.fragment,Wt),ZT=p(Wt),yp=s(Wt,"P",{});var U0=a(yp);eb=i(U0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),U0.forEach(t),tb=p(Wt),Yr=s(Wt,"P",{});var Cf=a(Yr);ob=i(Cf,"This model inherits from "),Md=s(Cf,"A",{href:!0});var R0=a(Md);nb=i(R0,"TFPreTrainedModel"),R0.forEach(t),sb=i(Cf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cf.forEach(t),ab=p(Wt),Zr=s(Wt,"P",{});var jf=a(Zr);rb=i(jf,"This model is also a "),ei=s(jf,"A",{href:!0,rel:!0});var H0=a(ei);ib=i(H0,"tf.keras.Model"),H0.forEach(t),lb=i(jf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jf.forEach(t),db=p(Wt),y(us.$$.fragment,Wt),cb=p(Wt),lt=s(Wt,"DIV",{class:!0});var mo=a(lt);y(ti.$$.fragment,mo),pb=p(mo),Bo=s(mo,"P",{});var tc=a(Bo);hb=i(tc,"The "),zd=s(tc,"A",{href:!0});var Q0=a(zd);mb=i(Q0,"TFElectraForSequenceClassification"),Q0.forEach(t),ub=i(tc," forward method, overrides the "),Ep=s(tc,"CODE",{});var B0=a(Ep);fb=i(B0,"__call__"),B0.forEach(t),gb=i(tc," special method."),tc.forEach(t),_b=p(mo),y(fs.$$.fragment,mo),kb=p(mo),y(gs.$$.fragment,mo),vb=p(mo),y(_s.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),Eu=p(o),Vo=s(o,"H2",{class:!0});var qf=a(Vo);ks=s(qf,"A",{id:!0,class:!0,href:!0});var V0=a(ks);wp=s(V0,"SPAN",{});var K0=a(wp);y(oi.$$.fragment,K0),K0.forEach(t),V0.forEach(t),Tb=p(qf),$p=s(qf,"SPAN",{});var J0=a($p);bb=i(J0,"TFElectraForMultipleChoice"),J0.forEach(t),qf.forEach(t),wu=p(o),Je=s(o,"DIV",{class:!0});var Ut=a(Je);y(ni.$$.fragment,Ut),yb=p(Ut),Fp=s(Ut,"P",{});var G0=a(Fp);Eb=i(G0,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),G0.forEach(t),wb=p(Ut),si=s(Ut,"P",{});var Pf=a(si);$b=i(Pf,"This model inherits from "),Cd=s(Pf,"A",{href:!0});var X0=a(Cd);Fb=i(X0,"TFPreTrainedModel"),X0.forEach(t),xb=i(Pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pf.forEach(t),Mb=p(Ut),ai=s(Ut,"P",{});var Af=a(ai);zb=i(Af,"This model is also a "),ri=s(Af,"A",{href:!0,rel:!0});var Y0=a(ri);Cb=i(Y0,"tf.keras.Model"),Y0.forEach(t),jb=i(Af,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
