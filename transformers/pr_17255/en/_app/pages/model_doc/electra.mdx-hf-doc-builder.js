...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17255/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17255/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17255/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17255/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17255/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17255/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17255/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17255/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17255/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dg.forEach(t),wy=p(ut),y(fs.$$.fragment,ut),$y=p(ut),lt=s(ut,"DIV",{class:!0});var go=a(lt);y(ri.$$.fragment,go),Fy=p(go),Ko=s(go,"P",{});var wc=a(Ko);xy=i(wc,"The "),Gd=s(wc,"A",{href:!0});var Yx=a(Gd);My=i(Yx,"TFElectraForMaskedLM"),Yx.forEach(t),zy=i(wc," forward method, overrides the "),Hp=s(wc,"CODE",{});var Zx=a(Hp);jy=i(Zx,"__call__"),Zx.forEach(t),Cy=i(wc," special method."),wc.forEach(t),qy=p(go),y(gs.$$.fragment,go),Py=p(go),y(_s.$$.fragment,go),Ay=p(go),y(ks.$$.fragment,go),go.forEach(t),ut.forEach(t),of=p(o),Jo=s(o,"H2",{class:!0});var cg=a(Jo);vs=s(cg,"A",{id:!0,class:!0,href:!0});var e5=a(vs);Qp=s(e5,"SPAN",{});var t5=a(Qp);y(ii.$$.fragment,t5),t5.forEach(t),e5.forEach(t),Oy=p(cg),Bp=s(cg,"SPAN",{});var o5=a(Bp);Ly=i(o5,"TFElectraForSequenceClassification"),o5.forEach(t),cg.forEach(t),nf=p(o),Je=s(o,"DIV",{class:!0});var Ht=a(Je);y(li.$$.fragment,Ht),Ny=p(Ht),Vp=s(Ht,"P",{});var n5=a(Vp);Iy=i(n5,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pg.forEach(t),Ry=p(Ht),ci=s(Ht,"P",{});var hg=a(ci);Hy=i(hg,"This model is also a "),pi=s(hg,"A",{href:!0,rel:!0});var a5=a(pi);Qy=i(a5,"tf.keras.Model"),a5.forEach(t),By=i(hg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg.forEach(t),Vy=p(Ht),y(Ts.$$.fragment,Ht),Ky=p(Ht),dt=s(Ht,"DIV",{class:!0});var _o=a(dt);y(hi.$$.fragment,_o),Jy=p(_o),Go=s(_o,"P",{});var $c=a(Go);Gy=i($c,"The "),Yd=s($c,"A",{href:!0});var r5=a(Yd);Xy=i(r5,"TFElectraForSequenceClassification"),r5.forEach(t),Yy=i($c," forward method, overrides the "),Kp=s($c,"CODE",{});var i5=a(Kp);Zy=i(i5,"__call__"),i5.forEach(t),e1=i($c," special method."),$c.forEach(t),t1=p(_o),y(bs.$$.fragment,_o),o1=p(_o),y(ys.$$.fragment,_o),n1=p(_o),y(Es.$$.fragment,_o),_o.forEach(t),Ht.forEach(t),sf=p(o),Xo=s(o,"H2",{class:!0});var mg=a(Xo);ws=s(mg,"A",{id:!0,class:!0,href:!0});var l5=a(ws);Jp=s(l5,"SPAN",{});var d5=a(Jp);y(mi.$$.fragment,d5),d5.forEach(t),l5.forEach(t),s1=p(mg),Gp=s(mg,"SPAN",{});var c5=a(Gp);a1=i(c5,"TFElectraForMultipleChoice"),c5.forEach(t),mg.forEach(t),af=p(o),Ge=s(o,"DIV",{class:!0});var Qt=a(Ge);y(ui.$$.fragment,Qt),r1=p(Qt),Xp=s(Qt,"P",{});var p5=a(Xp);i1=i(p5,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),p5.forEach(t),l1=p(Qt),fi=s(Qt,"P",{});var ug=a(fi);d1=i(ug,"This model inherits from "),Zd=s(ug,"A",{href:!0});var h5=a(Zd);c1=i(h5,"TFPreTrainedModel"),h5.forEach(t),p1=i(ug,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ug.forEach(t),h1=p(Qt),gi=s(Qt,"P",{});var fg=a(gi);m1=i(fg,"This model is also a "),_i=s(fg,"A",{href:!0,rel:!0});var m5=a(_i);u1=i(m5,"tf.keras.Model"),m5.forEach(t),f1=i(fg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),g1=p(Qt),y($s.$$.fragment,Qt),_1=p(Qt),Ct=s(Qt,"DIV",{class:!0});var ga=a(Ct);y(ki.$$.fragment,ga),k1=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);v1=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u5=a(ec);T1=i(u5,"TFElectraForMultipleChoice"),u5.forEach(t),b1=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f5=a(Yp);y1=i(f5,"__call__"),f5.forEach(t),E1=i(Fc," special method."),Fc.forEach(t),w1=p(ga),y(Fs.$$.fragment,ga),$1=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Qt.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g5=a(Ms);Zp=s(g5,"SPAN",{});var _5=a(Zp);y(vi.$$.fragment,_5),_5.forEach(t),g5.forEach(t),F1=p(gg),eh=s(gg,"SPAN",{});var k5=a(eh);x1=i(k5,"TFElectraForTokenClassification"),k5.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),M1=p(ft),th=s(ft,"P",{});var v5=a(th);z1=i(v5,"Electra model with a token classification head on top."),v5.forEach(t),j1=p(ft),oh=s(ft,"P",{});var T5=a(oh);C1=i(T5,"Both the discriminator and generator may be loaded into this model."),T5.forEach(t),q1=p(ft),bi=s(ft,"P",{});var _g=a(bi);P1=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b5=a(tc);A1=i(b5,"TFPreTrainedModel"),b5.forEach(t),O1=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),S1=p(ft),y(zs.$$.fragment,ft),W1=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),U1=p(ko),en=s(ko,"P",{});var xc=a(en);R1=i(xc,"The "),oc=s(xc,"A",{href:!0});var E5=a(oc);H1=i(E5,"TFElectraForTokenClassification"),E5.forEach(t),Q1=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w5=a(nh);B1=i(w5,"__call__"),w5.forEach(t),V1=i(xc," special method."),xc.forEach(t),K1=p(ko),y(js.$$.fragment,ko),J1=p(ko),y(Cs.$$.fragment,ko),G1=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $5=a(Ps);sh=s($5,"SPAN",{});var F5=a(sh);y($i.$$.fragment,F5),F5.forEach(t),$5.forEach(t),X1=p(vg),ah=s(vg,"SPAN",{});var x5=a(ah);Y1=i(x5,"TFElectraForQuestionAnswering"),x5.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Bt=a(Xe);y(Fi.$$.fragment,Bt),Z1=p(Bt),on=s(Bt,"P",{});var Mc=a(on);eE=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M5=a(rh);tE=i(M5,"span start logits"),M5.forEach(t),oE=i(Mc," and "),ih=s(Mc,"CODE",{});var z5=a(ih);nE=i(z5,"span end logits"),z5.forEach(t),sE=i(Mc,")."),Mc.forEach(t),aE=p(Bt),xi=s(Bt,"P",{});var Tg=a(xi);rE=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var j5=a(nc);iE=i(j5,"TFPreTrainedModel"),j5.forEach(t),lE=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dE=p(Bt),Mi=s(Bt,"P",{});var bg=a(Mi);cE=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var C5=a(zi);pE=i(C5,"tf.keras.Model"),C5.forEach(t),hE=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mE=p(Bt),y(As.$$.fragment,Bt),uE=p(Bt),pt=s(Bt,"DIV",{class:!0});var vo=a(pt);y(ji.$$.fragment,vo),fE=p(vo),nn=s(vo,"P",{});var zc=a(nn);gE=i(zc,"The "),sc=s(zc,"A",{href:!0});var q5=a(sc);_E=i(q5,"TFElectraForQuestionAnswering"),q5.forEach(t),kE=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P5=a(lh);vE=i(P5,"__call__"),P5.forEach(t),TE=i(zc," special method."),zc.forEach(t),bE=p(vo),y(Os.$$.fragment,vo),yE=p(vo),y(Ls.$$.fragment,vo),EE=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Bt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A5=a(Is);dh=s(A5,"SPAN",{});var O5=a(dh);y(Ci.$$.fragment,O5),O5.forEach(t),A5.forEach(t),wE=p(yg),ch=s(yg,"SPAN",{});var L5=a(ch);$E=i(L5,"FlaxElectraModel"),L5.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),FE=p(gt),ph=s(gt,"P",{});var N5=a(ph);xE=i(N5,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N5.forEach(t),ME=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zE=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I5=a(ac);jE=i(I5,"FlaxPreTrainedModel"),I5.forEach(t),CE=i(Eg,`. Check the superclass documentation for the generic methods the
