...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17255/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17255/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y$=p(nt),sh=s(nt,"P",{});var e5=a(sh);Z$=i(e5,"Finally, this model supports inherent JAX features such as:"),e5.forEach(t),e2=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var t5=a(ah);Wi=s(t5,"A",{href:!0,rel:!0});var o5=a(Wi);t2=i(o5,"Just-In-Time (JIT) compilation"),o5.forEach(t),t5.forEach(t),o2=p(Is),rh=s(Is,"LI",{});var n5=a(rh);Bi=s(n5,"A",{href:!0,rel:!0});var s5=a(Bi);n2=i(s5,"Automatic Differentiation"),s5.forEach(t),n5.forEach(t),s2=p(Is),ih=s(Is,"LI",{});var a5=a(ih);Ui=s(a5,"A",{href:!0,rel:!0});var r5=a(Ui);a2=i(r5,"Vectorization"),r5.forEach(t),a5.forEach(t),r2=p(Is),lh=s(Is,"LI",{});var i5=a(lh);Qi=s(i5,"A",{href:!0,rel:!0});var l5=a(Qi);i2=i(l5,"Parallelization"),l5.forEach(t),i5.forEach(t),Is.forEach(t),l2=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);d2=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var d5=a(Md);c2=i(d5,"FlaxRobertaForTokenClassification"),d5.forEach(t),p2=i(ff,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ff.forEach(t),h2=p(nt),qt=s(nt,"DIV",{class:!0});var Ds=a(qt);y(Vi.$$.fragment,Ds),m2=p(Ds),Jo=s(Ds,"P",{});var Gd=a(Jo);u2=i(Gd,"The "),dh=s(Gd,"CODE",{});var c5=a(dh);f2=i(c5,"FlaxRobertaPreTrainedModel"),c5.forEach(t),g2=i(Gd," forward method, overrides the "),ch=s(Gd,"CODE",{});var p5=a(ch);_2=i(p5,"__call__"),p5.forEach(t),b2=i(Gd," special method."),Gd.forEach(t),k2=p(Ds),y(ys.$$.fragment,Ds),v2=p(Ds),y(ws.$$.fragment,Ds),Ds.forEach(t),nt.forEach(t),Sm=p(o),Ko=s(o,"H2",{class:!0});var gf=a(Ko);$s=s(gf,"A",{id:!0,class:!0,href:!0});var h5=a($s);ph=s(h5,"SPAN",{});var m5=a(ph);y(Ji.$$.fragment,m5),m5.forEach(t),h5.forEach(t),T2=p(gf),hh=s(gf,"SPAN",{});var u5=a(hh);y2=i(u5,"FlaxXLMRobertaForQuestionAnswering"),u5.forEach(t),gf.forEach(t),Wm=p(o),Pe=s(o,"DIV",{class:!0});var st=a(Pe);y(Ki.$$.fragment,st),w2=p(st),Go=s(st,"P",{});var Yd=a(Go);$2=i(Yd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),mh=s(Yd,"CODE",{});var f5=a(mh);M2=i(f5,"span start logits"),f5.forEach(t),F2=i(Yd," and "),uh=s(Yd,"CODE",{});var g5=a(uh);x2=i(g5,"span end logits"),g5.forEach(t),R2=i(Yd,")."),Yd.forEach(t),L2=p(st),Gi=s(st,"P",{});var _f=a(Gi);E2=i(_f,"This model inherits from "),Fd=s(_f,"A",{href:!0});var _5=a(Fd);z2=i(_5,"FlaxPreTrainedModel"),_5.forEach(t),q2=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),_f.forEach(t),C2=p(st),Yi=s(st,"P",{});var bf=a(Yi);j2=i(bf,"This model is also a Flax Linen "),Zi=s(bf,"A",{href:!0,rel:!0});var b5=a(Zi);X2=i(b5,"flax.linen.Module"),b5.forEach(t),P2=i(bf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),bf.forEach(t),A2=p(st),fh=s(st,"P",{});var k5=a(fh);O2=i(k5,"Finally, this model supports inherent JAX features such as:"),k5.forEach(t),N2=p(st),Ht=s(st,"UL",{});var Ss=a(Ht);gh=s(Ss,"LI",{});var v5=a(gh);el=s(v5,"A",{href:!0,rel:!0});var T5=a(el);I2=i(T5,"Just-In-Time (JIT) compilation"),T5.forEach(t),v5.forEach(t),D2=p(Ss),_h=s(Ss,"LI",{});var y5=a(_h);tl=s(y5,"A",{href:!0,rel:!0});var w5=a(tl);S2=i(w5,"Automatic Differentiation"),w5.forEach(t),y5.forEach(t),W2=p(Ss),bh=s(Ss,"LI",{});var $5=a(bh);ol=s($5,"A",{href:!0,rel:!0});var M5=a(ol);B2=i(M5,"Vectorization"),M5.forEach(t),$5.forEach(t),U2=p(Ss),kh=s(Ss,"LI",{});var F5=a(kh);nl=s(F5,"A",{href:!0,rel:!0});var x5=a(nl);Q2=i(x5,"Parallelization"),x5.forEach(t),F5.forEach(t),Ss.forEach(t),H2=p(st),sl=s(st,"P",{});var kf=a(sl);V2=i(kf,"This class overrides "),xd=s(kf,"A",{href:!0});var R5=a(xd);J2=i(R5,"FlaxRobertaForQuestionAnswering"),R5.forEach(t),K2=i(kf,`. Please check the superclass for the appropriate
