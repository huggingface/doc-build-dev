...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),T(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);TT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),T(gs.$$.fragment,mo),RT=h(mo),T(_s.$$.fragment,mo),MT=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);T(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var e5=a(Mp);zT=i(e5,"TFRobertaForMultipleChoice"),e5.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var t5=a(Ep);CT=i(t5,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),T(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s5=a(Rd);HT=i(s5,"TFRobertaForMultipleChoice"),s5.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a5=a(zp);JT=i(a5,"__call__"),a5.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),T(ys.$$.fragment,aa),GT=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var r5=a(ws);qp=s(r5,"SPAN",{});var i5=a(qp);T(ii.$$.fragment,i5),i5.forEach(t),r5.forEach(t),XT=h(qu),Cp=s(qu,"SPAN",{});var l5=a(Cp);YT=i(l5,"TFRobertaForTokenClassification"),l5.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d5=a(jp);ew=i(d5,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Aw=h(Wt),T(Es.$$.fragment,Wt),Ow=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),Nw=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),qd=s(nc,"A",{href:!0});var y5=a(qd);Dw=i(y5,"TFRobertaForQuestionAnswering"),y5.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var T5=a(Ip);Ww=i(T5,"__call__"),T5.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(uo),T(zs.$$.fragment,uo),Hw=h(uo),T(qs.$$.fragment,uo),Qw=h(uo),T(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w5=a(js);Dp=s(w5,"SPAN",{});var $5=a(Dp);T(ki.$$.fragment,$5),$5.forEach(t),w5.forEach(t),Jw=h(Ou),Sp=s(Ou,"SPAN",{});var F5=a(Sp);Vw=i(F5,"FlaxRobertaModel"),F5.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var x5=a(Wp);Gw=i(x5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x5.forEach(t),Xw=h(gt),yi=s(gt,"P",{});var Nu=a(yi);Yw=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var R5=a(Cd);Zw=i(R5,"FlaxPreTrainedModel"),R5.forEach(t),e1=i(Nu,`. Check the superclass documentation for the generic methods the
