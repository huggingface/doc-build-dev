import{S as Po,i as Do,s as So,e as s,k as c,w as v,t as r,M as Mo,c as n,d as o,m as d,a,x as T,h as i,b as p,F as t,g as h,y as w,L as Io,q as y,o as q,B}from"../../chunks/vendor-4833417e.js";import{D as $e}from"../../chunks/Docstring-4f315ed9.js";import{C as Lo}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as to}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function No(et){let _,Z,f,g,ue,D,tt,fe,ot,Ee,z,E,ge,S,st,_e,nt,xe,x,at,M,rt,it,Re,ee,lt,je,te,ke,pt,Le,oe,ct,Pe,I,De,se,dt,Se,ne,N,ht,ae,mt,ut,Me,C,Ie,re,be,ft,Ne,k,gt,O,_t,kt,F,bt,vt,Ce,A,R,ve,V,Tt,Te,wt,Oe,m,X,yt,$,qt,ie,Bt,zt,W,At,$t,Et,U,xt,le,Rt,jt,Lt,b,G,Pt,we,Dt,St,H,pe,Mt,ye,It,Nt,ce,Ct,qe,Ot,Ft,j,K,Vt,Be,Xt,Wt,L,Q,Ut,ze,Gt,Ht,P,J,Kt,Y,Qt,Ae,Jt,Yt,Fe;return D=new to({}),S=new to({}),I=new Lo({props:{code:`import torch
...
`}}),K=new $e({props:{name:"convert_tokens_to_string",anchor:"transformers.BartphoTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16149/src/transformers/models/bartpho/tokenization_bartpho.py#L295"}}),Q=new $e({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16149/src/transformers/models/bartpho/tokenization_bartpho.py#L247",parametersDescription:[{anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
