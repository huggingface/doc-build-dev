import{S as am,i as rm,s as im,e as a,k as l,w as g,t as n,M as lm,c as r,d as o,m as d,a as i,x as _,h as s,b as c,F as e,g as u,y as b,q as k,o as v,B as Q,v as dm}from"../../chunks/vendor-6b77c823.js";import{T as ut}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-abef54e3.js";import{C as x}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Y}from"../../chunks/IconCopyLink-7a11ce68.js";function cm(B){let h,q,f,T,y;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=n("Module"),y=n(`
...
the latter silently ignores them.`)},l(w){h=r(w,"P",{});var m=i(h);q=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var $=i(f);T=s($,"Module"),$.forEach(o),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(w,m){u(w,h,m),e(h,q),e(h,f),e(f,T),e(h,y)},d(w){w&&o(h)}}}function bm(B){let h,q,f,T,y,w,m,$,yr,sa,_e,Ie,Fn,mt,qr,Cn,$r,aa,Oe,Dr,ft,zr,Br,ra,Ko,Mr,ia,Go,Pn,xr,la,Yo,jr,da,Z,An,Nn,Er,Fr,Sn,We,Cr,gt,Pr,Ar,Ln,Nr,Sr,In,_t,Lr,On,Ir,Or,Wr,Wn,bt,Hr,Zo,Rr,Ur,ca,He,Vr,kt,Xr,Jr,pa,be,Re,Hn,vt,Kr,Rn,Gr,ha,F,Yr,Un,Zr,ei,Qt,ti,oi,Vn,ni,si,Xn,ai,ri,wt,ii,li,ua,Ue,di,Jn,ci,pi,ma,en,hi,fa,Tt,ga,ke,Ve,Kn,yt,ui,Gn,mi,_a,tn,fi,ba,qt,ka,ve,Xe,Yn,$t,gi,Zn,_i,va,se,bi,Dt,ki,vi,zt,Qi,wi,Qa,Bt,wa,Qe,Je,es,Mt,Ti,ts,yi,Ta,N,xt,qi,we,$i,on,Di,zi,jt,Bi,Mi,xi,Te,ji,nn,Ei,Fi,sn,Ci,Pi,Ai,os,Ni,Si,Et,ya,ye,Ke,ns,Ft,Li,ss,Ii,qa,z,Ct,Oi,as,Wi,Hi,Pt,Ri,an,Ui,Vi,Xi,At,Ji,Nt,Ki,Gi,Yi,St,Zi,Lt,el,tl,ol,j,nl,rs,sl,al,is,rl,il,ls,ll,dl,ds,cl,pl,cs,hl,ul,ps,ml,fl,gl,U,It,_l,qe,bl,rn,kl,vl,hs,Ql,wl,Tl,Ge,yl,us,ql,$l,Ot,$a,$e,Ye,ms,Wt,Dl,fs,zl,Da,S,Ht,Bl,Rt,Ml,gs,xl,jl,El,Ut,Fl,ln,Cl,Pl,Al,Vt,Nl,Xt,Sl,Ll,Il,V,Jt,Ol,De,Wl,dn,Hl,Rl,_s,Ul,Vl,Xl,Ze,Jl,bs,Kl,Gl,Kt,za,ze,et,ks,Gt,Yl,vs,Zl,Ba,L,Yt,ed,Zt,td,Qs,od,nd,sd,eo,ad,cn,rd,id,ld,to,dd,oo,cd,pd,hd,C,no,ud,Be,md,pn,fd,gd,ws,_d,bd,kd,tt,vd,Ts,Qd,wd,so,Td,ao,Ma,Me,ot,ys,ro,yd,qs,qd,xa,I,io,$d,$s,Dd,zd,lo,Bd,hn,Md,xd,jd,co,Ed,po,Fd,Cd,Pd,D,ho,Ad,xe,Nd,un,Sd,Ld,Ds,Id,Od,Wd,nt,Hd,zs,Rd,Ud,uo,Vd,mo,Xd,Bs,Jd,Kd,fo,Gd,go,ja,je,st,Ms,_o,Yd,xs,Zd,Ea,O,bo,ec,ko,tc,js,oc,nc,sc,vo,ac,mn,rc,ic,lc,Qo,dc,wo,cc,pc,hc,X,To,uc,Ee,mc,fn,fc,gc,Es,_c,bc,kc,at,vc,Fs,Qc,wc,yo,Fa,Fe,rt,Cs,qo,Tc,Ps,yc,Ca,W,$o,qc,As,$c,Dc,Do,zc,gn,Bc,Mc,xc,zo,jc,Bo,Ec,Fc,Cc,J,Mo,Pc,Ce,Ac,_n,Nc,Sc,Ns,Lc,Ic,Oc,it,Wc,Ss,Hc,Rc,xo,Pa,Pe,lt,Ls,jo,Uc,Is,Vc,Aa,H,Eo,Xc,Os,Jc,Kc,Fo,Gc,bn,Yc,Zc,ep,Co,tp,Po,op,np,sp,P,Ao,ap,Ae,rp,kn,ip,lp,Ws,dp,cp,pp,dt,hp,Hs,up,mp,No,fp,So,Na,Ne,ct,Rs,Lo,gp,Us,_p,Sa,R,Io,bp,Se,kp,Vs,vp,Qp,Xs,wp,Tp,yp,Oo,qp,vn,$p,Dp,zp,Wo,Bp,Ho,Mp,xp,jp,A,Ro,Ep,Le,Fp,Qn,Cp,Pp,Js,Ap,Np,Sp,pt,Lp,Ks,Ip,Op,Uo,Wp,Vo,La;return w=new Y({}),mt=new Y({}),vt=new Y({}),Tt=new x({props:{code:`import pytorch_quantization.nn as quant_nn
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16568/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16568/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jt=new E({props:{name:"forward",anchor:"transformers.QDQBertLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16568/src/transformers/models/qdqbert/modeling_qdqbert.py#L1035",parametersDescription:[{anchor:"transformers.QDQBertLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16568/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16568/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16568/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16568/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),no=new E({props:{name:"forward",anchor:"transformers.QDQBertForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16568/src/transformers/models/qdqbert/modeling_qdqbert.py#L1186",parametersDescription:[{anchor:"transformers.QDQBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16568/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16568/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16568/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16568/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new E({props:{name:"forward",anchor:"transformers.QDQBertForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16568/src/transformers/models/qdqbert/modeling_qdqbert.py#L1386",parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16568/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16568/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16568/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16568/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new E({props:{name:"forward",anchor:"transformers.QDQBertForNextSentencePrediction.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16568/src/transformers/models/qdqbert/modeling_qdqbert.py#L1281",parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16568/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16568/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16568/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16568/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16568/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new E({props:{name:"forward",anchor:"transformers.QDQBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16568/src/transformers/models/qdqbert/modeling_qdqbert.py#L1660",parametersDescription:[{anchor:"transformers.QDQBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16568/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16568/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16568/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){h=a("meta"),q=l(),f=a("h1"),T=a("a"),y=a("span"),g(w.$$.fragment),m=l(),$=a("span"),yr=n("QDQBERT"),sa=l(),_e=a("h2"),Ie=a("a"),Fn=a("span"),g(mt.$$.fragment),qr=l(),Cn=a("span"),$r=n("Overview"),aa=l(),Oe=a("p"),Dr=n("The QDQBERT model can be referenced in "),ft=a("a"),zr=n(`Integer Quantization for Deep Learning Inference: Principles and Empirical
Evaluation`),Br=n(` by Hao Wu, Patrick Judd, Xiaojie Zhang, Mikhail Isaev and Paulius
Micikevicius.`),ra=l(),Ko=a("p"),Mr=n("The abstract from the paper is the following:"),ia=l(),Go=a("p"),Pn=a("em"),xr=n(`Quantization techniques can reduce the size of Deep Neural Networks and improve inference latency and throughput by
...
documentation from `),sn=a("a"),Ci=n("PretrainedConfig"),Pi=n(" for more information."),Ai=l(),os=a("p"),Ni=n("Examples:"),Si=l(),g(Et.$$.fragment),ya=l(),ye=a("h2"),Ke=a("a"),ns=a("span"),g(Ft.$$.fragment),Li=l(),ss=a("span"),Ii=n("QDQBertModel"),qa=l(),z=a("div"),g(Ct.$$.fragment),Oi=l(),as=a("p"),Wi=n("The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Hi=l(),Pt=a("p"),Ri=n("This model inherits from "),an=a("a"),Ui=n("PreTrainedModel"),Vi=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cc=l(),J=a("div"),g(Mo.$$.fragment),Pc=l(),Ce=a("p"),Ac=n("The "),_n=a("a"),Nc=n("QDQBertForMultipleChoice"),Sc=n(" forward method, overrides the "),Ns=a("code"),Lc=n("__call__"),Ic=n(" special method."),Oc=l(),g(it.$$.fragment),Wc=l(),Ss=a("p"),Hc=n("Example:"),Rc=l(),g(xo.$$.fragment),Pa=l(),Pe=a("h2"),lt=a("a"),Ls=a("span"),g(jo.$$.fragment),Uc=l(),Is=a("span"),Vc=n("QDQBertForTokenClassification"),Aa=l(),H=a("div"),g(Eo.$$.fragment),Xc=l(),Os=a("p"),Jc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep=l(),Co=a("p"),tp=n("This model is also a PyTorch "),Po=a("a"),op=n("torch.nn.Module"),np=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sp=l(),P=a("div"),g(Ao.$$.fragment),ap=l(),Ae=a("p"),rp=n("The "),kn=a("a"),ip=n("QDQBertForTokenClassification"),lp=n(" forward method, overrides the "),Ws=a("code"),dp=n("__call__"),cp=n(" special method."),pp=l(),g(dt.$$.fragment),hp=l(),Hs=a("p"),up=n("Example:"),mp=l(),g(No.$$.fragment),fp=l(),g(So.$$.fragment),Na=l(),Ne=a("h2"),ct=a("a"),Rs=a("span"),g(Lo.$$.fragment),gp=l(),Us=a("span"),_p=n("QDQBertForQuestionAnswering"),Sa=l(),R=a("div"),g(Io.$$.fragment),bp=l(),Se=a("p"),kp=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
quantization will be broken into a pair of QuantizeLinear/DequantizeLinear ONNX ops. After setting static member of
TensorQuantizer to use Pytorch\u2019s own fake quantization functions, fake quantized model can be exported to ONNX, follow
the instructions in `),zt=r(wn,"A",{href:!0,rel:!0});var Th=i(zt);Qi=s(Th,"torch.onnx"),Th.forEach(o),wi=s(wn,". Example:"),wn.forEach(o),Qa=d(t),_(Bt.$$.fragment,t),wa=d(t),Qe=r(t,"H2",{class:!0});var Ja=i(Qe);Je=r(Ja,"A",{id:!0,class:!0,href:!0});var yh=i(Je);es=r(yh,"SPAN",{});var qh=i(es);_(Mt.$$.fragment,qh),qh.forEach(o),yh.forEach(o),Ti=d(Ja),ts=r(Ja,"SPAN",{});var $h=i(ts);yi=s($h,"QDQBertConfig"),$h.forEach(o),Ja.forEach(o),Ta=d(t),N=r(t,"DIV",{class:!0});var ae=i(N);_(xt.$$.fragment,ae),qi=d(ae),we=r(ae,"P",{});var Tn=i(we);$i=s(Tn,"This is the configuration class to store the configuration of a "),on=r(Tn,"A",{href:!0});var Dh=i(on);Di=s(Dh,"QDQBertModel"),Dh.forEach(o),zi=s(Tn,`. It is used to instantiate an
QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the BERT
`),jt=r(Tn,"A",{href:!0,rel:!0});var zh=i(jt);Bi=s(zh,"bert-base-uncased"),zh.forEach(o),Mi=s(Tn," architecture."),Tn.forEach(o),xi=d(ae),Te=r(ae,"P",{});var yn=i(Te);ji=s(yn,"Configuration objects inherit from "),nn=r(yn,"A",{href:!0});var Bh=i(nn);Ei=s(Bh,"PretrainedConfig"),Bh.forEach(o),Fi=s(yn,` and can be used to control the model outputs. Read the
documentation from `),sn=r(yn,"A",{href:!0});var Mh=i(sn);Ci=s(Mh,"PretrainedConfig"),Mh.forEach(o),Pi=s(yn," for more information."),yn.forEach(o),Ai=d(ae),os=r(ae,"P",{});var xh=i(os);Ni=s(xh,"Examples:"),xh.forEach(o),Si=d(ae),_(Et.$$.fragment,ae),ae.forEach(o),ya=d(t),ye=r(t,"H2",{class:!0});var Ka=i(ye);Ke=r(Ka,"A",{id:!0,class:!0,href:!0});var jh=i(Ke);ns=r(jh,"SPAN",{});var Eh=i(ns);_(Ft.$$.fragment,Eh),Eh.forEach(o),jh.forEach(o),Li=d(Ka),ss=r(Ka,"SPAN",{});var Fh=i(ss);Ii=s(Fh,"QDQBertModel"),Fh.forEach(o),Ka.forEach(o),qa=d(t),z=r(t,"DIV",{class:!0});var K=i(z);_(Ct.$$.fragment,K),Oi=d(K),as=r(K,"P",{});var Ch=i(as);Wi=s(Ch,"The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Ch.forEach(o),Hi=d(K),Pt=r(K,"P",{});var Ga=i(Pt);Ri=s(Ga,"This model inherits from "),an=r(Ga,"A",{href:!0});var Ph=i(an);Ui=s(Ph,"PreTrainedModel"),Ph.forEach(o),Vi=s(Ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Za.forEach(o),ol=d(K),j=r(K,"P",{});var G=i(j);nl=s(G,"To behave as an decoder the model needs to be initialized with the "),rs=r(G,"CODE",{});var Sh=i(rs);sl=s(Sh,"is_decoder"),Sh.forEach(o),al=s(G,` argument of the configuration set
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ir.forEach(o),hd=d(de),C=r(de,"DIV",{class:!0});var te=i(C);_(no.$$.fragment,te),ud=d(te),Be=r(te,"P",{});var Dn=i(Be);md=s(Dn,"The "),pn=r(Dn,"A",{href:!0});var du=i(pn);fd=s(du,"QDQBertForMaskedLM"),du.forEach(o),gd=s(Dn," forward method, overrides the "),ws=r(Dn,"CODE",{});var cu=i(ws);_d=s(cu,"__call__"),cu.forEach(o),bd=s(Dn," special method."),Dn.forEach(o),kd=d(te),_(tt.$$.fragment,te),vd=d(te),Ts=r(te,"P",{});var pu=i(Ts);Qd=s(pu,"Example:"),pu.forEach(o),wd=d(te),_(so.$$.fragment,te),Td=d(te),_(ao.$$.fragment,te),te.forEach(o),de.forEach(o),Ma=d(t),Me=r(t,"H2",{class:!0});var lr=i(Me);ot=r(lr,"A",{id:!0,class:!0,href:!0});var hu=i(ot);ys=r(hu,"SPAN",{});var uu=i(ys);_(ro.$$.fragment,uu),uu.forEach(o),hu.forEach(o),yd=d(lr),qs=r(lr,"SPAN",{});var mu=i(qs);qd=s(mu,"QDQBertForSequenceClassification"),mu.forEach(o),lr.forEach(o),xa=d(t),I=r(t,"DIV",{class:!0});var ce=i(I);_(io.$$.fragment,ce),$d=d(ce),$s=r(ce,"P",{});var fu=i($s);Dd=s(fu,`Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),fu.forEach(o),zd=d(ce),lo=r(ce,"P",{});var dr=i(lo);Bd=s(dr,"This model inherits from "),hn=r(dr,"A",{href:!0});var gu=i(hn);Md=s(gu,"PreTrainedModel"),gu.forEach(o),xd=s(dr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dr.forEach(o),jd=d(ce),co=r(ce,"P",{});var cr=i(co);Ed=s(cr,"This model is also a PyTorch "),po=r(cr,"A",{href:!0,rel:!0});var _u=i(po);Fd=s(_u,"torch.nn.Module"),_u.forEach(o),Cd=s(cr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cr.forEach(o),Pd=d(ce),D=r(ce,"DIV",{class:!0});var M=i(D);_(ho.$$.fragment,M),Ad=d(M),xe=r(M,"P",{});var zn=i(xe);Nd=s(zn,"The "),un=r(zn,"A",{href:!0});var bu=i(un);Sd=s(bu,"QDQBertForSequenceClassification"),bu.forEach(o),Ld=s(zn," forward method, overrides the "),Ds=r(zn,"CODE",{});var ku=i(Ds);Id=s(ku,"__call__"),ku.forEach(o),Od=s(zn," special method."),zn.forEach(o),Wd=d(M),_(nt.$$.fragment,M),Hd=d(M),zs=r(M,"P",{});var vu=i(zs);Rd=s(vu,"Example of single-label classification:"),vu.forEach(o),Ud=d(M),_(uo.$$.fragment,M),Vd=d(M),_(mo.$$.fragment,M),Xd=d(M),Bs=r(M,"P",{});var Qu=i(Bs);Jd=s(Qu,"Example of multi-label classification:"),Qu.forEach(o),Kd=d(M),_(fo.$$.fragment,M),Gd=d(M),_(go.$$.fragment,M),M.forEach(o),ce.forEach(o),ja=d(t),je=r(t,"H2",{class:!0});var pr=i(je);st=r(pr,"A",{id:!0,class:!0,href:!0});var wu=i(st);Ms=r(wu,"SPAN",{});var Tu=i(Ms);_(_o.$$.fragment,Tu),Tu.forEach(o),wu.forEach(o),Yd=d(pr),xs=r(pr,"SPAN",{});var yu=i(xs);Zd=s(yu,"QDQBertForNextSentencePrediction"),yu.forEach(o),pr.forEach(o),Ea=d(t),O=r(t,"DIV",{class:!0});var pe=i(O);_(bo.$$.fragment,pe),ec=d(pe),ko=r(pe,"P",{});var hr=i(ko);tc=s(hr,"Bert Model with a "),js=r(hr,"CODE",{});var qu=i(js);oc=s(qu,"next sentence prediction (classification)"),qu.forEach(o),nc=s(hr," head on top."),hr.forEach(o),sc=d(pe),vo=r(pe,"P",{});var ur=i(vo);ac=s(ur,"This model inherits from "),mn=r(ur,"A",{href:!0});var $u=i(mn);rc=s($u,"PreTrainedModel"),$u.forEach(o),ic=s(ur,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mr.forEach(o),hc=d(pe),X=r(pe,"DIV",{class:!0});var he=i(X);_(To.$$.fragment,he),uc=d(he),Ee=r(he,"P",{});var Bn=i(Ee);mc=s(Bn,"The "),fn=r(Bn,"A",{href:!0});var zu=i(fn);fc=s(zu,"QDQBertForNextSentencePrediction"),zu.forEach(o),gc=s(Bn," forward method, overrides the "),Es=r(Bn,"CODE",{});var Bu=i(Es);_c=s(Bu,"__call__"),Bu.forEach(o),bc=s(Bn," special method."),Bn.forEach(o),kc=d(he),_(at.$$.fragment,he),vc=d(he),Fs=r(he,"P",{});var Mu=i(Fs);Qc=s(Mu,"Example:"),Mu.forEach(o),wc=d(he),_(yo.$$.fragment,he),he.forEach(o),pe.forEach(o),Fa=d(t),Fe=r(t,"H2",{class:!0});var fr=i(Fe);rt=r(fr,"A",{id:!0,class:!0,href:!0});var xu=i(rt);Cs=r(xu,"SPAN",{});var ju=i(Cs);_(qo.$$.fragment,ju),ju.forEach(o),xu.forEach(o),Tc=d(fr),Ps=r(fr,"SPAN",{});var Eu=i(Ps);yc=s(Eu,"QDQBertForMultipleChoice"),Eu.forEach(o),fr.forEach(o),Ca=d(t),W=r(t,"DIV",{class:!0});var ue=i(W);_($o.$$.fragment,ue),qc=d(ue),As=r(ue,"P",{});var Fu=i(As);$c=s(Fu,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Fu.forEach(o),Dc=d(ue),Do=r(ue,"P",{});var gr=i(Do);zc=s(gr,"This model inherits from "),gn=r(gr,"A",{href:!0});var Cu=i(gn);Bc=s(Cu,"PreTrainedModel"),Cu.forEach(o),Mc=s(gr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gr.forEach(o),xc=d(ue),zo=r(ue,"P",{});var _r=i(zo);jc=s(_r,"This model is also a PyTorch "),Bo=r(_r,"A",{href:!0,rel:!0});var Pu=i(Bo);Ec=s(Pu,"torch.nn.Module"),Pu.forEach(o),Fc=s(_r,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_r.forEach(o),Cc=d(ue),J=r(ue,"DIV",{class:!0});var me=i(J);_(Mo.$$.fragment,me),Pc=d(me),Ce=r(me,"P",{});var Mn=i(Ce);Ac=s(Mn,"The "),_n=r(Mn,"A",{href:!0});var Au=i(_n);Nc=s(Au,"QDQBertForMultipleChoice"),Au.forEach(o),Sc=s(Mn," forward method, overrides the "),Ns=r(Mn,"CODE",{});var Nu=i(Ns);Lc=s(Nu,"__call__"),Nu.forEach(o),Ic=s(Mn," special method."),Mn.forEach(o),Oc=d(me),_(it.$$.fragment,me),Wc=d(me),Ss=r(me,"P",{});var Su=i(Ss);Hc=s(Su,"Example:"),Su.forEach(o),Rc=d(me),_(xo.$$.fragment,me),me.forEach(o),ue.forEach(o),Pa=d(t),Pe=r(t,"H2",{class:!0});var br=i(Pe);lt=r(br,"A",{id:!0,class:!0,href:!0});var Lu=i(lt);Ls=r(Lu,"SPAN",{});var Iu=i(Ls);_(jo.$$.fragment,Iu),Iu.forEach(o),Lu.forEach(o),Uc=d(br),Is=r(br,"SPAN",{});var Ou=i(Is);Vc=s(Ou,"QDQBertForTokenClassification"),Ou.forEach(o),br.forEach(o),Aa=d(t),H=r(t,"DIV",{class:!0});var fe=i(H);_(Eo.$$.fragment,fe),Xc=d(fe),Os=r(fe,"P",{});var Wu=i(Os);Jc=s(Wu,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
