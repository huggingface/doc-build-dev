...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16585/src/transformers/models/gpt_neo/configuration_gpt_neo.py#L34"}}),Ve=new oe({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16585/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L709",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16585/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L824",returnDescription:`
