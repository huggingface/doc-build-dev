...
<a href="/docs/transformers/pr_16011/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16011/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_16011/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),go=new f({props:{name:"save_pretrained",anchor:"transformers.PreTrainedModel.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"save_config",val:": bool = True"},{name:"state_dict",val:": typing.Optional[dict] = None"},{name:"save_function",val:": typing.Callable = <function save at 0x7f2d07fefdc0>"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L999",parametersDescription:[{anchor:"transformers.PreTrainedModel.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7f2c9ed62860>"}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),zo=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_utils.py#L194"}}),Do=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16011/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16011/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_16011/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16011/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_16011/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_16011/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_16011/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16011/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16011/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_16011/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),or=o("a"),Hb=r("from_pretrained()"),Vb=r(" class method."),Xb=l(),pn=o("div"),c(as.$$.fragment),Rb=l(),Cl=o("p"),Yb=r("Method used for serving the model."),Kb=l(),cn=o("div"),c(rs.$$.fragment),Zb=l(),Il=o("p"),Jb=r("Prepare the output of the saved model. Each model must implement this function."),Qb=l(),mn=o("div"),c(is.$$.fragment),e1=l(),Bl=o("p"),t1=r("Set all the bias in the LM head."),n1=l(),un=o("div"),c(ls.$$.fragment),o1=l(),Wl=o("p"),s1=r("Set model\u2019s input embeddings"),a1=l(),gn=o("div"),c(ds.$$.fragment),r1=l(),Ul=o("p"),i1=r("Set model\u2019s output embeddings"),l1=l(),hn=o("div"),c(ps.$$.fragment),d1=l(),Hl=o("p"),p1=r("A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),c1=l(),ce=o("div"),c(cs.$$.fragment),m1=l(),oe=o("p"),u1=r("A modification of Keras\u2019s default "),Vl=o("code"),g1=r("train_step"),h1=r(` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=o("code"),_1=r("train_step"),f1=r(`. In
this case, it expects the same `),Rl=o("code"),b1=r("data"),v1=r(" as the original function (i.e. "),Yl=o("code"),y1=r("(inputs, labels)"),k1=r(")."),x1=l(),ut=o("p"),w1=r(`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=o("code"),T1=r("data"),j1=r(" is a singleton tuple containing "),Zl=o("code"),$1=r("(inputs,)"),M1=r("."),P1=l(),gt=o("p"),E1=r(`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=o("code"),L1=r("loss"),q1=r(" output, and the model will output a "),Ql=o("code"),F1=r("loss"),O1=r(` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Jp=l(),ht=o("h2"),_n=o("a"),ed=o("span"),c(ms.$$.fragment),z1=l(),td=o("span"),D1=r("TFModelUtilsMixin"),Qp=l(),Pe=o("div"),c(us.$$.fragment),A1=l(),gs=o("p"),G1=r("A few utilities for "),nd=o("code"),S1=r("tf.keras.Model"),N1=r(", to be used as a mixin."),C1=l(),fn=o("div"),c(hs.$$.fragment),I1=l(),od=o("p"),B1=r("Get the number of (optionally, trainable) parameters in the model."),ec=l(),_t=o("h2"),bn=o("a"),sd=o("span"),c(_s.$$.fragment),W1=l(),ad=o("span"),U1=r("FlaxPreTrainedModel"),tc=l(),M=o("div"),c(fs.$$.fragment),H1=l(),rd=o("p"),V1=r("Base class for all models."),X1=l(),sr=o("p"),ar=o("a"),R1=r("FlaxPreTrainedModel"),Y1=r(` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),K1=l(),id=o("p"),Z1=r("Class attributes (overridden by derived classes):"),J1=l(),ft=o("ul"),Xe=o("li"),ld=o("strong"),Q1=r("config_class"),ev=r(" ("),rr=o("a"),tv=r("PretrainedConfig"),nv=r(") \u2014 A subclass of "),ir=o("a"),ov=r("PretrainedConfig"),sv=r(` to use as configuration class
for this model architecture.`),av=l(),vn=o("li"),dd=o("strong"),rv=r("base_model_prefix"),iv=r(" ("),pd=o("code"),lv=r("str"),dv=r(`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),pv=l(),R=o("li"),cd=o("strong"),cv=r("main_input_name"),mv=r(" ("),md=o("code"),uv=r("str"),gv=r(") \u2014 The name of the principal input to the model (often "),ud=o("code"),hv=r("input_ids"),_v=r(` for NLP
models, `),gd=o("code"),fv=r("pixel_values"),bv=r(" for vision models and "),hd=o("code"),vv=r("input_values"),yv=r(" for speech models)."),kv=l(),me=o("div"),c(bs.$$.fragment),xv=l(),vs=o("p"),wv=r(`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=o("code"),Tv=r("repo_path_or_name"),jv=r("."),$v=l(),fd=o("p"),Mv=r("Examples:"),Pv=l(),c(ys.$$.fragment),Ev=l(),W=o("div"),c(ks.$$.fragment),Lv=l(),bd=o("p"),qv=r("Instantiate a pretrained flax model from a pre-trained model configuration."),Fv=l(),xs=o("p"),Ov=r("The warning "),vd=o("em"),zv=r("Weights from XXX not initialized from pretrained model"),Dv=r(` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),Av=l(),ws=o("p"),Gv=r("The warning "),yd=o("em"),Sv=r("Weights from XXX not used in YYY"),Nv=r(` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),Cv=l(),kd=o("p"),Iv=r("Examples:"),Bv=l(),c(Ts.$$.fragment),Wv=l(),Re=o("div"),c(js.$$.fragment),Uv=l(),xd=o("p"),Hv=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Vv=l(),c(yn.$$.fragment),Xv=l(),kn=o("div"),c($s.$$.fragment),Rv=l(),Ms=o("p"),Yv=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=o("code"),Kv=r("[from_pretrained()](/docs/transformers/pr_16011/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Zv=r(" class method"),Jv=l(),Y=o("div"),c(Ps.$$.fragment),Qv=l(),se=o("p"),ey=r("Cast the floating-point "),Td=o("code"),ty=r("params"),ny=r(" to "),jd=o("code"),oy=r("jax.numpy.bfloat16"),sy=r(". This returns a new "),$d=o("code"),ay=r("params"),ry=r(` tree and does not cast
...
`),Od=o("code"),wy=r("params"),Ty=r(" in place."),jy=l(),zd=o("p"),$y=r(`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),My=l(),Dd=o("p"),Py=r("Examples:"),Ey=l(),c(qs.$$.fragment),Ly=l(),ue=o("div"),c(Fs.$$.fragment),qy=l(),re=o("p"),Fy=r("Cast the floating-point "),Ad=o("code"),Oy=r("parmas"),zy=r(" to "),Gd=o("code"),Dy=r("jax.numpy.float32"),Ay=r(`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=o("code"),Gy=r("params"),Sy=r(" tree and does not cast the "),Nd=o("code"),Ny=r("params"),Cy=r(" in place."),Iy=l(),Cd=o("p"),By=r("Examples:"),Wy=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(zs.$$.fragment),Uy=l(),Bd=o("span"),Hy=r("Generation"),oc=l(),P=o("div"),c(Ds.$$.fragment),Vy=l(),As=o("p"),Xy=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),Ry=r("PreTrainedModel"),Yy=r("."),Ky=l(),wn=o("div"),c(Gs.$$.fragment),Zy=l(),Ss=o("p"),Jy=r("Implement in subclasses of "),dr=o("a"),Qy=r("PreTrainedModel"),ek=r(" for custom behavior to adjust the logits in the generate method."),tk=l(),ge=o("div"),c(Ns.$$.fragment),nk=l(),Wd=o("p"),ok=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),sk=l(),Ud=o("p"),ak=r("Examples:"),rk=l(),c(Cs.$$.fragment),ik=l(),he=o("div"),c(Is.$$.fragment),lk=l(),Hd=o("p"),dk=r("Generates sequences for models with a language modeling head using beam search decoding."),pk=l(),Vd=o("p"),ck=r("Examples:"),mk=l(),c(Bs.$$.fragment),uk=l(),Tn=o("div"),c(Ws.$$.fragment),gk=l(),Xd=o("p"),hk=r(`compute the transition probabilities of sequences given generation
...
`),Si=s(Tc,"CODE",{});var XT=a(Si);zh=i(XT,"[from_pretrained()](/docs/transformers/pr_16011/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),Dh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),or=s(tm,"A",{href:!0});var s0=a(or);Hb=i(s0,"from_pretrained()"),s0.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),pn=s(k,"DIV",{class:!0});var nm=a(pn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var a0=a(Cl);Yb=i(a0,"Method used for serving the model."),a0.forEach(t),nm.forEach(t),Kb=d(k),cn=s(k,"DIV",{class:!0});var om=a(cn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var r0=a(Il);Jb=i(r0,"Prepare the output of the saved model. Each model must implement this function."),r0.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),e1=d(sm),Bl=s(sm,"P",{});var i0=a(Bl);t1=i(i0,"Set all the bias in the LM head."),i0.forEach(t),sm.forEach(t),n1=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),o1=d(am),Wl=s(am,"P",{});var l0=a(Wl);s1=i(l0,"Set model\u2019s input embeddings"),l0.forEach(t),am.forEach(t),a1=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),r1=d(rm),Ul=s(rm,"P",{});var d0=a(Ul);i1=i(d0,"Set model\u2019s output embeddings"),d0.forEach(t),rm.forEach(t),l1=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(ps.$$.fragment,im),d1=d(im),Hl=s(im,"P",{});var p0=a(Hl);p1=i(p0,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),p0.forEach(t),im.forEach(t),c1=d(k),ce=s(k,"DIV",{class:!0});var Fn=a(ce);m(cs.$$.fragment,Fn),m1=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);u1=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var c0=a(Vl);g1=i(c0,"train_step"),c0.forEach(t),h1=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var m0=a(Xl);_1=i(m0,"train_step"),m0.forEach(t),f1=i(Ke,`. In
this case, it expects the same `),Rl=s(Ke,"CODE",{});var u0=a(Rl);b1=i(u0,"data"),u0.forEach(t),v1=i(Ke," as the original function (i.e. "),Yl=s(Ke,"CODE",{});var g0=a(Yl);y1=i(g0,"(inputs, labels)"),g0.forEach(t),k1=i(Ke,")."),Ke.forEach(t),x1=d(Fn),ut=s(Fn,"P",{});var Fr=a(ut);w1=i(Fr,`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h0=a(Kl);T1=i(h0,"data"),h0.forEach(t),j1=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _0=a(Zl);$1=i(_0,"(inputs,)"),_0.forEach(t),M1=i(Fr,"."),Fr.forEach(t),P1=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);E1=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var f0=a(Jl);L1=i(f0,"loss"),f0.forEach(t),q1=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b0=a(Ql);F1=i(b0,"loss"),b0.forEach(t),O1=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v0=a(_n);ed=s(v0,"SPAN",{});var y0=a(ed);m(ms.$$.fragment,y0),y0.forEach(t),v0.forEach(t),z1=d(lm),td=s(lm,"SPAN",{});var k0=a(td);D1=i(k0,"TFModelUtilsMixin"),k0.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var zr=a(Pe);m(us.$$.fragment,zr),A1=d(zr),gs=s(zr,"P",{});var dm=a(gs);G1=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x0=a(nd);S1=i(x0,"tf.keras.Model"),x0.forEach(t),N1=i(dm,", to be used as a mixin."),dm.forEach(t),C1=d(zr),fn=s(zr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),I1=d(pm),od=s(pm,"P",{});var w0=a(od);B1=i(w0,"Get the number of (optionally, trainable) parameters in the model."),w0.forEach(t),pm.forEach(t),zr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T0=a(bn);sd=s(T0,"SPAN",{});var j0=a(sd);m(_s.$$.fragment,j0),j0.forEach(t),T0.forEach(t),W1=d(cm),ad=s(cm,"SPAN",{});var $0=a(ad);U1=i($0,"FlaxPreTrainedModel"),$0.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),H1=d(q),rd=s(q,"P",{});var M0=a(rd);V1=i(M0,"Base class for all models."),M0.forEach(t),X1=d(q),sr=s(q,"P",{});var Dw=a(sr);ar=s(Dw,"A",{href:!0});var P0=a(ar);R1=i(P0,"FlaxPreTrainedModel"),P0.forEach(t),Y1=i(Dw,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),Dw.forEach(t),K1=d(q),id=s(q,"P",{});var E0=a(id);Z1=i(E0,"Class attributes (overridden by derived classes):"),E0.forEach(t),J1=d(q),ft=s(q,"UL",{});var Dr=a(ft);Xe=s(Dr,"LI",{});var Da=a(Xe);ld=s(Da,"STRONG",{});var L0=a(ld);Q1=i(L0,"config_class"),L0.forEach(t),ev=i(Da," ("),rr=s(Da,"A",{href:!0});var q0=a(rr);tv=i(q0,"PretrainedConfig"),q0.forEach(t),nv=i(Da,") \u2014 A subclass of "),ir=s(Da,"A",{href:!0});var F0=a(ir);ov=i(F0,"PretrainedConfig"),F0.forEach(t),sv=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),av=d(Dr),vn=s(Dr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O0=a(dd);rv=i(O0,"base_model_prefix"),O0.forEach(t),iv=i(qp," ("),pd=s(qp,"CODE",{});var z0=a(pd);lv=i(z0,"str"),z0.forEach(t),dv=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),pv=d(Dr),R=s(Dr,"LI",{});var De=a(R);cd=s(De,"STRONG",{});var D0=a(cd);cv=i(D0,"main_input_name"),D0.forEach(t),mv=i(De," ("),md=s(De,"CODE",{});var A0=a(md);uv=i(A0,"str"),A0.forEach(t),gv=i(De,") \u2014 The name of the principal input to the model (often "),ud=s(De,"CODE",{});var G0=a(ud);hv=i(G0,"input_ids"),G0.forEach(t),_v=i(De,` for NLP
models, `),gd=s(De,"CODE",{});var S0=a(gd);fv=i(S0,"pixel_values"),S0.forEach(t),bv=i(De," for vision models and "),hd=s(De,"CODE",{});var N0=a(hd);vv=i(N0,"input_values"),N0.forEach(t),yv=i(De," for speech models)."),De.forEach(t),Dr.forEach(t),kv=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xv=d(On),vs=s(On,"P",{});var mm=a(vs);wv=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C0=a(_d);Tv=i(C0,"repo_path_or_name"),C0.forEach(t),jv=i(mm,"."),mm.forEach(t),$v=d(On),fd=s(On,"P",{});var I0=a(fd);Mv=i(I0,"Examples:"),I0.forEach(t),Pv=d(On),m(ys.$$.fragment,On),On.forEach(t),Ev=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Lv=d(Te),bd=s(Te,"P",{});var B0=a(bd);qv=i(B0,"Instantiate a pretrained flax model from a pre-trained model configuration."),B0.forEach(t),Fv=d(Te),xs=s(Te,"P",{});var um=a(xs);Ov=i(um,"The warning "),vd=s(um,"EM",{});var W0=a(vd);zv=i(W0,"Weights from XXX not initialized from pretrained model"),W0.forEach(t),Dv=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),Av=d(Te),ws=s(Te,"P",{});var gm=a(ws);Gv=i(gm,"The warning "),yd=s(gm,"EM",{});var U0=a(yd);Sv=i(U0,"Weights from XXX not used in YYY"),U0.forEach(t),Nv=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),Cv=d(Te),kd=s(Te,"P",{});var H0=a(kd);Iv=i(H0,"Examples:"),H0.forEach(t),Bv=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),Wv=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m(js.$$.fragment,Ar),Uv=d(Ar),xd=s(Ar,"P",{});var V0=a(xd);Hv=i(V0,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V0.forEach(t),Vv=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xv=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m($s.$$.fragment,hm),Rv=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Yv=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X0=a(wd);Kv=i(X0,"[from_pretrained()](/docs/transformers/pr_16011/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X0.forEach(t),Zv=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jv=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qv=d(Ze),se=s(Ze,"P",{});var Je=a(se);ey=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R0=a(Td);ty=i(R0,"params"),R0.forEach(t),ny=i(Je," to "),jd=s(Je,"CODE",{});var Y0=a(jd);oy=i(Y0,"jax.numpy.bfloat16"),Y0.forEach(t),sy=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var K0=a($d);ay=i(K0,"params"),K0.forEach(t),ry=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Z0=a(Md);iy=i(Z0,"params"),Z0.forEach(t),ly=i(Je," in place."),Je.forEach(t),dy=d(Ze),Pd=s(Ze,"P",{});var J0=a(Pd);py=i(J0,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),J0.forEach(t),cy=d(Ze),Ed=s(Ze,"P",{});var Q0=a(Ed);my=i(Q0,"Examples:"),Q0.forEach(t),uy=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),gy=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),hy=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_y=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var ej=a(Ld);fy=i(ej,"parmas"),ej.forEach(t),by=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);vy=i(tj,"jax.numpy.float16"),tj.forEach(t),yy=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);ky=i(nj,"params"),nj.forEach(t),xy=i(et,` tree and does not cast the
`),Od=s(et,"CODE",{});var oj=a(Od);wy=i(oj,"params"),oj.forEach(t),Ty=i(et," in place."),et.forEach(t),jy=d(Qe),zd=s(Qe,"P",{});var sj=a(zd);$y=i(sj,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),sj.forEach(t),My=d(Qe),Dd=s(Qe,"P",{});var aj=a(Dd);Py=i(aj,"Examples:"),aj.forEach(t),Ey=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),Ly=d(q),ue=s(q,"DIV",{class:!0});var zn=a(ue);m(Fs.$$.fragment,zn),qy=d(zn),re=s(zn,"P",{});var tt=a(re);Fy=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var rj=a(Ad);Oy=i(rj,"parmas"),rj.forEach(t),zy=i(tt," to "),Gd=s(tt,"CODE",{});var ij=a(Gd);Dy=i(ij,"jax.numpy.float32"),ij.forEach(t),Ay=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var lj=a(Sd);Gy=i(lj,"params"),lj.forEach(t),Sy=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var dj=a(Nd);Ny=i(dj,"params"),dj.forEach(t),Cy=i(tt," in place."),tt.forEach(t),Iy=d(zn),Cd=s(zn,"P",{});var pj=a(Cd);By=i(pj,"Examples:"),pj.forEach(t),Wy=d(zn),m(Os.$$.fragment,zn),zn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var cj=a(xn);Id=s(cj,"SPAN",{});var mj=a(Id);m(zs.$$.fragment,mj),mj.forEach(t),cj.forEach(t),Uy=d(fm),Bd=s(fm,"SPAN",{});var uj=a(Bd);Hy=i(uj,"Generation"),uj.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(Ds.$$.fragment,F),Vy=d(F),As=s(F,"P",{});var bm=a(As);Xy=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var gj=a(lr);Ry=i(gj,"PreTrainedModel"),gj.forEach(t),Yy=i(bm,"."),bm.forEach(t),Ky=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Zy=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);Jy=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var hj=a(dr);Qy=i(hj,"PreTrainedModel"),hj.forEach(t),ek=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),tk=d(F),ge=s(F,"DIV",{class:!0});var Dn=a(ge);m(Ns.$$.fragment,Dn),nk=d(Dn),Wd=s(Dn,"P",{});var _j=a(Wd);ok=i(_j,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_j.forEach(t),sk=d(Dn),Ud=s(Dn,"P",{});var fj=a(Ud);ak=i(fj,"Examples:"),fj.forEach(t),rk=d(Dn),m(Cs.$$.fragment,Dn),Dn.forEach(t),ik=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),lk=d(An),Hd=s(An,"P",{});var bj=a(Hd);dk=i(bj,"Generates sequences for models with a language modeling head using beam search decoding."),bj.forEach(t),pk=d(An),Vd=s(An,"P",{});var vj=a(Vd);ck=i(vj,"Examples:"),vj.forEach(t),mk=d(An),m(Bs.$$.fragment,An),An.forEach(t),uk=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),gk=d(km),Xd=s(km,"P",{});var yj=a(Xd);hk=i(yj,`compute the transition probabilities of sequences given generation
