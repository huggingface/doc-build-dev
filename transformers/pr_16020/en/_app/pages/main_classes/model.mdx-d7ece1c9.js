import{S as i$,i as l$,s as d$,e as o,k as l,w as c,t as r,M as p$,c as s,d as t,m as d,a,x as m,h as i,b as p,F as e,g as v,y as u,q as g,o as h,B as _}from"../../chunks/vendor-4833417e.js";import{T as Fp}from"../../chunks/Tip-fffd6df1.js";import{D as f}from"../../chunks/Docstring-4f315ed9.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function c$(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var $=a(x);E=i($,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),$.forEach(t)},m(T,$){v(T,x,$),e(x,E)},d(T){T&&t(x)}}}function m$(ee){let x,E,T,$,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),$=r("\u201Coffline-mode\u201D"),te=r(` to
...
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16020/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_16020/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Lt=new Fp({props:{$$slots:{default:[c$]},$$scope:{ctx:ee}}}),qt=new Fp({props:{$$slots:{default:[m$]},$$scope:{ctx:ee}}}),to=new O({props:{code:`from transformers import BertConfig, BertModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),go=new f({props:{name:"save_pretrained",anchor:"transformers.PreTrainedModel.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"save_config",val:": bool = True"},{name:"state_dict",val:": typing.Optional[dict] = None"},{name:"save_function",val:": typing.Callable = <function save at 0x7f4ef63f2dc0>"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L999",parametersDescription:[{anchor:"transformers.PreTrainedModel.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7f4e8d023130>"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),zo=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_utils.py#L194"}}),Do=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16020/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_16020/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Qt=new Fp({props:{$$slots:{default:[g$]},$$scope:{ctx:ee}}}),Ho=new O({props:{code:`from transformers import BertConfig, TFBertModel
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_16020/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_16020/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16020/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
model parameters to fp32 precision. This returns a new `),Sd=o("code"),G1=r("params"),S1=r(" tree and does not cast the "),Nd=o("code"),N1=r("params"),C1=r(" in place."),I1=l(),Cd=o("p"),B1=r("Examples:"),W1=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(zs.$$.fragment),U1=l(),Bd=o("span"),H1=r("Generation"),oc=l(),P=o("div"),c(Ds.$$.fragment),V1=l(),As=o("p"),X1=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),R1=r("PreTrainedModel"),Y1=r("."),K1=l(),wn=o("div"),c(Gs.$$.fragment),Z1=l(),Ss=o("p"),J1=r("Implement in subclasses of "),dr=o("a"),Q1=r("PreTrainedModel"),e2=r(" for custom behavior to adjust the logits in the generate method."),t2=l(),ge=o("div"),c(Ns.$$.fragment),n2=l(),Wd=o("p"),o2=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),s2=l(),Ud=o("p"),a2=r("Examples:"),r2=l(),c(Cs.$$.fragment),i2=l(),he=o("div"),c(Is.$$.fragment),l2=l(),Hd=o("p"),d2=r("Generates sequences for models with a language modeling head using beam search decoding."),p2=l(),Vd=o("p"),c2=r("Examples:"),m2=l(),c(Bs.$$.fragment),u2=l(),Tn=o("div"),c(Ws.$$.fragment),g2=l(),Xd=o("p"),h2=r(`compute the transition probabilities of sequences given generation
...
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),j2=l(),vt=o("p"),$2=r("Apart from "),Zd=o("code"),M2=r("inputs"),P2=r(`, all the arguments below will default to the value of the attribute of the same name inside
...
post`),z2=r("."),D2=l(),Jd=o("p"),A2=r("Examples:"),G2=l(),c(Ys.$$.fragment),S2=l(),fe=o("div"),c(Ks.$$.fragment),N2=l(),Qd=o("p"),C2=r("Generates sequences for models with a language modeling head using greedy decoding."),I2=l(),ep=o("p"),B2=r("Examples:"),W2=l(),c(Zs.$$.fragment),U2=l(),be=o("div"),c(Js.$$.fragment),H2=l(),tp=o("p"),V2=r("Generates sequences for models with a language modeling head using beam search decoding."),X2=l(),np=o("p"),R2=r("Examples:"),Y2=l(),c(Qs.$$.fragment),K2=l(),jn=o("div"),c(ea.$$.fragment),Z2=l(),ta=o("p"),J2=r("Implement in subclasses of "),cr=o("a"),Q2=r("PreTrainedModel"),ek=r(" for custom behavior to prepare inputs in the generate method."),tk=l(),ve=o("div"),c(na.$$.fragment),nk=l(),op=o("p"),ok=r("Generates sequences for models with a language modeling head using multinomial sampling."),sk=l(),sp=o("p"),ak=r("Examples:"),rk=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),ik=l(),aa=o("p"),lk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),dk=r("TFPreTrainedModel"),pk=r("."),ck=l(),$n=o("div"),c(ra.$$.fragment),mk=l(),ia=o("p"),uk=r("Implement in subclasses of "),ur=o("a"),gk=r("PreTrainedModel"),hk=r(" for custom behavior to adjust the logits in the generate method."),_k=l(),N=o("div"),c(la.$$.fragment),fk=l(),ap=o("p"),bk=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),xk=r("."),wk=l(),Ee=o("p"),Tk=r("Apart from "),rp=o("code"),jk=r("input_ids"),$k=r(" and "),ip=o("code"),Mk=r("attention_mask"),Pk=r(`, all the arguments below will default to the value of the attribute
...
post`),zk=r("."),Dk=l(),lp=o("p"),Ak=r("Examples:"),Gk=l(),c(ua.$$.fragment),Sk=l(),ye=o("div"),c(ga.$$.fragment),Nk=l(),dp=o("p"),Ck=r("Generates sequences for models with a language modeling head using greedy decoding."),Ik=l(),pp=o("p"),Bk=r("Examples:"),Wk=l(),c(ha.$$.fragment),Uk=l(),Mn=o("div"),c(_a.$$.fragment),Hk=l(),fa=o("p"),Vk=r("Implement in subclasses of "),hr=o("a"),Xk=r("TFPreTrainedModel"),Rk=r(" for custom behavior to prepare inputs in the generate method."),Yk=l(),ke=o("div"),c(ba.$$.fragment),Kk=l(),cp=o("p"),Zk=r("Generates sequences for models with a language modeling head using multinomial sampling."),Jk=l(),mp=o("p"),Qk=r("Examples:"),e0=l(),c(va.$$.fragment),ac=l(),Le=o("div"),c(ya.$$.fragment),t0=l(),ka=o("p"),n0=r("A class containing all of the functions supporting generation, to be used as a mixin in "),_r=o("a"),o0=r("FlaxPreTrainedModel"),s0=r("."),a0=l(),H=o("div"),c(xa.$$.fragment),r0=l(),up=o("p"),i0=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),l0=l(),yt=o("p"),d0=r("Apart from "),gp=o("code"),p0=r("input_ids"),c0=r(`, all the arguments below will default to the value of the attribute of the same name
inside the `),fr=o("a"),m0=r("PretrainedConfig"),u0=r(` of the model. The default values indicated are the default values of those
config.`),g0=l(),wa=o("p"),h0=r("Most of these parameters are explained in more detail in "),Ta=o("a"),_0=r(`this blog
post`),f0=r("."),b0=l(),hp=o("p"),v0=r("Examples:"),y0=l(),c(ja.$$.fragment),rc=l(),kt=o("h2"),Pn=o("a"),_p=o("span"),c($a.$$.fragment),k0=l(),fp=o("span"),x0=r("Pushing to the Hub"),ic=l(),qe=o("div"),c(Ma.$$.fragment),w0=l(),bp=o("p"),T0=r("A Mixin containing the functionality to push a model or tokenizer to the hub."),j0=l(),xe=o("div"),c(Pa.$$.fragment),$0=l(),Ea=o("p"),M0=r(`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vp=o("code"),P0=r("repo_path_or_name"),E0=r("."),L0=l(),yp=o("p"),q0=r("Examples:"),F0=l(),c(La.$$.fragment),this.h()},l(n){const b=p$('[data-svelte="svelte-1phssyn"]',document.head);x=s(b,"META",{name:!0,content:!0}),b.forEach(t),E=d(n),T=s(n,"H1",{class:!0});var qa=a(T);$=s(qa,"A",{id:!0,class:!0,href:!0});var kp=a($);te=s(kp,"SPAN",{});var xp=a(te);m(A.$$.fragment,xp),xp.forEach(t),kp.forEach(t),I=d(qa),Me=s(qa,"SPAN",{});var wp=a(Me);Am=i(wp,"Models"),wp.forEach(t),qa.forEach(t),Op=d(n),ie=s(n,"P",{});var Fe=a(ie);Gm=i(Fe,"The base classes "),Aa=s(Fe,"A",{href:!0});var A0=a(Aa);Sm=i(A0,"PreTrainedModel"),A0.forEach(t),Nm=i(Fe,", "),Ga=s(Fe,"A",{href:!0});var G0=a(Ga);Cm=i(G0,"TFPreTrainedModel"),G0.forEach(t),Im=i(Fe,`, and
`),Sa=s(Fe,"A",{href:!0});var S0=a(Sa);Bm=i(S0,"FlaxPreTrainedModel"),S0.forEach(t),Wm=i(Fe,` implement the common methods for loading/saving a model either from a local
file or directory, or from a pretrained model configuration provided by the library (downloaded from HuggingFace\u2019s AWS
S3 repository).`),Fe.forEach(t),zp=d(n),nt=s(n,"P",{});var Tp=a(nt);Na=s(Tp,"A",{href:!0});var N0=a(Na);Um=i(N0,"PreTrainedModel"),N0.forEach(t),Hm=i(Tp," and "),Ca=s(Tp,"A",{href:!0});var C0=a(Ca);Vm=i(C0,"TFPreTrainedModel"),C0.forEach(t),Xm=i(Tp,` also implement a few methods which
are common among all the models to:`),Tp.forEach(t),Dp=d(n),wt=s(n,"UL",{});var dc=a(wt);Ir=s(dc,"LI",{});var I0=a(Ir);Rm=i(I0,"resize the input token embeddings when new tokens are added to the vocabulary"),I0.forEach(t),Ym=d(dc),Br=s(dc,"LI",{});var B0=a(Br);Km=i(B0,"prune the attention heads of the model."),B0.forEach(t),dc.forEach(t),Ap=d(n),B=s(n,"P",{});var we=a(B);Zm=i(we,"The other methods that are common to each model are defined in "),Ia=s(we,"A",{href:!0});var W0=a(Ia);Jm=i(W0,"ModuleUtilsMixin"),W0.forEach(t),Qm=i(we,`
(for the PyTorch models) and `),Wr=s(we,"CODE",{});var U0=a(Wr);eu=i(U0,"TFModuleUtilsMixin"),U0.forEach(t),tu=i(we,` (for the TensorFlow models) or
for text generation, `),Ba=s(we,"A",{href:!0});var H0=a(Ba);nu=i(H0,"GenerationMixin"),H0.forEach(t),ou=i(we,` (for the PyTorch models),
`),Wa=s(we,"A",{href:!0});var V0=a(Wa);su=i(V0,"TFGenerationMixin"),V0.forEach(t),au=i(we,` (for the TensorFlow models) and
`),Ua=s(we,"A",{href:!0});var X0=a(Ua);ru=i(X0,"FlaxGenerationMixin"),X0.forEach(t),iu=i(we," (for the Flax/JAX models)."),we.forEach(t),Gp=d(n),ot=s(n,"H2",{class:!0});var pc=a(ot);Tt=s(pc,"A",{id:!0,class:!0,href:!0});var R0=a(Tt);Ur=s(R0,"SPAN",{});var Y0=a(Ur);m(Hn.$$.fragment,Y0),Y0.forEach(t),R0.forEach(t),lu=d(pc),Hr=s(pc,"SPAN",{});var K0=a(Hr);du=i(K0,"PreTrainedModel"),K0.forEach(t),pc.forEach(t),Sp=d(n),w=s(n,"DIV",{class:!0});var j=a(w);m(Vn.$$.fragment,j),pu=d(j),Vr=s(j,"P",{});var Z0=a(Vr);cu=i(Z0,"Base class for all models."),Z0.forEach(t),mu=d(j),Ha=s(j,"P",{});var O0=a(Ha);Va=s(O0,"A",{href:!0});var J0=a(Va);uu=i(J0,"PreTrainedModel"),J0.forEach(t),gu=i(O0,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),O0.forEach(t),hu=d(j),Xn=s(j,"UL",{});var cc=a(Xn);Xr=s(cc,"LI",{});var Q0=a(Xr);_u=i(Q0,"resize the input embeddings,"),Q0.forEach(t),fu=d(cc),Rr=s(cc,"LI",{});var ex=a(Rr);bu=i(ex,"prune heads in the self-attention heads."),ex.forEach(t),cc.forEach(t),vu=d(j),Yr=s(j,"P",{});var tx=a(Yr);yu=i(tx,"Class attributes (overridden by derived classes):"),tx.forEach(t),ku=d(j),ne=s(j,"UL",{});var Ye=a(ne);Kr=s(Ye,"LI",{});var nx=a(Kr);Ae=s(nx,"P",{});var Fa=a(Ae);Zr=s(Fa,"STRONG",{});var ox=a(Zr);xu=i(ox,"config_class"),ox.forEach(t),wu=i(Fa," ("),Xa=s(Fa,"A",{href:!0});var sx=a(Xa);Tu=i(sx,"PretrainedConfig"),sx.forEach(t),ju=i(Fa,") \u2014 A subclass of "),Ra=s(Fa,"A",{href:!0});var ax=a(Ra);$u=i(ax,"PretrainedConfig"),ax.forEach(t),Mu=i(Fa,` to use as configuration class
for this model architecture.`),Fa.forEach(t),nx.forEach(t),Pu=d(Ye),Rn=s(Ye,"LI",{});var mc=a(Rn);Ge=s(mc,"P",{});var Oa=a(Ge);Jr=s(Oa,"STRONG",{});var rx=a(Jr);Eu=i(rx,"load_tf_weights"),rx.forEach(t),Lu=i(Oa," ("),Qr=s(Oa,"CODE",{});var ix=a(Qr);qu=i(ix,"Callable"),ix.forEach(t),Fu=i(Oa,") \u2014 A python "),ei=s(Oa,"EM",{});var lx=a(ei);Ou=i(lx,"method"),lx.forEach(t),zu=i(Oa,` for loading a TensorFlow checkpoint in a PyTorch model,
taking as arguments:`),Oa.forEach(t),Du=d(mc),st=s(mc,"UL",{});var br=a(st);jt=s(br,"LI",{});var jp=a(jt);ti=s(jp,"STRONG",{});var dx=a(ti);Au=i(dx,"model"),dx.forEach(t),Gu=i(jp," ("),Ya=s(jp,"A",{href:!0});var px=a(Ya);Su=i(px,"PreTrainedModel"),px.forEach(t),Nu=i(jp,") \u2014 An instance of the model on which to load the TensorFlow checkpoint."),jp.forEach(t),Cu=d(br),$t=s(br,"LI",{});var $p=a($t);ni=s($p,"STRONG",{});var cx=a(ni);Iu=i(cx,"config"),cx.forEach(t),Bu=i($p," ("),oi=s($p,"CODE",{});var mx=a(oi);Wu=i(mx,"PreTrainedConfig"),mx.forEach(t),Uu=i($p,") \u2014 An instance of the configuration associated to the model."),$p.forEach(t),Hu=d(br),Mt=s(br,"LI",{});var Mp=a(Mt);si=s(Mp,"STRONG",{});var ux=a(si);Vu=i(ux,"path"),ux.forEach(t),Xu=i(Mp," ("),ai=s(Mp,"CODE",{});var gx=a(ai);Ru=i(gx,"str"),gx.forEach(t),Yu=i(Mp,") \u2014 A path to the TensorFlow checkpoint."),Mp.forEach(t),br.forEach(t),mc.forEach(t),Ku=d(Ye),ri=s(Ye,"LI",{});var hx=a(ri);Pt=s(hx,"P",{});var Pp=a(Pt);ii=s(Pp,"STRONG",{});var _x=a(ii);Zu=i(_x,"base_model_prefix"),_x.forEach(t),Ju=i(Pp," ("),li=s(Pp,"CODE",{});var fx=a(li);Qu=i(fx,"str"),fx.forEach(t),eg=i(Pp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Pp.forEach(t),hx.forEach(t),tg=d(Ye),di=s(Ye,"LI",{});var bx=a(di);Et=s(bx,"P",{});var Ep=a(Et);pi=s(Ep,"STRONG",{});var vx=a(pi);ng=i(vx,"is_parallelizable"),vx.forEach(t),og=i(Ep," ("),ci=s(Ep,"CODE",{});var yx=a(ci);sg=i(yx,"bool"),yx.forEach(t),ag=i(Ep,") \u2014 A flag indicating whether this model supports model parallelization."),Ep.forEach(t),bx.forEach(t),rg=d(Ye),mi=s(Ye,"LI",{});var kx=a(mi);V=s(kx,"P",{});var Oe=a(V);ui=s(Oe,"STRONG",{});var xx=a(ui);ig=i(xx,"main_input_name"),xx.forEach(t),lg=i(Oe," ("),gi=s(Oe,"CODE",{});var wx=a(gi);dg=i(wx,"str"),wx.forEach(t),pg=i(Oe,") \u2014 The name of the principal input to the model (often "),hi=s(Oe,"CODE",{});var Tx=a(hi);cg=i(Tx,"input_ids"),Tx.forEach(t),mg=i(Oe,` for NLP
models, `),_i=s(Oe,"CODE",{});var jx=a(_i);ug=i(jx,"pixel_values"),jx.forEach(t),gg=i(Oe," for vision models and "),fi=s(Oe,"CODE",{});var $x=a(fi);hg=i($x,"input_values"),$x.forEach(t),_g=i(Oe," for speech models)."),Oe.forEach(t),kx.forEach(t),Ye.forEach(t),fg=d(j),le=s(j,"DIV",{class:!0});var En=a(le);m(Yn.$$.fragment,En),bg=d(En),Kn=s(En,"P",{});var uc=a(Kn);vg=i(uc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),bi=s(uc,"CODE",{});var Mx=a(bi);yg=i(Mx,"repo_path_or_name"),Mx.forEach(t),kg=i(uc,"."),uc.forEach(t),xg=d(En),vi=s(En,"P",{});var Px=a(vi);wg=i(Px,"Examples:"),Px.forEach(t),Tg=d(En),m(Zn.$$.fragment,En),En.forEach(t),jg=d(j),z=s(j,"DIV",{class:!0});var C=a(z);m(Jn.$$.fragment,C),$g=d(C),yi=s(C,"P",{});var Ex=a(yi);Mg=i(Ex,"Instantiate a pretrained pytorch model from a pre-trained model configuration."),Ex.forEach(t),Pg=d(C),at=s(C,"P",{});var vr=a(at);Eg=i(vr,"The model is set in evaluation mode by default using "),ki=s(vr,"CODE",{});var Lx=a(ki);Lg=i(Lx,"model.eval()"),Lx.forEach(t),qg=i(vr,` (Dropout modules are deactivated). To train
the model, you should first set it back in training mode with `),xi=s(vr,"CODE",{});var qx=a(xi);Fg=i(qx,"model.train()"),qx.forEach(t),Og=i(vr,"."),vr.forEach(t),zg=d(C),Qn=s(C,"P",{});var gc=a(Qn);Dg=i(gc,"The warning "),wi=s(gc,"EM",{});var Fx=a(wi);Ag=i(Fx,"Weights from XXX not initialized from pretrained model"),Fx.forEach(t),Gg=i(gc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),gc.forEach(t),Sg=d(C),eo=s(C,"P",{});var hc=a(eo);Ng=i(hc,"The warning "),Ti=s(hc,"EM",{});var Ox=a(Ti);Cg=i(Ox,"Weights from XXX not used in YYY"),Ox.forEach(t),Ig=i(hc,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),hc.forEach(t),Bg=d(C),m(Lt.$$.fragment,C),Wg=d(C),m(qt.$$.fragment,C),Ug=d(C),ji=s(C,"P",{});var zx=a(ji);Hg=i(zx,"Examples:"),zx.forEach(t),Vg=d(C),m(to.$$.fragment,C),C.forEach(t),Xg=d(j),Ft=s(j,"DIV",{class:!0});var _c=a(Ft);m(no.$$.fragment,_c),Rg=d(_c),$i=s(_c,"P",{});var Dx=a($i);Yg=i(Dx,"Returns the model\u2019s input embeddings."),Dx.forEach(t),_c.forEach(t),Kg=d(j),Ot=s(j,"DIV",{class:!0});var fc=a(Ot);m(oo.$$.fragment,fc),Zg=d(fc),Mi=s(fc,"P",{});var Ax=a(Mi);Jg=i(Ax,"Returns the model\u2019s output embeddings."),Ax.forEach(t),fc.forEach(t),Qg=d(j),Se=s(j,"DIV",{class:!0});var yr=a(Se);m(so.$$.fragment,yr),eh=d(yr),Pi=s(yr,"P",{});var Gx=a(Pi);th=i(Gx,"Deactivates gradient checkpointing for the current model."),Gx.forEach(t),nh=d(yr),Ei=s(yr,"P",{});var Sx=a(Ei);oh=i(Sx,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Sx.forEach(t),yr.forEach(t),sh=d(j),Ne=s(j,"DIV",{class:!0});var kr=a(Ne);m(ao.$$.fragment,kr),ah=d(kr),Li=s(kr,"P",{});var Nx=a(Li);rh=i(Nx,"Activates gradient checkpointing for the current model."),Nx.forEach(t),ih=d(kr),qi=s(kr,"P",{});var Cx=a(qi);lh=i(Cx,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Cx.forEach(t),kr.forEach(t),dh=d(j),zt=s(j,"DIV",{class:!0});var bc=a(zt);m(ro.$$.fragment,bc),ph=d(bc),Fi=s(bc,"P",{});var Ix=a(Fi);ch=i(Ix,"If needed prunes and maybe initializes weights."),Ix.forEach(t),bc.forEach(t),mh=d(j),Dt=s(j,"DIV",{class:!0});var vc=a(Dt);m(io.$$.fragment,vc),uh=d(vc),Oi=s(vc,"P",{});var Bx=a(Oi);gh=i(Bx,`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),Bx.forEach(t),vc.forEach(t),hh=d(j),At=s(j,"DIV",{class:!0});var yc=a(At);m(lo.$$.fragment,yc),_h=d(yc),zi=s(yc,"P",{});var Wx=a(zi);fh=i(Wx,"Prunes heads of the base model."),Wx.forEach(t),yc.forEach(t),bh=d(j),Ce=s(j,"DIV",{class:!0});var xr=a(Ce);m(po.$$.fragment,xr),vh=d(xr),Di=s(xr,"P",{});var Ux=a(Di);yh=i(Ux,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Ux.forEach(t),kh=d(xr),m(Gt.$$.fragment,xr),xr.forEach(t),xh=d(j),Ie=s(j,"DIV",{class:!0});var wr=a(Ie);m(co.$$.fragment,wr),wh=d(wr),mo=s(wr,"P",{});var kc=a(mo);Th=i(kc,"Resizes input token embeddings matrix of the model if "),Ai=s(kc,"CODE",{});var Hx=a(Ai);jh=i(Hx,"new_num_tokens != config.vocab_size"),Hx.forEach(t),$h=i(kc,"."),kc.forEach(t),Mh=d(wr),uo=s(wr,"P",{});var xc=a(uo);Ph=i(xc,"Takes care of tying weights embeddings afterwards if the model class has a "),Gi=s(xc,"CODE",{});var Vx=a(Gi);Eh=i(Vx,"tie_weights()"),Vx.forEach(t),Lh=i(xc," method."),xc.forEach(t),wr.forEach(t),qh=d(j),St=s(j,"DIV",{class:!0});var wc=a(St);m(go.$$.fragment,wc),Fh=d(wc),ho=s(wc,"P",{});var Tc=a(ho);Oh=i(Tc,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=s(Tc,"CODE",{});var Xx=a(Si);zh=i(Xx,"[from_pretrained()](/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Xx.forEach(t),Dh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var Rx=a(Ni);Sh=i(Rx,"Set model\u2019s input embeddings."),Rx.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var Yx=a(Ci);Ih=i(Yx,"Tie the weights between the input embeddings and the output embeddings."),Yx.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var Kx=a(Ii);Uh=i(Kx,"torchscript"),Kx.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),$c.forEach(t),Tr.forEach(t),j.forEach(t),Np=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cp=d(n),rt=s(n,"H3",{class:!0});var Mc=a(rt);Ct=s(Mc,"A",{id:!0,class:!0,href:!0});var Zx=a(Ct);Bi=s(Zx,"SPAN",{});var Jx=a(Bi);m(vo.$$.fragment,Jx),Jx.forEach(t),Zx.forEach(t),Vh=d(Mc),Wi=s(Mc,"SPAN",{});var Qx=a(Wi);Xh=i(Qx,"Model Instantiation dtype"),Qx.forEach(t),Mc.forEach(t),Ip=d(n),de=s(n,"P",{});var Ln=a(de);Rh=i(Ln,"Under Pytorch a model normally gets instantiated with "),Ui=s(Ln,"CODE",{});var ew=a(Ui);Yh=i(ew,"torch.float32"),ew.forEach(t),Kh=i(Ln,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(Ln,"CODE",{});var tw=a(Hi);Zh=i(tw,"dtype"),tw.forEach(t),Jh=i(Ln," using "),Vi=s(Ln,"CODE",{});var nw=a(Vi);Qh=i(nw,"torch_dtype"),nw.forEach(t),e_=i(Ln," argument:"),Ln.forEach(t),Bp=d(n),m(yo.$$.fragment,n),Wp=d(n),We=s(n,"P",{});var jr=a(We);t_=i(jr,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s(jr,"CODE",{});var ow=a(Xi);n_=i(ow,'"auto"'),ow.forEach(t),o_=i(jr,`,
and then `),Ri=s(jr,"CODE",{});var sw=a(Ri);s_=i(sw,"dtype"),sw.forEach(t),a_=i(jr," will be automatically derived from the model\u2019s weights:"),jr.forEach(t),Up=d(n),m(ko.$$.fragment,n),Hp=d(n),It=s(n,"P",{});var Pc=a(It);r_=i(Pc,"Models instantiated from scratch can also be told which "),Yi=s(Pc,"CODE",{});var aw=a(Yi);i_=i(aw,"dtype"),aw.forEach(t),l_=i(Pc," to use with:"),Pc.forEach(t),Vp=d(n),m(xo.$$.fragment,n),Xp=d(n),Za=s(n,"P",{});var rw=a(Za);d_=i(rw,"Due to Pytorch design, this functionality is only available for floating dtypes."),rw.forEach(t),Rp=d(n),it=s(n,"H2",{class:!0});var Ec=a(it);Bt=s(Ec,"A",{id:!0,class:!0,href:!0});var iw=a(Bt);Ki=s(iw,"SPAN",{});var lw=a(Ki);m(wo.$$.fragment,lw),lw.forEach(t),iw.forEach(t),p_=d(Ec),Zi=s(Ec,"SPAN",{});var dw=a(Zi);c_=i(dw,"ModuleUtilsMixin"),dw.forEach(t),Ec.forEach(t),Yp=d(n),L=s(n,"DIV",{class:!0});var D=a(L);m(To.$$.fragment,D),m_=d(D),jo=s(D,"P",{});var Lc=a(jo);u_=i(Lc,"A few utilities for "),Ji=s(Lc,"CODE",{});var pw=a(Ji);g_=i(pw,"torch.nn.Modules"),pw.forEach(t),h_=i(Lc,", to be used as a mixin."),Lc.forEach(t),__=d(D),Ue=s(D,"DIV",{class:!0});var $r=a(Ue);m($o.$$.fragment,$r),f_=d($r),Qi=s($r,"P",{});var cw=a(Qi);b_=i(cw,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),cw.forEach(t),v_=d($r),lt=s($r,"P",{});var Mr=a(lt);y_=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var mw=a(el);k_=i(mw,"mem_rss_diff"),mw.forEach(t),x_=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var uw=a(tl);w_=i(uw,"model.reset_memory_hooks_state()"),uw.forEach(t),T_=i(Mr,"."),Mr.forEach(t),$r.forEach(t),j_=d(D),Wt=s(D,"DIV",{class:!0});var qc=a(Wt);m(Mo.$$.fragment,qc),$_=d(qc),nl=s(qc,"P",{});var gw=a(nl);M_=i(gw,"Helper function to estimate the total number of tokens from the model inputs."),gw.forEach(t),qc.forEach(t),P_=d(D),Ut=s(D,"DIV",{class:!0});var Fc=a(Ut);m(Po.$$.fragment,Fc),E_=d(Fc),dt=s(Fc,"P",{});var Pr=a(dt);L_=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
tokens (valid if `),ol=s(Pr,"CODE",{});var hw=a(ol);q_=i(hw,"12 * d_model << sequence_length"),hw.forEach(t),F_=i(Pr,") as laid out in "),Eo=s(Pr,"A",{href:!0,rel:!0});var _w=a(Eo);O_=i(_w,`this
paper`),_w.forEach(t),z_=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fc.forEach(t),D_=d(D),Ht=s(D,"DIV",{class:!0});var Oc=a(Ht);m(Lo.$$.fragment,Oc),A_=d(Oc),sl=s(Oc,"P",{});var fw=a(sl);G_=i(fw,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),fw.forEach(t),Oc.forEach(t),S_=d(D),Vt=s(D,"DIV",{class:!0});var zc=a(Vt);m(qo.$$.fragment,zc),N_=d(zc),al=s(zc,"P",{});var bw=a(al);C_=i(bw,"Prepare the head mask if needed."),bw.forEach(t),zc.forEach(t),I_=d(D),Xt=s(D,"DIV",{class:!0});var Dc=a(Xt);m(Fo.$$.fragment,Dc),B_=d(Dc),rl=s(Dc,"P",{});var vw=a(rl);W_=i(vw,"Invert an attention mask (e.g., switches 0. and 1.)."),vw.forEach(t),Dc.forEach(t),U_=d(D),Rt=s(D,"DIV",{class:!0});var Ac=a(Rt);m(Oo.$$.fragment,Ac),H_=d(Ac),il=s(Ac,"P",{});var yw=a(il);V_=i(yw,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),yw.forEach(t),Ac.forEach(t),X_=d(D),Yt=s(D,"DIV",{class:!0});var Gc=a(Yt);m(zo.$$.fragment,Gc),R_=d(Gc),pt=s(Gc,"P",{});var Er=a(pt);Y_=i(Er,"Reset the "),ll=s(Er,"CODE",{});var kw=a(ll);K_=i(kw,"mem_rss_diff"),kw.forEach(t),Z_=i(Er," attribute of each module (see "),Ja=s(Er,"A",{href:!0});var xw=a(Ja);J_=i(xw,"add_memory_hooks()"),xw.forEach(t),Q_=i(Er,")."),Er.forEach(t),Gc.forEach(t),D.forEach(t),Kp=d(n),ct=s(n,"H2",{class:!0});var Sc=a(ct);Kt=s(Sc,"A",{id:!0,class:!0,href:!0});var ww=a(Kt);dl=s(ww,"SPAN",{});var Tw=a(dl);m(Do.$$.fragment,Tw),Tw.forEach(t),ww.forEach(t),ef=d(Sc),pl=s(Sc,"SPAN",{});var jw=a(pl);tf=i(jw,"TFPreTrainedModel"),jw.forEach(t),Sc.forEach(t),Zp=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),nf=d(k),cl=s(k,"P",{});var $w=a(cl);of=i($w,"Base class for all TF models."),$w.forEach(t),sf=d(k),Qa=s(k,"P",{});var z0=a(Qa);er=s(z0,"A",{href:!0});var Mw=a(er);af=i(Mw,"TFPreTrainedModel"),Mw.forEach(t),rf=i(z0,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),z0.forEach(t),lf=d(k),Go=s(k,"UL",{});var Nc=a(Go);ml=s(Nc,"LI",{});var Pw=a(ml);df=i(Pw,"resize the input embeddings,"),Pw.forEach(t),pf=d(Nc),ul=s(Nc,"LI",{});var Ew=a(ul);cf=i(Ew,"prune heads in the self-attention heads."),Ew.forEach(t),Nc.forEach(t),mf=d(k),gl=s(k,"P",{});var Lw=a(gl);uf=i(Lw,"Class attributes (overridden by derived classes):"),Lw.forEach(t),gf=d(k),mt=s(k,"UL",{});var Lr=a(mt);He=s(Lr,"LI",{});var za=a(He);hl=s(za,"STRONG",{});var qw=a(hl);hf=i(qw,"config_class"),qw.forEach(t),_f=i(za," ("),tr=s(za,"A",{href:!0});var Fw=a(tr);ff=i(Fw,"PretrainedConfig"),Fw.forEach(t),bf=i(za,") \u2014 A subclass of "),nr=s(za,"A",{href:!0});var Ow=a(nr);vf=i(Ow,"PretrainedConfig"),Ow.forEach(t),yf=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),kf=d(Lr),Zt=s(Lr,"LI",{});var Lp=a(Zt);_l=s(Lp,"STRONG",{});var zw=a(_l);xf=i(zw,"base_model_prefix"),zw.forEach(t),wf=i(Lp," ("),fl=s(Lp,"CODE",{});var Dw=a(fl);Tf=i(Dw,"str"),Dw.forEach(t),jf=i(Lp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Lp.forEach(t),$f=d(Lr),X=s(Lr,"LI",{});var ze=a(X);bl=s(ze,"STRONG",{});var Aw=a(bl);Mf=i(Aw,"main_input_name"),Aw.forEach(t),Pf=i(ze," ("),vl=s(ze,"CODE",{});var Gw=a(vl);Ef=i(Gw,"str"),Gw.forEach(t),Lf=i(ze,") \u2014 The name of the principal input to the model (often "),yl=s(ze,"CODE",{});var Sw=a(yl);qf=i(Sw,"input_ids"),Sw.forEach(t),Ff=i(ze,` for NLP
models, `),kl=s(ze,"CODE",{});var Nw=a(kl);Of=i(Nw,"pixel_values"),Nw.forEach(t),zf=i(ze," for vision models and "),xl=s(ze,"CODE",{});var Cw=a(xl);Df=i(Cw,"input_values"),Cw.forEach(t),Af=i(ze," for speech models)."),ze.forEach(t),Lr.forEach(t),Gf=d(k),pe=s(k,"DIV",{class:!0});var qn=a(pe);m(So.$$.fragment,qn),Sf=d(qn),No=s(qn,"P",{});var Cc=a(No);Nf=i(Cc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=s(Cc,"CODE",{});var Iw=a(wl);Cf=i(Iw,"repo_path_or_name"),Iw.forEach(t),If=i(Cc,"."),Cc.forEach(t),Bf=d(qn),Tl=s(qn,"P",{});var Bw=a(Tl);Wf=i(Bw,"Examples:"),Bw.forEach(t),Uf=d(qn),m(Co.$$.fragment,qn),qn.forEach(t),Hf=d(k),Jt=s(k,"DIV",{class:!0});var Ic=a(Jt);m(Io.$$.fragment,Ic),Vf=d(Ic),jl=s(Ic,"P",{});var Ww=a(jl);Xf=i(Ww,`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),Ww.forEach(t),Ic.forEach(t),Rf=d(k),S=s(k,"DIV",{class:!0});var Z=a(S);m(Bo.$$.fragment,Z),Yf=d(Z),$l=s(Z,"P",{});var Uw=a($l);Kf=i(Uw,"Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),Uw.forEach(t),Zf=d(Z),Wo=s(Z,"P",{});var Bc=a(Wo);Jf=i(Bc,"The warning "),Ml=s(Bc,"EM",{});var Hw=a(Ml);Qf=i(Hw,"Weights from XXX not initialized from pretrained model"),Hw.forEach(t),eb=i(Bc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),Bc.forEach(t),tb=d(Z),Uo=s(Z,"P",{});var Wc=a(Uo);nb=i(Wc,"The warning "),Pl=s(Wc,"EM",{});var Vw=a(Pl);ob=i(Vw,"Weights from XXX not used in YYY"),Vw.forEach(t),sb=i(Wc,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),Wc.forEach(t),ab=d(Z),m(Qt.$$.fragment,Z),rb=d(Z),El=s(Z,"P",{});var Xw=a(El);ib=i(Xw,"Examples:"),Xw.forEach(t),lb=d(Z),m(Ho.$$.fragment,Z),Z.forEach(t),db=d(k),en=s(k,"DIV",{class:!0});var Uc=a(en);m(Vo.$$.fragment,Uc),pb=d(Uc),Ll=s(Uc,"P",{});var Rw=a(Ll);cb=i(Rw,"Dict of bias attached to an LM head. The key represents the name of the bias attribute."),Rw.forEach(t),Uc.forEach(t),mb=d(k),tn=s(k,"DIV",{class:!0});var Hc=a(tn);m(Xo.$$.fragment,Hc),ub=d(Hc),ql=s(Hc,"P",{});var Yw=a(ql);gb=i(Yw,"Returns the model\u2019s input embeddings layer."),Yw.forEach(t),Hc.forEach(t),hb=d(k),nn=s(k,"DIV",{class:!0});var Vc=a(nn);m(Ro.$$.fragment,Vc),_b=d(Vc),Fl=s(Vc,"P",{});var Kw=a(Fl);fb=i(Kw,"The LM Head layer. This method must be overwritten by all the models that have a lm head."),Kw.forEach(t),Vc.forEach(t),bb=d(k),on=s(k,"DIV",{class:!0});var Xc=a(on);m(Yo.$$.fragment,Xc),vb=d(Xc),Ol=s(Xc,"P",{});var Zw=a(Ol);yb=i(Zw,"Returns the model\u2019s output embeddings"),Zw.forEach(t),Xc.forEach(t),kb=d(k),sn=s(k,"DIV",{class:!0});var Rc=a(sn);m(Ko.$$.fragment,Rc),xb=d(Rc),zl=s(Rc,"P",{});var Jw=a(zl);wb=i(Jw,`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),Jw.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),jb=d(Yc),Dl=s(Yc,"P",{});var Qw=a(Dl);$b=i(Qw,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),Qw.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var eT=a(Al);Eb=i(eT,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),eT.forEach(t),Kc.forEach(t),Lb=d(k),ln=s(k,"DIV",{class:!0});var Zc=a(ln);m(Qo.$$.fragment,Zc),qb=d(Zc),Gl=s(Zc,"P",{});var tT=a(Gl);Fb=i(tT,"Prunes heads of the base model."),tT.forEach(t),Zc.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),zb=d(qr),ts=s(qr,"P",{});var Jc=a(ts);Db=i(Jc,"Resizes input token embeddings matrix of the model if "),Sl=s(Jc,"CODE",{});var nT=a(Sl);Ab=i(nT,"new_num_tokens != config.vocab_size"),nT.forEach(t),Gb=i(Jc,"."),Jc.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qc=a(ns);Nb=i(Qc,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qc,"CODE",{});var oT=a(Nl);Cb=i(oT,"tie_weights()"),oT.forEach(t),Ib=i(Qc," method."),Qc.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),or=s(tm,"A",{href:!0});var sT=a(or);Hb=i(sT,"from_pretrained()"),sT.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),pn=s(k,"DIV",{class:!0});var nm=a(pn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var aT=a(Cl);Yb=i(aT,"Method used for serving the model."),aT.forEach(t),nm.forEach(t),Kb=d(k),cn=s(k,"DIV",{class:!0});var om=a(cn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var rT=a(Il);Jb=i(rT,"Prepare the output of the saved model. Each model must implement this function."),rT.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),ev=d(sm),Bl=s(sm,"P",{});var iT=a(Bl);tv=i(iT,"Set all the bias in the LM head."),iT.forEach(t),sm.forEach(t),nv=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),ov=d(am),Wl=s(am,"P",{});var lT=a(Wl);sv=i(lT,"Set model\u2019s input embeddings"),lT.forEach(t),am.forEach(t),av=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),rv=d(rm),Ul=s(rm,"P",{});var dT=a(Ul);iv=i(dT,"Set model\u2019s output embeddings"),dT.forEach(t),rm.forEach(t),lv=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(ps.$$.fragment,im),dv=d(im),Hl=s(im,"P",{});var pT=a(Hl);pv=i(pT,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),pT.forEach(t),im.forEach(t),cv=d(k),ce=s(k,"DIV",{class:!0});var Fn=a(ce);m(cs.$$.fragment,Fn),mv=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);uv=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var cT=a(Vl);gv=i(cT,"train_step"),cT.forEach(t),hv=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var mT=a(Xl);_v=i(mT,"train_step"),mT.forEach(t),fv=i(Ke,`. In
this case, it expects the same `),Rl=s(Ke,"CODE",{});var uT=a(Rl);bv=i(uT,"data"),uT.forEach(t),vv=i(Ke," as the original function (i.e. "),Yl=s(Ke,"CODE",{});var gT=a(Yl);yv=i(gT,"(inputs, labels)"),gT.forEach(t),kv=i(Ke,")."),Ke.forEach(t),xv=d(Fn),ut=s(Fn,"P",{});var Fr=a(ut);wv=i(Fr,`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var hT=a(Kl);Tv=i(hT,"data"),hT.forEach(t),jv=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _T=a(Zl);$v=i(_T,"(inputs,)"),_T.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var fT=a(Jl);Lv=i(fT,"loss"),fT.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var bT=a(Ql);Fv=i(bT,"loss"),bT.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var vT=a(_n);ed=s(vT,"SPAN",{});var yT=a(ed);m(ms.$$.fragment,yT),yT.forEach(t),vT.forEach(t),zv=d(lm),td=s(lm,"SPAN",{});var kT=a(td);Dv=i(kT,"TFModelUtilsMixin"),kT.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var zr=a(Pe);m(us.$$.fragment,zr),Av=d(zr),gs=s(zr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var xT=a(nd);Sv=i(xT,"tf.keras.Model"),xT.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(zr),fn=s(zr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),Iv=d(pm),od=s(pm,"P",{});var wT=a(od);Bv=i(wT,"Get the number of (optionally, trainable) parameters in the model."),wT.forEach(t),pm.forEach(t),zr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var TT=a(bn);sd=s(TT,"SPAN",{});var jT=a(sd);m(_s.$$.fragment,jT),jT.forEach(t),TT.forEach(t),Wv=d(cm),ad=s(cm,"SPAN",{});var $T=a(ad);Uv=i($T,"FlaxPreTrainedModel"),$T.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var MT=a(rd);Vv=i(MT,"Base class for all models."),MT.forEach(t),Xv=d(q),sr=s(q,"P",{});var D0=a(sr);ar=s(D0,"A",{href:!0});var PT=a(ar);Rv=i(PT,"FlaxPreTrainedModel"),PT.forEach(t),Yv=i(D0,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),D0.forEach(t),Kv=d(q),id=s(q,"P",{});var ET=a(id);Zv=i(ET,"Class attributes (overridden by derived classes):"),ET.forEach(t),Jv=d(q),ft=s(q,"UL",{});var Dr=a(ft);Xe=s(Dr,"LI",{});var Da=a(Xe);ld=s(Da,"STRONG",{});var LT=a(ld);Qv=i(LT,"config_class"),LT.forEach(t),ey=i(Da," ("),rr=s(Da,"A",{href:!0});var qT=a(rr);ty=i(qT,"PretrainedConfig"),qT.forEach(t),ny=i(Da,") \u2014 A subclass of "),ir=s(Da,"A",{href:!0});var FT=a(ir);oy=i(FT,"PretrainedConfig"),FT.forEach(t),sy=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),ay=d(Dr),vn=s(Dr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var OT=a(dd);ry=i(OT,"base_model_prefix"),OT.forEach(t),iy=i(qp," ("),pd=s(qp,"CODE",{});var zT=a(pd);ly=i(zT,"str"),zT.forEach(t),dy=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),py=d(Dr),R=s(Dr,"LI",{});var De=a(R);cd=s(De,"STRONG",{});var DT=a(cd);cy=i(DT,"main_input_name"),DT.forEach(t),my=i(De," ("),md=s(De,"CODE",{});var AT=a(md);uy=i(AT,"str"),AT.forEach(t),gy=i(De,") \u2014 The name of the principal input to the model (often "),ud=s(De,"CODE",{});var GT=a(ud);hy=i(GT,"input_ids"),GT.forEach(t),_y=i(De,` for NLP
models, `),gd=s(De,"CODE",{});var ST=a(gd);fy=i(ST,"pixel_values"),ST.forEach(t),by=i(De," for vision models and "),hd=s(De,"CODE",{});var NT=a(hd);vy=i(NT,"input_values"),NT.forEach(t),yy=i(De," for speech models)."),De.forEach(t),Dr.forEach(t),ky=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xy=d(On),vs=s(On,"P",{});var mm=a(vs);wy=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var CT=a(_d);Ty=i(CT,"repo_path_or_name"),CT.forEach(t),jy=i(mm,"."),mm.forEach(t),$y=d(On),fd=s(On,"P",{});var IT=a(fd);My=i(IT,"Examples:"),IT.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ey=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ly=d(Te),bd=s(Te,"P",{});var BT=a(bd);qy=i(BT,"Instantiate a pretrained flax model from a pre-trained model configuration."),BT.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var WT=a(vd);zy=i(WT,"Weights from XXX not initialized from pretrained model"),WT.forEach(t),Dy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),Ay=d(Te),ws=s(Te,"P",{});var gm=a(ws);Gy=i(gm,"The warning "),yd=s(gm,"EM",{});var UT=a(yd);Sy=i(UT,"Weights from XXX not used in YYY"),UT.forEach(t),Ny=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),Cy=d(Te),kd=s(Te,"P",{});var HT=a(kd);Iy=i(HT,"Examples:"),HT.forEach(t),By=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),Wy=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m(js.$$.fragment,Ar),Uy=d(Ar),xd=s(Ar,"P",{});var VT=a(xd);Hy=i(VT,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),VT.forEach(t),Vy=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xy=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m($s.$$.fragment,hm),Ry=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Yy=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var XT=a(wd);Ky=i(XT,"[from_pretrained()](/docs/transformers/pr_16020/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),XT.forEach(t),Zy=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);e1=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var RT=a(Td);t1=i(RT,"params"),RT.forEach(t),n1=i(Je," to "),jd=s(Je,"CODE",{});var YT=a(jd);o1=i(YT,"jax.numpy.bfloat16"),YT.forEach(t),s1=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var KT=a($d);a1=i(KT,"params"),KT.forEach(t),r1=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var ZT=a(Md);i1=i(ZT,"params"),ZT.forEach(t),l1=i(Je," in place."),Je.forEach(t),d1=d(Ze),Pd=s(Ze,"P",{});var JT=a(Pd);p1=i(JT,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),JT.forEach(t),c1=d(Ze),Ed=s(Ze,"P",{});var QT=a(Ed);m1=i(QT,"Examples:"),QT.forEach(t),u1=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),g1=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),h1=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_1=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var ej=a(Ld);f1=i(ej,"parmas"),ej.forEach(t),b1=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);v1=i(tj,"jax.numpy.float16"),tj.forEach(t),y1=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);k1=i(nj,"params"),nj.forEach(t),x1=i(et,` tree and does not cast the
`),Od=s(et,"CODE",{});var oj=a(Od);w1=i(oj,"params"),oj.forEach(t),T1=i(et," in place."),et.forEach(t),j1=d(Qe),zd=s(Qe,"P",{});var sj=a(zd);$1=i(sj,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),sj.forEach(t),M1=d(Qe),Dd=s(Qe,"P",{});var aj=a(Dd);P1=i(aj,"Examples:"),aj.forEach(t),E1=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),L1=d(q),ue=s(q,"DIV",{class:!0});var zn=a(ue);m(Fs.$$.fragment,zn),q1=d(zn),re=s(zn,"P",{});var tt=a(re);F1=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var rj=a(Ad);O1=i(rj,"parmas"),rj.forEach(t),z1=i(tt," to "),Gd=s(tt,"CODE",{});var ij=a(Gd);D1=i(ij,"jax.numpy.float32"),ij.forEach(t),A1=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var lj=a(Sd);G1=i(lj,"params"),lj.forEach(t),S1=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var dj=a(Nd);N1=i(dj,"params"),dj.forEach(t),C1=i(tt," in place."),tt.forEach(t),I1=d(zn),Cd=s(zn,"P",{});var pj=a(Cd);B1=i(pj,"Examples:"),pj.forEach(t),W1=d(zn),m(Os.$$.fragment,zn),zn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var cj=a(xn);Id=s(cj,"SPAN",{});var mj=a(Id);m(zs.$$.fragment,mj),mj.forEach(t),cj.forEach(t),U1=d(fm),Bd=s(fm,"SPAN",{});var uj=a(Bd);H1=i(uj,"Generation"),uj.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(Ds.$$.fragment,F),V1=d(F),As=s(F,"P",{});var bm=a(As);X1=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var gj=a(lr);R1=i(gj,"PreTrainedModel"),gj.forEach(t),Y1=i(bm,"."),bm.forEach(t),K1=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Z1=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);J1=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var hj=a(dr);Q1=i(hj,"PreTrainedModel"),hj.forEach(t),e2=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),t2=d(F),ge=s(F,"DIV",{class:!0});var Dn=a(ge);m(Ns.$$.fragment,Dn),n2=d(Dn),Wd=s(Dn,"P",{});var _j=a(Wd);o2=i(_j,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_j.forEach(t),s2=d(Dn),Ud=s(Dn,"P",{});var fj=a(Ud);a2=i(fj,"Examples:"),fj.forEach(t),r2=d(Dn),m(Cs.$$.fragment,Dn),Dn.forEach(t),i2=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),l2=d(An),Hd=s(An,"P",{});var bj=a(Hd);d2=i(bj,"Generates sequences for models with a language modeling head using beam search decoding."),bj.forEach(t),p2=d(An),Vd=s(An,"P",{});var vj=a(Vd);c2=i(vj,"Examples:"),vj.forEach(t),m2=d(An),m(Bs.$$.fragment,An),An.forEach(t),u2=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),g2=d(km),Xd=s(km,"P",{});var yj=a(Xd);h2=i(yj,`compute the transition probabilities of sequences given generation
scores and beam indices`),yj.forEach(t),km.forEach(t),_2=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),f2=d(Gn),Rd=s(Gn,"P",{});var kj=a(Rd);b2=i(kj,"Generates sequences for models with a language modeling head using beam search decoding."),kj.forEach(t),v2=d(Gn),Yd=s(Gn,"P",{});var xj=a(Yd);y2=i(xj,"Examples:"),xj.forEach(t),k2=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),x2=d(F),U=s(F,"DIV",{class:!0});var je=a(U);m(Vs.$$.fragment,je),w2=d(je),Kd=s(je,"P",{});var wj=a(Kd);T2=i(wj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),wj.forEach(t),j2=d(je),vt=s(je,"P",{});var Gr=a(vt);$2=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var Tj=a(Zd);M2=i(Tj,"inputs"),Tj.forEach(t),P2=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var jj=a(pr);E2=i(jj,"PretrainedConfig"),jj.forEach(t),L2=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),q2=d(je),Xs=s(je,"P",{});var xm=a(Xs);F2=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var $j=a(Rs);O2=i($j,`this blog
post`),$j.forEach(t),z2=i(xm,"."),xm.forEach(t),D2=d(je),Jd=s(je,"P",{});var Mj=a(Jd);A2=i(Mj,"Examples:"),Mj.forEach(t),G2=d(je),m(Ys.$$.fragment,je),je.forEach(t),S2=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),N2=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);C2=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),I2=d(Sn),ep=s(Sn,"P",{});var Ej=a(ep);B2=i(Ej,"Examples:"),Ej.forEach(t),W2=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),U2=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),H2=d(Nn),tp=s(Nn,"P",{});var Lj=a(tp);V2=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),X2=d(Nn),np=s(Nn,"P",{});var qj=a(np);R2=i(qj,"Examples:"),qj.forEach(t),Y2=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),K2=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Z2=d(wm),ta=s(wm,"P",{});var Tm=a(ta);J2=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Q2=i(Fj,"PreTrainedModel"),Fj.forEach(t),ek=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tk=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nk=d(Cn),op=s(Cn,"P",{});var Oj=a(op);ok=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),sk=d(Cn),sp=s(Cn,"P",{});var zj=a(sp);ak=i(zj,"Examples:"),zj.forEach(t),rk=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),ik=d(J),aa=s(J,"P",{});var jm=a(aa);lk=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var Dj=a(mr);dk=i(Dj,"TFPreTrainedModel"),Dj.forEach(t),pk=i(jm,"."),jm.forEach(t),ck=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),mk=d($m),ia=s($m,"P",{});var Mm=a(ia);uk=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);gk=i(Aj,"PreTrainedModel"),Aj.forEach(t),hk=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_k=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fk=d(Q),ap=s(Q,"P",{});var Gj=a(ap);bk=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),Sj.forEach(t),xk=i(Pm,"."),Pm.forEach(t),wk=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tk=i(In,"Apart from "),rp=s(In,"CODE",{});var Nj=a(rp);jk=i(Nj,"input_ids"),Nj.forEach(t),$k=i(In," and "),ip=s(In,"CODE",{});var Cj=a(ip);Mk=i(Cj,"attention_mask"),Cj.forEach(t),Pk=i(In,`, all the arguments below will default to the value of the attribute
