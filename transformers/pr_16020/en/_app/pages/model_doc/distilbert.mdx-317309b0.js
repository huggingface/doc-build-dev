...
<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new ye({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),rn=new ve({}),an=new U({props:{name:"class transformers.DistilBertTokenizer",anchor:"transformers.DistilBertTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/tokenization_distilbert.py#L56"}}),dn=new ve({}),cn=new U({props:{name:"class transformers.DistilBertTokenizerFast",anchor:"transformers.DistilBertTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/tokenization_distilbert_fast.py#L65"}}),un=new ve({}),fn=new U({props:{name:"class transformers.DistilBertModel",anchor:"transformers.DistilBertModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_distilbert.py#L435",parametersDescription:[{anchor:"transformers.DistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new U({props:{name:"forward",anchor:"transformers.DistilBertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_distilbert.py#L507",parametersDescription:[{anchor:"transformers.DistilBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),An=new ve({}),In=new U({props:{name:"class transformers.DistilBertForMultipleChoice",anchor:"transformers.DistilBertForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_distilbert.py#L997",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),On=new U({props:{name:"forward",anchor:"transformers.DistilBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_distilbert.py#L1029",parametersDescription:[{anchor:"transformers.DistilBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Rn=new ve({}),Hn=new U({props:{name:"class transformers.DistilBertForTokenClassification",anchor:"transformers.DistilBertForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_distilbert.py#L902",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jn=new U({props:{name:"forward",anchor:"transformers.DistilBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_distilbert.py#L934",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),or=new ve({}),nr=new U({props:{name:"class transformers.TFDistilBertModel",anchor:"transformers.TFDistilBertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L536",parametersDescription:[{anchor:"transformers.TFDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new me({props:{$$slots:{default:[mF]},$$scope:{ctx:j}}}),lr=new U({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L541",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),vr=new ve({}),br=new U({props:{name:"class transformers.TFDistilBertForSequenceClassification",anchor:"transformers.TFDistilBertForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L740",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new me({props:{$$slots:{default:[bF]},$$scope:{ctx:j}}}),$r=new U({props:{name:"call",anchor:"transformers.TFDistilBertForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L757",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Fr=new ve({}),yr=new U({props:{name:"class transformers.TFDistilBertForMultipleChoice",anchor:"transformers.TFDistilBertForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L931",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new me({props:{$$slots:{default:[kF]},$$scope:{ctx:j}}}),zr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L957",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jr=new ve({}),Cr=new U({props:{name:"class transformers.TFDistilBertForTokenClassification",anchor:"transformers.TFDistilBertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L841",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new me({props:{$$slots:{default:[$F]},$$scope:{ctx:j}}}),Ir=new U({props:{name:"call",anchor:"transformers.TFDistilBertForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L852",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Lr=new ve({}),Sr=new U({props:{name:"class transformers.TFDistilBertForQuestionAnswering",anchor:"transformers.TFDistilBertForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1073",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Mo=new me({props:{$$slots:{default:[FF]},$$scope:{ctx:j}}}),Hr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1084",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ua=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Da=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qa=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oi=new U({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/distilbert/modeling_flax_distilbert.py#L450",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh.forEach(t),Wg=d(Ut),Xe=n(Ut,"DIV",{class:!0});var Vt=r(Xe);k(tr.$$.fragment,Vt),Rg=d(Vt),ws=n(Vt,"P",{});var sl=r(ws);Hg=i(sl,"The "),zi=n(sl,"A",{href:!0});var e2=r(zi);Qg=i(e2,"DistilBertForQuestionAnswering"),e2.forEach(t),Ug=i(sl," forward method, overrides the "),sd=n(sl,"CODE",{});var t2=r(sd);Vg=i(t2,"__call__"),t2.forEach(t),Jg=i(sl," special method."),sl.forEach(t),Kg=d(Vt),k(ho.$$.fragment,Vt),Gg=d(Vt),od=n(Vt,"P",{});var s2=r(od);Xg=i(s2,"Example:"),s2.forEach(t),Yg=d(Vt),k(sr.$$.fragment,Vt),Vt.forEach(t),Ut.forEach(t),jp=d(s),$s=n(s,"H2",{class:!0});var Eh=r($s);uo=n(Eh,"A",{id:!0,class:!0,href:!0});var o2=r(uo);nd=n(o2,"SPAN",{});var n2=r(nd);k(or.$$.fragment,n2),n2.forEach(t),o2.forEach(t),Zg=d(Eh),rd=n(Eh,"SPAN",{});var r2=r(rd);e_=i(r2,"TFDistilBertModel"),r2.forEach(t),Eh.forEach(t),Cp=d(s),Pe=n(s,"DIV",{class:!0});var Tt=r(Pe);k(nr.$$.fragment,Tt),t_=d(Tt),ad=n(Tt,"P",{});var a2=r(ad);s_=i(a2,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),a2.forEach(t),o_=d(Tt),rr=n(Tt,"P",{});var Mh=r(rr);n_=i(Mh,"This model inherits from "),xi=n(Mh,"A",{href:!0});var i2=r(xi);r_=i(i2,"TFPreTrainedModel"),i2.forEach(t),a_=i(Mh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mh.forEach(t),i_=d(Tt),ar=n(Tt,"P",{});var zh=r(ar);l_=i(zh,"This model is also a "),ir=n(zh,"A",{href:!0,rel:!0});var l2=r(ir);d_=i(l2,"tf.keras.Model"),l2.forEach(t),c_=i(zh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zh.forEach(t),p_=d(Tt),k(fo.$$.fragment,Tt),h_=d(Tt),Ye=n(Tt,"DIV",{class:!0});var Jt=r(Ye);k(lr.$$.fragment,Jt),u_=d(Jt),Ds=n(Jt,"P",{});var ol=r(Ds);f_=i(ol,"The "),ji=n(ol,"A",{href:!0});var d2=r(ji);m_=i(d2,"TFDistilBertModel"),d2.forEach(t),g_=i(ol," forward method, overrides the "),id=n(ol,"CODE",{});var c2=r(id);__=i(c2,"__call__"),c2.forEach(t),v_=i(ol," special method."),ol.forEach(t),b_=d(Jt),k(mo.$$.fragment,Jt),T_=d(Jt),ld=n(Jt,"P",{});var p2=r(ld);k_=i(p2,"Example:"),p2.forEach(t),w_=d(Jt),k(dr.$$.fragment,Jt),Jt.forEach(t),Tt.forEach(t),Pp=d(s),Fs=n(s,"H2",{class:!0});var xh=r(Fs);go=n(xh,"A",{id:!0,class:!0,href:!0});var h2=r(go);dd=n(h2,"SPAN",{});var u2=r(dd);k(cr.$$.fragment,u2),u2.forEach(t),h2.forEach(t),$_=d(xh),cd=n(xh,"SPAN",{});var f2=r(cd);D_=i(f2,"TFDistilBertForMaskedLM"),f2.forEach(t),xh.forEach(t),qp=d(s),qe=n(s,"DIV",{class:!0});var kt=r(qe);k(pr.$$.fragment,kt),F_=d(kt),hr=n(kt,"P",{});var jh=r(hr);y_=i(jh,"DistilBert Model with a "),pd=n(jh,"CODE",{});var m2=r(pd);B_=i(m2,"masked language modeling"),m2.forEach(t),E_=i(jh," head on top."),jh.forEach(t),M_=d(kt),ur=n(kt,"P",{});var Ch=r(ur);z_=i(Ch,"This model inherits from "),Ci=n(Ch,"A",{href:!0});var g2=r(Ci);x_=i(g2,"TFPreTrainedModel"),g2.forEach(t),j_=i(Ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ch.forEach(t),C_=d(kt),fr=n(kt,"P",{});var Ph=r(fr);P_=i(Ph,"This model is also a "),mr=n(Ph,"A",{href:!0,rel:!0});var _2=r(mr);q_=i(_2,"tf.keras.Model"),_2.forEach(t),A_=i(Ph,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ph.forEach(t),I_=d(kt),k(_o.$$.fragment,kt),N_=d(kt),Ze=n(kt,"DIV",{class:!0});var Kt=r(Ze);k(gr.$$.fragment,Kt),L_=d(Kt),ys=n(Kt,"P",{});var nl=r(ys);S_=i(nl,"The "),Pi=n(nl,"A",{href:!0});var v2=r(Pi);O_=i(v2,"TFDistilBertForMaskedLM"),v2.forEach(t),W_=i(nl," forward method, overrides the "),hd=n(nl,"CODE",{});var b2=r(hd);R_=i(b2,"__call__"),b2.forEach(t),H_=i(nl," special method."),nl.forEach(t),Q_=d(Kt),k(vo.$$.fragment,Kt),U_=d(Kt),ud=n(Kt,"P",{});var T2=r(ud);V_=i(T2,"Example:"),T2.forEach(t),J_=d(Kt),k(_r.$$.fragment,Kt),Kt.forEach(t),kt.forEach(t),Ap=d(s),Bs=n(s,"H2",{class:!0});var qh=r(Bs);bo=n(qh,"A",{id:!0,class:!0,href:!0});var k2=r(bo);fd=n(k2,"SPAN",{});var w2=r(fd);k(vr.$$.fragment,w2),w2.forEach(t),k2.forEach(t),K_=d(qh),md=n(qh,"SPAN",{});var $2=r(md);G_=i($2,"TFDistilBertForSequenceClassification"),$2.forEach(t),qh.forEach(t),Ip=d(s),Ae=n(s,"DIV",{class:!0});var wt=r(Ae);k(br.$$.fragment,wt),X_=d(wt),gd=n(wt,"P",{});var D2=r(gd);Y_=i(D2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),D2.forEach(t),Z_=d(wt),Tr=n(wt,"P",{});var Ah=r(Tr);ev=i(Ah,"This model inherits from "),qi=n(Ah,"A",{href:!0});var F2=r(qi);tv=i(F2,"TFPreTrainedModel"),F2.forEach(t),sv=i(Ah,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ah.forEach(t),ov=d(wt),kr=n(wt,"P",{});var Ih=r(kr);nv=i(Ih,"This model is also a "),wr=n(Ih,"A",{href:!0,rel:!0});var y2=r(wr);rv=i(y2,"tf.keras.Model"),y2.forEach(t),av=i(Ih,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),iv=d(wt),k(To.$$.fragment,wt),lv=d(wt),et=n(wt,"DIV",{class:!0});var Gt=r(et);k($r.$$.fragment,Gt),dv=d(Gt),Es=n(Gt,"P",{});var rl=r(Es);cv=i(rl,"The "),Ai=n(rl,"A",{href:!0});var B2=r(Ai);pv=i(B2,"TFDistilBertForSequenceClassification"),B2.forEach(t),hv=i(rl," forward method, overrides the "),_d=n(rl,"CODE",{});var E2=r(_d);uv=i(E2,"__call__"),E2.forEach(t),fv=i(rl," special method."),rl.forEach(t),mv=d(Gt),k(ko.$$.fragment,Gt),gv=d(Gt),vd=n(Gt,"P",{});var M2=r(vd);_v=i(M2,"Example:"),M2.forEach(t),vv=d(Gt),k(Dr.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Np=d(s),Ms=n(s,"H2",{class:!0});var Nh=r(Ms);wo=n(Nh,"A",{id:!0,class:!0,href:!0});var z2=r(wo);bd=n(z2,"SPAN",{});var x2=r(bd);k(Fr.$$.fragment,x2),x2.forEach(t),z2.forEach(t),bv=d(Nh),Td=n(Nh,"SPAN",{});var j2=r(Td);Tv=i(j2,"TFDistilBertForMultipleChoice"),j2.forEach(t),Nh.forEach(t),Lp=d(s),Ie=n(s,"DIV",{class:!0});var $t=r(Ie);k(yr.$$.fragment,$t),kv=d($t),kd=n($t,"P",{});var C2=r(kd);wv=i(C2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),C2.forEach(t),$v=d($t),Br=n($t,"P",{});var Lh=r(Br);Dv=i(Lh,"This model inherits from "),Ii=n(Lh,"A",{href:!0});var P2=r(Ii);Fv=i(P2,"TFPreTrainedModel"),P2.forEach(t),yv=i(Lh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lh.forEach(t),Bv=d($t),Er=n($t,"P",{});var Sh=r(Er);Ev=i(Sh,"This model is also a "),Mr=n(Sh,"A",{href:!0,rel:!0});var q2=r(Mr);Mv=i(q2,"tf.keras.Model"),q2.forEach(t),zv=i(Sh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sh.forEach(t),xv=d($t),k($o.$$.fragment,$t),jv=d($t),tt=n($t,"DIV",{class:!0});var Xt=r(tt);k(zr.$$.fragment,Xt),Cv=d(Xt),zs=n(Xt,"P",{});var al=r(zs);Pv=i(al,"The "),Ni=n(al,"A",{href:!0});var A2=r(Ni);qv=i(A2,"TFDistilBertForMultipleChoice"),A2.forEach(t),Av=i(al," forward method, overrides the "),wd=n(al,"CODE",{});var I2=r(wd);Iv=i(I2,"__call__"),I2.forEach(t),Nv=i(al," special method."),al.forEach(t),Lv=d(Xt),k(Do.$$.fragment,Xt),Sv=d(Xt),$d=n(Xt,"P",{});var N2=r($d);Ov=i(N2,"Example:"),N2.forEach(t),Wv=d(Xt),k(xr.$$.fragment,Xt),Xt.forEach(t),$t.forEach(t),Sp=d(s),xs=n(s,"H2",{class:!0});var Oh=r(xs);Fo=n(Oh,"A",{id:!0,class:!0,href:!0});var L2=r(Fo);Dd=n(L2,"SPAN",{});var S2=r(Dd);k(jr.$$.fragment,S2),S2.forEach(t),L2.forEach(t),Rv=d(Oh),Fd=n(Oh,"SPAN",{});var O2=r(Fd);Hv=i(O2,"TFDistilBertForTokenClassification"),O2.forEach(t),Oh.forEach(t),Op=d(s),Ne=n(s,"DIV",{class:!0});var Dt=r(Ne);k(Cr.$$.fragment,Dt),Qv=d(Dt),yd=n(Dt,"P",{});var W2=r(yd);Uv=i(W2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),W2.forEach(t),Vv=d(Dt),Pr=n(Dt,"P",{});var Wh=r(Pr);Jv=i(Wh,"This model inherits from "),Li=n(Wh,"A",{href:!0});var R2=r(Li);Kv=i(R2,"TFPreTrainedModel"),R2.forEach(t),Gv=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),Xv=d(Dt),qr=n(Dt,"P",{});var Rh=r(qr);Yv=i(Rh,"This model is also a "),Ar=n(Rh,"A",{href:!0,rel:!0});var H2=r(Ar);Zv=i(H2,"tf.keras.Model"),H2.forEach(t),eb=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),tb=d(Dt),k(yo.$$.fragment,Dt),sb=d(Dt),st=n(Dt,"DIV",{class:!0});var Yt=r(st);k(Ir.$$.fragment,Yt),ob=d(Yt),js=n(Yt,"P",{});var il=r(js);nb=i(il,"The "),Si=n(il,"A",{href:!0});var Q2=r(Si);rb=i(Q2,"TFDistilBertForTokenClassification"),Q2.forEach(t),ab=i(il," forward method, overrides the "),Bd=n(il,"CODE",{});var U2=r(Bd);ib=i(U2,"__call__"),U2.forEach(t),lb=i(il," special method."),il.forEach(t),db=d(Yt),k(Bo.$$.fragment,Yt),cb=d(Yt),Ed=n(Yt,"P",{});var V2=r(Ed);pb=i(V2,"Example:"),V2.forEach(t),hb=d(Yt),k(Nr.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),Wp=d(s),Cs=n(s,"H2",{class:!0});var Hh=r(Cs);Eo=n(Hh,"A",{id:!0,class:!0,href:!0});var J2=r(Eo);Md=n(J2,"SPAN",{});var K2=r(Md);k(Lr.$$.fragment,K2),K2.forEach(t),J2.forEach(t),ub=d(Hh),zd=n(Hh,"SPAN",{});var G2=r(zd);fb=i(G2,"TFDistilBertForQuestionAnswering"),G2.forEach(t),Hh.forEach(t),Rp=d(s),Le=n(s,"DIV",{class:!0});var Ft=r(Le);k(Sr.$$.fragment,Ft),mb=d(Ft),Ps=n(Ft,"P",{});var ll=r(Ps);gb=i(ll,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),xd=n(ll,"CODE",{});var X2=r(xd);_b=i(X2,"span start logits"),X2.forEach(t),vb=i(ll," and "),jd=n(ll,"CODE",{});var Y2=r(jd);bb=i(Y2,"span end logits"),Y2.forEach(t),Tb=i(ll,")."),ll.forEach(t),kb=d(Ft),Or=n(Ft,"P",{});var Qh=r(Or);wb=i(Qh,"This model inherits from "),Oi=n(Qh,"A",{href:!0});var Z2=r(Oi);$b=i(Z2,"TFPreTrainedModel"),Z2.forEach(t),Db=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qh.forEach(t),Fb=d(Ft),Wr=n(Ft,"P",{});var Uh=r(Wr);yb=i(Uh,"This model is also a "),Rr=n(Uh,"A",{href:!0,rel:!0});var e$=r(Rr);Bb=i(e$,"tf.keras.Model"),e$.forEach(t),Eb=i(Uh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),Mb=d(Ft),k(Mo.$$.fragment,Ft),zb=d(Ft),ot=n(Ft,"DIV",{class:!0});var Zt=r(ot);k(Hr.$$.fragment,Zt),xb=d(Zt),qs=n(Zt,"P",{});var dl=r(qs);jb=i(dl,"The "),Wi=n(dl,"A",{href:!0});var t$=r(Wi);Cb=i(t$,"TFDistilBertForQuestionAnswering"),t$.forEach(t),Pb=i(dl," forward method, overrides the "),Cd=n(dl,"CODE",{});var s$=r(Cd);qb=i(s$,"__call__"),s$.forEach(t),Ab=i(dl," special method."),dl.forEach(t),Ib=d(Zt),k(zo.$$.fragment,Zt),Nb=d(Zt),Pd=n(Zt,"P",{});var o$=r(Pd);Lb=i(o$,"Example:"),o$.forEach(t),Sb=d(Zt),k(Qr.$$.fragment,Zt),Zt.forEach(t),Ft.forEach(t),Hp=d(s),As=n(s,"H2",{class:!0});var Vh=r(As);xo=n(Vh,"A",{id:!0,class:!0,href:!0});var n$=r(xo);qd=n(n$,"SPAN",{});var r$=r(qd);k(Ur.$$.fragment,r$),r$.forEach(t),n$.forEach(t),Ob=d(Vh),Ad=n(Vh,"SPAN",{});var a$=r(Ad);Wb=i(a$,"FlaxDistilBertModel"),a$.forEach(t),Vh.forEach(t),Qp=d(s),Be=n(s,"DIV",{class:!0});var pt=r(Be);k(Vr.$$.fragment,pt),Rb=d(pt),Id=n(pt,"P",{});var i$=r(Id);Hb=i(i$,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i$.forEach(t),Qb=d(pt),Jr=n(pt,"P",{});var Jh=r(Jr);Ub=i(Jh,"This model inherits from "),Ri=n(Jh,"A",{href:!0});var l$=r(Ri);Vb=i(l$,"FlaxPreTrainedModel"),l$.forEach(t),Jb=i(Jh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Jh.forEach(t),Kb=d(pt),Kr=n(pt,"P",{});var Kh=r(Kr);Gb=i(Kh,"This model is also a Flax Linen "),Gr=n(Kh,"A",{href:!0,rel:!0});var d$=r(Gr);Xb=i(d$,"flax.linen.Module"),d$.forEach(t),Yb=i(Kh,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kh.forEach(t),Zb=d(pt),Nd=n(pt,"P",{});var c$=r(Nd);e1=i(c$,"Finally, this model supports inherent JAX features such as:"),c$.forEach(t),t1=d(pt),Bt=n(pt,"UL",{});var Uo=r(Bt);Ld=n(Uo,"LI",{});var p$=r(Ld);Xr=n(p$,"A",{href:!0,rel:!0});var h$=r(Xr);s1=i(h$,"Just-In-Time (JIT) compilation"),h$.forEach(t),p$.forEach(t),o1=d(Uo),Sd=n(Uo,"LI",{});var u$=r(Sd);Yr=n(u$,"A",{href:!0,rel:!0});var f$=r(Yr);n1=i(f$,"Automatic Differentiation"),f$.forEach(t),u$.forEach(t),r1=d(Uo),Od=n(Uo,"LI",{});var m$=r(Od);Zr=n(m$,"A",{href:!0,rel:!0});var g$=r(Zr);a1=i(g$,"Vectorization"),g$.forEach(t),m$.forEach(t),i1=d(Uo),Wd=n(Uo,"LI",{});var _$=r(Wd);ea=n(_$,"A",{href:!0,rel:!0});var v$=r(ea);l1=i(v$,"Parallelization"),v$.forEach(t),_$.forEach(t),Uo.forEach(t),d1=d(pt),nt=n(pt,"DIV",{class:!0});var es=r(nt);k(ta.$$.fragment,es),c1=d(es),Is=n(es,"P",{});var cl=r(Is);p1=i(cl,"The "),Rd=n(cl,"CODE",{});var b$=r(Rd);h1=i(b$,"FlaxDistilBertPreTrainedModel"),b$.forEach(t),u1=i(cl,"forward method, overrides the "),Hd=n(cl,"CODE",{});var T$=r(Hd);f1=i(T$,"__call__"),T$.forEach(t),m1=i(cl," special method."),cl.forEach(t),g1=d(es),k(jo.$$.fragment,es),_1=d(es),Qd=n(es,"P",{});var k$=r(Qd);v1=i(k$,"Example:"),k$.forEach(t),b1=d(es),k(sa.$$.fragment,es),es.forEach(t),pt.forEach(t),Up=d(s),Ns=n(s,"H2",{class:!0});var Gh=r(Ns);Co=n(Gh,"A",{id:!0,class:!0,href:!0});var w$=r(Co);Ud=n(w$,"SPAN",{});var $$=r(Ud);k(oa.$$.fragment,$$),$$.forEach(t),w$.forEach(t),T1=d(Gh),Vd=n(Gh,"SPAN",{});var D$=r(Vd);k1=i(D$,"FlaxDistilBertForMaskedLM"),D$.forEach(t),Gh.forEach(t),Vp=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(na.$$.fragment,ht),w1=d(ht),ra=n(ht,"P",{});var Xh=r(ra);$1=i(Xh,"DistilBert Model with a "),Jd=n(Xh,"CODE",{});var F$=r(Jd);D1=i(F$,"language modeling"),F$.forEach(t),F1=i(Xh," head on top."),Xh.forEach(t),y1=d(ht),aa=n(ht,"P",{});var Yh=r(aa);B1=i(Yh,"This model inherits from "),Hi=n(Yh,"A",{href:!0});var y$=r(Hi);E1=i(y$,"FlaxPreTrainedModel"),y$.forEach(t),M1=i(Yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yh.forEach(t),z1=d(ht),ia=n(ht,"P",{});var Zh=r(ia);x1=i(Zh,"This model is also a Flax Linen "),la=n(Zh,"A",{href:!0,rel:!0});var B$=r(la);j1=i(B$,"flax.linen.Module"),B$.forEach(t),C1=i(Zh,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zh.forEach(t),P1=d(ht),Kd=n(ht,"P",{});var E$=r(Kd);q1=i(E$,"Finally, this model supports inherent JAX features such as:"),E$.forEach(t),A1=d(ht),Et=n(ht,"UL",{});var Vo=r(Et);Gd=n(Vo,"LI",{});var M$=r(Gd);da=n(M$,"A",{href:!0,rel:!0});var z$=r(da);I1=i(z$,"Just-In-Time (JIT) compilation"),z$.forEach(t),M$.forEach(t),N1=d(Vo),Xd=n(Vo,"LI",{});var x$=r(Xd);ca=n(x$,"A",{href:!0,rel:!0});var j$=r(ca);L1=i(j$,"Automatic Differentiation"),j$.forEach(t),x$.forEach(t),S1=d(Vo),Yd=n(Vo,"LI",{});var C$=r(Yd);pa=n(C$,"A",{href:!0,rel:!0});var P$=r(pa);O1=i(P$,"Vectorization"),P$.forEach(t),C$.forEach(t),W1=d(Vo),Zd=n(Vo,"LI",{});var q$=r(Zd);ha=n(q$,"A",{href:!0,rel:!0});var A$=r(ha);R1=i(A$,"Parallelization"),A$.forEach(t),q$.forEach(t),Vo.forEach(t),H1=d(ht),rt=n(ht,"DIV",{class:!0});var ts=r(rt);k(ua.$$.fragment,ts),Q1=d(ts),Ls=n(ts,"P",{});var pl=r(Ls);U1=i(pl,"The "),ec=n(pl,"CODE",{});var I$=r(ec);V1=i(I$,"FlaxDistilBertPreTrainedModel"),I$.forEach(t),J1=i(pl,"forward method, overrides the "),tc=n(pl,"CODE",{});var N$=r(tc);K1=i(N$,"__call__"),N$.forEach(t),G1=i(pl," special method."),pl.forEach(t),X1=d(ts),k(Po.$$.fragment,ts),Y1=d(ts),sc=n(ts,"P",{});var L$=r(sc);Z1=i(L$,"Example:"),L$.forEach(t),eT=d(ts),k(fa.$$.fragment,ts),ts.forEach(t),ht.forEach(t),Jp=d(s),Ss=n(s,"H2",{class:!0});var eu=r(Ss);qo=n(eu,"A",{id:!0,class:!0,href:!0});var S$=r(qo);oc=n(S$,"SPAN",{});var O$=r(oc);k(ma.$$.fragment,O$),O$.forEach(t),S$.forEach(t),tT=d(eu),nc=n(eu,"SPAN",{});var W$=r(nc);sT=i(W$,"FlaxDistilBertForSequenceClassification"),W$.forEach(t),eu.forEach(t),Kp=d(s),Me=n(s,"DIV",{class:!0});var ut=r(Me);k(ga.$$.fragment,ut),oT=d(ut),rc=n(ut,"P",{});var R$=r(rc);nT=i(R$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tu.forEach(t),dT=d(ut),va=n(ut,"P",{});var su=r(va);cT=i(su,"This model is also a Flax Linen "),ba=n(su,"A",{href:!0,rel:!0});var Q$=r(ba);pT=i(Q$,"flax.linen.Module"),Q$.forEach(t),hT=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),uT=d(ut),ac=n(ut,"P",{});var U$=r(ac);fT=i(U$,"Finally, this model supports inherent JAX features such as:"),U$.forEach(t),mT=d(ut),Mt=n(ut,"UL",{});var Jo=r(Mt);ic=n(Jo,"LI",{});var V$=r(ic);Ta=n(V$,"A",{href:!0,rel:!0});var J$=r(Ta);gT=i(J$,"Just-In-Time (JIT) compilation"),J$.forEach(t),V$.forEach(t),_T=d(Jo),lc=n(Jo,"LI",{});var K$=r(lc);ka=n(K$,"A",{href:!0,rel:!0});var G$=r(ka);vT=i(G$,"Automatic Differentiation"),G$.forEach(t),K$.forEach(t),bT=d(Jo),dc=n(Jo,"LI",{});var X$=r(dc);wa=n(X$,"A",{href:!0,rel:!0});var Y$=r(wa);TT=i(Y$,"Vectorization"),Y$.forEach(t),X$.forEach(t),kT=d(Jo),cc=n(Jo,"LI",{});var Z$=r(cc);$a=n(Z$,"A",{href:!0,rel:!0});var eD=r($a);wT=i(eD,"Parallelization"),eD.forEach(t),Z$.forEach(t),Jo.forEach(t),$T=d(ut),at=n(ut,"DIV",{class:!0});var ss=r(at);k(Da.$$.fragment,ss),DT=d(ss),Os=n(ss,"P",{});var hl=r(Os);FT=i(hl,"The "),pc=n(hl,"CODE",{});var tD=r(pc);yT=i(tD,"FlaxDistilBertPreTrainedModel"),tD.forEach(t),BT=i(hl,"forward method, overrides the "),hc=n(hl,"CODE",{});var sD=r(hc);ET=i(sD,"__call__"),sD.forEach(t),MT=i(hl," special method."),hl.forEach(t),zT=d(ss),k(Ao.$$.fragment,ss),xT=d(ss),uc=n(ss,"P",{});var oD=r(uc);jT=i(oD,"Example:"),oD.forEach(t),CT=d(ss),k(Fa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),Gp=d(s),Ws=n(s,"H2",{class:!0});var ou=r(Ws);Io=n(ou,"A",{id:!0,class:!0,href:!0});var nD=r(Io);fc=n(nD,"SPAN",{});var rD=r(fc);k(ya.$$.fragment,rD),rD.forEach(t),nD.forEach(t),PT=d(ou),mc=n(ou,"SPAN",{});var aD=r(mc);qT=i(aD,"FlaxDistilBertForMultipleChoice"),aD.forEach(t),ou.forEach(t),Xp=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);k(Ba.$$.fragment,ft),AT=d(ft),gc=n(ft,"P",{});var iD=r(gc);IT=i(iD,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ru.forEach(t),UT=d(ft),_c=n(ft,"P",{});var cD=r(_c);VT=i(cD,"Finally, this model supports inherent JAX features such as:"),cD.forEach(t),JT=d(ft),zt=n(ft,"UL",{});var Ko=r(zt);vc=n(Ko,"LI",{});var pD=r(vc);xa=n(pD,"A",{href:!0,rel:!0});var hD=r(xa);KT=i(hD,"Just-In-Time (JIT) compilation"),hD.forEach(t),pD.forEach(t),GT=d(Ko),bc=n(Ko,"LI",{});var uD=r(bc);ja=n(uD,"A",{href:!0,rel:!0});var fD=r(ja);XT=i(fD,"Automatic Differentiation"),fD.forEach(t),uD.forEach(t),YT=d(Ko),Tc=n(Ko,"LI",{});var mD=r(Tc);Ca=n(mD,"A",{href:!0,rel:!0});var gD=r(Ca);ZT=i(gD,"Vectorization"),gD.forEach(t),mD.forEach(t),ek=d(Ko),kc=n(Ko,"LI",{});var _D=r(kc);Pa=n(_D,"A",{href:!0,rel:!0});var vD=r(Pa);tk=i(vD,"Parallelization"),vD.forEach(t),_D.forEach(t),Ko.forEach(t),sk=d(ft),it=n(ft,"DIV",{class:!0});var os=r(it);k(qa.$$.fragment,os),ok=d(os),Rs=n(os,"P",{});var ul=r(Rs);nk=i(ul,"The "),wc=n(ul,"CODE",{});var bD=r(wc);rk=i(bD,"FlaxDistilBertPreTrainedModel"),bD.forEach(t),ak=i(ul,"forward method, overrides the "),$c=n(ul,"CODE",{});var TD=r($c);ik=i(TD,"__call__"),TD.forEach(t),lk=i(ul," special method."),ul.forEach(t),dk=d(os),k(No.$$.fragment,os),ck=d(os),Dc=n(os,"P",{});var kD=r(Dc);pk=i(kD,"Example:"),kD.forEach(t),hk=d(os),k(Aa.$$.fragment,os),os.forEach(t),ft.forEach(t),Yp=d(s),Hs=n(s,"H2",{class:!0});var au=r(Hs);Lo=n(au,"A",{id:!0,class:!0,href:!0});var wD=r(Lo);Fc=n(wD,"SPAN",{});var $D=r(Fc);k(Ia.$$.fragment,$D),$D.forEach(t),wD.forEach(t),uk=d(au),yc=n(au,"SPAN",{});var DD=r(yc);fk=i(DD,"FlaxDistilBertForTokenClassification"),DD.forEach(t),au.forEach(t),Zp=d(s),xe=n(s,"DIV",{class:!0});var mt=r(xe);k(Na.$$.fragment,mt),mk=d(mt),Bc=n(mt,"P",{});var FD=r(Bc);gk=i(FD,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Fk=d(mt),Ec=n(mt,"P",{});var ED=r(Ec);yk=i(ED,"Finally, this model supports inherent JAX features such as:"),ED.forEach(t),Bk=d(mt),xt=n(mt,"UL",{});var Go=r(xt);Mc=n(Go,"LI",{});var MD=r(Mc);Wa=n(MD,"A",{href:!0,rel:!0});var zD=r(Wa);Ek=i(zD,"Just-In-Time (JIT) compilation"),zD.forEach(t),MD.forEach(t),Mk=d(Go),zc=n(Go,"LI",{});var xD=r(zc);Ra=n(xD,"A",{href:!0,rel:!0});var jD=r(Ra);zk=i(jD,"Automatic Differentiation"),jD.forEach(t),xD.forEach(t),xk=d(Go),xc=n(Go,"LI",{});var CD=r(xc);Ha=n(CD,"A",{href:!0,rel:!0});var PD=r(Ha);jk=i(PD,"Vectorization"),PD.forEach(t),CD.forEach(t),Ck=d(Go),jc=n(Go,"LI",{});var qD=r(jc);Qa=n(qD,"A",{href:!0,rel:!0});var AD=r(Qa);Pk=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Go.forEach(t),qk=d(mt),lt=n(mt,"DIV",{class:!0});var ns=r(lt);k(Ua.$$.fragment,ns),Ak=d(ns),Qs=n(ns,"P",{});var fl=r(Qs);Ik=i(fl,"The "),Cc=n(fl,"CODE",{});var ID=r(Cc);Nk=i(ID,"FlaxDistilBertPreTrainedModel"),ID.forEach(t),Lk=i(fl,"forward method, overrides the "),Pc=n(fl,"CODE",{});var ND=r(Pc);Sk=i(ND,"__call__"),ND.forEach(t),Ok=i(fl," special method."),fl.forEach(t),Wk=d(ns),k(So.$$.fragment,ns),Rk=d(ns),qc=n(ns,"P",{});var LD=r(qc);Hk=i(LD,"Example:"),LD.forEach(t),Qk=d(ns),k(Va.$$.fragment,ns),ns.forEach(t),mt.forEach(t),eh=d(s),Us=n(s,"H2",{class:!0});var du=r(Us);Oo=n(du,"A",{id:!0,class:!0,href:!0});var SD=r(Oo);Ac=n(SD,"SPAN",{});var OD=r(Ac);k(Ja.$$.fragment,OD),OD.forEach(t),SD.forEach(t),Uk=d(du),Ic=n(du,"SPAN",{});var WD=r(Ic);Vk=i(WD,"FlaxDistilBertForQuestionAnswering"),WD.forEach(t),du.forEach(t),th=d(s),je=n(s,"DIV",{class:!0});var gt=r(je);k(Ka.$$.fragment,gt),Jk=d(gt),Vs=n(gt,"P",{});var ml=r(Vs);Kk=i(ml,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Nc=n(ml,"CODE",{});var RD=r(Nc);Gk=i(RD,"span start logits"),RD.forEach(t),Xk=i(ml," and "),Lc=n(ml,"CODE",{});var HD=r(Lc);Yk=i(HD,"span end logits"),HD.forEach(t),Zk=i(ml,")."),ml.forEach(t),ew=d(gt),Ga=n(gt,"P",{});var cu=r(Ga);tw=i(cu,"This model inherits from "),Ji=n(cu,"A",{href:!0});var QD=r(Ji);sw=i(QD,"FlaxPreTrainedModel"),QD.forEach(t),ow=i(cu,`. Check the superclass documentation for the generic methods the
