...
`,returnType:`
<p><code>List[int]</code></p>
`}}),_a=new B({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/tokenization_mbart_fast.py#L251"}}),ga=new B({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/tokenization_mbart_fast.py#L266"}}),ka=new U({}),ba=new B({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50.py#L48",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new B({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ea=new B({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),Pa=new B({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),Ca=new U({}),Aa=new B({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L57",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new B({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Wa=new B({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L221"}}),Ua=new B({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L236"}}),Xa=new U({}),Ha=new B({props:{name:"class transformers.MBartModel",anchor:"transformers.MBartModel",parameters:[{name:"config",val:": MBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1123",parametersDescription:[{anchor:"transformers.MBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ka=new B({props:{name:"forward",anchor:"transformers.MBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1150",parametersDescription:[{anchor:"transformers.MBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ya=new U({}),es=new B({props:{name:"class transformers.MBartForConditionalGeneration",anchor:"transformers.MBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1239",parametersDescription:[{anchor:"transformers.MBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),as=new B({props:{name:"forward",anchor:"transformers.MBartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1283",parametersDescription:[{anchor:"transformers.MBartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predictions).split()`}}),is=new U({}),ds=new B({props:{name:"class transformers.MBartForQuestionAnswering",anchor:"transformers.MBartForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1538",parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hs=new B({props:{name:"forward",anchor:"transformers.MBartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1550",parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),ms=new U({}),fs=new B({props:{name:"class transformers.MBartForSequenceClassification",anchor:"transformers.MBartForSequenceClassification",parameters:[{name:"config",val:": MBartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1412",parametersDescription:[{anchor:"transformers.MBartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new B({props:{name:"forward",anchor:"transformers.MBartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1425",parametersDescription:[{anchor:"transformers.MBartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ts=new U({}),Ms=new B({props:{name:"class transformers.MBartForCausalLM",anchor:"transformers.MBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1669"}}),ws=new B({props:{name:"forward",anchor:"transformers.MBartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1700",parametersDescription:[{anchor:"transformers.MBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new B({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_tf_mbart.py#L1302",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16020/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Rz]},$$scope:{ctx:E}}}),Ns=new B({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_tf_mbart.py#L1335",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),_r=new B({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_flax_mbart.py#L1343",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16020/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16020/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16020/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16020/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16020/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
target text format is `),Ve=a(jt,"CODE",{});var t1=s(Ve);Kt=i(t1,"[tgt_lang_code] X [eos]"),t1.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o1=s(rd);Pu=i(o1,"bos"),o1.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Au=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var U0=s(Cn);id=a(U0,"STRONG",{});var n1=s(id);Su=i(n1,"call"),n1.forEach(t),Iu=i(U0,"()"),U0.forEach(t),Nu=i(Ei,` will encode source text format, and it should be wrapped
...
adding special tokens. An MBART sequence has the following format, where `),Id=a(yh,"CODE",{});var Y1=s(Id);bf=i(Y1,"X"),Y1.forEach(t),vf=i(yh," represents the sequence:"),yh.forEach(t),yf=l(xn),oa=a(xn,"UL",{});var Th=s(oa);na=a(Th,"LI",{});var Mh=s(na);Nd=a(Mh,"CODE",{});var eM=s(Nd);Tf=i(eM,"input_ids"),eM.forEach(t),Mf=i(Mh," (for encoder) "),Od=a(Mh,"CODE",{});var tM=s(Od);wf=i(tM,"X [eos, src_lang_code]"),tM.forEach(t),Mh.forEach(t),zf=l(Th),aa=a(Th,"LI",{});var wh=s(aa);Dd=a(wh,"CODE",{});var oM=s(Dd);xf=i(oM,"decoder_input_ids"),oM.forEach(t),Bf=i(wh,": (for decoder) "),Ld=a(wh,"CODE",{});var nM=s(Ld);qf=i(nM,"X [eos, tgt_lang_code]"),nM.forEach(t),wh.forEach(t),Th.forEach(t),$f=l(xn),Gd=a(xn,"P",{});var aM=s(Gd);Ff=i(aM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),aM.forEach(t),xn.forEach(t),he.forEach(t),Sp=l(o),so=a(o,"H2",{class:!0});var zh=s(so);Lo=a(zh,"A",{id:!0,class:!0,href:!0});var sM=s(Lo);Rd=a(sM,"SPAN",{});var rM=s(Rd);f(sa.$$.fragment,rM),rM.forEach(t),sM.forEach(t),jf=l(zh),Wd=a(zh,"SPAN",{});var iM=s(Wd);Ef=i(iM,"MBartTokenizerFast"),iM.forEach(t),zh.forEach(t),Ip=l(o),C=a(o,"DIV",{class:!0});var H=s(C);f(ra.$$.fragment,H),Pf=l(H),ro=a(H,"P",{});var Ii=s(ro);Cf=i(Ii,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ud=a(Ii,"EM",{});var dM=s(Ud);Af=i(dM,"tokenizers"),dM.forEach(t),Sf=i(Ii,` library). Based on
`),ia=a(Ii,"A",{href:!0,rel:!0});var lM=s(ia);If=i(lM,"BPE"),lM.forEach(t),Nf=i(Ii,"."),Ii.forEach(t),Of=l(H),yt=a(H,"P",{});var Kr=s(yt);pi=a(Kr,"A",{href:!0});var cM=s(pi);Df=i(cM,"MBartTokenizerFast"),cM.forEach(t),Lf=i(Kr," is a subclass of "),hi=a(Kr,"A",{href:!0});var pM=s(hi);Gf=i(pM,"XLMRobertaTokenizerFast"),pM.forEach(t),Rf=i(Kr,`. Refer to superclass
`),ui=a(Kr,"A",{href:!0});var hM=s(ui);Wf=i(hM,"XLMRobertaTokenizerFast"),hM.forEach(t),Uf=i(Kr,` for usage examples and documentation concerning the initialization parameters and other
methods.`),Kr.forEach(t),Xf=l(H),da=a(H,"P",{});var xh=s(da);Hf=i(xh,"The tokenization method is "),Xd=a(xh,"CODE",{});var uM=s(Xd);Vf=i(uM,"<tokens> <eos> <language code>"),uM.forEach(t),Qf=i(xh," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),xh.forEach(t),Jf=l(H),Hd=a(H,"P",{});var mM=s(Hd);Kf=i(mM,"Examples:"),mM.forEach(t),Zf=l(H),f(la.$$.fragment,H),Yf=l(H),Pe=a(H,"DIV",{class:!0});var Pt=s(Pe);f(ca.$$.fragment,Pt),e_=l(Pt),Vd=a(Pt,"P",{});var fM=s(Vd);t_=i(fM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),fM.forEach(t),o_=l(Pt),pa=a(Pt,"P",{});var Bh=s(pa);n_=i(Bh,"An MBART sequence has the following format, where "),Qd=a(Bh,"CODE",{});var _M=s(Qd);a_=i(_M,"X"),_M.forEach(t),s_=i(Bh," represents the sequence:"),Bh.forEach(t),r_=l(Pt),ha=a(Pt,"UL",{});var qh=s(ha);ua=a(qh,"LI",{});var $h=s(ua);Jd=a($h,"CODE",{});var gM=s(Jd);i_=i(gM,"input_ids"),gM.forEach(t),d_=i($h," (for encoder) "),Kd=a($h,"CODE",{});var kM=s(Kd);l_=i(kM,"X [eos, src_lang_code]"),kM.forEach(t),$h.forEach(t),c_=l(qh),ma=a(qh,"LI",{});var Fh=s(ma);Zd=a(Fh,"CODE",{});var bM=s(Zd);p_=i(bM,"decoder_input_ids"),bM.forEach(t),h_=i(Fh,": (for decoder) "),Yd=a(Fh,"CODE",{});var vM=s(Yd);u_=i(vM,"X [eos, tgt_lang_code]"),vM.forEach(t),Fh.forEach(t),qh.forEach(t),m_=l(Pt),el=a(Pt,"P",{});var yM=s(el);f_=i(yM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
make use of token type ids, therefore a list of zeros is returned.`),TM.forEach(t),jh.forEach(t),b_=l(H),Ro=a(H,"DIV",{class:!0});var Eh=s(Ro);f(_a.$$.fragment,Eh),v_=l(Eh),ol=a(Eh,"P",{});var MM=s(ol);y_=i(MM,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),MM.forEach(t),Eh.forEach(t),T_=l(H),Wo=a(H,"DIV",{class:!0});var Ph=s(Wo);f(ga.$$.fragment,Ph),M_=l(Ph),nl=a(Ph,"P",{});var wM=s(nl);w_=i(wM,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),wM.forEach(t),Ph.forEach(t),H.forEach(t),Np=l(o),io=a(o,"H2",{class:!0});var Ch=s(io);Uo=a(Ch,"A",{id:!0,class:!0,href:!0});var zM=s(Uo);al=a(zM,"SPAN",{});var xM=s(al);f(ka.$$.fragment,xM),xM.forEach(t),zM.forEach(t),z_=l(Ch),sl=a(Ch,"SPAN",{});var BM=s(sl);x_=i(BM,"MBart50Tokenizer"),BM.forEach(t),Ch.forEach(t),Op=l(o),A=a(o,"DIV",{class:!0});var V=s(A);f(ba.$$.fragment,V),B_=l(V),va=a(V,"P",{});var Ah=s(va);q_=i(Ah,"Construct a MBart50 tokenizer. Based on "),ya=a(Ah,"A",{href:!0,rel:!0});var qM=s(ya);$_=i(qM,"SentencePiece"),qM.forEach(t),F_=i(Ah,"."),Ah.forEach(t),j_=l(V),Ta=a(V,"P",{});var Sh=s(Ta);E_=i(Sh,"This tokenizer inherits from "),mi=a(Sh,"A",{href:!0});var $M=s(mi);P_=i($M,"PreTrainedTokenizer"),$M.forEach(t),C_=i(Sh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Sh.forEach(t),A_=l(V),rl=a(V,"P",{});var FM=s(rl);S_=i(FM,"Examples:"),FM.forEach(t),I_=l(V),f(Ma.$$.fragment,V),N_=l(V),ot=a(V,"DIV",{class:!0});var Bn=s(ot);f(wa.$$.fragment,Bn),O_=l(Bn),za=a(Bn,"P",{});var Ih=s(za);D_=i(Ih,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),il=a(Ih,"CODE",{});var jM=s(il);L_=i(jM,"X"),jM.forEach(t),G_=i(Ih," represents the sequence:"),Ih.forEach(t),R_=l(Bn),xa=a(Bn,"UL",{});var Nh=s(xa);Ba=a(Nh,"LI",{});var Oh=s(Ba);dl=a(Oh,"CODE",{});var EM=s(dl);W_=i(EM,"input_ids"),EM.forEach(t),U_=i(Oh," (for encoder) "),ll=a(Oh,"CODE",{});var PM=s(ll);X_=i(PM,"[src_lang_code] X [eos]"),PM.forEach(t),Oh.forEach(t),H_=l(Nh),qa=a(Nh,"LI",{});var Dh=s(qa);cl=a(Dh,"CODE",{});var CM=s(cl);V_=i(CM,"labels"),CM.forEach(t),Q_=i(Dh,": (for decoder) "),pl=a(Dh,"CODE",{});var AM=s(pl);J_=i(AM,"[tgt_lang_code] X [eos]"),AM.forEach(t),Dh.forEach(t),Nh.forEach(t),K_=l(Bn),hl=a(Bn,"P",{});var SM=s(hl);Z_=i(SM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),SM.forEach(t),Bn.forEach(t),Y_=l(V),Xo=a(V,"DIV",{class:!0});var Lh=s(Xo);f($a.$$.fragment,Lh),eg=l(Lh),ul=a(Lh,"P",{});var IM=s(ul);tg=i(IM,"Converts a sequence of tokens (strings for sub-words) in a single string."),IM.forEach(t),Lh.forEach(t),og=l(V),Ho=a(V,"DIV",{class:!0});var Gh=s(Ho);f(Fa.$$.fragment,Gh),ng=l(Gh),ja=a(Gh,"P",{});var Rh=s(ja);ag=i(Rh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ml=a(Rh,"CODE",{});var NM=s(ml);sg=i(NM,"prepare_for_model"),NM.forEach(t),rg=i(Rh," method."),Rh.forEach(t),Gh.forEach(t),ig=l(V),Vo=a(V,"DIV",{class:!0});var Wh=s(Vo);f(Ea.$$.fragment,Wh),dg=l(Wh),fl=a(Wh,"P",{});var OM=s(fl);lg=i(OM,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),OM.forEach(t),Wh.forEach(t),cg=l(V),Qo=a(V,"DIV",{class:!0});var Uh=s(Qo);f(Pa.$$.fragment,Uh),pg=l(Uh),_l=a(Uh,"P",{});var DM=s(_l);hg=i(DM,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),DM.forEach(t),Uh.forEach(t),V.forEach(t),Dp=l(o),lo=a(o,"H2",{class:!0});var Xh=s(lo);Jo=a(Xh,"A",{id:!0,class:!0,href:!0});var LM=s(Jo);gl=a(LM,"SPAN",{});var GM=s(gl);f(Ca.$$.fragment,GM),GM.forEach(t),LM.forEach(t),ug=l(Xh),kl=a(Xh,"SPAN",{});var RM=s(kl);mg=i(RM,"MBart50TokenizerFast"),RM.forEach(t),Xh.forEach(t),Lp=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Aa.$$.fragment,ue),fg=l(ue),co=a(ue,"P",{});var Ni=s(co);_g=i(Ni,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ni,"EM",{});var WM=s(bl);gg=i(WM,"tokenizers"),WM.forEach(t),kg=i(Ni,` library). Based on
`),Sa=a(Ni,"A",{href:!0,rel:!0});var UM=s(Sa);bg=i(UM,"BPE"),UM.forEach(t),vg=i(Ni,"."),Ni.forEach(t),yg=l(ue),Ia=a(ue,"P",{});var Hh=s(Ia);Tg=i(Hh,"This tokenizer inherits from "),fi=a(Hh,"A",{href:!0});var XM=s(fi);Mg=i(XM,"PreTrainedTokenizerFast"),XM.forEach(t),wg=i(Hh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hh.forEach(t),zg=l(ue),vl=a(ue,"P",{});var HM=s(vl);xg=i(HM,"Examples:"),HM.forEach(t),Bg=l(ue),f(Na.$$.fragment,ue),qg=l(ue),Ce=a(ue,"DIV",{class:!0});var Ct=s(Ce);f(Oa.$$.fragment,Ct),$g=l(Ct),yl=a(Ct,"P",{});var VM=s(yl);Fg=i(VM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),VM.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var QM=s(Tl);Pg=i(QM,"X"),QM.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Ag=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var JM=s(Ml);Sg=i(JM,"input_ids"),JM.forEach(t),Ig=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var KM=s(wl);Ng=i(KM,"[src_lang_code] X [eos]"),KM.forEach(t),Jh.forEach(t),Og=l(Qh),Ra=a(Qh,"LI",{});var Kh=s(Ra);zl=a(Kh,"CODE",{});var ZM=s(zl);Dg=i(ZM,"labels"),ZM.forEach(t),Lg=i(Kh,": (for decoder) "),xl=a(Kh,"CODE",{});var YM=s(xl);Gg=i(YM,"[tgt_lang_code] X [eos]"),YM.forEach(t),Kh.forEach(t),Qh.forEach(t),Rg=l(Ct),Bl=a(Ct,"P",{});var e2=s(Bl);Wg=i(e2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),e2.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);f(Wa.$$.fragment,Zh),Xg=l(Zh),ql=a(Zh,"P",{});var t2=s(ql);Hg=i(t2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),t2.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);f(Ua.$$.fragment,Yh),Qg=l(Yh),$l=a(Yh,"P",{});var o2=s($l);Jg=i(o2,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),o2.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var n2=s(Yo);Fl=a(n2,"SPAN",{});var a2=s(Fl);f(Xa.$$.fragment,a2),a2.forEach(t),n2.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var s2=s(jl);Zg=i(s2,"MBartModel"),s2.forEach(t),eu.forEach(t),Rp=l(o),Qe=a(o,"DIV",{class:!0});var qn=s(Qe);f(Ha.$$.fragment,qn),Yg=l(qn),Va=a(qn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),_i=a(tu,"A",{href:!0});var r2=s(_i);tk=i(r2,"PreTrainedModel"),r2.forEach(t),ok=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),nk=l(qn),Qa=a(qn,"P",{});var ou=s(Qa);ak=i(ou,"This model is also a PyTorch "),Ja=a(ou,"A",{href:!0,rel:!0});var i2=s(Ja);sk=i(i2,"torch.nn.Module"),i2.forEach(t),rk=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(qn),Ae=a(qn,"DIV",{class:!0});var At=s(Ae);f(Ka.$$.fragment,At),dk=l(At),ho=a(At,"P",{});var Oi=s(ho);lk=i(Oi,"The "),gi=a(Oi,"A",{href:!0});var d2=s(gi);ck=i(d2,"MBartModel"),d2.forEach(t),pk=i(Oi," forward method, overrides the "),El=a(Oi,"CODE",{});var l2=s(El);hk=i(l2,"__call__"),l2.forEach(t),uk=i(Oi," special method."),Oi.forEach(t),mk=l(At),f(en.$$.fragment,At),fk=l(At),Pl=a(At,"P",{});var c2=s(Pl);_k=i(c2,"Example:"),c2.forEach(t),gk=l(At),f(Za.$$.fragment,At),At.forEach(t),qn.forEach(t),Wp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p2=s(tn);Cl=a(p2,"SPAN",{});var h2=s(Cl);f(Ya.$$.fragment,h2),h2.forEach(t),p2.forEach(t),kk=l(nu),Al=a(nu,"SPAN",{});var u2=s(Al);bk=i(u2,"MBartForConditionalGeneration"),u2.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ki=a(au,"A",{href:!0});var m2=s(ki);Tk=i(m2,"PreTrainedModel"),m2.forEach(t),Mk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l($n),os=a($n,"P",{});var su=s(os);zk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f2=s(ns);xk=i(f2,"torch.nn.Module"),f2.forEach(t),Bk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),qk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Di=s(mo);Fk=i(Di,"The "),bi=a(Di,"A",{href:!0});var _2=s(bi);jk=i(_2,"MBartForConditionalGeneration"),_2.forEach(t),Ek=i(Di," forward method, overrides the "),Sl=a(Di,"CODE",{});var g2=s(Sl);Pk=i(g2,"__call__"),g2.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Ak=l(Le),f(on.$$.fragment,Le),Sk=l(Le),Il=a(Le,"P",{});var k2=s(Il);Ik=i(k2,"Summarization example:"),k2.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Ok=l(Le),Nl=a(Le,"P",{});var b2=s(Nl);Dk=i(b2,"Mask filling example:"),b2.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var v2=s(nn);Ol=a(v2,"SPAN",{});var y2=s(Ol);f(is.$$.fragment,y2),y2.forEach(t),v2.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T2=s(Dl);Rk=i(T2,"MBartForQuestionAnswering"),T2.forEach(t),ru.forEach(t),Hp=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(ds.$$.fragment,St),Wk=l(St),_o=a(St,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M2=s(Ll);Xk=i(M2,"span start logits"),M2.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w2=s(Gl);Vk=i(w2,"span end logits"),w2.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(St),ls=a(St,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),vi=a(iu,"A",{href:!0});var z2=s(vi);Zk=i(z2,"PreTrainedModel"),z2.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),eb=l(St),cs=a(St,"P",{});var du=s(cs);tb=i(du,"This model is also a PyTorch "),ps=a(du,"A",{href:!0,rel:!0});var x2=s(ps);ob=i(x2,"torch.nn.Module"),x2.forEach(t),nb=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(St),Se=a(St,"DIV",{class:!0});var It=s(Se);f(hs.$$.fragment,It),sb=l(It),go=a(It,"P",{});var Gi=s(go);rb=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var B2=s(yi);ib=i(B2,"MBartForQuestionAnswering"),B2.forEach(t),db=i(Gi," forward method, overrides the "),Rl=a(Gi,"CODE",{});var q2=s(Rl);lb=i(q2,"__call__"),q2.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(It),f(an.$$.fragment,It),hb=l(It),Wl=a(It,"P",{});var $2=s(Wl);ub=i($2,"Example:"),$2.forEach(t),mb=l(It),f(us.$$.fragment,It),It.forEach(t),St.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var F2=s(sn);Ul=a(F2,"SPAN",{});var j2=s(Ul);f(ms.$$.fragment,j2),j2.forEach(t),F2.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E2=s(Xl);_b=i(E2,"MBartForSequenceClassification"),E2.forEach(t),lu.forEach(t),Qp=l(o),qe=a(o,"DIV",{class:!0});var Nt=s(qe);f(fs.$$.fragment,Nt),gb=l(Nt),Hl=a(Nt,"P",{});var P2=s(Hl);kb=i(P2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P2.forEach(t),bb=l(Nt),_s=a(Nt,"P",{});var cu=s(_s);vb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var C2=s(Ti);yb=i(C2,"PreTrainedModel"),C2.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(Nt),gs=a(Nt,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var A2=s(ks);zb=i(A2,"torch.nn.Module"),A2.forEach(t),xb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),Bb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),qb=l(Ge),bo=a(Ge,"P",{});var Ri=s(bo);$b=i(Ri,"The "),Mi=a(Ri,"A",{href:!0});var S2=s(Mi);Fb=i(S2,"MBartForSequenceClassification"),S2.forEach(t),jb=i(Ri," forward method, overrides the "),Vl=a(Ri,"CODE",{});var I2=s(Vl);Eb=i(I2,"__call__"),I2.forEach(t),Pb=i(Ri," special method."),Ri.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Ab=l(Ge),Ql=a(Ge,"P",{});var N2=s(Ql);Sb=i(N2,"Example of single-label classification:"),N2.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var O2=s(Jl);Ob=i(O2,"Example of multi-label classification:"),O2.forEach(t),Db=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D2=s(dn);Kl=a(D2,"SPAN",{});var L2=s(Kl);f(Ts.$$.fragment,L2),L2.forEach(t),D2.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G2=s(Zl);Gb=i(G2,"MBartForCausalLM"),G2.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Rb=l(uu),Tt=a(uu,"DIV",{class:!0});var Wi=s(Tt);f(ws.$$.fragment,Wi),Wb=l(Wi),Yl=a(Wi,"P",{});var R2=s(Yl);Ub=i(R2,"Example:"),R2.forEach(t),Xb=l(Wi),f(zs.$$.fragment,Wi),Wi.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var W2=s(ln);ec=a(W2,"SPAN",{});var U2=s(ec);f(xs.$$.fragment,U2),U2.forEach(t),W2.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X2=s(tc);Vb=i(X2,"TFMBartModel"),X2.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(Bs.$$.fragment,Ot),Qb=l(Ot),qs=a(Ot,"P",{});var fu=s(qs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),wi=a(fu,"A",{href:!0});var H2=s(wi);Kb=i(H2,"TFPreTrainedModel"),H2.forEach(t),Zb=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Ot),$s=a(Ot,"P",{});var _u=s($s);ev=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var V2=s(Fs);tv=i(V2,"tf.keras.Model"),V2.forEach(t),ov=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Ot),f(cn.$$.fragment,Ot),av=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sv=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),zi=a(Ui,"A",{href:!0});var Q2=s(zi);iv=i(Q2,"TFMBartModel"),Q2.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J2=s(oc);lv=i(J2,"__call__"),J2.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Dt),f(pn.$$.fragment,Dt),hv=l(Dt),nc=a(Dt,"P",{});var K2=s(nc);uv=i(K2,"Example:"),K2.forEach(t),mv=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z2=s(hn);ac=a(Z2,"SPAN",{});var Y2=s(ac);f(Ps.$$.fragment,Y2),Y2.forEach(t),Z2.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ew=s(sc);_v=i(ew,"TFMBartForConditionalGeneration"),ew.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),As=a(Lt,"P",{});var ku=s(As);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),xi=a(ku,"A",{href:!0});var tw=s(xi);bv=i(tw,"TFPreTrainedModel"),tw.forEach(t),vv=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),yv=l(Lt),Ss=a(Lt,"P",{});var bu=s(Ss);Tv=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var ow=s(Is);Mv=i(ow,"tf.keras.Model"),ow.forEach(t),wv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),zv=l(Lt),f(un.$$.fragment,Lt),xv=l(Lt),ee=a(Lt,"DIV",{class:!0});var Re=s(ee);f(Ns.$$.fragment,Re),Bv=l(Re),zo=a(Re,"P",{});var Xi=s(zo);qv=i(Xi,"The "),Bi=a(Xi,"A",{href:!0});var nw=s(Bi);$v=i(nw,"TFMBartForConditionalGeneration"),nw.forEach(t),Fv=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var aw=s(rc);jv=i(aw,"__call__"),aw.forEach(t),Ev=i(Xi," special method."),Xi.forEach(t),Pv=l(Re),f(mn.$$.fragment,Re),Cv=l(Re),ic=a(Re,"P",{});var sw=s(ic);Av=i(sw,"Summarization example:"),sw.forEach(t),Sv=l(Re),f(Os.$$.fragment,Re),Iv=l(Re),dc=a(Re,"P",{});var rw=s(dc);Nv=i(rw,"Mask filling example:"),rw.forEach(t),Ov=l(Re),f(Ds.$$.fragment,Re),Re.forEach(t),Lt.forEach(t),oh=l(o),xo=a(o,"H2",{class:!0});var vu=s(xo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var iw=s(fn);lc=a(iw,"SPAN",{});var dw=s(lc);f(Ls.$$.fragment,dw),dw.forEach(t),iw.forEach(t),Dv=l(vu),cc=a(vu,"SPAN",{});var lw=s(cc);Lv=i(lw,"FlaxMBartModel"),lw.forEach(t),vu.forEach(t),nh=l(o),R=a(o,"DIV",{class:!0});var me=s(R);f(Gs.$$.fragment,me),Gv=l(me),Rs=a(me,"P",{});var yu=s(Rs);Rv=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(yu,"A",{href:!0});var cw=s(qi);Wv=i(cw,"FlaxPreTrainedModel"),cw.forEach(t),Uv=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),Xv=l(me),Ws=a(me,"P",{});var Tu=s(Ws);Hv=i(Tu,`This model is also a Flax Linen
`),Us=a(Tu,"A",{href:!0,rel:!0});var pw=s(Us);Vv=i(pw,"flax.nn.Module"),pw.forEach(t),Qv=i(Tu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),Jv=l(me),pc=a(me,"P",{});var hw=s(pc);Kv=i(hw,"Finally, this model supports inherent JAX features such as:"),hw.forEach(t),Zv=l(me),mt=a(me,"UL",{});var Fn=s(mt);hc=a(Fn,"LI",{});var uw=s(hc);Xs=a(uw,"A",{href:!0,rel:!0});var mw=s(Xs);Yv=i(mw,"Just-In-Time (JIT) compilation"),mw.forEach(t),uw.forEach(t),ey=l(Fn),uc=a(Fn,"LI",{});var fw=s(uc);Hs=a(fw,"A",{href:!0,rel:!0});var _w=s(Hs);ty=i(_w,"Automatic Differentiation"),_w.forEach(t),fw.forEach(t),oy=l(Fn),mc=a(Fn,"LI",{});var gw=s(mc);Vs=a(gw,"A",{href:!0,rel:!0});var kw=s(Vs);ny=i(kw,"Vectorization"),kw.forEach(t),gw.forEach(t),ay=l(Fn),fc=a(Fn,"LI",{});var bw=s(fc);Qs=a(bw,"A",{href:!0,rel:!0});var vw=s(Qs);sy=i(vw,"Parallelization"),vw.forEach(t),bw.forEach(t),Fn.forEach(t),ry=l(me),Ne=a(me,"DIV",{class:!0});var Gt=s(Ne);f(Js.$$.fragment,Gt),iy=l(Gt),Bo=a(Gt,"P",{});var Hi=s(Bo);dy=i(Hi,"The "),_c=a(Hi,"CODE",{});var yw=s(_c);ly=i(yw,"FlaxMBartPreTrainedModel"),yw.forEach(t),cy=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tw=s(gc);py=i(Tw,"__call__"),Tw.forEach(t),hy=i(Hi," special method."),Hi.forEach(t),uy=l(Gt),f(_n.$$.fragment,Gt),my=l(Gt),kc=a(Gt,"P",{});var Mw=s(kc);fy=i(Mw,"Example:"),Mw.forEach(t),_y=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gy=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),ky=l(Vi),bc=a(Vi,"P",{});var ww=s(bc);by=i(ww,"Example:"),ww.forEach(t),vy=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),yy=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Ty=l(Qi),vc=a(Qi,"P",{});var zw=s(vc);My=i(zw,"Example:"),zw.forEach(t),wy=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(o),qo=a(o,"H2",{class:!0});var Mu=s(qo);gn=a(Mu,"A",{id:!0,class:!0,href:!0});var xw=s(gn);yc=a(xw,"SPAN",{});var Bw=s(yc);f(or.$$.fragment,Bw),Bw.forEach(t),xw.forEach(t),zy=l(Mu),Tc=a(Mu,"SPAN",{});var qw=s(Tc);xy=i(qw,"FlaxMBartForConditionalGeneration"),qw.forEach(t),Mu.forEach(t),sh=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);f(nr.$$.fragment,fe),By=l(fe),ar=a(fe,"P",{});var wu=s(ar);qy=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),$i=a(wu,"A",{href:!0});var $w=s($i);$y=i($w,"FlaxPreTrainedModel"),$w.forEach(t),Fy=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),jy=l(fe),sr=a(fe,"P",{});var zu=s(sr);Ey=i(zu,`This model is also a Flax Linen
`),rr=a(zu,"A",{href:!0,rel:!0});var Fw=s(rr);Py=i(Fw,"flax.nn.Module"),Fw.forEach(t),Cy=i(zu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zu.forEach(t),Ay=l(fe),Mc=a(fe,"P",{});var jw=s(Mc);Sy=i(jw,"Finally, this model supports inherent JAX features such as:"),jw.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ew=s(wc);ir=a(Ew,"A",{href:!0,rel:!0});var Pw=s(ir);Ny=i(Pw,"Just-In-Time (JIT) compilation"),Pw.forEach(t),Ew.forEach(t),Oy=l(jn),zc=a(jn,"LI",{});var Cw=s(zc);dr=a(Cw,"A",{href:!0,rel:!0});var Aw=s(dr);Dy=i(Aw,"Automatic Differentiation"),Aw.forEach(t),Cw.forEach(t),Ly=l(jn),xc=a(jn,"LI",{});var Sw=s(xc);lr=a(Sw,"A",{href:!0,rel:!0});var Iw=s(lr);Gy=i(Iw,"Vectorization"),Iw.forEach(t),Sw.forEach(t),Ry=l(jn),Bc=a(jn,"LI",{});var Nw=s(Bc);cr=a(Nw,"A",{href:!0,rel:!0});var Ow=s(cr);Wy=i(Ow,"Parallelization"),Ow.forEach(t),Nw.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var We=s(te);f(pr.$$.fragment,We),Xy=l(We),$o=a(We,"P",{});var Ji=s($o);Hy=i(Ji,"The "),qc=a(Ji,"CODE",{});var Dw=s(qc);Vy=i(Dw,"FlaxMBartPreTrainedModel"),Dw.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var Lw=s($c);Jy=i(Lw,"__call__"),Lw.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(We),f(kn.$$.fragment,We),Yy=l(We),Fc=a(We,"P",{});var Gw=s(Fc);eT=i(Gw,"Summarization example:"),Gw.forEach(t),tT=l(We),f(hr.$$.fragment,We),oT=l(We),jc=a(We,"P",{});var Rw=s(jc);nT=i(Rw,"Mask filling example:"),Rw.forEach(t),aT=l(We),f(ur.$$.fragment,We),We.forEach(t),sT=l(fe),zt=a(fe,"DIV",{class:!0});var Ki=s(zt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var Ww=s(Ec);iT=i(Ww,"Example:"),Ww.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),xt=a(fe,"DIV",{class:!0});var Zi=s(xt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var Uw=s(Pc);pT=i(Uw,"Example:"),Uw.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var xu=s(Fo);bn=a(xu,"A",{id:!0,class:!0,href:!0});var Xw=s(bn);Cc=a(Xw,"SPAN",{});var Hw=s(Cc);f(kr.$$.fragment,Hw),Hw.forEach(t),Xw.forEach(t),uT=l(xu),Ac=a(xu,"SPAN",{});var Vw=s(Ac);mT=i(Vw,"FlaxMBartForSequenceClassification"),Vw.forEach(t),xu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),fT=l(oe),Sc=a(oe,"P",{});var Qw=s(Sc);_T=i(Qw,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qw.forEach(t),gT=l(oe),vr=a(oe,"P",{});var Bu=s(vr);kT=i(Bu,"This model inherits from "),Fi=a(Bu,"A",{href:!0});var Jw=s(Fi);bT=i(Jw,"FlaxPreTrainedModel"),Jw.forEach(t),vT=i(Bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bu.forEach(t),yT=l(oe),yr=a(oe,"P",{});var qu=s(yr);TT=i(qu,`This model is also a Flax Linen
`),Tr=a(qu,"A",{href:!0,rel:!0});var Kw=s(Tr);MT=i(Kw,"flax.nn.Module"),Kw.forEach(t),wT=i(qu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),qu.forEach(t),zT=l(oe),Ic=a(oe,"P",{});var Zw=s(Ic);xT=i(Zw,"Finally, this model supports inherent JAX features such as:"),Zw.forEach(t),BT=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Yw=s(Nc);Mr=a(Yw,"A",{href:!0,rel:!0});var ez=s(Mr);qT=i(ez,"Just-In-Time (JIT) compilation"),ez.forEach(t),Yw.forEach(t),$T=l(En),Oc=a(En,"LI",{});var tz=s(Oc);wr=a(tz,"A",{href:!0,rel:!0});var oz=s(wr);FT=i(oz,"Automatic Differentiation"),oz.forEach(t),tz.forEach(t),jT=l(En),Dc=a(En,"LI",{});var nz=s(Dc);zr=a(nz,"A",{href:!0,rel:!0});var az=s(zr);ET=i(az,"Vectorization"),az.forEach(t),nz.forEach(t),PT=l(En),Lc=a(En,"LI",{});var sz=s(Lc);xr=a(sz,"A",{href:!0,rel:!0});var rz=s(xr);CT=i(rz,"Parallelization"),rz.forEach(t),sz.forEach(t),En.forEach(t),AT=l(oe),Oe=a(oe,"DIV",{class:!0});var Rt=s(Oe);f(Br.$$.fragment,Rt),ST=l(Rt),jo=a(Rt,"P",{});var Yi=s(jo);IT=i(Yi,"The "),Gc=a(Yi,"CODE",{});var iz=s(Gc);NT=i(iz,"FlaxMBartPreTrainedModel"),iz.forEach(t),OT=i(Yi,"forward method, overrides the "),Rc=a(Yi,"CODE",{});var dz=s(Rc);DT=i(dz,"__call__"),dz.forEach(t),LT=i(Yi," special method."),Yi.forEach(t),GT=l(Rt),f(vn.$$.fragment,Rt),RT=l(Rt),Wc=a(Rt,"P",{});var lz=s(Wc);WT=i(lz,"Example:"),lz.forEach(t),UT=l(Rt),f(qr.$$.fragment,Rt),Rt.forEach(t),XT=l(oe),Bt=a(oe,"DIV",{class:!0});var ed=s(Bt);f($r.$$.fragment,ed),HT=l(ed),Uc=a(ed,"P",{});var cz=s(Uc);VT=i(cz,"Example:"),cz.forEach(t),QT=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),JT=l(oe),qt=a(oe,"DIV",{class:!0});var td=s(qt);f(jr.$$.fragment,td),KT=l(td),Xc=a(td,"P",{});var pz=s(Xc);ZT=i(pz,"Example:"),pz.forEach(t),YT=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var hz=s(yn);Hc=a(hz,"SPAN",{});var uz=s(Hc);f(Pr.$$.fragment,uz),uz.forEach(t),hz.forEach(t),e0=l($u),Vc=a($u,"SPAN",{});var mz=s(Vc);t0=i(mz,"FlaxMBartForQuestionAnswering"),mz.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),o0=l(ne),Po=a(ne,"P",{});var od=s(Po);n0=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Qc=a(od,"CODE",{});var fz=s(Qc);a0=i(fz,"span start logits"),fz.forEach(t),s0=i(od," and "),Jc=a(od,"CODE",{});var _z=s(Jc);r0=i(_z,"span end logits"),_z.forEach(t),i0=i(od,")."),od.forEach(t),d0=l(ne),Ar=a(ne,"P",{});var Fu=s(Ar);l0=i(Fu,"This model inherits from "),ji=a(Fu,"A",{href:!0});var gz=s(ji);c0=i(gz,"FlaxPreTrainedModel"),gz.forEach(t),p0=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
