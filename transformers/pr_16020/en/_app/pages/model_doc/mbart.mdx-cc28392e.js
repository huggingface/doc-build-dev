...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),Ts=new U({}),Ms=new B({props:{name:"class transformers.MBartForCausalLM",anchor:"transformers.MBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1684"}}),ws=new B({props:{name:"forward",anchor:"transformers.MBartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16020/src/transformers/models/mbart/modeling_mbart.py#L1715",parametersDescription:[{anchor:"transformers.MBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Ghazvininejad, Mike Lewis, Luke Zettlemoyer.`),Jr.forEach(t),O=l(o),Ee=a(o,"P",{});var H0=s(Ee);be=i(H0,`According to the abstract, MBART is a sequence-to-sequence denoising auto-encoder pretrained on large-scale monolingual
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),k1.forEach(t),g1.forEach(t),zp=l(o),eo=a(o,"H3",{class:!0});var mh=s(eo);So=a(mh,"A",{id:!0,class:!0,href:!0});var b1=s(So);_d=a(b1,"SPAN",{});var v1=s(_d);f(On.$$.fragment,v1),v1.forEach(t),b1.forEach(t),am=l(mh),gd=a(mh,"SPAN",{});var y1=s(gd);sm=i(y1,"Training of MBart-50"),y1.forEach(t),mh.forEach(t),xp=l(o),et=a(o,"P",{});var wn=s(et);rm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
`),ia=a(Ii,"A",{href:!0,rel:!0});var lM=s(ia);If=i(lM,"BPE"),lM.forEach(t),Nf=i(Ii,"."),Ii.forEach(t),Df=l(H),yt=a(H,"P",{});var Kr=s(yt);pi=a(Kr,"A",{href:!0});var cM=s(pi);Of=i(cM,"MBartTokenizerFast"),cM.forEach(t),Lf=i(Kr," is a subclass of "),hi=a(Kr,"A",{href:!0});var pM=s(hi);Gf=i(pM,"XLMRobertaTokenizerFast"),pM.forEach(t),Rf=i(Kr,`. Refer to superclass
...
this superclass for more information regarding those methods.`),Sh.forEach(t),A_=l(V),rl=a(V,"P",{});var FM=s(rl);S_=i(FM,"Examples:"),FM.forEach(t),I_=l(V),f(Ma.$$.fragment,V),N_=l(V),ot=a(V,"DIV",{class:!0});var Bn=s(ot);f(wa.$$.fragment,Bn),D_=l(Bn),za=a(Bn,"P",{});var Ih=s(za);O_=i(Ih,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),il=a(Ih,"CODE",{});var jM=s(il);L_=i(jM,"X"),jM.forEach(t),G_=i(Ih," represents the sequence:"),Ih.forEach(t),R_=l(Bn),xa=a(Bn,"UL",{});var Nh=s(xa);Ba=a(Nh,"LI",{});var Dh=s(Ba);dl=a(Dh,"CODE",{});var EM=s(dl);W_=i(EM,"input_ids"),EM.forEach(t),U_=i(Dh," (for encoder) "),ll=a(Dh,"CODE",{});var PM=s(ll);X_=i(PM,"[src_lang_code] X [eos]"),PM.forEach(t),Dh.forEach(t),H_=l(Nh),qa=a(Nh,"LI",{});var Oh=s(qa);cl=a(Oh,"CODE",{});var CM=s(cl);V_=i(CM,"labels"),CM.forEach(t),Q_=i(Oh,": (for decoder) "),pl=a(Oh,"CODE",{});var AM=s(pl);J_=i(AM,"[tgt_lang_code] X [eos]"),AM.forEach(t),Oh.forEach(t),Nh.forEach(t),K_=l(Bn),hl=a(Bn,"P",{});var SM=s(hl);Z_=i(SM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
special tokens using the tokenizer `),ml=a(Rh,"CODE",{});var NM=s(ml);sg=i(NM,"prepare_for_model"),NM.forEach(t),rg=i(Rh," method."),Rh.forEach(t),Gh.forEach(t),ig=l(V),Vo=a(V,"DIV",{class:!0});var Wh=s(Vo);f(Ea.$$.fragment,Wh),dg=l(Wh),fl=a(Wh,"P",{});var DM=s(fl);lg=i(DM,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),DM.forEach(t),Wh.forEach(t),cg=l(V),Qo=a(V,"DIV",{class:!0});var Uh=s(Qo);f(Pa.$$.fragment,Uh),pg=l(Uh),_l=a(Uh,"P",{});var OM=s(_l);hg=i(OM,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),OM.forEach(t),Uh.forEach(t),V.forEach(t),Op=l(o),lo=a(o,"H2",{class:!0});var Xh=s(lo);Jo=a(Xh,"A",{id:!0,class:!0,href:!0});var LM=s(Jo);gl=a(LM,"SPAN",{});var GM=s(gl);f(Ca.$$.fragment,GM),GM.forEach(t),LM.forEach(t),ug=l(Xh),kl=a(Xh,"SPAN",{});var RM=s(kl);mg=i(RM,"MBart50TokenizerFast"),RM.forEach(t),Xh.forEach(t),Lp=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Aa.$$.fragment,ue),fg=l(ue),co=a(ue,"P",{});var Ni=s(co);_g=i(Ni,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ni,"EM",{});var WM=s(bl);gg=i(WM,"tokenizers"),WM.forEach(t),kg=i(Ni,` library). Based on
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(qn),Ae=a(qn,"DIV",{class:!0});var At=s(Ae);f(Ka.$$.fragment,At),dk=l(At),ho=a(At,"P",{});var Di=s(ho);lk=i(Di,"The "),gi=a(Di,"A",{href:!0});var d2=s(gi);ck=i(d2,"MBartModel"),d2.forEach(t),pk=i(Di," forward method, overrides the "),El=a(Di,"CODE",{});var l2=s(El);hk=i(l2,"__call__"),l2.forEach(t),uk=i(Di," special method."),Di.forEach(t),mk=l(At),f(en.$$.fragment,At),fk=l(At),Pl=a(At,"P",{});var c2=s(Pl);_k=i(c2,"Example:"),c2.forEach(t),gk=l(At),f(Za.$$.fragment,At),At.forEach(t),qn.forEach(t),Wp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p2=s(tn);Cl=a(p2,"SPAN",{});var h2=s(Cl);f(Ya.$$.fragment,h2),h2.forEach(t),p2.forEach(t),kk=l(nu),Al=a(nu,"SPAN",{});var u2=s(Al);bk=i(u2,"MBartForConditionalGeneration"),u2.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),qk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Oi=s(mo);Fk=i(Oi,"The "),bi=a(Oi,"A",{href:!0});var _2=s(bi);jk=i(_2,"MBartForConditionalGeneration"),_2.forEach(t),Ek=i(Oi," forward method, overrides the "),Sl=a(Oi,"CODE",{});var g2=s(Sl);Pk=i(g2,"__call__"),g2.forEach(t),Ck=i(Oi," special method."),Oi.forEach(t),Ak=l(Le),f(on.$$.fragment,Le),Sk=l(Le),Il=a(Le,"P",{});var k2=s(Il);Ik=i(k2,"Translation example:"),k2.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Dk=l(Le),Nl=a(Le,"P",{});var b2=s(Nl);Ok=i(b2,"Mask filling example:"),b2.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var v2=s(nn);Dl=a(v2,"SPAN",{});var y2=s(Dl);f(is.$$.fragment,y2),y2.forEach(t),v2.forEach(t),Gk=l(ru),Ol=a(ru,"SPAN",{});var T2=s(Ol);Rk=i(T2,"MBartForQuestionAnswering"),T2.forEach(t),ru.forEach(t),Hp=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(ds.$$.fragment,St),Wk=l(St),_o=a(St,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),Bb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),qb=l(Ge),bo=a(Ge,"P",{});var Ri=s(bo);$b=i(Ri,"The "),Mi=a(Ri,"A",{href:!0});var S2=s(Mi);Fb=i(S2,"MBartForSequenceClassification"),S2.forEach(t),jb=i(Ri," forward method, overrides the "),Vl=a(Ri,"CODE",{});var I2=s(Vl);Eb=i(I2,"__call__"),I2.forEach(t),Pb=i(Ri," special method."),Ri.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Ab=l(Ge),Ql=a(Ge,"P",{});var N2=s(Ql);Sb=i(N2,"Example of single-label classification:"),N2.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var D2=s(Jl);Db=i(D2,"Example of multi-label classification:"),D2.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var O2=s(dn);Kl=a(O2,"SPAN",{});var L2=s(Kl);f(Ts.$$.fragment,L2),L2.forEach(t),O2.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G2=s(Zl);Gb=i(G2,"MBartForCausalLM"),G2.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Rb=l(uu),Tt=a(uu,"DIV",{class:!0});var Wi=s(Tt);f(ws.$$.fragment,Wi),Wb=l(Wi),Yl=a(Wi,"P",{});var R2=s(Yl);Ub=i(R2,"Example:"),R2.forEach(t),Xb=l(Wi),f(zs.$$.fragment,Wi),Wi.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var W2=s(ln);ec=a(W2,"SPAN",{});var U2=s(ec);f(xs.$$.fragment,U2),U2.forEach(t),W2.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X2=s(tc);Vb=i(X2,"TFMBartModel"),X2.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Dt=s($e);f(Bs.$$.fragment,Dt),Qb=l(Dt),qs=a(Dt,"P",{});var fu=s(qs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Dt),$s=a(Dt,"P",{});var _u=s($s);ev=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var V2=s(Fs);tv=i(V2,"tf.keras.Model"),V2.forEach(t),ov=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Dt),f(cn.$$.fragment,Dt),av=l(Dt),Ie=a(Dt,"DIV",{class:!0});var Ot=s(Ie);f(js.$$.fragment,Ot),sv=l(Ot),Mo=a(Ot,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),zi=a(Ui,"A",{href:!0});var Q2=s(zi);iv=i(Q2,"TFMBartModel"),Q2.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J2=s(oc);lv=i(J2,"__call__"),J2.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Ot),f(pn.$$.fragment,Ot),hv=l(Ot),nc=a(Ot,"P",{});var K2=s(nc);uv=i(K2,"Example:"),K2.forEach(t),mv=l(Ot),f(Es.$$.fragment,Ot),Ot.forEach(t),Dt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z2=s(hn);ac=a(Z2,"SPAN",{});var Y2=s(ac);f(Ps.$$.fragment,Y2),Y2.forEach(t),Z2.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ew=s(sc);_v=i(ew,"TFMBartForConditionalGeneration"),ew.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),As=a(Lt,"P",{});var ku=s(As);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),zv=l(Lt),f(un.$$.fragment,Lt),xv=l(Lt),ee=a(Lt,"DIV",{class:!0});var Re=s(ee);f(Ns.$$.fragment,Re),Bv=l(Re),zo=a(Re,"P",{});var Xi=s(zo);qv=i(Xi,"The "),Bi=a(Xi,"A",{href:!0});var nw=s(Bi);$v=i(nw,"TFMBartForConditionalGeneration"),nw.forEach(t),Fv=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var aw=s(rc);jv=i(aw,"__call__"),aw.forEach(t),Ev=i(Xi," special method."),Xi.forEach(t),Pv=l(Re),f(mn.$$.fragment,Re),Cv=l(Re),ic=a(Re,"P",{});var sw=s(ic);Av=i(sw,"Summarization example:"),sw.forEach(t),Sv=l(Re),f(Ds.$$.fragment,Re),Iv=l(Re),dc=a(Re,"P",{});var rw=s(dc);Nv=i(rw,"Mask filling example:"),rw.forEach(t),Dv=l(Re),f(Os.$$.fragment,Re),Re.forEach(t),Lt.forEach(t),oh=l(o),xo=a(o,"H2",{class:!0});var vu=s(xo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var iw=s(fn);lc=a(iw,"SPAN",{});var dw=s(lc);f(Ls.$$.fragment,dw),dw.forEach(t),iw.forEach(t),Ov=l(vu),cc=a(vu,"SPAN",{});var lw=s(cc);Lv=i(lw,"FlaxMBartModel"),lw.forEach(t),vu.forEach(t),nh=l(o),R=a(o,"DIV",{class:!0});var me=s(R);f(Gs.$$.fragment,me),Gv=l(me),Rs=a(me,"P",{});var yu=s(Rs);Rv=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
