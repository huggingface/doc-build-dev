...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_18116/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_18116/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18116/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18116/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18116/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L1255",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L1466",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L1568",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_mobilebert.py#L1358",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18116/en/model_doc/mobilebert#transformers.MobileBertTokenizer">MobileBertTokenizer</a>. See <a href="/docs/transformers/pr_18116/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18116/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18116/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
splitting and wordpiece.`),Sd.forEach(t),fh=m(Bt),fs=a(Bt,"P",{});var Mc=i(fs);uh=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var j1=i(Pa);gh=s(j1,"BertTokenizerFast"),j1.forEach(t),_h=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=m(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var C1=i(Ao);Ii=a(C1,"SPAN",{});var N1=i(Ii);y(us.$$.fragment,N1),N1.forEach(t),C1.forEach(t),bh=m($c),Li=a($c,"SPAN",{});var O1=i(Li);Th=s(O1,"MobileBert specific outputs"),O1.forEach(t),$c.forEach(t),Rd=m(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),kh=m(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vh=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var S1=i(qa);yh=s(S1,"MobileBertForPreTraining"),S1.forEach(t),wh=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=m(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mh=m(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$h=s(xc,"Output type of "),ja=a(xc,"A",{href:!0});var A1=i(ja);Fh=s(A1,"TFMobileBertForPreTraining"),A1.forEach(t),Bh=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=m(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var I1=i(Io);Di=a(I1,"SPAN",{});var L1=i(Di);y(ks.$$.fragment,L1),L1.forEach(t),I1.forEach(t),Eh=m(zc),Wi=a(zc,"SPAN",{});var D1=i(Wi);xh=s(D1,"MobileBertModel"),D1.forEach(t),zc.forEach(t),Qd=m(o),Ce=a(o,"DIV",{class:!0});var ut=i(Ce);y(vs.$$.fragment,ut),zh=m(ut),Ri=a(ut,"P",{});var W1=i(Ri);Ph=s(W1,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),W1.forEach(t),qh=m(ut),ys=a(ut,"P",{});var Pc=i(ys);jh=s(Pc,"This model inherits from "),Ca=a(Pc,"A",{href:!0});var R1=i(Ca);Ch=s(R1,"PreTrainedModel"),R1.forEach(t),Nh=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc.forEach(t),Oh=m(ut),ws=a(ut,"P",{});var qc=i(ws);Sh=s(qc,"This model is also a PyTorch "),Ms=a(qc,"A",{href:!0,rel:!0});var U1=i(Ms);Ah=s(U1,"torch.nn.Module"),U1.forEach(t),Ih=s(qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qc.forEach(t),Lh=m(ut),Ui=a(ut,"P",{});var H1=i(Ui);$s=a(H1,"A",{href:!0,rel:!0});var Q1=i($s);Dh=s(Q1,"https://arxiv.org/pdf/2004.02984.pdf"),Q1.forEach(t),H1.forEach(t),Wh=m(ut),it=a(ut,"DIV",{class:!0});var Xn=i(it);y(Fs.$$.fragment,Xn),Rh=m(Xn),Gt=a(Xn,"P",{});var hi=i(Gt);Uh=s(hi,"The "),Na=a(hi,"A",{href:!0});var K1=i(Na);Hh=s(K1,"MobileBertModel"),K1.forEach(t),Qh=s(hi," forward method, overrides the "),Hi=a(hi,"CODE",{});var V1=i(Hi);Kh=s(V1,"__call__"),V1.forEach(t),Vh=s(hi," special method."),hi.forEach(t),Gh=m(Xn),y(Lo.$$.fragment,Xn),Yh=m(Xn),y(Do.$$.fragment,Xn),Xn.forEach(t),ut.forEach(t),Kd=m(o),Yt=a(o,"H2",{class:!0});var jc=i(Yt);Wo=a(jc,"A",{id:!0,class:!0,href:!0});var G1=i(Wo);Qi=a(G1,"SPAN",{});var Y1=i(Qi);y(Bs.$$.fragment,Y1),Y1.forEach(t),G1.forEach(t),Jh=m(jc),Ki=a(jc,"SPAN",{});var J1=i(Ki);Zh=s(J1,"MobileBertForPreTraining"),J1.forEach(t),jc.forEach(t),Vd=m(o),Re=a(o,"DIV",{class:!0});var Et=i(Re);y(Es.$$.fragment,Et),Xh=m(Et),Jt=a(Et,"P",{});var mi=i(Jt);em=s(mi,"MobileBert Model with two heads on top as done during the pretraining: a "),Vi=a(mi,"CODE",{});var Z1=i(Vi);tm=s(Z1,"masked language modeling"),Z1.forEach(t),om=s(mi,` head and a
`),Gi=a(mi,"CODE",{});var X1=i(Gi);nm=s(X1,"next sentence prediction (classification)"),X1.forEach(t),sm=s(mi," head."),mi.forEach(t),rm=m(Et),xs=a(Et,"P",{});var Cc=i(xs);am=s(Cc,"This model inherits from "),Oa=a(Cc,"A",{href:!0});var eT=i(Oa);im=s(eT,"PreTrainedModel"),eT.forEach(t),lm=s(Cc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cc.forEach(t),dm=m(Et),zs=a(Et,"P",{});var Nc=i(zs);cm=s(Nc,"This model is also a PyTorch "),Ps=a(Nc,"A",{href:!0,rel:!0});var tT=i(Ps);pm=s(tT,"torch.nn.Module"),tT.forEach(t),hm=s(Nc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),mm=m(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);y(qs.$$.fragment,es),fm=m(es),Zt=a(es,"P",{});var fi=i(Zt);um=s(fi,"The "),Sa=a(fi,"A",{href:!0});var oT=i(Sa);gm=s(oT,"MobileBertForPreTraining"),oT.forEach(t),_m=s(fi," forward method, overrides the "),Yi=a(fi,"CODE",{});var nT=i(Yi);bm=s(nT,"__call__"),nT.forEach(t),Tm=s(fi," special method."),fi.forEach(t),km=m(es),y(Ro.$$.fragment,es),vm=m(es),y(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=m(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sT=i(Ho);Ji=a(sT,"SPAN",{});var rT=i(Ji);y(js.$$.fragment,rT),rT.forEach(t),sT.forEach(t),ym=m(Oc),Zi=a(Oc,"SPAN",{});var aT=i(Zi);wm=s(aT,"MobileBertForMaskedLM"),aT.forEach(t),Oc.forEach(t),Yd=m(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);y(Cs.$$.fragment,xt),Mm=m(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$m=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var iT=i(Xi);Fm=s(iT,"language modeling"),iT.forEach(t),Bm=s(Sc," head on top."),Sc.forEach(t),Em=m(xt),Os=a(xt,"P",{});var Ac=i(Os);xm=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lT=i(Aa);zm=s(lT,"PreTrainedModel"),lT.forEach(t),Pm=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),qm=m(xt),Ss=a(xt,"P",{});var Ic=i(Ss);jm=s(Ic,"This model is also a PyTorch "),As=a(Ic,"A",{href:!0,rel:!0});var dT=i(As);Cm=s(dT,"torch.nn.Module"),dT.forEach(t),Nm=s(Ic,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Om=m(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sm=m(zt),eo=a(zt,"P",{});var ui=i(eo);Am=s(ui,"The "),Ia=a(ui,"A",{href:!0});var cT=i(Ia);Im=s(cT,"MobileBertForMaskedLM"),cT.forEach(t),Lm=s(ui," forward method, overrides the "),el=a(ui,"CODE",{});var pT=i(el);Dm=s(pT,"__call__"),pT.forEach(t),Wm=s(ui," special method."),ui.forEach(t),Rm=m(zt),y(Qo.$$.fragment,zt),Um=m(zt),y(Ko.$$.fragment,zt),Hm=m(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=m(o),to=a(o,"H2",{class:!0});var Lc=i(to);Go=a(Lc,"A",{id:!0,class:!0,href:!0});var hT=i(Go);tl=a(hT,"SPAN",{});var mT=i(tl);y(Ls.$$.fragment,mT),mT.forEach(t),hT.forEach(t),Qm=m(Lc),ol=a(Lc,"SPAN",{});var fT=i(ol);Km=s(fT,"MobileBertForNextSentencePrediction"),fT.forEach(t),Lc.forEach(t),Zd=m(o),He=a(o,"DIV",{class:!0});var Pt=i(He);y(Ds.$$.fragment,Pt),Vm=m(Pt),Ws=a(Pt,"P",{});var Dc=i(Ws);Gm=s(Dc,"MobileBert Model with a "),nl=a(Dc,"CODE",{});var uT=i(nl);Ym=s(uT,"next sentence prediction (classification)"),uT.forEach(t),Jm=s(Dc," head on top."),Dc.forEach(t),Zm=m(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xm=s(Wc,"This model inherits from "),La=a(Wc,"A",{href:!0});var gT=i(La);ef=s(gT,"PreTrainedModel"),gT.forEach(t),tf=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),of=m(Pt),Us=a(Pt,"P",{});var Rc=i(Us);nf=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _T=i(Hs);sf=s(_T,"torch.nn.Module"),_T.forEach(t),rf=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),af=m(Pt),dt=a(Pt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),lf=m(ts),oo=a(ts,"P",{});var gi=i(oo);df=s(gi,"The "),Da=a(gi,"A",{href:!0});var bT=i(Da);cf=s(bT,"MobileBertForNextSentencePrediction"),bT.forEach(t),pf=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var TT=i(sl);hf=s(TT,"__call__"),TT.forEach(t),mf=s(gi," special method."),gi.forEach(t),ff=m(ts),y(Yo.$$.fragment,ts),uf=m(ts),y(Jo.$$.fragment,ts),ts.forEach(t),Pt.forEach(t),Xd=m(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kT=i(Zo);rl=a(kT,"SPAN",{});var vT=i(rl);y(Ks.$$.fragment,vT),vT.forEach(t),kT.forEach(t),gf=m(Uc),al=a(Uc,"SPAN",{});var yT=i(al);_f=s(yT,"MobileBertForSequenceClassification"),yT.forEach(t),Uc.forEach(t),ec=m(o),Qe=a(o,"DIV",{class:!0});var qt=i(Qe);y(Vs.$$.fragment,qt),bf=m(qt),il=a(qt,"P",{});var wT=i(il);Tf=s(wT,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wT.forEach(t),kf=m(qt),Gs=a(qt,"P",{});var Hc=i(Gs);vf=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var MT=i(Wa);yf=s(MT,"PreTrainedModel"),MT.forEach(t),wf=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),Mf=m(qt),Ys=a(qt,"P",{});var Qc=i(Ys);$f=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $T=i(Js);Ff=s($T,"torch.nn.Module"),$T.forEach(t),Bf=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Ef=m(qt),je=a(qt,"DIV",{class:!0});var nt=i(je);y(Zs.$$.fragment,nt),xf=m(nt),so=a(nt,"P",{});var _i=i(so);zf=s(_i,"The "),Ra=a(_i,"A",{href:!0});var FT=i(Ra);Pf=s(FT,"MobileBertForSequenceClassification"),FT.forEach(t),qf=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var BT=i(ll);jf=s(BT,"__call__"),BT.forEach(t),Cf=s(_i," special method."),_i.forEach(t),Nf=m(nt),y(Xo.$$.fragment,nt),Of=m(nt),y(en.$$.fragment,nt),Sf=m(nt),y(tn.$$.fragment,nt),Af=m(nt),y(on.$$.fragment,nt),If=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var ET=i(sn);dl=a(ET,"SPAN",{});var xT=i(dl);y(Xs.$$.fragment,xT),xT.forEach(t),ET.forEach(t),Lf=m(Kc),cl=a(Kc,"SPAN",{});var zT=i(cl);Df=s(zT,"MobileBertForMultipleChoice"),zT.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var jt=i(Ke);y(er.$$.fragment,jt),Wf=m(jt),pl=a(jt,"P",{});var PT=i(pl);Rf=s(PT,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),PT.forEach(t),Uf=m(jt),tr=a(jt,"P",{});var Vc=i(tr);Hf=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qT=i(Ua);Qf=s(qT,"PreTrainedModel"),qT.forEach(t),Kf=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Vf=m(jt),or=a(jt,"P",{});var Gc=i(or);Gf=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var jT=i(nr);Yf=s(jT,"torch.nn.Module"),jT.forEach(t),Jf=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Zf=m(jt),ct=a(jt,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Xf=m(os),ao=a(os,"P",{});var bi=i(ao);eu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var CT=i(Ha);tu=s(CT,"MobileBertForMultipleChoice"),CT.forEach(t),ou=s(bi," forward method, overrides the "),hl=a(bi,"CODE",{});var NT=i(hl);nu=s(NT,"__call__"),NT.forEach(t),su=s(bi," special method."),bi.forEach(t),ru=m(os),y(rn.$$.fragment,os),au=m(os),y(an.$$.fragment,os),os.forEach(t),jt.forEach(t),nc=m(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var OT=i(ln);ml=a(OT,"SPAN",{});var ST=i(ml);y(rr.$$.fragment,ST),ST.forEach(t),OT.forEach(t),iu=m(Yc),fl=a(Yc,"SPAN",{});var AT=i(fl);lu=s(AT,"MobileBertForTokenClassification"),AT.forEach(t),Yc.forEach(t),sc=m(o),Ve=a(o,"DIV",{class:!0});var Ct=i(Ve);y(ar.$$.fragment,Ct),du=m(Ct),ul=a(Ct,"P",{});var IT=i(ul);cu=s(IT,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),IT.forEach(t),pu=m(Ct),ir=a(Ct,"P",{});var Jc=i(ir);hu=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var LT=i(Qa);mu=s(LT,"PreTrainedModel"),LT.forEach(t),fu=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),uu=m(Ct),lr=a(Ct,"P",{});var Zc=i(lr);gu=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var DT=i(dr);_u=s(DT,"torch.nn.Module"),DT.forEach(t),bu=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tu=m(Ct),Je=a(Ct,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),ku=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vu=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var WT=i(Ka);yu=s(WT,"MobileBertForTokenClassification"),WT.forEach(t),wu=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var RT=i(gl);Mu=s(RT,"__call__"),RT.forEach(t),$u=s(Ti," special method."),Ti.forEach(t),Fu=m(Nt),y(dn.$$.fragment,Nt),Bu=m(Nt),y(cn.$$.fragment,Nt),Eu=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),Ct.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var UT=i(hn);_l=a(UT,"SPAN",{});var HT=i(_l);y(pr.$$.fragment,HT),HT.forEach(t),UT.forEach(t),xu=m(Xc),bl=a(Xc,"SPAN",{});var QT=i(bl);zu=s(QT,"MobileBertForQuestionAnswering"),QT.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pu=m(Ot),po=a(Ot,"P",{});var ki=i(po);qu=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var KT=i(Tl);ju=s(KT,"span start logits"),KT.forEach(t),Cu=s(ki," and "),kl=a(ki,"CODE",{});var VT=i(kl);Nu=s(VT,"span end logits"),VT.forEach(t),Ou=s(ki,")."),ki.forEach(t),Su=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Au=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var GT=i(Va);Iu=s(GT,"PreTrainedModel"),GT.forEach(t),Lu=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Du=m(Ot),fr=a(Ot,"P",{});var tp=i(fr);Wu=s(tp,"This model is also a PyTorch "),ur=a(tp,"A",{href:!0,rel:!0});var YT=i(ur);Ru=s(YT,"torch.nn.Module"),YT.forEach(t),Uu=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Hu=m(Ot),Ze=a(Ot,"DIV",{class:!0});var St=i(Ze);y(gr.$$.fragment,St),Qu=m(St),ho=a(St,"P",{});var vi=i(ho);Ku=s(vi,"The "),Ga=a(vi,"A",{href:!0});var JT=i(Ga);Vu=s(JT,"MobileBertForQuestionAnswering"),JT.forEach(t),Gu=s(vi," forward method, overrides the "),vl=a(vi,"CODE",{});var ZT=i(vl);Yu=s(ZT,"__call__"),ZT.forEach(t),Ju=s(vi," special method."),vi.forEach(t),Zu=m(St),y(mn.$$.fragment,St),Xu=m(St),y(fn.$$.fragment,St),eg=m(St),y(un.$$.fragment,St),St.forEach(t),Ot.forEach(t),ic=m(o),mo=a(o,"H2",{class:!0});var op=i(mo);gn=a(op,"A",{id:!0,class:!0,href:!0});var XT=i(gn);yl=a(XT,"SPAN",{});var ek=i(yl);y(_r.$$.fragment,ek),ek.forEach(t),XT.forEach(t),tg=m(op),wl=a(op,"SPAN",{});var tk=i(wl);og=s(tk,"TFMobileBertModel"),tk.forEach(t),op.forEach(t),lc=m(o),Ne=a(o,"DIV",{class:!0});var gt=i(Ne);y(br.$$.fragment,gt),ng=m(gt),Ml=a(gt,"P",{});var ok=i(Ml);sg=s(ok,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),ok.forEach(t),rg=m(gt),Tr=a(gt,"P",{});var np=i(Tr);ag=s(np,"This model inherits from "),Ya=a(np,"A",{href:!0});var nk=i(Ya);ig=s(nk,"TFPreTrainedModel"),nk.forEach(t),lg=s(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sp.forEach(t),mg=m(gt),y(_n.$$.fragment,gt),fg=m(gt),pt=a(gt,"DIV",{class:!0});var ns=i(pt);y(yr.$$.fragment,ns),ug=m(ns),fo=a(ns,"P",{});var yi=i(fo);gg=s(yi,"The "),Ja=a(yi,"A",{href:!0});var rk=i(Ja);_g=s(rk,"TFMobileBertModel"),rk.forEach(t),bg=s(yi," forward method, overrides the "),$l=a(yi,"CODE",{});var ak=i($l);Tg=s(ak,"__call__"),ak.forEach(t),kg=s(yi," special method."),yi.forEach(t),vg=m(ns),y(bn.$$.fragment,ns),yg=m(ns),y(Tn.$$.fragment,ns),ns.forEach(t),gt.forEach(t),dc=m(o),uo=a(o,"H2",{class:!0});var rp=i(uo);kn=a(rp,"A",{id:!0,class:!0,href:!0});var ik=i(kn);Fl=a(ik,"SPAN",{});var lk=i(Fl);y(wr.$$.fragment,lk),lk.forEach(t),ik.forEach(t),wg=m(rp),Bl=a(rp,"SPAN",{});var dk=i(Bl);Mg=s(dk,"TFMobileBertForPreTraining"),dk.forEach(t),rp.forEach(t),cc=m(o),Oe=a(o,"DIV",{class:!0});var _t=i(Oe);y(Mr.$$.fragment,_t),$g=m(_t),go=a(_t,"P",{});var wi=i(go);Fg=s(wi,"MobileBert Model with two heads on top as done during the pretraining: a "),El=a(wi,"CODE",{});var ck=i(El);Bg=s(ck,"masked language modeling"),ck.forEach(t),Eg=s(wi,` head and a
`),xl=a(wi,"CODE",{});var pk=i(xl);xg=s(pk,"next sentence prediction (classification)"),pk.forEach(t),zg=s(wi," head."),wi.forEach(t),Pg=m(_t),$r=a(_t,"P",{});var ap=i($r);qg=s(ap,"This model inherits from "),Za=a(ap,"A",{href:!0});var hk=i(Za);jg=s(hk,"TFPreTrainedModel"),hk.forEach(t),Cg=s(ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=m(_t),y(vn.$$.fragment,_t),Lg=m(_t),ht=a(_t,"DIV",{class:!0});var ss=i(ht);y(Er.$$.fragment,ss),Dg=m(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var fk=i(Xa);Rg=s(fk,"TFMobileBertForPreTraining"),fk.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var uk=i(zl);Hg=s(uk,"__call__"),uk.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=m(ss),y(yn.$$.fragment,ss),Vg=m(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=m(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var gk=i(Mn);Pl=a(gk,"SPAN",{});var _k=i(Pl);y(xr.$$.fragment,_k),_k.forEach(t),gk.forEach(t),Gg=m(lp),ql=a(lp,"SPAN",{});var bk=i(ql);Yg=s(bk,"TFMobileBertForMaskedLM"),bk.forEach(t),lp.forEach(t),hc=m(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=m(bt),Pr=a(bt,"P",{});var dp=i(Pr);Zg=s(dp,"MobileBert Model with a "),jl=a(dp,"CODE",{});var Tk=i(jl);Xg=s(Tk,"language modeling"),Tk.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=m(bt),qr=a(bt,"P",{});var cp=i(qr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var kk=i(ei);n_=s(kk,"TFPreTrainedModel"),kk.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cp.forEach(t),r_=m(bt),jr=a(bt,"P",{});var pp=i(jr);a_=s(pp,"This model is also a "),Cr=a(pp,"A",{href:!0,rel:!0});var vk=i(Cr);i_=s(vk,"tf.keras.Model"),vk.forEach(t),l_=s(pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=m(bt),y($n.$$.fragment,bt),c_=m(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);y(Nr.$$.fragment,At),p_=m(At),To=a(At,"P",{});var $i=i(To);h_=s($i,"The "),ti=a($i,"A",{href:!0});var yk=i(ti);m_=s(yk,"TFMobileBertForMaskedLM"),yk.forEach(t),f_=s($i," forward method, overrides the "),Cl=a($i,"CODE",{});var wk=i(Cl);u_=s(wk,"__call__"),wk.forEach(t),g_=s($i," special method."),$i.forEach(t),__=m(At),y(Fn.$$.fragment,At),b_=m(At),y(Bn.$$.fragment,At),T_=m(At),y(En.$$.fragment,At),At.forEach(t),bt.forEach(t),mc=m(o),ko=a(o,"H2",{class:!0});var hp=i(ko);xn=a(hp,"A",{id:!0,class:!0,href:!0});var Mk=i(xn);Nl=a(Mk,"SPAN",{});var $k=i(Nl);y(Or.$$.fragment,$k),$k.forEach(t),Mk.forEach(t),k_=m(hp),Ol=a(hp,"SPAN",{});var Fk=i(Ol);v_=s(Fk,"TFMobileBertForNextSentencePrediction"),Fk.forEach(t),hp.forEach(t),fc=m(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);y(Sr.$$.fragment,Tt),y_=m(Tt),Ar=a(Tt,"P",{});var mp=i(Ar);w_=s(mp,"MobileBert Model with a "),Sl=a(mp,"CODE",{});var Bk=i(Sl);M_=s(Bk,"next sentence prediction (classification)"),Bk.forEach(t),$_=s(mp," head on top."),mp.forEach(t),F_=m(Tt),Ir=a(Tt,"P",{});var fp=i(Ir);B_=s(fp,"This model inherits from "),oi=a(fp,"A",{href:!0});var Ek=i(oi);E_=s(Ek,"TFPreTrainedModel"),Ek.forEach(t),x_=s(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),z_=m(Tt),Lr=a(Tt,"P",{});var up=i(Lr);P_=s(up,"This model is also a "),Dr=a(up,"A",{href:!0,rel:!0});var xk=i(Dr);q_=s(xk,"tf.keras.Model"),xk.forEach(t),j_=s(up,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),up.forEach(t),C_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zk=i(ni);A_=s(zk,"TFMobileBertForNextSentencePrediction"),zk.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pk=i(Al);L_=s(Pk,"__call__"),Pk.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(Pn.$$.fragment,rs),R_=m(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),uc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);jn=a(gp,"A",{id:!0,class:!0,href:!0});var qk=i(jn);Il=a(qk,"SPAN",{});var jk=i(Il);y(Rr.$$.fragment,jk),jk.forEach(t),qk.forEach(t),U_=m(gp),Ll=a(gp,"SPAN",{});var Ck=i(Ll);H_=s(Ck,"TFMobileBertForSequenceClassification"),Ck.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Dl=a(kt,"P",{});var Nk=i(Dl);K_=s(Nk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
linear layers on top of the hidden-states output to compute `),Xl=a(zi,"CODE",{});var rv=i(Xl);l1=s(rv,"span start logits"),rv.forEach(t),d1=s(zi," and "),ed=a(zi,"CODE",{});var av=i(ed);c1=s(av,"span end logits"),av.forEach(t),p1=s(zi,")."),zi.forEach(t),h1=m(wt),da=a(wt,"P",{});var Fp=i(da);m1=s(Fp,"This model inherits from "),ci=a(Fp,"A",{href:!0});var iv=i(ci);f1=s(iv,"TFPreTrainedModel"),iv.forEach(t),u1=s(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
