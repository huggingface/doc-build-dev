---
local: how-to-finetune-a-model-for-common-downstream-tasks
sections:
- local: sequence-classification-with-imdb-reviews
  sections:
  - local: load-imdb-dataset
    title: Load IMDb dataset
  - local: preprocess
    title: Preprocess
  - local: finetune-with-the-trainer-api
    title: Fine-tune with the Trainer API
  - local: finetune-with-tensorflow
    title: Fine-tune with TensorFlow
  title: Sequence classification with IMDb reviews
- local: token-classification-with-wnut-emerging-entities
  sections:
  ...
  - local: finetune-with-tensorflow
    title: Fine-tune with TensorFlow
  title: Token classification with WNUT emerging entities
- local: question-answering-with-squad
  sections:
  - local: load-squad-dataset
    title: Load SQuAD dataset
  - local: preprocess
    title: Preprocess
  - local: finetune-with-the-trainer-api
    title: Fine-tune with the Trainer API
  - local: finetune-with-tensorflow
    title: Fine-tune with TensorFlow
  title: Question Answering with SQuAD
title: How to fine-tune a model for common downstream tasks
---
<script>
...
<h1 id="how-to-finetune-a-model-for-common-downstream-tasks">How to fine-tune a model for common downstream tasks</h1>

<DocNotebookDropdown hydrate-props={{
  classNames: "absolute z-10 right-0 top-0",
  options:[
    {label: "Mixed", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/custom_datasets.ipynb"},
    {label: "PyTorch", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/custom_datasets.ipynb"},
    {label: "TensorFlow", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/custom_datasets.ipynb"},
    {label: "Mixed", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/transformers_doc/custom_datasets.ipynb"},
    {label: "PyTorch", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/custom_datasets.ipynb"},
    {label: "TensorFlow", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/custom_datasets.ipynb"},
]}} />
...
<h2 id="sequence-classification-with-imdb-reviews">Sequence classification with IMDb reviews</h2>
...
<h3 id="load-imdb-dataset">Load IMDb dataset</h3>
...
[AutoTokenizer](/docs/transformers/pr_15786/en/model_doc/auto#transformers.AutoTokenizer) because we will eventually train a classifier using a pretrained [DistilBERT](https://huggingface.co/distilbert-base-uncased) model:
...
<h3 id="finetune-with-the-trainer-api">Fine-tune with the Trainer API</h3>

Now load your model with the [AutoModelForSequenceClassification](/docs/transformers/pr_15786/en/model_doc/auto#transformers.AutoModelForSequenceClassification) class along with the number of expected labels:
...
1. Define your training hyperparameters in [TrainingArguments](/docs/transformers/pr_15786/en/main_classes/trainer#transformers.TrainingArguments).
2. Pass the training arguments to a [Trainer](/docs/transformers/pr_15786/en/main_classes/trainer#transformers.Trainer) along with the model, dataset, tokenizer, and data collator.
...
Start by batching the processed examples together with dynamic padding using the [DataCollatorWithPadding](/docs/transformers/pr_15786/en/main_classes/data_collator#transformers.DataCollatorWithPadding) function.
...
Load your model with the [TFAutoModelForSequenceClassification](/docs/transformers/pr_15786/en/model_doc/auto#transformers.TFAutoModelForSequenceClassification) class along with the number of expected labels:
...
<h2 id="token-classification-with-wnut-emerging-entities">Token classification with WNUT emerging entities</h2>
...
<h3 id="load-wnut-17-dataset">Load WNUT 17 dataset</h3>
...
Now you need to tokenize the text. Load the DistilBERT tokenizer with an [AutoTokenizer](/docs/transformers/pr_15786/en/model_doc/auto#transformers.AutoTokenizer):
...
Load your model with the [AutoModelForTokenClassification](/docs/transformers/pr_15786/en/model_doc/auto#transformers.AutoModelForTokenClassification) class along with the number of expected labels:
...
Gather your training arguments in [TrainingArguments](/docs/transformers/pr_15786/en/main_classes/trainer#transformers.TrainingArguments):
...
Collect your model, training arguments, dataset, data collator, and tokenizer in [Trainer](/docs/transformers/pr_15786/en/main_classes/trainer#transformers.Trainer):
...
Load the model with the [TFAutoModelForTokenClassification](/docs/transformers/pr_15786/en/model_doc/auto#transformers.TFAutoModelForTokenClassification) class along with the number of expected labels:
...
<h2 id="question-answering-with-squad">Question Answering with SQuAD</h2>
...
<h3 id="load-squad-dataset">Load SQuAD dataset</h3>
...
```python
>>> squad["train"][0]
&amp;lcub;'answers': &amp;lcub;'answer_start': [515], 'text': ['Saint Bernadette Soubirous']},
...
Load the DistilBERT tokenizer with an [AutoTokenizer](/docs/transformers/pr_15786/en/model_doc/auto#transformers.AutoTokenizer):
...
Load your model with the [AutoModelForQuestionAnswering](/docs/transformers/pr_15786/en/model_doc/auto#transformers.AutoModelForQuestionAnswering) class:
...
Load your model with the [TFAutoModelForQuestionAnswering](/docs/transformers/pr_15786/en/model_doc/auto#transformers.TFAutoModelForQuestionAnswering) class:
