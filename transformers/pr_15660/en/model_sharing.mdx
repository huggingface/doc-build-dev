...
After you fine-tune your model, call [push_to_hub()](/docs/transformers/pr_15660/en/main_classes/trainer#transformers.Trainer.push_to_hub) on [Trainer](/docs/transformers/pr_15660/en/main_classes/trainer#transformers.Trainer) to push the trained model to the Hub. 🤗 Transformers will even automatically add training hyperparameters, training results and framework versions to your model card!
...
TensorFlow users can enable the same functionality with [PushToHubCallback](/docs/transformers/pr_15660/en/main_classes/keras_callbacks#transformers.PushToHubCallback). In the [PushToHubCallback](/docs/transformers/pr_15660/en/main_classes/keras_callbacks#transformers.PushToHubCallback) function, add:
