import{S as As,i as Is,s as Os,e as a,k as d,w as k,t as n,M as Ss,c as s,d as o,m as c,a as i,x as y,h as r,b as l,G as e,g as p,y as L,L as Cs,q as b,o as v,B as w,v as Us}from"../../chunks/vendor-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ds}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Vt}from"../../chunks/IconCopyLink-hf-doc-builder.js";function Ws(ga){let S,Gt,C,j,dt,ne,Mo,ct,Xo,Ht,U,V,ut,re,Eo,pt,qo,Yt,q,$o,ae,Fo,Po,se,No,Do,Jt,Fe,Ao,Zt,Pe,mt,Io,Kt,Ne,Oo,Qt,ie,eo,$,So,De,Co,Uo,Ae,Wo,Ro,to,le,oo,z,Bo,Ie,jo,Vo,Oe,Go,Ho,Se,Yo,Jo,Ce,Zo,Ko,no,G,Qo,Ue,en,tn,ro,F,on,de,nn,rn,ce,an,sn,ao,W,H,ft,ue,ln,ht,dn,so,_,pe,cn,E,un,We,pn,mn,Re,fn,hn,me,_n,gn,kn,fe,yn,Be,Ln,bn,vn,Y,he,wn,_t,xn,Tn,P,_e,zn,gt,Mn,Xn,ge,je,En,kt,qn,$n,Ve,Fn,yt,Pn,Nn,J,ke,Dn,ye,An,Lt,In,On,Sn,Z,Le,Cn,bt,Un,Wn,Ge,be,io,R,K,vt,ve,Rn,wt,Bn,lo,M,we,jn,X,Vn,xt,Gn,Hn,He,Yn,Jn,Ye,Zn,Kn,xe,Qn,er,tr,Te,or,Je,nr,rr,ar,Q,ze,sr,Tt,ir,co,B,ee,zt,Me,lr,Mt,dr,uo,T,Xe,cr,Xt,ur,pr,Ze,Ke,mr,fr,hr,h,_r,Qe,gr,kr,et,yr,Lr,tt,br,vr,Et,wr,xr,qt,Tr,zr,$t,Mr,Xr,Ft,Er,qr,Pt,$r,Fr,Nt,Pr,Nr,Dr,N,Ee,Ar,m,Ir,Dt,Or,Sr,qe,At,Cr,Ur,Wr,ot,Rr,Br,It,jr,Vr,Ot,Gr,Hr,$e,St,Yr,Jr,Zr,Ct,Kr,Qr,nt,ea,ta,Ut,oa,na,Wt,ra,aa,Rt,sa,ia,Bt,la,da,ca,jt,ua,po;return ne=new Vt({}),re=new Vt({}),ie=new Ds({props:{code:`from transformers import LayoutLMv2Model
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LayoutXLMTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_18280/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_18280/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_18280/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L444",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18280/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18280/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L316",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18280/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L342",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18280/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L370",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),be=new O({props:{name:"save_vocabulary",anchor:"transformers.LayoutXLMTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_18280/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L427"}}),ve=new Vt({}),we=new O({props:{name:"class transformers.LayoutXLMTokenizerFast",anchor:"transformers.LayoutXLMTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutXLMTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_18280/src/transformers/models/layoutxlm/tokenization_layoutxlm_fast.py#L168",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18280/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
data for the model.`),no=d(),G=a("p"),Qo=n("As LayoutXLM\u2019s architecture is equivalent to that of LayoutLMv2, one can refer to "),Ue=a("a"),en=n("LayoutLMv2\u2019s documentation page"),tn=n(" for all tips, code examples and notebooks."),ro=d(),F=a("p"),on=n("This model was contributed by "),de=a("a"),nn=n("nielsr"),rn=n(". The original code can be found "),ce=a("a"),an=n("here"),sn=n("."),ao=d(),W=a("h2"),H=a("a"),ft=a("span"),k(ue.$$.fragment),ln=d(),ht=a("span"),dn=n("LayoutXLMTokenizer"),so=d(),_=a("div"),k(pe.$$.fragment),cn=d(),E=a("p"),un=n("Adapted from "),We=a("a"),pn=n("RobertaTokenizer"),mn=n(" and "),Re=a("a"),fn=n("XLNetTokenizer"),hn=n(`. Based on
`),me=a("a"),_n=n("SentencePiece"),gn=n("."),kn=d(),fe=a("p"),yn=n("This tokenizer inherits from "),Be=a("a"),Ln=n("PreTrainedTokenizer"),bn=n(` which contains most of the main methods. Users should refer to
...
single processor.`),pr=d(),Ze=a("p"),Ke=a("a"),mr=n("LayoutXLMProcessor"),fr=n(" offers all the functionalities you need to prepare data for the model."),hr=d(),h=a("p"),_r=n("It first uses "),Qe=a("a"),gr=n("LayoutLMv2FeatureExtractor"),kr=n(` to resize document images to a fixed size, and optionally applies OCR
...
into token-level `),Nt=a("code"),Pr=n("labels"),Nr=n(" for token classification tasks (such as FUNSD, CORD)."),Dr=d(),N=a("div"),k(Ee.$$.fragment),Ar=d(),m=a("p"),Ir=n("This method first forwards the "),Dt=a("code"),Or=n("images"),Sr=n(" argument to "),qe=a("a"),At=a("strong"),Cr=n("call"),Ur=n("()"),Wr=n(`. In case
...
on 53 languages.`),rt.forEach(o),Jt=c(t),Fe=s(t,"P",{});var za=i(Fe);Ao=r(za,"The abstract from the paper is the following:"),za.forEach(o),Zt=c(t),Pe=s(t,"P",{});var Ma=i(Pe);mt=s(Ma,"EM",{});var Xa=i(mt);Io=r(Xa,`Multimodal pre-training with text, layout, and image has achieved SOTA performance for visually-rich document
understanding tasks recently, which demonstrates the great potential for joint learning across different modalities. In
this paper, we present LayoutXLM, a multimodal pre-trained model for multilingual document understanding, which aims to
bridge the language barriers for visually-rich document understanding. To accurately evaluate LayoutXLM, we also
introduce a multilingual form understanding benchmark dataset named XFUN, which includes form understanding samples in
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Ga.forEach(o),Xn=c(it),ge=s(it,"UL",{});var yo=i(ge);je=s(yo,"LI",{});var pa=i(je);En=r(pa,"single sequence: "),kt=s(pa,"CODE",{});var Ha=i(kt);qn=r(Ha,"<s> X </s>"),Ha.forEach(o),pa.forEach(o),$n=c(yo),Ve=s(yo,"LI",{});var ma=i(Ve);Fn=r(ma,"pair of sequences: "),yt=s(ma,"CODE",{});var Ya=i(yt);Pn=r(Ya,"<s> A </s></s> B </s>"),Ya.forEach(o),ma.forEach(o),yo.forEach(o),it.forEach(o),Nn=c(x),J=s(x,"DIV",{class:!0});var Lo=i(J);y(ke.$$.fragment,Lo),Dn=c(Lo),ye=s(Lo,"P",{});var bo=i(ye);An=r(bo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
single processor.`),us.forEach(o),pr=c(I),Ze=s(I,"P",{});var fa=i(Ze);Ke=s(fa,"A",{href:!0});var ps=i(Ke);mr=r(ps,"LayoutXLMProcessor"),ps.forEach(o),fr=r(fa," offers all the functionalities you need to prepare data for the model."),fa.forEach(o),hr=c(I),h=s(I,"P",{});var g=i(h);_r=r(g,"It first uses "),Qe=s(g,"A",{href:!0});var ms=i(Qe);gr=r(ms,"LayoutLMv2FeatureExtractor"),ms.forEach(o),kr=r(g,` to resize document images to a fixed size, and optionally applies OCR
...
`),Wt=s(f,"CODE",{});var $s=i(Wt);ra=r($s,"False"),$s.forEach(o),aa=r(f,", it passes the words ("),Rt=s(f,"CODE",{});var Fs=i(Rt);sa=r(Fs,"text"),Fs.forEach(o),ia=r(f,"/"),Bt=s(f,"CODE",{});var Ps=i(Bt);la=r(Ps,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer.__call__) and returns the output, together with resized `images"),Ps.forEach(o),da=r(f,"."),f.forEach(o),ca=c(lt),jt=s(lt,"P",{});var Ns=i(jt);ua=r(Ns,"Please refer to the docstring of the above two methods for more information."),Ns.forEach(o),lt.forEach(o),I.forEach(o),this.h()},h(){l(S,"name","hf:doc:metadata"),l(S,"content",JSON.stringify(Rs)),l(j,"id","layoutxlm"),l(j,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(j,"href","#layoutxlm"),l(C,"class","relative group"),l(V,"id","overview"),l(V,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(V,"href","#overview"),l(U,"class","relative group"),l(ae,"href","https://arxiv.org/abs/2104.08836"),l(ae,"rel","nofollow"),l(se,"href","https://arxiv.org/abs/2012.14740"),l(se,"rel","nofollow"),l(De,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer"),l(Ae,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizerFast"),l(Ie,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMProcessor"),l(Oe,"href","/docs/transformers/pr_18280/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"),l(Se,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer"),l(Ce,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizerFast"),l(Ue,"href","layoutlmv2"),l(de,"href","https://huggingface.co/nielsr"),l(de,"rel","nofollow"),l(ce,"href","https://github.com/microsoft/unilm"),l(ce,"rel","nofollow"),l(H,"id","transformers.LayoutXLMTokenizer"),l(H,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(H,"href","#transformers.LayoutXLMTokenizer"),l(W,"class","relative group"),l(We,"href","/docs/transformers/pr_18280/en/model_doc/roberta#transformers.RobertaTokenizer"),l(Re,"href","/docs/transformers/pr_18280/en/model_doc/xlnet#transformers.XLNetTokenizer"),l(me,"href","https://github.com/google/sentencepiece"),l(me,"rel","nofollow"),l(Be,"href","/docs/transformers/pr_18280/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(K,"id","transformers.LayoutXLMTokenizerFast"),l(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(K,"href","#transformers.LayoutXLMTokenizerFast"),l(R,"class","relative group"),l(He,"href","/docs/transformers/pr_18280/en/model_doc/roberta#transformers.RobertaTokenizer"),l(Ye,"href","/docs/transformers/pr_18280/en/model_doc/xlnet#transformers.XLNetTokenizer"),l(xe,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=BPE#models"),l(xe,"rel","nofollow"),l(Je,"href","/docs/transformers/pr_18280/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ee,"id","transformers.LayoutXLMProcessor"),l(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ee,"href","#transformers.LayoutXLMProcessor"),l(B,"class","relative group"),l(Ke,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMProcessor"),l(Qe,"href","/docs/transformers/pr_18280/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"),l(et,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer"),l(tt,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizerFast"),l(qe,"href","/docs/transformers/pr_18280/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor.__call__"),l(ot,"href","/docs/transformers/pr_18280/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"),l($e,"href","/docs/transformers/pr_18280/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer.__call__"),l(nt,"href","/docs/transformers/pr_18280/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"),l(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,u){e(document.head,S),p(t,Gt,u),p(t,C,u),e(C,j),e(j,dt),L(ne,dt,null),e(C,Mo),e(C,ct),e(ct,Xo),p(t,Ht,u),p(t,U,u),e(U,V),e(V,ut),L(re,ut,null),e(U,Eo),e(U,pt),e(pt,qo),p(t,Yt,u),p(t,q,u),e(q,$o),e(q,ae),e(ae,Fo),e(q,Po),e(q,se),e(se,No),e(q,Do),p(t,Jt,u),p(t,Fe,u),e(Fe,Ao),p(t,Zt,u),p(t,Pe,u),e(Pe,mt),e(mt,Io),p(t,Kt,u),p(t,Ne,u),e(Ne,Oo),p(t,Qt,u),L(ie,t,u),p(t,eo,u),p(t,$,u),e($,So),e($,De),e(De,Co),e($,Uo),e($,Ae),e(Ae,Wo),e($,Ro),p(t,to,u),L(le,t,u),p(t,oo,u),p(t,z,u),e(z,Bo),e(z,Ie),e(Ie,jo),e(z,Vo),e(z,Oe),e(Oe,Go),e(z,Ho),e(z,Se),e(Se,Yo),e(z,Jo),e(z,Ce),e(Ce,Zo),e(z,Ko),p(t,no,u),p(t,G,u),e(G,Qo),e(G,Ue),e(Ue,en),e(G,tn),p(t,ro,u),p(t,F,u),e(F,on),e(F,de),e(de,nn),e(F,rn),e(F,ce),e(ce,an),e(F,sn),p(t,ao,u),p(t,W,u),e(W,H),e(H,ft),L(ue,ft,null),e(W,ln),e(W,ht),e(ht,dn),p(t,so,u),p(t,_,u),L(pe,_,null),e(_,cn),e(_,E),e(E,un),e(E,We),e(We,pn),e(E,mn),e(E,Re),e(Re,fn),e(E,hn),e(E,me),e(me,_n),e(E,gn),e(_,kn),e(_,fe),e(fe,yn),e(fe,Be),e(Be,Ln),e(fe,bn),e(_,vn),e(_,Y),L(he,Y,null),e(Y,wn),e(Y,_t),e(_t,xn),e(_,Tn),e(_,P),L(_e,P,null),e(P,zn),e(P,gt),e(gt,Mn),e(P,Xn),e(P,ge),e(ge,je),e(je,En),e(je,kt),e(kt,qn),e(ge,$n),e(ge,Ve),e(Ve,Fn),e(Ve,yt),e(yt,Pn),e(_,Nn),e(_,J),L(ke,J,null),e(J,Dn),e(J,ye),e(ye,An),e(ye,Lt),e(Lt,In),e(ye,On),e(_,Sn),e(_,Z),L(Le,Z,null),e(Z,Cn),e(Z,bt),e(bt,Un),e(_,Wn),e(_,Ge),L(be,Ge,null),p(t,io,u),p(t,R,u),e(R,K),e(K,vt),L(ve,vt,null),e(R,Rn),e(R,wt),e(wt,Bn),p(t,lo,u),p(t,M,u),L(we,M,null),e(M,jn),e(M,X),e(X,Vn),e(X,xt),e(xt,Gn),e(X,Hn),e(X,He),e(He,Yn),e(X,Jn),e(X,Ye),e(Ye,Zn),e(X,Kn),e(X,xe),e(xe,Qn),e(X,er),e(M,tr),e(M,Te),e(Te,or),e(Te,Je),e(Je,nr),e(Te,rr),e(M,ar),e(M,Q),L(ze,Q,null),e(Q,sr),e(Q,Tt),e(Tt,ir),p(t,co,u),p(t,B,u),e(B,ee),e(ee,zt),L(Me,zt,null),e(B,lr),e(B,Mt),e(Mt,dr),p(t,uo,u),p(t,T,u),L(Xe,T,null),e(T,cr),e(T,Xt),e(Xt,ur),e(T,pr),e(T,Ze),e(Ze,Ke),e(Ke,mr),e(Ze,fr),e(T,hr),e(T,h),e(h,_r),e(h,Qe),e(Qe,gr),e(h,kr),e(h,et),e(et,yr),e(h,Lr),e(h,tt),e(tt,br),e(h,vr),e(h,Et),e(Et,wr),e(h,xr),e(h,qt),e(qt,Tr),e(h,zr),e(h,$t),e($t,Mr),e(h,Xr),e(h,Ft),e(Ft,Er),e(h,qr),e(h,Pt),e(Pt,$r),e(h,Fr),e(h,Nt),e(Nt,Pr),e(h,Nr),e(T,Dr),e(T,N),L(Ee,N,null),e(N,Ar),e(N,m),e(m,Ir),e(m,Dt),e(Dt,Or),e(m,Sr),e(m,qe),e(qe,At),e(At,Cr),e(qe,Ur),e(m,Wr),e(m,ot),e(ot,Rr),e(m,Br),e(m,It),e(It,jr),e(m,Vr),e(m,Ot),e(Ot,Gr),e(m,Hr),e(m,$e),e($e,St),e(St,Yr),e($e,Jr),e(m,Zr),e(m,Ct),e(Ct,Kr),e(m,Qr),e(m,nt),e(nt,ea),e(m,ta),e(m,Ut),e(Ut,oa),e(m,na),e(m,Wt),e(Wt,ra),e(m,aa),e(m,Rt),e(Rt,sa),e(m,ia),e(m,Bt),e(Bt,la),e(m,da),e(N,ca),e(N,jt),e(jt,ua),po=!0},p:Cs,i(t){po||(b(ne.$$.fragment,t),b(re.$$.fragment,t),b(ie.$$.fragment,t),b(le.$$.fragment,t),b(ue.$$.fragment,t),b(pe.$$.fragment,t),b(he.$$.fragment,t),b(_e.$$.fragment,t),b(ke.$$.fragment,t),b(Le.$$.fragment,t),b(be.$$.fragment,t),b(ve.$$.fragment,t),b(we.$$.fragment,t),b(ze.$$.fragment,t),b(Me.$$.fragment,t),b(Xe.$$.fragment,t),b(Ee.$$.fragment,t),po=!0)},o(t){v(ne.$$.fragment,t),v(re.$$.fragment,t),v(ie.$$.fragment,t),v(le.$$.fragment,t),v(ue.$$.fragment,t),v(pe.$$.fragment,t),v(he.$$.fragment,t),v(_e.$$.fragment,t),v(ke.$$.fragment,t),v(Le.$$.fragment,t),v(be.$$.fragment,t),v(ve.$$.fragment,t),v(we.$$.fragment,t),v(ze.$$.fragment,t),v(Me.$$.fragment,t),v(Xe.$$.fragment,t),v(Ee.$$.fragment,t),po=!1},d(t){o(S),t&&o(Gt),t&&o(C),w(ne),t&&o(Ht),t&&o(U),w(re),t&&o(Yt),t&&o(q),t&&o(Jt),t&&o(Fe),t&&o(Zt),t&&o(Pe),t&&o(Kt),t&&o(Ne),t&&o(Qt),w(ie,t),t&&o(eo),t&&o($),t&&o(to),w(le,t),t&&o(oo),t&&o(z),t&&o(no),t&&o(G),t&&o(ro),t&&o(F),t&&o(ao),t&&o(W),w(ue),t&&o(so),t&&o(_),w(pe),w(he),w(_e),w(ke),w(Le),w(be),t&&o(io),t&&o(R),w(ve),t&&o(lo),t&&o(M),w(we),w(ze),t&&o(co),t&&o(B),w(Me),t&&o(uo),t&&o(T),w(Xe),w(Ee)}}}const Rs={local:"layoutxlm",sections:[{local:"overview",title:"Overview"},{local:"transformers.LayoutXLMTokenizer",title:"LayoutXLMTokenizer"},{local:"transformers.LayoutXLMTokenizerFast",title:"LayoutXLMTokenizerFast"},{local:"transformers.LayoutXLMProcessor",title:"LayoutXLMProcessor"}],title:"LayoutXLM"};function Bs(ga){return Us(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ys extends As{constructor(S){super();Is(this,S,Bs,Ws,Os,{})}}export{Ys as default,Rs as metadata};
