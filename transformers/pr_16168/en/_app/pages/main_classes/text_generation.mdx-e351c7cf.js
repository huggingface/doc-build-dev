import{S as Um,i as Vm,s as Km,e as s,k as l,w as m,t,M as Zm,c as a,d as o,m as d,a as r,x as g,h as n,b as c,F as e,g as w,y as _,q as u,o as h,B as f}from"../../chunks/vendor-6b77c823.js";import{T as Rm}from"../../chunks/Tip-39098574.js";import{D as be}from"../../chunks/Docstring-abef54e3.js";import{C as ye}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Cs}from"../../chunks/IconCopyLink-7a11ce68.js";function Xm(it){let p,P,j,T,I,E,xe,W,G,B,v;return{c(){p=s("p"),P=t("Apart from "),j=s("code"),T=t("inputs"),I=t(`, all the arguments below will default to the value of the attribute of the same name as
...
<p>A <a
  href="/docs/transformers/pr_16168/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
>SampleDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
>BeamSearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
>SampleEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
An derived instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
A derived instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An derived instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
documentation of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16168/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
`),Nn=s("code"),Fa=t("do_sample=True"),Aa=t("."),za=l(),V=s("li"),Dn=s("em"),Pa=t("beam-search decoding"),Na=t(" by calling "),mn=s("a"),Da=t("beam_search()"),Ca=t(" if "),Cn=s("code"),Ia=t("num_beams>1"),Wa=t(` and
...
`),oo=s("code"),Pr=t("do_sample=True"),Nr=t("."),Dr=l(),Y=s("li"),so=s("em"),Cr=t("beam-search decoding"),Ir=t(" by calling "),bn=s("a"),Wr=t("beam_search()"),Br=t(" if "),ao=s("code"),Hr=t("num_beams>1"),Rr=t(` and
...
decoding`),Tl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),El=l(),So=s("p"),Ol=t("Examples:"),ql=l(),m(At.$$.fragment),fs=l(),Te=s("h2"),Je=s("a"),$o=s("span"),m(zt.$$.fragment),Gl=l(),Fo=s("span"),Sl=t("TFGenerationMixn"),bs=l(),ke=s("div"),m(Pt.$$.fragment),$l=l(),Nt=s("p"),Fl=t("A class containing all of the functions supporting generation, to be used as a mixin in "),yn=s("a"),Al=t("TFPreTrainedModel"),zl=t("."),Pl=l(),O=s("div"),m(Dt.$$.fragment),Nl=l(),Ao=s("p"),Dl=t(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
post`),td=t("."),nd=l(),No=s("p"),od=t("Examples:"),sd=l(),m(Ht.$$.fragment),xs=l(),Ee=s("h2"),Qe=s("a"),Do=s("span"),m(Rt.$$.fragment),ad=l(),Co=s("span"),rd=t("FlaxGenerationMixn"),ks=l(),z=s("div"),m(Ut.$$.fragment),id=l(),Vt=s("p"),ld=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
and `),Ko=s("code"),Gd=t("do_sample=True"),Sd=t("."),$d=l(),pe=s("li"),Zo=s("em"),Fd=t("beam-search decoding"),Ad=t(" by calling "),Xo=s("code"),zd=t("_beam_search"),Pd=t(" if "),Jo=s("code"),Nd=t("num_beams>1"),Dd=t(`
...
`),ro=a(De,"CODE",{});var wp=r(ro);Ur=n(wp,"do_sample=False"),wp.forEach(o),Vr=n(De,"."),De.forEach(o),Kr=d(fe),ee=a(fe,"LI",{});var Ce=r(ee);io=a(Ce,"EM",{});var Tp=r(io);Zr=n(Tp,"beam-search multinomial sampling"),Tp.forEach(o),Xr=n(Ce," by calling "),xn=a(Ce,"A",{href:!0});var Ep=r(xn);Jr=n(Ep,"beam_sample()"),Ep.forEach(o),Qr=n(Ce,` if
...
`),ho=a(We,"CODE",{});var Np=r(ho);xi=n(Np,"force_words_ids!=None"),Np.forEach(o),ki=n(We,"."),We.forEach(o),fe.forEach(o),vi=d(M),g(Xe.$$.fragment,M),yi=d(M),gt=a(M,"P",{});var Ls=r(gt);ji=n(Ls,"Most of these parameters are explained in more detail in "),_t=a(Ls,"A",{href:!0,rel:!0});var Dp=r(_t);Mi=n(Dp,`this blog
post`),Dp.forEach(o),Li=n(Ls,"."),Ls.forEach(o),wi=d(M),fo=a(M,"P",{});var Cp=r(fo);Ti=n(Cp,"Examples:"),Cp.forEach(o),Ei=d(M),bo=a(M,"P",{});var Ip=r(bo);Oi=n(Ip,"Greedy Decoding:"),Ip.forEach(o),qi=d(M),g(ut.$$.fragment,M),Gi=d(M),xo=a(M,"P",{});var Wp=r(xo);Si=n(Wp,"Multinomial Sampling:"),Wp.forEach(o),$i=d(M),g(ht.$$.fragment,M),Fi=d(M),ko=a(M,"P",{});var Bp=r(ko);Ai=n(Bp,"Beam-search decoding:"),Bp.forEach(o),zi=d(M),g(ft.$$.fragment,M),M.forEach(o),Pi=d(L),oe=a(L,"DIV",{class:!0});var et=r(oe);g(bt.$$.fragment,et),Ni=d(et),xt=a(et,"P",{});var ws=r(xt);Di=n(ws,"Generates sequences of token ids for models with a language modeling head using "),vo=a(ws,"STRONG",{});var Hp=r(vo);Ci=n(Hp,"greedy decoding"),Hp.forEach(o),Ii=n(ws,` and can be
...
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),rm.forEach(o),Cl=d(D),Ct=a(D,"P",{});var Fs=r(Ct);Il=n(Fs,"Adapted in part from "),It=a(Fs,"A",{href:!0,rel:!0});var im=r(It);Wl=n(im,`Facebook\u2019s XLM beam search
code`),im.forEach(o),Bl=n(Fs,"."),Fs.forEach(o),Hl=d(D),ve=a(D,"P",{});var rt=r(ve);Rl=n(rt,"Apart from "),zo=a(rt,"CODE",{});var lm=r(zo);Ul=n(lm,"input_ids"),lm.forEach(o),Vl=n(rt," and "),Po=a(rt,"CODE",{});var dm=r(Po);Kl=n(dm,"attention_mask"),dm.forEach(o),Zl=n(rt,`, all the arguments below will default to the value of the attribute
