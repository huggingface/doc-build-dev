import{S as Qp,i as Yp,s as em,e as a,k as m,w as k,t,M as tm,c as r,d as o,m as g,a as i,x as v,h as n,b as h,G as e,g as x,y,q as j,o as M,B as w,v as nm,L as ue}from"../../chunks/vendor-hf-doc-builder.js";import{T as Jp}from"../../chunks/Tip-hf-doc-builder.js";import{D as ce}from"../../chunks/Docstring-hf-doc-builder.js";import{C as _e}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Cs}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ge}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function om(L){let d,f,u,c,_,s,p,C,q,I,S;return{c(){d=a("p"),f=t("Apart from "),u=a("code"),c=t("inputs"),_=t(`, all the arguments below will default to the value of the attribute of the same name as
...
should be prefixed with *decoder</em>*.`,name:"exponential_decay_length_penalty"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L844",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18257/en/main_classes/output#transformers.utils.ModelOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
>SampleDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
>BeamSearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
>SampleEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L1538",returnDescription:`
<p><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L1771",returnDescription:`
<p><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
An derived instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L2028",returnDescription:`
...
A derived instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L2336",returnDescription:`
<p><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
An derived instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L2654",returnDescription:`
<p><a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_utils.py#L3017",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_18257/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_tf_utils.py#L375",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18257/en/main_classes/output#transformers.utils.ModelOutput"
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If the model
is an encoder-decoder model, encoder specific kwargs should not be prefixed and decoder specific kwargs
should be prefixed with *decoder</em>*. Also accepts <code>encoder_outputs</code> to skip encoder part.`,name:"params"}],source:"https://github.com/huggingface/transformers/blob/vr_18257/src/transformers/generation_flax_utils.py#L163",returnDescription:`
<p><a
  href="/docs/transformers/pr_18257/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
...
`),Cn=a("code"),va=t("do_sample=False"),ya=t("."),ja=m(),W=a("li"),In=a("em"),Ma=t("multinomial sampling"),wa=t(" by calling "),pn=a("a"),La=t("sample()"),$a=t(" if "),Bn=a("code"),Ta=t("num_beams=1"),Ea=t(` and
...
`),vo=a("code"),_i=t("force_words_ids!=None"),hi=t("."),fi=m(),k(ot.$$.fragment),bi=m(),Mt=a("p"),xi=t("Most of these parameters are explained in more detail in "),wt=a("a"),ki=t(`this blog
post`),vi=t("."),yi=m(),yo=a("p"),ji=t("Examples:"),Mi=m(),k(st.$$.fragment),wi=m(),k(at.$$.fragment),Li=m(),k(rt.$$.fragment),$i=m(),be=a("div"),k(Lt.$$.fragment),Ti=m(),$t=a("p"),Ei=t("Generates sequences of token ids for models with a language modeling head using "),jo=a("strong"),Oi=t("greedy decoding"),Gi=t(` and can be
...
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Di=m(),k(lt.$$.fragment),Ni=m(),ke=a("div"),k(Ot.$$.fragment),Ci=m(),Gt=a("p"),Ii=t("Generates sequences of token ids for models with a language modeling head using "),wo=a("strong"),Bi=t("beam search decoding"),Wi=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Hi=m(),k(dt.$$.fragment),Ri=m(),ve=a("div"),k(qt.$$.fragment),Ui=m(),St=a("p"),Vi=t("Generates sequences of token ids for models with a language modeling head using "),Lo=a("strong"),Ki=t(`beam search multinomial
...
code`),vl=t("."),yl=m(),me=a("p"),jl=t("Apart from "),qo=a("code"),Ml=t("input_ids"),wl=t(" and "),So=a("code"),Ll=t("attention_mask"),$l=t(`, all the arguments below will default to the value of the attribute
...
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),vd=m(),Fe=a("ul"),oe=a("li"),Zo=a("em"),yd=t("greedy decoding"),jd=t(" by calling "),Xo=a("code"),Md=t("_greedy_search()"),wd=t(` if
...
`),vo=r(Ze,"CODE",{});var tp=i(vo);_i=n(tp,"force_words_ids!=None"),tp.forEach(o),hi=n(Ze,"."),Ze.forEach(o),ie.forEach(o),fi=g(G),v(ot.$$.fragment,G),bi=g(G),Mt=r(G,"P",{});var ws=i(Mt);xi=n(ws,"Most of these parameters are explained in more detail in "),wt=r(ws,"A",{href:!0,rel:!0});var np=i(wt);ki=n(np,`this blog
post`),np.forEach(o),vi=n(ws,"."),ws.forEach(o),yi=g(G),yo=r(G,"P",{});var op=i(yo);ji=n(op,"Examples:"),op.forEach(o),Mi=g(G),v(st.$$.fragment,G),wi=g(G),v(at.$$.fragment,G),Li=g(G),v(rt.$$.fragment,G),G.forEach(o),$i=g(O),be=r(O,"DIV",{class:!0});var $n=i(be);v(Lt.$$.fragment,$n),Ti=g($n),$t=r($n,"P",{});var Ls=i($t);Ei=n(Ls,"Generates sequences of token ids for models with a language modeling head using "),jo=r(Ls,"STRONG",{});var sp=i(jo);Oi=n(sp,"greedy decoding"),sp.forEach(o),Gi=n(Ls,` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ls.forEach(o),qi=g($n),v(it.$$.fragment,$n),$n.forEach(o),Si=g(O),xe=r(O,"DIV",{class:!0});var Tn=i(xe);v(Tt.$$.fragment,Tn),Fi=g(Tn),Et=r(Tn,"P",{});var $s=i(Et);zi=n($s,"Generates sequences of token ids for models with a language modeling head using "),Mo=r($s,"STRONG",{});var ap=i(Mo);Ai=n(ap,"multinomial sampling"),ap.forEach(o),Pi=n($s,` and
...
code`),_p.forEach(o),vl=n(Fs,"."),Fs.forEach(o),yl=g(le),me=r(le,"P",{});var bt=i(me);jl=n(bt,"Apart from "),qo=r(bt,"CODE",{});var hp=i(qo);Ml=n(hp,"input_ids"),hp.forEach(o),wl=n(bt," and "),So=r(bt,"CODE",{});var fp=i(So);Ll=n(fp,"attention_mask"),fp.forEach(o),$l=n(bt,`, all the arguments below will default to the value of the attribute
...
post`),Xp.forEach(o),Qd=n(Ns,"."),Ns.forEach(o),Yd=g(de),v(ft.$$.fragment,de),de.forEach(o),Me.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(fm)),h(c,"id","generation"),h(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(c,"href","#generation"),h(u,"class","relative group"),h(tn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(nn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),h(on,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),h(sn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),h(an,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(rn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),h(nt,"id","transformers.generation_utils.GenerationMixin"),h(nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(nt,"href","#transformers.generation_utils.GenerationMixin"),h(Oe,"class","relative group"),h(ln,"href","/docs/transformers/pr_18257/en/main_classes/model#transformers.PreTrainedModel"),h(dn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(cn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(pn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(mn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(gn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(un,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(_n,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(hn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(fn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(bn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(xn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(kn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(vn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(wt,"href","https://huggingface.co/blog/how-to-generate"),h(wt,"rel","nofollow"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(gt,"id","transformers.generation_tf_utils.TFGenerationMixin"),h(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(gt,"href","#transformers.generation_tf_utils.TFGenerationMixin"),h(Ge,"class","relative group"),h(yn,"href","/docs/transformers/pr_18257/en/main_classes/model#transformers.TFPreTrainedModel"),h(Wt,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),h(Wt,"rel","nofollow"),h(jn,"href","/docs/transformers/pr_18257/en/main_classes/configuration#transformers.PretrainedConfig"),h(Rt,"href","https://huggingface.co/blog/how-to-generate"),h(Rt,"rel","nofollow"),h(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(_t,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),h(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(_t,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),h(qe,"class","relative group"),h(Mn,"href","/docs/transformers/pr_18257/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(wn,"href","/docs/transformers/pr_18257/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(Qt,"href","https://huggingface.co/blog/how-to-generate"),h(Qt,"rel","nofollow"),h(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(l,b){e(document.head,d),x(l,f,b),x(l,u,b),e(u,c),e(c,_),y(s,_,null),e(u,p),e(u,C),e(C,q),x(l,I,b),x(l,S,b),e(S,A),e(S,$),e($,we),e(S,Le),x(l,he,b),x(l,fe,b),e(fe,$e),e($e,Is),e($e,tn),e(tn,Bs),e($e,Ws),e($e,nn),e(nn,Hs),e($e,Rs),e(fe,Us),e(fe,Te),e(Te,Vs),e(Te,on),e(on,Ks),e(Te,Zs),e(Te,sn),e(sn,Xs),e(Te,Js),e(fe,Qs),e(fe,Ee),e(Ee,Ys),e(Ee,an),e(an,ea),e(Ee,ta),e(Ee,rn),e(rn,na),e(Ee,oa),x(l,_s,b),x(l,Oe,b),e(Oe,nt),e(nt,An),y(xt,An,null),e(Oe,sa),e(Oe,Pn),e(Pn,aa),x(l,hs,b),x(l,T,b),y(kt,T,null),e(T,ra),e(T,vt),e(vt,ia),e(vt,ln),e(ln,la),e(vt,da),e(T,ca),e(T,yt),e(yt,pa),e(yt,dn),e(dn,ma),e(yt,ga),e(T,ua),e(T,P),e(P,B),e(B,Dn),e(Dn,_a),e(B,ha),e(B,cn),e(cn,fa),e(B,ba),e(B,Nn),e(Nn,xa),e(B,ka),e(B,Cn),e(Cn,va),e(B,ya),e(P,ja),e(P,W),e(W,In),e(In,Ma),e(W,wa),e(W,pn),e(pn,La),e(W,$a),e(W,Bn),e(Bn,Ta),e(W,Ea),e(W,Wn),e(Wn,Oa),e(W,Ga),e(P,qa),e(P,H),e(H,Hn),e(Hn,Sa),e(H,Fa),e(H,mn),e(mn,za),e(H,Aa),e(H,Rn),e(Rn,Pa),e(H,Da),e(H,Un),e(Un,Na),e(H,Ca),e(P,Ia),e(P,R),e(R,Vn),e(Vn,Ba),e(R,Wa),e(R,gn),e(gn,Ha),e(R,Ra),e(R,Kn),e(Kn,Ua),e(R,Va),e(R,Zn),e(Zn,Ka),e(R,Za),e(P,Xa),e(P,U),e(U,Xn),e(Xn,Ja),e(U,Qa),e(U,un),e(un,Ya),e(U,er),e(U,Jn),e(Jn,tr),e(U,nr),e(U,Qn),e(Qn,or),e(U,sr),e(P,ar),e(P,V),e(V,Yn),e(Yn,rr),e(V,ir),e(V,_n),e(_n,lr),e(V,dr),e(V,eo),e(eo,cr),e(V,pr),e(V,to),e(to,mr),e(V,gr),e(T,ur),e(T,E),y(jt,E,null),e(E,_r),e(E,no),e(no,hr),e(E,fr),e(E,D),e(D,K),e(K,oo),e(oo,br),e(K,xr),e(K,hn),e(hn,kr),e(K,vr),e(K,so),e(so,yr),e(K,jr),e(K,ao),e(ao,Mr),e(K,wr),e(D,Lr),e(D,Z),e(Z,ro),e(ro,$r),e(Z,Tr),e(Z,fn),e(fn,Er),e(Z,Or),e(Z,io),e(io,Gr),e(Z,qr),e(Z,lo),e(lo,Sr),e(Z,Fr),e(D,zr),e(D,X),e(X,co),e(co,Ar),e(X,Pr),e(X,bn),e(bn,Dr),e(X,Nr),e(X,po),e(po,Cr),e(X,Ir),e(X,mo),e(mo,Br),e(X,Wr),e(D,Hr),e(D,J),e(J,go),e(go,Rr),e(J,Ur),e(J,xn),e(xn,Vr),e(J,Kr),e(J,uo),e(uo,Zr),e(J,Xr),e(J,_o),e(_o,Jr),e(J,Qr),e(D,Yr),e(D,Q),e(Q,ho),e(ho,ei),e(Q,ti),e(Q,kn),e(kn,ni),e(Q,oi),e(Q,fo),e(fo,si),e(Q,ai),e(Q,bo),e(bo,ri),e(Q,ii),e(D,li),e(D,Y),e(Y,xo),e(xo,di),e(Y,ci),e(Y,vn),e(vn,pi),e(Y,mi),e(Y,ko),e(ko,gi),e(Y,ui),e(Y,vo),e(vo,_i),e(Y,hi),e(E,fi),y(ot,E,null),e(E,bi),e(E,Mt),e(Mt,xi),e(Mt,wt),e(wt,ki),e(Mt,vi),e(E,yi),e(E,yo),e(yo,ji),e(E,Mi),y(st,E,null),e(E,wi),y(at,E,null),e(E,Li),y(rt,E,null),e(T,$i),e(T,be),y(Lt,be,null),e(be,Ti),e(be,$t),e($t,Ei),e($t,jo),e(jo,Oi),e($t,Gi),e(be,qi),y(it,be,null),e(T,Si),e(T,xe),y(Tt,xe,null),e(xe,Fi),e(xe,Et),e(Et,zi),e(Et,Mo),e(Mo,Ai),e(Et,Pi),e(xe,Di),y(lt,xe,null),e(T,Ni),e(T,ke),y(Ot,ke,null),e(ke,Ci),e(ke,Gt),e(Gt,Ii),e(Gt,wo),e(wo,Bi),e(Gt,Wi),e(ke,Hi),y(dt,ke,null),e(T,Ri),e(T,ve),y(qt,ve,null),e(ve,Ui),e(ve,St),e(St,Vi),e(St,Lo),e(Lo,Ki),e(St,Zi),e(ve,Xi),y(ct,ve,null),e(T,Ji),e(T,ye),y(Ft,ye,null),e(ye,Qi),e(ye,zt),e(zt,Yi),e(zt,$o),e($o,el),e(zt,tl),e(ye,nl),y(pt,ye,null),e(T,ol),e(T,je),y(At,je,null),e(je,sl),e(je,Pt),e(Pt,al),e(Pt,To),e(To,rl),e(Pt,il),e(je,ll),y(mt,je,null),x(l,fs,b),x(l,Ge,b),e(Ge,gt),e(gt,Eo),y(Dt,Eo,null),e(Ge,dl),e(Ge,Oo),e(Oo,cl),x(l,bs,b),x(l,pe,b),y(Nt,pe,null),e(pe,pl),e(pe,Ct),e(Ct,ml),e(Ct,yn),e(yn,gl),e(Ct,ul),e(pe,_l),e(pe,F),y(It,F,null),e(F,hl),e(F,Go),e(Go,fl),e(F,bl),e(F,Bt),e(Bt,xl),e(Bt,Wt),e(Wt,kl),e(Bt,vl),e(F,yl),e(F,me),e(me,jl),e(me,qo),e(qo,Ml),e(me,wl),e(me,So),e(So,Ll),e(me,$l),e(me,jn),e(jn,Tl),e(me,El),e(F,Ol),e(F,Ht),e(Ht,Gl),e(Ht,Rt),e(Rt,ql),e(Ht,Sl),e(F,Fl),y(ut,F,null),x(l,xs,b),x(l,qe,b),e(qe,_t),e(_t,Fo),y(Ut,Fo,null),e(qe,zl),e(qe,zo),e(zo,Al),x(l,ks,b),x(l,N,b),y(Vt,N,null),e(N,Pl),e(N,Kt),e(Kt,Dl),e(Kt,Mn),e(Mn,Nl),e(Kt,Cl),e(N,Il),e(N,Zt),e(Zt,Bl),e(Zt,wn),e(wn,Wl),e(Zt,Hl),e(N,Rl),e(N,Se),e(Se,ee),e(ee,Ao),e(Ao,Ul),e(ee,Vl),e(ee,Po),e(Po,Kl),e(ee,Zl),e(ee,Do),e(Do,Xl),e(ee,Jl),e(ee,No),e(No,Ql),e(ee,Yl),e(Se,ed),e(Se,te),e(te,Co),e(Co,td),e(te,nd),e(te,Io),e(Io,od),e(te,sd),e(te,Bo),e(Bo,ad),e(te,rd),e(te,Wo),e(Wo,id),e(te,ld),e(Se,dd),e(Se,ne),e(ne,Ho),e(Ho,cd),e(ne,pd),e(ne,Ro),e(Ro,md),e(ne,gd),e(ne,Uo),e(Uo,ud),e(ne,_d),e(ne,Vo),e(Vo,hd),e(ne,fd),e(N,bd),e(N,z),y(Xt,z,null),e(z,xd),e(z,Ko),e(Ko,kd),e(z,vd),e(z,Fe),e(Fe,oe),e(oe,Zo),e(Zo,yd),e(oe,jd),e(oe,Xo),e(Xo,Md),e(oe,wd),e(oe,Jo),e(Jo,Ld),e(oe,$d),e(oe,Qo),e(Qo,Td),e(oe,Ed),e(Fe,Od),e(Fe,se),e(se,Yo),e(Yo,Gd),e(se,qd),e(se,es),e(es,Sd),e(se,Fd),e(se,ts),e(ts,zd),e(se,Ad),e(se,ns),e(ns,Pd),e(se,Dd),e(Fe,Nd),e(Fe,ae),e(ae,os),e(os,Cd),e(ae,Id),e(ae,ss),e(ss,Bd),e(ae,Wd),e(ae,as),e(as,Hd),e(ae,Rd),e(ae,rs),e(rs,Ud),e(ae,Vd),e(z,Kd),y(ht,z,null),e(z,Zd),e(z,Jt),e(Jt,Xd),e(Jt,Qt),e(Qt,Jd),e(Jt,Qd),e(z,Yd),y(ft,z,null),vs=!0},p(l,[b]){const Yt={};b&2&&(Yt.$$scope={dirty:b,ctx:l}),ot.$set(Yt);const is={};b&2&&(is.$$scope={dirty:b,ctx:l}),st.$set(is);const ls={};b&2&&(ls.$$scope={dirty:b,ctx:l}),at.$set(ls);const ds={};b&2&&(ds.$$scope={dirty:b,ctx:l}),rt.$set(ds);const en={};b&2&&(en.$$scope={dirty:b,ctx:l}),it.$set(en);const cs={};b&2&&(cs.$$scope={dirty:b,ctx:l}),lt.$set(cs);const ze={};b&2&&(ze.$$scope={dirty:b,ctx:l}),dt.$set(ze);const Ae={};b&2&&(Ae.$$scope={dirty:b,ctx:l}),ct.$set(Ae);const ps={};b&2&&(ps.$$scope={dirty:b,ctx:l}),pt.$set(ps);const ms={};b&2&&(ms.$$scope={dirty:b,ctx:l}),mt.$set(ms);const Pe={};b&2&&(Pe.$$scope={dirty:b,ctx:l}),ut.$set(Pe);const gs={};b&2&&(gs.$$scope={dirty:b,ctx:l}),ht.$set(gs);const us={};b&2&&(us.$$scope={dirty:b,ctx:l}),ft.$set(us)},i(l){vs||(j(s.$$.fragment,l),j(xt.$$.fragment,l),j(kt.$$.fragment,l),j(jt.$$.fragment,l),j(ot.$$.fragment,l),j(st.$$.fragment,l),j(at.$$.fragment,l),j(rt.$$.fragment,l),j(Lt.$$.fragment,l),j(it.$$.fragment,l),j(Tt.$$.fragment,l),j(lt.$$.fragment,l),j(Ot.$$.fragment,l),j(dt.$$.fragment,l),j(qt.$$.fragment,l),j(ct.$$.fragment,l),j(Ft.$$.fragment,l),j(pt.$$.fragment,l),j(At.$$.fragment,l),j(mt.$$.fragment,l),j(Dt.$$.fragment,l),j(Nt.$$.fragment,l),j(It.$$.fragment,l),j(ut.$$.fragment,l),j(Ut.$$.fragment,l),j(Vt.$$.fragment,l),j(Xt.$$.fragment,l),j(ht.$$.fragment,l),j(ft.$$.fragment,l),vs=!0)},o(l){M(s.$$.fragment,l),M(xt.$$.fragment,l),M(kt.$$.fragment,l),M(jt.$$.fragment,l),M(ot.$$.fragment,l),M(st.$$.fragment,l),M(at.$$.fragment,l),M(rt.$$.fragment,l),M(Lt.$$.fragment,l),M(it.$$.fragment,l),M(Tt.$$.fragment,l),M(lt.$$.fragment,l),M(Ot.$$.fragment,l),M(dt.$$.fragment,l),M(qt.$$.fragment,l),M(ct.$$.fragment,l),M(Ft.$$.fragment,l),M(pt.$$.fragment,l),M(At.$$.fragment,l),M(mt.$$.fragment,l),M(Dt.$$.fragment,l),M(Nt.$$.fragment,l),M(It.$$.fragment,l),M(ut.$$.fragment,l),M(Ut.$$.fragment,l),M(Vt.$$.fragment,l),M(Xt.$$.fragment,l),M(ht.$$.fragment,l),M(ft.$$.fragment,l),vs=!1},d(l){o(d),l&&o(f),l&&o(u),w(s),l&&o(I),l&&o(S),l&&o(he),l&&o(fe),l&&o(_s),l&&o(Oe),w(xt),l&&o(hs),l&&o(T),w(kt),w(jt),w(ot),w(st),w(at),w(rt),w(Lt),w(it),w(Tt),w(lt),w(Ot),w(dt),w(qt),w(ct),w(Ft),w(pt),w(At),w(mt),l&&o(fs),l&&o(Ge),w(Dt),l&&o(bs),l&&o(pe),w(Nt),w(It),w(ut),l&&o(xs),l&&o(qe),w(Ut),l&&o(ks),l&&o(N),w(Vt),w(Xt),w(ht),w(ft)}}}const fm={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function bm(L){return nm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class wm extends Qp{constructor(d){super();Yp(this,d,bm,hm,em,{})}}export{wm as default,fm as metadata};
