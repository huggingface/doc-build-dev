...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15833/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15833/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15833/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15833/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15833/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
configuration.`),X2=u(),Su=o("a"),Q2=u(),Bs=o("h3"),La=o("a"),e1=o("span"),f(Ql.$$.fragment),LT=u(),s1=o("span"),MT=a("Getting The Model Weights Out"),e3=u(),Ma=o("p"),ZT=a(`As long as you continue training and resuming using DeepSpeed you don\u2019t need to worry about anything. DeepSpeed stores
...
pattern), and are saved under the normal checkpoint.`),s3=u(),Cu=o("p"),a1=o("strong"),BT=a("FP16 Weights:"),t3=u(),Za=o("p"),WT=a("When a model is saved under ZeRO-2, you end up having the normal "),n1=o("code"),FT=a("pytorch_model.bin"),VT=a(` file with the model weights, but
they are only the fp16 version of the weights.`),a3=u(),B=o("p"),YT=a(`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
won\u2019t be possible to load it back.`),n3=u(),f(er.$$.fragment),o3=u(),xu=o("p"),i1=o("strong"),nA=a("FP32 Weights:"),l3=u(),Na=o("p"),oA=a(`While the fp16 weights are fine for resuming training, if you finished finetuning your model and want to upload it to
...
memory it can be done in the same training script. The following sections will discuss both approaches.`),r3=u(),Ru=o("p"),u1=o("strong"),pA=a("Live FP32 Weights Recovery:"),p3=u(),Iu=o("p"),iA=a("This approach may not work if you model is large and you have little free CPU memory left, at the end of the training."),i3=u(),Uu=o("p"),uA=a("If you have saved at least one checkpoint, and you want to use the latest one, you can do the following:"),u3=u(),f(tr.$$.fragment),c3=u(),ts=o("p"),cA=a("If you\u2019re using the "),c1=o("code"),hA=a("--load_best_model_at_end"),fA=a(" class:"),h1=o("em"),dA=a("~transformers.TrainingArguments"),mA=a(` argument (to track the best
checkpoint), then you can finish the training by first saving the final model explicitly and then do the same as above:`),h3=u(),f(ar.$$.fragment),f3=u(),f(Ha.$$.fragment),d3=u(),Ba=o("p"),_A=a("Of course, you don\u2019t have to use class:"),f1=o("em"),vA=a("~transformers.Trainer"),jA=a(` and you can adjust the examples above to your own
trainer.`),m3=u(),Wa=o("p"),gA=a("If for some reason you want more refinement, you can also extract the fp32 "),d1=o("code"),yA=a("state_dict"),wA=a(` of the weights and apply
these yourself as is shown in the following example:`),_3=u(),f(nr.$$.fragment),v3=u(),Gu=o("p"),m1=o("strong"),bA=a("Offline FP32 Weights Recovery:"),j3=u(),as=o("p"),qA=a("DeepSpeed creates a special conversion script "),_1=o("code"),EA=a("zero_to_fp32.py"),$A=a(` which it places in the top-level of the checkpoint
folder. Using this script you can extract the weights at any point. The script is standalone and you no longer need to
have the configuration file or a `),v1=o("code"),kA=a("Trainer"),PA=a(" to do the extraction."),g3=u(),Lu=o("p"),zA=a("Let\u2019s say your checkpoint folder looks like this:"),y3=u(),f(or.$$.fragment),w3=u(),Fa=o("p"),DA=a("In this example there is just one DeepSpeed checkpoint sub-folder "),j1=o("em"),OA=a("global_step1"),TA=a(`. Therefore to reconstruct the fp32
weights just run:`),b3=u(),f(lr.$$.fragment),q3=u(),Va=o("p"),AA=a("This is it. "),g1=o("code"),SA=a("pytorch_model.bin"),CA=a(" will now contain the full fp32 model weights consolidated from multiple GPUs."),E3=u(),Mu=o("p"),xA=a("The script will automatically be able to handle either a ZeRO-2 or ZeRO-3 checkpoint."),$3=u(),rr=o("p"),y1=o("code"),RA=a("python zero_to_fp32.py -h"),IA=a(" will give you usage details."),k3=u(),ns=o("p"),UA=a("The script will auto-discover the deepspeed sub-folder using the contents of the file "),w1=o("code"),GA=a("latest"),LA=a(`, which in the current
example will contain `),b1=o("code"),MA=a("global_step1"),ZA=a("."),P3=u(),Zu=o("p"),NA=a("Note: currently the script requires 2x general RAM of the final fp32 model weights."),z3=u(),Ws=o("h3"),Ya=o("a"),q1=o("span"),f(pr.$$.fragment),HA=u(),E1=o("span"),BA=a("ZeRO-3 and Infinity Nuances"),D3=u(),Nu=o("p"),WA=a("ZeRO-3 is quite different from ZeRO-2 because of its param sharding feature."),O3=u(),Hu=o("p"),FA=a("ZeRO-Infinity further extends ZeRO-3 to support NVMe memory and multiple other speed and scalability improvements."),T3=u(),Bu=o("p"),VA=a(`While all the efforts were made for things to just work without needing any special changes to your models, in certain
circumstances you may find the following information to be needed.`),A3=u(),Fs=o("h4"),Ka=o("a"),$1=o("span"),f(ir.$$.fragment),YA=u(),k1=o("span"),KA=a("Constructing Massive Models"),S3=u(),Ja=o("p"),JA=a(`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
context manager (which is also a function decorator), like so:`),C3=u(),f(ur.$$.fragment),x3=u(),Wu=o("p"),eS=a("As you can see this gives you a randomly initialized model."),R3=u(),k=o("p"),sS=a("If you want to use a pretrained model, "),z1=o("code"),tS=a("model_class.from_pretrained"),aS=a(` will activate this feature as long as
...
`),A1=o("code"),dS=a("from_pretrained"),mS=a(". Here is an example of a possible sequence:"),I3=u(),f(cr.$$.fragment),U3=u(),Xa=o("p"),_S=a("If you\u2019re using the official example scripts and your command line arguments include "),S1=o("code"),vS=a("--deepspeed ds_config.json"),jS=a(`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),G3=u(),Yu=o("p"),gS=a("Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),L3=u(),Qa=o("p"),yS=a("For full details on this method and other related features please refer to "),hr=o("a"),wS=a("Constructing Massive Models"),bS=a("."),M3=u(),oe=o("p"),qS=a("Also when loading fp16-pretrained models, you will want to tell "),C1=o("code"),ES=a("from_pretrained"),$S=a(` to use
`),x1=o("code"),kS=a("torch_dtype=torch.float16"),PS=a(". For details, please, see "),Ku=o("a"),zS=a("from_pretrained-torch-dtype"),DS=a("."),Z3=u(),Vs=o("h4"),en=o("a"),R1=o("span"),f(fr.$$.fragment),OS=u(),I1=o("span"),TS=a("Gathering Parameters"),N3=u(),dr=o("p"),AS=a(`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),mr=o("a"),SS=a("Gathering Parameters"),H3=u(),sn=o("p"),CS=a(`We do however use it internally in several places, one such example is when loading pretrained model weights in
...
limitations.`),B3=u(),Ju=o("p"),IS=a("Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),W3=u(),f(_r.$$.fragment),F3=u(),os=o("p"),US=a("stress on "),G1=o("code"),GS=a("tensor([1.])"),LS=a(", or if you get an error where it says the parameter is of size "),L1=o("code"),MS=a("1"),ZS=a(`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),V3=u(),Xu=o("a"),Y3=u(),Ys=o("h3"),tn=o("a"),M1=o("span"),f(vr.$$.fragment),NS=u(),Z1=o("span"),HS=a("ZeRO Inference"),K3=u(),Qu=o("p"),BS=a(`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),J3=u(),an=o("p"),WS=a("Otherwise you just need to pass the usual "),ec=o("a"),FS=a("TrainingArguments"),VS=a(" arguments. For example:"),X3=u(),f(jr.$$.fragment),Q3=u(),sc=o("p"),YS=a(`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),eb=u(),nn=o("p"),KS=a("Here is an example of running "),N1=o("code"),JS=a("run_translation.py"),XS=a(" under DeepSpeed deploying all available GPUs:"),sb=u(),f(gr.$$.fragment),tb=u(),tc=o("p"),QS=a(`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
should be able to fit much larger batches and/or sequence length onto the same hardware.`),ab=u(),ac=o("p"),eC=a(`Additionally DeepSpeed is currently developing a related product called Deepspeed-Inference which has no relationship
to the ZeRO technology, but instead uses tensor parallelism to scale models that can\u2019t fit onto a single GPU. This is a
work in progress and we will provide the integration once that product is complete.`),nb=u(),Ks=o("h3"),on=o("a"),H1=o("span"),f(yr.$$.fragment),sC=u(),B1=o("span"),tC=a("Memory Requirements"),ob=u(),nc=o("p"),aC=a("Since Deepspeed ZeRO can offload memory to CPU (and NVMe) the framework provides utils that allow one to tell how much CPU and GPU memory will be needed depending on the number of GPUs being used."),lb=u(),oc=o("p"),nC=a("Let\u2019s estimate how much memory is needed to finetune \u201Cbigscience/T0_3B\u201D on a single GPU:"),rb=u(),f(wr.$$.fragment),pb=u(),lc=o("p"),oC=a("So you can fit it on a single 80GB GPU and no CPU offload, or a tiny 8GB GPU but then need ~60GB of CPU memory. (Remember this is just the memory for params, optimizer states and gradients - you will need a bit more memory for cuda kernels, activations and temps.)"),ib=u(),rc=o("p"),lC=a("Then it\u2019s a tradeoff of cost vs speed. It\u2019ll be cheaper to buy/rent a smaller GPU (or less GPUs since you can use multiple GPUs with Deepspeed ZeRO. But then it\u2019ll be slower, so even if you don\u2019t care about how fast something will be done, the slowdown has a direct impact on the duration of using the GPU and thus bigger cost. So experiment and compare which works the best."),ub=u(),pc=o("p"),rC=a("If you have enough GPU memory make sure to disable the CPU/NVMe offload as it\u2019ll make everything faster."),cb=u(),ic=o("p"),pC=a("For example, let\u2019s repeat the same for 2 GPUs:"),hb=u(),f(br.$$.fragment),fb=u(),uc=o("p"),iC=a("So here you\u2019d want 2x 32GB GPUs or higher without offloading to CPU."),db=u(),ln=o("p"),uC=a("For full information please see "),qr=o("a"),cC=a("memory estimators"),hC=a("."),mb=u(),Js=o("h3"),rn=o("a"),W1=o("span"),f(Er.$$.fragment),fC=u(),F1=o("span"),dC=a("Filing Issues"),_b=u(),cc=o("p"),mC=a("Here is how to file an issue so that we could quickly get to the bottom of the issue and help you to unblock your work."),vb=u(),hc=o("p"),_C=a("In your report please always include:"),jb=u(),R=o("ol"),V1=o("li"),Y1=o("p"),vC=a("the full Deepspeed config file in the report"),jC=u(),K1=o("li"),qe=o("p"),gC=a("either the command line arguments if you were using the "),fc=o("a"),yC=a("Trainer"),wC=a(` or
...
a starting point.`),SC=u(),Q1=o("li"),ev=o("p"),CC=a("Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),xC=u(),sv=o("li"),Dr=o("p"),RC=a("If possible try to use one of the existing "),Or=o("a"),IC=a("examples"),UC=a(" to reproduce the problem with."),gb=u(),_c=o("p"),GC=a("Things to consider:"),yb=u(),pn=o("ul"),Xs=o("li"),tv=o("p"),LC=a("Deepspeed is often not the cause of the problem."),MC=u(),av=o("p"),ZC=a(`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
need be.`),wb=u(),Qs=o("h3"),un=o("a"),lv=o("span"),f(Sr.$$.fragment),YC=u(),rv=o("span"),KC=a("Troubleshooting"),bb=u(),et=o("h4"),cn=o("a"),pv=o("span"),f(Cr.$$.fragment),JC=u(),xr=o("span"),XC=a("the "),iv=o("code"),QC=a("deepspeed"),ex=a(" process gets killed at startup without a traceback"),qb=u(),I=o("p"),sx=a("If the "),uv=o("code"),tx=a("deepspeed"),ax=a(` process gets killed at launch time without a traceback, that usually means that the program tried
...
ZeRO-3. Here is how you can `),Rr=o("a"),ux=a("estimate how much memory is needed for a specific model"),cx=a("."),Eb=u(),st=o("h4"),hn=o("a"),dv=o("span"),f(Ir.$$.fragment),hx=u(),vc=o("span"),fx=a("training and/or eval/predict loss is "),mv=o("code"),dx=a("NaN"),$b=u(),jc=o("p"),mx=a("This often happens when one takes a model pre-trained in bf16 mixed precision mode and tries to use it under fp16 (with or without mixed precision). Most models trained on TPU and often the ones released by Google are in this category (e.g. almost all t5-based models). Here the solution is to either use fp32 or bf16 if your hardware supports it (TPU, Ampere GPUs or newer)."),kb=u(),gc=o("p"),_x=a("The other problem may have to do with using fp16. When you configure this section:"),Pb=u(),f(Ur.$$.fragment),zb=u(),fn=o("p"),vx=a("and you see in your log that Deepspeed reports "),_v=o("code"),jx=a("OVERFLOW!"),gx=a(" as follows:"),Db=u(),f(Gr.$$.fragment),Ob=u(),yc=o("p"),yx=a("that means that the Deepspeed loss scaler can\u2019t figure out a scaling co-efficient that overcomes loss overflow."),Tb=u(),wc=o("p"),wx=a("(the log was massaged to be more readable here.)"),Ab=u(),ls=o("p"),bx=a("In this case you usually need to raise the value of "),vv=o("code"),qx=a("initial_scale_power"),Ex=a(". Setting it to "),jv=o("code"),$x=a('"initial_scale_power": 32'),kx=a(" will typically resolve the problem."),Sb=u(),tt=o("h3"),dn=o("a"),gv=o("span"),f(Lr.$$.fragment),Px=u(),yv=o("span"),zx=a("Notes"),Cb=u(),rs=o("ul"),mn=o("li"),Dx=a("DeepSpeed works with the PyTorch "),bc=o("a"),Ox=a("Trainer"),Tx=a(" but not TF "),wv=o("code"),Ax=a("TFTrainer"),Sx=u(),Mr=o("li"),Cx=a("While DeepSpeed has a pip installable PyPI package, it is highly recommended that it gets installed from "),Zr=o("a"),xx=a("source"),Rx=a(` to best match your hardware and also if you need to enable
...
with your own trainer, and you will have to adapt the latter according to `),Nr=o("a"),Mx=a("the DeepSpeed integration instructions"),Zx=a("."),xb=u(),Ec=o("a"),Rb=u(),nt=o("h2"),_n=o("a"),bv=o("span"),f(Hr.$$.fragment),Nx=u(),qv=o("span"),Hx=a("Non-Trainer Deepspeed Integration"),Ib=u(),le=o("p"),Bx=a("The "),$c=o("a"),Wx=a("HfDeepSpeedConfig"),Fx=a(` is used to integrate Deepspeed into the \u{1F917} Transformers core
functionality, when `),kc=o("a"),Vx=a("Trainer"),Yx=a(" is not used. The only thing that it does is handling Deepspeed ZeRO 3 param gathering and automatically splitting the model onto multiple gpus during "),Ev=o("code"),Kx=a("from_pretrained"),Jx=a(" call. Everything else you have to do by yourself."),Ub=u(),vn=o("p"),Xx=a("When using "),Pc=o("a"),Qx=a("Trainer"),eR=a(" everything is automatically taken care of."),Gb=u(),ps=o("p"),sR=a("When not using "),zc=o("a"),tR=a("Trainer"),aR=a(`, to efficiently deploy DeepSpeed stage 3, you must instantiate the
`),Dc=o("a"),nR=a("HfDeepSpeedConfig"),oR=a(" object before instantiating the model."),Lb=u(),Oc=o("p"),lR=a("For example for a pretrained model:"),Mb=u(),f(Br.$$.fragment),Zb=u(),Tc=o("p"),rR=a("or for non-pretrained model:"),Nb=u(),f(Wr.$$.fragment),Hb=u(),re=o("p"),pR=a("Please note that if you\u2019re not using the "),Ac=o("a"),iR=a("Trainer"),uR=a(" integration, you\u2019re completely on your own. Basically follow the documentation on the "),Fr=o("a"),cR=a("Deepspeed"),hR=a(" website. Also you have to configure explicitly the config file - you can\u2019t use "),$v=o("code"),fR=a('"auto"'),dR=a(" values and you will have to put real values instead."),Bb=u(),ot=o("h2"),jn=o("a"),kv=o("span"),f(Vr.$$.fragment),mR=u(),Pv=o("span"),_R=a("HfDeepSpeedConfig"),Wb=u(),E=o("div"),f(Yr.$$.fragment),vR=u(),zv=o("p"),jR=a("This object contains a DeepSpeed configuration dictionary and can be quickly queried for things like zero stage."),gR=u(),Ee=o("p"),yR=a("A "),Dv=o("code"),wR=a("weakref"),bR=a(` of this object is stored in the module\u2019s globals to be able to access the config from areas where
...
pattern), and are saved under the normal checkpoint.`),Xq.forEach(t),s3=c(e),Cu=l(e,"P",{});var lB=r(Cu);a1=l(lB,"STRONG",{});var rB=r(a1);BT=n(rB,"FP16 Weights:"),rB.forEach(t),lB.forEach(t),t3=c(e),Za=l(e,"P",{});var Qq=r(Za);WT=n(Qq,"When a model is saved under ZeRO-2, you end up having the normal "),n1=l(Qq,"CODE",{});var pB=r(n1);FT=n(pB,"pytorch_model.bin"),pB.forEach(t),VT=n(Qq,` file with the model weights, but
they are only the fp16 version of the weights.`),Qq.forEach(t),a3=c(e),B=l(e,"P",{});var ds=r(B);YT=n(ds,`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
won\u2019t be possible to load it back.`),ds.forEach(t),n3=c(e),d(er.$$.fragment,e),o3=c(e),xu=l(e,"P",{});var fB=r(xu);i1=l(fB,"STRONG",{});var dB=r(i1);nA=n(dB,"FP32 Weights:"),dB.forEach(t),fB.forEach(t),l3=c(e),Na=l(e,"P",{});var eE=r(Na);oA=n(eE,`While the fp16 weights are fine for resuming training, if you finished finetuning your model and want to upload it to
...
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
limitations.`),cE.forEach(t),B3=c(e),Ju=l(e,"P",{});var cW=r(Ju);IS=n(cW,"Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),cW.forEach(t),W3=c(e),d(_r.$$.fragment,e),F3=c(e),os=l(e,"P",{});var bh=r(os);US=n(bh,"stress on "),G1=l(bh,"CODE",{});var hW=r(G1);GS=n(hW,"tensor([1.])"),hW.forEach(t),LS=n(bh,", or if you get an error where it says the parameter is of size "),L1=l(bh,"CODE",{});var fW=r(L1);MS=n(fW,"1"),fW.forEach(t),ZS=n(bh,`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),bh.forEach(t),V3=c(e),Xu=l(e,"A",{id:!0}),r(Xu).forEach(t),Y3=c(e),Ys=l(e,"H3",{class:!0});var hE=r(Ys);tn=l(hE,"A",{id:!0,class:!0,href:!0});var dW=r(tn);M1=l(dW,"SPAN",{});var mW=r(M1);d(vr.$$.fragment,mW),mW.forEach(t),dW.forEach(t),NS=c(hE),Z1=l(hE,"SPAN",{});var _W=r(Z1);HS=n(_W,"ZeRO Inference"),_W.forEach(t),hE.forEach(t),K3=c(e),Qu=l(e,"P",{});var vW=r(Qu);BS=n(vW,`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),vW.forEach(t),J3=c(e),an=l(e,"P",{});var fE=r(an);WS=n(fE,"Otherwise you just need to pass the usual "),ec=l(fE,"A",{href:!0});var jW=r(ec);FS=n(jW,"TrainingArguments"),jW.forEach(t),VS=n(fE," arguments. For example:"),fE.forEach(t),X3=c(e),d(jr.$$.fragment,e),Q3=c(e),sc=l(e,"P",{});var gW=r(sc);YS=n(gW,`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),gW.forEach(t),eb=c(e),nn=l(e,"P",{});var dE=r(nn);KS=n(dE,"Here is an example of running "),N1=l(dE,"CODE",{});var yW=r(N1);JS=n(yW,"run_translation.py"),yW.forEach(t),XS=n(dE," under DeepSpeed deploying all available GPUs:"),dE.forEach(t),sb=c(e),d(gr.$$.fragment,e),tb=c(e),tc=l(e,"P",{});var wW=r(tc);QS=n(wW,`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
should be able to fit much larger batches and/or sequence length onto the same hardware.`),wW.forEach(t),ab=c(e),ac=l(e,"P",{});var bW=r(ac);eC=n(bW,`Additionally DeepSpeed is currently developing a related product called Deepspeed-Inference which has no relationship
to the ZeRO technology, but instead uses tensor parallelism to scale models that can\u2019t fit onto a single GPU. This is a
work in progress and we will provide the integration once that product is complete.`),bW.forEach(t),nb=c(e),Ks=l(e,"H3",{class:!0});var mE=r(Ks);on=l(mE,"A",{id:!0,class:!0,href:!0});var qW=r(on);H1=l(qW,"SPAN",{});var EW=r(H1);d(yr.$$.fragment,EW),EW.forEach(t),qW.forEach(t),sC=c(mE),B1=l(mE,"SPAN",{});var $W=r(B1);tC=n($W,"Memory Requirements"),$W.forEach(t),mE.forEach(t),ob=c(e),nc=l(e,"P",{});var kW=r(nc);aC=n(kW,"Since Deepspeed ZeRO can offload memory to CPU (and NVMe) the framework provides utils that allow one to tell how much CPU and GPU memory will be needed depending on the number of GPUs being used."),kW.forEach(t),lb=c(e),oc=l(e,"P",{});var PW=r(oc);nC=n(PW,"Let\u2019s estimate how much memory is needed to finetune \u201Cbigscience/T0_3B\u201D on a single GPU:"),PW.forEach(t),rb=c(e),d(wr.$$.fragment,e),pb=c(e),lc=l(e,"P",{});var zW=r(lc);oC=n(zW,"So you can fit it on a single 80GB GPU and no CPU offload, or a tiny 8GB GPU but then need ~60GB of CPU memory. (Remember this is just the memory for params, optimizer states and gradients - you will need a bit more memory for cuda kernels, activations and temps.)"),zW.forEach(t),ib=c(e),rc=l(e,"P",{});var DW=r(rc);lC=n(DW,"Then it\u2019s a tradeoff of cost vs speed. It\u2019ll be cheaper to buy/rent a smaller GPU (or less GPUs since you can use multiple GPUs with Deepspeed ZeRO. But then it\u2019ll be slower, so even if you don\u2019t care about how fast something will be done, the slowdown has a direct impact on the duration of using the GPU and thus bigger cost. So experiment and compare which works the best."),DW.forEach(t),ub=c(e),pc=l(e,"P",{});var OW=r(pc);rC=n(OW,"If you have enough GPU memory make sure to disable the CPU/NVMe offload as it\u2019ll make everything faster."),OW.forEach(t),cb=c(e),ic=l(e,"P",{});var TW=r(ic);pC=n(TW,"For example, let\u2019s repeat the same for 2 GPUs:"),TW.forEach(t),hb=c(e),d(br.$$.fragment,e),fb=c(e),uc=l(e,"P",{});var AW=r(uc);iC=n(AW,"So here you\u2019d want 2x 32GB GPUs or higher without offloading to CPU."),AW.forEach(t),db=c(e),ln=l(e,"P",{});var _E=r(ln);uC=n(_E,"For full information please see "),qr=l(_E,"A",{href:!0,rel:!0});var SW=r(qr);cC=n(SW,"memory estimators"),SW.forEach(t),hC=n(_E,"."),_E.forEach(t),mb=c(e),Js=l(e,"H3",{class:!0});var vE=r(Js);rn=l(vE,"A",{id:!0,class:!0,href:!0});var CW=r(rn);W1=l(CW,"SPAN",{});var xW=r(W1);d(Er.$$.fragment,xW),xW.forEach(t),CW.forEach(t),fC=c(vE),F1=l(vE,"SPAN",{});var RW=r(F1);dC=n(RW,"Filing Issues"),RW.forEach(t),vE.forEach(t),_b=c(e),cc=l(e,"P",{});var IW=r(cc);mC=n(IW,"Here is how to file an issue so that we could quickly get to the bottom of the issue and help you to unblock your work."),IW.forEach(t),vb=c(e),hc=l(e,"P",{});var UW=r(hc);_C=n(UW,"In your report please always include:"),UW.forEach(t),jb=c(e),R=l(e,"OL",{});var ve=r(R);V1=l(ve,"LI",{});var GW=r(V1);Y1=l(GW,"P",{});var LW=r(Y1);vC=n(LW,"the full Deepspeed config file in the report"),LW.forEach(t),GW.forEach(t),jC=c(ve),K1=l(ve,"LI",{});var MW=r(K1);qe=l(MW,"P",{});var In=r(qe);gC=n(In,"either the command line arguments if you were using the "),fc=l(In,"A",{href:!0});var ZW=r(fc);yC=n(ZW,"Trainer"),ZW.forEach(t),wC=n(In,` or
