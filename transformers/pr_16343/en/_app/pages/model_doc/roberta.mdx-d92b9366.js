...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16343/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new fe({props:{$$slots:{default:[CM]},$$scope:{ctx:C}}}),_a=new j({props:{name:"call",anchor:"transformers.TFRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_tf_roberta.py#L1330",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`),Vd=s(wt,"CODE",{});var K2=r(Vd);l_=i(K2,"add_cross_attention"),K2.forEach(t),d_=i(wt," set to "),Jd=s(wt,"CODE",{});var G2=r(Jd);c_=i(G2,"True"),G2.forEach(t),p_=i(wt,"; an "),Kd=s(wt,"CODE",{});var X2=r(Kd);h_=i(X2,"encoder_hidden_states"),X2.forEach(t),u_=i(wt," is then expected as an input to the forward pass."),wt.forEach(t),f_=d(Xe),Rn=s(Xe,"P",{});var Hh=r(Rn);m_=i(Hh,".. _"),Gd=s(Hh,"EM",{});var Y2=r(Gd);g_=i(Y2,"Attention is all you need"),Y2.forEach(t),__=i(Hh,": "),Zs=s(Hh,"A",{href:!0,rel:!0});var Z2=r(Zs);b_=i(Z2,"https://arxiv.org/abs/1706.03762"),Z2.forEach(t),Hh.forEach(t),k_=d(Xe),st=s(Xe,"DIV",{class:!0});var Jt=r(st);y(er.$$.fragment,Jt),T_=d(Jt),Mo=s(Jt,"P",{});var Zl=r(Mo);y_=i(Zl,"The "),gl=s(Zl,"A",{href:!0});var e3=r(gl);v_=i(e3,"RobertaModel"),e3.forEach(t),w_=i(Zl," forward method, overrides the "),Xd=s(Zl,"CODE",{});var t3=r(Xd);$_=i(t3,"__call__"),t3.forEach(t),F_=i(Zl," special method."),Zl.forEach(t),R_=d(Jt),y(Mn.$$.fragment,Jt),M_=d(Jt),Yd=s(Jt,"P",{});var o3=r(Yd);E_=i(o3,"Example:"),o3.forEach(t),z_=d(Jt),y(tr.$$.fragment,Jt),Jt.forEach(t),Xe.forEach(t),tu=d(o),Eo=s(o,"H2",{class:!0});var of=r(Eo);En=s(of,"A",{id:!0,class:!0,href:!0});var n3=r(En);Zd=s(n3,"SPAN",{});var s3=r(Zd);y(or.$$.fragment,s3),s3.forEach(t),n3.forEach(t),x_=d(of),ec=s(of,"SPAN",{});var r3=r(ec);q_=i(r3,"RobertaForCausalLM"),r3.forEach(t),of.forEach(t),ou=d(o),Ye=s(o,"DIV",{class:!0});var Kt=r(Ye);y(nr.$$.fragment,Kt),C_=d(Kt),sr=s(Kt,"P",{});var nf=r(sr);P_=i(nf,"RoBERTa Model with a "),tc=s(nf,"CODE",{});var a3=r(tc);j_=i(a3,"language modeling"),a3.forEach(t),L_=i(nf," head on top for CLM fine-tuning."),nf.forEach(t),A_=d(Kt),rr=s(Kt,"P",{});var sf=r(rr);O_=i(sf,"This model inherits from "),_l=s(sf,"A",{href:!0});var i3=r(_l);N_=i(i3,"PreTrainedModel"),i3.forEach(t),I_=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sf.forEach(t),D_=d(Kt),ar=s(Kt,"P",{});var rf=r(ar);S_=i(rf,"This model is also a PyTorch "),ir=s(rf,"A",{href:!0,rel:!0});var l3=r(ir);W_=i(l3,"torch.nn.Module"),l3.forEach(t),B_=i(rf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rf.forEach(t),U_=d(Kt),rt=s(Kt,"DIV",{class:!0});var Gt=r(rt);y(lr.$$.fragment,Gt),H_=d(Gt),zo=s(Gt,"P",{});var ed=r(zo);Q_=i(ed,"The "),bl=s(ed,"A",{href:!0});var d3=r(bl);V_=i(d3,"RobertaForCausalLM"),d3.forEach(t),J_=i(ed," forward method, overrides the "),oc=s(ed,"CODE",{});var c3=r(oc);K_=i(c3,"__call__"),c3.forEach(t),G_=i(ed," special method."),ed.forEach(t),X_=d(Gt),y(zn.$$.fragment,Gt),Y_=d(Gt),nc=s(Gt,"P",{});var p3=r(nc);Z_=i(p3,"Example:"),p3.forEach(t),eb=d(Gt),y(dr.$$.fragment,Gt),Gt.forEach(t),Kt.forEach(t),nu=d(o),xo=s(o,"H2",{class:!0});var af=r(xo);xn=s(af,"A",{id:!0,class:!0,href:!0});var h3=r(xn);sc=s(h3,"SPAN",{});var u3=r(sc);y(cr.$$.fragment,u3),u3.forEach(t),h3.forEach(t),tb=d(af),rc=s(af,"SPAN",{});var f3=r(rc);ob=i(f3,"RobertaForMaskedLM"),f3.forEach(t),af.forEach(t),su=d(o),Ze=s(o,"DIV",{class:!0});var Xt=r(Ze);y(pr.$$.fragment,Xt),nb=d(Xt),hr=s(Xt,"P",{});var lf=r(hr);sb=i(lf,"RoBERTa Model with a "),ac=s(lf,"CODE",{});var m3=r(ac);rb=i(m3,"language modeling"),m3.forEach(t),ab=i(lf," head on top."),lf.forEach(t),ib=d(Xt),ur=s(Xt,"P",{});var df=r(ur);lb=i(df,"This model inherits from "),kl=s(df,"A",{href:!0});var g3=r(kl);db=i(g3,"PreTrainedModel"),g3.forEach(t),cb=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),pb=d(Xt),fr=s(Xt,"P",{});var cf=r(fr);hb=i(cf,"This model is also a PyTorch "),mr=s(cf,"A",{href:!0,rel:!0});var _3=r(mr);ub=i(_3,"torch.nn.Module"),_3.forEach(t),fb=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),mb=d(Xt),at=s(Xt,"DIV",{class:!0});var Yt=r(at);y(gr.$$.fragment,Yt),gb=d(Yt),qo=s(Yt,"P",{});var td=r(qo);_b=i(td,"The "),Tl=s(td,"A",{href:!0});var b3=r(Tl);bb=i(b3,"RobertaForMaskedLM"),b3.forEach(t),kb=i(td," forward method, overrides the "),ic=s(td,"CODE",{});var k3=r(ic);Tb=i(k3,"__call__"),k3.forEach(t),yb=i(td," special method."),td.forEach(t),vb=d(Yt),y(qn.$$.fragment,Yt),wb=d(Yt),lc=s(Yt,"P",{});var T3=r(lc);$b=i(T3,"Example:"),T3.forEach(t),Fb=d(Yt),y(_r.$$.fragment,Yt),Yt.forEach(t),Xt.forEach(t),ru=d(o),Co=s(o,"H2",{class:!0});var pf=r(Co);Cn=s(pf,"A",{id:!0,class:!0,href:!0});var y3=r(Cn);dc=s(y3,"SPAN",{});var v3=r(dc);y(br.$$.fragment,v3),v3.forEach(t),y3.forEach(t),Rb=d(pf),cc=s(pf,"SPAN",{});var w3=r(cc);Mb=i(w3,"RobertaForSequenceClassification"),w3.forEach(t),pf.forEach(t),au=d(o),et=s(o,"DIV",{class:!0});var Zt=r(et);y(kr.$$.fragment,Zt),Eb=d(Zt),pc=s(Zt,"P",{});var $3=r(pc);zb=i($3,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),$3.forEach(t),xb=d(Zt),Tr=s(Zt,"P",{});var hf=r(Tr);qb=i(hf,"This model inherits from "),yl=s(hf,"A",{href:!0});var F3=r(yl);Cb=i(F3,"PreTrainedModel"),F3.forEach(t),Pb=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),jb=d(Zt),yr=s(Zt,"P",{});var uf=r(yr);Lb=i(uf,"This model is also a PyTorch "),vr=s(uf,"A",{href:!0,rel:!0});var R3=r(vr);Ab=i(R3,"torch.nn.Module"),R3.forEach(t),Ob=i(uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uf.forEach(t),Nb=d(Zt),Se=s(Zt,"DIV",{class:!0});var $t=r(Se);y(wr.$$.fragment,$t),Ib=d($t),Po=s($t,"P",{});var od=r(Po);Db=i(od,"The "),vl=s(od,"A",{href:!0});var M3=r(vl);Sb=i(M3,"RobertaForSequenceClassification"),M3.forEach(t),Wb=i(od," forward method, overrides the "),hc=s(od,"CODE",{});var E3=r(hc);Bb=i(E3,"__call__"),E3.forEach(t),Ub=i(od," special method."),od.forEach(t),Hb=d($t),y(Pn.$$.fragment,$t),Qb=d($t),uc=s($t,"P",{});var z3=r(uc);Vb=i(z3,"Example of single-label classification:"),z3.forEach(t),Jb=d($t),y($r.$$.fragment,$t),Kb=d($t),fc=s($t,"P",{});var x3=r(fc);Gb=i(x3,"Example of multi-label classification:"),x3.forEach(t),Xb=d($t),y(Fr.$$.fragment,$t),$t.forEach(t),Zt.forEach(t),iu=d(o),jo=s(o,"H2",{class:!0});var ff=r(jo);jn=s(ff,"A",{id:!0,class:!0,href:!0});var q3=r(jn);mc=s(q3,"SPAN",{});var C3=r(mc);y(Rr.$$.fragment,C3),C3.forEach(t),q3.forEach(t),Yb=d(ff),gc=s(ff,"SPAN",{});var P3=r(gc);Zb=i(P3,"RobertaForMultipleChoice"),P3.forEach(t),ff.forEach(t),lu=d(o),tt=s(o,"DIV",{class:!0});var eo=r(tt);y(Mr.$$.fragment,eo),ek=d(eo),_c=s(eo,"P",{});var j3=r(_c);tk=i(j3,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),j3.forEach(t),ok=d(eo),Er=s(eo,"P",{});var mf=r(Er);nk=i(mf,"This model inherits from "),wl=s(mf,"A",{href:!0});var L3=r(wl);sk=i(L3,"PreTrainedModel"),L3.forEach(t),rk=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mf.forEach(t),ak=d(eo),zr=s(eo,"P",{});var gf=r(zr);ik=i(gf,"This model is also a PyTorch "),xr=s(gf,"A",{href:!0,rel:!0});var A3=r(xr);lk=i(A3,"torch.nn.Module"),A3.forEach(t),dk=i(gf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gf.forEach(t),ck=d(eo),it=s(eo,"DIV",{class:!0});var to=r(it);y(qr.$$.fragment,to),pk=d(to),Lo=s(to,"P",{});var nd=r(Lo);hk=i(nd,"The "),$l=s(nd,"A",{href:!0});var O3=r($l);uk=i(O3,"RobertaForMultipleChoice"),O3.forEach(t),fk=i(nd," forward method, overrides the "),bc=s(nd,"CODE",{});var N3=r(bc);mk=i(N3,"__call__"),N3.forEach(t),gk=i(nd," special method."),nd.forEach(t),_k=d(to),y(Ln.$$.fragment,to),bk=d(to),kc=s(to,"P",{});var I3=r(kc);kk=i(I3,"Example:"),I3.forEach(t),Tk=d(to),y(Cr.$$.fragment,to),to.forEach(t),eo.forEach(t),du=d(o),Ao=s(o,"H2",{class:!0});var _f=r(Ao);An=s(_f,"A",{id:!0,class:!0,href:!0});var D3=r(An);Tc=s(D3,"SPAN",{});var S3=r(Tc);y(Pr.$$.fragment,S3),S3.forEach(t),D3.forEach(t),yk=d(_f),yc=s(_f,"SPAN",{});var W3=r(yc);vk=i(W3,"RobertaForTokenClassification"),W3.forEach(t),_f.forEach(t),cu=d(o),ot=s(o,"DIV",{class:!0});var oo=r(ot);y(jr.$$.fragment,oo),wk=d(oo),vc=s(oo,"P",{});var B3=r(vc);$k=i(B3,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),B3.forEach(t),Fk=d(oo),Lr=s(oo,"P",{});var bf=r(Lr);Rk=i(bf,"This model inherits from "),Fl=s(bf,"A",{href:!0});var U3=r(Fl);Mk=i(U3,"PreTrainedModel"),U3.forEach(t),Ek=i(bf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bf.forEach(t),zk=d(oo),Ar=s(oo,"P",{});var kf=r(Ar);xk=i(kf,"This model is also a PyTorch "),Or=s(kf,"A",{href:!0,rel:!0});var H3=r(Or);qk=i(H3,"torch.nn.Module"),H3.forEach(t),Ck=i(kf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kf.forEach(t),Pk=d(oo),lt=s(oo,"DIV",{class:!0});var no=r(lt);y(Nr.$$.fragment,no),jk=d(no),Oo=s(no,"P",{});var sd=r(Oo);Lk=i(sd,"The "),Rl=s(sd,"A",{href:!0});var Q3=r(Rl);Ak=i(Q3,"RobertaForTokenClassification"),Q3.forEach(t),Ok=i(sd," forward method, overrides the "),wc=s(sd,"CODE",{});var V3=r(wc);Nk=i(V3,"__call__"),V3.forEach(t),Ik=i(sd," special method."),sd.forEach(t),Dk=d(no),y(On.$$.fragment,no),Sk=d(no),$c=s(no,"P",{});var J3=r($c);Wk=i(J3,"Example:"),J3.forEach(t),Bk=d(no),y(Ir.$$.fragment,no),no.forEach(t),oo.forEach(t),pu=d(o),No=s(o,"H2",{class:!0});var Tf=r(No);Nn=s(Tf,"A",{id:!0,class:!0,href:!0});var K3=r(Nn);Fc=s(K3,"SPAN",{});var G3=r(Fc);y(Dr.$$.fragment,G3),G3.forEach(t),K3.forEach(t),Uk=d(Tf),Rc=s(Tf,"SPAN",{});var X3=r(Rc);Hk=i(X3,"RobertaForQuestionAnswering"),X3.forEach(t),Tf.forEach(t),hu=d(o),nt=s(o,"DIV",{class:!0});var so=r(nt);y(Sr.$$.fragment,so),Qk=d(so),Io=s(so,"P",{});var rd=r(Io);Vk=i(rd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mc=s(rd,"CODE",{});var Y3=r(Mc);Jk=i(Y3,"span start logits"),Y3.forEach(t),Kk=i(rd," and "),Ec=s(rd,"CODE",{});var Z3=r(Ec);Gk=i(Z3,"span end logits"),Z3.forEach(t),Xk=i(rd,")."),rd.forEach(t),Yk=d(so),Wr=s(so,"P",{});var yf=r(Wr);Zk=i(yf,"This model inherits from "),Ml=s(yf,"A",{href:!0});var e0=r(Ml);eT=i(e0,"PreTrainedModel"),e0.forEach(t),tT=i(yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
