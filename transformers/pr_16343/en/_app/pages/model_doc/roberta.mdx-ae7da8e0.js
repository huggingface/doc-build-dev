...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16343/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16343/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16343/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ha=new ye({}),ua=new j({props:{name:"class transformers.TFRobertaForSequenceClassification",anchor:"transformers.TFRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_tf_roberta.py#L1319",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16343/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new fe({props:{$$slots:{default:[qM]},$$scope:{ctx:q}}}),_a=new j({props:{name:"call",anchor:"transformers.TFRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16343/src/transformers/models/roberta/modeling_tf_roberta.py#L1330",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16343/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16343/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),Cv=d(At),y(ts.$$.fragment,At),Pv=d(At),mt=s(At,"DIV",{class:!0});var ho=r(mt);y(qa.$$.fragment,ho),jv=d(ho),Zo=s(ho,"P",{});var hd=r(Zo);Lv=i(hd,"The "),Il=s(hd,"A",{href:!0});var Z3=r(Il);Av=i(Z3,"TFRobertaForTokenClassification"),Z3.forEach(t),Ov=i(hd," forward method, overrides the "),sp=s(hd,"CODE",{});var e4=r(sp);Nv=i(e4,"__call__"),e4.forEach(t),Iv=i(hd," special method."),hd.forEach(t),Dv=d(ho),y(os.$$.fragment,ho),Sv=d(ho),rp=s(ho,"P",{});var t4=r(rp);Wv=i(t4,"Example:"),t4.forEach(t),Bv=d(ho),y(Ca.$$.fragment,ho),ho.forEach(t),At.forEach(t),Fu=d(o),en=s(o,"H2",{class:!0});var Sf=r(en);ns=s(Sf,"A",{id:!0,class:!0,href:!0});var o4=r(ns);ap=s(o4,"SPAN",{});var n4=r(ap);y(Pa.$$.fragment,n4),n4.forEach(t),o4.forEach(t),Uv=d(Sf),ip=s(Sf,"SPAN",{});var s4=r(ip);Hv=i(s4,"TFRobertaForQuestionAnswering"),s4.forEach(t),Sf.forEach(t),Ru=d(o),Ke=s(o,"DIV",{class:!0});var Ot=r(Ke);y(ja.$$.fragment,Ot),Qv=d(Ot),tn=s(Ot,"P",{});var ud=r(tn);Vv=i(ud,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),lp=s(ud,"CODE",{});var r4=r(lp);Jv=i(r4,"span start logits"),r4.forEach(t),Kv=i(ud," and "),dp=s(ud,"CODE",{});var a4=r(dp);Gv=i(a4,"span end logits"),a4.forEach(t),Xv=i(ud,")."),ud.forEach(t),Yv=d(Ot),La=s(Ot,"P",{});var Wf=r(La);Zv=i(Wf,"This model inherits from "),Dl=s(Wf,"A",{href:!0});var i4=r(Dl);e1=i(i4,"TFPreTrainedModel"),i4.forEach(t),t1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),o1=d(Ot),Aa=s(Ot,"P",{});var Bf=r(Aa);n1=i(Bf,"This model is also a "),Oa=s(Bf,"A",{href:!0,rel:!0});var l4=r(Oa);s1=i(l4,"tf.keras.Model"),l4.forEach(t),r1=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),a1=d(Ot),y(ss.$$.fragment,Ot),i1=d(Ot),gt=s(Ot,"DIV",{class:!0});var uo=r(gt);y(Na.$$.fragment,uo),l1=d(uo),on=s(uo,"P",{});var fd=r(on);d1=i(fd,"The "),Sl=s(fd,"A",{href:!0});var d4=r(Sl);c1=i(d4,"TFRobertaForQuestionAnswering"),d4.forEach(t),p1=i(fd," forward method, overrides the "),cp=s(fd,"CODE",{});var c4=r(cp);h1=i(c4,"__call__"),c4.forEach(t),u1=i(fd," special method."),fd.forEach(t),f1=d(uo),y(rs.$$.fragment,uo),m1=d(uo),pp=s(uo,"P",{});var p4=r(pp);g1=i(p4,"Example:"),p4.forEach(t),_1=d(uo),y(Ia.$$.fragment,uo),uo.forEach(t),Ot.forEach(t),Mu=d(o),nn=s(o,"H2",{class:!0});var Uf=r(nn);as=s(Uf,"A",{id:!0,class:!0,href:!0});var h4=r(as);hp=s(h4,"SPAN",{});var u4=r(hp);y(Da.$$.fragment,u4),u4.forEach(t),h4.forEach(t),b1=d(Uf),up=s(Uf,"SPAN",{});var f4=r(up);k1=i(f4,"FlaxRobertaModel"),f4.forEach(t),Uf.forEach(t),Eu=d(o),Le=s(o,"DIV",{class:!0});var Ft=r(Le);y(Sa.$$.fragment,Ft),T1=d(Ft),fp=s(Ft,"P",{});var m4=r(fp);y1=i(m4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),m4.forEach(t),v1=d(Ft),Wa=s(Ft,"P",{});var Hf=r(Wa);w1=i(Hf,"This model inherits from "),Wl=s(Hf,"A",{href:!0});var g4=r(Wl);$1=i(g4,"FlaxPreTrainedModel"),g4.forEach(t),F1=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),R1=d(Ft),Ba=s(Ft,"P",{});var Qf=r(Ba);M1=i(Qf,"This model is also a Flax Linen "),Ua=s(Qf,"A",{href:!0,rel:!0});var _4=r(Ua);E1=i(_4,"flax.linen.Module"),_4.forEach(t),z1=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),x1=d(Ft),mp=s(Ft,"P",{});var b4=r(mp);q1=i(b4,"Finally, this model supports inherent JAX features such as:"),b4.forEach(t),C1=d(Ft),Nt=s(Ft,"UL",{});var bs=r(Nt);gp=s(bs,"LI",{});var k4=r(gp);Ha=s(k4,"A",{href:!0,rel:!0});var T4=r(Ha);P1=i(T4,"Just-In-Time (JIT) compilation"),T4.forEach(t),k4.forEach(t),j1=d(bs),_p=s(bs,"LI",{});var y4=r(_p);Qa=s(y4,"A",{href:!0,rel:!0});var v4=r(Qa);L1=i(v4,"Automatic Differentiation"),v4.forEach(t),y4.forEach(t),A1=d(bs),bp=s(bs,"LI",{});var w4=r(bp);Va=s(w4,"A",{href:!0,rel:!0});var $4=r(Va);O1=i($4,"Vectorization"),$4.forEach(t),w4.forEach(t),N1=d(bs),kp=s(bs,"LI",{});var F4=r(kp);Ja=s(F4,"A",{href:!0,rel:!0});var R4=r(Ja);I1=i(R4,"Parallelization"),R4.forEach(t),F4.forEach(t),bs.forEach(t),D1=d(Ft),_t=s(Ft,"DIV",{class:!0});var fo=r(_t);y(Ka.$$.fragment,fo),S1=d(fo),sn=s(fo,"P",{});var md=r(sn);W1=i(md,"The "),Tp=s(md,"CODE",{});var M4=r(Tp);B1=i(M4,"FlaxRobertaPreTrainedModel"),M4.forEach(t),U1=i(md,"forward method, overrides the "),yp=s(md,"CODE",{});var E4=r(yp);H1=i(E4,"__call__"),E4.forEach(t),Q1=i(md," special method."),md.forEach(t),V1=d(fo),y(is.$$.fragment,fo),J1=d(fo),vp=s(fo,"P",{});var z4=r(vp);K1=i(z4,"Example:"),z4.forEach(t),G1=d(fo),y(Ga.$$.fragment,fo),fo.forEach(t),Ft.forEach(t),zu=d(o),rn=s(o,"H2",{class:!0});var Vf=r(rn);ls=s(Vf,"A",{id:!0,class:!0,href:!0});var x4=r(ls);wp=s(x4,"SPAN",{});var q4=r(wp);y(Xa.$$.fragment,q4),q4.forEach(t),x4.forEach(t),X1=d(Vf),$p=s(Vf,"SPAN",{});var C4=r($p);Y1=i(C4,"FlaxRobertaForMaskedLM"),C4.forEach(t),Vf.forEach(t),xu=d(o),Ae=s(o,"DIV",{class:!0});var Rt=r(Ae);y(Ya.$$.fragment,Rt),Z1=d(Rt),Za=s(Rt,"P",{});var Jf=r(Za);ew=i(Jf,"RoBERTa Model with a "),Fp=s(Jf,"CODE",{});var P4=r(Fp);tw=i(P4,"language modeling"),P4.forEach(t),ow=i(Jf," head on top."),Jf.forEach(t),nw=d(Rt),ei=s(Rt,"P",{});var Kf=r(ei);sw=i(Kf,"This model inherits from "),Bl=s(Kf,"A",{href:!0});var j4=r(Bl);rw=i(j4,"FlaxPreTrainedModel"),j4.forEach(t),aw=i(Kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kf.forEach(t),iw=d(Rt),ti=s(Rt,"P",{});var Gf=r(ti);lw=i(Gf,"This model is also a Flax Linen "),oi=s(Gf,"A",{href:!0,rel:!0});var L4=r(oi);dw=i(L4,"flax.linen.Module"),L4.forEach(t),cw=i(Gf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gf.forEach(t),pw=d(Rt),Rp=s(Rt,"P",{});var A4=r(Rp);hw=i(A4,"Finally, this model supports inherent JAX features such as:"),A4.forEach(t),uw=d(Rt),It=s(Rt,"UL",{});var ks=r(It);Mp=s(ks,"LI",{});var O4=r(Mp);ni=s(O4,"A",{href:!0,rel:!0});var N4=r(ni);fw=i(N4,"Just-In-Time (JIT) compilation"),N4.forEach(t),O4.forEach(t),mw=d(ks),Ep=s(ks,"LI",{});var I4=r(Ep);si=s(I4,"A",{href:!0,rel:!0});var D4=r(si);gw=i(D4,"Automatic Differentiation"),D4.forEach(t),I4.forEach(t),_w=d(ks),zp=s(ks,"LI",{});var S4=r(zp);ri=s(S4,"A",{href:!0,rel:!0});var W4=r(ri);bw=i(W4,"Vectorization"),W4.forEach(t),S4.forEach(t),kw=d(ks),xp=s(ks,"LI",{});var B4=r(xp);ai=s(B4,"A",{href:!0,rel:!0});var U4=r(ai);Tw=i(U4,"Parallelization"),U4.forEach(t),B4.forEach(t),ks.forEach(t),yw=d(Rt),bt=s(Rt,"DIV",{class:!0});var mo=r(bt);y(ii.$$.fragment,mo),vw=d(mo),an=s(mo,"P",{});var gd=r(an);ww=i(gd,"The "),qp=s(gd,"CODE",{});var H4=r(qp);$w=i(H4,"FlaxRobertaPreTrainedModel"),H4.forEach(t),Fw=i(gd,"forward method, overrides the "),Cp=s(gd,"CODE",{});var Q4=r(Cp);Rw=i(Q4,"__call__"),Q4.forEach(t),Mw=i(gd," special method."),gd.forEach(t),Ew=d(mo),y(ds.$$.fragment,mo),zw=d(mo),Pp=s(mo,"P",{});var V4=r(Pp);xw=i(V4,"Example:"),V4.forEach(t),qw=d(mo),y(li.$$.fragment,mo),mo.forEach(t),Rt.forEach(t),qu=d(o),ln=s(o,"H2",{class:!0});var Xf=r(ln);cs=s(Xf,"A",{id:!0,class:!0,href:!0});var J4=r(cs);jp=s(J4,"SPAN",{});var K4=r(jp);y(di.$$.fragment,K4),K4.forEach(t),J4.forEach(t),Cw=d(Xf),Lp=s(Xf,"SPAN",{});var G4=r(Lp);Pw=i(G4,"FlaxRobertaForSequenceClassification"),G4.forEach(t),Xf.forEach(t),Cu=d(o),Oe=s(o,"DIV",{class:!0});var Mt=r(Oe);y(ci.$$.fragment,Mt),jw=d(Mt),Ap=s(Mt,"P",{});var X4=r(Ap);Lw=i(X4,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X4.forEach(t),Aw=d(Mt),pi=s(Mt,"P",{});var Yf=r(pi);Ow=i(Yf,"This model inherits from "),Ul=s(Yf,"A",{href:!0});var Y4=r(Ul);Nw=i(Y4,"FlaxPreTrainedModel"),Y4.forEach(t),Iw=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yf.forEach(t),Dw=d(Mt),hi=s(Mt,"P",{});var Zf=r(hi);Sw=i(Zf,"This model is also a Flax Linen "),ui=s(Zf,"A",{href:!0,rel:!0});var Z4=r(ui);Ww=i(Z4,"flax.linen.Module"),Z4.forEach(t),Bw=i(Zf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zf.forEach(t),Uw=d(Mt),Op=s(Mt,"P",{});var eR=r(Op);Hw=i(eR,"Finally, this model supports inherent JAX features such as:"),eR.forEach(t),Qw=d(Mt),Dt=s(Mt,"UL",{});var Ts=r(Dt);Np=s(Ts,"LI",{});var tR=r(Np);fi=s(tR,"A",{href:!0,rel:!0});var oR=r(fi);Vw=i(oR,"Just-In-Time (JIT) compilation"),oR.forEach(t),tR.forEach(t),Jw=d(Ts),Ip=s(Ts,"LI",{});var nR=r(Ip);mi=s(nR,"A",{href:!0,rel:!0});var sR=r(mi);Kw=i(sR,"Automatic Differentiation"),sR.forEach(t),nR.forEach(t),Gw=d(Ts),Dp=s(Ts,"LI",{});var rR=r(Dp);gi=s(rR,"A",{href:!0,rel:!0});var aR=r(gi);Xw=i(aR,"Vectorization"),aR.forEach(t),rR.forEach(t),Yw=d(Ts),Sp=s(Ts,"LI",{});var iR=r(Sp);_i=s(iR,"A",{href:!0,rel:!0});var lR=r(_i);Zw=i(lR,"Parallelization"),lR.forEach(t),iR.forEach(t),Ts.forEach(t),e$=d(Mt),kt=s(Mt,"DIV",{class:!0});var go=r(kt);y(bi.$$.fragment,go),t$=d(go),dn=s(go,"P",{});var _d=r(dn);o$=i(_d,"The "),Wp=s(_d,"CODE",{});var dR=r(Wp);n$=i(dR,"FlaxRobertaPreTrainedModel"),dR.forEach(t),s$=i(_d,"forward method, overrides the "),Bp=s(_d,"CODE",{});var cR=r(Bp);r$=i(cR,"__call__"),cR.forEach(t),a$=i(_d," special method."),_d.forEach(t),i$=d(go),y(ps.$$.fragment,go),l$=d(go),Up=s(go,"P",{});var pR=r(Up);d$=i(pR,"Example:"),pR.forEach(t),c$=d(go),y(ki.$$.fragment,go),go.forEach(t),Mt.forEach(t),Pu=d(o),cn=s(o,"H2",{class:!0});var em=r(cn);hs=s(em,"A",{id:!0,class:!0,href:!0});var hR=r(hs);Hp=s(hR,"SPAN",{});var uR=r(Hp);y(Ti.$$.fragment,uR),uR.forEach(t),hR.forEach(t),p$=d(em),Qp=s(em,"SPAN",{});var fR=r(Qp);h$=i(fR,"FlaxRobertaForMultipleChoice"),fR.forEach(t),em.forEach(t),ju=d(o),Ne=s(o,"DIV",{class:!0});var Et=r(Ne);y(yi.$$.fragment,Et),u$=d(Et),Vp=s(Et,"P",{});var mR=r(Vp);f$=i(mR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),mR.forEach(t),m$=d(Et),vi=s(Et,"P",{});var tm=r(vi);g$=i(tm,"This model inherits from "),Hl=s(tm,"A",{href:!0});var gR=r(Hl);_$=i(gR,"FlaxPreTrainedModel"),gR.forEach(t),b$=i(tm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),tm.forEach(t),k$=d(Et),wi=s(Et,"P",{});var om=r(wi);T$=i(om,"This model is also a Flax Linen "),$i=s(om,"A",{href:!0,rel:!0});var _R=r($i);y$=i(_R,"flax.linen.Module"),_R.forEach(t),v$=i(om,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),om.forEach(t),w$=d(Et),Jp=s(Et,"P",{});var bR=r(Jp);$$=i(bR,"Finally, this model supports inherent JAX features such as:"),bR.forEach(t),F$=d(Et),St=s(Et,"UL",{});var ys=r(St);Kp=s(ys,"LI",{});var kR=r(Kp);Fi=s(kR,"A",{href:!0,rel:!0});var TR=r(Fi);R$=i(TR,"Just-In-Time (JIT) compilation"),TR.forEach(t),kR.forEach(t),M$=d(ys),Gp=s(ys,"LI",{});var yR=r(Gp);Ri=s(yR,"A",{href:!0,rel:!0});var vR=r(Ri);E$=i(vR,"Automatic Differentiation"),vR.forEach(t),yR.forEach(t),z$=d(ys),Xp=s(ys,"LI",{});var wR=r(Xp);Mi=s(wR,"A",{href:!0,rel:!0});var $R=r(Mi);x$=i($R,"Vectorization"),$R.forEach(t),wR.forEach(t),q$=d(ys),Yp=s(ys,"LI",{});var FR=r(Yp);Ei=s(FR,"A",{href:!0,rel:!0});var RR=r(Ei);C$=i(RR,"Parallelization"),RR.forEach(t),FR.forEach(t),ys.forEach(t),P$=d(Et),Tt=s(Et,"DIV",{class:!0});var _o=r(Tt);y(zi.$$.fragment,_o),j$=d(_o),pn=s(_o,"P",{});var bd=r(pn);L$=i(bd,"The "),Zp=s(bd,"CODE",{});var MR=r(Zp);A$=i(MR,"FlaxRobertaPreTrainedModel"),MR.forEach(t),O$=i(bd,"forward method, overrides the "),eh=s(bd,"CODE",{});var ER=r(eh);N$=i(ER,"__call__"),ER.forEach(t),I$=i(bd," special method."),bd.forEach(t),D$=d(_o),y(us.$$.fragment,_o),S$=d(_o),th=s(_o,"P",{});var zR=r(th);W$=i(zR,"Example:"),zR.forEach(t),B$=d(_o),y(xi.$$.fragment,_o),_o.forEach(t),Et.forEach(t),Lu=d(o),hn=s(o,"H2",{class:!0});var nm=r(hn);fs=s(nm,"A",{id:!0,class:!0,href:!0});var xR=r(fs);oh=s(xR,"SPAN",{});var qR=r(oh);y(qi.$$.fragment,qR),qR.forEach(t),xR.forEach(t),U$=d(nm),nh=s(nm,"SPAN",{});var CR=r(nh);H$=i(CR,"FlaxRobertaForTokenClassification"),CR.forEach(t),nm.forEach(t),Au=d(o),Ie=s(o,"DIV",{class:!0});var zt=r(Ie);y(Ci.$$.fragment,zt),Q$=d(zt),sh=s(zt,"P",{});var PR=r(sh);V$=i(PR,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),PR.forEach(t),J$=d(zt),Pi=s(zt,"P",{});var sm=r(Pi);K$=i(sm,"This model inherits from "),Ql=s(sm,"A",{href:!0});var jR=r(Ql);G$=i(jR,"FlaxPreTrainedModel"),jR.forEach(t),X$=i(sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sm.forEach(t),Y$=d(zt),ji=s(zt,"P",{});var rm=r(ji);Z$=i(rm,"This model is also a Flax Linen "),Li=s(rm,"A",{href:!0,rel:!0});var LR=r(Li);eF=i(LR,"flax.linen.Module"),LR.forEach(t),tF=i(rm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),rm.forEach(t),oF=d(zt),rh=s(zt,"P",{});var AR=r(rh);nF=i(AR,"Finally, this model supports inherent JAX features such as:"),AR.forEach(t),sF=d(zt),Wt=s(zt,"UL",{});var vs=r(Wt);ah=s(vs,"LI",{});var OR=r(ah);Ai=s(OR,"A",{href:!0,rel:!0});var NR=r(Ai);rF=i(NR,"Just-In-Time (JIT) compilation"),NR.forEach(t),OR.forEach(t),aF=d(vs),ih=s(vs,"LI",{});var IR=r(ih);Oi=s(IR,"A",{href:!0,rel:!0});var DR=r(Oi);iF=i(DR,"Automatic Differentiation"),DR.forEach(t),IR.forEach(t),lF=d(vs),lh=s(vs,"LI",{});var SR=r(lh);Ni=s(SR,"A",{href:!0,rel:!0});var WR=r(Ni);dF=i(WR,"Vectorization"),WR.forEach(t),SR.forEach(t),cF=d(vs),dh=s(vs,"LI",{});var BR=r(dh);Ii=s(BR,"A",{href:!0,rel:!0});var UR=r(Ii);pF=i(UR,"Parallelization"),UR.forEach(t),BR.forEach(t),vs.forEach(t),hF=d(zt),yt=s(zt,"DIV",{class:!0});var bo=r(yt);y(Di.$$.fragment,bo),uF=d(bo),un=s(bo,"P",{});var kd=r(un);fF=i(kd,"The "),ch=s(kd,"CODE",{});var HR=r(ch);mF=i(HR,"FlaxRobertaPreTrainedModel"),HR.forEach(t),gF=i(kd,"forward method, overrides the "),ph=s(kd,"CODE",{});var QR=r(ph);_F=i(QR,"__call__"),QR.forEach(t),bF=i(kd," special method."),kd.forEach(t),kF=d(bo),y(ms.$$.fragment,bo),TF=d(bo),hh=s(bo,"P",{});var VR=r(hh);yF=i(VR,"Example:"),VR.forEach(t),vF=d(bo),y(Si.$$.fragment,bo),bo.forEach(t),zt.forEach(t),Ou=d(o),fn=s(o,"H2",{class:!0});var am=r(fn);gs=s(am,"A",{id:!0,class:!0,href:!0});var JR=r(gs);uh=s(JR,"SPAN",{});var KR=r(uh);y(Wi.$$.fragment,KR),KR.forEach(t),JR.forEach(t),wF=d(am),fh=s(am,"SPAN",{});var GR=r(fh);$F=i(GR,"FlaxRobertaForQuestionAnswering"),GR.forEach(t),am.forEach(t),Nu=d(o),De=s(o,"DIV",{class:!0});var xt=r(De);y(Bi.$$.fragment,xt),FF=d(xt),mn=s(xt,"P",{});var Td=r(mn);RF=i(Td,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),mh=s(Td,"CODE",{});var XR=r(mh);MF=i(XR,"span start logits"),XR.forEach(t),EF=i(Td," and "),gh=s(Td,"CODE",{});var YR=r(gh);zF=i(YR,"span end logits"),YR.forEach(t),xF=i(Td,")."),Td.forEach(t),qF=d(xt),Ui=s(xt,"P",{});var im=r(Ui);CF=i(im,"This model inherits from "),Vl=s(im,"A",{href:!0});var ZR=r(Vl);PF=i(ZR,"FlaxPreTrainedModel"),ZR.forEach(t),jF=i(im,`. Check the superclass documentation for the generic methods the
