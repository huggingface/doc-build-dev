...
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var y=i(u);D=r(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(y,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),x=r(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(w,y){p(w,u,y),e(u,D),e(u,m),e(m,B),e(u,x)},d(w){w&&o(u)}}}function _a(He){let u,D,m,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var y=i(u);D=r(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(y,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),x=r(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(w,y){p(w,u,y),e(u,D),e(u,m),e(m,B),e(u,x)},d(w){w&&o(u)}}}function ba(He){let u,D,m,B,x,w,y,S,Do,Kt,R,Y,kt,ie,So,Tt,Mo,Qt,M,Ao,Ve,No,Lo,de,Fo,Oo,Xt,Je,Io,Yt,Ke,wt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,yt,on,nn,rn,Et,sn,ao,N,an,ue,dn,ln,me,cn,hn,io,W,ee,Bt,fe,pn,zt,un,lo,$,ge,mn,_e,fn,$t,gn,_n,bn,U,vn,rt,kn,Tn,st,wn,yn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,C,ke,qn,Te,Pn,we,jn,xn,Cn,ye,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,jt,Be,Nn,xt,Ln,uo,f,ze,Fn,Ct,On,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,je,Yn,Zn,er,J,tr,lt,or,nr,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,mr,fr,Nt,gr,_r,Lt,br,vr,kr,q,Ce,Tr,K,wr,ct,yr,Er,Ft,Br,zr,$r,ne,Gr,Ot,qr,Pr,De,mo,Q,re,It,Se,jr,Rt,xr,fo,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Lr,Fr,Or,Le,Ir,Fe,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return w=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<p>A <a
  href="/docs/transformers/pr_16477/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16477/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
Tasks`),Oo=n(" by Sascha Rothe, Shashi Narayan, Aliaksei Severyn."),Xt=l(),Je=s("p"),Io=n("The abstract from the paper is the following:"),Yt=l(),Ke=s("p"),wt=s("em"),Ro=n(`Unsupervised pretraining of large neural models has recently revolutionized Natural Language Processing. By
...
documentation from `),st=s("a"),wn=n("PretrainedConfig"),yn=n(" for more information."),En=l(),Gt=s("p"),Bn=n("Examples:"),zn=l(),g(be.$$.fragment),co=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ve.$$.fragment),$n=l(),Pt=s("span"),Gn=n("BertGenerationTokenizer"),ho=l(),C=s("div"),g(ke.$$.fragment),qn=l(),Te=s("p"),Pn=n("Construct a BertGeneration tokenizer. Based on "),we=s("a"),jn=n("SentencePiece"),xn=n("."),Cn=l(),ye=s("p"),Dn=n("This tokenizer inherits from "),at=s("a"),Sn=n("PreTrainedTokenizer"),Mn=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),jt=s("span"),g(Be.$$.fragment),Nn=l(),xt=s("span"),Ln=n("BertGenerationEncoder"),uo=l(),f=s("div"),g(ze.$$.fragment),Fn=l(),Ct=s("p"),On=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(o),ko.forEach(o),ao=c(t),N=a(t,"P",{});var mt=i(N);an=r(mt,"This model was contributed by "),ue=a(mt,"A",{href:!0,rel:!0});var ws=i(ue);dn=r(ws,"patrickvonplaten"),ws.forEach(o),ln=r(mt,`. The original code can be
found `),me=a(mt,"A",{href:!0,rel:!0});var ys=i(me);cn=r(ys,"here"),ys.forEach(o),hn=r(mt,"."),mt.forEach(o),io=c(t),W=a(t,"H2",{class:!0});var To=i(W);ee=a(To,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(fe.$$.fragment,Bs),Bs.forEach(o),Es.forEach(o),pn=c(To),zt=a(To,"SPAN",{});var zs=i(zt);un=r(zs,"BertGenerationConfig"),zs.forEach(o),To.forEach(o),lo=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(ge.$$.fragment,L),mn=c(L),_e=a(L,"P",{});var wo=i(_e);fn=r(wo,"This is the configuration class to store the configuration of a "),$t=a(wo,"CODE",{});var $s=i($t);gn=r($s,"BertGenerationPreTrainedModel"),$s.forEach(o),_n=r(wo,` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),wo.forEach(o),bn=c(L),U=a(L,"P",{});var ft=i(U);vn=r(ft,"Configuration objects inherit from "),rt=a(ft,"A",{href:!0});var Gs=i(rt);kn=r(Gs,"PretrainedConfig"),Gs.forEach(o),Tn=r(ft,` and can be used to control the model outputs. Read the
documentation from `),st=a(ft,"A",{href:!0});var qs=i(st);wn=r(qs,"PretrainedConfig"),qs.forEach(o),yn=r(ft," for more information."),ft.forEach(o),En=c(L),Gt=a(L,"P",{});var Ps=i(Gt);Bn=r(Ps,"Examples:"),Ps.forEach(o),zn=c(L),_(be.$$.fragment,L),L.forEach(o),co=c(t),H=a(t,"H2",{class:!0});var yo=i(H);te=a(yo,"A",{id:!0,class:!0,href:!0});var js=i(te);qt=a(js,"SPAN",{});var xs=i(qt);_(ve.$$.fragment,xs),xs.forEach(o),js.forEach(o),$n=c(yo),Pt=a(yo,"SPAN",{});var Cs=i(Pt);Gn=r(Cs,"BertGenerationTokenizer"),Cs.forEach(o),yo.forEach(o),ho=c(t),C=a(t,"DIV",{class:!0});var ae=i(C);_(ke.$$.fragment,ae),qn=c(ae),Te=a(ae,"P",{});var Eo=i(Te);Pn=r(Eo,"Construct a BertGeneration tokenizer. Based on "),we=a(Eo,"A",{href:!0,rel:!0});var Ds=i(we);jn=r(Ds,"SentencePiece"),Ds.forEach(o),xn=r(Eo,"."),Eo.forEach(o),Cn=c(ae),ye=a(ae,"P",{});var Bo=i(ye);Dn=r(Bo,"This tokenizer inherits from "),at=a(Bo,"A",{href:!0});var Ss=i(at);Sn=r(Ss,"PreTrainedTokenizer"),Ss.forEach(o),Mn=r(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),An=c(ae),it=a(ae,"DIV",{class:!0});var Ms=i(it);_(Ee.$$.fragment,Ms),Ms.forEach(o),ae.forEach(o),po=c(t),V=a(t,"H2",{class:!0});var zo=i(V);oe=a(zo,"A",{id:!0,class:!0,href:!0});var As=i(oe);jt=a(As,"SPAN",{});var Ns=i(jt);_(Be.$$.fragment,Ns),Ns.forEach(o),As.forEach(o),Nn=c(zo),xt=a(zo,"SPAN",{});var Ls=i(xt);Ln=r(Ls,"BertGenerationEncoder"),Ls.forEach(o),zo.forEach(o),uo=c(t),f=a(t,"DIV",{class:!0});var z=i(f);_(ze.$$.fragment,z),Fn=c(z),Ct=a(z,"P",{});var Fs=i(Ct);On=r(Fs,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Fs.forEach(o),In=c(z),$e=a(z,"P",{});var $o=i($e);Rn=r($o,"This model inherits from "),dt=a($o,"A",{href:!0});var Os=i(dt);Wn=r(Os,"PreTrainedModel"),Os.forEach(o),Un=r($o,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
