...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">ResnetModel</span>(<span class="hljs-title class_ inherited__">PreTrainedModel</span>):
    ...
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, tensor, labels=<span class="hljs-literal">None</span></span>):
        ...
        <span class="hljs-keyword">return</span> {<span class="hljs-string">&quot;logits&quot;</span>: logits}`}}),ae=new ar({props:{$$slots:{default:[Li]},$$scope:{ctx:z}}}),Te=new E({props:{code:"resnet50d = ResnetModelForImageClassification(resnet50d_config)",highlighted:"resnet50d = ResnetModelForImageClassification(resnet50d_config)"}}),Me=new E({props:{code:`import timm
...
resnet50d.model.load_state_dict(pretrained_model.state_dict())`}}),Re=new Nt({}),re=new ar({props:{warning:"&lcub;true}",$$slots:{default:[Yi]},$$scope:{ctx:z}}}),qe=new E({props:{code:`.
\u2514\u2500\u2500 resnet_model
    \u251C\u2500\u2500 __init__.py
...
\u2514\u2500\u2500 resnet_model
    ...
    \u2514\u2500\u2500 modeling_resnet.<span class="hljs-keyword">py</span>`}}),ie=new ar({props:{warning:"&lcub;true}",$$slots:{default:[zi]},$$scope:{ctx:z}}}),Ie=new E({props:{code:`from resnet_model.configuration_resnet import ResnetConfig
