import{S as Ia,i as Aa,s as Pa,e as n,k as c,w,t as r,M as qa,c as a,d as o,m as h,a as s,x as v,h as i,b as l,N as za,F as e,g as p,y as b,q as S,o as $,B as y}from"../../chunks/vendor-4833417e.js";import{T as Ln}from"../../chunks/Tip-fffd6df1.js";import{D as ze}from"../../chunks/Docstring-7b52c3d4.js";import{C as eo}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as at}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Na(O){let m,T,f,_,k;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var x=s(f);_=i(x,"Module"),x.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,T),e(m,f),e(f,_),e(m,k)},d(u){u&&o(m)}}}function Oa(O){let m,T,f,_,k;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var x=s(f);_=i(x,"Module"),x.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,T),e(m,f),e(f,_),e(m,k)},d(u){u&&o(m)}}}function Da(O){let m,T,f,_,k;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var x=s(f);_=i(x,"Module"),x.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){p(u,m,g),e(m,T),e(m,f),e(f,_),e(m,k)},d(u){u&&o(m)}}}function La(O){let m,T,f,_,k,u,g,x,to,Mt,D,J,st,de,oo,rt,no,Et,L,ao,ce,so,ro,io,jt,Ne,lo,Ft,Oe,it,co,Ct,De,ho,It,Le,he,po,We,mo,fo,At,Q,Wn,Pt,X,uo,He,go,_o,qt,P,wo,pe,vo,bo,me,So,$o,zt,W,ee,lt,fe,yo,dt,To,Nt,F,ue,ko,H,xo,Ue,Mo,Eo,ge,jo,Fo,Co,U,Io,Be,Ao,Po,Ve,qo,zo,No,_e,Ot,B,te,ct,we,Oo,ht,Do,Dt,I,ve,Lo,be,Wo,Se,Ho,Uo,Bo,M,$e,Vo,V,Ko,Ke,Yo,Zo,pt,Ro,Go,Jo,oe,Qo,mt,Xo,en,ye,Lt,K,ne,ft,Te,tn,ut,on,Wt,A,ke,nn,Y,an,gt,sn,rn,xe,ln,dn,cn,E,Me,hn,Z,pn,Ye,mn,fn,_t,un,gn,_n,ae,wn,wt,vn,bn,Ee,Ht,R,se,vt,je,Sn,bt,$n,Ut,C,Fe,yn,St,Tn,kn,Ce,xn,Ie,Mn,En,jn,j,Ae,Fn,G,Cn,Ze,In,An,$t,Pn,qn,zn,re,Nn,yt,On,Dn,Pe,Bt;return u=new at({}),de=new at({}),fe=new at({}),ue=new ze({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15928/src/transformers/models/swin/configuration_swin.py#L29",parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),we=new at({}),ve=new ze({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15928/src/transformers/models/swin/modeling_swin.py#L684",parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15928/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$e=new ze({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15928/src/transformers/models/swin/modeling_swin.py#L711",parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_15928/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<p>A <a
  href="/docs/transformers/pr_15928/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),je=new at({}),Fe=new ze({props:{name:"class transformers.SwinForImageClassification",anchor:"transformers.SwinForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15928/src/transformers/models/swin/modeling_swin.py#L887",parametersDescription:[{anchor:"transformers.SwinForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15928/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ae=new ze({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15928/src/transformers/models/swin/modeling_swin.py#L902",parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_15928/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Ct=c(),De=n("p"),ho=r("Tips:"),It=c(),Le=n("ul"),he=n("li"),po=r("One can use the "),We=n("a"),mo=r("AutoFeatureExtractor"),fo=r(" API to prepare images for the model."),At=c(),Q=n("img"),Pt=c(),X=n("small"),uo=r("Swin Transformer architecture. Taken from the "),He=n("a"),go=r("original paper"),_o=r("."),qt=c(),P=n("p"),wo=r("This model was contributed by "),pe=n("a"),vo=r("novice03"),bo=r(". The original code can be found "),me=n("a"),So=r("here"),$o=r("."),zt=c(),W=n("h2"),ee=n("a"),lt=n("span"),w(fe.$$.fragment),yo=c(),dt=n("span"),To=r("SwinConfig"),Nt=c(),F=n("div"),w(ue.$$.fragment),ko=c(),H=n("p"),xo=r("This is the configuration class to store the configuration of a "),Ue=n("a"),Mo=r("SwinModel"),Eo=r(`. It is used to instantiate a Swin
...
architecture.`),Co=c(),U=n("p"),Io=r("Configuration objects inherit from "),Be=n("a"),Ao=r("PretrainedConfig"),Po=r(` and can be used to control the model outputs. Read the
...
behavior.`),Bo=c(),M=n("div"),w($e.$$.fragment),Vo=c(),V=n("p"),Ko=r("The "),Ke=n("a"),Yo=r("SwinModel"),Zo=r(" forward method, overrides the "),pt=n("code"),Ro=r("__call__"),Go=r(" special method."),Jo=c(),w(oe.$$.fragment),Qo=c(),mt=n("p"),Xo=r("Example:"),en=c(),w(ye.$$.fragment),Lt=c(),K=n("h2"),ne=n("a"),ft=n("span"),w(Te.$$.fragment),tn=c(),ut=n("span"),on=r("SwinForMaskedImageModeling"),Wt=c(),A=n("div"),w(ke.$$.fragment),nn=c(),Y=n("p"),an=r("Swin Model with a decoder on top for masked image modeling, as proposed in "),gt=n("code"),sn=r("SimMIM <https://arxiv.org/abs/2111.09886>"),rn=r(`__.
This model is a PyTorch `),xe=n("a"),ln=r("torch.nn.Module"),dn=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),cn=c(),E=n("div"),w(Me.$$.fragment),hn=c(),Z=n("p"),pn=r("The "),Ye=n("a"),mn=r("SwinForMaskedImageModeling"),fn=r(" forward method, overrides the "),_t=n("code"),un=r("__call__"),gn=r(" special method."),_n=c(),w(ae.$$.fragment),wn=c(),wt=n("p"),vn=r("Examples:"),bn=c(),w(Ee.$$.fragment),Ht=c(),R=n("h2"),se=n("a"),vt=n("span"),w(je.$$.fragment),Sn=c(),bt=n("span"),$n=r("SwinForImageClassification"),Ut=c(),C=n("div"),w(Fe.$$.fragment),yn=c(),St=n("p"),Tn=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),kn=c(),Ce=n("p"),xn=r("This model is a PyTorch "),Ie=n("a"),Mn=r("torch.nn.Module"),En=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jn=c(),j=n("div"),w(Ae.$$.fragment),Fn=c(),G=n("p"),Cn=r("The "),Ze=n("a"),In=r("SwinForImageClassification"),An=r(" forward method, overrides the "),$t=n("code"),Pn=r("__call__"),qn=r(" special method."),zn=c(),w(re.$$.fragment),Nn=c(),yt=n("p"),On=r("Example:"),Dn=c(),w(Pe.$$.fragment),this.h()},l(t){const d=qa('[data-svelte="svelte-1phssyn"]',document.head);m=a(d,"META",{name:!0,content:!0}),d.forEach(o),T=h(t),f=a(t,"H1",{class:!0});var qe=s(f);_=a(qe,"A",{id:!0,class:!0,href:!0});var Tt=s(_);k=a(Tt,"SPAN",{});var kt=s(k);v(u.$$.fragment,kt),kt.forEach(o),Tt.forEach(o),g=h(qe),x=a(qe,"SPAN",{});var Hn=s(x);to=i(Hn,"Swin Transformer"),Hn.forEach(o),qe.forEach(o),Mt=h(t),D=a(t,"H2",{class:!0});var Vt=s(D);J=a(Vt,"A",{id:!0,class:!0,href:!0});var Un=s(J);st=a(Un,"SPAN",{});var Bn=s(st);v(de.$$.fragment,Bn),Bn.forEach(o),Un.forEach(o),oo=h(Vt),rt=a(Vt,"SPAN",{});var Vn=s(rt);no=i(Vn,"Overview"),Vn.forEach(o),Vt.forEach(o),Et=h(t),L=a(t,"P",{});var xt=s(L);ao=i(xt,"The Swin Transformer was proposed in "),ce=a(xt,"A",{href:!0,rel:!0});var Kn=s(ce);so=i(Kn,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),Kn.forEach(o),ro=a(xt,"BR",{}),io=i(xt,`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),xt.forEach(o),jt=h(t),Ne=a(t,"P",{});var Yn=s(Ne);lo=i(Yn,"The abstract from the paper is the following:"),Yn.forEach(o),Ft=h(t),Oe=a(t,"P",{});var Zn=s(Oe);it=a(Zn,"EM",{});var Rn=s(it);co=i(Rn,`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
for computer vision. Challenges in adapting Transformer from language to vision arise from differences between the two domains,
such as large variations in the scale of visual entities and the high resolution of pixels in images compared to words in text.
To address these differences, we propose a hierarchical Transformer whose representation is computed with \\bold{S}hifted
\\bold{win}dows. The shifted windowing scheme brings greater efficiency by limiting self-attention computation to non-overlapping
...
(53.5 mIoU on ADE20K val). Its performance surpasses the previous state-of-the-art by a large margin of +2.7 box AP and
+2.6 mask AP on COCO, and +3.2 mIoU on ADE20K, demonstrating the potential of Transformer-based models as vision backbones.
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Rn.forEach(o),Zn.forEach(o),Ct=h(t),De=a(t,"P",{});var Gn=s(De);ho=i(Gn,"Tips:"),Gn.forEach(o),It=h(t),Le=a(t,"UL",{});var Jn=s(Le);he=a(Jn,"LI",{});var Kt=s(he);po=i(Kt,"One can use the "),We=a(Kt,"A",{href:!0});var Qn=s(We);mo=i(Qn,"AutoFeatureExtractor"),Qn.forEach(o),fo=i(Kt," API to prepare images for the model."),Kt.forEach(o),Jn.forEach(o),At=h(t),Q=a(t,"IMG",{src:!0,alt:!0,width:!0}),Pt=h(t),X=a(t,"SMALL",{});var Yt=s(X);uo=i(Yt,"Swin Transformer architecture. Taken from the "),He=a(Yt,"A",{href:!0});var Xn=s(He);go=i(Xn,"original paper"),Xn.forEach(o),_o=i(Yt,"."),Yt.forEach(o),qt=h(t),P=a(t,"P",{});var Re=s(P);wo=i(Re,"This model was contributed by "),pe=a(Re,"A",{href:!0,rel:!0});var ea=s(pe);vo=i(ea,"novice03"),ea.forEach(o),bo=i(Re,". The original code can be found "),me=a(Re,"A",{href:!0,rel:!0});var ta=s(me);So=i(ta,"here"),ta.forEach(o),$o=i(Re,"."),Re.forEach(o),zt=h(t),W=a(t,"H2",{class:!0});var Zt=s(W);ee=a(Zt,"A",{id:!0,class:!0,href:!0});var oa=s(ee);lt=a(oa,"SPAN",{});var na=s(lt);v(fe.$$.fragment,na),na.forEach(o),oa.forEach(o),yo=h(Zt),dt=a(Zt,"SPAN",{});var aa=s(dt);To=i(aa,"SwinConfig"),aa.forEach(o),Zt.forEach(o),Nt=h(t),F=a(t,"DIV",{class:!0});var ie=s(F);v(ue.$$.fragment,ie),ko=h(ie),H=a(ie,"P",{});var Ge=s(H);xo=i(Ge,"This is the configuration class to store the configuration of a "),Ue=a(Ge,"A",{href:!0});var sa=s(Ue);Mo=i(sa,"SwinModel"),sa.forEach(o),Eo=i(Ge,`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),ge=a(Ge,"A",{href:!0,rel:!0});var ra=s(ge);jo=i(ra,"microsoft/swin-tiny-patch4-window7-224"),ra.forEach(o),Fo=i(Ge,`
architecture.`),Ge.forEach(o),Co=h(ie),U=a(ie,"P",{});var Je=s(U);Io=i(Je,"Configuration objects inherit from "),Be=a(Je,"A",{href:!0});var ia=s(Be);Ao=i(ia,"PretrainedConfig"),ia.forEach(o),Po=i(Je,` and can be used to control the model outputs. Read the
...
This model is a PyTorch `),Se=a(Gt,"A",{href:!0,rel:!0});var pa=s(Se);Ho=i(pa,"torch.nn.Module"),pa.forEach(o),Uo=i(Gt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Gt.forEach(o),Bo=h(Qe),M=a(Qe,"DIV",{class:!0});var q=s(M);v($e.$$.fragment,q),Vo=h(q),V=a(q,"P",{});var Xe=s(V);Ko=i(Xe,"The "),Ke=a(Xe,"A",{href:!0});var ma=s(Ke);Yo=i(ma,"SwinModel"),ma.forEach(o),Zo=i(Xe," forward method, overrides the "),pt=a(Xe,"CODE",{});var fa=s(pt);Ro=i(fa,"__call__"),fa.forEach(o),Go=i(Xe," special method."),Xe.forEach(o),Jo=h(q),v(oe.$$.fragment,q),Qo=h(q),mt=a(q,"P",{});var ua=s(mt);Xo=i(ua,"Example:"),ua.forEach(o),en=h(q),v(ye.$$.fragment,q),q.forEach(o),Qe.forEach(o),Lt=h(t),K=a(t,"H2",{class:!0});var Jt=s(K);ne=a(Jt,"A",{id:!0,class:!0,href:!0});var ga=s(ne);ft=a(ga,"SPAN",{});var _a=s(ft);v(Te.$$.fragment,_a),_a.forEach(o),ga.forEach(o),tn=h(Jt),ut=a(Jt,"SPAN",{});var wa=s(ut);on=i(wa,"SwinForMaskedImageModeling"),wa.forEach(o),Jt.forEach(o),Wt=h(t),A=a(t,"DIV",{class:!0});var et=s(A);v(ke.$$.fragment,et),nn=h(et),Y=a(et,"P",{});var tt=s(Y);an=i(tt,"Swin Model with a decoder on top for masked image modeling, as proposed in "),gt=a(tt,"CODE",{});var va=s(gt);sn=i(va,"SimMIM <https://arxiv.org/abs/2111.09886>"),va.forEach(o),rn=i(tt,`__.
This model is a PyTorch `),xe=a(tt,"A",{href:!0,rel:!0});var ba=s(xe);ln=i(ba,"torch.nn.Module"),ba.forEach(o),dn=i(tt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),tt.forEach(o),cn=h(et),E=a(et,"DIV",{class:!0});var z=s(E);v(Me.$$.fragment,z),hn=h(z),Z=a(z,"P",{});var ot=s(Z);pn=i(ot,"The "),Ye=a(ot,"A",{href:!0});var Sa=s(Ye);mn=i(Sa,"SwinForMaskedImageModeling"),Sa.forEach(o),fn=i(ot," forward method, overrides the "),_t=a(ot,"CODE",{});var $a=s(_t);un=i($a,"__call__"),$a.forEach(o),gn=i(ot," special method."),ot.forEach(o),_n=h(z),v(ae.$$.fragment,z),wn=h(z),wt=a(z,"P",{});var ya=s(wt);vn=i(ya,"Examples:"),ya.forEach(o),bn=h(z),v(Ee.$$.fragment,z),z.forEach(o),et.forEach(o),Ht=h(t),R=a(t,"H2",{class:!0});var Qt=s(R);se=a(Qt,"A",{id:!0,class:!0,href:!0});var Ta=s(se);vt=a(Ta,"SPAN",{});var ka=s(vt);v(je.$$.fragment,ka),ka.forEach(o),Ta.forEach(o),Sn=h(Qt),bt=a(Qt,"SPAN",{});var xa=s(bt);$n=i(xa,"SwinForImageClassification"),xa.forEach(o),Qt.forEach(o),Ut=h(t),C=a(t,"DIV",{class:!0});var le=s(C);v(Fe.$$.fragment,le),yn=h(le),St=a(le,"P",{});var Ma=s(St);Tn=i(Ma,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Ma.forEach(o),kn=h(le),Ce=a(le,"P",{});var Xt=s(Ce);xn=i(Xt,"This model is a PyTorch "),Ie=a(Xt,"A",{href:!0,rel:!0});var Ea=s(Ie);Mn=i(Ea,"torch.nn.Module"),Ea.forEach(o),En=i(Xt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xt.forEach(o),jn=h(le),j=a(le,"DIV",{class:!0});var N=s(j);v(Ae.$$.fragment,N),Fn=h(N),G=a(N,"P",{});var nt=s(G);Cn=i(nt,"The "),Ze=a(nt,"A",{href:!0});var ja=s(Ze);In=i(ja,"SwinForImageClassification"),ja.forEach(o),An=i(nt," forward method, overrides the "),$t=a(nt,"CODE",{});var Fa=s($t);Pn=i(Fa,"__call__"),Fa.forEach(o),qn=i(nt," special method."),nt.forEach(o),zn=h(N),v(re.$$.fragment,N),Nn=h(N),yt=a(N,"P",{});var Ca=s(yt);On=i(Ca,"Example:"),Ca.forEach(o),Dn=h(N),v(Pe.$$.fragment,N),N.forEach(o),le.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Wa)),l(_,"id","swin-transformer"),l(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(_,"href","#swin-transformer"),l(f,"class","relative group"),l(J,"id","overview"),l(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(J,"href","#overview"),l(D,"class","relative group"),l(ce,"href","https://arxiv.org/abs/2103.14030"),l(ce,"rel","nofollow"),l(We,"href","/docs/transformers/pr_15928/en/model_doc/auto#transformers.AutoFeatureExtractor"),za(Q.src,Wn="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/swin_transformer_architecture.png")||l(Q,"src",Wn),l(Q,"alt","drawing"),l(Q,"width","600"),l(He,"href","https://arxiv.org/abs/2102.03334"),l(pe,"href","https://huggingface.co/novice03%3E"),l(pe,"rel","nofollow"),l(me,"href","https://github.com/microsoft/Swin-Transformer"),l(me,"rel","nofollow"),l(ee,"id","transformers.SwinConfig"),l(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ee,"href","#transformers.SwinConfig"),l(W,"class","relative group"),l(Ue,"href","/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinModel"),l(ge,"href","https://huggingface.co/microsoft/swin-tiny-patch4-window7-224"),l(ge,"rel","nofollow"),l(Be,"href","/docs/transformers/pr_15928/en/main_classes/configuration#transformers.PretrainedConfig"),l(Ve,"href","/docs/transformers/pr_15928/en/main_classes/configuration#transformers.PretrainedConfig"),l(F,"class","docstring"),l(te,"id","transformers.SwinModel"),l(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(te,"href","#transformers.SwinModel"),l(B,"class","relative group"),l(Se,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Se,"rel","nofollow"),l(Ke,"href","/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinModel"),l(M,"class","docstring"),l(I,"class","docstring"),l(ne,"id","transformers.SwinForMaskedImageModeling"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SwinForMaskedImageModeling"),l(K,"class","relative group"),l(xe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(xe,"rel","nofollow"),l(Ye,"href","/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinForMaskedImageModeling"),l(E,"class","docstring"),l(A,"class","docstring"),l(se,"id","transformers.SwinForImageClassification"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#transformers.SwinForImageClassification"),l(R,"class","relative group"),l(Ie,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ie,"rel","nofollow"),l(Ze,"href","/docs/transformers/pr_15928/en/model_doc/swin#transformers.SwinForImageClassification"),l(j,"class","docstring"),l(C,"class","docstring")},m(t,d){e(document.head,m),p(t,T,d),p(t,f,d),e(f,_),e(_,k),b(u,k,null),e(f,g),e(f,x),e(x,to),p(t,Mt,d),p(t,D,d),e(D,J),e(J,st),b(de,st,null),e(D,oo),e(D,rt),e(rt,no),p(t,Et,d),p(t,L,d),e(L,ao),e(L,ce),e(ce,so),e(L,ro),e(L,io),p(t,jt,d),p(t,Ne,d),e(Ne,lo),p(t,Ft,d),p(t,Oe,d),e(Oe,it),e(it,co),p(t,Ct,d),p(t,De,d),e(De,ho),p(t,It,d),p(t,Le,d),e(Le,he),e(he,po),e(he,We),e(We,mo),e(he,fo),p(t,At,d),p(t,Q,d),p(t,Pt,d),p(t,X,d),e(X,uo),e(X,He),e(He,go),e(X,_o),p(t,qt,d),p(t,P,d),e(P,wo),e(P,pe),e(pe,vo),e(P,bo),e(P,me),e(me,So),e(P,$o),p(t,zt,d),p(t,W,d),e(W,ee),e(ee,lt),b(fe,lt,null),e(W,yo),e(W,dt),e(dt,To),p(t,Nt,d),p(t,F,d),b(ue,F,null),e(F,ko),e(F,H),e(H,xo),e(H,Ue),e(Ue,Mo),e(H,Eo),e(H,ge),e(ge,jo),e(H,Fo),e(F,Co),e(F,U),e(U,Io),e(U,Be),e(Be,Ao),e(U,Po),e(U,Ve),e(Ve,qo),e(U,zo),e(F,No),b(_e,F,null),p(t,Ot,d),p(t,B,d),e(B,te),e(te,ct),b(we,ct,null),e(B,Oo),e(B,ht),e(ht,Do),p(t,Dt,d),p(t,I,d),b(ve,I,null),e(I,Lo),e(I,be),e(be,Wo),e(be,Se),e(Se,Ho),e(be,Uo),e(I,Bo),e(I,M),b($e,M,null),e(M,Vo),e(M,V),e(V,Ko),e(V,Ke),e(Ke,Yo),e(V,Zo),e(V,pt),e(pt,Ro),e(V,Go),e(M,Jo),b(oe,M,null),e(M,Qo),e(M,mt),e(mt,Xo),e(M,en),b(ye,M,null),p(t,Lt,d),p(t,K,d),e(K,ne),e(ne,ft),b(Te,ft,null),e(K,tn),e(K,ut),e(ut,on),p(t,Wt,d),p(t,A,d),b(ke,A,null),e(A,nn),e(A,Y),e(Y,an),e(Y,gt),e(gt,sn),e(Y,rn),e(Y,xe),e(xe,ln),e(Y,dn),e(A,cn),e(A,E),b(Me,E,null),e(E,hn),e(E,Z),e(Z,pn),e(Z,Ye),e(Ye,mn),e(Z,fn),e(Z,_t),e(_t,un),e(Z,gn),e(E,_n),b(ae,E,null),e(E,wn),e(E,wt),e(wt,vn),e(E,bn),b(Ee,E,null),p(t,Ht,d),p(t,R,d),e(R,se),e(se,vt),b(je,vt,null),e(R,Sn),e(R,bt),e(bt,$n),p(t,Ut,d),p(t,C,d),b(Fe,C,null),e(C,yn),e(C,St),e(St,Tn),e(C,kn),e(C,Ce),e(Ce,xn),e(Ce,Ie),e(Ie,Mn),e(Ce,En),e(C,jn),e(C,j),b(Ae,j,null),e(j,Fn),e(j,G),e(G,Cn),e(G,Ze),e(Ze,In),e(G,An),e(G,$t),e($t,Pn),e(G,qn),e(j,zn),b(re,j,null),e(j,Nn),e(j,yt),e(yt,On),e(j,Dn),b(Pe,j,null),Bt=!0},p(t,[d]){const qe={};d&2&&(qe.$$scope={dirty:d,ctx:t}),oe.$set(qe);const Tt={};d&2&&(Tt.$$scope={dirty:d,ctx:t}),ae.$set(Tt);const kt={};d&2&&(kt.$$scope={dirty:d,ctx:t}),re.$set(kt)},i(t){Bt||(S(u.$$.fragment,t),S(de.$$.fragment,t),S(fe.$$.fragment,t),S(ue.$$.fragment,t),S(_e.$$.fragment,t),S(we.$$.fragment,t),S(ve.$$.fragment,t),S($e.$$.fragment,t),S(oe.$$.fragment,t),S(ye.$$.fragment,t),S(Te.$$.fragment,t),S(ke.$$.fragment,t),S(Me.$$.fragment,t),S(ae.$$.fragment,t),S(Ee.$$.fragment,t),S(je.$$.fragment,t),S(Fe.$$.fragment,t),S(Ae.$$.fragment,t),S(re.$$.fragment,t),S(Pe.$$.fragment,t),Bt=!0)},o(t){$(u.$$.fragment,t),$(de.$$.fragment,t),$(fe.$$.fragment,t),$(ue.$$.fragment,t),$(_e.$$.fragment,t),$(we.$$.fragment,t),$(ve.$$.fragment,t),$($e.$$.fragment,t),$(oe.$$.fragment,t),$(ye.$$.fragment,t),$(Te.$$.fragment,t),$(ke.$$.fragment,t),$(Me.$$.fragment,t),$(ae.$$.fragment,t),$(Ee.$$.fragment,t),$(je.$$.fragment,t),$(Fe.$$.fragment,t),$(Ae.$$.fragment,t),$(re.$$.fragment,t),$(Pe.$$.fragment,t),Bt=!1},d(t){o(m),t&&o(T),t&&o(f),y(u),t&&o(Mt),t&&o(D),y(de),t&&o(Et),t&&o(L),t&&o(jt),t&&o(Ne),t&&o(Ft),t&&o(Oe),t&&o(Ct),t&&o(De),t&&o(It),t&&o(Le),t&&o(At),t&&o(Q),t&&o(Pt),t&&o(X),t&&o(qt),t&&o(P),t&&o(zt),t&&o(W),y(fe),t&&o(Nt),t&&o(F),y(ue),y(_e),t&&o(Ot),t&&o(B),y(we),t&&o(Dt),t&&o(I),y(ve),y($e),y(oe),y(ye),t&&o(Lt),t&&o(K),y(Te),t&&o(Wt),t&&o(A),y(ke),y(Me),y(ae),y(Ee),t&&o(Ht),t&&o(R),y(je),t&&o(Ut),t&&o(C),y(Fe),y(Ae),y(re),y(Pe)}}}const Wa={local:"swin-transformer",sections:[{local:"overview",title:"Overview"},{local:"transformers.SwinConfig",title:"SwinConfig"},{local:"transformers.SwinModel",title:"SwinModel"},{local:"transformers.SwinForMaskedImageModeling",title:"SwinForMaskedImageModeling"},{local:"transformers.SwinForImageClassification",title:"SwinForImageClassification"}],title:"Swin Transformer"};function Ha(O,m,T){let{fw:f}=m;return O.$$set=_=>{"fw"in _&&T(0,f=_.fw)},[f]}class Ra extends Ia{constructor(m){super();Aa(this,m,Ha,La,Pa,{fw:0})}}export{Ra as default,Wa as metadata};
