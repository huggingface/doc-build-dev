...
Whether or not to return a <a href="/docs/transformers/pr_18126/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18126/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18126/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18126/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18126/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18126/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18126/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);c1=i(Yw,"span start logits"),Yw.forEach(t),p1=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);h1=i(Zw,"span end logits"),Zw.forEach(t),u1=i(yl,")."),yl.forEach(t),f1=h(xt),ia=n(xt,"P",{});var su=r(ia);m1=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e2=r(nl);g1=i(e2,"TFPreTrainedModel"),e2.forEach(t),_1=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),b1=h(xt),la=n(xt,"P",{});var ou=r(la);v1=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t2=r(da);k1=i(t2,"tf.keras.Model"),t2.forEach(t),T1=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$1=h(xt),$(Uo.$$.fragment,xt),w1=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),y1=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);F1=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var s2=r(rl);D1=i(s2,"TFDistilBertForQuestionAnswering"),s2.forEach(t),x1=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var o2=r(Ad);B1=i(o2,"__call__"),o2.forEach(t),M1=i(Fl," special method."),Fl.forEach(t),E1=h(Zt),$(Ho.$$.fragment,Zt),z1=h(Zt),$(Ko.$$.fragment,Zt),j1=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n2=r(Jo);Od=n(n2,"SPAN",{});var r2=r(Od);$(pa.$$.fragment,r2),r2.forEach(t),n2.forEach(t),C1=h(nu),Nd=n(nu,"SPAN",{});var a2=r(Nd);q1=i(a2,"FlaxDistilBertModel"),a2.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),P1=h(st),Ld=n(st,"P",{});var i2=r(Ld);A1=i(i2,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i2.forEach(t),O1=h(st),ua=n(st,"P",{});var ru=r(ua);N1=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l2=r(al);L1=i(l2,"FlaxPreTrainedModel"),l2.forEach(t),S1=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),I1=h(st),fa=n(st,"P",{});var au=r(fa);W1=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d2=r(ma);Q1=i(d2,"flax.linen.Module"),d2.forEach(t),R1=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),U1=h(st),Sd=n(st,"P",{});var c2=r(Sd);H1=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),K1=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p2=r(Id);ga=n(p2,"A",{href:!0,rel:!0});var h2=r(ga);V1=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),J1=h(kn),Wd=n(kn,"LI",{});var u2=r(Wd);_a=n(u2,"A",{href:!0,rel:!0});var f2=r(_a);G1=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),X1=h(kn),Qd=n(kn,"LI",{});var m2=r(Qd);ba=n(m2,"A",{href:!0,rel:!0});var g2=r(ba);Y1=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),Z1=h(kn),Rd=n(kn,"LI",{});var _2=r(Rd);va=n(_2,"A",{href:!0,rel:!0});var b2=r(va);ev=i(b2,"Parallelization"),b2.forEach(t),_2.forEach(t),kn.forEach(t),tv=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sv=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ov=i(Dl,"The "),Ud=n(Dl,"CODE",{});var v2=r(Ud);nv=i(v2,"FlaxDistilBertPreTrainedModel"),v2.forEach(t),rv=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var k2=r(Hd);av=i(k2,"__call__"),k2.forEach(t),iv=i(Dl," special method."),Dl.forEach(t),lv=h(Tn),$(Go.$$.fragment,Tn),dv=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T2=r(Yo);Kd=n(T2,"SPAN",{});var $2=r(Kd);$(Ta.$$.fragment,$2),$2.forEach(t),T2.forEach(t),cv=h(iu),Vd=n(iu,"SPAN",{});var w2=r(Vd);pv=i(w2,"FlaxDistilBertForMaskedLM"),w2.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hv=h(ot),wa=n(ot,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y2=r(Jd);fv=i(y2,"language modeling"),y2.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(ot),ya=n(ot,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var F2=r(il);bv=i(F2,"FlaxPreTrainedModel"),F2.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kv=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tv=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var D2=r(Da);$v=i(D2,"flax.linen.Module"),D2.forEach(t),wv=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yv=h(ot),Gd=n(ot,"P",{});var x2=r(Gd);Fv=i(x2,"Finally, this model supports inherent JAX features such as:"),x2.forEach(t),Dv=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var B2=r(Xd);xa=n(B2,"A",{href:!0,rel:!0});var M2=r(xa);xv=i(M2,"Just-In-Time (JIT) compilation"),M2.forEach(t),B2.forEach(t),Bv=h($n),Yd=n($n,"LI",{});var E2=r(Yd);Ba=n(E2,"A",{href:!0,rel:!0});var z2=r(Ba);Mv=i(z2,"Automatic Differentiation"),z2.forEach(t),E2.forEach(t),Ev=h($n),Zd=n($n,"LI",{});var j2=r(Zd);Ma=n(j2,"A",{href:!0,rel:!0});var C2=r(Ma);zv=i(C2,"Vectorization"),C2.forEach(t),j2.forEach(t),jv=h($n),ec=n($n,"LI",{});var q2=r(ec);Ea=n(q2,"A",{href:!0,rel:!0});var P2=r(Ea);Cv=i(P2,"Parallelization"),P2.forEach(t),q2.forEach(t),$n.forEach(t),qv=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pv=h(wn),Cs=n(wn,"P",{});var xl=r(Cs);Av=i(xl,"The "),tc=n(xl,"CODE",{});var A2=r(tc);Ov=i(A2,"FlaxDistilBertPreTrainedModel"),A2.forEach(t),Nv=i(xl," forward method, overrides the "),sc=n(xl,"CODE",{});var O2=r(sc);Lv=i(O2,"__call__"),O2.forEach(t),Sv=i(xl," special method."),xl.forEach(t),Iv=h(wn),$(Zo.$$.fragment,wn),Wv=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N2=r(tn);oc=n(N2,"SPAN",{});var L2=r(oc);$(ja.$$.fragment,L2),L2.forEach(t),N2.forEach(t),Qv=h(pu),nc=n(pu,"SPAN",{});var S2=r(nc);Rv=i(S2,"FlaxDistilBertForSequenceClassification"),S2.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uv=h(nt),rc=n(nt,"P",{});var I2=r(rc);Hv=i(I2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I2.forEach(t),Kv=h(nt),qa=n(nt,"P",{});var hu=r(qa);Vv=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W2=r(ll);Jv=i(W2,"FlaxPreTrainedModel"),W2.forEach(t),Gv=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xv=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yv=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q2=r(Aa);Zv=i(Q2,"flax.linen.Module"),Q2.forEach(t),ek=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tk=h(nt),ac=n(nt,"P",{});var R2=r(ac);sk=i(R2,"Finally, this model supports inherent JAX features such as:"),R2.forEach(t),ok=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U2=r(ic);Oa=n(U2,"A",{href:!0,rel:!0});var H2=r(Oa);nk=i(H2,"Just-In-Time (JIT) compilation"),H2.forEach(t),U2.forEach(t),rk=h(yn),lc=n(yn,"LI",{});var K2=r(lc);Na=n(K2,"A",{href:!0,rel:!0});var V2=r(Na);ak=i(V2,"Automatic Differentiation"),V2.forEach(t),K2.forEach(t),ik=h(yn),dc=n(yn,"LI",{});var J2=r(dc);La=n(J2,"A",{href:!0,rel:!0});var G2=r(La);lk=i(G2,"Vectorization"),G2.forEach(t),J2.forEach(t),dk=h(yn),cc=n(yn,"LI",{});var X2=r(cc);Sa=n(X2,"A",{href:!0,rel:!0});var Y2=r(Sa);ck=i(Y2,"Parallelization"),Y2.forEach(t),X2.forEach(t),yn.forEach(t),pk=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hk=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uk=i(Bl,"The "),pc=n(Bl,"CODE",{});var Z2=r(pc);fk=i(Z2,"FlaxDistilBertPreTrainedModel"),Z2.forEach(t),mk=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var ey=r(hc);gk=i(ey,"__call__"),ey.forEach(t),_k=i(Bl," special method."),Bl.forEach(t),bk=h(Fn),$(sn.$$.fragment,Fn),vk=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kk=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);Tk=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$k=h(rt),mc=n(rt,"P",{});var ny=r(mc);wk=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jk=h(rt),gc=n(rt,"P",{});var iy=r(gc);Ck=i(iy,"Finally, this model supports inherent JAX features such as:"),iy.forEach(t),qk=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var ly=r(_c);Ka=n(ly,"A",{href:!0,rel:!0});var dy=r(Ka);Pk=i(dy,"Just-In-Time (JIT) compilation"),dy.forEach(t),ly.forEach(t),Ak=h(Dn),bc=n(Dn,"LI",{});var cy=r(bc);Va=n(cy,"A",{href:!0,rel:!0});var py=r(Va);Ok=i(py,"Automatic Differentiation"),py.forEach(t),cy.forEach(t),Nk=h(Dn),vc=n(Dn,"LI",{});var hy=r(vc);Ja=n(hy,"A",{href:!0,rel:!0});var uy=r(Ja);Lk=i(uy,"Vectorization"),uy.forEach(t),hy.forEach(t),Sk=h(Dn),kc=n(Dn,"LI",{});var fy=r(kc);Ga=n(fy,"A",{href:!0,rel:!0});var my=r(Ga);Ik=i(my,"Parallelization"),my.forEach(t),fy.forEach(t),Dn.forEach(t),Wk=h(rt),vt=n(rt,"DIV",{class:!0});var xn=r(vt);$(Xa.$$.fragment,xn),Qk=h(xn),Os=n(xn,"P",{});var Ml=r(Os);Rk=i(Ml,"The "),Tc=n(Ml,"CODE",{});var gy=r(Tc);Uk=i(gy,"FlaxDistilBertPreTrainedModel"),gy.forEach(t),Hk=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _y=r($c);Kk=i(_y,"__call__"),_y.forEach(t),Vk=i(Ml," special method."),Ml.forEach(t),Jk=h(xn),$(rn.$$.fragment,xn),Gk=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var by=r(ln);wc=n(by,"SPAN",{});var vy=r(wc);$(Ya.$$.fragment,vy),vy.forEach(t),by.forEach(t),Xk=h(_u),yc=n(_u,"SPAN",{});var ky=r(yc);Yk=i(ky,"FlaxDistilBertForTokenClassification"),ky.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Zk=h(at),Fc=n(at,"P",{});var Ty=r(Fc);eT=i(Ty,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
