...
<span class="hljs-meta">&gt;&gt;&gt; </span>swag = load_dataset(<span class="hljs-string">&quot;swag&quot;</span>, <span class="hljs-string">&quot;regular&quot;</span>)`}}),ps=new A({props:{code:'swag["train"][0],',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>swag[<span class="hljs-string">&quot;train&quot;</span>][<span class="hljs-number">0</span>]
{<span class="hljs-string">&#x27;ending0&#x27;</span>: <span class="hljs-string">&#x27;passes by walking down the street playing their instruments.&#x27;</span>,
 ...
 <span class="hljs-string">&#x27;video-id&#x27;</span>: <span class="hljs-string">&#x27;anetv_jkn6uvmqwh4&#x27;</span>}`}}),is=new Te({}),cs=new A({props:{code:`from transformers import AutoTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer = AutoTokenizer.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>)`}}),fs=new A({props:{code:`ending_names = ["ending0", "ending1", "ending2", "ending3"]
...
<span class="hljs-meta">... </span>    <span class="hljs-keyword">return</span> {k: [v[i : i + <span class="hljs-number">4</span>] <span class="hljs-keyword">for</span> i <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(<span class="hljs-number">0</span>, <span class="hljs-built_in">len</span>(v), <span class="hljs-number">4</span>)] <span class="hljs-keyword">for</span> k, v <span class="hljs-keyword">in</span> tokenized_examples.items()}`}}),ms=new A({props:{code:"tokenized_swag = swag.map(preprocess_function, batched=True),",highlighted:'tokenized_swag = swag.<span class="hljs-built_in">map</span>(preprocess_function, batched=<span class="hljs-literal">True</span>)'}}),_s=new Al({props:{pt:{code:`from dataclasses import dataclass
...
<span class="hljs-meta">... </span>        <span class="hljs-keyword">return</span> batch`},tf:{code:`from dataclasses import dataclass
from transformers.tokenization_utils_base import PreTrainedTokenizerBase, PaddingStrategy
from typing import Optional, Union
...
<span class="hljs-meta">... </span>        <span class="hljs-keyword">return</span> batch`}}}),gs=new Te({}),js=new A({props:{code:`from transformers import AutoModelForMultipleChoice, TrainingArguments, Trainer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = AutoModelForMultipleChoice.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>)`}}),J=new zl({props:{$$slots:{default:[Pl]},$$scope:{ctx:ts}}}),vs=new A({props:{code:`training_args = TrainingArguments(
    output_dir="./results",
...
<span class="hljs-meta">&gt;&gt;&gt; </span>trainer.train()`}}),ys=new Te({}),Q=new zl({props:{$$slots:{default:[Dl]},$$scope:{ctx:ts}}}),Es=new A({props:{code:`data_collator = DataCollatorForMultipleChoice(tokenizer=tokenizer)
...
<span class="hljs-meta">... </span>    batch_size=batch_size,
<span class="hljs-meta">... </span>    collate_fn=data_collator,
<span class="hljs-meta">... </span>)`}}),zs=new A({props:{code:`from transformers import create_optimizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>optimizer, schedule = create_optimizer(init_lr=<span class="hljs-number">5e-5</span>, num_warmup_steps=<span class="hljs-number">0</span>, num_train_steps=total_train_steps)`}}),qs=new A({props:{code:`from transformers import TFAutoModelForMultipleChoice
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFAutoModelForMultipleChoice.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>)`}}),Ts=new A({props:{code:`model.compile(
    optimizer=optimizer,
