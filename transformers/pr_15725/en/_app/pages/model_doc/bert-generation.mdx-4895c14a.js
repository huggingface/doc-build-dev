import{S as la,i as ca,s as ha,e as s,k as l,w as b,t as n,L as pa,c as a,d as o,m as c,a as i,x as v,h as r,b as d,J as e,g as p,y as k,q as T,o as w,B as y}from"../../chunks/vendor-9e2b328e.js";import{T as da}from"../../chunks/Tip-76f97a76.js";import{D as gt}from"../../chunks/Docstring-50fd6873.js";import{C as Vt}from"../../chunks/CodeBlock-88e23343.js";import{I as _t}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function ua(ie){let u,q,f,g,C;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),g=n("Module"),C=n(`
...
the latter silently ignores them.`)},l(_){u=a(_,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(E,"CODE",{});var S=i(f);g=r(S,"Module"),S.forEach(o),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(_,E){p(_,u,E),e(u,q),e(u,f),e(f,g),e(u,C)},d(_){_&&o(u)}}}function ma(ie){let u,q,f,g,C,_,E,S,Co,Jt,R,Y,bt,de,Do,vt,So,Kt,A,Ao,Ue,Mo,No,le,Lo,Fo,Qt,He,Oo,Xt,Ve,kt,Io,Yt,Je,Ro,Zt,Ke,ce,Wo,Qe,Uo,Ho,eo,he,to,Xe,pe,Vo,Ye,Jo,Ko,oo,ue,no,Ze,Qo,ro,Z,M,et,Xo,Yo,tt,Zo,en,Tt,tn,on,nn,wt,rn,so,N,sn,fe,an,dn,me,ln,cn,ao,W,ee,yt,ge,hn,Et,pn,io,$,_e,un,be,fn,Bt,mn,gn,_n,U,bn,ot,vn,kn,nt,Tn,wn,yn,zt,En,Bn,ve,lo,H,te,$t,ke,zn,Gt,$n,co,D,Te,Gn,we,qn,ye,Pn,jn,xn,Ee,Cn,rt,Dn,Sn,An,qt,ho,V,oe,Pt,Be,Mn,jt,Nn,po,m,ze,Ln,xt,Fn,On,$e,In,st,Rn,Wn,Un,Ge,Hn,qe,Vn,Jn,Kn,Pe,Qn,je,Xn,Yn,Zn,J,er,at,tr,or,xe,nr,rr,sr,B,ar,Ct,ir,dr,Dt,lr,cr,St,hr,pr,At,ur,fr,Mt,mr,gr,Nt,_r,br,vr,P,Ce,kr,K,Tr,it,wr,yr,Lt,Er,Br,zr,ne,$r,Ft,Gr,qr,De,uo,Q,re,Ot,Se,Pr,It,jr,fo,G,Ae,xr,Me,Cr,Rt,Dr,Sr,Ar,Ne,Mr,dt,Nr,Lr,Fr,Le,Or,Fe,Ir,Rr,Wr,j,Oe,Ur,X,Hr,lt,Vr,Jr,Wt,Kr,Qr,Xr,se,Yr,Ut,Zr,es,Ie,mo;return _=new _t({}),de=new _t({}),he=new Vt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}]}}),ve=new Vt({props:{code:`from transformers import BertGenerationConfig, BertGenerationEncoder
...
</ul>`,name:"sp_model_kwargs"}]}}),Be=new _t({}),ze=new gt({props:{name:"class transformers.BertGenerationEncoder",anchor:"transformers.BertGenerationEncoder",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/bert_generation/modeling_bert_generation.py#L253",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15725/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15725/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ce=new gt({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15725/en/model_doc/bert-generation#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See <a href="/docs/transformers/pr_15725/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15725/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15725/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),q=l(),f=s("h1"),g=s("a"),C=s("span"),b(_.$$.fragment),E=l(),S=s("span"),Co=n("BertGeneration"),Jt=l(),R=s("h2"),Y=s("a"),bt=s("span"),b(de.$$.fragment),Do=l(),vt=s("span"),So=n("Overview"),Kt=l(),A=s("p"),Ao=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),eo=l(),b(he.$$.fragment),to=l(),Xe=s("ul"),pe=s("li"),Vo=n("Pretrained "),Ye=s("a"),Jo=n("EncoderDecoderModel"),Ko=n(" are also directly available in the model hub, e.g.,"),oo=l(),b(ue.$$.fragment),no=l(),Ze=s("p"),Qo=n("Tips:"),ro=l(),Z=s("ul"),M=s("li"),et=s("a"),Xo=n("BertGenerationEncoder"),Yo=n(" and "),tt=s("a"),Zo=n("BertGenerationDecoder"),en=n(` should be used in
...
found `),me=s("a"),ln=n("here"),cn=n("."),ao=l(),W=s("h2"),ee=s("a"),yt=s("span"),b(ge.$$.fragment),hn=l(),Et=s("span"),pn=n("BertGenerationConfig"),io=l(),$=s("div"),b(_e.$$.fragment),un=l(),be=s("p"),fn=n("This is the configuration class to store the configuration of a "),Bt=s("code"),mn=n("BertGenerationPreTrainedModel"),gn=n(` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),_n=l(),U=s("p"),bn=n("Configuration objects inherit from "),ot=s("a"),vn=n("PretrainedConfig"),kn=n(` and can be used to control the model outputs. Read the
documentation from `),nt=s("a"),Tn=n("PretrainedConfig"),wn=n(" for more information."),yn=l(),zt=s("p"),En=n("Examples:"),Bn=l(),b(ve.$$.fragment),lo=l(),H=s("h2"),te=s("a"),$t=s("span"),b(ke.$$.fragment),zn=l(),Gt=s("span"),$n=n("BertGenerationTokenizer"),co=l(),D=s("div"),b(Te.$$.fragment),Gn=l(),we=s("p"),qn=n("Construct a BertGeneration tokenizer. Based on "),ye=s("a"),Pn=n("SentencePiece"),jn=n("."),xn=l(),Ee=s("p"),Cn=n("This tokenizer inherits from "),rt=s("a"),Dn=n("PreTrainedTokenizer"),Sn=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),An=l(),qt=s("div"),ho=l(),V=s("h2"),oe=s("a"),Pt=s("span"),b(Be.$$.fragment),Mn=l(),jt=s("span"),Nn=n("BertGenerationEncoder"),po=l(),m=s("div"),b(ze.$$.fragment),Ln=l(),xt=s("p"),Fn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),On=l(),$e=s("p"),In=n("This model inherits from "),st=s("a"),Rn=n("PreTrainedModel"),Wn=n(`. Check the superclass documentation for the generic methods the
...
`),At=s("code"),ur=n("add_cross_attention"),fr=n(" set to "),Mt=s("code"),mr=n("True"),gr=n("; an "),Nt=s("code"),_r=n("encoder_hidden_states"),br=n(" is then expected as an input to the forward pass."),vr=l(),P=s("div"),b(Ce.$$.fragment),kr=l(),K=s("p"),Tr=n("The "),it=s("a"),wr=n("BertGenerationEncoder"),yr=n(" forward method, overrides the "),Lt=s("code"),Er=n("__call__"),Br=n(" special method."),zr=l(),b(ne.$$.fragment),$r=l(),Ft=s("p"),Gr=n("Example:"),qr=l(),b(De.$$.fragment),uo=l(),Q=s("h2"),re=s("a"),Ot=s("span"),b(Se.$$.fragment),Pr=l(),It=s("span"),jr=n("BertGenerationDecoder"),fo=l(),G=s("div"),b(Ae.$$.fragment),xr=l(),Me=s("p"),Cr=n("BertGeneration Model with a "),Rt=s("code"),Dr=n("language modeling"),Sr=n(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Mr=n("This model inherits from "),dt=s("a"),Nr=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fr=l(),Le=s("p"),Or=n("This model is also a PyTorch "),Fe=s("a"),Ir=n("torch.nn.Module"),Rr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wr=l(),j=s("div"),b(Oe.$$.fragment),Ur=l(),X=s("p"),Hr=n("The "),lt=s("a"),Vr=n("BertGenerationDecoder"),Jr=n(" forward method, overrides the "),Wt=s("code"),Kr=n("__call__"),Qr=n(" special method."),Xr=l(),b(se.$$.fragment),Yr=l(),Ut=s("p"),Zr=n("Example:"),es=l(),b(Ie.$$.fragment),this.h()},l(t){const h=pa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),q=c(t),f=a(t,"H1",{class:!0});var Re=i(f);g=a(Re,"A",{id:!0,class:!0,href:!0});var Ht=i(g);C=a(Ht,"SPAN",{});var ts=i(C);v(_.$$.fragment,ts),ts.forEach(o),Ht.forEach(o),E=c(Re),S=a(Re,"SPAN",{});var os=i(S);Co=r(os,"BertGeneration"),os.forEach(o),Re.forEach(o),Jt=c(t),R=a(t,"H2",{class:!0});var go=i(R);Y=a(go,"A",{id:!0,class:!0,href:!0});var ns=i(Y);bt=a(ns,"SPAN",{});var rs=i(bt);v(de.$$.fragment,rs),rs.forEach(o),ns.forEach(o),Do=c(go),vt=a(go,"SPAN",{});var ss=i(vt);So=r(ss,"Overview"),ss.forEach(o),go.forEach(o),Kt=c(t),A=a(t,"P",{});var ct=i(A);Ao=r(ct,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),_o.forEach(o),ps.forEach(o),eo=c(t),v(he.$$.fragment,t),to=c(t),Xe=a(t,"UL",{});var fs=i(Xe);pe=a(fs,"LI",{});var bo=i(pe);Vo=r(bo,"Pretrained "),Ye=a(bo,"A",{href:!0});var ms=i(Ye);Jo=r(ms,"EncoderDecoderModel"),ms.forEach(o),Ko=r(bo," are also directly available in the model hub, e.g.,"),bo.forEach(o),fs.forEach(o),oo=c(t),v(ue.$$.fragment,t),no=c(t),Ze=a(t,"P",{});var gs=i(Ze);Qo=r(gs,"Tips:"),gs.forEach(o),ro=c(t),Z=a(t,"UL",{});var vo=i(Z);M=a(vo,"LI",{});var We=i(M);et=a(We,"A",{href:!0});var _s=i(et);Xo=r(_s,"BertGenerationEncoder"),_s.forEach(o),Yo=r(We," and "),tt=a(We,"A",{href:!0});var bs=i(tt);Zo=r(bs,"BertGenerationDecoder"),bs.forEach(o),en=r(We,` should be used in
combination with `),Tt=a(We,"CODE",{});var vs=i(Tt);tn=r(vs,"EncoderDecoder"),vs.forEach(o),on=r(We,"."),We.forEach(o),nn=c(vo),wt=a(vo,"LI",{});var ks=i(wt);rn=r(ks,`For summarization, sentence splitting, sentence fusion and translation, no special tokens are required for the input.
Therefore, no EOS token should be added to the end of the input.`),ks.forEach(o),vo.forEach(o),so=c(t),N=a(t,"P",{});var ht=i(N);sn=r(ht,"This model was contributed by "),fe=a(ht,"A",{href:!0,rel:!0});var Ts=i(fe);an=r(Ts,"patrickvonplaten"),Ts.forEach(o),dn=r(ht,`. The original code can be
found `),me=a(ht,"A",{href:!0,rel:!0});var ws=i(me);ln=r(ws,"here"),ws.forEach(o),cn=r(ht,"."),ht.forEach(o),ao=c(t),W=a(t,"H2",{class:!0});var ko=i(W);ee=a(ko,"A",{id:!0,class:!0,href:!0});var ys=i(ee);yt=a(ys,"SPAN",{});var Es=i(yt);v(ge.$$.fragment,Es),Es.forEach(o),ys.forEach(o),hn=c(ko),Et=a(ko,"SPAN",{});var Bs=i(Et);pn=r(Bs,"BertGenerationConfig"),Bs.forEach(o),ko.forEach(o),io=c(t),$=a(t,"DIV",{class:!0});var L=i($);v(_e.$$.fragment,L),un=c(L),be=a(L,"P",{});var To=i(be);fn=r(To,"This is the configuration class to store the configuration of a "),Bt=a(To,"CODE",{});var zs=i(Bt);mn=r(zs,"BertGenerationPreTrainedModel"),zs.forEach(o),gn=r(To,` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),To.forEach(o),_n=c(L),U=a(L,"P",{});var pt=i(U);bn=r(pt,"Configuration objects inherit from "),ot=a(pt,"A",{href:!0});var $s=i(ot);vn=r($s,"PretrainedConfig"),$s.forEach(o),kn=r(pt,` and can be used to control the model outputs. Read the
documentation from `),nt=a(pt,"A",{href:!0});var Gs=i(nt);Tn=r(Gs,"PretrainedConfig"),Gs.forEach(o),wn=r(pt," for more information."),pt.forEach(o),yn=c(L),zt=a(L,"P",{});var qs=i(zt);En=r(qs,"Examples:"),qs.forEach(o),Bn=c(L),v(ve.$$.fragment,L),L.forEach(o),lo=c(t),H=a(t,"H2",{class:!0});var wo=i(H);te=a(wo,"A",{id:!0,class:!0,href:!0});var Ps=i(te);$t=a(Ps,"SPAN",{});var js=i($t);v(ke.$$.fragment,js),js.forEach(o),Ps.forEach(o),zn=c(wo),Gt=a(wo,"SPAN",{});var xs=i(Gt);$n=r(xs,"BertGenerationTokenizer"),xs.forEach(o),wo.forEach(o),co=c(t),D=a(t,"DIV",{class:!0});var ae=i(D);v(Te.$$.fragment,ae),Gn=c(ae),we=a(ae,"P",{});var yo=i(we);qn=r(yo,"Construct a BertGeneration tokenizer. Based on "),ye=a(yo,"A",{href:!0,rel:!0});var Cs=i(ye);Pn=r(Cs,"SentencePiece"),Cs.forEach(o),jn=r(yo,"."),yo.forEach(o),xn=c(ae),Ee=a(ae,"P",{});var Eo=i(Ee);Cn=r(Eo,"This tokenizer inherits from "),rt=a(Eo,"A",{href:!0});var Ds=i(rt);Dn=r(Ds,"PreTrainedTokenizer"),Ds.forEach(o),Sn=r(Eo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Eo.forEach(o),An=c(ae),qt=a(ae,"DIV",{class:!0}),i(qt).forEach(o),ae.forEach(o),ho=c(t),V=a(t,"H2",{class:!0});var Bo=i(V);oe=a(Bo,"A",{id:!0,class:!0,href:!0});var Ss=i(oe);Pt=a(Ss,"SPAN",{});var As=i(Pt);v(Be.$$.fragment,As),As.forEach(o),Ss.forEach(o),Mn=c(Bo),jt=a(Bo,"SPAN",{});var Ms=i(jt);Nn=r(Ms,"BertGenerationEncoder"),Ms.forEach(o),Bo.forEach(o),po=c(t),m=a(t,"DIV",{class:!0});var z=i(m);v(ze.$$.fragment,z),Ln=c(z),xt=a(z,"P",{});var Ns=i(xt);Fn=r(Ns,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Ns.forEach(o),On=c(z),$e=a(z,"P",{});var zo=i($e);In=r(zo,"This model inherits from "),st=a(zo,"A",{href:!0});var Ls=i(st);Rn=r(Ls,"PreTrainedModel"),Ls.forEach(o),Wn=r(zo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
