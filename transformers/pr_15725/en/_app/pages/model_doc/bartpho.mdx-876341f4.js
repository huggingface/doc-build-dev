import{S as Po,i as Do,s as So,e as s,k as c,w as v,t as r,L as Mo,c as n,d as o,m as d,a,x as T,h as i,b as p,J as t,g as h,y as w,K as Io,q as y,o as q,B}from"../../chunks/vendor-9e2b328e.js";import{D as $e}from"../../chunks/Docstring-50fd6873.js";import{C as Lo}from"../../chunks/CodeBlock-88e23343.js";import{I as to}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function No(et){let _,Z,f,g,ue,D,tt,fe,ot,Ee,z,E,ge,S,st,_e,nt,xe,x,at,M,rt,it,Re,ee,lt,je,te,ke,pt,Le,oe,ct,Pe,I,De,se,dt,Se,ne,N,ht,ae,mt,ut,Me,C,Ie,re,be,ft,Ne,k,gt,O,_t,kt,V,bt,vt,Ce,A,R,ve,F,Tt,Te,wt,Oe,m,X,yt,$,qt,ie,Bt,zt,W,At,$t,Et,U,xt,le,Rt,jt,Lt,b,G,Pt,we,Dt,St,H,pe,Mt,ye,It,Nt,ce,Ct,qe,Ot,Vt,j,K,Ft,Be,Xt,Wt,L,J,Ut,ze,Gt,Ht,P,Q,Kt,Y,Jt,Ae,Qt,Yt,Ve;return D=new to({}),S=new to({}),I=new Lo({props:{code:`import torch
...
`}}),K=new $e({props:{name:"convert_tokens_to_string",anchor:"transformers.BartphoTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/bartpho/tokenization_bartpho.py#L295"}}),J=new $e({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/bartpho/tokenization_bartpho.py#L247",parametersDescription:[{anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Q=new $e({props:{name:"get_special_tokens_mask",anchor:"transformers.BartphoTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/bartpho/tokenization_bartpho.py#L219",parametersDescription:[{anchor:"transformers.BartphoTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),Ne=c(),k=s("p"),gt=r("This model was contributed by "),O=s("a"),_t=r("dqnguyen"),kt=r(". The original code can be found "),V=s("a"),bt=r("here"),vt=r("."),Ce=c(),A=s("h2"),R=s("a"),ve=s("span"),v(F.$$.fragment),Tt=c(),Te=s("span"),wt=r("BartphoTokenizer"),Oe=c(),m=s("div"),v(X.$$.fragment),yt=c(),$=s("p"),qt=r("Adapted from "),ie=s("a"),Bt=r("XLMRobertaTokenizer"),zt=r(". Based on "),W=s("a"),At=r("SentencePiece"),$t=r("."),Et=c(),U=s("p"),xt=r("This tokenizer inherits from "),le=s("a"),Rt=r("PreTrainedTokenizer"),jt=r(` which contains most of the main methods. Users should refer to
...
adding special tokens. An BARTPho sequence has the following format:`),St=c(),H=s("ul"),pe=s("li"),Mt=r("single sequence: "),ye=s("code"),It=r("<s> X </s>"),Nt=c(),ce=s("li"),Ct=r("pair of sequences: "),qe=s("code"),Ot=r("<s> A </s></s> B </s>"),Vt=c(),j=s("div"),v(K.$$.fragment),Ft=c(),Be=s("p"),Xt=r("Converts a sequence of tokens (strings for sub-words) in a single string."),Wt=c(),L=s("div"),v(J.$$.fragment),Ut=c(),ze=s("p"),Gt=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),Ht=c(),P=s("div"),v(Q.$$.fragment),Kt=c(),Y=s("p"),Jt=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ae=s("code"),Qt=r("prepare_for_model"),Yt=r(" method."),this.h()},l(e){const l=Mo('[data-svelte="svelte-1phssyn"]',document.head);_=n(l,"META",{name:!0,content:!0}),l.forEach(o),Z=d(e),f=n(e,"H1",{class:!0});var Fe=a(f);g=n(Fe,"A",{id:!0,class:!0,href:!0});var oo=a(g);ue=n(oo,"SPAN",{});var so=a(ue);T(D.$$.fragment,so),so.forEach(o),oo.forEach(o),tt=d(Fe),fe=n(Fe,"SPAN",{});var no=a(fe);ot=i(no,"BARTpho"),no.forEach(o),Fe.forEach(o),Ee=d(e),z=n(e,"H2",{class:!0});var Xe=a(z);E=n(Xe,"A",{id:!0,class:!0,href:!0});var ao=a(E);ge=n(ao,"SPAN",{});var ro=a(ge);T(S.$$.fragment,ro),ro.forEach(o),ao.forEach(o),st=d(Xe),_e=n(Xe,"SPAN",{});var io=a(_e);nt=i(io,"Overview"),io.forEach(o),Xe.forEach(o),xe=d(e),x=n(e,"P",{});var We=a(x);at=i(We,"The BARTpho model was proposed in "),M=n(We,"A",{href:!0,rel:!0});var lo=a(M);rt=i(lo,"BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese"),lo.forEach(o),it=i(We," by Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen."),We.forEach(o),Re=d(e),ee=n(e,"P",{});var po=a(ee);lt=i(po,"The abstract from the paper is the following:"),po.forEach(o),je=d(e),te=n(e,"P",{});var co=a(te);ke=n(co,"EM",{});var ho=a(ke);pt=i(ho,`We present BARTpho with two versions \u2014 BARTpho_word and BARTpho_syllable \u2014 the first public large-scale monolingual
sequence-to-sequence models pre-trained for Vietnamese. Our BARTpho uses the \u201Clarge\u201D architecture and pre-training
scheme of the sequence-to-sequence denoising model BART, thus especially suitable for generative NLP tasks. Experiments
on a downstream task of Vietnamese text summarization show that in both automatic and human evaluations, our BARTpho
outperforms the strong baseline mBART and improves the state-of-the-art. We release BARTpho to facilitate future
...
adding special tokens. An BARTPho sequence has the following format:`),Ao.forEach(o),St=d(me),H=n(me,"UL",{});var Ke=a(H);pe=n(Ke,"LI",{});var Zt=a(pe);Mt=i(Zt,"single sequence: "),ye=n(Zt,"CODE",{});var $o=a(ye);It=i($o,"<s> X </s>"),$o.forEach(o),Zt.forEach(o),Nt=d(Ke),ce=n(Ke,"LI",{});var eo=a(ce);Ct=i(eo,"pair of sequences: "),qe=n(eo,"CODE",{});var Eo=a(qe);Ot=i(Eo,"<s> A </s></s> B </s>"),Eo.forEach(o),eo.forEach(o),Ke.forEach(o),me.forEach(o),Vt=d(u),j=n(u,"DIV",{class:!0});var Je=a(j);T(K.$$.fragment,Je),Ft=d(Je),Be=n(Je,"P",{});var xo=a(Be);Xt=i(xo,"Converts a sequence of tokens (strings for sub-words) in a single string."),xo.forEach(o),Je.forEach(o),Wt=d(u),L=n(u,"DIV",{class:!0});var Qe=a(L);T(J.$$.fragment,Qe),Ut=d(Qe),ze=n(Qe,"P",{});var Ro=a(ze);Gt=i(Ro,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),Ro.forEach(o),Qe.forEach(o),Ht=d(u),P=n(u,"DIV",{class:!0});var Ye=a(P);T(Q.$$.fragment,Ye),Kt=d(Ye),Y=n(Ye,"P",{});var Ze=a(Y);Jt=i(Ze,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ae=n(Ze,"CODE",{});var jo=a(Ae);Qt=i(jo,"prepare_for_model"),jo.forEach(o),Yt=i(Ze," method."),Ze.forEach(o),Ye.forEach(o),u.forEach(o),this.h()},h(){p(_,"name","hf:doc:metadata"),p(_,"content",JSON.stringify(Co)),p(g,"id","bartpho"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#bartpho"),p(f,"class","relative group"),p(E,"id","overview"),p(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(E,"href","#overview"),p(z,"class","relative group"),p(M,"href","https://arxiv.org/abs/2109.09701"),p(M,"rel","nofollow"),p(ae,"href","bart"),p(O,"href","https://huggingface.co/dqnguyen"),p(O,"rel","nofollow"),p(V,"href","https://github.com/VinAIResearch/BARTpho"),p(V,"rel","nofollow"),p(R,"id","transformers.BartphoTokenizer"),p(R,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(R,"href","#transformers.BartphoTokenizer"),p(A,"class","relative group"),p(ie,"href","/docs/transformers/pr_15725/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer"),p(W,"href","https://github.com/google/sentencepiece"),p(W,"rel","nofollow"),p(le,"href","/docs/transformers/pr_15725/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(b,"class","docstring"),p(j,"class","docstring"),p(L,"class","docstring"),p(P,"class","docstring"),p(m,"class","docstring")},m(e,l){t(document.head,_),h(e,Z,l),h(e,f,l),t(f,g),t(g,ue),w(D,ue,null),t(f,tt),t(f,fe),t(fe,ot),h(e,Ee,l),h(e,z,l),t(z,E),t(E,ge),w(S,ge,null),t(z,st),t(z,_e),t(_e,nt),h(e,xe,l),h(e,x,l),t(x,at),t(x,M),t(M,rt),t(x,it),h(e,Re,l),h(e,ee,l),t(ee,lt),h(e,je,l),h(e,te,l),t(te,ke),t(ke,pt),h(e,Le,l),h(e,oe,l),t(oe,ct),h(e,Pe,l),w(I,e,l),h(e,De,l),h(e,se,l),t(se,dt),h(e,Se,l),h(e,ne,l),t(ne,N),t(N,ht),t(N,ae),t(ae,mt),t(N,ut),h(e,Me,l),w(C,e,l),h(e,Ie,l),h(e,re,l),t(re,be),t(be,ft),h(e,Ne,l),h(e,k,l),t(k,gt),t(k,O),t(O,_t),t(k,kt),t(k,V),t(V,bt),t(k,vt),h(e,Ce,l),h(e,A,l),t(A,R),t(R,ve),w(F,ve,null),t(A,Tt),t(A,Te),t(Te,wt),h(e,Oe,l),h(e,m,l),w(X,m,null),t(m,yt),t(m,$),t($,qt),t($,ie),t(ie,Bt),t($,zt),t($,W),t(W,At),t($,$t),t(m,Et),t(m,U),t(U,xt),t(U,le),t(le,Rt),t(U,jt),t(m,Lt),t(m,b),w(G,b,null),t(b,Pt),t(b,we),t(we,Dt),t(b,St),t(b,H),t(H,pe),t(pe,Mt),t(pe,ye),t(ye,It),t(H,Nt),t(H,ce),t(ce,Ct),t(ce,qe),t(qe,Ot),t(m,Vt),t(m,j),w(K,j,null),t(j,Ft),t(j,Be),t(Be,Xt),t(m,Wt),t(m,L),w(J,L,null),t(L,Ut),t(L,ze),t(ze,Gt),t(m,Ht),t(m,P),w(Q,P,null),t(P,Kt),t(P,Y),t(Y,Jt),t(Y,Ae),t(Ae,Qt),t(Y,Yt),Ve=!0},p:Io,i(e){Ve||(y(D.$$.fragment,e),y(S.$$.fragment,e),y(I.$$.fragment,e),y(C.$$.fragment,e),y(F.$$.fragment,e),y(X.$$.fragment,e),y(G.$$.fragment,e),y(K.$$.fragment,e),y(J.$$.fragment,e),y(Q.$$.fragment,e),Ve=!0)},o(e){q(D.$$.fragment,e),q(S.$$.fragment,e),q(I.$$.fragment,e),q(C.$$.fragment,e),q(F.$$.fragment,e),q(X.$$.fragment,e),q(G.$$.fragment,e),q(K.$$.fragment,e),q(J.$$.fragment,e),q(Q.$$.fragment,e),Ve=!1},d(e){o(_),e&&o(Z),e&&o(f),B(D),e&&o(Ee),e&&o(z),B(S),e&&o(xe),e&&o(x),e&&o(Re),e&&o(ee),e&&o(je),e&&o(te),e&&o(Le),e&&o(oe),e&&o(Pe),B(I,e),e&&o(De),e&&o(se),e&&o(Se),e&&o(ne),e&&o(Me),B(C,e),e&&o(Ie),e&&o(re),e&&o(Ne),e&&o(k),e&&o(Ce),e&&o(A),B(F),e&&o(Oe),e&&o(m),B(X),B(G),B(K),B(J),B(Q)}}}const Co={local:"bartpho",sections:[{local:"overview",title:"Overview"},{local:"transformers.BartphoTokenizer",title:"BartphoTokenizer"}],title:"BARTpho"};function Oo(et,_,Z){let{fw:f}=_;return et.$$set=g=>{"fw"in g&&Z(0,f=g.fw)},[f]}class Go extends Po{constructor(_){super();Do(this,_,Oo,No,So,{fw:0})}}export{Go as default,Co as metadata};
