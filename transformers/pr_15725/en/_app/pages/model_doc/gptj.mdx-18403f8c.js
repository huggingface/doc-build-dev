import{S as Mc,i as Fc,s as zc,e as n,k as d,w as _,t as r,L as Ec,c as s,d as o,m as c,a,x as T,h as i,b as l,J as e,g as u,y as v,q as P,o as k,B as w}from"../../chunks/vendor-9e2b328e.js";import{T as zo}from"../../chunks/Tip-76f97a76.js";import{D as Q}from"../../chunks/Docstring-50fd6873.js";import{C as Y}from"../../chunks/CodeBlock-88e23343.js";import{I as le}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function qc(F){let h,y,f,b,$;return{c(){h=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),b=r("Module"),$=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Ac(F){let h,y,f,b,$;return{c(){h=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),b=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var j=a(f);b=i(j,"Module"),j.forEach(o),$=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Cc(F){let h,y,f,b,$;return{c(){h=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),b=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var j=a(f);b=i(j,"Module"),j.forEach(o),$=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var j=a(f);b=i(j,"Module"),j.forEach(o),$=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Nc(F){let h,y,f,b,$,g,m,j,Cs,Wn,de,$e,Eo,Ve,Is,qo,Ls,Un,Z,Ss,Ke,Ns,Ds,Xe,Bs,Os,Qn,je,Ws,Ye,Us,Qs,Hn,ro,Hs,Rn,io,N,Rs,Ze,Vs,Ks,Ao,Xs,Ys,Co,Zs,ea,et,ta,oa,Vn,tt,Kn,Ge,Io,lo,na,ot,sa,aa,Lo,R,ra,nt,ia,la,So,da,ca,No,pa,ha,Xn,ce,xe,Do,st,ua,Bo,fa,Yn,Je,ma,co,ga,_a,Zn,at,es,po,Ta,ts,rt,os,pe,Me,Oo,it,va,Wo,Pa,ns,D,lt,ka,B,wa,ho,ba,ya,dt,$a,ja,uo,Ga,xa,fo,Ja,Ma,Fa,Uo,za,Ea,ct,ss,he,Fe,Qo,pt,qa,Ho,Aa,as,V,ht,Ca,ut,Ia,ft,La,Sa,Na,z,mt,Da,ue,Ba,mo,Oa,Wa,Ro,Ua,Qa,Ha,ze,Ra,Vo,Va,Ka,gt,rs,fe,Ee,Ko,_t,Xa,Xo,Ya,is,O,Tt,Za,Yo,er,tr,vt,or,Pt,nr,sr,ar,E,kt,rr,me,ir,go,lr,dr,Zo,cr,pr,hr,qe,ur,en,fr,mr,wt,ls,ge,Ae,tn,bt,gr,on,_r,ds,M,yt,Tr,nn,vr,Pr,_o,To,kr,wr,br,W,yr,sn,$r,jr,an,Gr,xr,rn,Jr,Mr,ln,Fr,zr,Er,$t,qr,jt,Ar,Cr,Ir,J,Gt,Lr,_e,Sr,vo,Nr,Dr,dn,Br,Or,Wr,Ce,Ur,cn,Qr,Hr,xt,Rr,pn,Vr,Kr,Jt,cs,Te,Ie,hn,Mt,Xr,un,Yr,ps,U,Ft,Zr,ve,ei,fn,ti,oi,mn,ni,si,ai,zt,ri,Et,ii,li,di,q,qt,ci,Pe,pi,Po,hi,ui,gn,fi,mi,gi,Le,_i,_n,Ti,vi,At,hs,ke,Se,Tn,Ct,Pi,vn,ki,us,G,It,wi,Pn,bi,yi,Lt,$i,ko,ji,Gi,xi,St,Ji,Nt,Mi,Fi,zi,kn,Ei,qi,K,wn,Dt,Ai,Ci,bn,Bt,Ii,Li,yn,Ot,Si,Ni,$n,Wt,Di,Bi,A,Ut,Oi,we,Wi,jn,Ui,Qi,Gn,Hi,Ri,Vi,Ne,Ki,xn,Xi,Yi,Qt,fs,be,De,Jn,Ht,Zi,Mn,el,ms,x,Rt,tl,Fn,ol,nl,Vt,sl,wo,al,rl,il,Kt,ll,Xt,dl,cl,pl,zn,hl,ul,X,En,Yt,fl,ml,qn,Zt,gl,_l,An,eo,Tl,vl,Cn,to,Pl,kl,C,oo,wl,ye,bl,In,yl,$l,Ln,jl,Gl,xl,Be,Jl,Sn,Ml,Fl,no,gs;return g=new le({}),Ve=new le({}),tt=new Y({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),pt=new le({}),ht=new Q({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/gptj/modeling_gptj.py#L450",parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15725/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15725/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),mt=new Q({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15725/src/transformers/models/gptj/modeling_gptj.py#L506",parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_15725/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15725/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15725/en/model_doc/gptj#transformers.GPTJConfig"
...
<p>A <a
  href="/docs/transformers/pr_15725/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
`}}),Ce=new zo({props:{$$slots:{default:[Cc]},$$scope:{ctx:F}}}),xt=new Y({props:{code:`from transformers import GPT2Tokenizer, GPTJForSequenceClassification
import torch
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_15725/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_15725/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15725/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
causal language model trained on `),Xe=n("a"),Bs=r("the Pile"),Os=r(" dataset."),Qn=d(),je=n("p"),Ws=r("This model was contributed by "),Ye=n("a"),Us=r("Stella Biderman"),Qs=r("."),Hn=d(),ro=n("p"),Hs=r("Tips:"),Rn=d(),io=n("ul"),N=n("li"),Rs=r("To load "),Ze=n("a"),Vs=r("GPT-J"),Ks=r(` in float32 one would need at least 2x model size CPU
...
behavior.`),Na=d(),z=n("div"),_(mt.$$.fragment),Da=d(),ue=n("p"),Ba=r("The "),mo=n("a"),Oa=r("GPTJModel"),Wa=r(" forward method, overrides the "),Ro=n("code"),Ua=r("__call__"),Qa=r(" special method."),Ha=d(),_(ze.$$.fragment),Ra=d(),Vo=n("p"),Va=r("Example:"),Ka=d(),_(gt.$$.fragment),rs=d(),fe=n("h2"),Ee=n("a"),Ko=n("span"),_(_t.$$.fragment),Xa=d(),Xo=n("span"),Ya=r("GPTJForCausalLM"),is=d(),O=n("div"),_(Tt.$$.fragment),Za=d(),Yo=n("p"),er=r("The GPT-J Model transformer with a language modeling head on top."),tr=d(),vt=n("p"),or=r("This model is a PyTorch "),Pt=n("a"),nr=r("torch.nn.Module"),sr=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
SQuAD (a linear layers on top of the hidden-states output to compute `),fn=n("code"),ti=r("span start logits"),oi=r(" and "),mn=n("code"),ni=r("span end logits"),si=r(")."),ai=d(),zt=n("p"),ri=r("This model is a PyTorch "),Et=n("a"),ii=r("torch.nn.Module"),li=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
each row of the batch).`),se.forEach(o),Er=c(H),$t=s(H,"P",{});var Gs=a($t);qr=i(Gs,"This model is a PyTorch "),jt=s(Gs,"A",{href:!0,rel:!0});var qd=a(jt);Ar=i(qd,"torch.nn.Module"),qd.forEach(o),Cr=i(Gs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
SQuAD (a linear layers on top of the hidden-states output to compute `),fn=s(xo,"CODE",{});var Bd=a(fn);ti=i(Bd,"span start logits"),Bd.forEach(o),oi=i(xo," and "),mn=s(xo,"CODE",{});var Od=a(mn);ni=i(Od,"span end logits"),Od.forEach(o),si=i(xo,")."),xo.forEach(o),ai=c(Qe),zt=s(Qe,"P",{});var Js=a(zt);ri=i(Js,"This model is a PyTorch "),Et=s(Js,"A",{href:!0,rel:!0});var Wd=a(Et);ii=i(Wd,"torch.nn.Module"),Wd.forEach(o),li=i(Js,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Js.forEach(o),di=c(Qe),q=s(Qe,"DIV",{class:!0});var ae=a(q);T(qt.$$.fragment,ae),ci=c(ae),Pe=s(ae,"P",{});var Jo=a(Pe);pi=i(Jo,"The "),Po=s(Jo,"A",{href:!0});var Ud=a(Po);hi=i(Ud,"GPTJForQuestionAnswering"),Ud.forEach(o),ui=i(Jo," forward method, overrides the "),gn=s(Jo,"CODE",{});var Qd=a(gn);fi=i(Qd,"__call__"),Qd.forEach(o),mi=i(Jo," special method."),Jo.forEach(o),gi=c(ae),T(Le.$$.fragment,ae),_i=c(ae),_n=s(ae,"P",{});var Hd=a(_n);Ti=i(Hd,"Example:"),Hd.forEach(o),vi=c(ae),T(At.$$.fragment,ae),ae.forEach(o),Qe.forEach(o),hs=c(t),ke=s(t,"H2",{class:!0});var Ms=a(ke);Se=s(Ms,"A",{id:!0,class:!0,href:!0});var Rd=a(Se);Tn=s(Rd,"SPAN",{});var Vd=a(Tn);T(Ct.$$.fragment,Vd),Vd.forEach(o),Rd.forEach(o),Pi=c(Ms),vn=s(Ms,"SPAN",{});var Kd=a(vn);ki=i(Kd,"FlaxGPTJModel"),Kd.forEach(o),Ms.forEach(o),us=c(t),G=s(t,"DIV",{class:!0});var L=a(G);T(It.$$.fragment,L),wi=c(L),Pn=s(L,"P",{});var Xd=a(Pn);bi=i(Xd,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Xd.forEach(o),yi=c(L),Lt=s(L,"P",{});var Fs=a(Lt);$i=i(Fs,"This model inherits from "),ko=s(Fs,"A",{href:!0});var Yd=a(ko);ji=i(Yd,"FlaxPreTrainedModel"),Yd.forEach(o),Gi=i(Fs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
