import{S as UK,i as GK,s as LK,e as o,k as u,w as f,t as a,M as MK,c as l,d as t,m as c,a as r,x as d,h as n,b as h,F as s,g as i,y as m,q as _,o as v,B as j,v as ZK}from"../../chunks/vendor-6b77c823.js";import{T as qG}from"../../chunks/Tip-39098574.js";import{D as Hj}from"../../chunks/Docstring-abef54e3.js";import{C as g}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as w}from"../../chunks/IconCopyLink-7a11ce68.js";function NK(bt){let y,C;return{c(){y=o("p"),C=a("This section is a must-read")},l(b){y=l(b,"P",{});var k=r(y);C=n(k,"This section is a must-read"),k.forEach(t)},m(b,k){i(b,y,k),s(y,C)},d(b){b&&t(y)}}}function HK(bt){let y,C,b,k,ee,z,x,se,R,ae,S;return{c(){y=o("p"),C=a("As of "),b=o("code"),k=a("deepspeed==0.6.0"),ee=a(" the bf16 support is new and experimental."),z=u(),x=o("p"),se=a("If you use "),R=o("a"),ae=a("gradient accumulation"),S=a(" with bf16-enabled, you need to be aware that it\u2019ll accumulate gradients in bf16, which may not be what you want due to this format\u2019s low precision, as it may lead to a lossy accumulation."),this.h()},l(E){y=l(E,"P",{});var q=r(y);C=n(q,"As of "),b=l(q,"CODE",{});var Es=r(b);k=n(Es,"deepspeed==0.6.0"),Es.forEach(t),ee=n(q," the bf16 support is new and experimental."),q.forEach(t),z=c(E),x=l(E,"P",{});var V=r(x);se=n(V,"If you use "),R=l(V,"A",{href:!0});var qs=r(R);ae=n(qs,"gradient accumulation"),qs.forEach(t),S=n(V," with bf16-enabled, you need to be aware that it\u2019ll accumulate gradients in bf16, which may not be what you want due to this format\u2019s low precision, as it may lead to a lossy accumulation."),V.forEach(t),this.h()},h(){h(R,"href","#gradient-accumulation")},m(E,q){i(E,y,q),s(y,C),s(y,b),s(b,k),s(y,ee),i(E,z,q),i(E,x,q),s(x,se),s(x,R),s(R,ae),s(x,S)},d(E){E&&t(y),E&&t(z),E&&t(x)}}}function BK(bt){let y,C,b,k,ee,z,x,se,R,ae,S;return{c(){y=o("p"),C=a("Note, that once "),b=o("code"),k=a("load_state_dict_from_zero_checkpoint"),ee=a(" was run, the "),z=o("code"),x=a("model"),se=a(` will no longer be useable in the
...
of the training.`),q.forEach(t)},m(E,q){i(E,y,q),s(y,C),s(y,b),s(b,k),s(y,ee),s(y,z),s(z,x),s(y,se),s(y,R),s(R,ae),s(y,S)},d(E){E&&t(y)}}}function WK(bt){let y,C,b,k,ee,z,x,se,R,ae,S,E,q,Es,V,qs,L6,Bj,I,sf,M6,Z6,tf,N6,H6,af,B6,W6,nf,F6,V6,of,Y6,K6,lf,J6,Wj,Se,X6,ao,Q6,e5,no,s5,t5,Fj,Up,a5,Vj,Gp,n5,Yj,Et,o5,oo,l5,r5,Kj,qt,lo,p5,Lp,i5,u5,c5,Y,h5,Mp,f5,d5,rf,m5,_5,pf,v5,j5,uf,g5,w5,Zp,y5,b5,Jj,Np,E5,Xj,Hp,q5,Qj,Bp,cf,$5,eg,Wp,k5,sg,Fp,ro,P5,Vp,D5,z5,tg,Yp,O5,ag,Kp,ng,$s,$t,hf,po,T5,ff,A5,og,Jp,lg,ks,kt,df,io,S5,mf,C5,rg,Xp,x5,pg,uo,ig,Ce,R5,_f,I5,U5,vf,G5,L5,ug,co,cg,xe,M5,ho,Z5,N5,fo,H5,B5,hg,Pt,W5,Qp,F5,V5,fg,ei,Y5,dg,si,K5,mg,mo,_g,Re,J5,jf,X5,Q5,gf,e$,s$,vg,Dt,t$,wf,a$,n$,jg,_o,gg,Pe,o$,yf,l$,r$,bf,p$,i$,Ef,u$,wg,ti,c$,yg,vo,bg,Ie,h$,qf,f$,d$,$f,m$,_$,Eg,zt,v$,kf,j$,g$,qg,Ue,w$,Pf,y$,b$,jo,E$,q$,$g,ai,$$,kg,go,Pg,ni,k$,Dg,wo,zg,oi,P$,Og,yo,Tg,Ot,D$,Df,z$,O$,Ag,Tt,T$,zf,A$,S$,Sg,At,C$,bo,x$,R$,Cg,li,xg,Ps,St,Of,Eo,I$,Tf,U$,Rg,Ct,G$,ri,L$,M$,Ig,xt,Ds,Z$,Af,N$,H$,Sf,B$,W$,F$,De,V$,Cf,Y$,K$,xf,J$,X$,qo,Q$,e4,Ug,pi,s4,Gg,$o,Lg,ii,t4,Mg,ko,Zg,U,a4,Rf,n4,o4,If,l4,r4,Uf,p4,i4,Gf,u4,c4,Po,h4,f4,Ng,ne,d4,Lf,m4,_4,Mf,v4,j4,Zf,g4,w4,Hg,Rt,y4,Nf,b4,E4,Bg,Do,Wg,It,q4,Hf,$4,k4,Fg,Ut,P4,zo,D4,z4,Vg,ui,Yg,zs,Gt,Bf,Oo,O4,Wf,T4,Kg,Lt,A4,ci,S4,C4,Jg,To,Xg,Ge,x4,Ff,R4,I4,Ao,U4,G4,Qg,hi,L4,ew,Mt,Vf,M4,Z4,Yf,N4,sw,fi,H4,tw,So,aw,di,B4,nw,Zt,W4,Co,F4,V4,ow,mi,Y4,lw,_i,K4,rw,vi,Os,xo,J4,Kf,X4,Q4,e9,Ro,s9,Jf,t9,pw,ji,iw,Ts,Nt,Xf,Io,a9,Qf,n9,uw,Ht,o9,ed,l9,r9,cw,gi,p9,hw,Uo,fw,Bt,i9,sd,u9,c9,dw,wi,h9,mw,yi,f9,_w,Go,vw,Le,d9,td,m9,_9,ad,v9,j9,jw,Lo,gw,Wt,g9,nd,w9,y9,ww,Mo,yw,bi,b9,bw,Ft,E9,od,q9,$9,Ew,Ei,qw,As,Vt,ld,Zo,k9,rd,P9,$w,Yt,D9,No,z9,O9,kw,Kt,T9,Ho,A9,S9,Pw,Bo,Dw,Jt,C9,pd,x9,R9,zw,Wo,Ow,Xt,I9,Fo,U9,G9,Tw,qi,L9,Aw,oe,M9,id,Z9,N9,ud,H9,B9,cd,W9,F9,Sw,Vo,Cw,Qt,V9,$i,Y9,K9,xw,ki,Rw,Ss,ea,hd,Yo,J9,fd,X9,Iw,G,Q9,Pi,e8,s8,Di,t8,a8,dd,n8,o8,md,l8,r8,zi,p8,i8,Uw,Oi,u8,Gw,Ko,Lw,Ti,c8,Mw,Jo,Zw,Ai,Nw,Cs,sa,_d,Xo,h8,vd,f8,Hw,ta,Bw,Me,d8,Si,m8,_8,Ci,v8,j8,Ww,aa,g8,xi,w8,y8,Fw,Ze,b8,jd,E8,q8,Ri,$8,k8,Vw,Ii,P8,Yw,na,D8,Ui,z8,O8,Kw,oa,gd,T8,A8,Qo,S8,Gi,C8,x8,Jw,le,R8,wd,I8,U8,Li,G8,L8,yd,M8,Z8,Xw,Mi,Qw,xs,la,bd,el,N8,Ed,H8,ey,sl,tl,B8,W8,sy,Ne,F8,qd,V8,Y8,al,K8,J8,ty,ra,X8,Zi,Q8,ek,ay,Ni,sk,ny,Hi,oy,Rs,pa,$d,nl,tk,kd,ak,ly,Bi,nk,ry,ol,py,Wi,Pd,ok,iy,He,Is,lk,Dd,rk,pk,zd,ik,uk,ck,L,Od,hk,fk,Td,dk,mk,Ad,_k,vk,Sd,jk,gk,Cd,wk,yk,xd,bk,Ek,qk,Rd,$k,uy,Be,kk,Id,Pk,Dk,Ud,zk,Ok,cy,ll,hy,Fi,Tk,fy,Vi,dy,Us,ia,Gd,rl,Ak,Ld,Sk,my,Yi,Ck,_y,pl,vy,K,xk,Md,Rk,Ik,Zd,Uk,Gk,Nd,Lk,Mk,Hd,Zk,Nk,jy,We,Hk,Bd,Bk,Wk,Wd,Fk,Vk,gy,Ki,Fd,Yk,wy,ua,il,Vd,Kk,Jk,Yd,Xk,Qk,ul,Kd,e7,s7,Jd,t7,yy,M,a7,Xd,n7,o7,Qd,l7,r7,em,p7,i7,sm,u7,c7,tm,h7,f7,by,ze,am,d7,m7,nm,_7,v7,om,j7,g7,Ey,Ji,w7,qy,Fe,cl,lm,y7,b7,rm,E7,q7,hl,pm,$7,k7,im,P7,D7,fl,um,z7,O7,cm,T7,$y,Ve,A7,hm,S7,C7,Xi,x7,R7,ky,dl,fm,I7,U7,Py,re,G7,dm,L7,M7,mm,Z7,N7,_m,H7,B7,Dy,Qi,ml,vm,W7,F7,jm,V7,zy,Oe,gm,Y7,K7,wm,J7,X7,ym,Q7,eP,Oy,Ye,sP,bm,tP,aP,Em,nP,oP,Ty,ca,_l,lP,qm,rP,pP,iP,vl,uP,$m,cP,hP,Ay,eu,Sy,Gs,ha,km,jl,fP,Pm,dP,Cy,su,mP,xy,tu,_P,Ry,gl,Iy,fa,vP,Dm,jP,gP,Uy,Ke,wP,wl,yP,bP,yl,EP,qP,Gy,da,$P,zm,kP,PP,Ly,Je,DP,Om,zP,OP,bl,TP,AP,My,au,Zy,Ls,ma,Tm,El,SP,Am,CP,Ny,nu,xP,Hy,ou,RP,By,_a,Ms,IP,Sm,UP,GP,Cm,LP,MP,ZP,ql,NP,xm,HP,BP,Wy,Xe,WP,Rm,FP,VP,Im,YP,KP,Fy,lu,Vy,Zs,va,Um,$l,JP,Gm,XP,Yy,ja,QP,Lm,eD,sD,Ky,kl,Jy,ga,tD,Mm,aD,nD,Xy,Pl,Qy,ru,e2,Ns,wa,Zm,Dl,oD,Nm,lD,s2,ya,rD,Hm,pD,iD,t2,zl,a2,ba,uD,Bm,cD,hD,n2,Ol,o2,Hs,Ea,Wm,Tl,fD,Fm,dD,l2,qa,mD,Vm,_D,vD,r2,pu,jD,p2,$a,gD,Ym,wD,yD,i2,iu,u2,Bs,ka,Km,Al,bD,Jm,ED,c2,Qe,qD,Xm,$D,kD,Sl,PD,DD,h2,$,zD,Qm,OD,TD,uu,AD,SD,e_,CD,xD,s_,RD,ID,t_,UD,GD,a_,LD,MD,n_,ZD,ND,o_,HD,BD,f2,es,WD,l_,FD,VD,r_,YD,KD,d2,Cl,m2,cu,JD,_2,pe,xl,p_,XD,QD,i_,ez,sz,Rl,u_,tz,az,c_,nz,oz,Il,h_,lz,rz,f_,pz,iz,Ul,d_,uz,cz,m_,hz,v2,hu,fz,j2,fu,dz,g2,Gl,w2,Pa,mz,du,_z,vz,y2,mu,jz,b2,Ll,E2,ie,gz,__,wz,yz,v_,bz,Ez,j_,qz,$z,q2,_u,$2,Ws,Da,g_,Ml,kz,w_,Pz,k2,Z,Dz,y_,zz,Oz,b_,Tz,Az,E_,Sz,Cz,q_,xz,Rz,Zl,Iz,Uz,P2,vu,Gz,D2,za,Nl,$_,Lz,Mz,k_,Zz,Nz,ss,P_,Hz,Bz,D_,Wz,Fz,z_,Vz,Yz,z2,O,Kz,O_,Jz,Xz,ju,Qz,eO,T_,sO,tO,A_,aO,nO,S_,oO,lO,C_,rO,pO,O2,ts,iO,x_,uO,cO,R_,hO,fO,T2,Hl,A2,as,dO,I_,mO,_O,gu,vO,jO,S2,ue,Oa,U_,gO,wO,G_,yO,bO,EO,Ta,L_,qO,$O,M_,kO,PO,DO,ns,Z_,zO,OO,N_,TO,AO,H_,SO,CO,xO,os,B_,RO,IO,W_,UO,GO,F_,LO,MO,C2,wu,ZO,x2,Bl,R2,Aa,NO,yu,HO,BO,I2,Sa,WO,V_,FO,VO,U2,Wl,G2,J,YO,Y_,KO,JO,K_,XO,QO,J_,eT,sT,X_,tT,aT,L2,bu,M2,Fs,Ca,Q_,Fl,nT,e1,oT,Z2,Eu,lT,N2,xa,rT,s1,pT,iT,H2,Vl,B2,Ra,uT,Yl,cT,hT,W2,ce,fT,t1,dT,mT,a1,_T,vT,n1,jT,gT,F2,qu,V2,Vs,Ia,o1,Kl,wT,l1,yT,Y2,$u,bT,K2,Ys,Ua,r1,Jl,ET,p1,qT,J2,ku,$T,X2,Xl,Q2,ls,kT,Pu,PT,DT,i1,zT,OT,eb,rs,TT,u1,AT,ST,c1,CT,xT,sb,Du,RT,tb,Ql,ab,Ga,IT,zu,UT,GT,nb,La,LT,er,MT,ZT,ob,Ks,Ma,h1,sr,NT,f1,HT,lb,Ou,BT,rb,tr,pb,Tu,WT,ib,ps,FT,d1,VT,YT,m1,KT,JT,ub,Au,XT,cb,ar,hb,Za,fb,Js,Na,_1,nr,QT,v1,eA,db,Su,sA,mb,or,_b,he,tA,Cu,aA,nA,j1,oA,lA,g1,rA,pA,vb,Ha,iA,w1,uA,cA,jb,xu,hA,gb,lr,wb,Ba,fA,Ru,dA,mA,yb,Wa,_A,rr,vA,jA,bb,Iu,Eb,Xs,Fa,y1,pr,gA,b1,wA,qb,Uu,yA,$b,ir,kb,N,bA,Gu,EA,qA,E1,$A,kA,q1,PA,DA,$1,zA,OA,k1,TA,AA,Pb,Lu,SA,Db,ur,zb,Va,CA,Mu,xA,RA,Ob,Zu,Tb,Qs,Ya,P1,cr,IA,D1,UA,Ab,Nu,GA,Sb,hr,Cb,is,LA,Hu,MA,ZA,z1,NA,HA,xb,Bu,BA,Rb,fr,Ib,Ka,WA,Wu,FA,VA,Ub,Fu,Gb,et,Ja,O1,dr,YA,T1,KA,Lb,Vu,JA,Mb,mr,Zb,us,XA,Yu,QA,eS,A1,sS,tS,Nb,Ku,aS,Hb,_r,Bb,Xa,nS,Ju,oS,lS,Wb,Xu,Fb,st,Qa,S1,vr,rS,C1,pS,Vb,en,iS,x1,uS,cS,Yb,Qu,R1,hS,Kb,sn,fS,I1,dS,mS,Jb,T,_S,U1,vS,jS,G1,gS,wS,L1,yS,bS,M1,ES,qS,Z1,$S,kS,N1,PS,DS,Xb,jr,Qb,ec,H1,zS,e3,tn,OS,gr,TS,AS,s3,sc,B1,SS,t3,tc,CS,a3,ac,xS,n3,wr,o3,cs,RS,W1,IS,US,F1,GS,LS,l3,yr,r3,an,p3,nn,MS,V1,ZS,NS,i3,on,HS,Y1,BS,WS,u3,br,c3,nc,K1,FS,h3,hs,VS,J1,YS,KS,X1,JS,XS,f3,oc,QS,d3,Er,m3,ln,eC,Q1,sC,tC,_3,qr,v3,rn,aC,ev,nC,oC,j3,lc,lC,g3,$r,sv,rC,pC,w3,fs,iC,tv,uC,cC,av,hC,fC,y3,rc,dC,b3,tt,pn,nv,kr,mC,ov,_C,E3,pc,vC,q3,ic,jC,$3,uc,gC,k3,at,un,lv,Pr,wC,rv,yC,P3,cn,bC,pv,EC,qC,D3,Dr,z3,cc,$C,O3,D,kC,iv,PC,DC,uv,zC,OC,cv,TC,AC,hc,SC,CC,fc,xC,RC,hv,IC,UC,fv,GC,LC,T3,zr,A3,hn,MC,dv,ZC,NC,S3,dc,HC,C3,fn,BC,Or,WC,FC,x3,fe,VC,mv,YC,KC,_v,JC,XC,mc,QC,ex,R3,nt,dn,vv,Tr,sx,jv,tx,I3,Ar,ax,Sr,nx,U3,mn,ox,gv,lx,rx,G3,_c,px,L3,Cr,M3,ds,ix,wv,ux,cx,yv,hx,fx,Z3,vc,N3,ot,_n,bv,xr,dx,Ev,mx,H3,jc,_x,B3,vn,vx,gc,jx,gx,W3,Rr,F3,wc,wx,V3,jn,yx,qv,bx,Ex,Y3,Ir,K3,yc,qx,J3,bc,$x,X3,lt,gn,$v,Ur,kx,kv,Px,Q3,Ec,Dx,e0,qc,zx,s0,Gr,t0,$c,Ox,a0,kc,Tx,n0,Pc,Ax,o0,Dc,Sx,l0,Lr,r0,zc,Cx,p0,wn,xx,Mr,Rx,Ix,i0,rt,yn,Pv,Zr,Ux,Dv,Gx,u0,Oc,Lx,c0,Tc,Mx,h0,H,zv,Ov,Zx,Nx,Tv,Te,Hx,Ac,Bx,Wx,Sc,Fx,Vx,Cc,Yx,Kx,Jx,Nr,Av,Xx,Qx,Hr,eR,Sv,Br,sR,Wr,tR,aR,nR,Cv,xv,oR,lR,Rv,Fr,rR,Vr,pR,iR,f0,xc,uR,d0,bn,pt,Iv,cR,hR,Uv,fR,dR,Gv,mR,_R,Lv,Yr,vR,Kr,jR,gR,m0,it,En,Mv,Jr,wR,Zv,yR,_0,ut,qn,Nv,Xr,bR,Qr,ER,Hv,qR,$R,v0,B,kR,Bv,PR,DR,Wv,zR,OR,Fv,TR,AR,Vv,SR,CR,ep,xR,RR,j0,ct,$n,Yv,sp,IR,Rc,UR,Kv,GR,g0,Ic,LR,w0,Uc,MR,y0,tp,b0,kn,ZR,Jv,NR,HR,E0,ap,q0,Gc,BR,$0,Lc,WR,k0,ms,FR,Xv,VR,YR,Qv,KR,JR,P0,ht,Pn,ej,np,XR,sj,QR,D0,_s,Dn,eI,Mc,sI,tI,tj,aI,nI,op,oI,lp,lI,rI,pI,ft,iI,Zc,uI,cI,rp,hI,fI,z0,Nc,O0,dt,zn,aj,pp,dI,nj,mI,T0,de,_I,Hc,vI,jI,Bc,gI,wI,oj,yI,bI,A0,On,EI,Wc,qI,$I,S0,vs,kI,Fc,PI,DI,Vc,zI,OI,C0,Tn,TI,lj,AI,SI,x0,Yc,CI,R0,ip,I0,Kc,xI,U0,up,G0,me,RI,Jc,II,UI,cp,GI,LI,rj,MI,ZI,L0,mt,An,pj,hp,NI,ij,HI,M0,P,fp,BI,uj,WI,FI,Ae,VI,cj,YI,KI,hj,JI,XI,fj,QI,eU,sU,_e,Xc,tU,aU,dj,nU,oU,Qc,lU,rU,mj,pU,iU,uU,js,dp,cU,_j,hU,fU,_t,dU,vj,mU,_U,jj,vU,jU,gU,Sn,mp,wU,_p,yU,gj,bU,EU,qU,Cn,vp,$U,vt,kU,wj,PU,DU,yj,zU,OU,TU,xn,jp,AU,jt,SU,bj,CU,xU,Ej,RU,IU,Z0,gt,Rn,qj,gp,UU,$j,GU,N0,In,LU,eh,MU,ZU,H0,sh,NU,B0,th,HU,W0,ah,BU,F0,Un,kj,WU,FU,Pj,VU,V0,wp,Y0,Gn,YU,Dj,KU,JU,K0,yp,J0,nh,XU,X0,wt,Ln,zj,bp,QU,Oj,eG,Q0,ve,Tj,Ep,sG,tG,Aj,qp,aG,nG,Sj,$p,oG,lG,Cj,kp,rG,eE,oh,pG,sE,gs,xj,Pp,iG,uG,Rj,Dp,cG,hG,Ij,zp,fG,tE,ws,dG,lh,mG,_G,Op,vG,jG,aE;return z=new w({}),po=new w({}),io=new w({}),uo=new g({props:{code:"pip install deepspeed",highlighted:"pip install deepspeed"}}),co=new g({props:{code:"pip install transformers[deepspeed]",highlighted:"pip install transformers[deepspeed]"}}),mo=new g({props:{code:`git clone https://github.com/microsoft/DeepSpeed/
cd DeepSpeed
rm -rf build
...
TrainingArguments(..., deepspeed=ds_config_dict)`}}),Xo=new w({}),ta=new qG({props:{warning:!0,$$slots:{default:[NK]},$$scope:{ctx:bt}}}),el=new w({}),nl=new w({}),ol=new g({props:{code:`{
    "zero_optimization": {
        "stage": 2,
        "offload_optimizer": {
            "device": "cpu",
...
<span class="hljs-punctuation">}</span>`}}),ar=new g({props:{code:`{
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Za=new qG({props:{$$slots:{default:[HK]},$$scope:{ctx:bt}}}),nr=new w({}),or=new g({props:{code:`"amp": {
    "enabled": "auto",
    "opt_level": "auto"
...
trainer.deepspeed.save_checkpoint(checkpoint_dir)
fp32_model = load_state_dict_from_zero_checkpoint(trainer.model, checkpoint_dir)`}}),an=new qG({props:{$$slots:{default:[BK]},$$scope:{ctx:bt}}}),br=new g({props:{code:`from deepspeed.utils.zero_to_fp32 import get_fp32_state_dict_from_zero_checkpoint
...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16529/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16529/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16529/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16529/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16529/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),bp=new w({}),{c(){y=o("meta"),C=u(),b=o("h1"),k=o("a"),ee=o("span"),f(z.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),S=o("p"),E=o("a"),q=a("DeepSpeed"),Es=a(" implements everything described in the "),V=o("a"),qs=a("ZeRO paper"),L6=a(". Currently it provides full support for:"),Bj=u(),I=o("ol"),sf=o("li"),M6=a("Optimizer state partitioning (ZeRO stage 1)"),Z6=u(),tf=o("li"),N6=a("Gradient partitioning (ZeRO stage 2)"),H6=u(),af=o("li"),B6=a("Parameter partitioning (ZeRO stage 3)"),W6=u(),nf=o("li"),F6=a("Custom mixed precision training handling"),V6=u(),of=o("li"),Y6=a("A range of fast CUDA-extension-based optimizers"),K6=u(),lf=o("li"),J6=a("ZeRO-Offload to CPU and NVMe"),Wj=u(),Se=o("p"),X6=a("ZeRO-Offload has its own dedicated paper: "),ao=o("a"),Q6=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),e5=a(". And NVMe-support is described in the paper "),no=o("a"),s5=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),t5=a("."),Fj=u(),Up=o("p"),a5=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Vj=u(),Gp=o("p"),n5=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Yj=u(),Et=o("p"),o5=a("\u{1F917} Transformers integrates "),oo=o("a"),l5=a("DeepSpeed"),r5=a(" via 2 options:"),Kj=u(),qt=o("ol"),lo=o("li"),p5=a("Integration of the core DeepSpeed features via "),Lp=o("a"),i5=a("Trainer"),u5=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),c5=u(),Y=o("li"),h5=a("If you don\u2019t use "),Mp=o("a"),f5=a("Trainer"),d5=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),rf=o("code"),m5=a("from_pretrained"),_5=a(" and "),pf=o("code"),v5=a("from_config"),j5=a(` include integration of essential
parts of DeepSpeed like `),uf=o("code"),g5=a("zero.Init"),w5=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=o("a"),y5=a("deepspeed-non-trainer-integration"),b5=a("."),Jj=u(),Np=o("p"),E5=a("What is integrated:"),Xj=u(),Hp=o("p"),q5=a("Training:"),Qj=u(),Bp=o("ol"),cf=o("li"),$5=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),eg=u(),Wp=o("p"),k5=a("Inference:"),sg=u(),Fp=o("ol"),ro=o("li"),P5=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=o("a"),D5=a("deepspeed-zero-inference"),z5=a("."),tg=u(),Yp=o("p"),O5=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),$s=o("h2"),$t=o("a"),hf=o("span"),f(po.$$.fragment),T5=u(),ff=o("span"),A5=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),ks=o("h3"),kt=o("a"),df=o("span"),f(io.$$.fragment),S5=u(),mf=o("span"),C5=a("Installation"),rg=u(),Xp=o("p"),x5=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R5=a("or via "),_f=o("code"),I5=a("transformers"),U5=a("\u2019 "),vf=o("code"),G5=a("extras"),L5=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M5=a("or find more details on "),ho=o("a"),Z5=a("the DeepSpeed\u2019s GitHub page"),N5=a(` and
`),fo=o("a"),H5=a("advanced install"),B5=a("."),hg=u(),Pt=o("p"),W5=a("If you\u2019re still struggling with the build, first make sure to read "),Qp=o("a"),F5=a("zero-install-notes"),V5=a("."),fg=u(),ei=o("p"),Y5=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),dg=u(),si=o("p"),K5=a("To make a local build for DeepSpeed:"),mg=u(),f(mo.$$.fragment),_g=u(),Re=o("p"),J5=a("If you intend to use NVMe offload you will also need to include "),jf=o("code"),X5=a("DS_BUILD_AIO=1"),Q5=a(` in the instructions above (and also
install `),gf=o("em"),e$=a("libaio-dev"),s$=a(" system-wide)."),vg=u(),Dt=o("p"),t$=a("Edit "),wf=o("code"),a$=a("TORCH_CUDA_ARCH_LIST"),n$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),jg=u(),f(_o.$$.fragment),gg=u(),Pe=o("p"),o$=a("So if you get "),yf=o("code"),l$=a("8, 6"),r$=a(", then use "),bf=o("code"),p$=a('TORCH_CUDA_ARCH_LIST="8.6"'),i$=a(`. If you have multiple different cards, you can list all
of them like so `),Ef=o("code"),u$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),wg=u(),ti=o("p"),c$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),yg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h$=a("it will generate something like "),qf=o("code"),f$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d$=a(` which now you can install
as `),$f=o("code"),m$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_$=a(" locally or on any other machine."),Eg=u(),zt=o("p"),v$=a("Again, remember to ensure to adjust "),kf=o("code"),j$=a("TORCH_CUDA_ARCH_LIST"),g$=a(" to the target architectures."),qg=u(),Ue=o("p"),w$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Pf=o("strong"),y$=a("Compute Capabilities"),b$=a(` (same as arch in this
context) `),jo=o("a"),E$=a("here"),q$=a("."),$g=u(),ai=o("p"),$$=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(wo.$$.fragment),zg=u(),oi=o("p"),P$=a("If the output is:"),Og=u(),f(yo.$$.fragment),Tg=u(),Ot=o("p"),D$=a("then you know that this card\u2019s arch is "),Df=o("code"),z$=a("8.6"),O$=a("."),Ag=u(),Tt=o("p"),T$=a("You can also leave "),zf=o("code"),A$=a("TORCH_CUDA_ARCH_LIST"),S$=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Sg=u(),At=o("p"),C$=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=o("a"),x$=a("Deepspeed"),R$=a(","),Cg=u(),li=o("a"),xg=u(),Ps=o("h3"),St=o("a"),Of=o("span"),f(Eo.$$.fragment),I$=u(),Tf=o("span"),U$=a("Deployment with multiple GPUs"),Rg=u(),Ct=o("p"),G$=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L$=a("Trainer"),M$=a(` command line arguments as
following:`),Ig=u(),xt=o("ol"),Ds=o("li"),Z$=a("replace "),Af=o("code"),N$=a("python -m torch.distributed.launch"),H$=a(" with "),Sf=o("code"),B$=a("deepspeed"),W$=a("."),F$=u(),De=o("li"),V$=a("add a new argument "),Cf=o("code"),Y$=a("--deepspeed ds_config.json"),K$=a(", where "),xf=o("code"),J$=a("ds_config.json"),X$=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q$=a("here"),e4=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s4=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t4=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a4=a("Unlike, "),Rf=o("code"),n4=a("torch.distributed.launch"),o4=a(" where you have to specify how many GPUs to use with "),If=o("code"),l4=a("--nproc_per_node"),r4=a(`, with the
`),Uf=o("code"),p4=a("deepspeed"),i4=a(" launcher you don\u2019t have to use the corresponding "),Gf=o("code"),u4=a("--num_gpus"),c4=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=o("a"),h4=a("here"),f4=a("."),Ng=u(),ne=o("p"),d4=a("In fact, you can continue using "),Lf=o("code"),m4=a("-m torch.distributed.launch"),_4=a(` with DeepSpeed as long as you don\u2019t need to use
`),Mf=o("code"),v4=a("deepspeed"),j4=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Zf=o("code"),g4=a("deepspeed"),w4=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Hg=u(),Rt=o("p"),y4=a("Here is an example of running "),Nf=o("code"),b4=a("run_translation.py"),E4=a(" under DeepSpeed deploying all available GPUs:"),Bg=u(),f(Do.$$.fragment),Wg=u(),It=o("p"),q4=a("Note that in the DeepSpeed documentation you are likely to see "),Hf=o("code"),$4=a("--deepspeed --deepspeed_config ds_config.json"),k4=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Fg=u(),Ut=o("p"),P4=a("For some practical usage examples, please, see this "),zo=o("a"),D4=a("post"),z4=a("."),Vg=u(),ui=o("a"),Yg=u(),zs=o("h3"),Gt=o("a"),Bf=o("span"),f(Oo.$$.fragment),O4=u(),Wf=o("span"),T4=a("Deployment with one GPU"),Kg=u(),Lt=o("p"),A4=a("To deploy DeepSpeed with one GPU adjust the "),ci=o("a"),S4=a("Trainer"),C4=a(" command line arguments as follows:"),Jg=u(),f(To.$$.fragment),Xg=u(),Ge=o("p"),x4=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Ff=o("code"),R4=a("--num_gpus=1"),I4=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=o("a"),U4=a("documentation"),G4=a(" discusses the launcher options."),Qg=u(),hi=o("p"),L4=a("Why would you want to use DeepSpeed with just one GPU?"),ew=u(),Mt=o("ol"),Vf=o("li"),M4=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),Z4=u(),Yf=o("li"),N4=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),sw=u(),fi=o("p"),H4=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),tw=u(),f(So.$$.fragment),aw=u(),di=o("p"),B4=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),nw=u(),Zt=o("p"),W4=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F4=a("post"),V4=a("."),ow=u(),mi=o("p"),Y4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K4=a("Notes:"),rw=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=o("code"),X4=a("CUDA_VISIBLE_DEVICES"),Q4=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e9=u(),f(Ro.$$.fragment),s9=u(),Jf=o("p"),t9=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pw=u(),ji=o("a"),iw=u(),Ts=o("h3"),Nt=o("a"),Xf=o("span"),f(Io.$$.fragment),a9=u(),Qf=o("span"),n9=a("Deployment in Notebooks"),uw=u(),Ht=o("p"),o9=a("The problem with running notebook cells as a script is that there is no normal "),ed=o("code"),l9=a("deepspeed"),r9=a(` launcher to rely on, so
under certain setups we have to emulate it.`),cw=u(),gi=o("p"),p9=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),hw=u(),f(Uo.$$.fragment),fw=u(),Bt=o("p"),i9=a("Note: "),sd=o("code"),u9=a("..."),c9=a(" stands for the normal arguments that you\u2019d pass to the functions."),dw=u(),wi=o("p"),h9=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),mw=u(),yi=o("p"),f9=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),_w=u(),f(Go.$$.fragment),vw=u(),Le=o("p"),d9=a("If the training script is in a normal file and not in the notebook cells, you can launch "),td=o("code"),m9=a("deepspeed"),_9=a(` normally via
shell from a cell. For example, to use `),ad=o("code"),v9=a("run_translation.py"),j9=a(" you would launch it with:"),jw=u(),f(Lo.$$.fragment),gw=u(),Wt=o("p"),g9=a("or with "),nd=o("code"),w9=a("%%bash"),y9=a(" magic, where you can write a multi-line code for the shell program to run:"),ww=u(),f(Mo.$$.fragment),yw=u(),bi=o("p"),b9=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),bw=u(),Ft=o("p"),E9=a("Note: While "),od=o("code"),q9=a("%%bash"),$9=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Ew=u(),Ei=o("a"),qw=u(),As=o("h3"),Vt=o("a"),ld=o("span"),f(Zo.$$.fragment),k9=u(),rd=o("span"),P9=a("Configuration"),$w=u(),Yt=o("p"),D9=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=o("a"),z9=a("following documentation"),O9=a("."),kw=u(),Kt=o("p"),T9=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=o("a"),A9=a(`the DeepSpeedExamples
repo`),S9=a(":"),Pw=u(),f(Bo.$$.fragment),Dw=u(),Jt=o("p"),C9=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),pd=o("code"),x9=a(".json"),R9=a(" files with:"),zw=u(),f(Wo.$$.fragment),Ow=u(),Xt=o("p"),I9=a("Some more examples are to be found in the "),Fo=o("a"),U9=a("main repo"),G9=a(" as well."),Tw=u(),qi=o("p"),L9=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Aw=u(),oe=o("p"),M9=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),id=o("code"),Z9=a("AdamW"),N9=a(" optimizer and "),ud=o("code"),H9=a("WarmupLR"),B9=a(` scheduler and will enable mixed
precision training if `),cd=o("code"),W9=a("--fp16"),F9=a(" is passed:"),Sw=u(),f(Vo.$$.fragment),Cw=u(),Qt=o("p"),V9=a("When you execute the program, DeepSpeed will log the configuration it received from the "),$i=o("a"),Y9=a("Trainer"),K9=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Ss=o("h3"),ea=o("a"),hd=o("span"),f(Yo.$$.fragment),J9=u(),fd=o("span"),X9=a("Passing Configuration"),Iw=u(),G=o("p"),Q9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=o("a"),e8=a("Trainer"),s8=a(" via "),Di=o("a"),t8=a("TrainingArguments"),a8=a(" then for the "),dd=o("code"),n8=a("deepspeed"),o8=a(` argument you can
pass a nested `),md=o("code"),l8=a("dict"),r8=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=o("a"),p8=a("TrainingArguments"),i8=a("."),Uw=u(),Oi=o("p"),u8=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c8=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),Cs=o("h3"),sa=o("a"),_d=o("span"),f(Xo.$$.fragment),h8=u(),vd=o("span"),f8=a("Shared Configuration"),Hw=u(),f(ta.$$.fragment),Bw=u(),Me=o("p"),d8=a("Some configuration values are required by both the "),Si=o("a"),m8=a("Trainer"),_8=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v8=a("Trainer"),j8=a(" command line arguments."),Ww=u(),aa=o("p"),g8=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),w8=a("Trainer"),y8=a(` do the majority
of configuration for you.`),Fw=u(),Ze=o("p"),b8=a("Therefore, in the rest of this guide you will find a special configuration value: "),jd=o("code"),E8=a("auto"),q8=a(`, which when set will be
...
difficult to detect ways. You have been warned.`),Vw=u(),Ii=o("p"),P8=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Yw=u(),na=o("p"),D8=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z8=a("TrainingArguments"),O8=a(" based on that. The steps are:"),Kw=u(),oa=o("ol"),gd=o("li"),T8=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A8=u(),Qo=o("li"),S8=a("Create the "),Gi=o("a"),C8=a("TrainingArguments"),x8=a(" object based on these values"),Jw=u(),le=o("p"),R8=a("Do note that some values, such as "),wd=o("code"),I8=a("scheduler.params.total_num_steps"),U8=a(` are calculated by
`),Li=o("a"),G8=a("Trainer"),L8=a(" during "),yd=o("code"),M8=a("train"),Z8=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),xs=o("h3"),la=o("a"),bd=o("span"),f(el.$$.fragment),N8=u(),Ed=o("span"),H8=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B8=a("Zero Redundancy Optimizer (ZeRO)"),W8=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sy=u(),Ne=o("p"),F8=a("The "),qd=o("code"),V8=a("zero_optimization"),Y8=a(" section of the configuration file is the most important part ("),al=o("a"),K8=a("docs"),J8=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ty=u(),ra=o("p"),X8=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q8=a("Trainer"),ek=a(` provides
no equivalent command line arguments.`),ay=u(),Ni=o("p"),sk=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),ny=u(),Hi=o("a"),oy=u(),Rs=o("h4"),pa=o("a"),$d=o("span"),f(nl.$$.fragment),tk=u(),kd=o("span"),ak=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),nk=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Pd=o("strong"),ok=a("Performance tuning:"),iy=u(),He=o("ul"),Is=o("li"),lk=a("enabling "),Dd=o("code"),rk=a("offload_optimizer"),pk=a(" should reduce GPU RAM usage (it requires "),zd=o("code"),ik=a('"stage": 2'),uk=a(")"),ck=u(),L=o("li"),Od=o("code"),hk=a('"overlap_comm": true'),fk=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Td=o("code"),dk=a("overlap_comm"),mk=a(` uses 4.5x
the `),Ad=o("code"),_k=a("allgather_bucket_size"),vk=a(" and "),Sd=o("code"),jk=a("reduce_bucket_size"),gk=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Cd=o("code"),wk=a("5e8 x 2Bytes x 2 x 4.5"),yk=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),xd=o("code"),bk=a("2e8"),Ek=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),qk=u(),Rd=o("li"),$k=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),uy=u(),Be=o("p"),kk=a("Additionally, "),Id=o("code"),Pk=a("deepspeed==0.4.4"),Dk=a(" added a new option "),Ud=o("code"),zk=a("round_robin_gradients"),Ok=a(" which you can enable with:"),cy=u(),f(ll.$$.fragment),hy=u(),Fi=o("p"),Tk=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fy=u(),Vi=o("a"),dy=u(),Us=o("h4"),ia=o("a"),Gd=o("span"),f(rl.$$.fragment),Ak=u(),Ld=o("span"),Sk=a("ZeRO-3 Config"),my=u(),Yi=o("p"),Ck=a("The following is an example of configuration for ZeRO stage 3:"),_y=u(),f(pl.$$.fragment),vy=u(),K=o("p"),xk=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Md=o("code"),Rk=a('"device": "cpu"'),Ik=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Zd=o("code"),Uk=a("none"),Gk=a(" instead of "),Nd=o("code"),Lk=a("cpu"),Mk=a(" for the "),Hd=o("code"),Zk=a("device"),Nk=a(` entry. Offloading to
NVMe is discussed further down.`),jy=u(),We=o("p"),Hk=a("Pinned memory is enabled with "),Bd=o("code"),Bk=a("pin_memory"),Wk=a(" set to "),Wd=o("code"),Fk=a("true"),Vk=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gy=u(),Ki=o("p"),Fd=o("strong"),Yk=a("Performance tuning:"),wy=u(),ua=o("ul"),il=o("li"),Vd=o("code"),Kk=a("stage3_max_live_parameters"),Jk=a(": "),Yd=o("code"),Xk=a("1e9"),Qk=u(),ul=o("li"),Kd=o("code"),e7=a("stage3_max_reuse_distance"),s7=a(": "),Jd=o("code"),t7=a("1e9"),yy=u(),M=o("p"),a7=a("If hitting OOM reduce "),Xd=o("code"),n7=a("stage3_max_live_parameters"),o7=a(" and "),Qd=o("code"),l7=a("stage3_max_reuse_distance"),r7=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),em=o("code"),p7=a("1e9"),i7=a(` would consume ~2GB. The memory is shared by
`),sm=o("code"),u7=a("stage3_max_live_parameters"),c7=a(" and "),tm=o("code"),h7=a("stage3_max_reuse_distance"),f7=a(", so it\u2019s not additive, it\u2019s just 2GB total."),by=u(),ze=o("p"),am=o("code"),d7=a("stage3_max_live_parameters"),m7=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),nm=o("code"),_7=a("stage3_max_reuse_distance"),v7=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),om=o("code"),j7=a("stage3_max_reuse_distance"),g7=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ey=u(),Ji=o("p"),w7=a("The following configuration values depend on the model\u2019s hidden size:"),qy=u(),Fe=o("ul"),cl=o("li"),lm=o("code"),y7=a("reduce_bucket_size"),b7=a(": "),rm=o("code"),E7=a("hidden_size*hidden_size"),q7=u(),hl=o("li"),pm=o("code"),$7=a("stage3_prefetch_bucket_size"),k7=a(": "),im=o("code"),P7=a("0.9 * hidden_size * hidden_size"),D7=u(),fl=o("li"),um=o("code"),z7=a("stage3_param_persistence_threshold"),O7=a(": "),cm=o("code"),T7=a("10 * hidden_size"),$y=u(),Ve=o("p"),A7=a("therefore set these values to "),hm=o("code"),S7=a("auto"),C7=a(" and the "),Xi=o("a"),x7=a("Trainer"),R7=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),ky=u(),dl=o("p"),fm=o("code"),I7=a("stage3_gather_16bit_weights_on_model_save"),U7=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Py=u(),re=o("p"),G7=a("If you\u2019re migrating from ZeRO-2 configuration note that "),dm=o("code"),L7=a("allgather_partitions"),M7=a(", "),mm=o("code"),Z7=a("allgather_bucket_size"),N7=a(` and
`),_m=o("code"),H7=a("reduce_scatter"),B7=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Dy=u(),Qi=o("ul"),ml=o("li"),vm=o("code"),W7=a("sub_group_size"),F7=a(": "),jm=o("code"),V7=a("1e9"),zy=u(),Oe=o("p"),gm=o("code"),Y7=a("sub_group_size"),K7=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),wm=o("code"),J7=a("sub_group_size"),X7=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),ym=o("code"),Q7=a("sub_group_size"),eP=a(` therefore controls the granularity in which model states are moved in and out of CPU
...
the increased data buffers.`),Ay=u(),eu=o("a"),Sy=u(),Gs=o("h3"),ha=o("a"),km=o("span"),f(jl.$$.fragment),fP=u(),Pm=o("span"),dP=a("NVMe Support"),Cy=u(),su=o("p"),mP=a(`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
...
`),bl=o("a"),TP=a("explained here"),AP=a("."),My=u(),au=o("a"),Zy=u(),Ls=o("h4"),ma=o("a"),Tm=o("span"),f(El.$$.fragment),SP=u(),Am=o("span"),CP=a("ZeRO-2 vs ZeRO-3 Performance"),Ny=u(),nu=o("p"),xP=a(`ZeRO-3 is likely to be slower than ZeRO-2 if everything else is configured the same because the former has to gather
...
these help you to trade scalability for speed depending on your needs.`),Fy=u(),lu=o("a"),Vy=u(),Zs=o("h4"),va=o("a"),Um=o("span"),f($l.$$.fragment),JP=u(),Gm=o("span"),XP=a("ZeRO-2 Example"),Yy=u(),ja=o("p"),QP=a("Here is a full ZeRO-2 auto-configuration file "),Lm=o("code"),eD=a("ds_config_zero2.json"),sD=a(":"),Ky=u(),f(kl.$$.fragment),Jy=u(),ga=o("p"),tD=a(`Here is a full ZeRO-2 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),Mm=o("code"),aD=a("auto"),nD=a(" settings in it."),Xy=u(),f(Pl.$$.fragment),Qy=u(),ru=o("a"),e2=u(),Ns=o("h4"),wa=o("a"),Zm=o("span"),f(Dl.$$.fragment),oD=u(),Nm=o("span"),lD=a("ZeRO-3 Example"),s2=u(),ya=o("p"),rD=a("Here is a full ZeRO-3 auto-configuration file "),Hm=o("code"),pD=a("ds_config_zero3.json"),iD=a(":"),t2=u(),f(zl.$$.fragment),a2=u(),ba=o("p"),uD=a(`Here is a full ZeRO-3 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),Bm=o("code"),cD=a("auto"),hD=a(" settings in it."),n2=u(),f(Ol.$$.fragment),o2=u(),Hs=o("h3"),Ea=o("a"),Wm=o("span"),f(Tl.$$.fragment),fD=u(),Fm=o("span"),dD=a("Optimizer and Scheduler"),l2=u(),qa=o("p"),mD=a("As long as you don\u2019t enable "),Vm=o("code"),_D=a("offload_optimizer"),vD=a(` you can mix and match DeepSpeed and HuggingFace schedulers and
...
GPU implementation (except LAMB).`),i2=u(),iu=o("a"),u2=u(),Bs=o("h4"),ka=o("a"),Km=o("span"),f(Al.$$.fragment),bD=u(),Jm=o("span"),ED=a("Optimizer"),c2=u(),Qe=o("p"),qD=a(`DeepSpeed\u2019s main optimizers are Adam, AdamW, OneBitAdam, and Lamb. These have been thoroughly tested with ZeRO and are
thus recommended to be used. It, however, can import other optimizers from `),Xm=o("code"),$D=a("torch"),kD=a(". The full documentation is "),Sl=o("a"),PD=a("here"),DD=a("."),h2=u(),$=o("p"),zD=a("If you don\u2019t configure the "),Qm=o("code"),OD=a("optimizer"),TD=a(" entry in the configuration file, the "),uu=o("a"),AD=a("Trainer"),SD=a(` will
...
therefore, if you don\u2019t configure the scheduler this is scheduler that will get configured by default.`),z2=u(),O=o("p"),Kz=a("If you don\u2019t configure the "),O_=o("code"),Jz=a("scheduler"),Xz=a(" entry in the configuration file, the "),ju=o("a"),Qz=a("Trainer"),eO=a(` will use
...
instructions on how to disable this automatic conversion if for some reason you prefer not to use it.`),W2=u(),ce=o("p"),fT=a("With the \u{1F917} Trainer you can use "),t1=o("code"),dT=a("--tf32"),mT=a(" to enable it, or disable it with "),a1=o("code"),_T=a("--tf32 0"),vT=a(" or "),n1=o("code"),jT=a("--no_tf32"),gT=a(". By default the PyTorch default is used."),F2=u(),qu=o("a"),V2=u(),Vs=o("h3"),Ia=o("a"),o1=o("span"),f(Kl.$$.fragment),wT=u(),l1=o("span"),yT=a("Automatic Mixed Precision"),Y2=u(),$u=o("p"),bT=a("You can use automatic mixed precision with either a pytorch-like AMP way or the apex-like way:"),K2=u(),Ys=o("h3"),Ua=o("a"),r1=o("span"),f(Jl.$$.fragment),ET=u(),p1=o("span"),qT=a("fp16"),J2=u(),ku=o("p"),$T=a("To configure pytorch AMP-like mode with fp16 (float16) set:"),X2=u(),f(Xl.$$.fragment),Q2=u(),ls=o("p"),kT=a("and the "),Pu=o("a"),PT=a("Trainer"),DT=a(` will automatically enable or disable it based on the value of
...
configuration.`),nb=u(),La=o("p"),LT=a("Here is the "),er=o("a"),MT=a("documentation"),ZT=a("."),ob=u(),Ks=o("h3"),Ma=o("a"),h1=o("span"),f(sr.$$.fragment),NT=u(),f1=o("span"),HT=a("bf16"),lb=u(),Ou=o("p"),BT=a("If bf16 (bfloat16) is desired instead of fp16 then the following configuration section is to be used:"),rb=u(),f(tr.$$.fragment),pb=u(),Tu=o("p"),WT=a("bf16 has the same dynamic range as fp32 and thus doesn\u2019t require loss scaling."),ib=u(),ps=o("p"),FT=a("This mode gets enabled when "),d1=o("code"),VT=a("--bf16"),YT=a(" or "),m1=o("code"),KT=a("--bf16_full_eval"),JT=a(" command line args are passed."),ub=u(),Au=o("p"),XT=a("You can also enable/disable this mode explicitly:"),cb=u(),f(ar.$$.fragment),hb=u(),f(Za.$$.fragment),fb=u(),Js=o("h3"),Na=o("a"),_1=o("span"),f(nr.$$.fragment),QT=u(),v1=o("span"),eA=a("apex"),db=u(),Su=o("p"),sA=a("To configure apex AMP-like mode set:"),mb=u(),f(or.$$.fragment),_b=u(),he=o("p"),tA=a("and the "),Cu=o("a"),aA=a("Trainer"),nA=a(" will automatically configure it based on the values of "),j1=o("code"),oA=a("args.fp16_backend"),lA=a(` and
...
configuration.`),Ob=u(),Zu=o("a"),Tb=u(),Qs=o("h3"),Ya=o("a"),P1=o("span"),f(cr.$$.fragment),IA=u(),D1=o("span"),UA=a("Gradient Accumulation"),Ab=u(),Nu=o("p"),GA=a("To configure gradient accumulation set:"),Sb=u(),f(hr.$$.fragment),Cb=u(),is=o("p"),LA=a("and the "),Hu=o("a"),MA=a("Trainer"),ZA=a(" will automatically set it to the value of "),z1=o("code"),NA=a("args.gradient_accumulation_steps"),HA=a("."),xb=u(),Bu=o("p"),BA=a("You can also set the value explicitly:"),Rb=u(),f(fr.$$.fragment),Ib=u(),Ka=o("p"),WA=a("But then you\u2019re on your own synchronizing the "),Wu=o("a"),FA=a("Trainer"),VA=a(` command line arguments and the DeepSpeed
configuration.`),Ub=u(),Fu=o("a"),Gb=u(),et=o("h3"),Ja=o("a"),O1=o("span"),f(dr.$$.fragment),YA=u(),T1=o("span"),KA=a("Gradient Clipping"),Lb=u(),Vu=o("p"),JA=a("To configure gradient gradient clipping set:"),Mb=u(),f(mr.$$.fragment),Zb=u(),us=o("p"),XA=a("and the "),Yu=o("a"),QA=a("Trainer"),eS=a(" will automatically set it to the value of "),A1=o("code"),sS=a("args.max_grad_norm"),tS=a("."),Nb=u(),Ku=o("p"),aS=a("You can also set the value explicitly:"),Hb=u(),f(_r.$$.fragment),Bb=u(),Xa=o("p"),nS=a("But then you\u2019re on your own synchronizing the "),Ju=o("a"),oS=a("Trainer"),lS=a(` command line arguments and the DeepSpeed
configuration.`),Wb=u(),Xu=o("a"),Fb=u(),st=o("h3"),Qa=o("a"),S1=o("span"),f(vr.$$.fragment),rS=u(),C1=o("span"),pS=a("Getting The Model Weights Out"),Vb=u(),en=o("p"),iS=a(`As long as you continue training and resuming using DeepSpeed you don\u2019t need to worry about anything. DeepSpeed stores
...
example will contain `),av=o("code"),hC=a("global_step1"),fC=a("."),y3=u(),rc=o("p"),dC=a("Note: currently the script requires 2x general RAM of the final fp32 model weights."),b3=u(),tt=o("h3"),pn=o("a"),nv=o("span"),f(kr.$$.fragment),mC=u(),ov=o("span"),_C=a("ZeRO-3 and Infinity Nuances"),E3=u(),pc=o("p"),vC=a("ZeRO-3 is quite different from ZeRO-2 because of its param sharding feature."),q3=u(),ic=o("p"),jC=a("ZeRO-Infinity further extends ZeRO-3 to support NVMe memory and multiple other speed and scalability improvements."),$3=u(),uc=o("p"),gC=a(`While all the efforts were made for things to just work without needing any special changes to your models, in certain
circumstances you may find the following information to be needed.`),k3=u(),at=o("h4"),un=o("a"),lv=o("span"),f(Pr.$$.fragment),wC=u(),rv=o("span"),yC=a("Constructing Massive Models"),P3=u(),cn=o("p"),bC=a(`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
a starting point.`),nR=u(),Cv=o("li"),xv=o("p"),oR=a("Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),lR=u(),Rv=o("li"),Fr=o("p"),rR=a("If possible try to use one of the existing "),Vr=o("a"),pR=a("examples"),iR=a(" to reproduce the problem with."),f0=u(),xc=o("p"),uR=a("Things to consider:"),d0=u(),bn=o("ul"),pt=o("li"),Iv=o("p"),cR=a("Deepspeed is often not the cause of the problem."),hR=u(),Uv=o("p"),fR=a(`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
ZeRO-3. Here is how you can `),ep=o("a"),xR=a("estimate how much memory is needed for a specific model"),RR=a("."),j0=u(),ct=o("h4"),$n=o("a"),Yv=o("span"),f(sp.$$.fragment),IR=u(),Rc=o("span"),UR=a("training and/or eval/predict loss is "),Kv=o("code"),GR=a("NaN"),g0=u(),Ic=o("p"),LR=a("This often happens when one takes a model pre-trained in bf16 mixed precision mode and tries to use it under fp16 (with or without mixed precision). Most models trained on TPU and often the ones released by Google are in this category (e.g. almost all t5-based models). Here the solution is to either use fp32 or bf16 if your hardware supports it (TPU, Ampere GPUs or newer)."),w0=u(),Uc=o("p"),MR=a("The other problem may have to do with using fp16. When you configure this section:"),y0=u(),f(tp.$$.fragment),b0=u(),kn=o("p"),ZR=a("and you see in your log that Deepspeed reports "),Jv=o("code"),NR=a("OVERFLOW!"),HR=a(" as follows:"),E0=u(),f(ap.$$.fragment),q0=u(),Gc=o("p"),BR=a("that means that the Deepspeed loss scaler can\u2019t figure out a scaling co-efficient that overcomes loss overflow."),$0=u(),Lc=o("p"),WR=a("(the log was massaged to be more readable here.)"),k0=u(),ms=o("p"),FR=a("In this case you usually need to raise the value of "),Xv=o("code"),VR=a("initial_scale_power"),YR=a(". Setting it to "),Qv=o("code"),KR=a('"initial_scale_power": 32'),JR=a(" will typically resolve the problem."),P0=u(),ht=o("h3"),Pn=o("a"),ej=o("span"),f(np.$$.fragment),XR=u(),sj=o("span"),QR=a("Notes"),D0=u(),_s=o("ul"),Dn=o("li"),eI=a("DeepSpeed works with the PyTorch "),Mc=o("a"),sI=a("Trainer"),tI=a(" but not TF "),tj=o("code"),aI=a("TFTrainer"),nI=u(),op=o("li"),oI=a("While DeepSpeed has a pip installable PyPI package, it is highly recommended that it gets installed from "),lp=o("a"),lI=a("source"),rI=a(` to best match your hardware and also if you need to enable
certain features, like 1-bit Adam, which aren\u2019t available in the pypi distribution.`),pI=u(),ft=o("li"),iI=a("You don\u2019t have to use the "),Zc=o("a"),uI=a("Trainer"),cI=a(` to use DeepSpeed with \u{1F917} Transformers - you can use any model
with your own trainer, and you will have to adapt the latter according to `),rp=o("a"),hI=a("the DeepSpeed integration instructions"),fI=a("."),z0=u(),Nc=o("a"),O0=u(),dt=o("h2"),zn=o("a"),aj=o("span"),f(pp.$$.fragment),dI=u(),nj=o("span"),mI=a("Non-Trainer Deepspeed Integration"),T0=u(),de=o("p"),_I=a("The "),Hc=o("a"),vI=a("HfDeepSpeedConfig"),jI=a(` is used to integrate Deepspeed into the \u{1F917} Transformers core
...
the DeepSpeed configuration is not modified in any way.`),uU=u(),js=o("div"),f(dp.$$.fragment),cU=u(),_j=o("p"),hU=a("Deletes a sub-section of the config file if it\u2019s found."),fU=u(),_t=o("p"),dU=a("Unless "),vj=o("code"),mU=a("must_exist"),_U=a(" is "),jj=o("code"),vU=a("True"),jU=a(" the section doesn\u2019t have to exist."),gU=u(),Sn=o("div"),f(mp.$$.fragment),wU=u(),_p=o("p"),yU=a("Returns the set value or "),gj=o("code"),bU=a("default"),EU=a(" if no value is set"),qU=u(),Cn=o("div"),f(vp.$$.fragment),$U=u(),vt=o("p"),kU=a("Returns "),wj=o("code"),PU=a("True"),DU=a("/"),yj=o("code"),zU=a("False` only if the value is set, always `False` otherwise. So use this method to ask the very specific question of whether the value is set to `False` (and it's not set to `True"),OU=a(" or isn\u2019t set)."),TU=u(),xn=o("div"),f(jp.$$.fragment),AU=u(),jt=o("p"),SU=a("Returns "),bj=o("code"),CU=a("True"),xU=a("/"),Ej=o("code"),RU=a("False` only if the value is set, always `False` otherwise. So use this method to ask the very specific question of whether the value is set to `True` (and it's not set to `False"),IU=a(" or isn\u2019t set)."),Z0=u(),gt=o("h3"),Rn=o("a"),qj=o("span"),f(gp.$$.fragment),UU=u(),$j=o("span"),GU=a("Custom DeepSpeed ZeRO Inference"),N0=u(),In=o("p"),LU=a("Here is an example of how one could do DeepSpeed ZeRO Inference without using "),eh=o("a"),MU=a("Trainer"),ZU=a(" when one can\u2019t fit a model onto a single GPU. The solution includes using additional GPUs or/and offloading GPU memory to CPU memory."),H0=u(),sh=o("p"),NU=a("The important nuance to understand here is that the way ZeRO is designed you can process different inputs on different GPUs in parallel."),B0=u(),th=o("p"),HU=a("The example has copious notes and is self-documenting."),W0=u(),ah=o("p"),BU=a("Make sure to:"),F0=u(),Un=o("ol"),kj=o("li"),WU=a("disable CPU offload if you have enough GPU memory (since it slows things down)"),FU=u(),Pj=o("li"),VU=a("enable bf16 if you own an Ampere or a newer GPU to make things faster. If you don\u2019t have that hardware you may enable fp16 as long as you don\u2019t use any model that was pre-trained in bf16 mixed precision (such as most t5 models). These usually overflow in fp16 and you will see garbage as output."),V0=u(),f(wp.$$.fragment),Y0=u(),Gn=o("p"),YU=a("Let\u2019s save it as "),Dj=o("code"),KU=a("t0.py"),JU=a(" and run it:"),K0=u(),f(yp.$$.fragment),J0=u(),nh=o("p"),XU=a("This was a very basic example and you will want to adapt it to your needs."),X0=u(),wt=o("h2"),Ln=o("a"),zj=o("span"),f(bp.$$.fragment),QU=u(),Oj=o("span"),eG=a("Main DeepSpeed Resources"),Q0=u(),ve=o("ul"),Tj=o("li"),Ep=o("a"),sG=a("Project\u2019s github"),tG=u(),Aj=o("li"),qp=o("a"),aG=a("Usage docs"),nG=u(),Sj=o("li"),$p=o("a"),oG=a("API docs"),lG=u(),Cj=o("li"),kp=o("a"),rG=a("Blog posts"),eE=u(),oh=o("p"),pG=a("Papers:"),sE=u(),gs=o("ul"),xj=o("li"),Pp=o("a"),iG=a("ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),uG=u(),Rj=o("li"),Dp=o("a"),cG=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),hG=u(),Ij=o("li"),zp=o("a"),fG=a("ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),tE=u(),ws=o("p"),dG=a("Finally, please, remember that, HuggingFace "),lh=o("a"),mG=a("Trainer"),_G=a(` only integrates DeepSpeed, therefore if you
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),vG=a("DeepSpeed GitHub"),jG=a("."),this.h()},l(e){const p=MK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Uj=r(k);ee=l(Uj,"SPAN",{});var Gj=r(ee);d(z.$$.fragment,Gj),Gj.forEach(t),Uj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var $G=r(se);R=n($G,"DeepSpeed Integration"),$G.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Lj=r(S);E=l(Lj,"A",{href:!0,rel:!0});var kG=r(E);q=n(kG,"DeepSpeed"),kG.forEach(t),Es=n(Lj," implements everything described in the "),V=l(Lj,"A",{href:!0,rel:!0});var PG=r(V);qs=n(PG,"ZeRO paper"),PG.forEach(t),L6=n(Lj,". Currently it provides full support for:"),Lj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);sf=l(je,"LI",{});var DG=r(sf);M6=n(DG,"Optimizer state partitioning (ZeRO stage 1)"),DG.forEach(t),Z6=c(je),tf=l(je,"LI",{});var zG=r(tf);N6=n(zG,"Gradient partitioning (ZeRO stage 2)"),zG.forEach(t),H6=c(je),af=l(je,"LI",{});var OG=r(af);B6=n(OG,"Parameter partitioning (ZeRO stage 3)"),OG.forEach(t),W6=c(je),nf=l(je,"LI",{});var TG=r(nf);F6=n(TG,"Custom mixed precision training handling"),TG.forEach(t),V6=c(je),of=l(je,"LI",{});var AG=r(of);Y6=n(AG,"A range of fast CUDA-extension-based optimizers"),AG.forEach(t),K6=c(je),lf=l(je,"LI",{});var SG=r(lf);J6=n(SG,"ZeRO-Offload to CPU and NVMe"),SG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X6=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var CG=r(ao);Q6=n(CG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),CG.forEach(t),e5=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var xG=r(no);s5=n(xG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),xG.forEach(t),t5=n(rh,"."),rh.forEach(t),Fj=c(e),Up=l(e,"P",{});var RG=r(Up);a5=n(RG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),RG.forEach(t),Vj=c(e),Gp=l(e,"P",{});var IG=r(Gp);n5=n(IG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),IG.forEach(t),Yj=c(e),Et=l(e,"P",{});var nE=r(Et);o5=n(nE,"\u{1F917} Transformers integrates "),oo=l(nE,"A",{href:!0,rel:!0});var UG=r(oo);l5=n(UG,"DeepSpeed"),UG.forEach(t),r5=n(nE," via 2 options:"),nE.forEach(t),Kj=c(e),qt=l(e,"OL",{});var oE=r(qt);lo=l(oE,"LI",{});var lE=r(lo);p5=n(lE,"Integration of the core DeepSpeed features via "),Lp=l(lE,"A",{href:!0});var GG=r(Lp);i5=n(GG,"Trainer"),GG.forEach(t),u5=n(lE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),lE.forEach(t),c5=c(oE),Y=l(oE,"LI",{});var ge=r(Y);h5=n(ge,"If you don\u2019t use "),Mp=l(ge,"A",{href:!0});var LG=r(Mp);f5=n(LG,"Trainer"),LG.forEach(t),d5=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),rf=l(ge,"CODE",{});var MG=r(rf);m5=n(MG,"from_pretrained"),MG.forEach(t),_5=n(ge," and "),pf=l(ge,"CODE",{});var ZG=r(pf);v5=n(ZG,"from_config"),ZG.forEach(t),j5=n(ge,` include integration of essential
parts of DeepSpeed like `),uf=l(ge,"CODE",{});var NG=r(uf);g5=n(NG,"zero.Init"),NG.forEach(t),w5=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=l(ge,"A",{href:!0});var HG=r(Zp);y5=n(HG,"deepspeed-non-trainer-integration"),HG.forEach(t),b5=n(ge,"."),ge.forEach(t),oE.forEach(t),Jj=c(e),Np=l(e,"P",{});var BG=r(Np);E5=n(BG,"What is integrated:"),BG.forEach(t),Xj=c(e),Hp=l(e,"P",{});var WG=r(Hp);q5=n(WG,"Training:"),WG.forEach(t),Qj=c(e),Bp=l(e,"OL",{});var FG=r(Bp);cf=l(FG,"LI",{});var VG=r(cf);$5=n(VG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),VG.forEach(t),FG.forEach(t),eg=c(e),Wp=l(e,"P",{});var YG=r(Wp);k5=n(YG,"Inference:"),YG.forEach(t),sg=c(e),Fp=l(e,"OL",{});var KG=r(Fp);ro=l(KG,"LI",{});var rE=r(ro);P5=n(rE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=l(rE,"A",{href:!0});var JG=r(Vp);D5=n(JG,"deepspeed-zero-inference"),JG.forEach(t),z5=n(rE,"."),rE.forEach(t),KG.forEach(t),tg=c(e),Yp=l(e,"P",{});var XG=r(Yp);O5=n(XG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),XG.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),$s=l(e,"H2",{class:!0});var pE=r($s);$t=l(pE,"A",{id:!0,class:!0,href:!0});var QG=r($t);hf=l(QG,"SPAN",{});var eL=r(hf);d(po.$$.fragment,eL),eL.forEach(t),QG.forEach(t),T5=c(pE),ff=l(pE,"SPAN",{});var sL=r(ff);A5=n(sL,"Trainer Deepspeed Integration"),sL.forEach(t),pE.forEach(t),og=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),lg=c(e),ks=l(e,"H3",{class:!0});var iE=r(ks);kt=l(iE,"A",{id:!0,class:!0,href:!0});var tL=r(kt);df=l(tL,"SPAN",{});var aL=r(df);d(io.$$.fragment,aL),aL.forEach(t),tL.forEach(t),S5=c(iE),mf=l(iE,"SPAN",{});var nL=r(mf);C5=n(nL,"Installation"),nL.forEach(t),iE.forEach(t),rg=c(e),Xp=l(e,"P",{});var oL=r(Xp);x5=n(oL,"Install the library via pypi:"),oL.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),Ce=l(e,"P",{});var ph=r(Ce);R5=n(ph,"or via "),_f=l(ph,"CODE",{});var lL=r(_f);I5=n(lL,"transformers"),lL.forEach(t),U5=n(ph,"\u2019 "),vf=l(ph,"CODE",{});var rL=r(vf);G5=n(rL,"extras"),rL.forEach(t),L5=n(ph,":"),ph.forEach(t),ug=c(e),d(co.$$.fragment,e),cg=c(e),xe=l(e,"P",{});var ih=r(xe);M5=n(ih,"or find more details on "),ho=l(ih,"A",{href:!0,rel:!0});var pL=r(ho);Z5=n(pL,"the DeepSpeed\u2019s GitHub page"),pL.forEach(t),N5=n(ih,` and
`),fo=l(ih,"A",{href:!0,rel:!0});var iL=r(fo);H5=n(iL,"advanced install"),iL.forEach(t),B5=n(ih,"."),ih.forEach(t),hg=c(e),Pt=l(e,"P",{});var uE=r(Pt);W5=n(uE,"If you\u2019re still struggling with the build, first make sure to read "),Qp=l(uE,"A",{href:!0});var uL=r(Qp);F5=n(uL,"zero-install-notes"),uL.forEach(t),V5=n(uE,"."),uE.forEach(t),fg=c(e),ei=l(e,"P",{});var cL=r(ei);Y5=n(cL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),cL.forEach(t),dg=c(e),si=l(e,"P",{});var hL=r(si);K5=n(hL,"To make a local build for DeepSpeed:"),hL.forEach(t),mg=c(e),d(mo.$$.fragment,e),_g=c(e),Re=l(e,"P",{});var uh=r(Re);J5=n(uh,"If you intend to use NVMe offload you will also need to include "),jf=l(uh,"CODE",{});var fL=r(jf);X5=n(fL,"DS_BUILD_AIO=1"),fL.forEach(t),Q5=n(uh,` in the instructions above (and also
install `),gf=l(uh,"EM",{});var dL=r(gf);e$=n(dL,"libaio-dev"),dL.forEach(t),s$=n(uh," system-wide)."),uh.forEach(t),vg=c(e),Dt=l(e,"P",{});var cE=r(Dt);t$=n(cE,"Edit "),wf=l(cE,"CODE",{});var mL=r(wf);a$=n(mL,"TORCH_CUDA_ARCH_LIST"),mL.forEach(t),n$=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),cE.forEach(t),jg=c(e),d(_o.$$.fragment,e),gg=c(e),Pe=l(e,"P",{});var Ap=r(Pe);o$=n(Ap,"So if you get "),yf=l(Ap,"CODE",{});var _L=r(yf);l$=n(_L,"8, 6"),_L.forEach(t),r$=n(Ap,", then use "),bf=l(Ap,"CODE",{});var vL=r(bf);p$=n(vL,'TORCH_CUDA_ARCH_LIST="8.6"'),vL.forEach(t),i$=n(Ap,`. If you have multiple different cards, you can list all
of them like so `),Ef=l(Ap,"CODE",{});var jL=r(Ef);u$=n(jL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),jL.forEach(t),Ap.forEach(t),wg=c(e),ti=l(e,"P",{});var gL=r(ti);c$=n(gL,"If you need to use the same setup on multiple machines, make a binary wheel:"),gL.forEach(t),yg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h$=n(ch,"it will generate something like "),qf=l(ch,"CODE",{});var wL=r(qf);f$=n(wL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wL.forEach(t),d$=n(ch,` which now you can install
as `),$f=l(ch,"CODE",{});var yL=r($f);m$=n(yL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),yL.forEach(t),_$=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),zt=l(e,"P",{});var hE=r(zt);v$=n(hE,"Again, remember to ensure to adjust "),kf=l(hE,"CODE",{});var bL=r(kf);j$=n(bL,"TORCH_CUDA_ARCH_LIST"),bL.forEach(t),g$=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);w$=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Pf=l(hh,"STRONG",{});var EL=r(Pf);y$=n(EL,"Compute Capabilities"),EL.forEach(t),b$=n(hh,` (same as arch in this
context) `),jo=l(hh,"A",{href:!0,rel:!0});var qL=r(jo);E$=n(qL,"here"),qL.forEach(t),q$=n(hh,"."),hh.forEach(t),$g=c(e),ai=l(e,"P",{});var $L=r(ai);$$=n($L,"You can check the archs pytorch was built with using:"),$L.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var kL=r(ni);k$=n(kL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),kL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),oi=l(e,"P",{});var PL=r(oi);P$=n(PL,"If the output is:"),PL.forEach(t),Og=c(e),d(yo.$$.fragment,e),Tg=c(e),Ot=l(e,"P",{});var fE=r(Ot);D$=n(fE,"then you know that this card\u2019s arch is "),Df=l(fE,"CODE",{});var DL=r(Df);z$=n(DL,"8.6"),DL.forEach(t),O$=n(fE,"."),fE.forEach(t),Ag=c(e),Tt=l(e,"P",{});var dE=r(Tt);T$=n(dE,"You can also leave "),zf=l(dE,"CODE",{});var zL=r(zf);A$=n(zL,"TORCH_CUDA_ARCH_LIST"),zL.forEach(t),S$=n(dE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),dE.forEach(t),Sg=c(e),At=l(e,"P",{});var mE=r(At);C$=n(mE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=l(mE,"A",{href:!0,rel:!0});var OL=r(bo);x$=n(OL,"Deepspeed"),OL.forEach(t),R$=n(mE,","),mE.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Ps=l(e,"H3",{class:!0});var _E=r(Ps);St=l(_E,"A",{id:!0,class:!0,href:!0});var TL=r(St);Of=l(TL,"SPAN",{});var AL=r(Of);d(Eo.$$.fragment,AL),AL.forEach(t),TL.forEach(t),I$=c(_E),Tf=l(_E,"SPAN",{});var SL=r(Tf);U$=n(SL,"Deployment with multiple GPUs"),SL.forEach(t),_E.forEach(t),Rg=c(e),Ct=l(e,"P",{});var vE=r(Ct);G$=n(vE,"To deploy this feature with multiple GPUs adjust the "),ri=l(vE,"A",{href:!0});var CL=r(ri);L$=n(CL,"Trainer"),CL.forEach(t),M$=n(vE,` command line arguments as
following:`),vE.forEach(t),Ig=c(e),xt=l(e,"OL",{});var jE=r(xt);Ds=l(jE,"LI",{});var fh=r(Ds);Z$=n(fh,"replace "),Af=l(fh,"CODE",{});var xL=r(Af);N$=n(xL,"python -m torch.distributed.launch"),xL.forEach(t),H$=n(fh," with "),Sf=l(fh,"CODE",{});var RL=r(Sf);B$=n(RL,"deepspeed"),RL.forEach(t),W$=n(fh,"."),fh.forEach(t),F$=c(jE),De=l(jE,"LI",{});var Mn=r(De);V$=n(Mn,"add a new argument "),Cf=l(Mn,"CODE",{});var IL=r(Cf);Y$=n(IL,"--deepspeed ds_config.json"),IL.forEach(t),K$=n(Mn,", where "),xf=l(Mn,"CODE",{});var UL=r(xf);J$=n(UL,"ds_config.json"),UL.forEach(t),X$=n(Mn,` is the DeepSpeed configuration file as
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var GL=r(qo);Q$=n(GL,"here"),GL.forEach(t),e4=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var LL=r(pi);s4=n(LL,"Therefore, if your original command line looked as follows:"),LL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ML=r(ii);t4=n(ML,"Now it should be:"),ML.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var we=r(U);a4=n(we,"Unlike, "),Rf=l(we,"CODE",{});var ZL=r(Rf);n4=n(ZL,"torch.distributed.launch"),ZL.forEach(t),o4=n(we," where you have to specify how many GPUs to use with "),If=l(we,"CODE",{});var NL=r(If);l4=n(NL,"--nproc_per_node"),NL.forEach(t),r4=n(we,`, with the
`),Uf=l(we,"CODE",{});var HL=r(Uf);p4=n(HL,"deepspeed"),HL.forEach(t),i4=n(we," launcher you don\u2019t have to use the corresponding "),Gf=l(we,"CODE",{});var BL=r(Gf);u4=n(BL,"--num_gpus"),BL.forEach(t),c4=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(we,"A",{href:!0,rel:!0});var WL=r(Po);h4=n(WL,"here"),WL.forEach(t),f4=n(we,"."),we.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d4=n(Zn,"In fact, you can continue using "),Lf=l(Zn,"CODE",{});var FL=r(Lf);m4=n(FL,"-m torch.distributed.launch"),FL.forEach(t),_4=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
`),Mf=l(Zn,"CODE",{});var VL=r(Mf);v4=n(VL,"deepspeed"),VL.forEach(t),j4=n(Zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Zf=l(Zn,"CODE",{});var YL=r(Zf);g4=n(YL,"deepspeed"),YL.forEach(t),w4=n(Zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zn.forEach(t),Hg=c(e),Rt=l(e,"P",{});var gE=r(Rt);y4=n(gE,"Here is an example of running "),Nf=l(gE,"CODE",{});var KL=r(Nf);b4=n(KL,"run_translation.py"),KL.forEach(t),E4=n(gE," under DeepSpeed deploying all available GPUs:"),gE.forEach(t),Bg=c(e),d(Do.$$.fragment,e),Wg=c(e),It=l(e,"P",{});var wE=r(It);q4=n(wE,"Note that in the DeepSpeed documentation you are likely to see "),Hf=l(wE,"CODE",{});var JL=r(Hf);$4=n(JL,"--deepspeed --deepspeed_config ds_config.json"),JL.forEach(t),k4=n(wE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),wE.forEach(t),Fg=c(e),Ut=l(e,"P",{});var yE=r(Ut);P4=n(yE,"For some practical usage examples, please, see this "),zo=l(yE,"A",{href:!0,rel:!0});var XL=r(zo);D4=n(XL,"post"),XL.forEach(t),z4=n(yE,"."),yE.forEach(t),Vg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Yg=c(e),zs=l(e,"H3",{class:!0});var bE=r(zs);Gt=l(bE,"A",{id:!0,class:!0,href:!0});var QL=r(Gt);Bf=l(QL,"SPAN",{});var eM=r(Bf);d(Oo.$$.fragment,eM),eM.forEach(t),QL.forEach(t),O4=c(bE),Wf=l(bE,"SPAN",{});var sM=r(Wf);T4=n(sM,"Deployment with one GPU"),sM.forEach(t),bE.forEach(t),Kg=c(e),Lt=l(e,"P",{});var EE=r(Lt);A4=n(EE,"To deploy DeepSpeed with one GPU adjust the "),ci=l(EE,"A",{href:!0});var tM=r(ci);S4=n(tM,"Trainer"),tM.forEach(t),C4=n(EE," command line arguments as follows:"),EE.forEach(t),Jg=c(e),d(To.$$.fragment,e),Xg=c(e),Ge=l(e,"P",{});var dh=r(Ge);x4=n(dh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Ff=l(dh,"CODE",{});var aM=r(Ff);R4=n(aM,"--num_gpus=1"),aM.forEach(t),I4=n(dh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=l(dh,"A",{href:!0,rel:!0});var nM=r(Ao);U4=n(nM,"documentation"),nM.forEach(t),G4=n(dh," discusses the launcher options."),dh.forEach(t),Qg=c(e),hi=l(e,"P",{});var oM=r(hi);L4=n(oM,"Why would you want to use DeepSpeed with just one GPU?"),oM.forEach(t),ew=c(e),Mt=l(e,"OL",{});var qE=r(Mt);Vf=l(qE,"LI",{});var lM=r(Vf);M4=n(lM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),lM.forEach(t),Z4=c(qE),Yf=l(qE,"LI",{});var rM=r(Yf);N4=n(rM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),rM.forEach(t),qE.forEach(t),sw=c(e),fi=l(e,"P",{});var pM=r(fi);H4=n(pM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),pM.forEach(t),tw=c(e),d(So.$$.fragment,e),aw=c(e),di=l(e,"P",{});var iM=r(di);B4=n(iM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),iM.forEach(t),nw=c(e),Zt=l(e,"P",{});var $E=r(Zt);W4=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var uM=r(Co);F4=n(uM,"post"),uM.forEach(t),V4=n($E,"."),$E.forEach(t),ow=c(e),mi=l(e,"P",{});var cM=r(mi);Y4=n(cM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),cM.forEach(t),lw=c(e),_i=l(e,"P",{});var hM=r(_i);K4=n(hM,"Notes:"),hM.forEach(t),rw=c(e),vi=l(e,"UL",{});var fM=r(vi);Os=l(fM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J4=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=l(kE,"CODE",{});var dM=r(Kf);X4=n(dM,"CUDA_VISIBLE_DEVICES"),dM.forEach(t),Q4=n(kE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e9=c(mh),d(Ro.$$.fragment,mh),s9=c(mh),Jf=l(mh,"P",{});var mM=r(Jf);t9=n(mM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),mM.forEach(t),mh.forEach(t),fM.forEach(t),pw=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iw=c(e),Ts=l(e,"H3",{class:!0});var PE=r(Ts);Nt=l(PE,"A",{id:!0,class:!0,href:!0});var _M=r(Nt);Xf=l(_M,"SPAN",{});var vM=r(Xf);d(Io.$$.fragment,vM),vM.forEach(t),_M.forEach(t),a9=c(PE),Qf=l(PE,"SPAN",{});var jM=r(Qf);n9=n(jM,"Deployment in Notebooks"),jM.forEach(t),PE.forEach(t),uw=c(e),Ht=l(e,"P",{});var DE=r(Ht);o9=n(DE,"The problem with running notebook cells as a script is that there is no normal "),ed=l(DE,"CODE",{});var gM=r(ed);l9=n(gM,"deepspeed"),gM.forEach(t),r9=n(DE,` launcher to rely on, so
under certain setups we have to emulate it.`),DE.forEach(t),cw=c(e),gi=l(e,"P",{});var wM=r(gi);p9=n(wM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),wM.forEach(t),hw=c(e),d(Uo.$$.fragment,e),fw=c(e),Bt=l(e,"P",{});var zE=r(Bt);i9=n(zE,"Note: "),sd=l(zE,"CODE",{});var yM=r(sd);u9=n(yM,"..."),yM.forEach(t),c9=n(zE," stands for the normal arguments that you\u2019d pass to the functions."),zE.forEach(t),dw=c(e),wi=l(e,"P",{});var bM=r(wi);h9=n(bM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),bM.forEach(t),mw=c(e),yi=l(e,"P",{});var EM=r(yi);f9=n(EM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),EM.forEach(t),_w=c(e),d(Go.$$.fragment,e),vw=c(e),Le=l(e,"P",{});var _h=r(Le);d9=n(_h,"If the training script is in a normal file and not in the notebook cells, you can launch "),td=l(_h,"CODE",{});var qM=r(td);m9=n(qM,"deepspeed"),qM.forEach(t),_9=n(_h,` normally via
shell from a cell. For example, to use `),ad=l(_h,"CODE",{});var $M=r(ad);v9=n($M,"run_translation.py"),$M.forEach(t),j9=n(_h," you would launch it with:"),_h.forEach(t),jw=c(e),d(Lo.$$.fragment,e),gw=c(e),Wt=l(e,"P",{});var OE=r(Wt);g9=n(OE,"or with "),nd=l(OE,"CODE",{});var kM=r(nd);w9=n(kM,"%%bash"),kM.forEach(t),y9=n(OE," magic, where you can write a multi-line code for the shell program to run:"),OE.forEach(t),ww=c(e),d(Mo.$$.fragment,e),yw=c(e),bi=l(e,"P",{});var PM=r(bi);b9=n(PM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),PM.forEach(t),bw=c(e),Ft=l(e,"P",{});var TE=r(Ft);E9=n(TE,"Note: While "),od=l(TE,"CODE",{});var DM=r(od);q9=n(DM,"%%bash"),DM.forEach(t),$9=n(TE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),TE.forEach(t),Ew=c(e),Ei=l(e,"A",{id:!0}),r(Ei).forEach(t),qw=c(e),As=l(e,"H3",{class:!0});var AE=r(As);Vt=l(AE,"A",{id:!0,class:!0,href:!0});var zM=r(Vt);ld=l(zM,"SPAN",{});var OM=r(ld);d(Zo.$$.fragment,OM),OM.forEach(t),zM.forEach(t),k9=c(AE),rd=l(AE,"SPAN",{});var TM=r(rd);P9=n(TM,"Configuration"),TM.forEach(t),AE.forEach(t),$w=c(e),Yt=l(e,"P",{});var SE=r(Yt);D9=n(SE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=l(SE,"A",{href:!0,rel:!0});var AM=r(No);z9=n(AM,"following documentation"),AM.forEach(t),O9=n(SE,"."),SE.forEach(t),kw=c(e),Kt=l(e,"P",{});var CE=r(Kt);T9=n(CE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=l(CE,"A",{href:!0,rel:!0});var SM=r(Ho);A9=n(SM,`the DeepSpeedExamples
repo`),SM.forEach(t),S9=n(CE,":"),CE.forEach(t),Pw=c(e),d(Bo.$$.fragment,e),Dw=c(e),Jt=l(e,"P",{});var xE=r(Jt);C9=n(xE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),pd=l(xE,"CODE",{});var CM=r(pd);x9=n(CM,".json"),CM.forEach(t),R9=n(xE," files with:"),xE.forEach(t),zw=c(e),d(Wo.$$.fragment,e),Ow=c(e),Xt=l(e,"P",{});var RE=r(Xt);I9=n(RE,"Some more examples are to be found in the "),Fo=l(RE,"A",{href:!0,rel:!0});var xM=r(Fo);U9=n(xM,"main repo"),xM.forEach(t),G9=n(RE," as well."),RE.forEach(t),Tw=c(e),qi=l(e,"P",{});var RM=r(qi);L9=n(RM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),RM.forEach(t),Aw=c(e),oe=l(e,"P",{});var Nn=r(oe);M9=n(Nn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),id=l(Nn,"CODE",{});var IM=r(id);Z9=n(IM,"AdamW"),IM.forEach(t),N9=n(Nn," optimizer and "),ud=l(Nn,"CODE",{});var UM=r(ud);H9=n(UM,"WarmupLR"),UM.forEach(t),B9=n(Nn,` scheduler and will enable mixed
precision training if `),cd=l(Nn,"CODE",{});var GM=r(cd);W9=n(GM,"--fp16"),GM.forEach(t),F9=n(Nn," is passed:"),Nn.forEach(t),Sw=c(e),d(Vo.$$.fragment,e),Cw=c(e),Qt=l(e,"P",{});var IE=r(Qt);V9=n(IE,"When you execute the program, DeepSpeed will log the configuration it received from the "),$i=l(IE,"A",{href:!0});var LM=r($i);Y9=n(LM,"Trainer"),LM.forEach(t),K9=n(IE,`
to the console, so you can see exactly what was the final configuration passed to it.`),IE.forEach(t),xw=c(e),ki=l(e,"A",{id:!0}),r(ki).forEach(t),Rw=c(e),Ss=l(e,"H3",{class:!0});var UE=r(Ss);ea=l(UE,"A",{id:!0,class:!0,href:!0});var MM=r(ea);hd=l(MM,"SPAN",{});var ZM=r(hd);d(Yo.$$.fragment,ZM),ZM.forEach(t),MM.forEach(t),J9=c(UE),fd=l(UE,"SPAN",{});var NM=r(fd);X9=n(NM,"Passing Configuration"),NM.forEach(t),UE.forEach(t),Iw=c(e),G=l(e,"P",{});var ye=r(G);Q9=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(ye,"A",{href:!0});var HM=r(Pi);e8=n(HM,"Trainer"),HM.forEach(t),s8=n(ye," via "),Di=l(ye,"A",{href:!0});var BM=r(Di);t8=n(BM,"TrainingArguments"),BM.forEach(t),a8=n(ye," then for the "),dd=l(ye,"CODE",{});var WM=r(dd);n8=n(WM,"deepspeed"),WM.forEach(t),o8=n(ye,` argument you can
pass a nested `),md=l(ye,"CODE",{});var FM=r(md);l8=n(FM,"dict"),FM.forEach(t),r8=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(ye,"A",{href:!0});var VM=r(zi);p8=n(VM,"TrainingArguments"),VM.forEach(t),i8=n(ye,"."),ye.forEach(t),Uw=c(e),Oi=l(e,"P",{});var YM=r(Oi);u8=n(YM,"To summarize you can do:"),YM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"P",{});var KM=r(Ti);c8=n(KM,"or:"),KM.forEach(t),Mw=c(e),d(Jo.$$.fragment,e),Zw=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Nw=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);sa=l(GE,"A",{id:!0,class:!0,href:!0});var JM=r(sa);_d=l(JM,"SPAN",{});var XM=r(_d);d(Xo.$$.fragment,XM),XM.forEach(t),JM.forEach(t),h8=c(GE),vd=l(GE,"SPAN",{});var QM=r(vd);f8=n(QM,"Shared Configuration"),QM.forEach(t),GE.forEach(t),Hw=c(e),d(ta.$$.fragment,e),Bw=c(e),Me=l(e,"P",{});var vh=r(Me);d8=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var eZ=r(Si);m8=n(eZ,"Trainer"),eZ.forEach(t),_8=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var sZ=r(Ci);v8=n(sZ,"Trainer"),sZ.forEach(t),j8=n(vh," command line arguments."),vh.forEach(t),Ww=c(e),aa=l(e,"P",{});var LE=r(aa);g8=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var tZ=r(xi);w8=n(tZ,"Trainer"),tZ.forEach(t),y8=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fw=c(e),Ze=l(e,"P",{});var jh=r(Ze);b8=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),jd=l(jh,"CODE",{});var aZ=r(jd);E8=n(aZ,"auto"),aZ.forEach(t),q8=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ri=l(jh,"A",{href:!0});var nZ=r(Ri);$8=n(nZ,"Trainer"),nZ.forEach(t),k8=n(jh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vw=c(e),Ii=l(e,"P",{});var oZ=r(Ii);P8=n(oZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),oZ.forEach(t),Yw=c(e),na=l(e,"P",{});var ME=r(na);D8=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var lZ=r(Ui);z8=n(lZ,"TrainingArguments"),lZ.forEach(t),O8=n(ME," based on that. The steps are:"),ME.forEach(t),Kw=c(e),oa=l(e,"OL",{});var ZE=r(oa);gd=l(ZE,"LI",{});var rZ=r(gd);T8=n(rZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),rZ.forEach(t),A8=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S8=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var pZ=r(Gi);C8=n(pZ,"TrainingArguments"),pZ.forEach(t),x8=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jw=c(e),le=l(e,"P",{});var Hn=r(le);R8=n(Hn,"Do note that some values, such as "),wd=l(Hn,"CODE",{});var iZ=r(wd);I8=n(iZ,"scheduler.params.total_num_steps"),iZ.forEach(t),U8=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var uZ=r(Li);G8=n(uZ,"Trainer"),uZ.forEach(t),L8=n(Hn," during "),yd=l(Hn,"CODE",{});var cZ=r(yd);M8=n(cZ,"train"),cZ.forEach(t),Z8=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qw=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);la=l(HE,"A",{id:!0,class:!0,href:!0});var hZ=r(la);bd=l(hZ,"SPAN",{});var fZ=r(bd);d(el.$$.fragment,fZ),fZ.forEach(t),hZ.forEach(t),N8=c(HE),Ed=l(HE,"SPAN",{});var dZ=r(Ed);H8=n(dZ,"ZeRO"),dZ.forEach(t),HE.forEach(t),ey=c(e),sl=l(e,"P",{});var gG=r(sl);tl=l(gG,"A",{href:!0,rel:!0});var mZ=r(tl);B8=n(mZ,"Zero Redundancy Optimizer (ZeRO)"),mZ.forEach(t),W8=n(gG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),gG.forEach(t),sy=c(e),Ne=l(e,"P",{});var gh=r(Ne);F8=n(gh,"The "),qd=l(gh,"CODE",{});var _Z=r(qd);V8=n(_Z,"zero_optimization"),_Z.forEach(t),Y8=n(gh," section of the configuration file is the most important part ("),al=l(gh,"A",{href:!0,rel:!0});var vZ=r(al);K8=n(vZ,"docs"),vZ.forEach(t),J8=n(gh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),ty=c(e),ra=l(e,"P",{});var BE=r(ra);X8=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var jZ=r(Zi);Q8=n(jZ,"Trainer"),jZ.forEach(t),ek=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),ay=c(e),Ni=l(e,"P",{});var gZ=r(Ni);sk=n(gZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),gZ.forEach(t),ny=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),oy=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);pa=l(WE,"A",{id:!0,class:!0,href:!0});var wZ=r(pa);$d=l(wZ,"SPAN",{});var yZ=r($d);d(nl.$$.fragment,yZ),yZ.forEach(t),wZ.forEach(t),tk=c(WE),kd=l(WE,"SPAN",{});var bZ=r(kd);ak=n(bZ,"ZeRO-2 Config"),bZ.forEach(t),WE.forEach(t),ly=c(e),Bi=l(e,"P",{});var EZ=r(Bi);nk=n(EZ,"The following is an example of configuration for ZeRO stage 2:"),EZ.forEach(t),ry=c(e),d(ol.$$.fragment,e),py=c(e),Wi=l(e,"P",{});var qZ=r(Wi);Pd=l(qZ,"STRONG",{});var $Z=r(Pd);ok=n($Z,"Performance tuning:"),$Z.forEach(t),qZ.forEach(t),iy=c(e),He=l(e,"UL",{});var wh=r(He);Is=l(wh,"LI",{});var yh=r(Is);lk=n(yh,"enabling "),Dd=l(yh,"CODE",{});var kZ=r(Dd);rk=n(kZ,"offload_optimizer"),kZ.forEach(t),pk=n(yh," should reduce GPU RAM usage (it requires "),zd=l(yh,"CODE",{});var PZ=r(zd);ik=n(PZ,'"stage": 2'),PZ.forEach(t),uk=n(yh,")"),yh.forEach(t),ck=c(wh),L=l(wh,"LI",{});var te=r(L);Od=l(te,"CODE",{});var DZ=r(Od);hk=n(DZ,'"overlap_comm": true'),DZ.forEach(t),fk=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Td=l(te,"CODE",{});var zZ=r(Td);dk=n(zZ,"overlap_comm"),zZ.forEach(t),mk=n(te,` uses 4.5x
the `),Ad=l(te,"CODE",{});var OZ=r(Ad);_k=n(OZ,"allgather_bucket_size"),OZ.forEach(t),vk=n(te," and "),Sd=l(te,"CODE",{});var TZ=r(Sd);jk=n(TZ,"reduce_bucket_size"),TZ.forEach(t),gk=n(te,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Cd=l(te,"CODE",{});var AZ=r(Cd);wk=n(AZ,"5e8 x 2Bytes x 2 x 4.5"),AZ.forEach(t),yk=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),xd=l(te,"CODE",{});var SZ=r(xd);bk=n(SZ,"2e8"),SZ.forEach(t),Ek=n(te,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),qk=c(wh),Rd=l(wh,"LI",{});var CZ=r(Rd);$k=n(CZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),CZ.forEach(t),wh.forEach(t),uy=c(e),Be=l(e,"P",{});var bh=r(Be);kk=n(bh,"Additionally, "),Id=l(bh,"CODE",{});var xZ=r(Id);Pk=n(xZ,"deepspeed==0.4.4"),xZ.forEach(t),Dk=n(bh," added a new option "),Ud=l(bh,"CODE",{});var RZ=r(Ud);zk=n(RZ,"round_robin_gradients"),RZ.forEach(t),Ok=n(bh," which you can enable with:"),bh.forEach(t),cy=c(e),d(ll.$$.fragment,e),hy=c(e),Fi=l(e,"P",{});var IZ=r(Fi);Tk=n(IZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),IZ.forEach(t),fy=c(e),Vi=l(e,"A",{id:!0}),r(Vi).forEach(t),dy=c(e),Us=l(e,"H4",{class:!0});var FE=r(Us);ia=l(FE,"A",{id:!0,class:!0,href:!0});var UZ=r(ia);Gd=l(UZ,"SPAN",{});var GZ=r(Gd);d(rl.$$.fragment,GZ),GZ.forEach(t),UZ.forEach(t),Ak=c(FE),Ld=l(FE,"SPAN",{});var LZ=r(Ld);Sk=n(LZ,"ZeRO-3 Config"),LZ.forEach(t),FE.forEach(t),my=c(e),Yi=l(e,"P",{});var MZ=r(Yi);Ck=n(MZ,"The following is an example of configuration for ZeRO stage 3:"),MZ.forEach(t),_y=c(e),d(pl.$$.fragment,e),vy=c(e),K=l(e,"P",{});var ys=r(K);xk=n(ys,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Md=l(ys,"CODE",{});var ZZ=r(Md);Rk=n(ZZ,'"device": "cpu"'),ZZ.forEach(t),Ik=n(ys,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Zd=l(ys,"CODE",{});var NZ=r(Zd);Uk=n(NZ,"none"),NZ.forEach(t),Gk=n(ys," instead of "),Nd=l(ys,"CODE",{});var HZ=r(Nd);Lk=n(HZ,"cpu"),HZ.forEach(t),Mk=n(ys," for the "),Hd=l(ys,"CODE",{});var BZ=r(Hd);Zk=n(BZ,"device"),BZ.forEach(t),Nk=n(ys,` entry. Offloading to
NVMe is discussed further down.`),ys.forEach(t),jy=c(e),We=l(e,"P",{});var Eh=r(We);Hk=n(Eh,"Pinned memory is enabled with "),Bd=l(Eh,"CODE",{});var WZ=r(Bd);Bk=n(WZ,"pin_memory"),WZ.forEach(t),Wk=n(Eh," set to "),Wd=l(Eh,"CODE",{});var FZ=r(Wd);Fk=n(FZ,"true"),FZ.forEach(t),Vk=n(Eh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Eh.forEach(t),gy=c(e),Ki=l(e,"P",{});var VZ=r(Ki);Fd=l(VZ,"STRONG",{});var YZ=r(Fd);Yk=n(YZ,"Performance tuning:"),YZ.forEach(t),VZ.forEach(t),wy=c(e),ua=l(e,"UL",{});var VE=r(ua);il=l(VE,"LI",{});var YE=r(il);Vd=l(YE,"CODE",{});var KZ=r(Vd);Kk=n(KZ,"stage3_max_live_parameters"),KZ.forEach(t),Jk=n(YE,": "),Yd=l(YE,"CODE",{});var JZ=r(Yd);Xk=n(JZ,"1e9"),JZ.forEach(t),YE.forEach(t),Qk=c(VE),ul=l(VE,"LI",{});var KE=r(ul);Kd=l(KE,"CODE",{});var XZ=r(Kd);e7=n(XZ,"stage3_max_reuse_distance"),XZ.forEach(t),s7=n(KE,": "),Jd=l(KE,"CODE",{});var QZ=r(Jd);t7=n(QZ,"1e9"),QZ.forEach(t),KE.forEach(t),VE.forEach(t),yy=c(e),M=l(e,"P",{});var be=r(M);a7=n(be,"If hitting OOM reduce "),Xd=l(be,"CODE",{});var eN=r(Xd);n7=n(eN,"stage3_max_live_parameters"),eN.forEach(t),o7=n(be," and "),Qd=l(be,"CODE",{});var sN=r(Qd);l7=n(sN,"stage3_max_reuse_distance"),sN.forEach(t),r7=n(be,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),em=l(be,"CODE",{});var tN=r(em);p7=n(tN,"1e9"),tN.forEach(t),i7=n(be,` would consume ~2GB. The memory is shared by
`),sm=l(be,"CODE",{});var aN=r(sm);u7=n(aN,"stage3_max_live_parameters"),aN.forEach(t),c7=n(be," and "),tm=l(be,"CODE",{});var nN=r(tm);h7=n(nN,"stage3_max_reuse_distance"),nN.forEach(t),f7=n(be,", so it\u2019s not additive, it\u2019s just 2GB total."),be.forEach(t),by=c(e),ze=l(e,"P",{});var Sp=r(ze);am=l(Sp,"CODE",{});var oN=r(am);d7=n(oN,"stage3_max_live_parameters"),oN.forEach(t),m7=n(Sp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),nm=l(Sp,"CODE",{});var lN=r(nm);_7=n(lN,"stage3_max_reuse_distance"),lN.forEach(t),v7=n(Sp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),om=l(Sp,"CODE",{});var rN=r(om);j7=n(rN,"stage3_max_reuse_distance"),rN.forEach(t),g7=n(Sp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Sp.forEach(t),Ey=c(e),Ji=l(e,"P",{});var pN=r(Ji);w7=n(pN,"The following configuration values depend on the model\u2019s hidden size:"),pN.forEach(t),qy=c(e),Fe=l(e,"UL",{});var qh=r(Fe);cl=l(qh,"LI",{});var JE=r(cl);lm=l(JE,"CODE",{});var iN=r(lm);y7=n(iN,"reduce_bucket_size"),iN.forEach(t),b7=n(JE,": "),rm=l(JE,"CODE",{});var uN=r(rm);E7=n(uN,"hidden_size*hidden_size"),uN.forEach(t),JE.forEach(t),q7=c(qh),hl=l(qh,"LI",{});var XE=r(hl);pm=l(XE,"CODE",{});var cN=r(pm);$7=n(cN,"stage3_prefetch_bucket_size"),cN.forEach(t),k7=n(XE,": "),im=l(XE,"CODE",{});var hN=r(im);P7=n(hN,"0.9 * hidden_size * hidden_size"),hN.forEach(t),XE.forEach(t),D7=c(qh),fl=l(qh,"LI",{});var QE=r(fl);um=l(QE,"CODE",{});var fN=r(um);z7=n(fN,"stage3_param_persistence_threshold"),fN.forEach(t),O7=n(QE,": "),cm=l(QE,"CODE",{});var dN=r(cm);T7=n(dN,"10 * hidden_size"),dN.forEach(t),QE.forEach(t),qh.forEach(t),$y=c(e),Ve=l(e,"P",{});var $h=r(Ve);A7=n($h,"therefore set these values to "),hm=l($h,"CODE",{});var mN=r(hm);S7=n(mN,"auto"),mN.forEach(t),C7=n($h," and the "),Xi=l($h,"A",{href:!0});var _N=r(Xi);x7=n(_N,"Trainer"),_N.forEach(t),R7=n($h,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),$h.forEach(t),ky=c(e),dl=l(e,"P",{});var wG=r(dl);fm=l(wG,"CODE",{});var vN=r(fm);I7=n(vN,"stage3_gather_16bit_weights_on_model_save"),vN.forEach(t),U7=n(wG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),wG.forEach(t),Py=c(e),re=l(e,"P",{});var Bn=r(re);G7=n(Bn,"If you\u2019re migrating from ZeRO-2 configuration note that "),dm=l(Bn,"CODE",{});var jN=r(dm);L7=n(jN,"allgather_partitions"),jN.forEach(t),M7=n(Bn,", "),mm=l(Bn,"CODE",{});var gN=r(mm);Z7=n(gN,"allgather_bucket_size"),gN.forEach(t),N7=n(Bn,` and
`),_m=l(Bn,"CODE",{});var wN=r(_m);H7=n(wN,"reduce_scatter"),wN.forEach(t),B7=n(Bn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Bn.forEach(t),Dy=c(e),Qi=l(e,"UL",{});var yN=r(Qi);ml=l(yN,"LI",{});var eq=r(ml);vm=l(eq,"CODE",{});var bN=r(vm);W7=n(bN,"sub_group_size"),bN.forEach(t),F7=n(eq,": "),jm=l(eq,"CODE",{});var EN=r(jm);V7=n(EN,"1e9"),EN.forEach(t),eq.forEach(t),yN.forEach(t),zy=c(e),Oe=l(e,"P",{});var Cp=r(Oe);gm=l(Cp,"CODE",{});var qN=r(gm);Y7=n(qN,"sub_group_size"),qN.forEach(t),K7=n(Cp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),wm=l(Cp,"CODE",{});var $N=r(wm);J7=n($N,"sub_group_size"),$N.forEach(t),X7=n(Cp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),ym=l(Cp,"CODE",{});var kN=r(ym);Q7=n(kN,"sub_group_size"),kN.forEach(t),eP=n(Cp,` therefore controls the granularity in which model states are moved in and out of CPU
...
`),fv=l(W,"CODE",{});var FF=r(fv);GC=n(FF,"from_pretrained"),FF.forEach(t),LC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),T3=c(e),d(zr.$$.fragment,e),A3=c(e),hn=l(e,"P",{});var o6=r(hn);MC=n(o6,"If you\u2019re using the official example scripts and your command line arguments include "),dv=l(o6,"CODE",{});var VF=r(dv);ZC=n(VF,"--deepspeed ds_config.json"),VF.forEach(t),NC=n(o6,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o6.forEach(t),S3=c(e),dc=l(e,"P",{});var YF=r(dc);HC=n(YF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),YF.forEach(t),C3=c(e),fn=l(e,"P",{});var l6=r(fn);BC=n(l6,"For full details on this method and other related features please refer to "),Or=l(l6,"A",{href:!0,rel:!0});var KF=r(Or);WC=n(KF,"Constructing Massive Models"),KF.forEach(t),FC=n(l6,"."),l6.forEach(t),x3=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),mv=l(Jn,"CODE",{});var JF=r(mv);YC=n(JF,"from_pretrained"),JF.forEach(t),KC=n(Jn,` to use
`),_v=l(Jn,"CODE",{});var XF=r(_v);JC=n(XF,"torch_dtype=torch.float16"),XF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var QF=r(mc);QC=n(QF,"from_pretrained-torch-dtype"),QF.forEach(t),ex=n(Jn,"."),Jn.forEach(t),R3=c(e),nt=l(e,"H4",{class:!0});var r6=r(nt);dn=l(r6,"A",{id:!0,class:!0,href:!0});var eV=r(dn);vv=l(eV,"SPAN",{});var sV=r(vv);d(Tr.$$.fragment,sV),sV.forEach(t),eV.forEach(t),sx=c(r6),jv=l(r6,"SPAN",{});var tV=r(jv);tx=n(tV,"Gathering Parameters"),tV.forEach(t),r6.forEach(t),I3=c(e),Ar=l(e,"P",{});var bG=r(Ar);ax=n(bG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(bG,"A",{href:!0,rel:!0});var aV=r(Sr);nx=n(aV,"Gathering Parameters"),aV.forEach(t),bG.forEach(t),U3=c(e),mn=l(e,"P",{});var p6=r(mn);ox=n(p6,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),gv=l(p6,"CODE",{});var nV=r(gv);lx=n(nV,"from_pretrained"),nV.forEach(t),rx=n(p6,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),Nh.forEach(t),Z3=c(e),vc=l(e,"A",{id:!0}),r(vc).forEach(t),N3=c(e),ot=l(e,"H3",{class:!0});var i6=r(ot);_n=l(i6,"A",{id:!0,class:!0,href:!0});var pV=r(_n);bv=l(pV,"SPAN",{});var iV=r(bv);d(xr.$$.fragment,iV),iV.forEach(t),pV.forEach(t),dx=c(i6),Ev=l(i6,"SPAN",{});var uV=r(Ev);mx=n(uV,"ZeRO Inference"),uV.forEach(t),i6.forEach(t),H3=c(e),jc=l(e,"P",{});var cV=r(jc);_x=n(cV,`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),cV.forEach(t),B3=c(e),vn=l(e,"P",{});var u6=r(vn);vx=n(u6,"Otherwise you just need to pass the usual "),gc=l(u6,"A",{href:!0});var hV=r(gc);jx=n(hV,"TrainingArguments"),hV.forEach(t),gx=n(u6," arguments. For example:"),u6.forEach(t),W3=c(e),d(Rr.$$.fragment,e),F3=c(e),wc=l(e,"P",{});var fV=r(wc);wx=n(fV,`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),fV.forEach(t),V3=c(e),jn=l(e,"P",{});var c6=r(jn);yx=n(c6,"Here is an example of running "),qv=l(c6,"CODE",{});var dV=r(qv);bx=n(dV,"run_translation.py"),dV.forEach(t),Ex=n(c6," under DeepSpeed deploying all available GPUs:"),c6.forEach(t),Y3=c(e),d(Ir.$$.fragment,e),K3=c(e),yc=l(e,"P",{});var mV=r(yc);qx=n(mV,`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
...
dump the `),Cc=l(Xn,"A",{href:!0});var UV=r(Cc);Yx=n(UV,"TrainingArguments"),UV.forEach(t),Kx=n(Xn," as it has dozens of entries that are irrelevant."),Xn.forEach(t),xV.forEach(t),Jx=c($e),Nr=l($e,"LI",{});var m6=r(Nr);Av=l(m6,"P",{});var GV=r(Av);Xx=n(GV,"Output of:"),GV.forEach(t),Qx=c(m6),d(Hr.$$.fragment,m6),m6.forEach(t),eR=c($e),Sv=l($e,"LI",{});var LV=r(Sv);Br=l(LV,"P",{});var _6=r(Br);sR=n(_6,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Wr=l(_6,"A",{href:!0,rel:!0});var MV=r(Wr);tR=n(MV,"notebook"),MV.forEach(t),aR=n(_6,` as
a starting point.`),_6.forEach(t),LV.forEach(t),nR=c($e),Cv=l($e,"LI",{});var ZV=r(Cv);xv=l(ZV,"P",{});var NV=r(xv);oR=n(NV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),NV.forEach(t),ZV.forEach(t),lR=c($e),Rv=l($e,"LI",{});var HV=r(Rv);Fr=l(HV,"P",{});var v6=r(Fr);rR=n(v6,"If possible try to use one of the existing "),Vr=l(v6,"A",{href:!0,rel:!0});var BV=r(Vr);pR=n(BV,"examples"),BV.forEach(t),iR=n(v6," to reproduce the problem with."),v6.forEach(t),HV.forEach(t),$e.forEach(t),f0=c(e),xc=l(e,"P",{});var WV=r(xc);uR=n(WV,"Things to consider:"),WV.forEach(t),d0=c(e),bn=l(e,"UL",{});var j6=r(bn);pt=l(j6,"LI",{});var Hh=r(pt);Iv=l(Hh,"P",{});var FV=r(Iv);cR=n(FV,"Deepspeed is often not the cause of the problem."),FV.forEach(t),hR=c(Hh),Uv=l(Hh,"P",{});var VV=r(Uv);fR=n(VV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),YV.forEach(t),Hh.forEach(t),_R=c(j6),Lv=l(j6,"LI",{});var KV=r(Lv);Yr=l(KV,"P",{});var g6=r(Yr);vR=n(g6,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Kr=l(g6,"A",{href:!0,rel:!0});var JV=r(Kr);jR=n(JV,"Deepspeed"),JV.forEach(t),gR=n(g6,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g6.forEach(t),KV.forEach(t),j6.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var w6=r(it);En=l(w6,"A",{id:!0,class:!0,href:!0});var XV=r(En);Mv=l(XV,"SPAN",{});var QV=r(Mv);d(Jr.$$.fragment,QV),QV.forEach(t),XV.forEach(t),wR=c(w6),Zv=l(w6,"SPAN",{});var eY=r(Zv);yR=n(eY,"Troubleshooting"),eY.forEach(t),w6.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var y6=r(ut);qn=l(y6,"A",{id:!0,class:!0,href:!0});var sY=r(qn);Nv=l(sY,"SPAN",{});var tY=r(Nv);d(Xr.$$.fragment,tY),tY.forEach(t),sY.forEach(t),bR=c(y6),Qr=l(y6,"SPAN",{});var b6=r(Qr);ER=n(b6,"the "),Hv=l(b6,"CODE",{});var aY=r(Hv);qR=n(aY,"deepspeed"),aY.forEach(t),$R=n(b6," process gets killed at startup without a traceback"),b6.forEach(t),y6.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Bv=l(ke,"CODE",{});var nY=r(Bv);PR=n(nY,"deepspeed"),nY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
...
it\u2019s important that this object remains alive while the program is still running.`),so.forEach(t),sU=c(F),_e=l(F,"P",{});var yt=r(_e);Xc=l(yt,"A",{href:!0});var YY=r(Xc);tU=n(YY,"Trainer"),YY.forEach(t),aU=n(yt," uses the "),dj=l(yt,"CODE",{});var KY=r(dj);nU=n(KY,"HfTrainerDeepSpeedConfig"),KY.forEach(t),oU=n(yt,` subclass instead. That subclass has logic to sync the configuration
with values of `),Qc=l(yt,"A",{href:!0});var JY=r(Qc);lU=n(JY,"TrainingArguments"),JY.forEach(t),rU=n(yt," by replacing special placeholder values: "),mj=l(yt,"CODE",{});var XY=r(mj);pU=n(XY,'"auto"'),XY.forEach(t),iU=n(yt,`. Without this special logic
the DeepSpeed configuration is not modified in any way.`),yt.forEach(t),uU=c(F),js=l(F,"DIV",{class:!0});var Yh=r(js);d(dp.$$.fragment,Yh),cU=c(Yh),_j=l(Yh,"P",{});var QY=r(_j);hU=n(QY,"Deletes a sub-section of the config file if it\u2019s found."),QY.forEach(t),fU=c(Yh),_t=l(Yh,"P",{});var Kh=r(_t);dU=n(Kh,"Unless "),vj=l(Kh,"CODE",{});var eK=r(vj);mU=n(eK,"must_exist"),eK.forEach(t),_U=n(Kh," is "),jj=l(Kh,"CODE",{});var sK=r(jj);vU=n(sK,"True"),sK.forEach(t),jU=n(Kh," the section doesn\u2019t have to exist."),Kh.forEach(t),Yh.forEach(t),gU=c(F),Sn=l(F,"DIV",{class:!0});var T6=r(Sn);d(mp.$$.fragment,T6),wU=c(T6),_p=l(T6,"P",{});var A6=r(_p);yU=n(A6,"Returns the set value or "),gj=l(A6,"CODE",{});var tK=r(gj);bU=n(tK,"default"),tK.forEach(t),EU=n(A6," if no value is set"),A6.forEach(t),T6.forEach(t),qU=c(F),Cn=l(F,"DIV",{class:!0});var S6=r(Cn);d(vp.$$.fragment,S6),$U=c(S6),vt=l(S6,"P",{});var Jh=r(vt);kU=n(Jh,"Returns "),wj=l(Jh,"CODE",{});var aK=r(wj);PU=n(aK,"True"),aK.forEach(t),DU=n(Jh,"/"),yj=l(Jh,"CODE",{});var nK=r(yj);zU=n(nK,"False` only if the value is set, always `False` otherwise. So use this method to ask the very specific question of whether the value is set to `False` (and it's not set to `True"),nK.forEach(t),OU=n(Jh," or isn\u2019t set)."),Jh.forEach(t),S6.forEach(t),TU=c(F),xn=l(F,"DIV",{class:!0});var C6=r(xn);d(jp.$$.fragment,C6),AU=c(C6),jt=l(C6,"P",{});var Xh=r(jt);SU=n(Xh,"Returns "),bj=l(Xh,"CODE",{});var oK=r(bj);CU=n(oK,"True"),oK.forEach(t),xU=n(Xh,"/"),Ej=l(Xh,"CODE",{});var lK=r(Ej);RU=n(lK,"False` only if the value is set, always `False` otherwise. So use this method to ask the very specific question of whether the value is set to `True` (and it's not set to `False"),lK.forEach(t),IU=n(Xh," or isn\u2019t set)."),Xh.forEach(t),C6.forEach(t),F.forEach(t),Z0=c(e),gt=l(e,"H3",{class:!0});var x6=r(gt);Rn=l(x6,"A",{id:!0,class:!0,href:!0});var rK=r(Rn);qj=l(rK,"SPAN",{});var pK=r(qj);d(gp.$$.fragment,pK),pK.forEach(t),rK.forEach(t),UU=c(x6),$j=l(x6,"SPAN",{});var iK=r($j);GU=n(iK,"Custom DeepSpeed ZeRO Inference"),iK.forEach(t),x6.forEach(t),N0=c(e),In=l(e,"P",{});var R6=r(In);LU=n(R6,"Here is an example of how one could do DeepSpeed ZeRO Inference without using "),eh=l(R6,"A",{href:!0});var uK=r(eh);MU=n(uK,"Trainer"),uK.forEach(t),ZU=n(R6," when one can\u2019t fit a model onto a single GPU. The solution includes using additional GPUs or/and offloading GPU memory to CPU memory."),R6.forEach(t),H0=c(e),sh=l(e,"P",{});var cK=r(sh);NU=n(cK,"The important nuance to understand here is that the way ZeRO is designed you can process different inputs on different GPUs in parallel."),cK.forEach(t),B0=c(e),th=l(e,"P",{});var hK=r(th);HU=n(hK,"The example has copious notes and is self-documenting."),hK.forEach(t),W0=c(e),ah=l(e,"P",{});var fK=r(ah);BU=n(fK,"Make sure to:"),fK.forEach(t),F0=c(e),Un=l(e,"OL",{});var I6=r(Un);kj=l(I6,"LI",{});var dK=r(kj);WU=n(dK,"disable CPU offload if you have enough GPU memory (since it slows things down)"),dK.forEach(t),FU=c(I6),Pj=l(I6,"LI",{});var mK=r(Pj);VU=n(mK,"enable bf16 if you own an Ampere or a newer GPU to make things faster. If you don\u2019t have that hardware you may enable fp16 as long as you don\u2019t use any model that was pre-trained in bf16 mixed precision (such as most t5 models). These usually overflow in fp16 and you will see garbage as output."),mK.forEach(t),I6.forEach(t),V0=c(e),d(wp.$$.fragment,e),Y0=c(e),Gn=l(e,"P",{});var U6=r(Gn);YU=n(U6,"Let\u2019s save it as "),Dj=l(U6,"CODE",{});var _K=r(Dj);KU=n(_K,"t0.py"),_K.forEach(t),JU=n(U6," and run it:"),U6.forEach(t),K0=c(e),d(yp.$$.fragment,e),J0=c(e),nh=l(e,"P",{});var vK=r(nh);XU=n(vK,"This was a very basic example and you will want to adapt it to your needs."),vK.forEach(t),X0=c(e),wt=l(e,"H2",{class:!0});var G6=r(wt);Ln=l(G6,"A",{id:!0,class:!0,href:!0});var jK=r(Ln);zj=l(jK,"SPAN",{});var gK=r(zj);d(bp.$$.fragment,gK),gK.forEach(t),jK.forEach(t),QU=c(G6),Oj=l(G6,"SPAN",{});var wK=r(Oj);eG=n(wK,"Main DeepSpeed Resources"),wK.forEach(t),G6.forEach(t),Q0=c(e),ve=l(e,"UL",{});var to=r(ve);Tj=l(to,"LI",{});var yK=r(Tj);Ep=l(yK,"A",{href:!0,rel:!0});var bK=r(Ep);sG=n(bK,"Project\u2019s github"),bK.forEach(t),yK.forEach(t),tG=c(to),Aj=l(to,"LI",{});var EK=r(Aj);qp=l(EK,"A",{href:!0,rel:!0});var qK=r(qp);aG=n(qK,"Usage docs"),qK.forEach(t),EK.forEach(t),nG=c(to),Sj=l(to,"LI",{});var $K=r(Sj);$p=l($K,"A",{href:!0,rel:!0});var kK=r($p);oG=n(kK,"API docs"),kK.forEach(t),$K.forEach(t),lG=c(to),Cj=l(to,"LI",{});var PK=r(Cj);kp=l(PK,"A",{href:!0,rel:!0});var DK=r(kp);rG=n(DK,"Blog posts"),DK.forEach(t),PK.forEach(t),to.forEach(t),eE=c(e),oh=l(e,"P",{});var zK=r(oh);pG=n(zK,"Papers:"),zK.forEach(t),sE=c(e),gs=l(e,"UL",{});var Qh=r(gs);xj=l(Qh,"LI",{});var OK=r(xj);Pp=l(OK,"A",{href:!0,rel:!0});var TK=r(Pp);iG=n(TK,"ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),TK.forEach(t),OK.forEach(t),uG=c(Qh),Rj=l(Qh,"LI",{});var AK=r(Rj);Dp=l(AK,"A",{href:!0,rel:!0});var SK=r(Dp);cG=n(SK,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),SK.forEach(t),AK.forEach(t),hG=c(Qh),Ij=l(Qh,"LI",{});var CK=r(Ij);zp=l(CK,"A",{href:!0,rel:!0});var xK=r(zp);fG=n(xK,"ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),xK.forEach(t),CK.forEach(t),Qh.forEach(t),tE=c(e),ws=l(e,"P",{});var ef=r(ws);dG=n(ef,"Finally, please, remember that, HuggingFace "),lh=l(ef,"A",{href:!0});var RK=r(lh);mG=n(RK,"Trainer"),RK.forEach(t),_G=n(ef,` only integrates DeepSpeed, therefore if you
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=l(ef,"A",{href:!0,rel:!0});var IK=r(Op);vG=n(IK,"DeepSpeed GitHub"),IK.forEach(t),jG=n(ef,"."),ef.forEach(t),this.h()},h(){h(y,"name","hf:doc:metadata"),h(y,"content",JSON.stringify(FK)),h(k,"id","deepspeed-integration"),h(k,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(k,"href","#deepspeed-integration"),h(b,"class","relative group"),h(E,"href","https://github.com/microsoft/DeepSpeed"),h(E,"rel","nofollow"),h(V,"href","https://arxiv.org/abs/1910.02054"),h(V,"rel","nofollow"),h(ao,"href","https://arxiv.org/abs/2101.06840"),h(ao,"rel","nofollow"),h(no,"href","https://arxiv.org/abs/2104.07857"),h(no,"rel","nofollow"),h(oo,"href","https://github.com/microsoft/DeepSpeed"),h(oo,"rel","nofollow"),h(Lp,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Mp,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Zp,"href","#deepspeed-non-trainer-integration"),h(Vp,"href","#deepspeed-zero-inference"),h(Kp,"id","deepspeed-trainer-integration"),h($t,"id","trainer-deepspeed-integration"),h($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h($t,"href","#trainer-deepspeed-integration"),h($s,"class","relative group"),h(Jp,"id","deepspeed-installation"),h(kt,"id","installation"),h(kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(kt,"href","#installation"),h(ks,"class","relative group"),h(ho,"href","https://github.com/microsoft/deepspeed#installation"),h(ho,"rel","nofollow"),h(fo,"href","https://www.deepspeed.ai/tutorials/advanced-install/"),h(fo,"rel","nofollow"),h(Qp,"href","#zero-install-notes"),h(jo,"href","https://developer.nvidia.com/cuda-gpus"),h(jo,"rel","nofollow"),h(bo,"href","https://github.com/microsoft/DeepSpeed/issues"),h(bo,"rel","nofollow"),h(li,"id","deepspeed-multi-gpu"),h(St,"id","deployment-with-multiple-gpus"),h(St,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(St,"href","#deployment-with-multiple-gpus"),h(Ps,"class","relative group"),h(ri,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(qo,"href","https://www.deepspeed.ai/docs/config-json/"),h(qo,"rel","nofollow"),h(Po,"href","https://www.deepspeed.ai/getting-started/#resource-configuration-multi-node"),h(Po,"rel","nofollow"),h(zo,"href","https://github.com/huggingface/transformers/issues/8771#issuecomment-759248400"),h(zo,"rel","nofollow"),h(ui,"id","deepspeed-one-gpu"),h(Gt,"id","deployment-with-one-gpu"),h(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Gt,"href","#deployment-with-one-gpu"),h(zs,"class","relative group"),h(ci,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ao,"href","https://www.deepspeed.ai/getting-started/#resource-configuration-multi-node"),h(Ao,"rel","nofollow"),h(Co,"href","https://github.com/huggingface/transformers/issues/8771#issuecomment-759176685"),h(Co,"rel","nofollow"),h(ji,"id","deepspeed-notebook"),h(Nt,"id","deployment-in-notebooks"),h(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Nt,"href","#deployment-in-notebooks"),h(Ts,"class","relative group"),h(Ei,"id","deepspeed-config"),h(Vt,"id","configuration"),h(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Vt,"href","#configuration"),h(As,"class","relative group"),h(No,"href","https://www.deepspeed.ai/docs/config-json/"),h(No,"rel","nofollow"),h(Ho,"href","https://github.com/microsoft/DeepSpeedExamples"),h(Ho,"rel","nofollow"),h(Fo,"href","https://github.com/microsoft/DeepSpeed"),h(Fo,"rel","nofollow"),h($i,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(ki,"id","deepspeed-config-passing"),h(ea,"id","passing-configuration"),h(ea,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ea,"href","#passing-configuration"),h(Ss,"class","relative group"),h(Pi,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Di,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(zi,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(Ai,"id","deepspeed-config-shared"),h(sa,"id","shared-configuration"),h(sa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(sa,"href","#shared-configuration"),h(Cs,"class","relative group"),h(Si,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ci,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(xi,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ri,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ui,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(Gi,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(Li,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Mi,"id","deepspeed-zero"),h(la,"id","zero"),h(la,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(la,"href","#zero"),h(xs,"class","relative group"),h(tl,"href","https://www.deepspeed.ai/tutorials/zero/"),h(tl,"rel","nofollow"),h(al,"href","https://www.deepspeed.ai/docs/config-json/#zero-optimizations-for-fp16-training"),h(al,"rel","nofollow"),h(Zi,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Hi,"id","deepspeed-zero2-config"),h(pa,"id","zero2-config"),h(pa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(pa,"href","#zero2-config"),h(Rs,"class","relative group"),h(Vi,"id","deepspeed-zero3-config"),h(ia,"id","zero3-config"),h(ia,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ia,"href","#zero3-config"),h(Us,"class","relative group"),h(Xi,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(eu,"id","deepspeed-nvme"),h(ha,"id","nvme-support"),h(ha,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ha,"href","#nvme-support"),h(Gs,"class","relative group"),h(wl,"href","https://www.deepspeed.ai/docs/config-json/#optimizer-offloading"),h(wl,"rel","nofollow"),h(yl,"href","https://www.deepspeed.ai/docs/config-json/#parameter-offloading"),h(yl,"rel","nofollow"),h(bl,"href","https://github.com/microsoft/DeepSpeed/issues/998"),h(bl,"rel","nofollow"),h(au,"id","deepspeed-zero2-zero3-performance"),h(ma,"id","zero2-vs-zero3-performance"),h(ma,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ma,"href","#zero2-vs-zero3-performance"),h(Ls,"class","relative group"),h(lu,"id","deepspeed-zero2-example"),h(va,"id","zero2-example"),h(va,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(va,"href","#zero2-example"),h(Zs,"class","relative group"),h(ru,"id","deepspeed-zero3-example"),h(wa,"id","zero3-example"),h(wa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(wa,"href","#zero3-example"),h(Ns,"class","relative group"),h(Ea,"id","optimizer-and-scheduler"),h(Ea,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ea,"href","#optimizer-and-scheduler"),h(Hs,"class","relative group"),h(iu,"id","deepspeed-optimizer"),h(ka,"id","optimizer"),h(ka,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ka,"href","#optimizer"),h(Bs,"class","relative group"),h(Sl,"href","https://www.deepspeed.ai/docs/config-json/#optimizer-parameters"),h(Sl,"rel","nofollow"),h(uu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(du,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(_u,"id","deepspeed-scheduler"),h(Da,"id","scheduler"),h(Da,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Da,"href","#scheduler"),h(Ws,"class","relative group"),h(Zl,"href","https://www.deepspeed.ai/docs/config-json/#scheduler-parameters"),h(Zl,"rel","nofollow"),h(ju,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(gu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(yu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(bu,"id","deepspeed-fp32"),h(Ca,"id","fp32-precision"),h(Ca,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ca,"href","#fp32-precision"),h(Fs,"class","relative group"),h(Yl,"href","https://pytorch.org/docs/stable/notes/cuda.html#tensorfloat-32-tf32-on-ampere-devices"),h(Yl,"rel","nofollow"),h(qu,"id","deepspeed-amp"),h(Ia,"id","automatic-mixed-precision"),h(Ia,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ia,"href","#automatic-mixed-precision"),h(Vs,"class","relative group"),h(Ua,"id","fp16"),h(Ua,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ua,"href","#fp16"),h(Ys,"class","relative group"),h(Pu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(zu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(er,"href","https://www.deepspeed.ai/docs/config-json/#fp16-training-options"),h(er,"rel","nofollow"),h(Ma,"id","bf16"),h(Ma,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ma,"href","#bf16"),h(Ks,"class","relative group"),h(Na,"id","apex"),h(Na,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Na,"href","#apex"),h(Js,"class","relative group"),h(Cu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ru,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(rr,"href","https://www.deepspeed.ai/docs/config-json/#automatic-mixed-precision-amp-training-options"),h(rr,"rel","nofollow"),h(Iu,"id","deepspeed-bs"),h(Fa,"id","batch-size"),h(Fa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Fa,"href","#batch-size"),h(Xs,"class","relative group"),h(Gu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Mu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Zu,"id","deepspeed-grad-acc"),h(Ya,"id","gradient-accumulation"),h(Ya,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ya,"href","#gradient-accumulation"),h(Qs,"class","relative group"),h(Hu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Wu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Fu,"id","deepspeed-grad-clip"),h(Ja,"id","gradient-clipping"),h(Ja,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ja,"href","#gradient-clipping"),h(et,"class","relative group"),h(Yu,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ju,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Xu,"id","deepspeed-weight-extraction"),h(Qa,"id","getting-the-model-weights-out"),h(Qa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Qa,"href","#getting-the-model-weights-out"),h(st,"class","relative group"),h(gr,"href","https://huggingface.co/models"),h(gr,"rel","nofollow"),h(pn,"id","zero3-and-infinity-nuances"),h(pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(pn,"href","#zero3-and-infinity-nuances"),h(tt,"class","relative group"),h(un,"id","constructing-massive-models"),h(un,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(un,"href","#constructing-massive-models"),h(at,"class","relative group"),h(hc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(fc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(Or,"href","https://deepspeed.readthedocs.io/en/latest/zero3.html#constructing-massive-models"),h(Or,"rel","nofollow"),h(mc,"href","#from_pretrained-torch-dtype"),h(dn,"id","gathering-parameters"),h(dn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(dn,"href","#gathering-parameters"),h(nt,"class","relative group"),h(Sr,"href","https://deepspeed.readthedocs.io/en/latest/zero3.html#manual-parameter-coordination"),h(Sr,"rel","nofollow"),h(vc,"id","deepspeed-zero-inference"),h(_n,"id","zero-inference"),h(_n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(_n,"href","#zero-inference"),h(ot,"class","relative group"),h(gc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(gn,"id","memory-requirements"),h(gn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(gn,"href","#memory-requirements"),h(lt,"class","relative group"),h(Mr,"href","https://deepspeed.readthedocs.io/en/latest/memory.html"),h(Mr,"rel","nofollow"),h(yn,"id","filing-issues"),h(yn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(yn,"href","#filing-issues"),h(rt,"class","relative group"),h(Ac,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Sc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(Cc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(Wr,"href","https://github.com/stas00/porting/blob/master/transformers/deepspeed/DeepSpeed_on_colab_CLI.ipynb"),h(Wr,"rel","nofollow"),h(Vr,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch"),h(Vr,"rel","nofollow"),h(Kr,"href","https://github.com/microsoft/DeepSpeed/"),h(Kr,"rel","nofollow"),h(En,"id","troubleshooting"),h(En,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(En,"href","#troubleshooting"),h(it,"class","relative group"),h(qn,"id","the-deepspeed-process-gets-killed-at-startup-without-a-traceback"),h(qn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(qn,"href","#the-deepspeed-process-gets-killed-at-startup-without-a-traceback"),h(ut,"class","relative group"),h(ep,"href","https://deepspeed.readthedocs.io/en/latest/memory.html"),h(ep,"rel","nofollow"),h($n,"id","training-andor-evalpredict-loss-is-nan"),h($n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h($n,"href","#training-andor-evalpredict-loss-is-nan"),h(ct,"class","relative group"),h(Pn,"id","notes"),h(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Pn,"href","#notes"),h(ht,"class","relative group"),h(Mc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(lp,"href","https://github.com/microsoft/deepspeed#installation"),h(lp,"rel","nofollow"),h(Zc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(rp,"href","https://www.deepspeed.ai/getting-started/#writing-deepspeed-models"),h(rp,"rel","nofollow"),h(Nc,"id","deepspeed-non-trainer-integration"),h(zn,"id","nontrainer-deepspeed-integration"),h(zn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(zn,"href","#nontrainer-deepspeed-integration"),h(dt,"class","relative group"),h(Hc,"href","/docs/transformers/pr_16529/en/main_classes/deepspeed#transformers.deepspeed.HfDeepSpeedConfig"),h(Bc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Wc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Fc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Vc,"href","/docs/transformers/pr_16529/en/main_classes/deepspeed#transformers.deepspeed.HfDeepSpeedConfig"),h(Jc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(cp,"href","https://www.deepspeed.ai/"),h(cp,"rel","nofollow"),h(An,"id","transformers.deepspeed.HfDeepSpeedConfig"),h(An,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(An,"href","#transformers.deepspeed.HfDeepSpeedConfig"),h(mt,"class","relative group"),h(Xc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Qc,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.TrainingArguments"),h(js,"class","docstring"),h(Sn,"class","docstring"),h(Cn,"class","docstring"),h(xn,"class","docstring"),h(P,"class","docstring"),h(Rn,"id","custom-deepspeed-zero-inference"),h(Rn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Rn,"href","#custom-deepspeed-zero-inference"),h(gt,"class","relative group"),h(eh,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Ln,"id","main-deepspeed-resources"),h(Ln,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ln,"href","#main-deepspeed-resources"),h(wt,"class","relative group"),h(Ep,"href","https://github.com/microsoft/deepspeed"),h(Ep,"rel","nofollow"),h(qp,"href","https://www.deepspeed.ai/getting-started/"),h(qp,"rel","nofollow"),h($p,"href","https://deepspeed.readthedocs.io/en/latest/index.html"),h($p,"rel","nofollow"),h(kp,"href","https://www.microsoft.com/en-us/research/search/?q=deepspeed"),h(kp,"rel","nofollow"),h(Pp,"href","https://arxiv.org/abs/1910.02054"),h(Pp,"rel","nofollow"),h(Dp,"href","https://arxiv.org/abs/2101.06840"),h(Dp,"rel","nofollow"),h(zp,"href","https://arxiv.org/abs/2104.07857"),h(zp,"rel","nofollow"),h(lh,"href","/docs/transformers/pr_16529/en/main_classes/trainer#transformers.Trainer"),h(Op,"href","https://github.com/microsoft/DeepSpeed/issues"),h(Op,"rel","nofollow")},m(e,p){s(document.head,y),i(e,C,p),i(e,b,p),s(b,k),s(k,ee),m(z,ee,null),s(b,x),s(b,se),s(se,R),i(e,ae,p),i(e,S,p),s(S,E),s(E,q),s(S,Es),s(S,V),s(V,qs),s(S,L6),i(e,Bj,p),i(e,I,p),s(I,sf),s(sf,M6),s(I,Z6),s(I,tf),s(tf,N6),s(I,H6),s(I,af),s(af,B6),s(I,W6),s(I,nf),s(nf,F6),s(I,V6),s(I,of),s(of,Y6),s(I,K6),s(I,lf),s(lf,J6),i(e,Wj,p),i(e,Se,p),s(Se,X6),s(Se,ao),s(ao,Q6),s(Se,e5),s(Se,no),s(no,s5),s(Se,t5),i(e,Fj,p),i(e,Up,p),s(Up,a5),i(e,Vj,p),i(e,Gp,p),s(Gp,n5),i(e,Yj,p),i(e,Et,p),s(Et,o5),s(Et,oo),s(oo,l5),s(Et,r5),i(e,Kj,p),i(e,qt,p),s(qt,lo),s(lo,p5),s(lo,Lp),s(Lp,i5),s(lo,u5),s(qt,c5),s(qt,Y),s(Y,h5),s(Y,Mp),s(Mp,f5),s(Y,d5),s(Y,rf),s(rf,m5),s(Y,_5),s(Y,pf),s(pf,v5),s(Y,j5),s(Y,uf),s(uf,g5),s(Y,w5),s(Y,Zp),s(Zp,y5),s(Y,b5),i(e,Jj,p),i(e,Np,p),s(Np,E5),i(e,Xj,p),i(e,Hp,p),s(Hp,q5),i(e,Qj,p),i(e,Bp,p),s(Bp,cf),s(cf,$5),i(e,eg,p),i(e,Wp,p),s(Wp,k5),i(e,sg,p),i(e,Fp,p),s(Fp,ro),s(ro,P5),s(ro,Vp),s(Vp,D5),s(ro,z5),i(e,tg,p),i(e,Yp,p),s(Yp,O5),i(e,ag,p),i(e,Kp,p),i(e,ng,p),i(e,$s,p),s($s,$t),s($t,hf),m(po,hf,null),s($s,T5),s($s,ff),s(ff,A5),i(e,og,p),i(e,Jp,p),i(e,lg,p),i(e,ks,p),s(ks,kt),s(kt,df),m(io,df,null),s(ks,S5),s(ks,mf),s(mf,C5),i(e,rg,p),i(e,Xp,p),s(Xp,x5),i(e,pg,p),m(uo,e,p),i(e,ig,p),i(e,Ce,p),s(Ce,R5),s(Ce,_f),s(_f,I5),s(Ce,U5),s(Ce,vf),s(vf,G5),s(Ce,L5),i(e,ug,p),m(co,e,p),i(e,cg,p),i(e,xe,p),s(xe,M5),s(xe,ho),s(ho,Z5),s(xe,N5),s(xe,fo),s(fo,H5),s(xe,B5),i(e,hg,p),i(e,Pt,p),s(Pt,W5),s(Pt,Qp),s(Qp,F5),s(Pt,V5),i(e,fg,p),i(e,ei,p),s(ei,Y5),i(e,dg,p),i(e,si,p),s(si,K5),i(e,mg,p),m(mo,e,p),i(e,_g,p),i(e,Re,p),s(Re,J5),s(Re,jf),s(jf,X5),s(Re,Q5),s(Re,gf),s(gf,e$),s(Re,s$),i(e,vg,p),i(e,Dt,p),s(Dt,t$),s(Dt,wf),s(wf,a$),s(Dt,n$),i(e,jg,p),m(_o,e,p),i(e,gg,p),i(e,Pe,p),s(Pe,o$),s(Pe,yf),s(yf,l$),s(Pe,r$),s(Pe,bf),s(bf,p$),s(Pe,i$),s(Pe,Ef),s(Ef,u$),i(e,wg,p),i(e,ti,p),s(ti,c$),i(e,yg,p),m(vo,e,p),i(e,bg,p),i(e,Ie,p),s(Ie,h$),s(Ie,qf),s(qf,f$),s(Ie,d$),s(Ie,$f),s($f,m$),s(Ie,_$),i(e,Eg,p),i(e,zt,p),s(zt,v$),s(zt,kf),s(kf,j$),s(zt,g$),i(e,qg,p),i(e,Ue,p),s(Ue,w$),s(Ue,Pf),s(Pf,y$),s(Ue,b$),s(Ue,jo),s(jo,E$),s(Ue,q$),i(e,$g,p),i(e,ai,p),s(ai,$$),i(e,kg,p),m(go,e,p),i(e,Pg,p),i(e,ni,p),s(ni,k$),i(e,Dg,p),m(wo,e,p),i(e,zg,p),i(e,oi,p),s(oi,P$),i(e,Og,p),m(yo,e,p),i(e,Tg,p),i(e,Ot,p),s(Ot,D$),s(Ot,Df),s(Df,z$),s(Ot,O$),i(e,Ag,p),i(e,Tt,p),s(Tt,T$),s(Tt,zf),s(zf,A$),s(Tt,S$),i(e,Sg,p),i(e,At,p),s(At,C$),s(At,bo),s(bo,x$),s(At,R$),i(e,Cg,p),i(e,li,p),i(e,xg,p),i(e,Ps,p),s(Ps,St),s(St,Of),m(Eo,Of,null),s(Ps,I$),s(Ps,Tf),s(Tf,U$),i(e,Rg,p),i(e,Ct,p),s(Ct,G$),s(Ct,ri),s(ri,L$),s(Ct,M$),i(e,Ig,p),i(e,xt,p),s(xt,Ds),s(Ds,Z$),s(Ds,Af),s(Af,N$),s(Ds,H$),s(Ds,Sf),s(Sf,B$),s(Ds,W$),s(xt,F$),s(xt,De),s(De,V$),s(De,Cf),s(Cf,Y$),s(De,K$),s(De,xf),s(xf,J$),s(De,X$),s(De,qo),s(qo,Q$),s(De,e4),i(e,Ug,p),i(e,pi,p),s(pi,s4),i(e,Gg,p),m($o,e,p),i(e,Lg,p),i(e,ii,p),s(ii,t4),i(e,Mg,p),m(ko,e,p),i(e,Zg,p),i(e,U,p),s(U,a4),s(U,Rf),s(Rf,n4),s(U,o4),s(U,If),s(If,l4),s(U,r4),s(U,Uf),s(Uf,p4),s(U,i4),s(U,Gf),s(Gf,u4),s(U,c4),s(U,Po),s(Po,h4),s(U,f4),i(e,Ng,p),i(e,ne,p),s(ne,d4),s(ne,Lf),s(Lf,m4),s(ne,_4),s(ne,Mf),s(Mf,v4),s(ne,j4),s(ne,Zf),s(Zf,g4),s(ne,w4),i(e,Hg,p),i(e,Rt,p),s(Rt,y4),s(Rt,Nf),s(Nf,b4),s(Rt,E4),i(e,Bg,p),m(Do,e,p),i(e,Wg,p),i(e,It,p),s(It,q4),s(It,Hf),s(Hf,$4),s(It,k4),i(e,Fg,p),i(e,Ut,p),s(Ut,P4),s(Ut,zo),s(zo,D4),s(Ut,z4),i(e,Vg,p),i(e,ui,p),i(e,Yg,p),i(e,zs,p),s(zs,Gt),s(Gt,Bf),m(Oo,Bf,null),s(zs,O4),s(zs,Wf),s(Wf,T4),i(e,Kg,p),i(e,Lt,p),s(Lt,A4),s(Lt,ci),s(ci,S4),s(Lt,C4),i(e,Jg,p),m(To,e,p),i(e,Xg,p),i(e,Ge,p),s(Ge,x4),s(Ge,Ff),s(Ff,R4),s(Ge,I4),s(Ge,Ao),s(Ao,U4),s(Ge,G4),i(e,Qg,p),i(e,hi,p),s(hi,L4),i(e,ew,p),i(e,Mt,p),s(Mt,Vf),s(Vf,M4),s(Mt,Z4),s(Mt,Yf),s(Yf,N4),i(e,sw,p),i(e,fi,p),s(fi,H4),i(e,tw,p),m(So,e,p),i(e,aw,p),i(e,di,p),s(di,B4),i(e,nw,p),i(e,Zt,p),s(Zt,W4),s(Zt,Co),s(Co,F4),s(Zt,V4),i(e,ow,p),i(e,mi,p),s(mi,Y4),i(e,lw,p),i(e,_i,p),s(_i,K4),i(e,rw,p),i(e,vi,p),s(vi,Os),s(Os,xo),s(xo,J4),s(xo,Kf),s(Kf,X4),s(xo,Q4),s(Os,e9),m(Ro,Os,null),s(Os,s9),s(Os,Jf),s(Jf,t9),i(e,pw,p),i(e,ji,p),i(e,iw,p),i(e,Ts,p),s(Ts,Nt),s(Nt,Xf),m(Io,Xf,null),s(Ts,a9),s(Ts,Qf),s(Qf,n9),i(e,uw,p),i(e,Ht,p),s(Ht,o9),s(Ht,ed),s(ed,l9),s(Ht,r9),i(e,cw,p),i(e,gi,p),s(gi,p9),i(e,hw,p),m(Uo,e,p),i(e,fw,p),i(e,Bt,p),s(Bt,i9),s(Bt,sd),s(sd,u9),s(Bt,c9),i(e,dw,p),i(e,wi,p),s(wi,h9),i(e,mw,p),i(e,yi,p),s(yi,f9),i(e,_w,p),m(Go,e,p),i(e,vw,p),i(e,Le,p),s(Le,d9),s(Le,td),s(td,m9),s(Le,_9),s(Le,ad),s(ad,v9),s(Le,j9),i(e,jw,p),m(Lo,e,p),i(e,gw,p),i(e,Wt,p),s(Wt,g9),s(Wt,nd),s(nd,w9),s(Wt,y9),i(e,ww,p),m(Mo,e,p),i(e,yw,p),i(e,bi,p),s(bi,b9),i(e,bw,p),i(e,Ft,p),s(Ft,E9),s(Ft,od),s(od,q9),s(Ft,$9),i(e,Ew,p),i(e,Ei,p),i(e,qw,p),i(e,As,p),s(As,Vt),s(Vt,ld),m(Zo,ld,null),s(As,k9),s(As,rd),s(rd,P9),i(e,$w,p),i(e,Yt,p),s(Yt,D9),s(Yt,No),s(No,z9),s(Yt,O9),i(e,kw,p),i(e,Kt,p),s(Kt,T9),s(Kt,Ho),s(Ho,A9),s(Kt,S9),i(e,Pw,p),m(Bo,e,p),i(e,Dw,p),i(e,Jt,p),s(Jt,C9),s(Jt,pd),s(pd,x9),s(Jt,R9),i(e,zw,p),m(Wo,e,p),i(e,Ow,p),i(e,Xt,p),s(Xt,I9),s(Xt,Fo),s(Fo,U9),s(Xt,G9),i(e,Tw,p),i(e,qi,p),s(qi,L9),i(e,Aw,p),i(e,oe,p),s(oe,M9),s(oe,id),s(id,Z9),s(oe,N9),s(oe,ud),s(ud,H9),s(oe,B9),s(oe,cd),s(cd,W9),s(oe,F9),i(e,Sw,p),m(Vo,e,p),i(e,Cw,p),i(e,Qt,p),s(Qt,V9),s(Qt,$i),s($i,Y9),s(Qt,K9),i(e,xw,p),i(e,ki,p),i(e,Rw,p),i(e,Ss,p),s(Ss,ea),s(ea,hd),m(Yo,hd,null),s(Ss,J9),s(Ss,fd),s(fd,X9),i(e,Iw,p),i(e,G,p),s(G,Q9),s(G,Pi),s(Pi,e8),s(G,s8),s(G,Di),s(Di,t8),s(G,a8),s(G,dd),s(dd,n8),s(G,o8),s(G,md),s(md,l8),s(G,r8),s(G,zi),s(zi,p8),s(G,i8),i(e,Uw,p),i(e,Oi,p),s(Oi,u8),i(e,Gw,p),m(Ko,e,p),i(e,Lw,p),i(e,Ti,p),s(Ti,c8),i(e,Mw,p),m(Jo,e,p),i(e,Zw,p),i(e,Ai,p),i(e,Nw,p),i(e,Cs,p),s(Cs,sa),s(sa,_d),m(Xo,_d,null),s(Cs,h8),s(Cs,vd),s(vd,f8),i(e,Hw,p),m(ta,e,p),i(e,Bw,p),i(e,Me,p),s(Me,d8),s(Me,Si),s(Si,m8),s(Me,_8),s(Me,Ci),s(Ci,v8),s(Me,j8),i(e,Ww,p),i(e,aa,p),s(aa,g8),s(aa,xi),s(xi,w8),s(aa,y8),i(e,Fw,p),i(e,Ze,p),s(Ze,b8),s(Ze,jd),s(jd,E8),s(Ze,q8),s(Ze,Ri),s(Ri,$8),s(Ze,k8),i(e,Vw,p),i(e,Ii,p),s(Ii,P8),i(e,Yw,p),i(e,na,p),s(na,D8),s(na,Ui),s(Ui,z8),s(na,O8),i(e,Kw,p),i(e,oa,p),s(oa,gd),s(gd,T8),s(oa,A8),s(oa,Qo),s(Qo,S8),s(Qo,Gi),s(Gi,C8),s(Qo,x8),i(e,Jw,p),i(e,le,p),s(le,R8),s(le,wd),s(wd,I8),s(le,U8),s(le,Li),s(Li,G8),s(le,L8),s(le,yd),s(yd,M8),s(le,Z8),i(e,Xw,p),i(e,Mi,p),i(e,Qw,p),i(e,xs,p),s(xs,la),s(la,bd),m(el,bd,null),s(xs,N8),s(xs,Ed),s(Ed,H8),i(e,ey,p),i(e,sl,p),s(sl,tl),s(tl,B8),s(sl,W8),i(e,sy,p),i(e,Ne,p),s(Ne,F8),s(Ne,qd),s(qd,V8),s(Ne,Y8),s(Ne,al),s(al,K8),s(Ne,J8),i(e,ty,p),i(e,ra,p),s(ra,X8),s(ra,Zi),s(Zi,Q8),s(ra,ek),i(e,ay,p),i(e,Ni,p),s(Ni,sk),i(e,ny,p),i(e,Hi,p),i(e,oy,p),i(e,Rs,p),s(Rs,pa),s(pa,$d),m(nl,$d,null),s(Rs,tk),s(Rs,kd),s(kd,ak),i(e,ly,p),i(e,Bi,p),s(Bi,nk),i(e,ry,p),m(ol,e,p),i(e,py,p),i(e,Wi,p),s(Wi,Pd),s(Pd,ok),i(e,iy,p),i(e,He,p),s(He,Is),s(Is,lk),s(Is,Dd),s(Dd,rk),s(Is,pk),s(Is,zd),s(zd,ik),s(Is,uk),s(He,ck),s(He,L),s(L,Od),s(Od,hk),s(L,fk),s(L,Td),s(Td,dk),s(L,mk),s(L,Ad),s(Ad,_k),s(L,vk),s(L,Sd),s(Sd,jk),s(L,gk),s(L,Cd),s(Cd,wk),s(L,yk),s(L,xd),s(xd,bk),s(L,Ek),s(He,qk),s(He,Rd),s(Rd,$k),i(e,uy,p),i(e,Be,p),s(Be,kk),s(Be,Id),s(Id,Pk),s(Be,Dk),s(Be,Ud),s(Ud,zk),s(Be,Ok),i(e,cy,p),m(ll,e,p),i(e,hy,p),i(e,Fi,p),s(Fi,Tk),i(e,fy,p),i(e,Vi,p),i(e,dy,p),i(e,Us,p),s(Us,ia),s(ia,Gd),m(rl,Gd,null),s(Us,Ak),s(Us,Ld),s(Ld,Sk),i(e,my,p),i(e,Yi,p),s(Yi,Ck),i(e,_y,p),m(pl,e,p),i(e,vy,p),i(e,K,p),s(K,xk),s(K,Md),s(Md,Rk),s(K,Ik),s(K,Zd),s(Zd,Uk),s(K,Gk),s(K,Nd),s(Nd,Lk),s(K,Mk),s(K,Hd),s(Hd,Zk),s(K,Nk),i(e,jy,p),i(e,We,p),s(We,Hk),s(We,Bd),s(Bd,Bk),s(We,Wk),s(We,Wd),s(Wd,Fk),s(We,Vk),i(e,gy,p),i(e,Ki,p),s(Ki,Fd),s(Fd,Yk),i(e,wy,p),i(e,ua,p),s(ua,il),s(il,Vd),s(Vd,Kk),s(il,Jk),s(il,Yd),s(Yd,Xk),s(ua,Qk),s(ua,ul),s(ul,Kd),s(Kd,e7),s(ul,s7),s(ul,Jd),s(Jd,t7),i(e,yy,p),i(e,M,p),s(M,a7),s(M,Xd),s(Xd,n7),s(M,o7),s(M,Qd),s(Qd,l7),s(M,r7),s(M,em),s(em,p7),s(M,i7),s(M,sm),s(sm,u7),s(M,c7),s(M,tm),s(tm,h7),s(M,f7),i(e,by,p),i(e,ze,p),s(ze,am),s(am,d7),s(ze,m7),s(ze,nm),s(nm,_7),s(ze,v7),s(ze,om),s(om,j7),s(ze,g7),i(e,Ey,p),i(e,Ji,p),s(Ji,w7),i(e,qy,p),i(e,Fe,p),s(Fe,cl),s(cl,lm),s(lm,y7),s(cl,b7),s(cl,rm),s(rm,E7),s(Fe,q7),s(Fe,hl),s(hl,pm),s(pm,$7),s(hl,k7),s(hl,im),s(im,P7),s(Fe,D7),s(Fe,fl),s(fl,um),s(um,z7),s(fl,O7),s(fl,cm),s(cm,T7),i(e,$y,p),i(e,Ve,p),s(Ve,A7),s(Ve,hm),s(hm,S7),s(Ve,C7),s(Ve,Xi),s(Xi,x7),s(Ve,R7),i(e,ky,p),i(e,dl,p),s(dl,fm),s(fm,I7),s(dl,U7),i(e,Py,p),i(e,re,p),s(re,G7),s(re,dm),s(dm,L7),s(re,M7),s(re,mm),s(mm,Z7),s(re,N7),s(re,_m),s(_m,H7),s(re,B7),i(e,Dy,p),i(e,Qi,p),s(Qi,ml),s(ml,vm),s(vm,W7),s(ml,F7),s(ml,jm),s(jm,V7),i(e,zy,p),i(e,Oe,p),s(Oe,gm),s(gm,Y7),s(Oe,K7),s(Oe,wm),s(wm,J7),s(Oe,X7),s(Oe,ym),s(ym,Q7),s(Oe,eP),i(e,Oy,p),i(e,Ye,p),s(Ye,sP),s(Ye,bm),s(bm,tP),s(Ye,aP),s(Ye,Em),s(Em,nP),s(Ye,oP),i(e,Ty,p),i(e,ca,p),s(ca,_l),s(_l,lP),s(_l,qm),s(qm,rP),s(_l,pP),s(ca,iP),s(ca,vl),s(vl,uP),s(vl,$m),s($m,cP),s(vl,hP),i(e,Ay,p),i(e,eu,p),i(e,Sy,p),i(e,Gs,p),s(Gs,ha),s(ha,km),m(jl,km,null),s(Gs,fP),s(Gs,Pm),s(Pm,dP),i(e,Cy,p),i(e,su,p),s(su,mP),i(e,xy,p),i(e,tu,p),s(tu,_P),i(e,Ry,p),m(gl,e,p),i(e,Iy,p),i(e,fa,p),s(fa,vP),s(fa,Dm),s(Dm,jP),s(fa,gP),i(e,Uy,p),i(e,Ke,p),s(Ke,wP),s(Ke,wl),s(wl,yP),s(Ke,bP),s(Ke,yl),s(yl,EP),s(Ke,qP),i(e,Gy,p),i(e,da,p),s(da,$P),s(da,zm),s(zm,kP),s(da,PP),i(e,Ly,p),i(e,Je,p),s(Je,DP),s(Je,Om),s(Om,zP),s(Je,OP),s(Je,bl),s(bl,TP),s(Je,AP),i(e,My,p),i(e,au,p),i(e,Zy,p),i(e,Ls,p),s(Ls,ma),s(ma,Tm),m(El,Tm,null),s(Ls,SP),s(Ls,Am),s(Am,CP),i(e,Ny,p),i(e,nu,p),s(nu,xP),i(e,Hy,p),i(e,ou,p),s(ou,RP),i(e,By,p),i(e,_a,p),s(_a,Ms),s(Ms,IP),s(Ms,Sm),s(Sm,UP),s(Ms,GP),s(Ms,Cm),s(Cm,LP),s(Ms,MP),s(_a,ZP),s(_a,ql),s(ql,NP),s(ql,xm),s(xm,HP),s(ql,BP),i(e,Wy,p),i(e,Xe,p),s(Xe,WP),s(Xe,Rm),s(Rm,FP),s(Xe,VP),s(Xe,Im),s(Im,YP),s(Xe,KP),i(e,Fy,p),i(e,lu,p),i(e,Vy,p),i(e,Zs,p),s(Zs,va),s(va,Um),m($l,Um,null),s(Zs,JP),s(Zs,Gm),s(Gm,XP),i(e,Yy,p),i(e,ja,p),s(ja,QP),s(ja,Lm),s(Lm,eD),s(ja,sD),i(e,Ky,p),m(kl,e,p),i(e,Jy,p),i(e,ga,p),s(ga,tD),s(ga,Mm),s(Mm,aD),s(ga,nD),i(e,Xy,p),m(Pl,e,p),i(e,Qy,p),i(e,ru,p),i(e,e2,p),i(e,Ns,p),s(Ns,wa),s(wa,Zm),m(Dl,Zm,null),s(Ns,oD),s(Ns,Nm),s(Nm,lD),i(e,s2,p),i(e,ya,p),s(ya,rD),s(ya,Hm),s(Hm,pD),s(ya,iD),i(e,t2,p),m(zl,e,p),i(e,a2,p),i(e,ba,p),s(ba,uD),s(ba,Bm),s(Bm,cD),s(ba,hD),i(e,n2,p),m(Ol,e,p),i(e,o2,p),i(e,Hs,p),s(Hs,Ea),s(Ea,Wm),m(Tl,Wm,null),s(Hs,fD),s(Hs,Fm),s(Fm,dD),i(e,l2,p),i(e,qa,p),s(qa,mD),s(qa,Vm),s(Vm,_D),s(qa,vD),i(e,r2,p),i(e,pu,p),s(pu,jD),i(e,p2,p),i(e,$a,p),s($a,gD),s($a,Ym),s(Ym,wD),s($a,yD),i(e,i2,p),i(e,iu,p),i(e,u2,p),i(e,Bs,p),s(Bs,ka),s(ka,Km),m(Al,Km,null),s(Bs,bD),s(Bs,Jm),s(Jm,ED),i(e,c2,p),i(e,Qe,p),s(Qe,qD),s(Qe,Xm),s(Xm,$D),s(Qe,kD),s(Qe,Sl),s(Sl,PD),s(Qe,DD),i(e,h2,p),i(e,$,p),s($,zD),s($,Qm),s(Qm,OD),s($,TD),s($,uu),s(uu,AD),s($,SD),s($,e_),s(e_,CD),s($,xD),s($,s_),s(s_,RD),s($,ID),s($,t_),s(t_,UD),s($,GD),s($,a_),s(a_,LD),s($,MD),s($,n_),s(n_,ZD),s($,ND),s($,o_),s(o_,HD),s($,BD),i(e,f2,p),i(e,es,p),s(es,WD),s(es,l_),s(l_,FD),s(es,VD),s(es,r_),s(r_,YD),s(es,KD),i(e,d2,p),m(Cl,e,p),i(e,m2,p),i(e,cu,p),s(cu,JD),i(e,_2,p),i(e,pe,p),s(pe,xl),s(xl,p_),s(p_,XD),s(xl,QD),s(xl,i_),s(i_,ez),s(pe,sz),s(pe,Rl),s(Rl,u_),s(u_,tz),s(Rl,az),s(Rl,c_),s(c_,nz),s(pe,oz),s(pe,Il),s(Il,h_),s(h_,lz),s(Il,rz),s(Il,f_),s(f_,pz),s(pe,iz),s(pe,Ul),s(Ul,d_),s(d_,uz),s(Ul,cz),s(Ul,m_),s(m_,hz),i(e,v2,p),i(e,hu,p),s(hu,fz),i(e,j2,p),i(e,fu,p),s(fu,dz),i(e,g2,p),m(Gl,e,p),i(e,w2,p),i(e,Pa,p),s(Pa,mz),s(Pa,du),s(du,_z),s(Pa,vz),i(e,y2,p),i(e,mu,p),s(mu,jz),i(e,b2,p),m(Ll,e,p),i(e,E2,p),i(e,ie,p),s(ie,gz),s(ie,__),s(__,wz),s(ie,yz),s(ie,v_),s(v_,bz),s(ie,Ez),s(ie,j_),s(j_,qz),s(ie,$z),i(e,q2,p),i(e,_u,p),i(e,$2,p),i(e,Ws,p),s(Ws,Da),s(Da,g_),m(Ml,g_,null),s(Ws,kz),s(Ws,w_),s(w_,Pz),i(e,k2,p),i(e,Z,p),s(Z,Dz),s(Z,y_),s(y_,zz),s(Z,Oz),s(Z,b_),s(b_,Tz),s(Z,Az),s(Z,E_),s(E_,Sz),s(Z,Cz),s(Z,q_),s(q_,xz),s(Z,Rz),s(Z,Zl),s(Zl,Iz),s(Z,Uz),i(e,P2,p),i(e,vu,p),s(vu,Gz),i(e,D2,p),i(e,za,p),s(za,Nl),s(Nl,$_),s($_,Lz),s(Nl,Mz),s(Nl,k_),s(k_,Zz),s(za,Nz),s(za,ss),s(ss,P_),s(P_,Hz),s(ss,Bz),s(ss,D_),s(D_,Wz),s(ss,Fz),s(ss,z_),s(z_,Vz),s(ss,Yz),i(e,z2,p),i(e,O,p),s(O,Kz),s(O,O_),s(O_,Jz),s(O,Xz),s(O,ju),s(ju,Qz),s(O,eO),s(O,T_),s(T_,sO),s(O,tO),s(O,A_),s(A_,aO),s(O,nO),s(O,S_),s(S_,oO),s(O,lO),s(O,C_),s(C_,rO),s(O,pO),i(e,O2,p),i(e,ts,p),s(ts,iO),s(ts,x_),s(x_,uO),s(ts,cO),s(ts,R_),s(R_,hO),s(ts,fO),i(e,T2,p),m(Hl,e,p),i(e,A2,p),i(e,as,p),s(as,dO),s(as,I_),s(I_,mO),s(as,_O),s(as,gu),s(gu,vO),s(as,jO),i(e,S2,p),i(e,ue,p),s(ue,Oa),s(Oa,U_),s(U_,gO),s(Oa,wO),s(Oa,G_),s(G_,yO),s(Oa,bO),s(ue,EO),s(ue,Ta),s(Ta,L_),s(L_,qO),s(Ta,$O),s(Ta,M_),s(M_,kO),s(Ta,PO),s(ue,DO),s(ue,ns),s(ns,Z_),s(Z_,zO),s(ns,OO),s(ns,N_),s(N_,TO),s(ns,AO),s(ns,H_),s(H_,SO),s(ns,CO),s(ue,xO),s(ue,os),s(os,B_),s(B_,RO),s(os,IO),s(os,W_),s(W_,UO),s(os,GO),s(os,F_),s(F_,LO),s(os,MO),i(e,C2,p),i(e,wu,p),s(wu,ZO),i(e,x2,p),m(Bl,e,p),i(e,R2,p),i(e,Aa,p),s(Aa,NO),s(Aa,yu),s(yu,HO),s(Aa,BO),i(e,I2,p),i(e,Sa,p),s(Sa,WO),s(Sa,V_),s(V_,FO),s(Sa,VO),i(e,U2,p),m(Wl,e,p),i(e,G2,p),i(e,J,p),s(J,YO),s(J,Y_),s(Y_,KO),s(J,JO),s(J,K_),s(K_,XO),s(J,QO),s(J,J_),s(J_,eT),s(J,sT),s(J,X_),s(X_,tT),s(J,aT),i(e,L2,p),i(e,bu,p),i(e,M2,p),i(e,Fs,p),s(Fs,Ca),s(Ca,Q_),m(Fl,Q_,null),s(Fs,nT),s(Fs,e1),s(e1,oT),i(e,Z2,p),i(e,Eu,p),s(Eu,lT),i(e,N2,p),i(e,xa,p),s(xa,rT),s(xa,s1),s(s1,pT),s(xa,iT),i(e,H2,p),m(Vl,e,p),i(e,B2,p),i(e,Ra,p),s(Ra,uT),s(Ra,Yl),s(Yl,cT),s(Ra,hT),i(e,W2,p),i(e,ce,p),s(ce,fT),s(ce,t1),s(t1,dT),s(ce,mT),s(ce,a1),s(a1,_T),s(ce,vT),s(ce,n1),s(n1,jT),s(ce,gT),i(e,F2,p),i(e,qu,p),i(e,V2,p),i(e,Vs,p),s(Vs,Ia),s(Ia,o1),m(Kl,o1,null),s(Vs,wT),s(Vs,l1),s(l1,yT),i(e,Y2,p),i(e,$u,p),s($u,bT),i(e,K2,p),i(e,Ys,p),s(Ys,Ua),s(Ua,r1),m(Jl,r1,null),s(Ys,ET),s(Ys,p1),s(p1,qT),i(e,J2,p),i(e,ku,p),s(ku,$T),i(e,X2,p),m(Xl,e,p),i(e,Q2,p),i(e,ls,p),s(ls,kT),s(ls,Pu),s(Pu,PT),s(ls,DT),s(ls,i1),s(i1,zT),s(ls,OT),i(e,eb,p),i(e,rs,p),s(rs,TT),s(rs,u1),s(u1,AT),s(rs,ST),s(rs,c1),s(c1,CT),s(rs,xT),i(e,sb,p),i(e,Du,p),s(Du,RT),i(e,tb,p),m(Ql,e,p),i(e,ab,p),i(e,Ga,p),s(Ga,IT),s(Ga,zu),s(zu,UT),s(Ga,GT),i(e,nb,p),i(e,La,p),s(La,LT),s(La,er),s(er,MT),s(La,ZT),i(e,ob,p),i(e,Ks,p),s(Ks,Ma),s(Ma,h1),m(sr,h1,null),s(Ks,NT),s(Ks,f1),s(f1,HT),i(e,lb,p),i(e,Ou,p),s(Ou,BT),i(e,rb,p),m(tr,e,p),i(e,pb,p),i(e,Tu,p),s(Tu,WT),i(e,ib,p),i(e,ps,p),s(ps,FT),s(ps,d1),s(d1,VT),s(ps,YT),s(ps,m1),s(m1,KT),s(ps,JT),i(e,ub,p),i(e,Au,p),s(Au,XT),i(e,cb,p),m(ar,e,p),i(e,hb,p),m(Za,e,p),i(e,fb,p),i(e,Js,p),s(Js,Na),s(Na,_1),m(nr,_1,null),s(Js,QT),s(Js,v1),s(v1,eA),i(e,db,p),i(e,Su,p),s(Su,sA),i(e,mb,p),m(or,e,p),i(e,_b,p),i(e,he,p),s(he,tA),s(he,Cu),s(Cu,aA),s(he,nA),s(he,j1),s(j1,oA),s(he,lA),s(he,g1),s(g1,rA),s(he,pA),i(e,vb,p),i(e,Ha,p),s(Ha,iA),s(Ha,w1),s(w1,uA),s(Ha,cA),i(e,jb,p),i(e,xu,p),s(xu,hA),i(e,gb,p),m(lr,e,p),i(e,wb,p),i(e,Ba,p),s(Ba,fA),s(Ba,Ru),s(Ru,dA),s(Ba,mA),i(e,yb,p),i(e,Wa,p),s(Wa,_A),s(Wa,rr),s(rr,vA),s(Wa,jA),i(e,bb,p),i(e,Iu,p),i(e,Eb,p),i(e,Xs,p),s(Xs,Fa),s(Fa,y1),m(pr,y1,null),s(Xs,gA),s(Xs,b1),s(b1,wA),i(e,qb,p),i(e,Uu,p),s(Uu,yA),i(e,$b,p),m(ir,e,p),i(e,kb,p),i(e,N,p),s(N,bA),s(N,Gu),s(Gu,EA),s(N,qA),s(N,E1),s(E1,$A),s(N,kA),s(N,q1),s(q1,PA),s(N,DA),s(N,$1),s($1,zA),s(N,OA),s(N,k1),s(k1,TA),s(N,AA),i(e,Pb,p),i(e,Lu,p),s(Lu,SA),i(e,Db,p),m(ur,e,p),i(e,zb,p),i(e,Va,p),s(Va,CA),s(Va,Mu),s(Mu,xA),s(Va,RA),i(e,Ob,p),i(e,Zu,p),i(e,Tb,p),i(e,Qs,p),s(Qs,Ya),s(Ya,P1),m(cr,P1,null),s(Qs,IA),s(Qs,D1),s(D1,UA),i(e,Ab,p),i(e,Nu,p),s(Nu,GA),i(e,Sb,p),m(hr,e,p),i(e,Cb,p),i(e,is,p),s(is,LA),s(is,Hu),s(Hu,MA),s(is,ZA),s(is,z1),s(z1,NA),s(is,HA),i(e,xb,p),i(e,Bu,p),s(Bu,BA),i(e,Rb,p),m(fr,e,p),i(e,Ib,p),i(e,Ka,p),s(Ka,WA),s(Ka,Wu),s(Wu,FA),s(Ka,VA),i(e,Ub,p),i(e,Fu,p),i(e,Gb,p),i(e,et,p),s(et,Ja),s(Ja,O1),m(dr,O1,null),s(et,YA),s(et,T1),s(T1,KA),i(e,Lb,p),i(e,Vu,p),s(Vu,JA),i(e,Mb,p),m(mr,e,p),i(e,Zb,p),i(e,us,p),s(us,XA),s(us,Yu),s(Yu,QA),s(us,eS),s(us,A1),s(A1,sS),s(us,tS),i(e,Nb,p),i(e,Ku,p),s(Ku,aS),i(e,Hb,p),m(_r,e,p),i(e,Bb,p),i(e,Xa,p),s(Xa,nS),s(Xa,Ju),s(Ju,oS),s(Xa,lS),i(e,Wb,p),i(e,Xu,p),i(e,Fb,p),i(e,st,p),s(st,Qa),s(Qa,S1),m(vr,S1,null),s(st,rS),s(st,C1),s(C1,pS),i(e,Vb,p),i(e,en,p),s(en,iS),s(en,x1),s(x1,uS),s(en,cS),i(e,Yb,p),i(e,Qu,p),s(Qu,R1),s(R1,hS),i(e,Kb,p),i(e,sn,p),s(sn,fS),s(sn,I1),s(I1,dS),s(sn,mS),i(e,Jb,p),i(e,T,p),s(T,_S),s(T,U1),s(U1,vS),s(T,jS),s(T,G1),s(G1,gS),s(T,wS),s(T,L1),s(L1,yS),s(T,bS),s(T,M1),s(M1,ES),s(T,qS),s(T,Z1),s(Z1,$S),s(T,kS),s(T,N1),s(N1,PS),s(T,DS),i(e,Xb,p),m(jr,e,p),i(e,Qb,p),i(e,ec,p),s(ec,H1),s(H1,zS),i(e,e3,p),i(e,tn,p),s(tn,OS),s(tn,gr),s(gr,TS),s(tn,AS),i(e,s3,p),i(e,sc,p),s(sc,B1),s(B1,SS),i(e,t3,p),i(e,tc,p),s(tc,CS),i(e,a3,p),i(e,ac,p),s(ac,xS),i(e,n3,p),m(wr,e,p),i(e,o3,p),i(e,cs,p),s(cs,RS),s(cs,W1),s(W1,IS),s(cs,US),s(cs,F1),s(F1,GS),s(cs,LS),i(e,l3,p),m(yr,e,p),i(e,r3,p),m(an,e,p),i(e,p3,p),i(e,nn,p),s(nn,MS),s(nn,V1),s(V1,ZS),s(nn,NS),i(e,i3,p),i(e,on,p),s(on,HS),s(on,Y1),s(Y1,BS),s(on,WS),i(e,u3,p),m(br,e,p),i(e,c3,p),i(e,nc,p),s(nc,K1),s(K1,FS),i(e,h3,p),i(e,hs,p),s(hs,VS),s(hs,J1),s(J1,YS),s(hs,KS),s(hs,X1),s(X1,JS),s(hs,XS),i(e,f3,p),i(e,oc,p),s(oc,QS),i(e,d3,p),m(Er,e,p),i(e,m3,p),i(e,ln,p),s(ln,eC),s(ln,Q1),s(Q1,sC),s(ln,tC),i(e,_3,p),m(qr,e,p),i(e,v3,p),i(e,rn,p),s(rn,aC),s(rn,ev),s(ev,nC),s(rn,oC),i(e,j3,p),i(e,lc,p),s(lc,lC),i(e,g3,p),i(e,$r,p),s($r,sv),s(sv,rC),s($r,pC),i(e,w3,p),i(e,fs,p),s(fs,iC),s(fs,tv),s(tv,uC),s(fs,cC),s(fs,av),s(av,hC),s(fs,fC),i(e,y3,p),i(e,rc,p),s(rc,dC),i(e,b3,p),i(e,tt,p),s(tt,pn),s(pn,nv),m(kr,nv,null),s(tt,mC),s(tt,ov),s(ov,_C),i(e,E3,p),i(e,pc,p),s(pc,vC),i(e,q3,p),i(e,ic,p),s(ic,jC),i(e,$3,p),i(e,uc,p),s(uc,gC),i(e,k3,p),i(e,at,p),s(at,un),s(un,lv),m(Pr,lv,null),s(at,wC),s(at,rv),s(rv,yC),i(e,P3,p),i(e,cn,p),s(cn,bC),s(cn,pv),s(pv,EC),s(cn,qC),i(e,D3,p),m(Dr,e,p),i(e,z3,p),i(e,cc,p),s(cc,$C),i(e,O3,p),i(e,D,p),s(D,kC),s(D,iv),s(iv,PC),s(D,DC),s(D,uv),s(uv,zC),s(D,OC),s(D,cv),s(cv,TC),s(D,AC),s(D,hc),s(hc,SC),s(D,CC),s(D,fc),s(fc,xC),s(D,RC),s(D,hv),s(hv,IC),s(D,UC),s(D,fv),s(fv,GC),s(D,LC),i(e,T3,p),m(zr,e,p),i(e,A3,p),i(e,hn,p),s(hn,MC),s(hn,dv),s(dv,ZC),s(hn,NC),i(e,S3,p),i(e,dc,p),s(dc,HC),i(e,C3,p),i(e,fn,p),s(fn,BC),s(fn,Or),s(Or,WC),s(fn,FC),i(e,x3,p),i(e,fe,p),s(fe,VC),s(fe,mv),s(mv,YC),s(fe,KC),s(fe,_v),s(_v,JC),s(fe,XC),s(fe,mc),s(mc,QC),s(fe,ex),i(e,R3,p),i(e,nt,p),s(nt,dn),s(dn,vv),m(Tr,vv,null),s(nt,sx),s(nt,jv),s(jv,tx),i(e,I3,p),i(e,Ar,p),s(Ar,ax),s(Ar,Sr),s(Sr,nx),i(e,U3,p),i(e,mn,p),s(mn,ox),s(mn,gv),s(gv,lx),s(mn,rx),i(e,G3,p),i(e,_c,p),s(_c,px),i(e,L3,p),m(Cr,e,p),i(e,M3,p),i(e,ds,p),s(ds,ix),s(ds,wv),s(wv,ux),s(ds,cx),s(ds,yv),s(yv,hx),s(ds,fx),i(e,Z3,p),i(e,vc,p),i(e,N3,p),i(e,ot,p),s(ot,_n),s(_n,bv),m(xr,bv,null),s(ot,dx),s(ot,Ev),s(Ev,mx),i(e,H3,p),i(e,jc,p),s(jc,_x),i(e,B3,p),i(e,vn,p),s(vn,vx),s(vn,gc),s(gc,jx),s(vn,gx),i(e,W3,p),m(Rr,e,p),i(e,F3,p),i(e,wc,p),s(wc,wx),i(e,V3,p),i(e,jn,p),s(jn,yx),s(jn,qv),s(qv,bx),s(jn,Ex),i(e,Y3,p),m(Ir,e,p),i(e,K3,p),i(e,yc,p),s(yc,qx),i(e,J3,p),i(e,bc,p),s(bc,$x),i(e,X3,p),i(e,lt,p),s(lt,gn),s(gn,$v),m(Ur,$v,null),s(lt,kx),s(lt,kv),s(kv,Px),i(e,Q3,p),i(e,Ec,p),s(Ec,Dx),i(e,e0,p),i(e,qc,p),s(qc,zx),i(e,s0,p),m(Gr,e,p),i(e,t0,p),i(e,$c,p),s($c,Ox),i(e,a0,p),i(e,kc,p),s(kc,Tx),i(e,n0,p),i(e,Pc,p),s(Pc,Ax),i(e,o0,p),i(e,Dc,p),s(Dc,Sx),i(e,l0,p),m(Lr,e,p),i(e,r0,p),i(e,zc,p),s(zc,Cx),i(e,p0,p),i(e,wn,p),s(wn,xx),s(wn,Mr),s(Mr,Rx),s(wn,Ix),i(e,i0,p),i(e,rt,p),s(rt,yn),s(yn,Pv),m(Zr,Pv,null),s(rt,Ux),s(rt,Dv),s(Dv,Gx),i(e,u0,p),i(e,Oc,p),s(Oc,Lx),i(e,c0,p),i(e,Tc,p),s(Tc,Mx),i(e,h0,p),i(e,H,p),s(H,zv),s(zv,Ov),s(Ov,Zx),s(H,Nx),s(H,Tv),s(Tv,Te),s(Te,Hx),s(Te,Ac),s(Ac,Bx),s(Te,Wx),s(Te,Sc),s(Sc,Fx),s(Te,Vx),s(Te,Cc),s(Cc,Yx),s(Te,Kx),s(H,Jx),s(H,Nr),s(Nr,Av),s(Av,Xx),s(Nr,Qx),m(Hr,Nr,null),s(H,eR),s(H,Sv),s(Sv,Br),s(Br,sR),s(Br,Wr),s(Wr,tR),s(Br,aR),s(H,nR),s(H,Cv),s(Cv,xv),s(xv,oR),s(H,lR),s(H,Rv),s(Rv,Fr),s(Fr,rR),s(Fr,Vr),s(Vr,pR),s(Fr,iR),i(e,f0,p),i(e,xc,p),s(xc,uR),i(e,d0,p),i(e,bn,p),s(bn,pt),s(pt,Iv),s(Iv,cR),s(pt,hR),s(pt,Uv),s(Uv,fR),s(pt,dR),s(pt,Gv),s(Gv,mR),s(bn,_R),s(bn,Lv),s(Lv,Yr),s(Yr,vR),s(Yr,Kr),s(Kr,jR),s(Yr,gR),i(e,m0,p),i(e,it,p),s(it,En),s(En,Mv),m(Jr,Mv,null),s(it,wR),s(it,Zv),s(Zv,yR),i(e,_0,p),i(e,ut,p),s(ut,qn),s(qn,Nv),m(Xr,Nv,null),s(ut,bR),s(ut,Qr),s(Qr,ER),s(Qr,Hv),s(Hv,qR),s(Qr,$R),i(e,v0,p),i(e,B,p),s(B,kR),s(B,Bv),s(Bv,PR),s(B,DR),s(B,Wv),s(Wv,zR),s(B,OR),s(B,Fv),s(Fv,TR),s(B,AR),s(B,Vv),s(Vv,SR),s(B,CR),s(B,ep),s(ep,xR),s(B,RR),i(e,j0,p),i(e,ct,p),s(ct,$n),s($n,Yv),m(sp,Yv,null),s(ct,IR),s(ct,Rc),s(Rc,UR),s(Rc,Kv),s(Kv,GR),i(e,g0,p),i(e,Ic,p),s(Ic,LR),i(e,w0,p),i(e,Uc,p),s(Uc,MR),i(e,y0,p),m(tp,e,p),i(e,b0,p),i(e,kn,p),s(kn,ZR),s(kn,Jv),s(Jv,NR),s(kn,HR),i(e,E0,p),m(ap,e,p),i(e,q0,p),i(e,Gc,p),s(Gc,BR),i(e,$0,p),i(e,Lc,p),s(Lc,WR),i(e,k0,p),i(e,ms,p),s(ms,FR),s(ms,Xv),s(Xv,VR),s(ms,YR),s(ms,Qv),s(Qv,KR),s(ms,JR),i(e,P0,p),i(e,ht,p),s(ht,Pn),s(Pn,ej),m(np,ej,null),s(ht,XR),s(ht,sj),s(sj,QR),i(e,D0,p),i(e,_s,p),s(_s,Dn),s(Dn,eI),s(Dn,Mc),s(Mc,sI),s(Dn,tI),s(Dn,tj),s(tj,aI),s(_s,nI),s(_s,op),s(op,oI),s(op,lp),s(lp,lI),s(op,rI),s(_s,pI),s(_s,ft),s(ft,iI),s(ft,Zc),s(Zc,uI),s(ft,cI),s(ft,rp),s(rp,hI),s(ft,fI),i(e,z0,p),i(e,Nc,p),i(e,O0,p),i(e,dt,p),s(dt,zn),s(zn,aj),m(pp,aj,null),s(dt,dI),s(dt,nj),s(nj,mI),i(e,T0,p),i(e,de,p),s(de,_I),s(de,Hc),s(Hc,vI),s(de,jI),s(de,Bc),s(Bc,gI),s(de,wI),s(de,oj),s(oj,yI),s(de,bI),i(e,A0,p),i(e,On,p),s(On,EI),s(On,Wc),s(Wc,qI),s(On,$I),i(e,S0,p),i(e,vs,p),s(vs,kI),s(vs,Fc),s(Fc,PI),s(vs,DI),s(vs,Vc),s(Vc,zI),s(vs,OI),i(e,C0,p),i(e,Tn,p),s(Tn,TI),s(Tn,lj),s(lj,AI),s(Tn,SI),i(e,x0,p),i(e,Yc,p),s(Yc,CI),i(e,R0,p),m(ip,e,p),i(e,I0,p),i(e,Kc,p),s(Kc,xI),i(e,U0,p),m(up,e,p),i(e,G0,p),i(e,me,p),s(me,RI),s(me,Jc),s(Jc,II),s(me,UI),s(me,cp),s(cp,GI),s(me,LI),s(me,rj),s(rj,MI),s(me,ZI),i(e,L0,p),i(e,mt,p),s(mt,An),s(An,pj),m(hp,pj,null),s(mt,NI),s(mt,ij),s(ij,HI),i(e,M0,p),i(e,P,p),m(fp,P,null),s(P,BI),s(P,uj),s(uj,WI),s(P,FI),s(P,Ae),s(Ae,VI),s(Ae,cj),s(cj,YI),s(Ae,KI),s(Ae,hj),s(hj,JI),s(Ae,XI),s(Ae,fj),s(fj,QI),s(Ae,eU),s(P,sU),s(P,_e),s(_e,Xc),s(Xc,tU),s(_e,aU),s(_e,dj),s(dj,nU),s(_e,oU),s(_e,Qc),s(Qc,lU),s(_e,rU),s(_e,mj),s(mj,pU),s(_e,iU),s(P,uU),s(P,js),m(dp,js,null),s(js,cU),s(js,_j),s(_j,hU),s(js,fU),s(js,_t),s(_t,dU),s(_t,vj),s(vj,mU),s(_t,_U),s(_t,jj),s(jj,vU),s(_t,jU),s(P,gU),s(P,Sn),m(mp,Sn,null),s(Sn,wU),s(Sn,_p),s(_p,yU),s(_p,gj),s(gj,bU),s(_p,EU),s(P,qU),s(P,Cn),m(vp,Cn,null),s(Cn,$U),s(Cn,vt),s(vt,kU),s(vt,wj),s(wj,PU),s(vt,DU),s(vt,yj),s(yj,zU),s(vt,OU),s(P,TU),s(P,xn),m(jp,xn,null),s(xn,AU),s(xn,jt),s(jt,SU),s(jt,bj),s(bj,CU),s(jt,xU),s(jt,Ej),s(Ej,RU),s(jt,IU),i(e,Z0,p),i(e,gt,p),s(gt,Rn),s(Rn,qj),m(gp,qj,null),s(gt,UU),s(gt,$j),s($j,GU),i(e,N0,p),i(e,In,p),s(In,LU),s(In,eh),s(eh,MU),s(In,ZU),i(e,H0,p),i(e,sh,p),s(sh,NU),i(e,B0,p),i(e,th,p),s(th,HU),i(e,W0,p),i(e,ah,p),s(ah,BU),i(e,F0,p),i(e,Un,p),s(Un,kj),s(kj,WU),s(Un,FU),s(Un,Pj),s(Pj,VU),i(e,V0,p),m(wp,e,p),i(e,Y0,p),i(e,Gn,p),s(Gn,YU),s(Gn,Dj),s(Dj,KU),s(Gn,JU),i(e,K0,p),m(yp,e,p),i(e,J0,p),i(e,nh,p),s(nh,XU),i(e,X0,p),i(e,wt,p),s(wt,Ln),s(Ln,zj),m(bp,zj,null),s(wt,QU),s(wt,Oj),s(Oj,eG),i(e,Q0,p),i(e,ve,p),s(ve,Tj),s(Tj,Ep),s(Ep,sG),s(ve,tG),s(ve,Aj),s(Aj,qp),s(qp,aG),s(ve,nG),s(ve,Sj),s(Sj,$p),s($p,oG),s(ve,lG),s(ve,Cj),s(Cj,kp),s(kp,rG),i(e,eE,p),i(e,oh,p),s(oh,pG),i(e,sE,p),i(e,gs,p),s(gs,xj),s(xj,Pp),s(Pp,iG),s(gs,uG),s(gs,Rj),s(Rj,Dp),s(Dp,cG),s(gs,hG),s(gs,Ij),s(Ij,zp),s(zp,fG),i(e,tE,p),i(e,ws,p),s(ws,dG),s(ws,lh),s(lh,mG),s(ws,_G),s(ws,Op),s(Op,vG),s(ws,jG),aE=!0},p(e,[p]){const Tp={};p&2&&(Tp.$$scope={dirty:p,ctx:e}),ta.$set(Tp);const Uj={};p&2&&(Uj.$$scope={dirty:p,ctx:e}),Za.$set(Uj);const Gj={};p&2&&(Gj.$$scope={dirty:p,ctx:e}),an.$set(Gj)},i(e){aE||(_(z.$$.fragment,e),_(po.$$.fragment,e),_(io.$$.fragment,e),_(uo.$$.fragment,e),_(co.$$.fragment,e),_(mo.$$.fragment,e),_(_o.$$.fragment,e),_(vo.$$.fragment,e),_(go.$$.fragment,e),_(wo.$$.fragment,e),_(yo.$$.fragment,e),_(Eo.$$.fragment,e),_($o.$$.fragment,e),_(ko.$$.fragment,e),_(Do.$$.fragment,e),_(Oo.$$.fragment,e),_(To.$$.fragment,e),_(So.$$.fragment,e),_(Ro.$$.fragment,e),_(Io.$$.fragment,e),_(Uo.$$.fragment,e),_(Go.$$.fragment,e),_(Lo.$$.fragment,e),_(Mo.$$.fragment,e),_(Zo.$$.fragment,e),_(Bo.$$.fragment,e),_(Wo.$$.fragment,e),_(Vo.$$.fragment,e),_(Yo.$$.fragment,e),_(Ko.$$.fragment,e),_(Jo.$$.fragment,e),_(Xo.$$.fragment,e),_(ta.$$.fragment,e),_(el.$$.fragment,e),_(nl.$$.fragment,e),_(ol.$$.fragment,e),_(ll.$$.fragment,e),_(rl.$$.fragment,e),_(pl.$$.fragment,e),_(jl.$$.fragment,e),_(gl.$$.fragment,e),_(El.$$.fragment,e),_($l.$$.fragment,e),_(kl.$$.fragment,e),_(Pl.$$.fragment,e),_(Dl.$$.fragment,e),_(zl.$$.fragment,e),_(Ol.$$.fragment,e),_(Tl.$$.fragment,e),_(Al.$$.fragment,e),_(Cl.$$.fragment,e),_(Gl.$$.fragment,e),_(Ll.$$.fragment,e),_(Ml.$$.fragment,e),_(Hl.$$.fragment,e),_(Bl.$$.fragment,e),_(Wl.$$.fragment,e),_(Fl.$$.fragment,e),_(Vl.$$.fragment,e),_(Kl.$$.fragment,e),_(Jl.$$.fragment,e),_(Xl.$$.fragment,e),_(Ql.$$.fragment,e),_(sr.$$.fragment,e),_(tr.$$.fragment,e),_(ar.$$.fragment,e),_(Za.$$.fragment,e),_(nr.$$.fragment,e),_(or.$$.fragment,e),_(lr.$$.fragment,e),_(pr.$$.fragment,e),_(ir.$$.fragment,e),_(ur.$$.fragment,e),_(cr.$$.fragment,e),_(hr.$$.fragment,e),_(fr.$$.fragment,e),_(dr.$$.fragment,e),_(mr.$$.fragment,e),_(_r.$$.fragment,e),_(vr.$$.fragment,e),_(jr.$$.fragment,e),_(wr.$$.fragment,e),_(yr.$$.fragment,e),_(an.$$.fragment,e),_(br.$$.fragment,e),_(Er.$$.fragment,e),_(qr.$$.fragment,e),_(kr.$$.fragment,e),_(Pr.$$.fragment,e),_(Dr.$$.fragment,e),_(zr.$$.fragment,e),_(Tr.$$.fragment,e),_(Cr.$$.fragment,e),_(xr.$$.fragment,e),_(Rr.$$.fragment,e),_(Ir.$$.fragment,e),_(Ur.$$.fragment,e),_(Gr.$$.fragment,e),_(Lr.$$.fragment,e),_(Zr.$$.fragment,e),_(Hr.$$.fragment,e),_(Jr.$$.fragment,e),_(Xr.$$.fragment,e),_(sp.$$.fragment,e),_(tp.$$.fragment,e),_(ap.$$.fragment,e),_(np.$$.fragment,e),_(pp.$$.fragment,e),_(ip.$$.fragment,e),_(up.$$.fragment,e),_(hp.$$.fragment,e),_(fp.$$.fragment,e),_(dp.$$.fragment,e),_(mp.$$.fragment,e),_(vp.$$.fragment,e),_(jp.$$.fragment,e),_(gp.$$.fragment,e),_(wp.$$.fragment,e),_(yp.$$.fragment,e),_(bp.$$.fragment,e),aE=!0)},o(e){v(z.$$.fragment,e),v(po.$$.fragment,e),v(io.$$.fragment,e),v(uo.$$.fragment,e),v(co.$$.fragment,e),v(mo.$$.fragment,e),v(_o.$$.fragment,e),v(vo.$$.fragment,e),v(go.$$.fragment,e),v(wo.$$.fragment,e),v(yo.$$.fragment,e),v(Eo.$$.fragment,e),v($o.$$.fragment,e),v(ko.$$.fragment,e),v(Do.$$.fragment,e),v(Oo.$$.fragment,e),v(To.$$.fragment,e),v(So.$$.fragment,e),v(Ro.$$.fragment,e),v(Io.$$.fragment,e),v(Uo.$$.fragment,e),v(Go.$$.fragment,e),v(Lo.$$.fragment,e),v(Mo.$$.fragment,e),v(Zo.$$.fragment,e),v(Bo.$$.fragment,e),v(Wo.$$.fragment,e),v(Vo.$$.fragment,e),v(Yo.$$.fragment,e),v(Ko.$$.fragment,e),v(Jo.$$.fragment,e),v(Xo.$$.fragment,e),v(ta.$$.fragment,e),v(el.$$.fragment,e),v(nl.$$.fragment,e),v(ol.$$.fragment,e),v(ll.$$.fragment,e),v(rl.$$.fragment,e),v(pl.$$.fragment,e),v(jl.$$.fragment,e),v(gl.$$.fragment,e),v(El.$$.fragment,e),v($l.$$.fragment,e),v(kl.$$.fragment,e),v(Pl.$$.fragment,e),v(Dl.$$.fragment,e),v(zl.$$.fragment,e),v(Ol.$$.fragment,e),v(Tl.$$.fragment,e),v(Al.$$.fragment,e),v(Cl.$$.fragment,e),v(Gl.$$.fragment,e),v(Ll.$$.fragment,e),v(Ml.$$.fragment,e),v(Hl.$$.fragment,e),v(Bl.$$.fragment,e),v(Wl.$$.fragment,e),v(Fl.$$.fragment,e),v(Vl.$$.fragment,e),v(Kl.$$.fragment,e),v(Jl.$$.fragment,e),v(Xl.$$.fragment,e),v(Ql.$$.fragment,e),v(sr.$$.fragment,e),v(tr.$$.fragment,e),v(ar.$$.fragment,e),v(Za.$$.fragment,e),v(nr.$$.fragment,e),v(or.$$.fragment,e),v(lr.$$.fragment,e),v(pr.$$.fragment,e),v(ir.$$.fragment,e),v(ur.$$.fragment,e),v(cr.$$.fragment,e),v(hr.$$.fragment,e),v(fr.$$.fragment,e),v(dr.$$.fragment,e),v(mr.$$.fragment,e),v(_r.$$.fragment,e),v(vr.$$.fragment,e),v(jr.$$.fragment,e),v(wr.$$.fragment,e),v(yr.$$.fragment,e),v(an.$$.fragment,e),v(br.$$.fragment,e),v(Er.$$.fragment,e),v(qr.$$.fragment,e),v(kr.$$.fragment,e),v(Pr.$$.fragment,e),v(Dr.$$.fragment,e),v(zr.$$.fragment,e),v(Tr.$$.fragment,e),v(Cr.$$.fragment,e),v(xr.$$.fragment,e),v(Rr.$$.fragment,e),v(Ir.$$.fragment,e),v(Ur.$$.fragment,e),v(Gr.$$.fragment,e),v(Lr.$$.fragment,e),v(Zr.$$.fragment,e),v(Hr.$$.fragment,e),v(Jr.$$.fragment,e),v(Xr.$$.fragment,e),v(sp.$$.fragment,e),v(tp.$$.fragment,e),v(ap.$$.fragment,e),v(np.$$.fragment,e),v(pp.$$.fragment,e),v(ip.$$.fragment,e),v(up.$$.fragment,e),v(hp.$$.fragment,e),v(fp.$$.fragment,e),v(dp.$$.fragment,e),v(mp.$$.fragment,e),v(vp.$$.fragment,e),v(jp.$$.fragment,e),v(gp.$$.fragment,e),v(wp.$$.fragment,e),v(yp.$$.fragment,e),v(bp.$$.fragment,e),aE=!1},d(e){t(y),e&&t(C),e&&t(b),j(z),e&&t(ae),e&&t(S),e&&t(Bj),e&&t(I),e&&t(Wj),e&&t(Se),e&&t(Fj),e&&t(Up),e&&t(Vj),e&&t(Gp),e&&t(Yj),e&&t(Et),e&&t(Kj),e&&t(qt),e&&t(Jj),e&&t(Np),e&&t(Xj),e&&t(Hp),e&&t(Qj),e&&t(Bp),e&&t(eg),e&&t(Wp),e&&t(sg),e&&t(Fp),e&&t(tg),e&&t(Yp),e&&t(ag),e&&t(Kp),e&&t(ng),e&&t($s),j(po),e&&t(og),e&&t(Jp),e&&t(lg),e&&t(ks),j(io),e&&t(rg),e&&t(Xp),e&&t(pg),j(uo,e),e&&t(ig),e&&t(Ce),e&&t(ug),j(co,e),e&&t(cg),e&&t(xe),e&&t(hg),e&&t(Pt),e&&t(fg),e&&t(ei),e&&t(dg),e&&t(si),e&&t(mg),j(mo,e),e&&t(_g),e&&t(Re),e&&t(vg),e&&t(Dt),e&&t(jg),j(_o,e),e&&t(gg),e&&t(Pe),e&&t(wg),e&&t(ti),e&&t(yg),j(vo,e),e&&t(bg),e&&t(Ie),e&&t(Eg),e&&t(zt),e&&t(qg),e&&t(Ue),e&&t($g),e&&t(ai),e&&t(kg),j(go,e),e&&t(Pg),e&&t(ni),e&&t(Dg),j(wo,e),e&&t(zg),e&&t(oi),e&&t(Og),j(yo,e),e&&t(Tg),e&&t(Ot),e&&t(Ag),e&&t(Tt),e&&t(Sg),e&&t(At),e&&t(Cg),e&&t(li),e&&t(xg),e&&t(Ps),j(Eo),e&&t(Rg),e&&t(Ct),e&&t(Ig),e&&t(xt),e&&t(Ug),e&&t(pi),e&&t(Gg),j($o,e),e&&t(Lg),e&&t(ii),e&&t(Mg),j(ko,e),e&&t(Zg),e&&t(U),e&&t(Ng),e&&t(ne),e&&t(Hg),e&&t(Rt),e&&t(Bg),j(Do,e),e&&t(Wg),e&&t(It),e&&t(Fg),e&&t(Ut),e&&t(Vg),e&&t(ui),e&&t(Yg),e&&t(zs),j(Oo),e&&t(Kg),e&&t(Lt),e&&t(Jg),j(To,e),e&&t(Xg),e&&t(Ge),e&&t(Qg),e&&t(hi),e&&t(ew),e&&t(Mt),e&&t(sw),e&&t(fi),e&&t(tw),j(So,e),e&&t(aw),e&&t(di),e&&t(nw),e&&t(Zt),e&&t(ow),e&&t(mi),e&&t(lw),e&&t(_i),e&&t(rw),e&&t(vi),j(Ro),e&&t(pw),e&&t(ji),e&&t(iw),e&&t(Ts),j(Io),e&&t(uw),e&&t(Ht),e&&t(cw),e&&t(gi),e&&t(hw),j(Uo,e),e&&t(fw),e&&t(Bt),e&&t(dw),e&&t(wi),e&&t(mw),e&&t(yi),e&&t(_w),j(Go,e),e&&t(vw),e&&t(Le),e&&t(jw),j(Lo,e),e&&t(gw),e&&t(Wt),e&&t(ww),j(Mo,e),e&&t(yw),e&&t(bi),e&&t(bw),e&&t(Ft),e&&t(Ew),e&&t(Ei),e&&t(qw),e&&t(As),j(Zo),e&&t($w),e&&t(Yt),e&&t(kw),e&&t(Kt),e&&t(Pw),j(Bo,e),e&&t(Dw),e&&t(Jt),e&&t(zw),j(Wo,e),e&&t(Ow),e&&t(Xt),e&&t(Tw),e&&t(qi),e&&t(Aw),e&&t(oe),e&&t(Sw),j(Vo,e),e&&t(Cw),e&&t(Qt),e&&t(xw),e&&t(ki),e&&t(Rw),e&&t(Ss),j(Yo),e&&t(Iw),e&&t(G),e&&t(Uw),e&&t(Oi),e&&t(Gw),j(Ko,e),e&&t(Lw),e&&t(Ti),e&&t(Mw),j(Jo,e),e&&t(Zw),e&&t(Ai),e&&t(Nw),e&&t(Cs),j(Xo),e&&t(Hw),j(ta,e),e&&t(Bw),e&&t(Me),e&&t(Ww),e&&t(aa),e&&t(Fw),e&&t(Ze),e&&t(Vw),e&&t(Ii),e&&t(Yw),e&&t(na),e&&t(Kw),e&&t(oa),e&&t(Jw),e&&t(le),e&&t(Xw),e&&t(Mi),e&&t(Qw),e&&t(xs),j(el),e&&t(ey),e&&t(sl),e&&t(sy),e&&t(Ne),e&&t(ty),e&&t(ra),e&&t(ay),e&&t(Ni),e&&t(ny),e&&t(Hi),e&&t(oy),e&&t(Rs),j(nl),e&&t(ly),e&&t(Bi),e&&t(ry),j(ol,e),e&&t(py),e&&t(Wi),e&&t(iy),e&&t(He),e&&t(uy),e&&t(Be),e&&t(cy),j(ll,e),e&&t(hy),e&&t(Fi),e&&t(fy),e&&t(Vi),e&&t(dy),e&&t(Us),j(rl),e&&t(my),e&&t(Yi),e&&t(_y),j(pl,e),e&&t(vy),e&&t(K),e&&t(jy),e&&t(We),e&&t(gy),e&&t(Ki),e&&t(wy),e&&t(ua),e&&t(yy),e&&t(M),e&&t(by),e&&t(ze),e&&t(Ey),e&&t(Ji),e&&t(qy),e&&t(Fe),e&&t($y),e&&t(Ve),e&&t(ky),e&&t(dl),e&&t(Py),e&&t(re),e&&t(Dy),e&&t(Qi),e&&t(zy),e&&t(Oe),e&&t(Oy),e&&t(Ye),e&&t(Ty),e&&t(ca),e&&t(Ay),e&&t(eu),e&&t(Sy),e&&t(Gs),j(jl),e&&t(Cy),e&&t(su),e&&t(xy),e&&t(tu),e&&t(Ry),j(gl,e),e&&t(Iy),e&&t(fa),e&&t(Uy),e&&t(Ke),e&&t(Gy),e&&t(da),e&&t(Ly),e&&t(Je),e&&t(My),e&&t(au),e&&t(Zy),e&&t(Ls),j(El),e&&t(Ny),e&&t(nu),e&&t(Hy),e&&t(ou),e&&t(By),e&&t(_a),e&&t(Wy),e&&t(Xe),e&&t(Fy),e&&t(lu),e&&t(Vy),e&&t(Zs),j($l),e&&t(Yy),e&&t(ja),e&&t(Ky),j(kl,e),e&&t(Jy),e&&t(ga),e&&t(Xy),j(Pl,e),e&&t(Qy),e&&t(ru),e&&t(e2),e&&t(Ns),j(Dl),e&&t(s2),e&&t(ya),e&&t(t2),j(zl,e),e&&t(a2),e&&t(ba),e&&t(n2),j(Ol,e),e&&t(o2),e&&t(Hs),j(Tl),e&&t(l2),e&&t(qa),e&&t(r2),e&&t(pu),e&&t(p2),e&&t($a),e&&t(i2),e&&t(iu),e&&t(u2),e&&t(Bs),j(Al),e&&t(c2),e&&t(Qe),e&&t(h2),e&&t($),e&&t(f2),e&&t(es),e&&t(d2),j(Cl,e),e&&t(m2),e&&t(cu),e&&t(_2),e&&t(pe),e&&t(v2),e&&t(hu),e&&t(j2),e&&t(fu),e&&t(g2),j(Gl,e),e&&t(w2),e&&t(Pa),e&&t(y2),e&&t(mu),e&&t(b2),j(Ll,e),e&&t(E2),e&&t(ie),e&&t(q2),e&&t(_u),e&&t($2),e&&t(Ws),j(Ml),e&&t(k2),e&&t(Z),e&&t(P2),e&&t(vu),e&&t(D2),e&&t(za),e&&t(z2),e&&t(O),e&&t(O2),e&&t(ts),e&&t(T2),j(Hl,e),e&&t(A2),e&&t(as),e&&t(S2),e&&t(ue),e&&t(C2),e&&t(wu),e&&t(x2),j(Bl,e),e&&t(R2),e&&t(Aa),e&&t(I2),e&&t(Sa),e&&t(U2),j(Wl,e),e&&t(G2),e&&t(J),e&&t(L2),e&&t(bu),e&&t(M2),e&&t(Fs),j(Fl),e&&t(Z2),e&&t(Eu),e&&t(N2),e&&t(xa),e&&t(H2),j(Vl,e),e&&t(B2),e&&t(Ra),e&&t(W2),e&&t(ce),e&&t(F2),e&&t(qu),e&&t(V2),e&&t(Vs),j(Kl),e&&t(Y2),e&&t($u),e&&t(K2),e&&t(Ys),j(Jl),e&&t(J2),e&&t(ku),e&&t(X2),j(Xl,e),e&&t(Q2),e&&t(ls),e&&t(eb),e&&t(rs),e&&t(sb),e&&t(Du),e&&t(tb),j(Ql,e),e&&t(ab),e&&t(Ga),e&&t(nb),e&&t(La),e&&t(ob),e&&t(Ks),j(sr),e&&t(lb),e&&t(Ou),e&&t(rb),j(tr,e),e&&t(pb),e&&t(Tu),e&&t(ib),e&&t(ps),e&&t(ub),e&&t(Au),e&&t(cb),j(ar,e),e&&t(hb),j(Za,e),e&&t(fb),e&&t(Js),j(nr),e&&t(db),e&&t(Su),e&&t(mb),j(or,e),e&&t(_b),e&&t(he),e&&t(vb),e&&t(Ha),e&&t(jb),e&&t(xu),e&&t(gb),j(lr,e),e&&t(wb),e&&t(Ba),e&&t(yb),e&&t(Wa),e&&t(bb),e&&t(Iu),e&&t(Eb),e&&t(Xs),j(pr),e&&t(qb),e&&t(Uu),e&&t($b),j(ir,e),e&&t(kb),e&&t(N),e&&t(Pb),e&&t(Lu),e&&t(Db),j(ur,e),e&&t(zb),e&&t(Va),e&&t(Ob),e&&t(Zu),e&&t(Tb),e&&t(Qs),j(cr),e&&t(Ab),e&&t(Nu),e&&t(Sb),j(hr,e),e&&t(Cb),e&&t(is),e&&t(xb),e&&t(Bu),e&&t(Rb),j(fr,e),e&&t(Ib),e&&t(Ka),e&&t(Ub),e&&t(Fu),e&&t(Gb),e&&t(et),j(dr),e&&t(Lb),e&&t(Vu),e&&t(Mb),j(mr,e),e&&t(Zb),e&&t(us),e&&t(Nb),e&&t(Ku),e&&t(Hb),j(_r,e),e&&t(Bb),e&&t(Xa),e&&t(Wb),e&&t(Xu),e&&t(Fb),e&&t(st),j(vr),e&&t(Vb),e&&t(en),e&&t(Yb),e&&t(Qu),e&&t(Kb),e&&t(sn),e&&t(Jb),e&&t(T),e&&t(Xb),j(jr,e),e&&t(Qb),e&&t(ec),e&&t(e3),e&&t(tn),e&&t(s3),e&&t(sc),e&&t(t3),e&&t(tc),e&&t(a3),e&&t(ac),e&&t(n3),j(wr,e),e&&t(o3),e&&t(cs),e&&t(l3),j(yr,e),e&&t(r3),j(an,e),e&&t(p3),e&&t(nn),e&&t(i3),e&&t(on),e&&t(u3),j(br,e),e&&t(c3),e&&t(nc),e&&t(h3),e&&t(hs),e&&t(f3),e&&t(oc),e&&t(d3),j(Er,e),e&&t(m3),e&&t(ln),e&&t(_3),j(qr,e),e&&t(v3),e&&t(rn),e&&t(j3),e&&t(lc),e&&t(g3),e&&t($r),e&&t(w3),e&&t(fs),e&&t(y3),e&&t(rc),e&&t(b3),e&&t(tt),j(kr),e&&t(E3),e&&t(pc),e&&t(q3),e&&t(ic),e&&t($3),e&&t(uc),e&&t(k3),e&&t(at),j(Pr),e&&t(P3),e&&t(cn),e&&t(D3),j(Dr,e),e&&t(z3),e&&t(cc),e&&t(O3),e&&t(D),e&&t(T3),j(zr,e),e&&t(A3),e&&t(hn),e&&t(S3),e&&t(dc),e&&t(C3),e&&t(fn),e&&t(x3),e&&t(fe),e&&t(R3),e&&t(nt),j(Tr),e&&t(I3),e&&t(Ar),e&&t(U3),e&&t(mn),e&&t(G3),e&&t(_c),e&&t(L3),j(Cr,e),e&&t(M3),e&&t(ds),e&&t(Z3),e&&t(vc),e&&t(N3),e&&t(ot),j(xr),e&&t(H3),e&&t(jc),e&&t(B3),e&&t(vn),e&&t(W3),j(Rr,e),e&&t(F3),e&&t(wc),e&&t(V3),e&&t(jn),e&&t(Y3),j(Ir,e),e&&t(K3),e&&t(yc),e&&t(J3),e&&t(bc),e&&t(X3),e&&t(lt),j(Ur),e&&t(Q3),e&&t(Ec),e&&t(e0),e&&t(qc),e&&t(s0),j(Gr,e),e&&t(t0),e&&t($c),e&&t(a0),e&&t(kc),e&&t(n0),e&&t(Pc),e&&t(o0),e&&t(Dc),e&&t(l0),j(Lr,e),e&&t(r0),e&&t(zc),e&&t(p0),e&&t(wn),e&&t(i0),e&&t(rt),j(Zr),e&&t(u0),e&&t(Oc),e&&t(c0),e&&t(Tc),e&&t(h0),e&&t(H),j(Hr),e&&t(f0),e&&t(xc),e&&t(d0),e&&t(bn),e&&t(m0),e&&t(it),j(Jr),e&&t(_0),e&&t(ut),j(Xr),e&&t(v0),e&&t(B),e&&t(j0),e&&t(ct),j(sp),e&&t(g0),e&&t(Ic),e&&t(w0),e&&t(Uc),e&&t(y0),j(tp,e),e&&t(b0),e&&t(kn),e&&t(E0),j(ap,e),e&&t(q0),e&&t(Gc),e&&t($0),e&&t(Lc),e&&t(k0),e&&t(ms),e&&t(P0),e&&t(ht),j(np),e&&t(D0),e&&t(_s),e&&t(z0),e&&t(Nc),e&&t(O0),e&&t(dt),j(pp),e&&t(T0),e&&t(de),e&&t(A0),e&&t(On),e&&t(S0),e&&t(vs),e&&t(C0),e&&t(Tn),e&&t(x0),e&&t(Yc),e&&t(R0),j(ip,e),e&&t(I0),e&&t(Kc),e&&t(U0),j(up,e),e&&t(G0),e&&t(me),e&&t(L0),e&&t(mt),j(hp),e&&t(M0),e&&t(P),j(fp),j(dp),j(mp),j(vp),j(jp),e&&t(Z0),e&&t(gt),j(gp),e&&t(N0),e&&t(In),e&&t(H0),e&&t(sh),e&&t(B0),e&&t(th),e&&t(W0),e&&t(ah),e&&t(F0),e&&t(Un),e&&t(V0),j(wp,e),e&&t(Y0),e&&t(Gn),e&&t(K0),j(yp,e),e&&t(J0),e&&t(nh),e&&t(X0),e&&t(wt),j(bp),e&&t(Q0),e&&t(ve),e&&t(eE),e&&t(oh),e&&t(sE),e&&t(gs),e&&t(tE),e&&t(ws)}}}const FK={local:"deepspeed-integration",sections:[{local:"trainer-deepspeed-integration",sections:[{local:"installation",title:"Installation"},{local:"deployment-with-multiple-gpus",title:"Deployment with multiple GPUs"},{local:"deployment-with-one-gpu",title:"Deployment with one GPU"},{local:"deployment-in-notebooks",title:"Deployment in Notebooks"},{local:"configuration",title:"Configuration"},{local:"passing-configuration",title:"Passing Configuration"},{local:"shared-configuration",title:"Shared Configuration"},{local:"zero",sections:[{local:"zero2-config",title:"ZeRO-2 Config"},{local:"zero3-config",title:"ZeRO-3 Config"}],title:"ZeRO"},{local:"nvme-support",sections:[{local:"zero2-vs-zero3-performance",title:"ZeRO-2 vs ZeRO-3 Performance"},{local:"zero2-example",title:"ZeRO-2 Example"},{local:"zero3-example",title:"ZeRO-3 Example"}],title:"NVMe Support"},{local:"optimizer-and-scheduler",sections:[{local:"optimizer",title:"Optimizer"},{local:"scheduler",title:"Scheduler"}],title:"Optimizer and Scheduler"},{local:"fp32-precision",title:"fp32 Precision"},{local:"automatic-mixed-precision",title:"Automatic Mixed Precision"},{local:"fp16",title:"fp16"},{local:"bf16",title:"bf16"},{local:"apex",title:"apex"},{local:"batch-size",title:"Batch Size"},{local:"gradient-accumulation",title:"Gradient Accumulation"},{local:"gradient-clipping",title:"Gradient Clipping"},{local:"getting-the-model-weights-out",title:"Getting The Model Weights Out"},{local:"zero3-and-infinity-nuances",sections:[{local:"constructing-massive-models",title:"Constructing Massive Models"},{local:"gathering-parameters",title:"Gathering Parameters"}],title:"ZeRO-3 and Infinity Nuances"},{local:"zero-inference",title:"ZeRO Inference"},{local:"memory-requirements",title:"Memory Requirements"},{local:"filing-issues",title:"Filing Issues"},{local:"troubleshooting",sections:[{local:"the-deepspeed-process-gets-killed-at-startup-without-a-traceback",title:"the `deepspeed` process gets killed at startup without a traceback"},{local:"training-andor-evalpredict-loss-is-nan",title:"training and/or eval/predict loss is `NaN`"}],title:"Troubleshooting"},{local:"notes",title:"Notes"}],title:"Trainer Deepspeed Integration"},{local:"nontrainer-deepspeed-integration",title:"Non-Trainer Deepspeed Integration"},{local:"transformers.deepspeed.HfDeepSpeedConfig",sections:[{local:"custom-deepspeed-zero-inference",title:"Custom DeepSpeed ZeRO Inference"}],title:"HfDeepSpeedConfig"},{local:"main-deepspeed-resources",title:"Main DeepSpeed Resources"}],title:"DeepSpeed Integration"};function VK(bt){return ZK(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class eJ extends UK{constructor(y){super();GK(this,y,VK,WK,LK,{})}}export{eJ as default,FK as metadata};
