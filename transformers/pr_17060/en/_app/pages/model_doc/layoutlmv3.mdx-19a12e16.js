...
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var h=i(p);T=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(h,"CODE",{});var P=i(_);f=a(P,"Module"),P.forEach(t),v=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){p=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){p=r(l,"P",{});var h=i(p);T=a(h,"Examples:"),h.forEach(t),_=u(l),b(f.$$.fragment,l)},m(l,h){g(l,p,h),e(p,T),g(l,_,h),L(f,l,h),v=!0},p:Qt,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){w(f.$$.fragment,l),v=!1},d(l){l&&t(p),l&&t(_),x(f,l)}}}function Ku(q){let p,T,_,f,v,l,h,P,rs,da,ae,ke,Gt,ao,is,Xt,ls,ca,K,ds,so,cs,us,it,ps,ms,ua,lt,hs,pa,dt,Jt,fs,ma,ct,gs,ha,we,Yt,_s,vs,se,ys,ut,bs,Ls,pt,ks,ws,fa,xe,Nd,ga,Te,xs,mt,Ts,Ms,_a,Z,$s,ro,zs,qs,io,Fs,Es,va,re,Me,Kt,lo,Cs,Zt,Ps,ya,N,co,As,ie,js,ht,Is,Ns,uo,Ss,Ds,Os,le,Ws,ft,Rs,Bs,gt,Us,Vs,Qs,$e,ba,de,ze,en,po,Hs,on,Gs,La,S,mo,Xs,tn,Js,Ys,ho,Ks,nn,Zs,er,or,ee,fo,tr,an,nr,ar,qe,ka,ce,Fe,sn,go,sr,rn,rr,wa,A,_o,ir,E,lr,ln,dr,cr,_t,ur,pr,dn,mr,hr,cn,fr,gr,un,_r,vr,pn,yr,br,mn,Lr,kr,wr,vo,xr,vt,Tr,Mr,$r,yt,bt,zr,qr,Fr,Ee,yo,Er,hn,Cr,Pr,Lt,bo,xa,ue,Ce,fn,Lo,Ar,gn,jr,Ta,D,ko,Ir,wo,Nr,_n,Sr,Dr,Or,xo,Wr,kt,Rr,Br,Ur,Pe,To,Vr,vn,Qr,Ma,pe,Ae,yn,Mo,Hr,bn,Gr,$a,I,$o,Xr,Ln,Jr,Yr,wt,xt,Kr,Zr,ei,z,oi,Tt,ti,ni,Mt,ai,si,$t,ri,ii,kn,li,di,wn,ci,ui,xn,pi,mi,Tn,hi,fi,Mn,gi,_i,$n,vi,yi,bi,oe,zo,Li,M,ki,zn,wi,xi,qo,qn,Ti,Mi,$i,zt,zi,qi,Fn,Fi,Ei,En,Ci,Pi,Fo,Cn,Ai,ji,Ii,Pn,Ni,Si,qt,Di,Oi,An,Wi,Ri,jn,Bi,Ui,In,Vi,Qi,Nn,Hi,Gi,Sn,Xi,Ji,Eo,Dn,Yi,Ki,Zi,On,el,ol,tl,Wn,nl,za,me,je,Rn,Co,al,Bn,sl,qa,X,Po,rl,Ao,il,jo,ll,dl,cl,U,Io,ul,he,pl,Ft,ml,hl,Un,fl,gl,_l,Ie,vl,Ne,Fa,fe,Se,Vn,No,yl,Qn,bl,Ea,O,So,Ll,Do,kl,Oo,wl,xl,Tl,Wo,Ml,Ro,$l,zl,ql,V,Bo,Fl,ge,El,Et,Cl,Pl,Hn,Al,jl,Il,De,Nl,Oe,Ca,_e,We,Gn,Uo,Sl,Xn,Dl,Pa,W,Vo,Ol,R,Wl,Qo,Rl,Bl,Ho,Ul,Vl,Go,Ql,Hl,Xo,Gl,Xl,Jl,Jo,Yl,Yo,Kl,Zl,ed,Q,Ko,od,ve,td,Ct,nd,ad,Jn,sd,rd,id,Re,ld,Be,Aa,ye,Ue,Yn,Zo,dd,Kn,cd,ja,B,et,ud,J,pd,ot,md,hd,Zn,fd,gd,ea,_d,vd,yd,tt,bd,nt,Ld,kd,wd,H,at,xd,be,Td,Pt,Md,$d,oa,zd,qd,Fd,Ve,Ed,Qe,Ia;return l=new Y({}),ao=new Y({}),lo=new Y({}),co=new C({props:{name:"class transformers.LayoutLMv3Config",anchor:"transformers.LayoutLMv3Config",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"max_2d_position_embeddings",val:" = 1024"},{name:"coordinate_size",val:" = 128"},{name:"shape_size",val:" = 128"},{name:"has_relative_attention_bias",val:" = True"},{name:"rel_pos_bins",val:" = 32"},{name:"max_rel_pos",val:" = 128"},{name:"rel_2d_pos_bins",val:" = 64"},{name:"max_rel_2d_pos",val:" = 256"},{name:"has_spatial_attention_bias",val:" = True"},{name:"text_embed",val:" = True"},{name:"visual_embed",val:" = True"},{name:"input_size",val:" = 224"},{name:"num_channels",val:" = 3"},{name:"patch_size",val:" = 16"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),Ve=new ss({props:{$$slots:{default:[Ju]},$$scope:{ctx:q}}}),Qe=new Vt({props:{anchor:"transformers.LayoutLMv3ForQuestionAnswering.forward.example",$$slots:{default:[Yu]},$$scope:{ctx:q}}}),{c(){p=s("meta"),T=c(),_=s("h1"),f=s("a"),v=s("span"),y(l.$$.fragment),h=c(),P=s("span"),rs=n("LayoutLMv3"),da=c(),ae=s("h2"),ke=s("a"),Gt=s("span"),y(ao.$$.fragment),is=c(),Xt=s("span"),ls=n("Overview"),ca=c(),K=s("p"),ds=n("The LayoutLMv3 model was proposed in "),so=s("a"),cs=n("LayoutLMv3: Pre-training for Document AI with Unified Text and Image Masking"),us=n(` by Yupan Huang, Tengchao Lv, Lei Cui, Yutong Lu, Furu Wei.
...
word-level bounding boxes into token-level bounding boxes.`),Fr=c(),Ee=s("div"),y(yo.$$.fragment),Er=c(),hn=s("p"),Cr=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),zt=s("a"),zi=n("LayoutLMv3FeatureExtractor"),qi=n(" was initialized with "),Fn=s("code"),Fi=n("apply_ocr"),Ei=n(" set to "),En=s("code"),Ci=n("True"),Pi=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),Fo=s("a"),Cn=s("strong"),Ai=n("call"),ji=n("()"),Ii=n(` and returns the output,
...
resized and normalized `),On=s("code"),el=n("pixel_values"),ol=n("."),tl=c(),Wn=s("p"),nl=n("Please refer to the docstring of the above two methods for more information."),za=c(),me=s("h2"),je=s("a"),Rn=s("span"),y(Co.$$.fragment),al=c(),Bn=s("span"),sl=n("LayoutLMv3Model"),qa=c(),X=s("div"),y(Po.$$.fragment),rl=c(),Ao=s("p"),il=n(`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
...
word-level bounding boxes into token-level bounding boxes.`),Cd.forEach(t),Fr=u(G),Ee=r(G,"DIV",{class:!0});var Ua=i(Ee);b(yo.$$.fragment,Ua),Er=u(Ua),hn=r(Ua,"P",{});var bc=i(hn);Cr=a(bc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
single processor.`),Ec.forEach(t),Yr=u(te),wt=r(te,"P",{});var Pd=i(wt);xt=r(Pd,"A",{href:!0});var Cc=i(xt);Kr=a(Cc,"LayoutLMv3Processor"),Cc.forEach(t),Zr=a(Pd," offers all the functionalities you need to prepare data for the model."),Pd.forEach(t),ei=u(te),z=r(te,"P",{});var F=i(z);oi=a(F,"It first uses "),Tt=r(F,"A",{href:!0});var Pc=i(Tt);ti=a(Pc,"LayoutLMv3FeatureExtractor"),Pc.forEach(t),ni=a(F,` to resize and normalize document images, and optionally applies OCR to
...
`),zt=r($,"A",{href:!0});var Uc=i(zt);zi=a(Uc,"LayoutLMv3FeatureExtractor"),Uc.forEach(t),qi=a($," was initialized with "),Fn=r($,"CODE",{});var Vc=i(Fn);Fi=a(Vc,"apply_ocr"),Vc.forEach(t),Ei=a($," set to "),En=r($,"CODE",{});var Qc=i(En);Ci=a(Qc,"True"),Qc.forEach(t),Pi=a($,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),Fo=r($,"A",{href:!0});var jd=i(Fo);Cn=r(jd,"STRONG",{});var Hc=i(Cn);Ai=a(Hc,"call"),Hc.forEach(t),ji=a(jd,"()"),jd.forEach(t),Ii=a($,` and returns the output,
...
resized and normalized `),On=r($,"CODE",{});var tu=i(On);el=a(tu,"pixel_values"),tu.forEach(t),ol=a($,"."),$.forEach(t),tl=u(Dt),Wn=r(Dt,"P",{});var nu=i(Wn);nl=a(nu,"Please refer to the docstring of the above two methods for more information."),nu.forEach(t),Dt.forEach(t),te.forEach(t),za=u(o),me=r(o,"H2",{class:!0});var Ja=i(me);je=r(Ja,"A",{id:!0,class:!0,href:!0});var au=i(je);Rn=r(au,"SPAN",{});var su=i(Rn);b(Co.$$.fragment,su),su.forEach(t),au.forEach(t),al=u(Ja),Bn=r(Ja,"SPAN",{});var ru=i(Bn);sl=a(ru,"LayoutLMv3Model"),ru.forEach(t),Ja.forEach(t),qa=u(o),X=r(o,"DIV",{class:!0});var Ot=i(X);b(Po.$$.fragment,Ot),rl=u(Ot),Ao=r(Ot,"P",{});var Ya=i(Ao);il=a(Ya,`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
