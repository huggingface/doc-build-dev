import{S as Zy,i as e2,s as t2,e as o,k as p,w as T,t as a,M as s2,c as n,d as t,m as h,a as r,x as $,h as i,b as m,F as e,g as b,y as w,q as y,o as F,B as D,v as o2,L as ae}from"../../chunks/vendor-6b77c823.js";import{T as be}from"../../chunks/Tip-39098574.js";import{D as H}from"../../chunks/Docstring-1088f2fb.js";import{C as ie}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Te}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as re}from"../../chunks/ExampleCodeBlock-5212b321.js";function n2(x){let d,g,c,u,_;return u=new ie({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17060/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17060/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y1=r(qd);cv=i(Y1,"span start logits"),Y1.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Z1=r(Pd);hv=i(Z1,"span end logits"),Z1.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(xt),ia=n(xt,"P",{});var su=r(ia);mv=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e0=r(nl);gv=i(e0,"TFPreTrainedModel"),e0.forEach(t),_v=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bv=h(xt),la=n(xt,"P",{});var ou=r(la);vv=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t0=r(da);kv=i(t0,"tf.keras.Model"),t0.forEach(t),Tv=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$v=h(xt),$(Uo.$$.fragment,xt),wv=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);Fv=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var s0=r(rl);Dv=i(s0,"TFDistilBertForQuestionAnswering"),s0.forEach(t),xv=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var o0=r(Ad);Bv=i(o0,"__call__"),o0.forEach(t),Mv=i(Fl," special method."),Fl.forEach(t),Ev=h(Zt),$(Ho.$$.fragment,Zt),zv=h(Zt),$(Ko.$$.fragment,Zt),jv=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n0=r(Jo);Od=n(n0,"SPAN",{});var r0=r(Od);$(pa.$$.fragment,r0),r0.forEach(t),n0.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var a0=r(Nd);qv=i(a0,"FlaxDistilBertModel"),a0.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pv=h(st),Ld=n(st,"P",{});var i0=r(Ld);Av=i(i0,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i0.forEach(t),Ov=h(st),ua=n(st,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l0=r(al);Lv=i(l0,"FlaxPreTrainedModel"),l0.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(st),fa=n(st,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d0=r(ma);Qv=i(d0,"flax.linen.Module"),d0.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(st),Sd=n(st,"P",{});var c0=r(Sd);Hv=i(c0,"Finally, this model supports inherent JAX features such as:"),c0.forEach(t),Kv=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p0=r(Id);ga=n(p0,"A",{href:!0,rel:!0});var h0=r(ga);Vv=i(h0,"Just-In-Time (JIT) compilation"),h0.forEach(t),p0.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u0=r(Wd);_a=n(u0,"A",{href:!0,rel:!0});var f0=r(_a);Gv=i(f0,"Automatic Differentiation"),f0.forEach(t),u0.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m0=r(Qd);ba=n(m0,"A",{href:!0,rel:!0});var g0=r(ba);Yv=i(g0,"Vectorization"),g0.forEach(t),m0.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _0=r(Rd);va=n(_0,"A",{href:!0,rel:!0});var b0=r(va);ek=i(b0,"Parallelization"),b0.forEach(t),_0.forEach(t),kn.forEach(t),tk=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sk=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ok=i(Dl,"The "),Ud=n(Dl,"CODE",{});var v0=r(Ud);nk=i(v0,"FlaxDistilBertPreTrainedModel"),v0.forEach(t),rk=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var k0=r(Hd);ak=i(k0,"__call__"),k0.forEach(t),ik=i(Dl," special method."),Dl.forEach(t),lk=h(Tn),$(Go.$$.fragment,Tn),dk=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T0=r(Yo);Kd=n(T0,"SPAN",{});var $0=r(Kd);$(Ta.$$.fragment,$0),$0.forEach(t),T0.forEach(t),ck=h(iu),Vd=n(iu,"SPAN",{});var w0=r(Vd);pk=i(w0,"FlaxDistilBertForMaskedLM"),w0.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hk=h(ot),wa=n(ot,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y0=r(Jd);fk=i(y0,"language modeling"),y0.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(ot),ya=n(ot,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var F0=r(il);bk=i(F0,"FlaxPreTrainedModel"),F0.forEach(t),vk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kk=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tk=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var D0=r(Da);$k=i(D0,"flax.linen.Module"),D0.forEach(t),wk=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yk=h(ot),Gd=n(ot,"P",{});var x0=r(Gd);Fk=i(x0,"Finally, this model supports inherent JAX features such as:"),x0.forEach(t),Dk=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var B0=r(Xd);xa=n(B0,"A",{href:!0,rel:!0});var M0=r(xa);xk=i(M0,"Just-In-Time (JIT) compilation"),M0.forEach(t),B0.forEach(t),Bk=h($n),Yd=n($n,"LI",{});var E0=r(Yd);Ba=n(E0,"A",{href:!0,rel:!0});var z0=r(Ba);Mk=i(z0,"Automatic Differentiation"),z0.forEach(t),E0.forEach(t),Ek=h($n),Zd=n($n,"LI",{});var j0=r(Zd);Ma=n(j0,"A",{href:!0,rel:!0});var C0=r(Ma);zk=i(C0,"Vectorization"),C0.forEach(t),j0.forEach(t),jk=h($n),ec=n($n,"LI",{});var q0=r(ec);Ea=n(q0,"A",{href:!0,rel:!0});var P0=r(Ea);Ck=i(P0,"Parallelization"),P0.forEach(t),q0.forEach(t),$n.forEach(t),qk=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pk=h(wn),Cs=n(wn,"P",{});var xl=r(Cs);Ak=i(xl,"The "),tc=n(xl,"CODE",{});var A0=r(tc);Ok=i(A0,"FlaxDistilBertPreTrainedModel"),A0.forEach(t),Nk=i(xl," forward method, overrides the "),sc=n(xl,"CODE",{});var O0=r(sc);Lk=i(O0,"__call__"),O0.forEach(t),Sk=i(xl," special method."),xl.forEach(t),Ik=h(wn),$(Zo.$$.fragment,wn),Wk=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N0=r(tn);oc=n(N0,"SPAN",{});var L0=r(oc);$(ja.$$.fragment,L0),L0.forEach(t),N0.forEach(t),Qk=h(pu),nc=n(pu,"SPAN",{});var S0=r(nc);Rk=i(S0,"FlaxDistilBertForSequenceClassification"),S0.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uk=h(nt),rc=n(nt,"P",{});var I0=r(rc);Hk=i(I0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I0.forEach(t),Kk=h(nt),qa=n(nt,"P",{});var hu=r(qa);Vk=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W0=r(ll);Jk=i(W0,"FlaxPreTrainedModel"),W0.forEach(t),Gk=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q0=r(Aa);Zk=i(Q0,"flax.linen.Module"),Q0.forEach(t),eT=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tT=h(nt),ac=n(nt,"P",{});var R0=r(ac);sT=i(R0,"Finally, this model supports inherent JAX features such as:"),R0.forEach(t),oT=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U0=r(ic);Oa=n(U0,"A",{href:!0,rel:!0});var H0=r(Oa);nT=i(H0,"Just-In-Time (JIT) compilation"),H0.forEach(t),U0.forEach(t),rT=h(yn),lc=n(yn,"LI",{});var K0=r(lc);Na=n(K0,"A",{href:!0,rel:!0});var V0=r(Na);aT=i(V0,"Automatic Differentiation"),V0.forEach(t),K0.forEach(t),iT=h(yn),dc=n(yn,"LI",{});var J0=r(dc);La=n(J0,"A",{href:!0,rel:!0});var G0=r(La);lT=i(G0,"Vectorization"),G0.forEach(t),J0.forEach(t),dT=h(yn),cc=n(yn,"LI",{});var X0=r(cc);Sa=n(X0,"A",{href:!0,rel:!0});var Y0=r(Sa);cT=i(Y0,"Parallelization"),Y0.forEach(t),X0.forEach(t),yn.forEach(t),pT=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hT=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uT=i(Bl,"The "),pc=n(Bl,"CODE",{});var Z0=r(pc);fT=i(Z0,"FlaxDistilBertPreTrainedModel"),Z0.forEach(t),mT=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var ey=r(hc);gT=i(ey,"__call__"),ey.forEach(t),_T=i(Bl," special method."),Bl.forEach(t),bT=h(Fn),$(sn.$$.fragment,Fn),vT=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kT=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);TT=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$T=h(rt),mc=n(rt,"P",{});var ny=r(mc);wT=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
