...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){p=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){p=r(l,"P",{});var h=i(p);T=a(h,"Examples:"),h.forEach(t),_=u(l),b(f.$$.fragment,l)},m(l,h){g(l,p,h),e(p,T),g(l,_,h),L(f,l,h),v=!0},p:Qt,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){w(f.$$.fragment,l),v=!1},d(l){l&&t(p),l&&t(_),x(f,l)}}}function Ku(q){let p,T,_,f,v,l,h,C,rs,da,ae,ke,Gt,ao,is,Xt,ls,ca,K,ds,so,cs,us,it,ps,ms,ua,lt,hs,pa,dt,Jt,fs,ma,ct,gs,ha,we,Yt,_s,vs,se,ys,ut,bs,Ls,pt,ks,ws,fa,xe,Nd,ga,Te,xs,mt,Ts,Ms,_a,Z,$s,ro,zs,qs,io,Es,Fs,va,re,Me,Kt,lo,Ps,Zt,Cs,ya,N,co,As,ie,js,ht,Is,Ns,uo,Ss,Ds,Os,le,Ws,ft,Rs,Bs,gt,Us,Vs,Qs,$e,ba,de,ze,en,po,Hs,on,Gs,La,S,mo,Xs,tn,Js,Ys,ho,Ks,nn,Zs,er,or,ee,fo,tr,an,nr,ar,qe,ka,ce,Ee,sn,go,sr,rn,rr,wa,A,_o,ir,F,lr,ln,dr,cr,_t,ur,pr,dn,mr,hr,cn,fr,gr,un,_r,vr,pn,yr,br,mn,Lr,kr,wr,vo,xr,vt,Tr,Mr,$r,yt,bt,zr,qr,Er,Fe,yo,Fr,hn,Pr,Cr,Lt,bo,xa,ue,Pe,fn,Lo,Ar,gn,jr,Ta,D,ko,Ir,wo,Nr,_n,Sr,Dr,Or,xo,Wr,kt,Rr,Br,Ur,Ce,To,Vr,vn,Qr,Ma,pe,Ae,yn,Mo,Hr,bn,Gr,$a,I,$o,Xr,Ln,Jr,Yr,wt,xt,Kr,Zr,ei,z,oi,Tt,ti,ni,Mt,ai,si,$t,ri,ii,kn,li,di,wn,ci,ui,xn,pi,mi,Tn,hi,fi,Mn,gi,_i,$n,vi,yi,bi,oe,zo,Li,M,ki,zn,wi,xi,qo,qn,Ti,Mi,$i,zt,zi,qi,En,Ei,Fi,Fn,Pi,Ci,Eo,Pn,Ai,ji,Ii,Cn,Ni,Si,qt,Di,Oi,An,Wi,Ri,jn,Bi,Ui,In,Vi,Qi,Nn,Hi,Gi,Sn,Xi,Ji,Fo,Dn,Yi,Ki,Zi,On,el,ol,tl,Wn,nl,za,me,je,Rn,Po,al,Bn,sl,qa,X,Co,rl,Ao,il,jo,ll,dl,cl,U,Io,ul,he,pl,Et,ml,hl,Un,fl,gl,_l,Ie,vl,Ne,Ea,fe,Se,Vn,No,yl,Qn,bl,Fa,O,So,Ll,Do,kl,Oo,wl,xl,Tl,Wo,Ml,Ro,$l,zl,ql,V,Bo,El,ge,Fl,Ft,Pl,Cl,Hn,Al,jl,Il,De,Nl,Oe,Pa,_e,We,Gn,Uo,Sl,Xn,Dl,Ca,W,Vo,Ol,R,Wl,Qo,Rl,Bl,Ho,Ul,Vl,Go,Ql,Hl,Xo,Gl,Xl,Jl,Jo,Yl,Yo,Kl,Zl,ed,Q,Ko,od,ve,td,Pt,nd,ad,Jn,sd,rd,id,Re,ld,Be,Aa,ye,Ue,Yn,Zo,dd,Kn,cd,ja,B,et,ud,J,pd,ot,md,hd,Zn,fd,gd,ea,_d,vd,yd,tt,bd,nt,Ld,kd,wd,H,at,xd,be,Td,Ct,Md,$d,oa,zd,qd,Ed,Ve,Fd,Qe,Ia;return l=new Y({}),ao=new Y({}),lo=new Y({}),co=new P({props:{name:"class transformers.LayoutLMv3Config",anchor:"transformers.LayoutLMv3Config",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"max_2d_position_embeddings",val:" = 1024"},{name:"coordinate_size",val:" = 128"},{name:"shape_size",val:" = 128"},{name:"has_relative_attention_bias",val:" = True"},{name:"rel_pos_bins",val:" = 32"},{name:"max_rel_pos",val:" = 128"},{name:"rel_2d_pos_bins",val:" = 64"},{name:"max_rel_2d_pos",val:" = 256"},{name:"has_spatial_attention_bias",val:" = True"},{name:"visual_embed",val:" = True"},{name:"input_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
word-level bounding boxes into token-level bounding boxes.`),Er=c(),Fe=s("div"),y(yo.$$.fragment),Fr=c(),hn=s("p"),Pr=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),zt=s("a"),zi=n("LayoutLMv3FeatureExtractor"),qi=n(" was initialized with "),En=s("code"),Ei=n("apply_ocr"),Fi=n(" set to "),Fn=s("code"),Pi=n("True"),Ci=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),Eo=s("a"),Pn=s("strong"),Ai=n("call"),ji=n("()"),Ii=n(` and returns the output,
...
behavior.`),cl=c(),U=s("div"),y(Io.$$.fragment),ul=c(),he=s("p"),pl=n("The "),Et=s("a"),ml=n("LayoutLMv3Model"),hl=n(" forward method, overrides the "),Un=s("code"),fl=n("__call__"),gl=n(" special method."),_l=c(),y(Ie.$$.fragment),vl=c(),y(Ne.$$.fragment),Ea=c(),fe=s("h2"),Se=s("a"),Vn=s("span"),y(No.$$.fragment),yl=c(),Qn=s("span"),bl=n("LayoutLMv3ForSequenceClassification"),Fa=c(),O=s("div"),y(So.$$.fragment),Ll=c(),Do=s("p"),kl=n(`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
...
word-level bounding boxes into token-level bounding boxes.`),Pd.forEach(t),Er=u(G),Fe=r(G,"DIV",{class:!0});var Ua=i(Fe);b(yo.$$.fragment,Ua),Fr=u(Ua),hn=r(Ua,"P",{});var bc=i(hn);Pr=a(bc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
sequences with word-level normalized bounding boxes and optional labels.`),$c.forEach(t),Ga.forEach(t),Xe.forEach(t),Ma=u(o),pe=r(o,"H2",{class:!0});var Xa=i(pe);Ae=r(Xa,"A",{id:!0,class:!0,href:!0});var zc=i(Ae);yn=r(zc,"SPAN",{});var qc=i(yn);b(Mo.$$.fragment,qc),qc.forEach(t),zc.forEach(t),Hr=u(Xa),bn=r(Xa,"SPAN",{});var Ec=i(bn);Gr=a(Ec,"LayoutLMv3Processor"),Ec.forEach(t),Xa.forEach(t),$a=u(o),I=r(o,"DIV",{class:!0});var te=i(I);b($o.$$.fragment,te),Xr=u(te),Ln=r(te,"P",{});var Fc=i(Ln);Jr=a(Fc,`Constructs a LayoutLMv3 processor which combines a LayoutLMv3 feature extractor and a LayoutLMv3 tokenizer into a
single processor.`),Fc.forEach(t),Yr=u(te),wt=r(te,"P",{});var Cd=i(wt);xt=r(Cd,"A",{href:!0});var Pc=i(xt);Kr=a(Pc,"LayoutLMv3Processor"),Pc.forEach(t),Zr=a(Cd," offers all the functionalities you need to prepare data for the model."),Cd.forEach(t),ei=u(te),z=r(te,"P",{});var E=i(z);oi=a(E,"It first uses "),Tt=r(E,"A",{href:!0});var Cc=i(Tt);ti=a(Cc,"LayoutLMv3FeatureExtractor"),Cc.forEach(t),ni=a(E,` to resize and normalize document images, and optionally applies OCR to
...
`),zt=r($,"A",{href:!0});var Uc=i(zt);zi=a(Uc,"LayoutLMv3FeatureExtractor"),Uc.forEach(t),qi=a($," was initialized with "),En=r($,"CODE",{});var Vc=i(En);Ei=a(Vc,"apply_ocr"),Vc.forEach(t),Fi=a($," set to "),Fn=r($,"CODE",{});var Qc=i(Fn);Pi=a(Qc,"True"),Qc.forEach(t),Ci=a($,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),Eo=r($,"A",{href:!0});var jd=i(Eo);Pn=r(jd,"STRONG",{});var Hc=i(Pn);Ai=a(Hc,"call"),Hc.forEach(t),ji=a(jd,"()"),jd.forEach(t),Ii=a($,` and returns the output,
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ya.forEach(t),cl=u(Ot),U=r(Ot,"DIV",{class:!0});var Je=i(U);b(Io.$$.fragment,Je),ul=u(Je),he=r(Je,"P",{});var Wt=i(he);pl=a(Wt,"The "),Et=r(Wt,"A",{href:!0});var lu=i(Et);ml=a(lu,"LayoutLMv3Model"),lu.forEach(t),hl=a(Wt," forward method, overrides the "),Un=r(Wt,"CODE",{});var du=i(Un);fl=a(du,"__call__"),du.forEach(t),gl=a(Wt," special method."),Wt.forEach(t),_l=u(Je),b(Ie.$$.fragment,Je),vl=u(Je),b(Ne.$$.fragment,Je),Je.forEach(t),Ot.forEach(t),Ea=u(o),fe=r(o,"H2",{class:!0});var Ka=i(fe);Se=r(Ka,"A",{id:!0,class:!0,href:!0});var cu=i(Se);Vn=r(cu,"SPAN",{});var uu=i(Vn);b(No.$$.fragment,uu),uu.forEach(t),cu.forEach(t),yl=u(Ka),Qn=r(Ka,"SPAN",{});var pu=i(Qn);bl=a(pu,"LayoutLMv3ForSequenceClassification"),pu.forEach(t),Ka.forEach(t),Fa=u(o),O=r(o,"DIV",{class:!0});var Ye=i(O);b(So.$$.fragment,Ye),Ll=u(Ye),Do=r(Ye,"P",{});var Za=i(Do);kl=a(Za,`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
`),ot=r(to,"A",{href:!0,rel:!0});var Eu=i(ot);md=a(Eu,"DocVQA"),Eu.forEach(t),hd=a(to,` (a linear layer on top of the text part of the hidden-states output to
