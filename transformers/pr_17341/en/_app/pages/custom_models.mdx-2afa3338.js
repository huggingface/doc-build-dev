...
to import from the `),u=l(I,"CODE",{});var ee=i(u);v=a(ee,"transformers"),ee.forEach(s),z=a(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,E),t(m,u),t(u,v),t(m,z)},d(P){P&&s(m)}}}function Gi(Z){let m,E,u,v,z,P,I,ee,sa,qs,Ge,oa,Is,Ke,aa,Ns,N,na,be,ra,la,Ve,ia,fa,xs,U,te,Ot,ve,ca,Dt,da,Os,se,ha,Ft,ma,ua,Ds,Je,pa,Fs,$e,Ss,Qe,_a,Bs,x,ke,ga,St,ya,wa,ba,G,va,Bt,$a,ka,Ht,Ea,ja,Ca,K,Pa,Wt,Aa,Ta,Lt,Ma,Ra,Hs,O,qa,Yt,Ia,Na,zt,xa,Oa,Ws,D,Da,Ut,Fa,Sa,Gt,Ba,Ha,Ls,Xe,Wa,Ys,Ee,zs,A,La,Kt,Ya,za,Vt,Ua,Ga,Jt,Ka,Va,Us,je,Gs,F,Ja,Ze,Qa,Xa,et,Za,en,Ks,V,oe,Qt,Ce,tn,Xt,sn,Vs,S,on,tt,an,nn,st,rn,ln,Js,ae,fn,Zt,cn,dn,Qs,Pe,Xs,ot,hn,Zs,Ae,eo,C,mn,es,un,pn,ts,_n,gn,ss,yn,wn,os,bn,vn,to,ne,so,B,$n,as,kn,En,at,jn,Cn,oo,nt,Pn,ao,Te,no,T,An,rt,Tn,Mn,lt,Rn,qn,it,In,Nn,ro,ft,xn,lo,Me,io,H,On,ct,Dn,Fn,dt,Sn,Bn,fo,J,re,ns,Re,Hn,rs,Wn,co,le,ho,$,Ln,ls,Yn,zn,is,Un,Gn,fs,Kn,Vn,cs,Jn,Qn,ds,Xn,Zn,hs,er,tr,ms,sr,or,mo,qe,uo,W,ar,us,nr,rr,ps,lr,ir,po,ie,_o,ht,fr,go,mt,cr,yo,Ie,wo,fe,dr,_s,hr,mr,bo,Ne,vo,ce,ur,ut,pr,_r,$o,pt,gr,ko,xe,Eo,_t,yr,jo,Oe,Co,gt,wr,Po,De,Ao,yt,br,To,Fe,Mo,M,vr,gs,$r,kr,ys,Er,jr,Se,Cr,Pr,Ro,de,Ar,wt,Tr,Mr,qo,Q,he,ws,Be,Rr,bs,qr,Io,R,Ir,vs,Nr,xr,He,Or,Dr,$s,Fr,Sr,No,We,xo,me,Br,ks,Hr,Wr,Oo,Le,Do,bt,Lr,Fo,X,ue,Es,Ye,Yr,js,zr,So,vt,Ur,Bo,L,Gr,Cs,Kr,Vr,Ps,Jr,Qr,Ho,ze,Wo,q,Xr,$t,Zr,el,As,tl,sl,Ts,ol,al,Lo;return P=new xt({}),ve=new xt({}),$e=new k({props:{code:`from transformers import PretrainedConfig
...
superclass.`),Ws=c(),D=r("p"),Da=o("Defining a "),Ut=r("code"),Fa=o("model_type"),Sa=o(" for your configuration (here "),Gt=r("code"),Ba=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
easy to transfer those weights:`),lo=c(),p(Me.$$.fragment),io=c(),H=r("p"),On=o("Now let\u2019s see how to make sure that when we do "),ct=r("a"),Dn=o("save_pretrained()"),Fn=o(" or "),dt=r("a"),Sn=o("push_to_hub()"),Bn=o(`, the
...
in this `),Se=r("a"),Cr=o("model repo"),Pr=o("."),Ro=c(),de=r("p"),Ar=o("See the "),wt=r("a"),Tr=o("sharing tutorial"),Mr=o(" for more information on the push to Hub method."),qo=c(),Q=r("h2"),he=r("a"),ws=r("span"),p(Be.$$.fragment),Rr=c(),bs=r("span"),qr=o("Using a model with custom code"),Io=c(),R=r("p"),Ir=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
hash of any commit.`),Fo=c(),X=r("h2"),ue=r("a"),Es=r("span"),p(Ye.$$.fragment),Yr=c(),js=r("span"),zr=o("Registering a model with custom code to the auto classes"),So=c(),vt=r("p"),Ur=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
superclass.`),Pt.forEach(s),Ws=d(e),D=l(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Ut=l(At,"CODE",{});var El=i(Ut);Fa=a(El,"model_type"),El.forEach(s),Sa=a(At," for your configuration (here "),Gt=l(At,"CODE",{});var jl=i(Gt);Ba=a(jl,'model_type="resnet"'),jl.forEach(s),Ha=a(At,`) is not mandatory, unless you want to
...
you want to register your model with the auto classes (see last section).`),Y.forEach(s),to=d(e),_(ne.$$.fragment,e),so=d(e),B=l(e,"P",{});var Rt=i(B);$n=a(Rt,`You can have your model return anything you want, but returning a dictionary like we did for
...
we will use the pretrained version of the resnet50d. Since our model is just a wrapper around it, it\u2019s going to be
easy to transfer those weights:`),Vl.forEach(s),lo=d(e),_(Me.$$.fragment,e),io=d(e),H=l(e,"P",{});var qt=i(H);On=a(qt,"Now let\u2019s see how to make sure that when we do "),ct=l(qt,"A",{href:!0});var Jl=i(ct);Dn=a(Jl,"save_pretrained()"),Jl.forEach(s),Fn=a(qt," or "),dt=l(qt,"A",{href:!0});var Ql=i(dt);Sn=a(Ql,"push_to_hub()"),Ql.forEach(s),Bn=a(qt,`, the
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=l(e,"H2",{class:!0});var ta=i(X);ue=l(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=l(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yr=d(ta),js=l(ta,"SPAN",{});var qi=i(js);zr=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),So=d(e),vt=l(e,"P",{});var Ii=i(vt);Ur=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Ii.forEach(s),Bo=d(e),L=l(e,"P",{});var Nt=i(L);Gr=a(Nt,"As long as your config has a "),Cs=l(Nt,"CODE",{});var Ni=i(Cs);Kr=a(Ni,"model_type"),Ni.forEach(s),Vr=a(Nt,` attribute that is different from existing model types, and that your model
