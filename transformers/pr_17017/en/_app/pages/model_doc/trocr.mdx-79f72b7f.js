import{S as hi,i as pi,s as mi,e as s,k as c,w as C,t as o,M as fi,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ui,F as e,g as m,y as k,q as $,o as O,B as y,v as gi,L as ci}from"../../chunks/vendor-6b77c823.js";import{T as li}from"../../chunks/Tip-39098574.js";import{D as Z}from"../../chunks/Docstring-1088f2fb.js";import{C as Hs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as jt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as di}from"../../chunks/ExampleCodeBlock-5212b321.js";function _i(S){let f,E,u,g,T;return g=new Hs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=s("p"),E=o("Example:"),u=c(),C(g.$$.fragment)},l(p){f=n(p,"P",{});var _=i(f);E=a(_,"Example:"),_.forEach(r),u=h(p),w(g.$$.fragment,p)},m(p,_){m(p,f,_),e(f,E),m(p,u,_),k(g,p,_),T=!0},p:ci,i(p){T||($(g.$$.fragment,p),T=!0)},o(p){O(g.$$.fragment,p),T=!1},d(p){p&&r(f),p&&r(u),y(g,p)}}}function vi(S){let f,E,u,g,T,p,_,D;return{c(){f=s("p"),E=o(`This class method is simply calling the feature extractor
...
methods above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/pr_17017/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(j,R){m(j,f,R),e(f,E),e(f,u),e(u,g),e(f,T),e(f,p),e(p,_),e(f,D)},d(j){j&&r(f)}}}function Ti(S){let f,E,u,g,T,p,_,D;return{c(){f=s("p"),E=o("This class method is simply calling "),u=s("a"),g=o("save_pretrained()"),T=o(` and
...
above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/pr_17017/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,R){m(j,f,R),e(f,E),e(f,u),e(u,g),e(f,T),e(f,p),e(p,_),e(f,D)},d(j){j&&r(f)}}}function bi(S){let f,E,u,g,T;return g=new Hs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("p"),E=o("Example:"),u=c(),C(g.$$.fragment)},l(p){f=n(p,"P",{});var _=i(f);E=a(_,"Example:"),_.forEach(r),u=h(p),w(g.$$.fragment,p)},m(p,_){m(p,f,_),e(f,E),m(p,u,_),k(g,p,_),T=!0},p:ci,i(p){T||($(g.$$.fragment,p),T=!0)},o(p){O(g.$$.fragment,p),T=!1},d(p){p&&r(f),p&&r(u),y(g,p)}}}function Ci(S){let f,E,u,g,T,p,_,D,j,R,z,F,zt,$e,ro,Lt,oo,ur,W,ao,Oe,so,no,ye,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,po,it,mo,fo,br,ae,uo,Dt,go,_o,Cr,B,vo,Re,To,bo,Ee,Co,wo,wr,lt,ko,kr,H,xe,$o,Pe,Oo,yo,Ro,I,Eo,Me,xo,Po,je,Mo,jo,ze,zo,Lo,Fo,Le,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,Or,U,No,It,So,Wo,ct,Bo,Ho,yr,v,Uo,Vt,Xo,Go,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Bt,oa,aa,Ht,sa,na,Ut,ia,la,Xt,da,ca,Rr,pt,Gt,ha,Er,De,xr,ne,pa,qe,ma,fa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,mt,Ta,ba,Ve,Ca,wa,ka,Q,$a,ft,Oa,ya,ut,Ra,Ea,xa,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,zr,b,Se,ja,Qt,za,La,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ba,We,ar,Ha,Ua,Xa,_t,Ga,Za,Ja,ce,Be,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,X,He,ns,ir,is,ls,he,ds,G,Ue,cs,Xe,hs,Tt,ps,ms,fs,pe,us,me,Ge,gs,Ze,_s,bt,vs,Ts,bs,fe,Je,Cs,Ye,ws,Ct,ks,$s,Os,ue,Ke,ys,lr,Rs,Lr,te,ge,dr,Qe,Es,cr,xs,Fr,A,et,Ps,N,Ms,wt,js,zs,hr,Ls,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return p=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Hs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17017/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not to use a layernorm after the word + position embeddings.`,name:"layernorm_embedding"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/configuration_trocr.py#L29"}}),le=new di({props:{anchor:"transformers.TrOCRConfig.example",$$slots:{default:[_i]},$$scope:{ctx:S}}}),Ne=new jt({}),Se=new Z({props:{name:"class transformers.TrOCRProcessor",anchor:"transformers.TrOCRProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.feature_extractor",description:`<strong>feature_extractor</strong> ([<code>ViTFeatureExtractor</code>/<code>DeiTFeatureExtractor</code>]) &#x2014;
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/processing_trocr.py#L23"}}),Be=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/processing_trocr.py#L44"}}),He=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_17017/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_17017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/processing_utils.py#L94"}}),pe=new li({props:{$$slots:{default:[Ti]},$$scope:{ctx:S}}}),Ge=new Z({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/processing_trocr.py#L53"}}),Je=new Z({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/processing_trocr.py#L60"}}),Ke=new Z({props:{name:"as_target_processor",anchor:"transformers.TrOCRProcessor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/processing_trocr.py#L67"}}),Qe=new jt({}),et=new Z({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17017/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/modeling_trocr.py#L775"}}),ot=new Z({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/pr_17017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_17017/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/trocr/modeling_trocr.py#L806",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
>transformers.modeling_outputs.CausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17017/en/model_doc/trocr#transformers.TrOCRConfig"
...
`}}),ve=new di({props:{anchor:"transformers.TrOCRForCausalLM.forward.example",$$slots:{default:[bi]},$$scope:{ctx:S}}}),{c(){f=s("meta"),E=c(),u=s("h1"),g=s("a"),T=s("span"),C(p.$$.fragment),_=c(),D=s("span"),j=o("TrOCR"),R=c(),z=s("h2"),F=s("a"),zt=s("span"),C($e.$$.fragment),ro=c(),Lt=s("span"),oo=o("Overview"),ur=c(),W=s("p"),ao=o("The TrOCR model was proposed in "),Oe=s("a"),so=o(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
perform `),ye=s("a"),io=o("optical character recognition (OCR)"),lo=o("."),gr=c(),st=s("p"),co=o("The abstract from the paper is the following:"),_r=c(),nt=s("p"),Ft=s("em"),ho=o(`Text recognition is a long-standing research problem for document digitalization. Existing approaches for text recognition
...
`),Ee=s("a"),Co=o("here"),wo=o("."),wr=c(),lt=s("p"),ko=o("Tips:"),kr=c(),H=s("ul"),xe=s("li"),$o=o("The quickest way to get started with TrOCR is by checking the "),Pe=s("a"),Oo=o(`tutorial
...
information, see the `),ze=s("a"),zo=o("official models"),Lo=o("."),Fo=c(),Le=s("li"),Do=o("TrOCR is always used within the "),dt=s("a"),qo=o("VisionEncoderDecoder"),Ao=o(" framework."),$r=c(),J=s("h2"),se=s("a"),qt=s("span"),C(Fe.$$.fragment),Io=c(),At=s("span"),Vo=o("Inference"),Or=c(),U=s("p"),No=o("TrOCR\u2019s "),It=s("code"),So=o("VisionEncoderDecoder"),Wo=o(` model accepts images as input and makes use of
`),ct=s("a"),Bo=o("generate()"),Ho=o(" to autoregressively generate text given the input image."),yr=c(),v=s("p"),Uo=o("The ["),Vt=s("code"),Xo=o("ViTFeatureExtractor"),Go=o("/"),Nt=s("code"),Zo=o("DeiTFeatureExtractor"),Jo=o(`] class is responsible for preprocessing the input image and
...
`),Ve=s("a"),Ca=o("microsoft/trocr-base-handwritten"),wa=o(" architecture."),ka=c(),Q=s("p"),$a=o("Configuration objects inherit from "),ft=s("a"),Oa=o("PretrainedConfig"),ya=o(` and can be used to control the model outputs. Read the
...
can be reloaded using the `),Tt=s("a"),ps=o("from_pretrained()"),ms=o(" method."),fs=c(),C(pe.$$.fragment),us=c(),me=s("div"),C(Ge.$$.fragment),gs=c(),Ze=s("p"),_s=o("This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=s("a"),vs=o("batch_decode()"),Ts=o(`. Please refer
...
effective, and can be pre-trained with large-scale synthetic data and fine-tuned with human-labeled datasets. Experiments
show that the TrOCR model outperforms the current state-of-the-art models on both printed and handwritten text recognition
tasks.`),en.forEach(r),Qs.forEach(r),vr=h(t),re=n(t,"IMG",{src:!0,alt:!0,width:!0}),Tr=h(t),oe=n(t,"SMALL",{});var Ar=i(oe);po=a(Ar,"TrOCR architecture. Taken from the "),it=n(Ar,"A",{href:!0});var tn=i(it);mo=a(tn,"original paper"),tn.forEach(r),fo=a(Ar,"."),Ar.forEach(r),br=h(t),ae=n(t,"P",{});var Ir=i(ae);uo=a(Ir,"Please refer to the "),Dt=n(Ir,"CODE",{});var rn=i(Dt);go=a(rn,"VisionEncoderDecoder"),rn.forEach(r),_o=a(Ir," class on how to use this model."),Ir.forEach(r),Cr=h(t),B=n(t,"P",{});var Ot=i(B);vo=a(Ot,"This model was contributed by "),Re=n(Ot,"A",{href:!0,rel:!0});var on=i(Re);To=a(on,"nielsr"),on.forEach(r),bo=a(Ot,`. The original code can be found
`),Ee=n(Ot,"A",{href:!0,rel:!0});var an=i(Ee);Co=a(an,"here"),an.forEach(r),wo=a(Ot,"."),Ot.forEach(r),wr=h(t),lt=n(t,"P",{});var sn=i(lt);ko=a(sn,"Tips:"),sn.forEach(r),kr=h(t),H=n(t,"UL",{});var yt=i(H);xe=n(yt,"LI",{});var Vr=i(xe);$o=a(Vr,"The quickest way to get started with TrOCR is by checking the "),Pe=n(Vr,"A",{href:!0,rel:!0});var nn=i(Pe);Oo=a(nn,`tutorial
notebooks`),nn.forEach(r),yo=a(Vr,`, which show how to use the model
at inference time as well as fine-tuning on custom data.`),Vr.forEach(r),Ro=h(yt),I=n(yt,"LI",{});var Te=i(I);Eo=a(Te,`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),ze=n(Te,"A",{href:!0,rel:!0});var cn=i(ze);zo=a(cn,"official models"),cn.forEach(r),Lo=a(Te,"."),Te.forEach(r),Fo=h(yt),Le=n(yt,"LI",{});var Nr=i(Le);Do=a(Nr,"TrOCR is always used within the "),dt=n(Nr,"A",{href:!0});var hn=i(dt);qo=a(hn,"VisionEncoderDecoder"),hn.forEach(r),Ao=a(Nr," framework."),Nr.forEach(r),yt.forEach(r),$r=h(t),J=n(t,"H2",{class:!0});var Sr=i(J);se=n(Sr,"A",{id:!0,class:!0,href:!0});var pn=i(se);qt=n(pn,"SPAN",{});var mn=i(qt);w(Fe.$$.fragment,mn),mn.forEach(r),pn.forEach(r),Io=h(Sr),At=n(Sr,"SPAN",{});var fn=i(At);Vo=a(fn,"Inference"),fn.forEach(r),Sr.forEach(r),Or=h(t),U=n(t,"P",{});var Rt=i(U);No=a(Rt,"TrOCR\u2019s "),It=n(Rt,"CODE",{});var un=i(It);So=a(un,"VisionEncoderDecoder"),un.forEach(r),Wo=a(Rt,` model accepts images as input and makes use of
`),ct=n(Rt,"A",{href:!0});var gn=i(ct);Bo=a(gn,"generate()"),gn.forEach(r),Ho=a(Rt," to autoregressively generate text given the input image."),Rt.forEach(r),yr=h(t),v=n(t,"P",{});var x=i(v);Uo=a(x,"The ["),Vt=n(x,"CODE",{});var _n=i(Vt);Xo=a(_n,"ViTFeatureExtractor"),_n.forEach(r),Go=a(x,"/"),Nt=n(x,"CODE",{});var vn=i(Nt);Zo=a(vn,"DeiTFeatureExtractor"),vn.forEach(r),Jo=a(x,`] class is responsible for preprocessing the input image and
...
can be reloaded using the `),Tt=n(Xr,"A",{href:!0});var Yn=i(Tt);ps=a(Yn,"from_pretrained()"),Yn.forEach(r),ms=a(Xr," method."),Xr.forEach(r),fs=h(Mt),w(pe.$$.fragment,Mt),Mt.forEach(r),us=h(M),me=n(M,"DIV",{class:!0});var Gr=i(me);w(Ge.$$.fragment,Gr),gs=h(Gr),Ze=n(Gr,"P",{});var Zr=i(Ze);_s=a(Zr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=n(Zr,"A",{href:!0});var Kn=i(bt);vs=a(Kn,"batch_decode()"),Kn.forEach(r),Ts=a(Zr,`. Please refer
