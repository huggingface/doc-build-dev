...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a> or <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.TFWav2Vec2Model">TFWav2Vec2Model</a>. Vocabulary size of the
model. Defines the different tokens that can be represented by the <em>inputs_ids</em> passed to the forward
method of <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a>.`,name:"vocab_size"},{anchor:"transformers.Wav2Vec2Config.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
instance of <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2CTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17017/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17017/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/tokenization_utils_base.py#L2393",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L488",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L418",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17017/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17017/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_17017/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_17017/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_17017/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17017/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1688",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777"}}),gn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",returnDescription:`
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17017/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17017/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17017/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1055"}}),dr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17017/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L887",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17017/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L887",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17017/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17017/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1319"}}),qr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17017/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17017/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17017/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),J_=p(zt),Ke=s(zt,"DIV",{class:!0});var Da=n(Ke);y(Dn.$$.fragment,Da),Z_=p(Da),io=s(Da,"P",{});var Ri=n(io);K_=i(Ri,"The "),Ti=s(Ri,"A",{href:!0});var e0=n(Ti);Q_=i(e0,"Wav2Vec2ForPreTraining"),e0.forEach(t),Y_=i(Ri," forward method, overrides the "),tc=s(Ri,"CODE",{});var t0=n(tc);ev=i(t0,"__call__"),t0.forEach(t),tv=i(Ri," special method."),Ri.forEach(t),ov=p(Da),y(pa.$$.fragment,Da),av=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),zt.forEach(t),Ed=p(o),lo=s(o,"H2",{class:!0});var Ip=n(lo);ha=s(Ip,"A",{id:!0,class:!0,href:!0});var o0=n(ha);oc=s(o0,"SPAN",{});var a0=n(oc);y(Sn.$$.fragment,a0),a0.forEach(t),o0.forEach(t),sv=p(Ip),ac=s(Ip,"SPAN",{});var s0=n(ac);nv=i(s0,"TFWav2Vec2Model"),s0.forEach(t),Ip.forEach(t),qd=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Nn.$$.fragment,rt),rv=p(rt),sc=s(rt,"P",{});var n0=n(sc);iv=i(n0,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),n0.forEach(t),lv=p(rt),In=s(rt,"P",{});var Bp=n(In);cv=i(Bp,"This model inherits from "),$i=s(Bp,"A",{href:!0});var r0=n($i);dv=i(r0,"TFPreTrainedModel"),r0.forEach(t),pv=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bp.forEach(t),mv=p(rt),Bn=s(rt,"P",{});var Up=n(Bn);hv=i(Up,"This model is also a "),Un=s(Up,"A",{href:!0,rel:!0});var i0=n(Un);fv=i(i0,"tf.keras.Model"),i0.forEach(t),uv=i(Up,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Up.forEach(t),gv=p(rt),y(fa.$$.fragment,rt),_v=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Rn.$$.fragment,Sa),vv=p(Sa),co=s(Sa,"P",{});var Hi=n(co);bv=i(Hi,"The "),xi=s(Hi,"A",{href:!0});var l0=n(xi);wv=i(l0,"TFWav2Vec2Model"),l0.forEach(t),yv=i(Hi," forward method, overrides the "),nc=s(Hi,"CODE",{});var c0=n(nc);kv=i(c0,"__call__"),c0.forEach(t),Tv=i(Hi," special method."),Hi.forEach(t),$v=p(Sa),y(ua.$$.fragment,Sa),xv=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),Pd=p(o),po=s(o,"H2",{class:!0});var Rp=n(po);_a=s(Rp,"A",{id:!0,class:!0,href:!0});var d0=n(_a);rc=s(d0,"SPAN",{});var p0=n(rc);y(Hn.$$.fragment,p0),p0.forEach(t),d0.forEach(t),Wv=p(Rp),ic=s(Rp,"SPAN",{});var m0=n(ic);Vv=i(m0,"TFWav2Vec2ForCTC"),m0.forEach(t),Rp.forEach(t),zd=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Xn.$$.fragment,it),jv=p(it),Gn=s(it,"P",{});var Hp=n(Gn);Fv=i(Hp,"TFWav2Vec2 Model with a "),lc=s(Hp,"CODE",{});var h0=n(lc);Cv=i(h0,"language modeling"),h0.forEach(t),Ev=i(Hp," head on top for Connectionist Temporal Classification (CTC)."),Hp.forEach(t),qv=p(it),Jn=s(it,"P",{});var Xp=n(Jn);Pv=i(Xp,"This model inherits from "),Wi=s(Xp,"A",{href:!0});var f0=n(Wi);zv=i(f0,"TFPreTrainedModel"),f0.forEach(t),Mv=i(Xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xp.forEach(t),Av=p(it),Zn=s(it,"P",{});var Gp=n(Zn);Ov=i(Gp,"This model is also a "),Kn=s(Gp,"A",{href:!0,rel:!0});var u0=n(Kn);Lv=i(u0,"tf.keras.Model"),u0.forEach(t),Dv=i(Gp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gp.forEach(t),Sv=p(it),y(va.$$.fragment,it),Nv=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Qn.$$.fragment,Na),Iv=p(Na),mo=s(Na,"P",{});var Xi=n(mo);Bv=i(Xi,"The "),Vi=s(Xi,"A",{href:!0});var g0=n(Vi);Uv=i(g0,"TFWav2Vec2ForCTC"),g0.forEach(t),Rv=i(Xi," forward method, overrides the "),cc=s(Xi,"CODE",{});var _0=n(cc);Hv=i(_0,"__call__"),_0.forEach(t),Xv=i(Xi," special method."),Xi.forEach(t),Gv=p(Na),y(ba.$$.fragment,Na),Jv=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),Md=p(o),ho=s(o,"H2",{class:!0});var Jp=n(ho);ya=s(Jp,"A",{id:!0,class:!0,href:!0});var v0=n(ya);dc=s(v0,"SPAN",{});var b0=n(dc);y(Yn.$$.fragment,b0),b0.forEach(t),v0.forEach(t),Zv=p(Jp),pc=s(Jp,"SPAN",{});var w0=n(pc);Kv=i(w0,"FlaxWav2Vec2Model"),w0.forEach(t),Jp.forEach(t),Ad=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(er.$$.fragment,Oe),Qv=p(Oe),tr=s(Oe,"P",{});var Zp=n(tr);Yv=i(Zp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),or=s(Zp,"A",{href:!0,rel:!0});var y0=n(or);e2=i(y0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),y0.forEach(t),t2=i(Zp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Zp.forEach(t),o2=p(Oe),ar=s(Oe,"P",{});var Kp=n(ar);a2=i(Kp,"This model inherits from "),ji=s(Kp,"A",{href:!0});var k0=n(ji);s2=i(k0,"FlaxPreTrainedModel"),k0.forEach(t),n2=i(Kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kp.forEach(t),r2=p(Oe),sr=s(Oe,"P",{});var Qp=n(sr);i2=i(Qp,`This model is also a Flax Linen
`),nr=s(Qp,"A",{href:!0,rel:!0});var T0=n(nr);l2=i(T0,"flax.nn.Module"),T0.forEach(t),c2=i(Qp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Qp.forEach(t),d2=p(Oe),mc=s(Oe,"P",{});var $0=n(mc);p2=i($0,"Finally, this model supports inherent JAX features such as:"),$0.forEach(t),m2=p(Oe),bt=s(Oe,"UL",{});var Ia=n(bt);hc=s(Ia,"LI",{});var x0=n(hc);rr=s(x0,"A",{href:!0,rel:!0});var W0=n(rr);h2=i(W0,"Just-In-Time (JIT) compilation"),W0.forEach(t),x0.forEach(t),f2=p(Ia),fc=s(Ia,"LI",{});var V0=n(fc);ir=s(V0,"A",{href:!0,rel:!0});var j0=n(ir);u2=i(j0,"Automatic Differentiation"),j0.forEach(t),V0.forEach(t),g2=p(Ia),uc=s(Ia,"LI",{});var F0=n(uc);lr=s(F0,"A",{href:!0,rel:!0});var C0=n(lr);_2=i(C0,"Vectorization"),C0.forEach(t),F0.forEach(t),v2=p(Ia),gc=s(Ia,"LI",{});var E0=n(gc);cr=s(E0,"A",{href:!0,rel:!0});var q0=n(cr);b2=i(q0,"Parallelization"),q0.forEach(t),E0.forEach(t),Ia.forEach(t),w2=p(Oe),et=s(Oe,"DIV",{class:!0});var Ba=n(et);y(dr.$$.fragment,Ba),y2=p(Ba),fo=s(Ba,"P",{});var Gi=n(fo);k2=i(Gi,"The "),_c=s(Gi,"CODE",{});var P0=n(_c);T2=i(P0,"FlaxWav2Vec2PreTrainedModel"),P0.forEach(t),$2=i(Gi," forward method, overrides the "),vc=s(Gi,"CODE",{});var z0=n(vc);x2=i(z0,"__call__"),z0.forEach(t),W2=i(Gi," special method."),Gi.forEach(t),V2=p(Ba),y(ka.$$.fragment,Ba),j2=p(Ba),y(Ta.$$.fragment,Ba),Ba.forEach(t),Oe.forEach(t),Od=p(o),uo=s(o,"H2",{class:!0});var Yp=n(uo);$a=s(Yp,"A",{id:!0,class:!0,href:!0});var M0=n($a);bc=s(M0,"SPAN",{});var A0=n(bc);y(pr.$$.fragment,A0),A0.forEach(t),M0.forEach(t),F2=p(Yp),wc=s(Yp,"SPAN",{});var O0=n(wc);C2=i(O0,"FlaxWav2Vec2ForCTC"),O0.forEach(t),Yp.forEach(t),Ld=p(o),Q=s(o,"DIV",{class:!0});var Le=n(Q);y(mr.$$.fragment,Le),E2=p(Le),go=s(Le,"P",{});var Ji=n(go);q2=i(Ji,"Wav2Vec2 Model with a "),yc=s(Ji,"CODE",{});var L0=n(yc);P2=i(L0,"language modeling"),L0.forEach(t),z2=i(Ji,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),hr=s(Ji,"A",{href:!0,rel:!0});var D0=n(hr);M2=i(D0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),D0.forEach(t),A2=i(Ji,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ji.forEach(t),O2=p(Le),fr=s(Le,"P",{});var em=n(fr);L2=i(em,"This model inherits from "),Fi=s(em,"A",{href:!0});var S0=n(Fi);D2=i(S0,"FlaxPreTrainedModel"),S0.forEach(t),S2=i(em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),em.forEach(t),N2=p(Le),ur=s(Le,"P",{});var tm=n(ur);I2=i(tm,`This model is also a Flax Linen
`),gr=s(tm,"A",{href:!0,rel:!0});var N0=n(gr);B2=i(N0,"flax.nn.Module"),N0.forEach(t),U2=i(tm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),R2=p(Le),kc=s(Le,"P",{});var I0=n(kc);H2=i(I0,"Finally, this model supports inherent JAX features such as:"),I0.forEach(t),X2=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);Tc=s(Ua,"LI",{});var B0=n(Tc);_r=s(B0,"A",{href:!0,rel:!0});var U0=n(_r);G2=i(U0,"Just-In-Time (JIT) compilation"),U0.forEach(t),B0.forEach(t),J2=p(Ua),$c=s(Ua,"LI",{});var R0=n($c);vr=s(R0,"A",{href:!0,rel:!0});var H0=n(vr);Z2=i(H0,"Automatic Differentiation"),H0.forEach(t),R0.forEach(t),K2=p(Ua),xc=s(Ua,"LI",{});var X0=n(xc);br=s(X0,"A",{href:!0,rel:!0});var G0=n(br);Q2=i(G0,"Vectorization"),G0.forEach(t),X0.forEach(t),Y2=p(Ua),Wc=s(Ua,"LI",{});var J0=n(Wc);wr=s(J0,"A",{href:!0,rel:!0});var Z0=n(wr);eb=i(Z0,"Parallelization"),Z0.forEach(t),J0.forEach(t),Ua.forEach(t),tb=p(Le),tt=s(Le,"DIV",{class:!0});var Ra=n(tt);y(yr.$$.fragment,Ra),ob=p(Ra),_o=s(Ra,"P",{});var Zi=n(_o);ab=i(Zi,"The "),Vc=s(Zi,"CODE",{});var K0=n(Vc);sb=i(K0,"FlaxWav2Vec2PreTrainedModel"),K0.forEach(t),nb=i(Zi," forward method, overrides the "),jc=s(Zi,"CODE",{});var Q0=n(jc);rb=i(Q0,"__call__"),Q0.forEach(t),ib=i(Zi," special method."),Zi.forEach(t),lb=p(Ra),y(xa.$$.fragment,Ra),cb=p(Ra),y(Wa.$$.fragment,Ra),Ra.forEach(t),Le.forEach(t),Dd=p(o),vo=s(o,"H2",{class:!0});var om=n(vo);Va=s(om,"A",{id:!0,class:!0,href:!0});var Y0=n(Va);Fc=s(Y0,"SPAN",{});var ey=n(Fc);y(kr.$$.fragment,ey),ey.forEach(t),Y0.forEach(t),db=p(om),Cc=s(om,"SPAN",{});var ty=n(Cc);pb=i(ty,"FlaxWav2Vec2ForPreTraining"),ty.forEach(t),om.forEach(t),Sd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(Tr.$$.fragment,De),mb=p(De),bo=s(De,"P",{});var Ki=n(bo);hb=i(Ki,"Wav2Vec2 Model with a quantizer and "),Ec=s(Ki,"CODE",{});var oy=n(Ec);fb=i(oy,"VQ"),oy.forEach(t),ub=i(Ki,` head on top.
