...
When using `lr=None` with [Trainer](/docs/transformers/pr_15240/en/main_classes/trainer#transformers.Trainer) you will most likely need to use `AdafactorSchedule`
...
<div class="docstring">
<docstring><name>step</name><anchor>transformers.Adafactor.step</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization.py#L531</source><parameters>[{"name": "closure", "val": " = None"}]</parameters><paramsdesc>- **closure** (callable, optional) -- A closure that reevaluates the model
...
<div class="docstring">
<docstring><name>from\_config</name><anchor>transformers.AdamWeightDecay.from_config</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization_tf.py#L209</source><parameters>[{"name": "config", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.SchedulerType</name><anchor>transformers.SchedulerType</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/trainer_utils.py#L281</source><parameters>[{"name": "value", "val": ""}, {"name": "names", "val": " = None"}, {"name": "module", "val": " = None"}, {"name": "qualname", "val": " = None"}, {"name": "type", "val": " = None"}, {"name": "start", "val": " = 1"}]</parameters></docstring>
An enumeration.
...
<docstring><name>transformers.get\_constant\_schedule</name><anchor>transformers.get_constant_schedule</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization.py#L34</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
...
<docstring><name>transformers.get\_constant\_schedule\_with\_warmup</name><anchor>transformers.get_constant_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization.py#L50</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "num_warmup_steps", "val": ": int"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
...
<docstring><name>transformers.get\_cosine\_schedule\_with\_warmup</name><anchor>transformers.get_cosine_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization.py#L104</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "num_warmup_steps", "val": ": int"}, {"name": "num_training_steps", "val": ": int"}, {"name": "num_cycles", "val": ": float = 0.5"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
  The number of steps for the warmup phase.
...
<docstring><name>transformers.get\_cosine\_with\_hard\_restarts\_schedule\_with\_warmup</name><anchor>transformers.get_cosine_with_hard_restarts_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization.py#L138</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "num_warmup_steps", "val": ": int"}, {"name": "num_training_steps", "val": ": int"}, {"name": "num_cycles", "val": ": int = 1"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
  The number of steps for the warmup phase.
- **num_training_steps** (`int`) --
...
<docstring><name>transformers.get\_linear\_schedule\_with\_warmup</name><anchor>transformers.get_linear_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization.py#L75</source><parameters>[{"name": "optimizer", "val": ""}, {"name": "num_warmup_steps", "val": ""}, {"name": "num_training_steps", "val": ""}, {"name": "last_epoch", "val": " = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
  The number of steps for the warmup phase.
- **num_training_steps** (`int`) --
...
<docstring><name>class transformers.GradientAccumulator</name><anchor>transformers.GradientAccumulator</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization_tf.py#L282</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>reset</name><anchor>transformers.GradientAccumulator.reset</anchor><source>https://github.com/huggingface/transformers/blob/pr_15240/src/transformers/optimization_tf.py#L344</source><parameters>[]</parameters></docstring>
