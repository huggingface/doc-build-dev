...
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16635/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16635/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new B({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Rs=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16635/src/transformers/models/t5/modeling_t5.py#L1506"}}),Bs=new B({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16635/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16635/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16635/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16635/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16635/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16635/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16635/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new B({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16635/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16635/src/transformers/models/t5/modeling_tf_t5.py#L1309",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16635/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16635/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16635/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16635/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16635/src/transformers/models/t5/modeling_tf_t5.py#L1618",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16635/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16635/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16635/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16635/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16635/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16635/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16635/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
behavior.`),WT=d(),f(Yn.$$.fragment),RT=d(),Ze=o("div"),f(ha.$$.fragment),BT=d(),_n=o("p"),HT=r("The "),Cr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),ZT=r(" special method."),JT=d(),f(Zn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),ek=d(),f(ua.$$.fragment),Pc=d(),gn=o("h2"),Jn=o("a"),hl=o("span"),f(ma.$$.fragment),tk=d(),ul=o("span"),nk=r("TFT5ForConditionalGeneration"),Nc=d(),le=o("div"),f(fa.$$.fragment),ok=d(),_a=o("p"),sk=r("T5 Model with a "),ml=o("code"),ak=r("language modeling"),rk=r(" head on top."),ik=d(),ga=o("p"),dk=r("The T5 model was proposed in "),Ta=o("a"),lk=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),ck=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),pk=d(),ka=o("p"),hk=r("This model inherits from "),Pr=o("a"),uk=r("TFPreTrainedModel"),mk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fk=d(),va=o("p"),_k=r("This model is also a "),ba=o("a"),gk=r("tf.keras.Model"),Tk=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kk=d(),f(Xn.$$.fragment),vk=d(),Je=o("div"),f(ya.$$.fragment),bk=d(),Tn=o("p"),yk=r("The "),Nr=o("a"),wk=r("TFT5ForConditionalGeneration"),xk=r(" forward method, overrides the "),fl=o("code"),zk=r("__call__"),$k=r(" special method."),qk=d(),f(Qn.$$.fragment),Ek=d(),_l=o("p"),jk=r("Examples:"),Fk=d(),f(wa.$$.fragment),Oc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),Mk=d(),Tl=o("span"),Ck=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),Pk=d(),kl=o("p"),Nk=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Ok=d(),$a=o("p"),Lk=r("The T5 model was proposed in "),qa=o("a"),Ak=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Nb=a(or);lh=i(Nb,"here"),Nb.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Cb.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Uc=a(En);ph=i(Uc,"All checkpoints can be found on the "),wo=s(Uc,"A",{href:!0,rel:!0});var Ob=a(wo);hh=i(Ob,"hub"),Ob.forEach(t),uh=i(Uc,"."),Uc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Lb=a(xo);fh=i(Lb,"thomwolf"),Lb.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var Ab=a(zo);gh=i(Ab,"here"),Ab.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var Ib=a(jn);wi=s(Ib,"SPAN",{});var Db=a(wi);_($o.$$.fragment,Db),Db.forEach(t),Ib.forEach(t),kh=l(Wc),xi=s(Wc,"SPAN",{});var Sb=a(xi);vh=i(Sb,"Training"),Sb.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
directory.`),Hc.forEach(t),Lt.forEach(t),Qh=l(Bc),ge=s(Bc,"LI",{});var nt=a(ge);Oi=s(nt,"P",{});var e5=a(Oi);eu=i(e5,"Supervised training"),e5.forEach(t),tu=l(nt),Li=s(nt,"P",{});var t5=a(Li);nu=i(t5,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),t5.forEach(t),ou=l(nt),_(Fo.$$.fragment,nt),su=l(nt),re=s(nt,"P",{});var we=a(re);au=i(we,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ai=s(we,"CODE",{});var n5=a(Ai);ru=i(n5,"input_ids"),n5.forEach(t),iu=i(we,` (which are the
`),Ii=s(we,"CODE",{});var o5=a(Ii);du=i(o5,"input_ids"),o5.forEach(t),lu=i(we," of the encoded input sequence) and "),Di=s(we,"CODE",{});var s5=a(Di);cu=i(s5,"labels"),s5.forEach(t),pu=i(we," (which are the "),Si=s(we,"CODE",{});var a5=a(Si);hu=i(a5,"input_ids"),a5.forEach(t),uu=i(we,` of the encoded
target sequence). The model will automatically create the `),Gi=s(we,"CODE",{});var r5=a(Gi);mu=i(r5,"decoder_input_ids"),r5.forEach(t),fu=i(we," based on the "),Ui=s(we,"CODE",{});var i5=a(Ui);_u=i(i5,"labels"),i5.forEach(t),gu=i(we,`, by
shifting them one position to the right and prepending the `),Wi=s(we,"CODE",{});var d5=a(Wi);Tu=i(d5,"config.decoder_start_token_id"),d5.forEach(t),ku=i(we,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Ri=s(Gr,"CODE",{});var l5=a(Ri);yu=i(l5,"max_source_length"),l5.forEach(t),wu=i(Gr," and "),Bi=s(Gr,"CODE",{});var c5=a(Bi);xu=i(c5,"max_target_length"),c5.forEach(t),zu=i(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
...
of the `),Ki=s(ot,"CODE",{});var u5=a(Ki);Cu=i(u5,"CrossEntropyLoss"),u5.forEach(t),Pu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var m5=a(Yi);Nu=i(m5,"decoder_attention_mask"),m5.forEach(t),Ou=i(ot,` to ignore padded tokens from
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var f5=a(Mo);Lu=i(f5,"Flax summarization script"),f5.forEach(t),Au=i(ot,` for details). We also pass
`),Zi=s(ot,"CODE",{});var _5=a(Zi);Iu=i(_5,"attention_mask"),_5.forEach(t),Du=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Su=l(nt),_(Co.$$.fragment,nt),nt.forEach(t),Bc.forEach(t),sc=l(n),ir=s(n,"P",{});var g5=a(ir);Gu=i(g5,"Additional training tips:"),g5.forEach(t),ac=l(n),Et=s(n,"UL",{});var Ur=a(Et);Ji=s(Ur,"LI",{});var T5=a(Ji);Po=s(T5,"P",{});var Vc=a(Po);Uu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var k5=a(Xi);Wu=i(k5,"Trainer"),k5.forEach(t),Ru=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Vc.forEach(t),T5.forEach(t),Bu=l(Ur),Qi=s(Ur,"LI",{});var v5=a(Qi);Xt=s(v5,"P",{});var Wr=a(Xt);Hu=i(Wr,"According to "),No=s(Wr,"A",{href:!0,rel:!0});var b5=a(No);Vu=i(b5,"this forum post"),b5.forEach(t),Ku=i(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Oo=s(Wr,"A",{href:!0,rel:!0});var y5=a(Oo);Yu=i(y5,"paper"),y5.forEach(t),Zu=i(Wr,` for the task prefixes
used).`),Wr.forEach(t),v5.forEach(t),Ju=l(Ur),ed=s(Ur,"LI",{});var w5=a(ed);Lo=s(w5,"P",{});var Kc=a(Lo);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Kc.forEach(t),w5.forEach(t),Ur.forEach(t),rc=l(n),dr=s(n,"A",{id:!0}),a(dr).forEach(t),ic=l(n),Qt=s(n,"H2",{class:!0});var Yc=a(Qt);Cn=s(Yc,"A",{id:!0,class:!0,href:!0});var z5=a(Cn);nd=s(z5,"SPAN",{});var $5=a(nd);_(Ao.$$.fragment,$5),$5.forEach(t),z5.forEach(t),tm=l(Yc),od=s(Yc,"SPAN",{});var q5=a(od);nm=i(q5,"Inference"),q5.forEach(t),Yc.forEach(t),dc=l(n),gt=s(n,"P",{});var co=a(gt);om=i(co,"At inference time, it is recommended to use "),lr=s(co,"A",{href:!0});var E5=a(lr);sm=i(E5,"generate()"),E5.forEach(t),am=i(co,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),Io=s(co,"A",{href:!0,rel:!0});var j5=a(Io);rm=i(j5,"this blog post"),j5.forEach(t),im=i(co,` to know all the details about generating text with Transformers.
There\u2019s also `),Do=s(co,"A",{href:!0,rel:!0});var F5=a(Do);dm=i(F5,"this blog post"),F5.forEach(t),lm=i(co,` which explains how
generation works in general in encoder-decoder models.`),co.forEach(t),lc=l(n),_(So.$$.fragment,n),cc=l(n),We=s(n,"P",{});var At=a(We);cm=i(At,"Note that T5 uses the "),sd=s(At,"CODE",{});var M5=a(sd);pm=i(M5,"pad_token_id"),M5.forEach(t),hm=i(At," as the "),ad=s(At,"CODE",{});var C5=a(ad);um=i(C5,"decoder_start_token_id"),C5.forEach(t),mm=i(At,`, so when doing generation without using
`),cr=s(At,"A",{href:!0});var P5=a(cr);fm=i(P5,"generate()"),P5.forEach(t),_m=i(At,", make sure you start it with the "),rd=s(At,"CODE",{});var N5=a(rd);gm=i(N5,"pad_token_id"),N5.forEach(t),Tm=i(At,"."),At.forEach(t),pc=l(n),pr=s(n,"P",{});var O5=a(pr);km=i(O5,"The example above only shows a single example. You can also do batched inference, like so:"),O5.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Pn=s(Zc,"A",{id:!0,class:!0,href:!0});var L5=a(Pn);id=s(L5,"SPAN",{});var A5=a(id);_(Uo.$$.fragment,A5),A5.forEach(t),L5.forEach(t),vm=l(Zc),dd=s(Zc,"SPAN",{});var I5=a(dd);bm=i(I5,"Performance"),I5.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Wo=s(po,"A",{href:!0,rel:!0});var D5=a(Wo);wm=i(D5,"apex"),D5.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var S5=a(ld);zm=i(S5,"apex.normalization.FusedRMSNorm"),S5.forEach(t),$m=i(po," instead of "),cd=s(po,"CODE",{});var G5=a(cd);qm=i(G5,"T5LayerNorm"),G5.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);Nn=s(Jc,"A",{id:!0,class:!0,href:!0});var U5=a(Nn);pd=s(U5,"SPAN",{});var W5=a(pd);_(Ro.$$.fragment,W5),W5.forEach(t),U5.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var R5=a(hd);Fm=i(R5,"Example scripts"),R5.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var B5=a(ur);Mm=i(B5,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),B5.forEach(t),Tc=l(n),On=s(n,"UL",{});var Xc=a(On);ud=s(Xc,"LI",{});var H5=a(ud);nn=s(H5,"P",{});var Rr=a(nn);Cm=i(Rr,"pre-training: the "),Bo=s(Rr,"A",{href:!0,rel:!0});var V5=a(Bo);Pm=i(V5,"run_t5_mlm_flax.py"),V5.forEach(t),Nm=i(Rr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Rr,"A",{href:!0,rel:!0});var K5=a(Ho);Om=i(K5,"t5_tokenizer_model.py"),K5.forEach(t),Lm=i(Rr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Rr.forEach(t),H5.forEach(t),Am=l(Xc),md=s(Xc,"LI",{});var Y5=a(md);Ie=s(Y5,"P",{});var yt=a(Ie);Im=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Z5=a(Vo);Dm=i(Z5,"PyTorch"),Z5.forEach(t),Sm=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var J5=a(Ko);Gm=i(J5,"Tensorflow"),J5.forEach(t),Um=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var X5=a(Yo);Wm=i(X5,"Flax"),X5.forEach(t),Rm=i(yt,`) and translation scripts
(`),Zo=s(yt,"A",{href:!0,rel:!0});var Q5=a(Zo);Bm=i(Q5,"PyTorch"),Q5.forEach(t),Hm=i(yt," and "),Jo=s(yt,"A",{href:!0,rel:!0});var ey=a(Jo);Vm=i(ey,"Tensorflow"),ey.forEach(t),Km=i(yt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),yt.forEach(t),Y5.forEach(t),Xc.forEach(t),kc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);Ln=s(Qc,"A",{id:!0,class:!0,href:!0});var ty=a(Ln);fd=s(ty,"SPAN",{});var ny=a(fd);_(Xo.$$.fragment,ny),ny.forEach(t),ty.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var oy=a(_d);Zm=i(oy,"T5Config"),oy.forEach(t),Qc.forEach(t),vc=l(n),wt=s(n,"DIV",{class:!0});var Br=a(wt);_(Qo.$$.fragment,Br),Jm=l(Br),xt=s(Br,"P",{});var ho=a(xt);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var sy=a(mr);Qm=i(sy,"T5Model"),sy.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var ay=a(fr);tf=i(ay,"TFT5Model"),ay.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qp.forEach(t),WT=l(at),_(Yn.$$.fragment,at),RT=l(at),Ze=s(at,"DIV",{class:!0});var Bt=a(Ze);_(ha.$$.fragment,Bt),BT=l(Bt),_n=s(Bt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Cr=s(Qr,"A",{href:!0});var E1=a(Cr);VT=i(E1,"TFT5Model"),E1.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var j1=a(cl);YT=i(j1,"__call__"),j1.forEach(t),ZT=i(Qr," special method."),Qr.forEach(t),JT=l(Bt),_(Zn.$$.fragment,Bt),XT=l(Bt),pl=s(Bt,"P",{});var F1=a(pl);QT=i(F1,"Examples:"),F1.forEach(t),ek=l(Bt),_(ua.$$.fragment,Bt),Bt.forEach(t),at.forEach(t),Pc=l(n),gn=s(n,"H2",{class:!0});var Ep=a(gn);Jn=s(Ep,"A",{id:!0,class:!0,href:!0});var M1=a(Jn);hl=s(M1,"SPAN",{});var C1=a(hl);_(ma.$$.fragment,C1),C1.forEach(t),M1.forEach(t),tk=l(Ep),ul=s(Ep,"SPAN",{});var P1=a(ul);nk=i(P1,"TFT5ForConditionalGeneration"),P1.forEach(t),Ep.forEach(t),Nc=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),ok=l(rt),_a=s(rt,"P",{});var jp=a(_a);sk=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var N1=a(ml);ak=i(N1,"language modeling"),N1.forEach(t),rk=i(jp," head on top."),jp.forEach(t),ik=l(rt),ga=s(rt,"P",{});var Fp=a(ga);dk=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var O1=a(Ta);lk=i(O1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),O1.forEach(t),ck=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),pk=l(rt),ka=s(rt,"P",{});var Mp=a(ka);hk=i(Mp,"This model inherits from "),Pr=s(Mp,"A",{href:!0});var L1=a(Pr);uk=i(L1,"TFPreTrainedModel"),L1.forEach(t),mk=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),fk=l(rt),va=s(rt,"P",{});var Cp=a(va);_k=i(Cp,"This model is also a "),ba=s(Cp,"A",{href:!0,rel:!0});var A1=a(ba);gk=i(A1,"tf.keras.Model"),A1.forEach(t),Tk=i(Cp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cp.forEach(t),kk=l(rt),_(Xn.$$.fragment,rt),vk=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),bk=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);yk=i(ei,"The "),Nr=s(ei,"A",{href:!0});var I1=a(Nr);wk=i(I1,"TFT5ForConditionalGeneration"),I1.forEach(t),xk=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var D1=a(fl);zk=i(D1,"__call__"),D1.forEach(t),$k=i(ei," special method."),ei.forEach(t),qk=l(Ht),_(Qn.$$.fragment,Ht),Ek=l(Ht),_l=s(Ht,"P",{});var S1=a(_l);jk=i(S1,"Examples:"),S1.forEach(t),Fk=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Oc=l(n),kn=s(n,"H2",{class:!0});var Pp=a(kn);eo=s(Pp,"A",{id:!0,class:!0,href:!0});var G1=a(eo);gl=s(G1,"SPAN",{});var U1=a(gl);_(xa.$$.fragment,U1),U1.forEach(t),G1.forEach(t),Mk=l(Pp),Tl=s(Pp,"SPAN",{});var W1=a(Tl);Ck=i(W1,"TFT5EncoderModel"),W1.forEach(t),Pp.forEach(t),Lc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),Pk=l(it),kl=s(it,"P",{});var R1=a(kl);Nk=i(R1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),R1.forEach(t),Ok=l(it),$a=s(it,"P",{});var Np=a($a);Lk=i(Np,"The T5 model was proposed in "),qa=s(Np,"A",{href:!0,rel:!0});var B1=a(qa);Ak=i(B1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),B1.forEach(t),Ik=i(Np,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
