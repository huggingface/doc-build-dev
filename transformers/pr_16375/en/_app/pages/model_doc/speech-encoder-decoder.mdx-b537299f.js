import{S as Ts,i as xs,s as Ms,e as a,k as i,w as b,t as n,M as Ds,c as s,d as o,m as l,a as d,x as y,h as t,b as c,F as e,g as u,y as w,q as E,o as k,B as S,v as $s}from"../../chunks/vendor-6b77c823.js";import{T as Ss}from"../../chunks/Tip-39098574.js";import{D as ne}from"../../chunks/Docstring-abef54e3.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as xn}from"../../chunks/IconCopyLink-7a11ce68.js";function js(Je){let h,C,g,D,F;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),D=n("Module"),F=n(`
...
the latter silently ignores them.`)},l(T){h=s(T,"P",{});var M=d(h);C=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(T,M){u(T,h,M),e(h,C),e(h,g),e(g,D),e(h,F)},d(T){T&&o(h)}}}function Ps(Je){let h,C,g,D,F,T,M,L,Mn,on,$,Dn,Ye,$n,jn,wo,qn,Pn,Ze,zn,Fn,Ke,Cn,An,nn,N,Ln,Eo,Nn,In,he,Wn,Vn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,rn,H,te,ko,me,Gn,So,Jn,an,x,fe,Yn,re,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,rt,at,st,To,dt,ct,ue,it,ae,ge,lt,_e,pt,ro,ht,mt,ft,se,ve,ut,J,gt,xo,_t,vt,Mo,bt,yt,sn,Y,de,Do,be,wt,$o,Et,dn,m,ye,kt,Z,St,jo,Tt,xt,qo,Mt,Dt,$t,we,jt,Ee,qt,Pt,zt,ke,Ft,Se,Ct,At,Lt,Po,Nt,It,Te,Wt,ao,Vt,Ot,Bt,xe,Rt,Me,Ut,Ht,Gt,W,so,Jt,Yt,zo,Zt,Kt,Fo,Qt,Xt,er,j,De,or,K,nr,co,tr,rr,Co,ar,sr,dr,ce,cr,Ao,ir,lr,$e,pr,q,je,hr,Lo,mr,fr,Q,ur,No,gr,_r,Io,vr,br,yr,Wo,wr,Er,qe,cn,X,ie,Vo,Pe,kr,Oo,Sr,ln,f,ze,Tr,ee,xr,Bo,Mr,Dr,Ro,$r,jr,qr,Fe,Pr,Ce,zr,Fr,Cr,Ae,Ar,Le,Lr,Nr,Ir,Uo,Wr,Vr,Ne,Or,io,Br,Rr,Ur,Ie,Hr,We,Gr,Jr,Yr,V,lo,Zr,Kr,Ho,Qr,Xr,Go,ea,oa,na,P,Ve,ta,oe,ra,po,aa,sa,Jo,da,ca,ia,le,la,Yo,pa,ha,Oe,ma,A,Be,fa,Zo,ua,ga,Ko,_a,va,Re,pn;return T=new xn({}),me=new xn({}),fe=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16375/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_16375/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_16375/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16375/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<a href="/docs/transformers/pr_16375/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
recognition and speech translation has `),Eo=a("em"),Nn=n("e.g."),In=n(" been shown in "),he=a("a"),Wn=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
`),Xe=a("a"),Un=n("Speech2Text2"),Hn=n("."),rn=i(),H=a("h2"),te=a("a"),ko=a("span"),b(me.$$.fragment),Gn=i(),So=a("span"),Jn=n("SpeechEncoderDecoderConfig"),an=i(),x=a("div"),b(fe.$$.fragment),Yn=i(),re=a("p"),eo=a("a"),Zn=n("SpeechEncoderDecoderConfig"),Kn=n(` is the configuration class to store the configuration of a
...
documentation from `),to=a("a"),rt=n("PretrainedConfig"),at=n(" for more information."),st=i(),To=a("p"),dt=n("Examples:"),ct=i(),b(ue.$$.fragment),it=i(),ae=a("div"),b(ge.$$.fragment),lt=i(),_e=a("p"),pt=n("Instantiate a "),ro=a("a"),ht=n("SpeechEncoderDecoderConfig"),mt=n(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),ft=i(),se=a("div"),b(ve.$$.fragment),ut=i(),J=a("p"),gt=n("Serializes this instance to a Python dictionary. Override the default "),xo=a("em"),_t=n("to_dict()"),vt=n(" from "),Mo=a("em"),bt=n("PretrainedConfig"),yt=n("."),sn=i(),Y=a("h2"),de=a("a"),Do=a("span"),b(be.$$.fragment),wt=i(),$o=a("span"),Et=n("SpeechEncoderDecoderModel"),dn=i(),m=a("div"),b(ye.$$.fragment),kt=i(),Z=a("p"),St=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
...
models (see the examples for more information).`),It=i(),Te=a("p"),Wt=n("This model inherits from "),ao=a("a"),Vt=n("PreTrainedModel"),Ot=n(`. Check the superclass documentation for the generic methods the
...
:meth`),Fo=a("em"),Qt=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xt=n(" class method for the decoder."),er=i(),j=a("div"),b(De.$$.fragment),or=i(),K=a("p"),nr=n("The "),co=a("a"),tr=n("SpeechEncoderDecoderModel"),rr=n(" forward method, overrides the "),Co=a("code"),ar=n("__call__"),sr=n(" special method."),dr=i(),b(ce.$$.fragment),cr=i(),Ao=a("p"),ir=n("Examples:"),lr=i(),b($e.$$.fragment),pr=i(),q=a("div"),b(je.$$.fragment),hr=i(),Lo=a("p"),mr=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=a("code"),vr=n("model.train()"),br=n("."),yr=i(),Wo=a("p"),wr=n("Example:"),Er=i(),b(qe.$$.fragment),cn=i(),X=a("h2"),ie=a("a"),Vo=a("span"),b(Pe.$$.fragment),kr=i(),Oo=a("span"),Sr=n("FlaxSpeechEncoderDecoderModel"),ln=i(),f=a("div"),b(ze.$$.fragment),Tr=i(),ee=a("p"),xr=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
models (see the examples for more information).`),Vr=i(),Ne=a("p"),Or=n("This model inherits from "),io=a("a"),Br=n("FlaxPreTrainedModel"),Rr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ur=i(),Ie=a("p"),Hr=n(`This model is also a Flax Linen
`),We=a("a"),Gr=n("flax.nn.Module"),Jr=n(` subclass. Use it as a
...
recognition and speech translation has `),Eo=s(ho,"EM",{});var Ta=d(Eo);Nn=t(Ta,"e.g."),Ta.forEach(o),In=t(ho," been shown in "),he=s(ho,"A",{href:!0,rel:!0});var xa=d(he);Wn=t(xa,`Large-Scale Self- and Semi-Supervised Learning for Speech
...
`),Xe=s(mo,"A",{href:!0});var Da=d(Xe);Un=t(Da,"Speech2Text2"),Da.forEach(o),Hn=t(mo,"."),mo.forEach(o),rn=l(r),H=s(r,"H2",{class:!0});var hn=d(H);te=s(hn,"A",{id:!0,class:!0,href:!0});var $a=d(te);ko=s($a,"SPAN",{});var ja=d(ko);y(me.$$.fragment,ja),ja.forEach(o),$a.forEach(o),Gn=l(hn),So=s(hn,"SPAN",{});var qa=d(So);Jn=t(qa,"SpeechEncoderDecoderConfig"),qa.forEach(o),hn.forEach(o),an=l(r),x=s(r,"DIV",{class:!0});var z=d(x);y(fe.$$.fragment,z),Yn=l(z),re=s(z,"P",{});var Xo=d(re);eo=s(Xo,"A",{href:!0});var Pa=d(eo);Zn=t(Pa,"SpeechEncoderDecoderConfig"),Pa.forEach(o),Kn=t(Xo,` is the configuration class to store the configuration of a
...
arguments, defining the encoder and decoder configs.`),Xo.forEach(o),et=l(z),G=s(z,"P",{});var fo=d(G);ot=t(fo,"Configuration objects inherit from "),no=s(fo,"A",{href:!0});var Fa=d(no);nt=t(Fa,"PretrainedConfig"),Fa.forEach(o),tt=t(fo,` and can be used to control the model outputs. Read the
documentation from `),to=s(fo,"A",{href:!0});var Ca=d(to);rt=t(Ca,"PretrainedConfig"),Ca.forEach(o),at=t(fo," for more information."),fo.forEach(o),st=l(z),To=s(z,"P",{});var Aa=d(To);dt=t(Aa,"Examples:"),Aa.forEach(o),ct=l(z),y(ue.$$.fragment,z),it=l(z),ae=s(z,"DIV",{class:!0});var mn=d(ae);y(ge.$$.fragment,mn),lt=l(mn),_e=s(mn,"P",{});var fn=d(_e);pt=t(fn,"Instantiate a "),ro=s(fn,"A",{href:!0});var La=d(ro);ht=t(La,"SpeechEncoderDecoderConfig"),La.forEach(o),mt=t(fn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),fn.forEach(o),mn.forEach(o),ft=l(z),se=s(z,"DIV",{class:!0});var un=d(se);y(ve.$$.fragment,un),ut=l(un),J=s(un,"P",{});var uo=d(J);gt=t(uo,"Serializes this instance to a Python dictionary. Override the default "),xo=s(uo,"EM",{});var Na=d(xo);_t=t(Na,"to_dict()"),Na.forEach(o),vt=t(uo," from "),Mo=s(uo,"EM",{});var Ia=d(Mo);bt=t(Ia,"PretrainedConfig"),Ia.forEach(o),yt=t(uo,"."),uo.forEach(o),un.forEach(o),z.forEach(o),sn=l(r),Y=s(r,"H2",{class:!0});var gn=d(Y);de=s(gn,"A",{id:!0,class:!0,href:!0});var Wa=d(de);Do=s(Wa,"SPAN",{});var Va=d(Do);y(be.$$.fragment,Va),Va.forEach(o),Wa.forEach(o),wt=l(gn),$o=s(gn,"SPAN",{});var Oa=d($o);Et=t(Oa,"SpeechEncoderDecoderModel"),Oa.forEach(o),gn.forEach(o),dn=l(r),m=s(r,"DIV",{class:!0});var _=d(m);y(ye.$$.fragment,_),kt=l(_),Z=s(_,"P",{});var go=d(Z);St=t(go,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
and should be fine-tuned on a downstream generative task, like summarization.`),go.forEach(o),$t=l(_),we=s(_,"P",{});var _n=d(we);jt=t(_n,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
models (see the examples for more information).`),Ga.forEach(o),It=l(_),Te=s(_,"P",{});var bn=d(Te);Wt=t(bn,"This model inherits from "),ao=s(bn,"A",{href:!0});var Ja=d(ao);Vt=t(Ja,"PreTrainedModel"),Ja.forEach(o),Ot=t(bn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yn.forEach(o),Gt=l(_),W=s(_,"P",{});var He=d(W);so=s(He,"A",{href:!0});var Za=d(so);Jt=t(Za,"SpeechEncoderDecoderModel"),Za.forEach(o),Yt=t(He,` is a generic model class that will be instantiated as a transformer architecture with
one of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),zo=s(He,"EM",{});var Ka=d(zo);Zt=t(Ka,"~transformers.AutoModel.from_pretrained"),Ka.forEach(o),Kt=t(He,` class method for the encoder and
:meth`),Fo=s(He,"EM",{});var Qa=d(Fo);Qt=t(Qa,"~transformers.AutoModelForCausalLM.from_pretrained"),Qa.forEach(o),Xt=t(He," class method for the decoder."),He.forEach(o),er=l(_),j=s(_,"DIV",{class:!0});var B=d(j);y(De.$$.fragment,B),or=l(B),K=s(B,"P",{});var _o=d(K);nr=t(_o,"The "),co=s(_o,"A",{href:!0});var Xa=d(co);tr=t(Xa,"SpeechEncoderDecoderModel"),Xa.forEach(o),rr=t(_o," forward method, overrides the "),Co=s(_o,"CODE",{});var es=d(Co);ar=t(es,"__call__"),es.forEach(o),sr=t(_o," special method."),_o.forEach(o),dr=l(B),y(ce.$$.fragment,B),cr=l(B),Ao=s(B,"P",{});var os=d(Ao);ir=t(os,"Examples:"),os.forEach(o),lr=l(B),y($e.$$.fragment,B),B.forEach(o),pr=l(_),q=s(_,"DIV",{class:!0});var R=d(q);y(je.$$.fragment,R),hr=l(R),Lo=s(R,"P",{});var ns=d(Lo);mr=t(ns,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=s(vo,"CODE",{});var rs=d(Io);vr=t(rs,"model.train()"),rs.forEach(o),br=t(vo,"."),vo.forEach(o),yr=l(R),Wo=s(R,"P",{});var as=d(Wo);wr=t(as,"Example:"),as.forEach(o),Er=l(R),y(qe.$$.fragment,R),R.forEach(o),_.forEach(o),cn=l(r),X=s(r,"H2",{class:!0});var wn=d(X);ie=s(wn,"A",{id:!0,class:!0,href:!0});var ss=d(ie);Vo=s(ss,"SPAN",{});var ds=d(Vo);y(Pe.$$.fragment,ds),ds.forEach(o),ss.forEach(o),kr=l(wn),Oo=s(wn,"SPAN",{});var cs=d(Oo);Sr=t(cs,"FlaxSpeechEncoderDecoderModel"),cs.forEach(o),wn.forEach(o),ln=l(r),f=s(r,"DIV",{class:!0});var v=d(f);y(ze.$$.fragment,v),Tr=l(v),ee=s(v,"P",{});var bo=d(ee);xr=t(bo,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
and should be fine-tuned on a downstream generative task, like summarization.`),bo.forEach(o),qr=l(v),Fe=s(v,"P",{});var En=d(Fe);Pr=t(En,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
models (see the examples for more information).`),ms.forEach(o),Vr=l(v),Ne=s(v,"P",{});var Sn=d(Ne);Or=t(Sn,"This model inherits from "),io=s(Sn,"A",{href:!0});var fs=d(io);Br=t(fs,"FlaxPreTrainedModel"),fs.forEach(o),Rr=t(Sn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sn.forEach(o),Ur=l(v),Ie=s(v,"P",{});var Tn=d(Ie);Hr=t(Tn,`This model is also a Flax Linen
`),We=s(Tn,"A",{href:!0,rel:!0});var us=d(We);Gr=t(us,"flax.nn.Module"),us.forEach(o),Jr=t(Tn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tn.forEach(o),Yr=l(v),V=s(v,"P",{});var Ge=d(V);lo=s(Ge,"A",{href:!0});var gs=d(lo);Zr=t(gs,"FlaxSpeechEncoderDecoderModel"),gs.forEach(o),Kr=t(Ge,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one
...
encoder and :meth`),Go=s(Ge,"EM",{});var vs=d(Go);ea=t(vs,"~transformers.FlaxAutoModelForCausalLM.from_pretrained"),vs.forEach(o),oa=t(Ge," class method for the decoder."),Ge.forEach(o),na=l(v),P=s(v,"DIV",{class:!0});var U=d(P);y(Ve.$$.fragment,U),ta=l(U),oe=s(U,"P",{});var yo=d(oe);ra=t(yo,"The "),po=s(yo,"A",{href:!0});var bs=d(po);aa=t(bs,"FlaxSpeechEncoderDecoderModel"),bs.forEach(o),sa=t(yo," forward method, overrides the "),Jo=s(yo,"CODE",{});var ys=d(Jo);da=t(ys,"__call__"),ys.forEach(o),ca=t(yo," special method."),yo.forEach(o),ia=l(U),y(le.$$.fragment,U),la=l(U),Yo=s(U,"P",{});var ws=d(Yo);pa=t(ws,"Examples:"),ws.forEach(o),ha=l(U),y(Oe.$$.fragment,U),U.forEach(o),ma=l(v),A=s(v,"DIV",{class:!0});var pe=d(A);y(Be.$$.fragment,pe),fa=l(pe),Zo=s(pe,"P",{});var Es=d(Zo);ua=t(Es,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Es.forEach(o),ga=l(pe),Ko=s(pe,"P",{});var ks=d(Ko);_a=t(ks,"Example:"),ks.forEach(o),va=l(pe),y(Re.$$.fragment,pe),pe.forEach(o),v.forEach(o),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(zs)),c(D,"id","speech-encoder-decoder-models"),c(D,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(D,"href","#speech-encoder-decoder-models"),c(g,"class","relative group"),c(Ye,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel"),c(Ze,"href","wav2vec2"),c(Ke,"href","hubert"),c(he,"href","https://arxiv.org/abs/2104.06678"),c(he,"rel","nofollow"),c(Qe,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel"),c(Xe,"href","speech_to_text_2"),c(te,"id","transformers.SpeechEncoderDecoderConfig"),c(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(te,"href","#transformers.SpeechEncoderDecoderConfig"),c(H,"class","relative group"),c(eo,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig"),c(oo,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel"),c(no,"href","/docs/transformers/pr_16375/en/main_classes/configuration#transformers.PretrainedConfig"),c(to,"href","/docs/transformers/pr_16375/en/main_classes/configuration#transformers.PretrainedConfig"),c(ro,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig"),c(ae,"class","docstring"),c(se,"class","docstring"),c(x,"class","docstring"),c(de,"id","transformers.SpeechEncoderDecoderModel"),c(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(de,"href","#transformers.SpeechEncoderDecoderModel"),c(Y,"class","relative group"),c(Ee,"href","https://arxiv.org/abs/1907.12461"),c(Ee,"rel","nofollow"),c(Se,"href","https://arxiv.org/abs/2104.06678"),c(Se,"rel","nofollow"),c(ao,"href","/docs/transformers/pr_16375/en/main_classes/model#transformers.PreTrainedModel"),c(Me,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Me,"rel","nofollow"),c(so,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel"),c(co,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel"),c(j,"class","docstring"),c(q,"class","docstring"),c(m,"class","docstring"),c(ie,"id","transformers.FlaxSpeechEncoderDecoderModel"),c(ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ie,"href","#transformers.FlaxSpeechEncoderDecoderModel"),c(X,"class","relative group"),c(Ce,"href","https://arxiv.org/abs/1907.12461"),c(Ce,"rel","nofollow"),c(Le,"href","https://arxiv.org/abs/2104.06678"),c(Le,"rel","nofollow"),c(io,"href","/docs/transformers/pr_16375/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(We,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(We,"rel","nofollow"),c(lo,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.FlaxSpeechEncoderDecoderModel"),c(po,"href","/docs/transformers/pr_16375/en/model_doc/speech-encoder-decoder#transformers.FlaxSpeechEncoderDecoderModel"),c(P,"class","docstring"),c(A,"class","docstring"),c(f,"class","docstring")},m(r,p){e(document.head,h),u(r,C,p),u(r,g,p),e(g,D),e(D,F),w(T,F,null),e(g,M),e(g,L),e(L,Mn),u(r,on,p),u(r,$,p),e($,Dn),e($,Ye),e(Ye,$n),e($,jn),e($,wo),e(wo,qn),e($,Pn),e($,Ze),e(Ze,zn),e($,Fn),e($,Ke),e(Ke,Cn),e($,An),u(r,nn,p),u(r,N,p),e(N,Ln),e(N,Eo),e(Eo,Nn),e(N,In),e(N,he),e(he,Wn),e(N,Vn),u(r,tn,p),u(r,I,p),e(I,On),e(I,Qe),e(Qe,Bn),e(I,Rn),e(I,Xe),e(Xe,Un),e(I,Hn),u(r,rn,p),u(r,H,p),e(H,te),e(te,ko),w(me,ko,null),e(H,Gn),e(H,So),e(So,Jn),u(r,an,p),u(r,x,p),w(fe,x,null),e(x,Yn),e(x,re),e(re,eo),e(eo,Zn),e(re,Kn),e(re,oo),e(oo,Qn),e(re,Xn),e(x,et),e(x,G),e(G,ot),e(G,no),e(no,nt),e(G,tt),e(G,to),e(to,rt),e(G,at),e(x,st),e(x,To),e(To,dt),e(x,ct),w(ue,x,null),e(x,it),e(x,ae),w(ge,ae,null),e(ae,lt),e(ae,_e),e(_e,pt),e(_e,ro),e(ro,ht),e(_e,mt),e(x,ft),e(x,se),w(ve,se,null),e(se,ut),e(se,J),e(J,gt),e(J,xo),e(xo,_t),e(J,vt),e(J,Mo),e(Mo,bt),e(J,yt),u(r,sn,p),u(r,Y,p),e(Y,de),e(de,Do),w(be,Do,null),e(Y,wt),e(Y,$o),e($o,Et),u(r,dn,p),u(r,m,p),w(ye,m,null),e(m,kt),e(m,Z),e(Z,St),e(Z,jo),e(jo,Tt),e(Z,xt),e(Z,qo),e(qo,Mt),e(Z,Dt),e(m,$t),e(m,we),e(we,jt),e(we,Ee),e(Ee,qt),e(we,Pt),e(m,zt),e(m,ke),e(ke,Ft),e(ke,Se),e(Se,Ct),e(ke,At),e(m,Lt),e(m,Po),e(Po,Nt),e(m,It),e(m,Te),e(Te,Wt),e(Te,ao),e(ao,Vt),e(Te,Ot),e(m,Bt),e(m,xe),e(xe,Rt),e(xe,Me),e(Me,Ut),e(xe,Ht),e(m,Gt),e(m,W),e(W,so),e(so,Jt),e(W,Yt),e(W,zo),e(zo,Zt),e(W,Kt),e(W,Fo),e(Fo,Qt),e(W,Xt),e(m,er),e(m,j),w(De,j,null),e(j,or),e(j,K),e(K,nr),e(K,co),e(co,tr),e(K,rr),e(K,Co),e(Co,ar),e(K,sr),e(j,dr),w(ce,j,null),e(j,cr),e(j,Ao),e(Ao,ir),e(j,lr),w($e,j,null),e(m,pr),e(m,q),w(je,q,null),e(q,hr),e(q,Lo),e(Lo,mr),e(q,fr),e(q,Q),e(Q,ur),e(Q,No),e(No,gr),e(Q,_r),e(Q,Io),e(Io,vr),e(Q,br),e(q,yr),e(q,Wo),e(Wo,wr),e(q,Er),w(qe,q,null),u(r,cn,p),u(r,X,p),e(X,ie),e(ie,Vo),w(Pe,Vo,null),e(X,kr),e(X,Oo),e(Oo,Sr),u(r,ln,p),u(r,f,p),w(ze,f,null),e(f,Tr),e(f,ee),e(ee,xr),e(ee,Bo),e(Bo,Mr),e(ee,Dr),e(ee,Ro),e(Ro,$r),e(ee,jr),e(f,qr),e(f,Fe),e(Fe,Pr),e(Fe,Ce),e(Ce,zr),e(Fe,Fr),e(f,Cr),e(f,Ae),e(Ae,Ar),e(Ae,Le),e(Le,Lr),e(Ae,Nr),e(f,Ir),e(f,Uo),e(Uo,Wr),e(f,Vr),e(f,Ne),e(Ne,Or),e(Ne,io),e(io,Br),e(Ne,Rr),e(f,Ur),e(f,Ie),e(Ie,Hr),e(Ie,We),e(We,Gr),e(Ie,Jr),e(f,Yr),e(f,V),e(V,lo),e(lo,Zr),e(V,Kr),e(V,Ho),e(Ho,Qr),e(V,Xr),e(V,Go),e(Go,ea),e(V,oa),e(f,na),e(f,P),w(Ve,P,null),e(P,ta),e(P,oe),e(oe,ra),e(oe,po),e(po,aa),e(oe,sa),e(oe,Jo),e(Jo,da),e(oe,ca),e(P,ia),w(le,P,null),e(P,la),e(P,Yo),e(Yo,pa),e(P,ha),w(Oe,P,null),e(f,ma),e(f,A),w(Be,A,null),e(A,fa),e(A,Zo),e(Zo,ua),e(A,ga),e(A,Ko),e(Ko,_a),e(A,va),w(Re,A,null),pn=!0},p(r,[p]){const Ue={};p&2&&(Ue.$$scope={dirty:p,ctx:r}),ce.$set(Ue);const Qo={};p&2&&(Qo.$$scope={dirty:p,ctx:r}),le.$set(Qo)},i(r){pn||(E(T.$$.fragment,r),E(me.$$.fragment,r),E(fe.$$.fragment,r),E(ue.$$.fragment,r),E(ge.$$.fragment,r),E(ve.$$.fragment,r),E(be.$$.fragment,r),E(ye.$$.fragment,r),E(De.$$.fragment,r),E(ce.$$.fragment,r),E($e.$$.fragment,r),E(je.$$.fragment,r),E(qe.$$.fragment,r),E(Pe.$$.fragment,r),E(ze.$$.fragment,r),E(Ve.$$.fragment,r),E(le.$$.fragment,r),E(Oe.$$.fragment,r),E(Be.$$.fragment,r),E(Re.$$.fragment,r),pn=!0)},o(r){k(T.$$.fragment,r),k(me.$$.fragment,r),k(fe.$$.fragment,r),k(ue.$$.fragment,r),k(ge.$$.fragment,r),k(ve.$$.fragment,r),k(be.$$.fragment,r),k(ye.$$.fragment,r),k(De.$$.fragment,r),k(ce.$$.fragment,r),k($e.$$.fragment,r),k(je.$$.fragment,r),k(qe.$$.fragment,r),k(Pe.$$.fragment,r),k(ze.$$.fragment,r),k(Ve.$$.fragment,r),k(le.$$.fragment,r),k(Oe.$$.fragment,r),k(Be.$$.fragment,r),k(Re.$$.fragment,r),pn=!1},d(r){o(h),r&&o(C),r&&o(g),S(T),r&&o(on),r&&o($),r&&o(nn),r&&o(N),r&&o(tn),r&&o(I),r&&o(rn),r&&o(H),S(me),r&&o(an),r&&o(x),S(fe),S(ue),S(ge),S(ve),r&&o(sn),r&&o(Y),S(be),r&&o(dn),r&&o(m),S(ye),S(De),S(ce),S($e),S(je),S(qe),r&&o(cn),r&&o(X),S(Pe),r&&o(ln),r&&o(f),S(ze),S(Ve),S(le),S(Oe),S(Be),S(Re)}}}const zs={local:"speech-encoder-decoder-models",sections:[{local:"transformers.SpeechEncoderDecoderConfig",title:"SpeechEncoderDecoderConfig"},{local:"transformers.SpeechEncoderDecoderModel",title:"SpeechEncoderDecoderModel"},{local:"transformers.FlaxSpeechEncoderDecoderModel",title:"FlaxSpeechEncoderDecoderModel"}],title:"Speech Encoder Decoder Models"};function Fs(Je){return $s(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ws extends Ts{constructor(h){super();xs(this,h,Fs,Ps,Ms,{})}}export{Ws as default,zs as metadata};
