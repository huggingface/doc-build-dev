import{S as rc,i as ac,s as sc,e as r,k as c,w as u,t,M as dc,c as a,d as o,m as l,a as s,x as g,h as n,b as i,F as e,g as w,y as _,q as v,o as b,B as T,v as ic}from"../../chunks/vendor-6b77c823.js";import{T as Vd}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-abef54e3.js";import{C as yo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Yt}from"../../chunks/IconCopyLink-7a11ce68.js";function cc(pe){let p,F,f,M,P;return{c(){p=r("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),M=t("Module"),P=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);F=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(j,"CODE",{});var C=s(f);M=n(C,"Module"),C.forEach(o),P=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,F),e(p,f),e(f,M),e(p,P)},d(y){y&&o(p)}}}function lc(pe){let p,F,f,M,P;return{c(){p=r("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),M=t("Module"),P=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);F=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(j,"CODE",{});var C=s(f);M=n(C,"Module"),C.forEach(o),P=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,F),e(p,f),e(f,M),e(p,P)},d(y){y&&o(p)}}}function pc(pe){let p,F,f,M,P;return{c(){p=r("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),M=t("Module"),P=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);F=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(j,"CODE",{});var C=s(f);M=n(C,"Module"),C.forEach(o),P=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,F),e(p,f),e(f,M),e(p,P)},d(y){y&&o(p)}}}function hc(pe){let p,F,f,M,P,y,j,C,Vn,Jt,m,$n,Eo,qn,zn,rt,Pn,Fn,ko,Cn,An,xo,Sn,In,jo,Ln,Nn,Do,On,Rn,at,Bn,Gn,Mo,Wn,Un,Vo,Hn,Zn,$o,Yn,Jn,qo,Kn,Qn,Kt,he,Xn,xe,er,or,Qt,G,tr,zo,nr,rr,Po,ar,sr,Xt,Q,me,st,je,dr,dt,ir,en,z,De,cr,fe,Fo,lr,pr,Co,hr,mr,fr,X,ur,Ao,gr,_r,So,vr,br,Tr,it,wr,yr,Me,Er,ue,Ve,kr,$e,xr,Io,jr,Dr,Mr,ge,qe,Vr,ee,$r,ct,qr,zr,lt,Pr,Fr,on,oe,_e,pt,ze,Cr,ht,Ar,tn,E,Pe,Sr,te,Ir,mt,Lr,Nr,ft,Or,Rr,Br,Fe,Gr,Ce,Wr,Ur,Hr,Ae,Zr,Se,Yr,Jr,Kr,ut,Qr,Xr,Ie,ea,Lo,oa,ta,na,Le,ra,Ne,aa,sa,da,W,No,ia,ca,gt,la,pa,_t,ha,ma,fa,A,Oe,ua,ne,ga,Oo,_a,va,vt,ba,Ta,wa,ve,ya,bt,Ea,ka,Re,xa,S,Be,ja,Tt,Da,Ma,re,Va,wt,$a,qa,yt,za,Pa,Fa,Et,Ca,Aa,Ge,nn,ae,be,kt,We,Sa,xt,Ia,rn,k,Ue,La,se,Na,jt,Oa,Ra,Dt,Ba,Ga,Wa,He,Ua,Ze,Ha,Za,Ya,Ye,Ja,Je,Ka,Qa,Xa,Mt,es,os,Ke,ts,Ro,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Bo,ls,ps,Vt,hs,ms,$t,fs,us,gs,I,eo,_s,de,vs,Go,bs,Ts,qt,ws,ys,Es,Te,ks,zt,xs,js,oo,Ds,O,to,Ms,Pt,Vs,$s,Ft,qs,zs,no,an,ie,we,Ct,ro,Ps,At,Fs,sn,x,ao,Cs,ce,As,St,Ss,Is,It,Ls,Ns,Os,so,Rs,io,Bs,Gs,Ws,co,Us,lo,Hs,Zs,Ys,Lt,Js,Ks,po,Qs,Wo,Xs,ed,od,ho,td,mo,nd,rd,ad,H,Uo,sd,dd,Nt,id,cd,Ot,ld,pd,hd,L,fo,md,le,fd,Ho,ud,gd,Rt,_d,vd,bd,ye,Td,Bt,wd,yd,uo,Ed,R,go,kd,Gt,xd,jd,Wt,Dd,Md,_o,dn;return y=new Yt({}),je=new Yt({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16375/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16375/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16375/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_16375/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"
>VisionEncoderDecoderConfig</a></p>
`}}),qe=new B({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16375/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L110",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, any]</code></p>
`}}),ze=new Yt({}),Pe=new B({props:{name:"class transformers.VisionEncoderDecoderModel",anchor:"transformers.VisionEncoderDecoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"decoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16375/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L148",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16375/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16375/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oe=new B({props:{name:"forward",anchor:"transformers.VisionEncoderDecoderModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16375/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L400",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16375/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16375/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16375/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16375/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),ve=new Vd({props:{$$slots:{default:[cc]},$$scope:{ctx:pe}}}),Re=new yo({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests
...
<a href="/docs/transformers/pr_16375/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_16375/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16375/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16375/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<p>A <a
  href="/docs/transformers/pr_16375/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),Te=new Vd({props:{$$slots:{default:[lc]},$$scope:{ctx:pe}}}),oo=new yo({props:{code:`from transformers import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
from PIL import Image
import requests
...
example is <code>google/vit-base-patch16-224-in21k</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16375/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_16375/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),ye=new Vd({props:{$$slots:{default:[pc]},$$scope:{ctx:pe}}}),uo=new yo({props:{code:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){p=r("meta"),F=c(),f=r("h1"),M=r("a"),P=r("span"),u(y.$$.fragment),j=c(),C=r("span"),Vn=t("Vision Encoder Decoder Models"),Jt=c(),m=r("p"),$n=t("The "),Eo=r("a"),qn=t("VisionEncoderDecoderModel"),zn=t(` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),rt=r("em"),Pn=t("e.g."),Fn=c(),ko=r("a"),Cn=t("ViT"),An=t(", "),xo=r("a"),Sn=t("BEiT"),In=t(", "),jo=r("a"),Ln=t("DeiT"),Nn=t(", "),Do=r("a"),On=t("Swin"),Rn=t(`)
and any pretrained language model as the decoder (`),at=r("em"),Bn=t("e.g."),Gn=c(),Mo=r("a"),Wn=t("RoBERTa"),Un=t(", "),Vo=r("a"),Hn=t("GPT2"),Zn=t(", "),$o=r("a"),Yn=t("BERT"),Jn=t(", "),qo=r("a"),Kn=t("DistilBERT"),Qn=t(")."),Kt=c(),he=r("p"),Xn=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
Zhoujun Li, Furu Wei.`),Qt=c(),G=r("p"),tr=t("An example of how to use a "),zo=r("a"),nr=t("VisionEncoderDecoderModel"),rr=t(" for inference can be seen in "),Po=r("a"),ar=t("TrOCR"),sr=t("."),Xt=c(),Q=r("h2"),me=r("a"),st=r("span"),u(je.$$.fragment),dr=c(),dt=r("span"),ir=t("VisionEncoderDecoderConfig"),en=c(),z=r("div"),u(De.$$.fragment),cr=c(),fe=r("p"),Fo=r("a"),lr=t("VisionEncoderDecoderConfig"),pr=t(` is the configuration class to store the configuration of a
...
documentation from `),So=r("a"),vr=t("PretrainedConfig"),br=t(" for more information."),Tr=c(),it=r("p"),wr=t("Examples:"),yr=c(),u(Me.$$.fragment),Er=c(),ue=r("div"),u(Ve.$$.fragment),kr=c(),$e=r("p"),xr=t("Instantiate a "),Io=r("a"),jr=t("VisionEncoderDecoderConfig"),Dr=t(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),Mr=c(),ge=r("div"),u(qe.$$.fragment),Vr=c(),ee=r("p"),$r=t("Serializes this instance to a Python dictionary. Override the default "),ct=r("em"),qr=t("to_dict()"),zr=t(" from "),lt=r("em"),Pr=t("PretrainedConfig"),Fr=t("."),on=c(),oe=r("h2"),_e=r("a"),pt=r("span"),u(ze.$$.fragment),Cr=c(),ht=r("span"),Ar=t("VisionEncoderDecoderModel"),tn=c(),E=r("div"),u(Pe.$$.fragment),Sr=c(),te=r("p"),Ir=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
...
other models (see the examples for more information).`),Xr=c(),Ie=r("p"),ea=t("This model inherits from "),Lo=r("a"),oa=t("PreTrainedModel"),ta=t(`. Check the superclass documentation for the generic methods the
...
:meth`),_t=r("em"),ha=t("~transformers.AutoModelForCausalLM.from_pretrained"),ma=t(" class method for the decoder."),fa=c(),A=r("div"),u(Oe.$$.fragment),ua=c(),ne=r("p"),ga=t("The "),Oo=r("a"),_a=t("VisionEncoderDecoderModel"),va=t(" forward method, overrides the "),vt=r("code"),ba=t("__call__"),Ta=t(" special method."),wa=c(),u(ve.$$.fragment),ya=c(),bt=r("p"),Ea=t("Examples:"),ka=c(),u(Re.$$.fragment),xa=c(),S=r("div"),u(Be.$$.fragment),ja=c(),Tt=r("p"),Da=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Ma=c(),re=r("p"),Va=t("The model is set in evaluation mode by default using "),wt=r("code"),$a=t("model.eval()"),qa=t(` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),yt=r("code"),za=t("model.train()"),Pa=t("."),Fa=c(),Et=r("p"),Ca=t("Example:"),Aa=c(),u(Ge.$$.fragment),nn=c(),ae=r("h2"),be=r("a"),kt=r("span"),u(We.$$.fragment),Sa=c(),xt=r("span"),Ia=t("TFVisionEncoderDecoderModel"),rn=c(),k=r("div"),u(Ue.$$.fragment),La=c(),se=r("p"),Na=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
`),$t=r("code"),fs=t("from_pretrained()"),us=t("class method for the decoder."),gs=c(),I=r("div"),u(eo.$$.fragment),_s=c(),de=r("p"),vs=t("The "),Go=r("a"),bs=t("TFVisionEncoderDecoderModel"),Ts=t(" forward method, overrides the "),qt=r("code"),ws=t("__call__"),ys=t(" special method."),Es=c(),u(Te.$$.fragment),ks=c(),zt=r("p"),xs=t("Examples:"),js=c(),u(oo.$$.fragment),Ds=c(),O=r("div"),u(to.$$.fragment),Ms=c(),Pt=r("p"),Vs=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),$s=c(),Ft=r("p"),qs=t("Example:"),zs=c(),u(no.$$.fragment),an=c(),ie=r("h2"),we=r("a"),Ct=r("span"),u(ro.$$.fragment),Ps=c(),At=r("span"),Fs=t("FlaxVisionEncoderDecoderModel"),sn=c(),x=r("div"),u(ao.$$.fragment),Cs=c(),ce=r("p"),As=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),St=r("code"),Ss=t("from_pretrained()"),Is=t("function and the decoder is loaded via "),It=r("code"),Ls=t("from_pretrained()"),Ns=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
for the encoder and :meth`),Ot=r("em"),ld=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),pd=t(" class method for the decoder."),hd=c(),L=r("div"),u(fo.$$.fragment),md=c(),le=r("p"),fd=t("The "),Ho=r("a"),ud=t("FlaxVisionEncoderDecoderModel"),gd=t(" forward method, overrides the "),Rt=r("code"),_d=t("__call__"),vd=t(" special method."),bd=c(),u(ye.$$.fragment),Td=c(),Bt=r("p"),wd=t("Examples:"),yd=c(),u(uo.$$.fragment),Ed=c(),R=r("div"),u(go.$$.fragment),kd=c(),Gt=r("p"),xd=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),jd=c(),Wt=r("p"),Dd=t("Example:"),Md=c(),u(_o.$$.fragment),this.h()},l(d){const h=dc('[data-svelte="svelte-1phssyn"]',document.head);p=a(h,"META",{name:!0,content:!0}),h.forEach(o),F=l(d),f=a(d,"H1",{class:!0});var vo=s(f);M=a(vo,"A",{id:!0,class:!0,href:!0});var Ut=s(M);P=a(Ut,"SPAN",{});var Ht=s(P);g(y.$$.fragment,Ht),Ht.forEach(o),Ut.forEach(o),j=l(vo),C=a(vo,"SPAN",{});var $d=s(C);Vn=n($d,"Vision Encoder Decoder Models"),$d.forEach(o),vo.forEach(o),Jt=l(d),m=a(d,"P",{});var D=s(m);$n=n(D,"The "),Eo=a(D,"A",{href:!0});var qd=s(Eo);qn=n(qd,"VisionEncoderDecoderModel"),qd.forEach(o),zn=n(D,` can be used to initialize an image-to-text-sequence model with any
pretrained Transformer-based vision autoencoding model as the encoder (`),rt=a(D,"EM",{});var zd=s(rt);Pn=n(zd,"e.g."),zd.forEach(o),Fn=l(D),ko=a(D,"A",{href:!0});var Pd=s(ko);Cn=n(Pd,"ViT"),Pd.forEach(o),An=n(D,", "),xo=a(D,"A",{href:!0});var Fd=s(xo);Sn=n(Fd,"BEiT"),Fd.forEach(o),In=n(D,", "),jo=a(D,"A",{href:!0});var Cd=s(jo);Ln=n(Cd,"DeiT"),Cd.forEach(o),Nn=n(D,", "),Do=a(D,"A",{href:!0});var Ad=s(Do);On=n(Ad,"Swin"),Ad.forEach(o),Rn=n(D,`)
...
Zhoujun Li, Furu Wei.`),cn.forEach(o),Qt=l(d),G=a(d,"P",{});var Zo=s(G);tr=n(Zo,"An example of how to use a "),zo=a(Zo,"A",{href:!0});var Bd=s(zo);nr=n(Bd,"VisionEncoderDecoderModel"),Bd.forEach(o),rr=n(Zo," for inference can be seen in "),Po=a(Zo,"A",{href:!0});var Gd=s(Po);ar=n(Gd,"TrOCR"),Gd.forEach(o),sr=n(Zo,"."),Zo.forEach(o),Xt=l(d),Q=a(d,"H2",{class:!0});var ln=s(Q);me=a(ln,"A",{id:!0,class:!0,href:!0});var Wd=s(me);st=a(Wd,"SPAN",{});var Ud=s(st);g(je.$$.fragment,Ud),Ud.forEach(o),Wd.forEach(o),dr=l(ln),dt=a(ln,"SPAN",{});var Hd=s(dt);ir=n(Hd,"VisionEncoderDecoderConfig"),Hd.forEach(o),ln.forEach(o),en=l(d),z=a(d,"DIV",{class:!0});var N=s(z);g(De.$$.fragment,N),cr=l(N),fe=a(N,"P",{});var Zt=s(fe);Fo=a(Zt,"A",{href:!0});var Zd=s(Fo);lr=n(Zd,"VisionEncoderDecoderConfig"),Zd.forEach(o),pr=n(Zt,` is the configuration class to store the configuration of a
...
specified arguments, defining the encoder and decoder configs.`),Zt.forEach(o),fr=l(N),X=a(N,"P",{});var Yo=s(X);ur=n(Yo,"Configuration objects inherit from "),Ao=a(Yo,"A",{href:!0});var Jd=s(Ao);gr=n(Jd,"PretrainedConfig"),Jd.forEach(o),_r=n(Yo,` and can be used to control the model outputs. Read the
documentation from `),So=a(Yo,"A",{href:!0});var Kd=s(So);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(Yo," for more information."),Yo.forEach(o),Tr=l(N),it=a(N,"P",{});var Qd=s(it);wr=n(Qd,"Examples:"),Qd.forEach(o),yr=l(N),g(Me.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(Ve.$$.fragment,pn),kr=l(pn),$e=a(pn,"P",{});var hn=s($e);xr=n(hn,"Instantiate a "),Io=a(hn,"A",{href:!0});var Xd=s(Io);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Dr=n(hn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),hn.forEach(o),pn.forEach(o),Mr=l(N),ge=a(N,"DIV",{class:!0});var mn=s(ge);g(qe.$$.fragment,mn),Vr=l(mn),ee=a(mn,"P",{});var Jo=s(ee);$r=n(Jo,"Serializes this instance to a Python dictionary. Override the default "),ct=a(Jo,"EM",{});var ei=s(ct);qr=n(ei,"to_dict()"),ei.forEach(o),zr=n(Jo," from "),lt=a(Jo,"EM",{});var oi=s(lt);Pr=n(oi,"PretrainedConfig"),oi.forEach(o),Fr=n(Jo,"."),Jo.forEach(o),mn.forEach(o),N.forEach(o),on=l(d),oe=a(d,"H2",{class:!0});var fn=s(oe);_e=a(fn,"A",{id:!0,class:!0,href:!0});var ti=s(_e);pt=a(ti,"SPAN",{});var ni=s(pt);g(ze.$$.fragment,ni),ni.forEach(o),ti.forEach(o),Cr=l(fn),ht=a(fn,"SPAN",{});var ri=s(ht);Ar=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),fn.forEach(o),tn=l(d),E=a(d,"DIV",{class:!0});var V=s(E);g(Pe.$$.fragment,V),Sr=l(V),te=a(V,"P",{});var Ko=s(te);Ir=n(Ko,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),un.forEach(o),Hr=l(V),Ae=a(V,"P",{});var gn=s(Ae);Zr=n(gn,"Additionally, in "),Se=a(gn,"A",{href:!0,rel:!0});var ii=s(Se);Yr=n(ii,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
other models (see the examples for more information).`),ci.forEach(o),Xr=l(V),Ie=a(V,"P",{});var _n=s(Ie);ea=n(_n,"This model inherits from "),Lo=a(_n,"A",{href:!0});var li=s(Lo);oa=n(li,"PreTrainedModel"),li.forEach(o),ta=n(_n,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
:meth`),_t=a(bo,"EM",{});var fi=s(_t);ha=n(fi,"~transformers.AutoModelForCausalLM.from_pretrained"),fi.forEach(o),ma=n(bo," class method for the decoder."),bo.forEach(o),fa=l(V),A=a(V,"DIV",{class:!0});var Z=s(A);g(Oe.$$.fragment,Z),ua=l(Z),ne=a(Z,"P",{});var Qo=s(ne);ga=n(Qo,"The "),Oo=a(Qo,"A",{href:!0});var ui=s(Oo);_a=n(ui,"VisionEncoderDecoderModel"),ui.forEach(o),va=n(Qo," forward method, overrides the "),vt=a(Qo,"CODE",{});var gi=s(vt);ba=n(gi,"__call__"),gi.forEach(o),Ta=n(Qo," special method."),Qo.forEach(o),wa=l(Z),g(ve.$$.fragment,Z),ya=l(Z),bt=a(Z,"P",{});var _i=s(bt);Ea=n(_i,"Examples:"),_i.forEach(o),ka=l(Z),g(Re.$$.fragment,Z),Z.forEach(o),xa=l(V),S=a(V,"DIV",{class:!0});var Y=s(S);g(Be.$$.fragment,Y),ja=l(Y),Tt=a(Y,"P",{});var vi=s(Tt);Da=n(vi,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),vi.forEach(o),Ma=l(Y),re=a(Y,"P",{});var Xo=s(re);Va=n(Xo,"The model is set in evaluation mode by default using "),wt=a(Xo,"CODE",{});var bi=s(wt);$a=n(bi,"model.eval()"),bi.forEach(o),qa=n(Xo,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),yt=a(Xo,"CODE",{});var Ti=s(yt);za=n(Ti,"model.train()"),Ti.forEach(o),Pa=n(Xo,"."),Xo.forEach(o),Fa=l(Y),Et=a(Y,"P",{});var wi=s(Et);Ca=n(wi,"Example:"),wi.forEach(o),Aa=l(Y),g(Ge.$$.fragment,Y),Y.forEach(o),V.forEach(o),nn=l(d),ae=a(d,"H2",{class:!0});var bn=s(ae);be=a(bn,"A",{id:!0,class:!0,href:!0});var yi=s(be);kt=a(yi,"SPAN",{});var Ei=s(kt);g(We.$$.fragment,Ei),Ei.forEach(o),yi.forEach(o),Sa=l(bn),xt=a(bn,"SPAN",{});var ki=s(xt);Ia=n(ki,"TFVisionEncoderDecoderModel"),ki.forEach(o),bn.forEach(o),rn=l(d),k=a(d,"DIV",{class:!0});var $=s(k);g(Ue.$$.fragment,$),La=l($),se=a($,"P",{});var et=s(se);Na=n(et,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),Tn.forEach(o),Ya=l($),Ye=a($,"P",{});var wn=s(Ye);Ja=n(wn,"Additionally, in "),Je=a(wn,"A",{href:!0,rel:!0});var Mi=s(Je);Ka=n(Mi,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
`),$t=a(To,"CODE",{});var Fi=s($t);fs=n(Fi,"from_pretrained()"),Fi.forEach(o),us=n(To,"class method for the decoder."),To.forEach(o),gs=l($),I=a($,"DIV",{class:!0});var J=s(I);g(eo.$$.fragment,J),_s=l(J),de=a(J,"P",{});var ot=s(de);vs=n(ot,"The "),Go=a(ot,"A",{href:!0});var Ci=s(Go);bs=n(Ci,"TFVisionEncoderDecoderModel"),Ci.forEach(o),Ts=n(ot," forward method, overrides the "),qt=a(ot,"CODE",{});var Ai=s(qt);ws=n(Ai,"__call__"),Ai.forEach(o),ys=n(ot," special method."),ot.forEach(o),Es=l(J),g(Te.$$.fragment,J),ks=l(J),zt=a(J,"P",{});var Si=s(zt);xs=n(Si,"Examples:"),Si.forEach(o),js=l(J),g(oo.$$.fragment,J),J.forEach(o),Ds=l($),O=a($,"DIV",{class:!0});var Ee=s(O);g(to.$$.fragment,Ee),Ms=l(Ee),Pt=a(Ee,"P",{});var Ii=s(Pt);Vs=n(Ii,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Ii.forEach(o),$s=l(Ee),Ft=a(Ee,"P",{});var Li=s(Ft);qs=n(Li,"Example:"),Li.forEach(o),zs=l(Ee),g(no.$$.fragment,Ee),Ee.forEach(o),$.forEach(o),an=l(d),ie=a(d,"H2",{class:!0});var kn=s(ie);we=a(kn,"A",{id:!0,class:!0,href:!0});var Ni=s(we);Ct=a(Ni,"SPAN",{});var Oi=s(Ct);g(ro.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),Ps=l(kn),At=a(kn,"SPAN",{});var Ri=s(At);Fs=n(Ri,"FlaxVisionEncoderDecoderModel"),Ri.forEach(o),kn.forEach(o),sn=l(d),x=a(d,"DIV",{class:!0});var q=s(x);g(ao.$$.fragment,q),Cs=l(q),ce=a(q,"P",{});var tt=s(ce);As=n(tt,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),St=a(tt,"CODE",{});var Bi=s(St);Ss=n(Bi,"from_pretrained()"),Bi.forEach(o),Is=n(tt,"function and the decoder is loaded via "),It=a(tt,"CODE",{});var Gi=s(It);Ls=n(Gi,"from_pretrained()"),Gi.forEach(o),Ns=n(tt,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
character recognition (OCR) yields a significant performance improvement.`),jn.forEach(o),Ys=l(q),Lt=a(q,"P",{});var Hi=s(Lt);Js=n(Hi,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
`),mo=a(Mn,"A",{href:!0,rel:!0});var Yi=s(mo);nd=n(Yi,"flax.nn.Module"),Yi.forEach(o),rd=n(Mn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mn.forEach(o),ad=l(q),H=a(q,"P",{});var wo=s(H);Uo=a(wo,"A",{href:!0});var Ji=s(Uo);sd=n(Ji,"FlaxVisionEncoderDecoderModel"),Ji.forEach(o),dd=n(wo,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
