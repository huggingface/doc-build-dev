...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Rw=l(),Oc=o("p"),Uw=a("Finally, this model supports inherent JAX features such as:"),Qw=l(),Nt=o("ul"),Nc=o("li"),Xa=o("a"),Hw=a("Just-In-Time (JIT) compilation"),Vw=l(),Lc=o("li"),Ya=o("a"),Kw=a("Automatic Differentiation"),Jw=l(),Sc=o("li"),Za=o("a"),Gw=a("Vectorization"),Xw=l(),Ic=o("li"),ei=o("a"),Yw=a("Parallelization"),Zw=l(),dt=o("div"),v(ti.$$.fragment),e2=l(),Qs=o("p"),t2=a("The "),Wc=o("code"),s2=a("FlaxDistilBertPreTrainedModel"),o2=a(" forward method, overrides the "),Rc=o("code"),n2=a("__call__"),r2=a(" special method."),a2=l(),v(So.$$.fragment),i2=l(),Uc=o("p"),l2=a("Example:"),d2=l(),v(si.$$.fragment),dh=l(),Hs=o("h2"),Io=o("a"),Qc=o("span"),v(oi.$$.fragment),c2=l(),Hc=o("span"),p2=a("FlaxDistilBertForQuestionAnswering"),ch=l(),Ce=o("div"),v(ni.$$.fragment),h2=l(),Vs=o("p"),u2=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Vc=o("code"),m2=a("span start logits"),f2=a(" and "),Kc=o("code"),g2=a("span end logits"),_2=a(")."),b2=l(),ri=o("p"),v2=a("This model inherits from "),ol=o("a"),k2=a("FlaxPreTrainedModel"),T2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),w2=l(),ai=o("p"),y2=a("This model is also a Flax Linen "),ii=o("a"),$2=a("flax.linen.Module"),F2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),D2=l(),Jc=o("p"),B2=a("Finally, this model supports inherent JAX features such as:"),M2=l(),Lt=o("ul"),Gc=o("li"),li=o("a"),E2=a("Just-In-Time (JIT) compilation"),x2=l(),Xc=o("li"),di=o("a"),z2=a("Automatic Differentiation"),j2=l(),Yc=o("li"),ci=o("a"),C2=a("Vectorization"),q2=l(),Zc=o("li"),pi=o("a"),P2=a("Parallelization"),A2=l(),ct=o("div"),v(hi.$$.fragment),O2=l(),Ks=o("p"),N2=a("The "),ep=o("code"),L2=a("FlaxDistilBertPreTrainedModel"),S2=a(" forward method, overrides the "),tp=o("code"),I2=a("__call__"),W2=a(" special method."),R2=l(),v(Wo.$$.fragment),U2=l(),sp=o("p"),Q2=a("Example:"),H2=l(),v(ui.$$.fragment),this.h()},l(s){const f=DD('[data-svelte="svelte-1phssyn"]',document.head);p=n(f,"META",{name:!0,content:!0}),f.forEach(t),D=d(s),g=n(s,"H1",{class:!0});var mi=r(g);b=n(mi,"A",{id:!0,class:!0,href:!0});var op=r(b);F=n(op,"SPAN",{});var np=r(F);k(_.$$.fragment,np),np.forEach(t),op.forEach(t),m=d(mi),B=n(mi,"SPAN",{});var rp=r(B);ce=i(rp,"DistilBERT"),rp.forEach(t),mi.forEach(t),V=d(s),E=n(s,"H2",{class:!0});var fi=r(E);G=n(fi,"A",{id:!0,class:!0,href:!0});var ap=r(G);S=n(ap,"SPAN",{});var ip=r(S);k(X.$$.fragment,ip),ip.forEach(t),ap.forEach(t),pe=d(fi),I=n(fi,"SPAN",{});var lp=r(I);he=i(lp,"Overview"),lp.forEach(t),fi.forEach(t),ae=d(s),N=n(s,"P",{});var St=r(N);P=i(St,"The DistilBERT model was proposed in the blog post "),Y=n(St,"A",{href:!0,rel:!0});var dp=r(Y);K=i(dp,`Smaller, faster, cheaper, lighter: Introducing DistilBERT, a
...
necessary though, just let us know if you need this option.`),_i.forEach(t),gi.forEach(t),wp=d(s),vt=n(s,"P",{});var Wt=r(vt);wu=i(Wt,"This model was contributed by "),Yo=n(Wt,"A",{href:!0,rel:!0});var V2=r(Yo);yu=i(V2,"victorsanh"),V2.forEach(t),$u=i(Wt,`. This model jax version was
contributed by `),Zo=n(Wt,"A",{href:!0,rel:!0});var K2=r(Zo);Fu=i(K2,"kamalkraj"),K2.forEach(t),Du=i(Wt,". The original code can be found "),en=n(Wt,"A",{href:!0,rel:!0});var J2=r(en);Bu=i(J2,"here"),J2.forEach(t),Mu=i(Wt,"."),Wt.forEach(t),yp=d(s),as=n(s,"H2",{class:!0});var hh=r(as);Js=n(hh,"A",{id:!0,class:!0,href:!0});var G2=r(Js);Dl=n(G2,"SPAN",{});var X2=r(Dl);k(tn.$$.fragment,X2),X2.forEach(t),G2.forEach(t),Eu=d(hh),Bl=n(hh,"SPAN",{});var Y2=r(Bl);xu=i(Y2,"DistilBertConfig"),Y2.forEach(t),hh.forEach(t),$p=d(s),Ke=n(s,"DIV",{class:!0});var Rt=r(Ke);k(sn.$$.fragment,Rt),zu=d(Rt),Ct=n(Rt,"P",{});var Ro=r(Ct);ju=i(Ro,"This is the configuration class to store the configuration of a "),bi=n(Ro,"A",{href:!0});var Z2=r(bi);Cu=i(Z2,"DistilBertModel"),Z2.forEach(t),qu=i(Ro," or a "),vi=n(Ro,"A",{href:!0});var ey=r(vi);Pu=i(ey,"TFDistilBertModel"),ey.forEach(t),Au=i(Ro,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Kt),st=n(Kt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),Pi=n(ll,"A",{href:!0});var Zy=r(Pi);ig=i(Zy,"DistilBertForMultipleChoice"),Zy.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var e1=r(ed);dg=i(e1,"__call__"),e1.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var t1=r(td);ug=i(t1,"Examples:"),t1.forEach(t),mg=d(Jt),k(Qn.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Op=d(s),bs=n(s,"H2",{class:!0});var zh=r(bs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var s1=r(lo);sd=n(s1,"SPAN",{});var o1=r(sd);k(Hn.$$.fragment,o1),o1.forEach(t),s1.forEach(t),fg=d(zh),od=n(zh,"SPAN",{});var n1=r(od);gg=i(n1,"DistilBertForTokenClassification"),n1.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Vn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var r1=r(nd);bg=i(r1,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),r1.forEach(t),vg=d(Gt),Kn=n(Gt,"P",{});var jh=r(Kn);kg=i(jh,"This model inherits from "),Ai=n(jh,"A",{href:!0});var a1=r(Ai);Tg=i(a1,"PreTrainedModel"),a1.forEach(t),wg=i(jh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jh.forEach(t),yg=d(Gt),Jn=n(Gt,"P",{});var Ch=r(Jn);$g=i(Ch,"This model is also a PyTorch "),Gn=n(Ch,"A",{href:!0,rel:!0});var i1=r(Gn);Fg=i(i1,"torch.nn.Module"),i1.forEach(t),Dg=i(Ch,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ch.forEach(t),Bg=d(Gt),We=n(Gt,"DIV",{class:!0});var Tt=r(We);k(Xn.$$.fragment,Tt),Mg=d(Tt),vs=n(Tt,"P",{});var dl=r(vs);Eg=i(dl,"The "),Oi=n(dl,"A",{href:!0});var l1=r(Oi);xg=i(l1,"DistilBertForTokenClassification"),l1.forEach(t),zg=i(dl," forward method, overrides the "),rd=n(dl,"CODE",{});var d1=r(rd);jg=i(d1,"__call__"),d1.forEach(t),Cg=i(dl," special method."),dl.forEach(t),qg=d(Tt),k(co.$$.fragment,Tt),Pg=d(Tt),ad=n(Tt,"P",{});var c1=r(ad);Ag=i(c1,"Example:"),c1.forEach(t),Og=d(Tt),k(Yn.$$.fragment,Tt),Ng=d(Tt),k(Zn.$$.fragment,Tt),Tt.forEach(t),Gt.forEach(t),Lp=d(s),ks=n(s,"H2",{class:!0});var qh=r(ks);po=n(qh,"A",{id:!0,class:!0,href:!0});var p1=r(po);id=n(p1,"SPAN",{});var h1=r(id);k(er.$$.fragment,h1),h1.forEach(t),p1.forEach(t),Lg=d(qh),ld=n(qh,"SPAN",{});var u1=r(ld);Sg=i(u1,"DistilBertForQuestionAnswering"),u1.forEach(t),qh.forEach(t),Sp=d(s),et=n(s,"DIV",{class:!0});var Xt=r(et);k(tr.$$.fragment,Xt),Ig=d(Xt),Ts=n(Xt,"P",{});var cl=r(Ts);Wg=i(cl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(cl,"CODE",{});var m1=r(dd);Rg=i(m1,"span start logits"),m1.forEach(t),Ug=i(cl," and "),cd=n(cl,"CODE",{});var f1=r(cd);Qg=i(f1,"span end logits"),f1.forEach(t),Hg=i(cl,")."),cl.forEach(t),Vg=d(Xt),sr=n(Xt,"P",{});var Ph=r(sr);Kg=i(Ph,"This model inherits from "),Ni=n(Ph,"A",{href:!0});var g1=r(Ni);Jg=i(g1,"PreTrainedModel"),g1.forEach(t),Gg=i(Ph,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ph.forEach(t),Xg=d(Xt),or=n(Xt,"P",{});var Ah=r(or);Yg=i(Ah,"This model is also a PyTorch "),nr=n(Ah,"A",{href:!0,rel:!0});var _1=r(nr);Zg=i(_1,"torch.nn.Module"),_1.forEach(t),e_=i(Ah,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ah.forEach(t),t_=d(Xt),Re=n(Xt,"DIV",{class:!0});var wt=r(Re);k(rr.$$.fragment,wt),s_=d(wt),ws=n(wt,"P",{});var pl=r(ws);o_=i(pl,"The "),Li=n(pl,"A",{href:!0});var b1=r(Li);n_=i(b1,"DistilBertForQuestionAnswering"),b1.forEach(t),r_=i(pl," forward method, overrides the "),pd=n(pl,"CODE",{});var v1=r(pd);a_=i(v1,"__call__"),v1.forEach(t),i_=i(pl," special method."),pl.forEach(t),l_=d(wt),k(ho.$$.fragment,wt),d_=d(wt),hd=n(wt,"P",{});var k1=r(hd);c_=i(k1,"Example:"),k1.forEach(t),p_=d(wt),k(ar.$$.fragment,wt),h_=d(wt),k(ir.$$.fragment,wt),wt.forEach(t),Xt.forEach(t),Ip=d(s),ys=n(s,"H2",{class:!0});var Oh=r(ys);uo=n(Oh,"A",{id:!0,class:!0,href:!0});var T1=r(uo);ud=n(T1,"SPAN",{});var w1=r(ud);k(lr.$$.fragment,w1),w1.forEach(t),T1.forEach(t),u_=d(Oh),md=n(Oh,"SPAN",{});var y1=r(md);m_=i(y1,"TFDistilBertModel"),y1.forEach(t),Oh.forEach(t),Wp=d(s),Pe=n(s,"DIV",{class:!0});var yt=r(Pe);k(dr.$$.fragment,yt),f_=d(yt),fd=n(yt,"P",{});var $1=r(fd);g_=i($1,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),$1.forEach(t),__=d(yt),cr=n(yt,"P",{});var Nh=r(cr);b_=i(Nh,"This model inherits from "),Si=n(Nh,"A",{href:!0});var F1=r(Si);v_=i(F1,"TFPreTrainedModel"),F1.forEach(t),k_=i(Nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nh.forEach(t),T_=d(yt),pr=n(yt,"P",{});var Lh=r(pr);w_=i(Lh,"This model is also a "),hr=n(Lh,"A",{href:!0,rel:!0});var D1=r(hr);y_=i(D1,"tf.keras.Model"),D1.forEach(t),$_=i(Lh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lh.forEach(t),F_=d(yt),k(mo.$$.fragment,yt),D_=d(yt),ot=n(yt,"DIV",{class:!0});var Yt=r(ot);k(ur.$$.fragment,Yt),B_=d(Yt),$s=n(Yt,"P",{});var hl=r($s);M_=i(hl,"The "),Ii=n(hl,"A",{href:!0});var B1=r(Ii);E_=i(B1,"TFDistilBertModel"),B1.forEach(t),x_=i(hl," forward method, overrides the "),gd=n(hl,"CODE",{});var M1=r(gd);z_=i(M1,"__call__"),M1.forEach(t),j_=i(hl," special method."),hl.forEach(t),C_=d(Yt),k(fo.$$.fragment,Yt),q_=d(Yt),_d=n(Yt,"P",{});var E1=r(_d);P_=i(E1,"Example:"),E1.forEach(t),A_=d(Yt),k(mr.$$.fragment,Yt),Yt.forEach(t),yt.forEach(t),Rp=d(s),Fs=n(s,"H2",{class:!0});var Sh=r(Fs);go=n(Sh,"A",{id:!0,class:!0,href:!0});var x1=r(go);bd=n(x1,"SPAN",{});var z1=r(bd);k(fr.$$.fragment,z1),z1.forEach(t),x1.forEach(t),O_=d(Sh),vd=n(Sh,"SPAN",{});var j1=r(vd);N_=i(j1,"TFDistilBertForMaskedLM"),j1.forEach(t),Sh.forEach(t),Up=d(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);k(gr.$$.fragment,$t),L_=d($t),_r=n($t,"P",{});var Ih=r(_r);S_=i(Ih,"DistilBert Model with a "),kd=n(Ih,"CODE",{});var C1=r(kd);I_=i(C1,"masked language modeling"),C1.forEach(t),W_=i(Ih," head on top."),Ih.forEach(t),R_=d($t),br=n($t,"P",{});var Wh=r(br);U_=i(Wh,"This model inherits from "),Wi=n(Wh,"A",{href:!0});var q1=r(Wi);Q_=i(q1,"TFPreTrainedModel"),q1.forEach(t),H_=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),V_=d($t),vr=n($t,"P",{});var Rh=r(vr);K_=i(Rh,"This model is also a "),kr=n(Rh,"A",{href:!0,rel:!0});var P1=r(kr);J_=i(P1,"tf.keras.Model"),P1.forEach(t),G_=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),X_=d($t),k(_o.$$.fragment,$t),Y_=d($t),Ue=n($t,"DIV",{class:!0});var Ft=r(Ue);k(Tr.$$.fragment,Ft),Z_=d(Ft),Ds=n(Ft,"P",{});var ul=r(Ds);eb=i(ul,"The "),Ri=n(ul,"A",{href:!0});var A1=r(Ri);tb=i(A1,"TFDistilBertForMaskedLM"),A1.forEach(t),sb=i(ul," forward method, overrides the "),Td=n(ul,"CODE",{});var O1=r(Td);ob=i(O1,"__call__"),O1.forEach(t),nb=i(ul," special method."),ul.forEach(t),rb=d(Ft),k(bo.$$.fragment,Ft),ab=d(Ft),wd=n(Ft,"P",{});var N1=r(wd);ib=i(N1,"Example:"),N1.forEach(t),lb=d(Ft),k(wr.$$.fragment,Ft),db=d(Ft),k(yr.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),Qp=d(s),Bs=n(s,"H2",{class:!0});var Uh=r(Bs);vo=n(Uh,"A",{id:!0,class:!0,href:!0});var L1=r(vo);yd=n(L1,"SPAN",{});var S1=r(yd);k($r.$$.fragment,S1),S1.forEach(t),L1.forEach(t),cb=d(Uh),$d=n(Uh,"SPAN",{});var I1=r($d);pb=i(I1,"TFDistilBertForSequenceClassification"),I1.forEach(t),Uh.forEach(t),Hp=d(s),Oe=n(s,"DIV",{class:!0});var Dt=r(Oe);k(Fr.$$.fragment,Dt),hb=d(Dt),Fd=n(Dt,"P",{});var W1=r(Fd);ub=i(W1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),W1.forEach(t),mb=d(Dt),Dr=n(Dt,"P",{});var Qh=r(Dr);fb=i(Qh,"This model inherits from "),Ui=n(Qh,"A",{href:!0});var R1=r(Ui);gb=i(R1,"TFPreTrainedModel"),R1.forEach(t),_b=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qh.forEach(t),bb=d(Dt),Br=n(Dt,"P",{});var Hh=r(Br);vb=i(Hh,"This model is also a "),Mr=n(Hh,"A",{href:!0,rel:!0});var U1=r(Mr);kb=i(U1,"tf.keras.Model"),U1.forEach(t),Tb=i(Hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh.forEach(t),wb=d(Dt),k(ko.$$.fragment,Dt),yb=d(Dt),Qe=n(Dt,"DIV",{class:!0});var Bt=r(Qe);k(Er.$$.fragment,Bt),$b=d(Bt),Ms=n(Bt,"P",{});var ml=r(Ms);Fb=i(ml,"The "),Qi=n(ml,"A",{href:!0});var Q1=r(Qi);Db=i(Q1,"TFDistilBertForSequenceClassification"),Q1.forEach(t),Bb=i(ml," forward method, overrides the "),Dd=n(ml,"CODE",{});var H1=r(Dd);Mb=i(H1,"__call__"),H1.forEach(t),Eb=i(ml," special method."),ml.forEach(t),xb=d(Bt),k(To.$$.fragment,Bt),zb=d(Bt),Bd=n(Bt,"P",{});var V1=r(Bd);jb=i(V1,"Example:"),V1.forEach(t),Cb=d(Bt),k(xr.$$.fragment,Bt),qb=d(Bt),k(zr.$$.fragment,Bt),Bt.forEach(t),Dt.forEach(t),Vp=d(s),Es=n(s,"H2",{class:!0});var Vh=r(Es);wo=n(Vh,"A",{id:!0,class:!0,href:!0});var K1=r(wo);Md=n(K1,"SPAN",{});var J1=r(Md);k(jr.$$.fragment,J1),J1.forEach(t),K1.forEach(t),Pb=d(Vh),Ed=n(Vh,"SPAN",{});var G1=r(Ed);Ab=i(G1,"TFDistilBertForMultipleChoice"),G1.forEach(t),Vh.forEach(t),Kp=d(s),Ne=n(s,"DIV",{class:!0});var Mt=r(Ne);k(Cr.$$.fragment,Mt),Ob=d(Mt),xd=n(Mt,"P",{});var X1=r(xd);Nb=i(X1,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),X1.forEach(t),Lb=d(Mt),qr=n(Mt,"P",{});var Kh=r(qr);Sb=i(Kh,"This model inherits from "),Hi=n(Kh,"A",{href:!0});var Y1=r(Hi);Ib=i(Y1,"TFPreTrainedModel"),Y1.forEach(t),Wb=i(Kh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kh.forEach(t),Rb=d(Mt),Pr=n(Mt,"P",{});var Jh=r(Pr);Ub=i(Jh,"This model is also a "),Ar=n(Jh,"A",{href:!0,rel:!0});var Z1=r(Ar);Qb=i(Z1,"tf.keras.Model"),Z1.forEach(t),Hb=i(Jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
