...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=p(),Zp=n("p"),O$=r("Finally, this model supports inherent JAX features such as:"),N$=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I$=r("Just-In-Time (JIT) compilation"),D$=p(),th=n("li"),Li=n("a"),S$=r("Automatic Differentiation"),W$=p(),oh=n("li"),Ai=n("a"),B$=r("Vectorization"),U$=p(),nh=n("li"),Oi=n("a"),H$=r("Parallelization"),Q$=p(),qt=n("div"),T(Ni.$$.fragment),J$=p(),tn=n("p"),V$=r("The "),sh=n("code"),K$=r("FlaxRobertaPreTrainedModel"),G$=r(" forward method, overrides the "),ah=n("code"),X$=r("__call__"),Y$=r(" special method."),Z$=p(),T(Os.$$.fragment),e2=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t2=p(),ih=n("span"),o2=r("FlaxRobertaForMaskedLM"),qf=p(),Ie=n("div"),T(Di.$$.fragment),n2=p(),Si=n("p"),s2=r("RoBERTa Model with a "),lh=n("code"),a2=r("language modeling"),r2=r(" head on top."),i2=p(),Wi=n("p"),l2=r("This model inherits from "),Pd=n("a"),d2=r("FlaxPreTrainedModel"),c2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),p2=p(),Bi=n("p"),h2=r("This model is also a Flax Linen "),Ui=n("a"),m2=r("flax.linen.Module"),f2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u2=p(),dh=n("p"),g2=r("Finally, this model supports inherent JAX features such as:"),_2=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b2=r("Just-In-Time (JIT) compilation"),k2=p(),ph=n("li"),Qi=n("a"),v2=r("Automatic Differentiation"),T2=p(),hh=n("li"),Ji=n("a"),y2=r("Vectorization"),w2=p(),mh=n("li"),Vi=n("a"),$2=r("Parallelization"),F2=p(),Ct=n("div"),T(Ki.$$.fragment),x2=p(),nn=n("p"),R2=r("The "),fh=n("code"),M2=r("FlaxRobertaPreTrainedModel"),E2=r(" forward method, overrides the "),uh=n("code"),z2=r("__call__"),q2=r(" special method."),C2=p(),T(Ds.$$.fragment),j2=p(),T(Ss.$$.fragment),Cf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),T(Gi.$$.fragment),P2=p(),_h=n("span"),L2=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),T(Xi.$$.fragment),A2=p(),bh=n("p"),O2=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),N2=p(),Yi=n("p"),I2=r("This model inherits from "),Ld=n("a"),D2=r("FlaxPreTrainedModel"),S2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),W2=p(),Zi=n("p"),B2=r("This model is also a Flax Linen "),el=n("a"),U2=r("flax.linen.Module"),H2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q2=p(),kh=n("p"),J2=r("Finally, this model supports inherent JAX features such as:"),V2=p(),Jt=n("ul"),vh=n("li"),tl=n("a"),K2=r("Just-In-Time (JIT) compilation"),G2=p(),Th=n("li"),ol=n("a"),X2=r("Automatic Differentiation"),Y2=p(),yh=n("li"),nl=n("a"),Z2=r("Vectorization"),e1=p(),wh=n("li"),sl=n("a"),t1=r("Parallelization"),o1=p(),jt=n("div"),T(al.$$.fragment),n1=p(),an=n("p"),s1=r("The "),$h=n("code"),a1=r("FlaxRobertaPreTrainedModel"),r1=r(" forward method, overrides the "),Fh=n("code"),i1=r("__call__"),l1=r(" special method."),d1=p(),T(Bs.$$.fragment),c1=p(),T(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),T(rl.$$.fragment),p1=p(),Rh=n("span"),h1=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),T(il.$$.fragment),m1=p(),Mh=n("p"),f1=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),u1=p(),ll=n("p"),g1=r("This model inherits from "),Ad=n("a"),_1=r("FlaxPreTrainedModel"),b1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k1=p(),dl=n("p"),v1=r("This model is also a Flax Linen "),cl=n("a"),T1=r("flax.linen.Module"),y1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w1=p(),Eh=n("p"),$1=r("Finally, this model supports inherent JAX features such as:"),F1=p(),Vt=n("ul"),zh=n("li"),pl=n("a"),x1=r("Just-In-Time (JIT) compilation"),R1=p(),qh=n("li"),hl=n("a"),M1=r("Automatic Differentiation"),E1=p(),Ch=n("li"),ml=n("a"),z1=r("Vectorization"),q1=p(),jh=n("li"),fl=n("a"),C1=r("Parallelization"),j1=p(),Pt=n("div"),T(ul.$$.fragment),P1=p(),ln=n("p"),L1=r("The "),Ph=n("code"),A1=r("FlaxRobertaPreTrainedModel"),O1=r(" forward method, overrides the "),Lh=n("code"),N1=r("__call__"),I1=r(" special method."),D1=p(),T(Qs.$$.fragment),S1=p(),T(Js.$$.fragment),Af=p(),dn=n("h2"),Vs=n("a"),Ah=n("span"),T(gl.$$.fragment),W1=p(),Oh=n("span"),B1=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),T(_l.$$.fragment),U1=p(),Nh=n("p"),H1=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q1=p(),bl=n("p"),J1=r("This model inherits from "),Od=n("a"),V1=r("FlaxPreTrainedModel"),K1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),G1=p(),kl=n("p"),X1=r("This model is also a Flax Linen "),vl=n("a"),Y1=r("flax.linen.Module"),Z1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),A$=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);O$=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),N$=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);I$=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),D$=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);S$=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),W$=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);B$=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),U$=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var eM=a(Oi);H$=i(eM,"Parallelization"),eM.forEach(t),ZR.forEach(t),la.forEach(t),Q$=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),J$=h(da),tn=s(da,"P",{});var ac=a(tn);V$=i(ac,"The "),sh=s(ac,"CODE",{});var tM=a(sh);K$=i(tM,"FlaxRobertaPreTrainedModel"),tM.forEach(t),G$=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oM=a(ah);X$=i(oM,"__call__"),oM.forEach(t),Y$=i(ac," special method."),ac.forEach(t),Z$=h(da),y(Os.$$.fragment,da),e2=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nM=a(Is);rh=s(nM,"SPAN",{});var sM=a(rh);y(Ii.$$.fragment,sM),sM.forEach(t),nM.forEach(t),t2=h(Bu),ih=s(Bu,"SPAN",{});var aM=a(ih);o2=i(aM,"FlaxRobertaForMaskedLM"),aM.forEach(t),Bu.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n2=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s2=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rM=a(lh);a2=i(rM,"language modeling"),rM.forEach(t),r2=i(Uu," head on top."),Uu.forEach(t),i2=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l2=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iM=a(Pd);d2=i(iM,"FlaxPreTrainedModel"),iM.forEach(t),c2=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hu.forEach(t),p2=h(bt),Bi=s(bt,"P",{});var Qu=a(Bi);h2=i(Qu,"This model is also a Flax Linen "),Ui=s(Qu,"A",{href:!0,rel:!0});var lM=a(Ui);m2=i(lM,"flax.linen.Module"),lM.forEach(t),f2=i(Qu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u2=h(bt),dh=s(bt,"P",{});var dM=a(dh);g2=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_2=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b2=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k2=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);v2=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),T2=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Ji=s(fM,"A",{href:!0,rel:!0});var uM=a(Ji);y2=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),w2=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Vi=s(gM,"A",{href:!0,rel:!0});var _M=a(Vi);$2=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F2=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),x2=h(pa),nn=s(pa,"P",{});var rc=a(nn);R2=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);M2=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E2=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);z2=i(kM,"__call__"),kM.forEach(t),q2=i(rc," special method."),rc.forEach(t),C2=h(pa),y(Ds.$$.fragment,pa),j2=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var TM=a(gh);y(Gi.$$.fragment,TM),TM.forEach(t),vM.forEach(t),P2=h(Ju),_h=s(Ju,"SPAN",{});var yM=a(_h);L2=i(yM,"FlaxRobertaForSequenceClassification"),yM.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A2=h(kt),bh=s(kt,"P",{});var wM=a(bh);O2=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wM.forEach(t),N2=h(kt),Yi=s(kt,"P",{});var Vu=a(Yi);I2=i(Vu,"This model inherits from "),Ld=s(Vu,"A",{href:!0});var $M=a(Ld);D2=i($M,"FlaxPreTrainedModel"),$M.forEach(t),S2=i(Vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vu.forEach(t),W2=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B2=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var FM=a(el);U2=i(FM,"flax.linen.Module"),FM.forEach(t),H2=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q2=h(kt),kh=s(kt,"P",{});var xM=a(kh);J2=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),V2=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);K2=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),G2=h(ha),Th=s(ha,"LI",{});var EM=a(Th);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);X2=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Y2=h(ha),yh=s(ha,"LI",{});var qM=a(yh);nl=s(qM,"A",{href:!0,rel:!0});var CM=a(nl);Z2=i(CM,"Vectorization"),CM.forEach(t),qM.forEach(t),e1=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t1=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o1=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n1=h(ma),an=s(ma,"P",{});var ic=a(an);s1=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a1=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r1=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i1=i(AM,"__call__"),AM.forEach(t),l1=i(ic," special method."),ic.forEach(t),d1=h(ma),y(Bs.$$.fragment,ma),c1=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);y(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p1=h(Gu),Rh=s(Gu,"SPAN",{});var IM=a(Rh);h1=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m1=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f1=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DM.forEach(t),u1=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g1=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var SM=a(Ad);_1=i(SM,"FlaxPreTrainedModel"),SM.forEach(t),b1=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k1=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v1=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WM=a(cl);T1=i(WM,"flax.linen.Module"),WM.forEach(t),y1=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w1=h(vt),Eh=s(vt,"P",{});var BM=a(Eh);$1=i(BM,"Finally, this model supports inherent JAX features such as:"),BM.forEach(t),F1=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UM=a(zh);pl=s(UM,"A",{href:!0,rel:!0});var HM=a(pl);x1=i(HM,"Just-In-Time (JIT) compilation"),HM.forEach(t),UM.forEach(t),R1=h(fa),qh=s(fa,"LI",{});var QM=a(qh);hl=s(QM,"A",{href:!0,rel:!0});var JM=a(hl);M1=i(JM,"Automatic Differentiation"),JM.forEach(t),QM.forEach(t),E1=h(fa),Ch=s(fa,"LI",{});var VM=a(Ch);ml=s(VM,"A",{href:!0,rel:!0});var KM=a(ml);z1=i(KM,"Vectorization"),KM.forEach(t),VM.forEach(t),q1=h(fa),jh=s(fa,"LI",{});var GM=a(jh);fl=s(GM,"A",{href:!0,rel:!0});var XM=a(fl);C1=i(XM,"Parallelization"),XM.forEach(t),GM.forEach(t),fa.forEach(t),j1=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P1=h(ua),ln=s(ua,"P",{});var lc=a(ln);L1=i(lc,"The "),Ph=s(lc,"CODE",{});var YM=a(Ph);A1=i(YM,"FlaxRobertaPreTrainedModel"),YM.forEach(t),O1=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZM=a(Lh);N1=i(ZM,"__call__"),ZM.forEach(t),I1=i(lc," special method."),lc.forEach(t),D1=h(ua),y(Qs.$$.fragment,ua),S1=h(ua),y(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eE=a(Vs);Ah=s(eE,"SPAN",{});var tE=a(Ah);y(gl.$$.fragment,tE),tE.forEach(t),eE.forEach(t),W1=h(Zu),Oh=s(Zu,"SPAN",{});var oE=a(Oh);B1=i(oE,"FlaxRobertaForTokenClassification"),oE.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U1=h(Tt),Nh=s(Tt,"P",{});var nE=a(Nh);H1=i(nE,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nE.forEach(t),Q1=h(Tt),bl=s(Tt,"P",{});var eg=a(bl);J1=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sE=a(Od);V1=i(sE,"FlaxPreTrainedModel"),sE.forEach(t),K1=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G1=h(Tt),kl=s(Tt,"P",{});var tg=a(kl);X1=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aE=a(vl);Y1=i(aE,"flax.linen.Module"),aE.forEach(t),Z1=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
