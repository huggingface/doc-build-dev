...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=p(),Zp=n("p"),O$=r("Finally, this model supports inherent JAX features such as:"),N$=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I$=r("Just-In-Time (JIT) compilation"),D$=p(),th=n("li"),Li=n("a"),S$=r("Automatic Differentiation"),W$=p(),oh=n("li"),Ai=n("a"),B$=r("Vectorization"),U$=p(),nh=n("li"),Oi=n("a"),H$=r("Parallelization"),Q$=p(),Ct=n("div"),y(Ni.$$.fragment),V$=p(),tn=n("p"),J$=r("The "),sh=n("code"),K$=r("FlaxRobertaPreTrainedModel"),G$=r(" forward method, overrides the "),ah=n("code"),X$=r("__call__"),Y$=r(" special method."),Z$=p(),y(Os.$$.fragment),e2=p(),y(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),y(Ii.$$.fragment),t2=p(),ih=n("span"),o2=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),y(Di.$$.fragment),n2=p(),Si=n("p"),s2=r("RoBERTa Model with a "),lh=n("code"),a2=r("language modeling"),r2=r(" head on top."),i2=p(),Wi=n("p"),l2=r("This model inherits from "),Pd=n("a"),d2=r("FlaxPreTrainedModel"),c2=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u2=p(),dh=n("p"),g2=r("Finally, this model supports inherent JAX features such as:"),_2=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b2=r("Just-In-Time (JIT) compilation"),k2=p(),ph=n("li"),Qi=n("a"),v2=r("Automatic Differentiation"),y2=p(),hh=n("li"),Vi=n("a"),T2=r("Vectorization"),w2=p(),mh=n("li"),Ji=n("a"),$2=r("Parallelization"),F2=p(),qt=n("div"),y(Ki.$$.fragment),x2=p(),nn=n("p"),R2=r("The "),fh=n("code"),M2=r("FlaxRobertaPreTrainedModel"),E2=r(" forward method, overrides the "),uh=n("code"),z2=r("__call__"),C2=r(" special method."),q2=p(),y(Ds.$$.fragment),j2=p(),y(Ss.$$.fragment),qf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),y(Gi.$$.fragment),P2=p(),_h=n("span"),L2=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),y(Xi.$$.fragment),A2=p(),bh=n("p"),O2=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q2=p(),kh=n("p"),V2=r("Finally, this model supports inherent JAX features such as:"),J2=p(),Vt=n("ul"),vh=n("li"),tl=n("a"),K2=r("Just-In-Time (JIT) compilation"),G2=p(),yh=n("li"),ol=n("a"),X2=r("Automatic Differentiation"),Y2=p(),Th=n("li"),nl=n("a"),Z2=r("Vectorization"),e1=p(),wh=n("li"),sl=n("a"),t1=r("Parallelization"),o1=p(),jt=n("div"),y(al.$$.fragment),n1=p(),an=n("p"),s1=r("The "),$h=n("code"),a1=r("FlaxRobertaPreTrainedModel"),r1=r(" forward method, overrides the "),Fh=n("code"),i1=r("__call__"),l1=r(" special method."),d1=p(),y(Bs.$$.fragment),c1=p(),y(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),y(rl.$$.fragment),p1=p(),Rh=n("span"),h1=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),y(il.$$.fragment),m1=p(),Mh=n("p"),f1=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k1=p(),dl=n("p"),v1=r("This model is also a Flax Linen "),cl=n("a"),y1=r("flax.linen.Module"),T1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w1=p(),Eh=n("p"),$1=r("Finally, this model supports inherent JAX features such as:"),F1=p(),Jt=n("ul"),zh=n("li"),pl=n("a"),x1=r("Just-In-Time (JIT) compilation"),R1=p(),Ch=n("li"),hl=n("a"),M1=r("Automatic Differentiation"),E1=p(),qh=n("li"),ml=n("a"),z1=r("Vectorization"),C1=p(),jh=n("li"),fl=n("a"),q1=r("Parallelization"),j1=p(),Pt=n("div"),y(ul.$$.fragment),P1=p(),ln=n("p"),L1=r("The "),Ph=n("code"),A1=r("FlaxRobertaPreTrainedModel"),O1=r(" forward method, overrides the "),Lh=n("code"),N1=r("__call__"),I1=r(" special method."),D1=p(),y(Qs.$$.fragment),S1=p(),y(Vs.$$.fragment),Af=p(),dn=n("h2"),Js=n("a"),Ah=n("span"),y(gl.$$.fragment),W1=p(),Oh=n("span"),B1=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),y(_l.$$.fragment),U1=p(),Nh=n("p"),H1=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q1=p(),bl=n("p"),V1=r("This model inherits from "),Od=n("a"),J1=r("FlaxPreTrainedModel"),K1=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u2=h(bt),dh=s(bt,"P",{});var dM=a(dh);g2=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_2=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b2=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k2=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);v2=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),y2=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Vi=s(fM,"A",{href:!0,rel:!0});var uM=a(Vi);T2=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),w2=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Ji=s(gM,"A",{href:!0,rel:!0});var _M=a(Ji);$2=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F2=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);T(Ki.$$.fragment,pa),x2=h(pa),nn=s(pa,"P",{});var rc=a(nn);R2=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);M2=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E2=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);z2=i(kM,"__call__"),kM.forEach(t),C2=i(rc," special method."),rc.forEach(t),q2=h(pa),T(Ds.$$.fragment,pa),j2=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var yM=a(gh);T(Gi.$$.fragment,yM),yM.forEach(t),vM.forEach(t),P2=h(Vu),_h=s(Vu,"SPAN",{});var TM=a(_h);L2=i(TM,"FlaxRobertaForSequenceClassification"),TM.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),A2=h(kt),bh=s(kt,"P",{});var wM=a(bh);O2=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wM.forEach(t),N2=h(kt),Yi=s(kt,"P",{});var Ju=a(Yi);I2=i(Ju,"This model inherits from "),Ld=s(Ju,"A",{href:!0});var $M=a(Ld);D2=i($M,"FlaxPreTrainedModel"),$M.forEach(t),S2=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ju.forEach(t),W2=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B2=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var FM=a(el);U2=i(FM,"flax.linen.Module"),FM.forEach(t),H2=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q2=h(kt),kh=s(kt,"P",{});var xM=a(kh);V2=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),J2=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);K2=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),G2=h(ha),yh=s(ha,"LI",{});var EM=a(yh);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);X2=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Y2=h(ha),Th=s(ha,"LI",{});var CM=a(Th);nl=s(CM,"A",{href:!0,rel:!0});var qM=a(nl);Z2=i(qM,"Vectorization"),qM.forEach(t),CM.forEach(t),e1=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t1=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o1=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n1=h(ma),an=s(ma,"P",{});var ic=a(an);s1=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a1=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r1=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i1=i(AM,"__call__"),AM.forEach(t),l1=i(ic," special method."),ic.forEach(t),d1=h(ma),T(Bs.$$.fragment,ma),c1=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);T(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p1=h(Gu),Rh=s(Gu,"SPAN",{});var IM=a(Rh);h1=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m1=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f1=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k1=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v1=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WM=a(cl);y1=i(WM,"flax.linen.Module"),WM.forEach(t),T1=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w1=h(vt),Eh=s(vt,"P",{});var BM=a(Eh);$1=i(BM,"Finally, this model supports inherent JAX features such as:"),BM.forEach(t),F1=h(vt),Jt=s(vt,"UL",{});var fa=a(Jt);zh=s(fa,"LI",{});var UM=a(zh);pl=s(UM,"A",{href:!0,rel:!0});var HM=a(pl);x1=i(HM,"Just-In-Time (JIT) compilation"),HM.forEach(t),UM.forEach(t),R1=h(fa),Ch=s(fa,"LI",{});var QM=a(Ch);hl=s(QM,"A",{href:!0,rel:!0});var VM=a(hl);M1=i(VM,"Automatic Differentiation"),VM.forEach(t),QM.forEach(t),E1=h(fa),qh=s(fa,"LI",{});var JM=a(qh);ml=s(JM,"A",{href:!0,rel:!0});var KM=a(ml);z1=i(KM,"Vectorization"),KM.forEach(t),JM.forEach(t),C1=h(fa),jh=s(fa,"LI",{});var GM=a(jh);fl=s(GM,"A",{href:!0,rel:!0});var XM=a(fl);q1=i(XM,"Parallelization"),XM.forEach(t),GM.forEach(t),fa.forEach(t),j1=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);T(ul.$$.fragment,ua),P1=h(ua),ln=s(ua,"P",{});var lc=a(ln);L1=i(lc,"The "),Ph=s(lc,"CODE",{});var YM=a(Ph);A1=i(YM,"FlaxRobertaPreTrainedModel"),YM.forEach(t),O1=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZM=a(Lh);N1=i(ZM,"__call__"),ZM.forEach(t),I1=i(lc," special method."),lc.forEach(t),D1=h(ua),T(Qs.$$.fragment,ua),S1=h(ua),T(Vs.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Js=s(Zu,"A",{id:!0,class:!0,href:!0});var eE=a(Js);Ah=s(eE,"SPAN",{});var tE=a(Ah);T(gl.$$.fragment,tE),tE.forEach(t),eE.forEach(t),W1=h(Zu),Oh=s(Zu,"SPAN",{});var oE=a(Oh);B1=i(oE,"FlaxRobertaForTokenClassification"),oE.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var yt=a(We);T(_l.$$.fragment,yt),U1=h(yt),Nh=s(yt,"P",{});var nE=a(Nh);H1=i(nE,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nE.forEach(t),Q1=h(yt),bl=s(yt,"P",{});var eg=a(bl);V1=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sE=a(Od);J1=i(sE,"FlaxPreTrainedModel"),sE.forEach(t),K1=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G1=h(yt),kl=s(yt,"P",{});var tg=a(kl);X1=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aE=a(vl);Y1=i(aE,"flax.linen.Module"),aE.forEach(t),Z1=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
