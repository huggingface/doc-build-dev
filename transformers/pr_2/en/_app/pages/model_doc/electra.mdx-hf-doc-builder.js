...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L805"}}),Ka=new we({}),Ja=new I({props:{name:"class transformers.ElectraModel",anchor:"transformers.ElectraModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L837",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_2/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_2/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_2/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_2/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_flax_electra.py#L923"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_flax_electra.py#L1078"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_flax_electra.py#L1576"}}),rl=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForCausalLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/electra/modeling_flax_electra.py#L1012"}}),_l=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$2=c(),Rh=n("p"),F2=r("Finally, this model supports inherent JAX features such as:"),x2=c(),Xt=n("ul"),Hh=n("li"),ml=n("a"),M2=r("Just-In-Time (JIT) compilation"),z2=c(),Qh=n("li"),ul=n("a"),j2=r("Automatic Differentiation"),C2=c(),Bh=n("li"),fl=n("a"),q2=r("Vectorization"),P2=c(),Vh=n("li"),gl=n("a"),A2=r("Parallelization"),O2=c(),Ot=n("div"),b(_l.$$.fragment),L2=c(),hn=n("p"),N2=r("The "),Kh=n("code"),I2=r("FlaxElectraPreTrainedModel"),D2=r(" forward method, overrides the "),Jh=n("code"),S2=r("__call__"),W2=r(" special method."),U2=c(),b(Ks.$$.fragment),R2=c(),b(Js.$$.fragment),vf=c(),mn=n("h2"),Gs=n("a"),Gh=n("span"),b(kl.$$.fragment),H2=c(),Xh=n("span"),Q2=r("FlaxElectraForSequenceClassification"),Tf=c(),We=n("div"),b(vl.$$.fragment),B2=c(),Yh=n("p"),V2=r(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
`),yl=n("a"),e1=r("flax.nn.Module"),t1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),o1=c(),Zh=n("p"),n1=r("Finally, this model supports inherent JAX features such as:"),s1=c(),Yt=n("ul"),em=n("li"),El=n("a"),a1=r("Just-In-Time (JIT) compilation"),r1=c(),tm=n("li"),wl=n("a"),i1=r("Automatic Differentiation"),l1=c(),om=n("li"),$l=n("a"),d1=r("Vectorization"),c1=c(),nm=n("li"),Fl=n("a"),p1=r("Parallelization"),h1=c(),Lt=n("div"),b(xl.$$.fragment),m1=c(),un=n("p"),u1=r("The "),sm=n("code"),f1=r("FlaxElectraPreTrainedModel"),g1=r(" forward method, overrides the "),am=n("code"),_1=r("__call__"),k1=r(" special method."),v1=c(),b(Xs.$$.fragment),T1=c(),b(Ys.$$.fragment),bf=c(),fn=n("h2"),Zs=n("a"),rm=n("span"),b(Ml.$$.fragment),b1=c(),im=n("span"),y1=r("FlaxElectraForMultipleChoice"),yf=c(),Ue=n("div"),b(zl.$$.fragment),E1=c(),lm=n("p"),w1=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),$1=c(),jl=n("p"),F1=r("This model inherits from "),cc=n("a"),x1=r("FlaxPreTrainedModel"),M1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),z1=c(),Cl=n("p"),j1=r(`This model is also a Flax Linen
`),ql=n("a"),C1=r("flax.nn.Module"),q1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),P1=c(),dm=n("p"),A1=r("Finally, this model supports inherent JAX features such as:"),O1=c(),Zt=n("ul"),cm=n("li"),Pl=n("a"),L1=r("Just-In-Time (JIT) compilation"),N1=c(),pm=n("li"),Al=n("a"),I1=r("Automatic Differentiation"),D1=c(),hm=n("li"),Ol=n("a"),S1=r("Vectorization"),W1=c(),mm=n("li"),Ll=n("a"),U1=r("Parallelization"),R1=c(),Nt=n("div"),b(Nl.$$.fragment),H1=c(),gn=n("p"),Q1=r("The "),um=n("code"),B1=r("FlaxElectraPreTrainedModel"),V1=r(" forward method, overrides the "),fm=n("code"),K1=r("__call__"),J1=r(" special method."),G1=c(),b(ea.$$.fragment),X1=c(),b(ta.$$.fragment),Ef=c(),_n=n("h2"),oa=n("a"),gm=n("span"),b(Il.$$.fragment),Y1=c(),_m=n("span"),Z1=r("FlaxElectraForTokenClassification"),wf=c(),Ae=n("div"),b(Dl.$$.fragment),eF=c(),km=n("p"),tF=r("Electra model with a token classification head on top."),oF=c(),vm=n("p"),nF=r("Both the discriminator and generator may be loaded into this model."),sF=c(),Sl=n("p"),aF=r("This model inherits from "),pc=n("a"),rF=r("FlaxPreTrainedModel"),iF=r(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jg.forEach(t),B$=p(_t),Ph=s(_t,"P",{});var bz=a(Ph);V$=i(bz,"Finally, this model supports inherent JAX features such as:"),bz.forEach(t),K$=p(_t),Gt=s(_t,"UL",{});var ba=a(Gt);Ah=s(ba,"LI",{});var yz=a(Ah);ol=s(yz,"A",{href:!0,rel:!0});var Ez=a(ol);J$=i(Ez,"Just-In-Time (JIT) compilation"),Ez.forEach(t),yz.forEach(t),G$=p(ba),Oh=s(ba,"LI",{});var wz=a(Oh);nl=s(wz,"A",{href:!0,rel:!0});var $z=a(nl);X$=i($z,"Automatic Differentiation"),$z.forEach(t),wz.forEach(t),Y$=p(ba),Lh=s(ba,"LI",{});var Fz=a(Lh);sl=s(Fz,"A",{href:!0,rel:!0});var xz=a(sl);Z$=i(xz,"Vectorization"),xz.forEach(t),Fz.forEach(t),e2=p(ba),Nh=s(ba,"LI",{});var Mz=a(Nh);al=s(Mz,"A",{href:!0,rel:!0});var zz=a(al);t2=i(zz,"Parallelization"),zz.forEach(t),Mz.forEach(t),ba.forEach(t),o2=p(_t),At=s(_t,"DIV",{class:!0});var ya=a(At);y(rl.$$.fragment,ya),n2=p(ya),cn=s(ya,"P",{});var qc=a(cn);s2=i(qc,"The "),Ih=s(qc,"CODE",{});var jz=a(Ih);a2=i(jz,"FlaxElectraPreTrainedModel"),jz.forEach(t),r2=i(qc," forward method, overrides the "),Dh=s(qc,"CODE",{});var Cz=a(Dh);i2=i(Cz,"__call__"),Cz.forEach(t),l2=i(qc," special method."),qc.forEach(t),d2=p(ya),y(Qs.$$.fragment,ya),c2=p(ya),y(Bs.$$.fragment,ya),ya.forEach(t),_t.forEach(t),_f=p(o),pn=s(o,"H2",{class:!0});var Cg=a(pn);Vs=s(Cg,"A",{id:!0,class:!0,href:!0});var qz=a(Vs);Sh=s(qz,"SPAN",{});var Pz=a(Sh);y(il.$$.fragment,Pz),Pz.forEach(t),qz.forEach(t),p2=p(Cg),Wh=s(Cg,"SPAN",{});var Az=a(Wh);h2=i(Az,"FlaxElectraForMaskedLM"),Az.forEach(t),Cg.forEach(t),kf=p(o),Se=s(o,"DIV",{class:!0});var kt=a(Se);y(ll.$$.fragment,kt),m2=p(kt),dl=s(kt,"P",{});var qg=a(dl);u2=i(qg,"Electra Model with a "),Uh=s(qg,"CODE",{});var Oz=a(Uh);f2=i(Oz,"language modeling"),Oz.forEach(t),g2=i(qg," head on top."),qg.forEach(t),_2=p(kt),cl=s(kt,"P",{});var Pg=a(cl);k2=i(Pg,"This model inherits from "),lc=s(Pg,"A",{href:!0});var Lz=a(lc);v2=i(Lz,"FlaxPreTrainedModel"),Lz.forEach(t),T2=i(Pg,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$2=p(kt),Rh=s(kt,"P",{});var Iz=a(Rh);F2=i(Iz,"Finally, this model supports inherent JAX features such as:"),Iz.forEach(t),x2=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var Dz=a(Hh);ml=s(Dz,"A",{href:!0,rel:!0});var Sz=a(ml);M2=i(Sz,"Just-In-Time (JIT) compilation"),Sz.forEach(t),Dz.forEach(t),z2=p(Ea),Qh=s(Ea,"LI",{});var Wz=a(Qh);ul=s(Wz,"A",{href:!0,rel:!0});var Uz=a(ul);j2=i(Uz,"Automatic Differentiation"),Uz.forEach(t),Wz.forEach(t),C2=p(Ea),Bh=s(Ea,"LI",{});var Rz=a(Bh);fl=s(Rz,"A",{href:!0,rel:!0});var Hz=a(fl);q2=i(Hz,"Vectorization"),Hz.forEach(t),Rz.forEach(t),P2=p(Ea),Vh=s(Ea,"LI",{});var Qz=a(Vh);gl=s(Qz,"A",{href:!0,rel:!0});var Bz=a(gl);A2=i(Bz,"Parallelization"),Bz.forEach(t),Qz.forEach(t),Ea.forEach(t),O2=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L2=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N2=i(Pc,"The "),Kh=s(Pc,"CODE",{});var Vz=a(Kh);I2=i(Vz,"FlaxElectraPreTrainedModel"),Vz.forEach(t),D2=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var Kz=a(Jh);S2=i(Kz,"__call__"),Kz.forEach(t),W2=i(Pc," special method."),Pc.forEach(t),U2=p(wa),y(Ks.$$.fragment,wa),R2=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var Jz=a(Gs);Gh=s(Jz,"SPAN",{});var Gz=a(Gh);y(kl.$$.fragment,Gz),Gz.forEach(t),Jz.forEach(t),H2=p(Og),Xh=s(Og,"SPAN",{});var Xz=a(Xh);Q2=i(Xz,"FlaxElectraForSequenceClassification"),Xz.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),B2=p(vt),Yh=s(vt,"P",{});var Yz=a(Yh);V2=i(Yz,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
`),yl=s(Ng,"A",{href:!0,rel:!0});var e4=a(yl);e1=i(e4,"flax.nn.Module"),e4.forEach(t),t1=i(Ng,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ng.forEach(t),o1=p(vt),Zh=s(vt,"P",{});var t4=a(Zh);n1=i(t4,"Finally, this model supports inherent JAX features such as:"),t4.forEach(t),s1=p(vt),Yt=s(vt,"UL",{});var $a=a(Yt);em=s($a,"LI",{});var o4=a(em);El=s(o4,"A",{href:!0,rel:!0});var n4=a(El);a1=i(n4,"Just-In-Time (JIT) compilation"),n4.forEach(t),o4.forEach(t),r1=p($a),tm=s($a,"LI",{});var s4=a(tm);wl=s(s4,"A",{href:!0,rel:!0});var a4=a(wl);i1=i(a4,"Automatic Differentiation"),a4.forEach(t),s4.forEach(t),l1=p($a),om=s($a,"LI",{});var r4=a(om);$l=s(r4,"A",{href:!0,rel:!0});var i4=a($l);d1=i(i4,"Vectorization"),i4.forEach(t),r4.forEach(t),c1=p($a),nm=s($a,"LI",{});var l4=a(nm);Fl=s(l4,"A",{href:!0,rel:!0});var d4=a(Fl);p1=i(d4,"Parallelization"),d4.forEach(t),l4.forEach(t),$a.forEach(t),h1=p(vt),Lt=s(vt,"DIV",{class:!0});var Fa=a(Lt);y(xl.$$.fragment,Fa),m1=p(Fa),un=s(Fa,"P",{});var Ac=a(un);u1=i(Ac,"The "),sm=s(Ac,"CODE",{});var c4=a(sm);f1=i(c4,"FlaxElectraPreTrainedModel"),c4.forEach(t),g1=i(Ac," forward method, overrides the "),am=s(Ac,"CODE",{});var p4=a(am);_1=i(p4,"__call__"),p4.forEach(t),k1=i(Ac," special method."),Ac.forEach(t),v1=p(Fa),y(Xs.$$.fragment,Fa),T1=p(Fa),y(Ys.$$.fragment,Fa),Fa.forEach(t),vt.forEach(t),bf=p(o),fn=s(o,"H2",{class:!0});var Ig=a(fn);Zs=s(Ig,"A",{id:!0,class:!0,href:!0});var h4=a(Zs);rm=s(h4,"SPAN",{});var m4=a(rm);y(Ml.$$.fragment,m4),m4.forEach(t),h4.forEach(t),b1=p(Ig),im=s(Ig,"SPAN",{});var u4=a(im);y1=i(u4,"FlaxElectraForMultipleChoice"),u4.forEach(t),Ig.forEach(t),yf=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(zl.$$.fragment,Tt),E1=p(Tt),lm=s(Tt,"P",{});var f4=a(lm);w1=i(f4,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),f4.forEach(t),$1=p(Tt),jl=s(Tt,"P",{});var Dg=a(jl);F1=i(Dg,"This model inherits from "),cc=s(Dg,"A",{href:!0});var g4=a(cc);x1=i(g4,"FlaxPreTrainedModel"),g4.forEach(t),M1=i(Dg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Dg.forEach(t),z1=p(Tt),Cl=s(Tt,"P",{});var Sg=a(Cl);j1=i(Sg,`This model is also a Flax Linen
`),ql=s(Sg,"A",{href:!0,rel:!0});var _4=a(ql);C1=i(_4,"flax.nn.Module"),_4.forEach(t),q1=i(Sg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sg.forEach(t),P1=p(Tt),dm=s(Tt,"P",{});var k4=a(dm);A1=i(k4,"Finally, this model supports inherent JAX features such as:"),k4.forEach(t),O1=p(Tt),Zt=s(Tt,"UL",{});var xa=a(Zt);cm=s(xa,"LI",{});var v4=a(cm);Pl=s(v4,"A",{href:!0,rel:!0});var T4=a(Pl);L1=i(T4,"Just-In-Time (JIT) compilation"),T4.forEach(t),v4.forEach(t),N1=p(xa),pm=s(xa,"LI",{});var b4=a(pm);Al=s(b4,"A",{href:!0,rel:!0});var y4=a(Al);I1=i(y4,"Automatic Differentiation"),y4.forEach(t),b4.forEach(t),D1=p(xa),hm=s(xa,"LI",{});var E4=a(hm);Ol=s(E4,"A",{href:!0,rel:!0});var w4=a(Ol);S1=i(w4,"Vectorization"),w4.forEach(t),E4.forEach(t),W1=p(xa),mm=s(xa,"LI",{});var $4=a(mm);Ll=s($4,"A",{href:!0,rel:!0});var F4=a(Ll);U1=i(F4,"Parallelization"),F4.forEach(t),$4.forEach(t),xa.forEach(t),R1=p(Tt),Nt=s(Tt,"DIV",{class:!0});var Ma=a(Nt);y(Nl.$$.fragment,Ma),H1=p(Ma),gn=s(Ma,"P",{});var Oc=a(gn);Q1=i(Oc,"The "),um=s(Oc,"CODE",{});var x4=a(um);B1=i(x4,"FlaxElectraPreTrainedModel"),x4.forEach(t),V1=i(Oc," forward method, overrides the "),fm=s(Oc,"CODE",{});var M4=a(fm);K1=i(M4,"__call__"),M4.forEach(t),J1=i(Oc," special method."),Oc.forEach(t),G1=p(Ma),y(ea.$$.fragment,Ma),X1=p(Ma),y(ta.$$.fragment,Ma),Ma.forEach(t),Tt.forEach(t),Ef=p(o),_n=s(o,"H2",{class:!0});var Wg=a(_n);oa=s(Wg,"A",{id:!0,class:!0,href:!0});var z4=a(oa);gm=s(z4,"SPAN",{});var j4=a(gm);y(Il.$$.fragment,j4),j4.forEach(t),z4.forEach(t),Y1=p(Wg),_m=s(Wg,"SPAN",{});var C4=a(_m);Z1=i(C4,"FlaxElectraForTokenClassification"),C4.forEach(t),Wg.forEach(t),wf=p(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);y(Dl.$$.fragment,Ze),eF=p(Ze),km=s(Ze,"P",{});var q4=a(km);tF=i(q4,"Electra model with a token classification head on top."),q4.forEach(t),oF=p(Ze),vm=s(Ze,"P",{});var P4=a(vm);nF=i(P4,"Both the discriminator and generator may be loaded into this model."),P4.forEach(t),sF=p(Ze),Sl=s(Ze,"P",{});var Ug=a(Sl);aF=i(Ug,"This model inherits from "),pc=s(Ug,"A",{href:!0});var A4=a(pc);rF=i(A4,"FlaxPreTrainedModel"),A4.forEach(t),iF=i(Ug,`. Check the superclass documentation for the generic methods the
