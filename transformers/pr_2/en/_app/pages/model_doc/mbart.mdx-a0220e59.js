...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),de=a(jt,"CODE",{});var YM=s(de);Ht=i(YM,"X [eos, src_lang_code]"),YM.forEach(t),Vt=i(jt," where "),le=a(jt,"CODE",{});var e2=s(le);Qt=i(e2,"X"),e2.forEach(t),Jt=i(jt,` is the source text. The
target text format is `),Ve=a(jt,"CODE",{});var t2=s(Ve);Kt=i(t2,"[tgt_lang_code] X [eos]"),t2.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o2=s(rd);Pu=i(o2,"bos"),o2.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var UM=s(Cn);id=a(UM,"STRONG",{});var n2=s(id);Au=i(n2,"call"),n2.forEach(t),Ou=i(UM,"()"),UM.forEach(t),Iu=i(Ei,` will encode source text format, and it should be wrapped
inside the context manager `),Zr=a(Ei,"A",{href:!0});var a2=s(Zr);Nu=i(a2,"as_target_tokenizer()"),a2.forEach(t),Du=i(Ei," to encode target text format."),Ei.forEach(t),gp=l(o),Yr=a(o,"UL",{});var s2=s(Yr);dd=a(s2,"LI",{});var r2=s(dd);Lu=i(r2,"Supervised training"),r2.forEach(t),s2.forEach(t),kp=l(o),f(Sn.$$.fragment,o),bp=l(o),ei=a(o,"UL",{});var i2=s(ei);An=a(i2,"LI",{});var hh=s(An);ld=a(hh,"P",{});var d2=s(ld);Gu=i(d2,"Generation"),d2.forEach(t),Wu=l(hh),Zt=a(hh,"P",{});var Pi=s(Zt);Ru=i(Pi,"While generating the target text set the "),cd=a(Pi,"CODE",{});var l2=s(cd);Uu=i(l2,"decoder_start_token_id"),l2.forEach(t),Xu=i(Pi,` to the target language id. The following
example shows how to translate English to Romanian using the `),pd=a(Pi,"EM",{});var c2=s(pd);Hu=i(c2,"facebook/mbart-large-en-ro"),c2.forEach(t),Vu=i(Pi," model."),Pi.forEach(t),hh.forEach(t),i2.forEach(t),yp=l(o),f(On.$$.fragment,o),vp=l(o),Yt=a(o,"H2",{class:!0});var uh=s(Yt);So=a(uh,"A",{id:!0,class:!0,href:!0});var p2=s(So);hd=a(p2,"SPAN",{});var h2=s(hd);f(In.$$.fragment,h2),h2.forEach(t),p2.forEach(t),Qu=l(uh),ud=a(uh,"SPAN",{});var u2=s(ud);Ju=i(u2,"Overview of MBart-50"),u2.forEach(t),uh.forEach(t),Tp=l(o),yt=a(o,"P",{});var Ci=s(yt);Ku=i(Ci,"MBart-50 was introduced in the "),Nn=a(Ci,"A",{href:!0,rel:!0});var m2=s(Nn);Zu=i(m2,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),m2.forEach(t),Yu=i(Ci,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),k2.forEach(t),g2.forEach(t),xp=l(o),eo=a(o,"H3",{class:!0});var mh=s(eo);Ao=a(mh,"A",{id:!0,class:!0,href:!0});var b2=s(Ao);_d=a(b2,"SPAN",{});var y2=s(_d);f(Dn.$$.fragment,y2),y2.forEach(t),b2.forEach(t),am=l(mh),gd=a(mh,"SPAN",{});var v2=s(gd);sm=i(v2,"Training of MBart-50"),v2.forEach(t),mh.forEach(t),zp=l(o),et=a(o,"P",{});var wn=s(et);rm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
language id for source text and target language id for target text, with `),yd=a(wn,"CODE",{});var w2=s(yd);pm=i(w2,"X"),w2.forEach(t),hm=i(wn,` being the source or target text
respectively.`),wn.forEach(t),qp=l(o),Oo=a(o,"P",{});var fh=s(Oo);um=i(fh,"MBart-50 has its own tokenizer "),ni=a(fh,"A",{href:!0});var x2=s(ni);mm=i(x2,"MBart50Tokenizer"),x2.forEach(t),fm=i(fh,"."),fh.forEach(t),Bp=l(o),ai=a(o,"UL",{});var z2=s(ai);vd=a(z2,"LI",{});var q2=s(vd);_m=i(q2,"Supervised training"),q2.forEach(t),z2.forEach(t),Fp=l(o),f(Ln.$$.fragment,o),$p=l(o),si=a(o,"UL",{});var B2=s(si);Gn=a(B2,"LI",{});var _h=s(Gn);Td=a(_h,"P",{});var F2=s(Td);gm=i(F2,"Generation"),F2.forEach(t),km=l(_h),xe=a(_h,"P",{});var nt=s(xe);bm=i(nt,"To generate using the mBART-50 multilingual translation models, "),Md=a(nt,"CODE",{});var $2=s(Md);ym=i($2,"eos_token_id"),$2.forEach(t),vm=i(nt,` is used as the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),qd=a(nt,"EM",{});var C2=s(qd);Bm=i(C2,"facebook/mbart-50-large-many-to-many"),C2.forEach(t),Fm=i(nt," checkpoint."),nt.forEach(t),_h.forEach(t),B2.forEach(t),jp=l(o),f(Wn.$$.fragment,o),Ep=l(o),to=a(o,"H2",{class:!0});var gh=s(to);Io=a(gh,"A",{id:!0,class:!0,href:!0});var S2=s(Io);Bd=a(S2,"SPAN",{});var A2=s(Bd);f(Rn.$$.fragment,A2),A2.forEach(t),S2.forEach(t),$m=l(gh),Fd=a(gh,"SPAN",{});var O2=s(Fd);jm=i(O2,"MBartConfig"),O2.forEach(t),gh.forEach(t),Pp=l(o),ze=a(o,"DIV",{class:!0});var Et=s(ze);f(Un.$$.fragment,Et),Em=l(Et),oo=a(Et,"P",{});var Si=s(oo);Pm=i(Si,"This is the configuration class to store the configuration of a "),ri=a(Si,"A",{href:!0});var I2=s(ri);Cm=i(I2,"MBartModel"),I2.forEach(t),Sm=i(Si,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Si,"A",{href:!0,rel:!0});var N2=s(Xn);Am=i(N2,"facebook/mbart-large-cc25"),N2.forEach(t),Om=i(Si," architecture."),Si.forEach(t),Im=l(Et),no=a(Et,"P",{});var Ai=s(no);Nm=i(Ai,"Configuration objects inherit from "),ii=a(Ai,"A",{href:!0});var D2=s(ii);Dm=i(D2,"PretrainedConfig"),D2.forEach(t),Lm=i(Ai,` and can be used to control the model outputs. Read the
documentation from `),di=a(Ai,"A",{href:!0});var L2=s(di);Gm=i(L2,"PretrainedConfig"),L2.forEach(t),Wm=i(Ai," for more information."),Ai.forEach(t),Rm=l(Et),$d=a(Et,"P",{});var G2=s($d);Um=i(G2,"Example:"),G2.forEach(t),Xm=l(Et),f(Hn.$$.fragment,Et),Et.forEach(t),Cp=l(o),ao=a(o,"H2",{class:!0});var kh=s(ao);No=a(kh,"A",{id:!0,class:!0,href:!0});var W2=s(No);jd=a(W2,"SPAN",{});var R2=s(jd);f(Vn.$$.fragment,R2),R2.forEach(t),W2.forEach(t),Hm=l(kh),Ed=a(kh,"SPAN",{});var U2=s(Ed);Vm=i(U2,"MBartTokenizer"),U2.forEach(t),kh.forEach(t),Sp=l(o),L=a(o,"DIV",{class:!0});var he=s(L);f(Qn.$$.fragment,he),Qm=l(he),Pd=a(he,"P",{});var X2=s(Pd);Jm=i(X2,"Construct an MBART tokenizer."),X2.forEach(t),Km=l(he),ut=a(he,"P",{});var xn=s(ut);Zm=i(xn,"Adapted from "),li=a(xn,"A",{href:!0});var H2=s(li);Ym=i(H2,"RobertaTokenizer"),H2.forEach(t),ef=i(xn," and "),ci=a(xn,"A",{href:!0});var V2=s(ci);tf=i(V2,"XLNetTokenizer"),V2.forEach(t),of=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var Q2=s(Jn);nf=i(Q2,"SentencePiece"),Q2.forEach(t),af=i(xn,"."),xn.forEach(t),sf=l(he),Kn=a(he,"P",{});var bh=s(Kn);rf=i(bh,"The tokenization method is "),Cd=a(bh,"CODE",{});var J2=s(Cd);df=i(J2,"<tokens> <eos> <language code>"),J2.forEach(t),lf=i(bh," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),bh.forEach(t),cf=l(he),Sd=a(he,"P",{});var K2=s(Sd);pf=i(K2,"Examples:"),K2.forEach(t),hf=l(he),f(Zn.$$.fragment,he),uf=l(he),Do=a(he,"DIV",{class:!0});var yh=s(Do);f(Yn.$$.fragment,yh),mf=l(yh),Ad=a(yh,"P",{});var Z2=s(Ad);ff=i(Z2,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Z2.forEach(t),yh.forEach(t),_f=l(he),tt=a(he,"DIV",{class:!0});var zn=s(tt);f(ea.$$.fragment,zn),gf=l(zn),ta=a(zn,"P",{});var vh=s(ta);kf=i(vh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Od=a(vh,"CODE",{});var Y2=s(Od);bf=i(Y2,"X"),Y2.forEach(t),yf=i(vh," represents the sequence:"),vh.forEach(t),vf=l(zn),oa=a(zn,"UL",{});var Th=s(oa);na=a(Th,"LI",{});var Mh=s(na);Id=a(Mh,"CODE",{});var ew=s(Id);Tf=i(ew,"input_ids"),ew.forEach(t),Mf=i(Mh," (for encoder) "),Nd=a(Mh,"CODE",{});var tw=s(Nd);wf=i(tw,"X [eos, src_lang_code]"),tw.forEach(t),Mh.forEach(t),xf=l(Th),aa=a(Th,"LI",{});var wh=s(aa);Dd=a(wh,"CODE",{});var ow=s(Dd);zf=i(ow,"decoder_input_ids"),ow.forEach(t),qf=i(wh,": (for decoder) "),Ld=a(wh,"CODE",{});var nw=s(Ld);Bf=i(nw,"X [eos, tgt_lang_code]"),nw.forEach(t),wh.forEach(t),Th.forEach(t),Ff=l(zn),Gd=a(zn,"P",{});var aw=s(Gd);$f=i(aw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
adding special tokens. The special tokens depend on calling set_lang.`),Vw.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var Qw=s(Tl);Pg=i(Qw,"X"),Qw.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Sg=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var Jw=s(Ml);Ag=i(Jw,"input_ids"),Jw.forEach(t),Og=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var Kw=s(wl);Ig=i(Kw,"[src_lang_code] X [eos]"),Kw.forEach(t),Jh.forEach(t),Ng=l(Qh),Wa=a(Qh,"LI",{});var Kh=s(Wa);xl=a(Kh,"CODE",{});var Zw=s(xl);Dg=i(Zw,"labels"),Zw.forEach(t),Lg=i(Kh,": (for decoder) "),zl=a(Kh,"CODE",{});var Yw=s(zl);Gg=i(Yw,"[tgt_lang_code] X [eos]"),Yw.forEach(t),Kh.forEach(t),Qh.forEach(t),Wg=l(Ct),ql=a(Ct,"P",{});var e1=s(ql);Rg=i(e1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),e1.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);f(Ra.$$.fragment,Zh),Xg=l(Zh),Bl=a(Zh,"P",{});var t1=s(Bl);Hg=i(t1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),t1.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);f(Ua.$$.fragment,Yh),Qg=l(Yh),Fl=a(Yh,"P",{});var o1=s(Fl);Jg=i(o1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),o1.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var n1=s(Yo);$l=a(n1,"SPAN",{});var a1=s($l);f(Xa.$$.fragment,a1),a1.forEach(t),n1.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var s1=s(jl);Zg=i(s1,"MBartModel"),s1.forEach(t),eu.forEach(t),Wp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);f(Ha.$$.fragment,Bn),Yg=l(Bn),Va=a(Bn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),_i=a(tu,"A",{href:!0});var r1=s(_i);tk=i(r1,"PreTrainedModel"),r1.forEach(t),ok=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),nk=l(Bn),Qa=a(Bn,"P",{});var ou=s(Qa);ak=i(ou,"This model is also a PyTorch "),Ja=a(ou,"A",{href:!0,rel:!0});var i1=s(Ja);sk=i(i1,"torch.nn.Module"),i1.forEach(t),rk=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Ni=s(ho);lk=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var d1=s(gi);ck=i(d1,"MBartModel"),d1.forEach(t),pk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var l1=s(El);hk=i(l1,"__call__"),l1.forEach(t),uk=i(Ni," special method."),Ni.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c1=s(Pl);_k=i(c1,"Example:"),c1.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p1=s(tn);Cl=a(p1,"SPAN",{});var h1=s(Cl);f(Ya.$$.fragment,h1),h1.forEach(t),p1.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u1=s(Sl);bk=i(u1,"MBartForConditionalGeneration"),u1.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var Fn=s(Je);f(es.$$.fragment,Fn),yk=l(Fn),ts=a(Fn,"P",{});var au=s(ts);vk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ki=a(au,"A",{href:!0});var m1=s(ki);Tk=i(m1,"PreTrainedModel"),m1.forEach(t),Mk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l(Fn),os=a(Fn,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f1=s(ns);zk=i(f1,"torch.nn.Module"),f1.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l(Fn),Z=a(Fn,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),Fk=l(Le),mo=a(Le,"P",{});var Di=s(mo);$k=i(Di,"The "),bi=a(Di,"A",{href:!0});var _1=s(bi);jk=i(_1,"MBartForConditionalGeneration"),_1.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g1=s(Al);Pk=i(g1,"__call__"),g1.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Ol=a(Le,"P",{});var k1=s(Ol);Ok=i(k1,"Translation example:"),k1.forEach(t),Ik=l(Le),f(ss.$$.fragment,Le),Nk=l(Le),Il=a(Le,"P",{});var b1=s(Il);Dk=i(b1,"Mask filling example:"),b1.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),Fn.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var y1=s(nn);Nl=a(y1,"SPAN",{});var v1=s(Nl);f(is.$$.fragment,v1),v1.forEach(t),y1.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T1=s(Dl);Wk=i(T1,"MBartForQuestionAnswering"),T1.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M1=s(Ll);Xk=i(M1,"span start logits"),M1.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w1=s(Gl);Vk=i(w1,"span end logits"),w1.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),yi=a(iu,"A",{href:!0});var x1=s(yi);Zk=i(x1,"PreTrainedModel"),x1.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),eb=l(At),cs=a(At,"P",{});var du=s(cs);tb=i(du,"This model is also a PyTorch "),ps=a(du,"A",{href:!0,rel:!0});var z1=s(ps);ob=i(z1,"torch.nn.Module"),z1.forEach(t),nb=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var Ot=s(Ae);f(hs.$$.fragment,Ot),sb=l(Ot),go=a(Ot,"P",{});var Gi=s(go);rb=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var q1=s(vi);ib=i(q1,"MBartForQuestionAnswering"),q1.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B1=s(Wl);lb=i(B1,"__call__"),B1.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(Ot),f(an.$$.fragment,Ot),hb=l(Ot),Rl=a(Ot,"P",{});var F1=s(Rl);ub=i(F1,"Example:"),F1.forEach(t),mb=l(Ot),f(us.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var $1=s(sn);Ul=a($1,"SPAN",{});var j1=s(Ul);f(ms.$$.fragment,j1),j1.forEach(t),$1.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E1=s(Xl);_b=i(E1,"MBartForSequenceClassification"),E1.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);f(fs.$$.fragment,It),gb=l(It),Hl=a(It,"P",{});var P1=s(Hl);kb=i(P1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P1.forEach(t),bb=l(It),_s=a(It,"P",{});var cu=s(_s);yb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var C1=s(Ti);vb=i(C1,"PreTrainedModel"),C1.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(It),gs=a(It,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S1=s(ks);xb=i(S1,"torch.nn.Module"),S1.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(It),Y=a(It,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);Fb=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A1=s(Mi);$b=i(A1,"MBartForSequenceClassification"),A1.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var O1=s(Vl);Eb=i(O1,"__call__"),O1.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var I1=s(Ql);Ab=i(I1,"Example of single-label classification:"),I1.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ib=l(Ge),Jl=a(Ge,"P",{});var N1=s(Jl);Nb=i(N1,"Example of multi-label classification:"),N1.forEach(t),Db=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),It.forEach(t),Jp=l(o),yo=a(o,"H2",{class:!0});var hu=s(yo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D1=s(dn);Kl=a(D1,"SPAN",{});var L1=s(Kl);f(Ts.$$.fragment,L1),L1.forEach(t),D1.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G1=s(Zl);Gb=i(G1,"MBartForCausalLM"),G1.forEach(t),hu.forEach(t),Kp=l(o),vo=a(o,"DIV",{class:!0});var uu=s(vo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W1=s(Yl);Ub=i(W1,"Example:"),W1.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R1=s(ln);ec=a(R1,"SPAN",{});var U1=s(ec);f(zs.$$.fragment,U1),U1.forEach(t),R1.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X1=s(tc);Vb=i(X1,"TFMBartModel"),X1.forEach(t),mu.forEach(t),Yp=l(o),Fe=a(o,"DIV",{class:!0});var Nt=s(Fe);f(qs.$$.fragment,Nt),Qb=l(Nt),Bs=a(Nt,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),wi=a(fu,"A",{href:!0});var H1=s(wi);Kb=i(H1,"TFPreTrainedModel"),H1.forEach(t),Zb=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),Fs=a(Nt,"P",{});var _u=s(Fs);ey=i(_u,"This model is also a "),$s=a(_u,"A",{href:!0,rel:!0});var V1=s($s);ty=i(V1,"tf.keras.Model"),V1.forEach(t),oy=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ny=l(Nt),f(cn.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),sy=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q1=s(xi);iy=i(Q1,"TFMBartModel"),Q1.forEach(t),dy=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J1=s(oc);ly=i(J1,"__call__"),J1.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),f(pn.$$.fragment,Dt),hy=l(Dt),nc=a(Dt,"P",{});var K1=s(nc);uy=i(K1,"Example:"),K1.forEach(t),my=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z1=s(hn);ac=a(Z1,"SPAN",{});var Y1=s(ac);f(Ps.$$.fragment,Y1),Y1.forEach(t),Z1.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_y=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),$e=a(o,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
