...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_2/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_2/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_2/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
documentation from `),pi=a(Ni,"A",{href:!0});var Hw=s(pi);Um=i(Hw,"PretrainedConfig"),Hw.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Hm=l(Pt),Pd=a(Pt,"P",{});var Vw=s(Pd);Vm=i(Vw,"Example:"),Vw.forEach(t),Qm=l(Pt),m(Hn.$$.fragment,Pt),Pt.forEach(t),Op=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var Qw=s(No);Cd=a(Qw,"SPAN",{});var Jw=s(Cd);m(Vn.$$.fragment,Jw),Jw.forEach(t),Qw.forEach(t),Jm=l(vh),Sd=a(vh,"SPAN",{});var Kw=s(Sd);Km=i(Kw,"MBartTokenizer"),Kw.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Qn.$$.fragment,me),Zm=l(me),Ad=a(me,"P",{});var Zw=s(Ad);Ym=i(Zw,"Construct an MBART tokenizer."),Zw.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Yw=s(hi);of=i(Yw,"RobertaTokenizer"),Yw.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var e2=s(ui);af=i(e2,"XLNetTokenizer"),e2.forEach(t),sf=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var t2=s(Jn);rf=i(t2,"SentencePiece"),t2.forEach(t),df=i(xn,"."),xn.forEach(t),lf=l(me),Kn=a(me,"P",{});var Th=s(Kn);cf=i(Th,"The tokenization method is "),Od=a(Th,"CODE",{});var o2=s(Od);pf=i(o2,"<tokens> <eos> <language code>"),o2.forEach(t),hf=i(Th," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Th.forEach(t),uf=l(me),Id=a(me,"P",{});var n2=s(Id);mf=i(n2,"Examples:"),n2.forEach(t),ff=l(me),m(Zn.$$.fragment,me),_f=l(me),Do=a(me,"DIV",{class:!0});var Mh=s(Do);m(Yn.$$.fragment,Mh),gf=l(Mh),Nd=a(Mh,"P",{});var a2=s(Nd);kf=i(a2,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),a2.forEach(t),Mh.forEach(t),bf=l(me),tt=a(me,"DIV",{class:!0});var zn=s(tt);m(ea.$$.fragment,zn),yf=l(zn),ta=a(zn,"P",{});var wh=s(ta);vf=i(wh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Dd=a(wh,"CODE",{});var s2=s(Dd);Tf=i(s2,"X"),s2.forEach(t),Mf=i(wh," represents the sequence:"),wh.forEach(t),wf=l(zn),oa=a(zn,"UL",{});var xh=s(oa);na=a(xh,"LI",{});var zh=s(na);Ld=a(zh,"CODE",{});var r2=s(Ld);xf=i(r2,"input_ids"),r2.forEach(t),zf=i(zh," (for encoder) "),Gd=a(zh,"CODE",{});var i2=s(Gd);qf=i(i2,"X [eos, src_lang_code]"),i2.forEach(t),zh.forEach(t),Bf=l(xh),aa=a(xh,"LI",{});var qh=s(aa);Wd=a(qh,"CODE",{});var d2=s(Wd);$f=i(d2,"decoder_input_ids"),d2.forEach(t),Ff=i(qh,": (for decoder) "),Rd=a(qh,"CODE",{});var l2=s(Rd);jf=i(l2,"X [eos, tgt_lang_code]"),l2.forEach(t),qh.forEach(t),xh.forEach(t),Ef=l(zn),Ud=a(zn,"P",{});var c2=s(Ud);Pf=i(c2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),c2.forEach(t),zn.forEach(t),me.forEach(t),Np=l(o),so=a(o,"H2",{class:!0});var Bh=s(so);Lo=a(Bh,"A",{id:!0,class:!0,href:!0});var p2=s(Lo);Xd=a(p2,"SPAN",{});var h2=s(Xd);m(sa.$$.fragment,h2),h2.forEach(t),p2.forEach(t),Cf=l(Bh),Hd=a(Bh,"SPAN",{});var u2=s(Hd);Sf=i(u2,"MBartTokenizerFast"),u2.forEach(t),Bh.forEach(t),Dp=l(o),C=a(o,"DIV",{class:!0});var V=s(C);m(ra.$$.fragment,V),Af=l(V),ro=a(V,"P",{});var Di=s(ro);Of=i(Di,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Vd=a(Di,"EM",{});var m2=s(Vd);If=i(m2,"tokenizers"),m2.forEach(t),Nf=i(Di,` library). Based on
`),ia=a(Di,"A",{href:!0,rel:!0});var f2=s(ia);Df=i(f2,"BPE"),f2.forEach(t),Lf=i(Di,"."),Di.forEach(t),Gf=l(V),Tt=a(V,"P",{});var ei=s(Tt);mi=a(ei,"A",{href:!0});var _2=s(mi);Wf=i(_2,"MBartTokenizerFast"),_2.forEach(t),Rf=i(ei," is a subclass of "),fi=a(ei,"A",{href:!0});var g2=s(fi);Uf=i(g2,"XLMRobertaTokenizerFast"),g2.forEach(t),Xf=i(ei,`. Refer to superclass
`),_i=a(ei,"A",{href:!0});var k2=s(_i);Hf=i(k2,"XLMRobertaTokenizerFast"),k2.forEach(t),Vf=i(ei,` for usage examples and documentation concerning the initialization parameters and other
methods.`),ei.forEach(t),Qf=l(V),da=a(V,"P",{});var $h=s(da);Jf=i($h,"The tokenization method is "),Qd=a($h,"CODE",{});var b2=s(Qd);Kf=i(b2,"<tokens> <eos> <language code>"),b2.forEach(t),Zf=i($h," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$h.forEach(t),Yf=l(V),Jd=a(V,"P",{});var y2=s(Jd);e_=i(y2,"Examples:"),y2.forEach(t),t_=l(V),m(la.$$.fragment,V),o_=l(V),Se=a(V,"DIV",{class:!0});var Ct=s(Se);m(ca.$$.fragment,Ct),n_=l(Ct),Kd=a(Ct,"P",{});var v2=s(Kd);a_=i(v2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),v2.forEach(t),s_=l(Ct),pa=a(Ct,"P",{});var Fh=s(pa);r_=i(Fh,"An MBART sequence has the following format, where "),Zd=a(Fh,"CODE",{});var T2=s(Zd);i_=i(T2,"X"),T2.forEach(t),d_=i(Fh," represents the sequence:"),Fh.forEach(t),l_=l(Ct),ha=a(Ct,"UL",{});var jh=s(ha);ua=a(jh,"LI",{});var Eh=s(ua);Yd=a(Eh,"CODE",{});var M2=s(Yd);c_=i(M2,"input_ids"),M2.forEach(t),p_=i(Eh," (for encoder) "),el=a(Eh,"CODE",{});var w2=s(el);h_=i(w2,"X [eos, src_lang_code]"),w2.forEach(t),Eh.forEach(t),u_=l(jh),ma=a(jh,"LI",{});var Ph=s(ma);tl=a(Ph,"CODE",{});var x2=s(tl);m_=i(x2,"decoder_input_ids"),x2.forEach(t),f_=i(Ph,": (for decoder) "),ol=a(Ph,"CODE",{});var z2=s(ol);__=i(z2,"X [eos, tgt_lang_code]"),z2.forEach(t),Ph.forEach(t),jh.forEach(t),g_=l(Ct),nl=a(Ct,"P",{});var q2=s(nl);k_=i(q2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),q2.forEach(t),Ct.forEach(t),b_=l(V),Go=a(V,"DIV",{class:!0});var Ch=s(Go);m(fa.$$.fragment,Ch),y_=l(Ch),al=a(Ch,"P",{});var B2=s(al);v_=i(B2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),B2.forEach(t),Ch.forEach(t),T_=l(V),Wo=a(V,"DIV",{class:!0});var Sh=s(Wo);m(_a.$$.fragment,Sh),M_=l(Sh),sl=a(Sh,"P",{});var $2=s(sl);w_=i($2,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$2.forEach(t),Sh.forEach(t),x_=l(V),Ro=a(V,"DIV",{class:!0});var Ah=s(Ro);m(ga.$$.fragment,Ah),z_=l(Ah),rl=a(Ah,"P",{});var F2=s(rl);q_=i(F2,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),F2.forEach(t),Ah.forEach(t),V.forEach(t),Lp=l(o),io=a(o,"H2",{class:!0});var Oh=s(io);Uo=a(Oh,"A",{id:!0,class:!0,href:!0});var j2=s(Uo);il=a(j2,"SPAN",{});var E2=s(il);m(ka.$$.fragment,E2),E2.forEach(t),j2.forEach(t),B_=l(Oh),dl=a(Oh,"SPAN",{});var P2=s(dl);$_=i(P2,"MBart50Tokenizer"),P2.forEach(t),Oh.forEach(t),Gp=l(o),S=a(o,"DIV",{class:!0});var Q=s(S);m(ba.$$.fragment,Q),F_=l(Q),ya=a(Q,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var C2=s(va);E_=i(C2,"SentencePiece"),C2.forEach(t),P_=i(Ih,"."),Ih.forEach(t),C_=l(Q),Ta=a(Q,"P",{});var Nh=s(Ta);S_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var S2=s(gi);A_=i(S2,"PreTrainedTokenizer"),S2.forEach(t),O_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(Q),ll=a(Q,"P",{});var A2=s(ll);N_=i(A2,"Examples:"),A2.forEach(t),D_=l(Q),m(Ma.$$.fragment,Q),L_=l(Q),ot=a(Q,"DIV",{class:!0});var qn=s(ot);m(wa.$$.fragment,qn),G_=l(qn),xa=a(qn,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=a(Dh,"CODE",{});var O2=s(cl);R_=i(O2,"X"),O2.forEach(t),U_=i(Dh," represents the sequence:"),Dh.forEach(t),X_=l(qn),za=a(qn,"UL",{});var Lh=s(za);qa=a(Lh,"LI",{});var Gh=s(qa);pl=a(Gh,"CODE",{});var I2=s(pl);H_=i(I2,"input_ids"),I2.forEach(t),V_=i(Gh," (for encoder) "),hl=a(Gh,"CODE",{});var N2=s(hl);Q_=i(N2,"[src_lang_code] X [eos]"),N2.forEach(t),Gh.forEach(t),J_=l(Lh),Ba=a(Lh,"LI",{});var Wh=s(Ba);ul=a(Wh,"CODE",{});var D2=s(ul);K_=i(D2,"labels"),D2.forEach(t),Z_=i(Wh,": (for decoder) "),ml=a(Wh,"CODE",{});var L2=s(ml);Y_=i(L2,"[tgt_lang_code] X [eos]"),L2.forEach(t),Wh.forEach(t),Lh.forEach(t),eg=l(qn),fl=a(qn,"P",{});var G2=s(fl);tg=i(G2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),G2.forEach(t),qn.forEach(t),og=l(Q),Xo=a(Q,"DIV",{class:!0});var Rh=s(Xo);m($a.$$.fragment,Rh),ng=l(Rh),_l=a(Rh,"P",{});var W2=s(_l);ag=i(W2,"Converts a sequence of tokens (strings for sub-words) in a single string."),W2.forEach(t),Rh.forEach(t),sg=l(Q),Ho=a(Q,"DIV",{class:!0});var Uh=s(Ho);m(Fa.$$.fragment,Uh),rg=l(Uh),ja=a(Uh,"P",{});var Xh=s(ja);ig=i(Xh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),gl=a(Xh,"CODE",{});var R2=s(gl);dg=i(R2,"prepare_for_model"),R2.forEach(t),lg=i(Xh," method."),Xh.forEach(t),Uh.forEach(t),cg=l(Q),Vo=a(Q,"DIV",{class:!0});var Hh=s(Vo);m(Ea.$$.fragment,Hh),pg=l(Hh),kl=a(Hh,"P",{});var U2=s(kl);hg=i(U2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),U2.forEach(t),Hh.forEach(t),ug=l(Q),Qo=a(Q,"DIV",{class:!0});var Vh=s(Qo);m(Pa.$$.fragment,Vh),mg=l(Vh),bl=a(Vh,"P",{});var X2=s(bl);fg=i(X2,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),X2.forEach(t),Vh.forEach(t),Q.forEach(t),Wp=l(o),lo=a(o,"H2",{class:!0});var Qh=s(lo);Jo=a(Qh,"A",{id:!0,class:!0,href:!0});var H2=s(Jo);yl=a(H2,"SPAN",{});var V2=s(yl);m(Ca.$$.fragment,V2),V2.forEach(t),H2.forEach(t),_g=l(Qh),vl=a(Qh,"SPAN",{});var Q2=s(vl);gg=i(Q2,"MBart50TokenizerFast"),Q2.forEach(t),Qh.forEach(t),Rp=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);m(Sa.$$.fragment,fe),kg=l(fe),co=a(fe,"P",{});var Li=s(co);bg=i(Li,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=a(Li,"EM",{});var J2=s(Tl);yg=i(J2,"tokenizers"),J2.forEach(t),vg=i(Li,` library). Based on
`),Aa=a(Li,"A",{href:!0,rel:!0});var K2=s(Aa);Tg=i(K2,"BPE"),K2.forEach(t),Mg=i(Li,"."),Li.forEach(t),wg=l(fe),Oa=a(fe,"P",{});var Jh=s(Oa);xg=i(Jh,"This tokenizer inherits from "),ki=a(Jh,"A",{href:!0});var Z2=s(ki);zg=i(Z2,"PreTrainedTokenizerFast"),Z2.forEach(t),qg=i(Jh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Bg=l(fe),Ml=a(fe,"P",{});var Y2=s(Ml);$g=i(Y2,"Examples:"),Y2.forEach(t),Fg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Eg=l(St),wl=a(St,"P",{});var e1=s(wl);Pg=i(e1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),e1.forEach(t),Cg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var t1=s(xl);Ag=i(t1,"X"),t1.forEach(t),Og=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var o1=s(zl);Ng=i(o1,"input_ids"),o1.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var n1=s(ql);Lg=i(n1,"[src_lang_code] X [eos]"),n1.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Bl=a(eu,"CODE",{});var a1=s(Bl);Wg=i(a1,"labels"),a1.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var s1=s($l);Ug=i(s1,"[tgt_lang_code] X [eos]"),s1.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Fl=a(St,"P",{});var r1=s(Fl);Hg=i(r1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),r1.forEach(t),St.forEach(t),Vg=l(fe),Ko=a(fe,"DIV",{class:!0});var tu=s(Ko);m(Ra.$$.fragment,tu),Qg=l(tu),jl=a(tu,"P",{});var i1=s(jl);Jg=i(i1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),i1.forEach(t),tu.forEach(t),Kg=l(fe),Zo=a(fe,"DIV",{class:!0});var ou=s(Zo);m(Ua.$$.fragment,ou),Zg=l(ou),El=a(ou,"P",{});var d1=s(El);Yg=i(d1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),d1.forEach(t),ou.forEach(t),fe.forEach(t),Up=l(o),po=a(o,"H2",{class:!0});var nu=s(po);Yo=a(nu,"A",{id:!0,class:!0,href:!0});var l1=s(Yo);Pl=a(l1,"SPAN",{});var c1=s(Pl);m(Xa.$$.fragment,c1),c1.forEach(t),l1.forEach(t),ek=l(nu),Cl=a(nu,"SPAN",{});var p1=s(Cl);tk=i(p1,"MBartModel"),p1.forEach(t),nu.forEach(t),Xp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);m(Ha.$$.fragment,Bn),ok=l(Bn),Va=a(Bn,"P",{});var au=s(Va);nk=i(au,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),rk=l(Bn),Qa=a(Bn,"P",{});var su=s(Qa);ik=i(su,"This model is also a PyTorch "),Ja=a(su,"A",{href:!0,rel:!0});var u1=s(Ja);dk=i(u1,"torch.nn.Module"),u1.forEach(t),lk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Bn),Oe=a(Bn,"DIV",{class:!0});var At=s(Oe);m(Ka.$$.fragment,At),pk=l(At),ho=a(At,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var m1=s(yi);uk=i(m1,"MBartModel"),m1.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var f1=s(Sl);fk=i(f1,"__call__"),f1.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(At),m(en.$$.fragment,At),kk=l(At),Al=a(At,"P",{});var _1=s(Al);bk=i(_1,"Example:"),_1.forEach(t),yk=l(At),m(Za.$$.fragment,At),At.forEach(t),Bn.forEach(t),Hp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var g1=s(tn);Ol=a(g1,"SPAN",{});var k1=s(Ol);m(Ya.$$.fragment,k1),k1.forEach(t),g1.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var b1=s(Il);Tk=i(b1,"MBartForConditionalGeneration"),b1.forEach(t),ru.forEach(t),Vp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),Mk=l($n),ts=a($n,"P",{});var iu=s(ts);wk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),qk=l($n),os=a($n,"P",{});var du=s(os);Bk=i(du,"This model is also a PyTorch "),ns=a(du,"A",{href:!0,rel:!0});var v1=s(ns);$k=i(v1,"torch.nn.Module"),v1.forEach(t),Fk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ek=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Pk=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var T1=s(Ti);Ck=i(T1,"MBartForConditionalGeneration"),T1.forEach(t),Sk=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var M1=s(Nl);Ak=i(M1,"__call__"),M1.forEach(t),Ok=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var w1=s(Dl);Dk=i(w1,"Translation example:"),w1.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var x1=s(Ll);Wk=i(x1,"Mask filling example:"),x1.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Qp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var z1=s(nn);Gl=a(z1,"SPAN",{});var q1=s(Gl);m(is.$$.fragment,q1),q1.forEach(t),z1.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var B1=s(Wl);Xk=i(B1,"MBartForQuestionAnswering"),B1.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);m(ds.$$.fragment,Ot),Hk=l(Ot),_o=a(Ot,"P",{});var Ri=s(_o);Vk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $1=s(Rl);Qk=i($1,"span start logits"),$1.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var F1=s(Ul);Kk=i(F1,"span end logits"),F1.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(Ot),ls=a(Ot,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),Mi=a(cu,"A",{href:!0});var j1=s(Mi);tb=i(j1,"PreTrainedModel"),j1.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(Ot),cs=a(Ot,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var E1=s(ps);sb=i(E1,"torch.nn.Module"),E1.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(Ot),ue=a(Ot,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),wi=a(Ui,"A",{href:!0});var P1=s(wi);cb=i(P1,"MBartForQuestionAnswering"),P1.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var C1=s(Xl);hb=i(C1,"__call__"),C1.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Hl=a(at,"P",{});var S1=s(Hl);_b=i(S1,"Example:"),S1.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),Ot.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var A1=s(sn);Vl=a(A1,"SPAN",{});var O1=s(Vl);m(fs.$$.fragment,O1),O1.forEach(t),A1.forEach(t),bb=l(hu),Ql=a(hu,"SPAN",{});var I1=s(Ql);yb=i(I1,"MBartForSequenceClassification"),I1.forEach(t),hu.forEach(t),Zp=l(o),Fe=a(o,"DIV",{class:!0});var It=s(Fe);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var N1=s(Jl);Tb=i(N1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),N1.forEach(t),Mb=l(It),gs=a(It,"P",{});var uu=s(gs);wb=i(uu,"This model inherits from "),xi=a(uu,"A",{href:!0});var D1=s(xi);xb=i(D1,"PreTrainedModel"),D1.forEach(t),zb=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),qb=l(It),ks=a(It,"P",{});var mu=s(ks);Bb=i(mu,"This model is also a PyTorch "),bs=a(mu,"A",{href:!0,rel:!0});var L1=s(bs);$b=i(L1,"torch.nn.Module"),L1.forEach(t),Fb=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),jb=l(It),L=a(It,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Eb=l(oe),bo=a(oe,"P",{});var Xi=s(bo);Pb=i(Xi,"The "),zi=a(Xi,"A",{href:!0});var G1=s(zi);Cb=i(G1,"MBartForSequenceClassification"),G1.forEach(t),Sb=i(Xi," forward method, overrides the "),Kl=a(Xi,"CODE",{});var W1=s(Kl);Ab=i(W1,"__call__"),W1.forEach(t),Ob=i(Xi," special method."),Xi.forEach(t),Ib=l(oe),m(rn.$$.fragment,oe),Nb=l(oe),Zl=a(oe,"P",{});var R1=s(Zl);Db=i(R1,"Example of single-label classification:"),R1.forEach(t),Lb=l(oe),m(vs.$$.fragment,oe),Gb=l(oe),m(Ts.$$.fragment,oe),Wb=l(oe),Yl=a(oe,"P",{});var U1=s(Yl);Rb=i(U1,"Example of multi-label classification:"),U1.forEach(t),Ub=l(oe),m(Ms.$$.fragment,oe),Xb=l(oe),m(ws.$$.fragment,oe),oe.forEach(t),It.forEach(t),Yp=l(o),yo=a(o,"H2",{class:!0});var fu=s(yo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var X1=s(dn);ec=a(X1,"SPAN",{});var H1=s(ec);m(xs.$$.fragment,H1),H1.forEach(t),X1.forEach(t),Hb=l(fu),tc=a(fu,"SPAN",{});var V1=s(tc);Vb=i(V1,"MBartForCausalLM"),V1.forEach(t),fu.forEach(t),eh=l(o),vo=a(o,"DIV",{class:!0});var _u=s(vo);m(zs.$$.fragment,_u),Qb=l(_u),Mt=a(_u,"DIV",{class:!0});var Hi=s(Mt);m(qs.$$.fragment,Hi),Jb=l(Hi),oc=a(Hi,"P",{});var Q1=s(oc);Kb=i(Q1,"Example:"),Q1.forEach(t),Zb=l(Hi),m(Bs.$$.fragment,Hi),Hi.forEach(t),_u.forEach(t),th=l(o),To=a(o,"H2",{class:!0});var gu=s(To);ln=a(gu,"A",{id:!0,class:!0,href:!0});var J1=s(ln);nc=a(J1,"SPAN",{});var K1=s(nc);m($s.$$.fragment,K1),K1.forEach(t),J1.forEach(t),Yb=l(gu),ac=a(gu,"SPAN",{});var Z1=s(ac);ey=i(Z1,"TFMBartModel"),Z1.forEach(t),gu.forEach(t),oh=l(o),je=a(o,"DIV",{class:!0});var Nt=s(je);m(Fs.$$.fragment,Nt),ty=l(Nt),js=a(Nt,"P",{});var ku=s(js);oy=i(ku,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(ku,"A",{href:!0});var Y1=s(qi);ny=i(Y1,"TFPreTrainedModel"),Y1.forEach(t),ay=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
