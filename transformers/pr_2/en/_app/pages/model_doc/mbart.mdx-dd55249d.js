...
separator.`),e1.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);f(Ra.$$.fragment,Zh),Xg=l(Zh),Bl=a(Zh,"P",{});var t1=s(Bl);Hg=i(t1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),t1.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);f(Ua.$$.fragment,Yh),Qg=l(Yh),$l=a(Yh,"P",{});var o1=s($l);Jg=i(o1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),o1.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var n1=s(Yo);Fl=a(n1,"SPAN",{});var a1=s(Fl);f(Xa.$$.fragment,a1),a1.forEach(t),n1.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var s1=s(jl);Zg=i(s1,"MBartModel"),s1.forEach(t),eu.forEach(t),Wp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);f(Ha.$$.fragment,Bn),Yg=l(Bn),Va=a(Bn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Oi=s(ho);lk=i(Oi,"The "),gi=a(Oi,"A",{href:!0});var d1=s(gi);ck=i(d1,"MBartModel"),d1.forEach(t),pk=i(Oi," forward method, overrides the "),El=a(Oi,"CODE",{});var l1=s(El);hk=i(l1,"__call__"),l1.forEach(t),uk=i(Oi," special method."),Oi.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c1=s(Pl);_k=i(c1,"Example:"),c1.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p1=s(tn);Cl=a(p1,"SPAN",{});var h1=s(Cl);f(Ya.$$.fragment,h1),h1.forEach(t),p1.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u1=s(Sl);bk=i(u1,"MBartForConditionalGeneration"),u1.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l($n),os=a($n,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f1=s(ns);zk=i(f1,"torch.nn.Module"),f1.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Di=s(mo);Fk=i(Di,"The "),bi=a(Di,"A",{href:!0});var _1=s(bi);jk=i(_1,"MBartForConditionalGeneration"),_1.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g1=s(Al);Pk=i(g1,"__call__"),g1.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Il=a(Le,"P",{});var k1=s(Il);Ik=i(k1,"Translation example:"),k1.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Ok=l(Le),Nl=a(Le,"P",{});var b1=s(Nl);Dk=i(b1,"Mask filling example:"),b1.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var v1=s(nn);Ol=a(v1,"SPAN",{});var y1=s(Ol);f(is.$$.fragment,y1),y1.forEach(t),v1.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T1=s(Dl);Wk=i(T1,"MBartForQuestionAnswering"),T1.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M1=s(Ll);Xk=i(M1,"span start logits"),M1.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w1=s(Gl);Vk=i(w1,"span end logits"),w1.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),vi=a(iu,"A",{href:!0});var x1=s(vi);Zk=i(x1,"PreTrainedModel"),x1.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var It=s(Ae);f(hs.$$.fragment,It),sb=l(It),go=a(It,"P",{});var Gi=s(go);rb=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var q1=s(yi);ib=i(q1,"MBartForQuestionAnswering"),q1.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B1=s(Wl);lb=i(B1,"__call__"),B1.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(It),f(an.$$.fragment,It),hb=l(It),Rl=a(It,"P",{});var $1=s(Rl);ub=i($1,"Example:"),$1.forEach(t),mb=l(It),f(us.$$.fragment,It),It.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var F1=s(sn);Ul=a(F1,"SPAN",{});var j1=s(Ul);f(ms.$$.fragment,j1),j1.forEach(t),F1.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E1=s(Xl);_b=i(E1,"MBartForSequenceClassification"),E1.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var Nt=s(Be);f(fs.$$.fragment,Nt),gb=l(Nt),Hl=a(Nt,"P",{});var P1=s(Hl);kb=i(P1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P1.forEach(t),bb=l(Nt),_s=a(Nt,"P",{});var cu=s(_s);vb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var C1=s(Ti);yb=i(C1,"PreTrainedModel"),C1.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(Nt),gs=a(Nt,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S1=s(ks);xb=i(S1,"torch.nn.Module"),S1.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);$b=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A1=s(Mi);Fb=i(A1,"MBartForSequenceClassification"),A1.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var I1=s(Vl);Eb=i(I1,"__call__"),I1.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var N1=s(Ql);Ab=i(N1,"Example of single-label classification:"),N1.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var O1=s(Jl);Ob=i(O1,"Example of multi-label classification:"),O1.forEach(t),Db=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D1=s(dn);Kl=a(D1,"SPAN",{});var L1=s(Kl);f(Ts.$$.fragment,L1),L1.forEach(t),D1.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G1=s(Zl);Gb=i(G1,"MBartForCausalLM"),G1.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W1=s(Yl);Ub=i(W1,"Example:"),W1.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R1=s(ln);ec=a(R1,"SPAN",{});var U1=s(ec);f(zs.$$.fragment,U1),U1.forEach(t),R1.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X1=s(tc);Vb=i(X1,"TFMBartModel"),X1.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(qs.$$.fragment,Ot),Qb=l(Ot),Bs=a(Ot,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Ot),$s=a(Ot,"P",{});var _u=s($s);ev=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var V1=s(Fs);tv=i(V1,"tf.keras.Model"),V1.forEach(t),ov=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Ot),f(cn.$$.fragment,Ot),av=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sv=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q1=s(xi);iv=i(Q1,"TFMBartModel"),Q1.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J1=s(oc);lv=i(J1,"__call__"),J1.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Dt),f(pn.$$.fragment,Dt),hv=l(Dt),nc=a(Dt,"P",{});var K1=s(nc);uv=i(K1,"Example:"),K1.forEach(t),mv=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z1=s(hn);ac=a(Z1,"SPAN",{});var Y1=s(ac);f(Ps.$$.fragment,Y1),Y1.forEach(t),Z1.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_v=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
