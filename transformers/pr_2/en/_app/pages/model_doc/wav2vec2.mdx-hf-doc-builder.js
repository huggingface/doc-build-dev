...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1632",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1721"}}),un=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1766",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1888",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2006"}}),En=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2068",returnDescription:`
<p>A <a
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1392",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1465",returnDescription:`
<p>A <a
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1589",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/pr_2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1058"}}),cr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),Er=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1325",returnDescription:`
<p>A <a
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dp.forEach(t),R_=p(zt),Ke=s(zt,"DIV",{class:!0});var Da=n(Ke);y(Ln.$$.fragment,Da),H_=p(Da),io=s(Da,"P",{});var Ui=n(io);X_=i(Ui,"The "),ki=s(Ui,"A",{href:!0});var Zy=n(ki);G_=i(Zy,"Wav2Vec2ForPreTraining"),Zy.forEach(t),J_=i(Ui," forward method, overrides the "),ec=s(Ui,"CODE",{});var Ky=n(ec);Z_=i(Ky,"__call__"),Ky.forEach(t),K_=i(Ui," special method."),Ui.forEach(t),Q_=p(Da),y(pa.$$.fragment,Da),Y_=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),zt.forEach(t),Cd=p(o),lo=s(o,"H2",{class:!0});var Sp=n(lo);ha=s(Sp,"A",{id:!0,class:!0,href:!0});var Qy=n(ha);tc=s(Qy,"SPAN",{});var Yy=n(tc);y(Dn.$$.fragment,Yy),Yy.forEach(t),Qy.forEach(t),e2=p(Sp),oc=s(Sp,"SPAN",{});var ek=n(oc);t2=i(ek,"TFWav2Vec2Model"),ek.forEach(t),Sp.forEach(t),Ed=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Sn.$$.fragment,rt),o2=p(rt),ac=s(rt,"P",{});var tk=n(ac);a2=i(tk,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),tk.forEach(t),s2=p(rt),Nn=s(rt,"P",{});var Np=n(Nn);n2=i(Np,"This model inherits from "),Ti=s(Np,"A",{href:!0});var ok=n(Ti);r2=i(ok,"TFPreTrainedModel"),ok.forEach(t),i2=i(Np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np.forEach(t),l2=p(rt),In=s(rt,"P",{});var Ip=n(In);c2=i(Ip,"This model is also a "),Bn=s(Ip,"A",{href:!0,rel:!0});var ak=n(Bn);d2=i(ak,"tf.keras.Model"),ak.forEach(t),p2=i(Ip,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ip.forEach(t),m2=p(rt),y(fa.$$.fragment,rt),h2=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Un.$$.fragment,Sa),f2=p(Sa),co=s(Sa,"P",{});var Ri=n(co);u2=i(Ri,"The "),$i=s(Ri,"A",{href:!0});var sk=n($i);g2=i(sk,"TFWav2Vec2Model"),sk.forEach(t),_2=i(Ri," forward method, overrides the "),sc=s(Ri,"CODE",{});var nk=n(sc);v2=i(nk,"__call__"),nk.forEach(t),b2=i(Ri," special method."),Ri.forEach(t),w2=p(Sa),y(ua.$$.fragment,Sa),y2=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),Pd=p(o),po=s(o,"H2",{class:!0});var Bp=n(po);_a=s(Bp,"A",{id:!0,class:!0,href:!0});var rk=n(_a);nc=s(rk,"SPAN",{});var ik=n(nc);y(Rn.$$.fragment,ik),ik.forEach(t),rk.forEach(t),k2=p(Bp),rc=s(Bp,"SPAN",{});var lk=n(rc);T2=i(lk,"TFWav2Vec2ForCTC"),lk.forEach(t),Bp.forEach(t),qd=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Hn.$$.fragment,it),$2=p(it),Xn=s(it,"P",{});var Up=n(Xn);x2=i(Up,"TFWav2Vec2 Model with a "),ic=s(Up,"CODE",{});var ck=n(ic);W2=i(ck,"language modeling"),ck.forEach(t),V2=i(Up," head on top for Connectionist Temporal Classification (CTC)."),Up.forEach(t),j2=p(it),Gn=s(it,"P",{});var Rp=n(Gn);F2=i(Rp,"This model inherits from "),xi=s(Rp,"A",{href:!0});var dk=n(xi);C2=i(dk,"TFPreTrainedModel"),dk.forEach(t),E2=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),P2=p(it),Jn=s(it,"P",{});var Hp=n(Jn);q2=i(Hp,"This model is also a "),Zn=s(Hp,"A",{href:!0,rel:!0});var pk=n(Zn);z2=i(pk,"tf.keras.Model"),pk.forEach(t),M2=i(Hp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp.forEach(t),A2=p(it),y(va.$$.fragment,it),O2=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Kn.$$.fragment,Na),L2=p(Na),mo=s(Na,"P",{});var Hi=n(mo);D2=i(Hi,"The "),Wi=s(Hi,"A",{href:!0});var mk=n(Wi);S2=i(mk,"TFWav2Vec2ForCTC"),mk.forEach(t),N2=i(Hi," forward method, overrides the "),lc=s(Hi,"CODE",{});var hk=n(lc);I2=i(hk,"__call__"),hk.forEach(t),B2=i(Hi," special method."),Hi.forEach(t),U2=p(Na),y(ba.$$.fragment,Na),R2=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),zd=p(o),ho=s(o,"H2",{class:!0});var Xp=n(ho);ya=s(Xp,"A",{id:!0,class:!0,href:!0});var fk=n(ya);cc=s(fk,"SPAN",{});var uk=n(cc);y(Qn.$$.fragment,uk),uk.forEach(t),fk.forEach(t),H2=p(Xp),dc=s(Xp,"SPAN",{});var gk=n(dc);X2=i(gk,"FlaxWav2Vec2Model"),gk.forEach(t),Xp.forEach(t),Md=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(Yn.$$.fragment,Oe),G2=p(Oe),er=s(Oe,"P",{});var Gp=n(er);J2=i(Gp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),tr=s(Gp,"A",{href:!0,rel:!0});var _k=n(tr);Z2=i(_k,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),_k.forEach(t),K2=i(Gp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Gp.forEach(t),Q2=p(Oe),or=s(Oe,"P",{});var Jp=n(or);Y2=i(Jp,"This model inherits from "),Vi=s(Jp,"A",{href:!0});var vk=n(Vi);ev=i(vk,"FlaxPreTrainedModel"),vk.forEach(t),tv=i(Jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jp.forEach(t),ov=p(Oe),ar=s(Oe,"P",{});var Zp=n(ar);av=i(Zp,`This model is also a Flax Linen
`),sr=s(Zp,"A",{href:!0,rel:!0});var bk=n(sr);sv=i(bk,"flax.nn.Module"),bk.forEach(t),nv=i(Zp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Zp.forEach(t),rv=p(Oe),pc=s(Oe,"P",{});var wk=n(pc);iv=i(wk,"Finally, this model supports inherent JAX features such as:"),wk.forEach(t),lv=p(Oe),bt=s(Oe,"UL",{});var Ia=n(bt);mc=s(Ia,"LI",{});var yk=n(mc);nr=s(yk,"A",{href:!0,rel:!0});var kk=n(nr);cv=i(kk,"Just-In-Time (JIT) compilation"),kk.forEach(t),yk.forEach(t),dv=p(Ia),hc=s(Ia,"LI",{});var Tk=n(hc);rr=s(Tk,"A",{href:!0,rel:!0});var $k=n(rr);pv=i($k,"Automatic Differentiation"),$k.forEach(t),Tk.forEach(t),mv=p(Ia),fc=s(Ia,"LI",{});var xk=n(fc);ir=s(xk,"A",{href:!0,rel:!0});var Wk=n(ir);hv=i(Wk,"Vectorization"),Wk.forEach(t),xk.forEach(t),fv=p(Ia),uc=s(Ia,"LI",{});var Vk=n(uc);lr=s(Vk,"A",{href:!0,rel:!0});var jk=n(lr);uv=i(jk,"Parallelization"),jk.forEach(t),Vk.forEach(t),Ia.forEach(t),gv=p(Oe),et=s(Oe,"DIV",{class:!0});var Ba=n(et);y(cr.$$.fragment,Ba),_v=p(Ba),fo=s(Ba,"P",{});var Xi=n(fo);vv=i(Xi,"The "),gc=s(Xi,"CODE",{});var Fk=n(gc);bv=i(Fk,"FlaxWav2Vec2PreTrainedModel"),Fk.forEach(t),wv=i(Xi," forward method, overrides the "),_c=s(Xi,"CODE",{});var Ck=n(_c);yv=i(Ck,"__call__"),Ck.forEach(t),kv=i(Xi," special method."),Xi.forEach(t),Tv=p(Ba),y(ka.$$.fragment,Ba),$v=p(Ba),y(Ta.$$.fragment,Ba),Ba.forEach(t),Oe.forEach(t),Ad=p(o),uo=s(o,"H2",{class:!0});var Kp=n(uo);$a=s(Kp,"A",{id:!0,class:!0,href:!0});var Ek=n($a);vc=s(Ek,"SPAN",{});var Pk=n(vc);y(dr.$$.fragment,Pk),Pk.forEach(t),Ek.forEach(t),xv=p(Kp),bc=s(Kp,"SPAN",{});var qk=n(bc);Wv=i(qk,"FlaxWav2Vec2ForCTC"),qk.forEach(t),Kp.forEach(t),Od=p(o),Q=s(o,"DIV",{class:!0});var Le=n(Q);y(pr.$$.fragment,Le),Vv=p(Le),go=s(Le,"P",{});var Gi=n(go);jv=i(Gi,"Wav2Vec2 Model with a "),wc=s(Gi,"CODE",{});var zk=n(wc);Fv=i(zk,"language modeling"),zk.forEach(t),Cv=i(Gi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),mr=s(Gi,"A",{href:!0,rel:!0});var Mk=n(mr);Ev=i(Mk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Mk.forEach(t),Pv=i(Gi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Gi.forEach(t),qv=p(Le),hr=s(Le,"P",{});var Qp=n(hr);zv=i(Qp,"This model inherits from "),ji=s(Qp,"A",{href:!0});var Ak=n(ji);Mv=i(Ak,"FlaxPreTrainedModel"),Ak.forEach(t),Av=i(Qp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qp.forEach(t),Ov=p(Le),fr=s(Le,"P",{});var Yp=n(fr);Lv=i(Yp,`This model is also a Flax Linen
`),ur=s(Yp,"A",{href:!0,rel:!0});var Ok=n(ur);Dv=i(Ok,"flax.nn.Module"),Ok.forEach(t),Sv=i(Yp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Yp.forEach(t),Nv=p(Le),yc=s(Le,"P",{});var Lk=n(yc);Iv=i(Lk,"Finally, this model supports inherent JAX features such as:"),Lk.forEach(t),Bv=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);kc=s(Ua,"LI",{});var Dk=n(kc);gr=s(Dk,"A",{href:!0,rel:!0});var Sk=n(gr);Uv=i(Sk,"Just-In-Time (JIT) compilation"),Sk.forEach(t),Dk.forEach(t),Rv=p(Ua),Tc=s(Ua,"LI",{});var Nk=n(Tc);_r=s(Nk,"A",{href:!0,rel:!0});var Ik=n(_r);Hv=i(Ik,"Automatic Differentiation"),Ik.forEach(t),Nk.forEach(t),Xv=p(Ua),$c=s(Ua,"LI",{});var Bk=n($c);vr=s(Bk,"A",{href:!0,rel:!0});var Uk=n(vr);Gv=i(Uk,"Vectorization"),Uk.forEach(t),Bk.forEach(t),Jv=p(Ua),xc=s(Ua,"LI",{});var Rk=n(xc);br=s(Rk,"A",{href:!0,rel:!0});var Hk=n(br);Zv=i(Hk,"Parallelization"),Hk.forEach(t),Rk.forEach(t),Ua.forEach(t),Kv=p(Le),tt=s(Le,"DIV",{class:!0});var Ra=n(tt);y(wr.$$.fragment,Ra),Qv=p(Ra),_o=s(Ra,"P",{});var Ji=n(_o);Yv=i(Ji,"The "),Wc=s(Ji,"CODE",{});var Xk=n(Wc);eb=i(Xk,"FlaxWav2Vec2PreTrainedModel"),Xk.forEach(t),tb=i(Ji," forward method, overrides the "),Vc=s(Ji,"CODE",{});var Gk=n(Vc);ob=i(Gk,"__call__"),Gk.forEach(t),ab=i(Ji," special method."),Ji.forEach(t),sb=p(Ra),y(xa.$$.fragment,Ra),nb=p(Ra),y(Wa.$$.fragment,Ra),Ra.forEach(t),Le.forEach(t),Ld=p(o),vo=s(o,"H2",{class:!0});var em=n(vo);Va=s(em,"A",{id:!0,class:!0,href:!0});var Jk=n(Va);jc=s(Jk,"SPAN",{});var Zk=n(jc);y(yr.$$.fragment,Zk),Zk.forEach(t),Jk.forEach(t),rb=p(em),Fc=s(em,"SPAN",{});var Kk=n(Fc);ib=i(Kk,"FlaxWav2Vec2ForPreTraining"),Kk.forEach(t),em.forEach(t),Dd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(kr.$$.fragment,De),lb=p(De),bo=s(De,"P",{});var Zi=n(bo);cb=i(Zi,"Wav2Vec2 Model with a quantizer and "),Cc=s(Zi,"CODE",{});var Qk=n(Cc);db=i(Qk,"VQ"),Qk.forEach(t),pb=i(Zi,` head on top.
