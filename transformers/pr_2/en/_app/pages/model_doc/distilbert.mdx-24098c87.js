...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Vt=r(Je);$(Tr.$$.fragment,Vt),bg=h(Vt),fo=n(Vt,"P",{});var gl=r(fo);vg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var Yw=r(Ui);kg=i(Yw,"DistilBertForTokenClassification"),Yw.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var Zw=r(ad);$g=i(Zw,"__call__"),Zw.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Vt),$(fs.$$.fragment,Vt),Dg=h(Vt),$(ms.$$.fragment,Vt),Fg=h(Vt),$(gs.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),Up=h(o),mo=n(o,"H2",{class:!0});var Ah=r(mo);_s=n(Ah,"A",{id:!0,class:!0,href:!0});var e2=r(_s);id=n(e2,"SPAN",{});var t2=r(id);$($r.$$.fragment,t2),t2.forEach(t),e2.forEach(t),Bg=h(Ah),ld=n(Ah,"SPAN",{});var o2=r(ld);xg=i(o2,"DistilBertForQuestionAnswering"),o2.forEach(t),Ah.forEach(t),Hp=h(o),Ve=n(o,"DIV",{class:!0});var Kt=r(Ve);$(wr.$$.fragment,Kt),Mg=h(Kt),go=n(Kt,"P",{});var _l=r(go);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(_l,"CODE",{});var s2=r(dd);zg=i(s2,"span start logits"),s2.forEach(t),jg=i(_l," and "),cd=n(_l,"CODE",{});var n2=r(cd);Cg=i(n2,"span end logits"),n2.forEach(t),qg=i(_l,")."),_l.forEach(t),Pg=h(Kt),yr=n(Kt,"P",{});var Oh=r(yr);Ag=i(Oh,"This model inherits from "),Hi=n(Oh,"A",{href:!0});var r2=r(Hi);Og=i(r2,"PreTrainedModel"),r2.forEach(t),Ng=i(Oh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oh.forEach(t),Lg=h(Kt),Dr=n(Kt,"P",{});var Nh=r(Dr);Sg=i(Nh,"This model is also a PyTorch "),Fr=n(Nh,"A",{href:!0,rel:!0});var a2=r(Fr);Ig=i(a2,"torch.nn.Module"),a2.forEach(t),Wg=i(Nh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh.forEach(t),Qg=h(Kt),Ge=n(Kt,"DIV",{class:!0});var Jt=r(Ge);$(Br.$$.fragment,Jt),Rg=h(Jt),_o=n(Jt,"P",{});var bl=r(_o);Ug=i(bl,"The "),Vi=n(bl,"A",{href:!0});var i2=r(Vi);Hg=i(i2,"DistilBertForQuestionAnswering"),i2.forEach(t),Vg=i(bl," forward method, overrides the "),pd=n(bl,"CODE",{});var l2=r(pd);Kg=i(l2,"__call__"),l2.forEach(t),Jg=i(bl," special method."),bl.forEach(t),Gg=h(Jt),$(bs.$$.fragment,Jt),Xg=h(Jt),$(vs.$$.fragment,Jt),Yg=h(Jt),$(ks.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Vp=h(o),bo=n(o,"H2",{class:!0});var Lh=r(bo);Ts=n(Lh,"A",{id:!0,class:!0,href:!0});var d2=r(Ts);hd=n(d2,"SPAN",{});var c2=r(hd);$(xr.$$.fragment,c2),c2.forEach(t),d2.forEach(t),Zg=h(Lh),ud=n(Lh,"SPAN",{});var p2=r(ud);e_=i(p2,"TFDistilBertModel"),p2.forEach(t),Lh.forEach(t),Kp=h(o),Ae=n(o,"DIV",{class:!0});var $t=r(Ae);$(Mr.$$.fragment,$t),t_=h($t),fd=n($t,"P",{});var h2=r(fd);o_=i(h2,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),h2.forEach(t),s_=h($t),Er=n($t,"P",{});var Sh=r(Er);n_=i(Sh,"This model inherits from "),Ki=n(Sh,"A",{href:!0});var u2=r(Ki);r_=i(u2,"TFPreTrainedModel"),u2.forEach(t),a_=i(Sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),p_=h($t),$($s.$$.fragment,$t),h_=h($t),ft=n($t,"DIV",{class:!0});var bn=r(ft);$(Cr.$$.fragment,bn),u_=h(bn),vo=n(bn,"P",{});var vl=r(vo);f_=i(vl,"The "),Ji=n(vl,"A",{href:!0});var m2=r(Ji);m_=i(m2,"TFDistilBertModel"),m2.forEach(t),g_=i(vl," forward method, overrides the "),md=n(vl,"CODE",{});var g2=r(md);__=i(g2,"__call__"),g2.forEach(t),b_=i(vl," special method."),vl.forEach(t),v_=h(bn),$(ws.$$.fragment,bn),k_=h(bn),$(ys.$$.fragment,bn),bn.forEach(t),$t.forEach(t),Jp=h(o),ko=n(o,"H2",{class:!0});var Wh=r(ko);Ds=n(Wh,"A",{id:!0,class:!0,href:!0});var _2=r(Ds);gd=n(_2,"SPAN",{});var b2=r(gd);$(qr.$$.fragment,b2),b2.forEach(t),_2.forEach(t),T_=h(Wh),_d=n(Wh,"SPAN",{});var v2=r(_d);$_=i(v2,"TFDistilBertForMaskedLM"),v2.forEach(t),Wh.forEach(t),Gp=h(o),Oe=n(o,"DIV",{class:!0});var wt=r(Oe);$(Pr.$$.fragment,wt),w_=h(wt),Ar=n(wt,"P",{});var Qh=r(Ar);y_=i(Qh,"DistilBert Model with a "),bd=n(Qh,"CODE",{});var k2=r(bd);D_=i(k2,"masked language modeling"),k2.forEach(t),F_=i(Qh," head on top."),Qh.forEach(t),B_=h(wt),Or=n(wt,"P",{});var Rh=r(Or);x_=i(Rh,"This model inherits from "),Gi=n(Rh,"A",{href:!0});var T2=r(Gi);M_=i(T2,"TFPreTrainedModel"),T2.forEach(t),E_=i(Rh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),P_=h(wt),$(Fs.$$.fragment,wt),A_=h(wt),Xe=n(wt,"DIV",{class:!0});var Gt=r(Xe);$(Sr.$$.fragment,Gt),O_=h(Gt),To=n(Gt,"P",{});var kl=r(To);N_=i(kl,"The "),Xi=n(kl,"A",{href:!0});var w2=r(Xi);L_=i(w2,"TFDistilBertForMaskedLM"),w2.forEach(t),S_=i(kl," forward method, overrides the "),vd=n(kl,"CODE",{});var y2=r(vd);I_=i(y2,"__call__"),y2.forEach(t),W_=i(kl," special method."),kl.forEach(t),Q_=h(Gt),$(Bs.$$.fragment,Gt),R_=h(Gt),$(xs.$$.fragment,Gt),U_=h(Gt),$(Ms.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Xp=h(o),$o=n(o,"H2",{class:!0});var Hh=r($o);Es=n(Hh,"A",{id:!0,class:!0,href:!0});var D2=r(Es);kd=n(D2,"SPAN",{});var F2=r(kd);$(Ir.$$.fragment,F2),F2.forEach(t),D2.forEach(t),H_=h(Hh),Td=n(Hh,"SPAN",{});var B2=r(Td);V_=i(B2,"TFDistilBertForSequenceClassification"),B2.forEach(t),Hh.forEach(t),Yp=h(o),Ne=n(o,"DIV",{class:!0});var yt=r(Ne);$(Wr.$$.fragment,yt),K_=h(yt),$d=n(yt,"P",{});var x2=r($d);J_=i(x2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),x2.forEach(t),G_=h(yt),Qr=n(yt,"P",{});var Vh=r(Qr);X_=i(Vh,"This model inherits from "),Yi=n(Vh,"A",{href:!0});var M2=r(Yi);Y_=i(M2,"TFPreTrainedModel"),M2.forEach(t),Z_=i(Vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vh.forEach(t),eb=h(yt),Rr=n(yt,"P",{});var Kh=r(Rr);tb=i(Kh,"This model is also a "),Ur=n(Kh,"A",{href:!0,rel:!0});var E2=r(Ur);ob=i(E2,"tf.keras.Model"),E2.forEach(t),sb=i(Kh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kh.forEach(t),nb=h(yt),$(zs.$$.fragment,yt),rb=h(yt),Ye=n(yt,"DIV",{class:!0});var Xt=r(Ye);$(Hr.$$.fragment,Xt),ab=h(Xt),wo=n(Xt,"P",{});var Tl=r(wo);ib=i(Tl,"The "),Zi=n(Tl,"A",{href:!0});var z2=r(Zi);lb=i(z2,"TFDistilBertForSequenceClassification"),z2.forEach(t),db=i(Tl," forward method, overrides the "),wd=n(Tl,"CODE",{});var j2=r(wd);cb=i(j2,"__call__"),j2.forEach(t),pb=i(Tl," special method."),Tl.forEach(t),hb=h(Xt),$(js.$$.fragment,Xt),ub=h(Xt),$(Cs.$$.fragment,Xt),fb=h(Xt),$(qs.$$.fragment,Xt),Xt.forEach(t),yt.forEach(t),Zp=h(o),yo=n(o,"H2",{class:!0});var Jh=r(yo);Ps=n(Jh,"A",{id:!0,class:!0,href:!0});var C2=r(Ps);yd=n(C2,"SPAN",{});var q2=r(yd);$(Vr.$$.fragment,q2),q2.forEach(t),C2.forEach(t),mb=h(Jh),Dd=n(Jh,"SPAN",{});var P2=r(Dd);gb=i(P2,"TFDistilBertForMultipleChoice"),P2.forEach(t),Jh.forEach(t),eh=h(o),Le=n(o,"DIV",{class:!0});var Dt=r(Le);$(Kr.$$.fragment,Dt),_b=h(Dt),Fd=n(Dt,"P",{});var A2=r(Fd);bb=i(A2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),A2.forEach(t),vb=h(Dt),Jr=n(Dt,"P",{});var Gh=r(Jr);kb=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var O2=r(el);Tb=i(O2,"TFPreTrainedModel"),O2.forEach(t),$b=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),wb=h(Dt),Gr=n(Dt,"P",{});var Xh=r(Gr);yb=i(Xh,"This model is also a "),Xr=n(Xh,"A",{href:!0,rel:!0});var N2=r(Xr);Db=i(N2,"tf.keras.Model"),N2.forEach(t),Fb=i(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),Bb=h(Dt),$(As.$$.fragment,Dt),xb=h(Dt),mt=n(Dt,"DIV",{class:!0});var vn=r(mt);$(Yr.$$.fragment,vn),Mb=h(vn),Do=n(vn,"P",{});var $l=r(Do);Eb=i($l,"The "),tl=n($l,"A",{href:!0});var L2=r(tl);zb=i(L2,"TFDistilBertForMultipleChoice"),L2.forEach(t),jb=i($l," forward method, overrides the "),Bd=n($l,"CODE",{});var S2=r(Bd);Cb=i(S2,"__call__"),S2.forEach(t),qb=i($l," special method."),$l.forEach(t),Pb=h(vn),$(Os.$$.fragment,vn),Ab=h(vn),$(Ns.$$.fragment,vn),vn.forEach(t),Dt.forEach(t),th=h(o),Fo=n(o,"H2",{class:!0});var Yh=r(Fo);Ls=n(Yh,"A",{id:!0,class:!0,href:!0});var I2=r(Ls);xd=n(I2,"SPAN",{});var W2=r(xd);$(Zr.$$.fragment,W2),W2.forEach(t),I2.forEach(t),Ob=h(Yh),Md=n(Yh,"SPAN",{});var Q2=r(Md);Nb=i(Q2,"TFDistilBertForTokenClassification"),Q2.forEach(t),Yh.forEach(t),oh=h(o),Se=n(o,"DIV",{class:!0});var Ft=r(Se);$(ea.$$.fragment,Ft),Lb=h(Ft),Ed=n(Ft,"P",{});var R2=r(Ed);Sb=i(R2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R2.forEach(t),Ib=h(Ft),ta=n(Ft,"P",{});var Zh=r(ta);Wb=i(Zh,"This model inherits from "),ol=n(Zh,"A",{href:!0});var U2=r(ol);Qb=i(U2,"TFPreTrainedModel"),U2.forEach(t),Rb=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Ub=h(Ft),oa=n(Ft,"P",{});var eu=r(oa);Hb=i(eu,"This model is also a "),sa=n(eu,"A",{href:!0,rel:!0});var H2=r(sa);Vb=i(H2,"tf.keras.Model"),H2.forEach(t),Kb=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Ft),$(Ss.$$.fragment,Ft),Gb=h(Ft),Ze=n(Ft,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Bo=n(Yt,"P",{});var wl=r(Bo);Yb=i(wl,"The "),sl=n(wl,"A",{href:!0});var V2=r(sl);Zb=i(V2,"TFDistilBertForTokenClassification"),V2.forEach(t),ev=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var K2=r(zd);tv=i(K2,"__call__"),K2.forEach(t),ov=i(wl," special method."),wl.forEach(t),sv=h(Yt),$(Is.$$.fragment,Yt),nv=h(Yt),$(Ws.$$.fragment,Yt),rv=h(Yt),$(Qs.$$.fragment,Yt),Yt.forEach(t),Ft.forEach(t),sh=h(o),xo=n(o,"H2",{class:!0});var tu=r(xo);Rs=n(tu,"A",{id:!0,class:!0,href:!0});var J2=r(Rs);jd=n(J2,"SPAN",{});var G2=r(jd);$(ra.$$.fragment,G2),G2.forEach(t),J2.forEach(t),av=h(tu),Cd=n(tu,"SPAN",{});var X2=r(Cd);iv=i(X2,"TFDistilBertForQuestionAnswering"),X2.forEach(t),tu.forEach(t),nh=h(o),Ie=n(o,"DIV",{class:!0});var Bt=r(Ie);$(aa.$$.fragment,Bt),lv=h(Bt),Mo=n(Bt,"P",{});var yl=r(Mo);dv=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y2=r(qd);cv=i(Y2,"span start logits"),Y2.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Z2=r(Pd);hv=i(Z2,"span end logits"),Z2.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(Bt),ia=n(Bt,"P",{});var ou=r(ia);mv=i(ou,"This model inherits from "),nl=n(ou,"A",{href:!0});var ey=r(nl);gv=i(ey,"TFPreTrainedModel"),ey.forEach(t),_v=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tT=h(nt),ac=n(nt,"P",{});var Ry=r(ac);oT=i(Ry,"Finally, this model supports inherent JAX features such as:"),Ry.forEach(t),sT=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uy=r(ic);Oa=n(Uy,"A",{href:!0,rel:!0});var Hy=r(Oa);nT=i(Hy,"Just-In-Time (JIT) compilation"),Hy.forEach(t),Uy.forEach(t),rT=h(yn),lc=n(yn,"LI",{});var Vy=r(lc);Na=n(Vy,"A",{href:!0,rel:!0});var Ky=r(Na);aT=i(Ky,"Automatic Differentiation"),Ky.forEach(t),Vy.forEach(t),iT=h(yn),dc=n(yn,"LI",{});var Jy=r(dc);La=n(Jy,"A",{href:!0,rel:!0});var Gy=r(La);lT=i(Gy,"Vectorization"),Gy.forEach(t),Jy.forEach(t),dT=h(yn),cc=n(yn,"LI",{});var Xy=r(cc);Sa=n(Xy,"A",{href:!0,rel:!0});var Yy=r(Sa);cT=i(Yy,"Parallelization"),Yy.forEach(t),Xy.forEach(t),yn.forEach(t),pT=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),hT=h(Dn),Ao=n(Dn,"P",{});var xl=r(Ao);uT=i(xl,"The "),pc=n(xl,"CODE",{});var Zy=r(pc);fT=i(Zy,"FlaxDistilBertPreTrainedModel"),Zy.forEach(t),mT=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var e1=r(hc);gT=i(e1,"__call__"),e1.forEach(t),_T=i(xl," special method."),xl.forEach(t),bT=h(Dn),$(on.$$.fragment,Dn),vT=h(Dn),$(sn.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(o),Oo=n(o,"H2",{class:!0});var fu=r(Oo);nn=n(fu,"A",{id:!0,class:!0,href:!0});var t1=r(nn);uc=n(t1,"SPAN",{});var o1=r(uc);$(Wa.$$.fragment,o1),o1.forEach(t),t1.forEach(t),kT=h(fu),fc=n(fu,"SPAN",{});var s1=r(fc);TT=i(s1,"FlaxDistilBertForMultipleChoice"),s1.forEach(t),fu.forEach(t),hh=h(o),je=n(o,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$T=h(rt),mc=n(rt,"P",{});var n1=r(mc);wT=i(n1,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),n1.forEach(t),yT=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);DT=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var r1=r(dl);FT=i(r1,"FlaxPreTrainedModel"),r1.forEach(t),BT=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),xT=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);MT=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var a1=r(Ha);ET=i(a1,"flax.linen.Module"),a1.forEach(t),zT=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jT=h(rt),gc=n(rt,"P",{});var i1=r(gc);CT=i(i1,"Finally, this model supports inherent JAX features such as:"),i1.forEach(t),qT=h(rt),jt=n(rt,"UL",{});var Fn=r(jt);_c=n(Fn,"LI",{});var l1=r(_c);Va=n(l1,"A",{href:!0,rel:!0});var d1=r(Va);PT=i(d1,"Just-In-Time (JIT) compilation"),d1.forEach(t),l1.forEach(t),AT=h(Fn),bc=n(Fn,"LI",{});var c1=r(bc);Ka=n(c1,"A",{href:!0,rel:!0});var p1=r(Ka);OT=i(p1,"Automatic Differentiation"),p1.forEach(t),c1.forEach(t),NT=h(Fn),vc=n(Fn,"LI",{});var h1=r(vc);Ja=n(h1,"A",{href:!0,rel:!0});var u1=r(Ja);LT=i(u1,"Vectorization"),u1.forEach(t),h1.forEach(t),ST=h(Fn),kc=n(Fn,"LI",{});var f1=r(kc);Ga=n(f1,"A",{href:!0,rel:!0});var m1=r(Ga);IT=i(m1,"Parallelization"),m1.forEach(t),f1.forEach(t),Fn.forEach(t),WT=h(rt),vt=n(rt,"DIV",{class:!0});var Bn=r(vt);$(Xa.$$.fragment,Bn),QT=h(Bn),No=n(Bn,"P",{});var Ml=r(No);RT=i(Ml,"The "),Tc=n(Ml,"CODE",{});var g1=r(Tc);UT=i(g1,"FlaxDistilBertPreTrainedModel"),g1.forEach(t),HT=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _1=r($c);VT=i(_1,"__call__"),_1.forEach(t),KT=i(Ml," special method."),Ml.forEach(t),JT=h(Bn),$(rn.$$.fragment,Bn),GT=h(Bn),$(an.$$.fragment,Bn),Bn.forEach(t),rt.forEach(t),uh=h(o),Lo=n(o,"H2",{class:!0});var _u=r(Lo);ln=n(_u,"A",{id:!0,class:!0,href:!0});var b1=r(ln);wc=n(b1,"SPAN",{});var v1=r(wc);$(Ya.$$.fragment,v1),v1.forEach(t),b1.forEach(t),XT=h(_u),yc=n(_u,"SPAN",{});var k1=r(yc);YT=i(k1,"FlaxDistilBertForTokenClassification"),k1.forEach(t),_u.forEach(t),fh=h(o),Ce=n(o,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),ZT=h(at),Dc=n(at,"P",{});var T1=r(Dc);e$=i(T1,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),T1.forEach(t),t$=h(at),ei=n(at,"P",{});var bu=r(ei);o$=i(bu,"This model inherits from "),cl=n(bu,"A",{href:!0});var $1=r(cl);s$=i($1,"FlaxPreTrainedModel"),$1.forEach(t),n$=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),bu.forEach(t),r$=h(at),ti=n(at,"P",{});var vu=r(ti);a$=i(vu,"This model is also a Flax Linen "),oi=n(vu,"A",{href:!0,rel:!0});var w1=r(oi);i$=i(w1,"flax.linen.Module"),w1.forEach(t),l$=i(vu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),vu.forEach(t),d$=h(at),Fc=n(at,"P",{});var y1=r(Fc);c$=i(y1,"Finally, this model supports inherent JAX features such as:"),y1.forEach(t),p$=h(at),Ct=n(at,"UL",{});var xn=r(Ct);Bc=n(xn,"LI",{});var D1=r(Bc);si=n(D1,"A",{href:!0,rel:!0});var F1=r(si);h$=i(F1,"Just-In-Time (JIT) compilation"),F1.forEach(t),D1.forEach(t),u$=h(xn),xc=n(xn,"LI",{});var B1=r(xc);ni=n(B1,"A",{href:!0,rel:!0});var x1=r(ni);f$=i(x1,"Automatic Differentiation"),x1.forEach(t),B1.forEach(t),m$=h(xn),Mc=n(xn,"LI",{});var M1=r(Mc);ri=n(M1,"A",{href:!0,rel:!0});var E1=r(ri);g$=i(E1,"Vectorization"),E1.forEach(t),M1.forEach(t),_$=h(xn),Ec=n(xn,"LI",{});var z1=r(Ec);ai=n(z1,"A",{href:!0,rel:!0});var j1=r(ai);b$=i(j1,"Parallelization"),j1.forEach(t),z1.forEach(t),xn.forEach(t),v$=h(at),kt=n(at,"DIV",{class:!0});var Mn=r(kt);$(ii.$$.fragment,Mn),k$=h(Mn),So=n(Mn,"P",{});var El=r(So);T$=i(El,"The "),zc=n(El,"CODE",{});var C1=r(zc);$$=i(C1,"FlaxDistilBertPreTrainedModel"),C1.forEach(t),w$=i(El," forward method, overrides the "),jc=n(El,"CODE",{});var q1=r(jc);y$=i(q1,"__call__"),q1.forEach(t),D$=i(El," special method."),El.forEach(t),F$=h(Mn),$(dn.$$.fragment,Mn),B$=h(Mn),$(cn.$$.fragment,Mn),Mn.forEach(t),at.forEach(t),mh=h(o),Io=n(o,"H2",{class:!0});var ku=r(Io);pn=n(ku,"A",{id:!0,class:!0,href:!0});var P1=r(pn);Cc=n(P1,"SPAN",{});var A1=r(Cc);$(li.$$.fragment,A1),A1.forEach(t),P1.forEach(t),x$=h(ku),qc=n(ku,"SPAN",{});var O1=r(qc);M$=i(O1,"FlaxDistilBertForQuestionAnswering"),O1.forEach(t),ku.forEach(t),gh=h(o),qe=n(o,"DIV",{class:!0});var it=r(qe);$(di.$$.fragment,it),E$=h(it),Wo=n(it,"P",{});var zl=r(Wo);z$=i(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
