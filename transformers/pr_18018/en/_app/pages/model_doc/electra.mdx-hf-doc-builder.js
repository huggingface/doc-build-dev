...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L805"}}),Ka=new we({}),Ja=new I({props:{name:"class transformers.ElectraModel",anchor:"transformers.ElectraModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18018/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L923"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18018/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L1078"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18018/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L1576"}}),rl=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForCausalLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18018/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L1012"}}),_l=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18018/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
`),Hi=s(xg,"A",{href:!0,rel:!0});var n8=a(Hi);mw=i(n8,"flax.nn.Module"),n8.forEach(t),uw=i(xg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),fw=p(Ye),Eh=s(Ye,"P",{});var s8=a(Eh);gw=i(s8,"Finally, this model supports inherent JAX features such as:"),s8.forEach(t),_w=p(Ye),Jt=s(Ye,"UL",{});var va=a(Jt);wh=s(va,"LI",{});var a8=a(wh);Qi=s(a8,"A",{href:!0,rel:!0});var r8=a(Qi);kw=i(r8,"Just-In-Time (JIT) compilation"),r8.forEach(t),a8.forEach(t),vw=p(va),$h=s(va,"LI",{});var i8=a($h);Vi=s(i8,"A",{href:!0,rel:!0});var l8=a(Vi);Tw=i(l8,"Automatic Differentiation"),l8.forEach(t),i8.forEach(t),bw=p(va),Fh=s(va,"LI",{});var d8=a(Fh);Ki=s(d8,"A",{href:!0,rel:!0});var c8=a(Ki);yw=i(c8,"Vectorization"),c8.forEach(t),d8.forEach(t),Ew=p(va),xh=s(va,"LI",{});var p8=a(xh);Ji=s(p8,"A",{href:!0,rel:!0});var h8=a(Ji);ww=i(h8,"Parallelization"),h8.forEach(t),p8.forEach(t),va.forEach(t),$w=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),Fw=p(Ta),ln=s(Ta,"P",{});var Cc=a(ln);xw=i(Cc,"The "),Mh=s(Cc,"CODE",{});var m8=a(Mh);Mw=i(m8,"FlaxElectraPreTrainedModel"),m8.forEach(t),zw=i(Cc," forward method, overrides the "),zh=s(Cc,"CODE",{});var u8=a(zh);jw=i(u8,"__call__"),u8.forEach(t),Cw=i(Cc," special method."),Cc.forEach(t),qw=p(Ta),y(Us.$$.fragment,Ta),Pw=p(Ta),y(Bs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Rs=s(Mg,"A",{id:!0,class:!0,href:!0});var f8=a(Rs);jh=s(f8,"SPAN",{});var g8=a(jh);y(Xi.$$.fragment,g8),g8.forEach(t),f8.forEach(t),Aw=p(Mg),Ch=s(Mg,"SPAN",{});var _8=a(Ch);Ow=i(_8,"FlaxElectraForCausalLM"),_8.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),Lw=p(_t),qh=s(_t,"P",{});var k8=a(qh);Nw=i(k8,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),k8.forEach(t),Iw=p(_t),Zi=s(_t,"P",{});var zg=a(Zi);Dw=i(zg,"This model inherits from "),ic=s(zg,"A",{href:!0});var v8=a(ic);Sw=i(v8,"FlaxPreTrainedModel"),v8.forEach(t),Ww=i(zg,`. Check the superclass documentation for the generic methods the
...
`),tl=s(jg,"A",{href:!0,rel:!0});var T8=a(tl);Rw=i(T8,"flax.nn.Module"),T8.forEach(t),Hw=i(jg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jg.forEach(t),Qw=p(_t),Ph=s(_t,"P",{});var b8=a(Ph);Vw=i(b8,"Finally, this model supports inherent JAX features such as:"),b8.forEach(t),Kw=p(_t),Gt=s(_t,"UL",{});var ba=a(Gt);Ah=s(ba,"LI",{});var y8=a(Ah);ol=s(y8,"A",{href:!0,rel:!0});var E8=a(ol);Jw=i(E8,"Just-In-Time (JIT) compilation"),E8.forEach(t),y8.forEach(t),Gw=p(ba),Oh=s(ba,"LI",{});var w8=a(Oh);nl=s(w8,"A",{href:!0,rel:!0});var $8=a(nl);Xw=i($8,"Automatic Differentiation"),$8.forEach(t),w8.forEach(t),Yw=p(ba),Lh=s(ba,"LI",{});var F8=a(Lh);sl=s(F8,"A",{href:!0,rel:!0});var x8=a(sl);Zw=i(x8,"Vectorization"),x8.forEach(t),F8.forEach(t),e$=p(ba),Nh=s(ba,"LI",{});var M8=a(Nh);al=s(M8,"A",{href:!0,rel:!0});var z8=a(al);t$=i(z8,"Parallelization"),z8.forEach(t),M8.forEach(t),ba.forEach(t),o$=p(_t),At=s(_t,"DIV",{class:!0});var ya=a(At);y(rl.$$.fragment,ya),n$=p(ya),cn=s(ya,"P",{});var qc=a(cn);s$=i(qc,"The "),Ih=s(qc,"CODE",{});var j8=a(Ih);a$=i(j8,"FlaxElectraPreTrainedModel"),j8.forEach(t),r$=i(qc," forward method, overrides the "),Dh=s(qc,"CODE",{});var C8=a(Dh);i$=i(C8,"__call__"),C8.forEach(t),l$=i(qc," special method."),qc.forEach(t),d$=p(ya),y(Hs.$$.fragment,ya),c$=p(ya),y(Qs.$$.fragment,ya),ya.forEach(t),_t.forEach(t),_f=p(o),pn=s(o,"H2",{class:!0});var Cg=a(pn);Vs=s(Cg,"A",{id:!0,class:!0,href:!0});var q8=a(Vs);Sh=s(q8,"SPAN",{});var P8=a(Sh);y(il.$$.fragment,P8),P8.forEach(t),q8.forEach(t),p$=p(Cg),Wh=s(Cg,"SPAN",{});var A8=a(Wh);h$=i(A8,"FlaxElectraForMaskedLM"),A8.forEach(t),Cg.forEach(t),kf=p(o),Se=s(o,"DIV",{class:!0});var kt=a(Se);y(ll.$$.fragment,kt),m$=p(kt),dl=s(kt,"P",{});var qg=a(dl);u$=i(qg,"Electra Model with a "),Uh=s(qg,"CODE",{});var O8=a(Uh);f$=i(O8,"language modeling"),O8.forEach(t),g$=i(qg," head on top."),qg.forEach(t),_$=p(kt),cl=s(kt,"P",{});var Pg=a(cl);k$=i(Pg,"This model inherits from "),lc=s(Pg,"A",{href:!0});var L8=a(lc);v$=i(L8,"FlaxPreTrainedModel"),L8.forEach(t),T$=i(Pg,`. Check the superclass documentation for the generic methods the
...
`),hl=s(Ag,"A",{href:!0,rel:!0});var N8=a(hl);E$=i(N8,"flax.nn.Module"),N8.forEach(t),w$=i(Ag,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$$=p(kt),Bh=s(kt,"P",{});var I8=a(Bh);F$=i(I8,"Finally, this model supports inherent JAX features such as:"),I8.forEach(t),x$=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Rh=s(Ea,"LI",{});var D8=a(Rh);ml=s(D8,"A",{href:!0,rel:!0});var S8=a(ml);M$=i(S8,"Just-In-Time (JIT) compilation"),S8.forEach(t),D8.forEach(t),z$=p(Ea),Hh=s(Ea,"LI",{});var W8=a(Hh);ul=s(W8,"A",{href:!0,rel:!0});var U8=a(ul);j$=i(U8,"Automatic Differentiation"),U8.forEach(t),W8.forEach(t),C$=p(Ea),Qh=s(Ea,"LI",{});var B8=a(Qh);fl=s(B8,"A",{href:!0,rel:!0});var R8=a(fl);q$=i(R8,"Vectorization"),R8.forEach(t),B8.forEach(t),P$=p(Ea),Vh=s(Ea,"LI",{});var H8=a(Vh);gl=s(H8,"A",{href:!0,rel:!0});var Q8=a(gl);A$=i(Q8,"Parallelization"),Q8.forEach(t),H8.forEach(t),Ea.forEach(t),O$=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L$=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N$=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V8=a(Kh);I$=i(V8,"FlaxElectraPreTrainedModel"),V8.forEach(t),D$=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K8=a(Jh);S$=i(K8,"__call__"),K8.forEach(t),W$=i(Pc," special method."),Pc.forEach(t),U$=p(wa),y(Ks.$$.fragment,wa),B$=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J8=a(Gs);Gh=s(J8,"SPAN",{});var G8=a(Gh);y(kl.$$.fragment,G8),G8.forEach(t),J8.forEach(t),R$=p(Og),Xh=s(Og,"SPAN",{});var X8=a(Xh);H$=i(X8,"FlaxElectraForSequenceClassification"),X8.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q$=p(vt),Yh=s(vt,"P",{});var Y8=a(Yh);V$=i(Y8,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Y8.forEach(t),K$=p(vt),Tl=s(vt,"P",{});var Lg=a(Tl);J$=i(Lg,"This model inherits from "),dc=s(Lg,"A",{href:!0});var Z8=a(dc);G$=i(Z8,"FlaxPreTrainedModel"),Z8.forEach(t),X$=i(Lg,`. Check the superclass documentation for the generic methods the
...
`),yl=s(Ng,"A",{href:!0,rel:!0});var ez=a(yl);e0=i(ez,"flax.nn.Module"),ez.forEach(t),t0=i(Ng,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ng.forEach(t),o0=p(vt),Zh=s(vt,"P",{});var tz=a(Zh);n0=i(tz,"Finally, this model supports inherent JAX features such as:"),tz.forEach(t),s0=p(vt),Yt=s(vt,"UL",{});var $a=a(Yt);em=s($a,"LI",{});var oz=a(em);El=s(oz,"A",{href:!0,rel:!0});var nz=a(El);a0=i(nz,"Just-In-Time (JIT) compilation"),nz.forEach(t),oz.forEach(t),r0=p($a),tm=s($a,"LI",{});var sz=a(tm);wl=s(sz,"A",{href:!0,rel:!0});var az=a(wl);i0=i(az,"Automatic Differentiation"),az.forEach(t),sz.forEach(t),l0=p($a),om=s($a,"LI",{});var rz=a(om);$l=s(rz,"A",{href:!0,rel:!0});var iz=a($l);d0=i(iz,"Vectorization"),iz.forEach(t),rz.forEach(t),c0=p($a),nm=s($a,"LI",{});var lz=a(nm);Fl=s(lz,"A",{href:!0,rel:!0});var dz=a(Fl);p0=i(dz,"Parallelization"),dz.forEach(t),lz.forEach(t),$a.forEach(t),h0=p(vt),Lt=s(vt,"DIV",{class:!0});var Fa=a(Lt);y(xl.$$.fragment,Fa),m0=p(Fa),un=s(Fa,"P",{});var Ac=a(un);u0=i(Ac,"The "),sm=s(Ac,"CODE",{});var cz=a(sm);f0=i(cz,"FlaxElectraPreTrainedModel"),cz.forEach(t),g0=i(Ac," forward method, overrides the "),am=s(Ac,"CODE",{});var pz=a(am);_0=i(pz,"__call__"),pz.forEach(t),k0=i(Ac," special method."),Ac.forEach(t),v0=p(Fa),y(Xs.$$.fragment,Fa),T0=p(Fa),y(Ys.$$.fragment,Fa),Fa.forEach(t),vt.forEach(t),bf=p(o),fn=s(o,"H2",{class:!0});var Ig=a(fn);Zs=s(Ig,"A",{id:!0,class:!0,href:!0});var hz=a(Zs);rm=s(hz,"SPAN",{});var mz=a(rm);y(Ml.$$.fragment,mz),mz.forEach(t),hz.forEach(t),b0=p(Ig),im=s(Ig,"SPAN",{});var uz=a(im);y0=i(uz,"FlaxElectraForMultipleChoice"),uz.forEach(t),Ig.forEach(t),yf=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(zl.$$.fragment,Tt),E0=p(Tt),lm=s(Tt,"P",{});var fz=a(lm);w0=i(fz,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),fz.forEach(t),$0=p(Tt),jl=s(Tt,"P",{});var Dg=a(jl);F0=i(Dg,"This model inherits from "),cc=s(Dg,"A",{href:!0});var gz=a(cc);x0=i(gz,"FlaxPreTrainedModel"),gz.forEach(t),M0=i(Dg,`. Check the superclass documentation for the generic methods the
...
`),ql=s(Sg,"A",{href:!0,rel:!0});var _z=a(ql);C0=i(_z,"flax.nn.Module"),_z.forEach(t),q0=i(Sg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sg.forEach(t),P0=p(Tt),dm=s(Tt,"P",{});var kz=a(dm);A0=i(kz,"Finally, this model supports inherent JAX features such as:"),kz.forEach(t),O0=p(Tt),Zt=s(Tt,"UL",{});var xa=a(Zt);cm=s(xa,"LI",{});var vz=a(cm);Pl=s(vz,"A",{href:!0,rel:!0});var Tz=a(Pl);L0=i(Tz,"Just-In-Time (JIT) compilation"),Tz.forEach(t),vz.forEach(t),N0=p(xa),pm=s(xa,"LI",{});var bz=a(pm);Al=s(bz,"A",{href:!0,rel:!0});var yz=a(Al);I0=i(yz,"Automatic Differentiation"),yz.forEach(t),bz.forEach(t),D0=p(xa),hm=s(xa,"LI",{});var Ez=a(hm);Ol=s(Ez,"A",{href:!0,rel:!0});var wz=a(Ol);S0=i(wz,"Vectorization"),wz.forEach(t),Ez.forEach(t),W0=p(xa),mm=s(xa,"LI",{});var $z=a(mm);Ll=s($z,"A",{href:!0,rel:!0});var Fz=a(Ll);U0=i(Fz,"Parallelization"),Fz.forEach(t),$z.forEach(t),xa.forEach(t),B0=p(Tt),Nt=s(Tt,"DIV",{class:!0});var Ma=a(Nt);y(Nl.$$.fragment,Ma),R0=p(Ma),gn=s(Ma,"P",{});var Oc=a(gn);H0=i(Oc,"The "),um=s(Oc,"CODE",{});var xz=a(um);Q0=i(xz,"FlaxElectraPreTrainedModel"),xz.forEach(t),V0=i(Oc," forward method, overrides the "),fm=s(Oc,"CODE",{});var Mz=a(fm);K0=i(Mz,"__call__"),Mz.forEach(t),J0=i(Oc," special method."),Oc.forEach(t),G0=p(Ma),y(ea.$$.fragment,Ma),X0=p(Ma),y(ta.$$.fragment,Ma),Ma.forEach(t),Tt.forEach(t),Ef=p(o),_n=s(o,"H2",{class:!0});var Wg=a(_n);oa=s(Wg,"A",{id:!0,class:!0,href:!0});var zz=a(oa);gm=s(zz,"SPAN",{});var jz=a(gm);y(Il.$$.fragment,jz),jz.forEach(t),zz.forEach(t),Y0=p(Wg),_m=s(Wg,"SPAN",{});var Cz=a(_m);Z0=i(Cz,"FlaxElectraForTokenClassification"),Cz.forEach(t),Wg.forEach(t),wf=p(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);y(Dl.$$.fragment,Ze),e2=p(Ze),km=s(Ze,"P",{});var qz=a(km);t2=i(qz,"Electra model with a token classification head on top."),qz.forEach(t),o2=p(Ze),vm=s(Ze,"P",{});var Pz=a(vm);n2=i(Pz,"Both the discriminator and generator may be loaded into this model."),Pz.forEach(t),s2=p(Ze),Sl=s(Ze,"P",{});var Ug=a(Sl);a2=i(Ug,"This model inherits from "),pc=s(Ug,"A",{href:!0});var Az=a(pc);r2=i(Az,"FlaxPreTrainedModel"),Az.forEach(t),i2=i(Ug,`. Check the superclass documentation for the generic methods the
...
`),Ul=s(Bg,"A",{href:!0,rel:!0});var Oz=a(Ul);c2=i(Oz,"flax.nn.Module"),Oz.forEach(t),p2=i(Bg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bg.forEach(t),h2=p(Ze),Tm=s(Ze,"P",{});var Lz=a(Tm);m2=i(Lz,"Finally, this model supports inherent JAX features such as:"),Lz.forEach(t),u2=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var Nz=a(bm);Bl=s(Nz,"A",{href:!0,rel:!0});var Iz=a(Bl);f2=i(Iz,"Just-In-Time (JIT) compilation"),Iz.forEach(t),Nz.forEach(t),g2=p(za),ym=s(za,"LI",{});var Dz=a(ym);Rl=s(Dz,"A",{href:!0,rel:!0});var Sz=a(Rl);_2=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Dz.forEach(t),k2=p(za),Em=s(za,"LI",{});var Wz=a(Em);Hl=s(Wz,"A",{href:!0,rel:!0});var Uz=a(Hl);v2=i(Uz,"Vectorization"),Uz.forEach(t),Wz.forEach(t),T2=p(za),wm=s(za,"LI",{});var Bz=a(wm);Ql=s(Bz,"A",{href:!0,rel:!0});var Rz=a(Ql);b2=i(Rz,"Parallelization"),Rz.forEach(t),Bz.forEach(t),za.forEach(t),y2=p(Ze),It=s(Ze,"DIV",{class:!0});var ja=a(It);y(Vl.$$.fragment,ja),E2=p(ja),kn=s(ja,"P",{});var Lc=a(kn);w2=i(Lc,"The "),$m=s(Lc,"CODE",{});var Hz=a($m);$2=i(Hz,"FlaxElectraPreTrainedModel"),Hz.forEach(t),F2=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var Qz=a(Fm);x2=i(Qz,"__call__"),Qz.forEach(t),M2=i(Lc," special method."),Lc.forEach(t),z2=p(ja),y(na.$$.fragment,ja),j2=p(ja),y(sa.$$.fragment,ja),ja.forEach(t),Ze.forEach(t),$f=p(o),vn=s(o,"H2",{class:!0});var Rg=a(vn);aa=s(Rg,"A",{id:!0,class:!0,href:!0});var Vz=a(aa);xm=s(Vz,"SPAN",{});var Kz=a(xm);y(Kl.$$.fragment,Kz),Kz.forEach(t),Vz.forEach(t),C2=p(Rg),Mm=s(Rg,"SPAN",{});var Jz=a(Mm);q2=i(Jz,"FlaxElectraForQuestionAnswering"),Jz.forEach(t),Rg.forEach(t),Ff=p(o),Be=s(o,"DIV",{class:!0});var bt=a(Be);y(Jl.$$.fragment,bt),P2=p(bt),Tn=s(bt,"P",{});var Nc=a(Tn);A2=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=s(Nc,"CODE",{});var Gz=a(zm);O2=i(Gz,"span start logits"),Gz.forEach(t),L2=i(Nc," and "),jm=s(Nc,"CODE",{});var Xz=a(jm);N2=i(Xz,"span end logits"),Xz.forEach(t),I2=i(Nc,")."),Nc.forEach(t),D2=p(bt),Gl=s(bt,"P",{});var Hg=a(Gl);S2=i(Hg,"This model inherits from "),hc=s(Hg,"A",{href:!0});var Yz=a(hc);W2=i(Yz,"FlaxPreTrainedModel"),Yz.forEach(t),U2=i(Hg,`. Check the superclass documentation for the generic methods the
