...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18018/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18018/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`),Qi=s(xg,"A",{href:!0,rel:!0});var n8=a(Qi);mw=i(n8,"flax.nn.Module"),n8.forEach(t),uw=i(xg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),fw=p(Ye),Eh=s(Ye,"P",{});var s8=a(Eh);gw=i(s8,"Finally, this model supports inherent JAX features such as:"),s8.forEach(t),_w=p(Ye),Jt=s(Ye,"UL",{});var va=a(Jt);wh=s(va,"LI",{});var a8=a(wh);Bi=s(a8,"A",{href:!0,rel:!0});var r8=a(Bi);kw=i(r8,"Just-In-Time (JIT) compilation"),r8.forEach(t),a8.forEach(t),vw=p(va),$h=s(va,"LI",{});var i8=a($h);Vi=s(i8,"A",{href:!0,rel:!0});var l8=a(Vi);Tw=i(l8,"Automatic Differentiation"),l8.forEach(t),i8.forEach(t),bw=p(va),Fh=s(va,"LI",{});var d8=a(Fh);Ki=s(d8,"A",{href:!0,rel:!0});var c8=a(Ki);yw=i(c8,"Vectorization"),c8.forEach(t),d8.forEach(t),Ew=p(va),xh=s(va,"LI",{});var p8=a(xh);Ji=s(p8,"A",{href:!0,rel:!0});var h8=a(Ji);ww=i(h8,"Parallelization"),h8.forEach(t),p8.forEach(t),va.forEach(t),$w=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),Fw=p(Ta),ln=s(Ta,"P",{});var Cc=a(ln);xw=i(Cc,"The "),Mh=s(Cc,"CODE",{});var m8=a(Mh);Mw=i(m8,"FlaxElectraPreTrainedModel"),m8.forEach(t),zw=i(Cc," forward method, overrides the "),zh=s(Cc,"CODE",{});var u8=a(zh);jw=i(u8,"__call__"),u8.forEach(t),Cw=i(Cc," special method."),Cc.forEach(t),qw=p(Ta),y(Us.$$.fragment,Ta),Pw=p(Ta),y(Rs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Hs=s(Mg,"A",{id:!0,class:!0,href:!0});var f8=a(Hs);jh=s(f8,"SPAN",{});var g8=a(jh);y(Xi.$$.fragment,g8),g8.forEach(t),f8.forEach(t),Aw=p(Mg),Ch=s(Mg,"SPAN",{});var _8=a(Ch);Ow=i(_8,"FlaxElectraForCausalLM"),_8.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),Lw=p(_t),qh=s(_t,"P",{});var k8=a(qh);Nw=i(k8,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
`),tl=s(jg,"A",{href:!0,rel:!0});var T8=a(tl);Hw=i(T8,"flax.nn.Module"),T8.forEach(t),Qw=i(jg,` subclass. Use it as a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$$=p(kt),Rh=s(kt,"P",{});var I8=a(Rh);F$=i(I8,"Finally, this model supports inherent JAX features such as:"),I8.forEach(t),x$=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var D8=a(Hh);ml=s(D8,"A",{href:!0,rel:!0});var S8=a(ml);M$=i(S8,"Just-In-Time (JIT) compilation"),S8.forEach(t),D8.forEach(t),z$=p(Ea),Qh=s(Ea,"LI",{});var W8=a(Qh);ul=s(W8,"A",{href:!0,rel:!0});var U8=a(ul);j$=i(U8,"Automatic Differentiation"),U8.forEach(t),W8.forEach(t),C$=p(Ea),Bh=s(Ea,"LI",{});var R8=a(Bh);fl=s(R8,"A",{href:!0,rel:!0});var H8=a(fl);q$=i(H8,"Vectorization"),H8.forEach(t),R8.forEach(t),P$=p(Ea),Vh=s(Ea,"LI",{});var Q8=a(Vh);gl=s(Q8,"A",{href:!0,rel:!0});var B8=a(gl);A$=i(B8,"Parallelization"),B8.forEach(t),Q8.forEach(t),Ea.forEach(t),O$=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L$=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N$=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V8=a(Kh);I$=i(V8,"FlaxElectraPreTrainedModel"),V8.forEach(t),D$=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K8=a(Jh);S$=i(K8,"__call__"),K8.forEach(t),W$=i(Pc," special method."),Pc.forEach(t),U$=p(wa),y(Ks.$$.fragment,wa),R$=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J8=a(Gs);Gh=s(J8,"SPAN",{});var G8=a(Gh);y(kl.$$.fragment,G8),G8.forEach(t),J8.forEach(t),H$=p(Og),Xh=s(Og,"SPAN",{});var X8=a(Xh);Q$=i(X8,"FlaxElectraForSequenceClassification"),X8.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),B$=p(vt),Yh=s(vt,"P",{});var Y8=a(Yh);V$=i(Y8,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rg.forEach(t),h2=p(Ze),Tm=s(Ze,"P",{});var Lz=a(Tm);m2=i(Lz,"Finally, this model supports inherent JAX features such as:"),Lz.forEach(t),u2=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var Nz=a(bm);Rl=s(Nz,"A",{href:!0,rel:!0});var Iz=a(Rl);f2=i(Iz,"Just-In-Time (JIT) compilation"),Iz.forEach(t),Nz.forEach(t),g2=p(za),ym=s(za,"LI",{});var Dz=a(ym);Hl=s(Dz,"A",{href:!0,rel:!0});var Sz=a(Hl);_2=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Dz.forEach(t),k2=p(za),Em=s(za,"LI",{});var Wz=a(Em);Ql=s(Wz,"A",{href:!0,rel:!0});var Uz=a(Ql);v2=i(Uz,"Vectorization"),Uz.forEach(t),Wz.forEach(t),T2=p(za),wm=s(za,"LI",{});var Rz=a(wm);Bl=s(Rz,"A",{href:!0,rel:!0});var Hz=a(Bl);b2=i(Hz,"Parallelization"),Hz.forEach(t),Rz.forEach(t),za.forEach(t),y2=p(Ze),It=s(Ze,"DIV",{class:!0});var ja=a(It);y(Vl.$$.fragment,ja),E2=p(ja),kn=s(ja,"P",{});var Lc=a(kn);w2=i(Lc,"The "),$m=s(Lc,"CODE",{});var Qz=a($m);$2=i(Qz,"FlaxElectraPreTrainedModel"),Qz.forEach(t),F2=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var Bz=a(Fm);x2=i(Bz,"__call__"),Bz.forEach(t),M2=i(Lc," special method."),Lc.forEach(t),z2=p(ja),y(na.$$.fragment,ja),j2=p(ja),y(sa.$$.fragment,ja),ja.forEach(t),Ze.forEach(t),$f=p(o),vn=s(o,"H2",{class:!0});var Hg=a(vn);aa=s(Hg,"A",{id:!0,class:!0,href:!0});var Vz=a(aa);xm=s(Vz,"SPAN",{});var Kz=a(xm);y(Kl.$$.fragment,Kz),Kz.forEach(t),Vz.forEach(t),C2=p(Hg),Mm=s(Hg,"SPAN",{});var Jz=a(Mm);q2=i(Jz,"FlaxElectraForQuestionAnswering"),Jz.forEach(t),Hg.forEach(t),Ff=p(o),Re=s(o,"DIV",{class:!0});var bt=a(Re);y(Jl.$$.fragment,bt),P2=p(bt),Tn=s(bt,"P",{});var Nc=a(Tn);A2=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=s(Nc,"CODE",{});var Gz=a(zm);O2=i(Gz,"span start logits"),Gz.forEach(t),L2=i(Nc," and "),jm=s(Nc,"CODE",{});var Xz=a(jm);N2=i(Xz,"span end logits"),Xz.forEach(t),I2=i(Nc,")."),Nc.forEach(t),D2=p(bt),Gl=s(bt,"P",{});var Qg=a(Gl);S2=i(Qg,"This model inherits from "),hc=s(Qg,"A",{href:!0});var Yz=a(hc);W2=i(Yz,"FlaxPreTrainedModel"),Yz.forEach(t),U2=i(Qg,`. Check the superclass documentation for the generic methods the
...
`),Yl=s(Bg,"A",{href:!0,rel:!0});var Zz=a(Yl);Q2=i(Zz,"flax.nn.Module"),Zz.forEach(t),B2=i(Bg,` subclass. Use it as a
