import{S as Qp,i as Yp,s as em,e as a,k as m,w as k,t,M as tm,c as r,d as o,m as g,a as i,x as v,h as n,b as h,G as e,g as x,y,q as j,o as M,B as L,v as nm,L as _e}from"../../chunks/vendor-hf-doc-builder.js";import{T as Jp}from"../../chunks/Tip-hf-doc-builder.js";import{D as ce}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ue}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Cs}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ge}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function om($){let d,f,_,c,u,s,p,C,S,I,q;return{c(){d=a("p"),f=t("Apart from "),_=a("code"),c=t("inputs"),u=t(`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=a("code"),p=t("config.json"),C=t(`) which in turn defaults to the
`),S=a("a"),I=t("PretrainedConfig"),q=t(" of the model."),this.h()},l(P){d=r(P,"P",{});var w=i(d);f=n(w,"Apart from "),_=r(w,"CODE",{});var Le=i(_);c=n(Le,"inputs"),Le.forEach(o),u=n(w,`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=r(w,"CODE",{});var $e=i(s);p=n($e,"config.json"),$e.forEach(o),C=n(w,`) which in turn defaults to the
`),S=r(w,"A",{href:!0});var he=i(S);I=n(he,"PretrainedConfig"),he.forEach(o),q=n(w," of the model."),w.forEach(o),this.h()},h(){h(S,"href","/docs/transformers/pr_18018/en/main_classes/configuration#transformers.PretrainedConfig")},m(P,w){x(P,d,w),e(d,f),e(d,_),e(_,c),e(d,u),e(d,s),e(s,p),e(d,C),e(d,S),e(S,I),e(d,q)},d(P){P&&o(d)}}}function sm($){let d,f,_,c,u;return c=new ue({props:{code:`from transformers import AutoTokenizer, AutoModelForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),_=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),_=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,_,p),y(c,s,p),u=!0},p:_e,i(s){u||(j(c.$$.fragment,s),u=!0)},o(s){M(c.$$.fragment,s),u=!1},d(s){s&&o(d),s&&o(_),L(c,s)}}}function cm($){let d,f,_,c,u;return c=new ue({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),_=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),_=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,_,p),y(c,s,p),u=!0},p:_e,i(s){u||(j(c.$$.fragment,s),u=!0)},o(s){M(c.$$.fragment,s),u=!1},d(s){s&&o(d),s&&o(_),L(c,s)}}}function pm($){let d,f,_,c,u;return c=new ue({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),_=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),_=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,_,p),y(c,s,p),u=!0},p:_e,i(s){u||(j(c.$$.fragment,s),u=!0)},o(s){M(c.$$.fragment,s),u=!1},d(s){s&&o(d),s&&o(_),L(c,s)}}}function mm($){let d,f,_,c,u;return c=new ue({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt sind Sie?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),_=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),_=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,_,p),y(c,s,p),u=!0},p:_e,i(s){u||(j(c.$$.fragment,s),u=!0)},o(s){M(c.$$.fragment,s),u=!1},d(s){s&&o(d),s&&o(_),L(c,s)}}}function gm($){let d,f,_,c,u;return c=new ue({props:{code:`
...
)  <span class="hljs-comment"># generate sequences without allowing bad_words to be generated</span>`}}),{c(){d=a("p"),f=t("Examples:"),_=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),_=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,_,p),y(c,s,p),u=!0},p:_e,i(s){u||(j(c.$$.fragment,s),u=!0)},o(s){M(c.$$.fragment,s),u=!1},d(s){s&&o(d),s&&o(_),L(c,s)}}}function _m($){let d,f,_,c,u,s,p,C,S,I,q;return{c(){d=a("p"),f=t("Apart from "),_=a("code"),c=t("inputs"),u=t(`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=a("code"),p=t("config.json"),C=t(`) which in turn defaults to the
`),S=a("a"),I=t("PretrainedConfig"),q=t(" of the model."),this.h()},l(P){d=r(P,"P",{});var w=i(d);f=n(w,"Apart from "),_=r(w,"CODE",{});var Le=i(_);c=n(Le,"inputs"),Le.forEach(o),u=n(w,`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=r(w,"CODE",{});var $e=i(s);p=n($e,"config.json"),$e.forEach(o),C=n(w,`) which in turn defaults to the
`),S=r(w,"A",{href:!0});var he=i(S);I=n(he,"PretrainedConfig"),he.forEach(o),q=n(w," of the model."),w.forEach(o),this.h()},h(){h(S,"href","/docs/transformers/pr_18018/en/main_classes/configuration#transformers.PretrainedConfig")},m(P,w){x(P,d,w),e(d,f),e(d,_),e(_,c),e(d,u),e(d,s),e(s,p),e(d,C),e(d,S),e(S,I),e(d,q)},d(P){P&&o(d)}}}function um($){let d,f,_,c,u;return c=new ue({props:{code:`from transformers import AutoTokenizer, FlaxAutoModelForCausalLM
...
<strong>DEPRECATED</strong> The maximum length of the sequence to be generated. Prefer the use of <code>max_new_tokens</code>.`,name:"max_length"},{anchor:"transformers.generation_utils.GenerationMixin.generate.max_new_tokens",description:`<strong>max_new_tokens</strong> (<code>int</code>, <em>optional</em>, defaults to None) &#x2014;
The maximum numbers of tokens to generate, ignoring the current number of tokens.`,name:"max_new_tokens"},{anchor:"transformers.generation_utils.GenerationMixin.generate.min_length",description:`<strong>min_length</strong> (<code>int</code>, <em>optional</em>, defaults to 10) &#x2014;
...
should be prefixed with *decoder</em>*.`,name:"exponential_decay_length_penalty"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/generation_utils.py#L844",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
<li><a
  href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
An derived instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
A derived instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An derived instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
documentation of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_18018/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<strong>DEPRECATED</strong> The maximum length of the sequence to be generated. Prefer the use of <code>max_new_tokens</code>.`,name:"max_length"},{anchor:"transformers.generation_tf_utils.TFGenerationMixin.generate.max_new_tokens",description:`<strong>max_new_tokens</strong> (<code>int</code>, <em>optional</em>, defaults to None) &#x2014;
The maximum numbers of tokens to generate, ignoring the current number of tokens.`,name:"max_new_tokens"},{anchor:"transformers.generation_tf_utils.TFGenerationMixin.generate.min_length",description:`<strong>min_length</strong> (<code>int</code>, <em>optional</em>, defaults to 10) &#x2014;
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/generation_tf_utils.py#L368",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput"
...
<strong>DEPRECATED</strong> The maximum length of the sequence to be generated. Prefer the use of <code>max_new_tokens</code>.`,name:"max_length"},{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.max_new_tokens",description:`<strong>max_new_tokens</strong> (<code>int</code>, <em>optional</em>, defaults to None) &#x2014;
The maximum numbers of tokens to generate, ignoring the current number of tokens.`,name:"max_new_tokens"},{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.do_sample",description:`<strong>do_sample</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If the model
is an encoder-decoder model, encoder specific kwargs should not be prefixed and decoder specific kwargs
should be prefixed with *decoder</em>*. Also accepts <code>encoder_outputs</code> to skip encoder part.`,name:"params"}],source:"https://github.com/huggingface/transformers/blob/vr_18018/src/transformers/generation_flax_utils.py#L163",returnDescription:`
<p><a
  href="/docs/transformers/pr_18018/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
`}}),ht=new Jp({props:{warning:!0,$$slots:{default:[_m]},$$scope:{ctx:$}}}),ft=new ge({props:{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){d=a("meta"),f=m(),_=a("h1"),c=a("a"),u=a("span"),k(s.$$.fragment),p=m(),C=a("span"),S=t("Generation"),I=m(),q=a("p"),P=t("Each framework has a generate method for auto-regressive text generation implemented in their respective "),w=a("code"),Le=t("GenerationMixin"),$e=t(" class:"),he=m(),fe=a("ul"),we=a("li"),Is=t("PyTorch "),tn=a("a"),Bs=t("generate()"),Ws=t(" is implemented in "),nn=a("a"),Rs=t("GenerationMixin"),Hs=t("."),Us=m(),Te=a("li"),Vs=t("TensorFlow "),on=a("a"),Ks=t("generate()"),Zs=t(" is implemented in "),sn=a("a"),Xs=t("TFGenerationMixin"),Js=t("."),Qs=m(),Ee=a("li"),Ys=t("Flax/JAX "),an=a("a"),ea=t("generate()"),ta=t(" is implemented in "),rn=a("a"),na=t("FlaxGenerationMixin"),oa=t("."),us=m(),Oe=a("h2"),nt=a("a"),Pn=a("span"),k(xt.$$.fragment),sa=m(),Dn=a("span"),aa=t("GenerationMixin"),hs=m(),T=a("div"),k(kt.$$.fragment),ra=m(),vt=a("p"),ia=t("A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=a("a"),la=t("PreTrainedModel"),da=t("."),ca=m(),yt=a("p"),pa=t("The class exposes "),dn=a("a"),ma=t("generate()"),ga=t(", which can be used for:"),_a=m(),D=a("ul"),B=a("li"),Nn=a("em"),ua=t("greedy decoding"),ha=t(" by calling "),cn=a("a"),fa=t("greedy_search()"),ba=t(" if "),zn=a("code"),xa=t("num_beams=1"),ka=t(` and
...
`),Wn=a("code"),Oa=t("do_sample=True"),Ga=t("."),Sa=m(),R=a("li"),Rn=a("em"),qa=t("beam-search decoding"),Fa=t(" by calling "),mn=a("a"),Aa=t("beam_search()"),Pa=t(" if "),Hn=a("code"),Da=t("num_beams>1"),Na=t(` and
`),Un=a("code"),za=t("do_sample=False"),Ca=t("."),Ia=m(),H=a("li"),Vn=a("em"),Ba=t("beam-search multinomial sampling"),Wa=t(" by calling "),gn=a("a"),Ra=t("beam_sample()"),Ha=t(` if
`),Kn=a("code"),Ua=t("num_beams>1"),Va=t(" and "),Zn=a("code"),Ka=t("do_sample=True"),Za=t("."),Xa=m(),U=a("li"),Xn=a("em"),Ja=t("diverse beam-search decoding"),Qa=t(" by calling "),_n=a("a"),Ya=t("group_beam_search()"),er=t(`, if
`),Jn=a("code"),tr=t("num_beams>1"),nr=t(" and "),Qn=a("code"),or=t("num_beam_groups>1"),sr=t("."),ar=m(),V=a("li"),Yn=a("em"),rr=t("constrained beam-search decoding"),ir=t(" by calling "),un=a("a"),lr=t("constrained_beam_search()"),dr=t(`,
if `),eo=a("code"),cr=t("constraints!=None"),pr=t(" or "),to=a("code"),mr=t("force_words_ids!=None"),gr=t("."),_r=m(),E=a("div"),k(jt.$$.fragment),ur=m(),no=a("p"),hr=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),fr=m(),N=a("ul"),K=a("li"),oo=a("em"),br=t("greedy decoding"),xr=t(" by calling "),hn=a("a"),kr=t("greedy_search()"),vr=t(" if "),so=a("code"),yr=t("num_beams=1"),jr=t(` and
...
`),lo=a("code"),qr=t("do_sample=True"),Fr=t("."),Ar=m(),X=a("li"),co=a("em"),Pr=t("beam-search decoding"),Dr=t(" by calling "),bn=a("a"),Nr=t("beam_search()"),zr=t(" if "),po=a("code"),Cr=t("num_beams>1"),Ir=t(` and
`),mo=a("code"),Br=t("do_sample=False"),Wr=t("."),Rr=m(),J=a("li"),go=a("em"),Hr=t("beam-search multinomial sampling"),Ur=t(" by calling "),xn=a("a"),Vr=t("beam_sample()"),Kr=t(` if
`),_o=a("code"),Zr=t("num_beams>1"),Xr=t(" and "),uo=a("code"),Jr=t("do_sample=True"),Qr=t("."),Yr=m(),Q=a("li"),ho=a("em"),ei=t("diverse beam-search decoding"),ti=t(" by calling "),kn=a("a"),ni=t("group_beam_search()"),oi=t(`, if
...
`),vn=a("a"),pi=t("constrained_beam_search()"),mi=t(", if "),ko=a("code"),gi=t("constraints!=None"),_i=t(` or
`),vo=a("code"),ui=t("force_words_ids!=None"),hi=t("."),fi=m(),k(ot.$$.fragment),bi=m(),Mt=a("p"),xi=t("Most of these parameters are explained in more detail in "),Lt=a("a"),ki=t(`this blog
...
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ni=m(),k(lt.$$.fragment),zi=m(),ke=a("div"),k(Ot.$$.fragment),Ci=m(),Gt=a("p"),Ii=t("Generates sequences of token ids for models with a language modeling head using "),Lo=a("strong"),Bi=t("beam search decoding"),Wi=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ri=m(),k(dt.$$.fragment),Hi=m(),ve=a("div"),k(St.$$.fragment),Ui=m(),qt=a("p"),Vi=t("Generates sequences of token ids for models with a language modeling head using "),$o=a("strong"),Ki=t(`beam search multinomial
...
decoding`),il=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),ll=m(),k(mt.$$.fragment),fs=m(),Ge=a("h2"),gt=a("a"),Eo=a("span"),k(Nt.$$.fragment),dl=m(),Oo=a("span"),cl=t("TFGenerationMixin"),bs=m(),pe=a("div"),k(zt.$$.fragment),pl=m(),Ct=a("p"),ml=t("A class containing all of the functions supporting generation, to be used as a mixin in "),yn=a("a"),gl=t("TFPreTrainedModel"),_l=t("."),ul=m(),F=a("div"),k(It.$$.fragment),hl=m(),Go=a("p"),fl=t(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
values of those config.`),Ol=m(),Rt=a("p"),Gl=t("Most of these parameters are explained in more detail in "),Ht=a("a"),Sl=t(`this blog
post`),ql=t("."),Fl=m(),k(_t.$$.fragment),xs=m(),Se=a("h2"),ut=a("a"),Fo=a("span"),k(Ut.$$.fragment),Al=m(),Ao=a("span"),Pl=t("FlaxGenerationMixin"),ks=m(),z=a("div"),k(Vt.$$.fragment),Dl=m(),Kt=a("p"),Nl=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),Mn=a("a"),zl=t("FlaxPreTrainedModel"),Cl=t("."),Il=m(),Zt=a("p"),Bl=t("The class exposes "),Ln=a("a"),Wl=t("generate()"),Rl=t(", which can be used for:"),Hl=m(),qe=a("ul"),ee=a("li"),Po=a("em"),Ul=t("greedy decoding"),Vl=t(" by calling "),Do=a("code"),Kl=t("_greedy_search()"),Zl=t(` if
`),No=a("code"),Xl=t("num_beams=1"),Jl=t(" and "),zo=a("code"),Ql=t("do_sample=False"),Yl=t("."),ed=m(),te=a("li"),Co=a("em"),td=t("multinomial sampling"),nd=t(" by calling "),Io=a("code"),od=t("_sample()"),sd=t(" if "),Bo=a("code"),ad=t("num_beams=1"),rd=t(`
and `),Wo=a("code"),id=t("do_sample=True"),ld=t("."),dd=m(),ne=a("li"),Ro=a("em"),cd=t("beam-search decoding"),pd=t(" by calling "),Ho=a("code"),md=t("_beam_search"),gd=t(" if "),Uo=a("code"),_d=t("num_beams>1"),ud=t(`
...
and `),ns=a("code"),Dd=t("do_sample=True"),Nd=t("."),zd=m(),ae=a("li"),os=a("em"),Cd=t("beam-search decoding"),Id=t(" by calling "),ss=a("code"),Bd=t("_beam_search"),Wd=t(" if "),as=a("code"),Rd=t("num_beams>1"),Hd=t(`
...
post`),Qd=t("."),Yd=m(),k(ft.$$.fragment),this.h()},l(l){const b=tm('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(o),f=g(l),_=r(l,"H1",{class:!0});var Yt=i(_);c=r(Yt,"A",{id:!0,class:!0,href:!0});var is=i(c);u=r(is,"SPAN",{});var ls=i(u);v(s.$$.fragment,ls),ls.forEach(o),is.forEach(o),p=g(Yt),C=r(Yt,"SPAN",{});var ds=i(C);S=n(ds,"Generation"),ds.forEach(o),Yt.forEach(o),I=g(l),q=r(l,"P",{});var en=i(q);P=n(en,"Each framework has a generate method for auto-regressive text generation implemented in their respective "),w=r(en,"CODE",{});var cs=i(w);Le=n(cs,"GenerationMixin"),cs.forEach(o),$e=n(en," class:"),en.forEach(o),he=g(l),fe=r(l,"UL",{});var Ae=i(fe);we=r(Ae,"LI",{});var Pe=i(we);Is=n(Pe,"PyTorch "),tn=r(Pe,"A",{href:!0});var ps=i(tn);Bs=n(ps,"generate()"),ps.forEach(o),Ws=n(Pe," is implemented in "),nn=r(Pe,"A",{href:!0});var ms=i(nn);Rs=n(ms,"GenerationMixin"),ms.forEach(o),Hs=n(Pe,"."),Pe.forEach(o),Us=g(Ae),Te=r(Ae,"LI",{});var De=i(Te);Vs=n(De,"TensorFlow "),on=r(De,"A",{href:!0});var gs=i(on);Ks=n(gs,"generate()"),gs.forEach(o),Zs=n(De," is implemented in "),sn=r(De,"A",{href:!0});var _s=i(sn);Xs=n(_s,"TFGenerationMixin"),_s.forEach(o),Js=n(De,"."),De.forEach(o),Qs=g(Ae),Ee=r(Ae,"LI",{});var $n=i(Ee);Ys=n($n,"Flax/JAX "),an=r($n,"A",{href:!0});var ec=i(an);ea=n(ec,"generate()"),ec.forEach(o),ta=n($n," is implemented in "),rn=r($n,"A",{href:!0});var tc=i(rn);na=n(tc,"FlaxGenerationMixin"),tc.forEach(o),oa=n($n,"."),$n.forEach(o),Ae.forEach(o),us=g(l),Oe=r(l,"H2",{class:!0});var ys=i(Oe);nt=r(ys,"A",{id:!0,class:!0,href:!0});var nc=i(nt);Pn=r(nc,"SPAN",{});var oc=i(Pn);v(xt.$$.fragment,oc),oc.forEach(o),nc.forEach(o),sa=g(ys),Dn=r(ys,"SPAN",{});var sc=i(Dn);aa=n(sc,"GenerationMixin"),sc.forEach(o),ys.forEach(o),hs=g(l),T=r(l,"DIV",{class:!0});var O=i(T);v(kt.$$.fragment,O),ra=g(O),vt=r(O,"P",{});var js=i(vt);ia=n(js,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=r(js,"A",{href:!0});var ac=i(ln);la=n(ac,"PreTrainedModel"),ac.forEach(o),da=n(js,"."),js.forEach(o),ca=g(O),yt=r(O,"P",{});var Ms=i(yt);pa=n(Ms,"The class exposes "),dn=r(Ms,"A",{href:!0});var rc=i(dn);ma=n(rc,"generate()"),rc.forEach(o),ga=n(Ms,", which can be used for:"),Ms.forEach(o),_a=g(O),D=r(O,"UL",{});var re=i(D);B=r(re,"LI",{});var Ne=i(B);Nn=r(Ne,"EM",{});var ic=i(Nn);ua=n(ic,"greedy decoding"),ic.forEach(o),ha=n(Ne," by calling "),cn=r(Ne,"A",{href:!0});var lc=i(cn);fa=n(lc,"greedy_search()"),lc.forEach(o),ba=n(Ne," if "),zn=r(Ne,"CODE",{});var dc=i(zn);xa=n(dc,"num_beams=1"),dc.forEach(o),ka=n(Ne,` and
`),Cn=r(Ne,"CODE",{});var cc=i(Cn);va=n(cc,"do_sample=False"),cc.forEach(o),ya=n(Ne,"."),Ne.forEach(o),ja=g(re),W=r(re,"LI",{});var ze=i(W);In=r(ze,"EM",{});var pc=i(In);Ma=n(pc,"multinomial sampling"),pc.forEach(o),La=n(ze," by calling "),pn=r(ze,"A",{href:!0});var mc=i(pn);$a=n(mc,"sample()"),mc.forEach(o),wa=n(ze," if "),Bn=r(ze,"CODE",{});var gc=i(Bn);Ta=n(gc,"num_beams=1"),gc.forEach(o),Ea=n(ze,` and
`),Wn=r(ze,"CODE",{});var _c=i(Wn);Oa=n(_c,"do_sample=True"),_c.forEach(o),Ga=n(ze,"."),ze.forEach(o),Sa=g(re),R=r(re,"LI",{});var Ce=i(R);Rn=r(Ce,"EM",{});var uc=i(Rn);qa=n(uc,"beam-search decoding"),uc.forEach(o),Fa=n(Ce," by calling "),mn=r(Ce,"A",{href:!0});var hc=i(mn);Aa=n(hc,"beam_search()"),hc.forEach(o),Pa=n(Ce," if "),Hn=r(Ce,"CODE",{});var fc=i(Hn);Da=n(fc,"num_beams>1"),fc.forEach(o),Na=n(Ce,` and
`),Un=r(Ce,"CODE",{});var bc=i(Un);za=n(bc,"do_sample=False"),bc.forEach(o),Ca=n(Ce,"."),Ce.forEach(o),Ia=g(re),H=r(re,"LI",{});var Ie=i(H);Vn=r(Ie,"EM",{});var xc=i(Vn);Ba=n(xc,"beam-search multinomial sampling"),xc.forEach(o),Wa=n(Ie," by calling "),gn=r(Ie,"A",{href:!0});var kc=i(gn);Ra=n(kc,"beam_sample()"),kc.forEach(o),Ha=n(Ie,` if
...
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),Gc.forEach(o),fr=g(G),N=r(G,"UL",{});var ie=i(N);K=r(ie,"LI",{});var Re=i(K);oo=r(Re,"EM",{});var Sc=i(oo);br=n(Sc,"greedy decoding"),Sc.forEach(o),xr=n(Re," by calling "),hn=r(Re,"A",{href:!0});var qc=i(hn);kr=n(qc,"greedy_search()"),qc.forEach(o),vr=n(Re," if "),so=r(Re,"CODE",{});var Fc=i(so);yr=n(Fc,"num_beams=1"),Fc.forEach(o),jr=n(Re,` and
`),ao=r(Re,"CODE",{});var Ac=i(ao);Mr=n(Ac,"do_sample=False"),Ac.forEach(o),Lr=n(Re,"."),Re.forEach(o),$r=g(ie),Z=r(ie,"LI",{});var He=i(Z);ro=r(He,"EM",{});var Pc=i(ro);wr=n(Pc,"multinomial sampling"),Pc.forEach(o),Tr=n(He," by calling "),fn=r(He,"A",{href:!0});var Dc=i(fn);Er=n(Dc,"sample()"),Dc.forEach(o),Or=n(He," if "),io=r(He,"CODE",{});var Nc=i(io);Gr=n(Nc,"num_beams=1"),Nc.forEach(o),Sr=n(He,` and
`),lo=r(He,"CODE",{});var zc=i(lo);qr=n(zc,"do_sample=True"),zc.forEach(o),Fr=n(He,"."),He.forEach(o),Ar=g(ie),X=r(ie,"LI",{});var Ue=i(X);co=r(Ue,"EM",{});var Cc=i(co);Pr=n(Cc,"beam-search decoding"),Cc.forEach(o),Dr=n(Ue," by calling "),bn=r(Ue,"A",{href:!0});var Ic=i(bn);Nr=n(Ic,"beam_search()"),Ic.forEach(o),zr=n(Ue," if "),po=r(Ue,"CODE",{});var Bc=i(po);Cr=n(Bc,"num_beams>1"),Bc.forEach(o),Ir=n(Ue,` and
`),mo=r(Ue,"CODE",{});var Wc=i(mo);Br=n(Wc,"do_sample=False"),Wc.forEach(o),Wr=n(Ue,"."),Ue.forEach(o),Rr=g(ie),J=r(ie,"LI",{});var Ve=i(J);go=r(Ve,"EM",{});var Rc=i(go);Hr=n(Rc,"beam-search multinomial sampling"),Rc.forEach(o),Ur=n(Ve," by calling "),xn=r(Ve,"A",{href:!0});var Hc=i(xn);Vr=n(Hc,"beam_sample()"),Hc.forEach(o),Kr=n(Ve,` if
...
`),vn=r(Ze,"A",{href:!0});var Yc=i(vn);pi=n(Yc,"constrained_beam_search()"),Yc.forEach(o),mi=n(Ze,", if "),ko=r(Ze,"CODE",{});var ep=i(ko);gi=n(ep,"constraints!=None"),ep.forEach(o),_i=n(Ze,` or
`),vo=r(Ze,"CODE",{});var tp=i(vo);ui=n(tp,"force_words_ids!=None"),tp.forEach(o),hi=n(Ze,"."),Ze.forEach(o),ie.forEach(o),fi=g(G),v(ot.$$.fragment,G),bi=g(G),Mt=r(G,"P",{});var Ls=i(Mt);xi=n(Ls,"Most of these parameters are explained in more detail in "),Lt=r(Ls,"A",{href:!0,rel:!0});var np=i(Lt);ki=n(np,`this blog
...
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),ws.forEach(o),Ni=g(Tn),v(lt.$$.fragment,Tn),Tn.forEach(o),zi=g(O),ke=r(O,"DIV",{class:!0});var En=i(ke);v(Ot.$$.fragment,En),Ci=g(En),Gt=r(En,"P",{});var Ts=i(Gt);Ii=n(Ts,"Generates sequences of token ids for models with a language modeling head using "),Lo=r(Ts,"STRONG",{});var rp=i(Lo);Bi=n(rp,"beam search decoding"),rp.forEach(o),Wi=n(Ts,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ts.forEach(o),Ri=g(En),v(dt.$$.fragment,En),En.forEach(o),Hi=g(O),ve=r(O,"DIV",{class:!0});var On=i(ve);v(St.$$.fragment,On),Ui=g(On),qt=r(On,"P",{});var Es=i(qt);Vi=n(Es,"Generates sequences of token ids for models with a language modeling head using "),$o=r(Es,"STRONG",{});var ip=i($o);Ki=n(ip,`beam search multinomial
...
decoding`),dp.forEach(o),il=n(Gs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Gs.forEach(o),ll=g(Sn),v(mt.$$.fragment,Sn),Sn.forEach(o),O.forEach(o),fs=g(l),Ge=r(l,"H2",{class:!0});var Ss=i(Ge);gt=r(Ss,"A",{id:!0,class:!0,href:!0});var cp=i(gt);Eo=r(cp,"SPAN",{});var pp=i(Eo);v(Nt.$$.fragment,pp),pp.forEach(o),cp.forEach(o),dl=g(Ss),Oo=r(Ss,"SPAN",{});var mp=i(Oo);cl=n(mp,"TFGenerationMixin"),mp.forEach(o),Ss.forEach(o),bs=g(l),pe=r(l,"DIV",{class:!0});var qn=i(pe);v(zt.$$.fragment,qn),pl=g(qn),Ct=r(qn,"P",{});var qs=i(Ct);ml=n(qs,"A class containing all of the functions supporting generation, to be used as a mixin in "),yn=r(qs,"A",{href:!0});var gp=i(yn);gl=n(gp,"TFPreTrainedModel"),gp.forEach(o),_l=n(qs,"."),qs.forEach(o),ul=g(qn),F=r(qn,"DIV",{class:!0});var le=i(F);v(It.$$.fragment,le),hl=g(le),Go=r(le,"P",{});var _p=i(Go);fl=n(_p,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),_p.forEach(o),bl=g(le),Bt=r(le,"P",{});var Fs=i(Bt);xl=n(Fs,"Adapted in part from "),Wt=r(Fs,"A",{href:!0,rel:!0});var up=i(Wt);kl=n(up,`Facebook\u2019s XLM beam search
code`),up.forEach(o),vl=n(Fs,"."),Fs.forEach(o),yl=g(le),me=r(le,"P",{});var bt=i(me);jl=n(bt,"Apart from "),So=r(bt,"CODE",{});var hp=i(So);Ml=n(hp,"input_ids"),hp.forEach(o),Ll=n(bt," and "),qo=r(bt,"CODE",{});var fp=i(qo);$l=n(fp,"attention_mask"),fp.forEach(o),wl=n(bt,`, all the arguments below will default to the value of the attribute
...
values of those config.`),bt.forEach(o),Ol=g(le),Rt=r(le,"P",{});var As=i(Rt);Gl=n(As,"Most of these parameters are explained in more detail in "),Ht=r(As,"A",{href:!0,rel:!0});var xp=i(Ht);Sl=n(xp,`this blog
post`),xp.forEach(o),ql=n(As,"."),As.forEach(o),Fl=g(le),v(_t.$$.fragment,le),le.forEach(o),qn.forEach(o),xs=g(l),Se=r(l,"H2",{class:!0});var Ps=i(Se);ut=r(Ps,"A",{id:!0,class:!0,href:!0});var kp=i(ut);Fo=r(kp,"SPAN",{});var vp=i(Fo);v(Ut.$$.fragment,vp),vp.forEach(o),kp.forEach(o),Al=g(Ps),Ao=r(Ps,"SPAN",{});var yp=i(Ao);Pl=n(yp,"FlaxGenerationMixin"),yp.forEach(o),Ps.forEach(o),ks=g(l),z=r(l,"DIV",{class:!0});var Me=i(z);v(Vt.$$.fragment,Me),Dl=g(Me),Kt=r(Me,"P",{});var Ds=i(Kt);Nl=n(Ds,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),Mn=r(Ds,"A",{href:!0});var jp=i(Mn);zl=n(jp,"FlaxPreTrainedModel"),jp.forEach(o),Cl=n(Ds,"."),Ds.forEach(o),Il=g(Me),Zt=r(Me,"P",{});var Ns=i(Zt);Bl=n(Ns,"The class exposes "),Ln=r(Ns,"A",{href:!0});var Mp=i(Ln);Wl=n(Mp,"generate()"),Mp.forEach(o),Rl=n(Ns,", which can be used for:"),Ns.forEach(o),Hl=g(Me),qe=r(Me,"UL",{});var Fn=i(qe);ee=r(Fn,"LI",{});var Xe=i(ee);Po=r(Xe,"EM",{});var Lp=i(Po);Ul=n(Lp,"greedy decoding"),Lp.forEach(o),Vl=n(Xe," by calling "),Do=r(Xe,"CODE",{});var $p=i(Do);Kl=n($p,"_greedy_search()"),$p.forEach(o),Zl=n(Xe,` if
`),No=r(Xe,"CODE",{});var wp=i(No);Xl=n(wp,"num_beams=1"),wp.forEach(o),Jl=n(Xe," and "),zo=r(Xe,"CODE",{});var Tp=i(zo);Ql=n(Tp,"do_sample=False"),Tp.forEach(o),Yl=n(Xe,"."),Xe.forEach(o),ed=g(Fn),te=r(Fn,"LI",{});var Je=i(te);Co=r(Je,"EM",{});var Ep=i(Co);td=n(Ep,"multinomial sampling"),Ep.forEach(o),nd=n(Je," by calling "),Io=r(Je,"CODE",{});var Op=i(Io);od=n(Op,"_sample()"),Op.forEach(o),sd=n(Je," if "),Bo=r(Je,"CODE",{});var Gp=i(Bo);ad=n(Gp,"num_beams=1"),Gp.forEach(o),rd=n(Je,`
and `),Wo=r(Je,"CODE",{});var Sp=i(Wo);id=n(Sp,"do_sample=True"),Sp.forEach(o),ld=n(Je,"."),Je.forEach(o),dd=g(Fn),ne=r(Fn,"LI",{});var Qe=i(ne);Ro=r(Qe,"EM",{});var qp=i(Ro);cd=n(qp,"beam-search decoding"),qp.forEach(o),pd=n(Qe," by calling "),Ho=r(Qe,"CODE",{});var Fp=i(Ho);md=n(Fp,"_beam_search"),Fp.forEach(o),gd=n(Qe," if "),Uo=r(Qe,"CODE",{});var Ap=i(Uo);_d=n(Ap,"num_beams>1"),Ap.forEach(o),ud=n(Qe,`
...
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),Dp.forEach(o),vd=g(de),Fe=r(de,"UL",{});var An=i(Fe);oe=r(An,"LI",{});var Ye=i(oe);Zo=r(Ye,"EM",{});var Np=i(Zo);yd=n(Np,"greedy decoding"),Np.forEach(o),jd=n(Ye," by calling "),Xo=r(Ye,"CODE",{});var zp=i(Xo);Md=n(zp,"_greedy_search()"),zp.forEach(o),Ld=n(Ye,` if
`),Jo=r(Ye,"CODE",{});var Cp=i(Jo);$d=n(Cp,"num_beams=1"),Cp.forEach(o),wd=n(Ye," and "),Qo=r(Ye,"CODE",{});var Ip=i(Qo);Td=n(Ip,"do_sample=False"),Ip.forEach(o),Ed=n(Ye,"."),Ye.forEach(o),Od=g(An),se=r(An,"LI",{});var et=i(se);Yo=r(et,"EM",{});var Bp=i(Yo);Gd=n(Bp,"multinomial sampling"),Bp.forEach(o),Sd=n(et," by calling "),es=r(et,"CODE",{});var Wp=i(es);qd=n(Wp,"_sample()"),Wp.forEach(o),Fd=n(et," if "),ts=r(et,"CODE",{});var Rp=i(ts);Ad=n(Rp,"num_beams=1"),Rp.forEach(o),Pd=n(et,`
and `),ns=r(et,"CODE",{});var Hp=i(ns);Dd=n(Hp,"do_sample=True"),Hp.forEach(o),Nd=n(et,"."),et.forEach(o),zd=g(An),ae=r(An,"LI",{});var tt=i(ae);os=r(tt,"EM",{});var Up=i(os);Cd=n(Up,"beam-search decoding"),Up.forEach(o),Id=n(tt," by calling "),ss=r(tt,"CODE",{});var Vp=i(ss);Bd=n(Vp,"_beam_search"),Vp.forEach(o),Wd=n(tt," if "),as=r(tt,"CODE",{});var Kp=i(as);Rd=n(Kp,"num_beams>1"),Kp.forEach(o),Hd=n(tt,`
and `),rs=r(tt,"CODE",{});var Zp=i(rs);Ud=n(Zp,"do_sample=False"),Zp.forEach(o),Vd=n(tt,"."),tt.forEach(o),An.forEach(o),Kd=g(de),v(ht.$$.fragment,de),Zd=g(de),Jt=r(de,"P",{});var zs=i(Jt);Xd=n(zs,"Most of these parameters are explained in more detail in "),Qt=r(zs,"A",{href:!0,rel:!0});var Xp=i(Qt);Jd=n(Xp,`this blog
post`),Xp.forEach(o),Qd=n(zs,"."),zs.forEach(o),Yd=g(de),v(ft.$$.fragment,de),de.forEach(o),Me.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(fm)),h(c,"id","generation"),h(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(c,"href","#generation"),h(_,"class","relative group"),h(tn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(nn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),h(on,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),h(sn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),h(an,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(rn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),h(nt,"id","transformers.generation_utils.GenerationMixin"),h(nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(nt,"href","#transformers.generation_utils.GenerationMixin"),h(Oe,"class","relative group"),h(ln,"href","/docs/transformers/pr_18018/en/main_classes/model#transformers.PreTrainedModel"),h(dn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(cn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(pn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(mn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(gn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(_n,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(un,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(hn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(fn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(bn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(xn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(kn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(vn,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(Lt,"href","https://huggingface.co/blog/how-to-generate"),h(Lt,"rel","nofollow"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(gt,"id","transformers.generation_tf_utils.TFGenerationMixin"),h(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(gt,"href","#transformers.generation_tf_utils.TFGenerationMixin"),h(Ge,"class","relative group"),h(yn,"href","/docs/transformers/pr_18018/en/main_classes/model#transformers.TFPreTrainedModel"),h(Wt,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),h(Wt,"rel","nofollow"),h(jn,"href","/docs/transformers/pr_18018/en/main_classes/configuration#transformers.PretrainedConfig"),h(Ht,"href","https://huggingface.co/blog/how-to-generate"),h(Ht,"rel","nofollow"),h(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ut,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),h(ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ut,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),h(Se,"class","relative group"),h(Mn,"href","/docs/transformers/pr_18018/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(Ln,"href","/docs/transformers/pr_18018/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(Qt,"href","https://huggingface.co/blog/how-to-generate"),h(Qt,"rel","nofollow"),h(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(l,b){e(document.head,d),x(l,f,b),x(l,_,b),e(_,c),e(c,u),y(s,u,null),e(_,p),e(_,C),e(C,S),x(l,I,b),x(l,q,b),e(q,P),e(q,w),e(w,Le),e(q,$e),x(l,he,b),x(l,fe,b),e(fe,we),e(we,Is),e(we,tn),e(tn,Bs),e(we,Ws),e(we,nn),e(nn,Rs),e(we,Hs),e(fe,Us),e(fe,Te),e(Te,Vs),e(Te,on),e(on,Ks),e(Te,Zs),e(Te,sn),e(sn,Xs),e(Te,Js),e(fe,Qs),e(fe,Ee),e(Ee,Ys),e(Ee,an),e(an,ea),e(Ee,ta),e(Ee,rn),e(rn,na),e(Ee,oa),x(l,us,b),x(l,Oe,b),e(Oe,nt),e(nt,Pn),y(xt,Pn,null),e(Oe,sa),e(Oe,Dn),e(Dn,aa),x(l,hs,b),x(l,T,b),y(kt,T,null),e(T,ra),e(T,vt),e(vt,ia),e(vt,ln),e(ln,la),e(vt,da),e(T,ca),e(T,yt),e(yt,pa),e(yt,dn),e(dn,ma),e(yt,ga),e(T,_a),e(T,D),e(D,B),e(B,Nn),e(Nn,ua),e(B,ha),e(B,cn),e(cn,fa),e(B,ba),e(B,zn),e(zn,xa),e(B,ka),e(B,Cn),e(Cn,va),e(B,ya),e(D,ja),e(D,W),e(W,In),e(In,Ma),e(W,La),e(W,pn),e(pn,$a),e(W,wa),e(W,Bn),e(Bn,Ta),e(W,Ea),e(W,Wn),e(Wn,Oa),e(W,Ga),e(D,Sa),e(D,R),e(R,Rn),e(Rn,qa),e(R,Fa),e(R,mn),e(mn,Aa),e(R,Pa),e(R,Hn),e(Hn,Da),e(R,Na),e(R,Un),e(Un,za),e(R,Ca),e(D,Ia),e(D,H),e(H,Vn),e(Vn,Ba),e(H,Wa),e(H,gn),e(gn,Ra),e(H,Ha),e(H,Kn),e(Kn,Ua),e(H,Va),e(H,Zn),e(Zn,Ka),e(H,Za),e(D,Xa),e(D,U),e(U,Xn),e(Xn,Ja),e(U,Qa),e(U,_n),e(_n,Ya),e(U,er),e(U,Jn),e(Jn,tr),e(U,nr),e(U,Qn),e(Qn,or),e(U,sr),e(D,ar),e(D,V),e(V,Yn),e(Yn,rr),e(V,ir),e(V,un),e(un,lr),e(V,dr),e(V,eo),e(eo,cr),e(V,pr),e(V,to),e(to,mr),e(V,gr),e(T,_r),e(T,E),y(jt,E,null),e(E,ur),e(E,no),e(no,hr),e(E,fr),e(E,N),e(N,K),e(K,oo),e(oo,br),e(K,xr),e(K,hn),e(hn,kr),e(K,vr),e(K,so),e(so,yr),e(K,jr),e(K,ao),e(ao,Mr),e(K,Lr),e(N,$r),e(N,Z),e(Z,ro),e(ro,wr),e(Z,Tr),e(Z,fn),e(fn,Er),e(Z,Or),e(Z,io),e(io,Gr),e(Z,Sr),e(Z,lo),e(lo,qr),e(Z,Fr),e(N,Ar),e(N,X),e(X,co),e(co,Pr),e(X,Dr),e(X,bn),e(bn,Nr),e(X,zr),e(X,po),e(po,Cr),e(X,Ir),e(X,mo),e(mo,Br),e(X,Wr),e(N,Rr),e(N,J),e(J,go),e(go,Hr),e(J,Ur),e(J,xn),e(xn,Vr),e(J,Kr),e(J,_o),e(_o,Zr),e(J,Xr),e(J,uo),e(uo,Jr),e(J,Qr),e(N,Yr),e(N,Q),e(Q,ho),e(ho,ei),e(Q,ti),e(Q,kn),e(kn,ni),e(Q,oi),e(Q,fo),e(fo,si),e(Q,ai),e(Q,bo),e(bo,ri),e(Q,ii),e(N,li),e(N,Y),e(Y,xo),e(xo,di),e(Y,ci),e(Y,vn),e(vn,pi),e(Y,mi),e(Y,ko),e(ko,gi),e(Y,_i),e(Y,vo),e(vo,ui),e(Y,hi),e(E,fi),y(ot,E,null),e(E,bi),e(E,Mt),e(Mt,xi),e(Mt,Lt),e(Lt,ki),e(Mt,vi),e(E,yi),e(E,yo),e(yo,ji),e(E,Mi),y(st,E,null),e(E,Li),y(at,E,null),e(E,$i),y(rt,E,null),e(T,wi),e(T,be),y($t,be,null),e(be,Ti),e(be,wt),e(wt,Ei),e(wt,jo),e(jo,Oi),e(wt,Gi),e(be,Si),y(it,be,null),e(T,qi),e(T,xe),y(Tt,xe,null),e(xe,Fi),e(xe,Et),e(Et,Ai),e(Et,Mo),e(Mo,Pi),e(Et,Di),e(xe,Ni),y(lt,xe,null),e(T,zi),e(T,ke),y(Ot,ke,null),e(ke,Ci),e(ke,Gt),e(Gt,Ii),e(Gt,Lo),e(Lo,Bi),e(Gt,Wi),e(ke,Ri),y(dt,ke,null),e(T,Hi),e(T,ve),y(St,ve,null),e(ve,Ui),e(ve,qt),e(qt,Vi),e(qt,$o),e($o,Ki),e(qt,Zi),e(ve,Xi),y(ct,ve,null),e(T,Ji),e(T,ye),y(Ft,ye,null),e(ye,Qi),e(ye,At),e(At,Yi),e(At,wo),e(wo,el),e(At,tl),e(ye,nl),y(pt,ye,null),e(T,ol),e(T,je),y(Pt,je,null),e(je,sl),e(je,Dt),e(Dt,al),e(Dt,To),e(To,rl),e(Dt,il),e(je,ll),y(mt,je,null),x(l,fs,b),x(l,Ge,b),e(Ge,gt),e(gt,Eo),y(Nt,Eo,null),e(Ge,dl),e(Ge,Oo),e(Oo,cl),x(l,bs,b),x(l,pe,b),y(zt,pe,null),e(pe,pl),e(pe,Ct),e(Ct,ml),e(Ct,yn),e(yn,gl),e(Ct,_l),e(pe,ul),e(pe,F),y(It,F,null),e(F,hl),e(F,Go),e(Go,fl),e(F,bl),e(F,Bt),e(Bt,xl),e(Bt,Wt),e(Wt,kl),e(Bt,vl),e(F,yl),e(F,me),e(me,jl),e(me,So),e(So,Ml),e(me,Ll),e(me,qo),e(qo,$l),e(me,wl),e(me,jn),e(jn,Tl),e(me,El),e(F,Ol),e(F,Rt),e(Rt,Gl),e(Rt,Ht),e(Ht,Sl),e(Rt,ql),e(F,Fl),y(_t,F,null),x(l,xs,b),x(l,Se,b),e(Se,ut),e(ut,Fo),y(Ut,Fo,null),e(Se,Al),e(Se,Ao),e(Ao,Pl),x(l,ks,b),x(l,z,b),y(Vt,z,null),e(z,Dl),e(z,Kt),e(Kt,Nl),e(Kt,Mn),e(Mn,zl),e(Kt,Cl),e(z,Il),e(z,Zt),e(Zt,Bl),e(Zt,Ln),e(Ln,Wl),e(Zt,Rl),e(z,Hl),e(z,qe),e(qe,ee),e(ee,Po),e(Po,Ul),e(ee,Vl),e(ee,Do),e(Do,Kl),e(ee,Zl),e(ee,No),e(No,Xl),e(ee,Jl),e(ee,zo),e(zo,Ql),e(ee,Yl),e(qe,ed),e(qe,te),e(te,Co),e(Co,td),e(te,nd),e(te,Io),e(Io,od),e(te,sd),e(te,Bo),e(Bo,ad),e(te,rd),e(te,Wo),e(Wo,id),e(te,ld),e(qe,dd),e(qe,ne),e(ne,Ro),e(Ro,cd),e(ne,pd),e(ne,Ho),e(Ho,md),e(ne,gd),e(ne,Uo),e(Uo,_d),e(ne,ud),e(ne,Vo),e(Vo,hd),e(ne,fd),e(z,bd),e(z,A),y(Xt,A,null),e(A,xd),e(A,Ko),e(Ko,kd),e(A,vd),e(A,Fe),e(Fe,oe),e(oe,Zo),e(Zo,yd),e(oe,jd),e(oe,Xo),e(Xo,Md),e(oe,Ld),e(oe,Jo),e(Jo,$d),e(oe,wd),e(oe,Qo),e(Qo,Td),e(oe,Ed),e(Fe,Od),e(Fe,se),e(se,Yo),e(Yo,Gd),e(se,Sd),e(se,es),e(es,qd),e(se,Fd),e(se,ts),e(ts,Ad),e(se,Pd),e(se,ns),e(ns,Dd),e(se,Nd),e(Fe,zd),e(Fe,ae),e(ae,os),e(os,Cd),e(ae,Id),e(ae,ss),e(ss,Bd),e(ae,Wd),e(ae,as),e(as,Rd),e(ae,Hd),e(ae,rs),e(rs,Ud),e(ae,Vd),e(A,Kd),y(ht,A,null),e(A,Zd),e(A,Jt),e(Jt,Xd),e(Jt,Qt),e(Qt,Jd),e(Jt,Qd),e(A,Yd),y(ft,A,null),vs=!0},p(l,[b]){const Yt={};b&2&&(Yt.$$scope={dirty:b,ctx:l}),ot.$set(Yt);const is={};b&2&&(is.$$scope={dirty:b,ctx:l}),st.$set(is);const ls={};b&2&&(ls.$$scope={dirty:b,ctx:l}),at.$set(ls);const ds={};b&2&&(ds.$$scope={dirty:b,ctx:l}),rt.$set(ds);const en={};b&2&&(en.$$scope={dirty:b,ctx:l}),it.$set(en);const cs={};b&2&&(cs.$$scope={dirty:b,ctx:l}),lt.$set(cs);const Ae={};b&2&&(Ae.$$scope={dirty:b,ctx:l}),dt.$set(Ae);const Pe={};b&2&&(Pe.$$scope={dirty:b,ctx:l}),ct.$set(Pe);const ps={};b&2&&(ps.$$scope={dirty:b,ctx:l}),pt.$set(ps);const ms={};b&2&&(ms.$$scope={dirty:b,ctx:l}),mt.$set(ms);const De={};b&2&&(De.$$scope={dirty:b,ctx:l}),_t.$set(De);const gs={};b&2&&(gs.$$scope={dirty:b,ctx:l}),ht.$set(gs);const _s={};b&2&&(_s.$$scope={dirty:b,ctx:l}),ft.$set(_s)},i(l){vs||(j(s.$$.fragment,l),j(xt.$$.fragment,l),j(kt.$$.fragment,l),j(jt.$$.fragment,l),j(ot.$$.fragment,l),j(st.$$.fragment,l),j(at.$$.fragment,l),j(rt.$$.fragment,l),j($t.$$.fragment,l),j(it.$$.fragment,l),j(Tt.$$.fragment,l),j(lt.$$.fragment,l),j(Ot.$$.fragment,l),j(dt.$$.fragment,l),j(St.$$.fragment,l),j(ct.$$.fragment,l),j(Ft.$$.fragment,l),j(pt.$$.fragment,l),j(Pt.$$.fragment,l),j(mt.$$.fragment,l),j(Nt.$$.fragment,l),j(zt.$$.fragment,l),j(It.$$.fragment,l),j(_t.$$.fragment,l),j(Ut.$$.fragment,l),j(Vt.$$.fragment,l),j(Xt.$$.fragment,l),j(ht.$$.fragment,l),j(ft.$$.fragment,l),vs=!0)},o(l){M(s.$$.fragment,l),M(xt.$$.fragment,l),M(kt.$$.fragment,l),M(jt.$$.fragment,l),M(ot.$$.fragment,l),M(st.$$.fragment,l),M(at.$$.fragment,l),M(rt.$$.fragment,l),M($t.$$.fragment,l),M(it.$$.fragment,l),M(Tt.$$.fragment,l),M(lt.$$.fragment,l),M(Ot.$$.fragment,l),M(dt.$$.fragment,l),M(St.$$.fragment,l),M(ct.$$.fragment,l),M(Ft.$$.fragment,l),M(pt.$$.fragment,l),M(Pt.$$.fragment,l),M(mt.$$.fragment,l),M(Nt.$$.fragment,l),M(zt.$$.fragment,l),M(It.$$.fragment,l),M(_t.$$.fragment,l),M(Ut.$$.fragment,l),M(Vt.$$.fragment,l),M(Xt.$$.fragment,l),M(ht.$$.fragment,l),M(ft.$$.fragment,l),vs=!1},d(l){o(d),l&&o(f),l&&o(_),L(s),l&&o(I),l&&o(q),l&&o(he),l&&o(fe),l&&o(us),l&&o(Oe),L(xt),l&&o(hs),l&&o(T),L(kt),L(jt),L(ot),L(st),L(at),L(rt),L($t),L(it),L(Tt),L(lt),L(Ot),L(dt),L(St),L(ct),L(Ft),L(pt),L(Pt),L(mt),l&&o(fs),l&&o(Ge),L(Nt),l&&o(bs),l&&o(pe),L(zt),L(It),L(_t),l&&o(xs),l&&o(Se),L(Ut),l&&o(ks),l&&o(z),L(Vt),L(Xt),L(ht),L(ft)}}}const fm={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function bm($){return nm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Lm extends Qp{constructor(d){super();Yp(this,d,bm,hm,em,{})}}export{Lm as default,fm as metadata};
