...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17043/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17043/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17043/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),Fy=h(Nt),y(bs.$$.fragment,Nt),xy=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),Ry=h(co),Uo=s(co,"P",{});var qd=a(Uo);My=i(qd,"The "),rd=s(qd,"A",{href:!0});var XF=a(rd);Ey=i(XF,"TFRobertaForTokenClassification"),XF.forEach(t),zy=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var YF=a(dp);qy=i(YF,"__call__"),YF.forEach(t),Cy=i(qd," special method."),qd.forEach(t),jy=h(co),y(ks.$$.fragment,co),Py=h(co),y(vs.$$.fragment,co),Ly=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var ZF=a(ys);cp=s(ZF,"SPAN",{});var e4=a(cp);y(oi.$$.fragment,e4),e4.forEach(t),ZF.forEach(t),Ay=h(Zf),pp=s(Zf,"SPAN",{});var t4=a(pp);Oy=i(t4,"TFRobertaForQuestionAnswering"),t4.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),Ny=h(It),Qo=s(It,"P",{});var Cd=a(Qo);Iy=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
