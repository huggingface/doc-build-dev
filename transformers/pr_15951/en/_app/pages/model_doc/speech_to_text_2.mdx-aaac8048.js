import{S as ic,i as cc,s as lc,e as a,k as l,w as m,t as r,M as dc,c as n,d as o,m as d,a as i,x as u,h as s,b as c,F as e,g as h,y as _,q as g,o as v,B as T}from"../../chunks/vendor-4833417e.js";import{T as nc}from"../../chunks/Tip-fffd6df1.js";import{D as L}from"../../chunks/Docstring-7b52c3d4.js";import{C as Pr}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as gt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function pc(ye){let f,q,k,w,D,S,B,I;return{c(){f=a("p"),q=r(`This class method is simply calling the feature extractor
...
`),S=n(b,"CODE",{});var M=i(S);B=s(M,"from_pretrained"),M.forEach(o),I=s(b,` methods. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/pr_15951/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){h(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,B),e(f,I)},d(P){P&&o(f)}}}function hc(ye){let f,q,k,w,D,S,B,I;return{c(){f=a("p"),q=r("This class method is simply calling "),k=a("a"),w=r("save_pretrained()"),D=r(` and
...
`),S=n(b,"CODE",{});var M=i(S);B=s(M,"save_pretrained"),M.forEach(o),I=s(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/pr_15951/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,B),e(f,I)},d(P){P&&o(f)}}}function fc(ye){let f,q,k,w,D,S,B,I,P,b,j,M,ro,$e,jr,so,Cr,Lo,R,qr,vt,Mr,Fr,Ee,Ar,Lr,Do,y,Dr,ao,Ir,Wr,no,Vr,Nr,Tt,Br,Or,kt,Ur,Hr,xt,Rr,Jr,io,Gr,Kr,Io,ie,Qr,ze,Xr,Yr,Wo,ce,Zr,Pe,es,ts,Vo,bt,os,No,J,je,rs,Ce,ss,as,ns,qe,is,wt,cs,ls,ds,Me,ps,Fe,hs,fs,Bo,ee,le,co,Ae,ms,lo,us,Oo,G,_s,St,gs,vs,yt,Ts,ks,Uo,z,xs,$t,bs,ws,Et,Ss,ys,zt,$s,Es,Pt,zs,Ps,jt,js,Cs,Ho,Ct,po,qs,Ro,Le,Jo,qt,De,ho,Ms,Fs,fo,As,Go,Ie,Ko,de,Ls,We,Ds,Is,Qo,te,pe,mo,Ve,Ws,uo,Vs,Xo,C,Ne,Ns,oe,Bs,Mt,Os,Us,Be,Hs,Rs,Js,re,Gs,Ft,Ks,Qs,At,Xs,Ys,Zs,_o,ea,ta,Oe,Yo,se,he,go,Ue,oa,vo,ra,Zo,E,He,sa,To,aa,na,Re,ia,Lt,ca,la,da,fe,Je,pa,ko,ha,fa,K,Ge,ma,xo,ua,_a,Ke,ga,bo,va,Ta,ka,Dt,Qe,er,ae,me,wo,Xe,xa,So,ba,tr,x,Ye,wa,yo,Sa,ya,F,It,$a,Ea,Wt,za,Pa,Vt,ja,Ca,Ze,$o,qa,Ma,Fa,Nt,Aa,La,Da,ue,et,Ia,O,Wa,Eo,Va,Na,Bt,Ba,Oa,tt,zo,Ua,Ha,Ra,Ja,Q,ot,Ga,Po,Ka,Qa,_e,Xa,X,rt,Ya,st,Za,Ot,en,tn,on,ge,rn,ve,at,sn,nt,an,Ut,nn,cn,ln,Te,it,dn,ct,pn,Ht,hn,fn,mn,ke,lt,un,jo,_n,or,ne,xe,Co,dt,gn,qo,vn,rr,W,pt,Tn,U,kn,Rt,xn,bn,Mo,wn,Sn,Jt,yn,$n,En,ht,zn,ft,Pn,jn,Cn,Y,mt,qn,Fo,Mn,Fn,ut,sr;return S=new gt({}),$e=new gt({}),Ae=new gt({}),Le=new Pr({props:{code:`import torch
...
`,returnType:`
<p><code>str</code></p>
`}}),Qe=new L({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15951/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L235"}}),Xe=new gt({}),Ye=new L({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15951/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23",parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_15951/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
>transformers.modeling_outputs.CausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15951/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
<span class="hljs-comment"># init random speech2text model</span>
...
<span class="hljs-comment"># pre-process inputs and labels</span>

<span class="hljs-meta">&gt;&gt;&gt; </span>ds = load_dataset(<span class="hljs-string">&quot;hf-internal-testing/librispeech_asr_dummy&quot;</span>, <span class="hljs-string">&quot;clean&quot;</span>, split=<span class="hljs-string">&quot;validation&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>input_values = feature_extractor(
...
<span class="hljs-comment"># backprop loss</span>

<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("meta"),q=l(),k=a("h1"),w=a("a"),D=a("span"),m(S.$$.fragment),B=l(),I=a("span"),P=r("Speech2Text2"),b=l(),j=a("h2"),M=a("a"),ro=a("span"),m($e.$$.fragment),jr=l(),so=a("span"),Cr=r("Overview"),Lo=l(),R=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Mr=r("Wav2Vec2"),Fr=r(` for Speech Translation models proposed in
...
`),Tt=a("a"),Br=r("Wav2Vec2"),Or=r(" or "),kt=a("a"),Ur=r("HuBERT"),Hr=r(` for Speech-to-Text tasks. Please refer to the
...
the `),Ce=a("a"),ss=r("official models"),as=r(" ."),ns=l(),qe=a("li"),is=r("Speech2Text2 is always used within the "),wt=a("a"),cs=r("SpeechEncoderDecoder"),ls=r(" framework."),ds=l(),Me=a("li"),ps=r("Speech2Text2\u2019s tokenizer is based on "),Fe=a("a"),hs=r("fastBPE"),fs=r("."),Bo=l(),ee=a("h2"),le=a("a"),co=a("span"),m(Ae.$$.fragment),ms=l(),lo=a("span"),us=r("Inference"),Oo=l(),G=a("p"),_s=r("Speech2Text2\u2019s "),St=a("a"),gs=r("SpeechEncoderDecoderModel"),vs=r(` model accepts raw waveform input values from speech and
...
predicted token ids.`),Ho=l(),Ct=a("ul"),po=a("li"),qs=r("Step-by-step Speech Translation"),Ro=l(),m(Le.$$.fragment),Jo=l(),qt=a("ul"),De=a("li"),ho=a("p"),Ms=r("Speech Translation via Pipelines"),Fs=l(),fo=a("p"),As=r("The automatic speech recognition pipeline can also be used to translate speech in just a couple lines of code"),Go=l(),m(Ie.$$.fragment),Ko=l(),de=a("p"),Ls=r("See "),We=a("a"),Ds=r("model hub"),Is=r(" to look for Speech2Text2 checkpoints."),Qo=l(),te=a("h2"),pe=a("a"),mo=a("span"),m(Ve.$$.fragment),Ws=l(),uo=a("span"),Vs=r("Speech2Text2Config"),Xo=l(),C=a("div"),m(Ne.$$.fragment),Ns=l(),oe=a("p"),Bs=r("This is the configuration class to store the configuration of a "),Mt=a("a"),Os=r("Speech2Text2ForCausalLM"),Us=r(`. It is used to
...
`),Be=a("a"),Hs=r("facebook/s2t-small-librispeech-asr"),Rs=r(" architecture."),Js=l(),re=a("p"),Gs=r("Configuration objects inherit from "),Ft=a("a"),Ks=r("PretrainedConfig"),Qs=r(` and can be used to control the model outputs. Read the
documentation from `),At=a("a"),Xs=r("PretrainedConfig"),Ys=r(" for more information."),Zs=l(),_o=a("p"),ea=r("Example:"),ta=l(),m(Oe.$$.fragment),Yo=l(),se=a("h2"),he=a("a"),go=a("span"),m(Ue.$$.fragment),oa=l(),vo=a("span"),ra=r("Speech2TextTokenizer"),Zo=l(),E=a("div"),m(He.$$.fragment),sa=l(),To=a("p"),aa=r("Constructs a Speech2Text2Tokenizer."),na=l(),Re=a("p"),ia=r("This tokenizer inherits from "),Lt=a("a"),ca=r("PreTrainedTokenizer"),la=r(` which contains some of the main methods. Users should refer to
...
See the `),Ze=a("a"),$o=a("strong"),qa=r("call"),Ma=r("()"),Fa=r(" and "),Nt=a("a"),Aa=r("decode()"),La=r(" for more information."),Da=l(),ue=a("div"),m(et.$$.fragment),Ia=l(),O=a("p"),Wa=r(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
and behavior.`),Cn=l(),Y=a("div"),m(mt.$$.fragment),qn=l(),Fo=a("p"),Mn=r("Example:"),Fn=l(),m(ut.$$.fragment),this.h()},l(t){const p=dc('[data-svelte="svelte-1phssyn"]',document.head);f=n(p,"META",{name:!0,content:!0}),p.forEach(o),q=d(t),k=n(t,"H1",{class:!0});var _t=i(k);w=n(_t,"A",{id:!0,class:!0,href:!0});var Ao=i(w);D=n(Ao,"SPAN",{});var Dn=i(D);u(S.$$.fragment,Dn),Dn.forEach(o),Ao.forEach(o),B=d(_t),I=n(_t,"SPAN",{});var In=i(I);P=s(In,"Speech2Text2"),In.forEach(o),_t.forEach(o),b=d(t),j=n(t,"H2",{class:!0});var ar=i(j);M=n(ar,"A",{id:!0,class:!0,href:!0});var Wn=i(M);ro=n(Wn,"SPAN",{});var Vn=i(ro);u($e.$$.fragment,Vn),Vn.forEach(o),Wn.forEach(o),jr=d(ar),so=n(ar,"SPAN",{});var Nn=i(so);Cr=s(Nn,"Overview"),Nn.forEach(o),ar.forEach(o),Lo=d(t),R=n(t,"P",{});var Gt=i(R);qr=s(Gt,"The Speech2Text2 model is used together with "),vt=n(Gt,"A",{href:!0});var Bn=i(vt);Mr=s(Bn,"Wav2Vec2"),Bn.forEach(o),Fr=s(Gt,` for Speech Translation models proposed in
`),Ee=n(Gt,"A",{href:!0,rel:!0});var On=i(Ee);Ar=s(On,"Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),On.forEach(o),Lr=s(Gt,` by
...
`),Tt=n(A,"A",{href:!0});var Rn=i(Tt);Br=s(Rn,"Wav2Vec2"),Rn.forEach(o),Or=s(A," or "),kt=n(A,"A",{href:!0});var Jn=i(kt);Ur=s(Jn,"HuBERT"),Jn.forEach(o),Hr=s(A,` for Speech-to-Text tasks. Please refer to the
...
See the `),Ze=n(H,"A",{href:!0});var An=i(Ze);$o=n(An,"STRONG",{});var Bi=i($o);qa=s(Bi,"call"),Bi.forEach(o),Ma=s(An,"()"),An.forEach(o),Fa=s(H," and "),Nt=n(H,"A",{href:!0});var Oi=i(Nt);Aa=s(Oi,"decode()"),Oi.forEach(o),La=s(H," for more information."),H.forEach(o),Da=d($),ue=n($,"DIV",{class:!0});var kr=i(ue);u(et.$$.fragment,kr),Ia=d(kr),O=n(kr,"P",{});var be=i(O);Wa=s(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
