...
`}}),pn=new le({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/tokenization_tapas.py#L397"}}),dn=new ss({}),cn=new le({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Tn=new le({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),vn=new ss({}),wn=new le({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),jn=new le({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),En=new ss({}),Fn=new le({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xn=new le({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),On=new ss({}),In=new le({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[Yq]},$$scope:{ctx:U}}}),Bn=new le({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Rn=new ss({}),Vn=new le({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[Xq]},$$scope:{ctx:U}}}),Zn=new le({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),so=new ss({}),to=new le({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15822/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[e0]},$$scope:{ctx:U}}}),ro=new le({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15822/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15822/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15822/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
dependency in case you\u2019re using Tensorflow:`),zr.forEach(s),Td=p(t),v(Fa.$$.fragment,t),bd=p(t),Cs=r(t,"P",{});var xr=i(Cs);Ku=n(xr,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),Eo=r(xr,"A",{href:!0});var Jk=i(Eo);Yu=n(Jk,"TapasConfig"),Jk.forEach(s),Ju=n(xr,", and then create a "),Fo=r(xr,"A",{href:!0});var Xk=i(Fo);Xu=n(Xk,"TapasForQuestionAnswering"),Xk.forEach(s),Zu=n(xr," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),xr.forEach(s),vd=p(t),v(Aa.$$.fragment,t),wd=p(t),Pt=r(t,"P",{});var bc=i(Pt);em=n(bc,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),$a=r(bc,"A",{href:!0,rel:!0});var Zk=i($a);sm=n(Zk,"here"),Zk.forEach(s),tm=n(bc," for more info."),bc.forEach(s),yd=p(t),St=r(t,"P",{});var vc=i(St);am=n(vc,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),za=r(vc,"A",{href:!0,rel:!0});var e2=i(za);nm=n(e2,"here"),e2.forEach(s),om=n(vc,"."),vc.forEach(s),kd=p(t),Ao=r(t,"P",{});var s2=i(Ao);Ei=r(s2,"STRONG",{});var t2=i(Ei);rm=n(t2,"STEP 2: Prepare your data in the SQA format"),t2.forEach(s),s2.forEach(s),jd=p(t),Dt=r(t,"P",{});var wc=i(Dt);im=n(wc,"Second, no matter what you picked above, you should prepare your dataset in the "),xa=r(wc,"A",{href:!0,rel:!0});var a2=i(xa);lm=n(a2,"SQA"),a2.forEach(s),pm=n(wc," format. This format is a TSV/CSV file with the following columns:"),wc.forEach(s),qd=p(t),ie=r(t,"UL",{});var ze=i(ie);$o=r(ze,"LI",{});var Dy=i($o);Fi=r(Dy,"CODE",{});var n2=i(Fi);dm=n(n2,"id"),n2.forEach(s),cm=n(Dy,": optional, id of the table-question pair, for bookkeeping purposes."),Dy.forEach(s),hm=p(ze),zo=r(ze,"LI",{});var Ny=i(zo);Ai=r(Ny,"CODE",{});var o2=i(Ai);um=n(o2,"annotator"),o2.forEach(s),mm=n(Ny,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),Ny.forEach(s),gm=p(ze),xo=r(ze,"LI",{});var Ly=i(xo);$i=r(Ly,"CODE",{});var r2=i($i);fm=n(r2,"position"),r2.forEach(s),_m=n(Ly,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),Ly.forEach(s),Tm=p(ze),Co=r(ze,"LI",{});var Qy=i(Co);zi=r(Qy,"CODE",{});var i2=i(zi);bm=n(i2,"question"),i2.forEach(s),vm=n(Qy,": string"),Qy.forEach(s),wm=p(ze),Mo=r(ze,"LI",{});var Oy=i(Mo);xi=r(Oy,"CODE",{});var l2=i(xi);ym=n(l2,"table_file"),l2.forEach(s),km=n(Oy,": string, name of a csv file containing the tabular data"),Oy.forEach(s),jm=p(ze),Po=r(ze,"LI",{});var Iy=i(Po);Ci=r(Iy,"CODE",{});var p2=i(Ci);qm=n(p2,"answer_coordinates"),p2.forEach(s),Em=n(Iy,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),Iy.forEach(s),Fm=p(ze),So=r(ze,"LI",{});var Wy=i(So);Mi=r(Wy,"CODE",{});var d2=i(Mi);Am=n(d2,"answer_text"),d2.forEach(s),$m=n(Wy,": list of one or more strings (each string being a cell value that is part of the answer)"),Wy.forEach(s),zm=p(ze),Do=r(ze,"LI",{});var Uy=i(Do);Pi=r(Uy,"CODE",{});var c2=i(Pi);xm=n(c2,"aggregation_label"),c2.forEach(s),Cm=n(Uy,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),Uy.forEach(s),Mm=p(ze),No=r(ze,"LI",{});var Hy=i(No);Si=r(Hy,"CODE",{});var h2=i(Si);Pm=n(h2,"float_answer"),h2.forEach(s),Sm=n(Hy,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),Hy.forEach(s),ze.forEach(s),Ed=p(t),We=r(t,"P",{});var ws=i(We);Dm=n(ws,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),Ca=r(ws,"A",{href:!0,rel:!0});var u2=i(Ca);Nm=n(u2,"here"),u2.forEach(s),Lm=n(ws,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),Ma=r(ws,"A",{href:!0,rel:!0});var m2=i(Ma);Qm=n(m2,"here"),m2.forEach(s),Om=n(ws,". Interestingly, these conversion scripts are not perfect (the "),Di=r(ws,"CODE",{});var g2=i(Di);Im=n(g2,"answer_coordinates"),g2.forEach(s),Wm=n(ws," and "),Ni=r(ws,"CODE",{});var f2=i(Ni);Um=n(f2,"float_answer"),f2.forEach(s),Hm=n(ws," fields are populated based on the "),Li=r(ws,"CODE",{});var _2=i(Li);Bm=n(_2,"answer_text"),_2.forEach(s),Gm=n(ws,"), meaning that WTQ and WikiSQL results could actually be improved."),ws.forEach(s),Fd=p(t),Lo=r(t,"P",{});var T2=i(Lo);Qi=r(T2,"STRONG",{});var b2=i(Qi);Rm=n(b2,"STEP 3: Convert your data into PyTorch/TensorFlow tensors using TapasTokenizer"),b2.forEach(s),T2.forEach(s),Ad=p(t),$e=r(t,"P",{});var cs=i($e);Vm=n(cs,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),Qo=r(cs,"A",{href:!0});var v2=i(Qo);Km=n(v2,"TapasTokenizer"),v2.forEach(s),Ym=n(cs," to convert table-question pairs into "),Oi=r(cs,"CODE",{});var w2=i(Oi);Jm=n(w2,"input_ids"),w2.forEach(s),Xm=n(cs,", "),Ii=r(cs,"CODE",{});var y2=i(Ii);Zm=n(y2,"attention_mask"),y2.forEach(s),eg=n(cs,", "),Wi=r(cs,"CODE",{});var k2=i(Wi);sg=n(k2,"token_type_ids"),k2.forEach(s),tg=n(cs," and so on. Again, based on which of the three cases you picked above, "),Oo=r(cs,"A",{href:!0});var j2=i(Oo);ag=n(j2,"TapasForQuestionAnswering"),j2.forEach(s),ng=n(cs,"/"),Io=r(cs,"A",{href:!0});var q2=i(Io);og=n(q2,"TFTapasForQuestionAnswering"),q2.forEach(s),rg=n(cs,` requires different
inputs to be fine-tuned:`),cs.forEach(s),$d=p(t),Nt=r(t,"TABLE",{});var yc=i(Nt);Ui=r(yc,"THEAD",{});var E2=i(Ui);Pa=r(E2,"TR",{});var kc=i(Pa);Hi=r(kc,"TH",{});var F2=i(Hi);Bi=r(F2,"STRONG",{});var A2=i(Bi);ig=n(A2,"Task"),A2.forEach(s),F2.forEach(s),lg=p(kc),Gi=r(kc,"TH",{});var $2=i(Gi);Ri=r($2,"STRONG",{});var z2=i(Ri);pg=n(z2,"Required inputs"),z2.forEach(s),$2.forEach(s),kc.forEach(s),E2.forEach(s),dg=p(yc),st=r(yc,"TBODY",{});var Cr=i(st);Sa=r(Cr,"TR",{});var jc=i(Sa);Vi=r(jc,"TD",{});var x2=i(Vi);cg=n(x2,"Conversational"),x2.forEach(s),hg=p(jc),$s=r(jc,"TD",{});var ua=i($s);Ki=r(ua,"CODE",{});var C2=i(Ki);ug=n(C2,"input_ids"),C2.forEach(s),mg=n(ua,", "),Yi=r(ua,"CODE",{});var M2=i(Yi);gg=n(M2,"attention_mask"),M2.forEach(s),fg=n(ua,", "),Ji=r(ua,"CODE",{});var P2=i(Ji);_g=n(P2,"token_type_ids"),P2.forEach(s),Tg=n(ua,", "),Xi=r(ua,"CODE",{});var S2=i(Xi);bg=n(S2,"labels"),S2.forEach(s),ua.forEach(s),jc.forEach(s),vg=p(Cr),Da=r(Cr,"TR",{});var qc=i(Da);Zi=r(qc,"TD",{});var D2=i(Zi);wg=n(D2,"Weak supervision for aggregation"),D2.forEach(s),yg=p(qc),Pe=r(qc,"TD",{});var hs=i(Pe);el=r(hs,"CODE",{});var N2=i(el);kg=n(N2,"input_ids"),N2.forEach(s),jg=n(hs,", "),sl=r(hs,"CODE",{});var L2=i(sl);qg=n(L2,"attention_mask"),L2.forEach(s),Eg=n(hs,", "),tl=r(hs,"CODE",{});var Q2=i(tl);Fg=n(Q2,"token_type_ids"),Q2.forEach(s),Ag=n(hs,", "),al=r(hs,"CODE",{});var O2=i(al);$g=n(O2,"labels"),O2.forEach(s),zg=n(hs,", "),nl=r(hs,"CODE",{});var I2=i(nl);xg=n(I2,"numeric_values"),I2.forEach(s),Cg=n(hs,", "),ol=r(hs,"CODE",{});var W2=i(ol);Mg=n(W2,"numeric_values_scale"),W2.forEach(s),Pg=n(hs,", "),rl=r(hs,"CODE",{});var U2=i(rl);Sg=n(U2,"float_answer"),U2.forEach(s),hs.forEach(s),qc.forEach(s),Dg=p(Cr),Na=r(Cr,"TR",{});var Ec=i(Na);il=r(Ec,"TD",{});var H2=i(il);Ng=n(H2,"Strong supervision for aggregation"),H2.forEach(s),Lg=p(Ec),ms=r(Ec,"TD",{});var Ss=i(ms);ll=r(Ss,"CODE",{});var B2=i(ll);Qg=n(B2,"input ids"),B2.forEach(s),Og=n(Ss,", "),pl=r(Ss,"CODE",{});var G2=i(pl);Ig=n(G2,"attention mask"),G2.forEach(s),Wg=n(Ss,", "),dl=r(Ss,"CODE",{});var R2=i(dl);Ug=n(R2,"token type ids"),R2.forEach(s),Hg=n(Ss,", "),cl=r(Ss,"CODE",{});var V2=i(cl);Bg=n(V2,"labels"),V2.forEach(s),Gg=n(Ss,", "),hl=r(Ss,"CODE",{});var K2=i(hl);Rg=n(K2,"aggregation_labels"),K2.forEach(s),Ss.forEach(s),Ec.forEach(s),Cr.forEach(s),yc.forEach(s),zd=p(t),pe=r(t,"P",{});var Ie=i(pe);Wo=r(Ie,"A",{href:!0});var Y2=i(Wo);Vg=n(Y2,"TapasTokenizer"),Y2.forEach(s),Kg=n(Ie," creates the "),ul=r(Ie,"CODE",{});var J2=i(ul);Yg=n(J2,"labels"),J2.forEach(s),Jg=n(Ie,", "),ml=r(Ie,"CODE",{});var X2=i(ml);Xg=n(X2,"numeric_values"),X2.forEach(s),Zg=n(Ie," and "),gl=r(Ie,"CODE",{});var Z2=i(gl);ef=n(Z2,"numeric_values_scale"),Z2.forEach(s),sf=n(Ie," based on the "),fl=r(Ie,"CODE",{});var e1=i(fl);tf=n(e1,"answer_coordinates"),e1.forEach(s),af=n(Ie," and "),_l=r(Ie,"CODE",{});var s1=i(_l);nf=n(s1,"answer_text"),s1.forEach(s),of=n(Ie," columns of the TSV file. The "),Tl=r(Ie,"CODE",{});var t1=i(Tl);rf=n(t1,"float_answer"),t1.forEach(s),lf=n(Ie," and "),bl=r(Ie,"CODE",{});var a1=i(bl);pf=n(a1,"aggregation_labels"),a1.forEach(s),df=n(Ie," are already in the TSV file of step 2. Here\u2019s an example:"),Ie.forEach(s),xd=p(t),v(La.$$.fragment,t),Cd=p(t),bs=r(t,"P",{});var ma=i(bs);cf=n(ma,"Note that "),Uo=r(ma,"A",{href:!0});var n1=i(Uo);hf=n(n1,"TapasTokenizer"),n1.forEach(s),uf=n(ma," expects the data of the table to be "),vl=r(ma,"STRONG",{});var o1=i(vl);mf=n(o1,"text-only"),o1.forEach(s),gf=n(ma,". You can use "),wl=r(ma,"CODE",{});var r1=i(wl);ff=n(r1,".astype(str)"),r1.forEach(s),_f=n(ma,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),ma.forEach(s),Md=p(t),v(Qa.$$.fragment,t),Pd=p(t),X=r(t,"P",{});var ge=i(X);Tf=n(ge,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),yl=r(ge,"STRONG",{});var i1=i(yl);bf=n(i1,"not conversational"),i1.forEach(s),vf=n(ge,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),kl=r(ge,"CODE",{});var l1=i(kl);wf=n(l1,"queries"),l1.forEach(s),yf=n(ge,", "),jl=r(ge,"CODE",{});var p1=i(jl);kf=n(p1,"answer_coordinates"),p1.forEach(s),jf=n(ge," and "),ql=r(ge,"CODE",{});var d1=i(ql);qf=n(d1,"answer_text"),d1.forEach(s),Ef=n(ge," per table (in the order of their "),El=r(ge,"CODE",{});var c1=i(El);Ff=n(c1,"position"),c1.forEach(s),Af=n(ge,`
index) and batch encode each table with its questions. This will make sure that the `),Fl=r(ge,"CODE",{});var h1=i(Fl);$f=n(h1,"prev_labels"),h1.forEach(s),zf=n(ge," token types (see docs of "),Ho=r(ge,"A",{href:!0});var u1=i(Ho);xf=n(u1,"TapasTokenizer"),u1.forEach(s),Cf=n(ge,") are set correctly. See "),Oa=r(ge,"A",{href:!0,rel:!0});var m1=i(Oa);Mf=n(m1,"this notebook"),m1.forEach(s),Pf=n(ge," for more info. See "),Ia=r(ge,"A",{href:!0,rel:!0});var g1=i(Ia);Sf=n(g1,"this notebook"),g1.forEach(s),Df=n(ge," for more info regarding using the TensorFlow model."),ge.forEach(s),Sd=p(t),Bo=r(t,"P",{});var f1=i(Bo);Al=r(f1,"STRONG",{});var _1=i(Al);Nf=n(_1,"STEP 4: Train (fine-tune) TapasForQuestionAnswering/TFTapasForQuestionAnswering"),_1.forEach(s),f1.forEach(s),Dd=p(t),Ms=r(t,"P",{});var Mr=i(Ms);Lf=n(Mr,"You can then fine-tune "),Go=r(Mr,"A",{href:!0});var T1=i(Go);Qf=n(T1,"TapasForQuestionAnswering"),T1.forEach(s),Of=n(Mr," or "),Ro=r(Mr,"A",{href:!0});var b1=i(Ro);If=n(b1,"TFTapasForQuestionAnswering"),b1.forEach(s),Wf=n(Mr," as follows (shown here for the weak supervision for aggregation case):"),Mr.forEach(s),Nd=p(t),v(Wa.$$.fragment,t),Ld=p(t),tt=r(t,"H2",{class:!0});var Fc=i(tt);Lt=r(Fc,"A",{id:!0,class:!0,href:!0});var v1=i(Lt);$l=r(v1,"SPAN",{});var w1=i($l);v(Ua.$$.fragment,w1),w1.forEach(s),v1.forEach(s),Uf=p(Fc),zl=r(Fc,"SPAN",{});var y1=i(zl);Hf=n(y1,"Usage: inference"),y1.forEach(s),Fc.forEach(s),Qd=p(t),me=r(t,"P",{});var He=i(me);Bf=n(He,"Here we explain how you can use "),Vo=r(He,"A",{href:!0});var k1=i(Vo);Gf=n(k1,"TapasForQuestionAnswering"),k1.forEach(s),Rf=n(He," or "),Ko=r(He,"A",{href:!0});var j1=i(Ko);Vf=n(j1,"TFTapasForQuestionAnswering"),j1.forEach(s),Kf=n(He," for inference (i.e. making predictions on new data). For inference, only "),xl=r(He,"CODE",{});var q1=i(xl);Yf=n(q1,"input_ids"),q1.forEach(s),Jf=n(He,", "),Cl=r(He,"CODE",{});var E1=i(Cl);Xf=n(E1,"attention_mask"),E1.forEach(s),Zf=n(He," and "),Ml=r(He,"CODE",{});var F1=i(Ml);e_=n(F1,"token_type_ids"),F1.forEach(s),s_=n(He," (which you can obtain using "),Yo=r(He,"A",{href:!0});var A1=i(Yo);t_=n(A1,"TapasTokenizer"),A1.forEach(s),a_=n(He,") have to be provided to the model to obtain the logits. Next, you can use the handy "),Pl=r(He,"CODE",{});var $1=i(Pl);n_=n($1,"convert_logits_to_predictions"),$1.forEach(s),o_=n(He," method to convert these into predicted coordinates and optional aggregation indices."),He.forEach(s),Od=p(t),Qt=r(t,"P",{});var Ac=i(Qt);r_=n(Ac,"However, note that inference is "),Sl=r(Ac,"STRONG",{});var z1=i(Sl);i_=n(z1,"different"),z1.forEach(s),l_=n(Ac," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),Ac.forEach(s),Id=p(t),v(Ha.$$.fragment,t),Wd=p(t),Ue=r(t,"P",{});var ys=i(Ue);p_=n(ys,"In case of a conversational set-up, then each table-question pair must be provided "),Dl=r(ys,"STRONG",{});var x1=i(Dl);d_=n(x1,"sequentially"),x1.forEach(s),c_=n(ys," to the model, such that the "),Nl=r(ys,"CODE",{});var C1=i(Nl);h_=n(C1,"prev_labels"),C1.forEach(s),u_=n(ys," token types can be overwritten by the predicted "),Ll=r(ys,"CODE",{});var M1=i(Ll);m_=n(M1,"labels"),M1.forEach(s),g_=n(ys," of the previous table-question pair. Again, more info can be found in "),Ba=r(ys,"A",{href:!0,rel:!0});var P1=i(Ba);f_=n(P1,"this notebook"),P1.forEach(s),__=n(ys," (for PyTorch) and "),Ga=r(ys,"A",{href:!0,rel:!0});var S1=i(Ga);T_=n(S1,"this notebook"),S1.forEach(s),b_=n(ys," (for TensorFlow)."),ys.forEach(s),Ud=p(t),at=r(t,"H2",{class:!0});var $c=i(at);Ot=r($c,"A",{id:!0,class:!0,href:!0});var D1=i(Ot);Ql=r(D1,"SPAN",{});var N1=i(Ql);v(Ra.$$.fragment,N1),N1.forEach(s),D1.forEach(s),v_=p($c),Ol=r($c,"SPAN",{});var L1=i(Ol);w_=n(L1,"TAPAS specific outputs"),L1.forEach(s),$c.forEach(s),Hd=p(t),nt=r(t,"DIV",{class:!0});var zc=i(nt);v(Va.$$.fragment,zc),y_=p(zc),Ka=r(zc,"P",{});var xc=i(Ka);k_=n(xc,"Output type of "),Jo=r(xc,"A",{href:!0});var Q1=i(Jo);j_=n(Q1,"TapasForQuestionAnswering"),Q1.forEach(s),q_=n(xc,"."),xc.forEach(s),zc.forEach(s),Bd=p(t),ot=r(t,"H2",{class:!0});var Cc=i(ot);It=r(Cc,"A",{id:!0,class:!0,href:!0});var O1=i(It);Il=r(O1,"SPAN",{});var I1=i(Il);v(Ya.$$.fragment,I1),I1.forEach(s),O1.forEach(s),E_=p(Cc),Wl=r(Cc,"SPAN",{});var W1=i(Wl);F_=n(W1,"TapasConfig"),W1.forEach(s),Cc.forEach(s),Gd=p(t),Xe=r(t,"DIV",{class:!0});var Ds=i(Xe);v(Ja.$$.fragment,Ds),A_=p(Ds),gs=r(Ds,"P",{});var Ns=i(gs);$_=n(Ns,"This is the configuration class to store the configuration of a "),Xo=r(Ns,"A",{href:!0});var U1=i(Xo);z_=n(U1,"TapasModel"),U1.forEach(s),x_=n(Ns,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS `),Ul=r(Ns,"EM",{});var H1=i(Ul);C_=n(H1,"tapas-base-finetuned-sqa"),H1.forEach(s),M_=n(Ns,` architecture.
Configuration objects inherit from `),Hl=r(Ns,"CODE",{});var B1=i(Hl);P_=n(B1,"PreTrainedConfig"),B1.forEach(s),S_=n(Ns,` and can be used to control the model outputs. Read the
documentation from `),Zo=r(Ns,"A",{href:!0});var G1=i(Zo);D_=n(G1,"PretrainedConfig"),G1.forEach(s),N_=n(Ns," for more information."),Ns.forEach(s),L_=p(Ds),Xa=r(Ds,"P",{});var Mc=i(Xa);Q_=n(Mc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Za=r(Mc,"A",{href:!0,rel:!0});var R1=i(Za);O_=n(R1,"https://github.com/google-research/tapas/tree/master"),R1.forEach(s),I_=n(Mc,"."),Mc.forEach(s),W_=p(Ds),Bl=r(Ds,"P",{});var V1=i(Bl);U_=n(V1,"Example:"),V1.forEach(s),H_=p(Ds),v(en.$$.fragment,Ds),Ds.forEach(s),Rd=p(t),rt=r(t,"H2",{class:!0});var Pc=i(rt);Wt=r(Pc,"A",{id:!0,class:!0,href:!0});var K1=i(Wt);Gl=r(K1,"SPAN",{});var Y1=i(Gl);v(sn.$$.fragment,Y1),Y1.forEach(s),K1.forEach(s),B_=p(Pc),Rl=r(Pc,"SPAN",{});var J1=i(Rl);G_=n(J1,"TapasTokenizer"),J1.forEach(s),Pc.forEach(s),Vd=p(t),de=r(t,"DIV",{class:!0});var Be=i(de);v(tn.$$.fragment,Be),R_=p(Be),Vl=r(Be,"P",{});var X1=i(Vl);V_=n(X1,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),X1.forEach(s),K_=p(Be),ne=r(Be,"P",{});var fe=i(ne);Y_=n(fe,"This tokenizer inherits from "),er=r(fe,"A",{href:!0});var Z1=i(er);J_=n(Z1,"PreTrainedTokenizer"),Z1.forEach(s),X_=n(fe,` which contains most of the main methods. Users should refer to
