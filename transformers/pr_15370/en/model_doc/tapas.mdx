...
Here we explain how you can fine-tune [TapasForQuestionAnswering](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForQuestionAnswering) on your own dataset.

**STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment**

Basically, there are 3 different ways in which one can fine-tune [TapasForQuestionAnswering](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForQuestionAnswering), corresponding to the different datasets on which Tapas was fine-tuned:
...
Note that [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer) expects the data of the table to be **text-only**. You can use `.astype(str)` on a dataframe to turn it into text-only data.
...
Output type of [TapasForQuestionAnswering](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForQuestionAnswering).
...
- **type_vocab_sizes** (`List[int]`, *optional*, defaults to `[3, 256, 256, 2, 256, 256, 10]`) --
  The vocabulary sizes of the `token_type_ids` passed when calling [TapasModel](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasModel).
...
This is the configuration class to store the configuration of a [TapasModel](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasModel). It is used to instantiate a TAPAS
...
this superclass for more information regarding those methods. [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer) creates several token type ids to
...
[TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer) runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.
...
<div class="docstring">
<docstring><name>convert\_logits\_to\_predictions</name><anchor>transformers.TapasTokenizer.convert_logits_to_predictions</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/tokenization_tapas.py#L1891</source><parameters>[{"name": "data", "val": ""}, {"name": "logits", "val": ""}, {"name": "logits_agg", "val": " = None"}, {"name": "cell_classification_threshold", "val": " = 0.5"}]</parameters><paramsdesc>- **data** (`dict`) --
  Dictionary mapping features to actual values. Should be created using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer).
...
Converts logits of [TapasForQuestionAnswering](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForQuestionAnswering) to actual predicted answer coordinates and optional
aggregation indices.
...
<docstring><name>class transformers.TapasModel</name><anchor>transformers.TapasModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L856</source><parameters>[{"name": "config", "val": ""}, {"name": "add_pooling_layer", "val": " = True"}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
...
This class is a small change compared to [BertModel](/docs/transformers/pr_15370/en/model_doc/bert#transformers.BertModel), taking into account the additional token type ids.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.TapasModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L894</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "encoder_hidden_states", "val": " = None"}, {"name": "encoder_attention_mask", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. Indices can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). See
  [PreTrainedTokenizer.encode()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.
...
- **token_type_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length, 7)`, *optional*) --
  Token indices that encode tabular structure. Indices can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). See this
  class for more info.

  [What are token type IDs?](../glossary#token-type-ids)
- **position_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  Indices of positions of each input sequence tokens in the position embeddings. If
  `reset_position_index_per_cell` of [TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig) is set to `True`, relative position embeddings will be
...
elements depending on the configuration ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) and inputs.
...
The [TapasModel](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.TapasForMaskedLM</name><anchor>transformers.TapasForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L1009</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15370/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.TapasForMaskedLM.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L1028</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "encoder_hidden_states", "val": " = None"}, {"name": "encoder_attention_mask", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. Indices can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). See
  [PreTrainedTokenizer.encode()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TapasForMaskedLM](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForMaskedLM) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.TapasForSequenceClassification</name><anchor>transformers.TapasForSequenceClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L1468</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15370/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.TapasForSequenceClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L1480</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. Indices can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). See
  [PreTrainedTokenizer.encode()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TapasForSequenceClassification](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForSequenceClassification) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.TapasForQuestionAnswering</name><anchor>transformers.TapasForQuestionAnswering</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L1124</source><parameters>[{"name": "config", "val": ": TapasConfig"}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15370/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.TapasForQuestionAnswering.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tapas.py#L1159</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "table_mask", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "aggregation_labels", "val": " = None"}, {"name": "float_answer", "val": " = None"}, {"name": "numeric_values", "val": " = None"}, {"name": "numeric_values_scale", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. Indices can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). See
  [PreTrainedTokenizer.encode()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/pr_15370/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.
...
- **labels** (`torch.LongTensor` of shape `(batch_size, seq_length)`, *optional*) --
  ...
  answer appearing in the table. Can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer).
...
- **numeric_values** (`torch.FloatTensor` of shape `(batch_size, seq_length)`, *optional*) --
  ...
  [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). Only required in case of weak supervision for aggregation (WTQ) to calculate the
  regression loss.
- **numeric_values_scale** (`torch.FloatTensor` of shape `(batch_size, seq_length)`, *optional*) --
  Scale of the numeric values of every token. Can be obtained using [TapasTokenizer](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasTokenizer). Only required in case
...
The [TapasForQuestionAnswering](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasForQuestionAnswering) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.TFTapasModel</name><anchor>transformers.TFTapasModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tf_tapas.py#L976</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15370/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
configuration ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) and inputs.
...
- **attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TFTapasModel](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TFTapasModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.TFTapasForMaskedLM</name><anchor>transformers.TFTapasForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tf_tapas.py#L1066</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15370/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
Tapas Model with a `language modeling` head on top.
...
- **attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TFTapasForMaskedLM](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TFTapasForMaskedLM) forward method, overrides the `__call__` special method.
...
- **attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TFTapasForSequenceClassification](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TFTapasForSequenceClassification) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.TFTapasForQuestionAnswering</name><anchor>transformers.TFTapasForQuestionAnswering</anchor><source>https://github.com/huggingface/transformers/blob/pr_15370/src/transformers/models/tapas/modeling_tf_tapas.py#L1292</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([TapasConfig](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TapasConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15370/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **attentions** (`tuple(tf.Tensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  sequence_length)`. Attentions weights after the attention softmax, used to compute the weighted average in
  the self-attention heads.</retdesc></docstring>
The [TFTapasForQuestionAnswering](/docs/transformers/pr_15370/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering) forward method, overrides the `__call__` special method.
