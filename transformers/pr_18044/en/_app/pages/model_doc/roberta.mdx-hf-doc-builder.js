...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18044/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18044/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18044/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
special tokens using the tokenizer `),yc=s(Ql,"CODE",{});var e4=a(yc);d_=i(e4,"prepare_for_model"),e4.forEach(t),c_=i(Ql," method."),Ql.forEach(t),Hl.forEach(t),p_=h(Fe),$n=s(Fe,"DIV",{class:!0});var Dm=a($n);y(ja.$$.fragment,Dm),h_=h(Dm),wc=s(Dm,"P",{});var t4=a(wc);u_=i(t4,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),t4.forEach(t),Dm.forEach(t),m_=h(Fe),od=s(Fe,"DIV",{class:!0});var o4=a(od);y(Pa.$$.fragment,o4),o4.forEach(t),Fe.forEach(t),Ku=h(o),vo=s(o,"H2",{class:!0});var Sm=a(vo);Fn=s(Sm,"A",{id:!0,class:!0,href:!0});var n4=a(Fn);$c=s(n4,"SPAN",{});var s4=a($c);y(La.$$.fragment,s4),s4.forEach(t),n4.forEach(t),f_=h(Sm),Fc=s(Sm,"SPAN",{});var a4=a(Fc);g_=i(a4,"RobertaTokenizerFast"),a4.forEach(t),Sm.forEach(t),Gu=h(o),Le=s(o,"DIV",{class:!0});var Ye=a(Le);y(Aa.$$.fragment,Ye),__=h(Ye),Oa=s(Ye,"P",{});var Wm=a(Oa);b_=i(Wm,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),xc=s(Wm,"EM",{});var r4=a(xc);k_=i(r4,"tokenizers"),r4.forEach(t),v_=i(Wm,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),Wm.forEach(t),T_=h(Ye),Rc=s(Ye,"P",{});var i4=a(Rc);y_=i(i4,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),i4.forEach(t),w_=h(Ye),y(xn.$$.fragment,Ye),$_=h(Ye),Na=s(Ye,"P",{});var Bm=a(Na);F_=i(Bm,"You can get around that behavior by passing "),Mc=s(Bm,"CODE",{});var l4=a(Mc);x_=i(l4,"add_prefix_space=True"),l4.forEach(t),R_=i(Bm,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Bm.forEach(t),M_=h(Ye),y(Rn.$$.fragment,Ye),E_=h(Ye),Ia=s(Ye,"P",{});var Um=a(Ia);z_=i(Um,"This tokenizer inherits from "),nd=s(Um,"A",{href:!0});var d4=a(nd);q_=i(d4,"PreTrainedTokenizerFast"),d4.forEach(t),C_=i(Um,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Um.forEach(t),j_=h(Ye),sd=s(Ye,"DIV",{class:!0});var c4=a(sd);y(Da.$$.fragment,c4),c4.forEach(t),Ye.forEach(t),Xu=h(o),To=s(o,"H2",{class:!0});var Hm=a(To);Mn=s(Hm,"A",{id:!0,class:!0,href:!0});var p4=a(Mn);Ec=s(p4,"SPAN",{});var h4=a(Ec);y(Sa.$$.fragment,h4),h4.forEach(t),p4.forEach(t),P_=h(Hm),zc=s(Hm,"SPAN",{});var u4=a(zc);L_=i(u4,"RobertaModel"),u4.forEach(t),Hm.forEach(t),Yu=h(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);y(Wa.$$.fragment,Ze),A_=h(Ze),qc=s(Ze,"P",{});var m4=a(qc);O_=i(m4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),m4.forEach(t),N_=h(Ze),Ba=s(Ze,"P",{});var Qm=a(Ba);I_=i(Qm,"This model inherits from "),ad=s(Qm,"A",{href:!0});var f4=a(ad);D_=i(f4,"PreTrainedModel"),f4.forEach(t),S_=i(Qm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qm.forEach(t),W_=h(Ze),Ua=s(Ze,"P",{});var Jm=a(Ua);B_=i(Jm,"This model is also a PyTorch "),Ha=s(Jm,"A",{href:!0,rel:!0});var g4=a(Ha);U_=i(g4,"torch.nn.Module"),g4.forEach(t),H_=i(Jm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),Cc=s(Vm,"EM",{});var _4=a(Cc);V_=i(_4,`Attention is
all you need`),_4.forEach(t),K_=i(Vm,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),Vm.forEach(t),G_=h(Ze),He=s(Ze,"P",{});var mt=a(He);X_=i(mt,"To behave as an decoder the model needs to be initialized with the "),jc=s(mt,"CODE",{});var b4=a(jc);Y_=i(b4,"is_decoder"),b4.forEach(t),Z_=i(mt,` argument of the configuration set
to `),Pc=s(mt,"CODE",{});var k4=a(Pc);eb=i(k4,"True"),k4.forEach(t),tb=i(mt,". To be used in a Seq2Seq model, the model needs to initialized with both "),Lc=s(mt,"CODE",{});var v4=a(Lc);ob=i(v4,"is_decoder"),v4.forEach(t),nb=i(mt,` argument and
`),Ac=s(mt,"CODE",{});var T4=a(Ac);sb=i(T4,"add_cross_attention"),T4.forEach(t),ab=i(mt," set to "),Oc=s(mt,"CODE",{});var y4=a(Oc);rb=i(y4,"True"),y4.forEach(t),ib=i(mt,"; an "),Nc=s(mt,"CODE",{});var w4=a(Nc);lb=i(w4,"encoder_hidden_states"),w4.forEach(t),db=i(mt," is then expected as an input to the forward pass."),mt.forEach(t),cb=h(Ze),En=s(Ze,"P",{});var Bu=a(En);pb=i(Bu,".. _"),Ic=s(Bu,"EM",{});var $4=a(Ic);hb=i($4,"Attention is all you need"),$4.forEach(t),ub=i(Bu,": "),Ja=s(Bu,"A",{href:!0,rel:!0});var F4=a(Ja);mb=i(F4,"https://arxiv.org/abs/1706.03762"),F4.forEach(t),Bu.forEach(t),fb=h(Ze),$t=s(Ze,"DIV",{class:!0});var ea=a($t);y(Va.$$.fragment,ea),gb=h(ea),yo=s(ea,"P",{});var Wd=a(yo);_b=i(Wd,"The "),rd=s(Wd,"A",{href:!0});var x4=a(rd);bb=i(x4,"RobertaModel"),x4.forEach(t),kb=i(Wd," forward method, overrides the "),Dc=s(Wd,"CODE",{});var R4=a(Dc);vb=i(R4,"__call__"),R4.forEach(t),Tb=i(Wd," special method."),Wd.forEach(t),yb=h(ea),y(zn.$$.fragment,ea),wb=h(ea),y(qn.$$.fragment,ea),ea.forEach(t),Ze.forEach(t),Zu=h(o),wo=s(o,"H2",{class:!0});var Km=a(wo);Cn=s(Km,"A",{id:!0,class:!0,href:!0});var M4=a(Cn);Sc=s(M4,"SPAN",{});var E4=a(Sc);y(Ka.$$.fragment,E4),E4.forEach(t),M4.forEach(t),$b=h(Km),Wc=s(Km,"SPAN",{});var z4=a(Wc);Fb=i(z4,"RobertaForCausalLM"),z4.forEach(t),Km.forEach(t),em=h(o),tt=s(o,"DIV",{class:!0});var oo=a(tt);y(Ga.$$.fragment,oo),xb=h(oo),Xa=s(oo,"P",{});var Gm=a(Xa);Rb=i(Gm,"RoBERTa Model with a "),Bc=s(Gm,"CODE",{});var q4=a(Bc);Mb=i(q4,"language modeling"),q4.forEach(t),Eb=i(Gm," head on top for CLM fine-tuning."),Gm.forEach(t),zb=h(oo),Ya=s(oo,"P",{});var Xm=a(Ya);qb=i(Xm,"This model inherits from "),id=s(Xm,"A",{href:!0});var C4=a(id);Cb=i(C4,"PreTrainedModel"),C4.forEach(t),jb=i(Xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xm.forEach(t),Pb=h(oo),Za=s(oo,"P",{});var Ym=a(Za);Lb=i(Ym,"This model is also a PyTorch "),er=s(Ym,"A",{href:!0,rel:!0});var j4=a(er);Ab=i(j4,"torch.nn.Module"),j4.forEach(t),Ob=i(Ym,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ym.forEach(t),Nb=h(oo),Ft=s(oo,"DIV",{class:!0});var ta=a(Ft);y(tr.$$.fragment,ta),Ib=h(ta),$o=s(ta,"P",{});var Bd=a($o);Db=i(Bd,"The "),ld=s(Bd,"A",{href:!0});var P4=a(ld);Sb=i(P4,"RobertaForCausalLM"),P4.forEach(t),Wb=i(Bd," forward method, overrides the "),Uc=s(Bd,"CODE",{});var L4=a(Uc);Bb=i(L4,"__call__"),L4.forEach(t),Ub=i(Bd," special method."),Bd.forEach(t),Hb=h(ta),y(jn.$$.fragment,ta),Qb=h(ta),y(Pn.$$.fragment,ta),ta.forEach(t),oo.forEach(t),tm=h(o),Fo=s(o,"H2",{class:!0});var Zm=a(Fo);Ln=s(Zm,"A",{id:!0,class:!0,href:!0});var A4=a(Ln);Hc=s(A4,"SPAN",{});var O4=a(Hc);y(or.$$.fragment,O4),O4.forEach(t),A4.forEach(t),Jb=h(Zm),Qc=s(Zm,"SPAN",{});var N4=a(Qc);Vb=i(N4,"RobertaForMaskedLM"),N4.forEach(t),Zm.forEach(t),om=h(o),ot=s(o,"DIV",{class:!0});var no=a(ot);y(nr.$$.fragment,no),Kb=h(no),sr=s(no,"P",{});var ef=a(sr);Gb=i(ef,"RoBERTa Model with a "),Jc=s(ef,"CODE",{});var I4=a(Jc);Xb=i(I4,"language modeling"),I4.forEach(t),Yb=i(ef," head on top."),ef.forEach(t),Zb=h(no),ar=s(no,"P",{});var tf=a(ar);ek=i(tf,"This model inherits from "),dd=s(tf,"A",{href:!0});var D4=a(dd);tk=i(D4,"PreTrainedModel"),D4.forEach(t),ok=i(tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tf.forEach(t),nk=h(no),rr=s(no,"P",{});var of=a(rr);sk=i(of,"This model is also a PyTorch "),ir=s(of,"A",{href:!0,rel:!0});var S4=a(ir);ak=i(S4,"torch.nn.Module"),S4.forEach(t),rk=i(of,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),of.forEach(t),ik=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(lr.$$.fragment,so),lk=h(so),xo=s(so,"P",{});var Ud=a(xo);dk=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var W4=a(cd);ck=i(W4,"RobertaForMaskedLM"),W4.forEach(t),pk=i(Ud," forward method, overrides the "),Vc=s(Ud,"CODE",{});var B4=a(Vc);hk=i(B4,"__call__"),B4.forEach(t),uk=i(Ud," special method."),Ud.forEach(t),mk=h(so),y(An.$$.fragment,so),fk=h(so),y(On.$$.fragment,so),gk=h(so),y(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nm=h(o),Ro=s(o,"H2",{class:!0});var nf=a(Ro);In=s(nf,"A",{id:!0,class:!0,href:!0});var U4=a(In);Kc=s(U4,"SPAN",{});var H4=a(Kc);y(dr.$$.fragment,H4),H4.forEach(t),U4.forEach(t),_k=h(nf),Gc=s(nf,"SPAN",{});var Q4=a(Gc);bk=i(Q4,"RobertaForSequenceClassification"),Q4.forEach(t),nf.forEach(t),sm=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);y(cr.$$.fragment,ao),kk=h(ao),Xc=s(ao,"P",{});var J4=a(Xc);vk=i(J4,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J4.forEach(t),Tk=h(ao),pr=s(ao,"P",{});var sf=a(pr);yk=i(sf,"This model inherits from "),pd=s(sf,"A",{href:!0});var V4=a(pd);wk=i(V4,"PreTrainedModel"),V4.forEach(t),$k=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sf.forEach(t),Fk=h(ao),hr=s(ao,"P",{});var af=a(hr);xk=i(af,"This model is also a PyTorch "),ur=s(af,"A",{href:!0,rel:!0});var K4=a(ur);Rk=i(K4,"torch.nn.Module"),K4.forEach(t),Mk=i(af,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),af.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ft=a(Ue);y(mr.$$.fragment,ft),zk=h(ft),Mo=s(ft,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G4=a(hd);Ck=i(G4,"RobertaForSequenceClassification"),G4.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X4=a(Yc);Pk=i(X4,"__call__"),X4.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ft),y(Dn.$$.fragment,ft),Ok=h(ft),y(Sn.$$.fragment,ft),Nk=h(ft),y(Wn.$$.fragment,ft),Ik=h(ft),y(Bn.$$.fragment,ft),Dk=h(ft),y(Un.$$.fragment,ft),ft.forEach(t),ao.forEach(t),am=h(o),Eo=s(o,"H2",{class:!0});var rf=a(Eo);Hn=s(rf,"A",{id:!0,class:!0,href:!0});var Y4=a(Hn);Zc=s(Y4,"SPAN",{});var Z4=a(Zc);y(fr.$$.fragment,Z4),Z4.forEach(t),Y4.forEach(t),Sk=h(rf),ep=s(rf,"SPAN",{});var eF=a(ep);Wk=i(eF,"RobertaForMultipleChoice"),eF.forEach(t),rf.forEach(t),rm=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);y(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var tF=a(tp);Uk=i(tF,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tF.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lf=a(_r);Qk=i(lf,"This model inherits from "),ud=s(lf,"A",{href:!0});var oF=a(ud);Jk=i(oF,"PreTrainedModel"),oF.forEach(t),Vk=i(lf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lf.forEach(t),Kk=h(ro),br=s(ro,"P",{});var df=a(br);Gk=i(df,"This model is also a PyTorch "),kr=s(df,"A",{href:!0,rel:!0});var nF=a(kr);Xk=i(nF,"torch.nn.Module"),nF.forEach(t),Yk=i(df,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),df.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),md=s(Qd,"A",{href:!0});var sF=a(md);ov=i(sF,"RobertaForMultipleChoice"),sF.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var aF=a(op);sv=i(aF,"__call__"),aF.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),im=h(o),qo=s(o,"H2",{class:!0});var cf=a(qo);Vn=s(cf,"A",{id:!0,class:!0,href:!0});var rF=a(Vn);np=s(rF,"SPAN",{});var iF=a(np);y(Tr.$$.fragment,iF),iF.forEach(t),rF.forEach(t),lv=h(cf),sp=s(cf,"SPAN",{});var lF=a(sp);dv=i(lF,"RobertaForTokenClassification"),lF.forEach(t),cf.forEach(t),lm=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var dF=a(ap);pv=i(dF,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dF.forEach(t),hv=h(io),wr=s(io,"P",{});var pf=a(wr);uv=i(pf,"This model inherits from "),fd=s(pf,"A",{href:!0});var cF=a(fd);mv=i(cF,"PreTrainedModel"),cF.forEach(t),fv=i(pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pf.forEach(t),gv=h(io),$r=s(io,"P",{});var hf=a($r);_v=i(hf,"This model is also a PyTorch "),Fr=s(hf,"A",{href:!0,rel:!0});var pF=a(Fr);bv=i(pF,"torch.nn.Module"),pF.forEach(t),kv=i(hf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hf.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var hF=a(gd);wv=i(hF,"RobertaForTokenClassification"),hF.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var uF=a(rp);Fv=i(uF,"__call__"),uF.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),dm=h(o),jo=s(o,"H2",{class:!0});var uf=a(jo);Yn=s(uf,"A",{id:!0,class:!0,href:!0});var mF=a(Yn);ip=s(mF,"SPAN",{});var fF=a(ip);y(Rr.$$.fragment,fF),fF.forEach(t),mF.forEach(t),zv=h(uf),lp=s(uf,"SPAN",{});var gF=a(lp);qv=i(gF,"RobertaForQuestionAnswering"),gF.forEach(t),uf.forEach(t),cm=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _F=a(dp);Pv=i(_F,"span start logits"),_F.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var bF=a(cp);Av=i(bF,"span end logits"),bF.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var mf=a(Er);Iv=i(mf,"This model inherits from "),_d=s(mf,"A",{href:!0});var kF=a(_d);Dv=i(kF,"PreTrainedModel"),kF.forEach(t),Sv=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mf.forEach(t),Wv=h(co),zr=s(co,"P",{});var ff=a(zr);Bv=i(ff,"This model is also a PyTorch "),qr=s(ff,"A",{href:!0,rel:!0});var vF=a(qr);Uv=i(vF,"torch.nn.Module"),vF.forEach(t),Hv=i(ff,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ff.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var TF=a(bd);Kv=i(TF,"RobertaForQuestionAnswering"),TF.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var yF=a(pp);Xv=i(yF,"__call__"),yF.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),pm=h(o),Ao=s(o,"H2",{class:!0});var gf=a(Ao);os=s(gf,"A",{id:!0,class:!0,href:!0});var wF=a(os);hp=s(wF,"SPAN",{});var $F=a(hp);y(jr.$$.fragment,$F),$F.forEach(t),wF.forEach(t),oT=h(gf),up=s(gf,"SPAN",{});var FF=a(up);nT=i(FF,"TFRobertaModel"),FF.forEach(t),gf.forEach(t),hm=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),mp=s(Ot,"P",{});var xF=a(mp);aT=i(xF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xF.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _f=a(Lr);iT=i(_f,"This model inherits from "),kd=s(_f,"A",{href:!0});var RF=a(kd);lT=i(RF,"TFPreTrainedModel"),RF.forEach(t),dT=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bf=a(Ar);pT=i(bf,"This model is also a "),Or=s(bf,"A",{href:!0,rel:!0});var MF=a(Or);hT=i(MF,"tf.keras.Model"),MF.forEach(t),uT=i(bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bf.forEach(t),mT=h(Ot),y(ns.$$.fragment,Ot),fT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var EF=a(vd);bT=i(EF,"TFRobertaModel"),EF.forEach(t),kT=i(Gd," forward method, overrides the "),fp=s(Gd,"CODE",{});var zF=a(fp);vT=i(zF,"__call__"),zF.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),um=h(o),No=s(o,"H2",{class:!0});var kf=a(No);rs=s(kf,"A",{id:!0,class:!0,href:!0});var qF=a(rs);gp=s(qF,"SPAN",{});var CF=a(gp);y(Ir.$$.fragment,CF),CF.forEach(t),qF.forEach(t),$T=h(kf),_p=s(kf,"SPAN",{});var jF=a(_p);FT=i(jF,"TFRobertaForCausalLM"),jF.forEach(t),kf.forEach(t),mm=h(o),Io=s(o,"DIV",{class:!0});var vf=a(Io);y(Dr.$$.fragment,vf),xT=h(vf),Mt=s(vf,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var PF=a(Td);ET=i(PF,"TFRobertaForCausalLM"),PF.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var LF=a(bp);qT=i(LF,"__call__"),LF.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vf.forEach(t),fm=h(o),So=s(o,"H2",{class:!0});var Tf=a(So);ds=s(Tf,"A",{id:!0,class:!0,href:!0});var AF=a(ds);kp=s(AF,"SPAN",{});var OF=a(kp);y(Wr.$$.fragment,OF),OF.forEach(t),AF.forEach(t),LT=h(Tf),vp=s(Tf,"SPAN",{});var NF=a(vp);AT=i(NF,"TFRobertaForMaskedLM"),NF.forEach(t),Tf.forEach(t),gm=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var yf=a(Ur);NT=i(yf,"RoBERTa Model with a "),Tp=s(yf,"CODE",{});var IF=a(Tp);IT=i(IF,"language modeling"),IF.forEach(t),DT=i(yf," head on top."),yf.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wf=a(Hr);WT=i(wf,"This model inherits from "),yd=s(wf,"A",{href:!0});var DF=a(yd);BT=i(DF,"TFPreTrainedModel"),DF.forEach(t),UT=i(wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wf.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $f=a(Qr);QT=i($f,"This model is also a "),Jr=s($f,"A",{href:!0,rel:!0});var SF=a(Jr);JT=i(SF,"tf.keras.Model"),SF.forEach(t),VT=i($f,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$f.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var WF=a(wd);ZT=i(WF,"TFRobertaForMaskedLM"),WF.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var BF=a(yp);ty=i(BF,"__call__"),BF.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),_m=h(o),Bo=s(o,"H2",{class:!0});var Ff=a(Bo);ms=s(Ff,"A",{id:!0,class:!0,href:!0});var UF=a(ms);wp=s(UF,"SPAN",{});var HF=a(wp);y(Kr.$$.fragment,HF),HF.forEach(t),UF.forEach(t),ry=h(Ff),$p=s(Ff,"SPAN",{});var QF=a($p);iy=i(QF,"TFRobertaForSequenceClassification"),QF.forEach(t),Ff.forEach(t),bm=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var JF=a(Fp);dy=i(JF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),JF.forEach(t),cy=h(It),Xr=s(It,"P",{});var xf=a(Xr);py=i(xf,"This model inherits from "),$d=s(xf,"A",{href:!0});var VF=a($d);hy=i(VF,"TFPreTrainedModel"),VF.forEach(t),uy=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xf.forEach(t),my=h(It),Yr=s(It,"P",{});var Rf=a(Yr);fy=i(Rf,"This model is also a "),Zr=s(Rf,"A",{href:!0,rel:!0});var KF=a(Zr);gy=i(KF,"tf.keras.Model"),KF.forEach(t),_y=i(Rf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rf.forEach(t),by=h(It),y(fs.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vy=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var GF=a(Fd);yy=i(GF,"TFRobertaForSequenceClassification"),GF.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var XF=a(xp);$y=i(XF,"__call__"),XF.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(uo),y(gs.$$.fragment,uo),Ry=h(uo),y(_s.$$.fragment,uo),My=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),km=h(o),Ho=s(o,"H2",{class:!0});var Mf=a(Ho);ks=s(Mf,"A",{id:!0,class:!0,href:!0});var YF=a(ks);Rp=s(YF,"SPAN",{});var ZF=a(Rp);y(ti.$$.fragment,ZF),ZF.forEach(t),YF.forEach(t),Ey=h(Mf),Mp=s(Mf,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mf.forEach(t),vm=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
