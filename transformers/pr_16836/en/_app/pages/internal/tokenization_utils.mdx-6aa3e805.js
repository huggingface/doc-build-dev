import{S as Fm,i as Cm,s as Om,e as r,k as d,w as k,t as o,M as Wm,c as s,d as t,m as l,a,x as b,h as n,b as m,F as e,g as P,y as v,q as T,o as y,B as w,v as jm,L as ks}from"../../chunks/vendor-6b77c823.js";import{T as Pr}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-1088f2fb.js";import{C as bs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _s}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as gs}from"../../chunks/ExampleCodeBlock-5212b321.js";function Rm(E){let p,$,f,h,x;return{c(){p=r("p"),$=o("This method is deprecated, "),f=r("code"),h=o("__call__"),x=o(" should be used instead.")},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"This method is deprecated, "),f=s(_,"CODE",{});var L=a(f);h=n(L,"__call__"),L.forEach(t),x=n(_," should be used instead."),_.forEach(t)},m(c,_){P(c,p,_),e(p,$),e(p,f),e(f,h),e(p,x)},d(c){c&&t(p)}}}function Mm(E){let p,$,f,h,x;return{c(){p=r("p"),$=o("This method is deprecated, "),f=r("code"),h=o("__call__"),x=o(" should be used instead.")},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"This method is deprecated, "),f=s(_,"CODE",{});var L=a(f);h=n(L,"__call__"),L.forEach(t),x=n(_," should be used instead."),_.forEach(t)},m(c,_){P(c,p,_),e(p,$),e(p,f),e(f,h),e(p,x)},d(c){c&&t(p)}}}function Um(E){let p,$,f,h,x;return{c(){p=r("p"),$=o("Passing "),f=r("code"),h=o("use_auth_token=True"),x=o(" is required when you want to use a private model.")},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Passing "),f=s(_,"CODE",{});var L=a(f);h=n(L,"use_auth_token=True"),L.forEach(t),x=n(_," is required when you want to use a private model."),_.forEach(t)},m(c,_){P(c,p,_),e(p,$),e(p,f),e(f,h),e(p,x)},d(c){c&&t(p)}}}function Vm(E){let p,$,f,h,x;return h=new bs({props:{code:`# We can't instantiate directly the base class *PreTrainedTokenizerBase* so let's show our examples on a derived class: BertTokenizer
...
<span class="hljs-keyword">assert</span> tokenizer.unk_token == <span class="hljs-string">&quot;&lt;unk&gt;&quot;</span>`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Gm(E){let p,$,f,h,x,c,_,L;return{c(){p=r("p"),$=o("If the "),f=r("code"),h=o("encoded_inputs"),x=o(` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
...
PyTorch tensors, you will lose the specific device of your tensors however.`)},l(_e){p=s(_e,"P",{});var W=a(p);$=n(W,"If the "),f=s(W,"CODE",{});var D=a(f);h=n(D,"encoded_inputs"),D.forEach(t),x=n(W,` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
result will use the same type unless you provide a different tensor type with `),c=s(W,"CODE",{});var no=a(c);_=n(no,"return_tensors"),no.forEach(t),L=n(W,`. In the case of
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(_e,W){P(_e,p,W),e(p,$),e(p,f),e(f,h),e(p,x),e(p,c),e(c,_),e(p,L)},d(_e){_e&&t(p)}}}function Hm(E){let p,$,f,h,x;return h=new bs({props:{code:`from transformers import AutoTokenizer
...
tokenizer.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Xm(E){let p,$;return{c(){p=r("p"),$=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(f){p=s(f,"P",{});var h=a(p);$=n(h,"This API is experimental and may have some slight breaking changes in the next releases."),h.forEach(t)},m(f,h){P(f,p,h),e(p,$)},d(f){f&&t(p)}}}function Ym(E){let p,$,f,h,x;return h=new bs({props:{code:`# Let's see how to add a new classification token to GPT-2
...
<span class="hljs-keyword">assert</span> tokenizer.cls_token == <span class="hljs-string">&quot;&lt;CLS&gt;&quot;</span>`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Jm(E){let p,$,f,h,x;return h=new bs({props:{code:`# Let's see how to increase the vocabulary of Bert model and tokenizer
...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Km(E){let p,$,f,h,x,c,_,L,_e,W,D,no,ro,vs,Ts,so,ys,ws,ao,zs,xs,io,$s,Ps,qr,lo,qs,Er,ge,Le,Fo,st,Es,Co,Bs,Br,u,at,Ls,ke,Ds,co,Is,Ns,po,As,Ss,Fs,Oo,Cs,Os,Wo,Ws,js,I,Z,jo,Rs,Ms,Ro,Us,Vs,Mo,Gs,Hs,Xs,S,Uo,Ys,Js,Vo,Ks,Qs,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,sa,U,Yo,aa,ia,Jo,da,la,Ko,ca,pa,Qo,ma,ha,ua,F,Zo,fa,_a,en,ga,ka,tn,ba,va,on,Ta,ya,mo,wa,za,xa,De,nn,$a,Pa,rn,qa,Ea,Ba,V,sn,La,Da,an,Ia,Na,dn,Aa,Sa,ln,Fa,Ca,Oa,G,cn,Wa,ja,pn,Ra,Ma,mn,Ua,Va,hn,Ga,Ha,Xa,Ie,it,Ya,un,Ja,Ka,Ne,dt,Qa,fn,Za,ei,Ae,lt,ti,_n,oi,ni,ee,ct,ri,gn,si,ai,Se,ii,te,pt,di,kn,li,ci,bn,pi,mi,Fe,mt,hi,vn,ui,fi,Ce,ht,_i,ut,gi,Tn,ki,bi,vi,oe,ft,Ti,ho,yi,uo,wi,zi,yn,xi,$i,ne,_t,Pi,wn,qi,Ei,gt,Bi,zn,Li,Di,Ii,re,kt,Ni,xn,Ai,Si,bt,Fi,$n,Ci,Oi,Wi,se,vt,ji,Pn,Ri,Mi,Oe,Ui,H,Tt,Vi,yt,Gi,fo,Hi,Xi,Yi,We,Ji,je,Ki,Re,wt,Qi,be,Zi,qn,ed,td,En,od,nd,rd,ae,zt,sd,Bn,ad,id,ie,Ln,dd,ld,Dn,cd,pd,In,md,hd,ud,X,xt,fd,Nn,_d,gd,J,kd,An,bd,vd,Sn,Td,yd,Fn,wd,zd,xd,Me,$d,Ue,$t,Pd,j,qd,Cn,Ed,Bd,On,Ld,Dd,Wn,Id,Nd,jn,Ad,Sd,Fd,Ve,Pt,Cd,Rn,Od,Wd,de,qt,jd,Et,Rd,Mn,Md,Ud,Vd,Ge,Gd,le,Bt,Hd,Lt,Xd,Un,Yd,Jd,Kd,He,Qd,Y,Dt,Zd,Vn,el,tl,It,ol,Gn,nl,rl,sl,Nt,al,Hn,il,dl,ll,ce,At,cl,Xn,pl,ml,St,hl,Yn,ul,fl,_l,Xe,Ft,gl,Ct,kl,Jn,bl,vl,Tl,Ye,Ot,yl,Kn,wl,Lr,ve,Je,Qn,Wt,zl,Zn,xl,Dr,A,jt,$l,Te,Pl,_o,ql,El,go,Bl,Ll,Dl,B,Rt,Il,er,Nl,Al,tr,Sl,Fl,Mt,Cl,ko,Ol,Wl,jl,Ut,Rl,or,Ml,Ul,Vl,Vt,nr,Gl,Hl,Gt,Xl,rr,Yl,Jl,Kl,R,Ql,bo,Zl,ec,sr,tc,oc,ar,nc,rc,ir,sc,ac,ic,Ke,dc,C,Ht,lc,dr,cc,pc,lr,mc,hc,Xt,uc,vo,fc,_c,gc,Qe,kc,pe,Yt,bc,ye,vc,cr,Tc,yc,pr,wc,zc,xc,mr,$c,Ir,we,Ze,hr,Jt,Pc,ur,qc,Nr,ze,Kt,Ec,xe,Bc,fr,Lc,Dc,et,Ic,_r,Nc,Ac,Sc,Ar,$e,Qt,Fc,gr,Cc,Sr,Pe,Zt,Oc,kr,Wc,Fr;return c=new _s({}),st=new _s({}),at=new q({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2374",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L3245",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2595",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L3278",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2184",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2499",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
using the <a href="/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
<code>additional_special_tokens</code>. See parameters in the <code>__init__</code> for more details.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L1549"}}),We=new Pr({props:{$$slots:{default:[Um]},$$scope:{ctx:E}}}),je=new gs({props:{anchor:"transformers.PreTrainedTokenizerBase.from_pretrained.example",$$slots:{default:[Vm]},$$scope:{ctx:E}}}),wt=new q({props:{name:"get_special_tokens_mask",anchor:"transformers.PreTrainedTokenizerBase.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L3323",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),zt=new q({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L1537",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),xt=new q({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16836/en/internal/file_utils#transformers.utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2899",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16836/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L3433",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L1985",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2146",returnDescription:`
...
<a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L2164",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L3035",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/tokenization_utils_base.py#L831",returnDescription:`
...
or `),Qo=r("code"),ma=o("None"),ha=o(" if the model has no maximum input size."),ua=d(),F=r("li"),Zo=r("strong"),fa=o("pretrained_init_configuration"),_a=o(" ("),en=r("code"),ga=o("Dict[str, Dict[str, Any]]"),ka=o(`) \u2014 A dictionary with, as keys, the
...
with the `),mo=r("a"),wa=o("from_pretrained()"),za=o(" method."),xa=d(),De=r("li"),nn=r("strong"),$a=o("model_input_names"),Pa=o(" ("),rn=r("code"),qa=o("List[str]"),Ea=o(") \u2014 A list of inputs expected in the forward pass of the model."),Ba=d(),V=r("li"),sn=r("strong"),La=o("padding_side"),Da=o(" ("),an=r("code"),Ia=o("str"),Na=o(`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),dn=r("code"),Aa=o("'right'"),Sa=o(" or "),ln=r("code"),Fa=o("'left'"),Ca=o("."),Oa=d(),G=r("li"),cn=r("strong"),Wa=o("truncation_side"),ja=o(" ("),pn=r("code"),Ra=o("str"),Ma=o(`) \u2014 The default value for the side on which the model should have truncation
applied. Should be `),mn=r("code"),Ua=o("'right'"),Va=o(" or "),hn=r("code"),Ga=o("'left'"),Ha=o("."),Xa=d(),Ie=r("div"),k(it.$$.fragment),Ya=d(),un=r("p"),Ja=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
sequence-to-sequence models that need a slightly different processing for the labels.`),ei=d(),Ae=r("div"),k(lt.$$.fragment),ti=d(),_n=r("p"),oi=o("Convert a list of lists of token ids into a list of strings by calling decode."),ni=d(),ee=r("div"),k(ct.$$.fragment),ri=d(),gn=r("p"),si=o("Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),ai=d(),k(Se.$$.fragment),ii=d(),te=r("div"),k(pt.$$.fragment),di=d(),kn=r("p"),li=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),ci=d(),bn=r("p"),pi=o("This implementation does not add special tokens and this method should be overridden in a subclass."),mi=d(),Fe=r("div"),k(mt.$$.fragment),hi=d(),vn=r("p"),ui=o("Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),fi=d(),Ce=r("div"),k(ht.$$.fragment),_i=d(),ut=r("p"),gi=o("Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=r("code"),ki=o('" ".join(tokens)'),bi=o(` but we
often want to remove sub-word tokenization artifacts at the same time.`),vi=d(),oe=r("div"),k(ft.$$.fragment),Ti=d(),ho=r("p"),yi=o("Create the token type IDs corresponding to the sequences passed. "),uo=r("a"),wi=o(`What are token type
IDs?`),zi=d(),yn=r("p"),xi=o("Should be overridden in a subclass if the model has a special way of building those."),$i=d(),ne=r("div"),k(_t.$$.fragment),Pi=d(),wn=r("p"),qi=o(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Ei=d(),gt=r("p"),Bi=o("Similar to doing "),zn=r("code"),Li=o("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Di=o("."),Ii=d(),re=r("div"),k(kt.$$.fragment),Ni=d(),xn=r("p"),Ai=o("Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Si=d(),bt=r("p"),Fi=o("Same as doing "),$n=r("code"),Ci=o("self.convert_tokens_to_ids(self.tokenize(text))"),Oi=o("."),Wi=d(),se=r("div"),k(vt.$$.fragment),ji=d(),Pn=r("p"),Ri=o("Tokenize and prepare for the model a sequence or a pair of sequences."),Mi=d(),k(Oe.$$.fragment),Ui=d(),H=r("div"),k(Tt.$$.fragment),Vi=d(),yt=r("p"),Gi=o("Instantiate a "),fo=r("a"),Hi=o("PreTrainedTokenizerBase"),Xi=o(` (or a derived class) from a predefined
tokenizer.`),Yi=d(),k(We.$$.fragment),Ji=d(),k(je.$$.fragment),Ki=d(),Re=r("div"),k(wt.$$.fragment),Qi=d(),be=r("p"),Zi=o(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),qn=r("code"),ed=o("prepare_for_model"),td=o(" or "),En=r("code"),od=o("encode_plus"),nd=o(" methods."),rd=d(),ae=r("div"),k(zt.$$.fragment),sd=d(),Bn=r("p"),ad=o("Returns the vocabulary as a dictionary of token to index."),id=d(),ie=r("p"),Ln=r("code"),dd=o("tokenizer.get_vocab()[token]"),ld=o(" is equivalent to "),Dn=r("code"),cd=o("tokenizer.convert_tokens_to_ids(token)"),pd=o(" when "),In=r("code"),md=o("token"),hd=o(` is in the
...
`),Sn=r("code"),Td=o("self.pad_token_id"),yd=o(" and "),Fn=r("code"),wd=o("self.pad_token_type_id"),zd=o(")"),xd=d(),k(Me.$$.fragment),$d=d(),Ue=r("div"),k($t.$$.fragment),Pd=d(),j=r("p"),qd=o(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
instance, modifying `),Hn=r("code"),il=o("tokenizer.do_lower_case"),dl=o(" after creation)."),ll=d(),ce=r("div"),k(At.$$.fragment),cl=d(),Xn=r("p"),pl=o("Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),ml=d(),St=r("p"),hl=o(`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Yn=r("code"),ul=o("_save_pretrained()"),fl=o(" to save the whole state of the tokenizer."),_l=d(),Xe=r("div"),k(Ft.$$.fragment),gl=d(),Ct=r("p"),kl=o("Converts a string in a sequence of tokens, replacing unknown tokens with the "),Jn=r("code"),bl=o("unk_token"),vl=o("."),Tl=d(),Ye=r("div"),k(Ot.$$.fragment),yl=d(),Kn=r("p"),wl=o("Truncates a sequence pair in-place following the strategy."),Lr=d(),ve=r("h2"),Je=r("a"),Qn=r("span"),k(Wt.$$.fragment),zl=d(),Zn=r("span"),xl=o("SpecialTokensMixin"),Dr=d(),A=r("div"),k(jt.$$.fragment),$l=d(),Te=r("p"),Pl=o("A mixin derived by "),_o=r("a"),ql=o("PreTrainedTokenizer"),El=o(" and "),go=r("a"),Bl=o("PreTrainedTokenizerFast"),Ll=o(` to handle specific behaviors related to
...
current vocabulary).`),Al=d(),tr=r("p"),Sl=o(`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
matrix of the model so that its embedding matrix matches the tokenizer.`),Fl=d(),Mt=r("p"),Cl=o("In order to do that, please use the "),ko=r("a"),Ol=o("resize_token_embeddings()"),Wl=o(" method."),jl=d(),Ut=r("p"),Rl=o("Using "),or=r("code"),Ml=o("add_special_tokens"),Ul=o(" will ensure your special tokens can be used in several ways:"),Vl=d(),Vt=r("ul"),nr=r("li"),Gl=o("Special tokens are carefully handled by the tokenizer (they are never split)."),Hl=d(),Gt=r("li"),Xl=o("You can easily refer to special tokens using tokenizer class attributes like "),rr=r("code"),Yl=o("tokenizer.cls_token"),Jl=o(`. This
...
`),pr=r("code"),wc=o("tokenizer.cls_token"),zc=o(", etc.) are in the vocabulary."),xc=d(),mr=r("p"),$c=o("Add the missing ones to the vocabulary if needed."),Ir=d(),we=r("h2"),Ze=r("a"),hr=r("span"),k(Jt.$$.fragment),Pc=d(),ur=r("span"),qc=o("Enums and namedtuples"),Nr=d(),ze=r("div"),k(Kt.$$.fragment),Ec=d(),xe=r("p"),Bc=o("Possible values for the "),fr=r("code"),Lc=o("truncation"),Dc=o(" argument in "),et=r("a"),Ic=o("PreTrainedTokenizerBase."),_r=r("strong"),Nc=o("call"),Ac=o("()"),Sc=o(`. Useful for tab-completion in
an IDE.`),Ar=d(),$e=r("div"),k(Qt.$$.fragment),Fc=d(),gr=r("p"),Cc=o("Character span in the original string."),Sr=d(),Pe=r("div"),k(Zt.$$.fragment),Oc=d(),kr=r("p"),Wc=o("Token span in an encoded string (list of tokens)."),this.h()},l(i){const z=Wm('[data-svelte="svelte-1phssyn"]',document.head);p=s(z,"META",{name:!0,content:!0}),z.forEach(t),$=l(i),f=s(i,"H1",{class:!0});var eo=a(f);h=s(eo,"A",{id:!0,class:!0,href:!0});var br=a(h);x=s(br,"SPAN",{});var vr=a(x);b(c.$$.fragment,vr),vr.forEach(t),br.forEach(t),_=l(eo),L=s(eo,"SPAN",{});var Tr=a(L);_e=n(Tr,"Utilities for Tokenizers"),Tr.forEach(t),eo.forEach(t),W=l(i),D=s(i,"P",{});var M=a(D);no=n(M,`This page lists all the utility functions used by the tokenizers, mainly the class
...
`),so=s(M,"A",{href:!0});var wr=a(so);ys=n(wr,"PreTrainedTokenizer"),wr.forEach(t),ws=n(M," and "),ao=s(M,"A",{href:!0});var zr=a(ao);zs=n(zr,"PreTrainedTokenizerFast"),zr.forEach(t),xs=n(M,` and the mixin
`),io=s(M,"A",{href:!0});var xr=a(io);$s=n(xr,"SpecialTokensMixin"),xr.forEach(t),Ps=n(M,"."),M.forEach(t),qr=l(i),lo=s(i,"P",{});var Rc=a(lo);qs=n(Rc,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Rc.forEach(t),Er=l(i),ge=s(i,"H2",{class:!0});var Cr=a(ge);Le=s(Cr,"A",{id:!0,class:!0,href:!0});var Mc=a(Le);Fo=s(Mc,"SPAN",{});var Uc=a(Fo);b(st.$$.fragment,Uc),Uc.forEach(t),Mc.forEach(t),Es=l(Cr),Co=s(Cr,"SPAN",{});var Vc=a(Co);Bs=n(Vc,"PreTrainedTokenizerBase"),Vc.forEach(t),Cr.forEach(t),Br=l(i),u=s(i,"DIV",{class:!0});var g=a(u);b(at.$$.fragment,g),Ls=l(g),ke=s(g,"P",{});var To=a(ke);Ds=n(To,"Base class for "),co=s(To,"A",{href:!0});var Gc=a(co);Is=n(Gc,"PreTrainedTokenizer"),Gc.forEach(t),Ns=n(To," and "),po=s(To,"A",{href:!0});var Hc=a(po);As=n(Hc,"PreTrainedTokenizerFast"),Hc.forEach(t),Ss=n(To,"."),To.forEach(t),Fs=l(g),Oo=s(g,"P",{});var Xc=a(Oo);Cs=n(Xc,"Handles shared (mostly boiler plate) methods for those two classes."),Xc.forEach(t),Os=l(g),Wo=s(g,"P",{});var Yc=a(Wo);Ws=n(Yc,"Class attributes (overridden by derived classes)"),Yc.forEach(t),js=l(g),I=s(g,"UL",{});var O=a(I);Z=s(O,"LI",{});var to=a(Z);jo=s(to,"STRONG",{});var Jc=a(jo);Rs=n(Jc,"vocab_files_names"),Jc.forEach(t),Ms=n(to," ("),Ro=s(to,"CODE",{});var Kc=a(Ro);Us=n(Kc,"Dict[str, str]"),Kc.forEach(t),Vs=n(to,") \u2014 A dictionary with, as keys, the "),Mo=s(to,"CODE",{});var Qc=a(Mo);Gs=n(Qc,"__init__"),Qc.forEach(t),Hs=n(to,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),to.forEach(t),Xs=l(O),S=s(O,"LI",{});var K=a(S);Uo=s(K,"STRONG",{});var Zc=a(Uo);Ys=n(Zc,"pretrained_vocab_files_map"),Zc.forEach(t),Js=n(K," ("),Vo=s(K,"CODE",{});var ep=a(Vo);Ks=n(ep,"Dict[str, Dict[str, str]]"),ep.forEach(t),Qs=n(K,`) \u2014 A dictionary of dictionaries, with the
...
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Qo=s(qe,"CODE",{});var ip=a(Qo);ma=n(ip,"None"),ip.forEach(t),ha=n(qe," if the model has no maximum input size."),qe.forEach(t),ua=l(O),F=s(O,"LI",{});var Q=a(F);Zo=s(Q,"STRONG",{});var dp=a(Zo);fa=n(dp,"pretrained_init_configuration"),dp.forEach(t),_a=n(Q," ("),en=s(Q,"CODE",{});var lp=a(en);ga=n(lp,"Dict[str, Dict[str, Any]]"),lp.forEach(t),ka=n(Q,`) \u2014 A dictionary with, as keys, the
...
with the `),mo=s(Q,"A",{href:!0});var mp=a(mo);wa=n(mp,"from_pretrained()"),mp.forEach(t),za=n(Q," method."),Q.forEach(t),xa=l(O),De=s(O,"LI",{});var $r=a(De);nn=s($r,"STRONG",{});var hp=a(nn);$a=n(hp,"model_input_names"),hp.forEach(t),Pa=n($r," ("),rn=s($r,"CODE",{});var up=a(rn);qa=n(up,"List[str]"),up.forEach(t),Ea=n($r,") \u2014 A list of inputs expected in the forward pass of the model."),$r.forEach(t),Ba=l(O),V=s(O,"LI",{});var Ee=a(V);sn=s(Ee,"STRONG",{});var fp=a(sn);La=n(fp,"padding_side"),fp.forEach(t),Da=n(Ee," ("),an=s(Ee,"CODE",{});var _p=a(an);Ia=n(_p,"str"),_p.forEach(t),Na=n(Ee,`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),dn=s(Ee,"CODE",{});var gp=a(dn);Aa=n(gp,"'right'"),gp.forEach(t),Sa=n(Ee," or "),ln=s(Ee,"CODE",{});var kp=a(ln);Fa=n(kp,"'left'"),kp.forEach(t),Ca=n(Ee,"."),Ee.forEach(t),Oa=l(O),G=s(O,"LI",{});var Be=a(G);cn=s(Be,"STRONG",{});var bp=a(cn);Wa=n(bp,"truncation_side"),bp.forEach(t),ja=n(Be," ("),pn=s(Be,"CODE",{});var vp=a(pn);Ra=n(vp,"str"),vp.forEach(t),Ma=n(Be,`) \u2014 The default value for the side on which the model should have truncation
applied. Should be `),mn=s(Be,"CODE",{});var Tp=a(mn);Ua=n(Tp,"'right'"),Tp.forEach(t),Va=n(Be," or "),hn=s(Be,"CODE",{});var yp=a(hn);Ga=n(yp,"'left'"),yp.forEach(t),Ha=n(Be,"."),Be.forEach(t),O.forEach(t),Xa=l(g),Ie=s(g,"DIV",{class:!0});var Or=a(Ie);b(it.$$.fragment,Or),Ya=l(Or),un=s(Or,"P",{});var wp=a(un);Ja=n(wp,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),wp.forEach(t),Or.forEach(t),Ka=l(g),Ne=s(g,"DIV",{class:!0});var Wr=a(Ne);b(dt.$$.fragment,Wr),Qa=l(Wr),fn=s(Wr,"P",{});var zp=a(fn);Za=n(zp,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),zp.forEach(t),Wr.forEach(t),ei=l(g),Ae=s(g,"DIV",{class:!0});var jr=a(Ae);b(lt.$$.fragment,jr),ti=l(jr),_n=s(jr,"P",{});var xp=a(_n);oi=n(xp,"Convert a list of lists of token ids into a list of strings by calling decode."),xp.forEach(t),jr.forEach(t),ni=l(g),ee=s(g,"DIV",{class:!0});var yo=a(ee);b(ct.$$.fragment,yo),ri=l(yo),gn=s(yo,"P",{});var $p=a(gn);si=n($p,"Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),$p.forEach(t),ai=l(yo),b(Se.$$.fragment,yo),yo.forEach(t),ii=l(g),te=s(g,"DIV",{class:!0});var wo=a(te);b(pt.$$.fragment,wo),di=l(wo),kn=s(wo,"P",{});var Pp=a(kn);li=n(Pp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),Pp.forEach(t),ci=l(wo),bn=s(wo,"P",{});var qp=a(bn);pi=n(qp,"This implementation does not add special tokens and this method should be overridden in a subclass."),qp.forEach(t),wo.forEach(t),mi=l(g),Fe=s(g,"DIV",{class:!0});var Rr=a(Fe);b(mt.$$.fragment,Rr),hi=l(Rr),vn=s(Rr,"P",{});var Ep=a(vn);ui=n(Ep,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Ep.forEach(t),Rr.forEach(t),fi=l(g),Ce=s(g,"DIV",{class:!0});var Mr=a(Ce);b(ht.$$.fragment,Mr),_i=l(Mr),ut=s(Mr,"P",{});var Ur=a(ut);gi=n(Ur,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Ur,"CODE",{});var Bp=a(Tn);ki=n(Bp,'" ".join(tokens)'),Bp.forEach(t),bi=n(Ur,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Ur.forEach(t),Mr.forEach(t),vi=l(g),oe=s(g,"DIV",{class:!0});var zo=a(oe);b(ft.$$.fragment,zo),Ti=l(zo),ho=s(zo,"P",{});var jc=a(ho);yi=n(jc,"Create the token type IDs corresponding to the sequences passed. "),uo=s(jc,"A",{href:!0});var Lp=a(uo);wi=n(Lp,`What are token type
IDs?`),Lp.forEach(t),jc.forEach(t),zi=l(zo),yn=s(zo,"P",{});var Dp=a(yn);xi=n(Dp,"Should be overridden in a subclass if the model has a special way of building those."),Dp.forEach(t),zo.forEach(t),$i=l(g),ne=s(g,"DIV",{class:!0});var xo=a(ne);b(_t.$$.fragment,xo),Pi=l(xo),wn=s(xo,"P",{});var Ip=a(wn);qi=n(Ip,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Ip.forEach(t),Ei=l(xo),gt=s(xo,"P",{});var Vr=a(gt);Bi=n(Vr,"Similar to doing "),zn=s(Vr,"CODE",{});var Np=a(zn);Li=n(Np,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Np.forEach(t),Di=n(Vr,"."),Vr.forEach(t),xo.forEach(t),Ii=l(g),re=s(g,"DIV",{class:!0});var $o=a(re);b(kt.$$.fragment,$o),Ni=l($o),xn=s($o,"P",{});var Ap=a(xn);Ai=n(Ap,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Ap.forEach(t),Si=l($o),bt=s($o,"P",{});var Gr=a(bt);Fi=n(Gr,"Same as doing "),$n=s(Gr,"CODE",{});var Sp=a($n);Ci=n(Sp,"self.convert_tokens_to_ids(self.tokenize(text))"),Sp.forEach(t),Oi=n(Gr,"."),Gr.forEach(t),$o.forEach(t),Wi=l(g),se=s(g,"DIV",{class:!0});var Po=a(se);b(vt.$$.fragment,Po),ji=l(Po),Pn=s(Po,"P",{});var Fp=a(Pn);Ri=n(Fp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Fp.forEach(t),Mi=l(Po),b(Oe.$$.fragment,Po),Po.forEach(t),Ui=l(g),H=s(g,"DIV",{class:!0});var tt=a(H);b(Tt.$$.fragment,tt),Vi=l(tt),yt=s(tt,"P",{});var Hr=a(yt);Gi=n(Hr,"Instantiate a "),fo=s(Hr,"A",{href:!0});var Cp=a(fo);Hi=n(Cp,"PreTrainedTokenizerBase"),Cp.forEach(t),Xi=n(Hr,` (or a derived class) from a predefined
tokenizer.`),Hr.forEach(t),Yi=l(tt),b(We.$$.fragment,tt),Ji=l(tt),b(je.$$.fragment,tt),tt.forEach(t),Ki=l(g),Re=s(g,"DIV",{class:!0});var Xr=a(Re);b(wt.$$.fragment,Xr),Qi=l(Xr),be=s(Xr,"P",{});var qo=a(be);Zi=n(qo,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),qn=s(qo,"CODE",{});var Op=a(qn);ed=n(Op,"prepare_for_model"),Op.forEach(t),td=n(qo," or "),En=s(qo,"CODE",{});var Wp=a(En);od=n(Wp,"encode_plus"),Wp.forEach(t),nd=n(qo," methods."),qo.forEach(t),Xr.forEach(t),rd=l(g),ae=s(g,"DIV",{class:!0});var Eo=a(ae);b(zt.$$.fragment,Eo),sd=l(Eo),Bn=s(Eo,"P",{});var jp=a(Bn);ad=n(jp,"Returns the vocabulary as a dictionary of token to index."),jp.forEach(t),id=l(Eo),ie=s(Eo,"P",{});var oo=a(ie);Ln=s(oo,"CODE",{});var Rp=a(Ln);dd=n(Rp,"tokenizer.get_vocab()[token]"),Rp.forEach(t),ld=n(oo," is equivalent to "),Dn=s(oo,"CODE",{});var Mp=a(Dn);cd=n(Mp,"tokenizer.convert_tokens_to_ids(token)"),Mp.forEach(t),pd=n(oo," when "),In=s(oo,"CODE",{});var Up=a(In);md=n(Up,"token"),Up.forEach(t),hd=n(oo,` is in the
...
`),Sn=s(nt,"CODE",{});var Hp=a(Sn);Td=n(Hp,"self.pad_token_id"),Hp.forEach(t),yd=n(nt," and "),Fn=s(nt,"CODE",{});var Xp=a(Fn);wd=n(Xp,"self.pad_token_type_id"),Xp.forEach(t),zd=n(nt,")"),nt.forEach(t),xd=l(ot),b(Me.$$.fragment,ot),ot.forEach(t),$d=l(g),Ue=s(g,"DIV",{class:!0});var Yr=a(Ue);b($t.$$.fragment,Yr),Pd=l(Yr),j=s(Yr,"P",{});var me=a(j);qd=n(me,`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
adds special tokens, truncates sequences if overflowing while taking into account the special tokens and
...
different than `),On=s(me,"CODE",{});var Jp=a(On);Ld=n(Jp,"None"),Jp.forEach(t),Dd=n(me," and "),Wn=s(me,"EM",{});var Kp=a(Wn);Id=n(Kp,"truncation_strategy = longest_first"),Kp.forEach(t),Nd=n(me," or "),jn=s(me,"CODE",{});var Qp=a(jn);Ad=n(Qp,"True"),Qp.forEach(t),Sd=n(me,`, it is not possible to return
overflowing tokens. Such a combination of arguments will raise an error.`),me.forEach(t),Yr.forEach(t),Fd=l(g),Ve=s(g,"DIV",{class:!0});var Jr=a(Ve);b(Pt.$$.fragment,Jr),Cd=l(Jr),Rn=s(Jr,"P",{});var Zp=a(Rn);Od=n(Zp,"Prepare model inputs for translation. For best performance, translate one sentence at a time."),Zp.forEach(t),Jr.forEach(t),Wd=l(g),de=s(g,"DIV",{class:!0});var Bo=a(de);b(qt.$$.fragment,Bo),jd=l(Bo),Et=s(Bo,"P",{});var Kr=a(Et);Rd=n(Kr,`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Mn=s(Kr,"CODE",{});var em=a(Mn);Md=n(em,"repo_path_or_name"),em.forEach(t),Ud=n(Kr,"."),Kr.forEach(t),Vd=l(Bo),b(Ge.$$.fragment,Bo),Bo.forEach(t),Gd=l(g),le=s(g,"DIV",{class:!0});var Lo=a(le);b(Bt.$$.fragment,Lo),Hd=l(Lo),Lt=s(Lo,"P",{});var Qr=a(Lt);Xd=n(Qr,`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with `),Un=s(Qr,"CODE",{});var tm=a(Un);Yd=n(tm,"AutoTokenizer"),tm.forEach(t),Jd=n(Qr,"."),Qr.forEach(t),Kd=l(Lo),b(He.$$.fragment,Lo),Lo.forEach(t),Qd=l(g),Y=s(g,"DIV",{class:!0});var rt=a(Y);b(Dt.$$.fragment,rt),Zd=l(rt),Vn=s(rt,"P",{});var om=a(Vn);el=n(om,"Save the full tokenizer state."),om.forEach(t),tl=l(rt),It=s(rt,"P",{});var Zr=a(It);ol=n(Zr,`This method make sure the full tokenizer can then be re-loaded using the
...
instance, modifying `),Hn=s(es,"CODE",{});var rm=a(Hn);il=n(rm,"tokenizer.do_lower_case"),rm.forEach(t),dl=n(es," after creation)."),es.forEach(t),rt.forEach(t),ll=l(g),ce=s(g,"DIV",{class:!0});var Do=a(ce);b(At.$$.fragment,Do),cl=l(Do),Xn=s(Do,"P",{});var sm=a(Xn);pl=n(sm,"Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),sm.forEach(t),ml=l(Do),St=s(Do,"P",{});var ts=a(St);hl=n(ts,`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Yn=s(ts,"CODE",{});var am=a(Yn);ul=n(am,"_save_pretrained()"),am.forEach(t),fl=n(ts," to save the whole state of the tokenizer."),ts.forEach(t),Do.forEach(t),_l=l(g),Xe=s(g,"DIV",{class:!0});var os=a(Xe);b(Ft.$$.fragment,os),gl=l(os),Ct=s(os,"P",{});var ns=a(Ct);kl=n(ns,"Converts a string in a sequence of tokens, replacing unknown tokens with the "),Jn=s(ns,"CODE",{});var im=a(Jn);bl=n(im,"unk_token"),im.forEach(t),vl=n(ns,"."),ns.forEach(t),os.forEach(t),Tl=l(g),Ye=s(g,"DIV",{class:!0});var rs=a(Ye);b(Ot.$$.fragment,rs),yl=l(rs),Kn=s(rs,"P",{});var dm=a(Kn);wl=n(dm,"Truncates a sequence pair in-place following the strategy."),dm.forEach(t),rs.forEach(t),g.forEach(t),Lr=l(i),ve=s(i,"H2",{class:!0});var ss=a(ve);Je=s(ss,"A",{id:!0,class:!0,href:!0});var lm=a(Je);Qn=s(lm,"SPAN",{});var cm=a(Qn);b(Wt.$$.fragment,cm),cm.forEach(t),lm.forEach(t),zl=l(ss),Zn=s(ss,"SPAN",{});var pm=a(Zn);xl=n(pm,"SpecialTokensMixin"),pm.forEach(t),ss.forEach(t),Dr=l(i),A=s(i,"DIV",{class:!0});var he=a(A);b(jt.$$.fragment,he),$l=l(he),Te=s(he,"P",{});var Io=a(Te);Pl=n(Io,"A mixin derived by "),_o=s(Io,"A",{href:!0});var mm=a(_o);ql=n(mm,"PreTrainedTokenizer"),mm.forEach(t),El=n(Io," and "),go=s(Io,"A",{href:!0});var hm=a(go);Bl=n(hm,"PreTrainedTokenizerFast"),hm.forEach(t),Ll=n(Io,` to handle specific behaviors related to
special tokens. In particular, this class hold the attributes which can be used to directly access these special
...
special tokens are NOT in the vocabulary, they are added to it (indexed starting from the last index of the
current vocabulary).`),um.forEach(t),Al=l(N),tr=s(N,"P",{});var fm=a(tr);Sl=n(fm,`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
matrix of the model so that its embedding matrix matches the tokenizer.`),fm.forEach(t),Fl=l(N),Mt=s(N,"P",{});var as=a(Mt);Cl=n(as,"In order to do that, please use the "),ko=s(as,"A",{href:!0});var _m=a(ko);Ol=n(_m,"resize_token_embeddings()"),_m.forEach(t),Wl=n(as," method."),as.forEach(t),jl=l(N),Ut=s(N,"P",{});var is=a(Ut);Rl=n(is,"Using "),or=s(is,"CODE",{});var gm=a(or);Ml=n(gm,"add_special_tokens"),gm.forEach(t),Ul=n(is," will ensure your special tokens can be used in several ways:"),is.forEach(t),Vl=l(N),Vt=s(N,"UL",{});var ds=a(Vt);nr=s(ds,"LI",{});var km=a(nr);Gl=n(km,"Special tokens are carefully handled by the tokenizer (they are never split)."),km.forEach(t),Hl=l(ds),Gt=s(ds,"LI",{});var ls=a(Gt);Xl=n(ls,"You can easily refer to special tokens using tokenizer class attributes like "),rr=s(ls,"CODE",{});var bm=a(rr);Yl=n(bm,"tokenizer.cls_token"),bm.forEach(t),Jl=n(ls,`. This
...
`),ir=s(ue,"CODE",{});var wm=a(ir);sc=n(wm,"'</s>'"),wm.forEach(t),ac=n(ue,")."),ue.forEach(t),ic=l(N),b(Ke.$$.fragment,N),N.forEach(t),dc=l(he),C=s(he,"DIV",{class:!0});var fe=a(C);b(Ht.$$.fragment,fe),lc=l(fe),dr=s(fe,"P",{});var zm=a(dr);cc=n(zm,`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
it with indices starting from length of the current vocabulary.`),zm.forEach(t),pc=l(fe),lr=s(fe,"P",{});var xm=a(lr);mc=n(xm,`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
...
`),pr=s(Ao,"CODE",{});var qm=a(pr);wc=n(qm,"tokenizer.cls_token"),qm.forEach(t),zc=n(Ao,", etc.) are in the vocabulary."),Ao.forEach(t),xc=l(No),mr=s(No,"P",{});var Em=a(mr);$c=n(Em,"Add the missing ones to the vocabulary if needed."),Em.forEach(t),No.forEach(t),he.forEach(t),Ir=l(i),we=s(i,"H2",{class:!0});var ps=a(we);Ze=s(ps,"A",{id:!0,class:!0,href:!0});var Bm=a(Ze);hr=s(Bm,"SPAN",{});var Lm=a(hr);b(Jt.$$.fragment,Lm),Lm.forEach(t),Bm.forEach(t),Pc=l(ps),ur=s(ps,"SPAN",{});var Dm=a(ur);qc=n(Dm,"Enums and namedtuples"),Dm.forEach(t),ps.forEach(t),Nr=l(i),ze=s(i,"DIV",{class:!0});var ms=a(ze);b(Kt.$$.fragment,ms),Ec=l(ms),xe=s(ms,"P",{});var So=a(xe);Bc=n(So,"Possible values for the "),fr=s(So,"CODE",{});var Im=a(fr);Lc=n(Im,"truncation"),Im.forEach(t),Dc=n(So," argument in "),et=s(So,"A",{href:!0});var hs=a(et);Ic=n(hs,"PreTrainedTokenizerBase."),_r=s(hs,"STRONG",{});var Nm=a(_r);Nc=n(Nm,"call"),Nm.forEach(t),Ac=n(hs,"()"),hs.forEach(t),Sc=n(So,`. Useful for tab-completion in
an IDE.`),So.forEach(t),ms.forEach(t),Ar=l(i),$e=s(i,"DIV",{class:!0});var us=a($e);b(Qt.$$.fragment,us),Fc=l(us),gr=s(us,"P",{});var Am=a(gr);Cc=n(Am,"Character span in the original string."),Am.forEach(t),us.forEach(t),Sr=l(i),Pe=s(i,"DIV",{class:!0});var fs=a(Pe);b(Zt.$$.fragment,fs),Oc=l(fs),kr=s(fs,"P",{});var Sm=a(kr);Wc=n(Sm,"Token span in an encoded string (list of tokens)."),Sm.forEach(t),fs.forEach(t),this.h()},h(){m(p,"name","hf:doc:metadata"),m(p,"content",JSON.stringify(Qm)),m(h,"id","utilities-for-tokenizers"),m(h,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(h,"href","#utilities-for-tokenizers"),m(f,"class","relative group"),m(ro,"href","/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),m(so,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(ao,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(io,"href","/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.SpecialTokensMixin"),m(Le,"id","transformers.PreTrainedTokenizerBase"),m(Le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Le,"href","#transformers.PreTrainedTokenizerBase"),m(ge,"class","relative group"),m(co,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(po,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(mo,"href","/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained"),m(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(uo,"href","../glossary#token-type-ids"),m(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(fo,"href","/docs/transformers/pr_16836/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),m(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(u,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Je,"id","transformers.SpecialTokensMixin"),m(Je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Je,"href","#transformers.SpecialTokensMixin"),m(ve,"class","relative group"),m(_o,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(go,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(ko,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),m(bo,"href","/docs/transformers/pr_16836/en/model_doc/bert#transformers.BertTokenizer"),m(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(vo,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),m(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ze,"id","transformers.tokenization_utils_base.TruncationStrategy"),m(Ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ze,"href","#transformers.tokenization_utils_base.TruncationStrategy"),m(we,"class","relative group"),m(et,"href","/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__"),m(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,z){e(document.head,p),P(i,$,z),P(i,f,z),e(f,h),e(h,x),v(c,x,null),e(f,_),e(f,L),e(L,_e),P(i,W,z),P(i,D,z),e(D,no),e(D,ro),e(ro,vs),e(D,Ts),e(D,so),e(so,ys),e(D,ws),e(D,ao),e(ao,zs),e(D,xs),e(D,io),e(io,$s),e(D,Ps),P(i,qr,z),P(i,lo,z),e(lo,qs),P(i,Er,z),P(i,ge,z),e(ge,Le),e(Le,Fo),v(st,Fo,null),e(ge,Es),e(ge,Co),e(Co,Bs),P(i,Br,z),P(i,u,z),v(at,u,null),e(u,Ls),e(u,ke),e(ke,Ds),e(ke,co),e(co,Is),e(ke,Ns),e(ke,po),e(po,As),e(ke,Ss),e(u,Fs),e(u,Oo),e(Oo,Cs),e(u,Os),e(u,Wo),e(Wo,Ws),e(u,js),e(u,I),e(I,Z),e(Z,jo),e(jo,Rs),e(Z,Ms),e(Z,Ro),e(Ro,Us),e(Z,Vs),e(Z,Mo),e(Mo,Gs),e(Z,Hs),e(I,Xs),e(I,S),e(S,Uo),e(Uo,Ys),e(S,Js),e(S,Vo),e(Vo,Ks),e(S,Qs),e(S,Go),e(Go,Zs),e(S,ea),e(S,Ho),e(Ho,ta),e(S,oa),e(S,Xo),e(Xo,na),e(S,ra),e(I,sa),e(I,U),e(U,Yo),e(Yo,aa),e(U,ia),e(U,Jo),e(Jo,da),e(U,la),e(U,Ko),e(Ko,ca),e(U,pa),e(U,Qo),e(Qo,ma),e(U,ha),e(I,ua),e(I,F),e(F,Zo),e(Zo,fa),e(F,_a),e(F,en),e(en,ga),e(F,ka),e(F,tn),e(tn,ba),e(F,va),e(F,on),e(on,Ta),e(F,ya),e(F,mo),e(mo,wa),e(F,za),e(I,xa),e(I,De),e(De,nn),e(nn,$a),e(De,Pa),e(De,rn),e(rn,qa),e(De,Ea),e(I,Ba),e(I,V),e(V,sn),e(sn,La),e(V,Da),e(V,an),e(an,Ia),e(V,Na),e(V,dn),e(dn,Aa),e(V,Sa),e(V,ln),e(ln,Fa),e(V,Ca),e(I,Oa),e(I,G),e(G,cn),e(cn,Wa),e(G,ja),e(G,pn),e(pn,Ra),e(G,Ma),e(G,mn),e(mn,Ua),e(G,Va),e(G,hn),e(hn,Ga),e(G,Ha),e(u,Xa),e(u,Ie),v(it,Ie,null),e(Ie,Ya),e(Ie,un),e(un,Ja),e(u,Ka),e(u,Ne),v(dt,Ne,null),e(Ne,Qa),e(Ne,fn),e(fn,Za),e(u,ei),e(u,Ae),v(lt,Ae,null),e(Ae,ti),e(Ae,_n),e(_n,oi),e(u,ni),e(u,ee),v(ct,ee,null),e(ee,ri),e(ee,gn),e(gn,si),e(ee,ai),v(Se,ee,null),e(u,ii),e(u,te),v(pt,te,null),e(te,di),e(te,kn),e(kn,li),e(te,ci),e(te,bn),e(bn,pi),e(u,mi),e(u,Fe),v(mt,Fe,null),e(Fe,hi),e(Fe,vn),e(vn,ui),e(u,fi),e(u,Ce),v(ht,Ce,null),e(Ce,_i),e(Ce,ut),e(ut,gi),e(ut,Tn),e(Tn,ki),e(ut,bi),e(u,vi),e(u,oe),v(ft,oe,null),e(oe,Ti),e(oe,ho),e(ho,yi),e(ho,uo),e(uo,wi),e(oe,zi),e(oe,yn),e(yn,xi),e(u,$i),e(u,ne),v(_t,ne,null),e(ne,Pi),e(ne,wn),e(wn,qi),e(ne,Ei),e(ne,gt),e(gt,Bi),e(gt,zn),e(zn,Li),e(gt,Di),e(u,Ii),e(u,re),v(kt,re,null),e(re,Ni),e(re,xn),e(xn,Ai),e(re,Si),e(re,bt),e(bt,Fi),e(bt,$n),e($n,Ci),e(bt,Oi),e(u,Wi),e(u,se),v(vt,se,null),e(se,ji),e(se,Pn),e(Pn,Ri),e(se,Mi),v(Oe,se,null),e(u,Ui),e(u,H),v(Tt,H,null),e(H,Vi),e(H,yt),e(yt,Gi),e(yt,fo),e(fo,Hi),e(yt,Xi),e(H,Yi),v(We,H,null),e(H,Ji),v(je,H,null),e(u,Ki),e(u,Re),v(wt,Re,null),e(Re,Qi),e(Re,be),e(be,Zi),e(be,qn),e(qn,ed),e(be,td),e(be,En),e(En,od),e(be,nd),e(u,rd),e(u,ae),v(zt,ae,null),e(ae,sd),e(ae,Bn),e(Bn,ad),e(ae,id),e(ae,ie),e(ie,Ln),e(Ln,dd),e(ie,ld),e(ie,Dn),e(Dn,cd),e(ie,pd),e(ie,In),e(In,md),e(ie,hd),e(u,ud),e(u,X),v(xt,X,null),e(X,fd),e(X,Nn),e(Nn,_d),e(X,gd),e(X,J),e(J,kd),e(J,An),e(An,bd),e(J,vd),e(J,Sn),e(Sn,Td),e(J,yd),e(J,Fn),e(Fn,wd),e(J,zd),e(X,xd),v(Me,X,null),e(u,$d),e(u,Ue),v($t,Ue,null),e(Ue,Pd),e(Ue,j),e(j,qd),e(j,Cn),e(Cn,Ed),e(j,Bd),e(j,On),e(On,Ld),e(j,Dd),e(j,Wn),e(Wn,Id),e(j,Nd),e(j,jn),e(jn,Ad),e(j,Sd),e(u,Fd),e(u,Ve),v(Pt,Ve,null),e(Ve,Cd),e(Ve,Rn),e(Rn,Od),e(u,Wd),e(u,de),v(qt,de,null),e(de,jd),e(de,Et),e(Et,Rd),e(Et,Mn),e(Mn,Md),e(Et,Ud),e(de,Vd),v(Ge,de,null),e(u,Gd),e(u,le),v(Bt,le,null),e(le,Hd),e(le,Lt),e(Lt,Xd),e(Lt,Un),e(Un,Yd),e(Lt,Jd),e(le,Kd),v(He,le,null),e(u,Qd),e(u,Y),v(Dt,Y,null),e(Y,Zd),e(Y,Vn),e(Vn,el),e(Y,tl),e(Y,It),e(It,ol),e(It,Gn),e(Gn,nl),e(It,rl),e(Y,sl),e(Y,Nt),e(Nt,al),e(Nt,Hn),e(Hn,il),e(Nt,dl),e(u,ll),e(u,ce),v(At,ce,null),e(ce,cl),e(ce,Xn),e(Xn,pl),e(ce,ml),e(ce,St),e(St,hl),e(St,Yn),e(Yn,ul),e(St,fl),e(u,_l),e(u,Xe),v(Ft,Xe,null),e(Xe,gl),e(Xe,Ct),e(Ct,kl),e(Ct,Jn),e(Jn,bl),e(Ct,vl),e(u,Tl),e(u,Ye),v(Ot,Ye,null),e(Ye,yl),e(Ye,Kn),e(Kn,wl),P(i,Lr,z),P(i,ve,z),e(ve,Je),e(Je,Qn),v(Wt,Qn,null),e(ve,zl),e(ve,Zn),e(Zn,xl),P(i,Dr,z),P(i,A,z),v(jt,A,null),e(A,$l),e(A,Te),e(Te,Pl),e(Te,_o),e(_o,ql),e(Te,El),e(Te,go),e(go,Bl),e(Te,Ll),e(A,Dl),e(A,B),v(Rt,B,null),e(B,Il),e(B,er),e(er,Nl),e(B,Al),e(B,tr),e(tr,Sl),e(B,Fl),e(B,Mt),e(Mt,Cl),e(Mt,ko),e(ko,Ol),e(Mt,Wl),e(B,jl),e(B,Ut),e(Ut,Rl),e(Ut,or),e(or,Ml),e(Ut,Ul),e(B,Vl),e(B,Vt),e(Vt,nr),e(nr,Gl),e(Vt,Hl),e(Vt,Gt),e(Gt,Xl),e(Gt,rr),e(rr,Yl),e(Gt,Jl),e(B,Kl),e(B,R),e(R,Ql),e(R,bo),e(bo,Zl),e(R,ec),e(R,sr),e(sr,tc),e(R,oc),e(R,ar),e(ar,nc),e(R,rc),e(R,ir),e(ir,sc),e(R,ac),e(B,ic),v(Ke,B,null),e(A,dc),e(A,C),v(Ht,C,null),e(C,lc),e(C,dr),e(dr,cc),e(C,pc),e(C,lr),e(lr,mc),e(C,hc),e(C,Xt),e(Xt,uc),e(Xt,vo),e(vo,fc),e(Xt,_c),e(C,gc),v(Qe,C,null),e(A,kc),e(A,pe),v(Yt,pe,null),e(pe,bc),e(pe,ye),e(ye,vc),e(ye,cr),e(cr,Tc),e(ye,yc),e(ye,pr),e(pr,wc),e(ye,zc),e(pe,xc),e(pe,mr),e(mr,$c),P(i,Ir,z),P(i,we,z),e(we,Ze),e(Ze,hr),v(Jt,hr,null),e(we,Pc),e(we,ur),e(ur,qc),P(i,Nr,z),P(i,ze,z),v(Kt,ze,null),e(ze,Ec),e(ze,xe),e(xe,Bc),e(xe,fr),e(fr,Lc),e(xe,Dc),e(xe,et),e(et,Ic),e(et,_r),e(_r,Nc),e(et,Ac),e(xe,Sc),P(i,Ar,z),P(i,$e,z),v(Qt,$e,null),e($e,Fc),e($e,gr),e(gr,Cc),P(i,Sr,z),P(i,Pe,z),v(Zt,Pe,null),e(Pe,Oc),e(Pe,kr),e(kr,Wc),Fr=!0},p(i,[z]){const eo={};z&2&&(eo.$$scope={dirty:z,ctx:i}),Se.$set(eo);const br={};z&2&&(br.$$scope={dirty:z,ctx:i}),Oe.$set(br);const vr={};z&2&&(vr.$$scope={dirty:z,ctx:i}),We.$set(vr);const Tr={};z&2&&(Tr.$$scope={dirty:z,ctx:i}),je.$set(Tr);const M={};z&2&&(M.$$scope={dirty:z,ctx:i}),Me.$set(M);const yr={};z&2&&(yr.$$scope={dirty:z,ctx:i}),Ge.$set(yr);const wr={};z&2&&(wr.$$scope={dirty:z,ctx:i}),He.$set(wr);const zr={};z&2&&(zr.$$scope={dirty:z,ctx:i}),Ke.$set(zr);const xr={};z&2&&(xr.$$scope={dirty:z,ctx:i}),Qe.$set(xr)},i(i){Fr||(T(c.$$.fragment,i),T(st.$$.fragment,i),T(at.$$.fragment,i),T(it.$$.fragment,i),T(dt.$$.fragment,i),T(lt.$$.fragment,i),T(ct.$$.fragment,i),T(Se.$$.fragment,i),T(pt.$$.fragment,i),T(mt.$$.fragment,i),T(ht.$$.fragment,i),T(ft.$$.fragment,i),T(_t.$$.fragment,i),T(kt.$$.fragment,i),T(vt.$$.fragment,i),T(Oe.$$.fragment,i),T(Tt.$$.fragment,i),T(We.$$.fragment,i),T(je.$$.fragment,i),T(wt.$$.fragment,i),T(zt.$$.fragment,i),T(xt.$$.fragment,i),T(Me.$$.fragment,i),T($t.$$.fragment,i),T(Pt.$$.fragment,i),T(qt.$$.fragment,i),T(Ge.$$.fragment,i),T(Bt.$$.fragment,i),T(He.$$.fragment,i),T(Dt.$$.fragment,i),T(At.$$.fragment,i),T(Ft.$$.fragment,i),T(Ot.$$.fragment,i),T(Wt.$$.fragment,i),T(jt.$$.fragment,i),T(Rt.$$.fragment,i),T(Ke.$$.fragment,i),T(Ht.$$.fragment,i),T(Qe.$$.fragment,i),T(Yt.$$.fragment,i),T(Jt.$$.fragment,i),T(Kt.$$.fragment,i),T(Qt.$$.fragment,i),T(Zt.$$.fragment,i),Fr=!0)},o(i){y(c.$$.fragment,i),y(st.$$.fragment,i),y(at.$$.fragment,i),y(it.$$.fragment,i),y(dt.$$.fragment,i),y(lt.$$.fragment,i),y(ct.$$.fragment,i),y(Se.$$.fragment,i),y(pt.$$.fragment,i),y(mt.$$.fragment,i),y(ht.$$.fragment,i),y(ft.$$.fragment,i),y(_t.$$.fragment,i),y(kt.$$.fragment,i),y(vt.$$.fragment,i),y(Oe.$$.fragment,i),y(Tt.$$.fragment,i),y(We.$$.fragment,i),y(je.$$.fragment,i),y(wt.$$.fragment,i),y(zt.$$.fragment,i),y(xt.$$.fragment,i),y(Me.$$.fragment,i),y($t.$$.fragment,i),y(Pt.$$.fragment,i),y(qt.$$.fragment,i),y(Ge.$$.fragment,i),y(Bt.$$.fragment,i),y(He.$$.fragment,i),y(Dt.$$.fragment,i),y(At.$$.fragment,i),y(Ft.$$.fragment,i),y(Ot.$$.fragment,i),y(Wt.$$.fragment,i),y(jt.$$.fragment,i),y(Rt.$$.fragment,i),y(Ke.$$.fragment,i),y(Ht.$$.fragment,i),y(Qe.$$.fragment,i),y(Yt.$$.fragment,i),y(Jt.$$.fragment,i),y(Kt.$$.fragment,i),y(Qt.$$.fragment,i),y(Zt.$$.fragment,i),Fr=!1},d(i){t(p),i&&t($),i&&t(f),w(c),i&&t(W),i&&t(D),i&&t(qr),i&&t(lo),i&&t(Er),i&&t(ge),w(st),i&&t(Br),i&&t(u),w(at),w(it),w(dt),w(lt),w(ct),w(Se),w(pt),w(mt),w(ht),w(ft),w(_t),w(kt),w(vt),w(Oe),w(Tt),w(We),w(je),w(wt),w(zt),w(xt),w(Me),w($t),w(Pt),w(qt),w(Ge),w(Bt),w(He),w(Dt),w(At),w(Ft),w(Ot),i&&t(Lr),i&&t(ve),w(Wt),i&&t(Dr),i&&t(A),w(jt),w(Rt),w(Ke),w(Ht),w(Qe),w(Yt),i&&t(Ir),i&&t(we),w(Jt),i&&t(Nr),i&&t(ze),w(Kt),i&&t(Ar),i&&t($e),w(Qt),i&&t(Sr),i&&t(Pe),w(Zt)}}}const Qm={local:"utilities-for-tokenizers",sections:[{local:"transformers.PreTrainedTokenizerBase",title:"PreTrainedTokenizerBase"},{local:"transformers.SpecialTokensMixin",title:"SpecialTokensMixin"},{local:"transformers.tokenization_utils_base.TruncationStrategy",title:"Enums and namedtuples"}],title:"Utilities for Tokenizers"};function Zm(E){return jm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ah extends Fm{constructor(p){super();Cm(this,p,Zm,Km,Om,{})}}export{ah as default,Qm as metadata};
