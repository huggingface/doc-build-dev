...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=s("p"),T=n("Examples:"),_=p(),v(g.$$.fragment)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Examples:"),f.forEach(t),_=u(d),y(g.$$.fragment,d)},m(d,f){m(d,h,f),e(h,T),m(d,_,f),b(g,d,f),x=!0},p:pa,i(d){x||(L(g.$$.fragment,d),x=!0)},o(d){w(g.$$.fragment,d),x=!1},d(d){d&&t(h),d&&t(_),k(g,d)}}}function cv(P){let h,T,_,g,x,d,f,D,Ci,sr,xe,We,ua,Mo,Ii,ma,Ai,rr,pe,Di,$o,Oi,Ni,Jt,Si,Ri,ir,ue,H,Ui,Eo,Wi,Bi,zo,Vi,Qi,Fo,Gi,Hi,qo,Ki,Xi,Yi,Po,Zi,jo,Ji,el,ol,Co,tl,Io,nl,al,lr,en,sl,cr,on,ha,rl,dr,tn,il,pr,W,fa,ll,cl,Ao,dl,Do,pl,ul,ml,Oo,hl,No,fl,gl,_l,Te,vl,So,yl,bl,Ro,Ll,wl,kl,M,xl,ga,Tl,Ml,nn,$l,El,_a,zl,Fl,va,ql,Pl,ya,jl,Cl,ba,Il,Al,La,Dl,Ol,wa,Nl,Sl,ka,Rl,Ul,an,Wl,Bl,Uo,Vl,Ql,Wo,Gl,Hl,ur,Bo,mr,me,Kl,xa,Xl,Yl,Ta,Zl,Jl,hr,Vo,fr,Be,ec,sn,oc,tc,gr,he,I,nc,rn,ac,sc,Ma,rc,ic,$a,lc,cc,ln,dc,pc,Ea,uc,mc,za,hc,fc,Fa,gc,_c,vc,Qo,yc,cn,bc,Lc,wc,Go,kc,qa,xc,Tc,_r,Ve,Mc,dn,$c,Ec,vr,Me,Qe,Pa,Ho,zc,ja,Fc,yr,B,qc,pn,Pc,jc,un,Cc,Ic,mn,Ac,Dc,hn,Oc,Nc,br,Ko,Lr,E,Sc,fn,Rc,Uc,gn,Wc,Bc,Ca,Vc,Qc,_n,Gc,Hc,vn,Kc,Xc,Ia,Yc,Zc,Aa,Jc,ed,Da,od,td,Oa,nd,ad,Na,sd,rd,wr,R,yn,id,ld,Xo,cd,dd,bn,pd,ud,Sa,md,hd,Ra,fd,gd,kr,Ln,_d,xr,wn,Ua,vd,Tr,kn,yd,Mr,Yo,$r,xn,Wa,bd,Er,fe,Ld,Ba,wd,kd,Va,xd,Td,zr,Zo,Fr,Tn,Qa,Md,qr,V,$d,Ga,Ed,zd,Ha,Fd,qd,Ka,Pd,jd,Xa,Cd,Id,Pr,Jo,jr,Mn,Ya,Ad,Cr,$n,Dd,Ir,et,Ar,En,Za,Od,Dr,zn,Nd,Or,ot,Nr,$e,Ge,Ja,tt,Sd,es,Rd,Sr,K,nt,Ud,Ee,Wd,Fn,Bd,Vd,at,Qd,Gd,Hd,ze,Kd,qn,Xd,Yd,Pn,Zd,Jd,ep,He,Rr,Fe,Ke,os,st,op,ts,tp,Ur,X,rt,np,ns,ap,sp,it,rp,as,ip,lp,cp,ge,lt,dp,ss,pp,up,Xe,Wr,qe,Ye,rs,ct,mp,is,hp,Br,O,dt,fp,N,gp,jn,_p,vp,ls,yp,bp,cs,Lp,wp,ds,kp,xp,ps,Tp,Mp,us,$p,Ep,zp,pt,Fp,Cn,qp,Pp,jp,In,An,Cp,Ip,Ap,Ze,ut,Dp,ms,Op,Np,Dn,mt,Vr,Pe,Je,hs,ht,Sp,fs,Rp,Qr,Y,ft,Up,gt,Wp,gs,Bp,Vp,Qp,_t,Gp,On,Hp,Kp,Xp,eo,vt,Yp,_s,Zp,Gr,je,oo,vs,yt,Jp,ys,eu,Hr,U,bt,ou,bs,tu,nu,Nn,Sn,au,su,ru,q,iu,Rn,lu,cu,Un,du,pu,Wn,uu,mu,Ls,hu,fu,ws,gu,_u,ks,vu,yu,xs,bu,Lu,Ts,wu,ku,Ms,xu,Tu,Mu,_e,Lt,$u,$,Eu,$s,zu,Fu,wt,Es,qu,Pu,ju,Bn,Cu,Iu,zs,Au,Du,Fs,Ou,Nu,kt,qs,Su,Ru,Uu,Ps,Wu,Bu,Vn,Vu,Qu,js,Gu,Hu,Cs,Ku,Xu,Is,Yu,Zu,As,Ju,em,om,Ds,tm,Kr,Ce,to,Os,xt,nm,Ns,am,Xr,le,Tt,sm,Mt,rm,$t,im,lm,cm,te,Et,dm,Ie,pm,Qn,um,mm,Ss,hm,fm,gm,no,_m,ao,Yr,Ae,so,Rs,zt,vm,Us,ym,Zr,Z,Ft,bm,qt,Lm,Pt,wm,km,xm,jt,Tm,Ct,Mm,$m,Em,ne,It,zm,De,Fm,Gn,qm,Pm,Ws,jm,Cm,Im,ro,Am,io,Jr,Oe,lo,Bs,At,Dm,Vs,Om,ei,J,Dt,Nm,ee,Sm,Ot,Rm,Um,Nt,Wm,Bm,St,Vm,Qm,Rt,Gm,Hm,Km,Ut,Xm,Wt,Ym,Zm,Jm,ae,Bt,eh,Ne,oh,Hn,th,nh,Qs,ah,sh,rh,co,ih,po,oi,Se,uo,Gs,Vt,lh,Hs,ch,ti,oe,Qt,dh,ce,ph,Gt,uh,mh,Ks,hh,fh,Xs,gh,_h,vh,Ht,yh,Kt,bh,Lh,wh,se,Xt,kh,Re,xh,Kn,Th,Mh,Ys,$h,Eh,zh,mo,Fh,ho,ni;return d=new ie({}),Mo=new ie({}),Bo=new G({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Model">LayoutLMv2Model</a> or
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a> with the following fields:</p>
<ul>
<li><strong>pixel_values</strong> \u2014 Pixel values to be fed to a model, of shape (batch_size, num_channels, height,
width).</li>
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L414"}}),mt=new A({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L394"}}),ht=new ie({}),ft=new A({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),Lt=new A({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),xt=new ie({}),Tt=new A({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L709"}}),Et=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L954"}}),It=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L968",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1123"}}),Bt=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1137",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1246",returnDescription:`
<p>A <a
...
`}}),mo=new ji({props:{$$slots:{default:[iv]},$$scope:{ctx:P}}}),ho=new da({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[lv]},$$scope:{ctx:P}}}),{c(){h=s("meta"),T=p(),_=s("h1"),g=s("a"),x=s("span"),v(d.$$.fragment),f=p(),D=s("span"),Ci=n("LayoutLMV2"),sr=p(),xe=s("h2"),We=s("a"),ua=s("span"),v(Mo.$$.fragment),Ii=p(),ma=s("span"),Ai=n("Overview"),rr=p(),pe=s("p"),Di=n("The LayoutLMV2 model was proposed in "),$o=s("a"),Oi=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ni=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
Dinei Florencio, Cha Zhang, Wanxiang Che, Min Zhang, Lidong Zhou. LayoutLMV2 improves `),Jt=s("a"),Si=n("LayoutLM"),Ri=n(` to obtain
state-of-the-art results across several document image understanding benchmarks:`),ir=p(),ue=s("ul"),H=s("li"),Ui=n("information extraction from scanned documents: the "),Eo=s("a"),Wi=n("FUNSD"),Bi=n(` dataset (a
...
this https URL.`),dr=p(),tn=s("p"),il=n("Tips:"),pr=p(),W=s("ul"),fa=s("li"),ll=n(`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
a 0-1000 scale. To normalize, you can use the following function:`),ur=p(),v(Bo.$$.fragment),mr=p(),me=s("p"),Kl=n("Here, "),xa=s("code"),Xl=n("width"),Yl=n(" and "),Ta=s("code"),Zl=n("height"),Jl=n(` correspond to the width and height of the original document in which the token
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),hr=p(),v(Vo.$$.fragment),fr=p(),Be=s("p"),ec=n("However, this model includes a brand new "),sn=s("a"),oc=n("LayoutLMv2Processor"),tc=n(` which can be used to directly
...
`),dn=s("a"),$c=n("LayoutXLM\u2019s documentation page"),Ec=n("."),vr=p(),Me=s("h2"),Qe=s("a"),Pa=s("span"),v(Ho.$$.fragment),zc=p(),ja=s("span"),Fc=n("Usage: LayoutLMv2Processor"),yr=p(),B=s("p"),qc=n("The easiest way to prepare data for the model is to use "),pn=s("a"),Pc=n("LayoutLMv2Processor"),jc=n(`, which internally
...
the words and normalized bounding boxes.`),Mr=p(),v(Yo.$$.fragment),$r=p(),xn=s("p"),Wa=s("strong"),bd=n("Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Er=p(),fe=s("p"),Ld=n("In case one wants to do OCR themselves, one can initialize the feature extractor with "),Ba=s("code"),wd=n("apply_ocr"),kd=n(` set to
...
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Or=p(),v(ot.$$.fragment),Nr=p(),$e=s("h2"),Ge=s("a"),Ja=s("span"),v(tt.$$.fragment),Sd=p(),es=s("span"),Rd=n("LayoutLMv2Config"),Sr=p(),K=s("div"),v(nt.$$.fragment),Ud=p(),Ee=s("p"),Wd=n("This is the configuration class to store the configuration of a "),Fn=s("a"),Bd=n("LayoutLMv2Model"),Vd=n(`. It is used to instantiate an
...
sequences with word-level normalized bounding boxes and optional labels.`),Np=p(),Dn=s("div"),v(mt.$$.fragment),Vr=p(),Pe=s("h2"),Je=s("a"),hs=s("span"),v(ht.$$.fragment),Sp=p(),fs=s("span"),Rp=n("LayoutLMv2TokenizerFast"),Qr=p(),Y=s("div"),v(ft.$$.fragment),Up=p(),gt=s("p"),Wp=n("Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),gs=s("em"),Bp=n("tokenizers"),Vp=n(" library). Based on WordPiece."),Qp=p(),_t=s("p"),Gp=n("This tokenizer inherits from "),On=s("a"),Hp=n("PreTrainedTokenizerFast"),Kp=n(` which contains most of the main methods. Users should
...
`),Wn=s("a"),uu=n("LayoutLMv2TokenizerFast"),mu=n(", which turns the words and bounding boxes into token-level "),Ls=s("code"),hu=n("input_ids"),fu=n(`,
...
`),Bn=s("a"),Cu=n("LayoutLMv2FeatureExtractor"),Iu=n(" was initialized with "),zs=s("code"),Au=n("apply_ocr"),Du=n(" set to "),Fs=s("code"),Ou=n("True"),Nu=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=s("a"),qs=s("strong"),Su=n("call"),Ru=n("()"),Uu=n(` and returns the output,
together with resized `),Ps=s("code"),Wu=n("images"),Bu=n(". In case "),Vn=s("a"),Vu=n("LayoutLMv2FeatureExtractor"),Qu=n(" was initialized with "),js=s("code"),Gu=n("apply_ocr"),Hu=n(` set to
...
state-of-the-art results across several document image understanding benchmarks:`),Ue.forEach(t),ir=u(o),ue=r(o,"UL",{});var Xn=i(ue);H=r(Xn,"LI",{});var ve=i(H);Ui=a(ve,"information extraction from scanned documents: the "),Eo=r(ve,"A",{href:!0,rel:!0});var Ah=i(Eo);Wi=a(Ah,"FUNSD"),Ah.forEach(t),Bi=a(ve,` dataset (a
...
questions defined on 12,000+ document images).`),si.forEach(t),Xn.forEach(t),lr=u(o),en=r(o,"P",{});var Uh=i(en);sl=a(Uh,"The abstract from the paper is the following:"),Uh.forEach(t),cr=u(o),on=r(o,"P",{});var Wh=i(on);ha=r(Wh,"EM",{});var Bh=i(ha);rl=a(Bh,`Pre-training of text and layout has proved effective in a variety of visually-rich document understanding tasks due to
its effective model architecture and the advantage of large-scale unlabeled scanned/digital-born documents. In this
paper, we present LayoutLMv2 by pre-training text, layout and image in a multi-modal framework, where new model
architectures and pre-training tasks are leveraged. Specifically, LayoutLMv2 not only uses the existing masked
visual-language modeling task but also the new text-image alignment and text-image matching tasks in the pre-training
...
including FUNSD (0.7895 -> 0.8420), CORD (0.9493 -> 0.9601), SROIE (0.9524 -> 0.9781), Kleister-NDA (0.834 -> 0.852),
RVL-CDIP (0.9443 -> 0.9564), and DocVQA (0.7295 -> 0.8672). The pre-trained LayoutLMv2 model is publicly available at
this https URL.`),Bh.forEach(t),Wh.forEach(t),dr=u(o),tn=r(o,"P",{});var Vh=i(tn);il=a(Vh,"Tips:"),Vh.forEach(t),pr=u(o),W=r(o,"UL",{});var ye=i(W);fa=r(ye,"LI",{});var Qh=i(fa);ll=a(Qh,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),Zn.forEach(t),hr=u(o),y(Vo.$$.fragment,o),fr=u(o),Be=r(o,"P",{});var li=i(Be);ec=a(li,"However, this model includes a brand new "),sn=r(li,"A",{href:!0});var uf=i(sn);oc=a(uf,"LayoutLMv2Processor"),uf.forEach(t),tc=a(li,` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
...
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),bn=r(de,"A",{href:!0});var Uf=i(bn);pd=a(Uf,"LayoutLMv2FeatureExtractor"),Uf.forEach(t),ud=a(de," with "),Sa=r(de,"CODE",{});var Wf=i(Sa);md=a(Wf,"apply_ocr"),Wf.forEach(t),hd=a(de," set to "),Ra=r(de,"CODE",{});var Bf=i(Ra);fd=a(Bf,"False"),Bf.forEach(t),gd=a(de,"."),de.forEach(t),kr=u(o),Ln=r(o,"P",{});var Vf=i(Ln);_d=a(Vf,`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
...
the words and normalized bounding boxes.`),Hf.forEach(t),Mr=u(o),y(Yo.$$.fragment,o),$r=u(o),xn=r(o,"P",{});var Kf=i(xn);Wa=r(Kf,"STRONG",{});var Xf=i(Wa);bd=a(Xf,"Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Xf.forEach(t),Kf.forEach(t),Er=u(o),fe=r(o,"P",{});var ea=i(fe);Ld=a(ea,"In case one wants to do OCR themselves, one can initialize the feature extractor with "),Ba=r(ea,"CODE",{});var Yf=i(Ba);wd=a(Yf,"apply_ocr"),Yf.forEach(t),kd=a(ea,` set to
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),fi.forEach(t),cp=u(go),ge=r(go,"DIV",{class:!0});var na=i(ge);y(lt.$$.fragment,na),dp=u(na),ss=r(na,"P",{});var kg=i(ss);pp=a(kg,"Main method to prepare for the model one or several image(s)."),kg.forEach(t),up=u(na),y(Xe.$$.fragment,na),na.forEach(t),go.forEach(t),Wr=u(o),qe=r(o,"H2",{class:!0});var gi=i(qe);Ye=r(gi,"A",{id:!0,class:!0,href:!0});var xg=i(Ye);rs=r(xg,"SPAN",{});var Tg=i(rs);y(ct.$$.fragment,Tg),Tg.forEach(t),xg.forEach(t),mp=u(gi),is=r(gi,"SPAN",{});var Mg=i(is);hp=a(Mg,"LayoutLMv2Tokenizer"),Mg.forEach(t),gi.forEach(t),Br=u(o),O=r(o,"DIV",{class:!0});var re=i(O);y(dt.$$.fragment,re),fp=u(re),N=r(re,"P",{});var Q=i(N);gp=a(Q,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),jn=r(Q,"A",{href:!0});var $g=i(jn);_p=a($g,"LayoutLMv2Tokenizer"),$g.forEach(t),vp=a(Q,` can be used to turn words, word-level
...
sequences with word-level normalized bounding boxes and optional labels.`),Ug.forEach(t),wi.forEach(t),_o.forEach(t),Gr=u(o),je=r(o,"H2",{class:!0});var ki=i(je);oo=r(ki,"A",{id:!0,class:!0,href:!0});var Wg=i(oo);vs=r(Wg,"SPAN",{});var Bg=i(vs);y(yt.$$.fragment,Bg),Bg.forEach(t),Wg.forEach(t),Jp=u(ki),ys=r(ki,"SPAN",{});var Vg=i(ys);eu=a(Vg,"LayoutLMv2Processor"),Vg.forEach(t),ki.forEach(t),Hr=u(o),U=r(o,"DIV",{class:!0});var we=i(U);y(bt.$$.fragment,we),ou=u(we),bs=r(we,"P",{});var Qg=i(bs);tu=a(Qg,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
...
`),Wn=r(C,"A",{href:!0});var Xg=i(Wn);uu=a(Xg,"LayoutLMv2TokenizerFast"),Xg.forEach(t),mu=a(C,", which turns the words and bounding boxes into token-level "),Ls=r(C,"CODE",{});var Yg=i(Ls);hu=a(Yg,"input_ids"),Yg.forEach(t),fu=a(C,`,
...
`),Bn=r(F,"A",{href:!0});var s_=i(Bn);Cu=a(s_,"LayoutLMv2FeatureExtractor"),s_.forEach(t),Iu=a(F," was initialized with "),zs=r(F,"CODE",{});var r_=i(zs);Au=a(r_,"apply_ocr"),r_.forEach(t),Du=a(F," set to "),Fs=r(F,"CODE",{});var i_=i(Fs);Ou=a(i_,"True"),i_.forEach(t),Nu=a(F,`, it passes the obtained words and
...
together with resized `),Ps=r(F,"CODE",{});var c_=i(Ps);Wu=a(c_,"images"),c_.forEach(t),Bu=a(F,". In case "),Vn=r(F,"A",{href:!0});var d_=i(Vn);Vu=a(d_,"LayoutLMv2FeatureExtractor"),d_.forEach(t),Qu=a(F," was initialized with "),js=r(F,"CODE",{});var p_=i(js);Gu=a(p_,"apply_ocr"),p_.forEach(t),Hu=a(F,` set to
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Em=u(yo),ne=r(yo,"DIV",{class:!0});var bo=i(ne);y(It.$$.fragment,bo),zm=u(bo),De=r(bo,"P",{});var ia=i(De);Fm=a(ia,"The "),Gn=r(ia,"A",{href:!0});var $_=i(Gn);qm=a($_,"LayoutLMv2ForSequenceClassification"),$_.forEach(t),Pm=a(ia," forward method, overrides the "),Ws=r(ia,"CODE",{});var E_=i(Ws);jm=a(E_,"__call__"),E_.forEach(t),Cm=a(ia," special method."),ia.forEach(t),Im=u(bo),y(ro.$$.fragment,bo),Am=u(bo),y(io.$$.fragment,bo),bo.forEach(t),yo.forEach(t),Jr=u(o),Oe=r(o,"H2",{class:!0});var zi=i(Oe);lo=r(zi,"A",{id:!0,class:!0,href:!0});var z_=i(lo);Bs=r(z_,"SPAN",{});var F_=i(Bs);y(At.$$.fragment,F_),F_.forEach(t),z_.forEach(t),Dm=u(zi),Vs=r(zi,"SPAN",{});var q_=i(Vs);Om=a(q_,"LayoutLMv2ForTokenClassification"),q_.forEach(t),zi.forEach(t),ei=u(o),J=r(o,"DIV",{class:!0});var Lo=i(J);y(Dt.$$.fragment,Lo),Nm=u(Lo),ee=r(Lo,"P",{});var ke=i(ee);Sm=a(ke,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
