import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as i,M as sn,c as s,d as n,m as u,a as r,x as $,h as a,b as l,F as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-6b77c823.js";import{D as xt}from"../../chunks/Docstring-1088f2fb.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qt}from"../../chunks/IconCopyLink-7a11ce68.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,_e,v,T,ce,S,Re,de,De,ge,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,J,Ye,ve,G,pe,He,be,Q,Ve,we,R,Te,L,Je,Z,Ge,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,_,nt,F,ot,st,O,rt,it,ze,b,q,ue,B,at,me,lt,Me,m,j,ct,h,dt,te,pt,ut,ne,mt,ht,X,ft,_t,gt,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Ee;return U=new qt({}),S=new qt({}),R=new en({props:{code:`from transformers import LukeModel
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/mluke/tokenization_mluke.py#L365",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/mluke/tokenization_mluke.py#L1492"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),E(U.$$.fragment),We=p(),le=o("span"),Ke=i("mLUKE"),_e=p(),v=o("h2"),T=o("a"),ce=o("span"),E(S.$$.fragment),Re=p(),de=o("span"),De=i("Overview"),ge=p(),f=o("p"),Fe=i("The mLUKE model was proposed in "),W=o("a"),Oe=i("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=i(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
classification, cloze-style knowledge completion.`),ye=p(),J=o("p"),Ye=i("The abstract from the paper is the following:"),ve=p(),G=o("p"),pe=o("em"),He=i(`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
...
knowledge more likely than using only word representations.`),be=p(),Q=o("p"),Ve=i("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),E(R.$$.fragment),Te=p(),L=o("p"),Je=i("Note that mLUKE has its own tokenizer, "),Z=o("a"),Ge=i("MLukeTokenizer"),Qe=i(". You can initialize it as follows:"),Le=p(),E(D.$$.fragment),xe=p(),x=o("p"),Ze=i("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=o("a"),et=i("LUKE\u2019s documentation page"),tt=i(` for all
tips, code examples and notebooks.`),qe=p(),_=o("p"),nt=i("This model was contributed by "),F=o("a"),ot=i("ryo0634"),st=i(". The original code can be found "),O=o("a"),rt=i("here"),it=i("."),ze=p(),b=o("h2"),q=o("a"),ue=o("span"),E(B.$$.fragment),at=p(),me=o("span"),lt=i("MLukeTokenizer"),Me=p(),m=o("div"),E(j.$$.fragment),ct=p(),h=o("p"),dt=i("Adapted from "),te=o("a"),pt=i("XLMRobertaTokenizer"),ut=i(" and "),ne=o("a"),mt=i("LukeTokenizer"),ht=i(`. Based on
`),X=o("a"),ft=i("SentencePiece"),_t=i("."),gt=p(),C=o("p"),kt=i("This tokenizer inherits from "),oe=o("a"),yt=i("PreTrainedTokenizer"),vt=i(` which contains most of the main methods. Users should refer to
...
sequences, depending on the task you want to prepare them for.`),Lt=p(),se=o("div"),E(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),fe=u(e),y=s(e,"H1",{class:!0});var $e=r(y);w=s($e,"A",{id:!0,class:!0,href:!0});var Mt=r(w);ae=s(Mt,"SPAN",{});var Et=r(ae);$(U.$$.fragment,Et),Et.forEach(n),Mt.forEach(n),We=u($e),le=s($e,"SPAN",{});var $t=r(le);Ke=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),_e=u(e),v=s(e,"H2",{class:!0});var Pe=r(v);T=s(Pe,"A",{id:!0,class:!0,href:!0});var Pt=r(T);ce=s(Pt,"SPAN",{});var At=r(ce);$(S.$$.fragment,At),At.forEach(n),Pt.forEach(n),Re=u(Pe),de=s(Pe,"SPAN",{});var Nt=r(de);De=a(Nt,"Overview"),Nt.forEach(n),Pe.forEach(n),ge=u(e),f=s(e,"P",{});var re=r(f);Fe=a(re,"The mLUKE model was proposed in "),W=s(re,"A",{href:!0,rel:!0});var It=r(W);Oe=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),Be=a(re,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
involving reasoning about entities such as named entity recognition, extractive question answering, relation
classification, cloze-style knowledge completion.`),St.forEach(n),ye=u(e),J=s(e,"P",{});var Wt=r(J);Ye=a(Wt,"The abstract from the paper is the following:"),Wt.forEach(n),ve=u(e),G=s(e,"P",{});var Kt=r(G);pe=s(Kt,"EM",{});var Rt=r(pe);He=a(Rt,`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
alignment information from Wikipedia entities. However, existing methods only exploit entity information in pretraining
and do not explicitly use entities in downstream tasks. In this study, we explore the effectiveness of leveraging
entity representations for downstream cross-lingual tasks. We train a multilingual language model with 24 languages
with entity representations and show the model consistently outperforms word-based pretrained models in various
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),Rt.forEach(n),Kt.forEach(n),be=u(e),Q=s(e,"P",{});var Dt=r(Q);Ve=a(Dt,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Dt.forEach(n),we=u(e),$(R.$$.fragment,e),Te=u(e),L=s(e,"P",{});var Ae=r(L);Je=a(Ae,"Note that mLUKE has its own tokenizer, "),Z=s(Ae,"A",{href:!0});var Ft=r(Z);Ge=a(Ft,"MLukeTokenizer"),Ft.forEach(n),Qe=a(Ae,". You can initialize it as follows:"),Ae.forEach(n),Le=u(e),$(D.$$.fragment,e),xe=u(e),x=s(e,"P",{});var Ne=r(x);Ze=a(Ne,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=s(Ne,"A",{href:!0});var Ot=r(ee);et=a(Ot,"LUKE\u2019s documentation page"),Ot.forEach(n),tt=a(Ne,` for all
tips, code examples and notebooks.`),Ne.forEach(n),qe=u(e),_=s(e,"P",{});var ie=r(_);nt=a(ie,"This model was contributed by "),F=s(ie,"A",{href:!0,rel:!0});var Bt=r(F);ot=a(Bt,"ryo0634"),Bt.forEach(n),st=a(ie,". The original code can be found "),O=s(ie,"A",{href:!0,rel:!0});var jt=r(O);rt=a(jt,"here"),jt.forEach(n),it=a(ie,"."),ie.forEach(n),ze=u(e),b=s(e,"H2",{class:!0});var Ie=r(b);q=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=r(q);ue=s(Xt,"SPAN",{});var Ct=r(ue);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),at=u(Ie),me=s(Ie,"SPAN",{});var Yt=r(me);lt=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Me=u(e),m=s(e,"DIV",{class:!0});var g=r(m);$(j.$$.fragment,g),ct=u(g),h=s(g,"P",{});var M=r(h);dt=a(M,"Adapted from "),te=s(M,"A",{href:!0});var Ht=r(te);pt=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),ut=a(M," and "),ne=s(M,"A",{href:!0});var Vt=r(ne);mt=a(Vt,"LukeTokenizer"),Vt.forEach(n),ht=a(M,`. Based on
`),X=s(M,"A",{href:!0,rel:!0});var Jt=r(X);ft=a(Jt,"SentencePiece"),Jt.forEach(n),_t=a(M,"."),M.forEach(n),gt=u(g),C=s(g,"P",{});var Ue=r(C);kt=a(Ue,"This tokenizer inherits from "),oe=s(Ue,"A",{href:!0});var Gt=r(oe);yt=a(Gt,"PreTrainedTokenizer"),Gt.forEach(n),vt=a(Ue,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ue.forEach(n),bt=u(g),z=s(g,"DIV",{class:!0});var Se=r(z);$(Y.$$.fragment,Se),wt=u(Se),he=s(Se,"P",{});var Qt=r(he);Tt=a(Qt,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Qt.forEach(n),Se.forEach(n),Lt=u(g),se=s(g,"DIV",{class:!0});var Zt=r(se);$(H.$$.fragment,Zt),Zt.forEach(n),g.forEach(n),this.h()},h(){l(k,"name","hf:doc:metadata"),l(k,"content",JSON.stringify(cn)),l(w,"id","mluke"),l(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(w,"href","#mluke"),l(y,"class","relative group"),l(T,"id","overview"),l(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(T,"href","#overview"),l(v,"class","relative group"),l(W,"href","https://arxiv.org/abs/2110.08151"),l(W,"rel","nofollow"),l(K,"href","https://arxiv.org/abs/2010.01057"),l(K,"rel","nofollow"),l(Z,"href","/docs/transformers/pr_16836/en/model_doc/mluke#transformers.MLukeTokenizer"),l(ee,"href","luke"),l(F,"href","https://huggingface.co/ryo0634"),l(F,"rel","nofollow"),l(O,"href","https://github.com/studio-ousia/luke"),l(O,"rel","nofollow"),l(q,"id","transformers.MLukeTokenizer"),l(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(q,"href","#transformers.MLukeTokenizer"),l(b,"class","relative group"),l(te,"href","/docs/transformers/pr_16836/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer"),l(ne,"href","/docs/transformers/pr_16836/en/model_doc/luke#transformers.LukeTokenizer"),l(X,"href","https://github.com/google/sentencepiece"),l(X,"rel","nofollow"),l(oe,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,c){t(document.head,k),d(e,fe,c),d(e,y,c),t(y,w),t(w,ae),P(U,ae,null),t(y,We),t(y,le),t(le,Ke),d(e,_e,c),d(e,v,c),t(v,T),t(T,ce),P(S,ce,null),t(v,Re),t(v,de),t(de,De),d(e,ge,c),d(e,f,c),t(f,Fe),t(f,W),t(W,Oe),t(f,Be),t(f,K),t(K,je),t(f,Xe),d(e,ke,c),d(e,V,c),t(V,Ce),d(e,ye,c),d(e,J,c),t(J,Ye),d(e,ve,c),d(e,G,c),t(G,pe),t(pe,He),d(e,be,c),d(e,Q,c),t(Q,Ve),d(e,we,c),P(R,e,c),d(e,Te,c),d(e,L,c),t(L,Je),t(L,Z),t(Z,Ge),t(L,Qe),d(e,Le,c),P(D,e,c),d(e,xe,c),d(e,x,c),t(x,Ze),t(x,ee),t(ee,et),t(x,tt),d(e,qe,c),d(e,_,c),t(_,nt),t(_,F),t(F,ot),t(_,st),t(_,O),t(O,rt),t(_,it),d(e,ze,c),d(e,b,c),t(b,q),t(q,ue),P(B,ue,null),t(b,at),t(b,me),t(me,lt),d(e,Me,c),d(e,m,c),P(j,m,null),t(m,ct),t(m,h),t(h,dt),t(h,te),t(te,pt),t(h,ut),t(h,ne),t(ne,mt),t(h,ht),t(h,X),t(X,ft),t(h,_t),t(m,gt),t(m,C),t(C,kt),t(C,oe),t(oe,yt),t(C,vt),t(m,bt),t(m,z),P(Y,z,null),t(z,wt),t(z,he),t(he,Tt),t(m,Lt),t(m,se),P(H,se,null),Ee=!0},p:rn,i(e){Ee||(A(U.$$.fragment,e),A(S.$$.fragment,e),A(R.$$.fragment,e),A(D.$$.fragment,e),A(B.$$.fragment,e),A(j.$$.fragment,e),A(Y.$$.fragment,e),A(H.$$.fragment,e),Ee=!0)},o(e){N(U.$$.fragment,e),N(S.$$.fragment,e),N(R.$$.fragment,e),N(D.$$.fragment,e),N(B.$$.fragment,e),N(j.$$.fragment,e),N(Y.$$.fragment,e),N(H.$$.fragment,e),Ee=!1},d(e){n(k),e&&n(fe),e&&n(y),I(U),e&&n(_e),e&&n(v),I(S),e&&n(ge),e&&n(f),e&&n(ke),e&&n(V),e&&n(ye),e&&n(J),e&&n(ve),e&&n(G),e&&n(be),e&&n(Q),e&&n(we),I(R,e),e&&n(Te),e&&n(L),e&&n(Le),I(D,e),e&&n(xe),e&&n(x),e&&n(qe),e&&n(_),e&&n(ze),e&&n(b),I(B),e&&n(Me),e&&n(m),I(j),I(Y),I(H)}}}const cn={local:"mluke",sections:[{local:"overview",title:"Overview"},{local:"transformers.MLukeTokenizer",title:"MLukeTokenizer"}],title:"mLUKE"};function dn(zt){return an(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class fn extends tn{constructor(k){super();nn(this,k,dn,ln,on,{})}}export{fn as default,cn as metadata};
