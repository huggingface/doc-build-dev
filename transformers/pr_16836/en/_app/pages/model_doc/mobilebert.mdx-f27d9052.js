import{S as py,i as hy,s as my,e as r,k as h,w as v,t as n,M as fy,c as a,d as t,m,a as i,x as y,h as s,b,F as e,g,y as w,q as M,o as $,B as F,v as uy,L as xe}from"../../chunks/vendor-6b77c823.js";import{T as Pe}from"../../chunks/Tip-39098574.js";import{D as ie}from"../../chunks/Docstring-1088f2fb.js";import{C as ze}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-5212b321.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(u,B){g(u,d,B),e(d,_),g(u,c,B),g(u,p,B),e(p,T),e(T,l),e(p,f),e(p,x),e(x,he),g(u,V,B),g(u,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,fe),e(z,le),g(u,K,B),g(u,N,B),e(N,ee),g(u,G,B),g(u,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,ue),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(u){u&&t(d),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(K),u&&t(N),u&&t(G),u&&t(P)}}}function Dy(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var f=i(d);_=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(f,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){g(l,d,f),e(d,_),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function Ly(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertTokenizer, TFMobileBertModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=h(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var f=i(d);_=s(f,"Example:"),f.forEach(t),c=m(l),y(p.$$.fragment,l)},m(l,f){g(l,d,f),e(d,_),g(l,c,f),w(p,l,f),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Wy(E){let d,_,c,p,T,l,f,x,he,V,z,J,D,X,me,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
<span class="hljs-number">0.57</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Gy(E){let d,_,c,p,T,l,f,x,he,V,z,J,D,X,me,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=r("p"),_=n("Example:"),c=h(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var f=i(d);_=s(f,"Example:"),f.forEach(t),c=m(l),y(p.$$.fragment,l)},m(l,f){g(l,d,f),e(d,_),g(l,c,f),w(p,l,f),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function rw(E){let d,_,c,p,T,l,f,x,he,V,z,J,D,X,me,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.03</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function dw(E){let d,_,c,p,T,l,f,x,he,V,z,J,D,X,me,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function mw(E){let d,_,c,p,T,l,f,x,he,V,z,J,D,X,me,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be,u,B,Y,ve,$e,S,we,Te,ke,j,I,Fe,ye,Q,Me,te,oe,Be,Mt,Ep,ya,xp,zp,wa,Pp,qp,is,Cp,jp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Dp,Lp,Co,Wp,qi,Rp,Ad,Rt,jo,Ci,ls,Up,ji,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,eh,Ea,th,oh,Dd,Ut,Oo,Oi,ps,nh,Si,sh,Ld,rt,hs,rh,ms,ah,Ai,ih,lh,dh,So,xa,ch,ph,za,hh,mh,fh,fs,uh,Pa,gh,_h,Wd,Ht,Ao,Ii,us,bh,Di,Th,Rd,Qt,gs,kh,_s,vh,qa,yh,wh,Ud,Kt,bs,Mh,Ts,$h,Ca,Fh,Bh,Hd,Vt,Io,Li,ks,Eh,Wi,xh,Qd,je,vs,zh,Ri,Ph,qh,ys,Ch,ja,jh,Nh,Oh,ws,Sh,Ms,Ah,Ih,Dh,Ui,$s,Lh,Wh,it,Fs,Rh,Gt,Uh,Na,Hh,Qh,Hi,Kh,Vh,Gh,Do,Yh,Lo,Kd,Yt,Wo,Qi,Bs,Jh,Ki,Zh,Vd,Re,Es,Xh,Jt,em,Vi,tm,om,Gi,nm,sm,rm,xs,am,Oa,im,lm,dm,zs,cm,Ps,pm,hm,mm,lt,qs,fm,Zt,um,Sa,gm,_m,Yi,bm,Tm,km,Ro,vm,Uo,Gd,Xt,Ho,Ji,Cs,ym,Zi,wm,Yd,Ue,js,Mm,Ns,$m,Xi,Fm,Bm,Em,Os,xm,Aa,zm,Pm,qm,Ss,Cm,As,jm,Nm,Om,Ye,Is,Sm,eo,Am,Ia,Im,Dm,el,Lm,Wm,Rm,Qo,Um,Ko,Hm,Vo,Jd,to,Go,tl,Ds,Qm,ol,Km,Zd,He,Ls,Vm,Ws,Gm,nl,Ym,Jm,Zm,Rs,Xm,Da,ef,tf,of,Us,nf,Hs,sf,rf,af,dt,Qs,lf,oo,df,La,cf,pf,sl,hf,mf,ff,Yo,uf,Jo,Xd,no,Zo,rl,Ks,gf,al,_f,ec,Qe,Vs,bf,il,Tf,kf,Gs,vf,Wa,yf,wf,Mf,Ys,$f,Js,Ff,Bf,Ef,Ce,Zs,xf,so,zf,Ra,Pf,qf,ll,Cf,jf,Nf,Xo,Of,en,Sf,tn,Af,on,If,nn,tc,ro,sn,dl,Xs,Df,cl,Lf,oc,Ke,er,Wf,pl,Rf,Uf,tr,Hf,Ua,Qf,Kf,Vf,or,Gf,nr,Yf,Jf,Zf,ct,sr,Xf,ao,eu,Ha,tu,ou,hl,nu,su,ru,rn,au,an,nc,io,ln,ml,rr,iu,fl,lu,sc,Ve,ar,du,ul,cu,pu,ir,hu,Qa,mu,fu,uu,lr,gu,dr,_u,bu,Tu,Je,cr,ku,lo,vu,Ka,yu,wu,gl,Mu,$u,Fu,dn,Bu,cn,Eu,pn,rc,co,hn,_l,pr,xu,bl,zu,ac,Ge,hr,Pu,po,qu,Tl,Cu,ju,kl,Nu,Ou,Su,mr,Au,Va,Iu,Du,Lu,fr,Wu,ur,Ru,Uu,Hu,Ze,gr,Qu,ho,Ku,Ga,Vu,Gu,vl,Yu,Ju,Zu,mn,Xu,fn,eg,un,ic,mo,gn,yl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,kr,cg,vr,pg,hg,mg,_n,fg,pt,yr,ug,fo,gg,Ja,_g,bg,$l,Tg,kg,vg,bn,yg,Tn,dc,uo,kn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,Pg,$r,qg,Za,Cg,jg,Ng,Fr,Og,Br,Sg,Ag,Ig,vn,Dg,ht,Er,Lg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,yn,Vg,wn,pc,bo,Mn,Pl,xr,Gg,ql,Yg,hc,Se,zr,Jg,Pr,Zg,Cl,Xg,e_,t_,qr,o_,ei,n_,s_,r_,Cr,a_,jr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,h_,ti,m_,f_,jl,u_,g_,__,Fn,b_,Bn,T_,En,mc,ko,xn,Nl,Or,k_,Ol,v_,fc,Ae,Sr,y_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Dr,P_,Lr,q_,C_,j_,zn,N_,mt,Wr,O_,vo,S_,ni,A_,I_,Al,D_,L_,W_,Pn,R_,qn,uc,yo,Cn,Il,Rr,U_,Dl,H_,gc,Ie,Ur,Q_,Ll,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,jn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,hb,Sn,_c,Mo,An,Rl,Gr,mb,Ul,fb,bc,De,Yr,ub,Hl,gb,_b,Jr,bb,ai,Tb,kb,vb,Zr,yb,Xr,wb,Mb,$b,In,Fb,ft,ea,Bb,$o,Eb,ii,xb,zb,Ql,Pb,qb,Cb,Dn,jb,Ln,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,kc,Le,oa,Sb,Gl,Ab,Ib,na,Db,li,Lb,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,vc,Eo,Kn,Jl,ia,sT,Zl,rT,yc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,hT,da,mT,ci,fT,uT,gT,ca,_T,pa,bT,TT,kT,Vn,vT,ot,ha,yT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new qe({}),X=new qe({}),I=new qe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_16836/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_16836/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16836/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L944",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L1053",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L1139",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L1248",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L1561",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_mobilebert.py#L1351",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16836/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
`}}),Gn=new Pe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[hw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=h(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),f=h(),x=r("span"),he=n("MobileBERT"),V=h(),z=r("h2"),J=r("a"),D=r("span"),v(X.$$.fragment),me=h(),L=r("span"),fe=n("Overview"),le=h(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ef=h(),Ce=r("div"),v(Zs.$$.fragment),xf=h(),so=r("p"),zf=n("The "),Ra=r("a"),Pf=n("MobileBertForSequenceClassification"),qf=n(" forward method, overrides the "),ll=r("code"),Cf=n("__call__"),jf=n(" special method."),Nf=h(),v(Xo.$$.fragment),Of=h(),v(en.$$.fragment),Sf=h(),v(tn.$$.fragment),Af=h(),v(on.$$.fragment),If=h(),v(nn.$$.fragment),tc=h(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Df=h(),cl=r("span"),Lf=n("MobileBertForMultipleChoice"),oc=h(),Ke=r("div"),v(er.$$.fragment),Wf=h(),pl=r("p"),Rf=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
linear layers on top of the hidden-states output to compute `),Tl=r("code"),Cu=n("span start logits"),ju=n(" and "),kl=r("code"),Nu=n("span end logits"),Ou=n(")."),Su=h(),mr=r("p"),Au=n("This model inherits from "),Va=r("a"),Iu=n("PreTrainedModel"),Du=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu=h(),fr=r("p"),Wu=n("This model is also a PyTorch "),ur=r("a"),Ru=n("torch.nn.Module"),Uu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d_=h(),v($n.$$.fragment),c_=h(),Xe=r("div"),v(Nr.$$.fragment),p_=h(),To=r("p"),h_=n("The "),ti=r("a"),m_=n("TFMobileBertForMaskedLM"),f_=n(" forward method, overrides the "),jl=r("code"),u_=n("__call__"),g_=n(" special method."),__=h(),v(Fn.$$.fragment),b_=h(),v(Bn.$$.fragment),T_=h(),v(En.$$.fragment),mc=h(),ko=r("h2"),xn=r("a"),Nl=r("span"),v(Or.$$.fragment),k_=h(),Ol=r("span"),v_=n("TFMobileBertForNextSentencePrediction"),fc=h(),Ae=r("div"),v(Sr.$$.fragment),y_=h(),Ar=r("p"),w_=n("MobileBert Model with a "),Sl=r("code"),M_=n("next sentence prediction (classification)"),$_=n(" head on top."),F_=h(),Ir=r("p"),B_=n("This model inherits from "),oi=r("a"),E_=n("TFPreTrainedModel"),x_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z_=h(),Dr=r("p"),P_=n("This model is also a "),Lr=r("a"),q_=n("tf.keras.Model"),C_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=h(),v(zn.$$.fragment),N_=h(),mt=r("div"),v(Wr.$$.fragment),O_=h(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),D_=n("__call__"),L_=n(" special method."),W_=h(),v(Pn.$$.fragment),R_=h(),v(qn.$$.fragment),uc=h(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=h(),Dl=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=h(),Ie=r("div"),v(Ur.$$.fragment),Q_=h(),Ll=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ob=h(),v(jn.$$.fragment),nb=h(),et=r("div"),v(Vr.$$.fragment),sb=h(),wo=r("p"),rb=n("The "),ri=r("a"),ab=n("TFMobileBertForSequenceClassification"),ib=n(" forward method, overrides the "),Wl=r("code"),lb=n("__call__"),db=n(" special method."),cb=h(),v(Nn.$$.fragment),pb=h(),v(On.$$.fragment),hb=h(),v(Sn.$$.fragment),_c=h(),Mo=r("h2"),An=r("a"),Rl=r("span"),v(Gr.$$.fragment),mb=h(),Ul=r("span"),fb=n("TFMobileBertForMultipleChoice"),bc=h(),De=r("div"),v(Yr.$$.fragment),ub=h(),Hl=r("p"),gb=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kT=h(),v(Vn.$$.fragment),vT=h(),ot=r("div"),v(ha.$$.fragment),yT=h(),zo=r("p"),wT=n("The "),pi=r("a"),MT=n("TFMobileBertForQuestionAnswering"),$T=n(" forward method, overrides the "),td=r("code"),FT=n("__call__"),BT=n(" special method."),ET=h(),v(Gn.$$.fragment),xT=h(),v(Yn.$$.fragment),zT=h(),v(Jn.$$.fragment),this.h()},l(o){const k=fy('[data-svelte="svelte-1phssyn"]',document.head);d=a(k,"META",{name:!0,content:!0}),k.forEach(t),_=m(o),c=a(o,"H1",{class:!0});var ma=i(c);p=a(ma,"A",{id:!0,class:!0,href:!0});var od=i(p);T=a(od,"SPAN",{});var nd=i(T);y(l.$$.fragment,nd),nd.forEach(t),od.forEach(t),f=m(ma),x=a(ma,"SPAN",{});var sd=i(x);he=s(sd,"MobileBERT"),sd.forEach(t),ma.forEach(t),V=m(o),z=a(o,"H2",{class:!0});var fa=i(z);J=a(fa,"A",{id:!0,class:!0,href:!0});var rd=i(J);D=a(rd,"SPAN",{});var ad=i(D);y(X.$$.fragment,ad),ad.forEach(t),rd.forEach(t),me=m(fa),L=a(fa,"SPAN",{});var id=i(L);fe=s(id,"Overview"),id.forEach(t),fa.forEach(t),le=m(o),K=a(o,"P",{});var ua=i(K);N=s(ua,"The MobileBERT model was proposed in "),ee=a(ua,"A",{href:!0,rel:!0});var ld=i(ee);G=s(ld,"MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),ld.forEach(t),P=s(ua,` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Om=m(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sm=m(zt),eo=a(zt,"P",{});var ui=i(eo);Am=s(ui,"The "),Ia=a(ui,"A",{href:!0});var ck=i(Ia);Im=s(ck,"MobileBertForMaskedLM"),ck.forEach(t),Dm=s(ui," forward method, overrides the "),el=a(ui,"CODE",{});var pk=i(el);Lm=s(pk,"__call__"),pk.forEach(t),Wm=s(ui," special method."),ui.forEach(t),Rm=m(zt),y(Qo.$$.fragment,zt),Um=m(zt),y(Ko.$$.fragment,zt),Hm=m(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=m(o),to=a(o,"H2",{class:!0});var Dc=i(to);Go=a(Dc,"A",{id:!0,class:!0,href:!0});var hk=i(Go);tl=a(hk,"SPAN",{});var mk=i(tl);y(Ds.$$.fragment,mk),mk.forEach(t),hk.forEach(t),Qm=m(Dc),ol=a(Dc,"SPAN",{});var fk=i(ol);Km=s(fk,"MobileBertForNextSentencePrediction"),fk.forEach(t),Dc.forEach(t),Zd=m(o),He=a(o,"DIV",{class:!0});var Pt=i(He);y(Ls.$$.fragment,Pt),Vm=m(Pt),Ws=a(Pt,"P",{});var Lc=i(Ws);Gm=s(Lc,"MobileBert Model with a "),nl=a(Lc,"CODE",{});var uk=i(nl);Ym=s(uk,"next sentence prediction (classification)"),uk.forEach(t),Jm=s(Lc," head on top."),Lc.forEach(t),Zm=m(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xm=s(Wc,"This model inherits from "),Da=a(Wc,"A",{href:!0});var gk=i(Da);ef=s(gk,"PreTrainedModel"),gk.forEach(t),tf=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Ef=m(qt),Ce=a(qt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),xf=m(nt),so=a(nt,"P",{});var _i=i(so);zf=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fk=i(Ra);Pf=s(Fk,"MobileBertForSequenceClassification"),Fk.forEach(t),qf=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bk=i(ll);Cf=s(Bk,"__call__"),Bk.forEach(t),jf=s(_i," special method."),_i.forEach(t),Nf=m(nt),y(Xo.$$.fragment,nt),Of=m(nt),y(en.$$.fragment,nt),Sf=m(nt),y(tn.$$.fragment,nt),Af=m(nt),y(on.$$.fragment,nt),If=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ek=i(sn);dl=a(Ek,"SPAN",{});var xk=i(dl);y(Xs.$$.fragment,xk),xk.forEach(t),Ek.forEach(t),Df=m(Kc),cl=a(Kc,"SPAN",{});var zk=i(cl);Lf=s(zk,"MobileBertForMultipleChoice"),zk.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Wf=m(Ct),pl=a(Ct,"P",{});var Pk=i(pl);Rf=s(Pk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Pk.forEach(t),Uf=m(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Hf=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qk=i(Ua);Qf=s(qk,"PreTrainedModel"),qk.forEach(t),Kf=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Vf=m(Ct),or=a(Ct,"P",{});var Gc=i(or);Gf=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var Ck=i(nr);Yf=s(Ck,"torch.nn.Module"),Ck.forEach(t),Jf=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Zf=m(Ct),ct=a(Ct,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Xf=m(os),ao=a(os,"P",{});var bi=i(ao);eu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var jk=i(Ha);tu=s(jk,"MobileBertForMultipleChoice"),jk.forEach(t),ou=s(bi," forward method, overrides the "),hl=a(bi,"CODE",{});var Nk=i(hl);nu=s(Nk,"__call__"),Nk.forEach(t),su=s(bi," special method."),bi.forEach(t),ru=m(os),y(rn.$$.fragment,os),au=m(os),y(an.$$.fragment,os),os.forEach(t),Ct.forEach(t),nc=m(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var Ok=i(ln);ml=a(Ok,"SPAN",{});var Sk=i(ml);y(rr.$$.fragment,Sk),Sk.forEach(t),Ok.forEach(t),iu=m(Yc),fl=a(Yc,"SPAN",{});var Ak=i(fl);lu=s(Ak,"MobileBertForTokenClassification"),Ak.forEach(t),Yc.forEach(t),sc=m(o),Ve=a(o,"DIV",{class:!0});var jt=i(Ve);y(ar.$$.fragment,jt),du=m(jt),ul=a(jt,"P",{});var Ik=i(ul);cu=s(Ik,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pu=m(jt),ir=a(jt,"P",{});var Jc=i(ir);hu=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Dk=i(Qa);mu=s(Dk,"PreTrainedModel"),Dk.forEach(t),fu=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),uu=m(jt),lr=a(jt,"P",{});var Zc=i(lr);gu=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Lk=i(dr);_u=s(Lk,"torch.nn.Module"),Lk.forEach(t),bu=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tu=m(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),ku=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vu=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wk=i(Ka);yu=s(Wk,"MobileBertForTokenClassification"),Wk.forEach(t),wu=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rk=i(gl);Mu=s(Rk,"__call__"),Rk.forEach(t),$u=s(Ti," special method."),Ti.forEach(t),Fu=m(Nt),y(dn.$$.fragment,Nt),Bu=m(Nt),y(cn.$$.fragment,Nt),Eu=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uk=i(hn);_l=a(Uk,"SPAN",{});var Hk=i(_l);y(pr.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),xu=m(Xc),bl=a(Xc,"SPAN",{});var Qk=i(bl);zu=s(Qk,"MobileBertForQuestionAnswering"),Qk.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pu=m(Ot),po=a(Ot,"P",{});var ki=i(po);qu=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Kk=i(Tl);Cu=s(Kk,"span start logits"),Kk.forEach(t),ju=s(ki," and "),kl=a(ki,"CODE",{});var Vk=i(kl);Nu=s(Vk,"span end logits"),Vk.forEach(t),Ou=s(ki,")."),ki.forEach(t),Su=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Au=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var Gk=i(Va);Iu=s(Gk,"PreTrainedModel"),Gk.forEach(t),Du=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Lu=m(Ot),fr=a(Ot,"P",{});var tp=i(fr);Wu=s(tp,"This model is also a PyTorch "),ur=a(tp,"A",{href:!0,rel:!0});var Yk=i(ur);Ru=s(Yk,"torch.nn.Module"),Yk.forEach(t),Uu=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Hu=m(Ot),Ze=a(Ot,"DIV",{class:!0});var St=i(Ze);y(gr.$$.fragment,St),Qu=m(St),ho=a(St,"P",{});var vi=i(ho);Ku=s(vi,"The "),Ga=a(vi,"A",{href:!0});var Jk=i(Ga);Vu=s(Jk,"MobileBertForQuestionAnswering"),Jk.forEach(t),Gu=s(vi," forward method, overrides the "),vl=a(vi,"CODE",{});var Zk=i(vl);Yu=s(Zk,"__call__"),Zk.forEach(t),Ju=s(vi," special method."),vi.forEach(t),Zu=m(St),y(mn.$$.fragment,St),Xu=m(St),y(fn.$$.fragment,St),eg=m(St),y(un.$$.fragment,St),St.forEach(t),Ot.forEach(t),ic=m(o),mo=a(o,"H2",{class:!0});var op=i(mo);gn=a(op,"A",{id:!0,class:!0,href:!0});var Xk=i(gn);yl=a(Xk,"SPAN",{});var ev=i(yl);y(_r.$$.fragment,ev),ev.forEach(t),Xk.forEach(t),tg=m(op),wl=a(op,"SPAN",{});var tv=i(wl);og=s(tv,"TFMobileBertModel"),tv.forEach(t),op.forEach(t),lc=m(o),Ne=a(o,"DIV",{class:!0});var gt=i(Ne);y(br.$$.fragment,gt),ng=m(gt),Ml=a(gt,"P",{});var ov=i(Ml);sg=s(ov,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),ov.forEach(t),rg=m(gt),Tr=a(gt,"P",{});var np=i(Tr);ag=s(np,"This model inherits from "),Ya=a(np,"A",{href:!0});var nv=i(Ya);ig=s(nv,"TFPreTrainedModel"),nv.forEach(t),lg=s(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sp.forEach(t),mg=m(gt),y(_n.$$.fragment,gt),fg=m(gt),pt=a(gt,"DIV",{class:!0});var ns=i(pt);y(yr.$$.fragment,ns),ug=m(ns),fo=a(ns,"P",{});var yi=i(fo);gg=s(yi,"The "),Ja=a(yi,"A",{href:!0});var rv=i(Ja);_g=s(rv,"TFMobileBertModel"),rv.forEach(t),bg=s(yi," forward method, overrides the "),$l=a(yi,"CODE",{});var av=i($l);Tg=s(av,"__call__"),av.forEach(t),kg=s(yi," special method."),yi.forEach(t),vg=m(ns),y(bn.$$.fragment,ns),yg=m(ns),y(Tn.$$.fragment,ns),ns.forEach(t),gt.forEach(t),dc=m(o),uo=a(o,"H2",{class:!0});var rp=i(uo);kn=a(rp,"A",{id:!0,class:!0,href:!0});var iv=i(kn);Fl=a(iv,"SPAN",{});var lv=i(Fl);y(wr.$$.fragment,lv),lv.forEach(t),iv.forEach(t),wg=m(rp),Bl=a(rp,"SPAN",{});var dv=i(Bl);Mg=s(dv,"TFMobileBertForPreTraining"),dv.forEach(t),rp.forEach(t),cc=m(o),Oe=a(o,"DIV",{class:!0});var _t=i(Oe);y(Mr.$$.fragment,_t),$g=m(_t),go=a(_t,"P",{});var wi=i(go);Fg=s(wi,"MobileBert Model with two heads on top as done during the pretraining: a "),El=a(wi,"CODE",{});var cv=i(El);Bg=s(cv,"masked language modeling"),cv.forEach(t),Eg=s(wi,` head and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=m(bt),y($n.$$.fragment,bt),c_=m(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);y(Nr.$$.fragment,At),p_=m(At),To=a(At,"P",{});var $i=i(To);h_=s($i,"The "),ti=a($i,"A",{href:!0});var yv=i(ti);m_=s(yv,"TFMobileBertForMaskedLM"),yv.forEach(t),f_=s($i," forward method, overrides the "),jl=a($i,"CODE",{});var wv=i(jl);u_=s(wv,"__call__"),wv.forEach(t),g_=s($i," special method."),$i.forEach(t),__=m(At),y(Fn.$$.fragment,At),b_=m(At),y(Bn.$$.fragment,At),T_=m(At),y(En.$$.fragment,At),At.forEach(t),bt.forEach(t),mc=m(o),ko=a(o,"H2",{class:!0});var hp=i(ko);xn=a(hp,"A",{id:!0,class:!0,href:!0});var Mv=i(xn);Nl=a(Mv,"SPAN",{});var $v=i(Nl);y(Or.$$.fragment,$v),$v.forEach(t),Mv.forEach(t),k_=m(hp),Ol=a(hp,"SPAN",{});var Fv=i(Ol);v_=s(Fv,"TFMobileBertForNextSentencePrediction"),Fv.forEach(t),hp.forEach(t),fc=m(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);y(Sr.$$.fragment,Tt),y_=m(Tt),Ar=a(Tt,"P",{});var mp=i(Ar);w_=s(mp,"MobileBert Model with a "),Sl=a(mp,"CODE",{});var Bv=i(Sl);M_=s(Bv,"next sentence prediction (classification)"),Bv.forEach(t),$_=s(mp," head on top."),mp.forEach(t),F_=m(Tt),Ir=a(Tt,"P",{});var fp=i(Ir);B_=s(fp,"This model inherits from "),oi=a(fp,"A",{href:!0});var Ev=i(oi);E_=s(Ev,"TFPreTrainedModel"),Ev.forEach(t),x_=s(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),z_=m(Tt),Dr=a(Tt,"P",{});var up=i(Dr);P_=s(up,"This model is also a "),Lr=a(up,"A",{href:!0,rel:!0});var xv=i(Lr);q_=s(xv,"tf.keras.Model"),xv.forEach(t),C_=s(up,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),up.forEach(t),j_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pv=i(Al);D_=s(Pv,"__call__"),Pv.forEach(t),L_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(Pn.$$.fragment,rs),R_=m(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),uc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var qv=i(Cn);Il=a(qv,"SPAN",{});var Cv=i(Il);y(Rr.$$.fragment,Cv),Cv.forEach(t),qv.forEach(t),U_=m(gp),Dl=a(gp,"SPAN",{});var jv=i(Dl);H_=s(jv,"TFMobileBertForSequenceClassification"),jv.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Ll=a(kt,"P",{});var Nv=i(Ll);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
