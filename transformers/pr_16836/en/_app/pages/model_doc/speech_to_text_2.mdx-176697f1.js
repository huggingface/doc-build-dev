import{S as ti,i as oi,s as ri,e as a,k as l,w as g,t as r,M as si,c as n,d as o,m as d,a as c,x as v,h as s,b as i,F as e,g as h,y as x,q as T,o as b,B as k,v as ai,L as ei}from"../../chunks/vendor-6b77c823.js";import{T as Yc}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-1088f2fb.js";import{C as Pr}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as gt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Zc}from"../../chunks/ExampleCodeBlock-5212b321.js";function ni(B){let m,E,u,_,w;return _=new Pr({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(f){m=n(f,"P",{});var S=c(m);E=s(S,"Example:"),S.forEach(o),u=d(f),v(_.$$.fragment,f)},m(f,S){h(f,m,S),e(m,E),h(f,u,S),x(_,f,S),w=!0},p:ei,i(f){w||(T(_.$$.fragment,f),w=!0)},o(f){b(_.$$.fragment,f),w=!1},d(f){f&&o(m),f&&o(u),k(_,f)}}}function di(B){let m,E,u,_,w,f,S,W,q,y,F,M,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Fr,Mr,Pe,Ar,Lr,Lo,z,Dr,so,Wr,Ir,ao,Vr,Nr,xt,Or,Ur,Tt,Rr,Hr,bt,Br,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Wo,ce,Zr,Ce,es,ts,Io,kt,os,Vo,G,qe,rs,Fe,ss,as,ns,Me,cs,St,is,ls,ds,Ae,ps,Le,hs,fs,No,Z,ie,co,De,ms,io,us,Oo,K,_s,wt,gs,vs,$t,xs,Ts,Uo,C,bs,yt,ks,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Ro,Ct,lo,qs,Ho,We,Bo,qt,Ie,po,Fs,Ms,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Ws,Ko,ee,de,fo,Oe,Is,mo,Vs,Qo,I,Ue,Ns,te,Os,Ft,Us,Rs,Re,Hs,Bs,Js,oe,Gs,Mt,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,He,ea,_o,ta,Yo,j,Be,oa,go,ra,sa,Je,aa,Lt,na,ca,ia,fe,Ge,la,vo,da,pa,Q,Ke,ha,xo,fa,ma,Qe,ua,To,_a,ga,va,Dt,Xe,Zo,se,me,bo,Ye,xa,ko,Ta,er,$,Ze,ba,So,ka,Sa,A,Wt,wa,$a,It,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Fa,Ma,Aa,ue,tt,La,U,Da,$o,Wa,Ia,Ot,Va,Na,ot,yo,Oa,Ua,Ra,Ha,X,rt,Ba,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Ut,Ya,Za,en,ge,tn,ve,nt,on,ct,rn,Rt,sn,an,nn,xe,it,cn,lt,ln,Ht,dn,pn,hn,Te,dt,fn,zo,mn,tr,ae,be,Po,pt,un,jo,_n,or,V,ht,gn,R,vn,Bt,xn,Tn,Co,bn,kn,Jt,Sn,wn,$n,ft,yn,mt,En,zn,Pn,ke,ut,jn,Se,rr;return f=new gt({}),ze=new gt({}),De=new gt({}),We=new Pr({props:{code:`import torch
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16836/en/model_doc/speech_to_text#transformers.Speech2TextModel">Speech2TextModel</a>`,name:"vocab_size"},{anchor:"transformers.Speech2Text2Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L29"}}),pe=new Zc({props:{anchor:"transformers.Speech2Text2Config.example",$$slots:{default:[ni]},$$scope:{ctx:B}}}),He=new gt({}),Be=new D({props:{name:"class transformers.Speech2Text2Tokenizer",anchor:"transformers.Speech2Text2Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"do_lower_case",val:" = False"},{name:"merges_file",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/tokenization_utils_base.py#L3245",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/tokenization_utils_base.py#L3278",returnDescription:`
<p>The decoded sentence.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Xe=new D({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L235"}}),Ye=new gt({}),Ze=new D({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16836/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer">Speech2Text2Tokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23"}}),tt=new D({props:{name:"__call__",anchor:"transformers.Speech2Text2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L44"}}),rt=new D({props:{name:"from_pretrained",anchor:"transformers.Speech2Text2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16836/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
`}}),Se=new Zc({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[li]},$$scope:{ctx:B}}}),{c(){m=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(f.$$.fragment),S=l(),W=a("span"),q=r("Speech2Text2"),y=l(),F=a("h2"),M=a("a"),oo=a("span"),g(ze.$$.fragment),jr=l(),ro=a("span"),Cr=r("Overview"),Ao=l(),J=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Fr=r("Wav2Vec2"),Mr=r(` for Speech Translation models proposed in
...
a single processor.`),Cc.forEach(o),Sa=d(P),A=n(P,"P",{});var H=c(A);Wt=n(H,"A",{href:!0});var qc=c(Wt);wa=s(qc,"Speech2Text2Processor"),qc.forEach(o),$a=s(H," offers all the functionalities of "),It=n(H,"A",{href:!0});var Fc=c(It);ya=s(Fc,"AutoFeatureExtractor"),Fc.forEach(o),Ea=s(H," and "),Vt=n(H,"A",{href:!0});var Mc=c(Vt);za=s(Mc,"Speech2Text2Tokenizer"),Mc.forEach(o),Pa=s(H,`.
See the `),et=n(H,"A",{href:!0});var Cn=c(et);wo=n(Cn,"STRONG",{});var Ac=c(wo);ja=s(Ac,"call"),Ac.forEach(o),Ca=s(Cn,"()"),Cn.forEach(o),qa=s(H," and "),Nt=n(H,"A",{href:!0});var Lc=c(Nt);Fa=s(Lc,"decode()"),Lc.forEach(o),Ma=s(H," for more information."),H.forEach(o),Aa=d(P),ue=n(P,"DIV",{class:!0});var xr=c(ue);v(tt.$$.fragment,xr),La=d(xr),U=n(xr,"P",{});var $e=c(U);Da=s($e,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
