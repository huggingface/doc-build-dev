import{S as uk,i as mk,s as fk,e as o,k as c,w as y,t as s,M as gk,c as n,d as t,m as h,a as r,x as q,h as a,b as f,N as _k,F as e,g as m,y as j,q as $,o as E,B as F,v as Tk,L as ut}from"../../chunks/vendor-6b77c823.js";import{T as Ms}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-1088f2fb.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Gt}from"../../chunks/IconCopyLink-7a11ce68.js";import{F as Pc,M as Tn}from"../../chunks/Markdown-9acf6d91.js";import{E as To}from"../../chunks/ExampleCodeBlock-5212b321.js";function bk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L;return g=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>config = TapasConfig(num_aggregation_labels=<span class="hljs-number">3</span>, average_logits_per_cell=<span class="hljs-literal">True</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># initializing the pre-trained base sized model with our custom classification heads</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFTapasForQuestionAnswering.from_pretrained(<span class="hljs-string">&quot;google/tapas-base&quot;</span>, config=config)`}}),{c(){l=o("p"),b=s("Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),p=o("a"),u=s("tensorflow_probability"),T=s(" dependency:"),d=c(),y(g.$$.fragment),A=c(),k=o("p"),N=s("Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=o("a"),U=s("TapasConfig"),B=s(", and then create a "),V=o("a"),R=s("TFTapasForQuestionAnswering"),K=s(" based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),re=c(),y(W.$$.fragment),this.h()},l(w){l=n(w,"P",{});var M=r(l);b=a(M,"Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),p=n(M,"A",{href:!0,rel:!0});var G=r(p);u=a(G,"tensorflow_probability"),G.forEach(t),T=a(M," dependency:"),M.forEach(t),d=h(w),q(g.$$.fragment,w),A=h(w),k=n(w,"P",{});var C=r(k);N=a(C,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=n(C,"A",{href:!0});var O=r(x);U=a(O,"TapasConfig"),O.forEach(t),B=a(C,", and then create a "),V=n(C,"A",{href:!0});var ee=r(V);R=a(ee,"TFTapasForQuestionAnswering"),ee.forEach(t),K=a(C," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),C.forEach(t),re=h(w),q(W.$$.fragment,w),this.h()},h(){f(p,"href","https://github.com/tensorflow/probability"),f(p,"rel","nofollow"),f(x,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasConfig"),f(V,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(w,M){m(w,l,M),e(l,b),e(l,p),e(p,u),e(l,T),m(w,d,M),j(g,w,M),m(w,A,M),m(w,k,M),e(k,N),e(k,x),e(x,U),e(k,B),e(k,V),e(V,R),e(k,K),m(w,re,M),j(W,w,M),L=!0},p:ut,i(w){L||($(g.$$.fragment,w),$(W.$$.fragment,w),L=!0)},o(w){E(g.$$.fragment,w),E(W.$$.fragment,w),L=!1},d(w){w&&t(l),w&&t(d),F(g,w),w&&t(A),w&&t(k),w&&t(re),F(W,w)}}}function kk(P){let l,b;return l=new Tn({props:{$$slots:{default:[wk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(p){q(l.$$.fragment,p)},m(p,u){j(l,p,u),b=!0},p(p,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:p}),l.$set(T)},i(p){b||($(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){F(l,p)}}}function yk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,pe,de,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Pe,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Bt,Ft,hs,Ye,$e,Ws,At,ae,ot,Vt,Hs,xt,Jt,Us,zt,Ct,Rs,Mt,Xt,Gs,Pt,Zt,Bs,St,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,os,nt,Js,Ot,Lt,Xs,Zs,Re,ea,ns,rs,et,Qt;return Ue=new Ve({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),b=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),p=o("a"),u=s("TapasTokenizer"),T=s(" to convert table-question pairs into "),d=o("code"),g=s("input_ids"),A=s(", "),k=o("code"),N=s("attention_mask"),x=s(", "),U=o("code"),B=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),R=o("a"),K=s("TapasForQuestionAnswering"),re=s(` requires different
...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),b=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),p=o("a"),u=s("TapasTokenizer"),T=s(" to convert table-question pairs into "),d=o("code"),g=s("input_ids"),A=s(", "),k=o("code"),N=s("attention_mask"),x=s(", "),U=o("code"),B=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),R=o("a"),K=s("TFTapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),W=c(),L=o("table"),w=o("thead"),M=o("tr"),G=o("th"),C=o("strong"),O=s("Task"),ee=c(),te=o("th"),ce=o("strong"),oe=s("Required inputs"),se=c(),S=o("tbody"),Q=o("tr"),H=o("td"),X=s("Conversational"),I=c(),Y=o("td"),ge=o("code"),ue=s("input_ids"),_e=s(", "),me=o("code"),ne=s("attention_mask"),qe=s(", "),ie=o("code"),ve=s("token_type_ids"),v=s(", "),D=o("code"),be=s("labels"),xe=c(),we=o("tr"),le=o("td"),ze=s("Weak supervision for aggregation"),Me=c(),Z=o("td"),pe=o("code"),de=s("input_ids"),De=s(", "),je=o("code"),Te=s("attention_mask"),Ne=s(", "),ke=o("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=o("code"),Ps=s("labels"),Ss=s(", "),mt=o("code"),ft=s("numeric_values"),ca=s(", "),gt=o("code"),_t=s("numeric_values_scale"),Ds=s(", "),tt=o("code"),Ns=s("float_answer"),Os=c(),Ke=o("tr"),Pe=o("td"),Ls=s("Strong supervision for aggregation"),kt=c(),ye=o("td"),yt=o("code"),qt=s("input ids"),Qs=s(", "),jt=o("code"),$t=s("attention mask"),Is=s(", "),Et=o("code"),cs=s("token type ids"),Bt=s(", "),Ft=o("code"),hs=s("labels"),Ye=s(", "),$e=o("code"),Ws=s("aggregation_labels"),At=c(),ae=o("p"),ot=o("a"),Vt=s("TapasTokenizer"),Hs=s(" creates the "),xt=o("code"),Jt=s("labels"),Us=s(", "),zt=o("code"),Ct=s("numeric_values"),Rs=s(" and "),Mt=o("code"),Xt=s("numeric_values_scale"),Gs=s(" based on the "),Pt=o("code"),Zt=s("answer_coordinates"),Bs=s(" and "),St=o("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Dt=o("code"),es=s("float_answer"),Ks=s(" and "),Nt=o("code"),ts=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ss=c(),y(Ue.$$.fragment),as=c(),Ee=o("p"),os=s("Note that "),nt=o("a"),Js=s("TapasTokenizer"),Ot=s(" expects the data of the table to be "),Lt=o("strong"),Xs=s("text-only"),Zs=s(". You can use "),Re=o("code"),ea=s(".astype(str)"),ns=s(` on a dataframe to turn it into text-only data.
...
inputs to be fine-tuned:`),J.forEach(t),W=h(z),L=n(z,"TABLE",{});var st=r(L);w=n(st,"THEAD",{});var sa=r(w);M=n(sa,"TR",{});var rt=r(M);G=n(rt,"TH",{});var ja=r(G);C=n(ja,"STRONG",{});var aa=r(C);O=a(aa,"Task"),aa.forEach(t),ja.forEach(t),ee=h(rt),te=n(rt,"TH",{});var $a=r(te);ce=n($a,"STRONG",{});var ua=r(ce);oe=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),rt.forEach(t),sa.forEach(t),se=h(st),S=n(st,"TBODY",{});var Ie=r(S);Q=n(Ie,"TR",{});var is=r(Q);H=n(is,"TD",{});var us=r(H);X=a(us,"Conversational"),us.forEach(t),I=h(is),Y=n(is,"TD",{});var Ge=r(Y);ge=n(Ge,"CODE",{});var Ea=r(ge);ue=a(Ea,"input_ids"),Ea.forEach(t),_e=a(Ge,", "),me=n(Ge,"CODE",{});var ma=r(me);ne=a(ma,"attention_mask"),ma.forEach(t),qe=a(Ge,", "),ie=n(Ge,"CODE",{});var ms=r(ie);ve=a(ms,"token_type_ids"),ms.forEach(t),v=a(Ge,", "),D=n(Ge,"CODE",{});var oa=r(D);be=a(oa,"labels"),oa.forEach(t),Ge.forEach(t),is.forEach(t),xe=h(Ie),we=n(Ie,"TR",{});var ls=r(we);le=n(ls,"TD",{});var fa=r(le);ze=a(fa,"Weak supervision for aggregation"),fa.forEach(t),Me=h(ls),Z=n(ls,"TD",{});var fe=r(Z);pe=n(fe,"CODE",{});var Fa=r(pe);de=a(Fa,"input_ids"),Fa.forEach(t),De=a(fe,", "),je=n(fe,"CODE",{});var fs=r(je);Te=a(fs,"attention_mask"),fs.forEach(t),Ne=a(fe,", "),ke=n(fe,"CODE",{});var Aa=r(ke);Ae=a(Aa,"token_type_ids"),Aa.forEach(t),Oe=a(fe,", "),Ze=n(fe,"CODE",{});var xa=r(Ze);Ps=a(xa,"labels"),xa.forEach(t),Ss=a(fe,", "),mt=n(fe,"CODE",{});var ga=r(mt);ft=a(ga,"numeric_values"),ga.forEach(t),ca=a(fe,", "),gt=n(fe,"CODE",{});var Tt=r(gt);_t=a(Tt,"numeric_values_scale"),Tt.forEach(t),Ds=a(fe,", "),tt=n(fe,"CODE",{});var na=r(tt);Ns=a(na,"float_answer"),na.forEach(t),fe.forEach(t),ls.forEach(t),Os=h(Ie),Ke=n(Ie,"TR",{});var ps=r(Ke);Pe=n(ps,"TD",{});var za=r(Pe);Ls=a(za,"Strong supervision for aggregation"),za.forEach(t),kt=h(ps),ye=n(ps,"TD",{});var Fe=r(ye);yt=n(Fe,"CODE",{});var Ca=r(yt);qt=a(Ca,"input ids"),Ca.forEach(t),Qs=a(Fe,", "),jt=n(Fe,"CODE",{});var ra=r(jt);$t=a(ra,"attention mask"),ra.forEach(t),Is=a(Fe,", "),Et=n(Fe,"CODE",{});var Ma=r(Et);cs=a(Ma,"token type ids"),Ma.forEach(t),Bt=a(Fe,", "),Ft=n(Fe,"CODE",{});var Pa=r(Ft);hs=a(Pa,"labels"),Pa.forEach(t),Ye=a(Fe,", "),$e=n(Fe,"CODE",{});var Sa=r($e);Ws=a(Sa,"aggregation_labels"),Sa.forEach(t),Fe.forEach(t),ps.forEach(t),Ie.forEach(t),st.forEach(t),At=h(z),ae=n(z,"P",{});var he=r(ae);ot=n(he,"A",{href:!0});var Da=r(ot);Vt=a(Da,"TapasTokenizer"),Da.forEach(t),Hs=a(he," creates the "),xt=n(he,"CODE",{});var ia=r(xt);Jt=a(ia,"labels"),ia.forEach(t),Us=a(he,", "),zt=n(he,"CODE",{});var Na=r(zt);Ct=a(Na,"numeric_values"),Na.forEach(t),Rs=a(he," and "),Mt=n(he,"CODE",{});var Oa=r(Mt);Xt=a(Oa,"numeric_values_scale"),Oa.forEach(t),Gs=a(he," based on the "),Pt=n(he,"CODE",{});var _a=r(Pt);Zt=a(_a,"answer_coordinates"),_a.forEach(t),Bs=a(he," and "),St=n(he,"CODE",{});var gs=r(St);Vs=a(gs,"answer_text"),gs.forEach(t),Le=a(he," columns of the TSV file. The "),Dt=n(he,"CODE",{});var La=r(Dt);es=a(La,"float_answer"),La.forEach(t),Ks=a(he," and "),Nt=n(he,"CODE",{});var Ta=r(Nt);ts=a(Ta,"aggregation_labels"),Ta.forEach(t),Ys=a(he," are already in the TSV file of step 2. Here\u2019s an example:"),he.forEach(t),ss=h(z),q(Ue.$$.fragment,z),as=h(z),Ee=n(z,"P",{});var Ce=r(Ee);os=a(Ce,"Note that "),nt=n(Ce,"A",{href:!0});var la=r(nt);Js=a(la,"TapasTokenizer"),la.forEach(t),Ot=a(Ce," expects the data of the table to be "),Lt=n(Ce,"STRONG",{});var Wt=r(Lt);Xs=a(Wt,"text-only"),Wt.forEach(t),Zs=a(Ce,". You can use "),Re=n(Ce,"CODE",{});var pa=r(Re);ea=a(pa,".astype(str)"),pa.forEach(t),ns=a(Ce,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ce.forEach(t),rs=h(z),q(et.$$.fragment,z),this.h()},h(){f(p,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer"),f(R,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(ot,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer"),f(nt,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,J){m(z,l,J),e(l,b),e(l,p),e(p,u),e(l,T),e(l,d),e(d,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,B),e(l,V),e(l,R),e(R,K),e(l,re),m(z,W,J),m(z,L,J),e(L,w),e(w,M),e(M,G),e(G,C),e(C,O),e(M,ee),e(M,te),e(te,ce),e(ce,oe),e(L,se),e(L,S),e(S,Q),e(Q,H),e(H,X),e(Q,I),e(Q,Y),e(Y,ge),e(ge,ue),e(Y,_e),e(Y,me),e(me,ne),e(Y,qe),e(Y,ie),e(ie,ve),e(Y,v),e(Y,D),e(D,be),e(S,xe),e(S,we),e(we,le),e(le,ze),e(we,Me),e(we,Z),e(Z,pe),e(pe,de),e(Z,De),e(Z,je),e(je,Te),e(Z,Ne),e(Z,ke),e(ke,Ae),e(Z,Oe),e(Z,Ze),e(Ze,Ps),e(Z,Ss),e(Z,mt),e(mt,ft),e(Z,ca),e(Z,gt),e(gt,_t),e(Z,Ds),e(Z,tt),e(tt,Ns),e(S,Os),e(S,Ke),e(Ke,Pe),e(Pe,Ls),e(Ke,kt),e(Ke,ye),e(ye,yt),e(yt,qt),e(ye,Qs),e(ye,jt),e(jt,$t),e(ye,Is),e(ye,Et),e(Et,cs),e(ye,Bt),e(ye,Ft),e(Ft,hs),e(ye,Ye),e(ye,$e),e($e,Ws),m(z,At,J),m(z,ae,J),e(ae,ot),e(ot,Vt),e(ae,Hs),e(ae,xt),e(xt,Jt),e(ae,Us),e(ae,zt),e(zt,Ct),e(ae,Rs),e(ae,Mt),e(Mt,Xt),e(ae,Gs),e(ae,Pt),e(Pt,Zt),e(ae,Bs),e(ae,St),e(St,Vs),e(ae,Le),e(ae,Dt),e(Dt,es),e(ae,Ks),e(ae,Nt),e(Nt,ts),e(ae,Ys),m(z,ss,J),j(Ue,z,J),m(z,as,J),m(z,Ee,J),e(Ee,os),e(Ee,nt),e(nt,Js),e(Ee,Ot),e(Ee,Lt),e(Lt,Xs),e(Ee,Zs),e(Ee,Re),e(Re,ea),e(Ee,ns),m(z,rs,J),j(et,z,J),Qt=!0},p:ut,i(z){Qt||($(Ue.$$.fragment,z),$(et.$$.fragment,z),Qt=!0)},o(z){E(Ue.$$.fragment,z),E(et.$$.fragment,z),Qt=!1},d(z){z&&t(l),z&&t(W),z&&t(L),z&&t(At),z&&t(ae),z&&t(ss),F(Ue,z),z&&t(as),z&&t(Ee),z&&t(rs),F(et,z)}}}function $k(P){let l,b;return l=new Tn({props:{$$slots:{default:[jk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(p){q(l.$$.fragment,p)},m(p,u){j(l,p,u),b=!0},p(p,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:p}),l.$set(T)},i(p){b||($(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){F(l,p)}}}function Ek(P){let l,b,p,u,T,d,g,A;return g=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering, AdamW
...
<span class="hljs-meta">... </span>        optimizer.step()`}}),{c(){l=o("p"),b=s("You can then fine-tune "),p=o("a"),u=s("TapasForQuestionAnswering"),T=s(" as follows (shown here for the weak supervision for aggregation case):"),d=c(),y(g.$$.fragment),this.h()},l(k){l=n(k,"P",{});var N=r(l);b=a(N,"You can then fine-tune "),p=n(N,"A",{href:!0});var x=r(p);u=a(x,"TapasForQuestionAnswering"),x.forEach(t),T=a(N," as follows (shown here for the weak supervision for aggregation case):"),N.forEach(t),d=h(k),q(g.$$.fragment,k),this.h()},h(){f(p,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(k,N){m(k,l,N),e(l,b),e(l,p),e(p,u),e(l,T),m(k,d,N),j(g,k,N),A=!0},p:ut,i(k){A||($(g.$$.fragment,k),A=!0)},o(k){E(g.$$.fragment,k),A=!1},d(k){k&&t(l),k&&t(d),F(g,k)}}}function Fk(P){let l,b;return l=new Tn({props:{$$slots:{default:[Ek]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(p){q(l.$$.fragment,p)},m(p,u){j(l,p,u),b=!0},p(p,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:p}),l.$set(T)},i(p){b||($(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){F(l,p)}}}function Ak(P){let l,b,p,u,T,d,g,A;return g=new Ve({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">... </span>        optimizer.apply_gradients(<span class="hljs-built_in">zip</span>(grads, model.trainable_weights))`}}),{c(){l=o("p"),b=s("You can then fine-tune "),p=o("a"),u=s("TFTapasForQuestionAnswering"),T=s(" as follows (shown here for the weak supervision for aggregation case):"),d=c(),y(g.$$.fragment),this.h()},l(k){l=n(k,"P",{});var N=r(l);b=a(N,"You can then fine-tune "),p=n(N,"A",{href:!0});var x=r(p);u=a(x,"TFTapasForQuestionAnswering"),x.forEach(t),T=a(N," as follows (shown here for the weak supervision for aggregation case):"),N.forEach(t),d=h(k),q(g.$$.fragment,k),this.h()},h(){f(p,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(k,N){m(k,l,N),e(l,b),e(l,p),e(p,u),e(l,T),m(k,d,N),j(g,k,N),A=!0},p:ut,i(k){A||($(g.$$.fragment,k),A=!0)},o(k){E(g.$$.fragment,k),A=!1},d(k){k&&t(l),k&&t(d),F(g,k)}}}function xk(P){let l,b;return l=new Tn({props:{$$slots:{default:[Ak]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(p){q(l.$$.fragment,p)},m(p,u){j(l,p,u),b=!0},p(p,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:p}),l.$set(T)},i(p){b||($(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){F(l,p)}}}function zk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H;return Q=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=o("p"),b=s("Example:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Example:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Dk(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Nk(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Ok(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Lk(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Qk(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Ik(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForSequenceClassification
import torch
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Wk(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Hk(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Uk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),p=c(),u=o("ul"),T=o("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
...
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,p,D),m(v,u,D),e(u,T),e(T,d),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,G,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(p),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(G),v&&t(C)}}}function Rk(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Gk(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Bk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),p=c(),u=o("ul"),T=o("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),p=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);d=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),B=n(le,"CODE",{});var ze=r(B);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),R=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),G=h(v),C=n(v,"UL",{});var pe=r(C);O=n(pe,"LI",{});var de=r(O);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),de.forEach(t),Q=h(pe),H=n(pe,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(pe),ne=n(pe,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,p,D),m(v,u,D),e(u,T),e(T,d),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,G,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(p),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(G),v&&t(C)}}}function Vk(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Kk(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Yk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),p=c(),u=o("ul"),T=o("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),p=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);d=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),B=n(le,"CODE",{});var ze=r(B);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),R=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),G=h(v),C=n(v,"UL",{});var pe=r(C);O=n(pe,"LI",{});var de=r(O);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),de.forEach(t),Q=h(pe),H=n(pe,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(pe),ne=n(pe,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,p,D),m(v,u,D),e(u,T),e(T,d),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,G,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(p),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(G),v&&t(C)}}}function Jk(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function Xk(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function Zk(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),p=c(),u=o("ul"),T=o("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),p=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);d=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),B=n(le,"CODE",{});var ze=r(B);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),R=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),G=h(v),C=n(v,"UL",{});var pe=r(C);O=n(pe,"LI",{});var de=r(O);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),de.forEach(t),Q=h(pe),H=n(pe,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(pe),ne=n(pe,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,p,D),m(v,u,D),e(u,T),e(T,d),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,G,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(p),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(G),v&&t(C)}}}function ey(P){let l,b,p,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(g,"CODE",{});var A=r(p);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){m(d,l,g),e(l,b),e(l,p),e(p,u),e(l,T)},d(d){d&&t(l)}}}function ty(P){let l,b,p,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),b=s("Examples:"),p=c(),y(u.$$.fragment)},l(d){l=n(d,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),p=h(d),q(u.$$.fragment,d)},m(d,g){m(d,l,g),e(l,b),m(d,p,g),j(u,d,g),T=!0},p:ut,i(d){T||($(u.$$.fragment,d),T=!0)},o(d){E(u.$$.fragment,d),T=!1},d(d){d&&t(l),d&&t(p),F(u,d)}}}function sy(P){let l,b,p,u,T,d,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,pe,de,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Pe,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Bt,Ft,hs,Ye,$e,Ws,At,ae,ot,Vt,Hs,xt,Jt,Us,zt,Ct,Rs,Mt,Xt,Gs,Pt,Zt,Bs,St,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,os,nt,Js,Ot,Lt,Xs,Zs,Re,ea,ns,rs,et,Qt,z,J,ya,ta,qa,ha,It,st,sa,rt,ja,aa,$a,ua,Ie,is,us,Ge,Ea,ma,ms,oa,ls,fa,fe,Fa,fs,Aa,xa,ga,Tt,na,ps,za,Fe,Ca,ra,Ma,Pa,Sa,he,Da,ia,Na,Oa,_a,gs,La,Ta,Ce,la,Wt,pa,el,Sc,Dc,tl,sl,Nc,Oc,al,ol,Lc,Qc,Qa,Ia,nl,Ic,Wc,rl,Hc,Uc,il,Rc,Gc,Wa,ll,Bc,Vc,pl,Kc,Yc,dl,Jc,Xc,Ha,cl,Zc,eh,hl,th,sh,ul,ah,od,bo,nd,vo,oh,bn,nh,rh,rd,wo,ih,vn,lh,ph,id,Rr,ml,dh,ld,ko,ch,wn,hh,uh,pd,We,Gr,fl,mh,fh,gh,Br,gl,_h,Th,bh,Vr,_l,vh,wh,kh,Kr,Tl,yh,qh,jh,Yr,bl,$h,Eh,Fh,Jr,vl,Ah,xh,zh,Xr,wl,Ch,Mh,Ph,Zr,kl,Sh,Dh,Nh,ei,yl,Oh,Lh,dd,bt,Qh,kn,Ih,Wh,yn,Hh,Uh,ql,Rh,Gh,jl,Bh,Vh,$l,Kh,Yh,cd,ti,El,Jh,hd,yo,ud,Se,Xh,Fl,Zh,eu,Al,tu,su,xl,au,ou,zl,nu,ru,Cl,iu,lu,Ml,pu,du,si,cu,hu,qn,uu,mu,jn,fu,gu,md,ai,_u,fd,qo,gd,Ua,jo,Pl,$n,Tu,Sl,bu,_d,$o,Td,vt,vu,Dl,wu,ku,Nl,yu,qu,Ol,ju,$u,En,Eu,Fu,Fn,Au,xu,bd,Ra,Eo,Ll,An,zu,Ql,Cu,vd,Ga,xn,Mu,zn,Pu,oi,Su,Du,wd,Ba,Fo,Il,Cn,Nu,Wl,Ou,kd,Ht,Mn,Lu,Va,Qu,ni,Iu,Wu,Pn,Hu,Uu,Ru,Ka,Gu,Hl,Bu,Vu,ri,Ku,Yu,Ju,Sn,Xu,Dn,Zu,em,tm,Ao,yd,Ya,xo,Ul,Nn,sm,Rl,am,qd,Be,On,om,Gl,nm,rm,Qe,im,ii,lm,pm,li,dm,cm,Bl,hm,um,Vl,mm,fm,Kl,gm,_m,Yl,Tm,bm,Jl,vm,wm,Xl,km,ym,Zl,qm,jm,$m,it,ep,Em,Fm,tp,Am,xm,sp,zm,Cm,ap,Mm,Pm,op,Sm,Dm,np,Nm,Om,rp,Lm,Qm,pi,di,Im,Wm,Hm,zo,Ln,Um,ip,Rm,Gm,ba,Qn,Bm,In,Vm,ci,Km,Ym,Jm,Wn,Xm,Hn,Zm,ef,tf,hi,Un,jd,Ja,Co,lp,Rn,sf,pp,af,$d,lt,Gn,of,Bn,nf,ui,rf,lf,pf,Vn,df,Kn,cf,hf,uf,Yn,mf,mi,ff,gf,_f,Jn,Tf,Xn,bf,vf,wf,_s,Zn,kf,Xa,yf,fi,qf,jf,dp,$f,Ef,Ff,Mo,Af,Po,Ed,Za,So,cp,er,xf,hp,zf,Fd,ds,tr,Cf,eo,Mf,up,Pf,Sf,gi,Df,Nf,Of,sr,Lf,ar,Qf,If,Wf,Ts,or,Hf,to,Uf,_i,Rf,Gf,mp,Bf,Vf,Kf,Do,Yf,No,Ad,so,Oo,fp,nr,Jf,gp,Xf,xd,Ut,rr,Zf,_p,eg,tg,ir,sg,Ti,ag,og,ng,lr,rg,pr,ig,lg,pg,bs,dr,dg,ao,cg,bi,hg,ug,Tp,mg,fg,gg,Lo,_g,Qo,zd,oo,Io,bp,cr,Tg,vp,bg,Cd,Rt,hr,vg,no,wg,wp,kg,yg,kp,qg,jg,$g,ur,Eg,vi,Fg,Ag,xg,mr,zg,fr,Cg,Mg,Pg,vs,gr,Sg,ro,Dg,wi,Ng,Og,yp,Lg,Qg,Ig,Wo,Wg,Ho,Md,io,Uo,qp,_r,Hg,jp,Ug,Pd,pt,Tr,Rg,$p,Gg,Bg,br,Vg,ki,Kg,Yg,Jg,vr,Xg,wr,Zg,e_,t_,Ro,s_,ws,kr,a_,lo,o_,yi,n_,r_,Ep,i_,l_,p_,Go,d_,Bo,Sd,po,Vo,Fp,yr,c_,Ap,h_,Dd,dt,qr,u_,jr,m_,xp,f_,g_,__,$r,T_,qi,b_,v_,w_,Er,k_,Fr,y_,q_,j_,Ko,$_,ks,Ar,E_,co,F_,ji,A_,x_,zp,z_,C_,M_,Yo,P_,Jo,Nd,ho,Xo,Cp,xr,S_,Mp,D_,Od,ct,zr,N_,Pp,O_,L_,Cr,Q_,$i,I_,W_,H_,Mr,U_,Pr,R_,G_,B_,Zo,V_,ys,Sr,K_,uo,Y_,Ei,J_,X_,Sp,Z_,eT,tT,en,sT,tn,Ld,mo,sn,Dp,Dr,aT,Np,oT,Qd,ht,Nr,nT,fo,rT,Op,iT,lT,Lp,pT,dT,cT,Or,hT,Fi,uT,mT,fT,Lr,gT,Qr,_T,TT,bT,an,vT,qs,Ir,wT,go,kT,Ai,yT,qT,Qp,jT,$T,ET,on,FT,nn,Id;return d=new Gt({}),V=new Gt({}),rt=new Gt({}),bo=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[kk],pytorch:[vk]},$$scope:{ctx:P}}}),yo=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[$k],pytorch:[qk]},$$scope:{ctx:P}}}),qo=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[xk],pytorch:[Fk]},$$scope:{ctx:P}}}),$n=new Gt({}),$o=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Pk],pytorch:[Ck]},$$scope:{ctx:P}}}),An=new Gt({}),xn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
this threshold will be selected.`,name:"cell_classification_threshold"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/tokenization_tapas.py#L1890",returnDescription:`
<ul>
...
`}}),Un=new He({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/tokenization_tapas.py#L396"}}),Rn=new Gt({}),Gn=new He({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L852"}}),Zn=new He({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
Whether or not to return a <a href="/docs/transformers/pr_16836/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L1005"}}),or=new He({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L1024",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L1464"}}),dr=new He({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L1476",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tapas.py#L1155",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tf_tapas.py#L961"}}),Ro=new Ms({props:{$$slots:{default:[Uk]},$$scope:{ctx:P}}}),kr=new He({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16836/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16836/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tf_tapas.py#L967",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tf_tapas.py#L1052",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy). Note: this is called
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tf_tapas.py#L1585",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16836/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/pr_16836/src/transformers/models/tapas/modeling_tf_tapas.py#L1264",returnDescription:`
...
implementation. Original implementation available at `),Dn=o("a"),Zu=s("https://github.com/google-research/tapas/tree/master"),em=s("."),tm=c(),y(Ao.$$.fragment),yd=c(),Ya=o("h2"),xo=o("a"),Ul=o("span"),y(Nn.$$.fragment),sm=c(),Rl=o("span"),am=s("TapasTokenizer"),qd=c(),Be=o("div"),y(On.$$.fragment),om=c(),Gl=o("p"),nm=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),rm=c(),Qe=o("p"),im=s("This tokenizer inherits from "),ii=o("a"),lm=s("PreTrainedTokenizer"),pm=s(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),li=o("a"),dm=s("TapasTokenizer"),cm=s(` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Bl=o("code"),hm=s("segment_ids"),um=s(`,
`),Vl=o("code"),mm=s("column_ids"),fm=s(", "),Kl=o("code"),gm=s("row_ids"),_m=s(", "),Yl=o("code"),Tm=s("prev_labels"),bm=s(", "),Jl=o("code"),vm=s("column_ranks"),wm=s(", "),Xl=o("code"),km=s("inv_column_ranks"),ym=s(" and "),Zl=o("code"),qm=s("numeric_relations"),jm=s(":"),$m=c(),it=o("ul"),ep=o("li"),Em=s(`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),Fm=c(),tp=o("li"),Am=s(`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),xm=c(),sp=o("li"),zm=s(`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Cm=c(),ap=o("li"),Mm=s(`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Pm=c(),op=o("li"),Sm=s(`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Dm=c(),np=o("li"),Nm=s(`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Om=c(),rp=o("li"),Lm=s(`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),Qm=c(),pi=o("p"),di=o("a"),Im=s("TapasTokenizer"),Wm=s(` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),Hm=c(),zo=o("div"),y(Ln.$$.fragment),Um=c(),ip=o("p"),Rm=s("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Gm=c(),ba=o("div"),y(Qn.$$.fragment),Bm=c(),In=o("p"),Vm=s("Converts logits of "),ci=o("a"),Km=s("TapasForQuestionAnswering"),Ym=s(` to actual predicted answer coordinates and optional
aggregation indices.`),Jm=c(),Wn=o("p"),Xm=s(`The original implementation, on which this function is based, can be found
`),Hn=o("a"),Zm=s("here"),ef=s("."),tf=c(),hi=o("div"),y(Un.$$.fragment),jd=c(),Ja=o("h2"),Co=o("a"),lp=o("span"),y(Rn.$$.fragment),sf=c(),pp=o("span"),af=s("TapasModel"),$d=c(),lt=o("div"),y(Gn.$$.fragment),of=c(),Bn=o("p"),nf=s(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
etc.)`),pf=c(),Vn=o("p"),df=s("This model is also a PyTorch "),Kn=o("a"),cf=s("torch.nn.Module"),hf=s(` subclass.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),wf=c(),_s=o("div"),y(Zn.$$.fragment),kf=c(),Xa=o("p"),yf=s("The "),fi=o("a"),qf=s("TapasModel"),jf=s(" forward method, overrides the "),dp=o("code"),$f=s("__call__"),Ef=s(" special method."),Ff=c(),y(Mo.$$.fragment),Af=c(),y(Po.$$.fragment),Ed=c(),Za=o("h2"),So=o("a"),cp=o("span"),y(er.$$.fragment),xf=c(),hp=o("span"),zf=s("TapasForMaskedLM"),Fd=c(),ds=o("div"),y(tr.$$.fragment),Cf=c(),eo=o("p"),Mf=s("Tapas Model with a "),up=o("code"),Pf=s("language modeling"),Sf=s(` head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wf=c(),Ts=o("div"),y(or.$$.fragment),Hf=c(),to=o("p"),Uf=s("The "),_i=o("a"),Rf=s("TapasForMaskedLM"),Gf=s(" forward method, overrides the "),mp=o("code"),Bf=s("__call__"),Vf=s(" special method."),Kf=c(),y(Do.$$.fragment),Yf=c(),y(No.$$.fragment),Ad=c(),so=o("h2"),Oo=o("a"),fp=o("span"),y(nr.$$.fragment),Jf=c(),gp=o("span"),Xf=s("TapasForSequenceClassification"),xd=c(),Ut=o("div"),y(rr.$$.fragment),Zf=c(),_p=o("p"),eg=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ng=c(),lr=o("p"),rg=s("This model is also a PyTorch "),pr=o("a"),ig=s("torch.nn.Module"),lg=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pg=c(),bs=o("div"),y(dr.$$.fragment),dg=c(),ao=o("p"),cg=s("The "),bi=o("a"),hg=s("TapasForSequenceClassification"),ug=s(" forward method, overrides the "),Tp=o("code"),mg=s("__call__"),fg=s(" special method."),gg=c(),y(Lo.$$.fragment),_g=c(),y(Qo.$$.fragment),zd=c(),oo=o("h2"),Io=o("a"),bp=o("span"),y(cr.$$.fragment),Tg=c(),vp=o("span"),bg=s("TapasForQuestionAnswering"),Cd=c(),Rt=o("div"),y(hr.$$.fragment),vg=c(),no=o("p"),wg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),wp=o("code"),kg=s("logits"),yg=s(" and optional "),kp=o("code"),qg=s("logits_aggregation"),jg=s(`), e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pg=c(),vs=o("div"),y(gr.$$.fragment),Sg=c(),ro=o("p"),Dg=s("The "),wi=o("a"),Ng=s("TapasForQuestionAnswering"),Og=s(" forward method, overrides the "),yp=o("code"),Lg=s("__call__"),Qg=s(" special method."),Ig=c(),y(Wo.$$.fragment),Wg=c(),y(Ho.$$.fragment),Md=c(),io=o("h2"),Uo=o("a"),qp=o("span"),y(_r.$$.fragment),Hg=c(),jp=o("span"),Ug=s("TFTapasModel"),Pd=c(),pt=o("div"),y(Tr.$$.fragment),Rg=c(),$p=o("p"),Gg=s("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Bg=c(),br=o("p"),Vg=s("This model inherits from "),ki=o("a"),Kg=s("TFPreTrainedModel"),Yg=s(`. Check the superclass documentation for the generic methods the
...
behavior.`),t_=c(),y(Ro.$$.fragment),s_=c(),ws=o("div"),y(kr.$$.fragment),a_=c(),lo=o("p"),o_=s("The "),yi=o("a"),n_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ep=o("code"),i_=s("__call__"),l_=s(" special method."),p_=c(),y(Go.$$.fragment),d_=c(),y(Bo.$$.fragment),Sd=c(),po=o("h2"),Vo=o("a"),Fp=o("span"),y(yr.$$.fragment),c_=c(),Ap=o("span"),h_=s("TFTapasForMaskedLM"),Dd=c(),dt=o("div"),y(qr.$$.fragment),u_=c(),jr=o("p"),m_=s("Tapas Model with a "),xp=o("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=o("p"),T_=s("This model inherits from "),qi=o("a"),b_=s("TFPreTrainedModel"),v_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),w_=c(),Er=o("p"),k_=s("This model is also a "),Fr=o("a"),y_=s("tf.keras.Model"),q_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=c(),y(Ko.$$.fragment),$_=c(),ks=o("div"),y(Ar.$$.fragment),E_=c(),co=o("p"),F_=s("The "),ji=o("a"),A_=s("TFTapasForMaskedLM"),x_=s(" forward method, overrides the "),zp=o("code"),z_=s("__call__"),C_=s(" special method."),M_=c(),y(Yo.$$.fragment),P_=c(),y(Jo.$$.fragment),Nd=c(),ho=o("h2"),Xo=o("a"),Cp=o("span"),y(xr.$$.fragment),S_=c(),Mp=o("span"),D_=s("TFTapasForSequenceClassification"),Od=c(),ct=o("div"),y(zr.$$.fragment),N_=c(),Pp=o("p"),O_=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),B_=c(),y(Zo.$$.fragment),V_=c(),ys=o("div"),y(Sr.$$.fragment),K_=c(),uo=o("p"),Y_=s("The "),Ei=o("a"),J_=s("TFTapasForSequenceClassification"),X_=s(" forward method, overrides the "),Sp=o("code"),Z_=s("__call__"),eT=s(" special method."),tT=c(),y(en.$$.fragment),sT=c(),y(tn.$$.fragment),Ld=c(),mo=o("h2"),sn=o("a"),Dp=o("span"),y(Dr.$$.fragment),aT=c(),Np=o("span"),oT=s("TFTapasForQuestionAnswering"),Qd=c(),ht=o("div"),y(Nr.$$.fragment),nT=c(),fo=o("p"),rT=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Op=o("code"),iT=s("logits"),lT=s(" and optional "),Lp=o("code"),pT=s("logits_aggregation"),dT=s(`), e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bT=c(),y(an.$$.fragment),vT=c(),qs=o("div"),y(Ir.$$.fragment),wT=c(),go=o("p"),kT=s("The "),Ai=o("a"),yT=s("TFTapasForQuestionAnswering"),qT=s(" forward method, overrides the "),Qp=o("code"),jT=s("__call__"),$T=s(" special method."),ET=c(),y(on.$$.fragment),FT=c(),y(nn.$$.fragment),this.h()},l(i){const _=gk('[data-svelte="svelte-1phssyn"]',document.head);l=n(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(i),p=n(i,"H1",{class:!0});var Wr=r(p);u=n(Wr,"A",{id:!0,class:!0,href:!0});var Ip=r(u);T=n(Ip,"SPAN",{});var Wp=r(T);q(d.$$.fragment,Wp),Wp.forEach(t),Ip.forEach(t),g=h(Wr),A=n(Wr,"SPAN",{});var Hp=r(A);k=a(Hp,"TAPAS"),Hp.forEach(t),Wr.forEach(t),N=h(i),x=n(i,"H2",{class:!0});var Hr=r(x);U=n(Hr,"A",{id:!0,class:!0,href:!0});var Up=r(U);B=n(Up,"SPAN",{});var Rp=r(B);q(V.$$.fragment,Rp),Rp.forEach(t),Up.forEach(t),R=h(Hr),K=n(Hr,"SPAN",{});var Gp=r(K);re=a(Gp,"Overview"),Gp.forEach(t),Hr.forEach(t),W=h(i),L=n(i,"P",{});var Ur=r(L);w=a(Ur,"The TAPAS model was proposed in "),M=n(Ur,"A",{href:!0,rel:!0});var Bp=r(M);G=a(Bp,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Bp.forEach(t),C=a(Ur,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Ur.forEach(t),O=h(i),ee=n(i,"P",{});var Vp=r(ee);te=a(Vp,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Vp.forEach(t),ce=h(i),oe=n(i,"UL",{});var _o=r(oe);se=n(_o,"LI",{});var xi=r(se);S=n(xi,"A",{href:!0,rel:!0});var Kp=r(S);Q=a(Kp,"SQA"),Kp.forEach(t),H=a(xi," (Sequential Question Answering by Microsoft)"),xi.forEach(t),X=h(_o),I=n(_o,"LI",{});var zi=r(I);Y=n(zi,"A",{href:!0,rel:!0});var Yp=r(Y);ge=a(Yp,"WTQ"),Yp.forEach(t),ue=a(zi," (Wiki Table Questions by Stanford University)"),zi.forEach(t),_e=h(_o),me=n(_o,"LI",{});var Ci=r(me);ne=n(Ci,"A",{href:!0,rel:!0});var Jp=r(ne);qe=a(Jp,"WikiSQL"),Jp.forEach(t),ie=a(Ci," (by Salesforce)."),Ci.forEach(t),_o.forEach(t),ve=h(i),v=n(i,"P",{});var Xp=r(v);D=a(Xp,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),Xp.forEach(t),be=h(i),xe=n(i,"P",{});var Zp=r(xe);we=a(Zp,"The abstract from the paper is the following:"),Zp.forEach(t),le=h(i),ze=n(i,"P",{});var ed=r(ze);Me=n(ed,"EM",{});var td=r(Me);Z=a(td,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),td.forEach(t),ed.forEach(t),pe=h(i),de=n(i,"P",{});var da=r(de);De=a(da,"In addition, the authors have further pre-trained TAPAS to recognize "),je=n(da,"STRONG",{});var sd=r(je);Te=a(sd,"table entailment"),sd.forEach(t),Ne=a(da,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=n(da,"A",{href:!0,rel:!0});var ad=r(ke);Ae=a(ad,"TabFact"),ad.forEach(t),Oe=a(da,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=n(da,"A",{href:!0,rel:!0});var LT=r(Ze);Ps=a(LT,"Understanding tables with intermediate pre-training"),LT.forEach(t),Ss=a(da," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),da.forEach(t),mt=h(i),ft=n(i,"IMG",{src:!0,alt:!0,width:!0}),gt=h(i),_t=n(i,"SMALL",{});var Wd=r(_t);Ds=a(Wd,"TAPAS architecture. Taken from the "),tt=n(Wd,"A",{href:!0});var QT=r(tt);Ns=a(QT,"original blog post"),QT.forEach(t),Os=a(Wd,"."),Wd.forEach(t),Ke=h(i),Pe=n(i,"P",{});var rn=r(Pe);Ls=a(rn,"This model was contributed by "),kt=n(rn,"A",{href:!0,rel:!0});var IT=r(kt);ye=a(IT,"nielsr"),IT.forEach(t),yt=a(rn,". The Tensorflow version of this model was contributed by "),qt=n(rn,"A",{href:!0,rel:!0});var WT=r(qt);Qs=a(WT,"kamalkraj"),WT.forEach(t),jt=a(rn,". The original code can be found "),$t=n(rn,"A",{href:!0,rel:!0});var HT=r($t);Is=a(HT,"here"),HT.forEach(t),Et=a(rn,"."),rn.forEach(t),cs=h(i),Bt=n(i,"P",{});var UT=r(Bt);Ft=a(UT,"Tips:"),UT.forEach(t),hs=h(i),Ye=n(i,"UL",{});var ln=r(Ye);$e=n(ln,"LI",{});var Kt=r($e);Ws=a(Kt,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),At=n(Kt,"CODE",{});var RT=r(At);ae=a(RT,"reset_position_index_per_cell"),RT.forEach(t),ot=a(Kt," parameter of "),Vt=n(Kt,"A",{href:!0});var GT=r(Vt);Hs=a(GT,"TapasConfig"),GT.forEach(t),xt=a(Kt,", which is set to "),Jt=n(Kt,"CODE",{});var BT=r(Jt);Us=a(BT,"True"),BT.forEach(t),zt=a(Kt," by default. The default versions of the models available on the "),Ct=n(Kt,"A",{href:!0,rel:!0});var VT=r(Ct);Rs=a(VT,"hub"),VT.forEach(t),Mt=a(Kt," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Xt=n(Kt,"CODE",{});var KT=r(Xt);Gs=a(KT,'revision="no_reset"'),KT.forEach(t),Pt=a(Kt," when calling the "),Zt=n(Kt,"CODE",{});var YT=r(Zt);Bs=a(YT,"from_pretrained()"),YT.forEach(t),St=a(Kt," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),Kt.forEach(t),Vs=h(ln),Le=n(ln,"LI",{});var js=r(Le);Dt=a(js,"TAPAS is based on BERT, so "),es=n(js,"CODE",{});var JT=r(es);Ks=a(JT,"TAPAS-base"),JT.forEach(t),Nt=a(js," for example corresponds to a "),ts=n(js,"CODE",{});var XT=r(ts);Ys=a(XT,"BERT-base"),XT.forEach(t),ss=a(js," architecture. Of course, "),Ue=n(js,"CODE",{});var ZT=r(Ue);as=a(ZT,"TAPAS-large"),ZT.forEach(t),Ee=a(js," will result in the best performance (the results reported in the paper are from "),os=n(js,"CODE",{});var eb=r(os);nt=a(eb,"TAPAS-large"),eb.forEach(t),Js=a(js,"). Results of the various sized models are shown on the "),Ot=n(js,"A",{href:!0,rel:!0});var tb=r(Ot);Lt=a(tb,"original Github repository"),tb.forEach(t),Xs=a(js,"."),js.forEach(t),Zs=h(ln),Re=n(ln,"LI",{});var Mi=r(Re);ea=a(Mi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),ns=n(Mi,"CODE",{});var sb=r(ns);rs=a(sb,"prev_labels"),sb.forEach(t),et=a(Mi," token type ids can be overwritten by the predicted "),Qt=n(Mi,"CODE",{});var ab=r(Qt);z=a(ab,"labels"),ab.forEach(t),J=a(Mi," of the model to the previous question. See \u201CUsage\u201D section for more info."),Mi.forEach(t),ya=h(ln),ta=n(ln,"LI",{});var ob=r(ta);qa=a(ob,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),ob.forEach(t),ln.forEach(t),ha=h(i),It=n(i,"H2",{class:!0});var Hd=r(It);st=n(Hd,"A",{id:!0,class:!0,href:!0});var nb=r(st);sa=n(nb,"SPAN",{});var rb=r(sa);q(rt.$$.fragment,rb),rb.forEach(t),nb.forEach(t),ja=h(Hd),aa=n(Hd,"SPAN",{});var ib=r(aa);$a=a(ib,"Usage: fine-tuning"),ib.forEach(t),Hd.forEach(t),ua=h(i),Ie=n(i,"P",{});var Ud=r(Ie);is=a(Ud,"Here we explain how you can fine-tune "),us=n(Ud,"A",{href:!0});var lb=r(us);Ge=a(lb,"TapasForQuestionAnswering"),lb.forEach(t),Ea=a(Ud," on your own dataset."),Ud.forEach(t),ma=h(i),ms=n(i,"P",{});var pb=r(ms);oa=n(pb,"STRONG",{});var db=r(oa);ls=a(db,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),db.forEach(t),pb.forEach(t),fa=h(i),fe=n(i,"P",{});var Rd=r(fe);Fa=a(Rd,"Basically, there are 3 different ways in which one can fine-tune "),fs=n(Rd,"A",{href:!0});var cb=r(fs);Aa=a(cb,"TapasForQuestionAnswering"),cb.forEach(t),xa=a(Rd,", corresponding to the different datasets on which Tapas was fine-tuned:"),Rd.forEach(t),ga=h(i),Tt=n(i,"OL",{});var Pi=r(Tt);na=n(Pi,"LI",{});var hb=r(na);ps=a(hb,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),hb.forEach(t),za=h(Pi),Fe=n(Pi,"LI",{});var Gd=r(Fe);Ca=a(Gd,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=n(Gd,"STRONG",{});var ub=r(ra);Ma=a(ub,"weak supervision"),ub.forEach(t),Pa=a(Gd,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Gd.forEach(t),Sa=h(Pi),he=n(Pi,"LI",{});var Bd=r(he);Da=a(Bd,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=n(Bd,"STRONG",{});var mb=r(ia);Na=a(mb,"strong supervision"),mb.forEach(t),Oa=a(Bd,". Here, learning the appropriate aggregation operator is much easier."),Bd.forEach(t),Pi.forEach(t),_a=h(i),gs=n(i,"P",{});var fb=r(gs);La=a(fb,"To summarize:"),fb.forEach(t),Ta=h(i),Ce=n(i,"TABLE",{});var Vd=r(Ce);la=n(Vd,"THEAD",{});var gb=r(la);Wt=n(gb,"TR",{});var Si=r(Wt);pa=n(Si,"TH",{});var _b=r(pa);el=n(_b,"STRONG",{});var Tb=r(el);Sc=a(Tb,"Task"),Tb.forEach(t),_b.forEach(t),Dc=h(Si),tl=n(Si,"TH",{});var bb=r(tl);sl=n(bb,"STRONG",{});var vb=r(sl);Nc=a(vb,"Example dataset"),vb.forEach(t),bb.forEach(t),Oc=h(Si),al=n(Si,"TH",{});var wb=r(al);ol=n(wb,"STRONG",{});var kb=r(ol);Lc=a(kb,"Description"),kb.forEach(t),wb.forEach(t),Si.forEach(t),gb.forEach(t),Qc=h(Vd),Qa=n(Vd,"TBODY",{});var Di=r(Qa);Ia=n(Di,"TR",{});var Ni=r(Ia);nl=n(Ni,"TD",{});var yb=r(nl);Ic=a(yb,"Conversational"),yb.forEach(t),Wc=h(Ni),rl=n(Ni,"TD",{});var qb=r(rl);Hc=a(qb,"SQA"),qb.forEach(t),Uc=h(Ni),il=n(Ni,"TD",{});var jb=r(il);Rc=a(jb,"Conversational, only cell selection questions"),jb.forEach(t),Ni.forEach(t),Gc=h(Di),Wa=n(Di,"TR",{});var Oi=r(Wa);ll=n(Oi,"TD",{});var $b=r(ll);Bc=a($b,"Weak supervision for aggregation"),$b.forEach(t),Vc=h(Oi),pl=n(Oi,"TD",{});var Eb=r(pl);Kc=a(Eb,"WTQ"),Eb.forEach(t),Yc=h(Oi),dl=n(Oi,"TD",{});var Fb=r(dl);Jc=a(Fb,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Fb.forEach(t),Oi.forEach(t),Xc=h(Di),Ha=n(Di,"TR",{});var Li=r(Ha);cl=n(Li,"TD",{});var Ab=r(cl);Zc=a(Ab,"Strong supervision for aggregation"),Ab.forEach(t),eh=h(Li),hl=n(Li,"TD",{});var xb=r(hl);th=a(xb,"WikiSQL-supervised"),xb.forEach(t),sh=h(Li),ul=n(Li,"TD",{});var zb=r(ul);ah=a(zb,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),zb.forEach(t),Li.forEach(t),Di.forEach(t),Vd.forEach(t),od=h(i),q(bo.$$.fragment,i),nd=h(i),vo=n(i,"P",{});var Kd=r(vo);oh=a(Kd,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),bn=n(Kd,"A",{href:!0,rel:!0});var Cb=r(bn);nh=a(Cb,"here"),Cb.forEach(t),rh=a(Kd," for more info."),Kd.forEach(t),rd=h(i),wo=n(i,"P",{});var Yd=r(wo);ih=a(Yd,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),vn=n(Yd,"A",{href:!0,rel:!0});var Mb=r(vn);lh=a(Mb,"here"),Mb.forEach(t),ph=a(Yd,"."),Yd.forEach(t),id=h(i),Rr=n(i,"P",{});var Pb=r(Rr);ml=n(Pb,"STRONG",{});var Sb=r(ml);dh=a(Sb,"STEP 2: Prepare your data in the SQA format"),Sb.forEach(t),Pb.forEach(t),ld=h(i),ko=n(i,"P",{});var Jd=r(ko);ch=a(Jd,"Second, no matter what you picked above, you should prepare your dataset in the "),wn=n(Jd,"A",{href:!0,rel:!0});var Db=r(wn);hh=a(Db,"SQA"),Db.forEach(t),uh=a(Jd," format. This format is a TSV/CSV file with the following columns:"),Jd.forEach(t),pd=h(i),We=n(i,"UL",{});var at=r(We);Gr=n(at,"LI",{});var AT=r(Gr);fl=n(AT,"CODE",{});var Nb=r(fl);mh=a(Nb,"id"),Nb.forEach(t),fh=a(AT,": optional, id of the table-question pair, for bookkeeping purposes."),AT.forEach(t),gh=h(at),Br=n(at,"LI",{});var xT=r(Br);gl=n(xT,"CODE",{});var Ob=r(gl);_h=a(Ob,"annotator"),Ob.forEach(t),Th=a(xT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),xT.forEach(t),bh=h(at),Vr=n(at,"LI",{});var zT=r(Vr);_l=n(zT,"CODE",{});var Lb=r(_l);vh=a(Lb,"position"),Lb.forEach(t),wh=a(zT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),zT.forEach(t),kh=h(at),Kr=n(at,"LI",{});var CT=r(Kr);Tl=n(CT,"CODE",{});var Qb=r(Tl);yh=a(Qb,"question"),Qb.forEach(t),qh=a(CT,": string"),CT.forEach(t),jh=h(at),Yr=n(at,"LI",{});var MT=r(Yr);bl=n(MT,"CODE",{});var Ib=r(bl);$h=a(Ib,"table_file"),Ib.forEach(t),Eh=a(MT,": string, name of a csv file containing the tabular data"),MT.forEach(t),Fh=h(at),Jr=n(at,"LI",{});var PT=r(Jr);vl=n(PT,"CODE",{});var Wb=r(vl);Ah=a(Wb,"answer_coordinates"),Wb.forEach(t),xh=a(PT,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),PT.forEach(t),zh=h(at),Xr=n(at,"LI",{});var ST=r(Xr);wl=n(ST,"CODE",{});var Hb=r(wl);Ch=a(Hb,"answer_text"),Hb.forEach(t),Mh=a(ST,": list of one or more strings (each string being a cell value that is part of the answer)"),ST.forEach(t),Ph=h(at),Zr=n(at,"LI",{});var DT=r(Zr);kl=n(DT,"CODE",{});var Ub=r(kl);Sh=a(Ub,"aggregation_label"),Ub.forEach(t),Dh=a(DT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),DT.forEach(t),Nh=h(at),ei=n(at,"LI",{});var NT=r(ei);yl=n(NT,"CODE",{});var Rb=r(yl);Oh=a(Rb,"float_answer"),Rb.forEach(t),Lh=a(NT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),NT.forEach(t),at.forEach(t),dd=h(i),bt=n(i,"P",{});var $s=r(bt);Qh=a($s,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),kn=n($s,"A",{href:!0,rel:!0});var Gb=r(kn);Ih=a(Gb,"here"),Gb.forEach(t),Wh=a($s,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),yn=n($s,"A",{href:!0,rel:!0});var Bb=r(yn);Hh=a(Bb,"here"),Bb.forEach(t),Uh=a($s,". Interestingly, these conversion scripts are not perfect (the "),ql=n($s,"CODE",{});var Vb=r(ql);Rh=a(Vb,"answer_coordinates"),Vb.forEach(t),Gh=a($s," and "),jl=n($s,"CODE",{});var Kb=r(jl);Bh=a(Kb,"float_answer"),Kb.forEach(t),Vh=a($s," fields are populated based on the "),$l=n($s,"CODE",{});var Yb=r($l);Kh=a(Yb,"answer_text"),Yb.forEach(t),Yh=a($s,"), meaning that WTQ and WikiSQL results could actually be improved."),$s.forEach(t),cd=h(i),ti=n(i,"P",{});var Jb=r(ti);El=n(Jb,"STRONG",{});var Xb=r(El);Jh=a(Xb,"STEP 3: Convert your data into tensors using TapasTokenizer"),Xb.forEach(t),Jb.forEach(t),hd=h(i),q(yo.$$.fragment,i),ud=h(i),Se=n(i,"P",{});var Je=r(Se);Xh=a(Je,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),Fl=n(Je,"STRONG",{});var Zb=r(Fl);Zh=a(Zb,"not conversational"),Zb.forEach(t),eu=a(Je,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),Al=n(Je,"CODE",{});var ev=r(Al);tu=a(ev,"queries"),ev.forEach(t),su=a(Je,", "),xl=n(Je,"CODE",{});var tv=r(xl);au=a(tv,"answer_coordinates"),tv.forEach(t),ou=a(Je," and "),zl=n(Je,"CODE",{});var sv=r(zl);nu=a(sv,"answer_text"),sv.forEach(t),ru=a(Je," per table (in the order of their "),Cl=n(Je,"CODE",{});var av=r(Cl);iu=a(av,"position"),av.forEach(t),lu=a(Je,`
index) and batch encode each table with its questions. This will make sure that the `),Ml=n(Je,"CODE",{});var ov=r(Ml);pu=a(ov,"prev_labels"),ov.forEach(t),du=a(Je," token types (see docs of "),si=n(Je,"A",{href:!0});var nv=r(si);cu=a(nv,"TapasTokenizer"),nv.forEach(t),hu=a(Je,") are set correctly. See "),qn=n(Je,"A",{href:!0,rel:!0});var rv=r(qn);uu=a(rv,"this notebook"),rv.forEach(t),mu=a(Je," for more info. See "),jn=n(Je,"A",{href:!0,rel:!0});var iv=r(jn);fu=a(iv,"this notebook"),iv.forEach(t),gu=a(Je," for more info regarding using the TensorFlow model."),Je.forEach(t),md=h(i),ai=n(i,"P",{});var lv=r(ai);_u=a(lv,"**STEP 4: Train (fine-tune) the model"),lv.forEach(t),fd=h(i),q(qo.$$.fragment,i),gd=h(i),Ua=n(i,"H2",{class:!0});var Xd=r(Ua);jo=n(Xd,"A",{id:!0,class:!0,href:!0});var pv=r(jo);Pl=n(pv,"SPAN",{});var dv=r(Pl);q($n.$$.fragment,dv),dv.forEach(t),pv.forEach(t),Tu=h(Xd),Sl=n(Xd,"SPAN",{});var cv=r(Sl);bu=a(cv,"Usage: inference"),cv.forEach(t),Xd.forEach(t),_d=h(i),q($o.$$.fragment,i),Td=h(i),vt=n(i,"P",{});var Es=r(vt);vu=a(Es,"In case of a conversational set-up, then each table-question pair must be provided "),Dl=n(Es,"STRONG",{});var hv=r(Dl);wu=a(hv,"sequentially"),hv.forEach(t),ku=a(Es," to the model, such that the "),Nl=n(Es,"CODE",{});var uv=r(Nl);yu=a(uv,"prev_labels"),uv.forEach(t),qu=a(Es," token types can be overwritten by the predicted "),Ol=n(Es,"CODE",{});var mv=r(Ol);ju=a(mv,"labels"),mv.forEach(t),$u=a(Es," of the previous table-question pair. Again, more info can be found in "),En=n(Es,"A",{href:!0,rel:!0});var fv=r(En);Eu=a(fv,"this notebook"),fv.forEach(t),Fu=a(Es," (for PyTorch) and "),Fn=n(Es,"A",{href:!0,rel:!0});var gv=r(Fn);Au=a(gv,"this notebook"),gv.forEach(t),xu=a(Es," (for TensorFlow)."),Es.forEach(t),bd=h(i),Ra=n(i,"H2",{class:!0});var Zd=r(Ra);Eo=n(Zd,"A",{id:!0,class:!0,href:!0});var _v=r(Eo);Ll=n(_v,"SPAN",{});var Tv=r(Ll);q(An.$$.fragment,Tv),Tv.forEach(t),_v.forEach(t),zu=h(Zd),Ql=n(Zd,"SPAN",{});var bv=r(Ql);Cu=a(bv,"TAPAS specific outputs"),bv.forEach(t),Zd.forEach(t),vd=h(i),Ga=n(i,"DIV",{class:!0});var ec=r(Ga);q(xn.$$.fragment,ec),Mu=h(ec),zn=n(ec,"P",{});var tc=r(zn);Pu=a(tc,"Output type of "),oi=n(tc,"A",{href:!0});var vv=r(oi);Su=a(vv,"TapasForQuestionAnswering"),vv.forEach(t),Du=a(tc,"."),tc.forEach(t),ec.forEach(t),wd=h(i),Ba=n(i,"H2",{class:!0});var sc=r(Ba);Fo=n(sc,"A",{id:!0,class:!0,href:!0});var wv=r(Fo);Il=n(wv,"SPAN",{});var kv=r(Il);q(Cn.$$.fragment,kv),kv.forEach(t),wv.forEach(t),Nu=h(sc),Wl=n(sc,"SPAN",{});var yv=r(Wl);Ou=a(yv,"TapasConfig"),yv.forEach(t),sc.forEach(t),kd=h(i),Ht=n(i,"DIV",{class:!0});var va=r(Ht);q(Mn.$$.fragment,va),Lu=h(va),Va=n(va,"P",{});var Qi=r(Va);Qu=a(Qi,"This is the configuration class to store the configuration of a "),ni=n(Qi,"A",{href:!0});var qv=r(ni);Iu=a(qv,"TapasModel"),qv.forEach(t),Wu=a(Qi,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS
`),Pn=n(Qi,"A",{href:!0,rel:!0});var jv=r(Pn);Hu=a(jv,"google/tapas-base-finetuned-sqa"),jv.forEach(t),Uu=a(Qi," architecture."),Qi.forEach(t),Ru=h(va),Ka=n(va,"P",{});var Ii=r(Ka);Gu=a(Ii,"Configuration objects inherit from "),Hl=n(Ii,"CODE",{});var $v=r(Hl);Bu=a($v,"PreTrainedConfig"),$v.forEach(t),Vu=a(Ii,` and can be used to control the model outputs. Read the
...
implementation. Original implementation available at `),Dn=n(ac,"A",{href:!0,rel:!0});var Fv=r(Dn);Zu=a(Fv,"https://github.com/google-research/tapas/tree/master"),Fv.forEach(t),em=a(ac,"."),ac.forEach(t),tm=h(va),q(Ao.$$.fragment,va),va.forEach(t),yd=h(i),Ya=n(i,"H2",{class:!0});var oc=r(Ya);xo=n(oc,"A",{id:!0,class:!0,href:!0});var Av=r(xo);Ul=n(Av,"SPAN",{});var xv=r(Ul);q(Nn.$$.fragment,xv),xv.forEach(t),Av.forEach(t),sm=h(oc),Rl=n(oc,"SPAN",{});var zv=r(Rl);am=a(zv,"TapasTokenizer"),zv.forEach(t),oc.forEach(t),qd=h(i),Be=n(i,"DIV",{class:!0});var wt=r(Be);q(On.$$.fragment,wt),om=h(wt),Gl=n(wt,"P",{});var Cv=r(Gl);nm=a(Cv,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),Cv.forEach(t),rm=h(wt),Qe=n(wt,"P",{});var Xe=r(Qe);im=a(Xe,"This tokenizer inherits from "),ii=n(Xe,"A",{href:!0});var Mv=r(ii);lm=a(Mv,"PreTrainedTokenizer"),Mv.forEach(t),pm=a(Xe,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),li=n(Xe,"A",{href:!0});var Pv=r(li);dm=a(Pv,"TapasTokenizer"),Pv.forEach(t),cm=a(Xe,` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Bl=n(Xe,"CODE",{});var Sv=r(Bl);hm=a(Sv,"segment_ids"),Sv.forEach(t),um=a(Xe,`,
`),Vl=n(Xe,"CODE",{});var Dv=r(Vl);mm=a(Dv,"column_ids"),Dv.forEach(t),fm=a(Xe,", "),Kl=n(Xe,"CODE",{});var Nv=r(Kl);gm=a(Nv,"row_ids"),Nv.forEach(t),_m=a(Xe,", "),Yl=n(Xe,"CODE",{});var Ov=r(Yl);Tm=a(Ov,"prev_labels"),Ov.forEach(t),bm=a(Xe,", "),Jl=n(Xe,"CODE",{});var Lv=r(Jl);vm=a(Lv,"column_ranks"),Lv.forEach(t),wm=a(Xe,", "),Xl=n(Xe,"CODE",{});var Qv=r(Xl);km=a(Qv,"inv_column_ranks"),Qv.forEach(t),ym=a(Xe," and "),Zl=n(Xe,"CODE",{});var Iv=r(Zl);qm=a(Iv,"numeric_relations"),Iv.forEach(t),jm=a(Xe,":"),Xe.forEach(t),$m=h(wt),it=n(wt,"UL",{});var Yt=r(it);ep=n(Yt,"LI",{});var Wv=r(ep);Em=a(Wv,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),Wv.forEach(t),Fm=h(Yt),tp=n(Yt,"LI",{});var Hv=r(tp);Am=a(Hv,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),Hv.forEach(t),xm=h(Yt),sp=n(Yt,"LI",{});var Uv=r(sp);zm=a(Uv,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Uv.forEach(t),Cm=h(Yt),ap=n(Yt,"LI",{});var Rv=r(ap);Mm=a(Rv,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Rv.forEach(t),Pm=h(Yt),op=n(Yt,"LI",{});var Gv=r(op);Sm=a(Gv,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Gv.forEach(t),Dm=h(Yt),np=n(Yt,"LI",{});var Bv=r(np);Nm=a(Bv,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Bv.forEach(t),Om=h(Yt),rp=n(Yt,"LI",{});var Vv=r(rp);Lm=a(Vv,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),Vv.forEach(t),Yt.forEach(t),Qm=h(wt),pi=n(wt,"P",{});var OT=r(pi);di=n(OT,"A",{href:!0});var Kv=r(di);Im=a(Kv,"TapasTokenizer"),Kv.forEach(t),Wm=a(OT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),OT.forEach(t),Hm=h(wt),zo=n(wt,"DIV",{class:!0});var nc=r(zo);q(Ln.$$.fragment,nc),Um=h(nc),ip=n(nc,"P",{});var Yv=r(ip);Rm=a(Yv,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Yv.forEach(t),nc.forEach(t),Gm=h(wt),ba=n(wt,"DIV",{class:!0});var Wi=r(ba);q(Qn.$$.fragment,Wi),Bm=h(Wi),In=n(Wi,"P",{});var rc=r(In);Vm=a(rc,"Converts logits of "),ci=n(rc,"A",{href:!0});var Jv=r(ci);Km=a(Jv,"TapasForQuestionAnswering"),Jv.forEach(t),Ym=a(rc,` to actual predicted answer coordinates and optional
...
`),Hn=n(ic,"A",{href:!0,rel:!0});var Xv=r(Hn);Zm=a(Xv,"here"),Xv.forEach(t),ef=a(ic,"."),ic.forEach(t),Wi.forEach(t),tf=h(wt),hi=n(wt,"DIV",{class:!0});var Zv=r(hi);q(Un.$$.fragment,Zv),Zv.forEach(t),wt.forEach(t),jd=h(i),Ja=n(i,"H2",{class:!0});var lc=r(Ja);Co=n(lc,"A",{id:!0,class:!0,href:!0});var ew=r(Co);lp=n(ew,"SPAN",{});var tw=r(lp);q(Rn.$$.fragment,tw),tw.forEach(t),ew.forEach(t),sf=h(lc),pp=n(lc,"SPAN",{});var sw=r(pp);af=a(sw,"TapasModel"),sw.forEach(t),lc.forEach(t),$d=h(i),lt=n(i,"DIV",{class:!0});var Fs=r(lt);q(Gn.$$.fragment,Fs),of=h(Fs),Bn=n(Fs,"P",{});var pc=r(Bn);nf=a(pc,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ui=n(pc,"A",{href:!0});var aw=r(ui);rf=a(aw,"PreTrainedModel"),aw.forEach(t),lf=a(pc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pc.forEach(t),pf=h(Fs),Vn=n(Fs,"P",{});var dc=r(Vn);df=a(dc,"This model is also a PyTorch "),Kn=n(dc,"A",{href:!0,rel:!0});var ow=r(Kn);cf=a(ow,"torch.nn.Module"),ow.forEach(t),hf=a(dc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dc.forEach(t),uf=h(Fs),Yn=n(Fs,"P",{});var cc=r(Yn);mf=a(cc,"This class is a small change compared to "),mi=n(cc,"A",{href:!0});var nw=r(mi);ff=a(nw,"BertModel"),nw.forEach(t),gf=a(cc,", taking into account the additional token type ids."),cc.forEach(t),_f=h(Fs),Jn=n(Fs,"P",{});var hc=r(Jn);Tf=a(hc,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),hc.forEach(t),wf=h(Fs),_s=n(Fs,"DIV",{class:!0});var pn=r(_s);q(Zn.$$.fragment,pn),kf=h(pn),Xa=n(pn,"P",{});var Hi=r(Xa);yf=a(Hi,"The "),fi=n(Hi,"A",{href:!0});var iw=r(fi);qf=a(iw,"TapasModel"),iw.forEach(t),jf=a(Hi," forward method, overrides the "),dp=n(Hi,"CODE",{});var lw=r(dp);$f=a(lw,"__call__"),lw.forEach(t),Ef=a(Hi," special method."),Hi.forEach(t),Ff=h(pn),q(Mo.$$.fragment,pn),Af=h(pn),q(Po.$$.fragment,pn),pn.forEach(t),Fs.forEach(t),Ed=h(i),Za=n(i,"H2",{class:!0});var uc=r(Za);So=n(uc,"A",{id:!0,class:!0,href:!0});var pw=r(So);cp=n(pw,"SPAN",{});var dw=r(cp);q(er.$$.fragment,dw),dw.forEach(t),pw.forEach(t),xf=h(uc),hp=n(uc,"SPAN",{});var cw=r(hp);zf=a(cw,"TapasForMaskedLM"),cw.forEach(t),uc.forEach(t),Fd=h(i),ds=n(i,"DIV",{class:!0});var dn=r(ds);q(tr.$$.fragment,dn),Cf=h(dn),eo=n(dn,"P",{});var Ui=r(eo);Mf=a(Ui,"Tapas Model with a "),up=n(Ui,"CODE",{});var hw=r(up);Pf=a(hw,"language modeling"),hw.forEach(t),Sf=a(Ui,` head on top.
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui.forEach(t),Of=h(dn),sr=n(dn,"P",{});var mc=r(sr);Lf=a(mc,"This model is also a PyTorch "),ar=n(mc,"A",{href:!0,rel:!0});var mw=r(ar);Qf=a(mw,"torch.nn.Module"),mw.forEach(t),If=a(mc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mc.forEach(t),Wf=h(dn),Ts=n(dn,"DIV",{class:!0});var cn=r(Ts);q(or.$$.fragment,cn),Hf=h(cn),to=n(cn,"P",{});var Ri=r(to);Uf=a(Ri,"The "),_i=n(Ri,"A",{href:!0});var fw=r(_i);Rf=a(fw,"TapasForMaskedLM"),fw.forEach(t),Gf=a(Ri," forward method, overrides the "),mp=n(Ri,"CODE",{});var gw=r(mp);Bf=a(gw,"__call__"),gw.forEach(t),Vf=a(Ri," special method."),Ri.forEach(t),Kf=h(cn),q(Do.$$.fragment,cn),Yf=h(cn),q(No.$$.fragment,cn),cn.forEach(t),dn.forEach(t),Ad=h(i),so=n(i,"H2",{class:!0});var fc=r(so);Oo=n(fc,"A",{id:!0,class:!0,href:!0});var _w=r(Oo);fp=n(_w,"SPAN",{});var Tw=r(fp);q(nr.$$.fragment,Tw),Tw.forEach(t),_w.forEach(t),Jf=h(fc),gp=n(fc,"SPAN",{});var bw=r(gp);Xf=a(bw,"TapasForSequenceClassification"),bw.forEach(t),fc.forEach(t),xd=h(i),Ut=n(i,"DIV",{class:!0});var wa=r(Ut);q(rr.$$.fragment,wa),Zf=h(wa),_p=n(wa,"P",{});var vw=r(_p);eg=a(vw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc.forEach(t),ng=h(wa),lr=n(wa,"P",{});var _c=r(lr);rg=a(_c,"This model is also a PyTorch "),pr=n(_c,"A",{href:!0,rel:!0});var kw=r(pr);ig=a(kw,"torch.nn.Module"),kw.forEach(t),lg=a(_c,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_c.forEach(t),pg=h(wa),bs=n(wa,"DIV",{class:!0});var hn=r(bs);q(dr.$$.fragment,hn),dg=h(hn),ao=n(hn,"P",{});var Gi=r(ao);cg=a(Gi,"The "),bi=n(Gi,"A",{href:!0});var yw=r(bi);hg=a(yw,"TapasForSequenceClassification"),yw.forEach(t),ug=a(Gi," forward method, overrides the "),Tp=n(Gi,"CODE",{});var qw=r(Tp);mg=a(qw,"__call__"),qw.forEach(t),fg=a(Gi," special method."),Gi.forEach(t),gg=h(hn),q(Lo.$$.fragment,hn),_g=h(hn),q(Qo.$$.fragment,hn),hn.forEach(t),wa.forEach(t),zd=h(i),oo=n(i,"H2",{class:!0});var Tc=r(oo);Io=n(Tc,"A",{id:!0,class:!0,href:!0});var jw=r(Io);bp=n(jw,"SPAN",{});var $w=r(bp);q(cr.$$.fragment,$w),$w.forEach(t),jw.forEach(t),Tg=h(Tc),vp=n(Tc,"SPAN",{});var Ew=r(vp);bg=a(Ew,"TapasForQuestionAnswering"),Ew.forEach(t),Tc.forEach(t),Cd=h(i),Rt=n(i,"DIV",{class:!0});var ka=r(Rt);q(hr.$$.fragment,ka),vg=h(ka),no=n(ka,"P",{});var Bi=r(no);wg=a(Bi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),wp=n(Bi,"CODE",{});var Fw=r(wp);kg=a(Fw,"logits"),Fw.forEach(t),yg=a(Bi," and optional "),kp=n(Bi,"CODE",{});var Aw=r(kp);qg=a(Aw,"logits_aggregation"),Aw.forEach(t),jg=a(Bi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Bi.forEach(t),$g=h(ka),ur=n(ka,"P",{});var bc=r(ur);Eg=a(bc,"This model inherits from "),vi=n(bc,"A",{href:!0});var xw=r(vi);Fg=a(xw,"PreTrainedModel"),xw.forEach(t),Ag=a(bc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vc.forEach(t),Pg=h(ka),vs=n(ka,"DIV",{class:!0});var un=r(vs);q(gr.$$.fragment,un),Sg=h(un),ro=n(un,"P",{});var Vi=r(ro);Dg=a(Vi,"The "),wi=n(Vi,"A",{href:!0});var Cw=r(wi);Ng=a(Cw,"TapasForQuestionAnswering"),Cw.forEach(t),Og=a(Vi," forward method, overrides the "),yp=n(Vi,"CODE",{});var Mw=r(yp);Lg=a(Mw,"__call__"),Mw.forEach(t),Qg=a(Vi," special method."),Vi.forEach(t),Ig=h(un),q(Wo.$$.fragment,un),Wg=h(un),q(Ho.$$.fragment,un),un.forEach(t),ka.forEach(t),Md=h(i),io=n(i,"H2",{class:!0});var wc=r(io);Uo=n(wc,"A",{id:!0,class:!0,href:!0});var Pw=r(Uo);qp=n(Pw,"SPAN",{});var Sw=r(qp);q(_r.$$.fragment,Sw),Sw.forEach(t),Pw.forEach(t),Hg=h(wc),jp=n(wc,"SPAN",{});var Dw=r(jp);Ug=a(Dw,"TFTapasModel"),Dw.forEach(t),wc.forEach(t),Pd=h(i),pt=n(i,"DIV",{class:!0});var As=r(pt);q(Tr.$$.fragment,As),Rg=h(As),$p=n(As,"P",{});var Nw=r($p);Gg=a(Nw,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Nw.forEach(t),Bg=h(As),br=n(As,"P",{});var kc=r(br);Vg=a(kc,"This model inherits from "),ki=n(kc,"A",{href:!0});var Ow=r(ki);Kg=a(Ow,"TFPreTrainedModel"),Ow.forEach(t),Yg=a(kc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc.forEach(t),t_=h(As),q(Ro.$$.fragment,As),s_=h(As),ws=n(As,"DIV",{class:!0});var mn=r(ws);q(kr.$$.fragment,mn),a_=h(mn),lo=n(mn,"P",{});var Ki=r(lo);o_=a(Ki,"The "),yi=n(Ki,"A",{href:!0});var Qw=r(yi);n_=a(Qw,"TFTapasModel"),Qw.forEach(t),r_=a(Ki," forward method, overrides the "),Ep=n(Ki,"CODE",{});var Iw=r(Ep);i_=a(Iw,"__call__"),Iw.forEach(t),l_=a(Ki," special method."),Ki.forEach(t),p_=h(mn),q(Go.$$.fragment,mn),d_=h(mn),q(Bo.$$.fragment,mn),mn.forEach(t),As.forEach(t),Sd=h(i),po=n(i,"H2",{class:!0});var qc=r(po);Vo=n(qc,"A",{id:!0,class:!0,href:!0});var Ww=r(Vo);Fp=n(Ww,"SPAN",{});var Hw=r(Fp);q(yr.$$.fragment,Hw),Hw.forEach(t),Ww.forEach(t),c_=h(qc),Ap=n(qc,"SPAN",{});var Uw=r(Ap);h_=a(Uw,"TFTapasForMaskedLM"),Uw.forEach(t),qc.forEach(t),Dd=h(i),dt=n(i,"DIV",{class:!0});var xs=r(dt);q(qr.$$.fragment,xs),u_=h(xs),jr=n(xs,"P",{});var jc=r(jr);m_=a(jc,"Tapas Model with a "),xp=n(jc,"CODE",{});var Rw=r(xp);f_=a(Rw,"language modeling"),Rw.forEach(t),g_=a(jc," head on top."),jc.forEach(t),__=h(xs),$r=n(xs,"P",{});var $c=r($r);T_=a($c,"This model inherits from "),qi=n($c,"A",{href:!0});var Gw=r(qi);b_=a(Gw,"TFPreTrainedModel"),Gw.forEach(t),v_=a($c,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec.forEach(t),j_=h(xs),q(Ko.$$.fragment,xs),$_=h(xs),ks=n(xs,"DIV",{class:!0});var fn=r(ks);q(Ar.$$.fragment,fn),E_=h(fn),co=n(fn,"P",{});var Yi=r(co);F_=a(Yi,"The "),ji=n(Yi,"A",{href:!0});var Vw=r(ji);A_=a(Vw,"TFTapasForMaskedLM"),Vw.forEach(t),x_=a(Yi," forward method, overrides the "),zp=n(Yi,"CODE",{});var Kw=r(zp);z_=a(Kw,"__call__"),Kw.forEach(t),C_=a(Yi," special method."),Yi.forEach(t),M_=h(fn),q(Yo.$$.fragment,fn),P_=h(fn),q(Jo.$$.fragment,fn),fn.forEach(t),xs.forEach(t),Nd=h(i),ho=n(i,"H2",{class:!0});var Fc=r(ho);Xo=n(Fc,"A",{id:!0,class:!0,href:!0});var Yw=r(Xo);Cp=n(Yw,"SPAN",{});var Jw=r(Cp);q(xr.$$.fragment,Jw),Jw.forEach(t),Yw.forEach(t),S_=h(Fc),Mp=n(Fc,"SPAN",{});var Xw=r(Mp);D_=a(Xw,"TFTapasForSequenceClassification"),Xw.forEach(t),Fc.forEach(t),Od=h(i),ct=n(i,"DIV",{class:!0});var zs=r(ct);q(zr.$$.fragment,zs),N_=h(zs),Pp=n(zs,"P",{});var Zw=r(Pp);O_=a(Zw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xc.forEach(t),B_=h(zs),q(Zo.$$.fragment,zs),V_=h(zs),ys=n(zs,"DIV",{class:!0});var gn=r(ys);q(Sr.$$.fragment,gn),K_=h(gn),uo=n(gn,"P",{});var Ji=r(uo);Y_=a(Ji,"The "),Ei=n(Ji,"A",{href:!0});var sk=r(Ei);J_=a(sk,"TFTapasForSequenceClassification"),sk.forEach(t),X_=a(Ji," forward method, overrides the "),Sp=n(Ji,"CODE",{});var ak=r(Sp);Z_=a(ak,"__call__"),ak.forEach(t),eT=a(Ji," special method."),Ji.forEach(t),tT=h(gn),q(en.$$.fragment,gn),sT=h(gn),q(tn.$$.fragment,gn),gn.forEach(t),zs.forEach(t),Ld=h(i),mo=n(i,"H2",{class:!0});var zc=r(mo);sn=n(zc,"A",{id:!0,class:!0,href:!0});var ok=r(sn);Dp=n(ok,"SPAN",{});var nk=r(Dp);q(Dr.$$.fragment,nk),nk.forEach(t),ok.forEach(t),aT=h(zc),Np=n(zc,"SPAN",{});var rk=r(Np);oT=a(rk,"TFTapasForQuestionAnswering"),rk.forEach(t),zc.forEach(t),Qd=h(i),ht=n(i,"DIV",{class:!0});var Cs=r(ht);q(Nr.$$.fragment,Cs),nT=h(Cs),fo=n(Cs,"P",{});var Xi=r(fo);rT=a(Xi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Op=n(Xi,"CODE",{});var ik=r(Op);iT=a(ik,"logits"),ik.forEach(t),lT=a(Xi," and optional "),Lp=n(Xi,"CODE",{});var lk=r(Lp);pT=a(lk,"logits_aggregation"),lk.forEach(t),dT=a(Xi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Xi.forEach(t),cT=h(Cs),Or=n(Cs,"P",{});var Cc=r(Or);hT=a(Cc,"This model inherits from "),Fi=n(Cc,"A",{href:!0});var pk=r(Fi);uT=a(pk,"TFPreTrainedModel"),pk.forEach(t),mT=a(Cc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cc.forEach(t),fT=h(Cs),Lr=n(Cs,"P",{});var Mc=r(Lr);gT=a(Mc,"This model is also a "),Qr=n(Mc,"A",{href:!0,rel:!0});var dk=r(Qr);_T=a(dk,"tf.keras.Model"),dk.forEach(t),TT=a(Mc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mc.forEach(t),bT=h(Cs),q(an.$$.fragment,Cs),vT=h(Cs),qs=n(Cs,"DIV",{class:!0});var _n=r(qs);q(Ir.$$.fragment,_n),wT=h(_n),go=n(_n,"P",{});var Zi=r(go);kT=a(Zi,"The "),Ai=n(Zi,"A",{href:!0});var ck=r(Ai);yT=a(ck,"TFTapasForQuestionAnswering"),ck.forEach(t),qT=a(Zi," forward method, overrides the "),Qp=n(Zi,"CODE",{});var hk=r(Qp);jT=a(hk,"__call__"),hk.forEach(t),$T=a(Zi," special method."),Zi.forEach(t),ET=h(_n),q(on.$$.fragment,_n),FT=h(_n),q(nn.$$.fragment,_n),_n.forEach(t),Cs.forEach(t),this.h()},h(){f(l,"name","hf:doc:metadata"),f(l,"content",JSON.stringify(ay)),f(u,"id","tapas"),f(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(u,"href","#tapas"),f(p,"class","relative group"),f(U,"id","overview"),f(U,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(U,"href","#overview"),f(x,"class","relative group"),f(M,"href","https://www.aclweb.org/anthology/2020.acl-main.398"),f(M,"rel","nofollow"),f(S,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),f(S,"rel","nofollow"),f(Y,"href","https://github.com/ppasupat/WikiTableQuestions"),f(Y,"rel","nofollow"),f(ne,"href","https://github.com/salesforce/WikiSQL"),f(ne,"rel","nofollow"),f(ke,"href","https://github.com/wenhuchen/Table-Fact-Checking"),f(ke,"rel","nofollow"),f(Ze,"href","https://www.aclweb.org/anthology/2020.findings-emnlp.27/"),f(Ze,"rel","nofollow"),_k(ft.src,ca="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/tapas_architecture.png")||f(ft,"src",ca),f(ft,"alt","drawing"),f(ft,"width","600"),f(tt,"href","https://ai.googleblog.com/2020/04/using-neural-networks-to-find-answers.html"),f(kt,"href","https://huggingface.co/nielsr"),f(kt,"rel","nofollow"),f(qt,"href","https://huggingface.co/kamalkraj"),f(qt,"rel","nofollow"),f($t,"href","https://github.com/google-research/tapas"),f($t,"rel","nofollow"),f(Vt,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasConfig"),f(Ct,"href","https://huggingface.co/models?search=tapas"),f(Ct,"rel","nofollow"),f(Ot,"href","https://github.com/google-research/tapas%3E"),f(Ot,"rel","nofollow"),f(st,"id","usage-finetuning"),f(st,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(st,"href","#usage-finetuning"),f(It,"class","relative group"),f(us,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(fs,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(bn,"href","https://github.com/google-research/tapas/issues/91#issuecomment-735719340"),f(bn,"rel","nofollow"),f(vn,"href","https://huggingface.co/models?search=tapas"),f(vn,"rel","nofollow"),f(wn,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),f(wn,"rel","nofollow"),f(kn,"href","https://github.com/google-research/tapas/issues/50#issuecomment-705465960"),f(kn,"rel","nofollow"),f(yn,"href","https://github.com/NielsRogge/tapas_utils"),f(yn,"rel","nofollow"),f(si,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer"),f(qn,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(qn,"rel","nofollow"),f(jn,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(jn,"rel","nofollow"),f(jo,"id","usage-inference"),f(jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(jo,"href","#usage-inference"),f(Ua,"class","relative group"),f(En,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(En,"rel","nofollow"),f(Fn,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(Fn,"rel","nofollow"),f(Eo,"id","transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),f(Eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Eo,"href","#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),f(Ra,"class","relative group"),f(oi,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(Ga,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Fo,"id","transformers.TapasConfig"),f(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Fo,"href","#transformers.TapasConfig"),f(Ba,"class","relative group"),f(ni,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasModel"),f(Pn,"href","https://huggingface.co/google/tapas-base-finetuned-sqa"),f(Pn,"rel","nofollow"),f(ri,"href","/docs/transformers/pr_16836/en/main_classes/configuration#transformers.PretrainedConfig"),f(Dn,"href","https://github.com/google-research/tapas/tree/master"),f(Dn,"rel","nofollow"),f(Ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(xo,"id","transformers.TapasTokenizer"),f(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(xo,"href","#transformers.TapasTokenizer"),f(Ya,"class","relative group"),f(ii,"href","/docs/transformers/pr_16836/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),f(li,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer"),f(di,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasTokenizer"),f(zo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ci,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(Hn,"href","https://github.com/google-research/tapas/blob/4908213eb4df7aa988573350278b44c4dbe3f71b/tapas/experiments/prediction_utils.py#L288"),f(Hn,"rel","nofollow"),f(ba,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(hi,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Co,"id","transformers.TapasModel"),f(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Co,"href","#transformers.TapasModel"),f(Ja,"class","relative group"),f(ui,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel"),f(Kn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Kn,"rel","nofollow"),f(mi,"href","/docs/transformers/pr_16836/en/model_doc/bert#transformers.BertModel"),f(Xn,"href","https://arxiv.org/abs/1706.03762"),f(Xn,"rel","nofollow"),f(fi,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasModel"),f(_s,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(So,"id","transformers.TapasForMaskedLM"),f(So,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(So,"href","#transformers.TapasForMaskedLM"),f(Za,"class","relative group"),f(gi,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel"),f(ar,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(ar,"rel","nofollow"),f(_i,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForMaskedLM"),f(Ts,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ds,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Oo,"id","transformers.TapasForSequenceClassification"),f(Oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Oo,"href","#transformers.TapasForSequenceClassification"),f(so,"class","relative group"),f(Ti,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel"),f(pr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(pr,"rel","nofollow"),f(bi,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForSequenceClassification"),f(bs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Io,"id","transformers.TapasForQuestionAnswering"),f(Io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Io,"href","#transformers.TapasForQuestionAnswering"),f(oo,"class","relative group"),f(vi,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.PreTrainedModel"),f(fr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(fr,"rel","nofollow"),f(wi,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(vs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Rt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Uo,"id","transformers.TFTapasModel"),f(Uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Uo,"href","#transformers.TFTapasModel"),f(io,"class","relative group"),f(ki,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.TFPreTrainedModel"),f(wr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(wr,"rel","nofollow"),f(yi,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasModel"),f(ws,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Vo,"id","transformers.TFTapasForMaskedLM"),f(Vo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Vo,"href","#transformers.TFTapasForMaskedLM"),f(po,"class","relative group"),f(qi,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.TFPreTrainedModel"),f(Fr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Fr,"rel","nofollow"),f(ji,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasForMaskedLM"),f(ks,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Xo,"id","transformers.TFTapasForSequenceClassification"),f(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Xo,"href","#transformers.TFTapasForSequenceClassification"),f(ho,"class","relative group"),f($i,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.TFPreTrainedModel"),f(Pr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Pr,"rel","nofollow"),f(Ei,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasForSequenceClassification"),f(ys,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(sn,"id","transformers.TFTapasForQuestionAnswering"),f(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(sn,"href","#transformers.TFTapasForQuestionAnswering"),f(mo,"class","relative group"),f(Fi,"href","/docs/transformers/pr_16836/en/main_classes/model#transformers.TFPreTrainedModel"),f(Qr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Qr,"rel","nofollow"),f(Ai,"href","/docs/transformers/pr_16836/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(qs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,_){e(document.head,l),m(i,b,_),m(i,p,_),e(p,u),e(u,T),j(d,T,null),e(p,g),e(p,A),e(A,k),m(i,N,_),m(i,x,_),e(x,U),e(U,B),j(V,B,null),e(x,R),e(x,K),e(K,re),m(i,W,_),m(i,L,_),e(L,w),e(L,M),e(M,G),e(L,C),m(i,O,_),m(i,ee,_),e(ee,te),m(i,ce,_),m(i,oe,_),e(oe,se),e(se,S),e(S,Q),e(se,H),e(oe,X),e(oe,I),e(I,Y),e(Y,ge),e(I,ue),e(oe,_e),e(oe,me),e(me,ne),e(ne,qe),e(me,ie),m(i,ve,_),m(i,v,_),e(v,D),m(i,be,_),m(i,xe,_),e(xe,we),m(i,le,_),m(i,ze,_),e(ze,Me),e(Me,Z),m(i,pe,_),m(i,de,_),e(de,De),e(de,je),e(je,Te),e(de,Ne),e(de,ke),e(ke,Ae),e(de,Oe),e(de,Ze),e(Ze,Ps),e(de,Ss),m(i,mt,_),m(i,ft,_),m(i,gt,_),m(i,_t,_),e(_t,Ds),e(_t,tt),e(tt,Ns),e(_t,Os),m(i,Ke,_),m(i,Pe,_),e(Pe,Ls),e(Pe,kt),e(kt,ye),e(Pe,yt),e(Pe,qt),e(qt,Qs),e(Pe,jt),e(Pe,$t),e($t,Is),e(Pe,Et),m(i,cs,_),m(i,Bt,_),e(Bt,Ft),m(i,hs,_),m(i,Ye,_),e(Ye,$e),e($e,Ws),e($e,At),e(At,ae),e($e,ot),e($e,Vt),e(Vt,Hs),e($e,xt),e($e,Jt),e(Jt,Us),e($e,zt),e($e,Ct),e(Ct,Rs),e($e,Mt),e($e,Xt),e(Xt,Gs),e($e,Pt),e($e,Zt),e(Zt,Bs),e($e,St),e(Ye,Vs),e(Ye,Le),e(Le,Dt),e(Le,es),e(es,Ks),e(Le,Nt),e(Le,ts),e(ts,Ys),e(Le,ss),e(Le,Ue),e(Ue,as),e(Le,Ee),e(Le,os),e(os,nt),e(Le,Js),e(Le,Ot),e(Ot,Lt),e(Le,Xs),e(Ye,Zs),e(Ye,Re),e(Re,ea),e(Re,ns),e(ns,rs),e(Re,et),e(Re,Qt),e(Qt,z),e(Re,J),e(Ye,ya),e(Ye,ta),e(ta,qa),m(i,ha,_),m(i,It,_),e(It,st),e(st,sa),j(rt,sa,null),e(It,ja),e(It,aa),e(aa,$a),m(i,ua,_),m(i,Ie,_),e(Ie,is),e(Ie,us),e(us,Ge),e(Ie,Ea),m(i,ma,_),m(i,ms,_),e(ms,oa),e(oa,ls),m(i,fa,_),m(i,fe,_),e(fe,Fa),e(fe,fs),e(fs,Aa),e(fe,xa),m(i,ga,_),m(i,Tt,_),e(Tt,na),e(na,ps),e(Tt,za),e(Tt,Fe),e(Fe,Ca),e(Fe,ra),e(ra,Ma),e(Fe,Pa),e(Tt,Sa),e(Tt,he),e(he,Da),e(he,ia),e(ia,Na),e(he,Oa),m(i,_a,_),m(i,gs,_),e(gs,La),m(i,Ta,_),m(i,Ce,_),e(Ce,la),e(la,Wt),e(Wt,pa),e(pa,el),e(el,Sc),e(Wt,Dc),e(Wt,tl),e(tl,sl),e(sl,Nc),e(Wt,Oc),e(Wt,al),e(al,ol),e(ol,Lc),e(Ce,Qc),e(Ce,Qa),e(Qa,Ia),e(Ia,nl),e(nl,Ic),e(Ia,Wc),e(Ia,rl),e(rl,Hc),e(Ia,Uc),e(Ia,il),e(il,Rc),e(Qa,Gc),e(Qa,Wa),e(Wa,ll),e(ll,Bc),e(Wa,Vc),e(Wa,pl),e(pl,Kc),e(Wa,Yc),e(Wa,dl),e(dl,Jc),e(Qa,Xc),e(Qa,Ha),e(Ha,cl),e(cl,Zc),e(Ha,eh),e(Ha,hl),e(hl,th),e(Ha,sh),e(Ha,ul),e(ul,ah),m(i,od,_),j(bo,i,_),m(i,nd,_),m(i,vo,_),e(vo,oh),e(vo,bn),e(bn,nh),e(vo,rh),m(i,rd,_),m(i,wo,_),e(wo,ih),e(wo,vn),e(vn,lh),e(wo,ph),m(i,id,_),m(i,Rr,_),e(Rr,ml),e(ml,dh),m(i,ld,_),m(i,ko,_),e(ko,ch),e(ko,wn),e(wn,hh),e(ko,uh),m(i,pd,_),m(i,We,_),e(We,Gr),e(Gr,fl),e(fl,mh),e(Gr,fh),e(We,gh),e(We,Br),e(Br,gl),e(gl,_h),e(Br,Th),e(We,bh),e(We,Vr),e(Vr,_l),e(_l,vh),e(Vr,wh),e(We,kh),e(We,Kr),e(Kr,Tl),e(Tl,yh),e(Kr,qh),e(We,jh),e(We,Yr),e(Yr,bl),e(bl,$h),e(Yr,Eh),e(We,Fh),e(We,Jr),e(Jr,vl),e(vl,Ah),e(Jr,xh),e(We,zh),e(We,Xr),e(Xr,wl),e(wl,Ch),e(Xr,Mh),e(We,Ph),e(We,Zr),e(Zr,kl),e(kl,Sh),e(Zr,Dh),e(We,Nh),e(We,ei),e(ei,yl),e(yl,Oh),e(ei,Lh),m(i,dd,_),m(i,bt,_),e(bt,Qh),e(bt,kn),e(kn,Ih),e(bt,Wh),e(bt,yn),e(yn,Hh),e(bt,Uh),e(bt,ql),e(ql,Rh),e(bt,Gh),e(bt,jl),e(jl,Bh),e(bt,Vh),e(bt,$l),e($l,Kh),e(bt,Yh),m(i,cd,_),m(i,ti,_),e(ti,El),e(El,Jh),m(i,hd,_),j(yo,i,_),m(i,ud,_),m(i,Se,_),e(Se,Xh),e(Se,Fl),e(Fl,Zh),e(Se,eu),e(Se,Al),e(Al,tu),e(Se,su),e(Se,xl),e(xl,au),e(Se,ou),e(Se,zl),e(zl,nu),e(Se,ru),e(Se,Cl),e(Cl,iu),e(Se,lu),e(Se,Ml),e(Ml,pu),e(Se,du),e(Se,si),e(si,cu),e(Se,hu),e(Se,qn),e(qn,uu),e(Se,mu),e(Se,jn),e(jn,fu),e(Se,gu),m(i,md,_),m(i,ai,_),e(ai,_u),m(i,fd,_),j(qo,i,_),m(i,gd,_),m(i,Ua,_),e(Ua,jo),e(jo,Pl),j($n,Pl,null),e(Ua,Tu),e(Ua,Sl),e(Sl,bu),m(i,_d,_),j($o,i,_),m(i,Td,_),m(i,vt,_),e(vt,vu),e(vt,Dl),e(Dl,wu),e(vt,ku),e(vt,Nl),e(Nl,yu),e(vt,qu),e(vt,Ol),e(Ol,ju),e(vt,$u),e(vt,En),e(En,Eu),e(vt,Fu),e(vt,Fn),e(Fn,Au),e(vt,xu),m(i,bd,_),m(i,Ra,_),e(Ra,Eo),e(Eo,Ll),j(An,Ll,null),e(Ra,zu),e(Ra,Ql),e(Ql,Cu),m(i,vd,_),m(i,Ga,_),j(xn,Ga,null),e(Ga,Mu),e(Ga,zn),e(zn,Pu),e(zn,oi),e(oi,Su),e(zn,Du),m(i,wd,_),m(i,Ba,_),e(Ba,Fo),e(Fo,Il),j(Cn,Il,null),e(Ba,Nu),e(Ba,Wl),e(Wl,Ou),m(i,kd,_),m(i,Ht,_),j(Mn,Ht,null),e(Ht,Lu),e(Ht,Va),e(Va,Qu),e(Va,ni),e(ni,Iu),e(Va,Wu),e(Va,Pn),e(Pn,Hu),e(Va,Uu),e(Ht,Ru),e(Ht,Ka),e(Ka,Gu),e(Ka,Hl),e(Hl,Bu),e(Ka,Vu),e(Ka,ri),e(ri,Ku),e(Ka,Yu),e(Ht,Ju),e(Ht,Sn),e(Sn,Xu),e(Sn,Dn),e(Dn,Zu),e(Sn,em),e(Ht,tm),j(Ao,Ht,null),m(i,yd,_),m(i,Ya,_),e(Ya,xo),e(xo,Ul),j(Nn,Ul,null),e(Ya,sm),e(Ya,Rl),e(Rl,am),m(i,qd,_),m(i,Be,_),j(On,Be,null),e(Be,om),e(Be,Gl),e(Gl,nm),e(Be,rm),e(Be,Qe),e(Qe,im),e(Qe,ii),e(ii,lm),e(Qe,pm),e(Qe,li),e(li,dm),e(Qe,cm),e(Qe,Bl),e(Bl,hm),e(Qe,um),e(Qe,Vl),e(Vl,mm),e(Qe,fm),e(Qe,Kl),e(Kl,gm),e(Qe,_m),e(Qe,Yl),e(Yl,Tm),e(Qe,bm),e(Qe,Jl),e(Jl,vm),e(Qe,wm),e(Qe,Xl),e(Xl,km),e(Qe,ym),e(Qe,Zl),e(Zl,qm),e(Qe,jm),e(Be,$m),e(Be,it),e(it,ep),e(ep,Em),e(it,Fm),e(it,tp),e(tp,Am),e(it,xm),e(it,sp),e(sp,zm),e(it,Cm),e(it,ap),e(ap,Mm),e(it,Pm),e(it,op),e(op,Sm),e(it,Dm),e(it,np),e(np,Nm),e(it,Om),e(it,rp),e(rp,Lm),e(Be,Qm),e(Be,pi),e(pi,di),e(di,Im),e(pi,Wm),e(Be,Hm),e(Be,zo),j(Ln,zo,null),e(zo,Um),e(zo,ip),e(ip,Rm),e(Be,Gm),e(Be,ba),j(Qn,ba,null),e(ba,Bm),e(ba,In),e(In,Vm),e(In,ci),e(ci,Km),e(In,Ym),e(ba,Jm),e(ba,Wn),e(Wn,Xm),e(Wn,Hn),e(Hn,Zm),e(Wn,ef),e(Be,tf),e(Be,hi),j(Un,hi,null),m(i,jd,_),m(i,Ja,_),e(Ja,Co),e(Co,lp),j(Rn,lp,null),e(Ja,sf),e(Ja,pp),e(pp,af),m(i,$d,_),m(i,lt,_),j(Gn,lt,null),e(lt,of),e(lt,Bn),e(Bn,nf),e(Bn,ui),e(ui,rf),e(Bn,lf),e(lt,pf),e(lt,Vn),e(Vn,df),e(Vn,Kn),e(Kn,cf),e(Vn,hf),e(lt,uf),e(lt,Yn),e(Yn,mf),e(Yn,mi),e(mi,ff),e(Yn,gf),e(lt,_f),e(lt,Jn),e(Jn,Tf),e(Jn,Xn),e(Xn,bf),e(Jn,vf),e(lt,wf),e(lt,_s),j(Zn,_s,null),e(_s,kf),e(_s,Xa),e(Xa,yf),e(Xa,fi),e(fi,qf),e(Xa,jf),e(Xa,dp),e(dp,$f),e(Xa,Ef),e(_s,Ff),j(Mo,_s,null),e(_s,Af),j(Po,_s,null),m(i,Ed,_),m(i,Za,_),e(Za,So),e(So,cp),j(er,cp,null),e(Za,xf),e(Za,hp),e(hp,zf),m(i,Fd,_),m(i,ds,_),j(tr,ds,null),e(ds,Cf),e(ds,eo),e(eo,Mf),e(eo,up),e(up,Pf),e(eo,Sf),e(eo,gi),e(gi,Df),e(eo,Nf),e(ds,Of),e(ds,sr),e(sr,Lf),e(sr,ar),e(ar,Qf),e(sr,If),e(ds,Wf),e(ds,Ts),j(or,Ts,null),e(Ts,Hf),e(Ts,to),e(to,Uf),e(to,_i),e(_i,Rf),e(to,Gf),e(to,mp),e(mp,Bf),e(to,Vf),e(Ts,Kf),j(Do,Ts,null),e(Ts,Yf),j(No,Ts,null),m(i,Ad,_),m(i,so,_),e(so,Oo),e(Oo,fp),j(nr,fp,null),e(so,Jf),e(so,gp),e(gp,Xf),m(i,xd,_),m(i,Ut,_),j(rr,Ut,null),e(Ut,Zf),e(Ut,_p),e(_p,eg),e(Ut,tg),e(Ut,ir),e(ir,sg),e(ir,Ti),e(Ti,ag),e(ir,og),e(Ut,ng),e(Ut,lr),e(lr,rg),e(lr,pr),e(pr,ig),e(lr,lg),e(Ut,pg),e(Ut,bs),j(dr,bs,null),e(bs,dg),e(bs,ao),e(ao,cg),e(ao,bi),e(bi,hg),e(ao,ug),e(ao,Tp),e(Tp,mg),e(ao,fg),e(bs,gg),j(Lo,bs,null),e(bs,_g),j(Qo,bs,null),m(i,zd,_),m(i,oo,_),e(oo,Io),e(Io,bp),j(cr,bp,null),e(oo,Tg),e(oo,vp),e(vp,bg),m(i,Cd,_),m(i,Rt,_),j(hr,Rt,null),e(Rt,vg),e(Rt,no),e(no,wg),e(no,wp),e(wp,kg),e(no,yg),e(no,kp),e(kp,qg),e(no,jg),e(Rt,$g),e(Rt,ur),e(ur,Eg),e(ur,vi),e(vi,Fg),e(ur,Ag),e(Rt,xg),e(Rt,mr),e(mr,zg),e(mr,fr),e(fr,Cg),e(mr,Mg),e(Rt,Pg),e(Rt,vs),j(gr,vs,null),e(vs,Sg),e(vs,ro),e(ro,Dg),e(ro,wi),e(wi,Ng),e(ro,Og),e(ro,yp),e(yp,Lg),e(ro,Qg),e(vs,Ig),j(Wo,vs,null),e(vs,Wg),j(Ho,vs,null),m(i,Md,_),m(i,io,_),e(io,Uo),e(Uo,qp),j(_r,qp,null),e(io,Hg),e(io,jp),e(jp,Ug),m(i,Pd,_),m(i,pt,_),j(Tr,pt,null),e(pt,Rg),e(pt,$p),e($p,Gg),e(pt,Bg),e(pt,br),e(br,Vg),e(br,ki),e(ki,Kg),e(br,Yg),e(pt,Jg),e(pt,vr),e(vr,Xg),e(vr,wr),e(wr,Zg),e(vr,e_),e(pt,t_),j(Ro,pt,null),e(pt,s_),e(pt,ws),j(kr,ws,null),e(ws,a_),e(ws,lo),e(lo,o_),e(lo,yi),e(yi,n_),e(lo,r_),e(lo,Ep),e(Ep,i_),e(lo,l_),e(ws,p_),j(Go,ws,null),e(ws,d_),j(Bo,ws,null),m(i,Sd,_),m(i,po,_),e(po,Vo),e(Vo,Fp),j(yr,Fp,null),e(po,c_),e(po,Ap),e(Ap,h_),m(i,Dd,_),m(i,dt,_),j(qr,dt,null),e(dt,u_),e(dt,jr),e(jr,m_),e(jr,xp),e(xp,f_),e(jr,g_),e(dt,__),e(dt,$r),e($r,T_),e($r,qi),e(qi,b_),e($r,v_),e(dt,w_),e(dt,Er),e(Er,k_),e(Er,Fr),e(Fr,y_),e(Er,q_),e(dt,j_),j(Ko,dt,null),e(dt,$_),e(dt,ks),j(Ar,ks,null),e(ks,E_),e(ks,co),e(co,F_),e(co,ji),e(ji,A_),e(co,x_),e(co,zp),e(zp,z_),e(co,C_),e(ks,M_),j(Yo,ks,null),e(ks,P_),j(Jo,ks,null),m(i,Nd,_),m(i,ho,_),e(ho,Xo),e(Xo,Cp),j(xr,Cp,null),e(ho,S_),e(ho,Mp),e(Mp,D_),m(i,Od,_),m(i,ct,_),j(zr,ct,null),e(ct,N_),e(ct,Pp),e(Pp,O_),e(ct,L_),e(ct,Cr),e(Cr,Q_),e(Cr,$i),e($i,I_),e(Cr,W_),e(ct,H_),e(ct,Mr),e(Mr,U_),e(Mr,Pr),e(Pr,R_),e(Mr,G_),e(ct,B_),j(Zo,ct,null),e(ct,V_),e(ct,ys),j(Sr,ys,null),e(ys,K_),e(ys,uo),e(uo,Y_),e(uo,Ei),e(Ei,J_),e(uo,X_),e(uo,Sp),e(Sp,Z_),e(uo,eT),e(ys,tT),j(en,ys,null),e(ys,sT),j(tn,ys,null),m(i,Ld,_),m(i,mo,_),e(mo,sn),e(sn,Dp),j(Dr,Dp,null),e(mo,aT),e(mo,Np),e(Np,oT),m(i,Qd,_),m(i,ht,_),j(Nr,ht,null),e(ht,nT),e(ht,fo),e(fo,rT),e(fo,Op),e(Op,iT),e(fo,lT),e(fo,Lp),e(Lp,pT),e(fo,dT),e(ht,cT),e(ht,Or),e(Or,hT),e(Or,Fi),e(Fi,uT),e(Or,mT),e(ht,fT),e(ht,Lr),e(Lr,gT),e(Lr,Qr),e(Qr,_T),e(Lr,TT),e(ht,bT),j(an,ht,null),e(ht,vT),e(ht,qs),j(Ir,qs,null),e(qs,wT),e(qs,go),e(go,kT),e(go,Ai),e(Ai,yT),e(go,qT),e(go,Qp),e(Qp,jT),e(go,$T),e(qs,ET),j(on,qs,null),e(qs,FT),j(nn,qs,null),Id=!0},p(i,[_]){const Wr={};_&2&&(Wr.$$scope={dirty:_,ctx:i}),bo.$set(Wr);const Ip={};_&2&&(Ip.$$scope={dirty:_,ctx:i}),yo.$set(Ip);const Wp={};_&2&&(Wp.$$scope={dirty:_,ctx:i}),qo.$set(Wp);const Hp={};_&2&&(Hp.$$scope={dirty:_,ctx:i}),$o.$set(Hp);const Hr={};_&2&&(Hr.$$scope={dirty:_,ctx:i}),Ao.$set(Hr);const Up={};_&2&&(Up.$$scope={dirty:_,ctx:i}),Mo.$set(Up);const Rp={};_&2&&(Rp.$$scope={dirty:_,ctx:i}),Po.$set(Rp);const Gp={};_&2&&(Gp.$$scope={dirty:_,ctx:i}),Do.$set(Gp);const Ur={};_&2&&(Ur.$$scope={dirty:_,ctx:i}),No.$set(Ur);const Bp={};_&2&&(Bp.$$scope={dirty:_,ctx:i}),Lo.$set(Bp);const Vp={};_&2&&(Vp.$$scope={dirty:_,ctx:i}),Qo.$set(Vp);const _o={};_&2&&(_o.$$scope={dirty:_,ctx:i}),Wo.$set(_o);const xi={};_&2&&(xi.$$scope={dirty:_,ctx:i}),Ho.$set(xi);const Kp={};_&2&&(Kp.$$scope={dirty:_,ctx:i}),Ro.$set(Kp);const zi={};_&2&&(zi.$$scope={dirty:_,ctx:i}),Go.$set(zi);const Yp={};_&2&&(Yp.$$scope={dirty:_,ctx:i}),Bo.$set(Yp);const Ci={};_&2&&(Ci.$$scope={dirty:_,ctx:i}),Ko.$set(Ci);const Jp={};_&2&&(Jp.$$scope={dirty:_,ctx:i}),Yo.$set(Jp);const Xp={};_&2&&(Xp.$$scope={dirty:_,ctx:i}),Jo.$set(Xp);const Zp={};_&2&&(Zp.$$scope={dirty:_,ctx:i}),Zo.$set(Zp);const ed={};_&2&&(ed.$$scope={dirty:_,ctx:i}),en.$set(ed);const td={};_&2&&(td.$$scope={dirty:_,ctx:i}),tn.$set(td);const da={};_&2&&(da.$$scope={dirty:_,ctx:i}),an.$set(da);const sd={};_&2&&(sd.$$scope={dirty:_,ctx:i}),on.$set(sd);const ad={};_&2&&(ad.$$scope={dirty:_,ctx:i}),nn.$set(ad)},i(i){Id||($(d.$$.fragment,i),$(V.$$.fragment,i),$(rt.$$.fragment,i),$(bo.$$.fragment,i),$(yo.$$.fragment,i),$(qo.$$.fragment,i),$($n.$$.fragment,i),$($o.$$.fragment,i),$(An.$$.fragment,i),$(xn.$$.fragment,i),$(Cn.$$.fragment,i),$(Mn.$$.fragment,i),$(Ao.$$.fragment,i),$(Nn.$$.fragment,i),$(On.$$.fragment,i),$(Ln.$$.fragment,i),$(Qn.$$.fragment,i),$(Un.$$.fragment,i),$(Rn.$$.fragment,i),$(Gn.$$.fragment,i),$(Zn.$$.fragment,i),$(Mo.$$.fragment,i),$(Po.$$.fragment,i),$(er.$$.fragment,i),$(tr.$$.fragment,i),$(or.$$.fragment,i),$(Do.$$.fragment,i),$(No.$$.fragment,i),$(nr.$$.fragment,i),$(rr.$$.fragment,i),$(dr.$$.fragment,i),$(Lo.$$.fragment,i),$(Qo.$$.fragment,i),$(cr.$$.fragment,i),$(hr.$$.fragment,i),$(gr.$$.fragment,i),$(Wo.$$.fragment,i),$(Ho.$$.fragment,i),$(_r.$$.fragment,i),$(Tr.$$.fragment,i),$(Ro.$$.fragment,i),$(kr.$$.fragment,i),$(Go.$$.fragment,i),$(Bo.$$.fragment,i),$(yr.$$.fragment,i),$(qr.$$.fragment,i),$(Ko.$$.fragment,i),$(Ar.$$.fragment,i),$(Yo.$$.fragment,i),$(Jo.$$.fragment,i),$(xr.$$.fragment,i),$(zr.$$.fragment,i),$(Zo.$$.fragment,i),$(Sr.$$.fragment,i),$(en.$$.fragment,i),$(tn.$$.fragment,i),$(Dr.$$.fragment,i),$(Nr.$$.fragment,i),$(an.$$.fragment,i),$(Ir.$$.fragment,i),$(on.$$.fragment,i),$(nn.$$.fragment,i),Id=!0)},o(i){E(d.$$.fragment,i),E(V.$$.fragment,i),E(rt.$$.fragment,i),E(bo.$$.fragment,i),E(yo.$$.fragment,i),E(qo.$$.fragment,i),E($n.$$.fragment,i),E($o.$$.fragment,i),E(An.$$.fragment,i),E(xn.$$.fragment,i),E(Cn.$$.fragment,i),E(Mn.$$.fragment,i),E(Ao.$$.fragment,i),E(Nn.$$.fragment,i),E(On.$$.fragment,i),E(Ln.$$.fragment,i),E(Qn.$$.fragment,i),E(Un.$$.fragment,i),E(Rn.$$.fragment,i),E(Gn.$$.fragment,i),E(Zn.$$.fragment,i),E(Mo.$$.fragment,i),E(Po.$$.fragment,i),E(er.$$.fragment,i),E(tr.$$.fragment,i),E(or.$$.fragment,i),E(Do.$$.fragment,i),E(No.$$.fragment,i),E(nr.$$.fragment,i),E(rr.$$.fragment,i),E(dr.$$.fragment,i),E(Lo.$$.fragment,i),E(Qo.$$.fragment,i),E(cr.$$.fragment,i),E(hr.$$.fragment,i),E(gr.$$.fragment,i),E(Wo.$$.fragment,i),E(Ho.$$.fragment,i),E(_r.$$.fragment,i),E(Tr.$$.fragment,i),E(Ro.$$.fragment,i),E(kr.$$.fragment,i),E(Go.$$.fragment,i),E(Bo.$$.fragment,i),E(yr.$$.fragment,i),E(qr.$$.fragment,i),E(Ko.$$.fragment,i),E(Ar.$$.fragment,i),E(Yo.$$.fragment,i),E(Jo.$$.fragment,i),E(xr.$$.fragment,i),E(zr.$$.fragment,i),E(Zo.$$.fragment,i),E(Sr.$$.fragment,i),E(en.$$.fragment,i),E(tn.$$.fragment,i),E(Dr.$$.fragment,i),E(Nr.$$.fragment,i),E(an.$$.fragment,i),E(Ir.$$.fragment,i),E(on.$$.fragment,i),E(nn.$$.fragment,i),Id=!1},d(i){t(l),i&&t(b),i&&t(p),F(d),i&&t(N),i&&t(x),F(V),i&&t(W),i&&t(L),i&&t(O),i&&t(ee),i&&t(ce),i&&t(oe),i&&t(ve),i&&t(v),i&&t(be),i&&t(xe),i&&t(le),i&&t(ze),i&&t(pe),i&&t(de),i&&t(mt),i&&t(ft),i&&t(gt),i&&t(_t),i&&t(Ke),i&&t(Pe),i&&t(cs),i&&t(Bt),i&&t(hs),i&&t(Ye),i&&t(ha),i&&t(It),F(rt),i&&t(ua),i&&t(Ie),i&&t(ma),i&&t(ms),i&&t(fa),i&&t(fe),i&&t(ga),i&&t(Tt),i&&t(_a),i&&t(gs),i&&t(Ta),i&&t(Ce),i&&t(od),F(bo,i),i&&t(nd),i&&t(vo),i&&t(rd),i&&t(wo),i&&t(id),i&&t(Rr),i&&t(ld),i&&t(ko),i&&t(pd),i&&t(We),i&&t(dd),i&&t(bt),i&&t(cd),i&&t(ti),i&&t(hd),F(yo,i),i&&t(ud),i&&t(Se),i&&t(md),i&&t(ai),i&&t(fd),F(qo,i),i&&t(gd),i&&t(Ua),F($n),i&&t(_d),F($o,i),i&&t(Td),i&&t(vt),i&&t(bd),i&&t(Ra),F(An),i&&t(vd),i&&t(Ga),F(xn),i&&t(wd),i&&t(Ba),F(Cn),i&&t(kd),i&&t(Ht),F(Mn),F(Ao),i&&t(yd),i&&t(Ya),F(Nn),i&&t(qd),i&&t(Be),F(On),F(Ln),F(Qn),F(Un),i&&t(jd),i&&t(Ja),F(Rn),i&&t($d),i&&t(lt),F(Gn),F(Zn),F(Mo),F(Po),i&&t(Ed),i&&t(Za),F(er),i&&t(Fd),i&&t(ds),F(tr),F(or),F(Do),F(No),i&&t(Ad),i&&t(so),F(nr),i&&t(xd),i&&t(Ut),F(rr),F(dr),F(Lo),F(Qo),i&&t(zd),i&&t(oo),F(cr),i&&t(Cd),i&&t(Rt),F(hr),F(gr),F(Wo),F(Ho),i&&t(Md),i&&t(io),F(_r),i&&t(Pd),i&&t(pt),F(Tr),F(Ro),F(kr),F(Go),F(Bo),i&&t(Sd),i&&t(po),F(yr),i&&t(Dd),i&&t(dt),F(qr),F(Ko),F(Ar),F(Yo),F(Jo),i&&t(Nd),i&&t(ho),F(xr),i&&t(Od),i&&t(ct),F(zr),F(Zo),F(Sr),F(en),F(tn),i&&t(Ld),i&&t(mo),F(Dr),i&&t(Qd),i&&t(ht),F(Nr),F(an),F(Ir),F(on),F(nn)}}}const ay={local:"tapas",sections:[{local:"overview",title:"Overview"},{local:"usage-finetuning",title:"Usage: fine-tuning"},{local:"usage-inference",title:"Usage: inference"},{local:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",title:"TAPAS specific outputs"},{local:"transformers.TapasConfig",title:"TapasConfig"},{local:"transformers.TapasTokenizer",title:"TapasTokenizer"},{local:"transformers.TapasModel",title:"TapasModel"},{local:"transformers.TapasForMaskedLM",title:"TapasForMaskedLM"},{local:"transformers.TapasForSequenceClassification",title:"TapasForSequenceClassification"},{local:"transformers.TapasForQuestionAnswering",title:"TapasForQuestionAnswering"},{local:"transformers.TFTapasModel",title:"TFTapasModel"},{local:"transformers.TFTapasForMaskedLM",title:"TFTapasForMaskedLM"},{local:"transformers.TFTapasForSequenceClassification",title:"TFTapasForSequenceClassification"},{local:"transformers.TFTapasForQuestionAnswering",title:"TFTapasForQuestionAnswering"}],title:"TAPAS"};function oy(P){return Tk(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class hy extends uk{constructor(l){super();mk(this,l,oy,sy,fk,{})}}export{hy as default,ay as metadata};
