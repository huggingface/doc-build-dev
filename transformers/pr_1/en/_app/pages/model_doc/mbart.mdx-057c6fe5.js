...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_1/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_1/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_1/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_1/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_1/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lv=d(),zc=n("p"),Gv=r("Finally, this model supports inherent JAX features such as:"),Wv=d(),_t=n("ul"),qc=n("li"),cr=n("a"),Rv=r("Just-In-Time (JIT) compilation"),Uv=d(),Bc=n("li"),pr=n("a"),Xv=r("Automatic Differentiation"),Hv=d(),$c=n("li"),hr=n("a"),Vv=r("Vectorization"),Qv=d(),Fc=n("li"),ur=n("a"),Jv=r("Parallelization"),Kv=d(),te=n("div"),u(mr.$$.fragment),Zv=d(),$o=n("p"),Yv=r("The "),jc=n("code"),eT=r("FlaxMBartPreTrainedModel"),tT=r("forward method, overrides the "),Ec=n("code"),oT=r("__call__"),nT=r(" special method."),aT=d(),u(kn.$$.fragment),sT=d(),Pc=n("p"),rT=r("Summarization example:"),iT=d(),u(fr.$$.fragment),dT=d(),Cc=n("p"),lT=r("Mask filling example:"),cT=d(),u(_r.$$.fragment),pT=d(),zt=n("div"),u(gr.$$.fragment),hT=d(),Sc=n("p"),uT=r("Example:"),mT=d(),u(kr.$$.fragment),fT=d(),qt=n("div"),u(br.$$.fragment),_T=d(),Ac=n("p"),gT=r("Example:"),kT=d(),u(yr.$$.fragment),lh=d(),Fo=n("h2"),bn=n("a"),Oc=n("span"),u(vr.$$.fragment),bT=d(),Ic=n("span"),yT=r("FlaxMBartForSequenceClassification"),ch=d(),O=n("div"),u(Tr.$$.fragment),vT=d(),Nc=n("p"),TT=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),MT=d(),Mr=n("p"),wT=r("This model inherits from "),Pi=n("a"),xT=r("FlaxPreTrainedModel"),zT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qT=d(),wr=n("p"),BT=r(`This model is also a Flax Linen
`),xr=n("a"),$T=r("flax.nn.Module"),FT=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jT=d(),Dc=n("p"),ET=r("Finally, this model supports inherent JAX features such as:"),PT=d(),gt=n("ul"),Lc=n("li"),zr=n("a"),CT=r("Just-In-Time (JIT) compilation"),ST=d(),Gc=n("li"),qr=n("a"),AT=r("Automatic Differentiation"),OT=d(),Wc=n("li"),Br=n("a"),IT=r("Vectorization"),NT=d(),Rc=n("li"),$r=n("a"),DT=r("Parallelization"),LT=d(),De=n("div"),u(Fr.$$.fragment),GT=d(),jo=n("p"),WT=r("The "),Uc=n("code"),RT=r("FlaxMBartPreTrainedModel"),UT=r("forward method, overrides the "),Xc=n("code"),XT=r("__call__"),HT=r(" special method."),VT=d(),u(yn.$$.fragment),QT=d(),Hc=n("p"),JT=r("Example:"),KT=d(),u(jr.$$.fragment),ZT=d(),Bt=n("div"),u(Er.$$.fragment),YT=d(),Vc=n("p"),eM=r("Example:"),tM=d(),u(Pr.$$.fragment),oM=d(),$t=n("div"),u(Cr.$$.fragment),nM=d(),Qc=n("p"),aM=r("Example:"),sM=d(),u(Sr.$$.fragment),ph=d(),Eo=n("h2"),vn=n("a"),Jc=n("span"),u(Ar.$$.fragment),rM=d(),Kc=n("span"),iM=r("FlaxMBartForQuestionAnswering"),hh=d(),I=n("div"),u(Or.$$.fragment),dM=d(),Po=n("p"),lM=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Zc=n("code"),cM=r("span start logits"),pM=r(" and "),Yc=n("code"),hM=r("span end logits"),uM=r(")."),mM=d(),Ir=n("p"),fM=r("This model inherits from "),Ci=n("a"),_M=r("FlaxPreTrainedModel"),gM=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kM=d(),Nr=n("p"),bM=r(`This model is also a Flax Linen
`),Dr=n("a"),yM=r("flax.nn.Module"),vM=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),TM=d(),ep=n("p"),MM=r("Finally, this model supports inherent JAX features such as:"),wM=d(),kt=n("ul"),tp=n("li"),Lr=n("a"),xM=r("Just-In-Time (JIT) compilation"),zM=d(),op=n("li"),Gr=n("a"),qM=r("Automatic Differentiation"),BM=d(),np=n("li"),Wr=n("a"),$M=r("Vectorization"),FM=d(),ap=n("li"),Rr=n("a"),jM=r("Parallelization"),EM=d(),Le=n("div"),u(Ur.$$.fragment),PM=d(),Co=n("p"),CM=r("The "),sp=n("code"),SM=r("FlaxMBartPreTrainedModel"),AM=r("forward method, overrides the "),rp=n("code"),OM=r("__call__"),IM=r(" special method."),NM=d(),u(Tn.$$.fragment),DM=d(),ip=n("p"),LM=r("Example:"),GM=d(),u(Xr.$$.fragment),WM=d(),Ft=n("div"),u(Hr.$$.fragment),RM=d(),dp=n("p"),UM=r("Example:"),XM=d(),u(Vr.$$.fragment),HM=d(),jt=n("div"),u(Qr.$$.fragment),VM=d(),lp=n("p"),QM=r("Example:"),JM=d(),u(Jr.$$.fragment),this.h()},l(o){const p=G2('[data-svelte="svelte-1phssyn"]',document.head);b=a(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(o),v=a(o,"H1",{class:!0});var Kr=s(v);w=a(Kr,"A",{id:!0,class:!0,href:!0});var cp=s(w);x=a(cp,"SPAN",{});var pp=s(x);m(T.$$.fragment,pp),pp.forEach(t),cp.forEach(t),y=l(Kr),B=a(Kr,"SPAN",{});var hp=s(B);rt=i(hp,"MBart and MBart-50"),hp.forEach(t),Kr.forEach(t),Pe=l(o),j=a(o,"P",{});var Mn=s(j);Ue=a(Mn,"STRONG",{});var up=s(Ue);ke=i(up,"DISCLAIMER:"),up.forEach(t),it=i(Mn," If you see something strange, file a "),be=a(Mn,"A",{href:!0,rel:!0});var mp=s(be);ye=i(mp,"Github Issue"),mp.forEach(t),dt=i(Mn,` and assign
@patrickvonplaten`),Mn.forEach(t),Ke=l(o),J=a(o,"H2",{class:!0});var Zr=s(J);N=a(Zr,"A",{id:!0,class:!0,href:!0});var fp=s(N);Xe=a(fp,"SPAN",{});var _p=s(Xe);m(se.$$.fragment,_p),_p.forEach(t),fp.forEach(t),P=l(Zr),A=a(Zr,"SPAN",{});var gp=s(A);lt=i(gp,"Overview of MBart"),gp.forEach(t),Zr.forEach(t),pe=l(o),he=a(o,"P",{});var Yr=s(he);ct=i(Yr,"The MBart model was presented in "),K=a(Yr,"A",{href:!0,rel:!0});var ZM=s(K);pt=i(ZM,"Multilingual Denoising Pre-training for Neural Machine Translation"),ZM.forEach(t),ht=i(Yr,` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
Ghazvininejad, Mike Lewis, Luke Zettlemoyer.`),Yr.forEach(t),D=l(o),Ce=a(o,"P",{});var YM=s(Ce);ve=i(YM,`According to the abstract, MBART is a sequence-to-sequence denoising auto-encoder pretrained on large-scale monolingual
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),YM.forEach(t),Ze=l(o),re=a(o,"P",{});var kp=s(re);Te=i(kp,"This model was contributed by "),Me=a(kp,"A",{href:!0,rel:!0});var e1=s(Me);ut=i(e1,"valhalla"),e1.forEach(t),ie=i(kp,". The Authors\u2019 code can be found "),we=a(kp,"A",{href:!0,rel:!0});var t1=s(we);xe=i(t1,"here"),t1.forEach(t),kp.forEach(t),Ye=l(o),M=a(o,"H3",{class:!0});var mh=s(M);F=a(mh,"A",{id:!0,class:!0,href:!0});var o1=s(F);ze=a(o1,"SPAN",{});var n1=s(ze);m(He.$$.fragment,n1),n1.forEach(t),o1.forEach(t),Ut=l(mh),Z=a(mh,"SPAN",{});var a1=s(Z);Xt=i(a1,"Training of MBart"),a1.forEach(t),mh.forEach(t),bt=l(o),H=a(o,"P",{});var Et=s(H);de=i(Et,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),le=a(Et,"CODE",{});var s1=s(le);Ht=i(s1,"X [eos, src_lang_code]"),s1.forEach(t),Vt=i(Et," where "),ce=a(Et,"CODE",{});var r1=s(ce);Qt=i(r1,"X"),r1.forEach(t),Jt=i(Et,` is the source text. The
target text format is `),Ve=a(Et,"CODE",{});var i1=s(Ve);Kt=i(i1,"[tgt_lang_code] X [eos]"),i1.forEach(t),Su=i(Et,". "),ld=a(Et,"CODE",{});var d1=s(ld);Au=i(d1,"bos"),d1.forEach(t),Ou=i(Et," is never used."),Et.forEach(t),bp=l(o),yt=a(o,"P",{});var Si=s(yt);Iu=i(Si,"The regular "),Cn=a(Si,"A",{href:!0});var KM=s(Cn);cd=a(KM,"STRONG",{});var l1=s(cd);Nu=i(l1,"call"),l1.forEach(t),Du=i(KM,"()"),KM.forEach(t),Lu=i(Si,` will encode source text format, and it should be wrapped
inside the context manager `),ti=a(Si,"A",{href:!0});var c1=s(ti);Gu=i(c1,"as_target_tokenizer()"),c1.forEach(t),Wu=i(Si," to encode target text format."),Si.forEach(t),yp=l(o),oi=a(o,"UL",{});var p1=s(oi);pd=a(p1,"LI",{});var h1=s(pd);Ru=i(h1,"Supervised training"),h1.forEach(t),p1.forEach(t),vp=l(o),m(Sn.$$.fragment,o),Tp=l(o),ni=a(o,"UL",{});var u1=s(ni);An=a(u1,"LI",{});var fh=s(An);hd=a(fh,"P",{});var m1=s(hd);Uu=i(m1,"Generation"),m1.forEach(t),Xu=l(fh),Zt=a(fh,"P",{});var Ai=s(Zt);Hu=i(Ai,"While generating the target text set the "),ud=a(Ai,"CODE",{});var f1=s(ud);Vu=i(f1,"decoder_start_token_id"),f1.forEach(t),Qu=i(Ai,` to the target language id. The following
example shows how to translate English to Romanian using the `),md=a(Ai,"EM",{});var _1=s(md);Ju=i(_1,"facebook/mbart-large-en-ro"),_1.forEach(t),Ku=i(Ai," model."),Ai.forEach(t),fh.forEach(t),u1.forEach(t),Mp=l(o),m(On.$$.fragment,o),wp=l(o),Yt=a(o,"H2",{class:!0});var _h=s(Yt);So=a(_h,"A",{id:!0,class:!0,href:!0});var g1=s(So);fd=a(g1,"SPAN",{});var k1=s(fd);m(In.$$.fragment,k1),k1.forEach(t),g1.forEach(t),Zu=l(_h),_d=a(_h,"SPAN",{});var b1=s(_d);Yu=i(b1,"Overview of MBart-50"),b1.forEach(t),_h.forEach(t),xp=l(o),vt=a(o,"P",{});var Oi=s(vt);em=i(Oi,"MBart-50 was introduced in the "),Nn=a(Oi,"A",{href:!0,rel:!0});var y1=s(Nn);tm=i(y1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),y1.forEach(t),om=i(Oi,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Oi.forEach(t),zp=l(o),ai=a(o,"P",{});var T1=s(ai);sm=i(T1,"According to the abstract"),T1.forEach(t),qp=l(o),si=a(o,"P",{});var M1=s(si);kd=a(M1,"EM",{});var w1=s(kd);rm=i(w1,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),w1.forEach(t),M1.forEach(t),Bp=l(o),eo=a(o,"H3",{class:!0});var gh=s(eo);Ao=a(gh,"A",{id:!0,class:!0,href:!0});var x1=s(Ao);bd=a(x1,"SPAN",{});var z1=s(bd);m(Dn.$$.fragment,z1),z1.forEach(t),x1.forEach(t),im=l(gh),yd=a(gh,"SPAN",{});var q1=s(yd);dm=i(q1,"Training of MBart-50"),q1.forEach(t),gh.forEach(t),$p=l(o),et=a(o,"P",{});var wn=s(et);lm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),vd=a(wn,"CODE",{});var B1=s(vd);cm=i(B1,"[lang_code] X [eos]"),B1.forEach(t),pm=i(wn,", where "),Td=a(wn,"CODE",{});var $1=s(Td);hm=i($1,"lang_code"),$1.forEach(t),um=i(wn,` is source
language id for source text and target language id for target text, with `),Md=a(wn,"CODE",{});var F1=s(Md);mm=i(F1,"X"),F1.forEach(t),fm=i(wn,` being the source or target text
respectively.`),wn.forEach(t),Fp=l(o),Oo=a(o,"P",{});var kh=s(Oo);_m=i(kh,"MBart-50 has its own tokenizer "),ri=a(kh,"A",{href:!0});var j1=s(ri);gm=i(j1,"MBart50Tokenizer"),j1.forEach(t),km=i(kh,"."),kh.forEach(t),jp=l(o),ii=a(o,"UL",{});var E1=s(ii);wd=a(E1,"LI",{});var P1=s(wd);bm=i(P1,"Supervised training"),P1.forEach(t),E1.forEach(t),Ep=l(o),m(Ln.$$.fragment,o),Pp=l(o),di=a(o,"UL",{});var C1=s(di);Gn=a(C1,"LI",{});var bh=s(Gn);xd=a(bh,"P",{});var S1=s(xd);ym=i(S1,"Generation"),S1.forEach(t),vm=l(bh),qe=a(bh,"P",{});var nt=s(qe);Tm=i(nt,"To generate using the mBART-50 multilingual translation models, "),zd=a(nt,"CODE",{});var A1=s(zd);Mm=i(A1,"eos_token_id"),A1.forEach(t),wm=i(nt,` is used as the
...
target language id as the first generated token, pass the `),Bd=a(nt,"EM",{});var I1=s(Bd);qm=i(I1,"forced_bos_token_id"),I1.forEach(t),Bm=i(nt," parameter to the "),$d=a(nt,"EM",{});var N1=s($d);$m=i(N1,"generate"),N1.forEach(t),Fm=i(nt,` method.
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Fd=a(nt,"EM",{});var D1=s(Fd);jm=i(D1,"facebook/mbart-50-large-many-to-many"),D1.forEach(t),Em=i(nt," checkpoint."),nt.forEach(t),bh.forEach(t),C1.forEach(t),Cp=l(o),m(Wn.$$.fragment,o),Sp=l(o),to=a(o,"H2",{class:!0});var yh=s(to);Io=a(yh,"A",{id:!0,class:!0,href:!0});var L1=s(Io);jd=a(L1,"SPAN",{});var G1=s(jd);m(Rn.$$.fragment,G1),G1.forEach(t),L1.forEach(t),Pm=l(yh),Ed=a(yh,"SPAN",{});var W1=s(Ed);Cm=i(W1,"MBartConfig"),W1.forEach(t),yh.forEach(t),Ap=l(o),Be=a(o,"DIV",{class:!0});var Pt=s(Be);m(Un.$$.fragment,Pt),Sm=l(Pt),oo=a(Pt,"P",{});var Ii=s(oo);Am=i(Ii,"This is the configuration class to store the configuration of a "),li=a(Ii,"A",{href:!0});var R1=s(li);Om=i(R1,"MBartModel"),R1.forEach(t),Im=i(Ii,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Ii,"A",{href:!0,rel:!0});var U1=s(Xn);Nm=i(U1,"facebook/mbart-large-cc25"),U1.forEach(t),Dm=i(Ii," architecture."),Ii.forEach(t),Lm=l(Pt),no=a(Pt,"P",{});var Ni=s(no);Gm=i(Ni,"Configuration objects inherit from "),ci=a(Ni,"A",{href:!0});var X1=s(ci);Wm=i(X1,"PretrainedConfig"),X1.forEach(t),Rm=i(Ni,` and can be used to control the model outputs. Read the
documentation from `),pi=a(Ni,"A",{href:!0});var H1=s(pi);Um=i(H1,"PretrainedConfig"),H1.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Hm=l(Pt),Pd=a(Pt,"P",{});var V1=s(Pd);Vm=i(V1,"Example:"),V1.forEach(t),Qm=l(Pt),m(Hn.$$.fragment,Pt),Pt.forEach(t),Op=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var Q1=s(No);Cd=a(Q1,"SPAN",{});var J1=s(Cd);m(Vn.$$.fragment,J1),J1.forEach(t),Q1.forEach(t),Jm=l(vh),Sd=a(vh,"SPAN",{});var K1=s(Sd);Km=i(K1,"MBartTokenizer"),K1.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Qn.$$.fragment,me),Zm=l(me),Ad=a(me,"P",{});var Z1=s(Ad);Ym=i(Z1,"Construct an MBART tokenizer."),Z1.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Y1=s(hi);of=i(Y1,"RobertaTokenizer"),Y1.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var ew=s(ui);af=i(ew,"XLNetTokenizer"),ew.forEach(t),sf=i(xn,`. Based on
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),Lv=l(ge),zc=a(ge,"P",{});var Oz=s(zc);Gv=i(Oz,"Finally, this model supports inherent JAX features such as:"),Oz.forEach(t),Wv=l(ge),_t=a(ge,"UL",{});var jn=s(_t);qc=a(jn,"LI",{});var Iz=s(qc);cr=a(Iz,"A",{href:!0,rel:!0});var Nz=s(cr);Rv=i(Nz,"Just-In-Time (JIT) compilation"),Nz.forEach(t),Iz.forEach(t),Uv=l(jn),Bc=a(jn,"LI",{});var Dz=s(Bc);pr=a(Dz,"A",{href:!0,rel:!0});var Lz=s(pr);Xv=i(Lz,"Automatic Differentiation"),Lz.forEach(t),Dz.forEach(t),Hv=l(jn),$c=a(jn,"LI",{});var Gz=s($c);hr=a(Gz,"A",{href:!0,rel:!0});var Wz=s(hr);Vv=i(Wz,"Vectorization"),Wz.forEach(t),Gz.forEach(t),Qv=l(jn),Fc=a(jn,"LI",{});var Rz=s(Fc);ur=a(Rz,"A",{href:!0,rel:!0});var Uz=s(ur);Jv=i(Uz,"Parallelization"),Uz.forEach(t),Rz.forEach(t),jn.forEach(t),Kv=l(ge),te=a(ge,"DIV",{class:!0});var Re=s(te);m(mr.$$.fragment,Re),Zv=l(Re),$o=a(Re,"P",{});var Yi=s($o);Yv=i(Yi,"The "),jc=a(Yi,"CODE",{});var Xz=s(jc);eT=i(Xz,"FlaxMBartPreTrainedModel"),Xz.forEach(t),tT=i(Yi,"forward method, overrides the "),Ec=a(Yi,"CODE",{});var Hz=s(Ec);oT=i(Hz,"__call__"),Hz.forEach(t),nT=i(Yi," special method."),Yi.forEach(t),aT=l(Re),m(kn.$$.fragment,Re),sT=l(Re),Pc=a(Re,"P",{});var Vz=s(Pc);rT=i(Vz,"Summarization example:"),Vz.forEach(t),iT=l(Re),m(fr.$$.fragment,Re),dT=l(Re),Cc=a(Re,"P",{});var Qz=s(Cc);lT=i(Qz,"Mask filling example:"),Qz.forEach(t),cT=l(Re),m(_r.$$.fragment,Re),Re.forEach(t),pT=l(ge),zt=a(ge,"DIV",{class:!0});var ed=s(zt);m(gr.$$.fragment,ed),hT=l(ed),Sc=a(ed,"P",{});var Jz=s(Sc);uT=i(Jz,"Example:"),Jz.forEach(t),mT=l(ed),m(kr.$$.fragment,ed),ed.forEach(t),fT=l(ge),qt=a(ge,"DIV",{class:!0});var td=s(qt);m(br.$$.fragment,td),_T=l(td),Ac=a(td,"P",{});var Kz=s(Ac);gT=i(Kz,"Example:"),Kz.forEach(t),kT=l(td),m(yr.$$.fragment,td),td.forEach(t),ge.forEach(t),lh=l(o),Fo=a(o,"H2",{class:!0});var $u=s(Fo);bn=a($u,"A",{id:!0,class:!0,href:!0});var Zz=s(bn);Oc=a(Zz,"SPAN",{});var Yz=s(Oc);m(vr.$$.fragment,Yz),Yz.forEach(t),Zz.forEach(t),bT=l($u),Ic=a($u,"SPAN",{});var e2=s(Ic);yT=i(e2,"FlaxMBartForSequenceClassification"),e2.forEach(t),$u.forEach(t),ch=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);m(Tr.$$.fragment,ne),vT=l(ne),Nc=a(ne,"P",{});var t2=s(Nc);TT=i(t2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),t2.forEach(t),MT=l(ne),Mr=a(ne,"P",{});var Fu=s(Mr);wT=i(Fu,"This model inherits from "),Pi=a(Fu,"A",{href:!0});var o2=s(Pi);xT=i(o2,"FlaxPreTrainedModel"),o2.forEach(t),zT=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fu.forEach(t),qT=l(ne),wr=a(ne,"P",{});var ju=s(wr);BT=i(ju,`This model is also a Flax Linen
`),xr=a(ju,"A",{href:!0,rel:!0});var n2=s(xr);$T=i(n2,"flax.nn.Module"),n2.forEach(t),FT=i(ju,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ju.forEach(t),jT=l(ne),Dc=a(ne,"P",{});var a2=s(Dc);ET=i(a2,"Finally, this model supports inherent JAX features such as:"),a2.forEach(t),PT=l(ne),gt=a(ne,"UL",{});var En=s(gt);Lc=a(En,"LI",{});var s2=s(Lc);zr=a(s2,"A",{href:!0,rel:!0});var r2=s(zr);CT=i(r2,"Just-In-Time (JIT) compilation"),r2.forEach(t),s2.forEach(t),ST=l(En),Gc=a(En,"LI",{});var i2=s(Gc);qr=a(i2,"A",{href:!0,rel:!0});var d2=s(qr);AT=i(d2,"Automatic Differentiation"),d2.forEach(t),i2.forEach(t),OT=l(En),Wc=a(En,"LI",{});var l2=s(Wc);Br=a(l2,"A",{href:!0,rel:!0});var c2=s(Br);IT=i(c2,"Vectorization"),c2.forEach(t),l2.forEach(t),NT=l(En),Rc=a(En,"LI",{});var p2=s(Rc);$r=a(p2,"A",{href:!0,rel:!0});var h2=s($r);DT=i(h2,"Parallelization"),h2.forEach(t),p2.forEach(t),En.forEach(t),LT=l(ne),De=a(ne,"DIV",{class:!0});var Wt=s(De);m(Fr.$$.fragment,Wt),GT=l(Wt),jo=a(Wt,"P",{});var od=s(jo);WT=i(od,"The "),Uc=a(od,"CODE",{});var u2=s(Uc);RT=i(u2,"FlaxMBartPreTrainedModel"),u2.forEach(t),UT=i(od,"forward method, overrides the "),Xc=a(od,"CODE",{});var m2=s(Xc);XT=i(m2,"__call__"),m2.forEach(t),HT=i(od," special method."),od.forEach(t),VT=l(Wt),m(yn.$$.fragment,Wt),QT=l(Wt),Hc=a(Wt,"P",{});var f2=s(Hc);JT=i(f2,"Example:"),f2.forEach(t),KT=l(Wt),m(jr.$$.fragment,Wt),Wt.forEach(t),ZT=l(ne),Bt=a(ne,"DIV",{class:!0});var nd=s(Bt);m(Er.$$.fragment,nd),YT=l(nd),Vc=a(nd,"P",{});var _2=s(Vc);eM=i(_2,"Example:"),_2.forEach(t),tM=l(nd),m(Pr.$$.fragment,nd),nd.forEach(t),oM=l(ne),$t=a(ne,"DIV",{class:!0});var ad=s($t);m(Cr.$$.fragment,ad),nM=l(ad),Qc=a(ad,"P",{});var g2=s(Qc);aM=i(g2,"Example:"),g2.forEach(t),sM=l(ad),m(Sr.$$.fragment,ad),ad.forEach(t),ne.forEach(t),ph=l(o),Eo=a(o,"H2",{class:!0});var Eu=s(Eo);vn=a(Eu,"A",{id:!0,class:!0,href:!0});var k2=s(vn);Jc=a(k2,"SPAN",{});var b2=s(Jc);m(Ar.$$.fragment,b2),b2.forEach(t),k2.forEach(t),rM=l(Eu),Kc=a(Eu,"SPAN",{});var y2=s(Kc);iM=i(y2,"FlaxMBartForQuestionAnswering"),y2.forEach(t),Eu.forEach(t),hh=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);m(Or.$$.fragment,ae),dM=l(ae),Po=a(ae,"P",{});var sd=s(Po);lM=i(sd,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
