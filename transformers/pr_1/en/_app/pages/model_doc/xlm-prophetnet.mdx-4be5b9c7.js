...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Me=new G({}),qe=new q({props:{name:"class transformers.XLMProphetNetModel",anchor:"transformers.XLMProphetNetModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/xlm_prophetnet/modeling_xlm_prophetnet.py#L86"}}),ye=new It({props:{code:`from transformers import XLMProphetNetTokenizer, XLMProphetNetModel
