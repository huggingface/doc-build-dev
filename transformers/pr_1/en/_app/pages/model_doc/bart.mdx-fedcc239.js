import{S as Cw,i as Aw,s as Ow,e as n,k as d,w as m,t as r,M as Sw,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as u,y as _,q as g,o as k,B as b,v as Iw}from"../../chunks/vendor-6b77c823.js";import{T as qe}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as P}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as H}from"../../chunks/IconCopyLink-7a11ce68.js";function Nw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("When used with "),T=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer will add a space before each word (even the first one).")},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"When used with "),T=a(y,"CODE",{});var B=s(T);w=i(B,"is_split_into_words=True"),B.forEach(t),x=i(y,", this tokenizer will add a space before each word (even the first one)."),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Lw(j){let p,z,T,w,x,v,y,B;return{c(){p=n("p"),z=r("When used with "),T=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer needs to be instantiated with "),v=n("code"),y=r("add_prefix_space=True"),B=r(".")},l(ae){p=a(ae,"P",{});var A=s(p);z=i(A,"When used with "),T=a(A,"CODE",{});var $=s(T);w=i($,"is_split_into_words=True"),$.forEach(t),x=i(A,", this tokenizer needs to be instantiated with "),v=a(A,"CODE",{});var ce=s(v);y=i(ce,"add_prefix_space=True"),ce.forEach(t),B=i(A,"."),A.forEach(t)},m(ae,A){u(ae,p,A),e(p,z),e(p,T),e(T,w),e(p,x),e(p,v),e(v,y),e(p,B)},d(ae){ae&&t(p)}}}function Dw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Gw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Ww(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Uw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Rw(j){let p,z,T,w,x,v,y,B,ae,A,$,ce,ge,et,ke,be,tt,Ze,Q,N,Ue,se,C,O,ot,pe,he,nt,V,at,st,L,$e,ye,Ye,K,re,rt,it,J,dt,Te,Re;return{c(){p=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),T=d(),w=n("ul"),x=n("li"),v=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),ce=r("This second option is useful when using "),ge=n("code"),et=r("tf.keras.Model.fit"),ke=r(` method which currently requires having all the
...
`),Te=a(Je,"CODE",{});var Rt=s(Te);Re=i(Rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Rt.forEach(t),Je.forEach(t),de.forEach(t)},m(F,M){u(F,p,M),e(p,z),u(F,T,M),u(F,w,M),e(w,x),e(x,v),e(w,y),e(w,B),e(B,ae),u(F,A,M),u(F,$,M),e($,ce),e($,ge),e(ge,et),e($,ke),e($,be),e(be,tt),e($,Ze),u(F,Q,M),u(F,N,M),e(N,Ue),u(F,se,M),u(F,C,M),e(C,O),e(O,ot),e(O,pe),e(pe,he),e(O,nt),e(O,V),e(V,at),e(C,st),e(C,L),e(L,$e),e(L,ye),e(ye,Ye),e(L,K),e(L,re),e(re,rt),e(C,it),e(C,J),e(J,dt),e(J,Te),e(Te,Re)},d(F){F&&t(p),F&&t(T),F&&t(w),F&&t(A),F&&t($),F&&t(Q),F&&t(N),F&&t(se),F&&t(C)}}}function Hw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Qw(j){let p,z,T,w,x,v,y,B,ae,A,$,ce,ge,et,ke,be,tt,Ze,Q,N,Ue,se,C,O,ot,pe,he,nt,V,at,st,L,$e,ye,Ye,K,re,rt,it,J,dt,Te,Re;return{c(){p=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),T=d(),w=n("ul"),x=n("li"),v=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),ce=r("This second option is useful when using "),ge=n("code"),et=r("tf.keras.Model.fit"),ke=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),be=n("code"),tt=r("model(inputs)"),Ze=r("."),Q=d(),N=n("p"),Ue=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),se=d(),C=n("ul"),O=n("li"),ot=r("a single Tensor with "),pe=n("code"),he=r("input_ids"),nt=r(" only and nothing else: "),V=n("code"),at=r("model(input_ids)"),st=d(),L=n("li"),$e=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ye=n("code"),Ye=r("model([input_ids, attention_mask])"),K=r(" or "),re=n("code"),rt=r("model([input_ids, attention_mask, token_type_ids])"),it=d(),J=n("li"),dt=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Te=n("code"),Re=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(F){p=a(F,"P",{});var M=s(p);z=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),T=l(F),w=a(F,"UL",{});var R=s(w);x=a(R,"LI",{});var Dt=s(x);v=i(Dt,"having all inputs as keyword arguments (like PyTorch models), or"),Dt.forEach(t),y=l(R),B=a(R,"LI",{});var He=s(B);ae=i(He,"having all inputs as a list, tuple or dict in the first positional arguments."),He.forEach(t),R.forEach(t),A=l(F),$=a(F,"P",{});var ie=s($);ce=i(ie,"This second option is useful when using "),ge=a(ie,"CODE",{});var Gt=s(ge);et=i(Gt,"tf.keras.Model.fit"),Gt.forEach(t),ke=i(ie,` method which currently requires having all the
...
first positional argument :`),Wt.forEach(t),se=l(F),C=a(F,"UL",{});var de=s(C);O=a(de,"LI",{});var ue=s(O);ot=i(ue,"a single Tensor with "),pe=a(ue,"CODE",{});var ve=s(pe);he=i(ve,"input_ids"),ve.forEach(t),nt=i(ue," only and nothing else: "),V=a(ue,"CODE",{});var je=s(V);at=i(je,"model(input_ids)"),je.forEach(t),ue.forEach(t),st=l(de),L=a(de,"LI",{});var le=s(L);$e=i(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ye=a(le,"CODE",{});var Ve=s(ye);Ye=i(Ve,"model([input_ids, attention_mask])"),Ve.forEach(t),K=i(le," or "),re=a(le,"CODE",{});var Ut=s(re);rt=i(Ut,"model([input_ids, attention_mask, token_type_ids])"),Ut.forEach(t),le.forEach(t),it=l(de),J=a(de,"LI",{});var Je=s(J);dt=i(Je,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Te=a(Je,"CODE",{});var Rt=s(Te);Re=i(Rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Rt.forEach(t),Je.forEach(t),de.forEach(t)},m(F,M){u(F,p,M),e(p,z),u(F,T,M),u(F,w,M),e(w,x),e(x,v),e(w,y),e(w,B),e(B,ae),u(F,A,M),u(F,$,M),e($,ce),e($,ge),e(ge,et),e($,ke),e($,be),e(be,tt),e($,Ze),u(F,Q,M),u(F,N,M),e(N,Ue),u(F,se,M),u(F,C,M),e(C,O),e(O,ot),e(O,pe),e(pe,he),e(O,nt),e(O,V),e(V,at),e(C,st),e(C,L),e(L,$e),e(L,ye),e(ye,Ye),e(L,K),e(L,re),e(re,rt),e(C,it),e(C,J),e(J,dt),e(J,Te),e(Te,Re)},d(F){F&&t(p),F&&t(T),F&&t(w),F&&t(A),F&&t($),F&&t(Q),F&&t(N),F&&t(se),F&&t(C)}}}function Vw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Xw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Zw(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_1/en/model_doc/bart#transformers.BartConfig"
...
`}}),Ro=new qe({props:{$$slots:{default:[Gw]},$$scope:{ctx:j}}}),ua=new P({props:{code:`from transformers import BartTokenizer, BartForConditionalGeneration
...
`}}),Qo=new qe({props:{$$slots:{default:[Ww]},$$scope:{ctx:j}}}),Ta=new P({props:{code:`import torch
...
`}}),Jo=new qe({props:{$$slots:{default:[Uw]},$$scope:{ctx:j}}}),$a=new P({props:{code:`from transformers import BartTokenizer, BartForQuestionAnswering
import torch
...
`}}),Yo=new qe({props:{$$slots:{default:[Hw]},$$scope:{ctx:j}}}),La=new P({props:{code:`from transformers import BartTokenizer, TFBartModel
...
`}}),on=new qe({props:{$$slots:{default:[Vw]},$$scope:{ctx:j}}}),Qa=new P({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration
...
`}}),an=new qe({props:{$$slots:{default:[Jw]},$$scope:{ctx:j}}}),ss=new P({props:{code:`from transformers import BartTokenizer, FlaxBartModel
...
`}}),rn=new qe({props:{$$slots:{default:[Xw]},$$scope:{ctx:j}}}),ys=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/bart/modeling_flax_bart.py#L1319",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_1/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
`}}),ln=new qe({props:{$$slots:{default:[Kw]},$$scope:{ctx:j}}}),Os=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
`}}),pn=new qe({props:{$$slots:{default:[Zw]},$$scope:{ctx:j}}}),Ks=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
<p><a
  href="/docs/transformers/pr_1/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),un=new qe({props:{$$slots:{default:[Yw]},$$scope:{ctx:j}}}),hr=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=n("meta"),z=d(),T=n("h1"),w=n("a"),x=n("span"),m(v.$$.fragment),y=d(),B=n("span"),ae=r("BART"),A=d(),$=n("p"),ce=n("strong"),ge=r("DISCLAIMER:"),et=r(" If you see something strange, file a "),ke=n("a"),be=r("Github Issue"),tt=r(` and assign
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ly=d(),Ol=n("p"),cy=r("Finally, this model supports inherent JAX features such as:"),py=d(),ft=n("ul"),Sl=n("li"),ir=n("a"),hy=r("Just-In-Time (JIT) compilation"),uy=d(),Il=n("li"),dr=n("a"),my=r("Automatic Differentiation"),fy=d(),Nl=n("li"),lr=n("a"),_y=r("Vectorization"),gy=d(),Ll=n("li"),cr=n("a"),ky=r("Parallelization"),by=d(),Ie=n("div"),m(pr.$$.fragment),yy=d(),qo=n("p"),Ty=r("The "),Dl=n("code"),vy=r("FlaxBartDecoderPreTrainedModel"),wy=r("forward method, overrides the "),Gl=n("code"),xy=r("__call__"),zy=r(" special method."),Fy=d(),m(un.$$.fragment),By=d(),Wl=n("p"),qy=r("Example:"),$y=d(),m(hr.$$.fragment),this.h()},l(o){const h=Sw('[data-svelte="svelte-1phssyn"]',document.head);p=a(h,"META",{name:!0,content:!0}),h.forEach(t),z=l(o),T=a(o,"H1",{class:!0});var ur=s(T);w=a(ur,"A",{id:!0,class:!0,href:!0});var Ul=s(w);x=a(Ul,"SPAN",{});var Rl=s(x);f(v.$$.fragment,Rl),Rl.forEach(t),Ul.forEach(t),y=l(ur),B=a(ur,"SPAN",{});var Hl=s(B);ae=i(Hl,"BART"),Hl.forEach(t),ur.forEach(t),A=l(o),$=a(o,"P",{});var mn=s($);ce=a(mn,"STRONG",{});var Ql=s(ce);ge=i(Ql,"DISCLAIMER:"),Ql.forEach(t),et=i(mn," If you see something strange, file a "),ke=a(mn,"A",{href:!0,rel:!0});var Vl=s(ke);be=i(Vl,"Github Issue"),Vl.forEach(t),tt=i(mn,` and assign
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xp.forEach(t),og=l(fe),Sd=a(fe,"P",{});var Jv=s(Sd);ng=i(Jv,"Finally, this model supports inherent JAX features such as:"),Jv.forEach(t),ag=l(fe),pt=a(fe,"UL",{});var bn=s(pt);Id=a(bn,"LI",{});var Xv=s(Id);es=a(Xv,"A",{href:!0,rel:!0});var Kv=s(es);sg=i(Kv,"Just-In-Time (JIT) compilation"),Kv.forEach(t),Xv.forEach(t),rg=l(bn),Nd=a(bn,"LI",{});var Zv=s(Nd);ts=a(Zv,"A",{href:!0,rel:!0});var Yv=s(ts);ig=i(Yv,"Automatic Differentiation"),Yv.forEach(t),Zv.forEach(t),dg=l(bn),Ld=a(bn,"LI",{});var e1=s(Ld);os=a(e1,"A",{href:!0,rel:!0});var t1=s(os);lg=i(t1,"Vectorization"),t1.forEach(t),e1.forEach(t),cg=l(bn),Dd=a(bn,"LI",{});var o1=s(Dd);ns=a(o1,"A",{href:!0,rel:!0});var n1=s(ns);pg=i(n1,"Parallelization"),n1.forEach(t),o1.forEach(t),bn.forEach(t),hg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);f(as.$$.fragment,St),ug=l(St),bo=a(St,"P",{});var li=s(bo);mg=i(li,"The "),Gd=a(li,"CODE",{});var a1=s(Gd);fg=i(a1,"FlaxBartPreTrainedModel"),a1.forEach(t),_g=i(li,"forward method, overrides the "),Wd=a(li,"CODE",{});var s1=s(Wd);gg=i(s1,"__call__"),s1.forEach(t),kg=i(li," special method."),li.forEach(t),bg=l(St),f(an.$$.fragment,St),yg=l(St),Ud=a(St,"P",{});var r1=s(Ud);Tg=i(r1,"Example:"),r1.forEach(t),vg=l(St),f(ss.$$.fragment,St),St.forEach(t),wg=l(fe),yt=a(fe,"DIV",{class:!0});var ci=s(yt);f(rs.$$.fragment,ci),xg=l(ci),Rd=a(ci,"P",{});var i1=s(Rd);zg=i(i1,"Example:"),i1.forEach(t),Fg=l(ci),f(is.$$.fragment,ci),ci.forEach(t),Bg=l(fe),Tt=a(fe,"DIV",{class:!0});var pi=s(Tt);f(ds.$$.fragment,pi),qg=l(pi),Hd=a(pi,"P",{});var d1=s(Hd);$g=i(d1,"Example:"),d1.forEach(t),jg=l(pi),f(ls.$$.fragment,pi),pi.forEach(t),fe.forEach(t),$c=l(o),yo=a(o,"H2",{class:!0});var zp=s(yo);sn=a(zp,"A",{id:!0,class:!0,href:!0});var l1=s(sn);Qd=a(l1,"SPAN",{});var c1=s(Qd);f(cs.$$.fragment,c1),c1.forEach(t),l1.forEach(t),Mg=l(zp),Vd=a(zp,"SPAN",{});var p1=s(Vd);Pg=i(p1,"FlaxBartForConditionalGeneration"),p1.forEach(t),zp.forEach(t),jc=l(o),U=a(o,"DIV",{class:!0});var _e=s(U);f(ps.$$.fragment,_e),Eg=l(_e),hs=a(_e,"P",{});var Fp=s(hs);Cg=i(Fp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(Fp,"A",{href:!0});var h1=s(Gr);Ag=i(h1,"FlaxPreTrainedModel"),h1.forEach(t),Og=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp.forEach(t),Sg=l(_e),us=a(_e,"P",{});var Bp=s(us);Ig=i(Bp,`This model is also a Flax Linen
`),ms=a(Bp,"A",{href:!0,rel:!0});var u1=s(ms);Ng=i(u1,"flax.nn.Module"),u1.forEach(t),Lg=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),Dg=l(_e),Jd=a(_e,"P",{});var m1=s(Jd);Gg=i(m1,"Finally, this model supports inherent JAX features such as:"),m1.forEach(t),Wg=l(_e),ht=a(_e,"UL",{});var yn=s(ht);Xd=a(yn,"LI",{});var f1=s(Xd);fs=a(f1,"A",{href:!0,rel:!0});var _1=s(fs);Ug=i(_1,"Just-In-Time (JIT) compilation"),_1.forEach(t),f1.forEach(t),Rg=l(yn),Kd=a(yn,"LI",{});var g1=s(Kd);_s=a(g1,"A",{href:!0,rel:!0});var k1=s(_s);Hg=i(k1,"Automatic Differentiation"),k1.forEach(t),g1.forEach(t),Qg=l(yn),Zd=a(yn,"LI",{});var b1=s(Zd);gs=a(b1,"A",{href:!0,rel:!0});var y1=s(gs);Vg=i(y1,"Vectorization"),y1.forEach(t),b1.forEach(t),Jg=l(yn),Yd=a(yn,"LI",{});var T1=s(Yd);ks=a(T1,"A",{href:!0,rel:!0});var v1=s(ks);Xg=i(v1,"Parallelization"),v1.forEach(t),T1.forEach(t),yn.forEach(t),Kg=l(_e),te=a(_e,"DIV",{class:!0});var Ge=s(te);f(bs.$$.fragment,Ge),Zg=l(Ge),To=a(Ge,"P",{});var hi=s(To);Yg=i(hi,"The "),el=a(hi,"CODE",{});var w1=s(el);ek=i(w1,"FlaxBartPreTrainedModel"),w1.forEach(t),tk=i(hi,"forward method, overrides the "),tl=a(hi,"CODE",{});var x1=s(tl);ok=i(x1,"__call__"),x1.forEach(t),nk=i(hi," special method."),hi.forEach(t),ak=l(Ge),f(rn.$$.fragment,Ge),sk=l(Ge),ol=a(Ge,"P",{});var z1=s(ol);rk=i(z1,"Summarization example:"),z1.forEach(t),ik=l(Ge),f(ys.$$.fragment,Ge),dk=l(Ge),nl=a(Ge,"P",{});var F1=s(nl);lk=i(F1,"Mask filling example:"),F1.forEach(t),ck=l(Ge),f(Ts.$$.fragment,Ge),Ge.forEach(t),pk=l(_e),vt=a(_e,"DIV",{class:!0});var ui=s(vt);f(vs.$$.fragment,ui),hk=l(ui),al=a(ui,"P",{});var B1=s(al);uk=i(B1,"Example:"),B1.forEach(t),mk=l(ui),f(ws.$$.fragment,ui),ui.forEach(t),fk=l(_e),wt=a(_e,"DIV",{class:!0});var mi=s(wt);f(xs.$$.fragment,mi),_k=l(mi),sl=a(mi,"P",{});var q1=s(sl);gk=i(q1,"Example:"),q1.forEach(t),kk=l(mi),f(zs.$$.fragment,mi),mi.forEach(t),_e.forEach(t),Mc=l(o),vo=a(o,"H2",{class:!0});var qp=s(vo);dn=a(qp,"A",{id:!0,class:!0,href:!0});var $1=s(dn);rl=a($1,"SPAN",{});var j1=s(rl);f(Fs.$$.fragment,j1),j1.forEach(t),$1.forEach(t),bk=l(qp),il=a(qp,"SPAN",{});var M1=s(il);yk=i(M1,"FlaxBartForSequenceClassification"),M1.forEach(t),qp.forEach(t),Pc=l(o),S=a(o,"DIV",{class:!0});var oe=s(S);f(Bs.$$.fragment,oe),Tk=l(oe),dl=a(oe,"P",{});var P1=s(dl);vk=i(P1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
