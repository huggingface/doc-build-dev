...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ne=new O({props:{name:"save_vocabulary",anchor:"transformers.SplinterTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/splinter/tokenization_splinter.py#L307"}}),je=new lt({}),Qe=new O({props:{name:"class transformers.SplinterTokenizerFast",anchor:"transformers.SplinterTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"question_token",val:" = '[QUESTION]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_1/src/transformers/models/splinter/tokenization_splinter_fast.py#L55",parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
one also has the pretrained wights of the QASS layer (`),Wt=o("em"),Mo=a("tau/splinter-base-qass"),Fo=a(" and "),Ut=o("em"),Co=a("tau/splinter-large-qass"),Io=a(`) and one
...
special tokens using the tokenizer `),tn=o("code"),As=a("prepare_for_model"),Ps=a(" method."),Ms=d(),W=o("div"),m(Oe.$$.fragment),Fs=d(),yt=o("p"),Cs=a("Create the token type IDs corresponding to the sequences passed. "),Tt=o("a"),Is=a(`What are token type
...
layers on top of the hidden-states output to compute `),gn=o("code"),Er=a("span start logits"),Ar=a(" and "),_n=o("code"),Pr=a("span end logits"),Mr=a(")."),Fr=d(),nt=o("p"),Cr=a("This model is a PyTorch "),ot=o("a"),Ir=a("torch.nn.Module"),Lr=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
one also has the pretrained wights of the QASS layer (`),Wt=s(B,"EM",{});var ma=r(Wt);Mo=i(ma,"tau/splinter-base-qass"),ma.forEach(n),Fo=i(B," and "),Ut=s(B,"EM",{});var fa=r(Ut);Co=i(fa,"tau/splinter-large-qass"),fa.forEach(n),Io=i(B,`) and one
