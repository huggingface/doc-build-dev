import{S as Wm,i as Qm,s as Um,e as a,k as l,w as k,t as n,M as Hm,c as r,d as t,m as d,a as i,x as w,h as s,b as c,F as e,g as u,y as b,q as y,o as P,B as $}from"../../chunks/vendor-4833417e.js";import{T as Ke}from"../../chunks/Tip-fffd6df1.js";import{D as ae}from"../../chunks/Docstring-4f315ed9.js";import{C as Ie}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Xe}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Rm(A){let p,F,m,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),_=n("Module"),v=n(`
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(g,"CODE",{});var G=i(m);_=s(G,"Module"),G.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,m),e(m,_),e(p,v)},d(T){T&&t(p)}}}function lg(A){let p,F,m,_,v,T,g,G,pe,K,E,X,O,Z,he,B,ue,re,L,I,ee,te,J,M,fe,U,ie,Y,H,oe,me,x,le,S,ge,de,N,W,_e,q,Te,R,ne,h,j,V,Me,xe,z,qe,ze,Ee,C,Q,ce,Pe,D,Ce,ve,ke,Ae,Qs,lt,Mi,Jo,xi,qi,Us,zi,Ci,Hs,Ai,Ii,Gr,$t,Kt,Rs,Mo,Li,Vs,Si,jr,Xt,Ni,ds,Di,Oi,Er,xo,Jr,cs,Bi,Mr,qo,xr,Ft,Yt,Ks,zo,Wi,Xs,Qi,qr,Ye,Co,Ui,Ze,Hi,ps,Ri,Vi,Ao,Ki,Xi,hs,Yi,Zi,us,el,tl,ol,Ys,nl,sl,Io,zr,Gt,Zt,Zs,Lo,al,ea,rl,Cr,dt,So,il,No,ll,Do,dl,cl,pl,Le,Oo,hl,jt,ul,fs,fl,ml,ta,gl,_l,Tl,eo,vl,oa,kl,wl,Bo,Ar,Et,to,na,Wo,bl,sa,yl,Ir,et,Qo,Pl,aa,$l,Fl,Uo,Gl,Ho,jl,El,Jl,Se,Ro,Ml,Jt,xl,ms,ql,zl,ra,Cl,Al,Il,oo,Ll,ia,Sl,Nl,Vo,Lr,Mt,no,la,Ko,Dl,da,Ol,Sr,$e,Xo,Bl,ca,Wl,Ql,gs,_s,Ul,Hl,Rl,tt,Vl,pa,Kl,Xl,ha,Yl,Zl,ua,ed,td,fa,od,nd,sd,Yo,ad,Zo,rd,id,ld,ye,en,dd,xt,cd,Ts,pd,hd,ma,ud,fd,md,so,gd,ga,_d,Td,tn,vd,_a,kd,wd,on,Nr,qt,ao,Ta,nn,bd,va,yd,Dr,ot,sn,Pd,zt,$d,ka,Fd,Gd,wa,jd,Ed,Jd,an,Md,rn,xd,qd,zd,Ne,ln,Cd,Ct,Ad,vs,Id,Ld,ba,Sd,Nd,Dd,ro,Od,ya,Bd,Wd,dn,Or,At,io,Pa,cn,Qd,$a,Ud,Br,Fe,pn,Hd,Fa,Rd,Vd,hn,Kd,ks,Xd,Yd,Zd,un,ec,fn,tc,oc,nc,lo,sc,De,mn,ac,It,rc,ws,ic,lc,Ga,dc,cc,pc,co,hc,ja,uc,fc,gn,Wr,Lt,po,Ea,_n,mc,Ja,gc,Qr,Ge,Tn,_c,Ma,Tc,vc,vn,kc,bs,wc,bc,yc,kn,Pc,wn,$c,Fc,Gc,ho,jc,Oe,bn,Ec,St,Jc,ys,Mc,xc,xa,qc,zc,Cc,uo,Ac,qa,Ic,Lc,yn,Ur,Nt,fo,za,Pn,Sc,Ca,Nc,Hr,se,$n,Dc,Aa,Oc,Bc,Ps,$s,Wc,Qc,Uc,nt,Hc,Ia,Rc,Vc,La,Kc,Xc,Sa,Yc,Zc,Na,ep,tp,op,Fn,np,Fs,sp,ap,rp,Gn,ip,jn,lp,dp,cp,mo,pp,Be,En,hp,Dt,up,Gs,fp,mp,Da,gp,_p,Tp,go,vp,Oa,kp,wp,Jn,Rr,Ot,_o,Ba,Mn,bp,Wa,yp,Vr,je,xn,Pp,Bt,$p,Qa,Fp,Gp,Ua,jp,Ep,Jp,qn,Mp,js,xp,qp,zp,zn,Cp,Cn,Ap,Ip,Lp,To,Sp,We,An,Np,Wt,Dp,Es,Op,Bp,Ha,Wp,Qp,Up,vo,Hp,Ra,Rp,Vp,In,Kr,Qt,ko,Va,Ln,Kp,Ka,Xp,Xr,we,Sn,Yp,Xa,Zp,eh,Nn,th,Js,oh,nh,sh,Dn,ah,On,rh,ih,lh,Ya,dh,ch,ct,Za,Bn,ph,hh,er,Wn,uh,fh,tr,Qn,mh,gh,or,Un,_h,Th,Qe,Hn,vh,Ut,kh,nr,wh,bh,sr,yh,Ph,$h,wo,Fh,ar,Gh,jh,Rn,Yr,Ht,bo,rr,Vn,Eh,ir,Jh,Zr,be,Kn,Mh,lr,xh,qh,Xn,zh,Ms,Ch,Ah,Ih,Yn,Lh,Zn,Sh,Nh,Dh,dr,Oh,Bh,pt,cr,es,Wh,Qh,pr,ts,Uh,Hh,hr,os,Rh,Vh,ur,ns,Kh,Xh,Ue,ss,Yh,Rt,Zh,fr,eu,tu,mr,ou,nu,su,yo,au,gr,ru,iu,as,ei;return T=new Xe({}),Z=new Xe({}),C=new Ie({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),_n=new Xe({}),Tn=new ae({props:{name:"class transformers.TFGPTJForCausalLM",anchor:"transformers.TFGPTJForCausalLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15623/src/transformers/models/gptj/modeling_tf_gptj.py#L736",parametersDescription:[{anchor:"transformers.TFGPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15623/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new Ke({props:{$$slots:{default:[eg]},$$scope:{ctx:A}}}),bn=new ae({props:{name:"call",anchor:"transformers.TFGPTJForCausalLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15623/src/transformers/models/gptj/modeling_tf_gptj.py#L776",parametersDescription:[{anchor:"transformers.TFGPTJForCausalLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_15623/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),uo=new Ke({props:{$$slots:{default:[tg]},$$scope:{ctx:A}}}),yn=new Ie({props:{code:`from transformers import GPTJTokenizer, TFGPTJForCausalLM
import tensorflow as tf
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"},{anchor:"transformers.TFGPTJForSequenceClassification.call.labels",description:`<strong>labels</strong> (<code>tf.Tensor</code> of shape <code>(batch_size,)</code>, <em>optional</em>) &#x2014;
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"},{anchor:"transformers.TFGPTJForQuestionAnswering.call.start_positions",description:`<strong>start_positions</strong> (<code>tf.Tensor</code> of shape <code>(batch_size,)</code>, <em>optional</em>) &#x2014;
Labels for position (index) of the start of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"start_positions"},{anchor:"transformers.TFGPTJForQuestionAnswering.call.end_positions",description:`<strong>end_positions</strong> (<code>tf.Tensor</code> of shape <code>(batch_size,)</code>, <em>optional</em>) &#x2014;
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
...
`}}),yo=new Ke({props:{$$slots:{default:[ig]},$$scope:{ctx:A}}}),as=new Ie({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJForCausalLM
...
behavior.`),pl=l(),Le=a("div"),k(Oo.$$.fragment),hl=l(),jt=a("p"),ul=n("The "),fs=a("a"),fl=n("GPTJModel"),ml=n(" forward method, overrides the "),ta=a("code"),gl=n("__call__"),_l=n(" special method."),Tl=l(),k(eo.$$.fragment),vl=l(),oa=a("p"),kl=n("Example:"),wl=l(),k(Bo.$$.fragment),Ar=l(),Et=a("h2"),to=a("a"),na=a("span"),k(Wo.$$.fragment),bl=l(),sa=a("span"),yl=n("GPTJForCausalLM"),Ir=l(),et=a("div"),k(Qo.$$.fragment),Pl=l(),aa=a("p"),$l=n("The GPT-J Model transformer with a language modeling head on top."),Fl=l(),Uo=a("p"),Gl=n("This model is a PyTorch "),Ho=a("a"),jl=n("torch.nn.Module"),El=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ld=l(),ye=a("div"),k(en.$$.fragment),dd=l(),xt=a("p"),cd=n("The "),Ts=a("a"),pd=n("GPTJForSequenceClassification"),hd=n(" forward method, overrides the "),ma=a("code"),ud=n("__call__"),fd=n(" special method."),md=l(),k(so.$$.fragment),gd=l(),ga=a("p"),_d=n("Example of single-label classification:"),Td=l(),k(tn.$$.fragment),vd=l(),_a=a("p"),kd=n("Example of multi-label classification:"),wd=l(),k(on.$$.fragment),Nr=l(),qt=a("h2"),ao=a("a"),Ta=a("span"),k(nn.$$.fragment),bd=l(),va=a("span"),yd=n("GPTJForQuestionAnswering"),Dr=l(),ot=a("div"),k(sn.$$.fragment),Pd=l(),zt=a("p"),$d=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zd=l(),Ne=a("div"),k(ln.$$.fragment),Cd=l(),Ct=a("p"),Ad=n("The "),vs=a("a"),Id=n("GPTJForQuestionAnswering"),Ld=n(" forward method, overrides the "),ba=a("code"),Sd=n("__call__"),Nd=n(" special method."),Dd=l(),k(ro.$$.fragment),Od=l(),ya=a("p"),Bd=n("Example:"),Wd=l(),k(dn.$$.fragment),Or=l(),At=a("h2"),io=a("a"),Pa=a("span"),k(cn.$$.fragment),Qd=l(),$a=a("span"),Ud=n("TFGPTJModel"),Br=l(),Fe=a("div"),k(pn.$$.fragment),Hd=l(),Fa=a("p"),Rd=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Vd=l(),hn=a("p"),Kd=n("This model inherits from "),ks=a("a"),Xd=n("TFPreTrainedModel"),Yd=n(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cp=l(),k(mo.$$.fragment),pp=l(),Be=a("div"),k(En.$$.fragment),hp=l(),Dt=a("p"),up=n("The "),Gs=a("a"),fp=n("TFGPTJForSequenceClassification"),mp=n(" forward method, overrides the "),Da=a("code"),gp=n("__call__"),_p=n(" special method."),Tp=l(),k(go.$$.fragment),vp=l(),Oa=a("p"),kp=n("Example:"),wp=l(),k(Jn.$$.fragment),Rr=l(),Ot=a("h2"),_o=a("a"),Ba=a("span"),k(Mn.$$.fragment),bp=l(),Wa=a("span"),yp=n("TFGPTJForQuestionAnswering"),Vr=l(),je=a("div"),k(xn.$$.fragment),Pp=l(),Bt=a("p"),$p=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
`),Us=r(Po,"CODE",{});var ku=i(Us);zi=s(ku,"<|extratoken_1|>... <|extratoken_143|>"),ku.forEach(t),Ci=s(Po,", so the "),Hs=r(Po,"CODE",{});var wu=i(Hs);Ai=s(wu,"vocab_size"),wu.forEach(t),Ii=s(Po," of tokenizer also becomes 50400."),Po.forEach(t),Tu.forEach(t),ti.forEach(t),Gr=d(o),$t=r(o,"H3",{class:!0});var oi=i($t);Kt=r(oi,"A",{id:!0,class:!0,href:!0});var bu=i(Kt);Rs=r(bu,"SPAN",{});var yu=i(Rs);w(Mo.$$.fragment,yu),yu.forEach(t),bu.forEach(t),Li=d(oi),Vs=r(oi,"SPAN",{});var Pu=i(Vs);Si=s(Pu,"Generation"),Pu.forEach(t),oi.forEach(t),jr=d(o),Xt=r(o,"P",{});var ni=i(Xt);Ni=s(ni,"The "),ds=r(ni,"A",{href:!0});var $u=i(ds);Di=s($u,"generate()"),$u.forEach(t),Oi=s(ni,` method can be used to generate text using GPT-J
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ci.forEach(t),ld=d(st),ye=r(st,"DIV",{class:!0});var He=i(ye);w(en.$$.fragment,He),dd=d(He),xt=r(He,"P",{});var Cs=i(xt);cd=s(Cs,"The "),Ts=r(Cs,"A",{href:!0});var rf=i(Ts);pd=s(rf,"GPTJForSequenceClassification"),rf.forEach(t),hd=s(Cs," forward method, overrides the "),ma=r(Cs,"CODE",{});var lf=i(ma);ud=s(lf,"__call__"),lf.forEach(t),fd=s(Cs," special method."),Cs.forEach(t),md=d(He),w(so.$$.fragment,He),gd=d(He),ga=r(He,"P",{});var df=i(ga);_d=s(df,"Example of single-label classification:"),df.forEach(t),Td=d(He),w(tn.$$.fragment,He),vd=d(He),_a=r(He,"P",{});var cf=i(_a);kd=s(cf,"Example of multi-label classification:"),cf.forEach(t),wd=d(He),w(on.$$.fragment,He),He.forEach(t),st.forEach(t),Nr=d(o),qt=r(o,"H2",{class:!0});var pi=i(qt);ao=r(pi,"A",{id:!0,class:!0,href:!0});var pf=i(ao);Ta=r(pf,"SPAN",{});var hf=i(Ta);w(nn.$$.fragment,hf),hf.forEach(t),pf.forEach(t),bd=d(pi),va=r(pi,"SPAN",{});var uf=i(va);yd=s(uf,"GPTJForQuestionAnswering"),uf.forEach(t),pi.forEach(t),Dr=d(o),ot=r(o,"DIV",{class:!0});var Go=i(ot);w(sn.$$.fragment,Go),Pd=d(Go),zt=r(Go,"P",{});var As=i(zt);$d=s(As,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),hi.forEach(t),zd=d(Go),Ne=r(Go,"DIV",{class:!0});var _t=i(Ne);w(ln.$$.fragment,_t),Cd=d(_t),Ct=r(_t,"P",{});var Is=i(Ct);Ad=s(Is,"The "),vs=r(Is,"A",{href:!0});var _f=i(vs);Id=s(_f,"GPTJForQuestionAnswering"),_f.forEach(t),Ld=s(Is," forward method, overrides the "),ba=r(Is,"CODE",{});var Tf=i(ba);Sd=s(Tf,"__call__"),Tf.forEach(t),Nd=s(Is," special method."),Is.forEach(t),Dd=d(_t),w(ro.$$.fragment,_t),Od=d(_t),ya=r(_t,"P",{});var vf=i(ya);Bd=s(vf,"Example:"),vf.forEach(t),Wd=d(_t),w(dn.$$.fragment,_t),_t.forEach(t),Go.forEach(t),Or=d(o),At=r(o,"H2",{class:!0});var ui=i(At);io=r(ui,"A",{id:!0,class:!0,href:!0});var kf=i(io);Pa=r(kf,"SPAN",{});var wf=i(Pa);w(cn.$$.fragment,wf),wf.forEach(t),kf.forEach(t),Qd=d(ui),$a=r(ui,"SPAN",{});var bf=i($a);Ud=s(bf,"TFGPTJModel"),bf.forEach(t),ui.forEach(t),Br=d(o),Fe=r(o,"DIV",{class:!0});var at=i(Fe);w(pn.$$.fragment,at),Hd=d(at),Fa=r(at,"P",{});var yf=i(Fa);Rd=s(yf,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),yf.forEach(t),Vd=d(at),hn=r(at,"P",{});var fi=i(hn);Kd=s(fi,"This model inherits from "),ks=r(fi,"A",{href:!0});var Pf=i(ks);Xd=s(Pf,"TFPreTrainedModel"),Pf.forEach(t),Yd=s(fi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wi.forEach(t),cp=d(Je),w(mo.$$.fragment,Je),pp=d(Je),Be=r(Je,"DIV",{class:!0});var wt=i(Be);w(En.$$.fragment,wt),hp=d(wt),Dt=r(wt,"P",{});var Ns=i(Dt);up=s(Ns,"The "),Gs=r(Ns,"A",{href:!0});var Vf=i(Gs);fp=s(Vf,"TFGPTJForSequenceClassification"),Vf.forEach(t),mp=s(Ns," forward method, overrides the "),Da=r(Ns,"CODE",{});var Kf=i(Da);gp=s(Kf,"__call__"),Kf.forEach(t),_p=s(Ns," special method."),Ns.forEach(t),Tp=d(wt),w(go.$$.fragment,wt),vp=d(wt),Oa=r(wt,"P",{});var Xf=i(Oa);kp=s(Xf,"Example:"),Xf.forEach(t),wp=d(wt),w(Jn.$$.fragment,wt),wt.forEach(t),Je.forEach(t),Rr=d(o),Ot=r(o,"H2",{class:!0});var bi=i(Ot);_o=r(bi,"A",{id:!0,class:!0,href:!0});var Yf=i(_o);Ba=r(Yf,"SPAN",{});var Zf=i(Ba);w(Mn.$$.fragment,Zf),Zf.forEach(t),Yf.forEach(t),bp=d(bi),Wa=r(bi,"SPAN",{});var em=i(Wa);yp=s(em,"TFGPTJForQuestionAnswering"),em.forEach(t),bi.forEach(t),Vr=d(o),je=r(o,"DIV",{class:!0});var it=i(je);w(xn.$$.fragment,it),Pp=d(it),Bt=r(it,"P",{});var Ds=i(Bt);$p=s(Ds,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=r(Ds,"CODE",{});var tm=i(Qa);Fp=s(tm,"span start logits"),tm.forEach(t),Gp=s(Ds," and "),Ua=r(Ds,"CODE",{});var om=i(Ua);jp=s(om,"span end logits"),om.forEach(t),Ep=s(Ds,")."),Ds.forEach(t),Jp=d(it),qn=r(it,"P",{});var yi=i(qn);Mp=s(yi,"This model inherits from "),js=r(yi,"A",{href:!0});var nm=i(js);xp=s(nm,"TFPreTrainedModel"),nm.forEach(t),qp=s(yi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yi.forEach(t),zp=d(it),zn=r(it,"P",{});var Pi=i(zn);Cp=s(Pi,"This model is also a "),Cn=r(Pi,"A",{href:!0,rel:!0});var sm=i(Cn);Ap=s(sm,"tf.keras.Model"),sm.forEach(t),Ip=s(Pi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pi.forEach(t),Lp=d(it),w(To.$$.fragment,it),Sp=d(it),We=r(it,"DIV",{class:!0});var bt=i(We);w(An.$$.fragment,bt),Np=d(bt),Wt=r(bt,"P",{});var Os=i(Wt);Dp=s(Os,"The "),Es=r(Os,"A",{href:!0});var am=i(Es);Op=s(am,"TFGPTJForQuestionAnswering"),am.forEach(t),Bp=s(Os," forward method, overrides the "),Ha=r(Os,"CODE",{});var rm=i(Ha);Wp=s(rm,"__call__"),rm.forEach(t),Qp=s(Os," special method."),Os.forEach(t),Up=d(bt),w(vo.$$.fragment,bt),Hp=d(bt),Ra=r(bt,"P",{});var im=i(Ra);Rp=s(im,"Example:"),im.forEach(t),Vp=d(bt),w(In.$$.fragment,bt),bt.forEach(t),it.forEach(t),Kr=d(o),Qt=r(o,"H2",{class:!0});var $i=i(Qt);ko=r($i,"A",{id:!0,class:!0,href:!0});var lm=i(ko);Va=r(lm,"SPAN",{});var dm=i(Va);w(Ln.$$.fragment,dm),dm.forEach(t),lm.forEach(t),Kp=d($i),Ka=r($i,"SPAN",{});var cm=i(Ka);Xp=s(cm,"FlaxGPTJModel"),cm.forEach(t),$i.forEach(t),Xr=d(o),we=r(o,"DIV",{class:!0});var Re=i(we);w(Sn.$$.fragment,Re),Yp=d(Re),Xa=r(Re,"P",{});var pm=i(Xa);Zp=s(pm,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),pm.forEach(t),eh=d(Re),Nn=r(Re,"P",{});var Fi=i(Nn);th=s(Fi,"This model inherits from "),Js=r(Fi,"A",{href:!0});var hm=i(Js);oh=s(hm,"FlaxPreTrainedModel"),hm.forEach(t),nh=s(Fi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Gi.forEach(t),lh=d(Re),Ya=r(Re,"P",{});var fm=i(Ya);dh=s(fm,"Finally, this model supports inherent JAX features such as:"),fm.forEach(t),ch=d(Re),ct=r(Re,"UL",{});var jo=i(ct);Za=r(jo,"LI",{});var mm=i(Za);Bn=r(mm,"A",{href:!0,rel:!0});var gm=i(Bn);ph=s(gm,"Just-In-Time (JIT) compilation"),gm.forEach(t),mm.forEach(t),hh=d(jo),er=r(jo,"LI",{});var _m=i(er);Wn=r(_m,"A",{href:!0,rel:!0});var Tm=i(Wn);uh=s(Tm,"Automatic Differentiation"),Tm.forEach(t),_m.forEach(t),fh=d(jo),tr=r(jo,"LI",{});var vm=i(tr);Qn=r(vm,"A",{href:!0,rel:!0});var km=i(Qn);mh=s(km,"Vectorization"),km.forEach(t),vm.forEach(t),gh=d(jo),or=r(jo,"LI",{});var wm=i(or);Un=r(wm,"A",{href:!0,rel:!0});var bm=i(Un);_h=s(bm,"Parallelization"),bm.forEach(t),wm.forEach(t),jo.forEach(t),Th=d(Re),Qe=r(Re,"DIV",{class:!0});var yt=i(Qe);w(Hn.$$.fragment,yt),vh=d(yt),Ut=r(yt,"P",{});var Bs=i(Ut);kh=s(Bs,"The "),nr=r(Bs,"CODE",{});var ym=i(nr);wh=s(ym,"FlaxGPTJPreTrainedModel"),ym.forEach(t),bh=s(Bs,"forward method, overrides the "),sr=r(Bs,"CODE",{});var Pm=i(sr);yh=s(Pm,"__call__"),Pm.forEach(t),Ph=s(Bs," special method."),Bs.forEach(t),$h=d(yt),w(wo.$$.fragment,yt),Fh=d(yt),ar=r(yt,"P",{});var $m=i(ar);Gh=s($m,"Example:"),$m.forEach(t),jh=d(yt),w(Rn.$$.fragment,yt),yt.forEach(t),Re.forEach(t),Yr=d(o),Ht=r(o,"H2",{class:!0});var ji=i(Ht);bo=r(ji,"A",{id:!0,class:!0,href:!0});var Fm=i(bo);rr=r(Fm,"SPAN",{});var Gm=i(rr);w(Vn.$$.fragment,Gm),Gm.forEach(t),Fm.forEach(t),Eh=d(ji),ir=r(ji,"SPAN",{});var jm=i(ir);Jh=s(jm,"FlaxGPTJForCausalLM"),jm.forEach(t),ji.forEach(t),Zr=d(o),be=r(o,"DIV",{class:!0});var Ve=i(be);w(Kn.$$.fragment,Ve),Mh=d(Ve),lr=r(Ve,"P",{});var Em=i(lr);xh=s(Em,"The GPTJ Model transformer with a language modeling head on top."),Em.forEach(t),qh=d(Ve),Xn=r(Ve,"P",{});var Ei=i(Xn);zh=s(Ei,"This model inherits from "),Ms=r(Ei,"A",{href:!0});var Jm=i(Ms);Ch=s(Jm,"FlaxPreTrainedModel"),Jm.forEach(t),Ah=s(Ei,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ji.forEach(t),Dh=d(Ve),dr=r(Ve,"P",{});var xm=i(dr);Oh=s(xm,"Finally, this model supports inherent JAX features such as:"),xm.forEach(t),Bh=d(Ve),pt=r(Ve,"UL",{});var Eo=i(pt);cr=r(Eo,"LI",{});var qm=i(cr);es=r(qm,"A",{href:!0,rel:!0});var zm=i(es);Wh=s(zm,"Just-In-Time (JIT) compilation"),zm.forEach(t),qm.forEach(t),Qh=d(Eo),pr=r(Eo,"LI",{});var Cm=i(pr);ts=r(Cm,"A",{href:!0,rel:!0});var Am=i(ts);Uh=s(Am,"Automatic Differentiation"),Am.forEach(t),Cm.forEach(t),Hh=d(Eo),hr=r(Eo,"LI",{});var Im=i(hr);os=r(Im,"A",{href:!0,rel:!0});var Lm=i(os);Rh=s(Lm,"Vectorization"),Lm.forEach(t),Im.forEach(t),Vh=d(Eo),ur=r(Eo,"LI",{});var Sm=i(ur);ns=r(Sm,"A",{href:!0,rel:!0});var Nm=i(ns);Kh=s(Nm,"Parallelization"),Nm.forEach(t),Sm.forEach(t),Eo.forEach(t),Xh=d(Ve),Ue=r(Ve,"DIV",{class:!0});var Pt=i(Ue);w(ss.$$.fragment,Pt),Yh=d(Pt),Rt=r(Pt,"P",{});var Ws=i(Rt);Zh=s(Ws,"The "),fr=r(Ws,"CODE",{});var Dm=i(fr);eu=s(Dm,"FlaxGPTJPreTrainedModel"),Dm.forEach(t),tu=s(Ws,"forward method, overrides the "),mr=r(Ws,"CODE",{});var Om=i(mr);ou=s(Om,"__call__"),Om.forEach(t),nu=s(Ws," special method."),Ws.forEach(t),su=d(Pt),w(yo.$$.fragment,Pt),au=d(Pt),gr=r(Pt,"P",{});var Bm=i(gr);ru=s(Bm,"Example:"),Bm.forEach(t),iu=d(Pt),w(as.$$.fragment,Pt),Pt.forEach(t),Ve.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(dg)),c(_,"id","gptj"),c(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_,"href","#gptj"),c(m,"class","relative group"),c(X,"id","overview"),c(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(X,"href","#overview"),c(E,"class","relative group"),c(ee,"href","https://github.com/kingoflolz/mesh-transformer-jax"),c(ee,"rel","nofollow"),c(M,"href","https://pile.eleuther.ai/"),c(M,"rel","nofollow"),c(oe,"href","https://huggingface.co/stellaathena"),c(oe,"rel","nofollow"),c(q,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(q,"rel","nofollow"),c(z,"href","https://huggingface.co/EleutherAI/gpt-j-6B/tree/float16"),c(z,"rel","nofollow"),c(ve,"href","https://github.com/kingoflolz/mesh-transformer-jax/blob/master/howto_finetune.md"),c(ve,"rel","nofollow"),c(Jo,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Jo,"rel","nofollow"),c(Kt,"id","generation"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#generation"),c($t,"class","relative group"),c(ds,"href","/docs/transformers/pr_15623/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Yt,"id","transformers.GPTJConfig"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.GPTJConfig"),c(Ft,"class","relative group"),c(ps,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJModel"),c(Ao,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Ao,"rel","nofollow"),c(hs,"href","/docs/transformers/pr_15623/en/main_classes/configuration#transformers.PretrainedConfig"),c(us,"href","/docs/transformers/pr_15623/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ye,"class","docstring"),c(Zt,"id","transformers.GPTJModel"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.GPTJModel"),c(Gt,"class","relative group"),c(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Do,"rel","nofollow"),c(fs,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJModel"),c(Le,"class","docstring"),c(dt,"class","docstring"),c(to,"id","transformers.GPTJForCausalLM"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.GPTJForCausalLM"),c(Et,"class","relative group"),c(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ho,"rel","nofollow"),c(ms,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJForCausalLM"),c(Se,"class","docstring"),c(et,"class","docstring"),c(no,"id","transformers.GPTJForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.GPTJForSequenceClassification"),c(Mt,"class","relative group"),c(_s,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Zo,"rel","nofollow"),c(Ts,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(ye,"class","docstring"),c($e,"class","docstring"),c(ao,"id","transformers.GPTJForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.GPTJForQuestionAnswering"),c(qt,"class","relative group"),c(rn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(rn,"rel","nofollow"),c(vs,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJForQuestionAnswering"),c(Ne,"class","docstring"),c(ot,"class","docstring"),c(io,"id","transformers.TFGPTJModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFGPTJModel"),c(At,"class","relative group"),c(ks,"href","/docs/transformers/pr_15623/en/main_classes/model#transformers.TFPreTrainedModel"),c(fn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(fn,"rel","nofollow"),c(ws,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.TFGPTJModel"),c(De,"class","docstring"),c(Fe,"class","docstring"),c(po,"id","transformers.TFGPTJForCausalLM"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.TFGPTJForCausalLM"),c(Lt,"class","relative group"),c(bs,"href","/docs/transformers/pr_15623/en/main_classes/model#transformers.TFPreTrainedModel"),c(wn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(wn,"rel","nofollow"),c(ys,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.TFGPTJForCausalLM"),c(Oe,"class","docstring"),c(Ge,"class","docstring"),c(fo,"id","transformers.TFGPTJForSequenceClassification"),c(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(fo,"href","#transformers.TFGPTJForSequenceClassification"),c(Nt,"class","relative group"),c($s,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Fs,"href","/docs/transformers/pr_15623/en/main_classes/model#transformers.TFPreTrainedModel"),c(jn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(jn,"rel","nofollow"),c(Gs,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.TFGPTJForSequenceClassification"),c(Be,"class","docstring"),c(se,"class","docstring"),c(_o,"id","transformers.TFGPTJForQuestionAnswering"),c(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_o,"href","#transformers.TFGPTJForQuestionAnswering"),c(Ot,"class","relative group"),c(js,"href","/docs/transformers/pr_15623/en/main_classes/model#transformers.TFPreTrainedModel"),c(Cn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Cn,"rel","nofollow"),c(Es,"href","/docs/transformers/pr_15623/en/model_doc/gptj#transformers.TFGPTJForQuestionAnswering"),c(We,"class","docstring"),c(je,"class","docstring"),c(ko,"id","transformers.FlaxGPTJModel"),c(ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ko,"href","#transformers.FlaxGPTJModel"),c(Qt,"class","relative group"),c(Js,"href","/docs/transformers/pr_15623/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(On,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(On,"rel","nofollow"),c(Bn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Bn,"rel","nofollow"),c(Wn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Wn,"rel","nofollow"),c(Qn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Qn,"rel","nofollow"),c(Un,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Un,"rel","nofollow"),c(Qe,"class","docstring"),c(we,"class","docstring"),c(bo,"id","transformers.FlaxGPTJForCausalLM"),c(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bo,"href","#transformers.FlaxGPTJForCausalLM"),c(Ht,"class","relative group"),c(Ms,"href","/docs/transformers/pr_15623/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Zn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Zn,"rel","nofollow"),c(es,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(es,"rel","nofollow"),c(ts,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(ts,"rel","nofollow"),c(os,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(os,"rel","nofollow"),c(ns,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ns,"rel","nofollow"),c(Ue,"class","docstring"),c(be,"class","docstring")},m(o,f){e(document.head,p),u(o,F,f),u(o,m,f),e(m,_),e(_,v),b(T,v,null),e(m,g),e(m,G),e(G,pe),u(o,K,f),u(o,E,f),e(E,X),e(X,O),b(Z,O,null),e(E,he),e(E,B),e(B,ue),u(o,re,f),u(o,L,f),e(L,I),e(L,ee),e(ee,te),e(L,J),e(L,M),e(M,fe),e(L,U),u(o,ie,f),u(o,Y,f),e(Y,H),e(Y,oe),e(oe,me),e(Y,x),u(o,le,f),u(o,S,f),e(S,ge),u(o,de,f),u(o,N,f),e(N,W),e(W,_e),e(W,q),e(q,Te),e(W,R),e(W,ne),e(ne,h),e(W,j),e(W,V),e(V,Me),e(W,xe),e(W,z),e(z,qe),e(W,ze),u(o,Ee,f),b(C,o,f),u(o,Q,f),u(o,ce,f),e(ce,Pe),e(Pe,D),e(D,Ce),e(D,ve),e(ve,ke),e(ce,Ae),e(ce,Qs),e(Qs,lt),e(lt,Mi),e(lt,Jo),e(Jo,xi),e(lt,qi),e(lt,Us),e(Us,zi),e(lt,Ci),e(lt,Hs),e(Hs,Ai),e(lt,Ii),u(o,Gr,f),u(o,$t,f),e($t,Kt),e(Kt,Rs),b(Mo,Rs,null),e($t,Li),e($t,Vs),e(Vs,Si),u(o,jr,f),u(o,Xt,f),e(Xt,Ni),e(Xt,ds),e(ds,Di),e(Xt,Oi),u(o,Er,f),b(xo,o,f),u(o,Jr,f),u(o,cs,f),e(cs,Bi),u(o,Mr,f),b(qo,o,f),u(o,xr,f),u(o,Ft,f),e(Ft,Yt),e(Yt,Ks),b(zo,Ks,null),e(Ft,Wi),e(Ft,Xs),e(Xs,Qi),u(o,qr,f),u(o,Ye,f),b(Co,Ye,null),e(Ye,Ui),e(Ye,Ze),e(Ze,Hi),e(Ze,ps),e(ps,Ri),e(Ze,Vi),e(Ze,Ao),e(Ao,Ki),e(Ze,Xi),e(Ze,hs),e(hs,Yi),e(Ze,Zi),e(Ze,us),e(us,el),e(Ze,tl),e(Ye,ol),e(Ye,Ys),e(Ys,nl),e(Ye,sl),b(Io,Ye,null),u(o,zr,f),u(o,Gt,f),e(Gt,Zt),e(Zt,Zs),b(Lo,Zs,null),e(Gt,al),e(Gt,ea),e(ea,rl),u(o,Cr,f),u(o,dt,f),b(So,dt,null),e(dt,il),e(dt,No),e(No,ll),e(No,Do),e(Do,dl),e(No,cl),e(dt,pl),e(dt,Le),b(Oo,Le,null),e(Le,hl),e(Le,jt),e(jt,ul),e(jt,fs),e(fs,fl),e(jt,ml),e(jt,ta),e(ta,gl),e(jt,_l),e(Le,Tl),b(eo,Le,null),e(Le,vl),e(Le,oa),e(oa,kl),e(Le,wl),b(Bo,Le,null),u(o,Ar,f),u(o,Et,f),e(Et,to),e(to,na),b(Wo,na,null),e(Et,bl),e(Et,sa),e(sa,yl),u(o,Ir,f),u(o,et,f),b(Qo,et,null),e(et,Pl),e(et,aa),e(aa,$l),e(et,Fl),e(et,Uo),e(Uo,Gl),e(Uo,Ho),e(Ho,jl),e(Uo,El),e(et,Jl),e(et,Se),b(Ro,Se,null),e(Se,Ml),e(Se,Jt),e(Jt,xl),e(Jt,ms),e(ms,ql),e(Jt,zl),e(Jt,ra),e(ra,Cl),e(Jt,Al),e(Se,Il),b(oo,Se,null),e(Se,Ll),e(Se,ia),e(ia,Sl),e(Se,Nl),b(Vo,Se,null),u(o,Lr,f),u(o,Mt,f),e(Mt,no),e(no,la),b(Ko,la,null),e(Mt,Dl),e(Mt,da),e(da,Ol),u(o,Sr,f),u(o,$e,f),b(Xo,$e,null),e($e,Bl),e($e,ca),e(ca,Wl),e($e,Ql),e($e,gs),e(gs,_s),e(_s,Ul),e(gs,Hl),e($e,Rl),e($e,tt),e(tt,Vl),e(tt,pa),e(pa,Kl),e(tt,Xl),e(tt,ha),e(ha,Yl),e(tt,Zl),e(tt,ua),e(ua,ed),e(tt,td),e(tt,fa),e(fa,od),e(tt,nd),e($e,sd),e($e,Yo),e(Yo,ad),e(Yo,Zo),e(Zo,rd),e(Yo,id),e($e,ld),e($e,ye),b(en,ye,null),e(ye,dd),e(ye,xt),e(xt,cd),e(xt,Ts),e(Ts,pd),e(xt,hd),e(xt,ma),e(ma,ud),e(xt,fd),e(ye,md),b(so,ye,null),e(ye,gd),e(ye,ga),e(ga,_d),e(ye,Td),b(tn,ye,null),e(ye,vd),e(ye,_a),e(_a,kd),e(ye,wd),b(on,ye,null),u(o,Nr,f),u(o,qt,f),e(qt,ao),e(ao,Ta),b(nn,Ta,null),e(qt,bd),e(qt,va),e(va,yd),u(o,Dr,f),u(o,ot,f),b(sn,ot,null),e(ot,Pd),e(ot,zt),e(zt,$d),e(zt,ka),e(ka,Fd),e(zt,Gd),e(zt,wa),e(wa,jd),e(zt,Ed),e(ot,Jd),e(ot,an),e(an,Md),e(an,rn),e(rn,xd),e(an,qd),e(ot,zd),e(ot,Ne),b(ln,Ne,null),e(Ne,Cd),e(Ne,Ct),e(Ct,Ad),e(Ct,vs),e(vs,Id),e(Ct,Ld),e(Ct,ba),e(ba,Sd),e(Ct,Nd),e(Ne,Dd),b(ro,Ne,null),e(Ne,Od),e(Ne,ya),e(ya,Bd),e(Ne,Wd),b(dn,Ne,null),u(o,Or,f),u(o,At,f),e(At,io),e(io,Pa),b(cn,Pa,null),e(At,Qd),e(At,$a),e($a,Ud),u(o,Br,f),u(o,Fe,f),b(pn,Fe,null),e(Fe,Hd),e(Fe,Fa),e(Fa,Rd),e(Fe,Vd),e(Fe,hn),e(hn,Kd),e(hn,ks),e(ks,Xd),e(hn,Yd),e(Fe,Zd),e(Fe,un),e(un,ec),e(un,fn),e(fn,tc),e(un,oc),e(Fe,nc),b(lo,Fe,null),e(Fe,sc),e(Fe,De),b(mn,De,null),e(De,ac),e(De,It),e(It,rc),e(It,ws),e(ws,ic),e(It,lc),e(It,Ga),e(Ga,dc),e(It,cc),e(De,pc),b(co,De,null),e(De,hc),e(De,ja),e(ja,uc),e(De,fc),b(gn,De,null),u(o,Wr,f),u(o,Lt,f),e(Lt,po),e(po,Ea),b(_n,Ea,null),e(Lt,mc),e(Lt,Ja),e(Ja,gc),u(o,Qr,f),u(o,Ge,f),b(Tn,Ge,null),e(Ge,_c),e(Ge,Ma),e(Ma,Tc),e(Ge,vc),e(Ge,vn),e(vn,kc),e(vn,bs),e(bs,wc),e(vn,bc),e(Ge,yc),e(Ge,kn),e(kn,Pc),e(kn,wn),e(wn,$c),e(kn,Fc),e(Ge,Gc),b(ho,Ge,null),e(Ge,jc),e(Ge,Oe),b(bn,Oe,null),e(Oe,Ec),e(Oe,St),e(St,Jc),e(St,ys),e(ys,Mc),e(St,xc),e(St,xa),e(xa,qc),e(St,zc),e(Oe,Cc),b(uo,Oe,null),e(Oe,Ac),e(Oe,qa),e(qa,Ic),e(Oe,Lc),b(yn,Oe,null),u(o,Ur,f),u(o,Nt,f),e(Nt,fo),e(fo,za),b(Pn,za,null),e(Nt,Sc),e(Nt,Ca),e(Ca,Nc),u(o,Hr,f),u(o,se,f),b($n,se,null),e(se,Dc),e(se,Aa),e(Aa,Oc),e(se,Bc),e(se,Ps),e(Ps,$s),e($s,Wc),e(Ps,Qc),e(se,Uc),e(se,nt),e(nt,Hc),e(nt,Ia),e(Ia,Rc),e(nt,Vc),e(nt,La),e(La,Kc),e(nt,Xc),e(nt,Sa),e(Sa,Yc),e(nt,Zc),e(nt,Na),e(Na,ep),e(nt,tp),e(se,op),e(se,Fn),e(Fn,np),e(Fn,Fs),e(Fs,sp),e(Fn,ap),e(se,rp),e(se,Gn),e(Gn,ip),e(Gn,jn),e(jn,lp),e(Gn,dp),e(se,cp),b(mo,se,null),e(se,pp),e(se,Be),b(En,Be,null),e(Be,hp),e(Be,Dt),e(Dt,up),e(Dt,Gs),e(Gs,fp),e(Dt,mp),e(Dt,Da),e(Da,gp),e(Dt,_p),e(Be,Tp),b(go,Be,null),e(Be,vp),e(Be,Oa),e(Oa,kp),e(Be,wp),b(Jn,Be,null),u(o,Rr,f),u(o,Ot,f),e(Ot,_o),e(_o,Ba),b(Mn,Ba,null),e(Ot,bp),e(Ot,Wa),e(Wa,yp),u(o,Vr,f),u(o,je,f),b(xn,je,null),e(je,Pp),e(je,Bt),e(Bt,$p),e(Bt,Qa),e(Qa,Fp),e(Bt,Gp),e(Bt,Ua),e(Ua,jp),e(Bt,Ep),e(je,Jp),e(je,qn),e(qn,Mp),e(qn,js),e(js,xp),e(qn,qp),e(je,zp),e(je,zn),e(zn,Cp),e(zn,Cn),e(Cn,Ap),e(zn,Ip),e(je,Lp),b(To,je,null),e(je,Sp),e(je,We),b(An,We,null),e(We,Np),e(We,Wt),e(Wt,Dp),e(Wt,Es),e(Es,Op),e(Wt,Bp),e(Wt,Ha),e(Ha,Wp),e(Wt,Qp),e(We,Up),b(vo,We,null),e(We,Hp),e(We,Ra),e(Ra,Rp),e(We,Vp),b(In,We,null),u(o,Kr,f),u(o,Qt,f),e(Qt,ko),e(ko,Va),b(Ln,Va,null),e(Qt,Kp),e(Qt,Ka),e(Ka,Xp),u(o,Xr,f),u(o,we,f),b(Sn,we,null),e(we,Yp),e(we,Xa),e(Xa,Zp),e(we,eh),e(we,Nn),e(Nn,th),e(Nn,Js),e(Js,oh),e(Nn,nh),e(we,sh),e(we,Dn),e(Dn,ah),e(Dn,On),e(On,rh),e(Dn,ih),e(we,lh),e(we,Ya),e(Ya,dh),e(we,ch),e(we,ct),e(ct,Za),e(Za,Bn),e(Bn,ph),e(ct,hh),e(ct,er),e(er,Wn),e(Wn,uh),e(ct,fh),e(ct,tr),e(tr,Qn),e(Qn,mh),e(ct,gh),e(ct,or),e(or,Un),e(Un,_h),e(we,Th),e(we,Qe),b(Hn,Qe,null),e(Qe,vh),e(Qe,Ut),e(Ut,kh),e(Ut,nr),e(nr,wh),e(Ut,bh),e(Ut,sr),e(sr,yh),e(Ut,Ph),e(Qe,$h),b(wo,Qe,null),e(Qe,Fh),e(Qe,ar),e(ar,Gh),e(Qe,jh),b(Rn,Qe,null),u(o,Yr,f),u(o,Ht,f),e(Ht,bo),e(bo,rr),b(Vn,rr,null),e(Ht,Eh),e(Ht,ir),e(ir,Jh),u(o,Zr,f),u(o,be,f),b(Kn,be,null),e(be,Mh),e(be,lr),e(lr,xh),e(be,qh),e(be,Xn),e(Xn,zh),e(Xn,Ms),e(Ms,Ch),e(Xn,Ah),e(be,Ih),e(be,Yn),e(Yn,Lh),e(Yn,Zn),e(Zn,Sh),e(Yn,Nh),e(be,Dh),e(be,dr),e(dr,Oh),e(be,Bh),e(be,pt),e(pt,cr),e(cr,es),e(es,Wh),e(pt,Qh),e(pt,pr),e(pr,ts),e(ts,Uh),e(pt,Hh),e(pt,hr),e(hr,os),e(os,Rh),e(pt,Vh),e(pt,ur),e(ur,ns),e(ns,Kh),e(be,Xh),e(be,Ue),b(ss,Ue,null),e(Ue,Yh),e(Ue,Rt),e(Rt,Zh),e(Rt,fr),e(fr,eu),e(Rt,tu),e(Rt,mr),e(mr,ou),e(Rt,nu),e(Ue,su),b(yo,Ue,null),e(Ue,au),e(Ue,gr),e(gr,ru),e(Ue,iu),b(as,Ue,null),ei=!0},p(o,[f]){const rs={};f&2&&(rs.$$scope={dirty:f,ctx:o}),eo.$set(rs);const _r={};f&2&&(_r.$$scope={dirty:f,ctx:o}),oo.$set(_r);const Tr={};f&2&&(Tr.$$scope={dirty:f,ctx:o}),so.$set(Tr);const vr={};f&2&&(vr.$$scope={dirty:f,ctx:o}),ro.$set(vr);const is={};f&2&&(is.$$scope={dirty:f,ctx:o}),lo.$set(is);const kr={};f&2&&(kr.$$scope={dirty:f,ctx:o}),co.$set(kr);const wr={};f&2&&(wr.$$scope={dirty:f,ctx:o}),ho.$set(wr);const br={};f&2&&(br.$$scope={dirty:f,ctx:o}),uo.$set(br);const Vt={};f&2&&(Vt.$$scope={dirty:f,ctx:o}),mo.$set(Vt);const yr={};f&2&&(yr.$$scope={dirty:f,ctx:o}),go.$set(yr);const Pr={};f&2&&(Pr.$$scope={dirty:f,ctx:o}),To.$set(Pr);const ls={};f&2&&(ls.$$scope={dirty:f,ctx:o}),vo.$set(ls);const $r={};f&2&&($r.$$scope={dirty:f,ctx:o}),wo.$set($r);const Fr={};f&2&&(Fr.$$scope={dirty:f,ctx:o}),yo.$set(Fr)},i(o){ei||(y(T.$$.fragment,o),y(Z.$$.fragment,o),y(C.$$.fragment,o),y(Mo.$$.fragment,o),y(xo.$$.fragment,o),y(qo.$$.fragment,o),y(zo.$$.fragment,o),y(Co.$$.fragment,o),y(Io.$$.fragment,o),y(Lo.$$.fragment,o),y(So.$$.fragment,o),y(Oo.$$.fragment,o),y(eo.$$.fragment,o),y(Bo.$$.fragment,o),y(Wo.$$.fragment,o),y(Qo.$$.fragment,o),y(Ro.$$.fragment,o),y(oo.$$.fragment,o),y(Vo.$$.fragment,o),y(Ko.$$.fragment,o),y(Xo.$$.fragment,o),y(en.$$.fragment,o),y(so.$$.fragment,o),y(tn.$$.fragment,o),y(on.$$.fragment,o),y(nn.$$.fragment,o),y(sn.$$.fragment,o),y(ln.$$.fragment,o),y(ro.$$.fragment,o),y(dn.$$.fragment,o),y(cn.$$.fragment,o),y(pn.$$.fragment,o),y(lo.$$.fragment,o),y(mn.$$.fragment,o),y(co.$$.fragment,o),y(gn.$$.fragment,o),y(_n.$$.fragment,o),y(Tn.$$.fragment,o),y(ho.$$.fragment,o),y(bn.$$.fragment,o),y(uo.$$.fragment,o),y(yn.$$.fragment,o),y(Pn.$$.fragment,o),y($n.$$.fragment,o),y(mo.$$.fragment,o),y(En.$$.fragment,o),y(go.$$.fragment,o),y(Jn.$$.fragment,o),y(Mn.$$.fragment,o),y(xn.$$.fragment,o),y(To.$$.fragment,o),y(An.$$.fragment,o),y(vo.$$.fragment,o),y(In.$$.fragment,o),y(Ln.$$.fragment,o),y(Sn.$$.fragment,o),y(Hn.$$.fragment,o),y(wo.$$.fragment,o),y(Rn.$$.fragment,o),y(Vn.$$.fragment,o),y(Kn.$$.fragment,o),y(ss.$$.fragment,o),y(yo.$$.fragment,o),y(as.$$.fragment,o),ei=!0)},o(o){P(T.$$.fragment,o),P(Z.$$.fragment,o),P(C.$$.fragment,o),P(Mo.$$.fragment,o),P(xo.$$.fragment,o),P(qo.$$.fragment,o),P(zo.$$.fragment,o),P(Co.$$.fragment,o),P(Io.$$.fragment,o),P(Lo.$$.fragment,o),P(So.$$.fragment,o),P(Oo.$$.fragment,o),P(eo.$$.fragment,o),P(Bo.$$.fragment,o),P(Wo.$$.fragment,o),P(Qo.$$.fragment,o),P(Ro.$$.fragment,o),P(oo.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(en.$$.fragment,o),P(so.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(ln.$$.fragment,o),P(ro.$$.fragment,o),P(dn.$$.fragment,o),P(cn.$$.fragment,o),P(pn.$$.fragment,o),P(lo.$$.fragment,o),P(mn.$$.fragment,o),P(co.$$.fragment,o),P(gn.$$.fragment,o),P(_n.$$.fragment,o),P(Tn.$$.fragment,o),P(ho.$$.fragment,o),P(bn.$$.fragment,o),P(uo.$$.fragment,o),P(yn.$$.fragment,o),P(Pn.$$.fragment,o),P($n.$$.fragment,o),P(mo.$$.fragment,o),P(En.$$.fragment,o),P(go.$$.fragment,o),P(Jn.$$.fragment,o),P(Mn.$$.fragment,o),P(xn.$$.fragment,o),P(To.$$.fragment,o),P(An.$$.fragment,o),P(vo.$$.fragment,o),P(In.$$.fragment,o),P(Ln.$$.fragment,o),P(Sn.$$.fragment,o),P(Hn.$$.fragment,o),P(wo.$$.fragment,o),P(Rn.$$.fragment,o),P(Vn.$$.fragment,o),P(Kn.$$.fragment,o),P(ss.$$.fragment,o),P(yo.$$.fragment,o),P(as.$$.fragment,o),ei=!1},d(o){t(p),o&&t(F),o&&t(m),$(T),o&&t(K),o&&t(E),$(Z),o&&t(re),o&&t(L),o&&t(ie),o&&t(Y),o&&t(le),o&&t(S),o&&t(de),o&&t(N),o&&t(Ee),$(C,o),o&&t(Q),o&&t(ce),o&&t(Gr),o&&t($t),$(Mo),o&&t(jr),o&&t(Xt),o&&t(Er),$(xo,o),o&&t(Jr),o&&t(cs),o&&t(Mr),$(qo,o),o&&t(xr),o&&t(Ft),$(zo),o&&t(qr),o&&t(Ye),$(Co),$(Io),o&&t(zr),o&&t(Gt),$(Lo),o&&t(Cr),o&&t(dt),$(So),$(Oo),$(eo),$(Bo),o&&t(Ar),o&&t(Et),$(Wo),o&&t(Ir),o&&t(et),$(Qo),$(Ro),$(oo),$(Vo),o&&t(Lr),o&&t(Mt),$(Ko),o&&t(Sr),o&&t($e),$(Xo),$(en),$(so),$(tn),$(on),o&&t(Nr),o&&t(qt),$(nn),o&&t(Dr),o&&t(ot),$(sn),$(ln),$(ro),$(dn),o&&t(Or),o&&t(At),$(cn),o&&t(Br),o&&t(Fe),$(pn),$(lo),$(mn),$(co),$(gn),o&&t(Wr),o&&t(Lt),$(_n),o&&t(Qr),o&&t(Ge),$(Tn),$(ho),$(bn),$(uo),$(yn),o&&t(Ur),o&&t(Nt),$(Pn),o&&t(Hr),o&&t(se),$($n),$(mo),$(En),$(go),$(Jn),o&&t(Rr),o&&t(Ot),$(Mn),o&&t(Vr),o&&t(je),$(xn),$(To),$(An),$(vo),$(In),o&&t(Kr),o&&t(Qt),$(Ln),o&&t(Xr),o&&t(we),$(Sn),$(Hn),$(wo),$(Rn),o&&t(Yr),o&&t(Ht),$(Vn),o&&t(Zr),o&&t(be),$(Kn),$(ss),$(yo),$(as)}}}const dg={local:"gptj",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTJConfig",title:"GPTJConfig"},{local:"transformers.GPTJModel",title:"GPTJModel"},{local:"transformers.GPTJForCausalLM",title:"GPTJForCausalLM"},{local:"transformers.GPTJForSequenceClassification",title:"GPTJForSequenceClassification"},{local:"transformers.GPTJForQuestionAnswering",title:"GPTJForQuestionAnswering"},{local:"transformers.TFGPTJModel",title:"TFGPTJModel"},{local:"transformers.TFGPTJForCausalLM",title:"TFGPTJForCausalLM"},{local:"transformers.TFGPTJForSequenceClassification",title:"TFGPTJForSequenceClassification"},{local:"transformers.TFGPTJForQuestionAnswering",title:"TFGPTJForQuestionAnswering"},{local:"transformers.FlaxGPTJModel",title:"FlaxGPTJModel"},{local:"transformers.FlaxGPTJForCausalLM",title:"FlaxGPTJForCausalLM"}],title:"GPT-J"};function cg(A,p,F){let{fw:m}=p;return A.$$set=_=>{"fw"in _&&F(0,m=_.fw)},[m]}class _g extends Wm{constructor(p){super();Qm(this,p,cg,lg,Um,{fw:0})}}export{_g as default,dg as metadata};
