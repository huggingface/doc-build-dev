...
`),S=a("code"),ge=n("model([input_ids, attention_mask])"),de=n(" or "),N=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),z=a("li"),Te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var j=i(p);F=s(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Me=i(v);T=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),g=d(V),G=r(V,"LI",{});var xe=i(G);pe=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var q=i(E);X=s(q,"This second option is useful when using "),O=r(q,"CODE",{});var ze=i(O);Z=s(ze,"tf.keras.Model.fit"),ze.forEach(t),he=s(q,` method which currently requires having all the
tensors in the first argument of the model call function: `),B=r(q,"CODE",{});var qe=i(B);ue=s(qe,"model(inputs)"),qe.forEach(t),re=s(q,"."),q.forEach(t),L=d(h),I=r(h,"P",{});var Ee=i(I);ee=s(Ee,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),S=r(D,"CODE",{});var Ce=i(S);ge=s(Ce,"model([input_ids, attention_mask])"),Ce.forEach(t),de=s(D," or "),N=r(D,"CODE",{});var ve=i(N);W=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),D.forEach(t),_e=d(C),z=r(C,"LI",{});var ke=i(z);Te=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ae=i(R);ne=s(Ae,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ae.forEach(t),ke.forEach(t),C.forEach(t)},m(h,j){u(h,p,j),e(p,F),u(h,m,j),u(h,_,j),e(_,v),e(v,T),e(_,g),e(_,G),e(G,pe),u(h,K,j),u(h,E,j),e(E,X),e(E,O),e(O,Z),e(E,he),e(E,B),e(B,ue),e(E,re),u(h,L,j),u(h,I,j),e(I,ee),u(h,te,j),u(h,J,j),e(J,M),e(M,fe),e(M,U),e(U,ie),e(M,Y),e(M,H),e(H,oe),e(J,me),e(J,x),e(x,le),e(x,S),e(S,ge),e(x,de),e(x,N),e(N,W),e(J,_e),e(J,z),e(z,Te),e(z,R),e(R,ne)},d(h){h&&t(p),h&&t(m),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(I),h&&t(te),h&&t(J)}}}function Zm(A){let p,F,m,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(g,"CODE",{});var G=i(m);_=s(G,"Module"),G.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,m),e(m,_),e(p,v)},d(T){T&&t(p)}}}function eg(A){let p,F,m,_,v,T,g,G,pe,K,E,X,O,Z,he,B,ue,re,L,I,ee,te,J,M,fe,U,ie,Y,H,oe,me,x,le,S,ge,de,N,W,_e,z,Te,R,ne;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),m=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),G=a("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),ue=n("model(inputs)"),re=n("."),L=l(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),M=a("li"),fe=n("a single Tensor with "),U=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),me=l(),x=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=a("code"),ge=n("model([input_ids, attention_mask])"),de=n(" or "),N=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),z=a("li"),Te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var j=i(p);F=s(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Me=i(v);T=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),g=d(V),G=r(V,"LI",{});var xe=i(G);pe=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var q=i(E);X=s(q,"This second option is useful when using "),O=r(q,"CODE",{});var ze=i(O);Z=s(ze,"tf.keras.Model.fit"),ze.forEach(t),he=s(q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(g,"CODE",{});var G=i(m);_=s(G,"Module"),G.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,m),e(m,_),e(p,v)},d(T){T&&t(p)}}}function og(A){let p,F,m,_,v,T,g,G,pe,K,E,X,O,Z,he,B,ue,re,L,I,ee,te,J,M,fe,U,ie,Y,H,oe,me,x,le,S,ge,de,N,W,_e,z,Te,R,ne;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),m=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),G=a("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),ue=n("model(inputs)"),re=n("."),L=l(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),M=a("li"),fe=n("a single Tensor with "),U=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),me=l(),x=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=a("code"),ge=n("model([input_ids, attention_mask])"),de=n(" or "),N=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),z=a("li"),Te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var j=i(p);F=s(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Me=i(v);T=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),g=d(V),G=r(V,"LI",{});var xe=i(G);pe=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var q=i(E);X=s(q,"This second option is useful when using "),O=r(q,"CODE",{});var ze=i(O);Z=s(ze,"tf.keras.Model.fit"),ze.forEach(t),he=s(q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(g,"CODE",{});var G=i(m);_=s(G,"Module"),G.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,m),e(m,_),e(p,v)},d(T){T&&t(p)}}}function sg(A){let p,F,m,_,v,T,g,G,pe,K,E,X,O,Z,he,B,ue,re,L,I,ee,te,J,M,fe,U,ie,Y,H,oe,me,x,le,S,ge,de,N,W,_e,z,Te,R,ne;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),m=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),G=a("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),ue=n("model(inputs)"),re=n("."),L=l(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),M=a("li"),fe=n("a single Tensor with "),U=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),me=l(),x=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=a("code"),ge=n("model([input_ids, attention_mask])"),de=n(" or "),N=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),z=a("li"),Te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var j=i(p);F=s(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Me=i(v);T=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),g=d(V),G=r(V,"LI",{});var xe=i(G);pe=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var q=i(E);X=s(q,"This second option is useful when using "),O=r(q,"CODE",{});var ze=i(O);Z=s(ze,"tf.keras.Model.fit"),ze.forEach(t),he=s(q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(g,"CODE",{});var G=i(m);_=s(G,"Module"),G.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,m),e(m,_),e(p,v)},d(T){T&&t(p)}}}function lg(A){let p,F,m,_,v,T,g,G,pe,K,E,X,O,Z,he,B,ue,re,L,I,ee,te,J,M,fe,U,ie,Y,H,oe,me,x,le,S,ge,de,N,W,_e,z,Te,R,ne,h,j,V,Me,xe,q,ze,qe,Ee,C,Q,ce,Pe,D,Ce,ve,ke,Ae,Qs,lt,Mi,Jo,xi,zi,Us,qi,Ci,Hs,Ai,Ii,Gr,$t,Kt,Rs,Mo,Li,Vs,Si,jr,Xt,Ni,ds,Di,Oi,Er,xo,Jr,cs,Bi,Mr,zo,xr,Ft,Yt,Ks,qo,Wi,Xs,Qi,zr,Ye,Co,Ui,Ze,Hi,ps,Ri,Vi,Ao,Ki,Xi,hs,Yi,Zi,us,el,tl,ol,Ys,nl,sl,Io,qr,Gt,Zt,Zs,Lo,al,ea,rl,Cr,dt,So,il,No,ll,Do,dl,cl,pl,Le,Oo,hl,jt,ul,fs,fl,ml,ta,gl,_l,Tl,eo,vl,oa,kl,wl,Bo,Ar,Et,to,na,Wo,yl,sa,bl,Ir,et,Qo,Pl,aa,$l,Fl,Uo,Gl,Ho,jl,El,Jl,Se,Ro,Ml,Jt,xl,ms,zl,ql,ra,Cl,Al,Il,oo,Ll,ia,Sl,Nl,Vo,Lr,Mt,no,la,Ko,Dl,da,Ol,Sr,$e,Xo,Bl,ca,Wl,Ql,gs,_s,Ul,Hl,Rl,tt,Vl,pa,Kl,Xl,ha,Yl,Zl,ua,ed,td,fa,od,nd,sd,Yo,ad,Zo,rd,id,ld,be,en,dd,xt,cd,Ts,pd,hd,ma,ud,fd,md,so,gd,ga,_d,Td,tn,vd,_a,kd,wd,on,Nr,zt,ao,Ta,nn,yd,va,bd,Dr,ot,sn,Pd,qt,$d,ka,Fd,Gd,wa,jd,Ed,Jd,an,Md,rn,xd,zd,qd,Ne,ln,Cd,Ct,Ad,vs,Id,Ld,ya,Sd,Nd,Dd,ro,Od,ba,Bd,Wd,dn,Or,At,io,Pa,cn,Qd,$a,Ud,Br,Fe,pn,Hd,Fa,Rd,Vd,hn,Kd,ks,Xd,Yd,Zd,un,ec,fn,tc,oc,nc,lo,sc,De,mn,ac,It,rc,ws,ic,lc,Ga,dc,cc,pc,co,hc,ja,uc,fc,gn,Wr,Lt,po,Ea,_n,mc,Ja,gc,Qr,Ge,Tn,_c,Ma,Tc,vc,vn,kc,ys,wc,yc,bc,kn,Pc,wn,$c,Fc,Gc,ho,jc,Oe,yn,Ec,St,Jc,bs,Mc,xc,xa,zc,qc,Cc,uo,Ac,za,Ic,Lc,bn,Ur,Nt,fo,qa,Pn,Sc,Ca,Nc,Hr,se,$n,Dc,Aa,Oc,Bc,Ps,$s,Wc,Qc,Uc,nt,Hc,Ia,Rc,Vc,La,Kc,Xc,Sa,Yc,Zc,Na,ep,tp,op,Fn,np,Fs,sp,ap,rp,Gn,ip,jn,lp,dp,cp,mo,pp,Be,En,hp,Dt,up,Gs,fp,mp,Da,gp,_p,Tp,go,vp,Oa,kp,wp,Jn,Rr,Ot,_o,Ba,Mn,yp,Wa,bp,Vr,je,xn,Pp,Bt,$p,Qa,Fp,Gp,Ua,jp,Ep,Jp,zn,Mp,js,xp,zp,qp,qn,Cp,Cn,Ap,Ip,Lp,To,Sp,We,An,Np,Wt,Dp,Es,Op,Bp,Ha,Wp,Qp,Up,vo,Hp,Ra,Rp,Vp,In,Kr,Qt,ko,Va,Ln,Kp,Ka,Xp,Xr,we,Sn,Yp,Xa,Zp,eh,Nn,th,Js,oh,nh,sh,Dn,ah,On,rh,ih,lh,Ya,dh,ch,ct,Za,Bn,ph,hh,er,Wn,uh,fh,tr,Qn,mh,gh,or,Un,_h,Th,Qe,Hn,vh,Ut,kh,nr,wh,yh,sr,bh,Ph,$h,wo,Fh,ar,Gh,jh,Rn,Yr,Ht,yo,rr,Vn,Eh,ir,Jh,Zr,ye,Kn,Mh,lr,xh,zh,Xn,qh,Ms,Ch,Ah,Ih,Yn,Lh,Zn,Sh,Nh,Dh,dr,Oh,Bh,pt,cr,es,Wh,Qh,pr,ts,Uh,Hh,hr,os,Rh,Vh,ur,ns,Kh,Xh,Ue,ss,Yh,Rt,Zh,fr,eu,tu,mr,ou,nu,su,bo,au,gr,ru,iu,as,ei;return T=new Xe({}),Z=new Xe({}),C=new Ie({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>gen_text = tokenizer.batch_decode(gen_tokens)[<span class="hljs-number">0</span>]`}}),zo=new Ie({props:{code:`from transformers import GPTJForCausalLM, AutoTokenizer
import torch
...
`}}),co=new Ke({props:{$$slots:{default:[Zm]},$$scope:{ctx:A}}}),gn=new Ie({props:{code:`from transformers import GPT2Tokenizer, TFGPTJModel
...
last_hidden_states = outputs.last_hidden_state`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> GPT2Tokenizer, TFGPTJModel
...
`}}),uo=new Ke({props:{$$slots:{default:[tg]},$$scope:{ctx:A}}}),bn=new Ie({props:{code:`from transformers import GPT2Tokenizer, TFGPTJForCausalLM
import tensorflow as tf
...
inputs = tokenizer("Hello, my dog is cute", return_tensors="tf")
outputs = model(inputs)
logits = outputs.logits`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> GPT2Tokenizer, TFGPTJForCausalLM
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">import</span> tensorflow <span class="hljs-keyword">as</span> tf
...
`}}),go=new Ke({props:{$$slots:{default:[ng]},$$scope:{ctx:A}}}),Jn=new Ie({props:{code:`from transformers import GPT2Tokenizer, TFGPTJForSequenceClassification
import tensorflow as tf
...
outputs = model(inputs)
loss = outputs.loss
logits = outputs.logits`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> GPT2Tokenizer, TFGPTJForSequenceClassification
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">import</span> tensorflow <span class="hljs-keyword">as</span> tf
...
`}}),vo=new Ke({props:{$$slots:{default:[ag]},$$scope:{ctx:A}}}),In=new Ie({props:{code:`from transformers import GPT2Tokenizer, TFGPTJForQuestionAnswering
import tensorflow as tf
...
answer = " ".join(all_tokens[tf.math.argmax(start_logits, 1)[0] : tf.math.argmax(end_logits, 1)[0] + 1])`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> GPT2Tokenizer, TFGPTJForQuestionAnswering
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">import</span> tensorflow <span class="hljs-keyword">as</span> tf
...
causal language model trained on `),M=a("a"),fe=n("the Pile"),U=n(" dataset."),ie=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),me=n("Stella Biderman"),x=n("."),le=l(),S=a("p"),ge=n("Tips:"),de=l(),N=a("ul"),W=a("li"),_e=n("To load "),z=a("a"),Te=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
usage to 1x. There is also a `),q=a("a"),ze=n("fp16 branch"),qe=n(` which stores
...
size, the tokenizer for `),Jo=a("a"),xi=n("GPT-J"),zi=n(` contains 143 extra tokens
`),Us=a("code"),qi=n("<|extratoken_1|>... <|extratoken_143|>"),Ci=n(", so the "),Hs=a("code"),Ai=n("vocab_size"),Ii=n(" of tokenizer also becomes 50400."),Gr=l(),$t=a("h3"),Kt=a("a"),Rs=a("span"),k(Mo.$$.fragment),Li=l(),Vs=a("span"),Si=n("Generation"),jr=l(),Xt=a("p"),Ni=n("The "),ds=a("a"),Di=n("generate()"),Oi=n(` method can be used to generate text using GPT-J
model.`),Er=l(),k(xo.$$.fragment),Jr=l(),cs=a("p"),Bi=n("\u2026or in float16 precision:"),Mr=l(),k(zo.$$.fragment),xr=l(),Ft=a("h2"),Yt=a("a"),Ks=a("span"),k(qo.$$.fragment),Wi=l(),Xs=a("span"),Qi=n("GPTJConfig"),zr=l(),Ye=a("div"),k(Co.$$.fragment),Ui=l(),Ze=a("p"),Hi=n("This is the configuration class to store the configuration of a "),ps=a("a"),Ri=n("GPTJModel"),Vi=n(`. It is used to instantiate a GPT-J
...
for more information.`),ol=l(),Ys=a("p"),nl=n("Example:"),sl=l(),k(Io.$$.fragment),qr=l(),Gt=a("h2"),Zt=a("a"),Zs=a("span"),k(Lo.$$.fragment),al=l(),ea=a("span"),rl=n("GPTJModel"),Cr=l(),dt=a("div"),k(So.$$.fragment),il=l(),No=a("p"),ll=n(`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Jl=l(),Se=a("div"),k(Ro.$$.fragment),Ml=l(),Jt=a("p"),xl=n("The "),ms=a("a"),zl=n("GPTJForCausalLM"),ql=n(" forward method, overrides the "),ra=a("code"),Cl=n("__call__"),Al=n(" special method."),Il=l(),k(oo.$$.fragment),Ll=l(),ia=a("p"),Sl=n("Example:"),Nl=l(),k(Vo.$$.fragment),Lr=l(),Mt=a("h2"),no=a("a"),la=a("span"),k(Ko.$$.fragment),Dl=l(),da=a("span"),Ol=n("GPTJForSequenceClassification"),Sr=l(),$e=a("div"),k(Xo.$$.fragment),Bl=l(),ca=a("p"),Wl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Ql=l(),gs=a("p"),_s=a("a"),Ul=n("GPTJForSequenceClassification"),Hl=n(` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ld=l(),be=a("div"),k(en.$$.fragment),dd=l(),xt=a("p"),cd=n("The "),Ts=a("a"),pd=n("GPTJForSequenceClassification"),hd=n(" forward method, overrides the "),ma=a("code"),ud=n("__call__"),fd=n(" special method."),md=l(),k(so.$$.fragment),gd=l(),ga=a("p"),_d=n("Example of single-label classification:"),Td=l(),k(tn.$$.fragment),vd=l(),_a=a("p"),kd=n("Example of multi-label classification:"),wd=l(),k(on.$$.fragment),Nr=l(),zt=a("h2"),ao=a("a"),Ta=a("span"),k(nn.$$.fragment),yd=l(),va=a("span"),bd=n("GPTJForQuestionAnswering"),Dr=l(),ot=a("div"),k(sn.$$.fragment),Pd=l(),qt=a("p"),$d=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),ka=a("code"),Fd=n("span start logits"),Gd=n(" and "),wa=a("code"),jd=n("span end logits"),Ed=n(")."),Jd=l(),an=a("p"),Md=n("This model is a PyTorch "),rn=a("a"),xd=n("torch.nn.Module"),zd=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qd=l(),Ne=a("div"),k(ln.$$.fragment),Cd=l(),Ct=a("p"),Ad=n("The "),vs=a("a"),Id=n("GPTJForQuestionAnswering"),Ld=n(" forward method, overrides the "),ya=a("code"),Sd=n("__call__"),Nd=n(" special method."),Dd=l(),k(ro.$$.fragment),Od=l(),ba=a("p"),Bd=n("Example:"),Wd=l(),k(dn.$$.fragment),Or=l(),At=a("h2"),io=a("a"),Pa=a("span"),k(cn.$$.fragment),Qd=l(),$a=a("span"),Ud=n("TFGPTJModel"),Br=l(),Fe=a("div"),k(pn.$$.fragment),Hd=l(),Fa=a("p"),Rd=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Vd=l(),hn=a("p"),Kd=n("This model inherits from "),ks=a("a"),Xd=n("TFPreTrainedModel"),Yd=n(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gc=l(),k(ho.$$.fragment),jc=l(),Oe=a("div"),k(yn.$$.fragment),Ec=l(),St=a("p"),Jc=n("The "),bs=a("a"),Mc=n("TFGPTJForCausalLM"),xc=n(" forward method, overrides the "),xa=a("code"),zc=n("__call__"),qc=n(" special method."),Cc=l(),k(uo.$$.fragment),Ac=l(),za=a("p"),Ic=n("Example:"),Lc=l(),k(bn.$$.fragment),Ur=l(),Nt=a("h2"),fo=a("a"),qa=a("span"),k(Pn.$$.fragment),Sc=l(),Ca=a("span"),Nc=n("TFGPTJForSequenceClassification"),Hr=l(),se=a("div"),k($n.$$.fragment),Dc=l(),Aa=a("p"),Oc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Bc=l(),Ps=a("p"),$s=a("a"),Wc=n("GPTJForSequenceClassification"),Qc=n(` uses the last token in order to do the classification, as other causal models
...
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=a("code"),Fp=n("span start logits"),Gp=n(" and "),Ua=a("code"),jp=n("span end logits"),Ep=n(")."),Jp=l(),zn=a("p"),Mp=n("This model inherits from "),js=a("a"),xp=n("TFPreTrainedModel"),zp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qp=l(),qn=a("p"),Cp=n("This model is also a "),Cn=a("a"),Ap=n("tf.keras.Model"),Ip=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
causal language model trained on `),M=r(Vt,"A",{href:!0,rel:!0});var Pr=i(M);fe=s(Pr,"the Pile"),Pr.forEach(t),U=s(Vt," dataset."),Vt.forEach(t),ie=d(o),Y=r(o,"P",{});var ls=i(Y);H=s(ls,"This model was contributed by "),oe=r(ls,"A",{href:!0,rel:!0});var $r=i(oe);me=s($r,"Stella Biderman"),$r.forEach(t),x=s(ls,"."),ls.forEach(t),le=d(o),S=r(o,"P",{});var Fr=i(S);ge=s(Fr,"Tips:"),Fr.forEach(t),de=d(o),N=r(o,"UL",{});var pu=i(N);W=r(pu,"LI",{});var ht=i(W);_e=s(ht,"To load "),z=r(ht,"A",{href:!0,rel:!0});var hu=i(z);Te=s(hu,"GPT-J"),hu.forEach(t),R=s(ht,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
...
usage to 1x. There is also a `),q=r(ht,"A",{href:!0,rel:!0});var mu=i(q);ze=s(mu,"fp16 branch"),mu.forEach(t),qe=s(ht,` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
...
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=r(Ds,"CODE",{});var tm=i(Qa);Fp=s(tm,"span start logits"),tm.forEach(t),Gp=s(Ds," and "),Ua=r(Ds,"CODE",{});var om=i(Ua);jp=s(om,"span end logits"),om.forEach(t),Ep=s(Ds,")."),Ds.forEach(t),Jp=d(it),zn=r(it,"P",{});var bi=i(zn);Mp=s(bi,"This model inherits from "),js=r(bi,"A",{href:!0});var nm=i(js);xp=s(nm,"TFPreTrainedModel"),nm.forEach(t),zp=s(bi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bi.forEach(t),qp=d(it),qn=r(it,"P",{});var Pi=i(qn);Cp=s(Pi,"This model is also a "),Cn=r(Pi,"A",{href:!0,rel:!0});var sm=i(Cn);Ap=s(sm,"tf.keras.Model"),sm.forEach(t),Ip=s(Pi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
