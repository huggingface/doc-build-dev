import{S as pi,i as hi,s as ui,e as o,k as d,w as m,t as a,M as mi,c as s,d as n,m as c,a as r,x as f,h as i,b as l,F as e,g as h,y as g,q as _,o as k,B as v,v as fi}from"../../chunks/vendor-6b77c823.js";import{T as ci}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-abef54e3.js";import{C as Xr}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as it}from"../../chunks/IconCopyLink-7a11ce68.js";function gi(lt){let u,I,w,S,x;return{c(){u=o("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),w=o("code"),S=a("Module"),x=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){u=s(b,"P",{});var T=r(u);I=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),w=s(T,"CODE",{});var O=r(w);S=i(O,"Module"),O.forEach(n),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(n)},m(b,T){h(b,u,T),e(u,I),e(u,w),e(w,S),e(u,x)},d(b){b&&n(u)}}}function _i(lt){let u,I,w,S,x;return{c(){u=o("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),w=o("code"),S=a("Module"),x=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){u=s(b,"P",{});var T=r(u);I=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),w=s(T,"CODE",{});var O=r(w);S=i(O,"Module"),O.forEach(n),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(n)},m(b,T){h(b,u,T),e(u,I),e(u,w),e(w,S),e(u,x)},d(b){b&&n(u)}}}function ki(lt){let u,I,w,S,x,b,T,O,oo,wn,J,se,Dt,we,so,Ot,ro,bn,re,ao,be,io,lo,yn,dt,co,Tn,ct,po,Sn,pt,ho,zn,C,ye,uo,ht,mo,fo,go,N,_o,ut,ko,vo,mt,wo,bo,Nt,yo,To,So,Te,zo,jt,qo,$o,Eo,A,xo,Qt,Ao,Po,Wt,Mo,Fo,Bt,Io,Co,Ut,Lo,Do,qn,L,Oo,Se,No,jo,ze,Qo,Wo,qe,Bo,Uo,$n,K,ae,Ht,$e,Ho,Vt,Vo,En,z,Ee,Jo,R,Ko,ft,Ro,Go,xe,Xo,Yo,Zo,G,es,gt,ts,ns,_t,os,ss,rs,Jt,as,is,Ae,xn,X,ie,Kt,Pe,ls,Rt,ds,An,y,Me,cs,Gt,ps,hs,Fe,us,kt,ms,fs,gs,j,Ie,_s,Xt,ks,vs,Ce,vt,ws,Yt,bs,ys,wt,Ts,Zt,Ss,zs,le,Le,qs,De,$s,en,Es,xs,As,Q,Oe,Ps,bt,Ms,yt,Fs,Is,tn,Cs,Ls,Tt,Ne,Pn,Y,de,nn,je,Ds,on,Os,Mn,P,Qe,Ns,We,js,sn,Qs,Ws,Bs,Be,Us,St,Hs,Vs,Js,W,Ue,Ks,rn,Rs,Gs,He,zt,Xs,an,Ys,Zs,qt,er,ln,tr,Fn,Z,ce,dn,Ve,nr,cn,or,In,M,Je,sr,Ke,rr,Re,ar,ir,lr,Ge,dr,Xe,cr,pr,hr,q,Ye,ur,ee,mr,$t,fr,gr,pn,_r,kr,vr,pe,wr,hn,br,yr,Ze,Cn,te,he,un,et,Tr,mn,Sr,Ln,F,tt,zr,ne,qr,fn,$r,Er,gn,xr,Ar,Pr,nt,Mr,ot,Fr,Ir,Cr,$,st,Lr,oe,Dr,Et,Or,Nr,_n,jr,Qr,Wr,ue,Br,kn,Ur,Hr,rt,Dn;return b=new it({}),we=new it({}),$e=new it({}),Ee=new D({props:{name:"class transformers.SplinterConfig",anchor:"transformers.SplinterConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 0"},{name:"question_token_id",val:" = 104"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/configuration_splinter.py#L32",parametersDescription:[{anchor:"transformers.SplinterConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the Splinter model. Defines the number of different tokens that can be represented by
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16264/en/model_doc/splinter#transformers.SplinterModel">SplinterModel</a>.`,name:"vocab_size"},{anchor:"transformers.SplinterConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Oe=new D({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/tokenization_splinter.py#L278",parametersDescription:[{anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:"<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014; The first tokenized sequence.",name:"token_ids_0"},{anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences.token_ids_1",description:"<strong>token_ids_1</strong> (<code>List[int]</code>, <em>optional</em>) &#x2014; The second tokenized sequence.",name:"token_ids_1"}],returnDescription:`
<p>The token type ids.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ne=new D({props:{name:"save_vocabulary",anchor:"transformers.SplinterTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/tokenization_splinter.py#L307"}}),je=new it({}),Qe=new D({props:{name:"class transformers.SplinterTokenizerFast",anchor:"transformers.SplinterTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"question_token",val:" = '[QUESTION]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/tokenization_splinter_fast.py#L55",parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
The prefix for subwords.`,name:"tokenize_chinese_chars"}]}}),Ue=new D({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.SplinterTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/tokenization_splinter_fast.py#L153",parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ve=new it({}),Je=new D({props:{name:"class transformers.SplinterModel",anchor:"transformers.SplinterModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/modeling_splinter.py#L611",parametersDescription:[{anchor:"transformers.SplinterModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16264/en/model_doc/splinter#transformers.SplinterConfig">SplinterConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16264/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ye=new D({props:{name:"forward",anchor:"transformers.SplinterModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16264/src/transformers/models/splinter/modeling_splinter.py#L642",parametersDescription:[{anchor:"transformers.SplinterModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16264/en/model_doc/splinter#transformers.SplinterTokenizer">SplinterTokenizer</a>. See <a href="/docs/transformers/pr_16264/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16264/en/model_doc/splinter#transformers.SplinterConfig"
...
`}}),ue=new ci({props:{$$slots:{default:[_i]},$$scope:{ctx:lt}}}),rt=new Xr({props:{code:`from transformers import SplinterTokenizer, SplinterForQuestionAnswering
import torch
...
`}}),{c(){u=o("meta"),I=d(),w=o("h1"),S=o("a"),x=o("span"),m(b.$$.fragment),T=d(),O=o("span"),oo=a("Splinter"),wn=d(),J=o("h2"),se=o("a"),Dt=o("span"),m(we.$$.fragment),so=d(),Ot=o("span"),ro=a("Overview"),bn=d(),re=o("p"),ao=a("The Splinter model was proposed in "),be=o("a"),io=a("Few-Shot Question Answering by Pretraining Span Selection"),lo=a(` by Ori Ram, Yuval Kirstain, Jonathan Berant, Amir Globerson, Omer Levy. Splinter
...
with only 128 training examples), while maintaining competitive performance in the high-resource setting.`),Sn=d(),pt=o("p"),ho=a("Tips:"),zn=d(),C=o("ul"),ye=o("li"),uo=a(`Splinter was trained to predict answers spans conditioned on a special [QUESTION] token. These tokens contextualize
to question representations which are used to predict the answers. This layer is called QASS, and is the default
behaviour in the `),ht=o("a"),mo=a("SplinterForQuestionAnswering"),fo=a(" class. Therefore:"),go=d(),N=o("li"),_o=a("Use "),ut=o("a"),ko=a("SplinterTokenizer"),vo=a(" (rather than "),mt=o("a"),wo=a("BertTokenizer"),bo=a(`), as it already
...
documentation from `),_t=o("a"),os=a("PretrainedConfig"),ss=a(" for more information."),rs=d(),Jt=o("p"),as=a("Example:"),is=d(),m(Ae.$$.fragment),xn=d(),X=o("h2"),ie=o("a"),Kt=o("span"),m(Pe.$$.fragment),ls=d(),Rt=o("span"),ds=a("SplinterTokenizer"),An=d(),y=o("div"),m(Me.$$.fragment),cs=d(),Gt=o("p"),ps=a("Construct a Splinter tokenizer. Based on WordPiece."),hs=d(),Fe=o("p"),us=a("This tokenizer inherits from "),kt=o("a"),ms=a("PreTrainedTokenizer"),fs=a(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),gs=d(),j=o("div"),m(Ie.$$.fragment),_s=d(),Xt=o("p"),ks=a(`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
tokens. A Splinter sequence has the following format:`),vs=d(),Ce=o("ul"),vt=o("li"),ws=a("single sequence: "),Yt=o("code"),bs=a("[CLS] X [SEP]"),ys=d(),wt=o("li"),Ts=a("pair of sequences for question answering: "),Zt=o("code"),Ss=a("[CLS] question_tokens [QUESTION] . [SEP] context_tokens [SEP]"),zs=d(),le=o("div"),m(Le.$$.fragment),qs=d(),De=o("p"),$s=a(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),en=o("code"),Es=a("prepare_for_model"),xs=a(" method."),As=d(),Q=o("div"),m(Oe.$$.fragment),Ps=d(),bt=o("p"),Ms=a("Create the token type IDs corresponding to the sequences passed. "),yt=o("a"),Fs=a(`What are token type
IDs?`),Is=d(),tn=o("p"),Cs=a("Should be overridden in a subclass if the model has a special way of building those."),Ls=d(),Tt=o("div"),m(Ne.$$.fragment),Pn=d(),Y=o("h2"),de=o("a"),nn=o("span"),m(je.$$.fragment),Ds=d(),on=o("span"),Os=a("SplinterTokenizerFast"),Mn=d(),P=o("div"),m(Qe.$$.fragment),Ns=d(),We=o("p"),js=a("Construct a \u201Cfast\u201D Splinter tokenizer (backed by HuggingFace\u2019s "),sn=o("em"),Qs=a("tokenizers"),Ws=a(" library). Based on WordPiece."),Bs=d(),Be=o("p"),Us=a("This tokenizer inherits from "),St=o("a"),Hs=a("PreTrainedTokenizerFast"),Vs=a(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Js=d(),W=o("div"),m(Ue.$$.fragment),Ks=d(),rn=o("p"),Rs=a(`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
tokens. A Splinter sequence has the following format:`),Gs=d(),He=o("ul"),zt=o("li"),Xs=a("single sequence: "),an=o("code"),Ys=a("[CLS] X [SEP]"),Zs=d(),qt=o("li"),er=a("pair of sequences for question answering: "),ln=o("code"),tr=a("[CLS] question_tokens [QUESTION] . [SEP] context_tokens [SEP]"),Fn=d(),Z=o("h2"),ce=o("a"),dn=o("span"),m(Ve.$$.fragment),nr=d(),cn=o("span"),or=a("SplinterModel"),In=d(),M=o("div"),m(Je.$$.fragment),sr=d(),Ke=o("p"),rr=a(`The bare Splinter Model transformer outputting raw hidden-states without any specific head on top.
...
Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),hr=d(),q=o("div"),m(Ye.$$.fragment),ur=d(),ee=o("p"),mr=a("The "),$t=o("a"),fr=a("SplinterModel"),gr=a(" forward method, overrides the "),pn=o("code"),_r=a("__call__"),kr=a(" special method."),vr=d(),m(pe.$$.fragment),wr=d(),hn=o("p"),br=a("Example:"),yr=d(),m(Ze.$$.fragment),Cn=d(),te=o("h2"),he=o("a"),un=o("span"),m(et.$$.fragment),Tr=d(),mn=o("span"),Sr=a("SplinterForQuestionAnswering"),Ln=d(),F=o("div"),m(tt.$$.fragment),zr=d(),ne=o("p"),qr=a(`Splinter Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
are replaced with a special token, viewed as a question representation, that is later used during fine-tuning to select
the answer span. The resulting model obtains surprisingly good results on multiple benchmarks (e.g., 72.7 F1 on SQuAD
with only 128 training examples), while maintaining competitive performance in the high-resource setting.`),ra.forEach(n),Sn=c(t),pt=s(t,"P",{});var aa=r(pt);ho=i(aa,"Tips:"),aa.forEach(n),zn=c(t),C=s(t,"UL",{});var me=r(C);ye=s(me,"LI",{});var jn=r(ye);uo=i(jn,`Splinter was trained to predict answers spans conditioned on a special [QUESTION] token. These tokens contextualize
to question representations which are used to predict the answers. This layer is called QASS, and is the default
behaviour in the `),ht=s(jn,"A",{href:!0});var ia=r(ht);mo=i(ia,"SplinterForQuestionAnswering"),ia.forEach(n),fo=i(jn," class. Therefore:"),jn.forEach(n),go=c(me),N=s(me,"LI",{});var fe=r(N);_o=i(fe,"Use "),ut=s(fe,"A",{href:!0});var la=r(ut);ko=i(la,"SplinterTokenizer"),la.forEach(n),vo=i(fe," (rather than "),mt=s(fe,"A",{href:!0});var da=r(mt);wo=i(da,"BertTokenizer"),da.forEach(n),bo=i(fe,`), as it already
contains this special token. Also, its default behavior is to use this token when two sequences are given (for
example, in the `),Nt=s(fe,"EM",{});var ca=r(Nt);yo=i(ca,"run_qa.py"),ca.forEach(n),To=i(fe," script)."),fe.forEach(n),So=c(me),Te=s(me,"LI",{});var Qn=r(Te);zo=i(Qn,"If you plan on using Splinter outside "),jt=s(Qn,"EM",{});var pa=r(jt);qo=i(pa,"run_qa.py"),pa.forEach(n),$o=i(Qn,`, please keep in mind the question token - it might be important for
the success of your model, especially in a few-shot setting.`),Qn.forEach(n),Eo=c(me),A=s(me,"LI",{});var B=r(A);xo=i(B,`Please note there are two different checkpoints for each size of Splinter. Both are basically the same, except that
one also has the pretrained wights of the QASS layer (`),Qt=s(B,"EM",{});var ha=r(Qt);Ao=i(ha,"tau/splinter-base-qass"),ha.forEach(n),Po=i(B," and "),Wt=s(B,"EM",{});var ua=r(Wt);Mo=i(ua,"tau/splinter-large-qass"),ua.forEach(n),Fo=i(B,`) and one
doesn\u2019t (`),Bt=s(B,"EM",{});var ma=r(Bt);Io=i(ma,"tau/splinter-base"),ma.forEach(n),Co=i(B," and "),Ut=s(B,"EM",{});var fa=r(Ut);Lo=i(fa,"tau/splinter-large"),fa.forEach(n),Do=i(B,`). This is done to support randomly initializing this layer at
fine-tuning, as it is shown to yield better results for some cases in the paper.`),B.forEach(n),me.forEach(n),qn=c(t),L=s(t,"P",{});var ge=r(L);Oo=i(ge,"This model was contributed by "),Se=s(ge,"A",{href:!0,rel:!0});var ga=r(Se);No=i(ga,"yuvalkirstain"),ga.forEach(n),jo=i(ge," and "),ze=s(ge,"A",{href:!0,rel:!0});var _a=r(ze);Qo=i(_a,"oriram"),_a.forEach(n),Wo=i(ge,". The original code can be found "),qe=s(ge,"A",{href:!0,rel:!0});var ka=r(qe);Bo=i(ka,"here"),ka.forEach(n),Uo=i(ge,"."),ge.forEach(n),$n=c(t),K=s(t,"H2",{class:!0});var Wn=r(K);ae=s(Wn,"A",{id:!0,class:!0,href:!0});var va=r(ae);Ht=s(va,"SPAN",{});var wa=r(Ht);f($e.$$.fragment,wa),wa.forEach(n),va.forEach(n),Ho=c(Wn),Vt=s(Wn,"SPAN",{});var ba=r(Vt);Vo=i(ba,"SplinterConfig"),ba.forEach(n),Wn.forEach(n),En=c(t),z=s(t,"DIV",{class:!0});var U=r(z);f(Ee.$$.fragment,U),Jo=c(U),R=s(U,"P",{});var xt=r(R);Ko=i(xt,"This is the configuration class to store the configuration of a "),ft=s(xt,"A",{href:!0});var ya=r(ft);Ro=i(ya,"SplinterModel"),ya.forEach(n),Go=i(xt,`. It is used to instantiate an
Splinter model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Splinter
