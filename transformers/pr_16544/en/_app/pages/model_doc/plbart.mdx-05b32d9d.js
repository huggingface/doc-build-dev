...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var j=a(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var j=a(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function sl(me){let u,B,v,L,z,T,y,j,ts,sn,O,io,os,ns,je,ss,as,Fe,rs,is,an,Y,fe,lo,Ee,ds,co,ls,rn,W,cs,Me,ps,hs,po,us,ms,dn,Mt,fs,ln,St,ho,gs,cn,G,_s,Se,bs,ks,Ae,vs,Ts,pn,Z,ge,uo,Ne,ys,mo,ws,hn,F,Ps,fo,Ls,qs,go,zs,Bs,_o,$s,xs,bo,Cs,js,un,_e,Fs,Ie,Es,Ms,mn,R,Ss,Oe,ko,As,Ns,Is,At,Os,Ds,fn,Nt,vo,Xs,gn,De,_n,It,Xe,To,Ws,Gs,ee,Rs,yo,Hs,Us,wo,Vs,Js,bn,We,kn,te,be,Po,Ge,Ks,Lo,Qs,vn,x,Re,Ys,oe,Zs,Ot,ea,ta,He,oa,na,sa,ne,aa,Dt,ra,ia,Xt,da,la,ca,qo,pa,ha,Ue,Tn,se,ke,zo,Ve,ua,Bo,ma,yn,P,Je,fa,$o,ga,_a,D,ba,Wt,ka,va,Gt,Ta,ya,Ke,wa,Pa,La,Qe,qa,xo,za,Ba,$a,Co,xa,Ca,Ye,ja,ve,Ze,Fa,jo,Ea,Ma,N,et,Sa,tt,Aa,Fo,Na,Ia,Oa,ot,nt,Eo,Da,Xa,Mo,Wa,Ga,st,So,Ra,Ha,Ao,Ua,Va,No,Ja,wn,ae,Te,Io,at,Ka,Oo,Qa,Pn,S,rt,Ya,it,Za,Rt,er,tr,or,dt,nr,lt,sr,ar,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,ye,mr,Xo,fr,gr,pt,Ln,ie,we,Wo,ht,_r,Go,br,qn,A,ut,kr,mt,vr,Ut,Tr,yr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Cr,Ro,jr,Fr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Ir,Bn,C,vt,Or,Jo,Dr,Xr,Tt,Wr,Jt,Gr,Rr,Hr,yt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,si,Qo,ai,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ct,fi,tn,gi,_i,jt,Cn;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
`}}),at=new ue({}),rt=new I({props:{name:"class transformers.PLBartModel",anchor:"transformers.PLBartModel",parameters:[{name:"config",val:": PLBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16544/src/transformers/models/plbart/modeling_plbart.py#L1110",parametersDescription:[{anchor:"transformers.PLBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16544/en/model_doc/plbart#transformers.PLBartConfig">PLBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16544/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ct=new I({props:{name:"forward",anchor:"transformers.PLBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16544/src/transformers/models/plbart/modeling_plbart.py#L1136",parametersDescription:[{anchor:"transformers.PLBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16544/en/model_doc/plbart#transformers.PLBartTokenizer">PLBartTokenizer</a> or <code>PLBartMultiTokenizer</code> depending on the checkpoint.
See <a href="/docs/transformers/pr_16544/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16544/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16544/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16544/en/model_doc/plbart#transformers.PLBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16544/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16544/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(T.$$.fragment),y=l(),j=n("span"),ts=r("PLBart"),sn=l(),O=n("p"),io=n("strong"),os=r("DISCLAIMER:"),ns=r(" If you see something strange, file a "),je=n("a"),ss=r("Github Issue"),as=r(` and assign
...
target text format is `),_o=n("code"),$s=r("[tgt_lang_code] X [eos]"),xs=r(". "),bo=n("code"),Cs=r("bos"),js=r(" is never used."),un=l(),_e=n("p"),Fs=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=n("a"),Es=r("the paper"),Ms=r(" to learn more about this."),mn=l(),R=n("p"),Ss=r("In cases where the language code is needed, The regular "),Oe=n("a"),ko=n("strong"),As=r("call"),Ns=r("()"),Is=r(` will encode source text format, and it should be wrapped
inside the context manager `),At=n("a"),Os=r("as_target_tokenizer()"),Ds=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xs=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),It=n("ul"),Xe=n("li"),To=n("p"),Ws=r("Generation"),Gs=l(),ee=n("p"),Rs=r("While generating the target text set the "),yo=n("code"),Hs=r("decoder_start_token_id"),Us=r(` to the target language id. The following
example shows how to translate Python to English using the `),wo=n("code"),Vs=r("uclanlp/plbart-python-en_XX"),Js=r(" model."),bn=l(),m(We.$$.fragment),kn=l(),te=n("h2"),be=n("a"),Po=n("span"),m(Ge.$$.fragment),Ks=l(),Lo=n("span"),Qs=r("PLBartConfig"),vn=l(),x=n("div"),m(Re.$$.fragment),Ys=l(),oe=n("p"),Zs=r("This is the configuration class to store the configuration of a "),Ot=n("a"),ea=r("PLBartModel"),ta=r(`. It is used to instantiate an
...
documentation from `),Xt=n("a"),da=r("PretrainedConfig"),la=r(" for more information."),ca=l(),qo=n("p"),pa=r("Example:"),ha=l(),m(Ue.$$.fragment),Tn=l(),se=n("h2"),ke=n("a"),zo=n("span"),m(Ve.$$.fragment),ua=l(),Bo=n("span"),ma=r("PLBartTokenizer"),yn=l(),P=n("div"),m(Je.$$.fragment),fa=l(),$o=n("p"),ga=r("Construct an PLBART tokenizer."),_a=l(),D=n("p"),ba=r("Adapted from "),Wt=n("a"),ka=r("RobertaTokenizer"),va=r(" and "),Gt=n("a"),Ta=r("XLNetTokenizer"),ya=r(`. Based on
...
adding special tokens. An PLBART sequence has the following format, where `),Fo=n("code"),Na=r("X"),Ia=r(" represents the sequence:"),Oa=l(),ot=n("ul"),nt=n("li"),Eo=n("code"),Da=r("input_ids"),Xa=r(" (for encoder) "),Mo=n("code"),Wa=r("X [eos, src_lang_code]"),Ga=l(),st=n("li"),So=n("code"),Ra=r("decoder_input_ids"),Ha=r(": (for decoder) "),Ao=n("code"),Ua=r("X [eos, tgt_lang_code]"),Va=l(),No=n("p"),Ja=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
target text format is `),_o=s(U,"CODE",{});var Ii=a(_o);$s=i(Ii,"[tgt_lang_code] X [eos]"),Ii.forEach(o),xs=i(U,". "),bo=s(U,"CODE",{});var Oi=a(bo);Cs=i(Oi,"bos"),Oi.forEach(o),js=i(U," is never used."),U.forEach(o),un=c(t),_e=s(t,"P",{});var En=a(_e);Fs=i(En,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=s(En,"A",{href:!0,rel:!0});var Di=a(Ie);Es=i(Di,"the paper"),Di.forEach(o),Ms=i(En," to learn more about this."),En.forEach(o),mn=c(t),R=s(t,"P",{});var Zt=a(R);Ss=i(Zt,"In cases where the language code is needed, The regular "),Oe=s(Zt,"A",{href:!0});var bi=a(Oe);ko=s(bi,"STRONG",{});var Xi=a(ko);As=i(Xi,"call"),Xi.forEach(o),Ns=i(bi,"()"),bi.forEach(o),Is=i(Zt,` will encode source text format, and it should be wrapped
inside the context manager `),At=s(Zt,"A",{href:!0});var Wi=a(At);Os=i(Wi,"as_target_tokenizer()"),Wi.forEach(o),Ds=i(Zt," to encode target text format."),Zt.forEach(o),fn=c(t),Nt=s(t,"UL",{});var Gi=a(Nt);vo=s(Gi,"LI",{});var Ri=a(vo);Xs=i(Ri,"Supervised training"),Ri.forEach(o),Gi.forEach(o),gn=c(t),f(De.$$.fragment,t),_n=c(t),It=s(t,"UL",{});var Hi=a(It);Xe=s(Hi,"LI",{});var Mn=a(Xe);To=s(Mn,"P",{});var Ui=a(To);Ws=i(Ui,"Generation"),Ui.forEach(o),Gs=c(Mn),ee=s(Mn,"P",{});var eo=a(ee);Rs=i(eo,"While generating the target text set the "),yo=s(eo,"CODE",{});var Vi=a(yo);Hs=i(Vi,"decoder_start_token_id"),Vi.forEach(o),Us=i(eo,` to the target language id. The following
example shows how to translate Python to English using the `),wo=s(eo,"CODE",{});var Ji=a(wo);Vs=i(Ji,"uclanlp/plbart-python-en_XX"),Ji.forEach(o),Js=i(eo," model."),eo.forEach(o),Mn.forEach(o),Hi.forEach(o),bn=c(t),f(We.$$.fragment,t),kn=c(t),te=s(t,"H2",{class:!0});var Sn=a(te);be=s(Sn,"A",{id:!0,class:!0,href:!0});var Ki=a(be);Po=s(Ki,"SPAN",{});var Qi=a(Po);f(Ge.$$.fragment,Qi),Qi.forEach(o),Ki.forEach(o),Ks=c(Sn),Lo=s(Sn,"SPAN",{});var Yi=a(Lo);Qs=i(Yi,"PLBartConfig"),Yi.forEach(o),Sn.forEach(o),vn=c(t),x=s(t,"DIV",{class:!0});var V=a(x);f(Re.$$.fragment,V),Ys=c(V),oe=s(V,"P",{});var to=a(oe);Zs=i(to,"This is the configuration class to store the configuration of a "),Ot=s(to,"A",{href:!0});var Zi=a(Ot);ea=i(Zi,"PLBartModel"),Zi.forEach(o),ta=i(to,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
documentation from `),Xt=s(oo,"A",{href:!0});var od=a(Xt);da=i(od,"PretrainedConfig"),od.forEach(o),la=i(oo," for more information."),oo.forEach(o),ca=c(V),qo=s(V,"P",{});var nd=a(qo);pa=i(nd,"Example:"),nd.forEach(o),ha=c(V),f(Ue.$$.fragment,V),V.forEach(o),Tn=c(t),se=s(t,"H2",{class:!0});var An=a(se);ke=s(An,"A",{id:!0,class:!0,href:!0});var sd=a(ke);zo=s(sd,"SPAN",{});var ad=a(zo);f(Ve.$$.fragment,ad),ad.forEach(o),sd.forEach(o),ua=c(An),Bo=s(An,"SPAN",{});var rd=a(Bo);ma=i(rd,"PLBartTokenizer"),rd.forEach(o),An.forEach(o),yn=c(t),P=s(t,"DIV",{class:!0});var $=a(P);f(Je.$$.fragment,$),fa=c($),$o=s($,"P",{});var id=a($o);ga=i(id,"Construct an PLBART tokenizer."),id.forEach(o),_a=c($),D=s($,"P",{});var Be=a(D);ba=i(Be,"Adapted from "),Wt=s(Be,"A",{href:!0});var dd=a(Wt);ka=i(dd,"RobertaTokenizer"),dd.forEach(o),va=i(Be," and "),Gt=s(Be,"A",{href:!0});var ld=a(Gt);Ta=i(ld,"XLNetTokenizer"),ld.forEach(o),ya=i(Be,`. Based on
...
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),ae=s(t,"H2",{class:!0});var Gn=a(ae);Te=s(Gn,"A",{id:!0,class:!0,href:!0});var vd=a(Te);Io=s(vd,"SPAN",{});var Td=a(Io);f(at.$$.fragment,Td),Td.forEach(o),vd.forEach(o),Ka=c(Gn),Oo=s(Gn,"SPAN",{});var yd=a(Oo);Qa=i(yd,"PLBartModel"),yd.forEach(o),Gn.forEach(o),Pn=c(t),S=s(t,"DIV",{class:!0});var xe=a(S);f(rt.$$.fragment,xe),Ya=c(xe),it=s(xe,"P",{});var Rn=a(it);Za=i(Rn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hn.forEach(o),rr=c(xe),E=s(xe,"DIV",{class:!0});var J=a(E);f(ct.$$.fragment,J),ir=c(J),re=s(J,"P",{});var no=a(re);dr=i(no,"The "),Ht=s(no,"A",{href:!0});var Ld=a(Ht);lr=i(Ld,"PLBartModel"),Ld.forEach(o),cr=i(no," forward method, overrides the "),Do=s(no,"CODE",{});var qd=a(Do);pr=i(qd,"__call__"),qd.forEach(o),hr=i(no," special method."),no.forEach(o),ur=c(J),f(ye.$$.fragment,J),mr=c(J),Xo=s(J,"P",{});var zd=a(Xo);fr=i(zd,"Example:"),zd.forEach(o),gr=c(J),f(pt.$$.fragment,J),J.forEach(o),xe.forEach(o),Ln=c(t),ie=s(t,"H2",{class:!0});var Un=a(ie);we=s(Un,"A",{id:!0,class:!0,href:!0});var Bd=a(we);Wo=s(Bd,"SPAN",{});var $d=a(Wo);f(ht.$$.fragment,$d),$d.forEach(o),Bd.forEach(o),_r=c(Un),Go=s(Un,"SPAN",{});var xd=a(Go);br=i(xd,"PLBartForConditionalGeneration"),xd.forEach(o),Un.forEach(o),qn=c(t),A=s(t,"DIV",{class:!0});var Ce=a(A);f(ut.$$.fragment,Ce),kr=c(Ce),mt=s(Ce,"P",{});var Vn=a(mt);vr=i(Vn,`The PLBART Model with a language modeling head. Can be used for code-to-text, text-to-code and code-to-code.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vn.forEach(o),wr=c(Ce),ft=s(Ce,"P",{});var Jn=a(ft);Pr=i(Jn,"This model is also a PyTorch "),gt=s(Jn,"A",{href:!0,rel:!0});var jd=a(gt);Lr=i(jd,"torch.nn.Module"),jd.forEach(o),qr=i(Jn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jn.forEach(o),zr=c(Ce),M=s(Ce,"DIV",{class:!0});var K=a(M);f(_t.$$.fragment,K),Br=c(K),de=s(K,"P",{});var so=a(de);$r=i(so,"The "),Vt=s(so,"A",{href:!0});var Fd=a(Vt);xr=i(Fd,"PLBartForConditionalGeneration"),Fd.forEach(o),Cr=i(so," forward method, overrides the "),Ro=s(so,"CODE",{});var Ed=a(Ro);jr=i(Ed,"__call__"),Ed.forEach(o),Fr=i(so," special method."),so.forEach(o),Er=c(K),f(Pe.$$.fragment,K),Mr=c(K),Ho=s(K,"P",{});var Md=a(Ho);Sr=i(Md,"Mask-filling example:"),Md.forEach(o),Ar=c(K),f(bt.$$.fragment,K),K.forEach(o),Ce.forEach(o),zn=c(t),le=s(t,"H2",{class:!0});var Kn=a(le);Le=s(Kn,"A",{id:!0,class:!0,href:!0});var Sd=a(Le);Uo=s(Sd,"SPAN",{});var Ad=a(Uo);f(kt.$$.fragment,Ad),Ad.forEach(o),Sd.forEach(o),Nr=c(Kn),Vo=s(Kn,"SPAN",{});var Nd=a(Vo);Ir=i(Nd,"PLBartForSequenceClassification"),Nd.forEach(o),Kn.forEach(o),Bn=c(t),C=s(t,"DIV",{class:!0});var Q=a(C);f(vt.$$.fragment,Q),Or=c(Q),Jo=s(Q,"P",{});var Id=a(Jo);Dr=i(Id,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Id.forEach(o),Xr=c(Q),Tt=s(Q,"P",{});var Qn=a(Tt);Wr=i(Qn,"This model inherits from "),Jt=s(Qn,"A",{href:!0});var Od=a(Jt);Gr=i(Od,"PreTrainedModel"),Od.forEach(o),Rr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
