...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Km(E){let p,$,f,h,x,c,_,L,_e,W,D,no,ro,vs,Ts,so,ys,ws,ao,zs,xs,io,$s,Ps,qr,lo,qs,Er,ge,Le,So,st,Es,Co,Bs,Br,u,at,Ls,ke,Ds,co,Is,Ns,po,As,Fs,Ss,Oo,Cs,Os,Wo,Ws,js,I,Z,jo,Rs,Us,Ro,Ms,Vs,Uo,Gs,Hs,Xs,F,Mo,Ys,Js,Vo,Ks,Qs,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,sa,M,Yo,aa,ia,Jo,da,la,Ko,ca,pa,Qo,ma,ha,ua,S,Zo,fa,_a,en,ga,ka,tn,ba,va,on,Ta,ya,mo,wa,za,xa,De,nn,$a,Pa,rn,qa,Ea,Ba,V,sn,La,Da,an,Ia,Na,dn,Aa,Fa,ln,Sa,Ca,Oa,G,cn,Wa,ja,pn,Ra,Ua,mn,Ma,Va,hn,Ga,Ha,Xa,Ie,it,Ya,un,Ja,Ka,Ne,dt,Qa,fn,Za,ei,Ae,lt,ti,_n,oi,ni,ee,ct,ri,gn,si,ai,Fe,ii,te,pt,di,kn,li,ci,bn,pi,mi,Se,mt,hi,vn,ui,fi,Ce,ht,_i,ut,gi,Tn,ki,bi,vi,oe,ft,Ti,ho,yi,uo,wi,zi,yn,xi,$i,ne,_t,Pi,wn,qi,Ei,gt,Bi,zn,Li,Di,Ii,re,kt,Ni,xn,Ai,Fi,bt,Si,$n,Ci,Oi,Wi,se,vt,ji,Pn,Ri,Ui,Oe,Mi,H,Tt,Vi,yt,Gi,fo,Hi,Xi,Yi,We,Ji,je,Ki,Re,wt,Qi,be,Zi,qn,ed,td,En,od,nd,rd,ae,zt,sd,Bn,ad,id,ie,Ln,dd,ld,Dn,cd,pd,In,md,hd,ud,X,xt,fd,Nn,_d,gd,J,kd,An,bd,vd,Fn,Td,yd,Sn,wd,zd,xd,Ue,$d,Me,$t,Pd,j,qd,Cn,Ed,Bd,On,Ld,Dd,Wn,Id,Nd,jn,Ad,Fd,Sd,Ve,Pt,Cd,Rn,Od,Wd,de,qt,jd,Et,Rd,Un,Ud,Md,Vd,Ge,Gd,le,Bt,Hd,Lt,Xd,Mn,Yd,Jd,Kd,He,Qd,Y,Dt,Zd,Vn,el,tl,It,ol,Gn,nl,rl,sl,Nt,al,Hn,il,dl,ll,ce,At,cl,Xn,pl,ml,Ft,hl,Yn,ul,fl,_l,Xe,St,gl,Ct,kl,Jn,bl,vl,Tl,Ye,Ot,yl,Kn,wl,Lr,ve,Je,Qn,Wt,zl,Zn,xl,Dr,A,jt,$l,Te,Pl,_o,ql,El,go,Bl,Ll,Dl,B,Rt,Il,er,Nl,Al,tr,Fl,Sl,Ut,Cl,ko,Ol,Wl,jl,Mt,Rl,or,Ul,Ml,Vl,Vt,nr,Gl,Hl,Gt,Xl,rr,Yl,Jl,Kl,R,Ql,bo,Zl,ec,sr,tc,oc,ar,nc,rc,ir,sc,ac,ic,Ke,dc,C,Ht,lc,dr,cc,pc,lr,mc,hc,Xt,uc,vo,fc,_c,gc,Qe,kc,pe,Yt,bc,ye,vc,cr,Tc,yc,pr,wc,zc,xc,mr,$c,Ir,we,Ze,hr,Jt,Pc,ur,qc,Nr,ze,Kt,Ec,xe,Bc,fr,Lc,Dc,et,Ic,_r,Nc,Ac,Fc,Ar,$e,Qt,Sc,gr,Cc,Fr,Pe,Zt,Oc,kr,Wc,Sr;return c=new _s({}),st=new _s({}),at=new q({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/pr_17760/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17760/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2409",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L3283",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2632",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L3316",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2219",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2536",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
using the <a href="/docs/transformers/pr_17760/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L3361",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),zt=new q({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L1537",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),xt=new q({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17760/en/internal/file_utils#transformers.utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2936",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17760/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17760/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L3471",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/utils/hub.py#L855",returnDescription:`
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2018",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2181",returnDescription:`
...
<a href="/docs/transformers/pr_17760/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L2199",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L3072",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17760/src/transformers/tokenization_utils_base.py#L832",returnDescription:`
...
Should be `),dn=r("code"),Aa=o("'right'"),Fa=o(" or "),ln=r("code"),Sa=o("'left'"),Ca=o("."),Oa=d(),G=r("li"),cn=r("strong"),Wa=o("truncation_side"),ja=o(" ("),pn=r("code"),Ra=o("str"),Ua=o(`) \u2014 The default value for the side on which the model should have truncation
...
`),Fn=r("code"),Td=o("self.pad_token_id"),yd=o(" and "),Sn=r("code"),wd=o("self.pad_token_type_id"),zd=o(")"),xd=d(),k(Ue.$$.fragment),$d=d(),Me=r("div"),k($t.$$.fragment),Pd=d(),j=r("p"),qd=o(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
`),io=s(U,"A",{href:!0});var xr=a(io);$s=n(xr,"SpecialTokensMixin"),xr.forEach(t),Ps=n(U,"."),U.forEach(t),qr=l(i),lo=s(i,"P",{});var Rc=a(lo);qs=n(Rc,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Rc.forEach(t),Er=l(i),ge=s(i,"H2",{class:!0});var Cr=a(ge);Le=s(Cr,"A",{id:!0,class:!0,href:!0});var Uc=a(Le);So=s(Uc,"SPAN",{});var Mc=a(So);b(st.$$.fragment,Mc),Mc.forEach(t),Uc.forEach(t),Es=l(Cr),Co=s(Cr,"SPAN",{});var Vc=a(Co);Bs=n(Vc,"PreTrainedTokenizerBase"),Vc.forEach(t),Cr.forEach(t),Br=l(i),u=s(i,"DIV",{class:!0});var g=a(u);b(at.$$.fragment,g),Ls=l(g),ke=s(g,"P",{});var To=a(ke);Ds=n(To,"Base class for "),co=s(To,"A",{href:!0});var Gc=a(co);Is=n(Gc,"PreTrainedTokenizer"),Gc.forEach(t),Ns=n(To," and "),po=s(To,"A",{href:!0});var Hc=a(po);As=n(Hc,"PreTrainedTokenizerFast"),Hc.forEach(t),Fs=n(To,"."),To.forEach(t),Ss=l(g),Oo=s(g,"P",{});var Xc=a(Oo);Cs=n(Xc,"Handles shared (mostly boiler plate) methods for those two classes."),Xc.forEach(t),Os=l(g),Wo=s(g,"P",{});var Yc=a(Wo);Ws=n(Yc,"Class attributes (overridden by derived classes)"),Yc.forEach(t),js=l(g),I=s(g,"UL",{});var O=a(I);Z=s(O,"LI",{});var to=a(Z);jo=s(to,"STRONG",{});var Jc=a(jo);Rs=n(Jc,"vocab_files_names"),Jc.forEach(t),Us=n(to," ("),Ro=s(to,"CODE",{});var Kc=a(Ro);Ms=n(Kc,"Dict[str, str]"),Kc.forEach(t),Vs=n(to,") \u2014 A dictionary with, as keys, the "),Uo=s(to,"CODE",{});var Qc=a(Uo);Gs=n(Qc,"__init__"),Qc.forEach(t),Hs=n(to,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),to.forEach(t),Xs=l(O),F=s(O,"LI",{});var K=a(F);Mo=s(K,"STRONG",{});var Zc=a(Mo);Ys=n(Zc,"pretrained_vocab_files_map"),Zc.forEach(t),Js=n(K," ("),Vo=s(K,"CODE",{});var ep=a(Vo);Ks=n(ep,"Dict[str, Dict[str, str]]"),ep.forEach(t),Qs=n(K,`) \u2014 A dictionary of dictionaries, with the
...
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Qo=s(qe,"CODE",{});var ip=a(Qo);ma=n(ip,"None"),ip.forEach(t),ha=n(qe," if the model has no maximum input size."),qe.forEach(t),ua=l(O),S=s(O,"LI",{});var Q=a(S);Zo=s(Q,"STRONG",{});var dp=a(Zo);fa=n(dp,"pretrained_init_configuration"),dp.forEach(t),_a=n(Q," ("),en=s(Q,"CODE",{});var lp=a(en);ga=n(lp,"Dict[str, Dict[str, Any]]"),lp.forEach(t),ka=n(Q,`) \u2014 A dictionary with, as keys, the
...
sequence-to-sequence models that need a slightly different processing for the labels.`),zp.forEach(t),Wr.forEach(t),ei=l(g),Ae=s(g,"DIV",{class:!0});var jr=a(Ae);b(lt.$$.fragment,jr),ti=l(jr),_n=s(jr,"P",{});var xp=a(_n);oi=n(xp,"Convert a list of lists of token ids into a list of strings by calling decode."),xp.forEach(t),jr.forEach(t),ni=l(g),ee=s(g,"DIV",{class:!0});var yo=a(ee);b(ct.$$.fragment,yo),ri=l(yo),gn=s(yo,"P",{});var $p=a(gn);si=n($p,"Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),$p.forEach(t),ai=l(yo),b(Fe.$$.fragment,yo),yo.forEach(t),ii=l(g),te=s(g,"DIV",{class:!0});var wo=a(te);b(pt.$$.fragment,wo),di=l(wo),kn=s(wo,"P",{});var Pp=a(kn);li=n(Pp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),Pp.forEach(t),ci=l(wo),bn=s(wo,"P",{});var qp=a(bn);pi=n(qp,"This implementation does not add special tokens and this method should be overridden in a subclass."),qp.forEach(t),wo.forEach(t),mi=l(g),Se=s(g,"DIV",{class:!0});var Rr=a(Se);b(mt.$$.fragment,Rr),hi=l(Rr),vn=s(Rr,"P",{});var Ep=a(vn);ui=n(Ep,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Ep.forEach(t),Rr.forEach(t),fi=l(g),Ce=s(g,"DIV",{class:!0});var Ur=a(Ce);b(ht.$$.fragment,Ur),_i=l(Ur),ut=s(Ur,"P",{});var Mr=a(ut);gi=n(Mr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Mr,"CODE",{});var Bp=a(Tn);ki=n(Bp,'" ".join(tokens)'),Bp.forEach(t),bi=n(Mr,` but we
...
tokens and clean up tokenization spaces.`),Ip.forEach(t),Ei=l(xo),gt=s(xo,"P",{});var Vr=a(gt);Bi=n(Vr,"Similar to doing "),zn=s(Vr,"CODE",{});var Np=a(zn);Li=n(Np,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Np.forEach(t),Di=n(Vr,"."),Vr.forEach(t),xo.forEach(t),Ii=l(g),re=s(g,"DIV",{class:!0});var $o=a(re);b(kt.$$.fragment,$o),Ni=l($o),xn=s($o,"P",{});var Ap=a(xn);Ai=n(Ap,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Ap.forEach(t),Fi=l($o),bt=s($o,"P",{});var Gr=a(bt);Si=n(Gr,"Same as doing "),$n=s(Gr,"CODE",{});var Fp=a($n);Ci=n(Fp,"self.convert_tokens_to_ids(self.tokenize(text))"),Fp.forEach(t),Oi=n(Gr,"."),Gr.forEach(t),$o.forEach(t),Wi=l(g),se=s(g,"DIV",{class:!0});var Po=a(se);b(vt.$$.fragment,Po),ji=l(Po),Pn=s(Po,"P",{});var Sp=a(Pn);Ri=n(Sp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Sp.forEach(t),Ui=l(Po),b(Oe.$$.fragment,Po),Po.forEach(t),Mi=l(g),H=s(g,"DIV",{class:!0});var tt=a(H);b(Tt.$$.fragment,tt),Vi=l(tt),yt=s(tt,"P",{});var Hr=a(yt);Gi=n(Hr,"Instantiate a "),fo=s(Hr,"A",{href:!0});var Cp=a(fo);Hi=n(Cp,"PreTrainedTokenizerBase"),Cp.forEach(t),Xi=n(Hr,` (or a derived class) from a predefined
...
different than `),On=s(me,"CODE",{});var Jp=a(On);Ld=n(Jp,"None"),Jp.forEach(t),Dd=n(me," and "),Wn=s(me,"EM",{});var Kp=a(Wn);Id=n(Kp,"truncation_strategy = longest_first"),Kp.forEach(t),Nd=n(me," or "),jn=s(me,"CODE",{});var Qp=a(jn);Ad=n(Qp,"True"),Qp.forEach(t),Fd=n(me,`, it is not possible to return
overflowing tokens. Such a combination of arguments will raise an error.`),me.forEach(t),Yr.forEach(t),Sd=l(g),Ve=s(g,"DIV",{class:!0});var Jr=a(Ve);b(Pt.$$.fragment,Jr),Cd=l(Jr),Rn=s(Jr,"P",{});var Zp=a(Rn);Od=n(Zp,"Prepare model inputs for translation. For best performance, translate one sentence at a time."),Zp.forEach(t),Jr.forEach(t),Wd=l(g),de=s(g,"DIV",{class:!0});var Bo=a(de);b(qt.$$.fragment,Bo),jd=l(Bo),Et=s(Bo,"P",{});var Kr=a(Et);Rd=n(Kr,`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
