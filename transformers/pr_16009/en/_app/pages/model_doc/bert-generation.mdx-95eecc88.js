import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as fa,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T}from"../../chunks/vendor-4833417e.js";import{T as ca}from"../../chunks/Tip-fffd6df1.js";import{D as He}from"../../chunks/Docstring-7b52c3d4.js";import{C as Jt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as vt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function ma(ie){let u,q,f,w,D;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),w=n("Module"),D=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(E,"CODE",{});var S=i(f);w=r(S,"Module"),S.forEach(o),D=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(y,E){p(y,u,E),e(u,q),e(u,f),e(f,w),e(u,D)},d(y){y&&o(u)}}}function ga(ie){let u,q,f,w,D;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),w=n("Module"),D=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(E,"CODE",{});var S=i(f);w=r(S,"Module"),S.forEach(o),D=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(y,E){p(y,u,E),e(u,q),e(u,f),e(f,w),e(u,D)},d(y){y&&o(u)}}}function _a(ie){let u,q,f,w,D,y,E,S,Co,Kt,R,Y,kt,de,So,Tt,Mo,Qt,M,Ao,Ve,No,Lo,le,Fo,Io,Xt,Je,Oo,Yt,Ke,wt,Ro,Zt,Qe,Uo,eo,Xe,ce,Wo,Ye,Ho,Vo,to,he,oo,Ze,pe,Jo,et,Ko,Qo,no,ue,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,yt,on,nn,rn,Et,sn,ao,N,an,fe,dn,ln,me,cn,hn,io,U,ee,Bt,ge,pn,zt,un,lo,$,_e,fn,be,mn,$t,gn,_n,bn,W,vn,rt,kn,Tn,st,wn,yn,En,Gt,Bn,zn,ve,co,H,te,qt,ke,$n,Pt,Gn,ho,C,Te,qn,we,Pn,ye,jn,xn,Dn,Ee,Cn,at,Sn,Mn,An,it,Be,po,V,oe,jt,ze,Nn,xt,Ln,uo,m,$e,Fn,Dt,In,On,Ge,Rn,dt,Un,Wn,Hn,qe,Vn,Pe,Jn,Kn,Qn,je,Xn,xe,Yn,Zn,er,J,tr,lt,or,nr,De,rr,sr,ar,B,ir,Ct,dr,lr,St,cr,hr,Mt,pr,ur,At,fr,mr,Nt,gr,_r,Lt,br,vr,kr,P,Ce,Tr,K,wr,ct,yr,Er,Ft,Br,zr,$r,ne,Gr,It,qr,Pr,Se,fo,Q,re,Ot,Me,jr,Rt,xr,mo,G,Ae,Dr,Ne,Cr,Ut,Sr,Mr,Ar,Le,Nr,ht,Lr,Fr,Ir,Fe,Or,Ie,Rr,Ur,Wr,j,Oe,Hr,X,Vr,pt,Jr,Kr,Wt,Qr,Xr,Yr,se,Zr,Ht,es,ts,Re,go;return y=new vt({}),de=new vt({}),he=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
</ul>`,name:"sp_model_kwargs"}]}}),Be=new He({props:{name:"save_vocabulary",anchor:"transformers.BertGenerationTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16009/src/transformers/models/bert_generation/tokenization_bert_generation.py#L155"}}),ze=new vt({}),$e=new He({props:{name:"class transformers.BertGenerationEncoder",anchor:"transformers.BertGenerationEncoder",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16009/src/transformers/models/bert_generation/modeling_bert_generation.py#L253",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16009/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16009/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ce=new He({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16009/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<a href="/docs/transformers/pr_16009/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16009/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
`}}),ne=new ca({props:{$$slots:{default:[ma]},$$scope:{ctx:ie}}}),Se=new Jt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationEncoder
import torch
...
BERT checkpoints for subsequent fine-tuning.`),to=l(),g(he.$$.fragment),oo=l(),Ze=s("ul"),pe=s("li"),Jo=n("Pretrained "),et=s("a"),Ko=n("EncoderDecoderModel"),Qo=n(" are also directly available in the model hub, e.g.,"),no=l(),g(ue.$$.fragment),ro=l(),tt=s("p"),Xo=n("Tips:"),so=l(),Z=s("ul"),A=s("li"),ot=s("a"),Yo=n("BertGenerationEncoder"),Zo=n(" and "),nt=s("a"),en=n("BertGenerationDecoder"),tn=n(` should be used in
...
Therefore, no EOS token should be added to the end of the input.`),ao=l(),N=s("p"),an=n("This model was contributed by "),fe=s("a"),dn=n("patrickvonplaten"),ln=n(`. The original code can be
found `),me=s("a"),cn=n("here"),hn=n("."),io=l(),U=s("h2"),ee=s("a"),Bt=s("span"),g(ge.$$.fragment),pn=l(),zt=s("span"),un=n("BertGenerationConfig"),lo=l(),$=s("div"),g(_e.$$.fragment),fn=l(),be=s("p"),mn=n("This is the configuration class to store the configuration of a "),$t=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(` It is used to
...
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Be.$$.fragment),po=l(),V=s("h2"),oe=s("a"),jt=s("span"),g(ze.$$.fragment),Nn=l(),xt=s("span"),Ln=n("BertGenerationEncoder"),uo=l(),m=s("div"),g($e.$$.fragment),Fn=l(),Dt=s("p"),In=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),On=l(),Ge=s("p"),Rn=n("This model inherits from "),dt=s("a"),Un=n("PreTrainedModel"),Wn=n(`. Check the superclass documentation for the generic methods the
...
`),At=s("code"),fr=n("add_cross_attention"),mr=n(" set to "),Nt=s("code"),gr=n("True"),_r=n("; an "),Lt=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),P=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),wr=n("The "),ct=s("a"),yr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Ft=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),It=s("p"),qr=n("Example:"),Pr=l(),g(Se.$$.fragment),fo=l(),Q=s("h2"),re=s("a"),Ot=s("span"),g(Me.$$.fragment),jr=l(),Rt=s("span"),xr=n("BertGenerationDecoder"),mo=l(),G=s("div"),g(Ae.$$.fragment),Dr=l(),Ne=s("p"),Cr=n("BertGeneration Model with a "),Ut=s("code"),Sr=n("language modeling"),Mr=n(" head on top for CLM fine-tuning."),Ar=l(),Le=s("p"),Nr=n("This model inherits from "),ht=s("a"),Lr=n("PreTrainedModel"),Fr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ir=l(),Fe=s("p"),Or=n("This model is also a PyTorch "),Ie=s("a"),Rr=n("torch.nn.Module"),Ur=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wr=l(),j=s("div"),g(Oe.$$.fragment),Hr=l(),X=s("p"),Vr=n("The "),pt=s("a"),Jr=n("BertGenerationDecoder"),Kr=n(" forward method, overrides the "),Wt=s("code"),Qr=n("__call__"),Xr=n(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=n("Example:"),ts=l(),g(Re.$$.fragment),this.h()},l(t){const h=fa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),q=c(t),f=a(t,"H1",{class:!0});var Ue=i(f);w=a(Ue,"A",{id:!0,class:!0,href:!0});var Vt=i(w);D=a(Vt,"SPAN",{});var os=i(D);_(y.$$.fragment,os),os.forEach(o),Vt.forEach(o),E=c(Ue),S=a(Ue,"SPAN",{});var ns=i(S);Co=r(ns,"BertGeneration"),ns.forEach(o),Ue.forEach(o),Kt=c(t),R=a(t,"H2",{class:!0});var _o=i(R);Y=a(_o,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(de.$$.fragment,ss),ss.forEach(o),rs.forEach(o),So=c(_o),Tt=a(_o,"SPAN",{});var as=i(Tt);Mo=r(as,"Overview"),as.forEach(o),_o.forEach(o),Qt=c(t),M=a(t,"P",{});var ut=i(M);Ao=r(ut,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(o),ko.forEach(o),ao=c(t),N=a(t,"P",{});var ft=i(N);an=r(ft,"This model was contributed by "),fe=a(ft,"A",{href:!0,rel:!0});var ws=i(fe);dn=r(ws,"patrickvonplaten"),ws.forEach(o),ln=r(ft,`. The original code can be
found `),me=a(ft,"A",{href:!0,rel:!0});var ys=i(me);cn=r(ys,"here"),ys.forEach(o),hn=r(ft,"."),ft.forEach(o),io=c(t),U=a(t,"H2",{class:!0});var To=i(U);ee=a(To,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(ge.$$.fragment,Bs),Bs.forEach(o),Es.forEach(o),pn=c(To),zt=a(To,"SPAN",{});var zs=i(zt);un=r(zs,"BertGenerationConfig"),zs.forEach(o),To.forEach(o),lo=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(_e.$$.fragment,L),fn=c(L),be=a(L,"P",{});var wo=i(be);mn=r(wo,"This is the configuration class to store the configuration of a "),$t=a(wo,"CODE",{});var $s=i($t);gn=r($s,"BertGenerationPreTrainedModel"),$s.forEach(o),_n=r(wo,` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),wo.forEach(o),bn=c(L),W=a(L,"P",{});var mt=i(W);vn=r(mt,"Configuration objects inherit from "),rt=a(mt,"A",{href:!0});var Gs=i(rt);kn=r(Gs,"PretrainedConfig"),Gs.forEach(o),Tn=r(mt,` and can be used to control the model outputs. Read the
documentation from `),st=a(mt,"A",{href:!0});var qs=i(st);wn=r(qs,"PretrainedConfig"),qs.forEach(o),yn=r(mt," for more information."),mt.forEach(o),En=c(L),Gt=a(L,"P",{});var Ps=i(Gt);Bn=r(Ps,"Examples:"),Ps.forEach(o),zn=c(L),_(ve.$$.fragment,L),L.forEach(o),co=c(t),H=a(t,"H2",{class:!0});var yo=i(H);te=a(yo,"A",{id:!0,class:!0,href:!0});var js=i(te);qt=a(js,"SPAN",{});var xs=i(qt);_(ke.$$.fragment,xs),xs.forEach(o),js.forEach(o),$n=c(yo),Pt=a(yo,"SPAN",{});var Ds=i(Pt);Gn=r(Ds,"BertGenerationTokenizer"),Ds.forEach(o),yo.forEach(o),ho=c(t),C=a(t,"DIV",{class:!0});var ae=i(C);_(Te.$$.fragment,ae),qn=c(ae),we=a(ae,"P",{});var Eo=i(we);Pn=r(Eo,"Construct a BertGeneration tokenizer. Based on "),ye=a(Eo,"A",{href:!0,rel:!0});var Cs=i(ye);jn=r(Cs,"SentencePiece"),Cs.forEach(o),xn=r(Eo,"."),Eo.forEach(o),Dn=c(ae),Ee=a(ae,"P",{});var Bo=i(Ee);Cn=r(Bo,"This tokenizer inherits from "),at=a(Bo,"A",{href:!0});var Ss=i(at);Sn=r(Ss,"PreTrainedTokenizer"),Ss.forEach(o),Mn=r(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),An=c(ae),it=a(ae,"DIV",{class:!0});var Ms=i(it);_(Be.$$.fragment,Ms),Ms.forEach(o),ae.forEach(o),po=c(t),V=a(t,"H2",{class:!0});var zo=i(V);oe=a(zo,"A",{id:!0,class:!0,href:!0});var As=i(oe);jt=a(As,"SPAN",{});var Ns=i(jt);_(ze.$$.fragment,Ns),Ns.forEach(o),As.forEach(o),Nn=c(zo),xt=a(zo,"SPAN",{});var Ls=i(xt);Ln=r(Ls,"BertGenerationEncoder"),Ls.forEach(o),zo.forEach(o),uo=c(t),m=a(t,"DIV",{class:!0});var z=i(m);_($e.$$.fragment,z),Fn=c(z),Dt=a(z,"P",{});var Fs=i(Dt);In=r(Fs,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Fs.forEach(o),On=c(z),Ge=a(z,"P",{});var $o=i(Ge);Rn=r($o,"This model inherits from "),dt=a($o,"A",{href:!0});var Is=i(dt);Un=r(Is,"PreTrainedModel"),Is.forEach(o),Wn=r($o,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Do.forEach(o),Wr=c(I),j=a(I,"DIV",{class:!0});var O=i(j);_(Oe.$$.fragment,O),Hr=c(O),X=a(O,"P",{});var bt=i(X);Vr=r(bt,"The "),pt=a(bt,"A",{href:!0});var ia=i(pt);Jr=r(ia,"BertGenerationDecoder"),ia.forEach(o),Kr=r(bt," forward method, overrides the "),Wt=a(bt,"CODE",{});var da=i(Wt);Qr=r(da,"__call__"),da.forEach(o),Xr=r(bt," special method."),bt.forEach(o),Yr=c(O),_(se.$$.fragment,O),Zr=c(O),Ht=a(O,"P",{});var la=i(Ht);es=r(la,"Example:"),la.forEach(o),ts=c(O),_(Re.$$.fragment,O),O.forEach(o),I.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(ba)),d(w,"id","bertgeneration"),d(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(w,"href","#bertgeneration"),d(f,"class","relative group"),d(Y,"id","overview"),d(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Y,"href","#overview"),d(R,"class","relative group"),d(Ve,"href","/docs/transformers/pr_16009/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(le,"href","https://arxiv.org/abs/1907.12461"),d(le,"rel","nofollow"),d(Ye,"href","/docs/transformers/pr_16009/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(et,"href","/docs/transformers/pr_16009/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(ot,"href","/docs/transformers/pr_16009/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(nt,"href","/docs/transformers/pr_16009/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(fe,"href","https://huggingface.co/patrickvonplaten"),d(fe,"rel","nofollow"),d(me,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(me,"rel","nofollow"),d(ee,"id","transformers.BertGenerationConfig"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#transformers.BertGenerationConfig"),d(U,"class","relative group"),d(rt,"href","/docs/transformers/pr_16009/en/main_classes/configuration#transformers.PretrainedConfig"),d(st,"href","/docs/transformers/pr_16009/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring"),d(te,"id","transformers.BertGenerationTokenizer"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationTokenizer"),d(H,"class","relative group"),d(ye,"href","https://github.com/google/sentencepiece"),d(ye,"rel","nofollow"),d(at,"href","/docs/transformers/pr_16009/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(it,"class","docstring"),d(C,"class","docstring"),d(oe,"id","transformers.BertGenerationEncoder"),d(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(oe,"href","#transformers.BertGenerationEncoder"),d(V,"class","relative group"),d(dt,"href","/docs/transformers/pr_16009/en/main_classes/model#transformers.PreTrainedModel"),d(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Pe,"rel","nofollow"),d(xe,"href","https://arxiv.org/abs/1706.03762"),d(xe,"rel","nofollow"),d(lt,"href","/docs/transformers/pr_16009/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(De,"href","https://arxiv.org/abs/1907.12461"),d(De,"rel","nofollow"),d(ct,"href","/docs/transformers/pr_16009/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(P,"class","docstring"),d(m,"class","docstring"),d(re,"id","transformers.BertGenerationDecoder"),d(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(re,"href","#transformers.BertGenerationDecoder"),d(Q,"class","relative group"),d(ht,"href","/docs/transformers/pr_16009/en/main_classes/model#transformers.PreTrainedModel"),d(Ie,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Ie,"rel","nofollow"),d(pt,"href","/docs/transformers/pr_16009/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(j,"class","docstring"),d(G,"class","docstring")},m(t,h){e(document.head,u),p(t,q,h),p(t,f,h),e(f,w),e(w,D),b(y,D,null),e(f,E),e(f,S),e(S,Co),p(t,Kt,h),p(t,R,h),e(R,Y),e(Y,kt),b(de,kt,null),e(R,So),e(R,Tt),e(Tt,Mo),p(t,Qt,h),p(t,M,h),e(M,Ao),e(M,Ve),e(Ve,No),e(M,Lo),e(M,le),e(le,Fo),e(M,Io),p(t,Xt,h),p(t,Je,h),e(Je,Oo),p(t,Yt,h),p(t,Ke,h),e(Ke,wt),e(wt,Ro),p(t,Zt,h),p(t,Qe,h),e(Qe,Uo),p(t,eo,h),p(t,Xe,h),e(Xe,ce),e(ce,Wo),e(ce,Ye),e(Ye,Ho),e(ce,Vo),p(t,to,h),b(he,t,h),p(t,oo,h),p(t,Ze,h),e(Ze,pe),e(pe,Jo),e(pe,et),e(et,Ko),e(pe,Qo),p(t,no,h),b(ue,t,h),p(t,ro,h),p(t,tt,h),e(tt,Xo),p(t,so,h),p(t,Z,h),e(Z,A),e(A,ot),e(ot,Yo),e(A,Zo),e(A,nt),e(nt,en),e(A,tn),e(A,yt),e(yt,on),e(A,nn),e(Z,rn),e(Z,Et),e(Et,sn),p(t,ao,h),p(t,N,h),e(N,an),e(N,fe),e(fe,dn),e(N,ln),e(N,me),e(me,cn),e(N,hn),p(t,io,h),p(t,U,h),e(U,ee),e(ee,Bt),b(ge,Bt,null),e(U,pn),e(U,zt),e(zt,un),p(t,lo,h),p(t,$,h),b(_e,$,null),e($,fn),e($,be),e(be,mn),e(be,$t),e($t,gn),e(be,_n),e($,bn),e($,W),e(W,vn),e(W,rt),e(rt,kn),e(W,Tn),e(W,st),e(st,wn),e(W,yn),e($,En),e($,Gt),e(Gt,Bn),e($,zn),b(ve,$,null),p(t,co,h),p(t,H,h),e(H,te),e(te,qt),b(ke,qt,null),e(H,$n),e(H,Pt),e(Pt,Gn),p(t,ho,h),p(t,C,h),b(Te,C,null),e(C,qn),e(C,we),e(we,Pn),e(we,ye),e(ye,jn),e(we,xn),e(C,Dn),e(C,Ee),e(Ee,Cn),e(Ee,at),e(at,Sn),e(Ee,Mn),e(C,An),e(C,it),b(Be,it,null),p(t,po,h),p(t,V,h),e(V,oe),e(oe,jt),b(ze,jt,null),e(V,Nn),e(V,xt),e(xt,Ln),p(t,uo,h),p(t,m,h),b($e,m,null),e(m,Fn),e(m,Dt),e(Dt,In),e(m,On),e(m,Ge),e(Ge,Rn),e(Ge,dt),e(dt,Un),e(Ge,Wn),e(m,Hn),e(m,qe),e(qe,Vn),e(qe,Pe),e(Pe,Jn),e(qe,Kn),e(m,Qn),e(m,je),e(je,Xn),e(je,xe),e(xe,Yn),e(je,Zn),e(m,er),e(m,J),e(J,tr),e(J,lt),e(lt,or),e(J,nr),e(J,De),e(De,rr),e(J,sr),e(m,ar),e(m,B),e(B,ir),e(B,Ct),e(Ct,dr),e(B,lr),e(B,St),e(St,cr),e(B,hr),e(B,Mt),e(Mt,pr),e(B,ur),e(B,At),e(At,fr),e(B,mr),e(B,Nt),e(Nt,gr),e(B,_r),e(B,Lt),e(Lt,br),e(B,vr),e(m,kr),e(m,P),b(Ce,P,null),e(P,Tr),e(P,K),e(K,wr),e(K,ct),e(ct,yr),e(K,Er),e(K,Ft),e(Ft,Br),e(K,zr),e(P,$r),b(ne,P,null),e(P,Gr),e(P,It),e(It,qr),e(P,Pr),b(Se,P,null),p(t,fo,h),p(t,Q,h),e(Q,re),e(re,Ot),b(Me,Ot,null),e(Q,jr),e(Q,Rt),e(Rt,xr),p(t,mo,h),p(t,G,h),b(Ae,G,null),e(G,Dr),e(G,Ne),e(Ne,Cr),e(Ne,Ut),e(Ut,Sr),e(Ne,Mr),e(G,Ar),e(G,Le),e(Le,Nr),e(Le,ht),e(ht,Lr),e(Le,Fr),e(G,Ir),e(G,Fe),e(Fe,Or),e(Fe,Ie),e(Ie,Rr),e(Fe,Ur),e(G,Wr),e(G,j),b(Oe,j,null),e(j,Hr),e(j,X),e(X,Vr),e(X,pt),e(pt,Jr),e(X,Kr),e(X,Wt),e(Wt,Qr),e(X,Xr),e(j,Yr),b(se,j,null),e(j,Zr),e(j,Ht),e(Ht,es),e(j,ts),b(Re,j,null),go=!0},p(t,[h]){const Ue={};h&2&&(Ue.$$scope={dirty:h,ctx:t}),ne.$set(Ue);const Vt={};h&2&&(Vt.$$scope={dirty:h,ctx:t}),se.$set(Vt)},i(t){go||(v(y.$$.fragment,t),v(de.$$.fragment,t),v(he.$$.fragment,t),v(ue.$$.fragment,t),v(ge.$$.fragment,t),v(_e.$$.fragment,t),v(ve.$$.fragment,t),v(ke.$$.fragment,t),v(Te.$$.fragment,t),v(Be.$$.fragment,t),v(ze.$$.fragment,t),v($e.$$.fragment,t),v(Ce.$$.fragment,t),v(ne.$$.fragment,t),v(Se.$$.fragment,t),v(Me.$$.fragment,t),v(Ae.$$.fragment,t),v(Oe.$$.fragment,t),v(se.$$.fragment,t),v(Re.$$.fragment,t),go=!0)},o(t){k(y.$$.fragment,t),k(de.$$.fragment,t),k(he.$$.fragment,t),k(ue.$$.fragment,t),k(ge.$$.fragment,t),k(_e.$$.fragment,t),k(ve.$$.fragment,t),k(ke.$$.fragment,t),k(Te.$$.fragment,t),k(Be.$$.fragment,t),k(ze.$$.fragment,t),k($e.$$.fragment,t),k(Ce.$$.fragment,t),k(ne.$$.fragment,t),k(Se.$$.fragment,t),k(Me.$$.fragment,t),k(Ae.$$.fragment,t),k(Oe.$$.fragment,t),k(se.$$.fragment,t),k(Re.$$.fragment,t),go=!1},d(t){o(u),t&&o(q),t&&o(f),T(y),t&&o(Kt),t&&o(R),T(de),t&&o(Qt),t&&o(M),t&&o(Xt),t&&o(Je),t&&o(Yt),t&&o(Ke),t&&o(Zt),t&&o(Qe),t&&o(eo),t&&o(Xe),t&&o(to),T(he,t),t&&o(oo),t&&o(Ze),t&&o(no),T(ue,t),t&&o(ro),t&&o(tt),t&&o(so),t&&o(Z),t&&o(ao),t&&o(N),t&&o(io),t&&o(U),T(ge),t&&o(lo),t&&o($),T(_e),T(ve),t&&o(co),t&&o(H),T(ke),t&&o(ho),t&&o(C),T(Te),T(Be),t&&o(po),t&&o(V),T(ze),t&&o(uo),t&&o(m),T($e),T(Ce),T(ne),T(Se),t&&o(fo),t&&o(Q),T(Me),t&&o(mo),t&&o(G),T(Ae),T(Oe),T(se),T(Re)}}}const ba={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function va(ie,u,q){let{fw:f}=u;return ie.$$set=w=>{"fw"in w&&q(0,f=w.fw)},[f]}class za extends ha{constructor(u){super();pa(this,u,va,_a,ua,{fw:0})}}export{za as default,ba as metadata};
