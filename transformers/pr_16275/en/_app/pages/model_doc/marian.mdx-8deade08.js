import{S as nf,i as of,s as sf,e as o,k as d,w as v,t as r,M as af,c as s,d as t,m as l,a,x as k,h as i,b as c,F as e,g as h,y as T,q as M,o as y,B as b}from"../../chunks/vendor-6b77c823.js";import{T as pn}from"../../chunks/Tip-39098574.js";import{D as V}from"../../chunks/Docstring-abef54e3.js";import{C as $e}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as he}from"../../chunks/IconCopyLink-7a11ce68.js";function rf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
...
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(I),O=s(I,"LI",{});var de=a(O);We=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=s(de,"CODE",{});var xe=a(S);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),I.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,_,j),e(_,w),e(w,x),e(_,g),e(_,$),e($,Ae),h(m,ue,j),h(m,q,j),e(q,ve),e(q,X),e(X,Oe),e(q,Q),e(q,ee),e(ee,Se),e(q,je),h(m,G,j),h(m,A,j),e(A,qe),h(m,L,j),h(m,E,j),e(E,F),e(F,te),e(F,ne),e(ne,ke),e(F,He),e(F,J),e(J,P),e(E,Te),e(E,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(E,Ue),e(E,O),e(O,We),e(O,S),e(S,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(q),m&&t(G),m&&t(A),m&&t(L),m&&t(E)}}}function cf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function pf(C){let u,z,f,_,w,x,g,$,Ae,ue,q,ve,X,Oe,Q,ee,Se,je,G,A,qe,L,E,F,te,ne,ke,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,O,We,S,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),_=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=o("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),q=o("p"),ve=r("This second option is useful when using "),X=o("code"),Oe=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Se=r("model(inputs)"),je=r("."),G=d(),A=o("p"),qe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),L=d(),E=o("ul"),F=o("li"),te=r("a single Tensor with "),ne=o("code"),ke=r("input_ids"),He=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),Te=d(),N=o("li"),De=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=o("code"),Me=r("model([input_ids, attention_mask])"),se=r(" or "),ae=o("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),Ue=d(),O=o("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),f=l(m),_=s(m,"UL",{});var ye=a(_);w=s(ye,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),g=l(ye),$=s(ye,"LI",{});var be=a($);Ae=i(be,"having all inputs as a list, tuple or dict in the first positional arguments."),be.forEach(t),ye.forEach(t),ue=l(m),q=s(m,"P",{});var D=a(q);ve=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Oe=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
...
first positional argument :`),Re.forEach(t),L=l(m),E=s(m,"UL",{});var I=a(E);F=s(I,"LI",{});var ie=a(F);te=i(ie,"a single Tensor with "),ne=s(ie,"CODE",{});var rt=a(ne);ke=i(rt,"input_ids"),rt.forEach(t),He=i(ie," only and nothing else: "),J=s(ie,"CODE",{});var Be=a(J);P=i(Be,"model(input_ids)"),Be.forEach(t),ie.forEach(t),Te=l(I),N=s(I,"LI",{});var U=a(N);De=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(I),O=s(I,"LI",{});var de=a(O);We=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=s(de,"CODE",{});var xe=a(S);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),I.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,_,j),e(_,w),e(w,x),e(_,g),e(_,$),e($,Ae),h(m,ue,j),h(m,q,j),e(q,ve),e(q,X),e(X,Oe),e(q,Q),e(q,ee),e(ee,Se),e(q,je),h(m,G,j),h(m,A,j),e(A,qe),h(m,L,j),h(m,E,j),e(E,F),e(F,te),e(F,ne),e(ne,ke),e(F,He),e(F,J),e(J,P),e(E,Te),e(E,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(E,Ue),e(E,O),e(O,We),e(O,S),e(S,H)},d(m){m&&t(u),m&&t(f),m&&t(_),m&&t(ue),m&&t(q),m&&t(G),m&&t(A),m&&t(L),m&&t(E)}}}function hf(C){let u,z,f,_,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16275/en/model_doc/marian#transformers.MarianConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),Qn=new he({}),eo=new V({props:{name:"class transformers.MarianMTModel",anchor:"transformers.MarianMTModel",parameters:[{name:"config",val:": MarianConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/marian/modeling_marian.py#L1267",parametersDescription:[{anchor:"transformers.MarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16275/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),so=new V({props:{name:"forward",anchor:"transformers.MarianMTModel.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple[torch.Tensor], transformers.modeling_outputs.BaseModelOutput, NoneType] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/marian/modeling_marian.py#L1390",parametersDescription:[{anchor:"transformers.MarianMTModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16275/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16275/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),To=new he({}),Mo=new V({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/marian/modeling_tf_marian.py#L1243",parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16275/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16275/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new pn({props:{$$slots:{default:[pf]},$$scope:{ctx:C}}}),wo=new V({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/marian/modeling_tf_marian.py#L1276",parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16275/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16275/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
`}}),en=new pn({props:{$$slots:{default:[uf]},$$scope:{ctx:C}}}),So=new $e({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
Whether or not to return a <a href="/docs/transformers/pr_16275/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){u=o("meta"),z=d(),f=o("h1"),_=o("a"),w=o("span"),v(x.$$.fragment),g=d(),$=o("span"),Ae=r("MarianMT"),ue=d(),q=o("p"),ve=o("strong"),X=r("Bugs:"),Oe=r(" If you see something strange, file a "),Q=o("a"),ee=r("Github Issue"),Se=r(`
and assign @patrickvonplaten.`),je=d(),G=o("p"),A=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),qe=d(),L=o("h2"),E=o("a"),F=o("span"),v(te.$$.fragment),ne=d(),ke=o("span"),He=r("Implementation Notes"),J=d(),P=o("ul"),Te=o("li"),N=o("p"),De=r("Each model is about 298 MB on disk, there are more than 1,000 models."),oe=d(),Me=o("li"),se=o("p"),ae=r("The list of supported language pairs can be found "),re=o("a"),Ue=r("here"),O=r("."),We=d(),S=o("li"),H=o("p"),m=r("Models were originally trained by "),j=o("a"),ye=r("J\xF6rg Tiedemann"),ot=r(" using the "),be=o("a"),D=r("Marian"),st=r(" C++ library, which supports fast training and translation."),at=d(),Re=o("li"),I=o("p"),ie=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
...
require 3 character language codes:`),ir=d(),v(En.$$.fragment),dr=d(),es=o("p"),Sd=r("Here is the code to see all available pretrained models on the hub:"),lr=d(),v(Pn.$$.fragment),cr=d(),ft=o("h2"),Ot=o("a"),ea=o("span"),v(Fn.$$.fragment),Hd=d(),ta=o("span"),Dd=r("Old Style Multi-Lingual Models"),pr=d(),ts=o("p"),Ud=r(`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),hr=d(),v(Nn.$$.fragment),ur=d(),ns=o("p"),Wd=r("Example of translating english to many romance languages, using old-style 2 character language codes"),mr=d(),v(Cn.$$.fragment),fr=d(),_t=o("h2"),St=o("a"),na=o("span"),v(Ln.$$.fragment),Rd=d(),oa=o("span"),Bd=r("MarianConfig"),_r=d(),le=o("div"),v(In.$$.fragment),Vd=d(),gt=o("p"),Gd=r("This is the configuration class to store the configuration of a "),os=o("a"),Jd=r("MarianModel"),Yd=r(`. It is used to instantiate an
...
documentation from `),as=o("a"),nl=r("PretrainedConfig"),ol=r(" for more information."),sl=d(),sa=o("p"),al=r("Examples:"),rl=d(),v(On.$$.fragment),gr=d(),kt=o("h2"),Ht=o("a"),aa=o("span"),v(Sn.$$.fragment),il=d(),ra=o("span"),dl=r("MarianTokenizer"),vr=d(),W=o("div"),v(Hn.$$.fragment),ll=d(),Dn=o("p"),cl=r("Construct a Marian tokenizer. Based on "),Un=o("a"),pl=r("SentencePiece"),hl=r("."),ul=d(),Wn=o("p"),ml=r("This tokenizer inherits from "),rs=o("a"),fl=r("PreTrainedTokenizer"),_l=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),gl=d(),ia=o("p"),vl=r("Examples:"),kl=d(),v(Rn.$$.fragment),Tl=d(),Dt=o("div"),v(Bn.$$.fragment),Ml=d(),da=o("p"),yl=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),kr=d(),Tt=o("h2"),Ut=o("a"),la=o("span"),v(Vn.$$.fragment),bl=d(),ca=o("span"),xl=r("MarianModel"),Tr=d(),we=o("div"),v(Gn.$$.fragment),wl=d(),Jn=o("p"),zl=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Nl=d(),me=o("div"),v(Zn.$$.fragment),Cl=d(),Mt=o("p"),Ll=r("The "),ds=o("a"),Il=r("MarianModel"),Al=r(" forward method, overrides the "),pa=o("code"),Ol=r("__call__"),Sl=r(" special method."),Hl=d(),v(Wt.$$.fragment),Dl=d(),ha=o("p"),Ul=r("Example:"),Wl=d(),v(Xn.$$.fragment),Mr=d(),yt=o("h2"),Rt=o("a"),ua=o("span"),v(Qn.$$.fragment),Rl=d(),ma=o("span"),Bl=r("MarianMTModel"),yr=d(),ze=o("div"),v(eo.$$.fragment),Vl=d(),to=o("p"),Gl=r(`The Marian Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=d(),Y=o("div"),v(so.$$.fragment),tc=d(),bt=o("p"),nc=r("The "),cs=o("a"),oc=r("MarianMTModel"),sc=r(" forward method, overrides the "),fa=o("code"),ac=r("__call__"),rc=r(" special method."),ic=d(),v(Bt.$$.fragment),dc=d(),ao=o("p"),lc=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),ro=o("a"),cc=r("here"),pc=r("."),hc=d(),_a=o("p"),uc=r("Examples:"),mc=d(),v(io.$$.fragment),br=d(),xt=o("h2"),Vt=o("a"),ga=o("span"),v(lo.$$.fragment),fc=d(),va=o("span"),_c=r("MarianForCausalLM"),xr=d(),wt=o("div"),v(co.$$.fragment),gc=d(),Ye=o("div"),v(po.$$.fragment),vc=d(),ka=o("p"),kc=r("Example:"),Tc=d(),v(ho.$$.fragment),wr=d(),zt=o("h2"),Gt=o("a"),Ta=o("span"),v(uo.$$.fragment),Mc=d(),Ma=o("span"),yc=r("TFMarianModel"),zr=d(),ce=o("div"),v(mo.$$.fragment),bc=d(),fo=o("p"),xc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Pc=d(),v(Jt.$$.fragment),Fc=d(),fe=o("div"),v(vo.$$.fragment),Nc=d(),$t=o("p"),Cc=r("The "),hs=o("a"),Lc=r("TFMarianModel"),Ic=r(" forward method, overrides the "),ya=o("code"),Ac=r("__call__"),Oc=r(" special method."),Sc=d(),v(Yt.$$.fragment),Hc=d(),ba=o("p"),Dc=r("Example:"),Uc=d(),v(ko.$$.fragment),$r=d(),jt=o("h2"),Kt=o("a"),xa=o("span"),v(To.$$.fragment),Wc=d(),wa=o("span"),Rc=r("TFMarianMTModel"),jr=d(),pe=o("div"),v(Mo.$$.fragment),Bc=d(),yo=o("p"),Vc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
models are listed `),$o=o("a"),cp=r("here"),pp=r("."),hp=d(),$a=o("p"),up=r("Examples:"),mp=d(),v(jo.$$.fragment),qr=d(),Et=o("h2"),Qt=o("a"),ja=o("span"),v(qo.$$.fragment),fp=d(),qa=o("span"),_p=r("FlaxMarianModel"),Er=d(),R=o("div"),v(Eo.$$.fragment),gp=d(),Po=o("p"),vp=r(`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wp=d(),Ea=o("p"),zp=r("Finally, this model supports inherent JAX features such as:"),$p=d(),Ve=o("ul"),Pa=o("li"),Co=o("a"),jp=r("Just-In-Time (JIT) compilation"),qp=d(),Fa=o("li"),Lo=o("a"),Ep=r("Automatic Differentiation"),Pp=d(),Na=o("li"),Io=o("a"),Fp=r("Vectorization"),Np=d(),Ca=o("li"),Ao=o("a"),Cp=r("Parallelization"),Lp=d(),_e=o("div"),v(Oo.$$.fragment),Ip=d(),Pt=o("p"),Ap=r("The "),La=o("code"),Op=r("FlaxMarianPreTrainedModel"),Sp=r("forward method, overrides the "),Ia=o("code"),Hp=r("__call__"),Dp=r(" special method."),Up=d(),v(en.$$.fragment),Wp=d(),Aa=o("p"),Rp=r("Example:"),Bp=d(),v(So.$$.fragment),Pr=d(),Ft=o("h2"),tn=o("a"),Oa=o("span"),v(Ho.$$.fragment),Vp=d(),Sa=o("span"),Gp=r("FlaxMarianMTModel"),Fr=d(),B=o("div"),v(Do.$$.fragment),Jp=d(),Uo=o("p"),Yp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
fine-tuning experiments and integration tests.`),su.forEach(t),fd=l(Ms),Gs=s(Ms,"LI",{});var au=a(Gs);Mn=s(au,"A",{href:!0,rel:!0});var ru=a(Mn);_d=i(ru,"Fine-tune on GPU"),ru.forEach(t),au.forEach(t),gd=l(Ms),Js=s(Ms,"LI",{});var iu=a(Js);yn=s(iu,"A",{href:!0,rel:!0});var du=a(yn);vd=i(du,"Fine-tune on GPU with pytorch-lightning"),du.forEach(t),iu.forEach(t),Ms.forEach(t),sr=l(n),mt=s(n,"H2",{class:!0});var Br=a(mt);It=s(Br,"A",{id:!0,class:!0,href:!0});var lu=a(It);Ys=s(lu,"SPAN",{});var cu=a(Ys);k(bn.$$.fragment,cu),cu.forEach(t),lu.forEach(t),kd=l(Br),Ks=s(Br,"SPAN",{});var pu=a(Ks);Td=i(pu,"Multilingual Models"),pu.forEach(t),Br.forEach(t),ar=l(n),Pe=s(n,"UL",{});var an=a(Pe);xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,"All model names use the following format: "),Zs=s(Vr,"CODE",{});var hu=a(Zs);yd=i(hu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),hu.forEach(t),bd=i(Vr,":"),Vr.forEach(t),xd=l(an),wn=s(an,"LI",{});var Gr=a(wn);wd=i(Gr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
require 3 character language codes:`),Kr.forEach(t),ir=l(n),k(En.$$.fragment,n),dr=l(n),es=s(n,"P",{});var gu=a(es);Sd=i(gu,"Here is the code to see all available pretrained models on the hub:"),gu.forEach(t),lr=l(n),k(Pn.$$.fragment,n),cr=l(n),ft=s(n,"H2",{class:!0});var Zr=a(ft);Ot=s(Zr,"A",{id:!0,class:!0,href:!0});var vu=a(Ot);ea=s(vu,"SPAN",{});var ku=a(ea);k(Fn.$$.fragment,ku),ku.forEach(t),vu.forEach(t),Hd=l(Zr),ta=s(Zr,"SPAN",{});var Tu=a(ta);Dd=i(Tu,"Old Style Multi-Lingual Models"),Tu.forEach(t),Zr.forEach(t),pr=l(n),ts=s(n,"P",{});var Mu=a(ts);Ud=i(Mu,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Mu.forEach(t),hr=l(n),k(Nn.$$.fragment,n),ur=l(n),ns=s(n,"P",{});var yu=a(ns);Wd=i(yu,"Example of translating english to many romance languages, using old-style 2 character language codes"),yu.forEach(t),mr=l(n),k(Cn.$$.fragment,n),fr=l(n),_t=s(n,"H2",{class:!0});var Xr=a(_t);St=s(Xr,"A",{id:!0,class:!0,href:!0});var bu=a(St);na=s(bu,"SPAN",{});var xu=a(na);k(Ln.$$.fragment,xu),xu.forEach(t),bu.forEach(t),Rd=l(Xr),oa=s(Xr,"SPAN",{});var wu=a(oa);Bd=i(wu,"MarianConfig"),wu.forEach(t),Xr.forEach(t),_r=l(n),le=s(n,"DIV",{class:!0});var Ke=a(le);k(In.$$.fragment,Ke),Vd=l(Ke),gt=s(Ke,"P",{});var ys=a(gt);Gd=i(ys,"This is the configuration class to store the configuration of a "),os=s(ys,"A",{href:!0});var zu=a(os);Jd=i(zu,"MarianModel"),zu.forEach(t),Yd=i(ys,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
...
documentation from `),as=s(bs,"A",{href:!0});var qu=a(as);nl=i(qu,"PretrainedConfig"),qu.forEach(t),ol=i(bs," for more information."),bs.forEach(t),sl=l(Ke),sa=s(Ke,"P",{});var Eu=a(sa);al=i(Eu,"Examples:"),Eu.forEach(t),rl=l(Ke),k(On.$$.fragment,Ke),Ke.forEach(t),gr=l(n),kt=s(n,"H2",{class:!0});var Qr=a(kt);Ht=s(Qr,"A",{id:!0,class:!0,href:!0});var Pu=a(Ht);aa=s(Pu,"SPAN",{});var Fu=a(aa);k(Sn.$$.fragment,Fu),Fu.forEach(t),Pu.forEach(t),il=l(Qr),ra=s(Qr,"SPAN",{});var Nu=a(ra);dl=i(Nu,"MarianTokenizer"),Nu.forEach(t),Qr.forEach(t),vr=l(n),W=s(n,"DIV",{class:!0});var Fe=a(W);k(Hn.$$.fragment,Fe),ll=l(Fe),Dn=s(Fe,"P",{});var ei=a(Dn);cl=i(ei,"Construct a Marian tokenizer. Based on "),Un=s(ei,"A",{href:!0,rel:!0});var Cu=a(Un);pl=i(Cu,"SentencePiece"),Cu.forEach(t),hl=i(ei,"."),ei.forEach(t),ul=l(Fe),Wn=s(Fe,"P",{});var ti=a(Wn);ml=i(ti,"This tokenizer inherits from "),rs=s(ti,"A",{href:!0});var Lu=a(rs);fl=i(Lu,"PreTrainedTokenizer"),Lu.forEach(t),_l=i(ti,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ti.forEach(t),gl=l(Fe),ia=s(Fe,"P",{});var Iu=a(ia);vl=i(Iu,"Examples:"),Iu.forEach(t),kl=l(Fe),k(Rn.$$.fragment,Fe),Tl=l(Fe),Dt=s(Fe,"DIV",{class:!0});var ni=a(Dt);k(Bn.$$.fragment,ni),Ml=l(ni),da=s(ni,"P",{});var Au=a(da);yl=i(Au,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Au.forEach(t),ni.forEach(t),Fe.forEach(t),kr=l(n),Tt=s(n,"H2",{class:!0});var oi=a(Tt);Ut=s(oi,"A",{id:!0,class:!0,href:!0});var Ou=a(Ut);la=s(Ou,"SPAN",{});var Su=a(la);k(Vn.$$.fragment,Su),Su.forEach(t),Ou.forEach(t),bl=l(oi),ca=s(oi,"SPAN",{});var Hu=a(ca);xl=i(Hu,"MarianModel"),Hu.forEach(t),oi.forEach(t),Tr=l(n),we=s(n,"DIV",{class:!0});var rn=a(we);k(Gn.$$.fragment,rn),wl=l(rn),Jn=s(rn,"P",{});var si=a(Jn);zl=i(si,`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mi.forEach(t),Pc=l(Xe),k(Jt.$$.fragment,Xe),Fc=l(Xe),fe=s(Xe,"DIV",{class:!0});var Qe=a(fe);k(vo.$$.fragment,Qe),Nc=l(Qe),$t=s(Qe,"P",{});var $s=a($t);Cc=i($s,"The "),hs=s($s,"A",{href:!0});var cm=a(hs);Lc=i(cm,"TFMarianModel"),cm.forEach(t),Ic=i($s," forward method, overrides the "),ya=s($s,"CODE",{});var pm=a(ya);Ac=i(pm,"__call__"),pm.forEach(t),Oc=i($s," special method."),$s.forEach(t),Sc=l(Qe),k(Yt.$$.fragment,Qe),Hc=l(Qe),ba=s(Qe,"P",{});var hm=a(ba);Dc=i(hm,"Example:"),hm.forEach(t),Uc=l(Qe),k(ko.$$.fragment,Qe),Qe.forEach(t),Xe.forEach(t),$r=l(n),jt=s(n,"H2",{class:!0});var fi=a(jt);Kt=s(fi,"A",{id:!0,class:!0,href:!0});var um=a(Kt);xa=s(um,"SPAN",{});var mm=a(xa);k(To.$$.fragment,mm),mm.forEach(t),um.forEach(t),Wc=l(fi),wa=s(fi,"SPAN",{});var fm=a(wa);Rc=i(fm,"TFMarianMTModel"),fm.forEach(t),fi.forEach(t),jr=l(n),pe=s(n,"DIV",{class:!0});var et=a(pe);k(Mo.$$.fragment,et),Bc=l(et),yo=s(et,"P",{});var _i=a(yo);Vc=i(_i,`The MARIAN Model with a language modeling head. Can be used for summarization.
