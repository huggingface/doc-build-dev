...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function Tw(A){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),N=o("code"),Pe=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),D=o("li"),Ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=o("code"),Ne=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);$=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),b=l(m),w=s(m,"UL",{});var te=a(w);z=s(te,"LI",{});var Se=a(z);x=i(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),y=l(te),q=s(te,"LI",{});var pt=a(q);qe=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),E=s(m,"P",{});var O=a(E);ee=i(O,"This second option is useful when using "),S=s(O,"CODE",{});var Ge=a(S);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),Ee=i(O,` method which currently requires having all the
tensors in the first argument of the model call function: `),G=s(O,"CODE",{});var ne=a(G);je=i(ne,"model(inputs)"),ne.forEach(t),ve=i(O,"."),O.forEach(t),U=l(m),I=s(m,"P",{});var ht=a(I);ae=i(ht,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var L=a(F);C=s(L,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),B=s(Y,"CODE",{});var Le=a(B);Fe=i(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),ye=l(L),P=s(L,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),N=s(Z,"CODE",{});var Ae=a(N);Pe=i(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),fe=l(L),D=s(L,"LI",{});var Ie=a(D);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=s(Ie,"CODE",{});var ft=a(W);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),L.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ve),p(m,U,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,B),e(B,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,N),e(N,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ne)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(I),m&&t(pe),m&&t(F)}}}function bw(A){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function yw(A){let u,$,b,w,z,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,ve,U,I,ae,pe,F,C,he,K,be,ue,B,Fe,ye,P,Me,H,V,me,N,Pe,fe,D,Ce,W,Ne;return{c(){u=o("p"),$=r("TF 2.0 models accepts two formats as inputs:"),b=d(),w=o("ul"),z=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=o("li"),qe=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),E=o("p"),ee=r("This second option is useful when using "),S=o("code"),se=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),ve=r("."),U=d(),I=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),C=o("li"),he=r("a single Tensor with "),K=o("code"),be=r("input_ids"),ue=r(" only and nothing else: "),B=o("code"),Fe=r("model(inputs_ids)"),ye=d(),P=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),N=o("code"),Pe=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),D=o("li"),Ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=o("code"),Ne=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);$=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),b=l(m),w=s(m,"UL",{});var te=a(w);z=s(te,"LI",{});var Se=a(z);x=i(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),y=l(te),q=s(te,"LI",{});var pt=a(q);qe=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),E=s(m,"P",{});var O=a(E);ee=i(O,"This second option is useful when using "),S=s(O,"CODE",{});var Ge=a(S);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),Ee=i(O,` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var L=a(F);C=s(L,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),B=s(Y,"CODE",{});var Le=a(B);Fe=i(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),ye=l(L),P=s(L,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),N=s(Z,"CODE",{});var Ae=a(N);Pe=i(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),fe=l(L),D=s(L,"LI",{});var Ie=a(D);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=s(Ie,"CODE",{});var ft=a(W);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),L.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ve),p(m,U,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,B),e(B,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,N),e(N,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ne)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(I),m&&t(pe),m&&t(F)}}}function ww(A){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function xw(A){let u,$,b,w,z,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,ve,U,I,ae,pe,F,C,he,K,be,ue,B,Fe,ye,P,Me,H,V,me,N,Pe,fe,D,Ce,W,Ne;return{c(){u=o("p"),$=r("TF 2.0 models accepts two formats as inputs:"),b=d(),w=o("ul"),z=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=o("li"),qe=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),E=o("p"),ee=r("This second option is useful when using "),S=o("code"),se=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),ve=r("."),U=d(),I=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),C=o("li"),he=r("a single Tensor with "),K=o("code"),be=r("input_ids"),ue=r(" only and nothing else: "),B=o("code"),Fe=r("model(inputs_ids)"),ye=d(),P=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),N=o("code"),Pe=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),D=o("li"),Ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=o("code"),Ne=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);$=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),b=l(m),w=s(m,"UL",{});var te=a(w);z=s(te,"LI",{});var Se=a(z);x=i(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),y=l(te),q=s(te,"LI",{});var pt=a(q);qe=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),E=s(m,"P",{});var O=a(E);ee=i(O,"This second option is useful when using "),S=s(O,"CODE",{});var Ge=a(S);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),Ee=i(O,` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var L=a(F);C=s(L,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),B=s(Y,"CODE",{});var Le=a(B);Fe=i(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),ye=l(L),P=s(L,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),N=s(Z,"CODE",{});var Ae=a(N);Pe=i(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),fe=l(L),D=s(L,"LI",{});var Ie=a(D);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=s(Ie,"CODE",{});var ft=a(W);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),L.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ve),p(m,U,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,B),e(B,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,N),e(N,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ne)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(I),m&&t(pe),m&&t(F)}}}function zw(A){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function $w(A){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function Ew(A){let u,$,b,w,z,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,ve,U,I,ae,pe,F,C,he,K,be,ue,B,Fe,ye,P,Me,H,V,me,N,Pe,fe,D,Ce,W,Ne,m,j,te,Se,pt,O,Ge,ne,ht,L,Y,ut,Le,Z,mt,Ae,Ie,ft,Vl,Xa,Op,Kl,Ue,di,li,To,Sp,Gp,ci,pi,ko,Up,Bp,hi,ui,vo,Wp,Rp,mi,fi,bo,Hp,Vp,_i,Qa,yo,Kp,Yp,Yl,er,Zp,Zl,$t,gi,zn,Ti,Jp,Xp,tr,Qp,eh,th,ki,$n,vi,nh,oh,nr,sh,ah,rh,bi,qn,yi,ih,dh,or,lh,ch,Jl,En,ph,wo,hh,uh,Xl,qt,mh,xo,fh,_h,zo,gh,Th,Ql,sr,ec,Zt,jn,wi,$o,kh,xi,vh,tc,_t,bh,zi,yh,wh,$i,xh,zh,qi,$h,qh,nc,Fn,Eh,ar,jh,Fh,oc,Mn,dt,Ei,Mh,Ph,_e,Ch,ji,Nh,Lh,Fi,Ah,Ih,Mi,Dh,Oh,Pi,Sh,Gh,Ci,Uh,Bh,rr,Wh,Rh,Hh,Ni,Vh,Kh,qo,Yh,Eo,Zh,jo,Jh,Xh,Qh,ge,Li,eu,tu,Ai,nu,ou,Fo,su,re,au,Ii,ru,iu,Di,du,lu,Oi,cu,pu,Si,hu,uu,Gi,mu,fu,Ui,_u,gu,Bi,Tu,ku,vu,Jt,bu,Wi,yu,wu,Ri,xu,zu,$u,Te,qu,Hi,Eu,ju,Vi,Fu,Mu,Ki,Pu,Cu,Yi,Nu,Lu,Mo,Au,Iu,Zi,Du,Ou,Su,Po,sc,ir,Gu,ac,Et,Ji,Co,Uu,Xi,Bu,Wu,Ru,Qi,Xt,Hu,No,Vu,Ku,Lo,Yu,Zu,Ju,ed,Ao,Xu,td,Qu,em,rc,dr,ic,Qt,Pn,nd,Io,tm,od,nm,dc,gt,om,lr,sm,am,Do,rm,im,Oo,dm,lm,lc,So,cc,Be,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,km,hc,Go,uc,hr,mc,en,Cn,id,Uo,vm,dd,bm,fc,Tt,ym,Bo,wm,xm,ld,zm,$m,cd,qm,Em,_c,tn,Nn,pd,Wo,jm,hd,Fm,gc,ur,Mm,Tc,Ln,ud,nn,Pm,Ro,Cm,Nm,Ho,Lm,Am,Im,md,De,Dm,Vo,Om,Sm,Ko,Gm,Um,Yo,Bm,Wm,Zo,Rm,Hm,Jo,Vm,Km,kc,on,An,fd,Xo,Ym,_d,Zm,vc,wt,Qo,Jm,xt,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,bc,an,In,gd,ts,hf,Td,uf,yc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,kf,Tr,vf,bf,yf,jt,rs,wf,kd,xf,zf,is,kr,$f,vd,qf,Ef,vr,jf,bd,Ff,Mf,Dn,ds,Pf,ls,Cf,yd,Nf,Lf,Af,On,cs,If,wd,Df,Of,br,ps,wc,rn,Sn,xd,hs,Sf,zd,Gf,xc,Oe,us,Uf,dn,Bf,$d,Wf,Rf,ms,Hf,Vf,Kf,fs,Yf,yr,Zf,Jf,Xf,Ft,_s,Qf,qd,e_,t_,gs,wr,n_,Ed,o_,s_,xr,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,zc,ln,Un,Md,ks,c_,Pd,p_,$c,J,vs,h_,Cd,u_,m_,bs,f_,ys,__,g_,T_,ws,k_,zr,v_,b_,y_,xs,w_,zs,x_,z_,$_,We,$s,q_,cn,E_,$r,j_,F_,Nd,M_,P_,C_,Bn,N_,Ld,L_,A_,qs,I_,Re,Es,D_,Ad,O_,S_,Id,G_,U_,Dd,B_,W_,js,R_,kt,Fs,H_,Od,V_,K_,Sd,Y_,Z_,Ms,qc,pn,Wn,Gd,Ps,J_,Ud,X_,Ec,X,Cs,Q_,Ns,eg,Bd,tg,ng,og,Ls,sg,As,ag,rg,ig,Is,dg,qr,lg,cg,pg,Ds,hg,Os,ug,mg,fg,He,Ss,_g,hn,gg,Er,Tg,kg,Wd,vg,bg,yg,Rn,wg,Rd,xg,zg,Gs,$g,Ve,Us,qg,Hd,Eg,jg,Vd,Fg,Mg,Kd,Pg,Cg,Bs,Ng,vt,Ws,Lg,Yd,Ag,Ig,Zd,Dg,Og,Rs,jc,un,Hn,Jd,Hs,Sg,Xd,Gg,Fc,Q,Vs,Ug,Qd,Bg,Wg,Ks,Rg,Ys,Hg,Vg,Kg,Zs,Yg,jr,Zg,Jg,Xg,Js,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,kT,vT,na,bT,bt,oa,yT,al,wT,xT,rl,zT,$T,sa,Mc,fn,Kn,il,aa,qT,dl,ET,Pc,de,ra,jT,ll,FT,MT,ia,PT,da,CT,NT,LT,la,AT,Mr,IT,DT,OT,ca,ST,pa,GT,UT,BT,Yn,WT,Ze,ha,RT,_n,HT,Pr,VT,KT,cl,YT,ZT,JT,Zn,XT,pl,QT,ek,ua,Cc,gn,Jn,hl,ma,tk,ul,nk,Nc,le,fa,ok,_a,sk,ml,ak,rk,ik,ga,dk,Ta,lk,ck,pk,ka,hk,Cr,uk,mk,fk,va,_k,ba,gk,Tk,kk,Xn,vk,Je,ya,bk,Tn,yk,Nr,wk,xk,fl,zk,$k,qk,Qn,Ek,_l,jk,Fk,wa,Lc,kn,eo,gl,xa,Mk,Tl,Pk,Ac,ce,za,Ck,kl,Nk,Lk,$a,Ak,qa,Ik,Dk,Ok,Ea,Sk,Lr,Gk,Uk,Bk,ja,Wk,Fa,Rk,Hk,Vk,to,Kk,Xe,Ma,Yk,vn,Zk,Ar,Jk,Xk,vl,Qk,ev,tv,no,nv,bl,ov,sv,Pa,Ic,bn,oo,yl,Ca,av,wl,rv,Dc,lt,Na,iv,Qe,La,dv,yn,lv,xl,cv,pv,zl,hv,uv,mv,so,fv,$l,_v,gv,Aa,Tv,Mt,Ia,kv,ql,vv,bv,Da,yv,Pt,Oa,wv,El,xv,zv,Sa,Oc,wn,ao,jl,Ga,$v,Fl,qv,Sc,ct,Ua,Ev,et,Ba,jv,xn,Fv,Ml,Mv,Pv,Pl,Cv,Nv,Lv,ro,Av,Cl,Iv,Dv,Wa,Ov,Ct,Ra,Sv,Nl,Gv,Uv,Ha,Bv,Nt,Va,Wv,Ll,Rv,Hv,Ka,Gc;return x=new ke({}),se=new ke({}),$o=new ke({}),qo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
loss = model(input_ids=input_ids, attention_mask=attention_mask, labels=labels).loss`}}),Io=new ke({}),So=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Bn=new zt({props:{$$slots:{default:[gw]},$$scope:{ctx:A}}}),qs=new R({props:{code:`from transformers import T5Tokenizer, T5Model
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_t5.py#L1310"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ss=new M({props:{name:"forward",anchor:"transformers.T5ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_t5.py#L1536",parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16275/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
`}}),Rn=new zt({props:{$$slots:{default:[Tw]},$$scope:{ctx:A}}}),Gs=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_t5.py#L1505"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_t5.py#L1807",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16275/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16275/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_t5.py#L1781"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
`}}),Zn=new zt({props:{$$slots:{default:[bw]},$$scope:{ctx:A}}}),ua=new R({props:{code:`from transformers import T5Tokenizer, TFT5Model
...
`}}),Qn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:A}}}),wa=new R({props:{code:`from transformers import T5Tokenizer, TFT5ForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),xa=new ke({}),za=new M({props:{name:"class transformers.TFT5EncoderModel",anchor:"transformers.TFT5EncoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_tf_t5.py#L1614",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16275/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[xw]},$$scope:{ctx:A}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor]"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16275/src/transformers/models/t5/modeling_tf_t5.py#L1632",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
...
`}}),no=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:A}}}),Pa=new R({props:{code:`from transformers import T5Tokenizer, TFT5EncoderModel
...
`}}),so=new zt({props:{$$slots:{default:[$w]},$$scope:{ctx:A}}}),Aa=new R({props:{code:`from transformers import T5Tokenizer, FlaxT5Model
...
<p><a
  href="/docs/transformers/pr_16275/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
>transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),ro=new zt({props:{$$slots:{default:[qw]},$$scope:{ctx:A}}}),Wa=new R({props:{code:`from transformers import T5Tokenizer, FlaxT5ForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=o("meta"),$=d(),b=o("h1"),w=o("a"),z=o("span"),f(x.$$.fragment),y=d(),q=o("span"),qe=r("T5"),oe=d(),E=o("h2"),ee=o("a"),S=o("span"),f(se.$$.fragment),Ee=d(),G=o("span"),je=r("Overview"),ve=d(),U=o("p"),I=r("The T5 model was presented in "),ae=o("a"),pe=r("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),F=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),W=o("em"),Ne=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Se=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),O=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),L=o("a"),Y=r("training"),ut=r(", "),Le=o("a"),Z=r("inference"),mt=r(" and "),Ae=o("a"),Ie=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Op=r("T5 comes in different sizes:"),Kl=d(),Ue=o("ul"),di=o("li"),li=o("p"),To=o("a"),Sp=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),ko=o("a"),Up=r("t5-base"),Bp=d(),hi=o("li"),ui=o("p"),vo=o("a"),Wp=r("t5-large"),Rp=d(),mi=o("li"),fi=o("p"),bo=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),yo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Zp=r("Based on the original T5 model, Google has released some follow-up works:"),Zl=d(),$t=o("ul"),gi=o("li"),zn=o("p"),Ti=o("strong"),Jp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
language modeling head on top of the decoder.`),oc=d(),Mn=o("ul"),dt=o("li"),Ei=o("p"),Mh=r("Unsupervised denoising training"),Ph=d(),_e=o("p"),Ch=r("In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=o("em"),Nh=r("a.k.a"),Lh=r(` unique mask tokens) and
...
sentinel token represents a unique mask token for this sentence and should start with `),Mi=o("code"),Dh=r("<extra_id_0>"),Oh=r(`,
...
`),Di=o("code"),du=r("input_ids"),lu=r(" of the encoded input sequence) and "),Oi=o("code"),cu=r("labels"),pu=r(" (which are the "),Si=o("code"),hu=r("input_ids"),uu=r(` of the encoded
...
of the `),Ki=o("code"),Pu=r("CrossEntropyLoss"),Cu=r(". In Flax, one can use the "),Yi=o("code"),Nu=r("decoder_attention_mask"),Lu=r(` to ignore padded tokens from
the loss (see the `),Mo=o("a"),Au=r("Flax summarization script"),Iu=r(` for details). We also pass
`),Zi=o("code"),Du=r("attention_mask"),Ou=r(` as additional input to the model, which makes sure that padding tokens of the inputs are
...
There\u2019s also `),Oo=o("a"),dm=r("this blog post"),lm=r(` which explains how
...
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Im=d(),md=o("li"),De=o("p"),Dm=r("fine-tuning: T5 is supported by the official summarization scripts ("),Vo=o("a"),Om=r("PyTorch"),Sm=r(", "),Ko=o("a"),Gm=r("Tensorflow"),Um=r(", and "),Yo=o("a"),Bm=r("Flax"),Wm=r(`) and translation scripts
(`),Zo=o("a"),Rm=r("PyTorch"),Hm=r(" and "),Jo=o("a"),Vm=r("Tensorflow"),Km=r(`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),kc=d(),on=o("h2"),An=o("a"),fd=o("span"),f(Xo.$$.fragment),Ym=d(),_d=o("span"),Zm=r("T5Config"),vc=d(),wt=o("div"),f(Qo.$$.fragment),Jm=d(),xt=o("p"),Xm=r("This is the configuration class to store the configuration of a "),mr=o("a"),Qm=r("T5Model"),ef=r(" or a "),fr=o("a"),tf=r("TFT5Model"),nf=r(`. It is used to
...
adding special tokens. A sequence has the following format:`),zf=d(),is=o("ul"),kr=o("li"),$f=r("single sequence: "),vd=o("code"),qf=r("X </s>"),Ef=d(),vr=o("li"),jf=r("pair of sequences: "),bd=o("code"),Ff=r("A </s> B </s>"),Mf=d(),Dn=o("div"),f(ds.$$.fragment),Pf=d(),ls=o("p"),Cf=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=o("code"),Nf=r("prepare_for_model"),Lf=r(" method."),Af=d(),On=o("div"),f(cs.$$.fragment),If=d(),wd=o("p"),Df=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Of=d(),br=o("div"),f(ps.$$.fragment),wc=d(),rn=o("h2"),Sn=o("a"),xd=o("span"),f(hs.$$.fragment),Sf=d(),zd=o("span"),Gf=r("T5TokenizerFast"),xc=d(),Oe=o("div"),f(us.$$.fragment),Uf=d(),dn=o("p"),Bf=r("Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),$d=o("em"),Wf=r("tokenizers"),Rf=r(` library). Based on
...
and behavior.`),$_=d(),We=o("div"),f($s.$$.fragment),q_=d(),cn=o("p"),E_=r("The "),$r=o("a"),j_=r("T5Model"),F_=r(" forward method, overrides the "),Nd=o("code"),M_=r("__call__"),P_=r(" special method."),C_=d(),f(Bn.$$.fragment),N_=d(),Ld=o("p"),L_=r("Example:"),A_=d(),f(qs.$$.fragment),I_=d(),Re=o("div"),f(Es.$$.fragment),D_=d(),Ad=o("p"),O_=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),S_=d(),Id=o("p"),G_=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),U_=d(),Dd=o("p"),B_=r("Example:"),W_=d(),f(js.$$.fragment),R_=d(),kt=o("div"),f(Fs.$$.fragment),H_=d(),Od=o("p"),V_=r("Moves the model to cpu from a model parallel state."),K_=d(),Sd=o("p"),Y_=r("Example:"),Z_=d(),f(Ms.$$.fragment),qc=d(),pn=o("h2"),Wn=o("a"),Gd=o("span"),f(Ps.$$.fragment),J_=d(),Ud=o("span"),X_=r("T5ForConditionalGeneration"),Ec=d(),X=o("div"),f(Cs.$$.fragment),Q_=d(),Ns=o("p"),eg=r("T5 Model with a "),Bd=o("code"),tg=r("language modeling"),ng=r(" head on top."),og=d(),Ls=o("p"),sg=r("The T5 model was proposed in "),As=o("a"),ag=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pg=d(),Ds=o("p"),hg=r("This model is also a PyTorch "),Os=o("a"),ug=r("torch.nn.Module"),mg=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),LT=d(),la=o("p"),AT=r("This model inherits from "),Mr=o("a"),IT=r("TFPreTrainedModel"),DT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),OT=d(),ca=o("p"),ST=r("This model is also a "),pa=o("a"),GT=r("tf.keras.Model"),UT=r(` subclass. Use it
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kk=d(),f(Xn.$$.fragment),vk=d(),Je=o("div"),f(ya.$$.fragment),bk=d(),Tn=o("p"),yk=r("The "),Nr=o("a"),wk=r("TFT5ForConditionalGeneration"),xk=r(" forward method, overrides the "),fl=o("code"),zk=r("__call__"),$k=r(" special method."),qk=d(),f(Qn.$$.fragment),Ek=d(),_l=o("p"),jk=r("Examples:"),Fk=d(),f(wa.$$.fragment),Lc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),Mk=d(),Tl=o("span"),Pk=r("TFT5EncoderModel"),Ac=d(),ce=o("div"),f(za.$$.fragment),Ck=d(),kl=o("p"),Nk=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Lk=d(),$a=o("p"),Ak=r("The T5 model was proposed in "),qa=o("a"),Ik=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Dk=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Ok=d(),Ea=o("p"),Sk=r("This model inherits from "),Lr=o("a"),Gk=r("TFPreTrainedModel"),Uk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bk=d(),ja=o("p"),Wk=r("This model is also a "),Fa=o("a"),Rk=r("tf.keras.Model"),Hk=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vk=d(),f(to.$$.fragment),Kk=d(),Xe=o("div"),f(Ma.$$.fragment),Yk=d(),vn=o("p"),Zk=r("The "),Ar=o("a"),Jk=r("TFT5EncoderModel"),Xk=r(" forward method, overrides the "),vl=o("code"),Qk=r("__call__"),ev=r(" special method."),tv=d(),f(no.$$.fragment),nv=d(),bl=o("p"),ov=r("Examples:"),sv=d(),f(Pa.$$.fragment),Ic=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),av=d(),wl=o("span"),rv=r("FlaxT5Model"),Dc=d(),lt=o("div"),f(Na.$$.fragment),iv=d(),Qe=o("div"),f(La.$$.fragment),dv=d(),yn=o("p"),lv=r("The "),xl=o("code"),cv=r("FlaxT5PreTrainedModel"),pv=r("forward method, overrides the "),zl=o("code"),hv=r("__call__"),uv=r(" special method."),mv=d(),f(so.$$.fragment),fv=d(),$l=o("p"),_v=r("Example:"),gv=d(),f(Aa.$$.fragment),Tv=d(),Mt=o("div"),f(Ia.$$.fragment),kv=d(),ql=o("p"),vv=r("Example:"),bv=d(),f(Da.$$.fragment),yv=d(),Pt=o("div"),f(Oa.$$.fragment),wv=d(),El=o("p"),xv=r("Example:"),zv=d(),f(Sa.$$.fragment),Oc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),$v=d(),Fl=o("span"),qv=r("FlaxT5ForConditionalGeneration"),Sc=d(),ct=o("div"),f(Ua.$$.fragment),Ev=d(),et=o("div"),f(Ba.$$.fragment),jv=d(),xn=o("p"),Fv=r("The "),Ml=o("code"),Mv=r("FlaxT5PreTrainedModel"),Pv=r("forward method, overrides the "),Pl=o("code"),Cv=r("__call__"),Nv=r(" special method."),Lv=d(),f(ro.$$.fragment),Av=d(),Cl=o("p"),Iv=r("Example:"),Dv=d(),f(Wa.$$.fragment),Ov=d(),Ct=o("div"),f(Ra.$$.fragment),Sv=d(),Nl=o("p"),Gv=r("Example:"),Uv=d(),f(Ha.$$.fragment),Bv=d(),Nt=o("div"),f(Va.$$.fragment),Wv=d(),Ll=o("p"),Rv=r("Example:"),Hv=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),$=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Al=a(w);z=s(Al,"SPAN",{});var Il=a(z);_(x.$$.fragment,Il),Il.forEach(t),Al.forEach(t),y=l(Ya),q=s(Ya,"SPAN",{});var Dl=a(q);qe=i(Dl,"T5"),Dl.forEach(t),Ya.forEach(t),oe=l(n),E=s(n,"H2",{class:!0});var Za=a(E);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Ol=a(ee);S=s(Ol,"SPAN",{});var Sl=a(S);_(se.$$.fragment,Sl),Sl.forEach(t),Ol.forEach(t),Ee=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),ve=l(n),U=s(n,"P",{});var Ja=a(U);I=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Ul=a(ae);pe=i(Ul,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Ul.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),W=s(Dr,"EM",{});var ob=a(W);Ne=i(ob,"summarize: \u2026"),ob.forEach(t),m=i(Dr,"."),Dr.forEach(t),tb.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var sb=a(te);Se=s(sb,"P",{});var ab=a(Se);pt=i(ab,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ab.forEach(t),sb.forEach(t),O=l(Ir),Ge=s(Ir,"LI",{});var rb=a(Ge);ne=s(rb,"P",{});var io=a(ne);ht=i(io,"See the "),L=s(io,"A",{href:!0});var ib=a(L);Y=i(ib,"training"),ib.forEach(t),ut=i(io,", "),Le=s(io,"A",{href:!0});var db=a(Le);Z=i(db,"inference"),db.forEach(t),mt=i(io," and "),Ae=s(io,"A",{href:!0});var lb=a(Ae);Ie=i(lb,"scripts"),lb.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rb.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var cb=a(Xa);Op=i(cb,"T5 comes in different sizes:"),cb.forEach(t),Kl=l(n),Ue=s(n,"UL",{});var Lt=a(Ue);di=s(Lt,"LI",{});var pb=a(di);li=s(pb,"P",{});var hb=a(li);To=s(hb,"A",{href:!0,rel:!0});var ub=a(To);Sp=i(ub,"t5-small"),ub.forEach(t),hb.forEach(t),pb.forEach(t),Gp=l(Lt),ci=s(Lt,"LI",{});var mb=a(ci);pi=s(mb,"P",{});var fb=a(pi);ko=s(fb,"A",{href:!0,rel:!0});var _b=a(ko);Up=i(_b,"t5-base"),_b.forEach(t),fb.forEach(t),mb.forEach(t),Bp=l(Lt),hi=s(Lt,"LI",{});var gb=a(hi);ui=s(gb,"P",{});var Tb=a(ui);vo=s(Tb,"A",{href:!0,rel:!0});var kb=a(vo);Wp=i(kb,"t5-large"),kb.forEach(t),Tb.forEach(t),gb.forEach(t),Rp=l(Lt),mi=s(Lt,"LI",{});var vb=a(mi);fi=s(vb,"P",{});var bb=a(fi);bo=s(bb,"A",{href:!0,rel:!0});var yb=a(bo);Hp=i(yb,"t5-3b"),yb.forEach(t),bb.forEach(t),vb.forEach(t),Vp=l(Lt),_i=s(Lt,"LI",{});var wb=a(_i);Qa=s(wb,"P",{});var Vv=a(Qa);yo=s(Vv,"A",{href:!0,rel:!0});var xb=a(yo);Kp=i(xb,"t5-11b"),xb.forEach(t),Yp=i(Vv,"."),Vv.forEach(t),wb.forEach(t),Lt.forEach(t),Yl=l(n),er=s(n,"P",{});var zb=a(er);Zp=i(zb,"Based on the original T5 model, Google has released some follow-up works:"),zb.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Or=a($t);gi=s(Or,"LI",{});var $b=a(gi);zn=s($b,"P",{});var Wl=a(zn);Ti=s(Wl,"STRONG",{});var qb=a(Ti);Jp=i(qb,"T5v1.1"),qb.forEach(t),Xp=i(Wl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Wl,"A",{href:!0});var Eb=a(tr);Qp=i(Eb,"here"),Eb.forEach(t),eh=i(Wl,"."),Wl.forEach(t),$b.forEach(t),th=l(Or),ki=s(Or,"LI",{});var jb=a(ki);$n=s(jb,"P",{});var Rl=a($n);vi=s(Rl,"STRONG",{});var Fb=a(vi);nh=i(Fb,"mT5"),Fb.forEach(t),oh=i(Rl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var Mb=a(nr);sh=i(Mb,"here"),Mb.forEach(t),ah=i(Rl,"."),Rl.forEach(t),jb.forEach(t),rh=l(Or),bi=s(Or,"LI",{});var Pb=a(bi);qn=s(Pb,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var Cb=a(yi);ih=i(Cb,"byT5"),Cb.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Nb=a(or);lh=i(Nb,"here"),Nb.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pb.forEach(t),Or.forEach(t),Jl=l(n),En=s(n,"P",{});var Uc=a(En);ph=i(Uc,"All checkpoints can be found on the "),wo=s(Uc,"A",{href:!0,rel:!0});var Lb=a(wo);hh=i(Lb,"hub"),Lb.forEach(t),uh=i(Uc,"."),Uc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Ab=a(xo);fh=i(Ab,"thomwolf"),Ab.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var Ib=a(zo);gh=i(Ib,"here"),Ib.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Bc=a(Zt);jn=s(Bc,"A",{id:!0,class:!0,href:!0});var Db=a(jn);wi=s(Db,"SPAN",{});var Ob=a(wi);_($o.$$.fragment,Ob),Ob.forEach(t),Db.forEach(t),kh=l(Bc),xi=s(Bc,"SPAN",{});var Sb=a(xi);vh=i(Sb,"Training"),Sb.forEach(t),Bc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),Wc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var At=a(dt);Ei=s(At,"P",{});var Rb=a(Ei);Mh=i(Rb,"Unsupervised denoising training"),Rb.forEach(t),Ph=l(At),_e=s(At,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hb=a(ji);Nh=i(Hb,"a.k.a"),Hb.forEach(t),Lh=i(tt,` unique mask tokens) and
...
sentinel token represents a unique mask token for this sentence and should start with `),Mi=s(tt,"CODE",{});var Kb=a(Mi);Dh=i(Kb,"<extra_id_0>"),Kb.forEach(t),Oh=i(tt,`,
...
`),rr=s(tt,"A",{href:!0});var Jb=a(rr);Wh=i(Jb,"T5Tokenizer"),Jb.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(At),Ni=s(At,"P",{});var Xb=a(Ni);Vh=i(Xb,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
`),Di=s(we,"CODE",{});var o5=a(Di);du=i(o5,"input_ids"),o5.forEach(t),lu=i(we," of the encoded input sequence) and "),Oi=s(we,"CODE",{});var s5=a(Oi);cu=i(s5,"labels"),s5.forEach(t),pu=i(we," (which are the "),Si=s(we,"CODE",{});var a5=a(Si);hu=i(a5,"input_ids"),a5.forEach(t),uu=i(we,` of the encoded
...
of the `),Ki=s(ot,"CODE",{});var u5=a(Ki);Pu=i(u5,"CrossEntropyLoss"),u5.forEach(t),Cu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var m5=a(Yi);Nu=i(m5,"decoder_attention_mask"),m5.forEach(t),Lu=i(ot,` to ignore padded tokens from
...
`),Zi=s(ot,"CODE",{});var _5=a(Zi);Du=i(_5,"attention_mask"),_5.forEach(t),Ou=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
...
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Lo=s(Br,"A",{href:!0,rel:!0});var y5=a(Lo);Yu=i(y5,"paper"),y5.forEach(t),Zu=i(Br,` for the task prefixes
used).`),Br.forEach(t),v5.forEach(t),Ju=l(Ur),ed=s(Ur,"LI",{});var w5=a(ed);Ao=s(w5,"P",{});var Kc=a(Ao);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
There\u2019s also `),Oo=s(co,"A",{href:!0,rel:!0});var F5=a(Oo);dm=i(F5,"this blog post"),F5.forEach(t),lm=i(co,` which explains how
generation works in general in encoder-decoder models.`),co.forEach(t),lc=l(n),_(So.$$.fragment,n),cc=l(n),Be=s(n,"P",{});var It=a(Be);cm=i(It,"Note that T5 uses the "),sd=s(It,"CODE",{});var M5=a(sd);pm=i(M5,"pad_token_id"),M5.forEach(t),hm=i(It," as the "),ad=s(It,"CODE",{});var P5=a(ad);um=i(P5,"decoder_start_token_id"),P5.forEach(t),mm=i(It,`, so when doing generation without using
`),cr=s(It,"A",{href:!0});var C5=a(cr);fm=i(C5,"generate()"),C5.forEach(t),_m=i(It,", make sure you start it with the "),rd=s(It,"CODE",{});var N5=a(rd);gm=i(N5,"pad_token_id"),N5.forEach(t),Tm=i(It,"."),It.forEach(t),pc=l(n),pr=s(n,"P",{});var L5=a(pr);km=i(L5,"The example above only shows a single example. You can also do batched inference, like so:"),L5.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Cn=s(Zc,"A",{id:!0,class:!0,href:!0});var A5=a(Cn);id=s(A5,"SPAN",{});var I5=a(id);_(Uo.$$.fragment,I5),I5.forEach(t),A5.forEach(t),vm=l(Zc),dd=s(Zc,"SPAN",{});var D5=a(dd);bm=i(D5,"Performance"),D5.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Bo=s(po,"A",{href:!0,rel:!0});var O5=a(Bo);wm=i(O5,"apex"),O5.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var S5=a(ld);zm=i(S5,"apex.normalization.FusedRMSNorm"),S5.forEach(t),$m=i(po," instead of "),cd=s(po,"CODE",{});var G5=a(cd);qm=i(G5,"T5LayerNorm"),G5.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);Nn=s(Jc,"A",{id:!0,class:!0,href:!0});var U5=a(Nn);pd=s(U5,"SPAN",{});var B5=a(pd);_(Wo.$$.fragment,B5),B5.forEach(t),U5.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var W5=a(hd);Fm=i(W5,"Example scripts"),W5.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var R5=a(ur);Mm=i(R5,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),R5.forEach(t),Tc=l(n),Ln=s(n,"UL",{});var Xc=a(Ln);ud=s(Xc,"LI",{});var H5=a(ud);nn=s(H5,"P",{});var Wr=a(nn);Pm=i(Wr,"pre-training: the "),Ro=s(Wr,"A",{href:!0,rel:!0});var V5=a(Ro);Cm=i(V5,"run_t5_mlm_flax.py"),V5.forEach(t),Nm=i(Wr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Wr,"A",{href:!0,rel:!0});var K5=a(Ho);Lm=i(K5,"t5_tokenizer_model.py"),K5.forEach(t),Am=i(Wr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Wr.forEach(t),H5.forEach(t),Im=l(Xc),md=s(Xc,"LI",{});var Y5=a(md);De=s(Y5,"P",{});var yt=a(De);Dm=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Z5=a(Vo);Om=i(Z5,"PyTorch"),Z5.forEach(t),Sm=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var J5=a(Ko);Gm=i(J5,"Tensorflow"),J5.forEach(t),Um=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var X5=a(Yo);Bm=i(X5,"Flax"),X5.forEach(t),Wm=i(yt,`) and translation scripts
...
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var g1=a(yd);Nf=i(g1,"prepare_for_model"),g1.forEach(t),Lf=i(ap," method."),ap.forEach(t),sp.forEach(t),Af=l(st),On=s(st,"DIV",{class:!0});var rp=a(On);_(cs.$$.fragment,rp),If=l(rp),wd=s(rp,"P",{});var T1=a(wd);Df=i(T1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T1.forEach(t),rp.forEach(t),Of=l(st),br=s(st,"DIV",{class:!0});var k1=a(br);_(ps.$$.fragment,k1),k1.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);Sn=s(ip,"A",{id:!0,class:!0,href:!0});var v1=a(Sn);xd=s(v1,"SPAN",{});var b1=a(xd);_(hs.$$.fragment,b1),b1.forEach(t),v1.forEach(t),Sf=l(ip),zd=s(ip,"SPAN",{});var y1=a(zd);Gf=i(y1,"T5TokenizerFast"),y1.forEach(t),ip.forEach(t),xc=l(n),Oe=s(n,"DIV",{class:!0});var Dt=a(Oe);_(us.$$.fragment,Dt),Uf=l(Dt),dn=s(Dt,"P",{});var Kr=a(dn);Bf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),$d=s(Kr,"EM",{});var w1=a($d);Wf=i(w1,"tokenizers"),w1.forEach(t),Rf=i(Kr,` library). Based on
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),$_=l(xe),We=s(xe,"DIV",{class:!0});var Ot=a(We);_($s.$$.fragment,Ot),q_=l(Ot),cn=s(Ot,"P",{});var Zr=a(cn);E_=i(Zr,"The "),$r=s(Zr,"A",{href:!0});var I1=a($r);j_=i(I1,"T5Model"),I1.forEach(t),F_=i(Zr," forward method, overrides the "),Nd=s(Zr,"CODE",{});var D1=a(Nd);M_=i(D1,"__call__"),D1.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(Ot),_(Bn.$$.fragment,Ot),N_=l(Ot),Ld=s(Ot,"P",{});var O1=a(Ld);L_=i(O1,"Example:"),O1.forEach(t),A_=l(Ot),_(qs.$$.fragment,Ot),Ot.forEach(t),I_=l(xe),Re=s(xe,"DIV",{class:!0});var St=a(Re);_(Es.$$.fragment,St),D_=l(St),Ad=s(St,"P",{});var S1=a(Ad);O_=i(S1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),S1.forEach(t),S_=l(St),Id=s(St,"P",{});var G1=a(Id);G_=i(G1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G1.forEach(t),U_=l(St),Dd=s(St,"P",{});var U1=a(Dd);B_=i(U1,"Example:"),U1.forEach(t),W_=l(St),_(js.$$.fragment,St),St.forEach(t),R_=l(xe),kt=s(xe,"DIV",{class:!0});var uo=a(kt);_(Fs.$$.fragment,uo),H_=l(uo),Od=s(uo,"P",{});var B1=a(Od);V_=i(B1,"Moves the model to cpu from a model parallel state."),B1.forEach(t),K_=l(uo),Sd=s(uo,"P",{});var W1=a(Sd);Y_=i(W1,"Example:"),W1.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Wn=s(fp,"A",{id:!0,class:!0,href:!0});var R1=a(Wn);Gd=s(R1,"SPAN",{});var H1=a(Gd);_(Ps.$$.fragment,H1),H1.forEach(t),R1.forEach(t),J_=l(fp),Ud=s(fp,"SPAN",{});var V1=a(Ud);X_=i(V1,"T5ForConditionalGeneration"),V1.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),Ns=s(ze,"P",{});var _p=a(Ns);eg=i(_p,"T5 Model with a "),Bd=s(_p,"CODE",{});var K1=a(Bd);tg=i(K1,"language modeling"),K1.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),Ls=s(ze,"P",{});var gp=a(Ls);sg=i(gp,"The T5 model was proposed in "),As=s(gp,"A",{href:!0,rel:!0});var Y1=a(As);ag=i(Y1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ds=s(ze,"P",{});var kp=a(Ds);hg=i(kp,"This model is also a PyTorch "),Os=s(kp,"A",{href:!0,rel:!0});var J1=a(Os);ug=i(J1,"torch.nn.Module"),J1.forEach(t),mg=i(kp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),zp.forEach(t),LT=l(at),la=s(at,"P",{});var $p=a(la);AT=i($p,"This model inherits from "),Mr=s($p,"A",{href:!0});var $y=a(Mr);IT=i($y,"TFPreTrainedModel"),$y.forEach(t),DT=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),OT=l(at),ca=s(at,"P",{});var qp=a(ca);ST=i(qp,"This model is also a "),pa=s(qp,"A",{href:!0,rel:!0});var qy=a(pa);GT=i(qy,"tf.keras.Model"),qy.forEach(t),UT=i(qp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qp.forEach(t),BT=l(at),_(Yn.$$.fragment,at),WT=l(at),Ze=s(at,"DIV",{class:!0});var Rt=a(Ze);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var Ey=a(Pr);VT=i(Ey,"TFT5Model"),Ey.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var jy=a(cl);YT=i(jy,"__call__"),jy.forEach(t),ZT=i(Qr," special method."),Qr.forEach(t),JT=l(Rt),_(Zn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var Fy=a(pl);QT=i(Fy,"Examples:"),Fy.forEach(t),ek=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var Ep=a(gn);Jn=s(Ep,"A",{id:!0,class:!0,href:!0});var My=a(Jn);hl=s(My,"SPAN",{});var Py=a(hl);_(ma.$$.fragment,Py),Py.forEach(t),My.forEach(t),tk=l(Ep),ul=s(Ep,"SPAN",{});var Cy=a(ul);nk=i(Cy,"TFT5ForConditionalGeneration"),Cy.forEach(t),Ep.forEach(t),Nc=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),ok=l(rt),_a=s(rt,"P",{});var jp=a(_a);sk=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var Ny=a(ml);ak=i(Ny,"language modeling"),Ny.forEach(t),rk=i(jp," head on top."),jp.forEach(t),ik=l(rt),ga=s(rt,"P",{});var Fp=a(ga);dk=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var Ly=a(Ta);lk=i(Ly,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ly.forEach(t),ck=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),pk=l(rt),ka=s(rt,"P",{});var Mp=a(ka);hk=i(Mp,"This model inherits from "),Cr=s(Mp,"A",{href:!0});var Ay=a(Cr);uk=i(Ay,"TFPreTrainedModel"),Ay.forEach(t),mk=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),kk=l(rt),_(Xn.$$.fragment,rt),vk=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),bk=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);yk=i(ei,"The "),Nr=s(ei,"A",{href:!0});var Dy=a(Nr);wk=i(Dy,"TFT5ForConditionalGeneration"),Dy.forEach(t),xk=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var Oy=a(fl);zk=i(Oy,"__call__"),Oy.forEach(t),$k=i(ei," special method."),ei.forEach(t),qk=l(Ht),_(Qn.$$.fragment,Ht),Ek=l(Ht),_l=s(Ht,"P",{});var Sy=a(_l);jk=i(Sy,"Examples:"),Sy.forEach(t),Fk=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Lc=l(n),kn=s(n,"H2",{class:!0});var Cp=a(kn);eo=s(Cp,"A",{id:!0,class:!0,href:!0});var Gy=a(eo);gl=s(Gy,"SPAN",{});var Uy=a(gl);_(xa.$$.fragment,Uy),Uy.forEach(t),Gy.forEach(t),Mk=l(Cp),Tl=s(Cp,"SPAN",{});var By=a(Tl);Pk=i(By,"TFT5EncoderModel"),By.forEach(t),Cp.forEach(t),Ac=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),Ck=l(it),kl=s(it,"P",{});var Wy=a(kl);Nk=i(Wy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Wy.forEach(t),Lk=l(it),$a=s(it,"P",{});var Np=a($a);Ak=i(Np,"The T5 model was proposed in "),qa=s(Np,"A",{href:!0,rel:!0});var Ry=a(qa);Ik=i(Ry,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ry.forEach(t),Dk=i(Np,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Np.forEach(t),Ok=l(it),Ea=s(it,"P",{});var Lp=a(Ea);Sk=i(Lp,"This model inherits from "),Lr=s(Lp,"A",{href:!0});var Hy=a(Lr);Gk=i(Hy,"TFPreTrainedModel"),Hy.forEach(t),Uk=i(Lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lp.forEach(t),Bk=l(it),ja=s(it,"P",{});var Ap=a(ja);Wk=i(Ap,"This model is also a "),Fa=s(Ap,"A",{href:!0,rel:!0});var Vy=a(Fa);Rk=i(Vy,"tf.keras.Model"),Vy.forEach(t),Hk=i(Ap,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ap.forEach(t),Vk=l(it),_(to.$$.fragment,it),Kk=l(it),Xe=s(it,"DIV",{class:!0});var Vt=a(Xe);_(Ma.$$.fragment,Vt),Yk=l(Vt),vn=s(Vt,"P",{});var ti=a(vn);Zk=i(ti,"The "),Ar=s(ti,"A",{href:!0});var Ky=a(Ar);Jk=i(Ky,"TFT5EncoderModel"),Ky.forEach(t),Xk=i(ti," forward method, overrides the "),vl=s(ti,"CODE",{});var Yy=a(vl);Qk=i(Yy,"__call__"),Yy.forEach(t),ev=i(ti," special method."),ti.forEach(t),tv=l(Vt),_(no.$$.fragment,Vt),nv=l(Vt),bl=s(Vt,"P",{});var Zy=a(bl);ov=i(Zy,"Examples:"),Zy.forEach(t),sv=l(Vt),_(Pa.$$.fragment,Vt),Vt.forEach(t),it.forEach(t),Ic=l(n),bn=s(n,"H2",{class:!0});var Ip=a(bn);oo=s(Ip,"A",{id:!0,class:!0,href:!0});var Jy=a(oo);yl=s(Jy,"SPAN",{});var Xy=a(yl);_(Ca.$$.fragment,Xy),Xy.forEach(t),Jy.forEach(t),av=l(Ip),wl=s(Ip,"SPAN",{});var Qy=a(wl);rv=i(Qy,"FlaxT5Model"),Qy.forEach(t),Ip.forEach(t),Dc=l(n),lt=s(n,"DIV",{class:!0});var _o=a(lt);_(Na.$$.fragment,_o),iv=l(_o),Qe=s(_o,"DIV",{class:!0});var Kt=a(Qe);_(La.$$.fragment,Kt),dv=l(Kt),yn=s(Kt,"P",{});var ni=a(yn);lv=i(ni,"The "),xl=s(ni,"CODE",{});var ew=a(xl);cv=i(ew,"FlaxT5PreTrainedModel"),ew.forEach(t),pv=i(ni,"forward method, overrides the "),zl=s(ni,"CODE",{});var tw=a(zl);hv=i(tw,"__call__"),tw.forEach(t),uv=i(ni," special method."),ni.forEach(t),mv=l(Kt),_(so.$$.fragment,Kt),fv=l(Kt),$l=s(Kt,"P",{});var nw=a($l);_v=i(nw,"Example:"),nw.forEach(t),gv=l(Kt),_(Aa.$$.fragment,Kt),Kt.forEach(t),Tv=l(_o),Mt=s(_o,"DIV",{class:!0});var oi=a(Mt);_(Ia.$$.fragment,oi),kv=l(oi),ql=s(oi,"P",{});var ow=a(ql);vv=i(ow,"Example:"),ow.forEach(t),bv=l(oi),_(Da.$$.fragment,oi),oi.forEach(t),yv=l(_o),Pt=s(_o,"DIV",{class:!0});var si=a(Pt);_(Oa.$$.fragment,si),wv=l(si),El=s(si,"P",{});var sw=a(El);xv=i(sw,"Example:"),sw.forEach(t),zv=l(si),_(Sa.$$.fragment,si),si.forEach(t),_o.forEach(t),Oc=l(n),wn=s(n,"H2",{class:!0});var Dp=a(wn);ao=s(Dp,"A",{id:!0,class:!0,href:!0});var aw=a(ao);jl=s(aw,"SPAN",{});var rw=a(jl);_(Ga.$$.fragment,rw),rw.forEach(t),aw.forEach(t),$v=l(Dp),Fl=s(Dp,"SPAN",{});var iw=a(Fl);qv=i(iw,"FlaxT5ForConditionalGeneration"),iw.forEach(t),Dp.forEach(t),Sc=l(n),ct=s(n,"DIV",{class:!0});var go=a(ct);_(Ua.$$.fragment,go),Ev=l(go),et=s(go,"DIV",{class:!0});var Yt=a(et);_(Ba.$$.fragment,Yt),jv=l(Yt),xn=s(Yt,"P",{});var ai=a(xn);Fv=i(ai,"The "),Ml=s(ai,"CODE",{});var dw=a(Ml);Mv=i(dw,"FlaxT5PreTrainedModel"),dw.forEach(t),Pv=i(ai,"forward method, overrides the "),Pl=s(ai,"CODE",{});var lw=a(Pl);Cv=i(lw,"__call__"),lw.forEach(t),Nv=i(ai," special method."),ai.forEach(t),Lv=l(Yt),_(ro.$$.fragment,Yt),Av=l(Yt),Cl=s(Yt,"P",{});var cw=a(Cl);Iv=i(cw,"Example:"),cw.forEach(t),Dv=l(Yt),_(Wa.$$.fragment,Yt),Yt.forEach(t),Ov=l(go),Ct=s(go,"DIV",{class:!0});var ri=a(Ct);_(Ra.$$.fragment,ri),Sv=l(ri),Nl=s(ri,"P",{});var pw=a(Nl);Gv=i(pw,"Example:"),pw.forEach(t),Uv=l(ri),_(Ha.$$.fragment,ri),ri.forEach(t),Bv=l(go),Nt=s(go,"DIV",{class:!0});var ii=a(Nt);_(Va.$$.fragment,ii),Wv=l(ii),Ll=s(ii,"P",{});var hw=a(Ll);Rv=i(hw,"Example:"),hw.forEach(t),Hv=l(ii),_(Ka.$$.fragment,ii),ii.forEach(t),go.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(jw)),c(w,"id","t5"),c(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(w,"href","#t5"),c(b,"class","relative group"),c(ee,"id","overview"),c(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ee,"href","#overview"),c(E,"class","relative group"),c(ae,"href","https://arxiv.org/pdf/1910.10683.pdf"),c(ae,"rel","nofollow"),c(L,"href","#training"),c(Le,"href","#inference"),c(Ae,"href","#scripts"),c(To,"href","https://huggingface.co/t5-small"),c(To,"rel","nofollow"),c(ko,"href","https://huggingface.co/t5-base"),c(ko,"rel","nofollow"),c(vo,"href","https://huggingface.co/t5-large"),c(vo,"rel","nofollow"),c(bo,"href","https://huggingface.co/t5-3b"),c(bo,"rel","nofollow"),c(yo,"href","https://huggingface.co/t5-11b"),c(yo,"rel","nofollow"),c(tr,"href","t5v1.1"),c(nr,"href","mt5"),c(or,"href","byt5"),c(wo,"href","https://huggingface.co/models?search=t5"),c(wo,"rel","nofollow"),c(xo,"href","https://huggingface.co/thomwolf"),c(xo,"rel","nofollow"),c(zo,"href","https://github.com/google-research/text-to-text-transfer-transformer"),c(zo,"rel","nofollow"),c(sr,"id","training"),c(jn,"id","training"),c(jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jn,"href","#training"),c(Zt,"class","relative group"),c(ar,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.T5ForConditionalGeneration"),c(rr,"href","/docs/transformers/pr_16275/en/model_doc/mt5#transformers.T5Tokenizer"),c(jo,"href","https://github.com/huggingface/transformers/tree/master/examples/flax/language-modeling"),c(jo,"rel","nofollow"),c(Mo,"href","https://github.com/huggingface/transformers/tree/master/examples/flax/summarization"),c(Mo,"rel","nofollow"),c(No,"href","https://discuss.huggingface.co/t/t5-finetuning-tips/684"),c(No,"rel","nofollow"),c(Lo,"href","https://arxiv.org/pdf/1910.10683.pdf"),c(Lo,"rel","nofollow"),c(dr,"id","inference"),c(Pn,"id","inference"),c(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pn,"href","#inference"),c(Qt,"class","relative group"),c(lr,"href","/docs/transformers/pr_16275/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Do,"href","https://huggingface.co/blog/how-to-generate"),c(Do,"rel","nofollow"),c(Oo,"href","https://huggingface.co/blog/encoder-decoder#encoder-decoder"),c(Oo,"rel","nofollow"),c(cr,"href","/docs/transformers/pr_16275/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(hr,"id","scripts"),c(Cn,"id","performance"),c(Cn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Cn,"href","#performance"),c(en,"class","relative group"),c(Bo,"href","https://github.com/NVIDIA/apex#quick-start"),c(Bo,"rel","nofollow"),c(Nn,"id","example-scripts"),c(Nn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nn,"href","#example-scripts"),c(tn,"class","relative group"),c(Ro,"href","https://github.com/huggingface/transformers/blob/master/examples/flax/language-modeling/run_t5_mlm_flax.py"),c(Ro,"rel","nofollow"),c(Ho,"href","https://github.com/huggingface/transformers/blob/master/examples/flax/language-modeling/t5_tokenizer_model.py"),c(Ho,"rel","nofollow"),c(Vo,"href","https://github.com/huggingface/transformers/tree/master/examples/pytorch/summarization"),c(Vo,"rel","nofollow"),c(Ko,"href","https://github.com/huggingface/transformers/tree/master/examples/tensorflow/summarization"),c(Ko,"rel","nofollow"),c(Yo,"href","https://github.com/huggingface/transformers/tree/master/examples/flax/summarization"),c(Yo,"rel","nofollow"),c(Zo,"href","https://github.com/huggingface/transformers/tree/master/examples/pytorch/translation"),c(Zo,"rel","nofollow"),c(Jo,"href","https://github.com/huggingface/transformers/tree/master/examples/tensorflow/translation"),c(Jo,"rel","nofollow"),c(An,"id","transformers.T5Config"),c(An,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(An,"href","#transformers.T5Config"),c(on,"class","relative group"),c(mr,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.T5Model"),c(fr,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.TFT5Model"),c(es,"href","https://huggingface.co/t5-small"),c(es,"rel","nofollow"),c(_r,"href","/docs/transformers/pr_16275/en/main_classes/configuration#transformers.PretrainedConfig"),c(gr,"href","/docs/transformers/pr_16275/en/main_classes/configuration#transformers.PretrainedConfig"),c(wt,"class","docstring"),c(In,"id","transformers.T5Tokenizer"),c(In,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(In,"href","#transformers.T5Tokenizer"),c(an,"class","relative group"),c(ss,"href","https://github.com/google/sentencepiece"),c(ss,"rel","nofollow"),c(Tr,"href","/docs/transformers/pr_16275/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(jt,"class","docstring"),c(Dn,"class","docstring"),c(On,"class","docstring"),c(br,"class","docstring"),c(ie,"class","docstring"),c(Sn,"id","transformers.T5TokenizerFast"),c(Sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Sn,"href","#transformers.T5TokenizerFast"),c(rn,"class","relative group"),c(ms,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),c(ms,"rel","nofollow"),c(yr,"href","/docs/transformers/pr_16275/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),c(Ft,"class","docstring"),c(Gn,"class","docstring"),c(Oe,"class","docstring"),c(Un,"id","transformers.T5Model"),c(Un,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Un,"href","#transformers.T5Model"),c(ln,"class","relative group"),c(ys,"href","https://arxiv.org/abs/1910.10683"),c(ys,"rel","nofollow"),c(zr,"href","/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel"),c(zs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(zs,"rel","nofollow"),c($r,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.T5Model"),c(We,"class","docstring"),c(Re,"class","docstring"),c(kt,"class","docstring"),c(J,"class","docstring"),c(Wn,"id","transformers.T5ForConditionalGeneration"),c(Wn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wn,"href","#transformers.T5ForConditionalGeneration"),c(pn,"class","relative group"),c(As,"href","https://arxiv.org/abs/1910.10683"),c(As,"rel","nofollow"),c(qr,"href","/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel"),c(Os,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Os,"rel","nofollow"),c(Er,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.T5ForConditionalGeneration"),c(He,"class","docstring"),c(Ve,"class","docstring"),c(vt,"class","docstring"),c(X,"class","docstring"),c(Hn,"id","transformers.T5EncoderModel"),c(Hn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Hn,"href","#transformers.T5EncoderModel"),c(un,"class","relative group"),c(Ys,"href","https://arxiv.org/abs/1910.10683"),c(Ys,"rel","nofollow"),c(jr,"href","/docs/transformers/pr_16275/en/main_classes/model#transformers.PreTrainedModel"),c(Xs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Xs,"rel","nofollow"),c(Fr,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.T5EncoderModel"),c(Ke,"class","docstring"),c(Ye,"class","docstring"),c(bt,"class","docstring"),c(Q,"class","docstring"),c(Kn,"id","transformers.TFT5Model"),c(Kn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kn,"href","#transformers.TFT5Model"),c(fn,"class","relative group"),c(da,"href","https://arxiv.org/abs/1910.10683"),c(da,"rel","nofollow"),c(Mr,"href","/docs/transformers/pr_16275/en/main_classes/model#transformers.TFPreTrainedModel"),c(pa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(pa,"rel","nofollow"),c(Pr,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.TFT5Model"),c(Ze,"class","docstring"),c(de,"class","docstring"),c(Jn,"id","transformers.TFT5ForConditionalGeneration"),c(Jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Jn,"href","#transformers.TFT5ForConditionalGeneration"),c(gn,"class","relative group"),c(Ta,"href","https://arxiv.org/abs/1910.10683"),c(Ta,"rel","nofollow"),c(Cr,"href","/docs/transformers/pr_16275/en/main_classes/model#transformers.TFPreTrainedModel"),c(ba,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(ba,"rel","nofollow"),c(Nr,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.TFT5ForConditionalGeneration"),c(Je,"class","docstring"),c(le,"class","docstring"),c(eo,"id","transformers.TFT5EncoderModel"),c(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(eo,"href","#transformers.TFT5EncoderModel"),c(kn,"class","relative group"),c(qa,"href","https://arxiv.org/abs/1910.10683"),c(qa,"rel","nofollow"),c(Lr,"href","/docs/transformers/pr_16275/en/main_classes/model#transformers.TFPreTrainedModel"),c(Fa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Fa,"rel","nofollow"),c(Ar,"href","/docs/transformers/pr_16275/en/model_doc/t5#transformers.TFT5EncoderModel"),c(Xe,"class","docstring"),c(ce,"class","docstring"),c(oo,"id","transformers.FlaxT5Model"),c(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(oo,"href","#transformers.FlaxT5Model"),c(bn,"class","relative group"),c(Qe,"class","docstring"),c(Mt,"class","docstring"),c(Pt,"class","docstring"),c(lt,"class","docstring"),c(ao,"id","transformers.FlaxT5ForConditionalGeneration"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.FlaxT5ForConditionalGeneration"),c(wn,"class","relative group"),c(et,"class","docstring"),c(Ct,"class","docstring"),c(Nt,"class","docstring"),c(ct,"class","docstring")},m(n,h){e(document.head,u),p(n,$,h),p(n,b,h),e(b,w),e(w,z),g(x,z,null),e(b,y),e(b,q),e(q,qe),p(n,oe,h),p(n,E,h),e(E,ee),e(ee,S),g(se,S,null),e(E,Ee),e(E,G),e(G,je),p(n,ve,h),p(n,U,h),e(U,I),e(U,ae),e(ae,pe),e(U,F),p(n,C,h),p(n,he,h),e(he,K),p(n,be,h),p(n,ue,h),e(ue,B),e(B,Fe),p(n,ye,h),p(n,P,h),e(P,Me),p(n,H,h),p(n,V,h),e(V,me),e(me,N),e(N,Pe),e(N,fe),e(fe,D),e(N,Ce),e(N,W),e(W,Ne),e(N,m),e(V,j),e(V,te),e(te,Se),e(Se,pt),e(V,O),e(V,Ge),e(Ge,ne),e(ne,ht),e(ne,L),e(L,Y),e(ne,ut),e(ne,Le),e(Le,Z),e(ne,mt),e(ne,Ae),e(Ae,Ie),e(ne,ft),p(n,Vl,h),p(n,Xa,h),e(Xa,Op),p(n,Kl,h),p(n,Ue,h),e(Ue,di),e(di,li),e(li,To),e(To,Sp),e(Ue,Gp),e(Ue,ci),e(ci,pi),e(pi,ko),e(ko,Up),e(Ue,Bp),e(Ue,hi),e(hi,ui),e(ui,vo),e(vo,Wp),e(Ue,Rp),e(Ue,mi),e(mi,fi),e(fi,bo),e(bo,Hp),e(Ue,Vp),e(Ue,_i),e(_i,Qa),e(Qa,yo),e(yo,Kp),e(Qa,Yp),p(n,Yl,h),p(n,er,h),e(er,Zp),p(n,Zl,h),p(n,$t,h),e($t,gi),e(gi,zn),e(zn,Ti),e(Ti,Jp),e(zn,Xp),e(zn,tr),e(tr,Qp),e(zn,eh),e($t,th),e($t,ki),e(ki,$n),e($n,vi),e(vi,nh),e($n,oh),e($n,nr),e(nr,sh),e($n,ah),e($t,rh),e($t,bi),e(bi,qn),e(qn,yi),e(yi,ih),e(qn,dh),e(qn,or),e(or,lh),e(qn,ch),p(n,Jl,h),p(n,En,h),e(En,ph),e(En,wo),e(wo,hh),e(En,uh),p(n,Xl,h),p(n,qt,h),e(qt,mh),e(qt,xo),e(xo,fh),e(qt,_h),e(qt,zo),e(zo,gh),e(qt,Th),p(n,Ql,h),p(n,sr,h),p(n,ec,h),p(n,Zt,h),e(Zt,jn),e(jn,wi),g($o,wi,null),e(Zt,kh),e(Zt,xi),e(xi,vh),p(n,tc,h),p(n,_t,h),e(_t,bh),e(_t,zi),e(zi,yh),e(_t,wh),e(_t,$i),e($i,xh),e(_t,zh),e(_t,qi),e(qi,$h),e(_t,qh),p(n,nc,h),p(n,Fn,h),e(Fn,Eh),e(Fn,ar),e(ar,jh),e(Fn,Fh),p(n,oc,h),p(n,Mn,h),e(Mn,dt),e(dt,Ei),e(Ei,Mh),e(dt,Ph),e(dt,_e),e(_e,Ch),e(_e,ji),e(ji,Nh),e(_e,Lh),e(_e,Fi),e(Fi,Ah),e(_e,Ih),e(_e,Mi),e(Mi,Dh),e(_e,Oh),e(_e,Pi),e(Pi,Sh),e(_e,Gh),e(_e,Ci),e(Ci,Uh),e(_e,Bh),e(_e,rr),e(rr,Wh),e(_e,Rh),e(dt,Hh),e(dt,Ni),e(Ni,Vh),e(dt,Kh),g(qo,dt,null),e(dt,Yh),e(dt,Eo),e(Eo,Zh),e(Eo,jo),e(jo,Jh),e(Eo,Xh),e(Mn,Qh),e(Mn,ge),e(ge,Li),e(Li,eu),e(ge,tu),e(ge,Ai),e(Ai,nu),e(ge,ou),g(Fo,ge,null),e(ge,su),e(ge,re),e(re,au),e(re,Ii),e(Ii,ru),e(re,iu),e(re,Di),e(Di,du),e(re,lu),e(re,Oi),e(Oi,cu),e(re,pu),e(re,Si),e(Si,hu),e(re,uu),e(re,Gi),e(Gi,mu),e(re,fu),e(re,Ui),e(Ui,_u),e(re,gu),e(re,Bi),e(Bi,Tu),e(re,ku),e(ge,vu),e(ge,Jt),e(Jt,bu),e(Jt,Wi),e(Wi,yu),e(Jt,wu),e(Jt,Ri),e(Ri,xu),e(Jt,zu),e(ge,$u),e(ge,Te),e(Te,qu),e(Te,Hi),e(Hi,Eu),e(Te,ju),e(Te,Vi),e(Vi,Fu),e(Te,Mu),e(Te,Ki),e(Ki,Pu),e(Te,Cu),e(Te,Yi),e(Yi,Nu),e(Te,Lu),e(Te,Mo),e(Mo,Au),e(Te,Iu),e(Te,Zi),e(Zi,Du),e(Te,Ou),e(ge,Su),g(Po,ge,null),p(n,sc,h),p(n,ir,h),e(ir,Gu),p(n,ac,h),p(n,Et,h),e(Et,Ji),e(Ji,Co),e(Co,Uu),e(Co,Xi),e(Xi,Bu),e(Co,Wu),e(Et,Ru),e(Et,Qi),e(Qi,Xt),e(Xt,Hu),e(Xt,No),e(No,Vu),e(Xt,Ku),e(Xt,Lo),e(Lo,Yu),e(Xt,Zu),e(Et,Ju),e(Et,ed),e(ed,Ao),e(Ao,Xu),e(Ao,td),e(td,Qu),e(Ao,em),p(n,rc,h),p(n,dr,h),p(n,ic,h),p(n,Qt,h),e(Qt,Pn),e(Pn,nd),g(Io,nd,null),e(Qt,tm),e(Qt,od),e(od,nm),p(n,dc,h),p(n,gt,h),e(gt,om),e(gt,lr),e(lr,sm),e(gt,am),e(gt,Do),e(Do,rm),e(gt,im),e(gt,Oo),e(Oo,dm),e(gt,lm),p(n,lc,h),g(So,n,h),p(n,cc,h),p(n,Be,h),e(Be,cm),e(Be,sd),e(sd,pm),e(Be,hm),e(Be,ad),e(ad,um),e(Be,mm),e(Be,cr),e(cr,fm),e(Be,_m),e(Be,rd),e(rd,gm),e(Be,Tm),p(n,pc,h),p(n,pr,h),e(pr,km),p(n,hc,h),g(Go,n,h),p(n,uc,h),p(n,hr,h),p(n,mc,h),p(n,en,h),e(en,Cn),e(Cn,id),g(Uo,id,null),e(en,vm),e(en,dd),e(dd,bm),p(n,fc,h),p(n,Tt,h),e(Tt,ym),e(Tt,Bo),e(Bo,wm),e(Tt,xm),e(Tt,ld),e(ld,zm),e(Tt,$m),e(Tt,cd),e(cd,qm),e(Tt,Em),p(n,_c,h),p(n,tn,h),e(tn,Nn),e(Nn,pd),g(Wo,pd,null),e(tn,jm),e(tn,hd),e(hd,Fm),p(n,gc,h),p(n,ur,h),e(ur,Mm),p(n,Tc,h),p(n,Ln,h),e(Ln,ud),e(ud,nn),e(nn,Pm),e(nn,Ro),e(Ro,Cm),e(nn,Nm),e(nn,Ho),e(Ho,Lm),e(nn,Am),e(Ln,Im),e(Ln,md),e(md,De),e(De,Dm),e(De,Vo),e(Vo,Om),e(De,Sm),e(De,Ko),e(Ko,Gm),e(De,Um),e(De,Yo),e(Yo,Bm),e(De,Wm),e(De,Zo),e(Zo,Rm),e(De,Hm),e(De,Jo),e(Jo,Vm),e(De,Km),p(n,kc,h),p(n,on,h),e(on,An),e(An,fd),g(Xo,fd,null),e(on,Ym),e(on,_d),e(_d,Zm),p(n,vc,h),p(n,wt,h),g(Qo,wt,null),e(wt,Jm),e(wt,xt),e(xt,Xm),e(xt,mr),e(mr,Qm),e(xt,ef),e(xt,fr),e(fr,tf),e(xt,nf),e(xt,es),e(es,of),e(xt,sf),e(wt,af),e(wt,sn),e(sn,rf),e(sn,_r),e(_r,df),e(sn,lf),e(sn,gr),e(gr,cf),e(sn,pf),p(n,bc,h),p(n,an,h),e(an,In),e(In,gd),g(ts,gd,null),e(an,hf),e(an,Td),e(Td,uf),p(n,yc,h),p(n,ie,h),g(ns,ie,null),e(ie,mf),e(ie,os),e(os,ff),e(os,ss),e(ss,_f),e(os,gf),e(ie,Tf),e(ie,as),e(as,kf),e(as,Tr),e(Tr,vf),e(as,bf),e(ie,yf),e(ie,jt),g(rs,jt,null),e(jt,wf),e(jt,kd),e(kd,xf),e(jt,zf),e(jt,is),e(is,kr),e(kr,$f),e(kr,vd),e(vd,qf),e(is,Ef),e(is,vr),e(vr,jf),e(vr,bd),e(bd,Ff),e(ie,Mf),e(ie,Dn),g(ds,Dn,null),e(Dn,Pf),e(Dn,ls),e(ls,Cf),e(ls,yd),e(yd,Nf),e(ls,Lf),e(ie,Af),e(ie,On),g(cs,On,null),e(On,If),e(On,wd),e(wd,Df),e(ie,Of),e(ie,br),g(ps,br,null),p(n,wc,h),p(n,rn,h),e(rn,Sn),e(Sn,xd),g(hs,xd,null),e(rn,Sf),e(rn,zd),e(zd,Gf),p(n,xc,h),p(n,Oe,h),g(us,Oe,null),e(Oe,Uf),e(Oe,dn),e(dn,Bf),e(dn,$d),e($d,Wf),e(dn,Rf),e(dn,ms),e(ms,Hf),e(dn,Vf),e(Oe,Kf),e(Oe,fs),e(fs,Yf),e(fs,yr),e(yr,Zf),e(fs,Jf),e(Oe,Xf),e(Oe,Ft),g(_s,Ft,null),e(Ft,Qf),e(Ft,qd),e(qd,e_),e(Ft,t_),e(Ft,gs),e(gs,wr),e(wr,n_),e(wr,Ed),e(Ed,o_),e(gs,s_),e(gs,xr),e(xr,a_),e(xr,jd),e(jd,r_),e(Oe,i_),e(Oe,Gn),g(Ts,Gn,null),e(Gn,d_),e(Gn,Fd),e(Fd,l_),p(n,zc,h),p(n,ln,h),e(ln,Un),e(Un,Md),g(ks,Md,null),e(ln,c_),e(ln,Pd),e(Pd,p_),p(n,$c,h),p(n,J,h),g(vs,J,null),e(J,h_),e(J,Cd),e(Cd,u_),e(J,m_),e(J,bs),e(bs,f_),e(bs,ys),e(ys,__),e(bs,g_),e(J,T_),e(J,ws),e(ws,k_),e(ws,zr),e(zr,v_),e(ws,b_),e(J,y_),e(J,xs),e(xs,w_),e(xs,zs),e(zs,x_),e(xs,z_),e(J,$_),e(J,We),g($s,We,null),e(We,q_),e(We,cn),e(cn,E_),e(cn,$r),e($r,j_),e(cn,F_),e(cn,Nd),e(Nd,M_),e(cn,P_),e(We,C_),g(Bn,We,null),e(We,N_),e(We,Ld),e(Ld,L_),e(We,A_),g(qs,We,null),e(J,I_),e(J,Re),g(Es,Re,null),e(Re,D_),e(Re,Ad),e(Ad,O_),e(Re,S_),e(Re,Id),e(Id,G_),e(Re,U_),e(Re,Dd),e(Dd,B_),e(Re,W_),g(js,Re,null),e(J,R_),e(J,kt),g(Fs,kt,null),e(kt,H_),e(kt,Od),e(Od,V_),e(kt,K_),e(kt,Sd),e(Sd,Y_),e(kt,Z_),g(Ms,kt,null),p(n,qc,h),p(n,pn,h),e(pn,Wn),e(Wn,Gd),g(Ps,Gd,null),e(pn,J_),e(pn,Ud),e(Ud,X_),p(n,Ec,h),p(n,X,h),g(Cs,X,null),e(X,Q_),e(X,Ns),e(Ns,eg),e(Ns,Bd),e(Bd,tg),e(Ns,ng),e(X,og),e(X,Ls),e(Ls,sg),e(Ls,As),e(As,ag),e(Ls,rg),e(X,ig),e(X,Is),e(Is,dg),e(Is,qr),e(qr,lg),e(Is,cg),e(X,pg),e(X,Ds),e(Ds,hg),e(Ds,Os),e(Os,ug),e(Ds,mg),e(X,fg),e(X,He),g(Ss,He,null),e(He,_g),e(He,hn),e(hn,gg),e(hn,Er),e(Er,Tg),e(hn,kg),e(hn,Wd),e(Wd,vg),e(hn,bg),e(He,yg),g(Rn,He,null),e(He,wg),e(He,Rd),e(Rd,xg),e(He,zg),g(Gs,He,null),e(X,$g),e(X,Ve),g(Us,Ve,null),e(Ve,qg),e(Ve,Hd),e(Hd,Eg),e(Ve,jg),e(Ve,Vd),e(Vd,Fg),e(Ve,Mg),e(Ve,Kd),e(Kd,Pg),e(Ve,Cg),g(Bs,Ve,null),e(X,Ng),e(X,vt),g(Ws,vt,null),e(vt,Lg),e(vt,Yd),e(Yd,Ag),e(vt,Ig),e(vt,Zd),e(Zd,Dg),e(vt,Og),g(Rs,vt,null),p(n,jc,h),p(n,un,h),e(un,Hn),e(Hn,Jd),g(Hs,Jd,null),e(un,Sg),e(un,Xd),e(Xd,Gg),p(n,Fc,h),p(n,Q,h),g(Vs,Q,null),e(Q,Ug),e(Q,Qd),e(Qd,Bg),e(Q,Wg),e(Q,Ks),e(Ks,Rg),e(Ks,Ys),e(Ys,Hg),e(Ks,Vg),e(Q,Kg),e(Q,Zs),e(Zs,Yg),e(Zs,jr),e(jr,Zg),e(Zs,Jg),e(Q,Xg),e(Q,Js),e(Js,Qg),e(Js,Xs),e(Xs,eT),e(Js,tT),e(Q,nT),e(Q,Ke),g(Qs,Ke,null),e(Ke,oT),e(Ke,mn),e(mn,sT),e(mn,Fr),e(Fr,aT),e(mn,rT),e(mn,el),e(el,iT),e(mn,dT),e(Ke,lT),g(Vn,Ke,null),e(Ke,cT),e(Ke,tl),e(tl,pT),e(Ke,hT),g(ea,Ke,null),e(Q,uT),e(Q,Ye),g(ta,Ye,null),e(Ye,mT),e(Ye,nl),e(nl,fT),e(Ye,_T),e(Ye,ol),e(ol,gT),e(Ye,TT),e(Ye,sl),e(sl,kT),e(Ye,vT),g(na,Ye,null),e(Q,bT),e(Q,bt),g(oa,bt,null),e(bt,yT),e(bt,al),e(al,wT),e(bt,xT),e(bt,rl),e(rl,zT),e(bt,$T),g(sa,bt,null),p(n,Mc,h),p(n,fn,h),e(fn,Kn),e(Kn,il),g(aa,il,null),e(fn,qT),e(fn,dl),e(dl,ET),p(n,Pc,h),p(n,de,h),g(ra,de,null),e(de,jT),e(de,ll),e(ll,FT),e(de,MT),e(de,ia),e(ia,PT),e(ia,da),e(da,CT),e(ia,NT),e(de,LT),e(de,la),e(la,AT),e(la,Mr),e(Mr,IT),e(la,DT),e(de,OT),e(de,ca),e(ca,ST),e(ca,pa),e(pa,GT),e(ca,UT),e(de,BT),g(Yn,de,null),e(de,WT),e(de,Ze),g(ha,Ze,null),e(Ze,RT),e(Ze,_n),e(_n,HT),e(_n,Pr),e(Pr,VT),e(_n,KT),e(_n,cl),e(cl,YT),e(_n,ZT),e(Ze,JT),g(Zn,Ze,null),e(Ze,XT),e(Ze,pl),e(pl,QT),e(Ze,ek),g(ua,Ze,null),p(n,Cc,h),p(n,gn,h),e(gn,Jn),e(Jn,hl),g(ma,hl,null),e(gn,tk),e(gn,ul),e(ul,nk),p(n,Nc,h),p(n,le,h),g(fa,le,null),e(le,ok),e(le,_a),e(_a,sk),e(_a,ml),e(ml,ak),e(_a,rk),e(le,ik),e(le,ga),e(ga,dk),e(ga,Ta),e(Ta,lk),e(ga,ck),e(le,pk),e(le,ka),e(ka,hk),e(ka,Cr),e(Cr,uk),e(ka,mk),e(le,fk),e(le,va),e(va,_k),e(va,ba),e(ba,gk),e(va,Tk),e(le,kk),g(Xn,le,null),e(le,vk),e(le,Je),g(ya,Je,null),e(Je,bk),e(Je,Tn),e(Tn,yk),e(Tn,Nr),e(Nr,wk),e(Tn,xk),e(Tn,fl),e(fl,zk),e(Tn,$k),e(Je,qk),g(Qn,Je,null),e(Je,Ek),e(Je,_l),e(_l,jk),e(Je,Fk),g(wa,Je,null),p(n,Lc,h),p(n,kn,h),e(kn,eo),e(eo,gl),g(xa,gl,null),e(kn,Mk),e(kn,Tl),e(Tl,Pk),p(n,Ac,h),p(n,ce,h),g(za,ce,null),e(ce,Ck),e(ce,kl),e(kl,Nk),e(ce,Lk),e(ce,$a),e($a,Ak),e($a,qa),e(qa,Ik),e($a,Dk),e(ce,Ok),e(ce,Ea),e(Ea,Sk),e(Ea,Lr),e(Lr,Gk),e(Ea,Uk),e(ce,Bk),e(ce,ja),e(ja,Wk),e(ja,Fa),e(Fa,Rk),e(ja,Hk),e(ce,Vk),g(to,ce,null),e(ce,Kk),e(ce,Xe),g(Ma,Xe,null),e(Xe,Yk),e(Xe,vn),e(vn,Zk),e(vn,Ar),e(Ar,Jk),e(vn,Xk),e(vn,vl),e(vl,Qk),e(vn,ev),e(Xe,tv),g(no,Xe,null),e(Xe,nv),e(Xe,bl),e(bl,ov),e(Xe,sv),g(Pa,Xe,null),p(n,Ic,h),p(n,bn,h),e(bn,oo),e(oo,yl),g(Ca,yl,null),e(bn,av),e(bn,wl),e(wl,rv),p(n,Dc,h),p(n,lt,h),g(Na,lt,null),e(lt,iv),e(lt,Qe),g(La,Qe,null),e(Qe,dv),e(Qe,yn),e(yn,lv),e(yn,xl),e(xl,cv),e(yn,pv),e(yn,zl),e(zl,hv),e(yn,uv),e(Qe,mv),g(so,Qe,null),e(Qe,fv),e(Qe,$l),e($l,_v),e(Qe,gv),g(Aa,Qe,null),e(lt,Tv),e(lt,Mt),g(Ia,Mt,null),e(Mt,kv),e(Mt,ql),e(ql,vv),e(Mt,bv),g(Da,Mt,null),e(lt,yv),e(lt,Pt),g(Oa,Pt,null),e(Pt,wv),e(Pt,El),e(El,xv),e(Pt,zv),g(Sa,Pt,null),p(n,Oc,h),p(n,wn,h),e(wn,ao),e(ao,jl),g(Ga,jl,null),e(wn,$v),e(wn,Fl),e(Fl,qv),p(n,Sc,h),p(n,ct,h),g(Ua,ct,null),e(ct,Ev),e(ct,et),g(Ba,et,null),e(et,jv),e(et,xn),e(xn,Fv),e(xn,Ml),e(Ml,Mv),e(xn,Pv),e(xn,Pl),e(Pl,Cv),e(xn,Nv),e(et,Lv),g(ro,et,null),e(et,Av),e(et,Cl),e(Cl,Iv),e(et,Dv),g(Wa,et,null),e(ct,Ov),e(ct,Ct),g(Ra,Ct,null),e(Ct,Sv),e(Ct,Nl),e(Nl,Gv),e(Ct,Uv),g(Ha,Ct,null),e(ct,Bv),e(ct,Nt),g(Va,Nt,null),e(Nt,Wv),e(Nt,Ll),e(Ll,Rv),e(Nt,Hv),g(Ka,Nt,null),Gc=!0},p(n,[h]){const Ya={};h&2&&(Ya.$$scope={dirty:h,ctx:n}),Bn.$set(Ya);const Al={};h&2&&(Al.$$scope={dirty:h,ctx:n}),Rn.$set(Al);const Il={};h&2&&(Il.$$scope={dirty:h,ctx:n}),Vn.$set(Il);const Dl={};h&2&&(Dl.$$scope={dirty:h,ctx:n}),Yn.$set(Dl);const Za={};h&2&&(Za.$$scope={dirty:h,ctx:n}),Zn.$set(Za);const Ol={};h&2&&(Ol.$$scope={dirty:h,ctx:n}),Xn.$set(Ol);const Sl={};h&2&&(Sl.$$scope={dirty:h,ctx:n}),Qn.$set(Sl);const Gl={};h&2&&(Gl.$$scope={dirty:h,ctx:n}),to.$set(Gl);const Ja={};h&2&&(Ja.$$scope={dirty:h,ctx:n}),no.$set(Ja);const Ul={};h&2&&(Ul.$$scope={dirty:h,ctx:n}),so.$set(Ul);const Bl={};h&2&&(Bl.$$scope={dirty:h,ctx:n}),ro.$set(Bl)},i(n){Gc||(T(x.$$.fragment,n),T(se.$$.fragment,n),T($o.$$.fragment,n),T(qo.$$.fragment,n),T(Fo.$$.fragment,n),T(Po.$$.fragment,n),T(Io.$$.fragment,n),T(So.$$.fragment,n),T(Go.$$.fragment,n),T(Uo.$$.fragment,n),T(Wo.$$.fragment,n),T(Xo.$$.fragment,n),T(Qo.$$.fragment,n),T(ts.$$.fragment,n),T(ns.$$.fragment,n),T(rs.$$.fragment,n),T(ds.$$.fragment,n),T(cs.$$.fragment,n),T(ps.$$.fragment,n),T(hs.$$.fragment,n),T(us.$$.fragment,n),T(_s.$$.fragment,n),T(Ts.$$.fragment,n),T(ks.$$.fragment,n),T(vs.$$.fragment,n),T($s.$$.fragment,n),T(Bn.$$.fragment,n),T(qs.$$.fragment,n),T(Es.$$.fragment,n),T(js.$$.fragment,n),T(Fs.$$.fragment,n),T(Ms.$$.fragment,n),T(Ps.$$.fragment,n),T(Cs.$$.fragment,n),T(Ss.$$.fragment,n),T(Rn.$$.fragment,n),T(Gs.$$.fragment,n),T(Us.$$.fragment,n),T(Bs.$$.fragment,n),T(Ws.$$.fragment,n),T(Rs.$$.fragment,n),T(Hs.$$.fragment,n),T(Vs.$$.fragment,n),T(Qs.$$.fragment,n),T(Vn.$$.fragment,n),T(ea.$$.fragment,n),T(ta.$$.fragment,n),T(na.$$.fragment,n),T(oa.$$.fragment,n),T(sa.$$.fragment,n),T(aa.$$.fragment,n),T(ra.$$.fragment,n),T(Yn.$$.fragment,n),T(ha.$$.fragment,n),T(Zn.$$.fragment,n),T(ua.$$.fragment,n),T(ma.$$.fragment,n),T(fa.$$.fragment,n),T(Xn.$$.fragment,n),T(ya.$$.fragment,n),T(Qn.$$.fragment,n),T(wa.$$.fragment,n),T(xa.$$.fragment,n),T(za.$$.fragment,n),T(to.$$.fragment,n),T(Ma.$$.fragment,n),T(no.$$.fragment,n),T(Pa.$$.fragment,n),T(Ca.$$.fragment,n),T(Na.$$.fragment,n),T(La.$$.fragment,n),T(so.$$.fragment,n),T(Aa.$$.fragment,n),T(Ia.$$.fragment,n),T(Da.$$.fragment,n),T(Oa.$$.fragment,n),T(Sa.$$.fragment,n),T(Ga.$$.fragment,n),T(Ua.$$.fragment,n),T(Ba.$$.fragment,n),T(ro.$$.fragment,n),T(Wa.$$.fragment,n),T(Ra.$$.fragment,n),T(Ha.$$.fragment,n),T(Va.$$.fragment,n),T(Ka.$$.fragment,n),Gc=!0)},o(n){k(x.$$.fragment,n),k(se.$$.fragment,n),k($o.$$.fragment,n),k(qo.$$.fragment,n),k(Fo.$$.fragment,n),k(Po.$$.fragment,n),k(Io.$$.fragment,n),k(So.$$.fragment,n),k(Go.$$.fragment,n),k(Uo.$$.fragment,n),k(Wo.$$.fragment,n),k(Xo.$$.fragment,n),k(Qo.$$.fragment,n),k(ts.$$.fragment,n),k(ns.$$.fragment,n),k(rs.$$.fragment,n),k(ds.$$.fragment,n),k(cs.$$.fragment,n),k(ps.$$.fragment,n),k(hs.$$.fragment,n),k(us.$$.fragment,n),k(_s.$$.fragment,n),k(Ts.$$.fragment,n),k(ks.$$.fragment,n),k(vs.$$.fragment,n),k($s.$$.fragment,n),k(Bn.$$.fragment,n),k(qs.$$.fragment,n),k(Es.$$.fragment,n),k(js.$$.fragment,n),k(Fs.$$.fragment,n),k(Ms.$$.fragment,n),k(Ps.$$.fragment,n),k(Cs.$$.fragment,n),k(Ss.$$.fragment,n),k(Rn.$$.fragment,n),k(Gs.$$.fragment,n),k(Us.$$.fragment,n),k(Bs.$$.fragment,n),k(Ws.$$.fragment,n),k(Rs.$$.fragment,n),k(Hs.$$.fragment,n),k(Vs.$$.fragment,n),k(Qs.$$.fragment,n),k(Vn.$$.fragment,n),k(ea.$$.fragment,n),k(ta.$$.fragment,n),k(na.$$.fragment,n),k(oa.$$.fragment,n),k(sa.$$.fragment,n),k(aa.$$.fragment,n),k(ra.$$.fragment,n),k(Yn.$$.fragment,n),k(ha.$$.fragment,n),k(Zn.$$.fragment,n),k(ua.$$.fragment,n),k(ma.$$.fragment,n),k(fa.$$.fragment,n),k(Xn.$$.fragment,n),k(ya.$$.fragment,n),k(Qn.$$.fragment,n),k(wa.$$.fragment,n),k(xa.$$.fragment,n),k(za.$$.fragment,n),k(to.$$.fragment,n),k(Ma.$$.fragment,n),k(no.$$.fragment,n),k(Pa.$$.fragment,n),k(Ca.$$.fragment,n),k(Na.$$.fragment,n),k(La.$$.fragment,n),k(so.$$.fragment,n),k(Aa.$$.fragment,n),k(Ia.$$.fragment,n),k(Da.$$.fragment,n),k(Oa.$$.fragment,n),k(Sa.$$.fragment,n),k(Ga.$$.fragment,n),k(Ua.$$.fragment,n),k(Ba.$$.fragment,n),k(ro.$$.fragment,n),k(Wa.$$.fragment,n),k(Ra.$$.fragment,n),k(Ha.$$.fragment,n),k(Va.$$.fragment,n),k(Ka.$$.fragment,n),Gc=!1},d(n){t(u),n&&t($),n&&t(b),v(x),n&&t(oe),n&&t(E),v(se),n&&t(ve),n&&t(U),n&&t(C),n&&t(he),n&&t(be),n&&t(ue),n&&t(ye),n&&t(P),n&&t(H),n&&t(V),n&&t(Vl),n&&t(Xa),n&&t(Kl),n&&t(Ue),n&&t(Yl),n&&t(er),n&&t(Zl),n&&t($t),n&&t(Jl),n&&t(En),n&&t(Xl),n&&t(qt),n&&t(Ql),n&&t(sr),n&&t(ec),n&&t(Zt),v($o),n&&t(tc),n&&t(_t),n&&t(nc),n&&t(Fn),n&&t(oc),n&&t(Mn),v(qo),v(Fo),v(Po),n&&t(sc),n&&t(ir),n&&t(ac),n&&t(Et),n&&t(rc),n&&t(dr),n&&t(ic),n&&t(Qt),v(Io),n&&t(dc),n&&t(gt),n&&t(lc),v(So,n),n&&t(cc),n&&t(Be),n&&t(pc),n&&t(pr),n&&t(hc),v(Go,n),n&&t(uc),n&&t(hr),n&&t(mc),n&&t(en),v(Uo),n&&t(fc),n&&t(Tt),n&&t(_c),n&&t(tn),v(Wo),n&&t(gc),n&&t(ur),n&&t(Tc),n&&t(Ln),n&&t(kc),n&&t(on),v(Xo),n&&t(vc),n&&t(wt),v(Qo),n&&t(bc),n&&t(an),v(ts),n&&t(yc),n&&t(ie),v(ns),v(rs),v(ds),v(cs),v(ps),n&&t(wc),n&&t(rn),v(hs),n&&t(xc),n&&t(Oe),v(us),v(_s),v(Ts),n&&t(zc),n&&t(ln),v(ks),n&&t($c),n&&t(J),v(vs),v($s),v(Bn),v(qs),v(Es),v(js),v(Fs),v(Ms),n&&t(qc),n&&t(pn),v(Ps),n&&t(Ec),n&&t(X),v(Cs),v(Ss),v(Rn),v(Gs),v(Us),v(Bs),v(Ws),v(Rs),n&&t(jc),n&&t(un),v(Hs),n&&t(Fc),n&&t(Q),v(Vs),v(Qs),v(Vn),v(ea),v(ta),v(na),v(oa),v(sa),n&&t(Mc),n&&t(fn),v(aa),n&&t(Pc),n&&t(de),v(ra),v(Yn),v(ha),v(Zn),v(ua),n&&t(Cc),n&&t(gn),v(ma),n&&t(Nc),n&&t(le),v(fa),v(Xn),v(ya),v(Qn),v(wa),n&&t(Lc),n&&t(kn),v(xa),n&&t(Ac),n&&t(ce),v(za),v(to),v(Ma),v(no),v(Pa),n&&t(Ic),n&&t(bn),v(Ca),n&&t(Dc),n&&t(lt),v(Na),v(La),v(so),v(Aa),v(Ia),v(Da),v(Oa),v(Sa),n&&t(Oc),n&&t(wn),v(Ga),n&&t(Sc),n&&t(ct),v(Ua),v(Ba),v(ro),v(Wa),v(Ra),v(Ha),v(Va),v(Ka)}}}const jw={local:"t5",sections:[{local:"overview",title:"Overview"},{local:"training",title:"Training"},{local:"inference",title:"Inference"},{local:"performance",title:"Performance"},{local:"example-scripts",title:"Example scripts"},{local:"transformers.T5Config",title:"T5Config"},{local:"transformers.T5Tokenizer",title:"T5Tokenizer"},{local:"transformers.T5TokenizerFast",title:"T5TokenizerFast"},{local:"transformers.T5Model",title:"T5Model"},{local:"transformers.T5ForConditionalGeneration",title:"T5ForConditionalGeneration"},{local:"transformers.T5EncoderModel",title:"T5EncoderModel"},{local:"transformers.TFT5Model",title:"TFT5Model"},{local:"transformers.TFT5ForConditionalGeneration",title:"TFT5ForConditionalGeneration"},{local:"transformers.TFT5EncoderModel",title:"TFT5EncoderModel"},{local:"transformers.FlaxT5Model",title:"FlaxT5Model"},{local:"transformers.FlaxT5ForConditionalGeneration",title:"FlaxT5ForConditionalGeneration"}],title:"T5"};function Fw(A,u,$){let{fw:b}=u;return A.$$set=w=>{"fw"in w&&$(0,b=w.fw)},[b]}class Aw extends uw{constructor(u){super();mw(this,u,Fw,Ew,fw,{fw:0})}}export{Aw as default,jw as metadata};
