import{S as ti,i as oi,s as ri,e as a,k as l,w as g,t as r,M as si,c as n,d as o,m as d,a as c,x as v,h as s,b as i,G as e,g as h,y as x,q as T,o as k,B as b,v as ai,L as ei}from"../../chunks/vendor-hf-doc-builder.js";import{T as Yc}from"../../chunks/Tip-hf-doc-builder.js";import{D}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Pr}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as gt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Zc}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function ni(H){let m,E,u,_,w;return _=new Pr({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(f){m=n(f,"P",{});var S=c(m);E=s(S,"Example:"),S.forEach(o),u=d(f),v(_.$$.fragment,f)},m(f,S){h(f,m,S),e(m,E),h(f,u,S),x(_,f,S),w=!0},p:ei,i(f){w||(T(_.$$.fragment,f),w=!0)},o(f){k(_.$$.fragment,f),w=!1},d(f){f&&o(m),f&&o(u),b(_,f)}}}function di(H){let m,E,u,_,w,f,S,W,q,y,M,F,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Mr,Fr,Pe,Ar,Lr,Lo,z,Dr,so,Wr,Ir,ao,Vr,Nr,xt,Or,Ur,Tt,Rr,Br,kt,Hr,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Wo,ce,Zr,Ce,es,ts,Io,bt,os,Vo,G,qe,rs,Me,ss,as,ns,Fe,cs,St,is,ls,ds,Ae,ps,Le,hs,fs,No,Z,ie,co,De,ms,io,us,Oo,K,_s,wt,gs,vs,$t,xs,Ts,Uo,C,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Ro,Ct,lo,qs,Bo,We,Ho,qt,Ie,po,Ms,Fs,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Ws,Ko,ee,de,fo,Oe,Is,mo,Vs,Qo,I,Ue,Ns,te,Os,Mt,Us,Rs,Re,Bs,Hs,Js,oe,Gs,Ft,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,Be,ea,_o,ta,Yo,j,He,oa,go,ra,sa,Je,aa,Lt,na,ca,ia,fe,Ge,la,vo,da,pa,Q,Ke,ha,xo,fa,ma,Qe,ua,To,_a,ga,va,Dt,Xe,Zo,se,me,ko,Ye,xa,bo,Ta,er,$,Ze,ka,So,ba,Sa,A,Wt,wa,$a,It,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Ma,Fa,Aa,ue,tt,La,U,Da,$o,Wa,Ia,Ot,Va,Na,ot,yo,Oa,Ua,Ra,Ba,X,rt,Ha,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Ut,Ya,Za,en,ge,tn,ve,nt,on,ct,rn,Rt,sn,an,nn,xe,it,cn,lt,ln,Bt,dn,pn,hn,Te,dt,fn,zo,mn,tr,ae,ke,Po,pt,un,jo,_n,or,V,ht,gn,R,vn,Ht,xn,Tn,Co,kn,bn,Jt,Sn,wn,$n,ft,yn,mt,En,zn,Pn,be,ut,jn,Se,rr;return f=new gt({}),ze=new gt({}),De=new gt({}),We=new Pr({props:{code:`import torch
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17716/en/model_doc/speech_to_text#transformers.Speech2TextModel">Speech2TextModel</a>`,name:"vocab_size"},{anchor:"transformers.Speech2Text2Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17716/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L31"}}),pe=new Zc({props:{anchor:"transformers.Speech2Text2Config.example",$$slots:{default:[ni]},$$scope:{ctx:H}}}),Be=new gt({}),He=new D({props:{name:"class transformers.Speech2Text2Tokenizer",anchor:"transformers.Speech2Text2Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"do_lower_case",val:" = False"},{name:"merges_file",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17716/src/transformers/tokenization_utils_base.py#L3283",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17716/src/transformers/tokenization_utils_base.py#L3316",returnDescription:`
<p>The decoded sentence.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Xe=new D({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17716/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L241"}}),Ye=new gt({}),Ze=new D({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17716/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer">Speech2Text2Tokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17716/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23"}}),tt=new D({props:{name:"__call__",anchor:"transformers.Speech2Text2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17716/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L44"}}),rt=new D({props:{name:"from_pretrained",anchor:"transformers.Speech2Text2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17716/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
`}}),Se=new Zc({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[li]},$$scope:{ctx:H}}}),{c(){m=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(f.$$.fragment),S=l(),W=a("span"),q=r("Speech2Text2"),y=l(),M=a("h2"),F=a("a"),oo=a("span"),g(ze.$$.fragment),jr=l(),ro=a("span"),Cr=r("Overview"),Ao=l(),J=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Mr=r("Wav2Vec2"),Fr=r(` for Speech Translation models proposed in
...
`),Re=a("a"),Bs=r("facebook/s2t-wav2vec2-large-en-de"),Hs=r(" architecture."),Js=l(),oe=a("p"),Gs=r("Configuration objects inherit from "),Ft=a("a"),Ks=r("PretrainedConfig"),Qs=r(` and can be used to control the model outputs. Read the
...
instantiate an Speech2Text2 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Speech2Text2
`),Re=n(Xt,"A",{href:!0,rel:!0});var _c=c(Re);Bs=s(_c,"facebook/s2t-wav2vec2-large-en-de"),_c.forEach(o),Hs=s(Xt," architecture."),Xt.forEach(o),Js=d(we),oe=n(we,"P",{});var Yt=c(oe);Gs=s(Yt,"Configuration objects inherit from "),Ft=n(Yt,"A",{href:!0});var gc=c(Ft);Ks=s(gc,"PretrainedConfig"),gc.forEach(o),Qs=s(Yt,` and can be used to control the model outputs. Read the
...
a single processor.`),Cc.forEach(o),Sa=d(P),A=n(P,"P",{});var B=c(A);Wt=n(B,"A",{href:!0});var qc=c(Wt);wa=s(qc,"Speech2Text2Processor"),qc.forEach(o),$a=s(B," offers all the functionalities of "),It=n(B,"A",{href:!0});var Mc=c(It);ya=s(Mc,"AutoFeatureExtractor"),Mc.forEach(o),Ea=s(B," and "),Vt=n(B,"A",{href:!0});var Fc=c(Vt);za=s(Fc,"Speech2Text2Tokenizer"),Fc.forEach(o),Pa=s(B,`.
See the `),et=n(B,"A",{href:!0});var Cn=c(et);wo=n(Cn,"STRONG",{});var Ac=c(wo);ja=s(Ac,"call"),Ac.forEach(o),Ca=s(Cn,"()"),Cn.forEach(o),qa=s(B," and "),Nt=n(B,"A",{href:!0});var Lc=c(Nt);Ma=s(Lc,"decode()"),Lc.forEach(o),Fa=s(B," for more information."),B.forEach(o),Aa=d(P),ue=n(P,"DIV",{class:!0});var xr=c(ue);v(tt.$$.fragment,xr),La=d(xr),U=n(xr,"P",{});var $e=c(U);Da=s($e,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
