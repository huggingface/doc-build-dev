import{S as Pd,i as Ld,s as $d,e as n,k as u,w as v,t as i,M as qd,c as a,d as o,m,a as s,x as y,h as d,b as c,G as e,g as _,y as T,q as w,o as P,B as L,v as zd,L as ue}from"../../chunks/vendor-hf-doc-builder.js";import{T as ii}from"../../chunks/Tip-hf-doc-builder.js";import{D as I}from"../../chunks/Docstring-hf-doc-builder.js";import{C as G}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as pe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as he}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Bd($){let l,b,p,f,k;return f=new G({props:{code:`from transformers import PLBartModel, PLBartConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs[<span class="hljs-string">&quot;labels&quot;</span>] = labels[<span class="hljs-string">&quot;input_ids&quot;</span>]`}}),{c(){l=n("p"),b=i("Examples:"),p=u(),v(f.$$.fragment)},l(r){l=a(r,"P",{});var g=s(l);b=d(g,"Examples:"),g.forEach(o),p=m(r),y(f.$$.fragment,r)},m(r,g){_(r,l,g),e(l,b),_(r,p,g),T(f,r,g),k=!0},p:ue,i(r){k||(w(f.$$.fragment,r),k=!0)},o(r){P(f.$$.fragment,r),k=!1},d(r){r&&o(l),r&&o(p),L(f,r)}}}function Cd($){let l,b,p,f,k;return{c(){l=n("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),f=i("Module"),k=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var g=s(l);b=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(g,"CODE",{});var x=s(p);f=d(x,"Module"),x.forEach(o),k=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
[<span class="hljs-string">&#x27;same&#x27;</span>, <span class="hljs-string">&#x27;first&#x27;</span>, <span class="hljs-string">&#x27;highest&#x27;</span>, <span class="hljs-string">&#x27;result&#x27;</span>, <span class="hljs-string">&#x27;Fib&#x27;</span>]`}}),{c(){l=n("p"),b=i("Mask-filling example:"),p=u(),v(f.$$.fragment)},l(r){l=a(r,"P",{});var g=s(l);b=d(g,"Mask-filling example:"),g.forEach(o),p=m(r),y(f.$$.fragment,r)},m(r,g){_(r,l,g),e(l,b),_(r,p,g),T(f,r,g),k=!0},p:ue,i(r){k||(w(f.$$.fragment,r),k=!0)},o(r){P(f.$$.fragment,r),k=!1},d(r){r&&o(l),r&&o(p),L(f,r)}}}function Md($){let l,b,p,f,k;return{c(){l=n("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),f=i("Module"),k=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var g=s(l);b=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(g,"CODE",{});var x=s(p);f=d(x,"Module"),x.forEach(o),k=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-literal">True</span>`}}),{c(){l=n("p"),b=i("Example:"),p=u(),v(f.$$.fragment)},l(r){l=a(r,"P",{});var g=s(l);b=d(g,"Example:"),g.forEach(o),p=m(r),y(f.$$.fragment,r)},m(r,g){_(r,l,g),e(l,b),_(r,p,g),T(f,r,g),k=!0},p:ue,i(r){k||(w(f.$$.fragment,r),k=!0)},o(r){P(f.$$.fragment,r),k=!1},d(r){r&&o(l),r&&o(p),L(f,r)}}}function Dd($){let l,b,p,f,k,r,g,x,na,rn,D,co,aa,sa,Re,ra,ia,We,da,la,dn,K,me,po,He,ca,ho,pa,ln,R,ha,Ue,ua,ma,uo,fa,ga,cn,Nt,_a,pn,Ot,mo,ba,hn,W,ka,Ve,va,ya,Je,Ta,wa,un,Q,fe,fo,Ke,Pa,go,La,mn,C,$a,_o,qa,za,bo,Ba,xa,ko,Ca,Fa,vo,ja,Ea,fn,ge,Ma,Qe,Sa,Aa,gn,H,Na,Ye,yo,Oa,Ia,Da,It,Xa,Ga,_n,Dt,To,Ra,bn,Ze,kn,Xt,et,wo,Wa,Ha,Y,Ua,Po,Va,Ja,Lo,Ka,Qa,vn,tt,yn,Z,_e,$o,ot,Ya,qo,Za,Tn,E,nt,es,ee,ts,Gt,os,ns,at,as,ss,rs,te,is,Rt,ds,ls,Wt,cs,ps,hs,be,wn,oe,ke,zo,st,us,Bo,ms,Pn,q,rt,fs,xo,gs,_s,X,bs,Ht,ks,vs,Ut,ys,Ts,it,ws,Ps,Ls,dt,$s,Co,qs,zs,Bs,ve,xs,ye,lt,Cs,Fo,Fs,js,A,ct,Es,pt,Ms,jo,Ss,As,Ns,ht,ut,Eo,Os,Is,Mo,Ds,Xs,mt,So,Gs,Rs,Ao,Ws,Hs,No,Us,Ln,ne,Te,Oo,ft,Vs,Io,Js,$n,M,gt,Ks,_t,Qs,Vt,Ys,Zs,er,bt,tr,kt,or,nr,ar,N,vt,sr,ae,rr,Jt,ir,dr,Do,lr,cr,pr,we,hr,Pe,qn,se,Le,Xo,yt,ur,Go,mr,zn,S,Tt,fr,wt,gr,Kt,_r,br,kr,Pt,vr,Lt,yr,Tr,wr,O,$t,Pr,re,Lr,Qt,$r,qr,Ro,zr,Br,xr,$e,Cr,qe,Bn,ie,ze,Wo,qt,Fr,Ho,jr,xn,B,zt,Er,Uo,Mr,Sr,Bt,Ar,Yt,Nr,Or,Ir,xt,Dr,Ct,Xr,Gr,Rr,z,Ft,Wr,de,Hr,Zt,Ur,Vr,Vo,Jr,Kr,Qr,Be,Yr,xe,Zr,Ce,ei,Fe,ti,je,Cn,le,Ee,Jo,jt,oi,Ko,ni,Fn,ce,Et,ai,Me,Mt,si,Se,jn;return r=new pe({}),He=new pe({}),Ke=new pe({}),Ze=new G({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18084/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18084/src/transformers/models/plbart/tokenization_plbart.py#L324",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_18084/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18084/src/transformers/models/plbart/modeling_plbart.py#L1144",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18084/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18084/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18084/src/transformers/models/plbart/modeling_plbart.py#L1277",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18084/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18084/src/transformers/models/plbart/modeling_plbart.py#L1416",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18084/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18084/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18084/src/transformers/models/plbart/modeling_plbart.py#L1571",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18084/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
`}}),Se=new he({props:{anchor:"transformers.PLBartForCausalLM.forward.example",$$slots:{default:[Id]},$$scope:{ctx:$}}}),{c(){l=n("meta"),b=u(),p=n("h1"),f=n("a"),k=n("span"),v(r.$$.fragment),g=u(),x=n("span"),na=i("PLBart"),rn=u(),D=n("p"),co=n("strong"),aa=i("DISCLAIMER:"),sa=i(" If you see something strange, file a "),Re=n("a"),ra=i("Github Issue"),ia=i(` and assign
`),We=n("a"),da=i("@gchhablani"),la=i("."),dn=u(),K=n("h2"),me=n("a"),po=n("span"),v(He.$$.fragment),ca=u(),ho=n("span"),pa=i("Overview of PLBart"),ln=u(),R=n("p"),ha=i("The PLBART model was proposed in "),Ue=n("a"),ua=i("Unified Pre-training for Program Understanding and Generation"),ma=i(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
even with limited annotations.`),hn=u(),W=n("p"),ka=i("This model was contributed by "),Ve=n("a"),va=i("gchhablani"),ya=i(". The Authors\u2019 code can be found "),Je=n("a"),Ta=i("here"),wa=i("."),un=u(),Q=n("h3"),fe=n("a"),fo=n("span"),v(Ke.$$.fragment),Pa=u(),go=n("span"),La=i("Training of PLBart"),mn=u(),C=n("p"),$a=i(`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
...
target text format is `),ko=n("code"),Ca=i("[tgt_lang_code] X [eos]"),Fa=i(". "),vo=n("code"),ja=i("bos"),Ea=i(" is never used."),fn=u(),ge=n("p"),Ma=i("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Qe=n("a"),Sa=i("the paper"),Aa=i(" to learn more about this."),gn=u(),H=n("p"),Na=i("In cases where the language code is needed, The regular "),Ye=n("a"),yo=n("strong"),Oa=i("call"),Ia=i("()"),Da=i(` will encode source text format, and it should be wrapped
inside the context manager `),It=n("a"),Xa=i("as_target_tokenizer()"),Ga=i(" to encode target text format."),_n=u(),Dt=n("ul"),To=n("li"),Ra=i("Supervised training"),bn=u(),v(Ze.$$.fragment),kn=u(),Xt=n("ul"),et=n("li"),wo=n("p"),Wa=i("Generation"),Ha=u(),Y=n("p"),Ua=i("While generating the target text set the "),Po=n("code"),Va=i("decoder_start_token_id"),Ja=i(` to the target language id. The following
example shows how to translate Python to English using the `),Lo=n("code"),Ka=i("uclanlp/plbart-python-en_XX"),Qa=i(" model."),vn=u(),v(tt.$$.fragment),yn=u(),Z=n("h2"),_e=n("a"),$o=n("span"),v(ot.$$.fragment),Ya=u(),qo=n("span"),Za=i("PLBartConfig"),Tn=u(),E=n("div"),v(nt.$$.fragment),es=u(),ee=n("p"),ts=i("This is the configuration class to store the configuration of a "),Gt=n("a"),os=i("PLBartModel"),ns=i(`. It is used to instantiate an
...
`),at=n("a"),as=i("uclanlp/plbart-base"),ss=i(" architecture."),rs=u(),te=n("p"),is=i("Configuration objects inherit from "),Rt=n("a"),ds=i("PretrainedConfig"),ls=i(` and can be used to control the model outputs. Read the
documentation from `),Wt=n("a"),cs=i("PretrainedConfig"),ps=i(" for more information."),hs=u(),v(be.$$.fragment),wn=u(),oe=n("h2"),ke=n("a"),zo=n("span"),v(st.$$.fragment),us=u(),Bo=n("span"),ms=i("PLBartTokenizer"),Pn=u(),q=n("div"),v(rt.$$.fragment),fs=u(),xo=n("p"),gs=i("Construct an PLBART tokenizer."),_s=u(),X=n("p"),bs=i("Adapted from "),Ht=n("a"),ks=i("RobertaTokenizer"),vs=i(" and "),Ut=n("a"),ys=i("XLNetTokenizer"),Ts=i(`. Based on
`),it=n("a"),ws=i("SentencePiece"),Ps=i("."),Ls=u(),dt=n("p"),$s=i("The tokenization method is "),Co=n("code"),qs=i("<tokens> <eos> <language code>"),zs=i(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Bs=u(),v(ve.$$.fragment),xs=u(),ye=n("div"),v(lt.$$.fragment),Cs=u(),Fo=n("p"),Fs=i(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),js=u(),A=n("div"),v(ct.$$.fragment),Es=u(),pt=n("p"),Ms=i(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An PLBART sequence has the following format, where `),jo=n("code"),Ss=i("X"),As=i(" represents the sequence:"),Ns=u(),ht=n("ul"),ut=n("li"),Eo=n("code"),Os=i("input_ids"),Is=i(" (for encoder) "),Mo=n("code"),Ds=i("X [eos, src_lang_code]"),Xs=u(),mt=n("li"),So=n("code"),Gs=i("decoder_input_ids"),Rs=i(": (for decoder) "),Ao=n("code"),Ws=i("X [eos, tgt_lang_code]"),Hs=u(),No=n("p"),Us=i(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Ln=u(),ne=n("h2"),Te=n("a"),Oo=n("span"),v(ft.$$.fragment),Vs=u(),Io=n("span"),Js=i("PLBartModel"),$n=u(),M=n("div"),v(gt.$$.fragment),Ks=u(),_t=n("p"),Qs=i(`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ar=u(),N=n("div"),v(vt.$$.fragment),sr=u(),ae=n("p"),rr=i("The "),Jt=n("a"),ir=i("PLBartModel"),dr=i(" forward method, overrides the "),Do=n("code"),lr=i("__call__"),cr=i(" special method."),pr=u(),v(we.$$.fragment),hr=u(),v(Pe.$$.fragment),qn=u(),se=n("h2"),Le=n("a"),Xo=n("span"),v(yt.$$.fragment),ur=u(),Go=n("span"),mr=i("PLBartForConditionalGeneration"),zn=u(),S=n("div"),v(Tt.$$.fragment),fr=u(),wt=n("p"),gr=i(`The PLBART Model with a language modeling head. Can be used for code-to-text, text-to-code and code-to-code.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr=u(),z=n("div"),v(Ft.$$.fragment),Wr=u(),de=n("p"),Hr=i("The "),Zt=n("a"),Ur=i("PLBartForSequenceClassification"),Vr=i(" forward method, overrides the "),Vo=n("code"),Jr=i("__call__"),Kr=i(" special method."),Qr=u(),v(Be.$$.fragment),Yr=u(),v(xe.$$.fragment),Zr=u(),v(Ce.$$.fragment),ei=u(),v(Fe.$$.fragment),ti=u(),v(je.$$.fragment),Cn=u(),le=n("h2"),Ee=n("a"),Jo=n("span"),v(jt.$$.fragment),oi=u(),Ko=n("span"),ni=i("PLBartForCausalLM"),Fn=u(),ce=n("div"),v(Et.$$.fragment),ai=u(),Me=n("div"),v(Mt.$$.fragment),si=u(),v(Se.$$.fragment),this.h()},l(t){const h=qd('[data-svelte="svelte-1phssyn"]',document.head);l=a(h,"META",{name:!0,content:!0}),h.forEach(o),b=m(t),p=a(t,"H1",{class:!0});var St=s(p);f=a(St,"A",{id:!0,class:!0,href:!0});var Qo=s(f);k=a(Qo,"SPAN",{});var Yo=s(k);y(r.$$.fragment,Yo),Yo.forEach(o),Qo.forEach(o),g=m(St),x=a(St,"SPAN",{});var Zo=s(x);na=d(Zo,"PLBart"),Zo.forEach(o),St.forEach(o),rn=m(t),D=a(t,"P",{});var U=s(D);co=a(U,"STRONG",{});var en=s(co);aa=d(en,"DISCLAIMER:"),en.forEach(o),sa=d(U," If you see something strange, file a "),Re=a(U,"A",{href:!0,rel:!0});var tn=s(Re);ra=d(tn,"Github Issue"),tn.forEach(o),ia=d(U,` and assign
`),We=a(U,"A",{href:!0,rel:!0});var on=s(We);da=d(on,"@gchhablani"),on.forEach(o),la=d(U,"."),U.forEach(o),dn=m(t),K=a(t,"H2",{class:!0});var At=s(K);me=a(At,"A",{id:!0,class:!0,href:!0});var nn=s(me);po=a(nn,"SPAN",{});var an=s(po);y(He.$$.fragment,an),an.forEach(o),nn.forEach(o),ca=m(At),ho=a(At,"SPAN",{});var sn=s(ho);pa=d(sn,"Overview of PLBart"),sn.forEach(o),At.forEach(o),ln=m(t),R=a(t,"P",{});var eo=s(R);ha=d(eo,"The PLBART model was proposed in "),Ue=a(eo,"A",{href:!0,rel:!0});var di=s(Ue);ua=d(di,"Unified Pre-training for Program Understanding and Generation"),di.forEach(o),ma=d(eo,` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
Furthermore, analysis reveals that PLBART learns program syntax, style (e.g., identifier naming convention), logical flow
(e.g., if block inside an else block is equivalent to else if block) that are crucial to program semantics and thus excels
even with limited annotations.`),hi.forEach(o),pi.forEach(o),hn=m(t),W=a(t,"P",{});var to=s(W);ka=d(to,"This model was contributed by "),Ve=a(to,"A",{href:!0,rel:!0});var ui=s(Ve);va=d(ui,"gchhablani"),ui.forEach(o),ya=d(to,". The Authors\u2019 code can be found "),Je=a(to,"A",{href:!0,rel:!0});var mi=s(Je);Ta=d(mi,"here"),mi.forEach(o),wa=d(to,"."),to.forEach(o),un=m(t),Q=a(t,"H3",{class:!0});var En=s(Q);fe=a(En,"A",{id:!0,class:!0,href:!0});var fi=s(fe);fo=a(fi,"SPAN",{});var gi=s(fo);y(Ke.$$.fragment,gi),gi.forEach(o),fi.forEach(o),Pa=m(En),go=a(En,"SPAN",{});var _i=s(go);La=d(_i,"Training of PLBart"),_i.forEach(o),En.forEach(o),mn=m(t),C=a(t,"P",{});var V=s(C);$a=d(V,`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),_o=a(V,"CODE",{});var bi=s(_o);qa=d(bi,"X [eos, src_lang_code]"),bi.forEach(o),za=d(V," where "),bo=a(V,"CODE",{});var ki=s(bo);Ba=d(ki,"X"),ki.forEach(o),xa=d(V,` is the source text. The
target text format is `),ko=a(V,"CODE",{});var vi=s(ko);Ca=d(vi,"[tgt_lang_code] X [eos]"),vi.forEach(o),Fa=d(V,". "),vo=a(V,"CODE",{});var yi=s(vo);ja=d(yi,"bos"),yi.forEach(o),Ea=d(V," is never used."),V.forEach(o),fn=m(t),ge=a(t,"P",{});var Mn=s(ge);Ma=d(Mn,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Qe=a(Mn,"A",{href:!0,rel:!0});var Ti=s(Qe);Sa=d(Ti,"the paper"),Ti.forEach(o),Aa=d(Mn," to learn more about this."),Mn.forEach(o),gn=m(t),H=a(t,"P",{});var oo=s(H);Na=d(oo,"In cases where the language code is needed, The regular "),Ye=a(oo,"A",{href:!0});var ri=s(Ye);yo=a(ri,"STRONG",{});var wi=s(yo);Oa=d(wi,"call"),wi.forEach(o),Ia=d(ri,"()"),ri.forEach(o),Da=d(oo,` will encode source text format, and it should be wrapped
inside the context manager `),It=a(oo,"A",{href:!0});var Pi=s(It);Xa=d(Pi,"as_target_tokenizer()"),Pi.forEach(o),Ga=d(oo," to encode target text format."),oo.forEach(o),_n=m(t),Dt=a(t,"UL",{});var Li=s(Dt);To=a(Li,"LI",{});var $i=s(To);Ra=d($i,"Supervised training"),$i.forEach(o),Li.forEach(o),bn=m(t),y(Ze.$$.fragment,t),kn=m(t),Xt=a(t,"UL",{});var qi=s(Xt);et=a(qi,"LI",{});var Sn=s(et);wo=a(Sn,"P",{});var zi=s(wo);Wa=d(zi,"Generation"),zi.forEach(o),Ha=m(Sn),Y=a(Sn,"P",{});var no=s(Y);Ua=d(no,"While generating the target text set the "),Po=a(no,"CODE",{});var Bi=s(Po);Va=d(Bi,"decoder_start_token_id"),Bi.forEach(o),Ja=d(no,` to the target language id. The following
example shows how to translate Python to English using the `),Lo=a(no,"CODE",{});var xi=s(Lo);Ka=d(xi,"uclanlp/plbart-python-en_XX"),xi.forEach(o),Qa=d(no," model."),no.forEach(o),Sn.forEach(o),qi.forEach(o),vn=m(t),y(tt.$$.fragment,t),yn=m(t),Z=a(t,"H2",{class:!0});var An=s(Z);_e=a(An,"A",{id:!0,class:!0,href:!0});var Ci=s(_e);$o=a(Ci,"SPAN",{});var Fi=s($o);y(ot.$$.fragment,Fi),Fi.forEach(o),Ci.forEach(o),Ya=m(An),qo=a(An,"SPAN",{});var ji=s(qo);Za=d(ji,"PLBartConfig"),ji.forEach(o),An.forEach(o),Tn=m(t),E=a(t,"DIV",{class:!0});var Ae=s(E);y(nt.$$.fragment,Ae),es=m(Ae),ee=a(Ae,"P",{});var ao=s(ee);ts=d(ao,"This is the configuration class to store the configuration of a "),Gt=a(ao,"A",{href:!0});var Ei=s(Gt);os=d(Ei,"PLBartModel"),Ei.forEach(o),ns=d(ao,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
`),at=a(ao,"A",{href:!0,rel:!0});var Mi=s(at);as=d(Mi,"uclanlp/plbart-base"),Mi.forEach(o),ss=d(ao," architecture."),ao.forEach(o),rs=m(Ae),te=a(Ae,"P",{});var so=s(te);is=d(so,"Configuration objects inherit from "),Rt=a(so,"A",{href:!0});var Si=s(Rt);ds=d(Si,"PretrainedConfig"),Si.forEach(o),ls=d(so,` and can be used to control the model outputs. Read the
documentation from `),Wt=a(so,"A",{href:!0});var Ai=s(Wt);cs=d(Ai,"PretrainedConfig"),Ai.forEach(o),ps=d(so," for more information."),so.forEach(o),hs=m(Ae),y(be.$$.fragment,Ae),Ae.forEach(o),wn=m(t),oe=a(t,"H2",{class:!0});var Nn=s(oe);ke=a(Nn,"A",{id:!0,class:!0,href:!0});var Ni=s(ke);zo=a(Ni,"SPAN",{});var Oi=s(zo);y(st.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),us=m(Nn),Bo=a(Nn,"SPAN",{});var Ii=s(Bo);ms=d(Ii,"PLBartTokenizer"),Ii.forEach(o),Nn.forEach(o),Pn=m(t),q=a(t,"DIV",{class:!0});var F=s(q);y(rt.$$.fragment,F),fs=m(F),xo=a(F,"P",{});var Di=s(xo);gs=d(Di,"Construct an PLBART tokenizer."),Di.forEach(o),_s=m(F),X=a(F,"P",{});var Ne=s(X);bs=d(Ne,"Adapted from "),Ht=a(Ne,"A",{href:!0});var Xi=s(Ht);ks=d(Xi,"RobertaTokenizer"),Xi.forEach(o),vs=d(Ne," and "),Ut=a(Ne,"A",{href:!0});var Gi=s(Ut);ys=d(Gi,"XLNetTokenizer"),Gi.forEach(o),Ts=d(Ne,`. Based on
`),it=a(Ne,"A",{href:!0,rel:!0});var Ri=s(it);ws=d(Ri,"SentencePiece"),Ri.forEach(o),Ps=d(Ne,"."),Ne.forEach(o),Ls=m(F),dt=a(F,"P",{});var On=s(dt);$s=d(On,"The tokenization method is "),Co=a(On,"CODE",{});var Wi=s(Co);qs=d(Wi,"<tokens> <eos> <language code>"),Wi.forEach(o),zs=d(On," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),On.forEach(o),Bs=m(F),y(ve.$$.fragment,F),xs=m(F),ye=a(F,"DIV",{class:!0});var In=s(ye);y(lt.$$.fragment,In),Cs=m(In),Fo=a(In,"P",{});var Hi=s(Fo);Fs=d(Hi,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An PLBART sequence has the following format, where `),jo=a(Dn,"CODE",{});var Ui=s(jo);Ss=d(Ui,"X"),Ui.forEach(o),As=d(Dn," represents the sequence:"),Dn.forEach(o),Ns=m(Oe),ht=a(Oe,"UL",{});var Xn=s(ht);ut=a(Xn,"LI",{});var Gn=s(ut);Eo=a(Gn,"CODE",{});var Vi=s(Eo);Os=d(Vi,"input_ids"),Vi.forEach(o),Is=d(Gn," (for encoder) "),Mo=a(Gn,"CODE",{});var Ji=s(Mo);Ds=d(Ji,"X [eos, src_lang_code]"),Ji.forEach(o),Gn.forEach(o),Xs=m(Xn),mt=a(Xn,"LI",{});var Rn=s(mt);So=a(Rn,"CODE",{});var Ki=s(So);Gs=d(Ki,"decoder_input_ids"),Ki.forEach(o),Rs=d(Rn,": (for decoder) "),Ao=a(Rn,"CODE",{});var Qi=s(Ao);Ws=d(Qi,"X [eos, tgt_lang_code]"),Qi.forEach(o),Rn.forEach(o),Xn.forEach(o),Hs=m(Oe),No=a(Oe,"P",{});var Yi=s(No);Us=d(Yi,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Yi.forEach(o),Oe.forEach(o),F.forEach(o),Ln=m(t),ne=a(t,"H2",{class:!0});var Wn=s(ne);Te=a(Wn,"A",{id:!0,class:!0,href:!0});var Zi=s(Te);Oo=a(Zi,"SPAN",{});var ed=s(Oo);y(ft.$$.fragment,ed),ed.forEach(o),Zi.forEach(o),Vs=m(Wn),Io=a(Wn,"SPAN",{});var td=s(Io);Js=d(td,"PLBartModel"),td.forEach(o),Wn.forEach(o),$n=m(t),M=a(t,"DIV",{class:!0});var Ie=s(M);y(gt.$$.fragment,Ie),Ks=m(Ie),_t=a(Ie,"P",{});var Hn=s(_t);Qs=d(Hn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hn.forEach(o),er=m(Ie),bt=a(Ie,"P",{});var Un=s(bt);tr=d(Un,"This model is also a PyTorch "),kt=a(Un,"A",{href:!0,rel:!0});var nd=s(kt);or=d(nd,"torch.nn.Module"),nd.forEach(o),nr=d(Un,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Un.forEach(o),ar=m(Ie),N=a(Ie,"DIV",{class:!0});var De=s(N);y(vt.$$.fragment,De),sr=m(De),ae=a(De,"P",{});var ro=s(ae);rr=d(ro,"The "),Jt=a(ro,"A",{href:!0});var ad=s(Jt);ir=d(ad,"PLBartModel"),ad.forEach(o),dr=d(ro," forward method, overrides the "),Do=a(ro,"CODE",{});var sd=s(Do);lr=d(sd,"__call__"),sd.forEach(o),cr=d(ro," special method."),ro.forEach(o),pr=m(De),y(we.$$.fragment,De),hr=m(De),y(Pe.$$.fragment,De),De.forEach(o),Ie.forEach(o),qn=m(t),se=a(t,"H2",{class:!0});var Vn=s(se);Le=a(Vn,"A",{id:!0,class:!0,href:!0});var rd=s(Le);Xo=a(rd,"SPAN",{});var id=s(Xo);y(yt.$$.fragment,id),id.forEach(o),rd.forEach(o),ur=m(Vn),Go=a(Vn,"SPAN",{});var dd=s(Go);mr=d(dd,"PLBartForConditionalGeneration"),dd.forEach(o),Vn.forEach(o),zn=m(t),S=a(t,"DIV",{class:!0});var Xe=s(S);y(Tt.$$.fragment,Xe),fr=m(Xe),wt=a(Xe,"P",{});var Jn=s(wt);gr=d(Jn,`The PLBART Model with a language modeling head. Can be used for code-to-text, text-to-code and code-to-code.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jn.forEach(o),kr=m(Xe),Pt=a(Xe,"P",{});var Kn=s(Pt);vr=d(Kn,"This model is also a PyTorch "),Lt=a(Kn,"A",{href:!0,rel:!0});var cd=s(Lt);yr=d(cd,"torch.nn.Module"),cd.forEach(o),Tr=d(Kn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kn.forEach(o),wr=m(Xe),O=a(Xe,"DIV",{class:!0});var Ge=s(O);y($t.$$.fragment,Ge),Pr=m(Ge),re=a(Ge,"P",{});var io=s(re);Lr=d(io,"The "),Qt=a(io,"A",{href:!0});var pd=s(Qt);$r=d(pd,"PLBartForConditionalGeneration"),pd.forEach(o),qr=d(io," forward method, overrides the "),Ro=a(io,"CODE",{});var hd=s(Ro);zr=d(hd,"__call__"),hd.forEach(o),Br=d(io," special method."),io.forEach(o),xr=m(Ge),y($e.$$.fragment,Ge),Cr=m(Ge),y(qe.$$.fragment,Ge),Ge.forEach(o),Xe.forEach(o),Bn=m(t),ie=a(t,"H2",{class:!0});var Qn=s(ie);ze=a(Qn,"A",{id:!0,class:!0,href:!0});var ud=s(ze);Wo=a(ud,"SPAN",{});var md=s(Wo);y(qt.$$.fragment,md),md.forEach(o),ud.forEach(o),Fr=m(Qn),Ho=a(Qn,"SPAN",{});var fd=s(Ho);jr=d(fd,"PLBartForSequenceClassification"),fd.forEach(o),Qn.forEach(o),xn=m(t),B=a(t,"DIV",{class:!0});var J=s(B);y(zt.$$.fragment,J),Er=m(J),Uo=a(J,"P",{});var gd=s(Uo);Mr=d(gd,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
