...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17334/src/transformers/models/dpt/feature_extraction_dpt.py#L133",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17334/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Whether or not to return a <a href="/docs/transformers/pr_17334/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17334/src/transformers/models/dpt/modeling_dpt.py#L708",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17334/en/model_doc/dpt#transformers.DPTConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17334/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17334/src/transformers/models/dpt/modeling_dpt.py#L863"}}),Ve=new J({props:{name:"forward",anchor:"transformers.DPTForDepthEstimation.forward",parameters:[{name:"pixel_values",val:""},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.DPTForDepthEstimation.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17334/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Ground truth depth estimation maps for computing the loss.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17334/src/transformers/models/dpt/modeling_dpt.py#L878",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17334/en/main_classes/output#transformers.modeling_outputs.DepthEstimatorOutput"
...
Ground truth semantic segmentation maps for computing the loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code>, a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17334/src/transformers/models/dpt/modeling_dpt.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17334/en/main_classes/output#transformers.modeling_outputs.SemanticSegmenterOutput"
