...
* Use the [PreTrainedModel.from_pretrained()](/docs/transformers/pr_15676/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) and [PreTrainedModel.save_pretrained()](/docs/transformers/pr_15676/en/main_classes/model#transformers.PreTrainedModel.save_pretrained) workflow:

    1. Download your files ahead of time with [PreTrainedModel.from_pretrained()](/docs/transformers/pr_15676/en/main_classes/model#transformers.PreTrainedModel.from_pretrained):
    ...
    2. Save your files to a specified directory with [PreTrainedModel.save_pretrained()](/docs/transformers/pr_15676/en/main_classes/model#transformers.PreTrainedModel.save_pretrained):
    ...
    3. Now when you're offline, reload your files with [PreTrainedModel.from_pretrained()](/docs/transformers/pr_15676/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) from the specified directory:
