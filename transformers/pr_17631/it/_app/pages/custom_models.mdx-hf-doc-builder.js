import{S as qr,i as Cr,s as jr,e as s,k as d,w as _,t as l,M as Pr,c as n,d as i,m as p,a as r,x as h,h as t,b as u,G as o,g as c,y as v,q as g,o as b,B as z,v as Ar}from"../chunks/vendor-hf-doc-builder.js";import{C as w,T as Ks}from"../chunks/CodeBlock-hf-doc-builder.js";import{I as zo}from"../chunks/IconCopyLink-hf-doc-builder.js";function Rr(Y){let m,E;return{c(){m=s("p"),E=l("Se il tuo modello \xE8 molto simile a un modello all\u2019interno della libreria, puoi ri-usare la stessa configurazione di quel modello.")},l(f){m=n(f,"P",{});var $=r(m);E=t($,"Se il tuo modello \xE8 molto simile a un modello all\u2019interno della libreria, puoi ri-usare la stessa configurazione di quel modello."),$.forEach(i)},m(f,$){c(f,m,$),o(m,E)},d(f){f&&i(m)}}}function Mr(Y){let m,E;return{c(){m=s("p"),E=l("Questa API \xE8 sperimentale e potrebbe avere alcuni cambiamenti nei prossimi rilasci.")},l(f){m=n(f,"P",{});var $=r(m);E=t($,"Questa API \xE8 sperimentale e potrebbe avere alcuni cambiamenti nei prossimi rilasci."),$.forEach(i)},m(f,$){c(f,m,$),o(m,E)},d(f){f&&i(m)}}}function Ir(Y){let m,E,f,$,Q;return{c(){m=s("p"),E=l(`Se stai copiando i file relativi alla modellazione della libreria, dovrai sostituire tutti gli import relativi in cima al file con import del
