...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16310/en/model_doc/bart#transformers.BartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16310/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16310/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16310/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16310/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16310/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16310/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16310/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16310/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16310/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16310/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16310/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),sf=l(Mt),Y=a(Mt,"DIV",{class:!0});var Le=s(Y);f(ya.$$.fragment,Le),rf=l(Le),io=a(Le,"P",{});var ni=s(io);df=i(ni,"The "),Cr=a(ni,"A",{href:!0});var l1=s(Cr);lf=i(l1,"BartForSequenceClassification"),l1.forEach(t),cf=i(ni," forward method, overrides the "),md=a(ni,"CODE",{});var c1=s(md);pf=i(c1,"__call__"),c1.forEach(t),hf=i(ni," special method."),ni.forEach(t),uf=l(Le),f(Qo.$$.fragment,Le),mf=l(Le),fd=a(Le,"P",{});var p1=s(fd);ff=i(p1,"Example of single-label classification:"),p1.forEach(t),_f=l(Le),f(Ta.$$.fragment,Le),gf=l(Le),_d=a(Le,"P",{});var h1=s(_d);kf=i(h1,"Example of multi-label classification:"),h1.forEach(t),bf=l(Le),f(va.$$.fragment,Le),Le.forEach(t),Mt.forEach(t),bc=l(o),lo=a(o,"H2",{class:!0});var pp=s(lo);Vo=a(pp,"A",{id:!0,class:!0,href:!0});var u1=s(Vo);gd=a(u1,"SPAN",{});var m1=s(gd);f(wa.$$.fragment,m1),m1.forEach(t),u1.forEach(t),yf=l(pp),kd=a(pp,"SPAN",{});var f1=s(kd);Tf=i(f1,"BartForQuestionAnswering"),f1.forEach(t),pp.forEach(t),yc=l(o),ze=a(o,"DIV",{class:!0});var Pt=s(ze);f(xa.$$.fragment,Pt),vf=l(Pt),co=a(Pt,"P",{});var ai=s(co);wf=i(ai,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),Of=l(Pt),Ee=a(Pt,"DIV",{class:!0});var Et=s(Ee);f(qa.$$.fragment,Et),Sf=l(Et),po=a(Et,"P",{});var si=s(po);If=i(si,"The "),Or=a(si,"A",{href:!0});var y1=s(Or);Nf=i(y1,"BartForQuestionAnswering"),y1.forEach(t),Lf=i(si," forward method, overrides the "),Td=a(si,"CODE",{});var T1=s(Td);Df=i(T1,"__call__"),T1.forEach(t),Gf=i(si," special method."),si.forEach(t),Wf=l(Et),f(Jo.$$.fragment,Et),Uf=l(Et),vd=a(Et,"P",{});var v1=s(vd);Rf=i(v1,"Example:"),v1.forEach(t),Hf=l(Et),f($a.$$.fragment,Et),Et.forEach(t),Pt.forEach(t),Tc=l(o),ho=a(o,"H2",{class:!0});var mp=s(ho);Xo=a(mp,"A",{id:!0,class:!0,href:!0});var w1=s(Xo);wd=a(w1,"SPAN",{});var x1=s(wd);f(ja.$$.fragment,x1),x1.forEach(t),w1.forEach(t),Qf=l(mp),xd=a(mp,"SPAN",{});var z1=s(xd);Vf=i(z1,"BartForCausalLM"),z1.forEach(t),mp.forEach(t),vc=l(o),uo=a(o,"DIV",{class:!0});var fp=s(uo);f(Ma.$$.fragment,fp),Jf=l(fp),bt=a(fp,"DIV",{class:!0});var ri=s(bt);f(Pa.$$.fragment,ri),Xf=l(ri),zd=a(ri,"P",{});var F1=s(zd);Kf=i(F1,"Example:"),F1.forEach(t),Zf=l(ri),f(Ea.$$.fragment,ri),ri.forEach(t),fp.forEach(t),wc=l(o),mo=a(o,"H2",{class:!0});var _p=s(mo);Ko=a(_p,"A",{id:!0,class:!0,href:!0});var B1=s(Ko);Fd=a(B1,"SPAN",{});var q1=s(Fd);f(Ca.$$.fragment,q1),q1.forEach(t),B1.forEach(t),Yf=l(_p),Bd=a(_p,"SPAN",{});var $1=s(Bd);e_=i($1,"TFBartModel"),$1.forEach(t),_p.forEach(t),xc=l(o),Fe=a(o,"DIV",{class:!0});var Ct=s(Fe);f(Aa.$$.fragment,Ct),t_=l(Ct),Oa=a(Ct,"P",{});var gp=s(Oa);o_=i(gp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Sr=a(gp,"A",{href:!0});var j1=s(Sr);n_=i(j1,"TFPreTrainedModel"),j1.forEach(t),a_=i(gp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gp.forEach(t),s_=l(Ct),Sa=a(Ct,"P",{});var kp=s(Sa);r_=i(kp,"This model is also a "),Ia=a(kp,"A",{href:!0,rel:!0});var M1=s(Ia);i_=i(M1,"tf.keras.Model"),M1.forEach(t),d_=i(kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kp.forEach(t),l_=l(Ct),f(Zo.$$.fragment,Ct),c_=l(Ct),Ce=a(Ct,"DIV",{class:!0});var At=s(Ce);f(Na.$$.fragment,At),p_=l(At),fo=a(At,"P",{});var ii=s(fo);h_=i(ii,"The "),Ir=a(ii,"A",{href:!0});var P1=s(Ir);u_=i(P1,"TFBartModel"),P1.forEach(t),m_=i(ii," forward method, overrides the "),qd=a(ii,"CODE",{});var E1=s(qd);f_=i(E1,"__call__"),E1.forEach(t),__=i(ii," special method."),ii.forEach(t),g_=l(At),f(Yo.$$.fragment,At),k_=l(At),$d=a(At,"P",{});var C1=s($d);b_=i(C1,"Example:"),C1.forEach(t),y_=l(At),f(La.$$.fragment,At),At.forEach(t),Ct.forEach(t),zc=l(o),_o=a(o,"H2",{class:!0});var bp=s(_o);en=a(bp,"A",{id:!0,class:!0,href:!0});var A1=s(en);jd=a(A1,"SPAN",{});var O1=s(jd);f(Da.$$.fragment,O1),O1.forEach(t),A1.forEach(t),T_=l(bp),Md=a(bp,"SPAN",{});var S1=s(Md);v_=i(S1,"TFBartForConditionalGeneration"),S1.forEach(t),bp.forEach(t),Fc=l(o),Be=a(o,"DIV",{class:!0});var Ot=s(Be);f(Ga.$$.fragment,Ot),w_=l(Ot),Wa=a(Ot,"P",{});var yp=s(Wa);x_=i(yp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Nr=a(yp,"A",{href:!0});var I1=s(Nr);z_=i(I1,"TFPreTrainedModel"),I1.forEach(t),F_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),B_=l(Ot),Ua=a(Ot,"P",{});var Tp=s(Ua);q_=i(Tp,"This model is also a "),Ra=a(Tp,"A",{href:!0,rel:!0});var N1=s(Ra);$_=i(N1,"tf.keras.Model"),N1.forEach(t),j_=i(Tp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),M_=l(Ot),f(tn.$$.fragment,Ot),P_=l(Ot),ee=a(Ot,"DIV",{class:!0});var De=s(ee);f(Ha.$$.fragment,De),E_=l(De),go=a(De,"P",{});var di=s(go);C_=i(di,"The "),Lr=a(di,"A",{href:!0});var L1=s(Lr);A_=i(L1,"TFBartForConditionalGeneration"),L1.forEach(t),O_=i(di," forward method, overrides the "),Pd=a(di,"CODE",{});var D1=s(Pd);S_=i(D1,"__call__"),D1.forEach(t),I_=i(di," special method."),di.forEach(t),N_=l(De),f(on.$$.fragment,De),L_=l(De),Ed=a(De,"P",{});var G1=s(Ed);D_=i(G1,"Summarization example:"),G1.forEach(t),G_=l(De),f(Qa.$$.fragment,De),W_=l(De),Cd=a(De,"P",{});var W1=s(Cd);U_=i(W1,"Mask filling example:"),W1.forEach(t),R_=l(De),f(Va.$$.fragment,De),De.forEach(t),Ot.forEach(t),Bc=l(o),ko=a(o,"H2",{class:!0});var vp=s(ko);nn=a(vp,"A",{id:!0,class:!0,href:!0});var U1=s(nn);Ad=a(U1,"SPAN",{});var R1=s(Ad);f(Ja.$$.fragment,R1),R1.forEach(t),U1.forEach(t),H_=l(vp),Od=a(vp,"SPAN",{});var H1=s(Od);Q_=i(H1,"FlaxBartModel"),H1.forEach(t),vp.forEach(t),qc=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);f(Xa.$$.fragment,fe),V_=l(fe),Ka=a(fe,"P",{});var wp=s(Ka);J_=i(wp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Dr=a(wp,"A",{href:!0});var Q1=s(Dr);X_=i(Q1,"FlaxPreTrainedModel"),Q1.forEach(t),K_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xp.forEach(t),og=l(fe),Sd=a(fe,"P",{});var J1=s(Sd);ng=i(J1,"Finally, this model supports inherent JAX features such as:"),J1.forEach(t),ag=l(fe),pt=a(fe,"UL",{});var bn=s(pt);Id=a(bn,"LI",{});var X1=s(Id);es=a(X1,"A",{href:!0,rel:!0});var K1=s(es);sg=i(K1,"Just-In-Time (JIT) compilation"),K1.forEach(t),X1.forEach(t),rg=l(bn),Nd=a(bn,"LI",{});var Z1=s(Nd);ts=a(Z1,"A",{href:!0,rel:!0});var Y1=s(ts);ig=i(Y1,"Automatic Differentiation"),Y1.forEach(t),Z1.forEach(t),dg=l(bn),Ld=a(bn,"LI",{});var ev=s(Ld);os=a(ev,"A",{href:!0,rel:!0});var tv=s(os);lg=i(tv,"Vectorization"),tv.forEach(t),ev.forEach(t),cg=l(bn),Dd=a(bn,"LI",{});var ov=s(Dd);ns=a(ov,"A",{href:!0,rel:!0});var nv=s(ns);pg=i(nv,"Parallelization"),nv.forEach(t),ov.forEach(t),bn.forEach(t),hg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);f(as.$$.fragment,St),ug=l(St),bo=a(St,"P",{});var li=s(bo);mg=i(li,"The "),Gd=a(li,"CODE",{});var av=s(Gd);fg=i(av,"FlaxBartPreTrainedModel"),av.forEach(t),_g=i(li,"forward method, overrides the "),Wd=a(li,"CODE",{});var sv=s(Wd);gg=i(sv,"__call__"),sv.forEach(t),kg=i(li," special method."),li.forEach(t),bg=l(St),f(an.$$.fragment,St),yg=l(St),Ud=a(St,"P",{});var rv=s(Ud);Tg=i(rv,"Example:"),rv.forEach(t),vg=l(St),f(ss.$$.fragment,St),St.forEach(t),wg=l(fe),yt=a(fe,"DIV",{class:!0});var ci=s(yt);f(rs.$$.fragment,ci),xg=l(ci),Rd=a(ci,"P",{});var iv=s(Rd);zg=i(iv,"Example:"),iv.forEach(t),Fg=l(ci),f(is.$$.fragment,ci),ci.forEach(t),Bg=l(fe),Tt=a(fe,"DIV",{class:!0});var pi=s(Tt);f(ds.$$.fragment,pi),qg=l(pi),Hd=a(pi,"P",{});var dv=s(Hd);$g=i(dv,"Example:"),dv.forEach(t),jg=l(pi),f(ls.$$.fragment,pi),pi.forEach(t),fe.forEach(t),$c=l(o),yo=a(o,"H2",{class:!0});var zp=s(yo);sn=a(zp,"A",{id:!0,class:!0,href:!0});var lv=s(sn);Qd=a(lv,"SPAN",{});var cv=s(Qd);f(cs.$$.fragment,cv),cv.forEach(t),lv.forEach(t),Mg=l(zp),Vd=a(zp,"SPAN",{});var pv=s(Vd);Pg=i(pv,"FlaxBartForConditionalGeneration"),pv.forEach(t),zp.forEach(t),jc=l(o),U=a(o,"DIV",{class:!0});var _e=s(U);f(ps.$$.fragment,_e),Eg=l(_e),hs=a(_e,"P",{});var Fp=s(hs);Cg=i(Fp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(Fp,"A",{href:!0});var hv=s(Gr);Ag=i(hv,"FlaxPreTrainedModel"),hv.forEach(t),Og=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp.forEach(t),Sg=l(_e),us=a(_e,"P",{});var Bp=s(us);Ig=i(Bp,`This model is also a Flax Linen
`),ms=a(Bp,"A",{href:!0,rel:!0});var uv=s(ms);Ng=i(uv,"flax.nn.Module"),uv.forEach(t),Lg=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),Dg=l(_e),Jd=a(_e,"P",{});var mv=s(Jd);Gg=i(mv,"Finally, this model supports inherent JAX features such as:"),mv.forEach(t),Wg=l(_e),ht=a(_e,"UL",{});var yn=s(ht);Xd=a(yn,"LI",{});var fv=s(Xd);fs=a(fv,"A",{href:!0,rel:!0});var _v=s(fs);Ug=i(_v,"Just-In-Time (JIT) compilation"),_v.forEach(t),fv.forEach(t),Rg=l(yn),Kd=a(yn,"LI",{});var gv=s(Kd);_s=a(gv,"A",{href:!0,rel:!0});var kv=s(_s);Hg=i(kv,"Automatic Differentiation"),kv.forEach(t),gv.forEach(t),Qg=l(yn),Zd=a(yn,"LI",{});var bv=s(Zd);gs=a(bv,"A",{href:!0,rel:!0});var yv=s(gs);Vg=i(yv,"Vectorization"),yv.forEach(t),bv.forEach(t),Jg=l(yn),Yd=a(yn,"LI",{});var Tv=s(Yd);ks=a(Tv,"A",{href:!0,rel:!0});var vv=s(ks);Xg=i(vv,"Parallelization"),vv.forEach(t),Tv.forEach(t),yn.forEach(t),Kg=l(_e),te=a(_e,"DIV",{class:!0});var Ge=s(te);f(bs.$$.fragment,Ge),Zg=l(Ge),To=a(Ge,"P",{});var hi=s(To);Yg=i(hi,"The "),el=a(hi,"CODE",{});var wv=s(el);ek=i(wv,"FlaxBartPreTrainedModel"),wv.forEach(t),tk=i(hi,"forward method, overrides the "),tl=a(hi,"CODE",{});var xv=s(tl);ok=i(xv,"__call__"),xv.forEach(t),nk=i(hi," special method."),hi.forEach(t),ak=l(Ge),f(rn.$$.fragment,Ge),sk=l(Ge),ol=a(Ge,"P",{});var zv=s(ol);rk=i(zv,"Summarization example:"),zv.forEach(t),ik=l(Ge),f(ys.$$.fragment,Ge),dk=l(Ge),nl=a(Ge,"P",{});var Fv=s(nl);lk=i(Fv,"Mask filling example:"),Fv.forEach(t),ck=l(Ge),f(Ts.$$.fragment,Ge),Ge.forEach(t),pk=l(_e),vt=a(_e,"DIV",{class:!0});var ui=s(vt);f(vs.$$.fragment,ui),hk=l(ui),al=a(ui,"P",{});var Bv=s(al);uk=i(Bv,"Example:"),Bv.forEach(t),mk=l(ui),f(ws.$$.fragment,ui),ui.forEach(t),fk=l(_e),wt=a(_e,"DIV",{class:!0});var mi=s(wt);f(xs.$$.fragment,mi),_k=l(mi),sl=a(mi,"P",{});var qv=s(sl);gk=i(qv,"Example:"),qv.forEach(t),kk=l(mi),f(zs.$$.fragment,mi),mi.forEach(t),_e.forEach(t),Mc=l(o),vo=a(o,"H2",{class:!0});var qp=s(vo);dn=a(qp,"A",{id:!0,class:!0,href:!0});var $v=s(dn);rl=a($v,"SPAN",{});var jv=s(rl);f(Fs.$$.fragment,jv),jv.forEach(t),$v.forEach(t),bk=l(qp),il=a(qp,"SPAN",{});var Mv=s(il);yk=i(Mv,"FlaxBartForSequenceClassification"),Mv.forEach(t),qp.forEach(t),Pc=l(o),S=a(o,"DIV",{class:!0});var oe=s(S);f(Bs.$$.fragment,oe),Tk=l(oe),dl=a(oe,"P",{});var Pv=s(dl);vk=i(Pv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Pv.forEach(t),wk=l(oe),qs=a(oe,"P",{});var $p=s(qs);xk=i($p,"This model inherits from "),Wr=a($p,"A",{href:!0});var Ev=s(Wr);zk=i(Ev,"FlaxPreTrainedModel"),Ev.forEach(t),Fk=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),Bk=l(oe),$s=a(oe,"P",{});var jp=s($s);qk=i(jp,`This model is also a Flax Linen
`),js=a(jp,"A",{href:!0,rel:!0});var Cv=s(js);$k=i(Cv,"flax.nn.Module"),Cv.forEach(t),jk=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Mk=l(oe),ll=a(oe,"P",{});var Av=s(ll);Pk=i(Av,"Finally, this model supports inherent JAX features such as:"),Av.forEach(t),Ek=l(oe),ut=a(oe,"UL",{});var Tn=s(ut);cl=a(Tn,"LI",{});var Ov=s(cl);Ms=a(Ov,"A",{href:!0,rel:!0});var Sv=s(Ms);Ck=i(Sv,"Just-In-Time (JIT) compilation"),Sv.forEach(t),Ov.forEach(t),Ak=l(Tn),pl=a(Tn,"LI",{});var Iv=s(pl);Ps=a(Iv,"A",{href:!0,rel:!0});var Nv=s(Ps);Ok=i(Nv,"Automatic Differentiation"),Nv.forEach(t),Iv.forEach(t),Sk=l(Tn),hl=a(Tn,"LI",{});var Lv=s(hl);Es=a(Lv,"A",{href:!0,rel:!0});var Dv=s(Es);Ik=i(Dv,"Vectorization"),Dv.forEach(t),Lv.forEach(t),Nk=l(Tn),ul=a(Tn,"LI",{});var Gv=s(ul);Cs=a(Gv,"A",{href:!0,rel:!0});var Wv=s(Cs);Lk=i(Wv,"Parallelization"),Wv.forEach(t),Gv.forEach(t),Tn.forEach(t),Dk=l(oe),Oe=a(oe,"DIV",{class:!0});var It=s(Oe);f(As.$$.fragment,It),Gk=l(It),wo=a(It,"P",{});var fi=s(wo);Wk=i(fi,"The "),ml=a(fi,"CODE",{});var Uv=s(ml);Uk=i(Uv,"FlaxBartPreTrainedModel"),Uv.forEach(t),Rk=i(fi,"forward method, overrides the "),fl=a(fi,"CODE",{});var Rv=s(fl);Hk=i(Rv,"__call__"),Rv.forEach(t),Qk=i(fi," special method."),fi.forEach(t),Vk=l(It),f(ln.$$.fragment,It),Jk=l(It),_l=a(It,"P",{});var Hv=s(_l);Xk=i(Hv,"Example:"),Hv.forEach(t),Kk=l(It),f(Os.$$.fragment,It),It.forEach(t),Zk=l(oe),xt=a(oe,"DIV",{class:!0});var _i=s(xt);f(Ss.$$.fragment,_i),Yk=l(_i),gl=a(_i,"P",{});var Qv=s(gl);eb=i(Qv,"Example:"),Qv.forEach(t),tb=l(_i),f(Is.$$.fragment,_i),_i.forEach(t),ob=l(oe),zt=a(oe,"DIV",{class:!0});var gi=s(zt);f(Ns.$$.fragment,gi),nb=l(gi),kl=a(gi,"P",{});var Vv=s(kl);ab=i(Vv,"Example:"),Vv.forEach(t),sb=l(gi),f(Ls.$$.fragment,gi),gi.forEach(t),oe.forEach(t),Ec=l(o),xo=a(o,"H2",{class:!0});var Mp=s(xo);cn=a(Mp,"A",{id:!0,class:!0,href:!0});var Jv=s(cn);bl=a(Jv,"SPAN",{});var Xv=s(bl);f(Ds.$$.fragment,Xv),Xv.forEach(t),Jv.forEach(t),rb=l(Mp),yl=a(Mp,"SPAN",{});var Kv=s(yl);ib=i(Kv,"FlaxBartForQuestionAnswering"),Kv.forEach(t),Mp.forEach(t),Cc=l(o),I=a(o,"DIV",{class:!0});var ne=s(I);f(Gs.$$.fragment,ne),db=l(ne),zo=a(ne,"P",{});var ki=s(zo);lb=i(ki,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Zv=s(Tl);cb=i(Zv,"span start logits"),Zv.forEach(t),pb=i(ki," and "),vl=a(ki,"CODE",{});var Yv=s(vl);hb=i(Yv,"span end logits"),Yv.forEach(t),ub=i(ki,")."),ki.forEach(t),mb=l(ne),Ws=a(ne,"P",{});var Pp=s(Ws);fb=i(Pp,"This model inherits from "),Ur=a(Pp,"A",{href:!0});var ew=s(Ur);_b=i(ew,"FlaxPreTrainedModel"),ew.forEach(t),gb=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
