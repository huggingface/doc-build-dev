import{S as fs,i as us,s as gs,e as n,k as m,w as v,t as i,M as _s,c as s,d as o,m as f,a,x as k,h as l,b as h,G as t,g,y as w,q as P,o as $,B as y,v as Ts,L as oo}from"../../chunks/vendor-hf-doc-builder.js";import{T as Mn}from"../../chunks/Tip-hf-doc-builder.js";import{D as et}from"../../chunks/Docstring-hf-doc-builder.js";import{C as tt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ae}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as to}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function bs(G){let d,T;return d=new tt({props:{code:`from transformers import GPTNeoXModel, GPTNeoXConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),v(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),b=!0},p:oo,i(r){b||(P(u.$$.fragment,r),b=!0)},o(r){$(u.$$.fragment,r),b=!1},d(r){r&&o(d),r&&o(p),y(u,r)}}}function Ns(G){let d,T,p,u,b,r,_,X,A,z,C,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Ie,ho,xt,ge,zt,Se,mo,Mt,I,K,st,_e,fo,at,uo,Ct,Q,go,rt,_o,To,Ft,Te,Et,S,Z,it,be,bo,lt,vo,qt,M,ve,ko,D,wo,De,Po,$o,ke,yo,No,Go,B,Xo,Be,xo,zo,We,Mo,Co,Fo,ee,jt,W,te,dt,we,Eo,ct,qo,Lt,N,Pe,jo,$e,Lo,pt,Ao,Io,So,ht,Do,Bo,oe,Wo,ye,Oo,mt,Ho,Uo,Vo,ne,Jo,Ne,Ro,Oe,Yo,Ko,At,O,se,ft,Ge,Qo,ut,Zo,It,j,Xe,en,xe,tn,ze,on,nn,sn,F,Me,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,St,U,ie,_t,Ce,fn,Tt,un,Dt,L,Fe,gn,V,_n,bt,Tn,bn,Ee,vn,kn,wn,E,qe,Pn,J,$n,Ue,yn,Nn,vt,Gn,Xn,xn,le,zn,de,Bt;return r=new Ae({}),me=new Ae({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ae({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
<span class="hljs-meta">&gt;&gt;&gt; </span>gen_text = tokenizer.batch_decode(gen_tokens)[<span class="hljs-number">0</span>]`}}),be=new Ae({}),ve=new et({props:{name:"class transformers.GPTNeoXConfig",anchor:"transformers.GPTNeoXConfig",parameters:[{name:"vocab_size",val:" = 50432"},{name:"hidden_size",val:" = 6144"},{name:"num_hidden_layers",val:" = 44"},{name:"num_attention_heads",val:" = 64"},{name:"intermediate_size",val:" = 24576"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"rotary_pct",val:" = 0.25"},{name:"rotary_emb_base",val:" = 10000"},{name:"max_position_embeddings",val:" = 2048"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"tie_word_embeddings",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the GPTNeoX model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXModel">GPTNeoXModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTNeoXConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Example &#x2014;`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/gpt_neox/configuration_gpt_neox.py#L29"}}),ee=new to({props:{anchor:"transformers.GPTNeoXConfig.example",$$slots:{default:[bs]},$$scope:{ctx:G}}}),we=new Ae({}),Pe=new et({props:{name:"class transformers.GPTNeoXTokenizerFast",anchor:"transformers.GPTNeoXTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"unk_token",val:" = '<|endoftext|>'"},{name:"bos_token",val:" = '<|endoftext|>'"},{name:"eos_token",val:" = '<|endoftext|>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[vs]},$$scope:{ctx:G}}}),ne=new Mn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Ae({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17308/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L383"}}),Me=new et({props:{name:"forward",anchor:"transformers.GPTNeoXModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17308/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L401",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17308/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXConfig"
...
`}}),ae=new Mn({props:{$$slots:{default:[ws]},$$scope:{ctx:G}}}),re=new to({props:{anchor:"transformers.GPTNeoXModel.forward.example",$$slots:{default:[Ps]},$$scope:{ctx:G}}}),Ce=new Ae({}),Fe=new et({props:{name:"class transformers.GPTNeoXForCausalLM",anchor:"transformers.GPTNeoXForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17308/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L521"}}),qe=new et({props:{name:"forward",anchor:"transformers.GPTNeoXForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17308/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17308/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L540",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17308/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Mt=m(),I=n("h3"),K=n("a"),st=n("span"),v(_e.$$.fragment),fo=m(),at=n("span"),uo=i("Generation"),Ct=m(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Ft=m(),v(Te.$$.fragment),Et=m(),S=n("h2"),Z=n("a"),it=n("span"),v(be.$$.fragment),bo=m(),lt=n("span"),vo=i("GPTNeoXConfig"),qt=m(),M=n("div"),v(ve.$$.fragment),ko=m(),D=n("p"),wo=i("This is the configuration class to store the configuration of a "),De=n("a"),Po=i("GPTNeoXModel"),$o=i(`. It is used to instantiate an
...
documentation from `),We=n("a"),Mo=i("PretrainedConfig"),Co=i(" for more information."),Fo=m(),v(ee.$$.fragment),jt=m(),W=n("h2"),te=n("a"),dt=n("span"),v(we.$$.fragment),Eo=m(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),Lt=m(),N=n("div"),v(Pe.$$.fragment),jo=m(),$e=n("p"),Lo=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Ao=i("tokenizers"),Io=i(` library). Based on byte-level
...
the model was not pretrained this way, it might yield a decrease in performance.`),Vo=m(),v(ne.$$.fragment),Jo=m(),Ne=n("p"),Ro=i("This tokenizer inherits from "),Oe=n("a"),Yo=i("PreTrainedTokenizerFast"),Ko=i(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),At=m(),O=n("h2"),se=n("a"),ft=n("span"),v(Ge.$$.fragment),Qo=m(),ut=n("span"),Zo=i("GPTNeoXModel"),It=m(),j=n("div"),v(Xe.$$.fragment),en=m(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=m(),F=n("div"),v(Me.$$.fragment),an=m(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=m(),v(ae.$$.fragment),mn=m(),v(re.$$.fragment),St=m(),U=n("h2"),ie=n("a"),_t=n("span"),v(Ce.$$.fragment),fn=m(),Tt=n("span"),un=i("GPTNeoXForCausalLM"),Dt=m(),L=n("div"),v(Fe.$$.fragment),gn=m(),V=n("p"),_n=i("GPTNeoX Model with a "),bt=n("code"),Tn=i("language modeling"),bn=i(` head on top for CLM fine-tuning.
This model is a PyTorch `),Ee=n("a"),vn=i("torch.nn.Module"),kn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wn=m(),E=n("div"),v(qe.$$.fragment),Pn=m(),J=n("p"),$n=i("The "),Ue=n("a"),yn=i("GPTNeoXForCausalLM"),Nn=i(" forward method, overrides the "),vt=n("code"),Gn=i("__call__"),Xn=i(" special method."),xn=m(),v(le.$$.fragment),zn=m(),v(de.$$.fragment),this.h()},l(e){const c=_s('[data-svelte="svelte-1phssyn"]',document.head);d=s(c,"META",{name:!0,content:!0}),c.forEach(o),T=f(e),p=s(e,"H1",{class:!0});var je=a(p);u=s(je,"A",{id:!0,class:!0,href:!0});var kt=a(u);b=s(kt,"SPAN",{});var wt=a(b);k(r.$$.fragment,wt),wt.forEach(o),kt.forEach(o),_=f(je),X=s(je,"SPAN",{});var Pt=a(X);A=l(Pt,"GPT-NeoX"),Pt.forEach(o),je.forEach(o),z=f(e),C=s(e,"H2",{class:!0});var Le=a(C);q=s(Le,"A",{id:!0,class:!0,href:!0});var $t=a(q);ot=s($t,"SPAN",{});var yt=a(ot);k(me.$$.fragment,yt),yt.forEach(o),$t.forEach(o),no=f(Le),nt=s(Le,"SPAN",{});var Cn=a(nt);so=l(Cn,"Overview"),Cn.forEach(o),Le.forEach(o),Nt=f(e),R=s(e,"P",{});var Wt=a(R);ao=l(Wt,`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
be made freely and openly available to the public through a permissive license. It is, to the best of our knowledge,
the largest dense autoregressive model that has publicly available weights at the time of submission. In this work,
we describe GPT-NeoX-20B\u2019s architecture and training and evaluate its performance on a range of language-understanding,
mathematics, and knowledge-based tasks. We find that GPT-NeoX-20B is a particularly powerful few-shot reasoner and
gains far more in performance when evaluated five-shot than similarly sized GPT-3 and FairSeq models. We open-source
the training and evaluation code, as well as the model weights, at `),fe=s(Wt,"A",{href:!0,rel:!0});var Fn=a(fe);ro=l(Fn,"https://github.com/EleutherAI/gpt-neox"),Fn.forEach(o),io=l(Wt,"."),Wt.forEach(o),Gt=f(e),Y=s(e,"P",{});var Ot=a(Y);lo=l(Ot,`Development of the model was led by Sid Black, Stella Biderman and Eric Hallahan, and the model was trained with
generous the support of `),ue=s(Ot,"A",{href:!0,rel:!0});var En=a(ue);co=l(En,"CoreWeave"),En.forEach(o),po=l(Ot,"."),Ot.forEach(o),Xt=f(e),Ie=s(e,"P",{});var qn=a(Ie);ho=l(qn,"GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),qn.forEach(o),xt=f(e),k(ge.$$.fragment,e),zt=f(e),Se=s(e,"P",{});var jn=a(Se);mo=l(jn,`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),jn.forEach(o),Mt=f(e),I=s(e,"H3",{class:!0});var Ht=a(I);K=s(Ht,"A",{id:!0,class:!0,href:!0});var Ln=a(K);st=s(Ln,"SPAN",{});var An=a(st);k(_e.$$.fragment,An),An.forEach(o),Ln.forEach(o),fo=f(Ht),at=s(Ht,"SPAN",{});var In=a(at);uo=l(In,"Generation"),In.forEach(o),Ht.forEach(o),Ct=f(e),Q=s(e,"P",{});var Ut=a(Q);go=l(Ut,"The "),rt=s(Ut,"CODE",{});var Sn=a(rt);_o=l(Sn,"generate()"),Sn.forEach(o),To=l(Ut," method can be used to generate text using GPT Neo model."),Ut.forEach(o),Ft=f(e),k(Te.$$.fragment,e),Et=f(e),S=s(e,"H2",{class:!0});var Vt=a(S);Z=s(Vt,"A",{id:!0,class:!0,href:!0});var Dn=a(Z);it=s(Dn,"SPAN",{});var Bn=a(it);k(be.$$.fragment,Bn),Bn.forEach(o),Dn.forEach(o),bo=f(Vt),lt=s(Vt,"SPAN",{});var Wn=a(lt);vo=l(Wn,"GPTNeoXConfig"),Wn.forEach(o),Vt.forEach(o),qt=f(e),M=s(e,"DIV",{class:!0});var ce=a(M);k(ve.$$.fragment,ce),ko=f(ce),D=s(ce,"P",{});var Ve=a(D);wo=l(Ve,"This is the configuration class to store the configuration of a "),De=s(Ve,"A",{href:!0});var On=a(De);Po=l(On,"GPTNeoXModel"),On.forEach(o),$o=l(Ve,`. It is used to instantiate an
GPTNeoX model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GPTNeoX
`),ke=s(Ve,"A",{href:!0,rel:!0});var Hn=a(ke);yo=l(Hn,"eleutherai/gpt-neox-20b"),Hn.forEach(o),No=l(Ve," architecture."),Ve.forEach(o),Go=f(ce),B=s(ce,"P",{});var Je=a(B);Xo=l(Je,"Configuration objects inherit from "),Be=s(Je,"A",{href:!0});var Un=a(Be);xo=l(Un,"PretrainedConfig"),Un.forEach(o),zo=l(Je,` and can be used to control the model outputs. Read the
documentation from `),We=s(Je,"A",{href:!0});var Vn=a(We);Mo=l(Vn,"PretrainedConfig"),Vn.forEach(o),Co=l(Je," for more information."),Je.forEach(o),Fo=f(ce),k(ee.$$.fragment,ce),ce.forEach(o),jt=f(e),W=s(e,"H2",{class:!0});var Jt=a(W);te=s(Jt,"A",{id:!0,class:!0,href:!0});var Jn=a(te);dt=s(Jn,"SPAN",{});var Rn=a(dt);k(we.$$.fragment,Rn),Rn.forEach(o),Jn.forEach(o),Eo=f(Jt),ct=s(Jt,"SPAN",{});var Yn=a(ct);qo=l(Yn,"GPTNeoXTokenizerFast"),Yn.forEach(o),Jt.forEach(o),Lt=f(e),N=s(e,"DIV",{class:!0});var x=a(N);k(Pe.$$.fragment,x),jo=f(x),$e=s(x,"P",{});var Rt=a($e);Lo=l(Rt,"Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=s(Rt,"EM",{});var Kn=a(pt);Ao=l(Kn,"tokenizers"),Kn.forEach(o),Io=l(Rt,` library). Based on byte-level
...
the model was not pretrained this way, it might yield a decrease in performance.`),Yt.forEach(o),Vo=f(x),k(ne.$$.fragment,x),Jo=f(x),Ne=s(x,"P",{});var Kt=a(Ne);Ro=l(Kt,"This tokenizer inherits from "),Oe=s(Kt,"A",{href:!0});var es=a(Oe);Yo=l(es,"PreTrainedTokenizerFast"),es.forEach(o),Ko=l(Kt,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Kt.forEach(o),x.forEach(o),At=f(e),O=s(e,"H2",{class:!0});var Qt=a(O);se=s(Qt,"A",{id:!0,class:!0,href:!0});var ts=a(se);ft=s(ts,"SPAN",{});var os=a(ft);k(Ge.$$.fragment,os),os.forEach(o),ts.forEach(o),Qo=f(Qt),ut=s(Qt,"SPAN",{});var ns=a(ut);Zo=l(ns,"GPTNeoXModel"),ns.forEach(o),Qt.forEach(o),It=f(e),j=s(e,"DIV",{class:!0});var Re=a(j);k(Xe.$$.fragment,Re),en=f(Re),xe=s(Re,"P",{});var Zt=a(xe);tn=l(Zt,`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=s(Zt,"A",{href:!0,rel:!0});var ss=a(ze);on=l(ss,"torch.nn.Module"),ss.forEach(o),nn=l(Zt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Zt.forEach(o),sn=f(Re),F=s(Re,"DIV",{class:!0});var pe=a(F);k(Me.$$.fragment,pe),an=f(pe),H=s(pe,"P",{});var Ye=a(H);rn=l(Ye,"The "),He=s(Ye,"A",{href:!0});var as=a(He);ln=l(as,"GPTNeoXModel"),as.forEach(o),dn=l(Ye," forward method, overrides the "),gt=s(Ye,"CODE",{});var rs=a(gt);cn=l(rs,"__call__"),rs.forEach(o),pn=l(Ye," special method."),Ye.forEach(o),hn=f(pe),k(ae.$$.fragment,pe),mn=f(pe),k(re.$$.fragment,pe),pe.forEach(o),Re.forEach(o),St=f(e),U=s(e,"H2",{class:!0});var eo=a(U);ie=s(eo,"A",{id:!0,class:!0,href:!0});var is=a(ie);_t=s(is,"SPAN",{});var ls=a(_t);k(Ce.$$.fragment,ls),ls.forEach(o),is.forEach(o),fn=f(eo),Tt=s(eo,"SPAN",{});var ds=a(Tt);un=l(ds,"GPTNeoXForCausalLM"),ds.forEach(o),eo.forEach(o),Dt=f(e),L=s(e,"DIV",{class:!0});var Ke=a(L);k(Fe.$$.fragment,Ke),gn=f(Ke),V=s(Ke,"P",{});var Qe=a(V);_n=l(Qe,"GPTNeoX Model with a "),bt=s(Qe,"CODE",{});var cs=a(bt);Tn=l(cs,"language modeling"),cs.forEach(o),bn=l(Qe,` head on top for CLM fine-tuning.
This model is a PyTorch `),Ee=s(Qe,"A",{href:!0,rel:!0});var ps=a(Ee);vn=l(ps,"torch.nn.Module"),ps.forEach(o),kn=l(Qe,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Qe.forEach(o),wn=f(Ke),E=s(Ke,"DIV",{class:!0});var he=a(E);k(qe.$$.fragment,he),Pn=f(he),J=s(he,"P",{});var Ze=a(J);$n=l(Ze,"The "),Ue=s(Ze,"A",{href:!0});var hs=a(Ue);yn=l(hs,"GPTNeoXForCausalLM"),hs.forEach(o),Nn=l(Ze," forward method, overrides the "),vt=s(Ze,"CODE",{});var ms=a(vt);Gn=l(ms,"__call__"),ms.forEach(o),Xn=l(Ze," special method."),Ze.forEach(o),xn=f(he),k(le.$$.fragment,he),zn=f(he),k(de.$$.fragment,he),he.forEach(o),Ke.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(Gs)),h(u,"id","gptneox"),h(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(u,"href","#gptneox"),h(p,"class","relative group"),h(q,"id","overview"),h(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(q,"href","#overview"),h(C,"class","relative group"),h(fe,"href","https://github.com/EleutherAI/gpt-neox"),h(fe,"rel","nofollow"),h(ue,"href","https://www.coreweave.com/"),h(ue,"rel","nofollow"),h(K,"id","generation"),h(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(K,"href","#generation"),h(I,"class","relative group"),h(Z,"id","transformers.GPTNeoXConfig"),h(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Z,"href","#transformers.GPTNeoXConfig"),h(S,"class","relative group"),h(De,"href","/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXModel"),h(ke,"href","https://huggingface.co/eleutherai/gpt-neox-20b"),h(ke,"rel","nofollow"),h(Be,"href","/docs/transformers/pr_17308/en/main_classes/configuration#transformers.PretrainedConfig"),h(We,"href","/docs/transformers/pr_17308/en/main_classes/configuration#transformers.PretrainedConfig"),h(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(te,"id","transformers.GPTNeoXTokenizerFast"),h(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(te,"href","#transformers.GPTNeoXTokenizerFast"),h(W,"class","relative group"),h(Oe,"href","/docs/transformers/pr_17308/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(se,"id","transformers.GPTNeoXModel"),h(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(se,"href","#transformers.GPTNeoXModel"),h(O,"class","relative group"),h(ze,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(ze,"rel","nofollow"),h(He,"href","/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXModel"),h(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ie,"id","transformers.GPTNeoXForCausalLM"),h(ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ie,"href","#transformers.GPTNeoXForCausalLM"),h(U,"class","relative group"),h(Ee,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ee,"rel","nofollow"),h(Ue,"href","/docs/transformers/pr_17308/en/model_doc/gpt_neox#transformers.GPTNeoXForCausalLM"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,c){t(document.head,d),g(e,T,c),g(e,p,c),t(p,u),t(u,b),w(r,b,null),t(p,_),t(p,X),t(X,A),g(e,z,c),g(e,C,c),t(C,q),t(q,ot),w(me,ot,null),t(C,no),t(C,nt),t(nt,so),g(e,Nt,c),g(e,R,c),t(R,ao),t(R,fe),t(fe,ro),t(R,io),g(e,Gt,c),g(e,Y,c),t(Y,lo),t(Y,ue),t(ue,co),t(Y,po),g(e,Xt,c),g(e,Ie,c),t(Ie,ho),g(e,xt,c),w(ge,e,c),g(e,zt,c),g(e,Se,c),t(Se,mo),g(e,Mt,c),g(e,I,c),t(I,K),t(K,st),w(_e,st,null),t(I,fo),t(I,at),t(at,uo),g(e,Ct,c),g(e,Q,c),t(Q,go),t(Q,rt),t(rt,_o),t(Q,To),g(e,Ft,c),w(Te,e,c),g(e,Et,c),g(e,S,c),t(S,Z),t(Z,it),w(be,it,null),t(S,bo),t(S,lt),t(lt,vo),g(e,qt,c),g(e,M,c),w(ve,M,null),t(M,ko),t(M,D),t(D,wo),t(D,De),t(De,Po),t(D,$o),t(D,ke),t(ke,yo),t(D,No),t(M,Go),t(M,B),t(B,Xo),t(B,Be),t(Be,xo),t(B,zo),t(B,We),t(We,Mo),t(B,Co),t(M,Fo),w(ee,M,null),g(e,jt,c),g(e,W,c),t(W,te),t(te,dt),w(we,dt,null),t(W,Eo),t(W,ct),t(ct,qo),g(e,Lt,c),g(e,N,c),w(Pe,N,null),t(N,jo),t(N,$e),t($e,Lo),t($e,pt),t(pt,Ao),t($e,Io),t(N,So),t(N,ht),t(ht,Do),t(N,Bo),w(oe,N,null),t(N,Wo),t(N,ye),t(ye,Oo),t(ye,mt),t(mt,Ho),t(ye,Uo),t(N,Vo),w(ne,N,null),t(N,Jo),t(N,Ne),t(Ne,Ro),t(Ne,Oe),t(Oe,Yo),t(Ne,Ko),g(e,At,c),g(e,O,c),t(O,se),t(se,ft),w(Ge,ft,null),t(O,Qo),t(O,ut),t(ut,Zo),g(e,It,c),g(e,j,c),w(Xe,j,null),t(j,en),t(j,xe),t(xe,tn),t(xe,ze),t(ze,on),t(xe,nn),t(j,sn),t(j,F),w(Me,F,null),t(F,an),t(F,H),t(H,rn),t(H,He),t(He,ln),t(H,dn),t(H,gt),t(gt,cn),t(H,pn),t(F,hn),w(ae,F,null),t(F,mn),w(re,F,null),g(e,St,c),g(e,U,c),t(U,ie),t(ie,_t),w(Ce,_t,null),t(U,fn),t(U,Tt),t(Tt,un),g(e,Dt,c),g(e,L,c),w(Fe,L,null),t(L,gn),t(L,V),t(V,_n),t(V,bt),t(bt,Tn),t(V,bn),t(V,Ee),t(Ee,vn),t(V,kn),t(L,wn),t(L,E),w(qe,E,null),t(E,Pn),t(E,J),t(J,$n),t(J,Ue),t(Ue,yn),t(J,Nn),t(J,vt),t(vt,Gn),t(J,Xn),t(E,xn),w(le,E,null),t(E,zn),w(de,E,null),Bt=!0},p(e,[c]){const je={};c&2&&(je.$$scope={dirty:c,ctx:e}),ee.$set(je);const kt={};c&2&&(kt.$$scope={dirty:c,ctx:e}),oe.$set(kt);const wt={};c&2&&(wt.$$scope={dirty:c,ctx:e}),ne.$set(wt);const Pt={};c&2&&(Pt.$$scope={dirty:c,ctx:e}),ae.$set(Pt);const Le={};c&2&&(Le.$$scope={dirty:c,ctx:e}),re.$set(Le);const $t={};c&2&&($t.$$scope={dirty:c,ctx:e}),le.$set($t);const yt={};c&2&&(yt.$$scope={dirty:c,ctx:e}),de.$set(yt)},i(e){Bt||(P(r.$$.fragment,e),P(me.$$.fragment,e),P(ge.$$.fragment,e),P(_e.$$.fragment,e),P(Te.$$.fragment,e),P(be.$$.fragment,e),P(ve.$$.fragment,e),P(ee.$$.fragment,e),P(we.$$.fragment,e),P(Pe.$$.fragment,e),P(oe.$$.fragment,e),P(ne.$$.fragment,e),P(Ge.$$.fragment,e),P(Xe.$$.fragment,e),P(Me.$$.fragment,e),P(ae.$$.fragment,e),P(re.$$.fragment,e),P(Ce.$$.fragment,e),P(Fe.$$.fragment,e),P(qe.$$.fragment,e),P(le.$$.fragment,e),P(de.$$.fragment,e),Bt=!0)},o(e){$(r.$$.fragment,e),$(me.$$.fragment,e),$(ge.$$.fragment,e),$(_e.$$.fragment,e),$(Te.$$.fragment,e),$(be.$$.fragment,e),$(ve.$$.fragment,e),$(ee.$$.fragment,e),$(we.$$.fragment,e),$(Pe.$$.fragment,e),$(oe.$$.fragment,e),$(ne.$$.fragment,e),$(Ge.$$.fragment,e),$(Xe.$$.fragment,e),$(Me.$$.fragment,e),$(ae.$$.fragment,e),$(re.$$.fragment,e),$(Ce.$$.fragment,e),$(Fe.$$.fragment,e),$(qe.$$.fragment,e),$(le.$$.fragment,e),$(de.$$.fragment,e),Bt=!1},d(e){o(d),e&&o(T),e&&o(p),y(r),e&&o(z),e&&o(C),y(me),e&&o(Nt),e&&o(R),e&&o(Gt),e&&o(Y),e&&o(Xt),e&&o(Ie),e&&o(xt),y(ge,e),e&&o(zt),e&&o(Se),e&&o(Mt),e&&o(I),y(_e),e&&o(Ct),e&&o(Q),e&&o(Ft),y(Te,e),e&&o(Et),e&&o(S),y(be),e&&o(qt),e&&o(M),y(ve),y(ee),e&&o(jt),e&&o(W),y(we),e&&o(Lt),e&&o(N),y(Pe),y(oe),y(ne),e&&o(At),e&&o(O),y(Ge),e&&o(It),e&&o(j),y(Xe),y(Me),y(ae),y(re),e&&o(St),e&&o(U),y(Ce),e&&o(Dt),e&&o(L),y(Fe),y(qe),y(le),y(de)}}}const Gs={local:"gptneox",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTNeoXConfig",title:"GPTNeoXConfig"},{local:"transformers.GPTNeoXTokenizerFast",title:"GPTNeoXTokenizerFast"},{local:"transformers.GPTNeoXModel",title:"GPTNeoXModel"},{local:"transformers.GPTNeoXForCausalLM",title:"GPTNeoXForCausalLM"}],title:"GPT-NeoX"};function Xs(G){return Ts(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class qs extends fs{constructor(d){super();us(this,d,Xs,Ns,gs,{})}}export{qs as default,Gs as metadata};
