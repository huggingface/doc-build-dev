import{S as wu,i as vu,s as $u,e as r,k as p,w as Q,t as n,M as Tu,c as a,d as o,m as h,a as i,x as w,h as s,b as f,G as e,g as b,y as v,q as $,o as T,B as y,v as yu,L as O}from"../../chunks/vendor-hf-doc-builder.js";import{T as xt}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as M}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as J}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as I}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function qu(q){let d,_,c,u,k;return u=new M({props:{code:`from transformers import QDQBertModel, QDQBertConfig
...
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Fu(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){v(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Ju(q){let d,_,c,u,k,l,m,D,Da,dr,fe,Se,Sn,jt,za,Ln,Ba,cr,Le,Ma,Et,xa,ja,pr,tn,Ea,hr,on,In,Fa,ur,nn,Pa,mr,G,On,Wn,Ca,Aa,Hn,Ie,Na,Ft,Sa,La,Rn,Ia,Oa,Un,Pt,Wa,Vn,Ha,Ra,Ua,Xn,Ct,Va,sn,Xa,Ja,fr,Oe,Ka,At,Ga,Ya,gr,ge,We,Jn,Nt,Za,Kn,ei,_r,E,ti,Gn,oi,ni,St,si,ri,Yn,ai,ii,Zn,li,di,Lt,ci,pi,br,He,hi,es,ui,mi,kr,rn,fi,Qr,It,wr,_e,Re,ts,Ot,gi,os,_i,vr,an,bi,$r,Wt,Tr,be,Ue,ns,Ht,ki,ss,Qi,yr,se,wi,Rt,vi,$i,Ut,Ti,yi,qr,Vt,Dr,ke,Ve,rs,Xt,qi,as,Di,zr,K,Jt,zi,Qe,Bi,ln,Mi,xi,Kt,ji,Ei,Fi,we,Pi,dn,Ci,Ai,cn,Ni,Si,Li,Xe,Br,ve,Je,is,Gt,Ii,ls,Oi,Mr,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,rl,al,ps,il,ll,hs,dl,cl,us,pl,hl,ms,ul,ml,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,Ql,wl,gs,vl,$l,Tl,Ke,yl,Ge,xr,Te,Ye,_s,ro,ql,bs,Dl,jr,F,ao,zl,io,Bl,ks,Ml,xl,jl,lo,El,un,Fl,Pl,Cl,co,Al,po,Nl,Sl,Ll,Z,ho,Il,ye,Ol,mn,Wl,Hl,Qs,Rl,Ul,Vl,Ze,Xl,et,Er,qe,tt,ws,uo,Jl,vs,Kl,Fr,P,mo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,rd,_o,ad,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,ud,Ts,md,fd,gd,ot,_d,nt,bd,st,Pr,ze,rt,ys,Qo,kd,qs,Qd,Cr,C,wo,wd,Ds,vd,$d,vo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,jd,Be,Ed,bn,Fd,Pd,zs,Cd,Ad,Nd,at,Sd,it,Ld,lt,Id,dt,Od,ct,Ar,Me,pt,Bs,qo,Wd,Ms,Hd,Nr,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,jo,sc,xe,rc,Qn,ac,ic,js,lc,dc,cc,ht,pc,ut,Sr,je,mt,Es,Eo,hc,Fs,uc,Lr,N,Fo,mc,Ps,fc,gc,Po,_c,wn,bc,kc,Qc,Co,wc,Ao,vc,$c,Tc,te,No,yc,Ee,qc,vn,Dc,zc,Cs,Bc,Mc,xc,ft,jc,gt,Ir,Fe,_t,As,So,Ec,Ns,Fc,Or,S,Lo,Pc,Ss,Cc,Ac,Io,Nc,$n,Sc,Lc,Ic,Oo,Oc,Wo,Wc,Hc,Rc,H,Ho,Uc,Pe,Vc,Tn,Xc,Jc,Ls,Kc,Gc,Yc,bt,Zc,kt,ep,Qt,Wr,Ce,wt,Is,Ro,tp,Os,op,Hr,L,Uo,np,Ae,sp,Ws,rp,ap,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,up,Xo,mp,Jo,fp,gp,_p,R,Ko,bp,Ne,kp,qn,Qp,wp,Rs,vp,$p,Tp,vt,yp,$t,qp,Tt,Rr;return l=new J({}),jt=new J({}),Nt=new J({}),It=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17308/en/model_doc/qdqbert#transformers.QDQBertModel">QDQBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.QDQBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L880",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17308/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1044",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1195",returnDescription:`
<p>A <a
...
`}}),ot=new xt({props:{$$slots:{default:[xu]},$$scope:{ctx:q}}}),nt=new I({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example",$$slots:{default:[ju]},$$scope:{ctx:q}}}),st=new I({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example-2",$$slots:{default:[Eu]},$$scope:{ctx:q}}}),Qo=new J({}),wo=new j({props:{name:"class transformers.QDQBertForSequenceClassification",anchor:"transformers.QDQBertForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17308/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1396",returnDescription:`
<p>A <a
...
`}}),at=new xt({props:{$$slots:{default:[Fu]},$$scope:{ctx:q}}}),it=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example",$$slots:{default:[Pu]},$$scope:{ctx:q}}}),lt=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-2",$$slots:{default:[Cu]},$$scope:{ctx:q}}}),dt=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-3",$$slots:{default:[Au]},$$scope:{ctx:q}}}),ct=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-4",$$slots:{default:[Nu]},$$scope:{ctx:q}}}),qo=new J({}),Do=new j({props:{name:"class transformers.QDQBertForNextSentencePrediction",anchor:"transformers.QDQBertForNextSentencePrediction",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17308/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1290",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1493",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1589",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17308/src/transformers/models/qdqbert/modeling_qdqbert.py#L1670",returnDescription:`
<p>A <a
...
`),Kt=r("a"),ji=n("bert-base-uncased"),Ei=n(" architecture."),Fi=p(),we=r("p"),Pi=n("Configuration objects inherit from "),dn=r("a"),Ci=n("PretrainedConfig"),Ai=n(` and can be used to control the model outputs. Read the
...
`),us=r("code"),pl=n("add_cross_attention"),hl=n(" set to "),ms=r("code"),ul=n("True"),ml=n("; an "),fs=r("code"),fl=n("encoder_hidden_states"),gl=n(" is then expected as an input to the forward pass."),_l=p(),Y=r("div"),Q(so.$$.fragment),bl=p(),$e=r("p"),kl=n("The "),hn=r("a"),Ql=n("QDQBertModel"),wl=n(" forward method, overrides the "),gs=r("code"),vl=n("__call__"),$l=n(" special method."),Tl=p(),Q(Ke.$$.fragment),yl=p(),Q(Ge.$$.fragment),xr=p(),Te=r("h2"),Ye=r("a"),_s=r("span"),Q(ro.$$.fragment),ql=p(),bs=r("span"),Dl=n("QDQBertLMHeadModel"),jr=p(),F=r("div"),Q(ao.$$.fragment),zl=p(),io=r("p"),Bl=n("QDQBERT Model with a "),ks=r("code"),Ml=n("language modeling"),xl=n(" head on top for CLM fine-tuning."),jl=p(),lo=r("p"),El=n("This model inherits from "),un=r("a"),Fl=n("PreTrainedModel"),Pl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cl=p(),co=r("p"),Al=n("This model is also a PyTorch "),po=r("a"),Nl=n("torch.nn.Module"),Sl=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ll=p(),Z=r("div"),Q(ho.$$.fragment),Il=p(),ye=r("p"),Ol=n("The "),mn=r("a"),Wl=n("QDQBertLMHeadModel"),Hl=n(" forward method, overrides the "),Qs=r("code"),Rl=n("__call__"),Ul=n(" special method."),Vl=p(),Q(Ze.$$.fragment),Xl=p(),Q(et.$$.fragment),Er=p(),qe=r("h2"),tt=r("a"),ws=r("span"),Q(uo.$$.fragment),Jl=p(),vs=r("span"),Kl=n("QDQBertForMaskedLM"),Fr=p(),P=r("div"),Q(mo.$$.fragment),Gl=p(),fo=r("p"),Yl=n("QDQBERT Model with a "),$s=r("code"),Zl=n("language modeling"),ed=n(" head on top."),td=p(),go=r("p"),od=n("This model inherits from "),fn=r("a"),nd=n("PreTrainedModel"),sd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nc=p(),ee=r("div"),Q(jo.$$.fragment),sc=p(),xe=r("p"),rc=n("The "),Qn=r("a"),ac=n("QDQBertForNextSentencePrediction"),ic=n(" forward method, overrides the "),js=r("code"),lc=n("__call__"),dc=n(" special method."),cc=p(),Q(ht.$$.fragment),pc=p(),Q(ut.$$.fragment),Sr=p(),je=r("h2"),mt=r("a"),Es=r("span"),Q(Eo.$$.fragment),hc=p(),Fs=r("span"),uc=n("QDQBertForMultipleChoice"),Lr=p(),N=r("div"),Q(Fo.$$.fragment),mc=p(),Ps=r("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=p(),te=r("div"),Q(No.$$.fragment),yc=p(),Ee=r("p"),qc=n("The "),vn=r("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Cs=r("code"),Bc=n("__call__"),Mc=n(" special method."),xc=p(),Q(ft.$$.fragment),jc=p(),Q(gt.$$.fragment),Ir=p(),Fe=r("h2"),_t=r("a"),As=r("span"),Q(So.$$.fragment),Ec=p(),Ns=r("span"),Fc=n("QDQBertForTokenClassification"),Or=p(),S=r("div"),Q(Lo.$$.fragment),Pc=p(),Ss=r("p"),Cc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p=p(),R=r("div"),Q(Ko.$$.fragment),bp=p(),Ne=r("p"),kp=n("The "),qn=r("a"),Qp=n("QDQBertForQuestionAnswering"),wp=n(" forward method, overrides the "),Rs=r("code"),vp=n("__call__"),$p=n(" special method."),Tp=p(),Q(vt.$$.fragment),yp=p(),Q($t.$$.fragment),qp=p(),Q(Tt.$$.fragment),this.h()},l(t){const g=Tu('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(o),_=h(t),c=a(t,"H1",{class:!0});var Go=i(c);u=a(Go,"A",{id:!0,class:!0,href:!0});var Us=i(u);k=a(Us,"SPAN",{});var Vs=i(k);w(l.$$.fragment,Vs),Vs.forEach(o),Us.forEach(o),m=h(Go),D=a(Go,"SPAN",{});var Xs=i(D);Da=s(Xs,"QDQBERT"),Xs.forEach(o),Go.forEach(o),dr=h(t),fe=a(t,"H2",{class:!0});var Yo=i(fe);Se=a(Yo,"A",{id:!0,class:!0,href:!0});var Js=i(Se);Sn=a(Js,"SPAN",{});var Ks=i(Sn);w(jt.$$.fragment,Ks),Ks.forEach(o),Js.forEach(o),za=h(Yo),Ln=a(Yo,"SPAN",{});var Gs=i(Ln);Ba=s(Gs,"Overview"),Gs.forEach(o),Yo.forEach(o),cr=h(t),Le=a(t,"P",{});var Zo=i(Le);Ma=s(Zo,"The QDQBERT model can be referenced in "),Et=a(Zo,"A",{href:!0,rel:!0});var Ys=i(Et);xa=s(Ys,`Integer Quantization for Deep Learning Inference: Principles and Empirical
...
`),Gn=a(oe,"CODE",{});var Fp=i(Gn);oi=s(Fp,"TensorQuantizer"),Fp.forEach(o),ni=s(oe," in "),St=a(oe,"A",{href:!0,rel:!0});var Pp=i(St);si=s(Pp,"Pytorch Quantization Toolkit"),Pp.forEach(o),ri=s(oe,". "),Yn=a(oe,"CODE",{});var Cp=i(Yn);ai=s(Cp,"TensorQuantizer"),Cp.forEach(o),ii=s(oe,` is the module
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ua.forEach(o),xd=h(le),B=a(le,"DIV",{class:!0});var X=i(B);w(yo.$$.fragment,X),jd=h(X),Be=a(X,"P",{});var En=i(Be);Ed=s(En,"The "),bn=a(En,"A",{href:!0});var Lh=i(bn);Fd=s(Lh,"QDQBertForSequenceClassification"),Lh.forEach(o),Pd=s(En," forward method, overrides the "),zs=a(En,"CODE",{});var Ih=i(zs);Cd=s(Ih,"__call__"),Ih.forEach(o),Ad=s(En," special method."),En.forEach(o),Nd=h(X),w(at.$$.fragment,X),Sd=h(X),w(it.$$.fragment,X),Ld=h(X),w(lt.$$.fragment,X),Id=h(X),w(dt.$$.fragment,X),Od=h(X),w(ct.$$.fragment,X),X.forEach(o),le.forEach(o),Ar=h(t),Me=a(t,"H2",{class:!0});var ma=i(Me);pt=a(ma,"A",{id:!0,class:!0,href:!0});var Oh=i(pt);Bs=a(Oh,"SPAN",{});var Wh=i(Bs);w(qo.$$.fragment,Wh),Wh.forEach(o),Oh.forEach(o),Wd=h(ma),Ms=a(ma,"SPAN",{});var Hh=i(Ms);Hd=s(Hh,"QDQBertForNextSentencePrediction"),Hh.forEach(o),ma.forEach(o),Nr=h(t),A=a(t,"DIV",{class:!0});var de=i(A);w(Do.$$.fragment,de),Rd=h(de),zo=a(de,"P",{});var fa=i(zo);Ud=s(fa,"Bert Model with a "),xs=a(fa,"CODE",{});var Rh=i(xs);Vd=s(Rh,"next sentence prediction (classification)"),Rh.forEach(o),Xd=s(fa," head on top."),fa.forEach(o),Jd=h(de),Bo=a(de,"P",{});var ga=i(Bo);Kd=s(ga,"This model inherits from "),kn=a(ga,"A",{href:!0});var Uh=i(kn);Gd=s(Uh,"PreTrainedModel"),Uh.forEach(o),Yd=s(ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_a.forEach(o),nc=h(de),ee=a(de,"DIV",{class:!0});var Bt=i(ee);w(jo.$$.fragment,Bt),sc=h(Bt),xe=a(Bt,"P",{});var Fn=i(xe);rc=s(Fn,"The "),Qn=a(Fn,"A",{href:!0});var Xh=i(Qn);ac=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(Fn," forward method, overrides the "),js=a(Fn,"CODE",{});var Jh=i(js);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(Fn," special method."),Fn.forEach(o),cc=h(Bt),w(ht.$$.fragment,Bt),pc=h(Bt),w(ut.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Sr=h(t),je=a(t,"H2",{class:!0});var ba=i(je);mt=a(ba,"A",{id:!0,class:!0,href:!0});var Kh=i(mt);Es=a(Kh,"SPAN",{});var Gh=i(Es);w(Eo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(ba),Fs=a(ba,"SPAN",{});var Yh=i(Fs);uc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),ba.forEach(o),Lr=h(t),N=a(t,"DIV",{class:!0});var ce=i(N);w(Fo.$$.fragment,ce),mc=h(ce),Ps=a(ce,"P",{});var Zh=i(Ps);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qa.forEach(o),Tc=h(ce),te=a(ce,"DIV",{class:!0});var Mt=i(te);w(No.$$.fragment,Mt),yc=h(Mt),Ee=a(Mt,"P",{});var Pn=i(Ee);qc=s(Pn,"The "),vn=a(Pn,"A",{href:!0});var ou=i(vn);Dc=s(ou,"QDQBertForMultipleChoice"),ou.forEach(o),zc=s(Pn," forward method, overrides the "),Cs=a(Pn,"CODE",{});var nu=i(Cs);Bc=s(nu,"__call__"),nu.forEach(o),Mc=s(Pn," special method."),Pn.forEach(o),xc=h(Mt),w(ft.$$.fragment,Mt),jc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Ir=h(t),Fe=a(t,"H2",{class:!0});var wa=i(Fe);_t=a(wa,"A",{id:!0,class:!0,href:!0});var su=i(_t);As=a(su,"SPAN",{});var ru=i(As);w(So.$$.fragment,ru),ru.forEach(o),su.forEach(o),Ec=h(wa),Ns=a(wa,"SPAN",{});var au=i(Ns);Fc=s(au,"QDQBertForTokenClassification"),au.forEach(o),wa.forEach(o),Or=h(t),S=a(t,"DIV",{class:!0});var pe=i(S);w(Lo.$$.fragment,pe),Pc=h(pe),Ss=a(pe,"P",{});var iu=i(Ss);Cc=s(iu,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
