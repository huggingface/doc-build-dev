...
to import from the `),u=l(I,"CODE",{});var ee=i(u);v=a(ee,"transformers"),ee.forEach(s),z=a(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,E),t(m,u),t(u,v),t(m,z)},d(P){P&&s(m)}}}function Ui(Z){let m,E,u,v,z,P,I,ee,sa,qs,Ue,oa,Is,Ke,aa,Ns,N,na,be,ra,la,Ve,ia,fa,xs,G,te,Ot,ve,ca,Dt,da,Os,se,ha,Ft,ma,ua,Ds,Je,pa,Fs,$e,Bs,Qe,_a,Ss,x,ke,ga,Bt,ya,wa,ba,U,va,St,$a,ka,Ht,Ea,ja,Ca,K,Pa,Wt,Aa,Ta,Lt,Ma,Ra,Hs,O,qa,Yt,Ia,Na,zt,xa,Oa,Ws,D,Da,Gt,Fa,Ba,Ut,Sa,Ha,Ls,Xe,Wa,Ys,Ee,zs,A,La,Kt,Ya,za,Vt,Ga,Ua,Jt,Ka,Va,Gs,je,Us,F,Ja,Ze,Qa,Xa,et,Za,en,Ks,V,oe,Qt,Ce,tn,Xt,sn,Vs,B,on,tt,an,nn,st,rn,ln,Js,ae,fn,Zt,cn,dn,Qs,Pe,Xs,ot,hn,Zs,Ae,eo,C,mn,es,un,pn,ts,_n,gn,ss,yn,wn,os,bn,vn,to,ne,so,S,$n,as,kn,En,at,jn,Cn,oo,nt,Pn,ao,Te,no,T,An,rt,Tn,Mn,lt,Rn,qn,it,In,Nn,ro,ft,xn,lo,Me,io,H,On,ct,Dn,Fn,dt,Bn,Sn,fo,J,re,ns,Re,Hn,rs,Wn,co,le,ho,$,Ln,ls,Yn,zn,is,Gn,Un,fs,Kn,Vn,cs,Jn,Qn,ds,Xn,Zn,hs,er,tr,ms,sr,or,mo,qe,uo,W,ar,us,nr,rr,ps,lr,ir,po,ie,_o,ht,fr,go,mt,cr,yo,Ie,wo,fe,dr,_s,hr,mr,bo,Ne,vo,ce,ur,ut,pr,_r,$o,pt,gr,ko,xe,Eo,_t,yr,jo,Oe,Co,gt,wr,Po,De,Ao,yt,br,To,Fe,Mo,M,vr,gs,$r,kr,ys,Er,jr,Be,Cr,Pr,Ro,de,Ar,wt,Tr,Mr,qo,Q,he,ws,Se,Rr,bs,qr,Io,R,Ir,vs,Nr,xr,He,Or,Dr,$s,Fr,Br,No,We,xo,me,Sr,ks,Hr,Wr,Oo,Le,Do,bt,Lr,Fo,X,ue,Es,Ye,Yr,js,zr,Bo,vt,Gr,So,L,Ur,Cs,Kr,Vr,Ps,Jr,Qr,Ho,ze,Wo,q,Xr,$t,Zr,el,As,tl,sl,Ts,ol,al,Lo;return P=new xt({}),ve=new xt({}),$e=new k({props:{code:`from transformers import PretrainedConfig
...
superclass.`),Ws=c(),D=r("p"),Da=o("Defining a "),Gt=r("code"),Fa=o("model_type"),Ba=o(" for your configuration (here "),Ut=r("code"),Sa=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
hash of any commit.`),Fo=c(),X=r("h2"),ue=r("a"),Es=r("span"),p(Ye.$$.fragment),Yr=c(),js=r("span"),zr=o("Registering a model with custom code to the auto classes"),Bo=c(),vt=r("p"),Gr=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
to match the `),Ts=r("code"),ol=o("config_class"),al=o(" of those models."),this.h()},l(e){const n=Wi('[data-svelte="svelte-1phssyn"]',document.head);m=l(n,"META",{name:!0,content:!0}),n.forEach(s),E=d(e),u=l(e,"H1",{class:!0});var Ge=i(u);v=l(Ge,"A",{id:!0,class:!0,href:!0});var Ms=i(v);z=l(Ms,"SPAN",{});var Rs=i(z);_(P.$$.fragment,Rs),Rs.forEach(s),Ms.forEach(s),I=d(Ge),ee=l(Ge,"SPAN",{});var rl=i(ee);sa=a(rl,"Sharing custom models"),rl.forEach(s),Ge.forEach(s),qs=d(e),Ue=l(e,"P",{});var ll=i(Ue);oa=a(ll,`The \u{1F917} Transformers library is designed to be easily extensible. Every model is fully coded in a given subfolder
...
superclass.`),Pt.forEach(s),Ws=d(e),D=l(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Gt=l(At,"CODE",{});var El=i(Gt);Fa=a(El,"model_type"),El.forEach(s),Ba=a(At," for your configuration (here "),Ut=l(At,"CODE",{});var jl=i(Ut);Sa=a(jl,'model_type="resnet"'),jl.forEach(s),Ha=a(At,`) is not mandatory, unless you want to
...
training loop or another library for training.`),Rt.forEach(s),oo=d(e),nt=l(e,"P",{});var zl=i(nt);Pn=a(zl,"Now that we have our model class, let\u2019s create one:"),zl.forEach(s),ao=d(e),_(Te.$$.fragment,e),no=d(e),T=l(e,"P",{});var _e=i(T);An=a(_e,"Again, you can use any of the methods of "),rt=l(_e,"A",{href:!0});var Gl=i(rt);Tn=a(Gl,"PreTrainedModel"),Gl.forEach(s),Mn=a(_e,", like "),lt=l(_e,"A",{href:!0});var Ul=i(lt);Rn=a(Ul,"save_pretrained()"),Ul.forEach(s),qn=a(_e,` or
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=l(e,"H2",{class:!0});var ta=i(X);ue=l(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=l(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yr=d(ta),js=l(ta,"SPAN",{});var qi=i(js);zr=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),Bo=d(e),vt=l(e,"P",{});var Ii=i(vt);Gr=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Ii.forEach(s),So=d(e),L=l(e,"P",{});var Nt=i(L);Ur=a(Nt,"As long as your config has a "),Cs=l(Nt,"CODE",{});var Ni=i(Cs);Kr=a(Ni,"model_type"),Ni.forEach(s),Vr=a(Nt,` attribute that is different from existing model types, and that your model
