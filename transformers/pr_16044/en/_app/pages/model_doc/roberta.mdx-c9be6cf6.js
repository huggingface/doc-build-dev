...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),sa=new ye({}),ra=new j({props:{name:"class transformers.TFRobertaForMaskedLM",anchor:"transformers.TFRobertaForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1055",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qn=new fe({props:{$$slots:{default:[zE]},$$scope:{ctx:q}}}),ca=new j({props:{name:"call",anchor:"transformers.TFRobertaForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1072",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ha=new ye({}),ua=new j({props:{name:"class transformers.TFRobertaForSequenceClassification",anchor:"transformers.TFRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1319",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new fe({props:{$$slots:{default:[qE]},$$scope:{ctx:q}}}),_a=new j({props:{name:"call",anchor:"transformers.TFRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1330",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ka=new ye({}),Ta=new j({props:{name:"class transformers.TFRobertaForMultipleChoice",anchor:"transformers.TFRobertaForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1402",parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Yn=new fe({props:{$$slots:{default:[PE]},$$scope:{ctx:q}}}),$a=new j({props:{name:"call",anchor:"transformers.TFRobertaForMultipleChoice.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ra=new ye({}),Ma=new j({props:{name:"class transformers.TFRobertaForTokenClassification",anchor:"transformers.TFRobertaForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1524",parametersDescription:[{anchor:"transformers.TFRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16044/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ts=new fe({props:{$$slots:{default:[LE]},$$scope:{ctx:q}}}),qa=new j({props:{name:"call",anchor:"transformers.TFRobertaForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16044/src/transformers/models/roberta/modeling_tf_roberta.py#L1542",parametersDescription:[{anchor:"transformers.TFRobertaForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16044/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16044/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16044/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16044/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16044/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16044/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16044/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Y0=l(),ji=n("p"),Z0=a("This model is also a Flax Linen "),Li=n("a"),e4=a("flax.linen.Module"),t4=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),o4=l(),rh=n("p"),n4=a("Finally, this model supports inherent JAX features such as:"),s4=l(),Wt=n("ul"),ah=n("li"),Ai=n("a"),r4=a("Just-In-Time (JIT) compilation"),a4=l(),ih=n("li"),Oi=n("a"),i4=a("Automatic Differentiation"),l4=l(),lh=n("li"),Ni=n("a"),d4=a("Vectorization"),c4=l(),dh=n("li"),Ii=n("a"),p4=a("Parallelization"),h4=l(),yt=n("div"),T(Di.$$.fragment),u4=l(),un=n("p"),f4=a("The "),ch=n("code"),m4=a("FlaxRobertaPreTrainedModel"),g4=a("forward method, overrides the "),ph=n("code"),_4=a("__call__"),b4=a(" special method."),k4=l(),T(ms.$$.fragment),T4=l(),hh=n("p"),y4=a("Example:"),v4=l(),T(Si.$$.fragment),Ou=l(),fn=n("h2"),gs=n("a"),uh=n("span"),T(Wi.$$.fragment),w4=l(),fh=n("span"),$4=a("FlaxRobertaForQuestionAnswering"),Nu=l(),De=n("div"),T(Bi.$$.fragment),F4=l(),mn=n("p"),R4=a(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),mh=n("code"),M4=a("span start logits"),E4=a(" and "),gh=n("code"),z4=a("span end logits"),x4=a(")."),q4=l(),Ui=n("p"),C4=a("This model inherits from "),Vl=n("a"),P4=a("FlaxPreTrainedModel"),j4=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),L4=l(),Hi=n("p"),A4=a("This model is also a Flax Linen "),Qi=n("a"),O4=a("flax.linen.Module"),N4=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),I4=l(),_h=n("p"),D4=a("Finally, this model supports inherent JAX features such as:"),S4=l(),Bt=n("ul"),bh=n("li"),Vi=n("a"),W4=a("Just-In-Time (JIT) compilation"),B4=l(),kh=n("li"),Ji=n("a"),U4=a("Automatic Differentiation"),H4=l(),Th=n("li"),Ki=n("a"),Q4=a("Vectorization"),V4=l(),yh=n("li"),Gi=n("a"),J4=a("Parallelization"),K4=l(),vt=n("div"),T(Xi.$$.fragment),G4=l(),gn=n("p"),X4=a("The "),vh=n("code"),Y4=a("FlaxRobertaPreTrainedModel"),Z4=a("forward method, overrides the "),wh=n("code"),e$=a("__call__"),t$=a(" special method."),o$=l(),T(_s.$$.fragment),n$=l(),$h=n("p"),s$=a("Example:"),r$=l(),T(Yi.$$.fragment),this.h()},l(o){const g=gE('[data-svelte="svelte-1phssyn"]',document.head);p=s(g,"META",{name:!0,content:!0}),g.forEach(t),R=d(o),m=s(o,"H1",{class:!0});var Zi=r(m);b=s(Zi,"A",{id:!0,class:!0,href:!0});var Fh=r(b);k=s(Fh,"SPAN",{});var Rh=r(k);y(_.$$.fragment,Rh),Rh.forEach(t),Fh.forEach(t),f=d(Zi),M=s(Zi,"SPAN",{});var Mh=r(M);Y=i(Mh,"RoBERTa"),Mh.forEach(t),Zi.forEach(t),I=d(o),z=s(o,"H2",{class:!0});var el=r(z);X=s(el,"A",{id:!0,class:!0,href:!0});var Eh=r(X);D=s(Eh,"SPAN",{});var zh=r(D);y(te.$$.fragment,zh),zh.forEach(t),Eh.forEach(t),me=d(el),S=s(el,"SPAN",{});var xh=r(S);ge=i(xh,"Overview"),xh.forEach(t),el.forEach(t),pe=d(o),K=s(o,"P",{});var tl=r(K);A=i(tl,"The RoBERTa model was proposed in "),oe=s(tl,"A",{href:!0,rel:!0});var qh=r(oe);Z=i(qh,"RoBERTa: A Robustly Optimized BERT Pretraining Approach"),qh.forEach(t),x=i(tl,` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
...
separate your segments with the separation token `),L=s(Ht,"CODE",{});var Dh=r(L);V=i(Dh,"tokenizer.sep_token"),Dh.forEach(t),xe=i(Ht," (or "),Fe=s(Ht,"CODE",{});var Sh=r(Fe);J=i(Sh,"</s>"),Sh.forEach(t),qe=i(Ht,")"),Ht.forEach(t),Ce=d(Ut),de=s(Ut,"LI",{});var Jl=r(de);ve=s(Jl,"A",{href:!0});var Wh=r(ve);dm=i(Wh,"CamemBERT"),Wh.forEach(t),cm=i(Jl," is a wrapper around RoBERTa. Refer to this page for usage examples."),Jl.forEach(t),Ut.forEach(t),Qh=d(o),Qt=s(o,"P",{});var _n=r(Qt);pm=i(_n,"This model was contributed by "),$s=s(_n,"A",{href:!0,rel:!0});var Bh=r($s);hm=i(Bh,"julien-c"),Bh.forEach(t),um=i(_n,". The original code can be found "),Fs=s(_n,"A",{href:!0,rel:!0});var Uh=r(Fs);fm=i(Uh,"here"),Uh.forEach(t),mm=i(_n,"."),_n.forEach(t),Vh=d(o),To=s(o,"H2",{class:!0});var Du=r(To);bn=s(Du,"A",{id:!0,class:!0,href:!0});var l$=r(bn);vd=s(l$,"SPAN",{});var d$=r(vd);y(Rs.$$.fragment,d$),d$.forEach(t),l$.forEach(t),gm=d(Du),wd=s(Du,"SPAN",{});var c$=r(wd);_m=i(c$,"RobertaConfig"),c$.forEach(t),Du.forEach(t),Jh=d(o),We=s(o,"DIV",{class:!0});var qt=r(We);y(Ms.$$.fragment,qt),bm=d(qt),yo=s(qt,"P",{});var Kl=r(yo);km=i(Kl,"This is the configuration class to store the configuration of a "),nl=s(Kl,"A",{href:!0});var p$=r(nl);Tm=i(p$,"RobertaModel"),p$.forEach(t),ym=i(Kl," or a "),sl=s(Kl,"A",{href:!0});var h$=r(sl);vm=i(h$,"TFRobertaModel"),h$.forEach(t),wm=i(Kl,`. It is
used to instantiate a RoBERTa model according to the specified arguments, defining the model architecture.`),Kl.forEach(t),$m=d(qt),vo=s(qt,"P",{});var Gl=r(vo);Fm=i(Gl,"Configuration objects inherit from "),rl=s(Gl,"A",{href:!0});var u$=r(rl);Rm=i(u$,"PretrainedConfig"),u$.forEach(t),Mm=i(Gl,` and can be used to control the model outputs. Read the
documentation from `),al=s(Gl,"A",{href:!0});var f$=r(al);Em=i(f$,"PretrainedConfig"),f$.forEach(t),zm=i(Gl," for more information."),Gl.forEach(t),xm=d(qt),wo=s(qt,"P",{});var Xl=r(wo);qm=i(Xl,"The "),il=s(Xl,"A",{href:!0});var m$=r(il);Cm=i(m$,"RobertaConfig"),m$.forEach(t),Pm=i(Xl," class directly inherits "),ll=s(Xl,"A",{href:!0});var g$=r(ll);jm=i(g$,"BertConfig"),g$.forEach(t),Lm=i(Xl,`. It reuses the same defaults. Please check the parent
class for more information.`),Xl.forEach(t),Am=d(qt),$d=s(qt,"P",{});var _$=r($d);Om=i(_$,"Examples:"),_$.forEach(t),Nm=d(qt),y(Es.$$.fragment,qt),qt.forEach(t),Kh=d(o),$o=s(o,"H2",{class:!0});var Su=r($o);kn=s(Su,"A",{id:!0,class:!0,href:!0});var b$=r(kn);Fd=s(b$,"SPAN",{});var k$=r(Fd);y(zs.$$.fragment,k$),k$.forEach(t),b$.forEach(t),Im=d(Su),Rd=s(Su,"SPAN",{});var T$=r(Rd);Dm=i(T$,"RobertaTokenizer"),T$.forEach(t),Su.forEach(t),Gh=d(o),Te=s(o,"DIV",{class:!0});var Re=r(Te);y(xs.$$.fragment,Re),Sm=d(Re),Md=s(Re,"P",{});var y$=r(Md);Wm=i(y$,"Constructs a RoBERTa tokenizer, derived from the GPT-2 tokenizer, using byte-level Byte-Pair-Encoding."),y$.forEach(t),Bm=d(Re),Ed=s(Re,"P",{});var v$=r(Ed);Um=i(v$,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),v$.forEach(t),Hm=d(Re),y(qs.$$.fragment,Re),Qm=d(Re),Cs=s(Re,"P",{});var Wu=r(Cs);Vm=i(Wu,"You can get around that behavior by passing "),zd=s(Wu,"CODE",{});var w$=r(zd);Jm=i(w$,"add_prefix_space=True"),w$.forEach(t),Km=i(Wu,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Wu.forEach(t),Gm=d(Re),y(Tn.$$.fragment,Re),Xm=d(Re),Ps=s(Re,"P",{});var Bu=r(Ps);Ym=i(Bu,"This tokenizer inherits from "),dl=s(Bu,"A",{href:!0});var $$=r(dl);Zm=i($$,"PreTrainedTokenizer"),$$.forEach(t),eg=i(Bu,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bu.forEach(t),tg=d(Re),Vt=s(Re,"DIV",{class:!0});var Yl=r(Vt);y(js.$$.fragment,Yl),og=d(Yl),xd=s(Yl,"P",{});var F$=r(xd);ng=i(F$,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),F$.forEach(t),sg=d(Yl),Ls=s(Yl,"UL",{});var Uu=r(Ls);cl=s(Uu,"LI",{});var a$=r(cl);rg=i(a$,"single sequence: "),qd=s(a$,"CODE",{});var R$=r(qd);ag=i(R$,"<s> X </s>"),R$.forEach(t),a$.forEach(t),ig=d(Uu),pl=s(Uu,"LI",{});var i$=r(pl);lg=i(i$,"pair of sequences: "),Cd=s(i$,"CODE",{});var M$=r(Cd);dg=i(M$,"<s> A </s></s> B </s>"),M$.forEach(t),i$.forEach(t),Uu.forEach(t),Yl.forEach(t),cg=d(Re),yn=s(Re,"DIV",{class:!0});var Hu=r(yn);y(As.$$.fragment,Hu),pg=d(Hu),Os=s(Hu,"P",{});var Qu=r(Os);hg=i(Qu,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Pd=s(Qu,"CODE",{});var E$=r(Pd);ug=i(E$,"prepare_for_model"),E$.forEach(t),fg=i(Qu," method."),Qu.forEach(t),Hu.forEach(t),mg=d(Re),vn=s(Re,"DIV",{class:!0});var Vu=r(vn);y(Ns.$$.fragment,Vu),gg=d(Vu),jd=s(Vu,"P",{});var z$=r(jd);_g=i(z$,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),z$.forEach(t),Vu.forEach(t),bg=d(Re),hl=s(Re,"DIV",{class:!0});var x$=r(hl);y(Is.$$.fragment,x$),x$.forEach(t),Re.forEach(t),Xh=d(o),Fo=s(o,"H2",{class:!0});var Ju=r(Fo);wn=s(Ju,"A",{id:!0,class:!0,href:!0});var q$=r(wn);Ld=s(q$,"SPAN",{});var C$=r(Ld);y(Ds.$$.fragment,C$),C$.forEach(t),q$.forEach(t),kg=d(Ju),Ad=s(Ju,"SPAN",{});var P$=r(Ad);Tg=i(P$,"RobertaTokenizerFast"),P$.forEach(t),Ju.forEach(t),Yh=d(o),Pe=s(o,"DIV",{class:!0});var Ge=r(Pe);y(Ss.$$.fragment,Ge),yg=d(Ge),Ws=s(Ge,"P",{});var Ku=r(Ws);vg=i(Ku,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),Od=s(Ku,"EM",{});var j$=r(Od);wg=i(j$,"tokenizers"),j$.forEach(t),$g=i(Ku,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),Ku.forEach(t),Fg=d(Ge),Nd=s(Ge,"P",{});var L$=r(Nd);Rg=i(L$,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),L$.forEach(t),Mg=d(Ge),y(Bs.$$.fragment,Ge),Eg=d(Ge),Us=s(Ge,"P",{});var Gu=r(Us);zg=i(Gu,"You can get around that behavior by passing "),Id=s(Gu,"CODE",{});var A$=r(Id);xg=i(A$,"add_prefix_space=True"),A$.forEach(t),qg=i(Gu,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Gu.forEach(t),Cg=d(Ge),y($n.$$.fragment,Ge),Pg=d(Ge),Hs=s(Ge,"P",{});var Xu=r(Hs);jg=i(Xu,"This tokenizer inherits from "),ul=s(Xu,"A",{href:!0});var O$=r(ul);Lg=i(O$,"PreTrainedTokenizerFast"),O$.forEach(t),Ag=i(Xu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Xu.forEach(t),Og=d(Ge),fl=s(Ge,"DIV",{class:!0});var N$=r(fl);y(Qs.$$.fragment,N$),N$.forEach(t),Ge.forEach(t),Zh=d(o),Ro=s(o,"H2",{class:!0});var Yu=r(Ro);Fn=s(Yu,"A",{id:!0,class:!0,href:!0});var I$=r(Fn);Dd=s(I$,"SPAN",{});var D$=r(Dd);y(Vs.$$.fragment,D$),D$.forEach(t),I$.forEach(t),Ng=d(Yu),Sd=s(Yu,"SPAN",{});var S$=r(Sd);Ig=i(S$,"RobertaModel"),S$.forEach(t),Yu.forEach(t),eu=d(o),je=s(o,"DIV",{class:!0});var Xe=r(je);y(Js.$$.fragment,Xe),Dg=d(Xe),Wd=s(Xe,"P",{});var W$=r(Wd);Sg=i(W$,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),W$.forEach(t),Wg=d(Xe),Ks=s(Xe,"P",{});var Zu=r(Ks);Bg=i(Zu,"This model inherits from "),ml=s(Zu,"A",{href:!0});var B$=r(ml);Ug=i(B$,"PreTrainedModel"),B$.forEach(t),Hg=i(Zu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zu.forEach(t),Qg=d(Xe),Gs=s(Xe,"P",{});var ef=r(Gs);Vg=i(ef,"This model is also a PyTorch "),Xs=s(ef,"A",{href:!0,rel:!0});var U$=r(Xs);Jg=i(U$,"torch.nn.Module"),U$.forEach(t),Kg=i(ef,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),Bd=s(tf,"EM",{});var H$=r(Bd);Yg=i(H$,`Attention is
all you need`),H$.forEach(t),Zg=i(tf,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),tf.forEach(t),e_=d(Xe),Be=s(Xe,"P",{});var wt=r(Be);t_=i(wt,"To behave as an decoder the model needs to be initialized with the "),Ud=s(wt,"CODE",{});var Q$=r(Ud);o_=i(Q$,"is_decoder"),Q$.forEach(t),n_=i(wt,` argument of the configuration set
to `),Hd=s(wt,"CODE",{});var V$=r(Hd);s_=i(V$,"True"),V$.forEach(t),r_=i(wt,". To be used in a Seq2Seq model, the model needs to initialized with both "),Qd=s(wt,"CODE",{});var J$=r(Qd);a_=i(J$,"is_decoder"),J$.forEach(t),i_=i(wt,` argument and
`),Vd=s(wt,"CODE",{});var K$=r(Vd);l_=i(K$,"add_cross_attention"),K$.forEach(t),d_=i(wt," set to "),Jd=s(wt,"CODE",{});var G$=r(Jd);c_=i(G$,"True"),G$.forEach(t),p_=i(wt,"; an "),Kd=s(wt,"CODE",{});var X$=r(Kd);h_=i(X$,"encoder_hidden_states"),X$.forEach(t),u_=i(wt," is then expected as an input to the forward pass."),wt.forEach(t),f_=d(Xe),Rn=s(Xe,"P",{});var Hh=r(Rn);m_=i(Hh,".. _"),Gd=s(Hh,"EM",{});var Y$=r(Gd);g_=i(Y$,"Attention is all you need"),Y$.forEach(t),__=i(Hh,": "),Zs=s(Hh,"A",{href:!0,rel:!0});var Z$=r(Zs);b_=i(Z$,"https://arxiv.org/abs/1706.03762"),Z$.forEach(t),Hh.forEach(t),k_=d(Xe),st=s(Xe,"DIV",{class:!0});var Jt=r(st);y(er.$$.fragment,Jt),T_=d(Jt),Mo=s(Jt,"P",{});var Zl=r(Mo);y_=i(Zl,"The "),gl=s(Zl,"A",{href:!0});var eF=r(gl);v_=i(eF,"RobertaModel"),eF.forEach(t),w_=i(Zl," forward method, overrides the "),Xd=s(Zl,"CODE",{});var tF=r(Xd);$_=i(tF,"__call__"),tF.forEach(t),F_=i(Zl," special method."),Zl.forEach(t),R_=d(Jt),y(Mn.$$.fragment,Jt),M_=d(Jt),Yd=s(Jt,"P",{});var oF=r(Yd);E_=i(oF,"Example:"),oF.forEach(t),z_=d(Jt),y(tr.$$.fragment,Jt),Jt.forEach(t),Xe.forEach(t),tu=d(o),Eo=s(o,"H2",{class:!0});var of=r(Eo);En=s(of,"A",{id:!0,class:!0,href:!0});var nF=r(En);Zd=s(nF,"SPAN",{});var sF=r(Zd);y(or.$$.fragment,sF),sF.forEach(t),nF.forEach(t),x_=d(of),ec=s(of,"SPAN",{});var rF=r(ec);q_=i(rF,"RobertaForCausalLM"),rF.forEach(t),of.forEach(t),ou=d(o),Ye=s(o,"DIV",{class:!0});var Kt=r(Ye);y(nr.$$.fragment,Kt),C_=d(Kt),sr=s(Kt,"P",{});var nf=r(sr);P_=i(nf,"RoBERTa Model with a "),tc=s(nf,"CODE",{});var aF=r(tc);j_=i(aF,"language modeling"),aF.forEach(t),L_=i(nf," head on top for CLM fine-tuning."),nf.forEach(t),A_=d(Kt),rr=s(Kt,"P",{});var sf=r(rr);O_=i(sf,"This model inherits from "),_l=s(sf,"A",{href:!0});var iF=r(_l);N_=i(iF,"PreTrainedModel"),iF.forEach(t),I_=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),jb=d(Zt),yr=s(Zt,"P",{});var uf=r(yr);Lb=i(uf,"This model is also a PyTorch "),vr=s(uf,"A",{href:!0,rel:!0});var RF=r(vr);Ab=i(RF,"torch.nn.Module"),RF.forEach(t),Ob=i(uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
softmax) e.g. for RocStories/SWAG tasks.`),jF.forEach(t),ok=d(eo),Er=s(eo,"P",{});var mf=r(Er);nk=i(mf,"This model inherits from "),wl=s(mf,"A",{href:!0});var LF=r(wl);sk=i(LF,"PreTrainedModel"),LF.forEach(t),rk=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mf.forEach(t),ak=d(eo),zr=s(eo,"P",{});var gf=r(zr);ik=i(gf,"This model is also a PyTorch "),xr=s(gf,"A",{href:!0,rel:!0});var AF=r(xr);lk=i(AF,"torch.nn.Module"),AF.forEach(t),dk=i(gf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gf.forEach(t),ck=d(eo),it=s(eo,"DIV",{class:!0});var to=r(it);y(qr.$$.fragment,to),pk=d(to),Lo=s(to,"P",{});var nd=r(Lo);hk=i(nd,"The "),$l=s(nd,"A",{href:!0});var OF=r($l);uk=i(OF,"RobertaForMultipleChoice"),OF.forEach(t),fk=i(nd," forward method, overrides the "),bc=s(nd,"CODE",{});var NF=r(bc);mk=i(NF,"__call__"),NF.forEach(t),gk=i(nd," special method."),nd.forEach(t),_k=d(to),y(Ln.$$.fragment,to),bk=d(to),kc=s(to,"P",{});var IF=r(kc);kk=i(IF,"Example:"),IF.forEach(t),Tk=d(to),y(Cr.$$.fragment,to),to.forEach(t),eo.forEach(t),du=d(o),Ao=s(o,"H2",{class:!0});var _f=r(Ao);An=s(_f,"A",{id:!0,class:!0,href:!0});var DF=r(An);Tc=s(DF,"SPAN",{});var SF=r(Tc);y(Pr.$$.fragment,SF),SF.forEach(t),DF.forEach(t),yk=d(_f),yc=s(_f,"SPAN",{});var WF=r(yc);vk=i(WF,"RobertaForTokenClassification"),WF.forEach(t),_f.forEach(t),cu=d(o),ot=s(o,"DIV",{class:!0});var oo=r(ot);y(jr.$$.fragment,oo),wk=d(oo),vc=s(oo,"P",{});var BF=r(vc);$k=i(BF,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),BF.forEach(t),Fk=d(oo),Lr=s(oo,"P",{});var bf=r(Lr);Rk=i(bf,"This model inherits from "),Fl=s(bf,"A",{href:!0});var UF=r(Fl);Mk=i(UF,"PreTrainedModel"),UF.forEach(t),Ek=i(bf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bf.forEach(t),zk=d(oo),Ar=s(oo,"P",{});var kf=r(Ar);xk=i(kf,"This model is also a PyTorch "),Or=s(kf,"A",{href:!0,rel:!0});var HF=r(Or);qk=i(HF,"torch.nn.Module"),HF.forEach(t),Ck=i(kf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kf.forEach(t),Pk=d(oo),lt=s(oo,"DIV",{class:!0});var no=r(lt);y(Nr.$$.fragment,no),jk=d(no),Oo=s(no,"P",{});var sd=r(Oo);Lk=i(sd,"The "),Rl=s(sd,"A",{href:!0});var QF=r(Rl);Ak=i(QF,"RobertaForTokenClassification"),QF.forEach(t),Ok=i(sd," forward method, overrides the "),wc=s(sd,"CODE",{});var VF=r(wc);Nk=i(VF,"__call__"),VF.forEach(t),Ik=i(sd," special method."),sd.forEach(t),Dk=d(no),y(On.$$.fragment,no),Sk=d(no),$c=s(no,"P",{});var JF=r($c);Wk=i(JF,"Example:"),JF.forEach(t),Bk=d(no),y(Ir.$$.fragment,no),no.forEach(t),oo.forEach(t),pu=d(o),No=s(o,"H2",{class:!0});var Tf=r(No);Nn=s(Tf,"A",{id:!0,class:!0,href:!0});var KF=r(Nn);Fc=s(KF,"SPAN",{});var GF=r(Fc);y(Dr.$$.fragment,GF),GF.forEach(t),KF.forEach(t),Uk=d(Tf),Rc=s(Tf,"SPAN",{});var XF=r(Rc);Hk=i(XF,"RobertaForQuestionAnswering"),XF.forEach(t),Tf.forEach(t),hu=d(o),nt=s(o,"DIV",{class:!0});var so=r(nt);y(Sr.$$.fragment,so),Qk=d(so),Io=s(so,"P",{});var rd=r(Io);Vk=i(rd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mc=s(rd,"CODE",{});var YF=r(Mc);Jk=i(YF,"span start logits"),YF.forEach(t),Kk=i(rd," and "),Ec=s(rd,"CODE",{});var ZF=r(Ec);Gk=i(ZF,"span end logits"),ZF.forEach(t),Xk=i(rd,")."),rd.forEach(t),Yk=d(so),Wr=s(so,"P",{});var yf=r(Wr);Zk=i(yf,"This model inherits from "),Ml=s(yf,"A",{href:!0});var e2=r(Ml);eT=i(e2,"PreTrainedModel"),e2.forEach(t),tT=i(yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yf.forEach(t),oT=d(so),Br=s(so,"P",{});var vf=r(Br);nT=i(vf,"This model is also a PyTorch "),Ur=s(vf,"A",{href:!0,rel:!0});var t2=r(Ur);sT=i(t2,"torch.nn.Module"),t2.forEach(t),rT=i(vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),aT=d(so),dt=s(so,"DIV",{class:!0});var ro=r(dt);y(Hr.$$.fragment,ro),iT=d(ro),Do=s(ro,"P",{});var ad=r(Do);lT=i(ad,"The "),El=s(ad,"A",{href:!0});var o2=r(El);dT=i(o2,"RobertaForQuestionAnswering"),o2.forEach(t),cT=i(ad," forward method, overrides the "),zc=s(ad,"CODE",{});var n2=r(zc);pT=i(n2,"__call__"),n2.forEach(t),hT=i(ad," special method."),ad.forEach(t),uT=d(ro),y(In.$$.fragment,ro),fT=d(ro),xc=s(ro,"P",{});var s2=r(xc);mT=i(s2,"Example:"),s2.forEach(t),gT=d(ro),y(Qr.$$.fragment,ro),ro.forEach(t),so.forEach(t),uu=d(o),So=s(o,"H2",{class:!0});var wf=r(So);Dn=s(wf,"A",{id:!0,class:!0,href:!0});var r2=r(Dn);qc=s(r2,"SPAN",{});var a2=r(qc);y(Vr.$$.fragment,a2),a2.forEach(t),r2.forEach(t),_T=d(wf),Cc=s(wf,"SPAN",{});var i2=r(Cc);bT=i(i2,"TFRobertaModel"),i2.forEach(t),wf.forEach(t),fu=d(o),Ue=s(o,"DIV",{class:!0});var Ct=r(Ue);y(Jr.$$.fragment,Ct),kT=d(Ct),Pc=s(Ct,"P",{});var l2=r(Pc);TT=i(l2,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),l2.forEach(t),yT=d(Ct),Kr=s(Ct,"P",{});var $f=r(Kr);vT=i($f,"This model inherits from "),zl=s($f,"A",{href:!0});var d2=r(zl);wT=i(d2,"TFPreTrainedModel"),d2.forEach(t),$T=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),FT=d(Ct),Gr=s(Ct,"P",{});var Ff=r(Gr);RT=i(Ff,"This model is also a "),Xr=s(Ff,"A",{href:!0,rel:!0});var c2=r(Xr);MT=i(c2,"tf.keras.Model"),c2.forEach(t),ET=i(Ff,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ff.forEach(t),zT=d(Ct),y(Sn.$$.fragment,Ct),xT=d(Ct),ct=s(Ct,"DIV",{class:!0});var ao=r(ct);y(Yr.$$.fragment,ao),qT=d(ao),Wo=s(ao,"P",{});var id=r(Wo);CT=i(id,"The "),xl=s(id,"A",{href:!0});var p2=r(xl);PT=i(p2,"TFRobertaModel"),p2.forEach(t),jT=i(id," forward method, overrides the "),jc=s(id,"CODE",{});var h2=r(jc);LT=i(h2,"__call__"),h2.forEach(t),AT=i(id," special method."),id.forEach(t),OT=d(ao),y(Wn.$$.fragment,ao),NT=d(ao),Lc=s(ao,"P",{});var u2=r(Lc);IT=i(u2,"Example:"),u2.forEach(t),DT=d(ao),y(Zr.$$.fragment,ao),ao.forEach(t),Ct.forEach(t),mu=d(o),Bo=s(o,"H2",{class:!0});var Rf=r(Bo);Bn=s(Rf,"A",{id:!0,class:!0,href:!0});var f2=r(Bn);Ac=s(f2,"SPAN",{});var m2=r(Ac);y(ea.$$.fragment,m2),m2.forEach(t),f2.forEach(t),ST=d(Rf),Oc=s(Rf,"SPAN",{});var g2=r(Oc);WT=i(g2,"TFRobertaForCausalLM"),g2.forEach(t),Rf.forEach(t),gu=d(o),Uo=s(o,"DIV",{class:!0});var Mf=r(Uo);y(ta.$$.fragment,Mf),BT=d(Mf),pt=s(Mf,"DIV",{class:!0});var io=r(pt);y(oa.$$.fragment,io),UT=d(io),Ho=s(io,"P",{});var ld=r(Ho);HT=i(ld,"The "),ql=s(ld,"A",{href:!0});var _2=r(ql);QT=i(_2,"TFRobertaForCausalLM"),_2.forEach(t),VT=i(ld," forward method, overrides the "),Nc=s(ld,"CODE",{});var b2=r(Nc);JT=i(b2,"__call__"),b2.forEach(t),KT=i(ld," special method."),ld.forEach(t),GT=d(io),y(Un.$$.fragment,io),XT=d(io),Ic=s(io,"P",{});var k2=r(Ic);YT=i(k2,"Example:"),k2.forEach(t),ZT=d(io),y(na.$$.fragment,io),io.forEach(t),Mf.forEach(t),_u=d(o),Qo=s(o,"H2",{class:!0});var Ef=r(Qo);Hn=s(Ef,"A",{id:!0,class:!0,href:!0});var T2=r(Hn);Dc=s(T2,"SPAN",{});var y2=r(Dc);y(sa.$$.fragment,y2),y2.forEach(t),T2.forEach(t),ey=d(Ef),Sc=s(Ef,"SPAN",{});var v2=r(Sc);ty=i(v2,"TFRobertaForMaskedLM"),v2.forEach(t),Ef.forEach(t),bu=d(o),He=s(o,"DIV",{class:!0});var Pt=r(He);y(ra.$$.fragment,Pt),oy=d(Pt),aa=s(Pt,"P",{});var zf=r(aa);ny=i(zf,"RoBERTa Model with a "),Wc=s(zf,"CODE",{});var w2=r(Wc);sy=i(w2,"language modeling"),w2.forEach(t),ry=i(zf," head on top."),zf.forEach(t),ay=d(Pt),ia=s(Pt,"P",{});var xf=r(ia);iy=i(xf,"This model inherits from "),Cl=s(xf,"A",{href:!0});var $2=r(Cl);ly=i($2,"TFPreTrainedModel"),$2.forEach(t),dy=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xf.forEach(t),cy=d(Pt),la=s(Pt,"P",{});var qf=r(la);py=i(qf,"This model is also a "),da=s(qf,"A",{href:!0,rel:!0});var F2=r(da);hy=i(F2,"tf.keras.Model"),F2.forEach(t),uy=i(qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qf.forEach(t),fy=d(Pt),y(Qn.$$.fragment,Pt),my=d(Pt),ht=s(Pt,"DIV",{class:!0});var lo=r(ht);y(ca.$$.fragment,lo),gy=d(lo),Vo=s(lo,"P",{});var dd=r(Vo);_y=i(dd,"The "),Pl=s(dd,"A",{href:!0});var R2=r(Pl);by=i(R2,"TFRobertaForMaskedLM"),R2.forEach(t),ky=i(dd," forward method, overrides the "),Bc=s(dd,"CODE",{});var M2=r(Bc);Ty=i(M2,"__call__"),M2.forEach(t),yy=i(dd," special method."),dd.forEach(t),vy=d(lo),y(Vn.$$.fragment,lo),wy=d(lo),Uc=s(lo,"P",{});var E2=r(Uc);$y=i(E2,"Example:"),E2.forEach(t),Fy=d(lo),y(pa.$$.fragment,lo),lo.forEach(t),Pt.forEach(t),ku=d(o),Jo=s(o,"H2",{class:!0});var Cf=r(Jo);Jn=s(Cf,"A",{id:!0,class:!0,href:!0});var z2=r(Jn);Hc=s(z2,"SPAN",{});var x2=r(Hc);y(ha.$$.fragment,x2),x2.forEach(t),z2.forEach(t),Ry=d(Cf),Qc=s(Cf,"SPAN",{});var q2=r(Qc);My=i(q2,"TFRobertaForSequenceClassification"),q2.forEach(t),Cf.forEach(t),Tu=d(o),Qe=s(o,"DIV",{class:!0});var jt=r(Qe);y(ua.$$.fragment,jt),Ey=d(jt),Vc=s(jt,"P",{});var C2=r(Vc);zy=i(C2,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C2.forEach(t),xy=d(jt),fa=s(jt,"P",{});var Pf=r(fa);qy=i(Pf,"This model inherits from "),jl=s(Pf,"A",{href:!0});var P2=r(jl);Cy=i(P2,"TFPreTrainedModel"),P2.forEach(t),Py=i(Pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pf.forEach(t),jy=d(jt),ma=s(jt,"P",{});var jf=r(ma);Ly=i(jf,"This model is also a "),ga=s(jf,"A",{href:!0,rel:!0});var j2=r(ga);Ay=i(j2,"tf.keras.Model"),j2.forEach(t),Oy=i(jf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jf.forEach(t),Ny=d(jt),y(Kn.$$.fragment,jt),Iy=d(jt),ut=s(jt,"DIV",{class:!0});var co=r(ut);y(_a.$$.fragment,co),Dy=d(co),Ko=s(co,"P",{});var cd=r(Ko);Sy=i(cd,"The "),Ll=s(cd,"A",{href:!0});var L2=r(Ll);Wy=i(L2,"TFRobertaForSequenceClassification"),L2.forEach(t),By=i(cd," forward method, overrides the "),Jc=s(cd,"CODE",{});var A2=r(Jc);Uy=i(A2,"__call__"),A2.forEach(t),Hy=i(cd," special method."),cd.forEach(t),Qy=d(co),y(Gn.$$.fragment,co),Vy=d(co),Kc=s(co,"P",{});var O2=r(Kc);Jy=i(O2,"Example:"),O2.forEach(t),Ky=d(co),y(ba.$$.fragment,co),co.forEach(t),jt.forEach(t),yu=d(o),Go=s(o,"H2",{class:!0});var Lf=r(Go);Xn=s(Lf,"A",{id:!0,class:!0,href:!0});var N2=r(Xn);Gc=s(N2,"SPAN",{});var I2=r(Gc);y(ka.$$.fragment,I2),I2.forEach(t),N2.forEach(t),Gy=d(Lf),Xc=s(Lf,"SPAN",{});var D2=r(Xc);Xy=i(D2,"TFRobertaForMultipleChoice"),D2.forEach(t),Lf.forEach(t),vu=d(o),Ve=s(o,"DIV",{class:!0});var Lt=r(Ve);y(Ta.$$.fragment,Lt),Yy=d(Lt),Yc=s(Lt,"P",{});var S2=r(Yc);Zy=i(S2,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),S2.forEach(t),ev=d(Lt),ya=s(Lt,"P",{});var Af=r(ya);tv=i(Af,"This model inherits from "),Al=s(Af,"A",{href:!0});var W2=r(Al);ov=i(W2,"TFPreTrainedModel"),W2.forEach(t),nv=i(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),sv=d(Lt),va=s(Lt,"P",{});var Of=r(va);rv=i(Of,"This model is also a "),wa=s(Of,"A",{href:!0,rel:!0});var B2=r(wa);av=i(B2,"tf.keras.Model"),B2.forEach(t),iv=i(Of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),lv=d(Lt),y(Yn.$$.fragment,Lt),dv=d(Lt),ft=s(Lt,"DIV",{class:!0});var po=r(ft);y($a.$$.fragment,po),cv=d(po),Xo=s(po,"P",{});var pd=r(Xo);pv=i(pd,"The "),Ol=s(pd,"A",{href:!0});var U2=r(Ol);hv=i(U2,"TFRobertaForMultipleChoice"),U2.forEach(t),uv=i(pd," forward method, overrides the "),Zc=s(pd,"CODE",{});var H2=r(Zc);fv=i(H2,"__call__"),H2.forEach(t),mv=i(pd," special method."),pd.forEach(t),gv=d(po),y(Zn.$$.fragment,po),_v=d(po),ep=s(po,"P",{});var Q2=r(ep);bv=i(Q2,"Example:"),Q2.forEach(t),kv=d(po),y(Fa.$$.fragment,po),po.forEach(t),Lt.forEach(t),wu=d(o),Yo=s(o,"H2",{class:!0});var Nf=r(Yo);es=s(Nf,"A",{id:!0,class:!0,href:!0});var V2=r(es);tp=s(V2,"SPAN",{});var J2=r(tp);y(Ra.$$.fragment,J2),J2.forEach(t),V2.forEach(t),Tv=d(Nf),op=s(Nf,"SPAN",{});var K2=r(op);yv=i(K2,"TFRobertaForTokenClassification"),K2.forEach(t),Nf.forEach(t),$u=d(o),Je=s(o,"DIV",{class:!0});var At=r(Je);y(Ma.$$.fragment,At),vv=d(At),np=s(At,"P",{});var G2=r(np);wv=i(G2,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),G2.forEach(t),$v=d(At),Ea=s(At,"P",{});var If=r(Ea);Fv=i(If,"This model inherits from "),Nl=s(If,"A",{href:!0});var X2=r(Nl);Rv=i(X2,"TFPreTrainedModel"),X2.forEach(t),Mv=i(If,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),If.forEach(t),Ev=d(At),za=s(At,"P",{});var Df=r(za);zv=i(Df,"This model is also a "),xa=s(Df,"A",{href:!0,rel:!0});var Y2=r(xa);xv=i(Y2,"tf.keras.Model"),Y2.forEach(t),qv=i(Df,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),Cv=d(At),y(ts.$$.fragment,At),Pv=d(At),mt=s(At,"DIV",{class:!0});var ho=r(mt);y(qa.$$.fragment,ho),jv=d(ho),Zo=s(ho,"P",{});var hd=r(Zo);Lv=i(hd,"The "),Il=s(hd,"A",{href:!0});var Z2=r(Il);Av=i(Z2,"TFRobertaForTokenClassification"),Z2.forEach(t),Ov=i(hd," forward method, overrides the "),sp=s(hd,"CODE",{});var eR=r(sp);Nv=i(eR,"__call__"),eR.forEach(t),Iv=i(hd," special method."),hd.forEach(t),Dv=d(ho),y(os.$$.fragment,ho),Sv=d(ho),rp=s(ho,"P",{});var tR=r(rp);Wv=i(tR,"Example:"),tR.forEach(t),Bv=d(ho),y(Ca.$$.fragment,ho),ho.forEach(t),At.forEach(t),Fu=d(o),en=s(o,"H2",{class:!0});var Sf=r(en);ns=s(Sf,"A",{id:!0,class:!0,href:!0});var oR=r(ns);ap=s(oR,"SPAN",{});var nR=r(ap);y(Pa.$$.fragment,nR),nR.forEach(t),oR.forEach(t),Uv=d(Sf),ip=s(Sf,"SPAN",{});var sR=r(ip);Hv=i(sR,"TFRobertaForQuestionAnswering"),sR.forEach(t),Sf.forEach(t),Ru=d(o),Ke=s(o,"DIV",{class:!0});var Ot=r(Ke);y(ja.$$.fragment,Ot),Qv=d(Ot),tn=s(Ot,"P",{});var ud=r(tn);Vv=i(ud,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
