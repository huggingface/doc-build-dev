import{S as Ys,i as Rs,s as Bs,e as n,k as h,w,t as s,M as Qs,c as a,d as o,m,a as r,x as y,h as i,b as d,F as e,g as _,y as $,q as S,o as T,B as k,v as Xs,L as St}from"../../chunks/vendor-6b77c823.js";import{T as fn}from"../../chunks/Tip-39098574.js";import{D as H}from"../../chunks/Docstring-1088f2fb.js";import{C as Tt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as je}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as $t}from"../../chunks/ExampleCodeBlock-5212b321.js";function Zs(U){let c,v,p,u,b;return u=new Tt({props:{code:`from transformers import UniSpeechModel, UniSpeechConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(l,f){_(l,c,f),e(c,v),e(c,p),e(p,u),e(c,b)},d(l){l&&o(c)}}}function Gs(U){let c,v,p,u,b;return u=new Tt({props:{code:`from transformers import Wav2Vec2Processor, UniSpeechModel
import torch
...
instance of <a href="/docs/transformers/pr_17378/en/model_doc/unispeech#transformers.UniSpeechForCTC">UniSpeechForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.UniSpeechConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17378/en/model_doc/unispeech#transformers.UniSpeechForCTC">UniSpeechForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.UniSpeechConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17378/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17378/src/transformers/models/unispeech/modeling_unispeech.py#L1128",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17378/en/main_classes/output#transformers.modeling_outputs.Wav2Vec2BaseModelOutput"
>transformers.modeling_outputs.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17378/en/model_doc/unispeech#transformers.UniSpeechConfig"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17378/src/transformers/models/unispeech/modeling_unispeech.py#L1380",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17378/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17378/src/transformers/models/unispeech/modeling_unispeech.py#L1515",returnDescription:`
<p>A <a
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17378/src/transformers/models/unispeech/modeling_unispeech.py#L1249",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17378/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput"
...
found `),ze=n("a"),zn=s("here"),On=s("."),Eo=h(),Y=n("h2"),ce=n("a"),Jt=n("span"),w(Oe.$$.fragment),An=h(),Gt=n("span"),Dn=s("UniSpeechConfig"),Mo=h(),M=n("div"),w(Ae.$$.fragment),Wn=h(),R=n("p"),Ln=s("This is the configuration class to store the configuration of a "),Ft=n("a"),Nn=s("UniSpeechModel"),Vn=s(`. It is used to instantiate an
...
behavior.`),va=h(),z=n("div"),w(Qe.$$.fragment),ba=h(),J=n("p"),wa=s("The "),Mt=n("a"),ya=s("UniSpeechModel"),$a=s(" forward method, overrides the "),ro=n("code"),Sa=s("__call__"),Ta=s(" special method."),ka=h(),w(me.$$.fragment),Ua=h(),w(ue.$$.fragment),Wo=h(),G=n("h2"),fe=n("a"),so=n("span"),w(Xe.$$.fragment),Ca=h(),io=n("span"),xa=s("UniSpeechForCTC"),Lo=h(),F=n("div"),w(Ze.$$.fragment),ja=h(),ee=n("p"),Fa=s("UniSpeech Model with a "),lo=n("code"),qa=s("language modeling"),Pa=s(` head on top for Connectionist Temporal Classification (CTC).
UniSpeech was proposed in `),Je=n("a"),Ea=s(`UniSpeech: Unified Speech Representation Learning with Labeled and Unlabeled
Data`),Ma=s(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),za=h(),Ge=n("p"),Oa=s("This model inherits from "),zt=n("a"),Aa=s("PreTrainedModel"),Da=s(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ia=h(),P=n("div"),w(ot.$$.fragment),Ha=h(),te=n("p"),Ka=s("The "),Ot=n("a"),Ya=s("UniSpeechForCTC"),Ra=s(" forward method, overrides the "),co=n("code"),Ba=s("__call__"),Qa=s(" special method."),Xa=h(),w(ge.$$.fragment),Za=h(),w(_e.$$.fragment),Ja=h(),w(ve.$$.fragment),No=h(),oe=n("h2"),be=n("a"),po=n("span"),w(nt.$$.fragment),Ga=h(),ho=n("span"),er=s("UniSpeechForSequenceClassification"),Vo=h(),x=n("div"),w(at.$$.fragment),tr=h(),mo=n("p"),or=s(`UniSpeech Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
decoded using `),jt=a(Bo,"A",{href:!0});var Jr=r(jt);Fn=i(Jr,"Wav2Vec2CTCTokenizer"),Jr.forEach(o),qn=i(Bo,"."),Bo.forEach(o),Yo.forEach(o),Po=m(t),D=a(t,"P",{});var Nt=r(D);Pn=i(Nt,"This model was contributed by "),Me=a(Nt,"A",{href:!0,rel:!0});var Gr=r(Me);En=i(Gr,"patrickvonplaten"),Gr.forEach(o),Mn=i(Nt,`. The Authors\u2019 code can be
found `),ze=a(Nt,"A",{href:!0,rel:!0});var es=r(ze);zn=i(es,"here"),es.forEach(o),On=i(Nt,"."),Nt.forEach(o),Eo=m(t),Y=a(t,"H2",{class:!0});var Qo=r(Y);ce=a(Qo,"A",{id:!0,class:!0,href:!0});var ts=r(ce);Jt=a(ts,"SPAN",{});var os=r(Jt);y(Oe.$$.fragment,os),os.forEach(o),ts.forEach(o),An=m(Qo),Gt=a(Qo,"SPAN",{});var ns=r(Gt);Dn=i(ns,"UniSpeechConfig"),ns.forEach(o),Qo.forEach(o),Mo=m(t),M=a(t,"DIV",{class:!0});var Ue=r(M);y(Ae.$$.fragment,Ue),Wn=m(Ue),R=a(Ue,"P",{});var Vt=r(R);Ln=i(Vt,"This is the configuration class to store the configuration of a "),Ft=a(Vt,"A",{href:!0});var as=r(Ft);Nn=i(as,"UniSpeechModel"),as.forEach(o),Vn=i(Vt,`. It is used to instantiate an
UniSpeech model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the UniSpeech
...
documentation from `),Pt=a(It,"A",{href:!0});var is=r(Pt);Qn=i(is,"PretrainedConfig"),is.forEach(o),Xn=i(It," for more information."),It.forEach(o),Zn=m(Ue),y(de.$$.fragment,Ue),Ue.forEach(o),zo=m(t),Q=a(t,"H2",{class:!0});var Xo=r(Q);pe=a(Xo,"A",{id:!0,class:!0,href:!0});var ls=r(pe);eo=a(ls,"SPAN",{});var cs=r(eo);y(We.$$.fragment,cs),cs.forEach(o),ls.forEach(o),Jn=m(Xo),to=a(Xo,"SPAN",{});var ds=r(to);Gn=i(ds,"UniSpeech specific outputs"),ds.forEach(o),Xo.forEach(o),Oo=m(t),X=a(t,"DIV",{class:!0});var Zo=r(X);y(Le.$$.fragment,Zo),ea=m(Zo),Ne=a(Zo,"P",{});var Jo=r(Ne);ta=i(Jo,"Output type of "),oo=a(Jo,"CODE",{});var ps=r(oo);oa=i(ps,"UniSpeechForPreTrainingOutput"),ps.forEach(o),na=i(Jo,", with potential hidden states and attentions."),Jo.forEach(o),Zo.forEach(o),Ao=m(t),Z=a(t,"H2",{class:!0});var Go=r(Z);he=a(Go,"A",{id:!0,class:!0,href:!0});var hs=r(he);no=a(hs,"SPAN",{});var ms=r(no);y(Ve.$$.fragment,ms),ms.forEach(o),hs.forEach(o),aa=m(Go),ao=a(Go,"SPAN",{});var us=r(ao);ra=i(us,"UniSpeechModel"),us.forEach(o),Go.forEach(o),Do=m(t),j=a(t,"DIV",{class:!0});var W=r(j);y(Ie.$$.fragment,W),sa=m(W),He=a(W,"P",{});var en=r(He);ia=i(en,`The bare UniSpeech Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),on.forEach(o),va=m(W),z=a(W,"DIV",{class:!0});var Ce=r(z);y(Qe.$$.fragment,Ce),ba=m(Ce),J=a(Ce,"P",{});var Ht=r(J);wa=i(Ht,"The "),Mt=a(Ht,"A",{href:!0});var vs=r(Mt);ya=i(vs,"UniSpeechModel"),vs.forEach(o),$a=i(Ht," forward method, overrides the "),ro=a(Ht,"CODE",{});var bs=r(ro);Sa=i(bs,"__call__"),bs.forEach(o),Ta=i(Ht," special method."),Ht.forEach(o),ka=m(Ce),y(me.$$.fragment,Ce),Ua=m(Ce),y(ue.$$.fragment,Ce),Ce.forEach(o),W.forEach(o),Wo=m(t),G=a(t,"H2",{class:!0});var nn=r(G);fe=a(nn,"A",{id:!0,class:!0,href:!0});var ws=r(fe);so=a(ws,"SPAN",{});var ys=r(so);y(Xe.$$.fragment,ys),ys.forEach(o),ws.forEach(o),Ca=m(nn),io=a(nn,"SPAN",{});var $s=r(io);xa=i($s,"UniSpeechForCTC"),$s.forEach(o),nn.forEach(o),Lo=m(t),F=a(t,"DIV",{class:!0});var L=r(F);y(Ze.$$.fragment,L),ja=m(L),ee=a(L,"P",{});var Kt=r(ee);Fa=i(Kt,"UniSpeech Model with a "),lo=a(Kt,"CODE",{});var Ss=r(lo);qa=i(Ss,"language modeling"),Ss.forEach(o),Pa=i(Kt,` head on top for Connectionist Temporal Classification (CTC).
UniSpeech was proposed in `),Je=a(Kt,"A",{href:!0,rel:!0});var Ts=r(Je);Ea=i(Ts,`UniSpeech: Unified Speech Representation Learning with Labeled and Unlabeled
Data`),Ts.forEach(o),Ma=i(Kt,` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),Kt.forEach(o),za=m(L),Ge=a(L,"P",{});var an=r(Ge);Oa=i(an,"This model inherits from "),zt=a(an,"A",{href:!0});var ks=r(zt);Aa=i(ks,"PreTrainedModel"),ks.forEach(o),Da=i(an,`. Check the superclass documentation for the generic methods the
