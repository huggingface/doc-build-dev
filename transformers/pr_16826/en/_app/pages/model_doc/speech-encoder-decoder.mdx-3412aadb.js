import{S as xs,i as Ts,s as Ms,e as a,k as i,w as b,t as n,M as Ds,c as s,d as o,m as l,a as d,x as y,h as t,b as c,F as e,g as u,y as w,q as E,o as k,B as S,v as $s}from"../../chunks/vendor-6b77c823.js";import{T as Ss}from"../../chunks/Tip-39098574.js";import{D as ne}from"../../chunks/Docstring-17b815d9.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Tn}from"../../chunks/IconCopyLink-7a11ce68.js";function js(Je){let h,C,g,D,F;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),D=n("Module"),F=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){h=s(x,"P",{});var M=d(h);C=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(x,M){u(x,h,M),e(h,C),e(h,g),e(g,D),e(h,F)},d(x){x&&o(h)}}}function qs(Je){let h,C,g,D,F;return{c(){h=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),D=n("Module"),F=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){h=s(x,"P",{});var M=d(h);C=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(x,M){u(x,h,M),e(h,C),e(h,g),e(g,D),e(h,F)},d(x){x&&o(h)}}}function Ps(Je){let h,C,g,D,F,x,M,L,Mn,on,$,Dn,Ye,$n,jn,xo,qn,Pn,Ze,zn,Fn,Ke,Cn,An,nn,N,Ln,To,Nn,In,he,Vn,Wn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,rn,H,te,Mo,me,Gn,Do,Jn,an,T,fe,Yn,re,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,rt,at,st,$o,dt,ct,ue,it,ae,ge,lt,_e,pt,ro,ht,mt,ft,se,ve,ut,J,gt,jo,_t,vt,qo,bt,yt,sn,Y,de,Po,be,wt,zo,Et,dn,m,ye,kt,Z,St,ao,xt,Tt,so,Mt,Dt,$t,we,jt,Ee,qt,Pt,zt,ke,Ft,Se,Ct,At,Lt,Fo,Nt,It,xe,Vt,co,Wt,Ot,Bt,Te,Rt,Me,Ut,Ht,Gt,V,io,Jt,Yt,Co,Zt,Kt,Ao,Qt,Xt,er,j,De,or,K,nr,lo,tr,rr,Lo,ar,sr,dr,ce,cr,No,ir,lr,$e,pr,q,je,hr,Io,mr,fr,Q,ur,Vo,gr,_r,Wo,vr,br,yr,Oo,wr,Er,qe,cn,X,ie,Bo,Pe,kr,Ro,Sr,ln,f,ze,xr,ee,Tr,po,Mr,Dr,ho,$r,jr,qr,Fe,Pr,Ce,zr,Fr,Cr,Ae,Ar,Le,Lr,Nr,Ir,Uo,Vr,Wr,Ne,Or,mo,Br,Rr,Ur,Ie,Hr,Ve,Gr,Jr,Yr,W,fo,Zr,Kr,Ho,Qr,Xr,Go,ea,oa,na,P,We,ta,oe,ra,uo,aa,sa,Jo,da,ca,ia,le,la,Yo,pa,ha,Oe,ma,A,Be,fa,Zo,ua,ga,Ko,_a,va,Re,pn;return x=new Tn({}),me=new Tn({}),fe=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16826/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16826/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16826/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27"}}),ue=new en({props:{code:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_16826/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_16826/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16826/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16826/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16826/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<a href="/docs/transformers/pr_16826/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16826/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L441",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16826/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_16826/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16826/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L285"}}),qe=new en({props:{code:`from transformers import SpeechEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),Pe=new Tn({}),ze=new ne({props:{name:"class transformers.FlaxSpeechEncoderDecoderModel",anchor:"transformers.FlaxSpeechEncoderDecoderModel",parameters:[{name:"config",val:": SpeechEncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxSpeechEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16826/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig">SpeechEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16826/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxSpeechEncoderDecoderModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16826/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L643",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16826/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16826/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16826/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L764"}}),Re=new en({props:{code:`from transformers import FlaxSpeechEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxSpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2-2-bart-large&quot;</span>)`}}),{c(){h=a("meta"),C=i(),g=a("h1"),D=a("a"),F=a("span"),b(x.$$.fragment),M=i(),L=a("span"),Mn=n("Speech Encoder Decoder Models"),on=i(),$=a("p"),Dn=n("The "),Ye=a("a"),$n=n("SpeechEncoderDecoderModel"),jn=n(` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),xo=a("em"),qn=n("e.g."),Pn=i(),Ze=a("a"),zn=n("Wav2Vec2"),Fn=n(", "),Ke=a("a"),Cn=n("Hubert"),An=n(") and any pretrained autoregressive model as the decoder."),nn=i(),N=a("p"),Ln=n(`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
recognition and speech translation has `),To=a("em"),Nn=n("e.g."),In=n(" been shown in "),he=a("a"),Vn=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
`),Xe=a("a"),Un=n("Speech2Text2"),Hn=n("."),rn=i(),H=a("h2"),te=a("a"),Mo=a("span"),b(me.$$.fragment),Gn=i(),Do=a("span"),Jn=n("SpeechEncoderDecoderConfig"),an=i(),T=a("div"),b(fe.$$.fragment),Yn=i(),re=a("p"),eo=a("a"),Zn=n("SpeechEncoderDecoderConfig"),Kn=n(` is the configuration class to store the configuration of a
...
loaded via `),ao=a("a"),xt=n("from_pretrained()"),Tt=n(` function and the decoder is loaded via
...
models (see the examples for more information).`),It=i(),xe=a("p"),Vt=n("This model inherits from "),co=a("a"),Wt=n("PreTrainedModel"),Ot=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bt=i(),Te=a("p"),Rt=n("This model is also a PyTorch "),Me=a("a"),Ut=n("torch.nn.Module"),Ht=n(` subclass.
...
the model, you need to first set it back in training mode with `),Wo=a("code"),vr=n("model.train()"),br=n("."),yr=i(),Oo=a("p"),wr=n("Example:"),Er=i(),b(qe.$$.fragment),cn=i(),X=a("h2"),ie=a("a"),Bo=a("span"),b(Pe.$$.fragment),kr=i(),Ro=a("span"),Sr=n("FlaxSpeechEncoderDecoderModel"),ln=i(),f=a("div"),b(ze.$$.fragment),xr=i(),ee=a("p"),Tr=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
checkpoints.`),ga=i(),Ko=a("p"),_a=n("Example:"),va=i(),b(Re.$$.fragment),this.h()},l(r){const p=Ds('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(o),C=l(r),g=s(r,"H1",{class:!0});var Ue=d(g);D=s(Ue,"A",{id:!0,class:!0,href:!0});var Qo=d(D);F=s(Qo,"SPAN",{});var ba=d(F);y(x.$$.fragment,ba),ba.forEach(o),Qo.forEach(o),M=l(Ue),L=s(Ue,"SPAN",{});var ya=d(L);Mn=t(ya,"Speech Encoder Decoder Models"),ya.forEach(o),Ue.forEach(o),on=l(r),$=s(r,"P",{});var O=d($);Dn=t(O,"The "),Ye=s(O,"A",{href:!0});var wa=d(Ye);$n=t(wa,"SpeechEncoderDecoderModel"),wa.forEach(o),jn=t(O,` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),xo=s(O,"EM",{});var Ea=d(xo);qn=t(Ea,"e.g."),Ea.forEach(o),Pn=l(O),Ze=s(O,"A",{href:!0});var ka=d(Ze);zn=t(ka,"Wav2Vec2"),ka.forEach(o),Fn=t(O,", "),Ke=s(O,"A",{href:!0});var Sa=d(Ke);Cn=t(Sa,"Hubert"),Sa.forEach(o),An=t(O,") and any pretrained autoregressive model as the decoder."),O.forEach(o),nn=l(r),N=s(r,"P",{});var go=d(N);Ln=t(go,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
recognition and speech translation has `),To=s(go,"EM",{});var xa=d(To);Nn=t(xa,"e.g."),xa.forEach(o),In=t(go," been shown in "),he=s(go,"A",{href:!0,rel:!0});var Ta=d(he);Vn=t(Ta,`Large-Scale Self- and Semi-Supervised Learning for Speech
Translation`),Ta.forEach(o),Wn=t(go,` by Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli,
...
`),Xe=s(_o,"A",{href:!0});var Da=d(Xe);Un=t(Da,"Speech2Text2"),Da.forEach(o),Hn=t(_o,"."),_o.forEach(o),rn=l(r),H=s(r,"H2",{class:!0});var hn=d(H);te=s(hn,"A",{id:!0,class:!0,href:!0});var $a=d(te);Mo=s($a,"SPAN",{});var ja=d(Mo);y(me.$$.fragment,ja),ja.forEach(o),$a.forEach(o),Gn=l(hn),Do=s(hn,"SPAN",{});var qa=d(Do);Jn=t(qa,"SpeechEncoderDecoderConfig"),qa.forEach(o),hn.forEach(o),an=l(r),T=s(r,"DIV",{class:!0});var z=d(T);y(fe.$$.fragment,z),Yn=l(z),re=s(z,"P",{});var Xo=d(re);eo=s(Xo,"A",{href:!0});var Pa=d(eo);Zn=t(Pa,"SpeechEncoderDecoderConfig"),Pa.forEach(o),Kn=t(Xo,` is the configuration class to store the configuration of a
...
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),ao=s(yo,"A",{href:!0});var Ba=d(ao);xt=t(Ba,"from_pretrained()"),Ba.forEach(o),Tt=t(yo,` function and the decoder is loaded via
...
models (see the examples for more information).`),Ga.forEach(o),It=l(_),xe=s(_,"P",{});var bn=d(xe);Vt=t(bn,"This model inherits from "),co=s(bn,"A",{href:!0});var Ja=d(co);Wt=t(Ja,"PreTrainedModel"),Ja.forEach(o),Ot=t(bn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bn.forEach(o),Bt=l(_),Te=s(_,"P",{});var yn=d(Te);Rt=t(yn,"This model is also a PyTorch "),Me=s(yn,"A",{href:!0,rel:!0});var Ya=d(Me);Ut=t(Ya,"torch.nn.Module"),Ya.forEach(o),Ht=t(yn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sn.forEach(o),Ur=l(v),Ie=s(v,"P",{});var xn=d(Ie);Hr=t(xn,`This model is also a Flax Linen
`),Ve=s(xn,"A",{href:!0,rel:!0});var us=d(Ve);Gr=t(us,"flax.nn.Module"),us.forEach(o),Jr=t(xn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xn.forEach(o),Yr=l(v),W=s(v,"P",{});var Ge=d(W);fo=s(Ge,"A",{href:!0});var gs=d(fo);Zr=t(gs,"FlaxSpeechEncoderDecoderModel"),gs.forEach(o),Kr=t(Ge,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one
