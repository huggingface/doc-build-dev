...
`}}),{c(){n=a("p"),g=i("Example:"),c=u(),v(p.$$.fragment)},l(s){n=r(s,"P",{});var m=l(n);g=d(m,"Example:"),m.forEach(t),c=f(s),$(p.$$.fragment,s)},m(s,m){k(s,n,m),e(n,g),k(s,c,m),w(p,s,m),b=!0},p:ee,i(s){b||(y(p.$$.fragment,s),b=!0)},o(s){T(p.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(p,s)}}}function Il(F){let n,g;return n=new oe({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,p){w(n,c,p),g=!0},p:ee,i(c){g||(y(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function Ll(F){let n,g,c,p,b,s,m,C,te,O,H,R,Xo,De,ws,Zo,ys,Ut,fe,Ts,We,Bs,Fs,Vt,M,et,He,Cs,zs,ot,Ue,qs,xs,tt,Ve,Ms,Es,st,Re,js,Ps,nt,Ge,Ss,As,Mo,Ye,Is,Ls,Rt,se,ge,at,Je,Ns,rt,Os,Gt,D,Ke,Ds,ne,Ws,Eo,Hs,Us,Qe,Vs,Rs,Gs,ae,Ys,jo,Js,Ks,Po,Qs,Xs,Zs,_e,Yt,re,be,lt,Xe,en,it,on,Jt,E,Ze,tn,dt,sn,nn,eo,an,So,rn,ln,dn,oo,cn,to,pn,mn,hn,U,so,un,le,fn,Ao,gn,_n,ct,bn,kn,vn,ke,$n,ve,Kt,ie,$e,pt,no,wn,mt,yn,Qt,z,ao,Tn,ro,Bn,ht,Fn,Cn,zn,ut,qn,xn,we,Mn,lo,En,ft,jn,Pn,Sn,ye,An,io,In,Io,Ln,Nn,Xt,de,Te,gt,co,On,_t,Dn,Zt,j,po,Wn,bt,Hn,Un,mo,Vn,Lo,Rn,Gn,Yn,ho,Jn,uo,Kn,Qn,Xn,V,fo,Zn,ce,ea,No,oa,ta,kt,sa,na,aa,Be,ra,Fe,es,pe,Ce,vt,go,la,$t,ia,os,q,_o,da,wt,ca,pa,Oo,Do,ma,ha,ua,W,fa,yt,ga,_a,Tt,ba,ka,Bt,va,$a,Ft,wa,ya,Ta,bo,Ba,Wo,Fa,Ca,za,ko,qa,vo,xa,Ma,Ea,x,$o,ja,me,Pa,Ho,Sa,Aa,Ct,Ia,La,Na,ze,Oa,qe,Da,xe,Wa,Me,Ha,Ee,ts,he,je,zt,wo,Ua,qt,Va,ss,P,yo,Ra,xt,Ga,Ya,To,Ja,Uo,Ka,Qa,Xa,Bo,Za,Fo,er,or,tr,A,Co,sr,ue,nr,Vo,ar,rr,Mt,lr,ir,dr,Pe,cr,Se,pr,Ae,ns;return s=new Oe({}),De=new Oe({}),Je=new Oe({}),Ke=new X({props:{name:"class transformers.BloomConfig",anchor:"transformers.BloomConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 64"},{name:"n_layer",val:" = 2"},{name:"n_head",val:" = 8"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"use_cache",val:" = False"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"apply_residual_connection_post_layernorm",val:" = False"},{name:"hidden_dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"pretraining_tp",val:" = 1"},{name:"slow_but_exact",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BloomConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
Vocabulary size of the Bloom model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomModel">BloomModel</a>.`,name:"vocab_size"},{anchor:"transformers.BloomConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
resolved in the future once the main model has been fine-tuned with TP_rank=1.`,name:"slow_but_exact"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/configuration_bloom.py#L42"}}),_e=new Z({props:{anchor:"transformers.BloomConfig.example",$$slots:{default:[yl]},$$scope:{ctx:F}}}),Xe=new Oe({}),Ze=new X({props:{name:"class transformers.BloomModel",anchor:"transformers.BloomModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L559"}}),so=new X({props:{name:"forward",anchor:"transformers.BloomModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomTokenizerFast">BloomTokenizerFast</a>. See <a href="/docs/transformers/pr_18141/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomConfig"
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/tokenization_bloom_fast.py#L49"}}),we=new Z({props:{anchor:"transformers.BloomTokenizerFast.example",$$slots:{default:[Fl]},$$scope:{ctx:F}}}),ye=new Ht({props:{$$slots:{default:[Cl]},$$scope:{ctx:F}}}),co=new Oe({}),po=new X({props:{name:"class transformers.BloomForCausalLM",anchor:"transformers.BloomForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L752"}}),fo=new X({props:{name:"forward",anchor:"transformers.BloomForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L783",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L875"}}),$o=new X({props:{name:"forward",anchor:"transformers.BloomForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L887",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L994"}}),Co=new X({props:{name:"forward",anchor:"transformers.BloomForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L1014",returnDescription:`
<p>A <a
...
the model was not pretrained this way, it might yield a decrease in performance.`),Sn=u(),v(ye.$$.fragment),An=u(),io=a("p"),In=i("This tokenizer inherits from "),Io=a("a"),Ln=i("PreTrainedTokenizerFast"),Nn=i(` which contains most of the main methods. Users should
...
embeddings).`),Un=u(),mo=a("p"),Vn=i("This model inherits from "),Lo=a("a"),Rn=i("PreTrainedModel"),Gn=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=u(),x=a("div"),v($o.$$.fragment),ja=u(),me=a("p"),Pa=i("The "),Ho=a("a"),Sa=i("BloomForSequenceClassification"),Aa=i(" forward method, overrides the "),Ct=a("code"),Ia=i("__call__"),La=i(" special method."),Na=u(),v(ze.$$.fragment),Oa=u(),v(qe.$$.fragment),Da=u(),v(xe.$$.fragment),Wa=u(),v(Me.$$.fragment),Ha=u(),v(Ee.$$.fragment),ts=u(),he=a("h2"),je=a("a"),zt=a("span"),v(wo.$$.fragment),Ua=u(),qt=a("span"),Va=i("BloomForTokenClassification"),ss=u(),P=a("div"),v(yo.$$.fragment),Ra=u(),xt=a("p"),Ga=i(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tr=u(),A=a("div"),v(Co.$$.fragment),sr=u(),ue=a("p"),nr=i("The "),Vo=a("a"),ar=i("BloomForTokenClassification"),rr=i(" forward method, overrides the "),Mt=a("code"),lr=i("__call__"),ir=i(" special method."),dr=u(),v(Pe.$$.fragment),cr=u(),v(Se.$$.fragment),pr=u(),v(Ae.$$.fragment),this.h()},l(o){const _=$l('[data-svelte="svelte-1phssyn"]',document.head);n=r(_,"META",{name:!0,content:!0}),_.forEach(t),g=f(o),c=r(o,"H1",{class:!0});var zo=l(c);p=r(zo,"A",{id:!0,class:!0,href:!0});var Et=l(p);b=r(Et,"SPAN",{});var jt=l(b);$(s.$$.fragment,jt),jt.forEach(t),Et.forEach(t),m=f(zo),C=r(zo,"SPAN",{});var Pt=l(C);te=d(Pt,"BLOOM"),Pt.forEach(t),zo.forEach(t),O=f(o),H=r(o,"H2",{class:!0});var qo=l(H);R=r(qo,"A",{id:!0,class:!0,href:!0});var St=l(R);Xo=r(St,"SPAN",{});var At=l(Xo);$(De.$$.fragment,At),At.forEach(t),St.forEach(t),ws=f(qo),Zo=r(qo,"SPAN",{});var It=l(Zo);ys=d(It,"Overview"),It.forEach(t),qo.forEach(t),Ut=f(o),fe=r(o,"P",{});var xo=l(fe);Ts=d(xo,"The BLOOM model has been proposed with its various versions through the "),We=r(xo,"A",{href:!0,rel:!0});var Lt=l(We);Bs=d(Lt,"BigScience Workshop"),Lt.forEach(t),Fs=d(xo,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of BLOOM is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),xo.forEach(t),Vt=f(o),M=r(o,"UL",{});var S=l(M);et=r(S,"LI",{});var Nt=l(et);He=r(Nt,"A",{href:!0,rel:!0});var Ot=l(He);Cs=d(Ot,"bloom-350m"),Ot.forEach(t),Nt.forEach(t),zs=f(S),ot=r(S,"LI",{});var Dt=l(ot);Ue=r(Dt,"A",{href:!0,rel:!0});var Wt=l(Ue);qs=d(Wt,"bloom-760m"),Wt.forEach(t),Dt.forEach(t),xs=f(S),tt=r(S,"LI",{});var ur=l(tt);Ve=r(ur,"A",{href:!0,rel:!0});var fr=l(Ve);Ms=d(fr,"bloom-1b3"),fr.forEach(t),ur.forEach(t),Es=f(S),st=r(S,"LI",{});var gr=l(st);Re=r(gr,"A",{href:!0,rel:!0});var _r=l(Re);js=d(_r,"bloom-2b5"),_r.forEach(t),gr.forEach(t),Ps=f(S),nt=r(S,"LI",{});var br=l(nt);Ge=r(br,"A",{href:!0,rel:!0});var kr=l(Ge);Ss=d(kr,"bloom-6b3"),kr.forEach(t),br.forEach(t),As=f(S),Mo=r(S,"LI",{});var mr=l(Mo);Ye=r(mr,"A",{href:!0,rel:!0});var vr=l(Ye);Is=d(vr,"bloom"),vr.forEach(t),Ls=d(mr," (175B parameters)"),mr.forEach(t),S.forEach(t),Rt=f(o),se=r(o,"H2",{class:!0});var as=l(se);ge=r(as,"A",{id:!0,class:!0,href:!0});var $r=l(ge);at=r($r,"SPAN",{});var wr=l(at);$(Je.$$.fragment,wr),wr.forEach(t),$r.forEach(t),Ns=f(as),rt=r(as,"SPAN",{});var yr=l(rt);Os=d(yr,"BloomConfig"),yr.forEach(t),as.forEach(t),Gt=f(o),D=r(o,"DIV",{class:!0});var Ie=l(D);$(Ke.$$.fragment,Ie),Ds=f(Ie),ne=r(Ie,"P",{});var Ro=l(ne);Ws=d(Ro,"This is the configuration class to store the configuration of a "),Eo=r(Ro,"A",{href:!0});var Tr=l(Eo);Hs=d(Tr,"BloomModel"),Tr.forEach(t),Us=d(Ro,`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),is.forEach(t),hn=f(G),U=r(G,"DIV",{class:!0});var Le=l(U);$(so.$$.fragment,Le),un=f(Le),le=r(Le,"P",{});var Yo=l(le);fn=d(Yo,"The "),Ao=r(Yo,"A",{href:!0});var Pr=l(Ao);gn=d(Pr,"BloomModel"),Pr.forEach(t),_n=d(Yo," forward method, overrides the "),ct=r(Yo,"CODE",{});var Sr=l(ct);bn=d(Sr,"__call__"),Sr.forEach(t),kn=d(Yo," special method."),Yo.forEach(t),vn=f(Le),$(ke.$$.fragment,Le),$n=f(Le),$(ve.$$.fragment,Le),Le.forEach(t),G.forEach(t),Kt=f(o),ie=r(o,"H2",{class:!0});var ds=l(ie);$e=r(ds,"A",{id:!0,class:!0,href:!0});var Ar=l($e);pt=r(Ar,"SPAN",{});var Ir=l(pt);$(no.$$.fragment,Ir),Ir.forEach(t),Ar.forEach(t),wn=f(ds),mt=r(ds,"SPAN",{});var Lr=l(mt);yn=d(Lr,"BloomTokenizerFast"),Lr.forEach(t),ds.forEach(t),Qt=f(o),z=r(o,"DIV",{class:!0});var I=l(z);$(ao.$$.fragment,I),Tn=f(I),ro=r(I,"P",{});var cs=l(ro);Bn=d(cs,"Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ht=r(cs,"EM",{});var Nr=l(ht);Fn=d(Nr,"tokenizers"),Nr.forEach(t),Cn=d(cs,` library). Based on byte-level
Byte-Pair-Encoding.`),cs.forEach(t),zn=f(I),ut=r(I,"P",{});var Or=l(ut);qn=d(Or,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Or.forEach(t),xn=f(I),$(we.$$.fragment,I),Mn=f(I),lo=r(I,"P",{});var ps=l(lo);En=d(ps,"You can get around that behavior by passing "),ft=r(ps,"CODE",{});var Dr=l(ft);jn=d(Dr,"add_prefix_space=True"),Dr.forEach(t),Pn=d(ps,` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),ps.forEach(t),Sn=f(I),$(ye.$$.fragment,I),An=f(I),io=r(I,"P",{});var ms=l(io);In=d(ms,"This tokenizer inherits from "),Io=r(ms,"A",{href:!0});var Wr=l(Io);Ln=d(Wr,"PreTrainedTokenizerFast"),Wr.forEach(t),Nn=d(ms,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ms.forEach(t),I.forEach(t),Xt=f(o),de=r(o,"H2",{class:!0});var hs=l(de);Te=r(hs,"A",{id:!0,class:!0,href:!0});var Hr=l(Te);gt=r(Hr,"SPAN",{});var Ur=l(gt);$(co.$$.fragment,Ur),Ur.forEach(t),Hr.forEach(t),On=f(hs),_t=r(hs,"SPAN",{});var Vr=l(_t);Dn=d(Vr,"BloomForCausalLM"),Vr.forEach(t),hs.forEach(t),Zt=f(o),j=r(o,"DIV",{class:!0});var Y=l(j);$(po.$$.fragment,Y),Wn=f(Y),bt=r(Y,"P",{});var Rr=l(bt);Hn=d(Rr,`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Rr.forEach(t),Un=f(Y),mo=r(Y,"P",{});var us=l(mo);Vn=d(us,"This model inherits from "),Lo=r(us,"A",{href:!0});var Gr=l(Lo);Rn=d(Gr,"PreTrainedModel"),Gr.forEach(t),Gn=d(us,`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fs.forEach(t),Xn=f(Y),V=r(Y,"DIV",{class:!0});var Ne=l(V);$(fo.$$.fragment,Ne),Zn=f(Ne),ce=r(Ne,"P",{});var Jo=l(ce);ea=d(Jo,"The "),No=r(Jo,"A",{href:!0});var Jr=l(No);oa=d(Jr,"BloomForCausalLM"),Jr.forEach(t),ta=d(Jo," forward method, overrides the "),kt=r(Jo,"CODE",{});var Kr=l(kt);sa=d(Kr,"__call__"),Kr.forEach(t),na=d(Jo," special method."),Jo.forEach(t),aa=f(Ne),$(Be.$$.fragment,Ne),ra=f(Ne),$(Fe.$$.fragment,Ne),Ne.forEach(t),Y.forEach(t),es=f(o),pe=r(o,"H2",{class:!0});var gs=l(pe);Ce=r(gs,"A",{id:!0,class:!0,href:!0});var Qr=l(Ce);vt=r(Qr,"SPAN",{});var Xr=l(vt);$(go.$$.fragment,Xr),Xr.forEach(t),Qr.forEach(t),la=f(gs),$t=r(gs,"SPAN",{});var Zr=l($t);ia=d(Zr,"BloomForSequenceClassification"),Zr.forEach(t),gs.forEach(t),os=f(o),q=r(o,"DIV",{class:!0});var L=l(q);$(_o.$$.fragment,L),da=f(L),wt=r(L,"P",{});var el=l(wt);ca=d(el,"The Bloom Model transformer with a sequence classification head on top (linear layer)."),el.forEach(t),pa=f(L),Oo=r(L,"P",{});var hr=l(Oo);Do=r(hr,"A",{href:!0});var ol=l(Do);ma=d(ol,"BloomForSequenceClassification"),ol.forEach(t),ha=d(hr,` uses the last token in order to do the classification, as other causal models
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),_s.forEach(t),za=f(L),ko=r(L,"P",{});var bs=l(ko);qa=d(bs,"This model is also a PyTorch "),vo=r(bs,"A",{href:!0,rel:!0});var ll=l(vo);xa=d(ll,"torch.nn.Module"),ll.forEach(t),Ma=d(bs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bs.forEach(t),Ea=f(L),x=r(L,"DIV",{class:!0});var N=l(x);$($o.$$.fragment,N),ja=f(N),me=r(N,"P",{});var Ko=l(me);Pa=d(Ko,"The "),Ho=r(Ko,"A",{href:!0});var il=l(Ho);Sa=d(il,"BloomForSequenceClassification"),il.forEach(t),Aa=d(Ko," forward method, overrides the "),Ct=r(Ko,"CODE",{});var dl=l(Ct);Ia=d(dl,"__call__"),dl.forEach(t),La=d(Ko," special method."),Ko.forEach(t),Na=f(N),$(ze.$$.fragment,N),Oa=f(N),$(qe.$$.fragment,N),Da=f(N),$(xe.$$.fragment,N),Wa=f(N),$(Me.$$.fragment,N),Ha=f(N),$(Ee.$$.fragment,N),N.forEach(t),L.forEach(t),ts=f(o),he=r(o,"H2",{class:!0});var ks=l(he);je=r(ks,"A",{id:!0,class:!0,href:!0});var cl=l(je);zt=r(cl,"SPAN",{});var pl=l(zt);$(wo.$$.fragment,pl),pl.forEach(t),cl.forEach(t),Ua=f(ks),qt=r(ks,"SPAN",{});var ml=l(qt);Va=d(ml,"BloomForTokenClassification"),ml.forEach(t),ks.forEach(t),ss=f(o),P=r(o,"DIV",{class:!0});var K=l(P);$(yo.$$.fragment,K),Ra=f(K),xt=r(K,"P",{});var hl=l(xt);Ga=d(hl,`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
