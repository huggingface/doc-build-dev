import{S as R_,i as H_,s as K_,e as n,k as l,w as b,t as r,M as V_,c as s,d as t,m as c,a,x as y,h as i,b as p,G as e,g as f,y as T,q as w,o as P,B as $,v as Q_,L as Qe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Uo}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Se}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Z}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ve}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function J_(z){let u,v,_,h,k;return h=new Se({props:{code:`from transformers import PegasusModel, PegasusConfig
...
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=l(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
`),de=s(X,"CODE",{});var dt=a(de);ze=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),te=i(X," or "),V=s(X,"CODE",{});var Xe=a(V);Ue=i(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),X.forEach(t),Be=c(G),B=s(G,"LI",{});var H=a(B);We=i(H,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(H,"CODE",{});var lt=a(oe);R=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),H.forEach(t),G.forEach(t)},m(x,q){f(x,u,q),e(u,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,K,q),f(x,S,q),e(S,O),e(O,Ge),e(O,Y),e(Y,ee),e(O,Le),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,V),e(V,Ue),e(S,Be),e(S,B),e(B,We),e(B,oe),e(oe,R)},d(x){x&&t(u),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(K),x&&t(S)}}}function nk(z){let u,v,_,h,k;return{c(){u=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,u,m),e(u,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(h,d)}}}function ak(z){let u,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,K,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R;return{c(){u=n("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),ve=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),S=n("ul"),O=n("li"),Ge=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Le=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=l(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),R=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){u=s(x,"P",{});var q=a(u);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var be=a(h);k=s(be,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(be),F=s(be,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){u=s(d,"P",{});var m=a(u);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,u,m),e(u,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(h,d)}}}function fk(z){let u,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,K,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R,x,q,be,at,ye,Q,rt,Je,le,G,J,Te,it,X,dt,Xe,H,lt,Bo,Zd,Yd,la,el,tl,zi,fe,ca,ol,nl,pa,sl,al,ua,rl,il,Wo,dl,Ro,ll,cl,pl,At,Ho,ul,hl,Ko,ml,fl,Fi,ct,It,ha,Vo,gl,ma,_l,qi,Ze,Gt,Qo,kl,vl,Jo,bl,yl,Tl,fa,wl,Pl,ga,$l,Ei,pt,Lt,_a,Xo,xl,ka,zl,Mi,ge,va,ba,Fl,ql,ya,Es,El,Ms,Ml,Cl,Zo,Ta,jl,Sl,ut,wa,Ol,Al,Pa,Il,Gl,Yo,Ll,$a,Nl,Dl,Ul,xa,Re,Bl,za,Wl,Rl,Fa,Hl,Kl,qa,Vl,Ql,Jl,Ea,ht,Xl,en,Zl,Yl,Ma,ec,tc,Ci,mt,Nt,Ca,tn,oc,ja,nc,ji,on,Si,ft,Dt,Sa,nn,sc,Oa,ac,Oi,we,sn,rc,gt,ic,Cs,dc,lc,an,cc,pc,uc,_t,hc,js,mc,fc,Ss,gc,_c,kc,Ut,Ai,kt,Bt,Aa,rn,vc,Ia,bc,Ii,Wt,yc,Ga,Tc,wc,Gi,W,dn,Pc,ln,$c,cn,xc,zc,Fc,pn,qc,Os,Ec,Mc,Cc,Fe,un,jc,hn,Sc,La,Oc,Ac,Ic,mn,As,Gc,Na,Lc,Nc,fn,Dc,Da,Uc,Bc,Wc,Ua,Rc,Hc,Rt,gn,Kc,Ba,Vc,Qc,Ht,_n,Jc,Wa,Xc,Zc,Kt,kn,Yc,Ra,ep,Li,vt,Vt,Ha,vn,tp,Ka,op,Ni,ce,bn,np,bt,sp,Va,ap,rp,yn,ip,dp,lp,Tn,cp,Is,pp,up,hp,Ye,wn,mp,Qa,fp,gp,Pn,Gs,_p,Ja,kp,vp,$n,bp,Xa,yp,Tp,wp,Qt,xn,Pp,Za,$p,Di,yt,Jt,Ya,zn,xp,er,zp,Ui,Pe,Fn,Fp,qn,qp,Ls,Ep,Mp,Cp,En,jp,Mn,Sp,Op,Ap,qe,Cn,Ip,Tt,Gp,Ns,Lp,Np,tr,Dp,Up,Bp,Xt,Wp,Zt,Bi,wt,Yt,or,jn,Rp,nr,Hp,Wi,$e,Sn,Kp,On,Vp,Ds,Qp,Jp,Xp,An,Zp,In,Yp,eu,tu,Ee,Gn,ou,Pt,nu,Us,su,au,sr,ru,iu,du,eo,lu,to,Ri,$t,oo,ar,Ln,cu,rr,pu,Hi,xt,Nn,uu,no,Dn,hu,so,Ki,zt,ao,ir,Un,mu,dr,fu,Vi,pe,Bn,gu,Wn,_u,Bs,ku,vu,bu,Rn,yu,Hn,Tu,wu,Pu,ro,$u,Me,Kn,xu,Ft,zu,Ws,Fu,qu,lr,Eu,Mu,Cu,io,ju,lo,Qi,qt,co,cr,Vn,Su,pr,Ou,Ji,ue,Qn,Au,Jn,Iu,Rs,Gu,Lu,Nu,Xn,Du,Zn,Uu,Bu,Wu,po,Ru,Ce,Yn,Hu,Et,Ku,Hs,Vu,Qu,ur,Ju,Xu,Zu,uo,Yu,ho,Xi,Mt,mo,hr,es,eh,mr,th,Zi,L,ts,oh,os,nh,Ks,sh,ah,rh,ns,ih,ss,dh,lh,ch,fr,ph,uh,He,gr,as,hh,mh,_r,rs,fh,gh,kr,is,_h,kh,vr,ds,vh,bh,je,ls,yh,Ct,Th,br,wh,Ph,yr,$h,xh,zh,fo,Fh,go,qh,_o,cs,Eh,ko,Mh,vo,ps,Ch,bo,Yi,jt,yo,Tr,us,jh,wr,Sh,ed,N,hs,Oh,ms,Ah,Vs,Ih,Gh,Lh,fs,Nh,gs,Dh,Uh,Bh,Pr,Wh,Rh,Ke,$r,_s,Hh,Kh,xr,ks,Vh,Qh,zr,vs,Jh,Xh,Fr,bs,Zh,Yh,M,ys,em,St,tm,qr,om,nm,Er,sm,am,rm,To,im,Mr,dm,lm,Cr,jr,Sr,Or,cm,pm,Ar,Ir,Gr,Lr,um,hm,Nr,Dr,Ur,Br,mm,fm,Wr,Rr,Ts,wo,Po,Hr,ws,gm,Kr,_m,km,Vr,vm,bm,Qr,ym,Tm,Jr,Xr,Zr,Yr,wm,Pm,ei,ti,oi,ni,$m,xm,si,ai,ri,ii,zm,Fm,di,li,ci,pi,qm,Em,$o,Ps,Mm,xo,Cm,zo,$s,jm,Fo,td;return d=new Z({}),K=new Z({}),Te=new Z({}),Vo=new Z({}),Xo=new Z({}),tn=new Z({}),on=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/tokenization_pegasus.py#L258",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_pegasus.py#L1190",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17447/en/model_doc/pegasus#transformers.PegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_pegasus.py#L1357",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_pegasus.py#L1549",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1208",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17447/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1285"}}),po=new Uo({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),Yn=new C({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17447/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_17447/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17447/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1318",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
`}}),bo=new Ve({props:{anchor:"transformers.FlaxPegasusModel.decode.example",$$slots:{default:[pk]},$$scope:{ctx:z}}}),us=new Z({}),hs=new C({props:{name:"class transformers.FlaxPegasusForConditionalGeneration",anchor:"transformers.FlaxPegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17447/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17447/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17447/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
...
extractive summary.`),Be=l(),B=n("li"),We=r("Pegasus achieves SOTA summarization performance on all 12 downstream tasks, as measured by ROUGE and human eval."),oe=l(),R=n("p"),x=r("This model was contributed by "),q=n("a"),be=r("sshleifer"),at=r(". The Authors\u2019 code can be found "),ye=n("a"),Q=r("here"),rt=r("."),Je=l(),le=n("h2"),G=n("a"),J=n("span"),b(Te.$$.fragment),it=l(),X=n("span"),dt=r("Checkpoints"),Xe=l(),H=n("p"),lt=r("All the "),Bo=n("a"),Zd=r("checkpoints"),Yd=r(` are fine-tuned for summarization, besides
`),la=n("em"),el=r("pegasus-large"),tl=r(", whence the other checkpoints are fine-tuned:"),zi=l(),fe=n("ul"),ca=n("li"),ol=r("Each checkpoint is 2.2 GB on disk and 568M parameters."),nl=l(),pa=n("li"),sl=r("FP16 is not supported (help/ideas on this appreciated!)."),al=l(),ua=n("li"),rl=r("Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),il=l(),Wo=n("li"),dl=r("Full replication results and correctly pre-processed data can be found in this "),Ro=n("a"),ll=r("Issue"),cl=r("."),pl=l(),At=n("li"),Ho=n("a"),ul=r("Distilled checkpoints"),hl=r(" are described in this "),Ko=n("a"),ml=r("paper"),fl=r("."),Fi=l(),ct=n("h3"),It=n("a"),ha=n("span"),b(Vo.$$.fragment),gl=l(),ma=n("span"),_l=r("Examples"),qi=l(),Ze=n("ul"),Gt=n("li"),Qo=n("a"),kl=r("Script"),vl=r(` to fine-tune pegasus
on the XSUM dataset. Data download instructions at `),Jo=n("a"),bl=r("examples/pytorch/summarization/"),yl=r("."),Tl=l(),fa=n("li"),wl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=l(),ga=n("li"),$l=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Ei=l(),pt=n("h2"),Lt=n("a"),_a=n("span"),b(Xo.$$.fragment),xl=l(),ka=n("span"),zl=r("Implementation Notes"),Mi=l(),ge=n("ul"),va=n("li"),ba=n("p"),Fl=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=l(),ya=n("li"),Es=n("p"),El=r("The implementation is completely inherited from "),Ms=n("a"),Ml=r("BartForConditionalGeneration"),Cl=l(),Zo=n("li"),Ta=n("p"),jl=r("Some key configuration differences:"),Sl=l(),ut=n("ul"),wa=n("li"),Ol=r("static, sinusoidal position embeddings"),Al=l(),Pa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Gl=l(),Yo=n("li"),Ll=r("more beams are used ("),$a=n("code"),Nl=r("num_beams=8"),Dl=r(")"),Ul=l(),xa=n("li"),Re=n("p"),Bl=r("All pretrained pegasus checkpoints are the same besides three attributes: "),za=n("code"),Wl=r("tokenizer.model_max_length"),Rl=r(` (maximum
...
and adding special tokens. A PEGASUS sequence has the following format, where `),La=n("code"),Oc=r("X"),Ac=r(" represents the sequence:"),Ic=l(),mn=n("ul"),As=n("li"),Gc=r("single sequence: "),Na=n("code"),Lc=r("X </s>"),Nc=l(),fn=n("li"),Dc=r("pair of sequences: "),Da=n("code"),Uc=r("A B </s>"),Bc=r(" (not intended use)"),Wc=l(),Ua=n("p"),Rc=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Hc=l(),Rt=n("div"),b(gn.$$.fragment),Kc=l(),Ba=n("p"),Vc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),Ht=n("div"),b(_n.$$.fragment),Jc=l(),Wa=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),Kt=n("div"),b(kn.$$.fragment),Yc=l(),Ra=n("p"),ep=r("Just EOS"),Li=l(),vt=n("h2"),Vt=n("a"),Ha=n("span"),b(vn.$$.fragment),tp=l(),Ka=n("span"),op=r("PegasusTokenizerFast"),Ni=l(),ce=n("div"),b(bn.$$.fragment),np=l(),bt=n("p"),sp=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Va=n("em"),ap=r("tokenizers"),rp=r(` library). Based on
...
and behavior.`),Ap=l(),qe=n("div"),b(Cn.$$.fragment),Ip=l(),Tt=n("p"),Gp=r("The "),Ns=n("a"),Lp=r("PegasusModel"),Np=r(" forward method, overrides the "),tr=n("code"),Dp=r("__call__"),Up=r(" special method."),Bp=l(),b(Xt.$$.fragment),Wp=l(),b(Zt.$$.fragment),Bi=l(),wt=n("h2"),Yt=n("a"),or=n("span"),b(jn.$$.fragment),Rp=l(),nr=n("span"),Hp=r("PegasusForConditionalGeneration"),Wi=l(),$e=n("div"),b(Sn.$$.fragment),Kp=l(),On=n("p"),Vp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tu=l(),Ee=n("div"),b(Gn.$$.fragment),ou=l(),Pt=n("p"),nu=r("The "),Us=n("a"),su=r("PegasusForConditionalGeneration"),au=r(" forward method, overrides the "),sr=n("code"),ru=r("__call__"),iu=r(" special method."),du=l(),b(eo.$$.fragment),lu=l(),b(to.$$.fragment),Ri=l(),$t=n("h2"),oo=n("a"),ar=n("span"),b(Ln.$$.fragment),cu=l(),rr=n("span"),pu=r("PegasusForCausalLM"),Hi=l(),xt=n("div"),b(Nn.$$.fragment),uu=l(),no=n("div"),b(Dn.$$.fragment),hu=l(),b(so.$$.fragment),Ki=l(),zt=n("h2"),ao=n("a"),ir=n("span"),b(Un.$$.fragment),mu=l(),dr=n("span"),fu=r("TFPegasusModel"),Vi=l(),pe=n("div"),b(Bn.$$.fragment),gu=l(),Wn=n("p"),_u=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Bs=n("a"),ku=r("TFPreTrainedModel"),vu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bu=l(),Rn=n("p"),yu=r("This model is also a "),Hn=n("a"),Tu=r("tf.keras.Model"),wu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pu=l(),b(ro.$$.fragment),$u=l(),Me=n("div"),b(Kn.$$.fragment),xu=l(),Ft=n("p"),zu=r("The "),Ws=n("a"),Fu=r("TFPegasusModel"),qu=r(" forward method, overrides the "),lr=n("code"),Eu=r("__call__"),Mu=r(" special method."),Cu=l(),b(io.$$.fragment),ju=l(),b(lo.$$.fragment),Qi=l(),qt=n("h2"),co=n("a"),cr=n("span"),b(Vn.$$.fragment),Su=l(),pr=n("span"),Ou=r("TFPegasusForConditionalGeneration"),Ji=l(),ue=n("div"),b(Qn.$$.fragment),Au=l(),Jn=n("p"),Iu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rs=n("a"),Gu=r("TFPreTrainedModel"),Lu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu=l(),Xn=n("p"),Du=r("This model is also a "),Zn=n("a"),Uu=r("tf.keras.Model"),Bu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wu=l(),b(po.$$.fragment),Ru=l(),Ce=n("div"),b(Yn.$$.fragment),Hu=l(),Et=n("p"),Ku=r("The "),Hs=n("a"),Vu=r("TFPegasusForConditionalGeneration"),Qu=r(" forward method, overrides the "),ur=n("code"),Ju=r("__call__"),Xu=r(" special method."),Zu=l(),b(uo.$$.fragment),Yu=l(),b(ho.$$.fragment),Xi=l(),Mt=n("h2"),mo=n("a"),hr=n("span"),b(es.$$.fragment),eh=l(),mr=n("span"),th=r("FlaxPegasusModel"),Zi=l(),L=n("div"),b(ts.$$.fragment),oh=l(),os=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bh=l(),Pr=n("p"),Wh=r("Finally, this model supports inherent JAX features such as:"),Rh=l(),Ke=n("ul"),$r=n("li"),_s=n("a"),Hh=r("Just-In-Time (JIT) compilation"),Kh=l(),xr=n("li"),ks=n("a"),Vh=r("Automatic Differentiation"),Qh=l(),zr=n("li"),vs=n("a"),Jh=r("Vectorization"),Xh=l(),Fr=n("li"),bs=n("a"),Zh=r("Parallelization"),Yh=l(),M=n("div"),b(ys.$$.fragment),em=l(),St=n("p"),tm=r("The "),qr=n("code"),om=r("FlaxPegasusPreTrainedModel"),nm=r(" forward method, overrides the "),Er=n("code"),sm=r("__call__"),am=r(" special method."),rm=l(),b(To.$$.fragment),im=l(),Mr=n("p"),dm=r("Summarization example:"),lm=l(),Cr=n("blockquote"),jr=n("blockquote"),Sr=n("blockquote"),Or=n("p"),cm=r("from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),pm=l(),Ar=n("blockquote"),Ir=n("blockquote"),Gr=n("blockquote"),Lr=n("p"),um=r(`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019)`),hm=l(),Nr=n("blockquote"),Dr=n("blockquote"),Ur=n("blockquote"),Br=n("p"),mm=r(`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),Wr=n("blockquote"),Rr=n("blockquote"),Ts=n("blockquote"),wo=n("h1"),Po=n("a"),Hr=n("span"),b(ws.$$.fragment),gm=l(),Kr=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),Vr=n("p"),vm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),bm=l(),Qr=n("p"),ym=r("Mask filling example:"),Tm=l(),Jr=n("blockquote"),Xr=n("blockquote"),Zr=n("blockquote"),Yr=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
documentation from `),Ss=s(ea,"A",{href:!0});var Ef=a(Ss);gc=i(Ef,"PretrainedConfig"),Ef.forEach(t),_c=i(ea," for more information."),ea.forEach(t),kc=c(Mo),y(Ut.$$.fragment,Mo),Mo.forEach(t),Ai=c(o),kt=s(o,"H2",{class:!0});var cd=a(kt);Bt=s(cd,"A",{id:!0,class:!0,href:!0});var Mf=a(Bt);Aa=s(Mf,"SPAN",{});var Cf=a(Aa);y(rn.$$.fragment,Cf),Cf.forEach(t),Mf.forEach(t),vc=c(cd),Ia=s(cd,"SPAN",{});var jf=a(Ia);bc=i(jf,"PegasusTokenizer"),jf.forEach(t),cd.forEach(t),Ii=c(o),Wt=s(o,"P",{});var pd=a(Wt);yc=i(pd,"warning: "),Ga=s(pd,"CODE",{});var Sf=a(Ga);Tc=i(Sf,"add_tokens"),Sf.forEach(t),wc=i(pd," does not work at the moment."),pd.forEach(t),Gi=c(o),W=s(o,"DIV",{class:!0});var _e=a(W);y(dn.$$.fragment,_e),Pc=c(_e),ln=s(_e,"P",{});var ud=a(ln);$c=i(ud,"Construct a PEGASUS tokenizer. Based on "),cn=s(ud,"A",{href:!0,rel:!0});var Of=a(cn);xc=i(Of,"SentencePiece"),Of.forEach(t),zc=i(ud,"."),ud.forEach(t),Fc=c(_e),pn=s(_e,"P",{});var hd=a(pn);qc=i(hd,"This tokenizer inherits from "),Os=s(hd,"A",{href:!0});var Af=a(Os);Ec=i(Af,"PreTrainedTokenizer"),Af.forEach(t),Mc=i(hd,` which contains most of the main methods. Users should refer to
...
and adding special tokens. A PEGASUS sequence has the following format, where `),La=s(md,"CODE",{});var If=a(La);Oc=i(If,"X"),If.forEach(t),Ac=i(md," represents the sequence:"),md.forEach(t),Ic=c(Co),mn=s(Co,"UL",{});var fd=a(mn);As=s(fd,"LI",{});var Om=a(As);Gc=i(Om,"single sequence: "),Na=s(Om,"CODE",{});var Gf=a(Na);Lc=i(Gf,"X </s>"),Gf.forEach(t),Om.forEach(t),Nc=c(fd),fn=s(fd,"LI",{});var gd=a(fn);Dc=i(gd,"pair of sequences: "),Da=s(gd,"CODE",{});var Lf=a(Da);Uc=i(Lf,"A B </s>"),Lf.forEach(t),Bc=i(gd," (not intended use)"),gd.forEach(t),fd.forEach(t),Wc=c(Co),Ua=s(Co,"P",{});var Nf=a(Ua);Rc=i(Nf,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Nf.forEach(t),Co.forEach(t),Hc=c(_e),Rt=s(_e,"DIV",{class:!0});var _d=a(Rt);y(gn.$$.fragment,_d),Kc=c(_d),Ba=s(_d,"P",{});var Df=a(Ba);Vc=i(Df,"Converts a sequence of tokens (string) in a single string."),Df.forEach(t),_d.forEach(t),Qc=c(_e),Ht=s(_e,"DIV",{class:!0});var kd=a(Ht);y(_n.$$.fragment,kd),Jc=c(kd),Wa=s(kd,"P",{});var Uf=a(Wa);Xc=i(Uf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Uf.forEach(t),kd.forEach(t),Zc=c(_e),Kt=s(_e,"DIV",{class:!0});var vd=a(Kt);y(kn.$$.fragment,vd),Yc=c(vd),Ra=s(vd,"P",{});var Bf=a(Ra);ep=i(Bf,"Just EOS"),Bf.forEach(t),vd.forEach(t),_e.forEach(t),Li=c(o),vt=s(o,"H2",{class:!0});var bd=a(vt);Vt=s(bd,"A",{id:!0,class:!0,href:!0});var Wf=a(Vt);Ha=s(Wf,"SPAN",{});var Rf=a(Ha);y(vn.$$.fragment,Rf),Rf.forEach(t),Wf.forEach(t),tp=c(bd),Ka=s(bd,"SPAN",{});var Hf=a(Ka);op=i(Hf,"PegasusTokenizerFast"),Hf.forEach(t),bd.forEach(t),Ni=c(o),ce=s(o,"DIV",{class:!0});var ot=a(ce);y(bn.$$.fragment,ot),np=c(ot),bt=s(ot,"P",{});var ta=a(bt);sp=i(ta,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Va=s(ta,"EM",{});var Kf=a(Va);ap=i(Kf,"tokenizers"),Kf.forEach(t),rp=i(ta,` library). Based on
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zd.forEach(t),Ap=c(jo),qe=s(jo,"DIV",{class:!0});var So=a(qe);y(Cn.$$.fragment,So),Ip=c(So),Tt=s(So,"P",{});var na=a(Tt);Gp=i(na,"The "),Ns=s(na,"A",{href:!0});var ag=a(Ns);Lp=i(ag,"PegasusModel"),ag.forEach(t),Np=i(na," forward method, overrides the "),tr=s(na,"CODE",{});var rg=a(tr);Dp=i(rg,"__call__"),rg.forEach(t),Up=i(na," special method."),na.forEach(t),Bp=c(So),y(Xt.$$.fragment,So),Wp=c(So),y(Zt.$$.fragment,So),So.forEach(t),jo.forEach(t),Bi=c(o),wt=s(o,"H2",{class:!0});var Fd=a(wt);Yt=s(Fd,"A",{id:!0,class:!0,href:!0});var ig=a(Yt);or=s(ig,"SPAN",{});var dg=a(or);y(jn.$$.fragment,dg),dg.forEach(t),ig.forEach(t),Rp=c(Fd),nr=s(Fd,"SPAN",{});var lg=a(nr);Hp=i(lg,"PegasusForConditionalGeneration"),lg.forEach(t),Fd.forEach(t),Wi=c(o),$e=s(o,"DIV",{class:!0});var Oo=a($e);y(Sn.$$.fragment,Oo),Kp=c(Oo),On=s(Oo,"P",{});var qd=a(On);Vp=i(qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed.forEach(t),tu=c(Oo),Ee=s(Oo,"DIV",{class:!0});var Ao=a(Ee);y(Gn.$$.fragment,Ao),ou=c(Ao),Pt=s(Ao,"P",{});var sa=a(Pt);nu=i(sa,"The "),Us=s(sa,"A",{href:!0});var ug=a(Us);su=i(ug,"PegasusForConditionalGeneration"),ug.forEach(t),au=i(sa," forward method, overrides the "),sr=s(sa,"CODE",{});var hg=a(sr);ru=i(hg,"__call__"),hg.forEach(t),iu=i(sa," special method."),sa.forEach(t),du=c(Ao),y(eo.$$.fragment,Ao),lu=c(Ao),y(to.$$.fragment,Ao),Ao.forEach(t),Oo.forEach(t),Ri=c(o),$t=s(o,"H2",{class:!0});var Md=a($t);oo=s(Md,"A",{id:!0,class:!0,href:!0});var mg=a(oo);ar=s(mg,"SPAN",{});var fg=a(ar);y(Ln.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cu=c(Md),rr=s(Md,"SPAN",{});var gg=a(rr);pu=i(gg,"PegasusForCausalLM"),gg.forEach(t),Md.forEach(t),Hi=c(o),xt=s(o,"DIV",{class:!0});var Cd=a(xt);y(Nn.$$.fragment,Cd),uu=c(Cd),no=s(Cd,"DIV",{class:!0});var jd=a(no);y(Dn.$$.fragment,jd),hu=c(jd),y(so.$$.fragment,jd),jd.forEach(t),Cd.forEach(t),Ki=c(o),zt=s(o,"H2",{class:!0});var Sd=a(zt);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var _g=a(ao);ir=s(_g,"SPAN",{});var kg=a(ir);y(Un.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mu=c(Sd),dr=s(Sd,"SPAN",{});var vg=a(dr);fu=i(vg,"TFPegasusModel"),vg.forEach(t),Sd.forEach(t),Vi=c(o),pe=s(o,"DIV",{class:!0});var nt=a(pe);y(Bn.$$.fragment,nt),gu=c(nt),Wn=s(nt,"P",{});var Od=a(Wn);_u=i(Od,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Bs=s(Od,"A",{href:!0});var bg=a(Bs);ku=i(bg,"TFPreTrainedModel"),bg.forEach(t),vu=i(Od,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ad.forEach(t),Pu=c(nt),y(ro.$$.fragment,nt),$u=c(nt),Me=s(nt,"DIV",{class:!0});var Io=a(Me);y(Kn.$$.fragment,Io),xu=c(Io),Ft=s(Io,"P",{});var aa=a(Ft);zu=i(aa,"The "),Ws=s(aa,"A",{href:!0});var Tg=a(Ws);Fu=i(Tg,"TFPegasusModel"),Tg.forEach(t),qu=i(aa," forward method, overrides the "),lr=s(aa,"CODE",{});var wg=a(lr);Eu=i(wg,"__call__"),wg.forEach(t),Mu=i(aa," special method."),aa.forEach(t),Cu=c(Io),y(io.$$.fragment,Io),ju=c(Io),y(lo.$$.fragment,Io),Io.forEach(t),nt.forEach(t),Qi=c(o),qt=s(o,"H2",{class:!0});var Id=a(qt);co=s(Id,"A",{id:!0,class:!0,href:!0});var Pg=a(co);cr=s(Pg,"SPAN",{});var $g=a(cr);y(Vn.$$.fragment,$g),$g.forEach(t),Pg.forEach(t),Su=c(Id),pr=s(Id,"SPAN",{});var xg=a(pr);Ou=i(xg,"TFPegasusForConditionalGeneration"),xg.forEach(t),Id.forEach(t),Ji=c(o),ue=s(o,"DIV",{class:!0});var st=a(ue);y(Qn.$$.fragment,st),Au=c(st),Jn=s(st,"P",{});var Gd=a(Jn);Iu=i(Gd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rs=s(Gd,"A",{href:!0});var zg=a(Rs);Gu=i(zg,"TFPreTrainedModel"),zg.forEach(t),Lu=i(Gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gd.forEach(t),Nu=c(st),Xn=s(st,"P",{});var Ld=a(Xn);Du=i(Ld,"This model is also a "),Zn=s(Ld,"A",{href:!0,rel:!0});var Fg=a(Zn);Uu=i(Fg,"tf.keras.Model"),Fg.forEach(t),Bu=i(Ld,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ld.forEach(t),Wu=c(st),y(po.$$.fragment,st),Ru=c(st),Ce=s(st,"DIV",{class:!0});var Go=a(Ce);y(Yn.$$.fragment,Go),Hu=c(Go),Et=s(Go,"P",{});var ra=a(Et);Ku=i(ra,"The "),Hs=s(ra,"A",{href:!0});var qg=a(Hs);Vu=i(qg,"TFPegasusForConditionalGeneration"),qg.forEach(t),Qu=i(ra," forward method, overrides the "),ur=s(ra,"CODE",{});var Eg=a(ur);Ju=i(Eg,"__call__"),Eg.forEach(t),Xu=i(ra," special method."),ra.forEach(t),Zu=c(Go),y(uo.$$.fragment,Go),Yu=c(Go),y(ho.$$.fragment,Go),Go.forEach(t),st.forEach(t),Xi=c(o),Mt=s(o,"H2",{class:!0});var Nd=a(Mt);mo=s(Nd,"A",{id:!0,class:!0,href:!0});var Mg=a(mo);hr=s(Mg,"SPAN",{});var Cg=a(hr);y(es.$$.fragment,Cg),Cg.forEach(t),Mg.forEach(t),eh=c(Nd),mr=s(Nd,"SPAN",{});var jg=a(mr);th=i(jg,"FlaxPegasusModel"),jg.forEach(t),Nd.forEach(t),Zi=c(o),L=s(o,"DIV",{class:!0});var ne=a(L);y(ts.$$.fragment,ne),oh=c(ne),os=s(ne,"P",{});var Dd=a(os);nh=i(Dd,`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
