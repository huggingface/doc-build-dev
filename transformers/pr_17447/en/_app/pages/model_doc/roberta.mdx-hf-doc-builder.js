...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17447/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),e4=p(),Ih=n("p"),t4=r("Finally, this model supports inherent JAX features such as:"),o4=p(),Kt=n("ul"),Dh=n("li"),Tl=n("a"),n4=r("Just-In-Time (JIT) compilation"),s4=p(),Sh=n("li"),yl=n("a"),a4=r("Automatic Differentiation"),r4=p(),Wh=n("li"),wl=n("a"),i4=r("Vectorization"),l4=p(),Bh=n("li"),$l=n("a"),d4=r("Parallelization"),c4=p(),Lt=n("div"),T(Fl.$$.fragment),p4=p(),cn=n("p"),h4=r("The "),Uh=n("code"),u4=r("FlaxRobertaPreTrainedModel"),m4=r(" forward method, overrides the "),Hh=n("code"),f4=r("__call__"),g4=r(" special method."),_4=p(),T(Ks.$$.fragment),b4=p(),T(Gs.$$.fragment),Om=p(),pn=n("h2"),Xs=n("a"),Qh=n("span"),T(xl.$$.fragment),k4=p(),Jh=n("span"),v4=r("FlaxRobertaForQuestionAnswering"),Nm=p(),Be=n("div"),T(Rl.$$.fragment),T4=p(),hn=n("p"),y4=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),af.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ft=a(Ue);y(mr.$$.fragment,ft),zk=h(ft),Mo=s(ft,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var GF=a(hd);Ck=i(GF,"RobertaForSequenceClassification"),GF.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var XF=a(Yc);Pk=i(XF,"__call__"),XF.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ft),y(Dn.$$.fragment,ft),Ok=h(ft),y(Sn.$$.fragment,ft),Nk=h(ft),y(Wn.$$.fragment,ft),Ik=h(ft),y(Bn.$$.fragment,ft),Dk=h(ft),y(Un.$$.fragment,ft),ft.forEach(t),ao.forEach(t),am=h(o),Eo=s(o,"H2",{class:!0});var rf=a(Eo);Hn=s(rf,"A",{id:!0,class:!0,href:!0});var YF=a(Hn);Zc=s(YF,"SPAN",{});var ZF=a(Zc);y(fr.$$.fragment,ZF),ZF.forEach(t),YF.forEach(t),Sk=h(rf),ep=s(rf,"SPAN",{});var e0=a(ep);Wk=i(e0,"RobertaForMultipleChoice"),e0.forEach(t),rf.forEach(t),rm=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);y(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t0=a(tp);Uk=i(t0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t0.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lf=a(_r);Qk=i(lf,"This model inherits from "),ud=s(lf,"A",{href:!0});var o0=a(ud);Jk=i(o0,"PreTrainedModel"),o0.forEach(t),Vk=i(lf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lf.forEach(t),Kk=h(ro),br=s(ro,"P",{});var df=a(br);Gk=i(df,"This model is also a PyTorch "),kr=s(df,"A",{href:!0,rel:!0});var n0=a(kr);Xk=i(n0,"torch.nn.Module"),n0.forEach(t),Yk=i(df,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),df.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),md=s(Qd,"A",{href:!0});var s0=a(md);ov=i(s0,"RobertaForMultipleChoice"),s0.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a0=a(op);sv=i(a0,"__call__"),a0.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),im=h(o),qo=s(o,"H2",{class:!0});var cf=a(qo);Vn=s(cf,"A",{id:!0,class:!0,href:!0});var r0=a(Vn);np=s(r0,"SPAN",{});var i0=a(np);y(Tr.$$.fragment,i0),i0.forEach(t),r0.forEach(t),lv=h(cf),sp=s(cf,"SPAN",{});var l0=a(sp);dv=i(l0,"RobertaForTokenClassification"),l0.forEach(t),cf.forEach(t),lm=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d0=a(ap);pv=i(d0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d0.forEach(t),hv=h(io),wr=s(io,"P",{});var pf=a(wr);uv=i(pf,"This model inherits from "),fd=s(pf,"A",{href:!0});var c0=a(fd);mv=i(c0,"PreTrainedModel"),c0.forEach(t),fv=i(pf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pf.forEach(t),gv=h(io),$r=s(io,"P",{});var hf=a($r);_v=i(hf,"This model is also a PyTorch "),Fr=s(hf,"A",{href:!0,rel:!0});var p0=a(Fr);bv=i(p0,"torch.nn.Module"),p0.forEach(t),kv=i(hf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hf.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h0=a(gd);wv=i(h0,"RobertaForTokenClassification"),h0.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var u0=a(rp);Fv=i(u0,"__call__"),u0.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),dm=h(o),jo=s(o,"H2",{class:!0});var uf=a(jo);Yn=s(uf,"A",{id:!0,class:!0,href:!0});var m0=a(Yn);ip=s(m0,"SPAN",{});var f0=a(ip);y(Rr.$$.fragment,f0),f0.forEach(t),m0.forEach(t),zv=h(uf),lp=s(uf,"SPAN",{});var g0=a(lp);qv=i(g0,"RobertaForQuestionAnswering"),g0.forEach(t),uf.forEach(t),cm=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _0=a(dp);Pv=i(_0,"span start logits"),_0.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b0=a(cp);Av=i(b0,"span end logits"),b0.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var mf=a(Er);Iv=i(mf,"This model inherits from "),_d=s(mf,"A",{href:!0});var k0=a(_d);Dv=i(k0,"PreTrainedModel"),k0.forEach(t),Sv=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mf.forEach(t),Wv=h(co),zr=s(co,"P",{});var ff=a(zr);Bv=i(ff,"This model is also a PyTorch "),qr=s(ff,"A",{href:!0,rel:!0});var v0=a(qr);Uv=i(v0,"torch.nn.Module"),v0.forEach(t),Hv=i(ff,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ff.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T0=a(bd);Kv=i(T0,"RobertaForQuestionAnswering"),T0.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y0=a(pp);Xv=i(y0,"__call__"),y0.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),pm=h(o),Ao=s(o,"H2",{class:!0});var gf=a(Ao);os=s(gf,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);y(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),oT=h(gf),up=s(gf,"SPAN",{});var F0=a(up);nT=i(F0,"TFRobertaModel"),F0.forEach(t),gf.forEach(t),hm=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),mp=s(Ot,"P",{});var x0=a(mp);aT=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _f=a(Lr);iT=i(_f,"This model inherits from "),kd=s(_f,"A",{href:!0});var R0=a(kd);lT=i(R0,"TFPreTrainedModel"),R0.forEach(t),dT=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bf=a(Ar);pT=i(bf,"This model is also a "),Or=s(bf,"A",{href:!0,rel:!0});var M0=a(Or);hT=i(M0,"tf.keras.Model"),M0.forEach(t),uT=i(bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bf.forEach(t),mT=h(Ot),y(ns.$$.fragment,Ot),fT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);bT=i(E0,"TFRobertaModel"),E0.forEach(t),kT=i(Gd," forward method, overrides the "),fp=s(Gd,"CODE",{});var z0=a(fp);vT=i(z0,"__call__"),z0.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),um=h(o),No=s(o,"H2",{class:!0});var kf=a(No);rs=s(kf,"A",{id:!0,class:!0,href:!0});var q0=a(rs);gp=s(q0,"SPAN",{});var C0=a(gp);y(Ir.$$.fragment,C0),C0.forEach(t),q0.forEach(t),$T=h(kf),_p=s(kf,"SPAN",{});var j0=a(_p);FT=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),kf.forEach(t),mm=h(o),Io=s(o,"DIV",{class:!0});var vf=a(Io);y(Dr.$$.fragment,vf),xT=h(vf),Mt=s(vf,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P0=a(Td);ET=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);qT=i(L0,"__call__"),L0.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vf.forEach(t),fm=h(o),So=s(o,"H2",{class:!0});var Tf=a(So);ds=s(Tf,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);y(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),LT=h(Tf),vp=s(Tf,"SPAN",{});var N0=a(vp);AT=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),Tf.forEach(t),gm=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var yf=a(Ur);NT=i(yf,"RoBERTa Model with a "),Tp=s(yf,"CODE",{});var I0=a(Tp);IT=i(I0,"language modeling"),I0.forEach(t),DT=i(yf," head on top."),yf.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wf=a(Hr);WT=i(wf,"This model inherits from "),yd=s(wf,"A",{href:!0});var D0=a(yd);BT=i(D0,"TFPreTrainedModel"),D0.forEach(t),UT=i(wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wf.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $f=a(Qr);QT=i($f,"This model is also a "),Jr=s($f,"A",{href:!0,rel:!0});var S0=a(Jr);JT=i(S0,"tf.keras.Model"),S0.forEach(t),VT=i($f,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$f.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);ZT=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B0=a(yp);ty=i(B0,"__call__"),B0.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),_m=h(o),Bo=s(o,"H2",{class:!0});var Ff=a(Bo);ms=s(Ff,"A",{id:!0,class:!0,href:!0});var U0=a(ms);wp=s(U0,"SPAN",{});var H0=a(wp);y(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),ry=h(Ff),$p=s(Ff,"SPAN",{});var Q0=a($p);iy=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Ff.forEach(t),bm=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var J0=a(Fp);dy=i(J0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J0.forEach(t),cy=h(It),Xr=s(It,"P",{});var xf=a(Xr);py=i(xf,"This model inherits from "),$d=s(xf,"A",{href:!0});var V0=a($d);hy=i(V0,"TFPreTrainedModel"),V0.forEach(t),uy=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xf.forEach(t),my=h(It),Yr=s(It,"P",{});var Rf=a(Yr);fy=i(Rf,"This model is also a "),Zr=s(Rf,"A",{href:!0,rel:!0});var K0=a(Zr);gy=i(K0,"tf.keras.Model"),K0.forEach(t),_y=i(Rf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rf.forEach(t),by=h(It),y(fs.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vy=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G0=a(Fd);yy=i(G0,"TFRobertaForSequenceClassification"),G0.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X0=a(xp);$y=i(X0,"__call__"),X0.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(uo),y(gs.$$.fragment,uo),Ry=h(uo),y(_s.$$.fragment,uo),My=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),km=h(o),Ho=s(o,"H2",{class:!0});var Mf=a(Ho);ks=s(Mf,"A",{id:!0,class:!0,href:!0});var Y0=a(ks);Rp=s(Y0,"SPAN",{});var Z0=a(Rp);y(ti.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Ey=h(Mf),Mp=s(Mf,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mf.forEach(t),vm=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tg.forEach(t),e4=h(Tt),Ih=s(Tt,"P",{});var r7=a(Ih);t4=i(r7,"Finally, this model supports inherent JAX features such as:"),r7.forEach(t),o4=h(Tt),Kt=s(Tt,"UL",{});var ga=a(Kt);Dh=s(ga,"LI",{});var i7=a(Dh);Tl=s(i7,"A",{href:!0,rel:!0});var l7=a(Tl);n4=i(l7,"Just-In-Time (JIT) compilation"),l7.forEach(t),i7.forEach(t),s4=h(ga),Sh=s(ga,"LI",{});var d7=a(Sh);yl=s(d7,"A",{href:!0,rel:!0});var c7=a(yl);a4=i(c7,"Automatic Differentiation"),c7.forEach(t),d7.forEach(t),r4=h(ga),Wh=s(ga,"LI",{});var p7=a(Wh);wl=s(p7,"A",{href:!0,rel:!0});var h7=a(wl);i4=i(h7,"Vectorization"),h7.forEach(t),p7.forEach(t),l4=h(ga),Bh=s(ga,"LI",{});var u7=a(Bh);$l=s(u7,"A",{href:!0,rel:!0});var m7=a($l);d4=i(m7,"Parallelization"),m7.forEach(t),u7.forEach(t),ga.forEach(t),c4=h(Tt),Lt=s(Tt,"DIV",{class:!0});var _a=a(Lt);y(Fl.$$.fragment,_a),p4=h(_a),cn=s(_a,"P",{});var dc=a(cn);h4=i(dc,"The "),Uh=s(dc,"CODE",{});var f7=a(Uh);u4=i(f7,"FlaxRobertaPreTrainedModel"),f7.forEach(t),m4=i(dc," forward method, overrides the "),Hh=s(dc,"CODE",{});var g7=a(Hh);f4=i(g7,"__call__"),g7.forEach(t),g4=i(dc," special method."),dc.forEach(t),_4=h(_a),y(Ks.$$.fragment,_a),b4=h(_a),y(Gs.$$.fragment,_a),_a.forEach(t),Tt.forEach(t),Om=h(o),pn=s(o,"H2",{class:!0});var og=a(pn);Xs=s(og,"A",{id:!0,class:!0,href:!0});var _7=a(Xs);Qh=s(_7,"SPAN",{});var b7=a(Qh);y(xl.$$.fragment,b7),b7.forEach(t),_7.forEach(t),k4=h(og),Jh=s(og,"SPAN",{});var k7=a(Jh);v4=i(k7,"FlaxRobertaForQuestionAnswering"),k7.forEach(t),og.forEach(t),Nm=h(o),Be=s(o,"DIV",{class:!0});var yt=a(Be);y(Rl.$$.fragment,yt),T4=h(yt),hn=s(yt,"P",{});var cc=a(hn);y4=i(cc,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
