...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),yp=new w({}),{c(){y=o("meta"),z=u(),b=o("h1"),q=o("a"),ee=o("span"),f(O.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),C=o("p"),E=o("a"),$=a("DeepSpeed"),qs=a(" implements everything described in the "),V=o("a"),$s=a("ZeRO paper"),R5=a(". Currently it provides full support for:"),Nj=u(),I=o("ol"),ef=o("li"),I5=a("Optimizer state partitioning (ZeRO stage 1)"),U5=u(),sf=o("li"),G5=a("Gradient partitioning (ZeRO stage 2)"),L5=u(),tf=o("li"),M5=a("Parameter partitioning (ZeRO stage 3)"),Z5=u(),af=o("li"),N5=a("Custom mixed precision training handling"),H5=u(),nf=o("li"),B5=a("A range of fast CUDA-extension-based optimizers"),W5=u(),of=o("li"),F5=a("ZeRO-Offload to CPU and NVMe"),Hj=u(),Se=o("p"),V5=a("ZeRO-Offload has its own dedicated paper: "),to=o("a"),Y5=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),K5=a(". And NVMe-support is described in the paper "),ao=o("a"),J5=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),X5=a("."),Bj=u(),Ip=o("p"),Q5=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Wj=u(),Up=o("p"),e$=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
...
install `),jf=o("em"),K$=a("libaio-dev"),J$=a(" system-wide)."),mg=u(),Dt=o("p"),X$=a("Edit "),gf=o("code"),Q$=a("TORCH_CUDA_ARCH_LIST"),e6=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_g=u(),f(mo.$$.fragment),vg=u(),Pe=o("p"),s6=a("So if you get "),wf=o("code"),t6=a("8, 6"),a6=a(", then use "),yf=o("code"),n6=a('TORCH_CUDA_ARCH_LIST="8.6"'),o6=a(`. If you have multiple different cards, you can list all
of them like so `),bf=o("code"),l6=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),jg=u(),si=o("p"),r6=a("If you need to use the same setup on multiple machines, make a binary wheel:"),gg=u(),f(_o.$$.fragment),wg=u(),Ie=o("p"),p6=a("it will generate something like "),Ef=o("code"),i6=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),u6=a(` which now you can install
as `),qf=o("code"),c6=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),h6=a(" locally or on any other machine."),yg=u(),zt=o("p"),f6=a("Again, remember to ensure to adjust "),$f=o("code"),d6=a("TORCH_CUDA_ARCH_LIST"),m6=a(" to the target architectures."),bg=u(),Ue=o("p"),_6=a("You can find the complete list of NVIDIA GPUs and their corresponding "),kf=o("strong"),v6=a("Compute Capabilities"),j6=a(` (same as arch in this
context) `),vo=o("a"),g6=a("here"),w6=a("."),Eg=u(),ti=o("p"),y6=a("You can check the archs pytorch was built with using:"),qg=u(),f(jo.$$.fragment),$g=u(),ai=o("p"),b6=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),E6=a("If the output is:"),Dg=u(),f(wo.$$.fragment),zg=u(),Ot=o("p"),q6=a("then you know that this card\u2019s arch is "),Pf=o("code"),$6=a("8.6"),k6=a("."),Og=u(),Tt=o("p"),P6=a("You can also leave "),Df=o("code"),D6=a("TORCH_CUDA_ARCH_LIST"),z6=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Tg=u(),At=o("p"),O6=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),yo=o("a"),T6=a("Deepspeed"),A6=a(","),Ag=u(),oi=o("a"),Sg=u(),Ds=o("h3"),St=o("a"),zf=o("span"),f(bo.$$.fragment),S6=u(),Of=o("span"),C6=a("Deployment with multiple GPUs"),Cg=u(),Ct=o("p"),x6=a("To deploy this feature with multiple GPUs adjust the "),li=o("a"),R6=a("Trainer"),I6=a(` command line arguments as
following:`),xg=u(),xt=o("ol"),zs=o("li"),U6=a("replace "),Tf=o("code"),G6=a("python -m torch.distributed.launch"),L6=a(" with "),Af=o("code"),M6=a("deepspeed"),Z6=a("."),N6=u(),De=o("li"),H6=a("add a new argument "),Sf=o("code"),B6=a("--deepspeed ds_config.json"),W6=a(", where "),Cf=o("code"),F6=a("ds_config.json"),V6=a(` is the DeepSpeed configuration file as
documented `),Eo=o("a"),Y6=a("here"),K6=a(". The file naming is up to you."),Rg=u(),ri=o("p"),J6=a("Therefore, if your original command line looked as follows:"),Ig=u(),f(qo.$$.fragment),Ug=u(),pi=o("p"),X6=a("Now it should be:"),Gg=u(),f($o.$$.fragment),Lg=u(),U=o("p"),Q6=a("Unlike, "),xf=o("code"),e4=a("torch.distributed.launch"),s4=a(" where you have to specify how many GPUs to use with "),Rf=o("code"),t4=a("--nproc_per_node"),a4=a(`, with the
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),zp=o("a"),uG=a("DeepSpeed GitHub"),cG=a("."),this.h()},l(e){const p=SK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),z=c(e),b=l(e,"H1",{class:!0});var Op=r(b);q=l(Op,"A",{id:!0,class:!0,href:!0});var Rj=r(q);ee=l(Rj,"SPAN",{});var Ij=r(ee);d(O.$$.fragment,Ij),Ij.forEach(t),Rj.forEach(t),x=c(Op),se=l(Op,"SPAN",{});var jG=r(se);R=n(jG,"DeepSpeed Integration"),jG.forEach(t),Op.forEach(t),ae=c(e),C=l(e,"P",{});var Uj=r(C);E=l(Uj,"A",{href:!0,rel:!0});var gG=r(E);$=n(gG,"DeepSpeed"),gG.forEach(t),qs=n(Uj," implements everything described in the "),V=l(Uj,"A",{href:!0,rel:!0});var wG=r(V);$s=n(wG,"ZeRO paper"),wG.forEach(t),R5=n(Uj,". Currently it provides full support for:"),Uj.forEach(t),Nj=c(e),I=l(e,"OL",{});var je=r(I);ef=l(je,"LI",{});var yG=r(ef);I5=n(yG,"Optimizer state partitioning (ZeRO stage 1)"),yG.forEach(t),U5=c(je),sf=l(je,"LI",{});var bG=r(sf);G5=n(bG,"Gradient partitioning (ZeRO stage 2)"),bG.forEach(t),L5=c(je),tf=l(je,"LI",{});var EG=r(tf);M5=n(EG,"Parameter partitioning (ZeRO stage 3)"),EG.forEach(t),Z5=c(je),af=l(je,"LI",{});var qG=r(af);N5=n(qG,"Custom mixed precision training handling"),qG.forEach(t),H5=c(je),nf=l(je,"LI",{});var $G=r(nf);B5=n($G,"A range of fast CUDA-extension-based optimizers"),$G.forEach(t),W5=c(je),of=l(je,"LI",{});var kG=r(of);F5=n(kG,"ZeRO-Offload to CPU and NVMe"),kG.forEach(t),je.forEach(t),Hj=c(e),Se=l(e,"P",{});var lh=r(Se);V5=n(lh,"ZeRO-Offload has its own dedicated paper: "),to=l(lh,"A",{href:!0,rel:!0});var PG=r(to);Y5=n(PG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),PG.forEach(t),K5=n(lh,". And NVMe-support is described in the paper "),ao=l(lh,"A",{href:!0,rel:!0});var DG=r(ao);J5=n(DG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),DG.forEach(t),X5=n(lh,"."),lh.forEach(t),Bj=c(e),Ip=l(e,"P",{});var zG=r(Ip);Q5=n(zG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),zG.forEach(t),Wj=c(e),Up=l(e,"P",{});var OG=r(Up);e$=n(OG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
...
install `),jf=l(ih,"EM",{});var rL=r(jf);K$=n(rL,"libaio-dev"),rL.forEach(t),J$=n(ih," system-wide)."),ih.forEach(t),mg=c(e),Dt=l(e,"P",{});var pE=r(Dt);X$=n(pE,"Edit "),gf=l(pE,"CODE",{});var pL=r(gf);Q$=n(pL,"TORCH_CUDA_ARCH_LIST"),pL.forEach(t),e6=n(pE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),pE.forEach(t),_g=c(e),d(mo.$$.fragment,e),vg=c(e),Pe=l(e,"P",{});var Tp=r(Pe);s6=n(Tp,"So if you get "),wf=l(Tp,"CODE",{});var iL=r(wf);t6=n(iL,"8, 6"),iL.forEach(t),a6=n(Tp,", then use "),yf=l(Tp,"CODE",{});var uL=r(yf);n6=n(uL,'TORCH_CUDA_ARCH_LIST="8.6"'),uL.forEach(t),o6=n(Tp,`. If you have multiple different cards, you can list all
of them like so `),bf=l(Tp,"CODE",{});var cL=r(bf);l6=n(cL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),cL.forEach(t),Tp.forEach(t),jg=c(e),si=l(e,"P",{});var hL=r(si);r6=n(hL,"If you need to use the same setup on multiple machines, make a binary wheel:"),hL.forEach(t),gg=c(e),d(_o.$$.fragment,e),wg=c(e),Ie=l(e,"P",{});var uh=r(Ie);p6=n(uh,"it will generate something like "),Ef=l(uh,"CODE",{});var fL=r(Ef);i6=n(fL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),fL.forEach(t),u6=n(uh,` which now you can install
as `),qf=l(uh,"CODE",{});var dL=r(qf);c6=n(dL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),dL.forEach(t),h6=n(uh," locally or on any other machine."),uh.forEach(t),yg=c(e),zt=l(e,"P",{});var iE=r(zt);f6=n(iE,"Again, remember to ensure to adjust "),$f=l(iE,"CODE",{});var mL=r($f);d6=n(mL,"TORCH_CUDA_ARCH_LIST"),mL.forEach(t),m6=n(iE," to the target architectures."),iE.forEach(t),bg=c(e),Ue=l(e,"P",{});var ch=r(Ue);_6=n(ch,"You can find the complete list of NVIDIA GPUs and their corresponding "),kf=l(ch,"STRONG",{});var _L=r(kf);v6=n(_L,"Compute Capabilities"),_L.forEach(t),j6=n(ch,` (same as arch in this
context) `),vo=l(ch,"A",{href:!0,rel:!0});var vL=r(vo);g6=n(vL,"here"),vL.forEach(t),w6=n(ch,"."),ch.forEach(t),Eg=c(e),ti=l(e,"P",{});var jL=r(ti);y6=n(jL,"You can check the archs pytorch was built with using:"),jL.forEach(t),qg=c(e),d(jo.$$.fragment,e),$g=c(e),ai=l(e,"P",{});var gL=r(ai);b6=n(gL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),gL.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var wL=r(ni);E6=n(wL,"If the output is:"),wL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),Ot=l(e,"P",{});var uE=r(Ot);q6=n(uE,"then you know that this card\u2019s arch is "),Pf=l(uE,"CODE",{});var yL=r(Pf);$6=n(yL,"8.6"),yL.forEach(t),k6=n(uE,"."),uE.forEach(t),Og=c(e),Tt=l(e,"P",{});var cE=r(Tt);P6=n(cE,"You can also leave "),Df=l(cE,"CODE",{});var bL=r(Df);D6=n(bL,"TORCH_CUDA_ARCH_LIST"),bL.forEach(t),z6=n(cE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),cE.forEach(t),Tg=c(e),At=l(e,"P",{});var hE=r(At);O6=n(hE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),yo=l(hE,"A",{href:!0,rel:!0});var EL=r(yo);T6=n(EL,"Deepspeed"),EL.forEach(t),A6=n(hE,","),hE.forEach(t),Ag=c(e),oi=l(e,"A",{id:!0}),r(oi).forEach(t),Sg=c(e),Ds=l(e,"H3",{class:!0});var fE=r(Ds);St=l(fE,"A",{id:!0,class:!0,href:!0});var qL=r(St);zf=l(qL,"SPAN",{});var $L=r(zf);d(bo.$$.fragment,$L),$L.forEach(t),qL.forEach(t),S6=c(fE),Of=l(fE,"SPAN",{});var kL=r(Of);C6=n(kL,"Deployment with multiple GPUs"),kL.forEach(t),fE.forEach(t),Cg=c(e),Ct=l(e,"P",{});var dE=r(Ct);x6=n(dE,"To deploy this feature with multiple GPUs adjust the "),li=l(dE,"A",{href:!0});var PL=r(li);R6=n(PL,"Trainer"),PL.forEach(t),I6=n(dE,` command line arguments as
following:`),dE.forEach(t),xg=c(e),xt=l(e,"OL",{});var mE=r(xt);zs=l(mE,"LI",{});var hh=r(zs);U6=n(hh,"replace "),Tf=l(hh,"CODE",{});var DL=r(Tf);G6=n(DL,"python -m torch.distributed.launch"),DL.forEach(t),L6=n(hh," with "),Af=l(hh,"CODE",{});var zL=r(Af);M6=n(zL,"deepspeed"),zL.forEach(t),Z6=n(hh,"."),hh.forEach(t),N6=c(mE),De=l(mE,"LI",{});var Ln=r(De);H6=n(Ln,"add a new argument "),Sf=l(Ln,"CODE",{});var OL=r(Sf);B6=n(OL,"--deepspeed ds_config.json"),OL.forEach(t),W6=n(Ln,", where "),Cf=l(Ln,"CODE",{});var TL=r(Cf);F6=n(TL,"ds_config.json"),TL.forEach(t),V6=n(Ln,` is the DeepSpeed configuration file as
documented `),Eo=l(Ln,"A",{href:!0,rel:!0});var AL=r(Eo);Y6=n(AL,"here"),AL.forEach(t),K6=n(Ln,". The file naming is up to you."),Ln.forEach(t),mE.forEach(t),Rg=c(e),ri=l(e,"P",{});var SL=r(ri);J6=n(SL,"Therefore, if your original command line looked as follows:"),SL.forEach(t),Ig=c(e),d(qo.$$.fragment,e),Ug=c(e),pi=l(e,"P",{});var CL=r(pi);X6=n(CL,"Now it should be:"),CL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),U=l(e,"P",{});var we=r(U);Q6=n(we,"Unlike, "),xf=l(we,"CODE",{});var xL=r(xf);e4=n(xL,"torch.distributed.launch"),xL.forEach(t),s4=n(we," where you have to specify how many GPUs to use with "),Rf=l(we,"CODE",{});var RL=r(Rf);t4=n(RL,"--nproc_per_node"),RL.forEach(t),a4=n(we,`, with the
...
circumstances you may find the following information to be needed.`),DF.forEach(t),q3=c(e),nt=l(e,"H4",{class:!0});var e5=r(nt);un=l(e5,"A",{id:!0,class:!0,href:!0});var zF=r(un);ov=l(zF,"SPAN",{});var OF=r(ov);d(kr.$$.fragment,OF),OF.forEach(t),zF.forEach(t),_C=c(e5),lv=l(e5,"SPAN",{});var TF=r(lv);vC=n(TF,"Constructing Massive Models"),TF.forEach(t),e5.forEach(t),$3=c(e),cn=l(e,"P",{});var s5=r(cn);jC=n(s5,`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
but also if you want the initialization to happen much faster, initialize the model using `),rv=l(s5,"EM",{});var AF=r(rv);gC=n(AF,"deepspeed.zero.Init()"),AF.forEach(t),wC=n(s5,`
context manager (which is also a function decorator), like so:`),s5.forEach(t),k3=c(e),d(Pr.$$.fragment,e),P3=c(e),uc=l(e,"P",{});var SF=r(uc);yC=n(SF,"As you can see this gives you a randomly initialized model."),SF.forEach(t),D3=c(e),D=l(e,"P",{});var W=r(D);bC=n(W,"If you want to use a pretrained model, "),pv=l(W,"CODE",{});var CF=r(pv);EC=n(CF,"model_class.from_pretrained"),CF.forEach(t),qC=n(W,` will activate this feature as long as
...
`),hv=l(W,"CODE",{});var LF=r(hv);xC=n(LF,"from_pretrained"),LF.forEach(t),RC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),z3=c(e),d(Dr.$$.fragment,e),O3=c(e),hn=l(e,"P",{});var t5=r(hn);IC=n(t5,"If you\u2019re using the official example scripts and your command line arguments include "),fv=l(t5,"CODE",{});var MF=r(fv);UC=n(MF,"--deepspeed ds_config.json"),MF.forEach(t),GC=n(t5,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),t5.forEach(t),T3=c(e),fc=l(e,"P",{});var ZF=r(fc);LC=n(ZF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),ZF.forEach(t),A3=c(e),fn=l(e,"P",{});var a5=r(fn);MC=n(a5,"For full details on this method and other related features please refer to "),zr=l(a5,"A",{href:!0,rel:!0});var NF=r(zr);ZC=n(NF,"Constructing Massive Models"),NF.forEach(t),NC=n(a5,"."),a5.forEach(t),S3=c(e),fe=l(e,"P",{});var Kn=r(fe);HC=n(Kn,"Also when loading fp16-pretrained models, you will want to tell "),dv=l(Kn,"CODE",{});var HF=r(dv);BC=n(HF,"from_pretrained"),HF.forEach(t),WC=n(Kn,` to use
`),mv=l(Kn,"CODE",{});var BF=r(mv);FC=n(BF,"torch_dtype=torch.float16"),BF.forEach(t),VC=n(Kn,". For details, please, see "),dc=l(Kn,"A",{href:!0});var WF=r(dc);YC=n(WF,"from_pretrained-torch-dtype"),WF.forEach(t),KC=n(Kn,"."),Kn.forEach(t),C3=c(e),ot=l(e,"H4",{class:!0});var n5=r(ot);dn=l(n5,"A",{id:!0,class:!0,href:!0});var FF=r(dn);_v=l(FF,"SPAN",{});var VF=r(_v);d(Or.$$.fragment,VF),VF.forEach(t),FF.forEach(t),JC=c(n5),vv=l(n5,"SPAN",{});var YF=r(vv);XC=n(YF,"Gathering Parameters"),YF.forEach(t),n5.forEach(t),x3=c(e),Tr=l(e,"P",{});var mG=r(Tr);QC=n(mG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Ar=l(mG,"A",{href:!0,rel:!0});var KF=r(Ar);ex=n(KF,"Gathering Parameters"),KF.forEach(t),mG.forEach(t),R3=c(e),mn=l(e,"P",{});var o5=r(mn);sx=n(o5,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),jv=l(o5,"CODE",{});var JF=r(jv);tx=n(JF,"from_pretrained"),JF.forEach(t),ax=n(o5,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
limitations.`),o5.forEach(t),I3=c(e),mc=l(e,"P",{});var XF=r(mc);nx=n(XF,"Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),XF.forEach(t),U3=c(e),d(Sr.$$.fragment,e),G3=c(e),ds=l(e,"P",{});var Zh=r(ds);ox=n(Zh,"stress on "),gv=l(Zh,"CODE",{});var QF=r(gv);lx=n(QF,"tensor([1.])"),QF.forEach(t),rx=n(Zh,", or if you get an error where it says the parameter is of size "),wv=l(Zh,"CODE",{});var eV=r(wv);px=n(eV,"1"),eV.forEach(t),ix=n(Zh,`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),Zh.forEach(t),L3=c(e),_c=l(e,"A",{id:!0}),r(_c).forEach(t),M3=c(e),lt=l(e,"H3",{class:!0});var l5=r(lt);_n=l(l5,"A",{id:!0,class:!0,href:!0});var sV=r(_n);yv=l(sV,"SPAN",{});var tV=r(yv);d(Cr.$$.fragment,tV),tV.forEach(t),sV.forEach(t),ux=c(l5),bv=l(l5,"SPAN",{});var aV=r(bv);cx=n(aV,"ZeRO Inference"),aV.forEach(t),l5.forEach(t),Z3=c(e),vc=l(e,"P",{});var nV=r(vc);hx=n(nV,`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),nV.forEach(t),N3=c(e),vn=l(e,"P",{});var r5=r(vn);fx=n(r5,"Otherwise you just need to pass the usual "),jc=l(r5,"A",{href:!0});var oV=r(jc);dx=n(oV,"TrainingArguments"),oV.forEach(t),mx=n(r5," arguments. For example:"),r5.forEach(t),H3=c(e),d(xr.$$.fragment,e),B3=c(e),gc=l(e,"P",{});var lV=r(gc);_x=n(lV,`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),lV.forEach(t),W3=c(e),jn=l(e,"P",{});var p5=r(jn);vx=n(p5,"Here is an example of running "),Ev=l(p5,"CODE",{});var rV=r(Ev);jx=n(rV,"run_translation.py"),rV.forEach(t),gx=n(p5," under DeepSpeed deploying all available GPUs:"),p5.forEach(t),F3=c(e),d(Rr.$$.fragment,e),V3=c(e),wc=l(e,"P",{});var pV=r(wc);wx=n(pV,`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
...
dump the `),Sc=l(Jn,"A",{href:!0});var TV=r(Sc);Bx=n(TV,"TrainingArguments"),TV.forEach(t),Wx=n(Jn," as it has dozens of entries that are irrelevant."),Jn.forEach(t),DV.forEach(t),Fx=c($e),Zr=l($e,"LI",{});var h5=r(Zr);Tv=l(h5,"P",{});var AV=r(Tv);Vx=n(AV,"Output of:"),AV.forEach(t),Yx=c(h5),d(Nr.$$.fragment,h5),h5.forEach(t),Kx=c($e),Av=l($e,"LI",{});var SV=r(Av);Hr=l(SV,"P",{});var f5=r(Hr);Jx=n(f5,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Br=l(f5,"A",{href:!0,rel:!0});var CV=r(Br);Xx=n(CV,"notebook"),CV.forEach(t),Qx=n(f5,` as
a starting point.`),f5.forEach(t),SV.forEach(t),eR=c($e),Sv=l($e,"LI",{});var xV=r(Sv);Cv=l(xV,"P",{});var RV=r(Cv);sR=n(RV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),RV.forEach(t),xV.forEach(t),tR=c($e),xv=l($e,"LI",{});var IV=r(xv);Wr=l(IV,"P",{});var d5=r(Wr);aR=n(d5,"If possible try to use one of the existing "),Fr=l(d5,"A",{href:!0,rel:!0});var UV=r(Fr);nR=n(UV,"examples"),UV.forEach(t),oR=n(d5," to reproduce the problem with."),d5.forEach(t),IV.forEach(t),$e.forEach(t),c0=c(e),Cc=l(e,"P",{});var GV=r(Cc);lR=n(GV,"Things to consider:"),GV.forEach(t),h0=c(e),bn=l(e,"UL",{});var m5=r(bn);it=l(m5,"LI",{});var Nh=r(it);Rv=l(Nh,"P",{});var LV=r(Rv);rR=n(LV,"Deepspeed is often not the cause of the problem."),LV.forEach(t),pR=c(Nh),Iv=l(Nh,"P",{});var MV=r(Iv);iR=n(MV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),ZV.forEach(t),Nh.forEach(t),hR=c(m5),Gv=l(m5,"LI",{});var NV=r(Gv);Vr=l(NV,"P",{});var _5=r(Vr);fR=n(_5,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Yr=l(_5,"A",{href:!0,rel:!0});var HV=r(Yr);dR=n(HV,"Deepspeed"),HV.forEach(t),mR=n(_5,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),_5.forEach(t),NV.forEach(t),m5.forEach(t),f0=c(e),ut=l(e,"H3",{class:!0});var v5=r(ut);En=l(v5,"A",{id:!0,class:!0,href:!0});var BV=r(En);Lv=l(BV,"SPAN",{});var WV=r(Lv);d(Kr.$$.fragment,WV),WV.forEach(t),BV.forEach(t),_R=c(v5),Mv=l(v5,"SPAN",{});var FV=r(Mv);vR=n(FV,"Troubleshooting"),FV.forEach(t),v5.forEach(t),d0=c(e),ct=l(e,"H4",{class:!0});var j5=r(ct);qn=l(j5,"A",{id:!0,class:!0,href:!0});var VV=r(qn);Zv=l(VV,"SPAN",{});var YV=r(Zv);d(Jr.$$.fragment,YV),YV.forEach(t),VV.forEach(t),jR=c(j5),Xr=l(j5,"SPAN",{});var g5=r(Xr);gR=n(g5,"the "),Nv=l(g5,"CODE",{});var KV=r(Nv);wR=n(KV,"deepspeed"),KV.forEach(t),yR=n(g5," process gets killed at startup without a traceback"),g5.forEach(t),j5.forEach(t),m0=c(e),B=l(e,"P",{});var ke=r(B);bR=n(ke,"If the "),Hv=l(ke,"CODE",{});var JV=r(Hv);ER=n(JV,"deepspeed"),JV.forEach(t),qR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
