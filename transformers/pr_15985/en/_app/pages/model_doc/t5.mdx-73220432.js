...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15985/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/models/t5/modeling_tf_t5.py#L1353",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15985/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15985/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15985/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15985/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[$w]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15985/src/transformers/models/t5/modeling_tf_t5.py#L1618",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k5=d(),f(Xn.$$.fragment),v5=d(),Je=o("div"),f(ya.$$.fragment),b5=d(),Tn=o("p"),y5=r("The "),Ar=o("a"),w5=r("TFT5ForConditionalGeneration"),$5=r(" forward method, overrides the "),fl=o("code"),z5=r("__call__"),x5=r(" special method."),E5=d(),f(Qn.$$.fragment),q5=d(),_l=o("p"),j5=r("Examples:"),F5=d(),f(wa.$$.fragment),Nc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f($a.$$.fragment),M5=d(),Tl=o("span"),P5=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),C5=d(),kl=o("p"),A5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),N5=d(),xa=o("p"),L5=r("The T5 model was proposed in "),Ea=o("a"),I5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),p5=l(rt),ka=s(rt,"P",{});var Mp=a(ka);h5=i(Mp,"This model inherits from "),Cr=s(Mp,"A",{href:!0});var Ly=a(Cr);u5=i(Ly,"TFPreTrainedModel"),Ly.forEach(t),m5=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),k5=l(rt),_(Xn.$$.fragment,rt),v5=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),b5=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);y5=i(ei,"The "),Ar=s(ei,"A",{href:!0});var Dy=a(Ar);w5=i(Dy,"TFT5ForConditionalGeneration"),Dy.forEach(t),$5=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var Sy=a(fl);z5=i(Sy,"__call__"),Sy.forEach(t),x5=i(ei," special method."),ei.forEach(t),E5=l(Ht),_(Qn.$$.fragment,Ht),q5=l(Ht),_l=s(Ht,"P",{});var Oy=a(_l);j5=i(Oy,"Examples:"),Oy.forEach(t),F5=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Nc=l(n),kn=s(n,"H2",{class:!0});var Cp=a(kn);eo=s(Cp,"A",{id:!0,class:!0,href:!0});var Gy=a(eo);gl=s(Gy,"SPAN",{});var By=a(gl);_($a.$$.fragment,By),By.forEach(t),Gy.forEach(t),M5=l(Cp),Tl=s(Cp,"SPAN",{});var Uy=a(Tl);P5=i(Uy,"TFT5EncoderModel"),Uy.forEach(t),Cp.forEach(t),Lc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),C5=l(it),kl=s(it,"P",{});var Wy=a(kl);A5=i(Wy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Wy.forEach(t),N5=l(it),xa=s(it,"P",{});var Ap=a(xa);L5=i(Ap,"The T5 model was proposed in "),Ea=s(Ap,"A",{href:!0,rel:!0});var Ry=a(Ea);I5=i(Ry,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
