...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17717/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17717/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17717/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uf.forEach(t),M_=h(Ye),y(Rn.$$.fragment,Ye),E_=h(Ye),Ia=s(Ye,"P",{});var Hf=a(Ia);z_=i(Hf,"This tokenizer inherits from "),nd=s(Hf,"A",{href:!0});var d7=a(nd);C_=i(d7,"PreTrainedTokenizerFast"),d7.forEach(t),q_=i(Hf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hf.forEach(t),j_=h(Ye),sd=s(Ye,"DIV",{class:!0});var c7=a(sd);y(Da.$$.fragment,c7),c7.forEach(t),Ye.forEach(t),Xm=h(o),To=s(o,"H2",{class:!0});var Qf=a(To);Mn=s(Qf,"A",{id:!0,class:!0,href:!0});var p7=a(Mn);Ec=s(p7,"SPAN",{});var h7=a(Ec);y(Sa.$$.fragment,h7),h7.forEach(t),p7.forEach(t),P_=h(Qf),zc=s(Qf,"SPAN",{});var m7=a(zc);L_=i(m7,"RobertaModel"),m7.forEach(t),Qf.forEach(t),Ym=h(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);y(Wa.$$.fragment,Ze),A_=h(Ze),Cc=s(Ze,"P",{});var f7=a(Cc);O_=i(f7,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),f7.forEach(t),N_=h(Ze),Ba=s(Ze,"P",{});var Vf=a(Ba);I_=i(Vf,"This model inherits from "),ad=s(Vf,"A",{href:!0});var u7=a(ad);D_=i(u7,"PreTrainedModel"),u7.forEach(t),S_=i(Vf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),ik=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(lr.$$.fragment,so),lk=h(so),xo=s(so,"P",{});var Ud=a(xo);dk=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var W7=a(cd);ck=i(W7,"RobertaForMaskedLM"),W7.forEach(t),pk=i(Ud," forward method, overrides the "),Jc=s(Ud,"CODE",{});var B7=a(Jc);hk=i(B7,"__call__"),B7.forEach(t),mk=i(Ud," special method."),Ud.forEach(t),fk=h(so),y(An.$$.fragment,so),uk=h(so),y(On.$$.fragment,so),gk=h(so),y(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nf=h(o),Ro=s(o,"H2",{class:!0});var su=a(Ro);In=s(su,"A",{id:!0,class:!0,href:!0});var U7=a(In);Kc=s(U7,"SPAN",{});var H7=a(Kc);y(dr.$$.fragment,H7),H7.forEach(t),U7.forEach(t),_k=h(su),Gc=s(su,"SPAN",{});var Q7=a(Gc);bk=i(Q7,"RobertaForSequenceClassification"),Q7.forEach(t),su.forEach(t),sf=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);y(cr.$$.fragment,ao),kk=h(ao),Xc=s(ao,"P",{});var V7=a(Xc);vk=i(V7,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V7.forEach(t),Tk=h(ao),pr=s(ao,"P",{});var au=a(pr);yk=i(au,"This model inherits from "),pd=s(au,"A",{href:!0});var J7=a(pd);wk=i(J7,"PreTrainedModel"),J7.forEach(t),$k=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
