...
- SEWForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded using
  [Wav2Vec2CTCTokenizer](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer).
...
- **final_dropout** (`float`, *optional*, defaults to 0.1) --
  The dropout probability for the final projection layer of [SEWForCTC](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWForCTC).
...
- **ctc_loss_reduction** (`str`, *optional*, defaults to `"sum"`) --
  ...
  instance of [SEWForCTC](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWForCTC).
- **ctc_zero_infinity** (`bool`, *optional*, defaults to `False`) --
  Whether to zero infinite losses and the associated gradients of `torch.nn.CTCLoss`. Infinite losses mainly
  occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
  of [SEWForCTC](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWForCTC).
- **use_weighted_layer_sum** (`bool`, *optional*, defaults to `False`) --
  Whether to use a weighted average of layer outputs with learned weights. Only relevant when using an
  instance of [Wav2Vec2ForSequenceClassification](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2ForSequenceClassification).
...
This is the configuration class to store the configuration of a [SEWModel](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWModel). It is used to instantiate a SEW model
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SEWModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15386/src/transformers/models/sew/modeling_sew.py#L892</source><parameters>[{"name": "input_values", "val": ""}, {"name": "attention_mask", "val": " = None"}, {"name": "mask_time_indices", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_values** (`torch.FloatTensor` of shape `(batch_size, sequence_length)`) --
  Float values of input raw speech waveform. Values can be obtained by loading a *.flac* or *.wav* audio file
  into an array of type *List[float]* or a *numpy.ndarray*, *e.g.* via the soundfile library (*pip install
  soundfile*). To prepare the array into *input_values*, the [Wav2Vec2Processor](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) should be used for padding
  and conversion into a tensor of type *torch.FloatTensor*. See [Wav2Vec2Processor.__call__()](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor.__call__) for details.
...
elements depending on the configuration ([SEWConfig](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWConfig)) and inputs.
...
The [SEWModel](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.SEWForCTC</name><anchor>transformers.SEWForCTC</anchor><source>https://github.com/huggingface/transformers/blob/pr_15386/src/transformers/models/sew/modeling_sew.py#L955</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([SEWConfig](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15386/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SEWForCTC.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15386/src/transformers/models/sew/modeling_sew.py#L993</source><parameters>[{"name": "input_values", "val": ""}, {"name": "attention_mask", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}, {"name": "labels", "val": " = None"}]</parameters><paramsdesc>- **input_values** (`torch.FloatTensor` of shape `(batch_size, sequence_length)`) --
  Float values of input raw speech waveform. Values can be obtained by loading a *.flac* or *.wav* audio file
  into an array of type *List[float]* or a *numpy.ndarray*, *e.g.* via the soundfile library (*pip install
  soundfile*). To prepare the array into *input_values*, the [Wav2Vec2Processor](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) should be used for padding
  and conversion into a tensor of type *torch.FloatTensor*. See [Wav2Vec2Processor.__call__()](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor.__call__) for details.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [SEWForCTC](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWForCTC) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.SEWForSequenceClassification</name><anchor>transformers.SEWForSequenceClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15386/src/transformers/models/sew/modeling_sew.py#L1083</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([SEWConfig](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15386/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SEWForSequenceClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15386/src/transformers/models/sew/modeling_sew.py#L1124</source><parameters>[{"name": "input_values", "val": ""}, {"name": "attention_mask", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}, {"name": "labels", "val": " = None"}]</parameters><paramsdesc>- **input_values** (`torch.FloatTensor` of shape `(batch_size, sequence_length)`) --
  Float values of input raw speech waveform. Values can be obtained by loading a *.flac* or *.wav* audio file
  into an array of type *List[float]* or a *numpy.ndarray*, *e.g.* via the soundfile library (*pip install
  soundfile*). To prepare the array into *input_values*, the [Wav2Vec2Processor](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) should be used for padding
  and conversion into a tensor of type *torch.FloatTensor*. See [Wav2Vec2Processor.__call__()](/docs/transformers/pr_15386/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor.__call__) for details.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [SEWForSequenceClassification](/docs/transformers/pr_15386/en/model_doc/sew#transformers.SEWForSequenceClassification) forward method, overrides the `__call__` special method.
