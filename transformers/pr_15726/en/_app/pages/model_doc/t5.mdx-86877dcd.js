...
configuration. Check out the <a href="/docs/transformers/pr_15726/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ys=new P({props:{name:"forward",anchor:"transformers.T5Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15726/src/transformers/models/t5/modeling_t5.py#L1340",parametersDescription:[{anchor:"transformers.T5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15726/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15726/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15726/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15726/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Es=new P({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15726/src/transformers/models/t5/modeling_t5.py#L1308"}}),qs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Gs=new P({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15726/src/transformers/models/t5/modeling_t5.py#L1503"}}),Bs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_15726/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),ea=new P({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15726/src/transformers/models/t5/modeling_t5.py#L1779"}}),ta=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15726/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15726/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15726/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15726/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
for summarization: `),W=s(Pr,"EM",{});var Xv=a(W);Ae=i(Xv,"summarize: \u2026"),Xv.forEach(t),m=i(Pr,"."),Pr.forEach(t),Jv.forEach(t),j=l(Mr),te=s(Mr,"LI",{});var Qv=a(te);Oe=s(Qv,"P",{});var e5=a(Oe);lt=i(e5,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),e5.forEach(t),Qv.forEach(t),S=l(Mr),Ge=s(Mr,"LI",{});var t5=a(Ge);ne=s(t5,"P",{});var io=a(ne);ct=i(io,"See the "),N=s(io,"A",{href:!0});var n5=a(N);Y=i(n5,"training"),n5.forEach(t),pt=i(io,", "),Ne=s(io,"A",{href:!0});var o5=a(Ne);J=i(o5,"inference"),o5.forEach(t),ht=i(io," and "),Le=s(io,"A",{href:!0});var s5=a(Le);Ie=i(s5,"scripts"),s5.forEach(t),ut=i(io," sections below for all details regarding usage."),io.forEach(t),t5.forEach(t),Mr.forEach(t),Wl=l(n),Va=s(n,"P",{});var a5=a(Va);Lp=i(a5,"T5 comes in different sizes:"),a5.forEach(t),Rl=l(n),Be=s(n,"UL",{});var Nt=a(Be);si=s(Nt,"LI",{});var r5=a(si);ai=s(r5,"P",{});var i5=a(ai);_o=s(i5,"A",{href:!0,rel:!0});var d5=a(_o);Ip=i(d5,"t5-small"),d5.forEach(t),i5.forEach(t),r5.forEach(t),Dp=l(Nt),ri=s(Nt,"LI",{});var l5=a(ri);ii=s(l5,"P",{});var c5=a(ii);go=s(c5,"A",{href:!0,rel:!0});var p5=a(go);Sp=i(p5,"t5-base"),p5.forEach(t),c5.forEach(t),l5.forEach(t),Op=l(Nt),di=s(Nt,"LI",{});var h5=a(di);li=s(h5,"P",{});var u5=a(li);To=s(u5,"A",{href:!0,rel:!0});var m5=a(To);Gp=i(m5,"t5-large"),m5.forEach(t),u5.forEach(t),h5.forEach(t),Bp=l(Nt),ci=s(Nt,"LI",{});var f5=a(ci);pi=s(f5,"P",{});var _5=a(pi);ko=s(_5,"A",{href:!0,rel:!0});var g5=a(ko);Up=i(g5,"t5-3b"),g5.forEach(t),_5.forEach(t),f5.forEach(t),Wp=l(Nt),hi=s(Nt,"LI",{});var T5=a(hi);Ka=s(T5,"P",{});var Bv=a(Ka);vo=s(Bv,"A",{href:!0,rel:!0});var k5=a(vo);Rp=i(k5,"t5-11b"),k5.forEach(t),Hp=i(Bv,"."),Bv.forEach(t),T5.forEach(t),Nt.forEach(t),Hl=l(n),Ya=s(n,"P",{});var v5=a(Ya);Vp=i(v5,"Based on the original T5 model, Google has released some follow-up works:"),v5.forEach(t),Vl=l(n),xt=s(n,"UL",{});var Cr=a(xt);ui=s(Cr,"LI",{});var b5=a(ui);$n=s(b5,"P",{});var Gl=a($n);mi=s(Gl,"STRONG",{});var w5=a(mi);Kp=i(w5,"T5v1.1"),w5.forEach(t),Yp=i(Gl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Ja=s(Gl,"A",{href:!0});var y5=a(Ja);Jp=i(y5,"here"),y5.forEach(t),Zp=i(Gl,"."),Gl.forEach(t),b5.forEach(t),Xp=l(Cr),fi=s(Cr,"LI",{});var z5=a(fi);xn=s(z5,"P",{});var Bl=a(xn);_i=s(Bl,"STRONG",{});var $5=a(_i);Qp=i($5,"mT5"),$5.forEach(t),eh=i(Bl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),Za=s(Bl,"A",{href:!0});var x5=a(Za);th=i(x5,"here"),x5.forEach(t),nh=i(Bl,"."),Bl.forEach(t),z5.forEach(t),oh=l(Cr),gi=s(Cr,"LI",{});var E5=a(gi);En=s(E5,"P",{});var Ul=a(En);Ti=s(Ul,"STRONG",{});var q5=a(Ti);sh=i(q5,"byT5"),q5.forEach(t),ah=i(Ul,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Xa=s(Ul,"A",{href:!0});var j5=a(Xa);rh=i(j5,"here"),j5.forEach(t),ih=i(Ul,"."),Ul.forEach(t),E5.forEach(t),Cr.forEach(t),Kl=l(n),qn=s(n,"P",{});var Sc=a(qn);dh=i(Sc,"All checkpoints can be found on the "),bo=s(Sc,"A",{href:!0,rel:!0});var F5=a(bo);lh=i(F5,"hub"),F5.forEach(t),ch=i(Sc,"."),Sc.forEach(t),Yl=l(n),Et=s(n,"P",{});var Ar=a(Et);ph=i(Ar,"This model was contributed by "),wo=s(Ar,"A",{href:!0,rel:!0});var M5=a(wo);hh=i(M5,"thomwolf"),M5.forEach(t),uh=i(Ar,". The original code can be found "),yo=s(Ar,"A",{href:!0,rel:!0});var P5=a(yo);mh=i(P5,"here"),P5.forEach(t),fh=i(Ar,"."),Ar.forEach(t),Jl=l(n),Qa=s(n,"A",{id:!0}),a(Qa).forEach(t),Zl=l(n),Jt=s(n,"H2",{class:!0});var Oc=a(Jt);jn=s(Oc,"A",{id:!0,class:!0,href:!0});var C5=a(jn);ki=s(C5,"SPAN",{});var A5=a(ki);_(zo.$$.fragment,A5),A5.forEach(t),C5.forEach(t),_h=l(Oc),vi=s(Oc,"SPAN",{});var N5=a(vi);gh=i(N5,"Training"),N5.forEach(t),Oc.forEach(t),Xl=l(n),mt=s(n,"P",{});var lo=a(mt);Th=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),bi=s(lo,"CODE",{});var L5=a(bi);kh=i(L5,"input_ids"),L5.forEach(t),vh=i(lo,`. The target sequence is shifted to the right, i.e., prepended by a
start-sequence token and fed to the decoder using the `),wi=s(lo,"CODE",{});var I5=a(wi);bh=i(I5,"decoder_input_ids"),I5.forEach(t),wh=i(lo,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),yi=s(lo,"CODE",{});var D5=a(yi);yh=i(D5,"labels"),D5.forEach(t),zh=i(lo,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),lo.forEach(t),Ql=l(n),Fn=s(n,"P",{});var Gc=a(Fn);$h=i(Gc,"One can use "),er=s(Gc,"A",{href:!0});var S5=a(er);xh=i(S5,"T5ForConditionalGeneration"),S5.forEach(t),Eh=i(Gc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Gc.forEach(t),ec=l(n),Mn=s(n,"UL",{});var Bc=a(Mn);dt=s(Bc,"LI",{});var Lt=a(dt);zi=s(Lt,"P",{});var O5=a(zi);qh=i(O5,"Unsupervised denoising training"),O5.forEach(t),jh=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Fh=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),$i=s(tt,"EM",{});var G5=a($i);Mh=i(G5,"a.k.a"),G5.forEach(t),Ph=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),xi=s(tt,"EM",{});var B5=a(xi);Ch=i(B5,"real"),B5.forEach(t),Ah=i(tt,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=s(tt,"CODE",{});var U5=a(Ei);Nh=i(U5,"<extra_id_0>"),U5.forEach(t),Lh=i(tt,`,
`),qi=s(tt,"CODE",{});var W5=a(qi);Ih=i(W5,"<extra_id_1>"),W5.forEach(t),Dh=i(tt,", \u2026 up to "),ji=s(tt,"CODE",{});var R5=a(ji);Sh=i(R5,"<extra_id_99>"),R5.forEach(t),Oh=i(tt,`. As a default, 100 sentinel tokens are available in
`),tr=s(tt,"A",{href:!0});var H5=a(tr);Gh=i(H5,"T5Tokenizer"),H5.forEach(t),Bh=i(tt,"."),tt.forEach(t),Uh=l(Lt),Fi=s(Lt,"P",{});var V5=a(Fi);Wh=i(V5,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),V5.forEach(t),Rh=l(Lt),_($o.$$.fragment,Lt),Hh=l(Lt),xo=s(Lt,"P",{});var Uc=a(xo);Vh=i(Uc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Eo=s(Uc,"A",{href:!0,rel:!0});var K5=a(Eo);Kh=i(K5,"run_t5_mlm_flax.py"),K5.forEach(t),Yh=i(Uc,` script in the Examples
directory.`),Uc.forEach(t),Lt.forEach(t),Jh=l(Bc),ge=s(Bc,"LI",{});var nt=a(ge);Mi=s(nt,"P",{});var Y5=a(Mi);Zh=i(Y5,"Supervised training"),Y5.forEach(t),Xh=l(nt),Pi=s(nt,"P",{});var J5=a(Pi);Qh=i(J5,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),J5.forEach(t),eu=l(nt),_(qo.$$.fragment,nt),tu=l(nt),re=s(nt,"P",{});var ye=a(re);nu=i(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ci=s(ye,"CODE",{});var Z5=a(Ci);ou=i(Z5,"input_ids"),Z5.forEach(t),su=i(ye,` (which are the
`),Ai=s(ye,"CODE",{});var X5=a(Ai);au=i(X5,"input_ids"),X5.forEach(t),ru=i(ye," of the encoded input sequence) and "),Ni=s(ye,"CODE",{});var Q5=a(Ni);iu=i(Q5,"labels"),Q5.forEach(t),du=i(ye," (which are the "),Li=s(ye,"CODE",{});var eb=a(Li);lu=i(eb,"input_ids"),eb.forEach(t),cu=i(ye,` of the encoded
