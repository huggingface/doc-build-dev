...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17771/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17771/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17771/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Df.forEach(t),Yk=p(lo),xt=s(lo,"DIV",{class:!0});var ha=a(xt);y(hr.$$.fragment,ha),Zk=p(ha),Co=s(ha,"P",{});var fc=a(Co);e1=i(fc,"The "),Ad=s(fc,"A",{href:!0});var N7=a(Ad);t1=i(N7,"ElectraForCausalLM"),N7.forEach(t),o1=i(fc," forward method, overrides the "),ip=s(fc,"CODE",{});var I7=a(ip);n1=i(I7,"__call__"),I7.forEach(t),s1=i(fc," special method."),fc.forEach(t),a1=p(ha),y(Nn.$$.fragment,ha),r1=p(ha),y(In.$$.fragment,ha),ha.forEach(t),lo.forEach(t),Su=p(o),qo=s(o,"H2",{class:!0});var Sf=a(qo);Dn=s(Sf,"A",{id:!0,class:!0,href:!0});var D7=a(Dn);lp=s(D7,"SPAN",{});var S7=a(lp);y(mr.$$.fragment,S7),S7.forEach(t),D7.forEach(t),i1=p(Sf),dp=s(Sf,"SPAN",{});var W7=a(dp);l1=i(W7,"ElectraForMaskedLM"),W7.forEach(t),Sf.forEach(t),Wu=p(o),Qe=s(o,"DIV",{class:!0});var Wt=a(Qe);y(ur.$$.fragment,Wt),d1=p(Wt),cp=s(Wt,"P",{});var U7=a(cp);c1=i(U7,"Electra model with a language modeling head on top."),U7.forEach(t),p1=p(Wt),pp=s(Wt,"P",{});var B7=a(pp);h1=i(B7,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),B7.forEach(t),m1=p(Wt),fr=s(Wt,"P",{});var Wf=a(fr);u1=i(Wf,"This model inherits from "),Od=s(Wf,"A",{href:!0});var R7=a(Od);f1=i(R7,"PreTrainedModel"),R7.forEach(t),g1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_1=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);k1=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var H7=a(_r);v1=i(H7,"torch.nn.Module"),H7.forEach(t),T1=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),b1=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),y1=p(co),Po=s(co,"P",{});var gc=a(Po);E1=i(gc,"The "),Ld=s(gc,"A",{href:!0});var Q7=a(Ld);w1=i(Q7,"ElectraForMaskedLM"),Q7.forEach(t),$1=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V7=a(hp);F1=i(V7,"__call__"),V7.forEach(t),x1=i(gc," special method."),gc.forEach(t),M1=p(co),y(Sn.$$.fragment,co),z1=p(co),y(Wn.$$.fragment,co),j1=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Bf=a(Ao);Bn=s(Bf,"A",{id:!0,class:!0,href:!0});var K7=a(Bn);mp=s(K7,"SPAN",{});var J7=a(mp);y(vr.$$.fragment,J7),J7.forEach(t),K7.forEach(t),C1=p(Bf),up=s(Bf,"SPAN",{});var G7=a(up);q1=i(G7,"ElectraForSequenceClassification"),G7.forEach(t),Bf.forEach(t),Bu=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),P1=p(po),fp=s(po,"P",{});var X7=a(fp);A1=i(X7,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X7.forEach(t),O1=p(po),br=s(po,"P",{});var Rf=a(br);L1=i(Rf,"This model inherits from "),Nd=s(Rf,"A",{href:!0});var Y7=a(Nd);N1=i(Y7,"PreTrainedModel"),Y7.forEach(t),I1=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),D1=p(po),yr=s(po,"P",{});var Hf=a(yr);S1=i(Hf,"This model is also a PyTorch "),Er=s(Hf,"A",{href:!0,rel:!0});var Z7=a(Er);W1=i(Z7,"torch.nn.Module"),Z7.forEach(t),U1=i(Hf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hf.forEach(t),B1=p(po),Re=s(po,"DIV",{class:!0});var ht=a(Re);y(wr.$$.fragment,ht),R1=p(ht),Oo=s(ht,"P",{});var _c=a(Oo);H1=i(_c,"The "),Id=s(_c,"A",{href:!0});var e0=a(Id);Q1=i(e0,"ElectraForSequenceClassification"),e0.forEach(t),V1=i(_c," forward method, overrides the "),gp=s(_c,"CODE",{});var t0=a(gp);K1=i(t0,"__call__"),t0.forEach(t),J1=i(_c," special method."),_c.forEach(t),G1=p(ht),y(Rn.$$.fragment,ht),X1=p(ht),y(Hn.$$.fragment,ht),Y1=p(ht),y(Qn.$$.fragment,ht),Z1=p(ht),y(Vn.$$.fragment,ht),ev=p(ht),y(Kn.$$.fragment,ht),ht.forEach(t),po.forEach(t),Ru=p(o),Lo=s(o,"H2",{class:!0});var Qf=a(Lo);Jn=s(Qf,"A",{id:!0,class:!0,href:!0});var o0=a(Jn);_p=s(o0,"SPAN",{});var n0=a(_p);y($r.$$.fragment,n0),n0.forEach(t),o0.forEach(t),tv=p(Qf),kp=s(Qf,"SPAN",{});var s0=a(kp);ov=i(s0,"ElectraForMultipleChoice"),s0.forEach(t),Qf.forEach(t),Hu=p(o),nt=s(o,"DIV",{class:!0});var ho=a(nt);y(Fr.$$.fragment,ho),nv=p(ho),vp=s(ho,"P",{});var a0=a(vp);sv=i(a0,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xf.forEach(t),Lv=p(Ut),rt=s(Ut,"DIV",{class:!0});var mo=a(rt);y(Lr.$$.fragment,mo),Nv=p(mo),Do=s(mo,"P",{});var vc=a(Do);Iv=i(vc,"The "),Ud=s(vc,"A",{href:!0});var _0=a(Ud);Dv=i(_0,"ElectraForTokenClassification"),_0.forEach(t),Sv=i(vc," forward method, overrides the "),$p=s(vc,"CODE",{});var k0=a($p);Wv=i(k0,"__call__"),k0.forEach(t),Uv=i(vc," special method."),vc.forEach(t),Bv=p(mo),y(Zn.$$.fragment,mo),Rv=p(mo),y(es.$$.fragment,mo),Hv=p(mo),y(ts.$$.fragment,mo),mo.forEach(t),Ut.forEach(t),Ku=p(o),So=s(o,"H2",{class:!0});var Yf=a(So);os=s(Yf,"A",{id:!0,class:!0,href:!0});var v0=a(os);Fp=s(v0,"SPAN",{});var T0=a(Fp);y(Nr.$$.fragment,T0),T0.forEach(t),v0.forEach(t),Qv=p(Yf),xp=s(Yf,"SPAN",{});var b0=a(xp);Vv=i(b0,"ElectraForQuestionAnswering"),b0.forEach(t),Yf.forEach(t),Ju=p(o),st=s(o,"DIV",{class:!0});var uo=a(st);y(Ir.$$.fragment,uo),Kv=p(uo),Wo=s(uo,"P",{});var Tc=a(Wo);Jv=i(Tc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mp=s(Tc,"CODE",{});var y0=a(Mp);Gv=i(y0,"span start logits"),y0.forEach(t),Xv=i(Tc," and "),zp=s(Tc,"CODE",{});var E0=a(zp);Yv=i(E0,"span end logits"),E0.forEach(t),Zv=i(Tc,")."),Tc.forEach(t),eT=p(uo),Dr=s(uo,"P",{});var Zf=a(Dr);tT=i(Zf,"This model inherits from "),Bd=s(Zf,"A",{href:!0});var w0=a(Bd);oT=i(w0,"PreTrainedModel"),w0.forEach(t),nT=i(Zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg.forEach(t),lT=p(uo),it=s(uo,"DIV",{class:!0});var fo=a(it);y(Ur.$$.fragment,fo),dT=p(fo),Uo=s(fo,"P",{});var bc=a(Uo);cT=i(bc,"The "),Rd=s(bc,"A",{href:!0});var F0=a(Rd);pT=i(F0,"ElectraForQuestionAnswering"),F0.forEach(t),hT=i(bc," forward method, overrides the "),jp=s(bc,"CODE",{});var x0=a(jp);mT=i(x0,"__call__"),x0.forEach(t),uT=i(bc," special method."),bc.forEach(t),fT=p(fo),y(ns.$$.fragment,fo),gT=p(fo),y(ss.$$.fragment,fo),_T=p(fo),y(as.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Gu=p(o),Bo=s(o,"H2",{class:!0});var tg=a(Bo);rs=s(tg,"A",{id:!0,class:!0,href:!0});var M0=a(rs);Cp=s(M0,"SPAN",{});var z0=a(Cp);y(Br.$$.fragment,z0),z0.forEach(t),M0.forEach(t),kT=p(tg),qp=s(tg,"SPAN",{});var j0=a(qp);vT=i(j0,"TFElectraModel"),j0.forEach(t),tg.forEach(t),Xu=p(o),Ke=s(o,"DIV",{class:!0});var Bt=a(Ke);y(Rr.$$.fragment,Bt),TT=p(Bt),Pp=s(Bt,"P",{});var C0=a(Pp);bT=i(C0,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),C0.forEach(t),yT=p(Bt),Hr=s(Bt,"P",{});var og=a(Hr);ET=i(og,"This model inherits from "),Hd=s(og,"A",{href:!0});var q0=a(Hd);wT=i(q0,"TFPreTrainedModel"),q0.forEach(t),$T=i(og,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),og.forEach(t),FT=p(Bt),Qr=s(Bt,"P",{});var ng=a(Qr);xT=i(ng,"This model is also a "),Vr=s(ng,"A",{href:!0,rel:!0});var P0=a(Vr);MT=i(P0,"tf.keras.Model"),P0.forEach(t),zT=i(ng,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ng.forEach(t),jT=p(Bt),y(is.$$.fragment,Bt),CT=p(Bt),zt=s(Bt,"DIV",{class:!0});var ua=a(zt);y(Kr.$$.fragment,ua),qT=p(ua),Ro=s(ua,"P",{});var yc=a(Ro);PT=i(yc,"The "),Qd=s(yc,"A",{href:!0});var A0=a(Qd);AT=i(A0,"TFElectraModel"),A0.forEach(t),OT=i(yc," forward method, overrides the "),Ap=s(yc,"CODE",{});var O0=a(Ap);LT=i(O0,"__call__"),O0.forEach(t),NT=i(yc," special method."),yc.forEach(t),IT=p(ua),y(ls.$$.fragment,ua),DT=p(ua),y(ds.$$.fragment,ua),ua.forEach(t),Bt.forEach(t),Yu=p(o),Ho=s(o,"H2",{class:!0});var sg=a(Ho);cs=s(sg,"A",{id:!0,class:!0,href:!0});var L0=a(cs);Op=s(L0,"SPAN",{});var N0=a(Op);y(Jr.$$.fragment,N0),N0.forEach(t),L0.forEach(t),ST=p(sg),Lp=s(sg,"SPAN",{});var I0=a(Lp);WT=i(I0,"TFElectraForPreTraining"),I0.forEach(t),sg.forEach(t),Zu=p(o),Oe=s(o,"DIV",{class:!0});var mt=a(Oe);y(Gr.$$.fragment,mt),UT=p(mt),Np=s(mt,"P",{});var D0=a(Np);BT=i(D0,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),D0.forEach(t),RT=p(mt),Ip=s(mt,"P",{});var S0=a(Ip);HT=i(S0,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rg.forEach(t),eb=p(mt),y(ps.$$.fragment,mt),tb=p(mt),jt=s(mt,"DIV",{class:!0});var fa=a(jt);y(ei.$$.fragment,fa),ob=p(fa),Qo=s(fa,"P",{});var Ec=a(Qo);nb=i(Ec,"The "),Kd=s(Ec,"A",{href:!0});var B0=a(Kd);sb=i(B0,"TFElectraForPreTraining"),B0.forEach(t),ab=i(Ec," forward method, overrides the "),Dp=s(Ec,"CODE",{});var R0=a(Dp);rb=i(R0,"__call__"),R0.forEach(t),ib=i(Ec," special method."),Ec.forEach(t),lb=p(fa),y(hs.$$.fragment,fa),db=p(fa),y(ms.$$.fragment,fa),fa.forEach(t),mt.forEach(t),ef=p(o),Vo=s(o,"H2",{class:!0});var ig=a(Vo);us=s(ig,"A",{id:!0,class:!0,href:!0});var H0=a(us);Sp=s(H0,"SPAN",{});var Q0=a(Sp);y(ti.$$.fragment,Q0),Q0.forEach(t),H0.forEach(t),cb=p(ig),Wp=s(ig,"SPAN",{});var V0=a(Wp);pb=i(V0,"TFElectraForMaskedLM"),V0.forEach(t),ig.forEach(t),tf=p(o),Le=s(o,"DIV",{class:!0});var ut=a(Le);y(oi.$$.fragment,ut),hb=p(ut),Up=s(ut,"P",{});var K0=a(Up);mb=i(K0,"Electra model with a language modeling head on top."),K0.forEach(t),ub=p(ut),Bp=s(ut,"P",{});var J0=a(Bp);fb=i(J0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dg.forEach(t),wb=p(ut),y(fs.$$.fragment,ut),$b=p(ut),lt=s(ut,"DIV",{class:!0});var go=a(lt);y(ri.$$.fragment,go),Fb=p(go),Ko=s(go,"P",{});var wc=a(Ko);xb=i(wc,"The "),Gd=s(wc,"A",{href:!0});var Y0=a(Gd);Mb=i(Y0,"TFElectraForMaskedLM"),Y0.forEach(t),zb=i(wc," forward method, overrides the "),Rp=s(wc,"CODE",{});var Z0=a(Rp);jb=i(Z0,"__call__"),Z0.forEach(t),Cb=i(wc," special method."),wc.forEach(t),qb=p(go),y(gs.$$.fragment,go),Pb=p(go),y(_s.$$.fragment,go),Ab=p(go),y(ks.$$.fragment,go),go.forEach(t),ut.forEach(t),of=p(o),Jo=s(o,"H2",{class:!0});var cg=a(Jo);vs=s(cg,"A",{id:!0,class:!0,href:!0});var ex=a(vs);Hp=s(ex,"SPAN",{});var tx=a(Hp);y(ii.$$.fragment,tx),tx.forEach(t),ex.forEach(t),Ob=p(cg),Qp=s(cg,"SPAN",{});var ox=a(Qp);Lb=i(ox,"TFElectraForSequenceClassification"),ox.forEach(t),cg.forEach(t),nf=p(o),Je=s(o,"DIV",{class:!0});var Rt=a(Je);y(li.$$.fragment,Rt),Nb=p(Rt),Vp=s(Rt,"P",{});var nx=a(Vp);Ib=i(nx,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),nx.forEach(t),Db=p(Rt),di=s(Rt,"P",{});var pg=a(di);Sb=i(pg,"This model inherits from "),Xd=s(pg,"A",{href:!0});var sx=a(Xd);Wb=i(sx,"TFPreTrainedModel"),sx.forEach(t),Ub=i(pg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pg.forEach(t),Bb=p(Rt),ci=s(Rt,"P",{});var hg=a(ci);Rb=i(hg,"This model is also a "),pi=s(hg,"A",{href:!0,rel:!0});var ax=a(pi);Hb=i(ax,"tf.keras.Model"),ax.forEach(t),Qb=i(hg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg.forEach(t),Vb=p(Rt),y(Ts.$$.fragment,Rt),Kb=p(Rt),dt=s(Rt,"DIV",{class:!0});var _o=a(dt);y(hi.$$.fragment,_o),Jb=p(_o),Go=s(_o,"P",{});var $c=a(Go);Gb=i($c,"The "),Yd=s($c,"A",{href:!0});var rx=a(Yd);Xb=i(rx,"TFElectraForSequenceClassification"),rx.forEach(t),Yb=i($c," forward method, overrides the "),Kp=s($c,"CODE",{});var ix=a(Kp);Zb=i(ix,"__call__"),ix.forEach(t),ey=i($c," special method."),$c.forEach(t),ty=p(_o),y(bs.$$.fragment,_o),oy=p(_o),y(ys.$$.fragment,_o),ny=p(_o),y(Es.$$.fragment,_o),_o.forEach(t),Rt.forEach(t),sf=p(o),Xo=s(o,"H2",{class:!0});var mg=a(Xo);ws=s(mg,"A",{id:!0,class:!0,href:!0});var lx=a(ws);Jp=s(lx,"SPAN",{});var dx=a(Jp);y(mi.$$.fragment,dx),dx.forEach(t),lx.forEach(t),sy=p(mg),Gp=s(mg,"SPAN",{});var cx=a(Gp);ay=i(cx,"TFElectraForMultipleChoice"),cx.forEach(t),mg.forEach(t),af=p(o),Ge=s(o,"DIV",{class:!0});var Ht=a(Ge);y(ui.$$.fragment,Ht),ry=p(Ht),Xp=s(Ht,"P",{});var px=a(Xp);iy=i(px,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),px.forEach(t),ly=p(Ht),fi=s(Ht,"P",{});var ug=a(fi);dy=i(ug,"This model inherits from "),Zd=s(ug,"A",{href:!0});var hx=a(Zd);cy=i(hx,"TFPreTrainedModel"),hx.forEach(t),py=i(ug,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ug.forEach(t),hy=p(Ht),gi=s(Ht,"P",{});var fg=a(gi);my=i(fg,"This model is also a "),_i=s(fg,"A",{href:!0,rel:!0});var mx=a(_i);uy=i(mx,"tf.keras.Model"),mx.forEach(t),fy=i(fg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),gy=p(Ht),y($s.$$.fragment,Ht),_y=p(Ht),Ct=s(Ht,"DIV",{class:!0});var ga=a(Ct);y(ki.$$.fragment,ga),ky=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);vy=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var ux=a(ec);Ty=i(ux,"TFElectraForMultipleChoice"),ux.forEach(t),by=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var fx=a(Yp);yy=i(fx,"__call__"),fx.forEach(t),Ey=i(Fc," special method."),Fc.forEach(t),wy=p(ga),y(Fs.$$.fragment,ga),$y=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Ht.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var gx=a(Ms);Zp=s(gx,"SPAN",{});var _x=a(Zp);y(vi.$$.fragment,_x),_x.forEach(t),gx.forEach(t),Fy=p(gg),eh=s(gg,"SPAN",{});var kx=a(eh);xy=i(kx,"TFElectraForTokenClassification"),kx.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),My=p(ft),th=s(ft,"P",{});var vx=a(th);zy=i(vx,"Electra model with a token classification head on top."),vx.forEach(t),jy=p(ft),oh=s(ft,"P",{});var Tx=a(oh);Cy=i(Tx,"Both the discriminator and generator may be loaded into this model."),Tx.forEach(t),qy=p(ft),bi=s(ft,"P",{});var _g=a(bi);Py=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var bx=a(tc);Ay=i(bx,"TFPreTrainedModel"),bx.forEach(t),Oy=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
