...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17771/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17771/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17771/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Df.forEach(t),Yk=p(lo),xt=s(lo,"DIV",{class:!0});var ha=a(xt);y(hr.$$.fragment,ha),Zk=p(ha),Co=s(ha,"P",{});var fc=a(Co);e1=i(fc,"The "),Ad=s(fc,"A",{href:!0});var N7=a(Ad);t1=i(N7,"ElectraForCausalLM"),N7.forEach(t),o1=i(fc," forward method, overrides the "),ip=s(fc,"CODE",{});var I7=a(ip);n1=i(I7,"__call__"),I7.forEach(t),s1=i(fc," special method."),fc.forEach(t),a1=p(ha),y(Nn.$$.fragment,ha),r1=p(ha),y(In.$$.fragment,ha),ha.forEach(t),lo.forEach(t),Su=p(o),qo=s(o,"H2",{class:!0});var Sf=a(qo);Dn=s(Sf,"A",{id:!0,class:!0,href:!0});var D7=a(Dn);lp=s(D7,"SPAN",{});var S7=a(lp);y(mr.$$.fragment,S7),S7.forEach(t),D7.forEach(t),i1=p(Sf),dp=s(Sf,"SPAN",{});var W7=a(dp);l1=i(W7,"ElectraForMaskedLM"),W7.forEach(t),Sf.forEach(t),Wu=p(o),Be=s(o,"DIV",{class:!0});var Wt=a(Be);y(ur.$$.fragment,Wt),d1=p(Wt),cp=s(Wt,"P",{});var U7=a(cp);c1=i(U7,"Electra model with a language modeling head on top."),U7.forEach(t),p1=p(Wt),pp=s(Wt,"P",{});var R7=a(pp);h1=i(R7,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),R7.forEach(t),m1=p(Wt),fr=s(Wt,"P",{});var Wf=a(fr);u1=i(Wf,"This model inherits from "),Od=s(Wf,"A",{href:!0});var H7=a(Od);f1=i(H7,"PreTrainedModel"),H7.forEach(t),g1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_1=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);k1=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var Q7=a(_r);v1=i(Q7,"torch.nn.Module"),Q7.forEach(t),T1=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),b1=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),y1=p(co),Po=s(co,"P",{});var gc=a(Po);E1=i(gc,"The "),Ld=s(gc,"A",{href:!0});var B7=a(Ld);w1=i(B7,"ElectraForMaskedLM"),B7.forEach(t),$1=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V7=a(hp);F1=i(V7,"__call__"),V7.forEach(t),x1=i(gc," special method."),gc.forEach(t),M1=p(co),y(Sn.$$.fragment,co),z1=p(co),y(Wn.$$.fragment,co),j1=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Rf=a(Ao);Rn=s(Rf,"A",{id:!0,class:!0,href:!0});var K7=a(Rn);mp=s(K7,"SPAN",{});var J7=a(mp);y(vr.$$.fragment,J7),J7.forEach(t),K7.forEach(t),C1=p(Rf),up=s(Rf,"SPAN",{});var G7=a(up);q1=i(G7,"ElectraForSequenceClassification"),G7.forEach(t),Rf.forEach(t),Ru=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),P1=p(po),fp=s(po,"P",{});var X7=a(fp);A1=i(X7,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X7.forEach(t),O1=p(po),br=s(po,"P",{});var Hf=a(br);L1=i(Hf,"This model inherits from "),Nd=s(Hf,"A",{href:!0});var Y7=a(Nd);N1=i(Y7,"PreTrainedModel"),Y7.forEach(t),I1=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),D1=p(po),yr=s(po,"P",{});var Qf=a(yr);S1=i(Qf,"This model is also a PyTorch "),Er=s(Qf,"A",{href:!0,rel:!0});var Z7=a(Er);W1=i(Z7,"torch.nn.Module"),Z7.forEach(t),U1=i(Qf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
