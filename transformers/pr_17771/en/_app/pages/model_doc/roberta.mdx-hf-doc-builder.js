...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/roberta/tokenization_roberta.py#L396",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17771/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),e1=h(oa),zo=s(oa,"P",{});var Qd=a(zo);t1=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s0=a(fd);o1=i(s0,"RobertaForMultipleChoice"),s0.forEach(t),n1=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a0=a(op);s1=i(a0,"__call__"),a0.forEach(t),a1=i(Qd," special method."),Qd.forEach(t),r1=h(oa),y(Qn.$$.fragment,oa),i1=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var r0=a(Vn);np=s(r0,"SPAN",{});var i0=a(np);y(Tr.$$.fragment,i0),i0.forEach(t),r0.forEach(t),l1=h(cu),sp=s(cu,"SPAN",{});var l0=a(sp);d1=i(l0,"RobertaForTokenClassification"),l0.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),c1=h(io),ap=s(io,"P",{});var d0=a(ap);p1=i(d0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d0.forEach(t),h1=h(io),wr=s(io,"P",{});var pu=a(wr);m1=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var c0=a(ud);f1=i(c0,"PreTrainedModel"),c0.forEach(t),u1=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),g1=h(io),$r=s(io,"P",{});var hu=a($r);_1=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var p0=a(Fr);b1=i(p0,"torch.nn.Module"),p0.forEach(t),k1=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),v1=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),T1=h(lo),Co=s(lo,"P",{});var Jd=a(Co);y1=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h0=a(gd);w1=i(h0,"RobertaForTokenClassification"),h0.forEach(t),$1=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var m0=a(rp);F1=i(m0,"__call__"),m0.forEach(t),x1=i(Jd," special method."),Jd.forEach(t),R1=h(lo),y(Kn.$$.fragment,lo),M1=h(lo),y(Gn.$$.fragment,lo),E1=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f0=a(Yn);ip=s(f0,"SPAN",{});var u0=a(ip);y(Rr.$$.fragment,u0),u0.forEach(t),f0.forEach(t),z1=h(mu),lp=s(mu,"SPAN",{});var g0=a(lp);q1=i(g0,"RobertaForQuestionAnswering"),g0.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),C1=h(co),Po=s(co,"P",{});var Vd=a(Po);j1=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _0=a(dp);P1=i(_0,"span start logits"),_0.forEach(t),L1=i(Vd," and "),cp=s(Vd,"CODE",{});var b0=a(cp);A1=i(b0,"span end logits"),b0.forEach(t),O1=i(Vd,")."),Vd.forEach(t),N1=h(co),Er=s(co,"P",{});var fu=a(Er);I1=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k0=a(_d);D1=i(k0,"PreTrainedModel"),k0.forEach(t),S1=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),W1=h(co),zr=s(co,"P",{});var uu=a(zr);B1=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var v0=a(qr);U1=i(v0,"torch.nn.Module"),v0.forEach(t),H1=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Q1=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),J1=h(po),Lo=s(po,"P",{});var Kd=a(Lo);V1=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T0=a(bd);K1=i(T0,"RobertaForQuestionAnswering"),T0.forEach(t),G1=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y0=a(pp);X1=i(y0,"__call__"),y0.forEach(t),Y1=i(Kd," special method."),Kd.forEach(t),Z1=h(po),y(Zn.$$.fragment,po),ev=h(po),y(es.$$.fragment,po),tv=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);y(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),ov=h(gu),mp=s(gu,"SPAN",{});var F0=a(mp);nv=i(F0,"TFRobertaModel"),F0.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sv=h(Ot),fp=s(Ot,"P",{});var x0=a(fp);av=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),rv=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iv=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R0=a(kd);lv=i(R0,"TFPreTrainedModel"),R0.forEach(t),dv=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cv=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);pv=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M0=a(Or);hv=i(M0,"tf.keras.Model"),M0.forEach(t),mv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fv=h(Ot),y(ns.$$.fragment,Ot),uv=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gv=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_v=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);bv=i(E0,"TFRobertaModel"),E0.forEach(t),kv=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z0=a(up);vv=i(z0,"__call__"),z0.forEach(t),Tv=i(Gd," special method."),Gd.forEach(t),yv=h(na),y(ss.$$.fragment,na),wv=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var q0=a(rs);gp=s(q0,"SPAN",{});var C0=a(gp);y(Ir.$$.fragment,C0),C0.forEach(t),q0.forEach(t),$v=h(ku),_p=s(ku,"SPAN",{});var j0=a(_p);Fv=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),xv=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),Rv=h(sa),Do=s(sa,"P",{});var Xd=a(Do);Mv=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P0=a(Td);Ev=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),zv=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);qv=i(L0,"__call__"),L0.forEach(t),Cv=i(Xd," special method."),Xd.forEach(t),jv=h(sa),y(is.$$.fragment,sa),Pv=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);y(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),Lv=h(Tu),vp=s(Tu,"SPAN",{});var N0=a(vp);Av=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),Tu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),Ov=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);Nv=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var I0=a(Tp);Iv=i(I0,"language modeling"),I0.forEach(t),Dv=i(yu," head on top."),yu.forEach(t),Sv=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wv=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var D0=a(yd);Bv=i(D0,"TFPreTrainedModel"),D0.forEach(t),Uv=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Hv=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Qv=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var S0=a(Jr);Jv=i(S0,"tf.keras.Model"),S0.forEach(t),Vv=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),Kv=h(Nt),y(cs.$$.fragment,Nt),Gv=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),Xv=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yv=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);Zv=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),eT=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B0=a(yp);tT=i(B0,"__call__"),B0.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),y(ps.$$.fragment,ho),sT=h(ho),y(hs.$$.fragment,ho),aT=h(ho),y(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U0=a(fs);wp=s(U0,"SPAN",{});var H0=a(wp);y(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Q0=a($p);iT=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var J0=a(Fp);dT=i(J0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);HT=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);JT=i(ax,"__call__"),ax.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var rx=a(ws);qp=s(rx,"SPAN",{});var ix=a(qp);y(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),XT=h(qu),Cp=s(qu,"SPAN",{});var lx=a(Cp);YT=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dx=a(jp);ey=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),ty=h(St),di=s(St,"P",{});var Cu=a(di);oy=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var cx=a(Md);ny=i(cx,"TFPreTrainedModel"),cx.forEach(t),sy=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var px=a(pi);iy=i(px,"tf.keras.Model"),px.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);my=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mx=a(Pp);uy=i(mx,"__call__"),mx.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var ux=a(Lp);y(mi.$$.fragment,ux),ux.forEach(t),fx.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var gx=a(Ap);Ty=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _x=a(Op);$y=i(_x,"span start logits"),_x.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var bx=a(Np);xy=i(bx,"span end logits"),bx.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kx=a(zd);zy=i(kx,"TFPreTrainedModel"),kx.forEach(t),qy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),Cy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vx=a(_i);Py=i(vx,"tf.keras.Model"),vx.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),qd=s(nc,"A",{href:!0});var Tx=a(qd);Dy=i(Tx,"TFRobertaForQuestionAnswering"),Tx.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yx=a(Ip);Wy=i(yx,"__call__"),yx.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(qs.$$.fragment,uo),Qy=h(uo),y(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);y(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),Jy=h(Ou),Sp=s(Ou,"SPAN",{});var Fx=a(Sp);Vy=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);Gy=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var Rx=a(Cd);Zy=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
