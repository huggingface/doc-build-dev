...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),e1=h(oa),zo=s(oa,"P",{});var Qd=a(zo);t1=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s0=a(fd);o1=i(s0,"RobertaForMultipleChoice"),s0.forEach(t),n1=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a0=a(op);s1=i(a0,"__call__"),a0.forEach(t),a1=i(Qd," special method."),Qd.forEach(t),r1=h(oa),y(Qn.$$.fragment,oa),i1=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cm=a(qo);Vn=s(cm,"A",{id:!0,class:!0,href:!0});var r0=a(Vn);np=s(r0,"SPAN",{});var i0=a(np);y(Tr.$$.fragment,i0),i0.forEach(t),r0.forEach(t),l1=h(cm),sp=s(cm,"SPAN",{});var l0=a(sp);d1=i(l0,"RobertaForTokenClassification"),l0.forEach(t),cm.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),c1=h(io),ap=s(io,"P",{});var d0=a(ap);p1=i(d0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d0.forEach(t),h1=h(io),wr=s(io,"P",{});var pm=a(wr);u1=i(pm,"This model inherits from "),md=s(pm,"A",{href:!0});var c0=a(md);f1=i(c0,"PreTrainedModel"),c0.forEach(t),m1=i(pm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pm.forEach(t),g1=h(io),$r=s(io,"P",{});var hm=a($r);_1=i(hm,"This model is also a PyTorch "),Fr=s(hm,"A",{href:!0,rel:!0});var p0=a(Fr);b1=i(p0,"torch.nn.Module"),p0.forEach(t),k1=i(hm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),v1=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),T1=h(lo),Co=s(lo,"P",{});var Jd=a(Co);y1=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h0=a(gd);w1=i(h0,"RobertaForTokenClassification"),h0.forEach(t),$1=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var u0=a(rp);F1=i(u0,"__call__"),u0.forEach(t),x1=i(Jd," special method."),Jd.forEach(t),R1=h(lo),y(Kn.$$.fragment,lo),M1=h(lo),y(Gn.$$.fragment,lo),E1=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var um=a(jo);Yn=s(um,"A",{id:!0,class:!0,href:!0});var f0=a(Yn);ip=s(f0,"SPAN",{});var m0=a(ip);y(Rr.$$.fragment,m0),m0.forEach(t),f0.forEach(t),z1=h(um),lp=s(um,"SPAN",{});var g0=a(lp);q1=i(g0,"RobertaForQuestionAnswering"),g0.forEach(t),um.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),C1=h(co),Po=s(co,"P",{});var Vd=a(Po);j1=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _0=a(dp);P1=i(_0,"span start logits"),_0.forEach(t),L1=i(Vd," and "),cp=s(Vd,"CODE",{});var b0=a(cp);A1=i(b0,"span end logits"),b0.forEach(t),O1=i(Vd,")."),Vd.forEach(t),N1=h(co),Er=s(co,"P",{});var fm=a(Er);I1=i(fm,"This model inherits from "),_d=s(fm,"A",{href:!0});var k0=a(_d);D1=i(k0,"PreTrainedModel"),k0.forEach(t),S1=i(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fm.forEach(t),W1=h(co),zr=s(co,"P",{});var mm=a(zr);B1=i(mm,"This model is also a PyTorch "),qr=s(mm,"A",{href:!0,rel:!0});var v0=a(qr);U1=i(v0,"torch.nn.Module"),v0.forEach(t),H1=i(mm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm.forEach(t),Q1=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),J1=h(po),Lo=s(po,"P",{});var Kd=a(Lo);V1=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T0=a(bd);K1=i(T0,"RobertaForQuestionAnswering"),T0.forEach(t),G1=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y0=a(pp);X1=i(y0,"__call__"),y0.forEach(t),Y1=i(Kd," special method."),Kd.forEach(t),Z1=h(po),y(Zn.$$.fragment,po),ev=h(po),y(es.$$.fragment,po),tv=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gm=a(Ao);os=s(gm,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);y(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),ov=h(gm),up=s(gm,"SPAN",{});var F0=a(up);nv=i(F0,"TFRobertaModel"),F0.forEach(t),gm.forEach(t),uf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sv=h(Ot),fp=s(Ot,"P",{});var x0=a(fp);av=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),rv=h(Ot),Lr=s(Ot,"P",{});var _m=a(Lr);iv=i(_m,"This model inherits from "),kd=s(_m,"A",{href:!0});var R0=a(kd);lv=i(R0,"TFPreTrainedModel"),R0.forEach(t),dv=i(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),cv=h(Ot),Ar=s(Ot,"P",{});var bm=a(Ar);pv=i(bm,"This model is also a "),Or=s(bm,"A",{href:!0,rel:!0});var M0=a(Or);hv=i(M0,"tf.keras.Model"),M0.forEach(t),uv=i(bm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bm.forEach(t),fv=h(Ot),y(ns.$$.fragment,Ot),mv=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gv=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_v=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);bv=i(E0,"TFRobertaModel"),E0.forEach(t),kv=i(Gd," forward method, overrides the "),mp=s(Gd,"CODE",{});var z0=a(mp);vv=i(z0,"__call__"),z0.forEach(t),Tv=i(Gd," special method."),Gd.forEach(t),yv=h(na),y(ss.$$.fragment,na),wv=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var km=a(No);rs=s(km,"A",{id:!0,class:!0,href:!0});var q0=a(rs);gp=s(q0,"SPAN",{});var C0=a(gp);y(Ir.$$.fragment,C0),C0.forEach(t),q0.forEach(t),$v=h(km),_p=s(km,"SPAN",{});var j0=a(_p);Fv=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),km.forEach(t),mf=h(o),Io=s(o,"DIV",{class:!0});var vm=a(Io);y(Dr.$$.fragment,vm),xv=h(vm),Mt=s(vm,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),Rv=h(sa),Do=s(sa,"P",{});var Xd=a(Do);Mv=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P0=a(Td);Ev=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),zv=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);qv=i(L0,"__call__"),L0.forEach(t),Cv=i(Xd," special method."),Xd.forEach(t),jv=h(sa),y(is.$$.fragment,sa),Pv=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vm.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tm=a(So);ds=s(Tm,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);y(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),Lv=h(Tm),vp=s(Tm,"SPAN",{});var N0=a(vp);Av=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),Tm.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),Ov=h(Nt),Ur=s(Nt,"P",{});var ym=a(Ur);Nv=i(ym,"RoBERTa Model with a "),Tp=s(ym,"CODE",{});var I0=a(Tp);Iv=i(I0,"language modeling"),I0.forEach(t),Dv=i(ym," head on top."),ym.forEach(t),Sv=h(Nt),Hr=s(Nt,"P",{});var wm=a(Hr);Wv=i(wm,"This model inherits from "),yd=s(wm,"A",{href:!0});var D0=a(yd);Bv=i(D0,"TFPreTrainedModel"),D0.forEach(t),Uv=i(wm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wm.forEach(t),Hv=h(Nt),Qr=s(Nt,"P",{});var $m=a(Qr);Qv=i($m,"This model is also a "),Jr=s($m,"A",{href:!0,rel:!0});var S0=a(Jr);Jv=i(S0,"tf.keras.Model"),S0.forEach(t),Vv=i($m,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),Kv=h(Nt),y(cs.$$.fragment,Nt),Gv=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),Xv=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yv=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);Zv=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),eT=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B0=a(yp);tT=i(B0,"__call__"),B0.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),y(ps.$$.fragment,ho),sT=h(ho),y(hs.$$.fragment,ho),aT=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fm=a(Bo);fs=s(Fm,"A",{id:!0,class:!0,href:!0});var U0=a(fs);wp=s(U0,"SPAN",{});var H0=a(wp);y(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),rT=h(Fm),$p=s(Fm,"SPAN",{});var Q0=a($p);iT=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Fm.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var J0=a(Fp);dT=i(J0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J0.forEach(t),cT=h(It),Xr=s(It,"P",{});var xm=a(Xr);pT=i(xm,"This model inherits from "),$d=s(xm,"A",{href:!0});var V0=a($d);hT=i(V0,"TFPreTrainedModel"),V0.forEach(t),uT=i(xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xm.forEach(t),fT=h(It),Yr=s(It,"P",{});var Rm=a(Yr);mT=i(Rm,"This model is also a "),Zr=s(Rm,"A",{href:!0,rel:!0});var K0=a(Zr);gT=i(K0,"tf.keras.Model"),K0.forEach(t),_T=i(Rm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),bT=h(It),y(ms.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vT=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G0=a(Fd);yT=i(G0,"TFRobertaForSequenceClassification"),G0.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X0=a(xp);$T=i(X0,"__call__"),X0.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(uo),y(gs.$$.fragment,uo),RT=h(uo),y(_s.$$.fragment,uo),MT=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mm=a(Ho);ks=s(Mm,"A",{id:!0,class:!0,href:!0});var Y0=a(ks);Rp=s(Y0,"SPAN",{});var Z0=a(Rp);y(ti.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),ET=h(Mm),Mp=s(Mm,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mm.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);CT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
