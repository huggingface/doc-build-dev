import{S as Bi,i as Si,s as Hi,e as r,k as c,w as p,t as o,M as Wi,c as l,d as s,m as d,a as i,x as _,h as a,b as h,F as t,g as f,y as g,q as y,o as w,B as b,v as Li}from"../chunks/vendor-6b77c823.js";import{T as nl}from"../chunks/Tip-39098574.js";import{I as xt}from"../chunks/IconCopyLink-7a11ce68.js";import{C as k}from"../chunks/CodeBlock-3a8b25a8.js";function Yi(Z){let m,E;return{c(){m=r("p"),E=o("If your model is very similar to a model inside the library, you can re-use the same configuration as this model.")},l(u){m=l(u,"P",{});var v=i(m);E=a(v,"If your model is very similar to a model inside the library, you can re-use the same configuration as this model."),v.forEach(s)},m(u,v){f(u,m,v),t(m,E)},d(u){u&&s(m)}}}function zi(Z){let m,E;return{c(){m=r("p"),E=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){m=l(u,"P",{});var v=i(m);E=a(v,"This API is experimental and may have some slight breaking changes in the next releases."),v.forEach(s)},m(u,v){f(u,m,v),t(m,E)},d(u){u&&s(m)}}}function Ui(Z){let m,E,u,v,z;return{c(){m=r("p"),E=o(`If copying a modeling files from the library, you will need to replace all the relative imports at the top of the file
...
to import from the `),u=l(I,"CODE",{});var ee=i(u);v=a(ee,"transformers"),ee.forEach(s),z=a(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,E),t(m,u),t(u,v),t(m,z)},d(P){P&&s(m)}}}function Gi(Z){let m,E,u,v,z,P,I,ee,sa,qs,Ge,oa,Is,Ke,aa,Ns,N,na,be,ra,la,Ve,ia,fa,xs,U,te,Ot,ve,ca,Dt,da,Os,se,ha,Ft,ma,ua,Ds,Je,pa,Fs,$e,Bs,Qe,_a,Ss,x,ke,ga,Bt,ya,wa,ba,G,va,St,$a,ka,Ht,Ea,ja,Ca,K,Pa,Wt,Aa,Ta,Lt,Ma,Ra,Hs,O,qa,Yt,Ia,Na,zt,xa,Oa,Ws,D,Da,Ut,Fa,Ba,Gt,Sa,Ha,Ls,Xe,Wa,Ys,Ee,zs,A,La,Kt,Ya,za,Vt,Ua,Ga,Jt,Ka,Va,Us,je,Gs,F,Ja,Ze,Qa,Xa,et,Za,en,Ks,V,oe,Qt,Ce,tn,Xt,sn,Vs,B,on,tt,an,nn,st,rn,ln,Js,ae,fn,Zt,cn,dn,Qs,Pe,Xs,ot,hn,Zs,Ae,eo,C,mn,es,un,pn,ts,_n,gn,ss,yn,wn,os,bn,vn,to,ne,so,S,$n,as,kn,En,at,jn,Cn,oo,nt,Pn,ao,Te,no,T,An,rt,Tn,Mn,lt,Rn,qn,it,In,Nn,ro,ft,xn,lo,Me,io,H,On,ct,Dn,Fn,dt,Bn,Sn,fo,J,re,ns,Re,Hn,rs,Wn,co,le,ho,$,Ln,ls,Yn,zn,is,Un,Gn,fs,Kn,Vn,cs,Jn,Qn,ds,Xn,Zn,hs,er,tr,ms,sr,or,mo,qe,uo,W,ar,us,nr,rr,ps,lr,ir,po,ie,_o,ht,fr,go,mt,cr,yo,Ie,wo,fe,dr,_s,hr,mr,bo,Ne,vo,ce,ur,ut,pr,_r,$o,pt,gr,ko,xe,Eo,_t,yr,jo,Oe,Co,gt,wr,Po,De,Ao,yt,br,To,Fe,Mo,M,vr,gs,$r,kr,ys,Er,jr,Be,Cr,Pr,Ro,de,Ar,wt,Tr,Mr,qo,Q,he,ws,Se,Rr,bs,qr,Io,R,Ir,vs,Nr,xr,He,Or,Dr,$s,Fr,Br,No,We,xo,me,Sr,ks,Hr,Wr,Oo,Le,Do,bt,Lr,Fo,X,ue,Es,Ye,Yr,js,zr,Bo,vt,Ur,So,L,Gr,Cs,Kr,Vr,Ps,Jr,Qr,Ho,ze,Wo,q,Xr,$t,Zr,el,As,tl,sl,Ts,ol,al,Lo;return P=new xt({}),ve=new xt({}),$e=new k({props:{code:`from transformers import PretrainedConfig
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">ResnetModel</span>(<span class="hljs-title class_ inherited__">PreTrainedModel</span>):
    ...
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, tensor, labels=<span class="hljs-literal">None</span></span>):
        ...
        <span class="hljs-keyword">return</span> {<span class="hljs-string">&quot;logits&quot;</span>: logits}`}}),ne=new nl({props:{$$slots:{default:[Yi]},$$scope:{ctx:Z}}}),Te=new k({props:{code:"resnet50d = ResnetModelForImageClassification(resnet50d_config)",highlighted:"resnet50d = ResnetModelForImageClassification(resnet50d_config)"}}),Me=new k({props:{code:`import timm
...
resnet50d.model.load_state_dict(pretrained_model.state_dict())`}}),Re=new xt({}),le=new nl({props:{warning:!0,$$slots:{default:[zi]},$$scope:{ctx:Z}}}),qe=new k({props:{code:`.
\u2514\u2500\u2500 resnet_model
    \u251C\u2500\u2500 __init__.py
...
`),be=r("a"),ra=o("timm library"),la=o(" into a "),Ve=r("a"),ia=o("PreTrainedModel"),fa=o("."),xs=c(),U=r("h2"),te=r("a"),Ot=r("span"),p(ve.$$.fragment),ca=c(),Dt=r("span"),da=o("Writing a custom configuration"),Os=c(),se=r("p"),ha=o(`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
...
after checking the validity of a few of them.`),Fs=c(),p($e.$$.fragment),Bs=c(),Qe=r("p"),_a=o("The three important things to remember when writing you own configuration are the following:"),Ss=c(),x=r("ul"),ke=r("li"),ga=o("you have to inherit from "),Bt=r("code"),ya=o("PretrainedConfig"),wa=o(","),ba=c(),G=r("li"),va=o("the "),St=r("code"),$a=o("__init__"),ka=o(" of your "),Ht=r("code"),Ea=o("PretrainedConfig"),ja=o(" must accept any kwargs,"),Ca=c(),K=r("li"),Pa=o("those "),Wt=r("code"),Aa=o("kwargs"),Ta=o(" need to be passed to the superclass "),Lt=r("code"),Ma=o("__init__"),Ra=o("."),Hs=c(),O=r("p"),qa=o(`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Ws=c(),D=r("p"),Da=o("Defining a "),Ut=r("code"),Fa=o("model_type"),Ba=o(" for your configuration (here "),Gt=r("code"),Sa=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
library. Here is how we can create a resnet50d config and save it:`),Ys=c(),p(Ee.$$.fragment),zs=c(),A=r("p"),La=o("This will save a file named "),Kt=r("code"),Ya=o("config.json"),za=o(" inside the folder "),Vt=r("code"),Ua=o("custom-resnet"),Ga=o(`. You can then reload your config with the
`),Jt=r("code"),Ka=o("from_pretrained"),Va=o(" method:"),Us=c(),p(je.$$.fragment),Gs=c(),F=r("p"),Ja=o("You can also use any other method of the "),Ze=r("a"),Qa=o("PretrainedConfig"),Xa=o(" class, like "),et=r("a"),Za=o("push_to_hub()"),en=o(` to
directly upload your config to the Hub.`),Ks=c(),V=r("h2"),oe=r("a"),Qt=r("span"),p(Ce.$$.fragment),tn=c(),Xt=r("span"),sn=o("Writing a custom model"),Vs=c(),B=r("p"),on=o(`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
you want to register your model with the auto classes (see last section).`),to=c(),p(ne.$$.fragment),so=c(),S=r("p"),$n=o(`You can have your model return anything you want, but returning a dictionary like we did for
...
training loop or another library for training.`),oo=c(),nt=r("p"),Pn=o("Now that we have our model class, let\u2019s create one:"),ao=c(),p(Te.$$.fragment),no=c(),T=r("p"),An=o("Again, you can use any of the methods of "),rt=r("a"),Tn=o("PreTrainedModel"),Mn=o(", like "),lt=r("a"),Rn=o("save_pretrained()"),qn=o(` or
...
easy to transfer those weights:`),lo=c(),p(Me.$$.fragment),io=c(),H=r("p"),On=o("Now let\u2019s see how to make sure that when we do "),ct=r("a"),Dn=o("save_pretrained()"),Fn=o(" or "),dt=r("a"),Bn=o("push_to_hub()"),Sn=o(`, the
code of the model is saved.`),fo=c(),J=r("h2"),re=r("a"),ns=r("span"),p(Re.$$.fragment),Hn=c(),rs=r("span"),Wn=o("Sending the code to the Hub"),co=c(),p(le.$$.fragment),ho=c(),$=r("p"),Ln=o("First, make sure your model is fully defined in a "),ls=r("code"),Yn=o(".py"),zn=o(` file. It can rely on relative imports to some other files as
...
in this `),Be=r("a"),Cr=o("model repo"),Pr=o("."),Ro=c(),de=r("p"),Ar=o("See the "),wt=r("a"),Tr=o("sharing tutorial"),Mr=o(" for more information on the push to Hub method."),qo=c(),Q=r("h2"),he=r("a"),ws=r("span"),p(Se.$$.fragment),Rr=c(),bs=r("span"),qr=o("Using a model with custom code"),Io=c(),R=r("p"),Ir=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
hash of any commit.`),Fo=c(),X=r("h2"),ue=r("a"),Es=r("span"),p(Ye.$$.fragment),Yr=c(),js=r("span"),zr=o("Registering a model with custom code to the auto classes"),Bo=c(),vt=r("p"),Ur=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),So=c(),L=r("p"),Gr=o("As long as your config has a "),Cs=r("code"),Kr=o("model_type"),Vr=o(` attribute that is different from existing model types, and that your model
...
`),be=l(kt,"A",{href:!0,rel:!0});var fl=i(be);ra=a(fl,"timm library"),fl.forEach(s),la=a(kt," into a "),Ve=l(kt,"A",{href:!0});var cl=i(Ve);ia=a(cl,"PreTrainedModel"),cl.forEach(s),fa=a(kt,"."),kt.forEach(s),xs=d(e),U=l(e,"H2",{class:!0});var Yo=i(U);te=l(Yo,"A",{id:!0,class:!0,href:!0});var dl=i(te);Ot=l(dl,"SPAN",{});var hl=i(Ot);_(ve.$$.fragment,hl),hl.forEach(s),dl.forEach(s),ca=d(Yo),Dt=l(Yo,"SPAN",{});var ml=i(Dt);da=a(ml,"Writing a custom configuration"),ml.forEach(s),Yo.forEach(s),Os=d(e),se=l(e,"P",{});var zo=i(se);ha=a(zo,`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
will contain all the necessary information to build the model. As we will see in the next section, the model can only
...
configurations will then give us the different types of ResNets that are possible. We then just store those arguments,
after checking the validity of a few of them.`),pl.forEach(s),Fs=d(e),_($e.$$.fragment,e),Bs=d(e),Qe=l(e,"P",{});var _l=i(Qe);_a=a(_l,"The three important things to remember when writing you own configuration are the following:"),_l.forEach(s),Ss=d(e),x=l(e,"UL",{});var Et=i(x);ke=l(Et,"LI",{});var Uo=i(ke);ga=a(Uo,"you have to inherit from "),Bt=l(Uo,"CODE",{});var gl=i(Bt);ya=a(gl,"PretrainedConfig"),gl.forEach(s),wa=a(Uo,","),Uo.forEach(s),ba=d(Et),G=l(Et,"LI",{});var jt=i(G);va=a(jt,"the "),St=l(jt,"CODE",{});var yl=i(St);$a=a(yl,"__init__"),yl.forEach(s),ka=a(jt," of your "),Ht=l(jt,"CODE",{});var wl=i(Ht);Ea=a(wl,"PretrainedConfig"),wl.forEach(s),ja=a(jt," must accept any kwargs,"),jt.forEach(s),Ca=d(Et),K=l(Et,"LI",{});var Ct=i(K);Pa=a(Ct,"those "),Wt=l(Ct,"CODE",{});var bl=i(Wt);Aa=a(bl,"kwargs"),bl.forEach(s),Ta=a(Ct," need to be passed to the superclass "),Lt=l(Ct,"CODE",{});var vl=i(Lt);Ma=a(vl,"__init__"),vl.forEach(s),Ra=a(Ct,"."),Ct.forEach(s),Et.forEach(s),Hs=d(e),O=l(e,"P",{});var Pt=i(O);qa=a(Pt,`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Pt.forEach(s),Ws=d(e),D=l(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Ut=l(At,"CODE",{});var El=i(Ut);Fa=a(El,"model_type"),El.forEach(s),Ba=a(At," for your configuration (here "),Gt=l(At,"CODE",{});var jl=i(Gt);Sa=a(jl,'model_type="resnet"'),jl.forEach(s),Ha=a(At,`) is not mandatory, unless you want to
...
library. Here is how we can create a resnet50d config and save it:`),Cl.forEach(s),Ys=d(e),_(Ee.$$.fragment,e),zs=d(e),A=l(e,"P",{});var pe=i(A);La=a(pe,"This will save a file named "),Kt=l(pe,"CODE",{});var Pl=i(Kt);Ya=a(Pl,"config.json"),Pl.forEach(s),za=a(pe," inside the folder "),Vt=l(pe,"CODE",{});var Al=i(Vt);Ua=a(Al,"custom-resnet"),Al.forEach(s),Ga=a(pe,`. You can then reload your config with the
`),Jt=l(pe,"CODE",{});var Tl=i(Jt);Ka=a(Tl,"from_pretrained"),Tl.forEach(s),Va=a(pe," method:"),pe.forEach(s),Us=d(e),_(je.$$.fragment,e),Gs=d(e),F=l(e,"P",{});var Tt=i(F);Ja=a(Tt,"You can also use any other method of the "),Ze=l(Tt,"A",{href:!0});var Ml=i(Ze);Qa=a(Ml,"PretrainedConfig"),Ml.forEach(s),Xa=a(Tt," class, like "),et=l(Tt,"A",{href:!0});var Rl=i(et);Za=a(Rl,"push_to_hub()"),Rl.forEach(s),en=a(Tt,` to
directly upload your config to the Hub.`),Tt.forEach(s),Ks=d(e),V=l(e,"H2",{class:!0});var Go=i(V);oe=l(Go,"A",{id:!0,class:!0,href:!0});var ql=i(oe);Qt=l(ql,"SPAN",{});var Il=i(Qt);_(Ce.$$.fragment,Il),Il.forEach(s),ql.forEach(s),tn=d(Go),Xt=l(Go,"SPAN",{});var Nl=i(Xt);sn=a(Nl,"Writing a custom model"),Nl.forEach(s),Go.forEach(s),Vs=d(e),B=l(e,"P",{});var Mt=i(B);on=a(Mt,`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
extracts the hidden features from a batch of images (like `),tt=l(Mt,"A",{href:!0});var xl=i(tt);an=a(xl,"BertModel"),xl.forEach(s),nn=a(Mt,`) and one that is suitable for image
classification (like `),st=l(Mt,"A",{href:!0});var Ol=i(st);rn=a(Ol,"BertForSequenceClassification"),Ol.forEach(s),ln=a(Mt,")."),Mt.forEach(s),Js=d(e),ae=l(e,"P",{});var Ko=i(ae);fn=a(Ko,`As we mentioned before, we\u2019ll only write a loose wrapper of the model to keep it simple for this example. The only
thing we need to do before writing this class is a map between the block types and actual block classes. Then the
model is defined from the configuration by passing everything to the `),Zt=l(Ko,"CODE",{});var Dl=i(Zt);cn=a(Dl,"ResNet"),Dl.forEach(s),dn=a(Ko," class:"),Ko.forEach(s),Qs=d(e),_(Pe.$$.fragment,e),Xs=d(e),ot=l(e,"P",{});var Fl=i(ot);hn=a(Fl,"For the model that will classify images, we just change the forward method:"),Fl.forEach(s),Zs=d(e),_(Ae.$$.fragment,e),eo=d(e),C=l(e,"P",{});var Y=i(C);mn=a(Y,"In both cases, notice how we inherit from "),es=l(Y,"CODE",{});var Bl=i(es);un=a(Bl,"PreTrainedModel"),Bl.forEach(s),pn=a(Y," and call the superclass initialization with the "),ts=l(Y,"CODE",{});var Sl=i(ts);_n=a(Sl,"config"),Sl.forEach(s),gn=a(Y,`
...
you want to register your model with the auto classes (see last section).`),Y.forEach(s),to=d(e),_(ne.$$.fragment,e),so=d(e),S=l(e,"P",{});var Rt=i(S);$n=a(Rt,`You can have your model return anything you want, but returning a dictionary like we did for
`),as=l(Rt,"CODE",{});var Ll=i(as);kn=a(Ll,"ResnetModelForImageClassification"),Ll.forEach(s),En=a(Rt,`, with the loss included when labels are passed, will make your model directly
usable inside the `),at=l(Rt,"A",{href:!0});var Yl=i(at);jn=a(Yl,"Trainer"),Yl.forEach(s),Cn=a(Rt,` class. Using another output format is fine as long as you are planning on using your own
training loop or another library for training.`),Rt.forEach(s),oo=d(e),nt=l(e,"P",{});var zl=i(nt);Pn=a(zl,"Now that we have our model class, let\u2019s create one:"),zl.forEach(s),ao=d(e),_(Te.$$.fragment,e),no=d(e),T=l(e,"P",{});var _e=i(T);An=a(_e,"Again, you can use any of the methods of "),rt=l(_e,"A",{href:!0});var Ul=i(rt);Tn=a(Ul,"PreTrainedModel"),Ul.forEach(s),Mn=a(_e,", like "),lt=l(_e,"A",{href:!0});var Gl=i(lt);Rn=a(Gl,"save_pretrained()"),Gl.forEach(s),qn=a(_e,` or
...
we will use the pretrained version of the resnet50d. Since our model is just a wrapper around it, it\u2019s going to be
easy to transfer those weights:`),Vl.forEach(s),lo=d(e),_(Me.$$.fragment,e),io=d(e),H=l(e,"P",{});var qt=i(H);On=a(qt,"Now let\u2019s see how to make sure that when we do "),ct=l(qt,"A",{href:!0});var Jl=i(ct);Dn=a(Jl,"save_pretrained()"),Jl.forEach(s),Fn=a(qt," or "),dt=l(qt,"A",{href:!0});var Ql=i(dt);Bn=a(Ql,"push_to_hub()"),Ql.forEach(s),Sn=a(qt,`, the
code of the model is saved.`),qt.forEach(s),fo=d(e),J=l(e,"H2",{class:!0});var Vo=i(J);re=l(Vo,"A",{id:!0,class:!0,href:!0});var Xl=i(re);ns=l(Xl,"SPAN",{});var Zl=i(ns);_(Re.$$.fragment,Zl),Zl.forEach(s),Xl.forEach(s),Hn=d(Vo),rs=l(Vo,"SPAN",{});var ei=i(rs);Wn=a(ei,"Sending the code to the Hub"),ei.forEach(s),Vo.forEach(s),co=d(e),_(le.$$.fragment,e),ho=d(e),$=l(e,"P",{});var j=i($);Ln=a(j,"First, make sure your model is fully defined in a "),ls=l(j,"CODE",{});var ti=i(ls);Yn=a(ti,".py"),ti.forEach(s),zn=a(j,` file. It can rely on relative imports to some other files as
long as all the files are in the same directory (we don\u2019t support submodules for this feature yet). For our example,
...
in this `),Be=l(ge,"A",{href:!0,rel:!0});var bi=i(Be);Cr=a(bi,"model repo"),bi.forEach(s),Pr=a(ge,"."),ge.forEach(s),Ro=d(e),de=l(e,"P",{});var Xo=i(de);Ar=a(Xo,"See the "),wt=l(Xo,"A",{href:!0});var vi=i(wt);Tr=a(vi,"sharing tutorial"),vi.forEach(s),Mr=a(Xo," for more information on the push to Hub method."),Xo.forEach(s),qo=d(e),Q=l(e,"H2",{class:!0});var Zo=i(Q);he=l(Zo,"A",{id:!0,class:!0,href:!0});var $i=i(he);ws=l($i,"SPAN",{});var ki=i(ws);_(Se.$$.fragment,ki),ki.forEach(s),$i.forEach(s),Rr=d(Zo),bs=l(Zo,"SPAN",{});var Ei=i(bs);qr=a(Ei,"Using a model with custom code"),Ei.forEach(s),Zo.forEach(s),Io=d(e),R=l(e,"P",{});var ye=i(R);Ir=a(ye,`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
review the model code and author to avoid executing malicious code on your machine. Set `),$s=l(ye,"CODE",{});var Pi=i($s);Fr=a(Pi,"trust_remote_code=True"),Pi.forEach(s),Br=a(ye,` to use
a model with custom code:`),ye.forEach(s),No=d(e),_(We.$$.fragment,e),xo=d(e),me=l(e,"P",{});var ea=i(me);Sr=a(ea,"It is also strongly encouraged to pass a commit hash as a "),ks=l(ea,"CODE",{});var Ai=i(ks);Hr=a(Ai,"revision"),Ai.forEach(s),Wr=a(ea,` to make sure the author of the models did not
update the code with some malicious new lines (unless you fully trust the authors of the models).`),ea.forEach(s),Oo=d(e),_(Le.$$.fragment,e),Do=d(e),bt=l(e,"P",{});var Ti=i(bt);Lr=a(Ti,`Note that when browsing the commit history of the model repo on the Hub, there is a button to easily copy the commit
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=l(e,"H2",{class:!0});var ta=i(X);ue=l(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=l(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yr=d(ta),js=l(ta,"SPAN",{});var qi=i(js);zr=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),Bo=d(e),vt=l(e,"P",{});var Ii=i(vt);Ur=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Ii.forEach(s),So=d(e),L=l(e,"P",{});var Nt=i(L);Gr=a(Nt,"As long as your config has a "),Cs=l(Nt,"CODE",{});var Ni=i(Cs);Kr=a(Ni,"model_type"),Ni.forEach(s),Vr=a(Nt,` attribute that is different from existing model types, and that your model
