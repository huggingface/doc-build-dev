...
above for more information.`),this.h()},l(O){p=s(O,"P",{});var P=n(p);W=i(P,"This class method is simply calling "),f=s(P,"A",{href:!0});var F=n(f);T=i(F,"save_pretrained()"),F.forEach(t),x=i(P,` and
`),k=s(P,"CODE",{});var A=n(k);y=i(A,"save_pretrained"),A.forEach(t),j=i(P,`. Please refer to the docstrings of the methods
above for more information.`),P.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/pr_16473/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(O,P){h(O,p,P),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j)},d(O){O&&t(p)}}}function TT(C){let p,W,f,T,x,k,y,j,O,P,F,A,L,X;return{c(){p=a("p"),W=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
`),f=a("a"),T=r("from_pretrained()"),x=r(`, Wav2Vec2CTCTokenizer\u2019s
`),k=a("code"),y=r("from_pretrained"),j=r(`, and
`),O=a("code"),P=r("pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),F=r("."),A=l(),L=a("p"),X=r("Please refer to the docstrings of the methods above for more information."),this.h()},l(S){p=s(S,"P",{});var q=n(p);W=i(q,`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
`),O=s(q,"CODE",{});var B=n(O);P=i(B,"pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),B.forEach(t),F=i(q,"."),q.forEach(t),A=c(S),L=s(S,"P",{});var R=n(L);X=i(R,"Please refer to the docstrings of the methods above for more information."),R.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/pr_16473/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(S,q){h(S,p,q),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j),e(p,O),e(O,P),e(p,F),h(S,A,q),h(S,L,q),e(L,X)},d(S){S&&t(p),S&&t(A),S&&t(L)}}}function xT(C){let p,W;return{c(){p=a("p"),W=r("This function makes use of Python\u2019s multiprocessing.")},l(f){p=s(f,"P",{});var T=n(p);W=i(T,"This function makes use of Python\u2019s multiprocessing."),T.forEach(t)},m(f,T){h(f,p,T),e(p,W)},d(f){f&&t(p)}}}function WT(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function ET(C){let p,W,f,T,x,k,y,j,O,P,F,A,L,X,S,q,Ve,ge,B,R,_e,Ge,z,I,Fe,ve,Ye,Ce,oe,ct,et,D,dt,de,pe,Je,we,pt,be,ae,Ee,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),O=r("having all inputs as a list, tuple or dict in the first positional arguments."),P=l(),F=a("p"),A=r("This second option is useful when using "),L=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
...
first positional argument :`),Ge=l(),z=a("ul"),I=a("li"),Fe=r("a single Tensor with "),ve=a("code"),Ye=r("input_values"),Ce=r(" only and nothing else: "),oe=a("code"),ct=r("model(inputs_ids)"),et=l(),D=a("li"),dt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ye=s(xe,"CODE",{});var Rt=n(ye);mt=i(Rt,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Rt.forEach(t),xe.forEach(t),G.forEach(t)},m($,E){h($,p,E),e(p,W),h($,f,E),h($,T,E),e(T,x),e(x,k),e(T,y),e(T,j),e(j,O),h($,P,E),h($,F,E),e(F,A),e(F,L),e(L,X),e(F,S),e(F,q),e(q,Ve),e(F,ge),h($,B,E),h($,R,E),e(R,_e),h($,Ge,E),h($,z,E),e(z,I),e(I,Fe),e(I,ve),e(ve,Ye),e(I,Ce),e(I,oe),e(oe,ct),e(z,et),e(z,D),e(D,dt),e(D,de),e(de,pe),e(D,Je),e(D,we),e(we,pt),e(z,be),e(z,ae),e(ae,Ee),e(ae,ye),e(ye,mt)},d($){$&&t(p),$&&t(f),$&&t(T),$&&t(P),$&&t(F),$&&t(B),$&&t(R),$&&t(Ge),$&&t(z)}}}function qT(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function PT(C){let p,W,f,T,x,k,y,j,O,P,F,A,L,X,S,q,Ve,ge,B,R,_e,Ge,z,I,Fe,ve,Ye,Ce,oe,ct,et,D,dt,de,pe,Je,we,pt,be,ae,Ee,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),O=r("having all inputs as a list, tuple or dict in the first positional arguments."),P=l(),F=a("p"),A=r("This second option is useful when using "),L=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),q=a("code"),Ve=r("model(inputs)"),ge=r("."),B=l(),R=a("p"),_e=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ge=l(),z=a("ul"),I=a("li"),Fe=r("a single Tensor with "),ve=a("code"),Ye=r("input_values"),Ce=r(" only and nothing else: "),oe=a("code"),ct=r("model(inputs_ids)"),et=l(),D=a("li"),dt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=a("code"),pe=r("model([input_values, attention_mask])"),Je=r(" or "),we=a("code"),pt=r("model([input_values, attention_mask, token_type_ids])"),be=l(),ae=a("li"),Ee=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),mt=r('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l($){p=s($,"P",{});var E=n(p);W=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),f=c($),T=s($,"UL",{});var Ze=n(T);x=s(Ze,"LI",{});var Ke=n(x);k=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),y=c(Ze),j=s(Ze,"LI",{});var Bt=n(j);O=i(Bt,"having all inputs as a list, tuple or dict in the first positional arguments."),Bt.forEach(t),Ze.forEach(t),P=c($),F=s($,"P",{});var se=n(F);A=i(se,"This second option is useful when using "),L=s(se,"CODE",{});var xt=n(L);X=i(xt,"tf.keras.Model.fit"),xt.forEach(t),S=i(se,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function LT(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function DT(C){let p,W,f,T,x,k,y,j,O,P,F,A,L,X,S,q,Ve,ge,B,R,_e,Ge,z,I,Fe,ve,Ye,Ce,oe,ct,et,D,dt,de,pe,Je,we,pt,be,ae,Ee,ye,mt,$,E,Ze,Ke,Bt,se,xt,ke,qe,G,J,Ut,ht,Te,Wt,U,xe,Rt,Ht,lm,zr,cm,dm,Fa,pm,mm,hm,Xt,fm,Mr,um,gm,Ar,_m,vm,wm,Xi,bm,ym,Ca,sd,Gt,Fo,Gi,Ea,km,Ji,Tm,nd,Z,qa,xm,Zi,Wm,$m,Pa,jm,Lr,Vm,Fm,Cm,Co,za,Em,Ki,qm,Pm,Dr,Ma,zm,Pe,Aa,Mm,Qi,Am,Lm,La,Dm,Yi,Om,Sm,Nm,el,Im,Bm,Da,Um,Eo,Oa,Rm,tl,Hm,rd,Jt,qo,ol,Sa,Xm,al,Gm,id,Qe,Na,Jm,sl,Zm,Km,Ia,Qm,Or,Ym,eh,th,Po,Ba,oh,nl,ah,ld,Zt,zo,rl,Ua,sh,il,nh,cd,M,Ra,rh,ll,ih,lh,ze,Sr,ch,dh,Nr,ph,mh,Ir,hh,fh,Ha,cl,uh,gh,_h,Br,vh,wh,bh,Mo,Xa,yh,ft,kh,Ga,dl,Th,xh,Wh,Ur,$h,jh,Ja,pl,Vh,Fh,Ch,Eh,Ao,Za,qh,ut,Ph,Rr,zh,Mh,Hr,Ah,Lh,Xr,Dh,Oh,Sh,Gr,Ka,Nh,$t,Qa,Ih,Ya,Bh,Jr,Uh,Rh,Hh,Lo,Xh,Do,es,Gh,ts,Jh,Zr,Zh,Kh,Qh,Oo,os,Yh,as,ef,Kr,tf,of,af,So,ss,sf,ml,nf,dd,Kt,No,hl,ns,rf,fl,lf,pd,N,rs,cf,ul,df,pf,Io,is,mf,gt,hf,ls,gl,ff,uf,gf,Qr,_f,vf,cs,_l,wf,bf,yf,kf,Bo,ds,Tf,_t,xf,Yr,Wf,$f,ei,jf,Vf,ti,Ff,Cf,Ef,jt,ps,qf,ms,Pf,oi,zf,Mf,Af,Uo,Lf,ai,hs,Df,Vt,fs,Of,vl,Sf,Nf,Ro,If,tt,us,Bf,wl,Uf,Rf,bl,Hf,Xf,gs,Gf,Ho,_s,Jf,yl,Zf,md,Qt,Xo,kl,vs,Kf,Tl,Qf,hd,Yt,ws,Yf,bs,eu,xl,tu,ou,fd,eo,ys,au,ks,su,Wl,nu,ru,ud,to,Ts,iu,xs,lu,si,cu,du,gd,vt,Ws,pu,$s,mu,$l,hu,fu,uu,Go,js,gu,jl,_u,_d,wt,Vs,vu,Fs,wu,Vl,bu,yu,ku,Jo,Cs,Tu,Fl,xu,vd,oo,Zo,Cl,Es,Wu,El,$u,wd,We,qs,ju,Ps,Vu,zs,Fu,Cu,Eu,Ms,qu,ni,Pu,zu,Mu,As,Au,Ls,Lu,Du,Ou,Me,Ds,Su,ao,Nu,ri,Iu,Bu,ql,Uu,Ru,Hu,Ko,Xu,Pl,Gu,Ju,Os,bd,so,Qo,zl,Ss,Zu,Ml,Ku,yd,$e,Ns,Qu,no,Yu,Al,eg,tg,Is,og,ag,sg,Bs,ng,ii,rg,ig,lg,Us,cg,Rs,dg,pg,mg,me,Hs,hg,ro,fg,li,ug,gg,Ll,_g,vg,wg,Yo,bg,Dl,yg,kg,Xs,Tg,Gs,kd,io,ea,Ol,Js,xg,Sl,Wg,Td,ne,Zs,$g,Nl,jg,Vg,Ks,Fg,Qs,Cg,Eg,qg,Ys,Pg,ci,zg,Mg,Ag,en,Lg,tn,Dg,Og,Sg,he,on,Ng,lo,Ig,di,Bg,Ug,Il,Rg,Hg,Xg,ta,Gg,Bl,Jg,Zg,an,Kg,sn,xd,co,oa,Ul,nn,Qg,Rl,Yg,Wd,re,rn,e_,Hl,t_,o_,ln,a_,cn,s_,n_,r_,dn,i_,pi,l_,c_,d_,pn,p_,mn,m_,h_,f_,Ae,hn,u_,po,g_,mi,__,v_,Xl,w_,b_,y_,aa,k_,Gl,T_,x_,fn,$d,mo,sa,Jl,un,W_,Zl,$_,jd,ie,gn,j_,Kl,V_,F_,_n,C_,vn,E_,q_,P_,wn,z_,hi,M_,A_,L_,bn,D_,yn,O_,S_,N_,Le,kn,I_,ho,B_,fi,U_,R_,Ql,H_,X_,G_,na,J_,Yl,Z_,K_,Tn,Vd,fo,ra,ec,xn,Q_,tc,Y_,Fd,je,Wn,ev,uo,tv,oc,ov,av,$n,sv,nv,rv,jn,iv,ui,lv,cv,dv,Vn,pv,Fn,mv,hv,fv,De,Cn,uv,go,gv,gi,_v,vv,ac,wv,bv,yv,ia,kv,sc,Tv,xv,En,Cd,_o,la,nc,qn,Wv,rc,$v,Ed,le,Pn,jv,ic,Vv,Fv,zn,Cv,_i,Ev,qv,Pv,Mn,zv,An,Mv,Av,Lv,ca,Dv,Oe,Ln,Ov,vo,Sv,vi,Nv,Iv,lc,Bv,Uv,Rv,da,Hv,cc,Xv,Gv,Dn,qd,wo,pa,dc,On,Jv,pc,Zv,Pd,ce,Sn,Kv,Nn,Qv,mc,Yv,e2,t2,In,o2,wi,a2,s2,n2,Bn,r2,Un,i2,l2,c2,ma,d2,Se,Rn,p2,bo,m2,bi,h2,f2,hc,u2,g2,_2,ha,v2,fc,w2,b2,Hn,zd,yo,fa,uc,Xn,y2,gc,k2,Md,K,Gn,T2,Jn,x2,Zn,W2,$2,j2,Kn,V2,yi,F2,C2,E2,Qn,q2,Yn,P2,z2,M2,_c,A2,L2,bt,vc,er,D2,O2,wc,tr,S2,N2,bc,or,I2,B2,yc,ar,U2,R2,Ne,sr,H2,ko,X2,kc,G2,J2,Tc,Z2,K2,Q2,ua,Y2,xc,ew,tw,nr,Ad,To,ga,Wc,rr,ow,$c,aw,Ld,Q,ir,sw,xo,nw,jc,rw,iw,lr,lw,cw,dw,cr,pw,ki,mw,hw,fw,dr,uw,pr,gw,_w,vw,Vc,ww,bw,yt,Fc,mr,yw,kw,Cc,hr,Tw,xw,Ec,fr,Ww,$w,qc,ur,jw,Vw,Ie,gr,Fw,Wo,Cw,Pc,Ew,qw,zc,Pw,zw,Mw,_a,Aw,Mc,Lw,Dw,_r,Dd,$o,va,Ac,vr,Ow,Lc,Sw,Od,Y,wr,Nw,jo,Iw,Dc,Bw,Uw,br,Rw,Hw,Xw,yr,Gw,Ti,Jw,Zw,Kw,kr,Qw,Tr,Yw,eb,tb,Oc,ob,ab,kt,Sc,xr,sb,nb,Nc,Wr,rb,ib,Ic,$r,lb,cb,Bc,jr,db,pb,Be,Vr,mb,Vo,hb,xi,fb,ub,Uc,gb,_b,vb,wa,wb,Rc,bb,yb,Fr,Sd;return k=new ee({}),X=new ee({}),J=new ee({}),xe=new V({props:{name:"class transformers.Wav2Vec2Config",anchor:"transformers.Wav2Vec2Config",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"feat_quantizer_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"num_codevectors_per_group",val:" = 320"},{name:"num_codevector_groups",val:" = 2"},{name:"contrastive_logits_temperature",val:" = 0.1"},{name:"num_negatives",val:" = 100"},{name:"codevector_dim",val:" = 256"},{name:"proj_codevector_dim",val:" = 256"},{name:"diversity_loss_weight",val:" = 0.1"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"tdnn_dim",val:" = (512, 512, 512, 512, 1500)"},{name:"tdnn_kernel",val:" = (5, 3, 3, 1, 1)"},{name:"tdnn_dilation",val:" = (1, 2, 3, 1, 1)"},{name:"xvector_output_dim",val:" = 512"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"add_adapter",val:" = False"},{name:"adapter_kernel_size",val:" = 3"},{name:"adapter_stride",val:" = 2"},{name:"num_adapter_layers",val:" = 3"},{name:"output_hidden_size",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/configuration_wav2vec2.py#L32",parametersDescription:[{anchor:"transformers.Wav2Vec2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ds=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2Model.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),Ko=new fe({props:{$$slots:{default:[WT]},$$scope:{ctx:C}}}),Os=new ue({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2Model
import torch
from datasets import load_dataset
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hs=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1688",parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16473/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16473/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16473/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16473/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[ET]},$$scope:{ctx:C}}}),Ln=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
`}}),da=new fe({props:{$$slots:{default:[qT]},$$scope:{ctx:C}}}),Dn=new ue({props:{code:`from transformers import Wav2Vec2Processor, TFWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16473/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[PT]},$$scope:{ctx:C}}}),Rn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16473/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16473/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16473/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16473/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),wa=new fe({props:{$$slots:{default:[LT]},$$scope:{ctx:C}}}),Fr=new ue({props:{code:`import optax
import numpy as np
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># show that cosine similarity is much higher than random</span>
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> np.asarray(cosine_sim)[mask_time_indices].mean() &gt; <span class="hljs-number">0.5</span>`}}),{c(){p=a("meta"),W=l(),f=a("h1"),T=a("a"),x=a("span"),u(k.$$.fragment),y=l(),j=a("span"),O=r("Wav2Vec2"),P=l(),F=a("h2"),A=a("a"),L=a("span"),u(X.$$.fragment),S=l(),q=a("span"),Ve=r("Overview"),ge=l(),B=a("p"),R=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Ge=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),z=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=l(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),Ye=l(),Ce=a("p"),oe=a("em"),ct=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
`),Hr=a("a"),Ah=r("as_target_processor()"),Lh=r(` this method forwards all its arguments to PreTrainedTokenizer\u2019s
...
can be reloaded using the `),Jr=a("a"),Uh=r("from_pretrained()"),Rh=r(" method."),Hh=l(),u(Lo.$$.fragment),Xh=l(),Do=a("div"),u(es.$$.fragment),Gh=l(),ts=a("p"),Jh=r("This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Zr=a("a"),Zh=r("batch_decode()"),Kh=r(`. Please
...
behavior.`),Ou=l(),Me=a("div"),u(Ds.$$.fragment),Su=l(),ao=a("p"),Nu=r("The "),ri=a("a"),Iu=r("Wav2Vec2Model"),Bu=r(" forward method, overrides the "),ql=a("code"),Uu=r("__call__"),Ru=r(" special method."),Hu=l(),u(Ko.$$.fragment),Xu=l(),Pl=a("p"),Gu=r("Example:"),Ju=l(),u(Os.$$.fragment),bd=l(),so=a("h2"),Qo=a("a"),zl=a("span"),u(Ss.$$.fragment),Zu=l(),Ml=a("span"),Ku=r("Wav2Vec2ForCTC"),yd=l(),$e=a("div"),u(Ns.$$.fragment),Qu=l(),no=a("p"),Yu=r("Wav2Vec2 Model with a "),Al=a("code"),eg=r("language modeling"),tg=r(` head on top for Connectionist Temporal Classification (CTC).
...
behavior.`),Lv=l(),u(ca.$$.fragment),Dv=l(),Oe=a("div"),u(Ln.$$.fragment),Ov=l(),vo=a("p"),Sv=r("The "),vi=a("a"),Nv=r("TFWav2Vec2Model"),Iv=r(" forward method, overrides the "),lc=a("code"),Bv=r("__call__"),Uv=r(" special method."),Rv=l(),u(da.$$.fragment),Hv=l(),cc=a("p"),Xv=r("Example:"),Gv=l(),u(Dn.$$.fragment),qd=l(),wo=a("h2"),pa=a("a"),dc=a("span"),u(On.$$.fragment),Jv=l(),pc=a("span"),Zv=r("TFWav2Vec2ForCTC"),Pd=l(),ce=a("div"),u(Sn.$$.fragment),Kv=l(),Nn=a("p"),Qv=r("TFWav2Vec2 Model with a "),mc=a("code"),Yv=r("language modeling"),e2=r(" head on top for Connectionist Temporal Classification (CTC)."),t2=l(),In=a("p"),o2=r("This model inherits from "),wi=a("a"),a2=r("TFPreTrainedModel"),s2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),M2=l(),_c=a("p"),A2=r("Finally, this model supports inherent JAX features such as:"),L2=l(),bt=a("ul"),vc=a("li"),er=a("a"),D2=r("Just-In-Time (JIT) compilation"),O2=l(),wc=a("li"),tr=a("a"),S2=r("Automatic Differentiation"),N2=l(),bc=a("li"),or=a("a"),I2=r("Vectorization"),B2=l(),yc=a("li"),ar=a("a"),U2=r("Parallelization"),R2=l(),Ne=a("div"),u(sr.$$.fragment),H2=l(),ko=a("p"),X2=r("The "),kc=a("code"),G2=r("FlaxWav2Vec2PreTrainedModel"),J2=r("forward method, overrides the "),Tc=a("code"),Z2=r("__call__"),K2=r(" special method."),Q2=l(),u(ua.$$.fragment),Y2=l(),xc=a("p"),ew=r("Example:"),tw=l(),u(nr.$$.fragment),Ad=l(),To=a("h2"),ga=a("a"),Wc=a("span"),u(rr.$$.fragment),ow=l(),$c=a("span"),aw=r("FlaxWav2Vec2ForCTC"),Ld=l(),Q=a("div"),u(ir.$$.fragment),sw=l(),xo=a("p"),nw=r("Wav2Vec2 Model with a "),jc=a("code"),rw=r("language modeling"),iw=r(` head on top for Connectionist Temporal Classification (CTC).
...
documentation from `),Ar=s($i,"A",{href:!0});var Mb=n(Ar);_m=i(Mb,"PretrainedConfig"),Mb.forEach(t),vm=i($i," for more information."),$i.forEach(t),wm=c(Ft),Xi=s(Ft,"P",{});var Ab=n(Xi);bm=i(Ab,"Example:"),Ab.forEach(t),ym=c(Ft),g(Ca.$$.fragment,Ft),Ft.forEach(t),sd=c(o),Gt=s(o,"H2",{class:!0});var Ud=n(Gt);Fo=s(Ud,"A",{id:!0,class:!0,href:!0});var Lb=n(Fo);Gi=s(Lb,"SPAN",{});var Db=n(Gi);g(Ea.$$.fragment,Db),Db.forEach(t),Lb.forEach(t),km=c(Ud),Ji=s(Ud,"SPAN",{});var Ob=n(Ji);Tm=i(Ob,"Wav2Vec2CTCTokenizer"),Ob.forEach(t),Ud.forEach(t),nd=c(o),Z=s(o,"DIV",{class:!0});var Ue=n(Z);g(qa.$$.fragment,Ue),xm=c(Ue),Zi=s(Ue,"P",{});var Sb=n(Zi);Wm=i(Sb,"Constructs a Wav2Vec2CTC tokenizer."),Sb.forEach(t),$m=c(Ue),Pa=s(Ue,"P",{});var Rd=n(Pa);jm=i(Rd,"This tokenizer inherits from "),Lr=s(Rd,"A",{href:!0});var Nb=n(Lr);Vm=i(Nb,"PreTrainedTokenizer"),Nb.forEach(t),Fm=i(Rd,` which contains some of the main methods. Users should refer to
...
sequences.`),Ib.forEach(t),Hd.forEach(t),Pm=c(Ue),Dr=s(Ue,"DIV",{class:!0});var Bb=n(Dr);g(Ma.$$.fragment,Bb),Bb.forEach(t),zm=c(Ue),Pe=s(Ue,"DIV",{class:!0});var Ct=n(Pe);g(Aa.$$.fragment,Ct),Mm=c(Ct),Qi=s(Ct,"P",{});var Ub=n(Qi);Am=i(Ub,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Ub.forEach(t),Lm=c(Ct),La=s(Ct,"P",{});var Xd=n(La);Dm=i(Xd,"Similar to doing "),Yi=s(Xd,"CODE",{});var Rb=n(Yi);Om=i(Rb,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Rb.forEach(t),Sm=i(Xd,"."),Xd.forEach(t),Nm=c(Ct),el=s(Ct,"P",{});var Hb=n(el);Im=i(Hb,"Example:"),Hb.forEach(t),Bm=c(Ct),g(Da.$$.fragment,Ct),Ct.forEach(t),Um=c(Ue),Eo=s(Ue,"DIV",{class:!0});var Gd=n(Eo);g(Oa.$$.fragment,Gd),Rm=c(Gd),tl=s(Gd,"P",{});var Xb=n(tl);Hm=i(Xb,"Convert a list of lists of token ids into a list of strings by calling decode."),Xb.forEach(t),Gd.forEach(t),Ue.forEach(t),rd=c(o),Jt=s(o,"H2",{class:!0});var Jd=n(Jt);qo=s(Jd,"A",{id:!0,class:!0,href:!0});var Gb=n(qo);ol=s(Gb,"SPAN",{});var Jb=n(ol);g(Sa.$$.fragment,Jb),Jb.forEach(t),Gb.forEach(t),Xm=c(Jd),al=s(Jd,"SPAN",{});var Zb=n(al);Gm=i(Zb,"Wav2Vec2FeatureExtractor"),Zb.forEach(t),Jd.forEach(t),id=c(o),Qe=s(o,"DIV",{class:!0});var ba=n(Qe);g(Na.$$.fragment,ba),Jm=c(ba),sl=s(ba,"P",{});var Kb=n(sl);Zm=i(Kb,"Constructs a Wav2Vec2 feature extractor."),Kb.forEach(t),Km=c(ba),Ia=s(ba,"P",{});var Zd=n(Ia);Qm=i(Zd,"This feature extractor inherits from "),Or=s(Zd,"A",{href:!0});var Qb=n(Or);Ym=i(Qb,"SequenceFeatureExtractor"),Qb.forEach(t),eh=i(Zd,` which contains
...
`),Hr=s(ka,"A",{href:!0});var h1=n(Hr);Ah=i(h1,"as_target_processor()"),h1.forEach(t),Lh=i(ka,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Xr=s(ka,"A",{href:!0});var f1=n(Xr);Dh=i(f1,"pad()"),f1.forEach(t),Oh=i(ka,". Please refer to the docstring of the above two methods for more information."),ka.forEach(t),ep.forEach(t),Sh=c(H),Gr=s(H,"DIV",{class:!0});var u1=n(Gr);g(Ka.$$.fragment,u1),u1.forEach(t),Nh=c(H),$t=s(H,"DIV",{class:!0});var ji=n($t);g(Qa.$$.fragment,ji),Ih=c(ji),Ya=s(ji,"P",{});var tp=n(Ya);Bh=i(tp,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Jr=s(tp,"A",{href:!0});var g1=n(Jr);Uh=i(g1,"from_pretrained()"),g1.forEach(t),Rh=i(tp," method."),tp.forEach(t),Hh=c(ji),g(Lo.$$.fragment,ji),ji.forEach(t),Xh=c(H),Do=s(H,"DIV",{class:!0});var op=n(Do);g(es.$$.fragment,op),Gh=c(op),ts=s(op,"P",{});var ap=n(ts);Jh=i(ap,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Zr=s(ap,"A",{href:!0});var _1=n(Zr);Zh=i(_1,"batch_decode()"),_1.forEach(t),Kh=i(ap,`. Please
refer to the docstring of this method for more information.`),ap.forEach(t),op.forEach(t),Qh=c(H),Oo=s(H,"DIV",{class:!0});var sp=n(Oo);g(os.$$.fragment,sp),Yh=c(sp),as=s(sp,"P",{});var np=n(as);ef=i(np,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Kr=s(np,"A",{href:!0});var v1=n(Kr);tf=i(v1,"decode()"),v1.forEach(t),of=i(np,`. Please refer
...
library implements for all its model (such as downloading or saving etc.).`),Wp.forEach(t),Mu=c(Et),As=s(Et,"P",{});var $p=n(As);Au=i($p,"This model is a PyTorch "),Ls=s($p,"A",{href:!0,rel:!0});var K1=n(Ls);Lu=i(K1,"torch.nn.Module"),K1.forEach(t),Du=i($p,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Ou=c(Et),Me=s(Et,"DIV",{class:!0});var qt=n(Me);g(Ds.$$.fragment,qt),Su=c(qt),ao=s(qt,"P",{});var qi=n(ao);Nu=i(qi,"The "),ri=s(qi,"A",{href:!0});var Q1=n(ri);Iu=i(Q1,"Wav2Vec2Model"),Q1.forEach(t),Bu=i(qi," forward method, overrides the "),ql=s(qi,"CODE",{});var Y1=n(ql);Uu=i(Y1,"__call__"),Y1.forEach(t),Ru=i(qi," special method."),qi.forEach(t),Hu=c(qt),g(Ko.$$.fragment,qt),Xu=c(qt),Pl=s(qt,"P",{});var ey=n(Pl);Gu=i(ey,"Example:"),ey.forEach(t),Ju=c(qt),g(Os.$$.fragment,qt),qt.forEach(t),Et.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var ty=n(Qo);zl=s(ty,"SPAN",{});var oy=n(zl);g(Ss.$$.fragment,oy),oy.forEach(t),ty.forEach(t),Zu=c(jp),Ml=s(jp,"SPAN",{});var ay=n(Ml);Ku=i(ay,"Wav2Vec2ForCTC"),ay.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var Pt=n($e);g(Ns.$$.fragment,Pt),Qu=c(Pt),no=s(Pt,"P",{});var Pi=n(no);Yu=i(Pi,"Wav2Vec2 Model with a "),Al=s(Pi,"CODE",{});var sy=n(Al);eg=i(sy,"language modeling"),sy.forEach(t),tg=i(Pi,` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),mg=c(Pt),me=s(Pt,"DIV",{class:!0});var ot=n(me);g(Hs.$$.fragment,ot),hg=c(ot),ro=s(ot,"P",{});var zi=n(ro);fg=i(zi,"The "),li=s(zi,"A",{href:!0});var ly=n(li);ug=i(ly,"Wav2Vec2ForCTC"),ly.forEach(t),gg=i(zi," forward method, overrides the "),Ll=s(zi,"CODE",{});var cy=n(Ll);_g=i(cy,"__call__"),cy.forEach(t),vg=i(zi," special method."),zi.forEach(t),wg=c(ot),g(Yo.$$.fragment,ot),bg=c(ot),Dl=s(ot,"P",{});var dy=n(Dl);yg=i(dy,"Example:"),dy.forEach(t),kg=c(ot),g(Xs.$$.fragment,ot),Tg=c(ot),g(Gs.$$.fragment,ot),ot.forEach(t),Pt.forEach(t),kd=c(o),io=s(o,"H2",{class:!0});var Cp=n(io);ea=s(Cp,"A",{id:!0,class:!0,href:!0});var py=n(ea);Ol=s(py,"SPAN",{});var my=n(Ol);g(Js.$$.fragment,my),my.forEach(t),py.forEach(t),xg=c(Cp),Sl=s(Cp,"SPAN",{});var hy=n(Sl);Wg=i(hy,"Wav2Vec2ForSequenceClassification"),hy.forEach(t),Cp.forEach(t),Td=c(o),ne=s(o,"DIV",{class:!0});var at=n(ne);g(Zs.$$.fragment,at),$g=c(at),Nl=s(at,"P",{});var fy=n(Nl);jg=i(fy,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
library implements for all its model (such as downloading or saving etc.).`),qp.forEach(t),Ag=c(at),en=s(at,"P",{});var Pp=n(en);Lg=i(Pp,"This model is a PyTorch "),tn=s(Pp,"A",{href:!0,rel:!0});var _y=n(tn);Dg=i(_y,"torch.nn.Module"),_y.forEach(t),Og=i(Pp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lp.forEach(t),f_=c(nt),Ae=s(nt,"DIV",{class:!0});var zt=n(Ae);g(hn.$$.fragment,zt),u_=c(zt),po=s(zt,"P",{});var Ai=n(po);g_=i(Ai,"The "),mi=s(Ai,"A",{href:!0});var Vy=n(mi);__=i(Vy,"Wav2Vec2ForAudioFrameClassification"),Vy.forEach(t),v_=i(Ai," forward method, overrides the "),Xl=s(Ai,"CODE",{});var Fy=n(Xl);w_=i(Fy,"__call__"),Fy.forEach(t),b_=i(Ai," special method."),Ai.forEach(t),y_=c(zt),g(aa.$$.fragment,zt),k_=c(zt),Gl=s(zt,"P",{});var Cy=n(Gl);T_=i(Cy,"Example:"),Cy.forEach(t),x_=c(zt),g(fn.$$.fragment,zt),zt.forEach(t),nt.forEach(t),$d=c(o),mo=s(o,"H2",{class:!0});var Dp=n(mo);sa=s(Dp,"A",{id:!0,class:!0,href:!0});var Ey=n(sa);Jl=s(Ey,"SPAN",{});var qy=n(Jl);g(un.$$.fragment,qy),qy.forEach(t),Ey.forEach(t),W_=c(Dp),Zl=s(Dp,"SPAN",{});var Py=n(Zl);$_=i(Py,"Wav2Vec2ForXVector"),Py.forEach(t),Dp.forEach(t),jd=c(o),ie=s(o,"DIV",{class:!0});var rt=n(ie);g(gn.$$.fragment,rt),j_=c(rt),Kl=s(rt,"P",{});var zy=n(Kl);V_=i(zy,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),zy.forEach(t),F_=c(rt),_n=s(rt,"P",{});var Op=n(_n);C_=i(Op,"Wav2Vec2 was proposed in "),vn=s(Op,"A",{href:!0,rel:!0});var My=n(vn);E_=i(My,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),My.forEach(t),q_=i(Op,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Op.forEach(t),P_=c(rt),wn=s(rt,"P",{});var Sp=n(wn);z_=i(Sp,"This model inherits from "),hi=s(Sp,"A",{href:!0});var Ay=n(hi);M_=i(Ay,"PreTrainedModel"),Ay.forEach(t),A_=i(Sp,`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kp.forEach(t),c2=c(lt),g(ma.$$.fragment,lt),d2=c(lt),Se=s(lt,"DIV",{class:!0});var Ot=n(Se);g(Rn.$$.fragment,Ot),p2=c(Ot),bo=s(Ot,"P",{});var Ni=n(bo);m2=i(Ni,"The "),bi=s(Ni,"A",{href:!0});var mk=n(bi);h2=i(mk,"TFWav2Vec2ForCTC"),mk.forEach(t),f2=i(Ni," forward method, overrides the "),hc=s(Ni,"CODE",{});var hk=n(hc);u2=i(hk,"__call__"),hk.forEach(t),g2=i(Ni," special method."),Ni.forEach(t),_2=c(Ot),g(ha.$$.fragment,Ot),v2=c(Ot),fc=s(Ot,"P",{});var fk=n(fc);w2=i(fk,"Example:"),fk.forEach(t),b2=c(Ot),g(Hn.$$.fragment,Ot),Ot.forEach(t),lt.forEach(t),zd=c(o),yo=s(o,"H2",{class:!0});var Qp=n(yo);fa=s(Qp,"A",{id:!0,class:!0,href:!0});var uk=n(fa);uc=s(uk,"SPAN",{});var gk=n(uc);g(Xn.$$.fragment,gk),gk.forEach(t),uk.forEach(t),y2=c(Qp),gc=s(Qp,"SPAN",{});var _k=n(gc);k2=i(_k,"FlaxWav2Vec2Model"),_k.forEach(t),Qp.forEach(t),Md=c(o),K=s(o,"DIV",{class:!0});var Re=n(K);g(Gn.$$.fragment,Re),T2=c(Re),Jn=s(Re,"P",{});var Yp=n(Jn);x2=i(Yp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),Bi.forEach(t),dw=c(He),cr=s(He,"P",{});var am=n(cr);pw=i(am,"This model inherits from "),ki=s(am,"A",{href:!0});var Dk=n(ki);mw=i(Dk,"FlaxPreTrainedModel"),Dk.forEach(t),hw=i(am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
