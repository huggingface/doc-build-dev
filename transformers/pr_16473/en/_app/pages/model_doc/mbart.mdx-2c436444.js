...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zT=d(),Ac=n("p"),FT=r("Finally, this model supports inherent JAX features such as:"),qT=d(),gt=n("ul"),Ic=n("li"),zr=n("a"),$T=r("Just-In-Time (JIT) compilation"),BT=d(),Nc=n("li"),Fr=n("a"),jT=r("Automatic Differentiation"),ET=d(),Dc=n("li"),qr=n("a"),CT=r("Vectorization"),PT=d(),Lc=n("li"),$r=n("a"),ST=r("Parallelization"),OT=d(),De=n("div"),u(Br.$$.fragment),AT=d(),Bo=n("p"),IT=r("The "),Gc=n("code"),NT=r("FlaxMBartPreTrainedModel"),DT=r("forward method, overrides the "),Wc=n("code"),LT=r("__call__"),GT=r(" special method."),WT=d(),u(bn.$$.fragment),UT=d(),Uc=n("p"),RT=r("Example:"),XT=d(),u(jr.$$.fragment),QT=d(),Ft=n("div"),u(Er.$$.fragment),HT=d(),Rc=n("p"),VT=r("Example:"),JT=d(),u(Cr.$$.fragment),KT=d(),qt=n("div"),u(Pr.$$.fragment),ZT=d(),Xc=n("p"),YT=r("Example:"),e1=d(),u(Sr.$$.fragment),dh=d(),jo=n("h2"),yn=n("a"),Qc=n("span"),u(Or.$$.fragment),t1=d(),Hc=n("span"),o1=r("FlaxMBartForQuestionAnswering"),lh=d(),I=n("div"),u(Ar.$$.fragment),n1=d(),Eo=n("p"),a1=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
target text format is `),He=a(jt,"CODE",{});var ow=s(He);Jt=i(ow,"[tgt_lang_code] X [eos]"),ow.forEach(t),Cu=i(jt,". "),rd=a(jt,"CODE",{});var nw=s(rd);Pu=i(nw,"bos"),nw.forEach(t),Su=i(jt," is never used."),jt.forEach(t),_p=l(o),yt=a(o,"P",{});var Ei=s(yt);Ou=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var X1=s(Cn);id=a(X1,"STRONG",{});var aw=s(id);Au=i(aw,"call"),aw.forEach(t),Iu=i(X1,"()"),X1.forEach(t),Nu=i(Ei,` will encode source text format, and it should be wrapped
