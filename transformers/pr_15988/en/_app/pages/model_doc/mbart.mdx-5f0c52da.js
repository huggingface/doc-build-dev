...
first positional argument :`),X.forEach(t),ae=l(w),P=a(w,"UL",{});var ie=s(P);S=a(ie,"LI",{});var de=s(S);dt=i(de,"a single Tensor with "),ce=a(de,"CODE",{});var Ht=s(ce);pe=i(Ht,"input_ids"),Ht.forEach(t),lt=i(de," only and nothing else: "),J=a(de,"CODE",{});var Vt=s(J);ct=i(Vt,"model(input_ids)"),Vt.forEach(t),de.forEach(t),pt=l(ie),O=a(ie,"LI",{});var le=s(O);Ee=i(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),be=a(le,"CODE",{});var Qt=s(be);Ze=i(Qt,"model([input_ids, attention_mask])"),Qt.forEach(t),se=i(le," or "),ve=a(le,"CODE",{});var Jt=s(ve);ye=i(Jt,"model([input_ids, attention_mask, token_type_ids])"),Jt.forEach(t),le.forEach(t),ht=l(ie),re=a(ie,"LI",{});var Ve=s(re);Te=i(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Me=a(Ve,"CODE",{});var Kt=s(Me);Ye=i(Kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Kt.forEach(t),Ve.forEach(t),ie.forEach(t)},m(w,$){h(w,u,$),e(u,x),h(w,v,$),h(w,M,$),e(M,z),e(z,T),e(M,y),e(M,q),e(q,st),h(w,je,$),h(w,j,$),e(j,Ue),e(j,_e),e(_e,rt),e(j,ge),e(j,ke),e(ke,it),e(j,Ke),h(w,Q,$),h(w,D,$),e(D,Xe),h(w,ae,$),h(w,P,$),e(P,S),e(S,dt),e(S,ce),e(ce,pe),e(S,lt),e(S,J),e(J,ct),e(P,pt),e(P,O),e(O,Ee),e(O,be),e(be,Ze),e(O,se),e(O,ve),e(ve,ye),e(P,ht),e(P,re),e(re,Te),e(re,Me),e(Me,Ye)},d(w){w&&t(u),w&&t(v),w&&t(M),w&&t(je),w&&t(j),w&&t(Q),w&&t(D),w&&t(ae),w&&t(P)}}}function W2(E){let u,x,v,M,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);M=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),an=new at({props:{$$slots:{default:[D2]},$$scope:{ctx:E}}}),us=new F({props:{code:`from transformers import MBartTokenizer, MBartForQuestionAnswering
import torch
...
`}}),rn=new at({props:{$$slots:{default:[O2]},$$scope:{ctx:E}}}),vs=new F({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>]`}}),Ts=new U({}),Ms=new B({props:{name:"class transformers.MBartForCausalLM",anchor:"transformers.MBartForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/mbart/modeling_mbart.py#L1684"}}),ws=new B({props:{name:"forward",anchor:"transformers.MBartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/mbart/modeling_mbart.py#L1715",parametersDescription:[{anchor:"transformers.MBartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),mn=new at({props:{$$slots:{default:[W2]},$$scope:{ctx:E}}}),Ds=new F({props:{code:`from transformers import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(qn),Ae=a(qn,"DIV",{class:!0});var At=s(Ae);f(Ka.$$.fragment,At),dk=l(At),ho=a(At,"P",{});var Di=s(ho);lk=i(Di,"The "),gi=a(Di,"A",{href:!0});var dz=s(gi);ck=i(dz,"MBartModel"),dz.forEach(t),pk=i(Di," forward method, overrides the "),El=a(Di,"CODE",{});var lz=s(El);hk=i(lz,"__call__"),lz.forEach(t),uk=i(Di," special method."),Di.forEach(t),mk=l(At),f(en.$$.fragment,At),fk=l(At),Pl=a(At,"P",{});var cz=s(Pl);_k=i(cz,"Example:"),cz.forEach(t),gk=l(At),f(Za.$$.fragment,At),At.forEach(t),qn.forEach(t),Wp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var pz=s(tn);Cl=a(pz,"SPAN",{});var hz=s(Cl);f(Ya.$$.fragment,hz),hz.forEach(t),pz.forEach(t),kk=l(nu),Al=a(nu,"SPAN",{});var uz=s(Al);bk=i(uz,"MBartForConditionalGeneration"),uz.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),qk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Oi=s(mo);Fk=i(Oi,"The "),bi=a(Oi,"A",{href:!0});var _z=s(bi);jk=i(_z,"MBartForConditionalGeneration"),_z.forEach(t),Ek=i(Oi," forward method, overrides the "),Sl=a(Oi,"CODE",{});var gz=s(Sl);Pk=i(gz,"__call__"),gz.forEach(t),Ck=i(Oi," special method."),Oi.forEach(t),Ak=l(Le),f(on.$$.fragment,Le),Sk=l(Le),Il=a(Le,"P",{});var kz=s(Il);Ik=i(kz,"Translation example:"),kz.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Dk=l(Le),Nl=a(Le,"P",{});var bz=s(Nl);Ok=i(bz,"Mask filling example:"),bz.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var vz=s(nn);Dl=a(vz,"SPAN",{});var yz=s(Dl);f(is.$$.fragment,yz),yz.forEach(t),vz.forEach(t),Gk=l(ru),Ol=a(ru,"SPAN",{});var Tz=s(Ol);Rk=i(Tz,"MBartForQuestionAnswering"),Tz.forEach(t),ru.forEach(t),Hp=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(ds.$$.fragment,St),Wk=l(St),_o=a(St,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),Bb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),qb=l(Ge),bo=a(Ge,"P",{});var Ri=s(bo);$b=i(Ri,"The "),Mi=a(Ri,"A",{href:!0});var Sz=s(Mi);Fb=i(Sz,"MBartForSequenceClassification"),Sz.forEach(t),jb=i(Ri," forward method, overrides the "),Vl=a(Ri,"CODE",{});var Iz=s(Vl);Eb=i(Iz,"__call__"),Iz.forEach(t),Pb=i(Ri," special method."),Ri.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Ab=l(Ge),Ql=a(Ge,"P",{});var Nz=s(Ql);Sb=i(Nz,"Example of single-label classification:"),Nz.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var Dz=s(Jl);Db=i(Dz,"Example of multi-label classification:"),Dz.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var Oz=s(dn);Kl=a(Oz,"SPAN",{});var Lz=s(Kl);f(Ts.$$.fragment,Lz),Lz.forEach(t),Oz.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var Gz=s(Zl);Gb=i(Gz,"MBartForCausalLM"),Gz.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Rb=l(uu),Tt=a(uu,"DIV",{class:!0});var Wi=s(Tt);f(ws.$$.fragment,Wi),Wb=l(Wi),Yl=a(Wi,"P",{});var Rz=s(Yl);Ub=i(Rz,"Example:"),Rz.forEach(t),Xb=l(Wi),f(zs.$$.fragment,Wi),Wi.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var Wz=s(ln);ec=a(Wz,"SPAN",{});var Uz=s(ec);f(xs.$$.fragment,Uz),Uz.forEach(t),Wz.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var Xz=s(tc);Vb=i(Xz,"TFMBartModel"),Xz.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Dt=s($e);f(Bs.$$.fragment,Dt),Qb=l(Dt),qs=a(Dt,"P",{});var fu=s(qs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Dt),$s=a(Dt,"P",{});var _u=s($s);ev=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var Vz=s(Fs);tv=i(Vz,"tf.keras.Model"),Vz.forEach(t),ov=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Dt),f(cn.$$.fragment,Dt),av=l(Dt),Ie=a(Dt,"DIV",{class:!0});var Ot=s(Ie);f(js.$$.fragment,Ot),sv=l(Ot),Mo=a(Ot,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),zi=a(Ui,"A",{href:!0});var Qz=s(zi);iv=i(Qz,"TFMBartModel"),Qz.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jz=s(oc);lv=i(Jz,"__call__"),Jz.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Ot),f(pn.$$.fragment,Ot),hv=l(Ot),nc=a(Ot,"P",{});var Kz=s(nc);uv=i(Kz,"Example:"),Kz.forEach(t),mv=l(Ot),f(Es.$$.fragment,Ot),Ot.forEach(t),Dt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zz=s(hn);ac=a(Zz,"SPAN",{});var Yz=s(ac);f(Ps.$$.fragment,Yz),Yz.forEach(t),Zz.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_v=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),As=a(Lt,"P",{});var ku=s(As);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
