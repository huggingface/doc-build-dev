import{S as Ck,i as Sk,s as Ak,e as n,k as d,w as m,t as r,M as Ik,c as s,d as t,m as l,a,x as g,h as i,b as c,F as e,g as p,y as f,q as _,o as k,B as v}from"../../chunks/vendor-4833417e.js";import{T as qo}from"../../chunks/Tip-fffd6df1.js";import{D as M}from"../../chunks/Docstring-4f315ed9.js";import{C as Se}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Z}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Ok(G){let h,z,b,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),T=r("Module"),x=r(`
...
`),oe=s(R,"CODE",{});var kt=a(oe);H=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),R.forEach(t),O.forEach(t)},m(y,q){p(y,h,q),e(h,z),p(y,b,q),p(y,T,q),e(T,x),e(x,w),e(T,P),e(T,$),e($,Ae),p(y,me,q),p(y,E,q),e(E,we),e(E,ae),e(ae,Ie),e(E,re),e(E,ie),e(ie,Oe),e(E,Me),p(y,D,q),p(y,A,q),e(A,xe),p(y,K,q),p(y,C,q),e(C,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ne),e(S,U),e(U,Ge),e(C,De),e(C,I),e(I,ge),e(I,de),e(de,je),e(I,te),e(I,V),e(V,Ue),e(C,Be),e(C,B),e(B,We),e(B,oe),e(oe,H)},d(y){y&&t(h),y&&t(b),y&&t(T),y&&t(me),y&&t(E),y&&t(D),y&&t(A),y&&t(K),y&&t(C)}}}function Gk(G){let h,z,b,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(P,"CODE",{});var $=a(b);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){p(w,h,P),e(h,z),e(h,b),e(b,T),e(h,x)},d(w){w&&t(h)}}}function Dk(G){let h,z,b,T,x,w,P,$,Ae,me,E,we,ae,Ie,re,ie,Oe,Me,D,A,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,I,ge,de,je,te,V,Ue,Be,B,We,oe,H;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),b=d(),T=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),P=d(),$=n("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),E=n("p"),we=r("This second option is useful when using "),ae=n("code"),Ie=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Oe=r("model(inputs)"),Me=r("."),D=d(),A=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=d(),C=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ne=r(" only and nothing else: "),U=n("code"),Ge=r("model(input_ids)"),De=d(),I=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),je=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=d(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){h=s(y,"P",{});var q=a(h);z=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),b=l(y),T=s(y,"UL",{});var ze=a(T);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),P=l(ze),$=s(ze,"LI",{});var $e=a($);Ae=i($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),ze.forEach(t),me=l(y),E=s(y,"P",{});var Q=a(E);we=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var gt=a(ae);Ie=i(gt,"tf.keras.Model.fit"),gt.forEach(t),re=i(Q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(P,"CODE",{});var $=a(b);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){p(w,h,P),e(h,z),e(h,b),e(b,T),e(h,x)},d(w){w&&t(h)}}}function Hk(G){let h,z,b,T,x,w,P,$,Ae,me,E,we,ae,Ie,re,ie,Oe,Me,D,A,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,I,ge,de,je,te,V,Ue,Be,B,We,oe,H,y,q,ze,mt,$e,Q,gt,Ve,le,O,J,qe,ft,X,_t,Qe,R,kt,Eo,Yd,el,ca,tl,ol,Mi,fe,pa,nl,sl,ua,al,rl,ha,il,dl,Fo,ll,Mo,cl,pl,ul,Wt,jo,hl,ml,Co,gl,fl,ji,vt,Ht,ma,So,_l,ga,kl,Ci,Je,Rt,Ao,vl,yl,Io,bl,Tl,Pl,fa,wl,xl,_a,zl,Si,yt,Kt,ka,Oo,$l,va,ql,Ai,_e,ya,ba,El,Fl,Ta,xs,Ml,zs,jl,Cl,Lo,Pa,Sl,Al,bt,wa,Il,Ol,xa,Ll,Nl,No,Gl,za,Dl,Ul,Bl,$a,He,Wl,qa,Hl,Rl,Ea,Kl,Vl,Fa,Ql,Jl,Xl,Ma,Tt,Zl,Go,Yl,ec,ja,tc,oc,Ii,Pt,Vt,Ca,Do,nc,Sa,sc,Oi,Uo,Li,wt,Qt,Aa,Bo,ac,Ia,rc,Ni,ce,Wo,ic,xt,dc,$s,lc,cc,Ho,pc,uc,hc,zt,mc,qs,gc,fc,Es,_c,kc,vc,Oa,yc,bc,Ro,Gi,$t,Jt,La,Ko,Tc,Na,Pc,Di,Xt,wc,Ga,xc,zc,Ui,W,Vo,$c,Qo,qc,Jo,Ec,Fc,Mc,Xo,jc,Fs,Cc,Sc,Ac,Ce,Zo,Ic,Yo,Oc,Da,Lc,Nc,Gc,en,Ms,Dc,Ua,Uc,Bc,tn,Wc,Ba,Hc,Rc,Kc,Wa,Vc,Qc,Zt,on,Jc,Ha,Xc,Zc,Yt,nn,Yc,Ra,ep,tp,eo,sn,op,Ka,np,Bi,qt,to,Va,an,sp,Qa,ap,Wi,pe,rn,rp,Et,ip,Ja,dp,lp,dn,cp,pp,up,ln,hp,js,mp,gp,fp,Xe,cn,_p,Xa,kp,vp,pn,Cs,yp,Za,bp,Tp,un,Pp,Ya,wp,xp,zp,oo,hn,$p,er,qp,Hi,Ft,no,tr,mn,Ep,or,Fp,Ri,Ee,gn,Mp,fn,jp,Ss,Cp,Sp,Ap,_n,Ip,kn,Op,Lp,Np,ke,vn,Gp,Mt,Dp,As,Up,Bp,nr,Wp,Hp,Rp,so,Kp,sr,Vp,Qp,yn,Ki,jt,ao,ar,bn,Jp,rr,Xp,Vi,Fe,Tn,Zp,Pn,Yp,Is,eu,tu,ou,wn,nu,xn,su,au,ru,ve,zn,iu,Ct,du,Os,lu,cu,ir,pu,uu,hu,ro,mu,dr,gu,fu,$n,Qi,St,io,lr,qn,_u,cr,ku,Ji,At,En,vu,Ze,Fn,yu,pr,bu,Tu,Mn,Xi,It,lo,ur,jn,Pu,hr,wu,Zi,ue,Cn,xu,Sn,zu,Ls,$u,qu,Eu,An,Fu,In,Mu,ju,Cu,co,Su,ye,On,Au,Ot,Iu,Ns,Ou,Lu,mr,Nu,Gu,Du,po,Uu,gr,Bu,Wu,Ln,Yi,Lt,uo,fr,Nn,Hu,_r,Ru,ed,he,Gn,Ku,Dn,Vu,Gs,Qu,Ju,Xu,Un,Zu,Bn,Yu,eh,th,ho,oh,be,Wn,nh,Nt,sh,Ds,ah,rh,kr,ih,dh,lh,mo,ch,vr,ph,uh,Hn,td,Gt,go,yr,Rn,hh,br,mh,od,L,Kn,gh,Vn,fh,Us,_h,kh,vh,Qn,yh,Jn,bh,Th,Ph,Tr,wh,xh,Re,Pr,Xn,zh,$h,wr,Zn,qh,Eh,xr,Yn,Fh,Mh,zr,es,jh,Ch,Te,ts,Sh,Dt,Ah,$r,Ih,Oh,qr,Lh,Nh,Gh,fo,Dh,Er,Uh,Bh,os,Wh,Ye,ns,Hh,Fr,Rh,Kh,ss,Vh,et,as,Qh,Mr,Jh,Xh,rs,nd,Ut,_o,jr,is,Zh,Cr,Yh,sd,N,ds,em,ls,tm,Bs,om,nm,sm,cs,am,ps,rm,im,dm,Sr,lm,cm,Ke,Ar,us,pm,um,Ir,hs,hm,mm,Or,ms,gm,fm,Lr,gs,_m,km,F,fs,vm,Bt,ym,Nr,bm,Tm,Gr,Pm,wm,xm,ko,zm,Dr,$m,qm,Ur,Br,Wr,Hr,Em,Fm,Rr,Kr,Vr,Qr,Mm,jm,Jr,Xr,Zr,Yr,Cm,Sm,ei,ti,_s,vo,yo,oi,ks,Am,ni,Im,Om,si,Lm,Nm,ai,Gm,Dm,ri,ii,di,li,Um,Bm,ci,pi,ui,hi,Wm,Hm,mi,gi,fi,_i,Rm,Km,ki,vi,yi,bi,Vm,Qm,tt,vs,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,Pi,tg,og,Ts,ad;return w=new Z({}),K=new Z({}),qe=new Z({}),So=new Z({}),Oo=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),hn=new M({props:{name:"get_special_tokens_mask",anchor:"transformers.PegasusTokenizerFast.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List"},{name:"token_ids_1",val:": typing.Optional[typing.List] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/tokenization_pegasus_fast.py#L165"}}),mn=new Z({}),gn=new M({props:{name:"class transformers.PegasusModel",anchor:"transformers.PegasusModel",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_pegasus.py#L1133",parametersDescription:[{anchor:"transformers.PegasusModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new M({props:{name:"forward",anchor:"transformers.PegasusModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_pegasus.py#L1183",parametersDescription:[{anchor:"transformers.PegasusModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_15988/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">1024</span>]`}}),bn=new Z({}),Tn=new M({props:{name:"class transformers.PegasusForConditionalGeneration",anchor:"transformers.PegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_pegasus.py#L1282",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zn=new M({props:{name:"forward",anchor:"transformers.PegasusForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_pegasus.py#L1350",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_15988/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15988/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-string">&quot;California&#x27;s largest electricity provider has turned off power to hundreds of thousands of customers.&quot;</span>`}}),qn=new Z({}),En=new M({props:{name:"class transformers.PegasusForCausalLM",anchor:"transformers.PegasusForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_pegasus.py#L1489"}}),Fn=new M({props:{name:"forward",anchor:"transformers.PegasusForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_pegasus.py#L1542",parametersDescription:[{anchor:"transformers.PegasusForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Nn=new Z({}),Gn=new M({props:{name:"class transformers.TFPegasusForConditionalGeneration",anchor:"transformers.TFPegasusForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1323",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15988/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new qo({props:{$$slots:{default:[Dk]},$$scope:{ctx:G}}}),Wn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15988/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1356",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15988/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_15988/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15988/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
and behavior.`),Np=d(),ke=n("div"),m(vn.$$.fragment),Gp=d(),Mt=n("p"),Dp=r("The "),As=n("a"),Up=r("PegasusModel"),Bp=r(" forward method, overrides the "),nr=n("code"),Wp=r("__call__"),Hp=r(" special method."),Rp=d(),m(so.$$.fragment),Kp=d(),sr=n("p"),Vp=r("Example:"),Qp=d(),m(yn.$$.fragment),Ki=d(),jt=n("h2"),ao=n("a"),ar=n("span"),m(bn.$$.fragment),Jp=d(),rr=n("span"),Xp=r("PegasusForConditionalGeneration"),Vi=d(),Fe=n("div"),m(Tn.$$.fragment),Zp=d(),Pn=n("p"),Yp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru=d(),ve=n("div"),m(zn.$$.fragment),iu=d(),Ct=n("p"),du=r("The "),Os=n("a"),lu=r("PegasusForConditionalGeneration"),cu=r(" forward method, overrides the "),ir=n("code"),pu=r("__call__"),uu=r(" special method."),hu=d(),m(ro.$$.fragment),mu=d(),dr=n("p"),gu=r("Summarization example:"),fu=d(),m($n.$$.fragment),Qi=d(),St=n("h2"),io=n("a"),lr=n("span"),m(qn.$$.fragment),_u=d(),cr=n("span"),ku=r("PegasusForCausalLM"),Ji=d(),At=n("div"),m(En.$$.fragment),vu=d(),Ze=n("div"),m(Fn.$$.fragment),yu=d(),pr=n("p"),bu=r("Example:"),Tu=d(),m(Mn.$$.fragment),Xi=d(),It=n("h2"),lo=n("a"),ur=n("span"),m(jn.$$.fragment),Pu=d(),hr=n("span"),wu=r("TFPegasusModel"),Zi=d(),ue=n("div"),m(Cn.$$.fragment),xu=d(),Sn=n("p"),zu=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu=d(),An=n("p"),Fu=r("This model is also a "),In=n("a"),Mu=r("tf.keras.Model"),ju=r(` subclass. Use it
...
refer to this superclass for more information regarding those methods.`),$d.forEach(t),fp=l(rt),Xe=s(rt,"DIV",{class:!0});var Zs=a(Xe);g(cn.$$.fragment,Zs),_p=l(Zs),Xa=s(Zs,"P",{});var qf=a(Xa);kp=i(qf,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),qf.forEach(t),vp=l(Zs),pn=s(Zs,"UL",{});var qd=a(pn);Cs=s(qd,"LI",{});var ag=a(Cs);yp=i(ag,"single sequence: "),Za=s(ag,"CODE",{});var Ef=a(Za);bp=i(Ef,"X </s>"),Ef.forEach(t),ag.forEach(t),Tp=l(qd),un=s(qd,"LI",{});var Ed=a(un);Pp=i(Ed,"pair of sequences: "),Ya=s(Ed,"CODE",{});var Ff=a(Ya);wp=i(Ff,"A B </s>"),Ff.forEach(t),xp=i(Ed," (not intended use)"),Ed.forEach(t),qd.forEach(t),Zs.forEach(t),zp=l(rt),oo=s(rt,"DIV",{class:!0});var Fd=a(oo);g(hn.$$.fragment,Fd),$p=l(Fd),er=s(Fd,"P",{});var Mf=a(er);qp=i(Mf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Mf.forEach(t),Fd.forEach(t),rt.forEach(t),Hi=l(o),Ft=s(o,"H2",{class:!0});var Md=a(Ft);no=s(Md,"A",{id:!0,class:!0,href:!0});var jf=a(no);tr=s(jf,"SPAN",{});var Cf=a(tr);g(mn.$$.fragment,Cf),Cf.forEach(t),jf.forEach(t),Ep=l(Md),or=s(Md,"SPAN",{});var Sf=a(or);Fp=i(Sf,"PegasusModel"),Sf.forEach(t),Md.forEach(t),Ri=l(o),Ee=s(o,"DIV",{class:!0});var wo=a(Ee);g(gn.$$.fragment,wo),Mp=l(wo),fn=s(wo,"P",{});var jd=a(fn);jp=i(jd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ss=s(jd,"A",{href:!0});var Af=a(Ss);Cp=i(Af,"PreTrainedModel"),Af.forEach(t),Sp=i(jd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jd.forEach(t),Ap=l(wo),_n=s(wo,"P",{});var Cd=a(_n);Ip=i(Cd,"This model is also a PyTorch "),kn=s(Cd,"A",{href:!0,rel:!0});var If=a(kn);Op=i(If,"torch.nn.Module"),If.forEach(t),Lp=i(Cd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cd.forEach(t),Np=l(wo),ke=s(wo,"DIV",{class:!0});var it=a(ke);g(vn.$$.fragment,it),Gp=l(it),Mt=s(it,"P",{});var Ys=a(Mt);Dp=i(Ys,"The "),As=s(Ys,"A",{href:!0});var Of=a(As);Up=i(Of,"PegasusModel"),Of.forEach(t),Bp=i(Ys," forward method, overrides the "),nr=s(Ys,"CODE",{});var Lf=a(nr);Wp=i(Lf,"__call__"),Lf.forEach(t),Hp=i(Ys," special method."),Ys.forEach(t),Rp=l(it),g(so.$$.fragment,it),Kp=l(it),sr=s(it,"P",{});var Nf=a(sr);Vp=i(Nf,"Example:"),Nf.forEach(t),Qp=l(it),g(yn.$$.fragment,it),it.forEach(t),wo.forEach(t),Ki=l(o),jt=s(o,"H2",{class:!0});var Sd=a(jt);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var Gf=a(ao);ar=s(Gf,"SPAN",{});var Df=a(ar);g(bn.$$.fragment,Df),Df.forEach(t),Gf.forEach(t),Jp=l(Sd),rr=s(Sd,"SPAN",{});var Uf=a(rr);Xp=i(Uf,"PegasusForConditionalGeneration"),Uf.forEach(t),Sd.forEach(t),Vi=l(o),Fe=s(o,"DIV",{class:!0});var xo=a(Fe);g(Tn.$$.fragment,xo),Zp=l(xo),Pn=s(xo,"P",{});var Ad=a(Pn);Yp=i(Ad,`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Is=s(Ad,"A",{href:!0});var Bf=a(Is);eu=i(Bf,"PreTrainedModel"),Bf.forEach(t),tu=i(Ad,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ad.forEach(t),ou=l(xo),wn=s(xo,"P",{});var Id=a(wn);nu=i(Id,"This model is also a PyTorch "),xn=s(Id,"A",{href:!0,rel:!0});var Wf=a(xn);su=i(Wf,"torch.nn.Module"),Wf.forEach(t),au=i(Id,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Id.forEach(t),ru=l(xo),ve=s(xo,"DIV",{class:!0});var dt=a(ve);g(zn.$$.fragment,dt),iu=l(dt),Ct=s(dt,"P",{});var ea=a(Ct);du=i(ea,"The "),Os=s(ea,"A",{href:!0});var Hf=a(Os);lu=i(Hf,"PegasusForConditionalGeneration"),Hf.forEach(t),cu=i(ea," forward method, overrides the "),ir=s(ea,"CODE",{});var Rf=a(ir);pu=i(Rf,"__call__"),Rf.forEach(t),uu=i(ea," special method."),ea.forEach(t),hu=l(dt),g(ro.$$.fragment,dt),mu=l(dt),dr=s(dt,"P",{});var Kf=a(dr);gu=i(Kf,"Summarization example:"),Kf.forEach(t),fu=l(dt),g($n.$$.fragment,dt),dt.forEach(t),xo.forEach(t),Qi=l(o),St=s(o,"H2",{class:!0});var Od=a(St);io=s(Od,"A",{id:!0,class:!0,href:!0});var Vf=a(io);lr=s(Vf,"SPAN",{});var Qf=a(lr);g(qn.$$.fragment,Qf),Qf.forEach(t),Vf.forEach(t),_u=l(Od),cr=s(Od,"SPAN",{});var Jf=a(cr);ku=i(Jf,"PegasusForCausalLM"),Jf.forEach(t),Od.forEach(t),Ji=l(o),At=s(o,"DIV",{class:!0});var Ld=a(At);g(En.$$.fragment,Ld),vu=l(Ld),Ze=s(Ld,"DIV",{class:!0});var ta=a(Ze);g(Fn.$$.fragment,ta),yu=l(ta),pr=s(ta,"P",{});var Xf=a(pr);bu=i(Xf,"Example:"),Xf.forEach(t),Tu=l(ta),g(Mn.$$.fragment,ta),ta.forEach(t),Ld.forEach(t),Xi=l(o),It=s(o,"H2",{class:!0});var Nd=a(It);lo=s(Nd,"A",{id:!0,class:!0,href:!0});var Zf=a(lo);ur=s(Zf,"SPAN",{});var Yf=a(ur);g(jn.$$.fragment,Yf),Yf.forEach(t),Zf.forEach(t),Pu=l(Nd),hr=s(Nd,"SPAN",{});var e_=a(hr);wu=i(e_,"TFPegasusModel"),e_.forEach(t),Nd.forEach(t),Zi=l(o),ue=s(o,"DIV",{class:!0});var lt=a(ue);g(Cn.$$.fragment,lt),xu=l(lt),Sn=s(lt,"P",{});var Gd=a(Sn);zu=i(Gd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
