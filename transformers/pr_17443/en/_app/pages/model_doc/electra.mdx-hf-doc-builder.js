...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17443/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17443/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17443/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17443/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`),Ul=s(Rg,"A",{href:!0,rel:!0});var O3=a(Ul);c4=i(O3,"flax.nn.Module"),O3.forEach(t),p4=i(Rg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rg.forEach(t),h4=p(Ze),Tm=s(Ze,"P",{});var L3=a(Tm);m4=i(L3,"Finally, this model supports inherent JAX features such as:"),L3.forEach(t),u4=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var N3=a(bm);Rl=s(N3,"A",{href:!0,rel:!0});var I3=a(Rl);f4=i(I3,"Just-In-Time (JIT) compilation"),I3.forEach(t),N3.forEach(t),g4=p(za),ym=s(za,"LI",{});var D3=a(ym);Hl=s(D3,"A",{href:!0,rel:!0});var S3=a(Hl);_4=i(S3,"Automatic Differentiation"),S3.forEach(t),D3.forEach(t),k4=p(za),Em=s(za,"LI",{});var W3=a(Em);Ql=s(W3,"A",{href:!0,rel:!0});var U3=a(Ql);v4=i(U3,"Vectorization"),U3.forEach(t),W3.forEach(t),T4=p(za),wm=s(za,"LI",{});var R3=a(wm);Bl=s(R3,"A",{href:!0,rel:!0});var H3=a(Bl);b4=i(H3,"Parallelization"),H3.forEach(t),R3.forEach(t),za.forEach(t),y4=p(Ze),It=s(Ze,"DIV",{class:!0});var ja=a(It);y(Vl.$$.fragment,ja),E4=p(ja),kn=s(ja,"P",{});var Lc=a(kn);w4=i(Lc,"The "),$m=s(Lc,"CODE",{});var Q3=a($m);$4=i(Q3,"FlaxElectraPreTrainedModel"),Q3.forEach(t),F4=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var B3=a(Fm);x4=i(B3,"__call__"),B3.forEach(t),M4=i(Lc," special method."),Lc.forEach(t),z4=p(ja),y(na.$$.fragment,ja),j4=p(ja),y(sa.$$.fragment,ja),ja.forEach(t),Ze.forEach(t),$f=p(o),vn=s(o,"H2",{class:!0});var Hg=a(vn);aa=s(Hg,"A",{id:!0,class:!0,href:!0});var V3=a(aa);xm=s(V3,"SPAN",{});var K3=a(xm);y(Kl.$$.fragment,K3),K3.forEach(t),V3.forEach(t),C4=p(Hg),Mm=s(Hg,"SPAN",{});var J3=a(Mm);q4=i(J3,"FlaxElectraForQuestionAnswering"),J3.forEach(t),Hg.forEach(t),Ff=p(o),Re=s(o,"DIV",{class:!0});var bt=a(Re);y(Jl.$$.fragment,bt),P4=p(bt),Tn=s(bt,"P",{});var Nc=a(Tn);A4=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=s(Nc,"CODE",{});var G3=a(zm);O4=i(G3,"span start logits"),G3.forEach(t),L4=i(Nc," and "),jm=s(Nc,"CODE",{});var X3=a(jm);N4=i(X3,"span end logits"),X3.forEach(t),I4=i(Nc,")."),Nc.forEach(t),D4=p(bt),Gl=s(bt,"P",{});var Qg=a(Gl);S4=i(Qg,"This model inherits from "),hc=s(Qg,"A",{href:!0});var Y3=a(hc);W4=i(Y3,"FlaxPreTrainedModel"),Y3.forEach(t),U4=i(Qg,`. Check the superclass documentation for the generic methods the
...
`),Yl=s(Bg,"A",{href:!0,rel:!0});var Z3=a(Yl);Q4=i(Z3,"flax.nn.Module"),Z3.forEach(t),B4=i(Bg,` subclass. Use it as a
