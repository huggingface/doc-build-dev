...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),De=new K({props:{anchor:"transformers.BigBirdPegasusForCausalLM.forward.example",$$slots:{default:[Hd]},$$scope:{ctx:P}}}),{c(){l=n("meta"),_=h(),c=n("h1"),u=n("a"),v=n("span"),y(r.$$.fragment),m=h(),x=n("span"),is=i("BigBirdPegasus"),gn=h(),Z=n("h2"),pe=n("a"),it=n("span"),y(He.$$.fragment),ds=h(),dt=n("span"),ls=i("Overview"),mn=h(),he=n("p"),cs=i("The BigBird model was proposed in "),Re=n("a"),us=i("Big Bird: Transformers for Longer Sequences"),ps=i(` by
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa=h(),D=n("div"),y(wo.$$.fragment),er=h(),se=n("p"),or=i("The "),Vo=n("a"),tr=i("BigBirdPegasusForConditionalGeneration"),nr=i(" forward method, overrides the "),Wt=n("code"),sr=i("__call__"),ar=i(" special method."),rr=h(),y(qe.$$.fragment),ir=h(),y(ze.$$.fragment),qn=h(),ae=n("h2"),Fe=n("a"),Ut=n("span"),y(ko.$$.fragment),dr=h(),Ht=n("span"),lr=i("BigBirdPegasusForSequenceClassification"),zn=h(),E=n("div"),y(Bo.$$.fragment),cr=h(),Rt=n("p"),ur=i(`BigBirdPegasus model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yr=h(),F=n("div"),y(qo.$$.fragment),wr=h(),re=n("p"),kr=i("The "),Zo=n("a"),Br=i("BigBirdPegasusForSequenceClassification"),Tr=i(" forward method, overrides the "),Kt=n("code"),$r=i("__call__"),Pr=i(" special method."),qr=h(),y(xe.$$.fragment),zr=h(),y(Ce.$$.fragment),Fr=h(),y(Ee.$$.fragment),xr=h(),y(Me.$$.fragment),Cr=h(),y(je.$$.fragment),Fn=h(),ie=n("h2"),Se=n("a"),Vt=n("span"),y(zo.$$.fragment),Er=h(),Jt=n("span"),Mr=i("BigBirdPegasusForQuestionAnswering"),xn=h(),M=n("div"),y(Fo.$$.fragment),jr=h(),de=n("p"),Sr=i(`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Zt=n("code"),Or=i("span start logits"),Ar=i(" and "),Yt=n("code"),Lr=i("span end logits"),Nr=i(")."),Ir=h(),xo=n("p"),Dr=i("This model inherits from "),Yo=n("a"),Qr=i("PreTrainedModel"),Gr=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jn.forEach(t),Xa=g(We),D=s(We,"DIV",{class:!0});var Ue=a(D);w(wo.$$.fragment,Ue),er=g(Ue),se=s(Ue,"P",{});var nt=a(se);or=d(nt,"The "),Vo=s(nt,"A",{href:!0});var rd=a(Vo);tr=d(rd,"BigBirdPegasusForConditionalGeneration"),rd.forEach(t),nr=d(nt," forward method, overrides the "),Wt=s(nt,"CODE",{});var id=a(Wt);sr=d(id,"__call__"),id.forEach(t),ar=d(nt," special method."),nt.forEach(t),rr=g(Ue),w(qe.$$.fragment,Ue),ir=g(Ue),w(ze.$$.fragment,Ue),Ue.forEach(t),We.forEach(t),qn=g(o),ae=s(o,"H2",{class:!0});var Zn=a(ae);Fe=s(Zn,"A",{id:!0,class:!0,href:!0});var dd=a(Fe);Ut=s(dd,"SPAN",{});var ld=a(Ut);w(ko.$$.fragment,ld),ld.forEach(t),dd.forEach(t),dr=g(Zn),Ht=s(Zn,"SPAN",{});var cd=a(Ht);lr=d(cd,"BigBirdPegasusForSequenceClassification"),cd.forEach(t),Zn.forEach(t),zn=g(o),E=s(o,"DIV",{class:!0});var U=a(E);w(Bo.$$.fragment,U),cr=g(U),Rt=s(U,"P",{});var ud=a(Rt);ur=d(ud,`BigBirdPegasus model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xn.forEach(t),yr=g(U),F=s(U,"DIV",{class:!0});var O=a(F);w(qo.$$.fragment,O),wr=g(O),re=s(O,"P",{});var st=a(re);kr=d(st,"The "),Zo=s(st,"A",{href:!0});var gd=a(Zo);Br=d(gd,"BigBirdPegasusForSequenceClassification"),gd.forEach(t),Tr=d(st," forward method, overrides the "),Kt=s(st,"CODE",{});var md=a(Kt);$r=d(md,"__call__"),md.forEach(t),Pr=d(st," special method."),st.forEach(t),qr=g(O),w(xe.$$.fragment,O),zr=g(O),w(Ce.$$.fragment,O),Fr=g(O),w(Ee.$$.fragment,O),xr=g(O),w(Me.$$.fragment,O),Cr=g(O),w(je.$$.fragment,O),O.forEach(t),U.forEach(t),Fn=g(o),ie=s(o,"H2",{class:!0});var es=a(ie);Se=s(es,"A",{id:!0,class:!0,href:!0});var fd=a(Se);Vt=s(fd,"SPAN",{});var _d=a(Vt);w(zo.$$.fragment,_d),_d.forEach(t),fd.forEach(t),Er=g(es),Jt=s(es,"SPAN",{});var bd=a(Jt);Mr=d(bd,"BigBirdPegasusForQuestionAnswering"),bd.forEach(t),es.forEach(t),xn=g(o),M=s(o,"DIV",{class:!0});var H=a(M);w(Fo.$$.fragment,H),jr=g(H),de=s(H,"P",{});var at=a(de);Sr=d(at,`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Zt=s(at,"CODE",{});var vd=a(Zt);Or=d(vd,"span start logits"),vd.forEach(t),Ar=d(at," and "),Yt=s(at,"CODE",{});var yd=a(Yt);Lr=d(yd,"span end logits"),yd.forEach(t),Nr=d(at,")."),at.forEach(t),Ir=g(H),xo=s(H,"P",{});var os=a(xo);Dr=d(os,"This model inherits from "),Yo=s(os,"A",{href:!0});var wd=a(Yo);Qr=d(wd,"PreTrainedModel"),wd.forEach(t),Gr=d(os,`. Check the superclass documentation for the generic methods the
