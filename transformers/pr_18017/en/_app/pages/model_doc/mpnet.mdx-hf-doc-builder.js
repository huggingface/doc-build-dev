import{S as Jg,i as Yg,s as Zg,e as n,k as m,w as T,t as a,M as e_,c as s,d as t,m as h,a as r,x as M,h as i,b as v,G as e,g as _,y as $,q as w,o as P,B as N,v as t_,L as ve}from"../../chunks/vendor-hf-doc-builder.js";import{T as Fe}from"../../chunks/Tip-hf-doc-builder.js";import{D as G}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Te}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ae}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as be}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function o_(y){let l,g,c,p,b;return p=new Te({props:{code:`from transformers import MPNetModel, MPNetConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function T_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=m(),E=n("p"),X=a("This second option is useful when using "),D=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),R=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),B=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=r(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),U=h(u),E=s(u,"P",{});var I=r(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=s(I,"CODE",{});var $e=r(W);ce=i($e,"model(inputs)"),$e.forEach(t),se=i(I,"."),I.forEach(t),R=h(u),O=s(u,"P",{});var we=r(O);Y=i(we,`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),B=s(S,"CODE",{});var ge=r(B);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,U,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,R,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,B),e(B,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(U),u&&t(E),u&&t(R),u&&t(O),u&&t(V),u&&t(q)}}}function M_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=a("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function w_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=m(),E=n("p"),X=a("This second option is useful when using "),D=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),R=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),B=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=r(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),U=h(u),E=s(u,"P",{});var I=r(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),B=s(S,"CODE",{});var ge=r(B);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,U,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,R,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,B),e(B,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(U),u&&t(E),u&&t(R),u&&t(O),u&&t(V),u&&t(q)}}}function P_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function F_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=m(),E=n("p"),X=a("This second option is useful when using "),D=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),R=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),B=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=r(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),U=h(u),E=s(u,"P",{});var I=r(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),B=s(S,"CODE",{});var ge=r(B);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,U,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,R,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,B),e(B,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(U),u&&t(E),u&&t(R),u&&t(O),u&&t(V),u&&t(q)}}}function z_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function x_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=m(),E=n("p"),X=a("This second option is useful when using "),D=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),R=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),B=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=r(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),U=h(u),E=s(u,"P",{});var I=r(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),B=s(S,"CODE",{});var ge=r(B);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,U,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,R,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,B),e(B,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(U),u&&t(E),u&&t(R),u&&t(O),u&&t(V),u&&t(q)}}}function C_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=a("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function L_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=m(),E=n("p"),X=a("This second option is useful when using "),D=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),R=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),B=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=r(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),U=h(u),E=s(u,"P",{});var I=r(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),B=s(S,"CODE",{});var ge=r(B);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,U,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,R,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,B),e(B,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(U),u&&t(E),u&&t(R),u&&t(O),u&&t(V),u&&t(q)}}}function A_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function S_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=m(),E=n("p"),X=a("This second option is useful when using "),D=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),R=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),B=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=r(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),U=h(u),E=s(u,"P",{});var I=r(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),B=s(S,"CODE",{});var ge=r(B);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,U,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,R,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,B),e(B,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(U),u&&t(E),u&&t(R),u&&t(O),u&&t(V),u&&t(q)}}}function D_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function H_(y){let l,g,c,p,b,d,f,z,le,U,E,X,D,J,de,W,ce,se,R,O,Y,V,q,x,Z,H,re,ee,B,ae,te,C,pe,Q,oe,me,L,ne,j,he,u,F,K,_e,Me,I,ke,$e,we,A,S,Pe,ge,fe,Ne,ie,ue,no,Kr,un,Jl,Xr,Yl,qi,Je,gn,Zl,dt,ed,tr,td,od,or,nd,sd,_n,rd,ad,id,Nt,ld,nr,dd,cd,sr,pd,md,hd,so,xi,yt,ro,Gr,kn,fd,Jr,ud,Ci,ze,bn,gd,vn,_d,rr,kd,bd,vd,ht,Tn,Td,Yr,Md,$d,Mn,ar,wd,Zr,Pd,Nd,ir,yd,ea,Fd,zd,ao,$n,Ed,wn,qd,ta,xd,Cd,jd,io,Pn,Ld,oa,Ad,Od,lr,Nn,ji,Ft,lo,na,yn,Id,sa,Sd,Li,Ye,Fn,Dd,zn,Wd,ra,Qd,Hd,Bd,En,Rd,dr,Ud,Vd,Kd,co,qn,Xd,aa,Gd,Ai,zt,po,ia,xn,Jd,la,Yd,Oi,Oe,Cn,Zd,da,ec,tc,jn,oc,cr,nc,sc,rc,Ln,ac,An,ic,lc,dc,Ze,On,cc,Et,pc,pr,mc,hc,ca,fc,uc,gc,mo,_c,ho,Ii,qt,fo,pa,In,kc,ma,bc,Si,xt,Sn,vc,He,Dn,Tc,Ct,Mc,mr,$c,wc,ha,Pc,Nc,yc,uo,Fc,go,zc,_o,Di,jt,ko,fa,Wn,Ec,ua,qc,Wi,Ie,Qn,xc,ga,Cc,jc,Hn,Lc,hr,Ac,Oc,Ic,Bn,Sc,Rn,Dc,Wc,Qc,ye,Un,Hc,Lt,Bc,fr,Rc,Uc,_a,Vc,Kc,Xc,bo,Gc,vo,Jc,To,Yc,Mo,Zc,$o,Qi,At,wo,ka,Vn,ep,ba,tp,Hi,Se,Kn,op,va,np,sp,Xn,rp,ur,ap,ip,lp,Gn,dp,Jn,cp,pp,mp,et,Yn,hp,Ot,fp,gr,up,gp,Ta,_p,kp,bp,Po,vp,No,Bi,It,yo,Ma,Zn,Tp,$a,Mp,Ri,De,es,$p,wa,wp,Pp,ts,Np,_r,yp,Fp,zp,os,Ep,ns,qp,xp,Cp,Be,ss,jp,St,Lp,kr,Ap,Op,Pa,Ip,Sp,Dp,Fo,Wp,zo,Qp,Eo,Ui,Dt,qo,Na,rs,Hp,ya,Bp,Vi,We,as,Rp,Wt,Up,Fa,Vp,Kp,za,Xp,Gp,Jp,is,Yp,br,Zp,em,tm,ls,om,ds,nm,sm,rm,Re,cs,am,Qt,im,vr,lm,dm,Ea,cm,pm,mm,xo,hm,Co,fm,jo,Ki,Ht,Lo,qa,ps,um,xa,gm,Xi,Ee,ms,_m,Ca,km,bm,hs,vm,Tr,Tm,Mm,$m,fs,wm,us,Pm,Nm,ym,Ao,Fm,tt,gs,zm,Bt,Em,Mr,qm,xm,ja,Cm,jm,Lm,Oo,Am,Io,Gi,Rt,So,La,_s,Om,Aa,Im,Ji,qe,ks,Sm,bs,Dm,Oa,Wm,Qm,Hm,vs,Bm,$r,Rm,Um,Vm,Ts,Km,Ms,Xm,Gm,Jm,Do,Ym,Ue,$s,Zm,Ut,eh,wr,th,oh,Ia,nh,sh,rh,Wo,ah,Qo,ih,Ho,Yi,Vt,Bo,Sa,ws,lh,Da,dh,Zi,xe,Ps,ch,Wa,ph,mh,Ns,hh,Pr,fh,uh,gh,ys,_h,Fs,kh,bh,vh,Ro,Th,Ve,zs,Mh,Kt,$h,Nr,wh,Ph,Qa,Nh,yh,Fh,Uo,zh,Vo,Eh,Ko,el,Xt,Xo,Ha,Es,qh,Ba,xh,tl,Ce,qs,Ch,Ra,jh,Lh,xs,Ah,yr,Oh,Ih,Sh,Cs,Dh,js,Wh,Qh,Hh,Go,Bh,ot,Ls,Rh,Gt,Uh,Fr,Vh,Kh,Ua,Xh,Gh,Jh,Jo,Yh,Yo,ol,Jt,Zo,Va,As,Zh,Ka,ef,nl,je,Os,tf,Xa,of,nf,Is,sf,zr,rf,af,lf,Ss,df,Ds,cf,pf,mf,en,hf,Ke,Ws,ff,Yt,uf,Er,gf,_f,Ga,kf,bf,vf,tn,Tf,on,Mf,nn,sl,Zt,sn,Ja,Qs,$f,Ya,wf,rl,Le,Hs,Pf,eo,Nf,Za,yf,Ff,ei,zf,Ef,qf,Bs,xf,qr,Cf,jf,Lf,Rs,Af,Us,Of,If,Sf,rn,Df,Xe,Vs,Wf,to,Qf,xr,Hf,Bf,ti,Rf,Uf,Vf,an,Kf,ln,Xf,dn,al;return d=new Ae({}),J=new Ae({}),un=new Ae({}),gn=new G({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/tokenization_mpnet.py#L231",returnDescription:`
...
Set to True if the token list is already formatted with special tokens for the model`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/tokenization_mpnet.py#L256",returnDescription:`
...
Optional second list of IDs for sequence pairs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/tokenization_mpnet_fast.py#L191",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
configuration. Check out the <a href="/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L483"}}),On=new G({props:{name:"forward",anchor:"transformers.MPNetModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetConfig"
...
`}}),mo=new Fe({props:{$$slots:{default:[n_]},$$scope:{ctx:y}}}),ho=new be({props:{anchor:"transformers.MPNetModel.forward.example",$$slots:{default:[s_]},$$scope:{ctx:y}}}),In=new Ae({}),Sn=new G({props:{name:"class transformers.MPNetForMaskedLM",anchor:"transformers.MPNetForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L576"}}),Dn=new G({props:{name:"forward",anchor:"transformers.MPNetForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L595",returnDescription:`
<p>A <a
...
`}}),uo=new Fe({props:{$$slots:{default:[r_]},$$scope:{ctx:y}}}),go=new be({props:{anchor:"transformers.MPNetForMaskedLM.forward.example",$$slots:{default:[a_]},$$scope:{ctx:y}}}),_o=new be({props:{anchor:"transformers.MPNetForMaskedLM.forward.example-2",$$slots:{default:[i_]},$$scope:{ctx:y}}}),Wn=new Ae({}),Qn=new G({props:{name:"class transformers.MPNetForSequenceClassification",anchor:"transformers.MPNetForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L685"}}),Un=new G({props:{name:"forward",anchor:"transformers.MPNetForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L698",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L780"}}),Yn=new G({props:{name:"forward",anchor:"transformers.MPNetForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L793",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L886",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
`}}),Fo=new Fe({props:{$$slots:{default:[u_]},$$scope:{ctx:y}}}),zo=new be({props:{anchor:"transformers.MPNetForTokenClassification.forward.example",$$slots:{default:[g_]},$$scope:{ctx:y}}}),Eo=new be({props:{anchor:"transformers.MPNetForTokenClassification.forward.example-2",$$slots:{default:[__]},$$scope:{ctx:y}}}),rs=new Ae({}),as=new G({props:{name:"class transformers.MPNetForQuestionAnswering",anchor:"transformers.MPNetForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L971"}}),cs=new G({props:{name:"forward",anchor:"transformers.MPNetForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_mpnet.py#L985",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
`}}),xo=new Fe({props:{$$slots:{default:[k_]},$$scope:{ctx:y}}}),Co=new be({props:{anchor:"transformers.MPNetForQuestionAnswering.forward.example",$$slots:{default:[b_]},$$scope:{ctx:y}}}),jo=new be({props:{anchor:"transformers.MPNetForQuestionAnswering.forward.example-2",$$slots:{default:[v_]},$$scope:{ctx:y}}}),ps=new Ae({}),ms=new G({props:{name:"class transformers.TFMPNetModel",anchor:"transformers.TFMPNetModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L664"}}),Ao=new Fe({props:{$$slots:{default:[T_]},$$scope:{ctx:y}}}),gs=new G({props:{name:"call",anchor:"transformers.TFMPNetModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMPNetModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_18017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L669",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
`}}),Oo=new Fe({props:{$$slots:{default:[M_]},$$scope:{ctx:y}}}),Io=new be({props:{anchor:"transformers.TFMPNetModel.call.example",$$slots:{default:[$_]},$$scope:{ctx:y}}}),_s=new Ae({}),ks=new G({props:{name:"class transformers.TFMPNetForMaskedLM",anchor:"transformers.TFMPNetForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L784",returnDescription:`
<p>A <a
...
`}}),Wo=new Fe({props:{$$slots:{default:[P_]},$$scope:{ctx:y}}}),Qo=new be({props:{anchor:"transformers.TFMPNetForMaskedLM.call.example",$$slots:{default:[N_]},$$scope:{ctx:y}}}),Ho=new be({props:{anchor:"transformers.TFMPNetForMaskedLM.call.example-2",$$slots:{default:[y_]},$$scope:{ctx:y}}}),ws=new Ae({}),Ps=new G({props:{name:"class transformers.TFMPNetForSequenceClassification",anchor:"transformers.TFMPNetForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L889",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L979",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1090",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18017/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1172",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18017/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
`}}),an=new Fe({props:{$$slots:{default:[D_]},$$scope:{ctx:y}}}),ln=new be({props:{anchor:"transformers.TFMPNetForQuestionAnswering.call.example",$$slots:{default:[W_]},$$scope:{ctx:y}}}),dn=new be({props:{anchor:"transformers.TFMPNetForQuestionAnswering.call.example-2",$$slots:{default:[Q_]},$$scope:{ctx:y}}}),{c(){l=n("meta"),g=m(),c=n("h1"),p=n("a"),b=n("span"),T(d.$$.fragment),f=m(),z=n("span"),le=a("MPNet"),U=m(),E=n("h2"),X=n("a"),D=n("span"),T(J.$$.fragment),de=m(),W=n("span"),ce=a("Overview"),se=m(),R=n("p"),O=a("The MPNet model was proposed in "),Y=n("a"),V=a("MPNet: Masked and Permuted Pre-training for Language Understanding"),q=a(" by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),x=m(),Z=n("p"),H=a(`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
masked language modeling and permuted language modeling for natural language understanding.`),re=m(),ee=n("p"),B=a("The abstract from the paper is the following:"),ae=m(),te=n("p"),C=n("em"),pe=a(`BERT adopts masked language modeling (MLM) for pre-training and is one of the most successful pre-training models.
...
separate your segments with the separation token `),_e=n("code"),Me=a("tokenizer.sep_token"),I=a(" (or "),ke=n("code"),$e=a("[sep]"),we=a(")."),A=m(),S=n("p"),Pe=a("The original code can be found "),ge=n("a"),fe=a("here"),Ne=a("."),ie=m(),ue=n("h2"),no=n("a"),Kr=n("span"),T(un.$$.fragment),Jl=m(),Xr=n("span"),Yl=a("MPNetConfig"),qi=m(),Je=n("div"),T(gn.$$.fragment),Zl=m(),dt=n("p"),ed=a("This is the configuration class to store the configuration of a "),tr=n("a"),td=a("MPNetModel"),od=a(" or a "),or=n("a"),nd=a("TFMPNetModel"),sd=a(`. It is used to
...
documentation from `),sr=n("a"),pd=a("PretrainedConfig"),md=a(" for more information."),hd=m(),T(so.$$.fragment),xi=m(),yt=n("h2"),ro=n("a"),Gr=n("span"),T(kn.$$.fragment),fd=m(),Jr=n("span"),ud=a("MPNetTokenizer"),Ci=m(),ze=n("div"),T(bn.$$.fragment),gd=m(),vn=n("p"),_d=a("This tokenizer inherits from "),rr=n("a"),kd=a("BertTokenizer"),bd=a(` which contains most of the methods. Users should refer to the
...
make use of token type ids, therefore a list of zeros is returned.`),Od=m(),lr=n("div"),T(Nn.$$.fragment),ji=m(),Ft=n("h2"),lo=n("a"),na=n("span"),T(yn.$$.fragment),Id=m(),sa=n("span"),Sd=a("MPNetTokenizerFast"),Li=m(),Ye=n("div"),T(Fn.$$.fragment),Dd=m(),zn=n("p"),Wd=a("Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),ra=n("em"),Qd=a("tokenizers"),Hd=a(" library). Based on WordPiece."),Bd=m(),En=n("p"),Rd=a("This tokenizer inherits from "),dr=n("a"),Ud=a("PreTrainedTokenizerFast"),Vd=a(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Kd=m(),co=n("div"),T(qn.$$.fragment),Xd=m(),aa=n("p"),Gd=a(`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
make use of token type ids, therefore a list of zeros is returned`),Ai=m(),zt=n("h2"),po=n("a"),ia=n("span"),T(xn.$$.fragment),Jd=m(),la=n("span"),Yd=a("MPNetModel"),Oi=m(),Oe=n("div"),T(Cn.$$.fragment),Zd=m(),da=n("p"),ec=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),tc=m(),jn=n("p"),oc=a("This model inherits from "),cr=n("a"),nc=a("PreTrainedModel"),sc=a(`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ic=m(),Bn=n("p"),Sc=a("This model is also a PyTorch "),Rn=n("a"),Dc=a("torch.nn.Module"),Wc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc=m(),ye=n("div"),T(Un.$$.fragment),Hc=m(),Lt=n("p"),Bc=a("The "),fr=n("a"),Rc=a("MPNetForSequenceClassification"),Uc=a(" forward method, overrides the "),_a=n("code"),Vc=a("__call__"),Kc=a(" special method."),Xc=m(),T(bo.$$.fragment),Gc=m(),T(vo.$$.fragment),Jc=m(),T(To.$$.fragment),Yc=m(),T(Mo.$$.fragment),Zc=m(),T($o.$$.fragment),Qi=m(),At=n("h2"),wo=n("a"),ka=n("span"),T(Vn.$$.fragment),ep=m(),ba=n("span"),tp=a("MPNetForMultipleChoice"),Hi=m(),Se=n("div"),T(Kn.$$.fragment),op=m(),va=n("p"),np=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp=m(),Gn=n("p"),dp=a("This model is also a PyTorch "),Jn=n("a"),cp=a("torch.nn.Module"),pp=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp=m(),et=n("div"),T(Yn.$$.fragment),hp=m(),Ot=n("p"),fp=a("The "),gr=n("a"),up=a("MPNetForMultipleChoice"),gp=a(" forward method, overrides the "),Ta=n("code"),_p=a("__call__"),kp=a(" special method."),bp=m(),T(Po.$$.fragment),vp=m(),T(No.$$.fragment),Bi=m(),It=n("h2"),yo=n("a"),Ma=n("span"),T(Zn.$$.fragment),Tp=m(),$a=n("span"),Mp=a("MPNetForTokenClassification"),Ri=m(),De=n("div"),T(es.$$.fragment),$p=m(),wa=n("p"),wp=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cp=m(),Be=n("div"),T(ss.$$.fragment),jp=m(),St=n("p"),Lp=a("The "),kr=n("a"),Ap=a("MPNetForTokenClassification"),Op=a(" forward method, overrides the "),Pa=n("code"),Ip=a("__call__"),Sp=a(" special method."),Dp=m(),T(Fo.$$.fragment),Wp=m(),T(zo.$$.fragment),Qp=m(),T(Eo.$$.fragment),Ui=m(),Dt=n("h2"),qo=n("a"),Na=n("span"),T(rs.$$.fragment),Hp=m(),ya=n("span"),Bp=a("MPNetForQuestionAnswering"),Vi=m(),We=n("div"),T(as.$$.fragment),Rp=m(),Wt=n("p"),Up=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fa=n("code"),Vp=a("span start logits"),Kp=a(" and "),za=n("code"),Xp=a("span end logits"),Gp=a(")."),Jp=m(),is=n("p"),Yp=a("This model inherits from "),br=n("a"),Zp=a("PreTrainedModel"),em=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tm=m(),ls=n("p"),om=a("This model is also a PyTorch "),ds=n("a"),nm=a("torch.nn.Module"),sm=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rm=m(),Re=n("div"),T(cs.$$.fragment),am=m(),Qt=n("p"),im=a("The "),vr=n("a"),lm=a("MPNetForQuestionAnswering"),dm=a(" forward method, overrides the "),Ea=n("code"),cm=a("__call__"),pm=a(" special method."),mm=m(),T(xo.$$.fragment),hm=m(),T(Co.$$.fragment),fm=m(),T(jo.$$.fragment),Ki=m(),Ht=n("h2"),Lo=n("a"),qa=n("span"),T(ps.$$.fragment),um=m(),xa=n("span"),gm=a("TFMPNetModel"),Xi=m(),Ee=n("div"),T(ms.$$.fragment),_m=m(),Ca=n("p"),km=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),bm=m(),hs=n("p"),vm=a("This model inherits from "),Tr=n("a"),Tm=a("TFPreTrainedModel"),Mm=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$m=m(),fs=n("p"),wm=a("This model is also a "),us=n("a"),Pm=a("tf.keras.Model"),Nm=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ym=m(),T(Ao.$$.fragment),Fm=m(),tt=n("div"),T(gs.$$.fragment),zm=m(),Bt=n("p"),Em=a("The "),Mr=n("a"),qm=a("TFMPNetModel"),xm=a(" forward method, overrides the "),ja=n("code"),Cm=a("__call__"),jm=a(" special method."),Lm=m(),T(Oo.$$.fragment),Am=m(),T(Io.$$.fragment),Gi=m(),Rt=n("h2"),So=n("a"),La=n("span"),T(_s.$$.fragment),Om=m(),Aa=n("span"),Im=a("TFMPNetForMaskedLM"),Ji=m(),qe=n("div"),T(ks.$$.fragment),Sm=m(),bs=n("p"),Dm=a("MPNet Model with a "),Oa=n("code"),Wm=a("language modeling"),Qm=a(" head on top."),Hm=m(),vs=n("p"),Bm=a("This model inherits from "),$r=n("a"),Rm=a("TFPreTrainedModel"),Um=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vm=m(),Ts=n("p"),Km=a("This model is also a "),Ms=n("a"),Xm=a("tf.keras.Model"),Gm=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jm=m(),T(Do.$$.fragment),Ym=m(),Ue=n("div"),T($s.$$.fragment),Zm=m(),Ut=n("p"),eh=a("The "),wr=n("a"),th=a("TFMPNetForMaskedLM"),oh=a(" forward method, overrides the "),Ia=n("code"),nh=a("__call__"),sh=a(" special method."),rh=m(),T(Wo.$$.fragment),ah=m(),T(Qo.$$.fragment),ih=m(),T(Ho.$$.fragment),Yi=m(),Vt=n("h2"),Bo=n("a"),Sa=n("span"),T(ws.$$.fragment),lh=m(),Da=n("span"),dh=a("TFMPNetForSequenceClassification"),Zi=m(),xe=n("div"),T(Ps.$$.fragment),ch=m(),Wa=n("p"),ph=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vh=m(),T(Ro.$$.fragment),Th=m(),Ve=n("div"),T(zs.$$.fragment),Mh=m(),Kt=n("p"),$h=a("The "),Nr=n("a"),wh=a("TFMPNetForSequenceClassification"),Ph=a(" forward method, overrides the "),Qa=n("code"),Nh=a("__call__"),yh=a(" special method."),Fh=m(),T(Uo.$$.fragment),zh=m(),T(Vo.$$.fragment),Eh=m(),T(Ko.$$.fragment),el=m(),Xt=n("h2"),Xo=n("a"),Ha=n("span"),T(Es.$$.fragment),qh=m(),Ba=n("span"),xh=a("TFMPNetForMultipleChoice"),tl=m(),Ce=n("div"),T(qs.$$.fragment),Ch=m(),Ra=n("p"),jh=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh=m(),T(Go.$$.fragment),Bh=m(),ot=n("div"),T(Ls.$$.fragment),Rh=m(),Gt=n("p"),Uh=a("The "),Fr=n("a"),Vh=a("TFMPNetForMultipleChoice"),Kh=a(" forward method, overrides the "),Ua=n("code"),Xh=a("__call__"),Gh=a(" special method."),Jh=m(),T(Jo.$$.fragment),Yh=m(),T(Yo.$$.fragment),ol=m(),Jt=n("h2"),Zo=n("a"),Va=n("span"),T(As.$$.fragment),Zh=m(),Ka=n("span"),ef=a("TFMPNetForTokenClassification"),nl=m(),je=n("div"),T(Os.$$.fragment),tf=m(),Xa=n("p"),of=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mf=m(),T(en.$$.fragment),hf=m(),Ke=n("div"),T(Ws.$$.fragment),ff=m(),Yt=n("p"),uf=a("The "),Er=n("a"),gf=a("TFMPNetForTokenClassification"),_f=a(" forward method, overrides the "),Ga=n("code"),kf=a("__call__"),bf=a(" special method."),vf=m(),T(tn.$$.fragment),Tf=m(),T(on.$$.fragment),Mf=m(),T(nn.$$.fragment),sl=m(),Zt=n("h2"),sn=n("a"),Ja=n("span"),T(Qs.$$.fragment),$f=m(),Ya=n("span"),wf=a("TFMPNetForQuestionAnswering"),rl=m(),Le=n("div"),T(Hs.$$.fragment),Pf=m(),eo=n("p"),Nf=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Za=n("code"),yf=a("span start logits"),Ff=a(" and "),ei=n("code"),zf=a("span end logits"),Ef=a(")."),qf=m(),Bs=n("p"),xf=a("This model inherits from "),qr=n("a"),Cf=a("TFPreTrainedModel"),jf=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf=m(),Rs=n("p"),Af=a("This model is also a "),Us=n("a"),Of=a("tf.keras.Model"),If=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sf=m(),T(rn.$$.fragment),Df=m(),Xe=n("div"),T(Vs.$$.fragment),Wf=m(),to=n("p"),Qf=a("The "),xr=n("a"),Hf=a("TFMPNetForQuestionAnswering"),Bf=a(" forward method, overrides the "),ti=n("code"),Rf=a("__call__"),Uf=a(" special method."),Vf=m(),T(an.$$.fragment),Kf=m(),T(ln.$$.fragment),Xf=m(),T(dn.$$.fragment),this.h()},l(o){const k=e_('[data-svelte="svelte-1phssyn"]',document.head);l=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var Ks=r(c);p=s(Ks,"A",{id:!0,class:!0,href:!0});var oi=r(p);b=s(oi,"SPAN",{});var ni=r(b);M(d.$$.fragment,ni),ni.forEach(t),oi.forEach(t),f=h(Ks),z=s(Ks,"SPAN",{});var si=r(z);le=i(si,"MPNet"),si.forEach(t),Ks.forEach(t),U=h(o),E=s(o,"H2",{class:!0});var Xs=r(E);X=s(Xs,"A",{id:!0,class:!0,href:!0});var ri=r(X);D=s(ri,"SPAN",{});var ai=r(D);M(J.$$.fragment,ai),ai.forEach(t),ri.forEach(t),de=h(Xs),W=s(Xs,"SPAN",{});var ii=r(W);ce=i(ii,"Overview"),ii.forEach(t),Xs.forEach(t),se=h(o),R=s(o,"P",{});var Gs=r(R);O=i(Gs,"The MPNet model was proposed in "),Y=s(Gs,"A",{href:!0,rel:!0});var li=r(Y);V=i(li,"MPNet: Masked and Permuted Pre-training for Language Understanding"),li.forEach(t),q=i(Gs," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),Gs.forEach(t),x=h(o),Z=s(o,"P",{});var di=r(Z);H=i(di,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
masked language modeling and permuted language modeling for natural language understanding.`),di.forEach(t),re=h(o),ee=s(o,"P",{});var ci=r(ee);B=i(ci,"The abstract from the paper is the following:"),ci.forEach(t),ae=h(o),te=s(o,"P",{});var pi=r(te);C=s(pi,"EM",{});var mi=r(C);pe=i(mi,`BERT adopts masked language modeling (MLM) for pre-training and is one of the most successful pre-training models.
Since BERT neglects dependency among predicted tokens, XLNet introduces permuted language modeling (PLM) for
pre-training to address this problem. However, XLNet does not leverage the full position information of a sentence and
thus suffers from position discrepancy between pre-training and fine-tuning. In this paper, we propose MPNet, a novel
pre-training method that inherits the advantages of BERT and XLNet and avoids their limitations. MPNet leverages the
...
separate your segments with the separation token `),_e=s(ct,"CODE",{});var gi=r(_e);Me=i(gi,"tokenizer.sep_token"),gi.forEach(t),I=i(ct," (or "),ke=s(ct,"CODE",{});var _i=r(ke);$e=i(_i,"[sep]"),_i.forEach(t),we=i(ct,")."),ct.forEach(t),fi.forEach(t),A=h(o),S=s(o,"P",{});var Js=r(S);Pe=i(Js,"The original code can be found "),ge=s(Js,"A",{href:!0,rel:!0});var ki=r(ge);fe=i(ki,"here"),ki.forEach(t),Ne=i(Js,"."),Js.forEach(t),ie=h(o),ue=s(o,"H2",{class:!0});var Ys=r(ue);no=s(Ys,"A",{id:!0,class:!0,href:!0});var bi=r(no);Kr=s(bi,"SPAN",{});var vi=r(Kr);M(un.$$.fragment,vi),vi.forEach(t),bi.forEach(t),Jl=h(Ys),Xr=s(Ys,"SPAN",{});var Ti=r(Xr);Yl=i(Ti,"MPNetConfig"),Ti.forEach(t),Ys.forEach(t),qi=h(o),Je=s(o,"DIV",{class:!0});var pt=r(Je);M(gn.$$.fragment,pt),Zl=h(pt),dt=s(pt,"P",{});var mt=r(dt);ed=i(mt,"This is the configuration class to store the configuration of a "),tr=s(mt,"A",{href:!0});var Mi=r(tr);td=i(Mi,"MPNetModel"),Mi.forEach(t),od=i(mt," or a "),or=s(mt,"A",{href:!0});var $i=r(or);nd=i($i,"TFMPNetModel"),$i.forEach(t),sd=i(mt,`. It is used to
instantiate a MPNet model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MPNet
...
adding special tokens. A MPNet sequence has the following format:`),Yf.forEach(t),$d=h(Cr),Mn=s(Cr,"UL",{});var il=r(Mn);ar=s(il,"LI",{});var Gf=r(ar);wd=i(Gf,"single sequence: "),Zr=s(Gf,"CODE",{});var Zf=r(Zr);Pd=i(Zf,"<s> X </s>"),Zf.forEach(t),Gf.forEach(t),Nd=h(il),ir=s(il,"LI",{});var Jf=r(ir);yd=i(Jf,"pair of sequences: "),ea=s(Jf,"CODE",{});var eu=r(ea);Fd=i(eu,"<s> A </s></s> B </s>"),eu.forEach(t),Jf.forEach(t),il.forEach(t),Cr.forEach(t),zd=h(Qe),ao=s(Qe,"DIV",{class:!0});var ll=r(ao);M($n.$$.fragment,ll),Ed=h(ll),wn=s(ll,"P",{});var dl=r(wn);qd=i(dl,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),ou.forEach(t),cl.forEach(t),Od=h(Qe),lr=s(Qe,"DIV",{class:!0});var nu=r(lr);M(Nn.$$.fragment,nu),nu.forEach(t),Qe.forEach(t),ji=h(o),Ft=s(o,"H2",{class:!0});var pl=r(Ft);lo=s(pl,"A",{id:!0,class:!0,href:!0});var su=r(lo);na=s(su,"SPAN",{});var ru=r(na);M(yn.$$.fragment,ru),ru.forEach(t),su.forEach(t),Id=h(pl),sa=s(pl,"SPAN",{});var au=r(sa);Sd=i(au,"MPNetTokenizerFast"),au.forEach(t),pl.forEach(t),Li=h(o),Ye=s(o,"DIV",{class:!0});var cn=r(Ye);M(Fn.$$.fragment,cn),Dd=h(cn),zn=s(cn,"P",{});var ml=r(zn);Wd=i(ml,"Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),ra=s(ml,"EM",{});var iu=r(ra);Qd=i(iu,"tokenizers"),iu.forEach(t),Hd=i(ml," library). Based on WordPiece."),ml.forEach(t),Bd=h(cn),En=s(cn,"P",{});var hl=r(En);Rd=i(hl,"This tokenizer inherits from "),dr=s(hl,"A",{href:!0});var lu=r(dr);Ud=i(lu,"PreTrainedTokenizerFast"),lu.forEach(t),Vd=i(hl,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),hl.forEach(t),Kd=h(cn),co=s(cn,"DIV",{class:!0});var fl=r(co);M(qn.$$.fragment,fl),Xd=h(fl),aa=s(fl,"P",{});var du=r(aa);Gd=i(du,`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
make use of token type ids, therefore a list of zeros is returned`),du.forEach(t),fl.forEach(t),cn.forEach(t),Ai=h(o),zt=s(o,"H2",{class:!0});var ul=r(zt);po=s(ul,"A",{id:!0,class:!0,href:!0});var cu=r(po);ia=s(cu,"SPAN",{});var pu=r(ia);M(xn.$$.fragment,pu),pu.forEach(t),cu.forEach(t),Jd=h(ul),la=s(ul,"SPAN",{});var mu=r(la);Yd=i(mu,"MPNetModel"),mu.forEach(t),ul.forEach(t),Oi=h(o),Oe=s(o,"DIV",{class:!0});var ft=r(Oe);M(Cn.$$.fragment,ft),Zd=h(ft),da=s(ft,"P",{});var hu=r(da);ec=i(hu,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),hu.forEach(t),tc=h(ft),jn=s(ft,"P",{});var gl=r(jn);oc=i(gl,"This model inherits from "),cr=s(gl,"A",{href:!0});var fu=r(cr);nc=i(fu,"PreTrainedModel"),fu.forEach(t),sc=i(gl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tl.forEach(t),Ic=h(gt),Bn=s(gt,"P",{});var Ml=r(Bn);Sc=i(Ml,"This model is also a PyTorch "),Rn=s(Ml,"A",{href:!0,rel:!0});var Fu=r(Rn);Dc=i(Fu,"torch.nn.Module"),Fu.forEach(t),Wc=i(Ml,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ml.forEach(t),Qc=h(gt),ye=s(gt,"DIV",{class:!0});var Ge=r(ye);M(Un.$$.fragment,Ge),Hc=h(Ge),Lt=s(Ge,"P",{});var Ar=r(Lt);Bc=i(Ar,"The "),fr=s(Ar,"A",{href:!0});var zu=r(fr);Rc=i(zu,"MPNetForSequenceClassification"),zu.forEach(t),Uc=i(Ar," forward method, overrides the "),_a=s(Ar,"CODE",{});var Eu=r(_a);Vc=i(Eu,"__call__"),Eu.forEach(t),Kc=i(Ar," special method."),Ar.forEach(t),Xc=h(Ge),M(bo.$$.fragment,Ge),Gc=h(Ge),M(vo.$$.fragment,Ge),Jc=h(Ge),M(To.$$.fragment,Ge),Yc=h(Ge),M(Mo.$$.fragment,Ge),Zc=h(Ge),M($o.$$.fragment,Ge),Ge.forEach(t),gt.forEach(t),Qi=h(o),At=s(o,"H2",{class:!0});var $l=r(At);wo=s($l,"A",{id:!0,class:!0,href:!0});var qu=r(wo);ka=s(qu,"SPAN",{});var xu=r(ka);M(Vn.$$.fragment,xu),xu.forEach(t),qu.forEach(t),ep=h($l),ba=s($l,"SPAN",{});var Cu=r(ba);tp=i(Cu,"MPNetForMultipleChoice"),Cu.forEach(t),$l.forEach(t),Hi=h(o),Se=s(o,"DIV",{class:!0});var _t=r(Se);M(Kn.$$.fragment,_t),op=h(_t),va=s(_t,"P",{});var ju=r(va);np=i(ju,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wl.forEach(t),lp=h(_t),Gn=s(_t,"P",{});var Pl=r(Gn);dp=i(Pl,"This model is also a PyTorch "),Jn=s(Pl,"A",{href:!0,rel:!0});var Au=r(Jn);cp=i(Au,"torch.nn.Module"),Au.forEach(t),pp=i(Pl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pl.forEach(t),mp=h(_t),et=s(_t,"DIV",{class:!0});var mn=r(et);M(Yn.$$.fragment,mn),hp=h(mn),Ot=s(mn,"P",{});var Or=r(Ot);fp=i(Or,"The "),gr=s(Or,"A",{href:!0});var Ou=r(gr);up=i(Ou,"MPNetForMultipleChoice"),Ou.forEach(t),gp=i(Or," forward method, overrides the "),Ta=s(Or,"CODE",{});var Iu=r(Ta);_p=i(Iu,"__call__"),Iu.forEach(t),kp=i(Or," special method."),Or.forEach(t),bp=h(mn),M(Po.$$.fragment,mn),vp=h(mn),M(No.$$.fragment,mn),mn.forEach(t),_t.forEach(t),Bi=h(o),It=s(o,"H2",{class:!0});var Nl=r(It);yo=s(Nl,"A",{id:!0,class:!0,href:!0});var Su=r(yo);Ma=s(Su,"SPAN",{});var Du=r(Ma);M(Zn.$$.fragment,Du),Du.forEach(t),Su.forEach(t),Tp=h(Nl),$a=s(Nl,"SPAN",{});var Wu=r($a);Mp=i(Wu,"MPNetForTokenClassification"),Wu.forEach(t),Nl.forEach(t),Ri=h(o),De=s(o,"DIV",{class:!0});var kt=r(De);M(es.$$.fragment,kt),$p=h(kt),wa=s(kt,"P",{});var Qu=r(wa);wp=i(Qu,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yl.forEach(t),zp=h(kt),os=s(kt,"P",{});var Fl=r(os);Ep=i(Fl,"This model is also a PyTorch "),ns=s(Fl,"A",{href:!0,rel:!0});var Bu=r(ns);qp=i(Bu,"torch.nn.Module"),Bu.forEach(t),xp=i(Fl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fl.forEach(t),Cp=h(kt),Be=s(kt,"DIV",{class:!0});var bt=r(Be);M(ss.$$.fragment,bt),jp=h(bt),St=s(bt,"P",{});var Ir=r(St);Lp=i(Ir,"The "),kr=s(Ir,"A",{href:!0});var Ru=r(kr);Ap=i(Ru,"MPNetForTokenClassification"),Ru.forEach(t),Op=i(Ir," forward method, overrides the "),Pa=s(Ir,"CODE",{});var Uu=r(Pa);Ip=i(Uu,"__call__"),Uu.forEach(t),Sp=i(Ir," special method."),Ir.forEach(t),Dp=h(bt),M(Fo.$$.fragment,bt),Wp=h(bt),M(zo.$$.fragment,bt),Qp=h(bt),M(Eo.$$.fragment,bt),bt.forEach(t),kt.forEach(t),Ui=h(o),Dt=s(o,"H2",{class:!0});var zl=r(Dt);qo=s(zl,"A",{id:!0,class:!0,href:!0});var Vu=r(qo);Na=s(Vu,"SPAN",{});var Ku=r(Na);M(rs.$$.fragment,Ku),Ku.forEach(t),Vu.forEach(t),Hp=h(zl),ya=s(zl,"SPAN",{});var Xu=r(ya);Bp=i(Xu,"MPNetForQuestionAnswering"),Xu.forEach(t),zl.forEach(t),Vi=h(o),We=s(o,"DIV",{class:!0});var vt=r(We);M(as.$$.fragment,vt),Rp=h(vt),Wt=s(vt,"P",{});var Sr=r(Wt);Up=i(Sr,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fa=s(Sr,"CODE",{});var Gu=r(Fa);Vp=i(Gu,"span start logits"),Gu.forEach(t),Kp=i(Sr," and "),za=s(Sr,"CODE",{});var Ju=r(za);Xp=i(Ju,"span end logits"),Ju.forEach(t),Gp=i(Sr,")."),Sr.forEach(t),Jp=h(vt),is=s(vt,"P",{});var El=r(is);Yp=i(El,"This model inherits from "),br=s(El,"A",{href:!0});var Yu=r(br);Zp=i(Yu,"PreTrainedModel"),Yu.forEach(t),em=i(El,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jl.forEach(t),ym=h(nt),M(Ao.$$.fragment,nt),Fm=h(nt),tt=s(nt,"DIV",{class:!0});var hn=r(tt);M(gs.$$.fragment,hn),zm=h(hn),Bt=s(hn,"P",{});var Wr=r(Bt);Em=i(Wr,"The "),Mr=s(Wr,"A",{href:!0});var lg=r(Mr);qm=i(lg,"TFMPNetModel"),lg.forEach(t),xm=i(Wr," forward method, overrides the "),ja=s(Wr,"CODE",{});var dg=r(ja);Cm=i(dg,"__call__"),dg.forEach(t),jm=i(Wr," special method."),Wr.forEach(t),Lm=h(hn),M(Oo.$$.fragment,hn),Am=h(hn),M(Io.$$.fragment,hn),hn.forEach(t),nt.forEach(t),Gi=h(o),Rt=s(o,"H2",{class:!0});var Ll=r(Rt);So=s(Ll,"A",{id:!0,class:!0,href:!0});var cg=r(So);La=s(cg,"SPAN",{});var pg=r(La);M(_s.$$.fragment,pg),pg.forEach(t),cg.forEach(t),Om=h(Ll),Aa=s(Ll,"SPAN",{});var mg=r(Aa);Im=i(mg,"TFMPNetForMaskedLM"),mg.forEach(t),Ll.forEach(t),Ji=h(o),qe=s(o,"DIV",{class:!0});var st=r(qe);M(ks.$$.fragment,st),Sm=h(st),bs=s(st,"P",{});var Al=r(bs);Dm=i(Al,"MPNet Model with a "),Oa=s(Al,"CODE",{});var hg=r(Oa);Wm=i(hg,"language modeling"),hg.forEach(t),Qm=i(Al," head on top."),Al.forEach(t),Hm=h(st),vs=s(st,"P",{});var Ol=r(vs);Bm=i(Ol,"This model inherits from "),$r=s(Ol,"A",{href:!0});var fg=r($r);Rm=i(fg,"TFPreTrainedModel"),fg.forEach(t),Um=i(Ol,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ol.forEach(t),Vm=h(st),Ts=s(st,"P",{});var Il=r(Ts);Km=i(Il,"This model is also a "),Ms=s(Il,"A",{href:!0,rel:!0});var ug=r(Ms);Xm=i(ug,"tf.keras.Model"),ug.forEach(t),Gm=i(Il,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Il.forEach(t),Jm=h(st),M(Do.$$.fragment,st),Ym=h(st),Ue=s(st,"DIV",{class:!0});var Mt=r(Ue);M($s.$$.fragment,Mt),Zm=h(Mt),Ut=s(Mt,"P",{});var Qr=r(Ut);eh=i(Qr,"The "),wr=s(Qr,"A",{href:!0});var gg=r(wr);th=i(gg,"TFMPNetForMaskedLM"),gg.forEach(t),oh=i(Qr," forward method, overrides the "),Ia=s(Qr,"CODE",{});var _g=r(Ia);nh=i(_g,"__call__"),_g.forEach(t),sh=i(Qr," special method."),Qr.forEach(t),rh=h(Mt),M(Wo.$$.fragment,Mt),ah=h(Mt),M(Qo.$$.fragment,Mt),ih=h(Mt),M(Ho.$$.fragment,Mt),Mt.forEach(t),st.forEach(t),Yi=h(o),Vt=s(o,"H2",{class:!0});var Sl=r(Vt);Bo=s(Sl,"A",{id:!0,class:!0,href:!0});var kg=r(Bo);Sa=s(kg,"SPAN",{});var bg=r(Sa);M(ws.$$.fragment,bg),bg.forEach(t),kg.forEach(t),lh=h(Sl),Da=s(Sl,"SPAN",{});var vg=r(Da);dh=i(vg,"TFMPNetForSequenceClassification"),vg.forEach(t),Sl.forEach(t),Zi=h(o),xe=s(o,"DIV",{class:!0});var rt=r(xe);M(Ps.$$.fragment,rt),ch=h(rt),Wa=s(rt,"P",{});var Tg=r(Wa);ph=i(Tg,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wl.forEach(t),vh=h(rt),M(Ro.$$.fragment,rt),Th=h(rt),Ve=s(rt,"DIV",{class:!0});var $t=r(Ve);M(zs.$$.fragment,$t),Mh=h($t),Kt=s($t,"P",{});var Hr=r(Kt);$h=i(Hr,"The "),Nr=s(Hr,"A",{href:!0});var wg=r(Nr);wh=i(wg,"TFMPNetForSequenceClassification"),wg.forEach(t),Ph=i(Hr," forward method, overrides the "),Qa=s(Hr,"CODE",{});var Pg=r(Qa);Nh=i(Pg,"__call__"),Pg.forEach(t),yh=i(Hr," special method."),Hr.forEach(t),Fh=h($t),M(Uo.$$.fragment,$t),zh=h($t),M(Vo.$$.fragment,$t),Eh=h($t),M(Ko.$$.fragment,$t),$t.forEach(t),rt.forEach(t),el=h(o),Xt=s(o,"H2",{class:!0});var Ql=r(Xt);Xo=s(Ql,"A",{id:!0,class:!0,href:!0});var Ng=r(Xo);Ha=s(Ng,"SPAN",{});var yg=r(Ha);M(Es.$$.fragment,yg),yg.forEach(t),Ng.forEach(t),qh=h(Ql),Ba=s(Ql,"SPAN",{});var Fg=r(Ba);xh=i(Fg,"TFMPNetForMultipleChoice"),Fg.forEach(t),Ql.forEach(t),tl=h(o),Ce=s(o,"DIV",{class:!0});var at=r(Ce);M(qs.$$.fragment,at),Ch=h(at),Ra=s(at,"P",{});var zg=r(Ra);jh=i(zg,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hl.forEach(t),Sh=h(at),Cs=s(at,"P",{});var Bl=r(Cs);Dh=i(Bl,"This model is also a "),js=s(Bl,"A",{href:!0,rel:!0});var qg=r(js);Wh=i(qg,"tf.keras.Model"),qg.forEach(t),Qh=i(Bl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bl.forEach(t),Hh=h(at),M(Go.$$.fragment,at),Bh=h(at),ot=s(at,"DIV",{class:!0});var fn=r(ot);M(Ls.$$.fragment,fn),Rh=h(fn),Gt=s(fn,"P",{});var Br=r(Gt);Uh=i(Br,"The "),Fr=s(Br,"A",{href:!0});var xg=r(Fr);Vh=i(xg,"TFMPNetForMultipleChoice"),xg.forEach(t),Kh=i(Br," forward method, overrides the "),Ua=s(Br,"CODE",{});var Cg=r(Ua);Xh=i(Cg,"__call__"),Cg.forEach(t),Gh=i(Br," special method."),Br.forEach(t),Jh=h(fn),M(Jo.$$.fragment,fn),Yh=h(fn),M(Yo.$$.fragment,fn),fn.forEach(t),at.forEach(t),ol=h(o),Jt=s(o,"H2",{class:!0});var Rl=r(Jt);Zo=s(Rl,"A",{id:!0,class:!0,href:!0});var jg=r(Zo);Va=s(jg,"SPAN",{});var Lg=r(Va);M(As.$$.fragment,Lg),Lg.forEach(t),jg.forEach(t),Zh=h(Rl),Ka=s(Rl,"SPAN",{});var Ag=r(Ka);ef=i(Ag,"TFMPNetForTokenClassification"),Ag.forEach(t),Rl.forEach(t),nl=h(o),je=s(o,"DIV",{class:!0});var it=r(je);M(Os.$$.fragment,it),tf=h(it),Xa=s(it,"P",{});var Og=r(Xa);of=i(Og,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Og.forEach(t),nf=h(it),Is=s(it,"P",{});var Ul=r(Is);sf=i(Ul,"This model inherits from "),zr=s(Ul,"A",{href:!0});var Ig=r(zr);rf=i(Ig,"TFPreTrainedModel"),Ig.forEach(t),af=i(Ul,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ul.forEach(t),lf=h(it),Ss=s(it,"P",{});var Vl=r(Ss);df=i(Vl,"This model is also a "),Ds=s(Vl,"A",{href:!0,rel:!0});var Sg=r(Ds);cf=i(Sg,"tf.keras.Model"),Sg.forEach(t),pf=i(Vl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vl.forEach(t),mf=h(it),M(en.$$.fragment,it),hf=h(it),Ke=s(it,"DIV",{class:!0});var wt=r(Ke);M(Ws.$$.fragment,wt),ff=h(wt),Yt=s(wt,"P",{});var Rr=r(Yt);uf=i(Rr,"The "),Er=s(Rr,"A",{href:!0});var Dg=r(Er);gf=i(Dg,"TFMPNetForTokenClassification"),Dg.forEach(t),_f=i(Rr," forward method, overrides the "),Ga=s(Rr,"CODE",{});var Wg=r(Ga);kf=i(Wg,"__call__"),Wg.forEach(t),bf=i(Rr," special method."),Rr.forEach(t),vf=h(wt),M(tn.$$.fragment,wt),Tf=h(wt),M(on.$$.fragment,wt),Mf=h(wt),M(nn.$$.fragment,wt),wt.forEach(t),it.forEach(t),sl=h(o),Zt=s(o,"H2",{class:!0});var Kl=r(Zt);sn=s(Kl,"A",{id:!0,class:!0,href:!0});var Qg=r(sn);Ja=s(Qg,"SPAN",{});var Hg=r(Ja);M(Qs.$$.fragment,Hg),Hg.forEach(t),Qg.forEach(t),$f=h(Kl),Ya=s(Kl,"SPAN",{});var Bg=r(Ya);wf=i(Bg,"TFMPNetForQuestionAnswering"),Bg.forEach(t),Kl.forEach(t),rl=h(o),Le=s(o,"DIV",{class:!0});var lt=r(Le);M(Hs.$$.fragment,lt),Pf=h(lt),eo=s(lt,"P",{});var Ur=r(eo);Nf=i(Ur,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Za=s(Ur,"CODE",{});var Rg=r(Za);yf=i(Rg,"span start logits"),Rg.forEach(t),Ff=i(Ur," and "),ei=s(Ur,"CODE",{});var Ug=r(ei);zf=i(Ug,"span end logits"),Ug.forEach(t),Ef=i(Ur,")."),Ur.forEach(t),qf=h(lt),Bs=s(lt,"P",{});var Xl=r(Bs);xf=i(Xl,"This model inherits from "),qr=s(Xl,"A",{href:!0});var Vg=r(qr);Cf=i(Vg,"TFPreTrainedModel"),Vg.forEach(t),jf=i(Xl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xl.forEach(t),Lf=h(lt),Rs=s(lt,"P",{});var Gl=r(Rs);Af=i(Gl,"This model is also a "),Us=s(Gl,"A",{href:!0,rel:!0});var Kg=r(Us);Of=i(Kg,"tf.keras.Model"),Kg.forEach(t),If=i(Gl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gl.forEach(t),Sf=h(lt),M(rn.$$.fragment,lt),Df=h(lt),Xe=s(lt,"DIV",{class:!0});var Pt=r(Xe);M(Vs.$$.fragment,Pt),Wf=h(Pt),to=s(Pt,"P",{});var Vr=r(to);Qf=i(Vr,"The "),xr=s(Vr,"A",{href:!0});var Xg=r(xr);Hf=i(Xg,"TFMPNetForQuestionAnswering"),Xg.forEach(t),Bf=i(Vr," forward method, overrides the "),ti=s(Vr,"CODE",{});var Gg=r(ti);Rf=i(Gg,"__call__"),Gg.forEach(t),Uf=i(Vr," special method."),Vr.forEach(t),Vf=h(Pt),M(an.$$.fragment,Pt),Kf=h(Pt),M(ln.$$.fragment,Pt),Xf=h(Pt),M(dn.$$.fragment,Pt),Pt.forEach(t),lt.forEach(t),this.h()},h(){v(l,"name","hf:doc:metadata"),v(l,"content",JSON.stringify(B_)),v(p,"id","mpnet"),v(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(p,"href","#mpnet"),v(c,"class","relative group"),v(X,"id","overview"),v(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(X,"href","#overview"),v(E,"class","relative group"),v(Y,"href","https://arxiv.org/abs/2004.09297"),v(Y,"rel","nofollow"),v(ge,"href","https://github.com/microsoft/MPNet"),v(ge,"rel","nofollow"),v(no,"id","transformers.MPNetConfig"),v(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(no,"href","#transformers.MPNetConfig"),v(ue,"class","relative group"),v(tr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetModel"),v(or,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetModel"),v(_n,"href","https://huggingface.co/microsoft/mpnet-base"),v(_n,"rel","nofollow"),v(nr,"href","/docs/transformers/pr_18017/en/main_classes/configuration#transformers.PretrainedConfig"),v(sr,"href","/docs/transformers/pr_18017/en/main_classes/configuration#transformers.PretrainedConfig"),v(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ro,"id","transformers.MPNetTokenizer"),v(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(ro,"href","#transformers.MPNetTokenizer"),v(yt,"class","relative group"),v(rr,"href","/docs/transformers/pr_18017/en/model_doc/bert#transformers.BertTokenizer"),v(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ao,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(io,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(lr,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(lo,"id","transformers.MPNetTokenizerFast"),v(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(lo,"href","#transformers.MPNetTokenizerFast"),v(Ft,"class","relative group"),v(dr,"href","/docs/transformers/pr_18017/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),v(co,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(po,"id","transformers.MPNetModel"),v(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(po,"href","#transformers.MPNetModel"),v(zt,"class","relative group"),v(cr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel"),v(An,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(An,"rel","nofollow"),v(pr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetModel"),v(Ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(fo,"id","transformers.MPNetForMaskedLM"),v(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(fo,"href","#transformers.MPNetForMaskedLM"),v(qt,"class","relative group"),v(mr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetForMaskedLM"),v(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(xt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ko,"id","transformers.MPNetForSequenceClassification"),v(ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(ko,"href","#transformers.MPNetForSequenceClassification"),v(jt,"class","relative group"),v(hr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel"),v(Rn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(Rn,"rel","nofollow"),v(fr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetForSequenceClassification"),v(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(wo,"id","transformers.MPNetForMultipleChoice"),v(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(wo,"href","#transformers.MPNetForMultipleChoice"),v(At,"class","relative group"),v(ur,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel"),v(Jn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(Jn,"rel","nofollow"),v(gr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetForMultipleChoice"),v(et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(yo,"id","transformers.MPNetForTokenClassification"),v(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(yo,"href","#transformers.MPNetForTokenClassification"),v(It,"class","relative group"),v(_r,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel"),v(ns,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(ns,"rel","nofollow"),v(kr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetForTokenClassification"),v(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(qo,"id","transformers.MPNetForQuestionAnswering"),v(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(qo,"href","#transformers.MPNetForQuestionAnswering"),v(Dt,"class","relative group"),v(br,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.PreTrainedModel"),v(ds,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(ds,"rel","nofollow"),v(vr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.MPNetForQuestionAnswering"),v(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Lo,"id","transformers.TFMPNetModel"),v(Lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Lo,"href","#transformers.TFMPNetModel"),v(Ht,"class","relative group"),v(Tr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.TFPreTrainedModel"),v(us,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(us,"rel","nofollow"),v(Mr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetModel"),v(tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(So,"id","transformers.TFMPNetForMaskedLM"),v(So,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(So,"href","#transformers.TFMPNetForMaskedLM"),v(Rt,"class","relative group"),v($r,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.TFPreTrainedModel"),v(Ms,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Ms,"rel","nofollow"),v(wr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetForMaskedLM"),v(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Bo,"id","transformers.TFMPNetForSequenceClassification"),v(Bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Bo,"href","#transformers.TFMPNetForSequenceClassification"),v(Vt,"class","relative group"),v(Pr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.TFPreTrainedModel"),v(Fs,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Fs,"rel","nofollow"),v(Nr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetForSequenceClassification"),v(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Xo,"id","transformers.TFMPNetForMultipleChoice"),v(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Xo,"href","#transformers.TFMPNetForMultipleChoice"),v(Xt,"class","relative group"),v(yr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.TFPreTrainedModel"),v(js,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(js,"rel","nofollow"),v(Fr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetForMultipleChoice"),v(ot,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Zo,"id","transformers.TFMPNetForTokenClassification"),v(Zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Zo,"href","#transformers.TFMPNetForTokenClassification"),v(Jt,"class","relative group"),v(zr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.TFPreTrainedModel"),v(Ds,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Ds,"rel","nofollow"),v(Er,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetForTokenClassification"),v(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(sn,"id","transformers.TFMPNetForQuestionAnswering"),v(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(sn,"href","#transformers.TFMPNetForQuestionAnswering"),v(Zt,"class","relative group"),v(qr,"href","/docs/transformers/pr_18017/en/main_classes/model#transformers.TFPreTrainedModel"),v(Us,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Us,"rel","nofollow"),v(xr,"href","/docs/transformers/pr_18017/en/model_doc/mpnet#transformers.TFMPNetForQuestionAnswering"),v(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,k){e(document.head,l),_(o,g,k),_(o,c,k),e(c,p),e(p,b),$(d,b,null),e(c,f),e(c,z),e(z,le),_(o,U,k),_(o,E,k),e(E,X),e(X,D),$(J,D,null),e(E,de),e(E,W),e(W,ce),_(o,se,k),_(o,R,k),e(R,O),e(R,Y),e(Y,V),e(R,q),_(o,x,k),_(o,Z,k),e(Z,H),_(o,re,k),_(o,ee,k),e(ee,B),_(o,ae,k),_(o,te,k),e(te,C),e(C,pe),_(o,Q,k),_(o,oe,k),e(oe,me),_(o,L,k),_(o,ne,k),e(ne,j),e(j,he),e(j,u),e(u,F),e(j,K),e(j,_e),e(_e,Me),e(j,I),e(j,ke),e(ke,$e),e(j,we),_(o,A,k),_(o,S,k),e(S,Pe),e(S,ge),e(ge,fe),e(S,Ne),_(o,ie,k),_(o,ue,k),e(ue,no),e(no,Kr),$(un,Kr,null),e(ue,Jl),e(ue,Xr),e(Xr,Yl),_(o,qi,k),_(o,Je,k),$(gn,Je,null),e(Je,Zl),e(Je,dt),e(dt,ed),e(dt,tr),e(tr,td),e(dt,od),e(dt,or),e(or,nd),e(dt,sd),e(dt,_n),e(_n,rd),e(dt,ad),e(Je,id),e(Je,Nt),e(Nt,ld),e(Nt,nr),e(nr,dd),e(Nt,cd),e(Nt,sr),e(sr,pd),e(Nt,md),e(Je,hd),$(so,Je,null),_(o,xi,k),_(o,yt,k),e(yt,ro),e(ro,Gr),$(kn,Gr,null),e(yt,fd),e(yt,Jr),e(Jr,ud),_(o,Ci,k),_(o,ze,k),$(bn,ze,null),e(ze,gd),e(ze,vn),e(vn,_d),e(vn,rr),e(rr,kd),e(vn,bd),e(ze,vd),e(ze,ht),$(Tn,ht,null),e(ht,Td),e(ht,Yr),e(Yr,Md),e(ht,$d),e(ht,Mn),e(Mn,ar),e(ar,wd),e(ar,Zr),e(Zr,Pd),e(Mn,Nd),e(Mn,ir),e(ir,yd),e(ir,ea),e(ea,Fd),e(ze,zd),e(ze,ao),$($n,ao,null),e(ao,Ed),e(ao,wn),e(wn,qd),e(wn,ta),e(ta,xd),e(wn,Cd),e(ze,jd),e(ze,io),$(Pn,io,null),e(io,Ld),e(io,oa),e(oa,Ad),e(ze,Od),e(ze,lr),$(Nn,lr,null),_(o,ji,k),_(o,Ft,k),e(Ft,lo),e(lo,na),$(yn,na,null),e(Ft,Id),e(Ft,sa),e(sa,Sd),_(o,Li,k),_(o,Ye,k),$(Fn,Ye,null),e(Ye,Dd),e(Ye,zn),e(zn,Wd),e(zn,ra),e(ra,Qd),e(zn,Hd),e(Ye,Bd),e(Ye,En),e(En,Rd),e(En,dr),e(dr,Ud),e(En,Vd),e(Ye,Kd),e(Ye,co),$(qn,co,null),e(co,Xd),e(co,aa),e(aa,Gd),_(o,Ai,k),_(o,zt,k),e(zt,po),e(po,ia),$(xn,ia,null),e(zt,Jd),e(zt,la),e(la,Yd),_(o,Oi,k),_(o,Oe,k),$(Cn,Oe,null),e(Oe,Zd),e(Oe,da),e(da,ec),e(Oe,tc),e(Oe,jn),e(jn,oc),e(jn,cr),e(cr,nc),e(jn,sc),e(Oe,rc),e(Oe,Ln),e(Ln,ac),e(Ln,An),e(An,ic),e(Ln,lc),e(Oe,dc),e(Oe,Ze),$(On,Ze,null),e(Ze,cc),e(Ze,Et),e(Et,pc),e(Et,pr),e(pr,mc),e(Et,hc),e(Et,ca),e(ca,fc),e(Et,uc),e(Ze,gc),$(mo,Ze,null),e(Ze,_c),$(ho,Ze,null),_(o,Ii,k),_(o,qt,k),e(qt,fo),e(fo,pa),$(In,pa,null),e(qt,kc),e(qt,ma),e(ma,bc),_(o,Si,k),_(o,xt,k),$(Sn,xt,null),e(xt,vc),e(xt,He),$(Dn,He,null),e(He,Tc),e(He,Ct),e(Ct,Mc),e(Ct,mr),e(mr,$c),e(Ct,wc),e(Ct,ha),e(ha,Pc),e(Ct,Nc),e(He,yc),$(uo,He,null),e(He,Fc),$(go,He,null),e(He,zc),$(_o,He,null),_(o,Di,k),_(o,jt,k),e(jt,ko),e(ko,fa),$(Wn,fa,null),e(jt,Ec),e(jt,ua),e(ua,qc),_(o,Wi,k),_(o,Ie,k),$(Qn,Ie,null),e(Ie,xc),e(Ie,ga),e(ga,Cc),e(Ie,jc),e(Ie,Hn),e(Hn,Lc),e(Hn,hr),e(hr,Ac),e(Hn,Oc),e(Ie,Ic),e(Ie,Bn),e(Bn,Sc),e(Bn,Rn),e(Rn,Dc),e(Bn,Wc),e(Ie,Qc),e(Ie,ye),$(Un,ye,null),e(ye,Hc),e(ye,Lt),e(Lt,Bc),e(Lt,fr),e(fr,Rc),e(Lt,Uc),e(Lt,_a),e(_a,Vc),e(Lt,Kc),e(ye,Xc),$(bo,ye,null),e(ye,Gc),$(vo,ye,null),e(ye,Jc),$(To,ye,null),e(ye,Yc),$(Mo,ye,null),e(ye,Zc),$($o,ye,null),_(o,Qi,k),_(o,At,k),e(At,wo),e(wo,ka),$(Vn,ka,null),e(At,ep),e(At,ba),e(ba,tp),_(o,Hi,k),_(o,Se,k),$(Kn,Se,null),e(Se,op),e(Se,va),e(va,np),e(Se,sp),e(Se,Xn),e(Xn,rp),e(Xn,ur),e(ur,ap),e(Xn,ip),e(Se,lp),e(Se,Gn),e(Gn,dp),e(Gn,Jn),e(Jn,cp),e(Gn,pp),e(Se,mp),e(Se,et),$(Yn,et,null),e(et,hp),e(et,Ot),e(Ot,fp),e(Ot,gr),e(gr,up),e(Ot,gp),e(Ot,Ta),e(Ta,_p),e(Ot,kp),e(et,bp),$(Po,et,null),e(et,vp),$(No,et,null),_(o,Bi,k),_(o,It,k),e(It,yo),e(yo,Ma),$(Zn,Ma,null),e(It,Tp),e(It,$a),e($a,Mp),_(o,Ri,k),_(o,De,k),$(es,De,null),e(De,$p),e(De,wa),e(wa,wp),e(De,Pp),e(De,ts),e(ts,Np),e(ts,_r),e(_r,yp),e(ts,Fp),e(De,zp),e(De,os),e(os,Ep),e(os,ns),e(ns,qp),e(os,xp),e(De,Cp),e(De,Be),$(ss,Be,null),e(Be,jp),e(Be,St),e(St,Lp),e(St,kr),e(kr,Ap),e(St,Op),e(St,Pa),e(Pa,Ip),e(St,Sp),e(Be,Dp),$(Fo,Be,null),e(Be,Wp),$(zo,Be,null),e(Be,Qp),$(Eo,Be,null),_(o,Ui,k),_(o,Dt,k),e(Dt,qo),e(qo,Na),$(rs,Na,null),e(Dt,Hp),e(Dt,ya),e(ya,Bp),_(o,Vi,k),_(o,We,k),$(as,We,null),e(We,Rp),e(We,Wt),e(Wt,Up),e(Wt,Fa),e(Fa,Vp),e(Wt,Kp),e(Wt,za),e(za,Xp),e(Wt,Gp),e(We,Jp),e(We,is),e(is,Yp),e(is,br),e(br,Zp),e(is,em),e(We,tm),e(We,ls),e(ls,om),e(ls,ds),e(ds,nm),e(ls,sm),e(We,rm),e(We,Re),$(cs,Re,null),e(Re,am),e(Re,Qt),e(Qt,im),e(Qt,vr),e(vr,lm),e(Qt,dm),e(Qt,Ea),e(Ea,cm),e(Qt,pm),e(Re,mm),$(xo,Re,null),e(Re,hm),$(Co,Re,null),e(Re,fm),$(jo,Re,null),_(o,Ki,k),_(o,Ht,k),e(Ht,Lo),e(Lo,qa),$(ps,qa,null),e(Ht,um),e(Ht,xa),e(xa,gm),_(o,Xi,k),_(o,Ee,k),$(ms,Ee,null),e(Ee,_m),e(Ee,Ca),e(Ca,km),e(Ee,bm),e(Ee,hs),e(hs,vm),e(hs,Tr),e(Tr,Tm),e(hs,Mm),e(Ee,$m),e(Ee,fs),e(fs,wm),e(fs,us),e(us,Pm),e(fs,Nm),e(Ee,ym),$(Ao,Ee,null),e(Ee,Fm),e(Ee,tt),$(gs,tt,null),e(tt,zm),e(tt,Bt),e(Bt,Em),e(Bt,Mr),e(Mr,qm),e(Bt,xm),e(Bt,ja),e(ja,Cm),e(Bt,jm),e(tt,Lm),$(Oo,tt,null),e(tt,Am),$(Io,tt,null),_(o,Gi,k),_(o,Rt,k),e(Rt,So),e(So,La),$(_s,La,null),e(Rt,Om),e(Rt,Aa),e(Aa,Im),_(o,Ji,k),_(o,qe,k),$(ks,qe,null),e(qe,Sm),e(qe,bs),e(bs,Dm),e(bs,Oa),e(Oa,Wm),e(bs,Qm),e(qe,Hm),e(qe,vs),e(vs,Bm),e(vs,$r),e($r,Rm),e(vs,Um),e(qe,Vm),e(qe,Ts),e(Ts,Km),e(Ts,Ms),e(Ms,Xm),e(Ts,Gm),e(qe,Jm),$(Do,qe,null),e(qe,Ym),e(qe,Ue),$($s,Ue,null),e(Ue,Zm),e(Ue,Ut),e(Ut,eh),e(Ut,wr),e(wr,th),e(Ut,oh),e(Ut,Ia),e(Ia,nh),e(Ut,sh),e(Ue,rh),$(Wo,Ue,null),e(Ue,ah),$(Qo,Ue,null),e(Ue,ih),$(Ho,Ue,null),_(o,Yi,k),_(o,Vt,k),e(Vt,Bo),e(Bo,Sa),$(ws,Sa,null),e(Vt,lh),e(Vt,Da),e(Da,dh),_(o,Zi,k),_(o,xe,k),$(Ps,xe,null),e(xe,ch),e(xe,Wa),e(Wa,ph),e(xe,mh),e(xe,Ns),e(Ns,hh),e(Ns,Pr),e(Pr,fh),e(Ns,uh),e(xe,gh),e(xe,ys),e(ys,_h),e(ys,Fs),e(Fs,kh),e(ys,bh),e(xe,vh),$(Ro,xe,null),e(xe,Th),e(xe,Ve),$(zs,Ve,null),e(Ve,Mh),e(Ve,Kt),e(Kt,$h),e(Kt,Nr),e(Nr,wh),e(Kt,Ph),e(Kt,Qa),e(Qa,Nh),e(Kt,yh),e(Ve,Fh),$(Uo,Ve,null),e(Ve,zh),$(Vo,Ve,null),e(Ve,Eh),$(Ko,Ve,null),_(o,el,k),_(o,Xt,k),e(Xt,Xo),e(Xo,Ha),$(Es,Ha,null),e(Xt,qh),e(Xt,Ba),e(Ba,xh),_(o,tl,k),_(o,Ce,k),$(qs,Ce,null),e(Ce,Ch),e(Ce,Ra),e(Ra,jh),e(Ce,Lh),e(Ce,xs),e(xs,Ah),e(xs,yr),e(yr,Oh),e(xs,Ih),e(Ce,Sh),e(Ce,Cs),e(Cs,Dh),e(Cs,js),e(js,Wh),e(Cs,Qh),e(Ce,Hh),$(Go,Ce,null),e(Ce,Bh),e(Ce,ot),$(Ls,ot,null),e(ot,Rh),e(ot,Gt),e(Gt,Uh),e(Gt,Fr),e(Fr,Vh),e(Gt,Kh),e(Gt,Ua),e(Ua,Xh),e(Gt,Gh),e(ot,Jh),$(Jo,ot,null),e(ot,Yh),$(Yo,ot,null),_(o,ol,k),_(o,Jt,k),e(Jt,Zo),e(Zo,Va),$(As,Va,null),e(Jt,Zh),e(Jt,Ka),e(Ka,ef),_(o,nl,k),_(o,je,k),$(Os,je,null),e(je,tf),e(je,Xa),e(Xa,of),e(je,nf),e(je,Is),e(Is,sf),e(Is,zr),e(zr,rf),e(Is,af),e(je,lf),e(je,Ss),e(Ss,df),e(Ss,Ds),e(Ds,cf),e(Ss,pf),e(je,mf),$(en,je,null),e(je,hf),e(je,Ke),$(Ws,Ke,null),e(Ke,ff),e(Ke,Yt),e(Yt,uf),e(Yt,Er),e(Er,gf),e(Yt,_f),e(Yt,Ga),e(Ga,kf),e(Yt,bf),e(Ke,vf),$(tn,Ke,null),e(Ke,Tf),$(on,Ke,null),e(Ke,Mf),$(nn,Ke,null),_(o,sl,k),_(o,Zt,k),e(Zt,sn),e(sn,Ja),$(Qs,Ja,null),e(Zt,$f),e(Zt,Ya),e(Ya,wf),_(o,rl,k),_(o,Le,k),$(Hs,Le,null),e(Le,Pf),e(Le,eo),e(eo,Nf),e(eo,Za),e(Za,yf),e(eo,Ff),e(eo,ei),e(ei,zf),e(eo,Ef),e(Le,qf),e(Le,Bs),e(Bs,xf),e(Bs,qr),e(qr,Cf),e(Bs,jf),e(Le,Lf),e(Le,Rs),e(Rs,Af),e(Rs,Us),e(Us,Of),e(Rs,If),e(Le,Sf),$(rn,Le,null),e(Le,Df),e(Le,Xe),$(Vs,Xe,null),e(Xe,Wf),e(Xe,to),e(to,Qf),e(to,xr),e(xr,Hf),e(to,Bf),e(to,ti),e(ti,Rf),e(to,Uf),e(Xe,Vf),$(an,Xe,null),e(Xe,Kf),$(ln,Xe,null),e(Xe,Xf),$(dn,Xe,null),al=!0},p(o,[k]){const Ks={};k&2&&(Ks.$$scope={dirty:k,ctx:o}),so.$set(Ks);const oi={};k&2&&(oi.$$scope={dirty:k,ctx:o}),mo.$set(oi);const ni={};k&2&&(ni.$$scope={dirty:k,ctx:o}),ho.$set(ni);const si={};k&2&&(si.$$scope={dirty:k,ctx:o}),uo.$set(si);const Xs={};k&2&&(Xs.$$scope={dirty:k,ctx:o}),go.$set(Xs);const ri={};k&2&&(ri.$$scope={dirty:k,ctx:o}),_o.$set(ri);const ai={};k&2&&(ai.$$scope={dirty:k,ctx:o}),bo.$set(ai);const ii={};k&2&&(ii.$$scope={dirty:k,ctx:o}),vo.$set(ii);const Gs={};k&2&&(Gs.$$scope={dirty:k,ctx:o}),To.$set(Gs);const li={};k&2&&(li.$$scope={dirty:k,ctx:o}),Mo.$set(li);const di={};k&2&&(di.$$scope={dirty:k,ctx:o}),$o.$set(di);const ci={};k&2&&(ci.$$scope={dirty:k,ctx:o}),Po.$set(ci);const pi={};k&2&&(pi.$$scope={dirty:k,ctx:o}),No.$set(pi);const mi={};k&2&&(mi.$$scope={dirty:k,ctx:o}),Fo.$set(mi);const hi={};k&2&&(hi.$$scope={dirty:k,ctx:o}),zo.$set(hi);const fi={};k&2&&(fi.$$scope={dirty:k,ctx:o}),Eo.$set(fi);const ct={};k&2&&(ct.$$scope={dirty:k,ctx:o}),xo.$set(ct);const ui={};k&2&&(ui.$$scope={dirty:k,ctx:o}),Co.$set(ui);const gi={};k&2&&(gi.$$scope={dirty:k,ctx:o}),jo.$set(gi);const _i={};k&2&&(_i.$$scope={dirty:k,ctx:o}),Ao.$set(_i);const Js={};k&2&&(Js.$$scope={dirty:k,ctx:o}),Oo.$set(Js);const ki={};k&2&&(ki.$$scope={dirty:k,ctx:o}),Io.$set(ki);const Ys={};k&2&&(Ys.$$scope={dirty:k,ctx:o}),Do.$set(Ys);const bi={};k&2&&(bi.$$scope={dirty:k,ctx:o}),Wo.$set(bi);const vi={};k&2&&(vi.$$scope={dirty:k,ctx:o}),Qo.$set(vi);const Ti={};k&2&&(Ti.$$scope={dirty:k,ctx:o}),Ho.$set(Ti);const pt={};k&2&&(pt.$$scope={dirty:k,ctx:o}),Ro.$set(pt);const mt={};k&2&&(mt.$$scope={dirty:k,ctx:o}),Uo.$set(mt);const Mi={};k&2&&(Mi.$$scope={dirty:k,ctx:o}),Vo.$set(Mi);const $i={};k&2&&($i.$$scope={dirty:k,ctx:o}),Ko.$set($i);const wi={};k&2&&(wi.$$scope={dirty:k,ctx:o}),Go.$set(wi);const oo={};k&2&&(oo.$$scope={dirty:k,ctx:o}),Jo.$set(oo);const Pi={};k&2&&(Pi.$$scope={dirty:k,ctx:o}),Yo.$set(Pi);const Ni={};k&2&&(Ni.$$scope={dirty:k,ctx:o}),en.$set(Ni);const Zs={};k&2&&(Zs.$$scope={dirty:k,ctx:o}),tn.$set(Zs);const yi={};k&2&&(yi.$$scope={dirty:k,ctx:o}),on.$set(yi);const Fi={};k&2&&(Fi.$$scope={dirty:k,ctx:o}),nn.$set(Fi);const zi={};k&2&&(zi.$$scope={dirty:k,ctx:o}),rn.$set(zi);const Qe={};k&2&&(Qe.$$scope={dirty:k,ctx:o}),an.$set(Qe);const er={};k&2&&(er.$$scope={dirty:k,ctx:o}),ln.$set(er);const Ei={};k&2&&(Ei.$$scope={dirty:k,ctx:o}),dn.$set(Ei)},i(o){al||(w(d.$$.fragment,o),w(J.$$.fragment,o),w(un.$$.fragment,o),w(gn.$$.fragment,o),w(so.$$.fragment,o),w(kn.$$.fragment,o),w(bn.$$.fragment,o),w(Tn.$$.fragment,o),w($n.$$.fragment,o),w(Pn.$$.fragment,o),w(Nn.$$.fragment,o),w(yn.$$.fragment,o),w(Fn.$$.fragment,o),w(qn.$$.fragment,o),w(xn.$$.fragment,o),w(Cn.$$.fragment,o),w(On.$$.fragment,o),w(mo.$$.fragment,o),w(ho.$$.fragment,o),w(In.$$.fragment,o),w(Sn.$$.fragment,o),w(Dn.$$.fragment,o),w(uo.$$.fragment,o),w(go.$$.fragment,o),w(_o.$$.fragment,o),w(Wn.$$.fragment,o),w(Qn.$$.fragment,o),w(Un.$$.fragment,o),w(bo.$$.fragment,o),w(vo.$$.fragment,o),w(To.$$.fragment,o),w(Mo.$$.fragment,o),w($o.$$.fragment,o),w(Vn.$$.fragment,o),w(Kn.$$.fragment,o),w(Yn.$$.fragment,o),w(Po.$$.fragment,o),w(No.$$.fragment,o),w(Zn.$$.fragment,o),w(es.$$.fragment,o),w(ss.$$.fragment,o),w(Fo.$$.fragment,o),w(zo.$$.fragment,o),w(Eo.$$.fragment,o),w(rs.$$.fragment,o),w(as.$$.fragment,o),w(cs.$$.fragment,o),w(xo.$$.fragment,o),w(Co.$$.fragment,o),w(jo.$$.fragment,o),w(ps.$$.fragment,o),w(ms.$$.fragment,o),w(Ao.$$.fragment,o),w(gs.$$.fragment,o),w(Oo.$$.fragment,o),w(Io.$$.fragment,o),w(_s.$$.fragment,o),w(ks.$$.fragment,o),w(Do.$$.fragment,o),w($s.$$.fragment,o),w(Wo.$$.fragment,o),w(Qo.$$.fragment,o),w(Ho.$$.fragment,o),w(ws.$$.fragment,o),w(Ps.$$.fragment,o),w(Ro.$$.fragment,o),w(zs.$$.fragment,o),w(Uo.$$.fragment,o),w(Vo.$$.fragment,o),w(Ko.$$.fragment,o),w(Es.$$.fragment,o),w(qs.$$.fragment,o),w(Go.$$.fragment,o),w(Ls.$$.fragment,o),w(Jo.$$.fragment,o),w(Yo.$$.fragment,o),w(As.$$.fragment,o),w(Os.$$.fragment,o),w(en.$$.fragment,o),w(Ws.$$.fragment,o),w(tn.$$.fragment,o),w(on.$$.fragment,o),w(nn.$$.fragment,o),w(Qs.$$.fragment,o),w(Hs.$$.fragment,o),w(rn.$$.fragment,o),w(Vs.$$.fragment,o),w(an.$$.fragment,o),w(ln.$$.fragment,o),w(dn.$$.fragment,o),al=!0)},o(o){P(d.$$.fragment,o),P(J.$$.fragment,o),P(un.$$.fragment,o),P(gn.$$.fragment,o),P(so.$$.fragment,o),P(kn.$$.fragment,o),P(bn.$$.fragment,o),P(Tn.$$.fragment,o),P($n.$$.fragment,o),P(Pn.$$.fragment,o),P(Nn.$$.fragment,o),P(yn.$$.fragment,o),P(Fn.$$.fragment,o),P(qn.$$.fragment,o),P(xn.$$.fragment,o),P(Cn.$$.fragment,o),P(On.$$.fragment,o),P(mo.$$.fragment,o),P(ho.$$.fragment,o),P(In.$$.fragment,o),P(Sn.$$.fragment,o),P(Dn.$$.fragment,o),P(uo.$$.fragment,o),P(go.$$.fragment,o),P(_o.$$.fragment,o),P(Wn.$$.fragment,o),P(Qn.$$.fragment,o),P(Un.$$.fragment,o),P(bo.$$.fragment,o),P(vo.$$.fragment,o),P(To.$$.fragment,o),P(Mo.$$.fragment,o),P($o.$$.fragment,o),P(Vn.$$.fragment,o),P(Kn.$$.fragment,o),P(Yn.$$.fragment,o),P(Po.$$.fragment,o),P(No.$$.fragment,o),P(Zn.$$.fragment,o),P(es.$$.fragment,o),P(ss.$$.fragment,o),P(Fo.$$.fragment,o),P(zo.$$.fragment,o),P(Eo.$$.fragment,o),P(rs.$$.fragment,o),P(as.$$.fragment,o),P(cs.$$.fragment,o),P(xo.$$.fragment,o),P(Co.$$.fragment,o),P(jo.$$.fragment,o),P(ps.$$.fragment,o),P(ms.$$.fragment,o),P(Ao.$$.fragment,o),P(gs.$$.fragment,o),P(Oo.$$.fragment,o),P(Io.$$.fragment,o),P(_s.$$.fragment,o),P(ks.$$.fragment,o),P(Do.$$.fragment,o),P($s.$$.fragment,o),P(Wo.$$.fragment,o),P(Qo.$$.fragment,o),P(Ho.$$.fragment,o),P(ws.$$.fragment,o),P(Ps.$$.fragment,o),P(Ro.$$.fragment,o),P(zs.$$.fragment,o),P(Uo.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Es.$$.fragment,o),P(qs.$$.fragment,o),P(Go.$$.fragment,o),P(Ls.$$.fragment,o),P(Jo.$$.fragment,o),P(Yo.$$.fragment,o),P(As.$$.fragment,o),P(Os.$$.fragment,o),P(en.$$.fragment,o),P(Ws.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(Qs.$$.fragment,o),P(Hs.$$.fragment,o),P(rn.$$.fragment,o),P(Vs.$$.fragment,o),P(an.$$.fragment,o),P(ln.$$.fragment,o),P(dn.$$.fragment,o),al=!1},d(o){t(l),o&&t(g),o&&t(c),N(d),o&&t(U),o&&t(E),N(J),o&&t(se),o&&t(R),o&&t(x),o&&t(Z),o&&t(re),o&&t(ee),o&&t(ae),o&&t(te),o&&t(Q),o&&t(oe),o&&t(L),o&&t(ne),o&&t(A),o&&t(S),o&&t(ie),o&&t(ue),N(un),o&&t(qi),o&&t(Je),N(gn),N(so),o&&t(xi),o&&t(yt),N(kn),o&&t(Ci),o&&t(ze),N(bn),N(Tn),N($n),N(Pn),N(Nn),o&&t(ji),o&&t(Ft),N(yn),o&&t(Li),o&&t(Ye),N(Fn),N(qn),o&&t(Ai),o&&t(zt),N(xn),o&&t(Oi),o&&t(Oe),N(Cn),N(On),N(mo),N(ho),o&&t(Ii),o&&t(qt),N(In),o&&t(Si),o&&t(xt),N(Sn),N(Dn),N(uo),N(go),N(_o),o&&t(Di),o&&t(jt),N(Wn),o&&t(Wi),o&&t(Ie),N(Qn),N(Un),N(bo),N(vo),N(To),N(Mo),N($o),o&&t(Qi),o&&t(At),N(Vn),o&&t(Hi),o&&t(Se),N(Kn),N(Yn),N(Po),N(No),o&&t(Bi),o&&t(It),N(Zn),o&&t(Ri),o&&t(De),N(es),N(ss),N(Fo),N(zo),N(Eo),o&&t(Ui),o&&t(Dt),N(rs),o&&t(Vi),o&&t(We),N(as),N(cs),N(xo),N(Co),N(jo),o&&t(Ki),o&&t(Ht),N(ps),o&&t(Xi),o&&t(Ee),N(ms),N(Ao),N(gs),N(Oo),N(Io),o&&t(Gi),o&&t(Rt),N(_s),o&&t(Ji),o&&t(qe),N(ks),N(Do),N($s),N(Wo),N(Qo),N(Ho),o&&t(Yi),o&&t(Vt),N(ws),o&&t(Zi),o&&t(xe),N(Ps),N(Ro),N(zs),N(Uo),N(Vo),N(Ko),o&&t(el),o&&t(Xt),N(Es),o&&t(tl),o&&t(Ce),N(qs),N(Go),N(Ls),N(Jo),N(Yo),o&&t(ol),o&&t(Jt),N(As),o&&t(nl),o&&t(je),N(Os),N(en),N(Ws),N(tn),N(on),N(nn),o&&t(sl),o&&t(Zt),N(Qs),o&&t(rl),o&&t(Le),N(Hs),N(rn),N(Vs),N(an),N(ln),N(dn)}}}const B_={local:"mpnet",sections:[{local:"overview",title:"Overview"},{local:"transformers.MPNetConfig",title:"MPNetConfig"},{local:"transformers.MPNetTokenizer",title:"MPNetTokenizer"},{local:"transformers.MPNetTokenizerFast",title:"MPNetTokenizerFast"},{local:"transformers.MPNetModel",title:"MPNetModel"},{local:"transformers.MPNetForMaskedLM",title:"MPNetForMaskedLM"},{local:"transformers.MPNetForSequenceClassification",title:"MPNetForSequenceClassification"},{local:"transformers.MPNetForMultipleChoice",title:"MPNetForMultipleChoice"},{local:"transformers.MPNetForTokenClassification",title:"MPNetForTokenClassification"},{local:"transformers.MPNetForQuestionAnswering",title:"MPNetForQuestionAnswering"},{local:"transformers.TFMPNetModel",title:"TFMPNetModel"},{local:"transformers.TFMPNetForMaskedLM",title:"TFMPNetForMaskedLM"},{local:"transformers.TFMPNetForSequenceClassification",title:"TFMPNetForSequenceClassification"},{local:"transformers.TFMPNetForMultipleChoice",title:"TFMPNetForMultipleChoice"},{local:"transformers.TFMPNetForTokenClassification",title:"TFMPNetForTokenClassification"},{local:"transformers.TFMPNetForQuestionAnswering",title:"TFMPNetForQuestionAnswering"}],title:"MPNet"};function R_(y){return t_(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Y_ extends Jg{constructor(l){super();Yg(this,l,R_,H_,Zg,{})}}export{Y_ as default,B_ as metadata};
