import{S as am,i as rm,s as im,e as a,k as l,w as g,t as n,M as lm,c as r,d as o,m as d,a as i,x as _,h as s,b as c,F as e,g as u,y as b,q as k,o as Q,B as v,v as dm}from"../../chunks/vendor-6b77c823.js";import{T as ut}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-abef54e3.js";import{C as x}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Y}from"../../chunks/IconCopyLink-7a11ce68.js";function cm(B){let h,q,f,T,y;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=n("Module"),y=n(`
...
the latter silently ignores them.`)},l(w){h=r(w,"P",{});var m=i(h);q=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var $=i(f);T=s($,"Module"),$.forEach(o),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(w,m){u(w,h,m),e(h,q),e(h,f),e(f,T),e(h,y)},d(w){w&&o(h)}}}function bm(B){let h,q,f,T,y,w,m,$,yr,sa,_e,Ie,Fn,mt,qr,Pn,$r,aa,Oe,Dr,ft,zr,Br,ra,Ko,Mr,ia,Go,Cn,xr,la,Yo,jr,da,Z,An,Nn,Er,Fr,Sn,We,Pr,gt,Cr,Ar,Ln,Nr,Sr,In,_t,Lr,On,Ir,Or,Wr,Wn,bt,Hr,Zo,Rr,Ur,ca,He,Vr,kt,Xr,Jr,pa,be,Re,Hn,Qt,Kr,Rn,Gr,ha,F,Yr,Un,Zr,ei,vt,ti,oi,Vn,ni,si,Xn,ai,ri,wt,ii,li,ua,Ue,di,Jn,ci,pi,ma,en,hi,fa,Tt,ga,ke,Ve,Kn,yt,ui,Gn,mi,_a,tn,fi,ba,qt,ka,Qe,Xe,Yn,$t,gi,Zn,_i,Qa,se,bi,Dt,ki,Qi,zt,vi,wi,va,Bt,wa,ve,Je,es,Mt,Ti,ts,yi,Ta,N,xt,qi,we,$i,on,Di,zi,jt,Bi,Mi,xi,Te,ji,nn,Ei,Fi,sn,Pi,Ci,Ai,os,Ni,Si,Et,ya,ye,Ke,ns,Ft,Li,ss,Ii,qa,z,Pt,Oi,as,Wi,Hi,Ct,Ri,an,Ui,Vi,Xi,At,Ji,Nt,Ki,Gi,Yi,St,Zi,Lt,el,tl,ol,j,nl,rs,sl,al,is,rl,il,ls,ll,dl,ds,cl,pl,cs,hl,ul,ps,ml,fl,gl,U,It,_l,qe,bl,rn,kl,Ql,hs,vl,wl,Tl,Ge,yl,us,ql,$l,Ot,$a,$e,Ye,ms,Wt,Dl,fs,zl,Da,S,Ht,Bl,Rt,Ml,gs,xl,jl,El,Ut,Fl,ln,Pl,Cl,Al,Vt,Nl,Xt,Sl,Ll,Il,V,Jt,Ol,De,Wl,dn,Hl,Rl,_s,Ul,Vl,Xl,Ze,Jl,bs,Kl,Gl,Kt,za,ze,et,ks,Gt,Yl,Qs,Zl,Ba,L,Yt,ed,Zt,td,vs,od,nd,sd,eo,ad,cn,rd,id,ld,to,dd,oo,cd,pd,hd,P,no,ud,Be,md,pn,fd,gd,ws,_d,bd,kd,tt,Qd,Ts,vd,wd,so,Td,ao,Ma,Me,ot,ys,ro,yd,qs,qd,xa,I,io,$d,$s,Dd,zd,lo,Bd,hn,Md,xd,jd,co,Ed,po,Fd,Pd,Cd,D,ho,Ad,xe,Nd,un,Sd,Ld,Ds,Id,Od,Wd,nt,Hd,zs,Rd,Ud,uo,Vd,mo,Xd,Bs,Jd,Kd,fo,Gd,go,ja,je,st,Ms,_o,Yd,xs,Zd,Ea,O,bo,ec,ko,tc,js,oc,nc,sc,Qo,ac,mn,rc,ic,lc,vo,dc,wo,cc,pc,hc,X,To,uc,Ee,mc,fn,fc,gc,Es,_c,bc,kc,at,Qc,Fs,vc,wc,yo,Fa,Fe,rt,Ps,qo,Tc,Cs,yc,Pa,W,$o,qc,As,$c,Dc,Do,zc,gn,Bc,Mc,xc,zo,jc,Bo,Ec,Fc,Pc,J,Mo,Cc,Pe,Ac,_n,Nc,Sc,Ns,Lc,Ic,Oc,it,Wc,Ss,Hc,Rc,xo,Ca,Ce,lt,Ls,jo,Uc,Is,Vc,Aa,H,Eo,Xc,Os,Jc,Kc,Fo,Gc,bn,Yc,Zc,ep,Po,tp,Co,op,np,sp,C,Ao,ap,Ae,rp,kn,ip,lp,Ws,dp,cp,pp,dt,hp,Hs,up,mp,No,fp,So,Na,Ne,ct,Rs,Lo,gp,Us,_p,Sa,R,Io,bp,Se,kp,Vs,Qp,vp,Xs,wp,Tp,yp,Oo,qp,Qn,$p,Dp,zp,Wo,Bp,Ho,Mp,xp,jp,A,Ro,Ep,Le,Fp,vn,Pp,Cp,Js,Ap,Np,Sp,pt,Lp,Ks,Ip,Op,Uo,Wp,Vo,La;return w=new Y({}),mt=new Y({}),Qt=new Y({}),Tt=new x({props:{code:`import pytorch_quantization.nn as quant_nn
...
<p>A <a
  href="/docs/transformers/pr_16590/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16590/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16590/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jt=new E({props:{name:"forward",anchor:"transformers.QDQBertLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16590/src/transformers/models/qdqbert/modeling_qdqbert.py#L1035",parametersDescription:[{anchor:"transformers.QDQBertLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16590/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>past_key_values</code>).`,name:"use_cache"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16590/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16590/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),no=new E({props:{name:"forward",anchor:"transformers.QDQBertForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16590/src/transformers/models/qdqbert/modeling_qdqbert.py#L1186",parametersDescription:[{anchor:"transformers.QDQBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16590/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16590/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16590/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new E({props:{name:"forward",anchor:"transformers.QDQBertForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16590/src/transformers/models/qdqbert/modeling_qdqbert.py#L1386",parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16590/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16590/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new E({props:{name:"forward",anchor:"transformers.QDQBertForNextSentencePrediction.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16590/src/transformers/models/qdqbert/modeling_qdqbert.py#L1281",parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16590/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16590/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<p>A <a
  href="/docs/transformers/pr_16590/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16590/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new E({props:{name:"forward",anchor:"transformers.QDQBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16590/src/transformers/models/qdqbert/modeling_qdqbert.py#L1660",parametersDescription:[{anchor:"transformers.QDQBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16590/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16590/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
SQUAD task can be found at `),Zo=a("a"),Rr=n("transformers/examples/research_projects/quantization-qdqbert/"),Ur=n("."),ca=l(),He=a("p"),Vr=n("This model was contributed by "),kt=a("a"),Xr=n("shangz"),Jr=n("."),pa=l(),be=a("h3"),Re=a("a"),Hn=a("span"),g(Qt.$$.fragment),Kr=l(),Rn=a("span"),Gr=n("Set default quantizers"),ha=l(),F=a("p"),Yr=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
`),Un=a("code"),Zr=n("TensorQuantizer"),ei=n(" in "),vt=a("a"),ti=n("Pytorch Quantization Toolkit"),oi=n(". "),Vn=a("code"),ni=n("TensorQuantizer"),si=n(` is the module
...
tensors. After setting up the tensor quantizers, one can use the following example to calibrate the model:`),ba=l(),g(qt.$$.fragment),ka=l(),Qe=a("h3"),Xe=a("a"),Yn=a("span"),g($t.$$.fragment),gi=l(),Zn=a("span"),_i=n("Export to ONNX"),Qa=l(),se=a("p"),bi=n("The goal of exporting to ONNX is to deploy inference by "),Dt=a("a"),ki=n("TensorRT"),Qi=n(`. Fake
...
the instructions in `),zt=a("a"),vi=n("torch.onnx"),wi=n(". Example:"),va=l(),g(Bt.$$.fragment),wa=l(),ve=a("h2"),Je=a("a"),es=a("span"),g(Mt.$$.fragment),Ti=l(),ts=a("span"),yi=n("QDQBertConfig"),Ta=l(),N=a("div"),g(xt.$$.fragment),qi=l(),we=a("p"),$i=n("This is the configuration class to store the configuration of a "),on=a("a"),Di=n("QDQBertModel"),zi=n(`. It is used to instantiate an
...
`),ds=a("code"),cl=n("add_cross_attention"),pl=n(" set to "),cs=a("code"),hl=n("True"),ul=n("; an "),ps=a("code"),ml=n("encoder_hidden_states"),fl=n(" is then expected as an input to the forward pass."),gl=l(),U=a("div"),g(It.$$.fragment),_l=l(),qe=a("p"),bl=n("The "),rn=a("a"),kl=n("QDQBertModel"),Ql=n(" forward method, overrides the "),hs=a("code"),vl=n("__call__"),wl=n(" special method."),Tl=l(),g(Ge.$$.fragment),yl=l(),us=a("p"),ql=n("Example:"),$l=l(),g(Ot.$$.fragment),$a=l(),$e=a("h2"),Ye=a("a"),ms=a("span"),g(Wt.$$.fragment),Dl=l(),fs=a("span"),zl=n("QDQBertLMHeadModel"),Da=l(),S=a("div"),g(Ht.$$.fragment),Bl=l(),Rt=a("p"),Ml=n("QDQBERT Model with a "),gs=a("code"),xl=n("language modeling"),jl=n(" head on top for CLM fine-tuning."),El=l(),Ut=a("p"),Fl=n("This model inherits from "),ln=a("a"),Pl=n("PreTrainedModel"),Cl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Al=l(),Vt=a("p"),Nl=n("This model is also a PyTorch "),Xt=a("a"),Sl=n("torch.nn.Module"),Ll=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Il=l(),V=a("div"),g(Jt.$$.fragment),Ol=l(),De=a("p"),Wl=n("The "),dn=a("a"),Hl=n("QDQBertLMHeadModel"),Rl=n(" forward method, overrides the "),_s=a("code"),Ul=n("__call__"),Vl=n(" special method."),Xl=l(),g(Ze.$$.fragment),Jl=l(),bs=a("p"),Kl=n("Example:"),Gl=l(),g(Kt.$$.fragment),za=l(),ze=a("h2"),et=a("a"),ks=a("span"),g(Gt.$$.fragment),Yl=l(),Qs=a("span"),Zl=n("QDQBertForMaskedLM"),Ba=l(),L=a("div"),g(Yt.$$.fragment),ed=l(),Zt=a("p"),td=n("QDQBERT Model with a "),vs=a("code"),od=n("language modeling"),nd=n(" head on top."),sd=l(),eo=a("p"),ad=n("This model inherits from "),cn=a("a"),rd=n("PreTrainedModel"),id=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ld=l(),to=a("p"),dd=n("This model is also a PyTorch "),oo=a("a"),cd=n("torch.nn.Module"),pd=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hd=l(),P=a("div"),g(no.$$.fragment),ud=l(),Be=a("p"),md=n("The "),pn=a("a"),fd=n("QDQBertForMaskedLM"),gd=n(" forward method, overrides the "),ws=a("code"),_d=n("__call__"),bd=n(" special method."),kd=l(),g(tt.$$.fragment),Qd=l(),Ts=a("p"),vd=n("Example:"),wd=l(),g(so.$$.fragment),Td=l(),g(ao.$$.fragment),Ma=l(),Me=a("h2"),ot=a("a"),ys=a("span"),g(ro.$$.fragment),yd=l(),qs=a("span"),qd=n("QDQBertForSequenceClassification"),xa=l(),I=a("div"),g(io.$$.fragment),$d=l(),$s=a("p"),Dd=n(`Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
SQUAD task can be found at `),Zo=r(Wa,"A",{href:!0});var nh=i(Zo);Rr=s(nh,"transformers/examples/research_projects/quantization-qdqbert/"),nh.forEach(o),Ur=s(Wa,"."),Wa.forEach(o),oh.forEach(o),ht.forEach(o),ca=d(t),He=r(t,"P",{});var Ha=i(He);Vr=s(Ha,"This model was contributed by "),kt=r(Ha,"A",{href:!0,rel:!0});var sh=i(kt);Xr=s(sh,"shangz"),sh.forEach(o),Jr=s(Ha,"."),Ha.forEach(o),pa=d(t),be=r(t,"H3",{class:!0});var Ra=i(be);Re=r(Ra,"A",{id:!0,class:!0,href:!0});var ah=i(Re);Hn=r(ah,"SPAN",{});var rh=i(Hn);_(Qt.$$.fragment,rh),rh.forEach(o),ah.forEach(o),Kr=d(Ra),Rn=r(Ra,"SPAN",{});var ih=i(Rn);Gr=s(ih,"Set default quantizers"),ih.forEach(o),Ra.forEach(o),ha=d(t),F=r(t,"P",{});var ee=i(F);Yr=s(ee,`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
`),Un=r(ee,"CODE",{});var lh=i(Un);Zr=s(lh,"TensorQuantizer"),lh.forEach(o),ei=s(ee," in "),vt=r(ee,"A",{href:!0,rel:!0});var dh=i(vt);ti=s(dh,"Pytorch Quantization Toolkit"),dh.forEach(o),oi=s(ee,". "),Vn=r(ee,"CODE",{});var ch=i(Vn);ni=s(ch,"TensorQuantizer"),ch.forEach(o),si=s(ee,` is the module
...
tensors. After setting up the tensor quantizers, one can use the following example to calibrate the model:`),bh.forEach(o),ba=d(t),_(qt.$$.fragment,t),ka=d(t),Qe=r(t,"H3",{class:!0});var Xa=i(Qe);Xe=r(Xa,"A",{id:!0,class:!0,href:!0});var kh=i(Xe);Yn=r(kh,"SPAN",{});var Qh=i(Yn);_($t.$$.fragment,Qh),Qh.forEach(o),kh.forEach(o),gi=d(Xa),Zn=r(Xa,"SPAN",{});var vh=i(Zn);_i=s(vh,"Export to ONNX"),vh.forEach(o),Xa.forEach(o),Qa=d(t),se=r(t,"P",{});var wn=i(se);bi=s(wn,"The goal of exporting to ONNX is to deploy inference by "),Dt=r(wn,"A",{href:!0,rel:!0});var wh=i(Dt);ki=s(wh,"TensorRT"),wh.forEach(o),Qi=s(wn,`. Fake
quantization will be broken into a pair of QuantizeLinear/DequantizeLinear ONNX ops. After setting static member of
TensorQuantizer to use Pytorch\u2019s own fake quantization functions, fake quantized model can be exported to ONNX, follow
the instructions in `),zt=r(wn,"A",{href:!0,rel:!0});var Th=i(zt);vi=s(Th,"torch.onnx"),Th.forEach(o),wi=s(wn,". Example:"),wn.forEach(o),va=d(t),_(Bt.$$.fragment,t),wa=d(t),ve=r(t,"H2",{class:!0});var Ja=i(ve);Je=r(Ja,"A",{id:!0,class:!0,href:!0});var yh=i(Je);es=r(yh,"SPAN",{});var qh=i(es);_(Mt.$$.fragment,qh),qh.forEach(o),yh.forEach(o),Ti=d(Ja),ts=r(Ja,"SPAN",{});var $h=i(ts);yi=s($h,"QDQBertConfig"),$h.forEach(o),Ja.forEach(o),Ta=d(t),N=r(t,"DIV",{class:!0});var ae=i(N);_(xt.$$.fragment,ae),qi=d(ae),we=r(ae,"P",{});var Tn=i(we);$i=s(Tn,"This is the configuration class to store the configuration of a "),on=r(Tn,"A",{href:!0});var Dh=i(on);Di=s(Dh,"QDQBertModel"),Dh.forEach(o),zi=s(Tn,`. It is used to instantiate an
QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the BERT
...
documentation from `),sn=r(yn,"A",{href:!0});var Mh=i(sn);Pi=s(Mh,"PretrainedConfig"),Mh.forEach(o),Ci=s(yn," for more information."),yn.forEach(o),Ai=d(ae),os=r(ae,"P",{});var xh=i(os);Ni=s(xh,"Examples:"),xh.forEach(o),Si=d(ae),_(Et.$$.fragment,ae),ae.forEach(o),ya=d(t),ye=r(t,"H2",{class:!0});var Ka=i(ye);Ke=r(Ka,"A",{id:!0,class:!0,href:!0});var jh=i(Ke);ns=r(jh,"SPAN",{});var Eh=i(ns);_(Ft.$$.fragment,Eh),Eh.forEach(o),jh.forEach(o),Li=d(Ka),ss=r(Ka,"SPAN",{});var Fh=i(ss);Ii=s(Fh,"QDQBertModel"),Fh.forEach(o),Ka.forEach(o),qa=d(t),z=r(t,"DIV",{class:!0});var K=i(z);_(Pt.$$.fragment,K),Oi=d(K),as=r(K,"P",{});var Ph=i(as);Wi=s(Ph,"The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Ph.forEach(o),Hi=d(K),Ct=r(K,"P",{});var Ga=i(Ct);Ri=s(Ga,"This model inherits from "),an=r(Ga,"A",{href:!0});var Ch=i(an);Ui=s(Ch,"PreTrainedModel"),Ch.forEach(o),Vi=s(Ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nr.forEach(o),Il=d(ie),V=r(ie,"DIV",{class:!0});var le=i(V);_(Jt.$$.fragment,le),Ol=d(le),De=r(le,"P",{});var $n=i(De);Wl=s($n,"The "),dn=r($n,"A",{href:!0});var eu=i(dn);Hl=s(eu,"QDQBertLMHeadModel"),eu.forEach(o),Rl=s($n," forward method, overrides the "),_s=r($n,"CODE",{});var tu=i(_s);Ul=s(tu,"__call__"),tu.forEach(o),Vl=s($n," special method."),$n.forEach(o),Xl=d(le),_(Ze.$$.fragment,le),Jl=d(le),bs=r(le,"P",{});var ou=i(bs);Kl=s(ou,"Example:"),ou.forEach(o),Gl=d(le),_(Kt.$$.fragment,le),le.forEach(o),ie.forEach(o),za=d(t),ze=r(t,"H2",{class:!0});var sr=i(ze);et=r(sr,"A",{id:!0,class:!0,href:!0});var nu=i(et);ks=r(nu,"SPAN",{});var su=i(ks);_(Gt.$$.fragment,su),su.forEach(o),nu.forEach(o),Yl=d(sr),Qs=r(sr,"SPAN",{});var au=i(Qs);Zl=s(au,"QDQBertForMaskedLM"),au.forEach(o),sr.forEach(o),Ba=d(t),L=r(t,"DIV",{class:!0});var de=i(L);_(Yt.$$.fragment,de),ed=d(de),Zt=r(de,"P",{});var ar=i(Zt);td=s(ar,"QDQBERT Model with a "),vs=r(ar,"CODE",{});var ru=i(vs);od=s(ru,"language modeling"),ru.forEach(o),nd=s(ar," head on top."),ar.forEach(o),sd=d(de),eo=r(de,"P",{});var rr=i(eo);ad=s(rr,"This model inherits from "),cn=r(rr,"A",{href:!0});var iu=i(cn);rd=s(iu,"PreTrainedModel"),iu.forEach(o),id=s(rr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dr.forEach(o),jd=d(ce),co=r(ce,"P",{});var cr=i(co);Ed=s(cr,"This model is also a PyTorch "),po=r(cr,"A",{href:!0,rel:!0});var _u=i(po);Fd=s(_u,"torch.nn.Module"),_u.forEach(o),Pd=s(cr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cr.forEach(o),Cd=d(ce),D=r(ce,"DIV",{class:!0});var M=i(D);_(ho.$$.fragment,M),Ad=d(M),xe=r(M,"P",{});var zn=i(xe);Nd=s(zn,"The "),un=r(zn,"A",{href:!0});var bu=i(un);Sd=s(bu,"QDQBertForSequenceClassification"),bu.forEach(o),Ld=s(zn," forward method, overrides the "),Ds=r(zn,"CODE",{});var ku=i(Ds);Id=s(ku,"__call__"),ku.forEach(o),Od=s(zn," special method."),zn.forEach(o),Wd=d(M),_(nt.$$.fragment,M),Hd=d(M),zs=r(M,"P",{});var Qu=i(zs);Rd=s(Qu,"Example of single-label classification:"),Qu.forEach(o),Ud=d(M),_(uo.$$.fragment,M),Vd=d(M),_(mo.$$.fragment,M),Xd=d(M),Bs=r(M,"P",{});var vu=i(Bs);Jd=s(vu,"Example of multi-label classification:"),vu.forEach(o),Kd=d(M),_(fo.$$.fragment,M),Gd=d(M),_(go.$$.fragment,M),M.forEach(o),ce.forEach(o),ja=d(t),je=r(t,"H2",{class:!0});var pr=i(je);st=r(pr,"A",{id:!0,class:!0,href:!0});var wu=i(st);Ms=r(wu,"SPAN",{});var Tu=i(Ms);_(_o.$$.fragment,Tu),Tu.forEach(o),wu.forEach(o),Yd=d(pr),xs=r(pr,"SPAN",{});var yu=i(xs);Zd=s(yu,"QDQBertForNextSentencePrediction"),yu.forEach(o),pr.forEach(o),Ea=d(t),O=r(t,"DIV",{class:!0});var pe=i(O);_(bo.$$.fragment,pe),ec=d(pe),ko=r(pe,"P",{});var hr=i(ko);tc=s(hr,"Bert Model with a "),js=r(hr,"CODE",{});var qu=i(js);oc=s(qu,"next sentence prediction (classification)"),qu.forEach(o),nc=s(hr," head on top."),hr.forEach(o),sc=d(pe),Qo=r(pe,"P",{});var ur=i(Qo);ac=s(ur,"This model inherits from "),mn=r(ur,"A",{href:!0});var $u=i(mn);rc=s($u,"PreTrainedModel"),$u.forEach(o),ic=s(ur,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ur.forEach(o),lc=d(pe),vo=r(pe,"P",{});var mr=i(vo);dc=s(mr,"This model is also a PyTorch "),wo=r(mr,"A",{href:!0,rel:!0});var Du=i(wo);cc=s(Du,"torch.nn.Module"),Du.forEach(o),pc=s(mr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mr.forEach(o),hc=d(pe),X=r(pe,"DIV",{class:!0});var he=i(X);_(To.$$.fragment,he),uc=d(he),Ee=r(he,"P",{});var Bn=i(Ee);mc=s(Bn,"The "),fn=r(Bn,"A",{href:!0});var zu=i(fn);fc=s(zu,"QDQBertForNextSentencePrediction"),zu.forEach(o),gc=s(Bn," forward method, overrides the "),Es=r(Bn,"CODE",{});var Bu=i(Es);_c=s(Bu,"__call__"),Bu.forEach(o),bc=s(Bn," special method."),Bn.forEach(o),kc=d(he),_(at.$$.fragment,he),Qc=d(he),Fs=r(he,"P",{});var Mu=i(Fs);vc=s(Mu,"Example:"),Mu.forEach(o),wc=d(he),_(yo.$$.fragment,he),he.forEach(o),pe.forEach(o),Fa=d(t),Fe=r(t,"H2",{class:!0});var fr=i(Fe);rt=r(fr,"A",{id:!0,class:!0,href:!0});var xu=i(rt);Ps=r(xu,"SPAN",{});var ju=i(Ps);_(qo.$$.fragment,ju),ju.forEach(o),xu.forEach(o),Tc=d(fr),Cs=r(fr,"SPAN",{});var Eu=i(Cs);yc=s(Eu,"QDQBertForMultipleChoice"),Eu.forEach(o),fr.forEach(o),Pa=d(t),W=r(t,"DIV",{class:!0});var ue=i(W);_($o.$$.fragment,ue),qc=d(ue),As=r(ue,"P",{});var Fu=i(As);$c=s(Fu,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kr.forEach(o),ep=d(fe),Po=r(fe,"P",{});var Qr=i(Po);tp=s(Qr,"This model is also a PyTorch "),Co=r(Qr,"A",{href:!0,rel:!0});var Ru=i(Co);op=s(Ru,"torch.nn.Module"),Ru.forEach(o),np=s(Qr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr.forEach(o),sp=d(fe),C=r(fe,"DIV",{class:!0});var oe=i(C);_(Ao.$$.fragment,oe),ap=d(oe),Ae=r(oe,"P",{});var xn=i(Ae);rp=s(xn,"The "),kn=r(xn,"A",{href:!0});var Uu=i(kn);ip=s(Uu,"QDQBertForTokenClassification"),Uu.forEach(o),lp=s(xn," forward method, overrides the "),Ws=r(xn,"CODE",{});var Vu=i(Ws);dp=s(Vu,"__call__"),Vu.forEach(o),cp=s(xn," special method."),xn.forEach(o),pp=d(oe),_(dt.$$.fragment,oe),hp=d(oe),Hs=r(oe,"P",{});var Xu=i(Hs);up=s(Xu,"Example:"),Xu.forEach(o),mp=d(oe),_(No.$$.fragment,oe),fp=d(oe),_(So.$$.fragment,oe),oe.forEach(o),fe.forEach(o),Na=d(t),Ne=r(t,"H2",{class:!0});var vr=i(Ne);ct=r(vr,"A",{id:!0,class:!0,href:!0});var Ju=i(ct);Rs=r(Ju,"SPAN",{});var Ku=i(Rs);_(Lo.$$.fragment,Ku),Ku.forEach(o),Ju.forEach(o),gp=d(vr),Us=r(vr,"SPAN",{});var Gu=i(Us);_p=s(Gu,"QDQBertForQuestionAnswering"),Gu.forEach(o),vr.forEach(o),Sa=d(t),R=r(t,"DIV",{class:!0});var ge=i(R);_(Io.$$.fragment,ge),bp=d(ge),Se=r(ge,"P",{});var jn=i(Se);kp=s(jn,`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vs=r(jn,"CODE",{});var Yu=i(Vs);Qp=s(Yu,"span start logits"),Yu.forEach(o),vp=s(jn," and "),Xs=r(jn,"CODE",{});var Zu=i(Xs);wp=s(Zu,"span end logits"),Zu.forEach(o),Tp=s(jn,")."),jn.forEach(o),yp=d(ge),Oo=r(ge,"P",{});var wr=i(Oo);qp=s(wr,"This model inherits from "),Qn=r(wr,"A",{href:!0});var em=i(Qn);$p=s(em,"PreTrainedModel"),em.forEach(o),Dp=s(wr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
