import{S as uy,i as my,s as fy,e as o,k as d,w as f,t as r,M as _y,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as k,B as v}from"../../chunks/vendor-4833417e.js";import{T as zt}from"../../chunks/Tip-fffd6df1.js";import{D as M}from"../../chunks/Docstring-44c5af16.js";import{C as R}from"../../chunks/CodeBlock-90ffda97.js";import{I as ke}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function gy(I){let u,x,b,y,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),y=r("Module"),z=r(`
...
configuration. Check out the <a href="/docs/transformers/pr_15825/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xs=new M({props:{name:"forward",anchor:"transformers.T5Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_t5.py#L1340",parametersDescription:[{anchor:"transformers.T5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15825/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15825/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_15825/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15825/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_t5.py#L1308"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15825/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Os=new M({props:{name:"forward",anchor:"transformers.T5ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_t5.py#L1534",parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15825/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_t5.py#L1503"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15825/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_t5.py#L1805",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15825/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_15825/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_t5.py#L1779"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15825/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[wy]},$$scope:{ctx:I}}}),wa=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_tf_t5.py#L1355",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15825/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15825/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[$y]},$$scope:{ctx:I}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15825/src/transformers/models/t5/modeling_tf_t5.py#L1630",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15825/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15825/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15825/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15825/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15825/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15825/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
behavior.`),UT=d(),f(Yn.$$.fragment),WT=d(),Ze=o("div"),f(ha.$$.fragment),RT=d(),_n=o("p"),HT=r("The "),Pr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),ZT=r(" special method."),JT=d(),f(Zn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),e5=d(),f(ua.$$.fragment),Cc=d(),gn=o("h2"),Jn=o("a"),hl=o("span"),f(ma.$$.fragment),t5=d(),ul=o("span"),n5=r("TFT5ForConditionalGeneration"),Ac=d(),le=o("div"),f(fa.$$.fragment),o5=d(),_a=o("p"),s5=r("T5 Model with a "),ml=o("code"),a5=r("language modeling"),r5=r(" head on top."),i5=d(),ga=o("p"),d5=r("The T5 model was proposed in "),Ta=o("a"),l5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k5=d(),f(Xn.$$.fragment),v5=d(),Je=o("div"),f(wa.$$.fragment),b5=d(),Tn=o("p"),w5=r("The "),Ar=o("a"),y5=r("TFT5ForConditionalGeneration"),$5=r(" forward method, overrides the "),fl=o("code"),z5=r("__call__"),x5=r(" special method."),E5=d(),f(Qn.$$.fragment),q5=d(),_l=o("p"),j5=r("Examples:"),F5=d(),f(ya.$$.fragment),Nc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f($a.$$.fragment),M5=d(),Tl=o("span"),P5=r("TFT5EncoderModel"),Ic=d(),ce=o("div"),f(za.$$.fragment),C5=d(),kl=o("p"),A5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),N5=d(),xa=o("p"),I5=r("The T5 model was proposed in "),Ea=o("a"),L5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),D5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),S5=d(),qa=o("p"),O5=r("This model inherits from "),Nr=o("a"),G5=r("TFPreTrainedModel"),B5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),U5=d(),ja=o("p"),W5=r("This model is also a "),Fa=o("a"),R5=r("tf.keras.Model"),H5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V5=d(),f(to.$$.fragment),K5=d(),Xe=o("div"),f(Ma.$$.fragment),Y5=d(),vn=o("p"),Z5=r("The "),Ir=o("a"),J5=r("TFT5EncoderModel"),X5=r(" forward method, overrides the "),vl=o("code"),Q5=r("__call__"),ek=r(" special method."),tk=d(),f(no.$$.fragment),nk=d(),bl=o("p"),ok=r("Examples:"),sk=d(),f(Pa.$$.fragment),Lc=d(),bn=o("h2"),oo=o("a"),wl=o("span"),f(Ca.$$.fragment),ak=d(),yl=o("span"),rk=r("FlaxT5Model"),Dc=d(),lt=o("div"),f(Aa.$$.fragment),ik=d(),Qe=o("div"),f(Na.$$.fragment),dk=d(),wn=o("p"),lk=r("The "),$l=o("code"),ck=r("FlaxT5PreTrainedModel"),pk=r("forward method, overrides the "),zl=o("code"),hk=r("__call__"),uk=r(" special method."),mk=d(),f(so.$$.fragment),fk=d(),xl=o("p"),_k=r("Example:"),gk=d(),f(Ia.$$.fragment),Tk=d(),Mt=o("div"),f(La.$$.fragment),kk=d(),El=o("p"),vk=r("Example:"),bk=d(),f(Da.$$.fragment),wk=d(),Pt=o("div"),f(Sa.$$.fragment),yk=d(),ql=o("p"),$k=r("Example:"),zk=d(),f(Oa.$$.fragment),Sc=d(),yn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),xk=d(),Fl=o("span"),Ek=r("FlaxT5ForConditionalGeneration"),Oc=d(),ct=o("div"),f(Ba.$$.fragment),qk=d(),et=o("div"),f(Ua.$$.fragment),jk=d(),$n=o("p"),Fk=r("The "),Ml=o("code"),Mk=r("FlaxT5PreTrainedModel"),Pk=r("forward method, overrides the "),Pl=o("code"),Ck=r("__call__"),Ak=r(" special method."),Nk=d(),f(ro.$$.fragment),Ik=d(),Cl=o("p"),Lk=r("Example:"),Dk=d(),f(Wa.$$.fragment),Sk=d(),Ct=o("div"),f(Ra.$$.fragment),Ok=d(),Al=o("p"),Gk=r("Example:"),Bk=d(),f(Ha.$$.fragment),Uk=d(),At=o("div"),f(Va.$$.fragment),Wk=d(),Nl=o("p"),Rk=r("Example:"),Hk=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_y('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);y=s(Ya,"A",{id:!0,class:!0,href:!0});var Il=a(y);z=s(Il,"SPAN",{});var Ll=a(z);_($.$$.fragment,Ll),Ll.forEach(t),Il.forEach(t),w=l(Ya),E=s(Ya,"SPAN",{});var Dl=a(E);Ee=i(Dl,"T5"),Dl.forEach(t),Ya.forEach(t),oe=l(n),q=s(n,"H2",{class:!0});var Za=a(q);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Sl=a(ee);O=s(Sl,"SPAN",{});var Ol=a(O);_(se.$$.fragment,Ol),Ol.forEach(t),Sl.forEach(t),qe=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),ve=l(n),B=s(n,"P",{});var Ja=a(B);L=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Bl=a(ae);pe=i(Bl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Bl.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),W=s(Dr,"EM",{});var ov=a(W);Ae=i(ov,"summarize: \u2026"),ov.forEach(t),m=i(Dr,"."),Dr.forEach(t),tv.forEach(t),j=l(Lr),te=s(Lr,"LI",{});var sv=a(te);Oe=s(sv,"P",{});var av=a(Oe);pt=i(av,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),av.forEach(t),sv.forEach(t),S=l(Lr),Ge=s(Lr,"LI",{});var rv=a(Ge);ne=s(rv,"P",{});var io=a(ne);ht=i(io,"See the "),N=s(io,"A",{href:!0});var iv=a(N);Y=i(iv,"training"),iv.forEach(t),ut=i(io,", "),Ne=s(io,"A",{href:!0});var dv=a(Ne);Z=i(dv,"inference"),dv.forEach(t),mt=i(io," and "),Ie=s(io,"A",{href:!0});var lv=a(Ie);Le=i(lv,"scripts"),lv.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rv.forEach(t),Lr.forEach(t),Vl=l(n),Xa=s(n,"P",{});var cv=a(Xa);Sp=i(cv,"T5 comes in different sizes:"),cv.forEach(t),Kl=l(n),Be=s(n,"UL",{});var Nt=a(Be);di=s(Nt,"LI",{});var pv=a(di);li=s(pv,"P",{});var hv=a(li);To=s(hv,"A",{href:!0,rel:!0});var uv=a(To);Op=i(uv,"t5-small"),uv.forEach(t),hv.forEach(t),pv.forEach(t),Gp=l(Nt),ci=s(Nt,"LI",{});var mv=a(ci);pi=s(mv,"P",{});var fv=a(pi);ko=s(fv,"A",{href:!0,rel:!0});var _v=a(ko);Bp=i(_v,"t5-base"),_v.forEach(t),fv.forEach(t),mv.forEach(t),Up=l(Nt),hi=s(Nt,"LI",{});var gv=a(hi);ui=s(gv,"P",{});var Tv=a(ui);vo=s(Tv,"A",{href:!0,rel:!0});var kv=a(vo);Wp=i(kv,"t5-large"),kv.forEach(t),Tv.forEach(t),gv.forEach(t),Rp=l(Nt),mi=s(Nt,"LI",{});var vv=a(mi);fi=s(vv,"P",{});var bv=a(fi);bo=s(bv,"A",{href:!0,rel:!0});var wv=a(bo);Hp=i(wv,"t5-3b"),wv.forEach(t),bv.forEach(t),vv.forEach(t),Vp=l(Nt),_i=s(Nt,"LI",{});var yv=a(_i);Qa=s(yv,"P",{});var Vk=a(Qa);wo=s(Vk,"A",{href:!0,rel:!0});var $v=a(wo);Kp=i($v,"t5-11b"),$v.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),yv.forEach(t),Nt.forEach(t),Yl=l(n),er=s(n,"P",{});var zv=a(er);Zp=i(zv,"Based on the original T5 model, Google has released some follow-up works:"),zv.forEach(t),Zl=l(n),xt=s(n,"UL",{});var Sr=a(xt);gi=s(Sr,"LI",{});var xv=a(gi);zn=s(xv,"P",{});var Wl=a(zn);Ti=s(Wl,"STRONG",{});var Ev=a(Ti);Jp=i(Ev,"T5v1.1"),Ev.forEach(t),Xp=i(Wl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var Mv=a(nr);sh=i(Mv,"here"),Mv.forEach(t),ah=i(Rl,"."),Rl.forEach(t),jv.forEach(t),rh=l(Sr),bi=s(Sr,"LI",{});var Pv=a(bi);En=s(Pv,"P",{});var Hl=a(En);wi=s(Hl,"STRONG",{});var Cv=a(wi);ih=i(Cv,"byT5"),Cv.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Av=a(or);lh=i(Av,"here"),Av.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pv.forEach(t),Sr.forEach(t),Jl=l(n),qn=s(n,"P",{});var Bc=a(qn);ph=i(Bc,"All checkpoints can be found on the "),yo=s(Bc,"A",{href:!0,rel:!0});var Nv=a(yo);hh=i(Nv,"hub"),Nv.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),Et=s(n,"P",{});var Or=a(Et);mh=i(Or,"This model was contributed by "),$o=s(Or,"A",{href:!0,rel:!0});var Iv=a($o);fh=i(Iv,"thomwolf"),Iv.forEach(t),_h=i(Or,". The original code can be found "),zo=s(Or,"A",{href:!0,rel:!0});var Lv=a(zo);gh=i(Lv,"here"),Lv.forEach(t),Th=i(Or,"."),Or.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Uc=a(Zt);jn=s(Uc,"A",{id:!0,class:!0,href:!0});var Dv=a(jn);yi=s(Dv,"SPAN",{});var Sv=a(yi);_(xo.$$.fragment,Sv),Sv.forEach(t),Dv.forEach(t),kh=l(Uc),$i=s(Uc,"SPAN",{});var Ov=a($i);vh=i(Ov,"Training"),Ov.forEach(t),Uc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),zi=s(lo,"CODE",{});var Gv=a(zi);wh=i(Gv,"input_ids"),Gv.forEach(t),yh=i(lo,`. The target sequence is shifted to the right, i.e., prepended by a
...
language modeling head on top of the decoder.`),Wc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var It=a(dt);qi=s(It,"P",{});var Rv=a(qi);Mh=i(Rv,"Unsupervised denoising training"),Rv.forEach(t),Ph=l(It),_e=s(It,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hv=a(ji);Ah=i(Hv,"a.k.a"),Hv.forEach(t),Nh=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var Vv=a(Fi);Ih=i(Vv,"real"),Vv.forEach(t),Lh=i(tt,` masked tokens. Each
...
`),Pi=s(tt,"CODE",{});var Yv=a(Pi);Oh=i(Yv,"<extra_id_1>"),Yv.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Zv=a(Ci);Bh=i(Zv,"<extra_id_99>"),Zv.forEach(t),Uh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var Jv=a(rr);Wh=i(Jv,"T5Tokenizer"),Jv.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(It),Ai=s(It,"P",{});var Xv=a(Ai);Vh=i(Xv,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Xv.forEach(t),Kh=l(It),_(Eo.$$.fragment,It),Yh=l(It),qo=s(It,"P",{});var Hc=a(qo);Zh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Qv=a(jo);Jh=i(Qv,"run_t5_mlm_flax.py"),Qv.forEach(t),Xh=i(Hc,` script in the Examples
directory.`),Hc.forEach(t),It.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Ni=s(nt,"P",{});var eb=a(Ni);eu=i(eb,"Supervised training"),eb.forEach(t),tu=l(nt),Ii=s(nt,"P",{});var tb=a(Ii);nu=i(tb,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),tb.forEach(t),ou=l(nt),_(Fo.$$.fragment,nt),su=l(nt),re=s(nt,"P",{});var ye=a(re);au=i(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Li=s(ye,"CODE",{});var nb=a(Li);ru=i(nb,"input_ids"),nb.forEach(t),iu=i(ye,` (which are the
`),Di=s(ye,"CODE",{});var ob=a(Di);du=i(ob,"input_ids"),ob.forEach(t),lu=i(ye," of the encoded input sequence) and "),Si=s(ye,"CODE",{});var sb=a(Si);cu=i(sb,"labels"),sb.forEach(t),pu=i(ye," (which are the "),Oi=s(ye,"CODE",{});var ab=a(Oi);hu=i(ab,"input_ids"),ab.forEach(t),uu=i(ye,` of the encoded
target sequence). The model will automatically create the `),Gi=s(ye,"CODE",{});var rb=a(Gi);mu=i(rb,"decoder_input_ids"),rb.forEach(t),fu=i(ye," based on the "),Bi=s(ye,"CODE",{});var ib=a(Bi);_u=i(ib,"labels"),ib.forEach(t),gu=i(ye,`, by
shifting them one position to the right and prepending the `),Ui=s(ye,"CODE",{});var db=a(Ui);Tu=i(db,"config.decoder_start_token_id"),db.forEach(t),ku=i(ye,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Wi=s(Gr,"CODE",{});var lb=a(Wi);wu=i(lb,"max_source_length"),lb.forEach(t),yu=i(Gr," and "),Ri=s(Gr,"CODE",{});var cb=a(Ri);$u=i(cb,"max_target_length"),cb.forEach(t),zu=i(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
...
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var fb=a(Mo);Iu=i(fb,"Flax summarization script"),fb.forEach(t),Lu=i(ot,` for details). We also pass
...
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),No=s(Ur,"A",{href:!0,rel:!0});var wb=a(No);Yu=i(wb,"paper"),wb.forEach(t),Zu=i(Ur,` for the task prefixes
used).`),Ur.forEach(t),vb.forEach(t),Ju=l(Br),ed=s(Br,"LI",{});var yb=a(ed);Io=s(yb,"P",{});var Kc=a(Io);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Kc.forEach(t),yb.forEach(t),Br.forEach(t),rc=l(n),dr=s(n,"A",{id:!0}),a(dr).forEach(t),ic=l(n),Qt=s(n,"H2",{class:!0});var Yc=a(Qt);Pn=s(Yc,"A",{id:!0,class:!0,href:!0});var zb=a(Pn);nd=s(zb,"SPAN",{});var xb=a(nd);_(Lo.$$.fragment,xb),xb.forEach(t),zb.forEach(t),tm=l(Yc),od=s(Yc,"SPAN",{});var Eb=a(od);nm=i(Eb,"Inference"),Eb.forEach(t),Yc.forEach(t),dc=l(n),gt=s(n,"P",{});var co=a(gt);om=i(co,"At inference time, it is recommended to use "),lr=s(co,"A",{href:!0});var qb=a(lr);sm=i(qb,"generate()"),qb.forEach(t),am=i(co,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
...
generation works in general in encoder-decoder models.`),co.forEach(t),lc=l(n),_(Oo.$$.fragment,n),cc=l(n),Ue=s(n,"P",{});var Lt=a(Ue);cm=i(Lt,"Note that T5 uses the "),sd=s(Lt,"CODE",{});var Mb=a(sd);pm=i(Mb,"pad_token_id"),Mb.forEach(t),hm=i(Lt," as the "),ad=s(Lt,"CODE",{});var Pb=a(ad);um=i(Pb,"decoder_start_token_id"),Pb.forEach(t),mm=i(Lt,`, so when doing generation without using
`),cr=s(Lt,"A",{href:!0});var Cb=a(cr);fm=i(Cb,"generate()"),Cb.forEach(t),_m=i(Lt,", make sure you start it with the "),rd=s(Lt,"CODE",{});var Ab=a(rd);gm=i(Ab,"pad_token_id"),Ab.forEach(t),Tm=i(Lt,"."),Lt.forEach(t),pc=l(n),pr=s(n,"P",{});var Nb=a(pr);km=i(Nb,"The example above only shows a single example. You can also do batched inference, like so:"),Nb.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Cn=s(Zc,"A",{id:!0,class:!0,href:!0});var Ib=a(Cn);id=s(Ib,"SPAN",{});var Lb=a(id);_(Bo.$$.fragment,Lb),Lb.forEach(t),Ib.forEach(t),vm=l(Zc),dd=s(Zc,"SPAN",{});var Db=a(dd);bm=i(Db,"Performance"),Db.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);wm=i(po,"If you\u2019d like a faster training and inference performance, install "),Uo=s(po,"A",{href:!0,rel:!0});var Sb=a(Uo);ym=i(Sb,"apex"),Sb.forEach(t),$m=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var Ob=a(ld);zm=i(Ob,"apex.normalization.FusedRMSNorm"),Ob.forEach(t),xm=i(po," instead of "),cd=s(po,"CODE",{});var Gb=a(cd);Em=i(Gb,"T5LayerNorm"),Gb.forEach(t),qm=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);An=s(Jc,"A",{id:!0,class:!0,href:!0});var Bb=a(An);pd=s(Bb,"SPAN",{});var Ub=a(pd);_(Wo.$$.fragment,Ub),Ub.forEach(t),Bb.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var Wb=a(hd);Fm=i(Wb,"Example scripts"),Wb.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var Rb=a(ur);Mm=i(Rb,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rb.forEach(t),Tc=l(n),Nn=s(n,"UL",{});var Xc=a(Nn);ud=s(Xc,"LI",{});var Hb=a(ud);nn=s(Hb,"P",{});var Wr=a(nn);Pm=i(Wr,"pre-training: the "),Ro=s(Wr,"A",{href:!0,rel:!0});var Vb=a(Ro);Cm=i(Vb,"run_t5_mlm_flax.py"),Vb.forEach(t),Am=i(Wr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Wr,"A",{href:!0,rel:!0});var Kb=a(Ho);Nm=i(Kb,"t5_tokenizer_model.py"),Kb.forEach(t),Im=i(Wr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Wr.forEach(t),Hb.forEach(t),Lm=l(Xc),md=s(Xc,"LI",{});var Yb=a(md);De=s(Yb,"P",{});var wt=a(De);Dm=i(wt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(wt,"A",{href:!0,rel:!0});var Zb=a(Vo);Sm=i(Zb,"PyTorch"),Zb.forEach(t),Om=i(wt,", "),Ko=s(wt,"A",{href:!0,rel:!0});var Jb=a(Ko);Gm=i(Jb,"Tensorflow"),Jb.forEach(t),Bm=i(wt,", and "),Yo=s(wt,"A",{href:!0,rel:!0});var Xb=a(Yo);Um=i(Xb,"Flax"),Xb.forEach(t),Wm=i(wt,`) and translation scripts
(`),Zo=s(wt,"A",{href:!0,rel:!0});var Qb=a(Zo);Rm=i(Qb,"PyTorch"),Qb.forEach(t),Hm=i(wt," and "),Jo=s(wt,"A",{href:!0,rel:!0});var e1=a(Jo);Vm=i(e1,"Tensorflow"),e1.forEach(t),Km=i(wt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),wt.forEach(t),Yb.forEach(t),Xc.forEach(t),kc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);In=s(Qc,"A",{id:!0,class:!0,href:!0});var t1=a(In);fd=s(t1,"SPAN",{});var n1=a(fd);_(Xo.$$.fragment,n1),n1.forEach(t),t1.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var o1=a(_d);Zm=i(o1,"T5Config"),o1.forEach(t),Qc.forEach(t),vc=l(n),yt=s(n,"DIV",{class:!0});var Rr=a(yt);_(Qo.$$.fragment,Rr),Jm=l(Rr),$t=s(Rr,"P",{});var ho=a($t);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var s1=a(mr);Qm=i(s1,"T5Model"),s1.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var a1=a(fr);tf=i(a1,"TFT5Model"),a1.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
