...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17942/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17942/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17942/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17942/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),by=h(It),y(ms.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vy=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yy=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$y=i(Xx,"__call__"),Xx.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(uo),y(gs.$$.fragment,uo),Ry=h(uo),y(_s.$$.fragment,uo),My=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mm=a(Ho);ks=s(Mm,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),Ey=h(Mm),Mp=s(Mm,"SPAN",{});var e4=a(Mp);zy=i(e4,"TFRobertaForMultipleChoice"),e4.forEach(t),Mm.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var t4=a(Ep);Cy=i(t4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t4.forEach(t),jy=h(Dt),ni=s(Dt,"P",{});var Em=a(ni);Py=i(Em,"This model inherits from "),xd=s(Em,"A",{href:!0});var o4=a(xd);Ly=i(o4,"TFPreTrainedModel"),o4.forEach(t),Ay=i(Em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em.forEach(t),Oy=h(Dt),si=s(Dt,"P",{});var zm=a(si);Ny=i(zm,"This model is also a "),ai=s(zm,"A",{href:!0,rel:!0});var n4=a(ai);Iy=i(n4,"tf.keras.Model"),n4.forEach(t),Dy=i(zm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zm.forEach(t),Sy=h(Dt),y(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s4=a(Rd);Hy=i(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a4=a(zp);Jy=i(a4,"__call__"),a4.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),y(Ts.$$.fragment,aa),Gy=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qm=a(Jo);ws=s(qm,"A",{id:!0,class:!0,href:!0});var r4=a(ws);qp=s(r4,"SPAN",{});var i4=a(qp);y(ii.$$.fragment,i4),i4.forEach(t),r4.forEach(t),Xy=h(qm),Cp=s(qm,"SPAN",{});var l4=a(Cp);Yy=i(l4,"TFRobertaForTokenClassification"),l4.forEach(t),qm.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var d4=a(jp);ew=i(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),tw=h(St),di=s(St,"P",{});var Cm=a(di);ow=i(Cm,"This model inherits from "),Md=s(Cm,"A",{href:!0});var c4=a(Md);nw=i(c4,"TFPreTrainedModel"),c4.forEach(t),sw=i(Cm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cm.forEach(t),aw=h(St),ci=s(St,"P",{});var jm=a(ci);rw=i(jm,"This model is also a "),pi=s(jm,"A",{href:!0,rel:!0});var p4=a(pi);iw=i(p4,"tf.keras.Model"),p4.forEach(t),lw=i(jm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jm.forEach(t),dw=h(St),y($s.$$.fragment,St),cw=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),pw=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hw=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h4=a(Ed);uw=i(h4,"TFRobertaForTokenClassification"),h4.forEach(t),fw=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var u4=a(Pp);mw=i(u4,"__call__"),u4.forEach(t),gw=i(tc," special method."),tc.forEach(t),_w=h(fo),y(Fs.$$.fragment,fo),bw=h(fo),y(xs.$$.fragment,fo),kw=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pm=a(Ko);Ms=s(Pm,"A",{id:!0,class:!0,href:!0});var f4=a(Ms);Lp=s(f4,"SPAN",{});var m4=a(Lp);y(ui.$$.fragment,m4),m4.forEach(t),f4.forEach(t),vw=h(Pm),Ap=s(Pm,"SPAN",{});var g4=a(Ap);Tw=i(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Pm.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yw=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);ww=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _4=a(Op);$w=i(_4,"span start logits"),_4.forEach(t),Fw=i(oc," and "),Np=s(oc,"CODE",{});var b4=a(Np);xw=i(b4,"span end logits"),b4.forEach(t),Rw=i(oc,")."),oc.forEach(t),Mw=h(Wt),mi=s(Wt,"P",{});var Lm=a(mi);Ew=i(Lm,"This model inherits from "),zd=s(Lm,"A",{href:!0});var k4=a(zd);zw=i(k4,"TFPreTrainedModel"),k4.forEach(t),qw=i(Lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lm.forEach(t),Cw=h(Wt),gi=s(Wt,"P",{});var Am=a(gi);jw=i(Am,"This model is also a "),_i=s(Am,"A",{href:!0,rel:!0});var v4=a(_i);Pw=i(v4,"tf.keras.Model"),v4.forEach(t),Lw=i(Am,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Am.forEach(t),Aw=h(Wt),y(Es.$$.fragment,Wt),Ow=h(Wt),ut=s(Wt,"DIV",{class:!0});var mo=a(ut);y(bi.$$.fragment,mo),Nw=h(mo),Xo=s(mo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),qd=s(nc,"A",{href:!0});var T4=a(qd);Dw=i(T4,"TFRobertaForQuestionAnswering"),T4.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y4=a(Ip);Ww=i(y4,"__call__"),y4.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(mo),y(zs.$$.fragment,mo),Hw=h(mo),y(qs.$$.fragment,mo),Qw=h(mo),y(Cs.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Om=a(Yo);js=s(Om,"A",{id:!0,class:!0,href:!0});var w4=a(js);Dp=s(w4,"SPAN",{});var $4=a(Dp);y(ki.$$.fragment,$4),$4.forEach(t),w4.forEach(t),Jw=h(Om),Sp=s(Om,"SPAN",{});var F4=a(Sp);Vw=i(F4,"FlaxRobertaModel"),F4.forEach(t),Om.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var x4=a(Wp);Gw=i(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),Xw=h(gt),Ti=s(gt,"P",{});var Nm=a(Ti);Yw=i(Nm,"This model inherits from "),Cd=s(Nm,"A",{href:!0});var R4=a(Cd);Zw=i(R4,"FlaxPreTrainedModel"),R4.forEach(t),e1=i(Nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nm.forEach(t),t1=h(gt),yi=s(gt,"P",{});var Im=a(yi);o1=i(Im,"This model is also a Flax Linen "),wi=s(Im,"A",{href:!0,rel:!0});var M4=a(wi);n1=i(M4,"flax.linen.Module"),M4.forEach(t),s1=i(Im,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Im.forEach(t),a1=h(gt),Bp=s(gt,"P",{});var E4=a(Bp);r1=i(E4,"Finally, this model supports inherent JAX features such as:"),E4.forEach(t),i1=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z4=a(Up);$i=s(z4,"A",{href:!0,rel:!0});var q4=a($i);l1=i(q4,"Just-In-Time (JIT) compilation"),q4.forEach(t),z4.forEach(t),d1=h(ra),Hp=s(ra,"LI",{});var C4=a(Hp);Fi=s(C4,"A",{href:!0,rel:!0});var j4=a(Fi);c1=i(j4,"Automatic Differentiation"),j4.forEach(t),C4.forEach(t),p1=h(ra),Qp=s(ra,"LI",{});var P4=a(Qp);xi=s(P4,"A",{href:!0,rel:!0});var L4=a(xi);h1=i(L4,"Vectorization"),L4.forEach(t),P4.forEach(t),u1=h(ra),Jp=s(ra,"LI",{});var A4=a(Jp);Ri=s(A4,"A",{href:!0,rel:!0});var O4=a(Ri);f1=i(O4,"Parallelization"),O4.forEach(t),A4.forEach(t),ra.forEach(t),m1=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),g1=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_1=i(sc,"The "),Vp=s(sc,"CODE",{});var N4=a(Vp);b1=i(N4,"FlaxRobertaPreTrainedModel"),N4.forEach(t),k1=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I4=a(Kp);v1=i(I4,"__call__"),I4.forEach(t),T1=i(sc," special method."),sc.forEach(t),y1=h(ia),y(Ps.$$.fragment,ia),w1=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Dm=a(en);As=s(Dm,"A",{id:!0,class:!0,href:!0});var D4=a(As);Gp=s(D4,"SPAN",{});var S4=a(Gp);y(Ei.$$.fragment,S4),S4.forEach(t),D4.forEach(t),$1=h(Dm),Xp=s(Dm,"SPAN",{});var W4=a(Xp);F1=i(W4,"FlaxRobertaForCausalLM"),W4.forEach(t),Dm.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),x1=h(_t),Yp=s(_t,"P",{});var B4=a(Yp);R1=i(B4,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),B4.forEach(t),M1=h(_t),qi=s(_t,"P",{});var Sm=a(qi);E1=i(Sm,"This model inherits from "),jd=s(Sm,"A",{href:!0});var U4=a(jd);z1=i(U4,"FlaxPreTrainedModel"),U4.forEach(t),q1=i(Sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Sm.forEach(t),C1=h(_t),Ci=s(_t,"P",{});var Wm=a(Ci);j1=i(Wm,"This model is also a Flax Linen "),ji=s(Wm,"A",{href:!0,rel:!0});var H4=a(ji);P1=i(H4,"flax.linen.Module"),H4.forEach(t),L1=i(Wm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wm.forEach(t),A1=h(_t),Zp=s(_t,"P",{});var Q4=a(Zp);O1=i(Q4,"Finally, this model supports inherent JAX features such as:"),Q4.forEach(t),N1=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var J4=a(eh);Pi=s(J4,"A",{href:!0,rel:!0});var V4=a(Pi);I1=i(V4,"Just-In-Time (JIT) compilation"),V4.forEach(t),J4.forEach(t),D1=h(la),th=s(la,"LI",{});var K4=a(th);Li=s(K4,"A",{href:!0,rel:!0});var G4=a(Li);S1=i(G4,"Automatic Differentiation"),G4.forEach(t),K4.forEach(t),W1=h(la),oh=s(la,"LI",{});var X4=a(oh);Ai=s(X4,"A",{href:!0,rel:!0});var Y4=a(Ai);B1=i(Y4,"Vectorization"),Y4.forEach(t),X4.forEach(t),U1=h(la),nh=s(la,"LI",{});var Z4=a(nh);Oi=s(Z4,"A",{href:!0,rel:!0});var eR=a(Oi);H1=i(eR,"Parallelization"),eR.forEach(t),Z4.forEach(t),la.forEach(t),Q1=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),J1=h(da),tn=s(da,"P",{});var ac=a(tn);V1=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);K1=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),G1=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);X1=i(oR,"__call__"),oR.forEach(t),Y1=i(ac," special method."),ac.forEach(t),Z1=h(da),y(Os.$$.fragment,da),e$=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bm=a(on);Is=s(Bm,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);y(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bm),ih=s(Bm,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bm.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Um=a(Si);s$=i(Um,"RoBERTa Model with a "),lh=s(Um,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Um," head on top."),Um.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hm=a(Wi);l$=i(Hm,"This model inherits from "),Pd=s(Hm,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hm,`. Check the superclass documentation for the generic methods the
