...
first positional argument :`),se=d(),P=n("ul"),S=n("li"),lt=r("a single Tensor with "),pe=n("code"),he=r("input_ids"),ct=r(" only and nothing else: "),K=n("code"),pt=r("model(input_ids)"),ht=d(),D=n("li"),Ce=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),xe=a(Ve,"CODE",{});var Kt=s(xe);Ye=i(Kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Kt.forEach(t),Ve.forEach(t),de.forEach(t)},m(M,F){h(M,b,F),e(b,z),h(M,v,F),h(M,w,F),e(w,x),e(x,T),e(w,y),e(w,B),e(B,rt),h(M,Pe,F),h(M,j,F),e(j,Ue),e(j,ke),e(ke,it),e(j,be),e(j,ye),e(ye,dt),e(j,Ke),h(M,J,F),h(M,N,F),e(N,Xe),h(M,se,F),h(M,P,F),e(P,S),e(S,lt),e(S,pe),e(pe,he),e(S,ct),e(S,K),e(K,pt),e(P,ht),e(P,D),e(D,Ce),e(D,ve),e(ve,Ze),e(D,re),e(D,Te),e(Te,Me),e(P,ut),e(P,ie),e(ie,we),e(ie,xe),e(xe,Ye)},d(M){M&&t(b),M&&t(v),M&&t(w),M&&t(Pe),M&&t(j),M&&t(J),M&&t(N),M&&t(se),M&&t(P)}}}function Qz(E){let b,z,v,w,x;return{c(){b=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var B=s(v);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,w),e(b,x)},d(T){T&&t(b)}}}function Jz(E){let b,z,v,w,x,T,y,B,rt,Pe,j,Ue,ke,it,be,ye,dt,Ke,J,N,Xe,se,P,S,lt,pe,he,ct,K,pt,ht,D,Ce,ve,Ze,re,Te,Me,ut,ie,we,xe,Ye;return{c(){b=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),rt=r("having all inputs as a list, tuple or dict in the first positional arguments."),Pe=d(),j=n("p"),Ue=r("This second option is useful when using "),ke=n("code"),it=r("tf.keras.Model.fit"),be=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ye=n("code"),dt=r("model(inputs)"),Ke=r("."),J=d(),N=n("p"),Xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),se=d(),P=n("ul"),S=n("li"),lt=r("a single Tensor with "),pe=n("code"),he=r("input_ids"),ct=r(" only and nothing else: "),K=n("code"),pt=r("model(input_ids)"),ht=d(),D=n("li"),Ce=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ve=n("code"),Ze=r("model([input_ids, attention_mask])"),re=r(" or "),Te=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),ut=d(),ie=n("li"),we=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),xe=n("code"),Ye=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(M){b=a(M,"P",{});var F=s(b);z=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),v=l(M),w=a(M,"UL",{});var ze=s(w);x=a(ze,"LI",{});var He=s(x);T=i(He,"having all inputs as keyword arguments (like PyTorch models), or"),He.forEach(t),y=l(ze),B=a(ze,"LI",{});var Ut=s(B);rt=i(Ut,"having all inputs as a list, tuple or dict in the first positional arguments."),Ut.forEach(t),ze.forEach(t),Pe=l(M),j=a(M,"P",{});var Z=s(j);Ue=i(Z,"This second option is useful when using "),ke=a(Z,"CODE",{});var Xt=s(ke);it=i(Xt,"tf.keras.Model.fit"),Xt.forEach(t),be=i(Z,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var B=s(v);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,w),e(b,x)},d(T){T&&t(b)}}}function o0(E){let b,z,v,w,x,T,y,B,rt,Pe,j,Ue,ke,it,be,ye,dt,Ke,J,N,Xe,se,P,S,lt,pe,he,ct,K,pt,ht,D,Ce,ve,Ze,re,Te,Me,ut,ie,we,xe,Ye,M,F,ze,He,Ut,Z,Xt,bt,H,de,le,Ht,Vt,ce,Qt,Jt,Ve,Kt,Ou,ld,Su,Au,bp,yt,Iu,Cn,cd,Nu,Du,Lu,ti,Gu,Wu,yp,oi,pd,Ru,vp,On,Tp,ni,Sn,hd,Uu,Xu,Zt,Hu,ud,Vu,Qu,md,Ju,Ku,Mp,An,wp,Yt,Oo,fd,In,Zu,_d,Yu,xp,vt,em,Nn,tm,om,gd,nm,am,zp,ai,sm,qp,si,kd,rm,Bp,eo,So,bd,Dn,im,yd,dm,$p,et,lm,vd,cm,pm,Td,hm,um,Md,mm,fm,Fp,Ao,_m,ri,gm,km,jp,ii,wd,bm,Ep,Ln,Pp,di,Gn,xd,ym,vm,qe,Tm,zd,Mm,wm,qd,xm,zm,Bd,qm,Bm,$d,$m,Fm,Fd,jm,Em,Cp,Wn,Op,to,Io,jd,Rn,Pm,Ed,Cm,Sp,Be,Un,Om,oo,Sm,li,Am,Im,Xn,Nm,Dm,Lm,no,Gm,ci,Wm,Rm,pi,Um,Xm,Hm,Pd,Vm,Qm,Hn,Ap,ao,No,Cd,Vn,Jm,Od,Km,Ip,G,Qn,Zm,Sd,Ym,ef,mt,tf,hi,of,nf,ui,af,sf,Jn,rf,df,lf,Kn,cf,Ad,pf,hf,uf,Id,mf,ff,Zn,_f,Do,Yn,gf,Nd,kf,bf,tt,ea,yf,ta,vf,Dd,Tf,Mf,wf,oa,na,Ld,xf,zf,Gd,qf,Bf,aa,Wd,$f,Ff,Rd,jf,Ef,Ud,Pf,Np,so,Lo,Xd,sa,Cf,Hd,Of,Dp,C,ra,Sf,ro,Af,Vd,If,Nf,ia,Df,Lf,Gf,Tt,mi,Wf,Rf,fi,Uf,Xf,_i,Hf,Vf,Qf,da,Jf,Qd,Kf,Zf,Yf,Jd,e_,t_,la,o_,Oe,ca,n_,Kd,a_,s_,pa,r_,Zd,i_,d_,l_,ha,ua,Yd,c_,p_,el,h_,u_,ma,tl,m_,f_,ol,__,g_,nl,k_,b_,Go,fa,y_,al,v_,T_,Wo,_a,M_,sl,w_,x_,Ro,ga,z_,rl,q_,Lp,io,Uo,il,ka,B_,dl,$_,Gp,O,ba,F_,ya,j_,va,E_,P_,C_,Ta,O_,gi,S_,A_,I_,ll,N_,D_,Ma,L_,ot,wa,G_,xa,W_,cl,R_,U_,X_,za,qa,pl,H_,V_,hl,Q_,J_,Ba,ul,K_,Z_,ml,Y_,eg,fl,tg,og,Xo,$a,ng,_l,ag,sg,Ho,Fa,rg,ja,ig,gl,dg,lg,cg,Vo,Ea,pg,kl,hg,ug,Qo,Pa,mg,bl,fg,Wp,lo,Jo,yl,Ca,_g,vl,gg,Rp,W,Oa,kg,co,bg,Tl,yg,vg,Sa,Tg,Mg,wg,Aa,xg,ki,zg,qg,Bg,Ml,$g,Fg,Ia,jg,Se,Na,Eg,wl,Pg,Cg,Da,Og,xl,Sg,Ag,Ig,La,Ga,zl,Ng,Dg,ql,Lg,Gg,Wa,Bl,Wg,Rg,$l,Ug,Xg,Fl,Hg,Vg,Ko,Ra,Qg,jl,Jg,Kg,Zo,Ua,Zg,El,Yg,Up,po,Yo,Pl,Xa,ek,Cl,tk,Xp,Qe,Ha,ok,Va,nk,bi,ak,sk,rk,Qa,ik,Ja,dk,lk,ck,Ae,Ka,pk,ho,hk,yi,uk,mk,Ol,fk,_k,gk,en,kk,Sl,bk,yk,Za,Hp,uo,tn,Al,Ya,vk,Il,Tk,Vp,Je,es,Mk,ts,wk,vi,xk,zk,qk,os,Bk,ns,$k,Fk,jk,Y,as,Ek,mo,Pk,Ti,Ck,Ok,Nl,Sk,Ak,Ik,on,Nk,Dl,Dk,Lk,ss,Gk,Ll,Wk,Rk,rs,Qp,fo,nn,Gl,is,Uk,Wl,Xk,Jp,$e,ds,Hk,_o,Vk,Rl,Qk,Jk,Ul,Kk,Zk,Yk,ls,eb,Mi,tb,ob,nb,cs,ab,ps,sb,rb,ib,ue,hs,db,go,lb,wi,cb,pb,Xl,hb,ub,mb,an,fb,Hl,_b,gb,us,kb,ms,Kp,ko,sn,Vl,fs,bb,Ql,yb,Zp,Fe,_s,vb,Jl,Tb,Mb,gs,wb,xi,xb,zb,qb,ks,Bb,bs,$b,Fb,jb,L,ys,Eb,bo,Pb,zi,Cb,Ob,Kl,Sb,Ab,Ib,rn,Nb,Zl,Db,Lb,vs,Gb,Ts,Wb,Yl,Rb,Ub,Ms,Xb,ws,Yp,yo,dn,ec,xs,Hb,tc,Vb,eh,vo,zs,Qb,Mt,qs,Jb,oc,Kb,Zb,Bs,th,To,ln,nc,$s,Yb,ac,ey,oh,je,Fs,ty,js,oy,qi,ny,ay,sy,Es,ry,Ps,iy,dy,ly,cn,cy,Ie,Cs,py,Mo,hy,Bi,uy,my,sc,fy,_y,gy,pn,ky,rc,by,yy,Os,nh,wo,hn,ic,Ss,vy,dc,Ty,ah,Ee,As,My,Is,wy,$i,xy,zy,qy,Ns,By,Ds,$y,Fy,jy,un,Ey,ee,Ls,Py,xo,Cy,Fi,Oy,Sy,lc,Ay,Iy,Ny,mn,Dy,cc,Ly,Gy,Gs,Wy,pc,Ry,Uy,Ws,sh,zo,fn,hc,Rs,Xy,uc,Hy,rh,R,Us,Vy,Xs,Qy,ji,Jy,Ky,Zy,Hs,Yy,Vs,ev,tv,ov,mc,nv,av,ft,fc,Qs,sv,rv,_c,Js,iv,dv,gc,Ks,lv,cv,kc,Zs,pv,hv,Ne,Ys,uv,qo,mv,bc,fv,_v,yc,gv,kv,bv,_n,yv,vc,vv,Tv,er,Mv,wt,tr,wv,Tc,xv,zv,or,qv,xt,nr,Bv,Mc,$v,Fv,ar,ih,Bo,gn,wc,sr,jv,xc,Ev,dh,U,rr,Pv,ir,Cv,Ei,Ov,Sv,Av,dr,Iv,lr,Nv,Dv,Lv,zc,Gv,Wv,_t,qc,cr,Rv,Uv,Bc,pr,Xv,Hv,$c,hr,Vv,Qv,Fc,ur,Jv,Kv,te,mr,Zv,$o,Yv,jc,eT,tT,Ec,oT,nT,aT,kn,sT,Pc,rT,iT,fr,dT,Cc,lT,cT,_r,pT,zt,gr,hT,Oc,uT,mT,kr,fT,qt,br,_T,Sc,gT,kT,yr,lh,Fo,bn,Ac,vr,bT,Ic,yT,ch,A,Tr,vT,Nc,TT,MT,Mr,wT,Pi,xT,zT,qT,wr,BT,xr,$T,FT,jT,Dc,ET,PT,gt,Lc,zr,CT,OT,Gc,qr,ST,AT,Wc,Br,IT,NT,Rc,$r,DT,LT,De,Fr,GT,jo,WT,Uc,RT,UT,Xc,XT,HT,VT,yn,QT,Hc,JT,KT,jr,ZT,Bt,Er,YT,Vc,eM,tM,Pr,oM,$t,Cr,nM,Qc,aM,sM,Or,ph,Eo,vn,Jc,Sr,rM,Kc,iM,hh,I,Ar,dM,Po,lM,Zc,cM,pM,Yc,hM,uM,mM,Ir,fM,Ci,_M,gM,kM,Nr,bM,Dr,yM,vM,TM,ep,MM,wM,kt,tp,Lr,xM,zM,op,Gr,qM,BM,np,Wr,$M,FM,ap,Rr,jM,EM,Le,Ur,PM,Co,CM,sp,OM,SM,rp,AM,IM,NM,Tn,DM,ip,LM,GM,Xr,WM,Ft,Hr,RM,dp,UM,XM,Vr,HM,jt,Qr,VM,lp,QM,JM,Jr,uh;return T=new X({}),se=new X({}),He=new X({}),On=new $({props:{code:`from transformers import MBartForConditionalGeneration, MBartTokenizer
...
`}}),pn=new st({props:{$$slots:{default:[Qz]},$$scope:{ctx:E}}}),Os=new $({props:{code:`from transformers import MBartTokenizer, TFMBartModel
...
@patrickvonplaten`),Ke=d(),J=n("h2"),N=n("a"),Xe=n("span"),u(se.$$.fragment),P=d(),S=n("span"),lt=r("Overview of MBart"),pe=d(),he=n("p"),ct=r("The MBart model was presented in "),K=n("a"),pt=r("Multilingual Denoising Pre-training for Neural Machine Translation"),ht=r(` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
...
target text format is `),Ve=n("code"),Kt=r("[tgt_lang_code] X [eos]"),Ou=r(". "),ld=n("code"),Su=r("bos"),Au=r(" is never used."),bp=d(),yt=n("p"),Iu=r("The regular "),Cn=n("a"),cd=n("strong"),Nu=r("call"),Du=r("()"),Lu=r(` will encode source text format, and it should be wrapped
inside the context manager `),ti=n("a"),Gu=r("as_target_tokenizer()"),Wu=r(" to encode target text format."),yp=d(),oi=n("ul"),pd=n("li"),Ru=r("Supervised training"),vp=d(),u(On.$$.fragment),Tp=d(),ni=n("ul"),Sn=n("li"),hd=n("p"),Uu=r("Generation"),Xu=d(),Zt=n("p"),Hu=r("While generating the target text set the "),ud=n("code"),Vu=r("decoder_start_token_id"),Qu=r(` to the target language id. The following
example shows how to translate English to Romanian using the `),md=n("em"),Ju=r("facebook/mbart-large-en-ro"),Ku=r(" model."),Mp=d(),u(An.$$.fragment),wp=d(),Yt=n("h2"),Oo=n("a"),fd=n("span"),u(In.$$.fragment),Zu=d(),_d=n("span"),Yu=r("Overview of MBart-50"),xp=d(),vt=n("p"),em=r("MBart-50 was introduced in the "),Nn=n("a"),tm=r("Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),om=r(` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
improving 9.3 BLEU on average over bilingual baselines from scratch.`),Bp=d(),eo=n("h3"),So=n("a"),bd=n("span"),u(Dn.$$.fragment),im=d(),yd=n("span"),dm=r("Training of MBart-50"),$p=d(),et=n("p"),lm=r(`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),Fp=d(),Ao=n("p"),_m=r("MBart-50 has its own tokenizer "),ri=n("a"),gm=r("MBart50Tokenizer"),km=r("."),jp=d(),ii=n("ul"),wd=n("li"),bm=r("Supervised training"),Ep=d(),u(Ln.$$.fragment),Pp=d(),di=n("ul"),Gn=n("li"),xd=n("p"),ym=r("Generation"),vm=d(),qe=n("p"),Tm=r("To generate using the mBART-50 multilingual translation models, "),zd=n("code"),Mm=r("eos_token_id"),wm=r(` is used as the
...
`),Fd=n("em"),jm=r("facebook/mbart-50-large-many-to-many"),Em=r(" checkpoint."),Cp=d(),u(Wn.$$.fragment),Op=d(),to=n("h2"),Io=n("a"),jd=n("span"),u(Rn.$$.fragment),Pm=d(),Ed=n("span"),Cm=r("MBartConfig"),Sp=d(),Be=n("div"),u(Un.$$.fragment),Om=d(),oo=n("p"),Sm=r("This is the configuration class to store the configuration of a "),li=n("a"),Am=r("MBartModel"),Im=r(`. It is used to instantiate an MBART
...
documentation from `),pi=n("a"),Um=r("PretrainedConfig"),Xm=r(" for more information."),Hm=d(),Pd=n("p"),Vm=r("Example:"),Qm=d(),u(Hn.$$.fragment),Ap=d(),ao=n("h2"),No=n("a"),Cd=n("span"),u(Vn.$$.fragment),Jm=d(),Od=n("span"),Km=r("MBartTokenizer"),Ip=d(),G=n("div"),u(Qn.$$.fragment),Zm=d(),Sd=n("p"),Ym=r("Construct an MBART tokenizer."),ef=d(),mt=n("p"),tf=r("Adapted from "),hi=n("a"),of=r("RobertaTokenizer"),nf=r(" and "),ui=n("a"),af=r("XLNetTokenizer"),sf=r(`. Based on
...
separator.`),Np=d(),so=n("h2"),Lo=n("a"),Xd=n("span"),u(sa.$$.fragment),Cf=d(),Hd=n("span"),Of=r("MBartTokenizerFast"),Dp=d(),C=n("div"),u(ra.$$.fragment),Sf=d(),ro=n("p"),Af=r("Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Vd=n("em"),If=r("tokenizers"),Nf=r(` library). Based on
...
methods.`),Qf=d(),da=n("p"),Jf=r("The tokenization method is "),Qd=n("code"),Kf=r("<tokens> <eos> <language code>"),Zf=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Yf=d(),Jd=n("p"),e_=r("Examples:"),t_=d(),u(la.$$.fragment),o_=d(),Oe=n("div"),u(ca.$$.fragment),n_=d(),Kd=n("p"),a_=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
make use of token type ids, therefore a list of zeros is returned.`),T_=d(),Wo=n("div"),u(_a.$$.fragment),M_=d(),sl=n("p"),w_=r("Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),x_=d(),Ro=n("div"),u(ga.$$.fragment),z_=d(),rl=n("p"),q_=r("Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),Lp=d(),io=n("h2"),Uo=n("a"),il=n("span"),u(ka.$$.fragment),B_=d(),dl=n("span"),$_=r("MBart50Tokenizer"),Gp=d(),O=n("div"),u(ba.$$.fragment),F_=d(),ya=n("p"),j_=r("Construct a MBart50 tokenizer. Based on "),va=n("a"),E_=r("SentencePiece"),P_=r("."),C_=d(),Ta=n("p"),O_=r("This tokenizer inherits from "),gi=n("a"),S_=r("PreTrainedTokenizer"),A_=r(` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),gl=n("code"),dg=r("prepare_for_model"),lg=r(" method."),cg=d(),Vo=n("div"),u(Ea.$$.fragment),pg=d(),kl=n("p"),hg=r("Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),ug=d(),Qo=n("div"),u(Pa.$$.fragment),mg=d(),bl=n("p"),fg=r("Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),Wp=d(),lo=n("h2"),Jo=n("a"),yl=n("span"),u(Ca.$$.fragment),_g=d(),vl=n("span"),gg=r("MBart50TokenizerFast"),Rp=d(),W=n("div"),u(Oa.$$.fragment),kg=d(),co=n("p"),bg=r("Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=n("em"),yg=r("tokenizers"),vg=r(` library). Based on
`),Sa=n("a"),Tg=r("BPE"),Mg=r("."),wg=d(),Aa=n("p"),xg=r("This tokenizer inherits from "),ki=n("a"),zg=r("PreTrainedTokenizerFast"),qg=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Bg=d(),Ml=n("p"),$g=r("Examples:"),Fg=d(),u(Ia.$$.fragment),jg=d(),Se=n("div"),u(Na.$$.fragment),Eg=d(),wl=n("p"),Pg=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),Cg=d(),Da=n("p"),Og=r("An MBART-50 sequence has the following format, where "),xl=n("code"),Sg=r("X"),Ag=r(" represents the sequence:"),Ig=d(),La=n("ul"),Ga=n("li"),zl=n("code"),Ng=r("input_ids"),Dg=r(" (for encoder) "),ql=n("code"),Lg=r("[src_lang_code] X [eos]"),Gg=d(),Wa=n("li"),Bl=n("code"),Wg=r("labels"),Rg=r(": (for decoder) "),$l=n("code"),Ug=r("[tgt_lang_code] X [eos]"),Xg=d(),Fl=n("p"),Hg=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
and behavior.`),ck=d(),Ae=n("div"),u(Ka.$$.fragment),pk=d(),ho=n("p"),hk=r("The "),yi=n("a"),uk=r("MBartModel"),mk=r(" forward method, overrides the "),Ol=n("code"),fk=r("__call__"),_k=r(" special method."),gk=d(),u(en.$$.fragment),kk=d(),Sl=n("p"),bk=r("Example:"),yk=d(),u(Za.$$.fragment),Hp=d(),uo=n("h2"),tn=n("a"),Al=n("span"),u(Ya.$$.fragment),vk=d(),Il=n("span"),Tk=r("MBartForConditionalGeneration"),Vp=d(),Je=n("div"),u(es.$$.fragment),Mk=d(),ts=n("p"),wk=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jb=d(),L=n("div"),u(ys.$$.fragment),Eb=d(),bo=n("p"),Pb=r("The "),zi=n("a"),Cb=r("MBartForSequenceClassification"),Ob=r(" forward method, overrides the "),Kl=n("code"),Sb=r("__call__"),Ab=r(" special method."),Ib=d(),u(rn.$$.fragment),Nb=d(),Zl=n("p"),Db=r("Example of single-label classification:"),Lb=d(),u(vs.$$.fragment),Gb=d(),u(Ts.$$.fragment),Wb=d(),Yl=n("p"),Rb=r("Example of multi-label classification:"),Ub=d(),u(Ms.$$.fragment),Xb=d(),u(ws.$$.fragment),Yp=d(),yo=n("h2"),dn=n("a"),ec=n("span"),u(xs.$$.fragment),Hb=d(),tc=n("span"),Vb=r("MBartForCausalLM"),eh=d(),vo=n("div"),u(zs.$$.fragment),Qb=d(),Mt=n("div"),u(qs.$$.fragment),Jb=d(),oc=n("p"),Kb=r("Example:"),Zb=d(),u(Bs.$$.fragment),th=d(),To=n("h2"),ln=n("a"),nc=n("span"),u($s.$$.fragment),Yb=d(),ac=n("span"),ey=r("TFMBartModel"),oh=d(),je=n("div"),u(Fs.$$.fragment),ty=d(),js=n("p"),oy=r(`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
behavior.`),ly=d(),u(cn.$$.fragment),cy=d(),Ie=n("div"),u(Cs.$$.fragment),py=d(),Mo=n("p"),hy=r("The "),Bi=n("a"),uy=r("TFMBartModel"),my=r(" forward method, overrides the "),sc=n("code"),fy=r("__call__"),_y=r(" special method."),gy=d(),u(pn.$$.fragment),ky=d(),rc=n("p"),by=r("Example:"),yy=d(),u(Os.$$.fragment),nh=d(),wo=n("h2"),hn=n("a"),ic=n("span"),u(Ss.$$.fragment),vy=d(),dc=n("span"),Ty=r("TFMBartForConditionalGeneration"),ah=d(),Ee=n("div"),u(As.$$.fragment),My=d(),Is=n("p"),wy=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jy=d(),u(un.$$.fragment),Ey=d(),ee=n("div"),u(Ls.$$.fragment),Py=d(),xo=n("p"),Cy=r("The "),Fi=n("a"),Oy=r("TFMBartForConditionalGeneration"),Sy=r(" forward method, overrides the "),lc=n("code"),Ay=r("__call__"),Iy=r(" special method."),Ny=d(),u(mn.$$.fragment),Dy=d(),cc=n("p"),Ly=r("Summarization example:"),Gy=d(),u(Gs.$$.fragment),Wy=d(),pc=n("p"),Ry=r("Mask filling example:"),Uy=d(),u(Ws.$$.fragment),sh=d(),zo=n("h2"),fn=n("a"),hc=n("span"),u(Rs.$$.fragment),Xy=d(),uc=n("span"),Hy=r("FlaxMBartModel"),rh=d(),R=n("div"),u(Us.$$.fragment),Vy=d(),Xs=n("p"),Qy=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jT=d(),Dc=n("p"),ET=r("Finally, this model supports inherent JAX features such as:"),PT=d(),gt=n("ul"),Lc=n("li"),zr=n("a"),CT=r("Just-In-Time (JIT) compilation"),OT=d(),Gc=n("li"),qr=n("a"),ST=r("Automatic Differentiation"),AT=d(),Wc=n("li"),Br=n("a"),IT=r("Vectorization"),NT=d(),Rc=n("li"),$r=n("a"),DT=r("Parallelization"),LT=d(),De=n("div"),u(Fr.$$.fragment),GT=d(),jo=n("p"),WT=r("The "),Uc=n("code"),RT=r("FlaxMBartPreTrainedModel"),UT=r("forward method, overrides the "),Xc=n("code"),XT=r("__call__"),HT=r(" special method."),VT=d(),u(yn.$$.fragment),QT=d(),Hc=n("p"),JT=r("Example:"),KT=d(),u(jr.$$.fragment),ZT=d(),Bt=n("div"),u(Er.$$.fragment),YT=d(),Vc=n("p"),eM=r("Example:"),tM=d(),u(Pr.$$.fragment),oM=d(),$t=n("div"),u(Cr.$$.fragment),nM=d(),Qc=n("p"),aM=r("Example:"),sM=d(),u(Or.$$.fragment),ph=d(),Eo=n("h2"),vn=n("a"),Jc=n("span"),u(Sr.$$.fragment),rM=d(),Kc=n("span"),iM=r("FlaxMBartForQuestionAnswering"),hh=d(),I=n("div"),u(Ar.$$.fragment),dM=d(),Po=n("p"),lM=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
target text format is `),Ve=a(Et,"CODE",{});var i1=s(Ve);Kt=i(i1,"[tgt_lang_code] X [eos]"),i1.forEach(t),Ou=i(Et,". "),ld=a(Et,"CODE",{});var d1=s(ld);Su=i(d1,"bos"),d1.forEach(t),Au=i(Et," is never used."),Et.forEach(t),bp=l(o),yt=a(o,"P",{});var Oi=s(yt);Iu=i(Oi,"The regular "),Cn=a(Oi,"A",{href:!0});var KM=s(Cn);cd=a(KM,"STRONG",{});var l1=s(cd);Nu=i(l1,"call"),l1.forEach(t),Du=i(KM,"()"),KM.forEach(t),Lu=i(Oi,` will encode source text format, and it should be wrapped
inside the context manager `),ti=a(Oi,"A",{href:!0});var c1=s(ti);Gu=i(c1,"as_target_tokenizer()"),c1.forEach(t),Wu=i(Oi," to encode target text format."),Oi.forEach(t),yp=l(o),oi=a(o,"UL",{});var p1=s(oi);pd=a(p1,"LI",{});var h1=s(pd);Ru=i(h1,"Supervised training"),h1.forEach(t),p1.forEach(t),vp=l(o),m(On.$$.fragment,o),Tp=l(o),ni=a(o,"UL",{});var u1=s(ni);Sn=a(u1,"LI",{});var fh=s(Sn);hd=a(fh,"P",{});var m1=s(hd);Uu=i(m1,"Generation"),m1.forEach(t),Xu=l(fh),Zt=a(fh,"P",{});var Si=s(Zt);Hu=i(Si,"While generating the target text set the "),ud=a(Si,"CODE",{});var f1=s(ud);Vu=i(f1,"decoder_start_token_id"),f1.forEach(t),Qu=i(Si,` to the target language id. The following
example shows how to translate English to Romanian using the `),md=a(Si,"EM",{});var _1=s(md);Ju=i(_1,"facebook/mbart-large-en-ro"),_1.forEach(t),Ku=i(Si," model."),Si.forEach(t),fh.forEach(t),u1.forEach(t),Mp=l(o),m(An.$$.fragment,o),wp=l(o),Yt=a(o,"H2",{class:!0});var _h=s(Yt);Oo=a(_h,"A",{id:!0,class:!0,href:!0});var g1=s(Oo);fd=a(g1,"SPAN",{});var k1=s(fd);m(In.$$.fragment,k1),k1.forEach(t),g1.forEach(t),Zu=l(_h),_d=a(_h,"SPAN",{});var b1=s(_d);Yu=i(b1,"Overview of MBart-50"),b1.forEach(t),_h.forEach(t),xp=l(o),vt=a(o,"P",{});var Ai=s(vt);em=i(Ai,"MBart-50 was introduced in the "),Nn=a(Ai,"A",{href:!0,rel:!0});var y1=s(Nn);tm=i(y1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),y1.forEach(t),om=i(Ai,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Ai.forEach(t),zp=l(o),ai=a(o,"P",{});var T1=s(ai);sm=i(T1,"According to the abstract"),T1.forEach(t),qp=l(o),si=a(o,"P",{});var M1=s(si);kd=a(M1,"EM",{});var w1=s(kd);rm=i(w1,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),w1.forEach(t),M1.forEach(t),Bp=l(o),eo=a(o,"H3",{class:!0});var gh=s(eo);So=a(gh,"A",{id:!0,class:!0,href:!0});var x1=s(So);bd=a(x1,"SPAN",{});var z1=s(bd);m(Dn.$$.fragment,z1),z1.forEach(t),x1.forEach(t),im=l(gh),yd=a(gh,"SPAN",{});var q1=s(yd);dm=i(q1,"Training of MBart-50"),q1.forEach(t),gh.forEach(t),$p=l(o),et=a(o,"P",{});var wn=s(et);lm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),wn.forEach(t),Fp=l(o),Ao=a(o,"P",{});var kh=s(Ao);_m=i(kh,"MBart-50 has its own tokenizer "),ri=a(kh,"A",{href:!0});var j1=s(ri);gm=i(j1,"MBart50Tokenizer"),j1.forEach(t),km=i(kh,"."),kh.forEach(t),jp=l(o),ii=a(o,"UL",{});var E1=s(ii);wd=a(E1,"LI",{});var P1=s(wd);bm=i(P1,"Supervised training"),P1.forEach(t),E1.forEach(t),Ep=l(o),m(Ln.$$.fragment,o),Pp=l(o),di=a(o,"UL",{});var C1=s(di);Gn=a(C1,"LI",{});var bh=s(Gn);xd=a(bh,"P",{});var O1=s(xd);ym=i(O1,"Generation"),O1.forEach(t),vm=l(bh),qe=a(bh,"P",{});var nt=s(qe);Tm=i(nt,"To generate using the mBART-50 multilingual translation models, "),zd=a(nt,"CODE",{});var S1=s(zd);Mm=i(S1,"eos_token_id"),S1.forEach(t),wm=i(nt,` is used as the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Fd=a(nt,"EM",{});var D1=s(Fd);jm=i(D1,"facebook/mbart-50-large-many-to-many"),D1.forEach(t),Em=i(nt," checkpoint."),nt.forEach(t),bh.forEach(t),C1.forEach(t),Cp=l(o),m(Wn.$$.fragment,o),Op=l(o),to=a(o,"H2",{class:!0});var yh=s(to);Io=a(yh,"A",{id:!0,class:!0,href:!0});var L1=s(Io);jd=a(L1,"SPAN",{});var G1=s(jd);m(Rn.$$.fragment,G1),G1.forEach(t),L1.forEach(t),Pm=l(yh),Ed=a(yh,"SPAN",{});var W1=s(Ed);Cm=i(W1,"MBartConfig"),W1.forEach(t),yh.forEach(t),Sp=l(o),Be=a(o,"DIV",{class:!0});var Pt=s(Be);m(Un.$$.fragment,Pt),Om=l(Pt),oo=a(Pt,"P",{});var Ii=s(oo);Sm=i(Ii,"This is the configuration class to store the configuration of a "),li=a(Ii,"A",{href:!0});var R1=s(li);Am=i(R1,"MBartModel"),R1.forEach(t),Im=i(Ii,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
...
documentation from `),pi=a(Ni,"A",{href:!0});var H1=s(pi);Um=i(H1,"PretrainedConfig"),H1.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Hm=l(Pt),Pd=a(Pt,"P",{});var V1=s(Pd);Vm=i(V1,"Example:"),V1.forEach(t),Qm=l(Pt),m(Hn.$$.fragment,Pt),Pt.forEach(t),Ap=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var Q1=s(No);Cd=a(Q1,"SPAN",{});var J1=s(Cd);m(Vn.$$.fragment,J1),J1.forEach(t),Q1.forEach(t),Jm=l(vh),Od=a(vh,"SPAN",{});var K1=s(Od);Km=i(K1,"MBartTokenizer"),K1.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Qn.$$.fragment,me),Zm=l(me),Sd=a(me,"P",{});var Z1=s(Sd);Ym=i(Z1,"Construct an MBART tokenizer."),Z1.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Y1=s(hi);of=i(Y1,"RobertaTokenizer"),Y1.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var ew=s(ui);af=i(ew,"XLNetTokenizer"),ew.forEach(t),sf=i(xn,`. Based on
...
methods.`),ei.forEach(t),Qf=l(V),da=a(V,"P",{});var $h=s(da);Jf=i($h,"The tokenization method is "),Qd=a($h,"CODE",{});var bw=s(Qd);Kf=i(bw,"<tokens> <eos> <language code>"),bw.forEach(t),Zf=i($h," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$h.forEach(t),Yf=l(V),Jd=a(V,"P",{});var yw=s(Jd);e_=i(yw,"Examples:"),yw.forEach(t),t_=l(V),m(la.$$.fragment,V),o_=l(V),Oe=a(V,"DIV",{class:!0});var Ct=s(Oe);m(ca.$$.fragment,Ct),n_=l(Ct),Kd=a(Ct,"P",{});var vw=s(Kd);a_=i(vw,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
make use of token type ids, therefore a list of zeros is returned.`),Bw.forEach(t),Ch.forEach(t),T_=l(V),Wo=a(V,"DIV",{class:!0});var Oh=s(Wo);m(_a.$$.fragment,Oh),M_=l(Oh),sl=a(Oh,"P",{});var $w=s(sl);w_=i($w,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$w.forEach(t),Oh.forEach(t),x_=l(V),Ro=a(V,"DIV",{class:!0});var Sh=s(Ro);m(ga.$$.fragment,Sh),z_=l(Sh),rl=a(Sh,"P",{});var Fw=s(rl);q_=i(Fw,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),Fw.forEach(t),Sh.forEach(t),V.forEach(t),Lp=l(o),io=a(o,"H2",{class:!0});var Ah=s(io);Uo=a(Ah,"A",{id:!0,class:!0,href:!0});var jw=s(Uo);il=a(jw,"SPAN",{});var Ew=s(il);m(ka.$$.fragment,Ew),Ew.forEach(t),jw.forEach(t),B_=l(Ah),dl=a(Ah,"SPAN",{});var Pw=s(dl);$_=i(Pw,"MBart50Tokenizer"),Pw.forEach(t),Ah.forEach(t),Gp=l(o),O=a(o,"DIV",{class:!0});var Q=s(O);m(ba.$$.fragment,Q),F_=l(Q),ya=a(Q,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var Cw=s(va);E_=i(Cw,"SentencePiece"),Cw.forEach(t),P_=i(Ih,"."),Ih.forEach(t),C_=l(Q),Ta=a(Q,"P",{});var Nh=s(Ta);O_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var Ow=s(gi);S_=i(Ow,"PreTrainedTokenizer"),Ow.forEach(t),A_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(Q),ll=a(Q,"P",{});var Sw=s(ll);N_=i(Sw,"Examples:"),Sw.forEach(t),D_=l(Q),m(Ma.$$.fragment,Q),L_=l(Q),ot=a(Q,"DIV",{class:!0});var qn=s(ot);m(wa.$$.fragment,qn),G_=l(qn),xa=a(qn,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Bn),Ae=a(Bn,"DIV",{class:!0});var St=s(Ae);m(Ka.$$.fragment,St),pk=l(St),ho=a(St,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var m2=s(yi);uk=i(m2,"MBartModel"),m2.forEach(t),mk=i(Gi," forward method, overrides the "),Ol=a(Gi,"CODE",{});var f2=s(Ol);fk=i(f2,"__call__"),f2.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(St),m(en.$$.fragment,St),kk=l(St),Sl=a(St,"P",{});var _2=s(Sl);bk=i(_2,"Example:"),_2.forEach(t),yk=l(St),m(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Hp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var g2=s(tn);Al=a(g2,"SPAN",{});var k2=s(Al);m(Ya.$$.fragment,k2),k2.forEach(t),g2.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var b2=s(Il);Tk=i(b2,"MBartForConditionalGeneration"),b2.forEach(t),ru.forEach(t),Vp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),Mk=l($n),ts=a($n,"P",{});var iu=s(ts);wk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ek=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Pk=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var T2=s(Ti);Ck=i(T2,"MBartForConditionalGeneration"),T2.forEach(t),Ok=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var M2=s(Nl);Sk=i(M2,"__call__"),M2.forEach(t),Ak=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var w2=s(Dl);Dk=i(w2,"Translation example:"),w2.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var x2=s(Ll);Wk=i(x2,"Mask filling example:"),x2.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Qp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var z2=s(nn);Gl=a(z2,"SPAN",{});var q2=s(Gl);m(is.$$.fragment,q2),q2.forEach(t),z2.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var B2=s(Wl);Xk=i(B2,"MBartForQuestionAnswering"),B2.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var At=s($e);m(ds.$$.fragment,At),Hk=l(At),_o=a(At,"P",{});var Ri=s(_o);Vk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $2=s(Rl);Qk=i($2,"span start logits"),$2.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var F2=s(Ul);Kk=i(F2,"span end logits"),F2.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(At),ls=a(At,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),Mi=a(cu,"A",{href:!0});var j2=s(Mi);tb=i(j2,"PreTrainedModel"),j2.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(At),cs=a(At,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var E2=s(ps);sb=i(E2,"torch.nn.Module"),E2.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(At),ue=a(At,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),wi=a(Ui,"A",{href:!0});var P2=s(wi);cb=i(P2,"MBartForQuestionAnswering"),P2.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var C2=s(Xl);hb=i(C2,"__call__"),C2.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Hl=a(at,"P",{});var O2=s(Hl);_b=i(O2,"Example:"),O2.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),At.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var S2=s(sn);Vl=a(S2,"SPAN",{});var A2=s(Vl);m(fs.$$.fragment,A2),A2.forEach(t),S2.forEach(t),bb=l(hu),Ql=a(hu,"SPAN",{});var I2=s(Ql);yb=i(I2,"MBartForSequenceClassification"),I2.forEach(t),hu.forEach(t),Zp=l(o),Fe=a(o,"DIV",{class:!0});var It=s(Fe);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var N2=s(Jl);Tb=i(N2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),ly=l(Nt),m(cn.$$.fragment,Nt),cy=l(Nt),Ie=a(Nt,"DIV",{class:!0});var Dt=s(Ie);m(Cs.$$.fragment,Dt),py=l(Dt),Mo=a(Dt,"P",{});var Vi=s(Mo);hy=i(Vi,"The "),Bi=a(Vi,"A",{href:!0});var tx=s(Bi);uy=i(tx,"TFMBartModel"),tx.forEach(t),my=i(Vi," forward method, overrides the "),sc=a(Vi,"CODE",{});var ox=s(sc);fy=i(ox,"__call__"),ox.forEach(t),_y=i(Vi," special method."),Vi.forEach(t),gy=l(Dt),m(pn.$$.fragment,Dt),ky=l(Dt),rc=a(Dt,"P",{});var nx=s(rc);by=i(nx,"Example:"),nx.forEach(t),yy=l(Dt),m(Os.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),nh=l(o),wo=a(o,"H2",{class:!0});var yu=s(wo);hn=a(yu,"A",{id:!0,class:!0,href:!0});var ax=s(hn);ic=a(ax,"SPAN",{});var sx=s(ic);m(Ss.$$.fragment,sx),sx.forEach(t),ax.forEach(t),vy=l(yu),dc=a(yu,"SPAN",{});var rx=s(dc);Ty=i(rx,"TFMBartForConditionalGeneration"),rx.forEach(t),yu.forEach(t),ah=l(o),Ee=a(o,"DIV",{class:!0});var Lt=s(Ee);m(As.$$.fragment,Lt),My=l(Lt),Is=a(Lt,"P",{});var vu=s(Is);wy=i(vu,`The MBART Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ju.forEach(t),jT=l(ne),Dc=a(ne,"P",{});var az=s(Dc);ET=i(az,"Finally, this model supports inherent JAX features such as:"),az.forEach(t),PT=l(ne),gt=a(ne,"UL",{});var En=s(gt);Lc=a(En,"LI",{});var sz=s(Lc);zr=a(sz,"A",{href:!0,rel:!0});var rz=s(zr);CT=i(rz,"Just-In-Time (JIT) compilation"),rz.forEach(t),sz.forEach(t),OT=l(En),Gc=a(En,"LI",{});var iz=s(Gc);qr=a(iz,"A",{href:!0,rel:!0});var dz=s(qr);ST=i(dz,"Automatic Differentiation"),dz.forEach(t),iz.forEach(t),AT=l(En),Wc=a(En,"LI",{});var lz=s(Wc);Br=a(lz,"A",{href:!0,rel:!0});var cz=s(Br);IT=i(cz,"Vectorization"),cz.forEach(t),lz.forEach(t),NT=l(En),Rc=a(En,"LI",{});var pz=s(Rc);$r=a(pz,"A",{href:!0,rel:!0});var hz=s($r);DT=i(hz,"Parallelization"),hz.forEach(t),pz.forEach(t),En.forEach(t),LT=l(ne),De=a(ne,"DIV",{class:!0});var Wt=s(De);m(Fr.$$.fragment,Wt),GT=l(Wt),jo=a(Wt,"P",{});var od=s(jo);WT=i(od,"The "),Uc=a(od,"CODE",{});var uz=s(Uc);RT=i(uz,"FlaxMBartPreTrainedModel"),uz.forEach(t),UT=i(od,"forward method, overrides the "),Xc=a(od,"CODE",{});var mz=s(Xc);XT=i(mz,"__call__"),mz.forEach(t),HT=i(od," special method."),od.forEach(t),VT=l(Wt),m(yn.$$.fragment,Wt),QT=l(Wt),Hc=a(Wt,"P",{});var fz=s(Hc);JT=i(fz,"Example:"),fz.forEach(t),KT=l(Wt),m(jr.$$.fragment,Wt),Wt.forEach(t),ZT=l(ne),Bt=a(ne,"DIV",{class:!0});var nd=s(Bt);m(Er.$$.fragment,nd),YT=l(nd),Vc=a(nd,"P",{});var _z=s(Vc);eM=i(_z,"Example:"),_z.forEach(t),tM=l(nd),m(Pr.$$.fragment,nd),nd.forEach(t),oM=l(ne),$t=a(ne,"DIV",{class:!0});var ad=s($t);m(Cr.$$.fragment,ad),nM=l(ad),Qc=a(ad,"P",{});var gz=s(Qc);aM=i(gz,"Example:"),gz.forEach(t),sM=l(ad),m(Or.$$.fragment,ad),ad.forEach(t),ne.forEach(t),ph=l(o),Eo=a(o,"H2",{class:!0});var Eu=s(Eo);vn=a(Eu,"A",{id:!0,class:!0,href:!0});var kz=s(vn);Jc=a(kz,"SPAN",{});var bz=s(Jc);m(Sr.$$.fragment,bz),bz.forEach(t),kz.forEach(t),rM=l(Eu),Kc=a(Eu,"SPAN",{});var yz=s(Kc);iM=i(yz,"FlaxMBartForQuestionAnswering"),yz.forEach(t),Eu.forEach(t),hh=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);m(Ar.$$.fragment,ae),dM=l(ae),Po=a(ae,"P",{});var sd=s(Po);lM=i(sd,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
