...
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(j,"CODE",{});var C=s(m);M=n(C,"Module"),C.forEach(o),F=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function pc(Q){let p,P,m,M,F,y,j,C,Vn,Yt,f,$n,Eo,qn,zn,rt,Pn,Fn,ko,Cn,An,xo,Sn,In,jo,Ln,Nn,Do,On,Rn,at,Bn,Gn,Mo,Wn,Un,Vo,Hn,Zn,$o,Jn,Yn,qo,Kn,Qn,Kt,he,Xn,xe,er,or,Qt,G,tr,zo,nr,rr,Po,ar,sr,Xt,X,me,st,je,dr,dt,ir,en,z,De,cr,fe,Fo,lr,pr,Co,hr,mr,fr,ee,ur,Ao,gr,_r,So,vr,br,Tr,it,wr,yr,Me,Er,ue,Ve,kr,$e,xr,Io,jr,Dr,Mr,ge,qe,Vr,oe,$r,ct,qr,zr,lt,Pr,Fr,on,te,_e,pt,ze,Cr,ht,Ar,tn,E,Pe,Sr,ne,Ir,mt,Lr,Nr,ft,Or,Rr,Br,Fe,Gr,Ce,Wr,Ur,Hr,Ae,Zr,Se,Jr,Yr,Kr,ut,Qr,Xr,Ie,ea,Lo,oa,ta,na,Le,ra,Ne,aa,sa,da,W,No,ia,ca,gt,la,pa,_t,ha,ma,fa,A,Oe,ua,re,ga,Oo,_a,va,vt,ba,Ta,wa,ve,ya,bt,Ea,ka,Re,xa,S,Be,ja,Tt,Da,Ma,ae,Va,wt,$a,qa,yt,za,Pa,Fa,Et,Ca,Aa,Ge,nn,se,be,kt,We,Sa,xt,Ia,rn,k,Ue,La,de,Na,jt,Oa,Ra,Dt,Ba,Ga,Wa,He,Ua,Ze,Ha,Za,Ja,Je,Ya,Ye,Ka,Qa,Xa,Mt,es,os,Ke,ts,Ro,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Bo,ls,ps,Vt,hs,ms,$t,fs,us,gs,I,eo,_s,ie,vs,Go,bs,Ts,qt,ws,ys,Es,Te,ks,zt,xs,js,oo,Ds,O,to,Ms,Pt,Vs,$s,Ft,qs,zs,no,an,ce,we,Ct,ro,Ps,At,Fs,sn,x,ao,Cs,le,As,St,Ss,Is,It,Ls,Ns,Os,so,Rs,io,Bs,Gs,Ws,co,Us,lo,Hs,Zs,Js,Lt,Ys,Ks,po,Qs,Wo,Xs,ed,od,ho,td,mo,nd,rd,ad,H,Uo,sd,dd,Nt,id,cd,Ot,ld,pd,hd,L,fo,md,pe,fd,Ho,ud,gd,Rt,_d,vd,bd,ye,Td,Bt,wd,yd,uo,Ed,R,go,kd,Gt,xd,jd,Wt,Dd,Md,_o,dn;return y=new Jt({}),je=new Jt({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_15806/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_15806/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15806/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15806/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Zhou, Wei Li, Peter J. Liu.`),Hr=c(),Ae=r("p"),Zr=t("Additionally, in "),Se=r("a"),Jr=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
documentation from `),So=a(Jo,"A",{href:!0});var Kd=s(So);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(Jo," for more information."),Jo.forEach(o),Tr=l(N),it=a(N,"P",{});var Qd=s(it);wr=n(Qd,"Examples:"),Qd.forEach(o),yr=l(N),g(Me.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(Ve.$$.fragment,pn),kr=l(pn),$e=a(pn,"P",{});var hn=s($e);xr=n(hn,"Instantiate a "),Io=a(hn,"A",{href:!0});var Xd=s(Io);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Dr=n(hn,` (or a derived class) from a pre-trained encoder model
...
Zhou, Wei Li, Peter J. Liu.`),un.forEach(o),Hr=l(V),Ae=a(V,"P",{});var gn=s(Ae);Zr=n(gn,"Additionally, in "),Se=a(gn,"A",{href:!0,rel:!0});var ii=s(Se);Jr=n(ii,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
`),$t=a(To,"CODE",{});var Fi=s($t);fs=n(Fi,"from_pretrained()"),Fi.forEach(o),us=n(To,"class method for the decoder."),To.forEach(o),gs=l($),I=a($,"DIV",{class:!0});var Y=s(I);g(eo.$$.fragment,Y),_s=l(Y),ie=a(Y,"P",{});var ot=s(ie);vs=n(ot,"The "),Go=a(ot,"A",{href:!0});var Ci=s(Go);bs=n(Ci,"TFVisionEncoderDecoderModel"),Ci.forEach(o),Ts=n(ot," forward method, overrides the "),qt=a(ot,"CODE",{});var Ai=s(qt);ws=n(Ai,"__call__"),Ai.forEach(o),ys=n(ot," special method."),ot.forEach(o),Es=l(Y),g(Te.$$.fragment,Y),ks=l(Y),zt=a(Y,"P",{});var Si=s(zt);xs=n(Si,"Examples:"),Si.forEach(o),js=l(Y),g(oo.$$.fragment,Y),Y.forEach(o),Ds=l($),O=a($,"DIV",{class:!0});var Ee=s(O);g(to.$$.fragment,Ee),Ms=l(Ee),Pt=a(Ee,"P",{});var Ii=s(Pt);Vs=n(Ii,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
