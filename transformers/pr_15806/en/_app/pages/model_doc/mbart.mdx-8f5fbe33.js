import{S as jz,i as Ez,s as Pz,e as n,k as d,w as m,t as r,L as Cz,c as a,d as t,m as l,a as s,x as f,h as i,b as c,J as e,g as u,y as _,q as g,o as k,B as b}from"../../chunks/vendor-9e2b328e.js";import{T as at}from"../../chunks/Tip-76f97a76.js";import{D as q}from"../../chunks/Docstring-50fd6873.js";import{C as F}from"../../chunks/CodeBlock-88e23343.js";import{I as U}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Sz(E){let h,z,v,M,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),x=r(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(expected_translation_romanian, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs[<span class="hljs-string">&quot;labels&quot;</span>] = labels[<span class="hljs-string">&quot;input_ids&quot;</span>]`}}),la=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart/tokenization_mbart_fast.py#L163",parametersDescription:[{anchor:"transformers.MBartTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Ma=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ra=new q({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L221"}}),Wa=new q({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L236"}}),Ua=new U({}),Xa=new q({props:{name:"class transformers.MBartModel",anchor:"transformers.MBartModel",parameters:[{name:"config",val:": MBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart/modeling_mbart.py#L1123",parametersDescription:[{anchor:"transformers.MBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15806/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15806/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ja=new q({props:{name:"forward",anchor:"transformers.MBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart/modeling_mbart.py#L1150",parametersDescription:[{anchor:"transformers.MBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15806/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15806/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15806/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Es=new U({}),Ps=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart/modeling_tf_mbart.py#L1311",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15806/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15806/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Lz]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15806/src/transformers/models/mbart/modeling_tf_mbart.py#L1344",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15806/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15806/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15806/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15806/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15806/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
separator.`),Kw.forEach(t),Ct.forEach(t),Rg=l(he),Jo=a(he,"DIV",{class:!0});var Ku=s(Jo);f(Ra.$$.fragment,Ku),Wg=l(Ku),ql=a(Ku,"P",{});var Zw=s(ql);Ug=i(Zw,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),Zw.forEach(t),Ku.forEach(t),Xg=l(he),Ko=a(he,"DIV",{class:!0});var Zu=s(Ko);f(Wa.$$.fragment,Zu),Hg=l(Zu),Bl=a(Zu,"P",{});var Yw=s(Bl);Vg=i(Yw,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),Yw.forEach(t),Zu.forEach(t),he.forEach(t),Lp=l(o),po=a(o,"H2",{class:!0});var Yu=s(po);Zo=a(Yu,"A",{id:!0,class:!0,href:!0});var e0=s(Zo);$l=a(e0,"SPAN",{});var t0=s($l);f(Ua.$$.fragment,t0),t0.forEach(t),e0.forEach(t),Qg=l(Yu),Fl=a(Yu,"SPAN",{});var o0=s(Fl);Jg=i(o0,"MBartModel"),o0.forEach(t),Yu.forEach(t),Gp=l(o),Qe=a(o,"DIV",{class:!0});var qn=s(Qe);f(Xa.$$.fragment,qn),Kg=l(qn),Ha=a(qn,"P",{});var eh=s(Ha);Zg=i(eh,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),fi=a(eh,"A",{href:!0});var n0=s(fi);Yg=i(n0,"PreTrainedModel"),n0.forEach(t),ek=i(eh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eh.forEach(t),tk=l(qn),Va=a(qn,"P",{});var th=s(Va);ok=i(th,"This model is also a PyTorch "),Qa=a(th,"A",{href:!0,rel:!0});var a0=s(Qa);nk=i(a0,"torch.nn.Module"),a0.forEach(t),ak=i(th,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),th.forEach(t),sk=l(qn),Se=a(qn,"DIV",{class:!0});var St=s(Se);f(Ja.$$.fragment,St),rk=l(St),uo=a(St,"P",{});var Ni=s(uo);ik=i(Ni,"The "),_i=a(Ni,"A",{href:!0});var s0=s(_i);dk=i(s0,"MBartModel"),s0.forEach(t),lk=i(Ni," forward method, overrides the "),jl=a(Ni,"CODE",{});var r0=s(jl);ck=i(r0,"__call__"),r0.forEach(t),pk=i(Ni," special method."),Ni.forEach(t),uk=l(St),f(Yo.$$.fragment,St),hk=l(St),El=a(St,"P",{});var i0=s(El);mk=i(i0,"Example:"),i0.forEach(t),fk=l(St),f(Ka.$$.fragment,St),St.forEach(t),qn.forEach(t),Rp=l(o),ho=a(o,"H2",{class:!0});var oh=s(ho);en=a(oh,"A",{id:!0,class:!0,href:!0});var d0=s(en);Pl=a(d0,"SPAN",{});var l0=s(Pl);f(Za.$$.fragment,l0),l0.forEach(t),d0.forEach(t),_k=l(oh),Cl=a(oh,"SPAN",{});var c0=s(Cl);gk=i(c0,"MBartForConditionalGeneration"),c0.forEach(t),oh.forEach(t),Wp=l(o),Je=a(o,"DIV",{class:!0});var Bn=s(Je);f(Ya.$$.fragment,Bn),kk=l(Bn),es=a(Bn,"P",{});var nh=s(es);bk=i(nh,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),gi=a(nh,"A",{href:!0});var p0=s(gi);vk=i(p0,"PreTrainedModel"),p0.forEach(t),yk=i(nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nh.forEach(t),Tk=l(Bn),ts=a(Bn,"P",{});var ah=s(ts);Mk=i(ah,"This model is also a PyTorch "),os=a(ah,"A",{href:!0,rel:!0});var u0=s(os);wk=i(u0,"torch.nn.Module"),u0.forEach(t),xk=i(ah,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ah.forEach(t),zk=l(Bn),Z=a(Bn,"DIV",{class:!0});var Le=s(Z);f(ns.$$.fragment,Le),qk=l(Le),mo=a(Le,"P",{});var Oi=s(mo);Bk=i(Oi,"The "),ki=a(Oi,"A",{href:!0});var h0=s(ki);$k=i(h0,"MBartForConditionalGeneration"),h0.forEach(t),Fk=i(Oi," forward method, overrides the "),Sl=a(Oi,"CODE",{});var m0=s(Sl);jk=i(m0,"__call__"),m0.forEach(t),Ek=i(Oi," special method."),Oi.forEach(t),Pk=l(Le),f(tn.$$.fragment,Le),Ck=l(Le),Al=a(Le,"P",{});var f0=s(Al);Sk=i(f0,"Summarization example:"),f0.forEach(t),Ak=l(Le),f(as.$$.fragment,Le),Ik=l(Le),Il=a(Le,"P",{});var _0=s(Il);Nk=i(_0,"Mask filling example:"),_0.forEach(t),Ok=l(Le),f(ss.$$.fragment,Le),Le.forEach(t),Bn.forEach(t),Up=l(o),fo=a(o,"H2",{class:!0});var sh=s(fo);on=a(sh,"A",{id:!0,class:!0,href:!0});var g0=s(on);Nl=a(g0,"SPAN",{});var k0=s(Nl);f(rs.$$.fragment,k0),k0.forEach(t),g0.forEach(t),Dk=l(sh),Ol=a(sh,"SPAN",{});var b0=s(Ol);Lk=i(b0,"MBartForQuestionAnswering"),b0.forEach(t),sh.forEach(t),Xp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(is.$$.fragment,At),Gk=l(At),_o=a(At,"P",{});var Di=s(_o);Rk=i(Di,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Dl=a(Di,"CODE",{});var v0=s(Dl);Wk=i(v0,"span start logits"),v0.forEach(t),Uk=i(Di," and "),Ll=a(Di,"CODE",{});var y0=s(Ll);Xk=i(y0,"span end logits"),y0.forEach(t),Hk=i(Di,")."),Di.forEach(t),Vk=l(At),ds=a(At,"P",{});var rh=s(ds);Qk=i(rh,"This model inherits from "),bi=a(rh,"A",{href:!0});var T0=s(bi);Jk=i(T0,"PreTrainedModel"),T0.forEach(t),Kk=i(rh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rh.forEach(t),Zk=l(At),ls=a(At,"P",{});var ih=s(ls);Yk=i(ih,"This model is also a PyTorch "),cs=a(ih,"A",{href:!0,rel:!0});var M0=s(cs);eb=i(M0,"torch.nn.Module"),M0.forEach(t),tb=i(ih,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ih.forEach(t),ob=l(At),Ae=a(At,"DIV",{class:!0});var It=s(Ae);f(ps.$$.fragment,It),nb=l(It),go=a(It,"P",{});var Li=s(go);ab=i(Li,"The "),vi=a(Li,"A",{href:!0});var w0=s(vi);sb=i(w0,"MBartForQuestionAnswering"),w0.forEach(t),rb=i(Li," forward method, overrides the "),Gl=a(Li,"CODE",{});var x0=s(Gl);ib=i(x0,"__call__"),x0.forEach(t),db=i(Li," special method."),Li.forEach(t),lb=l(It),f(nn.$$.fragment,It),cb=l(It),Rl=a(It,"P",{});var z0=s(Rl);pb=i(z0,"Example:"),z0.forEach(t),ub=l(It),f(us.$$.fragment,It),It.forEach(t),At.forEach(t),Hp=l(o),ko=a(o,"H2",{class:!0});var dh=s(ko);an=a(dh,"A",{id:!0,class:!0,href:!0});var q0=s(an);Wl=a(q0,"SPAN",{});var B0=s(Wl);f(hs.$$.fragment,B0),B0.forEach(t),q0.forEach(t),hb=l(dh),Ul=a(dh,"SPAN",{});var $0=s(Ul);mb=i($0,"MBartForSequenceClassification"),$0.forEach(t),dh.forEach(t),Vp=l(o),Be=a(o,"DIV",{class:!0});var Nt=s(Be);f(ms.$$.fragment,Nt),fb=l(Nt),Xl=a(Nt,"P",{});var F0=s(Xl);_b=i(F0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),F0.forEach(t),gb=l(Nt),fs=a(Nt,"P",{});var lh=s(fs);kb=i(lh,"This model inherits from "),yi=a(lh,"A",{href:!0});var j0=s(yi);bb=i(j0,"PreTrainedModel"),j0.forEach(t),vb=i(lh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lh.forEach(t),yb=l(Nt),_s=a(Nt,"P",{});var ch=s(_s);Tb=i(ch,"This model is also a PyTorch "),gs=a(ch,"A",{href:!0,rel:!0});var E0=s(gs);Mb=i(E0,"torch.nn.Module"),E0.forEach(t),wb=i(ch,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ch.forEach(t),xb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(ks.$$.fragment,Ge),zb=l(Ge),bo=a(Ge,"P",{});var Gi=s(bo);qb=i(Gi,"The "),Ti=a(Gi,"A",{href:!0});var P0=s(Ti);Bb=i(P0,"MBartForSequenceClassification"),P0.forEach(t),$b=i(Gi," forward method, overrides the "),Hl=a(Gi,"CODE",{});var C0=s(Hl);Fb=i(C0,"__call__"),C0.forEach(t),jb=i(Gi," special method."),Gi.forEach(t),Eb=l(Ge),f(sn.$$.fragment,Ge),Pb=l(Ge),Vl=a(Ge,"P",{});var S0=s(Vl);Cb=i(S0,"Example of single-label classification:"),S0.forEach(t),Sb=l(Ge),f(bs.$$.fragment,Ge),Ab=l(Ge),Ql=a(Ge,"P",{});var A0=s(Ql);Ib=i(A0,"Example of multi-label classification:"),A0.forEach(t),Nb=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Qp=l(o),vo=a(o,"H2",{class:!0});var ph=s(vo);rn=a(ph,"A",{id:!0,class:!0,href:!0});var I0=s(rn);Jl=a(I0,"SPAN",{});var N0=s(Jl);f(ys.$$.fragment,N0),N0.forEach(t),I0.forEach(t),Ob=l(ph),Kl=a(ph,"SPAN",{});var O0=s(Kl);Db=i(O0,"MBartForCausalLM"),O0.forEach(t),ph.forEach(t),Jp=l(o),Ts=a(o,"DIV",{class:!0});var D0=s(Ts);Tt=a(D0,"DIV",{class:!0});var Ri=s(Tt);f(Ms.$$.fragment,Ri),Lb=l(Ri),Zl=a(Ri,"P",{});var L0=s(Zl);Gb=i(L0,"Example:"),L0.forEach(t),Rb=l(Ri),f(ws.$$.fragment,Ri),Ri.forEach(t),D0.forEach(t),Kp=l(o),yo=a(o,"H2",{class:!0});var uh=s(yo);dn=a(uh,"A",{id:!0,class:!0,href:!0});var G0=s(dn);Yl=a(G0,"SPAN",{});var R0=s(Yl);f(xs.$$.fragment,R0),R0.forEach(t),G0.forEach(t),Wb=l(uh),ec=a(uh,"SPAN",{});var W0=s(ec);Ub=i(W0,"TFMBartModel"),W0.forEach(t),uh.forEach(t),Zp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(zs.$$.fragment,Ot),Xb=l(Ot),qs=a(Ot,"P",{});var hh=s(qs);Hb=i(hh,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Mi=a(hh,"A",{href:!0});var U0=s(Mi);Vb=i(U0,"TFPreTrainedModel"),U0.forEach(t),Qb=i(hh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hh.forEach(t),Jb=l(Ot),Bs=a(Ot,"P",{});var mh=s(Bs);Kb=i(mh,"This model is also a "),$s=a(mh,"A",{href:!0,rel:!0});var X0=s($s);Zb=i(X0,"tf.keras.Model"),X0.forEach(t),Yb=i(mh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mh.forEach(t),ev=l(Ot),f(ln.$$.fragment,Ot),tv=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(Fs.$$.fragment,Dt),ov=l(Dt),To=a(Dt,"P",{});var Wi=s(To);nv=i(Wi,"The "),wi=a(Wi,"A",{href:!0});var H0=s(wi);av=i(H0,"TFMBartModel"),H0.forEach(t),sv=i(Wi," forward method, overrides the "),tc=a(Wi,"CODE",{});var V0=s(tc);rv=i(V0,"__call__"),V0.forEach(t),iv=i(Wi," special method."),Wi.forEach(t),dv=l(Dt),f(cn.$$.fragment,Dt),lv=l(Dt),oc=a(Dt,"P",{});var Q0=s(oc);cv=i(Q0,"Example:"),Q0.forEach(t),pv=l(Dt),f(js.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),Yp=l(o),Mo=a(o,"H2",{class:!0});var fh=s(Mo);pn=a(fh,"A",{id:!0,class:!0,href:!0});var J0=s(pn);nc=a(J0,"SPAN",{});var K0=s(nc);f(Es.$$.fragment,K0),K0.forEach(t),J0.forEach(t),uv=l(fh),ac=a(fh,"SPAN",{});var Z0=s(ac);hv=i(Z0,"TFMBartForConditionalGeneration"),Z0.forEach(t),fh.forEach(t),eu=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Ps.$$.fragment,Lt),mv=l(Lt),Cs=a(Lt,"P",{});var _h=s(Cs);fv=i(_h,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),xi=a(_h,"A",{href:!0});var Y0=s(xi);_v=i(Y0,"TFPreTrainedModel"),Y0.forEach(t),gv=i(_h,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
