...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18014/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18014/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18014/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18014/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18014/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18014/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18014/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rf.forEach(t),bT=h(It),y(fs.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vT=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(uo),y(gs.$$.fragment,uo),RT=h(uo),y(_s.$$.fragment,uo),MT=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),km=h(o),Ho=s(o,"H2",{class:!0});var Mf=a(Ho);ks=s(Mf,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mf),Mp=s(Mf,"SPAN",{});var e4=a(Mp);zT=i(e4,"TFRobertaForMultipleChoice"),e4.forEach(t),Mf.forEach(t),vm=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var t4=a(Ep);CT=i(t4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t4.forEach(t),jT=h(Dt),ni=s(Dt,"P",{});var Ef=a(ni);PT=i(Ef,"This model inherits from "),xd=s(Ef,"A",{href:!0});var o4=a(xd);LT=i(o4,"TFPreTrainedModel"),o4.forEach(t),AT=i(Ef,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ef.forEach(t),OT=h(Dt),si=s(Dt,"P",{});var zf=a(si);NT=i(zf,"This model is also a "),ai=s(zf,"A",{href:!0,rel:!0});var n4=a(ai);IT=i(n4,"tf.keras.Model"),n4.forEach(t),DT=i(zf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zf.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s4=a(Rd);HT=i(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a4=a(zp);JT=i(a4,"__call__"),a4.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tm=h(o),Jo=s(o,"H2",{class:!0});var qf=a(Jo);ws=s(qf,"A",{id:!0,class:!0,href:!0});var r4=a(ws);qp=s(r4,"SPAN",{});var i4=a(qp);y(ii.$$.fragment,i4),i4.forEach(t),r4.forEach(t),XT=h(qf),Cp=s(qf,"SPAN",{});var l4=a(Cp);YT=i(l4,"TFRobertaForTokenClassification"),l4.forEach(t),qf.forEach(t),ym=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d4=a(jp);ey=i(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),ty=h(St),di=s(St,"P",{});var Cf=a(di);oy=i(Cf,"This model inherits from "),Md=s(Cf,"A",{href:!0});var c4=a(Md);ny=i(c4,"TFPreTrainedModel"),c4.forEach(t),sy=i(Cf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cf.forEach(t),ay=h(St),ci=s(St,"P",{});var jf=a(ci);ry=i(jf,"This model is also a "),pi=s(jf,"A",{href:!0,rel:!0});var p4=a(pi);iy=i(p4,"tf.keras.Model"),p4.forEach(t),ly=i(jf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jf.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var mo=a(ht);y(hi.$$.fragment,mo),py=h(mo),Vo=s(mo,"P",{});var tc=a(Vo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h4=a(Ed);uy=i(h4,"TFRobertaForTokenClassification"),h4.forEach(t),my=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var u4=a(Pp);fy=i(u4,"__call__"),u4.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(mo),y(Fs.$$.fragment,mo),by=h(mo),y(xs.$$.fragment,mo),ky=h(mo),y(Rs.$$.fragment,mo),mo.forEach(t),St.forEach(t),wm=h(o),Ko=s(o,"H2",{class:!0});var Pf=a(Ko);Ms=s(Pf,"A",{id:!0,class:!0,href:!0});var m4=a(Ms);Lp=s(m4,"SPAN",{});var f4=a(Lp);y(ui.$$.fragment,f4),f4.forEach(t),m4.forEach(t),vy=h(Pf),Ap=s(Pf,"SPAN",{});var g4=a(Ap);Ty=i(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Pf.forEach(t),$m=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(mi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _4=a(Op);$y=i(_4,"span start logits"),_4.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var b4=a(Np);xy=i(b4,"span end logits"),b4.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),fi=s(Wt,"P",{});var Lf=a(fi);Ey=i(Lf,"This model inherits from "),zd=s(Lf,"A",{href:!0});var k4=a(zd);zy=i(k4,"TFPreTrainedModel"),k4.forEach(t),qy=i(Lf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf.forEach(t),Cy=h(Wt),gi=s(Wt,"P",{});var Af=a(gi);jy=i(Af,"This model is also a "),_i=s(Af,"A",{href:!0,rel:!0});var v4=a(_i);Py=i(v4,"tf.keras.Model"),v4.forEach(t),Ly=i(Af,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Af.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),ut=s(Wt,"DIV",{class:!0});var fo=a(ut);y(bi.$$.fragment,fo),Ny=h(fo),Xo=s(fo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),qd=s(nc,"A",{href:!0});var T4=a(qd);Dy=i(T4,"TFRobertaForQuestionAnswering"),T4.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y4=a(Ip);Wy=i(y4,"__call__"),y4.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(fo),y(zs.$$.fragment,fo),Hy=h(fo),y(qs.$$.fragment,fo),Qy=h(fo),y(Cs.$$.fragment,fo),fo.forEach(t),Wt.forEach(t),Fm=h(o),Yo=s(o,"H2",{class:!0});var Of=a(Yo);js=s(Of,"A",{id:!0,class:!0,href:!0});var w4=a(js);Dp=s(w4,"SPAN",{});var $4=a(Dp);y(ki.$$.fragment,$4),$4.forEach(t),w4.forEach(t),Jy=h(Of),Sp=s(Of,"SPAN",{});var F4=a(Sp);Vy=i(F4,"FlaxRobertaModel"),F4.forEach(t),Of.forEach(t),xm=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var x4=a(Wp);Gy=i(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nf=a(Ti);Yy=i(Nf,"This model inherits from "),Cd=s(Nf,"A",{href:!0});var R4=a(Cd);Zy=i(R4,"FlaxPreTrainedModel"),R4.forEach(t),ew=i(Nf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nf.forEach(t),tw=h(gt),yi=s(gt,"P",{});var If=a(yi);ow=i(If,"This model is also a Flax Linen "),wi=s(If,"A",{href:!0,rel:!0});var M4=a(wi);nw=i(M4,"flax.linen.Module"),M4.forEach(t),sw=i(If,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),If.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var E4=a(Bp);rw=i(E4,"Finally, this model supports inherent JAX features such as:"),E4.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z4=a(Up);$i=s(z4,"A",{href:!0,rel:!0});var q4=a($i);lw=i(q4,"Just-In-Time (JIT) compilation"),q4.forEach(t),z4.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var C4=a(Hp);Fi=s(C4,"A",{href:!0,rel:!0});var j4=a(Fi);cw=i(j4,"Automatic Differentiation"),j4.forEach(t),C4.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var P4=a(Qp);xi=s(P4,"A",{href:!0,rel:!0});var L4=a(xi);hw=i(L4,"Vectorization"),L4.forEach(t),P4.forEach(t),uw=h(ra),Jp=s(ra,"LI",{});var A4=a(Jp);Ri=s(A4,"A",{href:!0,rel:!0});var O4=a(Ri);mw=i(O4,"Parallelization"),O4.forEach(t),A4.forEach(t),ra.forEach(t),fw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Vp=s(sc,"CODE",{});var N4=a(Vp);bw=i(N4,"FlaxRobertaPreTrainedModel"),N4.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I4=a(Kp);vw=i(I4,"__call__"),I4.forEach(t),Tw=i(sc," special method."),sc.forEach(t),yw=h(ia),y(Ps.$$.fragment,ia),ww=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Rm=h(o),en=s(o,"H2",{class:!0});var Df=a(en);As=s(Df,"A",{id:!0,class:!0,href:!0});var D4=a(As);Gp=s(D4,"SPAN",{});var S4=a(Gp);y(Ei.$$.fragment,S4),S4.forEach(t),D4.forEach(t),$w=h(Df),Xp=s(Df,"SPAN",{});var W4=a(Xp);Fw=i(W4,"FlaxRobertaForCausalLM"),W4.forEach(t),Df.forEach(t),Mm=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var B4=a(Yp);Rw=i(B4,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),B4.forEach(t),Mw=h(_t),qi=s(_t,"P",{});var Sf=a(qi);Ew=i(Sf,"This model inherits from "),jd=s(Sf,"A",{href:!0});var U4=a(jd);zw=i(U4,"FlaxPreTrainedModel"),U4.forEach(t),qw=i(Sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Sf.forEach(t),Cw=h(_t),Ci=s(_t,"P",{});var Wf=a(Ci);jw=i(Wf,"This model is also a Flax Linen "),ji=s(Wf,"A",{href:!0,rel:!0});var H4=a(ji);Pw=i(H4,"flax.linen.Module"),H4.forEach(t),Lw=i(Wf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wf.forEach(t),Aw=h(_t),Zp=s(_t,"P",{});var Q4=a(Zp);Ow=i(Q4,"Finally, this model supports inherent JAX features such as:"),Q4.forEach(t),Nw=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var J4=a(eh);Pi=s(J4,"A",{href:!0,rel:!0});var V4=a(Pi);Iw=i(V4,"Just-In-Time (JIT) compilation"),V4.forEach(t),J4.forEach(t),Dw=h(la),th=s(la,"LI",{});var K4=a(th);Li=s(K4,"A",{href:!0,rel:!0});var G4=a(Li);Sw=i(G4,"Automatic Differentiation"),G4.forEach(t),K4.forEach(t),Ww=h(la),oh=s(la,"LI",{});var X4=a(oh);Ai=s(X4,"A",{href:!0,rel:!0});var Y4=a(Ai);Bw=i(Y4,"Vectorization"),Y4.forEach(t),X4.forEach(t),Uw=h(la),nh=s(la,"LI",{});var Z4=a(nh);Oi=s(Z4,"A",{href:!0,rel:!0});var eR=a(Oi);Hw=i(eR,"Parallelization"),eR.forEach(t),Z4.forEach(t),la.forEach(t),Qw=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),Jw=h(da),tn=s(da,"P",{});var ac=a(tn);Vw=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);Kw=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),Gw=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);Xw=i(oR,"__call__"),oR.forEach(t),Yw=i(ac," special method."),ac.forEach(t),Zw=h(da),y(Os.$$.fragment,da),e$=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),Em=h(o),on=s(o,"H2",{class:!0});var Bf=a(on);Is=s(Bf,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);y(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bf),ih=s(Bf,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bf.forEach(t),zm=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uf=a(Si);s$=i(Uf,"RoBERTa Model with a "),lh=s(Uf,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Uf," head on top."),Uf.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hf=a(Wi);l$=i(Hf,"This model inherits from "),Pd=s(Hf,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hf,`. Check the superclass documentation for the generic methods the
